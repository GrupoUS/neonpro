    ...
    <footer className="bg-slate-900 text-white">
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Badge className="bg-sky-100 text-sky-700 text-xs">Healthcare</Badge>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Badge className="bg-green-900 text-green-300 border-green-700 text-xs justify-center">
                  LGPD 2020
                </Badge>
                <Badge className="bg-blue-900 text-blue-300 border-blue-700 text-xs justify-center">
                  ANVISA
                </Badge>
                <Badge className="bg-purple-900 text-purple-300 border-purple-700 text-xs justify-center">
                  CFM 2.314/2022
                </Badge>
                <Badge className="bg-amber-900 text-amber-300 border-amber-700 text-xs justify-center">
                  ISO 27001
                </Badge>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 p-4 bg-slate-800 rounded-lg border border-slate-700">
          <div className="flex items-start space-x-3">
            <Shield className="h-5 w-5 text-sky-400 flex-shrink-0 mt-0.5" />
            <div>
