import { format, differenceInDays, startOfMonth, endOfMonth, subMonths, addDays } from 'date-fns';
...
export const filterAlertsBySeverity = (alerts: KPIAlert[], minSeverity: 'low' | 'medium' | 'high' | 'critical'): KPIAlert[] => {
