...
import { IntelligentInvoicing } from '@/components/financial/IntelligentInvoicing';
import { IntelligentScheduling } from '@/components/financial/IntelligentScheduling';
import { FinancialAnalytics } from '@/components/financial/FinancialAnalytics';
import { formatCurrency, formatPercentage, calculateTotals } from '@/components/financial';
...
describe('Financial Components Test Suite', () => {
  ...
  describe('IntelligentInvoicing Component', () => {
    ...
    test('renders invoice generation interface', () => {
      ...
      expect(screen.getByText('Sistema automatizado com recomendações AI e templates personalizáveis')).toBeInTheDocument();
  ...
  describe('IntelligentScheduling Component', () => {
    ...
    test('renders scheduling interface', () => {
      ...
      expect(screen.getByText('Sistema AI para otimização de horários e detecção de conflitos')).toBeInTheDocument();
      expect(screen.getByPlaceholderText('Selecionar paciente')).toBeInTheDocument();
  ...
  describe('FinancialAnalytics Component', () => {
    ...
    test('renders analytics dashboard', () => {
      ...
      expect(screen.getByText('Dashboard com insights preditivos e métricas em tempo real')).toBeInTheDocument();
