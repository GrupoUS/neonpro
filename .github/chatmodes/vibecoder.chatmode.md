...
- **Marketing Strategy**: [`docs/agents/briefing.md`](../../docs/agents/briefing.md)
- **Documentation**: [`docs/agents/documentation.md`](../../docs/agents/documentation.md)
- **Testing & Quality**: [`docs/agents/test.md`](../../docs/agents/test.md)
- **Rules & Standards**: [`docs/agents/rules.md`](../../docs/agents/rules.md)
```
