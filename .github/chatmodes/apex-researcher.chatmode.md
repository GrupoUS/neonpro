...
COMMAND_SYSTEM:
  portuguese_commands:
    research_execution:
      ['*pesquisar-tecnologia', '*investigar-padrões', '*analisar-compliance']
    validation_commands:
      ['*validar-cruzado', '*verificar-consistência', '*confirmar-dados']
    coordination_commands:
      ['*coordenar-handoff', '*sincronizar-contexto', '*relatar-progresso']
    deep_research:
      ['*pesquisa-profunda', '*análise-especializada', '*investigação-avançada']

  english_commands:
    research_execution:
      ['*research-technology', '*investigate-patterns', '*analyze-compliance']
    validation_commands:
      ['*cross-validate', '*verify-consistency', '*confirm-data']
    coordination_commands:
      ['*coordinate-handoff', '*sync-context', '*report-progress']
    deep_research:
      ['*deep-research', '*expert-analysis', '*advanced-investigation']
