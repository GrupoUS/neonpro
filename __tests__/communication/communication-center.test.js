...
jest.mock('@/app/hooks/use-communication', function () { return ({
...
jest.mock('date-fns', function () { return ({
    formatDistanceToNow: jest.fn(function () { return '2 horas atrás'; }),
    format: jest.fn(function () { return '30/01/2025 10:30'; }),
    isToday: jest.fn(function () { return true; }),
    isYesterday: jest.fn(function () { return false; })
}); });
jest.mock('date-fns/locale', function () { return ({
    ptBR: {}
}); });
...
describe('Communication Center', function () {
    ...
    describe('CommunicationDashboard', function () {
        it('renders dashboard with statistics correctly', function () {
            (0, react_2.render)(<CommunicationDashboard_1.CommunicationDashboard />, { wrapper: createWrapper() });
        ...
        it('switches between tabs correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, composeTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, user.click(composeTab)
        ...
        it('handles template selection correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, user.click(templatesTab)
    ...
    describe('CommunicationInbox', function () {
        it('renders thread list correctly', function () {
            (0, react_2.render)(<CommunicationInbox_1.CommunicationInbox />, { wrapper: createWrapper() });
            // Check thread items
        ...
        it('handles thread filtering', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, user.type(searchInput, 'Maria')
                            // Should filter threads
                        ];
                    case 1:
                        _a.sent();
                        // Should filter threads
                        expect(mockHooks.useMessageThreads).toHaveBeenCalledWith(expect.objectContaining({
                            search: 'Maria'
                        }));
                        return [2 /*return*/];
                }
        ...
        it('handles thread selection and message loading', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, user.click(firstThread)
                            // Should load messages for selected thread
                        ];
                    case 1:
                        _a.sent();
                        // Should load messages for selected thread
                        expect(mockHooks.useMessages).toHaveBeenCalledWith(expect.objectContaining({
                            thread_id: 'thread-1'
                        }));
                        return [2 /*return*/];
                }
    ...
    describe('MessageComposer', function () {
        ...
        it('handles template selection', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, mockTemplate;
            return __generator(this, function (_a) {
                user = user_event_1.default.setup();
                mockTemplate = mockTemplates[0];
                (0, react_2.render)(<MessageComposer_1.MessageComposer selectedTemplate={mockTemplate}/>, { wrapper: createWrapper() });
        ...
        it('handles variable replacement', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, user.type(dataInput, '15/02/2025')
        ...
        it('sends message correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, user.type(messageInput, 'Olá, como está?')
                            // Submit form
                        ];
                    case 5:
                        _a.sent();
                        sendButton = react_2.screen.getByRole('button', { name: /enviar/i });
                        return [4 /*yield*/, user.click(sendButton)
    ...
    describe('TemplateManager', function () {
        ...
        it('handles template search and filtering', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, searchInput;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        expect(mockHooks.useTemplates).toHaveBeenCalledWith(expect.objectContaining({
                            search: 'Lembrete'
                        }));
                        return [2 /*return*/];
                }
        ...
        it('opens create template dialog', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('creates new template correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        // Fill form
                        return [4 /*yield*/, user.type(react_2.screen.getByLabelText(/nome/i), 'Novo Template')];
                    case 2:
                        // Fill form
                        _a.sent();
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, user.type(react_2.screen.getByLabelText(/conteúdo/i), 'Conteúdo do template')
                            // Submit
                        ];
                    case 4:
                        _a.sent();
        ...
        it('handles template selection in selection mode', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        (0, react_2.render)(<TemplateManager_1.TemplateManager selectionMode={true} onTemplateSelect={mockOnSelect}/>, { wrapper: createWrapper() });
        ...
        it('handles template duplication', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        firstMoreButton = moreButtons.find(function (btn) { var _a; return (_a = btn.querySelector('svg')) === null || _a === void 0 ? void 0 : _a.classList.contains('lucide-more-vertical'); });
    ...
    describe('Integration', function () {
        it('integrates all components correctly in dashboard', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, user.click(react_2.screen.getByRole('tab', { name: /templates/i }))];
                    case 1:
                        // Switch to templates and back to compose
                        _a.sent();
                        expect(react_2.screen.getByText('Gerenciar Templates')).toBeInTheDocument();
                        return [4 /*yield*/, user.click(react_2.screen.getByRole('tab', { name: /compor/i }))];
                    case 2:
                        _a.sent();
                        expect(react_2.screen.getByText('Nova Mensagem')).toBeInTheDocument();
                        return [2 /*return*/];
        ...
        it('handles patient-specific mode correctly', function () {
            (0, react_2.render)(<CommunicationDashboard_1.CommunicationDashboard patientId="patient-1"/>, { wrapper: createWrapper() });
