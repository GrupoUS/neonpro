...
jest.mock('@/app/components/ui/card', function () { return ({
    Card: function (_a) {
    ...
    CardDescription: function (_a) {
        var children = _a.children, props = __rest(_a, ["children"]);
        return <div data-testid="card-description" {...props}>{children}</div>;
    },
    ...
    CardTitle: function (_a) {
        var children = _a.children, props = __rest(_a, ["children"]);
        return <div data-testid="card-title" {...props}>{children}</div>;
    },
}); });
jest.mock('@/app/components/ui/tabs', function () { return ({
    Tabs: function (_a) {
        var children = _a.children, props = __rest(_a, ["children"]);
    ...
    TabsContent: function (_a) {
        var children = _a.children, props = __rest(_a, ["children"]);
        return <div data-testid="tabs-content" {...props}>{children}</div>;
    },
...
jest.mock('@/app/components/ui/button', function () { return ({
    Button: function (_a) {
        var children = _a.children, props = __rest(_a, ["children"]);
        return <button data-testid="button" {...props}>{children}</button>;
    },
}); });
jest.mock('@/app/components/ui/badge', function () { return ({
    Badge: function (_a) {
        var children = _a.children, props = __rest(_a, ["children"]);
        return <span data-testid="badge" {...props}>{children}</span>;
    },
}); });
jest.mock('@/app/components/ui/progress', function () { return ({
    Progress: function (_a) {
        var value = _a.value, props = __rest(_a, ["value"]);
        return <div data-testid="progress" data-value={value} {...props}></div>;
    },
}); });
describe('MarketingCampaignsDashboard', function () {
    beforeEach(function () {
        jest.clearAllMocks();
    });
    describe('Rendering and Layout', function () {
        it('should render the main dashboard component', function () {
        ...
        it('should display tab navigation', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
        ...
        it('should display create campaign button', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
    ...
    describe('Tab Navigation', function () {
        it('should display overview tab content by default', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
        ...
        it('should display campaigns tab content when selected', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                ...
                                expect(react_1.screen.getByText('Manage and monitor your automated marketing campaigns')).toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should display A/B testing tab content when selected', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                ...
                                expect(react_1.screen.getByText('Optimize campaigns with statistical A/B testing')).toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should display analytics tab content when selected', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                ...
                                expect(react_1.screen.getByText('Real-time performance tracking and ROI measurement')).toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should display automation tab content when selected', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(react_1.screen.getByText('Campaign Automation Engine')).toBeInTheDocument();
                                expect(react_1.screen.getByText('≥80% automation rate with AI-driven optimization')).toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Campaign Data Display', function () {
        it('should display recent campaigns', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
        ...
        it('should display campaign status badges', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
            var badges = react_1.screen.getAllByTestId('badge');
            expect(badges.length).toBeGreaterThan(0);
        });
        it('should display campaign metrics correctly', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
    ...
    describe('AI Personalization Features', function () {
        it('should display AI personalization status', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
            expect(react_1.screen.getByText('AI Personalization')).toBeInTheDocument();
        ...
        it('should display LGPD compliance status', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
            expect(react_1.screen.getByText('LGPD Compliance: Active')).toBeInTheDocument();
        });
        it('should display personalization progress bars', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
    ...
    describe('Automation Features', function () {
        it('should display automation statistics in automation tab', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, automationTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should display automation rates above 80% threshold', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, automationTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should display quick automation setup options', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, automationTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Accessibility', function () {
        it('should have proper ARIA labels for tabs', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
            var tabsList = react_1.screen.getByTestId('tabs-list');
            expect(tabsList).toBeInTheDocument();
        });
        it('should have accessible button elements', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
    ...
    describe('Responsive Design', function () {
        it('should render without errors on different screen sizes', function () {
    ...
    describe('Story 7.2 Acceptance Criteria', function () {
        it('should meet ≥80% automation rate requirement', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
            // Check that automation rate is 89% (above 80% threshold)
            expect(react_1.screen.getByText('89%')).toBeInTheDocument();
        });
        it('should display AI-driven personalization features', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
            expect(react_1.screen.getByText('AI Personalization')).toBeInTheDocument();
            expect(react_1.screen.getByText('Content Personalization')).toBeInTheDocument();
            expect(react_1.screen.getByText('Send Time Optimization')).toBeInTheDocument();
        });
        it('should display multi-channel campaign support', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
        ...
        it('should display A/B testing framework', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, abTestingTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should display analytics and ROI tracking', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, analyticsTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should display LGPD compliance features', function () {
            (0, react_1.render)(<marketing_campaigns_dashboard_1.MarketingCampaignsDashboard />);
            expect(react_1.screen.getByText('LGPD Compliance: Active')).toBeInTheDocument();
        });
    });
