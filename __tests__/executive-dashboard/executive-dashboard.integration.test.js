    ...
    createClient: jest.fn(function () { return ({
        from: jest.fn(function (table) {
            ...
            if (table === 'executive_dashboard_metrics' || table === 'executive_dashboard_charts') {
                ...
                mockChain.order = jest.fn(function () { return Promise.resolve({
                    data: [
                        {
                            id: '1',
                            date: '2024-01-01',
                ...
                mockChain.order = jest.fn(function () { return ({
                ...
                mockChain.eq = jest.fn(function () { return ({
                    single: jest.fn(function () { return Promise.resolve({
                        data: { role: 'admin', permissions: ['executive_dashboard'] },
                        error: null
                    }); })
        ...
        auth: {
            getUser: jest.fn(function () { return Promise.resolve({
...
jest.mock('@/lib/auth/server', function () { return ({
    getCurrentUser: jest.fn(function () { return Promise.resolve({ id: 'test-user-id' }); })
}); });
jest.mock('@/lib/analytics/service', function () { return ({
    AnalyticsService: jest.fn(function () { return ({}); })
}); });
...
describe('ExecutiveDashboardService Integration', function () {
    ...
    describe('Dashboard Metrics', function () {
        it('should fetch comprehensive dashboard metrics successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var filters, result;
        ...
        it('should calculate KPIs correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        revenueKPI = kpis.find(function (kpi) { return kpi.id === 'revenue'; });
                        expect(revenueKPI).toBeDefined();
                        expect(revenueKPI === null || revenueKPI === void 0 ? void 0 : revenueKPI.format).toBe('currency');
                        expect(revenueKPI === null || revenueKPI === void 0 ? void 0 : revenueKPI.category).toBe('financial');
                        return [2 /*return*/];
                }
            });
        }); });
        it('should fetch chart data with proper structure', function () { return __awaiter(void 0, void 0, void 0, function () {
            var filters, charts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should fetch alerts with proper prioritization', function () { return __awaiter(void 0, void 0, void 0, function () {
            var filters, alerts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Period Comparison', function () {
        it('should compare metrics between two periods', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Export Functionality', function () {
        it('should generate export URLs for different formats', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Error Handling', function () {
        it('should handle authentication errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(service.getDashboardMetrics(filters))
        ...
        it('should handle insufficient permissions', function () { return __awaiter(void 0, void 0, void 0, function () {
            var service, verifyAccessSpy, filters;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        service = new executive_dashboard_1.ExecutiveDashboardService();
                        verifyAccessSpy = jest.spyOn(service, 'verifyExecutiveAccess')
                        ...
                        return [4 /*yield*/, expect(service.getDashboardMetrics(filters))
                                .rejects.toThrow('Insufficient permissions for executive dashboard')];
                    case 1:
                        _a.sent();
