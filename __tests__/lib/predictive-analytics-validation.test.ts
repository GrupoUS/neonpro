  ...
  describe('TypeScript Interfaces', () => {
    ...
    describe('DemandAlert Interface', () => {
      ...
      it('supports alert severity levels', () => {
        const severities: DemandAlert['severity'][] = [
  ...
  describe('Service Layer Functions', () => {
    ...
    describe('optimizeResourceAllocation', () => {
      ...
      it('provides staff optimization recommendations', () => {
        ...
        const staffRec = recommendations.find(r => 
          r.recommendation_type === 'resource_allocation' && 
      ...
      it('provides schedule optimization suggestions', () => {
        ...
        const scheduleRec = recommendations.find(r => 
          r.recommendation_type === 'schedule_optimization'
        );
      ...
      it('handles capacity constraints', () => {
        ...
        const capacityAlert = recommendations.find(r => 
          r.recommendation_type === 'capacity_warning'
        );
