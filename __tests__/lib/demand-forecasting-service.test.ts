...
import { DemandForecast, ForecastType, FORECASTING_CONSTANTS } from '@/src/app/types/demand-forecasting';
...
describe('DemandForecastingEngine', () => {
  ...
  describe('Forecast Generation', () => {
    test('should generate forecast with required accuracy threshold', async () => {
      ...
      expect(forecast.confidence_level).toBeGreaterThanOrEqual(FORECASTING_CONSTANTS.MIN_ACCURACY_THRESHOLD);
  ...
  describe('Accuracy Monitoring', () => {
    test('should monitor forecast accuracy against actual demand', async () => {
      ...
      expect(accuracyReport.meets_threshold).toBe(expectedAccuracy >= FORECASTING_CONSTANTS.MIN_ACCURACY_THRESHOLD);
    });
    ...
    test('should identify accuracy degradation patterns', async () => {
      ...
      expect(accuracyReport.overall_accuracy).toBeLessThan(FORECASTING_CONSTANTS.MIN_ACCURACY_THRESHOLD);
  ...
  describe('Error Handling and Edge Cases', () => {
    test('should handle empty appointment data gracefully', async () => {
      ...
      await expect(
        calculateDemandForecast([], {}, forecastParams)
