...
(0, globals_1.describe)('Treatment Prediction Validation Schemas', function () {
    (0, globals_1.describe)('PredictionModelSchema', function () {
        (0, globals_1.test)('validates model with ≥85% accuracy requirement', function () {
            ...
            if (result.success) {
                ...
                (0, globals_1.expect)((_a = result.data.performance_metrics) === null || _a === void 0 ? void 0 : _a.f1_score).toBeGreaterThanOrEqual(0.85);
            }
        });
        (0, globals_1.test)('rejects model with accuracy below 85%', function () {
            ...
            if (!result.success) {
                (0, globals_1.expect)(result.error.issues.some(function (issue) {
                    return issue.path.includes('accuracy') &&
    ...
    (0, globals_1.describe)('TreatmentPredictionSchema', function () {
        (0, globals_1.test)('validates prediction with high confidence', function () {
            ...
            if (result.success) {
                ...
                (0, globals_1.expect)(result.data.confidence_interval.lower).toBeLessThanOrEqual(result.data.confidence_interval.upper);
            }
        });
        (0, globals_1.test)('validates prediction score range', function () {
            ...
            var result = treatment_prediction_1.TreatmentPredictionSchema.safeParse(invalidScorePrediction);
            (0, globals_1.expect)(result.success).toBe(false);
        });
        (0, globals_1.test)('validates confidence interval consistency', function () {
            ...
            var result = treatment_prediction_1.TreatmentPredictionSchema.safeParse(invalidIntervalPrediction);
            (0, globals_1.expect)(result.success).toBe(false);
        });
    });
    ...
    (0, globals_1.describe)('TreatmentCharacteristicsSchema', function () {
        ...
        (0, globals_1.test)('validates cost range structure', function () {
            ...
            var result = treatment_prediction_1.TreatmentCharacteristicsSchema.safeParse(invalidCostRange);
            (0, globals_1.expect)(result.success).toBe(false);
        });
    });
    (0, globals_1.describe)('ExplainabilityDataSchema', function () {
        (0, globals_1.test)('validates explainability data structure', function () {
            ...
            (0, globals_1.expect)(result.success).toBe(true);
            if (result.success) {
                (0, globals_1.expect)(Object.keys(result.data.feature_importance).length).toBeGreaterThan(0);
        ...
        (0, globals_1.test)('validates feature importance as numbers', function () {
            ...
            var result = treatment_prediction_1.ExplainabilityDataSchema.safeParse(invalidFeatureImportance);
            (0, globals_1.expect)(result.success).toBe(false);
        });
    });
    ...
    (0, globals_1.describe)('Medical-grade Validation Requirements', function () {
        (0, globals_1.test)('enforces medical safety constraints via features', function () {
            ...
            if (result.success) {
                var hasContraindications = ((_a = result.data.medical_conditions) === null || _a === void 0 ? void 0 : _a.includes('pregnancy')) ||
                    ((_b = result.data.medications) === null || _b === void 0 ? void 0 : _b.includes('anticoagulants')) ||
                    ((_c = result.data.allergies) === null || _c === void 0 ? void 0 : _c.includes('lidocaine'));
