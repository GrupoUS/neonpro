...
describe('Predictive Analytics Types and Validations', function () {
    describe('TypeScript Interfaces', function () {
        describe('ForecastingModel Interface', function () {
            ...
            it('enforces required fields', function () {
                ...
                expect(function () {
                    ...
                    var requiredFields = [
                        'id', 'model_type', 'model_name', 'accuracy_score',
        ...
        describe('DemandPrediction Interface', function () {
            it('accepts valid prediction data with confidence intervals', function () {
                ...
                expect(validPrediction.confidence_interval_lower).toBeLessThan(validPrediction.forecast_value);
                expect(validPrediction.confidence_interval_upper).toBeGreaterThan(validPrediction.forecast_value);
            });
            ...
            it('supports multiple prediction categories', function () {
                var categories = [
                    'appointments', 'treatments', 'revenue', 'resources'
                ];
        ...
        describe('DemandAlert Interface', function () {
            ...
            it('supports different alert types', function () {
                var alertTypes = [
                    'demand_spike', 'demand_drop', 'resource_shortage', 'capacity_exceeded'
                ];
    ...
    describe('Zod Schema Validations', function () {
        describe('ForecastingModel Schema', function () {
            it('validates valid forecasting model', function () {
                ...
                if (result.success) {
                    expect(result.data.accuracy_score).toBe(0.8750);
    ...
    describe('Service Layer Functions', function () {
        describe('generateDemandPrediction', function () {
            ...
            it('generates prediction with confidence intervals', function () {
                var prediction = (0, predictive_analytics_2.generateDemandPrediction)(mockHistoricalData, '2025-01-06', 'daily');
            ...
            it('handles different forecast periods', function () {
                ...
                periods.forEach(function (period) {
                    var prediction = (0, predictive_analytics_2.generateDemandPrediction)(mockHistoricalData, '2025-01-06', period);
                    expect(prediction.forecast_period).toBe(period);
            ...
            it('adapts to seasonal patterns', function () {
                ...
                var prediction = (0, predictive_analytics_2.generateDemandPrediction)(seasonalData, '2025-01-16', 'daily');
            ...
            it('provides higher confidence for stable patterns', function () {
                ...
                var prediction = (0, predictive_analytics_2.generateDemandPrediction)(stableData, '2025-01-06', 'daily');
        ...
        describe('calculateAccuracyMetrics', function () {
            ...
            it('calculates accuracy score', function () {
                var metrics = (0, predictive_analytics_2.calculateAccuracyMetrics)(mockActualValues, mockPredictedValues);
            ...
            it('identifies when accuracy meets threshold', function () {
                ...
                var metrics = (0, predictive_analytics_2.calculateAccuracyMetrics)(mockActualValues, perfectPredictions);
        ...
        describe('createDemandAlert', function () {
            it('creates spike alert for significant increases', function () {
                ...
                var alert = (0, predictive_analytics_2.createDemandAlert)(currentDemand, predictedDemand, 'appointments', 0.9);
            ...
            it('adjusts severity based on magnitude', function () {
                ...
                scenarios.forEach(function (scenario) {
                    var alert = (0, predictive_analytics_2.createDemandAlert)(scenario.current, scenario.predicted, 'appointments', 0.9);
        ...
        describe('optimizeResourceAllocation', function () {
            ...
            it('provides staff optimization recommendations', function () {
                var recommendations = (0, predictive_analytics_2.optimizeResourceAllocation)(mockDemandForecast, mockCurrentResources);
                expect(recommendations).toBeInstanceOf(Array);
                expect(recommendations.length).toBeGreaterThan(0);
                var staffRec = recommendations.find(function (r) {
                    return r.recommendation_type === 'resource_allocation' &&
                        r.metadata.resource_type === 'staff';
                });
            ...
            it('considers confidence scores in recommendations', function () {
                var highConfidenceForecast = mockDemandForecast.map(function (f) { return (__assign(__assign({}, f), { confidence_score: 0.95 })); });
                var recommendations = (0, predictive_analytics_2.optimizeResourceAllocation)(highConfidenceForecast, mockCurrentResources);
            ...
            it('handles capacity constraints', function () {
                ...
                var recommendations = (0, predictive_analytics_2.optimizeResourceAllocation)(highDemandForecast, mockCurrentResources);
    ...
    describe('PredictiveAnalyticsService Class', function () {
        ...
        describe('Model Management', function () {
            it('creates forecasting model with validation', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            createSpy.mockResolvedValue(__assign(__assign({ id: 'model-123' }, modelData), { accuracy_score: 0.85, status: 'training', created_at: '2025-01-26T09:00:00Z', updated_at: '2025-01-26T09:00:00Z' }));
            ...
            it('validates model accuracy threshold', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('activates models only when accuracy ≥85%', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        describe('Prediction Generation', function () {
            it('generates predictions with confidence intervals', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            generateSpy.mockResolvedValue(__assign(__assign({ id: 'pred-123' }, predictionRequest), { forecast_value: 45.5, confidence_interval_lower: 40.2, confidence_interval_upper: 50.8, confidence_score: 0.89, created_at: '2025-01-26T09:00:00Z' }));
            ...
            it('supports multi-dimensional forecasting', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, service.generatePrediction({
                                    model_id: 'model-123',
                                    prediction_date: '2025-02-01',
                                    forecast_period: 'daily',
                                    category: category,
                        ...
                        case 4:
                            ...
                            expect(predictions.map(function (p) { return p.category; })).toEqual(categories);
                            generateSpy.mockRestore();
                            return [2 /*return*/];
                    }
                });
        ...
        describe('Alert System', function () {
            it('creates demand spike alerts', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            createSpy.mockResolvedValue(__assign(__assign({ id: 'alert-123' }, alertData), { notification_sent: false, acknowledged: false, resolution_status: 'open', alert_date: '2025-01-26T09:00:00Z', created_at: '2025-01-26T09:00:00Z' }));
            ...
            it('manages alert acknowledgment workflow', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        describe('Performance Monitoring', function () {
            it('tracks accuracy metrics over time', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('identifies models needing retraining', function () { return __awaiter(void 0, void 0, void 0, function () {
