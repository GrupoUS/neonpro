        ...
        select: globals_1.jest.fn(function () { return ({
            ...
            neq: globals_1.jest.fn(function () { return ({
                order: globals_1.jest.fn(function () { return ({
                    limit: globals_1.jest.fn(function () { return ({
                        single: globals_1.jest.fn()
                    }); })
                }); })
            }); })
...
var mockCreateClient = globals_1.jest.fn(function () { return mockSupabase; });
...
(0, globals_1.describe)('SchedulingCommunicationWorkflow', function () {
    ...
    (0, globals_1.describe)('initializeWorkflows', function () {
        (0, globals_1.it)('should create reminder workflows based on configuration', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockPredictor, mockPredictorModule, config, workflows, reminderWorkflows, reminder24h, confirmationWorkflow;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        reminder24h = reminderWorkflows.find(function (w) { return w.metadata.timing === '24h'; });
                        (0, globals_1.expect)(reminder24h).toBeDefined();
                        (0, globals_1.expect)(reminder24h === null || reminder24h === void 0 ? void 0 : reminder24h.steps).toHaveLength(2); // send + wait
                        (0, globals_1.expect)(reminder24h === null || reminder24h === void 0 ? void 0 : reminder24h.scheduledAt).toBeInstanceOf(Date);
                        ...
                        (0, globals_1.expect)(confirmationWorkflow === null || confirmationWorkflow === void 0 ? void 0 : confirmationWorkflow.steps).toHaveLength(3); // predict + send + wait
                        (0, globals_1.expect)(confirmationWorkflow === null || confirmationWorkflow === void 0 ? void 0 : confirmationWorkflow.metadata.confirmationToken).toBeDefined();
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should create no-show prevention workflow for high-risk appointments', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        workflows = _a.sent();
                        noShowWorkflow = workflows.find(function (w) { return w.workflowType === 'no_show_prevention'; });
                        (0, globals_1.expect)(noShowWorkflow).toBeDefined();
                        (0, globals_1.expect)(noShowWorkflow === null || noShowWorkflow === void 0 ? void 0 : noShowWorkflow.steps).toHaveLength(3); // send + wait + escalate
                        (0, globals_1.expect)(noShowWorkflow === null || noShowWorkflow === void 0 ? void 0 : noShowWorkflow.metadata.noShowPrediction.probability).toBe(0.8);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should skip workflows for past appointments', function () { return __awaiter(void 0, void 0, void 0, function () {
            var pastAppointment, config, workflows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pastAppointment = __assign(__assign({}, mockAppointment), { date: '2023-01-15T10:00:00Z' // Past date
                         });
                        mockSupabase.from.mockImplementation(function (table) {
                            if (table === 'appointments') {
                                return {
        ...
        (0, globals_1.it)('should return empty array when workflows disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            var workflows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('executeWorkflow', function () {
        (0, globals_1.it)('should execute workflow steps in sequence', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockWorkflow, mockCommunicationService, mockCommModule, mockTemplate, mockTemplateEngine, mockTemplateModule, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockWorkflow = {
                        ...
                        mockTemplateEngine = {
                            ...
                            renderTemplate: globals_1.jest.fn().mockResolvedValue('Lembrete: Sua consulta é amanhã às 10:00')
                        };
        ...
        (0, globals_1.it)('should handle workflow not found', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, globals_1.expect)(workflow.executeWorkflow('nonexistent-workflow'))
