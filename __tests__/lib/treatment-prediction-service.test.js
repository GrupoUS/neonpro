...
globals_1.jest.mock('@/app/utils/supabase/server', function () { return ({
    createServerClient: function () { return mockSupabaseClient; },
    createClient: function () { return mockSupabaseClient; }
}); });
...
(0, globals_1.describe)('TreatmentPredictionService', function () {
    ...
    (0, globals_1.describe)('Model Management', function () {
        (0, globals_1.test)('creates prediction model with ≥85% accuracy requirement', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        mockResponse = __assign(__assign({}, mockModel), { id: 'model-123', created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
                        mockSupabaseClient.insert.mockResolvedValue({ data: mockResponse, error: null });
                        return [4 /*yield*/, service.createModel(mockModel)];
                    case 1:
                        result = _b.sent();
                        (0, globals_1.expect)(mockSupabaseClient.from).toHaveBeenCalledWith('prediction_models');
                        ...
                        (0, globals_1.expect)((_a = result.performance_metrics) === null || _a === void 0 ? void 0 : _a.f1_score).toBeGreaterThanOrEqual(0.85);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('validates accuracy threshold enforcement', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, globals_1.expect)(service.createModel(lowAccuracyModel)).rejects.toThrow()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        (0, globals_1.test)('retrieves active models with high accuracy', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        (0, globals_1.expect)(mockSupabaseClient.from).toHaveBeenCalledWith('prediction_models');
                        (0, globals_1.expect)(result.every(function (model) { return model.accuracy >= 0.85; })).toBe(true);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Treatment Prediction Generation', function () {
        (0, globals_1.test)('generates prediction with multi-factor analysis', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        (0, globals_1.expect)(mockSupabaseClient.from).toHaveBeenCalledWith('treatment_predictions');
                        ...
                        (0, globals_1.expect)(result.confidence_interval.lower).toBeLessThanOrEqual(result.confidence_interval.upper);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('processes real-time scoring with performance monitoring', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        mockSupabaseClient.insert.mockResolvedValue({ data: mockResponse, error: null });
                        return [4 /*yield*/, service.createPrediction({
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)((_a = result.explainability_data) === null || _a === void 0 ? void 0 : _a.confidence_reasoning).toBeTruthy();
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Historical Validation', function () {
        (0, globals_1.test)('tracks model performance over time', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(result.correct_predictions / result.total_predictions).toBeCloseTo(result.accuracy, 2);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('validates historical prediction accuracy', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockPredictions, result, highAccuracyPredictions, successfulHighAccuracy, historicalAccuracy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockPredictions = [
                    ...
                    case 1:
                        result = _a.sent();
                        highAccuracyPredictions = result.filter(function (p) { return p.prediction_score >= 0.85; });
    ...
    (0, globals_1.describe)('Medical-grade Validation', function () {
        (0, globals_1.test)('enforces medical safety constraints', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('validates treatment suitability based on medical history', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)((_a = result.medical_history) === null || _a === void 0 ? void 0 : _a.allergies).toEqual([]);
                        (0, globals_1.expect)((_b = result.medical_history) === null || _b === void 0 ? void 0 : _b.medications).toEqual([]);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Explainability Features', function () {
        (0, globals_1.test)('provides detailed feature importance analysis', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(Object.keys(result.feature_importance).length).toBeGreaterThan(5);
                        ...
                        totalImportance = Object.values(result.feature_importance).reduce(function (sum, val) { return sum + val; }, 0);
                        (0, globals_1.expect)(totalImportance).toBeCloseTo(1.0, 1);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('provides human-readable explanations', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('Performance Monitoring', function () {
        (0, globals_1.test)('monitors service response times', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('tracks prediction accuracy metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
            var metrics;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, service.calculateAccuracyMetrics('model-123')];
                    case 1:
                        metrics = _a.sent();
                        ...
                        (0, globals_1.expect)(metrics.successful_predictions).toBeLessThanOrEqual(metrics.predictions_count);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Error Handling', function () {
        (0, globals_1.test)('handles database errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, globals_1.expect)(service.createModel({
                                name: 'Test Model',
                                version: '1.0.0',
                                algorithm_type: 'ensemble',
                                accuracy: 0.89,
        ...
        (0, globals_1.test)('validates input parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, globals_1.expect)(service.createPrediction({
