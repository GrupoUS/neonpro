...
(0, globals_1.describe)('Stock Alert Config Schema Validation', function () {
    (0, globals_1.describe)('stockAlertConfigSchema', function () {
        ...
        (0, globals_1.it)('should reject negative threshold values', function () {
            ...
            (0, globals_1.expect)(result.success).toBe(false);
            if (!result.success) {
                (0, globals_1.expect)(result.error.issues[0].message).toContain('Must be a positive number');
            }
        });
        ...
        (0, globals_1.it)('should reject empty notification channels array', function () {
            ...
            (0, globals_1.expect)(result.success).toBe(false);
            if (!result.success) {
                (0, globals_1.expect)(result.error.issues[0].message).toContain('At least one notification channel required');
            }
        });
        (0, globals_1.it)('should validate config with category instead of product', function () {
            var categoryConfig = __assign(__assign({}, validAlertConfig), { productId: undefined, categoryId: 'cat123e45-e89b-12d3-a456-426614174000' });
        ...
        (0, globals_1.it)('should validate global config (no product or category)', function () {
            var globalConfig = __assign(__assign({}, validAlertConfig), { productId: undefined, categoryId: undefined });
...
(0, globals_1.describe)('Stock Alert Schema Validation', function () {
    (0, globals_1.describe)('stockAlertSchema', function () {
        ...
        (0, globals_1.it)('should reject empty or too long messages', function () {
            ...
            (0, globals_1.expect)(stock_alerts_1.stockAlertSchema.safeParse(emptyMessage).success).toBe(false);
            (0, globals_1.expect)(stock_alerts_1.stockAlertSchema.safeParse(longMessage).success).toBe(false);
        });
        (0, globals_1.it)('should validate acknowledgment constraint', function () {
            // Valid: both acknowledgedBy and acknowledgedAt present
            var validAck = __assign(__assign({}, validAlert), { acknowledgedBy: 'user123', acknowledgedAt: new Date() });
            ...
            (0, globals_1.expect)(result.success).toBe(false);
            if (!result.success) {
                (0, globals_1.expect)(result.error.issues[0].message).toContain('Both acknowledgedBy and acknowledgedAt must be provided');
            }
        });
    });
    (0, globals_1.describe)('acknowledgeAlertSchema', function () {
        ...
        (0, globals_1.it)('should trim and validate note length', function () {
            var longNote = __assign(__assign({}, validAcknowledgeAlert), { note: ' ' + 'a'.repeat(501) + ' ' });
        ...
        (0, globals_1.it)('should allow acknowledgment without note', function () {
            var note = validAcknowledgeAlert.note, ackWithoutNote = __rest(validAcknowledgeAlert, ["note"]);
    ...
    (0, globals_1.describe)('resolveAlertSchema', function () {
        ...
        (0, globals_1.it)('should require resolution description', function () {
            ...
            (0, globals_1.expect)(result.success).toBe(false);
            if (!result.success) {
                (0, globals_1.expect)(result.error.issues[0].message).toContain('Resolution description required');
            }
        });
        (0, globals_1.it)('should reject overly long resolution description', function () {
            var longResolution = __assign(__assign({}, validResolveAlert), { resolution: 'a'.repeat(1001) });
...
(0, globals_1.describe)('Custom Stock Reports Schema Validation', function () {
    ...
    (0, globals_1.it)('should trim report names', function () {
        var reportWithSpaces = __assign(__assign({}, validReport), { reportName: '  Trimmed Report  ' });
    ...
    (0, globals_1.it)('should validate date range constraint', function () {
        var invalidDateRange = __assign(__assign({}, validReport), { filters: {
                dateRange: {
        ...
        (0, globals_1.expect)(result.success).toBe(false);
        if (!result.success) {
            (0, globals_1.expect)(result.error.issues[0].message).toContain('Start date must be before or equal to end date');
        }
    });
    ...
    (0, globals_1.it)('should reject invalid time format in schedule', function () {
        ...
        var reportWithInvalidSchedule = __assign(__assign({}, validReport), { scheduleConfig: invalidSchedule });
...
(0, globals_1.describe)('Stock Dashboard Data Schema Validation', function () {
    ...
    (0, globals_1.it)('should apply default values for lastUpdated', function () {
        var lastUpdated = validDashboardData.lastUpdated, dataWithoutLastUpdated = __rest(validDashboardData, ["lastUpdated"]);
...
(0, globals_1.describe)('Validation Functions', function () {
    (0, globals_1.describe)('validateStockAlertConfig', function () {
        (0, globals_1.it)('should validate valid config', function () {
            (0, globals_1.expect)(function () { return (0, stock_alerts_1.validateStockAlertConfig)(validAlertConfig); }).not.toThrow();
        });
        (0, globals_1.it)('should throw on invalid config', function () {
            ...
            (0, globals_1.expect)(function () { return (0, stock_alerts_1.validateStockAlertConfig)(invalidConfig); }).toThrow();
        });
    });
    (0, globals_1.describe)('validateCreateStockAlertConfig', function () {
        (0, globals_1.it)('should validate valid create config', function () {
            (0, globals_1.expect)(function () { return (0, stock_alerts_1.validateCreateStockAlertConfig)(validCreateAlertConfig); }).not.toThrow();
        });
        (0, globals_1.it)('should throw on invalid create config', function () {
            ...
            (0, globals_1.expect)(function () { return (0, stock_alerts_1.validateCreateStockAlertConfig)(invalidConfig); }).toThrow();
        });
    });
    (0, globals_1.describe)('validateAcknowledgeAlert', function () {
        (0, globals_1.it)('should validate valid acknowledge request', function () {
            (0, globals_1.expect)(function () { return (0, stock_alerts_1.validateAcknowledgeAlert)(validAcknowledgeAlert); }).not.toThrow();
        });
        (0, globals_1.it)('should throw on invalid acknowledge request', function () {
            ...
            (0, globals_1.expect)(function () { return (0, stock_alerts_1.validateAcknowledgeAlert)(invalidAck); }).toThrow();
        });
    });
    (0, globals_1.describe)('validateResolveAlert', function () {
        (0, globals_1.it)('should validate valid resolve request', function () {
            (0, globals_1.expect)(function () { return (0, stock_alerts_1.validateResolveAlert)(validResolveAlert); }).not.toThrow();
        });
        (0, globals_1.it)('should throw on invalid resolve request', function () {
            var invalidResolve = __assign(__assign({}, validResolveAlert), { resolution: '' });
            (0, globals_1.expect)(function () { return (0, stock_alerts_1.validateResolveAlert)(invalidResolve); }).toThrow();
        });
    });
});
// =====================================================
...
(0, globals_1.describe)('Edge Cases and Security', function () {
    (0, globals_1.it)('should handle extremely large numbers appropriately', function () {
        var configWithLargeNumber = __assign(__assign({}, validCreateAlertConfig), { thresholdValue: Number.MAX_SAFE_INTEGER });
    ...
    (0, globals_1.it)('should handle array validation correctly', function () {
        var configWithInvalidChannels = __assign(__assign({}, validCreateAlertConfig), { notificationChannels: ['invalid_channel'] });
...
(0, globals_1.describe)('Performance and Scalability', function () {
    (0, globals_1.it)('should handle large arrays efficiently', function () {
        var largeArray = Array(1000).fill(0).map(function (_, i) { return ({
            date: new Date().toISOString(),
            value: i,
            trend: 'stable'
        }); });
