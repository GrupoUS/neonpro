        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, demand_forecasting_1.calculateDemandForecast)(
                  mockAppointmentData,
                  mockHistoricalData,
                  forecastParams,
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, demand_forecasting_1.generateResourceAllocation)([forecast], "balanced"),
              ];
            case 1:
              allocation = _a.sent();
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                (0, demand_forecasting_1.generateResourceAllocation)([forecast], strategy),
              ];
            case 2:
              allocation = _a.sent();
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, demand_forecasting_1.monitorForecastAccuracy)(forecasts, actualDemand),
              ];
            case 1:
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, demand_forecasting_1.monitorForecastAccuracy)(degradingForecasts, actualDemand),
              ];
            case 1:
              accuracyReport = _a.sent();
          ...
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                expect(
                  (0, demand_forecasting_1.calculateDemandForecast)([], {}, forecastParams),
                ).rejects.toThrow("Insufficient data for forecast generation"),
              ];
            case 1:
              _a.sent();
              return [2 /*return*/];
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, demand_forecasting_1.generateResourceAllocation)(
                  [zeroDemandForecast],
                  "balanced",
                ),
              ];
        ...
        return __generator(this, (_b) => {
          switch (_b.label) {
            ...
            case 1:
              ...
              expect(
                (_a = forecast.metadata) === null || _a === void 0
                  ? void 0
                  : _a.computation_time_ms,
              ).toBeLessThan(3000);
              return [2 /*return*/];
          }
        });
