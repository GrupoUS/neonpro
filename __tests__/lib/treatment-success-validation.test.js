...
describe('TreatmentSuccessService', function () {
    ...
    describe('getTreatmentOutcomes', function () {
        it('should fetch treatment outcomes with filters', function () { return __awaiter(void 0, void 0, void 0, function () {
            var filters, result;
        ...
        it('should handle date range filters', function () { return __awaiter(void 0, void 0, void 0, function () {
            var filters;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should handle complications filter', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockSupabaseClient.select.mockReturnValue(__assign(__assign({}, mockSupabaseClient), { range: jest.fn().mockReturnValue(__assign(__assign({}, mockSupabaseClient), { order: jest.fn().mockResolvedValue({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(service.getTreatmentOutcomes()).rejects.toThrow('Erro ao buscar resultados de tratamento')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('generateSuccessMetrics', function () {
        it('should calculate and generate success metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabaseClient.select.mockReturnValue(__assign(__assign({}, mockSupabaseClient), { eq: jest.fn().mockReturnValue(__assign(__assign({}, mockSupabaseClient), { gte: jest.fn().mockReturnValue(__assign(__assign({}, mockSupabaseClient), { lte: jest.fn().mockResolvedValue({
                                        data: mockOutcomes,
                                        error: null,
                                    }) })) })) }));
                        mockSupabaseClient.upsert.mockReturnValue(__assign(__assign({}, mockSupabaseClient), { select: jest.fn().mockReturnValue(__assign(__assign({}, mockSupabaseClient), { single: jest.fn().mockResolvedValue({
    ...
    describe('createSuccessPrediction', function () {
        it('should create success prediction with calculated rate', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabaseClient.select.mockReturnValue(__assign(__assign({}, mockSupabaseClient), { eq: jest.fn().mockReturnValue(__assign(__assign({}, mockSupabaseClient), { not: jest.fn().mockResolvedValue({
                    ...
                    case 1:
                        ...
                        expect(mockSupabaseClient.insert).toHaveBeenCalledWith(expect.objectContaining(__assign(__assign({}, predictionData), { predicted_success_rate: 0.85 })));
                        return [2 /*return*/];
                }
            });
        }); });
        it('should use default success rate when no historical data', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Dashboard Statistics', function () {
        it('should calculate success rate statistics', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should calculate provider statistics', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabaseClient.select.mockReturnValue(__assign(__assign({}, mockSupabaseClient), { not: jest.fn().mockReturnValue(__assign(__assign({}, mockSupabaseClient), { order: jest.fn().mockResolvedValue({
