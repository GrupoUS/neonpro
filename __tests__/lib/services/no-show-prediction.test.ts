...
describe('NoShowPredictionEngine', () => {
  let mockSupabase: any;  beforeEach(() => {
    jest.clearAllMocks();
  ...
  describe('updatePredictionOutcome', () => {
    it('should update prediction with actual outcome', async () => {
      ...
      const result = await noShowPredictionEngine.updatePredictionOutcome(
        'prediction-123',
        true
      );
  ...
  describe('generateInterventionRecommendations', () => {
    it('should recommend appropriate interventions based on risk score', async () => {
      ...
      const recommendations = await noShowPredictionEngine.generateInterventionRecommendations(
        highRiskPrediction
      );
