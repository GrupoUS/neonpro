...
describe('NoShowPredictionEngine', function () {
    ...
    describe('generatePrediction', function () {
        it('should generate prediction for valid appointment', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.generatePrediction('appointment-123')];
                    case 1:
                        result = _a.sent();
        ...
        it('should handle missing appointment', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockSupabase.single.mockResolvedValueOnce({
                        ...
                        return [4 /*yield*/, expect(no_show_prediction_1.noShowPredictionEngine.generatePrediction('invalid-appointment')).rejects.toThrow('Appointment not found')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('analyzeRiskFactors', function () {
        it('should analyze patient risk factors correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            var riskFactors;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.analyzeRiskFactors('patient-123', mockAppointment)];
                    case 1:
                        riskFactors = _a.sent();
        ...
        it('should handle patient with no history', function () { return __awaiter(void 0, void 0, void 0, function () {
            var riskFactors;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.analyzeRiskFactors('new-patient', mockAppointment)];
                    case 1:
                        riskFactors = _a.sent();
                        expect(riskFactors).toBeDefined();
                        expect(Array.isArray(riskFactors)).toBe(true);
    ...
    describe('updatePredictionOutcome', function () {
        it('should update prediction with actual outcome', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.updatePredictionOutcome('prediction-123', true)];
                    case 1:
                        result = _a.sent();
                        expect(result).toBeDefined();
    ...
    describe('calculateAccuracyMetrics', function () {
        it('should calculate accuracy metrics correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.calculateAccuracyMetrics('clinic-123', '2024-01-01', '2024-01-31')];
                    case 1:
                        metrics = _a.sent();
    ...
    describe('getHighRiskPatients', function () {
        it('should return high-risk patients for given date range', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.getHighRiskPatients('clinic-123', '2024-02-15', '2024-02-16')];
                    case 1:
                        result = _a.sent();
                        expect(result).toBeDefined();
    ...
    describe('generateInterventionRecommendations', function () {
        it('should recommend appropriate interventions based on risk score', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.generateInterventionRecommendations(highRiskPrediction)];
                    case 1:
        ...
        it('should recommend fewer interventions for medium risk', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.generateInterventionRecommendations(mediumRiskPrediction)];
                    case 1:
                        recommendations = _a.sent();
                        expect(recommendations).toBeDefined();
                        expect(Array.isArray(recommendations)).toBe(true);
