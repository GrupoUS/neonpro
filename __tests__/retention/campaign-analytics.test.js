...
describe('/api/retention-analytics/campaigns/analytics', function () {
    ...
    describe('GET - Campaign Analytics', function () {
        it('should return campaign analytics with performance metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should filter analytics by campaign IDs', function () { return __awaiter(void 0, void 0, void 0, function () {
            var campaignIds, _a, req, res, responseData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        campaignIds = '11111111-1111-1111-1111-111111111111,55555555-5555-5555-5555-555555555555';
                        _a = (0, node_mocks_http_1.createMocks)({
                            method: 'GET',
                            url: "/api/retention-analytics/campaigns/analytics?clinic_id=22222222-2222-2222-2222-222222222222&campaign_ids=".concat(campaignIds),
                        }), req = _a.req, res = _a.res;
                        return [4 /*yield*/, (0, route_1.GET)(req)];
                    case 1:
                        _b.sent();
                        ...
                        expect(responseData.data.analytics.every(function (a) {
        ...
        it('should group analytics by intervention type', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, req, res, responseData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        it('should include industry benchmarks when comparison is requested', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, req, res, responseData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        it('should filter analytics by date range', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = (0, node_mocks_http_1.createMocks)({
                            method: 'GET',
                            url: "/api/retention-analytics/campaigns/analytics?clinic_id=22222222-2222-2222-2222-222222222222&start_date=".concat(startDate, "&end_date=").concat(endDate),
                        }), req = _a.req, res = _a.res;
                        return [4 /*yield*/, (0, route_1.GET)(req)];
                    case 1:
                        _b.sent();
        ...
        it('should validate required clinic_id parameter', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, req, res, responseData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        it('should calculate correct performance metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('POST - A/B Test Results', function () {
        it('should generate A/B test results for enabled campaigns', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should calculate statistical significance correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should provide actionable recommendations', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should handle campaigns without A/B testing enabled', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        mockSupabase.from().select().eq().single.mockReturnValueOnce({
                            data: __assign(__assign({}, mockCampaigns[1]), { measurement_criteria: __assign(__assign({}, mockCampaigns[1].measurement_criteria), { abtest_enabled: false }) }),
                            error: null
                        });
                        abTestData = {
        ...
        it('should validate campaign existence', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockSupabase, abTestData, _a, req, res, responseData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    describe('Analytics Edge Cases', function () {
        it('should handle campaigns with zero metrics gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        mockSupabase.from().select().eq().order.mockReturnValueOnce({
                            data: [__assign(__assign({}, mockCampaigns[0]), { campaign_metrics: [{
        ...
        it('should calculate aggregated metrics correctly for grouped analytics', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should handle missing campaign metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        mockSupabase = require('@/app/utils/supabase/server').createClient();
                        mockSupabase.from().select().eq().order.mockReturnValueOnce({
                            data: [__assign(__assign({}, mockCampaigns[0]), { campaign_metrics: [], executions: [] })],
                            error: null
                        });
                        _a = (0, node_mocks_http_1.createMocks)({
                            method: 'GET',
