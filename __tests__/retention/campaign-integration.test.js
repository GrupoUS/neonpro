        ...
        from: jest.fn(function () { return ({
            select: jest.fn(function () { return ({
                ...
                update: jest.fn(function () { return ({
                    eq: jest.fn(function () { return ({
                        select: jest.fn(function () { return ({
                            data: [__assign(__assign({}, mockCampaigns[0]), { name: 'Updated Campaign' })],
                            error: null,
                        }); })
                    }); })
                }); }),
...
describe('/api/retention-analytics/campaigns', function () {
    ...
    describe('GET - List campaigns', function () {
        it('should return campaigns for a clinic', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should filter campaigns by status', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, req, res, responseData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        _b.sent();
                        responseData = JSON.parse(res._getData());
                        expect(responseData.data.campaigns.every(function (c) { return c.status === 'active'; })).toBe(true);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should return 400 for invalid clinic_id', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, req, res, responseData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    describe('POST - Create campaign', function () {
        it('should create a new retention campaign', function () { return __awaiter(void 0, void 0, void 0, function () {
...
describe('/api/retention-analytics/campaigns/[id]', function () {
    describe('PUT - Execute campaign', function () {
        it('should execute a retention campaign', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, route_2.PUT)(req, { params: { id: '11111111-1111-1111-1111-111111111111' } })];
                    case 1:
                        _b.sent();
                        expect(res._getStatusCode()).toBe(200);
                        responseData = JSON.parse(res._getData());
        ...
        it('should handle test mode execution', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('GET - Get campaign by ID', function () {
        it('should return campaign details with metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, req, res, responseData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, route_2.GET)(req, { params: { id: '11111111-1111-1111-1111-111111111111' } })];
                    case 1:
                        _b.sent();
                        expect(res._getStatusCode()).toBe(200);
                        responseData = JSON.parse(res._getData());
        ...
        it('should return 404 for non-existent campaign', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, route_2.GET)(req, { params: { id: '99999999-9999-9999-9999-999999999999' } })];
                    case 1:
                        _b.sent();
