...
global.Date = jest.fn(() => new originalDate("2025-01-24T10:00:00.000Z"));
...
var MockNextResponse = /** @class */ (() => {
  ...
  MockNextResponse.redirect = (url, status) => {
    if (status === void 0) {
      status = 302;
    }
    return new MockNextResponse(null, { status: status, headers: { location: url } });
  };
  MockNextResponse.rewrite = (_url) => new MockNextResponse(null, { status: 200 });
