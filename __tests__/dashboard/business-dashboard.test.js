...
var mockDashboardData = {
    ...
    comparison: {
        ...
        conversion: { current: 0.2875, previous: 0.3150, change: -8.7 }
    }
};
// Mock the business dashboard component since we need to check if it exists first
var MockBusinessDashboard = function () {
    return (<div data-testid="business-dashboard" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
...
describe('Business Dashboard - Story 8.1', function () {
    ...
    beforeEach(function () {
        ...
        global.fetch.mockResolvedValue({
            ok: true,
            json: function () { return Promise.resolve(mockDashboardData); },
        ...
        Object.defineProperty(window, 'localStorage', {
            value: {
                ...
                setItem: jest.fn(function () { return null; }),
                removeItem: jest.fn(function () { return null; }),
            },
            writable: true,
        });
    });
    ...
    describe('Loading Performance (<1s)', function () {
        it('should load initial state quickly', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should render core KPIs within performance budget', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderBusinessDashboard();
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                ...
                                expect(react_2.screen.getAllByText(/taxa de conversão/i)[0]).toBeInTheDocument();
    ...
    describe('KPI Display', function () {
        it('should display comprehensive KPIs correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderBusinessDashboard();
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                ...
                                // New Patients KPI
                                expect(react_2.screen.getByTestId('novos-pacientes-count')).toHaveTextContent('120');
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should show KPI trends and comparisons', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderBusinessDashboard();
    ...
    describe('Interactive Charts', function () {
        it('should render revenue chart with data', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderBusinessDashboard();
        ...
        it('should render conversion funnel', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderBusinessDashboard();
        ...
        it('should render procedure distribution chart', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderBusinessDashboard();
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                ...
                                expect(react_2.screen.getByText('Distribuição de Procedimentos')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Mobile Responsiveness', function () {
        ...
        it('should stack charts vertically on mobile', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderBusinessDashboard();
    ...
    describe('Customizable Layout', function () {
        it('should allow chart type switching', function () { return __awaiter(void 0, void 0, void 0, function () {
            var chartToggle;
            return __generator(this, function (_a) {
                renderBusinessDashboard();
        ...
        it('should persist layout preferences', function () { return __awaiter(void 0, void 0, void 0, function () {
            var layoutButton;
            return __generator(this, function (_a) {
                renderBusinessDashboard();
    ...
    describe('Alerts System', function () {
        it('should display business alerts', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderBusinessDashboard();
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                ...
                                expect(react_2.screen.getByText(/taxa de conversão está 5% abaixo/i)).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should allow alert dismissal', function () { return __awaiter(void 0, void 0, void 0, function () {
            var dismissButton;
            return __generator(this, function (_a) {
                renderBusinessDashboard();
    ...
    describe('Data Export', function () {
        it('should export dashboard data', function () { return __awaiter(void 0, void 0, void 0, function () {
            var exportButton;
            return __generator(this, function (_a) {
                renderBusinessDashboard();
    ...
    describe('Historical Comparison', function () {
        it('should show period comparison', function () { return __awaiter(void 0, void 0, void 0, function () {
            var periodSelect;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should display trend indicators', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderBusinessDashboard();
    ...
    describe('Performance Monitoring', function () {
        it('should track load times', function () { return __awaiter(void 0, void 0, void 0, function () {
            var startTime, loadTime;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
