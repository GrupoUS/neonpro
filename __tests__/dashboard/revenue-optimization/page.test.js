    ...
    test("should render dashboard layout and title", () =>
      __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, (_a) => {
          ...
          expect(
            react_2.screen.getByText(/Maximize revenue through intelligent optimization/),
          ).toBeInTheDocument();
          return [2 /*return*/];
        });
      }));
            ...
            case 0:
              ...
              return [
                ...
                (0, react_2.waitFor)(() => {
                  ...
                  expect(
                    react_2.screen.getByRole("button", { name: /Generate Report/i }),
                  ).toBeInTheDocument();
                  expect(
                    react_2.screen.getByRole("button", { name: /Export Data/i }),
                  ).toBeInTheDocument();
                }),
              ];
            case 1:
              ...
              return [
                ...
                (0, react_2.waitFor)(() => {
                  ...
                  expect(sonner_1.toast.success).toHaveBeenCalledWith(
                    "Pricing optimization created successfully!",
                  );
                }),
              ];
            case 2:
            ...
            case 1:
              ...
              return [
                ...
                (0, react_2.waitFor)(() => {
                  ...
                  expect(sonner_1.toast.success).toHaveBeenCalledWith(
                    "Service mix optimization created successfully!",
                  );
                }),
              ];
            case 2:
            ...
            case 1:
              ...
              return [
                ...
                (0, react_2.waitFor)(() => {
                  ...
                  expect(sonner_1.toast.success).toHaveBeenCalledWith(
                    "CLV optimization created successfully!",
                  );
                }),
              ];
            case 2:
            ...
            case 1:
              ...
              return [
                ...
                (0, react_2.waitFor)(() => {
                  ...
                  expect(sonner_1.toast.success).toHaveBeenCalledWith(
                    "Competitive analysis updated successfully!",
                  );
                }),
              ];
            case 2:
            ...
            case 0:
              ...
              return [
                ...
                (0, react_2.waitFor)(() => {
                  ...
                  expect(
                    react_2.screen.getByLabelText("Pricing optimization section"),
                  ).toBeInTheDocument();
                  expect(
                    react_2.screen.getByLabelText("Service mix analysis section"),
                  ).toBeInTheDocument();
                }),
              ];
            case 1:
            ...
            case 0:
              ...
              return [
                ...
                (0, react_2.waitFor)(() => {
                  ...
                  var secondButton = react_2.screen.getByRole("button", {
                    name: /Generate Report/i,
                  });
