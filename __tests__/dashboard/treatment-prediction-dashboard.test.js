...
jest.mock('@/app/lib/services/treatment-prediction', function () { return ({
    TreatmentPredictionService: jest.fn().mockImplementation(function () { return ({
...
var mockHighAccuracyPredictions = [
    {
        ...
        reasoning: 'Paciente com características ideais para o tratamento: idade adequada, tipo de pele compatível, sem contraindicações.',
        expectedResults: 'Melhora significativa na textura da pele, redução de cicatrizes e rugas finas',
...
describe('TreatmentPredictionDashboard', function () {
    ...
    describe('Component Rendering', function () {
        ...
        test('displays patient profile form', function () {
            ...
            expect(react_2.screen.getByRole('button', { name: /analisar e predizer tratamentos/i })).toBeInTheDocument();
        });
    });
    describe('Patient Data Input and Validation', function () {
        test('handles patient age input', function () { return __awaiter(void 0, void 0, void 0, function () {
            var ageInput;
        ...
        test('handles skin type selection', function () { return __awaiter(void 0, void 0, void 0, function () {
            var skinTypeSelect;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('validates required fields before analysis', function () { return __awaiter(void 0, void 0, void 0, function () {
            var analyzeButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, react_2.render)(<treatment_prediction_dashboard_1.default />);
                        analyzeButton = react_2.screen.getByRole('button', { name: /analisar e predizer tratamentos/i });
    ...
    describe('AI Prediction Generation', function () {
        test('shows loading state during analysis', function () { return __awaiter(void 0, void 0, void 0, function () {
            var analyzeButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, react_2.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, user.click(analyzeButton)];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
        ...
        test('generates predictions with high accuracy (≥85%)', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                expect(react_2.screen.queryByText(/analisando com ia/i)).not.toBeInTheDocument();
                            }, { timeout: 4000 })];
                    case 3:
                        // Wait for analysis to complete (mocked to 3 seconds)
                        _a.sent();
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                ...
                                expect(react_2.screen.getByText(/preenchimento com ácido hialurônico/i)).toBeInTheDocument();
        ...
        test('displays accuracy warning for predictions below 85%', function () { return __awaiter(void 0, void 0, void 0, function () {
            var analyzeButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        expect(react_2.screen.getByRole('button', { name: /analisar e predizer tratamentos/i })).toBeEnabled();
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('Multi-factor Analysis Display', function () {
        test('shows comprehensive patient factors', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Real-time Scoring Interface', function () {
        test('displays confidence scores in real-time', function () { return __awaiter(void 0, void 0, void 0, function () {
            var analyzeButton, predictionsTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('shows risk assessment levels', function () { return __awaiter(void 0, void 0, void 0, function () {
            var analyzeButton, predictionsTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Medical-grade Validation', function () {
        test('validates medical accuracy of predictions', function () { return __awaiter(void 0, void 0, void 0, function () {
            var analyzeButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('shows treatment contraindications', function () { return __awaiter(void 0, void 0, void 0, function () {
            var analyzeButton, predictionsTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Performance Monitoring', function () {
        ...
        test('monitors prediction generation time', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Accessibility and UX', function () {
        ...
        test('supports keyboard navigation', function () { return __awaiter(void 0, void 0, void 0, function () {
            var ageInput;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
