...
jest.mock('next/headers', function () { return ({
    cookies: function () { return ({
        get: function () { return ({ value: 'mock-session-token' }); },
    }); },
}); });
...
var mockSupabaseClient = {
    ...
    from: jest.fn(function () { return ({
        ...
        update: jest.fn(function () { return Promise.resolve({ data: [], error: null }); }),
        delete: jest.fn(function () { return Promise.resolve({ data: [], error: null }); }),
        eq: jest.fn(function () { return this; }),
        order: jest.fn(function () { return this; }),
        limit: jest.fn(function () { return this; }),
    }); }),
    rpc: jest.fn(function () { return Promise.resolve({ data: [], error: null }); }),
};
...
describe('Report Builder API Integration Tests', function () {
    ...
    describe('Story 8.2 Acceptance Criteria API Validation', function () {
        describe('AC4: Real-time Report Generation', function () {
            it('generates reports with <3 second response time', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch('/api/report-builder/generate/test-report-id', {
                                    method: 'POST',
            ...
            it('handles complex queries efficiently', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        describe('AC5: Advanced Filtering Capabilities', function () {
            it('validates advanced filter configurations', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch('/api/report-builder/filters/validate', {
                                    method: 'POST',
                                    headers: { 'Content-Type': 'application/json' },
        ...
        describe('AC6: Sharing and Collaboration Features', function () {
            it('enables report sharing with proper permissions', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch('/api/report-builder/sharing/test-report-id', {
                                    method: 'POST',
                                    headers: { 'Content-Type': 'application/json' },
            ...
            it('validates sharing permissions correctly', function () { return __awaiter(_this, void 0, void 0, function () {
                var response, data;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch('/api/report-builder/sharing/unauthorized-report', {
                                    method: 'POST',
                                    headers: { 'Content-Type': 'application/json' },
        ...
        describe('AC7: Automated Report Scheduling', function () {
            it('creates automated report schedules', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch('/api/report-builder/schedules', {
                                    method: 'POST',
                                    headers: { 'Content-Type': 'application/json' },
            ...
            it('validates schedule configuration', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        describe('AC8: Export Capabilities', function () {
            it('exports reports in multiple formats', function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, fetch("/api/report-builder/export/test-report-id", {
                                                    method: 'POST',
                                                    headers: { 'Content-Type': 'application/json' },
        ...
        describe('AC9: Analytics and Usage Tracking', function () {
            it('tracks report usage analytics', function () { return __awaiter(_this, void 0, void 0, function () {
                var response, data;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch('/api/report-builder/analytics/test-report-id', {
                                    method: 'POST',
                                    headers: { 'Content-Type': 'application/json' },
                                    body: JSON.stringify({
                                        action: 'view',
            ...
            it('provides usage analytics dashboard data', function () { return __awaiter(_this, void 0, void 0, function () {
                var response, data;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch('/api/report-builder/analytics', {
                                    method: 'GET',
                                    headers: { 'Content-Type': 'application/json' },
                                })];
                        case 1:
        ...
        describe('AC10: Integration with NeonPro Data Sources', function () {
            it('validates access to all NeonPro data sources', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch('/api/report-builder/data-sources', {
                                    method: 'GET',
                                    headers: { 'Content-Type': 'application/json' },
                                })];
                        case 1:
            ...
            it('handles data source access restrictions', function () { return __awaiter(_this, void 0, void 0, function () {
                var response, data;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch('/api/report-builder/data-sources?source=restricted_data', {
                                    method: 'GET',
                                    headers: { 'Content-Type': 'application/json' },
                                })];
                        case 1:
    ...
    describe('Report CRUD Operations', function () {
        describe('Create Report', function () {
            it('creates a new report successfully', function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            mockSupabaseClient.from.mockReturnValue({
                                insert: jest.fn().mockReturnValue({
                                    select: jest.fn().mockResolvedValue({
                                        data: [__assign(__assign(__assign({}, mockReport), newReportData), { id: 'new-report-id' })],
                                        error: null,
                                    }),
                                }),
                            });
                            mockFetch.mockResolvedValueOnce({
                                ...
                                json: function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        return [2 /*return*/, ({
                                                success: true,
                                                report: __assign(__assign(__assign({}, mockReport), newReportData), { id: 'new-report-id' })
                                            })];
                                    });
                                }); },
                            });
        ...
        describe('Read Report', function () {
            it('retrieves report by ID', function () { return __awaiter(_this, void 0, void 0, function () {
                var response, data;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        describe('Update Report', function () {
            it('updates report successfully', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        describe('Delete Report', function () {
            it('deletes report successfully', function () { return __awaiter(_this, void 0, void 0, function () {
                var response, data;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    describe('Template Management', function () {
        it('retrieves available templates', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    describe('Performance and Load Testing', function () {
        it('handles concurrent API requests gracefully', function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            mockFetch.mockResolvedValueOnce({
                                ...
                                json: function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        return [2 /*return*/, ({
                                                success: true,
                                                report: __assign(__assign({}, mockReport), { id: "test-report-".concat(i) })
                                            })];
                                    });
                                }); },
                            });
        ...
        it('maintains response time under load', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    describe('Error Handling and Edge Cases', function () {
        it('handles invalid request data gracefully', function () { return __awaiter(_this, void 0, void 0, function () {
            var response, data;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('handles database connection errors', function () { return __awaiter(_this, void 0, void 0, function () {
            var response;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('handles authentication failures', function () { return __awaiter(_this, void 0, void 0, function () {
            var response;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
