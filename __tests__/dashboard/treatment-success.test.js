...
describe("Treatment Success Rate Tracking Dashboard", () => {
  ...
  it("should show treatment performance data", () => {
    ...
    var treatments = (0, react_1.within)(performanceSection).getByTestId(
      "high-performing-treatments",
    );
  ...
  it("should display predictive analytics with forecast accuracy", () => {
    ...
    expect(
      (0, react_1.within)(suggestions).getByText(/increase consultation time/i),
    ).toBeInTheDocument();
    expect(
  ...
  it("should show compliance reporting status", () => {
    ...
    expect(
      (0, react_1.within)(complianceSection).getByText(/ANVISA: Compliant/i),
    ).toBeInTheDocument();
    expect(
