...
jest.mock('@/hooks/use-user', function () { return ({
    useUser: jest.fn()
}); });
var mockUser = {
    id: 'user-123',
...
(0, globals_1.describe)('useRBAC Hook', function () {
    ...
    (0, globals_1.describe)('Basic Hook Functionality', function () {
        (0, globals_1.it)('should initialize with loading state', function () {
            ...
            var result = (0, react_1.renderHook)(function () { return (0, use_rbac_1.useRBAC)(mockClinicId); }).result;
        ...
        (0, globals_1.it)('should load user role and permissions', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockRBACManager.getUserRole.mockResolvedValue(mockOwnerRole);
                        mockRBACManager.getUserPermissions.mockResolvedValue(mockOwnerRole.permissions);
                        result = (0, react_1.renderHook)(function () { return (0, use_rbac_1.useRBAC)(mockClinicId); }).result;
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(mockRBACManager.getUserRole).toHaveBeenCalledWith(mockUser.id, mockClinicId);
                        (0, globals_1.expect)(mockRBACManager.getUserPermissions).toHaveBeenCalledWith(mockUser.id, mockClinicId);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should handle errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(result.current.role).toBeNull();
                        (0, globals_1.expect)(result.current.permissions).toEqual([]);
                        (0, globals_1.expect)(consoleErrorSpy).toHaveBeenCalledWith('Error loading RBAC data:', globals_1.expect.any(Error));
        ...
        (0, globals_1.it)('should not load data when clinic ID is not provided', function () {
            var result = (0, react_1.renderHook)(function () { return (0, use_rbac_1.useRBAC)(undefined); }).result;
            (0, globals_1.expect)(result.current.loading).toBe(false);
            (0, globals_1.expect)(result.current.role).toBeNull();
            (0, globals_1.expect)(result.current.permissions).toEqual([]);
            (0, globals_1.expect)(mockRBACManager.getUserRole).not.toHaveBeenCalled();
    ...
    (0, globals_1.describe)('Permission Checking', function () {
        ...
        (0, globals_1.it)('should check single permission correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should check multiple permissions correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, result.current.checkMultiplePermissions([
                                'manage_users',
                                'delete_users'
                            ])];
                    case 2:
        ...
        (0, globals_1.it)('should check if user can manage another user', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        (0, globals_1.expect)(mockRBACManager.canManageUser).toHaveBeenCalledWith(mockUser.id, 'target-user-id', mockClinicId);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Role Hierarchy', function () {
        ...
        (0, globals_1.it)('should get role hierarchy level', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(mockRBACManager.getRoleHierarchyLevel).toHaveBeenCalledWith(mockOwnerRole.name);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Role Checking', function () {
        ...
        (0, globals_1.it)('should check if user is in specific role', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should check if user is at minimum role level', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('Refresh Functionality', function () {
        (0, globals_1.it)('should refresh role and permissions', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
(0, globals_1.describe)('usePermissionCheck Hook', function () {
    ...
    (0, globals_1.it)('should check permission and return result', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, globals_1.it)('should handle permission denied', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
(0, globals_1.describe)('useRoleGuard Hook', function () {
    ...
    (0, globals_1.it)('should render children when user has required role', function () {
        ...
        jest.doMock('@/hooks/use-rbac', function () { return ({
            useRBAC: function () { return mockUseRBAC; }
        }); });
...
(0, globals_1.describe)('usePermissionGuard Hook', function () {
    ...
    (0, globals_1.it)('should show loading state initially', function () {
        mockRBACManager.checkPermission.mockImplementation(function () { return new Promise(function (resolve) { return setTimeout(function () { return resolve({ granted: true }); }, 100); }); });
        var result = (0, react_1.renderHook)(function () {
            return (0, use_rbac_1.usePermissionGuard)('view_users', mockClinicId);
        }).result;
        (0, globals_1.expect)(result.current.loading).toBe(true);
