...
describe("RBAC Permission Guard Components", () => {
  ...
  describe("PermissionGuard", () => {
    ...
    it("should render fallback component when access is denied", async () => {
      ...
      render(
        <PermissionGuard permission="billing.manage" fallback={<FallbackComponent />}>
          <TestComponent />
        </PermissionGuard>,
      );
    ...
    it("should render loading component while checking permissions", () => {
      ...
      render(
        <PermissionGuard permission="patients.read" loading={<LoadingComponent />}>
          <TestComponent />
        </PermissionGuard>,
      );
    ...
    it("should pass resource ID to permission check", async () => {
      ...
      render(
        <PermissionGuard permission="patients.read" resourceId="patient-123">
          <TestComponent />
        </PermissionGuard>,
      );
    ...
    it("should pass context to permission check", async () => {
      ...
      render(
        <PermissionGuard permission="patients.read" context={context}>
          <TestComponent />
        </PermissionGuard>,
      );
    ...
    it("should handle multiple permissions with OR logic", async () => {
      ...
      render(
        <PermissionGuard permissions={["patients.read", "billing.read"]} requireAll={false}>
          <TestComponent />
        </PermissionGuard>,
      );
  ...
  describe("FeatureGuard", () => {
    ...
    it("should render loading state while checking feature access", () => {
      ...
      render(
        <FeatureGuard feature="patient-management" loading={<LoadingComponent />}>
          <TestComponent />
        </FeatureGuard>,
      );
  ...
  describe("ConditionalRender", () => {
    ...
    it("should render fallback when condition is false", () => {
      render(
        <ConditionalRender condition={false} fallback={<FallbackComponent />}>
          <TestComponent />
        </ConditionalRender>,
      );
  ...
  describe("PermissionButton", () => {
    it("should render enabled button when user has permission", async () => {
      ...
      render(
        <PermissionButton permission="patients.create" onClick={() => {}}>
          Create Patient
        </PermissionButton>,
      );
    ...
    it("should render disabled button when user lacks permission", async () => {
      ...
      render(
        <PermissionButton permission="billing.create" onClick={() => {}}>
          Create Invoice
        </PermissionButton>,
      );
    ...
    it("should call onClick when clicked and permission is granted", async () => {
      ...
      render(
        <PermissionButton permission="patients.create" onClick={mockOnClick}>
          Create Patient
        </PermissionButton>,
      );
    ...
    it("should not call onClick when clicked and permission is denied", async () => {
      ...
      render(
        <PermissionButton permission="billing.create" onClick={mockOnClick}>
          Create Invoice
        </PermissionButton>,
      );
  ...
  describe("PermissionLink", () => {
    it("should render enabled link when user has permission", async () => {
      ...
      render(
        <PermissionLink permission="patients.read" href="/patients">
          View Patients
        </PermissionLink>,
      );
    ...
    it("should render disabled link when user lacks permission", async () => {
      ...
      render(
        <PermissionLink permission="billing.read" href="/billing">
          View Billing
        </PermissionLink>,
      );
  ...
  describe("Error handling", () => {
    ...
    it("should render error fallback when provided", async () => {
      ...
      render(
        <PermissionGuard permission="patients.read" errorFallback={<ErrorComponent />}>
          <TestComponent />
        </PermissionGuard>,
      );
