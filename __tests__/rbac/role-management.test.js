...
// Mock dependencies
jest.mock('@/hooks/use-rbac', function () { return ({
    useRBAC: jest.fn()
}); });
jest.mock('@/lib/auth/rbac/permissions', function () { return ({
    RBACPermissionManager: jest.fn(function () { return ({
        assignRole: jest.fn(),
        removeRole: jest.fn(),
        getUserRole: jest.fn(),
        getAllUsers: jest.fn(),
...
jest.mock('@/components/ui/button', function () { return ({
    Button: function (_a) {
        var children = _a.children, onClick = _a.onClick, disabled = _a.disabled, variant = _a.variant;
        return (<button onClick={onClick} disabled={disabled} data-variant={variant}>
      {children}
    </button>);
    }
}); });
jest.mock('@/components/ui/select', function () { return ({
    Select: function (_a) {
        ...
        return (<div data-testid="select" onClick={function () { return onValueChange === null || onValueChange === void 0 ? void 0 : onValueChange('test-value'); }}>
      {children}
    </div>);
    },
...
jest.mock('@/components/ui/table', function () { return ({
    Table: function (_a) {
        var children = _a.children;
...
jest.mock('lucide-react', function () { return ({
    Users: function () { return <span data-testid="users-icon">Users</span>; },
    Shield: function () { return <span data-testid="shield-icon">Shield</span>; },
    UserCheck: function () { return <span data-testid="user-check-icon">UserCheck</span>; },
    AlertCircle: function () { return <span data-testid="alert-circle-icon">AlertCircle</span>; },
    Loader2: function () { return <span data-testid="loader-icon">Loading</span>; }
}); });
...
(0, globals_1.describe)('RoleManagement Component', function () {
    ...
    (0, globals_1.describe)('Component Rendering', function () {
        (0, globals_1.it)('should render role management interface', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, react_1.render)(<role_management_1.RoleManagement clinicId={mockClinicId}/>);
                        (0, globals_1.expect)(react_1.screen.getByText('Gerenciamento de Funções')).toBeInTheDocument();
                        (0, globals_1.expect)(react_1.screen.getByText('Gerencie funções e permissões dos usuários')).toBeInTheDocument();
        ...
        (0, globals_1.it)('should show loading state initially', function () {
            ...
            (0, globals_1.expect)(react_1.screen.getByText('Carregando dados de função...')).toBeInTheDocument();
        });
        (0, globals_1.it)('should show access denied when user lacks permissions', function () {
            ...
            (0, globals_1.expect)(react_1.screen.getByText('Você não tem permissão para gerenciar funções de usuário.')).toBeInTheDocument();
        });
    });
    (0, globals_1.describe)('User List Display', function () {
        (0, globals_1.it)('should display list of users with their roles', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, react_1.render)(<role_management_1.RoleManagement clinicId={mockClinicId}/>);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, globals_1.expect)(react_1.screen.getByText('Owner User')).toBeInTheDocument();
                                (0, globals_1.expect)(react_1.screen.getByText('Manager User')).toBeInTheDocument();
                                (0, globals_1.expect)(react_1.screen.getByText('Staff User')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        (0, globals_1.expect)(react_1.screen.getByText('owner@clinic.com')).toBeInTheDocument();
                        (0, globals_1.expect)(react_1.screen.getByText('manager@clinic.com')).toBeInTheDocument();
                        (0, globals_1.expect)(react_1.screen.getByText('staff@clinic.com')).toBeInTheDocument();
        ...
        (0, globals_1.it)('should show role hierarchy levels', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, react_1.render)(<role_management_1.RoleManagement clinicId={mockClinicId}/>);
        ...
        (0, globals_1.it)('should handle empty user list', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        (0, react_1.render)(<role_management_1.RoleManagement clinicId={mockClinicId}/>);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, globals_1.expect)(react_1.screen.getByText('Nenhum usuário encontrado')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    (0, globals_1.describe)('Role Assignment', function () {
        (0, globals_1.it)('should allow role assignment for manageable users', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        (0, globals_1.expect)(react_1.screen.getByText('Selecionar nova função')).toBeInTheDocument();
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should disable role assignment for non-manageable users', function () { return __awaiter(void 0, void 0, void 0, function () {
            var buttons;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should successfully assign new role', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        (0, globals_1.expect)(mockRBACManager.assignRole).toHaveBeenCalledWith('user-3', 'test-value', // Mock value from select
                        mockClinicId, globals_1.expect.any(Object));
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should handle role assignment errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, assignButtons, selectElement, confirmButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, globals_1.expect)(react_1.screen.getByText('Erro ao alterar função')).toBeInTheDocument();
                            })];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
    ...
    (0, globals_1.describe)('Role Removal', function () {
        (0, globals_1.it)('should allow role removal for manageable users', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        (0, globals_1.expect)(react_1.screen.getByText('Confirmar remoção de função')).toBeInTheDocument();
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should successfully remove role', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        (0, globals_1.expect)(mockRBACManager.removeRole).toHaveBeenCalledWith('user-3', mockClinicId);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should handle role removal errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, removeButtons, confirmButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, globals_1.expect)(react_1.screen.getByText('Erro ao remover função')).toBeInTheDocument();
                            })];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
    ...
    (0, globals_1.describe)('Permission Display', function () {
        (0, globals_1.it)('should show role permissions when expanded', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should hide permissions when collapsed', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        (0, globals_1.expect)(react_1.screen.queryByText('manage_clinic')).not.toBeInTheDocument();
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Statistics Display', function () {
        (0, globals_1.it)('should show role statistics', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, react_1.render)(<role_management_1.RoleManagement clinicId={mockClinicId}/>);
                    ...
                    case 1:
                        _a.sent();
                        (0, globals_1.expect)(react_1.screen.getByText('Total de Usuários')).toBeInTheDocument();
                        (0, globals_1.expect)(react_1.screen.getByText('Funções Ativas')).toBeInTheDocument();
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should update statistics when data changes', function () { return __awaiter(void 0, void 0, void 0, function () {
            var rerender;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        rerender = (0, react_1.render)(<role_management_1.RoleManagement clinicId={mockClinicId}/>).rerender;
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                    ...
                    case 1:
                        _a.sent();
                        // Update mock data
                        mockRBACManager.getAllUsers.mockResolvedValue(__spreadArray(__spreadArray([], mockUsers, true), [{
                                id: 'user-4',
    ...
    (0, globals_1.describe)('Error Handling', function () {
        (0, globals_1.it)('should handle data loading errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        (0, react_1.render)(<role_management_1.RoleManagement clinicId={mockClinicId}/>);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, globals_1.expect)(react_1.screen.getByText('Erro ao carregar dados')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        (0, globals_1.it)('should show retry option on error', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        (0, react_1.render)(<role_management_1.RoleManagement clinicId={mockClinicId}/>);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, globals_1.expect)(react_1.screen.getByText('Tentar Novamente')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
    ...
    (0, globals_1.describe)('Accessibility', function () {
        (0, globals_1.it)('should have proper ARIA labels', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, react_1.render)(<role_management_1.RoleManagement clinicId={mockClinicId}/>);
                    ...
                    case 1:
                        _a.sent();
                        (0, globals_1.expect)(react_1.screen.getByRole('table')).toHaveAttribute('aria-label', globals_1.expect.stringContaining('usuários'));
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should support keyboard navigation', function () { return __awaiter(void 0, void 0, void 0, function () {
