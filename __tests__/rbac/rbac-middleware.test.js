...
globals_1.jest.mock('@/middleware/rbac', function () { return ({
    rbacMiddleware: globals_1.jest.fn(),
    RoutePermissionConfig: {}
}); });
// Mock all problematic dependencies
globals_1.jest.mock('@supabase/auth-helpers-nextjs', function () { return ({
...
globals_1.jest.mock('@/lib/supabase/server', function () { return ({
    createClient: globals_1.jest.fn(function () { return ({
        auth: {
            getUser: globals_1.jest.fn()
        }
...
globals_1.jest.mock('@/lib/auth/rbac/permissions', function () { return ({
    RBACPermissionManager: globals_1.jest.fn().mockImplementation(function () { return ({
...
(0, globals_1.describe)('RBAC Middleware', function () {
    ...
    (0, globals_1.describe)('Authentication', function () {
        (0, globals_1.it)('should return 401 when user is not authenticated', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should proceed when user is authenticated', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('Route Permission Matching', function () {
        ...
        (0, globals_1.it)('should match exact route paths', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should match dynamic route patterns', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should handle nested dynamic routes', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should return 404 for unmatched routes', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response, responseData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('HTTP Method Handling', function () {
        ...
        (0, globals_1.it)('should handle GET requests', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        response = _a.sent();
                        (0, globals_1.expect)(response).toBeNull();
                        (0, globals_1.expect)(mockRBACManager.checkPermission).toHaveBeenCalledWith(globals_1.expect.objectContaining({
                            permission: 'view_users'
                        }));
                        return [2 /*return*/];
                }
        ...
        (0, globals_1.it)('should handle POST requests', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should return 405 for unsupported HTTP methods', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response, responseData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('Clinic ID Validation', function () {
        ...
        (0, globals_1.it)('should extract clinic ID from query parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should extract clinic ID from route parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should return 400 when clinic ID is required but missing', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response, responseData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('Permission Checking', function () {
        ...
        (0, globals_1.it)('should grant access when permission is granted', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should deny access when permission is denied', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response, responseData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should handle permission check errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response, responseData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('Context Extraction', function () {
        ...
        (0, globals_1.it)('should extract IP address from headers', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should extract user agent from headers', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should handle missing headers gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('Resource Owner Extraction', function () {
        ...
        (0, globals_1.it)('should extract resource owner ID from route parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should extract user ID from user-specific routes', function () { return __awaiter(void 0, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
