...
(0, globals_1.describe)('RBAC Permissions System', function () {
    (0, globals_1.describe)('hasPermission', function () {
        (0, globals_1.it)('should grant permission when user role has the required permission', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, result;
        ...
        (0, globals_1.it)('should deny permission when user role lacks the required permission', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should deny permission for invalid user role', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should deny cross-clinic access for non-admin users', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = createMockUser('staff', 'clinic-1');
                        return [4 /*yield*/, (0, permissions_1.hasPermission)(user, 'patients.read', undefined, { clinicId: 'clinic-2' })];
                    case 1:
                        result = _a.sent();
        ...
        (0, globals_1.it)('should use permission cache for repeated checks', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('hasAnyPermission', function () {
        (0, globals_1.it)('should grant access when user has at least one of the required permissions', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should deny access when user has none of the required permissions', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, permissions, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        result = _a.sent();
                        (0, globals_1.expect)(result.granted).toBe(false);
                        (0, globals_1.expect)(result.reason).toContain('does not have any of the required permissions');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should handle empty permissions array', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, permissions, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('hasAllPermissions', function () {
        (0, globals_1.it)('should grant access when user has all required permissions', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, permissions, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should deny access when user is missing any required permission', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, permissions, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('Role-based permission validation', function () {
        (0, globals_1.it)('should validate owner permissions', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should validate manager permissions', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, patientRead, billingManage, clinicManage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should validate staff permissions', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should validate patient permissions', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('Error handling', function () {
        (0, globals_1.it)('should handle permission validation errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        globals_1.jest.spyOn(originalValidation, 'hasPermission').mockRejectedValueOnce(new Error('Database error'));
                        return [4 /*yield*/, (0, permissions_1.hasPermission)(user, 'patients.read')];
                    case 1:
                        result = _a.sent();
                        (0, globals_1.expect)(result.granted).toBe(false);
        ...
        (0, globals_1.it)('should handle missing user data', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('Performance and caching', function () {
        (0, globals_1.it)('should cache permission results for performance', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('Resource-specific permissions', function () {
        (0, globals_1.it)('should handle patient-specific access', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = createMockUser('staff');
                        return [4 /*yield*/, (0, permissions_1.hasPermission)(user, 'patients.read', 'patient-123')];
                    case 1:
                        result = _a.sent();
                        (0, globals_1.expect)(result.granted).toBe(true);
                        (0, globals_1.expect)(result.roleUsed).toBe('staff');
        ...
        (0, globals_1.it)('should handle appointment-specific access', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = createMockUser('staff');
                        return [4 /*yield*/, (0, permissions_1.hasPermission)(user, 'appointments.manage', 'appointment-456')];
                    case 1:
                        result = _a.sent();
                        (0, globals_1.expect)(result.granted).toBe(true);
                        (0, globals_1.expect)(result.roleUsed).toBe('staff');
        ...
        (0, globals_1.it)('should handle financial data access restrictions', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('Audit logging', function () {
        (0, globals_1.it)('should log successful permission checks', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should log failed permission checks', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
