        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                rbacManager.hasPermission(mockUserId, "patients.read", mockClinicId),
              ];
            case 1:
              result = _a.sent();
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                rbacManager.hasPermission(mockUserId, "billing.manage", mockClinicId),
              ];
            case 1:
              result = _a.sent();
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                rbacManager.assignRole(mockUserId, mockRoleId, mockClinicId, mockUserId),
              ];
            case 1:
              result = _a.sent();
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                rbacManager.hasPermission(mockUserId, "patients.read", mockClinicId, "patient-123"),
              ];
            case 1:
              result = _a.sent();
              (0, globals_1.expect)(result.granted).toBe(true);
