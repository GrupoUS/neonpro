      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator('input[type="email"]')).toBeVisible(),
            ];
          case 2:
            _c.sent();
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator('input[type="password"]')).toBeVisible(),
            ];
          case 3:
            _c.sent();
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator('button[type="submit"]')).toBeVisible(),
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator("text=Entrar com Google")).toBeVisible(),
            ];
          case 5:
            // Check Google login button
            _c.sent();
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator("text=Email is required")).toBeVisible(),
            ];
          case 2:
            // Check for validation errors
            _c.sent();
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator("text=Password is required")).toBeVisible(),
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator("text=Invalid email format")).toBeVisible(),
            ];
          case 6:
            _c.sent();
            return [2 /*return*/];
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator("text=Invalid credentials")).toBeVisible(),
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              page.fill('input[type="password"]', "demopassword"),
              // Click login button
            ];
          case 2:
            _c.sent();
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page).toHaveURL(/\/dashboard/),
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              Promise.all([context.waitForEvent("page"), page.click("text=Entrar com Google")]),
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator('input[name="name"]')).toBeVisible(),
            ];
          case 2:
            _c.sent();
            return [
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator("text=Account created successfully")).toBeVisible(),
            ];
          case 5:
            // Should show success message or redirect
            _c.sent();
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page).toHaveURL(/\/login/),
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              page.click('button:has-text("Tentar novamente")'),
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator('input[type="email"]')).toBeFocused(),
            ];
          case 3:
            _c.sent();
            return [4 /*yield*/, page.keyboard.press("Tab")];
          case 4:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator('input[type="password"]')).toBeFocused(),
            ];
          case 5:
            _c.sent();
            return [4 /*yield*/, page.keyboard.press("Tab")];
          case 6:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator('button[type="submit"]')).toBeFocused(),
            ];
          case 7:
            _c.sent();
            return [2 /*return*/];
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator('input[type="email"]')).toHaveAttribute(
                "aria-label",
                /email/i,
              ),
            ];
          case 2:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator('input[type="password"]')).toHaveAttribute(
                "aria-label",
                /password/i,
              ),
            ];
          case 3:
            ...
            return [
              4 /*yield*/,
              (0, test_1.expect)(page.locator('button[type="submit"]')).toHaveAttribute(
                "aria-label",
                /login|sign in/i,
              ),
            ];
