...
var mockCookies = jest.fn(function () {
  return {
    get: jest.fn(),
    set: jest.fn(),
    delete: jest.fn(),
...
var createMockQueryBuilder = function () {
  return {
...
jest.mock("../app/utils/supabase/client", function () {
  return {
    ...
    createLegacyClient: jest.fn(function () {
      return mockSupabaseClient;
    }),
    createOptimizedClient: jest.fn(function () {
      return mockSupabaseClient;
    }),
  };
});
...
jest.mock("date-fns", function () {
  return {
    ...
    parseISO: jest.fn(function (str) {
      return new Date(str);
    }),
    isValid: jest.fn(function () {
      return true;
    }),
    addDays: jest.fn(function (date, days) {
      return new Date(date.getTime() + days * 24 * 60 * 60 * 1000);
    }),
    subDays: jest.fn(function (date, days) {
      return new Date(date.getTime() - days * 24 * 60 * 60 * 1000);
    }),
    startOfMonth: jest.fn(function (date) {
      return new Date(date.getFullYear(), date.getMonth(), 1);
    }),
    endOfMonth: jest.fn(function (date) {
      return new Date(date.getFullYear(), date.getMonth() + 1, 0);
    }),
  };
});
// Mock react-hot-toast
jest.mock("react-hot-toast", function () {
  return {
    toast: {
      success: jest.fn(),
      error: jest.fn(),
...
jest.mock("recharts", function () {
  return {
    ...
    Bar: function () {
      return { type: "div", props: { "data-testid": "bar" } };
    },
    Line: function () {
      return { type: "div", props: { "data-testid": "line" } };
    },
    Pie: function () {
      return { type: "div", props: { "data-testid": "pie" } };
    },
    XAxis: function () {
      return { type: "div", props: { "data-testid": "x-axis" } };
    },
    YAxis: function () {
      return { type: "div", props: { "data-testid": "y-axis" } };
    },
    CartesianGrid: function () {
      return { type: "div", props: { "data-testid": "cartesian-grid" } };
    },
    Tooltip: function () {
      return { type: "div", props: { "data-testid": "tooltip" } };
    },
    Legend: function () {
      return { type: "div", props: { "data-testid": "legend" } };
    },
    Cell: function () {
      return { type: "div", props: { "data-testid": "cell" } };
    },
  };
});
...
global.NextResponse = {
  json: jest.fn(function (object, init) {
    return {
      json: function () {
