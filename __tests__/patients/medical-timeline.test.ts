...
// Mock implementation
const mockGetPatientTimeline = jest.fn().mockImplementation(async (patientId: string, filter?: any) => {
...
const mockUpdateTimelineEvent = jest.fn().mockImplementation(async (eventId: string, updates: any) => {
  return {
