...
jest.mock('@/hooks/useVisionAnalysis', function () { return ({
    useVisionAnalysis: function () { return ({
...
describe('AnalysisResults', function () {
    ...
    it('should display annotations correctly', function () {
        ...
        expect(react_2.screen.getByText('Significant texture improvement in this region')).toBeInTheDocument();
    ...
    it('should handle export functionality', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, react_2.waitFor)(function () {
                            expect(mockExportAnalysis).toHaveBeenCalledWith(mockAnalysisResult.id, expect.objectContaining({
                                format: 'pdf',
                                includeImages: true,
    ...
    it('should handle share functionality', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, react_2.waitFor)(function () {
                            expect(mockShareAnalysis).toHaveBeenCalledWith(mockAnalysisResult.id, expect.objectContaining({
    ...
    it('should handle missing or incomplete data gracefully', function () {
        var incompleteResult = __assign(__assign({}, mockAnalysisResult), { changeMetrics: undefined, annotations: [] });
    ...
    it('should handle low quality results appropriately', function () {
        var lowQualityResult = __assign(__assign({}, mockAnalysisResult), { accuracyScore: 0.75, confidenceScore: 0.70 });
