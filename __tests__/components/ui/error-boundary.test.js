...
var ThrowError = function (_a) {
    var _b = _a.shouldThrow, shouldThrow = _b === void 0 ? true : _b;
    if (shouldThrow) {
...
describe('ErrorBoundary', function () {
    it('renders children when there is no error', function () {
        (0, react_2.render)(<error_boundary_1.ErrorBoundary>
    ...
    it('renders error UI when child component throws', function () {
        ...
        expect(react_2.screen.getByText('Ocorreu um erro inesperado. Nossa equipe foi notificada.')).toBeInTheDocument();
    });
    ...
    it('shows technical details when showDetails is true', function () {
        (0, react_2.render)(<error_boundary_1.ErrorBoundary showDetails={true}>
        <ThrowError />
      </error_boundary_1.ErrorBoundary>);
    ...
    it('calls onError callback when error occurs', function () {
        ...
        (0, react_2.render)(<error_boundary_1.ErrorBoundary onError={onErrorMock}>
        <ThrowError />
      </error_boundary_1.ErrorBoundary>);
        expect(onErrorMock).toHaveBeenCalledWith(expect.any(Error), expect.objectContaining({
            componentStack: expect.any(String)
        }));
    });
    it('renders custom fallback when provided', function () {
        var customFallback = <div>Custom error message</div>;
        (0, react_2.render)(<error_boundary_1.ErrorBoundary fallback={customFallback}>
        <ThrowError />
      </error_boundary_1.ErrorBoundary>);
...
describe('CriticalErrorBoundary', function () {
    it('renders critical error UI with reload button', function () {
        ...
        (0, react_2.render)(<error_boundary_1.CriticalErrorBoundary title="Test Section">
        <ThrowError />
...
describe('withErrorBoundary HOC', function () {
    it('wraps component with error boundary', function () {
        var TestComponent = function () { return <div>Test Component</div>; };
    ...
    it('sets correct display name', function () {
        var TestComponent = function () { return <div>Test</div>; };
...
describe('Error Boundary Edge Cases', function () {
    ...
    it('maintains error state across re-renders', function () {
        var rerender = (0, react_2.render)(<error_boundary_1.ErrorBoundary>
        <ThrowError />
      </error_boundary_1.ErrorBoundary>).rerender;
        expect(react_2.screen.getByText('Oops! Algo deu errado')).toBeInTheDocument();
        // Re-render with same error
        rerender(<error_boundary_1.ErrorBoundary>
        <ThrowError />
      </error_boundary_1.ErrorBoundary>);
        expect(react_2.screen.getByText('Oops! Algo deu errado')).toBeInTheDocument();
    });
