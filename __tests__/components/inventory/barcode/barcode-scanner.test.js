...
// Mock the hooks
vitest_1.vi.mock('@/app/hooks/use-barcode-scanner', function () { return ({
    useBarcodeScanner: vitest_1.vi.fn(function () { return ({
        isScanning: false,
        result: null,
        error: null,
    ...
    useScanHistory: vitest_1.vi.fn(function () { return ({
        data: [],
        isLoading: false
    }); })
}); });
...
(0, vitest_1.describe)('BarcodeScanner Component', function () {
    (0, vitest_1.beforeEach)(function () {
        vitest_1.vi.clearAllMocks();
    });
    (0, vitest_1.it)('renders scanner interface correctly', function () {
        ...
        (0, vitest_1.expect)(react_2.screen.getByPlaceholderText('Digite o código manualmente')).toBeInTheDocument();
    });
    (0, vitest_1.it)('switches between camera and manual input modes', function () {
        (0, react_2.render)(<barcode_scanner_1.default />);
    ...
    (0, vitest_1.it)('handles manual code input', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)('displays scan history when enabled', function () {
        (0, react_2.render)(<barcode_scanner_1.default showHistory={true}/>);
        (0, vitest_1.expect)(react_2.screen.getByText('Histórico de Escaneamentos')).toBeInTheDocument();
    });
    (0, vitest_1.it)('handles scan errors gracefully', function () {
    ...
    (0, vitest_1.it)('calls onScanSuccess when scan is successful', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)('validates barcode format correctly', function () {
        (0, react_2.render)(<barcode_scanner_1.default />);
    ...
    (0, vitest_1.it)('clears result when clear button is clicked', function () {
    ...
    (0, vitest_1.it)('handles auto-focus correctly', function () {
    ...
    (0, vitest_1.it)('applies custom className correctly', function () {
        var container = (0, react_2.render)(<barcode_scanner_1.default className="custom-class"/>).container;
        (0, vitest_1.expect)(container.firstChild).toHaveClass('custom-class');
    });
});
// Integration Tests
(0, vitest_1.describe)('BarcodeScanner Integration', function () {
    (0, vitest_1.it)('integrates properly with barcode service', function () { return __awaiter(void 0, void 0, void 0, function () {
