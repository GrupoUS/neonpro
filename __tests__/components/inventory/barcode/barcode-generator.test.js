...
vitest_1.vi.mock('@/app/hooks/use-barcode-scanner', function () { return ({
    useBarcodeGeneration: vitest_1.vi.fn(function () { return ({
        generateBarcode: vitest_1.vi.fn(),
        isGenerating: false,
        error: null,
        data: null
    }); }),
    useBarcodeData: vitest_1.vi.fn(function () { return ({
        data: [],
        isLoading: false
    }); }),
    useLabelPrinting: vitest_1.vi.fn(function () { return ({
...
(0, vitest_1.describe)('BarcodeGenerator Component', function () {
    ...
    (0, vitest_1.it)('validates required fields before generation', function () { return __awaiter(void 0, void 0, void 0, function () {
        var generateButton;
    ...
    (0, vitest_1.it)('generates barcode with valid input', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)('enables print functionality when barcode is generated', function () {
        ...
        var _a = require('@/app/hooks/use-barcode-scanner'), useBarcodeGeneration = _a.useBarcodeGeneration, useLabelPrinting = _a.useLabelPrinting;
        useBarcodeGeneration.mockReturnValue({
            generateBarcode: vitest_1.vi.fn(),
            isGenerating: false,
            error: null,
    ...
    (0, vitest_1.it)('copies barcode to clipboard', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)('warns about duplicate barcode types', function () {
        ...
        (0, vitest_1.expect)(react_2.screen.getByText(/Já existe um código CODE128/)).toBeInTheDocument();
    });
    (0, vitest_1.it)('handles optional fields correctly', function () {
        ...
        react_2.fireEvent.click(generateButton);
        (0, vitest_1.expect)(mockGenerate).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
