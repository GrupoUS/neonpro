...
describe("ResourceManagement Component", () => {
  ...
  it("renders resource management dashboard", async () => {
    ...
    expect(
      screen.getByText("Manage clinic resources, allocations, and optimize utilization"),
    ).toBeInTheDocument();
...
describe("ResourceAllocationForm Component", () => {
  ...
  it("renders allocation form when open", () => {
    ...
    expect(
      screen.getByText("Allocate a resource for an appointment or maintenance period"),
    ).toBeInTheDocument();
  });
...
describe("ResourceOptimization Component", () => {
  ...
  it("renders optimization dashboard", async () => {
    ...
    expect(
      screen.getByText("AI-powered insights and recommendations for optimal resource utilization"),
    ).toBeInTheDocument();
  });
