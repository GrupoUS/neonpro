          ...
          case 0:
            ...
            return [
              ...
              (0, react_1.waitFor)(function () {
                ...
                (0, globals_1.expect)(
                  react_1.screen.getByText("Laser Equipment"),
                ).toBeInTheDocument();
              }),
            ];
          case 1:
          ...
          case 0:
            ...
            return [
              ...
              (0, react_1.waitFor)(function () {
                ...
                (0, globals_1.expect)(
                  react_1.screen.getByText("room • treatment_room"),
                ).toBeInTheDocument();
          ...
          case 2:
            ...
            return [
              ...
              (0, react_1.waitFor)(function () {
                ...
                (0, globals_1.expect)(sonner_1.toast.success).toHaveBeenCalledWith(
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            renderWithProps(
              <resource_management_1.default clinicId="clinic-1" userRole="patient" />,
            );
            return [
              4 /*yield*/,
              (0, react_1.waitFor)(function () {
          ...
          case 1:
            _a.sent();
            (0, globals_1.expect)(
              react_1.screen.queryByText("Add Resource"),
            ).not.toBeInTheDocument();
            (0, globals_1.expect)(
              react_1.screen.queryByText("Set Maintenance"),
            ).not.toBeInTheDocument();
            return [2 /*return*/];
        }
      });
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            renderWithProps(
              <resource_optimization_1.default clinicId="clinic-1" userRole="admin" />,
            );
            return [
              4 /*yield*/,
              (0, react_1.waitFor)(function () {
                ...
                (0, globals_1.expect)(
                  react_1.screen.getByText("Efficiency Score"),
                ).toBeInTheDocument();
                (0, globals_1.expect)(
                  react_1.screen.getByText("Cost Effectiveness"),
                ).toBeInTheDocument();
                (0, globals_1.expect)(
                  react_1.screen.getByText("Maintenance Compliance"),
                ).toBeInTheDocument();
              }),
            ];
          case 1:
