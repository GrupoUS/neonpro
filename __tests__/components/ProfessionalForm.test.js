...
describe('ProfessionalForm', function () {
    ...
    describe('Component Rendering', function () {
        it('should render form title for new professional', function () {
            ...
            expect(react_1.screen.getByText('Preencha as informações do profissional')).toBeInTheDocument();
        });
        it('should render form title for editing professional', function () {
            ...
            expect(react_1.screen.getByText('Atualize as informações do profissional')).toBeInTheDocument();
        });
        ...
        it('should render form action buttons', function () {
            ...
            expect(react_1.screen.getByRole('button', { name: 'Cadastrar Profissional' })).toBeInTheDocument();
        });
    });
    describe('Form Pre-population', function () {
        it('should pre-populate form fields when editing', function () {
            ...
            expect(react_1.screen.getByDisplayValue('Especialista em dermatologia estética')).toBeInTheDocument();
        ...
        it('should change submit button text when editing', function () {
            (0, react_1.render)(<ProfessionalForm_1.default professional={mockProfessional}/>);
            expect(react_1.screen.getByRole('button', { name: 'Atualizar Profissional' })).toBeInTheDocument();
            expect(react_1.screen.queryByRole('button', { name: 'Cadastrar Profissional' })).not.toBeInTheDocument();
        });
    });
    describe('Form Validation', function () {
        it('should show validation errors for required fields', function () { return __awaiter(void 0, void 0, void 0, function () {
            var submitButton;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                ...
                                expect(react_1.screen.getByText('Número da licença é obrigatório')).toBeInTheDocument();
                                expect(react_1.screen.getByText('Qualificação é obrigatória')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should validate email format', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should validate phone number format', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        react_1.fireEvent.click(submitButton);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(react_1.screen.getByText('Telefone deve ter pelo menos 10 dígitos')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should validate CEP format', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should validate birth date is not in future', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        react_1.fireEvent.click(submitButton);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(react_1.screen.getByText('Data de nascimento não pode ser no futuro')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Credentials Management', function () {
        it('should allow adding new credential', function () { return __awaiter(void 0, void 0, void 0, function () {
            var addCredentialButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, react_1.render)(<ProfessionalForm_1.default />);
                        addCredentialButton = react_1.screen.getByRole('button', { name: 'Adicionar Credencial' });
        ...
        it('should allow removing credential', function () { return __awaiter(void 0, void 0, void 0, function () {
            var addCredentialButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(react_1.screen.queryByLabelText('Tipo de Credencial')).not.toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should validate credential fields', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                ...
                                expect(react_1.screen.getByText('Autoridade emissora é obrigatória')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should validate credential expiry date is after issue date', function () { return __awaiter(void 0, void 0, void 0, function () {
            var addCredentialButton, submitButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        react_1.fireEvent.click(submitButton);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(react_1.screen.getByText('Data de expiração deve ser posterior à data de emissão')).toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Services Management', function () {
        it('should allow adding new service', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should allow removing service', function () { return __awaiter(void 0, void 0, void 0, function () {
            var addServiceButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(react_1.screen.queryByLabelText('Nome do Serviço')).not.toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should validate service fields', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        react_1.fireEvent.click(submitButton);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(react_1.screen.getByText('Nome do serviço é obrigatório')).toBeInTheDocument();
                                expect(react_1.screen.getByText('Tipo de serviço é obrigatório')).toBeInTheDocument();
                                expect(react_1.screen.getByText('Duração deve ser maior que 0')).toBeInTheDocument();
                                expect(react_1.screen.getByText('Preço deve ser maior que 0')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Form Submission', function () {
        it('should create new professional successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var submitButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        react_1.fireEvent.change(react_1.screen.getByLabelText('Nome'), { target: { value: 'João' } });
                        react_1.fireEvent.change(react_1.screen.getByLabelText('Sobrenome'), { target: { value: 'Santos' } });
                        react_1.fireEvent.change(react_1.screen.getByLabelText('Email'), { target: { value: 'joao@email.com' } });
                        react_1.fireEvent.change(react_1.screen.getByLabelText('Número da Licença'), { target: { value: 'CRM 789012' } });
                        react_1.fireEvent.change(react_1.screen.getByLabelText('Qualificação'), { target: { value: 'Cardiologista' } });
                        submitButton = react_1.screen.getByRole('button', { name: 'Cadastrar Profissional' });
                        react_1.fireEvent.click(submitButton);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(professionals_1.createProfessional).toHaveBeenCalledWith(expect.objectContaining({
                                    given_name: 'João',
                                    family_name: 'Santos',
                                ...
                                expect(sonner_1.toast.success).toHaveBeenCalledWith('Profissional cadastrado com sucesso!');
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should update existing professional successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        react_1.fireEvent.click(submitButton);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(professionals_1.updateProfessional).toHaveBeenCalledWith('1', expect.objectContaining({
                                    given_name: 'Dr. Ana Luiza'
                                }));
                                expect(sonner_1.toast.success).toHaveBeenCalledWith('Profissional atualizado com sucesso!');
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        react_1.fireEvent.click(submitButton);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(sonner_1.toast.error).toHaveBeenCalledWith('Erro ao cadastrar profissional');
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should handle update errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var submitButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        react_1.fireEvent.click(submitButton);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(sonner_1.toast.error).toHaveBeenCalledWith('Erro ao atualizar profissional');
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should disable submit button during submission', function () { return __awaiter(void 0, void 0, void 0, function () {
            var submitButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Navigation', function () {
        it('should navigate back when cancel is clicked', function () {
            ...
            globals_1.jest.doMock('next/navigation', function () { return ({
                useRouter: function () { return ({ push: globals_1.jest.fn(), back: mockBack }); }
            }); });
            (0, react_1.render)(<ProfessionalForm_1.default />);
        ...
        it('should navigate to professionals list after successful creation', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockPush;
            return __generator(this, function (_a) {
    ...
    describe('User Experience', function () {
        it('should show loading state during submission', function () { return __awaiter(void 0, void 0, void 0, function () {
            var submitButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should clear form after successful submission', function () { return __awaiter(void 0, void 0, void 0, function () {
            var nameInput, submitButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Accessibility', function () {
        ...
        it('should have proper error announcements', function () { return __awaiter(void 0, void 0, void 0, function () {
            var submitButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
