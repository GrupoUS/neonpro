          ...
          case 2:
            ...
            return [
              ...
              (0, react_1.waitFor)(function () {
                ...
                expect(
                  duplicate_detection_1.duplicateDetectionSystem.detectDuplicates,
                ).toHaveBeenCalledTimes(2); // Mount + reload
              }),
            ];
          case 3:
            _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            duplicate_detection_1.duplicateDetectionSystem.detectDuplicates.mockRejectedValue(
              new Error("API Error"),
            );
            (0, react_1.render)(<duplicate_manager_1.default />);
            return [
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            consoleSpy = jest.spyOn(console, "error").mockImplementation();
            duplicate_detection_1.duplicateDetectionSystem.comparePatients.mockRejectedValue(
