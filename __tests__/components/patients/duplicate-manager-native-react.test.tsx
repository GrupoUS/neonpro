...
describe('DuplicateManagerHookMinimal - Native React Testing', () => {
  ...
  test('renders without crashing using server-side rendering', () => {
    ...
    const html = renderToString(
      React.createElement(DuplicateManagerHookMinimal, { duplicates: mockDuplicates })
    );
  ...
  test('component structure is valid', () => {
    ...
    const element = React.createElement(DuplicateManagerHookMinimal, { duplicates: mockDuplicates });
