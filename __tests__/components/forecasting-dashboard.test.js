...
jest.mock('date-fns', function () { return ({
    ...
    parseISO: jest.fn(function (dateString) { return new Date(dateString); }),
...
describe('ForecastingDashboard', function () {
        ...
        mockFetch.mockImplementation(function (url) {
            if (url.includes('/api/forecasting/alerts')) {
                return Promise.resolve({
                    ok: true,
                    json: function () { return Promise.resolve({ success: true, data: mockAlertsData }); },
                });
            }
            if (url.includes('/api/forecasting/resource-allocation') && url.includes('POST')) {
                return Promise.resolve({
                    ok: true,
                    json: function () { return Promise.resolve({ success: true, data: mockResourceAllocationData }); },
                });
            }
            if (url.includes('/api/forecasting')) {
                return Promise.resolve({
                    ok: true,
                    json: function () { return Promise.resolve({ success: true, data: mockForecastData }); },
                });
            }
    ...
    describe('Component Rendering', function () {
        test('should render dashboard header with title and controls', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                expect(react_2.screen.getByText('AI-powered demand prediction with ≥80% accuracy')).toBeInTheDocument();
        ...
        test('should render key metrics cards', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
        ...
        test('should render tabs for different views', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                renderWithQueryClient(<forecasting_dashboard_1.default />);
    ...
    describe('Metrics Display', function () {
        test('should calculate and display correct accuracy percentage', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
        ...
        test('should show warning when accuracy is below threshold', function () { return __awaiter(void 0, void 0, void 0, function () {
            var lowAccuracyData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockFetch.mockImplementation(function (url) {
                            ...
                            if (url.includes('/api/forecasting')) {
                                return Promise.resolve({
                                    ok: true,
                                    json: function () { return Promise.resolve({ success: true, data: lowAccuracyData }); },
                                });
                            }
                            return Promise.reject(new Error('Unknown API endpoint'));
                        });
        ...
        test('should display correct count of active forecasts', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
        ...
        test('should display correct count of active alerts', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
        ...
        test('should calculate and display average confidence', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                ...
                                expect(react_2.screen.getByText("".concat(avgConfidence, "%"))).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Chart Rendering', function () {
        test('should render demand forecast trend chart', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
        ...
        test('should render confidence distribution chart', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
        ...
        test('should display accuracy status with progress bar', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                ...
                                expect(react_2.screen.getByText('Meeting accuracy requirements')).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Tab Navigation', function () {
        test('should switch between tabs correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        expect(react_2.screen.getByRole('tabpanel')).toHaveTextContent('Demand Forecast Trend');
                        // Switch to forecasts tab
                        return [4 /*yield*/, user.click(react_2.screen.getByRole('tab', { name: /forecasts/i }))];
                    case 1:
                        // Switch to forecasts tab
                        _a.sent();
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, user.click(react_2.screen.getByRole('tab', { name: /resources/i }))];
                    case 3:
                        // Switch to resources tab
                        _a.sent();
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, user.click(react_2.screen.getByRole('tab', { name: /alerts/i }))];
                    case 5:
                        // Switch to alerts tab
                        _a.sent();
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
    ...
    describe('Forecasts Tab', function () {
        test('should display forecast details correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('should handle empty forecasts gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var emptyData, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockFetch.mockImplementation(function (url) {
                            ...
                            if (url.includes('/api/forecasting')) {
                                return Promise.resolve({
                                    ok: true,
                                    json: function () { return Promise.resolve({ success: true, data: emptyData }); },
                                });
                            }
                            return Promise.reject(new Error('Unknown API endpoint'));
                        });
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                ...
                                expect(react_2.screen.getByRole('button', { name: /generate forecasts/i })).toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Resources Tab', function () {
        test('should display resource allocation recommendations', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('should handle no resource allocations', function () { return __awaiter(void 0, void 0, void 0, function () {
            var emptyData, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                expect(react_2.screen.getByText('No resource allocations available. Generate forecasts first.')).toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Alerts Tab', function () {
        test('should display active alerts correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                ...
                                expect(react_2.screen.getByText('Capacity shortage - critical')).toBeInTheDocument();
                                expect(react_2.screen.getByText('High demand predicted for service-1 next week')).toBeInTheDocument();
                                expect(react_2.screen.getByText('Insufficient capacity for predicted demand')).toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
        ...
        test('should handle no active alerts', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('User Interactions', function () {
        test('should handle regenerate forecast button click', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                expect(sonner_1.toast.success).toHaveBeenCalledWith('Demand forecast generated successfully');
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
        ...
        test('should handle export data button click', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = user_event_1.default.setup();
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
                        mockCreateObjectURL = jest.fn(function () { return 'mock-url'; });
                        ...
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                expect(react_2.screen.getByRole('button', { name: /export/i })).not.toBeDisabled();
                            })];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                ...
                                expect(sonner_1.toast.success).toHaveBeenCalledWith('Forecast data exported successfully');
                            })];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
        ...
        test('should disable export button when no data available', function () { return __awaiter(void 0, void 0, void 0, function () {
            var emptyData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Error Handling', function () {
        test('should display error message when API call fails', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockFetch.mockImplementation(function () {
                            return Promise.resolve({
                                ok: false,
                                status: 500,
                                json: function () { return Promise.resolve({ success: false, error: { message: 'Server error' } }); },
                            });
                        });
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
        ...
        test('should handle network errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockFetch.mockImplementation(function () { return Promise.reject(new Error('Network error')); });
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                expect(react_2.screen.getByText('Error Loading Forecasts')).toBeInTheDocument();
                            })];
        ...
        test('should show error toast when regenerate fails', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockFetch.mockImplementation(function (url) {
                            ...
                            return Promise.resolve({
                                ok: false,
                                status: 500,
                                json: function () { return Promise.resolve({ success: false, error: { message: 'Regenerate failed' } }); },
                            });
                        });
                        renderWithQueryClient(<forecasting_dashboard_1.default />);
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, (0, react_2.waitFor)(function () {
                                expect(sonner_1.toast.error).toHaveBeenCalledWith('Failed to generate forecast: Regenerate failed');
                            })];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Accessibility', function () {
        test('should have proper ARIA labels and roles', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                renderWithQueryClient(<forecasting_dashboard_1.default />);
