...
(0, globals_1.describe)("Dashboard Component", () => {
  (0, globals_1.beforeEach)(() => {
    // Reset any mocks before each test
  });
  (0, globals_1.test)("should render dashboard title", () => {
  ...
  (0, globals_1.test)("should render dashboard subtitle", () => {
    (0, react_1.render)(<page_1.default />);
  ...
  (0, globals_1.test)("should render all KPI cards", () => {
    (0, react_1.render)(<page_1.default />);
  ...
  (0, globals_1.test)("should render KPI labels", () => {
    (0, react_1.render)(<page_1.default />);
  ...
  (0, globals_1.test)("should render action buttons", () => {
    (0, react_1.render)(<page_1.default />);
  ...
  (0, globals_1.test)("should render quick actions section", () => {
    (0, react_1.render)(<page_1.default />);
  ...
  (0, globals_1.test)("should render recent activities section", () => {
    (0, react_1.render)(<page_1.default />);
  ...
  (0, globals_1.test)("should render all icons correctly", () => {
    (0, react_1.render)(<page_1.default />);
  ...
  (0, globals_1.test)("should handle button clicks without errors", () => {
    (0, react_1.render)(<page_1.default />);
    var newPatientButton = react_1.screen.getByText("Novo Paciente");
    var newAppointmentButton = react_1.screen.getByText("Novo Agendamento");
  ...
  (0, globals_1.test)("should render with correct accessibility attributes", () => {
    (0, react_1.render)(<page_1.default />);
    var titleElement = react_1.screen.getByText("Dashboard Executivo");
  ...
  (0, globals_1.test)("should render monthly growth indicators", () => {
    (0, react_1.render)(<page_1.default />);
  ...
  (0, globals_1.test)("should render dashboard with proper layout structure", () => {
  ...
  (0, globals_1.test)("should render with healthcare-specific data", () => {
    (0, react_1.render)(<page_1.default />);
