...
jest.mock("lucide-react", function () {
  return {
    Users: function () {
      return <div data-testid="users-icon">👥</div>;
    },
    Calendar: function () {
      return <div data-testid="calendar-icon">📅</div>;
    },
    TrendingUp: function () {
      return <div data-testid="trending-up-icon">📈</div>;
    },
    DollarSign: function () {
      return <div data-testid="dollar-icon">💲</div>;
    },
    Activity: function () {
      return <div data-testid="activity-icon">⚡</div>;
    },
    Clock: function () {
      return <div data-testid="clock-icon">🕐</div>;
    },
    UserPlus: function () {
      return <div data-testid="user-plus-icon">👤➕</div>;
    },
    CalendarPlus: function () {
      return <div data-testid="calendar-plus-icon">📅➕</div>;
    },
  };
});
