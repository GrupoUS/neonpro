...
describe("ForecastingDashboard", () => {
  ...
  describe("Component Rendering", () => {
    test("should render dashboard header with title and controls", async () => {
      ...
      expect(
        screen.getByText("AI-powered demand prediction with ≥80% accuracy"),
      ).toBeInTheDocument();
  ...
  describe("Resources Tab", () => {
    ...
    test("should handle no resource allocations", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("No resource allocations available. Generate forecasts first."),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("Alerts Tab", () => {
    test("should display active alerts correctly", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText("High demand predicted for service-1 next week"),
        ).toBeInTheDocument();
