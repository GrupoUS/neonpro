        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                ssoManager.generateAuthUrl("google", {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                expect(ssoManager.generateAuthUrl("invalid-provider", {})).rejects.toMatchObject({
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                expect(ssoManager.logout("non-existent-session")).resolves.toBeUndefined(),
              ];
            case 1:
              _a.sent();
              return [2 /*return*/];
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 1:
              ...
              expect(
                (_a = config.globalSettings) === null || _a === void 0 ? void 0 : _a.enabled,
              ).toBe(false);
              expect(
                (_b = config.globalSettings) === null || _b === void 0
                  ? void 0
                  : _b.allowLocalFallback,
              ).toBe(false);
              expect(mockSupabase.insert).toHaveBeenCalled(); // Audit log
              return [2 /*return*/];
          }
