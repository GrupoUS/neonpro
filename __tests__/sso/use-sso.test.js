...
describe('useSSO', function () {
    ...
    describe('getProviders', function () {
        it('should fetch and set providers', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        result = (0, react_1.renderHook)(function () { return (0, use_sso_1.useSSO)(); }).result;
                        expect(result.current.isLoading).toBe(false);
                        expect(result.current.providers).toEqual([]);
                        return [4 /*yield*/, (0, react_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, result.current.getProviders()];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
        ...
        it('should handle fetch error', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('login', function () {
        it('should redirect to authorization URL', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, react_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, result.current.login('google')];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                    ...
                    case 1:
                        _a.sent();
                        expect(fetch).toHaveBeenCalledWith('/api/auth/sso/authorize?provider=google&prompt=select_account');
    ...
    describe('logout', function () {
        it('should logout and redirect', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should handle logout error', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('session management', function () {
        it('should update session state', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                result = (0, react_1.renderHook)(function () { return (0, use_sso_1.useSSO)(); }).result;
