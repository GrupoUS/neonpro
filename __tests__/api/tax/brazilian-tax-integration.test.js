          ...
          switch (_a.label) {
            case 0:
              request = new server_1.NextRequest(
                "http://localhost/api/tax/cnpj?action=validate&cnpj=12345678000190",
              );
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 2:
              ...
              (0, globals_1.expect)(result.data.calculations[0].calculation).toHaveProperty(
                "total_taxes",
              );
              (0, globals_1.expect)(result.data.summary.effective_rate).toBeGreaterThan(0);
              return [2 /*return*/];
      ...
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              request = new server_1.NextRequest(
                "http://localhost/api/tax/nfe?action=status&nfe_id=test-nfe-id",
              );
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
              ...
              testScenarios = [
                {
                  ...
                  expected_iss: 50.0, // 5% ISS rate
                  tax_regime: "simples_nacional",
                },
                {
                  service_value: 5000.0,
                  expected_iss: 250.0,
                  tax_regime: "lucro_presumido",
                },
              ];
            ...
            case 3:
              result = _a.sent();
              (0, globals_1.expect)(response.status).toBe(200);
              (0, globals_1.expect)(result.data.summary.total_taxes).toBeCloseTo(150.5, 2);
              _a.label = 4;
            case 4:
              _i++;
              return [3 /*break*/, 1];
      ...
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              request = new server_1.NextRequest(
                "http://localhost/api/tax/cnpj?action=validate&cnpj=invalid-cnpj",
              );
      ...
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              testCases = [
                { value: 100.0, expected_rate: 15.05 },
                { value: 500.0, expected_rate: 15.05 },
                { value: 1000.0, expected_rate: 15.05 },
              ];
            ...
            case 3:
              result = _a.sent();
              (0, globals_1.expect)(response.status).toBe(200);
              (0, globals_1.expect)(result.data.summary.effective_rate).toBeCloseTo(
                testCase.expected_rate,
                2,
              );
              _a.label = 4;
            case 4:
      ...
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              workflowSteps = [];
              cnpjRequest = new server_1.NextRequest(
                "http://localhost/api/tax/cnpj?action=validate&cnpj=12345678000190",
              );
