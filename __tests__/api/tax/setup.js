...
global.testUtils = {
    ...
    generateMockNFE: function () { return ({
...
global.simulateError = {
    ...
    validationError: function (field) { return ({
        valid: false,
...
global.performanceUtils = {
    measureExecutionTime: function (fn) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    assertPerformance: function (executionTime, maxTime, operation) {
        ...
        if (executionTime >= maxTime) {
            console.warn("\u26A0\uFE0F Performance Warning: ".concat(operation, " took ").concat(executionTime, "ms (max: ").concat(maxTime, "ms)"));
        }
    }
};
