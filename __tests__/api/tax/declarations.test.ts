...
import {
  GET as declarationsGET,
  POST as declarationsPOST,
  PUT as declarationsPUT,
} from "@/app/api/tax/declarations/route";
...
describe("Tax Declarations API - Story 5.5 AC5: Automated Tax Reporting and Declaration Generation", () => {
  ...
  describe("GET /api/tax/declarations - Declaration Listing and Status", () => {
    it("should list all declarations for a clinic", async () => {
      const request = new NextRequest(
        `http://localhost/api/tax/declarations?clinic_id=${testClinicId}&action=list`,
      );
    ...
    it("should get specific declaration details", async () => {
      const request = new NextRequest(
        `http://localhost/api/tax/declarations?declaration_id=${testDeclarationId}&action=details`,
      );
    ...
    it("should filter declarations by type", async () => {
      const request = new NextRequest(
        `http://localhost/api/tax/declarations?clinic_id=${testClinicId}&action=list&type=DEFIS`,
      );
    ...
    it("should filter declarations by period", async () => {
      const request = new NextRequest(
        `http://localhost/api/tax/declarations?clinic_id=${testClinicId}&action=list&year=${testYear}`,
      );
    ...
    it("should filter declarations by status", async () => {
      const request = new NextRequest(
        `http://localhost/api/tax/declarations?clinic_id=${testClinicId}&action=list&status=generated`,
      );
    ...
    it("should download declaration file", async () => {
      const request = new NextRequest(
        `http://localhost/api/tax/declarations?declaration_id=${testDeclarationId}&action=download`,
      );
    ...
    it("should check declaration submission status", async () => {
      const request = new NextRequest(
        `http://localhost/api/tax/declarations?declaration_id=${testDeclarationId}&action=submission-status`,
      );
    ...
    it("should get declaration statistics", async () => {
      const request = new NextRequest(
        `http://localhost/api/tax/declarations?clinic_id=${testClinicId}&action=statistics&year=${testYear}`,
      );
      ...
      jest
        ...
        .mockImplementationOnce(() => ({
          validateDeclaration: jest.fn().mockResolvedValue({
            ...
            validation_errors: ["Invalid revenue amount", "Missing required field: taxpayer_id"],
  ...
  describe("Compliance and Audit Requirements", () => {
    it("should maintain complete audit trail for declarations", async () => {
      const request = new NextRequest(
        `http://localhost/api/tax/declarations?declaration_id=${testDeclarationId}&action=audit-trail`,
      );
