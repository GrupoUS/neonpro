          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                (0, globals_1.expect)(result.data.company_data).toHaveProperty(
                  "atividade_principal",
                );
                (0, globals_1.expect)(result.data.company_data.razao_social).toBe(
                  "CLINICA TESTE LTDA",
                );
        ...
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                request = new server_1.NextRequest(
                  "http://localhost/api/tax/cnpj?action=history&cnpj=".concat(validCNPJ),
                );
                return [4 /*yield*/, (0, route_1.GET)(request)];
              case 1:
                response = _a.sent();
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                (0, globals_1.expect)(result.data.validation_errors).toContain(
                  "Invalid CNPJ format",
                );
                (0, globals_1.expect)(result.data.validation_errors).toContain(
        ...
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                request = new server_1.NextRequest(
                  "http://localhost/api/tax/cnpj?action=invalid&cnpj=".concat(validCNPJ),
                );
                return [4 /*yield*/, (0, route_1.GET)(request)];
              case 1:
                response = _a.sent();
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                request = new server_1.NextRequest(
                  "http://localhost/api/tax/cnpj?action=validate&cnpj=".concat(malformedCNPJ),
                );
            ...
            switch (_a.label) {
              ...
              case 2:
                ...
                (0, globals_1.expect)(result.error).toBe(
                  "Batch size exceeds maximum limit of 100 CNPJs",
                );
                return [2 /*return*/];
            }
          });
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                secondRequest = new server_1.NextRequest(
                  "http://localhost/api/tax/cnpj?action=validate&cnpj=".concat(
                    validCNPJ,
                    "&use_cache=true",
                  ),
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 2:
                ...
                (0, globals_1.expect)(result.data.certifications).toHaveProperty(
                  "medical_licenses",
                );
                (0, globals_1.expect)(result.data.certifications).toHaveProperty(
