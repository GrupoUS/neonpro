...
(0, globals_1.describe)('NFE API - Story 5.5 AC1: Automated NFSe Generation and Submission', function () {
    ...
    (0, globals_1.describe)('GET /api/tax/nfe - NFE Listing and Status', function () {
        (0, globals_1.it)('should list NFEs for a clinic', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest("http://localhost/api/tax/nfe?clinic_id=".concat(testClinicId, "&action=list"));
        ...
        (0, globals_1.it)('should get specific NFE details', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest("http://localhost/api/tax/nfe?nfe_id=".concat(testNFEId, "&action=details"));
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
        ...
        (0, globals_1.it)('should check NFE status with municipal authority', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest("http://localhost/api/tax/nfe?nfe_id=".concat(testNFEId, "&action=status"));
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
        ...
        (0, globals_1.it)('should download NFE XML', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest("http://localhost/api/tax/nfe?nfe_id=".concat(testNFEId, "&action=download&format=xml"));
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
        ...
        (0, globals_1.it)('should filter NFEs by date range', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endDate = '2024-12-31';
                        request = new server_1.NextRequest("http://localhost/api/tax/nfe?clinic_id=".concat(testClinicId, "&action=list&start_date=").concat(startDate, "&end_date=").concat(endDate));
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
        ...
        (0, globals_1.it)('should filter NFEs by status', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest("http://localhost/api/tax/nfe?clinic_id=".concat(testClinicId, "&action=list&status=emitted"));
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
    ...
    (0, globals_1.describe)('POST /api/tax/nfe - NFE Generation and Operations', function () {
        (0, globals_1.it)('should generate new NFE', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should generate and emit NFE immediately', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should cancel NFE', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should retransmit NFE', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should validate NFE data before generation', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should handle batch NFE generation', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('PUT /api/tax/nfe - NFE Updates', function () {
        (0, globals_1.it)('should update NFE metadata', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('DELETE /api/tax/nfe - NFE Removal', function () {
        (0, globals_1.it)('should delete NFE (logical deletion)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest("http://localhost/api/tax/nfe?nfe_id=".concat(testNFEId));
    ...
    (0, globals_1.describe)('Error Handling and Edge Cases', function () {
        ...
        (0, globals_1.it)('should handle invalid NFE ID', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest('http://localhost/api/tax/nfe?nfe_id=invalid-id&action=details');
        ...
        (0, globals_1.it)('should handle missing required fields for NFE generation', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        result = _a.sent();
                        (0, globals_1.expect)(response.status).toBe(400);
                        (0, globals_1.expect)(result.error).toBe('Missing required fields: invoice_id, customer, services');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should handle NFE emission failures', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // Mock emission failure
                        globals_1.jest.mocked(require('@/lib/services/tax/nfe-service').NFEIntegrationService)
                            .mockImplementationOnce(function () { return ({
                            emitNFE: globals_1.jest.fn().mockRejectedValue(new Error('Municipal service unavailable'))
                        }); });
                        request = new server_1.NextRequest('http://localhost/api/tax/nfe', {
                            method: 'POST',
                            body: JSON.stringify({
    ...
    (0, globals_1.describe)('Performance Requirements - AC1', function () {
        (0, globals_1.it)('should generate NFE within 3 seconds', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should emit NFE within 5 seconds', function () { return __awaiter(void 0, void 0, void 0, function () {
            var startTime, request, response, endTime;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should handle concurrent NFE generations efficiently', function () { return __awaiter(void 0, void 0, void 0, function () {
