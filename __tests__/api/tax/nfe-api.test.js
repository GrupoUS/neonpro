...
(0, globals_1.describe)("NFE API - Story 5.5 AC1: Automated NFSe Generation and Submission", () => {
  ...
  (0, globals_1.describe)("GET /api/tax/nfe - NFE Listing and Status", () => {
    (0, globals_1.it)("should list NFEs for a clinic", () =>
    ...
    (0, globals_1.it)("should get specific NFE details", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should check NFE status with municipal authority", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should download NFE XML", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should filter NFEs by date range", () =>
      __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.it)("should filter NFEs by status", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
  ...
  (0, globals_1.describe)("POST /api/tax/nfe - NFE Generation and Operations", () => {
    (0, globals_1.it)("should generate new NFE", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should generate and emit NFE immediately", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should cancel NFE", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should retransmit NFE", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should validate NFE data before generation", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should handle batch NFE generation", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
  ...
  (0, globals_1.describe)("PUT /api/tax/nfe - NFE Updates", () => {
    (0, globals_1.it)("should update NFE metadata", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
  ...
  (0, globals_1.describe)("DELETE /api/tax/nfe - NFE Removal", () => {
    (0, globals_1.it)("should delete NFE (logical deletion)", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
  ...
  (0, globals_1.describe)("Error Handling and Edge Cases", () => {
    ...
    (0, globals_1.it)("should handle invalid NFE ID", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should handle missing required fields for NFE generation", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should handle NFE emission failures", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var request, response, result;
        return __generator(this, (_a) => {
          switch (_a.label) {
  ...
  (0, globals_1.describe)("Performance Requirements - AC1", () => {
    (0, globals_1.it)("should generate NFE within 3 seconds", () =>
      __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.it)("should emit NFE within 5 seconds", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var startTime, request, response, endTime;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should handle concurrent NFE generations efficiently", () =>
      __awaiter(void 0, void 0, void 0, function () {
          ...
          switch (_a.label) {
            case 0:
              concurrentRequests = Array.from(
                { length: 5 },
                (_, index) =>
                  new server_1.NextRequest("http://localhost/api/tax/nfe", {
                    method: "POST",
                    body: JSON.stringify({
                      action: "generate",
                      clinic_id: testClinicId,
