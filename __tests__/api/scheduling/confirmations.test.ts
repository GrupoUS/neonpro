...
describe('/api/scheduling/confirmations', () => {
  ...
  describe('PUT /api/scheduling/confirmations', () => {
    it('should handle patient confirmation response', async () => {
      ...
      expect(data.nextSteps).toEqual(expect.arrayContaining([
  ...
  describe('GET /api/scheduling/confirmations', () => {
    it('should fetch confirmations with filters for authenticated users', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/scheduling/confirmations?clinicId=clinic-123&status=pending')
    ...
    it('should fetch single confirmation by token (public endpoint)', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/scheduling/confirmations?token=token-123')
    ...
    it('should handle invalid tokens gracefully', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/scheduling/confirmations?token=invalid-token')
  ...
  describe('DELETE /api/scheduling/confirmations', () => {
    it('should expire confirmation by ID', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/scheduling/confirmations?id=confirmation-123', {
        method: 'DELETE'
      })
    ...
    it('should expire confirmations by appointment ID', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/scheduling/confirmations?appointmentId=appointment-123', {
        method: 'DELETE'
      })
