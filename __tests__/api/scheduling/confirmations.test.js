        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              (0, globals_1.expect)(data.nextSteps).toEqual(
                globals_1.expect.arrayContaining(["Sua consulta está confirmada"]),
              );
              return [2 /*return*/];
          }
        });
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
                ...
                if (table === "appointment_confirmations") {
                  return {
                    select: globals_1.jest.fn().mockReturnValue({
                      eq: globals_1.jest.fn().mockReturnValue({
                        single: globals_1.jest.fn().mockResolvedValue({
                          data: __assign(__assign({}, mockConfirmation), {
            ...
            case 2:
              ...
              (0, globals_1.expect)(data.nextSteps).toEqual(
                globals_1.expect.arrayContaining(["Solicitação de reagendamento enviada"]),
              );
              return [2 /*return*/];
          }
        });
