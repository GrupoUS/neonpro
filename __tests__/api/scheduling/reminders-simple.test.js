...
jest.mock('../../../lib/communication/scheduling-workflow', function () { return ({
...
jest.mock('../../../lib/communication/communication-service', function () { return ({
...
describe('Reminders API - Simple Test', function () {
    ...
    it('should schedule reminders successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should fetch reminders successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
        var request, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    request = new server_1.NextRequest('http://localhost:3000/api/scheduling/reminders?clinicId=450e8400-e29b-41d4-a716-446655440000');
