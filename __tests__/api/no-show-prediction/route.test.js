          ...
          switch (_a.label) {
            case 0:
              ...
              mockRequest = new server_2.NextRequest(
                "http://localhost:3000/api/no-show-prediction?page=1&limit=10",
              );
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              mockRequest = new server_2.NextRequest(
                "http://localhost:3000/api/no-show-prediction",
              );
              return [4 /*yield*/, (0, route_1.GET)(mockRequest)];
            case 1:
              response = _a.sent();
      ...
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              noShowPredictionEngine =
                require("@/app/lib/services/no-show-prediction").noShowPredictionEngine;
              mockPrediction = {
                id: "prediction-123",
            ...
            case 2:
              ...
              expect(noShowPredictionEngine.generatePrediction).toHaveBeenCalledWith(
                "appointment-123",
              );
              return [2 /*return*/];
          }
