...
// Mock the service
globals_1.jest.mock('@/app/lib/services/treatment-prediction', function () { return ({
    TreatmentPredictionService: globals_1.jest.fn().mockImplementation(function () { return ({
...
(0, globals_1.describe)('Treatment Prediction API Endpoints', function () {
    ...
    (0, globals_1.describe)('POST /api/treatment-prediction/predictions', function () {
        (0, globals_1.test)('generates prediction with high accuracy', function () { return __awaiter(void 0, void 0, void 0, function () {
            var POST, mockPredictionRequest, mockPredictionResponse, request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/app/api/treatment-prediction/predictions/route'); })];
                    case 1:
                        POST = (_a.sent()).POST;
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/treatment-prediction/predictions', {
                            method: 'POST',
        ...
        (0, globals_1.test)('validates required fields', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('handles authentication', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('GET /api/treatment-prediction/predictions', function () {
        (0, globals_1.test)('retrieves predictions with filtering', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        url = new URL('http://localhost:3000/api/treatment-prediction/predictions?patient_id=patient-123&prediction_score_min=0.85');
                    ...
                    case 3:
                        ...
                        (0, globals_1.expect)(data.data.every(function (p) { return p.prediction_score >= 0.85; })).toBe(true);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('POST /api/treatment-prediction/batch', function () {
        (0, globals_1.test)('processes batch predictions efficiently', function () { return __awaiter(void 0, void 0, void 0, function () {
            var POST, mockBatchRequest, mockBatchResponse, request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/app/api/treatment-prediction/batch/route'); })];
                    case 1:
                        POST = (_a.sent()).POST;
                        mockBatchRequest = {
                            predictions: [
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/treatment-prediction/batch', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                    ...
                    case 3:
                        ...
                        (0, globals_1.expect)(data.data.summary.average_confidence).toBeGreaterThanOrEqual(0.85);
    ...
    (0, globals_1.describe)('POST /api/treatment-prediction/models', function () {
        (0, globals_1.test)('creates new prediction model with accuracy validation', function () { return __awaiter(void 0, void 0, void 0, function () {
            var POST, mockModelRequest, mockModelResponse, request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/app/api/treatment-prediction/models/route'); })];
                    case 1:
                        POST = (_a.sent()).POST;
                        mockModelRequest = {
                        ...
                        mockModelResponse = __assign(__assign({}, mockModelRequest), { id: 'model-789', status: 'training', created_at: new Date().toISOString() });
                        mockSupabaseClient.insert.mockResolvedValue({
                            data: mockModelResponse,
                            error: null
                        });
                        request = new server_1.NextRequest('http://localhost:3000/api/treatment-prediction/models', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                    ...
                    case 3:
                        ...
                        (0, globals_1.expect)(data.data.performance_metrics.f1_score).toBeGreaterThanOrEqual(0.85);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('rejects models below accuracy threshold', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('GET /api/treatment-prediction/analytics', function () {
        (0, globals_1.test)('provides comprehensive analytics', function () { return __awaiter(void 0, void 0, void 0, function () {
            var GET, mockAnalytics, request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/app/api/treatment-prediction/analytics/route'); })];
                    case 1:
                        GET = (_a.sent()).GET;
                        mockAnalytics = {
                            overall_metrics: {
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/treatment-prediction/analytics');
                        return [4 /*yield*/, GET(request)];
                    case 2:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
                    case 3:
                        ...
                        (0, globals_1.expect)(response.status).toBe(200);
                        (0, globals_1.expect)(data.success).toBe(true);
                        (0, globals_1.expect)(data.data.overall_metrics.overall_accuracy).toBeGreaterThanOrEqual(0.85);
                        (0, globals_1.expect)(data.data.model_performance.every(function (m) { return m.accuracy >= 0.85; })).toBe(true);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('POST /api/treatment-prediction/feedback', function () {
        (0, globals_1.test)('processes medical professional feedback', function () { return __awaiter(void 0, void 0, void 0, function () {
            var POST, mockFeedbackRequest, mockFeedbackResponse, request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/app/api/treatment-prediction/feedback/route'); })];
                    case 1:
                        POST = (_a.sent()).POST;
                        mockFeedbackRequest = {
                        ...
                        mockFeedbackResponse = __assign(__assign({}, mockFeedbackRequest), { id: 'feedback-123', provider_id: 'user-123', created_at: new Date().toISOString() });
                        mockSupabaseClient.insert.mockResolvedValue({
                            data: mockFeedbackResponse,
                            error: null
                        });
                        request = new server_1.NextRequest('http://localhost:3000/api/treatment-prediction/feedback', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
    ...
    (0, globals_1.describe)('GET /api/treatment-prediction/performance', function () {
        (0, globals_1.test)('monitors real-time performance metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
            var GET, mockPerformanceMetrics, request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/app/api/treatment-prediction/performance/route'); })];
                    case 1:
                        GET = (_a.sent()).GET;
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/treatment-prediction/performance');
                        return [4 /*yield*/, GET(request)];
                    case 2:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
                    case 3:
                        ...
                        (0, globals_1.expect)(data.data.model_health.models_above_threshold).toBeGreaterThan(0);
    ...
    (0, globals_1.describe)('Error Handling', function () {
        (0, globals_1.test)('handles invalid JSON requests', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('handles database errors', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('handles rate limiting', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        POST = (_a.sent()).POST;
                        promises = Array(100).fill(null).map(function () {
                            var request = new server_1.NextRequest('http://localhost:3000/api/treatment-prediction/predictions', {
                                method: 'POST',
                                headers: { 'Content-Type': 'application/json' },
                    ...
                    case 2:
                        responses = _a.sent();
                        successfulRequests = responses.filter(function (r) { return r.status < 400; });
    ...
    (0, globals_1.describe)('Performance Requirements', function () {
        (0, globals_1.test)('meets response time requirements', function () { return __awaiter(void 0, void 0, void 0, function () {
