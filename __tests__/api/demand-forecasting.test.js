...
jest.mock('next/server', function () { return ({
    NextRequest: jest.requireActual('next/server').NextRequest,
    NextResponse: {
        json: jest.fn(function (data, init) { return ({
...
jest.mock('@/app/utils/supabase/server', function () { return ({
    createServerSupabaseClient: jest.fn(function () { return mockSupabaseClient; })
}); });
// Mock demand forecasting engine
jest.mock('@/src/lib/analytics/demand-forecasting', function () { return ({
    DemandForecastingEngine: jest.fn().mockImplementation(function () { return ({
...
describe('/api/forecasting - Demand Forecasting API', function () {
    beforeEach(function () {
        ...
        var DemandForecastingEngine = require('@/src/lib/analytics/demand-forecasting').DemandForecastingEngine;
        DemandForecastingEngine.mockImplementation(function () { return ({
            generateForecast: jest.fn().mockResolvedValue({
                id: '123e4567-e89b-12d3-a456-426614174000',
                accuracy: 0.85,
        ...
        mockSupabaseClient.from.mockImplementation(function (table) {
            if (table === 'appointments') {
                ...
                return __assign(__assign({}, mockSupabaseClient), { insert: jest.fn().mockReturnThis(), select: jest.fn().mockResolvedValue({
                        data: [mockForecast],
                        error: null
                    }), data: [mockForecast], error: null });
            }
    ...
    describe('GET /api/forecasting', function () {
        test('should generate demand forecast with default parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        expect(data.data.accuracy).toBeGreaterThanOrEqual(0.80);
        ...
        test('should generate forecast with custom parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        test('should filter by service ID when provided', function () { return __awaiter(void 0, void 0, void 0, function () {
            var url, request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('should validate accuracy threshold requirement', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('should handle missing appointment data', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('should handle authentication errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('should validate parameter ranges', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Forecast Generation Performance', function () {
        test('should complete forecast generation within time limits', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        test('should handle concurrent forecast requests', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requests, responses;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        requests = Array.from({ length: 3 }, function () {
                            return (0, route_1.GET)(new server_1.NextRequest('http://localhost:3000/api/forecasting'));
                        });
    ...
    describe('Error Handling', function () {
        test('should handle database connection errors', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        test('should handle forecasting engine errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var DemandForecastingEngine, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        DemandForecastingEngine = require('@/src/lib/analytics/demand-forecasting').DemandForecastingEngine;
                        DemandForecastingEngine.mockImplementation(function () { return ({
...
describe('/api/forecasting/resource-allocation - Resource Allocation API', function () {
    beforeEach(function () {
        ...
        mockSupabaseClient.from.mockImplementation(function (table) {
            if (table === 'demand_forecasts') {
                return __assign(__assign({}, mockSupabaseClient), { select: jest.fn().mockReturnThis(), in: jest.fn().mockResolvedValue({
                        data: [mockForecast],
                        error: null
                    }) });
            }
    ...
    describe('POST /api/forecasting/resource-allocation', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/forecasting/resource-allocation', {
                            method: 'POST',
        ...
        test('should handle different optimization strategies', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        test('should validate required request parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        test('should handle empty forecast IDs array', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('should validate optimization type parameter', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('GET /api/forecasting/resource-allocation', function () {
        test('should return current resource allocation status', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest("http://localhost:3000/api/forecasting/resource-allocation?forecastId=".concat(validForecastId));
        ...
        test('should return error for missing forecastId', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test('should handle no existing allocations', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Resource Allocation Performance', function () {
        test('should optimize resource allocation within time constraints', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        test('should handle large numbers of forecasts efficiently', function () { return __awaiter(void 0, void 0, void 0, function () {
