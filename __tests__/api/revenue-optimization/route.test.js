...
globals_1.jest.mock('@/lib/financial/revenue-optimization-engine', function () { return ({
    RevenueOptimizationEngine: globals_1.jest.fn().mockImplementation(function () { return ({
...
(0, globals_1.describe)('Revenue Optimization API', function () {
    ...
    (0, globals_1.beforeEach)(function () {
        ...
        var revenueOptimizationEngine = require('@/lib/financial/revenue-optimization-engine').revenueOptimizationEngine;
        ...
        mockSupabaseClient = {
            ...
            from: globals_1.jest.fn().mockReturnValue({
                ...
                delete: globals_1.jest.fn(function () { return ({
                    eq: globals_1.jest.fn(function () { return ({
                        eq: globals_1.jest.fn(function () { return Promise.resolve({
                            error: null
                        }); })
                    }); })
                }); }),
    ...
    (0, globals_1.describe)('🔥 GET /api/revenue-optimization', function () {
        (0, globals_1.test)('should return comprehensive revenue optimization overview', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, errorData, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest("http://localhost:3000/api/revenue-optimization?clinicId=".concat(validClinicId));
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 6, , 7]);
                    ...
                    case 3:
                        errorData = _a.sent();
                        throw new Error("API returned ".concat(response.status, ": ").concat(JSON.stringify(errorData)));
                    case 4:
        ...
        (0, globals_1.test)('should validate clinic access', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should require clinic ID', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.test)('should handle authentication errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.test)('should call all optimization engines', function () { return __awaiter(void 0, void 0, void 0, function () {
            var revenueOptimizationEngine, request;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        revenueOptimizationEngine = require('@/lib/financial/revenue-optimization-engine').revenueOptimizationEngine;
                        request = new server_1.NextRequest("http://localhost:3000/api/revenue-optimization?clinicId=".concat(validClinicId));
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        _a.sent();
                        (0, globals_1.expect)(revenueOptimizationEngine.optimizePricing).toHaveBeenCalledWith(validClinicId, undefined);
                        (0, globals_1.expect)(revenueOptimizationEngine.optimizeServiceMix).toHaveBeenCalledWith(validClinicId);
                        (0, globals_1.expect)(revenueOptimizationEngine.enhanceCLV).toHaveBeenCalledWith(validClinicId, undefined);
                        (0, globals_1.expect)(revenueOptimizationEngine.generateAutomatedRecommendations).toHaveBeenCalledWith(validClinicId);
                        (0, globals_1.expect)(revenueOptimizationEngine.performCompetitiveAnalysis).toHaveBeenCalledWith(validClinicId);
                        (0, globals_1.expect)(revenueOptimizationEngine.trackROI).toHaveBeenCalledWith(validClinicId, undefined);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should handle engine errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('🔥 POST /api/revenue-optimization', function () {
        (0, globals_1.test)('should create pricing optimization', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        (0, globals_1.expect)(response.status).toBe(200);
                        (0, globals_1.expect)(mockOptimizePricing).toHaveBeenCalledWith(validClinicId, 'service-123');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should create service mix optimization', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.test)('should create CLV optimization', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        response = _a.sent();
                        (0, globals_1.expect)(response.status).toBe(200);
                        (0, globals_1.expect)(mockEnhanceCLV).toHaveBeenCalledWith(validClinicId, 'patient-123');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should create automated recommendations', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        response = _a.sent();
                        (0, globals_1.expect)(response.status).toBe(200);
                        (0, globals_1.expect)(mockGenerateAutomatedRecommendations).toHaveBeenCalledWith(validClinicId);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should create competitive analysis', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        response = _a.sent();
                        (0, globals_1.expect)(response.status).toBe(200);
                        (0, globals_1.expect)(mockPerformCompetitiveAnalysis).toHaveBeenCalledWith(validClinicId);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should create ROI tracking', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.test)('should validate required fields', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.test)('should reject invalid optimization type', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.test)('should handle Supabase insert errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('🔥 PUT /api/revenue-optimization', function () {
        (0, globals_1.test)('should update optimization successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.test)('should validate required fields for update', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.test)('should handle update errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requestBody, request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('🔥 DELETE /api/revenue-optimization', function () {
        (0, globals_1.test)('should delete optimization successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest('http://localhost:3000/api/revenue-optimization?id=opt-1&clinicId=clinic-123', {
                            method: 'DELETE'
                        });
        ...
        (0, globals_1.test)('should validate required parameters for delete', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new server_1.NextRequest('http://localhost:3000/api/revenue-optimization?id=opt-1', {
                            method: 'DELETE'
                            // Missing clinicId
                        });
                        return [4 /*yield*/, (0, route_1.DELETE)(request)];
        ...
        (0, globals_1.test)('should handle delete errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('🔥 Authorization and Security', function () {
        (0, globals_1.test)('should require authentication for all endpoints', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        getRequest = new server_1.NextRequest('http://localhost:3000/api/revenue-optimization?clinicId=clinic-123');
                        postRequest = new server_1.NextRequest('http://localhost:3000/api/revenue-optimization', {
                            method: 'POST',
        ...
        (0, globals_1.test)('should verify clinic access for all endpoints', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/revenue-optimization?clinicId=unauthorized-clinic');
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        (0, globals_1.expect)(response.status).toBe(403);
    ...
    (0, globals_1.describe)('🔥 Performance and Error Handling', function () {
        (0, globals_1.test)('should handle concurrent optimization requests', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabaseClient.from.mockReturnValue({
                            select: globals_1.jest.fn(function () { return ({
                                eq: globals_1.jest.fn(function () { return ({
                                    eq: globals_1.jest.fn(function () { return ({
                                        eq: globals_1.jest.fn(function () { return ({
                                            single: globals_1.jest.fn(function () { return Promise.resolve({ data: { clinic_id: validClinicId }, error: null }); })
                                        }); })
                                    }); })
                                }); })
                            }); })
                        ...
                        requests = Array.from({ length: 5 }, function (_, i) {
                            return new server_1.NextRequest("http://localhost:3000/api/revenue-optimization?clinicId=".concat(validClinicId));
                        });
                        return [4 /*yield*/, Promise.all(requests.map(function (req) { return (0, route_1.GET)(req); }))];
                    case 1:
                        responses = _a.sent();
        ...
        (0, globals_1.test)('should handle malformed JSON in POST requests', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.test)('should timeout gracefully on slow operations', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        timeoutPromise = new Promise(function (_, reject) {
                            return setTimeout(function () { return reject(new Error('Test timeout')); }, 1000);
                        });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
