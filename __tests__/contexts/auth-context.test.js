...
var mockSupabase = {
    auth: {
        ...
        onAuthStateChange: jest.fn(function () { return ({
...
var TestComponent = function () {
    var _a = (0, auth_context_1.useAuth)(), user = _a.user, session = _a.session, loading = _a.loading, signIn = _a.signIn, signUp = _a.signUp, signOut = _a.signOut, signInWithGoogle = _a.signInWithGoogle;
    return (<div>
      <div data-testid="loading">{loading ? 'loading' : 'not-loading'}</div>
      <div data-testid="user">{user ? user.email : 'no-user'}</div>
      <div data-testid="session">{session ? 'has-session' : 'no-session'}</div>
      
      <button onClick={function () { return signIn('test@example.com', 'password'); }} data-testid="signin-btn">
        Sign In
      </button>
      
      <button onClick={function () { return signUp('test@example.com', 'password', 'Test User'); }} data-testid="signup-btn">
        Sign Up
      </button>
      
      <button onClick={function () { return signOut(); }} data-testid="signout-btn">
        Sign Out
      </button>
      
      <button onClick={function () { return signInWithGoogle(); }} data-testid="google-signin-btn">
        Sign In with Google
      </button>
    </div>);
};
describe('AuthProvider', function () {
    ...
    it('provides auth context to children', function () {
        (0, react_2.render)(<auth_context_1.AuthProvider>
        <TestComponent />
    ...
    it('initializes with session when available', function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockSession;
    ...
    it('handles sign in successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('handles sign in error', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('handles sign up successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('handles sign up without name', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    TestSignUpWithoutName = function () {
                        ...
                        return (<button onClick={function () { return signUp('test@example.com', 'password'); }} data-testid="signup-no-name-btn">
          Sign Up No Name
        </button>);
                    };
                    (0, react_2.render)(<auth_context_1.AuthProvider>
    ...
    it('handles sign out', function () { return __awaiter(void 0, void 0, void 0, function () {
        var signOutBtn;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('handles Google OAuth', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('handles Google OAuth error', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('handles auth state changes', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('cleans up subscription on unmount', function () {
        ...
        var unmount = (0, react_2.render)(<auth_context_1.AuthProvider>
        <TestComponent />
      </auth_context_1.AuthProvider>).unmount;
        unmount();
