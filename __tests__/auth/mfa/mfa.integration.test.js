...
var TestDatabaseManager = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, this.supabase.from('mfa_audit_logs').delete().eq('user_id', userId)];
                    case 1:
                        // Clean up test data in reverse dependency order
                        _a.sent();
                        return [4 /*yield*/, this.supabase.from('user_trusted_devices').delete().eq('user_id', userId)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.supabase.from('user_mfa_methods').delete().eq('user_id', userId)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.supabase.from('user_mfa_sms_tokens').delete().eq('user_id', userId)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.supabase.from('user_mfa_settings').delete().eq('user_id', userId)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    TestDatabaseManager.prototype.createTestUser = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.supabase.from('users').upsert({
                            id: userId,
...
(0, globals_1.describe)('MFA Integration Tests', function () {
    ...
    (0, globals_1.describe)('MFA Setup Flow', function () {
        (0, globals_1.describe)('TOTP Setup', function () {
            (0, globals_1.it)('should successfully setup TOTP with valid parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            (0, globals_1.expect)(result.backupCodes.every(function (code) { return code.length === 10; })).toBe(true);
            ...
            (0, globals_1.it)('should validate LGPD consent requirement', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            // Act & Assert
                            return [4 /*yield*/, (0, globals_1.expect)(mfaService.setupMFA(mockUserId, 'totp', setupRequest)).rejects.toThrow('LGPD consent is required')];
                        case 1:
                            // Act & Assert
                            _a.sent();
                            return [4 /*yield*/, dbManager.getMFASettings(mockUserId)];
            ...
            (0, globals_1.it)('should prevent duplicate MFA setup', function () { return __awaiter(void 0, void 0, void 0, function () {
                var setupRequest;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, (0, globals_1.expect)(mfaService.setupMFA(mockUserId, 'totp', setupRequest)).rejects.toThrow('MFA already enabled for this user')];
                        case 2:
                            // Act & Assert - Second setup should fail
                            _a.sent();
                            return [2 /*return*/];
        ...
        (0, globals_1.describe)('SMS Setup', function () {
            (0, globals_1.it)('should successfully setup SMS with valid phone number', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            (0, globals_1.it)('should validate phone number requirement for SMS', function () { return __awaiter(void 0, void 0, void 0, function () {
                var setupRequest;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            // Act & Assert
                            return [4 /*yield*/, (0, globals_1.expect)(mfaService.setupMFA(mockUserId, 'sms', setupRequest)).rejects.toThrow()];
                        case 1:
                            // Act & Assert
                            _a.sent();
                            return [2 /*return*/];
    ...
    (0, globals_1.describe)('MFA Verification Flow', function () {
        ...
        (0, globals_1.describe)('TOTP Verification', function () {
            (0, globals_1.it)('should successfully verify valid TOTP token', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, mfaService.verifyMFA(mockUserId, validToken, 'totp', {
                                    userAgent: mockUserAgent,
                                    ipAddress: mockIpAddress,
                        ...
                        case 2:
                            auditLogs = _a.sent();
                            verifyLog = auditLogs.find(function (log) { return log.action === 'verify'; });
            ...
            (0, globals_1.it)('should reject invalid TOTP token', function () { return __awaiter(void 0, void 0, void 0, function () {
                var invalidToken, result, auditLogs, verifyLog;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            invalidToken = '123456';
                            return [4 /*yield*/, mfaService.verifyMFA(mockUserId, invalidToken, 'totp', {
                                    userAgent: mockUserAgent,
                                    ipAddress: mockIpAddress,
                                })];
                        case 1:
            ...
            (0, globals_1.it)('should handle TOTP token window tolerance', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, mfaService.verifyMFA(mockUserId, previousToken, 'totp', {
                                    userAgent: mockUserAgent,
                                    ipAddress: mockIpAddress,
                                })];
                        case 1:
        ...
        (0, globals_1.describe)('Backup Code Verification', function () {
            (0, globals_1.it)('should successfully verify valid backup code', function () { return __awaiter(void 0, void 0, void 0, function () {
                var validBackupCode, result, mfaSettings;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            validBackupCode = backupCodes[0];
                            return [4 /*yield*/, mfaService.verifyMFA(mockUserId, validBackupCode, 'backup', {
                                    userAgent: mockUserAgent,
                                    ipAddress: mockIpAddress,
                                })];
                        case 1:
            ...
            (0, globals_1.it)('should reject reused backup code', function () { return __awaiter(void 0, void 0, void 0, function () {
                var backupCode, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            backupCode = backupCodes[0];
                            return [4 /*yield*/, mfaService.verifyMFA(mockUserId, backupCode, 'backup', {
                                    userAgent: mockUserAgent,
                                    ipAddress: mockIpAddress,
                                })];
                        case 1:
            ...
            (0, globals_1.it)('should reject invalid backup code', function () { return __awaiter(void 0, void 0, void 0, function () {
                var invalidBackupCode, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            invalidBackupCode = 'INVALIDCODE';
                            return [4 /*yield*/, mfaService.verifyMFA(mockUserId, invalidBackupCode, 'backup', {
                                    userAgent: mockUserAgent,
                                    ipAddress: mockIpAddress,
                                })];
                        case 1:
    ...
    (0, globals_1.describe)('Rate Limiting and Security', function () {
        ...
        (0, globals_1.it)('should enforce rate limiting after failed attempts', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        i++;
                        return [3 /*break*/, 1];
                    case 4: return [4 /*yield*/, mfaService.verifyMFA(mockUserId, invalidToken, 'totp', {
                            userAgent: mockUserAgent,
                            ipAddress: mockIpAddress,
                        })];
                    case 5:
                    ...
                    case 6:
                        auditLogs = _a.sent();
                        lockedLog = auditLogs.find(function (log) { return log.result === 'locked'; });
                        (0, globals_1.expect)(lockedLog).toBeDefined();
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should reset rate limiting after successful verification', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        i++;
                        return [3 /*break*/, 1];
                    case 4: return [4 /*yield*/, dbManager.getMFASettings(mockUserId)];
                    case 5:
                        mfaSettings = _a.sent();
                        totp = new OTPAuth.TOTP({
    ...
    (0, globals_1.describe)('Emergency Bypass', function () {
        ...
        (0, globals_1.it)('should allow emergency bypass with valid reason', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result, auditLogs, bypassLog;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mfaService.verifyMFA(mockUserId, '000000', // Placeholder token for emergency
                        'emergency', {
                            userAgent: mockUserAgent,
                            ipAddress: mockIpAddress,
                    ...
                    case 2:
                        auditLogs = _a.sent();
                        bypassLog = auditLogs.find(function (log) { return log.action === 'bypass'; });
        ...
        (0, globals_1.it)('should enforce daily emergency bypass limit', function () { return __awaiter(void 0, void 0, void 0, function () {
            var i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        if (!(i < 3)) return [3 /*break*/, 4];
                        return [4 /*yield*/, mfaService.verifyMFA(mockUserId, '000000', 'emergency', {
                                userAgent: mockUserAgent,
                                ipAddress: mockIpAddress,
                                emergencyBypass: true,
                    ...
                    return [4 /*yield*/, (0, globals_1.expect)(mfaService.verifyMFA(mockUserId, '000000', 'emergency', {
                            userAgent: mockUserAgent,
                            ipAddress: mockIpAddress,
                            emergencyBypass: true,
    ...
    (0, globals_1.describe)('Device Trust Management', function () {
        ...
        (0, globals_1.it)('should register trusted device after successful verification', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mfaSettings, totp, validToken, trustedDevices;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dbManager.getMFASettings(mockUserId)];
                    case 1:
                        mfaSettings = _a.sent();
                        totp = new OTPAuth.TOTP({
                            secret: OTPAuth.Secret.fromBase32(mfaSettings.secret),
                    ...
                    case 2:
                        // Act
                        _a.sent();
                        return [4 /*yield*/, dbManager.supabase
    ...
    (0, globals_1.describe)('Healthcare Compliance', function () {
        (0, globals_1.it)('should create comprehensive audit logs for compliance', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        auditLogs.forEach(function (log) {
                            ...
                            (0, globals_1.expect)(['setup', 'verify', 'bypass', 'disable']).toContain(log.action);
        ...
        (0, globals_1.it)('should handle LGPD consent validation', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    (0, globals_1.describe)('Error Handling', function () {
        (0, globals_1.it)('should handle database connection errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var invalidService;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // Act & Assert
                        return [4 /*yield*/, (0, globals_1.expect)(invalidService.setupMFA(mockUserId, 'totp', {
                                method: 'totp',
                                deviceName: 'Test Device',
                                lgpdConsent: true,
                                userAgent: mockUserAgent,
        ...
        (0, globals_1.it)('should validate input parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // Test empty user ID
                    return [4 /*yield*/, (0, globals_1.expect)(mfaService.setupMFA('', 'totp', {
                            method: 'totp',
                            deviceName: 'Test Device',
                            lgpdConsent: true,
                            userAgent: mockUserAgent,
                    ...
                    case 1:
                        ...
                        _a.sent();
                        // Test invalid method
                        return [4 /*yield*/, (0, globals_1.expect)(mfaService.setupMFA(mockUserId, 'invalid', {
                                method: 'invalid',
                                deviceName: 'Test Device',
                                lgpdConsent: true,
                                userAgent: mockUserAgent,
    ...
    (0, globals_1.describe)('Backup Code Management', function () {
        ...
        (0, globals_1.it)('should generate new backup codes', function () { return __awaiter(void 0, void 0, void 0, function () {
            var newBackupCodes, mfaSettings, auditLogs, recoverLog;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mfaService.generateNewBackupCodes(mockUserId, {
                            userAgent: mockUserAgent,
                            ipAddress: mockIpAddress,
                        })];
                    case 1:
                        ...
                        (0, globals_1.expect)(newBackupCodes.every(function (code) { return code.length === 10; })).toBe(true);
                        (0, globals_1.expect)(newBackupCodes.every(function (code) { return /^[A-F0-9]+$/.test(code); })).toBe(true);
                        return [4 /*yield*/, dbManager.getMFASettings(mockUserId)];
                    case 2:
                        mfaSettings = _a.sent();
                    ...
                    case 3:
                        auditLogs = _a.sent();
                        recoverLog = auditLogs.find(function (log) { return log.action === 'recover'; });
    ...
    (0, globals_1.describe)('Statistics and Monitoring', function () {
        (0, globals_1.it)('should provide accurate MFA statistics', function () { return __awaiter(void 0, void 0, void 0, function () {
