...
exports.testConfig = exports.cleanup = exports.measurePerformance = exports.createTestDatabase = exports.mockTimers = exports.mockConsole = exports.waitFor = exports.createMockUser = exports.createMockNotification = exports.createMockSecurityEvent = exports.createMockDevice = exports.createMockSession = void 0;
...
var createMockSession = function (overrides) {
    ...
    return (__assign({ id: 'session-123', userId: 'user-123', deviceId: 'device-123', tokenHash: 'hashed-token', status: 'active', createdAt: new Date().toISOString(), expiresAt: new Date(Date.now() + 24 * 60 * 60 * 1000).toISOString(), lastActivity: new Date().toISOString(), ipAddress: '192.168.1.1', userAgent: 'Mozilla/5.0...', metadata: {} }, overrides));
};
exports.createMockSession = createMockSession;
var createMockDevice = function (overrides) {
    if (overrides === void 0) { overrides = {}; }
    return (__assign({ id: 'device-123', userId: 'user-123', fingerprint: 'device-fingerprint-123', name: 'Test Device', type: 'desktop', trusted: false, blocked: false, firstSeen: new Date().toISOString(), lastSeen: new Date().toISOString(), trustExpiresAt: null, userAgent: 'Mozilla/5.0...', metadata: {} }, overrides));
};
exports.createMockDevice = createMockDevice;
var createMockSecurityEvent = function (overrides) {
    if (overrides === void 0) { overrides = {}; }
    return (__assign({ id: 'event-123', userId: 'user-123', sessionId: 'session-123', deviceId: 'device-123', type: 'login_attempt', severity: 'medium', description: 'User login attempt', details: {
            ipAddress: '192.168.1.1',
            userAgent: 'Mozilla/5.0...',
            success: true
        }, resolved: false, resolvedAt: null, resolvedBy: null, createdAt: new Date().toISOString(), ipAddress: '192.168.1.1', userAgent: 'Mozilla/5.0...' }, overrides));
};
exports.createMockSecurityEvent = createMockSecurityEvent;
var createMockNotification = function (overrides) {
    if (overrides === void 0) { overrides = {}; }
    return (__assign({ id: 'notification-123', userId: 'user-123', type: 'security_alert', title: 'Security Alert', message: 'New device detected', data: {
            deviceId: 'device-123',
            deviceName: 'Unknown Device'
        }, read: false, readAt: null, createdAt: new Date().toISOString(), expiresAt: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString() }, overrides));
};
exports.createMockNotification = createMockNotification;
var createMockUser = function (overrides) {
    if (overrides === void 0) { overrides = {}; }
    return (__assign({ id: 'user-123', email: 'test@example.com', emailConfirmed: true, phone: null, phoneConfirmed: false, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), lastSignInAt: new Date().toISOString(), role: 'authenticated' }, overrides));
};
...
var createTestDatabase = function () {
    ...
    var generateId = function () { return "test-".concat(Math.random().toString(36).substr(2, 9)); };
    return {
        // Session operations
        ...
        getSession: function (id) { return mockDb.sessions.get(id); },
        ...
        deleteSession: function (id) { return mockDb.sessions.delete(id); },
        // Device operations
        ...
        getDevice: function (id) { return mockDb.devices.get(id); },
        getUserDevices: function (userId) {
            return Array.from(mockDb.devices.values())
                .filter(function (device) { return device.userId === userId; });
        },
        ...
        getSecurityEvents: function (userId) {
            return Array.from(mockDb.securityEvents.values())
                .filter(function (event) { return event.userId === userId; });
        },
        ...
        getUserNotifications: function (userId) {
            return Array.from(mockDb.notifications.values())
...
var measurePerformance = function (fn, name) { return __awaiter(void 0, void 0, void 0, function () {
