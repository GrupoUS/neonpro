...
(0, globals_1.describe)('SessionManager', function () {
    ...
    (0, globals_1.describe)('Session Creation', function () {
        (0, globals_1.it)('should create a new session successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should generate unique session tokens', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        mockSession = (0, setup_1.createMockSession)(__assign(__assign({}, sessionData), { id: "session-".concat(i) }));
                        mockSupabase.from().insert().select().single.mockResolvedValue({
                            data: mockSession,
                            error: null
                        });
        ...
        (0, globals_1.it)('should enforce maximum session limit', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        existingSessions = Array.from({ length: 5 }, function (_, i) {
                            return (0, setup_1.createMockSession)(__assign(__assign({}, sessionData), { id: "session-".concat(i) }));
                        });
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)((_a = result.error) === null || _a === void 0 ? void 0 : _a.code).toBe('SESSION_LIMIT_EXCEEDED');
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Session Validation', function () {
        (0, globals_1.it)('should validate active session successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should reject expired session', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockSession, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should reject inactive session', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockSession, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should handle non-existent session', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('Session Updates', function () {
        (0, globals_1.it)('should update session activity', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockSession, updatedSession, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockSession = (0, setup_1.createMockSession)();
                        updatedSession = __assign(__assign({}, mockSession), { lastActivity: new Date().toISOString() });
                    ...
                    case 1:
                        result = _a.sent();
                        (0, globals_1.expect)(result.success).toBe(true);
                        (0, globals_1.expect)(mockSupabase.from().update).toHaveBeenCalledWith(globals_1.expect.objectContaining({
        ...
        (0, globals_1.it)('should extend session expiration on activity', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        updatedSession = __assign(__assign({}, mockSession), { expiresAt: futureExpiration, lastActivity: new Date().toISOString() });
                        mockSupabase.from().update().eq().select().single.mockResolvedValue({
                            data: updatedSession,
                            error: null
                        });
    ...
    (0, globals_1.describe)('Session Termination', function () {
        (0, globals_1.it)('should terminate single session', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockSupabase.from().update().eq().select().single.mockResolvedValue({
                            data: __assign(__assign({}, (0, setup_1.createMockSession)()), { status: 'terminated' }),
                            error: null
                        });
        ...
        (0, globals_1.it)('should terminate all user sessions', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        mockSupabase.from().update().in().mockResolvedValue({
                            data: mockSessions.map(function (s) { return (__assign(__assign({}, s), { status: 'terminated' })); }),
                            error: null
                        });
                    ...
                    case 1:
                        result = _b.sent();
                        (0, globals_1.expect)(result.success).toBe(true);
                        (0, globals_1.expect)((_a = result.data) === null || _a === void 0 ? void 0 : _a.terminatedCount).toBe(3);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Session Cleanup', function () {
        (0, globals_1.it)('should clean up expired sessions', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should clean up inactive sessions', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        mockSupabase.from().update().in().mockResolvedValue({
                            data: inactiveSessions.map(function (s) { return (__assign(__assign({}, s), { status: 'inactive' })); }),
                            error: null
                        });
                    ...
                    case 1:
                        result = _b.sent();
                        (0, globals_1.expect)(result.success).toBe(true);
                        (0, globals_1.expect)((_a = result.data) === null || _a === void 0 ? void 0 : _a.inactiveCount).toBe(1);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Session Queries', function () {
        (0, globals_1.it)('should get user sessions', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should get session statistics', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('Error Handling', function () {
        ...
        (0, globals_1.it)('should handle invalid input data', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, sessionManager.createSession({
    ...
    (0, globals_1.describe)('Security Features', function () {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (i > 5) { // After 5 attempts, should be rate limited
                            (0, globals_1.expect)(result.success).toBe(false);
                            (0, globals_1.expect)((_a = result.error) === null || _a === void 0 ? void 0 : _a.code).toBe('RATE_LIMIT_EXCEEDED');
                        }
                        _b.label = 3;
                    case 3:
                        i++;
        ...
        (0, globals_1.it)('should validate session token format', function () { return __awaiter(void 0, void 0, void 0, function () {
