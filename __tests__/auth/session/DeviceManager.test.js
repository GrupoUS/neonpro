...
(0, globals_1.describe)('DeviceManager', function () {
    ...
    (0, globals_1.describe)('Device Registration', function () {
        (0, globals_1.it)('should register a new device successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should detect existing device by fingerprint', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should enforce device limit per user', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)((_a = result.error) === null || _a === void 0 ? void 0 : _a.code).toBe('DEVICE_LIMIT_EXCEEDED');
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Device Trust Management', function () {
        (0, globals_1.it)('should trust a device successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        trustedDevice = __assign(__assign({}, mockDevice), { trusted: true, trustExpiresAt: new Date(Date.now() + mockConfig.trustDuration).toISOString() });
                    ...
                    case 1:
                        result = _c.sent();
                        (0, globals_1.expect)(result.success).toBe(true);
                        (0, globals_1.expect)((_a = result.data) === null || _a === void 0 ? void 0 : _a.trusted).toBe(true);
                        (0, globals_1.expect)((_b = result.data) === null || _b === void 0 ? void 0 : _b.trustExpiresAt).toBeDefined();
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should revoke device trust', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        untrustedDevice = __assign(__assign({}, mockDevice), { trusted: false, trustExpiresAt: null });
                        mockSupabase.from().update().eq().select().single.mockResolvedValue({
                    ...
                    case 1:
                        result = _c.sent();
                        (0, globals_1.expect)(result.success).toBe(true);
                        (0, globals_1.expect)((_a = result.data) === null || _a === void 0 ? void 0 : _a.trusted).toBe(false);
                        (0, globals_1.expect)((_b = result.data) === null || _b === void 0 ? void 0 : _b.trustExpiresAt).toBeNull();
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        (0, globals_1.it)('should auto-trust devices on same network', function () { return __awaiter(void 0, void 0, void 0, function () {
            var configWithAutoTrust, existingDevice, newDeviceData, autoTrustedDevice, result;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        configWithAutoTrust = __assign(__assign({}, mockConfig), { autoTrustSameNetwork: true });
                        ...
                        autoTrustedDevice = (0, setup_1.createMockDevice)(__assign(__assign({}, newDeviceData), { trusted: true }));
                        mockSupabase.from().insert().select().single.mockResolvedValue({
    ...
    (0, globals_1.describe)('Device Blocking', function () {
        (0, globals_1.it)('should block a suspicious device', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        blockedDevice = __assign(__assign({}, mockDevice), { blocked: true, blockedAt: new Date().toISOString(), blockedReason: 'Suspicious activity detected' });
                        mockSupabase.from().update().eq().select().single.mockResolvedValue({
                            data: blockedDevice,
                            error: null
                        });
                        return [4 /*yield*/, deviceManager.blockDevice('device-123', 'Suspicious activity detected')];
                    case 1:
                        result = _c.sent();
                        (0, globals_1.expect)(result.success).toBe(true);
                        (0, globals_1.expect)((_a = result.data) === null || _a === void 0 ? void 0 : _a.blocked).toBe(true);
                        (0, globals_1.expect)((_b = result.data) === null || _b === void 0 ? void 0 : _b.blockedReason).toBe('Suspicious activity detected');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should unblock a device', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        unblockedDevice = __assign(__assign({}, mockDevice), { blocked: false, blockedAt: null, blockedReason: null });
                        mockSupabase.from().update().eq().select().single.mockResolvedValue({
                    ...
                    case 1:
                        result = _b.sent();
                        (0, globals_1.expect)(result.success).toBe(true);
                        (0, globals_1.expect)((_a = result.data) === null || _a === void 0 ? void 0 : _a.blocked).toBe(false);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should detect suspicious device patterns', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                for (_i = 0, suspiciousDevices_1 = suspiciousDevices; _i < suspiciousDevices_1.length; _i++) {
    ...
    (0, globals_1.describe)('Device Information', function () {
        (0, globals_1.it)('should get user devices', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should get device statistics', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('Device Cleanup', function () {
        (0, globals_1.it)('should clean up inactive devices', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should revoke expired trust', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        mockSupabase.from().update().in().mockResolvedValue({
                            data: expiredTrustDevices.map(function (d) { return (__assign(__assign({}, d), { trusted: false, trustExpiresAt: null })); }),
                            error: null
                        });
    ...
    (0, globals_1.describe)('Error Handling', function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, deviceManager.registerDevice({
                                userId: 'user-123',
        ...
        (0, globals_1.it)('should handle invalid device data', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('Security Features', function () {
        (0, globals_1.it)('should detect device fingerprint collisions', function () { return __awaiter(void 0, void 0, void 0, function () {
            var existingDevice, result;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        result = _b.sent();
                        (0, globals_1.expect)(result.success).toBe(false);
                        (0, globals_1.expect)((_a = result.error) === null || _a === void 0 ? void 0 : _a.code).toBe('FINGERPRINT_COLLISION');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.it)('should validate device fingerprint format', function () {
            ...
            for (var _i = 0, invalidFingerprints_1 = invalidFingerprints; _i < invalidFingerprints_1.length; _i++) {
