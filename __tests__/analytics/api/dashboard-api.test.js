...
(0, globals_1.describe)('Analytics Dashboard API Routes', function () {
    ...
    (0, globals_1.describe)('GET /api/analytics/dashboard', function () {
        (0, globals_1.test)('should return dashboard metrics for authenticated user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should respect rate limiting', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requests = Array(11).fill(null).map(function () { return (0, route_1.GET)(request); });
                        return [4 /*yield*/, Promise.all(requests)];
                    case 1:
                        responses = _a.sent();
                        lastResponse = responses[responses.length - 1];
                        rateLimitedResponse = responses.find(function (res) { return res.status === 429; });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/analytics/dashboard?period=invalid&limit=abc', { method: 'GET' });
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
    ...
    (0, globals_1.describe)('POST /api/analytics/dashboard', function () {
        (0, globals_1.test)('should create custom dashboard configuration', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        (0, globals_1.expect)(mockSupabase.from).toHaveBeenCalledWith('dashboard_configurations');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should validate dashboard configuration schema', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('caching behavior', function () {
        (0, globals_1.test)('should return cached data when available', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should set appropriate cache headers', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        // Assert
                        (0, globals_1.expect)(response.headers.get('cache-control')).toBe('public, max-age=300');
    ...
    (0, globals_1.describe)('security', function () {
        (0, globals_1.test)('should include security headers', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should validate user permissions for admin endpoints', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockUser, request, response, responseData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/analytics/dashboard?admin=true', { method: 'GET' });
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
    ...
    (0, globals_1.describe)('error handling', function () {
        (0, globals_1.test)('should handle malformed JSON requests', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockUser, request, response, responseData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.test)('should handle unexpected server errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var request, response, responseData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
