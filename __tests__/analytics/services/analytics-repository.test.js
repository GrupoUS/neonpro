...
(0, globals_1.describe)('AnalyticsRepository', function () {
    ...
    (0, globals_1.describe)('getSubscriptionMetrics', function () {
        (0, globals_1.test)('should fetch subscription metrics from database', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should handle database errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabase.from.mockReturnValue(mockFrom);
                        // Act & Assert
                        return [4 /*yield*/, (0, globals_1.expect)(repository.getSubscriptionMetrics('monthly'))
                                .rejects
        ...
        (0, globals_1.test)('should handle missing data gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockFrom;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('getTrialMetrics', function () {
        (0, globals_1.test)('should fetch trial metrics with AI predictions', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should handle RPC function calls for complex analytics', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(mockSupabase.rpc).toHaveBeenCalledWith('calculate_trial_conversion_ai', {
                            user_id: 'user123'
                        });
                        return [2 /*return*/];
                }
    ...
    (0, globals_1.describe)('getCohortAnalysis', function () {
        (0, globals_1.test)('should fetch cohort data with retention rates', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('getRevenueForecasting', function () {
        (0, globals_1.test)('should fetch revenue predictions from ML model', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('real-time subscriptions', function () {
        (0, globals_1.test)('should set up real-time listener for metrics updates', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(mockChannel.on).toHaveBeenCalledWith('postgres_changes', globals_1.expect.objectContaining({
                            event: '*',
                            schema: 'public',
    ...
    (0, globals_1.describe)('data validation', function () {
        (0, globals_1.test)('should validate subscription metrics data format', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should validate date ranges for cohort analysis', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endDate = new Date('2024-01-31');
                        // Act & Assert
                        return [4 /*yield*/, (0, globals_1.expect)(repository.getCohortAnalysis(startDate, endDate))
                                .rejects
    ...
    (0, globals_1.describe)('performance optimization', function () {
        (0, globals_1.test)('should implement connection pooling', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should handle concurrent requests efficiently', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabase.from.mockReturnValue(mockFrom);
                        startTime = Date.now();
                        promises = Array(10).fill(null).map(function () {
                            return repository.getSubscriptionMetrics('monthly');
                        });
                        return [4 /*yield*/, Promise.all(promises)];
                    case 1:
