...
(0, globals_1.describe)('AnalyticsService', function () {
    ...
    (0, globals_1.describe)('getSubscriptionMetrics', function () {
        (0, globals_1.test)('should return cached metrics when available', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(mockRepository.getSubscriptionMetrics).toHaveBeenCalledWith('monthly');
                        (0, globals_1.expect)(mockRepository.getSubscriptionMetrics).toHaveBeenCalledTimes(1);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should handle repository errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // Act & Assert
                        return [4 /*yield*/, (0, globals_1.expect)(analyticsService.getSubscriptionMetrics('monthly'))
                                .rejects
        ...
        (0, globals_1.test)('should validate period parameter', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // Act & Assert
                    return [4 /*yield*/, (0, globals_1.expect)(analyticsService.getSubscriptionMetrics('invalid'))
                            .rejects
    ...
    (0, globals_1.describe)('getTrialMetrics', function () {
        (0, globals_1.test)('should return trial conversion data with AI predictions', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(result.conversionPredictions[0].probability).toBeGreaterThan(0.8);
                        (0, globals_1.expect)(mockRepository.getTrialMetrics).toHaveBeenCalledWith('monthly');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should handle empty trial data', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('getCohortAnalysis', function () {
        (0, globals_1.test)('should return cohort retention data', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(mockRepository.getCohortAnalysis).toHaveBeenCalledWith(startDate, endDate);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should validate date range parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // Act & Assert
                        return [4 /*yield*/, (0, globals_1.expect)(analyticsService.getCohortAnalysis(startDate, endDate))
                                .rejects
    ...
    (0, globals_1.describe)('getRevenueForecasting', function () {
        (0, globals_1.test)('should return revenue predictions with confidence intervals', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(result.predictions[0].confidence.lower).toBeLessThan(result.predictions[0].value);
                        (0, globals_1.expect)(result.predictions[0].confidence.upper).toBeGreaterThan(result.predictions[0].value);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should validate periods parameter', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // Act & Assert
                    return [4 /*yield*/, (0, globals_1.expect)(analyticsService.getRevenueForecasting(0))
                            .rejects
                            .toThrow('Periods must be greater than 0')];
                    case 1:
                        // Act & Assert
                        _a.sent();
                        return [4 /*yield*/, (0, globals_1.expect)(analyticsService.getRevenueForecasting(25))
                                .rejects
    ...
    (0, globals_1.describe)('caching behavior', function () {
        (0, globals_1.test)('should cache subscription metrics and return cached data on subsequent calls', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        (0, globals_1.expect)(mockRepository.getSubscriptionMetrics).toHaveBeenCalledTimes(1); // Should be cached
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should invalidate cache after specified TTL', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    (0, globals_1.describe)('error handling', function () {
        (0, globals_1.test)('should handle network errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // Arrange
        ...
        (0, globals_1.test)('should handle malformed data gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // Arrange
    ...
    (0, globals_1.describe)('performance metrics', function () {
        (0, globals_1.test)('should complete subscription metrics retrieval within acceptable time', function () { return __awaiter(void 0, void 0, void 0, function () {
