...
(0, globals_1.describe)("AnalyticsService", function () {
  ...
  (0, globals_1.describe)("getSubscriptionMetrics", function () {
    (0, globals_1.test)("should return cached metrics when available", function () {
    ...
    (0, globals_1.test)("should handle repository errors gracefully", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var errorMessage;
        return __generator(this, function (_a) {
          switch (_a.label) {
    ...
    (0, globals_1.test)("should validate period parameter", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
  ...
  (0, globals_1.describe)("getTrialMetrics", function () {
    (0, globals_1.test)("should return trial conversion data with AI predictions", function () {
      return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.test)("should handle empty trial data", function () {
      return __awaiter(void 0, void 0, void 0, function () {
  ...
  (0, globals_1.describe)("getCohortAnalysis", function () {
    (0, globals_1.test)("should return cohort retention data", function () {
      return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.test)("should validate date range parameters", function () {
      return __awaiter(void 0, void 0, void 0, function () {
  ...
  (0, globals_1.describe)("getRevenueForecasting", function () {
    (0, globals_1.test)("should return revenue predictions with confidence intervals", function () {
      return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.test)("should validate periods parameter", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
  ...
  (0, globals_1.describe)("caching behavior", function () {
    ...
    (0, globals_1.test)("should invalidate cache after specified TTL", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
  ...
  (0, globals_1.describe)("error handling", function () {
    (0, globals_1.test)("should handle network errors gracefully", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
    ...
    (0, globals_1.test)("should handle malformed data gracefully", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
