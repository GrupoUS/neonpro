            ...
            case 0:
              ...
              return [
                ...
                (0, react_1.waitFor)(function () {
                  ...
                  (0, globals_1.expect)(
                    react_1.screen.getByText("Failed to fetch data"),
                  ).toBeInTheDocument();
            ...
            case 0:
              ...
              return [
                ...
                (0, react_1.waitFor)(function () {
                  ...
                  (0, globals_1.expect)(
                    react_1.screen.getByTestId("pie-chart"),
                  ).toBeInTheDocument();
                }),
              ];
            case 1:
            ...
            case 0:
              ...
              return [
                ...
                (0, react_1.waitFor)(function () {
                  ...
                  (0, globals_1.expect)(
                    react_1.screen.queryByText("Customer Lifetime Value"),
                  ).not.toBeInTheDocument();
                }),
              ];
            case 1:
            ...
            case 0:
              ...
              return [
                ...
                (0, react_1.waitFor)(function () {
                  ...
                  (0, globals_1.expect)(
                    react_1.screen.getByRole("region", { name: "Subscription Metrics" }),
                  ).toBeInTheDocument();
                  (0, globals_1.expect)(
                    react_1.screen.getByRole("region", { name: "Trial Metrics" }),
                  ).toBeInTheDocument();
                  (0, globals_1.expect)(
                    react_1.screen.getByRole("region", { name: "Revenue Charts" }),
                  ).toBeInTheDocument();
                }),
              ];
            case 1:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              (0, globals_1.expect)(
                react_1.screen.getByTestId("memoized-calculations"),
              ).toBeInTheDocument();
              return [2 /*return*/];
          }
        });
            ...
            case 0:
              ...
              return [
                ...
                (0, react_1.waitFor)(function () {
                  ...
                  (0, globals_1.expect)(
                    react_1.screen.getAllByTestId("subscription-item"),
                  ).toHaveLength(10);
                }),
              ];
            case 1:
