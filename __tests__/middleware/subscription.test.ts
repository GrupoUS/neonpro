...
describe('Subscription Middleware', () => {
  ...
  describe('validateSubscriptionStatus', () => {
    ...
    it('should detect expired subscriptions', async () => {      const expiredSubscription = createMockSubscription({
        status: 'expired',
  ...
  describe('routeProtection', () => {
    ...
    it('should protect premium routes', async () => {
      ...
      const subscription = createMockSubscription({ status: 'active', tier: 'premium' })
  ...
  describe('errorHandling', () => {
    ...
    it('should handle invalid subscription responses', async () => {
      mockFetch.mockResolvedValueOnce(
        createMockResponse(null, 404) as any
      )
