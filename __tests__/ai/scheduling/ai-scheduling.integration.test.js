        ...
        select: jest.fn(function () { return ({
            eq: jest.fn(function () { return ({
                order: jest.fn(function () { return ({
                    limit: jest.fn(function () { return Promise.resolve({ data: [], error: null }); })
                }); })
            }); })
        }); }),
...
// Mock AuditLogger
var mockAuditLogger = {
    logEvent: jest.fn(function () { return Promise.resolve(); }),
    logError: jest.fn(function () { return Promise.resolve(); }),
    logAccess: jest.fn(function () { return Promise.resolve(); })
};
describe('AI Scheduling Integration Tests', function () {
    ...
    describe('AISchedulingOptimizer', function () {
        ...
        it('should handle suggestOptimalSlots call', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should handle getPatientPreferenceData call', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('PatientPreferenceLearner', function () {
        ...
        it('should handle updatePreferences call', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, learner.updatePreferences('patient_123', {
        ...
        it('should handle getPatientPreferences call', function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    case 0:
                        mockPreferences = {
                            ...
                            patterns: {
                                ...
                                staff_preferences: [{ staff_id: 'staff_1', staff_name: 'Dr. Smith', preference_strength: 0.95, interaction_count: 12 }],
                                treatment_preferences: [{ treatment_type: 'consultation', preference_score: 0.88, optimal_timing: 'morning' }],
                                scheduling_behaviors: [{ behavior: 'Books 1 week in advance', frequency: 80, reliability: 0.85 }]
                            }
                        };
    ...
    describe('Service Integration', function () {
        it('should demonstrate integration between optimizer and learner', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expect(patientPrefs.current_preferences.time_preferences.preferred_times).toContain('09:00-12:00');
                        return [4 /*yield*/, optimizer.suggestOptimalSlots({
                                patient_id: 'patient_123',
                                treatment_type: 'consultation',
                                preferred_date_range: {
