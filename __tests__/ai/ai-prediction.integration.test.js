...
(0, globals_1.describe)('AI Duration Prediction Integration', function () {
    (0, globals_1.describe)('Service Structure', function () {
        (0, globals_1.test)('should export AI Duration Prediction services', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, AIDurationPredictionService, AIABTestingService, ModelPerformanceService;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/ai/duration-prediction'); })];
                    case 1:
                        _a = _b.sent(), AIDurationPredictionService = _a.AIDurationPredictionService, AIABTestingService = _a.AIABTestingService, ModelPerformanceService = _a.ModelPerformanceService;
        ...
        (0, globals_1.test)('should create service instances', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, AIDurationPredictionService, AIABTestingService, ModelPerformanceService, aiService, abTestService, performanceService;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/ai/duration-prediction'); })];
                    case 1:
        ...
        (0, globals_1.test)('should have required methods on AI Duration Prediction Service', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(typeof aiService.getProfessionalEfficiencyMetrics).toBe('function');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should have required methods on A/B Testing Service', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should have required methods on Model Performance Service', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(typeof performanceService.getCurrentModelMetrics).toBe('function');
                        (0, globals_1.expect)(typeof performanceService.updatePerformanceMetrics).toBe('function');
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('Type Definitions', function () {
        (0, globals_1.test)('should have correct interface structure for PredictionFeatures', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should validate basic parameter types', function () { return __awaiter(void 0, void 0, void 0, function () {
            var AIDurationPredictionService, aiService;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/ai/duration-prediction'); })];
    ...
    (0, globals_1.describe)('Error Handling', function () {
        (0, globals_1.test)('should handle invalid appointment ID gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        invalidId = '';
                        return [4 /*yield*/, (0, globals_1.expect)(aiService.predictDuration(invalidId, features)).rejects.toThrow()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        (0, globals_1.test)('should validate duration values', function () { return __awaiter(void 0, void 0, void 0, function () {
            var AIDurationPredictionService, aiService;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/ai/duration-prediction'); })];
                    case 1:
                        AIDurationPredictionService = (_a.sent()).AIDurationPredictionService;
                        aiService = new AIDurationPredictionService();
                        return [4 /*yield*/, (0, globals_1.expect)(aiService.updatePredictionWithActual('test-appointment', -5)).rejects.toThrow('Duration must be positive')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, (0, globals_1.expect)(aiService.updatePredictionWithActual('test-appointment', 0)).rejects.toThrow('Duration must be positive')];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    (0, globals_1.describe)('Basic Functionality Tests', function () {
        (0, globals_1.test)('should create service instances without throwing', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, AIDurationPredictionService, AIABTestingService, ModelPerformanceService;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/ai/duration-prediction'); })];
        ...
        (0, globals_1.test)('should handle method calls on service instances', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, AIDurationPredictionService, AIABTestingService, ModelPerformanceService, aiService, abTestService, performanceService;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/ai/duration-prediction'); })];
    ...
    (0, globals_1.describe)('Architecture Validation', function () {
        (0, globals_1.test)('should have proper database schema structure', function () { return __awaiter(void 0, void 0, void 0, function () {
            var fs, path, migrationPath;
            return __generator(this, function (_a) {
                fs = require('fs');
                path = require('path');
                migrationPath = path.join(process.cwd(), 'supabase', 'migrations', '20250726_create_ai_prediction_schema.sql');
                (0, globals_1.expect)(function () {
        ...
        (0, globals_1.test)('should have API routes defined', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should have React components defined', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('Story 2.1 Completion Validation', function () {
        (0, globals_1.test)('should have all required implementation files', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should confirm Story 2.1 implementation is complete', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, AIDurationPredictionService, AIABTestingService, ModelPerformanceService, aiService, abTestService, performanceService;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/ai/duration-prediction'); })];
