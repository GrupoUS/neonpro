...
var mockUseState = jest.fn(function (initial) { return [initial, mockSetState]; });
var mockUseEffect = jest.fn();
var mockUseCallback = jest.fn(function (fn) { return fn; });
var mockUseRef = jest.fn(function () { return ({ current: null }); });
jest.mock('react', function () { return (__assign(__assign({}, jest.requireActual('react')), { useState: mockUseState, useEffect: mockUseEffect, useCallback: mockUseCallback, useRef: mockUseRef })); });
...
// Mock MediaStream
global.MediaStream = jest.fn().mockImplementation(function () { return ({
...
// Mock AudioContext
global.AudioContext = jest.fn().mockImplementation(function () { return ({
    createOscillator: jest.fn(function () { return ({
        connect: jest.fn(),
        start: jest.fn(),
        stop: jest.fn(),
        frequency: { value: 800 }
    }); }),
    createGain: jest.fn(function () { return ({
        connect: jest.fn(),
        gain: { value: 0.1 }
    }); }),
    destination: {}
...
describe('Inventory Management System', function () {
    ...
    describe('useInventory hook - Basic functionality', function () {
        it('should be importable and have expected structure', function () { return __awaiter(void 0, void 0, void 0, function () {
            var useInventory;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/hooks/inventory/use-inventory'); })];
                    case 1:
        ...
        it('should initialize useState with correct default state structure', function () { return __awaiter(void 0, void 0, void 0, function () {
            var useInventory;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/hooks/inventory/use-inventory'); })];
                    case 1:
                        ...
                        expect(mockUseState).toHaveBeenCalledWith(expect.objectContaining({
                            items: [],
                            locations: [],
                            categories: [],
                            movements: [],
        ...
        it('should handle options parameter correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            var useInventory;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/hooks/inventory/use-inventory'); })];
    ...
    describe('useBarcode hook - Basic functionality', function () {
        ...
        it('should be importable and have expected structure', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/hooks/inventory/use-barcode'); })];
                    case 1:
        ...
        it('should initialize useState with correct scanner state', function () { return __awaiter(void 0, void 0, void 0, function () {
            var useBarcode;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/hooks/inventory/use-barcode'); })];
        ...
        it('should handle barcode options parameter', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Integration capabilities', function () {
        it('should support both hooks working together', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        useInventory = (_a.sent()).useInventory;
                        return [4 /*yield*/, Promise.resolve().then(function () { return require('@/hooks/inventory/use-barcode'); })];
                    case 2:
                        useBarcode = (_a.sent()).useBarcode;
