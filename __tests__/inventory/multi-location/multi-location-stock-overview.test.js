...
(0, globals_1.describe)('MultiLocationStockOverview', function () {
    ...
    (0, globals_1.it)('renders loading state initially', function () {
    ...
    (0, globals_1.it)('renders stock overview with data', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        <multi_location_stock_overview_1.MultiLocationStockOverview />
                    ...
                    return [4 /*yield*/, (0, react_1.waitFor)(function () {
                            (0, globals_1.expect)(react_1.screen.getByText('Visão Geral do Estoque')).toBeInTheDocument();
                        })];
                case 1:
                    _a.sent();
    ...
    (0, globals_1.it)('shows low stock and expiring alerts', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    (0, react_1.render)(<TestWrapper>
        <multi_location_stock_overview_1.MultiLocationStockOverview />
                    ...
                    return [4 /*yield*/, (0, react_1.waitFor)(function () {
                            (0, globals_1.expect)(react_1.screen.getByText('Estoque Baixo')).toBeInTheDocument();
                        })];
                case 1:
                    _a.sent();
    ...
    (0, globals_1.it)('filters by search term', function () { return __awaiter(void 0, void 0, void 0, function () {
        var searchInput;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
        ...
        <multi_location_stock_overview_1.MultiLocationStockOverview />
                ...
                case 1:
                    _a.sent();
                    searchInput = react_1.screen.getByPlaceholderText('Buscar por nome, SKU ou localização...');
                    react_1.fireEvent.change(searchInput, { target: { value: 'Botox' } });
                    return [4 /*yield*/, (0, react_1.waitFor)(function () {
                            (0, globals_1.expect)(mockService.getInventoryStock).toHaveBeenCalledWith(globals_1.expect.objectContaining({
                                search: 'Botox'
                            }));
                        })];
                case 2:
    ...
    (0, globals_1.it)('shows location filter when showLocationFilter is true', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    (0, react_1.render)(<TestWrapper>
        <multi_location_stock_overview_1.MultiLocationStockOverview showLocationFilter={true}/>
      </TestWrapper>);
                    return [4 /*yield*/, (0, react_1.waitFor)(function () {
                ...
                case 1:
                    _a.sent();
                    (0, globals_1.expect)(react_1.screen.getByText('Todas Localizações')).toBeInTheDocument();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, globals_1.it)('does not show location filter when showLocationFilter is false', function () {
        (0, react_1.render)(<TestWrapper>
    ...
    (0, globals_1.it)('handles category filter changes', function () { return __awaiter(void 0, void 0, void 0, function () {
