...
jest.mock('sonner', function () { return ({
    toast: {
        ...
        error: jest.fn(),
        info: jest.fn(),
        loading: jest.fn(function () { return 'toast-id'; }),
        dismiss: jest.fn()
    }
}); });
// Mock fetch
...
global.URL.createObjectURL = jest.fn(function () { return 'blob:mock-url'; });
...
jest.spyOn(document.body, 'appendChild').mockImplementation(function () { return mockAnchorElement; });
jest.spyOn(document.body, 'removeChild').mockImplementation(function () { return mockAnchorElement; });
...
describe('useVisionAnalysis', function () {
    ...
    it('should initialize with default state', function () {
        var result = (0, react_1.renderHook)(function () { return (0, useVisionAnalysis_1.useVisionAnalysis)(); }).result;
    ...
    describe('startAnalysis', function () {
        it('should start analysis successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        result = (0, react_1.renderHook)(function () { return (0, useVisionAnalysis_1.useVisionAnalysis)(); }).result;
                        return [4 /*yield*/, (0, react_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, result.current.startAnalysis({
                                                patientId: 'patient-456',
                                                treatmentId: 'treatment-789',
                    ...
                    case 1:
                        ...
                        expect(sonner_1.toast.success).toHaveBeenCalledWith('Analysis completed successfully!');
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        it('should simulate progress during analysis', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('loadAnalysisHistory', function () {
        it('should load analysis history successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, react_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, result.current.loadAnalysisHistory('patient-456')];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
    ...
    describe('exportAnalysis', function () {
        it('should export analysis as PDF successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockBlob, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, react_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, result.current.exportAnalysis('analysis-123', {
                                                format: 'pdf',
                                                includeImages: true,
                    ...
                    case 1:
                        ...
                        expect(sonner_1.toast.success).toHaveBeenCalledWith('Analysis exported successfully!');
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('shareAnalysis', function () {
        it('should share analysis successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, react_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, result.current.shareAnalysis('analysis-123', {
                    ...
                    case 1:
                        ...
                        expect(sonner_1.toast.success).toHaveBeenCalledWith('Share link copied to clipboard!');
                        return [2 /*return*/];
                }
            });
        }); });
        it('should handle share errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('performance metrics', function () {
        it('should update performance metrics after successful analysis', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should handle failed analyses in performance metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
