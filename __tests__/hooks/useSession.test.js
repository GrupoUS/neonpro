      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            (0, vitest_1.expect)(mockSessionManager.getUserSessions).toHaveBeenCalledWith(
              "user-123",
            );
            return [2 /*return*/];
        }
    ...
    __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
                  ...
                  return __generator(this, (_a) => {
                    switch (_a.label) {
                      case 0:
                        return [
                          4 /*yield*/,
                          result.current.createSession(mockDevice, "192.168.1.1"),
                        ];
                      case 1:
                        _a.sent();
                        return [2 /*return*/];
          ...
          case 2:
            _a.sent();
            (0, vitest_1.expect)(mockSessionManager.createSession).toHaveBeenCalledWith(
              "user-123",
              mockDevice,
              "192.168.1.1",
              undefined,
    ...
    __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 2:
            _a.sent();
            (0, vitest_1.expect)(mockSessionManager.updateSession).toHaveBeenCalledWith(
              "session-123",
    ...
    __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 2:
            _a.sent();
            (0, vitest_1.expect)(mockSessionManager.terminateSession).toHaveBeenCalledWith(
              "session-123",
            );
            return [2 /*return*/];
        }
    ...
    __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 2:
            _a.sent();
            (0, vitest_1.expect)(mockSessionManager.terminateAllUserSessions).toHaveBeenCalledWith(
              "user-123",
            );
            return [2 /*return*/];
        }
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            (0, vitest_1.expect)(mockSessionManager.getSecurityEvents).toHaveBeenCalledWith(
              "user-123",
              {},
            );
            return [2 /*return*/];
    ...
    __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
                  ...
                  return __generator(this, (_a) => {
                    switch (_a.label) {
                      case 0:
                        return [
                          4 /*yield*/,
                          result.current.resolveEvent("event-123", "admin-123", "False positive"),
                        ];
                      case 1:
                        _a.sent();
                        return [2 /*return*/];
          ...
          case 2:
            _a.sent();
            (0, vitest_1.expect)(mockSessionManager.resolveSecurityEvent).toHaveBeenCalledWith(
              "event-123",
              "admin-123",
              "False positive",
            );
    ...
    __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
                  ...
                  return __generator(this, (_a) => {
                    switch (_a.label) {
                      case 0:
                        return [
                          4 /*yield*/,
                          result.current.updateTrustLevel("device-123", "trusted"),
                        ];
                      case 1:
                        _a.sent();
                        return [2 /*return*/];
          ...
          case 2:
            _a.sent();
            (0, vitest_1.expect)(mockSessionManager.updateDeviceTrust).toHaveBeenCalledWith(
              "device-123",
              "trusted",
            );
            return [2 /*return*/];
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            suspiciousDevice = __assign(__assign({ id: "device-456" }, mockDevice), {
