...
describe('useErrorHandling', function () {
    ...
    it('initializes with empty errors array', function () {
        var result = (0, react_1.renderHook)(function () { return (0, use_error_handling_1.useErrorHandling)(); }).result;
    ...
    it('adds multiple error types', function () {
        ...
        expect(result.current.errors.map(function (e) { return e.type; })).toEqual(['error', 'warning', 'info', 'success']);
    });
    ...
    it('handles auto-hide functionality', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            jest.useFakeTimers();
            result = (0, react_1.renderHook)(function () { return (0, use_error_handling_1.useErrorHandling)(); }).result;
            (0, react_1.act)(function () {
                result.current.addError({
                    type: 'success',
                    title: 'Auto Hide',
    ...
    it('filters errors by type', function () {
        ...
        expect(errorMessages.every(function (e) { return e.type === 'error'; })).toBe(true);
        expect(warningMessages.every(function (e) { return e.type === 'warning'; })).toBe(true);
    });
    it('generates unique error IDs', function () {
        ...
        var ids = result.current.errors.map(function (e) { return e.id; });
        expect(new Set(ids).size).toBe(2); // All IDs should be unique
        expect(ids.every(function (id) { return typeof id === 'string' && id.length > 0; })).toBe(true);
    });
    ...
    it('respects LGPD compliance in error handling', function () {
        var _a;
        var result = (0, react_1.renderHook)(function () { return (0, use_error_handling_1.useErrorHandling)({
            lgpdCompliant: true
        }); }).result;
        (0, react_1.act)(function () {
            result.current.addError({
        ...
        expect((_a = result.current.errors[0].context) === null || _a === void 0 ? void 0 : _a.userId).toBeDefined();
