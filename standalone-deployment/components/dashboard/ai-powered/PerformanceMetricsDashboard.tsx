        ...
        <Card className="neonpro-card group">
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <Progress
                value={metrics.systemPerformance.cpuUsage}
                className="h-2"
              />
        ...
        <Card className="neonpro-card group">
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <Progress
                value={metrics.systemPerformance.memoryUsage}
                className="h-2"
              />
              <div className="text-xs text-muted-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="neonpro-card">
          <CardHeader>
            ...
            <CardDescription>
              Últimas 24 horas (em milissegundos)
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-64">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <Progress
                    value={metrics.cacheMetrics.evictionRate}
                    className="w-32 h-2"
                  />
                  <span className="text-sm">
                    {metrics.cacheMetrics.evictionRate}%
                  </span>
                </div>
              </div>
        ...
        <Card className="neonpro-card">
          <CardHeader>
            ...
            <CardDescription>
              Performance operacional da clínica
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-lg font-bold">
                  {metrics.businessMetrics.appointmentsPerHour}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-lg font-bold">
                  {metrics.businessMetrics.patientSatisfaction}/10
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                ...
                <span className="text-lg font-bold">
                  {metrics.businessMetrics.systemAdoption}%
                </span>
              </div>
            </div>
          </CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="neonpro-card text-center">
          <CardContent className="pt-6">
            ...
            <Badge
              variant="outline"
              className="text-green-600 border-green-600 mt-2"
            >
              Excelente
            </Badge>
          </CardContent>
        ...
        <Card className="neonpro-card text-center">
          <CardContent className="pt-6">
            <div className="text-2xl font-bold">
              {metrics.applicationMetrics.activeConnections}
            </div>
        ...
        <Card className="neonpro-card text-center">
          <CardContent className="pt-6">
            <div className="text-2xl font-bold text-blue-600">
              {metrics.systemPerformance.networkLatency}ms
            </div>
        ...
        <Card className="neonpro-card text-center">
          <CardContent className="pt-6">
            <div className="text-2xl font-bold">
              {metrics.systemPerformance.diskUsage}%
            </div>
