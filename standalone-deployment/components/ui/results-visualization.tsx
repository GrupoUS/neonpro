      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          ...
          <div className="bg-white border rounded p-3">
            ...
            <p className="font-bold text-lg">
              {Math.round(
                chartData.data.reduce((acc, d) => acc + d.value, 0) / chartData.data.length,
                    ...
                    <CardContent className="pt-0">
                      ...
                      {result.type === "table" && result.table && (
                        <div className="text-xs text-gray-600">
                          <p>
                            {result.table.headers.length} colunas, {result.table.rows.length} linhas
                          </p>
                ...
                {filteredResults.length > 1 && (
                  <div className="flex items-center justify-between">
                    <p className="text-sm text-gray-600">
                      Resultado {filteredResults.findIndex(r => r.id === currentResult.id) + 1} de
                      {" "}
