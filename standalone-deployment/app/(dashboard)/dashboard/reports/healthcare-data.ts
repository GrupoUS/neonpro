...
export const financialData = {
  ...
  paymentMethods: {
    pix: { amount: 145_230, percentage: 29.8, transactions: 234 },
    creditCard: { amount: 234_560, percentage: 48.1, transactions: 456 },
    debitCard: { amount: 87_450, percentage: 17.9, transactions: 189 },
    cash: { amount: 20_410, percentage: 4.2, transactions: 67 },
  },
  insurance: {
    sus: { amount: 0, percentage: 0, patients: 0 },
    private: { amount: 234_560, percentage: 48.1, patients: 1247 },
    particular: { amount: 253_090, percentage: 51.9, patients: 1456 },
  },
  profitability: {
    grossMargin: 68.4,
    netMargin: 23.7,
    ebitda: 115_678,
    operationalCosts: 154_230,
  },
  taxes: {
    irpj: 23_456,
    csll: 15_234,
  ...
  serviceAnalysis: [
    { service: "Botox", revenue: 145_230, margin: 72.3, sessions: 234 },
    {
    ...
    { service: "Laser CO2", revenue: 98_760, margin: 74.2, sessions: 123 },
    { service: "Peeling", revenue: 65_430, margin: 65.1, sessions: 189 },
    { service: "Consulta", revenue: 54_780, margin: 85.4, sessions: 456 },
  ],
};
...
export const patientDemographics = {
  totalPatients: 2847,
  ageDistribution: {
    "18-25": { count: 284, percentage: 10 },
    "26-35": { count: 997, percentage: 35 },
    "36-45": { count: 1139, percentage: 40 },
    "46-55": { count: 284, percentage: 10 },
    "56+": { count: 143, percentage: 5 },
  },
  genderDistribution: {
    female: { count: 2277, percentage: 80 },
    male: { count: 570, percentage: 20 },
  },
  regionDistribution: {
    "São Paulo": { count: 1423, percentage: 50 },
    "Rio de Janeiro": { count: 569, percentage: 20 },
    "Minas Gerais": { count: 427, percentage: 15 },
    Outros: { count: 428, percentage: 15 },
  },
  treatmentHistory: {
    newPatients: 456,
