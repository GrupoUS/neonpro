...
#### || 3.1.1 Create core package index [Type Safety & Data Integrity, KISS, YAGNI]
...
#### 3.1.2 Migrate authentication logic
...
#### 3.1.3 Consolidate healthcare services
...
#### 4.1.1 Create tRPC router structure
...
#### 4.1.2 Implement appointment procedures
...
export const useCreateAppointment = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      queryClient.setQueryData(['appointments', variables.clinicId], (old: any[]) => 
        [...old, data]
      );
    },
  });
