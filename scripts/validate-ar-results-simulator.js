...
function validateBuildProcess() {
  ...
  try {
    ...
    const apiResult = execSync('pnpm --filter=@neonpro/api build', { 
      cwd: projectRoot, 
      encoding: 'utf8',
      timeout: 60000 
    });
    ...
    const webResult = execSync('pnpm --filter=@neonpro/web type-check', { 
      cwd: projectRoot, 
      encoding: 'utf8',
      timeout: 60000 
    });
    ...
    error(`Build process failed: ${buildError.message}`);
    return false;
  }
}
