...
const comparisonBenchmarks = [
  {
    ...
    nodeCommand: 'time npm install --no-save',
    iterations: 3,
    type: 'installation',
  },
  {
  ...
  },
  {
    ...
    nodeCommand: 'time npm run build',
    iterations: 3,
    type: 'build',
  },
  {
    ...
    nodeCommand: 'time npm run type-check',
    iterations: 3,
    type: 'validation',
  },
  {
    ...
    nodeCommand: 'time timeout 10s npm run dev:web || true',
    iterations: 3,
    type: 'startup',
  },
];
...
const healthcareBenchmarks = [
  {
    ...
    nodeCommand: 'npm run test:healthcare-compliance || true',
    iterations: 5,
    type: 'compliance',
  },
  {
    ...
    nodeCommand: 'npm run test:security-compliance || true',
    iterations: 5,
    type: 'security',
  },
  {
    ...
    nodeCommand: 'npm run test:regulatory-compliance || true',
    iterations: 5,
    type: 'regulatory',
  },
];
