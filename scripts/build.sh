...
# Check if React app build exists and copy it
if [ -f "apps/web/dist/index.html" ]; then
    echo "📋 Copying existing React build..."
    cp -r apps/web/dist/* dist/
    echo "✅ React app copied successfully!"
else
    echo "🚀 Creating detailed NeonPro landing page..."
