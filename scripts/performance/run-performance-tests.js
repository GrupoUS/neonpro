...
async function runPerformanceTests() {
  ...
  try {
    ...
    console.log(`   Success rate: ${((subscriptionResult.successfulRequests / subscriptionResult.totalRequests) * 100).toFixed(2)}%`);
    ...
    console.log(`   Success rate: ${((updateResult.successfulRequests / updateResult.totalRequests) * 100).toFixed(2)}%`);
    ...
    console.log(`   Success rate: ${((syncResult.successfulRequests / syncResult.totalRequests) * 100).toFixed(2)}%`);
