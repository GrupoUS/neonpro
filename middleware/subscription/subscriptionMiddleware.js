      ...
      switch (_f.label) {
        ...
        case 2:
          ...
          if (!userClinic) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "No active clinic found" }, { status: 403 }),
            ];
          }
          return [
            4 /*yield*/,
                ...
                server_1.NextResponse.json(
                  {
                    ...
                    message:
                      "Esta funcionalidade n\u00E3o est\u00E1 dispon\u00EDvel no seu plano ".concat(
                        (_c = subscription.plan) === null || _c === void 0
                          ? void 0
                          : _c.display_name,
                        ".",
                      ),
                    ...
                    current_plan:
                      (_d = subscription.plan) === null || _d === void 0 ? void 0 : _d.name,
        ...
        case 5:
          ...
          response.headers.set(
            "x-subscription-tier",
            ((_e = subscription.plan) === null || _e === void 0 ? void 0 : _e.name) || "unknown",
          );
