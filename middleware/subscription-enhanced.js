    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            getOptimizedSubscriptionStatus(user.id, pathname, mergedConfig),
            // Validate access
          ];
        case 4:
          ...
          return [
            4 /*yield*/,
            validateRouteAccess(subscriptionResult, routeProtection, user, mergedConfig),
          ...
          recordRequestMetrics(
            {
              ...
              duration: duration,
              cacheHit:
                ((_b = subscriptionResult.performance) === null || _b === void 0
                  ? void 0
                  : _b.cacheHit) || false,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            subscription_cache_enhanced_1.enhancedSubscriptionCache.set(cacheKey, cacheData, 60000),
          ]; // 1 minute cache
        case 4:
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      ...
                      if (!currentBatch || currentBatch.length === 0) return [2 /*return*/];
    ...
    return __generator(this, function (_d) {
      ...
      if (routeProtection.requiredTier) {
        userTier =
          ((_c =
            (_b =
              (_a = subscriptionResult.subscription) === null || _a === void 0
                ? void 0
...
function recordRequestMetrics(metrics, config) {
  ...
  if (metrics.duration > config.monitoring.slowRequestThreshold) {
    console.warn(
      "Slow request detected: ".concat(metrics.path, " took ").concat(metrics.duration, "ms"),
    );
  }
  ...
  subscription_performance_monitor_1.subscriptionPerformanceMonitor.recordRealtimeOperation(
    metrics.duration,
...
function createAccessDeniedResponse(subscriptionResult, routeProtection) {
  ...
  var upgradeNeeded =
    ...
    (!((_b =
      (_a = subscriptionResult.subscription) === null || _a === void 0 ? void 0 : _a.plan) ===
      null || _b === void 0
      ? void 0
      : _b.name) ||
  ...
  return server_1.NextResponse.json(
    {
      ...
      currentTier:
        ((_d =
          (_c = subscriptionResult.subscription) === null || _c === void 0 ? void 0 : _c.plan) ===
          null || _d === void 0
          ? void 0
          : _d.name) || "free",
    },
...
function addSubscriptionHeaders(response, subscriptionResult, user) {
  ...
  response.headers.set(
    "x-subscription-tier",
    ((_b = (_a = subscriptionResult.subscription) === null || _a === void 0 ? void 0 : _a.plan) ===
      null || _b === void 0
      ? void 0
      : _b.name) || "free",
  );
