            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        sessionToken = (_a = request.cookies.get('session-token')) === null || _a === void 0 ? void 0 : _a.value;
                        if (!sessionToken) {
                    ...
                    case 2:
                        ...
                        // Log security event
                        return [4 /*yield*/, this.logSecurityEvent(sessionValidation.userId || 'unknown', session_1.SecurityEventType.SESSION_VALIDATION_FAILED, {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.sessionManager.refreshSession(sessionToken, {
                                ipAddress: this.getClientIP(request),
                                userAgent: request.headers.get('user-agent') || 'Unknown'
                            })];
                    case 5:
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, this.logSecurityEvent('unknown', session_1.SecurityEventType.SYSTEM_ERROR, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.sessionManager.logSecurityEvent({
                                userId: userId,
                                eventType: eventType,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.logSecurityEvent(userId, session_1.SecurityEventType.SUSPICIOUS_ACTIVITY, {
                    ...
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5: return [4 /*yield*/, this.checkUnusualLocation(userId, ipAddress)];
                    case 6:
