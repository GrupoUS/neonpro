...
var HealthcareRBACMiddleware = /** @class */ (function () {
    function HealthcareRBACMiddleware() {
        ...
        this.supabase = (0, ssr_1.createServerClient)(process.env.NEXT_PUBLIC_SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE_KEY, {
            cookies: {
    ...
    HealthcareRBACMiddleware.prototype.protect = function (options) {
        ...
        return function (request) { return __awaiter(_this, void 0, void 0, function () {
            var authResult, user, userContext, requestContext, _a, emergencyOverride, healthcareValidation, permissionResults, hasRequiredPermissions, hasAlternativePermissions, _b, failedPermissions, rbacContext, requestWithContext, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        userContext = _c.sent();
                        if (!userContext) {
                            return [2 /*return*/, this.createErrorResponse({
                    ...
                    case 3:
                        _a = _c.sent();
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.extractDefaultContext(request)];
                    case 5:
                        _a = _c.sent();
                        _c.label = 6;
                    case 6:
                        ...
                        return [4 /*yield*/, this.logEmergencyOverride(user.id, options.permissions, requestContext, request)];
                    case 7:
                        _c.sent();
                        _c.label = 8;
                    case 8: return [4 /*yield*/, this.validateHealthcareRequirements(userContext, options)];
                    case 9:
                        healthcareValidation = _c.sent();
                        if (!healthcareValidation.valid) {
                            return [2 /*return*/, this.createErrorResponse(healthcareValidation.error, request)];
                        }
                        return [4 /*yield*/, this.checkPermissions(user.id, options, __assign(__assign({}, requestContext), { emergencyOverride: emergencyOverride }))];
                    case 10:
                        permissionResults = _c.sent();
                        hasRequiredPermissions = permissionResults.every(function (result) { return result.granted; });
                        if (!options.alternativePermissions) return [3 /*break*/, 12];
                        return [4 /*yield*/, this.checkAlternativePermissions(user.id, options.alternativePermissions, __assign(__assign({}, requestContext), { emergencyOverride: emergencyOverride }))];
                    case 11:
                        _b = _c.sent();
                        return [3 /*break*/, 13];
                    case 12:
                    ...
                    case 13:
                        ...
                        if (!hasRequiredPermissions && !hasAlternativePermissions) {
                            failedPermissions = permissionResults
                                .filter(function (result) { return !result.granted; })
                                .map(function (result) { return result.permission; });
                            return [2 /*return*/, this.createErrorResponse({
                        ...
                        return [4 /*yield*/, this.logSuccessfulAccess(user.id, options.permissions, requestContext, request, options.auditMetadata)];
                    case 14:
                        // Log successful access
                        _c.sent();
                        rbacContext = __assign(__assign({ user: user, userContext: userContext, permissions: permissionResults }, requestContext), { emergencyOverride: emergencyOverride });
                        requestWithContext = new server_1.NextRequest(request.url, __assign(__assign({}, request), { headers: new Headers(request.headers) }));
                        requestWithContext.headers.set('x-rbac-context', Buffer.from(JSON.stringify(rbacContext)).toString('base64'));
                        return [2 /*return*/];
                    case 15:
                        error_1 = _c.sent();
                ...
                switch (_h.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                medical_license: ((_b = data.medical_licenses) === null || _b === void 0 ? void 0 : _b.license_number) || null,
                                cfm_number: ((_c = data.medical_licenses) === null || _c === void 0 ? void 0 : _c.cfm_number) || null,
                                medical_specialty: ((_d = data.medical_licenses) === null || _d === void 0 ? void 0 : _d.specialty) || null,
                                license_expiry: ((_e = data.medical_licenses) === null || _e === void 0 ? void 0 : _e.expires_at) ? new Date(data.medical_licenses.expires_at) : null,
                                license_active: ((_f = data.medical_licenses) === null || _f === void 0 ? void 0 : _f.active) || false,
                                additional_specialties: ((_g = data.medical_licenses) === null || _g === void 0 ? void 0 : _g.additional_specialties) || [],
                                ...
                                access_expires_at: data.access_expires_at ? new Date(data.access_expires_at) : undefined,
    ...
    HealthcareRBACMiddleware.prototype.extractDefaultContext = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var url, searchParams, pathname, clinicId, patientId, resourceId, pathParts, clinicIndex, patientIndex;
            return __generator(this, function (_a) {
                ...
                patientId = searchParams.get('patientId') || request.headers.get('x-patient-id') || undefined;
                resourceId = searchParams.get('resourceId') || request.headers.get('x-resource-id') || undefined;
     ...
     */
    HealthcareRBACMiddleware.prototype.validateHealthcareRequirements = function (userContext, options) {
        return __awaiter(this, void 0, void 0, function () {
            var userSpecialties;
            return __generator(this, function (_a) {
                ...
                if (options.requiredSpecialty) {
                    userSpecialties = __spreadArray(__spreadArray([], (userContext.medical_specialty ? [userContext.medical_specialty] : []), true), userContext.additional_specialties, true);
                    if (!userSpecialties.includes(options.requiredSpecialty)) {
                        return [2 /*return*/, {
                                valid: false,
                                error: {
                                    code: 'MEDICAL_SPECIALTY_REQUIRED',
                                    message: "Medical specialty '".concat(options.requiredSpecialty, "' required for this operation"),
                                    statusCode: 403,
                                    userRole: userContext.role,
                                    details: {
                                        userId: userContext.user_id,
    ...
    HealthcareRBACMiddleware.prototype.checkPermissions = function (userId, options, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all(options.permissions.map(function (permission) {
     ...
     */
    HealthcareRBACMiddleware.prototype.checkAlternativePermissions = function (userId, permissions, context) {
        return __awaiter(this, void 0, void 0, function () {
            var results;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all(permissions.map(function (permission) {
                            return _this.rbacEngine.checkPermission(userId, permission, context);
                        }))];
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, results.some(function (result) { return result.granted; })];
                }
            });
        });
    };
     ...
     */
    HealthcareRBACMiddleware.prototype.logEmergencyOverride = function (userId, permissions, context, request) {
        return __awaiter(this, void 0, void 0, function () {
            var error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase.from('audit_logs').insert({
                                ...
                                context: __assign(__assign({}, context), { url: request.url, method: request.method, userAgent: request.headers.get('user-agent'), ip: request.headers.get('x-forwarded-for') || request.headers.get('x-real-ip') }),
                                result: 'granted',
     ...
     * Log successful access
     */
    HealthcareRBACMiddleware.prototype.logSuccessfulAccess = function (userId, permissions, context, request, metadata) {
        return __awaiter(this, void 0, void 0, function () {
            var error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase.from('audit_logs').insert({
                                ...
                                action: 'api_access',
                                resource: permissions.join(','),
                                context: __assign(__assign(__assign({}, context), { url: request.url, method: request.method, userAgent: request.headers.get('user-agent'), ip: request.headers.get('x-forwarded-for') || request.headers.get('x-real-ip') }), metadata),
                                result: 'granted',
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase.from('audit_logs').insert({
                                ...
                                resource: ((_a = error.requiredPermissions) === null || _a === void 0 ? void 0 : _a.join(',')) || 'unknown',
                                context: {
                                    url: request.url,
...
function requireClinicalAccess(options) {
    if (options === void 0) { options = {}; }
    return rbacMiddleware.protect(__assign({ permissions: ['patient.read.own', 'procedure.perform.general'], requireMedicalLicense: true, allowEmergencyOverride: true }, options));
}
/**
...
function requireAdministrativeAccess(options) {
    if (options === void 0) { options = {}; }
    return rbacMiddleware.protect(__assign({ permissions: ['scheduling.manage.clinic', 'billing.process.standard'], allowEmergencyOverride: false }, options));
}
/**
...
function requireComplianceAccess(options) {
    if (options === void 0) { options = {}; }
    return rbacMiddleware.protect(__assign({ permissions: ['audit.access.clinic', 'compliance.report.cfm'], allowEmergencyOverride: false }, options));
}
/**
...
function requireSystemAdminAccess(options) {
    if (options === void 0) { options = {}; }
    return rbacMiddleware.protect(__assign({ permissions: ['system.manage.users', 'system.configure.clinic'], allowEmergencyOverride: false }, options));
}
/**
