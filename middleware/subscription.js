...
exports.routeProtector = exports.healthCheck = exports.globalSubscriptionCache = exports.getPerformanceSummary = exports.getPerformanceMetrics = exports.getCacheStats = exports.clearSubscriptionCache = exports.cacheManager = void 0;
...
Object.defineProperty(exports, "routeProtector", { enumerable: true, get: function () { return route_protection_1.routeProtector; } });
var subscription_cache_1 = require("../lib/subscription-cache");
Object.defineProperty(exports, "cacheManager", { enumerable: true, get: function () { return subscription_cache_1.cacheManager; } });
Object.defineProperty(exports, "globalSubscriptionCache", { enumerable: true, get: function () { return subscription_cache_1.globalSubscriptionCache; } });
var subscription_status_1 = require("../lib/subscription-status");
Object.defineProperty(exports, "clearSubscriptionCache", { enumerable: true, get: function () { return subscription_status_1.clearSubscriptionCache; } });
Object.defineProperty(exports, "getCacheStats", { enumerable: true, get: function () { return subscription_status_1.getCacheStats; } });
Object.defineProperty(exports, "getPerformanceMetrics", { enumerable: true, get: function () { return subscription_status_1.getPerformanceMetrics; } });
Object.defineProperty(exports, "getPerformanceSummary", { enumerable: true, get: function () { return subscription_status_1.getPerformanceSummary; } });
Object.defineProperty(exports, "healthCheck", { enumerable: true, get: function () { return subscription_status_1.healthCheck; } });
/**
...
function subscriptionMiddleware(req) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, pathname, supabase, _a, session, sessionError, routeContext, profile, subscription, accessResult, redirectUrl, response, processingTime, error_1, errorTime, errorUrl, response;
        var _b;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    supabase = (0, ssr_1.createServerClient)(process.env.NEXT_PUBLIC_SUPABASE_URL, process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY, {
                        cookies: {
                            get: function (name) { var _a; return ((_a = req.cookies.get(name)) === null || _a === void 0 ? void 0 : _a.value) || ''; },
                ...
                case 2:
                    ...
                    routeContext = null;
                    if (!(session === null || session === void 0 ? void 0 : session.user)) return [3 /*break*/, 6];
                ...
                case 4:
                    ...
                    _b = {
                        ...
                        userRole: (0, route_protection_1.getUserRole)((profile === null || profile === void 0 ? void 0 : profile.role) || 'patient'),
                        subscriptionTier: (0, route_protection_1.getSubscriptionTier)((subscription === null || subscription === void 0 ? void 0 : subscription.tier) || 'free'),
                        subscriptionStatus: (subscription === null || subscription === void 0 ? void 0 : subscription.status) || 'inactive',
                        subscriptionExpiresAt: (subscription === null || subscription === void 0 ? void 0 : subscription.current_period_end)
                            ? new Date(subscription.current_period_end)
                            : undefined,
                        gracePeriodEndsAt: (subscription === null || subscription === void 0 ? void 0 : subscription.current_period_end)
                            ? (0, route_protection_1.calculateGracePeriodEnd)(new Date(subscription.current_period_end), 3)
                            : undefined,
                        permissions: Array.isArray(profile === null || profile === void 0 ? void 0 : profile.permissions) ? profile.permissions : ['read']
                    };
                    return [4 /*yield*/, getUserFeatureFlags(session.user.id, supabase)];
                case 5:
                    // Build comprehensive route context
                    routeContext = (_b.featureFlags = _c.sent(),
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    routeContext = (_a.featureFlags = _b.sent(),
                        _a);
                    return [4 /*yield*/, route_protection_1.routeProtector.checkAccess(req, routeContext)];
                case 4:
                    result = _b.sent();
