...
describe('SecurityMonitor', () => {
  ...
  describe('detectSuspiciousActivity', () => {
    it('should detect unusual location access', async () => {
      ...
      const result = await securityMonitor.detectSuspiciousActivity(
...
describe('DeviceManager', () => {
  ...
  describe('validateDevice', () => {
    it('should validate a trusted device', async () => {
      ...
      const result = await deviceManager.validateDevice(
        mockUser.id,
...
describe('SessionSystem Integration', () => {
  ...
  describe('Full Session Lifecycle', () => {
    it('should handle complete session lifecycle', async () => {
      ...
      // 4. Terminate session
      const terminateResult = await sessionSystem.terminateSession(
        sessionToken,
        'user_logout'
      );
