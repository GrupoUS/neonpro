...
import { WebhookUtils, RetryUtils } from '../utils'
import type {
  BaseEvent,
  WebhookEndpoint,
  EventDelivery,
...
describe('WebhookManager', () => {
  ...
  describe('Webhook Registration', () => {
    ...
    it('should validate webhook configuration before registration', async () => {
      ...
      await expect(webhookManager.registerWebhook(invalidWebhookData))
  ...
  describe('Analytics and Monitoring', () => {
    it('should track delivery analytics', async () => {
      ...
      const analytics = await webhookManager.getDeliveryAnalytics('webhook-123', startDate, endDate)
  ...
  describe('Error Handling', () => {
    it('should handle database errors gracefully', async () => {
      ...
      await expect(webhookManager.registerWebhook(webhookData))
