...
exports.MFARateLimitError = exports.MFAVerificationError = exports.MFASetupError = exports.MFAError = void 0;
// Error Types
...
var MFARateLimitError = /** @class */ (function (_super) {
    ...
    function MFARateLimitError(message, lockedUntil, metadata) {
        var _this = _super.call(this, message, 'MFA_RATE_LIMIT_ERROR', 429, __assign(__assign({}, metadata), { lockedUntil: lockedUntil })) || this;
