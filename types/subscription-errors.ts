...
export class SubscriptionErrorFactory {
  static createError(
    type: 'auth' | 'validation' | 'network' | 'database' | 'cache' | 'rate_limit' | 'timeout' | 'external_service',
    technicalMessage: string,
