...
import { Check, X, AlertCircle, Clock, Shield } from 'lucide-react';
...
import { CommunicationConsent } from '@/src/types/communication';
...
export function ConsentManager({ 
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1 space-y-1">
            <div className="flex items-center gap-2">
              ...
              <Badge 
                variant={isConsented ? 'default' : 'secondary'}
                className="text-xs"
              >
  ...
  const groupedConsents = CONSENT_TYPES.reduce((acc, consentType) => {
