...
const mockPreferences: NotificationPreferences = {
  ...
  return (
    <div className="space-y-6">
      ...
      </Card>      {/* Categorias de Notificação */}
      <Card>
        <CardHeader>
          <CardTitle>Tipos de Notificação</CardTitle>
          <CardDescription>
            Configure individualmente como deseja receber cada tipo de notificação. 
            Respeite suas preferências de LGPD.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 mt-3">
                          ...
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span>Frequência: {
                              category.frequency === 'immediate' ? 'Imediata' :
                              category.frequency === 'daily' ? 'Diária' :
                              category.frequency === 'weekly' ? 'Semanal' : 'Mensal'
                            }</span>
                          </div>
                        </div>
                      </div>
                ...
                <div className="p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                    {Object.entries(category.settings).map(([channelKey, enabled]) => {
                      ...
                      return (
                        <div key={channelKey} className="flex items-center justify-between p-3 border rounded-lg">
                          <div className="flex items-center gap-2">
                            {channel.icon}
                    ...
                    <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="text-sm">
                          <p className="font-medium text-yellow-800 mb-1">Consentimento LGPD Necessário</p>
                          <p className="text-yellow-700 mb-3">
                            Para receber notificações de marketing, você precisa autorizar o uso de seus dados 
                            para fins promocionais conforme a LGPD.
                          </p>
                          <Button 
                            size="sm" 
                            variant="outline"
          ...
          <div className="mt-6 pt-6 border-t">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => 
                  setPreferences(prev => ({ ...prev, emergencyOnly: checked }))
                }
              />
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-blue-800 space-y-2">
                ...
                <p>
                  • Você pode retirar seu consentimento para qualquer tipo de comunicação a qualquer momento
                </p>
                <p>
                  • Notificações essenciais (consultas, segurança) são enviadas independente das configurações
                </p>
                <p>
                  • Seus dados de contato não são compartilhados com terceiros sem seu consentimento explícito
                </p>
              </div>
