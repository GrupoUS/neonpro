...
export async function ClientAppointments({ clientId }: ClientAppointmentsProps) {
    ...
    <Card>
      <CardHeader>
        <div className="flex justify-between items-center">
          ...
          <Link href={`/dashboard/agendamentos/novo?cliente=${clientId}`}>
            <Button size="sm">
          ...
          <div className="space-y-4">
            ...
            {appointments.length === 10 && (
              <div className="text-center pt-4">
                <Link href={`/dashboard/agendamentos?cliente=${clientId}`}>
