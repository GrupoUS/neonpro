		...
		<div className="flex min-h-screen flex-col">
				...
				<div className="container mx-auto px-4 py-6">
					<div className="flex items-center justify-between">
						<div className="flex items-center space-x-3">
							...
							<div>
								<h1 className="font-bold text-2xl text-slate-900 dark:text-white">NeonPro Documentation</h1>
								<p className="text-slate-600 text-sm dark:text-slate-300">Healthcare Platform Documentation</p>
							</div>
						</div>
			...
			<main className="container mx-auto flex-1 px-4 py-12">
				<div className="mx-auto max-w-4xl text-center">
					<h2 className="mb-6 font-bold text-4xl text-slate-900 dark:text-white">Welcome to NeonPro Documentation</h2>
					<p className="mx-auto mb-12 max-w-2xl text-slate-600 text-xl dark:text-slate-300">
						Comprehensive documentation for the NeonPro healthcare platform, including API references, component guides,
					...
					<div className="mt-16 grid gap-8 md:grid-cols-3">
						<div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
							...
							<h3 className="mb-2 font-semibold text-lg text-slate-900 dark:text-white">API Documentation</h3>
						...
						<div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
							...
							<h3 className="mb-2 font-semibold text-lg text-slate-900 dark:text-white">Component Library</h3>
							<p className="text-slate-600 text-sm dark:text-slate-300">
						...
						<div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
							...
							<h3 className="mb-2 font-semibold text-lg text-slate-900 dark:text-white">Healthcare Compliance</h3>
							<p className="text-slate-600 text-sm dark:text-slate-300">
				...
				<div className="container mx-auto px-4 py-8">
					<div className="flex flex-col items-center justify-between md:flex-row">
						...
						<div className="mt-4 flex items-center space-x-6 md:mt-0">
							...
							<a className="text-slate-600 text-sm hover:text-blue-600 dark:text-slate-300" href="/api/health">
								API Status
							</a>
							<a className="text-slate-600 text-sm hover:text-blue-600 dark:text-slate-300" href="/support">
								Support
							</a>
						</div>
					</div>
