	...
	return (
		...
		>
			...
			<div className="flex items-center justify-between">
				...
				<div className="flex items-center space-x-2" role="status" aria-label="Sistema operacional">
					<div className="flex h-3 w-3 rounded-full bg-green-600 animate-pulse" aria-hidden="true"></div>
					...
					<CardContent>
						<div className="space-y-3">
							...
							<div className="pt-2 border-t">
								<div className="text-lg font-bold text-green-600">{metrics.complianceStatus}%</div>
