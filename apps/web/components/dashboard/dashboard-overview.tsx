...
export function DashboardOverview() {
	...
	return (
		<div className="space-y-6">
			{/* Welcome Section */}
			<div>
				<h1 className="font-bold text-3xl">Bem-vindo de volta, {user?.name || "Usuário"}!</h1>
			...
			<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Total de Pacientes</CardTitle>
				...
				<Card>
					...
					<CardContent>
						...
						<p className="text-muted-foreground text-xs">3 pendentes, 9 confirmadas</p>
					</CardContent>
				</Card>
			...
			<div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
				<Card>
					...
					<CardContent className="space-y-4">
						{[1, 2, 3].map((i) => (
							<div className="flex items-center justify-between rounded-lg border p-3" key={i}>
