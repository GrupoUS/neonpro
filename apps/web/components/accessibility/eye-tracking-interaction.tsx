            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e,) =>
                    updateSettings({ default_dwell_time: parseInt(e.target.value,), },)}
                  min={300}
                  max={3000}
                  step={100}
                  className="w-full"
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e,) =>
                    updateSettings({ medical_dwell_time: parseInt(e.target.value,), },)}
                  min={500}
                  max={5000}
                  step={100}
                  className="w-full"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked,) =>
                      updateSettings({ medical_safety_mode: checked, },)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked,) =>
                      updateSettings({ patient_monitoring: checked, },)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked,) =>
                      updateSettings({ gesture_activation: checked, },)}
                  />
                </div>
              </div>
