...
export interface SwitchNavigationContextType {
  ...
  // Actions
  registerElement: (id: string, element: HTMLElement, metadata?: HealthcareMetadata,) => void
...
export function SwitchNavigationProvider({ children, }: { children: React.ReactNode },) {
  ...
  const [elements, setElements,] = useState<
    Map<string, { element: HTMLElement; metadata?: HealthcareMetadata }>
  >(new Map(),)
  ...
  const registerElement = useCallback(
    (id: string, element: HTMLElement, metadata?: HealthcareMetadata,) => {
...
export function useSwitchElement(id: string, metadata?: HealthcareMetadata,) {
