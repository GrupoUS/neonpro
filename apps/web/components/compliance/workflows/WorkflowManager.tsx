...
export const WorkflowManager: React.FC<WorkflowManagerProps> = ({ className }) => {
  ...
  const filteredWorkflows = workflows.filter(workflow => {
    if (searchTerm && !workflow.id.toLowerCase().includes(searchTerm.toLowerCase()) && 
  ...
  const stats = {
    ...
    overdue: workflows.filter(w => w.dueDate && new Date() > w.dueDate && w.status !== 'completed').length,
              ...
              <div className="space-y-4">
                      ...
                      <div className="space-y-2 flex-1">
                        ...
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium">{workflow.progress.percentage}%</span>
                          </div>
                            ...
                            <div className="space-y-6">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                  ...
                                  <p className="mt-1 text-sm">{selectedWorkflow.assignedTo || 'Não atribuído'}</p>
                                </div>
                              ...
                              <div>
                                ...
                                <div className="mt-2 space-y-2">
                                  <Progress value={selectedWorkflow.progress.percentage} className="h-3" />
                                  <p className="text-sm text-muted-foreground">
                                    {selectedWorkflow.progress.completedSteps} de {selectedWorkflow.progress.totalSteps} etapas concluídas ({selectedWorkflow.progress.percentage}%)
                                  </p>
                                </div>
                              </div>
                                        ...
                                        <AlertDescription>
                                          <div className="flex items-center justify-between">
                                            ...
                                            <Badge variant="outline" className={cn(
                                              ...
                                              blocker.severity === 'medium' ? 'text-orange-600' : 'text-green-600'
                                            )}>
                                              {blocker.severity}
                                            </Badge>
                                          </div>
                              ...
                              <div>
                                ...
                                <div className="mt-2 grid grid-cols-3 gap-4 text-sm">
                                  <div>
                                    ...
                                    <span className="ml-2 font-medium">{selectedWorkflow.metrics.escalations}</span>
                                  </div>
                                  <div>
                                    <span className="text-muted-foreground">Reaberturas:</span>
                                    <span className="ml-2 font-medium">{selectedWorkflow.metrics.reopenCount}</span>
                                  </div>
                                  {selectedWorkflow.metrics.timeToResolution && (
                                    <div>
                                      <span className="text-muted-foreground">Tempo de resolução:</span>
                                      <span className="ml-2 font-medium">{selectedWorkflow.metrics.timeToResolution.toFixed(1)}h</span>
                                    </div>
                                  )}
                                </div>
                              </div>
                ...
                {filteredWorkflows.length === 0 && (
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p className="text-sm">Ajuste os filtros ou aguarde novas violações serem detectadas</p>
                  </div>
                )}
              </div>
            </CardContent>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm text-muted-foreground">{stats.averageResolution.toFixed(1)}h</span>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Progress value={((stats.total - stats.overdue) / stats.total) * 100} className="mt-2 h-2" />
                  </div>
                </div>
              </CardContent>
            </Card>
