...
export default function BrazilianComplianceAutomationDashboard() {
  ...
  const handleGenerateReport = useCallback(
    (regulation: 'lgpd' | 'anvisa' | 'cfm' | 'all',) => {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Sistema automatizado de compliance LGPD, ANVISA e CFM
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Badge
              variant={getStatusColor(complianceStatus.lgpd.status,)}
              className="mt-2"
            >
              {complianceStatus.lgpd.status.toUpperCase()}
            </Badge>
            <p className="text-xs text-muted-foreground mt-2">
              {complianceStatus.lgpd.issues.length} pendências
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Badge
              variant={getStatusColor(complianceStatus.anvisa.status,)}
              className="mt-2"
            >
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Badge
              variant={getStatusColor(complianceStatus.cfm.status,)}
              className="mt-2"
            >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    Licença de estabelecimento vence em 6 meses
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
                  ...
                  {complianceStatus.anvisa.licenses.map((license,) => (
                    <div key={license.id} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          variant={license.status === 'valid' ? 'default' : 'outline'}
                        >
                  ...
                  {complianceStatus.cfm.certifications.map((cert,) => (
                    <div key={cert.id} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          variant={cert.status === 'valid' ? 'default' : 'outline'}
                        >
