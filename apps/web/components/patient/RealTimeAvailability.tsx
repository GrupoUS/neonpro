...
export default function BehavioralCRM() {
  // Estado principal
  const [patients, setPatients] = useState<PatientBehaviorProfile[]>([
    {
      id: '1',
      patientId: 'p001',
      name: 'Ana Silva',
  ...
  const getPersonalityIcon = (type: string) => {
    switch (type) {
      ...
      case 'expressive': return <MessageSquare className="w-4 h-4" />;
      case 'driver': return <Target className="w-4 h-4" />;
      case 'amiable': return <Heart className="w-4 h-4" />;
              ...
              <Card className="lg:col-span-2">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                      <div className={`text-2xl font-bold ${selectedPatient.riskScore > 50 ? 'text-red-500' : 'text-green-500'}`}>
