...
const mockPaymentData = {
  ...
  financialSummary: {
    ...
    categoryBreakdown: [
      { category: "Facial", amount: 2200, percentage: 64 },
      { category: "Corporal", amount: 800, percentage: 23 },
      { category: "Consultas", amount: 450, percentage: 13 },
    ],
  },
};
...
export function PaymentBilling() {
  ...
  if (selectedPayment) {
    return (
      <div className="space-y-6">
        {/* Back Button */}
        <Button onClick={() => setSelectedPayment(undefined)} variant="outline">
          ← Voltar
        </Button>
