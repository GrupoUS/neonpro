...
import { AlertCircle, Calendar as CalendarIcon, CheckCircle, Clock, Edit, Plus, User, XCircle } from "lucide-react";
...
export default function AppointmentScheduler() {
	...
	const filteredAppointments = appointments.filter((apt) => apt.date.toDateString() === selectedDate.toDateString());
		...
		<div className="space-y-6">
			...
			<div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
				...
				<Card>
					...
					<CardContent>
						<Calendar className="rounded-md border" mode="single" onSelect={handleDateSelect} selected={selectedDate} />
					</CardContent>
				</Card>
				...
				<Card className="lg:col-span-2">
					<CardHeader>
						...
						<CardDescription>{filteredAppointments.length} agendamento(s) para esta data</CardDescription>
					</CardHeader>
					<CardContent>
						{filteredAppointments.length === 0 ? (
							<div className="py-8 text-center">
								...
								<p className="mt-1 text-gray-500 text-sm">Não há consultas agendadas para esta data.</p>
							</div>
						) : (
						...
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p className="font-bold text-2xl">
									{appointments.filter((apt) => apt.date.toDateString() === new Date().toDateString()).length}
								</p>
							</div>
						</div>
					</CardContent>
					...
					<CardContent className="p-4">
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p className="font-bold text-2xl">{appointments.filter((apt) => apt.status === "confirmed").length}</p>
							</div>
						</div>
					</CardContent>
				</Card>
					...
					<CardContent className="p-4">
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p className="font-bold text-2xl">{appointments.filter((apt) => apt.status === "cancelled").length}</p>
							</div>
						</div>
					</CardContent>
				</Card>
					...
					<CardContent className="p-4">
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p className="font-bold text-2xl">{appointments.filter((apt) => apt.status === "no-show").length}</p>
							</div>
						</div>
					</CardContent>
				</Card>
