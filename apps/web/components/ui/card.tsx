...
function Card({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			className={cn(
				"flex flex-col gap-6 rounded-xl border bg-card py-6 text-card-foreground shadow-neonpro-card transition-shadow duration-200 hover:shadow-neonpro-glow/20",
				className
			)}
			data-slot="card"
			{...props}
