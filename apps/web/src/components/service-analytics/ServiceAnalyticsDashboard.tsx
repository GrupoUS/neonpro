    ...
    <div className='space-y-6'>
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
        <Card>
          ...
          <CardContent>
            ...
            <div className='flex items-center text-xs text-muted-foreground'>
              ...
              <span className={kpis.growth_rate >= 0 ? 'text-green-500' : 'text-red-500'}>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {kpis.client_satisfaction ? `${kpis.client_satisfaction.toFixed(1)}/5` : 'N/A'}
            </div>
            <p className='text-xs text-muted-foreground'>
      ...
      <Card>
        ...
        <CardContent>
          <div className='space-y-4'>
            {dashboard?.service_performance?.slice(0, 5).map((service, index) => (
              <div key={service.service_id} className='flex items-center justify-between'>
                ...
                <div className='text-right'>
                  ...
                  <Badge variant={service.growth_rate >= 0 ? 'default' : 'secondary'}>
      ...
      <div className='grid gap-4 md:grid-cols-2'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='space-y-4'>
              {dashboard?.professional_performance?.slice(0, 5).map((professional, index) => (
                <div
                ...
                >
                  <div className='flex items-center space-x-3'>
                    ...
                    <div>
                      <p className='font-medium'>{professional.professional_name}</p>
                      <p className='text-sm text-muted-foreground'>
                  ...
                  <div className='text-right'>
                    <p className='font-medium'>{formatCurrency(professional.total_revenue)}</p>
                    <p className='text-sm text-muted-foreground'>
