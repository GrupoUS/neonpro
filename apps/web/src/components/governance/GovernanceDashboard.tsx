  ...
  return (
    <main className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        <section aria-label="KPI Overview" role="region" className="xl:col-span-3">
          <KPIOverviewCards />
        </section>

        <section aria-label="Compliance Status" role="region" className="lg:col-span-2">
        ...
        <section aria-label="Policy Management" role="region" className="lg:col-span-2">
        ...
        <section aria-label="Audit Trail" role="region" className="xl:col-span-3">
          <AuditTrailTable />
        </section>
      </div>
    </main>
