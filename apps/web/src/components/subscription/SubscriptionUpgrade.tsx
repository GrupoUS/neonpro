...
export default function SubscriptionUpgrade({
  ...
  if (variant === 'modal') {
    return (
      <div className={cn('bg-white rounded-lg border border-[#D2D0C8] p-6', className)}>
          ...
          <div className='space-y-4 mb-6'>
            {PRO_FEATURES.map((feature, index) => (
              <div key={index} className='flex items-start space-x-3'>
                ...
                <div>
                  <h4 className='font-medium text-[#112031] mb-1'>{feature.title}</h4>
                  <p className='text-sm text-[#B4AC9C]'>{feature.description}</p>
                </div>
              </div>
            ))}
          </div>
    ...
    >
      <div className='flex items-start justify-between mb-4'>
        <div>
          <div className='flex items-center space-x-2 mb-2'>
            ...
            <h3 className='text-lg font-semibold text-[#112031]'>NeonPro Pro</h3>
          </div>
      ...
      {showFeatures && (
        <div className='space-y-2 mb-6'>
          <div className='text-sm font-medium text-[#112031] mb-3'>Incluído no Pro:</div>
          {PRO_FEATURES.map((feature, index) => (
