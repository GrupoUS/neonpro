...
import { Contact, Phone, Mail, UserPlus, Search, Check, X, AlertCircle, Clock, Star } from "lucide-react";
          ...
          filteredContacts.map((contact) => (
            <div
              ...
              className={`border rounded-lg p-3 hover:bg-gray-50 transition-colors ${
                selectedContacts.includes(contact.id!) ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
              }`}
            >
                ...
                <div className="flex items-center space-x-1 ml-2">
                  <button
                    ...
                    className={`p-1 rounded ${
                      contact.isFavorite ? 'text-yellow-500 bg-yellow-50' : 'text-gray-400 hover:text-gray-600'
                    }`}
