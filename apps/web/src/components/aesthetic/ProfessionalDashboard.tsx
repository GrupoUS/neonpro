    ...
    <div className='max-w-7xl mx-auto space-y-6'>
            ...
            <Card key={alert.id} className='border-red-200 bg-red-50'>
              <CardContent className='pt-4'>
                <div className='flex items-start space-x-3'>
                  ...
                  <Button size='sm' variant='outline' onClick={onNavigateToCompliance}>
                    Resolver
                  </Button>
                </div>
              </CardContent>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>{metrics.procedures.completed}</div>
            <p className='text-xs text-muted-foreground'>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className='mt-4 flex justify-end'>
            <Button variant='outline' size='sm' onClick={onNavigateToCompliance}>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className='mt-4'>
              <Button variant='outline' className='w-full' onClick={onNavigateToSchedule}>
                Ver Agenda Completa
              </Button>
            </div>
          </CardContent>
                ...
                >
                  ...
                  <div className='flex-1 min-w-0'>
                    <div className='flex items-center justify-between'>
                      ...
                      <Badge {...getStatusBadge(activity.status)} className='ml-2 text-xs'>
                    ...
                    <div className='flex items-center justify-between mt-1'>
                      ...
                      {activity.price && (
                        <p className='text-xs font-medium text-green-600'>
                          {formatCurrency(activity.price, activity.currency || 'R$')}
                        </p>
                      )}
                    </div>
                  </div>
