      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {metrics.procedures.scheduled} agendados •{" "}
              {metrics.procedures.pending} pendentes
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              NPS: {metrics.satisfaction.npsScore} •{" "}
              {metrics.satisfaction.totalReviews} avaliações
            </p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Badge
                  className={
                    metrics.compliance.lgpdCompliance >= 95
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Badge
                  className={
                    metrics.compliance.anvisaCompliance >= 95
                      ? "bg-green-100 text-green-800"
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Badge
                  className={
                    metrics.compliance.auditScore >= 95
                      ? "bg-green-100 text-green-800"
