...
export function TreatmentSuggestions({
  ...
  const [selectedForComparison, setSelectedForComparison] =
    useState<string[]>(selectedTreatments);
  ...
  return (
    <div className={cn("space-y-6", className)}>
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Baseado na análise IA das suas fotos • {displayedSuggestions.length}{" "}
          sugestões
        </p>
      </div>
              ...
              onClick={() => {
                onTreatmentCompare?.(
                  suggestions.filter((t) =>
                    selectedForComparison.includes(t.id),
                  ),
                );
              }}
            >
            ...
            <div className="p-4 space-y-3">
              ...
              {suggestion.price && (
                <div className="flex items-center gap-1 text-sm">
                  ...
                  <span>
                    {formatCurrency(suggestion.price.min)} -{" "}
      ...
      <div className="text-xs text-muted-foreground text-center space-y-1">
        <p>
          💡 As recomendações são baseadas em análise de IA e devem ser
          confirmadas por um profissional
        </p>
        <p>
          Resultados podem variar dependendo das características individuais e
