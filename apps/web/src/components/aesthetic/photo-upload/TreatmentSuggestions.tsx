          ...
          >
            ...
            {expandedTreatment === suggestion.id && (
              <div className='border-t bg-muted/30 p-4 space-y-3'>
                {/* Full Description */}
                <div>
                  <h5 className='text-sm font-medium mb-1'>Descrição Completa</h5>
                  <p className='text-sm text-muted-foreground'>
                    {suggestion.description}
                  </p>
                </div>
                ...
                {/* Treatment Duration */}
                <div>
                  <h5 className='text-sm font-medium mb-1'>Duração do Tratamento</h5>
                  <p className='text-sm text-muted-foreground'>
                    {formatDuration(suggestion.estimatedSessions, suggestion.intervalWeeks)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className='text-sm text-muted-foreground space-y-1'>
                    ...
                    <li>• Acompanhamento profissional durante todo tratamento</li>
                  </ul>
                </div>
...
export function TreatmentComparison({ treatments, onClose }: TreatmentComparisonProps) {
            ...
            {treatments.map(treatment => (
              <div key={treatment.id} className='border rounded-lg p-4'>
                ...
                <div className='space-y-2 text-sm'>
                  ...
                  <div className='flex justify-between'>
                    <span>Sessões:</span>
                    <span className='font-medium'>{treatment.estimatedSessions}</span>
                  </div>
                  <div className='flex justify-between'>
                    <span>Intervalo:</span>
                    <span className='font-medium'>{treatment.intervalWeeks} semanas</span>
                  </div>
                  {treatment.price && (
                    <div className='flex justify-between'>
                      <span>Preço:</span>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span className='font-medium capitalize'>{treatment.priority}</span>
                  </div>
                </div>
              </div>
            ))}
