...
const CONSENT_DESCRIPTIONS = {
  dataProcessing: {
    ...
    details:
      "Suas fotos serão processadas por nossos sistemas de IA para identificar características da pele e fornecer recomendações personalizadas.",
    category: "required" as const,
  },
  imageAnalysis: {
    title: "Análise por IA",
    description:
      "Permite a análise das suas fotos usando inteligência artificial",
    details:
      "Nossos algoritmos de IA analisarão suas fotos para identificar condições da pele, rugas, acne, e outras características estéticas.",
    category: "required" as const,
  },
  storageDuration: {
    ...
    details:
      "Você pode escolher por quanto tempo deseja que suas fotos sejam armazenadas. Após este período, os dados serão automaticamente excluídos.",
    category: "required" as const,
  },
  dataSharing: {
    ...
    details:
      "Dados anonimizados podem ser compartilhados com parceiros para melhoria dos serviços de IA e pesquisa estética.",
  ...
  medicalAnalysis: {
    ...
    details:
      "Profissionais de saúde podem analisar suas fotos para fornecer recomendações de tratamentos estéticos personalizados.",
  ...
  treatmentRecommendations: {
    ...
    details:
      "Baseado na análise das suas fotos, nosso sistema irá sugerir tratamentos estéticos personalizados para suas necessidades.",
    category: "recommended" as const,
  },
  anonymizationForResearch: {
    ...
    details:
      "Suas fotos podem ser usadas de forma anonimizada em pesquisas científicas para avançar o conhecimento em estética.",
    category: "optional" as const,
  },
  marketingCommunications: {
    ...
    details:
      "Enviaremos informações sobre novos tratamentos, promoções e novidades do mundo da estética.",
    category: "optional" as const,
  },
  treatmentReminders: {
    ...
    details:
      "Enviaremos lembretes para ajudar você a manter seu tratamento estético em dia.",
    category: "optional" as const,
  },
  rightToWithdraw: {
    title: "Direito de Retirada",
    description:
      "Reconheço que posso retirar meu consentimento a qualquer momento",
    details:
      "Você tem o direito de retirar seu consentimento a qualquer momento através das configurações da sua conta.",
    category: "required" as const,
  },
  dataPortability: {
    title: "Portabilidade de Dados",
    description:
      "Entendo que tenho direito aos meus dados e posso solicitá-los",
    details:
      "Você pode solicitar uma cópia de todos os seus dados a qualquer momento de acordo com a LGPD.",
    category: "required" as const,
  },
} as const;
...
const STORAGE_DURATION_OPTIONS = [
  { value: "30", label: "30 dias", description: "Para análises pontuais" },
  {
    value: "90",
    label: "3 meses",
    description: "Para acompanhamento de curto prazo",
  },
  ...
  { value: "365", label: "1 ano", description: "Para acompanhamento completo" },
  {
    value: "indefinite",
    label: "Indeterminado",
    description: "Para histórico completo do paciente",
  },
];
...
export function LGPDConsentManager({
  ...
  const renderConsentItem = (
    field: keyof LGPDConsentData,
    config: (typeof CONSENT_DESCRIPTIONS)[keyof typeof CONSENT_DESCRIPTIONS],
  ) => {
        ...
        <div className="flex items-start gap-3">
          <div className="flex-shrink-0 mt-1">
            <IconComponent
              className={cn(
                "h-5 w-5",
                CONSENT_CATEGORIES[config.category].color,
              )}
            />
          </div>
            ...
            <div className="flex items-center justify-between">
              ...
              {field === "storageDuration" ? (
                <select
                  ...
                  onChange={(e) =>
                    handleConsentChange("storageDuration", e.target.value)
                  }
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    checked={isChecked}
                    onChange={(e) =>
                      handleConsentChange(field, e.target.checked)
                    }
    ...
    <div className={cn("space-y-6", className)}>
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
          De acordo com a Lei Geral de Proteção de Dados (LGPD), precisamos do
          seu consentimento para processar suas fotos e fornecer análise
        ...
        <div className="max-w-md mx-auto">
          <div className="flex justify-between text-xs text-muted-foreground mb-1">
            ...
            <span>
              {status.required}/{status.totalRequired} (
      ...
      <div className="space-y-4">
        ...
        {Object.entries(CONSENT_DESCRIPTIONS)
          ...
          .map(([field, config]) =>
            renderConsentItem(field as keyof LGPDConsentData, config),
          )}
      </div>
        ...
        <div className="grid gap-3 text-sm">
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <span className="text-muted-foreground ml-1">
                Dados armazenados pelo período selecionado (
                {
                  STORAGE_DURATION_OPTIONS.find(
                    (o) => o.value === consent.storageDuration,
                  )?.label
                }
                )
              </span>
      ...
      {showWithdrawDialog && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-background rounded-lg max-w-md w-full p-6 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Por favor, informe o motivo pelo qual deseja retirar seu
              consentimento. Isso nos ajuda a melhorar nossos serviços.
            </p>
      ...
      <div className="text-xs text-muted-foreground space-y-1">
        <p>
          📍 De acordo com a Lei nº 13.709/2018 (LGPD), você tem direito de
          acesso, correção, anonimização, bloqueio ou eliminação de seus dados
          pessoais.
        </p>
        <p>
          📍 Você pode exercer seus direitos entrando em contato com nosso
          Encarregado de Dados através do email: dpo@neonpro.com.br
        </p>
        <p>
          📍 Esta empresa está inscrita no CNPJ sob o nº 00.000.000/0001-00 e
          está em conformidade com as normas da LGPD e ANVISA.
        </p>
      </div>
    </div>
  );
