      ...
      <div key={field} className='space-y-2 p-4 border rounded-lg'>
        <div className='flex items-start gap-3'>
          ...
          <div className='flex-1 space-y-2'>
            ...
            {isChecked && field !== 'storageDuration' && field !== 'rightToWithdraw'
        ...
        <div className='grid gap-3 text-sm'>
          ...
          <div className='flex items-start gap-2'>
            ...
            <div>
              ...
              <span className='text-muted-foreground ml-1'>
                Dados armazenados pelo período selecionado ({STORAGE_DURATION_OPTIONS.find(o =>
                  o.value === consent.storageDuration
                )?.label})
              </span>
            </div>
          </div>
