...
describe('LGPDConsentManager Component', () => {
  ...
  describe('Renderização Inicial', () => {
    ...
    it('deve mostrar consentimento expirado', () => {
      ...
      expect(screen.getByText(/Seu consentimento expirou e precisa ser renovado/i))
        .toBeInTheDocument();
    });
  ...
  describe('Submissão do Formulário', () => {
    ...
    it('deve mostrar confirmação antes de salvar', async () => {
      ...
      expect(screen.getByText(/tem certeza que deseja conceder consentimento/i))
        .toBeInTheDocument();
    });
  ...
  describe('Gerenciamento de Consentimento Existente', () => {
    ...
    it('deve permitir editar consentimento', async () => {
      render(
        <LGPDConsentManager consentData={mockConsentData} onUpdateConsent={mockUpdateConsent} />,
      );
  ...
  describe('Direitos do Titular', () => {
    ...
    it('deve permitir exercer direitos através de botões', async () => {
      ...
      render(
        <LGPDConsentManager consentData={mockConsentData} onExerciseRight={onExerciseRight} />,
      );
  ...
  describe('Acessibilidade', () => {
    ...
    it('deve ter landmarks ARIA corretos', () => {
      ...
      expect(screen.getByRole('complementary', { name: /direitos do titular/i }))
        .toBeInTheDocument();
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('deve lidar com desconexão de rede', async () => {
      ...
      expect(screen.getByText(/algumas funcionalidades podem estar limitadas/i))
        .toBeInTheDocument();
    });
