...
>(({
  ...
  const accessibilityProps = {
    ...
    role: props.role || (variant === 'link' ? 'link' : 'button'),
  };
  ...
  return (
    <button
      ...
      className={cn(
        ...
        variants[variant],
        sizes[size],
        isEmergency && 'bg-red-600 hover:bg-red-700 text-white font-bold animate-pulse',
...
>(({
  ...
  const accessibilityProps = {
    role: variant === 'emergency' ? 'alert' : 'alertdialog',
