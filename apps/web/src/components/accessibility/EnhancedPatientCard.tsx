        ...
        <div id={`patient-${patient.id}-details`} className="space-y-2">
          ...
          {patient.lastAppointment && (
            <div className="text-sm text-gray-500">
              ...
              <span
                aria-label={`Último agendamento: ${ScreenReaderUtils.formatDateForScreenReader(
                  patient.lastAppointment,
                )}`}
              >
                Último:{" "}
          ...
          {patient.nextAppointment && (
            <div className="text-sm text-gray-500">
              ...
              <span
                aria-label={`Próximo agendamento: ${ScreenReaderUtils.formatDateForScreenReader(
                  patient.nextAppointment,
                )}`}
              >
                Próxima:{" "}
          ...
          <div id={`patient-${patient.id}-healthcare`} className="sr-only">
            ...
            {getHealthcareCategoryLabel(healthcareDataCategory)}. Contexto da
