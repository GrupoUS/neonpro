...
import { Button, Card, CardContent, CardHeader, CardTitle, Input, Label, Textarea } from '@neonpro/ui';
...
export function AccessibleHealthcareForm({
  ...
  const validateForm = useCallback(() => {
    ...
    if (errors.length > 0) {
      ...
      announceLive(`Formulário contém ${errors.length} erros. Corrija os campos destacados.`, 'assertive');
    }
  ...
  }, [isSubmitting, isLoading, validateForm, fields, fieldHooks, onSubmit, announceFormSuccess, announceFormError, announceLive]);
