            ...
            <div className='text-center'>
              <div
                className={`text-2xl font-bold ${
                  getStatusColor(complianceStatus)
                ...
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <div className='grid grid-cols-2 md:grid-cols-3 gap-2 text-sm'>
                      <div>
                        <strong>Patient Journey:</strong> {result.context.patientJourney}
                      </div>
                      <div>
                        <strong>Data Sensitivity:</strong> {result.context.dataSensitivity}
                      </div>
                      <div>
                      ...
                      <div>
                        <strong>Emergency Issues:</strong> {emergencyIssuesCount}
                      </div>
                    </div>
                  </div>
                      ...
                      >
                        <CardContent className='pt-4'>
                          ...
                          <div className='flex flex-wrap gap-2 mb-2'>
                            ...
                            {issue.lgpdRelevant && <Badge variant='outline'>LGPD</Badge>}
                          </div>

                          <div className='text-sm space-y-1'>
                            <div>
                              <strong>Patient Impact:</strong> {issue.patientImpact}
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              {issue.complianceStandards.map(s => s.name).join(', ')}
                            </div>
                          </div>
                  ...
                  {result.context.regulatoryRequirements.map(standard => (
                    <div key={standard.id}>
                      ...
                      <div className='text-xs space-y-1'>
                        <div>
                          <strong>Regulatory Body:</strong> {standard.regulatoryBody}
                        </div>
                        <div>
