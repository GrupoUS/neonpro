...
export function AccessibilityTester({
  ...
  const [activeTab, setActiveTab] = useState<
    'summary' | 'violations' | 'contrast' | 'keyboard'
  >('summary');
      ...
      >
        <Button
          ...
          aria-label={isVisible
            ? 'Hide accessibility tester'
            : 'Show accessibility tester'}
            ...
            <CardHeader className='pb-3'>
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  >
                    <RefreshCw
                      className={`w-4 h-4 ${isTesting || isTestingKeyboard ? 'animate-spin' : ''}`}
                    />
                  </Button>
                  <Button
                    variant='ghost'
              ...
              <div className='flex flex-wrap gap-2 mt-3'>
                ...
                <div className='flex items-center gap-1 text-sm'>
                  ...
                  <span>
                    Healthcare: {healthcareCompliance.healthcareData ? '✅' : '❌'}
                  </span>
                </div>
                    ...
                    <div className='p-3 rounded-lg bg-gray-50 border'>
                      ...
                      <div className='space-y-1 text-sm'>
                        ...
                        <div className='flex justify-between'>
                          ...
                          <span>
                            {healthcareCompliance.healthcareData ? '✅' : '❌'}
                          </span>
                        </div>
                        <div className='flex justify-between'>
                          <span>🚨 Emergency Features</span>
                          <span>
                            {healthcareCompliance.emergencyFeatures
                              ? '✅'
                              : '❌'}
                          </span>
                        </div>
                    ...
                    {issues.length === 0
                      ? (
                        <div className='text-center py-8 text-green-600'>
                          ...
                          <p className='text-sm'>
                            Your interface meets WCAG 2.1 AA+ standards.
                          </p>
                        </div>
                      )
                    ...
                    {colorContrast.elements.length === 0
                      ? (
                        <div className='text-center py-8 text-gray-500'>
                          ...
                          <p className='text-sm'>
                            Run a test to check color contrast.
                          </p>
                        </div>
                      )
