                  ...
                  <div className="mt-3">
                    ...
                    <ul className="text-xs text-muted-foreground space-y-1">
                      ...
                      {score.issues.length > 2 && (
                        <li>• ... and {score.issues.length - 2} more</li>
                      )}
                    </ul>
                  </div>
                )}
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        >
          {isValidating ? <Timer className="w-4 h-4 animate-spin" /> : <ClipboardCheck className="w-4 h-4" />}
      ...
      {validationResult && (validationResult.criticalIssues.length > 0 || validationResult.topRecommendations.length > 0) && (
