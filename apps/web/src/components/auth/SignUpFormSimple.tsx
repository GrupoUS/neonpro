        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <div>
            <label htmlFor='license' className='block text-sm font-medium text-gray-700 mb-1'>
              ...
              {formData.profession && formData.profession !== 'admin' &&
                formData.profession !== 'recepcionista' && ' *'}
            </label>
            <input
              ref={licenseRef}
              id='license'
              ...
              onChange={handleInputChange}
              placeholder={formData.profession === 'medico'
                ? 'CRM 12345/SP'
          ...
          <div className='space-y-4'>
            <label className='flex items-start'>
              ...
              <span className='ml-2 text-sm text-gray-600'>
                <span className='font-medium'>Li e concordo</span>{' '}
                com o tratamento dos meus dados pessoais de acordo com a{' '}
                <a
                  href='/privacy'
                  target='_blank'
