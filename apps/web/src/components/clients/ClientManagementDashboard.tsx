          ...
          recommendations: [
            {
              ...
              description: 'Agendar sessão de acompanhamento para discutir progresso',
              actionItems: [
      ...
      const mockPendingActions: ClientAction[] = [
        {
          ...
          description: 'Ligar para cliente de alto risco para entender situação',
          dueDate: '2024-01-15',
          completed: false,
        },
        {
            ...
            <Card key={analytics.clientId}>
              <CardHeader>
                <CardTitle className='flex items-center justify-between'>
                  ...
                  <Badge
                    variant={analytics.riskLevel === 'high'
                      ? 'destructive'
                      : analytics.riskLevel === 'medium'
                      ? 'default'
                      : 'secondary'}
                  >
                    Risco {analytics.riskLevel === 'high'
                      ? 'Alto'
                      : analytics.riskLevel === 'medium'
                      ? 'Médio'
                      : 'Baixo'} ({Math.round(analytics.riskScore * 100)}%)
                  </Badge>
                </CardTitle>
              </CardHeader>
              <CardContent>
                    ...
                    <div className='flex items-center space-x-3'>
                      ...
                      <div className='flex-1'>
                        ...
                        <div className='flex items-center space-x-4 mt-1'>
                          ...
                          {action.dueDate && (
                            <div className='text-xs text-gray-500'>
                              Prazo: {new Date(action.dueDate).toLocaleDateString(
                                'pt-BR',
                              )}
                            </div>
                          )}
              ...
              <div className='space-y-4'>
                <Alert>
                  ...
                  <AlertDescription>
                    ...
                    Os dados indicam uma oportunidade de melhoria de 15% na retenção através de
                    ...
                    <CardContent>
                      <ul className='text-sm space-y-2'>
                        <li className='flex items-center'>
                          ...
                          Personalização de comunicação pode aumentar engajamento em 25%
                        </li>
                        <li className='flex items-center'>
                          <CheckCircle className='h-4 w-4 text-green-500 mr-2' />
                        ...
                        <li className='flex items-center'>
                          <CheckCircle className='h-4 w-4 text-green-500 mr-2' />
                          Follow-ups automatizados podem melhorar satisfação em 12%
                        </li>
                      </ul>
                    </CardContent>
                  </Card>
