...
export function SyncSettings({
  ...
  const { data: integration, isLoading } = useQuery({
    queryKey: ['google-calendar-integration',_userId,_clinicId],
    queryFn: async () => {
      ...
      <CardContent className='space-y-6'>
        ...
        <div className='flex items-center justify-between p-4 bg-gray-50 rounded-lg'>
          ...
          <Button
            ...
            size='sm'
          >
            {syncNowMutation.isPending && <RefreshCw className='mr-2 h-4 w-4 animate-spin' />}
            Sincronizar Agora
          </Button>
        </div>
        ...
        <Alert>
          ...
          <AlertDescription>
            Todos os dados são sincronizados de forma segura e em conformidade com a LGPD. Os
            compromissos são marcados como privados no Google Calendar.
          </AlertDescription>
        </Alert>
