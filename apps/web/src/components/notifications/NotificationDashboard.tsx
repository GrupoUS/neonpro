        ...
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              disabled={
                processPendingMutation.isPending || stats?.pending === 0
              }
            >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 mt-1">
                  Existem {stats?.pending} notificações aguardando
                  processamento. Considere processar as pendentes para melhorar
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-700 mt-1">
                  {failureRate}% das notificações falharam. Verifique a
                  configuração dos serviços de email, SMS e WhatsApp.
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 mt-1">
                  O sistema está configurado e pronto para enviar notificações.
                  As notificações aparecerão aqui conforme os agendamentos forem
                  criados.
                </p>
              </div>
            </div>
