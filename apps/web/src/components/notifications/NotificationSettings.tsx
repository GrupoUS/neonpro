...
export function NotificationSettings({
  ...
  const { data: preferences, isLoading } =
    useNotificationPreferences(patientId);
    ...
    <Card className={className}>
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Configure como você deseja receber notificações sobre seus
          agendamentos
        </p>
      </CardHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                autorizar ou revogar o consentimento para recebimento de
          ...
          {localPreferences?.lgpdConsentDate && (
            <p className="text-xs text-muted-foreground">
              ...
              {new Date(localPreferences.lgpdConsentDate).toLocaleDateString(
                "pt-BR",
              )}
            </p>
          )}
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handlePreferenceChange("promotionalMessages", checked)
                }
                disabled={!localPreferences?.lgpdConsent}
              />
            </div>
        ...
        {!localPreferences?.lgpdConsent && (
          <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
            ...
            <div className="text-sm text-amber-800">
              ...
              <p>
                Para receber notificações, é necessário autorizar o
                consentimento LGPD acima.
              </p>
            </div>
          </div>
        )}
