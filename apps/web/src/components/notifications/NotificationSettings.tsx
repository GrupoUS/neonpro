      ...
      <CardContent className='space-y-6'>
        ...
        <div className='space-y-4'>
          ...
          {localPreferences?.lgpdConsentDate && (
            <p className='text-xs text-muted-foreground'>
              ...
              {new Date(localPreferences.lgpdConsentDate).toLocaleDateString('pt-BR')}
            </p>
          )}
        </div>
        ...
        <div className='space-y-4'>
          ...
          <div className='space-y-3'>
            <div className='flex items-center justify-between'>
              <div>
                <Label htmlFor='appointment-confirmations' className='text-sm font-medium'>
            ...
            <div className='flex items-center justify-between'>
              <div>
                <Label htmlFor='appointment-cancellations' className='text-sm font-medium'>
                  Cancelamentos
                </Label>
                <p className='text-xs text-muted-foreground'>
        ...
        {!localPreferences?.lgpdConsent && (
          <div className='flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-lg'>
            ...
            <div className='text-sm text-amber-800'>
              ...
              <p>Para receber notificações, é necessário autorizar o consentimento LGPD acima.</p>
            </div>
          </div>
        )}
