                ...
                <CardContent className="space-y-4">
                  <div className="grid gap-4">
                    ...
                    <div className="space-y-2 p-4 border rounded-lg">
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        incluindo autenticação e segurança.
                      </p>
                    </div>
                    ...
                    <div className="space-y-2 p-4 border rounded-lg">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          variant={
                            hasConsent("analytics") ? "default" : "outline"
                          }
                          className="text-xs"
                        >
                      ...
                      <p className="text-xs text-muted-foreground">
                        Coletam dados sobre como você usa nosso site para
                    ...
                    <div className="space-y-2 p-4 border rounded-lg">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          variant={
                            hasConsent("marketing") ? "default" : "outline"
                          }
                          className="text-xs"
                        >
                  ...
                  <div className="flex flex-col gap-2 pt-4 border-t sm:flex-row sm:justify-between sm:items-center">
                    <div className="text-xs text-muted-foreground">
                      Suas preferências podem ser alteradas a qualquer momento
                      nas configurações.
                    </div>
