      ...
      <Card className="w-full max-w-md text-center shadow-lg">
        <CardHeader className="pb-4">
          ...
          <CardDescription className="text-gray-600">
            Ocorreu um problema técnico. Nossa equipe foi notificada
            automaticamente.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="pt-4 border-t border-gray-200">
            <p className="text-xs text-gray-500 mb-2">O problema persiste?</p>
            <div className="space-y-2">
              ...
              >
                <a
                  href={
                    "mailto:suporte@neonpro.com.br?subject=Erro%20do%20Servidor&body=ID%20do%20Erro:%20" +
