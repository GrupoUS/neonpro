          ...
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Demonstração dos componentes de interface para gestão de
                  pacientes com compliance LGPD
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <div className="space-y-2 text-sm">
                            <div>
                              (11) 99999-9999:{" "}
                              {validateBrazilianPhone("(11) 99999-9999")
                                ? "✅ Válido"
                                : "❌ Inválido"}
                            </div>
                            <div>
                              (11) 8888-8888:{" "}
                              {validateBrazilianPhone("(11) 8888-8888")
                                ? "✅ Válido"
                                : "❌ Inválido"}
                            </div>
                            <div>
                              (11) 1234-5678:{" "}
                              {validateBrazilianPhone("(11) 1234-5678")
                                ? "✅ Válido"
                                : "❌ Inválido"}
                            </div>
                          </div>
