...
export const lgpdComplianceValidation: LGPDComplianceCheck[] = [
  {
    ...
    requirement:
      "Art. 8º - Consentimento do titular para tratamento de dados pessoais",
  ...
  },
  {
    ...
    implementation:
      "Consent withdrawal functionality in ConsentManagementDialog",
    status: "compliant",
    evidence: [
...
export const accessibilityComplianceValidation: AccessibilityCheck[] = [
  ...
  },
  {
    ...
    status: "pass",
    implementation:
      "Semantic HTML structure with proper heading hierarchy and form relationships",
  ...
  },
  {
    ...
    status: "pass",
    implementation:
      "NeonPro color palette meets 4.5:1 contrast ratio requirements",
