...
const ConsentIndicator = (
  { consentStatus }: { consentStatus: MobilePatientData['consentStatus'] },
) => {
  const consentConfig = {
        ...
        <div className='flex items-start justify-between'>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align='end' className='w-48'>
              ...
              <DropdownMenuItem
                onClick={() =>
                  navigate({ to: `/appointments/new`, search: { patientId: patient.id } })}
              >
...
export function MobilePatientList({
  ...
  const [consentFilter, setConsentFilter] = useState<'all' | MobilePatientData['consentStatus']>(
    'all',
  );
