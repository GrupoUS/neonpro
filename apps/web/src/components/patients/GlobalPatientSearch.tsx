...
export function GlobalPatientSearch({
  ...
  const SearchResultItem = (
    { patient, index }: { patient: PatientSearchResult; index: number },
  ) => (
    <div
      className={cn(
        ...
        >
          ...
          <div className='border-t p-2 bg-gray-50 dark:bg-gray-800'>
            <div className='flex items-center justify-between text-xs text-gray-500'>
              <span>
                Pressione <kbd className='px-1 py-0.5 bg-white dark:bg-gray-700 rounded'>/</kbd>
                {' '}
                para focar
              </span>
              <span>
                <kbd className='px-1 py-0.5 bg-white dark:bg-gray-700 rounded'>↑↓</kbd> navegar
              </span>
              <span>
              ...
              <span>
                <kbd className='px-1 py-0.5 bg-white dark:bg-gray-700 rounded'>Esc</kbd> fechar
              </span>
            </div>
          </div>
        </PopoverContent>
