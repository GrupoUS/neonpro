        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
          <Card className="w-full max-w-2xl">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Ocorreu um erro inesperado no sistema. Nossos dados estão
                protegidos e nenhuma informação do paciente foi comprometida.
              </CardDescription>
            </CardHeader>
                ...
                <AlertDescription>
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Este ID pode ser usado para rastrear o problema com nossa
                      equipe de suporte.
                    </p>
                  </div>
                </AlertDescription>
                ...
                <AlertDescription className="text-blue-800">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm">
                      ...
                      <br />✓ O erro foi registrado em nosso sistema de
                      auditoria LGPD
                    </p>
                  </div>
                </AlertDescription>
