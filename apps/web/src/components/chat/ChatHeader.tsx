...
const MenuIcon = ({ className }: { className?: string }) => (
  <svg className={cn("w-4 h-4", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <line strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} x1={3} y1={6} x2={21} y2={6} />
    <line strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} x1={3} y1={12} x2={21} y2={12} />
    <line strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} x1={3} y1={18} x2={21} y2={18} />
  </svg>
);
...
const InfoIcon = ({ className }: { className?: string }) => (
  <svg className={cn("w-4 h-4", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <line strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} x1={12} y1={16} x2={12} y2={12} />
    <line strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} x1={12} y1={8} x2={12.01} y2={8} />
  </svg>
);
...
const StethoscopeIcon = ({ className }: { className?: string }) => (
  <svg className={cn("w-4 h-4", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 2a2 2 0 0 0-2 2v6.5a.5.5 0 0 1-.5.5.5.5 0 0 1-.5-.5V8a2 2 0 0 0-2-2 2 2 0 0 0-2 2v2.5a.5.5 0 0 1-.5.5.5.5 0 0 1-.5-.5V8a4 4 0 0 1 8 0v13a2 2 0 0 1-4 0v-4a2 2 0 0 1 2-2 2 2 0 0 1 2 2" />
  </svg>
);
...
export default function ChatHeader({
  ...
  const activeParticipants = conversation.participants.filter(p => 
  ...
  const getHealthcareContextInfo = useCallback(() => {
    ...
    return {
      specialty: context.medical_specialty ? specialtyMap[context.medical_specialty] : null,
  ...
  return (
    <div className={cn(
      ...
      emergencyMode && "bg-red-50 dark:bg-red-950 border-b-2 border-red-200 dark:border-red-800",
      className
    )}>
      ...
      <div className="flex items-center gap-3 min-w-0 flex-1">
        ...
        <div className="relative flex-shrink-0">
          <div className={cn(
            ...
            conversationInfo.color === 'blue' && "bg-blue-100 dark:bg-blue-900",
            conversationInfo.color === 'green' && "bg-green-100 dark:bg-green-900", 
            conversationInfo.color === 'teal' && "bg-teal-100 dark:bg-teal-900",
            conversationInfo.color === 'purple' && "bg-purple-100 dark:bg-purple-900",
            conversationInfo.color === 'red' && "bg-red-100 dark:bg-red-900",
            conversationInfo.color === 'indigo' && "bg-indigo-100 dark:bg-indigo-900",
            conversationInfo.color === 'gray' && "bg-gray-100 dark:bg-gray-800",
            emergencyMode && "animate-pulse"
          )}>
            {React.createElement(conversationInfo.icon, { 
              className: cn(
                "w-5 h-5",
                conversationInfo.color === 'blue' && "text-blue-600 dark:text-blue-400",
                conversationInfo.color === 'green' && "text-green-600 dark:text-green-400",
                conversationInfo.color === 'teal' && "text-teal-600 dark:text-teal-400",
                conversationInfo.color === 'purple' && "text-purple-600 dark:text-purple-400",
                conversationInfo.color === 'red' && "text-red-600 dark:text-red-400",
                conversationInfo.color === 'indigo' && "text-indigo-600 dark:text-indigo-400",
                conversationInfo.color === 'gray' && "text-gray-600 dark:text-gray-400"
              )
            })}
          </div>
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            {conversation.ai_enabled && conversation.type !== 'ai_assistant' && (
              <div className="flex items-center gap-1 px-2 py-1 bg-blue-100 dark:bg-blue-900 rounded-full">
                ...
                <span className="text-xs text-blue-700 dark:text-blue-300">IA</span>
              </div>
            )}
          </div>
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            {activeParticipants.length > 0 && (
              <>
                <span>•</span>
                <span>
                  {activeParticipants.length === 1 ? '1 participante' : `${activeParticipants.length} participantes`}
                </span>
              </>
            )}
          </div>
        ...
        {onCall && conversation.type !== 'ai_assistant' && (
          <button
            ...
            className={cn(
              ...
              "text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200",
              "hover:bg-gray-100 dark:hover:bg-gray-800",
              emergencyMode && "text-red-600 hover:text-red-700 hover:bg-red-100 dark:hover:bg-red-900"
            )}
            title="Fazer chamada"
          >
            <PhoneIcon />
