    ...
    <div className="p-8 space-y-8">
      <div className="bg-gradient-to-r from-[#AC9469]/10 to-[#112031]/10 border border-[#AC9469]/30 text-[#112031] px-6 py-4 rounded-lg mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div>
            <p>
              <strong>✅ Expected Result:</strong> Neumorphic 3D styling with
          ...
          <div>
            ...
            <p>
              <strong>🎭 Animations:</strong> Gradient, border spin, and shimmer
              effects
            </p>
            <p>
      ...
      <div className="space-y-2">
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <p>
              This card content demonstrates the shadcn/ui Card component
              working in our monorepo setup.
            </p>
          </CardContent>
        </Card>
      </div>
