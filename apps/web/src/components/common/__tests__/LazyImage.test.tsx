...
describe('LazyImage', () => {
  ...
  it('should show loading state initially', () => {
    ...
    const loadingIndicator = screen.getByRole('img').parentElement?.querySelector('.animate-pulse');
  ...
  it('should use custom fallback image', async () => {
    render(<LazyImage {...defaultProps} fallback='/custom-fallback.jpg' priority />);
  ...
  it('should apply custom containerClassName', () => {
    render(<LazyImage {...defaultProps} containerClassName='custom-container' />);
...
describe('ResponsiveImage', () => {
  ...
  it('should generate srcSet for different breakpoints', () => {
    ...
    const webpSource = screen.getByRole('img').closest('picture')?.querySelector(
      'source[type="image/webp"]',
    );
    expect(webpSource).toHaveAttribute('srcset', expect.stringContaining('400w'));
    expect(webpSource).toHaveAttribute('srcset', expect.stringContaining('800w'));
    expect(webpSource).toHaveAttribute('srcset', expect.stringContaining('1200w'));
  });
  ...
  it('should generate sizes attribute', () => {
    ...
    expect(webpSource).toHaveAttribute('sizes', expect.stringContaining('640px'));
    expect(webpSource).toHaveAttribute('sizes', expect.stringContaining('768px'));
    expect(webpSource).toHaveAttribute('sizes', expect.stringContaining('1024px'));
  });
});
