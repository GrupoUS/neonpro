...
export function CertificationValidator({ onValidationComplete, onError }: CertificationValidatorProps) {
  ...
  const getExperienceLevelIcon = (level: string) => {
    switch (level) {
      ...
      case 'beginner': return <AlertTriangle className="h-4 w-4" />;
                  ...
                  {filteredProfessionals.map((professional: any) => (
                    <Card
                      ...
                      className={`cursor-pointer transition-all hover:shadow-md ${
                        selectedProfessional === professional.id ? 'ring-2 ring-blue-500 shadow-lg' : ''
                      }`}
            ...
            <CardContent>
              {!selectedProfessional || selectedProcedures.length === 0 ? (
                <Alert>
                  ...
                  <AlertDescription>
                    Selecione um profissional e ao menos um procedimento para realizar a validação.
                  </AlertDescription>
                </Alert>
              ) : (
                <div className="space-y-6">
                  ...
                  {validationResults && (
                    <div className="space-y-6">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        <h4 className="font-medium text-gray-900 mb-3">Detalhes do Profissional</h4>
                      ...
                      <div className="bg-green-50 rounded-lg p-4">
                        <h4 className="font-medium text-green-900 mb-3">Status de Conformidade</h4>
