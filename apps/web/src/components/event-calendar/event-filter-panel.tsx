            ...
            {statusOptions.map(({ value, label, color }) => (
              <Badge
                ...
                className={cn(
                  ...
                  selectedStatuses.includes(value) && `bg-${color}-100 text-${color}-800 border-${color}-300`
                )}
                onClick={() => {
          ...
          <div className="flex flex-wrap gap-2">
            {priorityOptions.map(({ value, label, color }) => (
              <Badge
                ...
                className={cn(
                  "cursor-pointer text-xs",
                  selectedPriorities.includes(value) && `bg-${color}-100 text-${color}-800 border-${color}-300`
                )}
                onClick={() => {
