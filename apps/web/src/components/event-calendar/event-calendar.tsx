...
export function EventCalendar({
  ...
  return (
    <div
      className='flex flex-col rounded-lg border has-data-[slot=month-view]:flex-1 focus:outline-none focus:ring-2 focus:ring-blue-500'
      style={{
    ...
    >
      <div id='calendar-instructions' className='sr-only'>
        Keyboard shortcuts: Arrow keys to navigate between periods. Home or T for today. M for month
        view, W for week view, D for day view, A for agenda view. Press Enter to select a date or
