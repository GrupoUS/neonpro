...
describe('Performance Benchmark Suite - Calendar Optimization', () => {
  ...
  describe('Rendering Performance', () => {
    it('should render calendar within 50ms threshold', async () => {
      const { measureComponentRender } = require('@/utils/performance-optimizer');
  ...
  describe('Interaction Performance', () => {
    ...
    it('should handle view switching within 100ms', () => {
      render(<EventCalendar events={performanceEvents} initialView="month" {...mockCallbacks} />);
  ...
  describe('Frame Rate Performance', () => {
    it('should maintain 60 FPS during interactions', async () => {
      const { measureCalendarPerformance } = require('@/utils/performance-optimizer');
  ...
  describe('Network Performance', () => {
    ...
    it('should implement efficient data loading', () => {
      const optimizedEvents = Array.from({ length: 50 }, (_, i) => ({
        id: `optimized-${i}`,
  ...
  describe('Benchmarking and Metrics', () => {
    it('should meet Core Web Vitals thresholds', async () => {
      const { validatePerformanceBudget } = require('@/utils/performance-optimizer');
  ...
  describe('Scalability Performance', () => {
    it('should scale with user count', () => {
      const userEvents = Array.from({ length: 1000 }, (_, i) => ({
        id: `user-${i}`,
        title: `Evento Usuário ${i}`,
        start: new Date(`2024-01-${String((i % 30) + 1).padStart(2, '0')}T${String(Math.floor(i / 4) + 8).padStart(2, '0')}:00`),
        end: new Date(`2024-01-${String((i % 30) + 1).padStart(2, '0')}T${String(Math.floor(i / 4) + 9).padStart(2, '0')}:00`),
        color: ['blue', 'emerald', 'violet', 'rose'][i % 4] as EventColor,
        userId: `user-${i}`,
      }));
