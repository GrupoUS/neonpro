...
vi.mock('@/utils/accessibility/healthcare-audit-utils', () => ({
  ...
  auditEventAccess: vi.fn().mockResolvedValue({ valid: true, auditId: 'audit-123' }),
...
describe('Healthcare Compliance Suite - LGPD, ANVISA, CFM', () => {
  ...
  describe('LGPD Compliance - Lei Geral de Proteção de Dados', () => {
    it('should implement data minimization for patient information', () => {
      ...
      render(<EventCalendar events={[sensitiveEvent as any]} {...mockCallbacks} />);
      ...
      expect(screen.queryByText('maria.santos@email.com')).not.toBeInTheDocument();
    ...
    it('should validate LGPD compliance on event access', async () => {
      const { validateLGPDCompliance, auditEventAccess } = await import('@/utils/accessibility/healthcare-audit-utils');
    ...
    it('should implement patient consent management', async () => {
      ...
      render(<EventCalendar events={[consentEvent as any]} {...mockCallbacks} />);
      
      expect(screen.getByText('Consulta com Consentimento')).toBeInTheDocument();
    ...
    it('should implement encryption for sensitive data', () => {
      ...
      render(<EventCalendar events={[encryptedEvent as any]} {...mockCallbacks} />);
  ...
  describe('ANVISA Compliance - Agência Nacional de Vigilância Sanitária', () => {
    it('should validate medical device classification', async () => {
      const { validateANVISACompliance } = await import('@/utils/accessibility/healthcare-audit-utils');
      ...
      render(<EventCalendar events={[medicalDeviceEvent as any]} {...mockCallbacks} />);
    ...
    it('should handle medical device recall situations', () => {
      ...
      render(<EventCalendar events={[recallEvent as any]} {...mockCallbacks} />);
    ...
    it('should validate sterilization procedures', () => {
      ...
      render(<EventCalendar events={[sterilizationEvent as any]} {...mockCallbacks} />);
    ...
    it('should track quality control procedures', () => {
      ...
      render(<EventCalendar events={[qualityControlEvent as any]} {...mockCallbacks} />);
  ...
  describe('CFM Compliance - Conselho Federal de Medicina', () => {
    it('should validate professional license and credentials', async () => {
      const { validateProfessionalLicense } = await import('@/utils/professional-registry');
    ...
    it('should enforce appointment duration limits', () => {
      ...
      render(<EventCalendar events={[excessiveDurationEvent]} {...mockCallbacks} />);
      
      expect(screen.getByText('Consulta Excessivamente Longa')).toBeInTheDocument();
    ...
    it('should prevent simultaneous appointments for same professional', () => {
      ...
      expect(screen.getByText('Consulta Dr. Silva - Paciente A')).toBeInTheDocument();
      expect(screen.getByText('Consulta Dr. Silva - Paciente B')).toBeInTheDocument();
      // Should handle professional scheduling conflicts
    });

    it('should validate professional-patient relationship boundaries', async () => {
      const { validateCFMCompliance } = await import('@/utils/accessibility/healthcare-audit-utils');
    ...
    it('should enforce telemedicine regulations', () => {
      ...
      render(<EventCalendar events={[telemedicineEvent as any]} {...mockCallbacks} />);
    ...
    it('should handle prescription management', () => {
      ...
      render(<EventCalendar events={[prescriptionEvent as any]} {...mockCallbacks} />);
    ...
    it('should maintain professional confidentiality', () => {
      ...
      render(<EventCalendar events={[confidentialEvent as any]} {...mockCallbacks} />);
  ...
  describe('Comprehensive Audit Trail', () => {
    it('should generate complete audit trail for all operations', async () => {
      const { generateAuditTrail } = await import('@/utils/accessibility/healthcare-audit-utils');
  ...
  describe('Cross-Compliance Integration', () => {
    it('should coordinate between LGPD, ANVISA, and CFM requirements', async () => {
      ...
      render(<EventCalendar events={[integratedEvent as any]} {...mockCallbacks} />);
    ...
    it('should handle compliance violations appropriately', () => {
      ...
      render(<EventCalendar events={[violationEvent as any]} {...mockCallbacks} />);
