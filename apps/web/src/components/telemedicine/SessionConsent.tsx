...
export function SessionConsent({
  ...
  // Hooks
  const { consent, updateConsent, revokeConsent, validateConsent, isUpdating } =
  ...
  const consentSections: ConsentSection[] = [
    {
      ...
      consequences:
        "Sem este consentimento, não é possível realizar a consulta por telemedicina.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Autorizo a gravação da consulta para fins médicos, legais e de qualidade.",
      required: true,
      category: "cfm",
      legalBasis: "CFM nº 2.314/2022 Art. 8º",
      consequences:
        "Gravação necessária para documentação médica e conformidade legal.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Autorizo o uso do microfone para comunicação durante a consulta.",
      required: true,
      category: "technical",
      legalBasis: "Necessário para teleconsulta",
      consequences:
        "Sem áudio, a consulta não pode ser realizada adequadamente.",
    },
    {
      id: "videoPermission",
      title: "Permissão de Vídeo",
      description:
        "Autorizo o uso da câmera para visualização durante a consulta.",
      required: true,
      category: "technical",
      legalBasis: "Necessário para teleconsulta",
    ...
    },
    {
      ...
      description:
        "Autorizo o uso de IA para auxiliar na consulta (triagem, sugestões, tradução).",
      required: false,
      category: "advanced",
    ...
    },
    {
      ...
      description:
        "Autorizo o compartilhamento de tela para mostrar exames ou documentos.",
      required: false,
      category: "technical",
            ...
            <Tabs defaultValue="current" className="w-full">
              ...
              <TabsContent value="compliance" className="space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    Todos os consentimentos estão em conformidade com LGPD e
                    CFM.
                  </AlertDescription>
                </Alert>
              </TabsContent>
  ...
  return (
    <div className={`max-w-4xl mx-auto space-y-6 ${className}`}>
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Importante:</strong> Leia atentamente cada seção antes de dar
          seu consentimento. Você pode revogar seu consentimento a qualquer
          momento, exceto para dados já processados sob base legal legítima.
          Campos marcados como "Obrigatório" são necessários para a realização
          da consulta.
        </AlertDescription>
      </Alert>
        ...
        <DialogContent className="max-w-4xl max-h-[80vh]">
          ...
          <ScrollArea className="h-96">
            <div className="space-y-4 text-sm">
              ...
              <p>
                Este documento estabelece os termos e condições para a
                realização de consulta médica por telemedicina, em conformidade
                com a Resolução CFM nº 2.314/2022 e a Lei Geral de Proteção de
                Dados (LGPD - Lei 13.709/2018).
              </p>

              <h5 className="font-medium">1. Definições</h5>
              <p>
                Telemedicina: exercício da medicina mediado por tecnologias para
                fins de assistência, educação, pesquisa, prevenção de doenças e
                lesões e promoção de saúde.
              </p>

              <h5 className="font-medium">2. Consentimento do Paciente</h5>
              <p>
                O paciente deve consentir de forma livre e esclarecida para a
                realização da telemedicina, após ser informado sobre as
                limitações inerentes ao uso da tecnologia.
              </p>

              <h5 className="font-medium">3. Proteção de Dados</h5>
              <p>
                Todos os dados pessoais serão tratados em conformidade com a
                LGPD, garantindo a segurança, confidencialidade e integridade
                das informações.
              </p>
      ...
      {!validateRequiredConsents() && (
        <Alert className="border-red-200 bg-red-50">
          ...
          <AlertDescription className="text-red-800">
            Para prosseguir, é necessário aceitar todos os consentimentos
            obrigatórios.
          </AlertDescription>
        </Alert>
      )}
