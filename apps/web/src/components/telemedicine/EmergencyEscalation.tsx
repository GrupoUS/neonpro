...
export function EmergencyEscalation({
  ...
  const handleStopRecording = () => {
    ...
    addTimelineEvent(
      "update",
      `Gravação finalizada - ${Math.floor(recordingDuration / 60)}:${String(
            ...
            <div className="flex items-center">
              <div className="flex-1">
                ...
                <div className="text-sm text-red-600">
                  Serviços de emergência contatados • Tempo:{" "}
                  {formatDuration(timeline.length * 30)}
                </div>
              </div>
        ...
        <ScrollArea className="flex-1 px-6">
          <Tabs value={currentStep.toString()} className="space-y-4">
            <TabsList className="grid w-full grid-cols-4">
              ...
              {isEmergencyActive && (
                <TabsTrigger value="4">Monitor</TabsTrigger>
              )}
            </TabsList>
            ...
            <TabsContent value="3" className="space-y-4">
              ...
              <div className="flex justify-center">
                <Button
                  ...
                  disabled={
                    !selectedEmergencyType || !symptoms || !location.address
                  }
                >
