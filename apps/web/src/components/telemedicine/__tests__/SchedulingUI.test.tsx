...
describe('SchedulingUI', () => {
  ...
  test('renders scheduling UI title', () => {
    ...
    expect(screen.getByText('Gerencie consultas virtuais e presenciais')).toBeInTheDocument();
  });
  ...
  test('search functionality works', () => {
    render(<SchedulingUI {...mockProps} />);
    const searchInput = screen.getByPlaceholderText('Buscar por paciente ou profissional...');
  ...
  test('handles empty state correctly', () => {
    ...
    expect(screen.getByText('Nenhuma consulta agendada para este dia')).toBeInTheDocument();
  });
