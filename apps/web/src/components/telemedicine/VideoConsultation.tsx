...
export function VideoConsultation({
  ...
  const [networkQuality, setNetworkQuality] = useState<'excellent' | 'good' | 'poor' | 'critical'>(
    'excellent',
  );
        ...
        <div className='flex items-center justify-center mt-2'>
          <div className='flex items-center space-x-2 text-xs text-gray-400'>
            <div className='flex space-x-1'>
              ...
              <div
                className={`w-1 h-3 rounded ${
                  ['good', 'excellent'].includes(networkQuality) ? 'bg-green-500' : 'bg-gray-600'
                }`}
              />
              <div
                className={`w-1 h-3 rounded ${
                  networkQuality === 'excellent' ? 'bg-green-500' : 'bg-gray-600'
                }`}
              />
            </div>
