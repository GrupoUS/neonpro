...
export function ConsentDialog({
  ...
  const consentItems: ConsentItem[] = [
    ...
    },
    {
      ...
      description:
        "Informações médicas sensíveis (exames, diagnósticos, tratamentos específicos)",
      required: false,
      icon: Shield,
    },
    {
      ...
      description:
        "Informações relacionadas à saúde mental e tratamentos psiquiátricos",
      required: false,
      icon: Eye,
    },
    {
  ...
  const purposeDescriptions = {
    ...
    ai_assistance:
      "assistência por inteligência artificial para melhor atendimento",
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            consentimento para processar seus dados pessoais durante a{" "}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg text-xs text-gray-600">
            ...
            <p>
              Você tem o direito de confirmar a existência de tratamento,
              acessar seus dados, corrigi-los, anonimizá-los, bloqueá-los ou
              eliminá-los, bem como a portabilidade dos dados e informação sobre
              o compartilhamento.
            </p>
          </div>
        </div>
