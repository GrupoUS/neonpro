...
export function WaitingRoomPreview() {
  const [currentScenario, setCurrentScenario] = React.useState<keyof typeof mockScenarios>('standard');
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <h1 className="text-2xl font-bold mb-4">WaitingRoom Component Preview</h1>
          <p className="text-gray-600 mb-6">
            Interactive preview of the telemedicine waiting room interface.
            Switch between different scenarios to test various states.
          </p>
