...
export const COMPONENT_INFO = {
  ...
  AIChatInput: {
    name: 'AI Chat Input',
    description: 'Enhanced input component with voice and file attachment capabilities',
    features: [
  ...
  AIMessageDisplay: {
    ...
    description: 'Message display component with streaming and markdown support',
    features: [
      'Streaming text',
      'Markdown rendering',
      'Source citations',
