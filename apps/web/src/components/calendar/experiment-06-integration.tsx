...
export function Experiment06CalendarIntegration({
    ...
    const processAppointmentsWithCompliance = async () => {
      ...
      try {
        ...
        setComplianceStatus({
          ...
          minimizationLevel: result.compliantAppointments[0]?.consentLevel
        ...
        {complianceStatus.hasIssues && (
          <div className='mt-3 p-3 bg-red-100 rounded border border-red-200'>
            <p className='text-red-800 text-sm font-medium'>
              {complianceStatus.blockedAppointments.length}{' '}
              agendamento(s) bloqueado(s) por conformidade LGPD
            </p>
  ...
  const ComplianceIndicator = () => (
    ...
    >
      {complianceStatus.isCompliant ? <span>✓ Conformidade LGPD</span> : (
        <span>
    ...
    <div className={className}>
      ...
      <div className='mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md'>
        <p className='text-blue-800 text-sm'>
          <strong>LGPD:</strong>{' '}
          Este calendário opera em conformidade com a Lei Geral de Proteção de Dados. Dados dos
          pacientes são minimizados e processados apenas com consentimento válido.
        </p>
        {complianceStatus.hasIssues && (
