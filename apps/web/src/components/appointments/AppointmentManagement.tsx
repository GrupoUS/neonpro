...
export function AppointmentManagement({
  ...
  const [selectedView, setSelectedView] = useState<'today' | 'week' | 'month'>(view);
...
function AppointmentCard({ appointment, onStatusUpdate, onSendReminder }: AppointmentCardProps) {
  const appointmentDate = new Date(appointment.startTime);
              ...
              <div className="mt-3 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                {appointment.noShowRisk.interventions && (
                  <div className="mt-2 flex gap-2">
                    {appointment.noShowRisk.interventions.slice(0, 2).map((intervention: string, index: number) => (
            ...
            <DropdownMenuContent align="end">
              ...
              {appointment.status === 'scheduled' && (
                <>
                  ...
                  <DropdownMenuItem onClick={() => onStatusUpdate(appointment.id, 'no-show')}>
              ...
              {/* Reminders */}
              <DropdownMenuItem onClick={() => onSendReminder(appointment.id, 'whatsapp')}>
                <MessageSquare className="h-4 w-4 mr-2" />
                Lembrete WhatsApp
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => onSendReminder(appointment.id, 'sms')}>
                <Phone className="h-4 w-4 mr-2" />
                Lembrete SMS
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => onSendReminder(appointment.id, 'email')}>
