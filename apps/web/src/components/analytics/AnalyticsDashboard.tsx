        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Análise temporal dos agendamentos e comparação com períodos
                anteriores
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Terças-feiras têm 23% mais cancelamentos. Considere
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      45% dos pacientes de limpeza de pele retornam em 30 dias.
                      Ideal para pacotes.
                    </p>
                    <Badge variant="secondary" className="mt-1">
                      Oportunidade
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Quintas 14h-16h têm baixa ocupação. Considere promoções
                      direcionadas.
                    </p>
                    <Badge variant="secondary" className="mt-1">
                      Otimização
