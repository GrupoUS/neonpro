      ...
      setInsights([
        {
          ...
          description:
            "Terças-feiras às 14h apresentam 31% mais cancelamentos que a média.",
          confidence: 0.87,
          impact: "high",
          recommendation:
        ...
        },
        {
          ...
          description:
            "52% dos pacientes de hidratação facial retornam em 21 dias.",
          confidence: 0.82,
          impact: "high",
          recommendation:
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <Card className="border-l-4 border-l-blue-600">
        <CardHeader>
          ...
          <CardDescription>
            Análises inteligentes e recomendações baseadas em padrões detectados
            nos dados
          </CardDescription>
        </CardHeader>
        <CardContent>
