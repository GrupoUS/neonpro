...
const NEONPRO_FEATURE_BENTO_KOKONUT =
  ((import.meta as any).env?.VITE_NEONPRO_FEATURE_BENTO_KOKONUT ?? "true") !==
  "false";
  ...
  return (
    <MotionWrapper {...(cardProps as any)}>
      ...
      >
        ...
        {/* Custom Content */}
        {children && (
          <CardContent className="relative z-10 flex-1">{children}</CardContent>
        )}
 ...
 */
export function AccessibleBentoGrid({
  className,
  children,
  ...props
}: BentoGridProps) {
