  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        "gradient-primary": "bg-gradient-to-r from-[#112031] to-[#294359] text-white shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300",
        "gradient-secondary": "bg-gradient-to-r from-[#294359] to-[#B4AC9C] text-white shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300",
        "gradient-gold": "bg-gradient-to-r from-[#AC9469] to-[#B4AC9C] text-white shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300",
        "gradient-neon": "bg-gradient-to-r from-[#AC9469] to-[#294359] text-white shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300",
        
        // Neumorph variants (Cult-UI style) - NeonPro Colors with smaller radius
        "neumorph": "bg-[#D2D0C8] text-[#112031] rounded-lg shadow-[4px_4px_8px_#b8b6b0,-4px_-4px_8px_#ecebe6] hover:shadow-[inset_4px_4px_8px_#b8b6b0,inset_-4px_-4px_8px_#ecebe6] dark:bg-[#112031] dark:text-[#D2D0C8] dark:shadow-[4px_4px_8px_#0a0f15,-4px_-4px_8px_#18314d] transition-all duration-200",
        "neumorph-primary": "bg-[#B4AC9C] text-[#112031] rounded-lg shadow-[4px_4px_8px_#969085,-4px_-4px_8px_#d2c8b3] hover:shadow-[inset_4px_4px_8px_#969085,inset_-4px_-4px_8px_#d2c8b3] transition-all duration-200",
        "neumorph-gold": "bg-[#AC9469] text-white rounded-lg shadow-[4px_4px_8px_#8d7854,-4px_-4px_8px_#cbb07e] hover:shadow-[inset_4px_4px_8px_#8d7854,inset_-4px_-4px_8px_#cbb07e] transition-all duration-200",
        
        // Standard variants - NeonPro Colors
        default: "bg-[#112031] text-white shadow-xs hover:bg-[#294359] transition-colors duration-200",
        destructive: "bg-destructive text-white shadow-xs hover:bg-destructive/90",
        outline: "border border-[#AC9469] bg-background text-[#112031] shadow-xs hover:bg-[#AC9469]/10 hover:text-[#112031] transition-colors duration-200",
        secondary: "bg-[#B4AC9C] text-[#112031] shadow-xs hover:bg-[#AC9469] hover:text-white transition-colors duration-200",
        ghost: "text-[#112031] hover:bg-[#D2D0C8] hover:text-[#112031] transition-colors duration-200",
        link: "text-[#AC9469] underline-offset-4 hover:underline hover:text-[#294359] transition-colors duration-200",
      },
      size: {
...
function UniversalButton({
  ...
  const neumorphShadows = {
    light: "shadow-[2px_2px_4px_#b8b6b0,-2px_-2px_4px_#ecebe6] hover:shadow-[inset_2px_2px_4px_#b8b6b0,inset_-2px_-2px_4px_#ecebe6] dark:shadow-[2px_2px_4px_#0a0f15,-2px_-2px_4px_#18314d]",
    medium: "shadow-[4px_4px_8px_#b8b6b0,-4px_-4px_8px_#ecebe6] hover:shadow-[inset_4px_4px_8px_#b8b6b0,inset_-4px_-4px_8px_#ecebe6] dark:shadow-[4px_4px_8px_#0a0f15,-4px_-4px_8px_#18314d]",
    strong: "shadow-[6px_6px_12px_#b8b6b0,-6px_-6px_12px_#ecebe6] hover:shadow-[inset_6px_6px_12px_#b8b6b0,inset_-6px_-6px_12px_#ecebe6] dark:shadow-[6px_6px_12px_#0a0f15,-6px_-6px_12px_#18314d]",
  };
  ...
  const combinedClassName = cn(
    ...
    (gradientFrom && gradientTo) && "transform hover:scale-[1.02] transition-all duration-300",
    className
  );
