...
export function ProfessionalServiceManager({
  ...
  const filteredAssignments = assignments?.filter(assignment => {
    const matchesSearch =
      assignment.professional_name.toLowerCase().includes(searchQuery.toLowerCase())
  ...
  const handleDeleteAssignment = async (assignment: ProfessionalServiceDetailed) => {
    if (
      window.confirm(
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          ...
          <div className='flex items-center gap-4 flex-wrap'>
            ...
            <Select value={primaryFilter} onValueChange={value => setPrimaryFilter(value as any)}>
            ...
            ? (
              <div className='text-center py-12'>
                ...
                <h3 className='text-lg font-medium mb-2'>
                  {searchQuery || proficiencyFilter !== 'all' || primaryFilter !== 'all'
                      ...
                      <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-4'>
                          <div className='flex flex-col'>
                            <div className='flex items-center gap-2'>
                              <h4 className='font-medium'>{assignment.professional_name}</h4>
                        ...
                        <div className='flex items-center gap-2'>
                          <Badge
                            variant='outline'
                            style={{
                              borderColor: getProficiencyColor(assignment.proficiency_level),
                              color: getProficiencyColor(assignment.proficiency_level),
                            }}
                          >
