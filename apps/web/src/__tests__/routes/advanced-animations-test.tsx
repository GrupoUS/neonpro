      ...
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Comprehensive testing environment for hover border gradient and
            enhanced shine border animations. Featuring 60fps performance
            monitoring, GPU acceleration, and accessibility compliance.
          </p>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      This card demonstrates the hover border gradient animation
                      inspired by AceternityUI. Move your mouse over the card to
                      see the effect.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      This card showcases the enhanced shine border animation
                      inspired by MagicUI. Watch the animated border patterns.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-2">
                ...
                <Card className="sm:col-span-2">
                  <CardHeader>
                    ...
                    <CardDescription>
                      This card combines both animation types with premium
                      settings for the ultimate visual experience.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
