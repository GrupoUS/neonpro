  ...
  return (
    <div className="min-h-full h-full bg-background">
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-[#294359] mb-4">
              Demo Kokonut UI Enhanced
            </h2>
            <p className="text-muted-foreground mb-6">
              Grade com animações avançadas do Kokonut UI, ícones integrados e
              variantes de design.
            </p>
          </div>
          <BentoGrid
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-[#294359] mb-4">
              Versão Legacy (Fallback)
            </h2>
            <p className="text-muted-foreground mb-6">
              Grade com animações reduzidas para dispositivos com
              prefer-reduced-motion ou feature flag desabilitada.
            </p>
          </div>
          <BentoGrid
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-2xl font-bold text-[#294359] mb-6">
            Detalhes Técnicos
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-card p-6 rounded-lg border">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  • <strong>Primary:</strong> Gradiente azul escuro (#112031 →
                  #294359)
                </li>
                <li>
                  • <strong>Secondary:</strong> Gradiente dourado (#AC9469 →
                  #B4AC9C)
                </li>
                <li>
