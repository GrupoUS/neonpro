...
function HealthcareTestComponent() {
  ...
  const { data: appointments, isLoading: appointmentsLoading } =
    usePatientAppointments(testPatientId);
  ...
  const handleUpdatePatient = async () => {
    ...
    try {
      await updatePatientMutation.mutateAsync({
        ...
        updates: {
          patient_notes: `Atualizado em ${new Date().toLocaleString(
            "pt-BR",
    ...
    <div className="container mx-auto p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p>
                  ...
                  {patient.phone_primary || "Não informado"}
                </p>
                <p>
              ...
              <div>
                <p>
                  ...
                  <Badge
                    variant={
                      patient.lgpd_consent_given ? "default" : "destructive"
                    }
                    className="ml-2"
                  >
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-sm text-gray-600 space-y-1">
            <p>
              • <strong>Atualizar Observações:</strong> Testa a mutação de
              atualização com logging LGPD
            </p>
            <p>
              • <strong>Criar Agendamento:</strong> Testa a criação de
              agendamento com validações healthcare
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-lg">
        <p className="text-xs text-gray-600 text-center">
          ...
          Teste de integração healthcare com Supabase • ID do Paciente:{" "}
          {testPatientId}
        </p>
      </div>
    </div>
