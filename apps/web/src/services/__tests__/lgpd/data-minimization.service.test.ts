...
describe('CalendarDataMinimizationService - RED Phase Tests', () => {
  ...
  describe('Data Minimization Processing', () => {
    ...
    it('should FAIL - should handle export context restrictions', async () => {
      ...
      expect(minimized.description).toContain('não disponíveis para exportação');
  ...
  describe('Data Sensitivity Assessment', () => {
    it('should FAIL - should identify high sensitivity for sensitive medical terms', () => {
      ...
      const sensitivity = calendarDataMinimizationService['assessDataSensitivity'](sensitiveAppointment);
    ...
    it('should FAIL - should identify medium sensitivity for routine care', () => {
      ...
      const sensitivity = calendarDataMinimizationService['assessDataSensitivity'](routineAppointment);
    ...
    it('should FAIL - should identify emergency status as higher sensitivity', () => {
      ...
      const sensitivity = calendarDataMinimizationService['assessDataSensitivity'](emergencyAppointment);
  ...
  describe('Compliance Scoring', () => {
    ...
    it('should FAIL - should heavily penalize inappropriate export permissions', () => {
      ...
      const sensitiveScore = calendarDataMinimizationService['calculateComplianceScore'](
        config,
        PatientDataSensitivity.HIGH,
        'export'
      );

      const normalScore = calendarDataMinimizationService['calculateComplianceScore'](
        config,
        PatientDataSensitivity.LOW,
        'view'
      );
  ...
  describe('Data Anonymization', () => {
    ...
    it('should FAIL - should apply partial anonymization method', () => {
      ...
      const anonymized = calendarDataMinimizationService['anonymizePatientName'](
        'João Silva Santos',
        'partial'
      );
  ...
  describe('LGPD Compliance Validation', () => {
    ...
    it('should FAIL - should determine shared data categories correctly', () => {
      ...
      const categories = calendarDataMinimizationService['getDataCategoriesShared'](
        config,
        mockAppointment
      );
    ...
    it('should FAIL - should apply proper retention periods', () => {
      ...
      const cancelledRetention = calendarDataMinimizationService['calculateRetentionPeriod']('cancelled');
      expect(cancelledRetention).toBe(90);

      const completedRetention = calendarDataMinimizationService['calculateRetentionPeriod']('completed');
      expect(completedRetention).toBe(2555);

      const emergencyRetention = calendarDataMinimizationService['calculateRetentionPeriod']('emergency');
  ...
  describe('Integration with Calendar Component', () => {
    ...
    it('should FAIL - should export service instance correctly', () => {
      ...
      expect(exported.calendarDataMinimizationService).toBe(calendarDataMinimizationService);
    });
  });
});