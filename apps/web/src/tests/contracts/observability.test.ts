...
describe('Observability Contracts', () => {
  ...
  describe('Sentry Configuration Contract', () => {
    ...
    test('should include healthcare context in error reports', () => {
      ...
      expect(Array.isArray(healthcareContext.compliance_requirements)).toBe(true);
    });
  });
  ...
  describe('OpenTelemetry Tracing Contract', () => {
    test('should provide healthcare-compliant tracing configuration', () => {
      ...
      expect(expectedTracingConfig.serviceName).toBe('neonpro-healthcare-platform');
    ...
    test('should create spans with healthcare attributes', () => {
      ...
      expect(typeof healthcareSpanAttributes['healthcare.patient.id']).toBe('string');
      expect(typeof healthcareSpanAttributes['healthcare.workflow.type']).toBe('string');
    });
    ...
    test('should provide medical workflow tracing utilities', () => {
      ...
      expect(typeof workflowTracingUtils.tracePatientOperation).toBe('function');
  ...
  describe('Web Vitals Monitoring Contract', () => {
    ...
    test('should provide healthcare performance context', () => {
      ...
      expect(Array.isArray(performanceContext.compliance_requirements)).toBe(true);
    });
    ...
    test('should provide performance monitoring callbacks', () => {
      ...
      expect(typeof performanceCallbacks.onLCPThresholdExceeded).toBe('function');
      expect(typeof performanceCallbacks.onFIDThresholdExceeded).toBe('function');
      expect(typeof performanceCallbacks.onCLSThresholdExceeded).toBe('function');
      expect(typeof performanceCallbacks.onPerformanceDegradation).toBe('function');
      expect(typeof performanceCallbacks.onPatientSafetyImpact).toBe('function');
    });
  });
