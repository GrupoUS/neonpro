...
export type ServiceTemplateType = 'package' | 'procedure' | 'consultation' | 'followup';
...
export const SERVICE_TEMPLATE_TYPES: Record<ServiceTemplateType, {
  label: string;
  description: string;
  color: string;
  icon: string;
...
export const SERVICE_TEMPLATE_PRICE_TYPES: Record<ServiceTemplatePriceType, {
  label: string;
  description: string;
}> = {
  fixed: {
...
// Validation helpers
export const isValidTemplateType = (type: string): type is ServiceTemplateType => {
  return Object.keys(SERVICE_TEMPLATE_TYPES).includes(type as ServiceTemplateType);
};

export const isValidPriceType = (type: string): type is ServiceTemplatePriceType => {
  return Object.keys(SERVICE_TEMPLATE_PRICE_TYPES).includes(type as ServiceTemplatePriceType);
};
