...
export const APPOINTMENT_TEMPLATE_CATEGORY_LABELS: Record<AppointmentTemplateCategory, string> = {
...
export const APPOINTMENT_TEMPLATE_CATEGORY_COLORS: Record<AppointmentTemplateCategory, string> = {
  consultation: '#3b82f6',
  facial: '#10b981',
  body: '#06b6d4',
  laser: '#ef4444',
