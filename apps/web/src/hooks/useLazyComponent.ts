...
export function useComponentPreloader() {
  ...
  const preloadComponent = async <T extends ComponentType<any>>(
    ...
    try {
      ...
      console.error(`[Performance] Failed to preload component: ${cacheKey}`, error);
    }
  };

  const preloadRouteComponents = async (routeComponents: Array<{
...
export const criticalComponents = [
  { importFn: () => import('@/components/auth/AuthForm'), cacheKey: 'auth-form' },
  { importFn: () => import('@/components/layout/EnhancedSidebar'), cacheKey: 'sidebar' },
  { importFn: () => import('@/components/patient/patient-card'), cacheKey: 'patient-card' },
];
