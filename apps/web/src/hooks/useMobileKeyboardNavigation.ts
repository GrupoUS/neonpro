...
export function useMobileKeyboardNavigation(config: Partial<FocusConfig> = {}) {
  ...
  const handleKeyboardShortcuts = useCallback((event: KeyboardEvent) => {
    ...
    switch (shortcut) {
      case HEALTHCARE_KEYBOARD_SHORTCUTS.EMERGENCY_CONTACT:
        ...
        const emergencyElement = document.querySelector('[data-emergency-contact]') as HTMLElement;
      ...
      case HEALTHCARE_KEYBOARD_SHORTCUTS.PATIENT_SEARCH:
        ...
        const searchElement = document.querySelector('[data-patient-search]') as HTMLElement;
        searchElement?.focus();
        break;
      ...
      case HEALTHCARE_KEYBOARD_SHORTCUTS.NEW_APPOINTMENT:
        ...
        const appointmentElement = document.querySelector('[data-new-appointment]') as HTMLElement;
      ...
      case HEALTHCARE_KEYBOARD_SHORTCUTS.MEDICATION_LIST:
        ...
        const medicationElement = document.querySelector('[data-medication-list]') as HTMLElement;
      ...
      case HEALTHCARE_KEYBOARD_SHORTCUTS.VITAL_SIGNS:
        ...
        const vitalSignsElement = document.querySelector('[data-vital-signs]') as HTMLElement;
  ...
  const createSkipLinks = useCallback(() => {
    ...
    const skipLinksData = finalConfig.skipLinks.map(skipLinkType => {
      switch (skipLinkType) {
