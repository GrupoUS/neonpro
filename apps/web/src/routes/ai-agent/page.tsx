  ...
  const features = [
    {
      ...
      description:
        "Encontre pacientes rapidamente com busca por nome e filtros avançados",
    },
    {
      icon: Calendar,
      title: "Gestão de Agenda",
      description:
        "Consulte agendamentos, horários disponíveis e gere novos compromissos",
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description:
        "Segurança e conformidade com a Lei Geral de Proteção de Dados",
    },
  ];
            ...
            <Card className="border-amber-200 bg-amber-50">
              ...
              <CardContent>
                <p className="text-sm text-amber-700">
                  Todas as interações são criptografadas e seguem as diretrizes
                  da LGPD. Dados sensíveis são tratados com o máximo cuidado.
                </p>
              </CardContent>
            </Card>
          </div>
