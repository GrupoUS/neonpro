          ...
          <CardContent className="p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm text-muted-foreground">
              ...
              <div>
                ...
                <ul className="space-y-1">
                  <li>• <span className="font-medium">Iniciante:</span> Conhecimento básico, requer supervisão</li>
                  <li>• <span className="font-medium">Intermediário:</span> Trabalha independentemente</li>
                  <li>• <span className="font-medium">Avançado:</span> Pode treinar outros profissionais</li>
                  <li>• <span className="font-medium">Especialista:</span> Referência na área</li>
                </ul>
              </div>
            </div>
          </CardContent>
