    ...
    <div className='space-y-6 max-w-4xl mx-auto'>
      ...
      <div>
        ...
        <p className='text-muted-foreground'>
          Configure e inicie uma nova consulta seguindo as diretrizes CFM 2.314/2022
        </p>
      </div>
                    ...
                    <div className='flex items-center space-x-3'>
                      ...
                      <div className='flex-1'>
                        ...
                        <div className='text-sm text-muted-foreground'>
                          {patient.age} anos • {patient.medicalRecord} • {patient.phone}
                        </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div>
                  ...
                  <Select value={sessionType} onValueChange={setSessionType}>
                    ...
                    <SelectContent>
                      <SelectItem value='first-consultation'>Primeira Consulta</SelectItem>
            ...
            <CardContent className='space-y-4'>
              ...
              <div className='flex items-center space-x-2'>
                <Checkbox
                  ...
                  onCheckedChange={checked => setDeviceChecked(checked as boolean)}
                />
