        ...
        <main className='p-6'>
            ...
            <div className='bg-white rounded-lg shadow p-6'>
              <div className='flex items-center justify-between'>
                ...
                <div className='text-right'>
                  <div
                    className={`text-4xl font-bold ${getScoreColor(dashboardData.complianceScore)}`}
                  >
                    {dashboardData.complianceScore}%
                  </div>
                  <div
                    className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                      getScoreBgColor(dashboardData.complianceScore)
                    } ${getScoreColor(dashboardData.complianceScore)}`}
                  >
                    {dashboardData.complianceScore >= 90
                      ? 'Excelente'
                      : dashboardData.complianceScore >= 70
                      ? 'Bom'
                      : 'Requer Melhoria'}
                  </div>
                </div>
          ...
          <div className='mt-8 bg-white rounded-lg shadow p-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
              ...
              <button
                onClick={() =>
                  api.complianceManagement.runAutomatedComplianceChecks.mutate({
