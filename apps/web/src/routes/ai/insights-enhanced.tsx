...
const generateMockModels = (): AIModel[] => [
  {
    ...
    features: ['patient_age', 'appointment_time', 'day_of_week', 'history', 'distance'],
  ...
  },
  {
    ...
    features: ['demographics', 'time_series', 'environmental_factors', 'utilization'],
...
const generateMockTrends = (): PredictionTrend[] => [
  { date: '2024-01-15', accuracy: 0.92, predictions: 450, impact: 85, modelVersion: 'v2.1.3' },
  { date: '2024-01-14', accuracy: 0.91, predictions: 432, impact: 82, modelVersion: 'v2.1.3' },
  { date: '2024-01-13', accuracy: 0.89, predictions: 418, impact: 79, modelVersion: 'v2.1.2' },
  { date: '2024-01-12', accuracy: 0.90, predictions: 445, impact: 84, modelVersion: 'v2.1.2' },
  { date: '2024-01-11', accuracy: 0.88, predictions: 401, impact: 76, modelVersion: 'v2.1.1' },
];
...
const generateMockTreatmentEffectiveness = (): TreatmentEffectiveness[] => [
  {
    ...
    trends: [
      ...
      { period: 'Q2 2023', successRate: 0.80 },
            ...
            <div className='grid gap-2 grid-cols-1 sm:grid-cols-3 flex-1'>
              <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value='Saúde Populacional'>Saúde Populacional</SelectItem>
              ...
              >
                <CardHeader className='pb-3'>
                  ...
                  <CardDescription className='text-xs'>
                    ...
                    {insight.patientCount && ` • ${insight.patientCount} pacientes`}
                  </CardDescription>
                </CardHeader>
            ...
            <div className='grid gap-6 grid-cols-1 lg:grid-cols-2'>
                      ...
                      return (
                        <div key={level} className='space-y-2'>
                          <div className='flex justify-between text-sm'>
                            ...
                            <span>{count} pacientes ({percentage.toFixed(1)}%)</span>
                          </div>
                  ...
                  <div className='grid gap-4 grid-cols-2'>
                    <div className='text-center'>
                      <div className='text-2xl font-bold text-green-600'>
                        {formatPercentage(populationMetrics.treatmentOutcomes.successRate)}
                      </div>
                      <div className='text-xs text-muted-foreground'>Taxa de Sucesso</div>
                    </div>
                    <div className='text-center'>
                      <div className='text-2xl font-bold text-blue-600'>
                        {populationMetrics.treatmentOutcomes.patientSatisfaction.toFixed(1)}
                      </div>
                  ...
                  <div className='space-y-2'>
                    <div className='flex justify-between text-sm'>
                      ...
                      <span className='text-orange-600'>
                        {formatPercentage(populationMetrics.treatmentOutcomes.complicationRate)}
                      </span>
                    </div>
                    <div className='flex justify-between text-sm'>
                      <span>Taxa de readmissão:</span>
                      <span className='text-red-600'>
                        {formatPercentage(populationMetrics.treatmentOutcomes.readmissionRate)}
                      </span>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent className='space-y-3'>
                  {populationMetrics.demographics.locations.slice(0, 5).map((location, index) => (
                      ...
                      <tbody>
                        {treatmentEffectiveness.map((treatment, index) => (
                          <tr key={index} className='border-b'>
                            <td className='p-2 font-medium'>{treatment.treatmentType}</td>
                            ...
                            <td className='p-2'>{treatment.averageDuration} dias</td>
                            <td className='p-2'>
        ...
        <CardContent className='p-4 sm:p-6'>
          <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <Badge variant='outline' className='text-xs'>
                {models.reduce((sum, m) => sum + m.predictionsCount, 0).toLocaleString()} previsões
              </Badge>
              <Badge variant='outline' className='text-xs'>
