      ...
      try {
        ...
        const mockInsights: AIInsight[] = [
          ...
          },
          {
            ...
            impact:
              "Melhoria na satisfação do paciente e eficiência operacional",
            recommendations: [
          ...
          },
          {
            ...
            description:
              "Aumento de 35% em casos de dengue na região, recomenda ações preventivas",
            confidence: 94,
            priority: "critical",
        ...
        const mockModels: AIModel[] = [
          ...
          },
          {
            ...
            description:
              "Classificação de riscos de saúde baseada em histórico",
          },
          {
            id: "3",
          ...
          <div className="flex items-start sm:items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-sm sm:text-base text-gray-600 mt-1">
                Análise inteligente para tomada de decisões clínicas e
                operacionais
              </p>
            </div>
          </div>
