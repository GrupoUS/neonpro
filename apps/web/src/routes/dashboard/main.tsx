...
interface RealTimeUpdate {
  type: 'new_patient' | 'appointment_update' | 'status_change' | 'risk_level_change';
  message: string;
  timestamp: Date;
  patientId?: string;
}
...
function DashboardMain() {
  ...
  const mockAIInsights: AIInsight[] = [
    {
      ...
      description: 'Pacientes com histórico de faltas apresentam 85% de probabilidade de não comparecimento',
      confidence: 0.85,
      priority: 'high',
      category: 'Gestão de Consultas',
      patientCount: 12,
      impact: 'Alto impacto na receita',
      recommendations: ['Enviar lembretes personalizados', 'Oferecer reagenda fácil', 'Contato telefônico proativo'],
      timestamp: new Date(),
    },
    {
      id: '2',
      ...
      recommendations: ['Revisar protocolo atual', 'Implementar nova técnica', 'Monitorar resultados'],
      timestamp: new Date(),
    },
    {
      id: '3',
      ...
      recommendations: ['Atualizar prontuários', 'Implementar checklist', 'Treinar equipe'],
      timestamp: new Date(),
    },
  ];
  ...
  const patients = mockRecentPatients.filter(patient =>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className='space-y-4'>
        ...
        <TabsContent value='overview' className='space-y-6'>
          ...
          <section aria-labelledby='metrics-heading'>
            <h2 id='metrics-heading' className='sr-only'>Métricas principais</h2>
                  ...
                  <CardContent className='pt-2'>
                    ...
                    <p className='text-xs sm:text-sm text-muted-foreground'>
                      <span
                        ...
                        aria-label={`${
                          metric.changeType === 'increase' ? 'Aumento' : 'Diminuição'
                        } de ${metric.change}`}
                      >
