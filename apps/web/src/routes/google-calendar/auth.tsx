    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">Por favor, aguarde enquanto finalizamos a integração...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl font-semibold mb-2 text-red-600">Erro na Conexão</h2>
