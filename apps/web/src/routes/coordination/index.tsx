                  ...
                  <div key={referral.id} className="px-6 py-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getUrgencyColor(referral.urgencyLevel)}`}>
                          {referral.urgencyLevel}
                        </span>
                        <p className="text-xs text-gray-500 mt-1">{getReferralTypeLabel(referral.referralType)}</p>
                      </div>
                    </div>
                  </div>
                ))}
                  ...
                  <div key={session.id} className="px-6 py-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-gray-500 mt-1">{getSessionTypeLabel(session.sessionType)}</p>
                      </div>
                    </div>
                  </div>
                ))}
                ...
                <div key={team.id} className="px-6 py-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-900">{team.name}</p>
                      <p className="text-sm text-gray-500">
                        {getTeamTypeLabel(team.teamType)} • {team.memberCount} membros • Criada em {new Date(team.createdAt).toLocaleDateString()}
                      </p>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="text-right">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                          ...
                          thread.priority === 'normal' ? 'bg-yellow-100 text-yellow-800' :
