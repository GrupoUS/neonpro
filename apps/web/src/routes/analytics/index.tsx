...
function AnalyticsDashboard() {
  ...
  const kpis = [
    { name: 'Receita Total', value: 'R$ 45.230', change: '+23%', icon: DollarSign, color: 'text-green-600' },
    ...
    { name: 'Taxa de Comparecimento', value: '92%', change: '+5%', icon: CheckCircle, color: 'text-emerald-600' },
  ...
  const alerts = [
    { id: 1, name: 'Alta Taxa de Não Comparecimento', type: 'threshold', severity: 'high', triggered: '2 horas atrás' },
    { id: 2, name: 'Receita Abaixo do Esperado', type: 'trend', severity: 'medium', triggered: '1 dia atrás' },
    { id: 3, name: 'Estoque Baixo - Botox', type: 'anomaly', severity: 'critical', triggered: '30 minutos atrás' },
  ];

  const reports = [
    { id: 1, name: 'Relatório Financeiro Mensal', type: 'financial', lastRun: 'Hoje, 09:00', nextRun: 'Amanhã, 09:00' },
    { id: 2, name: 'Análise de Desempenho', type: 'operational', lastRun: 'Ontem, 18:00', nextRun: 'Sexta, 18:00' },
    { id: 3, name: 'Relatório de Satisfação', type: 'patient', lastRun: 'Segunda, 10:00', nextRun: 'Próxima Segunda' },
  ];

  const models = [
    { id: 1, name: 'Previsão de Não Comparecimento', type: 'no_show_prediction', accuracy: 0.87, lastTrained: 'Hoje' },
    { id: 2, name: 'Previsão de Receita', type: 'revenue_forecast', accuracy: 0.92, lastTrained: 'Ontem' },
    { id: 3, name: 'Demanda de Estoque', type: 'inventory_demand', accuracy: 0.78, lastTrained: '2 dias atrás' },
  ];
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Analytics e Business Intelligence</h1>
                <p className="text-sm text-gray-600">Insights e métricas para sua clínica estética</p>
              </div>
            </div>
                ...
                <div className="p-6">
                  <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-gray-500">Gráfico de distribuição por tipo de procedimento</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {[
                ...
                <div key={dashboard.id} className="bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                  <div className="p-6">
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-sm text-gray-500">{kpi.category} • {kpi.frequency}</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="text-sm font-medium text-gray-900">
                            {kpi.currentValue} {kpi.name.includes('Receita') ? 'R$' : kpi.name.includes('Taxa') ? '' : '%'}
                          </p>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-medium text-gray-900">{model.lastTrained}</span>
                      </div>
                    </div>
                    <div className="mt-4 flex space-x-2">
            ...
            <div className="bg-white rounded-lg shadow">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    <h4 className="text-sm font-medium text-gray-900 mb-2">Risco de Não Comparecimento - Amanhã</h4>
            ...
            <div className="bg-white rounded-lg shadow">
              ...
              <div className="p-6">
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Nenhuma exportação recente</h3>
                  <p className="text-gray-500 mb-4">Crie sua primeira exportação de dados analytics</p>
