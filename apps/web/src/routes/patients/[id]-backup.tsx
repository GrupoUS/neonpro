        ...
        const mockAppointments: Appointment[] = [
          {
            ...
            aiPrediction: {
              ...
              confidence: 85,
              factors: [
                "Histórico de comparecimento bom",
                "Horário conveniente",
              ],
            },
          },
        ...
        const mockInsights: AIInsight[] = [
          {
            ...
            description:
              "Análise dos dados sugere risco moderado de descompensação glicêmica",
            confidence: 78,
            priority: "medium",
            recommendations: [
  ...
  return (
    <div className="container mx-auto px-4 py-4 sm:py-6 max-w-7xl">
      ...
      <section aria-labelledby="patient-info-heading" className="mb-6">
        <h2 id="patient-info-heading" className="sr-only">
                          ...
                          <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className="text-sm font-medium text-blue-800">
                                ...
                                {appointment.aiPrediction.noShowRisk}% risco de
                                não comparecimento
                              </span>
                            </div>
                            <div className="text-xs text-blue-700">
                              Confiança: {appointment.aiPrediction.confidence}%
                              • Fatores:{" "}
                      ...
                      <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                        <div>
                          ...
                          <p className="text-sm text-green-700">
                            Consentimento para processamento de informações
                            médicas
                          </p>
                        </div>
