          ...
          <Card key={section.title} className='shadow-sm'>
            <CardHeader className='pb-4'>
              <CardTitle className='text-lg sm:text-xl font-semibold text-gray-900'>
                {section.title}
                {sectionIndex < 2 && (
                  <span className='text-red-500 ml-1' aria-label='seção obrigatória'>*</span>
                )}
              </CardTitle>
            ...
            <fieldset className='space-y-4'>
              ...
              <div className='flex items-start space-x-3 p-3 rounded-lg border border-gray-200'>
                ...
                <div className='grid gap-2 leading-none'>
                  ...
                  <p id='lgpd_communication_desc' className='text-sm text-gray-600'>
              ...
              <div className='flex items-start space-x-3 p-3 rounded-lg border border-gray-200'>
                ...
                <div className='grid gap-2 leading-none'>
                  ...
                  <p id='lgpd_ai_processing_desc' className='text-sm text-gray-600'>
