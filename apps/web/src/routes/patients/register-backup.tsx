...
function PatientRegister() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.emergency_phone.trim()) {
      newErrors.emergency_phone =
        "Telefone do contato de emergência é obrigatório";
    }
    ...
    if (!formData.lgpd_data_processing) {
      newErrors.lgpd_data_processing =
        "Consentimento de processamento de dados é obrigatório";
    }
      ...
      >
        ...
        <Card className="shadow-sm border-blue-100">
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-sm sm:text-base text-gray-600">
              De acordo com a Lei Geral de Proteção de Dados, necessitamos do
              seu consentimento para processar os dados do paciente. Você pode
            ...
            <fieldset className="space-y-4">
              ...
              <div className="flex items-start space-x-3 p-3 rounded-lg border border-blue-200 bg-blue-50">
                ...
                <div className="grid gap-2 leading-none">
                  ...
                  >
                    Autorizo o processamento de meus dados para fins médicos e
                    administrativos
                  </p>
              ...
              <div className="flex items-start space-x-3 p-3 rounded-lg border border-gray-200">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInputChange("lgpd_storage", checked as boolean)
                  }
                  className="mt-1 h-5 w-5 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              ...
              <div className="flex items-start space-x-3 p-3 rounded-lg border border-gray-200">
                ...
                <div className="grid gap-2 leading-none">
                  ...
                  <p
                    ...
                    className="text-sm text-gray-600"
                  >
                    Autorizo o uso de inteligência artificial para análise e
                    previsões de saúde
                  </p>
                </div>
              </div>
