        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm sm:text-base text-muted-foreground mt-1 sm:mt-0">
              Cadastre novos pacientes com todas as informações necessárias para
              tratamento
            </p>
          </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-4 grid-cols-1 sm:grid-cols-5">
              {[
                ...
                const isCompleted =
                  registrationProgress.completedSteps.includes(step.id);
                const isCurrent = registrationProgress.currentStep === step.id;
                const isError =
                  registrationProgress.validationErrors.length > 0 && isCurrent;
              ...
              {registrationProgress.draftSaved &&
                registrationProgress.lastSaved && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-700">
                      Rascunho salvo às{" "}
                      {registrationProgress.lastSaved.toLocaleTimeString(
                        "pt-BR",
                      )}
                    </span>
                  </div>
              ...
              {registrationProgress.validationErrors.length > 0 && (
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-red-700">
                    {registrationProgress.validationErrors.length} erro(s) de
                    validação
                  </span>
                </div>
              )}
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-base">
              O paciente foi cadastrado no sistema e já está disponível para
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">
                    Todos os dados são processados conforme Lei Geral de
                    Proteção de Dados
                  </p>
                </div>
              </div>
