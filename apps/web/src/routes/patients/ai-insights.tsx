...
function PatientAIInsights() {
  ...
  const [selectedInsight, setSelectedInsight] =
    useState<PatientAIInsight | null>(null);
  ...
  const mockInsights: PatientAIInsight[] = [
      ...
      actionItems: [
        {
          ...
          description:
            "Realizar contato telefônico com os 8 pacientes com risco >90%",
          priority: "high",
          dueDate: "2024-01-20",
        },
        {
      ...
      actionItems: [
        {
          ...
          description:
            "Criar estrutura de benefícios para pacientes frequentes",
          priority: "medium",
          dueDate: "2024-01-30",
        },
      ],
    ...
    },
    {
      ...
      description:
        "Identificados 45 pacientes com documentação médica desatualizada ou incompleta",
      confidence: 0.95,
      priority: "critical",
  ...
  const mockTreatments: TreatmentEffectiveness[] = [
    ...
    },
    {
      ...
      cost: 450,
      recommendation:
        "Considerar ajuste na concentração para melhor resultados",
    },
    {
      treatmentId: "3",
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm sm:text-base text-muted-foreground mt-1 sm:mt-0">
              Análise preditiva e recomendações inteligentes para gestão de
              pacientes
            </p>
          </div>
