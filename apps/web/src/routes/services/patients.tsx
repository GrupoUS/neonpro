      ...
      <Card className="max-w-lg mx-auto text-center">
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            Não foi possível carregar a lista de pacientes. Verifique sua
      ...
      <div className="container mx-auto p-4 md:p-6">
        <Card className="max-w-lg mx-auto text-center">
          ...
          <CardContent>
            ...
            <Button
              onClick={() =>
                toast.error("Função de suporte ainda não implementada")
              }
              variant="outline"
            >
              Contatar Suporte
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm md:text-base">
              Administre os pacientes da sua clínica com segurança e
              conformidade LGPD
            </p>
          </div>
          ...
          <CardContent className="text-xs space-y-1">
            ...
            {connectionTest.session !== undefined && (
              <p>
                ...
                {connectionTest.session ? "Sim" : "Não"}
              </p>
            )}
      ...
      <Card className="bg-muted/30">
        <CardContent className="p-4">
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            ...
            <span>
              Sistema em conformidade com a LGPD • Todos os acessos são
              auditados • Pacientes têm direito ao acesso, correção e exclusão
              de dados
            </span>
          </div>
        </CardContent>
