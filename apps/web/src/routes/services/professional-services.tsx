        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Gerencie quais profissionais podem realizar cada serviço da
              clínica
            </p>
          </div>
        </div>
        ...
        <Card>
          <CardContent className="p-6">
            <h3 className="font-semibold mb-3">
              Como gerenciar atribuições profissional-serviço
            </h3>
            <div className="grid md:grid-cols-2 gap-4 text-sm text-muted-foreground">
              <div>
                ...
                <ul className="space-y-1">
                  ...
                  <li>
                    • Configure profissionais principais para cada serviço
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-1">
                  ...
                  <li>
                    • <span className="font-medium">Avançado:</span> Pode
