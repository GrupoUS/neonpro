              ...
              <div>
                ...
                <ul className='space-y-1'>
                  <li>
                    ...
                    Conjunto de serviços com desconto
                  </li>
                  <li>
                  ...
                  <li>
                    • <span className='font-medium'>Consultas:</span> Consultas médicas padrão
                  </li>
                  <li>
                    • <span className='font-medium'>Retornos:</span> Consultas de acompanhamento
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className='space-y-1'>
                  <li>
                    • <span className='font-medium'>Fixo:</span> Preço definido manualmente
                  </li>
                  <li>
                    • <span className='font-medium'>Calculado:</span> Soma dos preços dos serviços
                  </li>
                  <li>
