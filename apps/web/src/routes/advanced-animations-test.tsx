                  ...
                  <div className='flex items-center space-x-2'>
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        setConfig(prev => ({ ...prev, hoverBorderEnabled: checked }))}
                    />
                    ...
                    <div className='space-y-3 pl-4 border-l-2 border-blue-500/20'>
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value: any) =>
                            setConfig(prev => ({ ...prev, hoverBorderIntensity: value }))}
                        >
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value: any) =>
                            setConfig(prev => ({ ...prev, hoverBorderDirection: value }))}
                        >
                          <SelectTrigger className='h-8'>
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value: any) =>
                            setConfig(prev => ({ ...prev, hoverBorderTheme: value }))}
                        >
                          <SelectTrigger className='h-8'>
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value: any) =>
                            setConfig(prev => ({ ...prev, hoverBorderSpeed: value }))}
                        >
                          <SelectTrigger className='h-8'>
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={([value]) =>
                            setConfig(prev => ({ ...prev, hoverBorderWidth: value }))}
                          max={5}
                          min={1}
                          step={1}
                          className='mt-2'
                ...
                <div className='space-y-4'>
                  ...
                  <div className='flex items-center space-x-2'>
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        setConfig(prev => ({ ...prev, shineBorderEnabled: checked }))}
                    />
                    <Label>Enable Animation</Label>
                  </div>
                    ...
                    <div className='space-y-3 pl-4 border-l-2 border-purple-500/20'>
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value: any) =>
                            setConfig(prev => ({ ...prev, shineBorderPattern: value }))}
                        >
                          <SelectTrigger className='h-8'>
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={([value]) =>
                            setConfig(prev => ({ ...prev, shineBorderDuration: value }))}
                          max={5000}
                          min={500}
                          step={100}
                          className='mt-2'
                      ...
                      <div className='flex items-center space-x-2'>
                        <Switch
                          ...
                          onCheckedChange={checked =>
                            setConfig(prev => ({ ...prev, shineBorderAutoStart: checked }))}
                        />
                      ...
                      <div className='flex items-center space-x-2'>
                        <Switch
                          ...
                          onCheckedChange={checked =>
                            setConfig(prev => ({ ...prev, shineBorderHoverOnly: checked }))}
                        />
