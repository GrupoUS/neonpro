  ...
  const stopTest = useCallback(() => {
    ...
    const validationResults: ValidationResult[] = [
      ...
      },
      {
        ...
        status: metrics.avgFrameTime <= 16.67 ? 'pass' : metrics.avgFrameTime <= 33.33 ? 'warning' : 'fail',
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">
          Comprehensive testing for production readiness: Performance, Accessibility, Cross-browser compatibility
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <div>
              <Label htmlFor="animationCount">Animation Count: {animationCount[0]}</Label>
              <Slider
                id="animationCount"
                min={1}
                max={100}
            ...
            <div>
              <Label htmlFor="testDuration">Test Duration: {testDuration[0]}s</Label>
              <Slider
                id="testDuration"
                min={5}
                max={120}
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">{metrics.avgFrameTime}</div>
              <div className="text-sm text-muted-foreground">Frame Time (ms)</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">{metrics.animationCount}</div>
      ...
      <Alert>
        <AlertDescription>
          <strong>Cross-browser Testing:</strong> Test this page in Chrome, Firefox, Safari, and Edge. 
          Monitor the metrics above for consistent performance across browsers.
        </AlertDescription>
      </Alert>
    </div>
  )
