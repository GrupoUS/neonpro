...
function SettingsPage() {
  ...
  const [hiddenProviders, setHidden] = React.useState<ProviderKey[]>(() =>
    getHiddenProviders(),
  );
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      {shouldShowUpgradePrompt && (
        <Alert>
          ...
          <AlertDescription>
            Faça upgrade para o NeonPro Pro e acesse todos os recursos avançados
            incluindo modelos de IA premium.{" "}
            <a
              href={upgradeUrl}
              target="_blank"
              rel="noreferrer"
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
                ...
                {filteredModels.slice(0, 3).map((model) => (
                  ...
                  >
                    ...
                    <Button
                      size="sm"
                      variant={
                        defaultModel === model.model ? "default" : "outline"
                      }
              ...
              <p className="text-xs text-muted-foreground">
                Modelo usado por padrão no chat. Você pode alterar durante a
                conversa.
              </p>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground border-t pt-4">
              Seus dados são protegidos conforme a LGPD. O uso do chat AI segue
              as políticas de privacidade e consentimento.
            </div>
          </CardContent>
        </Card>
