              ...
              <CardContent>
                <div className='mb-6'>
                  <p className='text-slate-600 dark:text-slate-400 mb-4'>
                    Experience the full power of NeonPro's AI assistant. Try different scenarios and
                    see how it can help with various tasks in your aesthetic clinic.
                  </p>
              ...
              <Card>
                ...
                <CardContent className='space-y-3'>
                  <ul className='text-sm space-y-2'>
                    <li>
                      • Always obtain explicit consent before accessing patient data
                    </li>
                    <li>
        ...
        <div className='container mx-auto px-4 py-8'>
          <div className='text-center space-y-4'>
            ...
            <p className='text-slate-600 dark:text-slate-400 max-w-2xl mx-auto'>
              Experience the power of AI in aesthetic clinic management. Our AI assistant is
              designed to streamline operations, improve patient care, and boost your clinic's
              efficiency.
            </p>
