...
export const toBeValidPhone = (received: string) => {
  ...
  return {
    message: () => 
      `expected ${received} ${pass ? 'not ' : ''}to be a valid Brazilian phone number`,
    pass,
  };
};
...
export const toBeValidCPF = (received: string) => {
  ...
  return {
    message: () => 
      `expected ${received} ${pass ? 'not ' : ''}to be a valid CPF format`,
    pass,
  };
};
...
export const toHaveLoadingState = (received: any) => {
  ...
  return {
    message: () => 
      `expected component ${pass ? 'not ' : ''}to have loading state`,
    pass,
  };
};
...
export const toHaveErrorState = (received: any) => {
  ...
  return {
    message: () => 
      `expected component ${pass ? 'not ' : ''}to have error state`,
    pass,
  };
};
