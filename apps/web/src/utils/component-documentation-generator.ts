...
export type AccessibilityLevel =
  (typeof ACCESSIBILITY_LEVELS)[keyof typeof ACCESSIBILITY_LEVELS];
...
export class ComponentDocumentationGenerator {
  ...
  private initializeHealthcareComponents(): void {
    ...
    this.components.push({
      ...
      description:
        "Displays patient information with accessibility and mobile optimization",
      descriptionPtBr:
        "Exibe informações do paciente com acessibilidade e otimização móvel",
      ...
      props: [
        {
          ...
          descriptionPtBr:
            "Objeto de dados do paciente com informações médicas",
          examples: [
            {
              id: "pat_123",
              name: "João Silva",
          ...
          healthcareContext:
            "Contains sensitive patient data requiring LGPD compliance",
        ...
        },
        {
          ...
          descriptionPtBr:
            "Nível de conformidade WCAG para recursos de acessibilidade",
          examples: ["AA", "AAA"],
          accessibilityNotes:
            "Determines the level of accessibility enhancements applied",
        },
        {
          ...
          examples: [true, false],
          mobileNotes:
            "Enables touch-friendly interactions and responsive layout",
        },
        {
          name: "lgpdCompliant",
          type: "boolean",
          ...
          descriptionPtBr:
            "Habilitar recursos de conformidade LGPD para dados do paciente",
          examples: [true, false],
          healthcareContext:
            "Ensures patient data is handled according to LGPD regulations",
        },
        {
          ...
          descriptionPtBr:
            "Função de callback para ação de contato de emergência",
          healthcareContext:
            "Provides quick access to emergency contact information",
      ...
      examples: [
        {
          ...
          descriptionPtBr:
            "Cartão padrão do paciente com recursos de acessibilidade",
          code: `
...
/>
          ...
          healthcareContext:
            "Displaying patient information for medical consultation",
        ...
        },
        {
          ...
          descriptionPtBr:
            "Cartão de paciente otimizado para situações de emergência",
          code: `
<PatientCard
...
/>
          `,
          preview:
            "Emergency-optimized patient card with enhanced accessibility",
          healthcareContext:
    ...
    this.components.push({
      ...
      description:
        "Interactive appointment scheduling with accessibility and mobile support",
      descriptionPtBr:
        "Agendamento interativo de consultas com acessibilidade e suporte móvel",
      ...
      props: [
        {
          ...
          accessibilityNotes:
            "Time slots are announced with date and time information",
        ...
        },
        {
          ...
          healthcareContext:
            "Handles appointment creation with patient and doctor information",
        },
        {
          ...
          accessibilityNotes:
            "Allows patients to specify accessibility requirements",
          healthcareContext:
            "Ensures medical facilities can accommodate patient needs",
        },
      ],
      accessibility: {
        level: ACCESSIBILITY_LEVELS.AA,
...
/>
          ...
          healthcareContext:
            "Scheduling medical consultations with accessibility options",
          accessibilityDemo: true,
          mobileDemo: true,
          interactive: true,
        },
    ...
    this.components.push({
      ...
      description:
        "React hook for mobile accessibility features and validation",
      descriptionPtBr:
        "Hook React para recursos e validação de acessibilidade móvel",
      ...
      props: [
        {
          ...
          accessibilityNotes:
            "Configures mobile-specific accessibility enhancements",
  ...
  return (
    ...
    >
      Clique aqui
          ...
          healthcareContext:
            "Enhancing healthcare components with mobile accessibility",
          accessibilityDemo: true,
          mobileDemo: true,
          interactive: true,
        },
