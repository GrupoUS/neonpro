...
const ApiGoogleCalendarWebhookRoute = ApiGoogleCalendarWebhookRouteImport.update({
  id: '/api/google-calendar/webhook',
  path: '/api/google-calendar/webhook',
  getParentRoute: () => rootRouteImport,
} as any);
const ApiGoogleCalendarDisconnectRoute = ApiGoogleCalendarDisconnectRouteImport.update({
  id: '/api/google-calendar/disconnect',
  path: '/api/google-calendar/disconnect',
  getParentRoute: () => rootRouteImport,
} as any);
const ApiGoogleCalendarConnectRoute = ApiGoogleCalendarConnectRouteImport.update({
