...
describe("Healthcare Testing Framework Validation", () => {
  describe("Healthcare Data Factories", () => {
    ...
    it("should create valid appointment data with proper relationships", () => {
      ...
      const appointment = healthcareFactories.createAppointment(patient.id, professional.id);
    ...
    it("should create valid medical records with CFM compliance", () => {
      const patient = healthcareFactories.createPatient();
      const professional = healthcareFactories.createHealthcareProfessional();
      const medicalRecord = healthcareFactories.createMedicalRecord(patient.id, professional.id);
      ...
      // CFM compliance
      expect(medicalRecord.digital_signature.professional_id).toBe(professional.id);
  ...
  describe("LGPD Compliance Validators", () => {
    it("should validate LGPD consent correctly", () => {
      const validConsent = healthcareFactories.createLGPDConsent("patient_1", "clinic_1");
  ...
  describe("Healthcare Test Scenarios", () => {
    it("should create complete patient journey scenario", () => {
      ...
      expect(journey.medicalRecord.professional_id).toBe(journey.professional.id);
    });
  ...
  describe("Performance and Coverage Validation", () => {
    ...
    it("should have proper test utilities available", () => {
      ...
      expect(global.healthcareTestUtils.generateLGPDConsent).toBeTypeOf("function");
      expect(global.healthcareTestUtils.generateMedicalRecord).toBeTypeOf("function");
      expect(global.healthcareTestUtils.generateTenantContext).toBeTypeOf("function");
    });
  });
