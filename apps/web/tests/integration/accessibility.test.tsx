        ...
        <div role="main" aria-label="Painel do Paciente">
          ...
          <nav aria-label="Navegação principal">
            <ul>
              ...
              <li><a href="/medical-records">Prontuário</a></li>
              <li><a href="/prescriptions">Receitas</a></li>
            </ul>
          </nav>
        ...
        <nav role="navigation" aria-label="Navegação principal">
          <ul>
            ...
            <li>
              <a 
                href="/patients"
                aria-describedby="patients-desc"
              >
                Pacientes
              </a>
      ...
      const mockMedicalChart = (
        <div>
          ...
          <div id="chart-summary" className="sr-only">
            Gráfico mostrando a pressão arterial do paciente nos últimos 30 dias.
            Tendência geral: melhora gradual com medicação.
          </div>

          <div id="chart-data" className="sr-only">
            Dados detalhados: 1º de dezembro: 140/90 mmHg,
            15 de dezembro: 130/85 mmHg,
            30 de dezembro: 125/80 mmHg.
            Meta: abaixo de 120/80 mmHg.
          </div>
      ...
      const mockEmergencyPanel = (
        <div onKeyDown={(e) => {
          ...
          <div id="emergency-shortcuts" className="sr-only">
            Atalhos disponíveis: Ctrl + E para emergência,
            Tab para navegar, Enter para ativar
          </div>
        </div>
      );
  ...
  describe('Healthcare-Specific Accessibility', () => {
      ...
      const mockPrescription = (
        <div role="region" aria-labelledby="prescription-title">
          ...
          <dl aria-describedby="prescription-help">
            <dt>Medicamento:</dt>
            <dd>
              <strong aria-label="Medicamento prescrito">
                Losartana 50mg
              </strong>
            </dd>
            ...
            <dt>Duração:</dt>
            <dd aria-label="Duração do tratamento">
          ...
          <div id="prescription-help" className="sr-only">
            Receita válida por 30 dias. Mantenha em local seguro.
            Em caso de dúvidas, consulte o médico prescritor.
          </div>
        </div>
      );
    ...
    it('should provide accessible medical image descriptions', async () => {
      const mockMedicalImage = (
        <figure role="img" aria-labelledby="image-title" aria-describedby="image-desc">
          <img 
            src="/medical-scan.jpg"
            alt=""
            aria-hidden="true"
          />
          ...
          <figcaption>
            ...
            <div id="image-desc">
              <p>
                <strong>Achados:</strong> Campos pulmonares simétricos e bem aerados.
                Silhueta cardíaca dentro dos limites normais.
                Sem sinais de derrame pleural ou consolidação.
              </p>
              
              <p>
                <strong>Impressão diagnóstica:</strong> Radiografia de tórax sem alterações
                significativas. Pulmões e coração com aspectos radiológicos normais.
              </p>
              
              <div role="note" aria-label="Observação importante">
                <strong>Nota:</strong> Correlacionar com dados clínicos do paciente
        ...
        <div role="application" aria-label="Interface de Telemedicina">
          ...
          <main>
            <section aria-labelledby="video-section">
              <h2 id="video-section" className="sr-only">Área de Vídeo</h2>
    ...
    it('should meet Brazilian accessibility standards (Lei Brasileira de Inclusão)', async () => {
      const mockBrazilianInterface = (
        <div lang="pt-BR">
          ...
          <div id="accessibility-options" role="region" aria-label="Configurações de Acessibilidade">
          ...
          <main id="main-content" role="main">
            ...
            <section aria-labelledby="important-info">
              ...
              <div role="note" aria-label="Aviso importante sobre telemedicina">
                📋 A telemedicina é regulamentada pelo Conselho Federal de Medicina.
                Consultas virtuais são equivalentes a consultas presenciais
                para fins de diagnóstico e prescrição.
              </div>
            </section>
          </main>
        </div>
        ...
        <div>
          ...
          >
            <p id="at-support-info">
              Este sistema é compatível com leitores de tela NVDA, JAWS, 
              VoiceOver e Orca. Para melhor experiência, mantenha seu 
              software assistivo atualizado.
            </p>
            
            <button 
              aria-haspopup="dialog"
              aria-describedby="at-help"
            >
