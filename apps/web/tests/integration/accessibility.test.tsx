            ...
            onClick={() => {
              ...
              if (statusElement) {
                statusElement.textContent =
                  "Paciente João Silva: Em atendimento";
              }
            }}
      ...
      const mockMedicalChart = (
        <div>
          ...
          <div id="chart-summary" className="sr-only">
            Gráfico mostrando a pressão arterial do paciente nos últimos 30
            dias. Tendência geral: melhora gradual com medicação.
          </div>

          <div id="chart-data" className="sr-only">
            Dados detalhados: 1º de dezembro: 140/90 mmHg, 15 de dezembro:
            130/85 mmHg, 30 de dezembro: 125/80 mmHg. Meta: abaixo de 120/80
            mmHg.
          </div>
      ...
      const mockEmergencyPanel = (
        ...
        >
          ...
          <div id="emergency-shortcuts" className="sr-only">
            Atalhos disponíveis: Ctrl + E para emergência, Tab para navegar,
            Enter para ativar
          </div>
        </div>
      );
      ...
      const mockPrescription = (
        <div role="region" aria-labelledby="prescription-title">
          ...
          <div id="prescription-help" className="sr-only">
            Receita válida por 30 dias. Mantenha em local seguro. Em caso de
            dúvidas, consulte o médico prescritor.
          </div>
        </div>
      );
      ...
      const mockMedicalImage = (
        ...
        >
          ...
          <figcaption>
            ...
            <div id="image-desc">
              <p>
                <strong>Achados:</strong> Campos pulmonares simétricos e bem
                aerados. Silhueta cardíaca dentro dos limites normais. Sem
                sinais de derrame pleural ou consolidação.
              </p>

              <p>
                <strong>Impressão diagnóstica:</strong> Radiografia de tórax sem
                alterações significativas. Pulmões e coração com aspectos
                radiológicos normais.
              </p>

              <div role="note" aria-label="Observação importante">
                <strong>Nota:</strong> Correlacionar com dados clínicos do
                paciente para interpretação adequada.
              </div>
            </div>
          </figcaption>
        </figure>
          ...
          <main id="main-content" role="main">
            ...
            <section aria-labelledby="important-info">
              ...
              <div role="note" aria-label="Aviso importante sobre telemedicina">
                📋 A telemedicina é regulamentada pelo Conselho Federal de
                Medicina. Consultas virtuais são equivalentes a consultas
                presenciais para fins de diagnóstico e prescrição.
              </div>
            </section>
          </main>
        </div>
        ...
        <div>
          ...
          >
            <p id="at-support-info">
              ...
              VoiceOver e Orca. Para melhor experiência, mantenha seu software
              assistivo atualizado.
            </p>
            ...
            <div id="at-help" className="sr-only">
              Abre dialog com instruções específicas para cada tecnologia
              assistiva
            </div>
          </div>
        </div>
