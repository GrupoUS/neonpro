...
const MockNotificationCenter = () => <div data-testid="notification-center">Notification Center</div>;
  ...
  describe('Real-Time Chat with Medical Terminology', () => {
    ...
    it('should handle emergency escalation through chat interface', async () => {
      ...
      expect(() => {
        ...
        const chatInput = screen.getByTestId('chat-message-input');
        fireEvent.change(chatInput, { target: { value: 'Socorro! Estou sentindo uma dor muito forte!' } });
