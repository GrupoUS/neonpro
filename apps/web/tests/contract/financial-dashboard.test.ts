...
import { makeAbsoluteUrl, TEST_AUTH_HEADERS } from '../utils/test-config';
  ...
  describe('GET /api/financial/dashboard', () => {
    it('should return valid financial dashboard structure', async () => {
      ...
      const response = await fetch(
        makeAbsoluteUrl('/api/financial/dashboard?period=current_month'),
        {
    ...
    it('should handle authentication errors appropriately', async () => {
      ...
      const response = await fetch(makeAbsoluteUrl('/api/financial/dashboard')
    ...
    it('should handle server errors gracefully', async () => {
      ...
      const response = await fetch(makeAbsoluteUrl('/api/financial/dashboard/invalid')
