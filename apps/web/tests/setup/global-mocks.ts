...
const createMockQueryBuilder = () => {
  ...
  } /* eslint-disable unicorn/no-thenable */ // Add promise-like behavior for direct awaiting
...
const mockSupabaseClient: {
  ...
  from: vi.fn().mockImplementation((tableName: string,) => {
    const builder = createMockQueryBuilder() // Set the current table for the builder
