...
export class SubscriptionPerformanceMonitor {
  ...
  private getAlertMessage(
    ...
    return (
      messages[metric as keyof typeof messages] ||
      `${metric} performance issue detected`
    );
  }
  ...
  private generateRecommendations(
    ...
    const recommendations: Record<string, OptimizationRecommendation> = {
      ...
      cacheHitRate: {
        ...
        recommendation:
          'Increase cache TTL and implement cache warming strategies',
...
export const subscriptionPerformanceMonitor =
  new SubscriptionPerformanceMonitor();
