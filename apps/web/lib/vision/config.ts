...
export const VISION_CONFIG = {
  ...
  PERFORMANCE: {
    ...
    TARGET_PROCESSING_TIME_MS: 15_000, // 15 seconds target
    ...
    CACHE_ENABLED: true,
    CACHE_TTL_MS: 3_600_000, // 1 hour cache TTL
  },
  ...
  MONITORING: {
    ...
    ALERT_THRESHOLDS: {
      processing_time_ms: 25_000, // Alert if > 25s
  ...
  API: {
    ...
    TIMEOUT_MS: 45_000, // 45 seconds API timeout
...
export function validateVoidBeastCompliance(metrics: {
  ...
  return {
    compliant:
      violations.length === 0 &&
      score >= VISION_CONFIG.PERFORMANCE.QUALITY_THRESHOLD,
    violations,
