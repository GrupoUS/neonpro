...
export class EnhancedSubscriptionCache {
  ...
  private readonly config: EnhancedCacheConfig = {
    ...
    maxSize: 50_000, // 50k entries (increased)
  ...
  getStats(): CacheStats {
    ...
    return {
      ...
      newestEntry,
      averageAccessCount:
        validEntries > 0 ? totalAccessCount / validEntries : 0,
   ...
   */
  private getPopularCandidates(_config: any): string[] {
  ...
  private recordOperation(
    ...
    if (this.operations.length > 10_000) {
