...
export interface Vendor {
  ...
  // Vendor details
  vendor_type: 'supplier' | 'service_provider' | 'contractor' | 'consultant' | 'other'
...
export interface AccountsPayable {
  ...
  // Status and workflow
  status: 'draft' | 'pending' | 'approved' | 'scheduled' | 'paid' | 'partially_paid' | 'overdue' | 'disputed' | 'cancelled' | 'refunded'
...
export interface APDocument {
  ...
  // Document details
  document_type: 'invoice' | 'receipt' | 'contract' | 'purchase_order' | 'payment_voucher' | 'other'
