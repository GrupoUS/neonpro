...
export const PERFORMANCE_CONFIG = {
  ...
  response_time_thresholds: {
    forecast_generation: 30_000, // 30 seconds max for forecast generation
    model_training: 3_600_000, // 1 hour max for model training
    resource_optimization: 60_000, // 1 minute max for optimization
