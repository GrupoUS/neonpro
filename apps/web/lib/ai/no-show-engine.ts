...
export class NoShowEngine {
	 ...
	 */
	private async calculateRiskScore(patient: PatientProfile, appointment: AppointmentFeatures): Promise<number> {
		// Feature engineering
		const features = {
			// Patient features
	...
	private calculateConfidence(patient: PatientProfile, _appointment: AppointmentFeatures): number {
	...
	private analyzeRiskFactors(patient: PatientProfile, appointment: AppointmentFeatures): NoShowPrediction["factors"] {
		const factors = [];
