...
export const ptBRErrorMessages = {
  // Network Errors
  NETWORK_UNAVAILABLE: {
  ...
  NETWORK_TIMEOUT: {
    ...
    message:
      'A operação demorou mais que o esperado. Isso pode indicar lentidão na rede.',
  ...
  AUTH_INSUFFICIENT_PERMISSIONS: {
    ...
    message:
      'Você não tem permissão para executar esta ação. Entre em contato com seu supervisor.',
  ...
  VALIDATION_REQUIRED_FIELD: {
    ...
    message:
      'Alguns campos obrigatórios não foram preenchidos. Verifique o formulário.',
    shortMessage: 'Preencha todos os campos obrigatórios',
  },
  VALIDATION_INVALID_FORMAT: {
    title: 'Formato Inválido',
    message:
      'Alguns dados não estão no formato esperado. Verifique as informações.',
  ...
  APPOINTMENT_CONFLICT: {
    ...
    message:
      'Já existe um agendamento neste horário. Escolha um horário alternativo.',
  ...
  SYSTEM_OVERLOAD: {
    ...
    message:
      'O sistema está com alta demanda. Aguarde um momento e tente novamente.',
  ...
  DATA_PROCESSING_ERROR: {
    ...
    message:
      'Ocorreu um erro ao processar suas informações. Seus dados não foram alterados.',
    shortMessage: 'Erro ao processar dados',
  },
  IMPORT_ERROR: {
    title: 'Erro na Importação',
    message:
      'Não foi possível importar os dados. Verifique o formato do arquivo.',
  ...
  BACKUP_ERROR: {
    ...
    message:
      'Falha ao criar backup dos dados. Operação cancelada por segurança.',
  ...
  PRIVACY_CONSENT_REQUIRED: {
    ...
    message:
      'Esta operação requer seu consentimento para processamento de dados pessoais.',
    shortMessage: 'Consentimento LGPD necessário',
  },
  PRIVACY_DATA_RETENTION: {
    title: 'Período de Retenção',
    message:
      'Este dado atingiu o período máximo de retenção permitido pela LGPD.',
...
export const ptBRActionMessages = {
...
export const ptBRDateTimeFormats = {
  date: 'DD/MM/YYYY',
  time: 'HH:mm',
...
export const ptBRValidationMessages = {
...
export const ptBRTranslations = {
  errors: ptBRErrorMessages,
  actions: ptBRActionMessages,
  common: ptBRCommonTerms,
  datetime: ptBRDateTimeFormats,
  validation: ptBRValidationMessages,
};
