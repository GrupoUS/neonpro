		...
		<div className="space-y-6">
			...
			<div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
				<div>
					...
					<p className="text-muted-foreground">KPIs, métricas de compliance e relatórios detalhados</p>
				</div>
			...
			{emergencyMode && (
				<div className="rounded-r-md border-red-500 border-l-4 bg-red-100 p-4">
					<div className="flex items-center">
						...
						<div>
							<p className="font-medium text-red-800">Modo de Emergência - Dados em Tempo Real</p>
							<p className="text-red-700 text-sm">Métricas atualizadas automaticamente durante situações críticas</p>
						</div>
					</div>
				</div>
			)}
					...
					<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								<CardTitle className="font-medium text-sm">Satisfação do Paciente</CardTitle>
								<Heart className="h-4 w-4 text-muted-foreground" />
							</CardHeader>
							<CardContent>
								<div className="font-bold text-2xl text-blue-600">{mockTeamKPIs.patientSatisfaction.current}/10</div>
								...
								<Progress className="mt-3" value={(mockTeamKPIs.patientSatisfaction.current / 10) * 100} />
								<p className="mt-2 text-muted-foreground text-xs">Meta: {mockTeamKPIs.patientSatisfaction.target}/10</p>
							</CardContent>
						</Card>
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								<CardTitle className="font-medium text-sm">Tempo de Resposta</CardTitle>
								<Clock className="h-4 w-4 text-muted-foreground" />
							</CardHeader>
							<CardContent>
								<div className="font-bold text-2xl text-green-600">{mockTeamKPIs.averageResponseTime.current} min</div>
								<div className="flex items-center space-x-2 text-muted-foreground text-xs">
								...
								<Progress
									className="mt-3"
									value={
										100 - (mockTeamKPIs.averageResponseTime.current / mockTeamKPIs.averageResponseTime.target) * 100
									}
								/>
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								<CardTitle className="font-medium text-sm">Taxa de Sucesso</CardTitle>
								<Star className="h-4 w-4 text-muted-foreground" />
							</CardHeader>
							<CardContent>
								<div className="font-bold text-2xl text-green-600">{mockTeamKPIs.treatmentSuccessRate.current}%</div>
								<div className="flex items-center space-x-2 text-muted-foreground text-xs">
									{getTrendIcon(mockTeamKPIs.treatmentSuccessRate.trend)}
									<span>+{mockTeamKPIs.treatmentSuccessRate.change}% vs mês anterior</span>
								</div>
								<Progress className="mt-3" value={mockTeamKPIs.treatmentSuccessRate.current} />
								<p className="mt-2 text-muted-foreground text-xs">
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								<CardTitle className="font-medium text-sm">Eficiência da Equipe</CardTitle>
								<Zap className="h-4 w-4 text-muted-foreground" />
							</CardHeader>
							<CardContent>
								<div className="font-bold text-2xl text-blue-600">{mockTeamKPIs.teamEfficiency.current}%</div>
								<div className="flex items-center space-x-2 text-muted-foreground text-xs">
									{getTrendIcon(mockTeamKPIs.teamEfficiency.trend)}
									<span>+{mockTeamKPIs.teamEfficiency.change}% vs mês anterior</span>
								</div>
								<Progress className="mt-3" value={mockTeamKPIs.teamEfficiency.current} />
								<p className="mt-2 text-muted-foreground text-xs">Meta: ≥ {mockTeamKPIs.teamEfficiency.target}%</p>
							</CardContent>
						</Card>
					</div>
					...
					<div className="grid gap-6 lg:grid-cols-2">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>Principais indicadores do período selecionado</CardDescription>
							</CardHeader>
							<CardContent className="space-y-4">
								<div className="space-y-3">
									<div className="flex items-center justify-between">
										<span className="font-medium text-sm">Pacientes Atendidos</span>
										<span className="font-bold text-blue-600 text-lg">324</span>
									</div>
									<div className="flex items-center justify-between">
										<span className="font-medium text-sm">Procedimentos Realizados</span>
										<span className="font-bold text-green-600 text-lg">186</span>
									</div>
									<div className="flex items-center justify-between">
									...
									<div className="flex items-center justify-between">
										<span className="font-medium text-sm">Tempo Médio de Espera</span>
										<span className="font-bold text-lg text-orange-600">23 min</span>
									</div>
								</div>

								<div className="border-t pt-4">
									<h4 className="mb-3 font-medium text-sm">Alertas de Performance</h4>
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>Performance relativa entre setores</CardDescription>
							</CardHeader>
							<CardContent>
										...
										<div className="space-y-2" key={dept.name}>
											<div className="flex items-center justify-between text-sm">
												...
												<div className="flex items-center space-x-4">
													<span className="text-muted-foreground text-xs">Eficiência: {dept.efficiency}%</span>
													<span className="text-muted-foreground text-xs">Satisfação: {dept.satisfaction}</span>
												</div>
											</div>
											<div className="flex space-x-2">
												...
												<div className="flex-1">
													<Progress className="h-2" value={(dept.satisfaction / 10) * 100} />
												</div>
											</div>
										</div>
									))}
				...
				<TabsContent className="space-y-6" value="compliance">
					...
					<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
						...
						<Card className={getComplianceBgColor(mockComplianceData.cfm.complianceRate)}>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								<CardTitle className="font-medium text-sm">CFM (Licenças Médicas)</CardTitle>
								<Shield className="h-4 w-4 text-muted-foreground" />
							</CardHeader>
							<CardContent>
								<div className={`font-bold text-2xl ${getComplianceColor(mockComplianceData.cfm.complianceRate)}`}>
								...
								<Progress className="mt-3" value={mockComplianceData.cfm.complianceRate} />
								<div className="mt-2 flex items-center justify-between text-xs">
									<span className="text-yellow-600">{mockComplianceData.cfm.expiringWithin30Days} expirando</span>
									<span className="text-red-600">{mockComplianceData.cfm.expired} expiradas</span>
								</div>
							</CardContent>
						</Card>
						...
						<Card className={getComplianceBgColor(mockComplianceData.clt.complianceRate)}>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								<CardTitle className="font-medium text-sm">CLT (Leis Trabalhistas)</CardTitle>
								<Calendar className="h-4 w-4 text-muted-foreground" />
							</CardHeader>
							<CardContent>
								<div className={`font-bold text-2xl ${getComplianceColor(mockComplianceData.clt.complianceRate)}`}>
								...
								<Progress className="mt-3" value={mockComplianceData.clt.complianceRate} />
								<div className="mt-2 flex items-center justify-between text-xs">
									<span className="text-orange-600">{mockComplianceData.clt.overtimeViolations} horas extras</span>
									<span className="text-red-600">{mockComplianceData.clt.restPeriodViolations} descanso</span>
								</div>
							</CardContent>
						</Card>
						...
						<Card className={getComplianceBgColor(mockComplianceData.lgpd.complianceRate)}>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								<CardTitle className="font-medium text-sm">LGPD (Proteção Dados)</CardTitle>
								<Shield className="h-4 w-4 text-muted-foreground" />
							</CardHeader>
							<CardContent>
								<div className={`font-bold text-2xl ${getComplianceColor(mockComplianceData.lgpd.complianceRate)}`}>
								...
								<div className="mt-1 text-muted-foreground text-xs">
									...
									atividades conformes
								</div>
								<Progress className="mt-3" value={mockComplianceData.lgpd.complianceRate} />
								<div className="mt-2 flex items-center justify-between text-xs">
									<span className="text-yellow-600">
										{mockComplianceData.lgpd.pendingConsents} consentimentos pendentes
									</span>
									<span className="text-green-600">{mockComplianceData.lgpd.dataBreaches} violações</span>
								</div>
							</CardContent>
						</Card>
						...
						<Card className={getComplianceBgColor(mockComplianceData.anvisa.complianceRate)}>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								<CardTitle className="font-medium text-sm">ANVISA (Equipamentos)</CardTitle>
								<Heart className="h-4 w-4 text-muted-foreground" />
							</CardHeader>
							<CardContent>
								<div className={`font-bold text-2xl ${getComplianceColor(mockComplianceData.anvisa.complianceRate)}`}>
									{mockComplianceData.anvisa.complianceRate}%
								</div>
								<div className="mt-1 text-muted-foreground text-xs">
									{mockComplianceData.anvisa.compliantEquipment}/{mockComplianceData.anvisa.medicalEquipment}{" "}
									equipamentos conformes
								</div>
								<Progress className="mt-3" value={mockComplianceData.anvisa.complianceRate} />
								<div className="mt-2 flex items-center justify-between text-xs">
									<span className="text-orange-600">{mockComplianceData.anvisa.maintenanceDue} manutenção devida</span>
									<span className="text-green-600">{mockComplianceData.anvisa.expired} expirados</span>
								</div>
							</CardContent>
						</Card>
					</div>
					...
					<div className="grid gap-6 lg:grid-cols-2">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>Status das licenças do Conselho Federal de Medicina</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="space-y-4">
									<div className="space-y-3">
										<div className="flex items-center justify-between rounded border border-green-200 bg-green-50 p-3">
											<div>
												<p className="font-medium text-green-800 text-sm">Licenças Válidas</p>
												<p className="text-green-600 text-xs">Em conformidade total</p>
											</div>
										...
										<div className="flex items-center justify-between rounded border border-red-200 bg-red-50 p-3">
											<div>
												<p className="font-medium text-red-800 text-sm">Licenças Expiradas</p>
												<p className="text-red-600 text-xs">Ação imediata necessária</p>
											</div>
											<Badge className="border-red-300 bg-red-100 text-red-800">{mockComplianceData.cfm.expired}</Badge>
										</div>
									</div>
								...
								<div className="space-y-4">
									<div className="space-y-3">
										<div className="flex items-center justify-between rounded border border-blue-200 bg-blue-50 p-3">
											<div>
												<p className="font-medium text-blue-800 text-sm">Atividades de Tratamento</p>
												<p className="text-blue-600 text-xs">Mapeadas e documentadas</p>
											</div>
										...
										<div className="flex items-center justify-between rounded border border-green-200 bg-green-50 p-3">
											<div>
												<p className="font-medium text-green-800 text-sm">Violações de Dados</p>
												<p className="text-green-600 text-xs">Nenhuma no período</p>
											</div>
											<Badge className="border-green-300 bg-green-100 text-green-800">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>Itens que requerem atenção imediata para manter conformidade</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="space-y-3">
								<div className="flex items-start space-x-3 rounded border border-red-200 bg-red-50 p-3">
									...
									<div className="flex-1">
										<p className="font-medium text-red-800 text-sm">Dr. Carlos Mendes - CFM expira em 15 dias</p>
										<p className="mt-1 text-red-600 text-xs">Contatar profissional para renovação da licença CFM</p>
								...
								<div className="flex items-start space-x-3 rounded border border-yellow-200 bg-yellow-50 p-3">
									...
									<div className="flex-1">
										...
										<p className="mt-1 text-xs text-yellow-600">Revisar escalas de trabalho para conformidade CLT</p>
								...
								<div className="flex items-start space-x-3 rounded border border-blue-200 bg-blue-50 p-3">
									...
									<div className="flex-1">
										<p className="font-medium text-blue-800 text-sm">LGPD - 3 consentimentos de pacientes pendentes</p>
										<p className="mt-1 text-blue-600 text-xs">Atualizar consentimentos para uso de dados pessoais</p>
										<Button className="mt-2" size="sm" variant="outline">
				...
				<TabsContent className="space-y-6" value="individual">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>Métricas detalhadas por profissional de saúde</CardDescription>
						</CardHeader>
						<CardContent>
										...
										<TableRow key={professional.id}>
											...
											<TableCell>
												<div className="flex items-center space-x-2">
													...
													<Progress className="h-2 w-16" value={professional.complianceRate} />
												</div>
											</TableCell>
											<TableCell>
												<div>
													...
													{professional.overtimeHours > 0 && (
														<p className="text-xs text-yellow-600">+{professional.overtimeHours}h extra</p>
													)}
												</div>
											</TableCell>
											<TableCell>
												<div className="flex items-center space-x-2">
													<span
														className={`font-medium text-sm ${
															professional.cmeCredits >= professional.cmeRequired ? "text-green-600" : "text-red-600"
														}`}
													>
				...
				<TabsContent className="space-y-6" value="trends">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>Evolução dos principais indicadores nos últimos 6 meses</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="space-y-6">
								...
								<div className="flex h-64 items-center justify-center rounded-lg border-2 border-gray-300 border-dashed bg-gray-50">
									<div className="text-center">
										...
										<p className="font-medium text-gray-500">Gráfico de Tendências</p>
										<p className="text-gray-400 text-sm">Integração com biblioteca de gráficos necessária</p>
									</div>
								</div>
								...
								<div className="grid gap-4 md:grid-cols-3">
									<div className="rounded border border-green-200 bg-green-50 p-4">
										<div className="flex items-center justify-between">
											<div>
												<p className="font-medium text-green-800 text-sm">Satisfação do Paciente</p>
												<p className="text-green-600 text-xs">Tendência crescente</p>
											</div>
											<TrendingUp className="h-8 w-8 text-green-600" />
										</div>
										<div className="mt-2">
											<p className="font-bold text-green-700 text-lg">+3.6%</p>
											<p className="text-green-600 text-xs">vs período anterior</p>
										</div>
									</div>
									...
									<div className="rounded border border-blue-200 bg-blue-50 p-4">
										<div className="flex items-center justify-between">
											<div>
												<p className="font-medium text-blue-800 text-sm">Eficiência da Equipe</p>
												<p className="text-blue-600 text-xs">Melhoria constante</p>
											</div>
											<TrendingUp className="h-8 w-8 text-blue-600" />
										</div>
										<div className="mt-2">
											<p className="font-bold text-blue-700 text-lg">+5.1%</p>
											<p className="text-blue-600 text-xs">vs período anterior</p>
										</div>
									</div>
									...
									<div className="rounded border border-yellow-200 bg-yellow-50 p-4">
										<div className="flex items-center justify-between">
											<div>
												<p className="font-medium text-sm text-yellow-800">Compliance Geral</p>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>Análise inteligente baseada nas tendências identificadas</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="space-y-4">
								<div className="flex items-start space-x-3 rounded border border-green-200 bg-green-50 p-4">
									...
									<div>
										<p className="font-medium text-green-800 text-sm">Melhoria na Satisfação do Paciente</p>
										<p className="mt-1 text-green-600 text-xs">
											A implementação de protocolos de comunicação resultou em aumento de 3.6% na satisfação. Continue
											investindo em treinamento de comunicação.
										</p>
									</div>
								</div>
								...
								<div className="flex items-start space-x-3 rounded border border-blue-200 bg-blue-50 p-4">
									...
									<div>
										<p className="font-medium text-blue-800 text-sm">Eficiência Operacional em Alta</p>
										<p className="mt-1 text-blue-600 text-xs">
											A otimização de escalas e recursos elevou a eficiência em 5.1%. Considere expandir essas práticas
								...
								<div className="flex items-start space-x-3 rounded border border-orange-200 bg-orange-50 p-4">
									...
									<div>
										<p className="font-medium text-orange-800 text-sm">Atenção: CME em Atraso</p>
										<p className="mt-1 text-orange-600 text-xs">
											25% dos profissionais estão com CME pendente. Implemente lembretes automáticos e facilite o acesso
											a cursos online.
										</p>
									</div>
								</div>
								...
								<div className="flex items-start space-x-3 rounded border border-purple-200 bg-purple-50 p-4">
									...
									<div>
										<p className="font-medium text-purple-800 text-sm">Reconhecimento de Performance</p>
										<p className="mt-1 text-purple-600 text-xs">
											Enf. Ana Paula e Dra. Maria Silva destacam-se consistentemente. Considere reconhecimento formal e
