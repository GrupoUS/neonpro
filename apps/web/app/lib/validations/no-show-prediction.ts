...
export const GetPredictionsQuerySchema = z.object({
  ...
  sort_by: z
    .enum(['risk_score', 'prediction_date', 'accuracy'])
...
export const GetRiskFactorsQuerySchema = z.object({
  ...
  limit: z.number().int().min(1).max(100).default(20),
  sort_by: z
    .enum(['weight_score', 'last_updated', 'factor_value'])
...
export const GetInterventionsQuerySchema = z.object({
  ...
  limit: z.number().int().min(1).max(100).default(20),
  sort_by: z
    .enum(['trigger_time', 'effectiveness_score', 'cost_impact'])
...
export type BatchInterventionInput = z.infer<
  typeof BatchInterventionInputSchema
>;
...
export type InterventionOptimizationInput = z.infer<
  typeof InterventionOptimizationInputSchema
>;
export type RiskScoreCalibrationInput = z.infer<
  typeof RiskScoreCalibrationInputSchema
>;
export type ExternalSystemSync = z.infer<typeof ExternalSystemSyncSchema>;

export type PredictionResponse = z.infer<typeof PredictionResponseSchema>;
export type AnalyticsResponse = z.infer<typeof AnalyticsResponseSchema>;
export type ModelPerformanceResponse = z.infer<
  typeof ModelPerformanceResponseSchema
>;
