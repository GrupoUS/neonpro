...
const ClinicSizeCategorySchema = z.enum([
  'small',
  'medium',
  'large',
  'enterprise',
...
const CreateRetentionCampaignAnalyticsSchema =
  RetentionCampaignAnalyticsSchema.omit({
    id: true,
    created_at: true,
    updated_at: true,
  });
...
const UpdatePatientRetentionAnalyticsSchema =
  PatientRetentionAnalyticsSchema.partial().omit({
    id: true,
    created_at: true,
  });
...
const UpdatePatientChurnPredictionSchema =
  PatientChurnPredictionSchema.partial().omit({ id: true, created_at: true });
const UpdateRetentionInterventionSchema =
  RetentionInterventionSchema.partial().omit({ id: true, created_at: true });
const UpdateRetentionCampaignAnalyticsSchema =
  RetentionCampaignAnalyticsSchema.partial().omit({
    id: true,
    created_at: true,
  });
