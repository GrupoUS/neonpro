...
export const progressTrackingSchema = z.object({
  ...
  validation_status: z
    .enum(['pending', 'validated', 'rejected', 'manual_review'])
    .default('pending'),
...
export const progressMilestoneSchema = z.object({
  ...
  validation_status: z
    .enum(['detected', 'confirmed', 'false_positive', 'manually_added'])
    .default('detected'),
  validated_by: z.string().uuid().optional().nullable(),
  validation_notes: z.string().optional(),
...
export const progressTrackingFiltersSchema = z.object({
  ...
  tracking_type: z
    .enum(['healing', 'aesthetic', 'treatment_response', 'maintenance'])
    .optional(),
...
export const progressVisualizationConfigSchema = z.object({
  ...
  group_by: z
    .enum(['treatment_type', 'treatment_area', 'tracking_type'])
    .optional(),
