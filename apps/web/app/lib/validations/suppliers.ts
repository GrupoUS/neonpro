...
export const supplierEvaluationSchema = z
  ...
  .refine(
    (data) =>
      new Date(data.evaluation_period_end) >
      new Date(data.evaluation_period_start),
    {
      message: 'Data de fim deve ser posterior à data de início',
...
export type QualityIssueFiltersInput = z.infer<
  typeof qualityIssueFiltersSchema
>;
export type PerformanceAnalysisInput = z.infer<
  typeof performanceAnalysisSchema
>;
