...
export const communicationKeys = {
  ...
  message: (id: string) =>
    [...communicationKeys.messages(), 'detail', id] as const,
  ...
  thread: (id: string) =>
    [...communicationKeys.threads(), 'detail', id] as const,
  ...
  template: (id: string) =>
    [...communicationKeys.templates(), 'detail', id] as const,
  ...
  statsMessages: (period?: string) =>
    [...communicationKeys.stats(), 'messages', period] as const,
};
...
export function useUpdateThread() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      id: string;
      data: Parameters<typeof api.updateThread>[1];
...
export function useTemplates(filters?: TemplateFilters) {
  return useQuery({
    ...
    staleTime: 60_000, // 1 minute - templates change less frequently
    refetchOnWindowFocus: false,
  });
}
