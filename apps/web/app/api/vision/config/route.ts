...
const configSchema = z.object({
  ...
  maxProcessingTimeMs: z.number().min(1000).max(60_000).default(30_000),
...
export const GET = withErrorMonitoring(async (_request: NextRequest) => {
...
export const PUT = withErrorMonitoring(async (request: NextRequest) => {
  ...
  try {
    ...
    if (
      validatedConfig.defaultAccuracyThreshold >
