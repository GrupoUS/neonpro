...
export async function GET(request: NextRequest) {
  try {
    ...
    const includeTrends =
      request.nextUrl.searchParams.get('include_trends') === 'true';
    const includeComparisons =
      request.nextUrl.searchParams.get('include_comparisons') === 'true';
    const includeForecasts =
      request.nextUrl.searchParams.get('include_forecasts') === 'true';
