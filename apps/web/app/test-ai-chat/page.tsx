	...
	return (
		<div className="min-h-screen bg-gray-50 p-4">
			<div className="mx-auto max-w-7xl">
				{/* Header */}
				<div className="mb-8">
					<h1 className="mb-2 font-bold text-3xl text-gray-900">Universal AI Chat System</h1>
					<p className="text-gray-600">
						Sistema de chat com IA dual: Interface Externa para Pacientes e Interface Interna para Equipe
					</p>
				</div>
				...
				<div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
					<Card className="p-4">
						...
						<p className="text-gray-600 text-sm">Atendimento 24/7 para pacientes com agendamentos e orientações</p>
					</Card>
					...
					<Card className="p-4">
						...
						<p className="text-gray-600 text-sm">Assistente para equipe com dados operacionais e insights</p>
					</Card>
					...
					<Card className="p-4">
						...
						<p className="text-gray-600 text-sm">Respostas em tempo real com tecnologia Vercel AI SDK</p>
					</Card>
					...
					<Card className="p-4">
						...
						<p className="text-gray-600 text-sm">Otimizada para saúde brasileira com compliance LGPD/ANVISA</p>
					</Card>
				</div>
				...
				<Card className="mb-6 p-6">
					...
					<div className="flex items-center gap-4">
						<Badge className="text-sm" variant={activeInterface === "external" ? "default" : "secondary"}>
				...
				<div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
					...
					<div className="lg:col-span-2">
						<ChatProvider apiBaseUrl="/api/ai/universal-chat" initialInterface={activeInterface}>
							<ChatInterface
								className="h-[600px]"
							...
							<Tabs defaultValue={activeInterface}>
								...
								<TabsContent className="space-y-2" value="external">
									<div className="space-y-2 text-sm">
										...
										<div className="rounded bg-gray-100 p-2 text-gray-700">"Estou com dor de cabeça há 2 dias"</div>
										<div className="rounded bg-gray-100 p-2 text-gray-700">"Como cancelo minha consulta?"</div>
									</div>
								</TabsContent>
								...
								<TabsContent className="space-y-2" value="internal">
									<div className="space-y-2 text-sm">
										...
										<div className="rounded bg-gray-100 p-2 text-gray-700">"Gere um relatório de performance"</div>
										<div className="rounded bg-gray-100 p-2 text-gray-700">"Status dos equipamentos da clínica"</div>
									</div>
								</TabsContent>
							</Tabs>
						</Card>
				...
				<div className="mt-8 rounded-lg border bg-white p-4 text-center text-gray-600 text-sm">
					<p>
						🚀 Sistema Universal de Chat com IA • NeonPro Healthcare Platform • Compliance LGPD/ANVISA/CFM • Português
						Brasileiro
					</p>
				</div>
			</div>
