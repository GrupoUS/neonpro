...
// Component functions
function DashboardHeader({ viewMode, setViewMode }: { viewMode: string; setViewMode: (mode: "standard" | "bmad-master") => void }) {
  return (
    <motion.div
    ...
    >
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-300">Visão geral do sistema e métricas principais</p>
        </div>
        ...
        return (
          ...
          >
            <NeonGradientCard>
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-slate-300 text-sm">{stat.title}</p>
                  <p className="font-bold text-2xl text-white">{stat.value}</p>
                  <p className="text-emerald-400 text-sm">{stat.change} vs mês anterior</p>
                </div>
...
const DashboardPage = () => {
  const [viewMode, setViewMode] = useState<"standard" | "bmad-master">("standard");
