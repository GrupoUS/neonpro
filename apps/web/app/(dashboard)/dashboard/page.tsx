...
const CosmicGlowButton = ({
  ...
  const variants = {
    ...
    success: "bg-gradient-to-r from-emerald-600 to-green-600 hover: from-emerald-700 hover:to-green-700",
...
const DashboardPage = () => {
  ...
  const quickActions = [
    ...
    { label: 'Ver Agenda',
    icon: Calendar, variant: 'secondary' },
    { label: 'Relatórios',
                    ...
                    <div className="flex items-center gap-4" />
                      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-pink-500 to-purple-500" />
                        <span className="font-semibold text-white text-sm" />
                          {(patient as any).name.charAt(0)}
                        </span />
                      <div />
                        <p className="font-medium text-white">{(patient as any).name}</p />
