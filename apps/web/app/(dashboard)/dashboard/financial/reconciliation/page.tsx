		...
		return (
			<div className="flex h-screen items-center justify-center">
				<Alert data-testid="permission-denied-alert" variant="destructive">
					...
					<AlertDescription>
						Permissão insuficiente para acessar dados financeiros. Entre em contato com o administrador da clínica.
					</AlertDescription>
				</Alert>
			</div>
		);
		...
		<div className="container mx-auto space-y-6 p-6" data-testid="reconciliation-page">
			...
			<div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
				<div className="flex gap-2">
					<ImportStatementButton canImport={canManageReconciliation} data-testid="import-statement-button" />
				</div>
			</div>
