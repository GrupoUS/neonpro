...
export default async function PerfilPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-sky-50 px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        {/* Healthcare-focused header */}
        <div className="mb-8 text-center">
          <h1 className="mb-2 font-bold text-3xl text-slate-900">
            Perfil Profissional
          </h1>
          <p className="text-slate-600">
            Gerencie suas informações profissionais e configurações de conta
          </p>
          <div className="mt-4 inline-flex items-center rounded-full bg-emerald-100 px-3 py-1 font-medium text-emerald-800 text-xs">
        ...
        <div className="mx-auto mt-8 max-w-2xl">
          <div className="rounded-xl border border-blue-200 bg-blue-50 p-6">
            ...
            <div className="space-y-3 text-blue-800 text-sm">
              <p>
                <strong>Proteção de Dados:</strong> Todas as informações são
                criptografadas e armazenadas em conformidade com a LGPD e normas
                do CFM.
              </p>
              <p>
                <strong>Registro Profissional:</strong> Mantenha seus dados de
                registro profissional sempre atualizados para garantir o acesso
                completo ao sistema.
              </p>
              <p>
                <strong>Segurança:</strong> Recomendamos ativar a autenticação
                de dois fatores para máxima segurança dos dados dos pacientes.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-6">
            <h3 className="mb-3 font-semibold text-amber-900 text-lg">
              ⚖️ Seus Direitos sob a LGPD
            </h3>
            <div className="grid gap-4 text-amber-800 text-sm md:grid-cols-2">
              <div>
            ...
            <div className="mt-4 border-amber-200 border-t pt-4">
...
export const metadata = {
  ...
  description:
    'Gerencie seu perfil profissional e configurações de conta com segurança LGPD',
};
