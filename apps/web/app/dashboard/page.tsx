...
export default function DashboardPage({ searchParams }: DashboardPageProps) {
	return (
		<main className="min-h-screen bg-background p-4 md:p-6 lg:p-8" aria-labelledby="dashboard-heading">
			<div className="container mx-auto">
				<div className="space-y-6">
					...
					<div role="region" aria-label="Painéis de controle da clínica" className="w-full">
						<DashboardLayout
							defaultView="tabs"
