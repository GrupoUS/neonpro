				...
				<div className="relative z-20 mt-auto space-y-8">
					<blockquote className="space-y-4">
						<p className="font-medium text-foreground text-lg leading-relaxed">
							&ldquo;Transforme sua clínica estética com tecnologia brasileira de ponta. Junte-se a centenas de
							profissionais que já confiam na nossa plataforma para gestão completa, segura e em total
							conformidade.&rdquo;
						</p>
			...
			<div className="bg-background lg:p-8">
				<div className="mx-auto flex w-full flex-col justify-center space-y-8 sm:w-[450px]">
					...
					<div className="flex flex-col space-y-4 text-center">
						...
						<h1 className="font-bold text-3xl text-foreground tracking-tight">Comece sua Transformação Digital</h1>
						<p className="mx-auto max-w-md text-muted-foreground leading-relaxed">
							Crie sua conta gratuita e descubra como o NeonPro Healthcare pode revolucionar a gestão da sua clínica
							estética
						</p>
					</div>
					...
					<div className="space-y-4">
						...
						<div className="rounded-lg border border-primary/20 bg-primary/5 p-4 text-center">
							<p className="text-foreground/80 text-xs leading-relaxed">
								🛡️ Seus dados estão protegidos com criptografia de nível bancário • ✓ Conformidade total com LGPD • 📞
								Suporte especializado incluído • 🆓 30 dias grátis sem compromisso
							</p>
						</div>
					</div>
				</div>
