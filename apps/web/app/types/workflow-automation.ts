...
export interface WorkflowRule {
  ...
  // Rule categorization
  category: 'prediction' | 'intervention' | 'escalation' | 'notification' | 'scheduling';
...
export interface WorkflowCondition {
  ...
  operator: 'and' | 'or' | 'not' | 'equals' | 'not_equals' | 'greater_than' | 'less_than' | 'contains' | 'matches';
  
  // Data source
  dataSource: 'appointment' | 'patient' | 'prediction' | 'staff' | 'clinic' | 'external';
...
export interface WorkflowAction {
  id: string;
  type: 'notification' | 'intervention' | 'data_update' | 'external_api' | 'workflow' | 'schedule';
...
export interface WorkflowAuditEntry {
  id: string;
  timestamp: Date;
  action: 'workflow_started' | 'action_executed' | 'condition_evaluated' | 'workflow_completed' | 'error_occurred';
  details: string;
  userId?: string;
