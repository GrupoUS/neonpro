...
test.describe('Responsive Design and Accessibility', () => {
  ...
  test.describe('Accessibility Compliance', () => {
    test('should have proper ARIA labels and roles', async ({ page }) => {
      ...
      await expect(page.locator('button[type="submit"]')).toHaveText(/Entrar na Plataforma|Processando/);
    ...
    test('should provide screen reader friendly error messages', async ({ page }) => {
      ...
      const firstNameError = page.locator('#firstname').locator('..').locator('p[class*="text-destructive"]');
