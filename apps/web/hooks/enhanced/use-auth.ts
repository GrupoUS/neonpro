...
import { useHealthcareQueryUtils, QueryKeys } from '@/lib/query/query-utils';
...
export function useLogin() {
  ...
  return queryUtils.createMutation({
    ...
    validator: (data: unknown) => LoginResponseSchema.parse({ success: true, data, message: 'Login successful' }).data!,
...
export function useRegister() {
  ...
  return queryUtils.createMutation({
    ...
    validator: (data: unknown) => RegisterResponseSchema.parse({ success: true, data, message: 'Registration successful' }).data!,
...
export function useUpdateProfile() {
  ...
  return queryUtils.createMutation({
    ...
    validator: (data: unknown) => UpdateProfileResponseSchema.parse({ success: true, data, message: 'Profile updated' }).data!,
...
export function useRefreshToken() {
  ...
  return queryUtils.createMutation({
    ...
    validator: (data: unknown) => RefreshTokenResponseSchema.parse({ success: true, data, message: 'Token refreshed' }).data!,
...
export function useAuthUtils() {
  ...
  return {
    ...
    exportUserData: useCallback(async (userId: string) => {
