...
describe('Patients Mobile Integration API', () => {
  ...
  describe('GET /api/v2/patients/{id}/mobile-data', () => {
    it('should return 200 with mobile-optimized patient data', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-data`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json',
    ...
    it('should include mobile-specific UI preferences', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-data?include_ui_preferences=true`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json',
    ...
    it('should support offline data synchronization', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-data?offline_mode=true`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json',
  ...
  describe('POST /api/v2/patients/{id}/mobile-sync', () => {
    it('should return 200 for successful mobile sync', async () => {
      ...
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-sync`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json',
  ...
  describe('GET /api/v2/patients/{id}/mobile-notifications', () => {
    it('should return 200 with mobile notification settings', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-notifications`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json',
    ...
    it('should include notification history for mobile devices', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-notifications?include_history=true&limit=10`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json',
  ...
  describe('POST /api/v2/patients/{id}/mobile-actions', () => {
    it('should return 200 for successful mobile action processing', async () => {
      ...
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-actions`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json',
  ...
  describe('Mobile Security and Performance', () => {
    it('should enforce mobile device security checks', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-security-check`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json',
    ...
    it('should optimize API responses for mobile networks', async () => {
      ...
      expect(response.status).toBe(200)
      expect(Number(response.headers.get('content-length'))).toBeLessThan(50000) // Should be small
    ...
    it('should support progressive data loading for mobile', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-data?progressive_load=true`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json',
  ...
  describe('Mobile Device Management', () => {
    it('should register and manage mobile devices', async () => {
      ...
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-devices`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json'
    ...
    it('should handle device revocation for security', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/mobile-devices/test-device-123/revoke`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json'
