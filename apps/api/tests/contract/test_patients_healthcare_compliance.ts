...
describe('Patients Healthcare Compliance API', () => {
  ...
  describe('GET /api/v2/patients/{id}/compliance-status', () => {
    ...
    it('should return 404 for non-existent patient', async () => {
      const response = await app.request('/api/v2/patients/550e8400-e29b-41d4-a716-446655449999/compliance-status', {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json'
  ...
  describe('GET /api/v2/patients/{id}/consent-records', () => {
    ...
    it('should track consent withdrawals and modifications', async () => {
      ...
      const withdrawalRecord = data.consent_records.records.find((r: any) => r.type === 'ai_processing_withdrawal')
    ...
    it('should support consent export for compliance reporting', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/consent-records?export=pdf&format=lgpd`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json'
  ...
  describe('GET /api/v2/patients/{id}/compliance-reports', () => {
    ...
    it('should generate regulatory compliance reports', async () => {
      ...
      const response = await app.request(`/api/v2/patients/${patientId}/compliance-reports/generate`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json'
  ...
  describe('International Compliance', () => {
    it('should include GDPR compliance for EU patients', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/compliance-status?include_gdpr=true`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json'
    ...
    it('should handle HIPAA compliance for US healthcare interactions', async () => {
      const response = await app.request(`/api/v2/patients/${patientId}/compliance-status?include_hipaa=true`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${testClient.token}`,
          'Content-Type': 'application/json'
