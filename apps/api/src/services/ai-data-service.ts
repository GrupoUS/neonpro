    ...
    switch (intent) {
      case 'client_data':
        if (!permissions.includes('read_clients')) {
          throw new Error('Access denied: Insufficient permissions for client data access');
        }
        break;
      case 'appointments':
        if (!permissions.includes('read_appointments')) {
          throw new Error('Access denied: Insufficient permissions for appointment data access');
        }
        break;
      case 'financial':
