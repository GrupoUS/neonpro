...
import { HealthcareLogger } from '../logging/healthcare-logger'
  ...
  export class HealthcareError extends Error {
     ...
     constructor(code: string, category: string, severity: string, message: string, details?: Record<string, unknown>, _context?: Record<string, unknown>) {
       super(message);
     ...
     private isSensitiveField(key: string): boolean {
       const sensitiveFields = ['password', 'token', 'secret', 'key', 'cpf', 'cnpj', 'email', 'phone', 'address', 'ssn'];
  ...
  export class HealthcareAuthenticationError extends HealthcareError {
    constructor(message: string, details?: Record<string, unknown>, _context?: Record<string, unknown>) {
      super('HEALTHCARE_AUTH_ERROR', HealthcareErrorCategory.AUTHENTICATION, HealthcareErrorSeverity.HIGH, message, details, _context);
  ...
  export class HealthcareAuthorizationError extends HealthcareError {
    constructor(message: string, resourceType?: string, resourceId?: string, _context?: Record<string, unknown>) {
      super('HEALTHCARE_AUTHZ_ERROR', HealthcareErrorCategory.AUTHORIZATION, HealthcareErrorSeverity.HIGH, message, { resourceType, resourceId }, _context);
  ...
  export class LGPDComplianceError extends HealthcareError {
    ...
    constructor(message: string, lgpdArticle?: string, dataCategory?: string, _context?: Record<string, unknown>) {
      super('LGPD_COMPLIANCE_ERROR', HealthcareErrorCategory.COMPLIANCE, HealthcareErrorSeverity.CRITICAL, message, { lgpdArticle, dataCategory }, _context);
  ...
  export class BrazilianRegulatoryError extends HealthcareError {
    ...
    constructor(message: string, regulatoryBody: 'ANVISA' | 'CFM' | 'CFF' | 'CREF', regulation?: string, _context?: Record<string, unknown>) {
      super(`${regulatoryBody}_COMPLIANCE_ERROR`, HealthcareErrorCategory.COMPLIANCE, HealthcareErrorSeverity.HIGH, message, { regulatoryBody, regulation }, _context);
  ...
  export class PatientDataValidationError extends HealthcareError {
    ...
    constructor(
      ...
      super('PATIENT_DATA_VALIDATION_ERROR', HealthcareErrorCategory.VALIDATION, HealthcareErrorSeverity.MEDIUM, message, { validationErrors }, _context);
  ...
  export class AppointmentSchedulingError extends HealthcareError {
    ...
    constructor(
      ...
      super('APPOINTMENT_SCHEDULING_ERROR', HealthcareErrorCategory.VALIDATION, HealthcareErrorSeverity.MEDIUM, message, { conflictType }, _context);
  ...
  export class HealthcareDataIntegrityError extends HealthcareError {
    constructor(message: string, operation?: string, _context?: Record<string, unknown>) {
      super('HEALTHCARE_DATA_INTEGRITY_ERROR', HealthcareErrorCategory.DATA_INTEGRITY, HealthcareErrorSeverity.HIGH, message, { operation }, _context);
  ...
  export class ExternalHealthcareServiceError extends HealthcareError {
    ...
    constructor(
      ...
      super('EXTERNAL_HEALTHCARE_SERVICE_ERROR', HealthcareErrorCategory.EXTERNAL_SERVICE, HealthcareErrorSeverity.MEDIUM, message, { serviceName, serviceResponse }, _context);
