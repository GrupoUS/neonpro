...
class SecretManager {
  ...
  private generateEncryptionKey(): string {
    ...
    logger.warn('Generated new encryption key. Store this securely: SECRET_ENCRYPTION_KEY=' + key);
    return key;
  }
  ...
  private async loadFromVault(): Promise<void> {
    ...
    logger.warn('Vault provider not fully implemented, falling back to environment');
    this.loadFromEnvironment();
  }
  ...
  private loadFromFile(): void {
    ...
    // For now, fallback to environment
    logger.warn('File provider not fully implemented, falling back to environment');
    this.loadFromEnvironment();
  }
  ...
  public rotateSecret(name: string, newValue: string, rotatedBy?: string): void {
...
// Factory function
export function createSecretManager(config?: Partial<SecretConfig>): SecretManager {
