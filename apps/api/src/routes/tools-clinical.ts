...
app.post('/treatments/new', zValidator('json', NewTreatmentsRequest), c => {
  const data: TreatmentsResponse = {
    items: [
      { id: 't_001', patientId: 'p_001', provider: 'Dra. Maria', codes: ['TRT-FA-01'], consentRequired: false },
      { id: 't_002', patientId: 'p_002', provider: 'Dr. João', codes: ['TRT-CO-11', 'TRT-CO-15'], consentRequired: true }
    ]
  }
  return c.json(data)
})
