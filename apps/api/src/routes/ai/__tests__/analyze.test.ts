  ...
  beforeEach(async () => {
    ...
    mockAIChatService.analyzeData.mockResolvedValue({
      ...
      data: {
        ...
        results: {
          summary:
            "Análise dos dados estruturados do paciente revela padrões consistentes",
          insights: [
            {
              category: "treatment_effectiveness",
              finding:
                "Melhora significativa após tratamentos de limpeza de pele",
              confidence: 0.89,
              evidence: [
      ...
      data: {
        ...
        results: {
          imageAnalysis: {
            ...
            overallAssessment:
              "Pele com sinais de acne comedonal moderada e melasma leve",
  ...
  describe("Successful AI Analysis Operations", () => {
    ...
    it("should analyze patient feedback text", async () => {
      ...
      const analysisData = {
        analysisType: "patient_feedback",
        data: {
          text: "Estou muito satisfeita com o tratamento de limpeza de pele. Os resultados foram excelentes e superaram minhas expectativas. Houve um leve desconforto durante o procedimento, mas nada insuportável. Gostaria de saber sobre outros tratamentos disponíveis.",
          patientId: "patient-123",
