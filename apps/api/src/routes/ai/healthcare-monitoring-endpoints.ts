    ...
    const complianceReport = {
      ...
      compliance_scores: {
        lgpd: {
          ...
          status: metrics.compliance_status.lgpd_compliance_score >= 95
            ? 'compliant'
            : 'non_compliant',
        ...
        anvisa: {
          ...
          status: metrics.compliance_status.anvisa_compliance_score >= 95
            ? 'compliant'
            : 'non_compliant',
        ...
        cfm: {
          ...
          status: metrics.compliance_status.cfm_compliance_score >= 95
            ? 'compliant'
            : 'non_compliant',
      ...
      data_retention_status: {
        violations: metrics.compliance_status.data_retention_violations,
        policy_adherence: metrics.compliance_status.data_retention_violations === 0
          ? 'compliant'
          : 'issues_detected',
      },
      access_control_status: {
        violations: metrics.compliance_status.access_control_violations,
        policy_adherence: metrics.compliance_status.access_control_violations === 0
          ? 'compliant'
          : 'issues_detected',
      },
  ...
  try {
    ...
    const performanceAnalytics = {
      ...
      response_times: {
        ...
        api_target: 500,
        api_status: metrics.system_performance.api_response_time_ms <= 500
          ? 'meeting_target'
          : 'below_target',

        database_current: metrics.system_performance.database_query_time_ms,
        database_target: 100,
        database_status: metrics.system_performance.database_query_time_ms <= 100
          ? 'meeting_target'
          : 'below_target',

        emergency_access_current: metrics.patient_safety.emergency_access_response_time_ms,
        emergency_access_target: 5000,
        emergency_access_status: metrics.patient_safety.emergency_access_response_time_ms <= 5000
          ? 'meeting_target'
          : 'critical',
      },
      ...
      resource_utilization: {
        memory: {
          ...
          threshold: 80,
          status: metrics.system_performance.memory_usage_percentage <= 80
            ? 'normal'
            : 'high',
        },
        cpu: {
          ...
          threshold: 70,
          status: metrics.system_performance.cpu_usage_percentage <= 70
            ? 'normal'
            : 'high',
        },
        cache_efficiency: {
          ...
          target: 85,
          status: metrics.system_performance.cache_hit_rate_percentage >= 85
            ? 'good'
            : 'needs_improvement',
        },
      },
