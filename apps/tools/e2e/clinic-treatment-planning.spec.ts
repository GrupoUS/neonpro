...
test.describe('Aesthetic Treatment Planning Flows @clinic @treatment', () => {
  ...
  test.describe('Treatment Planning Interface @professional', () => {
    ...
    test('should create new treatment plan @desktop', async ({ page }) => {
      ...
      await page.fill('textarea[name="assessment"]', 'Patient shows fine lines and wrinkles in forehead area');
      await page.fill('textarea[name="goals"]', 'Reduce appearance of wrinkles, achieve natural look');
