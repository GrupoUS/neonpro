        ...
        return __generator(this, (_b) => {
          ...
          if (session) {
            console.log(
              ...
              (_a = session.user) === null || _a === void 0 ? void 0 : _a.email,
            );
            setSession(session);
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              exports.supabase.auth.signInWithPassword({
                email: email,
                password: password,
              }),
            ];
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              security_audit_logger_1.securityAuditLogger.logSessionEvent(
                "session_logout",
                user.id,
                { method: "manual" },
              ),
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              SessionManager_1.sessionManager.terminateSession(session.access_token, "user_logout"),
            ];
          case 3:
            _a.sent();
            _a.label = 4;
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              security_audit_logger_1.securityAuditLogger.logOAuthEvent(
                "oauth_attempt",
                "google",
                null,
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              exports.supabase.auth.signInWithOAuth({
                provider: "google",
                options: {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              oauth_error_handler_1.oauthErrorHandler.handleOAuthError(error, {
                provider: "google",
                method: "popup",
                step: "initiation",
              }),
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 2:
            ...
            authError = {
              message: error_4 instanceof Error ? error_4.message : "Unknown session refresh error",
              __isAuthError: true,
            };
            return [2 /*return*/, { error: authError }];
          case 3:
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 5:
            ...
            authError = {
              message:
                error_5 instanceof Error ? error_5.message : "Unknown session validation error",
              __isAuthError: true,
            };
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              permission_validator_1.permissionValidator.checkPermission(user.id, resource, action),
            ];
          case 2:
            result = _a.sent();
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              permission_validator_1.permissionValidator.getUserPermissions(user.id),
            ];
          case 2:
