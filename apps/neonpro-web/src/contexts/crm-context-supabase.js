...
var crmReducer = function (state, action) {
    ...
    switch (action.type) {
        case "SET_LOADING":
            return __assign(__assign({}, state), { loading: __assign(__assign({}, state.loading), (_a = {}, _a[action.payload.key] = action.payload.value, _a)) });
        case "SET_ERROR":
            return __assign(__assign({}, state), { errors: __assign(__assign({}, state.errors), (_b = {}, _b[action.payload.key] = action.payload.value, _b)) });
        case "SET_CUSTOMERS":
            return __assign(__assign({}, state), { customers: action.payload });
        case "ADD_CUSTOMER":
            return __assign(__assign({}, state), { customers: __spreadArray(__spreadArray([], state.customers, true), [action.payload], false) });
        case "UPDATE_CUSTOMER":
            return __assign(__assign({}, state), { customers: state.customers.map(function (customer) {
                    return customer.id === action.payload.id ? action.payload : customer;
                }) });
        case "DELETE_CUSTOMER":
            return __assign(__assign({}, state), { customers: state.customers.filter(function (customer) { return customer.id !== action.payload; }) });
        case "SET_SEGMENTS":
            return __assign(__assign({}, state), { segments: action.payload });
        case "ADD_SEGMENT":
            return __assign(__assign({}, state), { segments: __spreadArray(__spreadArray([], state.segments, true), [action.payload], false) });
        case "UPDATE_SEGMENT":
            return __assign(__assign({}, state), { segments: state.segments.map(function (segment) {
                    return segment.id === action.payload.id ? action.payload : segment;
                }) });
        case "DELETE_SEGMENT":
            return __assign(__assign({}, state), { segments: state.segments.filter(function (segment) { return segment.id !== action.payload; }) });
        case "SET_CAMPAIGNS":
            return __assign(__assign({}, state), { campaigns: action.payload });
        case "ADD_CAMPAIGN":
            return __assign(__assign({}, state), { campaigns: __spreadArray(__spreadArray([], state.campaigns, true), [action.payload], false) });
        case "UPDATE_CAMPAIGN":
            return __assign(__assign({}, state), { campaigns: state.campaigns.map(function (campaign) {
                    return campaign.id === action.payload.id ? action.payload : campaign;
                }) });
        case "DELETE_CAMPAIGN":
            return __assign(__assign({}, state), { campaigns: state.campaigns.filter(function (campaign) { return campaign.id !== action.payload; }) });
        case "SET_FILTER":
            return __assign(__assign({}, state), { filters: __assign(__assign({}, state.filters), (_c = {}, _c[action.payload.key] = action.payload.value, _c)) });
        default:
            return state;
    }
};
...
function CRMProvider(_a) {
    ...
    var _b = (0, react_1.useReducer)(crmReducer, initialState), state = _b[0], dispatch = _b[1];
    var supabase = (0, client_1.createClient)();
    // Customer functions
    var loadCustomers = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var createCustomer = function (customerData) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var updateCustomer = function (customer) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var deleteCustomer = function (customerId) { return __awaiter(_this, void 0, void 0, function () {
        var error, error_4;
    ...
    // Segment functions
    var loadSegments = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var createSegment = function (segmentData) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var updateSegment = function (segment) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var deleteSegment = function (segmentId) { return __awaiter(_this, void 0, void 0, function () {
        var error, error_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var createCampaign = function (campaignData) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var updateCampaign = function (campaign) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var filteredCustomers = state.customers.filter(function (customer) {
        ...
        if (state.filters.customer_search) {
            ...
            var matchesSearch = ((_b = (_a = customer.profile) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(search)) ||
                ((_d = (_c = customer.profile) === null || _c === void 0 ? void 0 : _c.email) === null || _d === void 0 ? void 0 : _d.toLowerCase().includes(search)) ||
                ((_f = (_e = customer.profile) === null || _e === void 0 ? void 0 : _e.phone) === null || _f === void 0 ? void 0 : _f.includes(search));
            if (!matchesSearch)
                return false;
        }
        // Status filter
        if (state.filters.customer_status &&
