...
describe("PatientInsightsIntegration", () => {
  ...
  describe("Error Handling for Disabled Features", () => {
    it("should throw error when risk assessment is disabled", () =>
      __awaiter(void 0, void 0, void 0, function () {
    ...
    it("should throw error when treatment recommendations are disabled", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var disabledInstance;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    it("should return empty array when continuous learning is disabled", () =>
      __awaiter(void 0, void 0, void 0, function () {
  ...
  describe("Input Validation", () => {
    it("should validate patient ID in comprehensive insights", () =>
      __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
    ...
    it("should validate requested insights array", () =>
      __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
  ...
  describe("Performance Requirements", () => {
    it(
      "should complete system health check within reasonable time",
      () =>
        __awaiter(void 0, void 0, void 0, function () {
          var start, duration;
          return __generator(this, (_a) => {
