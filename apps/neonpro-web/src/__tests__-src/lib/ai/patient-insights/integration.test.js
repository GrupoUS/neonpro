...
describe('PatientInsightsIntegration', function () {
    ...
    describe('Basic Functionality', function () {
        ...
        it('should return system health status', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, patientInsights.getSystemHealth()];
                    case 1:
                        result = _a.sent();
    ...
    describe('Error Handling for Disabled Features', function () {
        it('should throw error when risk assessment is disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(disabledInstance.generateQuickRiskAssessment('patient-123')).rejects.toThrow('Risk assessment is disabled')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('should throw error when treatment recommendations are disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            var disabledInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(disabledInstance.generateTreatmentGuidance('patient-123')).rejects.toThrow('Treatment recommendations are disabled')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('should return empty array when continuous learning is disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, disabledInstance.updatePatientOutcome('patient-123', 'treatment-456', { result: 'successful' })];
                    case 1:
                        result = _a.sent();
    ...
    describe('Input Validation', function () {
        it('should validate patient ID in comprehensive insights', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, expect(patientInsights.generateComprehensiveInsights({
                            patientId: '',
                            requestId: 'req-456',
        ...
        it('should validate requested insights array', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, expect(patientInsights.generateComprehensiveInsights({
    ...
    describe('Performance Requirements', function () {
        it('should complete system health check within reasonable time', function () { return __awaiter(void 0, void 0, void 0, function () {
            var start, duration;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
