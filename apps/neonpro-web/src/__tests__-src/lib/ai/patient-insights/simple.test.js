...
(0, globals_1.describe)("Patient Insights Integration - Simple Test", () => {
  (0, globals_1.test)("should validate PatientInsightsIntegration class exists", () => {
  ...
  (0, globals_1.test)("should create PatientInsightsIntegration instance", () => {
    var mockSupabase = {
