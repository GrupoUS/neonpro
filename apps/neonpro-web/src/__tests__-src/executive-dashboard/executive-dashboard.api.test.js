          ...
          switch (_a.label) {
            case 0:
              ...
              request = new server_1.NextRequest(
                "http://localhost:3000/api/executive-dashboard/kpis?clinic_id=clinic-1&period_type=monthly&period_start=2024-01-01&period_end=2024-01-31",
              );
      ...
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              request = new server_1.NextRequest(
                "http://localhost:3000/api/executive-dashboard/kpis",
              );
              return [4 /*yield*/, (0, route_1.GET)(request)];
            case 1:
              response = _a.sent();
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              request = new server_1.NextRequest(
                "http://localhost:3000/api/executive-dashboard/alerts?clinic_id=clinic-1",
              );
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              request = new server_1.NextRequest(
                "http://localhost:3000/api/executive-dashboard/widgets?clinic_id=clinic-1&user_id=user-1",
              );
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              request = new server_1.NextRequest(
                "http://localhost:3000/api/executive-dashboard/widgets",
                {
                  method: "POST",
            ...
            case 2:
              ...
              expect(response.status).toBe(200);
              expect(responseData.success).toBe(true);
              expect(mockExecutiveDashboardService.saveWidgetConfiguration).toHaveBeenCalledWith(
                widgetData,
              );
              return [2 /*return*/];
          }
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              request = new server_1.NextRequest(
                "http://localhost:3000/api/executive-dashboard/reports?clinic_id=clinic-1",
              );
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              request = new server_1.NextRequest(
                "http://localhost:3000/api/executive-dashboard/reports",
                {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              request = new server_1.NextRequest(
                "http://localhost:3000/api/executive-dashboard/comparison?clinic_id=clinic-1&period_type=monthly&current_start=2024-02-01&current_end=2024-02-29&previous_start=2024-01-01&previous_end=2024-01-31",
              );
      ...
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              request = new server_1.NextRequest(
                "http://localhost:3000/api/executive-dashboard/comparison?clinic_id=clinic-1",
              );
              return [4 /*yield*/, (0, route_5.GET)(request)];
            case 1:
              response = _a.sent();
