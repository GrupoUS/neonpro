...
import { GET as getRiskAssessment, POST as postRiskAssessment } from '../../../../../../app/api/patients/[patientId]/insights/risk-assessment/route'
import { GET as getAlerts, POST as postAlerts } from '../../../../../../app/api/patients/[patientId]/insights/alerts/route'
import { GET as getTreatments, POST as postTreatments } from '../../../../../../app/api/patients/[patientId]/insights/treatments/route'
import { GET as getComprehensive, POST as postComprehensive } from '../../../../../../app/api/patients/[patientId]/insights/comprehensive/route'
...
jest.mock('@/lib/ai/patient-insights', () => {
  return jest.fn().mockImplementation(() => ({
    generateQuickRiskAssessment: jest.fn(() => Promise.resolve({
      patientId: 'patient-123',
      overallRiskScore: 0.45,
      confidence: 0.85,
      recommendations: ['Monitor blood pressure', 'Follow up in 2 weeks']
    })),
    generateComprehensiveInsights: jest.fn(() => Promise.resolve({
      patientId: 'patient-123',
      requestId: 'req-456',
      riskAssessment: {
        patientId: 'patient-123',
    ...
    generateTreatmentGuidance: jest.fn(() => Promise.resolve({
      patientId: 'patient-123',
    ...
    monitorPatientAlerts: jest.fn(() => Promise.resolve({
      patientId: 'patient-123',
      totalAlerts: 3,
      criticalAlerts: 1,
      warningAlerts: 1,
    ...
    updatePatientOutcome: jest.fn(() => Promise.resolve([
      {
...
describe('Patient Insights API Endpoints', () => {
  ...
  describe('Risk Assessment API', () => {
    describe('GET /api/patients/[patientId]/insights/risk-assessment', () => {
      it('should return risk assessment for authenticated user', async () => {
        const request = new NextRequest('http://localhost:3000/api/patients/patient-123/insights/risk-assessment')
  ...
  describe('Comprehensive Insights API', () => {
    describe('POST /api/patients/[patientId]/insights/comprehensive', () => {
      it('should generate comprehensive insights successfully', async () => {
        ...
        const request = new NextRequest('http://localhost:3000/api/patients/patient-123/insights/comprehensive', {
          method: 'POST',
          body: JSON.stringify(requestBody)
        })
    ...
    describe('GET /api/patients/[patientId]/insights/comprehensive', () => {
      it('should return recent insights with pagination', async () => {
        const request = new NextRequest('http://localhost:3000/api/patients/patient-123/insights/comprehensive?limit=5&offset=0')
      ...
      it('should filter by date when since parameter is provided', async () => {
        ...
        const request = new NextRequest(`http://localhost:3000/api/patients/patient-123/insights/comprehensive?since=${since}`)
  ...
  describe('Alerts API', () => {
    describe('GET /api/patients/[patientId]/insights/alerts', () => {
      it('should return patient alerts successfully', async () => {
        const request = new NextRequest('http://localhost:3000/api/patients/patient-123/insights/alerts')
      ...
      it('should filter alerts by severity', async () => {
        const request = new NextRequest('http://localhost:3000/api/patients/patient-123/insights/alerts?severity=high')
      ...
      it('should filter alerts by category', async () => {
        const request = new NextRequest('http://localhost:3000/api/patients/patient-123/insights/alerts?category=risk')
      ...
      it('should filter active alerts only', async () => {
        const request = new NextRequest('http://localhost:3000/api/patients/patient-123/insights/alerts?active=true')
  ...
  describe('Treatment Guidance API', () => {
    describe('GET /api/patients/[patientId]/insights/treatments', () => {
      it('should return treatment guidance successfully', async () => {
        const request = new NextRequest('http://localhost:3000/api/patients/patient-123/insights/treatments')
      ...
      it('should include treatment context when provided', async () => {
        const request = new NextRequest('http://localhost:3000/api/patients/patient-123/insights/treatments?context=follow-up')
  ...
  describe('Error Handling', () => {
    it('should handle patient not found', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/patients/nonexistent/insights/risk-assessment')
