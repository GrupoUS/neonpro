...
var BundleOptimizer = /** @class */ (function () {
    function BundleOptimizer(config) {
        ...
        this.config = __assign({ enableCodeSplitting: true, enableTreeShaking: true, enableCompression: true, enablePreloading: true, chunkSizeLimit: 250000, preloadThreshold: 0.8, cacheStrategy: 'aggressive' }, config);
        this.metrics = {
            totalSize: 0,
            gzippedSize: 0,
            chunkCount: 0,
    ...
    BundleOptimizer.prototype.updateMetrics = function () {
        var jsResources = this.resourceTimings.filter(function (r) { return r.name.includes('.js'); });
        var cssResources = this.resourceTimings.filter(function (r) { return r.name.includes('.css'); });
        ...
        var avgLoadTime = this.resourceTimings.reduce(function (sum, resource) {
            return sum + (resource.responseEnd - resource.requestStart);
        }, 0) / this.resourceTimings.length || 0;
        // Calculate cache hit rate
        var cachedResources = this.resourceTimings.filter(function (r) { return r.transferSize === 0; });
        var cacheHitRate = this.resourceTimings.length > 0
            ...
            try {
                ...
                Object.values(coverage).forEach(function (file) {
                    if (file.s) { // Statement coverage
                        ...
                        usedLines_1 += Object.values(file.s).filter(function (count) { return count > 0; }).length;
                    }
                });
    ...
    BundleOptimizer.prototype.notifyObservers = function () {
        var _this = this;
        this.observers.forEach(function (observer) { return observer(_this.metrics); });
    };
    // =====================================================================================
    // PUBLIC API
    // =====================================================================================
    ...
    BundleOptimizer.prototype.implementCodeSplitting = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_a) {
                largeChunks = Array.from(this.chunks.values())
                    .filter(function (chunk) { return chunk.size > _this.config.chunkSizeLimit; });
    ...
    BundleOptimizer.prototype.generateReport = function () {
        ...
        return {
            ...
            chunks: chunks.map(function (chunk) { return ({
                name: chunk.name,
...
function useBundleOptimizer(config) {
    var _this = this;
    var optimizer = (0, react_1.useState)(function () { return new BundleOptimizer(config); })[0];
    var _a = (0, react_1.useState)(optimizer.getMetrics()), metrics = _a[0], setMetrics = _a[1];
    var _b = (0, react_1.useState)(false), isOptimizing = _b[0], setIsOptimizing = _b[1];
    var _c = (0, react_1.useState)(null), lastOptimization = _c[0], setLastOptimization = _c[1];
    (0, react_1.useEffect)(function () {
        var unsubscribe = optimizer.subscribe(setMetrics);
        return unsubscribe;
    }, [optimizer]);
    var optimize = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function createChunkPreloader(chunkMap) {
    ...
    return {
        preload: function (chunkName) { return __awaiter(_this, void 0, void 0, function () {
            var loader, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        preloadAll: function (chunkNames) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.allSettled(chunkNames.map(function (name) {
                            var loader = chunkMap[name];
                            return loader ? loader() : Promise.resolve();
                        }))];
                    case 1:
                        _a.sent();
                        chunkNames.forEach(function (name) { return preloadedChunks.add(name); });
                        return [2 /*return*/];
                }
            });
        }); },
        isPreloaded: function (chunkName) { return preloadedChunks.has(chunkName); }
    };
}
function measureBundleImpact(fn, label) {
    var _a, _b;
    var start = performance.now();
    var startMemory = ((_a = performance.memory) === null || _a === void 0 ? void 0 : _a.usedJSHeapSize) || 0;
    var result = fn();
    var end = performance.now();
    var endMemory = ((_b = performance.memory) === null || _b === void 0 ? void 0 : _b.usedJSHeapSize) || 0;
