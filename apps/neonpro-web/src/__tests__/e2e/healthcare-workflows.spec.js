...
test_1.test.describe('Healthcare Critical Workflows', function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('[data-testid=dashboard]')).toBeVisible()];
                case 5:
                    // Wait for dashboard to load
                    _c.sent();
                    return [2 /*return*/];
    ...
    (0, test_1.test)('Patient Registration and Management', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: 
                ...
                case 7:
                    _c.sent();
                    return [4 /*yield*/, page.fill('[data-testid=patient-birth-date]', TEST_PATIENT.birth_date)];
                case 8:
                    _c.sent();
                    // Submit form
                ...
                case 10:
                    // Verify patient was created
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator("text=".concat(TEST_PATIENT.name))).toBeVisible()];
                case 11:
                    _c.sent();
                    // Search for patient
                ...
                case 14:
                    ...
                    return [4 /*yield*/, page.click("[data-testid=patient-".concat(TEST_PATIENT.name.replace(/\s+/g, '-'), "]"))];
                case 15:
                    // View patient details
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('h1')).toContainText(TEST_PATIENT.name)];
                case 16:
                    _c.sent();
                    return [2 /*return*/];
            }
    ...
    (0, test_1.test)('Appointment Scheduling Workflow', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    // Navigate to appointments
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('h1')).toContainText('Agendamentos')];
                case 2:
                    _c.sent();
                ...
                case 4:
                    // Select patient (assuming TEST_PATIENT exists)
                    _c.sent();
                    return [4 /*yield*/, page.fill('[data-testid=patient-search-input]', TEST_PATIENT.name)];
                case 5:
                    _c.sent();
                    return [4 /*yield*/, page.click("[data-testid=patient-option-".concat(TEST_PATIENT.name, "]"))];
                case 6:
                    _c.sent();
                    // Select doctor
                ...
                case 7:
                    // Select doctor
                    _c.sent();
                    return [4 /*yield*/, page.click("[data-testid=doctor-option-".concat(TEST_DOCTOR.name, "]"))];
                case 8:
                    _c.sent();
                    tomorrow = new Date();
                ...
                case 10:
                    _c.sent();
                    return [4 /*yield*/, page.selectOption('[data-testid=appointment-type]', 'consultation')];
                case 11:
                    _c.sent();
                    // Submit appointment
                ...
                case 14:
                    // Check appointment appears in calendar
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator("text=".concat(TEST_DOCTOR.name))).toBeVisible()];
                case 15:
                    _c.sent();
                    return [2 /*return*/];
            }
    ...
    (0, test_1.test)('Dashboard Healthcare Metrics', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('[data-testid=total-patients]')).toBeVisible()];
                case 2:
                    // Check key healthcare metrics are displayed
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('[data-testid=today-appointments]')).toBeVisible()];
                case 3:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('[data-testid=pending-results]')).toBeVisible()];
                case 4:
                    _c.sent();
    ...
    (0, test_1.test)('Patient Portal Access', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: 
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('[data-testid=patient-appointments]')).toBeVisible()];
                case 5:
                    // Verify patient can see their appointments
                    _c.sent();
                ...
                case 6:
                    // Verify patient can see their medical history
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('[data-testid=medical-history-list]')).toBeVisible()];
                case 7:
                    _c.sent();
                ...
                case 8:
                    // Test appointment rescheduling
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('[data-testid=reschedule-modal]')).toBeVisible()];
                case 9:
                    _c.sent();
                    return [2 /*return*/];
            }
    ...
    (0, test_1.test)('Healthcare Compliance Features', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: 
                ...
                case 2:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('text=Consentimento')).toBeVisible()];
                case 3:
                    _c.sent();
                ...
                case 4:
                    // Test audit log access (admin only)
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('[data-testid=audit-logs-table]')).toBeVisible()];
                case 5:
                    _c.sent();
    ...
    (0, test_1.test)('System Performance and Health', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var response, health, apiStart, apiResponse, apiTime;
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, page.request.get('/api/health')];
                case 1:
                    response = _c.sent();
    ...
    (0, test_1.test)('Mobile Responsiveness - Patient Portal', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var appointmentForm;
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    // Verify mobile navigation works
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('[data-testid=mobile-menu]')).toBeVisible()];
                case 4:
                    _c.sent();
                ...
                case 5:
                    // Test appointment booking on mobile
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('[data-testid=appointment-form]')).toBeVisible()];
                case 6:
                    _c.sent();
