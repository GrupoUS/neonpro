...
var BaselineManager = /** @class */ (function () {
                    ...
                    case 1:
                        ...
                        latestBaselines_1.forEach(function (record, metricName) {
                            ...
                            var baseline = {
                                ...
                                measurement_period: ((_a = record.metadata) === null || _a === void 0 ? void 0 : _a.measurement_period) || 'daily',
                                baseline_date: record.timestamp,
                                confidence_level: ((_b = record.metadata) === null || _b === void 0 ? void 0 : _b.confidence_level) || 0.8,
                                sample_size: ((_c = record.metadata) === null || _c === void 0 ? void 0 : _c.sample_size) || 100,
    ...
    BaselineManager.prototype.establishBaseline = function (metricName_1, metricUnit_1) {
        return __awaiter(this, arguments, void 0, function (metricName, metricUnit, measurementPeriod) {
            ...
            if (measurementPeriod === void 0) { measurementPeriod = 'daily'; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 1:
                        ...
                        console.warn("No measurements available for ".concat(metricName, ", using default value"));
                        return [4 /*yield*/, this.createDefaultBaseline(metricName, metricUnit, measurementPeriod)];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3:
                        baseline = this.calculateBaselineStatistics(metricName, metricUnit, measurementPeriod, measurements);
                    ...
                    case 4:
                        ...
                        console.log("\u2705 Baseline established for ".concat(metricName, ": ").concat(baseline.metric_value, " ").concat(baseline.metric_unit));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        periodDays = measurementPeriod === 'daily' ? 7 :
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, data.map(function (record) { return record.metric_value; }).filter(function (val) { return val !== null; })];
                    case 2:
                        error_4 = _b.sent();
     ...
     */
    BaselineManager.prototype.calculateBaselineStatistics = function (metricName, metricUnit, measurementPeriod, measurements) {
        // Calculate statistical measures
        var sorted = __spreadArray([], measurements, true).sort(function (a, b) { return a - b; });
        var mean = measurements.reduce(function (sum, val) { return sum + val; }, 0) / measurements.length;
        ...
        var variance = measurements.reduce(function (sum, val) { return sum + Math.pow(val - mean, 2); }, 0) / measurements.length;
        var standardDeviation = Math.sqrt(variance);
        var coefficientOfVariation = standardDeviation / mean;
        // Higher confidence for larger samples and lower variance
        var confidenceLevel = Math.min(0.95, Math.max(0.5, (measurements.length / 100) * (1 - Math.min(1, coefficientOfVariation))));
        return {
            metric_name: metricName,
     ...
     */
    BaselineManager.prototype.createDefaultBaseline = function (metricName, metricUnit, measurementPeriod) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                metadata: __assign({ measurement_period: baseline.measurement_period, confidence_level: baseline.confidence_level, sample_size: baseline.sample_size }, baseline.metadata)
                            })];
                    case 1:
                        error = (_a.sent()).error;
                        if (error) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        changePercentage = ((currentValue - baseline.metric_value) / baseline.metric_value) * 100;
                        changeDirection = this.determineChangeDirection(metricName, changePercentage);
                        significanceLevel = this.determineSignificanceLevel(Math.abs(changePercentage), baseline.confidence_level);
                        comparison = {
                            metric_name: metricName,
                        ...
                        console.log("\uD83D\uDEA8 Significant ".concat(changeDirection, " detected in ").concat(metricName, ": ").concat(changePercentage.toFixed(1), "%"));
                    ...
                    case 1:
                        ...
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, comparison];
                }
            });
        });
    };
     ...
     */
    BaselineManager.prototype.determineSignificanceLevel = function (absoluteChangePercentage, confidenceLevel) {
    ...
    BaselineManager.prototype.generateBaselineReport = function () {
        return __awaiter(this, arguments, void 0, function (measurementPeriod) {
            var comparisons, recommendations, _i, _a, _b, metricName, baseline, currentValue, comparison, significantChanges, regressions, improvements, neutralChanges, report, error_7;
            if (measurementPeriod === void 0) { measurementPeriod = 'daily'; }
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 1];
                    case 5:
                        significantChanges = comparisons.filter(function (c) { return c.significance_level === 'high'; }).length;
                        regressions = comparisons.filter(function (c) { return c.change_direction === 'regression'; }).length;
                        improvements = comparisons.filter(function (c) { return c.change_direction === 'improvement'; }).length;
                        neutralChanges = comparisons.filter(function (c) { return c.change_direction === 'neutral'; }).length;
                        report = {
    ...
    BaselineManager.prototype.generateRecommendation = function (comparison) {
        ...
        var recommendations = {
            'page_load_time': "Page load time increased by ".concat(Math.abs(changePercentage).toFixed(1), "%. Consider optimizing images, reducing bundle size, or implementing caching."),
            'error_rate': "Error rate increased by ".concat(Math.abs(changePercentage).toFixed(1), "%. Review recent deployments and check error logs for patterns."),
            'api_response_time': "API response time increased by ".concat(Math.abs(changePercentage).toFixed(1), "%. Check database performance and API endpoint optimization."),
            'bounce_rate': "Bounce rate increased by ".concat(Math.abs(changePercentage).toFixed(1), "%. Review landing page performance and user experience."),
            'memory_usage': "Memory usage increased by ".concat(Math.abs(changePercentage).toFixed(1), "%. Check for memory leaks and optimize resource usage.")
        };
        return recommendations[metricName] ||
            "".concat(metricName, " shows regression of ").concat(Math.abs(changePercentage).toFixed(1), "%. Investigation recommended.");
    };
    /**
     * Store report in database
     */
    ...
    BaselineManager.prototype.startPeriodicMeasurement = function () {
        ...
        this.measurementInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            var error_10;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                try {
                    ...
                    metrics.memory_usage = ((_a = performance.memory) === null || _a === void 0 ? void 0 : _a.usedJSHeapSize) / (1024 * 1024) || 0;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.establishBaseline(metricName, existingBaseline.metric_unit, existingBaseline.measurement_period)];
...
var createbaselineManager = function () { return new BaselineManager(); };
exports.createbaselineManager = createbaselineManager;
// Utility functions
function establishBaseline(metricName, metricUnit, measurementPeriod) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, baselineManager.establishBaseline(metricName, metricUnit, measurementPeriod)];
        });
    });
}
