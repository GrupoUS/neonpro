...
var FeatureFlagManager = /** @class */ (function () {
    ...
    FeatureFlagManager.prototype.evaluateFlag = function (flag, userId, context) {
        ...
        if (flag.rollout_percentage < 100) {
            var isInRollout = this.evaluatePercentageRollout(flag.flag_name, flag.rollout_percentage, userId);
            return {
                flagName: flag.flag_name,
    ...
    FeatureFlagManager.prototype.evaluateTargetAudience = function (targetAudience, userId, context) {
        ...
        if (targetAudience.clinicIds && (context === null || context === void 0 ? void 0 : context.clinicId)) {
            return targetAudience.clinicIds.includes(context.clinicId);
        }
        // Check user role targeting
        if (targetAudience.userRoles && (context === null || context === void 0 ? void 0 : context.userRole)) {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                rollout_percentage: (_c = config.rolloutPercentage) !== null && _c !== void 0 ? _c : 0,
    ...
    FeatureFlagManager.prototype.gradualRollout = function (flagName_1, targetPercentage_1) {
        return __awaiter(this, arguments, void 0, function (flagName, targetPercentage, incrementStep, intervalMinutes) {
            var flag, currentPercentage, nextPercentage;
            var _this = this;
            if (incrementStep === void 0) { incrementStep = 10; }
            if (intervalMinutes === void 0) { intervalMinutes = 15; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getFeatureFlag(flagName)];
                    case 1:
                        flag = _a.sent();
                        if (!flag) {
                    ...
                    case 2:
                        ...
                        if (nextPercentage < targetPercentage) {
                            setTimeout(function () {
                                _this.gradualRollout(flagName, targetPercentage, incrementStep, intervalMinutes);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log("Emergency rollback completed for ".concat(flagName), reason ? "Reason: ".concat(reason) : '');
...
var createfeatureFlagManager = function () { return new FeatureFlagManager(); };
...
function useFeatureFlag(flagName, context) {
    ...
    var _a = (0, react_1.useState)({
        ...
        isEnabled: false,
        reason: 'not_found'
    }), evaluation = _a[0], setEvaluation = _a[1];
    var _b = (0, react_1.useState)(true), loading = _b[0], setLoading = _b[1];
    (0, react_1.useEffect)(function () {
        var checkFlag = function () { return __awaiter(_this, void 0, void 0, function () {
            var userId, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
