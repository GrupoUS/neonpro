...
var ConnectionPoolMonitor = /** @class */ (function () {
            ...
            if (currentMetrics.criticalAlerts > 0) {
              console.warn(
                "\uD83D\uDEA8 ".concat(
                  ...
                  " critical healthcare alerts active",
                ),
              );
            }
            return [3 /*break*/, 8];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              ...
              this.createAlert({
                severity: "emergency",
                type: "performance",
                message: "EMERGENCY: Response time ".concat(
                  health.avgResponseTime,
                  "ms exceeds emergency threshold",
                ),
                clinicId: clinicId,
                poolKey: poolKey,
          ...
          case 1:
            ...
            return [3 /*break*/, 6];
          case 2:
            if (!(health.avgResponseTime > this.thresholds.responseTime.critical))
              return [3 /*break*/, 4];
            return [
              4 /*yield*/,
              this.createAlert({
                severity: "critical",
                type: "performance",
                message: "CRITICAL: Response time ".concat(
                  health.avgResponseTime,
          ...
          case 3:
            ...
            return [3 /*break*/, 6];
          case 4:
            if (!(health.avgResponseTime > this.thresholds.responseTime.warning))
              return [3 /*break*/, 6];
            return [
              4 /*yield*/,
              this.createAlert({
                severity: "warning",
                type: "performance",
                message: "WARNING: Response time ".concat(
                  health.avgResponseTime,
                  "ms exceeds warning threshold",
                ),
                clinicId: clinicId,
                poolKey: poolKey,
                responseTime: health.avgResponseTime,
          ...
          case 6:
            ...
            return [
              ...
              this.createAlert({
                severity: "emergency",
                type: "performance",
                message: "EMERGENCY: Pool utilization ".concat(
                  health.poolUtilization.toFixed(1),
                  "% at emergency level",
                ),
                clinicId: clinicId,
                poolKey: poolKey,
          ...
          case 7:
            ...
            return [3 /*break*/, 10];
          case 8:
            if (!(health.poolUtilization > this.thresholds.poolUtilization.critical))
              return [3 /*break*/, 10];
            return [
              4 /*yield*/,
              this.createAlert({
                severity: "critical",
                type: "performance",
                message: "CRITICAL: Pool utilization ".concat(
                  health.poolUtilization.toFixed(1),
                  "% at critical level",
                ),
                clinicId: clinicId,
          ...
          case 10:
            ...
            return [
              ...
              this.createAlert({
                severity: "emergency",
                type: "availability",
                message: "EMERGENCY: Connection failure rate ".concat(
          ...
          case 12:
            ...
            return [
              ...
              this.createAlert({
                severity: "emergency",
                type: "compliance",
                message: "EMERGENCY: Healthcare compliance violations detected: ".concat(
          ...
          case 0:
            ...
            return [
              ...
              this.createAlert({
                severity: "emergency",
                type: "compliance",
                message: "EMERGENCY: System-wide compliance score ".concat(
          ...
          case 2:
            ...
            return [
              ...
              this.createAlert({
                severity: "emergency",
                type: "availability",
                message: "EMERGENCY: Only ".concat(
                  healthyRatio.toFixed(1),
                  "% of pools are healthy",
                ),
                clinicId: "system",
                poolKey: "system-wide",
                metadata: {
          ...
          case 4:
            ...
            return [
              ...
              this.createAlert({
                severity: "critical",
                type: "availability",
                message: "CRITICAL: ".concat(
                  metrics.unhealthyPools,
                  " pools are unhealthy - potential cascade failure",
                ),
                clinicId: "system",
                poolKey: "system-wide",
            ...
            logLevel =
              alert.severity === "emergency"
                ...
                : alert.severity === "critical"
                  ...
                  : "warn";
            console[logLevel](
              "\uD83D\uDEA8 HEALTHCARE ALERT [".concat(alert.severity.toUpperCase(), "]:"),
              {
                id: alert.id,
                type: alert.type,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        console.error("Security emergency response activated for:", {
          ...
          poolKey: alert.poolKey,
          isolationStatus:
            (_a = alert.metadata) === null || _a === void 0 ? void 0 : _a.isolationStatus,
        });
        return [2 /*return*/];
      });
    });
  ...
  ConnectionPoolMonitor.prototype.getHealthSummary = function () {
    ...
    return {
      ...
      lastUpdate:
        (latestMetrics === null || latestMetrics === void 0 ? void 0 : latestMetrics.timestamp) ||
        new Date(),
      complianceScore:
        latestMetrics === null || latestMetrics === void 0 ? void 0 : latestMetrics.complianceScore,
      avgResponseTime:
        latestMetrics === null || latestMetrics === void 0 ? void 0 : latestMetrics.avgResponseTime,
    };
  };
  /**
   * Shutdown monitoring
