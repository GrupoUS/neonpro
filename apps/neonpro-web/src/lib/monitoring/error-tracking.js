        ...
        switch (_a.label) {
          case 0:
            errorEvent = {
              ...
              route_path:
                (context === null || context === void 0 ? void 0 : context.route_path) ||
                window.location.pathname,
              user_id: context === null || context === void 0 ? void 0 : context.user_id,
              session_id:
                (context === null || context === void 0 ? void 0 : context.session_id) ||
                this.getSessionId(),
              severity:
                (context === null || context === void 0 ? void 0 : context.severity) ||
                this.determineSeverity(errorType, error),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.triggerErrorAlert(errorEvent.error_type, hourlyCount, threshold),
            ];
          case 3:
            _b.sent();
            _b.label = 4;
          ...
          case 0:
            console.error(
              "\uD83D\uDEA8 ERROR THRESHOLD EXCEEDED: "
                .concat(errorType, " - ")
                .concat(count, " errors in the last hour (threshold: ")
                .concat(threshold.max_count_per_hour, ")"),
            );
  ...
  ErrorTracker.prototype.flushErrors = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            if (this.errorQueue.length === 0) return [2 /*return*/];
