...
var PerformanceMonitor = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.logPerformanceMetric(__assign(__assign({}, metric), { duration_ms: duration_ms }))];
                    case 1:
                        _a.sent();
    ...
    PerformanceMonitor.prototype.checkPerformanceBudget = function (metricType, duration, routePath) {
        ...
        if (duration > budget) {
            console.warn("Performance budget exceeded for ".concat(metricType, " on ").concat(routePath, ": ").concat(duration, "ms > ").concat(budget, "ms"));
            // Log budget violation as system metric
            this.logSystemMetric('performance_budget_violation', "".concat(metricType, "_budget_exceeded"), duration - budget, 'ms', { route_path: routePath, budget: budget, actual: duration });
        }
    };
    /**
     * Log system-level metrics
     */
    PerformanceMonitor.prototype.logSystemMetric = function (metricType, metricName, value, unit, metadata) {
        return __awaiter(this, void 0, void 0, function () {
            var error, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        durations = data.map(function (d) { return d.duration_ms; }).sort(function (a, b) { return a - b; });
                        count = durations.length;
                        return [2 /*return*/, {
                                average: durations.reduce(function (sum, d) { return sum + d; }, 0) / count,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        Object.keys(report_1).forEach(function (key) {
                            var durations = report_1[key].durations.sort(function (a, b) { return a - b; });
                            var count = durations.length;
                            report_1[key] = __assign(__assign({}, report_1[key]), { count: count, average: durations.reduce(function (sum, d) { return sum + d; }, 0) / count, median: durations[Math.floor(count / 2)], p95: durations[Math.floor(count * 0.95)], p99: durations[Math.floor(count * 0.99)], min: durations[0], max: durations[count - 1] });
...
var createperformanceMonitor = function () { return new PerformanceMonitor(); };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            result = _a.sent();
                            return [4 /*yield*/, performanceMonitor.endMeasurement(operationId, {
...
function usePerformanceTracker(componentName) {
    var _this = this;
    var measureComponentRender = function (renderTime) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, performanceMonitor.logPerformanceMetric({
...
function getPerformanceMetrics() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, performanceMonitor.generatePerformanceReport()];
        });
    });
}
function recordPerformanceMetric(metric) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, performanceMonitor.logPerformanceMetric(metric)];
        });
    });
}
