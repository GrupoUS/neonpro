...
exports.MedicalDataValidator = exports.validationResultSchema = exports.ValidationCategory = exports.ValidationSeverity = void 0;
...
exports.validationResultSchema = zod_1.z.object({
    ...
    // Clinical flags
    clinicalAlerts: zod_1.z.array(zod_1.z.object({
        type: zod_1.z.enum(['drug_interaction', 'allergy_conflict', 'contraindication', 'age_restriction']),
        severity: zod_1.z.enum(['low', 'medium', 'high', 'critical']),
        message: zod_1.z.string(),
        recommendations: zod_1.z.array(zod_1.z.string()).default([])
    })).default([]),
    // Security validation
    securityFlags: zod_1.z.array(zod_1.z.object({
        type: zod_1.z.enum(['data_exposure', 'access_violation', 'encryption_required', 'audit_required']),
        message: zod_1.z.string(),
...
var MedicalDataValidator = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.validateClinicalData(patientData, validationResult)
                    ...
                    case 2:
                        ...
                        _a.sent();
                        // 3. Business Rules Validation
                        return [4 /*yield*/, this.validateBusinessRules(patientData, validationResult)
                    ...
                    case 3:
                        ...
                        _a.sent();
                        // 4. Security Validation
                        return [4 /*yield*/, this.validateSecurity(patientData, context, validationResult)
                    ...
                    case 4:
                        ...
                        _a.sent();
                        // 5. Compliance Validation
                        return [4 /*yield*/, this.validateCompliance(patientData, validationResult)
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, lgpd_1.AuditLogger.log({
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 8];
                    case 8: return [2 /*return*/, validationResult];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 7, , 8]);
                        schemaValidation = (0, schemas_1.validateData)(schemas_1.appointmentSchema, appointmentData);
                        if (!schemaValidation.success) {
                            this.addSchemaErrors(validationResult, schemaValidation.errors || []);
                        }
                    ...
                    case 2:
                        // Appointment-specific validations
                        _a.sent();
                        return [4 /*yield*/, this.validateSchedulingConflicts(appointmentData, validationResult)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.validatePatientAvailability(appointmentData, validationResult)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.validateProfessionalAvailability(appointmentData, validationResult)
                            // Security validation
                        ];
                    case 5:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 8, , 9]);
                        schemaValidation = (0, schemas_1.validateData)(schemas_1.treatmentSchema, treatmentData);
                        if (!schemaValidation.success) {
                            this.addSchemaErrors(validationResult, schemaValidation.errors || []);
                        }
                        // Clinical safety validations
                        return [4 /*yield*/, this.validateDrugInteractions(treatmentData, patientData, validationResult)];
                    case 2:
                        // Clinical safety validations
                        _a.sent();
                        return [4 /*yield*/, this.validateAllergies(treatmentData, patientData, validationResult)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.validateContraindications(treatmentData, patientData, validationResult)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.validateDosage(treatmentData, patientData, validationResult)
                            // Age and condition specific validations
                        ];
                    case 5:
                        _a.sent();
                        // Age and condition specific validations
                        return [4 /*yield*/, this.validateAgeRestrictions(treatmentData, patientData, validationResult)];
                    case 6:
                        // Age and condition specific validations
                        _a.sent();
                        return [4 /*yield*/, this.validateMedicalConditions(treatmentData, patientData, validationResult)];
                    case 7:
                        _a.sent();
                        this.calculateValidationScore(validationResult);
                        return [3 /*break*/, 9];
                    case 8:
                        ...
                        return [3 /*break*/, 9];
                    case 9: return [2 /*return*/, validationResult];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    ...
                    if (!schemaResult.success) {
                        result.valid = false;
                        result.errors = schemaResult.error.errors.map(function (e) { return e.message; });
                    }
    ...
    MedicalDataValidator.validateClinicalData = function (patientData, result) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                ...
                // Validate allergies
                if (((_d = (_c = patientData.medicalInfo) === null || _c === void 0 ? void 0 : _c.allergies) === null || _d === void 0 ? void 0 : _d.length) > 0) {
    ...
    MedicalDataValidator.validateBusinessRules = function (patientData, result) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                for (_i = 0, requiredForTreatment_1 = requiredForTreatment; _i < requiredForTreatment_1.length; _i++) {
                ...
                if (!((_a = patientData.personalData) === null || _a === void 0 ? void 0 : _a.email) && !((_b = patientData.personalData) === null || _b === void 0 ? void 0 : _b.phone)) {
                    result.errors.push({
                        field: 'contact',
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (patientData.createdAt) {
                    daysSinceCreation = (Date.now() - new Date(patientData.createdAt).getTime()) / (1000 * 60 * 60 * 24);
    ...
    MedicalDataValidator.assessDataQuality = function (data, result) {
        ...
        var completedFields = requiredFields.filter(function (field) { return _this.hasField(data, field); });
        ...
        if (((_a = data.personalData) === null || _a === void 0 ? void 0 : _a.email) && !this.isValidEmail(data.personalData.email)) {
            accuracyScore -= 20;
        }
        if (((_b = data.personalData) === null || _b === void 0 ? void 0 : _b.phone) && !this.isValidPhone(data.personalData.phone)) {
            accuracyScore -= 20;
        }
        quality.accuracy = Math.max(0, accuracyScore);
        // Timeliness assessment
        if (data.updatedAt) {
            var daysSinceUpdate = (Date.now() - new Date(data.updatedAt).getTime()) / (1000 * 60 * 60 * 24);
    ...
    MedicalDataValidator.validateDrugInteractions = function (treatmentData, patientData, result) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (((_a = patientData.medicalInfo) === null || _a === void 0 ? void 0 : _a.medications) && patientData.medicalInfo.medications.length > 0) {
                    result.clinicalAlerts.push({
    ...
    MedicalDataValidator.validateAllergies = function (treatmentData, patientData, result) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                if (((_a = patientData.medicalInfo) === null || _a === void 0 ? void 0 : _a.allergies) && patientData.medicalInfo.allergies.length > 0) {
                    result.clinicalAlerts.push({
                        type: 'allergy_conflict',
                        severity: 'critical',
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if ((_a = patientData.medicalInfo) === null || _a === void 0 ? void 0 : _a.medicalHistory) {
                    ...
                    patientConditions_1 = patientData.medicalInfo.medicalHistory.map(function (c) { return c.toLowerCase(); });
                    hasHighRiskCondition = highRiskConditions.some(function (condition) {
                        return patientConditions_1.some(function (pc) { return pc.includes(condition); });
                    });
    ...
    MedicalDataValidator.calculateValidationScore = function (result) {
        ...
        var avgQuality = (result.dataQuality.completeness +
            result.dataQuality.accuracy +
            result.dataQuality.consistency +
            result.dataQuality.timeliness) / 4;
