...
exports.appointmentNotificationSchema =
  ...
  exports.appointmentRescheduleSchema =
  exports.appointmentCancellationSchema =
  exports.appointmentConfirmationSchema =
  exports.availableTimesSchema =
  exports.availabilitySchema =
  exports.appointmentFiltersSchema =
...
exports.appointmentFiltersSchema = zod_1.z.object({
  ...
  sortBy: zod_1.z
    .enum(["scheduledDate", "createdAt", "patientName", "status"])
