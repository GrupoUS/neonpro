...
exports.patientEmergencyDataSchema = exports.treatmentConsentSchema = exports.patientMedicalHistorySchema = exports.patientSearchSchema = exports.patientFiltersSchema = exports.updatePatientSchema = exports.patientSchema = void 0;
...
exports.patientSchema = zod_1.z.object({
    ...
    clinicInfo: zod_1.z.object({
        registrationDate: zod_1.z.date().default(function () { return new Date(); }),
...
exports.patientSearchSchema = zod_1.z.object({
    ...
    searchFields: zod_1.z.array(zod_1.z.enum(['name', 'email', 'cpf', 'phone'])).default(['name', 'email']),
...
exports.patientMedicalHistorySchema = zod_1.z.object({
    ...
    entries: zod_1.z.array(zod_1.z.object({
        ...
        attachments: zod_1.z.array(zod_1.z.object({
            ...
            uploadedAt: zod_1.z.date().default(function () { return new Date(); })
        })).default([]),
        createdAt: zod_1.z.date().default(function () { return new Date(); }),
        updatedAt: zod_1.z.date().default(function () { return new Date(); })
    }))
