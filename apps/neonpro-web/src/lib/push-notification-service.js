...
var PushNotificationService = /** @class */ (function () {
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            if (subscriptions_1.length === 0) {
              return [
                2 /*return*/,
                { success: false, sent: 0, failed: 0, errors: ["No active subscriptions found"] },
              ];
            }
            return [
              4 /*yield*/,
          ...
          case 2:
            ...
            results.forEach(function (result, index) {
              ...
              if (result.status === "fulfilled") {
                ...
                errors_1.push(
                  "Failed to send to "
                    .concat(subscription.endpoint, ": ")
                    .concat((_a = result.reason) === null || _a === void 0 ? void 0 : _a.message),
                );
                // If subscription is invalid, mark as inactive
                if (
                  ((_b = result.reason) === null || _b === void 0 ? void 0 : _b.statusCode) === 410
                ) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        payload = {
          ...
          body: "Ol\u00E1 "
            .concat(appointmentData.patientName, "! Voc\u00EA tem consulta de ")
            .concat(appointmentData.serviceName, " amanh\u00E3 \u00E0s ")
            .concat(appointmentData.appointmentTime, " com ")
            .concat(appointmentData.professionalName, "."),
  ...
  PushNotificationService.prototype.sendAppointmentConfirmation = function (
    userId,
    appointmentData,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        payload = {
          ...
          body: "Sua consulta de "
            .concat(appointmentData.serviceName, " foi confirmada para ")
            .concat(appointmentData.appointmentDate, " \u00E0s ")
            .concat(appointmentData.appointmentTime, "."),
          icon: "/icons/icon-192x192.png",
          badge: "/icons/badge-72x72.png",
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        payload = {
          ...
          body: "Ol\u00E1 "
            .concat(paymentData.patientName, "! Voc\u00EA tem um pagamento de R$ ")
            .concat(paymentData.amount.toFixed(2), " vencendo em ")
            .concat(paymentData.dueDate, "."),
          icon: "/icons/icon-192x192.png",
          badge: "/icons/badge-72x72.png",
        ...
        switch (_c.label) {
          case 0:
            ...
            if (
              ...
              !((_a = subscription.keys) === null || _a === void 0 ? void 0 : _a.p256dh) ||
              !((_b = subscription.keys) === null || _b === void 0 ? void 0 : _b.auth)
            ) {
            ...
            return [
              4 /*yield*/,
              web_push_1.default.sendNotification(subscription, JSON.stringify(testPayload)),
            ];
          case 1:
            _c.sent();
