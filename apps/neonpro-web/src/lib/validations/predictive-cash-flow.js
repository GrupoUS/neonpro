...
exports.createForecastingScenarioSchema = exports.createCashFlowPredictionSchema = exports.predictionPeriodTypeSchema = exports.ConfidenceRangeSchema = exports.AmountRangeSchema = exports.DateRangeSchema = exports.PaginationParamsSchema = exports.AlertFiltersSchema = exports.ScenarioFiltersSchema = exports.ModelFiltersSchema = exports.PredictionFiltersSchema = exports.UpdatePredictionAlertSchema = exports.CreatePredictionAlertSchema = exports.CreatePredictionAccuracySchema = exports.UpdateForecastingScenarioSchema = exports.CreateForecastingScenarioSchema = exports.UpdateCashFlowPredictionSchema = exports.CreateCashFlowPredictionSchema = exports.UpdatePredictionModelSchema = exports.CreatePredictionModelSchema = exports.ErrorMagnitudeSchema = exports.ErrorCategorySchema = exports.AlertStatusSchema = exports.SeverityLevelSchema = exports.AlertTypeSchema = exports.ScenarioTypeSchema = void 0;
...
var ModelTypeSchema = zod_1.z.enum([
    'linear_regression',
    'arima',
    'lstm',
    'ensemble'
]);
var AlgorithmTypeSchema = zod_1.z.enum([
    'statistical',
    'machine_learning',
    'deep_learning'
]);
...
exports.ErrorMagnitudeSchema = zod_1.z.enum([
    'low',
    'medium',
    'high',
    'critical'
...
// =====================================================================================
exports.CreatePredictionModelSchema = zod_1.z.object({
    ...
    training_data_size: zod_1.z.number()
...
exports.UpdatePredictionModelSchema = zod_1.z.object({
    model_name: zod_1.z.string()
        .min(1, 'Model name is required')
        .max(100, 'Model name too long')
        .regex(/^[a-zA-Z0-9_-]+$/, 'Model name can only contain letters, numbers, hyphens, and underscores')
...
// =====================================================================================
exports.CreateCashFlowPredictionSchema = zod_1.z.object({
    model_id: UUIDSchema,
...
exports.UpdateCashFlowPredictionSchema = zod_1.z.object({
...
// =====================================================================================
exports.CreateForecastingScenarioSchema = zod_1.z.object({
    scenario_name: zod_1.z.string()
...
exports.UpdateForecastingScenarioSchema = zod_1.z.object({
    scenario_name: zod_1.z.string()
        .min(1, 'Scenario name is required')
        .max(100, 'Scenario name too long')
        .optional(),
...
// =====================================================================================
exports.CreatePredictionAccuracySchema = zod_1.z.object({
...
// =====================================================================================
exports.CreatePredictionAlertSchema = zod_1.z.object({
    ...
    recommended_actions: zod_1.z.array(zod_1.z.string().max(200, 'Recommended action too long'))
        .max(10, 'Too many recommended actions')
        .optional()
        .default([]),
    assigned_to: UUIDSchema.optional(),
    notification_channels: zod_1.z.array(zod_1.z.enum(['email', 'sms', 'push', 'dashboard']))
...
exports.UpdatePredictionAlertSchema = zod_1.z.object({
...
// =====================================================================================
exports.PredictionFiltersSchema = zod_1.z.object({
...
exports.PaginationParamsSchema = zod_1.z.object({
    ...
    per_page: zod_1.z.number().int().min(1, 'Per page must be at least 1').max(100, 'Per page cannot exceed 100').optional().default(20),
...
exports.AmountRangeSchema = zod_1.z.object({
...
exports.ConfidenceRangeSchema = zod_1.z.object({
