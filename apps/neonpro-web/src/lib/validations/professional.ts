...
export const medicalSpecialtyCreateSchema = z.object({
  name: z.string().min(1, "Specialty name is required").max(100, "Specialty name too long"),
...
export const professionalCredentialCreateSchema = z.object({
  ...
  credential_number: z.string().max(50, "Credential number too long").optional(),
...
export const professionalCredentialUpdateSchema = professionalCredentialCreateSchema
  .partial()
  .omit({
...
export const performanceMetricCreateSchema = z.object({
  ...
  metric_name: z.string().min(1, "Metric name is required").max(100, "Metric name too long"),
...
export const professionalDevelopmentCreateSchema = z.object({
  ...
  activity_name: z.string().min(1, "Activity name is required").max(200, "Activity name too long"),
...
export const professionalDevelopmentUpdateSchema = professionalDevelopmentCreateSchema
  .partial()
  .omit({
    professional_id: true,
    activity_type: true,
...
export const credentialingWorkflowCreateSchema = z.object({
  ...
  workflow_name: z.string().min(1, "Workflow name is required").max(100, "Workflow name too long"),
...
export const credentialingAlertCreateSchema = z.object({
  ...
  title: z.string().min(1, "Alert title is required").max(200, "Alert title too long"),

  message: z.string().min(1, "Alert message is required").max(1000, "Alert message too long"),
