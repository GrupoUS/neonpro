...
exports.LgpdAuditSchema = exports.PatientProfileUpdateSchema = exports.PatientProfileSchema = void 0;
...
exports.PatientProfileSchema = zod_1.z.object({
    ...
    gender: zod_1.z.enum(['male', 'female', 'other', 'prefer_not_to_say'], {
        errorMap: function () { return ({ message: 'Selecione um gênero válido' }); }
    }),
    cpf: zod_1.z.string()
        ...
        return digits.length === 11 && !digits.every(function (d) { return d === digits[0]; });
    }, 'CPF inválido'),
    rg: zod_1.z.string()
    ...
    contactPreferences: zod_1.z.object({
        ...
        preferredMethod: zod_1.z.enum(['email', 'sms', 'whatsapp', 'phone'], {
            errorMap: function () { return ({ message: 'Selecione um método de comunicação preferido' }); }
        }).optional(),
        // Best time to contact
        bestTimeToContact: zod_1.z.enum(['morning', 'afternoon', 'evening', 'anytime'], {
            errorMap: function () { return ({ message: 'Selecione o melhor horário para contato' }); }
        }).default('anytime')
    }),
    ...
    lgpdConsent: zod_1.z.object({
        dataProcessingConsent: zod_1.z.boolean()
            .refine(function (val) { return val === true; }, 'Consentimento para processamento de dados é obrigatório'),
        sensitiveDataConsent: zod_1.z.boolean()
            .refine(function (val) { return val === true; }, 'Consentimento para dados sensíveis de saúde é obrigatório'),
        marketingConsent: zod_1.z.boolean().default(false),
        dataRetentionAcknowledgment: zod_1.z.boolean()
            .refine(function (val) { return val === true; }, 'Reconhecimento sobre retenção de dados é obrigatório'),
        consentDate: zod_1.z.string().optional(),
        consentVersion: zod_1.z.string().default('1.0')
    }),
    // Health Information Preferences
    healthDataPreferences: zod_1.z.object({
