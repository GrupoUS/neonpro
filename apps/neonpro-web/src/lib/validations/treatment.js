...
exports.clinicalNoteSearchSchema = exports.procedureSearchSchema = exports.treatmentPlanSearchSchema = exports.clinicalNoteFormSchema = exports.clinicalNoteSchema = exports.clinicalNoteRelatesToSchema = exports.procedureFormSchema = exports.procedureSchema = exports.procedurePerformerSchema = exports.treatmentPlanFormSchema = exports.treatmentPlanSchema = exports.treatmentPlanActivitySchema = void 0;
var zod_1 = require("zod");
// ===============================================
// BASE VALIDATION SCHEMAS
// ===============================================
var uuidSchema = zod_1.z.string().uuid('ID deve ser um UUID válido');
var fhirIdSchema = zod_1.z.string()
...
var isoDateTimeSchema = zod_1.z.string()
    .datetime('Data deve estar no formato ISO 8601')
    .optional()
    .or(zod_1.z.literal(''));
var nonEmptyStringSchema = zod_1.z.string()
    .min(1, 'Campo é obrigatório')
    .trim();
var optionalStringSchema = zod_1.z.string()
    .trim()
    .optional()
    .or(zod_1.z.literal(''));
...
var lgpdConsentSchema = zod_1.z.object({
    ...
    data_consent_date: zod_1.z.string()
        .datetime('Data de consentimento deve estar no formato ISO 8601')
        .optional(),
    data_retention_until: zod_1.z.string()
...
var treatmentPlanStatusSchema = zod_1.z.enum([
    ...
    errorMap: function () { return ({ message: 'Status do plano de tratamento inválido' }); },
});
var treatmentPlanIntentSchema = zod_1.z.enum([
    'proposal', 'plan', 'order', 'option', 'directive'
], {
    errorMap: function () { return ({ message: 'Intenção do plano de tratamento inválida' }); },
});
...
exports.treatmentPlanSchema = zod_1.z.object(__assign(__assign({ id: uuidSchema.optional(), patient_id: uuidSchema, provider_id: uuidSchema, 
    // FHIR CarePlan Core Fields
    fhir_id: fhirIdSchema.optional(), status: treatmentPlanStatusSchema, intent: treatmentPlanIntentSchema, category: zod_1.z.array(zod_1.z.any()).default([]), title: nonEmptyStringSchema.max(255, 'Título deve ter no máximo 255 caracteres'), description: zod_1.z.string().max(2000, 'Descrição deve ter no máximo 2000 caracteres').optional(), 
    // Clinical Context
    subject_reference: nonEmptyStringSchema, encounter_reference: optionalStringSchema, period_start: isoDateTimeSchema, period_end: isoDateTimeSchema, 
    // Care Team & Goals
    care_team: zod_1.z.array(zod_1.z.any()).default([]), goals: zod_1.z.array(zod_1.z.any()).default([]), activities: zod_1.z.array(exports.treatmentPlanActivitySchema).default([]), 
    // Supporting Information
    supporting_info: zod_1.z.array(zod_1.z.any()).default([]), addresses: zod_1.z.array(zod_1.z.any()).default([]), 
    // FHIR Metadata
    fhir_meta: zod_1.z.object({}).default({}), fhir_text: zod_1.z.object({}).default({}) }, lgpdConsentSchema.shape), { 
    // Audit & Versioning
    version: zod_1.z.number().int().min(1).default(1), replaces: uuidSchema.optional() })).refine(function (data) {
...
exports.treatmentPlanFormSchema = zod_1.z.object({
    title: nonEmptyStringSchema.max(255, 'Título deve ter no máximo 255 caracteres'),
    description: zod_1.z.string().max(2000, 'Descrição deve ter no máximo 2000 caracteres').optional(),
...
var procedureStatusSchema = zod_1.z.enum([
    ...
    errorMap: function () { return ({ message: 'Status do procedimento inválido' }); },
});
...
exports.procedureSchema = zod_1.z.object(__assign(__assign({ id: uuidSchema.optional(), patient_id: uuidSchema, provider_id: uuidSchema, treatment_plan_id: uuidSchema.optional(), 
    // FHIR Procedure Core Fields
    fhir_id: fhirIdSchema.optional(), status: procedureStatusSchema, status_reason: zod_1.z.any().optional(), 
    // Procedure Classification
    category: zod_1.z.any().optional(), code: zod_1.z.any({ required_error: 'Código do procedimento é obrigatório' }), 
    // Clinical Context
    subject_reference: nonEmptyStringSchema, encounter_reference: optionalStringSchema, performed_datetime: isoDateTimeSchema, performed_period_start: isoDateTimeSchema, performed_period_end: isoDateTimeSchema, 
    // Procedure Details
    recorder_reference: optionalStringSchema, asserter_reference: optionalStringSchema, performers: zod_1.z.array(exports.procedurePerformerSchema).default([]), location_reference: optionalStringSchema, reason_code: zod_1.z.array(zod_1.z.any()).default([]), reason_reference: zod_1.z.array(zod_1.z.any()).default([]), body_site: zod_1.z.array(zod_1.z.any()).default([]), outcome: zod_1.z.any().optional(), report: zod_1.z.array(zod_1.z.any()).default([]), complications: zod_1.z.array(zod_1.z.any()).default([]), follow_up: zod_1.z.array(zod_1.z.any()).default([]), 
    // Supporting Documentation
    notes: zod_1.z.string().max(5000, 'Observações devem ter no máximo 5000 caracteres').optional(), used_reference: zod_1.z.array(zod_1.z.any()).default([]), used_code: zod_1.z.array(zod_1.z.any()).default([]), 
    // FHIR Metadata
    fhir_meta: zod_1.z.object({}).default({}), fhir_text: zod_1.z.object({}).default({}) }, lgpdConsentSchema.shape), { 
    // Audit & Versioning
    version: zod_1.z.number().int().min(1).default(1) })).refine(function (data) {
...
exports.procedureFormSchema = zod_1.z.object({
...
// ===============================================
var clinicalNoteStatusSchema = zod_1.z.enum([
    'current', 'superseded', 'entered-in-error'
], {
    errorMap: function () { return ({ message: 'Status da nota clínica inválido' }); },
});
var confidentialityLevelSchema = zod_1.z.enum([
    'U', 'L', 'M', 'N', 'R', 'V'
], {
    errorMap: function () { return ({ message: 'Nível de confidencialidade inválido' }); },
});
...
exports.clinicalNoteSchema = zod_1.z.object(__assign(__assign({ id: uuidSchema.optional(), patient_id: uuidSchema, provider_id: uuidSchema, treatment_plan_id: uuidSchema.optional(), procedure_id: uuidSchema.optional(), 
    // FHIR DocumentReference/Observation Fields
    fhir_id: fhirIdSchema.optional(), status: clinicalNoteStatusSchema, 
    // Note Classification
    category: zod_1.z.any().optional(), type: zod_1.z.any({ required_error: 'Tipo de nota é obrigatório' }), subject_reference: nonEmptyStringSchema, encounter_reference: optionalStringSchema, 
    // Note Content
    title: nonEmptyStringSchema.max(255, 'Título deve ter no máximo 255 caracteres'), content: nonEmptyStringSchema.max(10000, 'Conteúdo deve ter no máximo 10000 caracteres'), content_type: zod_1.z.string().default('text/plain'), 
    // Clinical Context
    authored_time: zod_1.z.string().datetime('Data de autoria deve estar no formato ISO 8601'), author_reference: nonEmptyStringSchema, authenticator_reference: optionalStringSchema, 
    // Related Information
    relates_to: zod_1.z.array(exports.clinicalNoteRelatesToSchema).default([]), context_reference: optionalStringSchema, 
    // Security & Access
    security_label: zod_1.z.array(zod_1.z.any()).default([]), confidentiality: confidentialityLevelSchema, 
    // FHIR Metadata
    fhir_meta: zod_1.z.object({}).default({}), fhir_text: zod_1.z.object({}).default({}) }, lgpdConsentSchema.shape), { 
    // Audit & Versioning
    version: zod_1.z.number().int().min(1).default(1), replaces: uuidSchema.optional() }));
...
exports.treatmentPlanSearchSchema = zod_1.z.object({
    ...
    period_start: isoDateTimeSchema,
    period_end: isoDateTimeSchema,
    search_text: zod_1.z.string().max(255, 'Texto de busca deve ter no máximo 255 caracteres').optional(),
