...
exports.financialValidationSchemas =
  exports.parseCurrencyToCentavos =
  exports.formatCurrency =
  exports.centavosToReais =
  exports.reaisToCentavos =
  exports.validateCpf =
  exports.validateCnpj =
  exports.validateUuid =
  exports.validatePositiveAmount =
  exports.validateAmount =
  exports.paymentQuerySchema =
  exports.invoiceQuerySchema =
  exports.paginationSchema =
  exports.paymentReminderSchema =
  exports.shadowValidationSchema =
  exports.paymentReportFiltersSchema =
  exports.invoiceReportFiltersSchema =
  exports.paymentProcessingRequestSchema =
  exports.nfseRequestSchema =
...
var positiveAmountSchema = zod_1.z
  .number()
  .int("Amount must be an integer (in centavos)")
...
var serviceCodeSchema = zod_1.z
  .string()
  .regex(/^\d{2,10}$/, "Service code must be 2-10 digits")
  .optional();
var pixKeySchema = zod_1.z
  .string()
...
var paymentMethodSchema = zod_1.z.enum([
  "cash",
  "credit_card",
  "debit_card",
  "pix",
...
var paymentProcessingStatusSchema = zod_1.z.enum([
  "pending",
  "processing",
  "completed",
  "failed",
...
var createInvoiceItemSchema = zod_1.z
  .object({
    description: zod_1.z
      .string()
      ...
      .max(
        ...
        "Description cannot exceed ".concat(MAX_DESCRIPTION_LENGTH, " characters"),
      ),
    quantity: zod_1.z
      .number()
...
var createInstallmentSchema = zod_1.z
  .object({
    installment_number: zod_1.z
      .number()
...
exports.nfseRequestSchema = zod_1.z.object({
  invoice_id: uuidSchema,
  service_code: zod_1.z.string().regex(/^\d{2,10}$/, "Service code must be 2-10 digits"),
  service_description: zod_1.z
    .string()
  ...
  taker_name: zod_1.z.string().min(1, "Taker name is required").max(100, "Taker name too long"),
...
exports.invoiceReportFiltersSchema = zod_1.z
  .object({
...
exports.paymentReportFiltersSchema = zod_1.z
  .object({
    clinic_id: uuidSchema.optional(),
...
exports.invoiceQuerySchema = zod_1.z
  .object({
    clinic_id: uuidSchema.optional(),
    patient_id: uuidSchema.optional(),
