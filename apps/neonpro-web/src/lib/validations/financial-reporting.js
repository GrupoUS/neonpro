...
exports.financialReportingValidation = exports.validateKPIThresholds = exports.validateEmailList = exports.validateReportPeriod = exports.kpiQuerySchema = exports.financialReportQuerySchema = exports.validationResultSchema = exports.financialReportErrorSchema = exports.dashboardSubscriptionSchema = exports.reportExportOptionsSchema = exports.revenueAnalyticsSchema = exports.kpiCalculationSchema = exports.cashFlowStatementSchema = exports.balanceSheetSchema = exports.profitLossStatementSchema = exports.reportParametersSchema = exports.createReportTemplateSchema = exports.reportTemplateSchema = exports.createBudgetItemSchema = exports.budgetItemSchema = exports.createBudgetPlanSchema = exports.budgetPlanSchema = exports.financialBenchmarkSchema = exports.financialAnalyticsSchema = exports.createReportScheduleSchema = exports.reportScheduleSchema = exports.createFinancialKPISchema = exports.financialKPISchema = exports.createFinancialReportSchema = exports.financialReportSchema = void 0;
...
exports.reportExportOptionsSchema = zod_1.z.object({
    ...
    language: zod_1.z.string().default('pt-BR'),
    currency: zod_1.z.string().default('BRL'),
    custom_branding: zod_1.z.object({
        logo_url: zod_1.z.string().url().optional(),
        clinic_name: zod_1.z.string().optional(),
        header_color: zod_1.z.string().regex(/^#[0-9A-F]{6}$/i).optional(),
...
var validateEmailList = function (emails) {
    return emails.every(function (email) { return zod_1.z.string().email().safeParse(email).success; });
};
