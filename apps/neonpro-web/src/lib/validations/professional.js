...
exports.credentialAnalyticsFiltersSchema = exports.professionalDashboardFiltersSchema = exports.credentialImportSchema = exports.professionalImportSchema = exports.bulkCredentialExpirationCheckSchema = exports.bulkProfessionalUpdateSchema = exports.performanceMetricSearchSchema = exports.credentialSearchSchema = exports.professionalSearchSchema = exports.credentialingAlertUpdateSchema = exports.credentialingAlertCreateSchema = exports.credentialingWorkflowUpdateSchema = exports.credentialingWorkflowCreateSchema = exports.professionalDevelopmentUpdateSchema = exports.professionalDevelopmentCreateSchema = exports.performanceMetricUpdateSchema = exports.performanceMetricCreateSchema = exports.professionalServiceUpdateSchema = exports.professionalServiceCreateSchema = exports.professionalCredentialUpdateSchema = exports.professionalCredentialCreateSchema = exports.professionalSpecialtyCreateSchema = exports.medicalSpecialtyUpdateSchema = exports.medicalSpecialtyCreateSchema = exports.professionalUpdateSchema = exports.professionalCreateSchema = void 0;
var zod_1 = require("zod");
// ============================================
// COMMON VALIDATION PATTERNS
// ============================================
// NPI (National Provider Identifier) validation - exactly 10 digits
var npiSchema = zod_1.z.string()
...
var phoneSchema = zod_1.z.string()
    .regex(/^\+?[1-9]\d{1,14}$/, 'Invalid phone number format')
    .min(10, 'Phone number too short')
    .max(15, 'Phone number too long');
// Email validation
var emailSchema = zod_1.z.string()
    .email('Invalid email format')
    .max(255, 'Email too long');
// License number validation (alphanumeric, state-specific patterns)
var licenseSchema = zod_1.z.string()
...
var suffixSchema = zod_1.z.string()
    .regex(/^[A-Z.]+$/, 'Professional suffix must be uppercase letters and periods')
    .max(10, 'Professional suffix too long')
    .optional();
// Date validation helpers
var dateSchema = zod_1.z.string().datetime().or(zod_1.z.date().transform(function (d) { return d.toISOString(); }));
var futureDateSchema = zod_1.z.string().datetime().refine(function (date) { return new Date(date) > new Date(); }, 'Date must be in the future');
// ============================================
// ENUM VALIDATIONS
// ============================================
var employmentStatusSchema = zod_1.z.enum(['full_time', 'part_time', 'contractor', 'locum_tenens', 'retired']);
var professionalStatusSchema = zod_1.z.enum(['active', 'inactive', 'suspended', 'pending_verification']);
var credentialTypeSchema = zod_1.z.enum(['license', 'certification', 'board_certification', 'fellowship', 'residency', 'degree', 'cme', 'training']);
var verificationStatusSchema = zod_1.z.enum(['pending', 'in_progress', 'verified', 'expired', 'rejected', 'requires_update']);
var metricTypeSchema = zod_1.z.enum(['quality', 'safety', 'efficiency', 'patient_satisfaction', 'productivity', 'compliance', 'availability']);
var workflowStatusSchema = zod_1.z.enum(['pending', 'in_progress', 'requires_documents', 'under_review', 'approved', 'rejected', 'expired']);
var alertSeveritySchema = zod_1.z.enum(['low', 'medium', 'high', 'critical']);
var alertTypeSchema = zod_1.z.enum(['expiration', 'renewal_required', 'compliance_check', 'performance_review', 'document_missing', 'license_status']);
var serviceTypeSchema = zod_1.z.enum(['consultation', 'procedure', 'surgery', 'diagnostic', 'therapy', 'emergency', 'telemedicine', 'administrative']);
var specialtyCategorySchema = zod_1.z.enum(['primary_care', 'specialty', 'surgical', 'emergency', 'diagnostic', 'mental_health', 'perioperative', 'administrative']);
// ============================================
...
exports.professionalCreateSchema = zod_1.z.object({
    ...
    primary_specialty: zod_1.z.string()
...
exports.medicalSpecialtyCreateSchema = zod_1.z.object({
    ...
    code: zod_1.z.string()
        ...
        .regex(/^[A-Z0-9_-]+$/, 'Specialty code must be uppercase letters, numbers, underscores, or hyphens'),
...
exports.professionalCredentialUpdateSchema = exports.professionalCredentialCreateSchema.partial().omit({
...
exports.professionalServiceCreateSchema = zod_1.z.object({
    ...
    // Availability
    is_active: zod_1.z.boolean().default(true),
    available_from: zod_1.z.string().regex(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/).optional(), // HH:MM format
    available_to: zod_1.z.string().regex(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/).optional(),
    days_of_week: zod_1.z.array(zod_1.z.enum(['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'])).optional(),
...
exports.performanceMetricCreateSchema = zod_1.z.object({
    ...
    measurement_frequency: zod_1.z.enum(['daily', 'weekly', 'monthly', 'quarterly', 'annually']).optional(),
    // Context
...
exports.professionalDevelopmentCreateSchema = zod_1.z.object({
    professional_id: zod_1.z.string().uuid(),
    // Activity details
    activity_type: zod_1.z.enum(['cme', 'conference', 'workshop', 'certification', 'course', 'simulation', 'research']),
    ...
    completion_status: zod_1.z.enum(['registered', 'in_progress', 'completed', 'cancelled']).default('registered'),
...
exports.professionalDevelopmentUpdateSchema = exports.professionalDevelopmentCreateSchema.partial().omit({
    professional_id: true,
    activity_type: true,
    start_date: true
});
...
exports.credentialingWorkflowCreateSchema = zod_1.z.object({
    ...
    workflow_type: zod_1.z.enum(['initial_credentialing', 'recredentialing', 'privilege_request', 'status_change', 'incident_review']),
    ...
    // Communication
    communication_log: zod_1.z.array(zod_1.z.object({
        date: dateSchema,
...
exports.credentialingWorkflowUpdateSchema = exports.credentialingWorkflowCreateSchema.partial().omit({
    professional_id: true,
    workflow_type: true,
    initiated_date: true
});
...
exports.professionalSearchSchema = zod_1.z.object({
    ...
    // Sorting
    sort_by: zod_1.z.enum(['last_name', 'first_name', 'hire_date', 'status', 'primary_specialty']).default('last_name'),
...
exports.credentialSearchSchema = zod_1.z.object({
    ...
    page: zod_1.z.number().int().min(1).default(1),
    limit: zod_1.z.number().int().min(1).max(100).default(20),
    sort_by: zod_1.z.enum(['expiration_date', 'issue_date', 'credential_name', 'verification_status']).default('expiration_date'),
    sort_order: zod_1.z.enum(['asc', 'desc']).default('asc')
});
exports.performanceMetricSearchSchema = zod_1.z.object({
    ...
    page: zod_1.z.number().int().min(1).default(1),
    limit: zod_1.z.number().int().min(1).max(100).default(20),
    sort_by: zod_1.z.enum(['measurement_period_start', 'metric_value', 'metric_name']).default('measurement_period_start'),
