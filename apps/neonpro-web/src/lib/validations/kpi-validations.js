...
exports.dashboardWidgetSchema = exports.dashboardLayoutSchema = exports.PerformanceOptimizationSchema = exports.AlertListQuerySchema = exports.DashboardListQuerySchema = exports.KPIListQuerySchema = exports.BulkThresholdUpdateSchema = exports.BulkKPIUpdateSchema = exports.UpdateThresholdRequestSchema = exports.CreateThresholdRequestSchema = exports.UpdateDashboardRequestSchema = exports.CreateDashboardRequestSchema = exports.UpdateKPIRequestSchema = exports.CreateKPIRequestSchema = exports.DashboardPerformanceSchema = exports.KPIAlertSchema = exports.DashboardTemplateSchema = exports.DrillDownRequestSchema = exports.KPICalculationRequestSchema = exports.KPIDrillPathSchema = exports.DashboardLayoutSchema = exports.DashboardFiltersSchema = exports.DashboardWidgetSchema = exports.KPIThresholdSchema = exports.FinancialKPISchema = void 0;
...
exports.DashboardFiltersSchema = zod_1.z.object({
    ...
    comparison_period: zod_1.z.object({
...
exports.DashboardLayoutSchema = zod_1.z.object({
    ...
    layout_type: zod_1.z.enum(['kpi_dashboard', 'executive_summary', 'detailed_analysis']).default('kpi_dashboard'),
...
exports.KPIListQuerySchema = zod_1.z.object({
    category: zod_1.z.enum(['revenue', 'profitability', 'operational', 'financial_health']).optional(),
    search: zod_1.z.string().optional(),
    sort_by: zod_1.z.enum(['kpi_name', 'current_value', 'variance_percent', 'last_updated']).default('kpi_name'),
