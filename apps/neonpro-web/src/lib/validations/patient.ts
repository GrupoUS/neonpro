...
export const CEPSchema = z.string().regex(/^\d{5}-?\d{3}$/, "Must be a valid CEP (00000-000)");
...
export const PatientRegistrationSchema = z.object({
  ...
  given_names: z.array(z.string().min(1)).min(1, "At least one given name is required"),
