...
exports.CacheManager = exports.staticCache = exports.userCache = exports.apiCache = exports.defaultCache = void 0;
var CacheManager = /** @class */ (function () {
    ...
    CacheManager.prototype.getMany = function (keys) {
        var _this = this;
        return keys.map(function (key) { return ({ key: key, data: _this.get(key) }); });
    };
    ...
    CacheManager.prototype.cleanup = function () {
        ...
        expiredKeys.forEach(function (key) { return _this.delete(key); });
    };
