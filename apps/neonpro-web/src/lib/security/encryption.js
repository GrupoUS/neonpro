...
var HealthcareEncryption = /** @class */ (() => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getEncryptionKey(classification),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getKey(encryptedData.keyId),
  ...
  HealthcareEncryption.generateKey = function (alias_1, classification_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (alias, classification, algorithm, rotationDays) {
  ...
  HealthcareEncryption.rotateKey = function (keyId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getKeyInfo(keyId)];
          case 1:
            oldKeyInfo = _a.sent();
            if (!oldKeyInfo) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            keyInfo = _a.sent();
            if (!keyInfo) return [2 /*return*/];
            // Mark key as revoked
            keyInfo.status = "revoked";
            return [
              4 /*yield*/,
              this.updateKeyInfo(keyInfo),
