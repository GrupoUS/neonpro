...
var SessionHijackingProtection = /** @class */ (function () {
    ...
    SessionHijackingProtection.createFingerprintHash = function (fingerprint) {
        var data = "".concat(fingerprint.userAgent, ":").concat(fingerprint.acceptLanguage, ":").concat(fingerprint.acceptEncoding);
    ...
    SessionHijackingProtection.validateSessionFingerprint = function (sessionId, currentFingerprint) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, _a, storedSession, error, storedFingerprint, riskScore, reasons, action, requiresReauth, error_2;
    ...
    SessionHijackingProtection.detectConcurrentSessions = function (userId_1, currentSessionId_1) {
        return __awaiter(this, arguments, void 0, function (userId, currentSessionId, maxConcurrentSessions) {
            var supabase, _a, sessions, error, activeSessions, hasExcess, sessionsToTerminate, sessionsToKeep_1, error_3;
            if (maxConcurrentSessions === void 0) { maxConcurrentSessions = 3; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 5, , 6]);
                    ...
                    case 2:
                        ...
                        if (error || !sessions) {
                            return [2 /*return*/, { hasExcess: false, activeSessions: 0, sessionsToTerminate: [] }];
                        }
                        ...
                        sessionsToKeep_1 = sessions
                            .filter(function (s) { return s.session_id === currentSessionId; })
                            .concat(sessions
                            .filter(function (s) { return s.session_id !== currentSessionId; })
                            .slice(0, maxConcurrentSessions - 1));
                        sessionsToTerminate = sessions
                            .filter(function (s) { return !sessionsToKeep_1.some(function (keep) { return keep.session_id === s.session_id; }); })
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        _i++;
                        return [3 /*break*/, 3];
                    case 8: return [2 /*return*/, !fingerprintError];
                    case 9:
                        error_5 = _a.sent();
