...
export function getSessionTimeoutConfig(config?: IntegratedSecurityConfig): SessionTimeoutConfig {
...
export function getRateLimitConfig(config?: IntegratedSecurityConfig): RateLimitConfig {
  return (config || getSecurityConfig()).rateLimiting;
}

export function getSecurityEventConfig(config?: IntegratedSecurityConfig): SecurityEventConfig {
  return (config || getSecurityConfig()).securityEvents;
}

export function getCleanupConfig(config?: IntegratedSecurityConfig): CleanupConfig {
  return (config || getSecurityConfig()).cleanup;
}

export function getSecurityHeadersConfig(config?: IntegratedSecurityConfig): SecurityHeadersConfig {
