...
function intelligentSecurityMiddleware(request) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, ip, userAgent, route, method, threatAnalysis, limits, rateLimitResult, response_1, response_2, response, response;
        return __generator(this, function (_a) {
            ...
            try {
                ...
                if (!rateLimitResult.allowed) {
                    response_1 = new NextResponse(JSON.stringify({
                ...
                if (threatAnalysis.riskScore >= 8) {
                    response_2 = new NextResponse(JSON.stringify({
                        error: "Request blocked for security reasons",
                        requestId: "sec_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                    }), {
                        status: 403,
                        headers: {
                            'Content-Type': 'application/json',
