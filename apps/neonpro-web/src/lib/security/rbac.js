...
var HealthcareRBAC = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.checkRolePermission(userRole, permission, context, resourceId),
            ];
          case 3:
            ...
            return [
              4 /*yield*/,
              this.logAccessDecision(userId, permission, context, true, hasPermission.reason),
            ];
          case 4:
            // Log access decision for audit
            _a.sent();
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              this.logAccessDecision(userId, permission, context, false, "Permission denied"),
            ];
          case 7:
            // Permission denied
            _a.sent();
   ...
   */
  HealthcareRBAC.emergencyAccess = function (
    userId,
    permission,
    patientId,
    justification,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.hasPermission(userId, Permission.BREAK_GLASS, AccessContext.EMERGENCY),
            ];
          case 1:
          ...
          case 2:
            ...
            return [
              ...
              this.logAccessDecision(
                ...
                true,
                "Emergency access: ".concat(justification),
              ),
              // Alert security team
            ];
          case 3:
            ...
            return [
              4 /*yield*/,
              this.alertEmergencyAccess(userId, permission, patientId, justification),
            ];
          case 4:
            // Alert security team
            _a.sent();
  ...
  HealthcareRBAC.revokeRole = function (userId, role, revokedBy, reason) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.canRevokeRole(revokedBy, role)];
          case 1:
            canRevoke = _a.sent();
            if (!canRevoke) {
            ...
            return [
              4 /*yield*/,
              this.deactivateUserRole(userId, role),
              // Log role revocation
            ];
          case 2:
            // Deactivate user role
  ...
  HealthcareRBAC.checkRolePermission = function (userRole, permission, context, resourceId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getRoleDefinition(userRole.role)];
          case 1:
  ...
  HealthcareRBAC.checkTimeRestrictions = function (now, restrictions) {
    ...
    if (restrictions.startTime && restrictions.endTime) {
      ...
      var _a = restrictions.startTime.split(":").map(Number),
        startHour = _a[0],
        startMin = _a[1];
      var _b = restrictions.endTime.split(":").map(Number),
        endHour = _b[0],
        endMin = _b[1];
  ...
  HealthcareRBAC.canAssignRole = function (assignerId, role) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.hasPermission(assignerId, Permission.MANAGE_USERS)];
          case 1:
  ...
  HealthcareRBAC.canRevokeRole = function (revokerId, role) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.hasPermission(revokerId, Permission.MANAGE_USERS)];
          case 1:
            canManageUsers = _a.sent();
            return [2 /*return*/, canManageUsers.granted];
        }
  ...
  HealthcareRBAC.ROLE_PERMISSIONS =
    ((_b = {}),
    (_b[Role.SUPER_ADMIN] = [
