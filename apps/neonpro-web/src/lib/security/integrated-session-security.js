...
var IntegratedSessionSecurity = /** @class */ (function () {
     ...
     */
    IntegratedSessionSecurity.initializeSessionSecurity = function (sessionId_1, userId_1, request_1) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        fingerprint = session_hijacking_protection_1.SessionHijackingProtection.generateFingerprint(request);
                        if (!fullConfig.hijackingProtection.enabled) return [3 /*break*/, 2];
                        return [4 /*yield*/, session_hijacking_protection_1.SessionHijackingProtection.storeSessionFingerprint(sessionId, userId, fingerprint)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        if (!fullConfig.timeout.enabled) return [3 /*break*/, 4];
                        return [4 /*yield*/, session_timeout_manager_1.SessionTimeoutManager.initializeSessionTimeout(sessionId, userId, {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, session_hijacking_protection_1.SessionHijackingProtection.detectConcurrentSessions(userId, sessionId, fullConfig.concurrentSessions.maxSessions)];
                    case 5:
                        concurrentCheck = _a.sent();
                        if (!(concurrentCheck.hasExcess && fullConfig.concurrentSessions.terminateOldest)) return [3 /*break*/, 7];
                        return [4 /*yield*/, session_hijacking_protection_1.SessionHijackingProtection.terminateSessions(concurrentCheck.sessionsToTerminate)];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7: 
    ...
    IntegratedSessionSecurity.performSecurityCheck = function (request, sessionId) {
        return __awaiter(this, void 0, void 0, function () {
            var riskScore, warnings, requiresReauth, csrfToken, config, _a, csrfResult, tokenResult, fingerprint, hijackingCheck, timeoutCheck, action, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        config = _a;
                        if (!(config.csrf.enabled && !['GET', 'HEAD', 'OPTIONS'].includes(request.method))) return [3 /*break*/, 6];
                    ...
                    case 6:
                        ...
                        fingerprint = session_hijacking_protection_1.SessionHijackingProtection.generateFingerprint(request);
                        return [4 /*yield*/, session_hijacking_protection_1.SessionHijackingProtection.validateSessionFingerprint(sessionId, fingerprint)];
                    case 7:
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, session_timeout_manager_1.SessionTimeoutManager.checkSessionTimeout(sessionId)];
                    case 9:
                        ...
                        return [4 /*yield*/, session_timeout_manager_1.SessionTimeoutManager.updateActivity(sessionId, {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!securityResult.allowed) {
                            response_1 = new server_1.NextResponse(JSON.stringify({
    ...
    IntegratedSessionSecurity.getSessionSecurityContext = function (sessionId) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, sessionData, timeoutData, lastActivity, isActive, timeoutAt, requiresReauth, error_3;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        isActive = (_a = timeoutData === null || timeoutData === void 0 ? void 0 : timeoutData.is_active) !== null && _a !== void 0 ? _a : true;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data = (_a.sent()).data;
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.config) || this.DEFAULT_CONFIG];
                    case 3:
                        error_5 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        return [4 /*yield*/, session_timeout_manager_1.SessionTimeoutManager.cleanupExpiredSessions()];
                    case 1:
                        _a.sent();
