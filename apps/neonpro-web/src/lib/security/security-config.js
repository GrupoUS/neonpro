...
exports.SECURITY_CONFIG = exports.PRODUCTION_CONFIG_OVERRIDES = exports.DEVELOPMENT_CONFIG_OVERRIDES = exports.DEFAULT_SECURITY_CONFIG = void 0;
...
exports.DEVELOPMENT_CONFIG_OVERRIDES = {
    csrf: __assign(__assign({}, exports.DEFAULT_SECURITY_CONFIG.csrf), { validateIP: false, expirationHours: 1 // Shorter expiration for testing
     }),
    sessionHijacking: __assign(__assign({}, exports.DEFAULT_SECURITY_CONFIG.sessionHijacking), { riskThresholds: {
            allow: 5, // More lenient in development
            challenge: 7,
            block: 9,
            terminate: 10
        } }),
    sessionTimeout: __assign(__assign({}, exports.DEFAULT_SECURITY_CONFIG.sessionTimeout), { defaultTimeoutMinutes: 60, warningMinutes: [10, 5, 2] }),
    rateLimiting: __assign(__assign({}, exports.DEFAULT_SECURITY_CONFIG.rateLimiting), { defaultLimits: {
    ...
    global: __assign(__assign({}, exports.DEFAULT_SECURITY_CONFIG.global), { debugMode: true, environment: 'development', strictMode: false })
};
/**
...
exports.PRODUCTION_CONFIG_OVERRIDES = {
    ...
    rateLimiting: __assign(__assign({}, exports.DEFAULT_SECURITY_CONFIG.rateLimiting), { strictModeForSuspiciousIPs: true }),
    global: __assign(__assign({}, exports.DEFAULT_SECURITY_CONFIG.global), { debugMode: false, environment: 'production', strictMode: true })
};
/**
