...
exports.SecurityMiddleware = exports.HealthcareSecurity = exports.userRoleSchema = exports.roleSchema = exports.permissionSchema = exports.AccessContext = exports.Permission = exports.Role = exports.HealthcareRBAC = exports.keyInfoSchema = exports.encryptedDataSchema = exports.DataClassification = exports.EncryptionAlgorithm = exports.EncryptionUtils = exports.HealthcareEncryption = exports.sessionSchema = exports.MFAMethod = exports.SessionStatus = exports.UserRole = exports.HealthcareSessionManager = void 0;
// Session Management
var session_manager_1 = require("./session-manager");
Object.defineProperty(exports, "HealthcareSessionManager", { enumerable: true, get: function () { return session_manager_1.HealthcareSessionManager; } });
Object.defineProperty(exports, "UserRole", { enumerable: true, get: function () { return session_manager_1.UserRole; } });
Object.defineProperty(exports, "SessionStatus", { enumerable: true, get: function () { return session_manager_1.SessionStatus; } });
Object.defineProperty(exports, "MFAMethod", { enumerable: true, get: function () { return session_manager_1.MFAMethod; } });
Object.defineProperty(exports, "sessionSchema", { enumerable: true, get: function () { return session_manager_1.sessionSchema; } });
// Encryption
var encryption_1 = require("./encryption");
Object.defineProperty(exports, "HealthcareEncryption", { enumerable: true, get: function () { return encryption_1.HealthcareEncryption; } });
...
Object.defineProperty(exports, "DataClassification", { enumerable: true, get: function () { return encryption_1.DataClassification; } });
Object.defineProperty(exports, "encryptedDataSchema", { enumerable: true, get: function () { return encryption_1.encryptedDataSchema; } });
Object.defineProperty(exports, "keyInfoSchema", { enumerable: true, get: function () { return encryption_1.keyInfoSchema; } });
// Role-Based Access Control
var rbac_1 = require("./rbac");
Object.defineProperty(exports, "HealthcareRBAC", { enumerable: true, get: function () { return rbac_1.HealthcareRBAC; } });
...
Object.defineProperty(exports, "AccessContext", { enumerable: true, get: function () { return rbac_1.AccessContext; } });
Object.defineProperty(exports, "permissionSchema", { enumerable: true, get: function () { return rbac_1.permissionSchema; } });
Object.defineProperty(exports, "roleSchema", { enumerable: true, get: function () { return rbac_1.roleSchema; } });
Object.defineProperty(exports, "userRoleSchema", { enumerable: true, get: function () { return rbac_1.userRoleSchema; } });
/**
...
var HealthcareSecurity = /** @class */ (function () {
    ...
    HealthcareSecurity.createSession = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, HealthcareSessionManager.createSession({
    ...
    HealthcareSecurity.validateSessionAndPermission = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, HealthcareSessionManager.validateSession(params.sessionId, params.ipAddress)];
                    case 1:
                        ...
                        return [4 /*yield*/, HealthcareRBAC.hasPermission(sessionResult.session.userId, params.permission, params.context || AccessContext.NORMAL, params.resourceId)];
                    case 2:
    ...
    HealthcareSecurity.encryptPatientData = function (patientData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, HealthcareEncryption.encryptPatientRecord(patientData)];
    ...
    HealthcareSecurity.decryptPatientData = function (encryptedData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, HealthcareEncryption.decryptPatientRecord(encryptedData)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.createAuditRecord('emergency_access_denied', {
                                userId: params.userId,
                                reason: 'Invalid session',
                                patientId: params.patientId
                            })];
                    case 2: return [2 /*return*/, (_a.auditId = _b.sent(),
                            _a)];
                    case 3: return [4 /*yield*/, HealthcareRBAC.emergencyAccess(params.userId, params.permission, params.patientId, params.justification, params.approver)
                        // Create comprehensive audit record
                    ];
                    case 4:
                        emergencyResult = _b.sent();
                        return [4 /*yield*/, this.createAuditRecord('emergency_access_requested', {
                                userId: params.userId,
                                patientId: params.patientId,
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, HealthcareSessionManager.validateSession(params.sessionId, params.ipAddress)];
                    case 1:
                        result_1 = _e.sent();
                        return [2 /*return*/, {
                    ...
                    case 2: return [4 /*yield*/, HealthcareSecurity.validateSessionAndPermission({
