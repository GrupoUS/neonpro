...
var SessionSecurityMiddleware = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.logSecurityEvent({
                                ...
                                riskScore: 5,
                                eventDetails: { error: error_1 instanceof Error ? error_1.message : 'Unknown error' },
                                request: request
                            })];
                    case 4:
                        // Log security event
    ...
    SessionSecurityMiddleware.prototype.performSecurityCheck = function (request, sessionId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var totalRiskScore, reasons, headers, csrfResult, hijackResult, timeoutResult, concurrentResult, rateLimitResult, action;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        totalRiskScore = 0;
                        reasons = [];
                        headers = {};
                        if (!(this.config.enableCSRF && this.requiresCSRFCheck(request))) return [3 /*break*/, 2];
                    ...
                    case 7:
                        ...
                        _a.label = 8;
                    case 8: return [4 /*yield*/, this.checkRateLimit(request, userId)];
                    case 9:
     ...
     */
    SessionSecurityMiddleware.prototype.checkSessionHijacking = function (request, sessionId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.security.hijackingProtection.validateSessionFingerprint(request, sessionId, userId)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.security.timeoutManager.checkSessionTimeout(sessionId, userId)];
                    case 1:
                        result = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.security.hijackingProtection.detectConcurrentSessions(userId, this.config.maxConcurrentSessions || 3)];
                    case 1:
                        sessions = _a.sent();
                        return [2 /*return*/, { allowed: sessions.length <= (this.config.maxConcurrentSessions || 3) }];
                    case 2:
                        error_5 = _a.sent();
    ...
    SessionSecurityMiddleware.prototype.shouldSkipPath = function (pathname) {
        var _a;
        return ((_a = this.config.skipPaths) === null || _a === void 0 ? void 0 : _a.some(function (path) {
    ...
    SessionSecurityMiddleware.prototype.createErrorResponse = function (message, status) {
        return server_1.NextResponse.json({ error: message, timestamp: new Date().toISOString() }, { status: status });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        eventType = params.eventType, riskScore = params.riskScore, eventDetails = params.eventDetails, request = params.request;
...
function createSessionSecurityMiddleware(config) {
    ...
    return function (request) { return middleware.middleware(request); };
}
