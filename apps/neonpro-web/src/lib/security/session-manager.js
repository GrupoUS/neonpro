...
exports.HealthcareSessionManager = exports.sessionSchema = exports.MFAMethod = exports.SessionStatus = exports.UserRole = void 0;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        ;
                        return [4 /*yield*/, this.calculateRiskScore({
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.storeSession(validated)
                    ...
                    case 4:
                        ...
                        _c.sent();
                        // Log session creation
                        return [4 /*yield*/, this.logSessionEvent(validated.id, 'session_created', {
                                userRole: params.userRole,
                                riskScore: riskScore,
                                loginMethod: params.loginMethod
                            })
                    ...
                    case 5:
                        // Log session creation
                        _c.sent();
                        if (!(riskScore >= this.RISK_THRESHOLDS.MFA_REQUIRED || this.requiresMFA(params.userRole))) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.initiateMFA(validated.id)];
                    case 6:
                        _c.sent();
                        _c.label = 7;
                    case 7: return [2 /*return*/, validated];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.flagSuspiciousActivity(sessionId, 'ip_mismatch', {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.logSessionEvent(sessionId, 'mfa_verified', { method: method })];
                    case 4:
                        _a.sent();
                    ...
                    case 6:
                        // Log failed MFA attempt
                        _a.sent();
                        return [4 /*yield*/, this.flagSuspiciousActivity(sessionId, 'mfa_failure', { method: method })];
                    case 7:
                        _a.sent();
                        return [2 /*return*/, { success: false }];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.logSessionEvent(sessionId, 'session_terminated', {
                                reason: reason,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [4 /*yield*/, this.logSessionEvent('system', 'all_sessions_terminated', {
                            userId: userId,
                            reason: reason,
                            terminatedBy: terminatedBy,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                permissions = (_a = {},
                    ...
                    _a[UserRole.DOCTOR] = ['read_patients', 'write_patients', 'read_medical_records', 'write_medical_records', 'prescribe'],
                    _a[UserRole.NURSE] = ['read_patients', 'update_patient_vitals', 'read_medical_records'],
                    _a[UserRole.RECEPTIONIST] = ['read_patients', 'create_appointments', 'update_appointments', 'billing'],
    ...
    HealthcareSessionManager.flagSuspiciousActivity = function (sessionId, type, details) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log('Suspicious activity flagged:', { sessionId: sessionId, type: type, details: details });
                return [2 /*return*/];
            });
        });
    };
    // Session timeout configurations (in minutes)
    HealthcareSessionManager.SESSION_TIMEOUTS = (_a = {},
        _a[UserRole.ADMIN] = 30,
        _a[UserRole.DOCTOR] = 60,
        _a[UserRole.NURSE] = 45,
        _a[UserRole.RECEPTIONIST] = 120,
        _a[UserRole.PATIENT] = 30,
        _a[UserRole.SYSTEM] = 1440 // 24 hours for system
    ,
        _a);
