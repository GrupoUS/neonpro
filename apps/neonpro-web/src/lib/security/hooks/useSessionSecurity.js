...
function useSessionSecurity(options) {
    ...
    var _a = options.enableCSRF, enableCSRF = _a === void 0 ? true : _a, _b = options.enableTimeout, enableTimeout = _b === void 0 ? true : _b, _c = options.enableActivityTracking, enableActivityTracking = _c === void 0 ? true : _c, _d = options.timeoutConfig, timeoutConfig = _d === void 0 ? {} : _d, onSecurityWarning = options.onSecurityWarning, onSessionTimeout = options.onSessionTimeout, onCSRFError = options.onCSRFError;
    ...
    }), securityState = _e[0], setSecurityState = _e[1];
     ...
     */
    var initializeSecurity = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    setSecurityState(function (prev) { return (__assign(__assign({}, prev), { sessionId: sessionId_1, csrfToken: csrfToken_1, lastActivity: new Date() })); });
                    return [3 /*break*/, 7];
                case 6:
                    error_1 = _a.sent();
                    console.error('Failed to initialize session security:', error_1);
                    setSecurityState(function (prev) { return (__assign(__assign({}, prev), { isSecure: false, warnings: __spreadArray(__spreadArray([], prev.warnings, true), ['Failed to initialize security'], false) })); });
                    return [3 /*break*/, 7];
     ...
     */
    var fetchCSRFToken = function (sessionId) { return __awaiter(_this, void 0, void 0, function () {
        var response, data, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch('/api/security/csrf-token', {
                            method: 'POST',
                            headers: {
     ...
     */
    var initializeSessionTimeout = function (sessionId) { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch('/api/security/session-timeout', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-Session-ID': sessionId
    ...
    var setupTimeoutMonitoring = function (sessionId) {
        ...
        warningTimeoutsRef.current.forEach(function (timeout) { return clearTimeout(timeout); });
        ...
        config.warningMinutes.forEach(function (warningMinutes) {
            ...
            var warningTimeout = setTimeout(function () {
                var warning = "Session will expire in ".concat(warningMinutes, " minute").concat(warningMinutes !== 1 ? 's' : '');
                setSecurityState(function (prev) { return (__assign(__assign({}, prev), { timeoutWarning: warning, warnings: __spreadArray(__spreadArray([], prev.warnings, true), [warning], false) })); });
                if (config.showWarnings) {
                    onSecurityWarning === null || onSecurityWarning === void 0 ? void 0 : onSecurityWarning(warning);
                }
            }, warningMs);
     ...
     */
    var handleSessionTimeout = function (sessionId) { return __awaiter(_this, void 0, void 0, function () {
        var error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch('/api/security/session-timeout/force', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-Session-ID': sessionId
                ...
                case 1:
                    ...
                    localStorage.clear();
                    setSecurityState(function (prev) { return (__assign(__assign({}, prev), { isSecure: false, warnings: __spreadArray(__spreadArray([], prev.warnings, true), ['Session has expired'], false) })); });
    ...
    var setupActivityTracking = function (sessionId) {
        ...
        var handleActivity = function () { return __awaiter(_this, void 0, void 0, function () {
            var now, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fetch('/api/security/session-activity', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'X-Session-ID': sessionId
                    ...
                    case 2:
                        ...
                        _a.sent();
                        // Update local state
                        setSecurityState(function (prev) { return (__assign(__assign({}, prev), { lastActivity: new Date() })); });
     ...
     */
    var extendSession = (0, react_1.useCallback)(function () {
        var args_1 = [];
        ...
        return __awaiter(_this, __spreadArray([], args_1, true), void 0, function (minutes) {
            var error_6;
            if (minutes === void 0) { minutes = config.timeoutMinutes; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fetch('/api/security/session-timeout/extend', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                    ...
                    case 2:
                        ...
                        setSecurityState(function (prev) { return (__assign(__assign({}, prev), { timeoutWarning: undefined, warnings: prev.warnings.filter(function (w) { return !w.includes('expire'); }) })); });
                        return [3 /*break*/, 4];
                    case 3:
                        error_6 = _a.sent();
     ...
     * Refresh CSRF token
     */
    var refreshCSRFToken = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    newToken_1 = _a.sent();
                    setSecurityState(function (prev) { return (__assign(__assign({}, prev), { csrfToken: newToken_1 })); });
     ...
     */
    var getSecureHeaders = (0, react_1.useCallback)(function () {
        var headers = {};
        if (securityState.sessionId) {
...
function useCSRFToken(sessionId) {
    ...
    var fetchToken = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
...
function useSessionTimeout(sessionId, onTimeout) {
    var _this = this;
    var _a = (0, react_1.useState)(null), timeRemaining = _a[0], setTimeRemaining = _a[1];
    var _b = (0, react_1.useState)(null), warning = _b[0], setWarning = _b[1];
    (0, react_1.useEffect)(function () {
        if (!sessionId)
            return;
        var checkTimeout = function () { return __awaiter(_this, void 0, void 0, function () {
            var response, data, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, fetch("/api/security/session-timeout/status?sessionId=".concat(sessionId))];
                    case 1:
                        response = _a.sent();
