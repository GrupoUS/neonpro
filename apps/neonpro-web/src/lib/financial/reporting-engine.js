      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            ...
            taxExpenses =
              totalRevenue *
              (financial_reporting_1.FINANCIAL_CONSTANTS.BRAZILIAN_TAX_RATES.ISS +
            ...
            validation =
              financial_reporting_2.profitLossStatementSchema.safeParse(profitLossStatement);
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 1:
            ...
            if (cashError) throw new Error("Cash data fetch failed: ".concat(cashError.message));
            return [
              4 /*yield*/,
              this.supabase
                .from("invoices")
          ...
          case 3:
            ...
            cashAndEquivalents =
              (cashData === null || cashData === void 0 ? void 0 : cashData.current_balance) || 0;
            accountsReceivable =
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 3:
            ...
            beginningCash =
              ((_b =
                beginningCashData === null || beginningCashData === void 0
                  ? void 0
                  : beginningCashData[0]) === null || _b === void 0
                ? void 0
                : _b.running_balance) || 0;
            endingCash =
              ((_c =
                endingCashData === null || endingCashData === void 0
                  ? void 0
                  : endingCashData[0]) === null || _c === void 0
                ? void 0
                : _c.running_balance) || 0;
            operatingRevenue =
            ...
            if (!validation.success) {
              throw new Error(
                "Cash flow statement validation failed: ".concat(validation.error.message),
              );
            }
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) throw new Error("Revenue analytics fetch failed: ".concat(error.message));
            totalRevenue =
              (revenueData === null || revenueData === void 0
                ? void 0
            ...
            revenueData === null || revenueData === void 0
              ...
              : revenueData.forEach((invoice) => {
                  ...
                  var providerName =
                    ((_b =
                      (_a = invoice.appointments) === null || _a === void 0
                        ? void 0
                        : _a.professionals) === null || _b === void 0
                      ? void 0
                      : _b.name) || "Unknown";
                  var current = providerRevenue.get(providerName) || {
                    revenue: 0,
                    patient_count: 0,
                  };
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) throw new Error("Expense analytics fetch failed: ".concat(error.message));
            totalExpenses =
              (expenseData === null || expenseData === void 0
                ? void 0
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) throw new Error("Failed to save report: ".concat(error.message));
