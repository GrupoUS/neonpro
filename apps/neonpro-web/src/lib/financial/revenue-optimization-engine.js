...
exports.createrevenueOptimizationEngine =
  ...
  exports.PricingStrategySchema =
  exports.RevenueOptimizationSchema =
    void 0;
...
var createrevenueOptimizationEngine = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            ...
            projectedIncrease = this.calculateProjectedIncrease(
              currentStrategy,
              recommendations,
              marketAnalysis,
            );
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            optimizedMix = this.generateOptimizedServiceMix(
              servicePerformance,
              profitabilityMetrics,
            );
            profitabilityGain = this.calculateMixProfitabilityGain(
              servicePerformance,
              optimizedMix,
            );
            recommendations = [
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            enhancementStrategies = this.generateCLVEnhancementStrategies(
              clvPredictions,
              riskSegmentation,
            );
  ...
  createrevenueOptimizationEngine.prototype.generatePricingRecommendations = function (
    clinicId,
    serviceId,
    marketAnalysis,
    competitiveAnalysis,
