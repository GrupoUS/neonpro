...
var RevenueAnalyticsEngine = /** @class */ (function () {
    ...
    RevenueAnalyticsEngine.prototype.analyzeRevenueByService = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        clinicId = filters.clinicId, dateRange = filters.dateRange, serviceIds = filters.serviceIds;
                        return [4 /*yield*/, this.supabase.rpc('analyze_service_revenue', {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Service revenue analysis failed: ".concat(error.message));
                        return [4 /*yield*/, Promise.all(serviceData.map(function (service) { return __awaiter(_this, void 0, void 0, function () {
                                var costAllocation, seasonalIndex, growthRate;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.calculateServiceCostAllocation(service.service_id, dateRange)];
                                        case 1:
                                            costAllocation = _a.sent();
                                            return [4 /*yield*/, this.calculateSeasonalIndex(service.service_id, dateRange)];
                                        case 2:
                                            seasonalIndex = _a.sent();
                                            return [4 /*yield*/, this.calculateGrowthRate(service.service_id, dateRange)];
                                        case 3:
                                            growthRate = _a.sent();
                                            return [2 /*return*/, {
                                                    ...
                                                    profitMargin: ((parseFloat(service.total_revenue) - costAllocation) / parseFloat(service.total_revenue)) * 100,
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, enrichedData.sort(function (a, b) { return b.totalRevenue - a.totalRevenue; })];
                }
            });
        });
    };
    ...
    RevenueAnalyticsEngine.prototype.calculateServiceProfitability = function (serviceId, dateRange) {
        return __awaiter(this, void 0, void 0, function () {
            var directCosts, overheadData, directCostTotal, overheadCost, totalCost, revenueData, totalRevenue, grossProfit, marginPercent;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.supabase.rpc('calculate_overhead_allocation', {
                    ...
                    case 2:
                        ...
                        directCostTotal = (directCosts === null || directCosts === void 0 ? void 0 : directCosts.reduce(function (sum, cost) { return sum + parseFloat(cost.amount); }, 0)) || 0;
                        overheadCost = ((_a = overheadData === null || overheadData === void 0 ? void 0 : overheadData[0]) === null || _a === void 0 ? void 0 : _a.overhead_allocation) || 0;
                        totalCost = directCostTotal + overheadCost;
                        return [4 /*yield*/, this.supabase.rpc('get_service_revenue', {
                                p_service_id: serviceId,
                                p_start_date: dateRange.start.toISOString(),
                                p_end_date: dateRange.end.toISOString()
                            })];
                    case 3:
                        ...
                        totalRevenue = ((_b = revenueData === null || revenueData === void 0 ? void 0 : revenueData[0]) === null || _b === void 0 ? void 0 : _b.total_revenue) || 0;
                        ...
                        return [2 /*return*/, {
                                ...
                                breakEvenVolume: totalCost > 0 ? Math.ceil(totalCost / (totalRevenue / (((_c = revenueData === null || revenueData === void 0 ? void 0 : revenueData[0]) === null || _c === void 0 ? void 0 : _c.transaction_count) || 1))) : 0
                            }];
                }
            });
        });
    ...
    RevenueAnalyticsEngine.prototype.analyzeProviderPerformance = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        clinicId = filters.clinicId, dateRange = filters.dateRange, providerIds = filters.providerIds;
                        return [4 /*yield*/, this.supabase.rpc('analyze_provider_revenue', {
                                p_clinic_id: clinicId,
                                p_start_date: dateRange.start.toISOString(),
                                p_end_date: dateRange.end.toISOString(),
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(providerData.map(function (provider) { return __awaiter(_this, void 0, void 0, function () {
                                var utilizationRate, conversionRate, growthTrend;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.calculateProviderUtilization(provider.provider_id, dateRange)];
                                        case 1:
                                            utilizationRate = _a.sent();
                                            return [4 /*yield*/, this.calculateProviderConversionRate(provider.provider_id, dateRange)];
                                        case 2:
                                            conversionRate = _a.sent();
                                            return [4 /*yield*/, this.calculateProviderGrowthTrend(provider.provider_id, dateRange)];
                                        case 3:
                                            growthTrend = _a.sent();
                                            return [2 /*return*/, {
    ...
    RevenueAnalyticsEngine.prototype.calculateProviderUtilization = function (providerId, dateRange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('calculate_provider_utilization', {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, ((_a = utilizationData === null || utilizationData === void 0 ? void 0 : utilizationData[0]) === null || _a === void 0 ? void 0 : _a.utilization_rate) || 0];
                }
            });
        });
    };
     ...
     */
    RevenueAnalyticsEngine.prototype.calculateProviderConversionRate = function (providerId, dateRange) {
        return __awaiter(this, void 0, void 0, function () {
            var conversionData;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('calculate_provider_conversion', {
                            p_provider_id: providerId,
                            p_start_date: dateRange.start.toISOString(),
                            p_end_date: dateRange.end.toISOString()
                        })];
                    case 1:
                        ...
                        return [2 /*return*/, ((_a = conversionData === null || conversionData === void 0 ? void 0 : conversionData[0]) === null || _a === void 0 ? void 0 : _a.conversion_rate) || 0];
                }
            });
        });
    };
     ...
     */
    RevenueAnalyticsEngine.prototype.generateTimePeriodAnalysis = function (clinicId, currentPeriod, comparisonType) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, timeSeriesData, error;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('generate_time_series_analysis', {
                            p_clinic_id: clinicId,
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Time series analysis failed: ".concat(error.message));
                        return [2 /*return*/, timeSeriesData.map(function (period) { return ({
    ...
    RevenueAnalyticsEngine.prototype.calculateSeasonalIndex = function (serviceId, dateRange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('calculate_seasonal_index', {
                            p_service_id: serviceId,
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, ((_a = seasonalData === null || seasonalData === void 0 ? void 0 : seasonalData[0]) === null || _a === void 0 ? void 0 : _a.seasonal_index) || 1.0];
                }
            });
        });
    };
    ...
    RevenueAnalyticsEngine.prototype.calculatePatientLifetimeValue = function (clinicId, patientIds) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('calculate_patient_ltv', {
                            p_clinic_id: clinicId,
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Patient LTV calculation failed: ".concat(error.message));
                        return [2 /*return*/, ltvData.map(function (patient) { return ({
    ...
    RevenueAnalyticsEngine.prototype.generateRevenueForecast = function (clinicId_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, forecastPeriods, forecastType) {
            ...
            if (forecastPeriods === void 0) { forecastPeriods = 12; }
            if (forecastType === void 0) { forecastType = 'seasonal'; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('generate_revenue_forecast', {
                            p_clinic_id: clinicId,
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Revenue forecasting failed: ".concat(error.message));
                        return [2 /*return*/, forecastData.map(function (forecast) { return ({
    ...
    RevenueAnalyticsEngine.prototype.calculateGrowthRate = function (entityId_1, dateRange_1) {
        return __awaiter(this, arguments, void 0, function (entityId, dateRange, entityType) {
            var growthData;
            var _a;
            if (entityType === void 0) { entityType = 'service'; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('calculate_growth_rate', {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, ((_a = growthData === null || growthData === void 0 ? void 0 : growthData[0]) === null || _a === void 0 ? void 0 : _a.growth_rate) || 0];
                }
            });
        });
    };
     ...
     */
    RevenueAnalyticsEngine.prototype.calculateServiceCostAllocation = function (serviceId, dateRange) {
        return __awaiter(this, void 0, void 0, function () {
            var costData;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('calculate_service_cost_allocation', {
                            p_service_id: serviceId,
                            p_start_date: dateRange.start.toISOString(),
                            p_end_date: dateRange.end.toISOString()
                        })];
                    case 1:
                        ...
                        return [2 /*return*/, ((_a = costData === null || costData === void 0 ? void 0 : costData[0]) === null || _a === void 0 ? void 0 : _a.total_allocated_cost) || 0];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _a = _e.sent(), serviceRevenue = _a[0], providerPerformance = _a[1], timeSeries = _a[2], topPatients = _a[3], forecast = _a[4];
                        return [2 /*return*/, {
                                ...
                                summary: {
                                    totalRevenue: serviceRevenue.reduce(function (sum, s) { return sum + s.totalRevenue; }, 0),
                                    averageProfitMargin: serviceRevenue.reduce(function (sum, s) { return sum + s.profitMargin; }, 0) / serviceRevenue.length,
                                    topServiceRevenue: ((_b = serviceRevenue[0]) === null || _b === void 0 ? void 0 : _b.totalRevenue) || 0,
                                    topProviderRevenue: ((_c = providerPerformance[0]) === null || _c === void 0 ? void 0 : _c.totalRevenue) || 0,
                                    growthRate: ((_d = timeSeries[timeSeries.length - 1]) === null || _d === void 0 ? void 0 : _d.growthRate) || 0
                                }
                            }];
                }
            });
