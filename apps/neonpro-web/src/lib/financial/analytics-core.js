...
var FinancialAnalyticsCore = /** @class */ (function () {
    ...
    FinancialAnalyticsCore.prototype.calculateFinancialKPIs = function (clinicId, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var period_start, period_end, _a, profitLoss, balanceSheet, cashFlow, grossProfitMargin, operatingProfitMargin, netProfitMargin, returnOnAssets, returnOnEquity, currentRatio, quickRatio, cashRatio, assetTurnover, receivablesTurnover, daysInAccountsReceivable, debtToAssets, debtToEquity, equityMultiplier, operatingCashFlowRatio, cashFlowToDebt, freeCashFlow;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        returnOnAssets = balanceSheet.assets.total_assets > 0 ?
                            (profitLoss.net_profit / balanceSheet.assets.total_assets) * 100 : 0;
                        returnOnEquity = balanceSheet.equity.total_equity > 0 ?
                            (profitLoss.net_profit / balanceSheet.equity.total_equity) * 100 : 0;
                        currentRatio = balanceSheet.liabilities.current_liabilities.total_current_liabilities > 0 ?
                        ...
                        quickRatio = balanceSheet.liabilities.current_liabilities.total_current_liabilities > 0 ?
                            (balanceSheet.assets.current_assets.cash_and_equivalents + balanceSheet.assets.current_assets.accounts_receivable) /
                                balanceSheet.liabilities.current_liabilities.total_current_liabilities : 0;
                        cashRatio = balanceSheet.liabilities.current_liabilities.total_current_liabilities > 0 ?
                            balanceSheet.assets.current_assets.cash_and_equivalents /
                                balanceSheet.liabilities.current_liabilities.total_current_liabilities : 0;
                        assetTurnover = balanceSheet.assets.total_assets > 0 ?
                            profitLoss.revenue.total_revenue / balanceSheet.assets.total_assets : 0;
                        receivablesTurnover = balanceSheet.assets.current_assets.accounts_receivable > 0 ?
                            profitLoss.revenue.total_revenue / balanceSheet.assets.current_assets.accounts_receivable : 0;
                        daysInAccountsReceivable = receivablesTurnover > 0 ? 365 / receivablesTurnover : 0;
                        debtToAssets = balanceSheet.assets.total_assets > 0 ?
                            balanceSheet.liabilities.total_liabilities / balanceSheet.assets.total_assets : 0;
                        debtToEquity = balanceSheet.equity.total_equity > 0 ?
                            balanceSheet.liabilities.total_liabilities / balanceSheet.equity.total_equity : 0;
                        equityMultiplier = balanceSheet.equity.total_equity > 0 ?
                            balanceSheet.assets.total_assets / balanceSheet.equity.total_equity : 0;
                        operatingCashFlowRatio = balanceSheet.liabilities.current_liabilities.total_current_liabilities > 0 ?
                            cashFlow.operating_activities.net_cash_from_operations /
                                balanceSheet.liabilities.current_liabilities.total_current_liabilities : 0;
                        cashFlowToDebt = balanceSheet.liabilities.total_liabilities > 0 ?
                            cashFlow.operating_activities.net_cash_from_operations / balanceSheet.liabilities.total_liabilities : 0;
                        freeCashFlow = cashFlow.operating_activities.net_cash_from_operations +
                        ...
                        return [2 /*return*/, {
                                ...
                                liquidity_kpis: {
                                    ...
                                    working_capital: balanceSheet.assets.current_assets.total_current_assets -
    ...
    FinancialAnalyticsCore.prototype.calculatePerformanceMetrics = function (clinicId, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var period_start, period_end, _a, appointmentData, revenueData, expenseData, revenueGrowthRate, averageTransactionValue, revenuePerSquareMeter, patientRetentionRate, appointmentUtilizationRate, averageWaitTime, patientSatisfactionScore, costGrowthRate, costPerPatient, costPerAppointment, marketShare, competitivePosition, brandAwareness;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _a = _d.sent(), appointmentData = _a[0], revenueData = _a[1], expenseData = _a[2];
                        return [4 /*yield*/, this.calculateGrowthRate(clinicId, 'revenue', period_start, period_end)];
                    case 2:
                        revenueGrowthRate = _d.sent();
                        averageTransactionValue = revenueData.total_revenue / (appointmentData.total_appointments || 1);
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.calculateGrowthRate(clinicId, 'expenses', period_start, period_end)];
                    case 4:
                        costGrowthRate = _d.sent();
                        costPerPatient = expenseData.cost_per_patient;
                        costPerAppointment = expenseData.total_expenses / (appointmentData.total_appointments || 1);
                        marketShare = 0;
                    ...
                    return [2 /*return*/, (_b.benchmarks = (_c.historical_performance = _d.sent(),
                            _c),
                            _b)];
                }
            });
    ...
    FinancialAnalyticsCore.prototype.generateDashboardData = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var now, currentMonth, lastMonth, _a, currentKPIs, lastMonthKPIs, revenueAnalytics, expenseAnalytics, performanceMetrics, kpiChanges, alerts, recommendations;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 1:
                        _a = _d.sent(), currentKPIs = _a[0], lastMonthKPIs = _a[1], revenueAnalytics = _a[2], expenseAnalytics = _a[3], performanceMetrics = _a[4];
                    ...
                    case 2:
                        _c.revenue_trends = _d.sent(),
                            _c.expense_breakdown = expenseAnalytics.expense_by_category.map(function (cat) { return ({
                    ...
                    case 4: return [2 /*return*/, (_b.charts_data = (_c.profitability_analysis = _d.sent(),
                            _c.kpi_dashboard = {
                            ...
                            _b.refresh_interval = financial_reporting_1.DASHBOARD_REFRESH_INTERVALS.FINANCIAL_OVERVIEW,
                            _b)];
                }
            });
        });
    ...
    FinancialAnalyticsCore.prototype.fetchAppointmentMetrics = function (clinicId, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var period_start, period_end, _a, appointmentData, error, totalAppointments, completedAppointments, utilizationRate;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        period_start = parameters.period_start, period_end = parameters.period_end;
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Appointment metrics fetch failed: ".concat(error.message));
                        totalAppointments = (appointmentData === null || appointmentData === void 0 ? void 0 : appointmentData.length) || 0;
                        completedAppointments = (appointmentData === null || appointmentData === void 0 ? void 0 : appointmentData.filter(function (apt) { return apt.status === 'completed'; }).length) || 0;
                        utilizationRate = totalAppointments > 0 ? (completedAppointments / totalAppointments) * 100 : 0;
                        return [2 /*return*/, {
     ...
     */
    FinancialAnalyticsCore.prototype.calculateGrowthRate = function (clinicId, metricType, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    FinancialAnalyticsCore.prototype.calculateKPIChanges = function (current, previous) {
        return {
            ...
            cash_flow_change: current.cash_flow_kpis.free_cash_flow - previous.cash_flow_kpis.free_cash_flow
        };
    };
    /**
    ...
    FinancialAnalyticsCore.prototype.generateRecommendations = function (kpis, performance) {
        ...
        if (performance.revenue_metrics.revenue_growth_rate < 10) {
            recommendations.push({
                ...
                description: 'Considerar novos serviços, parcerias ou campanhas de marketing para aumentar receita.',
