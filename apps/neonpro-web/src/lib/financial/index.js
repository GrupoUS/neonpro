...
exports.FinancialDashboardEngine = exports.createpredictiveAnalyticsEngine = exports.AutomatedAlertsEngine = exports.CashFlowEngine = exports.PaymentTracker = exports.AutomatedInvoiceGenerator = exports.FinancialManagementSystem = void 0;
var invoice_generator_1 = require("./invoice-generator");
Object.defineProperty(exports, "AutomatedInvoiceGenerator", { enumerable: true, get: function () { return invoice_generator_1.AutomatedInvoiceGenerator; } });
var payment_tracker_1 = require("./payment-tracker");
Object.defineProperty(exports, "PaymentTracker", { enumerable: true, get: function () { return payment_tracker_1.PaymentTracker; } });
...
var FinancialManagementSystem = /** @class */ (function () {
    function FinancialManagementSystem(config) {
        ...
        this.invoiceGenerator = new invoice_generator_1.AutomatedInvoiceGenerator(this.config.invoiceGeneration);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        // Initialize subsystems
                        _a.sent();
                        return [4 /*yield*/, this.paymentTracker.initialize()
                            // Setup integration workflows
                        ];
                    case 2:
                        _a.sent();
                        // Setup integration workflows
                        return [4 /*yield*/, this.setupIntegrationWorkflows()
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.invoiceGenerator.generateFromAppointment(invoiceData.appointmentId, {
                                customServices: invoiceData.services,
                                paymentMethod: (_a = invoiceData.paymentMethods) === null || _a === void 0 ? void 0 : _a[0],
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.invoiceGenerator.generateFromTreatment(invoiceData.treatmentId, {
                                generateNFSe: invoiceData.generateNFSe
                            })];
                    case 3:
                        invoices = _b.sent();
                        ...
                        return [3 /*break*/, 5];
                    case 4: throw new Error('Either appointmentId or treatmentId must be provided');
                    case 5:
                        paymentSetup = undefined;
                        if (!(invoiceData.autoSetupPayment && invoice.paymentMethods.length > 0)) return [3 /*break*/, 8];
                        primaryPaymentMethod = invoice.paymentMethods[0];
                        return [4 /*yield*/, this.paymentTracker.createPayment({
                    ...
                    case 6:
                        payment = _b.sent();
                        return [4 /*yield*/, this.paymentTracker.generatePaymentLink(payment.id, primaryPaymentMethod)];
                    case 7:
                        // Generate payment links
                    ...
                    return [4 /*yield*/, this.createFinancialTransaction({
                            type: 'invoice',
                            invoiceId: invoice.id,
                            amount: invoice.totalAmount,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // Track payment
                        return [4 /*yield*/, this.paymentTracker.trackPayment(paymentData.invoiceId, {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.generateAlert({
    ...
    FinancialManagementSystem.prototype.getFinancialSummary = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            var period, invoiceAnalytics, paymentAnalytics, revenue, payments, gatewayFees, expenses, profitability, trends, summary, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        ...
                        period = {
                            startDate: (filters === null || filters === void 0 ? void 0 : filters.startDate) || new Date(new Date().getFullYear(), new Date().getMonth(), 1),
                            endDate: (filters === null || filters === void 0 ? void 0 : filters.endDate) || new Date()
                        };
                        return [4 /*yield*/, this.invoiceGenerator.getInvoiceAnalytics({
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.paymentTracker.getPaymentAnalytics({
                                startDate: period.startDate,
                                endDate: period.endDate,
                                clinicId: filters === null || filters === void 0 ? void 0 : filters.clinicId
                            })
                    ...
                    case 2:
                        ...
                        gatewayFees = Object.values(paymentAnalytics.byGateway)
                            .reduce(function (sum, gateway) { return sum + gateway.fees; }, 0);
                        expenses = {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        reportId = "report_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9));
                        reportData = void 0;
                        _a = reportConfig.type;
                        switch (_a) {
                            case 'revenue': return [3 /*break*/, 1];
                            case 'payments': return [3 /*break*/, 3];
                            case 'taxes': return [3 /*break*/, 5];
                            case 'reconciliation': return [3 /*break*/, 7];
                            case 'compliance': return [3 /*break*/, 9];
                        }
                        return [3 /*break*/, 11];
                    case 1: return [4 /*yield*/, this.generateRevenueReportData(reportConfig)];
                    case 2:
                        reportData = _c.sent();
                        return [3 /*break*/, 13];
                    case 3: return [4 /*yield*/, this.generatePaymentsReportData(reportConfig)];
                    case 4:
                        reportData = _c.sent();
                        return [3 /*break*/, 13];
                    case 5: return [4 /*yield*/, this.generateTaxReportData(reportConfig)];
                    case 6:
                        reportData = _c.sent();
                        return [3 /*break*/, 13];
                    case 7: return [4 /*yield*/, this.generateReconciliationReportData(reportConfig)];
                    case 8:
                        reportData = _c.sent();
                        return [3 /*break*/, 13];
                    case 9: return [4 /*yield*/, this.generateComplianceReportData(reportConfig)];
                    case 10:
                        reportData = _c.sent();
                        return [3 /*break*/, 13];
                    case 11: return [4 /*yield*/, this.generateCustomReportData(reportConfig)];
                    case 12:
                        reportData = _c.sent();
                        _c.label = 13;
                    case 13:
                        ...
                        // Store report
                        return [4 /*yield*/, this.storeFinancialReport(report)
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        alerts = (_a.sent()).data;
                        return [2 /*return*/, (alerts === null || alerts === void 0 ? void 0 : alerts.map(this.convertDbRecordToAlert)) || []];
                    case 2:
                        error_6 = _a.sent();
    ...
    FinancialManagementSystem.prototype.getSystemStatus = function () {
        return __awaiter(this, void 0, void 0, function () {
            var components, today, startOfDay, _a, invoiceAnalytics, paymentAnalytics, alerts, metrics, status_1, error_8;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        _a = _b.sent(), invoiceAnalytics = _a[0], paymentAnalytics = _a[1], alerts = _a[2];
                        metrics = {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.supabase
                    ...
                    .on('postgres_changes', { event: '*', schema: 'public', table: 'invoices' }, function (payload) { return _this.handleInvoiceUpdate(payload); })
                    .on('postgres_changes', { event: '*', schema: 'public', table: 'payment_records' }, function (payload) { return _this.handlePaymentUpdate(payload); })
                    .subscribe();
                return [2 /*return*/];
            });
        });
    ...
    FinancialManagementSystem.prototype.createFinancialTransaction = function (transaction) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transactionId = "transaction_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9));
                        return [4 /*yield*/, this.supabase
    ...
    FinancialManagementSystem.prototype.generateReportFile = function (report, includeCharts) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, "https://reports.example.com/".concat(report.id, ".").concat(report.format)];
            });
        });
    };
    // Event handlers
...
Object.defineProperty(exports, "CashFlowEngine", { enumerable: true, get: function () { return cash_flow_engine_1.CashFlowEngine; } });
var automated_alerts_engine_1 = require("./automated-alerts-engine");
Object.defineProperty(exports, "AutomatedAlertsEngine", { enumerable: true, get: function () { return automated_alerts_engine_1.AutomatedAlertsEngine; } });
var predictive_analytics_engine_1 = require("./predictive-analytics-engine");
Object.defineProperty(exports, "createpredictiveAnalyticsEngine", { enumerable: true, get: function () { return predictive_analytics_engine_1.createpredictiveAnalyticsEngine; } });
var financial_dashboard_engine_1 = require("./financial-dashboard-engine");
Object.defineProperty(exports, "FinancialDashboardEngine", { enumerable: true, get: function () { return financial_dashboard_engine_1.FinancialDashboardEngine; } });
