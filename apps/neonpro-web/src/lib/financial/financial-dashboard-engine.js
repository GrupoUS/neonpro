...
var FinancialDashboardEngine = /** @class */ (function () {
    ...
    FinancialDashboardEngine.prototype.getDashboardData = function (clinicId, config) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, cached, _a, cashFlow, metrics, alerts, forecasts, riskAssessment, performanceIndicators, trends, comparisons, recommendations, dashboardData, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), cashFlow = _a[0], metrics = _a[1], alerts = _a[2], forecasts = _a[3], riskAssessment = _a[4];
                        return [4 /*yield*/, this.calculatePerformanceIndicators(clinicId, metrics)
                            // Analyze trends
                        ];
                    case 2:
                        performanceIndicators = _b.sent();
                        return [4 /*yield*/, this.analyzeTrends(clinicId)
                            // Generate comparisons
                        ];
                    case 3:
                        trends = _b.sent();
                        return [4 /*yield*/, this.generateComparisons(clinicId, metrics)
                            // Generate recommendations
                        ];
                    case 4:
                        comparisons = _b.sent();
                        return [4 /*yield*/, this.generateRecommendations(clinicId, {
                                metrics: metrics,
                                alerts: alerts,
                    ...
                    case 5:
                        ...
                        dashboardData = {
                            ...
                            cash_flow: cashFlow,
                            metrics: metrics,
                            alerts: alerts.filter(function (alert) { return !alert.acknowledged_at; }), // Only unacknowledged alerts
                            forecasts: forecasts,
                        ...
                        // Cache the result
                        this.setCache(cacheKey, dashboardData, (config === null || config === void 0 ? void 0 : config.cache_duration) || 300); // 5 minutes default
    ...
    FinancialDashboardEngine.prototype.calculateFinancialMetrics = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var cashFlowMetrics, revenueData, expenseData, profitabilityMetrics, efficiencyMetrics, activityMetrics, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                        return [4 /*yield*/, this.cashFlowEngine.getCashFlowMetrics(clinicId)
                            // Get revenue data
                        ];
                    case 1:
                        cashFlowMetrics = _a.sent();
                        return [4 /*yield*/, this.getRevenueMetrics(clinicId)
                            // Get expense data
                        ];
                    case 2:
                        revenueData = _a.sent();
                        return [4 /*yield*/, this.getExpenseMetrics(clinicId)
                            // Calculate profitability metrics
                        ];
                    case 3:
                        expenseData = _a.sent();
                        profitabilityMetrics = this.calculateProfitabilityMetrics(revenueData, expenseData);
                        return [4 /*yield*/, this.calculateEfficiencyMetrics(clinicId, revenueData)
    ...
    FinancialDashboardEngine.prototype.generateDashboardForecasts = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var forecasts, revenueForecast, cashFlowForecast, currentRevenue, currentCashFlow, revenue30d, cashFlow30d, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        forecasts = [];
                        return [4 /*yield*/, this.predictiveEngine.generateFinancialForecast(clinicId, 'revenue_forecast', 3 // 3 months
                            )
                            // Generate cash flow forecast
                        ];
                    case 1:
                        revenueForecast = _a.sent();
                        return [4 /*yield*/, this.predictiveEngine.generateFinancialForecast(clinicId, 'cash_flow_prediction', 3 // 3 months
                            )
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.getCurrentCashFlow(clinicId)
                    ...
                    case 4:
                        ...
                        revenue30d = revenueForecast.predictions
                            .slice(0, 30)
                            .reduce(function (sum, p) { return sum + p.predicted_value; }, 0);
                        forecasts.push({
                            type: 'revenue',
                            period: '30d',
                            ...
                            trend: revenue30d > currentRevenue ? 'up' : revenue30d < currentRevenue ? 'down' : 'stable',
                        ...
                        forecasts.push({
                            ...
                            trend: cashFlow30d > currentCashFlow ? 'up' : cashFlow30d < currentCashFlow ? 'down' : 'stable',
    ...
    FinancialDashboardEngine.prototype.calculatePerformanceIndicators = function (clinicId, metrics) {
        return __awaiter(this, void 0, void 0, function () {
            var financialHealthScore, growthScore, efficiencyScore, riskScore, overallScore, benchmarks, analysis, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        ...
                        return [4 /*yield*/, this.calculateRiskScore(clinicId)
                            // Calculate overall score (weighted average)
                        ];
                    case 1:
                        riskScore = _a.sent();
                        overallScore = (financialHealthScore * 0.3 +
                            growthScore * 0.25 +
                            efficiencyScore * 0.25 +
                            (100 - riskScore) * 0.2 // Lower risk = higher score
                        );
                        return [4 /*yield*/, this.getIndustryBenchmarks(clinicId)
    ...
    FinancialDashboardEngine.prototype.analyzeTrends = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var historicalData, revenueTrend, expenseTrend, profitTrend, cashFlowTrend, patientVolumeTrend, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                ...
                try {
                    ...
                    if (analysisData.metrics.revenue_growth.monthly < 0.05) {
                        recommendations.push({
                            ...
                            description: 'Monthly revenue growth is below target. Consider implementing revenue optimization strategies.',
                            expected_impact: {
                    ...
                    if (analysisData.trends.cash_flow_trend.direction === 'down') {
                        recommendations.push({
                            ...
                            description: 'Cash flow trend is declining. Immediate action required to stabilize financial position.',
                            expected_impact: {
                    ...
                    if (analysisData.metrics.collection_efficiency < 0.9) {
                        recommendations.push({
                            ...
                            description: 'Collection efficiency is below optimal levels. Implement better collection processes.',
                            expected_impact: {
    ...
    FinancialDashboardEngine.prototype.calculateProfitabilityMetrics = function (revenueData, expenseData) {
    ...
    FinancialDashboardEngine.prototype.analyzeTrendComponent = function (data, field) {
        ...
        var recentAvg = recent.reduce(function (sum, val) { return sum + val; }, 0) / recent.length;
        var olderAvg = older.reduce(function (sum, val) { return sum + val; }, 0) / older.length;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = (_a.sent()).data;
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.reduce(function (sum, d) { return sum + d.total_inflows; }, 0)) || 0];
                }
            });
        });
    };
    FinancialDashboardEngine.prototype.getCurrentCashFlow = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cashFlowEngine.getCashFlowSummary(clinicId)];
                    case 1:
