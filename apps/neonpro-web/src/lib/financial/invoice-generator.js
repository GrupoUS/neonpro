...
var AutomatedInvoiceGenerator = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.loadInvoiceTemplates()
                    ...
                    case 3:
                        if (!(this.config.paymentIntegration.pixEnabled ||
                            ...
                            this.config.paymentIntegration.creditCardEnabled)) return [3 /*break*/, 5];
    ...
    AutomatedInvoiceGenerator.prototype.generateFromAppointment = function (appointmentId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var appointment, patient, clinic, services, template, taxCalculation, recipient, invoiceNumber, invoice, nfseResult, nfseError_1, error_2;
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 3:
                        ...
                        services = void 0;
                        if (!(options === null || options === void 0 ? void 0 : options.customServices)) return [3 /*break*/, 4];
                        services = options.customServices;
                        return [3 /*break*/, 7];
                    case 4:
                        if (!(options === null || options === void 0 ? void 0 : options.templateId)) return [3 /*break*/, 5];
                        ...
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.buildServicesFromAppointment(appointment)];
                    case 6:
                        services = _j.sent();
                        _j.label = 7;
                    case 7:
                        ...
                        recipient = {
                            ...
                            address: {
                                street: ((_a = patient.address) === null || _a === void 0 ? void 0 : _a.street) || '',
                                number: ((_b = patient.address) === null || _b === void 0 ? void 0 : _b.number) || '',
                                complement: (_c = patient.address) === null || _c === void 0 ? void 0 : _c.complement,
                                neighborhood: ((_d = patient.address) === null || _d === void 0 ? void 0 : _d.neighborhood) || '',
                                city: ((_e = patient.address) === null || _e === void 0 ? void 0 : _e.city) || '',
                                state: ((_f = patient.address) === null || _f === void 0 ? void 0 : _f.state) || '',
                                zipCode: ((_g = patient.address) === null || _g === void 0 ? void 0 : _g.zip_code) || '',
                                country: 'Brasil'
                            },
                            taxInfo: patient.taxInfo
                        };
                        return [4 /*yield*/, this.generateInvoiceNumber(clinic.id)
                            // Create invoice data
                        ];
                    case 8:
                        invoiceNumber = _j.sent();
                        invoice = {
                            id: "invoice_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                            number: invoiceNumber.number,
                            series: invoiceNumber.series,
                            issueDate: new Date(),
                            dueDate: (options === null || options === void 0 ? void 0 : options.dueDate) || this.calculateDueDate(),
                            recipient: recipient,
                            services: services,
                            paymentMethods: (options === null || options === void 0 ? void 0 : options.paymentMethod) ? [options.paymentMethod] : this.getDefaultPaymentMethods(),
                        ...
                        return [4 /*yield*/, this.storeInvoice(invoice)
                            // Generate NFSe if requested and enabled
                        ];
                    case 9:
                        // Store invoice in database
                        _j.sent();
                        if (!((options === null || options === void 0 ? void 0 : options.generateNFSe) !== false && this.config.nfseIntegration.enabled)) return [3 /*break*/, 15];
                        _j.label = 10;
                    case 10:
                    ...
                    case 11:
                        ...
                        invoice.nfseInfo = {
                            ...
                            serviceLocation: ((_h = clinic.address) === null || _h === void 0 ? void 0 : _h.city) || ''
                        };
    ...
    AutomatedInvoiceGenerator.prototype.generateFromTreatment = function (treatmentId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var treatment, invoices, installmentAmount, i, dueDate, installmentInvoice, singleInvoice, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 9, , 10]);
                    ...
                    case 1:
                        ...
                        invoices = [];
                        if (!((options === null || options === void 0 ? void 0 : options.installments) && options.installments > 1)) return [3 /*break*/, 6];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.generateInstallmentInvoice(treatment, i + 1, options.installments, installmentAmount, dueDate, options)];
                    case 3:
                    ...
                    case 6: return [4 /*yield*/, this.generateSingleTreatmentInvoice(treatment, options)];
                    case 7:
                        singleInvoice = _a.sent();
                        invoices.push(singleInvoice);
                        _a.label = 8;
                    case 8:
                        console.log("\u2705 Generated ".concat(invoices.length, " invoice(s) for treatment ").concat(treatmentId));
    ...
    AutomatedInvoiceGenerator.prototype.calculateTaxes = function (services, clinicTaxInfo) {
        var subtotal = services.reduce(function (sum, service) { return sum + service.totalPrice; }, 0);
        var issAmount = 0;
        var pisAmount = 0;
        var cofinsAmount = 0;
        var irAmount = 0;
        ...
        var taxableServices = services.filter(function (s) { return s.taxable; });
        var taxableAmount = taxableServices.reduce(function (sum, service) { return sum + service.totalPrice; }, 0);
        if (taxableAmount > 0) {
        ...
        var retentions = {
            issRetention: services.some(function (s) { return s.issRetention; }) ? issAmount : 0,
            irRetention: 0, // Would be calculated based on client type
            pisRetention: 0,
            cofinsRetention: 0,
            csllRetention: 0
        };
        var netAmount = subtotal - retentions.issRetention - retentions.irRetention -
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        clinic = _c.sent();
                        if (!((_a = clinic === null || clinic === void 0 ? void 0 : clinic.taxInfo) === null || _a === void 0 ? void 0 : _a.cnpj)) {
                        ...
                        nfseRequest = {
                            ...
                            servico: {
                                discriminacao: invoice.services.map(function (s) { return s.description; }).join('; '),
                                codigoServico: ((_b = invoice.services[0]) === null || _b === void 0 ? void 0 : _b.serviceCode) || '1.01', // Default to medical consultation
                                valorServicos: invoice.subtotal,
                                aliquota: clinic.taxInfo.aliquotaISS,
                                issRetido: invoice.services.some(function (s) { return s.issRetention; }),
                            ...
                            valores: {
                                ...
                                valorIssRetido: invoice.services.some(function (s) { return s.issRetention; }) ? invoice.taxAmount : 0,
                                outrasRetencoes: 0,
                    ...
                    case 3:
                        ...
                        _c.sent();
                        _c.label = 4;
                    case 4: return [2 /*return*/, nfseResponse];
                    case 5:
                        error_4 = _c.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        payment = {
                            id: "payment_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = method.type;
                        switch (_a) {
                            case 'pix': return [3 /*break*/, 2];
                            case 'boleto': return [3 /*break*/, 4];
                            case 'credit_card': return [3 /*break*/, 6];
                            case 'debit_card': return [3 /*break*/, 6];
                        }
                        return [3 /*break*/, 8];
                    case 2: return [4 /*yield*/, this.generatePixCode(invoice)];
                    case 3:
                        pixCode = _b.sent();
                        return [2 /*return*/, { pixCode: pixCode, expiresAt: expiresAt }];
                    case 4: return [4 /*yield*/, this.generateBoleto(invoice)];
                    case 5:
                        boletoUrl = _b.sent();
                        return [2 /*return*/, { boletoUrl: boletoUrl, expiresAt: expiresAt }];
                    case 6: return [4 /*yield*/, this.generateCardPaymentUrl(invoice, method)];
                    case 7:
                        paymentUrl = _b.sent();
                        return [2 /*return*/, { paymentUrl: paymentUrl, expiresAt: expiresAt }];
                    case 8: throw new Error('Unsupported payment method');
    ...
    AutomatedInvoiceGenerator.prototype.getInvoiceAnalytics = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            var query, invoices, totalInvoices, totalAmount, paidAmount, pendingAmount, overdueAmount, paymentMethods, paymentTimes, _i, invoices_1, invoice, payments, invoicePaidAmount, lastPayment, paymentTime, _a, payments_1, payment, averagePaymentTime, monthlyData, _b, invoices_2, invoice, month, monthlyTrends, error_7;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        totalAmount = invoices.reduce(function (sum, inv) { return sum + inv.total_amount; }, 0);
                        paidAmount = 0;
                        pendingAmount = 0;
                        overdueAmount = 0;
                        paymentMethods = {};
                        ...
                        for (_i = 0, invoices_1 = invoices; _i < invoices_1.length; _i++) {
                            ...
                            invoicePaidAmount = payments.reduce(function (sum, p) { return sum + p.amount; }, 0);
                            if (invoice.status === 'paid') {
                                paidAmount += invoice.total_amount;
                                lastPayment = payments[payments.length - 1];
                                if (lastPayment) {
                                    paymentTime = new Date(lastPayment.paid_at).getTime() - new Date(invoice.issue_date).getTime();
                        ...
                        averagePaymentTime = paymentTimes.length > 0
                            ? paymentTimes.reduce(function (sum, time) { return sum + time; }, 0) / paymentTimes.length
                            : 0;
                        monthlyData = {};
    ...
    AutomatedInvoiceGenerator.prototype.buildServicesFromTemplate = function (template, appointment) {
        return template.services.map(function (service, index) { return ({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        lastNumber = (lastInvoice === null || lastInvoice === void 0 ? void 0 : lastInvoice.number) ? parseInt(lastInvoice.number) : 0;
    ...
    AutomatedInvoiceGenerator.prototype.generateInstallmentInvoice = function (treatment, installmentNumber, totalInstallments, amount, dueDate, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    AutomatedInvoiceGenerator.prototype.generateSingleTreatmentInvoice = function (treatment, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            ...
                            issue_date: (_a = nfseResponse.issueDate) === null || _a === void 0 ? void 0 : _a.toISOString(),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, (payments === null || payments === void 0 ? void 0 : payments.reduce(function (sum, payment) { return sum + payment.amount; }, 0)) || 0];
                }
            });
        });
    };
