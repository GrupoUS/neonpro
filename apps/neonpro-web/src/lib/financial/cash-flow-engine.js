...
var CashFlowEngine = /** @class */ (function () {
    ...
    CashFlowEngine.prototype.calculateRealTimeCashFlow = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var today, previousDay, openingBalance, _a, inflows, outflows, netCashFlow, closingBalance, cashFlowData, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        openingBalance = (previousDay === null || previousDay === void 0 ? void 0 : previousDay.closing_balance) || 0;
    ...
    CashFlowEngine.prototype.getCashFlowSummary = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var today, yesterday_1, weekAgo_1, monthAgo, currentCashFlow, currentBalance, historicalData, yesterdayData, weekAgoData, monthAgoData, dailyChange, weeklyChange, monthlyChange, recentTrend, trendDirection, trendPercentage, avgDailyOutflow, runwayDays, projectedBalance7d, projectedBalance30d, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        yesterdayData = historicalData.find(function (d) { return d.date === yesterday_1.toISOString().split('T')[0]; });
                        weekAgoData = historicalData.find(function (d) { return d.date === weekAgo_1.toISOString().split('T')[0]; });
                        ...
                        avgDailyOutflow = historicalData.reduce(function (sum, d) { return sum + Math.abs(Math.min(d.net_cash_flow, 0)); }, 0) / historicalData.length;
                        runwayDays = avgDailyOutflow > 0 ? Math.floor(currentBalance / avgDailyOutflow) : Infinity;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        thresholds = (settings === null || settings === void 0 ? void 0 : settings.cash_flow_alerts) || {
                            low_balance: 10000,
                        ...
                        if (summary.current_balance < thresholds.low_balance) {
                            alerts.push({
                                ...
                                type: 'low_balance',
                                severity: summary.current_balance < thresholds.low_balance * 0.5 ? 'critical' : 'warning',
                                message: "Cash balance is below threshold: R$ ".concat(summary.current_balance.toLocaleString('pt-BR')),
                        ...
                        if (summary.trend_direction === 'down' && summary.trend_percentage > 10) {
                            alerts.push({
                                ...
                                message: "Negative cash flow trend detected: ".concat(summary.trend_percentage.toFixed(1), "% decline"),
                        ...
                        if (summary.cash_burn_rate > thresholds.high_burn_rate) {
                            alerts.push({
                                ...
                                type: 'high_burn_rate',
                                severity: 'warning',
                                message: "High cash burn rate: R$ ".concat(summary.cash_burn_rate.toLocaleString('pt-BR'), "/day"),
                        ...
                        if (summary.runway_days < thresholds.runway_warning_days && summary.runway_days !== Infinity) {
                            alerts.push({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        total = (payments === null || payments === void 0 ? void 0 : payments.reduce(function (sum, p) { return sum + p.amount; }, 0)) || 0;
                        operating = (payments === null || payments === void 0 ? void 0 : payments.filter(function (p) { return p.category === 'treatment' || p.category === 'product'; }).reduce(function (sum, p) { return sum + p.amount; }, 0)) || 0;
                        investing = (payments === null || payments === void 0 ? void 0 : payments.filter(function (p) { return p.category === 'investment'; }).reduce(function (sum, p) { return sum + p.amount; }, 0)) || 0;
                        financing = (payments === null || payments === void 0 ? void 0 : payments.filter(function (p) { return p.category === 'loan' || p.category === 'equity'; }).reduce(function (sum, p) { return sum + p.amount; }, 0)) || 0;
                        return [2 /*return*/, { total: total, operating: operating, investing: investing, financing: financing }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        total = (expenses === null || expenses === void 0 ? void 0 : expenses.reduce(function (sum, e) { return sum + e.amount; }, 0)) || 0;
                        operating = (expenses === null || expenses === void 0 ? void 0 : expenses.filter(function (e) { return e.category === 'operational' || e.category === 'staff'; }).reduce(function (sum, e) { return sum + e.amount; }, 0)) || 0;
                        investing = (expenses === null || expenses === void 0 ? void 0 : expenses.filter(function (e) { return e.category === 'equipment' || e.category === 'technology'; }).reduce(function (sum, e) { return sum + e.amount; }, 0)) || 0;
                        financing = (expenses === null || expenses === void 0 ? void 0 : expenses.filter(function (e) { return e.category === 'loan_payment' || e.category === 'interest'; }).reduce(function (sum, e) { return sum + e.amount; }, 0)) || 0;
                        return [2 /*return*/, { total: total, operating: operating, investing: investing, financing: financing }];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        avgDailyCashFlow = historicalData.reduce(function (sum, d) { return sum + d.net_cash_flow; }, 0) / historicalData.length;
                        return [4 /*yield*/, this.calculateRealTimeCashFlow(clinicId)];
                    case 2:
    ...
    CashFlowEngine.prototype.getCashFlowMetrics = function (clinicId_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, days) {
            var endDate, startDate, cashFlowData, dailyInflows, dailyOutflows, balances_1, dailyAverageInflow, dailyAverageOutflow, dailyChanges, avgDailyChange_1, variance, weeklyVolatility, firstBalance, lastBalance, monthlyGrowthRate, financialPosition, currentAssets, currentLiabilities, quickAssets, workingCapital, currentRatio, quickRatio, error_5;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        dailyInflows = cashFlowData.map(function (d) { return d.total_inflows; });
                        dailyOutflows = cashFlowData.map(function (d) { return d.total_outflows; });
                        balances_1 = cashFlowData.map(function (d) { return d.closing_balance; });
                        dailyAverageInflow = dailyInflows.reduce(function (sum, val) { return sum + val; }, 0) / dailyInflows.length;
                        dailyAverageOutflow = dailyOutflows.reduce(function (sum, val) { return sum + val; }, 0) / dailyOutflows.length;
                        dailyChanges = balances_1.slice(1).map(function (balance, i) { return balance - balances_1[i]; });
                        avgDailyChange_1 = dailyChanges.reduce(function (sum, val) { return sum + val; }, 0) / dailyChanges.length;
                        variance = dailyChanges.reduce(function (sum, val) { return sum + Math.pow(val - avgDailyChange_1, 2); }, 0) / dailyChanges.length;
                        ...
                        monthlyGrowthRate = firstBalance > 0 ? ((lastBalance - firstBalance) / firstBalance) * 100 : 0;
                        return [4 /*yield*/, this.supabase
                    ...
                    case 2:
                        ...
                        currentAssets = (financialPosition === null || financialPosition === void 0 ? void 0 : financialPosition.current_assets) || 0;
                        currentLiabilities = (financialPosition === null || financialPosition === void 0 ? void 0 : financialPosition.current_liabilities) || 0;
                        quickAssets = (financialPosition === null || financialPosition === void 0 ? void 0 : financialPosition.quick_assets) || 0;
