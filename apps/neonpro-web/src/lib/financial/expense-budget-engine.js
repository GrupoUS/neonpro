...
var ExpenseBudgetEngine = /** @class */ (function () {
    ...
    ExpenseBudgetEngine.prototype.categorizeExpenses = function (clinicId, expenseIds) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('auto_categorize_expenses', {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Expense categorization failed: ".concat(error.message));
                        return [2 /*return*/, {
    ...
    ExpenseBudgetEngine.prototype.getExpenseCategories = function (clinicId, dateRange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('get_expense_categories_with_budget', {
                            p_clinic_id: clinicId,
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, categoryData.map(function (category) { return ({
    ...
    ExpenseBudgetEngine.prototype.generateBudgetVarianceReport = function (clinicId_1, period_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, period, includeForecasting) {
            var dateRange, _a, categories, alerts, totalBudget, totalActual, totalVariance, variancePercent;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        totalBudget = categories.reduce(function (sum, cat) { return sum + cat.budgetAllocation; }, 0);
                        totalActual = categories.reduce(function (sum, cat) { return sum + cat.actualSpending; }, 0);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Failed to fetch budget alerts: ".concat(error.message));
                        return [2 /*return*/, alertData.map(function (alert) { return ({
                                alertId: alert.id,
     ...
     */
    ExpenseBudgetEngine.prototype.createBudgetAlert = function (clinicId, categoryId, alertType, currentAmount, threshold) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), alertData = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to create budget alert: ".concat(error.message));
    ...
    ExpenseBudgetEngine.prototype.analyzeExpenseTrends = function (clinicId_1, dateRange_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, dateRange, granularity) {
            ...
            if (granularity === void 0) { granularity = 'monthly'; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('analyze_expense_trends', {
                            p_clinic_id: clinicId,
                            p_start_date: dateRange.start.toISOString(),
                            p_end_date: dateRange.end.toISOString(),
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Expense trend analysis failed: ".concat(error.message));
                        return [2 /*return*/, trendData.map(function (trend) { return ({
                                period: trend.period,
    ...
    ExpenseBudgetEngine.prototype.generateCostOptimizationInsights = function (clinicId, dateRange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('generate_cost_optimization_insights', {
                            p_clinic_id: clinicId,
                            p_start_date: dateRange.start.toISOString(),
                            p_end_date: dateRange.end.toISOString()
                        })];
                    case 1:
                        ...
                        if (error)
                            throw new Error("Cost optimization analysis failed: ".concat(error.message));
                        return [2 /*return*/, insights.map(function (insight) { return ({
    ...
    ExpenseBudgetEngine.prototype.analyzeVendorExpenses = function (clinicId, dateRange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('analyze_vendor_expenses', {
                            p_clinic_id: clinicId,
                            p_start_date: dateRange.start.toISOString(),
                            p_end_date: dateRange.end.toISOString()
                        })];
                    case 1:
                        ...
                        if (error)
                            throw new Error("Vendor expense analysis failed: ".concat(error.message));
                        return [2 /*return*/, vendorData.map(function (vendor) { return ({
    ...
    ExpenseBudgetEngine.prototype.allocateCostsByCenter = function (clinicId, dateRange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('allocate_costs_by_center', {
                            p_clinic_id: clinicId,
                            p_start_date: dateRange.start.toISOString(),
                            p_end_date: dateRange.end.toISOString()
                        })];
                    case 1:
                        ...
                        if (error)
                            throw new Error("Cost center allocation failed: ".concat(error.message));
                        return [2 /*return*/, allocationData.map(function (center) { return ({
    ...
    ExpenseBudgetEngine.prototype.generateExpenseForecast = function (clinicId_1, categoryIds_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, categoryIds, forecastPeriods) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('generate_expense_forecast', {
                            p_clinic_id: clinicId,
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Expense forecasting failed: ".concat(error.message));
    ...
    ExpenseBudgetEngine.prototype.createBudgetPlan = function (clinicId_1, planYear_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, planYear, baselineType) {
            ...
            if (baselineType === void 0) { baselineType = 'growth_adjusted'; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.rpc('create_budget_plan', {
                            p_clinic_id: clinicId,
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Budget plan creation failed: ".concat(error.message));
     ...
     */
    ExpenseBudgetEngine.prototype.generateAlertMessage = function (alertType, currentAmount, threshold) {
        ...
        switch (alertType) {
            ...
            case 'critical':
                return "CRITICAL: Budget utilization at ".concat(percentage, "% - immediate attention required");
            case 'exceeded':
                return "EXCEEDED: Budget overrun by ".concat((currentAmount - threshold).toFixed(2), " (").concat(percentage, "% of threshold)");
            default:
                return "Budget alert: Current spending ".concat(currentAmount, " vs threshold ").concat(threshold);
        }
    };
