...
var PaymentTracker = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.setupGatewayIntegrations()
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.calculateFees(paymentData.amount, paymentData.method, paymentData.gateway)
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.initializeGatewayPayment(payment)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // Update in database
                        return [4 /*yield*/, this.updatePaymentRecord(payment)
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        webhook = {
                            id: "webhook_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                            gateway: gateway,
                        ...
                        return [4 /*yield*/, this.storeWebhookRecord(webhook)
                            // Process webhook
                        ];
                    case 3:
                        _b.sent();
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, this.updateWebhookRecord(__assign(__assign({}, webhookData), { processed: false, error: error_4.message }))];
                    case 9:
                        // Store error in webhook record
                        _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                        console.log("Starting payment reconciliation for ".concat(gateway, " on ").concat(date.toDateString()));
                        reconciliationId = "reconciliation_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9));
                        return [4 /*yield*/, this.getPaymentsByDate(gateway, date)
                            // Get payments from gateway
                        ];
                    case 1:
                        ourPayments = _a.sent();
                        return [4 /*yield*/, this.getGatewayPayments(gateway, date)
                    ...
                    case 2:
                        ...
                        reconciliation = {
                            ...
                            totalAmount: gatewayPayments.reduce(function (sum, p) { return sum + p.amount; }, 0),
                            reconciledTransactions: ourPayments.length - discrepancies_1.missingPayments.length,
                            reconciledAmount: ourPayments
                                .filter(function (p) { return !discrepancies_1.missingPayments.includes(p.id); })
                                .reduce(function (sum, p) { return sum + p.amount; }, 0),
                            discrepancies: discrepancies_1,
                            status: discrepancies_1.missingPayments.length > 0 ||
                                discrepancies_1.extraPayments.length > 0 ||
                                discrepancies_1.amountMismatches.length > 0 ? 'failed' : 'completed',
                            processedBy: 'system',
                            processedAt: new Date()
                        };
                        // Store reconciliation record
                        return [4 /*yield*/, this.storeReconciliationRecord(reconciliation)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 2];
                    case 5:
                        console.log("\u2705 Dunning processed for ".concat(overdueInvoices.length, " invoices"));
                        return [3 /*break*/, 7];
                    case 6:
                        error_7 = _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = payment.gateway;
                        switch (_a) {
                            case 'stripe': return [3 /*break*/, 1];
                            case 'pagarme': return [3 /*break*/, 3];
                            case 'mercadopago': return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 7];
                    case 1: return [4 /*yield*/, this.initializeStripePayment(payment)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 3: return [4 /*yield*/, this.initializePagarmePayment(payment)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 5: return [4 /*yield*/, this.initializeMercadoPagoPayment(payment)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 7: 
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            ...
                            nsu: payment.nsu,
                            tid: payment.tid,
                            processed_at: (_a = payment.metadata.processedAt) === null || _a === void 0 ? void 0 : _a.toISOString(),
                            confirmed_at: (_b = payment.metadata.confirmedAt) === null || _b === void 0 ? void 0 : _b.toISOString(),
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'failed': return [3 /*break*/, 3];
                            case 'refunded': return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 7];
                    case 1: return [4 /*yield*/, this.handlePaymentConfirmed(payment)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 3: return [4 /*yield*/, this.handlePaymentFailed(payment)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 5: return [4 /*yield*/, this.handlePaymentRefunded(payment)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 7: 
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, this.updateInvoicePaymentStatus(payment.invoiceId, 'paid')
                    ...
                    case 3: 
                    // Log audit trail
                    return [4 /*yield*/, this.logPaymentAudit(payment.id, 'payment_confirmed', 'Payment confirmed successfully')];
                    case 4:
                        // Log audit trail
                        _a.sent();
                        return [2 /*return*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2: 
                    // Log audit trail
                    return [4 /*yield*/, this.logPaymentAudit(payment.id, 'payment_failed', 'Payment failed')];
                    case 3:
                        // Log audit trail
                        _a.sent();
                        return [2 /*return*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // Update invoice status
                    return [4 /*yield*/, this.updateInvoicePaymentStatus(payment.invoiceId, 'refunded')
                        // Log audit trail
                    ];
                    case 1:
                        // Update invoice status
                        _a.sent();
                        // Log audit trail
                        return [4 /*yield*/, this.logPaymentAudit(payment.id, 'payment_refunded', 'Payment refunded')];
                    case 2:
                        // Log audit trail
                        _a.sent();
                        return [2 /*return*/];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            ...
                            processed_at: (_a = webhook.processedAt) === null || _a === void 0 ? void 0 : _a.toISOString(),
                            error: webhook.error
                        })];
                    case 1:
                        _b.sent();
    ...
    PaymentTracker.prototype.mapGatewayStatusToPaymentStatus = function (gateway, gatewayStatus) {
        ...
        return statusMap[gatewayStatus === null || gatewayStatus === void 0 ? void 0 : gatewayStatus.toLowerCase()] || 'pending';
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = (_a.sent()).data;
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.map(this.convertDbRecordToPaymentRecord)) || []];
                }
            });
        });
    };
    ...
    PaymentTracker.prototype.findPaymentDiscrepancies = function (ourPayments, gatewayPayments) {
        ...
        var _loop_1 = function (ourPayment) {
            var gatewayPayment = gatewayPayments.find(function (gp) {
                return gp.transaction_id === ourPayment.transactionId ||
                    gp.id === ourPayment.gatewayTransactionId;
            });
            if (!gatewayPayment) {
                missingPayments.push(ourPayment.id);
            }
            else if (Math.abs(gatewayPayment.amount - ourPayment.amount) > this_1.config.reconciliation.toleranceAmount) {
        ...
        var _loop_2 = function (gatewayPayment) {
            var ourPayment = ourPayments.find(function (op) {
                return op.transactionId === gatewayPayment.transaction_id ||
        ...
        return { missingPayments: missingPayments, extraPayments: extraPayments, amountMismatches: amountMismatches };
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        console.warn("Reconciliation discrepancies found for ".concat(reconciliation.gateway, ":"), reconciliation.discrepancies);
                        return [2 /*return*/];
                }
            });
        });
    ...
    PaymentTracker.prototype.calculatePaymentAnalytics = function (payments, filters) {
        var period = {
            startDate: (filters === null || filters === void 0 ? void 0 : filters.startDate) || new Date(Math.min.apply(Math, payments.map(function (p) { return new Date(p.created_at).getTime(); }))),
            endDate: (filters === null || filters === void 0 ? void 0 : filters.endDate) || new Date(Math.max.apply(Math, payments.map(function (p) { return new Date(p.created_at).getTime(); })))
        };
        var totalPayments = payments.length;
        var totalAmount = payments.reduce(function (sum, p) { return sum + p.amount; }, 0);
        var confirmedPayments = payments.filter(function (p) { return p.status === 'confirmed'; });
        var refundedPayments = payments.filter(function (p) { return p.status === 'refunded'; });
        var summary = {
        ...
        for (var _i = 0, _a = Object.entries(methodGroups); _i < _a.length; _i++) {
            var _b = _a[_i], method = _b[0], methodPayments = _b[1];
            var confirmed = methodPayments.filter(function (p) { return p.status === 'confirmed'; });
            byMethod[method] = {
                count: methodPayments.length,
                amount: methodPayments.reduce(function (sum, p) { return sum + p.amount; }, 0),
        ...
        for (var _c = 0, _d = Object.entries(gatewayGroups); _c < _d.length; _c++) {
            var _e = _d[_c], gateway = _e[0], gatewayPayments = _e[1];
            var confirmed = gatewayPayments.filter(function (p) { return p.status === 'confirmed'; });
            byGateway[gateway] = {
                count: gatewayPayments.length,
                amount: gatewayPayments.reduce(function (sum, p) { return sum + p.amount; }, 0),
                fees: gatewayPayments.reduce(function (sum, p) { return sum + (JSON.parse(p.fees || '{}').total || 0); }, 0),
        ...
        var failedPayments = payments.filter(function (p) { return p.status === 'failed'; });
    ...
    PaymentTracker.prototype.calculateAverageProcessingTime = function (payments) {
        var processingTimes = payments
            .filter(function (p) { return p.processed_at && p.created_at; })
            .map(function (p) { return new Date(p.processed_at).getTime() - new Date(p.created_at).getTime(); });
        return processingTimes.length > 0
            ? processingTimes.reduce(function (sum, time) { return sum + time; }, 0) / processingTimes.length / 1000 // Convert to seconds
            : 0;
    };
    ...
    PaymentTracker.prototype.processDunningForInvoice = function (invoice) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        daysPastDue = Math.floor((new Date().getTime() - new Date(invoice.due_date).getTime()) / (1000 * 60 * 60 * 24));
                        stage = this.config.dunning.stages.find(function (s) {
                            var _a;
                            return daysPastDue >= s.daysAfterDue &&
                                daysPastDue < (((_a = _this.config.dunning.stages[_this.config.dunning.stages.indexOf(s) + 1]) === null || _a === void 0 ? void 0 : _a.daysAfterDue) || Infinity);
                        });
    ...
    PaymentTracker.prototype.executeDunningAction = function (invoice, stage) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        console.log("Executing dunning action: ".concat(stage.action, " for invoice ").concat(invoice.number));
                        _a = stage.action;
                        switch (_a) {
                            case 'email': return [3 /*break*/, 1];
                            case 'sms': return [3 /*break*/, 3];
                            case 'whatsapp': return [3 /*break*/, 5];
                            case 'call': return [3 /*break*/, 7];
                            case 'letter': return [3 /*break*/, 9];
                        }
                        return [3 /*break*/, 11];
                    case 1: return [4 /*yield*/, this.sendDunningEmail(invoice, stage.template)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 3: return [4 /*yield*/, this.sendDunningSMS(invoice, stage.template)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 5: return [4 /*yield*/, this.sendDunningWhatsApp(invoice, stage.template)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 7: return [4 /*yield*/, this.scheduleDunningCall(invoice)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, this.generateDunningLetter(invoice)];
                    case 10:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 11: 
    ...
    PaymentTracker.prototype.sendDunningEmail = function (invoice, template) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log("Sending dunning email for invoice ".concat(invoice.number, " using template ").concat(template));
                return [2 /*return*/];
            });
        });
    };
    PaymentTracker.prototype.sendDunningSMS = function (invoice, template) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log("Sending dunning SMS for invoice ".concat(invoice.number, " using template ").concat(template));
                return [2 /*return*/];
            });
        });
    };
    PaymentTracker.prototype.sendDunningWhatsApp = function (invoice, template) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log("Sending dunning WhatsApp for invoice ".concat(invoice.number, " using template ").concat(template));
                return [2 /*return*/];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = (_a.sent()).data;
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.map(function (record) { return ({
