      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) throw new Error("Failed to create report schedule: ".concat(error.message));
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) throw new Error("Failed to fetch due reports: ".concat(error.message));
            processed = 0;
            failed = 0;
  ...
  ReportAutomationEngine.prototype.generateAndDeliverReport = function (schedule) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.generateReport(schedule.report_type, schedule.parameters)];
          case 1:
            reportData = _a.sent();
            return [
              4 /*yield*/,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) throw new Error("Failed to create report template: ".concat(error.message));
  ...
  ReportAutomationEngine.prototype.getReportTemplates = function (clinicId, reportType) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            query = this.supabase.from("report_templates").select("*").eq("clinic_id", clinicId);
            if (reportType) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [3 /*break*/, 9];
          case 1:
            return [4 /*yield*/, this.exportToPDF(reportData, options)];
          case 2:
            exportResult = _b.sent();
            return [3 /*break*/, 10];
          case 3:
            return [4 /*yield*/, this.exportToExcel(reportData, options)];
          case 4:
            exportResult = _b.sent();
            return [3 /*break*/, 10];
          case 5:
            return [4 /*yield*/, this.exportToCSV(reportData, options)];
          case 6:
            exportResult = _b.sent();
            return [3 /*break*/, 10];
          case 7:
            return [4 /*yield*/, this.exportToJSON(reportData, options)];
          case 8:
            exportResult = _b.sent();
            return [3 /*break*/, 10];
          case 9:
            throw new Error("Unsupported export format: ".concat(options.format));
          case 10:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("generate_pdf_report", {
          ...
          case 1:
            ...
            if (error) throw new Error("PDF generation failed: ".concat(error.message));
            return [
              2 /*return*/,
              {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("generate_excel_report", {
                report_data: reportData,
                include_charts: options.includeCharts,
          ...
          case 1:
            ...
            if (error) throw new Error("Excel generation failed: ".concat(error.message));
            return [
              2 /*return*/,
              {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("generate_csv_report", {
                report_data: reportData,
                include_raw_data: options.includeRawData,
              }),
            ];
          case 1:
            ...
            if (error) throw new Error("CSV generation failed: ".concat(error.message));
            return [
              2 /*return*/,
              {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("generate_json_report", {
                report_data: reportData,
              }),
            ];
          case 1:
            (_a = _b.sent()), (jsonResult = _a.data), (error = _a.error);
            if (error) throw new Error("JSON generation failed: ".concat(error.message));
            return [
              2 /*return*/,
              {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) throw new Error("Failed to create report delivery: ".concat(error.message));
            if (!(delivery.deliveryMethod === "email")) return [3 /*break*/, 3];
            return [
              4 /*yield*/,
              this.sendReportEmail(deliveryData.id, delivery.recipients, delivery.filePath),
            ];
          case 2:
            _b.sent();
            _b.label = 3;
          case 3:
            return [2 /*return*/, deliveryData.id];
        }
      });
    });
  };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.rpc("send_report_email", {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) throw new Error("Failed to archive report: ".concat(error.message));
  ...
  ReportAutomationEngine.prototype.getArchivedReports = function (clinicId, reportType, dateRange) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            query = this.supabase.from("report_archives").select("*").eq("clinic_id", clinicId);
            if (reportType) {
              query = query.eq("report_type", reportType);
            }
            if (dateRange) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("generate_report_data", {
          ...
          case 1:
            ...
            if (error) throw new Error("Report generation failed: ".concat(error.message));
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("compress_file", {
                file_path: fileResult.filePath,
              }),
            ];
          case 1:
            (_a = _b.sent()), (compressedResult = _a.data), (error = _a.error);
            if (error) throw new Error("File compression failed: ".concat(error.message));
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("password_protect_file", {
                file_path: fileResult.filePath,
                password: password,
              }),
            ];
          case 1:
            ...
            if (error) throw new Error("Password protection failed: ".concat(error.message));
