      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.createDefaultAlertRules(clinicId),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 4:
            ...
            return [3 /*break*/, 2];
          case 5:
            return [4 /*yield*/, this.detectFinancialAnomalies(clinicId)];
          case 6:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.getFinancialDataForRule(clinicId, rule),
              // Evaluate conditions
            ];
          case 3:
            currentData = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            historicalData = _a.sent().data; // Last 90 days
            ...
            for (
              _i = 0, cashFlowAnomalies_1 = cashFlowAnomalies;
              _i < cashFlowAnomalies_1.length;
              _i++
            ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.sendAlert(alert, alertRule),
  ...
  AutomatedAlertsEngine.prototype.formatAlertForChannel = function (alert, channel) {
    ...
    switch (channel) {
      case "email":
        return "\n          <h2>"
          .concat(emoji, " ")
          .concat(alert.title, "</h2>\n          <p><strong>Severity:</strong> ")
          .concat(alert.severity.toUpperCase(), "</p>\n          <p><strong>Time:</strong> ")
          .concat(new Date(alert.triggered_at).toLocaleString("pt-BR"), "</p>\n          <p>")
          .concat(alert.message, "</p>\n          \n          ")
          .concat(
            alert.threshold_value
              ? "<p><strong>Threshold:</strong> R$ ".concat(
                  alert.threshold_value.toLocaleString("pt-BR"),
                  "</p>",
                )
              : "",
            "\n          <p><strong>Current Value:</strong> R$ ",
          )
          .concat(alert.current_value.toLocaleString("pt-BR"), "</p>\n          \n          ")
          .concat(
      ...
      case "sms":
        return ""
          .concat(emoji, " ")
          .concat(alert.title, ": R$ ")
          .concat(alert.current_value.toLocaleString("pt-BR"), ". ")
          .concat(alert.message.substring(0, 100), "...");
      case "whatsapp":
        return ""
          .concat(baseMessage, "\n\n\uD83D\uDCB0 *Current Value:* R$ ")
          .concat(alert.current_value.toLocaleString("pt-BR"), "\n\u23F0 *Time:* ")
          .concat(new Date(alert.triggered_at).toLocaleString("pt-BR"));
      default:
        return baseMessage;
    }
  };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            defaultRules = [
              ...
              },
              {
                ...
                conditions: [
                  { field: "trend_percentage", operator: "gt", value: 15, timeframe: "7d" },
                ],
                severity: "critical",
                enabled: true,
              ...
              },
              {
                ...
                conditions: [
                  { field: "revenue_change", operator: "lt", value: -20, timeframe: "30d" },
                ],
                severity: "warning",
                enabled: true,
                channels: ["email", "in_app"],
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("financial_alert_rules").upsert(
                __assign(__assign({}, rule), {
                  id: "".concat(clinicId, "_").concat(rule.alert_type),
                  clinic_id: clinicId,
                  recipients: [
                    {
                      user_id: "admin",
