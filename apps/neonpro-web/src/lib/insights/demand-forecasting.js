...
var DemandForecastingEngine = /** @class */ (() => {
  ...
  DemandForecastingEngine.prototype.generateForecast = function (options) {
    ...
    var _a = options.periods,
      periods = _a === void 0 ? exports.FORECASTING_CONSTANTS.DEFAULT_PERIODS : _a,
      _b = options.confidence_level,
      confidence_level = _b === void 0 ? exports.FORECASTING_CONSTANTS.DEFAULT_CONFIDENCE : _b,
      _c = options.include_seasonality,
      include_seasonality = _c === void 0 ? true : _c,
    ...
    if (data.length < exports.FORECASTING_CONSTANTS.MIN_HISTORICAL_DATA) {
      throw new Error(
        "Insufficient historical data. Need at least ".concat(
          exports.FORECASTING_CONSTANTS.MIN_HISTORICAL_DATA,
          " data points.",
        ),
      );
    }
