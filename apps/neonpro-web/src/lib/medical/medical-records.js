...
exports.medicalRecordsManager =
  exports.MedicalRecordsManager =
  exports.AttachmentCategory =
  exports.RecordStatus =
  exports.MedicalRecordType =
    void 0;
...
var MedicalRecordsManager = /** @class */ (() => {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.lgpdManager.checkConsent(recordData.patient_id, "medical_data"),
            ];
          case 1:
            ...
            newRecord = __assign(__assign({}, recordData), {
              id: recordId,
              created_at: now,
              updated_at: now,
              version: 1,
            ...
            return [
              4 /*yield*/,
              this.supabase.from("medical_records").insert(newRecord).select().single(),
            ];
          case 2:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            now = new Date().toISOString();
            updatedRecord = __assign(__assign({}, updates), {
              updated_at: now,
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.createRecordVersion(currentRecord.data, userId),
              // Log audit event
            ];
          case 3:
            // Create version history
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            sortBy =
              (options === null || options === void 0 ? void 0 : options.sortBy) || "created_at";
            sortOrder =
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.lgpdManager.checkConsent(historyData.patient_id, "medical_data"),
            ];
          case 1:
            consentCheck = _b.sent();
            if (!consentCheck.hasConsent) {
            ...
            now = new Date().toISOString();
            newHistory = __assign(__assign({}, historyData), {
              id: historyId,
              created_at: now,
              updated_at: now,
            });
            return [
              4 /*yield*/,
              this.supabase.from("medical_histories").insert(newHistory).select().single(),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 3, , 4]);
            now = new Date().toISOString();
            updatedHistory = __assign(__assign({}, updates), {
              updated_at: now,
  ...
  // ========================================================================
  MedicalRecordsManager.prototype.uploadMedicalAttachment = function (
    file,
    recordId,
    category,
    userId,
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.storage.from("medical-files").upload(filePath, file),
            ];
          case 1:
            (_a = _c.sent()), (uploadData = _a.data), (uploadError = _a.error);
            if (uploadError) throw uploadError;
            urlData = this.supabase.storage.from("medical-files").getPublicUrl(filePath).data;
            thumbnailUrl = void 0;
          ...
          case 3:
            attachment = {
              ...
              version: 1,
              is_before_after:
                (options === null || options === void 0 ? void 0 : options.isBeforeAfter) || false,
              before_after_pair_id:
                options === null || options === void 0 ? void 0 : options.beforeAfterPairId,
            };
            return [
              4 /*yield*/,
              this.supabase.from("medical_attachments").insert(attachment).select().single(),
            ];
          case 4:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("medical_attachments").select("*").eq("id", attachmentId).single(),
            ];
          case 1:
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("medical_attachments").delete().eq("id", attachmentId),
            ];
          case 3:
            error = _b.sent().error;
            if (error) throw error;
  ...
  // DIGITAL SIGNATURE
  // ========================================================================
  MedicalRecordsManager.prototype.signMedicalRecord = function (
    recordId,
    signerId,
    signerName,
    signerRole,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3]);
            versionData = __assign(__assign({}, record), {
              id: crypto_1.default.randomUUID(),
              original_record_id: record.id,
              version_created_at: new Date().toISOString(),
              version_created_by: userId,
            });
            return [4 /*yield*/, this.supabase.from("medical_record_versions").insert(versionData)];
          case 1:
            _a.sent();
            return [3 /*break*/, 3];
          case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        try {
          ...
          data = this.supabase.storage.from("medical-files").getPublicUrl(thumbnailPath).data;
  ...
  // ========================================================================
  MedicalRecordsManager.prototype.searchMedicalRecords = function (
    query,
    clinicId,
    userId,
    filters,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [4 /*yield*/, dbQuery.order("created_at", { ascending: false }).limit(50)];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
            // Log audit event
