...
var DigitalSignatureManager = /** @class */ (() => {
  ...
  // SIGNATURE CREATION
  // ========================================================================
  DigitalSignatureManager.prototype.signDocument = function (
    documentId,
    signerId,
    signerName,
    signerEmail,
        ...
        switch (_c.label) {
          ...
          case 1:
            ...
            if (!documentHash) {
              return [
                2 /*return*/,
                { success: false, error: "Document not found or inaccessible" },
              ];
            }
          ...
          case 3:
            return [
              4 /*yield*/,
              this.createCertificateSignature(
                documentHash,
          ...
          case 4:
            ...
            return [3 /*break*/, 12];
          case 5:
            return [4 /*yield*/, this.createElectronicSignature(documentHash, signerId, timestamp)];
          case 6:
          ...
          case 7:
            return [
              4 /*yield*/,
              this.createBiometricSignature(documentHash, options.biometricData),
            ];
          case 8:
            signatureData = _c.sent();
            return [3 /*break*/, 12];
          case 9:
            return [
              4 /*yield*/,
              this.createPinSignature(documentHash, signerId, options.pin, timestamp),
            ];
          case 10:
            signatureData = _c.sent();
            return [3 /*break*/, 12];
          case 11:
            return [2 /*return*/, { success: false, error: "Unsupported signature type" }];
          case 12:
            metadata = {
              device_info: {
            ...
            return [
              4 /*yield*/,
              this.supabase.from("digital_signatures").insert(signature).select().single(),
            ];
          case 13:
            ...
            return [
              4 /*yield*/,
              this.updateDocumentSignatureStatus(documentId),
              // Log audit event
            ];
          case 14:
            // Update document status
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("digital_signatures").select("*").eq("id", signatureId).single(),
            ];
          case 1:
  ...
  // SIGNATURE REQUESTS
  // ========================================================================
  DigitalSignatureManager.prototype.createSignatureRequest = function (
    documentId,
    requesterId,
    requiredSigners,
    signatureOrder,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("signature_requests").insert(request).select().single(),
            ];
          case 1:
            ...
            return [
              4 /*yield*/,
              this.sendSignatureNotifications(request),
              // Log audit event
            ];
          case 2:
            // Send notifications to signers
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("signature_requests").select("*").eq("id", requestId).single(),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
  ...
  DigitalSignatureManager.prototype.updateSignatureRequestStatus = function (
    requestId,
    signerId,
    action,
    signatureId,
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            if (newStatus === RequestStatus.COMPLETED) {
              ...
              updateData.cancellation_reason = "Declined by "
                .concat(signerId, ": ")
                .concat(declineReason);
            }
            return [
              4 /*yield*/,
              this.supabase.from("signature_requests").update(updateData).eq("id", requestId),
            ];
          case 2:
            error = _a.sent().error;
            if (error) throw error;
  ...
  // ========================================================================
  DigitalSignatureManager.prototype.createCertificateSignature = function (
    documentHash,
    certificatePath,
    privateKeyPath,
    pin,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        try {
          ...
          thumbprint = crypto_1.default.createHash("sha1").update(certificate).digest("hex");
          return [
            2 /*return*/,
            { signature: signature, certificate: certificate, thumbprint: thumbprint },
          ];
        } catch (error) {
  ...
  DigitalSignatureManager.prototype.createElectronicSignature = function (
    documentHash,
    signerId,
    timestamp,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        try {
          ...
          return [
            2 /*return*/,
            crypto_1.default.createHash("sha256").update(signatureData).digest("base64"),
          ];
        } catch (error) {
  ...
  DigitalSignatureManager.prototype.createBiometricSignature = function (
    documentHash,
    biometricData,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  DigitalSignatureManager.prototype.createPinSignature = function (
    documentHash,
    signerId,
    pin,
    timestamp,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            if (
              !((_a = signature.metadata) === null || _a === void 0 ? void 0 : _a.biometric_data)
            ) {
              return [2 /*return*/, false];
            }
            return [
              4 /*yield*/,
              this.createBiometricSignature(
                signature.document_hash,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              (data === null || data === void 0 ? void 0 : data.checksum) || null,
            ];
          case 2:
            error_8 = _b.sent();
      ...
      return __generator(this, (_b) => {
        try {
          ...
          for (_i = 0, _a = request.required_signers; _i < _a.length; _i++) {
            signer = _a[_i];
            console.log(
              "Sending signature notification to "
                .concat(signer.email, " for request ")
                .concat(request.id),
            );
