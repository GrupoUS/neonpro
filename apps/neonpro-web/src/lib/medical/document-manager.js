...
exports.medicalDocumentManager = exports.MedicalDocumentManager = exports.AccessLevel = exports.DocumentCategory = exports.DocumentType = void 0;
...
var MedicalDocumentManager = /** @class */ (function () {
    ...
    // ========================================================================
    MedicalDocumentManager.prototype.uploadDocument = function (file, patientId, clinicId, options, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var validation, consentCheck, documentId, fileExtension, fileName, filePath, checksum, duplicateCheck, _a, uploadData, uploadError, urlData, metadata, thumbnailUrl, documentType, document_1, _b, data, error, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        filePath = "".concat(clinicId, "/").concat(patientId, "/").concat(options.category, "/").concat(fileName);
                        return [4 /*yield*/, this.calculateChecksum(file)
                    ...
                    case 4:
                        ...
                        if (duplicateCheck.isDuplicate) {
                            return [2 /*return*/, {
                                    success: false,
                                    error: "Duplicate file detected. Original uploaded: ".concat(duplicateCheck.originalDate)
                                }];
                        }
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.extractMetadata(file)
                            // Generate thumbnail if needed
                        ];
                    case 6:
                        metadata = _c.sent();
                        thumbnailUrl = void 0;
                        if (!(options.generateThumbnail && file.type.startsWith('image/'))) return [3 /*break*/, 8];
                    ...
                    case 11:
                        if (!(options.beforeAfterPairId &&
                            (options.category === DocumentCategory.BEFORE_PHOTO ||
                                options.category === DocumentCategory.AFTER_PHOTO))) return [3 /*break*/, 13];
                        return [4 /*yield*/, this.handleBeforeAfterPairing(documentId, options.beforeAfterPairId, options.category)];
                    case 12:
                        _c.sent();
                        _c.label = 13;
                    case 13: 
    ...
    MedicalDocumentManager.prototype.getPatientDocuments = function (patientId, userId, filters, pagination) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if ((filters === null || filters === void 0 ? void 0 : filters.hasExpiration) !== undefined) {
    ...
    // ========================================================================
    MedicalDocumentManager.prototype.createBeforeAfterPair = function (patientId, clinicId, procedureName, procedureDate, beforePhotoId, afterPhotoId, userId, notes) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // DOCUMENT VERSIONING
    // ========================================================================
    MedicalDocumentManager.prototype.createDocumentVersion = function (documentId, newFile, changesDescription, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var currentDoc, document_3, versionId, fileExtension, fileName, filePath, _a, uploadData, uploadError, urlData, checksum, version, _b, data, error, error_8;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 7, , 8]);
                    ...
                    case 1:
                        ...
                        filePath = "".concat(document_3.clinic_id, "/").concat(document_3.patient_id, "/versions/").concat(fileName);
                        return [4 /*yield*/, this.supabase.storage
                                .from(this.STORAGE_BUCKET)
                    ...
                    case 2:
                        ...
                        urlData = this.supabase.storage
                            .from(this.STORAGE_BUCKET)
                            .getPublicUrl(filePath).data;
                        return [4 /*yield*/, this.calculateChecksum(newFile)
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (file.size > this.MAX_FILE_SIZE) {
                    return [2 /*return*/, {
                            isValid: false,
                            error: "File size exceeds maximum allowed size of ".concat(this.MAX_FILE_SIZE / 1024 / 1024, "MB")
                        }];
                }
                // Check MIME type
    ...
    MedicalDocumentManager.prototype.handleBeforeAfterPairing = function (documentId, pairId, category) {
        return __awaiter(this, void 0, void 0, function () {
            var error_11;
            return __generator(this, function (_a) {
                switch (_a.label) {
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        dbQuery = this.supabase
                            ...
                            .eq('is_active', true)
                            .or("title.ilike.%".concat(query, "%,description.ilike.%").concat(query, "%,original_file_name.ilike.%").concat(query, "%"));
                        // Apply filters
                        if (filters === null || filters === void 0 ? void 0 : filters.documentType) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        data === null || data === void 0 ? void 0 : data.forEach(function (doc) {
                            stats_1.total_size += doc.file_size;
                            // Count by type
                            stats_1.by_type[doc.document_type] =
                                (stats_1.by_type[doc.document_type] || 0) + 1;
                            // Count by category
                            stats_1.by_category[doc.category] =
                                (stats_1.by_category[doc.category] || 0) + 1;
                            // Count by month
                            var month = new Date(doc.uploaded_at).toISOString().slice(0, 7);
                            stats_1.by_month[month] = (stats_1.by_month[month] || 0) + 1;
                        });
                        stats_1.average_size = stats_1.total_documents > 0 ?
                            stats_1.total_size / stats_1.total_documents : 0;
