...
var mockSupabase = {
    from: vitest_1.vi.fn(function () { return ({
        ...
        insert: vitest_1.vi.fn(function () { return ({
            select: vitest_1.vi.fn(function () { return ({
                single: vitest_1.vi.fn(function () { return ({
                    data: null,
                    error: null
                }); })
            }); })
        ...
        delete: vitest_1.vi.fn(function () { return ({
            eq: vitest_1.vi.fn(function () { return ({
                data: null,
                error: null
            }); })
    ...
    storage: {
        from: vitest_1.vi.fn(function () { return ({
            upload: vitest_1.vi.fn(function () { return ({
                data: { path: 'test-path' },
                error: null
            }); }),
            download: vitest_1.vi.fn(function () { return ({
                data: new Blob(['test']),
                error: null
            }); }),
            remove: vitest_1.vi.fn(function () { return ({
                data: null,
                error: null
            }); })
        }); })
...
// Mock dependencies
vitest_1.vi.mock('@/lib/supabase', function () { return ({
    supabase: mockSupabase
}); });
vitest_1.vi.mock('@/lib/audit/audit-logger', function () { return ({
    AuditLogger: {
        log: vitest_1.vi.fn()
    }
}); });
vitest_1.vi.mock('@/lib/lgpd/lgpd-manager', function () { return ({
    LGPDManager: {
...
(0, vitest_1.describe)('MedicalRecordsManager', function () {
    ...
    (0, vitest_1.describe)('Medical Records', function () {
        ...
        (0, vitest_1.describe)('createMedicalRecord', function () {
            (0, vitest_1.it)('should create a medical record successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            (0, vitest_1.it)('should handle creation errors', function () { return __awaiter(void 0, void 0, void 0, function () {
                var createData, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        (0, vitest_1.describe)('getMedicalRecord', function () {
            (0, vitest_1.it)('should retrieve a medical record by id', function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            (0, vitest_1.it)('should handle record not found', function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        (0, vitest_1.describe)('updateMedicalRecord', function () {
            (0, vitest_1.it)('should update a medical record successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            updatedRecord = __assign(__assign(__assign({}, mockMedicalRecord), updateData), { version: 2 });
                            mockSupabase.from().update().eq().select().single.mockResolvedValueOnce({
                                data: updatedRecord,
                                error: null
                            });
                            return [4 /*yield*/, manager.updateMedicalRecord('record-1', updateData, mockUserId)];
                        case 1:
                            result = _c.sent();
                            (0, vitest_1.expect)(result.success).toBe(true);
                            (0, vitest_1.expect)((_a = result.data) === null || _a === void 0 ? void 0 : _a.title).toBe('Título Atualizado');
                            (0, vitest_1.expect)((_b = result.data) === null || _b === void 0 ? void 0 : _b.version).toBe(2);
                            return [2 /*return*/];
                    }
                });
            }); });
            (0, vitest_1.it)('should handle update errors', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.describe)('deleteMedicalRecord', function () {
            (0, vitest_1.it)('should soft delete a medical record', function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            result = _a.sent();
                            (0, vitest_1.expect)(result.success).toBe(true);
                            (0, vitest_1.expect)(mockSupabase.from().update).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ isDeleted: true }));
                            return [2 /*return*/];
                    }
                });
            }); });
        ...
        (0, vitest_1.describe)('getPatientMedicalRecords', function () {
            (0, vitest_1.it)('should retrieve all medical records for a patient', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            (0, vitest_1.expect)(mockSupabase.from().select().eq).toHaveBeenCalledWith('patient_id', mockPatientId);
                            return [2 /*return*/];
                    }
                });
            }); });
            (0, vitest_1.it)('should filter by type when specified', function () { return __awaiter(void 0, void 0, void 0, function () {
                var mockRecords, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    (0, vitest_1.describe)('Medical History', function () {
        ...
        (0, vitest_1.describe)('createMedicalHistory', function () {
            (0, vitest_1.it)('should create medical history successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
                var createData, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            (0, vitest_1.it)('should validate required fields for medical history', function () { return __awaiter(void 0, void 0, void 0, function () {
                var invalidData, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        (0, vitest_1.describe)('getMedicalHistory', function () {
            (0, vitest_1.it)('should retrieve medical history by id', function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        (0, vitest_1.describe)('getPatientMedicalHistory', function () {
            (0, vitest_1.it)('should retrieve all medical history for a patient', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            (0, vitest_1.it)('should filter by category when specified', function () { return __awaiter(void 0, void 0, void 0, function () {
                var mockHistories, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    (0, vitest_1.describe)('Attachments', function () {
        ...
        (0, vitest_1.describe)('uploadAttachment', function () {
            (0, vitest_1.it)('should upload attachment successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
                var mockFile, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, manager.uploadAttachment('record-1', mockFile, {
                                    category: 'document',
                                    subcategory: 'report',
                                    description: 'Test document',
                                    tags: ['test']
                        ...
                        case 1:
                            ...
                            (0, vitest_1.expect)(mockSupabase.storage.from).toHaveBeenCalledWith('medical-attachments');
                            return [2 /*return*/];
                    }
                });
            }); });
            (0, vitest_1.it)('should handle upload errors', function () { return __awaiter(void 0, void 0, void 0, function () {
                var mockFile, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            (0, vitest_1.it)('should validate file size', function () { return __awaiter(void 0, void 0, void 0, function () {
                var largeFile, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            largeFile = new File(['x'.repeat(11 * 1024 * 1024)], 'large.pdf', { type: 'application/pdf' });
                            return [4 /*yield*/, manager.uploadAttachment('record-1', largeFile, {
                                    category: 'document',
            ...
            (0, vitest_1.it)('should validate file type', function () { return __awaiter(void 0, void 0, void 0, function () {
                var invalidFile, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            invalidFile = new File(['test'], 'test.exe', { type: 'application/x-executable' });
                            return [4 /*yield*/, manager.uploadAttachment('record-1', invalidFile, {
                                    category: 'document',
        ...
        (0, vitest_1.describe)('getAttachment', function () {
            (0, vitest_1.it)('should retrieve attachment by id', function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        (0, vitest_1.describe)('downloadAttachment', function () {
            (0, vitest_1.it)('should download attachment successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
                var mockBlob, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            (0, vitest_1.it)('should handle download errors', function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        (0, vitest_1.describe)('deleteAttachment', function () {
            (0, vitest_1.it)('should delete attachment successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    (0, vitest_1.describe)('Search and Analytics', function () {
        (0, vitest_1.describe)('searchMedicalRecords', function () {
            (0, vitest_1.it)('should search medical records by query', function () { return __awaiter(void 0, void 0, void 0, function () {
                var mockRecords, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, manager.searchMedicalRecords({
                                    query: 'consulta',
                                    patientId: mockPatientId
                                })];
                        case 1:
            ...
            (0, vitest_1.it)('should handle search with filters', function () { return __awaiter(void 0, void 0, void 0, function () {
                var mockRecords, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        (0, vitest_1.describe)('getPatientSummary', function () {
            (0, vitest_1.it)('should generate patient summary', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.describe)('Utility Methods', function () {
        (0, vitest_1.describe)('generateThumbnail', function () {
            (0, vitest_1.it)('should generate thumbnail for image files', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            mockCanvas = {
                                getContext: vitest_1.vi.fn(function () { return ({
                                    drawImage: vitest_1.vi.fn(),
                                    canvas: {
                                        toBlob: vitest_1.vi.fn(function (callback) { return callback(new Blob(['thumbnail'], { type: 'image/jpeg' })); })
                                    }
                                }); }),
                                width: 0,
                                height: 0
                            };
                            global.HTMLCanvasElement = vitest_1.vi.fn(function () { return mockCanvas; });
                            global.Image = vitest_1.vi.fn(function () { return ({
                                onload: null,
                                onerror: null,
                                src: ''
                            }); });
            ...
            (0, vitest_1.it)('should return null for non-image files', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.describe)('Error Handling', function () {
        (0, vitest_1.it)('should handle database connection errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, vitest_1.it)('should handle invalid input data', function () { return __awaiter(void 0, void 0, void 0, function () {
            var invalidData, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, vitest_1.it)('should handle missing user ID', function () { return __awaiter(void 0, void 0, void 0, function () {
            var createData, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, vitest_1.describe)('Integration Tests', function () {
        (0, vitest_1.it)('should create record with attachment workflow', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        mockRecord = __assign(__assign({ id: 'record-1' }, createData), { status: 'active', attachments: [], createdAt: new Date(), updatedAt: new Date(), createdBy: mockUserId, version: 1, isDeleted: false });
                        mockSupabase.from().insert().select().single.mockResolvedValueOnce({
                            data: mockRecord,
                            error: null
                        });
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, manager.uploadAttachment('record-1', mockFile, { category: 'document' }, mockUserId)];
                    case 2:
                        attachmentResult = _b.sent();
                        (0, vitest_1.expect)(attachmentResult.success).toBe(true);
                        (0, vitest_1.expect)((_a = attachmentResult.data) === null || _a === void 0 ? void 0 : _a.recordId).toBe('record-1');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, vitest_1.it)('should handle complete patient data retrieval', function () { return __awaiter(void 0, void 0, void 0, function () {
