...
exports.consentFormsManager =
  exports.ConsentFormsManager =
  exports.LogicAction =
  exports.LogicCondition =
  exports.ValidationType =
  exports.LegalBasisType =
  exports.DataCategory =
  exports.FieldType =
  exports.ConsentMethod =
  exports.ConsentFormType =
    void 0;
...
var ConsentFormsManager = /** @class */ (() => {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            form = __assign(__assign({}, formData), {
              id: formId,
              clinic_id: clinicId,
              created_at: now,
              updated_at: now,
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("consent_forms").insert(form).select().single(),
            ];
          case 2:
    ...
    return __awaiter(this, arguments, void 0, function (clinicId, formType, activeOnly) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            query = this.supabase.from("consent_forms").select("*").eq("clinic_id", clinicId);
            if (activeOnly) {
  ...
  // ========================================================================
  ConsentFormsManager.prototype.submitConsentResponse = function (
    formId,
    patientId,
    responses,
    consentMethod,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("consent_responses").insert(consentResponse).select().single(),
            ];
          case 3:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
            if (
              !(
                (options === null || options === void 0 ? void 0 : options.requireSignature) &&
                consentGiven
              )
            )
              return [3 /*break*/, 6];
            return [
              4 /*yield*/,
              this.signatureManager.signDocument(
                responseId, // Use response ID as document ID
                patientId,
                "Patient Consent - ".concat(form.title),
                ...
                digital_signature_1.SignerRole.PATIENT,
                {
                  ...
                  includeGeolocation: !!(options === null || options === void 0
                    ? void 0
                    : options.geolocation),
                },
              ),
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              this.updateLGPDConsent(patientId, form, responses, consentGiven),
              // Log audit event
            ];
          case 7:
            // Update LGPD consent records
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.lgpdManager.withdrawConsent(patientId, "medical_data", reason),
              // Log audit event
            ];
          case 2:
            // Update LGPD records
  ...
  ConsentFormsManager.prototype.getFormTemplate = function (templateType, language) {
    ...
    switch (templateType) {
      case ConsentFormType.TREATMENT_CONSENT:
        return __assign(__assign({}, baseTemplate), {
        ...
        try {
          ...
          for (_i = 0, _a = form.fields; _i < _a.length; _i++) {
            ...
            if (!field.name || !field.label || !field.type) {
              return [
                2 /*return*/,
                { isValid: false, error: "Invalid field structure: ".concat(field.id) },
              ];
            }
          }
          ...
          if (!form.legal_basis || form.legal_basis.length === 0) {
            return [
              2 /*return*/,
              { isValid: false, error: "At least one legal basis is required" },
            ];
          }
      ...
      switch (field.type) {
        ...
        case FieldType.PHONE: {
          ...
          if (value && !phoneRegex.test(value.replace(/\s/g, ""))) {
            return {
              isValid: false,
              error: "".concat(field.label, " must be a valid phone number"),
            };
          }
          break;
        }
        case FieldType.NUMBER:
          ...
          if (validation.min_value !== undefined && Number(value) < validation.min_value) {
            return {
              isValid: false,
              error: "".concat(field.label, " must be at least ").concat(validation.min_value),
            };
          }
          if (validation.max_value !== undefined && Number(value) > validation.max_value) {
            return {
              isValid: false,
              error: "".concat(field.label, " must be at most ").concat(validation.max_value),
            };
          }
          break;
        case FieldType.TEXT:
        case FieldType.TEXTAREA:
          if (validation.min_length && value.length < validation.min_length) {
            return {
              isValid: false,
              error: ""
                .concat(field.label, " must be at least ")
                .concat(validation.min_length, " characters"),
            };
          }
          if (validation.max_length && value.length > validation.max_length) {
            return {
              isValid: false,
              error: ""
                .concat(field.label, " must be at most ")
                .concat(validation.max_length, " characters"),
            };
          }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4 /*yield*/, this.supabase.from("consent_form_versions").insert(version)];
          case 1:
            _a.sent();
            return [3 /*break*/, 3];
          case 2:
  ...
  ConsentFormsManager.prototype.updateLGPDConsent = function (
    patientId,
    form,
    responses,
    consentGiven,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.lgpdManager.recordConsent(
                patientId,
                category,
                ((_a = form.legal_basis[0]) === null || _a === void 0 ? void 0 : _a.purpose) ||
                  "Medical services",
