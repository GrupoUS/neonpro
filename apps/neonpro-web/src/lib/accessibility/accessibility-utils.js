...
exports.SkipLinks = exports.FormA11y = exports.HealthcareA11y = exports.ColorContrast = exports.KeyboardNavigation = exports.AriaAttributes = exports.FocusManager = exports.KEYBOARD_KEYS = exports.WCAG_CONTRAST_RATIOS = void 0;
...
var FocusManager = /** @class */ (function () {
    ...
    FocusManager.trapFocus = function (containerRef) {
        ...
        var focusableElements = container.querySelectorAll('a[href], button:not([disabled]), textarea:not([disabled]), input[type="text"]:not([disabled]), input[type="radio"]:not([disabled]), input[type="checkbox"]:not([disabled]), select:not([disabled]), [tabindex]:not([tabindex="-1"])');
...
exports.AriaAttributes = {
     ...
     */
    modal: function (titleId, descriptionId) { return (__assign({ role: 'dialog', 'aria-modal': true, 'aria-labelledby': titleId }, (descriptionId && { 'aria-describedby': descriptionId }))); },
    /**
...
exports.ColorContrast = {
    ...
    meetsWCAG: function (foreground, background, level) {
        if (level === void 0) { level = 'NORMAL_TEXT'; }
...
exports.HealthcareA11y = {
    ...
    announceAppointmentStatus: function (patientName, appointmentTime, status) {
        var message = "Compromiso de ".concat(patientName, " \u00E0s ").concat(appointmentTime, " atualizado para ").concat(status);
    ...
    appointmentAriaLabel: function (patientName, service, date, time, status) {
        return "Consulta de ".concat(patientName, ", ").concat(service, ", ").concat(date, " \u00E0s ").concat(time, ", status ").concat(status);
    },
    /**
    ...
    enhanceForm: function (formElement) {
        ...
        fields.forEach(function (field) {
            ...
            if (fieldId) {
                ...
                var describedBy = [];
                if (errorElement && ((_a = errorElement.textContent) === null || _a === void 0 ? void 0 : _a.trim())) {
