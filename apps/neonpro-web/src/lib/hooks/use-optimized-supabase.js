...
function useOptimizedSupabase(options) {
    var _this = this;
    var clinicId = options.clinicId, _a = options.operationType, operationType = _a === void 0 ? 'standard' : _a, _b = options.autoRetry, autoRetry = _b === void 0 ? true : _b, _c = options.healthMonitoring, healthMonitoring = _c === void 0 ? true : _c;
    ...
    var _g = (0, react_1.useState)(null), healthStatus = _g[0], setHealthStatus = _g[1];
    var _h = (0, react_1.useState)(null), metrics = _h[0], setMetrics = _h[1];
    var poolManager = (0, react_1.useMemo)(function () { return (0, connection_pool_manager_1.getConnectionPoolManager)(); }, []);
    ...
    var checkConnection = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var testError, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (testError && testError.code !== 'PGRST116') { // Ignore "no rows" error
    ...
    var scheduleRetry = (0, react_1.useCallback)(function () {
    ...
    var updateHealthMetrics = (0, react_1.useCallback)(function () {
        if (!healthMonitoring)
            return;
        var analytics = poolManager.getPoolAnalytics();
        var poolKey = "healthcare_".concat(clinicId, "_").concat(operationType);
        var poolData = analytics.pools.find(function (p) { return p.poolKey === poolKey; });
        if (poolData) {
...
function useOptimizedServerSupabase(clinicId) {
    ...
    var poolManager = (0, react_1.useMemo)(function () { return (0, connection_pool_manager_1.getConnectionPoolManager)(); }, []);
    (0, react_1.useEffect)(function () {
        var initializeServerClient = function () { return __awaiter(_this, void 0, void 0, function () {
...
function useHealthcareCompliantSupabase(clinicId, operationType) {
    var _this = this;
    if (operationType === void 0) { operationType = 'standard'; }
    ...
    var complianceStatus = (0, react_1.useMemo)(function () {
        ...
        return {
            ...
            overallCompliant: baseHook.healthStatus.compliance.lgpdCompliant &&
    ...
    var executeHealthcareQuery = (0, react_1.useCallback)(function (queryFn, auditInfo) { return __awaiter(_this, void 0, void 0, function () {
        var auditHeaders, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!baseHook.client || !(complianceStatus === null || complianceStatus === void 0 ? void 0 : complianceStatus.overallCompliant)) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, queryFn(baseHook.client)
    ...
    return __assign(__assign({}, baseHook), { complianceStatus: complianceStatus, executeHealthcareQuery: executeHealthcareQuery });
}
/**
...
function usePoolAnalytics() {
    ...
    var _b = (0, react_1.useState)(true), isLoading = _b[0], setIsLoading = _b[1];
    var poolManager = (0, react_1.useMemo)(function () { return (0, connection_pool_manager_1.getConnectionPoolManager)(); }, []);
    var refreshAnalytics = (0, react_1.useCallback)(function () {
        try {
            setIsLoading(true);
...
function useCriticalHealthcareSupabase(clinicId) {
    ...
    var _a = (0, react_1.useState)([]), operationHistory = _a[0], setOperationHistory = _a[1];
    var executeCriticalOperation = (0, react_1.useCallback)(function (queryFn, auditInfo) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    setOperationHistory(function (prev) { return __spreadArray(__spreadArray([], prev, true), [{
                            timestamp: new Date(),
                            action: auditInfo.action,
                            success: success,
                            responseTime: responseTime_1
                        }], false).slice(-100); }); // Keep last 100 operations
                    return [7 /*endfinally*/];
                case 4: return [2 /*return*/];
            }
        });
    }); }, [baseHook]);
    return __assign(__assign({}, baseHook), { executeCriticalOperation: executeCriticalOperation, operationHistory: operationHistory });
}
