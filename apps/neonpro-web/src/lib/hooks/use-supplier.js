          ...
          return __generator(this, function (_e) {
            switch (_e.label) {
              case 0:
                ...
                // Apply filters
                if (
                  (_b = filters === null || filters === void 0 ? void 0 : filters.status) ===
                    null || _b === void 0
                    ? void 0
                    : _b.length
                ) {
                ...
                if (
                  (_d = filters === null || filters === void 0 ? void 0 : filters.riskLevel) ===
                    null || _d === void 0
                    ? void 0
                    : _d.length
                ) {
                ...
                if (filters === null || filters === void 0 ? void 0 : filters.search) {
                  query = query.or(
                    "name.ilike.%"
                      .concat(filters.search, "%,legal_name.ilike.%")
            ...
            case 0:
              return [
                ...
                supabase
                  .from("suppliers")
                  .insert(
                    __assign(__assign({}, supplierData), {
            ...
            case 0:
              return [
                ...
                supabase
                  .from("suppliers")
                  .update(
                    __assign(__assign({}, supplierData), { updated_at: new Date().toISOString() }),
                  )
                  .eq("id", id)
                  .select()
                  .single(),
          ...
          return __generator(this, function (_e) {
            switch (_e.label) {
              case 0:
                ...
                if (
                  (_c = filters === null || filters === void 0 ? void 0 : filters.severity) ===
                    null || _c === void 0
                    ? void 0
                    : _c.length
                ) {
                ...
                if (
                  (_d = filters === null || filters === void 0 ? void 0 : filters.type) === null ||
                  _d === void 0
                    ? void 0
                    : _d.length
                ) {
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                supabase.from("quality_issues").update(updates).eq("id", issueId).select().single(),
              ];
            case 1:
              (_c = _d.sent()), (data = _c.data), (error = _c.error);
              if (error) throw error;
          ...
          return __generator(this, function (_d) {
            switch (_d.label) {
              case 0:
                ...
                if (
                  (_c = filters === null || filters === void 0 ? void 0 : filters.type) === null ||
                  _c === void 0
                    ? void 0
                    : _c.length
                ) {
            ...
            case 0:
              return [
                ...
                supabase
                  .from("supplier_communications")
                  .insert(
                    __assign(__assign({}, communicationData), {
...
function useSupplierSearch() {
  ...
  var _b = (0, react_1.useState)([]),
    selectedCategories = _b[0],
    setSelectedCategories = _b[1];
  var _c = (0, react_1.useState)([]),
    selectedStatuses = _c[0],
    setSelectedStatuses = _c[1];
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                return [
                  4 /*yield*/,
                  supabase.from("suppliers").select("status, category, risk_level"),
                ];
              case 2:
