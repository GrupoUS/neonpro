...
var DataExportService = /** @class */ (() => {
  ...
  DataExportService.exportUserData = function (request) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        ...
        return [2 /*return*/, Buffer.from(JSON.stringify(data))];
      });
    });
  };
...
function generateDataExport(request) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, (_a) => [2 /*return*/, DataExportService.exportUserData(request)]);
  });
}
