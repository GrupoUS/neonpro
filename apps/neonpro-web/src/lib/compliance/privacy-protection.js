...
var PrivacyProtectionManager = /** @class */ (() => {
   ...
   */
  PrivacyProtectionManager.prototype.createPrivacyProfile = function (
    patientId,
    initialConsent,
    preferences,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            consentRecord = __assign(
              { id: "consent_".concat(patientId, "_").concat(Date.now()), patientId: patientId },
              initialConsent,
            );
            defaultPreferences = {
              patientId: patientId,
          ...
          case 3:
            ...
            logger_1.logger.info(
              "Privacy profile created successfully for patient ".concat(patientId),
            );
            return [2 /*return*/, privacyProfile];
          case 4:
            error_2 = _b.sent();
            logger_1.logger.error(
              "Failed to create privacy profile for patient ".concat(patientId, ":"),
              error_2,
            );
            throw error_2;
          case 5:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            error_3 = _a.sent();
            logger_1.logger.error(
              "Failed to record consent for patient ".concat(patientId, ":"),
              error_3,
            );
            throw error_3;
          case 5:
   ...
   */
  PrivacyProtectionManager.prototype.withdrawConsent = function (
    patientId,
    consentId,
    withdrawalReason,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.processConsentWithdrawal(patientId, consent, withdrawalReason),
            ];
          case 3:
            // Process withdrawal implications
            _a.sent();
            logger_1.logger.info(
              "Consent withdrawn for patient ".concat(patientId, ", consent ").concat(consentId),
            );
            return [3 /*break*/, 5];
          case 4:
            error_4 = _a.sent();
            logger_1.logger.error(
              "Failed to withdraw consent for patient ".concat(patientId, ":"),
              error_4,
            );
            throw error_4;
          case 5:
   ...
   */
  PrivacyProtectionManager.prototype.processDataSubjectRightRequest = function (
    patientId,
    requestType,
    requestDetails,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            _a.sent();
            logger_1.logger.info(
              "Data subject right request processed for patient "
                .concat(patientId, ": ")
                .concat(requestType),
            );
          ...
          case 4:
            error_5 = _a.sent();
            logger_1.logger.error(
              "Failed to process data subject right request for patient ".concat(patientId, ":"),
              error_5,
            );
            throw error_5;
          case 5:
   ...
   */
  PrivacyProtectionManager.prototype.anonymizePatientData = function (
    patientId_1,
    anonymizationLevel_1,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            profile.anonymizationStatus = __assign(__assign({}, profile.anonymizationStatus), {
              anonymizationLevel: anonymizationLevel,
              anonymizationDate: new Date().toISOString(),
              anonymizationMethod: method,
              reversibilityStatus:
                anonymizationLevel === "pseudonymized" ? "reversible" : "irreversible",
            });
          ...
          case 2:
            _a.sent();
            logger_1.logger.info(
              "Patient data anonymized for "
                .concat(patientId, " using ")
                .concat(method, " at level ")
                .concat(anonymizationLevel),
            );
            return [2 /*return*/, profile.anonymizationStatus];
          case 3:
            error_6 = _a.sent();
            logger_1.logger.error(
              "Failed to anonymize patient data for ".concat(patientId, ":"),
              error_6,
            );
            throw error_6;
          case 4:
   ...
   */
  PrivacyProtectionManager.prototype.generatePrivacyComplianceReport = function (
    patientId,
    regulations,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 6:
            report = ((_a.nextActions = _b.sent()), _a);
  ...
  PrivacyProtectionManager.prototype.processConsentWithdrawal = function (
    patientId,
    consent,
    reason,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [3 /*break*/, 13];
          case 1:
            return [4 /*yield*/, this.fulfillAccessRequest(request, profile)];
          case 2:
            _b.sent();
            return [3 /*break*/, 13];
          case 3:
            return [4 /*yield*/, this.fulfillPortabilityRequest(request, profile)];
          case 4:
            _b.sent();
            return [3 /*break*/, 13];
          case 5:
            return [4 /*yield*/, this.fulfillRectificationRequest(request, profile)];
          case 6:
            _b.sent();
            return [3 /*break*/, 13];
          case 7:
            return [4 /*yield*/, this.fulfillErasureRequest(request, profile)];
          case 8:
            _b.sent();
            return [3 /*break*/, 13];
          case 9:
            return [4 /*yield*/, this.fulfillRestrictionRequest(request, profile)];
          case 10:
            _b.sent();
            return [3 /*break*/, 13];
          case 11:
            return [4 /*yield*/, this.fulfillObjectionRequest(request, profile)];
          case 12:
            _b.sent();
            return [3 /*break*/, 13];
          case 13:
  ...
  PrivacyProtectionManager.prototype.loadPrivacyProfiles = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("patient_privacy_profiles").select("*")];
          case 1:
            data = _a.sent().data;
            if (data) {
              data.forEach((record) => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("patient_privacy_profiles").upsert({
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("privacy_compliance_reports").insert({
                id: report.id,
...
exports.ConsentValidationSchema = zod_1.z.object({
  ...
  purposes: zod_1.z
    ...
    .min(1),
  dataCategories: zod_1.z
    .array(zod_1.z.enum(["personal", "sensitive", "medical", "biometric", "genetic", "anonymous"]))
    .min(1),
