...
exports.createauditTrailManager = exports.AuditEventType = exports.LGPDAuditTrailService = exports.LGPDAuditTrail = exports.AuditEventValidationSchema = exports.AuditTrailManager = void 0;
...
var AuditTrailManager = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 6, , 7]);
                        _a = { id: "audit_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)), timestamp: new Date().toISOString(), severity: eventData.severity || 'info', userRole: eventData.userRole || 'unknown', sessionId: eventData.sessionId || 'unknown', ipAddress: eventData.ipAddress || 'unknown', userAgent: eventData.userAgent || 'unknown', metadata: __assign({ applicationName: 'NeonPro', applicationVersion: '1.0.0', moduleId: 'compliance_system', functionName: 'audit_trail', requestId: "req_".concat(Date.now()), correlationId: "corr_".concat(Date.now()), childEventIds: [], tags: [], customData: {} }, eventData.metadata) };
                    ...
                    case 2:
                        auditEntry = __assign.apply(void 0, [(_a.riskAssessment = _b.sent(), _a.retention = this.generateRetentionInfo(eventData), _a), eventData]);
                        // Add to buffer
    ...
    AuditTrailManager.prototype.queryAuditTrail = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var queryBuilder, sortBy, sortOrder, limit, offset, _a, data, error, count, entries, totalCount, hasMore, error_3;
            var _this = this;
            var _b, _c, _d, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        if (query.searchText) {
                            queryBuilder = queryBuilder.or("description.ilike.%".concat(query.searchText, "%,action.ilike.%").concat(query.searchText, "%"));
                        }
                    ...
                    case 1:
                        ...
                        entries = (data === null || data === void 0 ? void 0 : data.map(function (row) { return _this.mapRowToAuditEntry(row); })) || [];
                        totalCount = count || 0;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 6, , 7]);
                        logger_1.logger.info("Generating ".concat(reportType, " audit report for ").concat(timeRange.startDate, " to ").concat(timeRange.endDate));
                    ...
                    case 1:
                        ...
                        _a = {
                            ...
                            timeRange: timeRange,
                            scope: {
                                includedCategories: (scope === null || scope === void 0 ? void 0 : scope.includedCategories) || Object.values(this.getAuditCategories()),
                                includedUsers: (scope === null || scope === void 0 ? void 0 : scope.includedUsers) || [],
                                includedResources: (scope === null || scope === void 0 ? void 0 : scope.includedResources) || [],
                                excludedPatterns: (scope === null || scope === void 0 ? void 0 : scope.excludedPatterns) || [],
                                filterCriteria: (scope === null || scope === void 0 ? void 0 : scope.filterCriteria) || {}
                            },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        filteredResults = regulations ?
                            validationResults.filter(function (result) {
                                return regulations.some(function (reg) { return result.ruleName.includes(reg); });
                            }) : validationResults;
                        _a = {
                            totalValidations: filteredResults.length,
                            passedValidations: filteredResults.filter(function (r) { return r.validationStatus === 'passed'; }).length,
                            failedValidations: filteredResults.filter(function (r) { return r.validationStatus === 'failed'; }).length,
                            warningValidations: filteredResults.filter(function (r) { return r.validationStatus === 'warning'; }).length,
                            complianceRate: filteredResults.length > 0 ?
                                (filteredResults.filter(function (r) { return r.validationStatus === 'passed'; }).length / filteredResults.length) * 100 : 0,
                    ...
                    case 2:
                        summary = (_a.recommendations = _b.sent(),
                            _a);
    ...
    AuditTrailManager.prototype.startComplianceMonitoring = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.on('auditEvent', function (entry) { return __awaiter(_this, void 0, void 0, function () {
                    var violations;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        violatedRules = validationResults
                            .filter(function (r) { return r.validationStatus === 'failed'; })
                            .map(function (r) { return r.ruleId; });
                        return [2 /*return*/, {
                                applicableRegulations: applicableRegulations,
                                complianceStatus: violatedRules.length > 0 ? 'non_compliant' : 'compliant',
                                complianceRules: complianceRules.map(function (r) { return r.id; }),
    ...
    AuditTrailManager.prototype.checkImmediateCompliance = function (entry) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(entry.complianceContext.complianceStatus === 'non_compliant')) return [3 /*break*/, 2];
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('audit_trail')
                                .insert(entries.map(function (entry) { return _this.mapAuditEntryToRow(entry); }))];
                    case 2:
                        error = (_b.sent()).error;
                        if (error) {
    ...
    AuditTrailManager.prototype.getComplianceRules = function (eventData) {
        return Array.from(this.complianceRules.values()).filter(function (rule) {
            return rule.applicableCategories.includes(eventData.category || 'system_security') &&
    ...
    AuditTrailManager.prototype.validateRule = function (eventData, rule) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.executeRuleValidation(eventData, rule)];
                    case 1:
                        isValid = _a.sent();
                        return [2 /*return*/, {
                                ruleId: rule.id,
    ...
    AuditTrailManager.prototype.assessImpact = function (eventData, riskLevel) {
        var baseImpact = riskLevel === 'critical' ? 'high' :
    ...
    AuditTrailManager.prototype.triggerImmediateResponse = function (entry, violations) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.logger.error("Critical compliance violation detected: ".concat(violations.join(', ')));
                // Emit critical event
    ...
    AuditTrailManager.prototype.generateAuditFindings = function (entries) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                findings = [];
                nonCompliantEvents = entries.filter(function (e) { return e.complianceContext.complianceStatus === 'non_compliant'; });
                if (nonCompliantEvents.length > 0) {
                    findings.push({
                        ...
                        evidence: nonCompliantEvents.map(function (e) { return e.id; }),
                        relatedEvents: nonCompliantEvents.map(function (e) { return e.id; }),
                        impactAssessment: {
                            patientSafety: 'low',
                            dataPrivacy: 'medium',
                            systemSecurity: 'low',
    ...
    AuditTrailManager.prototype.generateRiskMetrics = function (entries) {
        return {
            ...
            highRiskEvents: entries.filter(function (e) { return e.riskAssessment.riskLevel === 'high'; }).length,
            criticalRiskEvents: entries.filter(function (e) { return e.riskAssessment.riskLevel === 'critical'; }).length,
    ...
    AuditTrailManager.prototype.calculateComplianceRate = function (entries) {
        if (entries.length === 0)
            return 100;
        var compliantEntries = entries.filter(function (e) { return e.complianceContext.complianceStatus === 'compliant'; });
        return (compliantEntries.length / entries.length) * 100;
    };
    AuditTrailManager.prototype.calculateRiskDistribution = function (entries) {
        return this.groupByField(entries.map(function (e) { return ({ riskLevel: e.riskAssessment.riskLevel }); }), 'riskLevel');
    };
    AuditTrailManager.prototype.getTopUsers = function (entries) {
        var userActivity = new Map();
        entries.forEach(function (entry) {
            var existing = userActivity.get(entry.userId) || { count: 0, riskScore: 0, lastActivity: entry.timestamp };
    ...
    AuditTrailManager.prototype.getTopResources = function (entries) {
        ...
        return Array.from(resourceActivity.entries()).map(function (_a) {
            var resourceId = _a[0], activity = _a[1];
            return ({
    ...
    AuditTrailManager.prototype.calculateViolationsSummary = function (entries) {
        var violations = entries.filter(function (e) { return e.complianceContext.complianceStatus === 'non_compliant'; });
        return {
    ...
    AuditTrailManager.prototype.calculateOverallRiskScore = function (entries) {
        if (entries.length === 0)
            return 0;
        var totalRisk = entries.reduce(function (sum, entry) { return sum + entry.riskAssessment.riskScore; }, 0);
...
exports.AuditEventValidationSchema = zod_1.z.object({
    eventType: zod_1.z.enum(['access', 'modification', 'deletion', 'creation', 'authentication', 'authorization', 'compliance_check', 'data_export', 'system_event']),
    category: zod_1.z.enum(['patient_data', 'medical_records', 'system_security', 'user_activity', 'compliance_validation', 'data_processing']),
...
var createauditTrailManager = function () { return new AuditTrailManager(); };
