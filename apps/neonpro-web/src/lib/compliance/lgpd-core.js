...
exports.LGPDManager = exports.DataSubjectRequestStatus = exports.DataSubjectRequestType = exports.LGPDCore = exports.LGPDComplianceService = exports.LGPDDataSubjectService = exports.LGPDConsentService = exports.LGPDEncryptionService = void 0;
...
var LGPDEncryptionService = /** @class */ (function () {
    ...
    LGPDEncryptionService.getEncryptionKey = function (password, salt) {
        return crypto_1.default.pbkdf2Sync(password, salt, this.DEFAULT_CONFIG.iterations, this.DEFAULT_CONFIG.keySize, 'sha512');
    };
    /**
    ...
    LGPDEncryptionService.decrypt = function (encryptedData, masterKey) {
        try {
            ...
            var key = this.getEncryptionKey(masterKey, salt);
            var _a = encryptedData.data.split(':'), encrypted = _a[0], authTagHex = _a[1];
...
var LGPDConsentService = /** @class */ (function () {
     ...
     */
    LGPDConsentService.prototype.grantConsent = function (context, consentType, legalBasis, purpose, description, expiresAt) {
...
Object.defineProperty(exports, "DataSubjectRequestType", { enumerable: true, get: function () { return lgpd_2.DataSubjectRight; } });
// Export RequestStatus as DataSubjectRequestStatus for compatibility  
var lgpd_3 = require("../../types/lgpd");
Object.defineProperty(exports, "DataSubjectRequestStatus", { enumerable: true, get: function () { return lgpd_3.RequestStatus; } });
