...
var LGPDAutomationOrchestrator = /** @class */ (() => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.reportingService.generateComplianceReports(clinicId, reportTypes),
            ];
          case 2:
            reports = _a.sent();
            return [
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("lgpd_automation_config").upsert({
                clinic_id: clinicId,
                config: config,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("lgpd_automation_schedules").select("*").eq("clinic_id", clinicId),
            ];
          case 1:
            data = _a.sent().data;
            return [2 /*return*/, data || []];
  ...
  LGPDAutomationOrchestrator.prototype.logAutomationExecution = function (
    clinicId,
    results,
    startTime,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [3 /*break*/, 11];
          case 1:
            return [4 /*yield*/, this.executeConsentAutomation(task.clinic_id)];
          case 2:
            _b.sent();
            return [3 /*break*/, 11];
          case 3:
            return [4 /*yield*/, this.executeAuditAutomation(task.clinic_id)];
          case 4:
            _b.sent();
            return [3 /*break*/, 11];
          case 5:
            return [4 /*yield*/, this.executeReportingAutomation(task.clinic_id)];
          case 6:
            _b.sent();
            return [3 /*break*/, 11];
          case 7:
            return [4 /*yield*/, this.executeAnonymizationAutomation(task.clinic_id)];
          case 8:
            _b.sent();
            return [3 /*break*/, 11];
          case 9:
            return [4 /*yield*/, this.executeHealthCheck(task.clinic_id)];
          case 10:
            _b.sent();
            return [3 /*break*/, 11];
          case 11:
