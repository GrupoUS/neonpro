...
exports.lgpdEncryptionService = exports.encryptionService = exports.LGPDEncryptionService = exports.EncryptionService = void 0;
    ...
    LGPDEncryptionService.prototype.encryptPersonalData = function (data) {
        ...
        for (var _i = 0, sensitiveFields_1 = sensitiveFields; _i < sensitiveFields_1.length; _i++) {
            ...
            if (encrypted[field] && typeof encrypted[field] === 'string') {
                ...
                encrypted[field] = "enc:".concat(encryptionResult.encrypted, ":").concat(encryptionResult.iv, ":").concat(encryptionResult.tag);
            }
        }
        return encrypted;
    };
    LGPDEncryptionService.prototype.decryptPersonalData = function (data) {
        ...
        for (var _i = 0, _a = Object.entries(decrypted); _i < _a.length; _i++) {
            ...
            if (typeof value === 'string' && value.startsWith('enc:')) {
                var _c = value.split(':'), encrypted = _c[1], iv = _c[2], tag = _c[3];
                try {
