...
exports.createinteroperabilityManager =
  ...
  exports.InteroperabilityManager =
    void 0;
...
var InteroperabilityManager = /** @class */ (function () {
   ...
   */
  InteroperabilityManager.prototype.createFHIRResource = function (
    resourceType,
    resourceData,
    profileId,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            fhirResource = __assign(
              {
                resourceType: resourceType,
                id: ""
                  .concat(resourceType.toLowerCase(), "-")
                  .concat(Date.now(), "-")
          ...
          case 2:
            ...
            logger_1.logger.info(
              "FHIR ".concat(resourceType, " resource created: ").concat(fhirResource.id),
            );
            return [2 /*return*/, fhirResource];
          case 3:
            error_2 = _a.sent();
            logger_1.logger.error(
              "Failed to create FHIR ".concat(resourceType, " resource:"),
              error_2,
            );
            throw error_2;
          case 4:
   ...
   */
  InteroperabilityManager.prototype.sendDataExchange = function (
    targetSystem,
    standard,
    format,
    messageType,
              ...
              metadata: __assign(
                {
                  ...
                  messageControlId: "ctrl_".concat(Date.now()),
                  processingId: "P",
                  versionId: "2.5.1",
                },
                metadata,
   ...
   */
  InteroperabilityManager.prototype.processIncomingExchange = function (
    sourceSystem,
    standard,
    format,
    payload,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            ...
            processing.duration =
              new Date(processing.endTime).getTime() - new Date(processing.startTime).getTime();
            logger_1.logger.info(
              "Incoming exchange processed successfully from ".concat(sourceSystem),
            );
            return [2 /*return*/, processing];
          case 5:
            error_4 = _a.sent();
            logger_1.logger.error(
              "Failed to process incoming exchange from ".concat(sourceSystem, ":"),
              error_4,
            );
            throw error_4;
          case 6:
   ...
   */
  InteroperabilityManager.prototype.validateFHIRResource = function (
    resourceType,
    resourceData,
    profile,
  ) {
          ...
          case 1:
            ...
            if (!resourceData.resourceType || resourceData.resourceType !== resourceType) {
              results.push({
                ...
                status: "failed",
                message: "Resource type mismatch. Expected: "
                  .concat(resourceType, ", Found: ")
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            _a = {
              ...
              pendingExchanges: exchanges.filter(function (e) {
                ...
                return (
                  ...
                  ((_b = e.status) === null || _b === void 0 ? void 0 : _b.status) === "processing"
                );
              }).length,
          ...
          case 2:
            metrics = ((_a.complianceMetrics = _b.sent()), _a);
  ...
  InteroperabilityManager.prototype.loadEndpoints = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("interoperability_endpoints").select("*")];
          case 1:
            data = _a.sent().data;
            if (data) {
  ...
  InteroperabilityManager.prototype.loadDataMappings = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("data_mappings").select("*")];
          case 1:
            data = _a.sent().data;
            if (data) {
            ...
            if (!endpoint) {
              throw new Error(
                "No active endpoint found for "
                  .concat(exchange.standard, "/")
                  .concat(exchange.format),
              );
            }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("fhir_resources").insert({
                id: resource.id,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("data_exchanges").insert({
                id: exchange.id,
