...
exports.createhealthcareComplianceManager =
  ...
  exports.HealthcareComplianceManager =
    void 0;
...
var HealthcareComplianceManager = /** @class */ (() => {
   ...
   */
  HealthcareComplianceManager.prototype.validateComponentCompliance = function (
    componentId,
    standards,
  ) {
    return __awaiter(this, void 0, void 0, function () {
          ...
          case 5:
            ...
            return [
              ...
              this.createAuditEntry({
                ...
                details: "Validated compliance for "
                  .concat(componentId, " against ")
                  .concat(standards.join(", ")),
                userId: "system",
                systemComponent: componentId,
                standard: standards[0], // Primary standard
                complianceImpact:
                  compliance.overallComplianceStatus === "compliant" ? "none" : "high",
              }),
            ];
          case 6:
            // Create audit entry
            ...
            logger_1.logger.info(
              "Compliance validation completed for "
                .concat(componentId, ": ")
                .concat(compliance.overallComplianceStatus),
            );
            return [2 /*return*/, compliance];
          case 7:
            error_2 = _a.sent();
            logger_1.logger.error(
              "Failed to validate compliance for component ".concat(componentId, ":"),
              error_2,
            );
            throw error_2;
          case 8:
   ...
   */
  HealthcareComplianceManager.prototype.validateStandardCompliance = function (
    componentId,
    standard,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this.getStandardRequirements(standard)];
          case 1:
          ...
          case 7:
            return [2 /*return*/, ((_a.nonComplianceIssues = _b.sent()), _a)];
        }
      });
    });
  };
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ...
            return [3 /*break*/, 9];
          case 1:
            return [4 /*yield*/, this.validateDocumentation(componentId, requirement)];
          case 2:
            validationResult = _d.sent();
            return [3 /*break*/, 10];
          case 3:
            return [4 /*yield*/, this.performAudit(componentId, requirement)];
          case 4:
            validationResult = _d.sent();
            return [3 /*break*/, 10];
          case 5:
            return [4 /*yield*/, this.assessConformity(componentId, requirement)];
          case 6:
            validationResult = _d.sent();
            return [3 /*break*/, 10];
          case 7:
            return [4 /*yield*/, this.auditSystem(componentId, requirement)];
          case 8:
            validationResult = _d.sent();
            return [3 /*break*/, 10];
          case 9:
          ...
          case 11:
            return [
              2 /*return*/,
              __assign.apply(void 0, _b.concat([((_c.evidence = _d.sent()), _c)])),
            ];
          case 12:
            error_3 = _d.sent();
            logger_1.logger.error(
              "Failed to validate requirement ".concat(requirement.id, ":"),
              error_3,
            );
            return [
              2 /*return*/,
              __assign(__assign({}, requirement), {
                status: "non_compliant",
                lastValidated: new Date().toISOString(),
                comments: "Validation failed: ".concat(error_3.message),
              }),
            ];
          case 13:
            return [2 /*return*/];
   ...
   */
  HealthcareComplianceManager.prototype.generateComplianceReport = function (
    componentId,
    standards,
  ) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        switch (_b.label) {
          case 0:
            ...
            for (_i = 0, components_1 = components; _i < components_1.length; _i++) {
              ...
              reportData.push({
                componentId: comp,
                compliance: __assign(__assign({}, compliance), {
  ...
  HealthcareComplianceManager.prototype.collectRequirementEvidence = function (
    componentId,
    requirement,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  HealthcareComplianceManager.prototype.loadComplianceData = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("medical_device_compliance").select("*")];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("medical_device_compliance").upsert({
                id: compliance.id,
  ...
  HealthcareComplianceManager.prototype.createAuditEntry = function (entry) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("compliance_audit_trail").insert(entry)];
          case 1:
            error = _a.sent().error;
            if (error) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("compliance_reports").insert({
                id: report.id,
...
exports.ComplianceValidationSchema = zod_1.z.object({
  ...
  standards: zod_1.z
    .array(zod_1.z.enum(["FDA", "CE", "ANVISA", "ISO_14971", "ISO_13485", "IEC_62304"]))
