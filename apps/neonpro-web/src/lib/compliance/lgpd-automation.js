...
exports.LGPDAutoAnonymizationService = exports.LGPDAutoReportingService = exports.LGPDAutoAuditService = exports.LGPDAutoDataSubjectRightsService = exports.LGPDAutoConsentService = void 0;
...
var LGPDAutoConsentService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            ...
                            .insert(__assign(__assign({}, rule), { createdAt: new Date(), updatedAt: new Date() }))
                            .select()
                            .single()];
                    case 1:
     ...
     */
    LGPDAutoConsentService.prototype.processAutoConsent = function (context, triggerEvent, eventData) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        expiresAt = rule.expirationDays
                            ...
                            : undefined;
                        return [4 /*yield*/, this.complianceService.consent.grantConsent(context, rule.consentType, rule.legalBasis, rule.purpose, "".concat(rule.description, " (Autom\u00E1tico: ").concat(triggerEvent, ")"), expiresAt)];
                    case 4:
                        consent = _b.sent();
                    ...
                    case 6:
                        _i++;
                        return [3 /*break*/, 2];
                    case 7: return [2 /*return*/, grantedConsents];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(expired === null || expired === void 0 ? void 0 : expired.length)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.supabase
                                .from('lgpd_consent_records')
                                .update({ status: lgpd_1.ConsentStatus.EXPIRED })
                                .in('id', expired.map(function (c) { return c.id; }))];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
                        notified = 0;
                        if (!(expiring === null || expiring === void 0 ? void 0 : expiring.length)) return [3 /*break*/, 8];
...
var LGPDAutoDataSubjectRightsService = /** @class */ (function () {
    ...
    LGPDAutoDataSubjectRightsService.prototype.processDataSubjectRequests = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, requests, error, processed, automated, requiresManualReview, _i, requests_1, request, canAutomate, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase
                    ...
                    case 5:
                        ...
                        automated++;
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.flagForManualReview(request)];
                    case 7:
                        _b.sent();
                    ...
                    case 10:
                        _i++;
                        return [3 /*break*/, 2];
                    case 11: return [2 /*return*/, { processed: processed, automated: automated, requiresManualReview: requiresManualReview }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            case lgpd_1.DataSubjectRight.ACCESS: return [3 /*break*/, 1];
                            case lgpd_1.DataSubjectRight.PORTABILITY: return [3 /*break*/, 2];
                            case lgpd_1.DataSubjectRight.RECTIFICATION: return [3 /*break*/, 3];
                            case lgpd_1.DataSubjectRight.ELIMINATION: return [3 /*break*/, 4];
                        }
                        return [3 /*break*/, 6];
                    case 1: return [2 /*return*/, true]; // Sempre pode ser automatizado
                    case 2: return [2 /*return*/, true]; // Exportação de dados pode ser automatizada
                    case 3: 
                    // Só automatizar se for correção simples
                    return [2 /*return*/, this.isSimpleRectification(request)];
                    case 4: return [4 /*yield*/, this.canDeleteUserData(request.userId, request.clinicId)];
                    case 5: 
                    // Verificar se não há impedimentos legais
                    return [2 /*return*/, _b.sent()];
                    case 6: return [2 /*return*/, false]; // Outros tipos requerem revisão manual
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = request.requestType;
                        switch (_a) {
                            case lgpd_1.DataSubjectRight.ACCESS: return [3 /*break*/, 2];
                            case lgpd_1.DataSubjectRight.PORTABILITY: return [3 /*break*/, 4];
                            case lgpd_1.DataSubjectRight.ELIMINATION: return [3 /*break*/, 6];
                            case lgpd_1.DataSubjectRight.RECTIFICATION: return [3 /*break*/, 8];
                        }
                        return [3 /*break*/, 10];
                    case 2: return [4 /*yield*/, this.automateAccessRequest(request)];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 4: return [4 /*yield*/, this.automatePortabilityRequest(request)];
                    case 5:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 6: return [4 /*yield*/, this.automateErasureRequest(request)];
                    case 7:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 8: return [4 /*yield*/, this.automateRectificationRequest(request)];
                    case 9:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 10: return [4 /*yield*/, this.supabase
                            .from('lgpd_data_subject_requests')
                            .update({
    ...
    LGPDAutoDataSubjectRightsService.prototype.automateAccessRequest = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.complianceService.dataSubject.exportUserData(request.userId, request.clinicId)];
                    case 1:
                        userData = _a.sent();
                        report = {
    ...
    LGPDAutoDataSubjectRightsService.prototype.automateErasureRequest = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.complianceService.dataSubject.processErasureRequest(request.id, 'SYSTEM_AUTO')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            ...
                            .update({
                            status: lgpd_1.RequestStatus.IN_PROGRESS,
                            metadata: __assign(__assign({}, request.metadata), { requiresManualReview: true, flaggedAt: new Date(), reason: 'Complex request requiring human review' })
                        })
                            .eq('id', request.id)];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (medicalRecords === null || medicalRecords === void 0 ? void 0 : medicalRecords.length) {
                            fiveYearsAgo_1 = new Date();
                            fiveYearsAgo_1.setFullYear(fiveYearsAgo_1.getFullYear() - 5);
                            recentRecords = medicalRecords.filter(function (record) { return new Date(record.created_at) > fiveYearsAgo_1; });
...
var LGPDAutoAuditService = /** @class */ (function () {
    ...
    LGPDAutoAuditService.prototype.performComplianceAudit = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var timestamp, _a, consentCheck, retentionCheck, auditCheck, encryptionCheck, rightsCheck, overallScore, actionItems, healthCheck;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        timestamp = new Date();
                    ...
                    case 1:
                        _a = _b.sent(), consentCheck = _a[0], retentionCheck = _a[1], auditCheck = _a[2], encryptionCheck = _a[3], rightsCheck = _a[4];
                        overallScore = Math.round((consentCheck.score + retentionCheck.score + auditCheck.score +
                            encryptionCheck.score + rightsCheck.score) / 5);
                    ...
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4: return [2 /*return*/, healthCheck];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (expiredConsents === null || expiredConsents === void 0 ? void 0 : expiredConsents.length) {
                            issues.push("".concat(expiredConsents.length, " consentimentos expirados encontrados"));
                    ...
                    case 2:
                        ...
                        if (invalidConsents === null || invalidConsents === void 0 ? void 0 : invalidConsents.length) {
                    ...
                    case 3:
                        ...
                        if (usersWithoutConsent === null || usersWithoutConsent === void 0 ? void 0 : usersWithoutConsent.length) {
                            issues.push("".concat(usersWithoutConsent.length, " usu\u00E1rios sem consentimento para dados sens\u00EDveis"));
    ...
    LGPDAutoAuditService.prototype.auditDataRetention = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var recommendations, score, expiredRecords, fiveYearsAgo, expiredMedicalRecords, twoYearsAgo, oldAuditLogs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        recommendations = [];
                    ...
                    case 1:
                        ...
                        if (expiredMedicalRecords === null || expiredMedicalRecords === void 0 ? void 0 : expiredMedicalRecords.length) {
                            expiredRecords += expiredMedicalRecords.length;
                            recommendations.push("Anonimizar ou deletar ".concat(expiredMedicalRecords.length, " registros m\u00E9dicos expirados"));
                    ...
                    case 2:
                        ...
                        if (oldAuditLogs === null || oldAuditLogs === void 0 ? void 0 : oldAuditLogs.length) {
                            ...
                            recommendations.push("Arquivar ".concat(oldAuditLogs.length, " logs de auditoria antigos"));
    ...
    LGPDAutoAuditService.prototype.auditAuditTrail = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var recommendations, score, missingLogs, last24Hours, recentLogs, expectedMinimumLogs, criticalEvents, _i, criticalEvents_1, eventType, criticalLogs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        recommendations = [];
                    ...
                    case 1:
                        ...
                        if (!recentLogs || recentLogs.length < expectedMinimumLogs) {
                            missingLogs = expectedMinimumLogs - ((recentLogs === null || recentLogs === void 0 ? void 0 : recentLogs.length) || 0);
                    ...
                    case 3:
                        ...
                        if (!(criticalLogs === null || criticalLogs === void 0 ? void 0 : criticalLogs.length)) {
    ...
    LGPDAutoAuditService.prototype.auditEncryptionCompliance = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var unencryptedFields, recommendations, score, sensitiveFields, _i, sensitiveFields_1, _a, table, field, data, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        unencryptedFields = [];
                    ...
                    case 3:
                        data = (_b.sent()).data;
                        if ((data === null || data === void 0 ? void 0 : data.length) && !this.isFieldEncrypted(data[0][field])) {
    ...
    LGPDAutoAuditService.prototype.auditDataSubjectRights = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var recommendations, score, pendingRequests, pendingCount, fifteenDaysAgo, overdueRequests, overdueCount;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        recommendations = [];
                    ...
                    case 1:
                        ...
                        pendingCount = (pendingRequests === null || pendingRequests === void 0 ? void 0 : pendingRequests.length) || 0;
                        fifteenDaysAgo = new Date(Date.now() - 15 * 24 * 60 * 60 * 1000);
                        overdueRequests = (pendingRequests === null || pendingRequests === void 0 ? void 0 : pendingRequests.filter(function (req) { return new Date(req.requestedAt) < fifteenDaysAgo; })) || [];
                        overdueCount = overdueRequests.length;
                        if (pendingCount > 0) {
                            score -= Math.min(30, pendingCount * 3);
                            recommendations.push("Processar ".concat(pendingCount, " solicita\u00E7\u00F5es pendentes"));
                        }
                        if (overdueCount > 0) {
                            score -= Math.min(40, overdueCount * 5);
                            recommendations.push("URGENTE: ".concat(overdueCount, " solicita\u00E7\u00F5es em atraso (>15 dias)"));
                        }
                        return [2 /*return*/, {
                                score: Math.max(0, score),
    ...
    LGPDAutoAuditService.prototype.generateActionItems = function (checks) {
        ...
        if (checks.rightsCheck.overdueRequests > 0) {
            actionItems.push({
                priority: 'critical',
                description: "Processar ".concat(checks.rightsCheck.overdueRequests, " solicita\u00E7\u00F5es em atraso"),
...
var LGPDAutoReportingService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _i++;
                        return [3 /*break*/, 1];
                    case 6: return [2 /*return*/, reports];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = reportType;
                        switch (_a) {
                            case lgpd_1.ComplianceReportType.CONSENT_SUMMARY: return [3 /*break*/, 1];
                            case lgpd_1.ComplianceReportType.DATA_PROCESSING: return [3 /*break*/, 3];
                            case lgpd_1.ComplianceReportType.AUDIT_TRAIL: return [3 /*break*/, 5];
                            case lgpd_1.ComplianceReportType.DATA_INVENTORY: return [3 /*break*/, 7];
                            case lgpd_1.ComplianceReportType.RISK_ASSESSMENT: return [3 /*break*/, 9];
                        }
                        return [3 /*break*/, 11];
                    case 1: return [4 /*yield*/, this.generateConsentSummaryData(clinicId, startDate, endDate)];
                    case 2:
                        reportData = _b.sent();
                        title = 'Relatório de Consentimentos';
                        description = 'Resumo dos consentimentos concedidos, revogados e expirados';
                        return [3 /*break*/, 12];
                    case 3: return [4 /*yield*/, this.generateDataProcessingData(clinicId, startDate, endDate)];
                    case 4:
                        reportData = _b.sent();
                        title = 'Relatório de Processamento de Dados';
                        description = 'Atividades de processamento de dados pessoais';
                        return [3 /*break*/, 12];
                    case 5: return [4 /*yield*/, this.generateAuditTrailData(clinicId, startDate, endDate)];
                    case 6:
                        reportData = _b.sent();
                        title = 'Relatório de Trilha de Auditoria';
                        description = 'Eventos de auditoria e atividades do sistema';
                        return [3 /*break*/, 12];
                    case 7: return [4 /*yield*/, this.generateDataInventoryData(clinicId)];
                    case 8:
                        reportData = _b.sent();
                        title = 'Inventário de Dados';
                        description = 'Mapeamento de dados pessoais processados';
                        return [3 /*break*/, 12];
                    case 9: return [4 /*yield*/, this.generateRiskAssessmentData(clinicId, startDate, endDate)];
                    case 10:
                        reportData = _b.sent();
                        title = 'Avaliação de Riscos';
                        description = 'Análise de riscos de privacidade e segurança';
                        return [3 /*break*/, 12];
                    case 11: throw new Error("Unsupported report type: ".concat(reportType));
                    case 12:
                        report = {
     ...
     */
    LGPDAutoReportingService.prototype.generateConsentSummaryData = function (clinicId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                summary: {
                                    totalConsents: (consentsByType === null || consentsByType === void 0 ? void 0 : consentsByType.length) || 0,
                                    byType: typeStats,
     ...
     */
    LGPDAutoReportingService.prototype.generateDataProcessingData = function (clinicId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                summary: {
                                    totalEvents: (processingEvents === null || processingEvents === void 0 ? void 0 : processingEvents.length) || 0,
                                    byType: eventStats
                                },
                                activities: {
     ...
     */
    LGPDAutoReportingService.prototype.generateAuditTrailData = function (clinicId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                summary: {
                                    totalEvents: (auditEvents === null || auditEvents === void 0 ? void 0 : auditEvents.length) || 0,
                ...
                switch (_a.label) {
                    ...
                    case 6: return [2 /*return*/, {
                            ...
                            summary: {
                                ...
                                totalRecords: inventory.reduce(function (sum, item) { return sum + item.recordCount; }, 0),
     ...
     */
    LGPDAutoReportingService.prototype.generateRiskAssessmentData = function (clinicId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        riskScore = this.calculateRiskScore({
                            highRiskEvents: (highRiskEvents === null || highRiskEvents === void 0 ? void 0 : highRiskEvents.length) || 0,
                            accessViolations: (accessViolations === null || accessViolations === void 0 ? void 0 : accessViolations.length) || 0
                        });
                        return [2 /*return*/, {
                                riskScore: riskScore,
                                riskLevel: this.getRiskLevel(riskScore),
                                threats: {
                                    unauthorizedAccess: (accessViolations === null || accessViolations === void 0 ? void 0 : accessViolations.length) || 0,
    ...
    LGPDAutoReportingService.prototype.calculateExpirationRate = function (statusStats) {
        var total = Object.values(statusStats).reduce(function (sum, count) { return sum + count; }, 0);
    ...
    LGPDAutoReportingService.prototype.countSecurityIncidents = function (events) {
        return events.filter(function (event) {
            return event.eventType === lgpd_1.AuditEventType.UNAUTHORIZED_ACCESS ||
...
var LGPDAutoAnonymizationService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        if (!job.errors)
                            job.errors = [];
                        job.errors.push("Rule ".concat(rule.id, ": ").concat(error_7 instanceof Error ? error_7.message : 'Unknown error'));
                        return [3 /*break*/, 7];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = rule.trigger;
                        switch (_a) {
                            case 'consent_withdrawn': return [3 /*break*/, 1];
                            case 'retention_expired': return [3 /*break*/, 3];
                            case 'scheduled': return [3 /*break*/, 4];
                        }
                        return [3 /*break*/, 5];
                    ...
                    case 2:
                        ...
                        userIds = (withdrawnConsents === null || withdrawnConsents === void 0 ? void 0 : withdrawnConsents.map(function (c) { return c.userId; })) || [];
                        if (userIds.length > 0) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        switch (_a) {
                            case 'hash': return [3 /*break*/, 1];
                            case 'mask': return [3 /*break*/, 3];
                            case 'pseudonymize': return [3 /*break*/, 4];
                            case 'remove': return [3 /*break*/, 6];
                            case 'generalize': return [3 /*break*/, 7];
                        }
                        return [3 /*break*/, 8];
                    case 1: return [4 /*yield*/, this.hashValue(originalValue)];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 9];
                    case 4: return [4 /*yield*/, this.pseudonymizeValue(originalValue, rule.fieldName)];
                    case 5:
                        anonymizedValue = _c.sent();
                        return [3 /*break*/, 9];
                    case 6:
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 9];
                    case 8: throw new Error("Unsupported anonymization type: ".concat(rule.anonymizationType));
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, this.logFieldAnonymization(record.id, rule, originalValue, anonymizedValue)];
                    case 11:
                        // Registrar auditoria da anonimização
                        _c.sent();
                        return [2 /*return*/];
     ...
     */
    LGPDAutoAnonymizationService.prototype.logFieldAnonymization = function (recordId, rule, originalValue, anonymizedValue) {
        return __awaiter(this, void 0, void 0, function () {
            var auditLog;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        auditLog = (_a.details = (_b.originalValueHash = _c.sent(),
                            _b.anonymizedValue = anonymizedValue,
                            _b),
                            _a.ipAddress = 'system',
     ...
     */
    LGPDAutoAnonymizationService.prototype.scheduleAnonymization = function (clinicId, rules, scheduledFor) {
        return __awaiter(this, void 0, void 0, function () {
            var jobId;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        error_8 = _b.sent();
                        console.error("Failed to execute scheduled anonymization job ".concat(job.id, ":"), error_8);
                        // Marcar como falhou
                        return [4 /*yield*/, this.supabase
                                .from('lgpd_scheduled_jobs')
                                .update({
