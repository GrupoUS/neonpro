...
exports.useConflictStream =
  ...
  exports.optimizedSchedulingAPI =
  exports.OptimizedSchedulingAPI =
    void 0;
  ...
  BatchRequestManager.prototype.processBatch = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (this.batchQueue.length === 0) return [2 /*return*/];
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 1:
            ...
            return [3 /*break*/, 6];
          case 2:
            return [4 /*yield*/, this.batchConflictCheck(supabase, requests)];
          case 3:
            conflictResults = _d.sent();
            results.push.apply(results, conflictResults);
            return [3 /*break*/, 7];
          case 4:
            return [4 /*yield*/, this.batchResolutionValidation(supabase, requests)];
          case 5:
...
var OptimizedSchedulingAPI = /** @class */ (function () {
                        ...
                        if (filters.search) {
                          query = query.or(
                            "\n          description.ilike.%"
                              .concat(
                                filters.search,
                                "%,\n          appointments.patients.name.ilike.%",
                              )
                              .concat(
                                filters.search,
                                "%,\n          appointments.professionals.name.ilike.%",
                              )
  ...
  OptimizedSchedulingAPI.prototype.resolveConflictsBatch = function (
    conflictIds,
    resolutionType,
    metadata,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.rpc("resolve_conflicts_batch", {
    ...
    return __assign(__assign({}, this.performanceMetrics), {
      ...
      cacheHitRate:
        this.performanceMetrics.totalRequests > 0
          ? (
              (this.performanceMetrics.cachedResponses / this.performanceMetrics.totalRequests) *
              100
            ).toFixed(2) + "%"
          : "0%",
      apiCallReduction:
        this.performanceMetrics.totalRequests > 0
          ? (
              (this.performanceMetrics.apiCallsReduced / this.performanceMetrics.totalRequests) *
              100
            ).toFixed(2) + "%"
          : "0%",
    });
