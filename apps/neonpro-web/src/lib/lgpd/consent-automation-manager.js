...
exports.createconsentAutomationManager = exports.ConsentAutomationManager = exports.LGPDPurpose = exports.LGPDDataType = void 0;
...
var ConsentAutomationManager = /** @class */ (function () {
    ...
    ConsentAutomationManager.prototype.collectConsent = function (request, ipAddress, userAgent) {
        return __awaiter(this, void 0, void 0, function () {
            var consentRecords, timestamp, expiresAt, _i, _a, dataType, _b, _c, purpose, consentRecord, _d, data, error, error_1;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 1];
                    case 7:
                        logger_1.logger.info("Collected ".concat(consentRecords.length, " consent records for user ").concat(request.userId));
     ...
     */
    ConsentAutomationManager.prototype.withdrawConsent = function (userId, clinicId, dataType, purpose, reason, ipAddress, userAgent) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!data || data.length === 0) {
                            logger_1.logger.warn("No active consent found for withdrawal: ".concat(userId, ", ").concat(dataType, ", ").concat(purpose));
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.triggerDataProcessingStop(userId, clinicId, dataType, purpose)];
                    case 3:
                        // Trigger data processing stop for withdrawn consent
                        _b.sent();
                        logger_1.logger.info("Consent withdrawn for user ".concat(userId, ": ").concat(dataType, "/").concat(purpose));
     ...
     */
    ConsentAutomationManager.prototype.hasValidConsent = function (userId, clinicId, dataType, purpose) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    ConsentAutomationManager.prototype.updateConsentVersion = function (userId_1, clinicId_1, newVersion_1, newConsentText_1) {
        return __awaiter(this, arguments, void 0, function (userId, clinicId, newVersion, newConsentText, forceRecollection) {
            var currentConsents, requiresRecollection, _i, currentConsents_1, consent, _a, currentConsents_2, consent, error_5;
            if (forceRecollection === void 0) { forceRecollection = false; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        if (currentConsents.length === 0) {
                            logger_1.logger.info("No active consents found for user ".concat(userId, " to update"));
                            return [2 /*return*/, true];
                        }
                        requiresRecollection = forceRecollection ||
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                consentGiven: false,
                                updatedAt: new Date(),
                                metadata: __assign(__assign({}, consent.metadata), { versionUpdateRequired: true, newVersion: newVersion, requiresRecollection: true })
                            })
                                .eq('id', consent.id)];
                    case 3:
                        _b.sent();
                    ...
                    case 10:
                        ...
                        return [3 /*break*/, 8];
                    case 11:
                        logger_1.logger.info("Updated consent version for user ".concat(userId, " to ").concat(newVersion));
                        return [2 /*return*/, true];
                    case 12:
                        error_5 = _b.sent();
    ...
    ConsentAutomationManager.prototype.getConsentAnalytics = function (clinicId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _a, allConsents, error, now_1, activeConsents_1, withdrawnConsents, expiredConsents, consentsByDataType_1, consentsByPurpose_1, thirtyDaysAgo_1, recentWithdrawals, thirtyDaysFromNow_1, expiringConsents, error_6;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        now_1 = new Date();
                        activeConsents_1 = (allConsents === null || allConsents === void 0 ? void 0 : allConsents.filter(function (c) {
                            return c.consentGiven &&
                                !c.withdrawnAt &&
                                (!c.expiresAt || new Date(c.expiresAt) > now_1);
                        })) || [];
                        withdrawnConsents = (allConsents === null || allConsents === void 0 ? void 0 : allConsents.filter(function (c) { return c.withdrawnAt; })) || [];
                        expiredConsents = (allConsents === null || allConsents === void 0 ? void 0 : allConsents.filter(function (c) {
                            return c.expiresAt && new Date(c.expiresAt) <= now_1;
                        })) || [];
                        consentsByDataType_1 = {};
                        Object.values(LGPDDataType).forEach(function (type) {
                            consentsByDataType_1[type] = activeConsents_1.filter(function (c) { return c.dataType === type; }).length;
                        });
                        consentsByPurpose_1 = {};
                        Object.values(LGPDPurpose).forEach(function (purpose) {
                            consentsByPurpose_1[purpose] = activeConsents_1.filter(function (c) { return c.purpose === purpose; }).length;
                        });
                        thirtyDaysAgo_1 = new Date(now_1.getTime() - 30 * 24 * 60 * 60 * 1000);
                        recentWithdrawals = withdrawnConsents
                            .filter(function (c) { return c.withdrawnAt && new Date(c.withdrawnAt) > thirtyDaysAgo_1; })
                            .slice(0, 10);
                        thirtyDaysFromNow_1 = new Date(now_1.getTime() + 30 * 24 * 60 * 60 * 1000);
                        expiringConsents = activeConsents_1
                            .filter(function (c) { return c.expiresAt && new Date(c.expiresAt) <= thirtyDaysFromNow_1; })
                            .slice(0, 10);
                        return [2 /*return*/, {
                                totalConsents: (allConsents === null || allConsents === void 0 ? void 0 : allConsents.length) || 0,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        _b.sent();
                        _b.label = 3;
                    case 3: return [2 /*return*/, cleanedCount];
                    case 4:
                        error_7 = _b.sent();
     ...
     */
    ConsentAutomationManager.prototype.versionRequiresRecollection = function (oldVersion, newVersion) {
     ...
     * Trigger data processing stop for withdrawn consent
     */
    ConsentAutomationManager.prototype.triggerDataProcessingStop = function (userId, clinicId, dataType, purpose) {
        return __awaiter(this, void 0, void 0, function () {
            var error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // For now, we'll log the requirement
                        _a.sent();
                        logger_1.logger.info("Data processing stop triggered for ".concat(userId, ": ").concat(dataType, "/").concat(purpose));
                        return [3 /*break*/, 3];
                    case 2:
                        error_8 = _a.sent();
...
var createconsentAutomationManager = function () { return new ConsentAutomationManager(); };
