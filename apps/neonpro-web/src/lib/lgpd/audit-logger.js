...
exports.AUDIT_DATA_CATEGORIES = exports.AuditLogger = exports.auditLogSchema = exports.RiskLevel = exports.DataProcessingActivity = void 0;
...
exports.auditLogSchema = zod_1.z.object({
    ...
    legalBasis: zod_1.z.enum(['consent', 'contract', 'legal_obligation', 'vital_interests', 'public_interest', 'legitimate_interests']),
...
var AuditLogger = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(validated.riskLevel === RiskLevel.HIGH || validated.riskLevel === RiskLevel.CRITICAL)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.alertSecurityTeam(validated)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, validated];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.log({
                        ...
                        description: "Consent ".concat(params.consentType, " changed from ").concat(params.oldStatus, " to ").concat(params.newStatus),
                        actorId: params.actorId,
                        actorType: 'user',
                        dataSubjectId: params.patientId,
                        dataSubjectType: 'patient',
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.log({
                        ...
                        riskLevel: params.severity === 'critical' ? RiskLevel.CRITICAL :
                            params.severity === 'high' ? RiskLevel.HIGH :
                                params.severity === 'medium' ? RiskLevel.MEDIUM : RiskLevel.LOW
                    })];
            });
        });
    };
    ...
    AuditLogger.getRetentionPeriod = function (activity) {
        ...
        var retentionPeriods = (_a = {},
            _a[DataProcessingActivity.MEDICAL_RECORD_CREATE] = 3650, // 10 years
            _a[DataProcessingActivity.MEDICAL_RECORD_READ] = 1825, // 5 years
            _a[DataProcessingActivity.MEDICAL_RECORD_UPDATE] = 3650,
            _a[DataProcessingActivity.MEDICAL_RECORD_DELETE] = 3650,
            _a[DataProcessingActivity.DATA_BREACH] = 3650, // 10 years for security incidents
            _a[DataProcessingActivity.CONSENT_CHANGE] = 2555, // 7 years
            _a[DataProcessingActivity.FINANCIAL_CREATE] = 1825, // 5 years for financial data
            _a[DataProcessingActivity.LOGIN] = 365, // 1 year for access logs
