                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                .rpc('get_lgpd_dashboard_metrics')];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        updateFields = __assign(__assign({}, updateData), { updated_at: new Date().toISOString() });
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        data === null || data === void 0 ? void 0 : data.forEach(function (event) {
                            stats_1.by_event_type[event.event_type] = (stats_1.by_event_type[event.event_type] || 0) + 1;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        data === null || data === void 0 ? void 0 : data.forEach(function (breach) {
                            stats_2.by_severity[breach.severity] = (stats_2.by_severity[breach.severity] || 0) + 1;
