...
exports.complianceMonitor = exports.ComplianceMonitor = exports.ComplianceStatus = exports.ViolationSeverity = exports.LGPDArticle = exports.ComplianceCategory = void 0;
...
var ComplianceMonitor = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.createViolation({
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 4];
                    case 8:
                        criticalViolations = violations.filter(function (v) { return v.severity === ViolationSeverity.CRITICAL; });
                        if (criticalViolations.length > 0 && this.config.notificationEnabled) {
                            this.emit('compliance:critical_alert', {
                                alert: "".concat(criticalViolations.length, " critical compliance violations detected"),
                                details: {
                                    operation: operation,
                                    violations: criticalViolations.map(function (v) { return v.id; }),
                                    timestamp: new Date()
                                }
                            });
                        }
     ...
     */
    ComplianceMonitor.prototype.recordViolation = function (category, article, severity, description, context) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.createViolation({
                        category: category,
                        article: article,
                        severity: severity,
    ...
    ComplianceMonitor.prototype.getActiveViolations = function () {
        return Array.from(this.violations.values())
            .filter(function (v) { return v.status === 'detected' || v.status === 'investigating'; })
            .sort(function (a, b) {
            var _a;
    ...
    ComplianceMonitor.prototype.getViolationsByCategory = function (category) {
        return Array.from(this.violations.values())
            .filter(function (v) { return v.category === category; })
    ...
    ComplianceMonitor.prototype.getLatestAudit = function () {
        return Array.from(this.audits.values())
            ...
            .sort(function (a, b) { return b.endDate.getTime() - a.endDate.getTime(); })[0];
    };
    /**
    ...
    ComplianceMonitor.prototype.getComplianceDashboard = function () {
        ...
        return {
            ...
            trends: {
                ...
                scoreTrend: ((_a = this.complianceScore) === null || _a === void 0 ? void 0 : _a.trend.weekly) || {}
            }
        };
    };
    /**
    ...
    ComplianceMonitor.prototype.calculateComplianceScore = function () {
        return __awaiter(this, void 0, void 0, function () {
            var requirements, violations, activeViolations, totalRequirements, compliantRequirements, partiallyCompliantRequirements, weightedScore, violationPenalty, _i, activeViolations_1, violation, overallScore, byCategory, _loop_1, _a, _b, category, riskAreas;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        activeViolations = violations.filter(function (v) { return v.status === 'detected' || v.status === 'investigating'; });
                        totalRequirements = requirements.length;
                        compliantRequirements = requirements.filter(function (r) { return r.implementationStatus === ComplianceStatus.COMPLIANT; }).length;
                        partiallyCompliantRequirements = requirements.filter(function (r) { return r.implementationStatus === ComplianceStatus.PARTIALLY_COMPLIANT; }).length;
                        weightedScore = (compliantRequirements + (partiallyCompliantRequirements * 0.5)) / totalRequirements;
                        violationPenalty = 0;
                        for (_i = 0, activeViolations_1 = activeViolations; _i < activeViolations_1.length; _i++) {
                        ...
                        _loop_1 = function (category) {
                            var categoryRequirements = requirements.filter(function (r) { return r.category === category; });
                            if (categoryRequirements.length === 0) {
                                byCategory[category] = 100; // Default if no requirements
                                return "continue";
                            }
                            var compliant = categoryRequirements.filter(function (r) { return r.implementationStatus === ComplianceStatus.COMPLIANT; }).length;
                            var partiallyCompliant = categoryRequirements.filter(function (r) { return r.implementationStatus === ComplianceStatus.PARTIALLY_COMPLIANT; }).length;
                            var categoryWeightedScore = (compliant + (partiallyCompliant * 0.5)) / categoryRequirements.length;
                            // Adjust for violations in this category
                            var categoryViolations = activeViolations.filter(function (v) { return v.category === category; });
                            var categoryPenalty = 0;
                            for (var _d = 0, categoryViolations_1 = categoryViolations; _d < categoryViolations_1.length; _d++) {
                            ...
                            byCategory[category] = Math.max(0, Math.min(100, categoryWeightedScore * 100 * (1 - categoryPenalty)));
                        };
                    ...
                    case 1:
                        ...
                        if (overallScore < this.config.alertThreshold && this.config.notificationEnabled) {
                            this.emit('compliance:critical_alert', {
                                alert: "Compliance score (".concat(Math.round(overallScore), ") is below threshold (").concat(this.config.alertThreshold, ")"),
                                details: {
                                    score: Math.round(overallScore),
                                    threshold: this.config.alertThreshold,
                                    riskAreas: riskAreas.map(function (r) { return r.category; }),
                                    timestamp: new Date()
                                }
                            });
                        }
    ...
    ComplianceMonitor.prototype.startMonitoringInterval = function () {
        ...
        this.monitoringInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.performSystemCheck()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ComplianceMonitor.prototype.startScoreUpdateInterval = function () {
        var _this = this;
        this.scoreUpdateInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.calculateComplianceScore()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ComplianceMonitor.prototype.performSystemCheck = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    outdatedRequirements = Array.from(this.requirements.values())
                        .filter(function (r) {
                        if (!r.lastVerified)
                            return true;
                        var lastVerified = new Date(r.lastVerified);
                        var updateThreshold = new Date();
                        updateThreshold.setDate(updateThreshold.getDate() - _this.config.requirementUpdateIntervalDays);
                    ...
                    if (outdatedRequirements.length > 0) {
                        this.logActivity('system', 'outdated_requirements_detected', {
                            ...
                            requirements: outdatedRequirements.map(function (r) { return r.id; })
                        });
                    }
                    longStandingViolations = Array.from(this.violations.values())
                        .filter(function (v) {
                        ...
                        return ((v.severity === ViolationSeverity.CRITICAL && ageInDays > 1) ||
                    ...
                    if (longStandingViolations.length > 0 && this.config.notificationEnabled) {
                        this.emit('compliance:critical_alert', {
                            alert: "".concat(longStandingViolations.length, " long-standing compliance violations require attention"),
                            details: {
                                violations: longStandingViolations.map(function (v) { return ({
                                    id: v.id,
                                    category: v.category,
                                    severity: v.severity,
                    ...
                    if (latestAudit === null || latestAudit === void 0 ? void 0 : latestAudit.nextAuditDate) {
                        daysUntilAudit = Math.floor((latestAudit.nextAuditDate.getTime() - Date.now()) / (1000 * 60 * 60 * 24));
        ...
        return [
            {
                ...
                check: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
    ...
    ComplianceMonitor.prototype.findRelatedRequirements = function (category, article) {
        return Array.from(this.requirements.values())
            .filter(function (r) { return r.category === category && r.article === article; });
    };
    /**
    ...
    ComplianceMonitor.prototype.loadRequirements = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                for (_i = 0, sampleRequirements_1 = sampleRequirements; _i < sampleRequirements_1.length; _i++) {
    ...
    ComplianceMonitor.prototype.getHealthStatus = function () {
        ...
        var criticalViolations = Array.from(this.violations.values())
            .filter(function (v) {
        ...
        return {
            ...
            details: {
                ...
                complianceScore: (_a = this.complianceScore) === null || _a === void 0 ? void 0 : _a.overall,
                lastUpdated: (_b = this.complianceScore) === null || _b === void 0 ? void 0 : _b.lastUpdated,
                issues: issues
            }
        };
    };
