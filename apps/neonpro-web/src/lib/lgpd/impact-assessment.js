...
exports.impactAssessmentManager = exports.ImpactAssessmentManager = exports.AssessmentStatus = exports.RiskLikelihood = exports.RiskSeverity = exports.RiskCategory = void 0;
...
var ImpactAssessmentManager = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _c.label = 2;
                    case 2:
                        assessment = __assign(__assign({}, assessmentData), { id: this.generateId('assessment'), createdAt: new Date(), updatedAt: new Date() });
                    ...
                    case 4:
                        ...
                        _b = assessment;
                        return [4 /*yield*/, this.performComplianceAnalysis(assessment.scope.processingContext)];
                    case 5:
                        // Perform compliance analysis
    ...
    ImpactAssessmentManager.prototype.assessRisk = function (category, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                mitigationMeasures = this.recommendMitigationMeasures(category, overallRisk, existingControls);
                return [2 /*return*/, {
    ...
    ImpactAssessmentManager.prototype.calculateRiskFactors = function (context) {
        ...
        var sensitiveDataCount = context.dataTypes.filter(function (dt) { return dt.sensitive; }).length;
        var dataSensitivity = Math.min(5, Math.ceil((sensitiveDataCount / context.dataTypes.length) * 5));
     ...
     */
    ImpactAssessmentManager.prototype.recommendMitigationMeasures = function (category, riskLevel, existingControls) {
        var recommended = [];
        // Category-specific recommendations
        var categoryRecommendations = this.getCategoryRecommendations(category);
        for (var _i = 0, categoryRecommendations_1 = categoryRecommendations; _i < categoryRecommendations_1.length; _i++) {
     ...
     * Calculate residual risk
     */
    ImpactAssessmentManager.prototype.calculateResidualRisk = function (originalRisk, mitigationCount) {
        var _a;
        var riskScores = (_a = {},
            _a[RiskSeverity.VERY_LOW] = 1,
            _a[RiskSeverity.LOW] = 2,
    ...
    ImpactAssessmentManager.prototype.performComplianceAnalysis = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var gaps, lgpdRequirements, _i, lgpdRequirements_1, requirement, gap, criticalGaps, totalRequirements, compliantRequirements, overallCompliance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        gaps = [];
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        criticalGaps = gaps.filter(function (g) { return g.gapSeverity === 'critical'; }).length;
    ...
    ImpactAssessmentManager.prototype.assessCurrentCompliance = function (requirement, context) {
        ...
        switch (requirement.article) {
            ...
            case 'Art. 46':
                var hasBasicSecurity = context.technicalMeasures.encryption &&
    ...
    ImpactAssessmentManager.prototype.applyTemplate = function (assessment, template) {
        ...
        assessment.scope.nextReviewDate = new Date(Date.now() + (template.defaults.reviewFrequency * 30 * 24 * 60 * 60 * 1000));
        // Set up workflow
        assessment.workflow.reviewers = template.defaults.requiredApprovers.map(function (approver) { return ({
            role: approver,
            name: '',
            status: 'pending'
        }); });
    ...
    ImpactAssessmentManager.prototype.getRiskDescription = function (category) {
        var _a;
        var descriptions = (_a = {},
            _a[RiskCategory.DATA_BREACH] = 'Risk of unauthorized access to personal data due to security vulnerabilities',
            _a[RiskCategory.UNAUTHORIZED_ACCESS] = 'Risk of unauthorized individuals gaining access to personal data',
            _a[RiskCategory.DATA_LOSS] = 'Risk of permanent loss of personal data due to technical failures or human error',
            _a[RiskCategory.PRIVACY_VIOLATION] = 'Risk of violating individual privacy rights through inappropriate data use',
            _a[RiskCategory.CONSENT_ISSUES] = 'Risk of processing personal data without proper consent',
            _a[RiskCategory.THIRD_PARTY_SHARING] = 'Risk associated with sharing personal data with third parties',
            _a[RiskCategory.CROSS_BORDER_TRANSFER] = 'Risk of transferring personal data to countries without adequate protection',
            _a[RiskCategory.AUTOMATED_DECISION] = 'Risk of automated decision-making affecting individuals',
            _a[RiskCategory.PROFILING] = 'Risk of creating detailed profiles of individuals',
            _a[RiskCategory.SURVEILLANCE] = 'Risk of excessive monitoring or surveillance of individuals',
            _a[RiskCategory.DISCRIMINATION] = 'Risk of discriminatory treatment based on personal data',
            _a[RiskCategory.REPUTATION_DAMAGE] = 'Risk of damage to individual reputation due to data misuse',
            _a);
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(assessment.scope.nextReviewDate <= now &&
                            assessment.status === AssessmentStatus.APPROVED)) return [3 /*break*/, 3];
    ...
    ImpactAssessmentManager.prototype.getAssessments = function (filters) {
        ...
        if (filters) {
            if (filters.status) {
                assessments = assessments.filter(function (a) { return a.status === filters.status; });
            }
            if (filters.riskLevel) {
                assessments = assessments.filter(function (a) { return a.riskAnalysis.overallRiskLevel === filters.riskLevel; });
            }
            if (filters.dateRange) {
                assessments = assessments.filter(function (a) {
                    return a.createdAt >= filters.dateRange.start &&
                        a.createdAt <= filters.dateRange.end;
                });
            }
        }
        return assessments.sort(function (a, b) { return b.updatedAt.getTime() - a.updatedAt.getTime(); });
    };
    /**
     * Generate ID
     */
    ...
    ImpactAssessmentManager.prototype.getHealthStatus = function () {
        ...
        var dueReviews = Array.from(this.assessments.values())
            .filter(function (a) { return a.scope.nextReviewDate <= new Date() && a.status === AssessmentStatus.APPROVED; });
