 ...
 * Usage:
 * ```typescript
 * import type { ConsentManager, AuditLogger, DataSubjectRightsManager } from "@/lib/lgpd"
 *
 * // Collect consent
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 7:
            ...
            return [
              2 /*return*/,
              { authorized: authorized, auditEntry: auditEntry, consentStatus: consentStatus },
            ];
        }
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            auditEntry = _a.sent();
            notificationRequired = this.requiresANPDNotification(
              params.severity,
