...
exports.consentManager = exports.ConsentValidator = exports.ConsentManager = exports.ConsentStatus = exports.LGPDLegalBasis = exports.LGPDProcessingPurpose = exports.LGPDDataType = void 0;
...
var ConsentManager = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.createConsentRecord({
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        auditEntry = {
                            ...
                            timestamp: new Date(),
                            reason: reason,
                            ipAddress: (context === null || context === void 0 ? void 0 : context.ipAddress) || 'unknown',
                            userAgent: (context === null || context === void 0 ? void 0 : context.userAgent) || 'unknown',
                            metadata: { interface: context === null || context === void 0 ? void 0 : context.interface }
                        };
    ...
    ConsentManager.prototype.getUserConsents = function (userId) {
        return Array.from(this.consents.values())
            .filter(function (consent) { return consent.userId === userId; })
    ...
    ConsentManager.prototype.generateAnalytics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var consents, now, thirtyDaysAgo, totalConsents, activeConsents, withdrawnConsents, expiredConsents, consentsByType, consentsByPurpose, consentsByStatus, consentRate, withdrawalRate, renewalRate, expiringConsents, compliance;
            return __generator(this, function (_a) {
                consents = Array.from(this.consents.values());
                now = new Date();
                thirtyDaysAgo = new Date(now.getTime() - 30 * 24 * 60 * 60 * 1000);
                totalConsents = consents.length;
                activeConsents = consents.filter(function (c) { return c.status === ConsentStatus.GIVEN; }).length;
                withdrawnConsents = consents.filter(function (c) { return c.status === ConsentStatus.WITHDRAWN; }).length;
                expiredConsents = consents.filter(function (c) { return c.status === ConsentStatus.EXPIRED; }).length;
                ...
                renewalRate = totalConsents > 0 ? (consents.filter(function (c) {
                    return c.auditTrail.some(function (entry) { return entry.action === 'renewed'; });
                }).length / totalConsents) * 100 : 0;
                expiringConsents = consents.filter(function (consent) {
                    return consent.expiryDate &&
    ...
    ConsentManager.prototype.assessCompliance = function (consents) {
        ...
        var missingAuditTrails = consents.filter(function (c) { return c.auditTrail.length === 0; });
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        consent = {
                            ...
                            metadata: __assign({ ipAddress: data.context.ipAddress, userAgent: data.context.userAgent, consentMethod: 'explicit', consentInterface: data.context.interface, dataRetentionPeriod: config === null || config === void 0 ? void 0 : config.defaultExpiry, thirdPartySharing: (_a = config === null || config === void 0 ? void 0 : config.thirdPartySharing) === null || _a === void 0 ? void 0 : _a.enabled, automatedDecisionMaking: (_b = config === null || config === void 0 ? void 0 : config.automatedDecisionMaking) === null || _b === void 0 ? void 0 : _b.enabled }, data.metadata),
                            auditTrail: [{
                                    id: this.generateId(),
    ...
    ConsentManager.prototype.startCleanupInterval = function () {
        ...
        this.cleanupInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cleanupExpiredConsents()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ConsentManager.prototype.startAnalyticsInterval = function () {
        ...
        this.analyticsInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.generateAnalytics()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(consent.expiryDate &&
                            ...
                            consent.status === ConsentStatus.GIVEN)) return [3 /*break*/, 3];
