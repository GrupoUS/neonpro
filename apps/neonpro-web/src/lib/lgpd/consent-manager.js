...
exports.HEALTHCARE_DATA_CATEGORIES =
  exports.HEALTHCARE_CONSENT_PURPOSES =
  exports.ConsentManager =
  exports.consentRecordSchema =
  exports.LegalBasis =
  ...
  ConsentManager.hasValidConsent = function (userId, consentType) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getLatestConsent(userId, consentType)];
          case 1:
            ...
            // Check if consent is granted and not expired
            if (consentRecord.status !== ConsentStatus.GRANTED) return [2 /*return*/, false];
  ...
  ConsentManager.revokeConsent = function (params) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getLatestConsent(params.userId, params.consentType)];
          case 1:
            existingConsent = _a.sent();
            if (!existingConsent) {
              throw new Error("No consent found to revoke");
            }
            updatedConsent = __assign(__assign({}, existingConsent), {
