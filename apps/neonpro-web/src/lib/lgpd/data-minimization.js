...
exports.dataMinimizationManager = exports.DataMinimizationManager = exports.MinimizationAction = exports.DataNecessity = exports.ProcessingPurpose = exports.DataCategory = void 0;
...
var DataMinimizationManager = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        schema = __assign(__assign({}, schemaData), { id: this.generateId('schema'), createdAt: new Date(), updatedAt: new Date() });
                        // Validate schema
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        request = __assign(__assign({}, requestData), { id: this.generateId('request'), processing: {
                                status: 'pending',
                                appliedActions: [],
                                rejectedFields: [],
                                warnings: []
                    ...
                    case 4:
                        ...
                        _a.label = 5;
                    case 5:
                        if (!(schema.minimizationEnabled && this.config.autoMinimization)) return [3 /*break*/, 7];
                    ...
                    case 8:
                        ...
                        reductionPercentage = originalFields > 0 ?
                            ((originalFields - minimizedFields) / originalFields) * 100 : 0;
                        if (reductionPercentage > 0) {
                            this.emit('data:minimized', { request: request, reductionPercentage: reductionPercentage });
                        }
                        return [3 /*break*/, 10];
                    case 9:
                        error_2 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        rule = __assign(__assign({}, ruleData), { id: this.generateId('rule'), metrics: {
                                applicationsCount: 0,
                                successRate: 0,
                                averageReduction: 0
                    ...
                    case 0:
                        ...
                        _loop_1 = function (fieldName) {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        fieldDef = schema.fields.find(function (f) { return f.name === fieldName; });
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        applicableRules = Array.from(this.rules.values())
                            .filter(function (rule) { return rule.enabled && rule.category === fieldDef.category; })
                    ...
                    case 1:
                        ...
                        if (!this.evaluateGlobalRuleConditions(rule.conditions, request, fieldDef)) return [3 /*break*/, 3];
                        // Update rule metrics
                    ...
                    case 4:
                        ...
                        switch (fieldDef.necessity) {
                            ...
                            case DataNecessity.FUNCTIONAL:
                                return [2 /*return*/, { action: MinimizationAction.COLLECT, reason: 'Essential/functional field' }];
                            case DataNecessity.ANALYTICAL:
                                return [2 /*return*/, { action: MinimizationAction.PSEUDONYMIZE, reason: 'Analytical field - pseudonymized' }];
                            case DataNecessity.MARKETING:
                                return [2 /*return*/, { action: MinimizationAction.ANONYMIZE, reason: 'Marketing field - anonymized' }];
                            case DataNecessity.OPTIONAL:
                                return [2 /*return*/, { action: MinimizationAction.FILTER, reason: 'Optional field - filtered' }];
                            default:
                                return [2 /*return*/, { action: MinimizationAction.COLLECT, reason: 'Default action' }];
                        }
                        return [2 /*return*/];
                }
            });
     ...
     */
    DataMinimizationManager.prototype.evaluateRuleConditions = function (conditions, request, fieldDef) {
     ...
     */
    DataMinimizationManager.prototype.evaluateGlobalRuleConditions = function (conditions, request, fieldDef) {
        if (conditions.purpose && conditions.purpose !== request.purpose) {
            return false;
        }
    ...
    DataMinimizationManager.prototype.generateReport = function (period, generatedBy) {
        return __awaiter(this, void 0, void 0, function () {
            var requests, totalRequests, processedRequests, rejectedRequests, minimizedRequests, totalFieldsRequested, totalFieldsCollected, categoryStats, purposeStats, _i, requests_1, request, requestedCount, collectedCount, reductionPercentage, schemaCompliance, consentCompliance, purposeLimitation, dataAccuracy, actionCounts, _a, requests_2, request, _b, _c, action, topActions, recommendations, report;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        requests = Array.from(this.requests.values())
                            .filter(function (r) { return r.createdAt >= period.start && r.createdAt <= period.end; });
                        totalRequests = requests.length;
                        processedRequests = requests.filter(function (r) { return r.processing.status === 'processed'; }).length;
                        rejectedRequests = requests.filter(function (r) { return r.processing.status === 'rejected'; }).length;
                        minimizedRequests = requests.filter(function (r) { return r.processing.appliedActions.length > 0; }).length;
                        ...
                        reductionPercentage = totalFieldsRequested > 0 ?
    ...
    DataMinimizationManager.prototype.getRequests = function (filters) {
        ...
        if (filters) {
            if (filters.schemaId) {
                requests = requests.filter(function (r) { return r.schemaId === filters.schemaId; });
            }
            if (filters.purpose) {
                requests = requests.filter(function (r) { return r.purpose === filters.purpose; });
            }
            if (filters.status) {
                requests = requests.filter(function (r) { return r.processing.status === filters.status; });
            }
            if (filters.dateRange) {
                requests = requests.filter(function (r) {
                    return r.createdAt >= filters.dateRange.start &&
                        r.createdAt <= filters.dateRange.end;
                });
            }
        }
        return requests.sort(function (a, b) { return b.createdAt.getTime() - a.createdAt.getTime(); });
    };
    /**
     * Get schemas
     */
    ...
    DataMinimizationManager.prototype.calculateConsentCompliance = function (requests) {
        ...
        if (consentRequiredRequests.length === 0)
            return 100;
        var validConsentRequests = consentRequiredRequests.filter(function (r) { return r.userConsent; });
    ...
    DataMinimizationManager.prototype.calculateDataAccuracy = function (requests) {
        ...
        var processedRequests = requests.filter(function (r) { return r.processing.status === 'processed'; });
        var errorRequests = requests.filter(function (r) { return r.processing.status === 'error'; });
    ...
    DataMinimizationManager.prototype.convertToReductionStats = function (stats) {
        ...
        for (var _i = 0, _a = Object.entries(stats); _i < _a.length; _i++) {
            ...
            result[key] = __assign(__assign({}, value), { reduction: value.requested > 0 ?
    ...
    DataMinimizationManager.prototype.startMonitoring = function () {
        ...
        this.monitoringInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.performMonitoringCheck()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    recentRequests = Array.from(this.requests.values())
                        .filter(function (r) { return r.createdAt >= oneHourAgo_1; });
    ...
    DataMinimizationManager.prototype.getHealthStatus = function () {
        ...
        var enabledRules = Array.from(this.rules.values()).filter(function (r) { return r.enabled; });
