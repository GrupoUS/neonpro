...
exports.DataSubjectRequestStatus = exports.DataSubjectRequestType = exports.LGPDAuditSeverity = exports.LGPDAuditEventType = exports.LGPDPurpose = exports.LGPDDataType = exports.lgpdComplianceSystem = exports.defaultLGPDConfig = exports.LGPDComplianceSystem = void 0;
...
Object.defineProperty(exports, "LGPDDataType", { enumerable: true, get: function () { return consent_automation_manager_1.LGPDDataType; } });
Object.defineProperty(exports, "LGPDPurpose", { enumerable: true, get: function () { return consent_automation_manager_1.LGPDPurpose; } });
var audit_trail_manager_1 = require("./audit-trail-manager");
Object.defineProperty(exports, "LGPDAuditEventType", { enumerable: true, get: function () { return audit_trail_manager_1.LGPDAuditEventType; } });
Object.defineProperty(exports, "LGPDAuditSeverity", { enumerable: true, get: function () { return audit_trail_manager_1.LGPDAuditSeverity; } });
Object.defineProperty(exports, "DataSubjectRequestType", { enumerable: true, get: function () { return audit_trail_manager_1.DataSubjectRequestType; } });
Object.defineProperty(exports, "DataSubjectRequestStatus", { enumerable: true, get: function () { return audit_trail_manager_1.DataSubjectRequestStatus; } });
...
var LGPDComplianceSystem = /** @class */ (function () {
    ...
    LGPDComplianceSystem.prototype.getComplianceStatus = function (startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, consentAnalytics, auditAnalytics, retentionAnalytics, totalConsents, activeConsents, consentComplianceRate, consentScore, auditComplianceRate, auditScore, retentionComplianceRate, retentionScore, overallScore, riskLevel, recommendations, alerts, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, Promise.all([
                                consent_automation_manager_1.consentAutomationManager.getConsentAnalytics(this.config.clinicId, startDate, endDate),
                                audit_trail_manager_1.auditTrailManager.getAuditAnalytics(this.config.clinicId, startDate, endDate),
                                data_retention_manager_1.dataRetentionManager.getRetentionAnalytics(this.config.clinicId, startDate, endDate)
                            ])];
                    case 1:
                        _a = _b.sent(), consentAnalytics = _a[0], auditAnalytics = _a[1], retentionAnalytics = _a[2];
                        totalConsents = consentAnalytics.totalConsents;
                        activeConsents = consentAnalytics.activeConsents;
                        consentComplianceRate = totalConsents > 0 ? (activeConsents / totalConsents) * 100 : 100;
                        consentScore = Math.min(100, consentComplianceRate * 1.2);
                        auditComplianceRate = auditAnalytics.complianceRate;
                        auditScore = Math.max(0, auditComplianceRate - (auditAnalytics.recentViolations.length * 10));
                        retentionComplianceRate = retentionAnalytics.retentionCompliance;
                        retentionScore = Math.max(0, retentionComplianceRate - (retentionAnalytics.expiredRecords * 5));
                        ...
                        recommendations = this.generateRecommendations(consentAnalytics, auditAnalytics, retentionAnalytics);
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, audit_trail_manager_1.auditTrailManager.logAuditEvent({
                                ...
                                severity: request.urgency === 'HIGH' ? audit_trail_manager_1.LGPDAuditSeverity.WARNING : audit_trail_manager_1.LGPDAuditSeverity.INFO,
                                dataType: request.dataTypes[0] || consent_automation_manager_1.LGPDDataType.PERSONAL_DATA,
                                description: "Data subject request: ".concat(request.type, " - ").concat(request.description),
                    ...
                    case 1:
                        // Log the request in audit trail
                        _a.sent();
                        return [4 /*yield*/, audit_trail_manager_1.auditTrailManager.createDataSubjectRequest({
                                clinicId: this.config.clinicId,
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.createAlert({
                                ...
                                description: "Nova solicita\u00E7\u00E3o de ".concat(request.type, " com alta urg\u00EAncia requer aten\u00E7\u00E3o imediata"),
                                actionRequired: true,
                    ...
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/, requestId];
                    case 5:
                        error_2 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 7, , 8]);
                        return [4 /*yield*/, consent_automation_manager_1.consentAutomationManager.collectConsent(request)];
                    case 1:
                        consentId = _b.sent();
                        // Log in audit trail
                        return [4 /*yield*/, audit_trail_manager_1.auditTrailManager.logAuditEvent({
                    ...
                    case 3:
                        ...
                        dataType = _a[_i];
                        return [4 /*yield*/, data_retention_manager_1.dataRetentionManager.registerDataForTracking({
                                clinicId: this.config.clinicId,
                                dataType: dataType,
                    ...
                    case 5:
                        _i++;
                        return [3 /*break*/, 3];
                    case 6: return [2 /*return*/, consentId];
                    case 7:
                        error_3 = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, consent_automation_manager_1.consentAutomationManager.withdrawConsent(request)];
                    case 1:
                        // Withdraw the consent
                        _a.sent();
                        // Log in audit trail
    ...
    LGPDComplianceSystem.prototype.runComplianceChecks = function () {
        return __awaiter(this, void 0, void 0, function () {
            var alerts, expiringConsents, retentionAnalytics, auditAnalytics, overdueRequests, _i, alerts_1, alert_1, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 8, , 9]);
                        alerts = [];
                        return [4 /*yield*/, consent_automation_manager_1.consentAutomationManager.getExpiringConsents(this.config.clinicId, 30 // 30 days warning
                            )];
                    case 1:
                        ...
                        if (expiringConsents.length > 0) {
                            alerts.push({
                                ...
                                description: "".concat(expiringConsents.length, " consentimento(s) expirando nos pr\u00F3ximos 30 dias"),
                                actionRequired: true,
                                createdAt: new Date(),
                                metadata: { count: expiringConsents.length }
                            });
                        }
                        return [4 /*yield*/, data_retention_manager_1.dataRetentionManager.getRetentionAnalytics(this.config.clinicId)];
                    case 2:
                        ...
                        if (retentionAnalytics.expiredRecords > 0) {
                            alerts.push({
                                ...
                                description: "".concat(retentionAnalytics.expiredRecords, " registro(s) com per\u00EDodo de reten\u00E7\u00E3o expirado"),
                                actionRequired: true,
                                createdAt: new Date(),
                                metadata: { count: retentionAnalytics.expiredRecords }
                            });
                        }
                        return [4 /*yield*/, audit_trail_manager_1.auditTrailManager.getAuditAnalytics(this.config.clinicId)];
                    case 3:
                        ...
                        if (auditAnalytics.recentViolations.length > 0) {
                            alerts.push({
                                ...
                                description: "".concat(auditAnalytics.recentViolations.length, " viola\u00E7\u00E3o(\u00F5es) de conformidade detectada(s)"),
                                actionRequired: true,
                                createdAt: new Date(),
                        ...
                        if (overdueRequests > 5) { // Threshold for overdue requests
                            alerts.push({
                                ...
                                description: "".concat(overdueRequests, " solicita\u00E7\u00E3o(\u00F5es) de titular pendente(s)"),
                                actionRequired: true,
                                createdAt: new Date(),
    ...
    LGPDComplianceSystem.prototype.generateComplianceReport = function (startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var reportId, _a, complianceStatus, consentAnalytics, auditAnalytics, retentionAnalytics, violations, executiveSummary, error_6;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        _a = _b.sent(), complianceStatus = _a[0], consentAnalytics = _a[1], auditAnalytics = _a[2], retentionAnalytics = _a[3];
                        return [4 /*yield*/, audit_trail_manager_1.auditTrailManager.getAuditTrail(this.config.clinicId, {
                    ...
                    case 2:
                        violations = _b.sent();
                        executiveSummary = this.generateExecutiveSummary(complianceStatus, consentAnalytics, auditAnalytics, retentionAnalytics);
                        return [2 /*return*/, {
                                reportId: reportId,
                                clinicId: this.config.clinicId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, data_retention_manager_1.dataRetentionManager.processExpiredData(this.config.clinicId)];
                    case 1:
                        result = _a.sent();
                        // Clean up expired consents
                        return [4 /*yield*/, consent_automation_manager_1.consentAutomationManager.cleanupExpiredConsents(this.config.clinicId)];
                    case 2:
                        // Clean up expired consents
                        _a.sent();
                        ...
                        return [4 /*yield*/, audit_trail_manager_1.auditTrailManager.logAuditEvent({
                                ...
                                severity: audit_trail_manager_1.LGPDAuditSeverity.INFO,
                                dataType: consent_automation_manager_1.LGPDDataType.PERSONAL_DATA,
                                description: "Automated cleanup completed: ".concat(result.processed, " processed, ").concat(result.deleted, " deleted, ").concat(result.anonymized, " anonymized"),
                                metadata: result
                            })];
                    case 3:
                        // Log cleanup activity
    ...
    LGPDComplianceSystem.prototype.generateRecommendations = function (consentAnalytics, auditAnalytics, retentionAnalytics) {
        var recommendations = [];
    ...
    LGPDComplianceSystem.prototype.generateExecutiveSummary = function (complianceStatus, consentAnalytics, auditAnalytics, retentionAnalytics) {
        var riskText = {
            'LOW': 'baixo',
            'MEDIUM': 'médio',
            'HIGH': 'alto',
        ...
        return "\nResumo Executivo - Conformidade LGPD\n\nA cl\u00EDnica apresenta um score geral de conformidade de ".concat(complianceStatus.overallScore, "% com n\u00EDvel de risco ").concat(riskText, ".\n\nConsentimentos: ").concat(consentAnalytics.activeConsents, " ativos de ").concat(consentAnalytics.totalConsents, " total (").concat(Math.round((consentAnalytics.activeConsents / consentAnalytics.totalConsents) * 100), "% de conformidade).\n\nAuditoria: ").concat(auditAnalytics.recentViolations.length, " viola\u00E7\u00E3o(\u00F5es) recente(s) identificada(s), com tempo m\u00E9dio de resposta de ").concat(Math.round(auditAnalytics.dataSubjectRequests.averageResponseTime), " dias para solicita\u00E7\u00F5es.\n\nReten\u00E7\u00E3o: ").concat(retentionAnalytics.expiredRecords, " registro(s) com per\u00EDodo expirado, ").concat(retentionAnalytics.expiringSoonRecords, " expirando em breve.\n\nRecomenda\u00E7\u00F5es principais: ").concat(complianceStatus.recommendations.slice(0, 3).join('; '), ".\n    ").trim();
    };
    LGPDComplianceSystem.prototype.createAlert = function (alertData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        alert = __assign({ id: "alert-".concat(Date.now(), "-").concat(Math.random().toString(36).substr(2, 9)), createdAt: new Date() }, alertData);
    ...
    LGPDComplianceSystem.prototype.getActiveAlerts = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.alerts.filter(function (alert) { return !alert.resolvedAt; })];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log("Processing data deletion for user ".concat(userId, ", data types: ").concat(dataTypes.join(', ')));
                        return [2 /*return*/];
                }
            });
        });
