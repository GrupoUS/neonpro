...
exports.breachDetectionSystem = exports.BreachDetectionSystem = exports.DetectionSource = exports.AffectedDataCategory = exports.BreachStatus = exports.BreachSeverity = exports.BreachType = void 0;
...
var BreachDetectionSystem = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        incident = __assign(__assign({}, incidentData), { id: this.generateId('incident'), createdAt: new Date(), updatedAt: new Date() });
     ...
     */
    BreachDetectionSystem.prototype.updateIncidentStatus = function (incidentId, status, updatedBy, notes) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        alert = __assign(__assign({}, alertData), { id: this.generateId('alert'), ruleId: ruleId, ruleName: rule.name, responseActions: [], relatedIncidents: [], createdAt: new Date(), updatedAt: new Date() });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.createAlert(rule.id, {
                    ...
                    case 6:
                        _i++;
                        return [3 /*break*/, 3];
                    case 7: return [2 /*return*/, triggeredAlerts];
                }
            });
        });
    };
    ...
    BreachDetectionSystem.prototype.getIncidents = function (filters) {
        ...
        if (filters) {
            if (filters.status) {
                incidents = incidents.filter(function (i) { return i.status === filters.status; });
            }
            if (filters.severity) {
                incidents = incidents.filter(function (i) { return i.severity === filters.severity; });
            }
            if (filters.type) {
                incidents = incidents.filter(function (i) { return i.type === filters.type; });
            }
            if (filters.dateRange) {
                incidents = incidents.filter(function (i) {
                    return i.detectedAt >= filters.dateRange.start &&
                        i.detectedAt <= filters.dateRange.end;
                });
            }
        }
        return incidents.sort(function (a, b) { return b.detectedAt.getTime() - a.detectedAt.getTime(); });
    };
    /**
    ...
    BreachDetectionSystem.prototype.getAlerts = function (filters) {
        ...
        if (filters) {
            ...
            if (filters.ruleId) {
                alerts = alerts.filter(function (a) { return a.ruleId === filters.ruleId; });
            }
        }
        return alerts.sort(function (a, b) { return b.detectedAt.getTime() - a.detectedAt.getTime(); });
    };
    /**
    ...
    BreachDetectionSystem.prototype.calculateSeverity = function (incident) {
        ...
        if (incident.affectedData.categories.includes(AffectedDataCategory.FINANCIAL_DATA))
            score += 25;
        if (incident.affectedData.categories.includes(AffectedDataCategory.HEALTH_DATA))
            score += 25;
        if (incident.affectedData.categories.includes(AffectedDataCategory.BIOMETRIC_DATA))
            score += 20;
        if (incident.affectedData.categories.includes(AffectedDataCategory.CHILDREN_DATA))
            score += 20;
        // Volume scoring
        if (incident.affectedData.estimatedRecords > 100000)
            score += 20;
        else if (incident.affectedData.estimatedRecords > 10000)
            score += 15;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _b = condition.type;
                        switch (_b) {
                            case 'threshold': return [3 /*break*/, 2];
                            case 'pattern': return [3 /*break*/, 3];
                            case 'anomaly': return [3 /*break*/, 4];
                        }
                        return [3 /*break*/, 6];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.evaluateAnomalyCondition(condition, event)];
                    case 5:
                        if (_c.sent()) {
                            return [2 /*return*/, true];
                        }
    ...
    BreachDetectionSystem.prototype.shouldEscalate = function (alert, threshold) {
        ...
        var similarAlerts = Array.from(this.alerts.values())
            .filter(function (a) {
    ...
    BreachDetectionSystem.prototype.startComplianceCheckInterval = function () {
        var _this = this;
        this.complianceCheckInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.performComplianceCheck()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BreachDetectionSystem.prototype.performMonitoringCheck = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    openAlerts = Array.from(this.alerts.values())
                    ...
                    staleIncidents = Array.from(this.incidents.values())
                        .filter(function (i) {
                    ...
                    if (staleIncidents.length > 0) {
                        this.logActivity('system', 'stale_incidents_detected', {
                            ...
                            incidents: staleIncidents.map(function (i) { return i.id; })
                        });
                    }
                }
                catch (error) {
    ...
    BreachDetectionSystem.prototype.getHealthStatus = function () {
        ...
        var openIncidents = Array.from(this.incidents.values())
            .filter(function (i) { return i.status !== BreachStatus.RESOLVED && i.status !== BreachStatus.FALSE_POSITIVE; });
