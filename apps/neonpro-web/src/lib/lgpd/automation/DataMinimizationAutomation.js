...
var DataMinimizationAutomation = /** @class */ (function () {
    ...
    DataMinimizationAutomation.prototype.startDataMinimization = function () {
        return __awaiter(this, arguments, void 0, function (analysisIntervalHours) {
            var error_1;
            var _this = this;
            if (analysisIntervalHours === void 0) { analysisIntervalHours = 24; }
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (this.config.auto_discovery_enabled) {
                            this.analysisInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                                var error_2;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                        ...
                        console.log("Data minimization automation started (".concat(analysisIntervalHours, "h intervals)"));
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
     ...
     */
    DataMinimizationAutomation.prototype.scheduleMinimizationTask = function (ruleId_1, scheduledAt_1) {
        return __awaiter(this, arguments, void 0, function (ruleId, scheduledAt, taskType) {
            var _a, rule, ruleError, affectedRecords, executionPlan, businessImpact, rollbackPlan, _b, task, error, error_4;
            if (taskType === void 0) { taskType = 'scheduled'; }
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.analyzeAffectedRecords(rule)
                            // Generate execution plan
                        ];
                    case 2:
                        affectedRecords = _c.sent();
                        return [4 /*yield*/, this.generateExecutionPlan(rule, affectedRecords)
                            // Generate business impact assessment
                        ];
                    case 3:
                        executionPlan = _c.sent();
                        return [4 /*yield*/, this.assessBusinessImpact(rule, affectedRecords)
                            // Generate rollback plan
                        ];
                    case 4:
                        businessImpact = _c.sent();
                        return [4 /*yield*/, this.generateRollbackPlan(rule, executionPlan)
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        ...
                        switch (_b) {
                            case 'anonymization': return [3 /*break*/, 6];
                            case 'pseudonymization': return [3 /*break*/, 8];
                            case 'aggregation': return [3 /*break*/, 10];
                            case 'deletion': return [3 /*break*/, 12];
                            case 'masking': return [3 /*break*/, 14];
                            case 'encryption': return [3 /*break*/, 16];
                        }
                        return [3 /*break*/, 18];
                    case 6: return [4 /*yield*/, this.executeAnonymization(task)];
                    case 7:
                        recordsProcessed = _d.sent();
                        return [3 /*break*/, 19];
                    case 8: return [4 /*yield*/, this.executePseudonymization(task)];
                    case 9:
                        recordsProcessed = _d.sent();
                        return [3 /*break*/, 19];
                    case 10: return [4 /*yield*/, this.executeAggregation(task)];
                    case 11:
                        recordsProcessed = _d.sent();
                        return [3 /*break*/, 19];
                    case 12: return [4 /*yield*/, this.executeDeletion(task)];
                    case 13:
                        recordsProcessed = _d.sent();
                        return [3 /*break*/, 19];
                    case 14: return [4 /*yield*/, this.executeMasking(task)];
                    case 15:
                        recordsProcessed = _d.sent();
                        return [3 /*break*/, 19];
                    case 16: return [4 /*yield*/, this.executeEncryption(task)];
                    case 17:
                        recordsProcessed = _d.sent();
                        return [3 /*break*/, 19];
                    case 18: throw new Error("Unsupported minimization method: ".concat(task.minimization_method));
                    case 19: 
                    ...
                    case 20:
                        ...
                        for (_i = 0, _c = this.minimizationCallbacks; _i < _c.length; _i++) {
                            callback = _c[_i];
                            try {
                                callback(__assign(__assign({}, task), { status: 'completed', completed_at: new Date().toISOString() }));
                            }
                            catch (error) {
     ...
     */
    DataMinimizationAutomation.prototype.approveMinimizationTask = function (taskId, approvedBy, approvalNotes) {
        return __awaiter(this, void 0, void 0, function () {
            var error, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DataMinimizationAutomation.prototype.getDataInventory = function () {
        return __awaiter(this, arguments, void 0, function (includeAnalysis) {
            ...
            if (includeAnalysis === void 0) { includeAnalysis = true; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.supabase
                                .rpc('get_data_inventory', {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.supabase
                                .rpc('analyze_minimization_opportunities', {
                    ...
                    case 2:
                        ...
                        throw new Error("Failed to analyze minimization opportunities: ".concat(error_8.message));
                    case 3: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.supabase
                                .rpc('get_minimization_dashboard')];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, {
                        ...
                        estimated_duration: this.estimateExecutionDuration(affectedRecords.count, rule.minimization_type),
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, {
                        ...
                        storage_savings: this.calculateStorageSavings(affectedRecords.count, rule.minimization_type),
    ...
    DataMinimizationAutomation.prototype.createDataBackup = function (task) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            .rpc('create_minimization_backup', {
                            task_id: task.id,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        return [2 /*return*/, (result === null || result === void 0 ? void 0 : result.records_processed) || 0];
                }
            });
        });
    };
    ...
    DataMinimizationAutomation.prototype.estimateExecutionDuration = function (recordCount, minimizationType) {
    ...
    DataMinimizationAutomation.prototype.calculateStorageSavings = function (recordCount, minimizationType) {
