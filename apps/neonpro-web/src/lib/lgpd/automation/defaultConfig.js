...
exports.productionLGPDAutomationConfig =
  exports.developmentLGPDAutomationConfig =
 ...
 */
exports.developmentLGPDAutomationConfig = __assign(
  __assign({}, exports.defaultLGPDAutomationConfig),
  {
    consent_automation: __assign(
      __assign({}, exports.defaultLGPDAutomationConfig.consent_automation),
      {
    ...
    data_subject_rights: __assign(
      __assign({}, exports.defaultLGPDAutomationConfig.data_subject_rights),
      {
        response_time_hours: {
    ...
    compliance_monitoring: __assign(
      __assign({}, exports.defaultLGPDAutomationConfig.compliance_monitoring),
      {
    ...
    data_retention: __assign(__assign({}, exports.defaultLGPDAutomationConfig.data_retention), {
    ...
    breach_detection: __assign(__assign({}, exports.defaultLGPDAutomationConfig.breach_detection), {
      notification_settings: {
        email_enabled: false,
        sms_enabled: false,
        webhook_enabled: false,
    ...
    data_minimization: __assign(
      __assign({}, exports.defaultLGPDAutomationConfig.data_minimization),
      {
    ...
    third_party_compliance: __assign(
      __assign({}, exports.defaultLGPDAutomationConfig.third_party_compliance),
      {
    ...
    audit_reporting: __assign(__assign({}, exports.defaultLGPDAutomationConfig.audit_reporting), {
      notification_settings: {
        email_enabled: false,
        webhook_enabled: false,
      },
 ...
 */
exports.productionLGPDAutomationConfig = __assign(
  __assign({}, exports.defaultLGPDAutomationConfig),
  {
    compliance_monitoring: __assign(
      __assign({}, exports.defaultLGPDAutomationConfig.compliance_monitoring),
    ...
    breach_detection: __assign(__assign({}, exports.defaultLGPDAutomationConfig.breach_detection), {
      detection_rules: __assign(
        __assign({}, exports.defaultLGPDAutomationConfig.breach_detection.detection_rules),
        { failed_login_threshold: 3, failed_login_window_minutes: 10 },
      ),
    }),
    data_retention: __assign(__assign({}, exports.defaultLGPDAutomationConfig.data_retention), {
      approval_required: true,
    ...
    data_minimization: __assign(
      __assign({}, exports.defaultLGPDAutomationConfig.data_minimization),
      { approval_required: true, business_impact_assessment: true, safety_checks_enabled: true },
    ),
  },
);
/**
