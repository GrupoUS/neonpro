...
var AuditReportingAutomation = /** @class */ (() => {
   ...
   */
  AuditReportingAutomation.prototype.generateComplianceReport = function (
    reportType_1,
    periodStart_1,
    periodEnd_1,
    scope_1,
    ...
    return __awaiter(
      ...
      arguments,
      void 0,
      function (reportType, periodStart, periodEnd, scope, format, generatedBy) {
        var _a,
          report,
          error,
          reportContent,
        ...
        return __generator(this, function (_g) {
          switch (_g.label) {
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                this.generateReportContent(reportType, periodStart, periodEnd, scope),
            ...
            case 3:
              ...
              return [
                4 /*yield*/,
                this.generateExecutiveSummary(reportContent),
            ...
            case 4:
              ...
              return [
                4 /*yield*/,
                this.identifyKeyFindings(reportContent),
            ...
            case 5:
              ...
              return [
                4 /*yield*/,
                this.analyzeComplianceGaps(reportContent),
            ...
            case 6:
              ...
              return [
                4 /*yield*/,
                this.generateRecommendations(reportContent, complianceGaps),
            ...
            case 8:
              ...
              _g.label = 9;
            case 9:
              _c = (_b = this.supabase.from("lgpd_audit_reports")).update;
              _f = {
                status: "completed",
                file_path: filePath,
              };
          ...
          case 0:
            ...
            return [
              ...
              this.supabase
                ...
                .insert(
                  __assign(__assign({}, scheduleData), {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (!validation.valid) {
              throw new Error(
                "Invalid dashboard configuration: ".concat(validation.errors.join(", ")),
              );
            }
            return [
              4 /*yield*/,
              this.supabase
                ...
                .insert(
                  __assign(__assign({}, dashboardData), {
                    created_at: new Date().toISOString(),
                    updated_at: new Date().toISOString(),
                  }),
                )
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.initializeDashboardData(dashboard.id, dashboardData),
    ...
    return __awaiter(this, arguments, void 0, function (filters, pagination) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            query = this.supabase.from("lgpd_audit_trail").select("*", { count: "exact" });
            // Apply filters
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.rpc("get_executive_compliance_dashboard")];
          case 1:
            (_a = _b.sent()), (dashboard = _a.data), (error = _a.error);
            if (error) throw error;
  ...
  AuditReportingAutomation.prototype.exportAuditData = function (exportType_1, format_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (exportType, format, filters, includeMetadata) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.generateExportData(exportType, filters, includeMetadata),
                // Export to file
              ];
            case 1:
              exportData = _a.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 5:
            ...
            console.error(
              "Error processing scheduled report ".concat(schedule.id, ":"),
              scheduleError_1,
            );
            return [3 /*break*/, 6];
          case 6:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("lgpd_compliance_dashboards").select("*").eq("auto_refresh", true),
            ];
          case 1:
  ...
  AuditReportingAutomation.prototype.generateReportTitle = (reportType, periodStart, periodEnd) => {
    ...
    var titles = {
      compliance_overview: "Relat\u00F3rio de Conformidade LGPD - "
        .concat(startDate, " a ")
        .concat(endDate),
      consent_audit: "Auditoria de Consentimentos - ".concat(startDate, " a ").concat(endDate),
      data_subject_rights: "Relat\u00F3rio de Direitos dos Titulares - "
        .concat(startDate, " a ")
        .concat(endDate),
      breach_incidents: "Relat\u00F3rio de Incidentes de Viola\u00E7\u00E3o - "
        .concat(startDate, " a ")
        .concat(endDate),
      third_party_compliance: "Conformidade de Terceiros - "
        .concat(startDate, " a ")
        .concat(endDate),
      data_retention: "Relat\u00F3rio de Reten\u00E7\u00E3o de Dados - "
        .concat(startDate, " a ")
        .concat(endDate),
    };
  ...
  AuditReportingAutomation.prototype.generateReportContent = function (
    reportType,
    periodStart,
    periodEnd,
    scope,
  ...
  AuditReportingAutomation.prototype.generateRecommendations = function (
    reportContent,
    complianceGaps,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  AuditReportingAutomation.prototype.initializeDashboardData = function (
    dashboardId,
    dashboardData,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  AuditReportingAutomation.prototype.exportDataToFile = function (data, format, exportType) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, (_a) => {
        ...
        return [
          2 /*return*/,
          "/exports/".concat(exportType, "_").concat(Date.now(), ".").concat(format),
        ];
      });
    });
  };
