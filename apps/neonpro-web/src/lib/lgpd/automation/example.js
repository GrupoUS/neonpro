      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            // Criar orquestrador
            this.orchestrator = new index_1.LGPDAutomationOrchestrator(
              this.supabase,
  ...
  LGPDAutomationService.prototype.getEnvironmentConfig = () => {
    ...
    if (ENVIRONMENT === "production") {
      return __assign(__assign({}, baseConfig), {
        ...
        breach_detection: __assign(__assign({}, baseConfig.breach_detection), {
          notification_settings: __assign(
            __assign({}, baseConfig.breach_detection.notification_settings),
            {
...
var LGPDUsageExamples = /** @class */ (() => {
   ...
   */
  LGPDUsageExamples.prototype.collectUserConsent = function (
    userId,
    purpose,
    ipAddress,
    userAgent,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              modules.dataSubjectRights.processAccessRequest({
                user_id: userId,
                request_type: "access",
                contact_email: email,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              modules.dataSubjectRights.processDeletionRequest({
                user_id: userId,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              modules.dataRetention.createRetentionPolicy({
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              modules.thirdPartyCompliance.registerProvider({
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              modules.auditReporting.generateComplianceReport({
        ...
        switch (_b.label) {
          case 0:
            ...
            (_a = req.body),
              (userId = _a.userId),
              (purpose = _a.purpose),
              (ipAddress = _a.ipAddress),
              (userAgent = _a.userAgent);
            examples = new LGPDUsageExamples();
            return [
              4 /*yield*/,
              examples.collectUserConsent(userId, purpose, ipAddress, userAgent),
            ];
          case 1:
            consent = _b.sent();
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              modules.consentAutomation.getConsents({
                user_id: userId,
