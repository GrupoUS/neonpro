...
exports.AuditReportingAutomation =
  ...
  exports.DataMinimizationAutomation =
  exports.BreachDetectionAutomation =
  exports.DataRetentionAutomation =
  exports.RealTimeComplianceMonitor =
  exports.DataSubjectRightsAutomation =
...
var LGPDAutomationOrchestrator = /** @class */ (() => {
  ...
  LGPDAutomationOrchestrator.prototype.initializeModules = function () {
    this.consentAutomation = new ConsentAutomationManager_1.ConsentAutomationManager(
      this.supabase,
      this.complianceManager,
      this.config.consent_automation,
    );
    this.dataSubjectRights = new DataSubjectRightsAutomation_1.DataSubjectRightsAutomation(
      this.supabase,
      this.complianceManager,
      this.config.data_subject_rights,
    );
    this.complianceMonitor = new RealTimeComplianceMonitor_1.RealTimeComplianceMonitor(
      this.supabase,
      this.complianceManager,
      this.config.compliance_monitoring,
    );
    this.dataRetention = new DataRetentionAutomation_1.DataRetentionAutomation(
      this.supabase,
      this.complianceManager,
      this.config.data_retention,
    );
    this.breachDetection = new BreachDetectionAutomation_1.BreachDetectionAutomation(
      this.supabase,
      this.complianceManager,
      this.config.breach_detection,
    );
    this.dataMinimization = new DataMinimizationAutomation_1.DataMinimizationAutomation(
      this.supabase,
      this.complianceManager,
      this.config.data_minimization,
    );
    this.thirdPartyCompliance = new ThirdPartyComplianceAutomation_1.ThirdPartyComplianceAutomation(
      this.supabase,
      this.complianceManager,
      this.config.third_party_compliance,
    );
    this.auditReporting = new AuditReportingAutomation_1.AuditReportingAutomation(
      this.supabase,
      this.complianceManager,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.rpc("get_automation_status")];
          case 1:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.rpc("get_automation_metrics")];
          case 1:
    ...
    return __awaiter(this, arguments, void 0, function (filters, pagination) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            query = this.supabase.from("lgpd_automation_alerts").select("*", { count: "exact" });
            // Apply filters
            if (filters.module) {
   ...
   */
  LGPDAutomationOrchestrator.prototype.resolveAlert = function (
    alertId,
    resolvedBy,
    resolutionNotes,
  ) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.rpc("get_unified_automation_dashboard")];
          case 1:
    ...
    this.breachDetection.onBreachDetected((incident) =>
      __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.complianceMonitor.triggerEmergencyCompliance(incident)];
            case 1:
              _a.sent();
              return [2 /*return*/];
          }
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                this.dataRetention.reviewRetentionForConsent(consent.user_id, consent.purpose),
              ];
            case 1:
              _a.sent();
              return [2 /*return*/];
    ...
    this.dataSubjectRights.onRequestProcessed((request) =>
      __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.complianceMonitor.validateRequestCompliance(request)];
            case 1:
              _a.sent();
              return [2 /*return*/];
          }
    ...
    this.thirdPartyCompliance.onComplianceAssessmentCompleted((assessment) =>
      __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              if (!(assessment.risk_rating === "high" || assessment.risk_rating === "critical"))
                return [3 /*break*/, 2];
              return [
                4 /*yield*/,
                this.createAlert({
                  ...
                  message: "Provider "
                    .concat(assessment.provider_id, " has ")
                    .concat(assessment.risk_rating, " risk rating"),
                  details: assessment,
                }),
              ];
            case 1:
    ...
    this.dataMinimization.onMinimizationOpportunity((opportunity) =>
      __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.dataRetention.evaluateMinimizationOpportunity(opportunity)];
            case 1:
              _a.sent();
              return [2 /*return*/];
          }
