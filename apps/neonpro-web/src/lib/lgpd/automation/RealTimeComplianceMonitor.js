...
var RealTimeComplianceMonitor = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        console.log("Real-time compliance monitoring started (".concat(intervalMinutes, "min intervals)"));
                        return [3 /*break*/, 5];
                    case 4:
                        error_1 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        trends = _b.sent();
                        return [4 /*yield*/, this.getUpcomingLegalDeadlines()
    ...
    RealTimeComplianceMonitor.prototype.performComplianceCheck = function () {
        return __awaiter(this, void 0, void 0, function () {
            var newAlerts, resolvedAlerts, metrics, consentAlerts, rightsAlerts, breachAlerts, retentionAlerts, documentationAlerts, thirdPartyAlerts, alertsError, _i, newAlerts_1, alert_1, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('lgpd_compliance_alerts')
                                .insert(newAlerts.map(function (alert) { return ({
                                type: alert.type,
    ...
    RealTimeComplianceMonitor.prototype.generateComplianceReport = function (reportType_1) {
        return __awaiter(this, arguments, void 0, function (reportType, includeRecommendations) {
            ...
            if (includeRecommendations === void 0) { includeRecommendations = true; }
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, this.getComplianceDashboard()
                    ...
                    case 3:
                        ...
                        if (reportError_1)
                            throw reportError_1;
                        return [2 /*return*/, __assign(__assign({ report_id: report.id }, reportData), { generated_at: new Date().toISOString() })];
                    case 4:
                        error_6 = _c.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.supabase
                                .rpc('calculate_compliance_metrics')];
                    case 1:
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                .select('*')
                                .eq('status', 'granted')
                                .lt('expires_at', new Date(Date.now() + this.config.alert_thresholds.consent_expiry_days * 24 * 60 * 60 * 1000).toISOString())];
                    case 2:
                        ...
                        if (expiringConsents && expiringConsents.length > 0) {
                            alerts.push({
                                ...
                                description: "".concat(expiringConsents.length, " user consents are expiring within ").concat(this.config.alert_thresholds.consent_expiry_days, " days"),
                                severity_score: 60,
                    ...
                    case 2:
                        ...
                        if (overdueRequests && overdueRequests.length > 0) {
                            alerts.push({
                                ...
                                description: "".concat(overdueRequests.length, " data subject requests are overdue"),
                                severity_score: 95,
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                .lt('created_at', new Date(Date.now() - this.config.alert_thresholds.breach_response_hours * 60 * 60 * 1000).toISOString())];
                    case 2:
                        ...
                        if (breachIncidents && breachIncidents.length > 0) {
                            alerts.push({
                                ...
                                description: "".concat(breachIncidents.length, " breach incidents require immediate notification to ANPD"),
                                severity_score: 100,
                                ...
                                affected_users: breachIncidents.reduce(function (sum, incident) { return sum + (incident.affected_users || 0); }, 0),
                                created_at: new Date().toISOString(),
                                status: 'active'
                            });
                        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.supabase
                                .rpc('check_retention_compliance')];
                    case 2:
                        ...
                        if (retentionViolations && retentionViolations.length > 0) {
                            alerts.push({
                                ...
                                description: "".concat(retentionViolations.length, " data records exceed retention periods"),
                                severity_score: 80,
                                auto_resolution_available: true,
                                resolution_steps: [
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.supabase
                                .rpc('check_documentation_compliance')];
                    case 2:
                        ...
                        if (documentationIssues && documentationIssues.missing_documents > 0) {
                            alerts.push({
                                ...
                                description: "".concat(documentationIssues.missing_documents, " required LGPD documents are missing or outdated"),
                                severity_score: 70,
                                auto_resolution_available: false,
                                resolution_steps: [
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.supabase
                                .rpc('check_third_party_compliance')];
                    case 2:
                        ...
                        if (thirdPartyIssues && thirdPartyIssues.non_compliant_shares > 0) {
                            alerts.push({
                                ...
                                description: "".concat(thirdPartyIssues.non_compliant_shares, " third-party data shares lack proper compliance documentation"),
                                severity_score: 85,
                                auto_resolution_available: false,
                                resolution_steps: [
    ...
    RealTimeComplianceMonitor.prototype.handleBreachIncidentAlert = function (incident) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(incident.severity === 'high' || incident.severity === 'critical')) return [3 /*break*/, 2];
                        alert_2 = {
                            id: "breach-incident-".concat(incident.id),
                            type: 'critical',
                            category: 'breach',
                            title: 'New Critical Breach Incident',
                            description: "A ".concat(incident.severity, " severity breach incident has been reported"),
    ...
    RealTimeComplianceMonitor.prototype.handleDataSubjectRequestAlert = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(request.request_type === 'erasure' || request.priority === 'high')) return [3 /*break*/, 2];
                        alert_3 = {
                            id: "data-request-".concat(request.id),
                            type: 'high',
                            category: 'rights',
                            title: 'High-Priority Data Subject Request',
                            description: "A ".concat(request.request_type, " request requires immediate attention"),
                            severity_score: 80,
    ...
    RealTimeComplianceMonitor.prototype.getUpcomingLegalDeadlines = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            .rpc('get_upcoming_legal_deadlines')];
                    case 1:
