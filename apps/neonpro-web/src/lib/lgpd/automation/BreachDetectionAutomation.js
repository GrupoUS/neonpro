...
var BreachDetectionAutomation = /** @class */ (function () {
    ...
    return __awaiter(this, arguments, void 0, function (intervalMinutes) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            console.log(
              "Real-time breach detection started (".concat(intervalMinutes, "min intervals)"),
            );
            return [3 /*break*/, 5];
          case 4:
            error_1 = _a.sent();
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [
              ...
              this.supabase
                ...
                .insert(
                  __assign(__assign({}, incidentData), {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.initializeBreachResponse(incident.id, incidentData),
   ...
   */
  BreachDetectionAutomation.prototype.updateIncidentStatus = function (
    incidentId,
    status,
    notes,
    updatedBy,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            existingNotes =
              (currentIncident === null || currentIncident === void 0
                ? void 0
                : currentIncident.investigation_notes) || [];
            updateData.investigation_notes = __spreadArray(
              __spreadArray([], existingNotes, true),
              [
                {
          ...
          case 2:
            return [
              4 /*yield*/,
              this.supabase.from("lgpd_breach_incidents").update(updateData).eq("id", incidentId),
            ];
          case 3:
            error = _a.sent().error;
            if (error) throw error;
            ...
            return [
              4 /*yield*/,
              this.updateBreachResponseTimeline(incidentId, {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("lgpd_breach_incidents").select("*").eq("id", incidentId).single(),
            ];
          case 1:
            ...
            return [
              4 /*yield*/,
              this.generateANPDNotificationContent(incident),
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.generateUserNotificationContent(incident),
          ...
          case 6:
            ...
            if (notificationError) {
              failedNotifications++;
              console.error(
                "Failed to send notification to user ".concat(user.id, ":"),
                notificationError,
              );
            } else {
              notificationsSent++;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.rpc("get_breach_dashboard")];
          case 1:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.rpc("execute_detection_rule", {
                rule_id: rule.id,
        ...
        switch (_a.label) {
          case 0:
            ...
            incidentData = {
              ...
              description: "Breach detected by rule: "
                .concat(rule.description, ". ")
                .concat(detectionResult.details),
  ...
  BreachDetectionAutomation.prototype.initializeBreachResponse = function (
    incidentId,
    incidentData,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("lgpd_breach_responses").insert({
                incident_id: incidentId,
  ...
  BreachDetectionAutomation.prototype.triggerAutomatedContainment = function (
    incidentId,
    incidentData,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            error_12 = _a.sent();
            console.error(
              "Failed to execute containment action ".concat(action.type, ":"),
              error_12,
            );
            return [3 /*break*/, 5];
          case 5:
  ...
  BreachDetectionAutomation.prototype.triggerBreachNotifications = function (
    incidentId,
    incidentData,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  BreachDetectionAutomation.prototype.updateBreachResponseTimeline = function (
    incidentId,
    timelineEntry,
  ) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        switch (_b.label) {
          ...
          case 1:
            ...
            updatedResponse.response_timeline.push(
              __assign({ timestamp: new Date().toISOString() }, timelineEntry),
            );
            return [
              4 /*yield*/,
              this.supabase
            ...
            function (payload) {
              return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/, this.handleAuthEvent(payload)];
                    case 1:
                      _a.sent();
                      return [2 /*return*/];
                  }
            ...
            function (payload) {
              return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/, this.handleAuditEvent(payload)];
                    case 1:
                      _a.sent();
                      return [2 /*return*/];
                  }
      ...
      return __generator(this, function (_a) {
        ...
        return [
          ...
          "\nNotifica\u00E7\u00E3o de Incidente de Seguran\u00E7a - LGPD\n\nTipo de Incidente: "
            .concat(incident.incident_type, "\nSeveridade: ")
            .concat(incident.severity, "\nData/Hora da Detec\u00E7\u00E3o: ")
            .concat(incident.detection_timestamp, "\n\nDescri\u00E7\u00E3o: ")
            .concat(incident.description, "\n\nDados Afetados:\n- Categorias: ")
            .concat(incident.affected_data_categories.join(", "), "\n- N\u00FAmero de Titulares: ")
            .concat(incident.affected_users_count, "\n- N\u00FAmero de Registros: ")
            .concat(
              incident.affected_records_count,
              "\n\nMedidas de Conten\u00E7\u00E3o: Em andamento\nNotifica\u00E7\u00E3o aos Titulares: ",
            )
            .concat(
              incident.requires_user_notification ? "Necessária" : "Não necessária",
      ...
      return __generator(this, function (_a) {
        ...
        return [
          ...
          "\nCaro(a) Cliente,\n\nInformamos sobre um incidente de seguran\u00E7a que pode ter afetado seus dados pessoais.\n\nO que aconteceu: "
            .concat(incident.description, "\nQuando: ")
            .concat(
              new Date(incident.detection_timestamp).toLocaleString("pt-BR"),
              "\nDados potencialmente afetados: ",
            )
            .concat(
              incident.affected_data_categories.join(", "),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("get_affected_users_by_incident", {
                incident_id: incidentId,
              }),
            ];
          case 1:
