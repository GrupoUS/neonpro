...
var DataSubjectRightsAutomation = /** @class */ (() => {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.generateDataAccessReport(userId, requestId),
   ...
   */
  DataSubjectRightsAutomation.prototype.processDataRectificationRequest = function (
    requestId,
    userId,
    rectificationData,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              this.validateRectificationRequest(
                userId,
                rectification.table,
                rectification.field,
   ...
   */
  DataSubjectRightsAutomation.prototype.processDataErasureRequest = function (
    requestId,
    userId,
    erasureScope,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.analyzeDataForErasure(userId, erasureScope),
   ...
   */
  DataSubjectRightsAutomation.prototype.processDataPortabilityRequest = function (
    requestId,
    userId,
    exportFormat,
    deliveryMethod,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.generatePortableDataPackage(userId, requestId, exportFormat),
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.createSecureDownloadLink(portabilityPackage, deliveryMethod),
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.rpc("monitor_legal_timeline_compliance")];
          case 1:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("generate_data_access_report", {
  ...
  DataSubjectRightsAutomation.prototype.validateRectificationRequest = function (
    userId,
    table,
    field,
    newValue,
  ...
  DataSubjectRightsAutomation.prototype.applyDataRectification = function (
    userId,
    table,
    field,
    currentValue,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("analyze_data_for_erasure", {
                target_user_id: userId,
  ...
  DataSubjectRightsAutomation.prototype.executeSecureDataErasure = function (
    userId,
    eligibleData,
    requestId,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("execute_secure_data_erasure", {
                target_user_id: userId,
  ...
  DataSubjectRightsAutomation.prototype.generatePortableDataPackage = function (
    userId,
    requestId,
    format,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("generate_portable_data_package", {
                target_user_id: userId,
                request_id: requestId,
  ...
  DataSubjectRightsAutomation.prototype.createSecureDownloadLink = function (
    packageData,
    deliveryMethod,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("create_secure_download_link", {
