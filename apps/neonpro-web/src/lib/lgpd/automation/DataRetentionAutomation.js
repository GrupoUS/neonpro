...
var DataRetentionAutomation = /** @class */ (() => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.processRetentionSchedules(),
          ...
          case 1:
            ...
            console.log(
              "Automated retention processing started (".concat(checkIntervalHours, "h intervals)"),
            );
            return [3 /*break*/, 3];
          case 2:
            error_1 = _a.sent();
   ...
   */
  DataRetentionAutomation.prototype.scheduleRetentionExecution = function (
    policyId,
    scheduledDate,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.calculateAffectedRecords(policy),
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.sendRetentionNotification({
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              this.performRetentionExecution(
                execution.id,
            ...
            return [
              ...
              this.supabase
                ...
                .update({
                  ...
                  status: "failed",
                  errors: [
                    { error: executionError_1.message, timestamp: new Date().toISOString() },
                  ],
                })
                .eq("id", execution.id),
              // Update schedule status
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            console.log(
              "Processing ".concat(pendingSchedules.length, " pending retention schedules"),
            );
          ...
          case 5:
            ...
            results.failed++;
            console.error(
              "Failed to execute retention schedule ".concat(schedule.id, ":"),
              scheduleError_1,
            );
            // Log failure
            return [
              ...
              this.complianceManager.logAuditEvent({
                ...
                details: {
                  ...
                  policy_name:
                    (_b = schedule.lgpd_retention_policies) === null || _b === void 0
                      ? void 0
                      : _b.name,
                },
              }),
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.rpc("get_retention_status_report")];
          case 1:
   ...
   */
  DataRetentionAutomation.prototype.approveRetentionSchedule = function (
    scheduleId,
    approvedBy,
    notes,
  ) {
  ...
  DataRetentionAutomation.prototype.validateRetentionPolicy = function (policy) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        ...
        if (
          !["hard_delete", "soft_delete", "anonymize", "archive"].includes(policy.deletion_method)
        ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.rpc("calculate_affected_records", {
  ...
  DataRetentionAutomation.prototype.validateExecutionConditions = function (schedule) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        if (
          !((_a = schedule.lgpd_retention_policies) === null || _a === void 0 ? void 0 : _a.active)
        ) {
  ...
  DataRetentionAutomation.prototype.performRetentionExecution = function (
    executionId,
    policy,
    expectedRecords,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            return [3 /*break*/, 13];
          case 4:
            return [4 /*yield*/, this.performHardDelete(policy)];
          case 5:
            ...
            return [3 /*break*/, 13];
          case 6:
            return [4 /*yield*/, this.performSoftDelete(policy)];
          case 7:
            ...
            return [3 /*break*/, 13];
          case 8:
            return [4 /*yield*/, this.performAnonymization(policy)];
          case 9:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("create_data_archive", {
                execution_id: executionId,
                policy_id: policy.id,
                table_name: policy.table_name,
                retention_period_days: policy.retention_period_days,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("perform_hard_delete", {
                table_name: policy.table_name,
                retention_period_days: policy.retention_period_days,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("perform_soft_delete", {
                table_name: policy.table_name,
                retention_period_days: policy.retention_period_days,
                batch_size: this.config.batch_size,
              }),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("perform_anonymization", {
                table_name: policy.table_name,
                retention_period_days: policy.retention_period_days,
                batch_size: this.config.batch_size,
              }),
