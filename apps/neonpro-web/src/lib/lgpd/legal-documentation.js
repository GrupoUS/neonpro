...
exports.legalDocumentationManager = exports.LegalDocumentationManager = exports.LegalFramework = exports.DocumentLanguage = exports.DocumentStatus = exports.DocumentType = void 0;
...
var LegalDocumentationManager = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        template = __assign(__assign({}, templateData), { id: this.generateId('template'), createdAt: new Date(), updatedAt: new Date() });
                        // Validate template
     ...
     */
    LegalDocumentationManager.prototype.generateDocumentContent = function (document, template, options) {
        return __awaiter(this, void 0, void 0, function () {
            var html, markdown, headerHtml, tocHtml, _loop_1, this_1, _i, _a, section, footerHtml, signatureHtml, _b;
            var _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (template.content.header) {
                            headerHtml = this.processTemplate(template.content.header, document.data.variables, document.data);
                            html += headerHtml;
                        ...
                        _loop_1 = function (section) {
                            var sectionContent = template.content.sections.find(function (s) { return s.sectionId === section.id; });
                            if (!sectionContent)
                                return "continue";
                            // Process main section content
                            var sectionHtml = "<section id=\"".concat(section.id, "\">\n<h2>").concat(section.title, "</h2>\n");
                            var sectionMarkdown = "## ".concat(section.title, "\n\n");
                            var processedContent = this_1.processTemplate(sectionContent.content, document.data.variables, document.data);
                            ...
                            if (sectionContent.conditionalContent) {
                                for (var _e = 0, _f = sectionContent.conditionalContent; _e < _f.length; _e++) {
                                    ...
                                    if (this_1.evaluateCondition(conditional.condition, document.data.variables, document.data)) {
                                        var conditionalHtml = this_1.processTemplate(conditional.content, document.data.variables, document.data);
                        ...
                        this_1 = this;
                        // Process sections
                        for (_i = 0, _a = template.structure.sections.sort(function (a, b) { return a.order - b.order; }); _i < _a.length; _i++) {
                            section = _a[_i];
                            _loop_1(section);
                        }
                        // Add footer
                        if (template.content.footer) {
                            footerHtml = this.processTemplate(template.content.footer, document.data.variables, document.data);
                            html += footerHtml;
                        ...
                        if (!((options === null || options === void 0 ? void 0 : options.generatePdf) && this.config.pdfGeneration)) return [3 /*break*/, 2];
                        _b = document.content;
    ...
    LegalDocumentationManager.prototype.processTemplate = function (template, variables, context) {
        ...
        if (context.processingActivities) {
            var activitiesList = context.processingActivities
                .map(function (activity) { return "<li><strong>".concat(activity.name, "</strong>: ").concat(activity.purpose, "</li>"); })
                .join('\n');
    ...
    LegalDocumentationManager.prototype.evaluateCondition = function (condition, variables, context) {
        ...
        try {
            ...
            var evalContext = __assign(__assign({}, variables), { organization: context.organizationInfo, processingActivities: context.processingActivities || [], hasProcessingActivities: (((_a = context.processingActivities) === null || _a === void 0 ? void 0 : _a.length) || 0) > 0, hasDPO: !!context.organizationInfo.dpo });
            // Simple condition evaluation (in production, use a safer expression evaluator)
            var func = new (Function.bind.apply(Function, __spreadArray(__spreadArray([void 0], Object.keys(evalContext), false), ["return ".concat(condition)], false)))();
        ...
        var sections = template.structure.sections
            ...
            if (section.subsections && section.subsections.length > 0) {
                var subsections = section.subsections
                    .sort(function (a, b) { return a.order - b.order; })
                    .map(function (sub) { return "<li><a href=\"#".concat(sub.id, "\">").concat(sub.title, "</a></li>"); })
                    .join('\n');
                html += "\n<ul>\n".concat(subsections, "\n</ul>");
            }
            html += '</li>';
    ...
    LegalDocumentationManager.prototype.generateSignatureSection = function (document) {
        ...
        return "\n<div class=\"signature-section\">\n<h3>Assinatura e Aprova\u00E7\u00E3o</h3>\n<p>Este documento foi aprovado e \u00E9 v\u00E1lido a partir de ".concat(currentDate, ".</p>\n<div class=\"signature-block\">\n<p><strong>Organiza\u00E7\u00E3o:</strong> ").concat(orgInfo.legalName, "</p>\n<p><strong>CNPJ:</strong> ").concat(orgInfo.cnpj || 'N/A', "</p>\n").concat(orgInfo.dpo ? "<p><strong>Encarregado de Dados:</strong> ".concat(orgInfo.dpo.name, "</p>") : '', "\n<p><strong>Data de Aprova\u00E7\u00E3o:</strong> ").concat(currentDate, "</p>\n</div>\n</div>\n");
    };
    /**
    ...
    LegalDocumentationManager.prototype.generatePdf = function (html) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Buffer.from("PDF content for: ".concat(html.substring(0, 100), "..."))];
            });
        });
    };
    /**
    ...
    LegalDocumentationManager.prototype.getDefaultReviewers = function (type) {
        ...
        var reviewerMap = (_a = {},
            ...
            _a[DocumentType.DATA_SUBJECT_RIGHTS] = [
                { role: 'DPO', name: '', status: 'pending' }
            ],
     ...
     */
    LegalDocumentationManager.prototype.generateComplianceReport = function (reportData, generatedBy) {
        return __awaiter(this, void 0, void 0, function () {
            var report;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        report = __assign(__assign({}, reportData), { id: this.generateId('report'), generatedBy: generatedBy, generatedAt: new Date() });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        hasPrivacyPolicy = existingTemplates.some(function (t) { return t.type === DocumentType.PRIVACY_POLICY; });
    ...
    LegalDocumentationManager.prototype.startReviewMonitoring = function () {
        var _this = this;
        this.reviewCheckInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.checkDueReviews()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        document_1 = _a[_i];
                        if (!(document_1.compliance.nextReview <= now &&
                            document_1.status === DocumentStatus.PUBLISHED)) return [3 /*break*/, 3];
    ...
    LegalDocumentationManager.prototype.getDocuments = function (filters) {
        ...
        if (filters) {
            if (filters.type) {
                documents = documents.filter(function (d) { return d.type === filters.type; });
            }
            if (filters.status) {
                documents = documents.filter(function (d) { return d.status === filters.status; });
            }
            if (filters.language) {
                documents = documents.filter(function (d) { return d.language === filters.language; });
            }
            if (filters.framework) {
                documents = documents.filter(function (d) { return d.compliance.framework === filters.framework; });
            }
        }
        return documents.sort(function (a, b) { return b.updatedAt.getTime() - a.updatedAt.getTime(); });
    };
    /**
    ...
    LegalDocumentationManager.prototype.getTemplates = function (filters) {
        ...
        if (filters) {
            if (filters.type) {
                templates = templates.filter(function (t) { return t.type === filters.type; });
            }
            if (filters.framework) {
                templates = templates.filter(function (t) { return t.framework === filters.framework; });
            }
            if (filters.language) {
                templates = templates.filter(function (t) { return t.language === filters.language; });
            }
        }
        return templates.sort(function (a, b) { return b.updatedAt.getTime() - a.updatedAt.getTime(); });
    };
    /**
    ...
    LegalDocumentationManager.prototype.getReports = function (filters) {
        ...
        if (filters) {
            if (filters.type) {
                reports = reports.filter(function (r) { return r.type === filters.type; });
            }
            if (filters.framework) {
                reports = reports.filter(function (r) { return r.framework === filters.framework; });
            }
            if (filters.dateRange) {
                reports = reports.filter(function (r) {
                    return r.generatedAt >= filters.dateRange.start &&
                        r.generatedAt <= filters.dateRange.end;
                });
            }
        }
        return reports.sort(function (a, b) { return b.generatedAt.getTime() - a.generatedAt.getTime(); });
    };
    /**
     * Generate ID
     */
    ...
    LegalDocumentationManager.prototype.getHealthStatus = function () {
        ...
        var dueReviews = Array.from(this.documents.values())
            .filter(function (d) { return d.compliance.nextReview <= new Date() && d.status === DocumentStatus.PUBLISHED; });
