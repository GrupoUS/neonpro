...
exports.STANDARD_RESPONSE_TIMES = exports.DataSubjectRightsManager = exports.dataSubjectRequestSchema = exports.RequestStatus = exports.DataSubjectRight = void 0;
...
exports.dataSubjectRequestSchema = zod_1.z.object({
    ...
    submittedAt: zod_1.z.date().default(function () { return new Date(); }),
    ...
    processingNotes: zod_1.z.array(zod_1.z.object({
    ...
    documentsGenerated: zod_1.z.array(zod_1.z.object({
        type: zod_1.z.string(),
    ...
    // Communication
    communicationHistory: zod_1.z.array(zod_1.z.object({
        timestamp: zod_1.z.date(),
    ...
    verificationMethod: zod_1.z.enum(['document', 'biometric', 'knowledge_based', 'in_person']).optional(),
...
var DataSubjectRightsManager = /** @class */ (function () {
    ...
    DataSubjectRightsManager.processAccessRequest = function (requestId, processorId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getPersonalData(requestId)];
                    case 1:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.getAuditTrail(requestId)
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.updateRequestStatus(requestId, RequestStatus.COMPLETED, processorId)
                            // Log completion
                        ];
                    case 5:
                        // Update request status
     ...
     */
    DataSubjectRightsManager.processErasureRequest = function (requestId, processorId, justification) {
        return __awaiter(this, void 0, void 0, function () {
            var request, erasureAnalysis, itemsErased, itemsRetained, retentionReasons, _i, _a, item, error_1, _b, _c, item, success;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.getRequest(requestId)];
                    case 1:
                        request = _d.sent();
                        if (!request)
                    ...
                    case 8:
                        ...
                        // Update request status
                        return [4 /*yield*/, this.updateRequestStatus(requestId, success ? RequestStatus.COMPLETED : RequestStatus.PARTIALLY_COMPLETED, processorId)
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, audit_logger_1.AuditLogger.log({
                                ...
                                description: "Right to erasure processed: ".concat(itemsErased, " items erased, ").concat(itemsRetained, " retained"),
                                actorId: processorId,
                                actorType: 'user',
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!request)
                            throw new Error('Request not found');
                        return [4 /*yield*/, this.extractPortableData(request.dataSubjectId, format)
    ...
    DataSubjectRightsManager.updateRequestStatus = function (requestId, status, processorId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log("Request ".concat(requestId, " updated to ").concat(status, " by ").concat(processorId));
                return [2 /*return*/];
            });
        });
    };
 ...
 */
exports.STANDARD_RESPONSE_TIMES = (_a = {},
