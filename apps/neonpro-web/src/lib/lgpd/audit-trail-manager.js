...
exports.createauditTrailManager = exports.AuditTrailManager = exports.LGPDAuditSeverity = exports.LGPDAuditEventType = void 0;
...
var AuditTrailManager = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(event.severity === LGPDAuditSeverity.CRITICAL || event.severity === LGPDAuditSeverity.ERROR)) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3:
                        logger_1.logger.info("LGPD audit event logged: ".concat(event.eventType, " - ").concat(event.severity));
     ...
     */
    AuditTrailManager.prototype.logDataAccess = function (userId, clinicId, dataType, purpose, dataSubjectId, accessDetails, ipAddress, userAgent) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.logAuditEvent({
                            ...
                            details: __assign(__assign({}, accessDetails), { accessedFields: accessDetails.fields || [], recordCount: accessDetails.recordCount || 1 }),
                            ipAddress: ipAddress,
                            userAgent: userAgent,
     ...
     */
    AuditTrailManager.prototype.logDataModification = function (userId, clinicId, dataType, purpose, dataSubjectId, modifications, ipAddress, userAgent) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.logAuditEvent({
     ...
     */
    AuditTrailManager.prototype.logDataDeletion = function (userId, clinicId, dataType, dataSubjectId, deletionReason, deletionDetails, ipAddress, userAgent) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.logAuditEvent({
     ...
     */
    AuditTrailManager.prototype.logDataBreach = function (clinicId, dataType, breachDetails, ipAddress) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.logAuditEvent({
                            ...
                            description: "Data breach: ".concat(breachDetails.breachType, " - ").concat(breachDetails.description),
                            details: __assign(__assign({}, breachDetails), { reportedToANPD: false, dataSubjectsNotified: false, mitigationActions: [] }),
                            ipAddress: ipAddress,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        dataSubjectRequest = __assign(__assign({}, request), { status: 'pending', submittedAt: new Date() });
                        return [4 /*yield*/, this.supabase
                    ...
                    case 2:
                        // Log the request creation
                        _b.sent();
                        logger_1.logger.info("Data subject request created: ".concat(data.id, " - ").concat(request.requestType));
                        return [2 /*return*/, data];
                    case 3:
                        error_2 = _b.sent();
     ...
     */
    AuditTrailManager.prototype.updateDataSubjectRequestStatus = function (requestId, status, responseDetails, assignedTo) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AuditTrailManager.prototype.getAuditAnalytics = function (clinicId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var auditEvents, requestQuery, _a, requests, requestError, eventsByType_1, eventsBySeverity_1, dataTypeCounts_1, compliantEvents, complianceRate, recentViolations, completedRequests, averageResponseTime, riskScore, topDataTypes, error_5;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.getAuditTrail(clinicId, { startDate: startDate, endDate: endDate }, 1000)];
                    case 1:
                        auditEvents = _b.sent();
                    ...
                    case 2:
                        ...
                        if (requestError) {
                            ...
                            throw new Error("Failed to fetch data subject requests: ".concat(requestError.message));
                        }
                        eventsByType_1 = {};
                        eventsBySeverity_1 = {};
                        dataTypeCounts_1 = {};
                        // Initialize counters
                        Object.values(LGPDAuditEventType).forEach(function (type) { return eventsByType_1[type] = 0; });
                        Object.values(LGPDAuditSeverity).forEach(function (severity) { return eventsBySeverity_1[severity] = 0; });
                        Object.values(consent_automation_manager_1.LGPDDataType).forEach(function (type) { return dataTypeCounts_1[type] = 0; });
                        // Count events
                        ...
                        compliantEvents = auditEvents.filter(function (e) { return e.complianceStatus === 'compliant'; }).length;
                        complianceRate = auditEvents.length > 0 ? (compliantEvents / auditEvents.length) * 100 : 100;
                        recentViolations = auditEvents
                            .filter(function (e) { return e.complianceStatus === 'non_compliant'; })
                            .slice(0, 10);
                        completedRequests = (requests === null || requests === void 0 ? void 0 : requests.filter(function (r) { return r.status === 'completed'; })) || [];
                        ...
                        return [2 /*return*/, {
                                ...
                                dataSubjectRequests: {
                                    ...
                                    pending: (requests === null || requests === void 0 ? void 0 : requests.filter(function (r) { return r.status === 'pending'; }).length) || 0,
    ...
    AuditTrailManager.prototype.getLegalBasisForPurpose = function (purpose) {
        var _a;
        var legalBasisMap = (_a = {},
            _a[consent_automation_manager_1.LGPDPurpose.SERVICE_PROVISION] = 'Art. 7º, V - execução de contrato',
            _a[consent_automation_manager_1.LGPDPurpose.LEGAL_OBLIGATION] = 'Art. 7º, II - cumprimento de obrigação legal',
            _a[consent_automation_manager_1.LGPDPurpose.LEGITIMATE_INTEREST] = 'Art. 7º, IX - interesse legítimo',
            _a[consent_automation_manager_1.LGPDPurpose.CONSENT] = 'Art. 7º, I - consentimento',
            _a[consent_automation_manager_1.LGPDPurpose.VITAL_INTEREST] = 'Art. 7º, IV - proteção da vida',
            _a[consent_automation_manager_1.LGPDPurpose.PUBLIC_INTEREST] = 'Art. 7º, III - interesse público',
            _a[consent_automation_manager_1.LGPDPurpose.CONTRACT_PERFORMANCE] = 'Art. 7º, V - execução de contrato',
            _a);
    ...
    AuditTrailManager.prototype.calculateRiskScore = function (auditEvents, dataSubjectRequests) {
        ...
        var nonCompliantEvents = auditEvents.filter(function (e) { return e.complianceStatus === 'non_compliant'; });
        ...
        var overdueRequests = dataSubjectRequests.filter(function (r) {
            if (r.status === 'completed')
                return false;
            var daysSinceSubmission = (Date.now() - new Date(r.submittedAt).getTime()) / (1000 * 60 * 60 * 24);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        logger_1.logger.warn("Data breach response triggered for clinic ".concat(clinicId, ":"), breachDetails);
