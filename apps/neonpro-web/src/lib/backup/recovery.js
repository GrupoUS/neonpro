...
var RecoveryService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        error_1 = _b.sent();
                        return [2 /*return*/, this.handleError('Erro ao criar solicitação de recovery', error_1)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this.storageManager.exists(backup.path)];
                    case 4:
                        exists = _a.sent();
                        if (!exists) {
                            validation.isValid = false;
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 6];
                    case 6: return [2 /*return*/, validation];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        _a = request.type;
                        switch (_a) {
                            case types_1.RecoveryType.FULL_RESTORE: return [3 /*break*/, 3];
                            case types_1.RecoveryType.PARTIAL_RESTORE: return [3 /*break*/, 5];
                            case types_1.RecoveryType.POINT_IN_TIME: return [3 /*break*/, 7];
                            case types_1.RecoveryType.VERIFICATION: return [3 /*break*/, 9];
                        }
                        return [3 /*break*/, 11];
                    case 3: return [4 /*yield*/, this.performFullRestore(request, progress)];
                    case 4:
                        result = _b.sent();
                        return [3 /*break*/, 12];
                    case 5: return [4 /*yield*/, this.performPartialRestore(request, progress)];
                    case 6:
                        result = _b.sent();
                        return [3 /*break*/, 12];
                    case 7: return [4 /*yield*/, this.performPointInTimeRestore(request, progress)];
                    case 8:
                        result = _b.sent();
                        return [3 /*break*/, 12];
                    case 9: return [4 /*yield*/, this.performVerification(request, progress)];
                    case 10:
                        result = _b.sent();
                        return [3 /*break*/, 12];
                    case 11: throw new Error("Tipo de recovery n\u00E3o suportado: ".concat(request.type));
                    case 12: 
                    // Finalizar recovery
                    ...
                    case 16:
                        ...
                        setTimeout(function () { return _this.processRecoveryQueue(); }, 1000);
                        return [7 /*endfinally*/];
    ...
    RecoveryService.prototype.performFullRestore = function (request, progress) {
        return __awaiter(this, void 0, void 0, function () {
            var result, startTime, backup, backupData, extractedFiles, restoredFiles, verification, error_4;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.storageManager.download(backup.path, {
                    ...
                    case 11:
                        ...
                        result.restoredSize = restoredFiles.reduce(function (sum, f) { return sum + f.size; }, 0);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    return [4 /*yield*/, this.supabase
                            ...
                            estimatedCompletion: (_a = progress.estimatedCompletion) === null || _a === void 0 ? void 0 : _a.toISOString()
                        })
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.monitoring.createAlert('RECOVERY_FAILURE', 'HIGH', "Falha no recovery ".concat(request.id, ": ").concat(errorMessage), { requestId: request.id, error: errorMessage })];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.recoveryQueue = this.recoveryQueue.filter(function (r) { return r.id !== requestId; });
                        return [4 /*yield*/, this.supabase
                                .from('recovery_requests')
                                .update({
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        recoveryPoints = (backups || []).map(function (backup) { return ({
                            id: backup.id,
                            timestamp: new Date(backup.startTime),
                            type: backup.type,
                            size: backup.size,
                            description: "Backup ".concat(backup.type, " - ").concat(new Date(backup.startTime).toLocaleString()),
                    ...
                    case 2:
                        error_10 = _b.sent();
                        return [2 /*return*/, this.handleError('Erro ao obter pontos de recuperação', error_10)];
                    case 3: return [2 /*return*/];
                }
            });
        });
    ...
    RecoveryService.prototype.handleError = function (message, error) {
        ...
        return {
            success: false,
            error: (error === null || error === void 0 ? void 0 : error.message) || 'Erro interno do servidor',
            message: message,
            timestamp: new Date(),
            requestId: crypto.randomUUID()
        };
