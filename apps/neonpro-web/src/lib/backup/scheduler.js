...
var SchedulerService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        task = node_cron_1.default.schedule(cronExpression, function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.executeScheduledBackup(config.id)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2: return [4 /*yield*/, this.unscheduleBackup(config.id)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, {
                                success: true,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        scheduledTask.nextRun = this.getNextRunTime(scheduledTask.cronExpression, scheduledTask.config.schedule.timezone);
                        return [4 /*yield*/, audit_logger_1.auditLogger.log({
                                action: 'SCHEDULED_BACKUP_SUCCESS',
                                entityType: 'BACKUP',
                                entityId: ((_a = result.data) === null || _a === void 0 ? void 0 : _a.id) || 'unknown',
                    ...
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 6];
                    case 5: throw new Error(result.error || 'Falha no backup');
                    ...
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, this.updateScheduledTask(scheduledTask)];
                    case 10:
                        _b.sent();
                        return [7 /*endfinally*/];
    ...
    SchedulerService.prototype.scheduleToCron = function (schedule) {
        var frequency = schedule.frequency, time = schedule.time, dayOfWeek = schedule.dayOfWeek, dayOfMonth = schedule.dayOfMonth;
    ...
    SchedulerService.prototype.listScheduledTasks = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    tasks = Array.from(this.scheduledTasks.values()).map(function (task) { return ({
                        id: task.id,
                        configId: task.configId,
                        cronExpression: task.cronExpression,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [4 /*yield*/, audit_logger_1.auditLogger.log({
    ...
    SchedulerService.prototype.getSchedulerStats = function () {
        ...
        var stats = {
            ...
            activeTasks: tasks.filter(function (t) { return t.status === types_1.TaskStatus.SCHEDULED; }).length,
            pausedTasks: tasks.filter(function (t) { return t.status === types_1.TaskStatus.PAUSED; }).length,
            failedTasks: tasks.filter(function (t) { return t.status === types_1.TaskStatus.FAILED; }).length,
            nextExecution: undefined
        };
        // Encontrar próxima execução
        var nextRuns = tasks
            .filter(function (t) { return t.status === types_1.TaskStatus.SCHEDULED; })
            .map(function (t) { return t.nextRun; })
