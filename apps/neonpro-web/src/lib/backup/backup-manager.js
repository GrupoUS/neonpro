...
var BackupManager = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        // Validar configuração
                        _b.sent();
                        newConfig = __assign(__assign({}, config), { id: crypto.randomUUID(), createdAt: new Date(), updatedAt: new Date() });
                    ...
                    case 6:
                        error_1 = _b.sent();
                        return [2 /*return*/, this.handleError('Erro ao criar configuração de backup', error_1)];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, audit_logger_1.auditLogger.log({
    ...
    BackupManager.prototype.listBackupConfigs = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, page, _c, limit, _d, sortBy, _e, sortOrder, offset, _f, data, error, count, totalPages, error_3;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        _g.trys.push([0, 2, , 3]);
                        _a = options || {}, _b = _a.page, page = _b === void 0 ? 1 : _b, _c = _a.limit, limit = _c === void 0 ? 20 : _c, _d = _a.sortBy, sortBy = _d === void 0 ? 'createdAt' : _d, _e = _a.sortOrder, sortOrder = _e === void 0 ? 'DESC' : _e;
                        offset = (page - 1) * limit;
                        return [4 /*yield*/, this.supabase
                                .from('backup_configs')
                                .select('*', { count: 'exact' })
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 11:
                        ...
                        return [4 /*yield*/, this.updateBackupStatus(record.id, types_1.BackupStatus.FAILED, error_5.message)];
                    case 12:
                        // Atualizar status para FAILED
                        _a.sent();
                        // Notificar falha
                        return [4 /*yield*/, this.monitoring.notifyBackupFailure(record.id, config, error_5.message)];
                    case 13:
                        // Notificar falha
                        _a.sent();
                        return [4 /*yield*/, audit_logger_1.auditLogger.log({
    ...
    BackupManager.prototype.executeBackupByType = function (config, progress) {
        return __awaiter(this, void 0, void 0, function () {
            var results, _i, _a, dataType, _b, dbResult, filesResult, logsResult, configResult, mediaResult, docsResult, compressedResult, encryptedResult;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _b = dataType;
                        switch (_b) {
                            case types_1.DataType.DATABASE: return [3 /*break*/, 2];
                            case types_1.DataType.FILES: return [3 /*break*/, 4];
                            case types_1.DataType.LOGS: return [3 /*break*/, 6];
                            case types_1.DataType.CONFIG: return [3 /*break*/, 8];
                            case types_1.DataType.MEDIA: return [3 /*break*/, 10];
                            case types_1.DataType.DOCUMENTS: return [3 /*break*/, 12];
                        }
                        return [3 /*break*/, 14];
                    case 2: return [4 /*yield*/, this.backupDatabase(config, progress)];
                    case 3:
                        dbResult = _c.sent();
                        results.size += dbResult.size;
                        results.filesCount += dbResult.filesCount;
                        return [3 /*break*/, 14];
                    case 4: return [4 /*yield*/, this.backupFiles(config, progress)];
                    case 5:
                        filesResult = _c.sent();
                        results.size += filesResult.size;
                        results.filesCount += filesResult.filesCount;
                        return [3 /*break*/, 14];
                    case 6: return [4 /*yield*/, this.backupLogs(config, progress)];
                    case 7:
                        logsResult = _c.sent();
                        results.size += logsResult.size;
                        results.filesCount += logsResult.filesCount;
                        return [3 /*break*/, 14];
                    case 8: return [4 /*yield*/, this.backupConfig(config, progress)];
                    case 9:
                        configResult = _c.sent();
                        results.size += configResult.size;
                        results.filesCount += configResult.filesCount;
                        return [3 /*break*/, 14];
                    case 10: return [4 /*yield*/, this.backupMedia(config, progress)];
                    case 11:
                        mediaResult = _c.sent();
                        results.size += mediaResult.size;
                        results.filesCount += mediaResult.filesCount;
                        return [3 /*break*/, 14];
                    case 12: return [4 /*yield*/, this.backupDocuments(config, progress)];
                    case 13:
                        docsResult = _c.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        recoveryRequest = __assign(__assign({}, request), { id: crypto.randomUUID(), requestedAt: new Date(), status: 'NOT_STARTED' });
                        return [4 /*yield*/, this.supabase
    ...
    BackupManager.prototype.listBackups = function (filter, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, page, _c, limit, _d, sortBy, _e, sortOrder, offset, query, _f, data, error, count, totalPages, error_8;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        _g.trys.push([0, 2, , 3]);
                        _a = options || {}, _b = _a.page, page = _b === void 0 ? 1 : _b, _c = _a.limit, limit = _c === void 0 ? 20 : _c, _d = _a.sortBy, sortBy = _d === void 0 ? 'startTime' : _d, _e = _a.sortOrder, sortOrder = _e === void 0 ? 'DESC' : _e;
                        offset = (page - 1) * limit;
                        query = this.supabase
                            .from('backup_records')
                            .select('*', { count: 'exact' });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (status === types_1.BackupStatus.COMPLETED || status === types_1.BackupStatus.FAILED) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.updateBackupStatus(progress.backupId, types_1.BackupStatus.CANCELLED)];
                    case 1:
                        // Atualizar status para CANCELLED
                        _a.sent();
