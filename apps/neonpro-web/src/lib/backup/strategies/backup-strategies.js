...
exports.BackupStrategyManager = exports.FileSystemBackupStrategy = exports.DatabaseBackupStrategy = void 0;
...
var DatabaseBackupStrategy = /** @class */ (function () {
    ...
    DatabaseBackupStrategy.prototype.backup = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, errors, warnings, totalSize, filesProcessed, connectionTest, tables, _i, tables_1, table, tableBackup, error_1, schemaBackup, checksum, compressedSize, executionTime, storageLocation, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 12:
                        _i++;
                        return [3 /*break*/, 5];
                    case 13: return [4 /*yield*/, this.backupDatabaseSchema(context)];
                    case 14:
    ...
    DatabaseBackupStrategy.prototype.compressBackup = function (jobId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getBackupSize(jobId)];
                    case 1:
    ...
    DatabaseBackupStrategy.prototype.encryptBackup = function (jobId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getBackupData(jobId)];
                    case 1:
                        backupData = _a.sent();
...
var FileSystemBackupStrategy = /** @class */ (function () {
    ...
    FileSystemBackupStrategy.prototype.backup = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, errors, warnings, totalSize, filesProcessed, filesSkipped, backupPaths, _i, backupPaths_1, path, pathResult, error_12, checksum, compressedSize, executionTime, storageLocation, error_13;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        startTime = Date.now();
                    ...
                    case 7:
                        _i++;
                        return [3 /*break*/, 3];
                    case 8: return [4 /*yield*/, this.generateFileSystemChecksum(context.job_id)];
                    case 9:
                        checksum = _a.sent();
                        compressedSize = totalSize;
    ...
    FileSystemBackupStrategy.prototype.getBackupPaths = function (context) {
        ...
        return paths.filter(function (path) {
            return context.strategy.data_sources.includes('files') ||
    ...
    FileSystemBackupStrategy.prototype.generateFileSystemChecksum = function (jobId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, "fs_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9))];
            });
        });
    };
    FileSystemBackupStrategy.prototype.compressFileSystemBackup = function (jobId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getFileSystemBackupSize(jobId)];
                    case 1:
                        originalSize = _a.sent();
    ...
    FileSystemBackupStrategy.prototype.restoreFiles = function (backupLocation, targetLocation) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log("Restaurando arquivos de ".concat(backupLocation, " para ").concat(targetLocation));
                return [2 /*return*/];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        validation = _a.sent();
                        if (!validation.valid) {
                            throw new Error("Estrat\u00E9gia inv\u00E1lida: ".concat(validation.errors.join(', ')));
                        }
                        return [2 /*return*/];
                }
            });
