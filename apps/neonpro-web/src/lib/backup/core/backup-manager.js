          ...
          case 0:
            ...
            job = {
              ...
              metadata: {
                ...
                priority:
                  (options === null || options === void 0 ? void 0 : options.priority) || "normal",
                notify_on_completion:
                  (options === null || options === void 0
                    ? void 0
                    : options.notify_on_completion) || false,
              },
              created_by: userId,
              created_at: new Date(),
            };
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("backup_jobs").select("*").eq("id", jobId).single(),
            ];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4 /*yield*/, this.supabase.from("recovery_points").insert(recoveryPoint)];
          case 2:
            error = _a.sent().error;
            if (error) throw error;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("recovery_points").select("*").eq("id", recoveryPointId).single(),
            ];
          case 1:
            ...
            return [4 /*yield*/, this.supabase.from("recovery_requests").insert(recoveryRequest)];
          case 2:
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            verification = {
              ...
              details: "Checksum: "
                .concat(checksumVerification ? "OK" : "FALHOU", ", Integridade: ")
                .concat(integrityCheck ? "OK" : "FALHOU"),
              verified_at: new Date(),
            };
            // Salvar verificação
            return [4 /*yield*/, this.supabase.from("backup_verifications").insert(verification)];
          case 4:
            // Salvar verificação
            _a.sent();
            return [
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("backup_jobs").select("*").in("status", ["pending", "running"]),
            ];
          case 1:
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [3 /*break*/, 6];
          case 2:
            return [4 /*yield*/, this.backupDatabase()];
          case 3:
            dbBackup = _c.sent();
            ...
            return [3 /*break*/, 6];
          case 4:
            return [4 /*yield*/, this.backupFiles()];
          case 5:
            filesBackup = _c.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error || !request) return [2 /*return*/];
            _b.label = 2;
          case 2:
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("backup_jobs").insert({
                id: job.id,
                type: job.type,
                status: job.status,
                data_sources: job.data_sources,
                started_at:
                  (_a = job.started_at) === null || _a === void 0 ? void 0 : _a.toISOString(),
                completed_at:
                  (_b = job.completed_at) === null || _b === void 0 ? void 0 : _b.toISOString(),
