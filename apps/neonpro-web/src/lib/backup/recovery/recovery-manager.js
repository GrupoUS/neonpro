...
var RecoveryManager = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!!(options === null || options === void 0 ? void 0 : options.force_execution)) return [3 /*break*/, 3];
                    ...
                    case 3:
                        ...
                        estimatedCompletion.setMinutes(estimatedCompletion.getMinutes() + plan.estimated_duration_minutes);
                        execution = {
                            id: executionId_1,
                            plan_id: planId,
                            status: 'pending',
                            ...
                            executed_by: userId,
                            metadata: {
                                dry_run: (options === null || options === void 0 ? void 0 : options.dry_run) || false,
                                skip_validation: (options === null || options === void 0 ? void 0 : options.skip_validation) || false,
                                custom_parameters: (options === null || options === void 0 ? void 0 : options.custom_parameters) || {}
                            }
                        };
                        // Salvar execução
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        execution.actual_duration_minutes = Math.floor((execution.completed_at.getTime() - execution.started_at.getTime()) / 60000);
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                limit: (pagination === null || pagination === void 0 ? void 0 : pagination.limit) || plans.length
                            }];
                    case 2:
                        error_6 = _b.sent();
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                total: count || 0,
                                page: (pagination === null || pagination === void 0 ? void 0 : pagination.page) || 1,
                                limit: (pagination === null || pagination === void 0 ? void 0 : pagination.limit) || executions.length
                            }];
                    case 2:
                        error_7 = _b.sent();
    ...
    RecoveryManager.prototype.getRecoveryMetrics = function () {
        return __awaiter(this, arguments, void 0, function (period) {
            var startDate, _a, executions, error, totalRecoveries_1, successfulRecoveries, failedRecoveries, successRate, completedExecutions, averageDuration, errorCounts_1, mostCommonErrors, recoveryTrends, dataSourcePerformance, error_8;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        successfulRecoveries = executions.filter(function (e) { return e.status === 'completed'; }).length;
                        failedRecoveries = executions.filter(function (e) { return e.status === 'failed'; }).length;
                        successRate = totalRecoveries_1 > 0 ? (successfulRecoveries / totalRecoveries_1) * 100 : 0;
                        completedExecutions = executions.filter(function (e) { return e.actual_duration_minutes; });
                        averageDuration = completedExecutions.length > 0 ?
                            completedExecutions.reduce(function (sum, e) { return sum + e.actual_duration_minutes; }, 0) / completedExecutions.length : 0;
                        errorCounts_1 = new Map();
                        executions.forEach(function (e) {
                            var _a;
                            (_a = e.errors) === null || _a === void 0 ? void 0 : _a.forEach(function (error) {
    ...
    RecoveryManager.prototype.testRecoveryPlan = function (planId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var plan, issues, warnings, estimatedDuration, _i, _a, step, stepValidation, dependencyValidation, backupValidation, error_9;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 9, , 10]);
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [4 /*yield*/, this.validateStepDependencies(plan.recovery_steps)];
                    case 6:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 9];
                    case 1: return [4 /*yield*/, this.prepareRecoveryStep(step, execution)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 3: return [4 /*yield*/, strategy.restore(step.backup_location, step.target_location)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 5: return [4 /*yield*/, strategy.validate(step.backup_location)];
                    case 6:
                        isValid = _b.sent();
                        if (!isValid) {
                        ...
                        return [3 /*break*/, 10];
                    case 7: return [4 /*yield*/, this.cleanupRecoveryStep(step, execution)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 9: throw new Error("Tipo de step n\u00E3o suportado: ".concat(step.type));
                    case 10: return [2 /*return*/];
                }
            });
        });
    ...
    RecoveryManager.prototype.executeRollbackSteps = function (rollbackSteps, execution) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _i = 0, _a = rollbackSteps.sort(function (a, b) { return a.order - b.order; });
                        _b.label = 1;
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = check.type;
                        switch (_a) {
                            case 'checksum': return [3 /*break*/, 1];
                            case 'integrity': return [3 /*break*/, 3];
                            case 'connectivity': return [3 /*break*/, 5];
                            case 'performance': return [3 /*break*/, 7];
                            case 'custom': return [3 /*break*/, 9];
                        }
                        return [3 /*break*/, 12];
                    case 1: return [4 /*yield*/, this.validateChecksum(check.target)];
                    case 2:
                        actualResult = _b.sent();
                        return [3 /*break*/, 12];
                    case 3: return [4 /*yield*/, this.validateIntegrity(check.target)];
                    case 4:
                        actualResult = _b.sent();
                        return [3 /*break*/, 12];
                    case 5: return [4 /*yield*/, this.validateConnectivity(check.target)];
                    case 6:
                        actualResult = _b.sent();
                        return [3 /*break*/, 12];
                    case 7: return [4 /*yield*/, this.validatePerformance(check.target)];
                    case 8:
                        actualResult = _b.sent();
                        return [3 /*break*/, 12];
                    case 9:
                    ...
                    case 12:
                        ...
                        if (actualResult !== check.expected_result) {
                            ...
                            if (difference > check.tolerance) {
                                status = 'failed';
                                message = "Resultado ".concat(actualResult, " difere do esperado ").concat(check.expected_result);
                            }
                            else {
                                status = 'warning';
    ...
    RecoveryManager.prototype.orderStepsByDependencies = function (steps) {
        ...
        return steps.sort(function (a, b) { return a.order - b.order; });
    };
    ...
    RecoveryManager.prototype.validateStepDependencies = function (steps) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                errors = [];
                stepIds = new Set(steps.map(function (s) { return s.id; }));
                for (_i = 0, steps_1 = steps; _i < steps_1.length; _i++) {
                    step = steps_1[_i];
                    for (_a = 0, _b = step.dependencies; _a < _b.length; _a++) {
                        dependency = _b[_a];
                        if (!stepIds.has(dependency)) {
                            errors.push("Depend\u00EAncia n\u00E3o encontrada: ".concat(dependency, " para step ").concat(step.id));
                        }
                    }
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, { valid: errors.length === 0, errors: errors }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            ...
                            completed_at: (_a = execution.completed_at) === null || _a === void 0 ? void 0 : _a.toISOString(),
