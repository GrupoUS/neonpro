...
var BackupRecoverySystem = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        // Configurar estratégias de backup padrão
                        _a.sent();
                        if (!((config === null || config === void 0 ? void 0 : config.auto_start_backup) !== false)) return [3 /*break*/, 4];
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.auditLogger.log({
                                ...
                                resource_id: 'main',
                                details: {
                                    auto_start_backup: config === null || config === void 0 ? void 0 : config.auto_start_backup,
                                    encryption_enabled: config === null || config === void 0 ? void 0 : config.encryption_enabled,
                                    compression_enabled: config === null || config === void 0 ? void 0 : config.compression_enabled
                                }
                            })];
                    case 5:
                        _a.sent();
                    ...
                    case 0:
                        ...
                        backupConfig = {
                            ...
                            storage_config: {
                                ...
                                encryption_enabled: (_a = config.encryption_enabled) !== null && _a !== void 0 ? _a : true,
                                compression_enabled: (_b = config.compression_enabled) !== null && _b !== void 0 ? _b : true,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_11 = _a.sent();
                        throw new Error("Erro ao listar execu\u00E7\u00F5es de recupera\u00E7\u00E3o: ".concat(error_11));
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (period) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_13 = _a.sent();
                        throw new Error("Erro ao obter m\u00E9tricas de recupera\u00E7\u00E3o: ".concat(error_13));
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2: return [4 /*yield*/, this.backupManager.listBackups({
                            status: ['completed'],
                    ...
                    case 9: return [2 /*return*/, {
                            ...
                            valid_backups: verificationResults.filter(function (r) { return r.valid; }).length,
                            invalid_backups: verificationResults.filter(function (r) { return !r.valid; }).length,
    ...
    BackupRecoverySystem.prototype.getSystemReport = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, backupMetrics, recoveryMetrics, storageMetrics, storageConnections, allConnectionsHealthy, backupSuccessRate, recoverySuccessRate, systemStatus, recommendations, totalStorageUsed, totalStorageAvailable, recentActivities, error_25;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        _a = _b.sent(), backupMetrics = _a[0], recoveryMetrics = _a[1], storageMetrics = _a[2], storageConnections = _a[3];
                        allConnectionsHealthy = Object.values(storageConnections).every(function (connected) { return connected; });
                        ...
                        totalStorageUsed = storageMetrics.reduce(function (sum, metric) { return sum + metric.used_storage_gb; }, 0);
                        totalStorageAvailable = storageMetrics.reduce(function (sum, metric) { return sum + metric.total_storage_gb; }, 0);
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, this.storageManager.registerProvider({
                            provider: 'local',
                            name: 'local_default',
                            enabled: true,
                            priority: 1,
