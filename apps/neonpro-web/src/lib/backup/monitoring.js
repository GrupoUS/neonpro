...
var MonitoringService = /** @class */ (function () {
    ...
    MonitoringService.prototype.calculateMetrics = function (startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var start, end, _a, backups, error, records, totalBackups, successfulBackups, failedBackups, totalSize, totalDuration, successRate, averageSize, averageDuration, lastBackup, nextScheduled, nextBackup, previousPeriod, previousBackups, previousTotal, previousSuccessful, previousSuccessRate, trends, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        successfulBackups = records.filter(function (b) { return b.status === types_1.BackupStatus.COMPLETED; }).length;
                        failedBackups = records.filter(function (b) { return b.status === types_1.BackupStatus.FAILED; }).length;
                        totalSize = records.reduce(function (sum, b) { return sum + (b.size || 0); }, 0);
                        totalDuration = records
                            .filter(function (b) { return b.duration; })
                            .reduce(function (sum, b) { return sum + b.duration; }, 0);
                        successRate = totalBackups > 0 ? (successfulBackups / totalBackups) * 100 : 100;
                        averageSize = totalBackups > 0 ? totalSize / totalBackups : 0;
                        averageDuration = records.filter(function (b) { return b.duration; }).length > 0
                            ? totalDuration / records.filter(function (b) { return b.duration; }).length
                            : 0;
                    ...
                    case 3:
                        ...
                        previousTotal = (previousBackups === null || previousBackups === void 0 ? void 0 : previousBackups.length) || 0;
                        previousSuccessful = (previousBackups === null || previousBackups === void 0 ? void 0 : previousBackups.filter(function (b) { return b.status === types_1.BackupStatus.COMPLETED; }).length) || 0;
                        previousSuccessRate = previousTotal > 0 ? (previousSuccessful / previousTotal) * 100 : 100;
                        trends = {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_2 = _a.sent();
                        return [2 /*return*/, this.handleError('Erro ao obter métricas em tempo real', error_2)];
    ...
    MonitoringService.prototype.updateRealTimeMetrics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var activeBackups, queuedBackups, yesterday, failedBackups, storageData, totalStorage, recentBackups, recentTotal, recentSuccessful, successRate, completedBackups, averageBackupTime, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 4:
                        ...
                        totalStorage = (storageData === null || storageData === void 0 ? void 0 : storageData.reduce(function (sum, b) { return sum + (b.size || 0); }, 0)) || 0;
                        return [4 /*yield*/, this.supabase
                                .from('backup_records')
                                .select('status')
                                .gte('startTime', yesterday.toISOString())];
                    case 5:
                        ...
                        recentTotal = (recentBackups === null || recentBackups === void 0 ? void 0 : recentBackups.length) || 0;
                        recentSuccessful = (recentBackups === null || recentBackups === void 0 ? void 0 : recentBackups.filter(function (b) { return b.status === types_1.BackupStatus.COMPLETED; }).length) || 0;
                    ...
                    case 6:
                        ...
                        averageBackupTime = (completedBackups === null || completedBackups === void 0 ? void 0 : completedBackups.length) > 0
                            ? completedBackups.reduce(function (sum, b) { return sum + b.duration; }, 0) / completedBackups.length
                            : 0;
                        // Atualizar métricas
                        this.realTimeMetrics = {
                            activeBackups: (activeBackups === null || activeBackups === void 0 ? void 0 : activeBackups.length) || 0,
                            queuedBackups: (queuedBackups === null || queuedBackups === void 0 ? void 0 : queuedBackups.length) || 0,
                            failedBackups: (failedBackups === null || failedBackups === void 0 ? void 0 : failedBackups.length) || 0,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        metrics = _a.sent();
                        if (!(metrics.successRate < (100 - this.config.alertThresholds.failureRate * 100))) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.createAlert(types_1.AlertType.BACKUP_FAILURE, types_1.AlertSeverity.HIGH, "Taxa de sucesso baixa: ".concat(metrics.successRate.toFixed(1), "%"), { successRate: metrics.successRate, threshold: this.config.alertThresholds.failureRate })];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
                        if (!(metrics.averageDuration > this.config.alertThresholds.maxBackupTime)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.createAlert(types_1.AlertType.PERFORMANCE, types_1.AlertSeverity.MEDIUM, "Tempo de backup acima do limite: ".concat(Math.round(metrics.averageDuration / 60), " minutos"), { averageDuration: metrics.averageDuration, threshold: this.config.alertThresholds.maxBackupTime })];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5: 
    ...
    MonitoringService.prototype.checkStaleBackups = function () {
        return __awaiter(this, void 0, void 0, function () {
            var configs, _i, _a, config, lastBackup, lastBackupTime, hoursSinceLastBackup, maxHours, error_6;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.createAlert(types_1.AlertType.BACKUP_OVERDUE, types_1.AlertSeverity.HIGH, "Backup atrasado para configura\u00E7\u00E3o \"".concat(config.name, "\": ").concat(Math.round(hoursSinceLastBackup), " horas"), {
                                configId: config.id,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5:
                        schedulerStats = (_a = this.backupManager.scheduler) === null || _a === void 0 ? void 0 : _a.getSchedulerStats();
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 9];
                    case 9: return [2 /*return*/, healthCheck];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        if (!((_a = config.notifications) === null || _a === void 0 ? void 0 : _a.onSuccess)) return [3 /*break*/, 2];
                        notification = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        // Criar alerta
                        return [4 /*yield*/, this.createAlert(types_1.AlertType.BACKUP_FAILURE, types_1.AlertSeverity.HIGH, "Falha no backup \"".concat(config.name, "\": ").concat(errorMessage), { backupId: backupId, configId: config.id, error: errorMessage }, config.id)];
                    case 2:
                        // Criar alerta
                        _a.sent();
                        return [3 /*break*/, 4];
    ...
    MonitoringService.prototype.getPerformanceHistory = function (hours) {
        ...
        return this.performanceHistory.filter(function (m) { return m.timestamp >= cutoff; });
    };
    /**
