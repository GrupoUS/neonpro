...
exports.StorageManager = exports.S3StorageProvider = exports.LocalStorageProvider = exports.StorageProvider = void 0;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'decrypt': return [3 /*break*/, 4];
                            case 'compress': return [3 /*break*/, 7];
                            case 'decompress': return [3 /*break*/, 10];
                        }
                        return [3 /*break*/, 13];
                    case 1:
...
var LocalStorageProvider = /** @class */ (function (_super) {
    ...
    LocalStorageProvider.prototype.upload = function (localPath, remotePath, options) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, processedPath, targetPath, fileSize, checksum, duration, transferRate, location_1, error_1, duration;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        startTime = Date.now();
...
var S3StorageProvider = /** @class */ (function (_super) {
    ...
    S3StorageProvider.prototype.upload = function (localPath, remotePath, options) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, processedPath, fileSize, checksum, duration, transferRate, location_2, error_5, duration;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        startTime = Date.now();
                    ...
                    case 4:
                        processedPath = _a.sent();
                        _a.label = 5;
                    case 5: return [4 /*yield*/, this.getFileSize(processedPath)];
                    case 6:
                        fileSize = _a.sent();
                        return [4 /*yield*/, this.calculateChecksum(processedPath)];
                    case 7:
                        ...
                        console.log("Uploading ".concat(processedPath, " to S3: ").concat(this.bucket, "/").concat(remotePath));
                        duration = Date.now() - startTime;
                        transferRate = (fileSize / 1024 / 1024) / (duration / 1000);
                        location_2 = {
                            id: this.generateLocationId(),
                            ...
                            expires_at: this.config.retention_days > 0 ?
                                new Date(Date.now() + this.config.retention_days * 24 * 60 * 60 * 1000) : undefined,
                            metadata: __assign({ bucket: this.bucket, storage_class: (options === null || options === void 0 ? void 0 : options.storage_class) || 'STANDARD' }, options === null || options === void 0 ? void 0 : options.metadata)
                        };
                        return [2 /*return*/, {
                                success: true,
                                location: location_2,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 6, , 7]);
                        console.log("Downloading from S3: ".concat(this.bucket, "/").concat(remotePath, " to ").concat(localPath));
                        fileSize = 1024 * 1024;
                        processedPath = localPath;
                        if (!this.config.encryption_enabled) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.processFile(processedPath, 'decrypt')];
    ...
    S3StorageProvider.prototype.exists = function (remotePath) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    console.log("Verificando exist\u00EAncia no S3: ".concat(this.bucket, "/").concat(remotePath));
                    return [2 /*return*/, true];
                }
                catch (error) {
                    return [2 /*return*/, false];
...
var StorageManager = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        operation = (_a.bytes_total = _b.sent(),
                            _a.bytes_transferred = 0,
                            _a.transfer_rate_mbps = 0,
                            _a.retry_count = 0,
                            _a.max_retries = 3,
                            _a.metadata = (options === null || options === void 0 ? void 0 : options.metadata) || {},
                            _a);
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                limit: (pagination === null || pagination === void 0 ? void 0 : pagination.limit) || operations.length
                            }];
                    case 2:
                        error_16 = _b.sent();
    ...
    StorageManager.prototype.selectBestProvider = function (operation) {
        ...
        var availableProviders = Array.from(this.providers.values())
            .filter(function (provider) { return provider['config'].enabled; });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            ...
                            completed_at: (_a = operation.completed_at) === null || _a === void 0 ? void 0 : _a.toISOString(),
