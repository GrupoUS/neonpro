...
var SubscriptionQueryOptimizer = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this.executeOptimizedQuery(this.buildSubscriptionStatusQuery(), [userId], options)
                    ...
                    case 4:
                        ...
                        cacheKey = "subscription_status_".concat(userId);
                        return [4 /*yield*/, subscription_cache_enhanced_1.enhancedSubscriptionCache.set(cacheKey, validationResult, options.cacheTTL)];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6:
    ...
    SubscriptionQueryOptimizer.prototype.getBatchSubscriptionStatus = function (userIds_1) {
        return __awaiter(this, arguments, void 0, function (userIds, options) {
            var startTime, queryId, results, uncachedUserIds, _i, userIds_2, userId, cacheKey, cached, batchResults, i, userId, validationResult, cacheKey, error_2;
            if (options === void 0) { options = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, this.executeBatchQuery(this.buildBatchSubscriptionStatusQuery(uncachedUserIds.length), uncachedUserIds, options)
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (cached && Array.isArray(cached.data)) {
                            this.recordQueryStats(queryId, performance.now() - startTime, cached.data.length, true);
                            return [2 /*return*/, cached.data];
                        }
                        _a.label = 3;
                    case 3:
                        query = this.buildUserPlansQuery(filters);
                        return [4 /*yield*/, this.executeOptimizedQuery(query.sql, query.params, options)
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, subscription_cache_enhanced_1.enhancedSubscriptionCache.set(cacheKey, cacheData, options.cacheTTL || 300000)]; // 5 min default
                    case 5:
    ...
    SubscriptionQueryOptimizer.prototype.getSubscriptionAnalytics = function (dateRange_1) {
        return __awaiter(this, arguments, void 0, function (dateRange, aggregation, options) {
            ...
            if (aggregation === void 0) { aggregation = 'daily'; }
            if (options === void 0) { options = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        startTime = performance.now();
                        cacheKey = "analytics_".concat(dateRange.start.toISOString(), "_").concat(dateRange.end.toISOString(), "_").concat(aggregation);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, subscription_cache_enhanced_1.enhancedSubscriptionCache.set(cacheKey, cacheData, options.cacheTTL || 1800000)]; // 30 min default
                    case 5:
    ...
    SubscriptionQueryOptimizer.prototype.executeOptimizedQuery = function (sql_1) {
        return __awaiter(this, arguments, void 0, function (sql, params, options) {
            var startTime, supabase, controller, timerId, result, _a, data, error, _b, data, error, duration, error_5;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (options.timeout) {
                            setTimeout(function () { return controller.abort(); }, options.timeout);
                        }
                        _c.label = 2;
                    case 2:
                        _c.trys.push([2, 7, , 8]);
                        timerId = subscription_performance_monitor_1.subscriptionPerformanceMonitor.startTimer("query_".concat(sql.substring(0, 20)));
                        result = void 0;
                        if (!sql.includes('SELECT')) return [3 /*break*/, 4];
                        return [4 /*yield*/, supabase.rpc('execute_optimized_query', {
                                query: sql,
                                parameters: params
                            })];
                    case 3:
                        ...
                        result = data;
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, supabase.from('user_subscriptions')
                            .select("\n            *,\n            subscription_plans (\n              id,\n              name,\n              description,\n              price_cents,\n              stripe_price_id,\n              features,\n              max_patients,\n              max_clinics\n            )\n          ")
                            .eq('user_id', params[0])
                            .single()];
                    case 5:
                        ...
                        _c.label = 6;
                    case 6:
                        duration = subscription_performance_monitor_1.subscriptionPerformanceMonitor.endTimer(timerId, true);
                        subscription_performance_monitor_1.subscriptionPerformanceMonitor.recordDatabaseOperation(duration);
                        return [2 /*return*/, result || []];
                    case 7:
                        error_5 = _c.sent();
                        subscription_performance_monitor_1.subscriptionPerformanceMonitor.recordDatabaseOperation(performance.now() - startTime);
                        throw error_5;
                    case 8: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, params.map(function (userId) { return resultMap_1.get(userId) || null; })];
                    case 4:
                        error_6 = _b.sent();
                        subscription_performance_monitor_1.subscriptionPerformanceMonitor.recordDatabaseOperation(performance.now() - startTime);
                        throw error_6;
    ...
    SubscriptionQueryOptimizer.prototype.buildBatchSubscriptionStatusQuery = function (count) {
        var placeholders = Array.from({ length: count }, function (_, i) { return "$".concat(i + 1); }).join(', ');
        return "\n      SELECT \n        us.*,\n        sp.id as plan_id,\n        sp.name as plan_name,\n        sp.description as plan_description,\n        sp.price_cents,\n        sp.stripe_price_id,\n        sp.features,\n        sp.max_patients,\n        sp.max_clinics\n      FROM user_subscriptions us\n      JOIN subscription_plans sp ON us.plan_id = sp.id\n      WHERE us.user_id IN (".concat(placeholders, ")\n      AND us.status IN ('active', 'trialing', 'past_due')\n      ORDER BY us.user_id, us.current_period_end DESC NULLS LAST\n    ");
    };
    /**
    ...
    SubscriptionQueryOptimizer.prototype.processSubscriptionResult = function (data) {
        ...
        var subscription = {
            ...
            plan: {
                id: data.plan_id || ((_a = data.subscription_plans) === null || _a === void 0 ? void 0 : _a.id),
                name: data.plan_name || ((_b = data.subscription_plans) === null || _b === void 0 ? void 0 : _b.name),
                description: data.plan_description || ((_c = data.subscription_plans) === null || _c === void 0 ? void 0 : _c.description),
                price_cents: data.price_cents || ((_d = data.subscription_plans) === null || _d === void 0 ? void 0 : _d.price_cents),
                stripe_price_id: data.stripe_price_id || ((_e = data.subscription_plans) === null || _e === void 0 ? void 0 : _e.stripe_price_id),
                features: data.features || ((_f = data.subscription_plans) === null || _f === void 0 ? void 0 : _f.features) || [],
                max_patients: data.max_patients || ((_g = data.subscription_plans) === null || _g === void 0 ? void 0 : _g.max_patients),
                max_clinics: data.max_clinics || ((_h = data.subscription_plans) === null || _h === void 0 ? void 0 : _h.max_clinics),
            }
        };
        var now = new Date();
     ...
     * Get access message
     */
    SubscriptionQueryOptimizer.prototype.getAccessMessage = function (subscription, hasAccess, gracePeriod) {
        if (!subscription)
     ...
     */
    SubscriptionQueryOptimizer.prototype.recordQueryStats = function (queryType, executionTime, resultCount, fromCache) {
    ...
    SubscriptionQueryOptimizer.prototype.processPendingBatches = function () {
        ...
        for (var _i = 0, _a = this.pendingBatches; _i < _a.length; _i++) {
            var _b = _a[_i], batchType = _b[0], queries = _b[1];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.executeBatchOptimization(queries)
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.executeOptimizedQuery(query.query, query.params, query.options)];
                    case 3:
                        result = _a.sent();
                        results.push(result);
                        return [3 /*break*/, 5];
...
var createsubscriptionQueryOptimizer = function () { return new SubscriptionQueryOptimizer(); };
