...
exports.createreportSystem = exports.ReportSystem = exports.ReportInstanceSchema = exports.ReportScheduleSchema = exports.ReportTemplateSchema = exports.ReportStatusSchema = exports.ReportFrequencySchema = exports.ReportFormatSchema = exports.ReportTypeSchema = void 0;
...
exports.ReportFrequencySchema = zod_1.z.enum(['daily', 'weekly', 'monthly', 'quarterly', 'yearly', 'on_demand']);
exports.ReportStatusSchema = zod_1.z.enum(['pending', 'generating', 'completed', 'failed', 'cancelled']);
    ...
    configuration: zod_1.z.object({
        ...
        filters: zod_1.z.object({
            dateRange: zod_1.z.object({
                enabled: zod_1.z.boolean().default(true),
                defaultPeriod: zod_1.z.enum(['last_7_days', 'last_30_days', 'last_quarter', 'last_year']).default('last_30_days')
            }),
...
var ReportSystem = /** @class */ (function () {
    ...
    ReportSystem.prototype.start = function () {
        ...
        this.schedulerTimer = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
    ...
    ReportSystem.prototype.generateReport = function (templateId_1, format_1) {
        return __awaiter(this, arguments, void 0, function (templateId, format, parameters, userId) {
            var _a, templateData, templateError, template, reportId, now, reportInstance, insertError, error_4;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, __assign(__assign({}, reportInstance), { completedAt: undefined, filePath: undefined, fileSize: undefined, downloadUrl: undefined, expiresAt: undefined, errorMessage: undefined, metadata: undefined })];
                    case 3:
                        error_4 = _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, data.map(function (report) { return ({
                                id: report.id,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.generateReport(schedule.templateId, schedule.format, schedule.parameters || {})];
                    case 1:
                    ...
                    case 4:
                        error_7 = _a.sent();
                        logger_1.logger.error("Error executing scheduled report ".concat(schedule.name, ":"), error_7);
                        return [3 /*break*/, 5];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        error_8 = _a.sent();
                        logger_1.logger.error("Error generating report ".concat(reportInstance.name, ":"), error_8);
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        _b = section.type;
                        switch (_b) {
                            case 'kpi_summary': return [3 /*break*/, 3];
                            case 'chart': return [3 /*break*/, 5];
                    ...
                    case 3:
                        _c = data;
                        _d = section.id;
                        return [4 /*yield*/, this.collectKPIData(template.clinicId, section.dataSource, parameters)];
                    case 4:
                        _c[_d] = _j.sent();
                        return [3 /*break*/, 10];
                    case 5:
                        _e = data;
                        _f = section.id;
                        return [4 /*yield*/, this.collectChartTableData(template.clinicId, section.dataSource, parameters)];
                    case 6:
                        _e[_f] = _j.sent();
                        return [3 /*break*/, 10];
                    case 7:
                    ...
                    case 11:
                        error_9 = _j.sent();
                        logger_1.logger.error("Error collecting data for section ".concat(section.id, ":"), error_9);
                        data[section.id] = null;
                        return [3 /*break*/, 12];
                    case 12:
                        _i++;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'financial_kpis': return [3 /*break*/, 3];
                        }
                        return [3 /*break*/, 5];
                    case 1: return [4 /*yield*/, (0, kpi_calculation_service_1.createkpiCalculationService)().calculateClinicKPIs(clinicId, periodStart, periodEnd)];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3: return [4 /*yield*/, (0, kpi_calculation_service_1.createkpiCalculationService)().calculateClinicKPIs(clinicId, periodStart, periodEnd)];
                    case 4:
                        allKPIs = _b.sent();
    ...
    ReportSystem.prototype.collectTextData = function (dataSource, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, "Report generated on ".concat(new Date().toLocaleDateString('pt-BR'))];
            });
        });
    };
    /**
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 9];
                    case 1: return [4 /*yield*/, this.generatePDFReport(filePath, template, data)];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3: return [4 /*yield*/, this.generateExcelReport(filePath, template, data)];
                    case 4: return [2 /*return*/, _b.sent()];
                    case 5: return [4 /*yield*/, this.generateCSVReport(filePath, template, data)];
                    case 6: return [2 /*return*/, _b.sent()];
                    case 7: return [4 /*yield*/, this.generateJSONReport(filePath, template, data)];
                    case 8: return [2 /*return*/, _b.sent()];
                    case 9: throw new Error("Unsupported report format: ".concat(reportInstance.format));
                }
            });
        });
    };
    ...
    ReportSystem.prototype.getDataSourcesUsed = function (template) {
        return template.configuration.sections.map(function (section) { return section.dataSource; });
    };
    /**
...
var createreportSystem = function () { return new ReportSystem(); };
