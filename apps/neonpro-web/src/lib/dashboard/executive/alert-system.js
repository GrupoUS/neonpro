...
exports.createalertSystem = exports.AlertSystem = exports.AlertNotificationSchema = exports.AlertInstanceSchema = exports.AlertRuleSchema = exports.AlertTypeSchema = exports.AlertStatusSchema = exports.AlertSeveritySchema = void 0;
...
exports.AlertTypeSchema = zod_1.z.enum(['kpi_threshold', 'trend_anomaly', 'system_health', 'business_rule']);
...
var AlertSystem = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, data.map(function (alert) { return ({
                                id: alert.id,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, kpi_calculation_service_1.createkpiCalculationService)().calculateClinicKPIs(rule.clinicId)];
                    case 1:
                        kpiResults = _a.sent();
                        targetKPI = kpiResults.find(function (kpi) { return kpi.kpi.id === rule.conditions.kpiId; });
                        if (!targetKPI) {
    ...
    AlertSystem.prototype.evaluateCondition = function (value, conditions) {
        var operator = conditions.operator, threshold = conditions.threshold, secondaryThreshold = conditions.secondaryThreshold;
        switch (operator) {
            case '>':
    ...
    AlertSystem.prototype.generateAlertMessage = function (rule, kpiResult) {
        ...
        return "O KPI \"".concat(kpiName, "\" est\u00E1 com valor ").concat(currentValue, ", que ").concat(operator, " ").concat(threshold, ". ") +
    ...
    AlertSystem.prototype.sendEmailNotification = function (alert, email) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.logger.info("Sending email notification to ".concat(email, " for alert ").concat(alert.id));
                return [2 /*return*/];
            });
        });
    };
    ...
    AlertSystem.prototype.sendSMSNotification = function (alert, phone) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.logger.info("Sending SMS notification to ".concat(phone, " for alert ").concat(alert.id));
                return [2 /*return*/];
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        stats = {
                            total: data.length,
                            active: data.filter(function (a) { return a.status === 'active'; }).length,
                            critical: data.filter(function (a) { return a.severity === 'critical'; }).length,
                            high: data.filter(function (a) { return a.severity === 'high'; }).length,
                            medium: data.filter(function (a) { return a.severity === 'medium'; }).length,
                            low: data.filter(function (a) { return a.severity === 'low'; }).length
                        };
...
var createalertSystem = function () { return new AlertSystem(); };
