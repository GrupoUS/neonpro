...
exports.createwidgetService =
  ...
  exports.WidgetDataSchema =
  exports.WidgetConfigurationSchema =
  exports.WidgetDataSourceSchema =
  exports.WidgetTypeSchema =
    void 0;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("dashboard_widgets").delete().eq("id", widgetId),
            ];
          case 1:
            error = _a.sent().error;
            if (error) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("dashboard_widgets").select("*").eq("id", widgetId).single(),
            ];
          case 1:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            return [
              4 /*yield*/,
              this.fetchKPIData(widgetConfig.clinic_id, dataSource.source, dataSource.parameters),
            ];
          case 2:
            return [2 /*return*/, _b.sent()];
          case 3:
            return [4 /*yield*/, this.fetchQueryData(dataSource.source, dataSource.parameters)];
          case 4:
            return [2 /*return*/, _b.sent()];
          case 5:
            return [4 /*yield*/, this.fetchAPIData(dataSource.source, dataSource.parameters)];
          case 6:
            return [2 /*return*/, _b.sent()];
          case 7:
            return [2 /*return*/, this.fetchStaticData(dataSource.source)];
          case 8:
            throw new Error("Unknown data source type: ".concat(dataSource.type));
        }
      });
    });
  };
          ...
          case 1:
            return [
              ...
              (0, kpi_calculation_service_1.createkpiCalculationService)().calculateClinicKPIs(
                clinicId,
                (parameters === null || parameters === void 0 ? void 0 : parameters.periodStart)
                  ? new Date(parameters.periodStart)
                  : undefined,
                (parameters === null || parameters === void 0 ? void 0 : parameters.periodEnd)
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.rpc("execute_dashboard_query", {
                query_name: query,
  ...
  WidgetService.prototype.initializeDashboardWidgets = function (dashboardId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getDashboardWidgets(dashboardId)];
          case 1:
            widgets = _a.sent();
