...
exports.createkpiCalculationService = exports.KPICalculationResultSchema = exports.KPIValueSchema = exports.KPIDefinitionSchema = void 0;
...
var createkpiCalculationService = /** @class */ (function () {
     ...
     */
    createkpiCalculationService.prototype.calculateClinicKPIs = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var period, cacheKey, cached, _a, kpiDefinitions, error, results, _i, kpiDefinitions_1, kpiDef, result, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 6, , 7]);
                        period = this.normalizePeriod(periodStart, periodEnd);
                        cacheKey = "clinic_".concat(clinicId, "_").concat(period.start.toISOString(), "_").concat(period.end.toISOString());
                    ...
                    case 3:
                        ...
                        if (result) {
                            results.push(result);
                            this.setCachedResult("kpi_".concat(kpiDef.id, "_").concat(period.start.toISOString()), result);
                        }
                        _b.label = 4;
                    case 4:
                        _i++;
     ...
     */
    createkpiCalculationService.prototype.calculateSingleKPI = function (kpiDefinition, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, cached, currentValue, previousPeriod, previousValue, variance, variancePercent, trend, status_1, formattedValue, formattedPreviousValue, result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.executeKPICalculation(kpiDefinition, previousPeriod.start, previousPeriod.end)];
                    case 2:
                        previousValue = _a.sent();
                        variance = previousValue !== null ? currentValue - previousValue : undefined;
                        variancePercent = previousValue !== null && previousValue !== 0
                        ...
                        formattedPreviousValue = previousValue !== null
     ...
     */
    createkpiCalculationService.prototype.executeKPICalculation = function (kpiDefinition, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = method;
                        switch (_a) {
                            case 'financial.monthly_revenue': return [3 /*break*/, 1];
                            case 'financial.average_ticket': return [3 /*break*/, 3];
                            case 'financial.profit_margin': return [3 /*break*/, 5];
                            case 'patients.new_patients': return [3 /*break*/, 7];
                            case 'patients.retention_rate': return [3 /*break*/, 9];
                            case 'patients.satisfaction_score': return [3 /*break*/, 11];
                            case 'operations.occupancy_rate': return [3 /*break*/, 13];
                            case 'operations.no_show_rate': return [3 /*break*/, 15];
                            case 'operations.average_wait_time': return [3 /*break*/, 17];
                            case 'staff.utilization_rate': return [3 /*break*/, 19];
                            case 'staff.productivity_score': return [3 /*break*/, 21];
                        }
                        return [3 /*break*/, 23];
                    case 1: return [4 /*yield*/, this.calculateMonthlyRevenue(clinicId, periodStart, periodEnd)];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3: return [4 /*yield*/, this.calculateAverageTicket(clinicId, periodStart, periodEnd)];
                    case 4: return [2 /*return*/, _b.sent()];
                    case 5: return [4 /*yield*/, this.calculateProfitMargin(clinicId, periodStart, periodEnd)];
                    case 6: return [2 /*return*/, _b.sent()];
                    case 7: return [4 /*yield*/, this.calculateNewPatients(clinicId, periodStart, periodEnd)];
                    case 8: return [2 /*return*/, _b.sent()];
                    case 9: return [4 /*yield*/, this.calculateRetentionRate(clinicId, periodStart, periodEnd)];
                    case 10: return [2 /*return*/, _b.sent()];
                    case 11: return [4 /*yield*/, this.calculateSatisfactionScore(clinicId, periodStart, periodEnd)];
                    case 12: return [2 /*return*/, _b.sent()];
                    case 13: return [4 /*yield*/, this.calculateOccupancyRate(clinicId, periodStart, periodEnd)];
                    case 14: return [2 /*return*/, _b.sent()];
                    case 15: return [4 /*yield*/, this.calculateNoShowRate(clinicId, periodStart, periodEnd)];
                    case 16: return [2 /*return*/, _b.sent()];
                    case 17: return [4 /*yield*/, this.calculateAverageWaitTime(clinicId, periodStart, periodEnd)];
                    case 18: return [2 /*return*/, _b.sent()];
                    case 19: return [4 /*yield*/, this.calculateStaffUtilization(clinicId, periodStart, periodEnd)];
                    case 20: return [2 /*return*/, _b.sent()];
                    case 21: return [4 /*yield*/, this.calculateStaffProductivity(clinicId, periodStart, periodEnd)];
    ...
    createkpiCalculationService.prototype.calculateMonthlyRevenue = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, error;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, data.reduce(function (sum, payment) { return sum + (payment.amount || 0); }, 0)];
                }
            });
        });
    };
    createkpiCalculationService.prototype.calculateAverageTicket = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        total = data.reduce(function (sum, payment) { return sum + (payment.amount || 0); }, 0);
                        return [2 /*return*/, total / data.length];
                }
            });
        });
    };
    createkpiCalculationService.prototype.calculateProfitMargin = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var revenue, estimatedCosts, profit;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.calculateMonthlyRevenue(clinicId, periodStart, periodEnd)];
                    case 1:
                        revenue = _a.sent();
    ...
    createkpiCalculationService.prototype.calculateNewPatients = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, error;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    createkpiCalculationService.prototype.calculateRetentionRate = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var previousPeriod, _a, currentPatients, currentError, _b, previousPatients, previousError, currentPatientIds, previousPatientIds, retainedPatients;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        currentPatientIds = new Set(currentPatients.map(function (p) { return p.patient_id; }));
                        previousPatientIds = new Set(previousPatients.map(function (p) { return p.patient_id; }));
                        retainedPatients = Array.from(previousPatientIds)
                            .filter(function (id) { return currentPatientIds.has(id); }).length;
                        return [2 /*return*/, (retainedPatients / previousPatientIds.size) * 100];
                }
            });
        });
    };
    createkpiCalculationService.prototype.calculateSatisfactionScore = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    createkpiCalculationService.prototype.calculateOccupancyRate = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    createkpiCalculationService.prototype.calculateNoShowRate = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        noShows = appointments.filter(function (a) { return a.status === 'no_show'; }).length;
                        return [2 /*return*/, (noShows / appointments.length) * 100];
                }
            });
        });
    };
    createkpiCalculationService.prototype.calculateAverageWaitTime = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    createkpiCalculationService.prototype.calculateStaffUtilization = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var occupancyRate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.calculateOccupancyRate(clinicId, periodStart, periodEnd)];
                    case 1:
    ...
    createkpiCalculationService.prototype.calculateStaffProductivity = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    createkpiCalculationService.prototype.calculateStatus = function (value, kpiDefinition) {
        if (kpiDefinition.critical_threshold !== null) {
            if (value <= kpiDefinition.critical_threshold)
                return 'critical';
        }
        if (kpiDefinition.warning_threshold !== null) {
            if (value <= kpiDefinition.warning_threshold)
                return 'warning';
        }
        return 'normal';
    };
    ...
    createkpiCalculationService.prototype.getRealTimeKPIs = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.calculateClinicKPIs(clinicId)];
