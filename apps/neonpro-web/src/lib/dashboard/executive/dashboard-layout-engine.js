...
exports.createdashboardLayoutEngine = exports.DashboardLayoutEngine = exports.DashboardLayoutSchema = exports.WidgetConfigSchema = exports.WidgetPositionSchema = void 0;
...
var DashboardLayoutEngine = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, data.map(function (item) { return _this.transformDatabaseToLayout(item); })];
                    case 2:
                        error_2 = _b.sent();
    ...
    DashboardLayoutEngine.prototype.createDashboardLayout = function (layout) {
        return __awaiter(this, void 0, void 0, function () {
            var now_1, dashboardId_1, _a, dashboardData, dashboardError, widgetInserts, widgetsError, newLayout, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 5, , 6]);
                    ...
                    case 1:
                        ...
                        widgetInserts = layout.widgets.map(function (widget) { return ({
                            id: widget.id,
                            dashboard_id: dashboardId_1,
                            widget_type: widget.type,
                            title: widget.title,
                            config: __assign(__assign({}, widget.config), { permissions: widget.permissions, isVisible: widget.isVisible }),
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, null];
                    case 4:
                        newLayout = __assign(__assign({}, layout), { id: dashboardId_1, createdAt: now_1, updatedAt: now_1 });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        widgetInserts = updates.widgets.map(function (widget) { return ({
                            id: widget.id,
    ...
    DashboardLayoutEngine.prototype.validateLayout = function (layout) {
        try {
            ...
            if (error instanceof zod_1.z.ZodError) {
                return {
                    isValid: false,
                    errors: error.errors.map(function (err) { return "".concat(err.path.join('.'), ": ").concat(err.message); })
                };
            }
            return {
                isValid: false,
    ...
    DashboardLayoutEngine.prototype.generateDefaultLayout = function (clinicId, createdBy, name) {
        if (name === void 0) { name = 'Dashboard Executivo'; }
        ...
        return {
            ...
            widgets: (data.widgets || []).map(function (widget) {
                ...
                return ({
                    ...
                    position: widget.position,
                    permissions: ((_a = widget.config) === null || _a === void 0 ? void 0 : _a.permissions) || [],
                    isVisible: (_c = (_b = widget.config) === null || _b === void 0 ? void 0 : _b.isVisible) !== null && _c !== void 0 ? _c : true,
...
var createdashboardLayoutEngine = function () { return new DashboardLayoutEngine(); };
