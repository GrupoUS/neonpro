...
exports.DocumentationRouteBuilder = exports.DocumentationMiddleware = exports.OpenApiDocumentationGenerator = void 0;
/**
...
var OpenApiDocumentationGenerator = /** @class */ (function () {
    ...
    OpenApiDocumentationGenerator.prototype.generateOperationId = function (route) {
        ...
        var pathParts = route.path.split('/').filter(function (part) { return part && !part.startsWith(':'); });
    ...
    OpenApiDocumentationGenerator.prototype.generateRequestBody = function (route) {
        var requestBodyParam = route.documentation.parameters.find(function (p) { return p.in === 'body'; });
        if (!requestBodyParam) {
            return {
                required: true,
                content: {
...
var DocumentationMiddleware = /** @class */ (function () {
    ...
    DocumentationMiddleware.prototype.getDocumentationJson = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.generateDocumentation()];
                    case 1:
