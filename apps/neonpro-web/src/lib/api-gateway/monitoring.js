...
exports.ApiGatewayPerformanceMonitor = exports.MonitoringMiddleware = exports.ApiGatewayHealthCheckManager = exports.ApiGatewayMetricsCollector = void 0;
/**
 * Metrics Collector
...
var ApiGatewayMetricsCollector = /** @class */ (function () {
    function ApiGatewayMetricsCollector(logger) {
        ...
        setInterval(function () { return _this.collectSystemMetrics(); }, 30000);
    }
    /**
    ...
    ApiGatewayMetricsCollector.prototype.recordRequest = function (context) {
        ...
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.debug('Request metrics recorded', { requestId: context.requestId, labels: labels });
    };
    /**
    ...
    ApiGatewayMetricsCollector.prototype.recordResponse = function (context) {
        ...
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.debug('Response metrics recorded', {
    ...
    ApiGatewayMetricsCollector.prototype.recordError = function (error, context) {
        ...
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.error('Error metrics recorded', error, labels);
    };
    /**
     * Record rate limit metrics
     */
    ApiGatewayMetricsCollector.prototype.recordRateLimit = function (clientId, limit, remaining, resetTime) {
    ...
    ApiGatewayMetricsCollector.prototype.collectSystemMetrics = function () {
        ...
        try {
            ...
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.error('System metrics collection error', error);
        }
    };
...
var ApiGatewayHealthCheckManager = /** @class */ (function () {
    ...
    ApiGatewayHealthCheckManager.prototype.registerCheck = function (name, check) {
        ...
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Health check registered', { name: name });
    };
    /**
    ...
    ApiGatewayHealthCheckManager.prototype.unregisterCheck = function (name) {
        ...
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Health check unregistered', { name: name });
    };
    /**
    ...
    ApiGatewayHealthCheckManager.prototype.runChecks = function () {
        return __awaiter(this, void 0, void 0, function () {
            var results, overallStatus, _i, _a, _b, name_1, check, result, resultWithTimestamp, error_1, errorResult, healthStatus;
            var _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.race([
                                ...
                                new Promise(function (_, reject) {
                                    return setTimeout(function () { return reject(new Error('Health check timeout')); }, 5000);
                                })
                            ])];
                    case 3:
                        result = _e.sent();
                    ...
                    case 4:
                        ...
                        overallStatus = 'unhealthy';
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('Health check failed', error_1, { checkName: name_1 });
                        return [3 /*break*/, 5];
                    case 5:
                        _i++;
                        return [3 /*break*/, 1];
                    case 6:
                        ...
                        (_d = this.logger) === null || _d === void 0 ? void 0 : _d.debug('Health checks completed', {
                            status: overallStatus,
    ...
    ApiGatewayHealthCheckManager.prototype.getLastResults = function () {
        ...
        for (var _i = 0, _a = this.lastResults.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], name_2 = _b[0], result = _b[1];
        ...
        this.intervalId = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        error_2 = _b.sent();
                        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.error('Periodic health check error', error_2);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
        }); }, this.checkInterval);
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Periodic health checks started', { interval: this.checkInterval });
    };
    /**
    ...
    ApiGatewayHealthCheckManager.prototype.stopPeriodicChecks = function () {
        ...
        if (this.intervalId) {
            ...
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Periodic health checks stopped');
        }
    };
    /**
     * Register default health checks
    ...
    ApiGatewayHealthCheckManager.prototype.registerDefaultChecks = function () {
        ...
        this.registerCheck('memory', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (typeof process === 'undefined' || !process.memoryUsage) {
                    return [2 /*return*/, { status: 'healthy', details: { message: 'Memory monitoring not available' } }];
                }
        ...
        this.registerCheck('event_loop', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
        ...
        // Uptime check
        this.registerCheck('uptime', function () { return __awaiter(_this, void 0, void 0, function () {
            var uptimeSeconds;
            var _a;
            return __generator(this, function (_b) {
                uptimeSeconds = typeof process !== 'undefined' && process.uptime
                    ? process.uptime()
                    : (Date.now() - ((_a = this.lastResults.get('uptime')) === null || _a === void 0 ? void 0 : _a.timestamp) || Date.now()) / 1000;
                return [2 /*return*/, {
                        status: 'healthy',
                        details: {
            ...
            handler: function (context, next) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            startTime = Date.now();
                            if (!((_a = config.excludePaths) === null || _a === void 0 ? void 0 : _a.includes(context.path))) return [3 /*break*/, 2];
                            return [4 /*yield*/, next()];
                        case 1:
                            _b.sent();
                            return [2 /*return*/];
                        ...
                        case 4:
                            // Execute request
                            _b.sent();
                            responseContext = __assign(__assign({}, context), { statusCode: context.statusCode || 200, responseSize: context.responseSize || 0 });
...
var ApiGatewayPerformanceMonitor = /** @class */ (function () {
    function ApiGatewayPerformanceMonitor(metrics, healthCheck, monitorInterval, logger) {
        if (monitorInterval === void 0) { monitorInterval = 60000; }
        this.alerts = new Map();
    ...
    ApiGatewayPerformanceMonitor.prototype.registerAlert = function (name, threshold, callback) {
        ...
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Performance alert registered', { name: name, threshold: threshold });
    };
    /**
    ...
    ApiGatewayPerformanceMonitor.prototype.startMonitoring = function () {
        ...
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Performance monitoring started', { interval: this.monitorInterval });
    };
    /**
    ...
    ApiGatewayPerformanceMonitor.prototype.stopMonitoring = function () {
        ...
        if (this.intervalId) {
            clearInterval(this.intervalId);
            this.intervalId = undefined;
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Performance monitoring stopped');
        }
    };
    /**
    ...
    ApiGatewayPerformanceMonitor.prototype.checkPerformance = function () {
        ...
        try {
            ...
            for (var _i = 0, _d = this.alerts.entries(); _i < _d.length; _i++) {
                var _e = _d[_i], name_3 = _e[0], alert_1 = _e[1];
                var value = metrics[name_3];
                if (typeof value === 'number' && value > alert_1.threshold) {
                    (_a = this.logger) === null || _a === void 0 ? void 0 : _a.warn('Performance alert triggered', {
                        alert: name_3,
                        value: value,
                    ...
                    try {
                        ...
                        (_b = this.logger) === null || _b === void 0 ? void 0 : _b.error('Performance alert callback error', error, { alert: name_3 });
                    }
                }
            }
        }
        catch (error) {
            (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('Performance monitoring error', error);
        }
    };
    /**
    ...
    ApiGatewayPerformanceMonitor.prototype.registerDefaultAlerts = function () {
        ...
        this.registerAlert('request_duration_ms_p95', 1000, function (value) {
            var _a;
            (_a = _this.logger) === null || _a === void 0 ? void 0 : _a.warn('High response time detected', { p95ResponseTime: value });
        });
        // High error rate alert
        this.registerAlert('errors_total', 100, function (value) {
            var _a;
            (_a = _this.logger) === null || _a === void 0 ? void 0 : _a.warn('High error rate detected', { totalErrors: value });
        });
        // Memory usage alert
        this.registerAlert('process_memory_heap_used_bytes', 500 * 1024 * 1024, function (value) {
            var _a;
            (_a = _this.logger) === null || _a === void 0 ? void 0 : _a.warn('High memory usage detected', { heapUsedMB: Math.round(value / 1024 / 1024) });
        });
    };
