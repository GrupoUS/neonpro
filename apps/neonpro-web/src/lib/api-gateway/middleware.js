                ...
                return __generator(this, function (_b) {
                  switch (_b.label) {
                    ...
                    case 3:
                      ...
                      (_a = this.logger) === null || _a === void 0
                        ? void 0
                        : _a.error("Middleware error", error_1, {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 3:
                ...
                logger === null || logger === void 0
                  ? void 0
                  : logger.error("API Error", error_2, {
                      requestId: context.requestId,
                      duration: duration,
                      statusCode: 500,
                    });
  ...
  RequestValidationMiddleware.validateValue = function (value, schema, fieldName) {
    ...
    if (schema.type) {
      ...
      if (actualType !== schema.type) {
        errors.push(
          ""
            .concat(fieldName, " must be of type ")
            .concat(schema.type, ", got ")
            .concat(actualType),
        );
        return errors;
      }
    ...
    if (schema.type === "string") {
      if (schema.minLength && value.length < schema.minLength) {
        errors.push(
          "".concat(fieldName, " must be at least ").concat(schema.minLength, " characters long"),
        );
      }
      if (schema.maxLength && value.length > schema.maxLength) {
        errors.push(
          "".concat(fieldName, " must be at most ").concat(schema.maxLength, " characters long"),
        );
      }
    ...
    if (schema.type === "object" && schema.properties) {
      for (var _i = 0, _a = Object.entries(schema.properties); _i < _a.length; _i++) {
        ...
        if (propValue !== undefined && propValue !== null) {
          var propErrors = RequestValidationMiddleware.validateValue(
            propValue,
            propSchema,
            "".concat(fieldName, ".").concat(propName),
          );
