...
var MemoryApiGatewayCache = /** @class */ (function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        (_a = this.logger) === null || _a === void 0
          ? void 0
          : _a.debug("Cache set", { key: key, ttl: ttl || this.defaultTtl });
        return [2 /*return*/];
      });
    });
  };
  ...
  MemoryApiGatewayCache.prototype.clear = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        (_a = this.logger) === null || _a === void 0
          ? void 0
          : _a.info("Cache cleared", { entriesRemoved: size });
        return [2 /*return*/];
      });
    });
  };
  ...
  MemoryApiGatewayCache.prototype.getStats = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          __assign(__assign({}, this.stats), { size: this.cache.size, hitRate: hitRate }),
        ];
      });
    });
  };
  ...
  MemoryApiGatewayCache.prototype.evictLRU = function () {
    ...
    if (oldestKey) {
      ...
      (_a = this.logger) === null || _a === void 0
        ? void 0
        : _a.debug("Cache LRU eviction", { key: oldestKey });
    }
  };
  /**
  ...
  MemoryApiGatewayCache.prototype.cleanup = function () {
    ...
    if (cleaned > 0) {
      (_a = this.logger) === null || _a === void 0
        ? void 0
        : _a.debug("Cache cleanup", { entriesRemoved: cleaned });
    }
  };
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            (_a = this.logger) === null || _a === void 0
              ? void 0
              : _a.error("Redis cache get error", error_1, { key: key });
            return [2 /*return*/, null];
          case 3:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            (_a = this.logger) === null || _a === void 0
              ? void 0
              : _a.debug("Redis cache set", { key: key, ttl: expiry });
            return [3 /*break*/, 3];
          case 2:
            error_2 = _c.sent();
            this.stats.errors++;
            (_b = this.logger) === null || _b === void 0
              ? void 0
              : _b.error("Redis cache set error", error_2, { key: key });
            throw error_2;
          case 3:
            return [2 /*return*/];
        }
        ...
        switch (_c.label) {
          ...
          case 1:
            ...
            if (deleted) {
              ...
              (_a = this.logger) === null || _a === void 0
                ? void 0
                : _a.debug("Redis cache delete", { key: key });
            }
            return [2 /*return*/, deleted];
          case 2:
            error_3 = _c.sent();
            ...
            (_b = this.logger) === null || _b === void 0
              ? void 0
              : _b.error("Redis cache delete error", error_3, { key: key });
            return [2 /*return*/, false];
          case 3:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 2:
            ...
            (_b = this.logger) === null || _b === void 0
              ? void 0
              : _b.info("Redis cache cleared", { entriesRemoved: keys.length });
            _d.label = 3;
          case 3:
            return [3 /*break*/, 5];
          case 4:
            ...
            (_c = this.logger) === null || _c === void 0
              ? void 0
              : _c.error("Redis cache clear error", error_4);
            throw error_4;
          case 5:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            (_a = this.logger) === null || _a === void 0
              ? void 0
              : _a.error("Redis cache exists error", error_5, { key: key });
            return [2 /*return*/, false];
          case 3:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            (_a = this.logger) === null || _a === void 0
              ? void 0
              : _a.error("Redis info error", error_6);
            return [3 /*break*/, 4];
          case 4:
            return [
              2 /*return*/,
              __assign(__assign({}, this.stats), { hitRate: hitRate, redisInfo: redisInfo }),
            ];
        }
      });
    });
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 7:
            ...
            (_b = this.logger) === null || _b === void 0
              ? void 0
              : _b.error("Supabase cache get error", error_7, { key: key });
            return [2 /*return*/, null];
          case 8:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from(this.tableName).upsert({
                key: key,
          ...
          case 2:
            ...
            (_a = this.logger) === null || _a === void 0
              ? void 0
              : _a.debug("Supabase cache set", { key: key, ttl: ttl });
            return [3 /*break*/, 4];
          case 3:
            error_8 = _c.sent();
            this.stats.errors++;
            (_b = this.logger) === null || _b === void 0
              ? void 0
              : _b.error("Supabase cache set error", error_8, { key: key });
            throw error_8;
          case 4:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            // Delete from memory cache
            _c.sent();
            return [4 /*yield*/, this.supabase.from(this.tableName).delete().eq("key", key)];
          case 2:
            error = _c.sent().error;
            if (error) {
              throw error;
            ...
            (_a = this.logger) === null || _a === void 0
              ? void 0
              : _a.debug("Supabase cache delete", { key: key });
            return [2 /*return*/, true];
          case 3:
            error_9 = _c.sent();
            this.stats.errors++;
            (_b = this.logger) === null || _b === void 0
              ? void 0
              : _b.error("Supabase cache delete error", error_9, { key: key });
            return [2 /*return*/, false];
          case 4:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            // Clear memory cache
            _c.sent();
            return [4 /*yield*/, this.supabase.from(this.tableName).delete().neq("key", "")];
          case 2:
            error = _c.sent().error;
            if (error) {
              throw error;
            ...
            (_a = this.logger) === null || _a === void 0
              ? void 0
              : _a.info("Supabase cache cleared");
            return [3 /*break*/, 4];
          case 3:
            error_10 = _c.sent();
            this.stats.errors++;
            (_b = this.logger) === null || _b === void 0
              ? void 0
              : _b.error("Supabase cache clear error", error_10);
            throw error_10;
          case 4:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from(this.tableName).select("expires_at").eq("key", key).single(),
            ];
          case 2:
            (_a = _c.sent()), (data = _a.data), (error = _a.error);
            if (error || !data) {
          ...
          case 3:
            ...
            (_b = this.logger) === null || _b === void 0
              ? void 0
              : _b.error("Supabase cache exists error", error_11, { key: key });
            return [2 /*return*/, false];
          case 4:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              __assign(__assign({}, this.stats), { hitRate: hitRate, memoryStats: memoryStats }),
            ];
        }
      });
    });
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            (_a = this.logger) === null || _a === void 0
              ? void 0
              : _a.debug("Supabase cache cleanup completed");
            return [3 /*break*/, 3];
          case 2:
            error_12 = _c.sent();
            (_b = this.logger) === null || _b === void 0
              ? void 0
              : _b.error("Supabase cache cleanup error", error_12);
            return [3 /*break*/, 3];
          case 3:
            return [2 /*return*/];
        }
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 4:
                ...
                return [
                  4 /*yield*/,
                  config.cache.set(cacheKey, context.response, config.defaultTtl),
                ];
              case 5:
                _a.sent();
