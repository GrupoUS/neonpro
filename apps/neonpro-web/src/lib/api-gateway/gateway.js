...
var NeonProApiGateway = /** @class */ (function () {
    ...
    NeonProApiGateway.prototype.setupDefaultMiddleware = function () {
            ...
            handler: function (context, next) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            startTime = Date.now();
                            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('API Request', {
                        ...
                        case 3:
                            ...
                            (_b = this.logger) === null || _b === void 0 ? void 0 : _b.info('API Response', {
                                requestId: context.requestId,
                                duration: duration,
        ...
        this.registerMiddleware({
            ...
            handler: function (context, next) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.checkRateLimit(context)];
                        case 1:
                            allowed = _a.sent();
                            if (!allowed) {
    ...
    NeonProApiGateway.prototype.registerRoute = function (route) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Route registered', {
                    routeId: route.id,
                    path: route.path,
                    method: route.method
                });
    ...
    NeonProApiGateway.prototype.unregisterRoute = function (routeId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Route unregistered', { routeId: routeId });
                return [2 /*return*/];
            });
        });
    };
    ...
    NeonProApiGateway.prototype.createClient = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _a;
            return __generator(this, function (_b) {
                client = __assign(__assign({}, config), { id: this.generateId(), createdAt: new Date(), updatedAt: new Date() });
                this.clients.set(client.id, client);
                this.emit('client:created', { client: client });
                (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Client created', {
                    clientId: client.id,
                    name: client.name,
                    type: client.type
                });
    ...
    NeonProApiGateway.prototype.updateClient = function (clientId, updates) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                updatedClient = __assign(__assign(__assign({}, client), updates), { updatedAt: new Date() });
                this.clients.set(clientId, updatedClient);
                this.emit('client:updated', { client: updatedClient });
                (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Client updated', { clientId: clientId });
    ...
    NeonProApiGateway.prototype.deleteClient = function (clientId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info('Client deleted', { clientId: clientId });
                return [2 /*return*/];
            });
        });
    };
    ...
    NeonProApiGateway.prototype.authenticateRequest = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        apiKey = context.headers['x-api-key'] || ((_a = context.headers['authorization']) === null || _a === void 0 ? void 0 : _a.replace('Bearer ', ''));
                        if (!apiKey) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (route.authentication.roles && route.authentication.roles.length > 0) {
                            if (!context.userRoles || !route.authentication.roles.some(function (role) { return context.userRoles.includes(role); })) {
                                return [2 /*return*/, false];
                            }
                        }
                        // Check required permissions
                        if (route.authentication.permissions && route.authentication.permissions.length > 0) {
                            if (!context.userPermissions || !route.authentication.permissions.some(function (perm) { return context.userPermissions.includes(perm); })) {
                                return [2 /*return*/, false];
                            }
                        }
    ...
    NeonProApiGateway.prototype.generateApiKey = function (clientId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getClient(clientId)];
                    case 1:
                        client = _a.sent();
                        if (!client) {
                            throw new Error("Client not found: ".concat(clientId));
    ...
    NeonProApiGateway.prototype.getMetrics = function (period) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, __assign(__assign({}, this.metrics), { period: period || this.metrics.period })];
            });
        });
    };
    /**
     ...
     */
    NeonProApiGateway.prototype.determineOverallHealth = function (dbCheck, cacheCheck, integrationChecks) {
        if (dbCheck.status === 'down') {
            return 'unhealthy';
        }
        var downIntegrations = integrationChecks.filter(function (check) { return check.status === 'down'; });
    ...
    NeonProApiGateway.prototype.generateDocumentation = function () {
        return __awaiter(this, void 0, void 0, function () {
            var routes, paths, schemas, tags, _i, routes_1, route, pathKey, methodKey, _loop_1, _a, _b, tag;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.listRoutes()];
                    case 1:
                        routes = _c.sent();
                        paths = {};
                        schemas = {};
                        ...
                        for (_i = 0, routes_1 = routes; _i < routes_1.length; _i++) {
                            ...
                            _loop_1 = function (tag) {
                                if (!tags.find(function (t) { return t.name === tag; })) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.generateDocumentation()];
                    case 3:
                    ...
                    case 4:
                        _a.sent(); // 1 hour
                        _a.label = 5;
                    case 5: return [2 /*return*/, documentation];
                }
            });
        });
    };
        ...
        if (listeners) {
            listeners.forEach(function (listener) {
                ...
                try {
                    ...
                    (_a = _this.logger) === null || _a === void 0 ? void 0 : _a.error('Event listener error', error, { event: event });
                }
            });
        }
    };
