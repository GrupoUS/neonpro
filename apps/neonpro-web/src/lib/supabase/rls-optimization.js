...
var RLSOptimizationManager = /** @class */ (function () {
    ...
    RLSOptimizationManager.prototype.validateOptimization = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cacheStats, healthChecks, criticalIssues, warningIssues, healthStatus, responseTimeCheck, avgResponseTime, error_8;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.getCacheStats()
                            // Get health check
                        ];
                    case 1:
                        cacheStats = _b.sent();
                    ...
                    case 2:
                        ...
                        criticalIssues = healthChecks.filter(function (check) { return check.status === 'CRITICAL'; });
                        warningIssues = healthChecks.filter(function (check) { return check.status === 'WARNING'; });
                        healthStatus = 'OK';
                        ...
                        avgResponseTime = responseTimeCheck
                            ? parseFloat(((_a = responseTimeCheck.details.match(/(\d+\.?\d*) ms/)) === null || _a === void 0 ? void 0 : _a[1]) || '0')
                            : 0;
                        return [2 /*return*/, {
                                isOptimized: avgResponseTime <= 100 && healthStatus !== 'CRITICAL',
                                avgResponseTime: avgResponseTime,
                                cacheValid: (cacheStats === null || cacheStats === void 0 ? void 0 : cacheStats.cache_valid) || false,
