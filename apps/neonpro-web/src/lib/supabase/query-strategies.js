...
var HealthcareQueryStrategies = /** @class */ (function () {
    ...
    HealthcareQueryStrategies.prototype.executeQuery = function (queryFn, context) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, strategy, client, poolKey, timeoutPromise, queryPromise, data, executionTime, auditTrail, complianceVerified, error_1, executionTime, auditTrail;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        timeoutPromise = new Promise(function (_, reject) {
                            setTimeout(function () { return reject(new Error("Query timeout after ".concat(strategy.timeout, "ms"))); }, strategy.timeout);
                        });
                    ...
                    case 3:
                        auditTrail = _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, this.verifyCompliance(context, data)];
                    case 5:
     ...
     */
    HealthcareQueryStrategies.prototype.executeWithRetry = function (queryFn, client, maxRetries, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 2:
                                        error_2 = _c.sent();
                                        lastError = error_2;
                                        console.warn("Query attempt ".concat(attempt, "/").concat(maxRetries, " failed:"), {
                    ...
                    case 3:
                        attempt++;
                        return [3 /*break*/, 1];
                    case 4: throw lastError || new Error('Query failed after all retry attempts');
                }
            });
        });
    };
    ...
    HealthcareQueryStrategies.prototype.hasPatientAccess = function (context) {
        ...
        return ['admin', 'professional'].includes(context.userRole) ||
     ...
     */
    HealthcareQueryStrategies.prototype.createAuditTrail = function (context, success, executionTime) {
        return __awaiter(this, void 0, void 0, function () {
            var auditEntry;
            return __generator(this, function (_a) {
                auditEntry = {
                ...
                console.log('🔍 Healthcare audit trail:', __assign(__assign({}, auditEntry), { executionTime: executionTime, priority: context.priority }));
    ...
    HealthcareQueryStrategies.prototype.getPerformanceRecommendations = function (queryType) {
        ...
        var recommendations = [
            ...
            strategy.cacheEnabled ? 'Caching enabled for performance' : 'Caching disabled for data freshness',
    ...
    HealthcareQueryStrategies.prototype.generateOptimizations = function (queryType, strategy) {
        ...
        switch (queryType) {
            case 'patient_critical':
                optimizations.push('Use indexed queries for emergency patient lookup', 'Minimize data fetched to essential fields only', 'Consider real-time subscriptions for critical monitoring');
                break;
            case 'analytics_readonly':
                optimizations.push('Use read replicas for heavy analytical queries', 'Implement query result caching', 'Consider materialized views for complex aggregations');
                break;
            case 'clinical_workflow':
                optimizations.push('Batch related operations in single transaction', 'Use optimistic locking for concurrent updates', 'Implement efficient scheduling algorithms');
                break;
            default:
                optimizations.push('Review query patterns for optimization opportunities', 'Consider connection pooling benefits', 'Monitor query performance metrics');
        }
...
var getQueryStrategies = function () { return HealthcareQueryStrategies.getInstance(); };
...
var createQueryContext = function (clinicId, userId, queryType, options) {
    ...
    return (__assign({ clinicId: clinicId, userId: userId, queryType: queryType, userRole: 'professional', priority: 'normal', requiresAudit: true, lgpdSensitive: queryType.includes('patient') || queryType === 'financial_sensitive' }, options));
};
exports.createQueryContext = createQueryContext;
// Healthcare query builder helpers
exports.HealthcareQueries = {
    patientData: function (patientId) { return (0, exports.createQueryContext)('', '', 'patient_standard', { patientId: patientId, lgpdSensitive: true }); },
    emergencyAccess: function (patientId) { return (0, exports.createQueryContext)('', '', 'patient_critical', { patientId: patientId, priority: 'emergency', lgpdSensitive: true }); },
    clinicalWorkflow: function () { return (0, exports.createQueryContext)('', '', 'clinical_workflow', { priority: 'high' }); },
    analytics: function () { return (0, exports.createQueryContext)('', '', 'analytics_readonly', { requiresAudit: false, lgpdSensitive: false }); },
    financial: function () { return (0, exports.createQueryContext)('', '', 'financial_sensitive', { priority: 'high', lgpdSensitive: true }); }
};
