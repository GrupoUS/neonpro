...
var PatientError = /** @class */ (function (_super) {
...
function transformRegistrationToFHIR(data, clinic_id, user_id) {
    ...
    // Add optional fields
    if (data.cpf) {
        (_a = fhir_patient.identifier) === null || _a === void 0 ? void 0 : _a.push({
            use: 'official',
            type: {
                coding: [{
    ...
    if (data.rg) {
        (_b = fhir_patient.identifier) === null || _b === void 0 ? void 0 : _b.push({
            use: 'official',
            type: {
                coding: [{
                        system: 'http://www.saude.gov.br/fhir/r4/CodeSystem/BRTipoDocumento',
    ...
    if (data.email) {
        (_c = fhir_patient.telecom) === null || _c === void 0 ? void 0 : _c.push({
            system: 'email',
            value: data.email,
            use: 'home'
        });
    ...
    if (data.phone_secondary) {
        (_d = fhir_patient.telecom) === null || _d === void 0 ? void 0 : _d.push({
            system: 'phone',
    ...
    if (data.emergency_contact_email) {
        (_g = (_f = (_e = fhir_patient.contact) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.telecom) === null || _g === void 0 ? void 0 : _g.push({
            system: 'email',
...
function createPatient(data, user_id) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, profile, profileError, _b, existingPatient, checkError, _c, patientData, consentData, _d, createdPatient_1, patientError, consentsWithPatientId, _e, createdConsents, consentError, error_1;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    ...
                    if (profileError || !(profile === null || profile === void 0 ? void 0 : profile.clinic_id)) {
                ...
                case 4:
                    ...
                    if (existingPatient) {
                        throw new PatientError('Medical record number already exists in this clinic', 'DUPLICATE_MEDICAL_RECORD', 409);
                    }
                    _c = transformRegistrationToFHIR(data, profile.clinic_id, user_id), patientData = _c.patient, consentData = _c.consents;
                    return [4 /*yield*/, supabase
                            .from('patients')
                            .insert([patientData])
                            .select()
                ...
                case 5:
                    ...
                    if (patientError) {
                        throw new PatientError("Failed to create patient: ".concat(patientError.message), 'PATIENT_CREATION_FAILED');
                    }
                    consentsWithPatientId = consentData.map(function (consent) { return (__assign(__assign({}, consent), { patient_id: createdPatient_1.id })); });
                    return [4 /*yield*/, supabase
                ...
                case 7:
                    // Rollback patient creation if consent creation fails
                    _f.sent();
                    throw new PatientError("Failed to create patient consents: ".concat(consentError.message), 'CONSENT_CREATION_FAILED');
                ...
                case 9:
                    ...
                    throw new PatientError("Unexpected error creating patient: ".concat(error_1 instanceof Error ? error_1.message : 'Unknown error'), 'UNEXPECTED_ERROR');
...
function searchPatients(params, user_id) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, profile, profileError, query, sortField, _b, patients, searchError, count, error_2;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (params.query) {
                        ...
                        query = query.or("medical_record_number.ilike.%".concat(params.query, "%,fhir_data->>name.ilike.%").concat(params.query, "%"));
                    }
                ...
                case 4:
                    ...
                    if (searchError) {
                        throw new PatientError("Failed to search patients: ".concat(searchError.message), 'SEARCH_FAILED');
                    }
                    return [2 /*return*/, {
                            patients: patients || [],
                            total_count: count || 0,
                ...
                case 5:
                    ...
                    throw new PatientError("Unexpected error searching patients: ".concat(error_2 instanceof Error ? error_2.message : 'Unknown error'), 'UNEXPECTED_ERROR');
            ...
            switch (_c.label) {
                ...
                case 4:
                    ...
                    if (patientError) {
                        ...
                        throw new PatientError("Failed to get patient: ".concat(patientError.message), 'GET_PATIENT_FAILED');
                    }
                ...
                case 5:
                    ...
                    throw new PatientError("Unexpected error getting patient: ".concat(error_3 instanceof Error ? error_3.message : 'Unknown error'), 'UNEXPECTED_ERROR');
                case 6: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    if (updateError) {
                        throw new PatientError("Failed to update consent: ".concat(updateError.message), 'UPDATE_CONSENT_FAILED');
                    }
                ...
                case 5:
                    ...
                    throw new PatientError("Unexpected error updating consent: ".concat(error_4 instanceof Error ? error_4.message : 'Unknown error'), 'UNEXPECTED_ERROR');
                case 6: return [2 /*return*/];
            }
        });
    });
...
function getPatientStats(clinicId) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, activeClinicId, now, thirtyDaysAgo, sevenDaysFromNow, _b, totalPatients, totalError, firstDayOfMonth, _c, newPatients, newError, _d, activePatients, activeError, _e, scheduledAppointments, scheduledError, stats, error_5;
        var _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 2:
                    ...
                    activeClinicId = clinicId || ((_f = user.user_metadata) === null || _f === void 0 ? void 0 : _f.clinic_id);
                    if (!activeClinicId) {
                ...
                case 3:
                    ...
                    if (totalError) {
                        throw new PatientError("Failed to get total patients: ".concat(totalError.message), 'STATS_FETCH_FAILED');
                    }
                ...
                case 4:
                    ...
                    if (newError) {
                        throw new PatientError("Failed to get new patients: ".concat(newError.message), 'STATS_FETCH_FAILED');
                    }
                    return [4 /*yield*/, supabase
                            .from('appointments')
                ...
                case 5:
                    ...
                    if (activeError) {
                        throw new PatientError("Failed to get active patients: ".concat(activeError.message), 'STATS_FETCH_FAILED');
                    }
                    return [4 /*yield*/, supabase
                            .from('appointments')
                            .select('*', { count: 'exact', head: true })
                ...
                case 6:
                    ...
                    if (scheduledError) {
                        throw new PatientError("Failed to get scheduled appointments: ".concat(scheduledError.message), 'STATS_FETCH_FAILED');
                    }
                    stats = {
                ...
                case 7:
                    ...
                    return [2 /*return*/, {
                            success: false,
                            error: "Unexpected error getting patient statistics: ".concat(error_5 instanceof Error ? error_5.message : 'Unknown error'),
