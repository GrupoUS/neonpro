...
Object.defineProperty(exports, "centavosToReais", { enumerable: true, get: function () { return financial_1.centavosToReais; } });
Object.defineProperty(exports, "formatCurrency", { enumerable: true, get: function () { return financial_1.formatCurrency; } });
Object.defineProperty(exports, "reaisToCentavos", { enumerable: true, get: function () { return financial_1.reaisToCentavos; } });
...
function createInvoice(input) {
    return __awaiter(this, void 0, void 0, function () {
        var validatedInput, items, subtotal, discount, tax, total, clinic, invoiceNumber, _a, invoice_1, invoiceError, itemsWithInvoiceId, itemsError, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 7, , 8]);
                    validatedInput = financial_1.createInvoiceSchema.parse(input);
                    items = validatedInput.items.map(function (item) { return (__assign(__assign({}, item), { unit_price: (0, financial_1.reaisToCentavos)(item.unit_price), discount_amount: (0, financial_1.reaisToCentavos)(item.discount_amount || 0) })); });
                    subtotal = items.reduce(function (sum, item) { return sum + (item.unit_price * item.quantity); }, 0);
                    discount = items.reduce(function (sum, item) { return sum + item.discount_amount; }, 0);
                    tax = items.reduce(function (sum, item) { return sum + Math.round(item.unit_price * item.quantity * item.tax_rate); }, 0);
                ...
                case 3:
                    ...
                    if (invoiceError)
                        throw invoiceError;
                    itemsWithInvoiceId = items.map(function (item) { return (__assign(__assign({}, item), { invoice_id: invoice_1.id, total_amount: (item.unit_price * item.quantity) - item.discount_amount + Math.round(item.unit_price * item.quantity * item.tax_rate), tax_amount: Math.round(item.unit_price * item.quantity * item.tax_rate) })); });
                    return [4 /*yield*/, supabase
                            .from('invoice_items')
                ...
                case 4:
                    ...
                    return [4 /*yield*/, performShadowValidation('invoice_calculation', invoice_1.id, {
                            subtotal: subtotal,
                            discount: discount,
                            tax: tax,
                            total: total,
                ...
                case 7:
                    ...
                    throw new Error("Failed to create invoice: ".concat(error_1 instanceof Error ? error_1.message : 'Unknown error'));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    throw new Error("Failed to fetch invoice: ".concat(error_2 instanceof Error ? error_2.message : 'Unknown error'));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    throw new Error("Failed to list invoices: ".concat(error_3 instanceof Error ? error_3.message : 'Unknown error'));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            .from('invoices')
                            .update(__assign(__assign({}, validatedInput), { updated_at: new Date().toISOString() }))
                            .eq('id', id)
                            .select()
                            .single()];
                case 1:
                ...
                case 3:
                    ...
                    throw new Error("Failed to update invoice: ".concat(error_4 instanceof Error ? error_4.message : 'Unknown error'));
                case 4: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    throw new Error("Failed to issue invoice: ".concat(error_5 instanceof Error ? error_5.message : 'Unknown error'));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4: return [4 /*yield*/, getInvoiceById(id)];
                case 5: return [2 /*return*/, _a.sent()];
                case 6:
                    error_6 = _a.sent();
                    console.error('Error cancelling invoice:', error_6);
                    throw new Error("Failed to cancel invoice: ".concat(error_6 instanceof Error ? error_6.message : 'Unknown error'));
...
function createPayment(input) {
    return __awaiter(this, void 0, void 0, function () {
        var validatedInput_1, amount, _a, payment_1, paymentError, installments, installmentsError, error_7;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 6, , 7]);
                ...
                case 1:
                    ...
                    if (paymentError)
                        throw paymentError;
                    if (!(validatedInput_1.installments && validatedInput_1.installments.length > 0)) return [3 /*break*/, 3];
                    installments = validatedInput_1.installments.map(function (inst) { return ({
                ...
                case 6:
                    ...
                    throw new Error("Failed to create payment: ".concat(error_7 instanceof Error ? error_7.message : 'Unknown error'));
                case 7: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    throw new Error("Failed to fetch payment: ".concat(error_8 instanceof Error ? error_8.message : 'Unknown error'));
                case 3: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    updateData = __assign(__assign({}, validatedInput), { updated_at: new Date().toISOString() });
                    // Convert processing fee to centavos if provided
                    if (validatedInput.processing_fee !== undefined) {
                        updateData.processing_fee = (0, financial_1.reaisToCentavos)(validatedInput.processing_fee);
                    }
                ...
                case 3:
                    ...
                    throw new Error("Failed to update payment: ".concat(error_9 instanceof Error ? error_9.message : 'Unknown error'));
                case 4: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    throw new Error("Failed to list payments: ".concat(error_10 instanceof Error ? error_10.message : 'Unknown error'));
                case 3: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    ...
                    throw new Error("Shadow validation failed: ".concat(error_11 instanceof Error ? error_11.message : 'Unknown error'));
                case 6: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (operationType) {
                case 'invoice_calculation':
                    ...
                    shadow = {
                        subtotal: data.items.reduce(function (sum, item) { return sum + (item.unit_price * item.quantity); }, 0),
                        discount: data.items.reduce(function (sum, item) { return sum + item.discount_amount; }, 0),
                        tax: data.items.reduce(function (sum, item) { return sum + item.tax_amount; }, 0),
                        total: 0,
                    };
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error)
                        throw error;
                    summary_1 = {
                        total_invoices: (invoices === null || invoices === void 0 ? void 0 : invoices.length) || 0,
                        total_amount: 0,
                        total_paid: 0,
                        total_pending: 0,
                        total_overdue: 0,
                    ...
                    if (invoices) {
                        summary_1.total_amount = invoices.reduce(function (sum, inv) { return sum + inv.total_amount; }, 0);
                        summary_1.total_paid = invoices.filter(function (inv) { return inv.payment_status === 'paid'; }).reduce(function (sum, inv) { return sum + inv.total_amount; }, 0);
                        summary_1.total_pending = invoices.filter(function (inv) { return inv.payment_status === 'pending'; }).reduce(function (sum, inv) { return sum + inv.total_amount; }, 0);
                        summary_1.total_overdue = invoices.filter(function (inv) { return inv.payment_status === 'overdue'; }).reduce(function (sum, inv) { return sum + inv.total_amount; }, 0);
                        // Group by status
                ...
                case 3:
                    ...
                    throw new Error("Failed to get financial summary: ".concat(error_12 instanceof Error ? error_12.message : 'Unknown error'));
                case 4: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    throw new Error("NFSe generation failed: ".concat(error_13 instanceof Error ? error_13.message : 'Unknown error'));
                case 3: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    throw new Error("NFSe cancellation failed: ".concat(error_14 instanceof Error ? error_14.message : 'Unknown error'));
                case 3: return [2 /*return*/];
            }
        });
    });
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (payment.payment_method === 'pix') {
                        ...
                        mockResponse.pix_copy_paste = "00020126330014BR.GOV.BCB.PIX0111".concat(payment.pix_key, "520400005303986540").concat((0, financial_1.centavosToReais)(payment.amount).toFixed(2), "5802BR5925NEONPRO CLINIC6009SAO PAULO622905251234567890123456789063042EF7");
                    }
                    // Update payment with processing results
                    return [4 /*yield*/, updatePayment(payment.id, {
                ...
                case 2:
                    ...
                    throw new Error("Payment processing failed: ".concat(error_15 instanceof Error ? error_15.message : 'Unknown error'));
                case 3: return [2 /*return*/];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    invoice = _b.sent();
                    mockPDFContent = "\nInvoice #".concat(invoice.invoice_number, "\nDate: ").concat(new Date(invoice.issue_date).toLocaleDateString('pt-BR'), "\nPatient: ").concat(((_a = invoice.patient) === null || _a === void 0 ? void 0 : _a.name) || 'N/A', "\nTotal: ").concat((0, financial_1.formatCurrency)(invoice.total_amount), "\n");
                    blob = new Blob([mockPDFContent], { type: 'application/pdf' });
                    return [2 /*return*/, blob];
                case 2:
                    error_16 = _b.sent();
                    console.error('Error generating PDF:', error_16);
                    throw new Error("PDF generation failed: ".concat(error_16 instanceof Error ? error_16.message : 'Unknown error'));
                case 3: return [2 /*return*/];
            }
        });
    });
