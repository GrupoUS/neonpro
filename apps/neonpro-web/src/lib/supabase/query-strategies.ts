...
export type { HealthcareQueryType, QueryContext, QueryResult, QueryStrategy, AuditEntry };
...
export const HealthcareQueries = {
  patientData: (patientId: string) =>
    createQueryContext("", "", "patient_standard", { patientId, lgpdSensitive: true }),
  ...
  clinicalWorkflow: () => createQueryContext("", "", "clinical_workflow", { priority: "high" }),
  ...
  financial: () =>
    createQueryContext("", "", "financial_sensitive", { priority: "high", lgpdSensitive: true }),
};
