...
var HealthcareConnectionRetryManager = /** @class */ (function () {
    ...
    HealthcareConnectionRetryManager.prototype.executeWithRetry = function (operation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, config, circuitBreakerKey, lastError, attempts, poolManager, client, timeoutMs, result, complianceValidated, _a, error_1, errorClassification, delay, totalTime, patientSafetyEnsured;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (config.circuitBreakerEnabled && this.isCircuitBreakerOpen(circuitBreakerKey)) {
                            return [2 /*return*/, {
                                    ...
                                    finalError: new Error('Circuit breaker is open - service temporarily unavailable'),
                    ...
                    case 2:
                        ...
                        client = poolManager.getHealthcareClient(options.clinicId, options.priority === 'emergency' || options.priority === 'critical' ? 'critical' : 'standard');
                        timeoutMs = this.getTimeoutForPriority(options.priority);
                        return [4 /*yield*/, this.executeWithTimeout(operation(client), timeoutMs)
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, this.logHealthcareError(error_1, options, attempts, errorClassification)
                    ...
                    case 10:
                        ...
                        console.warn("Healthcare operation failed, retrying in ".concat(delay, "ms (attempt ").concat(attempts, "/").concat(config.maxAttempts, "):"), {
                            error: error_1.message,
                            clinicId: options.clinicId,
                    ...
                    case 14:
                        totalTime = Date.now() - startTime;
                        return [4 /*yield*/, this.handleHealthcareFailure(lastError, options, attempts, totalTime)];
                    case 15:
    ...
    HealthcareConnectionRetryManager.prototype.classifyHealthcareError = function (error) {
        ...
        if (message.includes('authorization') || message.includes('permission') || code === 'PGRST302') {
            return {
                type: 'authorization',
                severity: 'critical',
                isRetryable: false,
    ...
    HealthcareConnectionRetryManager.prototype.calculateDelay = function (attempt, config) {
        var exponentialDelay = Math.min(config.baseDelay * Math.pow(config.backoffMultiplier, attempt - 1), config.maxDelay);
        if (config.jitter) {
    ...
    HealthcareConnectionRetryManager.prototype.getTimeoutForPriority = function (priority) {
        switch (priority) {
            case 'emergency': return 5000; // 5 seconds for emergency
            case 'critical': return 10000; // 10 seconds for critical
            case 'standard': return 15000; // 15 seconds for standard
            case 'background': return 30000; // 30 seconds for background
        }
    };
    /**
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.race([
                        ...
                        new Promise(function (_, reject) {
                            setTimeout(function () { return reject(new Error("Healthcare operation timeout after ".concat(timeoutMs, "ms"))); }, timeoutMs);
                        })
                    ])];
            });
        });
     ...
     */
    HealthcareConnectionRetryManager.prototype.logHealthcareError = function (error, options, attempt, classification) {
        return __awaiter(this, void 0, void 0, function () {
            var errorLog;
            return __generator(this, function (_a) {
                errorLog = {
     ...
     */
    HealthcareConnectionRetryManager.prototype.escalateEmergency = function (error, options, classification) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    HealthcareConnectionRetryManager.prototype.handleHealthcareFailure = function (error, options, attempts, totalTime) {
        return __awaiter(this, void 0, void 0, function () {
            var classification;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.activatePatientSafetyProtocols(error, options, classification)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, false]; // Patient safety could not be ensured
                    case 2: return [2 /*return*/, true]; // No patient safety impact
                }
            });
        });
    };
     ...
     */
    HealthcareConnectionRetryManager.prototype.activatePatientSafetyProtocols = function (error, options, classification) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    HealthcareConnectionRetryManager.prototype.validateHealthcareCompliance = function (options, result) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
    ...
    HealthcareConnectionRetryManager.prototype.monitorCircuitBreakers = function () {
        for (var _i = 0, _a = this.circuitBreakers; _i < _a.length; _i++) {
            var _b = _a[_i], key = _b[0], breaker = _b[1];
            if (breaker.state === 'open') {
    ...
    HealthcareConnectionRetryManager.prototype.getRetryStatistics = function () {
        var openBreakers = Array.from(this.circuitBreakers.values())
            .filter(function (b) { return b.state === 'open'; }).length;
        return {
...
// Export singleton
var getRetryManager = function () { return HealthcareConnectionRetryManager.getInstance(); };
...
var executeWithHealthcareRetry = function (operation_1, clinicId_1, operationType_1) {
    ...
    return __awaiter(void 0, __spreadArray([operation_1, clinicId_1, operationType_1], args_1, true), void 0, function (operation, clinicId, operationType, priority, options) {
        var retryManager;
        if (priority === void 0) { priority = 'standard'; }
        return __generator(this, function (_a) {
            retryManager = (0, exports.getRetryManager)();
            return [2 /*return*/, retryManager.executeWithRetry(operation, {
                    clinicId: clinicId,
                    ...
                    requiresCompliance: (options === null || options === void 0 ? void 0 : options.requiresCompliance) || false
                })];
        });
    });
};
