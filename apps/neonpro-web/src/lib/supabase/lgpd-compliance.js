...
var LGPDComplianceManager = /** @class */ (() => {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            enhancedEntry = __assign(__assign({}, logEntry), {
              user_id:
                logEntry.user_id ||
              ...
              metadata: __assign(__assign({}, logEntry.metadata), {
                compliance_version: "1.0",
                lgpd_article: this.getLGPDArticle(logEntry.event_type),
                timestamp_utc: new Date().toISOString(),
                user_role:
                  ((_a = user === null || user === void 0 ? void 0 : user.user_metadata) === null ||
                  _a === void 0
                    ? void 0
                    : _a.role) || "unknown",
                application: "NeonPro",
            ...
            return [4 /*yield*/, this.supabase.from("lgpd_audit_logs").insert(enhancedEntry)];
          case 2:
            error = _b.sent().error;
            if (error) {
   ...
   */
  LGPDComplianceManager.prototype.logPatientDataAccess = function (
    patientId,
    clinicId,
    accessType,
    tableAccessed,
   ...
   */
  LGPDComplianceManager.prototype.logConsentAction = function (
    patientId,
    clinicId,
    consentType,
    action,
   ...
   */
  LGPDComplianceManager.prototype.logSensitiveDataAccess = function (
    userId,
    patientId,
    clinicId,
    dataType,
   ...
   */
  LGPDComplianceManager.prototype.processDataSubjectRequest = function (
    patientId,
    clinicId,
    requestType,
    requestDetails,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [3 /*break*/, 8];
          case 2:
            return [4 /*yield*/, this.exportPatientData(patientId, clinicId)];
          case 3:
            return [2 /*return*/, _b.sent()];
          case 4:
            return [4 /*yield*/, this.anonymizePatientData(patientId, clinicId)];
          case 5:
            return [2 /*return*/, _b.sent()];
          case 6:
            return [4 /*yield*/, this.exportPatientDataPortable(patientId, clinicId)];
          case 7:
            return [2 /*return*/, _b.sent()];
          case 8:
            return [
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            if (exportResult.success && exportResult.data) {
              portableData = __assign(__assign({}, exportResult.data), {
...
var HealthcareLGPDHooks = /** @class */ (() => {
   ...
   */
  HealthcareLGPDHooks.prototype.beforePatientAccess = function (
    patientId,
    clinicId,
    action,
    context,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.compliance.logPatientDataAccess(
                patientId,
                clinicId,
                action,
   ...
   */
  HealthcareLGPDHooks.prototype.beforeSensitiveDataAccess = function (
    patientId,
    clinicId,
    dataType,
    action,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.compliance.logSensitiveDataAccess(
                context.userId,
                patientId,
                clinicId,
                dataType,
   ...
   */
  HealthcareLGPDHooks.prototype.validateConsent = function (
    patientId,
    clinicId,
    consentType,
    purpose,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.compliance.createAuditLog({
