            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (filters === null || filters === void 0 ? void 0 : filters.search) {
                        query = query.or("name.ilike.%".concat(filters.search, "%,sku.ilike.%").concat(filters.search, "%,description.ilike.%").concat(filters.search, "%"));
                    }
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, supabase
                            .from('inventory_items')
                            .insert(__assign(__assign({}, item), { created_by: (_b = userData.user) === null || _b === void 0 ? void 0 : _b.id, last_updated_by: (_c = userData.user) === null || _c === void 0 ? void 0 : _c.id }))
                            .select("\n        *,\n        category:inventory_categories(*),\n        location:inventory_locations(*)\n      ")
                            .single()];
                case 2:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, supabase
                            .from('inventory_items')
                            .update(__assign(__assign({}, updates), { last_updated_by: (_b = userData.user) === null || _b === void 0 ? void 0 : _b.id }))
                            .eq('id', id)
                            .select("\n        *,\n        category:inventory_categories(*),\n        location:inventory_locations(*)\n      ")
                            .single()];
                case 2:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, supabase.rpc('update_stock_level', {
                            p_inventory_item_id: inventoryItemId,
                            p_quantity: quantity,
                            p_movement_type: movementType,
                            p_location_id: locationId,
                            p_user_id: userData.user.id,
                            p_reference_type: (options === null || options === void 0 ? void 0 : options.referenceType) || null,
                            p_reference_id: (options === null || options === void 0 ? void 0 : options.referenceId) || null,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                return [4 /*yield*/, _c.apply(_b, [(_d.total_items_scanned = _e.sent(),
                            _d)])
                        .eq('id', sessionId)];
                case 3:
                    // Update session total count
