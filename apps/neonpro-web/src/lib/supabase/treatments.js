            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    treatmentPlan = {
                        ...
                        status: data.status,
                        intent: data.intent,
                        category: data.category.map(function (cat) { return ({
                        ...
                        care_team: [],
                        goals: data.goals.map(function (goal) { return ({ reference: "Goal/".concat(goal) }); }),
                        activities: [],
                        supporting_info: [],
                        addresses: data.addresses.map(function (addr) { return ({ reference: "Condition/".concat(addr) }); }),
                        fhir_meta: {
                            versionId: '1',
                        ...
                        fhir_text: {
                            status: 'generated',
                            div: "<div>".concat(data.title, ": ").concat(data.description || 'Plano de tratamento', "</div>")
                        },
                        ...
                        data_retention_until: data.data_consent_given ?
                            new Date(Date.now() + 10 * 365 * 24 * 60 * 60 * 1000).toISOString() : null, // 10 years
                        version: 1,
                        created_by: user.id,
                        updated_by: user.id,
                    };
                ...
                case 2:
                    ...
                    if (error)
                        throw new Error("Erro ao criar plano de tratamento: ".concat(error.message));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!user)
                        throw new Error('Usuário não autenticado');
                    updateData = __assign(__assign({}, data), { fhir_meta: {
                            lastUpdated: new Date().toISOString(),
                        }, updated_by: user.id });
                    return [4 /*yield*/, supabase
                            .from('treatment_plans')
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (filters.search_text) {
                        query = query.or("title.ilike.%".concat(filters.search_text, "%,description.ilike.%").concat(filters.search_text, "%"));
                    }
                    from = (page - 1) * perPage;
                    to = from + perPage - 1;
                ...
                case 1:
                    ...
                    if (error)
                        throw new Error("Erro ao buscar planos de tratamento: ".concat(error.message));
                    return [2 /*return*/, {
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    procedure = {
                        ...
                        reason_code: data.reason_code.map(function (code) { return ({
                            coding: [{ code: code, display: code }]
                        }); }),
                        reason_reference: [],
                        body_site: data.body_site.map(function (site) { return ({
                ...
                case 2:
                    _a = _b.sent(), result = _a.data, error = _a.error;
                    if (error)
                        throw new Error("Erro ao criar procedimento: ".concat(error.message));
                    return [2 /*return*/, result];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a = _b.sent(), result = _a.data, error = _a.error;
                    if (error)
                        throw new Error("Erro ao atualizar procedimento: ".concat(error.message));
                    return [2 /*return*/, result];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), data = _a.data, error = _a.error, count = _a.count;
                    if (error)
                        throw new Error("Erro ao buscar procedimentos: ".concat(error.message));
                    return [2 /*return*/, {
                            procedures: data || [],
                            total_count: count || 0,
                            page: page,
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    clinicalNote = {
                        ...
                        fhir_text: {
                            status: 'generated',
                            div: "<div>".concat(data.title, ": ").concat(data.content.substring(0, 100), "...</div>")
                        },
                        data_consent_given: data.data_consent_given,
                        data_consent_date: data.data_consent_given ? new Date().toISOString() : null,
                        data_retention_until: data.data_consent_given ?
                ...
                case 2:
                    _a = _b.sent(), result = _a.data, error = _a.error;
                    if (error)
                        throw new Error("Erro ao criar nota cl\u00EDnica: ".concat(error.message));
                    return [2 /*return*/, result];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a = _b.sent(), result = _a.data, error = _a.error;
                    if (error)
                        throw new Error("Erro ao atualizar nota cl\u00EDnica: ".concat(error.message));
                    return [2 /*return*/, result];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (filters.search_text) {
                        query = query.or("title.ilike.%".concat(filters.search_text, "%,content.ilike.%").concat(filters.search_text, "%"));
                    }
                    from = (page - 1) * perPage;
                    to = from + perPage - 1;
                    return [4 /*yield*/, query
                ...
                case 1:
                    _a = _b.sent(), data = _a.data, error = _a.error, count = _a.count;
                    if (error)
                        throw new Error("Erro ao buscar notas cl\u00EDnicas: ".concat(error.message));
                    return [2 /*return*/, {
                            clinical_notes: data || [],
                            total_count: count || 0,
                            page: page,
...
function getTreatmentStatistics() {
    return __awaiter(this, void 0, void 0, function () {
        var user, treatmentPlansStats, proceduresStats, thisMonth, proceduresThisMonth, outcomes, procedureCounts, mostCommonProcedures, completedPlans, avgDuration;
            ...
            switch (_a.label) {
                ...
                case 5:
                    ...
                    procedureCounts = (proceduresStats || []).reduce(function (acc, proc) {
                        ...
                        var code = ((_c = (_b = (_a = proc.code) === null || _a === void 0 ? void 0 : _a.coding) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.code) || 'unknown';
                        var display = ((_f = (_e = (_d = proc.code) === null || _d === void 0 ? void 0 : _d.coding) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.display) || 'Procedimento não especificado';
                        if (!acc[code]) {
                    ...
                    mostCommonProcedures = Object.values(procedureCounts)
                        ...
                        .slice(0, 5);
                    completedPlans = (treatmentPlansStats || []).filter(function (plan) { return plan.status === 'completed'; });
                    avgDuration = completedPlans.length > 0 ?
                        ...
                        }, 0) / completedPlans.length : 0;
                    return [2 /*return*/, {
                            total_treatment_plans: (treatmentPlansStats === null || treatmentPlansStats === void 0 ? void 0 : treatmentPlansStats.length) || 0,
                            active_treatment_plans: (treatmentPlansStats === null || treatmentPlansStats === void 0 ? void 0 : treatmentPlansStats.filter(function (p) { return p.status === 'active'; }).length) || 0,
                            completed_treatment_plans: (treatmentPlansStats === null || treatmentPlansStats === void 0 ? void 0 : treatmentPlansStats.filter(function (p) { return p.status === 'completed'; }).length) || 0,
                            total_procedures: (proceduresStats === null || proceduresStats === void 0 ? void 0 : proceduresStats.length) || 0,
                            procedures_this_month: (proceduresThisMonth === null || proceduresThisMonth === void 0 ? void 0 : proceduresThisMonth.length) || 0,
                            average_treatment_duration_days: Math.round(avgDuration),
                            most_common_procedures: mostCommonProcedures,
                            treatment_outcomes: {
                                successful: (outcomes === null || outcomes === void 0 ? void 0 : outcomes.filter(function (o) { var _a, _b, _c; return ((_c = (_b = (_a = o.outcome) === null || _a === void 0 ? void 0 : _a.coding) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.code) === 'successful'; }).length) || 0,
                                partial: (outcomes === null || outcomes === void 0 ? void 0 : outcomes.filter(function (o) { var _a, _b, _c; return ((_c = (_b = (_a = o.outcome) === null || _a === void 0 ? void 0 : _a.coding) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.code) === 'partial'; }).length) || 0,
                                unsuccessful: (outcomes === null || outcomes === void 0 ? void 0 : outcomes.filter(function (o) { var _a, _b, _c; return ((_c = (_b = (_a = o.outcome) === null || _a === void 0 ? void 0 : _a.coding) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.code) === 'unsuccessful'; }).length) || 0,
                            },
                        }];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error = (_a.sent()).error;
                    if (error)
                        throw new Error("Erro ao excluir plano de tratamento: ".concat(error.message));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error = (_a.sent()).error;
                    if (error)
                        throw new Error("Erro ao excluir procedimento: ".concat(error.message));
                    return [2 /*return*/, true];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error = (_a.sent()).error;
                    if (error)
                        throw new Error("Erro ao excluir nota cl\u00EDnica: ".concat(error.message));
                    return [2 /*return*/, true];
            }
        });
    });
