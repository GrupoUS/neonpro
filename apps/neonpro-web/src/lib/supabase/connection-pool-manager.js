...
var NeonProConnectionPoolManager = /** @class */ (function () {
    function NeonProConnectionPoolManager(clinicSize) {
        if (clinicSize === void 0) { clinicSize = 'medium'; }
        this.pools = new Map();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        client = (0, ssr_1.createServerClient)(process.env.SUPABASE_URL, process.env.SUPABASE_ANON_KEY, {
                            cookies: {
                                get: function (name) {
                                    var _a;
                    ...
                    case 4:
                        ...
                        fallbackClient = (0, supabase_js_1.createClient)(process.env.SUPABASE_URL, process.env.SUPABASE_ANON_KEY);
    ...
    NeonProConnectionPoolManager.prototype.getBrowserClient = function (clinicId) {
        ...
        if (!this.pools.has(poolKey)) {
            var client = (0, ssr_1.createBrowserClient)(process.env.SUPABASE_URL, process.env.SUPABASE_ANON_KEY);
            this.pools.set(poolKey, client);
            this.initializeMetrics(poolKey);
        }
        this.updateConnectionMetrics(poolKey);
     ...
     */
    NeonProConnectionPoolManager.prototype.createOptimizedClient = function (operationType, clinicId) {
    ...
    NeonProConnectionPoolManager.prototype.performHealthChecks = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, _b, poolKey, client, startTime, error, responseTime, metrics, healthCheck, error_2, failedHealthCheck;
                ...
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        healthCheck = {
                            ...
                            connectionCount: (metrics === null || metrics === void 0 ? void 0 : metrics.activeConnections) || 0,
                            poolUtilization: (((metrics === null || metrics === void 0 ? void 0 : metrics.activeConnections) || 0) / this.config.maxClients) * 100,
                        ...
                        if (!(!healthCheck.compliance.lgpdCompliant ||
                            ...
                            !healthCheck.compliance.cfmCompliant)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.handleComplianceViolation(poolKey, healthCheck)];
                    case 4:
                        _c.sent();
                        _c.label = 5;
                    case 5:
                        if (!(healthCheck.status === 'unhealthy' || responseTime > 2000)) return [3 /*break*/, 7];
     ...
     */
    NeonProConnectionPoolManager.prototype.handleComplianceViolation = function (poolKey, healthCheck) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.error("\uD83D\uDEA8 HEALTHCARE COMPLIANCE VIOLATION detected in pool: ".concat(poolKey), {
     ...
     */
    NeonProConnectionPoolManager.prototype.handlePerformanceDegradation = function (poolKey, healthCheck) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.warn("\u26A0\uFE0F Performance degradation detected in pool: ".concat(poolKey), {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        console.log("\u2705 Pool ".concat(poolKey, " recovered after ").concat(attempt, " attempts"));
                                        return [2 /*return*/, { value: void 0 }];
                                    case 2:
                                        error_3 = _b.sent();
                                        console.error("Retry attempt ".concat(attempt, " failed for pool ").concat(poolKey, ":"), error_3);
    ...
    NeonProConnectionPoolManager.prototype.getPoolAnalytics = function () {
        var _this = this;
        var pools = Array.from(this.pools.keys()).map(function (poolKey) { return ({
            poolKey: poolKey,
        ...
        var healthyPools = pools.filter(function (p) { return p.health.status === 'healthy'; }).length;
        var complianceScore = pools.reduce(function (acc, p) {
            var compliant = p.health.compliance.lgpdCompliant &&
                p.health.compliance.anvisaCompliant &&
                p.health.compliance.cfmCompliant;
            return acc + (compliant ? 1 : 0);
        }, 0) / pools.length * 100;
        var avgResponseTime = pools.reduce(function (acc, p) { return acc + p.health.avgResponseTime; }, 0) / pools.length;
        return {
            pools: pools,
            summary: {
