      ...
      switch (_b.label) {
        case 0:
          ...
          if (filters.search) {
            query = query.or(
              "first_name.ilike.%"
                .concat(filters.search, "%,last_name.ilike.%")
                .concat(filters.search, "%,email.ilike.%")
          ...
          // Sorting
          query = query.order(filters.sort_by || "last_name", {
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 1:
          ...
          if (error) {
            throw new Error(
              "Failed to get professionals with expiring licenses: ".concat(error.message),
            );
          }
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          ...
          // Sorting
          query = query.order(filters.sort_by || "expiration_date", {
            ascending: filters.sort_order === "asc",
          });
          from = (filters.page - 1) * filters.limit;
          to = from + filters.limit - 1;
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          ...
          if (
            (filters === null || filters === void 0 ? void 0 : filters.professional_ids) &&
            filters.professional_ids.length > 0
          ) {
            query = query.in("professional_id", filters.professional_ids);
          }
          if (
            (filters === null || filters === void 0 ? void 0 : filters.metric_types) &&
        ...
        case 0:
          return [
            ...
            supabase
              .from("credentialing_workflow")
              .update(
                __assign(__assign({ status: status }, updates), {
    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        ...
        case 3:
          ...
          return [
            ...
            createAlert({
              ...
              message: "Your "
                .concat(credential.credential_name, " will expire on ")
                .concat(credential.expiration_date, ". Please renew before expiration."),
        ...
        case 5:
          error_1 = _a.sent();
          console.error(
            "Failed to create alert for credential ".concat(credential.id, ":"),
            error_1,
          );
          return [3 /*break*/, 6];
        case 6:
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 1:
          ...
          if (!professional) return [2 /*return*/, null];
          return [
            4 /*yield*/,
            Promise.all([
        ...
        case 2:
          (_a = _b.sent()),
            (recentMetrics = _a[0]),
            (activeCredentials = _a[1]),
            (currentServices = _a[2]),
            (recentDevelopment = _a[3]),
            (activeWorkflows = _a[4]),
            (activeAlerts = _a[5]);
          return [
            2 /*return*/,
            {
