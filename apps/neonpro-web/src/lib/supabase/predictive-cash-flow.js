    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            supabase.from("prediction_models").update(updateData).eq("id", id).select("*").single(),
          ];
        case 1:
          (_a = _b.sent()), (data = _a.data), (error = _a.error);
          if (error) {
  ...
  return __awaiter(this, arguments, void 0, function (supabase, filters, pagination) {
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          _b.trys.push([0, 2, , 3]);
          query = supabase.from("prediction_models").select("*", { count: "exact" });
          // Apply filters
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            supabase.from("prediction_models").select("*").eq("id", id).single(),
          ];
        case 1:
          (_a = _b.sent()), (data = _a.data), (error = _a.error);
          if (error) {
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 2, , 3]);
          return [4 /*yield*/, supabase.from("prediction_models").delete().eq("id", id)];
        case 1:
          error = _a.sent().error;
          if (error) {
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 2:
          ...
          return [
            2 /*return*/,
            { data: [], total: 0, error: "Failed to fetch cash flow predictions" },
          ];
        case 3:
          return [2 /*return*/];
      }
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            supabase.from("forecasting_scenarios").select("clinic_id").eq("id", id).single(),
          ];
        case 1:
  ...
  return __awaiter(this, arguments, void 0, function (supabase, filters, pagination) {
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          _b.trys.push([0, 2, , 3]);
          query = supabase.from("forecasting_scenarios").select("*", { count: "exact" });
          // Apply filters
          if (filters.clinic_id) {
            query = query.eq("clinic_id", filters.clinic_id);
          }
        ...
        case 2:
          ...
          return [
            2 /*return*/,
            { data: [], total: 0, error: "Failed to fetch forecasting scenarios" },
          ];
        case 3:
          return [2 /*return*/];
      }
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          _b.trys.push([0, 2, , 3]);
          return [4 /*yield*/, supabase.rpc("get_model_accuracy_summary", { p_model_id: modelId })];
        case 1:
          (_a = _b.sent()), (data = _a.data), (error = _a.error);
          if (error) {
...
function generateCashFlowForecast(supabase_1, clinicId_1, periodType_1) {
  return __awaiter(
    ...
    arguments,
    void 0,
    function (supabase, clinicId, periodType, periodsAhead) {
      var models,
        model,
        predictions,
        totalInflow,
      ...
      return __generator(this, (_c) => {
        switch (_c.label) {
          ...
          case 2:
            ...
            lowestPeriod =
              ((_b = sortedByNet[sortedByNet.length - 1]) === null || _b === void 0
                ? void 0
                : _b.start_date) || "";
