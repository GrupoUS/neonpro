...
var BrazilianTaxEngine = /** @class */ (function () {
    ...
    BrazilianTaxEngine.prototype.calculateTaxes = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var validatedRequest, taxConfig, serviceTaxCode, regime, taxBreakdown, totalTaxes, netValue, calculation, error_3;
                    ...
                    case 3:
                        ...
                        switch (regime) {
                            case 'simples_nacional':
                                taxBreakdown = this.calculateSimplesNacional(validatedRequest.valor_base, taxConfig, serviceTaxCode);
                                break;
                            case 'lucro_presumido':
                                taxBreakdown = this.calculateLucroPresumido(validatedRequest.valor_base, taxConfig, serviceTaxCode);
                                break;
                            case 'lucro_real':
                                taxBreakdown = this.calculateLucroReal(validatedRequest.valor_base, taxConfig, serviceTaxCode);
                                break;
                            default:
                                throw new Error("Unknown tax regime: ".concat(regime));
                        }
                        totalTaxes = Object.values(taxBreakdown).reduce(function (sum, value) { return sum + value; }, 0);
    ...
    BrazilianTaxEngine.prototype.calculateSimplesNacional = function (valorBase, taxConfig, serviceTaxCode) {
        var breakdown = {
            icms: 0,
            iss: 0,
            pis: 0,
    ...
    BrazilianTaxEngine.prototype.calculateLucroPresumido = function (valorBase, taxConfig, serviceTaxCode) {
        var breakdown = {
            icms: 0,
            iss: 0,
            pis: 0,
    ...
    BrazilianTaxEngine.prototype.calculateLucroReal = function (valorBase, taxConfig, serviceTaxCode) {
        var breakdown = {
            icms: 0,
            iss: 0,
            pis: 0,
    ...
    BrazilianTaxEngine.prototype.getEffectiveTaxRate = function (clinicId_1, serviceType_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, serviceType, valorBase) {
            ...
            if (valorBase === void 0) { valorBase = 1000; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.calculateTaxes({
                                clinic_id: clinicId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _i++;
                        return [3 /*break*/, 1];
                    case 6: return [2 /*return*/, calculations];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.calculateServiceTax(calculation.service_type, calculation.amount, clinicId, {
