...
var BrazilianTaxEngine = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            totalTaxes = Object.values(taxBreakdown).reduce(function (sum, value) {
              return sum + value;
            }, 0);
  ...
  BrazilianTaxEngine.prototype.calculateSimplesNacional = function (
    valorBase,
    taxConfig,
    serviceTaxCode,
  ) {
  ...
  BrazilianTaxEngine.prototype.calculateLucroPresumido = function (
    valorBase,
    taxConfig,
    serviceTaxCode,
  ) {
  ...
  BrazilianTaxEngine.prototype.calculateLucroReal = function (
    valorBase,
    taxConfig,
    serviceTaxCode,
  ) {
