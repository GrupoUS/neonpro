...
var CNPJConsultationService = /** @class */ (() => {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
              ...
              if (cached) {
                return [
                  2 /*return*/,
                  {
                    ...
                    cached: true,
                    cache_expiry:
                      (_a = cnpj_validator_1.CNPJCache.getCacheExpiry(cleanedCNPJ)) === null ||
                      _a === void 0
                        ? void 0
                        : _a.toISOString(),
                  },
              ...
              return [
                2 /*return*/,
                {
                  ...
                  rate_limit: {
                    ...
                    reset_time:
                      cnpj_validator_1.CNPJRateLimiter.getResetTime(clientIP).toISOString(),
                  },
                },
              ];
            }
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.fetchWithRetry("".concat(this.BASE_URL, "/").concat(cleanedCNPJ), finalConfig),
            ];
          case 2:
            data = _b.sent();
          ...
          case 4:
            ...
            if (
              !(
                ...
                error_2.name !== CNPJConsultationError.NOT_FOUND
              )
            )
              return [3 /*break*/, 6];
            return [
  ...
  CNPJConsultationService.transformBrasilAPIResponse = (response) => {
    ...
    return {
      ...
      telefone: response.ddd_telefone_1
        ? "("
            .concat(response.ddd_telefone_1.slice(0, 2), ") ")
            .concat(response.ddd_telefone_1.slice(2))
        : undefined,
            ...
            batchPromises = batch.map((cnpj) =>
              __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/, this.consultCNPJ(cnpj, clientIP, config)];
                    case 1:
                      result = _a.sent();
  ...
  CNPJConsultationService.getCacheStats = () => {
    ...
    var entriesCount =
      ((_a = cnpj_validator_1.CNPJCache.cache) === null || _a === void 0 ? void 0 : _a.size) || 0;
    return {
