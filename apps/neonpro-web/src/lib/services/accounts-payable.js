...
var AccountsPayableService = /** @class */ (function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (filters === null || filters === void 0 ? void 0 : filters.search) {
                            query = query.or("ap_number.ilike.%".concat(filters.search, "%,invoice_number.ilike.%").concat(filters.search, "%,description.ilike.%").concat(filters.search, "%"));
                        }
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, supabase.auth.getUser()];
                    case 1: return [4 /*yield*/, _b.apply(_a, [(_c.deleted_by = (_d = (_e.sent()).data.user) === null || _d === void 0 ? void 0 : _d.id,
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, supabase.auth.getUser()];
                    case 1:
                        updateData = (_c.updated_by = (_d = (_f.sent()).data.user) === null || _d === void 0 ? void 0 : _d.id,
                            _c.updated_at = new Date().toISOString(),
                            _c);
    ...
    AccountsPayableService.getDashboardStats = function () {
        return __awaiter(this, void 0, void 0, function () {
            var today, _a, totalResult, pendingResult, overdueResult, dueTodayResult, totalAmountResult, totalOpenAmount, error_7;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a = _c.sent(), totalResult = _a[0], pendingResult = _a[1], overdueResult = _a[2], dueTodayResult = _a[3], totalAmountResult = _a[4];
                        totalOpenAmount = ((_b = totalAmountResult.data) === null || _b === void 0 ? void 0 : _b.reduce(function (sum, ap) { return sum + (ap.balance_amount || 0); }, 0)) || 0;
                        return [2 /*return*/, {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, "AP".concat(year, "-").concat(nextNumber.toString().padStart(6, '0'))];
                    case 2:
                        error_9 = _b.sent();
