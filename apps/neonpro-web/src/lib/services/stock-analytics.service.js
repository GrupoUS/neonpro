...
var StockAnalyticsService = /** @class */ (() => {
  ...
  // METRICS CALCULATION
  // ==========================================
  StockAnalyticsService.prototype.calculateDailyMetrics = function (
    clinicId,
    date,
    alertType,
    severityLevel,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.calculateNotificationMetrics(clinicId, date, alertType, severityLevel),
            ];
          case 4:
  ...
  StockAnalyticsService.prototype.calculateRecurrenceCount = function (
    clinicId,
    startDate,
    endDate,
    alertType,
  ...
  StockAnalyticsService.prototype.calculateNotificationMetrics = function (
    clinicId,
    date,
    alertType,
    severityLevel,
        ...
        switch (_b.label) {
          ...
          case 2:
            ...
            if (error) {
              ...
              return [
                2 /*return*/,
                { automationTriggered: 0, notificationsSent: 0, successRate: 0 },
              ];
            }
            filteredNotifications =
            ...
            return [
              4 /*yield*/,
              this.countAutomationTriggers(clinicId, date, alertType, severityLevel),
            ];
          case 3:
  ...
  StockAnalyticsService.prototype.countAutomationTriggers = function (
    clinicId,
    date,
    alertType,
    severityLevel,
    ...
    return __awaiter(this, void 0, void 0, function () {
      var startOfDay,
        ...
        purchaseItems,
        purchaseError,
        purchaseOrderTriggers,
        configUpdateQuery,
        _b,
        configUpdates,
        configError,
        configUpdateTriggers,
        reorderQuery,
        _c,
        reorderSuggestions,
        reorderError,
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 2:
            ...
            purchaseOrderTriggers =
              (purchaseItems === null || purchaseItems === void 0
                ? void 0
          ...
          case 3:
            ...
            configUpdateTriggers =
              (configUpdates === null || configUpdates === void 0
                ? void 0
          ...
          case 4:
            ...
            reorderTriggers =
              (reorderSuggestions === null || reorderSuggestions === void 0
                ? void 0
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("alert_resolution_analytics").upsert({
  ...
  StockAnalyticsService.prototype.getResolutionTimeAnalysis = function (
    clinicId,
    startDate,
    endDate,
    alertType,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.calculateDailyMetrics(clinicId, date, alertType, severityLevel),
            ];
          case 4:
            metrics = _b.sent();
          ...
          case 5:
            ...
            if (saved) {
              ...
              results.failed++;
              results.errors.push(
                "Failed to save metrics for ".concat(alertType, "/").concat(severityLevel),
              );
            }
            return [3 /*break*/, 7];
          case 6:
            results.failed++;
            results.errors.push(
              "Failed to calculate metrics for ".concat(alertType, "/").concat(severityLevel),
            );
            _b.label = 7;
          case 7:
            _a++;
