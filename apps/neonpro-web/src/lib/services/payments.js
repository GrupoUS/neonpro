...
var PaymentsService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error_2)
                            throw error_2;
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.map(function (payment) {
                                var _a, _b;
                                return (__assign(__assign({}, payment), { vendor_name: (_a = payment.accounts_payable) === null || _a === void 0 ? void 0 : _a.vendor_name, invoice_number: (_b = payment.accounts_payable) === null || _b === void 0 ? void 0 : _b.invoice_number }));
                            })) || []];
                    case 2:
                        error_1 = _b.sent();
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, __assign(__assign({}, data), { vendor_name: (_b = data.accounts_payable) === null || _b === void 0 ? void 0 : _b.vendor_name, invoice_number: (_c = data.accounts_payable) === null || _c === void 0 ? void 0 : _c.invoice_number })];
                    case 2:
                        error_3 = _d.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        insertData = __assign(__assign({}, paymentData), { created_by: currentUser.user.id, created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
                        return [4 /*yield*/, this.supabase
                                .from('ap_payments')
                                .insert([insertData])
                                .select()
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!currentUser_1.user)
                            throw new Error('Usuário não autenticado');
                        payments = bulkData.payments.map(function (payment) { return ({
    ...
    PaymentsService.prototype.getPaymentSummary = function (dateFrom, dateTo) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _a, data, error_16, payments, completedPayments, pendingPayments, failedPayments, totalAmount, averageAmount, paymentMethods_1, error_15;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        if (error_16)
                            throw error_16;
                        payments = data || [];
                        completedPayments = payments.filter(function (p) { return p.status === 'completed'; });
                        pendingPayments = payments.filter(function (p) { return p.status === 'pending'; });
                        failedPayments = payments.filter(function (p) { return p.status === 'failed'; });
                        totalAmount = completedPayments.reduce(function (sum, p) { return sum + p.amount_paid; }, 0);
                        ...
                        completedPayments.forEach(function (payment) {
                            paymentMethods_1[payment.payment_method] = (paymentMethods_1[payment.payment_method] || 0) + 1;
                        });
                        return [2 /*return*/, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        totalPaid = (payments === null || payments === void 0 ? void 0 : payments.reduce(function (sum, p) { return sum + p.amount_paid; }, 0)) || 0;
...
var createpaymentsService = function () { return new PaymentsService(); };
