...
var ExpenseCategoryService = /** @class */ (() => {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              supabase.from("expense_categories").select("*").eq("id", id).single(),
            ];
          case 1:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_g) => {
        switch (_g.label) {
          case 0:
            _g.trys.push([0, 3, , 4]);
            _c = (_b = supabase.from("expense_categories")).insert;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_g) => {
        switch (_g.label) {
          case 0:
            _g.trys.push([0, 3, , 4]);
            _c = (_b = supabase.from("expense_categories")).update;
            _d = [__assign({}, categoryData)];
            _e = {};
            return [4 /*yield*/, supabase.auth.getUser()];
          case 1:
