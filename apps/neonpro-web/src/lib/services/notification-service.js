...
var NotificationService = /** @class */ (() => {
  ...
  NotificationService.prototype.updateNotificationConfig = function (id, config) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getNotificationConfigs(config.clinic_id || "")];
          case 1:
            existingConfig = _a.sent();
            configToUpdate = existingConfig.find((c) => c.id === id);
            if (!configToUpdate) {
              throw new Error("Configuration not found");
            }
            return [
              2 /*return*/,
              __assign(__assign(__assign({}, configToUpdate), config), {
                updated_at: new Date().toISOString(),
              }),
            ];
        }
  ...
  NotificationService.prototype.getDashboardAlerts = function (clinicId_1) {
    return __awaiter(this, arguments, void 0, function (clinicId, limit) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this.getDuePayments(clinicId, 7)];
          case 1:
            duePayments = _b.sent();
            alerts = [];
            for (_i = 0, _a = duePayments.slice(0, limit); _i < _a.length; _i++) {
              ...
              if (reminder.alert_type === "overdue") {
                ...
                message = "Conta de R$ "
                  .concat(reminder.accounts_payable.amount, " est\u00E1 ")
                  .concat(reminder.days_overdue, " dias em atraso");
                ...
                message = "Conta de R$ "
                  .concat(reminder.accounts_payable.amount, " vence em ")
                  .concat(reminder.days_until_due, " dias");
              }
              alerts.push({
                ...
                is_read: false,
                is_dismissed: false,
                action_url: "/dashboard/accounts-payable/payables?id=".concat(
                  reminder.accounts_payable.id,
                ),
  ...
  NotificationService.prototype.queueNotification = function (notification) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        queuedNotification = __assign(__assign({}, notification), {
          id: "queue_".concat(Date.now()),
          created_at: new Date().toISOString(),
          updated_at: new Date().toISOString(),
        });
  ...
  NotificationService.prototype.escalateOverduePayments = function (clinicId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getDuePayments(clinicId, 0)];
          case 1:
            overduePayments = _a.sent();
            overdue = overduePayments.filter((p) => p.alert_type === "overdue");
          ...
          case 3:
            ...
            console.log(
              "Escalated payment "
                .concat(payment.accounts_payable.id, " to level ")
                .concat(escalationLevel),
            );
            _a.label = 4;
          case 4:
            _i++;
  ...
  // Utilitários
  NotificationService.prototype.formatCurrency = (amount) =>
    new Intl.NumberFormat("pt-BR", {
      style: "currency",
      currency: "BRL",
    }).format(amount);
  NotificationService.prototype.formatDate = (date) => new Date(date).toLocaleDateString("pt-BR");
  NotificationService.prototype.calculateBusinessDays = (startDate, endDate) => {
    var count = 0;
...
var createnotificationService = () => new NotificationService();
