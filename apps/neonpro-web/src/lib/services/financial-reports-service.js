...
var FinancialReportsService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, mockAgingData.sort(function (a, b) { return b.total_amount - a.total_amount; })];
                    case 2:
                        error_1 = _a.sent();
    ...
    FinancialReportsService.prototype.getVendorPerformanceReport = function (clinicId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, mockPerformanceData.sort(function (a, b) { return a.risk_score - b.risk_score; })];
                    case 2:
                        error_2 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, mockCategoryData.sort(function (a, b) { return b.current_month - a.current_month; })];
                    case 2:
                        error_3 = _a.sent();
    ...
    FinancialReportsService.prototype.getCashFlowProjection = function (clinicId_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, periods, periodType) {
            var supabase, projections, currentDate, runningBalance, i, projectedOutflows, projectedInflows, netFlow, apDue, error_5;
            if (periods === void 0) { periods = 12; }
            if (periodType === void 0) { periodType = 'monthly'; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
...
var createfinancialReportsService = function () { return new FinancialReportsService(); };
