...
var EmailNotificationService = /** @class */ (function () {
    ...
    EmailNotificationService.prototype.sendOverduePaymentNotification = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendNotification('overduePayment', data)];
    ...
    EmailNotificationService.prototype.sendDueTodayNotification = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendNotification('dueToday', data)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EmailNotificationService.prototype.sendDueSoonNotification = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendNotification('dueSoon', data)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EmailNotificationService.prototype.sendPaymentCompletedNotification = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendNotification('paymentCompleted', data)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        smsSuccess = _a.sent();
                        _a.label = 5;
                    case 5: return [2 /*return*/, emailSuccess && smsSuccess];
                    case 6:
                        error_1 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        result = _b.sent();
                        console.log("\u2705 Email notification sent (".concat(type, ") to ").concat(data.recipientEmail, ":"), (_a = result.data) === null || _a === void 0 ? void 0 : _a.id);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    console.log("\uD83D\uDCF1 SMS notification would be sent to ".concat(data.recipientPhone, ": ").concat(message));
    ...
    EmailNotificationService.createNotificationData = function (accountsPayable, recipientEmail, recipientPhone) {
        return {
    ...
    EmailNotificationService.prototype.sendBatchNotifications = function (notifications) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.allSettled(notifications.map(function (_a) {
