                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (filters === null || filters === void 0 ? void 0 : filters.search) {
                            query = query.or("company_name.ilike.%".concat(filters.search, "%,vendor_code.ilike.%").concat(filters.search, "%,contact_person.ilike.%").concat(filters.search, "%"));
                        }
                        ...
                        if ((filters === null || filters === void 0 ? void 0 : filters.requires_approval) !== undefined) {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, supabase.auth.getUser()];
                    case 1: return [4 /*yield*/, _c.apply(_b, [(_d.updated_by = (_e = (_f.sent()).data.user) === null || _e === void 0 ? void 0 : _e.id,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, vendors.map(function (vendor) { return ({
                                id: vendor.id,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a = _c.sent(), totalResult = _a[0], activeResult = _a[1], inactiveResult = _a[2], typesResult = _a[3];
                        typeDistribution = ((_b = typesResult.data) === null || _b === void 0 ? void 0 : _b.reduce(function (acc, vendor) {
