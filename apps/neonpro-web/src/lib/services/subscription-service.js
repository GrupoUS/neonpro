...
var SubscriptionService = /** @class */ (function () {
  ...
  SubscriptionService.prototype.createCheckoutSession = function (
    planId,
    userId,
    userEmail,
    successUrl,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              stripe_1.stripe.billingPortal.sessions.create({
                customer: customerId,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              stripe_1.stripe.subscriptions.list({
                customer: customerId,
                status: "active",
                limit: 1,
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              stripe_1.stripe.subscriptions.update(subscriptionId, {
            ...
            return [
              ...
              supabase.from("user_subscriptions").upsert({
                ...
                current_period_start:
                  (_a = subscriptionData.currentPeriodStart) === null || _a === void 0
                    ? void 0
                    : _a.toISOString(),
                current_period_end:
                  (_b = subscriptionData.currentPeriodEnd) === null || _b === void 0
                    ? void 0
                    : _b.toISOString(),
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            subscription = _a.sent();
            if (!subscription) return [2 /*return*/, false];
            return [
              2 /*return*/,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [3 /*break*/, 11];
          case 1:
            return [4 /*yield*/, this.handleCheckoutCompleted(event.data.object)];
          case 2:
            _b.sent();
            return [3 /*break*/, 12];
          case 3:
            return [4 /*yield*/, this.handleSubscriptionChange(event.data.object)];
          case 4:
            _b.sent();
            return [3 /*break*/, 12];
          case 5:
            return [4 /*yield*/, this.handleSubscriptionDeleted(event.data.object)];
          case 6:
            _b.sent();
            return [3 /*break*/, 12];
          case 7:
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.subscriptionService.updateUserSubscription(userId, {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            _b.sent();
            console.log(
              "Subscription updated for user ".concat(userId, ": ").concat(subscription.status),
            );
            return [3 /*break*/, 3];
          case 2:
            error_10 = _b.sent();
