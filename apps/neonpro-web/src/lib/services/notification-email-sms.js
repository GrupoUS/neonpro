...
var NotificationService = /** @class */ (function () {
        ...
        switch (type) {
            case 'overdue':
                return {
                    ...
                    html: "\n            <div style=\"font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;\">\n              <h2 style=\"color: #dc2626;\">\u26A0\uFE0F Conta Vencida</h2>\n              <p><strong>Fornecedor:</strong> ".concat(context.vendorName, "</p>\n              <p><strong>Fatura:</strong> ").concat(context.invoiceNumber, "</p>\n              <p><strong>Valor:</strong> R$ ").concat(context.amount.toFixed(2), "</p>\n              <p><strong>Vencimento:</strong> ").concat(context.dueDate, "</p>\n              <p><strong>Dias em Atraso:</strong> ").concat(context.daysPastDue, " dias</p>\n              <div style=\"background-color: #fee2e2; padding: 15px; border-radius: 5px; margin: 20px 0;\">\n                <p style=\"color: #dc2626; margin: 0;\">\n                  <strong>A\u00E7\u00E3o Urgente Necess\u00E1ria:</strong> Esta conta est\u00E1 vencida h\u00E1 ").concat(context.daysPastDue, " dias. \n                  Por favor, providencie o pagamento o mais breve poss\u00EDvel para evitar juros e multas.\n                </p>\n              </div>\n              <a href=\"http://127.0.0.1:8080/dashboard/accounts-payable\" \n                 style=\"background-color: #dc2626; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; display: inline-block;\">\n                Acessar Sistema\n              </a>\n            </div>\n          "),
                    text: "Conta Vencida - ".concat(context.invoiceNumber, " - ").concat(context.vendorName, " - R$ ").concat(context.amount.toFixed(2), " - ").concat(context.daysPastDue, " dias em atraso")
                };
            case 'due_today':
                return {
                    to: context.vendorName,
                    ...
                    text: "Vencimento Hoje - ".concat(context.invoiceNumber, " - ").concat(context.vendorName, " - R$ ").concat(context.amount.toFixed(2))
                };
            case 'due_soon':
                return {
                    to: context.vendorName,
                    subject: "".concat(baseSubject, "Vencimento Pr\u00F3ximo - ").concat(context.invoiceNumber),
                    ...
                    text: "Vencimento Pr\u00F3ximo - ".concat(context.invoiceNumber, " - ").concat(context.vendorName, " - R$ ").concat(context.amount.toFixed(2), " em ").concat(context.dueDate)
                };
            case 'payment_complete':
                return {
                    to: context.vendorName,
                    subject: "".concat(baseSubject, "Pagamento Realizado - ").concat(context.invoiceNumber),
                    html: "\n            <div style=\"font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;\">\n              <h2 style=\"color: #10b981;\">\u2705 Pagamento Realizado</h2>\n              <p><strong>Fornecedor:</strong> ".concat(context.vendorName, "</p>\n              <p><strong>Fatura:</strong> ").concat(context.invoiceNumber, "</p>\n              <p><strong>Valor Pago:</strong> R$ ").concat(context.amount.toFixed(2), "</p>\n              <div style=\"background-color: #d1fae5; padding: 15px; border-radius: 5px; margin: 20px 0;\">\n                <p style=\"color: #065f46; margin: 0;\">\n                  <strong>Confirmado:</strong> O pagamento foi processado com sucesso.\n                </p>\n              </div>\n              <a href=\"http://127.0.0.1:8080/dashboard/accounts-payable\" \n                 style=\"background-color: #10b981; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; display: inline-block;\">\n                Ver Comprovante\n              </a>\n            </div>\n          "),
                    text: "Pagamento Realizado - ".concat(context.invoiceNumber, " - ").concat(context.vendorName, " - R$ ").concat(context.amount.toFixed(2))
                };
            default:
                return {
                    to: context.vendorName,
                    subject: "".concat(baseSubject, "Notifica\u00E7\u00E3o - ").concat(context.invoiceNumber),
                    html: "<p>Notifica\u00E7\u00E3o sobre a fatura ".concat(context.invoiceNumber, " - ").concat(context.vendorName, "</p>"),
                    text: "Notifica\u00E7\u00E3o sobre a fatura ".concat(context.invoiceNumber, " - ").concat(context.vendorName)
                };
        }
    };
    // Templates de SMS
    NotificationService.prototype.getSMSTemplate = function (type, context) {
        switch (type) {
            case 'overdue':
                return "[NeonPro] URGENTE: Conta ".concat(context.invoiceNumber, " vencida h\u00E1 ").concat(context.daysPastDue, " dias. Valor: R$ ").concat(context.amount.toFixed(2), ". Acesse: http://127.0.0.1:8080/dashboard/accounts-payable");
            case 'due_today':
                return "[NeonPro] VENCE HOJE: ".concat(context.invoiceNumber, " - R$ ").concat(context.amount.toFixed(2), ". Providencie pagamento. Acesse: http://127.0.0.1:8080/dashboard/accounts-payable");
            case 'due_soon':
                return "[NeonPro] Vence ".concat(context.dueDate, ": ").concat(context.invoiceNumber, " - R$ ").concat(context.amount.toFixed(2), ". Prepare-se para o pagamento.");
            case 'payment_complete':
                return "[NeonPro] \u2705 Pagamento confirmado: ".concat(context.invoiceNumber, " - R$ ").concat(context.amount.toFixed(2));
            default:
                return "[NeonPro] Notifica\u00E7\u00E3o sobre ".concat(context.invoiceNumber, " - R$ ").concat(context.amount.toFixed(2));
        }
    };
    // Enviar email
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        console.log("\u2705 Email enviado: ".concat(template.subject, " para ").concat(recipientEmail));
