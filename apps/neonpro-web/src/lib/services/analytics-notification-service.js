...
var ANALYTICS_NOTIFICATION_TEMPLATES = {
    trial_started: {
        ...
        message: 'Seu trial {{trialType}} foi iniciado e expira em {{endDate}}. Aproveite todos os recursos premium!',
        priority: 'medium',
    ...
    trial_ending: {
        ...
        message: 'Seu trial {{trialType}} expira em {{daysLeft}} dias. Faça upgrade agora para continuar aproveitando os recursos premium.',
        priority: 'high',
    ...
    trial_expired: {
        ...
        message: 'Seu trial {{trialType}} expirou. Faça upgrade para um plano pago para restaurar o acesso aos recursos premium.',
        priority: 'urgent',
        channels: ['database', 'websocket', 'email'],
        variables: ['trialType']
    },
    trial_converted: {
        ...
        message: 'Parabéns! Seu trial foi convertido com sucesso para uma assinatura {{subscriptionTier}}.',
        priority: 'medium',
        channels: ['database', 'websocket', 'email'],
    ...
    subscription_updated: {
        ...
        message: 'Sua assinatura foi atualizada para {{newTier}}. As mudanças entram em vigor imediatamente.',
        priority: 'medium',
        channels: ['database', 'websocket', 'email'],
        variables: ['newTier']
    },
    ...
    payment_failed: {
        ...
        message: 'Seu pagamento de {{amount}} não pôde ser processado. Por favor, atualize seu método de pagamento.',
        priority: 'urgent',
        channels: ['database', 'websocket', 'email'],
        variables: ['amount']
    },
...
var AnalyticsNotificationService = /** @class */ (function () {
    ...
    AnalyticsNotificationService.processNotification = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.saveToDatabase(data)];
                    case 1:
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, supabase
                                ...
                                data: data.data || {},
                                scheduled_for: (_b = data.scheduledFor) === null || _b === void 0 ? void 0 : _b.toISOString(),
                                expires_at: (_c = data.expiresAt) === null || _c === void 0 ? void 0 : _c.toISOString(),
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (analyticsEmailPrefs[data.type] === false) {
                            console.log("Analytics email notifications disabled for ".concat(data.type, " by user ").concat(data.userId));
                            return [2 /*return*/];
                        }
                        ...
                        return [4 /*yield*/, supabase
                                ...
                                priority: data.priority,
                                category: 'analytics',
                                scheduled_for: ((_b = data.scheduledFor) === null || _b === void 0 ? void 0 : _b.toISOString()) || new Date().toISOString()
                            })];
                    case 2:
                        // Queue email for sending
                        _c.sent();
                    ...
                    case 1:
                        ...
                        pushJobs = tokens.map(function (tokenData) {
                            ...
                            return ({
                                ...
                                priority: data.priority,
                                category: 'analytics',
                                scheduled_for: ((_a = data.scheduledFor) === null || _a === void 0 ? void 0 : _a.toISOString()) || new Date().toISOString()
                            });
                        });
                        return [4 /*yield*/, supabase
                                .from('push_queue')
     ...
     */
    AnalyticsNotificationService.sendTrialMilestoneNotification = function (userId, trialData, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.sendNotification(notificationType, userId, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        switch (milestone.type) {
                            ...
                            case 'conversion':
                                ...
                                trend = milestone.previousValue
                                    ? (milestone.value > milestone.previousValue ? 'aumentou' : 'diminuiu')
                                    : 'está em';
                                variables = {
                                    trend: trend,
                                    rate: milestone.value.toFixed(1),
                                    recommendation: milestone.value < 5
                            ...
                            case 'churn':
                                ...
                                variables = {
                                    trend: churnTrend,
                                    rate: milestone.value.toFixed(1),
                                    actionRequired: milestone.value > 10
                        ...
                        return [4 /*yield*/, this.sendNotification(notificationType, userId, variables, { clinicId: clinicId })];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
