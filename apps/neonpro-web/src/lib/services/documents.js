...
var DocumentsService = /** @class */ (function () {
    ...
    DocumentsService.prototype.uploadDocument = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var user, fileExtension, timestamp, uniqueFileName, filePath, uploadError, documentData, _a, document_1, dbError, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        timestamp = Date.now();
                        uniqueFileName = "".concat(timestamp, "_").concat(Math.random().toString(36).substr(2, 9), ".").concat(fileExtension);
                        filePath = "documents/".concat(data.entityType, "/").concat(data.entityId, "/").concat(uniqueFileName);
...
var createdocumentsService = function () { return new DocumentsService(); };
