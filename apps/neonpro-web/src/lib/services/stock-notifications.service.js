...
var StockNotificationsService = /** @class */ (() => {
  ...
  // TEMPLATE MANAGEMENT
  // ==========================================
  StockNotificationsService.prototype.getNotificationTemplate = function (
    clinicId,
    templateType,
    channel,
  ) {
  ...
  StockNotificationsService.prototype.replaceVariables = (content, variables) => {
    var result = content;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("notification_deliveries").update(update).eq("id", id),
            ];
          case 1:
            error = _a.sent().error;
            if (error) {
  ...
  // ==========================================
  StockNotificationsService.prototype.getNotificationRecipients = function (
    clinicId,
    alertType,
    severityLevel,
  ) {
            ...
            return [
              ...
              data
                .filter((staff) => {
                  ...
                  var wantsSeverity =
                    !prefs.severity_filter || prefs.severity_filter.includes(severityLevel);
                  var wantsType =
                    !prefs.alert_type_filter || prefs.alert_type_filter.includes(alertType);
  ...
  // EMAIL NOTIFICATIONS
  // ==========================================
  StockNotificationsService.prototype.sendEmailNotification = function (
    clinicId,
    alertData,
    recipients,
    templateType,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              this.updateNotificationDelivery(deliveryId, {
                status: "sent",
                sent_at: new Date(),
              }),
            ];
          ...
          case 8:
            ...
            results.failed++;
            results.errors.push(
              "Failed to send email to ".concat(recipientEmail, ": ").concat(errorMessage),
            );
            // Update delivery status
            return [
              4 /*yield*/,
  ...
  // PUSH NOTIFICATIONS
  // ==========================================
  StockNotificationsService.prototype.sendPushNotification = function (
    clinicId,
    alertData,
    userIds,
    templateType,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              push_notification_service_1.default.sendToUser(userId, pushPayload),
            ];
          case 6:
            pushResult = _a.sent();
          ...
          case 8:
            ...
            results.failed++;
            results.errors.push(
              "Failed to send push to user ".concat(userId, ": ").concat(errorMessage),
            );
            // Update delivery status
            return [
              4 /*yield*/,
  ...
  // ==========================================
  StockNotificationsService.prototype.sendWebhookNotification = function (
    clinicId,
    alertData,
    webhookUrls,
    templateType,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              axios_1.default.post(webhookUrl, webhookPayload, {
          ...
          case 10:
            ...
            results.failed++;
            results.errors.push(
              "Failed to send webhook to ".concat(webhookUrl, ": ").concat(errorMessage),
            );
            // Update delivery status
            return [
              4 /*yield*/,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            ...
            _a.label = 6;
          case 6:
            return [4 /*yield*/, this.getClinicWebhookUrls(alertData.clinicId, "stock_alert")];
          case 7:
            webhookUrls = _a.sent();
  ...
  // UTILITY METHODS
  // ==========================================
  StockNotificationsService.prototype.prepareTemplateVariables = (data, templateType) => {
    var baseVariables = {
    ...
    if (templateType === "stock_alert") {
      var alertData = data;
      return __assign(__assign({}, baseVariables), {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [2 /*return*/, data.map((config) => config.webhook_url)];
          case 2:
            error_12 = _b.sent();
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.updateNotificationDelivery(notification.id, {
                status: "retrying",
          ...
          case 9:
            ...
            return [
              4 /*yield*/,
              axios_1.default.post(notification.webhook_url, JSON.parse(notification.content), {
                timeout: 30000,
          ...
          case 10:
            ...
            if (!success) errorMessage = "HTTP ".concat(response.status);
            _c.label = 11;
          case 11:
            return [3 /*break*/, 15];
          case 12:
            ...
            return [
              4 /*yield*/,
              push_notification_service_1.default.sendToUser(notification.recipient_id, payload),
            ];
          case 13:
            pushResult = _c.sent();
