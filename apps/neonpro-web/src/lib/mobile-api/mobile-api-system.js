...
var MobileApiSystemImpl = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.compressionUtils = new compression_utils_1.CompressionUtils(this.config.compression);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        ...
                        authResult = _a.sent();
                        return [3 /*break*/, 9];
                    case 8: throw new Error('Invalid authentication request');
                    case 9:
                        ...
                        return [4 /*yield*/, this.pushManager.registerDevice({
                    ...
                    return [4 /*yield*/, this.offlineSync.initializeForUser(authResult.user.id, authResult.clinic.id)
                    ...
                    case 13:
                        ...
                        throw this.createApiError('AUTH_FAILED', "Authentication failed: ".concat(error_2), true);
    ...
    MobileApiSystemImpl.prototype.biometricAuthentication = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.securityUtils.validateBiometricData(request.biometricData, request.deviceId)];
                    case 1:
                        isValid = _a.sent();
                        if (!isValid) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, this.emailPasswordAuthentication(__assign(__assign({}, request), { email: credentials.email, password: credentials.password }))];
                }
            });
        });
    };
    MobileApiSystemImpl.prototype.refreshAuthentication = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.supabase.auth.refreshSession({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.ensureAuthenticated()
                    ...
                    case 3:
                        ...
                        if (cachedResponse) {
                            return [2 /*return*/, this.buildResponse(cachedResponse.data, {
                                    requestId: requestId,
                                    timestamp: Date.now(),
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.makeNetworkRequest(request, requestId, startTime)
                            // Cache response if successful
                        ];
                    case 5:
                        response = _a.sent();
                        if (!(response.success && this.shouldCacheResponse(request, response))) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.cache.set(this.buildCacheKey(request), {
                                key: this.buildCacheKey(request),
                                data: response.data,
                                metadata: {
                                    version: this.config.version,
    ...
    MobileApiSystemImpl.prototype.makeNetworkRequest = function (request, requestId, startTime) {
        return __awaiter(this, void 0, void 0, function () {
            var url, headers, body, compressionResult, compressed, fetchOptions, response, responseData, contentEncoding, decompressed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = "".concat(this.config.baseUrl).concat(request.endpoint);
                        headers = __assign({ 'Content-Type': 'application/json', 'Authorization': "Bearer ".concat(this.accessToken), 'X-Request-ID': requestId, 'X-Client-Version': this.config.version, 'X-Device-Platform': request.deviceInfo.platform }, request.headers);
                        body = request.body;
                    ...
                    case 3:
                        response = _a.sent();
                        if (!response.ok) {
                            throw this.createApiError("HTTP_".concat(response.status), "HTTP ".concat(response.status, ": ").concat(response.statusText), response.status >= 500);
                        }
                    ...
                    case 4:
                        ...
                        if (!(contentEncoding && this.compressionUtils.isSupported(contentEncoding))) return [3 /*break*/, 6];
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6: return [2 /*return*/, this.buildResponse(responseData, {
                            requestId: requestId,
                            timestamp: Date.now(),
                            processingTime: Date.now() - startTime,
                            source: 'network',
    ...
    MobileApiSystemImpl.prototype.handleOfflineRequest = function (request, requestId, startTime) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.offlineSync.getOfflineData(request.endpoint, request.params)];
                    case 1:
                        offlineData = _a.sent();
                        if (offlineData) {
                            return [2 /*return*/, this.buildResponse(offlineData, {
                                    requestId: requestId,
                                    timestamp: Date.now(),
                                    processingTime: Date.now() - startTime,
                                    source: 'offline',
                        ...
                        if (!['POST', 'PUT', 'PATCH', 'DELETE'].includes(request.method)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.offlineSync.queueOperation({
                                id: requestId,
                    ...
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: throw this.createApiError('OFFLINE_NO_DATA', 'No offline data available for this request', true);
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.offlineSync.performSync(__assign({ userId: this.currentUser.id, clinicId: this.currentClinic.id }, options))];
                    case 1:
                        result = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                errors: [this.createApiError('PUSH_FAILED', "Push notification failed: ".concat(error_5), true)]
                            }];
                    case 3: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.tokenExpiresAt - Date.now() < this.config.security.tokenRefreshThreshold * 1000)) return [3 /*break*/, 6];
                    ...
                    case 5: throw this.createApiError('TOKEN_EXPIRED', 'Token expired and no refresh token available', false);
    ...
    MobileApiSystemImpl.prototype.checkTokenExpiry = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.accessToken && this.tokenExpiresAt - Date.now() < this.config.security.tokenRefreshThreshold * 1000)) return [3 /*break*/, 4];
