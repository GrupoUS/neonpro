...
export class MobileCache {
  ...
  async initialize(): Promise<void> {
    try {
      ...
      await Promise.all([this.compressionUtils.initialize(), this.securityUtils.initialize()]);
  ...
  async destroy(): Promise<void> {
    try {
      ...
      // Cleanup subsystems
      await Promise.all([this.compressionUtils.destroy(), this.securityUtils.destroy()]);
