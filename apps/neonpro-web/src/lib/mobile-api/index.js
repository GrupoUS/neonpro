 ...
 */
var UnifiedMobileApiManager = /** @class */ (() => {
  function UnifiedMobileApiManager(config) {
    ...
    this.notificationsManager = new push_notifications_1.PushNotificationsManager(
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            optimizedRequest = utils_1.MobileApiUtils.NetworkUtils.optimizeRequest(
              request,
              networkCondition,
            );
            if (!((_a = optimizedRequest.cache) === null || _a === void 0 ? void 0 : _a.enabled))
              return [3 /*break*/, 3];
          ...
          case 2:
            ...
            _c.label = 3;
          case 3:
            return [4 /*yield*/, this.apiSystem.request(optimizedRequest)];
          case 4:
            response = _c.sent();
            if (
              !(
                response.success &&
                ((_b = optimizedRequest.cache) === null || _b === void 0 ? void 0 : _b.enabled)
              )
            )
              return [3 /*break*/, 6];
            return [
  ...
  UnifiedMobileApiManager.prototype.clearCache = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.cacheManager.clear()];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
  ...
  UnifiedMobileApiManager.prototype.resetSyncQueue = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.syncManager.clearQueue()];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
  ...
  UnifiedMobileApiManager.prototype.setupIntegrations = function () {
    ...
    this.syncManager.on("dataUpdated", (data) =>
      __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.cacheManager.invalidatePattern(data.pattern)];
            case 1:
              _a.sent();
              return [2 /*return*/];
          }
    ...
    this.syncManager.on("syncCompleted", (status) =>
      __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    this.apiSystem.on("requestCompleted", (metrics) => {
   ...
   */
  UnifiedMobileApiManager.prototype.generateCacheKey = (request) => {
    var keyData = {
   ...
   */
  UnifiedMobileApiManager.prototype.shouldQueueForSync = (request, response) => {
   ...
   * Calculate data size
   */
  UnifiedMobileApiManager.prototype.calculateDataSize = (response) =>
      ...
      () =>
        __awaiter(this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4 /*yield*/, this.checkSystemHealth()];
              case 1:
                _a.sent();
                return [2 /*return*/];
            }
   ...
   */
  UnifiedMobileApiManager.prototype.stopHealthMonitoring = () => {
   ...
   */
  UnifiedMobileApiManager.prototype.stopPerformanceMonitoring = () => {
    // Implementation would clear the interval
  };
  /**
   * Check system health
  ...
  UnifiedMobileApiManager.prototype.collectPerformanceMetrics = function () {
    try {
      ...
      this.performanceMetrics.memoryUsage =
        utils_1.MobileApiUtils.PerformanceUtils.getMemoryUsage();
      // Calculate cache hit rate
      var totalCacheRequests = this.stats.cacheHits + this.stats.cacheMisses;
      this.performanceMetrics.cacheHitRate =
        utils_1.MobileApiUtils.PerformanceUtils.calculateCacheHitRate(
          this.stats.cacheHits,
          totalCacheRequests,
        );
      ...
      this.performanceMetrics.throughput =
        utils_1.MobileApiUtils.PerformanceUtils.calculateThroughput(
          this.stats.totalRequests,
          duration,
        );
    } catch (error) {
