...
exports.MobileApiUtils = exports.OptimizationUtils = exports.ValidationUtils = exports.NetworkUtils = exports.PerformanceUtils = exports.SecurityUtils = exports.CompressionUtils = void 0;
...
var CompressionUtils = /** @class */ (function () {
    ...
    CompressionUtils.compressData = function (data, config) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, originalSize, compressedData, algorithm, _a, compressedSize, compressionRatio, compressionTime, error_1;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        switch (_a) {
                            ...
                            case 'brotli': return [3 /*break*/, 4];
                            case 'lz4': return [3 /*break*/, 6];
                        }
                        return [3 /*break*/, 8];
                    case 2: return [4 /*yield*/, this.gzipCompress(data)];
                    case 3:
                        compressedData = _b.sent();
                        algorithm = 'gzip';
                        return [3 /*break*/, 10];
                    case 4: return [4 /*yield*/, this.brotliCompress(data)];
                    case 5:
                        compressedData = _b.sent();
                        algorithm = 'brotli';
                        return [3 /*break*/, 10];
                    case 6: return [4 /*yield*/, this.lz4Compress(data)];
                    case 7:
                        compressedData = _b.sent();
                        algorithm = 'lz4';
                        return [3 /*break*/, 10];
                    case 8: return [4 /*yield*/, this.defaultCompress(data)];
                    case 9:
                        compressedData = _b.sent();
                        algorithm = 'default';
                        _b.label = 10;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'brotli': return [3 /*break*/, 3];
                            case 'lz4': return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 7];
                    case 1: return [4 /*yield*/, this.gzipDecompress(compressedData)];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3: return [4 /*yield*/, this.brotliDecompress(compressedData)];
                    case 4: return [2 /*return*/, _b.sent()];
                    case 5: return [4 /*yield*/, this.lz4Decompress(compressedData)];
                    case 6: return [2 /*return*/, _b.sent()];
                    case 7: return [4 /*yield*/, this.defaultDecompress(compressedData)];
     ...
     */
    CompressionUtils.chooseOptimalCompression = function (data, networkCondition, deviceCapabilities) {
...
var SecurityUtils = /** @class */ (function () {
    ...
    SecurityUtils.generateSignature = function (method, url, body, timestamp, secretKey) {
        ...
        return (0, crypto_1.createHash)('sha256').update(message + secretKey).digest('hex');
    };
    /**
     * Validate API signature
     */
    SecurityUtils.validateSignature = function (signature, method, url, body, timestamp, secretKey, tolerance // 5 minutes
    ) {
        if (tolerance === void 0) { tolerance = 300000; }
