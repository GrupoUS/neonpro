...
var OfflineSync = /** @class */ (function () {
    function OfflineSync(supabase, config) {
        ...
        this.config = __assign({ enabled: true, maxStorageSize: 100 * 1024 * 1024, syncInterval: 60, conflictResolution: 'timestamp', autoSync: true, syncOnReconnect: true, backgroundSync: true, maxRetries: 5, retryDelay: 5 }, config);
        this.offlineStorage = {
            patients: [],
            appointments: [],
            treatments: [],
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.loadOfflineStorage()
                    ...
                    case 1:
                        ...
                        _a.sent();
                        // Load operation queue
                        return [4 /*yield*/, this.loadOperationQueue()
                            // Load conflict queue
                        ];
                    case 2:
                        // Load operation queue
    ...
    OfflineSync.prototype.initializeForUser = function (userId, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log("Offline sync initialized for user ".concat(userId, " in clinic ").concat(clinicId));
                return [2 /*return*/];
            });
        });
    };
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, this.updateOfflineMetadata()
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.downloadOperation(operation)];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        // Save queue to storage
                        _a.sent();
                        console.log("Queued operation: ".concat(operation.type, " ").concat(operation.entity, " ").concat(operation.entityId));
                        return [3 /*break*/, 3];
                    case 2:
                        error_5 = _a.sent();
    ...
    OfflineSync.prototype.uploadOperation = function (operation) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        entity = operation.entity, entityId = operation.entityId, type = operation.type, data = operation.data;
                        _a = type;
                        switch (_a) {
                        ...
                        return [3 /*break*/, 7];
                    case 1: return [4 /*yield*/, this.createServerRecord(entity, data)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 3: return [4 /*yield*/, this.updateServerRecord(entity, entityId, data)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.deleteServerRecord(entity, entityId)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 7];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 5];
                    case 1: return [4 /*yield*/, this.updateLocalRecord(entity, data)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.deleteLocalRecord(entity, entityId)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/];
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        // Apply resolution
                                        return [4 /*yield*/, this_1.applyConflictResolution(conflict, resolution.resolution, resolution.resolvedData)
                                            // Remove from conflict queue
                                        ];
                                    case 2:
                                        // Apply resolution
                                        _b.sent();
                                        index = this_1.conflictQueue.findIndex(function (c) { return c.id === conflict.id; });
                                        if (index > -1) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.updateServerRecord(conflict.entity, conflict.entityId, conflict.localData)];
                    case 1:
                        // Upload local data to server
                        _a.sent();
                        return [3 /*break*/, 7];
                    ...
                    case 5:
                        // Apply merged data to both local and server
                        _a.sent();
                        return [4 /*yield*/, this.updateServerRecord(conflict.entity, conflict.entityId, resolvedData)];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7: return [2 /*return*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    switch (entity) {
                        case 'patients':
                            return [2 /*return*/, entityId_1
                                    ? this.offlineStorage.patients.find(function (p) { return p.id === entityId_1; })
                                    : this.filterPatients(params)];
                        case 'appointments':
                            return [2 /*return*/, entityId_1
                                    ? this.offlineStorage.appointments.find(function (a) { return a.id === entityId_1; })
                                    : this.filterAppointments(params)];
                        case 'treatments':
                            return [2 /*return*/, entityId_1
                                    ? this.offlineStorage.treatments.find(function (t) { return t.id === entityId_1; })
                                    : this.filterTreatments(params)];
                        case 'payments':
                            return [2 /*return*/, entityId_1
                                    ? this.offlineStorage.payments.find(function (p) { return p.id === entityId_1; })
    ...
    OfflineSync.prototype.deleteLocalRecord = function (entity, entityId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (entity) {
                    case 'patients':
                        this.offlineStorage.patients = this.offlineStorage.patients.filter(function (p) { return p.id !== entityId; });
                        break;
                    case 'appointments':
                        this.offlineStorage.appointments = this.offlineStorage.appointments.filter(function (a) { return a.id !== entityId; });
                        break;
                    case 'treatments':
                        this.offlineStorage.treatments = this.offlineStorage.treatments.filter(function (t) { return t.id !== entityId; });
                        break;
                    case 'payments':
                        this.offlineStorage.payments = this.offlineStorage.payments.filter(function (p) { return p.id !== entityId; });
                        break;
                }
                return [2 /*return*/];
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, {
                        ...
                        pendingOperations: this.operationQueue.filter(function (op) { return op.status === 'pending'; }).length,
    ...
    OfflineSync.prototype.estimateTimeRemaining = function () {
        ...
        var pendingOps = this.operationQueue.filter(function (op) { return op.status === 'pending'; }).length;
    ...
    OfflineSync.prototype.saveOfflineStorage = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    if (typeof window !== 'undefined' && window.localStorage) {
                        localStorage.setItem("offline-storage-".concat(this.userId), JSON.stringify(this.offlineStorage));
                    }
                }
                catch (error) {
    ...
    OfflineSync.prototype.saveOperationQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    if (typeof window !== 'undefined' && window.localStorage) {
                        localStorage.setItem("operation-queue-".concat(this.userId), JSON.stringify(this.operationQueue));
                    }
                }
                catch (error) {
    ...
    OfflineSync.prototype.saveConflictQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    if (typeof window !== 'undefined' && window.localStorage) {
                        localStorage.setItem("conflict-queue-".concat(this.userId), JSON.stringify(this.conflictQueue));
                    }
                }
                catch (error) {
    ...
    OfflineSync.prototype.createDownloadOperations = function (entity, serverData) {
        return serverData.map(function (data) { return ({
    ...
    OfflineSync.prototype.filterPatients = function (params) {
        ...
        if (params === null || params === void 0 ? void 0 : params.search) {
            ...
            patients = patients.filter(function (p) {
                var _a, _b;
                return p.name.toLowerCase().includes(search_1) ||
                    ((_a = p.email) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(search_1)) ||
                    ((_b = p.phone) === null || _b === void 0 ? void 0 : _b.includes(search_1));
            });
        }
        if ((params === null || params === void 0 ? void 0 : params.isActive) !== undefined) {
            patients = patients.filter(function (p) { return p.isActive === params.isActive; });
        }
        return patients;
    };
    OfflineSync.prototype.filterAppointments = function (params) {
        ...
        if (params === null || params === void 0 ? void 0 : params.patientId) {
            appointments = appointments.filter(function (a) { return a.patientId === params.patientId; });
        }
        if (params === null || params === void 0 ? void 0 : params.status) {
            appointments = appointments.filter(function (a) { return a.status === params.status; });
        }
    ...
    OfflineSync.prototype.filterTreatments = function (params) {
        ...
        if (params === null || params === void 0 ? void 0 : params.category) {
            treatments = treatments.filter(function (t) { return t.category === params.category; });
        }
        if ((params === null || params === void 0 ? void 0 : params.isActive) !== undefined) {
            treatments = treatments.filter(function (t) { return t.isActive === params.isActive; });
        }
        return treatments;
    };
    OfflineSync.prototype.filterPayments = function (params) {
        ...
        if (params === null || params === void 0 ? void 0 : params.patientId) {
            payments = payments.filter(function (p) { return p.patientId === params.patientId; });
        }
        if (params === null || params === void 0 ? void 0 : params.status) {
            payments = payments.filter(function (p) { return p.status === params.status; });
        }
        return payments;
    };
    OfflineSync.prototype.updatePatientRecord = function (data) {
        var index = this.offlineStorage.patients.findIndex(function (p) { return p.id === data.id; });
        if (index > -1) {
            this.offlineStorage.patients[index] = __assign(__assign({}, this.offlineStorage.patients[index]), data);
        }
        else {
    ...
    OfflineSync.prototype.updateAppointmentRecord = function (data) {
        var index = this.offlineStorage.appointments.findIndex(function (a) { return a.id === data.id; });
        if (index > -1) {
            this.offlineStorage.appointments[index] = __assign(__assign({}, this.offlineStorage.appointments[index]), data);
        }
        else {
    ...
    OfflineSync.prototype.updateTreatmentRecord = function (data) {
        var index = this.offlineStorage.treatments.findIndex(function (t) { return t.id === data.id; });
        if (index > -1) {
            this.offlineStorage.treatments[index] = __assign(__assign({}, this.offlineStorage.treatments[index]), data);
        }
        else {
    ...
    OfflineSync.prototype.updatePaymentRecord = function (data) {
        var index = this.offlineStorage.payments.findIndex(function (p) { return p.id === data.id; });
        if (index > -1) {
            this.offlineStorage.payments[index] = __assign(__assign({}, this.offlineStorage.payments[index]), data);
        }
        else {
    ...
    OfflineSync.prototype.getTotalRecords = function () {
        return (this.offlineStorage.patients.length +
