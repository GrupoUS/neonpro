...
var MobileCache = /** @class */ (function () {
    function MobileCache(config) {
        ...
        this.eventHandlers = {};
        this.config = __assign({ strategy: 'cache-first', ttl: 300, maxSize: 50 * 1024 * 1024, maxEntries: 10000, compression: true, encryption: false, persistToDisk: true, syncOnReconnect: true }, config);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    return [4 /*yield*/, this.ensureCapacity(cacheEntry.size)
    ...
    MobileCache.prototype.networkOnlyStrategy = function (networkFetcher) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, networkFetcher()];
                    case 1:
                        networkData = _a.sent();
                        return [2 /*return*/, { data: networkData, source: 'network' }];
                }
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        // Check if we need to evict more entries due to size limits
                        _d.sent();
                        console.log("Cache cleanup completed. Removed ".concat(expiredKeys.length, " expired entries."));
                        return [3 /*break*/, 7];
                    case 6:
                        error_7 = _d.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.evictBySize(currentSize + newEntrySize - this.config.maxSize)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    MobileCache.prototype.getStats = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, __assign(__assign({}, this.stats), { totalEntries: totalEntries, totalSize: currentSize, averageSize: totalEntries > 0 ? currentSize / totalEntries : 0, oldestEntry: this.getOldestEntry(), newestEntry: this.getNewestEntry() })];
            });
        });
    };
