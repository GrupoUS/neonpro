...
var PushNotificationsManager = /** @class */ (() => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [3 /*break*/, 4];
          case 2:
            return [4 /*yield*/, this.sendFCMNotification(device, payload)];
          case 3:
            result = _a.sent();
            _a.label = 4;
          case 4:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("notification_schedules").insert({
        ...
        switch (_a.label) {
          case 0:
            ...
            fcmPayload = {
              ...
              data: __assign(__assign({}, payload.data), {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("device_registrations").select("*").eq("is_active", true),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
   ...
   * Store notification record
   */
  PushNotificationsManager.prototype.storeNotificationRecord = function (
    deviceId,
    payload,
    result,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("notification_logs").insert({
                device_id: deviceId,
                title: payload.title,
                body: payload.body,
                category: payload.category,
  ...
  PushNotificationsManager.prototype.updateAnalytics = function (result, category) {
    ...
    var categoryStats = this.analytics.categoryMetrics.get(category) || {
      sent: 0,
      delivered: 0,
      failed: 0,
    };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("notification_analytics").insert({
 ...
 */
exports.defaultNotificationTemplates =
  ((_a = {}),
