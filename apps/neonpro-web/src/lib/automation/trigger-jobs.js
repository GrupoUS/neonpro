 ...
 */
var NeonProAutomation = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, client.sendEvent({
                    ...
                    case 2:
                        ...
                        throw new Error("Failed to send appointment confirmation: ".concat(error_1 instanceof Error ? error_1.message : error_1));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!scheduleFor) {
                            appointmentDateTime = new Date("".concat(params.appointmentDate, "T").concat(params.appointmentTime));
                    ...
                    case 2:
                        ...
                        throw new Error("Failed to schedule reminder: ".concat(error_2 instanceof Error ? error_2.message : error_2));
                    case 3: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        throw new Error("Failed to send invoice: ".concat(error_3 instanceof Error ? error_3.message : error_3));
                    case 3: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        throw new Error("Failed to send payment reminder: ".concat(error_4 instanceof Error ? error_4.message : error_4));
                    case 3: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        _b = results;
                        return [4 /*yield*/, this.sendPaymentReminder(__assign(__assign({}, invoiceData), { delayDays: Math.ceil((reminderDate.getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24)) }))];
                    case 3:
