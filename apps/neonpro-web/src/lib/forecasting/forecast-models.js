...
var ForecastModelManager = /** @class */ (function () {
    ...
    ForecastModelManager.prototype.compareModels = function (championModelId_1, challengerModelId_1) {
        return __awaiter(this, arguments, void 0, function (championModelId, challengerModelId, testPeriodDays) {
            var _a, championModel, challengerModel, endDate, startDate, _b, championMetrics, challengerMetrics, accuracyImprovement, speedImprovement, stabilityImprovement, overallScore, recommendation, confidenceLevel, result, error_5;
            if (testPeriodDays === void 0) { testPeriodDays = 30; }
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        accuracyImprovement = challengerMetrics.test_metrics.accuracy_percentage -
                            championMetrics.test_metrics.accuracy_percentage;
                        speedImprovement = (championMetrics.inference_time_ms - challengerMetrics.inference_time_ms) /
                            championMetrics.inference_time_ms * 100;
                        stabilityImprovement = challengerMetrics.stability_score - championMetrics.stability_score;
                        overallScore = (accuracyImprovement * 0.5) +
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (model.accuracy_score < this.ACCURACY_THRESHOLD) {
                            throw new Error("Model accuracy ".concat(model.accuracy_score, " below threshold ").concat(this.ACCURACY_THRESHOLD));
                        }
                        // Deactivate current models of same type
                        return [4 /*yield*/, this.deactivateCurrentModels(clinicId, model.model_type, model.service_type)];
                    case 2:
                        // Deactivate current models of same type
                        _a.sent();
                        // Activate new model
     ...
     */
    ForecastModelManager.prototype.optimizeHyperparameters = function (clinicId_1, modelType_1, serviceId_1) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.storeOptimizationResults(clinicId, modelType, bestConfig, bestScore)];
                    case 6:
                        // Store optimization results
                        _a.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        console.log("Model ".concat(model.id, " shows drift (").concat(driftScore, "), scheduling retraining"));
                        // Schedule retraining
    ...
    ForecastModelManager.prototype.getTrainingRecommendations = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var recommendations, activeModels, requiredModelTypes, _loop_1, _i, requiredModelTypes_1, modelType, _a, activeModels_1, model, thirtyDaysAgo, _b, activeModels_2, model, trainingDate, error_11;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        recommendations = [];
                    ...
                    case 2:
                        ...
                        _loop_1 = function (modelType) {
                            var hasModel = activeModels.some(function (m) { return m.model_type === modelType; });
                            if (!hasModel) {
                        ...
                        for (_i = 0, requiredModelTypes_1 = requiredModelTypes; _i < requiredModelTypes_1.length; _i++) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        progress += 10;
                        return [3 /*break*/, 2];
                    case 6: return [4 /*yield*/, this.createTrainedModel(job)];
                    case 7:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // Store model
                        return [4 /*yield*/, supabase_1.supabase.from('forecast_models').insert(__assign(__assign({}, model), { clinic_id: job.clinic_id }))];
                    case 1:
                        // Store model
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, {
                        ...
                        test_metrics: __assign(__assign({}, model.validation_metrics), { accuracy_percentage: model.validation_metrics.accuracy_percentage - Math.random() * 5 }),
                        feature_importance: {
                            'seasonality': 0.3,
                            'trend': 0.4,
    ...
    ForecastModelManager.prototype.deactivateCurrentModels = function (clinicId, modelType, serviceType) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
    ...
    ForecastModelManager.prototype.storeOptimizationResults = function (clinicId, modelType, config, score) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
