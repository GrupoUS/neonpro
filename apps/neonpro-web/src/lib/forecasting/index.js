      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.engine.generateServiceForecasts(
                request.clinic_id,
          ...
          case 4:
            return [
              4 /*yield*/,
              this.resourceOptimizer.generateAllocationPlan(
                request.clinic_id,
                forecasts,
                {
  ...
  ForecastingSystemAPI.prototype.getTrainingStatus = function (jobId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.modelManager.getTrainingStatus(jobId)];
          case 1:
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              exports.forecastingSystemAPI.generateForecast({
                clinic_id: clinicId,
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              exports.forecastingSystemAPI.generateAllocationPlan({
                clinic_id: clinicId,
                planning_period: {
                  start_date: startDate.toISOString(),
                  end_date: endDate.toISOString(),
