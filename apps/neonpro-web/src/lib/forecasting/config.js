...
exports.MODEL_TRAINING_CONFIG =
  exports.RESOURCE_CONFIG =
  exports.FORECASTING_CONFIG =
  ...
  exports.EXTERNAL_FACTOR_CONFIGS =
  exports.MODEL_CONFIGS =
  exports.DEFAULT_MODEL_TRAINING =
  exports.DEFAULT_RESOURCE_CONFIG =
  exports.DEFAULT_FORECASTING_CONFIG =
    void 0;
/**
...
exports.DEFAULT_FORECASTING_CONFIG = {
  ...
  accuracy_threshold: 0.8, // 80% minimum accuracy requirement per story 11.1
  ...
  drift_detection_threshold: 0.1, // 10% drift threshold
  // Alert thresholds
  alert_thresholds: {
    demand_spike_multiplier: 1.5, // Alert when demand exceeds 150% of average
    capacity_shortage_threshold: 0.9, // Alert when capacity utilization > 90%
    accuracy_degradation_threshold: 0.75, // Alert when accuracy drops below 75%
  },
};
exports.FORECASTING_CONFIG = exports.DEFAULT_FORECASTING_CONFIG;
/**
...
exports.DEFAULT_RESOURCE_CONFIG = {
  ...
  cost_variance_threshold: 0.1, // 10% cost variance threshold
  efficiency_threshold: 0.8, // 80% minimum efficiency
  // Resource-specific limits
  staff_overtime_limit_hours: 10, // Maximum 10 hours overtime per week
  equipment_max_utilization: 0.9, // Maximum 90% equipment utilization
  ...
  optimization_objectives_weights: {
    cost_minimization: 0.3, // 30% weight on cost reduction
    ...
    satisfaction_optimization: 0.1, // 10% weight on satisfaction metrics
  },
};
exports.RESOURCE_CONFIG = exports.DEFAULT_RESOURCE_CONFIG;
/**
...
exports.MODEL_TRAINING_CONFIG = exports.DEFAULT_MODEL_TRAINING;
/**
...
exports.EXTERNAL_FACTOR_CONFIGS = {
  ...
  economic_indicators: {
    ...
    indicators: ["unemployment_rate", "inflation_rate", "healthcare_spending"],
  },
  health_trends: {
    enabled: true,
    data_source: "government_health_api",
    update_interval_hours: 24,
    trend_types: ["seasonal_illness", "vaccination_rates", "public_health_alerts"],
  },
};
/**
...
var ConfigManager = /** @class */ (function () {
  ...
  ConfigManager.prototype.loadConfiguration = function () {
    // Load environment-specific configuration
    var environment = process.env.NODE_ENV || "development";
    var envConfig = exports.ENVIRONMENT_CONFIGS[environment];
    ...
    this.config = __assign(
          ...
          __assign(
            __assign(
              __assign(
                __assign(
                  __assign(
                    __assign({}, exports.DEFAULT_FORECASTING_CONFIG),
                    exports.DEFAULT_RESOURCE_CONFIG,
                  ),
                  exports.DEFAULT_MODEL_TRAINING,
                ),
      ...
      ),
      {
        ...
        external_factors: exports.EXTERNAL_FACTOR_CONFIGS,
  ...
  ConfigManager.prototype.isFeatureEnabled = function (feature) {
    return this.get("feature_flags.".concat(feature), false);
  };
