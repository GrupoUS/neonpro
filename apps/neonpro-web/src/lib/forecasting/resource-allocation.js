...
var ResourceAllocationOptimizer = /** @class */ (function () {
    function ResourceAllocationOptimizer() {
        ...
        this.COST_VARIANCE_THRESHOLD = 0.10; // 10% cost variance threshold
        this.EFFICIENCY_THRESHOLD = 0.80; // 80% minimum efficiency
    }
    /**
     ...
     */
    ResourceAllocationOptimizer.prototype.generateAllocationPlan = function (clinicId_1, forecasts_1, planningPeriod_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, forecasts, planningPeriod, objectives) {
            var defaultObjectives, activeObjectives, _a, staffAllocations, equipmentAllocations, roomAllocations, inventoryAllocations, totalCost, expectedRevenue, efficiencyScore, constraints, plan, error_2;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), staffAllocations = _a[0], equipmentAllocations = _a[1], roomAllocations = _a[2], inventoryAllocations = _a[3];
                        totalCost = this.calculateTotalCost(staffAllocations, equipmentAllocations, roomAllocations, inventoryAllocations);
                        expectedRevenue = this.calculateExpectedRevenue(forecasts, roomAllocations, staffAllocations);
                        efficiencyScore = this.calculateEfficiencyScore(staffAllocations, equipmentAllocations, roomAllocations);
     ...
     */
    ResourceAllocationOptimizer.prototype.optimizeStaffAllocation = function (clinicId, forecasts, planningPeriod) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, staff, error, allocations, demandByRole, _i, _b, member, roleDemand, requiredHours, scheduledHours, overtimeHours, utilizationRate, regularCost, overtimeCost, totalCost, efficiencyScore, availabilityWindows, allocation, error_3;
                    ...
                    case 1:
                        ...
                        for (_i = 0, _b = staff || []; _i < _b.length; _i++) {
                            ...
                            try {
                                ...
                                requiredHours = this.calculateRequiredStaffHours(member, roleDemand, planningPeriod);
                                ...
                                efficiencyScore = this.calculateStaffEfficiency(member, utilizationRate, overtimeHours);
     ...
     */
    ResourceAllocationOptimizer.prototype.optimizeEquipmentAllocation = function (clinicId, forecasts, planningPeriod) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, equipment, error, allocations, demandByType, _i, _b, item, typeDemand, predictedDemandHours, maxUsageHours, scheduledUsageHours, utilizationRate, totalOperationalCost, maintenanceWindows, efficiencyRating, allocation, error_4;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        for (_i = 0, _b = equipment || []; _i < _b.length; _i++) {
                            ...
                            try {
                                ...
                                predictedDemandHours = this.calculateEquipmentHours(item, typeDemand, planningPeriod);
     ...
     */
    ResourceAllocationOptimizer.prototype.optimizeRoomAllocation = function (clinicId, forecasts, planningPeriod) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, rooms, error, allocations, demandByType, _i, _b, room, typeDemand, predictedDemand, existingBookings, scheduledBookings, maxBookingsPerWeek, utilizationRate, totalRevenuePotential, availabilityWindows, allocation, error_5, error_6;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 8, , 9]);
                    ...
                    case 6:
                        _i++;
                        return [3 /*break*/, 2];
                    case 7: return [2 /*return*/, allocations];
                    case 8:
                        error_6 = _c.sent();
     ...
     */
    ResourceAllocationOptimizer.prototype.optimizeInventoryAllocation = function (clinicId, forecasts, planningPeriod) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, inventory, error, allocations, consumptionByCategory, _i, _b, item, categoryConsumption, predictedConsumption, safetyStock, stockoutRisk, expirationRisk, allocation, error_7;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        for (_i = 0, _b = inventory || []; _i < _b.length; _i++) {
                            ...
                            try {
                                ...
                                predictedConsumption = this.calculateItemConsumption(item, categoryConsumption, planningPeriod);
     ...
     */
    ResourceAllocationOptimizer.prototype.calculateTotalCost = function (staffAllocations, equipmentAllocations, roomAllocations, inventoryAllocations) {
        var staffCost = staffAllocations.reduce(function (sum, allocation) { return sum + allocation.total_cost; }, 0);
        var equipmentCost = equipmentAllocations.reduce(function (sum, allocation) { return sum + allocation.total_operational_cost; }, 0);
     ...
     */
    ResourceAllocationOptimizer.prototype.calculateExpectedRevenue = function (forecasts, roomAllocations, staffAllocations) {
     ...
     */
    ResourceAllocationOptimizer.prototype.calculateEfficiencyScore = function (staffAllocations, equipmentAllocations, roomAllocations) {
        var avgStaffEfficiency = staffAllocations.reduce(function (sum, allocation) {
            return sum + allocation.efficiency_score;
        }, 0) / staffAllocations.length;
        var avgEquipmentEfficiency = equipmentAllocations.reduce(function (sum, allocation) {
            return sum + allocation.efficiency_rating;
        }, 0) / equipmentAllocations.length;
        var avgRoomUtilization = roomAllocations.reduce(function (sum, allocation) {
    ...
    ResourceAllocationOptimizer.prototype.calculateDemandByRole = function (forecasts) {
        ...
        var totalDemand = forecasts.reduce(function (sum, forecast) { return sum + forecast.predicted_demand; }, 0);
        return {
    ...
    ResourceAllocationOptimizer.prototype.calculateRequiredStaffHours = function (staff, demand, period) {
        // Simplified calculation
        var hoursPerService = staff.role === 'doctor' ? 1 : 0.5;
        return demand * hoursPerService;
    };
    ResourceAllocationOptimizer.prototype.calculateStaffEfficiency = function (staff, utilizationRate, overtimeHours) {
    ...
    ResourceAllocationOptimizer.prototype.optimizeStaffAssignments = function (allocations, forecasts) {
    ...
    ResourceAllocationOptimizer.prototype.calculateEquipmentHours = function (equipment, demand, period) {
        // Simplified calculation
        var hoursPerUse = equipment.type === 'diagnostic' ? 0.5 : 1.0;
        return demand * hoursPerUse;
    };
    ResourceAllocationOptimizer.prototype.calculateEquipmentEfficiency = function (equipment, utilizationRate) {
    ...
    ResourceAllocationOptimizer.prototype.calculateItemConsumption = function (item, categoryConsumption, period) {
        // Simplified calculation
    ...
    ResourceAllocationOptimizer.prototype.calculateStockoutRisk = function (item, consumption, safetyStock) {
