...
exports.demandForecastingEngine = exports.ForecastingUtils = exports.DemandForecastingEngine = void 0;
...
var DemandForecastingEngine = /** @class */ (function () {
    function DemandForecastingEngine() {
        ...
        this.ACCURACY_THRESHOLD = 0.80; // 80% minimum accuracy requirement
    }
    /**
     ...
     */
    DemandForecastingEngine.prototype.generateForecast = function (clinicId_1, serviceId_1, forecastType_1, startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, serviceId, forecastType, startDate, endDate, options) {
            var defaultOptions, opts, historicalData, patterns, selectedModel, adjustedData, forecast, confidenceLevel, demandForecast, error_2;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.loadHistoricalData(clinicId, serviceId, forecastType, startDate, endDate)];
                    case 2:
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6: return [4 /*yield*/, this.executeModelPrediction(selectedModel, adjustedData, startDate, endDate)];
                    case 7:
                        forecast = _a.sent();
                        if (!opts.model_ensemble) return [3 /*break*/, 9];
                        return [4 /*yield*/, this.applyEnsembleMethod(forecast, forecastType, serviceId, adjustedData, startDate, endDate)];
                    case 8:
                        forecast = _a.sent();
                        _a.label = 9;
                    case 9: return [4 /*yield*/, this.calculateConfidence(selectedModel, patterns, forecast)];
                    case 10:
                        confidenceLevel = _a.sent();
                        // 8. Validate accuracy threshold
                        if (confidenceLevel < opts.min_accuracy_threshold) {
                            console.warn("Forecast confidence ".concat(confidenceLevel, " below threshold ").concat(opts.min_accuracy_threshold));
                        }
                        demandForecast = {
     ...
     */
    DemandForecastingEngine.prototype.generateServiceForecasts = function (clinicId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, services, error, forecasts, _i, _b, service, forecast, error_3, appointmentForecast, error_4;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        _c.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this.generateForecast(clinicId, service.id, 'service_demand', startDate, endDate)];
                    case 4:
                        forecast = _c.sent();
                    ...
                    case 6:
                        _i++;
                        return [3 /*break*/, 2];
                    case 7: return [4 /*yield*/, this.generateForecast(clinicId, null, 'appointments', startDate, endDate)];
                    case 8:
    ...
    DemandForecastingEngine.prototype.adjustForecastRealTime = function (forecastId, currentData) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, existingForecast, error, adjustmentFactor, adjustedDemand, newConfidence, _b, updatedForecast, updateError, error_5;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 5, , 6]);
     ...
     */
    DemandForecastingEngine.prototype.loadHistoricalData = function (clinicId, serviceId, forecastType, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        query = supabase_1.supabase.from('appointments').select("\n        id,\n        scheduled_at,\n        duration_minutes,\n        status,\n        service_id,\n        services(name, category, price)\n      ");
                        query = query
                            .eq('clinic_id', clinicId)
     ...
     */
    DemandForecastingEngine.prototype.selectOptimalModel = function (forecastType, serviceId, patterns) {
        return __awaiter(this, void 0, void 0, function () {
            var availableModels, bestModel;
            return __generator(this, function (_a) {
                availableModels = Array.from(this.models.values()).filter(function (model) { return model.status === 'active'; });
     ...
     */
    DemandForecastingEngine.prototype.executeModelPrediction = function (model, data, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var dailyAverage, forecastDays, adjustment, predictedValue, confidence;
            return __generator(this, function (_a) {
                try {
                    dailyAverage = data.length / Math.max(1, Math.ceil((endDate.getTime() - startDate.getTime()) / (1000 * 60 * 60 * 24)));
     ...
     */
    DemandForecastingEngine.prototype.applyEnsembleMethod = function (baseForecast, forecastType, serviceId, data, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var activeModels, predictions, _i, activeModels_1, model, prediction, error_8, totalWeight, weightedSum, ensembleValue, ensembleConfidence;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        activeModels = Array.from(this.models.values())
                            .filter(function (model) { return model.status === 'active'; })
                            .slice(0, 3);
    ...
    DemandForecastingEngine.prototype.calculateConfidence = function (model, patterns, forecast) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                confidence = model.accuracy_score;
                avgPatternConfidence = patterns.reduce(function (sum, pattern) { return sum + pattern.confidence; }, 0) / patterns.length;
                    ...
                    case 0:
                        ...
                        if (forecastDaily > averageHistorical * 1.5) {
                            alerts.push({
                                ...
                                severity: 'high',
                                message: "Predicted demand spike: ".concat(forecastDaily.toFixed(0), " vs historical ").concat(averageHistorical.toFixed(0)),
                        ...
                        if (forecast.confidence_level < this.ACCURACY_THRESHOLD) {
                            alerts.push({
                                ...
                                severity: 'medium',
                                message: "Low forecast confidence: ".concat((forecast.confidence_level * 100).toFixed(1), "%"),
                                forecast_id: forecast.id,
                                affected_resources: [],
                                recommended_actions: [
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        this.models.clear();
                        models === null || models === void 0 ? void 0 : models.forEach(function (model) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        console.warn("Model ".concat(modelId, " accuracy ").concat(model.accuracy_score, " below threshold ").concat(this.ACCURACY_THRESHOLD));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // Store in database
                        return [4 /*yield*/, supabase_1.supabase.from('forecast_models').insert(__assign(__assign({}, model), { clinic_id: clinicId }))];
                    case 2:
                        // Store in database
                        _a.sent();
                        _a.label = 3;
    ...
    DemandForecastingEngine.prototype.recalculateConfidence = function (forecast, adjustmentFactor) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Math.max(this.ACCURACY_THRESHOLD, forecast.confidence_level - deviationPenalty)];
            });
        });
    };
    /**
    ...
    DemandForecastingEngine.prototype.calculateStaffAllocations = function (clinicId, forecasts) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                allocations = [];
                totalDemand = forecasts.reduce(function (sum, forecast) { return sum + forecast.predicted_demand; }, 0);
                allocations.push({
                    resource_type: 'staff',
...
exports.ForecastingUtils = {
    ...
    formatForecastPeriod: function (startDate, endDate) {
        ...
        return "".concat((0, date_fns_1.format)(start, 'MMM dd'), " - ").concat((0, date_fns_1.format)(end, 'MMM dd, yyyy'));
    },
    /**
     ...
     */
    getForecastHorizons: function () { return [
