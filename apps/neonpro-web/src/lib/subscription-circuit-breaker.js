...
exports.circuitBreakerRegistry = exports.SubscriptionExternalAPICircuitBreaker = exports.SubscriptionCacheCircuitBreaker = exports.SubscriptionDatabaseCircuitBreaker = exports.SubscriptionCircuitBreaker = exports.CircuitBreakerState = void 0;
...
var SubscriptionCircuitBreaker = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.state === CircuitBreakerState.OPEN) {
                            if (this.shouldAttemptReset()) {
                                ...
                                error = subscription_errors_1.SubscriptionErrorFactory.createError('external_service', "Circuit breaker is OPEN for ".concat(this.serviceName), context);
                                return [2 /*return*/, {
                                        success: false,
                                        error: error,
                        ...
                        if (this.state === CircuitBreakerState.HALF_OPEN) {
                            if (this.halfOpenRequestsInProgress >= this.config.halfOpenMaxConcurrentRequests) {
                                this.rejectedRequests++;
                                error = subscription_errors_1.SubscriptionErrorFactory.createError('rate_limit', "Circuit breaker is HALF_OPEN with maximum concurrent requests for ".concat(this.serviceName), context);
                                return [2 /*return*/, {
                                        success: false,
                                        error: error,
                                        fromCircuitBreaker: true,
                    ...
                    case 3:
                        error_1 = _a.sent();
                        executionTime = Date.now() - startTime;
                        subscriptionError = error_1 instanceof Error && 'code' in error_1
                            ? error_1
                            : subscription_errors_1.SubscriptionErrorFactory.createError('external_service', error_1 instanceof Error ? error_1.message : 'Unknown error', context);
                        // Record failure
    ...
    SubscriptionCircuitBreaker.prototype.onSuccess = function (responseTime) {
        ...
        if (this.config.monitoring.enabled) {
            console.log("Circuit breaker success: ".concat(this.serviceName, " - ").concat(responseTime, "ms"));
        }
    ...
    SubscriptionCircuitBreaker.prototype.onFailure = function (error) {
        ...
        if (this.state === CircuitBreakerState.CLOSED && this.failureCount >= this.config.failureThreshold) {
            ...
            if (this.config.monitoring.alertOnOpen) {
                this.sendAlert("Circuit breaker opened for ".concat(this.serviceName, " after ").concat(this.failureCount, " failures"));
            }
        }
    ...
    SubscriptionCircuitBreaker.prototype.getStats = function () {
        var averageResponseTime = this.successfulRequests > 0
            ? this.responseTimeSum / this.successfulRequests
            : 0;
        var uptime = this.totalRequests > 0
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (this.shouldAttemptReset()) {
                            this.state = CircuitBreakerState.HALF_OPEN;
                            this.stateChangedAt = new Date();
                            this.logStateChange(CircuitBreakerState.HALF_OPEN, 'Health check passed, attempting reset');
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        error_2 = _a.sent();
    ...
    SubscriptionCircuitBreaker.prototype.logStateChange = function (newState, reason) {
        if (this.config.monitoring.enabled && this.config.monitoring.logStateChanges) {
            console.log("Circuit breaker ".concat(this.serviceName, " changed to ").concat(newState, ": ").concat(reason));
        }
    };
    /**
...
var SubscriptionDatabaseCircuitBreaker = /** @class */ (function (_super) {
    ...
    function SubscriptionDatabaseCircuitBreaker(config) {
        return _super.call(this, 'subscription_database', __assign({ failureThreshold: 3, timeout: 30000 }, config)) || this;
    }
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Promise.race([
                        ...
                        new Promise(function (_, reject) {
                            setTimeout(function () { return reject(new Error('Health check timeout')); }, timeout);
                        })
                    ])];
            });
        });
...
var SubscriptionCacheCircuitBreaker = /** @class */ (function (_super) {
    ...
    function SubscriptionCacheCircuitBreaker(config) {
        return _super.call(this, 'subscription_cache', __assign({ failureThreshold: 5, timeout: 10000 }, config)) || this;
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Promise.race([
                        ...
                        new Promise(function (_, reject) {
                            setTimeout(function () { return reject(new Error('Cache health check timeout')); }, timeout);
                        })
                    ])];
            });
        });
...
var SubscriptionExternalAPICircuitBreaker = /** @class */ (function (_super) {
    ...
    function SubscriptionExternalAPICircuitBreaker(apiName, config) {
        return _super.call(this, "subscription_external_api_".concat(apiName), __assign({ failureThreshold: 3, timeout: 60000 }, config)) || this;
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Promise.race([
                        ...
                        new Promise(function (_, reject) {
                            setTimeout(function () { return reject(new Error('API health check timeout')); }, timeout);
                        })
                    ])];
            });
        });
...
var CircuitBreakerRegistry = /** @class */ (function () {
    ...
    CircuitBreakerRegistry.prototype.getStats = function () {
        ...
        for (var _i = 0, _a = this.breakers; _i < _a.length; _i++) {
            var _b = _a[_i], name_1 = _b[0], breaker = _b[1];
