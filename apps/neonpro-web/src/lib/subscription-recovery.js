...
var SubscriptionRecoveryManager = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                switch (strategy) {
                    ...
                    case 'fallback':
                        return [2 /*return*/, this.executeFallbackStrategy(operation, error, context, startTime)];
                    case 'graceful_degrade':
                        return [2 /*return*/, this.executeGracefulDegradationStrategy(operation, error, context, startTime)];
                    case 'circuit_break':
                        return [2 /*return*/, this.executeCircuitBreakerStrategy(operation, error, context, startTime)];
                    default:
                        return [2 /*return*/, this.executeDefaultStrategy(operation, error, context, startTime)];
                }
                return [2 /*return*/];
            });
        });
    };
    SubscriptionRecoveryManager.prototype.executeRetryStrategy = function (operation, error, context, startTime) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SubscriptionRecoveryManager.prototype.executeFallbackStrategy = function (operation, error, context, startTime) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    SubscriptionRecoveryManager.prototype.executeGracefulDegradationStrategy = function (operation, error, context, startTime) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    SubscriptionRecoveryManager.prototype.executeCircuitBreakerStrategy = function (operation, error, context, startTime) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    SubscriptionRecoveryManager.prototype.executeDefaultStrategy = function (operation, error, context, startTime) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
