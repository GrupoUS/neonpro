...
exports.routeConfigManager = exports.RouteConfigManager = exports.DEFAULT_ROUTE_CONFIG = exports.ConfigValidator = exports.PREDEFINED_ROUTES = exports.createRoute = exports.RouteBuilder = exports.FEATURE_GROUPS = exports.PERMISSION_PRESETS = exports.RBAC_PRESETS = exports.ROUTE_PRESETS = void 0;
...
var RouteBuilder = /** @class */ (function () {
    ...
    RouteBuilder.prototype.build = function () {
        ...
        return __assign({ requiresAuth: false, requiresSubscription: false, auditLevel: 'none' }, this.route);
    };
    return RouteBuilder;
}());
exports.RouteBuilder = RouteBuilder;
// Quick route creation helpers
var createRoute = function (pattern, name) { return new RouteBuilder(pattern, name); };
...
var RouteConfigManager = /** @class */ (function () {
    function RouteConfigManager(initialRoutes) {
        if (initialRoutes === void 0) { initialRoutes = exports.PREDEFINED_ROUTES; }
        this.routes = [];
    ...
    RouteConfigManager.prototype.removeRoute = function (name) {
        var index = this.routes.findIndex(function (route) { return route.name === name; });
        if (index !== -1) {
    ...
    RouteConfigManager.prototype.getRoute = function (name) {
        return this.routes.find(function (route) { return route.name === name; });
    };
