...
var OptimalTimingEngine = /** @class */ (function () {
    ...
    OptimalTimingEngine.prototype.analyzeTimingPatterns = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var requestId, communicationData, globalPatterns, segmentedPatterns, recommendations, insights, performanceMetrics, result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.generateMLRecommendations(globalPatterns, segmentedPatterns, request)];
                    case 4:
                        recommendations = _a.sent();
                        return [4 /*yield*/, this.generateTimingInsights(globalPatterns, segmentedPatterns, communicationData)];
                    case 5:
                        insights = _a.sent();
    ...
    OptimalTimingEngine.prototype.analyzeGlobalPatterns = function (data, request) {
        return __awaiter(this, void 0, void 0, function () {
            var patterns, _i, data_1, communication, sentDate, dayOfWeek, hour, key, pattern, events, hasOpen, hasClick, hasResponse;
            var _this = this;
            var _a;
                ...
                for (_i = 0, data_1 = data; _i < data_1.length; _i++) {
                    ...
                    if (!patterns.has(key)) {
                        patterns.set(key, {
                            ...
                            timezone: ((_a = this.config) === null || _a === void 0 ? void 0 : _a.globalSettings.defaultTimezone) || 'America/Sao_Paulo'
                        });
                    }
                    pattern = patterns.get(key);
                    pattern.sampleSize++;
                    events = communication.communication_events || [];
                    hasOpen = events.some(function (e) { return e.type === 'open'; });
                    hasClick = events.some(function (e) { return e.type === 'click'; });
                    hasResponse = events.some(function (e) { return e.type === 'response'; });
                    if (hasOpen)
                    ...
                    if (hasResponse)
                        pattern.responseRate = (pattern.responseRate * (pattern.sampleSize - 1) + 1) / pattern.sampleSize;
                }
                // Converter para array e calcular confiança
                return [2 /*return*/, Array.from(patterns.values()).map(function (pattern) { return (__assign(__assign({}, pattern), { confidence: _this.calculatePatternConfidence(pattern.sampleSize), responseRate: pattern.responseRate * 100, openRate: (pattern.openRate || 0) * 100, clickRate: (pattern.clickRate || 0) * 100 })); })];
            });
        });
    };
    /**
    ...
    OptimalTimingEngine.prototype.analyzeSegmentedPatterns = function (data, request) {
        return __awaiter(this, void 0, void 0, function () {
            var segmentedPatterns, ageSegments, _i, _a, _b, segment, segmentData, _c, _d, genderSegments, _e, _f, _g, segment, segmentData, _h, _j, typeSegments, _k, _l, _m, segment, segmentData, _o, _p;
            return __generator(this, function (_q) {
                switch (_q.label) {
                    ...
                    case 11:
                        _k++;
                        return [3 /*break*/, 9];
                    case 12: return [2 /*return*/, segmentedPatterns];
                }
            });
        });
    };
     ...
     */
    OptimalTimingEngine.prototype.generateMLRecommendations = function (globalPatterns, segmentedPatterns, request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        recommendations = [];
                        if (!((_b = request.patientIds) === null || _b === void 0 ? void 0 : _b.length)) return [3 /*break*/, 5];
                        _i = 0, _a = request.patientIds;
                        _c.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 4];
                        patientId = _a[_i];
                        return [4 /*yield*/, this.generatePersonalizedRecommendation(patientId, request.communicationType, globalPatterns, segmentedPatterns)];
                    case 2:
                    ...
                    case 5: return [4 /*yield*/, this.generateGeneralRecommendations(globalPatterns, segmentedPatterns, request)];
                    case 6:
     ...
     */
    OptimalTimingEngine.prototype.generatePersonalizedRecommendation = function (patientId_1, communicationType_1) {
        return __awaiter(this, arguments, void 0, function (patientId, communicationType, globalPatterns, segmentedPatterns) {
            var patient, patientPatterns, segments, optimalTime, alternativeTimes, avoidTimes, reasoning, error_4;
            if (globalPatterns === void 0) { globalPatterns = []; }
            if (segmentedPatterns === void 0) { segmentedPatterns = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.predictOptimalTime(patient, communicationType || 'email', patientPatterns, globalPatterns, segmentedPatterns)];
                    case 3:
                        optimalTime = _a.sent();
                        return [4 /*yield*/, this.generateAlternativeTimes(optimalTime, patientPatterns, globalPatterns)];
                    case 4:
                        alternativeTimes = _a.sent();
                        avoidTimes = this.determineAvoidTimes(patient, patientPatterns);
                        reasoning = this.generateRecommendationReasoning(optimalTime, patientPatterns, segments, globalPatterns);
                        return [2 /*return*/, {
                                patientId: patientId,
     ...
     */
    OptimalTimingEngine.prototype.predictOptimalTime = function (patient, communicationType, patientPatterns, globalPatterns, segmentedPatterns) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!model || patientPatterns.length === 0) {
                            ...
                            return [2 /*return*/, this.generateStatisticalOptimalTime(patient, communicationType, globalPatterns)];
                        }
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                timezone: patient.timezone || ((_a = this.config) === null || _a === void 0 ? void 0 : _a.globalSettings.defaultTimezone) || 'America/Sao_Paulo',
    ...
    OptimalTimingEngine.prototype.simulateMLPrediction = function (features, model) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, predictions.sort(function (a, b) { return b.probability - a.probability; })];
            });
        });
    };
    /**
     ...
     */
    OptimalTimingEngine.prototype.prepareMLFeatures = function (patient, communicationType, patterns) {
        var age = this.calculateAge(new Date(patient.birth_date));
        var avgResponseRate = patterns.length > 0
            ? patterns.reduce(function (sum, p) { return sum + p.responseRate; }, 0) / patterns.length
            : 0;
        var recentEngagement = patterns
            .filter(function (p) { return p.lastUpdated > new Date(Date.now() - 30 * 24 * 60 * 60 * 1000); })
            .length;
        return {
            patientAge: age,
    ...
    OptimalTimingEngine.prototype.analyzeBehaviorPattern = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var patterns, hourCounts, preferredHours, dayCounts, preferredDays, pattern, avgResponseLatency, engagementWindow, confidence, error_5;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 2: return [2 /*return*/, (_a.characteristics = (_b.responseLatency = _c.sent(),
                            _b.engagementWindow = engagementWindow,
                            _b),
    ...
    OptimalTimingEngine.prototype.classifyBehaviorPattern = function (preferredHours, preferredDays) {
        var morningHours = preferredHours.filter(function (h) { return h >= 6 && h <= 10; }).length;
        var eveningHours = preferredHours.filter(function (h) { return h >= 18 && h <= 22; }).length;
        var businessHours = preferredHours.filter(function (h) { return h >= 9 && h <= 17; }).length;
        var weekendDays = preferredDays.filter(function (d) { return d === 0 || d === 6; }).length;
        if (morningHours >= 2)
            return 'early_bird';
        if (eveningHours >= 2)
            return 'night_owl';
     ...
     */
    OptimalTimingEngine.prototype.optimizeSendTime = function (communicationId, patientId, scheduledTime, communicationType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.applyOptimizationRules(scheduledTime, recommendation, realTimeFactors)];
                    case 3:
                        optimizedTime = _a.sent();
                        expectedImprovement = this.calculateExpectedImprovement(scheduledTime, optimizedTime, recommendation);
                        return [2 /*return*/, {
                                ...
                                confidence: (recommendation === null || recommendation === void 0 ? void 0 : recommendation.confidence) || 0.5,
     ...
     */
    OptimalTimingEngine.prototype.applyOptimizationRules = function (scheduledTime, recommendation, realTimeFactors) {
        return __awaiter(this, void 0, void 0, function () {
            var optimizedTime, optimalHour, optimalDay, daysToAdd, _i, _a, avoidTime, now, businessHours, hour;
            var _b;
            return __generator(this, function (_c) {
                optimizedTime = new Date(scheduledTime);
                // Regra 1: Respeitar horário ótimo se disponível
                if (recommendation === null || recommendation === void 0 ? void 0 : recommendation.optimalTime) {
                ...
                if (recommendation === null || recommendation === void 0 ? void 0 : recommendation.avoidTimes) {
                ...
                if (realTimeFactors === null || realTimeFactors === void 0 ? void 0 : realTimeFactors.factors.deviceActivity) {
                    now = new Date();
                ...
                if ((_b = this.config) === null || _b === void 0 ? void 0 : _b.globalSettings.businessHours) {
    ...
    OptimalTimingEngine.prototype.calculateOptimizationPerformance = function (clinicId, period) {
        return __awaiter(this, void 0, void 0, function () {
            var communications, optimized, baseline, baselineMetrics, optimizedMetrics, improvement, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        optimized = communications.filter(function (c) { var _a; return ((_a = c.send_time_optimization) === null || _a === void 0 ? void 0 : _a.length) > 0; });
                        baseline = communications.filter(function (c) { var _a; return !((_a = c.send_time_optimization) === null || _a === void 0 ? void 0 : _a.length); });
    ...
    OptimalTimingEngine.prototype.segmentByAge = function (data) {
        ...
        return data.reduce(function (acc, item) {
            var _a;
            if (!((_a = item.patient) === null || _a === void 0 ? void 0 : _a.birth_date))
                return acc;
    ...
    OptimalTimingEngine.prototype.segmentByGender = function (data) {
        return data.reduce(function (acc, item) {
            var _a;
            var gender = ((_a = item.patient) === null || _a === void 0 ? void 0 : _a.gender) || 'unknown';
            if (!acc[gender])
                acc[gender] = [];
    ...
    OptimalTimingEngine.prototype.generateGeneralRecommendations = function (globalPatterns, segmentedPatterns, request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, []];
            });
    ...
    OptimalTimingEngine.prototype.generateTimingInsights = function (globalPatterns, segmentedPatterns, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, []];
            });
    ...
    OptimalTimingEngine.prototype.determinePatientSegments = function (patient) {
        ...
        if (age < 25)
            ...
            segments.push('middle_age');
        else
            segments.push('senior');
        segments.push(patient.gender || 'unknown');
        return segments;
    };
    OptimalTimingEngine.prototype.generateAlternativeTimes = function (optimalTime, patientPatterns, globalPatterns) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, []];
            });
    ...
    OptimalTimingEngine.prototype.generateRecommendationReasoning = function (optimalTime, patterns, segments, globalPatterns) {
        return ['Based on historical engagement patterns'];
    };
    OptimalTimingEngine.prototype.calculateSeasonalAdjustments = function () {
        return [];
    };
    OptimalTimingEngine.prototype.generateStatisticalOptimalTime = function (patient, communicationType, patterns) {
        var _a;
        // Fallback simples baseado em padrões estatísticos
        var bestPattern = patterns
            .filter(function (p) { return p.communicationType === communicationType; })
            .sort(function (a, b) { return b.responseRate - a.responseRate; })[0];
        if (bestPattern) {
            return {
    ...
    OptimalTimingEngine.prototype.calculateExpectedImprovement = function (originalTime, optimizedTime, recommendation) {
        // Calcular melhoria esperada em %
        return 0;
    };
    OptimalTimingEngine.prototype.generateOptimizationReason = function (originalTime, optimizedTime, recommendation) {
        return 'Optimized based on timing analysis';
    };
    OptimalTimingEngine.prototype.extractOptimizationFactors = function (realTimeFactors, recommendation) {
        return [];
    };
    ...
    OptimalTimingEngine.prototype.calculateGroupMetrics = function (communications) {
        ...
        communications.forEach(function (comm) {
            ...
            if (events.some(function (e) { return e.type === 'response'; }))
                totalResponses++;
            if (events.some(function (e) { return e.type === 'open'; }))
                totalOpens++;
            if (events.some(function (e) { return e.type === 'click'; }))
                totalClicks++;
            if (events.some(function (e) { return e.type === 'conversion'; }))
                totalConversions++;
        });
        return {
...
var createoptimalTimingEngine = function () { return new OptimalTimingEngine(); };
