        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, simple_session_manager_1.sessionManager.updateSessionActivity(sessionId)];
                case 2:
                    // Update session activity
                    _b.sent();
                    return [2 /*return*/, {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                ...
                return [2 /*return*/, simple_session_manager_1.sessionManager.hasPermission(sessionId, permission)];
            }
            catch (_b) {
                return [2 /*return*/, false];
            }
...
function requirePermission(permission_1) {
    return __awaiter(this, arguments, void 0, function (permission, unauthorizedUrl) {
        var authResult;
        if (unauthorizedUrl === void 0) { unauthorizedUrl = '/unauthorized'; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, requireAuth()];
                case 1:
                    authResult = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [2 /*return*/, {
                            publicMetadata: (user === null || user === void 0 ? void 0 : user.publicMetadata) || {},
                            privateMetadata: (user === null || user === void 0 ? void 0 : user.privateMetadata) || {},
                            unsafeMetadata: (user === null || user === void 0 ? void 0 : user.unsafeMetadata) || {}
                        }];
                case 2:
                    error_2 = _a.sent();
...
function isProtectedRoute(pathname) {
    return clerk_config_1.clerkConfig.protectedRoutes.some(function (route) {
...
function isPublicRoute(pathname) {
    return clerk_config_1.clerkConfig.publicRoutes.some(function (route) {
