...
var RealTimeSecurityMonitor = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 9:
                        metrics = (_a.securityEvents = _b.sent(),
                            _a);
    ...
    RealTimeSecurityMonitor.prototype.getMetricsHistory = function (timeRange_1) {
        return __awaiter(this, arguments, void 0, function (timeRange, interval) {
            ...
            if (interval === void 0) { interval = 'hour'; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        fullIncident = __assign(__assign({}, incident), { incidentId: "incident_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)), detectedAt: new Date(), timeline: [
                                {
                                    timestamp: new Date(),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        updatedIncident = __assign(__assign(__assign({}, existingIncident), updates), { timeline: __spreadArray(__spreadArray([], existingIncident.timeline, true), [
                                {
                                    timestamp: new Date(),
    ...
    RealTimeSecurityMonitor.prototype.getMonitoringStatistics = function (timeRange) {
        return __awaiter(this, void 0, void 0, function () {
            var incidents, metrics, incidentsBySeverity, incidentsByType, totalResolutionTime, resolvedIncidents, falsePositives, _i, incidents_1, incident, resolutionTime, error_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.getIncidents({
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _i = 0, _a = this.config.thresholds.filter(function (t) { return t.isEnabled; });
                        _b.label = 1;
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 6, , 7]);
                        return [4 /*yield*/, this.createIncident({
                                type: 'threshold_breach',
                                severity: threshold.severity,
                                title: "Threshold breach: ".concat(threshold.metricName),
                                description: "".concat(threshold.description, ". Current value: ").concat(value, ", threshold: ").concat(threshold.value),
                                status: 'open',
                                metrics: metrics,
                                evidence: {
                                    threshold: threshold,
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        setTimeout(function () { return _this.executeThresholdAction(action, incident_1); }, action.delay * 1000);
                                        return [3 /*break*/, 3];
                                    case 1: return [4 /*yield*/, this_1.executeThresholdAction(action, incident_1)];
                                    case 2:
                                        _c.sent();
                                        _c.label = 3;
                                    case 3: return [2 /*return*/];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'escalate': return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 7];
                    case 1: return [4 /*yield*/, this.sendEmailAlert(action.target, incident)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 3: return [4 /*yield*/, this.sendWebhookAlert(action.target, incident)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.escalateIncident(incident, action.target)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 7: 
    ...
    RealTimeSecurityMonitor.prototype.sendEmailAlert = function (recipient, incident) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log("Email alert sent to ".concat(recipient, " for incident ").concat(incident.incidentId));
                return [2 /*return*/];
            });
        });
    };
    RealTimeSecurityMonitor.prototype.sendWebhookAlert = function (url, incident) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log("Webhook alert sent to ".concat(url, " for incident ").concat(incident.incidentId));
                return [2 /*return*/];
            });
        });
    };
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                resolved_at: (_a = incident.resolvedAt) === null || _a === void 0 ? void 0 : _a.toISOString(),
