...
var DeviceTrackingManager = /** @class */ (function () {
     ...
     */
    DeviceTrackingManager.prototype.registerDevice = function (userId, userRole, fingerprint, deviceInfo, metadata) {
        return __awaiter(this, void 0, void 0, function () {
            var deviceId, now, existingDevice, isNewDevice, deviceType, riskFactors, riskScore, policy, requiresVerification, isBlocked, error, error, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.assessDeviceRisk(userId, deviceId, fingerprint, deviceInfo.ipAddress, deviceInfo.location, isNewDevice)];
                    case 2:
                        riskFactors = _a.sent();
                        riskScore = this.calculateRiskScore(riskFactors);
                        policy = this.devicePolicies[userRole];
                        requiresVerification = isNewDevice && (policy.requireVerification ||
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                metadata: __assign(__assign({}, metadata), { riskFactors: riskFactors, userRole: userRole, registrationPolicy: policy })
                            })];
                    case 3:
                        error = (_a.sent()).error;
                        if (error) {
                    ...
                    case 7: return [4 /*yield*/, this.supabase
                            ...
                            .update({
                            last_seen: now.toISOString(),
                            session_count: ((existingDevice === null || existingDevice === void 0 ? void 0 : existingDevice.sessionCount) || 0) + 1,
                            risk_score: riskScore,
                            ip_address: deviceInfo.ipAddress,
                            location: deviceInfo.location,
                            metadata: __assign(__assign(__assign({}, existingDevice === null || existingDevice === void 0 ? void 0 : existingDevice.metadata), metadata), { lastRiskFactors: riskFactors, lastUpdate: now.toISOString() })
                        })
     ...
     */
    DeviceTrackingManager.prototype.createVerificationChallenge = function (deviceId, userId, challengeType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        challengeId = "challenge_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9));
    ...
    DeviceTrackingManager.prototype.cleanupOldDevices = function () {
        return __awaiter(this, void 0, void 0, function () {
            var devicesRemoved, challengesRemoved, _i, _a, _b, role, policy, retentionDate, _c, oldDevices, selectError, deleteError, _d, expiredChallenges, challengeSelectError, challengeDeleteError, error_8;
                ...
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('device_registrations')
                                .delete()
                                .in('device_id', oldDevices.map(function (d) { return d.device_id; }))];
                    case 3:
                    ...
                    case 6:
                        ...
                        if (!(!challengeSelectError && expiredChallenges && expiredChallenges.length > 0)) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.supabase
                                .from('device_verification_challenges')
                                .delete()
                                .in('challenge_id', expiredChallenges.map(function (c) { return c.challenge_id; }))];
                    case 7:
                    ...
                    case 9:
                        // Log cleanup event
                        _e.sent();
                        return [2 /*return*/, { devicesRemoved: devicesRemoved, challengesRemoved: challengesRemoved }];
                    case 10:
                        error_8 = _e.sent();
    ...
    DeviceTrackingManager.prototype.updateDevicePolicy = function (role, policy) {
        this.devicePolicies[role] = __assign(__assign(__assign({}, this.devicePolicies[role]), policy), { role: role });
    };
    /**
    ...
    DeviceTrackingManager.prototype.assessDeviceRisk = function (userId_1, deviceId_1, fingerprint_1, ipAddress_1, location_1) {
        return __awaiter(this, arguments, void 0, function (userId, deviceId, fingerprint, ipAddress, location, isNewDevice) {
            var userDevices, riskFactors, lastDevice, distance, similarDevices, _a, _b, _c;
            if (isNewDevice === void 0) { isNewDevice = false; }
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.getUserDevices(userId)];
                    case 1:
                        userDevices = _d.sent();
                        riskFactors = {
                            isNewDevice: isNewDevice,
                        ...
                        if (userDevices.length > 0) {
                            ...
                            if (lastDevice.location && location) {
                                distance = this.calculateDistance(lastDevice.location.coordinates, location.coordinates);
                                riskFactors.locationChange = distance > 1000; // More than 1000km
                            }
                            similarDevices = userDevices.filter(function (d) {
                                return d.fingerprint.platform === fingerprint.platform &&
