...
var SessionManager = /** @class */ ((_super) => {
  ...
  function SessionManager(config) {
    ...
    _this.config = config;
    _this.supabase = (0, supabase_js_1.createClient)(
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            if (
              (_b = this.emergencyControls) === null || _b === void 0
                ? void 0
                : _b.global_kill_switch
            ) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.deviceTracker.validateDevice(userId, deviceFingerprint, userAgent),
            ];
          case 4:
            deviceInfo = _c.sent();
            return [
              4 /*yield*/,
              this.suspiciousActivityDetector.analyzeLoginAttempt(
                userId,
                ipAddress,
                deviceFingerprint,
                userAgent,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            // Check emergency controls
            if (
              (_a = this.emergencyControls) === null || _a === void 0
                ? void 0
                : _a.global_kill_switch
            ) {
              return [
                2 /*return*/,
                {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.updateSession(__assign(__assign({}, session), { is_active: false })),
            ];
          case 2:
            // Mark as inactive
            _a.sent();
  ...
  SessionManager.prototype.activateEmergencyControls = function (controls, initiatedBy) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            this.emergencyControls = __assign(
              __assign(
                {
              ...
              { initiated_by: initiatedBy, initiated_at: new Date() },
            );
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.redis.set(
                "".concat(this.config.redis.prefix, "emergency_controls"),
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            syncData = {
              ...
              sync_data: {
                preferences:
                  (userPrefs === null || userPrefs === void 0 ? void 0 : userPrefs.preferences) ||
                  {},
                ui_state:
                  (userPrefs === null || userPrefs === void 0 ? void 0 : userPrefs.ui_state) || {},
            ...
            return [
              4 /*yield*/,
              this.redis.set(
                "".concat(this.config.redis.prefix, "sync:").concat(userId),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("session_policies").select("*").eq("role_id", roleId).single(),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.terminateSession(oldestSession.id, "Concurrent session limit exceeded"),
            ];
          case 2:
            _a.sent();
            return [
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("user_sessions").insert(this.mapSessionToDatabaseRow(session)),
            ];
          case 1:
            error = _a.sent().error;
            if (error) throw error;
        ...
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.redis.set(
                "".concat(this.config.redis.prefix, "session:").concat(session.id),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.redis.get("".concat(this.config.redis.prefix, "session:").concat(sessionId)),
            ];
          case 1:
            cached = _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.redis.del("".concat(this.config.redis.prefix, "session:").concat(sessionId)),
            ];
          case 1:
            _a.sent();
            return [2 /*return*/];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.suspiciousActivityDetector.analyzeSessionActivity(
                session.user_id,
                session.id,
                ipAddress,
                userAgent || "",
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            auditEvent = __assign(
              { id: (0, crypto_1.randomBytes)(16).toString("hex"), timestamp: new Date() },
              event,
            );
            return [
              4 /*yield*/,
...
var SuspiciousActivityDetector = /** @class */ (() => {
  ...
  SuspiciousActivityDetector.prototype.analyzeLoginAttempt = function (
    userId,
    ipAddress,
    deviceFingerprint,
    userAgent,
  ...
  SuspiciousActivityDetector.prototype.analyzeSessionActivity = function (
    userId,
    sessionId,
    ipAddress,
    userAgent,
