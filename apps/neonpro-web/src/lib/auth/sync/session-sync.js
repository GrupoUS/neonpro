...
var SessionSyncManager = /** @class */ (function () {
    ...
    SessionSyncManager.prototype.detectConflict = function (event, syncState) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                recentEvents = syncState.pendingEvents.filter(function (e) { return e.sessionId === event.sessionId &&
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            case 'last_write_wins': return [3 /*break*/, 1];
                            case 'first_write_wins': return [3 /*break*/, 2];
                            case 'merge_changes': return [3 /*break*/, 3];
                            case 'device_priority': return [3 /*break*/, 5];
                            case 'rollback_changes': return [3 /*break*/, 6];
                        }
                        return [3 /*break*/, 7];
                    case 1: return [2 /*return*/, this.resolveLastWriteWins(conflict)];
                    case 2: return [2 /*return*/, this.resolveFirstWriteWins(conflict)];
                    case 3: return [4 /*yield*/, this.resolveMergeChanges(conflict)];
                    case 4: return [2 /*return*/, _b.sent()];
                    case 5: return [2 /*return*/, this.resolveDevicePriority(conflict)];
                    case 6: return [2 /*return*/, this.resolveRollback(conflict)];
                    case 7: return [2 /*return*/, null]; // Manual resolution required
                }
            });
        });
    };
    ...
    SessionSyncManager.prototype.resolveMergeChanges = function (conflict) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    mergedData = this.mergeEventData(conflict.localVersion.data, conflict.remoteVersions.map(function (e) { return e.data; }));
                    mergedEvent = {
                        id: this.utils.generateSessionToken(),
                        ...
                        data: mergedData,
                        timestamp: Date.now(),
                        version: Math.max.apply(Math, __spreadArray([conflict.localVersion.version], conflict.remoteVersions.map(function (e) { return e.version; }), false)) + 1,
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'session_updated': return [3 /*break*/, 3];
                            case 'session_terminated': return [3 /*break*/, 5];
                            case 'device_registered': return [3 /*break*/, 7];
                            case 'device_updated': return [3 /*break*/, 9];
                            case 'device_removed': return [3 /*break*/, 11];
                            case 'preferences_updated': return [3 /*break*/, 13];
                            case 'security_event': return [3 /*break*/, 15];
                        }
                        return [3 /*break*/, 17];
                    case 1: return [4 /*yield*/, this.applySessionCreated(event)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 18];
                    case 3: return [4 /*yield*/, this.applySessionUpdated(event)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 18];
                    case 5: return [4 /*yield*/, this.applySessionTerminated(event)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 18];
                    case 7: return [4 /*yield*/, this.applyDeviceRegistered(event)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 18];
                    case 9: return [4 /*yield*/, this.applyDeviceUpdated(event)];
                    case 10:
                        _b.sent();
                        return [3 /*break*/, 18];
                    case 11: return [4 /*yield*/, this.applyDeviceRemoved(event)];
                    case 12:
                        _b.sent();
                        return [3 /*break*/, 18];
                    case 13: return [4 /*yield*/, this.applyPreferencesUpdated(event)];
                    case 14:
                        _b.sent();
                        return [3 /*break*/, 18];
                    case 15: return [4 /*yield*/, this.applySecurityEvent(event)];
                    case 16:
                        _b.sent();
                        return [3 /*break*/, 18];
                    case 17:
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, fetch('/api/session/sync/create', {
                            method: 'POST',
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, fetch('/api/session/sync/update', {
                            method: 'PUT',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                sessionId: event.sessionId,
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, fetch('/api/session/sync/terminate', {
                            method: 'DELETE',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                sessionId: event.sessionId,
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, fetch('/api/devices/sync/register', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify(event.data)
                        })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, fetch('/api/devices/sync/update', {
                            method: 'PUT',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, fetch('/api/devices/sync/remove', {
                            method: 'DELETE',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                deviceId: event.data.deviceId
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, fetch('/api/users/sync/preferences', {
                            method: 'PUT',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                userId: event.userId,
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, fetch('/api/security/sync/event', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify(event.data)
                        })];
            ...
            return __generator(this, function (_b) {
                ...
                message = {
                    ...
                    payload: {
                        ...
                        userId: this.userId,
                        deviceId: this.deviceId,
                        lastSyncTimestamp: ((_a = this.syncStates.get(this.userId)) === null || _a === void 0 ? void 0 : _a.lastSyncTimestamp) || 0
                    },
                    timestamp: Date.now(),
                    messageId: this.utils.generateSessionToken(),
                    senderId: this.deviceId
    ...
    SessionSyncManager.prototype.attemptReconnection = function () {
        ...
        setTimeout(function () {
            console.log("Attempting reconnection ".concat(_this.reconnectAttempts, "/").concat(_this.maxReconnectAttempts));
    ...
    SessionSyncManager.prototype.handleAcknowledgment = function (message) {
        ...
        if (this.userId) {
            var syncState = this.syncStates.get(this.userId);
            if (syncState) {
                syncState.pendingEvents = syncState.pendingEvents.filter(function (e) { return e.id !== message.payload.eventId; });
            }
        }
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (this.userId) {
                            syncState = this.syncStates.get(this.userId);
                            if (syncState) {
                                syncState.conflictQueue = syncState.conflictQueue.filter(function (c) { return c.id !== conflict.id; });
                            }
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!syncState)
                            return [2 /*return*/, false];
                        conflict = syncState.conflictQueue.find(function (c) { return c.id === conflictId; });
                        if (!conflict)
                            return [2 /*return*/, false];
                        return [4 /*yield*/, this.applyConflictResolution(conflict, resolution)];
                    case 1:
    ...
    SessionSyncManager.prototype.cleanup = function () {
        ...
        for (var _i = 0, _a = this.syncStates.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], userId = _b[0], syncState = _b[1];
            // Clean up old pending events
            syncState.pendingEvents = syncState.pendingEvents.filter(function (e) { return now - e.timestamp < maxAge; });
            // Clean up resolved conflicts
            syncState.conflictQueue = syncState.conflictQueue.filter(function (c) { return !c.resolvedAt || now - c.resolvedAt < maxAge; });
        }
    };
