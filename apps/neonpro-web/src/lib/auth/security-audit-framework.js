...
var SecurityAuditFramework = /** @class */ (function () {
    ...
    SecurityAuditFramework.getInstance = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        supabase = _a.sent();
                        securityEvent = __assign(__assign({}, event), { id: crypto.randomUUID(), timestamp: new Date() });
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6:
                        performance_tracker_1.performanceTracker.recordMetric('security_event_logging', Date.now() - startTime);
                        return [3 /*break*/, 8];
                    case 7:
                        error_1 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(event.eventType === 'authentication' && event.outcome === 'failure')) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.checkFailedLoginThreshold(event.ipAddress, event.userId)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
                        if (!(event.severity === 'high' || event.severity === 'critical')) return [3 /*break*/, 5];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!(failedAttempts >= this.config.alertThresholds.failedLoginAttempts)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.triggerSecurityAlert({
                                type: 'failed_login_threshold',
                                severity: 'high',
                                message: "".concat(failedAttempts, " failed login attempts from IP ").concat(ipAddress),
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!(suspiciousEvents >= this.config.alertThresholds.suspiciousIPActivity)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.triggerSecurityAlert({
                                type: 'suspicious_ip_activity',
                                severity: 'critical',
                                message: "".concat(suspiciousEvents, " suspicious activities from IP ").concat(ipAddress),
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (!(dataAccessCount >= this.config.alertThresholds.dataAccessVolume)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.triggerSecurityAlert({
                                type: 'unusual_data_access',
                                severity: 'medium',
                                message: "User ".concat(userId, " accessed ").concat(dataAccessCount, " data records in the last hour"),
                                metadata: { userId: userId, ipAddress: ipAddress, dataAccessCount: dataAccessCount },
                            })];
                    case 4:
                        _b.sent();
                        _b.label = 5;
    ...
    SecurityAuditFramework.prototype.alertConfigurationChange = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.triggerSecurityAlert({
                            type: 'configuration_change',
                            severity: 'medium',
                            message: "Configuration change: ".concat(event.action, " on ").concat(event.resource),
                            metadata: {
                                userId: event.userId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        console.warn("SECURITY ALERT [".concat(alert.severity.toUpperCase(), "]: ").concat(alert.message));
                        return [3 /*break*/, 4];
                    case 3:
                        error_6 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                        if (!(event.eventType === 'data_access' && event.outcome === 'failure')) return [3 /*break*/, 2];
                        if (!(event.resource.includes('patient') || event.resource.includes('personal'))) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.logComplianceViolation({
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(event.action === 'export' && !event.metadata.consentVerified)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.logComplianceViolation({
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        if (!(event.action === 'access' && event.metadata.dataAge > this.config.retentionPeriodDays)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.logComplianceViolation({
    ...
    SecurityAuditFramework.prototype.generateComplianceReport = function (period) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, lgpdMetrics, securityMetrics, _a, highRiskEvents, error, overallRiskScore, recommendations, error_9;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 5, , 6]);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        events = data || [];
                        return [2 /*return*/, {
                                dataAccessRequests: events.filter(function (e) { return e.action === 'data_access_request'; }).length,
                                dataExportRequests: events.filter(function (e) { return e.action === 'data_export'; }).length,
                                dataDeletionRequests: events.filter(function (e) { return e.action === 'data_deletion'; }).length,
                                consentUpdates: events.filter(function (e) { return e.action === 'consent_update'; }).length,
                                breachNotifications: events.filter(function (e) { return e.action === 'breach_notification'; }).length,
                            }];
                    case 3:
                        error_10 = _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        events = data || [];
                        return [2 /*return*/, {
                                failedLoginAttempts: events.filter(function (e) {
                                    return e.event_type === 'authentication' && e.outcome === 'failure';
                                }).length,
                                suspiciousActivities: events.filter(function (e) {
                                    return e.severity === 'high' || e.severity === 'critical';
                                }).length,
                                blockedRequests: events.filter(function (e) { return e.outcome === 'blocked'; }).length,
                                vulnerabilityScans: events.filter(function (e) { return e.event_type === 'security_scan'; }).length,
                            }];
                    case 3:
                        error_11 = _b.sent();
     ...
     */
    SecurityAuditFramework.prototype.calculateRiskScore = function (securityMetrics, highRiskEvents) {
        var score = 0;
     ...
     */
    SecurityAuditFramework.prototype.generateRecommendations = function (securityMetrics, highRiskEvents) {
        var recommendations = [];
     ...
     */
    SecurityAuditFramework.prototype.mapDatabaseEventToSecurityEvent = function (dbEvent) {
        return {
            id: dbEvent.event_id,
