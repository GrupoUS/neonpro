...
export function getLicenseRequiredPermissions(): Permission[] {
  return Object.values(HEALTHCARE_PERMISSIONS).filter((permission) => permission.requires_license);
}
...
export function getCFMCompliancePermissions(): Permission[] {
  return Object.values(HEALTHCARE_PERMISSIONS).filter((permission) => permission.cfm_compliance);
}
...
export function getLGPDSensitivePermissions(): Permission[] {
  return Object.values(HEALTHCARE_PERMISSIONS).filter((permission) => permission.lgpd_sensitive);
}
...
export function getANVISAControlledPermissions(): Permission[] {
  return Object.values(HEALTHCARE_PERMISSIONS).filter((permission) => permission.anvisa_controlled);
}
