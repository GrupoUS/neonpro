...
var SuspiciousActivityDetector = /** @class */ (() => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("user_activity_patterns").insert({
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            updatedBaseline = __assign(__assign({}, existingBaseline), {
              lastUpdated: new Date(),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (
              (options === null || options === void 0 ? void 0 : options.resolved) !== undefined
            ) {
   ...
   */
  SuspiciousActivityDetector.prototype.resolveAlert = function (
    alertId_1,
    resolution_1,
    resolvedBy_1,
  ) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (alertId, resolution, resolvedBy, falsePositive) {
        var error, error_6;
          ...
          case 1:
            ...
            for (_i = 0, alertData_1 = alertData; _i < alertData_1.length; _i++) {
              ...
              if (alert_2.is_resolved && alert_2.resolved_at) {
                resolutionTime =
                  new Date(alert_2.resolved_at).getTime() - new Date(alert_2.detected_at).getTime();
      ...
      return __generator(this, function (_d) {
        ...
        if (conditionResults.every((result) => result.met)) {
          alert_3 = {
            ...
            userId: userId,
            sessionId:
              ((_b = windowActivities[windowActivities.length - 1]) === null || _b === void 0
                ? void 0
                : _b.sessionId) || "",
            deviceId:
              ((_c = windowActivities[windowActivities.length - 1]) === null || _c === void 0
                ? void 0
                : _c.deviceId) || "",
  ...
  SuspiciousActivityDetector.prototype.evaluateCondition = function (
    condition,
    activities,
    baseline,
  ) {
  ...
  SuspiciousActivityDetector.prototype.calculateMaxDistance = function (activities) {
    ...
    for (var i = 1; i < activities.length; i++) {
      ...
      if (
        ((_a = prev.location) === null || _a === void 0 ? void 0 : _a.coordinates) &&
        ((_b = curr.location) === null || _b === void 0 ? void 0 : _b.coordinates)
      ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("suspicious_activity_alerts").insert({
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("user_behavior_baselines").upsert({
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            _c.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.from("user_behavior_baselines").select("*")];
          case 1:
