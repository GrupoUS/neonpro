...
var ConcurrentSessionManager = /** @class */ (function () {
    ...
    ConcurrentSessionManager.prototype.canCreateSession = function (userId, deviceId, userRole) {
        return __awaiter(this, void 0, void 0, function () {
            var concurrentConfig, existingSessions, conflict, deviceSessions, conflict, suspiciousLogin, conflict, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(existingSessions.length >= concurrentConfig.maxConcurrentSessions)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.createSessionConflict(userId, 'max_sessions_exceeded', existingSessions, { userId: userId, deviceId: deviceId })];
                    case 2:
                        conflict = _a.sent();
                        return [2 /*return*/, {
                                allowed: false,
                                reason: "Maximum concurrent sessions (".concat(concurrentConfig.maxConcurrentSessions, ") exceeded"),
                                conflictId: conflict.id,
                                existingSessions: existingSessions
                            }];
                    case 3:
                        deviceSessions = existingSessions.filter(function (s) { return s.deviceId === deviceId; });
                        if (!(deviceSessions.length > 0 && !concurrentConfig.allowMultipleDevices)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.createSessionConflict(userId, 'same_device_login', deviceSessions, { userId: userId, deviceId: deviceId })];
                    case 4:
                        conflict = _a.sent();
                        return [2 /*return*/, {
                                allowed: false,
                    ...
                    case 5: return [4 /*yield*/, this.detectSuspiciousLogin(userId, deviceId, existingSessions)];
                    case 6:
                        suspiciousLogin = _a.sent();
                        if (!suspiciousLogin) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.createSessionConflict(userId, 'suspicious_location', existingSessions, { userId: userId, deviceId: deviceId })];
                    case 7:
                        conflict = _a.sent();
                        return [2 /*return*/, {
                                allowed: false,
                    ...
                    case 8: return [2 /*return*/, { allowed: true }];
                    case 9:
                        error_1 = _a.sent();
     ...
     */
    ConcurrentSessionManager.prototype.handleSessionCreation = function (userId, deviceId, userRole, conflictId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, this.autoResolveConflict(concurrentConfig, existingSessions, { userId: userId, deviceId: deviceId })];
                    case 7:
                        resolution = _a.sent();
    ...
    ConcurrentSessionManager.prototype.resolveSessionConflict = function (conflict) {
        return __awaiter(this, void 0, void 0, function () {
            var resolution, terminatedSessions, newSessionId, transferId, _a, oldestSession, _i, _b, sessionId, error_3;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        switch (_a) {
                            case 'terminate_oldest': return [3 /*break*/, 1];
                            case 'terminate_newest': return [3 /*break*/, 6];
                            case 'terminate_specific': return [3 /*break*/, 7];
                            case 'allow_concurrent': return [3 /*break*/, 14];
                            case 'require_user_choice': return [3 /*break*/, 16];
                        }
                        return [3 /*break*/, 17];
                    case 1:
                        oldestSession = this.findOldestSession(conflict.existingSessions);
                        if (!oldestSession) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.terminateSession(oldestSession.id, 'Replaced by newer session')];
                    case 2:
                        _c.sent();
                        terminatedSessions.push(oldestSession.id);
                        return [4 /*yield*/, this.initiateSessionTransfer(oldestSession.id, conflict.newSession.userId, conflict.newSession.deviceId)];
                    case 3:
                        // Transfer session data if needed
                        transferId = _c.sent();
                        _c.label = 4;
                    case 4: return [4 /*yield*/, this.createNewSession(conflict.newSession.userId, conflict.newSession.deviceId)];
                    case 5:
                    ...
                    case 8:
                        ...
                        sessionId = _b[_i];
                        return [4 /*yield*/, this.terminateSession(sessionId, 'Terminated due to conflict resolution')];
                    case 9:
                        _c.sent();
                    ...
                    case 10:
                        _i++;
                        return [3 /*break*/, 8];
                    case 11: return [4 /*yield*/, this.createNewSession(conflict.newSession.userId, conflict.newSession.deviceId)];
                    case 12:
                        newSessionId = _c.sent();
                        _c.label = 13;
                    case 13: return [3 /*break*/, 17];
                    case 14: return [4 /*yield*/, this.createNewSession(conflict.newSession.userId, conflict.newSession.deviceId)];
                    case 15:
                        newSessionId = _c.sent();
                        return [3 /*break*/, 17];
                    case 16: 
                    ...
                    case 17:
                        ...
                        return [4 /*yield*/, this.notifySessionTerminations(conflict.userId, terminatedSessions)];
                    case 18:
                        _c.sent();
                        _c.label = 19;
     ...
     */
    ConcurrentSessionManager.prototype.autoResolveConflict = function (config, existingSessions, newSession) {
        return __awaiter(this, void 0, void 0, function () {
                    ...
                    case 0:
                        ...
                        switch (config.conflictResolution) {
                            ...
                            case 'device_priority':
                                sessionToTerminate = this.findLowestPrioritySession(existingSessions, config.devicePriorityOrder);
                                break;
                            default:
                                sessionToTerminate = this.findOldestSession(existingSessions);
                        }
                        if (!sessionToTerminate) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.terminateSession(sessionToTerminate.id, 'Replaced by auto-resolution')];
                    case 1:
                        _a.sent();
                        terminatedSessions.push(sessionToTerminate.id);
                        return [4 /*yield*/, this.initiateSessionTransfer(sessionToTerminate.id, newSession.userId, newSession.deviceId)];
                    case 2:
                        transferId = _a.sent();
     ...
     */
    ConcurrentSessionManager.prototype.initiateSessionTransfer = function (fromSessionId, userId, deviceId) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    ConcurrentSessionManager.prototype.createSessionConflict = function (userId, conflictType, existingSessions, newSession) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    ConcurrentSessionManager.prototype.detectSuspiciousLogin = function (userId, deviceId, existingSessions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                        recentSessions = existingSessions.filter(function (s) { return Date.now() - new Date(s.lastActivity).getTime() < 30 * 60 * 1000; } // Last 30 minutes
                        );
    ...
    ConcurrentSessionManager.prototype.findLowestPrioritySession = function (sessions, priorityOrder) {
        if (sessions.length === 0)
            return null;
    ...
    ConcurrentSessionManager.prototype.createNewSession = function (userId, deviceId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/session/create', {
                            method: 'POST',
                            headers: {
                    ...
                    case 3: throw new Error('Failed to create session');
                }
            });
        });
    };
    ConcurrentSessionManager.prototype.terminateSession = function (sessionId, reason) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/session/terminate', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
    ...
    ConcurrentSessionManager.prototype.getActiveConflicts = function (userId) {
        return Array.from(this.activeConflicts.values())
            .filter(function (conflict) { return conflict.userId === userId && !conflict.resolved; });
    };
    /**
     * Resolve conflict with user choice
     */
    ConcurrentSessionManager.prototype.resolveConflictWithUserChoice = function (conflictId, action, targetSessionIds) {
        return __awaiter(this, void 0, void 0, function () {
            var conflict, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ConcurrentSessionManager.prototype.cleanup = function () {
        ...
        for (var _c = 0, _d = this.sessionTransfers.entries(); _c < _d.length; _c++) {
            var _e = _d[_c], id = _e[0], transfer = _e[1];
