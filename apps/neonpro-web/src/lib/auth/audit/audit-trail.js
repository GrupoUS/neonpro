...
var AuditTrailManager = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _c.context = _d.sent(),
                            _c.result = eventData.result || { status: 'success' };
                        return [4 /*yield*/, this.buildMetadata()];
                    case 2:
                        event = (_c.metadata = _d.sent(),
    ...
    AuditTrailManager.prototype.buildContext = function (contextData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                context = {
                    sessionId: contextData === null || contextData === void 0 ? void 0 : contextData.sessionId,
                    requestId: (contextData === null || contextData === void 0 ? void 0 : contextData.requestId) || this.utils.generateSessionToken(),
                    transactionId: contextData === null || contextData === void 0 ? void 0 : contextData.transactionId,
                    workflowId: contextData === null || contextData === void 0 ? void 0 : contextData.workflowId,
                    applicationVersion: process.env.APP_VERSION || '1.0.0',
                    environment: process.env.NODE_ENV || 'development',
                    clientInfo: contextData === null || contextData === void 0 ? void 0 : contextData.clientInfo,
                    serverInfo: {
                    ...
                    networkInfo: contextData === null || contextData === void 0 ? void 0 : contextData.networkInfo
                };
    ...
    AuditTrailManager.prototype.startFlushTimer = function () {
        var _this = this;
        this.flushTimer = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            var error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(event.category === 'security' && event.severity === 'high')) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.sendAlert({
                                type: 'security_event',
                                event: event,
                    ...
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, this.complianceEngine.checkViolations(event)];
                    case 5:
                        violations = _a.sent();
                        ...
                        return [4 /*yield*/, this.sendAlert({
                                ...
                                message: "Compliance violation detected: ".concat(violations.map(function (v) { return v.requirement; }).join(', '))
                            })];
                    case 6:
                        _a.sent();
                        _a.label = 7;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch('/api/monitoring/alert', {
                                method: 'POST',
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        if (!(options === null || options === void 0 ? void 0 : options.includeInsights)) return [3 /*break*/, 4];
                    ...
                    case 5:
                        _d.insights = _a;
                        if (!(options === null || options === void 0 ? void 0 : options.includeRecommendations)) return [3 /*break*/, 7];
                    ...
                    case 8:
                        ...
                        if (!(options === null || options === void 0 ? void 0 : options.includeCompliance)) return [3 /*break*/, 10];
    ...
    AuditTrailManager.prototype.generateSummary = function (events) {
        var summary = {
            ...
            eventsBySeverity: {},
            eventsByStatus: {},
            uniqueActors: new Set(events.map(function (e) { return e.actor.id; })).size,
            uniqueTargets: new Set(events.map(function (e) { return e.target.id; })).size,
            timeRange: {
                start: Math.min.apply(Math, events.map(function (e) { return e.timestamp; })),
                end: Math.max.apply(Math, events.map(function (e) { return e.timestamp; }))
            }
        };
        // Count by type
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.logEvent({
                                ...
                                description: "Audit event integrity verification failed for event ".concat(event_2.id),
                    ...
                    case 8:
                        _i++;
                        return [3 /*break*/, 1];
                    case 9: return [2 /*return*/, verifiedEvents];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        decryptedEvents.push(__assign(__assign({}, event_3), { result: __assign(__assign({}, event_3.result), { status: 'error', message: 'Decryption failed' }) }));
                        return [3 /*break*/, 7];
                    case 7:
                        _i++;
                        return [3 /*break*/, 1];
                    case 8: return [2 /*return*/, decryptedEvents];
                }
            });
        });
    };
    ...
    AuditTrailManager.prototype.logSecurityIncident = function (type, description, severity, details) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.logEvent({
                        type: 'security_incident',
    ...
    AuditTrailManager.prototype.logDataAccess = function (userId, resource, action, success, details) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.logEvent({
                        type: 'data_access',
                        ...
                        action: action,
                        description: "User ".concat(success ? 'accessed' : 'attempted to access', " ").concat(resource),
                        actor: { type: 'user', id: userId },
    ...
    AuditTrailManager.prototype.logConfigurationChange = function (adminId, setting, oldValue, newValue, details) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                return [2 /*return*/, this.logEvent({
                        ...
                        result: { status: 'success' },
                        details: __assign({ operation: 'update_configuration', previousValues: (_a = {}, _a[setting] = oldValue, _a), newValues: (_b = {}, _b[setting] = newValue, _b), changes: [{ field: setting, oldValue: oldValue, newValue: newValue, changeType: 'update' }] }, details)
                    })];
            });
        });
    };
