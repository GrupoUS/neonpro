...
var ClerkSessionManager = /** @class */ (function () {
    function ClerkSessionManager(options) {
        ...
        this.options = {
            ...
            enforceConcurrentLimits: (_b = options.enforceConcurrentLimits) !== null && _b !== void 0 ? _b : true
        };
    }
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        sessionData = {
                            ...
                            roles: ((_b = user === null || user === void 0 ? void 0 : user.publicMetadata) === null || _b === void 0 ? void 0 : _b.roles) || [],
                            permissions: ((_c = user === null || user === void 0 ? void 0 : user.publicMetadata) === null || _c === void 0 ? void 0 : _c.permissions) || []
                        };
    ...
    ClerkSessionManager.prototype.getUserActiveSessions = function (userId) {
        ...
        return Array.from(this.sessionStore.values())
            ...
            return session.userId === userId &&
                _this.isSessionValid(session.sessionId);
        });
    };
    /**
    ...
    ClerkSessionManager.prototype.enforceConcurrentSessionLimits = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (!this.options.enforceConcurrentLimits)
                ...
                if (activeSessions.length > clerk_config_1.clerkConfig.maxConcurrentSessions) {
                    ...
                    sessionsToRemove = sortedSessions
                        .slice(0, activeSessions.length - clerk_config_1.clerkConfig.maxConcurrentSessions);
    ...
    ClerkSessionManager.prototype.getSessionStats = function () {
        var _this = this;
        var now = Date.now();
        var activeSessions = Array.from(this.sessionStore.values())
            .filter(function (session) { return _this.isSessionValid(session.sessionId); });
        return {
            totalSessions: this.sessionStore.size,
            activeSessions: activeSessions.length,
            expiredSessions: this.sessionStore.size - activeSessions.length,
            uniqueUsers: new Set(activeSessions.map(function (s) { return s.userId; })).size,
            lastCleanup: now
        };
    };
    /**
    ...
    ClerkSessionManager.prototype.hasPermission = function (sessionId, permission) {
        ...
        if (!session || !this.isSessionValid(sessionId))
            return false;
        return ((_a = session.permissions) === null || _a === void 0 ? void 0 : _a.includes(permission)) || false;
    };
    /**
     * Check user roles
     */
