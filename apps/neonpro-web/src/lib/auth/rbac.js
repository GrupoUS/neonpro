...
exports.HealthcareRBACEngine =
  exports.HEALTHCARE_ROLE_DEFINITIONS =
  exports.PermissionCheckResultSchema =
  exports.RoleDefinitionSchema =
  exports.UserRoleContextSchema =
    void 0;
...
exports.UserRoleContextSchema = zod_1.z.object({
  ...
  additional_specialties: zod_1.z
    .array(zod_1.z.nativeEnum(permissions_1.MedicalSpecialty))
    .default([]),
...
var HealthcareRBACEngine = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (
              !(
                (context === null || context === void 0 ? void 0 : context.emergencyOverride) &&
                roleDefinition.emergency_override_capable
              )
            )
              return [3 /*break*/, 3];
            result_1 = this.createPermissionResult(
              true,
              permission,
              userId,
              userContext.role,
          ...
          case 5:
            ...
            result = this.createPermissionResult(
              true,
              permission,
              userId,
              userContext.role,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            userContext = _b.sent();
            if (!userContext) return [2 /*return*/, []];
            roleDefinition = exports.HEALTHCARE_ROLE_DEFINITIONS[userContext.role];
            if (!roleDefinition) return [2 /*return*/, []];
   ...
   */
  HealthcareRBACEngine.prototype.grantTemporaryAccess = function (
    userId,
    grantedBy,
    permissions,
    expiresAt,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!granterContext) return [2 /*return*/, false];
            granterRole = exports.HEALTHCARE_ROLE_DEFINITIONS[granterContext.role];
            if (!granterRole.can_approve_emergency_access) return [2 /*return*/, false];
            if (!this.supabase) return [3 /*break*/, 3];
            return [
              4 /*yield*/,
              this.supabase.from("temporary_access").insert({
                user_id: userId,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!revokerContext) return [2 /*return*/, false];
            revokerRole = exports.HEALTHCARE_ROLE_DEFINITIONS[revokerContext.role];
            if (!revokerRole.can_approve_emergency_access) return [2 /*return*/, false];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            if (!this.supabase) return [2 /*return*/, null];
            return [
              4 /*yield*/,
              this.supabase
                .from("user_roles")
  ...
  HealthcareRBACEngine.prototype.validateHealthcareRequirements = function (
    userContext,
    permission,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  HealthcareRBACEngine.prototype.checkSpecialtyRequirement = function (userContext, permission) {
    ...
    if (!userContext.medical_specialty && userContext.additional_specialties.length === 0)
      return false;
    var userSpecialties = __spreadArray(
      __spreadArray([], userContext.medical_specialty ? [userContext.medical_specialty] : [], true),
        ...
        switch (_a.label) {
          case 0:
            ...
            if (
              ...
              context.clinicId !== userContext.clinic_id
            ) {
              roleDefinition = exports.HEALTHCARE_ROLE_DEFINITIONS[userContext.role];
              if (!roleDefinition.multi_clinic_access) {
                return [
                  2 /*return*/,
                  { valid: false, reason: "Cross-clinic access not authorized" },
                ];
              }
            }
            if (
              !(
                (context === null || context === void 0 ? void 0 : context.patientId) &&
            ...
            return [
              4 /*yield*/,
              this.checkPatientRelationship(userContext.user_id, context.patientId),
            ];
          case 1:
            ...
            if (!hasPatientRelationship) {
              return [
                2 /*return*/,
                { valid: false, reason: "No authorized relationship with patient" },
              ];
            }
            _a.label = 2;
          case 2:
            return [2 /*return*/, { valid: true, reason: "Context validated" }];
        }
      });
    });
  };
  HealthcareRBACEngine.prototype.checkPatientRelationship = function (userId, patientId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            if (!this.supabase) return [2 /*return*/, false];
            return [
              4 /*yield*/,
              this.supabase
  ...
  HealthcareRBACEngine.prototype.logAuditTrail = function (result, context) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!this.supabase) return [2 /*return*/];
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
            return [
...
function canDelegate(fromRole, toRole) {
  ...
  return (
    (fromRoleDef === null || fromRoleDef === void 0
      ? void 0
      : fromRoleDef.can_delegate_to.includes(toRole)) || false
  );
}
/**
