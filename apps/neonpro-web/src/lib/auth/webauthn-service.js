...
var WebAuthnService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        excludeCredentials = (existingCredentials === null || existingCredentials === void 0 ? void 0 : existingCredentials.map(function (cred) { return ({
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.storeChallenge(options.userId, registrationOptions.challenge, 'registration')];
                    case 4:
                        // Store challenge temporarily (in production, use Redis or secure session storage)
                        _a.sent();
                        // Log analytics
                        return [4 /*yield*/, (0, analytics_1.logAnalyticsEvent)('webauthn_registration_started', {
                                userId: options.userId,
    ...
    WebAuthnService.prototype.verifyRegistrationResponse = function (userId, response, deviceName) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, performance_tracker_1.trackMFAVerification)(function () { return __awaiter(_this, void 0, void 0, function () {
                        var supabase, challenge, verification, _a, credentialID, credentialPublicKey, counter, credentialDeviceType, credentialBackedUp, error;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 3:
                                    ...
                                    if (!(!verification.verified || !verification.registrationInfo)) return [3 /*break*/, 5];
                                    return [4 /*yield*/, (0, analytics_1.logAnalyticsEvent)('webauthn_registration_failed', {
                                            userId: userId,
                                ...
                                case 5:
                                    _a = verification.registrationInfo, credentialID = _a.credentialID, credentialPublicKey = _a.credentialPublicKey, counter = _a.counter, credentialDeviceType = _a.credentialDeviceType, credentialBackedUp = _a.credentialBackedUp;
                                    return [4 /*yield*/, supabase
                                            .from('webauthn_credentials')
                                            .insert({
                                            user_id: userId,
                                ...
                                case 6:
                                    error = (_b.sent()).error;
                                    if (error) {
                                        throw new Error("Failed to store WebAuthn credential: ".concat(error.message));
                                    }
                                    // Clean up challenge
                                ...
                                case 7:
                                    // Clean up challenge
                                    _b.sent();
                                    return [4 /*yield*/, (0, analytics_1.logAnalyticsEvent)('webauthn_registration_success', {
                                            userId: userId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        allowCredentials = credentials === null || credentials === void 0 ? void 0 : credentials.map(function (cred) { return ({
                            id: cred.credential_id,
                            type: 'public-key',
                            transports: cred.transports,
                        }); });
                        _a.label = 3;
                    case 3: return [4 /*yield*/, (0, server_1.generateAuthenticationOptions)({
                            timeout: 60000,
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.storeChallenge(challengeKey, authenticationOptions.challenge, 'authentication')];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, (0, analytics_1.logAnalyticsEvent)('webauthn_authentication_started', {
                                userId: options.userId,
                                hasAllowCredentials: !!(allowCredentials === null || allowCredentials === void 0 ? void 0 : allowCredentials.length),
                                timestamp: new Date().toISOString(),
                            })];
                    case 6:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, performance_tracker_1.trackMFAVerification)(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 4:
                                    ...
                                    return [4 /*yield*/, (0, analytics_1.logAnalyticsEvent)('webauthn_authentication_failed', {
                                ...
                                case 8:
                                    // Clean up challenge
                                    _a.sent();
                                    return [4 /*yield*/, (0, analytics_1.logAnalyticsEvent)('webauthn_authentication_success', {
                                            userId: credential.user_id,
                                            credentialId: credential.credential_id,
                        ...
                        userId: userId || (credential === null || credential === void 0 ? void 0 : credential.user_id),
                        method: 'webauthn',
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, analytics_1.logAnalyticsEvent)('webauthn_credential_removed', {
                                userId: userId,
