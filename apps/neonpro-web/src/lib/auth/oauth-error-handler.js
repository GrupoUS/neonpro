...
var OAuthErrorHandler = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        // Handle specific error recovery
                        _a.sent();
                        performance_tracker_1.performanceTracker.recordMetric('oauth_error_handling', Date.now() - startTime);
    ...
    OAuthErrorHandler.prototype.classifyError = function (error, context) {
        var errorMessage = (error === null || error === void 0 ? void 0 : error.message) || (error === null || error === void 0 ? void 0 : error.error_description) || 'Unknown error';
        var errorCode = (error === null || error === void 0 ? void 0 : error.error) || (error === null || error === void 0 ? void 0 : error.code) || 'unknown_error';
    ...
    OAuthErrorHandler.prototype.isNetworkError = function (error) {
        ...
        var errorCode = ((_b = error === null || error === void 0 ? void 0 : error.code) === null || _b === void 0 ? void 0 : _b.toUpperCase()) || '';
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'redirect': return [3 /*break*/, 3];
                            case 'manual': return [3 /*break*/, 5];
                            case 'contact_support': return [3 /*break*/, 6];
                        }
                        return [3 /*break*/, 8];
                    case 1: return [4 /*yield*/, this.handleRetryAction(errorDetails, context)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 3: return [4 /*yield*/, this.handleRedirectAction(errorDetails, context)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 5: 
                    ...
                    return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.handleSupportAction(errorDetails, context)];
                    case 7:
                        _b.sent();
                        return [3 /*break*/, 8];
    ...
    OAuthErrorHandler.prototype.handleRetryAction = function (errorDetails, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        retryKey = "".concat(context.provider, "_").concat(context.operation, "_").concat(context.sessionId || 'anonymous');
                        ...
                        setTimeout(function () {
                            ...
                            if (typeof window !== 'undefined') {
                                window.dispatchEvent(new CustomEvent('oauth-retry', {
                                    detail: { errorDetails: errorDetails, context: context, attempt: currentRetries + 1 }
                                }));
                            }
                        }, delay);
                        return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, SessionManager_1.sessionManager.terminateSession(context.sessionId, 'error_recovery_redirect')];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    OAuthErrorHandler.prototype.trackErrorMetrics = function (errorCode, context) {
        ...
        performance_tracker_1.performanceTracker.recordMetric("oauth_error_".concat(context.provider), 1);
        performance_tracker_1.performanceTracker.recordMetric("oauth_error_".concat(context.operation), 1);
    };
    /**
     * Log error details
     */
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        criticalLogEntry = __assign(__assign({}, errorDetails), { context: context, requires_immediate_attention: true, escalation_level: 'critical', timestamp: new Date().toISOString() });
    ...
    OAuthErrorHandler.prototype.clearRetryAttempts = function (provider, operation, sessionId) {
        var retryKey = "".concat(provider, "_").concat(operation, "_").concat(sessionId || 'anonymous');
