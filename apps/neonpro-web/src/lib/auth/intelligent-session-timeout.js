...
var IntelligentSessionTimeout = /** @class */ (function () {
     ...
     */
    IntelligentSessionTimeout.prototype.initializeSessionTimeout = function (sessionId, userId, userRole, customConfig) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.logSessionEvent(sessionId, 'timeout_initialized', {
                                config: config,
     ...
     */
    IntelligentSessionTimeout.prototype.recordActivity = function (sessionId, activityType, metadata) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // Record activity
                        return [4 /*yield*/, this.storeActivity(sessionId, session.user_id, activityType, metadata)];
                    case 2:
                        // Record activity
                        _a.sent();
    ...
    IntelligentSessionTimeout.prototype.extendSession = function (sessionId, extensionMinutes) {
        return __awaiter(this, void 0, void 0, function () {
            var session, config, currentDuration, newDuration, maxDuration, remainingMinutes, newExpiresAt, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 2:
                        ...
                        // Log extension
                        return [4 /*yield*/, this.logSessionEvent(sessionId, 'session_extended', {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // Log warning
                        return [4 /*yield*/, this.logSessionEvent(sessionId, 'timeout_warning', {
                                warningType: warningType,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        _a.sent();
                        // Log session expiry
                        return [4 /*yield*/, this.logSessionEvent(sessionId, 'session_expired', {
    ...
    IntelligentSessionTimeout.prototype.getSessionAnalytics = function (sessionId) {
        return __awaiter(this, void 0, void 0, function () {
            var activities, events, session, totalDuration, extensionCount, warningCount, activityPattern, lastActivity, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 3:
                        ...
                        extensionCount = events.filter(function (e) { return e.event_type === 'session_extended'; }).length;
                        warningCount = events.filter(function (e) { return e.event_type === 'timeout_warning'; }).length;
    ...
    IntelligentSessionTimeout.prototype.setupWarningTimers = function (sessionId, config, customTimeoutMinutes) {
        var _this = this;
        ...
        config.warningThresholds.forEach(function (warningMinutes) {
            if (warningMinutes < timeoutMinutes) {
                ...
                var timer = setTimeout(function () {
                    var warningType = warningMinutes === 1 ? 'final' :
    ...
    IntelligentSessionTimeout.prototype.clearSessionTimers = function (sessionId) {
        ...
        if (warningTimers) {
            warningTimers.forEach(function (timer) { return clearTimeout(timer); });
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        promises = activeSessions.map(function (sessionId) {
                            return _this.recordActivity(sessionId, 'page_navigation', { global: true, type: activityType });
                        });
                        return [4 /*yield*/, Promise.all(promises)];
                    case 1:
                        _a.sent();
    ...
    IntelligentSessionTimeout.prototype.storeActivity = function (sessionId, userId, activityType, metadata) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.supabase
    ...
    IntelligentSessionTimeout.prototype.emitSessionExpiredEvent = function (sessionId, dataPreserved) {
        if (typeof window !== 'undefined') {
    ...
    IntelligentSessionTimeout.prototype.cleanup = function () {
        var _this = this;
        // Clear all timers
        this.activeTimers.forEach(function (timer) { return clearTimeout(timer); });
        this.warningTimers.forEach(function (timers) { return timers.forEach(function (timer) { return clearTimeout(timer); }); });
