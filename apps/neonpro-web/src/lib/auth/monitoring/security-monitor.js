...
var SecurityMonitor = /** @class */ (function () {
    function SecurityMonitor() {
        this.suspiciousActivityDetector = (0, suspicious_activity_detector_1.getSuspiciousActivityDetector)();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        console.log("Security threat detected: ".concat(threat.type, " (Risk: ").concat(threat.riskScore, ")"));
                        return [3 /*break*/, 8];
                    case 7:
                        error_3 = _a.sent();
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, action.delay); })];
                                    case 1:
                                        _c.sent();
                                        _c.label = 2;
                                    case 2:
                                        ...
                                        return [4 /*yield*/, this_1.executeMitigationAction(action.type, action.parameters, threat)];
                                    case 3:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = type;
                        switch (_a) {
                            case 'block_ip': return [3 /*break*/, 1];
                            case 'suspend_session': return [3 /*break*/, 3];
                            case 'require_mfa': return [3 /*break*/, 5];
                            case 'rate_limit': return [3 /*break*/, 7];
                            case 'quarantine_user': return [3 /*break*/, 9];
                            case 'alert_admin': return [3 /*break*/, 11];
                            case 'log_incident': return [3 /*break*/, 13];
                            case 'backup_data': return [3 /*break*/, 15];
                            case 'isolate_system': return [3 /*break*/, 17];
                            case 'force_logout': return [3 /*break*/, 19];
                        }
                        return [3 /*break*/, 21];
                    case 1: return [4 /*yield*/, this.blockIpAddress(threat, parameters)];
                    case 2:
                        _b.sent();
                        action.result = 'success';
                        return [3 /*break*/, 22];
                    case 3: return [4 /*yield*/, this.suspendSession(threat.target.details.sessionId, "Security threat: ".concat(threat.type))];
                    case 4:
                        _b.sent();
                        action.result = 'success';
                        return [3 /*break*/, 22];
                    case 5: return [4 /*yield*/, this.requireMfa(threat.target.details.sessionId)];
                    case 6:
                        _b.sent();
                        action.result = 'success';
                        return [3 /*break*/, 22];
                    case 7: return [4 /*yield*/, this.applyRateLimit(threat, parameters)];
                    case 8:
                        _b.sent();
                        action.result = 'success';
                        return [3 /*break*/, 22];
                    case 9: return [4 /*yield*/, this.quarantineUser(threat.target.id)];
                    case 10:
                        _b.sent();
                        action.result = 'success';
                        return [3 /*break*/, 22];
                    case 11: return [4 /*yield*/, this.alertAdministrators(threat, parameters)];
                    case 12:
                        _b.sent();
                        action.result = 'success';
                        return [3 /*break*/, 22];
                    case 13: return [4 /*yield*/, this.logIncident(threat, parameters)];
                    case 14:
                        _b.sent();
                        action.result = 'success';
                        return [3 /*break*/, 22];
                    case 15: return [4 /*yield*/, this.backupUserData(threat.target.id)];
                    case 16:
                        _b.sent();
                        action.result = 'success';
                        return [3 /*break*/, 22];
                    case 17: return [4 /*yield*/, this.isolateSystem(threat)];
                    case 18:
                        _b.sent();
                        action.result = 'success';
                        return [3 /*break*/, 22];
                    case 19: return [4 /*yield*/, this.forceLogout(threat.target.id)];
                    case 20:
                        _b.sent();
                        action.result = 'success';
                        return [3 /*break*/, 22];
                    case 21:
                        ...
                        _b.label = 22;
                    case 22: return [2 /*return*/, action];
                    case 23:
                        error_5 = _b.sent();
    ...
    SecurityMonitor.prototype.blockIpAddress = function (threat, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ipIndicator = threat.indicators.find(function (i) { return i.type === 'ip_address'; });
    ...
    SecurityMonitor.prototype.requireMfa = function (sessionId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/session/require-mfa', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
    ...
    SecurityMonitor.prototype.applyRateLimit = function (threat, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/security/rate-limit', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
    ...
    SecurityMonitor.prototype.quarantineUser = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/users/quarantine', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
    ...
    SecurityMonitor.prototype.alertAdministrators = function (threat, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/security/alert-admins', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                threatId: threat.id,
    ...
    SecurityMonitor.prototype.logIncident = function (threat, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/security/incidents', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                threatId: threat.id,
    ...
    SecurityMonitor.prototype.backupUserData = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/users/backup', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({ userId: userId })
                        })];
    ...
    SecurityMonitor.prototype.forceLogout = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/users/force-logout', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({ userId: userId })
                        })];
    ...
    SecurityMonitor.prototype.findApplicableRules = function (threat) {
        return Array.from(this.monitoringRules.values())
            .filter(function (rule) { return rule.enabled && rule.threatType === threat.type; })
    ...
    SecurityMonitor.prototype.updateSecurityMetrics = function () {
        ...
        this.securityMetrics = {
            ...
            activeThreats: activeThreats.filter(function (t) { return t.status === 'active'; }).length,
            resolvedThreats: activeThreats.filter(function (t) { return t.status === 'resolved'; }).length,
            falsePositives: activeThreats.filter(function (t) { return t.falsePositive; }).length,
    ...
    SecurityMonitor.prototype.calculateAverageResponseTime = function (threats) {
        var resolvedThreats = threats.filter(function (t) { return t.resolvedAt; });
    ...
    SecurityMonitor.prototype.calculateMitigationSuccess = function (threats) {
        var threatsWithActions = threats.filter(function (t) { return t.mitigationActions.length > 0; });
        if (threatsWithActions.length === 0)
            return 0;
        var successfulActions = threatsWithActions.reduce(function (sum, t) {
            return sum + t.mitigationActions.filter(function (a) { return a.result === 'success'; }).length;
        }, 0);
        var totalActions = threatsWithActions.reduce(function (sum, t) { return sum + t.mitigationActions.length; }, 0);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fetch('/api/security/alerts', {
                                method: 'POST',
                                headers: { 'Content-Type': 'application/json' },
    ...
    SecurityMonitor.prototype.getActiveThreats = function () {
        return Array.from(this.activeThreats.values())
            .filter(function (threat) { return threat.status === 'active'; });
    };
    ...
    SecurityMonitor.prototype.cleanup = function () {
        ...
        for (var _i = 0, _a = this.activeThreats.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], id = _b[0], threat = _b[1];
