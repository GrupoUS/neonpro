...
var SessionConfig = /** @class */ (function () {
    ...
    SessionConfig.getEnvironmentConfig = function () {
        ...
        return __assign(__assign({}, (isDevelopment && {
            COOKIE_SECURE: false,
            LOG_LEVEL: 'debug',
    ...
    SessionConfig.validateConfig = function () {
        try {
            ...
            for (var _a = 0, _b = Object.entries(this.DEFAULT_POLICIES); _a < _b.length; _a++) {
                var _c = _b[_a], name_1 = _c[0], policy = _c[1];
    ...
    SessionConfig.validatePolicy = function (policy) {
        return (policy.max_session_duration > 0 &&
    ...
    SessionConfig.getConfig = function (environment) {
        ...
        return __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, this.DEFAULT_POLICIES), this.SECURITY_THRESHOLDS), this.CLEANUP_INTERVALS), this.COOKIE_CONFIG), this.RATE_LIMITS), this.ENCRYPTION), this.DATABASE), this.MONITORING), this.FEATURES), this.API_ENDPOINTS), this.getEnvironmentConfig()), { ENVIRONMENT: env });
    };
