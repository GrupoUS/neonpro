...
exports.UnifiedSessionSystem = exports.createsessionManager = exports.SessionManager = exports.SecurityLevel = exports.DeviceType = exports.SessionAction = void 0;
var client_1 = require("@/lib/supabase/client");
var session_1 = require("@/types/session");
// Re-export types that are needed elsewhere
var session_2 = require("@/types/session");
Object.defineProperty(exports, "SessionAction", { enumerable: true, get: function () { return session_2.SessionAction; } });
Object.defineProperty(exports, "DeviceType", { enumerable: true, get: function () { return session_2.DeviceType; } });
Object.defineProperty(exports, "SecurityLevel", { enumerable: true, get: function () { return session_2.SecurityLevel; } });
...
var SessionManager = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.logSessionAction(session.id, request.user_id, SessionAction.LOGIN, {
                                device_fingerprint: request.device_fingerprint,
                                ip_address: request.ip_address,
                                security_score: securityScore
                            })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                        updateData = __assign(__assign({}, updates), { last_activity: new Date().toISOString() });
                        return [4 /*yield*/, this.supabase
                                .from('user_sessions')
                                .update(updateData)
                                .eq('id', sessionId)
                    ...
                    case 4:
                        error_2 = _b.sent();
                        logger_1.logger.error('Failed to update session', { error: error_2, sessionId: sessionId, updates: updates });
                        throw error_2;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.logSessionAction(sessionId, session.user_id, SessionAction.LOGOUT, {
                                reason: reason,
                    ...
                    case 4:
                        error_3 = _a.sent();
                        logger_1.logger.error('Failed to terminate session', { error: error_3, sessionId: sessionId, reason: reason });
                        throw error_3;
                    case 5: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8:
                        _a.sent();
                        return [4 /*yield*/, this.createSecurityEvent(session, session_1.SecurityEventType.SESSION_HIJACK_ATTEMPT, session_1.SecuritySeverity.CRITICAL)];
                    case 9:
                        _a.sent();
                        _a.label = 10;
                    ...
                    case 11:
                        error_4 = _a.sent();
                        logger_1.logger.error('Security monitoring failed', { error: error_4, session_id: session.id });
                        return [3 /*break*/, 12];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, this.getDeviceRegistration(request.user_id, request.device_fingerprint)];
                    case 2:
                        device = _a.sent();
                        if (!(device === null || device === void 0 ? void 0 : device.trusted))
                            score -= 20;
                    ...
                    case 5:
                        error_5 = _a.sent();
                        logger_1.logger.error('Security score calculation failed', { error: error_5, request: request });
    ...
    SessionManager.prototype.createSecurityEvent = function (session_3, eventType_1) {
        return __awaiter(this, arguments, void 0, function (session, eventType, severity) {
            ...
            if (severity === void 0) { severity = session_1.SecuritySeverity.MEDIUM; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        error_6 = _a.sent();
                        logger_1.logger.error('Failed to create security event', { error: error_6, eventType: eventType, session: session });
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        _a.sent();
                        _a.label = 5;
                    case 5: return [2 /*return*/, device];
                    case 6:
                        error_7 = _a.sent();
                        logger_1.logger.error('Device validation failed', { error: error_7, userId: userId, deviceFingerprint: deviceFingerprint });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        logger_1.logger.info('New device registered', { device_id: device.id, user_id: userId });
                        return [2 /*return*/, device];
                    case 2:
                        error_8 = _b.sent();
                        logger_1.logger.error('Device registration failed', { error: error_8, userId: userId, deviceFingerprint: deviceFingerprint });
                        throw error_8;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_10 = _a.sent();
                        logger_1.logger.error('Failed to update device last seen', { error: error_10, deviceId: deviceId });
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.terminateSession(oldestSession.id, 'concurrent_limit_exceeded')];
                    case 3:
                        _a.sent();
                    ...
                    case 5:
                        error_11 = _a.sent();
                        logger_1.logger.error('Failed to enforce concurrent session limits', { error: error_11, userId: userId });
                        return [3 /*break*/, 6];
                    case 6: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_12 = _a.sent();
                        logger_1.logger.error('Failed to get session policy', { error: error_12, userId: userId });
                        throw error_12;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_13 = _a.sent();
                        logger_1.logger.error('Failed to calculate expiry time', { error: error_13, userId: userId });
                        expiryTime = new Date();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        error_14 = _b.sent();
                        logger_1.logger.error('Failed to get active sessions', { error: error_14, userId: userId });
                        return [2 /*return*/, []];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    SessionManager.prototype.getActiveSessionCount = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getActiveSessions(userId)];
                    case 1:
                        sessions = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        recentIPs = recentSessions.map(function (s) { return s.ip_address; });
                        return [2 /*return*/, !recentIPs.includes(ipAddress)];
                    case 2:
                        error_15 = _a.sent();
                        logger_1.logger.error('Failed to check unusual location', { error: error_15, userId: userId, ipAddress: ipAddress });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_16 = _a.sent();
                        logger_1.logger.error('Failed to check new device', { error: error_16, userId: userId, deviceFingerprint: deviceFingerprint });
                        return [2 /*return*/, false];
                    case 3: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        return [2 /*return*/, ((recentLogins === null || recentLogins === void 0 ? void 0 : recentLogins.length) || 0) > this.securityThresholds.suspicious_login_attempts];
                    case 2:
                        error_17 = _b.sent();
                        logger_1.logger.error('Failed to check rapid login attempts', { error: error_17, userId: userId });
                        return [2 /*return*/, false];
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        logger_1.logger.info('Session extended', { session_id: sessionId, new_expiry: newExpiryTime });
                        _a.label = 4;
                    case 4: return [3 /*break*/, 6];
                    case 5:
                        error_18 = _a.sent();
                        logger_1.logger.error('Failed to extend session', { error: error_18, sessionId: sessionId });
                        return [3 /*break*/, 6];
                    case 6: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_19 = _a.sent();
                        logger_1.logger.error('Failed to log session action', { error: error_19, sessionId: sessionId, action: action });
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
