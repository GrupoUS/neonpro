        ...
        switch (_g.label) {
          ...
          case 14:
            ...
            if (action.required && actionResult.status === "failure") {
              throw new Error(
                "Required action '".concat(action.id, "' failed: ").concat(actionResult.error),
              );
            }
            _g.label = 15;
          case 15:
          ...
          case 17:
            ...
            return [
              ...
              this.auditLogger.logEvent({
                ...
                description: "Cleanup task '".concat(
                  task.name,
            ...
            return [
              ...
              this.auditLogger.logEvent({
                ...
                description: "Cleanup task '"
                  .concat(task.name, "' execution failed: ")
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            batchSize =
              (options === null || options === void 0 ? void 0 : options.batchSize) ||
              target.batchSize;
  ...
  DataCleanupManager.prototype.getTargetItems = function (target, task) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        ...
        console.log(
          "Getting items for target ".concat(target.type, " from ").concat(target.source.type),
        );
        return [2 /*return*/, []];
      });
    });
            ...
            return [
              ...
              this.auditLogger.logEvent({
                ...
                description: "Cleanup action '"
                  .concat(action.type, "' executed for task '")
                  .concat(task.name, "'"),
                actor: { type: "system", id: "cleanup_manager" },
                target: { type: "system", id: task.id },
              }),
  ...
  DataCleanupManager.prototype.updateTaskStatistics = function (task, result) {
    ...
    if (result.status === "success") {
      ...
      task.statistics.lastError =
        (_a = result.errors[0]) === null || _a === void 0 ? void 0 : _a.message;
    }
