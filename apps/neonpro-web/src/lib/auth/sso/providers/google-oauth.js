      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("".concat(this.revokeUrl, "?token=").concat(encodeURIComponent(token)), {
                method: "POST",
                headers: {
                  "Content-Type": "application/x-www-form-urlencoded",
                },
          ...
          case 4:
            error_4 = _a.sent();
            logger_1.logger.error("Google OAuth: Token revocation error", {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("https://oauth2.googleapis.com/tokeninfo?id_token=".concat(idToken)),
            ];
          case 1:
            response = _a.sent();
            if (!response.ok) {
          ...
          case 3:
            error_5 = _a.sent();
            logger_1.logger.error("Google OAuth: ID token validation error", {
...
exports.DEFAULT_GOOGLE_SCOPES = ["openid", "email", "profile"];
exports.GOOGLE_WORKSPACE_SCOPES = __spreadArray(
  __spreadArray([], exports.DEFAULT_GOOGLE_SCOPES, true),
  [
