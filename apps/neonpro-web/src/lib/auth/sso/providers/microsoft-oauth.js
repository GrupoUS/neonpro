...
exports.MICROSOFT_GRAPH_SCOPES =
  exports.AZURE_AD_SCOPES =
...
var MicrosoftOAuthProvider = /** @class */ (() => {
          ...
          case 0:
            ...
            return [
              ...
              fetch(
                "".concat(
                  this.graphUrl,
                  "/me?$select=id,displayName,givenName,surname,userPrincipalName,mail,mobilePhone,officeLocation,preferredLanguage,jobTitle,businessPhones,onPremisesSamAccountName,onPremisesUserPrincipalName,employeeId,department,companyName,usageLocation",
                ),
                {
                  headers: {
                    Authorization: "Bearer ".concat(accessToken),
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("".concat(this.graphUrl, "/organization"), {
                headers: {
                  Authorization: "Bearer ".concat(accessToken),
                  Accept: "application/json",
                },
          ...
          case 4:
            ...
            logger_1.logger.info("Microsoft OAuth: Organization info retrieved", {
              organizationCount:
                ((_a = orgData.value) === null || _a === void 0 ? void 0 : _a.length) || 0,
              tenant: this.config.tenant,
            });
            return [
              2 /*return*/,
              ((_b = orgData.value) === null || _b === void 0 ? void 0 : _b[0]) || null,
            ];
          case 5:
            error_5 = _c.sent();
  ...
  MicrosoftOAuthProvider.prototype.generateLogoutUrl = function (postLogoutRedirectUri) {
    ...
    var fullLogoutUrl = params.toString()
      ? "".concat(logoutUrl, "?").concat(params.toString())
      : logoutUrl;
  ...
  MicrosoftOAuthProvider.prototype.getProviderConfig = function () {
    var _a = this.getTenantUrls(),
      authUrl = _a.authUrl,
      tokenUrl = _a.tokenUrl;
    return {
      id: "microsoft",
      name: "Microsoft",
      type: "oauth2",
...
exports.DEFAULT_MICROSOFT_SCOPES = ["openid", "profile", "email", "User.Read"];
exports.AZURE_AD_SCOPES = __spreadArray(
  __spreadArray([], exports.DEFAULT_MICROSOFT_SCOPES, true),
  ["Directory.Read.All", "Group.Read.All", "Organization.Read.All"],
  false,
);
exports.MICROSOFT_GRAPH_SCOPES = __spreadArray(
  __spreadArray([], exports.DEFAULT_MICROSOFT_SCOPES, true),
  ["Calendars.Read", "Files.Read", "Mail.Read", "People.Read"],
  false,
);
