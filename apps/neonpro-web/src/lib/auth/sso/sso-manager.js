...
var SSOManager = /** @class */ (() => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!provider) {
              throw this.createError(
                "PROVIDER_NOT_FOUND",
                "Provider ".concat(providerId, " not found"),
              );
            }
            if (!provider.enabled) {
              throw this.createError(
                "PROVIDER_DISABLED",
                "Provider ".concat(providerId, " is disabled"),
              );
            }
            state = options.state || this.generateSecureToken();
            nonce = options.nonce || this.generateSecureToken();
            authRequest = __assign(
              {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              "".concat(provider.config.authUrl, "?").concat(params.toString()),
            ];
        }
      });
    });
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.exchangeCodeForTokens(provider, response.code, authRequest.redirectUri),
            ];
          case 5:
          ...
          case 7:
            ...
            return [
              ...
              this.createSSOSession({
                ...
                scope:
                  ((_a = tokenResponse.scope) === null || _a === void 0 ? void 0 : _a.split(" ")) ||
                  authRequest.scopes,
                userInfo: userInfo,
              }),
            ];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch(provider.config.tokenUrl, {
                method: "POST",
                headers: {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch(provider.config.userInfoUrl, {
                headers: {
  ...
  SSOManager.prototype.normalizeUserInfo = (providerId, userData) => {
    ...
    switch (providerId) {
      case "google":
        return __assign(__assign({}, baseInfo), {
          name: userData.name,
      ...
      case "facebook":
        return __assign(__assign({}, baseInfo), {
          ...
          picture:
            (_b = (_a = userData.picture) === null || _a === void 0 ? void 0 : _a.data) === null ||
            _b === void 0
              ? void 0
              : _b.url,
        });
      case "apple":
        return __assign(__assign({}, baseInfo), {
          name: userData.name
            ? "".concat(userData.name.firstName, " ").concat(userData.name.lastName)
            : undefined,
          firstName: (_c = userData.name) === null || _c === void 0 ? void 0 : _c.firstName,
          lastName: (_d = userData.name) === null || _d === void 0 ? void 0 : _d.lastName,
        });
      default:
        return baseInfo;
    }
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("users").select("id").eq("email", userInfo.email).single(),
            ];
          case 1:
          ...
          case 4:
            ...
            if (error) {
              throw this.createError(
                ...
                "Failed to create user: ".concat(error.message),
              );
            }
            // Link SSO account
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("sso_account_links").upsert(linking, {
          ...
          case 1:
            ...
            if (error) {
              throw this.createError(
                "ACCOUNT_LINKING_FAILED",
                "Failed to link account: ".concat(error.message),
              );
            }
            return [
              4 /*yield*/,
  ...
  SSOManager.prototype.createSSOSession = function (sessionData) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            session = __assign(__assign({}, sessionData), {
              createdAt: new Date(),
              lastUsedAt: new Date(),
            });
            return [
              4 /*yield*/,
              this.supabase.from("sso_sessions").insert(session).select().single(),
            ];
          case 1:
            ...
            if (error) {
              throw this.createError(
                "PROVIDER_ERROR",
                "Failed to create session: ".concat(error.message),
              );
            }
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("sso_sessions").select("*").eq("id", sessionId).single(),
            ];
          case 1:
            ...
            if (!provider) {
              throw this.createError(
                "PROVIDER_NOT_FOUND",
                "Provider ".concat(session.providerId, " not found"),
              );
            }
            _c.label = 2;
          case 2:
          ...
          case 3:
            ...
            updatedSession = __assign(__assign({}, session), {
              accessToken: tokenResponse.accessToken,
          ...
          case 4:
            ...
            if (updateError) {
              throw this.createError(
                "PROVIDER_ERROR",
                "Failed to update session: ".concat(updateError.message),
              );
            }
            return [
              4 /*yield*/,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            // Delete session
            return [4 /*yield*/, this.supabase.from("sso_sessions").delete().eq("id", sessionId)];
          case 2:
            // Delete session
            _b.sent();
            return [
  ...
  SSOManager.prototype.logAudit = function (auditData) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            audit = __assign(__assign({}, auditData), {
              timestamp: new Date(),
              ipAddress: "0.0.0.0",
              userAgent: "Unknown",
            });
            return [4 /*yield*/, this.supabase.from("sso_audit_logs").insert(audit)];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
...
exports.ssoManager = new SSOManager(
