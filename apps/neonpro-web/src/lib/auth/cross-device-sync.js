...
var CrossDeviceSync = /** @class */ (function () {
     ...
     */
    CrossDeviceSync.prototype.registerDeviceSession = function (sessionId, userId, deviceInfo, preferences) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        session = (_a.isPrimary = _b.sent(),
                            ...
                            _a.preferences = __assign({ notifications: true, autoSync: true, syncFrequency: this.config.syncInterval, conflictResolution: this.config.conflictResolution }, preferences),
                            _a.metadata = {},
                            _a);
                        // Store session
                    ...
                    case 2:
                        ...
                        // Create sync event
                        return [4 /*yield*/, this.createSyncEvent({
                                sessionId: sessionId,
                                userId: userId,
                                deviceId: deviceId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        updatedSession = __assign(__assign(__assign({}, existingSession), updates), { lastActivity: new Date(), syncState: __assign(__assign({}, existingSession.syncState), { pendingChanges: existingSession.syncState.pendingChanges + 1 }) });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        terminatedSession = __assign(__assign({}, session), { isActive: false, lastActivity: new Date() });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        newSessionId = "session_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9));
                        handoffSession = __assign(__assign({}, fromSession), { sessionId: newSessionId, deviceId: toDeviceId, createdAt: new Date(), lastActivity: new Date(), syncState: {
                                lastSyncAt: new Date(),
                                pendingChanges: 0,
                                conflictCount: 0,
                                isOnline: true
                            }, metadata: __assign(__assign({}, fromSession.metadata), { handoffFrom: fromSessionId, handoffAt: new Date().toISOString(), statePreserved: preserveState }) });
                        // Store new session
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'session_updated': return [3 /*break*/, 1];
                            case 'session_terminated': return [3 /*break*/, 3];
                            case 'data_changed': return [3 /*break*/, 5];
                            case 'activity_recorded': return [3 /*break*/, 7];
                        }
                        return [3 /*break*/, 9];
                    case 1: return [4 /*yield*/, this.syncSessionUpdate(syncEvent)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 9];
                    case 3: return [4 /*yield*/, this.syncSessionTermination(syncEvent)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 9];
                    case 5: return [4 /*yield*/, this.syncDataChange(syncEvent)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 9];
                    case 7: return [4 /*yield*/, this.syncActivityRecord(syncEvent)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 9];
                    case 9: 
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.broadcastToUserDevices(syncEvent.userId, {
                                type: 'session_update',
    ...
    CrossDeviceSync.prototype.syncDataChange = function (syncEvent) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.detectDataConflict(syncEvent)];
                    case 1:
                        conflict = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        conflictingEvents = recentEvents.filter(function (event) {
                            return event.eventId !== syncEvent.eventId &&
                        ...
                        if (conflictingEvents.length > 0) {
                            return [2 /*return*/, {
                                    conflictId: "conflict_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                                    sessionId: syncEvent.sessionId,
                    ...
                    case 0:
                        ...
                        switch (this.config.conflictResolution) {
                            ...
                            case 'primary_wins':
                                ...
                                resolution = (session === null || session === void 0 ? void 0 : session.isPrimary) ? 'use_local' : 'use_remote';
                                break;
                            default:
    ...
    CrossDeviceSync.prototype.generateDeviceId = function (deviceInfo) {
        ...
        var deviceString = "".concat(deviceInfo.type, "_").concat(deviceInfo.os, "_").concat(deviceInfo.browser, "_").concat(deviceInfo.userAgent);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        syncEvent = __assign(__assign({}, eventData), { eventId: "event_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)), timestamp: new Date(), version: 1, checksum: this.calculateChecksum(eventData.data), isProcessed: false });
                        // Store sync event
                        return [4 /*yield*/, this.supabase
                                .from('sync_events')
                                .insert({
    ...
    CrossDeviceSync.prototype.updateStatistics = function () {
        ...
        this.syncStatistics.activeSessions = Array.from(this.activeSessions.values())
            .filter(function (s) { return s.isActive; }).length;
        this.syncStatistics.devicesOnline = Array.from(this.activeSessions.values())
            .filter(function (s) { return s.syncState.isOnline; }).length;
        this.syncStatistics.lastSyncAt = new Date();
        // Calculate sync health
        var conflictRate = this.syncStatistics.conflictsDetected / Math.max(this.syncStatistics.syncEventsProcessed, 1);
