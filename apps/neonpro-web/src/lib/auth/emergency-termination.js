...
var EmergencyTermination = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                        startTime = Date.now();
                        terminationRequest = __assign(__assign({}, request), { requestId: "term_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)), timestamp: new Date() });
                        // Validate request
                    ...
                    case 4: return [4 /*yield*/, this.executeTermination(terminationRequest)];
                    case 5:
                        result = _a.sent();
     ...
     */
    EmergencyTermination.prototype.executeProtocol = function (protocolId, initiatedBy, initiatorRole, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        terminationRequest = {
                            requestId: "protocol_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.lockUserAccounts(result.terminatedSessions.map(function (s) { return s.userId; }))];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
     ...
     */
    EmergencyTermination.prototype.terminateSession = function (sessionId_1, initiatedBy_1, reason_1) {
        return __awaiter(this, arguments, void 0, function (sessionId, initiatedBy, reason, preserveData) {
            var session, terminationRequest, error_4;
            if (preserveData === void 0) { preserveData = true; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        terminationRequest = {
                            requestId: "single_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                            initiatedBy: initiatedBy,
     ...
     */
    EmergencyTermination.prototype.terminateUserSessions = function (userId_1, initiatedBy_1, reason_1) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        terminationRequest = {
                            requestId: "user_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                            initiatedBy: initiatedBy,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        terminationRequest = {
                            requestId: "all_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                            initiatedBy: initiatedBy,
                            initiatorRole: 'owner',
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                last_triggered: (_a = protocol.lastTriggered) === null || _a === void 0 ? void 0 : _a.toISOString()
                            })
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        switch (_a) {
                            case 'single_session': return [3 /*break*/, 1];
                            case 'user_sessions': return [3 /*break*/, 2];
                            case 'all_sessions': return [3 /*break*/, 4];
                        }
                        return [3 /*break*/, 5];
                    case 1:
                    ...
                    return [3 /*break*/, 6];
                    case 5: throw new Error('Invalid termination type');
                    case 6:
    ...
    EmergencyTermination.prototype.executeTermination = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var result, targetSessions, _i, targetSessions_1, session, preservationBackupId, backup, error_12, error_13;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.sessionPreservation.createEmergencyBackup(session.session_id, "Emergency termination: ".concat(request.reason))];
                    case 5:
                        backup = _a.sent();
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, this.notifyAffectedUsers(result.terminatedSessions, request.reason)];
                    case 11:
                        _a.sent();
                        _a.label = 12;
                    case 12:
    ...
    EmergencyTermination.prototype.logTermination = function (request, result) {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, terminatedSession, auditLog, _b, _c, failedTermination, session, auditLog, error_15;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('termination_audit_logs')
                                .insert({
                                log_id: "log_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
    ...
    EmergencyTermination.prototype.notifyAffectedUsers = function (terminatedSessions, reason) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log("Notifying ".concat(terminatedSessions.length, " affected users about session termination: ").concat(reason));
                return [2 /*return*/];
            });
        });
    };
    ...
    EmergencyTermination.prototype.escalateToSecurity = function (request, result) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log("Escalating emergency termination to security team: ".concat(request.requestId));
                return [2 /*return*/];
            });
        });
    };
    EmergencyTermination.prototype.hasTerminationPermission = function (role, terminationType) {
        ...
        return ((_a = permissions[role]) === null || _a === void 0 ? void 0 : _a.includes(terminationType)) || false;
    };
