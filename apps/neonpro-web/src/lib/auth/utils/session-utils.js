...
var SessionUtils = /** @class */ (function () {
    ...
    SessionUtils.generateSessionPolicy = function (userRole, securityLevel) {
        if (securityLevel === void 0) { securityLevel = 'MEDIUM'; }
        var basePolicy = {
        ...
        switch (securityLevel) {
            case 'HIGH':
                return __assign(__assign({}, basePolicy), { max_session_duration: 4 * 60, idle_timeout: 15, max_concurrent_sessions: 1, require_device_trust: true, allow_concurrent_ips: false, session_refresh_threshold: 30, security_check_interval: 5 // 5 minutes
                 });
            case 'LOW':
                return __assign(__assign({}, basePolicy), { max_session_duration: 24 * 60, idle_timeout: 60, max_concurrent_sessions: 5, security_check_interval: 30 // 30 minutes
                 });
            default:
                return basePolicy;
        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        encoder = new TextEncoder();
                        return [4 /*yield*/, crypto.subtle.importKey('raw', encoder.encode(key.padEnd(32, '0').substring(0, 32)), { name: 'AES-GCM' }, false, ['encrypt'])];
                    case 1:
                        keyData = _a.sent();
                        iv = crypto.getRandomValues(new Uint8Array(12));
                        return [4 /*yield*/, crypto.subtle.encrypt({ name: 'AES-GCM', iv: iv }, keyData, encoder.encode(data))];
                    case 2:
                        encrypted = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        encoder = new TextEncoder();
                        combined = new Uint8Array(atob(encryptedData).split('').map(function (char) { return char.charCodeAt(0); }));
                        iv = combined.slice(0, 12);
                        encrypted = combined.slice(12);
                        return [4 /*yield*/, crypto.subtle.importKey('raw', encoder.encode(key.padEnd(32, '0').substring(0, 32)), { name: 'AES-GCM' }, false, ['decrypt'])];
                    case 1:
                        keyData = _a.sent();
                        return [4 /*yield*/, crypto.subtle.decrypt({ name: 'AES-GCM', iv: iv }, keyData, encrypted)];
                    case 2:
                        decrypted = _a.sent();
