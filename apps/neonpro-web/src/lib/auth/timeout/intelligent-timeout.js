...
var IntelligentTimeoutManager = /** @class */ (() => {
  ...
  IntelligentTimeoutManager.prototype.startTimeoutManagement = function (session) {
    ...
    console.log(
      "Timeout management started for session "
        .concat(session.id, " with ")
        .concat(timeoutConfig.baseTimeout, " minute timeout"),
    );
  };
  /**
    ...
    var message =
      type === "final"
        ? "Sua sess\u00E3o expirar\u00E1 em "
            .concat(minutes, ":")
            .concat(seconds.toString().padStart(2, "0"), '. Clique em "Continuar" para estender.')
        : "Sua sess\u00E3o expirar\u00E1 em ".concat(
            minutes,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.extendSession(session.id, "Grace period for recent activity"),
            ];
          case 1:
            // Grace period extension for recent activity
            _a.sent();
