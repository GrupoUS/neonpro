    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        ...
        case 1:
          ...
          if (config.requiredRole && !hasMinimumRole(user.role, config.requiredRole)) {
            return [
              2 /*return*/,
              {
                ...
                user: user,
                reason: "Minimum role '"
                  .concat(config.requiredRole, "' required, user has '")
                  .concat(user.role, "'"),
                statusCode: 403,
              },
            ];
          ...
          return [
            4 /*yield*/,
            (0, permissions_1.hasAllPermissions)(
              user,
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            (0, permissions_1.hasAnyPermission)(user, config.anyPermissions, resourceId, context),
          ];
        case 4:
          permissionResult = _a.sent();
          if (!permissionResult.granted) {
  ...
  return (req) =>
    __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, authorize(req, config)];
          case 1:
            result = _a.sent();
