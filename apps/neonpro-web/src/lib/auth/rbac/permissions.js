...
Object.defineProperty(exports, "RBACPermissionManager", { enumerable: true, get: function () { return rbac_manager_1.RBACPermissionManager; } });
/**
...
function getCacheKey(check) {
    return "".concat(check.userId, ":").concat(check.permission, ":").concat(check.clinicId, ":").concat(check.resourceId || 'global');
}
/**
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!hasRolePermission) {
                        return [2 /*return*/, {
                                granted: false,
                                reason: "Role '".concat(user.role, "' does not have permission '").concat(check.permission, "'"),
                                roleUsed: user.role,
                ...
                case 4: return [2 /*return*/, (_a.auditId = _b.sent(),
                        _a)];
                case 5:
                    error_1 = _b.sent();
...
function checkResourceAccess(check, user) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(check.permission.startsWith('patients.') && check.resourceId)) return [3 /*break*/, 2];
                    return [4 /*yield*/, checkPatientAccess(check.resourceId, user)];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    if (!(check.permission.startsWith('appointments.') && check.resourceId)) return [3 /*break*/, 4];
                    return [4 /*yield*/, checkAppointmentAccess(check.resourceId, user)];
                case 3: return [2 /*return*/, _a.sent()];
                case 4:
                    if (!(check.permission.startsWith('billing.') || check.permission.startsWith('payments.'))) return [3 /*break*/, 6];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    supabase = _c.sent();
                    return [4 /*yield*/, supabase.from('permission_audit_log').insert({
                            ...
                            granted: granted,
                            role_used: user.role,
                            ip_address: ((_a = check.context) === null || _a === void 0 ? void 0 : _a.ipAddress) || 'unknown',
                            user_agent: ((_b = check.context) === null || _b === void 0 ? void 0 : _b.userAgent) || 'unknown',
...
function generateAuditId() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, "audit_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9))];
        });
    });
}
/**
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4: return [2 /*return*/, {
                        granted: false,
                        reason: "User does not have any of the required permissions: ".concat(permissions.join(', ')),
                        roleUsed: user.role
                    }];
            }
        });
