...
var RBACPermissionManager = /** @class */ (() => {
   ...
   */
  RBACPermissionManager.prototype.hasPermission = function (
    userId,
    permission,
    clinicId,
    resourceId,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            targetRole = _a.sent();
            if (
              !(managerRole === null || managerRole === void 0 ? void 0 : managerRole.role) ||
              !(targetRole === null || targetRole === void 0 ? void 0 : targetRole.role)
            ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("user_roles").insert({
                user_id: userId,
                role_id: roleId,
                clinic_id: clinicId,
