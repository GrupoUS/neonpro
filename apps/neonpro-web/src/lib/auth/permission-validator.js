...
var PermissionValidator = /** @class */ (function () {
    ...
    PermissionValidator.prototype.checkPermission = function (context, resource, action) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, userPermissions, matchedPermission, result_1, conditionResult, result_2, elevationCheck, result, error_1, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        matchedPermission = this.findMatchingPermission(userPermissions.effectivePermissions, resource, action);
                    ...
                    case 4: return [4 /*yield*/, this.evaluateConditions(matchedPermission.conditions || [], context)];
                    case 5:
                    ...
                    case 7: return [4 /*yield*/, this.checkElevationRequirements(matchedPermission, context)];
                    case 8:
                    ...
                    case 9:
                        _a.sent();
                        performance_tracker_1.performanceTracker.recordMetric('permission_check', Date.now() - startTime);
    ...
    PermissionValidator.prototype.getUserPermissions = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var cached, cacheExpiry, startTime, supabase, userRoles, directPermissions, roles, clinicPermissions, allPermissions, _i, userRoles_1, userRole, role, rolePermissions, _a, _b, rp, processedRole, directPerms, _c, directPermissions_1, dp, effectivePermissions, userPermissions, error_2;
            var _d;
                ...
                switch (_e.label) {
                    ...
                    case 4:
                        ...
                        if (directPermissions) {
                            for (_c = 0, directPermissions_1 = directPermissions; _c < directPermissions_1.length; _c++) {
                        ...
                        performance_tracker_1.performanceTracker.recordMetric('user_permissions_load', Date.now() - startTime);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        // Log security event
                        return [4 /*yield*/, security_audit_logger_1.securityAuditLogger.logSecurityEvent('permission_granted', "Role ".concat(roleId, " assigned to user ").concat(userId), {
                                role_id: roleId,
                                clinic_id: clinicId,
                                assigned_by: assignedBy,
                            }, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.clearUserCache(userId);
                        // Log security event
                        return [4 /*yield*/, security_audit_logger_1.securityAuditLogger.logSecurityEvent('permission_denied', "Role ".concat(roleId, " removed from user ").concat(userId), {
                                role_id: roleId,
                                clinic_id: clinicId,
                                removed_by: removedBy,
                            }, {
     ...
     */
    PermissionValidator.prototype.grantPermission = function (userId, permissionId, clinicId, grantedBy) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.clearUserCache(userId);
                        // Log security event
                        return [4 /*yield*/, security_audit_logger_1.securityAuditLogger.logSecurityEvent('permission_granted', "Permission ".concat(permissionId, " granted to user ").concat(userId), {
                                permission_id: permissionId,
                                clinic_id: clinicId,
                                granted_by: grantedBy,
                            }, {
     ...
     */
    PermissionValidator.prototype.revokePermission = function (userId, permissionId, clinicId, revokedBy) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.clearUserCache(userId);
                        // Log security event
                        return [4 /*yield*/, security_audit_logger_1.securityAuditLogger.logSecurityEvent('permission_denied', "Permission ".concat(permissionId, " revoked from user ").concat(userId), {
                                permission_id: permissionId,
                                clinic_id: clinicId,
                                revoked_by: revokedBy,
                            }, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, { passed: true }];
                }
            });
        });
    };
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'location': return [3 /*break*/, 2];
                            case 'resource_owner': return [3 /*break*/, 3];
                            case 'clinic_member': return [3 /*break*/, 5];
                            case 'custom': return [3 /*break*/, 7];
                        }
                        return [3 /*break*/, 9];
                    case 1: return [2 /*return*/, this.evaluateTimeCondition(condition, context)];
                    case 2: return [2 /*return*/, this.evaluateLocationCondition(condition, context)];
                    case 3: return [4 /*yield*/, this.evaluateResourceOwnerCondition(condition, context)];
                    case 4: return [2 /*return*/, _b.sent()];
                    case 5: return [4 /*yield*/, this.evaluateClinicMemberCondition(condition, context)];
                    case 6: return [2 /*return*/, _b.sent()];
                    case 7: return [4 /*yield*/, this.evaluateCustomCondition(condition, context)];
                    case 8: return [2 /*return*/, _b.sent()];
                    case 9: return [2 /*return*/, { passed: true }];
                }
            });
        });
    };
        ...
        switch (condition.operator) {
            case 'greater_than':
                return {
                    ...
                    reason: currentHour <= condition.value ? "Current time ".concat(currentHour, " is not after ").concat(condition.value) : undefined,
                };
            case 'less_than':
                return {
                    passed: currentHour < condition.value,
                    reason: currentHour >= condition.value ? "Current time ".concat(currentHour, " is not before ").concat(condition.value) : undefined,
                };
            default:
                return { passed: true };
        }
        ...
        switch (condition.operator) {
            case 'in':
                ...
                return {
                    ...
                    reason: !allowedIPs.includes(userIP) ? "IP ".concat(userIP, " not in allowed list") : undefined,
                };
            default:
                return { passed: true };
        }
                ...
                switch (_a.label) {
                    case 0:
                        if (!context.resourceId || !context.resourceType) {
                            return [2 /*return*/, { passed: false, reason: 'Resource information required for ownership check' }];
                        }
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                    ...
                    case 3:
                        ...
                        isOwner = data.created_by === context.userId ||
    ...
    PermissionValidator.prototype.checkElevationRequirements = function (permission, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (sensitiveActions.includes(permission.action) ||
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, security_audit_logger_1.securityAuditLogger.logSecurityEvent(eventType, "Permission check: ".concat(action, " on ").concat(resource, " - ").concat(result.granted ? 'granted' : 'denied'), {
                                resource: resource,
                                action: action,
                                granted: result.granted,
                                reason: result.reason,
                                matched_permission: (_a = result.matchedPermission) === null || _a === void 0 ? void 0 : _a.id,
