...
var SessionPreservationManager = /** @class */ (function () {
    function SessionPreservationManager(config) {
        ...
        this.preservationConfig = __assign({ snapshotInterval: 30000, maxSnapshots: 10, compressionEnabled: true, encryptionEnabled: true, storageType: 'indexedDB', retentionPeriod: 7 * 24 * 60 * 60 * 1000, autoRestore: true, conflictResolution: 'merge' }, config);
    }
    /**
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.getLatestSnapshot(sessionId)];
                    case 3:
                        _a = _b.sent();
                        _b.label = 4;
                    case 4:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), auth = _a[0], prefs = _a[1], nav = _a[2], forms = _a[3], cache = _a[4], perms = _a[5], activity = _a[6];
                        return [2 /*return*/, {
                                authentication: auth,
                                preferences: prefs,
                                navigation: nav,
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        switch (_a) {
                            ...
                            case 'indexedDB': return [3 /*break*/, 7];
                            case 'sessionStorage': return [3 /*break*/, 9];
                            case 'memory': return [3 /*break*/, 11];
                        }
                        return [3 /*break*/, 12];
                    case 5: return [4 /*yield*/, this.storeInLocalStorage(snapshot.sessionId, data)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 12];
                    case 7: return [4 /*yield*/, this.storeInIndexedDB(snapshot.sessionId, data)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 12];
                    case 9: return [4 /*yield*/, this.storeInSessionStorage(snapshot.sessionId, data)];
                    case 10:
                        _b.sent();
                        return [3 /*break*/, 12];
                    case 11:
                    ...
                    case 12:
                        ...
                        if (!(sessionSnapshots.length > this.preservationConfig.maxSnapshots)) return [3 /*break*/, 14];
    ...
    SessionPreservationManager.prototype.getSnapshot = function (sessionId, snapshotId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, sessionSnapshots.find(function (s) { return s.id === snapshotId; }) || null];
            });
        });
    };
    /**
    ...
    SessionPreservationManager.prototype.getNextVersion = function (sessionId) {
        ...
        var latestVersion = Math.max.apply(Math, sessionSnapshots.map(function (s) { return s.version; }));
    ...
    SessionPreservationManager.prototype.getNetworkInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, {
                        type: (connection === null || connection === void 0 ? void 0 : connection.effectiveType) || 'unknown',
                        speed: (connection === null || connection === void 0 ? void 0 : connection.downlink) || 0,
    ...
    SessionPreservationManager.prototype.getPerformanceInfo = function () {
        ...
        return {
            loadTime: (navigation === null || navigation === void 0 ? void 0 : navigation.loadEventEnd) - (navigation === null || navigation === void 0 ? void 0 : navigation.loadEventStart) || 0,
            renderTime: (navigation === null || navigation === void 0 ? void 0 : navigation.domContentLoadedEventEnd) - (navigation === null || navigation === void 0 ? void 0 : navigation.domContentLoadedEventStart) || 0,
    ...
    SessionPreservationManager.prototype.getBrowserVersion = function () {
        ...
        return ((_a = navigator.userAgent.match(/\d+\.\d+/)) === null || _a === void 0 ? void 0 : _a[0]) || 'Unknown';
    };
    ...
    SessionPreservationManager.prototype.compressSnapshot = function (snapshot) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, __assign(__assign({}, snapshot), { compressed: true, originalSize: JSON.stringify(snapshot).length, compressedSize: Math.floor(compressed.length * this.compressionRatio) })];
            });
        });
    };
    SessionPreservationManager.prototype.encryptSnapshot = function (snapshot) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, __assign(__assign({}, snapshot), { encrypted: true, encryptionMethod: 'AES-256' })];
            });
        });
    };
    /**
    ...
    SessionPreservationManager.prototype.applyAuthenticationState = function (sessionId, auth) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/session/".concat(sessionId, "/restore-auth"), {
                            method: 'POST',
    ...
    SessionPreservationManager.prototype.applyUserPreferences = function (sessionId, prefs) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/session/".concat(sessionId, "/restore-preferences"), {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
    ...
    SessionPreservationManager.prototype.applyPermissionState = function (sessionId, perms) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/session/".concat(sessionId, "/restore-permissions"), {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
    ...
    SessionPreservationManager.prototype.cleanupOldSnapshots = function () {
        return __awaiter(this, void 0, void 0, function () {
            var now, cutoff, _i, _a, _b, sessionId, snapshots, validSnapshots, removedSnapshots, _c, removedSnapshots_1, snapshot;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        validSnapshots = snapshots.filter(function (s) { return s.timestamp > cutoff; });
                        if (!(validSnapshots.length !== snapshots.length)) return [3 /*break*/, 5];
                        this.snapshots.set(sessionId, validSnapshots);
                        removedSnapshots = snapshots.filter(function (s) { return s.timestamp <= cutoff; });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.preservationConfig.storageType;
                        switch (_a) {
                            case 'localStorage': return [3 /*break*/, 1];
                            case 'indexedDB': return [3 /*break*/, 2];
                            case 'sessionStorage': return [3 /*break*/, 4];
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 6];
                    case 2: return [4 /*yield*/, this.loadFromIndexedDB()];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 6];
                    case 4:
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        request.onsuccess = function () {
                            ...
                            getAllRequest.onerror = function () { return reject(getAllRequest.error); };
                        };
                    })];
            });
        });
    ...
    SessionPreservationManager.prototype.startAutomaticSnapshots = function () {
        ...
        this.snapshotInterval = setInterval(function () {
            ...
            _this.currentState.forEach(function (state, sessionId) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            error_10 = _a.sent();
                            console.error("Error creating automatic snapshot for ".concat(sessionId, ":"), error_10);
                            return [3 /*break*/, 6];
                        case 6: return [2 /*return*/];
                    }
                });
            ...
            _this.currentState.forEach(function (state, sessionId) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            error_11 = _a.sent();
                            console.error("Error creating final snapshot for ".concat(sessionId, ":"), error_11);
                            return [3 /*break*/, 6];
                        case 6: return [2 /*return*/];
                    }
                });
        ...
        switch (this.preservationConfig.storageType) {
            case 'localStorage':
                for (var i = 0; i < localStorage.length; i++) {
                    var key = localStorage.key(i);
                    if (key && key.startsWith('neonpro_snapshot_')) {
                        used += ((_a = localStorage.getItem(key)) === null || _a === void 0 ? void 0 : _a.length) || 0;
                    }
                }
                break;
            case 'memory':
