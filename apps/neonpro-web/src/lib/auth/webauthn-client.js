...
var WebAuthnClient = /** @class */ (function () {
    ...
    WebAuthnClient.prototype.registerCredential = function (deviceName) {
        return __awaiter(this, void 0, void 0, function () {
            var capabilities, optionsResponse, error, options, registrationResponse, verificationResponse, error, error_2, errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fetch('/api/auth/webauthn/register/options', {
                                method: 'POST',
                                headers: {
                    ...
                    case 4: return [4 /*yield*/, optionsResponse.json()];
                    case 5:
                        options = _a.sent();
                        return [4 /*yield*/, (0, browser_1.startRegistration)(options)];
                    case 6:
                        registrationResponse = _a.sent();
                        return [4 /*yield*/, fetch('/api/auth/webauthn/register/verify', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
    ...
    WebAuthnClient.prototype.authenticateWithCredential = function (userIdentifier) {
        return __awaiter(this, void 0, void 0, function () {
            var capabilities, optionsResponse, error, options, authenticationResponse, verificationResponse, error, error_3, errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 10, , 11]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fetch('/api/auth/webauthn/authenticate/options', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, fetch('/api/auth/webauthn/authenticate/verify', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
    ...
    WebAuthnClient.prototype.getSuggestedAuthFlow = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.checkCapabilities()];
                    case 1:
                        capabilities = _a.sent();
                        reasons = [];
                        if (!capabilities.supported) {
...
var useWebAuthnCapabilities = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exports.webAuthnClient.checkCapabilities()];
...
var getWebAuthnErrorMessage = function (error) {
    ...
    for (var _i = 0, _a = Object.entries(errorMap); _i < _a.length; _i++) {
        var _b = _a[_i], errorType = _b[0], message = _b[1];
