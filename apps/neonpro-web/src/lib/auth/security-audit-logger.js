...
var SecurityAuditLogger = /** @class */ (() => {
   ...
   */
  SecurityAuditLogger.prototype.logOAuthEvent = function (
    operation_1,
    provider_1,
    success_1,
    userId_1,
    ...
    return __awaiter(
      ...
      arguments,
      void 0,
      function (operation, provider, success, userId, sessionId, metadata) {
        ...
        return __generator(this, function (_a) {
          ...
          description = "OAuth "
            .concat(operation, " ")
            .concat(success ? "successful" : "failed", " for provider ")
            .concat(provider);
          return [
            2 /*return*/,
  ...
  SecurityAuditLogger.prototype.logLGPDEvent = function (eventType_1, userId_1, complianceData_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (eventType, userId, complianceData, metadata) {
   ...
   */
  SecurityAuditLogger.prototype.logSessionEvent = function (
    eventType_1,
    sessionId_1,
    userId_1,
    reason_1,
    ...
    return __awaiter(
      ...
      arguments,
      void 0,
      function (eventType, sessionId, userId, reason, metadata) {
        var securityEventType, description;
        if (metadata === void 0) {
          metadata = {};
        }
        return __generator(this, function (_a) {
          ...
          return [
            ...
            this.logSecurityEvent(
              securityEventType,
              description,
              __assign(__assign({}, metadata), { reason: reason, session_event_type: eventType }),
              {
                userId: userId,
                sessionId: sessionId,
   ...
   */
  SecurityAuditLogger.prototype.logDataAccess = function (
    userId_1,
    resourceType_1,
    resourceId_1,
    operation_1,
    ...
    return __awaiter(
      ...
      arguments,
      void 0,
      function (userId, resourceType, resourceId, operation, success, metadata) {
        var eventType, description;
        if (metadata === void 0) {
          metadata = {};
        }
        return __generator(this, function (_a) {
          eventType = operation === "read" ? "data_access" : "data_modification";
          description = "Data "
            .concat(operation, " ")
            .concat(success ? "successful" : "failed", " for ")
            .concat(resourceType, ":")
            .concat(resourceId);
          return [
            2 /*return*/,
  ...
  SecurityAuditLogger.prototype.determineSeverity = (eventType) => {
    var criticalEvents = ["security_violation", "suspicious_activity"];
    var warningEvents = ["authentication_failure", "permission_denied", "session_expired"];
    if (criticalEvents.includes(eventType)) return "critical";
    if (warningEvents.includes(eventType)) return "warning";
    return "info";
  };
  SecurityAuditLogger.prototype.determineComplianceFlags = (eventType) => {
    var flags = [];
    ...
    var consentEvents = ["privacy_consent_given", "privacy_consent_withdrawn"];
  ...
  SecurityAuditLogger.prototype.flushEvents = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            if (this.eventQueue.length === 0) return [2 /*return*/];
  ...
  SecurityAuditLogger.prototype.groupEventsByType = (events) =>
    events.reduce((acc, event) => {
      acc[event.event_type] = (acc[event.event_type] || 0) + 1;
      return acc;
    }, {});
  SecurityAuditLogger.prototype.groupEventsBySeverity = (events) =>
    events.reduce((acc, event) => {
      acc[event.severity] = (acc[event.severity] || 0) + 1;
      return acc;
    }, {});
  SecurityAuditLogger.prototype.generateComplianceSummary = (events) => {
    var lgpdEvents = events.filter(
  ...
  SecurityAuditLogger.prototype.generateLGPDSummary = (events) => {
    var lgpdEvents = events.filter(
      (e) => e.compliance_flags && e.compliance_flags.includes("lgpd_relevant"),
    );
    return {
  ...
  SecurityAuditLogger.prototype.generateRecommendations = (events) => {
    var recommendations = [];
    var criticalEvents = events.filter((e) => e.severity === "critical");
    if (criticalEvents.length > 0) {
      recommendations.push("Investigate critical security events immediately");
    }
    var failedAuth = events.filter((e) => e.event_type === "authentication_failure");
    ...
    var suspiciousActivity = events.filter((e) => e.event_type === "suspicious_activity");
