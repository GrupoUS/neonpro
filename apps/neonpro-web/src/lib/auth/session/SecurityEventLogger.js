...
var SecurityEventLogger = /** @class */ (() => {
   ...
   */
  SecurityEventLogger.prototype.logEvent = function (
    type,
    severity,
    userId,
    deviceId,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("security_events").insert(eventData).select().single(),
            ];
          case 2:
   ...
   */
  SecurityEventLogger.prototype.getEvents = function (
    userId_1,
    type_1,
    severity_1,
    startDate_1,
    ...
    return __awaiter(
      ...
      arguments,
      void 0,
      function (userId, type, severity, startDate, endDate, limit) {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              _b.trys.push([0, 2, , 3]);
              query = this.supabase.from("security_events").select("*");
              if (userId) {
                if (!(0, utils_1.validateUUID)(userId)) {
                  return [
                    2 /*return*/,
              ...
              return [4 /*yield*/, query.order("created_at", { ascending: false }).limit(limit)];
            case 1:
              (_a = _b.sent()), (data = _a.data), (error = _a.error);
              if (error) {
                return [
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            error_5 = _b.sent();
            throw new Error(
              "Error generating security report: ".concat(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.logEvent("security_breach", "high", event.userId, event.deviceId, {
  ...
  SecurityEventLogger.prototype.assessUserRisk = function (userId, events) {
    ...
    var riskLevel = riskFactors.length === 0 ? "low" : riskFactors.length <= 2 ? "medium" : "high";
    return {
      level: riskLevel,
      factors: riskFactors,
