...
var DeviceManager = /** @class */ (function () {
    ...
    DeviceManager.prototype.registerDevice = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var fingerprint, existingDevice, deviceLimitCheck, userAgentInfo, deviceId, deviceData, _a, data, error, device, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        fingerprint = request.fingerprint || (0, utils_1.generateDeviceFingerprint)({
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        devices = data.map(function (row) { return _this.convertToDeviceData(row); });
                        return [2 /*return*/, {
                                success: true,
                                data: devices,
                                timestamp: new Date().toISOString()
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, {
                                ...
                                error: {
                                    ...
                                    details: { error: error_10 instanceof Error ? error_10.message : 'Unknown error' }
                                },
                                timestamp: new Date().toISOString()
                            }];
    ...
    DeviceManager.prototype.cleanupInactiveDevices = function () {
        return __awaiter(this, arguments, void 0, function (inactiveDays) {
            ...
            if (inactiveDays === void 0) { inactiveDays = 90; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                error: {
                                    ...
                                    details: { error: error_12 instanceof Error ? error_12.message : 'Unknown error' }
                                },
                                timestamp: new Date().toISOString()
                            }];
                    case 3: return [2 /*return*/];
    ...
    DeviceManager.prototype.getDeviceStats = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, devices, error, now_1, trustedDevices, blockedDevices, recentDevices, deviceTypes, operatingSystems, error_13;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        now_1 = new Date();
                        trustedDevices = devices.filter(function (d) { return d.trusted && (!d.trust_expires_at || new Date(d.trust_expires_at) > now_1); });
                        blockedDevices = devices.filter(function (d) { return d.blocked; });
                    ...
                    case 2:
                        error_13 = _b.sent();
                        throw new Error("Error generating device statistics: ".concat(error_13 instanceof Error ? error_13.message : 'Unknown error'));
                    case 3: return [2 /*return*/];
                }
            });
        });
                        ...
                        if (deviceCount >= this.config.maxDevicesPerUser) {
                            return [2 /*return*/, {
                                    ...
                                    error: {
                                        ...
                                        message: "Maximum devices per user (".concat(this.config.maxDevicesPerUser, ") exceeded"),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        sameNetworkTrusted = trustedDevices === null || trustedDevices === void 0 ? void 0 : trustedDevices.some(function (td) {
