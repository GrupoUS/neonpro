...
var SessionManager = /** @class */ (function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        updateData = (0, utils_1.removeUndefined)({
                            ...
                            location: (activity === null || activity === void 0 ? void 0 : activity.location) ? JSON.stringify(activity.location) : undefined,
                            metadata: (activity === null || activity === void 0 ? void 0 : activity.metadata) ? JSON.stringify(activity.metadata) : undefined
                        });
                        return [4 /*yield*/, this.supabase
                                .from('sessions')
                                .update(updateData)
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        sessions = data.map(function (row) { return ({
                            id: row.id,
                            userId: row.user_id,
    ...
    SessionManager.prototype.cleanupExpiredSessions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var now, _a, expiredSessions, updateError, retentionDate, _b, deletedSessions, deleteError, error_9;
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                success: true,
                                data: {
                                    expiredCount: (expiredSessions === null || expiredSessions === void 0 ? void 0 : expiredSessions.length) || 0,
                                    deletedCount: (deletedSessions === null || deletedSessions === void 0 ? void 0 : deletedSessions.length) || 0,
                                    cleanupDate: now
                                },
                                timestamp: new Date().toISOString()
                            }];
    ...
    SessionManager.prototype.getSessionMetrics = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _a, allSessions, error, now_1, activeSessions, expiredSessions, terminatedSessions, completedSessions, totalDuration, averageDuration, terminationReasons, error_10;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        terminatedSessions = allSessions.filter(function (s) { return s.terminated_at; });
                        completedSessions = terminatedSessions.filter(function (s) { return s.terminated_at; });
                    ...
                    case 2:
                        error_10 = _b.sent();
                        throw new Error("Error generating session metrics: ".concat(error_10 instanceof Error ? error_10.message : 'Unknown error'));
                    case 3: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        activeCount = (activeSessions === null || activeSessions === void 0 ? void 0 : activeSessions.length) || 0;
                        if (activeCount >= this.config.maxConcurrentSessions) {
                            return [2 /*return*/, {
                                    success: false,
                                    error: {
                                        code: 'MAX_SESSIONS_EXCEEDED',
                                        message: "Maximum concurrent sessions (".concat(this.config.maxConcurrentSessions, ") exceeded"),
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                error: {
                                    ...
                                    details: { error: error_11 instanceof Error ? error_11.message : 'Unknown error' }
                                },
                                timestamp: new Date().toISOString()
                            }];
                    case 3: return [2 /*return*/];
