...
var NotificationService = /** @class */ (function () {
     ...
     * Send a notification
     */
    NotificationService.prototype.sendNotification = function (userId_1, type_1, priority_1, channels_1) {
        return __awaiter(this, arguments, void 0, function (userId, type, priority, channels, data, templateId) {
     ...
     */
    NotificationService.prototype.sendSessionTimeoutWarning = function (userId, sessionId, timeoutMinutes) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.sendNotification(userId, 'session_timeout_warning', 'medium', ['in_app', 'push'], {
                        sessionId: sessionId,
                        timeoutMinutes: timeoutMinutes,
                        message: "Your session will expire in ".concat(timeoutMinutes, " minutes. Click to extend.")
     ...
     * Send security alert
     */
    NotificationService.prototype.sendSecurityAlert = function (userId, alertType, severity, details) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.sendNotification(userId, 'security_alert', priorityMap[severity], channelMap[severity], __assign({ alertType: alertType, severity: severity }, details), 'security_alert')];
            });
        });
    };
    /**
     ...
     */
    NotificationService.prototype.sendDeviceTrustNotification = function (userId, deviceId, action, deviceInfo) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.sendNotification(userId, 'device_trust', 'medium', ['in_app', 'email'], {
                        deviceId: deviceId,
                        action: action,
    ...
    NotificationService.prototype.sendLoginNotification = function (userId, deviceInfo, location) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.sendNotification(userId, 'login_notification', 'low', ['in_app', 'email'], {
                        deviceInfo: deviceInfo,
                        location: location,
                        timestamp: new Date().toISOString()
                    }, 'login_notification')];
     ...
     */
    NotificationService.prototype.updateUserNotificationPreferences = function (userId, enabledChannels, preferences) {
        return __awaiter(this, void 0, void 0, function () {
            var error, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        notifications = (data || []).map(function (row) { return _this.convertToNotificationData(row); });
                        return [2 /*return*/, {
                                success: true,
                                data: notifications,
                                timestamp: new Date().toISOString()
    ...
    NotificationService.prototype.startQueueProcessor = function () {
        ...
        setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(!this.isProcessingQueue && this.deliveryQueue.length > 0)) return [3 /*break*/, 2];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(batch.map(function (notification) { return _this.processNotification(notification); }))];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 3:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 9:
                        _b.sent();
                        return [3 /*break*/, 12];
                    case 10: return [4 /*yield*/, this.updateNotificationStatus(notification.id, 'failed')];
                    case 11:
                        _b.sent();
                        _b.label = 12;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = channel;
                        switch (_a) {
                            case 'in_app': return [3 /*break*/, 1];
                            case 'email': return [3 /*break*/, 3];
                            case 'push': return [3 /*break*/, 5];
                            case 'sms': return [3 /*break*/, 7];
                        }
                        return [3 /*break*/, 9];
                    case 1: return [4 /*yield*/, this.deliverInApp(notification, content)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 3: return [4 /*yield*/, this.deliverEmail(notification, content)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 5: return [4 /*yield*/, this.deliverPush(notification, content)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 7: return [4 /*yield*/, this.deliverSMS(notification, content)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 10];
