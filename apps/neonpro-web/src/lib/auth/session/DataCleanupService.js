      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [4 /*yield*/, this.supabase.from("sessions").select("id").lt("expires_at", now)];
          case 2:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("sessions").delete().lt("expires_at", now).select("id"),
            ];
          case 3:
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("devices").select("id").lt("last_seen", cutoffDateString),
            ];
          case 2:
            ...
            itemsProcessed =
              (inactiveDevices === null || inactiveDevices === void 0
                ? void 0
            ...
            return [
              4 /*yield*/,
              this.supabase.from("devices").delete().lt("last_seen", cutoffDateString).select("id"),
            ];
          case 3:
            ...
            itemsDeleted =
              (deletedDevices === null || deletedDevices === void 0
                ? void 0
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            ...
            itemsProcessed =
              (oldEvents === null || oldEvents === void 0 ? void 0 : oldEvents.length) || 0;
            if (itemsProcessed === 0) {
              return [
                2 /*return*/,
                {
          ...
          case 5:
            ...
            itemsDeleted =
              (deletedEvents === null || deletedEvents === void 0
                ? void 0
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("notifications").select("id").lt("created_at", cutoffDateString),
            ];
          case 2:
            ...
            itemsProcessed =
              (oldNotifications === null || oldNotifications === void 0
                ? void 0
          ...
          case 3:
            ...
            itemsDeleted =
              (deletedNotifications === null || deletedNotifications === void 0
                ? void 0
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("device_verifications").select("id").lt("expires_at", now),
            ];
          case 2:
            (_a = _c.sent()), (expiredVerifications = _a.data), (selectError = _a.error);
            if (selectError) {
              throw new Error(
                "Failed to query expired verifications: ".concat(selectError.message),
              );
            }
            itemsProcessed =
              (expiredVerifications === null || expiredVerifications === void 0
                ? void 0
          ...
          case 3:
            ...
            if (deleteError) {
              throw new Error(
                "Failed to delete expired verifications: ".concat(deleteError.message),
              );
            }
            itemsDeleted =
              (deletedVerifications === null || deletedVerifications === void 0
                ? void 0
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            console.log(
              "Would archive ".concat(criticalEvents.length, " critical security events"),
            );
            return [3 /*break*/, 3];
          case 2:
            error_9 = _b.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("cleanup_logs").insert({
