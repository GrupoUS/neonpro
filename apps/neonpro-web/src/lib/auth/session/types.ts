 ...
 * Status de resolução
 */
export type ResolutionStatus = "pending" | "investigating" | "resolved" | "dismissed";
 ...
 */
export const DEVICE_TYPES: DeviceType[] = ["desktop", "mobile", "tablet", "unknown"];
 ...
 */
export const NOTIFICATION_CHANNELS: NotificationChannel[] = ["email", "sms", "push", "inApp"];
