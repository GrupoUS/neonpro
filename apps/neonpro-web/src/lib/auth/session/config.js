...
function getMergedConfig() {
  ...
  return __assign(__assign(__assign({}, exports.DEFAULT_SESSION_CONFIG), envConfig), {
    timeout: __assign(__assign({}, exports.DEFAULT_SESSION_CONFIG.timeout), envConfig.timeout),
    security: __assign(__assign({}, exports.DEFAULT_SESSION_CONFIG.security), envConfig.security),
  });
}
// ============================================================================
...
function createCustomConfig(overrides) {
  ...
  return __assign(__assign(__assign({}, baseConfig), overrides), {
    timeout: __assign(__assign({}, baseConfig.timeout), overrides.timeout),
    security: __assign(__assign({}, baseConfig.security), overrides.security),
    activity: __assign(__assign({}, baseConfig.activity), overrides.activity),
  });
}
/**
...
exports.sessionConfig = __assign(__assign({}, exports.FINAL_CONFIG), {
  cleanup: exports.DEFAULT_CLEANUP_CONFIG,
  device: exports.DEFAULT_DEVICE_CONFIG,
  security: exports.DEFAULT_SECURITY_CONFIG,
  notification: exports.DEFAULT_NOTIFICATION_CONFIG,
