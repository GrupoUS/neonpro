...
var UnifiedSessionSystem = /** @class */ (function () {
    function UnifiedSessionSystem(config) {
        ...
        this.updateActivityTracking = (0, utils_1.debounce)(function (sessionId) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                inactivityTimer = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.handleSessionInactivity(sessionId)];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
        ...
        this.config = {
            session: __assign(__assign({}, config_1.sessionConfig.session), config === null || config === void 0 ? void 0 : config.session),
            device: __assign(__assign({}, config_1.sessionConfig.device), config === null || config === void 0 ? void 0 : config.device),
            security: __assign(__assign({}, config_1.sessionConfig.security), config === null || config === void 0 ? void 0 : config.security)
        };
        ...
        this.notificationService = new NotificationService_1.NotificationService(this.config.security.notifications);
        this.cleanupService = new DataCleanupService_1.DataCleanupService(this.config.security.retentionDays);
    ...
    UnifiedSessionSystem.prototype.authenticateUser = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, deviceResult, device, riskScore, _a, _b, sessionTimeout, sessionResult, session, error_1;
            var _c, _d;
            var _e, _f, _g, _h, _j;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        startTime = Date.now();
                        return [4 /*yield*/, this.deviceManager.registerDevice({
                                userId: request.userId,
                                fingerprint: request.deviceFingerprint || (0, utils_1.generateDeviceFingerprint)(request.deviceInfo),
                                name: ((_e = request.deviceInfo) === null || _e === void 0 ? void 0 : _e.name) || 'Unknown Device',
                                type: ((_f = request.deviceInfo) === null || _f === void 0 ? void 0 : _f.type) || 'unknown',
                                userAgent: request.userAgent,
                                ipAddress: request.ipAddress,
                                location: request.location,
                                screen: (_g = request.deviceInfo) === null || _g === void 0 ? void 0 : _g.screen,
                                timezone: (_h = request.deviceInfo) === null || _h === void 0 ? void 0 : _h.timezone,
                                language: (_j = request.deviceInfo) === null || _j === void 0 ? void 0 : _j.language
                            })];
                    case 1:
                        deviceResult = _k.sent();
                        if (!!deviceResult.success) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.securityLogger.logEvent({
                                userId: request.userId,
                    ...
                    case 5: return [4 /*yield*/, _b.apply(_a, [(_c.details = (_d.factors = _k.sent(), _d),
                                _c)])];
                    case 6:
                        _k.sent();
                        return [2 /*return*/, {
                    ...
                    case 7: return [4 /*yield*/, this.calculateSessionTimeout(request.userId)];
                    case 8:
                        sessionTimeout = _k.sent();
                        return [4 /*yield*/, this.sessionManager.createSession({
                                userId: request.userId,
                                deviceId: device.id,
                                ipAddress: request.ipAddress,
                                userAgent: request.userAgent,
                                ...
                                metadata: __assign({ riskScore: riskScore, authenticationTime: Date.now() - startTime, deviceTrusted: device.trusted }, request.metadata)
                            })];
                    case 9:
                    ...
                    case 13:
                        ...
                        return [4 /*yield*/, this.notificationService.sendNotification({
                                userId: request.userId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(timeToExpiry < extendThreshold && this.config.session.extendOnActivity)) return [3 /*break*/, 3];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        // Update activity tracking
                        _d.sent();
                        if (!(activity === null || activity === void 0 ? void 0 : activity.significantActivity)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.securityLogger.logEvent({
                    ...
                    case 4:
                        ...
                        if (!(activity === null || activity === void 0 ? void 0 : activity.significantActivity)) return [3 /*break*/, 6];
                    ...
                    case 6:
                        _a = undefined;
                        _d.label = 7;
                    case 7: return [2 /*return*/, (_b.data = (_c.securityEvent = _a,
                            _c),
    ...
    UnifiedSessionSystem.prototype.terminateSession = function (sessionId_1) {
        return __awaiter(this, arguments, void 0, function (sessionId, reason) {
            ...
            var _a, _b;
            if (reason === void 0) { reason = 'user_logout'; }
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.securityLogger.getLatestEvent(session.userId)];
                    case 3: return [2 /*return*/, (_a.data = (_b.securityEvent = _c.sent(),
                            _b),
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(sessions.map(function (session) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.deviceManager.getDevice(session.deviceId)];
                                        case 1:
                                            deviceResult = _a.sent();
                                            device = deviceResult.success ? deviceResult.data : null;
                                            return [2 /*return*/, __assign(__assign({}, session), { device: device, isActive: this.activityTrackers.has(session.id), timeToExpiry: new Date(session.expiresAt).getTime() - Date.now() })];
                                    }
                                });
                            }); }))];
                    case 2:
    ...
    UnifiedSessionSystem.prototype.setupSessionTimeoutTracking = function (session) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (warningTime > 0) {
                    warningTimer = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.sendSessionWarning(session.id, '5 minutes')];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                ...
                if (finalWarningTime > 0) {
                    finalWarningTimer = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.sendSessionWarning(session.id, '1 minute')];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                ...
                expiryTimer = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.handleSessionExpiry(session.id)];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.notificationService.sendNotification({
                                ...
                                message: "Your session will expire in ".concat(timeRemaining, ". Please save your work."),
                                data: {
                                    sessionId: sessionId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.sessionManager.extendSession(sessionId, new Date(newExpiryTime).toISOString())];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.securityLogger.getRecentFailedAttempts(request.userId, 60 * 60 * 1000)];
                    case 1:
    ...
    UnifiedSessionSystem.prototype.startSecurityMonitoring = function () {
        ...
        this.securityMonitor = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            var error_11;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    UnifiedSessionSystem.prototype.startCleanupScheduler = function () {
        ...
        this.cleanupScheduler = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            var error_12;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    UnifiedSessionSystem.prototype.performSecurityCheck = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.securityLogger.detectSuspiciousPatterns()];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.handleSecurityThreat({
    ...
    UnifiedSessionSystem.prototype.performScheduledCleanup = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cleanupService.performCleanup({
    ...
    UnifiedSessionSystem.prototype.authenticateWithTrustedDevice = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.deviceManager.getDeviceByFingerprint(request.deviceFingerprint)];
                    case 1:
                        deviceResult = _b.sent();
                        if (!deviceResult.success || !((_a = deviceResult.data) === null || _a === void 0 ? void 0 : _a.trusted)) {
                            return [2 /*return*/, {
                                    success: false,
                                    error: {
                        ...
                        return [2 /*return*/, this.authenticateUser(__assign(__assign({}, request), { deviceInfo: {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!(sessionsResult.success && ((_a = sessionsResult.data) === null || _a === void 0 ? void 0 : _a.sessions))) return [3 /*break*/, 4];
                        return [4 /*yield*/, Promise.all(sessionsResult.data.sessions.map(function (session) {
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, {
                                ...
                                error: {
                                    ...
                                    details: { error: error_13 instanceof Error ? error_13.message : 'Unknown error' }
                                },
                                timestamp: new Date().toISOString()
                            }];
                    case 6: return [2 /*return*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.securityLogger.getEventsByDateRange(period.startDate.toISOString(), period.endDate.toISOString())];
                    case 1:
                        events = _a.sent();
                    ...
                    case 2:
                        ...
                        report = {
                            ...
                            summary: {
                                ...
                                criticalEvents: events.filter(function (e) { return e.severity === 'critical'; }).length,
                                highEvents: events.filter(function (e) { return e.severity === 'high'; }).length,
                                mediumEvents: events.filter(function (e) { return e.severity === 'medium'; }).length,
                                lowEvents: events.filter(function (e) { return e.severity === 'low'; }).length
                            },
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, {
                                ...
                                error: {
                                    ...
                                    details: { error: error_14 instanceof Error ? error_14.message : 'Unknown error' }
                                },
                                timestamp: new Date().toISOString()
                            }];
                    case 4: return [2 /*return*/];
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                error: {
                                    ...
                                    details: { error: error_15 instanceof Error ? error_15.message : 'Unknown error' }
                                },
                                timestamp: new Date().toISOString()
                            }];
                    case 3: return [2 /*return*/];
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                error: {
                                    ...
                                    details: { error: error_16 instanceof Error ? error_16.message : 'Unknown error' }
                                },
                                timestamp: new Date().toISOString()
                            }];
                    case 3: return [2 /*return*/];
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                error: {
                                    ...
                                    details: { error: error_17 instanceof Error ? error_17.message : 'Unknown error' }
                                },
                                timestamp: new Date().toISOString()
                            }];
                    case 3: return [2 /*return*/];
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                error: {
                                    ...
                                    details: { error: error_18 instanceof Error ? error_18.message : 'Unknown error' }
                                },
                                timestamp: new Date().toISOString()
                            }];
                    case 3: return [2 /*return*/];
    ...
    UnifiedSessionSystem.prototype.shutdown = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // Clear all timers
                this.activityTrackers.forEach(function (timer) { return clearTimeout(timer); });
                this.sessionWarnings.forEach(function (timer) { return clearTimeout(timer); });
