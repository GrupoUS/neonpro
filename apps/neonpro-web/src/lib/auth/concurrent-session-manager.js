...
var ConcurrentSessionManager = /** @class */ (function () {
     ...
     */
    ConcurrentSessionManager.prototype.createSession = function (userId, userRole, deviceInfo, metadata) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.enforceSessionLimits(userId, userRole, deviceInfo.deviceId, activeSessions, limits)];
                    case 2:
                    ...
                    case 4:
                        // Log session creation
                        _a.sent();
                        if (!(limits.notifyOnNewSession && terminatedSessions.length === 0)) return [3 /*break*/, 6];
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.auditLogger.logSecurityEvent({
                                ...
                                metadata: __assign({ reason: reason.type, message: reason.message, terminatedBy: terminatedBy, sessionDuration: Date.now() - session.createdAt.getTime() }, reason.metadata)
                            })];
                    case 3:
                        // Log session termination
                        _a.sent();
     ...
     */
    ConcurrentSessionManager.prototype.terminateAllUserSessions = function (userId, reason, excludeSessionId, terminatedBy) {
        return __awaiter(this, void 0, void 0, function () {
            var activeSessions, sessionsToTerminate, terminatedSessionIds, _i, sessionsToTerminate_1, session, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                    ...
                    case 1:
                        ...
                        sessionsToTerminate = excludeSessionId
                            ? activeSessions.filter(function (s) { return s.sessionId !== excludeSessionId; })
                            : activeSessions;
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, terminatedSessionIds];
                    case 6:
                        error_4 = _a.sent();
    ...
    ConcurrentSessionManager.prototype.getSessionStatistics = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _a, activeSessions, activeError, yesterday, terminationQuery, _b, recentTerminations, terminationError, sessionsByRole, sessionsByDevice, totalDuration, _i, _c, session, deviceType, duration, averageSessionDuration, error_7;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        if (terminationError) {
                            throw new Error("Failed to get recent terminations: ".concat(terminationError.message));
                        }
                        sessionsByRole = {
                            owner: 0,
                            manager: 0,
                        ...
                        averageSessionDuration = (activeSessions === null || activeSessions === void 0 ? void 0 : activeSessions.length)
                            ? totalDuration / activeSessions.length
                            : 0;
                        return [2 /*return*/, {
                                totalActiveSessions: (activeSessions === null || activeSessions === void 0 ? void 0 : activeSessions.length) || 0,
                                sessionsByRole: sessionsByRole,
                                sessionsByDevice: sessionsByDevice,
                                averageSessionDuration: averageSessionDuration,
                                recentTerminations: (recentTerminations === null || recentTerminations === void 0 ? void 0 : recentTerminations.length) || 0
                            }];
                    case 3:
                        error_7 = _d.sent();
    ...
    ConcurrentSessionManager.prototype.updateSessionLimits = function (role, limits) {
        this.sessionLimits[role] = __assign(__assign(__assign({}, this.sessionLimits[role]), limits), { role: role });
    };
    /**
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                .in('session_id', expiredSessions.map(function (s) { return s.session_id; }))];
                    case 2:
    ...
    ConcurrentSessionManager.prototype.enforceSessionLimits = function (userId, userRole, deviceId, activeSessions, limits) {
        return __awaiter(this, void 0, void 0, function () {
            var terminatedSessions, otherDeviceSessions, _i, otherDeviceSessions_1, session, deviceSessions, sessionsToTerminate, _a, sessionsToTerminate_2, session, remainingSessions, sessionsToTerminate, _b, sessionsToTerminate_3, session;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        terminatedSessions = [];
                        if (!!limits.allowMultipleDevices) return [3 /*break*/, 4];
                        otherDeviceSessions = activeSessions.filter(function (s) { return s.deviceId !== deviceId; });
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.terminateSession(session.sessionId, {
                                type: 'device_change',
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        deviceSessions = activeSessions.filter(function (s) { return s.deviceId === deviceId; });
                        if (!(deviceSessions.length >= limits.maxSessionsPerDevice)) return [3 /*break*/, 8];
                        sessionsToTerminate = deviceSessions
                            .sort(function (a, b) { return a.lastActivity.getTime() - b.lastActivity.getTime(); })
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 5];
                    case 8:
                        remainingSessions = activeSessions.filter(function (s) { return !terminatedSessions.includes(s.sessionId); });
                    ...
                    case 11:
                        _b++;
                        return [3 /*break*/, 9];
                    case 12: return [2 /*return*/, terminatedSessions];
                }
            });
        });
    };
