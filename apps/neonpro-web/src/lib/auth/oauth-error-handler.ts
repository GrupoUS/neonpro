...
class OAuthErrorHandler {
   ...
   */
  private getNetworkErrorDetails(error: any, context: OAuthErrorContext): OAuthErrorDetails {
    return {
      code: "network_error",
  ...
  private async handleRedirectAction(
    ...
    if (context.sessionId) {
      await sessionManager.terminateSession(context.sessionId, "error_recovery_redirect");
    }
