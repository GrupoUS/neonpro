...
var TrialManagementEngine = /** @class */ (function () {
    ...
    TrialManagementEngine.prototype.createTrial = function (userId_1) {
        return __awaiter(this, arguments, void 0, function (userId, signupSource) {
            ...
            if (signupSource === void 0) { signupSource = 'website'; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Failed to create trial: ".concat(error.message));
    ...
    TrialManagementEngine.prototype.updateTrialStage = function (trialId_1, newStage_1) {
        return __awaiter(this, arguments, void 0, function (trialId, newStage, trigger) {
            var _a, currentTrial, fetchError, journey, conversionProbability, _b, updatedTrial, updateError;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (fetchError)
                            throw new Error("Trial not found: ".concat(fetchError.message));
                        return [4 /*yield*/, this.getUserJourney(trialId)];
                    case 2:
                        journey = _c.sent();
                        return [4 /*yield*/, this.calculateConversionProbability(this.mapDatabaseToTrial(currentTrial), journey)
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.logStageTransition(trialId, currentTrial.trial_status, newStage, trigger)
    ...
    TrialManagementEngine.prototype.predictConversion = function (trialId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getTrial(trialId)];
                    case 1:
                        trial = _a.sent();
                        if (!trial)
    ...
    TrialManagementEngine.prototype.calculateConversionProbability = function (trial, journey) {
        return __awaiter(this, void 0, void 0, function () {
            var factors, probability, engagementScore, timeUrgency, featureAdoption, supportInteraction, emailEngagement, collaborativeBoost;
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, this.calculateConversionFactors(trial, journey)];
                    case 1:
                        factors = _e.sent();
                        probability = 0.1 // base probability
                        ;
                        engagementScore = ((_a = factors.find(function (f) { return f.name === 'engagement'; })) === null || _a === void 0 ? void 0 : _a.value) || 0;
                        probability += (engagementScore / 100) * 0.4;
                        timeUrgency = Math.max(0, 1 - (trial.daysRemaining / 14));
                        probability += timeUrgency * 0.2;
                        featureAdoption = ((_b = factors.find(function (f) { return f.name === 'feature_adoption'; })) === null || _b === void 0 ? void 0 : _b.value) || 0;
                        probability += (featureAdoption / 100) * 0.25;
                        supportInteraction = ((_c = factors.find(function (f) { return f.name === 'support_interaction'; })) === null || _c === void 0 ? void 0 : _c.value) || 0;
                        probability += (supportInteraction / 100) * 0.1;
                        emailEngagement = ((_d = factors.find(function (f) { return f.name === 'email_engagement'; })) === null || _d === void 0 ? void 0 : _d.value) || 0;
    ...
    TrialManagementEngine.prototype.calculateConversionFactors = function (trial, journey) {
        return __awaiter(this, void 0, void 0, function () {
            var factors, engagementEvents, engagementScore, uniqueFeatures, featureAdoptionScore, timeUrgency, supportEvents, supportScore, emailEvents, emailScore;
            return __generator(this, function (_a) {
                factors = [];
                engagementEvents = journey.events.filter(function (e) { return e.type === 'feature_usage'; });
                ...
                uniqueFeatures = new Set(journey.events
                    .filter(function (e) { return e.type === 'feature_usage'; })
                    .map(function (e) { return e.data.featureId; })).size;
                ...
                supportEvents = journey.events.filter(function (e) { return e.type === 'support_contact'; });
                ...
                emailEvents = journey.events.filter(function (e) { return e.type === 'email_interaction'; });
    ...
    TrialManagementEngine.prototype.generateConversionRecommendations = function (trial, factors) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                recommendations = [];
                engagementFactor = factors.find(function (f) { return f.name === 'engagement'; });
                featureFactor = factors.find(function (f) { return f.name === 'feature_adoption'; });
                timeFactor = factors.find(function (f) { return f.name === 'time_urgency'; });
    ...
    TrialManagementEngine.prototype.determineOptimalStrategy = function (trial, factors) {
        var _a, _b;
        var engagementValue = ((_a = factors.find(function (f) { return f.name === 'engagement'; })) === null || _a === void 0 ? void 0 : _a.value) || 0;
        var featureValue = ((_b = factors.find(function (f) { return f.name === 'feature_adoption'; })) === null || _b === void 0 ? void 0 : _b.value) || 0;
    ...
    TrialManagementEngine.prototype.calculatePredictionConfidence = function (factors) {
        ...
        var totalDataPoints = factors.reduce(function (sum, f) { return sum + f.value; }, 0);
    ...
    TrialManagementEngine.prototype.calculateFactorConsistency = function (factors) {
        var positiveFactors = factors.filter(function (f) { return f.impact === 'positive'; }).length;
        var negativeFactors = factors.filter(function (f) { return f.impact === 'negative'; }).length;
        var neutralFactors = factors.filter(function (f) { return f.impact === 'neutral'; }).length;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!similarUsers || similarUsers.length === 0)
                            return [2 /*return*/, 0];
                        avgConversionRate = similarUsers.reduce(function (sum, user) {
    ...
    TrialManagementEngine.prototype.trackEvent = function (trialId_1, eventType_1, data_1) {
        return __awaiter(this, arguments, void 0, function (trialId, eventType, data, source) {
            var event;
            if (source === void 0) { source = 'webapp'; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        event = {
                    ...
                    case 1:
                        ...
                        _a.sent();
                        // Update trial engagement score
                        return [4 /*yield*/, this.updateTrialEngagement(trialId)
    ...
    TrialManagementEngine.prototype.determineTrialStage = function (trial, journey) {
        ...
        var featureUsageEvents = journey.events.filter(function (e) { return e.type === 'feature_usage'; }).length;
        var uniqueFeatures = new Set(journey.events
            .filter(function (e) { return e.type === 'feature_usage'; })
            .map(function (e) { return e.data.featureId; })).size;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Failed to get journey: ".concat(error.message));
                        return [4 /*yield*/, this.getTrial(trialId)];
                    case 2:
                        trial = _c.sent();
                        if (!trial)
                            throw new Error('Trial not found');
                        mappedEvents = (events === null || events === void 0 ? void 0 : events.map(function (event) { return ({
                            id: event.id,
                    ...
                    case 3: return [2 /*return*/, (_b.stageHistory = _c.sent(),
                            _b)];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, this.trackEvent(trialId, 'page_view', {
    ...
    TrialManagementEngine.prototype.logStageTransition = function (trialId, fromStage, toStage, trigger) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.supabase
        ...
        var milestones = [
            {
                ...
                completed: events.some(function (e) { return e.type === 'page_view' && e.data.page === 'dashboard'; }),
                completedAt: (_a = events.find(function (e) { return e.type === 'page_view' && e.data.page === 'dashboard'; })) === null || _a === void 0 ? void 0 : _a.timestamp,
                importance: 0.8,
                category: 'onboarding'
            },
            {
                ...
                completed: events.some(function (e) { return e.type === 'feature_usage'; }),
                completedAt: (_b = events.find(function (e) { return e.type === 'feature_usage'; })) === null || _b === void 0 ? void 0 : _b.timestamp,
                importance: 0.9,
                category: 'engagement'
            },
            {
                ...
                completed: new Set(events.filter(function (e) { return e.type === 'feature_usage'; }).map(function (e) { return e.data.featureId; })).size >= 3,
                completedAt: events.filter(function (e) { return e.type === 'feature_usage'; }).length >= 3 ?
                    (_c = events.filter(function (e) { return e.type === 'feature_usage'; })[2]) === null || _c === void 0 ? void 0 : _c.timestamp : undefined,
                importance: 0.95,
            ...
            },
            {
                ...
                completed: events.some(function (e) { return e.type === 'support_contact'; }),
                completedAt: (_d = events.find(function (e) { return e.type === 'support_contact'; })) === null || _d === void 0 ? void 0 : _d.timestamp,
                importance: 0.7,
                category: 'engagement'
            }
        ];
    ...
    TrialManagementEngine.prototype.calculateProgressScore = function (events, milestones) {
        ...
        var totalImportance = milestones.reduce(function (sum, m) { return sum + m.importance; }, 0);
        var completedImportance = completedMilestones.reduce(function (sum, m) { return sum + m.importance; }, 0);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, (transitions === null || transitions === void 0 ? void 0 : transitions.map(function (t) { return ({
