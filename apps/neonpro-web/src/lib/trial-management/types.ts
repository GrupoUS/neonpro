...
export type TrialStage = 'signup' | 'onboarding' | 'active' | 'at_risk' | 'converting' | 'converted' | 'expired' | 'cancelled'
export type ConversionStrategy = 'engagement_boost' | 'feature_highlight' | 'discount_offer' | 'demo_scheduling' | 'urgency_reminder'
export type UserSegment = 'power_user' | 'casual_user' | 'explorer' | 'passive' | 'high_value' | 'at_risk'
...
export interface JourneyEvent {
  id: string
  type: 'feature_usage' | 'page_view' | 'email_interaction' | 'support_contact' | 'upgrade_attempt'
  timestamp: Date
...
export interface JourneyMilestone {
  ...
  completedAt?: Date
  importance: number
  category: 'onboarding' | 'engagement' | 'value_realization' | 'conversion_readiness'
}
...
export interface CallToAction {
  text: string
  action: 'upgrade' | 'schedule_demo' | 'contact_sales' | 'extend_trial' | 'feature_tour'
  url?: string
...
export const TrialStageSchema = z.enum(['signup', 'onboarding', 'active', 'at_risk', 'converting', 'converted', 'expired', 'cancelled'])
export const ConversionStrategySchema = z.enum(['engagement_boost', 'feature_highlight', 'discount_offer', 'demo_scheduling', 'urgency_reminder'])
export const UserSegmentSchema = z.enum(['power_user', 'casual_user', 'explorer', 'passive', 'high_value', 'at_risk'])
export const EngagementLevelSchema = z.enum(['very_high', 'high', 'medium', 'low', 'very_low'])
