...
var TrialAnalyticsIntegration = /** @class */ (function () {
    ...
    TrialAnalyticsIntegration.prototype.trackTrialConversion = function (trial, conversionData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.analytics.trackConversion({
                            userId: trial.userId,
                            trialId: trial.id,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        event_1 = _a[_i];
                        return [4 /*yield*/, this.analytics.trackEvent({
                                userId: journey.userId,
                                eventType: "trial_".concat(event_1.type),
                                timestamp: event_1.timestamp,
                                properties: __assign({ trialId: journey.trialId, stage: event_1.stage }, event_1.data)
                            })];
                    case 2:
                        _b.sent();
                        _b.label = 3;
    ...
    TrialAnalyticsIntegration.prototype.generateTrialMetrics = function (timeRange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.analytics.getTrialMetrics(timeRange)];
                    case 1:
    ...
    TrialAnalyticsIntegration.prototype.trackCampaignOutcome = function (campaignId, outcome) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.analytics.trackEvent({
    ...
    TrialAnalyticsIntegration.prototype.getTrialOptimizationInsights = function (trialId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.trialManager.predictConversion(trialId)];
                    case 1:
                        prediction = _b.sent();
                    ...
                    case 3:
                        ...
                        _a = {
                            ...
                            riskFactors: prediction.factors.filter(function (f) { return f.impact < 0; }),
                            opportunities: prediction.factors.filter(function (f) { return f.impact > 0; }),
                    ...
                    case 4: return [2 /*return*/, (_a.benchmarkComparison = _b.sent(),
                            _a)];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        _b.realTime = (_c.averageEngagement = _e.sent(),
                            _c);
                        _d = {
                    ...
                    case 3: return [2 /*return*/, (_b.trends = (_d.engagementTrend = _e.sent(),
                            _d),
    ...
    TrialAnalyticsIntegration.prototype.analyzeJourneyPatterns = function (journey) {
        return {
            ...
            criticalEvents: journey.events.filter(function (e) { return e.type === 'feature_discovered' || e.type === 'milestone_reached'; }),
    ...
    TrialAnalyticsIntegration.prototype.identifyDropOffPoints = function (journey) {
        var dropOffs = [];
        var events = journey.events.sort(function (a, b) { return a.timestamp.getTime() - b.timestamp.getTime(); });
