      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) throw new Error("Failed to create campaign: ".concat(error.message));
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.estimateAudienceSize(campaign.target),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("trial_campaigns").select("*").eq("id", campaignId).single(),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
  ...
  CampaignManager.prototype.getEligibleTrials = function (target) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            query = this.supabase.from("trial_analytics").select("*");
          ...
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw new Error("Failed to get eligible trials: ".concat(error.message));
            return [
              2 /*return*/,
  ...
  CampaignManager.prototype.estimateAudienceSize = function (target) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getEligibleTrials(target)];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("campaign_ab_tests").insert({
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("campaign_ab_test_results").insert({
                campaign_id: campaignId,
                user_id: userId,
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.personalizeContent(campaign.content, trial),
          ...
          case 5:
            ...
            return [3 /*break*/, 12];
          case 6:
            return [4 /*yield*/, this.sendEmail(trial.userId, personalizedContent)];
          case 7:
            _c.sent();
            return [3 /*break*/, 12];
          case 8:
            return [4 /*yield*/, this.showInAppMessage(trial.userId, personalizedContent)];
          case 9:
            _c.sent();
            return [3 /*break*/, 12];
          case 10:
            return [4 /*yield*/, this.sendPushNotification(trial.userId, personalizedContent)];
          case 11:
            _c.sent();
            return [3 /*break*/, 12];
          case 12:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("profiles").select("full_name").eq("id", trial.userId).single(),
            ];
          case 1:
            user = _a.sent().data;
            personalizedMessage = personalizedMessage.replace(
              "{{user_name}}",
              (user === null || user === void 0 ? void 0 : user.full_name) || "there",
            );
            _a.label = 2;
          case 2:
          ...
          case 4:
            return [
              2 /*return*/,
              __assign(__assign({}, content), { message: personalizedMessage }),
            ];
        }
      });
    });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("campaign_deliveries").insert({
                campaign_id: campaignId,
                user_id: userId,
                variant_id: variant,
