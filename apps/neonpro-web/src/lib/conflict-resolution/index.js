...
exports.ResourceOptimizer = exports.ResolutionEngine = exports.ConflictDetector = exports.IntelligentConflictResolutionSystem = void 0;
...
var IntelligentConflictResolutionSystem = /** @class */ (function () {
    function IntelligentConflictResolutionSystem(supabaseUrl, supabaseKey, config, constraints, automationSettings) {
        this.analyticsCache = new Map();
        this.supabase = (0, supabase_js_1.createClient)(supabaseUrl, supabaseKey);
        // Default configuration
        this.config = __assign({ weights: {
        ...
        // Default constraints
        this.constraints = __assign({ maxStaffUtilization: 0.9, minStaffUtilization: 0.4, maxRoomUtilization: 0.95, minRoomUtilization: 0.3, maxEquipmentUtilization: 0.9, minEquipmentUtilization: 0.2, businessHours: {
                start: '08:00',
                end: '18:00'
            }, maxOvertimeHours: 2, minBufferTime: 15, maxReschedulingWindow: 7 }, constraints);
        // Default automation settings
        this.automationSettings = __assign({ autoDetection: true, autoResolution: false, autoOptimization: false, notificationSettings: {
        ...
        this.conflictDetector = new conflict_detector_1.ConflictDetector(supabaseUrl, supabaseKey, this.config, this.constraints);
        this.resolutionEngine = new resolution_engine_1.ResolutionEngine(supabaseUrl, supabaseKey, this.config, this.constraints);
        this.resourceOptimizer = new resource_optimizer_1.ResourceOptimizer(supabaseUrl, supabaseKey, this.config, this.constraints);
     ...
     */
    IntelligentConflictResolutionSystem.prototype.detectAndResolveConflicts = function (startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function (startDate, endDate, autoResolve) {
            var start, end, conflicts, startTime, resolutions, appliedResolutions, _i, conflicts_1, conflict, conflictResolutions, bestResolution, result, error_1, optimizations, executionTime, error_2;
            if (autoResolve === void 0) { autoResolve = false; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (!(autoResolve && this.shouldAutoResolve(conflictResolutions))) return [3 /*break*/, 8];
                    ...
                    case 8:
                        _i++;
                        return [3 /*break*/, 3];
                    case 9: return [4 /*yield*/, this.generateSystemOptimizations(start, end)];
                    case 10:
     ...
     */
    IntelligentConflictResolutionSystem.prototype.detectConflicts = function (startDate, endDate, conflictTypes) {
     ...
     */
    IntelligentConflictResolutionSystem.prototype.generateResolutions = function (conflictId, strategies) {
        return __awaiter(this, void 0, void 0, function () {
            var conflict;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getConflictById(conflictId)];
                    case 1:
                        conflict = _a.sent();
                        if (!conflict) {
    ...
    IntelligentConflictResolutionSystem.prototype.applyResolution = function (resolutionId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resolutionEngine.applyResolution(resolutionId)];
                    case 1:
                        result = _a.sent();
                        this.performanceMetrics.conflictsResolved++;
                        this.performanceMetrics.lastUpdated = new Date();
     ...
     */
    IntelligentConflictResolutionSystem.prototype.optimizeResources = function (startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function (startDate, endDate, strategy) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resourceOptimizer.optimizeResources(startDate, endDate, strategy)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    IntelligentConflictResolutionSystem.prototype.balanceWorkload = function (startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function (startDate, endDate, targetUtilization) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resourceOptimizer.balanceWorkload(startDate, endDate, targetUtilization)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    IntelligentConflictResolutionSystem.prototype.applyOptimization = function (optimizationId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resourceOptimizer.applyOptimization(optimizationId)];
                    case 1:
                        result = _a.sent();
     ...
     */
    IntelligentConflictResolutionSystem.prototype.getSystemAnalytics = function (startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function (startDate, endDate, includeForecasting) {
            var cacheKey, conflictAnalytics, resolutionAnalytics, optimizationAnalytics, resourceMetrics, forecasting, analytics, error_3;
            var _a;
            if (includeForecasting === void 0) { includeForecasting = true; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        cacheKey = "analytics-".concat(startDate.toISOString(), "-").concat(endDate.toISOString(), "-").concat(includeForecasting);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.resourceOptimizer.calculateResourceMetrics(startDate, endDate)];
                    case 5:
    ...
    IntelligentConflictResolutionSystem.prototype.getPerformanceMetrics = function () {
        return __assign(__assign({}, this.performanceMetrics), { systemUptime: Date.now() - this.performanceMetrics.systemUptime });
    };
    /**
     * Update system configuration
     */
    IntelligentConflictResolutionSystem.prototype.updateConfiguration = function (config, constraints, automationSettings) {
        if (config) {
        ...
        setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.detectAndResolveConflicts(new Date(), new Date(Date.now() + 24 * 60 * 60 * 1000), // Next 24 hours
     ...
     */
    IntelligentConflictResolutionSystem.prototype.generateSystemOptimizations = function (startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        optimizations = [];
                        return [4 /*yield*/, this.resourceOptimizer.optimizeResources(startDate, endDate, types_1.OptimizationStrategy.BALANCED)];
                    case 1:
                        resourceOpt = _b.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.resourceOptimizer.calculateResourceMetrics(startDate, endDate)];
                    case 3:
                        _a.currentMetrics = _b.sent(),
                            _a.recommendations = [];
                        return [4 /*yield*/, this.resourceOptimizer.calculateResourceMetrics(startDate, endDate)];
                    case 4:
                        workloadOpt = (_a.expectedImprovements = _b.sent(),
                        ...
                        _b.label = 5;
                    case 5: return [2 /*return*/, optimizations];
                }
            });
        });
    };
    ...
    IntelligentConflictResolutionSystem.prototype.shouldAutoResolve = function (resolutions) {
        ...
        return (bestResolution.confidence >= this.config.thresholds.autoResolutionConfidence &&
    ...
    IntelligentConflictResolutionSystem.prototype.calculateSuccessRate = function () {
        if (this.performanceMetrics.conflictsDetected === 0)
            return 1.0;
     ...
     */
    IntelligentConflictResolutionSystem.prototype.getConflictAnalytics = function (startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    IntelligentConflictResolutionSystem.prototype.getResolutionAnalytics = function (startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    IntelligentConflictResolutionSystem.prototype.getOptimizationAnalytics = function (startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    IntelligentConflictResolutionSystem.prototype.generateForecasting = function (startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
...
Object.defineProperty(exports, "ConflictDetector", { enumerable: true, get: function () { return conflict_detector_2.ConflictDetector; } });
var resolution_engine_2 = require("./resolution-engine");
Object.defineProperty(exports, "ResolutionEngine", { enumerable: true, get: function () { return resolution_engine_2.ResolutionEngine; } });
var resource_optimizer_2 = require("./resource-optimizer");
Object.defineProperty(exports, "ResourceOptimizer", { enumerable: true, get: function () { return resource_optimizer_2.ResourceOptimizer; } });
// Default export
