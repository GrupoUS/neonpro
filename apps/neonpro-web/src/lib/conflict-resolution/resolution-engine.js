...
var ConflictResolutionEngine = /** @class */ (function () {
    function ConflictResolutionEngine(supabaseUrl, supabaseKey, conflictDetector, config, constraints) {
        ...
        this.config = __assign({ prioritizePatientSatisfaction: true, prioritizeStaffWorkload: true, prioritizeResourceUtilization: true, prioritizeFinancialImpact: false, weights: {
        ...
        this.constraints = __assign({ maxReschedulingDistance: 24, minStaffBreakTime: 15, maxDailyWorkHours: 8, requiredEquipmentAvailability: 0.95, maxRoomCapacityUtilization: 0.9, businessHours: { start: '08:00', end: '18:00' }, excludedDays: ['sunday'] }, constraints);
    }
    /**
    ...
    ConflictResolutionEngine.prototype.generateResolutions = function (conflictId) {
        return __awaiter(this, void 0, void 0, function () {
            var conflict, appointments, resources, resolutions, rescheduleOptions, earlierOptions, resourceOptions, restructureOptions, alternativeOptions, evaluatedResolutions, rankedResolutions, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        resources = _a.sent();
                        resolutions = [];
                        return [4 /*yield*/, this.generateRescheduleOptions(conflict, appointments, resources, 'later')];
                    case 4:
                        rescheduleOptions = _a.sent();
                        resolutions.push.apply(resolutions, rescheduleOptions);
                        return [4 /*yield*/, this.generateRescheduleOptions(conflict, appointments, resources, 'earlier')];
                    case 5:
                        earlierOptions = _a.sent();
                        resolutions.push.apply(resolutions, earlierOptions);
                        return [4 /*yield*/, this.generateResourceChangeOptions(conflict, appointments, resources)];
                    case 6:
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, this.generateAlternativeOptions(conflict, appointments, resources)];
                    case 8:
     ...
     */
    ConflictResolutionEngine.prototype.generateRescheduleOptions = function (conflict, appointments, resources, direction) {
        return __awaiter(this, void 0, void 0, function () {
            var options, _i, appointments_1, appointment, availableSlots, _a, _b, slot, proposedChanges, impact, confidence;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.findAvailableSlots(appointment, resources, direction, this.constraints.maxReschedulingDistance)];
                    case 2:
                    ...
                    case 4:
                        ...
                        options.push({
                            id: "reschedule_".concat(direction, "_").concat(appointment.id, "_").concat(slot.start.getTime()),
                            strategy: direction === 'later' ? types_1.ResolutionStrategy.RESCHEDULE_LATER : types_1.ResolutionStrategy.RESCHEDULE_EARLIER,
                            description: "Reschedule appointment ".concat(direction, " to ").concat(slot.start.toLocaleString()),
     ...
     */
    ConflictResolutionEngine.prototype.generateResourceChangeOptions = function (conflict, appointments, resources) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        _loop_1 = function (appointment) {
                            var alternativeStaff, _b, _c, staff, proposedChanges, impact, alternativeRooms, _d, _e, room, proposedChanges, impact;
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    case 0:
                                        if (!(appointment.staff_id && resources.staff)) return [3 /*break*/, 5];
                                        return [4 /*yield*/, this_1.findAlternativeStaff(appointment, resources.staff, new Date(appointment.start_time), new Date(appointment.end_time))];
                                    case 1:
                                    ...
                                    case 2:
                                        ...
                                        return [4 /*yield*/, this_1.calculateResolutionImpact(proposedChanges, conflict)];
                                    case 3:
                                        impact = _f.sent();
                                        options.push({
                                            ...
                                            metadata: {
                                                originalStaff: resources.staff.find(function (s) { return s.id === appointment.staff_id; }),
                                                newStaff: staff,
                                    ...
                                    case 5:
                                        ...
                                        return [4 /*yield*/, this_1.findAlternativeRooms(appointment, resources.rooms, new Date(appointment.start_time), new Date(appointment.end_time))];
                                    case 6:
                                    ...
                                    case 8:
                                        ...
                                        options.push({
                                            ...
                                            metadata: {
                                                originalRoom: resources.rooms.find(function (r) { return r.id === appointment.room_id; }),
                                                newRoom: room,
                                                appointment: appointment
                                            }
                                        });
     ...
     */
    ConflictResolutionEngine.prototype.generateRestructureOptions = function (conflict, appointments) {
        return __awaiter(this, void 0, void 0, function () {
            var options, _i, appointments_3, appointment, duration, durationMinutes, splitOptions, mergeOptions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = [];
                    ...
                    case 1:
                        ...
                        duration = new Date(appointment.end_time).getTime() - new Date(appointment.start_time).getTime();
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6: return [2 /*return*/, options];
                }
            });
        });
    };
     ...
     */
    ConflictResolutionEngine.prototype.generateAlternativeOptions = function (conflict, appointments, resources) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ConflictResolutionEngine.prototype.evaluateResolutions = function (resolutions, conflict) {
        return __awaiter(this, void 0, void 0, function () {
            var evaluatedResolutions, _i, resolutions_1, resolution, updatedImpact, overallScore, updatedFeasibility;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.calculateResolutionImpact(resolution.proposedChanges, conflict)];
                    case 2:
                    ...
                    case 3:
                        ...
                        evaluatedResolutions.push(__assign(__assign({}, resolution), { impact: updatedImpact, feasibility: updatedFeasibility, metadata: __assign(__assign({}, resolution.metadata), { overallScore: overallScore, evaluatedAt: new Date().toISOString() }) }));
                        _a.label = 4;
                    case 4:
                        _i++;
                        return [3 /*break*/, 1];
                    case 5: return [2 /*return*/, evaluatedResolutions];
                }
            });
        });
    };
    ...
    ConflictResolutionEngine.prototype.calculateOverallScore = function (impact) {
        ...
        return (impact.patientSatisfaction * weights.patientSatisfaction +
     ...
     */
    ConflictResolutionEngine.prototype.calculateResolutionImpact = function (proposedChanges, conflict) {
        return __awaiter(this, void 0, void 0, function () {
            var patientSatisfaction, staffWorkload, resourceUtilization, operationalEfficiency, financialImpact, _i, _a, change, appointment, originalTime, newTime, timeDiff, _b, _c, assignment, newStaff, currentWorkload, _d, _e, assignment, newRoom, roomUtilization, overallScore;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
    ...
    ConflictResolutionEngine.prototype.applyChangesInTransaction = function (resolution) {
        return __awaiter(this, void 0, void 0, function () {
            var changes, appliedChanges, warnings, _a, data, error, _i, _b, change, updateError, _c, _d, assignment, updateError, _e, _f, assignment, updateError, _g, _h, assignment, insertError, deleteError, _j, _k, newApt, _l, insertedApt, insertError, _m, _o, aptId, updateError, commitError, error_3;
            return __generator(this, function (_p) {
                switch (_p.label) {
                    ...
                    case 4:
                        ...
                        if (updateError) {
                            warnings.push("Failed to update appointment ".concat(change.id, ": ").concat(updateError.message));
                        }
                        else {
                    ...
                    case 8:
                        updateError = (_p.sent()).error;
                        if (updateError) {
                            warnings.push("Failed to update staff assignment for appointment ".concat(assignment.appointmentId, ": ").concat(updateError.message));
                        }
                        else {
                    ...
                    case 12:
                        updateError = (_p.sent()).error;
                        if (updateError) {
                            warnings.push("Failed to update room assignment for appointment ".concat(assignment.appointmentId, ": ").concat(updateError.message));
                        }
                        else {
                    ...
                    case 16:
                        ...
                        if (insertError) {
                            warnings.push("Failed to assign equipment ".concat(assignment.equipmentId, ": ").concat(insertError.message));
                        }
                        else {
                    ...
                    case 18:
                        ...
                        if (deleteError) {
                            warnings.push("Failed to unassign equipment ".concat(assignment.equipmentId, ": ").concat(deleteError.message));
                        }
                        else {
                            appliedChanges.equipmentAssignments.push(assignment);
                        }
                    ...
                    case 26:
                        updateError = (_p.sent()).error;
                        if (updateError) {
                            warnings.push("Failed to cancel appointment ".concat(aptId, ": ").concat(updateError.message));
                        }
                        else {
                    ...
                    case 27:
                        _m++;
                        return [3 /*break*/, 25];
                    case 28: return [4 /*yield*/, this.supabase.rpc('commit_transaction')];
                    case 29:
    ...
    ConflictResolutionEngine.prototype.validateResolution = function (resolution) {
        return __awaiter(this, void 0, void 0, function () {
            var errors, _i, _a, change, appointment, _b, _c, assignment, staff, _d, _e, assignment, room, constraintErrors;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        errors = [];
                    ...
                    case 11:
                        _d++;
                        return [3 /*break*/, 9];
                    case 12: return [4 /*yield*/, this.validateBusinessConstraints(resolution)];
                    case 13:
     ...
     */
    ConflictResolutionEngine.prototype.findAvailableSlots = function (appointment, resources, direction, maxHours) {
        return __awaiter(this, void 0, void 0, function () {
            var slots, duration, originalStart, searchStart, searchEnd, time, slotStart, slotEnd, isAvailable, score;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        slots = [];
                        ...
                        searchStart = direction === 'earlier'
                            ? new Date(originalStart.getTime() - (maxHours * 60 * 60 * 1000))
                            : originalStart;
                        searchEnd = direction === 'later'
                            ? new Date(originalStart.getTime() + (maxHours * 60 * 60 * 1000))
                            : originalStart;
                    ...
                    case 1:
                        ...
                        if (!this.isWithinBusinessHours(slotStart, slotEnd))
                            return [3 /*break*/, 3];
                    ...
                    return [2 /*return*/, slots.sort(function (a, b) { return b.score - a.score; }).slice(0, 5)];
                }
            });
        });
    };
    ConflictResolutionEngine.prototype.findAlternativeStaff = function (appointment, allStaff, startTime, endTime) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 1];
                    case 5: return [2 /*return*/, alternatives];
                }
            });
        });
    };
    ConflictResolutionEngine.prototype.findAlternativeRooms = function (appointment, allRooms, startTime, endTime) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ConflictResolutionEngine.prototype.calculateSlotScore = function (slotStart, originalStart, appointment) {
        var score = 1.0;
    ...
    ConflictResolutionEngine.prototype.calculateEstimatedTime = function (changes) {
        ...
        if (changes.appointments)
            time += changes.appointments.length * 2;
        if (changes.staffAssignments)
            time += changes.staffAssignments.length * 3;
        if (changes.roomAssignments)
            time += changes.roomAssignments.length * 5;
        if (changes.equipmentAssignments)
            time += changes.equipmentAssignments.length * 2;
        return Math.max(5, time);
    };
    ConflictResolutionEngine.prototype.calculateCost = function (changes) {
        var cost = 0.1; // Base cost
        if (changes.appointments)
            cost += changes.appointments.length * 0.1;
        if (changes.staffAssignments)
            cost += changes.staffAssignments.length * 0.2;
        if (changes.roomAssignments)
            cost += changes.roomAssignments.length * 0.15;
    ...
    ConflictResolutionEngine.prototype.generatePros = function (strategy, impact) {
        var pros = [];
        if (impact.patientSatisfaction > 0)
            pros.push('Improves patient satisfaction');
        if (impact.staffWorkload > 0)
            pros.push('Balances staff workload');
        if (impact.resourceUtilization > 0)
            pros.push('Optimizes resource usage');
        if (impact.operationalEfficiency > 0)
            pros.push('Increases operational efficiency');
        switch (strategy) {
    ...
    ConflictResolutionEngine.prototype.generateCons = function (strategy, impact) {
        var cons = [];
        if (impact.patientSatisfaction < 0)
            cons.push('May reduce patient satisfaction');
        if (impact.staffWorkload < 0)
            cons.push('May increase staff workload');
        if (impact.resourceUtilization < 0)
            cons.push('May reduce resource efficiency');
        switch (strategy) {
            case types_1.ResolutionStrategy.RESCHEDULE_LATER:
            case types_1.ResolutionStrategy.RESCHEDULE_EARLIER:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6: return [2 /*return*/, resources];
                }
            });
        });
    };
    // Additional placeholder methods
    ConflictResolutionEngine.prototype.isSlotAvailable = function (start, end, appointment, resources) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ConflictResolutionEngine.prototype.logResolutionApplication = function (resolutionId, result, impact) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
    ...
    ConflictResolutionEngine.prototype.calculateStaffChangeConfidence = function (staff, appointment) {
    ...
    ConflictResolutionEngine.prototype.calculateStaffChangeFeasibility = function (staff, appointment) {
