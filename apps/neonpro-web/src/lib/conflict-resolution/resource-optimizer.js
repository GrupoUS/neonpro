...
var ResourceOptimizer = /** @class */ (() => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.generateOptimizationRecommendations(currentMetrics, workloadAnalysis, strategy),
            ];
          case 4:
            recommendations = _a.sent();
            return [
              4 /*yield*/,
              this.calculateExpectedImprovements(currentMetrics, recommendations),
            ];
          case 5:
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            if (!validation.isValid) {
              throw new Error(
                "Optimization is no longer valid: ".concat(validation.errors.join(", ")),
              );
            }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.calculateEquipmentUtilization(appointments, startDate, endDate),
            ];
          case 4:
  ...
  ResourceOptimizer.prototype.analyzeWorkloadDistribution = function (startDate, endDate) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getAllActiveStaff()];
          case 1:
            staff = _a.sent();
            workloadBalances = [];
            (_i = 0), (staff_1 = staff);
          ...
          case 6:
            ...
            return [3 /*break*/, 2];
          case 7:
            return [2 /*return*/, workloadBalances];
        }
      });
    });
  };
   ...
   */
  ResourceOptimizer.prototype.generateOptimizationRecommendations = function (
    metrics,
    workloadAnalysis,
    strategy,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.generateEquipmentOptimizations(metrics.equipmentUtilization, strategy),
            ];
          case 3:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
              ...
              if (redistributionTargets.length > 0) {
                recommendations.push({
                  ...
                  description: "Redistribute "
                    .concat(
                      Math.ceil(
                        (overloaded.currentUtilization - overloaded.targetUtilization) *
                          overloaded.availableHours,
                      ),
                      " hours from ",
                    )
                    .concat(overloaded.staffName, " to less utilized staff"),
                  metadata: {
          ...
          case 1:
            ...
            for (
              _a = 0, highDemandPeriods_1 = highDemandPeriods;
              _a < highDemandPeriods_1.length;
              _a++
            ) {
              ...
              recommendations.push({
                ...
                estimatedTime: 60,
                confidence: 0.7,
                description: "Add temporary staff during high-demand period: ".concat(
                  period.description,
                ),
                metadata: {
          ...
          case 3:
            ...
            if (utilization < this.constraints.minRoomUtilization) {
              ...
              recommendations.push({
                ...
                estimatedTime: 45,
                confidence: 0.75,
                description: "Consolidate appointments in "
                  .concat(room.name, " (")
                  .concat(Math.round(utilization * 100), "% utilization) to optimize room usage"),
                metadata: {
                  currentUtilization: utilization,
              ...
              recommendations.push({
                ...
                estimatedTime: 60,
                confidence: 0.7,
                description: "Address overcapacity in "
                  .concat(room.name, " (")
                  .concat(Math.round(utilization * 100), "% utilization)"),
                metadata: {
                  currentUtilization: utilization,
   ...
   */
  ResourceOptimizer.prototype.generateEquipmentOptimizations = function (
    equipmentUtilization,
    strategy,
  ) {
    return __awaiter(this, void 0, void 0, function () {
          ...
          case 4:
            ...
            if (maintenanceSchedule.hasConflicts) {
              recommendations.push({
                ...
                estimatedTime: 30,
                confidence: 0.85,
                description: "Reschedule maintenance for ".concat(
                  item.name,
                  " to avoid appointment conflicts",
                ),
                metadata: {
            ...
            if (utilization < this.constraints.minEquipmentUtilization) {
              recommendations.push({
                ...
                estimatedTime: 45,
                confidence: 0.7,
                description: "Increase utilization of "
                  .concat(item.name, " (currently ")
                  .concat(Math.round(utilization * 100), "%)"),
                metadata: {
                  currentUtilization: utilization,
                  targetUtilization: this.constraints.minEquipmentUtilization,
                  suggestedActions: [
                    "schedule_more_appointments",
                    "cross_train_staff",
                    "marketing_push",
                  ],
                },
   ...
   */
  ResourceOptimizer.prototype.calculateExpectedImprovements = function (
    currentMetrics,
    recommendations,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      var utilizationImprovement,
        efficiencyGain,
      ...
      return __generator(this, function (_a) {
        ...
        improvedMetrics = __assign(__assign({}, currentMetrics), {
          staffUtilization: __assign(__assign({}, currentMetrics.staffUtilization), {
            average: Math.min(
              1.0,
              currentMetrics.staffUtilization.average + utilizationImprovement,
            ),
          }),
          efficiency: __assign(__assign({}, currentMetrics.efficiency), {
            overall: Math.min(1.0, currentMetrics.efficiency.overall + efficiencyGain),
          }),
          patientSatisfaction: __assign(__assign({}, currentMetrics.patientSatisfaction), {
            overall: Math.min(
              1.0,
  ...
  ResourceOptimizer.prototype.calculateOverallScore = function (metrics) {
    ...
    return (
      (((_a = metrics.staffUtilization) === null || _a === void 0 ? void 0 : _a.average) || 0) *
        weights.staffWorkload +
      (((_b = metrics.roomUtilization) === null || _b === void 0 ? void 0 : _b.average) || 0) *
        weights.resourceUtilization +
      (((_c = metrics.efficiency) === null || _c === void 0 ? void 0 : _c.overall) || 0) *
        weights.operationalEfficiency +
      (((_d = metrics.patientSatisfaction) === null || _d === void 0 ? void 0 : _d.overall) || 0) *
        weights.patientSatisfaction
    );
  };
  ...
  ResourceOptimizer.prototype.getAllActiveStaff = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("staff").select("*").eq("active", true)];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
            return [2 /*return*/, data || []];
  ...
  ResourceOptimizer.prototype.getAllActiveRooms = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("rooms").select("*").eq("active", true)];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
            return [2 /*return*/, data || []];
  ...
  ResourceOptimizer.prototype.getAllActiveEquipment = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("equipment").select("*").eq("active", true)];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
            return [2 /*return*/, data || []];
  ...
  ResourceOptimizer.prototype.calculateStaffUtilization = function (
    appointments,
    startDate,
    endDate,
  ) {
