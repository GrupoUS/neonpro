            ...
            eq: jest.fn(function () { return ({
                gte: jest.fn(function () { return ({
                    lte: jest.fn(function () { return ({
                        neq: jest.fn(function () { return Promise.resolve({ data: [], error: null }); })
                    }); })
                }); })
            }); })
        }); }),
...
describe('ResolutionEngine', function () {
    ...
    describe('Initialization', function () {
        ...
        it('should validate config on initialization', function () {
            ...
            expect(function () { return new resolution_engine_1.ResolutionEngine(invalidConfig); }).toThrow();
        });
    });
    describe('generateResolutions', function () {
        it('should generate resolution options for time overlap conflict', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should generate different strategies for different conflict types', function () { return __awaiter(void 0, void 0, void 0, function () {
            var staffConflict, roomConflict, mockAppointment, staffResolutions, roomResolutions, staffStrategies, roomStrategies;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        staffConflict = __assign(__assign({}, mockConflict), { type: types_1.ConflictType.STAFF_CONFLICT });
                        roomConflict = __assign(__assign({}, mockConflict), { type: types_1.ConflictType.ROOM_CONFLICT });
                        mockAppointment = {
                            id: 'appointment-1',
                            start_time: '2024-01-15T10:00:00Z',
                            end_time: '2024-01-15T11:00:00Z',
                    ...
                    case 2:
                        ...
                        staffStrategies = staffResolutions.map(function (r) { return r.strategy; });
                        roomStrategies = roomResolutions.map(function (r) { return r.strategy; });
        ...
        it('should rank resolutions by score', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should handle equipment conflicts', function () { return __awaiter(void 0, void 0, void 0, function () {
            var equipmentConflict, mockAppointment, resolutions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        equipmentConflict = __assign(__assign({}, mockConflict), { type: types_1.ConflictType.EQUIPMENT_CONFLICT });
                        mockAppointment = {
                            id: 'appointment-1',
                            start_time: '2024-01-15T10:00:00Z',
                            end_time: '2024-01-15T11:00:00Z',
    ...
    describe('applyResolution', function () {
        ...
        it('should apply resolution successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should handle validation errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        invalidResolution = __assign(__assign({}, mockResolution), { changes: {
                                appointmentId: 'appointment-1',
        ...
        it('should create rollback point when enabled', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should handle staff changes', function () { return __awaiter(void 0, void 0, void 0, function () {
            var staffChangeResolution, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        staffChangeResolution = __assign(__assign({}, mockResolution), { strategy: types_1.ResolutionStrategy.CHANGE_STAFF, changes: {
                                appointmentId: 'appointment-1',
                                newStaffId: 'staff-2'
                            } });
                        mockSupabase.from.mockReturnValue({
        ...
        it('should handle room changes', function () { return __awaiter(void 0, void 0, void 0, function () {
            var roomChangeResolution, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        roomChangeResolution = __assign(__assign({}, mockResolution), { strategy: types_1.ResolutionStrategy.CHANGE_ROOM, changes: {
                                appointmentId: 'appointment-1',
                                newRoomId: 'room-2'
                            } });
                        mockSupabase.from.mockReturnValue({
    ...
    describe('rollbackResolution', function () {
        it('should rollback resolution successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should handle rollback not found', function () { return __awaiter(void 0, void 0, void 0, function () {
            var rollbackId, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should handle expired rollback', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Configuration Updates', function () {
        ...
        it('should validate new configuration', function () {
            ...
            expect(function () { return engine.updateConfig(invalidConfig); }).toThrow();
        });
    });
    describe('Performance and Optimization', function () {
        it('should handle multiple resolutions efficiently', function () { return __awaiter(void 0, void 0, void 0, function () {
            var conflicts, mockAppointment, startTime, resolutionPromises, results, endTime;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        conflicts = Array.from({ length: 10 }, function (_, i) { return (__assign(__assign({}, mockConflict), { id: "conflict-".concat(i), appointmentId: "appointment-".concat(i) })); });
                        mockAppointment = {
                            id: 'appointment-1',
                            start_time: '2024-01-15T10:00:00Z',
                            end_time: '2024-01-15T11:00:00Z',
        ...
        it('should cache resolution strategies', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Error Handling', function () {
        it('should handle invalid conflict data', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(engine.generateResolutions(invalidConflict, mockAppointment))
                                .rejects.toThrow()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should handle network failures gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockAppointment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabase.from.mockReturnValue({
                            select: jest.fn(function () { return ({
                                eq: jest.fn(function () { return ({
                                    gte: jest.fn(function () { return ({
                                        lte: jest.fn(function () { return ({
                                            neq: jest.fn(function () { return Promise.reject(new Error('Network error')); })
                                        }); })
                                    }); })
                                }); })
                            }); })
                        });
                        return [4 /*yield*/, expect(engine.generateResolutions(mockConflict, mockAppointment))
