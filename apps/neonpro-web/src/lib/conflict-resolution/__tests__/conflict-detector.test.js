...
describe('ConflictDetector', function () {
    ...
    describe('Initialization', function () {
        ...
        it('should validate config on initialization', function () {
            var invalidConfig = __assign(__assign({}, mockConfig), { severityThresholds: {
                    low: 0.8,
                    medium: 0.6,
                    high: 0.3
                } });
            expect(function () { return new conflict_detector_1.ConflictDetector(invalidConfig); }).toThrow();
        });
    });
    describe('detectConflicts', function () {
        ...
        it('should detect time overlap conflicts', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should detect staff conflicts', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should detect room conflicts', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should handle multiple conflicts', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should return empty array when no conflicts', function () { return __awaiter(void 0, void 0, void 0, function () {
            var conflicts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(detector.detectConflicts(mockAppointment)).rejects.toThrow('Database error')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('detectBatchConflicts', function () {
        ...
        it('should detect conflicts for multiple appointments', function () { return __awaiter(void 0, void 0, void 0, function () {
            var results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should handle empty appointment list', function () { return __awaiter(void 0, void 0, void 0, function () {
            var results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, detector.detectBatchConflicts([])];
                    case 1:
                        results = _a.sent();
        ...
        it('should respect batch size limits', function () { return __awaiter(void 0, void 0, void 0, function () {
            var largeAppointmentList, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        largeAppointmentList = Array.from({ length: 250 }, function (_, i) { return ({
    ...
    describe('Cache Management', function () {
        it('should use cache when enabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            var appointment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should clear cache when requested', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, detector.clearCache()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('Configuration Updates', function () {
        ...
        it('should validate new configuration', function () {
            ...
            expect(function () { return detector.updateConfig(invalidConfig); }).toThrow();
        });
    });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(detector.detectConflicts(invalidAppointment)).rejects.toThrow()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
                        ...
                        mockSupabase.from.mockReturnValue({
                            select: jest.fn(function () { return ({
                                gte: jest.fn(function () { return ({
                                    lte: jest.fn(function () { return ({
                                        eq: jest.fn(function () { return ({
                                            neq: jest.fn(function () { return Promise.reject(new Error('Network timeout')); })
                                        }); })
                                    }); })
                                }); })
                            }); })
                        });
                        return [4 /*yield*/, expect(detector.detectConflicts(appointment)).rejects.toThrow('Network timeout')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
