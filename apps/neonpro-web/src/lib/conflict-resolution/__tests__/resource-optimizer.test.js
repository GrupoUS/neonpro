...
describe('ResourceOptimizer', function () {
    ...
    describe('Initialization', function () {
        ...
        it('should validate config on initialization', function () {
            var invalidConfig = __assign(__assign({}, mockConfig), { workloadThresholds: {
                    underutilized: 0.8,
                    optimal: 0.7,
                    overloaded: 0.6
                } });
            expect(function () { return new resource_optimizer_1.ResourceOptimizer(invalidConfig); }).toThrow();
        });
    });
    describe('optimizeResources', function () {
        ...
        it('should optimize resources for given date range', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should handle empty date range', function () { return __awaiter(void 0, void 0, void 0, function () {
            var emptyDateRange;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(optimizer.optimizeResources(emptyDateRange)).rejects.toThrow()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('should respect staff availability constraints', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        availabilityRecommendations = result.recommendations.filter(function (rec) { return rec.description.includes('availability'); });
    ...
    describe('balanceWorkload', function () {
        it('should balance workload across staff members', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should identify overloaded staff', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        overloadRecommendations = result.recommendations.filter(function (rec) { return rec.description.includes('overloaded') || rec.description.includes('reduce'); });
                        expect(overloadRecommendations.length).toBeGreaterThan(0);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should identify underutilized staff', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        underutilizedRecommendations = result.recommendations.filter(function (rec) { return rec.description.includes('underutilized') || rec.description.includes('increase'); });
    ...
    describe('applyOptimizations', function () {
        ...
        it('should apply optimization recommendations', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should handle partial application failures', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should validate recommendations before applying', function () { return __awaiter(void 0, void 0, void 0, function () {
            var invalidRecommendations, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        invalidRecommendations = [
                            __assign(__assign({}, mockRecommendations[0]), { actions: [
                                    {
                                        type: 'invalid_action',
                                        appointmentId: 'appointment-1'
                                    }
        ...
        it('should handle database transaction failures', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockSupabase.from.mockReturnValue({
                            update: jest.fn(function () { return ({
                                eq: jest.fn(function () { return Promise.reject(new Error('Transaction failed')); })
                            }); })
                        });
                        return [4 /*yield*/, optimizer.applyOptimizations(mockRecommendations)];
                    case 1:
    ...
    describe('calculateResourceMetrics', function () {
        ...
        it('should calculate comprehensive resource metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    case 0:
                        ...
                        mockSupabase.from.mockImplementation(function (table) {
                            return {
                                select: jest.fn(function () { return ({
                                    gte: jest.fn(function () { return ({
                                        lte: jest.fn(function () { return Promise.resolve({
                                            data: mockData[table] || [],
                                            error: null
                                        }); })
                                    }); })
        ...
        it('should handle empty data gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var metrics;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('generateRecommendations', function () {
        it('should generate staff balancing recommendations', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        staffRecommendations = recommendations.filter(function (rec) { return rec.type === types_1.OptimizationType.STAFF_BALANCING; });
                        expect(staffRecommendations.length).toBeGreaterThan(0);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should prioritize recommendations correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        recommendations = _a.sent();
                        highPriorityRecs = recommendations.filter(function (rec) { return rec.priority === 'high'; });
                        staffRecs = highPriorityRecs.filter(function (rec) { return rec.type === types_1.OptimizationType.STAFF_BALANCING; });
    ...
    describe('Configuration and Updates', function () {
        ...
        it('should validate new configuration', function () {
            ...
            expect(function () { return optimizer.updateConfig(invalidConfig); }).toThrow();
        });
    });
    describe('Performance and Scalability', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        largeAppointmentSet = Array.from({ length: 1000 }, function (_, i) { return ({
        ...
        it('should cache optimization results', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Error Handling', function () {
                    ...
                    case 0:
                        ...
                        mockSupabase.from.mockReturnValue({
                            select: jest.fn(function () { return ({
                                gte: jest.fn(function () { return ({
                                    lte: jest.fn(function () { return ({
                                        eq: jest.fn(function () { return Promise.reject(new Error('Database connection failed')); })
                                    }); })
                                }); })
                            }); })
                        });
                        return [4 /*yield*/, expect(optimizer.optimizeResources(dateRange)).rejects.toThrow('Database connection failed')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('should handle invalid date ranges', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(optimizer.optimizeResources(invalidDateRange)).rejects.toThrow()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
                    ...
                    case 0:
                        ...
                        mockSupabase.from.mockReturnValue({
                            select: jest.fn(function () { return ({
                                gte: jest.fn(function () { return ({
                                    lte: jest.fn(function () { return ({
                                        eq: jest.fn(function () { return new Promise(function (_, reject) {
                                            setTimeout(function () { return reject(new Error('Network timeout')); }, 100);
                                        }); })
                                    }); })
                                }); })
                            }); })
                        });
                        return [4 /*yield*/, expect(optimizer.optimizeResources(dateRange)).rejects.toThrow('Network timeout')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
