...
var ConflictDetectionEngine = /** @class */ (() => {
    ...
    this.config = __assign(
      {
        ...
        maxLookaheadDays: 30,
        conflictSeverityThreshold: types_1.ConflictSeverity.MEDIUM,
      },
      config,
    );
  }
      ...
      return __generator(this, function (_s) {
        switch (_s.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getAppointmentsInRange(params.dateRange.start, params.dateRange.end),
            ];
          case 1:
            appointments = _s.sent();
            return [
              4 /*yield*/,
              Promise.all([this.getStaff(), this.getRooms(), this.getEquipment()]),
            ];
          case 2:
          ...
          case 10:
            ...
            return [
              4 /*yield*/,
              this.detectResourceOverbooking(appointments, staff, rooms, equipment),
            ];
          case 11:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        ...
        for (_i = 0, roomAppointments_1 = roomAppointments; _i < roomAppointments_1.length; _i++) {
          ...
          for (
            _b = 0, simultaneousAppointments_1 = simultaneousAppointments;
            _b < simultaneousAppointments_1.length;
            _b++
          ) {
  ...
  ConflictDetectionEngine.prototype.detectEquipmentConflicts = function (appointments, equipment) {
    return __awaiter(this, void 0, void 0, function () {
      var conflicts,
        ...
        _loop_1,
        _i,
        equipmentAssignments_1,
        assignment,
        _a,
        equipmentAppointments_1,
        _b,
        equipmentId,
        assignments,
        equipmentItem,
        ...
        switch (_d.label) {
          ...
          case 1:
            ...
            _loop_1 = (assignment) => {
              ...
              equipmentAppointments
                .get(assignment.equipment_id)
                .push({ appointment: appointment, assignment: assignment });
            };
            for (
              _i = 0, equipmentAssignments_1 = equipmentAssignments;
              _i < equipmentAssignments_1.length;
              _i++
            ) {
          ...
          case 2:
            ...
            for (i = 0; i < sortedAssignments.length - 1; i++) {
              ...
              if (currentEnd.getTime() + requiredGap > nextStart.getTime()) {
                conflicts.push({
                  id: "equipment_conflict_"
                    .concat(equipmentId, "_")
                    .concat(current.appointment.id, "_")
                    .concat(next.appointment.id),
          ...
          case 3:
            ...
            for (
              _c = 0, maintenanceSchedule_1 = maintenanceSchedule;
              _c < maintenanceSchedule_1.length;
              _c++
            ) {
   ...
   */
  ConflictDetectionEngine.prototype.detectResourceOverbooking = function (
    appointments,
    staff,
    rooms,
    equipment,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.analyzeResourceUtilization(appointments, staff, rooms, equipment),
            ];
          case 1:
            utilizationAnalysis = _b.sent();
            // Check for critical utilization levels
            for (
              _i = 0, utilizationAnalysis_1 = utilizationAnalysis;
              _i < utilizationAnalysis_1.length;
              _i++
            ) {
              analysis = utilizationAnalysis_1[_i];
              if (analysis.utilizationRate > 0.95) {
                conflicts.push({
                  id: "resource_overbook_"
                    .concat(analysis.resourceType, "_")
                    .concat(analysis.resourceId),
                  type: types_1.ConflictType.RESOURCE_OVERBOOKED,
                  severity: types_1.ConflictSeverity.HIGH,
                  description: ""
                    .concat(analysis.resourceType, " ")
                    .concat(analysis.resourceName, " critically overbooked (")
                    .concat(Math.round(analysis.utilizationRate * 100), "%)"),
                  affectedAppointments: analysis.affectedAppointments,
                  affectedResources:
                    ((_a = {}), (_a[analysis.resourceType] = [analysis.resourceId]), _a),
                  conflictTime: {
  ...
  ConflictDetectionEngine.prototype.calculateStaffWorkload = function (staffId, appointments) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getStaffById(staffId)];
          case 1:
            staff = _a.sent();
            if (!staff) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("staff").select("*").eq("id", staffId).single(),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
  ...
  ConflictDetectionEngine.prototype.analyzeResourceUtilization = function (
    appointments,
    staff,
    rooms,
    equipment,
