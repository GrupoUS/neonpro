      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            ...
            if (!connector) {
              throw new IntegrationFrameworkError(
                "Connector not found for type: ".concat(config.type),
                "CONNECTOR_NOT_FOUND",
                config.id,
              );
            }
          ...
          case 2:
            ...
            _c = (_b = this.supabase.from("integrations")).insert;
            _d = {
              id: config.id,
              name: config.name,
              type: config.type,
          ...
          case 4:
            ...
            if (error) {
              throw new IntegrationFrameworkError(
                "Failed to save integration: ".concat(error.message),
                "DATABASE_ERROR",
                config.id,
              );
            }
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          ...
          case 1:
            ...
            if (!existing) {
              throw new IntegrationFrameworkError(
                "Integration not found: ".concat(id),
                "INTEGRATION_NOT_FOUND",
                id,
              );
            }
            updated = __assign(__assign(__assign({}, existing), updates), {
              updatedAt: new Date(),
            });
            ...
            if (!connector) {
              throw new IntegrationFrameworkError(
                "Connector not found for type: ".concat(updates.type),
                "CONNECTOR_NOT_FOUND",
                id,
              );
            }
          ...
          case 2:
            ...
            _e.label = 3;
          case 3:
            _b = (_a = this.supabase.from("integrations")).update;
            _d = {
              name: updated.name,
              type: updated.type,
          ...
          case 7:
            ...
            if (error) {
              throw new IntegrationFrameworkError(
                "Failed to update integration: ".concat(error.message),
                "DATABASE_ERROR",
                id,
              );
            }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4 /*yield*/, this.supabase.from("integrations").delete().eq("id", id)];
          case 2:
            error = _a.sent().error;
            if (error) {
              throw new IntegrationFrameworkError(
                "Failed to delete integration: ".concat(error.message),
                "DATABASE_ERROR",
                id,
              );
            }
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("integrations").select("*").eq("id", id).single(),
            ];
          case 2:
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 1:
            ...
            if (error) {
              throw new IntegrationFrameworkError(
                "Failed to list integrations: ".concat(error.message),
                "DATABASE_ERROR",
                "list",
              );
            }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!connector) {
              throw new IntegrationFrameworkError(
                "Connector not found for type: ".concat(integration.type),
                "CONNECTOR_NOT_FOUND",
                id,
              );
            }
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            if (!integration.enabled) {
              throw new IntegrationFrameworkError(
                "Integration is disabled: ".concat(id),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("integration_sync_operations").insert(syncOperation),
            ];
          case 2:
            error = _a.sent().error;
            if (error) {
              throw new IntegrationFrameworkError(
                "Failed to save sync operation: ".concat(error.message),
                "DATABASE_ERROR",
                id,
              );
            }
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) {
              throw new IntegrationFrameworkError(
                "Failed to get logs: ".concat(error.message),
                "DATABASE_ERROR",
                id,
              );
            }
  ...
  NeonProIntegrationFramework.prototype.logRequest = function (request) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("integration_requests").insert(request)];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
  ...
  NeonProIntegrationFramework.prototype.logResponse = function (response) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("integration_responses").insert(response)];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
  ...
  NeonProIntegrationFramework.prototype.logEvent = function (event) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.supabase.from("integration_events").insert(event)];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
