...
var NeonProWebhookManager = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        // Log registration
                        return [4 /*yield*/, this.logWebhookEvent(config.id, 'webhook_registered', {
                                url: config.url,
                                events: config.events
                            })];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (updates.secret)
                            updateData.secret = this.hashSecret(updates.secret);
                        if (updates.active !== undefined)
                            updateData.active = updates.active;
                        if (updates.retryPolicy)
                            updateData.retry_policy = updates.retryPolicy;
                        if (updates.filters)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        // Log deletion
                        return [4 /*yield*/, this.logWebhookEvent(id, 'webhook_deleted', {
                                url: webhook.url
                            })];
                    case 3:
                        // Log deletion
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(webhook.filters && !this.applyFilters(payload, webhook.filters))) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.logWebhookEvent(id, 'webhook_filtered', {
                    ...
                    case 3:
                        ...
                        if (!(!webhook.events.includes(eventType) && !webhook.events.includes('*'))) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.logWebhookEvent(id, 'webhook_ignored', {
                                eventType: eventType,
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, this.logWebhookEvent(id, 'webhook_processed', {
                                eventType: eventType,
                                jobId: job.id
                            })];
                    case 7:
                    ...
                    case 8:
                        ...
                        // Log error
                        return [4 /*yield*/, this.logWebhookEvent(id, 'webhook_error', {
    ...
    NeonProWebhookManager.prototype.validateSignature = function (payload, signature, secret) {
        try {
            ...
            return crypto_1.default.timingSafeEqual(Buffer.from(cleanSignature, 'hex'), Buffer.from(cleanExpected, 'hex'));
        }
        catch (error) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        _i++;
                        return [3 /*break*/, 3];
                    case 6: return [4 /*yield*/, this.logWebhookEvent(id, 'webhook_retry_scheduled', {
                            count: (failedDeliveries === null || failedDeliveries === void 0 ? void 0 : failedDeliveries.length) || 0
                        })];
                    case 7:
                        _c.sent();
                        return [3 /*break*/, 9];
    ...
    NeonProWebhookManager.prototype.destroy = function () {
        ...
        for (var _i = 0, _a = this.retryJobs; _i < _a.length; _i++) {
            var _b = _a[_i], id = _b[0], timeoutId = _b[1];
