...
var SupabaseRateLimiter = /** @class */ (function () {
    ...
    SupabaseRateLimiter.prototype.checkLimit = function (integrationId, endpoint) {
        return __awaiter(this, void 0, void 0, function () {
            var config, now, key, minuteKey, minuteCount, hourKey, hourCount, dayKey, dayCount, burstKey, burstEntry, timeDiff, error_1;
    ...
    SupabaseRateLimiter.prototype.getRemainingRequests = function (integrationId, endpoint) {
        return __awaiter(this, void 0, void 0, function () {
            var config, now, key, minuteKey, minuteCount, minuteRemaining, hourKey, hourCount, hourRemaining, dayKey, dayCount, dayRemaining, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
...
var MemoryRateLimiter = /** @class */ (function () {
    ...
    MemoryRateLimiter.prototype.getRemainingRequests = function (integrationId, endpoint) {
        return __awaiter(this, void 0, void 0, function () {
            var config, now, key, minuteKey, minuteRemaining, hourKey, hourRemaining, dayKey, dayRemaining;
            return __generator(this, function (_a) {
                config = this.configs.get(integrationId);
                if (!config) {
