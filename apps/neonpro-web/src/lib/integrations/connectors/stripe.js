...
var StripeConnector = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        response = _b.sent();
                        return [2 /*return*/, response.success && ((_a = response.data) === null || _a === void 0 ? void 0 : _a.id)];
                    case 2:
                        error_1 = _b.sent();
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.makeRequest({
                                ...
                                data: __assign(__assign({}, paymentIntent), { payment_method_types: paymentIntent.payment_method_types || ['card', 'pix'] })
                            })];
                    case 1:
                        response = _c.sent();
                        return [2 /*return*/, {
                                ...
                                metadata: {
                                    ...
                                    clientSecret: (_b = response.data) === null || _b === void 0 ? void 0 : _b.client_secret,
                                    timestamp: new Date().toISOString()
                                }
                            }];
                    case 2:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                error: error_5 instanceof Error ? error_5.message : 'Failed to create payment intent',
                                metadata: {
                                    timestamp: new Date().toISOString()
                                }
                            }];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                error: error_6 instanceof Error ? error_6.message : 'Failed to confirm payment intent',
                                metadata: {
                                    paymentIntentId: paymentIntentId,
                                    timestamp: new Date().toISOString()
                                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                error: error_7 instanceof Error ? error_7.message : 'Failed to cancel payment intent',
                                metadata: {
                                    paymentIntentId: paymentIntentId,
                                    timestamp: new Date().toISOString()
                                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                error: error_10 instanceof Error ? error_10.message : 'Failed to create subscription',
                                metadata: {
                                    timestamp: new Date().toISOString()
                                }
                            }];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                error: error_11 instanceof Error ? error_11.message : 'Failed to cancel subscription',
                                metadata: {
                                    subscriptionId: subscriptionId,
                                    timestamp: new Date().toISOString()
                                }
     ...
     */
    StripeConnector.prototype.createAppointmentPayment = function (patientEmail, patientName, appointmentId, amount, description) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.createCustomer({
                                email: patientEmail,
                                name: patientName,
                                metadata: {
                                    source: 'neonpro',
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                error: error_12 instanceof Error ? error_12.message : 'Failed to create appointment payment',
                                metadata: {
                                    appointmentId: appointmentId,
                                    timestamp: new Date().toISOString()
                                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    throw new Error("Webhook processing failed: ".concat(error instanceof Error ? error.message : 'Unknown error'));
                }
                return [2 /*return*/];
            });
        });
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        options = {
                            ...
                            headers: __assign({ 'Authorization': "Bearer ".concat(this.config.secretKey), 'Content-Type': 'application/x-www-form-urlencoded', 'Stripe-Version': '2023-10-16' }, request.headers)
                        };
                        if (request.data) {
                ...
                if (typeof value === 'object' && !Array.isArray(value)) {
                    ...
                    value.forEach(function (item, index) {
                        if (typeof item === 'object') {
                            params.push(_this.encodeFormData(item, "".concat(encodedKey_1, "[").concat(index, "]")));
                        }
                        else {
                            params.push("".concat(encodedKey_1, "[").concat(index, "]=").concat(encodeURIComponent(item)));
                        }
                    });
                }
                else {
    ...
    StripeConnector.prototype.verifyWebhookSignature = function (payload, signature) {
        try {
            ...
            var expectedSignature = signature.split(',').find(function (s) { return s.startsWith('v1='); });
...
var StripeUtils = /** @class */ (function () {
     ...
     */
    StripeUtils.generatePaymentDescription = function (appointmentType, patientName, doctorName, date) {
        var formattedDate = date.toLocaleDateString('pt-BR');
        return "".concat(appointmentType, " - ").concat(patientName, " com Dr(a). ").concat(doctorName, " em ").concat(formattedDate);
    };
    /**
     ...
     */
    StripeUtils.createInstallmentOptions = function (amount, maxInstallments, minInstallmentAmount // R$ 5.00 in cents
    ) {
        if (maxInstallments === void 0) { maxInstallments = 12; }
        if (minInstallmentAmount === void 0) { minInstallmentAmount = 500; }
        var options = [];
