...
var WhatsAppConnector = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        response = _b.sent();
                        return [2 /*return*/, response.success && ((_a = response.data) === null || _a === void 0 ? void 0 : _a.id) === this.config.phoneNumberId];
                    case 2:
                        error_1 = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 2, , 3]);
                        payload = __assign({ messaging_product: 'whatsapp', recipient_type: 'individual', to: message.to, type: message.type }, this.buildMessagePayload(message));
                        return [4 /*yield*/, this.makeRequest({
                                method: 'POST',
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                metadata: {
                                    messageId: (_c = (_b = (_a = response.data) === null || _a === void 0 ? void 0 : _a.messages) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.id,
     ...
     */
    WhatsAppConnector.prototype.sendAppointmentReminder = function (phoneNumber, patientName, appointmentDate, doctorName, clinicName) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
     ...
     */
    WhatsAppConnector.prototype.sendAppointmentConfirmation = function (phoneNumber, patientName, appointmentDate, doctorName) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
                message = {
     ...
     */
    WhatsAppConnector.prototype.sendExamResults = function (phoneNumber, patientName, examType, resultsUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var message, message;
            return __generator(this, function (_a) {
                if (resultsUrl) {
                    message = {
                        ...
                        document: {
                            link: resultsUrl,
                            caption: "Ol\u00E1 ".concat(patientName, ", seus resultados de ").concat(examType, " est\u00E3o prontos. Confira o documento anexo."),
                            filename: "Resultados_".concat(examType, "_").concat(patientName.replace(/\s+/g, '_'), ".pdf")
                        }
                    };
                    return [2 /*return*/, this.sendMessage(message)];
                }
                    ...
                    message = {
                        ...
                        type: 'text',
                        text: {
                            body: "Ol\u00E1 ".concat(patientName, ", seus resultados de ").concat(examType, " est\u00E3o prontos. Entre em contato conosco para mais informa\u00E7\u00F5es.")
                        }
                    };
                    return [2 /*return*/, this.sendMessage(message)];
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("".concat(this.baseUrl, "/").concat(this.config.phoneNumberId, "/media"), {
                                method: 'POST',
                                headers: {
                    ...
                    case 2:
                        data = _b.sent();
                        if (!response.ok) {
                            throw new Error(((_a = data.error) === null || _a === void 0 ? void 0 : _a.message) || 'Upload failed');
                        }
                        return [2 /*return*/, {
                                success: true,
                                data: {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        response = _b.sent();
                        if (!(response.success && ((_a = response.data) === null || _a === void 0 ? void 0 : _a.url))) return [3 /*break*/, 3];
                        return [4 /*yield*/, fetch(response.data.url, {
                                headers: {
                                    'Authorization': "Bearer ".concat(this.config.accessToken)
                                }
                            })];
...
var WhatsAppUtils = /** @class */ (function () {
    ...
    WhatsAppUtils.formatPhoneNumber = function (phone, countryCode) {
        if (countryCode === void 0) { countryCode = '55'; }
