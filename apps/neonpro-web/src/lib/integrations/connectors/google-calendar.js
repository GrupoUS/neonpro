...
var GoogleCalendarConnector = /** @class */ (() => {
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              {
                ...
                data: {
                  events:
                    ((_a = response.data) === null || _a === void 0 ? void 0 : _a.items) || [],
                  nextPageToken:
                    (_b = response.data) === null || _b === void 0 ? void 0 : _b.nextPageToken,
                  summary: (_c = response.data) === null || _c === void 0 ? void 0 : _c.summary,
                },
                error: response.error,
                metadata: {
                  count:
                    ((_e = (_d = response.data) === null || _d === void 0 ? void 0 : _d.items) ===
                      null || _e === void 0
                      ? void 0
                      : _e.length) || 0,
                  timestamp: new Date().toISOString(),
   ...
   */
  GoogleCalendarConnector.prototype.checkAvailability = function (
    startTime,
    endTime,
    excludeEventId,
  ) {
   ...
   */
  GoogleCalendarConnector.prototype.createAppointment = function (
    patientName,
    patientEmail,
    doctorName,
    startTime,
          ...
          case 2:
            ...
            if (response.success) {
              ...
              this.config.resourceId =
                (_a = response.data) === null || _a === void 0 ? void 0 : _a.resourceId;
            }
            return [2 /*return*/, response];
          case 3:
            error_8 = _b.sent();
