...
exports.CacheFactory = exports.SupabaseIntegrationCache = exports.RedisIntegrationCache = exports.MemoryIntegrationCache = void 0;
...
var MemoryIntegrationCache = /** @class */ (function () {
    function MemoryIntegrationCache(config) {
        ...
        if (this.config.cleanupInterval > 0) {
            setInterval(function () { return _this.cleanup(); }, this.config.cleanupInterval);
        }
    }
    /**
    ...
    MemoryIntegrationCache.prototype.keys = function (pattern) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, keys.filter(function (key) { return regex.test(key); })];
            });
        });
    };
...
var RedisIntegrationCache = /** @class */ (function () {
    function RedisIntegrationCache(redisClient, config) {
        ...
        this.config = __assign({ maxSize: 10000, defaultTtl: 300000, keyPrefix: 'neonpro:integration:' }, config);
    }
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.redis.set(keyStr, serialized)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    RedisIntegrationCache.prototype.serializeKey = function (key) {
        ...
        var parts = [
            ...
            key.operation,
            key.resource || '',
            key.params ? crypto_1.default.createHash('md5').update(JSON.stringify(key.params)).digest('hex') : ''
        ];
        return parts.join(':');
    };
    /**
...
var SupabaseIntegrationCache = /** @class */ (function () {
    function SupabaseIntegrationCache(supabaseUrl, supabaseKey, config) {
        ...
        // Start cleanup interval
        setInterval(function () { return _this.cleanup(); }, 300000); // 5 minutes
    }
    /**
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (!(data.expires_at && new Date(data.expires_at) < new Date())) return [3 /*break*/, 5];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.memoryCache.set(key, value, Math.min(expiry || 60000, 60000))];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        if (!(data.expires_at && new Date(data.expires_at) < new Date())) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.delete(key)];
                    case 5:
                        _c.sent();
                        return [2 /*return*/, false];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3: return [2 /*return*/, __assign({}, this.stats)];
                    case 4:
                        error_14 = _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, (data || []).map(function (item) { return item.key; })];
                    case 2:
                        error_16 = _b.sent();
