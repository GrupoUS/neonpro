...
var MemoryIntegrationQueue = /** @class */ (() => {
  function MemoryIntegrationQueue(config) {
    ...
    this.config = __assign(
      { maxConcurrency: 5, retryDelay: 5000, maxRetries: 3, processInterval: 1000 },
      config,
    );
...
var SupabaseIntegrationQueue = /** @class */ (() => {
  function SupabaseIntegrationQueue(supabaseUrl, supabaseKey, config) {
    ...
    this.config = __assign(
      { maxConcurrency: 5, retryDelay: 5000, maxRetries: 3, processInterval: 5000 },
      config,
    );
    // Start processing loop
    this.startProcessing();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("integration_jobs").insert({
                id: job.id,
                type: job.type,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("integration_jobs").select("*").eq("id", id).single(),
            ];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("integration_jobs").update(updateData).eq("id", id),
            ];
          case 1:
            error = _a.sent().error;
            if (error) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.from("integration_jobs").delete().eq("id", id)];
          case 1:
            error = _a.sent().error;
            if (error) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("integration_jobs").select("*").eq("status", "processing"),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) {
