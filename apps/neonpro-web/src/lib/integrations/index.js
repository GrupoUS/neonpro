...
exports.IntegrationFrameworkFactory =
  ...
  exports.GoogleCalendarUtils =
  exports.GoogleCalendarConnector =
  exports.WhatsAppUtils =
  exports.WhatsAppConnector =
  exports.QueueFactory =
  exports.SupabaseIntegrationQueue =
  exports.MemoryIntegrationQueue =
  ...
  exports.SupabaseRateLimiter =
  exports.WebhookSignatureUtils =
  exports.NeonProWebhookManager =
  exports.NeonProIntegrationFramework =
    void 0;
// Core Framework
    ...
    return __awaiter(this, arguments, void 0, function (config) {
      ...
      return __generator(this, (_d) => {
        (_a = config.cacheType),
          ...
          (_b = config.queueType),
          (queueType = _b === void 0 ? "memory" : _b),
          (_c = config.rateLimiterType),
          (rateLimiterType = _c === void 0 ? "memory" : _c);
        ...
        return [
          2 /*return*/,
          new NeonProIntegrationFramework({
            cache: cache,
            queue: queue,
            rateLimiter: rateLimiter,
