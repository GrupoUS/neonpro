...
var NLPSearchEngine = /** @class */ (function () {
  ...
  NLPSearchEngine.prototype.extractEntities = function (query) {
    ...
    for (
      var _b = 0, conditionKeywords_1 = conditionKeywords;
      _b < conditionKeywords_1.length;
      _b++
    ) {
    ...
    for (
      var _c = 0, procedureKeywords_1 = procedureKeywords;
      _c < procedureKeywords_1.length;
      _c++
    ) {
