...
var createunifiedSearchSystem = /** @class */ (function () {
    ...
    createunifiedSearchSystem.prototype.search = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, nlpAnalysis, allResults, searchPromises, searchTypes, searchResults, offset, limit, paginatedResults, executionTime, suggestions, error_1;
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.trys.push([1, 5, , 6]);
                        nlpAnalysis = void 0;
                        if (!(((_a = query.options) === null || _a === void 0 ? void 0 : _a.useNLP) !== false)) return [3 /*break*/, 3];
                        return [4 /*yield*/, nlp_engine_1.nlpSearchEngine.processQuery(query.term, query.context)];
                    case 2:
                        nlpAnalysis = _e.sent();
                    ...
                    case 4:
                        ...
                        allResults.sort(function (a, b) { return b.relevanceScore - a.relevanceScore; });
                        ...
                        suggestions = (nlpAnalysis === null || nlpAnalysis === void 0 ? void 0 : nlpAnalysis.suggestions) || this.generateSearchSuggestions(query.term);
                        return [2 /*return*/, {
                                query: query,
     ...
     */
    createunifiedSearchSystem.prototype.refineSearchTypesFromNLP = function (defaultTypes, nlpAnalysis) {
        ...
        var hasPersonEntity = nlpAnalysis.entities.some(function (e) { return e.type === 'person'; });
        var hasProcedureEntity = nlpAnalysis.entities.some(function (e) { return e.type === 'procedure'; });
        var hasConditionEntity = nlpAnalysis.entities.some(function (e) { return e.type === 'condition'; });
    ...
    createunifiedSearchSystem.prototype.searchPatients = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var results, nlpAnalysis, searchTerm, nameFilter, ageFilter, specialtyFilter, personEntities, ageEntities, age, specialtyEntities, mockPatients, _i, mockPatients_1, patient, matches, matchScore, matchReasons, procedureEntities, _a, procedureEntities_1, proc;
            return __generator(this, function (_b) {
                try {
                    ...
                    if (nlpAnalysis) {
                        personEntities = nlpAnalysis.entities.filter(function (e) { return e.type === 'person'; });
                        if (personEntities.length > 0) {
                            nameFilter = personEntities[0].value;
                        }
                        ageEntities = nlpAnalysis.entities.filter(function (e) { return e.type === 'age'; });
                        if (ageEntities.length > 0) {
                            age = parseInt(ageEntities[0].value);
                            ageFilter = { min: age - 2, max: age + 2 }; // Allow some variance
                        }
                        specialtyEntities = nlpAnalysis.entities.filter(function (e) { return e.type === 'specialty'; });
                    ...
                    for (_i = 0, mockPatients_1 = mockPatients; _i < mockPatients_1.length; _i++) {
                        ...
                        if (nlpAnalysis) {
                            procedureEntities = nlpAnalysis.entities.filter(function (e) { return e.type === 'procedure'; });
                            for (_a = 0, procedureEntities_1 = procedureEntities; _a < procedureEntities_1.length; _a++) {
                        ...
                        if (matches) {
                            results.push({
                                ...
                                type: 'patients',
                                title: patient.name,
                                description: "".concat(patient.email, " \u2022 ").concat(patient.phone, " \u2022 ").concat(patient.age, " anos \u2022 ").concat(patient.specialty),
                                relevanceScore: Math.min(matchScore, 1.0),
                                metadata: __assign(__assign({}, patient), { matchReasons: matchReasons, nlpEnhanced: !!nlpAnalysis }),
                                ...
                                actions: [
                                    ...
                                    { id: 'timeline', label: 'Timeline', url: "/patients/".concat(patient.id, "/timeline") }
                                ]
                            });
                        }
                    }
                    return [2 /*return*/, results.sort(function (a, b) { return b.relevanceScore - a.relevanceScore; })];
                }
                catch (error) {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    for (_i = 0, mockEvents_1 = mockEvents; _i < mockEvents_1.length; _i++) {
                        ...
                        if (this.matchesSearchTerm(query.term, event_1.title, event_1.description, event_1.provider)) {
                            results.push({
                                id: event_1.id,
                        ...
                        for (_i = 0, duplicates_1 = duplicates; _i < duplicates_1.length; _i++) {
                            ...
                            if (this.matchesSearchTerm(query.term, duplicate.id, duplicate.status)) {
                                results.push({
                                    id: duplicate.id,
                                    type: 'duplicates',
                                    title: "Duplicata: ".concat(duplicate.primaryPatientId, " \u2194 ").concat(duplicate.duplicatePatientId),
                                    description: "Score: ".concat(duplicate.confidenceScore, " \u2022 Status: ").concat(duplicate.status),
                    ...
                    for (_i = 0, mockPhotos_1 = mockPhotos; _i < mockPhotos_1.length; _i++) {
                        ...
                        if (this.matchesSearchTerm(query.term, photo.fileName, photo.patientId, photo.status)) {
                            results.push({
                                ...
                                description: "Paciente: ".concat(photo.patientId, " \u2022 Status: ").concat(photo.status),
    ...
    createunifiedSearchSystem.prototype.calculateRelevance = function (searchTerm, text) {
        ...
        var matches = termWords.filter(function (word) {
            return contentWords.some(function (contentWord) { return contentWord.includes(word); });
        }).length;
                ...
                switch (_a.label) {
                    case 0:
                        query = {
                            ...
                            context: context,
                            filters: {
                                types: (options === null || options === void 0 ? void 0 : options.types) || ['patients', 'appointments', 'timeline_events', 'insights']
                            },
                            options: {
     ...
     */
    createunifiedSearchSystem.prototype.conversationalSearch = function (naturalLanguageQuery_1, userId_1) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response.nlpAnalysis) {
                            ...
                            console.log("Conversational search by ".concat(userId, ": \"").concat(naturalLanguageQuery, "\""));
                            console.log("Intent: ".concat(response.nlpAnalysis.intent.action, " ").concat(response.nlpAnalysis.intent.target));
                            console.log("Entities: ".concat(response.nlpAnalysis.entities.map(function (e) { return "".concat(e.type, ":").concat(e.value); }).join(', ')));
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        searchTerms = __spreadArray(__spreadArray(__spreadArray([
                            criteria.patientName
                        ], (criteria.keywords || []), true), (criteria.eventTypes || []), true), (criteria.providers || []), true).filter(Boolean).join(' ');
                        query = {
                            term: searchTerms,
