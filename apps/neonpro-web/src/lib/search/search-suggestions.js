...
var SearchSuggestions = /** @class */ (function () {
    ...
    SearchSuggestions.prototype.getSuggestions = function (query_1, context_1) {
        return __awaiter(this, arguments, void 0, function (query, context, options) {
            var cacheKey, suggestions_1, _a, completions, historical, popular, contextual, personalized, semantic, filteredSuggestions, finalSuggestions, error_2;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _a = _b.sent(), completions = _a[0], historical = _a[1], popular = _a[2], contextual = _a[3], personalized = _a[4], semantic = _a[5];
                        ...
                        suggestions_1.push.apply(suggestions_1, __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], historical, false), popular, false), contextual, false), personalized, false), semantic, false));
                        filteredSuggestions = suggestions_1.filter(function (s) {
                            return s.confidence >= options.minConfidence &&
    ...
    SearchSuggestions.prototype.getQueryCompletions = function (query, context) {
        return __awaiter(this, void 0, void 0, function () {
            var completions, prefixMatches, entityCompletions, templateCompletions, semanticCompletions, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (query.length < 2)
    ...
    SearchSuggestions.prototype.getPrefixCompletions = function (query) {
        ...
        for (var _i = 0, _a = this.popularQueries.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], popularQuery = _b[0], frequency = _b[1];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/, completions];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, nlp_engine_1.nlpEngine.processQuery(query, context.language || 'pt')];
                    case 1:
                        nlpResult = _a.sent();
                        completions_1 = [];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, search_indexer_1.searchIndexer.getSuggestions(query, {
                                maxSuggestions: 5,
                                minScore: 0.5
                            })];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.updateSuggestionPerformance(data.selectedSuggestion, data.success)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
...
var createsearchSuggestions = function () { return new SearchSuggestions(); };
