...
var SearchIndexer = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log("Removed ".concat(contentType, ":").concat(contentId, " from search index"));
                        return [3 /*break*/, 3];
                    case 2:
                        error_2 = _a.sent();
    ...
    SearchIndexer.prototype.updateIndex = function (content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.indexContent(content)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log("Bulk indexed ".concat(contents.length, " items in ").concat(processingTime, "s"));
                        return [3 /*break*/, 3];
                    case 2:
                        error_3 = _a.sent();
    ...
    SearchIndexer.prototype.search = function (query_1) {
        return __awaiter(this, arguments, void 0, function (query, options) {
            var startTime, _a, language, contentTypes, _b, limit, _c, offset, _d, filters, nlpResult, searchQuery, _i, _e, _f, key, value, _g, data, error, count, processingTime, error_4;
            var _h;
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 1:
                        ...
                        _a = options.language, language = _a === void 0 ? 'pt' : _a, contentTypes = options.contentTypes, _b = options.limit, limit = _b === void 0 ? 20 : _b, _c = options.offset, offset = _c === void 0 ? 0 : _c, _d = options.filters, filters = _d === void 0 ? {} : _d;
                    ...
                    case 2:
                        ...
                        if (Object.keys(filters).length > 0) {
                            for (_i = 0, _e = Object.entries(filters); _i < _e.length; _i++) {
                                ...
                                searchQuery = searchQuery.contains('metadata_json', (_h = {}, _h[key] = value, _h));
                            }
                        }
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.logSearchAnalytics(query, nlpResult, (data === null || data === void 0 ? void 0 : data.length) || 0, processingTime)];
                    case 4:
                        // Log search analytics
                        _j.sent();
                        return [2 /*return*/, {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        suggestions = (data === null || data === void 0 ? void 0 : data.map(function (item) { return item.suggestion_text; })) || [];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(batch.map(function (content) { return _this.prepareIndexEntry(content); }))];
                    case 2:
                    ...
                    case 4:
                        ...
                        console.log("Processed ".concat(batch.length, " index entries in ").concat(processingTime, "s"));
                        return [3 /*break*/, 7];
                    case 5:
                        error_6 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, nlp_engine_1.nlpEngine.processQuery(content.searchableText, language)];
                    case 1:
                        nlpResult = _a.sent();
                        keywords = __spreadArray(__spreadArray(__spreadArray([], nlpResult.tokens, true), nlpResult.entities.map(function (e) { return e.value; }), true), (content.keywords || []), true);
     ...
     * Log search analytics
     */
    SearchIndexer.prototype.logSearchAnalytics = function (query, nlpResult, resultCount, responseTime) {
        return __awaiter(this, void 0, void 0, function () {
            var error, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log("Cleared search index".concat(contentType ? " for ".concat(contentType) : ''));
                        return [3 /*break*/, 3];
                    case 2:
                        error_8 = _a.sent();
