...
export class SearchSuggestions {
  ...
  async getSuggestions(
    ...
    try {
      ...
      const [completions, historical, popular, contextual, personalized, semantic] =
        await Promise.all([
   ...
   */
  async getQueryCompletions(query: string, context: SuggestionContext): Promise<QueryCompletion[]> {
   ...
   */
  private getTemplateCompletions(query: string, context: SuggestionContext): QueryCompletion[] {
    const templates = [
   ...
   */
  private highlightSuggestions(suggestions: SearchSuggestion[], query: string): SearchSuggestion[] {
   ...
   */
  private async updateSuggestionPerformance(suggestion: string, success: boolean): Promise<void> {
    try {
