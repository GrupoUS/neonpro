...
var ComprehensiveSearch = /** @class */ (() => {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_k) {
        switch (_k.label) {
          ...
          case 1:
            _k.trys.push([1, 7, , 8]);
            (query_1 = options.query),
              (_a = options.language),
              (language = _a === void 0 ? "pt" : _a),
              (dataTypes = options.dataTypes),
              (dateRange_1 = options.dateRange),
              (_b = options.filters),
              (filters_1 = _b === void 0 ? {} : _b),
              (_c = options.sortBy),
              (sortBy = _c === void 0 ? "relevance" : _c),
              (_d = options.sortOrder),
              (sortOrder = _d === void 0 ? "desc" : _d),
              (_e = options.limit),
              (limit_1 = _e === void 0 ? 50 : _e),
              (_f = options.offset),
              (offset = _f === void 0 ? 0 : _f),
              (_g = options.includeArchived),
              (includeArchived_1 = _g === void 0 ? false : _g),
              (_h = options.fuzzySearch),
              (fuzzySearch_1 = _h === void 0 ? true : _h),
              (_j = options.exactMatch),
              (exactMatch_1 = _j === void 0 ? false : _j);
  ...
  ComprehensiveSearch.prototype.transformResult = function (item, config, nlpResult) {
    ...
    var _a = this.generateTitleAndDescription(item, config),
      title = _a.title,
  ...
  ComprehensiveSearch.prototype.generateTitleAndDescription = function (item, config) {
    ...
    switch (config.type) {
      ...
      case "appointment":
        ...
        description = ""
          .concat(item.reason || "", " \u2022 ")
          .concat(new Date(item.scheduled_at).toLocaleDateString());
        break;
      case "treatment":
      ...
      case "file":
        ...
        description = ""
          .concat(item.file_type || "", " \u2022 ")
          .concat(this.formatFileSize(item.file_size));
        break;
      case "provider":
   ...
   */
  ComprehensiveSearch.prototype.indexContent = function (
    type,
    contentId,
    searchableText,
    metadata,
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              search_indexer_1.searchIndexer.indexContent({
                contentType: type,
                contentId: contentId,
...
exports.comprehensiveSearch = new ComprehensiveSearch(
