...
var PatientSegmentation = /** @class */ (function () {
  ...
  PatientSegmentation.prototype.createSegment = function (name_1, naturalLanguageQuery_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (name, naturalLanguageQuery, language, createdBy, description) {
        var nlpResult,
          structuredCriteria,
          criteria,
          _a,
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                nlp_engine_1.nlpEngine.processQuery(naturalLanguageQuery, language),
              ];
            case 1:
              nlpResult = _b.sent();
            ...
            case 2:
              ...
              criteria = {
                ...
                description:
                  description ||
                  'Segmento criado a partir da consulta: "'.concat(naturalLanguageQuery, '"'),
    ...
    return __awaiter(this, arguments, void 0, function (criteria, options) {
      ...
      return __generator(this, function (_h) {
        switch (_h.label) {
          case 0:
            _h.trys.push([0, 6, , 7]);
            (_a = options.includeInactive),
              (includeInactive = _a === void 0 ? false : _a),
              (_b = options.maxPatients),
              (maxPatients = _b === void 0 ? 1000 : _b),
              (_c = options.minMatchScore),
              (minMatchScore = _c === void 0 ? 0.5 : _c),
              (_d = options.sortBy),
              (sortBy = _d === void 0 ? "matchScore" : _d),
              (_e = options.sortOrder),
              (sortOrder = _e === void 0 ? "desc" : _e),
              (_f = options.refreshData),
              (refreshData = _f === void 0 ? false : _f);
            // Check cache first
            ...
            return [
              4 /*yield*/,
              this.supabase.rpc("search_patients_by_criteria", {
                criteria_json: criteria.structuredCriteria,
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.calculateMatchScores(patients || [], criteria, minMatchScore),
            ];
          case 2:
   ...
   */
  PatientSegmentation.prototype.calculateMatchScores = function (
    patients,
    criteria,
    minMatchScore,
  ) {
  ...
  PatientSegmentation.prototype.scoreDemographics = function (patient, demographics) {
    ...
    if (demographics.location && demographics.location.length > 0) {
      maxScore += 10;
      var patientLocation_1 = ""
        .concat(patient.address || "", " ")
        .concat(patient.city || "", " ")
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        insights.commonCharacteristics = [
          "Faixa et\u00E1ria predominante: ".concat(
            ((_a = ageGroups[0]) === null || _a === void 0 ? void 0 : _a.range) || "N/A",
          ),
        ...
        insights.trends = [
          ...
          "Score m\u00E9dio de correspond\u00EAncia: ".concat(
            this.calculateAverageMatchScore(members).toFixed(2),
          ),
          "Frequ\u00EAncia m\u00E9dia de visitas: ".concat(
            this.calculateAverageVisitFrequency(members).toFixed(1),
          ),
        ];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("patient_segments").delete().eq("id", segmentId),
            ];
          case 1:
            error = _a.sent().error;
            if (error) {
...
exports.patientSegmentation = new PatientSegmentation(
