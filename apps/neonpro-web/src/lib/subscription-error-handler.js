...
var SubscriptionErrorHandler = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (context) {
                            subscriptionError = subscription_errors_1.SubscriptionErrorFactory.enrichError(subscriptionError, context);
                        }
                        ...
                        if (this.config.enableCircuitBreaker && this.shouldUseCircuitBreaker(subscriptionError)) {
                            return [2 /*return*/, this.handleWithCircuitBreaker(operation, subscriptionError, context, startTime)];
                        }
                        // Attempt recovery if enabled
                        if (this.config.enableAutoRecovery && subscriptionError.retryable) {
                            return [2 /*return*/, this.attemptRecovery(operation, subscriptionError, context, startTime)];
                        }
    ...
    SubscriptionErrorHandler.prototype.classifyError = function (error, context) {
        ...
        if (message.includes('auth') || message.includes('unauthorized') || message.includes('token')) {
            return subscription_errors_1.SubscriptionErrorFactory.createError('auth', error.message, context);
        }
        // Network errors
        if (message.includes('network') || message.includes('fetch') || message.includes('connection')) {
            return subscription_errors_1.SubscriptionErrorFactory.createError('network', error.message, context);
        }
        // Timeout errors
        if (message.includes('timeout') || message.includes('aborted')) {
            return subscription_errors_1.SubscriptionErrorFactory.createError('timeout', error.message, context);
        }
        // Database errors
        if (message.includes('database') || message.includes('sql') || message.includes('query')) {
            return subscription_errors_1.SubscriptionErrorFactory.createError('database', error.message, context);
        }
        // Rate limit errors
        if (message.includes('rate') || message.includes('limit') || message.includes('throttle')) {
            return subscription_errors_1.SubscriptionErrorFactory.createError('rate_limit', error.message, context);
        }
        // Default to validation error
        return subscription_errors_1.SubscriptionErrorFactory.createError('validation', error.message, context);
    };
    /**
    ...
    SubscriptionErrorHandler.prototype.initializeRecoveryStrategies = function () {
        ...
        strategies.set(subscription_errors_1.RecoveryStrategy.RETRY, {
            canHandle: function (error) { return error.retryable && error.category !== subscription_errors_1.ErrorCategory.AUTHENTICATION; },
            execute: function (operation, error, context, attempt) { return __awaiter(_this, void 0, void 0, function () {
                var delay;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        strategies.set(subscription_errors_1.RecoveryStrategy.FALLBACK, {
            canHandle: function (error) { return error.category === subscription_errors_1.ErrorCategory.CACHE || error.category === subscription_errors_1.ErrorCategory.EXTERNAL_SERVICE; },
            execute: function (operation, error, context, attempt) { return __awaiter(_this, void 0, void 0, function () {
                var cachedResult;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(this.config.enableFallbackCache && (context === null || context === void 0 ? void 0 : context.userId))) return [3 /*break*/, 2];
                        ...
                        case 1:
                            ...
                            _a.label = 2;
                        case 2: throw error; // Re-throw if no fallback available
                    }
                });
            }); },
            maxAttempts: 1,
        ...
        strategies.set(subscription_errors_1.RecoveryStrategy.GRACEFUL_DEGRADE, {
            canHandle: function (error) { return _this.config.gracefulDegradationEnabled; },
            execute: function (operation, error, context, attempt) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
     ...
     */
    SubscriptionErrorHandler.prototype.attemptRecovery = function (operation, error, context, startTime) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        lastError = retryError_1 instanceof Error && 'code' in retryError_1
                            ? retryError_1
                            : this.classifyError(retryError_1, context);
                        // Log retry attempt
                        if (this.config.logErrors) {
                            console.warn("Recovery attempt ".concat(attempts, "/").concat(maxAttempts, " failed:"), lastError.message);
                        }
                        // Check if we should stop retrying
                        if (!lastError.retryable || lastError.severity === subscription_errors_1.ErrorSeverity.CRITICAL) {
                            return [3 /*break*/, 6];
                        }
                        return [3 /*break*/, 5];
                    case 5: return [3 /*break*/, 1];
                    case 6: return [4 /*yield*/, this.applyFallbackStrategies(lastError, context)];
                    case 7:
                        fallbackResult = _a.sent();
                        return [2 /*return*/, {
                                success: false,
     ...
     */
    SubscriptionErrorHandler.prototype.handleWithCircuitBreaker = function (operation, error, context, startTime) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4: return [2 /*return*/, { fallbackUsed: false }];
                }
            });
        });
    };
    ...
    SubscriptionErrorHandler.prototype.shouldUseCircuitBreaker = function (error) {
        return error.severity === subscription_errors_1.ErrorSeverity.HIGH ||
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    return [2 /*return*/, exports.subscriptionErrorHandler.handleError(error_1, operation, context)];
