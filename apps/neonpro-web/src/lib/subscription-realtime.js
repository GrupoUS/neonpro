...
var SubscriptionRealtimeManager = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    this.channel
                        ...
                        schema: 'public',
                        table: 'subscriptions'
                    }, function (payload) { return _this.handleSubscriptionChange(payload); })
                        .on('broadcast', { event: 'subscription_event' }, function (payload) { return _this.handleBroadcastEvent(payload); })
                        .on('presence', { event: 'sync' }, function () { return _this.handlePresenceSync(); })
                    ...
                    this.log("Failed to connect: ".concat(error instanceof Error ? error.message : 'Unknown error'), 'error');
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        this.log("Failed to broadcast event: ".concat(error_1 instanceof Error ? error_1.message : 'Unknown error'), 'error');
                        return [2 /*return*/, false];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error) {
                            this.log("Failed to refresh subscription for user ".concat(userId, ": ").concat(error.message), 'error');
                            return [2 /*return*/];
                        }
                        if (subscription) {
                            update = {
                    ...
                    case 2:
                        error_2 = _b.sent();
                        this.log("Failed to force refresh: ".concat(error_2 instanceof Error ? error_2.message : 'Unknown error'), 'error');
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    SubscriptionRealtimeManager.prototype.handleSubscriptionChange = function (payload) {
        try {
            ...
            var status_1 = (newRecord === null || newRecord === void 0 ? void 0 : newRecord.status) || (oldRecord === null || oldRecord === void 0 ? void 0 : oldRecord.status);
            ...
            switch (eventType) {
                case 'INSERT':
                    ...
                    break;
                case 'UPDATE':
                    if ((oldRecord === null || oldRecord === void 0 ? void 0 : oldRecord.status) !== (newRecord === null || newRecord === void 0 ? void 0 : newRecord.status)) {
                    ...
                    else if ((oldRecord === null || oldRecord === void 0 ? void 0 : oldRecord.tier) !== (newRecord === null || newRecord === void 0 ? void 0 : newRecord.tier)) {
                        event_1 = newRecord.tier > oldRecord.tier ? 'subscription_upgraded' : 'subscription_downgraded';
                    }
                    break;
                case 'DELETE':
                    event_1 = 'subscription_cancelled';
            ...
            if (record) {
                ...
                this.notifyListeners(update);
                this.log("Processed subscription change: ".concat(event_1, " for user ").concat(record.user_id));
            }
        }
        catch (error) {
            this.log("Failed to handle subscription change: ".concat(error instanceof Error ? error.message : 'Unknown error'), 'error');
        }
    };
    /**
    ...
    SubscriptionRealtimeManager.prototype.handleBroadcastEvent = function (payload) {
        try {
            ...
            this.notifyListeners(update);
            this.log("Received broadcast event: ".concat(update.event, " for user ").concat(update.userId));
        }
        catch (error) {
            this.log("Failed to handle broadcast event: ".concat(error instanceof Error ? error.message : 'Unknown error'), 'error');
        }
    };
    /**
        ...
        if (listeners) {
            listeners.forEach(function (callback) {
                try {
                    ...
                    _this.log("Listener error for user ".concat(update.userId, ": ").concat(error instanceof Error ? error.message : 'Unknown error'), 'error');
                }
            });
        }
    };
    ...
    SubscriptionRealtimeManager.prototype.scheduleReconnect = function () {
        ...
        if (this.reconnectAttempts >= this.config.maxReconnectAttempts) {
            this.log("Max reconnection attempts (".concat(this.config.maxReconnectAttempts, ") reached"), 'error');
            return;
        }
        this.reconnectAttempts++;
        this.metrics.reconnectAttempts++;
        setTimeout(function () {
            _this.log("Reconnection attempt ".concat(_this.reconnectAttempts, "/").concat(_this.config.maxReconnectAttempts));
            _this.connect();
