...
var ChannelOptimizationEngine = /** @class */ (() => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("channel_optimization_config").select("*").single(),
            ];
          case 1:
            data = _a.sent().data;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getOrCreatePatientProfile(request.patientId, request.clinicId),
            ];
          case 1:
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.generateChannelRecommendations(request, patientProfile, context),
            ];
          case 3:
            recommendations = _a.sent();
            return [
              4 /*yield*/,
              this.identifyAlternativeChannels(recommendations, request, patientProfile),
            ];
          case 4:
            ...
            return [
              4 /*yield*/,
              this.estimateEffectiveness(recommendations, patientProfile, context),
            ];
          case 5:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [3 /*break*/, 4];
          case 4:
            return [4 /*yield*/, this.createNewPatientProfile(patientId, clinicId)];
          case 5:
            newProfile = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            return [2 /*return*/, ((_a.communicationHistory = _b.sent()), _a)];
        }
      });
    });
  };
   ...
   */
  ChannelOptimizationEngine.prototype.generateChannelRecommendations = function (
    request,
    profile,
    context,
  ) {
            ...
            if (
              !((_c =
                (_b = this.config) === null || _b === void 0
                  ? void 0
                  : _b.channelSettings[channel]) === null || _c === void 0
                ? void 0
                : _c.enabled)
            )
              return [3 /*break*/, 3];
          ...
          case 4:
            ...
            maxChannels =
              ((_d = this.config) === null || _d === void 0
                ? void 0
                : _d.globalSettings.maxChannelsPerCommunication) || 2;
   ...
   */
  ChannelOptimizationEngine.prototype.evaluateChannel = function (
    channel,
    request,
    profile,
    context,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.calculateRecommendedTiming(channel, profile, request.urgency),
            ];
          case 2:
            timing = _a.sent();
            expectedOutcome = this.estimateChannelOutcome(channel, behavior, context);
            reasoning = this.generateChannelReasoning(
              channel,
              preference,
              behavior,
              context,
   ...
   */
  ChannelOptimizationEngine.prototype.learnFromOutcome = function (
    communicationId,
    prediction,
    actualOutcome,
  ) {
   ...
   */
  ChannelOptimizationEngine.prototype.updatePatientProfile = function (
    patientId,
    clinicId,
    newBehavior,
  ) {
            ...
            if (newBehavior.channel) {
              ...
              if (existingBehaviorIndex >= 0) {
                ...
                profile.behaviors[existingBehaviorIndex] = __assign(
                  __assign({}, profile.behaviors[existingBehaviorIndex]),
                  newBehavior,
                );
              } else {
  ...
  ChannelOptimizationEngine.prototype.meetsConstraints = function (channel, request, profile) {
    var _a, _b;
    var channelSettings =
      (_a = this.config) === null || _a === void 0 ? void 0 : _a.channelSettings[channel];
   ...
   */
  ChannelOptimizationEngine.prototype.calculateChannelPriority = function (
    channel,
    confidence,
    preference,
  ) {
    ...
    var channelSettings =
      (_a = this.config) === null || _a === void 0 ? void 0 : _a.channelSettings[channel];
    var priority =
      (channelSettings === null || channelSettings === void 0
        ? void 0
        : channelSettings.priority) || 10;
  ...
  ChannelOptimizationEngine.prototype.generateChannelReasoning = (
    ...
    if (preference && preference.preference > 0.7) {
      reasons.push(
        "Paciente demonstra alta prefer\u00EAncia por "
          .concat(channel, " (")
          .concat(Math.round(preference.preference * 100), "%)"),
      );
    }
    if (
      (behavior === null || behavior === void 0 ? void 0 : behavior.engagement.engagementScore) > 70
    ) {
      reasons.push(
        "Hist\u00F3rico de alto engajamento em "
          .concat(channel, " (")
          .concat(behavior.engagement.engagementScore, "%)"),
      );
    }
    ...
    if (adaptations.length > 0) {
      reasons.push(
        "Conte\u00FAdo ser\u00E1 adaptado para otimizar efetividade em ".concat(channel),
      );
    }
    if (reasons.length === 0) {
  ...
  ChannelOptimizationEngine.prototype.identifyAlternativeChannels = function (
    recommendations,
    request,
    profile,
  ) {
  ...
  ChannelOptimizationEngine.prototype.estimateEffectiveness = function (
    recommendations,
    profile,
    context,
  ) {
  ...
  ChannelOptimizationEngine.prototype.validateCompliance = function (
    recommendations,
    request,
    profile,
  ) {
  ...
  ChannelOptimizationEngine.prototype.calculateRecommendedTiming = function (
    channel,
    profile,
    urgency,
  ) {
