...
var ABTestingEngine = /** @class */ (function () {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ...
            calculatedSampleSize = this.calculateSampleSize(
            ...
            return [
              ...
              this.supabase
                ...
                .insert({
                  ...
                  end_date:
                    (_b = testConfig.endDate) === null || _b === void 0 ? void 0 : _b.toISOString(),
          ...
          case 1:
            ...
            if (!((_c = config.variations) === null || _c === void 0 ? void 0 : _c.length))
              return [3 /*break*/, 3];
          ...
          case 2:
            ...
            _d.label = 3;
          case 3:
            return [4 /*yield*/, this.invalidateCache("test_".concat(testConfig.id))];
          case 4:
            _d.sent();
            ...
            return [
              ...
              this.supabase
                ...
                .update({
                  ...
                  end_date:
                    (_b = updates.endDate) === null || _b === void 0 ? void 0 : _b.toISOString(),
        ...
        switch (_e.label) {
          case 0:
            ...
            if (filter.searchTerm) {
              query = query.or(
                "name.ilike.%"
                  .concat(filter.searchTerm, "%,description.ilike.%")
                  .concat(filter.searchTerm, "%"),
              );
            }
            page = filter.page || 1;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.logTestEvent(testId, "test_started", { startedBy: test.createdBy }),
            ];
          case 3:
            // Criar eventos de audit
            _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.logTestEvent(testId, "test_completed", { reason: reason, results: results }),
            ];
          case 4:
            _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            test = _a.sent();
            if (!test || test.status !== "active") return [2 /*return*/, null];
            return [4 /*yield*/, this.isPatientInAudience(patientId, test.audienceFilter)];
          case 2:
            isInAudience = _a.sent();
            if (!isInAudience) return [2 /*return*/, null];
            random = Math.random() * 100;
            if (random > test.trafficAllocation) return [2 /*return*/, null];
            variation = this.selectVariationByWeight(test.variations);
            if (!variation) return [2 /*return*/, null];
   ...
   */
  ABTestingEngine.prototype.recordConversion = function (
    testId,
    variationId,
    patientId,
    goalId,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("ab_test_events").select("*").eq("test_id", testId),
            ];
          case 2:
            events = _b.sent().data;
          ...
          case 5:
            (_a.dailyResults = _b.sent()), (_a.insights = insights);
            return [4 /*yield*/, this.generateRecommendations(test, variationResults, insights)];
          case 6:
            results = ((_a.recommendations = _b.sent()), (_a.calculatedAt = new Date()), _a);
            // Salvar resultados
  ...
  ABTestingEngine.prototype.performStatisticalAnalysis = function (variationResults) {
    ...
    for (var _i = 0, variants_1 = variants; _i < variants_1.length; _i++) {
      ...
      var _a = this.performTTest(control, variant),
        pValue = _a.pValue,
        power = _a.power;
        ...
        switch (_c.label) {
          case 0:
            ...
            if ((_b = filter.excludePatients) === null || _b === void 0 ? void 0 : _b.length) {
              if (filter.excludePatients.includes(patientId)) return [2 /*return*/, false];
            }
            return [
              4 /*yield*/,
          ...
          case 1:
            ...
            if (!patient) return [2 /*return*/, false];
  ...
  ABTestingEngine.prototype.flushEventBuffer = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            if (!this.eventBuffer.length) return [2 /*return*/];
            _b.label = 1;
          case 1:
            _b.trys.push([1, 4, , 5]);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("ab_tests").update({ results: results }).eq("id", testId),
            ];
          case 1:
            _a.sent();
            return [2 /*return*/];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("ab_test_audit_log").insert({
                test_id: testId,
