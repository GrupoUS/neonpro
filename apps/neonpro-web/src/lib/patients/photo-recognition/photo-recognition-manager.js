...
var PhotoRecognitionManager = /** @class */ (function () {
     ...
     */
    PhotoRecognitionManager.prototype.uploadPatientPhoto = function (patientId, photoFile, photoType, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var hasConsent, qualityAssessment, fileExtension, filename, _a, uploadData, uploadError, metadata, dimensions, recognitionResult, dbError, error_1;
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (qualityAssessment.overall < this.config.qualityThreshold) {
                            throw new Error("Photo quality too low: ".concat(qualityAssessment.recommendations.join(', ')));
                        }
                        fileExtension = this.getFileExtension(photoFile);
                        filename = "".concat(patientId, "/").concat(photoType, "/").concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9), ".").concat(fileExtension);
                    ...
                    case 6: return [4 /*yield*/, this.supabase
                            ...
                            recognition_data: (recognitionResult === null || recognitionResult === void 0 ? void 0 : recognitionResult.features) || null,
    ...
    PhotoRecognitionManager.prototype.verifyPatientIdentity = function (request, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, hasConsent, qualityAssessment, recognitionResult, bestMatch, verified, securityFlags, recommendations, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 6, , 8]);
                        return [4 /*yield*/, this.lgpdManager.checkConsent(request.patientId, 'biometric_verification')];
                    case 2:
                        hasConsent = _a.sent();
                        if (!hasConsent) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.performFacialRecognition(request.photoFile, request.patientId)];
                    case 4:
                        ...
                        bestMatch = recognitionResult.matches
                            .filter(function (match) { return match.patientId === request.patientId; })
                        ...
                        return [4 /*yield*/, this.auditLogger.log({
                                ...
                                details: {
                                    ...
                                    verified: verified,
                                    confidence: (bestMatch === null || bestMatch === void 0 ? void 0 : bestMatch.confidence) || 0,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, this.convertToBase64(photoFile)
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.searchFacialMatches(features, patientId)
                            // Find best match
                        ];
                    case 3:
                        matches = _a.sent();
                        ...
                        return [2 /*return*/, {
                                success: true,
                                patientId: bestMatch === null || bestMatch === void 0 ? void 0 : bestMatch.patientId,
                                confidence: (bestMatch === null || bestMatch === void 0 ? void 0 : bestMatch.confidence) || 0,
                                matches: matches,
                                features: features
                            }];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        mockFeatures = {
                            landmarks: [
                                [100, 120], [150, 120], // Eyes
                                [125, 140], // Nose
                                [110, 160], [140, 160] // Mouth corners
                            ],
                            encoding: Array.from({ length: 128 }, function () { return Math.random() * 2 - 1; }),
                    ...
                    case 1:
                        ...
                        for (_i = 0, _b = storedPhotos || []; _i < _b.length; _i++) {
                            ...
                            if (!((_c = photo.recognition_data) === null || _c === void 0 ? void 0 : _c.encoding))
                                continue;
                            similarity = this.calculateFacialSimilarity(features.encoding, photo.recognition_data.encoding);
                        ...
                        return [2 /*return*/, matches.sort(function (a, b) { return b.confidence - a.confidence; })];
                    case 2:
                        error_5 = _d.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        filteredPhotos = (photos === null || photos === void 0 ? void 0 : photos.filter(function (photo) {
                            ...
                            var daysSinceUpload = (Date.now() - uploadDate.getTime()) / (1000 * 60 * 60 * 24);
                            if (daysSinceUpload > privacyControls_1.dataRetentionDays) {
                                return false;
                            }
                            return true;
                        })) || [];
                        return [2 /*return*/, filteredPhotos.map(function (photo) { return ({
                                id: photo.id,
                                patientId: photo.patient_id,
     ...
     */
    PhotoRecognitionManager.prototype.updatePatientPrivacyControls = function (patientId, controls, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var error, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PhotoRecognitionManager.prototype.getRecognitionStats = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _a, photos, error, totalPhotos, recognizedPhotos, confidenceScores, averageConfidence, lastRecognition, error_10;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        recognizedPhotos = (photos === null || photos === void 0 ? void 0 : photos.filter(function (p) { return p.recognition_data; }).length) || 0;
                        confidenceScores = (photos === null || photos === void 0 ? void 0 : photos.filter(function (p) { var _a; return (_a = p.recognition_data) === null || _a === void 0 ? void 0 : _a.confidence; }).map(function (p) { return p.recognition_data.confidence; })) || [];
                        averageConfidence = confidenceScores.length > 0
                            ...
                            : 0;
                        lastRecognition = (_b = photos === null || photos === void 0 ? void 0 : photos.filter(function (p) { return p.recognition_data; }).sort(function (a, b) { return new Date(b.upload_date).getTime() - new Date(a.upload_date).getTime(); })[0]) === null || _b === void 0 ? void 0 : _b.upload_date;
                        return [2 /*return*/, {
