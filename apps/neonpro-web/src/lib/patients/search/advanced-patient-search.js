    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            if (!query || query.length < 2) return [2 /*return*/, []];
            return [
              4 /*yield*/,
              client_1.supabase
                .from("patients")
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [4 /*yield*/, client_1.supabase.from("patient_segments").insert(segment)];
          case 3:
            error = _a.sent().error;
            if (error) throw error;
            logger_1.logger.info(
              "Created patient segment: "
                .concat(name, " with ")
                .concat(segment.patient_count, " patients"),
            );
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              client_1.supabase.rpc("calculate_segment_stats", { filter_criteria: criteria }),
            ];
          case 1:
            stats = _a.sent().data;
            return [
              ...
              {
                avg_satisfaction:
                  (stats === null || stats === void 0 ? void 0 : stats.avg_satisfaction) || 0,
                avg_risk_score:
                  (stats === null || stats === void 0 ? void 0 : stats.avg_risk_score) || 0,
              },
            ];
          case 2:
            error_6 = _a.sent();
