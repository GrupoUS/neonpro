...
var createsystemIntegrationManager = /** @class */ (function () {
    ...
    createsystemIntegrationManager.prototype.searchPatients = function (query_1) {
        return __awaiter(this, arguments, void 0, function (query, filters, userId, limit) {
            var startTime, searchQuery, currentYear, maxBirthYear, minBirthYear, _a, patients, error, count, enrichedPatients, suggestions, searchTime, error_1;
            var _this = this;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        // Apply text search
                        if (query) {
                            searchQuery = searchQuery.or("name.ilike.%".concat(query, "%,email.ilike.%").concat(query, "%,phone.ilike.%").concat(query, "%,cpf.ilike.%").concat(query, "%"));
                        }
                        // Apply filters
                        if (filters.ageRange) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, Promise.all((patients || []).map(function (patient) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.getIntegratedPatientData(patient.id, userId)];
    ...
    createsystemIntegrationManager.prototype.getIntegratedPatientData = function (patientId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var hasPermission, _a, patient, patientError, appointments, treatments, photoCount, riskAssessment, totalSpent, lastActivity, loyaltyScore, communicationHistory, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 8, , 9]);
                        return [4 /*yield*/, this.lgpdManager.checkDataAccess(userId, patientId, 'patient_profile')];
                    case 1:
                    ...
                    case 6:
                        ...
                        totalSpent = (treatments === null || treatments === void 0 ? void 0 : treatments.reduce(function (sum, treatment) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        patientSuggestions === null || patientSuggestions === void 0 ? void 0 : patientSuggestions.forEach(function (patient) {
                            suggestions.push({
                                type: 'patient',
                                id: patient.id,
                                title: patient.name,
                    ...
                    case 3:
                        ...
                        treatmentSuggestions === null || treatmentSuggestions === void 0 ? void 0 : treatmentSuggestions.forEach(function (treatment) {
                            var _a;
                            suggestions.push({
                                type: 'treatment',
                                id: treatment.id,
                                title: treatment.name,
                                subtitle: "Paciente: ".concat((_a = treatment.patients) === null || _a === void 0 ? void 0 : _a.name),
                                relevanceScore: _this.calculateRelevanceScore(query, treatment.name),
                                matchedFields: ['treatment_name']
                            });
                        });
                        // Sort by relevance
                        suggestions.sort(function (a, b) { return b.relevanceScore - a.relevanceScore; });
     ...
     */
    createsystemIntegrationManager.prototype.createPatientSegment = function (name, description, criteria, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        recentAppointments === null || recentAppointments === void 0 ? void 0 : recentAppointments.forEach(function (appointment) {
                            var _a;
                            if (!seenPatients_1.has(appointment.patient_id)) {
                                seenPatients_1.add(appointment.patient_id);
                                quickAccess_1.push({
                                    patientId: appointment.patient_id,
                                    patientName: ((_a = appointment.patients) === null || _a === void 0 ? void 0 : _a.name) || 'Nome não disponível',
     ...
     */
    createsystemIntegrationManager.prototype.getPatientCommunicationHistory = function (patientId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.lgpdManager.checkDataAccess(userId, patientId, 'communication_history')];
                    case 1:
                    ...
                    case 2:
                        ...
                        communicationHistory = (appointments === null || appointments === void 0 ? void 0 : appointments.map(function (appointment) { return ({
                            id: appointment.id,
                            type: 'appointment',
    ...
    createsystemIntegrationManager.prototype.getLastActivity = function (appointments, treatments) {
        var allDates = __spreadArray(__spreadArray([], appointments.map(function (a) { return new Date(a.appointment_date); }), true), treatments.map(function (t) { return new Date(t.created_at); }), true);
        return allDates.length > 0
            ? new Date(Math.max.apply(Math, allDates.map(function (d) { return d.getTime(); })))
            : new Date();
    };
    createsystemIntegrationManager.prototype.calculateLoyaltyScore = function (appointments, treatments) {
        var appointmentCount = appointments.length;
        var treatmentCount = treatments.length;
        var completedAppointments = appointments.filter(function (a) { return a.status === 'completed'; }).length;
