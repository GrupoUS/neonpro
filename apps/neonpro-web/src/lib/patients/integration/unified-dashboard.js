      ...
      return __generator(this, function (_j) {
        switch (_j.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              appointment_integration_1.PatientAppointmentIntegration.generateAppointmentInsights(
                patientId,
              ),
            ];
          case 2:
            ...
            return [
              4 /*yield*/,
              treatment_integration_1.PatientTreatmentIntegration.generateTreatmentInsights(
                patientId,
              ),
            ];
          case 3:
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              this.generateAIInsights(patientId, {
          ...
          case 7:
              ...
              profile_extended: {
                ...
                satisfaction_score:
                  ((_c = patient.patient_profiles_extended) === null || _c === void 0
                    ? void 0
                    : _c.satisfaction_score) || 0,
                loyalty_score:
                  ((_d = patient.patient_profiles_extended) === null || _d === void 0
                    ? void 0
                    : _d.loyalty_score) || 0,
                ...
                communication_preferences:
                  ((_e = patient.patient_profiles_extended) === null || _e === void 0
                    ? void 0
                    : _e.communication_preferences) || [],
                emergency_contacts: patient.emergency_contacts || [],
                medical_conditions:
                  ((_f = patient.patient_profiles_extended) === null || _f === void 0
                    ? void 0
                    : _f.medical_conditions) || [],
                allergies:
                  ((_g = patient.patient_profiles_extended) === null || _g === void 0
                    ? void 0
                    : _g.allergies) || [],
                medications:
                  ((_h = patient.patient_profiles_extended) === null || _h === void 0
                    ? void 0
                    : _h.current_medications) || [],
              },
            ...
            logger_1.logger.info(
              "Successfully generated unified profile for patient ".concat(patientId),
            );
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              client_1.supabase.from("patients").select("*", { count: "exact", head: true }),
            ];
          case 1:
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              client_1.supabase.from("patient_treatments").select("cost_total, cost_paid"),
            ];
          case 6:
          ...
          case 8:
            ...
            appointmentUtilization =
              totalSlots && totalSlots > 0 ? ((bookedSlots || 0) / totalSlots) * 100 : 0;
            return [
              4 /*yield*/,
              client_1.supabase
          ...
          case 12:
            ...
            patientRetentionRate =
              oldPatients && oldPatients > 0 ? ((returningPatients || 0) / oldPatients) * 100 : 0;
            return [
              2 /*return*/,
              {
          ...
          case 1:
            ...
            lastContactDate =
              ((_a =
                communications === null || communications === void 0
                  ? void 0
                  : communications[0]) === null || _a === void 0
                ? void 0
                : _a.created_at) || "";
            channelCounts_1 = {};
            communications === null || communications === void 0
