...
var PatientAppointmentIntegration = /** @class */ (function () {
    ...
    PatientAppointmentIntegration.getPatientAppointmentHistory = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, appointments, error, completed, cancelled, noShows, timePreferences, servicePreferences, ratingsSum, averageRating, nextAppointment, error_1;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        completed = (appointments === null || appointments === void 0 ? void 0 : appointments.filter(function (apt) { return apt.status === 'completed'; })) || [];
                        cancelled = (appointments === null || appointments === void 0 ? void 0 : appointments.filter(function (apt) { return apt.status === 'cancelled'; })) || [];
                        noShows = (appointments === null || appointments === void 0 ? void 0 : appointments.filter(function (apt) { return apt.status === 'no_show'; })) || [];
                        ...
                        ratingsSum = completed
                            .filter(function (apt) { return apt.rating; })
                            .reduce(function (sum, apt) { return sum + (apt.rating || 0); }, 0);
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                total_appointments: (appointments === null || appointments === void 0 ? void 0 : appointments.length) || 0,
                                completed_appointments: completed.length,
                                cancelled_appointments: cancelled.length,
                                no_show_count: noShows.length,
                                average_rating: averageRating,
                                last_appointment_date: ((_b = completed[0]) === null || _b === void 0 ? void 0 : _b.appointment_date) || null,
                                next_appointment_date: (nextAppointment === null || nextAppointment === void 0 ? void 0 : nextAppointment.appointment_date) || null,
    ...
    PatientAppointmentIntegration.generateAppointmentInsights = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var history_1, attendanceRate, punctualityScore, satisfactionScore, loyaltyIndex, riskFactors, recommendations, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        history_1 = _a.sent();
                        attendanceRate = history_1.total_appointments > 0
                    ...
                    case 2:
                        ...
                        recommendations = this.generateRecommendations(history_1, attendanceRate, satisfactionScore);
                        return [2 /*return*/, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        history_2 = _b.sent();
                        optimizedAppointment = __assign(__assign({}, appointmentData), { patient_id: patientId, preferred_time: appointmentData.appointment_time || history_2.preferred_times[0], notes: "".concat(appointmentData.notes || '', " | Patient preferences: ").concat(history_2.preferred_services.join(', ')) });
                        return [4 /*yield*/, client_1.supabase
                                .from('appointments')
                    ...
                    case 3:
                        // Update patient's last interaction
                        _b.sent();
                        logger_1.logger.info("Patient ".concat(patientId, " linked to appointment ").concat(appointment.id));
    ...
    PatientAppointmentIntegration.calculateLoyaltyIndex = function (history) {
        ...
        return Math.round(Object.values(factors).reduce(function (sum, factor) { return sum + factor; }, 0));
    };
    /**
    ...
    PatientAppointmentIntegration.calculateConsistency = function (history) {
        ...
        var variance = intervals.reduce(function (sum, interval) { return sum + Math.pow(interval - avgInterval, 2); }, 0) / intervals.length;
     ...
     */
    PatientAppointmentIntegration.generateRecommendations = function (history, attendanceRate, satisfactionScore) {
        var recommendations = [];
        if (attendanceRate < 80) {
            recommendations.push('Send appointment reminders 24h and 2h before');
        }
        if (history.preferred_times.length > 0) {
            recommendations.push("Schedule during preferred times: ".concat(history.preferred_times.join(', ')));
        }
        ...
        if (history.preferred_services.length > 0) {
            recommendations.push("Focus on preferred services: ".concat(history.preferred_services.slice(0, 2).join(', ')));
        }
