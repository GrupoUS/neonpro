              ...
              (treatments === null || treatments === void 0
                ...
                : treatments.map(function (treatment) {
                    ...
                    return {
                      ...
                      service_name:
                        ((_a = treatment.services) === null || _a === void 0 ? void 0 : _a.name) ||
                        "Unknown Service",
                      provider_name:
                        ((_b = treatment.staff) === null || _b === void 0 ? void 0 : _b.name) ||
                        "Unknown Provider",
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            return [2 /*return*/, ((_a.next_recommended_treatments = _b.sent()), _a)];
          case 3:
            error_2 = _b.sent();
        ...
        switch (_b.label) {
          case 0:
            ...
            return [
              ...
              client_1.supabase
                .from("patient_treatments")
                .insert(
                  __assign(__assign({ patient_id: patientId }, treatmentData), {
          ...
          case 1:
            ...
            logger_1.logger.info(
              "Linked patient ".concat(patientId, " to treatment ").concat(treatment.id),
            );
          ...
          case 0:
            ...
            return [
              ...
              client_1.supabase
                .from("patient_treatments")
                .update(
                  __assign(__assign({}, progressData), { updated_at: new Date().toISOString() }),
                )
                .eq("id", treatmentId),
            ];
          case 1:
