...
var DuplicateDetectionSystem = /** @class */ (() => {
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, (_a) => {
        try {
          ...
          console.log(
            "Duplicata "
              .concat(duplicateId, " rejeitada por ")
              .concat(reviewedBy, ": ")
              .concat(reason),
          );
          return [2 /*return*/, true];
   ...
   */
  DuplicateDetectionSystem.prototype.mergePatients = function (
    primaryPatientId,
    duplicatePatientId,
    strategy,
    performedBy,
      ...
      return __generator(this, (_a) => {
        try {
          ...
          console.log(
            "Merge executado por "
              .concat(performedBy, ": ")
              .concat(duplicatePatientId, " -> ")
              .concat(primaryPatientId),
          );
   ...
   */
  DuplicateDetectionSystem.prototype.previewMerge = function (
    primaryPatientId,
    duplicatePatientId,
    strategy,
  ) {
