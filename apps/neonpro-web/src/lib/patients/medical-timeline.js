...
var createmedicalTimelineService = /** @class */ (() => {
                  ...
                  __assign(
                    __assign(
                      __assign(
                        __assign(
                          __assign(
                            __assign({}, updates.title && { title: updates.title }),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            return [
              2 /*return*/,
              __assign({ id: "photo_".concat(Date.now()), eventId: eventId }, photos),
            ];
          case 4:
            return [2 /*return*/];
        }
   ...
   */
  createmedicalTimelineService.prototype.updateMilestoneProgress = function (
    milestoneId,
    progress,
    notes,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("milestones").update(updates).eq("id", milestoneId).select().single(),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) {
