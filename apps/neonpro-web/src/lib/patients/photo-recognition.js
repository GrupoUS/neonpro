...
var PhotoRecognitionSystem = /** @class */ (function () {
     ...
     */
    PhotoRecognitionSystem.prototype.uploadPatientPhoto = function (patientId, photoFile, uploadedBy) {
     ...
     */
    PhotoRecognitionSystem.prototype.updatePhotoStatus = function (photoId, status, verificationScore) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
        ...
        return __awaiter(this, arguments, void 0, function (photoFile, threshold) {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    return [2 /*return*/, similarPatients.filter(function (patient) { return patient.similarity >= threshold; })];
                }
                catch (error) {
    ...
    PhotoRecognitionSystem.prototype.generateBiometricTemplate = function (photoId_1) {
        return __awaiter(this, arguments, void 0, function (photoId, algorithm) {
            var template;
            if (algorithm === void 0) { algorithm = 'facenet'; }
            return __generator(this, function (_a) {
                try {
                    template = {
...
var createphotoRecognitionSystem = function () { return new PhotoRecognitionSystem(); };
