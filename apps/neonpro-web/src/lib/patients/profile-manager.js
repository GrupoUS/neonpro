...
var ProfileManager = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.complianceManager.validateDataConsent(profileData, "patient_profile_creation"),
            ];
          case 3:
            // LGPD Compliance Validation
            _a.sent();
          ...
          case 5:
            ...
            if (executionTime > 20000) {
              console.warn(
                "Patient profile creation exceeded 20s target: ".concat(executionTime, "ms"),
              );
            }
            console.log(
              "Created patient profile for "
                .concat(profile.patient_id, " with completeness: ")
                .concat(completenessScore, " (")
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              ...
              this.auditLogger.log({
                ...
                event_description: "Patient profile accessed for ".concat(
          ...
          case 3:
            ...
            if (executionTime > 2000) {
              console.warn(
                "Patient profile retrieval exceeded 2s target: ".concat(executionTime, "ms"),
              );
            }
            console.log(
              "Retrieved patient profile for ".concat(patientId, " (").concat(executionTime, "ms)"),
            );
            return [2 /*return*/, profile];
          case 4:
            error_2 = _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            updatedProfile = __assign(__assign({}, mergedData), {
              profile_completeness_score: newCompleteness,
              updated_at: new Date().toISOString(),
            });
            this.mockProfiles.set(patientId, updatedProfile);
            console.log(
              "Updated patient profile for "
                .concat(patientId, ", new completeness: ")
                .concat(newCompleteness),
            );
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (profileData.demographics) {
          demoFields = ["name", "date_of_birth", "gender", "phone", "email", "address"];
          requiredFields = ["insurance_provider", "preferred_language", "emergency_contact_name"];
          demoScore = this.calculateSectionCompleteness(
        ...
        if (profileData.medical_information) {
          ...
          medScore = this.calculateSectionCompleteness(
        ...
        if (profileData.vital_signs) {
          ...
          vitalScore = this.calculateSectionCompleteness(
        ...
        if (profileData.care_preferences) {
          ...
          careScore = this.calculateSectionCompleteness(
  ...
  ProfileManager.prototype.calculateSectionCompleteness = function (
    sectionData,
    requiredFields,
    optionalFields,
  ) {
    if (optionalFields === void 0) {
      optionalFields = [];
    }
  ...
  ProfileManager.prototype.mergeProfileData = function (currentProfile, updateData) {
    return __assign(__assign({}, currentProfile), {
      ...
      medical_information: updateData.medical_information
        ? __assign(__assign({}, currentProfile.medical_information), updateData.medical_information)
        : currentProfile.medical_information,
      vital_signs: updateData.vital_signs
        ? __assign(__assign({}, currentProfile.vital_signs), updateData.vital_signs)
        : currentProfile.vital_signs,
      care_preferences: updateData.care_preferences
        ? __assign(__assign({}, currentProfile.care_preferences), updateData.care_preferences)
