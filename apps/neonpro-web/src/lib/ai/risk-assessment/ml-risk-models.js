...
var MLRiskAssessmentEngine = /** @class */ (function () {
    ...
    MLRiskAssessmentEngine.prototype.assessRisk = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var categoryRisks, overallRisk, criticalAlerts, recommendations, predictiveInsights, complianceNotes, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        console.log("Starting risk assessment for patient ".concat(input.patientId, ", treatment ").concat(input.treatmentId));
                        // Step 1: Validate input data
                        this.validateInput(input);
                        return [4 /*yield*/, this.calculateCategoryRisks(input)
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.generateRecommendations(input, categoryRisks)
                            // Step 6: Generate predictive insights
                        ];
                    case 2:
                        recommendations = _a.sent();
                        return [4 /*yield*/, this.generatePredictiveInsights(input, overallRisk)
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.storeAssessment(input, result)
                            // Log assessment
                        ];
                    case 4:
                        // Store assessment for learning
                        _a.sent();
                        // Log assessment
                        console.log("Risk assessment completed. Overall risk: ".concat(overallRisk.severity, " (").concat(overallRisk.score, ")"));
    ...
    MLRiskAssessmentEngine.prototype.calculateCategoryRisks = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var categoryRisks, cardiovascularRisk, allergicRisk, infectionRisk, bleedingRisk, anesthesiaRisk, treatmentRisk, psychologicalRisk;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        categoryRisks = [];
    ...
    MLRiskAssessmentEngine.prototype.calculateCardiovascularRisk = function (input) {
        ...
        // Blood pressure
        var _a = input.patientData.bloodPressure, systolic = _a.systolic, diastolic = _a.diastolic;
        ...
        var hasCardiacHistory = input.patientData.medicalHistory.some(function (condition) {
            return cardiacConditions.some(function (cardiac) { return condition.toLowerCase().includes(cardiac); });
        });
    ...
    MLRiskAssessmentEngine.prototype.calculateInfectionRisk = function (input) {
        ...
        var hasImmuneIssues = input.patientData.medicalHistory.some(function (condition) {
            return immuneConditions.some(function (immune) { return condition.toLowerCase().includes(immune); });
        });
        if (hasImmuneIssues) {
            score += 20;
    ...
    MLRiskAssessmentEngine.prototype.calculateBleedingRisk = function (input) {
        ...
        var hasBleedingMeds = input.patientData.medications.some(function (med) {
            return bleedingMeds.some(function (bleeding) { return med.toLowerCase().includes(bleeding); });
        });
        if (hasBleedingMeds) {
            score += 25;
        ...
        var hasBleedingConditions = input.patientData.medicalHistory.some(function (condition) {
            return bleedingConditions.some(function (bleeding) { return condition.toLowerCase().includes(bleeding); });
        });
    ...
    MLRiskAssessmentEngine.prototype.calculateAnesthesiaRisk = function (input) {
        ...
        var hasRespiratoryIssues = input.patientData.medicalHistory.some(function (condition) {
            return respiratoryConditions.some(function (resp) { return condition.toLowerCase().includes(resp); });
        });
    ...
    MLRiskAssessmentEngine.prototype.calculateTreatmentSpecificRisk = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var score, factors, recommendations, treatmentRisks, treatmentRisk, contraindications, hasContraindications, previousOutcomes, complications, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        score = 0;
                    ...
                    case 3:
                        ...
                        if (previousOutcomes && previousOutcomes.length > 0) {
                            complications = previousOutcomes.filter(function (outcome) { return outcome.complications; });
    ...
    MLRiskAssessmentEngine.prototype.calculatePsychologicalRisk = function (input) {
        ...
        var hasMentalHealthIssues = input.patientData.medicalHistory.some(function (condition) {
            return mentalHealthConditions.some(function (mental) { return condition.toLowerCase().includes(mental); });
        });
    ...
    MLRiskAssessmentEngine.prototype.calculateOverallRisk = function (categoryRisks) {
        ...
        var finalSeverity = this.severityToNumber(maxSeverity) > this.severityToNumber(calculatedSeverity)
            ? maxSeverity
            : calculatedSeverity;
        return {
    ...
    MLRiskAssessmentEngine.prototype.generateCriticalAlerts = function (input, categoryRisks) {
        ...
        categoryRisks.forEach(function (risk) {
            if (risk.severity === 'critical') {
                alerts.push({
                    type: 'high_risk',
                    message: "Critical ".concat(risk.category, " risk detected: ").concat(risk.factors.join(', ')),
                    severity: 'critical',
                    action: 'block',
    ...
    MLRiskAssessmentEngine.prototype.generatePredictiveInsights = function (input, overallRisk) {
        return __awaiter(this, void 0, void 0, function () {
            var complicationProbability, recoveryTimeMin, recoveryTimeMax, unit, successProbability, alternativeTreatments;
            return __generator(this, function (_a) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (historical) {
                            this.historicalData = historical.map(function (record) { return ({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                accuracies = this.historicalData
                    .filter(function (data) { return data.accuracy > 0; })
                    .map(function (data) { return data.accuracy; });
                if (accuracies.length > 0) {
                    this.modelAccuracy = accuracies.reduce(function (sum, acc) { return sum + acc; }, 0) / accuracies.length;
                }
                return [2 /*return*/];
            });
        });
