...
var PredictiveInsightsEngine = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (
              !(
                !(options === null || options === void 0 ? void 0 : options.focusAreas) ||
                options.focusAreas.includes("risk_trend")
              )
            )
              return [3 /*break*/, 3];
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              this.generateTreatmentRecommendationInsight(patientId, patientData),
            ];
          case 6:
          ...
          case 8:
            ...
            _a.label = 9;
          case 9:
            if (!(options === null || options === void 0 ? void 0 : options.includePopulation))
              return [3 /*break*/, 11];
          ...
          case 15:
            console.log(
              "Generated ".concat(insights.length, " insights for patient ").concat(patientId),
            );
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getPopulationData(criteria),
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.analyzePopulationHealthMetrics(populationData),
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.analyzePopulationRiskProfile(populationData),
              // Analyze outcomes
            ];
          case 3:
            riskProfile = _a.sent();
            return [
              4 /*yield*/,
              this.analyzePopulationOutcomes(populationData),
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.generatePopulationInterventions(populationData, riskProfile),
          ...
          case 7:
            _a.sent();
            console.log(
              "Generated population insight for ".concat(populationData.length, " patients"),
            );
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getHistoricalData(metric, timeframe, filters),
              // Analyze trend
            ];
          case 1:
            ...
            return [
              4 /*yield*/,
              this.generateForecast(historicalData, trend),
              // Generate insights
            ];
          case 2:
            forecast = _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getPatternAnalysisData(dataType, timeWindow, filters),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getBaselineData(metric, context),
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              {
                ...
                priority: priority,
                confidence:
                  trend.confidence > 0.8 ? "high" : trend.confidence > 0.6 ? "medium" : "low",
                timeHorizon: "medium_term",
                title: "Risk Trend Analysis for Patient ".concat(patientId),
                description: "Patient's risk level is "
                  .concat(trend.direction, " with ")
                  .concat(trend.confidence * 100, "% confidence"),
   ...
   */
  PredictiveInsightsEngine.prototype.generateOutcomePredictionInsight = function (
    patientId,
    patientData,
  ) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            return [
              2 /*return*/,
              {
                ...
                description: "Predicted "
                  .concat(prediction.outcome, " with ")
                  .concat(prediction.confidence * 100, "% confidence"),
                summary: "Based on analysis of "
                  .concat(similarPatients.length, " similar patients, the predicted outcome is ")
                  .concat(prediction.outcome),
                details: {
                  patientId: patientId,
                  predictedOutcome: {
   ...
   */
  PredictiveInsightsEngine.prototype.generateTreatmentRecommendationInsight = function (
    patientId,
    patientData,
  ) {
    return __awaiter(this, void 0, void 0, function () {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              {
                ...
                description: "".concat(
                  rankedTreatments.length,
                  " treatment options analyzed and ranked",
                ),
                summary: "Recommended treatment: "
                  .concat(rankedTreatments[0].name, " with ")
                  .concat(rankedTreatments[0].effectiveness, "% effectiveness"),
                details: {
                  patientId: patientId,
                  recommendations: recommendations,
   ...
   */
  PredictiveInsightsEngine.prototype.generatePreventiveCareInsight = function (
    patientId,
    patientData,
  ) {
    return __awaiter(this, void 0, void 0, function () {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              {
                ...
                description: "".concat(
                  prioritizedOpportunities.length,
                  " preventive care opportunities identified",
                ),
                summary: "Top priority: "
                  .concat(prioritizedOpportunities[0].intervention, " - ")
                  .concat(prioritizedOpportunities[0].impact, "% risk reduction"),
                details: {
                  patientId: patientId,
                  recommendations: recommendations,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("predictive_insights").insert({
                id: insight.id,
                type: insight.type,
