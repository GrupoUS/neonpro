...
var SafetyAlertsSystem = /** @class */ (function () {
     ...
     */
    SafetyAlertsSystem.prototype.createAlert = function (type, severity, title, message, details, options) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        _a = {
                            ...
                            type: type,
                            severity: severity,
                            priority: (options === null || options === void 0 ? void 0 : options.priority) || this.determinePriority(severity),
                            status: 'active',
                            title: title,
                            message: message,
                            details: details,
                            metadata: {
                                ...
                                timestamp: now,
                                expiresAt: (options === null || options === void 0 ? void 0 : options.expiresIn) ? new Date(now.getTime() + options.expiresIn * 60000) : undefined,
                                escalationTime: (options === null || options === void 0 ? void 0 : options.escalateIn) ? new Date(now.getTime() + options.escalateIn * 60000) : undefined
                            },
                            channels: (options === null || options === void 0 ? void 0 : options.channels) || this.getDefaultChannels(severity)
                        };
                        return [4 /*yield*/, this.determineRecipients(type, severity, options === null || options === void 0 ? void 0 : options.recipients)];
                    case 1:
                        alert_1 = (_a.recipients = _b.sent(),
                    ...
                    case 3:
                        // Process alert
                        _b.sent();
                        console.log("Safety alert created: ".concat(alertId, " - ").concat(title, " (").concat(severity, ")"));
     ...
     */
    SafetyAlertsSystem.prototype.processRiskAssessment = function (patientId, treatmentId, riskResult) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!(riskResult.criticalAlerts && riskResult.criticalAlerts.length > 0)) return [3 /*break*/, 5];
                        _i = 0, _a = riskResult.criticalAlerts;
                        _c.label = 2;
                    case 2:
                        if (!(_i < _a.length)) return [3 /*break*/, 5];
                        criticalAlert = _a[_i];
                        return [4 /*yield*/, this.createAlert(criticalAlert.type, criticalAlert.severity, "Critical Risk Alert: ".concat(criticalAlert.type), criticalAlert.message, {
                                patientId: patientId,
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 2];
                    case 5:
                        if (!(riskResult.overallRisk.severity === 'high' || riskResult.overallRisk.severity === 'critical')) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.createAlert('high_risk', riskResult.overallRisk.severity === 'critical' ? 'critical' : 'urgent', "High Risk Patient Alert", "Patient ".concat(patientId, " has ").concat(riskResult.overallRisk.severity, " risk level (").concat(riskResult.overallRisk.score, "/100)"), {
                                patientId: patientId,
                                treatmentId: treatmentId,
                                riskScore: riskResult.overallRisk.score,
                    ...
                    case 6:
                        ...
                        _c.label = 7;
                    case 7:
                        contraindications = (_b = riskResult.criticalAlerts) === null || _b === void 0 ? void 0 : _b.filter(function (alert) { return alert.type === 'contraindication'; });
                        if (!(contraindications && contraindications.length > 0)) return [3 /*break*/, 9];
                        return [4 /*yield*/, this.createAlert('contraindication', 'critical', 'Contraindication Detected', 'Treatment contraindications have been identified', {
                                patientId: patientId,
                                treatmentId: treatmentId,
                                riskFactors: contraindications.map(function (c) { return c.message; }),
    ...
    SafetyAlertsSystem.prototype.monitorPatientVitals = function (patientId, vitals) {
        return __awaiter(this, void 0, void 0, function () {
            var alerts, severity, alert_5, _a, systolic, diastolic, severity, alert_6, severity, alert_7, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        alerts = [];
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.createAlert('critical_risk', severity, 'Abnormal Heart Rate', "Heart rate: ".concat(vitals.heartRate, " bpm"), {
                                patientId: patientId,
                    ...
                    case 3:
                        ...
                        if (!(systolic > 180 || systolic < 90 || diastolic > 110 || diastolic < 60)) return [3 /*break*/, 5];
                        severity = systolic > 200 || systolic < 80 || diastolic > 120 || diastolic < 50 ? 'critical' : 'urgent';
                        return [4 /*yield*/, this.createAlert('critical_risk', severity, 'Abnormal Blood Pressure', "Blood pressure: ".concat(systolic, "/").concat(diastolic, " mmHg"), {
                                patientId: patientId,
                                riskFactors: ["Blood pressure: ".concat(systolic, "/").concat(diastolic, " mmHg")],
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.createAlert('critical_risk', severity, 'Low Oxygen Saturation', "Oxygen saturation: ".concat(vitals.oxygenSaturation, "%"), {
                                patientId: patientId,
     ...
     */
    SafetyAlertsSystem.prototype.checkDrugInteractions = function (patientId, medications, newMedication) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                .select('*')
                                .or("drug1.in.(".concat(medications.join(','), "),drug2.eq.").concat(newMedication))];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.createAlert('drug_interaction', severity, 'Drug Interaction Alert', "Interaction between ".concat(interaction.drug1, " and ").concat(interaction.drug2), {
                                patientId: patientId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.createAlert('equipment_failure', 'critical', 'Equipment Failure', "Equipment ".concat(equipmentId, " is not operational"), {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.createAlert('equipment_failure', 'urgent', 'Equipment Calibration Expired', "Equipment ".concat(equipmentId, " calibration has expired"), {
                                equipmentId: equipmentId,
                    ...
                    case 4:
                        ...
                        _a.label = 5;
                    case 5:
                        if (!(status.nextMaintenance && status.nextMaintenance < new Date())) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.createAlert('equipment_failure', 'warning', 'Equipment Maintenance Overdue', "Equipment ".concat(equipmentId, " maintenance is overdue"), {
                                equipmentId: equipmentId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        // Update in database
                        _a.sent();
                        console.log("Alert ".concat(alertId, " resolved by ").concat(userId, ": ").concat(resolution));
                        return [2 /*return*/, true];
                    case 2:
                        error_7 = _a.sent();
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.sendAlertNotifications(alert_14, escalationRule.channels)
                            // Update in database
                        ];
                    case 1:
                        // Send escalation notifications
    ...
    SafetyAlertsSystem.prototype.getActiveAlerts = function (filters) {
        ...
        if (filters) {
            if (filters.type)
                alerts = alerts.filter(function (a) { return a.type === filters.type; });
            if (filters.severity)
                alerts = alerts.filter(function (a) { return a.severity === filters.severity; });
            if (filters.priority)
                alerts = alerts.filter(function (a) { return a.priority === filters.priority; });
            if (filters.patientId)
                alerts = alerts.filter(function (a) { return a.details.patientId === filters.patientId; });
            if (filters.treatmentId)
                alerts = alerts.filter(function (a) { return a.details.treatmentId === filters.treatmentId; });
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        escalatedAlerts = alerts.filter(function (a) { return a.status === 'escalated'; });
                        ...
                        responseTimes = resolvedAlerts
                            .filter(function (a) { return a.acknowledged_at && a.created_at; })
                            .map(function (a) { return new Date(a.acknowledged_at).getTime() - new Date(a.created_at).getTime(); })
                            .map(function (ms) { return ms / 60000; }) // Convert to minutes
                        ;
                        if (responseTimes.length > 0) {
                            stats_1.responseTime.average = responseTimes.reduce(function (sum, time) { return sum + time; }, 0) / responseTimes.length;
                            responseTimes.sort(function (a, b) { return a - b; });
                            stats_1.responseTime.median = responseTimes[Math.floor(responseTimes.length / 2)];
                            stats_1.responseTime.percentile95 = responseTimes[Math.floor(responseTimes.length * 0.95)];
                        }
    ...
    SafetyAlertsSystem.prototype.startRealTimeMonitoring = function () {
        ...
        if (this.config.monitoring.batchProcessing) {
            this.monitoringInterval = setInterval(function () { return _this.performPeriodicChecks(); }, this.config.monitoring.intervalMinutes * 60000);
        }
    };
    /**
    ...
    SafetyAlertsSystem.prototype.setupRealtimeSubscriptions = function () {
        ...
        this.supabase
            ...
            .on('postgres_changes', { event: 'INSERT', schema: 'public', table: 'patient_vitals' }, function (payload) { return _this.handleVitalsUpdate(payload.new); })
            .subscribe();
        // Subscribe to equipment status changes
        this.supabase
            .channel('equipment_status')
            .on('postgres_changes', { event: 'UPDATE', schema: 'public', table: 'equipment' }, function (payload) { return _this.handleEquipmentUpdate(payload.new); })
            .subscribe();
        // Subscribe to treatment updates
        this.supabase
            .channel('treatments')
            .on('postgres_changes', { event: 'UPDATE', schema: 'public', table: 'treatments' }, function (payload) { return _this.handleTreatmentUpdate(payload.new); })
            .subscribe();
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.monitorPatientVitals(vitals.patient_id, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.monitorEquipmentStatus(equipment.id, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        if (!(treatment.status === 'emergency' || treatment.status === 'complication')) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.createAlert('emergency_protocol', 'critical', 'Treatment Emergency', "Treatment ".concat(treatment.id, " status changed to ").concat(treatment.status), {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.checkExpiredAlerts()
                    ...
                    case 1:
                        ...
                        _a.sent();
                        // Check for escalation timeouts
                        return [4 /*yield*/, this.checkEscalationTimeouts()
                    ...
                    case 2:
                        ...
                        _a.sent();
                        // Check compliance requirements
                        return [4 /*yield*/, this.checkComplianceRequirements()
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!(alert_15.metadata.expiresAt && alert_15.metadata.expiresAt < now)) return [3 /*break*/, 3];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!(alert_16.metadata.escalationTime && alert_16.metadata.escalationTime < now && alert_16.status === 'active')) return [3 /*break*/, 3];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!(alert_17.compliance.cfmRequired || alert_17.compliance.anvisaRequired)) return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.getDefaultRecipients(type, severity)];
                    case 2:
                        defaultRecipients = _a.sent();
                        recipients.push.apply(recipients, defaultRecipients);
                        _a.label = 3;
                    case 3: return [2 /*return*/, recipients];
                }
            });
        });
    };
    ...
    SafetyAlertsSystem.prototype.extractRiskFactors = function (categoryRisks) {
        return categoryRisks
            .filter(function (risk) { return risk.severity === 'high' || risk.severity === 'critical'; })
            .flatMap(function (risk) { return risk.factors; });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // Send notifications
                    return [4 /*yield*/, this.sendAlertNotifications(alert, alert.channels)
                        // Apply alert rules
                    ];
                    case 1:
                        // Send notifications
                        _a.sent();
                        // Apply alert rules
                        return [4 /*yield*/, this.applyAlertRules(alert)
                            // Log alert
                        ];
                    case 2:
                        // Apply alert rules
    ...
    SafetyAlertsSystem.prototype.sendAlertNotifications = function (alert, channels) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log("Sending alert notifications for ".concat(alert.id, " via channels: ").concat(channels.join(', ')));
                return [2 /*return*/];
            });
        });
    };
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        switch (_b) {
                            ...
                            case 'require_approval': return [3 /*break*/, 3];
                            case 'escalate': return [3 /*break*/, 4];
