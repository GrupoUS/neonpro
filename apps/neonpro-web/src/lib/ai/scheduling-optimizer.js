...
var AISchedulingOptimizer = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getAvailableSlots(request.preferred_date_range, request.duration_minutes)];
                    case 2:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                time_preferences: data.time_preferences || { preferred_days: [], preferred_hours: [] },
                                staff_preferences: data.staff_preferences || { preferred_staff_ids: [], avoid_staff_ids: [] },
    ...
    AISchedulingOptimizer.prototype.scoreSlots = function (slots, request, patientPrefs) {
        return __awaiter(this, void 0, void 0, function () {
            var scoredSlots, _i, slots_1, slot, slotDate, patientScore, staffScore, revenueScore, utilizationScore, confidenceScore;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        scoredSlots = [];
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getStaffEfficiencyScore(slot.staff_id, slotDate.getDay(), slotDate.getHours())];
                    case 2:
                        staffScore = _a.sent();
                    ...
                    case 3:
                        ...
                        confidenceScore = (patientScore * 0.3 +
                            staffScore * 0.25 +
                            revenueScore * 0.25 +
                            utilizationScore * 0.2);
                        scoredSlots.push(__assign(__assign({}, slot), { confidence_score: confidenceScore, optimization_factors: {
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 1];
                    case 5: return [2 /*return*/, scoredSlots.sort(function (a, b) { return b.confidence_score - a.confidence_score; })];
                }
            });
        });
    };
    ...
    AISchedulingOptimizer.prototype.getStaffEfficiencyScore = function (staffId, dayOfWeek, hourOfDay) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, error;
            return __generator(this, function (_b) {
                switch (_b.label) {
            ...
            return __generator(this, function (_b) {
                ...
                _loop_1 = function (slot) {
                    ...
                    var alternatives = scoredSlots
                        .filter(function (s) { return s.slot_time !== slot.slot_time; })
                        .slice(0, 3)
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        logData = {
                            ...
                            suggested_slot: (_a = suggestions[0]) === null || _a === void 0 ? void 0 : _a.slot_time,
                            alternative_slots: suggestions.slice(1).map(function (s) { return ({
                                slot_time: s.slot_time,
                                confidence_score: s.confidence_score
                            }); }),
                            optimization_factors: ((_b = suggestions[0]) === null || _b === void 0 ? void 0 : _b.optimization_factors) || {},
                            confidence_score: ((_c = suggestions[0]) === null || _c === void 0 ? void 0 : _c.confidence_score) || 0
                        };
    ...
    AISchedulingOptimizer.prototype.updatePatientPreferences = function (patientId, appointmentOutcome) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AISchedulingOptimizer.prototype.mergePreferenceData = function (currentPrefs, outcome) {
        ...
        if (satisfaction >= 4) {
            ...
            return __assign(__assign({}, currentPrefs), { confidence_score: Math.min(1.0, currentPrefs.confidence_score + 0.1), data_points_count: currentPrefs.data_points_count + 1, last_updated: new Date().toISOString() });
        }
        else {
            // Negative outcome - reduce confidence slightly
            return __assign(__assign({}, currentPrefs), { confidence_score: Math.max(0.1, currentPrefs.confidence_score - 0.05), data_points_count: currentPrefs.data_points_count + 1, last_updated: new Date().toISOString() });
        }
    };
    ...
    AISchedulingOptimizer.prototype.aggregateAnalytics = function (data) {
        ...
        if (data.length > 0) {
            metrics.average_ai_influence = data.reduce(function (sum, item) { return sum + (item.ai_influence_score || 0); }, 0) / data.length;
            var utilizationData = data.filter(function (item) { return item.metric_type === 'utilization'; });
            if (utilizationData.length > 0) {
                metrics.utilization_improvement = utilizationData.reduce(function (sum, item) { return sum + item.value; }, 0) / utilizationData.length;
            }
        }
        return metrics;
    };
