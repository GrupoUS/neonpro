...
var HealthTrendMonitor = /** @class */ (function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            (_a = _b.sent()),
              (vitalSignsTrends = _a[0]),
              (symptomTrends = _a[1]),
              (treatmentResponseTrends = _a[2]),
              (recoveryTrends = _a[3]),
              (satisfactionTrends = _a[4]),
              (behavioralHealthTrends = _a[5]);
            trendAnomalies = this.identifyTrendAnomalies(
              __spreadArray(
                __spreadArray(
                  __spreadArray(__spreadArray([], vitalSignsTrends, true), symptomTrends, true),
                  treatmentResponseTrends,
                  true,
                ),
                recoveryTrends,
            ...
            healthTrajectoryScore = this.calculateHealthTrajectoryScore(
              vitalSignsTrends,
              symptomTrends,
              treatmentResponseTrends,
              recoveryTrends,
          ...
          case 4:
            ...
            throw new Error(
              "Failed to monitor health trends: ".concat(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getRecentTrends(patientId, 30),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            throw new Error(
              "Failed to generate health report: ".concat(
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.runHealthPredictionModels(
                  healthData,
                  treatmentPlan,
                  currentTrends,
                  timeHorizon,
            ...
            case 3:
              ...
              throw new Error(
                "Failed to predict health outcomes: ".concat(
              ...
              this.supabase
                ...
                .select(
                  "\n        *,\n        vital_signs!inner(\n          *,\n          created_at >= '"
                    ...
                    .concat(timeWindow.start.toISOString(), "'\n        )\n      "),
                )
                .eq("id", patientId)
                .single(),
            ];
  ...
  HealthTrendMonitor.prototype.generateBPTrendDescription = function (
    ...
    return (
      "Blood pressure ".concat(
        direction === "improving" ? "improving" : "increasing",
        " trend detected. ",
      ) +
      "Projected 30-day change: "
        .concat(systolicChange.toFixed(1), "/")
        .concat(diastolicChange.toFixed(1), " mmHg")
    );
  };
  HealthTrendMonitor.prototype.calculateBPAlertLevel = function (
    direction,
    systolicTrend,
    diastolicTrend,
  ) {
  ...
  HealthTrendMonitor.prototype.runHealthPredictionModels = function (
    healthData,
    treatmentPlan,
    trends,
    timeHorizon,
