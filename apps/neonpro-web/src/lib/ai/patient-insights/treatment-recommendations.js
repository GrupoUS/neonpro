...
var TreatmentRecommendationEngine = /** @class */ (function () {
    ...
    TreatmentRecommendationEngine.prototype.generateRecommendations = function (patientId, riskAssessment, treatmentGoal) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, patientData, availableTreatments, recommendations, _i, availableTreatments_1, treatment, recommendation, rankedRecommendations, safeRecommendations, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        patientData = _a.sent();
                        return [4 /*yield*/, this.getAvailableTreatments()
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.analyzeTreatment(treatment, patientData, riskAssessment, treatmentGoal)];
                    case 5:
                    ...
                    case 7:
                        ...
                        safeRecommendations = this.filterContraindications(rankedRecommendations, riskAssessment);
                        return [2 /*return*/, {
                                success: true,
    ...
    TreatmentRecommendationEngine.prototype.analyzeTreatment = function (treatment, patientData, riskAssessment, treatmentGoal) {
        return __awaiter(this, void 0, void 0, function () {
            var successProbability, riskLevel, contraindications, evidenceLevel, estimatedCost, estimatedDuration, reasoning;
            return __generator(this, function (_a) {
                // 1. Check basic eligibility
                if (!this.isPatientEligible(treatment, patientData)) {
                    return [2 /*return*/, null];
                }
                successProbability = this.calculateSuccessProbability(treatment, patientData, riskAssessment);
                ...
                reasoning = this.generateRecommendationReasoning(treatment, successProbability, riskLevel, evidenceLevel);
                return [2 /*return*/, {
                        treatmentId: treatment.id,
                        treatmentName: treatment.name,
                        category: contraindications.length > 0 ? 'contraindicated' :
                            successProbability > 0.7 ? 'primary' : 'alternative',
    ...
    TreatmentRecommendationEngine.prototype.calculateSuccessProbability = function (treatment, patientData, riskAssessment) {
        var _a;
        ...
        if (((_a = patientData.treatments) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            var successfulTreatments = patientData.treatments.filter(function (t) { return t.outcome === 'successful'; }).length;
        ...
        var medicalRisks = riskAssessment.riskFactors.filter(function (rf) { return rf.category === 'medical'; });
    ...
    TreatmentRecommendationEngine.prototype.assessTreatmentRisk = function (treatment, riskAssessment) {
    ...
    TreatmentRecommendationEngine.prototype.checkContraindications = function (treatment, patientData, riskAssessment) {
        var _a, _b, _c;
        var contraindications = [];
        // Medical condition contraindications
        var medicalConditions = ((_a = patientData.medical_history) === null || _a === void 0 ? void 0 : _a.map(function (mh) { return mh.condition_type; })) || [];
        ...
        var medications = ((_b = patientData.medications) === null || _b === void 0 ? void 0 : _b.map(function (m) { return m.medication_name.toLowerCase(); })) || [];
        if (treatment.contraindicated_medications) {
            var _loop_1 = function (medication) {
                if (medications.some(function (m) { return m.includes(medication.toLowerCase()); })) {
        ...
        var allergens = ((_c = patientData.allergies) === null || _c === void 0 ? void 0 : _c.map(function (a) { return a.allergen.toLowerCase(); })) || [];
        ...
        var criticalRisks = riskAssessment.riskFactors.filter(function (rf) { return rf.severity === 'critical'; });
    ...
    TreatmentRecommendationEngine.prototype.getEvidenceLevel = function (treatment, treatmentGoal) {
        var evidence = this.evidenceDatabase.get(treatment.id) || this.evidenceDatabase.get(treatment.category);
        if (!evidence)
            return 'weak';
    ...
    TreatmentRecommendationEngine.prototype.calculateEstimatedCost = function (treatment, patientData) {
        var _a;
        ...
        var complicatingConditions = ((_a = patientData.medical_history) === null || _a === void 0 ? void 0 : _a.filter(function (mh) {
            return ['diabetes', 'heart_disease', 'kidney_disease'].includes(mh.condition_type);
        })) || [];
        baseCost *= (1 + complicatingConditions.length * 0.1);
        return Math.round(baseCost);
    };
    TreatmentRecommendationEngine.prototype.calculateEstimatedDuration = function (treatment, patientData) {
        var _a;
        ...
        var medicalConditions = ((_a = patientData.medical_history) === null || _a === void 0 ? void 0 : _a.length) || 0;
    ...
    TreatmentRecommendationEngine.prototype.getPrerequisites = function (treatment, patientData) {
        ...
        var medications = ((_b = patientData.medications) === null || _b === void 0 ? void 0 : _b.map(function (m) { return m.medication_name.toLowerCase(); })) || [];
        if (medications.some(function (m) { return m.includes('warfarin') || m.includes('anticoagulant'); })) {
            prerequisites.push('Anticoagulation management');
        }
        return __spreadArray([], new Set(prerequisites), true); // Remove duplicates
    };
    TreatmentRecommendationEngine.prototype.getExpectedOutcome = function (treatment, successProbability) {
    ...
    TreatmentRecommendationEngine.prototype.generateRecommendationReasoning = function (treatment, successProbability, riskLevel, evidenceLevel) {
        var reasons = [];
    ...
    TreatmentRecommendationEngine.prototype.filterContraindications = function (recommendations, riskAssessment) {
        // Filter out contraindicated treatments unless specifically requested
        return recommendations.filter(function (rec) { return rec.category !== 'contraindicated'; });
    };
