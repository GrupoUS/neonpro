...
var RiskAssessmentEngine = /** @class */ (function () {
    ...
    RiskAssessmentEngine.prototype.assessPatientRisk = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, patientData, riskFactors, overallRiskScore, predictions, alerts, assessment, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.analyzeRiskFactors(patientData)
                            // 3. Calculate overall risk score
                        ];
                    case 3:
                        riskFactors = _a.sent();
                        overallRiskScore = this.calculateOverallRiskScore(riskFactors);
                        return [4 /*yield*/, this.generateHealthPredictions(patientData, riskFactors)
                            // 5. Generate safety alerts
                        ];
                    case 4:
                        predictions = _a.sent();
                        return [4 /*yield*/, this.generateSafetyAlerts(patientData, riskFactors)
    ...
    RiskAssessmentEngine.prototype.analyzeRiskFactors = function (patientData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                ...
                if (((_b = patientData.medical_history) === null || _b === void 0 ? void 0 : _b.length) > 0) {
                ...
                if (patientData.lifestyle_data) {
                    riskFactors.push.apply(riskFactors, this.assessLifestyleRisks(patientData.lifestyle_data));
                }
                ...
                return [2 /*return*/, riskFactors.filter(function (rf) { return rf.severity !== 'low' || rf.weight > 0.3; })];
            });
        });
    };
    ...
    RiskAssessmentEngine.prototype.assessMedicationRisks = function (medications) {
        ...
        medications.forEach(function (med) {
            if (highRiskMeds.some(function (hrm) { return med.medication_name.toLowerCase().includes(hrm); })) {
                risks.push({
        ...
        if (polypharmacy) {
            risks.push({
                ...
                weight: 0.5,
                confidence: 0.8,
                description: "Patient taking ".concat(medications.length, " medications (polypharmacy risk)"),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                predictions.push({
                    ...
                    confidence: 0.8,
                    timeframe: '1_month',
                    factors: riskFactors.map(function (rf) { return rf.name; }),
                    evidenceBased: true
                });
                ...
                predictions.push({
                    ...
                    confidence: 0.75,
                    timeframe: '3_months',
                    factors: riskFactors.filter(function (rf) { return rf.category === 'medical'; }).map(function (rf) { return rf.name; }),
                    evidenceBased: true
                });
    ...
    RiskAssessmentEngine.prototype.calculateTreatmentSuccessRate = function (patientData, riskFactors) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        alerts = [];
                        criticalFactors = riskFactors.filter(function (rf) { return rf.severity === 'critical'; });
                        ...
                        if (!(((_a = patientData.medications) === null || _a === void 0 ? void 0 : _a.length) > 0)) return [3 /*break*/, 2];
    ...
    RiskAssessmentEngine.prototype.checkDrugInteractions = function (medications) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                medNames = medications.map(function (m) { return m.medication_name.toLowerCase(); });
                knownInteractions.forEach(function (interaction) {
                    if (medNames.includes(interaction.drug1) && medNames.includes(interaction.drug2)) {
                        alerts.push({
                            ...
                            message: "Drug interaction detected: ".concat(interaction.drug1, " + ").concat(interaction.drug2),
                            affectedTreatments: ['all'],
    ...
    RiskAssessmentEngine.prototype.calculateConfidenceScore = function (riskFactors, predictions) {
        var factorConfidence = riskFactors.reduce(function (sum, rf) { return sum + rf.confidence; }, 0) / riskFactors.length;
        var predictionConfidence = predictions.reduce(function (sum, p) { return sum + p.confidence; }, 0) / predictions.length;
