...
var createpredictiveAnalyticsEngine = /** @class */ (function () {
  ...
  createpredictiveAnalyticsEngine.prototype.predictTreatmentOutcome = function (
    patientId,
    treatmentId,
    riskAssessment,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.runPredictionModels(features, treatmentData.category),
          ...
          case 3:
            ...
            throw new Error(
              "Failed to predict treatment outcome: ".concat(
  ...
  createpredictiveAnalyticsEngine.prototype.predictComplicationRisk = function (
    patientId,
    treatmentId,
    riskAssessment,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            complicationFeatures = this.extractComplicationFeatures(
              patientData,
              treatmentData,
              riskAssessment,
            );
            return [
              4 /*yield*/,
              this.predictSpecificComplications(complicationFeatures, treatmentData),
            ...
            return [
              2 /*return*/,
              {
                ...
                recommendedPrecautions:
                  this.generatePrecautionRecommendations(complicationPredictions),
          ...
          case 4:
            ...
            throw new Error(
              "Failed to predict complications: ".concat(
  ...
  createpredictiveAnalyticsEngine.prototype.predictRecoveryTrajectory = function (
    patientId,
    treatmentId,
    riskAssessment,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            treatmentData = _a.sent();
            recoveryFeatures = this.extractRecoveryFeatures(
              patientData,
              treatmentData,
              riskAssessment,
            );
            return [
              4 /*yield*/,
              this.predictRecoveryPhases(recoveryFeatures, treatmentData),
          ...
          case 4:
            ...
            throw new Error(
              "Failed to predict recovery: ".concat(
  ...
  createpredictiveAnalyticsEngine.prototype.predictPatientSatisfaction = function (
    patientId,
    treatmentId,
    riskAssessment,
  ) {
        ...
        switch (_b.label) {
          ...
          case 1:
            (_a = _b.sent()),
              (patientData = _a[0]),
              (treatmentData = _a[1]),
              (historicalSatisfaction = _a[2]);
            satisfactionFeatures = this.extractSatisfactionFeatures(
              patientData,
              treatmentData,
              riskAssessment,
            );
            return [
              4 /*yield*/,
              this.predictSatisfactionDimensions(satisfactionFeatures, treatmentData),
          ...
          case 2:
            ...
            optimizationStrategies = this.generateSatisfactionOptimization(
              satisfactionDimensions,
              satisfactionRisks,
            );
            return [
          ...
          case 3:
            ...
            throw new Error(
              "Failed to predict satisfaction: ".concat(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("treatment_types").select("*").eq("id", treatmentId).single(),
            ];
          case 1:
            data = _a.sent().data;
            return [2 /*return*/, data];
  ...
  createpredictiveAnalyticsEngine.prototype.getHistoricalSatisfactionData = function (
    patientId,
    treatmentId,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  createpredictiveAnalyticsEngine.prototype.extractFeatures = function (
    patientData,
    treatmentData,
    riskAssessment,
  ) {
    ...
    return {
      ...
      medicationCount:
        ((_b = patientData.medications) === null || _b === void 0 ? void 0 : _b.length) || 0,
      allergyCount:
        ((_c = patientData.allergies) === null || _c === void 0 ? void 0 : _c.length) || 0,
      // Lifestyle factors
      smokingStatus:
        ((_d = patientData.lifestyle_data) === null || _d === void 0
          ? void 0
          : _d.smoking_status) || "unknown",
      exerciseLevel:
        ((_e = patientData.lifestyle_data) === null || _e === void 0
          ? void 0
          : _e.exercise_level) || "unknown",
      stressLevel:
        ((_f = patientData.lifestyle_data) === null || _f === void 0 ? void 0 : _f.stress_level) ||
        "unknown",
      // Treatment factors
      ...
      // Historical factors
      previousTreatmentCount:
        ((_g = patientData.previous_treatments) === null || _g === void 0 ? void 0 : _g.length) ||
        0,
  ...
  createpredictiveAnalyticsEngine.prototype.extractComplicationFeatures = function (
    patientData,
    treatmentData,
    riskAssessment,
  ) {
    ...
    return __assign(__assign({}, baseFeatures), {
      ...
      bleedingRisk: this.assessBleedingRisk(patientData),
  ...
  createpredictiveAnalyticsEngine.prototype.extractRecoveryFeatures = function (
    patientData,
    treatmentData,
    riskAssessment,
  ) {
  ...
  createpredictiveAnalyticsEngine.prototype.extractSatisfactionFeatures = function (
    patientData,
    treatmentData,
    riskAssessment,
  ) {
  ...
  createpredictiveAnalyticsEngine.prototype.runPredictionModels = function (
    features,
    treatmentCategory,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  createpredictiveAnalyticsEngine.prototype.initializePredictiveModels = function () {
    ...
    this.models.set(
      "botox",
      __assign(__assign({}, defaultModel), {
  ...
  createpredictiveAnalyticsEngine.prototype.predictSpecificComplications = function (
    features,
    treatmentData,
  ) {
    return __awaiter(this, void 0, void 0, function () {
