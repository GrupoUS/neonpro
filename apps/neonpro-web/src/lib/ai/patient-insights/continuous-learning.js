...
var ContinuousLearningSystem = /** @class */ (() => {
  ...
  ContinuousLearningSystem.prototype.processNewOutcome = function (
    patientId,
    treatmentId,
    outcome,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.storeOutcomeData(patientId, treatmentId, outcome),
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.evaluatePredictionAccuracy(patientId, treatmentId, outcome),
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.updateFeatureImportance(treatmentId, outcome, predictionAccuracy),
            ];
          case 5:
            // 6. Update feature importance scores
            _a.sent();
          ...
          case 6:
            ...
            throw new Error(
              "Failed to process outcome: ".concat(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getTrainingData(modelId, 1000),
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.evaluateCurrentModel(modelId, trainingData),
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.retrainModel(modelId, trainingData),
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.evaluateRetrainedModel(updatedModel, trainingData),
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              this.updateModelHistory(modelId, newPerformance, performanceImprovement),
            ];
          case 7:
            // 7. Update model history
            _a.sent();
          ...
          case 8:
            ...
            throw new Error(
              "Failed to retrain model: ".concat(
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.analyzePerformanceTrends(reportPeriod),
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.identifyLearnedPatterns(reportPeriod),
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.calculateLearningMetrics(reportPeriod),
          ...
          case 5:
            return [
              2 /*return*/,
              ((_a.dataQualityInsights = _b.sent()), (_a.generatedDate = new Date()), _a),
            ];
          case 6:
            error_3 = _b.sent();
            console.error("Learning report generation error:", error_3);
            throw new Error(
              "Failed to generate learning report: ".concat(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getCurrentModelParameters(modelId),
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              this.validateParameters(modelId, bestParameters),
          ...
          case 9:
            ...
            throw new Error(
              "Failed to optimize parameters: ".concat(
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (!model) throw new Error("Model ".concat(modelId, " not found"));
            return [
              4 /*yield*/,
              this.getFeatureAnalysisData(modelId, treatmentType),
          ...
          case 2:
            (_a = _b.sent()),
              (permutationImportance = _a[0]),
              (shapValues = _a[1]),
              (correlationAnalysis = _a[2]),
              (gainImportance = _a[3]);
            combinedImportance = this.combineImportanceScores(
              permutationImportance,
              shapValues,
              correlationAnalysis,
              gainImportance,
            ...
            return [
              4 /*yield*/,
              this.analyzeFeatureInteractions(topFeatures, analysisData),
          ...
          case 4:
            ...
            throw new Error(
              "Failed to analyze feature importance: ".concat(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.getRecentProductionData(modelId, 30),
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.analyzeFeatureDrift(baselineData, recentData),
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.analyzeTargetDrift(baselineData, recentData),
          ...
          case 5:
            ...
            throw new Error(
              "Failed to detect data drift: ".concat(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("treatment_outcomes").insert({
  ...
  ContinuousLearningSystem.prototype.evaluatePredictionAccuracy = function (
    patientId,
    treatmentId,
    actualOutcome,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            predictionError = this.calculatePredictionError(
              prediction.predicted_outcome,
              actualOutcome,
            );
            predictionBias = this.calculatePredictionBias(
              prediction.predicted_outcome,
              actualOutcome,
            );
            return [
  ...
  ContinuousLearningSystem.prototype.retrainModel = function (modelId, trainingData) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        model = this.models.get(modelId);
        if (!model) throw new Error("Model ".concat(modelId, " not found"));
        updatedModel = __assign(__assign({}, model), {
  ...
  ContinuousLearningSystem.prototype.updateFeatureImportance = function (
    treatmentId,
    outcome,
    accuracy,
  ) {
  ...
  ContinuousLearningSystem.prototype.calculatePerformanceImprovement = (current, new_) => {
    ...
    var isSignificant = Math.abs(accuracyImprovement) > 0.02 || Math.abs(f1Improvement) > 0.02;
    return {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("model_deployments").insert({
                model_id: model.id,
  ...
  ContinuousLearningSystem.prototype.updateModelHistory = function (
    modelId,
    performance,
    improvement,
  ) {
  ...
  ContinuousLearningSystem.prototype.identifySpecificImprovements = (previous, current) => {
    ...
    if (current.accuracy > previous.accuracy + 0.01) {
      improvements.push(
        "Accuracy improved by ".concat(
          ((current.accuracy - previous.accuracy) * 100).toFixed(1),
          "%",
        ),
      );
    }
    if (current.precision > previous.precision + 0.01) {
      improvements.push(
        "Precision improved by ".concat(
          ((current.precision - previous.precision) * 100).toFixed(1),
          "%",
        ),
      );
    }
    if (current.recall > previous.recall + 0.01) {
      improvements.push(
        "Recall improved by ".concat(((current.recall - previous.recall) * 100).toFixed(1), "%"),
      );
    }
    return improvements;
  };
