...
var AISchedulingSystem = /** @class */ (() => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.aiCore.generateRecommendations(request.criteria, request.preferences),
            ];
          case 2:
            ...
            return [
              4 /*yield*/,
              this.optimizationEngine.optimizeSchedule(
                initialRecommendations,
                request.criteria,
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              this.complianceEngine.validateCompliance(
                recommendation,
                request.criteria,
                request.context,
              ),
          ...
          case 9:
            return [
              4 /*yield*/,
              this.generateAlternatives(request, compliantRecommendations),
          ...
          case 10:
            ...
            return [
              4 /*yield*/,
              this.setupRealTimeMonitoring(compliantRecommendations[0], request),
            ];
          case 11:
            _a.sent();
            _a.label = 12;
          case 12:
            response = {
              ...
              metadata: {
                ...
                nextAvailableSlot:
                  alternatives.length > 0 ? alternatives[0].timeSlot.startTime : undefined,
              },
            };
          ...
          case 13:
            ...
            errors.push(
              "System error: ".concat(error_1 instanceof Error ? error_1.message : "Unknown error"),
            );
            return [
              2 /*return*/,
              {
   ...
   */
  AISchedulingSystem.prototype.rescheduleAppointment = function (
    appointmentId,
    newCriteria,
    reason,
  ) {
          ...
          case 1:
            ...
            request = {
              criteria: {
                ...
                specialRequirements:
                  newCriteria.specialRequirements || appointment.special_requirements,
              },
              context: {
                isReschedule: true,
            ...
            return [
              4 /*yield*/,
              this.scheduleAppointment(request),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.realTimeAdaptive.handleAppointmentCancellation({
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.notifyPatientCancellation(appointment.patient_id, appointmentId, reason),
            ];
          case 5:
            _a.sent();
            _a.label = 6;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            alternativeCriteria = __assign(__assign({}, request.criteria), {
            ...
            return [
              4 /*yield*/,
              this.aiCore.generateRecommendations(alternativeCriteria, request.preferences),
            ];
          case 1:
            alternatives_1 = _a.sent();
            return [2 /*return*/, alternatives_1.slice(0, 3)]; // Return top 3 alternatives
          case 2:
            relaxedCriteria = __assign(__assign({}, request.criteria), {
              urgencyLevel: "normal",
              duration: Math.max(30, request.criteria.duration - 15), // Reduce duration slightly
            });
            return [
              4 /*yield*/,
              this.aiCore.generateRecommendations(
                relaxedCriteria,
                __assign(__assign({}, request.preferences), { allowAlternatives: true }),
              ),
            ];
          case 3:
            alternatives = _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.realTimeAdaptive.monitorAppointment({
   ...
   */
  AISchedulingSystem.prototype.notifyPatientCancellation = function (
    patientId,
    appointmentId,
    reason,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, (_a) => {
        try {
          ...
          console.log(
            "Notifying patient "
              .concat(patientId, " of appointment ")
              .concat(appointmentId, " cancellation: ")
              .concat(reason),
          );
