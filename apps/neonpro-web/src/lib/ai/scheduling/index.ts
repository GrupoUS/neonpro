...
class AISchedulingSystem {
  ...
  async scheduleAppointment(request: SchedulingRequest): Promise<SchedulingResponse> {
    ...
    try {
      ...
      const alternatives = await this.generateAlternatives(request, compliantRecommendations);
  ...
  private async generateAlternatives(
    ...
    try {
      ...
      const alternatives = await this.aiCore.generateRecommendations(relaxedCriteria, {
        ...request.preferences,
