...
var ComplianceRulesEngine = /** @class */ (function () {
    ...
    ComplianceRulesEngine.prototype.validateCompliance = function (recommendation_1, criteria_1) {
        return __awaiter(this, arguments, void 0, function (recommendation, criteria, context) {
            var violations, warnings, requiredApprovals, suggestedModifications, validationContext, _i, _a, rule, ruleResult, complianceScore, result, cacheKey, error_1;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.buildValidationContext(recommendation, criteria, context)
                    ...
                    case 3:
                        ...
                        if (ruleResult.suggestedModifications.length > 0) {
                            suggestedModifications.push.apply(suggestedModifications, ruleResult.suggestedModifications);
                        }
                        _b.label = 4;
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5:
                        complianceScore = this.calculateComplianceScore(violations, warnings, requiredApprovals);
                        result = {
                            isCompliant: violations.filter(function (v) { return v.severity === 'critical' || v.severity === 'error'; }).length === 0,
    ...
    ComplianceRulesEngine.prototype.validateRule = function (rule, context) {
        return __awaiter(this, void 0, void 0, function () {
            var violations, warnings, requiredApprovals, suggestedModifications, conditionsMet, _i, _a, action;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        violations = [];
                    ...
                    case 1:
                                ...
                                switch (action.type) {
                                    case 'block':
                                        violations.push({
                                            ...
                                            overrideRequirements: rule.exceptions.map(function (e) { return e.description; })
                                        });
                                        break;
                                    case 'warn':
                                        warnings.push({
                        ...
                        return [2 /*return*/, { violations: violations, warnings: warnings, requiredApprovals: requiredApprovals, suggestedModifications: suggestedModifications }];
                }
            });
        });
    };
     ...
     */
    ComplianceRulesEngine.prototype.buildValidationContext = function (recommendation, criteria, additionalContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, __assign({ recommendation: recommendation, criteria: criteria, patient: patient, treatment: treatment, staff: staff, equipmentRequirements: equipmentRequirements, timeSlot: recommendation.timeSlot, dayOfWeek: recommendation.timeSlot.startTime.getDay(), hourOfDay: recommendation.timeSlot.startTime.getHours(), appointmentDuration: (treatment === null || treatment === void 0 ? void 0 : treatment.duration_minutes) || 60, patientAge: patient ? this.calculateAge(patient.birth_date) : 0, isMinor: patient ? this.calculateAge(patient.birth_date) < 18 : false, isEmergency: criteria.urgencyLevel === 'urgent', isFollowUp: criteria.isFollowUp }, additionalContext)];
                    case 5:
                        error_2 = _a.sent();
                        console.error('Error building validation context:', error_2);
                        return [2 /*return*/, __assign({ recommendation: recommendation, criteria: criteria }, additionalContext)];
     ...
     */
    ComplianceRulesEngine.prototype.calculateComplianceScore = function (violations, warnings, requiredApprovals) {
        var score = 100;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                defaultRules.forEach(function (rule) {
                    if (rule.id) {
                        _this.rules.set(rule.id, __assign(__assign({}, rule), { createdAt: new Date(), updatedAt: new Date(), createdBy: 'system' }));
                    }
                });
                return [2 /*return*/];
            });
    ...
    ComplianceRulesEngine.prototype.generateCacheKey = function (recommendation, criteria) {
        return "".concat(criteria.patientId, "-").concat(criteria.treatmentId, "-").concat(recommendation.staffId, "-").concat(recommendation.timeSlot.startTime.getTime());
    };
    /**
     * Log compliance validation for audit purposes
     */
    ComplianceRulesEngine.prototype.logComplianceValidation = function (recommendation, criteria, result) {
        return __awaiter(this, void 0, void 0, function () {
            var error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        newRule = __assign(__assign({}, rule), { id: ruleId, createdAt: new Date(), updatedAt: new Date() });
                        // Save to database
                        return [4 /*yield*/, this.supabase
                                .from('compliance_rules')
                                .insert({
