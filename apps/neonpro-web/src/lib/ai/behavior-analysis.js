...
var AIBehaviorAnalysisEngine = /** @class */ (function () {
     ...
     */
    AIBehaviorAnalysisEngine.prototype.analyzeBehaviorPatterns = function (patient, appointments, treatments, communications) {
        return __awaiter(this, void 0, void 0, function () {
            var behaviorProfile, engagementPatterns, riskIndicators, recommendations, confidenceScore, nextAnalysisDate, analysis, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.buildBehaviorProfile(patient, appointments, treatments, communications)];
                    case 1:
                        behaviorProfile = _a.sent();
                        engagementPatterns = this.identifyEngagementPatterns(appointments, treatments, communications);
                        riskIndicators = this.assessBehaviorRisks(behaviorProfile, engagementPatterns, patient);
                        recommendations = this.generateBehaviorRecommendations(behaviorProfile, riskIndicators, patient);
                        confidenceScore = this.calculateAnalysisConfidence(appointments, treatments, communications);
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        predictions = [];
                        if (!(scenario === 'appointment_scheduling' || scenario === 'all')) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        _j.label = 2;
                    case 2:
                        if (!(scenario === 'treatment_compliance' || scenario === 'all')) return [3 /*break*/, 4];
                    ...
                    case 7:
                        _h.apply(_g, [_j.sent()]);
                        _j.label = 8;
                    case 8: return [2 /*return*/, predictions];
                }
            });
        });
    };
    ...
    AIBehaviorAnalysisEngine.prototype.segmentPatient = function (patient, behaviorAnalysis) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                segmentId = this.determineSegment(engagementScore, complianceScore, communicationScore, riskScore);
     ...
     */
    AIBehaviorAnalysisEngine.prototype.generateEngagementStrategy = function (patient, behaviorAnalysis, segment) {
        return __awaiter(this, void 0, void 0, function () {
            var profile;
            return __generator(this, function (_a) {
                profile = behaviorAnalysis.behavior_profile;
     ...
     */
    AIBehaviorAnalysisEngine.prototype.analyzeCommunicationEffectiveness = function (patient, communications, outcomes) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    AIBehaviorAnalysisEngine.prototype.detectBehaviorAnomalies = function (patient, recentBehavior, historicalPattern) {
        return __awaiter(this, void 0, void 0, function () {
            var anomalies, baselineEngagement, currentEngagement, appointmentAnomalies, communicationAnomalies;
            return __generator(this, function (_a) {
                anomalies = [];
                ...
                communicationAnomalies = this.detectCommunicationAnomalies(recentBehavior, historicalPattern);
    ...
    AIBehaviorAnalysisEngine.prototype.buildBehaviorProfile = function (patient, appointments, treatments, communications) {
        return __awaiter(this, void 0, void 0, function () {
            var communicationStyle, appointmentBehavior, treatmentCompliance, decisionMakingPattern, satisfactionDrivers, behavioralTriggers, engagementLevel;
            return __generator(this, function (_a) {
                ...
                engagementLevel = this.calculateOverallEngagement(communicationStyle, appointmentBehavior, treatmentCompliance);
                return [2 /*return*/, {
    ...
    AIBehaviorAnalysisEngine.prototype.analyzeCommunicationStyle = function (communications) {
        ...
        var responseTimes = communications
            .filter(function (comm) { return comm.response_time; })
            .map(function (comm) { return comm.response_time; });
    ...
    AIBehaviorAnalysisEngine.prototype.analyzeAppointmentBehavior = function (appointments) {
        ...
        var avgAdvance = schedulingAdvance.reduce(function (sum, days) { return sum + days; }, 0) / schedulingAdvance.length;
        var schedulingPattern = this.categorizeSchedulingPattern(avgAdvance);
        // Analyze cancellation and rescheduling
        var cancellations = appointments.filter(function (apt) { return apt.status === 'cancelled'; }).length;
        var reschedules = appointments.filter(function (apt) { return apt.status === 'rescheduled'; }).length;
    ...
    AIBehaviorAnalysisEngine.prototype.identifyEngagementPatterns = function (appointments, treatments, communications) {
        var patterns = [];
    ...
    AIBehaviorAnalysisEngine.prototype.generateBehaviorRecommendations = function (profile, risks, patient) {
        var recommendations = [];
    ...
    AIBehaviorAnalysisEngine.prototype.calculateOverallEngagement = function (communication, appointment, treatment) {
    ...
    AIBehaviorAnalysisEngine.prototype.analyzeDecisionMaking = function (patient, appointments, treatments) {
        return {
    ...
    AIBehaviorAnalysisEngine.prototype.identifySatisfactionDrivers = function (treatments, communications) {
        return [];
    };
    AIBehaviorAnalysisEngine.prototype.identifyBehavioralTriggers = function (appointments, communications) {
        return [];
    };
    ...
    AIBehaviorAnalysisEngine.prototype.analyzeCommunicationEngagementPattern = function (communications) {
        return null; // Simplified
    };
    AIBehaviorAnalysisEngine.prototype.calculateAnalysisConfidence = function (appointments, treatments, communications) {
    ...
    AIBehaviorAnalysisEngine.prototype.calculateNextAnalysisDate = function (profile, risks) {
        ...
        var highRisks = risks.filter(function (r) { return r.severity === 'high' || r.severity === 'critical'; }).length;
        if (highRisks > 0) {
    ...
    AIBehaviorAnalysisEngine.prototype.determineSegment = function (engagement, compliance, communication, risk) {
    ...
    AIBehaviorAnalysisEngine.prototype.createMonitoringPlan = function (risks) {
        return {
            ...
            alerts: risks.map(function (r) { return r.risk_type; })
        };
    };
    ...
    AIBehaviorAnalysisEngine.prototype.analyzeChannelEffectiveness = function (communications, outcomes) {
    ...
    AIBehaviorAnalysisEngine.prototype.analyzeContentEffectiveness = function (communications, outcomes) {
        return { effective_content_types: ['educational', 'reminder'] };
    };
    AIBehaviorAnalysisEngine.prototype.generateCommunicationRecommendations = function (communications) {
    ...
    AIBehaviorAnalysisEngine.prototype.getEngagementAnomalyRecommendations = function (current, baseline) {
        if (current < baseline) {
