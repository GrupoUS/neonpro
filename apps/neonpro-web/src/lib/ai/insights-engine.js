        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), insights = _a[0], riskAssessment = _a[1], recommendations = _a[2], trends = _a[3], anomalies = _a[4];
                        return [2 /*return*/, {
                                patientId: patientId,
                                ...
                                summary: {
                                    ...
                                    highPriorityInsights: insights.filter(function (i) { return i.priority === 'high' || i.priority === 'critical'; }).length,
                                    overallRiskLevel: riskAssessment.overall > 0.7 ? 'high' : riskAssessment.overall > 0.4 ? 'medium' : 'low',
                                    urgentRecommendations: recommendations.filter(function (r) { return r.urgency === 'urgent' || r.urgency === 'immediate'; }).length,
                                    activeAnomalies: anomalies.filter(function (a) { return a.severity !== 'low'; }).length
                                }
                            }];
                    case 2:
                        error_1 = _b.sent();
...
var createaiInsightsEngine = function () { return new AIInsightsEngine(); };
