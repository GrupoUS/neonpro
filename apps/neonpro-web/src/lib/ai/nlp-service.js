...
var NLPServiceManager = /** @class */ (function () {
    ...
    NLPServiceManager.prototype.processQuery = function (query, userId, sessionContext) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, cacheKey_1, processedQuery, language, medicalTerms, detectedIntent, extractedEntities, suggestedFilters, temporalFilters, confidence, result, error_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        suggestedFilters = this.generateSearchFilters(processedQuery, detectedIntent, extractedEntities);
                        temporalFilters = this.extractTemporalFilters(processedQuery);
                        confidence = this.calculateConfidenceScore(detectedIntent, extractedEntities, medicalTerms);
                        result = {
                            originalQuery: query,
                        ...
                        if (this.config.cacheEnabled) {
                            ...
                            setTimeout(function () { return _this.cache.delete(cacheKey_1); }, this.config.cacheTTL * 1000);
                        }
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new search_types_1.NLPProcessingError("Failed to process natural language query: ".concat(error_1 instanceof Error ? error_1.message : 'Unknown error'), { query: query, userId: userId, error: error_1 });
    ...
    NLPServiceManager.prototype.detectLanguage = function (query) {
        var portugueseWords = ['paciente', 'agendamento', 'consulta', 'prontuário', 'tratamento', 'procedimento', 'quando', 'onde', 'como', 'porque'];
        var englishWords = ['patient', 'appointment', 'consultation', 'record', 'treatment', 'procedure', 'when', 'where', 'how', 'why'];
        var portugueseCount = portugueseWords.filter(function (word) { return query.includes(word); }).length;
        var englishCount = englishWords.filter(function (word) { return query.includes(word); }).length;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2: return [2 /*return*/, 'general_search'];
                }
            });
        });
    };
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.openaiClient.chat.completions.create({
                    ...
                    case 1:
                        response = _d.sent();
                        intent = (_c = (_b = (_a = response.choices[0]) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c.trim();
                        validIntents = [
                        ...
                        return [2 /*return*/, validIntents.includes(intent) ?
                                intent : 'general_search'];
                    case 2:
                        error_2 = _d.sent();
                        console.warn('AI intent classification failed, falling back to general_search:', error_2);
    ...
    NLPServiceManager.prototype.extractEntities = function (query, intent) {
        return __awaiter(this, void 0, void 0, function () {
            var entities, _i, _a, _b, entityType, patterns, _c, patterns_2, pattern, matches, _d, matches_1, match;
            return __generator(this, function (_e) {
                ...
                return [2 /*return*/, entities
                        ...
                        return index === self.findIndex(function (e) { return e.type === entity.type && e.value === entity.value; });
                    })
    ...
    NLPServiceManager.prototype.calculateEntityConfidence = function (entityType, value, intent) {
        ...
        if ((_a = intentEntityMap[intent]) === null || _a === void 0 ? void 0 : _a.includes(entityType)) {
            confidence += 0.3;
        }
    ...
    NLPServiceManager.prototype.extractTemporalFilters = function (query) {
        ...
        for (var _i = 0, temporalPatterns_1 = temporalPatterns; _i < temporalPatterns_1.length; _i++) {
            var _a = temporalPatterns_1[_i], pattern = _a.pattern, days = _a.days, type = _a.type;
    ...
    NLPServiceManager.prototype.calculateConfidenceScore = function (intent, entities, medicalTerms) {
        ...
        if (entities.length > 0) {
            var avgEntityConfidence = entities.reduce(function (sum, e) { return sum + e.confidence; }, 0) / entities.length;
    ...
    NLPServiceManager.prototype.updateMedicalTerms = function (newTerms) {
        var _this = this;
        newTerms.forEach(function (term) { return _this.medicalTerms.add(term.toLowerCase()); });
    };
