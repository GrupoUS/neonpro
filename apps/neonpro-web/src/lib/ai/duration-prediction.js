...
exports.ModelPerformanceService = exports.AIABTestingService = exports.AIDurationPredictionService = void 0;
...
var AIDurationPredictionService = /** @class */ (function () {
    ...
    AIDurationPredictionService.prototype.predictDuration = function (appointmentId, features) {
        return __awaiter(this, void 0, void 0, function () {
            var activeModel, baseDuration, efficiencyFactor, complexityMultiplier, temporalFactor, predictedDuration, confidenceScore, prediction, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getProfessionalEfficiencyFactor(features.professionalId, features.treatmentType)];
                    case 2:
                        ...
                        predictedDuration = Math.round(baseDuration * efficiencyFactor * complexityMultiplier * temporalFactor);
                        confidenceScore = this.calculateConfidenceScore(features, activeModel.confidenceThreshold);
                        prediction = {
                    ...
                    case 3:
                        ...
                        _a.sent();
                        // Audit log
                        return [4 /*yield*/, this.auditLogger.logInfo('ai_duration_prediction', {
                                appointmentId: appointmentId,
                    ...
                    case 5:
                        error_1 = _a.sent();
                        return [4 /*yield*/, this.auditLogger.logError('ai_duration_prediction_failed', error_1, {
                                appointmentId: appointmentId,
                                features: features
                            })];
                    case 6:
     ...
     */
    AIDurationPredictionService.prototype.updatePredictionWithActual = function (appointmentId, actualDuration, feedbackNotes) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        accuracyScore = 1.0 - Math.min(Math.abs(prediction.predicted_duration - actualDuration) /
                            Math.max(prediction.predicted_duration, actualDuration), 1.0);
                        result = {
                            appointmentId: appointmentId,
                    ...
                    case 3:
                        ...
                        // Audit log
                        return [4 /*yield*/, this.auditLogger.logInfo('ai_prediction_feedback', {
                                appointmentId: appointmentId,
                    ...
                    case 5:
                        error_2 = _b.sent();
                        return [4 /*yield*/, this.auditLogger.logError('ai_prediction_feedback_failed', error_2, {
                                appointmentId: appointmentId,
                                actualDuration: actualDuration
                            })];
                    case 6:
     ...
     */
    AIDurationPredictionService.prototype.getProfessionalEfficiencyMetrics = function (professionalId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        error_3 = _b.sent();
                        return [4 /*yield*/, this.auditLogger.logError('professional_efficiency_metrics_failed', error_3, {
                                professionalId: professionalId
                            })];
                    case 3:
                        _b.sent();
    ...
    AIDurationPredictionService.prototype.getProfessionalEfficiencyFactor = function (professionalId, treatmentType) {
        return __awaiter(this, void 0, void 0, function () {
            var data, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        data = (_b.sent()).data;
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.efficiency_rating) || 1.0];
                    case 2:
                        _a = _b.sent();
                        return [2 /*return*/, 1.0];
    ...
    AIDurationPredictionService.prototype.calculateConfidenceScore = function (features, threshold) {
        ...
        var featureCount = Object.values(features).filter(function (v) { return v !== undefined && v !== null; }).length;
...
var AIABTestingService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        error_4 = _c.sent();
                        return [4 /*yield*/, this.auditLogger.logError('ab_test_assignment_failed', error_4, {
                                userId: userId
                            })];
                    case 4:
                        _c.sent();
    ...
    AIABTestingService.prototype.shouldUseAIPrediction = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.assignUserToTestGroup(userId)];
                    case 1:
                        assignment = _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        controlGroup = data.filter(function (d) { return d.test_group === 'control'; }).length;
                        treatmentGroup = data.filter(function (d) { return d.test_group === 'treatment'; }).length;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        error_6 = _b.sent();
                        return [4 /*yield*/, this.auditLogger.logError('model_deployment_failed', error_6, {
                                modelVersion: modelMetrics.modelVersion
                            })];
                    case 4:
                        _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        error_7 = _b.sent();
                        return [4 /*yield*/, this.auditLogger.logError('model_metrics_retrieval_failed', error_7)];
                    case 3:
                        _b.sent();
                        throw error_7;
                    case 4: return [2 /*return*/];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        updatedAccuracy = (currentModel.accuracyPercentage + feedbackData.predictionAccuracy * 100) / 2;
                        return [4 /*yield*/, this.supabase
                                .from('ml_model_performance')
                                .update({
                    ...
                    case 3:
                        error_8 = _b.sent();
                        return [4 /*yield*/, this.auditLogger.logError('performance_metrics_update_failed', error_8)];
                    case 4:
                        _b.sent();
                        throw error_8;
                    case 5: return [2 /*return*/];
