...
var EnhancedSubscriptionCache = /** @class */ (function () {
    ...
    EnhancedSubscriptionCache.prototype.get = function (key_1) {
        return __awaiter(this, arguments, void 0, function (key, prefetched) {
            ...
            if (prefetched === void 0) { prefetched = false; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        subscription_performance_monitor_1.subscriptionPerformanceMonitor.recordCacheOperation(true, duration);
                        data = entry.data;
    ...
    EnhancedSubscriptionCache.prototype.set = function (key_1, value_1, ttl_1) {
        return __awaiter(this, arguments, void 0, function (key, value, ttl, options) {
            var startTime, now, finalTTL, finalData, compressed, compressionRatio, dataSize, compressedData, compressedSize, compressionError_1, entry, oldEntry, duration, error_2, duration;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(!options.skipCompression &&
                            ...
                            this.shouldCompress(value))) return [3 /*break*/, 5];
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.ensureMemoryLimit(entry.memorySize)
                            // Store entry
                        ];
                    case 6:
                        // Check memory limits and evict if necessary
    ...
    EnhancedSubscriptionCache.prototype.cleanup = function () {
        ...
        console.debug("Cache cleanup: removed ".concat(removedCount, " entries, reclaimed ").concat(reclaimedMemory, " bytes"));
    };
    /**
                ...
                switch (_b.label) {
                    case 0:
                        if (!this.config.prefetch.enabled)
                            return [2 /*return*/];
                        strategies = this.prefetchStrategies.filter(function (s) { return s.enabled; });
                    ...
                    case 2:
                        keys_2 = _b.sent();
                        keys_2.forEach(function (key) { return candidateKeys.add(key); });
                        _b.label = 3;
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
    ...
    EnhancedSubscriptionCache.prototype.calculatePriority = function (value) {
        ...
        if (((_a = value.subscription) === null || _a === void 0 ? void 0 : _a.status) === 'active')
            priority += 3;
        else if (((_b = value.subscription) === null || _b === void 0 ? void 0 : _b.status) === 'trialing')
            priority += 2;
        else if (((_c = value.subscription) === null || _c === void 0 ? void 0 : _c.status) === 'past_due')
            priority += 1;
    ...
    EnhancedSubscriptionCache.prototype.calculateAdaptiveTTL = function (key, baseTTL) {
        ...
        var now = Date.now();
        var recentAccesses = pattern.filter(function (time) { return now - time < 60 * 60 * 1000; }); // Last hour
    ...
    EnhancedSubscriptionCache.prototype.trackAccessPattern = function (key) {
        ...
        var recentPattern = pattern.filter(function (time) { return time > cutoff; });
    ...
    EnhancedSubscriptionCache.prototype.getRecentCandidates = function (config) {
        ...
        for (var _i = 0, _a = this.accessPatterns; _i < _a.length; _i++) {
            ...
            if (pattern.some(function (time) { return time > cutoff; })) {
                candidates.push(key);
            }
        }
    ...
    EnhancedSubscriptionCache.prototype.updatePopularKeys = function (key) {
        ...
        if (this.popularKeys.size > 1000) {
            ...
            toRemove.forEach(function (k) { return _this.popularKeys.delete(k); });
        }
    };
    /**
    ...
    EnhancedSubscriptionCache.prototype.evictEntries = function (memoryToFree) {
        return __awaiter(this, void 0, void 0, function () {
            var strategy, freedMemory, now, candidates, _i, _a, _b, key, entry, score, age, recency, accessFreq, hotness, _c, candidates_1, _d, key, entry;
     ...
     */
    EnhancedSubscriptionCache.prototype.recordOperation = function (type, key, hit, duration, cacheLayer, memorySize) {
        if (cacheLayer === void 0) { cacheLayer = 'memory'; }
        if (!this.config.monitoring.trackOperations)
            return;
    ...
    EnhancedSubscriptionCache.prototype.handleCacheError = function (error, operation, key) {
        ...
        console.error("Cache ".concat(operation, " error").concat(key ? " for key ".concat(key) : '', ":"), error);
    ...
    EnhancedSubscriptionCache.prototype.startPrefetchTimer = function () {
        ...
        if (!this.config.prefetch.enabled)
            return;
        this.prefetchTimer = setInterval(function () {
