      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.executeImmediateHandlers(event_1),
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            if (
              (_b = filters === null || filters === void 0 ? void 0 : filters.eventTypes) ===
                null || _b === void 0
                ? void 0
                : _b.length
            ) {
          ...
          case 5:
            analytics = ((_a.performanceMetrics = _c.sent()), _a);
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (
              (_a = criteria === null || criteria === void 0 ? void 0 : criteria.eventTypes) ===
                null || _a === void 0
                ? void 0
                : _a.length
            ) {
          ...
          case 1:
            ...
            return [
              ...
              (events === null || events === void 0
                ? void 0
                : events.map(this.convertDbRecordToEvent)) || [],
            ];
          case 2:
            error_4 = _b.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("events").delete().lt("timestamp", cutoffDate.toISOString()),
            ];
          case 1:
                    ...
                    return __generator(this, (_a) => {
                      switch (_a.label) {
                        ...
                        case 2:
                          error_16 = _a.sent();
                          console.error(
                            "\u274C Async handler failed for ".concat(item.event.type, ":"),
                            error_16,
                          );
                          return [3 /*break*/, 3];
                        case 3:
