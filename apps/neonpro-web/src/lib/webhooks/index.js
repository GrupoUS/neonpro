...
var WebhookEventSystem = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // Initialize event system
                        return [4 /*yield*/, this.eventSystem.initialize()
                            // Initialize webhook manager
                        ];
                    case 1:
                        // Initialize event system
                        _a.sent();
                        // Initialize webhook manager
                        return [4 /*yield*/, this.webhookManager.initialize()
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.eventSystem.publishEvent(eventData)
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.webhookManager.deliverEvent(event_1)
                            // Update metrics
                        ];
                    case 3:
                        deliveryIds = _a.sent();
                        ...
                        console.log("\u2705 Event ".concat(eventId, " published with ").concat(deliveryIds.length, " webhook deliveries"));
                        return [2 /*return*/, {
                                eventId: eventId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.checkEventSystemHealth()
                            // Get webhook system health
                        ];
                    case 1:
                        eventSystemHealth = _a.sent();
                        return [4 /*yield*/, this.checkWebhookSystemHealth()
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.eventSystem.cleanupOldEvents()
                    ...
                    case 1:
                        ...
                        ;
                        console.log("\u2705 Cleanup completed: ".concat(eventsDeleted, " events, ").concat(deliveriesDeleted, " deliveries deleted"));
                        return [2 /*return*/, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.webhookManager.stop()
                            // Stop event system
                        ];
                    case 1:
                        // Stop webhook manager
    ...
    WebhookEventSystem.prototype.startHealthMonitoring = function () {
        var _this = this;
        this.healthCheckInterval = setInterval(function () { return _this.performHealthCheck(); }, this.config.monitoring.healthCheckInterval);
