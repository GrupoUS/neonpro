      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            console.log(
              "Registering webhook: ".concat(webhook.name, " (").concat(webhook.url, ")"),
            );
          ...
          case 3:
            return [
              4 /*yield*/,
              this.supabase.from("webhook_endpoints").insert({
                id: webhook.id,
                name: webhook.name,
                url: webhook.url,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            updatedWebhook = __assign(__assign(__assign({}, existingWebhook), updates), {
              id: webhookId,
              updatedAt: new Date(),
            });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("webhook_endpoints").delete().eq("id", webhookId),
            ];
          case 1:
            error = _a.sent().error;
            if (error) {
        ...
        switch (_c.label) {
          ...
          case 1:
            ...
            if (!this.eventMatchesWebhookFilters(event, webhook)) {
              console.log(
                "Event ".concat(event.id, " filtered out for webhook ").concat(webhook.id),
              );
              return [3 /*break*/, 3];
            }
            // Check rate limiting
            ...
            delivery = {
              ...
              attempts: 0,
              maxAttempts:
                ((_b = webhook.retryStrategy) === null || _b === void 0
                  ? void 0
                  : _b.maxAttempts) || this.config.maxRetries,
          ...
          case 4:
            console.log(
              "\u2705 Created "
                .concat(deliveryIds.length, " delivery records for event ")
                .concat(event.id),
            );
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            headers = __assign(
              { "Content-Type": "application/json", "User-Agent": "NeonPro-Webhook/1.0" },
              webhook.headers,
            );
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              (deliveries === null || deliveries === void 0
                ? void 0
                : deliveries.map(this.convertDbRecordToDelivery)) || [],
            ];
          case 2:
            error_7 = _a.sent();
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            ...
            console.log(
              "\u2705 Delivery ".concat(delivery.id, " successful (").concat(responseTime, "ms)"),
            );
            return [3 /*break*/, 6];
          case 3:
            delivery.httpStatus = response.status;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        if (delivery.attempts >= delivery.maxAttempts) {
          ...
          console.error(
            "\u274C Delivery "
              .concat(delivery.id, " failed permanently after ")
              .concat(delivery.attempts, " attempts"),
          );
        } else {
          delivery.status = "pending";
          ...
          console.log(
            "\u23F3 Delivery "
              .concat(delivery.id, " scheduled for retry in ")
              .concat(delayMs, "ms (attempt ")
              .concat(delivery.attempts, "/")
              .concat(delivery.maxAttempts, ")"),
          );
        }
        return [2 /*return*/];
      });
            ...
            return [
              ...
              this.supabase
                ...
                .update({
                  ...
                  attempts: delivery.attempts,
                  last_attempt_at:
                    (_a = delivery.lastAttemptAt) === null || _a === void 0
                      ? void 0
                      : _a.toISOString(),
                  delivered_at:
                    (_b = delivery.deliveredAt) === null || _b === void 0
                      ? void 0
                      : _b.toISOString(),
                  failed_at:
                    (_c = delivery.failedAt) === null || _c === void 0 ? void 0 : _c.toISOString(),
