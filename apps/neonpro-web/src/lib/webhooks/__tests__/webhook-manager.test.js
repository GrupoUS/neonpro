          ...
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, vitest_1.expect)(
                  webhookManager.registerWebhook(invalidWebhookData),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              (0, vitest_1.expect)(mockFetch).toHaveBeenCalledWith(
                mockWebhook.url,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                webhookManager.getDeliveryAnalytics("webhook-123", startDate, endDate),
              ];
            case 1:
              analytics = _a.sent();
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                webhookManager.deliverEvent(eventWithSensitiveData, mockWebhook),
              ];
            case 1:
              _a.sent();
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, vitest_1.expect)(webhookManager.registerWebhook(webhookData)).rejects.toThrow(
