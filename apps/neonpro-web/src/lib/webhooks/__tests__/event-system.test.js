...
var mockSupabase = {
    ...
    channel: vitest_1.vi.fn(function () { return ({
...
(0, vitest_1.describe)('EventSystem', function () {
    ...
    (0, vitest_1.describe)('Event Creation and Validation', function () {
        (0, vitest_1.it)('should create a valid event with all required fields', function () { return __awaiter(void 0, void 0, void 0, function () {
            var eventData, event;
        ...
        (0, vitest_1.it)('should validate event data and reject invalid events', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, vitest_1.expect)(eventSystem.createEvent(invalidEventData))
        ...
        (0, vitest_1.it)('should set default values for optional fields', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.it)('should generate unique fingerprints for different events', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.describe)('Event Publishing', function () {
        (0, vitest_1.it)('should publish event and add to queue', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.it)('should handle high priority events immediately', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.it)('should prevent duplicate events using fingerprints', function () { return __awaiter(void 0, void 0, void 0, function () {
            var eventData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, vitest_1.expect)(eventSystem.publishEvent(eventData))
    ...
    (0, vitest_1.describe)('Event Subscriptions', function () {
        (0, vitest_1.it)('should create event subscription with filters', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.it)('should update existing subscription', function () { return __awaiter(void 0, void 0, void 0, function () {
            var updates;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, vitest_1.it)('should delete subscription', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, eventSystem.deleteSubscription('sub-123')];
                    case 1:
                        _a.sent();
                        (0, vitest_1.expect)(mockSupabase.from().delete().eq).toHaveBeenCalledWith('id', 'sub-123');
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, vitest_1.describe)('Event Queue Management', function () {
        (0, vitest_1.it)('should add events to queue', function () { return __awaiter(void 0, void 0, void 0, function () {
            var event, queueSize;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, vitest_1.it)('should process queue in batches', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        i++;
                        return [3 /*break*/, 1];
                    case 4: return [4 /*yield*/, eventSystem.processQueue()
        ...
        (0, vitest_1.it)('should handle queue overflow', function () { return __awaiter(void 0, void 0, void 0, function () {
            var largeQueue, event;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        largeQueue = Array.from({ length: 1001 }, function (_, i) { return ({
                            id: "event-".concat(i),
                            type: 'patient.created',
                            source: 'patient-service',
                            data: { patientId: "".concat(i) },
                        ...
                        return [4 /*yield*/, (0, vitest_1.expect)(eventSystem.addToQueue(event))
    ...
    (0, vitest_1.describe)('Real-time Streaming', function () {
        (0, vitest_1.it)('should start real-time streaming', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, eventSystem.startRealTimeStreaming()];
                    case 1:
                        _a.sent();
        ...
        (0, vitest_1.it)('should stop real-time streaming', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, eventSystem.startRealTimeStreaming()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, eventSystem.stopRealTimeStreaming()
        ...
        (0, vitest_1.it)('should handle real-time event notifications', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.describe)('Analytics and Monitoring', function () {
        (0, vitest_1.it)('should get event analytics', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.it)('should get system health metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
            var health;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, eventSystem.getSystemHealth()];
                    case 1:
                        health = _a.sent();
        ...
        (0, vitest_1.it)('should track event processing metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
            var event, metrics;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, eventSystem.publishEvent({
                                type: event.type,
                                source: event.source,
                                data: event.data,
    ...
    (0, vitest_1.describe)('Error Handling', function () {
        ...
        (0, vitest_1.it)('should handle invalid event data gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var invalidEventData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, vitest_1.it)('should handle queue processing errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            var originalProcessQueue;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        originalProcessQueue = eventSystem.processQueue;
                        eventSystem.processQueue = vitest_1.vi.fn().mockRejectedValue(new Error('Processing failed'));
                        // Should not crash the system
                        return [4 /*yield*/, (0, vitest_1.expect)(eventSystem.processQueue()).rejects.toThrow('Processing failed')
    ...
    (0, vitest_1.describe)('Event Utilities Integration', function () {
        (0, vitest_1.it)('should use EventUtils for validation', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.it)('should use EventUtils for fingerprint generation', function () { return __awaiter(void 0, void 0, void 0, function () {
            var generateFingerprintSpy, eventData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        generateFingerprintSpy = vitest_1.vi.spyOn(utils_1.EventUtils, 'generateEventFingerprint');
                        eventData = {
                            type: 'patient.created',
                            source: 'patient-service',
                            data: { patientId: '123' },
    ...
    (0, vitest_1.describe)('Performance Tests', function () {
        (0, vitest_1.it)('should handle high volume of events', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.it)('should maintain performance under load', function () { return __awaiter(void 0, void 0, void 0, function () {
