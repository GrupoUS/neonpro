  ...
  (0, vitest_1.describe)("validateEvent", function () {
    ...
    (0, vitest_1.it)("should reject invalid version format", function () {
      ...
      (0, vitest_1.expect)(result.errors).toContain(
        "Event version must follow semantic versioning (e.g., 1.0.0)",
      );
    });
  });
...
(0, vitest_1.describe)("WebhookUtils", function () {
  ...
  (0, vitest_1.describe)("validateWebhookUrl", function () {
    ...
    (0, vitest_1.it)("should reject localhost URLs in production", function () {
      ...
      (0, vitest_1.expect)(result.isValid).toBe(false);
      (0, vitest_1.expect)(result.errors).toContain(
        "Webhook URL cannot point to private/local addresses in production",
      );
      process.env.NODE_ENV = originalEnv;
    });
  ...
  (0, vitest_1.describe)("checkRateLimit", function () {
    ...
    (0, vitest_1.it)("should handle burst limits", function () {
      ...
      for (var i = 0; i < burstLimit; i++) {
        var result_2 = utils_1.RateLimitUtils.checkRateLimit(
          identifier,
          maxRequests,
          windowMs,
          burstLimit,
      ...
      var result = utils_1.RateLimitUtils.checkRateLimit(
        identifier,
        maxRequests,
        windowMs,
        burstLimit,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                utils_1.RetryUtils.executeWithRetry(mockFn, 3, strategy, onRetry),
              ];
            case 1:
              result = _a.sent();
              (0, vitest_1.expect)(result).toBe("success");
          ...
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, vitest_1.expect)(
                  utils_1.RetryUtils.executeWithRetry(mockFn, 2, strategy),
          ...
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, vitest_1.expect)(
                  utils_1.RetryUtils.executeWithRetry(mockFn, 3, strategy),
