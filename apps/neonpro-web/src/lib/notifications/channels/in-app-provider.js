...
var InAppProvider = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.config = __assign({ enableRealTime: true, maxNotifications: 100, autoMarkAsRead: false, soundEnabled: true, persistNotifications: true }, config.settings);
            ...
            return __generator(this, function (_b) {
                ...
                try {
                    ...
                    this.websocket.onclose = function () {
                        ...
                        setTimeout(function () { return _this.initializeWebSocket(); }, 5000);
                    };
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    if (stored) {
                        ...
                        this.notifications = new Map(Object.entries(data).map(function (_a) {
                            var userId = _a[0], notifications = _a[1];
                            return [
                                userId,
                                notifications.map(function (n) { return (__assign(__assign({}, n), { createdAt: new Date(n.createdAt), readAt: n.readAt ? new Date(n.readAt) : undefined, expiresAt: n.expiresAt ? new Date(n.expiresAt) : undefined })); })
                            ];
                        }));
                    }
                }
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, {
                                ...
                                metadata: {
                                    ...
                                    websocketSent: ((_a = this.websocket) === null || _a === void 0 ? void 0 : _a.readyState) === WebSocket.OPEN
                                },
                                attempts: 1,
                                sentAt: new Date(),
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        notification = userNotifications.find(function (n) { return n.id === notificationId; });
                        if (!notification)
                            return [2 /*return*/, false];
                        notification.isRead = true;
                        notification.readAt = new Date();
                        if (!((_a = this.config) === null || _a === void 0 ? void 0 : _a.persistNotifications)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.persistNotifications()];
                    case 1:
                        _b.sent();
                        _b.label = 2;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(((_a = this.config) === null || _a === void 0 ? void 0 : _a.persistNotifications) && count > 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.persistNotifications()];
                    case 1:
                        _b.sent();
                        _b.label = 2;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!userNotifications)
                            return [2 /*return*/, false];
                        index = userNotifications.findIndex(function (n) { return n.id === notificationId; });
                        if (index === -1)
                            return [2 /*return*/, false];
    ...
    InAppProvider.prototype.validateConfig = function (config) {
        ...
        if ((settings === null || settings === void 0 ? void 0 : settings.maxNotifications) && settings.maxNotifications < 1) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                wsStatus = this.config.enableRealTime ?
                    (((_a = this.websocket) === null || _a === void 0 ? void 0 : _a.readyState) === WebSocket.OPEN ? 'conectado' : 'desconectado') :
                    'desabilitado';
                return [2 /*return*/, {
                        healthy: true,
    ...
    InAppProvider.prototype.getStats = function () {
        ...
        this.notifications.forEach(function (userNotifications) {
            ...
            unreadNotifications += userNotifications.filter(function (n) { return !n.isRead && !n.isArchived; }).length;
        });
        return {
            totalNotifications: totalNotifications,
            unreadNotifications: unreadNotifications,
            activeUsers: this.notifications.size,
            websocketConnected: ((_a = this.websocket) === null || _a === void 0 ? void 0 : _a.readyState) === WebSocket.OPEN
        };
    };
