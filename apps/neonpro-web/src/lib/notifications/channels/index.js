 ...
 */
var NotificationChannelManager = /** @class */ (function () {
    ...
    NotificationChannelManager.prototype.registerDefaultProviders = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./email-provider'); })];
                    case 1:
                        EmailProvider = (_a.sent()).EmailProvider;
                        return [4 /*yield*/, Promise.resolve().then(function () { return require('./sms-provider'); })];
                    case 2:
                        SMSProvider = (_a.sent()).SMSProvider;
                        return [4 /*yield*/, Promise.resolve().then(function () { return require('./push-provider'); })];
                    case 3:
                        PushProvider = (_a.sent()).PushProvider;
                        return [4 /*yield*/, Promise.resolve().then(function () { return require('./in-app-provider'); })];
                    case 4:
    ...
    NotificationChannelManager.prototype.getAvailableChannels = function () {
        var _this = this;
        return Array.from(this.providers.keys()).filter(function (channel) {
            var _a;
            var provider = _this.providers.get(channel);
            return (_a = provider === null || provider === void 0 ? void 0 : provider.isEnabled) !== null && _a !== void 0 ? _a : false;
        });
    };
    // ============================================================================
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        console.error("Erro ao enviar notifica\u00E7\u00E3o via ".concat(channel, ":"), error_2);
                        return [2 /*return*/, {
                                id: this.generateDeliveryId(),
                                notificationId: context.notificationId || '',
                                channel: channel,
     ...
     */
    NotificationChannelManager.prototype.generateDeliveryId = function () {
        return "delivery_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9));
    };
    /**
