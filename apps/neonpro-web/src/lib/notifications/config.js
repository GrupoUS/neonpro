...
exports.config = exports.NotificationPriority = exports.NotificationChannel = exports.WEBHOOK_EVENTS = exports.TEMPLATE_DEFAULTS = exports.DEFAULT_CONFIG = void 0;
...
function isChannelEnabled(config, channel) {
    ...
    switch (channel) {
        ...
        case types_1.NotificationChannel.SMS:
            ...
            return ((smsConfig.provider === 'twilio' && !!(smsConfig.accountSid && smsConfig.authToken)) ||
        ...
        case types_1.NotificationChannel.PUSH:
            ...
            return ((pushConfig.provider === 'fcm' && !!pushConfig.projectId) ||
...
Object.defineProperty(exports, "NotificationChannel", { enumerable: true, get: function () { return types_2.NotificationChannel; } });
Object.defineProperty(exports, "NotificationPriority", { enumerable: true, get: function () { return types_2.NotificationPriority; } });
