...
var NotificationComplianceEngine = /** @class */ (() => {
   ...
   */
  NotificationComplianceEngine.prototype.validateLGPDCompliance = function (
    userId,
    clinicId,
    notificationType,
    channel,
   ...
   */
  NotificationComplianceEngine.prototype.getValidConsent = function (
    userId,
    clinicId,
    notificationType,
  ) {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            purposeMapping =
              ((_b = {}),
              (_b[types_1.NotificationType.APPOINTMENT_REMINDER] = [
                "appointment",
                "reminder",
                "healthcare",
              ]),
              (_b[types_1.NotificationType.APPOINTMENT_CONFIRMATION] = [
                "appointment",
                "confirmation",
                "healthcare",
              ]),
              (_b[types_1.NotificationType.PRESCRIPTION_READY] = [
                "prescription",
                "healthcare",
                "medication",
              ]),
   ...
   */
  NotificationComplianceEngine.prototype.validateDataMinimization = function (
    userId,
    notificationType,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        requiredFields =
          ...
          (_a[types_1.NotificationType.APPOINTMENT_CONFIRMATION] = [
            "name",
            "phone",
            "appointment_date",
          ]),
  ...
  NotificationComplianceEngine.prototype.validateChannelCompliance = function (userId, channel) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        ...
        return [
          2 /*return*/,
          secureChannels.includes(channel) || channel === types_1.NotificationChannel.IN_APP,
        ];
      });
    });
  };
   ...
   */
  NotificationComplianceEngine.prototype.validateMedicalCompliance = function (
    userId,
    clinicId,
    content,
    notificationType,
        ...
        switch (_a.label) {
          case 0:
            ...
            if (hasSensitiveInfo.detected) {
              auditTrail.push(
                "Informa\u00E7\u00F5es m\u00E9dicas detectadas: ".concat(
                  hasSensitiveInfo.types.join(", "),
                ),
              );
  ...
  NotificationComplianceEngine.prototype.logAuditEvent = function (event) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            auditLog = __assign(__assign({}, event), {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            this.auditBuffer = [];
            return [4 /*yield*/, this.supabase.from("compliance_audit_logs").insert(logs)];
          case 2:
            error = _b.sent().error;
            if (error) {
   ...
   */
  NotificationComplianceEngine.prototype.performDPIA = function (
    clinicId,
    processName,
    description,
    reviewerId,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4 /*yield*/, this.supabase.from("dpia_assessments").insert(dpia)];
          case 1:
            error = _a.sent().error;
            if (error) {
