...
var NotificationManager = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, audit_logger_1.auditLogger.log({
                                ...
                                severity: 'info',
                                details: {
                                    channelsEnabled: config.channels.filter(function (c) { return c.isEnabled; }).length,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 7, , 9]);
                        return [4 /*yield*/, this.createNotification(type, data, options === null || options === void 0 ? void 0 : options.priority)];
                    case 2:
                        notification_1 = _a.sent();
                        channels = this.determineChannels(recipient, type, options === null || options === void 0 ? void 0 : options.channels);
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, Promise.all(channels.map(function (channel) {
                                return _this.createDeliveryNotification(notification_1, recipient, channel, options);
                            }))];
                    case 4:
                        deliveryNotifications = _a.sent();
                        return [4 /*yield*/, Promise.all(deliveryNotifications.map(function (dn) { return _this.deliverNotification(dn); }))];
                    case 5:
                        results = _a.sent();
                        // Registrar métricas
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.ensureInitialized();
                        batchSize = (options === null || options === void 0 ? void 0 : options.batchSize) || 100;
                        results = [];
                        i = 0;
                        _a.label = 1;
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(batch.map(function (recipient) {
    ...
    NotificationManager.prototype.createNotification = function (type_1, data_1) {
        return __awaiter(this, arguments, void 0, function (type, data, priority) {
            ...
            if (priority === void 0) { priority = types_1.NotificationPriority.NORMAL; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
     ...
     */
    NotificationManager.prototype.createDeliveryNotification = function (notification, recipient, channel, options) {
        return __awaiter(this, void 0, void 0, function () {
            var template, context, renderedContent, deliveryNotification, error;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getTemplate(notification.type, channel, options === null || options === void 0 ? void 0 : options.template)];
                    case 1:
                        template = _b.sent();
                        _a = {
                            recipient: recipient
                    ...
                    case 3:
                        ...
                        deliveryNotification = __assign(__assign({}, notification), { title: renderedContent.title, message: renderedContent.body, recipient: recipient, channel: channel, template: template, scheduledFor: options === null || options === void 0 ? void 0 : options.scheduledFor, attempts: [], status: types_1.NotificationStatus.PENDING });
                        return [4 /*yield*/, this.supabase
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 9]);
                        if (!(notification.scheduledFor && notification.scheduledFor > new Date())) return [3 /*break*/, 2];
                    ...
                    case 2: return [4 /*yield*/, this.channelManager.deliver(notification)];
                    case 3:
                        result = _a.sent();
                        // Atualizar status
                    ...
                    case 4:
                        ...
                        _a.sent();
                        // Registrar evento
                        return [4 /*yield*/, this.recordNotificationEvent(notification.id, 'sent', {
                    ...
                    case 7:
                        _a.sent();
                        return [4 /*yield*/, this.recordNotificationEvent(notification.id, 'failed', {
                                error: error_3.message
                            })];
                    case 8:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2: return [4 /*yield*/, this.templateEngine.getTemplateByType(type, channel)];
        ...
        if (requestedChannels) {
            ...
            return requestedChannels.filter(function (channel) {
                ...
                return preferences.channels[channel] &&
                    ((_a = preferences.categories[category]) === null || _a === void 0 ? void 0 : _a.channels.includes(channel));
            });
        }
        // Usar preferências do usuário
        return ((_a = preferences.categories[category]) === null || _a === void 0 ? void 0 : _a.channels) || [this.config.defaultChannel];
    };
    /**
    ...
    NotificationManager.prototype.getNotificationCategory = function (type) {
        ...
        for (var _i = 0, _a = Object.entries(categoryMap); _i < _a.length; _i++) {
            var _b = _a[_i], prefix = _b[0], category = _b[1];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.recordNotificationEvent(notificationId, 'read', { userId: userId })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
