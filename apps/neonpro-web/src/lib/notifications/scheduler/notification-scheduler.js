...
var NotificationScheduler = /** @class */ (function () {
  ...
  NotificationScheduler.prototype.createSchedule = function (config) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            validatedConfig = ScheduleConfigSchema.parse(
              __assign({ id: crypto.randomUUID() }, config),
            );
            _b.label = 1;
          case 1:
            _b.trys.push([1, 7, , 8]);
          ...
          case 6:
            console.log(
              "\uD83D\uDCC5 Agendamento criado: "
                .concat(validatedConfig.id, " - ")
                .concat(validatedConfig.name),
            );
  ...
  NotificationScheduler.prototype.processScheduledNotifications = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            if (this.isProcessing) return [2 /*return*/];
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          ...
          case 4:
            ...
            if (
              !((_a = notification.notification_schedules.options) === null || _a === void 0
                ? void 0
                : _a.optimizeDeliveryTime)
            )
              return [3 /*break*/, 6];
            return [
              4 /*yield*/,
              this.optimizeDeliveryTime(notification.user_id, notification.channel, finalTime),
            ];
          case 5:
          ...
          case 6:
            if (
              !this.isInQuietHours(
                finalTime,
                (_b = notification.notification_schedules.options) === null || _b === void 0
                  ? void 0
                  : _b.quietHours,
              )
            )
              return [3 /*break*/, 8];
            nextAvailable = this.findNextAvailableTime(
              finalTime,
              (_c = notification.notification_schedules.options) === null || _c === void 0
                ? void 0
                : _c.quietHours,
            );
            return [
          ...
          case 8:
            ...
            return [
              4 /*yield*/,
              notification_manager_1.notificationManager.sendNotification({
                userId: notification.user_id,
                channel: notification.channel,
                type: types_1.NotificationType.CUSTOM,
                content: notification.content,
                metadata: __assign(
                  { scheduleId: scheduleId, scheduledNotificationId: notification.id },
          ...
          case 12:
            ...
            _e.sent();
            maxRetries =
              ((_d = notification.notification_schedules.options) === null || _d === void 0
                ? void 0
          ...
          case 17:
            error_6 = _e.sent();
            console.error(
              "Erro ao processar lote do agendamento ".concat(scheduleId, ":"),
              error_6,
            );
            throw error_6;
          case 18:
          ...
          case 1:
            ...
            history_1.forEach(function (notification) {
              ...
              if (openedAt) {
                ...
                current.avgResponseTime =
                  (current.avgResponseTime * (current.count - 1) + responseTime) / current.count;
            ...
            factors.push(
              {
                ...
                impact: "".concat(
                  (
                    (((hourlyData === null || hourlyData === void 0 ? void 0 : hourlyData.count) ||
                      0) /
                      history_1.length) *
                    100
                  ).toFixed(1),
              ...
              },
              {
                ...
                weight: 0.4,
                impact: "M\u00E9dia de ".concat(
                  ((_b =
                    hourlyData === null || hourlyData === void 0
                      ? void 0
                      : hourlyData.avgResponseTime) === null || _b === void 0
                    ? void 0
                    : _b.toFixed(0)) || 0,
                  " minutos",
                ),
            ...
            return [
              2 /*return*/,
              {
                ...
                reason: "Hor\u00E1rio otimizado baseado em ".concat(
                  history_1.length,
  ...
  NotificationScheduler.prototype.isInQuietHours = function (time, quietHours) {
    ...
    var _a = quietHours.start.split(":").map(Number),
      startHour = _a[0],
      startMinute = _a[1];
    var _b = quietHours.end.split(":").map(Number),
      endHour = _b[0],
      endMinute = _b[1];
  ...
  NotificationScheduler.prototype.findNextAvailableTime = function (time, quietHours) {
    ...
    var _a = quietHours.end.split(":").map(Number),
      endHour = _a[0],
      endMinute = _a[1];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.resolveAudience(schedule_1.audience_config, schedule_1.clinic_id),
            ];
          case 2:
            audience_1 = _b.sent();
            ...
            return [
              4 /*yield*/,
              this.supabase.from("scheduled_notifications").insert(notifications),
            ];
          case 3:
            ...
            if (insertError) {
              ...
              console.log(
                "\uD83D\uDCC5 Geradas "
                  .concat(notifications.length, " execu\u00E7\u00F5es para agendamento ")
                  .concat(scheduleId),
              );
            }
            _b.label = 4;
  ...
  NotificationScheduler.prototype.calculateNextExecutions = function (config, limit) {
    ...
    var _loop_1 = function (i) {
      ...
      switch (recurrence.frequency) {
        ...
        default:
          throw new Error(
            "Frequ\u00EAncia de recorr\u00EAncia n\u00E3o suportada: ".concat(recurrence.frequency),
          );
      }
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            return [
              4 /*yield*/,
              this.supabase.from("profiles").select("id").eq("clinic_id", clinicId),
            ];
          case 2:
  ...
  NotificationScheduler.prototype.resolveCustomAudience = function (filters, clinicId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!filters || filters.length === 0) return [2 /*return*/, []];
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.resolveAudience(schedule_2.audience_config, schedule_2.clinic_id),
            ];
          case 2:
            audience = _b.sent();
