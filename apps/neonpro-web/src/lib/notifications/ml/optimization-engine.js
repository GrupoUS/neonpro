...
var OptimizationConfigSchema = zod_1.z.object({
    ...
    models: zod_1.z.object({
        engagementModel: zod_1.z.enum(['logistic', 'random_forest', 'neural_network']).default('logistic'),
...
var NotificationMLEngine = /** @class */ (function () {
    ...
    NotificationMLEngine.prototype.buildUserProfile = function (userId, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, user, userError, _b, notifications, notificationError, notificationHistory, totalNotifications, totalOpened, totalClicked, engagementScore, channelStats_1, preferredChannels, hourlyEngagement_1, bestHours, responseTimes, avgResponseTime, responsePattern, weekendEngagement, weekdayEngagement, weekendSent, weekdayRate, weekendRate, lastEngagement, daysSinceLastEngagement, churnRisk, profile, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        totalOpened = notificationHistory.filter(function (n) { return n.opened_at; }).length;
                        totalClicked = notificationHistory.filter(function (n) { return n.clicked_at; }).length;
                        ...
                        hourlyEngagement_1 = new Array(24).fill(0).map(function () { return ({ sent: 0, opened: 0 }); });
                        notificationHistory.forEach(function (n) {
                            var hour = new Date(n.sent_at).getHours();
                            hourlyEngagement_1[hour].sent++;
                            if (n.opened_at)
                                hourlyEngagement_1[hour].opened++;
                        });
                        bestHours = hourlyEngagement_1
                            .map(function (stats, hour) { return ({
                            hour: hour,
                            rate: stats.sent > 0 ? stats.opened / stats.sent : 0,
                            count: stats.sent,
                        }); })
                            .filter(function (h) { return h.count >= 3; }) // Mínimo de dados
                            .sort(function (a, b) { return b.rate - a.rate; })
                            .slice(0, 5)
                            .map(function (h) { return h.hour; });
                        responseTimes = notificationHistory
                            .filter(function (n) { return n.opened_at; })
                            .map(function (n) {
                        ...
                        weekdayRate = (totalNotifications - weekendSent) > 0
                        ...
                        lastEngagement = notificationHistory.find(function (n) { return n.opened_at || n.clicked_at; });
                        ...
                        profile = {
                            ...
                            behavior: {
                                ...
                                preferredChannels: preferredChannels.length > 0 ? preferredChannels : [types_1.NotificationChannel.EMAIL],
                            ...
                            history: {
                                ...
                                lastEngagement: lastEngagement === null || lastEngagement === void 0 ? void 0 : lastEngagement.sent_at,
                            },
                        };
    ...
    NotificationMLEngine.prototype.optimizeForUser = function (userId, clinicId, baseNotification) {
        return __awaiter(this, void 0, void 0, function () {
            var profile, channelOptimization, timingOptimization, contentOptimization, frequencyOptimization, error_3;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.optimizeTiming(profile, baseNotification.scheduledFor || new Date())];
                    case 3:
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, {
                                ...
                                modelVersions: {
                                    engagement: ((_a = this.models.get('engagement')) === null || _a === void 0 ? void 0 : _a.version) || '1.0.0',
                                    timing: ((_b = this.models.get('timing')) === null || _b === void 0 ? void 0 : _b.version) || '1.0.0',
                                    content: '1.0.0',
                                },
    ...
    NotificationMLEngine.prototype.optimizeChannel = function (profile, availableChannels) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                channelScores = channels.map(function (channel) {
                    ...
                    if (channel === types_1.NotificationChannel.PUSH && profile.behavior.responsePattern === 'immediate') {
                        score += 0.15;
                    }
                    if (channel === types_1.NotificationChannel.EMAIL && profile.behavior.responsePattern === 'delayed') {
                        score += 0.1;
                    }
    ...
    NotificationMLEngine.prototype.optimizeTiming = function (profile, baseTime) {
        return __awaiter(this, void 0, void 0, function () {
            var optimizedTime, factors, currentHour, bestHour, userTimezone, hour, dayOfWeek, daysToWeekend, confidence;
            return __generator(this, function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        features = profiles.map(function (profile) { return [
    ...
    NotificationMLEngine.prototype.performKMeans = function (features, profiles, k) {
        ...
        var _loop_1 = function () {
            ...
            converged = newAssignments.every(function (assignment, i) { return assignment === assignments[i]; });
            assignments = newAssignments;
            var _loop_3 = function (j) {
                var clusterPoints = features.filter(function (_, i) { return assignments[i] === j; });
                if (clusterPoints.length > 0) {
                    var _loop_4 = function (d) {
                        centroids[j][d] = clusterPoints.reduce(function (sum, point) { return sum + point[d]; }, 0) / clusterPoints.length;
                    };
        ...
        var _loop_2 = function (i) {
            var segmentUsers = profiles.filter(function (_, idx) { return assignments[idx] === i; });
            if (segmentUsers.length === 0)
                return "continue";
            var avgEngagement = segmentUsers.reduce(function (sum, user) { return sum + user.behavior.engagementScore; }, 0) / segmentUsers.length;
            var avgChurnRisk = segmentUsers.reduce(function (sum, user) { return sum + user.behavior.churnRisk; }, 0) / segmentUsers.length;
            var name_1 = '';
            var description = '';
            var strategy = {
            ...
            segments.push({
                ...
                userIds: segmentUsers.map(function (user) { return user.user_id; }),
                characteristics: {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                data.forEach(function (notification) {
                    ...
                    model.weights.channel.set(channel, currentChannelWeight + _this.config.learningRate * (label - 0.5));
                });
                hourSum = model.weights.hour.reduce(function (a, b) { return a + Math.abs(b); }, 0);
                if (hourSum > 0) {
                    model.weights.hour = model.weights.hour.map(function (w) { return w / hourSum; });
                }
