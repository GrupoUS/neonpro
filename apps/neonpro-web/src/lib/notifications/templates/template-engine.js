...
var TemplateEngine = /** @class */ (function () {
    ...
    TemplateEngine.prototype.render = function (templateId, context) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, template, variables, renderedContent, renderedSubject, variablesUsed, result, error_1;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('notification_templates')
                                .insert(__assign(__assign({}, template), { created_at: new Date().toISOString(), updated_at: new Date().toISOString() }))
                                .select()
                                .single()];
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('notification_templates')
                                .update(__assign(__assign({}, updates), { version: currentTemplate.version + 1, updated_at: new Date().toISOString() }))
                                .eq('id', templateId)
                                .select()
                                .single()];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        invalidVariables = variables.filter(function (v) { return !allowedVariables.includes(v); });
                        if (invalidVariables.length > 0) {
                            throw new Error("Vari\u00E1veis inv\u00E1lidas encontradas: ".concat(invalidVariables.join(', ')));
                        }
                        return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                if (context.appointment) {
                    rendered = rendered.replace(/{{\s*appointment\.date\s*}}/g, context.appointment.date.toLocaleDateString('pt-BR'));
                ...
                if (context.payment) {
                    rendered = rendered.replace(/{{\s*payment\.amount\s*}}/g, context.payment.amount.toLocaleString('pt-BR', {
                        style: 'currency',
                        currency: context.payment.currency || 'BRL'
                    }));
                    if (context.payment.due_date) {
                        rendered = rendered.replace(/{{\s*payment\.due_date\s*}}/g, context.payment.due_date.toLocaleDateString('pt-BR'));
                    }
                }
    ...
    TemplateEngine.prototype.validateContext = function (context, variables) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                requiredVariables = variables.filter(function (v) { return v.required; });
                for (_i = 0, requiredVariables_1 = requiredVariables; _i < requiredVariables_1.length; _i++) {
