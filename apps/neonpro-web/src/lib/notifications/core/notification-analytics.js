...
var NotificationAnalytics = /** @class */ (function () {
    ...
    NotificationAnalytics.prototype.getChannelMetrics = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, cached, channels, channelMetrics, _i, channels_1, channel, channelFilters, query, _a, data, error, metrics, volumeTrend, performanceTrend, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    NotificationAnalytics.prototype.getUserEngagementMetrics = function (userId, filters) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _a, data, error, userGroups, userMetrics, _i, _b, _c, userId_1, notifications, metrics, error_3;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, userMetrics.sort(function (a, b) { return b.engagement_score - a.engagement_score; })];
                    case 2:
                        error_3 = _d.sent();
    ...
    NotificationAnalytics.prototype.getTemplateMetrics = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _a, data, error, templateGroups, templateMetrics, _i, _b, _c, templateId, group, metrics, error_4;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, templateMetrics.sort(function (a, b) { return b.usage_count - a.usage_count; })];
                    case 2:
                        error_4 = _d.sent();
    ...
    NotificationAnalytics.prototype.getCampaignMetrics = function (campaignId, filters) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _a, data, error, campaignGroups, campaignMetrics, _i, _b, _c, campaignId_1, group, notifications, metrics, channelBreakdown, geographicBreakdown, demographicBreakdown, dates, startDate, endDate, error_5;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        for (_i = 0, _b = Object.entries(campaignGroups); _i < _b.length; _i++) {
                            ...
                            dates = notifications.map(function (n) { return new Date(n.sent_at); }).sort();
                            startDate = dates[0];
                            ...
                            campaignMetrics.push({
                                ...
                                end_date: endDate,
                                total_recipients: new Set(notifications.map(function (n) { return n.user_id; })).size,
                                metrics: metrics,
    ...
    NotificationAnalytics.prototype.getRealTimeMetrics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var now, oneHourAgo, oneMinuteAgo, queueData, recentData, errorData, totalHourData, activeChannels, uniqueChannels, errorRate, systemHealth, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        uniqueChannels = __spreadArray([], new Set((activeChannels === null || activeChannels === void 0 ? void 0 : activeChannels.map(function (c) { return c.channel; })) || []), true);
                        errorRate = (totalHourData === null || totalHourData === void 0 ? void 0 : totalHourData.length) ?
                            ((errorData === null || errorData === void 0 ? void 0 : errorData.length) || 0) / totalHourData.length * 100 : 0;
                        systemHealth = errorRate > 10 ? 'critical' : errorRate > 5 ? 'warning' : 'healthy';
                        return [2 /*return*/, {
                                current_queue_size: (queueData === null || queueData === void 0 ? void 0 : queueData.length) || 0,
                                processing_rate_per_minute: (recentData === null || recentData === void 0 ? void 0 : recentData.length) || 0,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), summary = _a[0], channels = _a[1], templates = _a[2], userEngagement = _a[3];
    ...
    NotificationAnalytics.prototype.calculateMetrics = function (data) {
        ...
        var total_delivered = data.filter(function (n) { return n.delivered_at; }).length;
        var total_opened = data.filter(function (n) { return n.opened_at; }).length;
        var total_clicked = data.filter(function (n) { return n.clicked_at; }).length;
        var total_failed = data.filter(function (n) { return n.status === 'failed'; }).length;
        ...
        var deliveredNotifications = data.filter(function (n) { return n.sent_at && n.delivered_at; });
        ...
        // Custo
        var total_cost = data.reduce(function (sum, n) { return sum + (n.cost || 0); }, 0);
    ...
    NotificationAnalytics.prototype.calculateUserEngagement = function (userId, notifications) {
        ...
        var total_opened = notifications.filter(function (n) { return n.opened_at; }).length;
        var total_clicked = notifications.filter(function (n) { return n.clicked_at; }).length;
        // Score de engajamento (0-100)
        var engagement_score = total_received > 0 ?
        ...
        var preferred_channel = ((_a = Object.entries(channelCounts)
            .sort(function (_a, _b) {
            var a = _a[1];
            var b = _b[1];
            return b - a;
        })[0]) === null || _a === void 0 ? void 0 : _a[0]) || 'email';
        // Horário preferido (simulado)
        var preferred_time = '14:00';
        // Última interação
        var interactions = notifications.filter(function (n) { return n.opened_at || n.clicked_at; });
        var last_interaction = interactions.length > 0 ?
            new Date(Math.max.apply(Math, interactions.map(function (n) {
    ...
    NotificationAnalytics.prototype.calculateChannelBreakdown = function (notifications) {
        var breakdown = {};
        var channels = __spreadArray([], new Set(notifications.map(function (n) { return n.channel; })), true);
        var _loop_1 = function (channel) {
            var channelNotifications = notifications.filter(function (n) { return n.channel === channel; });
    ...
    NotificationAnalytics.prototype.generateRecommendations = function (summary, channels) {
        ...
        var bestChannel = channels.sort(function (a, b) { return b.metrics.open_rate - a.metrics.open_rate; })[0];
        if (bestChannel) {
            recommendations.push("Canal ".concat(bestChannel.channel, " tem melhor performance. Considere aumentar seu uso."));
        }
