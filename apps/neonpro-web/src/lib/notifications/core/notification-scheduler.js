            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.processingInterval = setInterval(function () { return _this.processScheduledNotifications(); }, this.processingIntervalMs);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (error)
                            throw error;
                        if (!(!config.repeat_pattern && this.isNearFuture(config.scheduled_at))) return [3 /*break*/, 4];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this.auditLogger.log({
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        data.forEach(function (notification) {
                            // Status
                            stats_1[notification.status] =
                                stats_1[notification.status] + 1;
                            // Canais
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        error_6 = _b.sent();
                        console.error("Erro ao processar notifica\u00E7\u00E3o ".concat(notification.id, ":"), error_6);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5: return [4 /*yield*/, this.auditLogger.log({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log("Enviando notifica\u00E7\u00E3o ".concat(notification.id, " via ").concat(notification.channel, " para ").concat(notification.recipient));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        newNotification = __assign(__assign({}, notification), { id: newScheduleId, scheduled_at: nextDate, status: 'pending', retry_count: 0, created_at: new Date(), updated_at: new Date(), sent_at: undefined, error_message: undefined });
                        return [4 /*yield*/, this.supabase
                                .from('scheduled_notifications')
    ...
    NotificationScheduler.prototype.createCronJob = function (scheduleId, scheduledAt) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                job = node_cron_1.default.schedule(cronExpression, function () { return __awaiter(_this, void 0, void 0, function () {
