...
export class ChannelProvider {
   ...
   */
  getChannelMetrics(channel: NotificationChannelEnum): ChannelMetrics | undefined {
   ...
   */
  getChannelConfig(channel: NotificationChannelEnum): ChannelConfig | undefined {
  ...
  private initializeChannelConfigs(): void {
    ...
    const defaultConfigs: Record<NotificationChannelEnum, ChannelConfig> = {
      ...
      [NotificationChannelEnum.WHATSAPP]: {
        ...
        priority: 4,
        fallback_channels: [NotificationChannelEnum.SMS, NotificationChannelEnum.EMAIL],
        rate_limit: {
  ...
  private async checkRateLimit(channel: NotificationChannelEnum): Promise<void> {
