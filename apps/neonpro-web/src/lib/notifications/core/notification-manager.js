...
exports.createNotificationManager =
  exports.NotificationManager =
  exports.NotificationPriorityEnum =
  exports.NotificationChannelEnum =
...
var NotificationManager = /** @class */ (() => {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.lgpdManager.checkConsentForNotification(
                config.recipient_id,
                config.channel,
                config.type,
              ),
          ...
          case 9:
            ...
            return [
              4 /*yield*/,
              this.analytics.recordNotificationSent({
                type: config.type,
                channel: config.channel,
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            batchPromises = batch.map((config) =>
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.analytics.recordNotificationEngagement(notificationId, "opened"),
            ];
          case 2:
            // Atualizar analytics
            _a.sent();
  ...
  NotificationManager.prototype.isChannelEnabled = (preferences, channel) => {
    switch (channel) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 4:
            return [2 /*return*/, ((_b.content = _c.sent()), _b)];
          case 5:
            return [2 /*return*/, renderedContent];
        }
      });
    });
  };
              ...
              this.supabase
                ...
                .insert(
                  __assign(__assign({}, config), {
                    status: result.status,
                    sent_at:
                      (_b = result.sent_at) === null || _b === void 0 ? void 0 : _b.toISOString(),
                    delivered_at:
                      (_c = result.delivered_at) === null || _c === void 0
                        ? void 0
                        : _c.toISOString(),
  ...
  NotificationManager.prototype.shouldRetry = (error) => {
    // Implementar lógica de retry baseada no tipo de erro
    var retryableErrors = ["network_error", "timeout", "rate_limit", "temporary_failure"];
        ...
        switch (_d.label) {
          case 0:
            retryDelay = Math.min(
              1000 *
                2 **
                  (((_a = config.metadata) === null || _a === void 0 ? void 0 : _a.retry_count) ||
                    0),
              300000,
            );
            ...
            return [
              ...
              this.scheduleNotification(
                __assign(__assign({}, config), {
                  metadata: __assign(__assign({}, config.metadata), {
                    retry_count:
                      (((_b = config.metadata) === null || _b === void 0
                        ? void 0
                        : _b.retry_count) || 0) + 1,
                    original_attempt:
                      ((_c = config.metadata) === null || _c === void 0
                        ? void 0
                        : _c.original_attempt) || new Date(),
                  }),
                }),
                retryAt,
              ),
...
var createNotificationManager = () => new NotificationManager();
