...
var ChannelProvider = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if (!(channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.enabled)) {
                    ...
                    case 3: return [4 /*yield*/, _b.apply(_a, [(_c.to = _d.sent(),
                                _c.subject = config.data.subject,
                                _c.content = config.data.content,
                                _c.metadata = __assign({ notification_id: config.id, type: config.type, priority: config.priority }, config.metadata),
                                _c)])];
                    case 4:
                        result = _d.sent();
                        // Atualizar métricas
                        return [4 /*yield*/, this.updateMetrics(config.channel, result, Date.now() - startTime)];
                    case 5:
                        // Atualizar métricas
                        _d.sent();
                        // Log de auditoria
    ...
    ChannelProvider.prototype.sendWithFallback = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var channelConfig, fallbackChannels, primaryError_1, _i, fallbackChannels_1, fallbackChannel, fallbackConfig, result, fallbackError_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        channelConfig = this.channelConfigs.get(config.channel);
                        fallbackChannels = (channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.fallback_channels) || [];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 11]);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, healthStatus];
                }
            });
        });
    };
    ...
    ChannelProvider.prototype.initializeChannelConfigs = function () {
        ...
        var defaultConfigs = (_a = {},
            ...
            _a[notification_manager_1.NotificationChannelEnum.WHATSAPP] = {
                ...
                priority: 4,
                fallback_channels: [notification_manager_1.NotificationChannelEnum.SMS, notification_manager_1.NotificationChannelEnum.EMAIL],
                rate_limit: {
        ...
        for (var _i = 0, _b = Object.entries(defaultConfigs); _i < _b.length; _i++) {
            var _c = _b[_i], channel = _c[0], config = _c[1];
            this.channelConfigs.set(channel, config);
        }
    };
    ChannelProvider.prototype.initializeMetrics = function () {
        for (var _i = 0, _a = Object.values(notification_manager_1.NotificationChannelEnum); _i < _a.length; _i++) {
            var channel = _a[_i];
    ...
    ChannelProvider.prototype.updateMetrics = function (channel, result, deliveryTimeMs) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.cost_per_message) {
