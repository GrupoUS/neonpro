...
var NotificationSecurity = /** @class */ (function () {
    function NotificationSecurity(config) {
        ...
        this.securityConfig = __assign({ encryption_enabled: true, data_retention_days: 90, anonymization_enabled: true, audit_enabled: true, rate_limiting: {
                enabled: true,
                max_per_minute: 60,
                max_per_hour: 1000,
                max_per_day: 10000
     ...
     */
    NotificationSecurity.prototype.validateNotificationSecurity = function (notificationData, context) {
        return __awaiter(this, void 0, void 0, function () {
            var violations, riskScore, accessViolations, rateLimitViolations, contentViolations, lgpdViolations, retentionViolations, isValid, recommendations, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        isValid = violations.filter(function (v) { return v.severity === 'critical' || v.severity === 'high'; }).length === 0;
                        recommendations = this.generateSecurityRecommendations(violations);
                        if (!this.securityConfig.audit_enabled) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.logSecurityAudit({
    ...
    NotificationSecurity.prototype.encryptNotificationData = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var sensitiveFields, dataToEncrypt, metadata, _i, sensitiveFields_1, field, encryptedContent, encryptedMetadata, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.encryptionService.decrypt({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.lgpdManager.anonymizeData('notification_logs', {
                                id: notificationId
                            })];
                    case 2:
                        _a.sent();
    ...
    NotificationSecurity.prototype.cleanupExpiredData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cutoffDate, expiredNotifications, deletedCount, anonymizedCount, _i, expiredNotifications_1, notification, error, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        ...
                        _a.label = 8;
                    case 8: return [4 /*yield*/, this.auditLogger.log({
    ...
    NotificationSecurity.prototype.generateSecurityReport = function () {
        return __awaiter(this, arguments, void 0, function (period) {
            var startDate, auditLogs, totalValidations, blockedNotifications, allViolations, totalViolations, averageRiskScore, violationsByType, topViolations, rateLimitData, usersLimited, recommendations, error_9;
            var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        totalValidations = (auditLogs === null || auditLogs === void 0 ? void 0 : auditLogs.length) || 0;
                        blockedNotifications = (auditLogs === null || auditLogs === void 0 ? void 0 : auditLogs.filter(function (log) { return log.action_taken === 'blocked'; }).length) || 0;
                        allViolations = (auditLogs === null || auditLogs === void 0 ? void 0 : auditLogs.flatMap(function (log) { return log.security_violations || []; })) || [];
                        totalViolations = allViolations.length;
                        averageRiskScore = (auditLogs === null || auditLogs === void 0 ? void 0 : auditLogs.length) ?
                            auditLogs.reduce(function (sum, log) { return sum + (log.risk_score || 0); }, 0) / auditLogs.length : 0;
                        ...
                        topViolations = allViolations
                            .filter(function (v) { return v.severity === 'high' || v.severity === 'critical'; })
                            .slice(0, 10);
                        return [4 /*yield*/, this.supabase
                                .from('notification_rate_limits')
                    ...
                    case 2:
                        ...
                        usersLimited = (rateLimitData === null || rateLimitData === void 0 ? void 0 : rateLimitData.filter(function (rl) {
                            return rl.current_minute >= _this.securityConfig.rate_limiting.max_per_minute ||
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/, violations];
                }
            });
        });
    };
                ...
                if (data.created_at) {
                    ...
                    if (daysDiff > this.securityConfig.data_retention_days) {
                        violations.push({
                            type: 'data_retention',
                            severity: 'medium',
                            description: "Dados com ".concat(daysDiff, " dias excedem pol\u00EDtica de reten\u00E7\u00E3o"),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                _loop_1 = function (url) {
                    ...
                    if (suspiciousDomains.some(function (d) { return domain.includes(d); })) {
                        issues.push({
                            type: 'malicious_link',
                            confidence: 0.6,
    ...
    NotificationSecurity.prototype.generateSecurityRecommendations = function (violations) {
        ...
        var criticalCount = violations.filter(function (v) { return v.severity === 'critical'; }).length;
        var highCount = violations.filter(function (v) { return v.severity === 'high'; }).length;
        if (criticalCount > 0) {
        ...
        var piiCount = violations.filter(function (v) { return v.type === 'pii_detected'; }).length;
        if (piiCount > 0) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('security_audit_logs')
                                .insert(__assign(__assign({}, auditData), { timestamp: new Date().toISOString(), metadata: {} }))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
