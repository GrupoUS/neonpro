...
var AutomationEngine = /** @class */ (function () {
    ...
    AutomationEngine.prototype.getActiveRules = function () {
        return Array.from(this.rules.values()).filter(function (rule) { return rule.isActive; });
    };
    // ============================================================================
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log("\uD83D\uDD04 Processando evento ".concat(event.type, " - ").concat(applicableRules.length, " regras aplic\u00E1veis"));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        console.error("\u274C Erro ao executar a\u00E7\u00E3o ".concat(action.type, ":"), error_1);
                        return [3 /*break*/, 6];
                    case 6:
                        _i++;
                        return [3 /*break*/, 2];
                    ...
                    case 9:
                        ...
                        console.log("\u2705 Regra ".concat(rule.name, " executada em ").concat(execution.duration, "ms - ") +
                            "".concat(execution.actionsExecuted, " a\u00E7\u00F5es, ").concat(execution.errors.length, " erros"));
    ...
    AutomationEngine.prototype.evaluateConditions = function (conditions, event) {
        var _this = this;
        return conditions.every(function (condition) { return _this.evaluateCondition(condition, event); });
    };
    /**
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'delay': return [3 /*break*/, 3];
                            case 'webhook': return [3 /*break*/, 5];
                            case 'update_entity': return [3 /*break*/, 7];
                        }
                        return [3 /*break*/, 9];
                    case 1: return [4 /*yield*/, this.executeSendNotificationAction(action, event, rule)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 3: return [4 /*yield*/, this.executeDelayAction(action)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 5: return [4 /*yield*/, this.executeWebhookAction(action, event)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 7: return [4 /*yield*/, this.executeUpdateEntityAction(action, event)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 10];
                    case 9: throw new Error("Tipo de a\u00E7\u00E3o n\u00E3o suportado: ".concat(action.type));
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch(config.url, {
                                ...
                                body: JSON.stringify(__assign({ event: event, timestamp: new Date().toISOString() }, config.payload))
                            })];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
    ...
    AutomationEngine.prototype.getStats = function () {
        ...
        var successfulExecutions = this.executionHistory.filter(function (e) { return e.errors.length === 0; }).length;
        var failedExecutions = totalExecutions - successfulExecutions;
        var totalDuration = this.executionHistory.reduce(function (sum, e) { return sum + e.duration; }, 0);
