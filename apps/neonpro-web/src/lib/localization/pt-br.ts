...
export const ptBRStrings: LocalizationStrings = {
  ...
  status: {
    ...
    saving: (context?: string) => (context ? `Salvando ${context}...` : "Salvando..."),
    saveComplete: (context?: string) =>
      context ? `${context} salvo com sucesso` : "Salvo com sucesso",
    deleting: (context?: string) => (context ? `Excluindo ${context}...` : "Excluindo..."),
    ...
    appointmentScheduled: (patientName?: string) =>
      patientName ? `Consulta agendada para ${patientName}` : "Consulta agendada com sucesso",
    appointmentCanceled: (patientName?: string) =>
      patientName ? `Consulta cancelada para ${patientName}` : "Consulta cancelada",
    appointmentCompleted: (patientName?: string) =>
      patientName ? `Consulta concluída para ${patientName}` : "Consulta concluída",
