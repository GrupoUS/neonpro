...
exports.ptBRStrings = {
  navigation: {
    ...
    goToPage: function (page) {
      return "Ir para p\u00E1gina ".concat(page);
    },
  },
  forms: {
    ...
    fieldRequired: function (field) {
      return "".concat(field, " \u00E9 obrigat\u00F3rio");
    },
    fieldOptional: function (field) {
      return "".concat(field, " \u00E9 opcional");
    },
  ...
  status: {
    ...
    appointmentCanceled: function (patientName) {
      return patientName ? "Consulta cancelada para ".concat(patientName) : "Consulta cancelada";
    },
  ...
  accessibility: {
    openDialog: function (dialogName) {
      return "Abrir di\u00E1logo: ".concat(dialogName);
    },
    closeDialog: "Fechar diálogo",
    expandSection: function (section) {
      return "Expandir se\u00E7\u00E3o: ".concat(section);
    },
    collapseSection: function (section) {
      return "Recolher se\u00E7\u00E3o: ".concat(section);
    },
    ...
    selectedOption: function (option) {
      return "Op\u00E7\u00E3o selecionada: ".concat(option);
    },
    menuExpanded: "Menu expandido",
    menuCollapsed: "Menu recolhido",
    tabSelected: function (tab) {
      return "Aba selecionada: ".concat(tab);
    },
  },
  errors: {
    ...
    requiredField: function (field) {
      return "O campo ".concat(field, " \u00E9 obrigat\u00F3rio");
    },
    ...
    passwordTooShort: function (minLength) {
      return "A senha deve ter pelo menos ".concat(minLength, " caracteres");
    },
...
exports.healthcareAriaLabels = {
  patientCard: function (patientName) {
    return "Cart\u00E3o do paciente ".concat(patientName);
  },
  appointmentCard: function (patientName, date, time) {
    return "Consulta de ".concat(patientName, " em ").concat(date, " \u00E0s ").concat(time);
  },
  treatmentPlan: function (patientName) {
    return "Plano de tratamento de ".concat(patientName);
  },
  medicalHistory: function (patientName) {
    return "Hist\u00F3rico m\u00E9dico de ".concat(patientName);
  },
  vitalSigns: function (patientName) {
    return "Sinais vitais de ".concat(patientName);
  },
  prescriptionList: function (patientName) {
    return "Lista de prescri\u00E7\u00F5es de ".concat(patientName);
  },
  allergyList: function (patientName) {
    return "Lista de alergias de ".concat(patientName);
  },
  appointmentStatus: function (status) {
    return "Status da consulta: ".concat(status);
  },
  patientStatus: function (status) {
    return "Status do paciente: ".concat(status);
  },
  urgencyLevel: function (level) {
    return "N\u00EDvel de urg\u00EAncia: ".concat(level);
  },
};
