      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 5:
            ...
            return [
              2 /*return*/,
              {
                ...
                customer_id: customer.id,
                receipt_url:
                  (_a = paymentIntent.charges.data[0]) === null || _a === void 0
                    ? void 0
                    : _a.receipt_url,
          ...
          case 6:
            ...
            throw new Error(
              "Failed to create card payment: ".concat(
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            throw new Error(
              "Failed to confirm payment: ".concat(
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            throw new Error(
              "Failed to capture payment: ".concat(
      ...
      return __generator(this, (_c) => {
        switch (_c.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              stripe.paymentIntents.retrieve(validatedData.payment_intent_id, {
          ...
          case 2:
            ...
            throw new Error(
              "Failed to get payment status: ".concat(
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            paymentIntent = _b.sent();
            chargeId =
              (_a = paymentIntent.charges.data[0]) === null || _a === void 0 ? void 0 : _a.id;
            if (!chargeId) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.updatePaymentStatus(validatedData.payment_intent_id, "refunded"),
            ];
          case 3:
            // Update payment status in database
            _b.sent();
          ...
          case 5:
            ...
            throw new Error(
              "Failed to process refund: ".concat(
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [3 /*break*/, 9];
          case 1:
            return [4 /*yield*/, this.handlePaymentSucceeded(event.data.object)];
          case 2:
            _b.sent();
            return [3 /*break*/, 10];
          case 3:
            return [4 /*yield*/, this.handlePaymentFailed(event.data.object)];
          case 4:
            _b.sent();
            return [3 /*break*/, 10];
          case 5:
            return [4 /*yield*/, this.handlePaymentCanceled(event.data.object)];
          case 6:
            _b.sent();
            return [3 /*break*/, 10];
          case 7:
            return [4 /*yield*/, this.handleChargeDispute(event.data.object)];
          case 8:
            _b.sent();
            return [3 /*break*/, 10];
          case 9:
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              supabase.from("card_payments").insert({
  ...
  CardPaymentService.storeRefund = function (data) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, supabase.from("card_refunds").insert(data)];
          case 1:
            error = _a.sent().error;
            if (error) {
  ...
  CardPaymentService.storeWebhookEvent = function (data) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, supabase.from("card_webhook_events").insert(data)];
          case 1:
            error = _a.sent().error;
            if (error) {
  ...
  CardPaymentService.handlePaymentSucceeded = function (paymentIntent) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.updatePaymentStatus(paymentIntent.id, "succeeded")];
          case 1:
            _a.sent();
  ...
  CardPaymentService.handlePaymentFailed = function (paymentIntent) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.updatePaymentStatus(paymentIntent.id, "failed")];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
  ...
  CardPaymentService.handlePaymentCanceled = function (paymentIntent) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.updatePaymentStatus(paymentIntent.id, "canceled")];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
