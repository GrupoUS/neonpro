...
var PixIntegration = /** @class */ (function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.generateQRCodeImage(qrCodeData),
          ...
          case 4:
            ...
            throw new Error(
              "PIX payment creation failed: ".concat(
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            return [2 /*return*/, payment.status];
          case 4:
            error_2 = _b.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("pix_payments").update(updateData).eq("id", paymentId),
            ];
          case 1:
            error = _a.sent().error;
            if (error) {
  ...
  PixIntegration.prototype.generatePixQRCode = function (data) {
    ...
    var payload = [
      ...
      "54"
        .concat(String(data.amount.toFixed(2)).padStart(2, "0"))
        .concat(data.amount.toFixed(2)), // Transaction Amount
      "5802BR", // Country Code
      "59"
        .concat(String(data.merchantName.length).padStart(2, "0"))
        .concat(data.merchantName), // Merchant Name
      "60"
        .concat(String(data.merchantCity.length).padStart(2, "0"))
        .concat(data.merchantCity), // Merchant City
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("pix_payments").select("*").eq("id", paymentId).single(),
            ];
          case 1:
            (_a = _b.sent()), (payment = _a.data), (error = _a.error);
            if (error || !payment) {
