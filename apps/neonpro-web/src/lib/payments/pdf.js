      ...
      <renderer_1.Page size="A4" style={styles.page}>
        ...
        <renderer_1.View style={styles.header}>
          ...
          <renderer_1.View style={styles.company}>
            ...
            {data.company.phone && (
              <renderer_1.Text style={styles.text}>{data.company.phone}</renderer_1.Text>
            )}
            {data.company.address && (
              <renderer_1.Text style={styles.text}>{data.company.address}</renderer_1.Text>
            )}
          </renderer_1.View>
        </renderer_1.View>
        ...
        <renderer_1.View style={styles.billToSection}>
          <renderer_1.View style={styles.billToBox}>
            ...
            <renderer_1.Text style={styles.text}>
              Status: {data.status.toUpperCase()}
            </renderer_1.Text>
            {data.paymentTerms && (
              <renderer_1.Text style={styles.text}>Terms: {data.paymentTerms}</renderer_1.Text>
            )}
          </renderer_1.View>
          ...
          <renderer_1.View style={styles.billToBox}>
            ...
            {data.client.phone && (
              <renderer_1.Text style={styles.text}>{data.client.phone}</renderer_1.Text>
            )}
            {data.client.address && (
              <renderer_1.Text style={styles.text}>{data.client.address}</renderer_1.Text>
            )}
          </renderer_1.View>
        </renderer_1.View>
        ...
        <renderer_1.View style={styles.totalSection}>
          ...
          <renderer_1.View style={styles.finalTotal}>
            ...
            <renderer_1.Text style={styles.finalTotalValue}>
