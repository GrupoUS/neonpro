...
var SubscriptionService = /** @class */ (() => {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.getOrCreateStripeCustomer(patient),
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              stripe_1.stripe.paymentMethods.attach(data.paymentMethodId, {
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              stripe_1.stripe.customers.update(stripeCustomerId, {
                invoice_settings: {
          ...
          case 5:
            ...
            return [
              ...
              stripe_1.stripe.subscriptions.create({
                ...
                default_payment_method: data.paymentMethodId,
                metadata: __assign(
                  { patientId: data.patientId, planId: data.planId },
                  data.metadata,
                ),
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              stripe_1.stripe.subscriptions.retrieve(subscription.stripe_subscription_id),
            ];
          case 2:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              stripe_1.stripe.subscriptions.update(subscription.stripe_subscription_id, {
          ...
          case 3:
            return [
              4 /*yield*/,
              stripe_1.stripe.subscriptions.cancel(subscription.stripe_subscription_id),
            ];
          case 4:
            _a.sent();
            _a.label = 5;
  ...
  SubscriptionService.prototype.updateSubscriptionPlan = function (subscriptionId_1, newPlanId_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (subscriptionId, newPlanId, prorationBehavior) {
        var subscription,
          newPlan,
          stripeSubscription,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 5:
              ...
              return [
                2 /*return*/,
                this.formatSubscriptionStatus(updatedSubscription, updatedStripeSubscription),
              ];
            case 6:
              error_4 = _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              stripe_1.stripe.customers.create({
                email: patient.email,
                name: patient.name,
                metadata: {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("stripe_customers").insert({
