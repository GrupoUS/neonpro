...
var SubscriptionManager = /** @class */ (() => {
        ...
        switch (_c.label) {
          ...
          case 3:
            subscriptionData = {
              ...
              trial_start:
                trialStart === null || trialStart === void 0 ? void 0 : trialStart.toISOString(),
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              this.logBillingEvent(data.id, "subscription_created", {
                plan_id: params.plan_id,
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              this.sendSubscriptionNotification(data.id, "subscription_created"),
            ];
          case 7:
            // Send welcome notification
            _c.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.calculateProration(subscriptionId, subscription.plan_id, params.plan_id),
            ];
          case 3:
            proration = _b.sent();
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              this.updateStripeSubscription(subscription.stripe_subscription_id, {
          ...
          case 9:
            return [
              4 /*yield*/,
              this.logBillingEvent(subscriptionId, "cancellation_scheduled", {
          ...
          case 12:
            ...
            _b.label = 13;
          case 13:
            return [4 /*yield*/, this.logBillingEvent(subscriptionId, "cancellation_removed", {})];
          case 14:
            _b.sent();
            _b.label = 15;
          case 15:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            return [
              4 /*yield*/,
              this.logBillingEvent(subscriptionId, "subscription_canceled_immediate", {}),
            ];
          case 4:
            _b.sent();
            return [3 /*break*/, 9];
          ...
          case 7:
            return [
              4 /*yield*/,
              this.logBillingEvent(subscriptionId, "subscription_canceled_scheduled", {
                cancel_at: subscription.current_period_end,
              }),
            ];
          case 8:
  ...
  // Helper Methods
  SubscriptionManager.prototype.calculateNextBillingDate = (startDate, billingCycle) => {
    switch (billingCycle) {
      case "monthly":
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (
              !(customer === null || customer === void 0 ? void 0 : customer.stripe_customer_id)
            ) {
  ...
  SubscriptionManager.prototype.calculateProration = function (
    subscriptionId,
    oldPlanId,
    newPlanId,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("proration_calculations").insert({
  ...
  SubscriptionManager.prototype.extractUsageLimit = (features, usageType) => {
    var feature = features.find((f) => f.toLowerCase().includes(usageType));
  ...
  SubscriptionManager.prototype.sendSubscriptionNotification = function (
    subscriptionId,
    notificationType,
  ) {
    return __awaiter(this, void 0, void 0, function () {
