...
var RecurringPaymentProcessor = /** @class */ (function () {
    function RecurringPaymentProcessor(config) {
        ...
        this.config = __assign({ max_retry_attempts: 4, retry_intervals_hours: [24, 72, 168, 336], dunning_management: {
                grace_period_days: 3,
    ...
    RecurringPaymentProcessor.prototype.processBillingCycle = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, dueSubscriptions, _i, dueSubscriptions_1, subscription, paymentResult, error_1, errorMessage, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        logger_1.logger.info("Found ".concat(dueSubscriptions.length, " subscriptions due for billing"));
                    ...
                    case 8:
                        _a.sent();
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, this.handleFinalPaymentFailure(subscription.id, paymentResult)];
                    case 10:
                        _a.sent();
                        _a.label = 11;
                    ...
                    case 12:
                        error_1 = _a.sent();
                        errorMessage = "Error processing subscription ".concat(subscription.id, ": ").concat(error_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                        return [4 /*yield*/, subscription_manager_1.subscriptionManager.getSubscription(subscriptionId)];
                    case 1:
                        subscription = _a.sent();
                        if (!subscription) {
                            throw new Error('Subscription not found');
                        }
                        return [4 /*yield*/, subscription_manager_1.subscriptionManager.getSubscriptionPlan(subscription.plan_id)];
                    case 2:
                        plan = _a.sent();
                        if (!plan) {
                    ...
                    case 4: return [4 /*yield*/, this.processStripePayment(subscription, plan)];
                    case 5: 
                    // Process Stripe payment
                    return [2 /*return*/, _a.sent()];
                    case 6:
                        error_3 = _a.sent();
                        logger_1.logger.error("Error processing payment for subscription ".concat(subscriptionId, ":"), error_3);
                        return [2 /*return*/, {
                                success: false,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 7, , 8]);
                        return [4 /*yield*/, this.stripe.subscriptions.retrieve(subscription.stripe_subscription_id, { expand: ['latest_invoice', 'latest_invoice.payment_intent'] })];
                    case 1:
                        ...
                        if (!(paymentIntent && paymentIntent.status === 'requires_payment_method')) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.stripe.customers.retrieve(stripeSubscription.customer)];
                    case 2:
                        customer = _c.sent();
                        if (!((_a = customer.invoice_settings) === null || _a === void 0 ? void 0 : _a.default_payment_method)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.stripe.paymentIntents.confirm(paymentIntent.id, {
                                payment_method: customer.invoice_settings.default_payment_method
                            })];
                    case 3:
                        _c.sent();
                        _c.label = 4;
                    case 4: return [4 /*yield*/, this.stripe.paymentIntents.retrieve(paymentIntent.id)];
                    case 5:
                        ...
                        if (updatedPaymentIntent.status === 'succeeded') {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    payment_intent_id: updatedPaymentIntent.id,
                                    error_message: ((_b = updatedPaymentIntent.last_payment_error) === null || _b === void 0 ? void 0 : _b.message) || 'Payment failed',
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!customer || !((_a = customer.payment_methods) === null || _a === void 0 ? void 0 : _a.length)) {
                            return [2 /*return*/, {
                                    success: false,
                        ...
                        defaultPaymentMethod = customer.payment_methods.find(function (pm) { return pm.is_default; }) || customer.payment_methods[0];
                        return [4 /*yield*/, this.paymentProcessor.processPayment({
    ...
    RecurringPaymentProcessor.prototype.schedulePaymentRetry = function (subscriptionId, paymentResult) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        currentAttempt = ((_a = existingRetries === null || existingRetries === void 0 ? void 0 : existingRetries[0]) === null || _a === void 0 ? void 0 : _a.attempt_count) || 0;
                    ...
                    case 2:
                        ...
                        return [2 /*return*/];
                    case 3:
                        retryHours = this.config.retry_intervals_hours[nextAttempt - 1] ||
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.sendPaymentRetryNotification(subscriptionId, nextAttempt, nextRetryDate)];
                    case 5:
                        _b.sent();
                        _b.label = 6;
                    case 6:
                        logger_1.logger.info("Payment retry scheduled for subscription ".concat(subscriptionId, ", attempt ").concat(nextAttempt));
                        return [3 /*break*/, 8];
                    case 7:
                        error_6 = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        logger_1.logger.info("Processing ".concat(dueRetries.length, " scheduled payment retries"));
                    ...
                    case 6:
                        ...
                        _a.sent();
                        result.successful_payments++;
                        return [4 /*yield*/, this.handleSuccessfulPayment(retry.subscription_id, paymentResult)];
                    case 7:
                        _a.sent();
                        return [3 /*break*/, 13];
                    case 8: 
                    ...
                    case 10:
                        ...
                        result.retry_scheduled++;
                        return [3 /*break*/, 13];
                    case 11: return [4 /*yield*/, this.handleFinalPaymentFailure(retry.subscription_id, paymentResult)];
                    case 12:
                        _a.sent();
                        _a.label = 13;
    ...
    RecurringPaymentProcessor.prototype.handleSuccessfulPayment = function (subscriptionId, paymentResult) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.createPaymentRecord(subscriptionId, paymentResult, 'completed')];
                    case 4:
                        // Create payment record
                        _a.sent();
                        // Reset usage tracking for new period
                        return [4 /*yield*/, this.resetUsageTracking(subscriptionId, nextPeriodStart, nextPeriodEnd)];
                    case 5:
                        // Reset usage tracking for new period
                        _a.sent();
                    ...
                    case 6:
                        ...
                        _a.label = 7;
                    case 7:
                        logger_1.logger.info("Successful payment processed for subscription ".concat(subscriptionId));
                        return [3 /*break*/, 9];
                    case 8:
                        error_9 = _a.sent();
    ...
    RecurringPaymentProcessor.prototype.handleFinalPaymentFailure = function (subscriptionId, paymentResult) {
        return __awaiter(this, void 0, void 0, function () {
            var error_10;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.sendPaymentFailureNotification(subscriptionId, paymentResult.error_message)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
                        logger_1.logger.info("Final payment failure handled for subscription ".concat(subscriptionId));
                        return [3 /*break*/, 6];
                    case 5:
                        error_10 = _a.sent();
    ...
    RecurringPaymentProcessor.prototype.updateSubscriptionStatuses = function () {
        return __awaiter(this, void 0, void 0, function () {
            var now, gracePeriodDate, suspensionDate, cancellationDate, subscriptionsToCancel, _i, _a, subscription, subscriptionsToSuspend, _b, _c, subscription, error_11;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 13, , 14]);
                        now = new Date();
                        gracePeriodDate = new Date(now.getTime() - (this.config.dunning_management.grace_period_days * 24 * 60 * 60 * 1000));
                        suspensionDate = new Date(now.getTime() - (this.config.dunning_management.suspension_after_days * 24 * 60 * 60 * 1000));
                        cancellationDate = new Date(now.getTime() - (this.config.dunning_management.cancellation_after_days * 24 * 60 * 60 * 1000));
                        return [4 /*yield*/, this.supabase
                                .from('subscriptions')
                                .select('*')
                                .eq('status', 'past_due')
                    ...
                    case 2:
                        ...
                        subscription = _a[_i];
                        return [4 /*yield*/, subscription_manager_1.subscriptionManager.cancelSubscription(subscription.id, true)];
                    case 3:
                        _d.sent();
    ...
    RecurringPaymentProcessor.prototype.calculateNextBillingDate = function (startDate, billingCycle) {
        switch (billingCycle) {
            case 'monthly':
    ...
    RecurringPaymentProcessor.prototype.createPaymentRecord = function (subscriptionId, paymentResult, status) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        subscription = _a.sent();
                        return [4 /*yield*/, subscription_manager_1.subscriptionManager.getSubscriptionPlan(subscription === null || subscription === void 0 ? void 0 : subscription.plan_id)];
                    case 2:
                        plan = _a.sent();
    ...
    RecurringPaymentProcessor.prototype.resetUsageTracking = function (subscriptionId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RecurringPaymentProcessor.prototype.sendPaymentRetryNotification = function (subscriptionId, attemptNumber, nextRetryDate) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RecurringPaymentProcessor.prototype.sendPaymentSuccessNotification = function (subscriptionId, amount) {
        return __awaiter(this, void 0, void 0, function () {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, notification_service_1.sendNotification)({
                                ...
                                data: {
                                    ...
                                    amount: amount,
                                    plan_name: (_a = subscription.plan) === null || _a === void 0 ? void 0 : _a.name,
                                    next_billing_date: (0, date_fns_1.format)(new Date(subscription.current_period_end), 'PPP')
                                }
                            })];
                    case 2:
                        _b.sent();
    ...
    RecurringPaymentProcessor.prototype.sendPaymentFailureNotification = function (subscriptionId, errorMessage) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RecurringPaymentProcessor.prototype.sendSubscriptionSuspendedNotification = function (subscriptionId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RecurringPaymentProcessor.prototype.sendSubscriptionCanceledNotification = function (subscriptionId) {
        return __awaiter(this, void 0, void 0, function () {
