...
var SubscriptionBillingService = /** @class */ (() => {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("subscription_plans").select("*").eq("id", planId).single(),
            ];
          case 1:
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("subscriptions").insert(subscriptionData).select().single(),
            ];
          case 4:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.syncSubscriptionWithStripe(subscriptionId, stripeSubscription),
            ];
          case 3:
            // Update local subscription with Stripe data
            _b.sent();
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.logBillingEvent(subscriptionId, "billing_cycle_processed", {
   ...
   */
  SubscriptionBillingService.prototype.handleFailedPayment = function (
    subscriptionId,
    paymentIntentId,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [2 /*return*/];
          case 3:
            retryDate = (0, date_fns_1.addDays)(
              new Date(),
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.sendPaymentFailureNotification(subscriptionId, currentAttempt),
            ];
          case 5:
            // Send notification to customer
            _b.sent();
   ...
   */
  SubscriptionBillingService.prototype.calculateProratedBilling = function (
    subscriptionId_1,
    newPlanId_1,
  ) {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("subscription_plans").select("*").eq("id", newPlanId).single(),
            ];
          case 2:
   ...
   */
  SubscriptionBillingService.prototype.changeSubscriptionPlan = function (
    subscriptionId_1,
    newPlanId_1,
  ) {
      ...
      return __generator(this, function (_j) {
        switch (_j.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.calculateProratedBilling(subscriptionId, newPlanId, effectiveDate),
            ];
          case 1:
          ...
          case 2:
            return [
              4 /*yield*/,
              this.supabase.from("subscriptions").select("*").eq("id", subscriptionId).single(),
            ];
          case 3:
          ...
          case 5:
            return [
              ...
              _d.apply(
                ...
                _e.concat([
                  ((_g.items = [
                    ((_h.id = _j.sent().items.data[0].id),
                    (_h.price = newPlan.stripe_price_id),
                    _h),
                  ]),
                  (_g.proration_behavior =
          ...
          case 8:
            ...
            return [
              4 /*yield*/,
              this.logBillingEvent(subscriptionId, "plan_changed", {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              this.logBillingEvent(subscriptionId, "subscription_canceled", {
  ...
  SubscriptionBillingService.prototype.syncSubscriptionWithStripe = function (
    subscriptionId,
    stripeSubscription,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.logBillingEvent(subscriptionId, "max_retries_reached", {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.logBillingEvent(subscriptionId, "billing_error", {
  ...
  SubscriptionBillingService.prototype.logBillingEvent = function (
    subscriptionId,
    eventType,
    data,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("billing_events").insert({
                subscription_id: subscriptionId,
  ...
  SubscriptionBillingService.prototype.sendPaymentFailureNotification = function (
    subscriptionId,
    attemptCount,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, (_a) => {
        ...
        console.log(
          "Sending payment failure notification for subscription "
