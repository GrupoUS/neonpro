...
var DelinquencyManager = /** @class */ (() => {
            ...
            overdueInvoices === null || overdueInvoices === void 0
              ...
              : overdueInvoices.forEach((invoice) => {
                  ...
                  overduePayments_1.push({
                    ...
                    type: "invoice",
                    status: "overdue",
                    riskLevel: _this.calculateRiskLevel(
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.rpc("get_customer_payment_history", { customer_id: customerId }),
            ];
          case 1:
            (_a = _b.sent()), (paymentHistory = _a.data), (error = _a.error);
            if (error) throw error;
            totalPayments =
              (paymentHistory === null || paymentHistory === void 0
                ? void 0
                : paymentHistory.total_payments) || 0;
            onTimePayments =
              (paymentHistory === null || paymentHistory === void 0
                ? void 0
                : paymentHistory.on_time_payments) || 0;
            latePayments =
              (paymentHistory === null || paymentHistory === void 0
                ? void 0
                : paymentHistory.late_payments) || 0;
            averageDelayDays =
              (paymentHistory === null || paymentHistory === void 0
                ? void 0
                : paymentHistory.average_delay_days) || 0;
            riskScore = 0;
            ...
            return [
              4 /*yield*/,
              this.supabase.from("customer_risk_profiles").upsert({
   ...
   */
  DelinquencyManager.prototype.sendNotification = function (
    customerId,
    type,
    channel,
    templateId,
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("delinquency_notifications").insert({
                customer_id: customerId,
                type: type,
                channel: channel,
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.rpc("get_delinquency_statistics", {
                start_date:
                  (_b = dateRange === null || dateRange === void 0 ? void 0 : dateRange.from) ===
                    null || _b === void 0
                    ? void 0
                    : _b.toISOString(),
                end_date:
                  (_c = dateRange === null || dateRange === void 0 ? void 0 : dateRange.to) ===
                    null || _c === void 0
                    ? void 0
                    : _c.toISOString(),
              }),
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              {
                ...
                averageDaysOverdue:
                  (data === null || data === void 0 ? void 0 : data.average_days_overdue) || 0,
                riskDistribution:
                  (data === null || data === void 0 ? void 0 : data.risk_distribution) || {},
                recoveryRate: (data === null || data === void 0 ? void 0 : data.recovery_rate) || 0,
                collectionEfficiency:
                  (data === null || data === void 0 ? void 0 : data.collection_efficiency) || 0,
              },
            ];
          case 2:
            error_6 = _d.sent();
  ...
  DelinquencyManager.prototype.calculateRiskLevel = (riskProfile, daysOverdue) => {
    ...
    return (
      (riskProfile === null || riskProfile === void 0 ? void 0 : riskProfile.risk_level) || "low"
    );
  };
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("delinquency_rules").select("*").eq("is_active", true),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("scheduled_notifications").insert({
  ...
  DelinquencyManager.prototype.sendEmailNotification = function (customer, template, metadata) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!this.emailTransporter) return [2 /*return*/, false];
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
