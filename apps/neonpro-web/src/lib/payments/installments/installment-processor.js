...
var InstallmentProcessor = /** @class */ (function () {
    function InstallmentProcessor(config) {
        this.config = __assign({ retryAttempts: 3, lateFeePercentage: 2.0, gracePeriodDays: 3 }, config);
     ...
     */
    InstallmentProcessor.prototype.processInstallmentPayment = function (installmentId, paymentMethodId, customerId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, installment, installmentError, customer, stripeCustomerId, lateFee, totalAmount, finalPaymentMethodId, defaultPaymentMethod, paymentIntent, updateError, error_1;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (installmentError || !installment) {
                            throw new Error("Installment not found: ".concat(installmentError === null || installmentError === void 0 ? void 0 : installmentError.message));
                        }
                    ...
                    case 3:
                        ...
                        finalPaymentMethodId = defaultPaymentMethod === null || defaultPaymentMethod === void 0 ? void 0 : defaultPaymentMethod.id;
                        _b.label = 4;
                    case 4:
                        ...
                        return [4 /*yield*/, this.stripe.paymentIntents.create({
                                ...
                                confirm: true,
                                return_url: "".concat(process.env.NEXT_PUBLIC_APP_URL, "/payments/installments/").concat(installmentId, "/success"),
                                metadata: {
    ...
    InstallmentProcessor.prototype.processBulkInstallments = function (installmentIds_1) {
        return __awaiter(this, arguments, void 0, function (installmentIds, options) {
            var _a, maxConcurrent, results, errors, totalAmount, totalLateFees, successful, failed, i, batch, batchPromises, batchResults;
            var _this = this;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        batchPromises = batch.map(function (installmentId) { return __awaiter(_this, void 0, void 0, function () {
                            var result;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.processInstallmentPayment(installmentId, options.paymentMethodId, options.customerId)];
                                    case 1:
                                        result = _a.sent();
                                        if (result.success) {
                                            successful++;
    ...
    InstallmentProcessor.prototype.processOverdueInstallments = function () {
        return __awaiter(this, arguments, void 0, function (options) {
            var _a, maxDaysOverdue, _b, maxInstallments, _c, dryRun, _d, overdueInstallments, error, simulatedResults, installmentIds, error_2;
            if (options === void 0) { options = {}; }
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _a = options.maxDaysOverdue, maxDaysOverdue = _a === void 0 ? 30 : _a, _b = options.maxInstallments, maxInstallments = _b === void 0 ? 100 : _b, _c = options.dryRun, dryRun = _c === void 0 ? false : _c;
                        _e.label = 1;
                    case 1:
                        _e.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.supabase
                    ...
                    case 2:
                        ...
                        if (dryRun) {
                            simulatedResults = overdueInstallments.map(function (installment) { return ({
                                success: true,
                            ...
                            return [2 /*return*/, {
                                    ...
                                    summary: {
                                        totalAmount: overdueInstallments.reduce(function (sum, i) { return sum + i.amount; }, 0),
                                        totalLateFees: overdueInstallments.reduce(function (sum, i) { return sum + (i.late_fee || 0); }, 0),
                                        errors: []
                                    }
                                }];
                        }
                        installmentIds = overdueInstallments.map(function (i) { return i.id; });
     ...
     */
    InstallmentProcessor.prototype.markInstallmentAsPaid = function (installmentId, paymentIntentId, paymentMethod) {
        return __awaiter(this, void 0, void 0, function () {
            var error;
            return __generator(this, function (_a) {
                switch (_a.label) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error || !installment) {
                            throw new Error("Installment not found: ".concat(error === null || error === void 0 ? void 0 : error.message));
                        }
                        if (installment.status === 'paid') {
                            return [2 /*return*/, {
                                    success: false,
                    ...
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.stripe.paymentIntents.cancel(installment.stripe_payment_intent_id)];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5: return [4 /*yield*/, this.processInstallmentPayment(installmentId, paymentMethodId, installment.payment_plans.customers.stripe_customer_id)];
                    case 6: 
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 5: return [4 /*yield*/, this.handlePaymentIntentCanceled(event.data.object)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 7:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.markInstallmentAsPaid(installmentId, paymentIntent.id, 'stripe')];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('installments')
                                .update({
                                metadata: __assign(__assign({}, paymentIntent.metadata), { last_payment_error: ((_a = paymentIntent.last_payment_error) === null || _a === void 0 ? void 0 : _a.message) || 'Payment failed', failed_at: new Date().toISOString() }),
                                updated_at: new Date().toISOString()
                            })
                                .eq('id', installmentId)];
                    case 1:
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                metadata: __assign(__assign({}, paymentIntent.metadata), { canceled_at: new Date().toISOString() }),
                                updated_at: new Date().toISOString()
                            })
                                .eq('id', installmentId)];
                    case 1:
