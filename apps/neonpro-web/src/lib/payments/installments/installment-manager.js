...
var InstallmentManager = /** @class */ (function () {
    ...
    InstallmentManager.prototype.createPaymentPlan = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, customer, customerError, installmentAmount, adjustedTotal, paymentPlan, _b, createdPlan, planError, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        installmentAmount = Math.round((request.total_amount / request.installment_count) * 100) / 100;
                        ...
                        paymentPlan = {
                            ...
                            metadata: __assign(__assign({}, request.metadata), { auto_charge: request.auto_charge || false, late_fee_percentage: request.late_fee_percentage || 0, grace_period_days: request.grace_period_days || 0, created_by: 'system' })
                        };
                        return [4 /*yield*/, supabase
                                .from('payment_plans')
                                .insert(paymentPlan)
                    ...
                    case 3:
                        // Generate installments
                        _c.sent();
                        logger_1.logger.info("Payment plan created: ".concat(createdPlan.id, " for customer: ").concat(request.customer_id));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        logger_1.logger.info("Generated ".concat(installments.length, " installments for payment plan: ").concat(paymentPlanId));
                        return [3 /*break*/, 3];
                    case 2:
                        error_2 = _a.sent();
    ...
    InstallmentManager.prototype.processInstallmentPayment = function (installmentId, paymentMethodId, metadata) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, installment, installmentError, customer, totalAmount, lateFeePercentage, lateFee, paymentIntent, error_3;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        lateFeePercentage = ((_b = installment.payment_plan.metadata) === null || _b === void 0 ? void 0 : _b.late_fee_percentage) || 0;
                    ...
                    case 2:
                        ...
                        _c.sent();
                        _c.label = 3;
                    case 3: return [4 /*yield*/, stripe.paymentIntents.create({
                            ...
                            metadata: __assign({ installment_id: installmentId, payment_plan_id: installment.payment_plan_id, installment_number: installment.installment_number.toString() }, metadata),
                            description: "Installment ".concat(installment.installment_number, "/").concat(installment.payment_plan.installment_count, " - ").concat(installment.payment_plan.description || 'Payment Plan')
                        })];
                    case 4:
    ...
    InstallmentManager.prototype.markInstallmentAsPaid = function (installmentId, paymentIntentId, paymentMethod) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(installments && installments.every(function (inst) { return inst.status === 'paid'; }))) return [3 /*break*/, 3];
                        return [4 /*yield*/, supabase
                                .from('payment_plans')
                                .update({
                                status: 'completed',
    ...
    InstallmentManager.prototype.getOverdueInstallments = function () {
        return __awaiter(this, arguments, void 0, function (gracePeriodDays) {
            ...
            if (gracePeriodDays === void 0) { gracePeriodDays = 0; }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        installmentIds = overdueInstallments.map(function (inst) { return inst.id; });
                        return [4 /*yield*/, supabase
                                .from('installments')
                                .update({
                                status: 'overdue',
                    ...
                    case 2:
                        ...
                        logger_1.logger.info("Marked ".concat(overdueInstallments.length, " installments as overdue"));
    ...
    InstallmentManager.prototype.modifyPaymentPlan = function (paymentPlanId, modifications) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, currentPlan, planError, paidInstallments, paidCount, paidAmount, remainingAmount, remainingInstallments, newInstallmentAmount, lastPaidInstallment, nextDueDate, newInstallments, i, updatedPlan, _b, result, updateError, error_8;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 8, , 9]);
                    ...
                    case 2:
                        ...
                        paidCount = (paidInstallments === null || paidInstallments === void 0 ? void 0 : paidInstallments.length) || 0;
                        if (!(modifications.installment_count && modifications.installment_count !== currentPlan.installment_count)) return [3 /*break*/, 6];
                    ...
                    case 3:
                        ...
                        newInstallmentAmount = Math.round((remainingAmount / remainingInstallments) * 100) / 100;
                        return [4 /*yield*/, supabase
                                .from('installments')
                                .select('due_date')
                                .eq('payment_plan_id', paymentPlanId)
                    ...
                    case 5:
                        ...
                        _c.label = 6;
                    case 6:
                        updatedPlan = __assign(__assign(__assign({}, currentPlan), modifications), { metadata: __assign(__assign(__assign({}, currentPlan.metadata), modifications.metadata), { modified_at: new Date().toISOString() }), updated_at: new Date().toISOString() });
                        return [4 /*yield*/, supabase
                                .from('payment_plans')
                                .update(updatedPlan)
                                .eq('id', paymentPlanId)
