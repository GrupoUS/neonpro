...
export class BankReconciliationService {
   ...
   */
  static async getReconciliationSummary(bankAccountId: string, startDate: string, endDate: string) {
    try {
      const { data: summary, error } = await supabase.rpc("get_reconciliation_summary", {
