...
var BankReconciliationManager = /** @class */ (() => {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("bank_statements").insert(validatedStatement).select().single(),
            ];
          case 1:
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("bank_transactions").insert(validatedTransactions).select(),
            ];
          case 4:
            (_b = _c.sent()), (data = _b.data), (error = _b.error);
            if (error) {
              importResult.errors.push(
                "Batch ".concat(Math.floor(i / batchSize) + 1, ": ").concat(error.message),
              );
          ...
          case 5:
            ...
            importResult.errors.push(
              "Validation error in batch "
                .concat(Math.floor(i / batchSize) + 1, ": ")
                .concat(validationError_1),
            );
            importResult.failed_transactions += batch.length;
            return [3 /*break*/, 6];
          case 6:
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            return [
              ...
              this.supabase
                ...
                .update({
                  ...
                  notes: "Auto-matched using criteria: ".concat(
                    matchResult.matching_criteria.join(", "),
                  ),
                })
          ...
          case 6:
            ...
            return [3 /*break*/, 3];
          case 7:
            return [2 /*return*/, matchingResults];
          case 8:
            error_2 = _c.sent();
            throw new Error(
              "Auto matching failed: ".concat(
   ...
   */
  BankReconciliationManager.prototype.calculateMatchingConfidence = function (
    transaction,
    payment,
    rules,
  ) {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("bank_statements").select("*").eq("id", statementId).single(),
            ];
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("bank_transactions").select("*").eq("statement_id", statementId),
            ];
          case 2:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("reconciliation_discrepancies").insert(discrepancies),
            ];
          case 3:
            ...
            _d.label = 4;
          case 4:
            return [2 /*return*/, discrepancies];
          case 5:
            error_4 = _d.sent();
            throw new Error(
              "Discrepancy detection failed: ".concat(
  ...
  BankReconciliationManager.prototype.findDuplicateTransactions = (transactions) => {
    ...
    for (var _i = 0, transactions_2 = transactions; _i < transactions_2.length; _i++) {
      ...
      var key = ""
        .concat(transaction.transaction_date, "_")
        .concat(transaction.credit_amount || transaction.debit_amount, "_")
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 3:
            error_5 = _c.sent();
            throw new Error(
              "Failed to get reconciliation summary: ".concat(
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("reconciliation_rules").insert(validatedRule).select().single(),
            ];
          case 1:
