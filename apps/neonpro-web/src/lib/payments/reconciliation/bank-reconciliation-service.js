...
var BankReconciliationService = /** @class */ (function () {
     ...
     */
    BankReconciliationService.importBankStatement = function (csvContent, bankAccountId, mapping, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var validatedMapping, records, transactions, errors, i, record, dateStr, parsedDate, amountStr, amount, type, typeValue, transaction, _a, insertedTransactions, insertError, matchingResult, error_1;
                        ...
                        for (i = 0; i < records.length; i++) {
                            try {
                                ...
                                if (validatedMapping.type_column && record[validatedMapping.type_column]) {
                                    ...
                                    if (validatedMapping.debit_indicator && typeValue.includes(validatedMapping.debit_indicator.toLowerCase())) {
                                        type = 'debit';
                                    }
                                    else if (validatedMapping.credit_indicator && typeValue.includes(validatedMapping.credit_indicator.toLowerCase())) {
                                        type = 'credit';
                                    }
                                }
                                else {
                                ...
                                transaction = {
                                    ...
                                    type: type,
                                    reference: validatedMapping.reference_column ? record[validatedMapping.reference_column] : undefined,
                                ...
                                errors.push("Row ".concat(i + 1, ": ").concat(error instanceof Error ? error.message : 'Unknown error'));
                            }
                        }
    ...
    BankReconciliationService.performAutomaticMatching = function (transactions, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var matched_transactions, unmatched_transactions, ninetyDaysAgo, _a, payments, paymentsError, pixPayments, cardPayments, allPayments, _i, transactions_1, transaction, matches, bestMatch;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        if (paymentsError) {
                            ...
                            return [2 /*return*/, { matched_transactions: matched_transactions, unmatched_transactions: transactions }];
                        }
                        return [4 /*yield*/, supabase
                                .from('pix_payments')
                    ...
                    case 3:
                        ...
                        allPayments = __spreadArray(__spreadArray(__spreadArray([], (payments || []).map(function (p) {
                            var _a, _b;
                            return ({
                                id: p.id,
                                amount: p.amount,
                                ...
                                customer_name: (_a = p.ap_payables) === null || _a === void 0 ? void 0 : _a.supplier_name,
                                description: (_b = p.ap_payables) === null || _b === void 0 ? void 0 : _b.description,
                                status: 'completed',
                            });
                        }), true), (pixPayments || []).map(function (p) { return ({
                            id: p.id,
                            amount: p.amount,
                            payment_date: p.payment_date,
                            payment_method: 'pix',
                            ...
                            status: 'completed',
                        }); }), true), (cardPayments || []).map(function (p) { return ({
                            id: p.id,
                            amount: p.amount,
                            payment_date: p.payment_date,
                            payment_method: 'card',
                    ...
                    case 10:
                        _i++;
                        return [3 /*break*/, 4];
                    case 11: return [2 /*return*/, { matched_transactions: matched_transactions, unmatched_transactions: unmatched_transactions }];
                }
            });
        });
    };
    ...
    BankReconciliationService.findPaymentMatches = function (transaction, payments) {
        ...
        for (var _i = 0, payments_1 = payments; _i < payments_1.length; _i++) {
            ...
            if (transaction.reference && payment.reference_id) {
                ...
                else if (transaction.reference.includes(payment.reference_id) ||
            ...
            if (payment.customer_name && transaction.description) {
                var similarity = this.calculateStringSimilarity(transaction.description.toLowerCase(), payment.customer_name.toLowerCase());
                score += similarity * 0.1;
            }
        ...
        return matches.sort(function (a, b) { return b.confidence_score - a.confidence_score; });
    };
    /**
     ...
     */
    BankReconciliationService.getReconciliationSummary = function (bankAccountId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
