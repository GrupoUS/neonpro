...
exports.communicationSystem = exports.CommunicationSystem = exports.CommunicationAnalytics = exports.WaitlistManager = exports.NoShowPredictor = exports.TemplateEngine = exports.WhatsAppProvider = exports.EmailProvider = exports.SMSProvider = exports.CommunicationService = void 0;
// Core types
__exportStar(require("./types"), exports);
// Main communication service
var communication_service_1 = require("./communication-service");
Object.defineProperty(exports, "CommunicationService", { enumerable: true, get: function () { return communication_service_1.CommunicationService; } });
...
Object.defineProperty(exports, "WhatsAppProvider", { enumerable: true, get: function () { return whatsapp_provider_1.WhatsAppProvider; } });
// Template engine
...
Object.defineProperty(exports, "NoShowPredictor", { enumerable: true, get: function () { return no_show_predictor_1.NoShowPredictor; } });
// Waitlist management
var waitlist_manager_1 = require("./waitlist-manager");
Object.defineProperty(exports, "WaitlistManager", { enumerable: true, get: function () { return waitlist_manager_1.WaitlistManager; } });
// Analytics and insights
var analytics_1 = require("./analytics");
Object.defineProperty(exports, "CommunicationAnalytics", { enumerable: true, get: function () { return analytics_1.CommunicationAnalytics; } });
/**
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                errors: results.filter(function (r) { return !r.success; }).map(function (r) { return r.error || 'Unknown error'; })
                            }];
                    case 2:
                        error_2 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, {
                                notified: results.filter(function (r) { return r.notification_sent; }).length,
                                failed: results.filter(function (r) { return !r.notification_sent; }).length,
                                errors: results.filter(function (r) { return !r.notification_sent; }).map(function (r) { return r.error || 'Unknown error'; })
                            }];
                    case 2:
                        error_3 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.noShowPredictor.batchPredict({
                                startDate: new Date(),
