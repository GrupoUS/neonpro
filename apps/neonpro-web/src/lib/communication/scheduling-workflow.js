...
var SchedulingCommunicationWorkflow = /** @class */ (function () {
    ...
    SchedulingCommunicationWorkflow.prototype.initializeWorkflows = function (appointmentId, config) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, appointment, appointmentError, workflowConfig, workflows, appointmentDate, now, reminderTime24h, _b, _c, reminderTime2h, _d, _e, reminderTime30m, _f, _g, confirmationTime, _h, _j, prediction, interventionTime, _k, _l, _i, workflows_1, workflow, error_1;
            return __generator(this, function (_m) {
                switch (_m.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.createReminderWorkflow(appointment, '24h', reminderTime24h, workflowConfig)];
                    case 3:
                        _c.apply(_b, [_m.sent()]);
                        _m.label = 4;
                    case 4:
                        ...
                        return [4 /*yield*/, this.createReminderWorkflow(appointment, '2h', reminderTime2h, workflowConfig)];
                    case 5:
                        _e.apply(_d, [_m.sent()]);
                        _m.label = 6;
                    case 6:
                        ...
                        return [4 /*yield*/, this.createReminderWorkflow(appointment, '30m', reminderTime30m, workflowConfig)];
                    case 7:
                        _g.apply(_f, [_m.sent()]);
                        _m.label = 8;
                    case 8:
                        if (!workflowConfig.confirmationSettings.enableConfirmationRequests) return [3 /*break*/, 10];
                        confirmationTime = this.calculateConfirmationTime(appointmentDate, workflowConfig.confirmationSettings.sendTime);
                        if (!(confirmationTime > now)) return [3 /*break*/, 10];
                        _j = (_h = workflows).push;
                        return [4 /*yield*/, this.createConfirmationWorkflow(appointment, confirmationTime, workflowConfig)];
                    case 9:
                        _j.apply(_h, [_m.sent()]);
                        _m.label = 10;
                    case 10:
                    ...
                    case 11:
                        prediction = _m.sent();
                        if (!(prediction.probability >= workflowConfig.noShowPrevention.probabilityThreshold)) return [3 /*break*/, 13];
                        interventionTime = this.calculateInterventionTime(appointmentDate, workflowConfig.noShowPrevention.interventionTiming);
                        if (!(interventionTime > now)) return [3 /*break*/, 13];
                        _l = (_k = workflows).push;
                        return [4 /*yield*/, this.createNoShowPreventionWorkflow(appointment, prediction, interventionTime, workflowConfig)];
                    case 12:
                        _l.apply(_k, [_m.sent()]);
                        _m.label = 13;
                    case 13:
                    ...
                    case 16:
                        _i++;
                        return [3 /*break*/, 14];
                    case 17: return [2 /*return*/, workflows];
                    case 18:
                        error_1 = _m.sent();
     ...
     */
    SchedulingCommunicationWorkflow.prototype.createReminderWorkflows = function (appointmentId, config, appointment) {
        var _a, _b;
        var workflows = [];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = step.type;
                        switch (_a) {
                            case 'send_message': return [3 /*break*/, 1];
                            case 'predict_no_show': return [3 /*break*/, 3];
                            case 'wait_response': return [3 /*break*/, 5];
                            case 'escalate': return [3 /*break*/, 7];
                            case 'complete': return [3 /*break*/, 9];
                        }
                        return [3 /*break*/, 10];
                    case 1: return [4 /*yield*/, this.executeSendMessageStep(workflow, step)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 3: return [4 /*yield*/, this.executePredictNoShowStep(workflow, step)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 5: return [4 /*yield*/, this.executeWaitResponseStep(workflow, step)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 7: return [4 /*yield*/, this.executeEscalationStep(workflow, step)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 9:
                        ...
                        return [3 /*break*/, 11];
                    case 10: throw new Error("Unknown step type: ".concat(step.type));
                    case 11: return [2 /*return*/];
                }
            });
        });
    ...
    SchedulingCommunicationWorkflow.prototype.executeSendMessageStep = function (workflow, step) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, templateType, channel, timing, appointment, templateConditionData, template, variables, renderedContent, result;
            var _b, _c, _d, _e, _f, _g, _h;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        _a = step.input, templateType = _a.templateType, channel = _a.channel, timing = _a.timing;
                        return [4 /*yield*/, this.supabase
                                .from('appointments')
                                .select("\n        *,\n        patients(*),\n        professionals(*),\n        services(*),\n        clinics(*)\n      ")
                    ...
                    case 1:
                        ...
                        templateConditionData = __assign(__assign({}, appointment), { service_category: ((_b = appointment.services) === null || _b === void 0 ? void 0 : _b.category) || 'general', service_name: ((_c = appointment.services) === null || _c === void 0 ? void 0 : _c.name) || 'Consulta', professional_name: ((_d = appointment.professionals) === null || _d === void 0 ? void 0 : _d.name) || 'Profissional', patient_name: ((_e = appointment.patients) === null || _e === void 0 ? void 0 : _e.name) || 'Paciente', patient_age: ((_f = appointment.patients) === null || _f === void 0 ? void 0 : _f.age) || 0, clinic_name: ((_g = appointment.clinics) === null || _g === void 0 ? void 0 : _g.name) || 'Clínica' });
                        template = scheduling_templates_1.schedulingTemplateEngine.selectBestTemplate(templateType, templateConditionData, appointment.patients || {}, workflow.metadata.noShowPrediction || {});
                        if (!template) {
                        ...
                        variables = {
                            ...
                            confirmationUrl: "".concat(process.env.NEXT_PUBLIC_APP_URL, "/patient/confirm/").concat(workflow.metadata.confirmationToken),
                            rescheduleUrl: "".concat(process.env.NEXT_PUBLIC_APP_URL, "/patient/reschedule/").concat(workflow.metadata.confirmationToken),
                            no_show_probability: (_h = workflow.metadata.noShowPrediction) === null || _h === void 0 ? void 0 : _h.probability,
                            service_category: appointment.services.category
                        };
                        return [4 /*yield*/, scheduling_templates_1.schedulingTemplateEngine.renderTemplate(template, channel, variables)
                            // Send message
                        ];
                    case 2:
                        renderedContent = _j.sent();
                        return [4 /*yield*/, this.communicationService.sendMessage({
    ...
    SchedulingCommunicationWorkflow.prototype.executePredictNoShowStep = function (workflow, step) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.noShowPredictor.predict(workflow.appointmentId)];
                    case 1:
                        prediction = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.executeSendMessageStep(workflow, __assign(__assign({}, step), { input: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, __assign(__assign(__assign({}, defaultConfig), savedConfig === null || savedConfig === void 0 ? void 0 : savedConfig.config), override)];
                }
            });
        });
    };
     ...
     */
    SchedulingCommunicationWorkflow.prototype.createReminderWorkflow = function (appointment, timing, scheduledTime, config) {
        return __awaiter(this, void 0, void 0, function () {
            var workflowId;
            return __generator(this, function (_a) {
     ...
     */
    SchedulingCommunicationWorkflow.prototype.createConfirmationWorkflow = function (appointment, scheduledTime, config) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    SchedulingCommunicationWorkflow.prototype.createNoShowPreventionWorkflow = function (appointment, prediction, scheduledTime, config) {
        return __awaiter(this, void 0, void 0, function () {
            var workflowId;
            return __generator(this, function (_a) {
     ...
     * Helper methods
     */
    SchedulingCommunicationWorkflow.prototype.calculateConfirmationTime = function (appointmentDate, sendTime) {
        var _a = sendTime.split(':').map(Number), hours = _a[0], minutes = _a[1];
    ...
    SchedulingCommunicationWorkflow.prototype.calculateInterventionTime = function (appointmentDate, timing) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            ...
                            .update({
                            status: workflow.status,
                            started_at: (_a = workflow.startedAt) === null || _a === void 0 ? void 0 : _a.toISOString(),
                            completed_at: (_b = workflow.completedAt) === null || _b === void 0 ? void 0 : _b.toISOString(),
                            steps: workflow.steps,
                            results: workflow.results,
                            metadata: workflow.metadata,
...
var createschedulingCommunicationWorkflow = function () { return new SchedulingCommunicationWorkflow(); };
