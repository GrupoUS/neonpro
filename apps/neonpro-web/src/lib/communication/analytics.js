...
var CommunicationAnalytics = /** @class */ (function () {
  ...
  CommunicationAnalytics.prototype.getChannelPerformance = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
      var channels,
        ...
        error_3;
      var clinicId = _b.clinicId,
        currentPeriodStart = _b.currentPeriodStart,
        currentPeriodEnd = _b.currentPeriodEnd,
        previousPeriodStart = _b.previousPeriodStart,
        previousPeriodEnd = _b.previousPeriodEnd;
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              supabase.from("communication_campaigns").select("*").eq("id", campaignId).single(),
            ];
          case 1:
   ...
   */
  CommunicationAnalytics.prototype.calculatePatientEngagementScore = function (
    patientId,
    clinicId,
  ) {
    return __awaiter(this, void 0, void 0, function () {
          ...
          case 1:
            ...
            templatePerformance = Object.entries(templateGroups).map(function (_a) {
              ...
              return {
                ...
                template_name:
                  ((_b = firstLog.message_templates) === null || _b === void 0
                    ? void 0
                    : _b.name) || "Unknown Template",
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            deliveryChange = this.calculateChangePercentage(
              currentMetrics.delivery_rate,
              previousMetrics.delivery_rate,
            );
            if (deliveryChange > 10) {
              insights.push(
                "Delivery rate improved by ".concat(deliveryChange.toFixed(1), "% this month"),
              );
            } else if (deliveryChange < -10) {
              insights.push(
                "Delivery rate decreased by ".concat(
                  Math.abs(deliveryChange).toFixed(1),
                  "% this month",
                ),
              );
            ...
            if (currentMetrics.cost_per_message > 0) {
              costChange = this.calculateChangePercentage(
            ...
            volumeChange = this.calculateChangePercentage(
            ...
            return [
              2 /*return*/,
              { insights: insights, recommendations: recommendations, alerts: alerts },
            ];
          case 3:
            error_7 = _a.sent();
