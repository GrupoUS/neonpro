...
var SchedulingTemplateEngine = /** @class */ (function () {
    ...
    SchedulingTemplateEngine.prototype.initializeDefaultTemplates = function () {
        ...
        this.templates.set('reminder_24h_high_priority', {
            ...
            variables: [
                'patientName', 'serviceName', 'appointmentDate', 'appointmentTime',
                'professionalName', 'clinicName', 'clinicPhone', 'timeGreeting',
                'isHighRiskService', 'hasNoShowHistory'
            ],
            personalization: {
                usePatientName: true,
        ...
        this.templates.set('reminder_2h_all_services', {
            ...
            variables: [
                'patientName', 'serviceName', 'appointmentTime', 'professionalName',
                'clinicName', 'weatherAlert', 'trafficAlert'
            ],
            personalization: {
                usePatientName: true,
                useProfessionalName: true,
        ...
        this.templates.set('no_show_prevention_high_risk', {
            ...
            variables: [
                'patientName', 'serviceName', 'appointmentTime', 'professionalName',
                'clinicName', 'clinicPhone', 'confirmationUrl', 'rescheduleUrl'
            ],
            personalization: {
                usePatientName: true,
                useProfessionalName: true,
        ...
        this.templates.set('waitlist_slot_available', {
            ...
            variables: [
                'patientName', 'serviceName', 'professionalName', 'appointmentDate',
                'appointmentTime', 'clinicName'
            ],
            personalization: {
                usePatientName: true,
                useProfessionalName: true,
    ...
    SchedulingTemplateEngine.prototype.getTemplatesByType = function (type, conditions) {
        ...
        return Array.from(this.templates.values())
            .filter(function (template) { return template.type === type && template.active; })
            .filter(function (template) { return _this.matchesConditions(template, conditions); });
    };
    /**
     * Select best template based on appointment and patient data
     */
    SchedulingTemplateEngine.prototype.selectBestTemplate = function (type, appointmentData, patientData, noShowPrediction) {
        var _this = this;
        ...
        var contextData = __assign(__assign(__assign({}, (appointmentData || {})), (patientData || {})), (noShowPrediction || {}));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.applyPersonalization(template.personalization, variables)
    ...
    SchedulingTemplateEngine.prototype.renderText = function (template, variables) {
        ...
        rendered = rendered.replace(/{{#if (\w+)}}(.*?){{\/if}}/gs, function (match, condition, content) {
    ...
    SchedulingTemplateEngine.prototype.updateAnalytics = function (templateId, metrics) {
        ...
        if (template) {
            template.analytics = __assign(__assign(__assign({}, template.analytics), metrics), { lastUpdated: new Date() });
        }
    };
    /**
    ...
    SchedulingTemplateEngine.prototype.getAllActiveTemplates = function () {
        return Array.from(this.templates.values()).filter(function (t) { return t.active; });
    };
    /**
     * Add custom template
     */
