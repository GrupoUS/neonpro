...
var EmailService = /** @class */ (() => {
  ...
  EmailService.prototype.sendEmail = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
      ...
      var to = _b.to,
        templateName = _b.template,
        variables = _b.variables,
        _d = _b.from,
        from = _d === void 0 ? this.defaultFrom : _d,
        _e = _b.reply_to,
        reply_to = _e === void 0 ? this.defaultReplyTo : _e;
        ...
        switch (_f.label) {
          ...
          case 1:
            ...
            if (!template) {
              return [
                2 /*return*/,
                { success: false, error: "Template '".concat(templateName, "' not found") },
              ];
            }
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              { success: true, messageId: data === null || data === void 0 ? void 0 : data.id },
            ];
          case 3:
            error_3 = _f.sent();
  ...
  EmailService.prototype.sendBulkEmails = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
      ...
      var _this = this;
      var templateName = _b.template,
        recipients = _b.recipients,
        _c = _b.from,
        from = _c === void 0 ? this.defaultFrom : _c,
        _d = _b.reply_to,
        reply_to = _d === void 0 ? this.defaultReplyTo : _d;
  ...
  EmailService.prototype.sendAppointmentConfirmation = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
      var patientEmail = _b.patientEmail,
        patientName = _b.patientName,
        appointmentDate = _b.appointmentDate,
        appointmentTime = _b.appointmentTime,
        serviceName = _b.serviceName,
        professionalName = _b.professionalName,
        _c = _b.clinicName,
        clinicName = _c === void 0 ? "NeonPro" : _c;
  ...
  EmailService.prototype.sendAppointmentCancellation = function (_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
      var patientEmail = _b.patientEmail,
        ...
        appointmentDate = _b.appointmentDate,
        appointmentTime = _b.appointmentTime,
        _c = _b.cancellationReason,
        cancellationReason = _c === void 0 ? "Solicitação da clínica" : _c,
        _d = _b.clinicName,
        clinicName = _d === void 0 ? "NeonPro" : _d;
      return __generator(this, function (_e) {
        return [
          2 /*return*/,
          this.sendEmail({
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            supabase = _b.sent();
            return [4 /*yield*/, supabase.from("email_templates").select("id").limit(1)];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) {
              return [2 /*return*/, { success: false, error: error.message }];
