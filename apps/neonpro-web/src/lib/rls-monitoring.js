  ...
  RLSPerformanceMonitor.prototype.validateOptimization = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this.supabase.rpc("validate_rls_optimization")];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) {
  ...
  RLSPerformanceMonitor.prototype.getCacheStatistics = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this.supabase.rpc("get_cache_stats")];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            console.log(
              "Patient Data Access: ".concat(responseTime.toFixed(2), "ms (Target: <100ms)"),
            );
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            (_a = _b.sent()),
              (performanceMetrics = _a[0]),
              (healthCheck = _a[1]),
              (cacheStats = _a[2]),
              (patientAccessTime = _a[3]);
            return [
              2 /*return*/,
              {
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            if (patientAccessTime > 100) {
              alerts.push(
                "CRITICAL: Patient data access time ".concat(
                  patientAccessTime.toFixed(2),
