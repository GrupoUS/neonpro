...
var PortalDashboard = /** @class */ (function () {
    function PortalDashboard(supabaseUrl, supabaseKey, auditLogger, lgpdManager, sessionManager, config) {
        this.cache = new Map();
        this.supabase = (0, supabase_js_1.createClient)(supabaseUrl, supabaseKey);
        this.auditLogger = auditLogger;
        this.lgpdManager = lgpdManager;
        this.sessionManager = sessionManager;
        this.config = __assign({ refreshInterval: 30, maxRecentItems: 5, enableRealTimeUpdates: true, cacheTimeout: 5, defaultLanguage: 'pt-BR', defaultTheme: 'light' }, config);
    }
    /**
    ...
    PortalDashboard.prototype.getDashboardData = function (patientId, sessionToken) {
        return __awaiter(this, void 0, void 0, function () {
            var sessionValidation, cacheKey, cached, _a, patient, appointments, progress, uploads, tasks, notifications, stats, preferences, dashboardData, error_1;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all([this.getPatientInfo(patientId),
                    ...
                    case 2:
                        _a = _c.sent(), patient = _a[0], appointments = _a[1], progress = _a[2], uploads = _a[3], tasks = _a[4], notifications = _a[5], stats = _a[6], preferences = _a[7];
                        dashboardData = {
                            patient: patient,
    ...
    PortalDashboard.prototype.getAppointments = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var now, thirtyDaysAgo, _a, upcomingData, upcomingError, _b, recentData, recentError, upcoming, recent;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (recentError)
                            throw recentError;
                        upcoming = (upcomingData === null || upcomingData === void 0 ? void 0 : upcomingData.map(function (apt) { return _this.transformAppointment(apt); })) || [];
                        recent = (recentData === null || recentData === void 0 ? void 0 : recentData.map(function (apt) { return _this.transformAppointment(apt); })) || [];
    ...
    PortalDashboard.prototype.transformAppointment = function (apt) {
        var _a, _b;
        var appointmentDate = new Date("".concat(apt.appointment_date, "T").concat(apt.appointment_time));
        var now = new Date();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.map(function (progress) { return ({
                                id: progress.id,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.map(function (upload) { return ({ id: upload.id,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.map(function (notification) { return ({
                                id: notification.id,
    ...
    PortalDashboard.prototype.getDashboardStats = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var totalAppointments, completedTreatments, uploadedDocuments, pendingTasks, ratings, averageRating, patient, membershipDays;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.supabase
                            .from('appointments')
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.supabase.from('patient_evaluations')
                                .select('rating')
                                .eq('patient_id', patientId)
                                .not('rating', 'is', null)];
                    case 5:
                        ratings = (_a.sent()).data;
                        averageRating = (ratings === null || ratings === void 0 ? void 0 : ratings.length) > 0
                    ...
                    case 6:
                        ...
                        membershipDays = (patient === null || patient === void 0 ? void 0 : patient.membership_start_date)
    ...
    PortalDashboard.prototype.clearCache = function (patientId) {
        var _this = this;
        if (patientId) {
            var keysToDelete = Array.from(this.cache.keys())
                .filter(function (key) { return key.includes(patientId); });
