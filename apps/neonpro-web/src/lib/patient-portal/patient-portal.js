...
var PatientPortal = /** @class */ (function () {
    function PatientPortal(supabase, auditLogger, lgpdManager, encryptionService, notificationService, config) {
        ...
        this.config = config;
        this.portalId = "portal_".concat(Date.now(), "_").concat(Math.random().toString(36).substring(7));
    ...
    PatientPortal.prototype.initializeComponents = function () {
        ...
        this.sessionManager = new session_manager_1.SessionManager(this.supabase, this.auditLogger, this.lgpdManager, this.encryptionService, this.config.session);
        // Initialize dashboard
        this.dashboard = new portal_dashboard_1.PortalDashboard(this.supabase, this.auditLogger, this.lgpdManager, this.sessionManager, this.config.dashboard);
        // Initialize appointment manager
        this.appointments = new appointment_manager_1.AppointmentManager(this.supabase, this.auditLogger, this.lgpdManager, this.sessionManager, this.config.appointments);
        // Initialize upload manager
        this.uploads = new upload_manager_1.UploadManager(this.supabase, this.auditLogger, this.lgpdManager, this.sessionManager, this.encryptionService, this.config.uploads);
        // Initialize communication manager
        this.communication = new communication_manager_1.CommunicationManager(this.supabase, this.auditLogger, this.lgpdManager, this.sessionManager, this.notificationService, this.config.communication);
    };
    /**
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!configValidation.isValid) {
                            throw new Error("Configura\u00E7\u00E3o inv\u00E1lida: ".concat(configValidation.message));
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error = (_a.sent()).error;
                        if (error) {
                            throw new Error("Tabela requerida '".concat(table, "' n\u00E3o encontrada ou inacess\u00EDvel"));
                        }
                        _a.label = 3;
                    case 3:
                        _i++;
