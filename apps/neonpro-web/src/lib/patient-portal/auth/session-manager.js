...
var SessionManager = /** @class */ (function () {
    function SessionManager(supabaseUrl, supabaseKey, auditLogger, encryption, lgpdManager, config) {
        ...
        this.config = __assign({ sessionTimeout: 120, maxConcurrentSessions: 3, sessionCleanupInterval: 15, inactivityTimeout: 30, secureSessionCookies: true, sessionTokenLength: 64, enableDeviceFingerprinting: true, maxLoginAttempts: 5, lockoutDuration: 15, enableTwoFactor: false }, config);
        this.startCleanupInterval();
    }
    /**
     * Create a new session for a patient
     */
    SessionManager.prototype.createSession = function (patientId, ipAddress, userAgent, deviceFingerprint) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        sessionData = (_b.sessionToken = _c.sent(),
                    ...
                    case 3:
                        ...
                        session = __assign(__assign({}, data), { sessionToken: sessionToken // Return unencrypted token for client use
                         });
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.logSecurityEvent({
                                ...
                                userAgent: userAgent,
                                details: {
                                    deviceFingerprint: deviceFingerprint === null || deviceFingerprint === void 0 ? void 0 : deviceFingerprint.hash,
    ...
    SessionManager.prototype.validateSession = function (sessionToken) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, sessions, error, _i, _b, sessionRecord, decryptedToken, session, inactivityLimit, requiresRefresh, decryptError_1, error_2;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 8:
                        _i++;
                        return [3 /*break*/, 2];
                    case 9: return [2 /*return*/, { isValid: false, reason: 'Invalid session token' }];
                    case 10:
                        error_2 = _c.sent();
                        return [2 /*return*/, {
                                isValid: false,
     ...
     */
    SessionManager.prototype.generateDeviceFingerprint = function (fingerprintData) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('patient_portal_sessions')
                                .delete()
                                .or("expires_at.lt.".concat(new Date().toISOString(), ",last_activity.lt.").concat(new Date(Date.now() - this.config.inactivityTimeout * 60 * 1000).toISOString()))];
                    case 1:
                        _a = _b.sent(), error = _a.error, count = _a.count;
                        if (error) {
                    ...
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3: return [2 /*return*/, count || 0];
                    case 4:
                        error_8 = _b.sent();
    ...
    SessionManager.prototype.getSessionStatistics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var activeSessions, sessionsByPatient, totalDuration, recentLogins, oneHourAgo, _i, _a, session, duration, averageSessionDuration, error_9;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        for (_i = 0, _a = activeSessions || []; _i < _a.length; _i++) {
                            ...
                            duration = new Date(session.last_activity).getTime() - new Date(session.created_at).getTime();
                        ...
                        averageSessionDuration = (activeSessions === null || activeSessions === void 0 ? void 0 : activeSessions.length) ? totalDuration / activeSessions.length / (1000 * 60) : 0;
                        return [2 /*return*/, {
    ...
    SessionManager.prototype.enforceSessionLimits = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getActiveSessions(patientId)];
                    case 1:
                        activeSessions = _a.sent();
                        if (!(activeSessions.length >= this.config.maxConcurrentSessions)) return [3 /*break*/, 5];
