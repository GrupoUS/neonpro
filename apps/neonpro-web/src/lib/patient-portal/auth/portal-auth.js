...
var PortalAuthManager = /** @class */ (function () {
   ...
   */
  PortalAuthManager.prototype.authenticatePatient = function (
    email,
    password,
    ipAddress,
    userAgent,
   ...
   */
  PortalAuthManager.prototype.verifyTwoFactor = function (
    email,
    twoFactorToken,
    code,
    ipAddress,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("patients").select("*").eq("email", email.toLowerCase()).single(),
            ];
          case 2:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("patient_login_attempts").insert({
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("patients").select("password_hash").eq("id", patientId).single(),
            ];
          case 1:
            patient = _a.sent().data;
            if (!patient) {
  ...
  PortalAuthManager.prototype.validatePassword = function (password) {
    ...
    if (password.length < policy.minLength) {
      return {
        valid: false,
        error: "Senha deve ter pelo menos ".concat(policy.minLength, " caracteres"),
      };
    }
