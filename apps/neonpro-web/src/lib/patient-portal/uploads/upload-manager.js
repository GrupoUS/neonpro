...
var UploadManager = /** @class */ (function () {
    function UploadManager(supabase, auditLogger, lgpdManager, sessionManager, encryptionService, config) {
    ...
    UploadManager.prototype.uploadFiles = function (request, sessionToken) {
        return __awaiter(this, void 0, void 0, function () {
            var sessionValidation, validationResult, _a, uploadRecord, uploadError, uploadedFiles, errors, _i, _b, file, uploadedFile, error_1, finalStatus, error_2;
            var _c, _d;
                ...
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                tags: request.tags,
                                expiration_date: (_d = request.expirationDate) === null || _d === void 0 ? void 0 : _d.toISOString(),
                                status: 'uploading',
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 3];
                    case 8:
                        finalStatus = errors.length === 0 ? 'completed' :
                    ...
                    case 10:
                        ...
                        return [2 /*return*/, {
                                ...
                                message: errors.length === 0 ?
                                    ...
                                    "".concat(uploadedFiles.length, " de ").concat(request.files.length, " arquivos enviados com sucesso."),
    ...
    UploadManager.prototype.processFile = function (file, uploadId, request) {
        return __awaiter(this, void 0, void 0, function () {
            var fileExtension, storedName, filePath, fileBuffer, processedBuffer, _a, uploadData, uploadError, _b, fileRecord, fileError;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        fileExtension = file.name.split('.').pop();
                        storedName = "".concat(uploadId, "_").concat(Date.now(), "_").concat(Math.random().toString(36).substring(7), ".").concat(fileExtension);
                        filePath = "uploads/".concat(request.patientId, "/").concat(request.category, "/").concat(storedName);
    ...
    UploadManager.prototype.validateUploadRequest = function (request) {
        ...
        for (var _i = 0, _a = request.files; _i < _a.length; _i++) {
            ...
            if (file.size > this.config.maxFileSize) {
                errors.push({
                    fileName: file.name,
                    error: "Arquivo excede o tamanho m\u00E1ximo de ".concat(this.formatFileSize(this.config.maxFileSize), "."),
                    code: 'FILE_TOO_LARGE'
                });
            }
            // Check file type
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        _a.label = 5;
                    case 5:
                        if (!(this.config.thumbnailGeneration && mimeType.startsWith('image/'))) return [3 /*break*/, 7];
