...
export class CommunicationManager {
   ...
   * Send a message
   */
  async sendMessage(request: SendMessageRequest, sessionToken: string): Promise<SendMessageResult> {
    try {
      // Validate session
   ...
   */
  private async processAttachments(files: File[], patientId: string): Promise<MessageAttachment[]> {
   ...
   */
  private async sendNotifications(message: any, request: SendMessageRequest): Promise<void> {
