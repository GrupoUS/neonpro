...
var CommunicationManager = /** @class */ (function () {
        ...
        switch (_g.label) {
          ...
          case 1:
            ...
            if (
              ...
              ((_f = sessionValidation.session) === null || _f === void 0
                ? void 0
                : _f.patientId) !== request.patientId
            ) {
          ...
          case 4:
            ...
            _g.label = 5;
          case 5:
            _c = (_b = this.supabase.from("messages")).insert;
            _e = {
  ...
  CommunicationManager.prototype.validateMessage = function (request) {
    ...
    if (request.content.length > this.config.maxMessageLength) {
      return {
        isValid: false,
        message: "Mensagem excede o limite de ".concat(
            ...
            return [
              ...
              this.supabase
                ...
                .insert({
                  ...
                  subject:
                    request.subject ||
                    "".concat(request.messageType, " - ").concat(new Date().toLocaleDateString()),
                  status: "active",
                  priority: request.priority,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("conversations").update(updateData).eq("id", conversationId),
            ];
          case 1:
            error = _a.sent().error;
            if (error) throw error;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.supabase.storage.from("message-attachments").upload(filePath, file),
            ];
          case 2:
            ...
            return [
              4 /*yield*/,
              this.supabase.storage.from("message-attachments").createSignedUrl(filePath, 3600),
            ];
          case 3:
