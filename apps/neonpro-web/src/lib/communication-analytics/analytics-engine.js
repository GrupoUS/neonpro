        ...
        switch (_e.label) {
          case 0:
            ...
            eventData = {
              ...
              delivered_at:
                (_a = event.deliveredAt) === null || _a === void 0 ? void 0 : _a.toISOString(),
              opened_at:
                (_b = event.openedAt) === null || _b === void 0 ? void 0 : _b.toISOString(),
              clicked_at:
                (_c = event.clickedAt) === null || _c === void 0 ? void 0 : _c.toISOString(),
              responded_at:
                (_d = event.respondedAt) === null || _d === void 0 ? void 0 : _d.toISOString(),
              cost: event.cost,
            ...
            return [4 /*yield*/, this.supabase.from("communication_events").insert(eventData)];
          case 1:
            _e.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 3:
            return [2 /*return*/, ((_b.metadata = ((_c.confidence = _d.sent()), _c)), _b)];
          case 4:
            error_2 = _d.sent();
                    ...
                    return __generator(this, function (_b) {
                      switch (_b.label) {
                        case 0:
                          ...
                          return [
                            4 /*yield*/,
                            this.getChannelTimingData(channel.channel_type, filter),
                          ];
                        case 1:
                          timingData = _b.sent();
                          _a = {
                          ...
                          return [
                            4 /*yield*/,
                            this.calculateConversionRate(channel.channel_type, filter),
                          ];
                        case 2:
                          return [
                            2 /*return*/,
                            ((_a.conversionRate = _b.sent()),
          ...
          case 1:
            ...
            for (_i = 0, data_1 = data; _i < data_1.length; _i++) {
              ...
              if (event_1.delivered_at && event_1.sent_at) {
                deliveryTime =
                  new Date(event_1.delivered_at).getTime() - new Date(event_1.sent_at).getTime();
                totalDeliveryTime += deliveryTime / 1000; // segundos
                deliveryCount++;
              }
              if (event_1.opened_at && event_1.delivered_at) {
                openTime =
                  new Date(event_1.opened_at).getTime() - new Date(event_1.delivered_at).getTime();
                totalOpenTime += openTime / 1000;
                openCount++;
              }
              if (event_1.clicked_at && event_1.opened_at) {
                clickTime =
                  new Date(event_1.clicked_at).getTime() - new Date(event_1.opened_at).getTime();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            (_b = _c.sent()),
              (engagementScore = _b[0]),
              (avgResponseTime = _b[1]),
              (reachRate = _b[2]),
              (frequencyRate = _b[3]),
              (retentionRate = _b[4]),
              (satisfactionScore = _b[5]);
            return [
              2 /*return*/,
              {
                totalMessages: totalMessages,
          ...
          case 1:
            ...
            for (_i = 0, data_2 = data; _i < data_2.length; _i++) {
              ...
              if (event_2.responded_at && event_2.sent_at) {
                responseTime =
                  new Date(event_2.responded_at).getTime() - new Date(event_2.sent_at).getTime();
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ...
            previousFilter = __assign(__assign({}, filter), {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!channelPerformance.length) return [2 /*return*/, 0];
            weights = {
              deliveryRate: 0.2,
              openRate: 0.3,
              clickRate: 0.25,
            ...
            totalWeight = 0;
            for (
              _i = 0, channelPerformance_1 = channelPerformance;
              _i < channelPerformance_1.length;
              _i++
            ) {
  ...
  number >
  {
    try: {
      const:
        ...
        _a),
      return:
        ((_r = data === null || data === void 0 ? void 0 : data[0]) === null || _r === void 0
          ? void 0
          : _r.count) || 0,
    },
...
Promise <
  number >
  {
    ...
    return: 100,
    const: (withDelivery =
      parseInt(data === null || data === void 0 ? void 0 : data.with_delivery) || 0),
    const: (withPatient =
      parseInt(data === null || data === void 0 ? void 0 : data.with_patient) || 0),
...
}
{
  ...
  var dayFilter = __assign(__assign({}, filter), {
  ...
  number >
  {
    try: {
      const:
        ...
        _f),
      return:
        ((_s = data === null || data === void 0 ? void 0 : data[0]) === null || _s === void 0
          ? void 0
          : _s.count) || 0,
    },
    catch: function (error) {
    ...
    try: {
      ...
      const:
        ((_k = await this.supabase
          ...
          .eq("clinic_id", filter.clinicId)
          .eq("status", "active")),
        (totalPatients = _k.data),
        _k),
      const: (reachedPatients =
        parseInt(data === null || data === void 0 ? void 0 : data.reached_patients) || 0),
      const: (total =
        ((_t = totalPatients === null || totalPatients === void 0 ? void 0 : totalPatients[0]) ===
          null || _t === void 0
          ? void 0
          : _t.count) || 0),
...
Promise <
  number >
  {
    try: {
      ...
      const:
        ((_m = await this.supabase
          .from("communication_events")
          .select("DISTINCT patient_id")
          .gte("sent_at", filter.dateRange.start.toISOString())
          .lte("sent_at", filter.dateRange.end.toISOString())
          .eq("clinic_id", filter.clinicId)),
        (currentPeriod = _m.data),
        _m),
