...
exports.Emergency =
  ...
  exports.AlertAcknowledgmentSchema =
  exports.ValidationRequestSchema =
  exports.ComplicationDetectionRequestSchema =
  exports.getEnabledModels =
  exports.disableModel =
  exports.enableModel =
  exports.updateModelConfig =
  exports.calculateComplicationRiskScore =
  exports.getNotificationTargetsForAlert =
  exports.getAlertLevelForRiskScore =
  exports.getModelByType =
  exports.validateConfiguration =
  exports.SECURITY_CONFIG =
  exports.PERFORMANCE_BENCHMARKS =
  exports.ALERT_CONFIG =
  exports.QUALITY_CONFIG =
  exports.PROCESSING_CONFIG =
  exports.COMPLICATION_RISK_WEIGHTS =
  exports.NOTIFICATION_PRIORITY =
  exports.ALERT_THRESHOLDS =
  exports.EMERGENCY_CONTACTS =
  exports.DETECTION_MODELS =
  exports.COMPLICATION_DETECTION_CONFIG =
  exports.complicationAlertSystem =
  exports.ComplicationAlertSystem =
  exports.ComplicationDetector =
    void 0;
      ...
      switch (_a.label) {
        case 0:
          ...
          if (!configValidation.isValid) {
            throw new Error(
              "Configuration validation failed: ".concat(configValidation.errors.join(", ")),
            );
          }
        ...
        case 4:
          ...
          logger_1.logger.info(
            "Complication detection completed for patient "
              ...
              .concat(result.detectedComplications.length, " complications, ")
              .concat(alerts.length, " alerts"),
          );
          return [2 /*return*/, { result: result, alerts: alerts }];
        case 5:
          error_2 = _b.sent();
          logger_1.logger.error(
            "Complication detection failed for patient ".concat(request.patientId, ":"),
            error_2,
          );
          throw error_2;
        case 6:
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 1:
          (_a = _b.sent()),
            (detector = _a.detector),
            (alertSystem = _a.alertSystem),
            (isHealthy = _a.isHealthy);
          return [4 /*yield*/, detector.healthCheck()];
        case 2:
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              alertSystem.processDetectionResult({
          ...
          case 1:
            ...
            logger_1.logger.warn(
              "Emergency alert triggered for patient ".concat(patientId, ": ").concat(message),
            );
            return [3 /*break*/, 3];
          case 2:
            error_4 = _a.sent();
            logger_1.logger.error(
              "Failed to trigger emergency alert for patient ".concat(patientId, ":"),
              error_4,
            );
            throw error_4;
          case 3:
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            logger_1.logger.info(
              "Emergency system test ".concat(systemHealthy ? "passed" : "failed"),
            );
