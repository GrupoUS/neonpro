...
var ComplicationAlertSystem = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 8, , 9]);
                        logger_1.logger.info("Processing detection result ".concat(result.id, " for alert evaluation"));
                        alerts = [];
                    ...
                    case 1:
                        alert_1 = _b.sent();
                        alerts.push(alert_1);
                        if (!(result.alertLevel === 'critical' && result.emergencyProtocol)) return [3 /*break*/, 3];
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 4];
                    case 7:
                        logger_1.logger.info("Created ".concat(alerts.length, " alerts for detection result ").concat(result.id));
                        return [2 /*return*/, alerts];
                    case 8:
                        error_2 = _b.sent();
                        logger_1.logger.error("Failed to process detection result ".concat(result.id, " for alerts:"), error_2);
                        throw error_2;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        alert = {
                            ...
                            complicationType: ((_a = result.detectedComplications[0]) === null || _a === void 0 ? void 0 : _a.type) || 'other',
                            severity: ((_b = result.detectedComplications[0]) === null || _b === void 0 ? void 0 : _b.severity) || 'moderate',
    ...
    ComplicationAlertSystem.prototype.createComplicationAlert = function (result, complication) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        alertId = "comp_alert_".concat(result.id, "_").concat(complication.type, "_").concat(Date.now());
    ...
    ComplicationAlertSystem.prototype.sendNotifications = function (alert) {
        return __awaiter(this, void 0, void 0, function () {
            var targets, notifications, _i, targets_1, target, methods, _a, methods_1, method, notification, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 8, , 9]);
                    ...
                    case 7:
                        _b.sent();
                        logger_1.logger.info("Sent ".concat(notifications.length, " notifications for alert ").concat(alert.id));
                        return [3 /*break*/, 9];
                    case 8:
                        error_3 = _b.sent();
                        logger_1.logger.error("Failed to send notifications for alert ".concat(alert.id, ":"), error_3);
                        throw error_3;
                    case 9: return [2 /*return*/];
                }
            });
    ...
    ComplicationAlertSystem.prototype.sendNotification = function (alert, target, method) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        notificationId = "notif_".concat(alert.id, "_").concat(target, "_").concat(method, "_").concat(Date.now());
                        notification = {
                            id: notificationId,
                            target: target,
                            method: method,
                    ...
                    case 2:
                        ...
                        switch (_a) {
                            ...
                            case 'call': return [3 /*break*/, 9];
                        }
                        return [3 /*break*/, 11];
                    case 3: return [4 /*yield*/, this.sendEmailNotification(contactInfo.email, content, alert)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 5: return [4 /*yield*/, this.sendSMSNotification(contactInfo.phone, content, alert)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 7: return [4 /*yield*/, this.sendPushNotification(contactInfo.userId, content, alert)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, this.initiatePhoneCall(contactInfo.phone, content, alert)];
                    case 10:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 11:
                    ...
                    case 12:
                        error_4 = _b.sent();
                        logger_1.logger.error("Failed to send ".concat(method, " notification to ").concat(target, ":"), error_4);
                        ...
                        return [3 /*break*/, 13];
                    case 13: return [2 /*return*/, notification];
                }
            });
        });
    };
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        logger_1.logger.warn("Activating emergency protocol for critical alert ".concat(alert.id));
                    ...
                    case 14:
                        error_5 = _d.sent();
                        logger_1.logger.error("Failed to activate emergency protocol for alert ".concat(alert.id, ":"), error_5);
                        throw error_5;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        logger_1.logger.info("Alert ".concat(alertId, " acknowledged by ").concat(acknowledgedBy));
                        // Log acknowledgment
                        return [4 /*yield*/, this.logAlertAction(alertId, 'acknowledged', acknowledgedBy, notes)];
                    case 2:
                        // Log acknowledgment
                        _a.sent();
                        return [3 /*break*/, 4];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Array.from(this.activeAlerts.values())
                        .filter(function (alert) { return alert.patientId === patientId && alert.status !== 'resolved'; })];
            });
        });
    };
    /**
    ...
    ComplicationAlertSystem.prototype.getActiveAlerts = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Array.from(this.activeAlerts.values())
                        .filter(function (alert) { return alert.status !== 'resolved'; })];
            });
        });
    };
    /**
    ...
    ComplicationAlertSystem.prototype.createNotificationContent = function (alert) {
        ...
        return {
            subject: "".concat(urgencyText, " - Complica\u00E7\u00E3o Detectada - Paciente ").concat(alert.patientId),
            body: "\nUma complica\u00E7\u00E3o foi detectada automaticamente no sistema NeonPro.\n\n\uD83C\uDFE5 **DETALHES DA COMPLICA\u00C7\u00C3O**\n- Tipo: ".concat(alert.complicationType, "\n- Severidade: ").concat(alert.severity, "\n- N\u00EDvel de Alerta: ").concat(urgencyText, "\n- Paciente ID: ").concat(alert.patientId, "\n- Detectado em: ").concat(new Date(alert.triggeredAt).toLocaleString('pt-BR'), "\n\n\u26A1 **A\u00C7\u00C3O REQUERIDA**\n").concat(alert.alertLevel === 'critical' ?
    ...
    ComplicationAlertSystem.prototype.sendEmailNotification = function (email, content, alert) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.logger.info("Email notification sent to ".concat(email, " for alert ").concat(alert.id));
                return [2 /*return*/];
            });
        });
    };
    ComplicationAlertSystem.prototype.sendSMSNotification = function (phone, content, alert) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.logger.info("SMS notification sent to ".concat(phone, " for alert ").concat(alert.id));
                return [2 /*return*/];
            });
        });
    };
    ComplicationAlertSystem.prototype.sendPushNotification = function (userId, content, alert) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.logger.info("Push notification sent to user ".concat(userId, " for alert ").concat(alert.id));
                return [2 /*return*/];
            });
        });
    };
    ComplicationAlertSystem.prototype.initiatePhoneCall = function (phone, content, alert) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.logger.info("Phone call initiated to ".concat(phone, " for alert ").concat(alert.id));
                return [2 /*return*/];
            });
        });
    };
    ...
    ComplicationAlertSystem.prototype.executeEmergencyAction = function (action, alert) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                logger_1.logger.info("Executing emergency action: ".concat(action, " for alert ").concat(alert.id));
                return [2 /*return*/];
            });
        });
    };
    ...
    ComplicationAlertSystem.prototype.sendEscalationNotifications = function (alert, escalatedTo) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.logger.info("Sending escalation notifications to ".concat(escalatedTo, " for alert ").concat(alert.id));
                return [2 /*return*/];
            });
        });
    };
    ComplicationAlertSystem.prototype.retryNotification = function (notification, alert) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.logger.info("Retrying notification ".concat(notification.id, " (attempt ").concat(notification.retryCount, ")"));
                return [2 /*return*/];
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 4];
                        alert_5 = _a[_i];
                        if (!(alert_5.status === 'pending' && alert_5.alertLevel === 'critical')) return [3 /*break*/, 3];
                        alertTime = new Date(alert_5.triggeredAt).getTime();
                        timeElapsed = now - alertTime;
                        if (!(timeElapsed > config_1.ALERT_CONFIG.acknowledgmentTimeout)) return [3 /*break*/, 3];
...
var createcomplicationAlertSystem = function () { return new ComplicationAlertSystem(); };
