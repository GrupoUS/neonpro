...
var VisionAnalysisEngine = /** @class */ (function () {
     ...
     */
    VisionAnalysisEngine.prototype.analyzeBeforeAfter = function (beforeImageUrl, afterImageUrl, patientId, treatmentType) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, beforeImage, afterImage, changeMetrics, annotations, improvementPercentage, accuracyScore, processingTime, result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        afterImage = _a.sent();
                        return [4 /*yield*/, this.calculateChangeMetrics(beforeImage, afterImage, treatmentType)];
                    case 4:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.calculateAccuracyScore(beforeImage, afterImage, changeMetrics)];
                    case 6:
                    ...
                    case 8:
                        ...
                        throw new Error("Analysis failed: ".concat(error_2 instanceof Error ? error_2.message : 'Unknown error'));
     ...
     */
    VisionAnalysisEngine.prototype.calculateChangeMetrics = function (beforeImage, afterImage, treatmentType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        if (!(treatmentType.includes('skin') || treatmentType.includes('aesthetic'))) return [3 /*break*/, 4];
                        _a = metrics;
                    ...
                    case 3:
                        ...
                        _h.label = 4;
                    case 4:
                        if (!(treatmentType.includes('medical') || treatmentType.includes('healing'))) return [3 /*break*/, 7];
                        _d = metrics;
                    ...
                    case 6:
                        ...
                        _h.label = 7;
                    case 7:
                        if (!(treatmentType.includes('body') || treatmentType.includes('contouring'))) return [3 /*break*/, 10];
                        _f = metrics;
     ...
     */
    VisionAnalysisEngine.prototype.generateAnnotations = function (beforeImage, afterImage, changeMetrics) {
        return __awaiter(this, void 0, void 0, function () {
            var annotations;
            return __generator(this, function (_a) {
                annotations = [];
    ...
    VisionAnalysisEngine.prototype.calculateOverallImprovement = function (metrics) {
        var values = Object.values(metrics).filter(function (value) { return typeof value === 'number' && value !== metrics.overallImprovement; });
        if (values.length === 0)
            return 0;
     ...
     */
    VisionAnalysisEngine.prototype.calculateAccuracyScore = function (beforeImage, afterImage, changeMetrics) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    VisionAnalysisEngine.prototype.calculateSkinTextureImprovement = function (beforeImage, afterImage) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    VisionAnalysisEngine.prototype.calculatePigmentationImprovement = function (beforeImage, afterImage) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
