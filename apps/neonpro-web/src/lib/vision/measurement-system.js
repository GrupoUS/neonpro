...
exports.objectiveMeasurementSystem = exports.ObjectiveMeasurementSystem = exports.MeasurementCategory = exports.MeasurementType = void 0;
...
var ObjectiveMeasurementSystem = /** @class */ (function () {
     ...
     */
    ObjectiveMeasurementSystem.prototype.performMeasurements = function (beforeImage_1, afterImage_1, patientId_1, analysisId_1, treatmentType_1) {
        return __awaiter(this, arguments, void 0, function (beforeImage, afterImage, patientId, analysisId, treatmentType, options) {
            var protocol, beforeMeasurements, afterMeasurements, objectiveMeasurements, comparisonScore, clinicalSignificance, standardizedMetrics, qualityAssurance, result, error_1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        objectiveMeasurements = this.calculateObjectiveMeasurements(beforeMeasurements, afterMeasurements, protocol);
                        return [4 /*yield*/, this.statisticalAnalyzer.calculateComparisonScore(objectiveMeasurements)];
                    case 4:
                        comparisonScore = _a.sent();
                        return [4 /*yield*/, this.clinicalValidator.assessSignificance(objectiveMeasurements, treatmentType)];
                    case 5:
                        clinicalSignificance = _a.sent();
                        standardizedMetrics = this.generateStandardizedMetrics(objectiveMeasurements, treatmentType);
                        return [4 /*yield*/, this.qualityController.performQA(objectiveMeasurements, beforeImage, afterImage)];
                    case 6:
                    ...
                    case 8:
                        ...
                        throw new Error("Measurement failed: ".concat(error_1 instanceof Error ? error_1.message : 'Unknown error'));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        error_2 = _b.sent();
                        console.warn("Failed to extract ".concat(measurementSpec.type, " measurement:"), error_2);
                        return [3 /*break*/, 5];
                    case 5:
                        _i++;
                        return [3 /*break*/, 1];
                    case 6: return [2 /*return*/, measurements];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, tf.tidy(function () {
                        ...
                        var threshold = ((_a = spec.parameters) === null || _a === void 0 ? void 0 : _a.threshold) || 0.5;
    ...
    ObjectiveMeasurementSystem.prototype.measureDistance = function (image, spec) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                point1 = landmarks[0];
                point2 = landmarks[1];
                pixelDistance = Math.sqrt(Math.pow(point2.x - point1.x, 2) + Math.pow(point2.y - point1.y, 2));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, tf.tidy(function () {
                        ...
                        var uniformityScore = 1.0 - (colorVariance.reduce(function (a, b) { return a + b; }, 0) / 3);
                        return {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, tf.tidy(function () {
                        ...
                        var _a = tf.grad(gray), gradX = _a[0], gradY = _a[1];
    ...
    ObjectiveMeasurementSystem.prototype.calculateObjectiveMeasurements = function (beforeMeasurements, afterMeasurements, protocol) {
        var objectiveMeasurements = [];
        var _loop_1 = function (beforeMeas) {
            var afterMeas = afterMeasurements.find(function (m) { return m.type === beforeMeas.type; });
            if (afterMeas) {
                var changeValue = afterMeas.value - beforeMeas.value;
                var changePercentage = beforeMeas.value !== 0
        ...
        var this_1 = this;
        for (var _i = 0, beforeMeasurements_1 = beforeMeasurements; _i < beforeMeasurements_1.length; _i++) {
    ...
    ObjectiveMeasurementSystem.prototype.calculateClinicalRelevance = function (type, changePercentage) {
        var _a;
        // Calculate clinical relevance based on measurement type and change magnitude
        var relevanceThresholds = (_a = {},
            _a[MeasurementType.AREA] = 10, // 10% change is clinically relevant
    ...
    ObjectiveMeasurementSystem.prototype.generateStandardizedMetrics = function (measurements, treatmentType) {
        var metrics = {
    ...
    ObjectiveMeasurementSystem.prototype.calculateSymmetryIndex = function (measurements) {
        var symmetryMeasurements = measurements.filter(function (m) { return m.type === MeasurementType.SYMMETRY; });
        if (symmetryMeasurements.length === 0)
            return 0;
        var avgImprovement = symmetryMeasurements.reduce(function (sum, m) { return sum + m.changePercentage; }, 0) / symmetryMeasurements.length;
    ...
    ObjectiveMeasurementSystem.prototype.calculateVolumetricChange = function (measurements) {
        var volumeMeasurements = measurements.filter(function (m) { return m.type === MeasurementType.VOLUME; });
        if (volumeMeasurements.length === 0)
            return 0;
        return volumeMeasurements.reduce(function (sum, m) { return sum + m.changePercentage; }, 0) / volumeMeasurements.length;
    };
    ObjectiveMeasurementSystem.prototype.calculateContourDefinition = function (measurements) {
        var perimeterMeasurements = measurements.filter(function (m) { return m.type === MeasurementType.PERIMETER; });
        if (perimeterMeasurements.length === 0)
            return 0;
        var avgChange = perimeterMeasurements.reduce(function (sum, m) { return sum + Math.abs(m.changePercentage); }, 0) / perimeterMeasurements.length;
        return Math.min(100, avgChange);
    };
    ObjectiveMeasurementSystem.prototype.calculateProportionalBalance = function (measurements) {
        var angleMeasurements = measurements.filter(function (m) { return m.type === MeasurementType.ANGLE; });
        if (angleMeasurements.length === 0)
            return 0;
        var avgImprovement = angleMeasurements.reduce(function (sum, m) { return sum + Math.abs(m.changePercentage); }, 0) / angleMeasurements.length;
    ...
    ObjectiveMeasurementSystem.prototype.calculateSkinQualityIndex = function (measurements) {
        ...
        var roughnessScore = measurements.filter(function (m) { return m.type === MeasurementType.ROUGHNESS; })
            .reduce(function (sum, m) { return sum + (100 - Math.abs(m.changePercentage)); }, 0) / Math.max(1, measurements.filter(function (m) { return m.type === MeasurementType.ROUGHNESS; }).length);
    ...
    ObjectiveMeasurementSystem.prototype.calculateTextureUniformity = function (measurements) {
        var textureMeasurements = measurements.filter(function (m) { return m.type === MeasurementType.TEXTURE; });
        if (textureMeasurements.length === 0)
            return 0;
        var avgImprovement = textureMeasurements.reduce(function (sum, m) { return sum + m.changePercentage; }, 0) / textureMeasurements.length;
    ...
    ObjectiveMeasurementSystem.prototype.calculatePigmentationIndex = function (measurements) {
        var colorMeasurements = measurements.filter(function (m) { return m.type === MeasurementType.COLOR; });
        if (colorMeasurements.length === 0)
            return 0;
        var avgImprovement = colorMeasurements.reduce(function (sum, m) { return sum + m.changePercentage; }, 0) / colorMeasurements.length;
        return Math.max(0, Math.min(100, 50 + avgImprovement));
    };
    ...
    ObjectiveMeasurementSystem.prototype.calculateHealingProgress = function (measurements) {
        var areaMeasurements = measurements.filter(function (m) { return m.type === MeasurementType.AREA; });
        if (areaMeasurements.length === 0)
            return 0;
        // Healing typically involves area reduction
        var avgAreaReduction = areaMeasurements.reduce(function (sum, m) { return sum + Math.max(0, -m.changePercentage); }, 0) / areaMeasurements.length;
    ...
    ObjectiveMeasurementSystem.prototype.calculateInflammationReduction = function (measurements) {
        var intensityMeasurements = measurements.filter(function (m) { return m.type === MeasurementType.INTENSITY; });
        if (intensityMeasurements.length === 0)
            return 0;
        // Inflammation reduction typically shows as intensity decrease
        var avgIntensityReduction = intensityMeasurements.reduce(function (sum, m) { return sum + Math.max(0, -m.changePercentage); }, 0) / intensityMeasurements.length;
    ...
    ObjectiveMeasurementSystem.prototype.calculateLesionSize = function (measurements) {
        ...
        if (areaMeasurements.length === 0)
            return 0;
        return areaMeasurements.reduce(function (sum, m) { return sum + m.afterValue; }, 0) / areaMeasurements.length;
    };
    ObjectiveMeasurementSystem.prototype.calculateScarVisibility = function (measurements) {
        var textureMeasurements = measurements.filter(function (m) { return m.type === MeasurementType.TEXTURE; });
        var colorMeasurements = measurements.filter(function (m) { return m.type === MeasurementType.COLOR; });
        var textureScore = textureMeasurements.length > 0
            ? textureMeasurements.reduce(function (sum, m) { return sum + (100 - Math.abs(m.changePercentage)); }, 0) / textureMeasurements.length
            : 50;
        var colorScore = colorMeasurements.length > 0
            ? colorMeasurements.reduce(function (sum, m) { return sum + (100 - Math.abs(m.changePercentage)); }, 0) / colorMeasurements.length
            : 50;
    ...
    ObjectiveMeasurementSystem.prototype.calculateOverallImprovement = function (measurements) {
        ...
        var totalWeight = measurements.reduce(function (sum, m) { return sum + m.clinicalRelevance; }, 0);
    ...
    ObjectiveMeasurementSystem.prototype.calculateTreatmentResponse = function (measurements) {
        ...
        var totalWeight = measurements.reduce(function (sum, m) { return sum + m.confidence; }, 0);
        return totalWeight > 0 ? weightedSum / totalWeight : 0;
    };
    ObjectiveMeasurementSystem.prototype.predictPatientSatisfaction = function (measurements) {
        ...
        var avgImprovement = visibleImprovements.reduce(function (sum, m) { return sum + Math.abs(m.changePercentage); }, 0) / visibleImprovements.length;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        data === null || data === void 0 ? void 0 : data.forEach(function (calibration) {
    ...
    ObjectiveMeasurementSystem.prototype.ensureCalibration = function (beforeImage, afterImage) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                daysSinceCalibration = (Date.now() - calibration.calibrationDate.getTime()) / (1000 * 60 * 60 * 24);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.map(function (row) { return ({
                                id: row.id,
     ...
     */
    ObjectiveMeasurementSystem.prototype.validateMeasurements = function (measurementId, groundTruth) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.clinicalValidator.validateMeasurements(measurementId, groundTruth)];
            });
        });
    };
    /**
...
var QualityController = /** @class */ (function () {
    ...
    QualityController.prototype.performQA = function (measurements, beforeImage, afterImage) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                passedChecks = validationChecks.filter(function (check) { return check.passed; }).length;
    ...
    QualityController.prototype.checkConsistency = function (measurements) {
        ...
        return measurements.every(function (m) { return m.confidence > 0.8; });
    };
    ...
    StatisticalAnalyzer.prototype.calculateComparisonScore = function (measurements) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                totalWeight = measurements.reduce(function (sum, m) { return sum + (m.confidence * m.clinicalRelevance); }, 0);
...
var ClinicalValidator = /** @class */ (function () {
    ...
    ClinicalValidator.prototype.assessSignificance = function (measurements, treatmentType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                progressIndicators = measurements.map(function (m) { return ({
                ...
                overallSignificance = measurements.reduce(function (sum, m) { return sum + m.clinicalRelevance; }, 0) / measurements.length;
                return [2 /*return*/, {
                        overallSignificance: overallSignificance,
                        treatmentEfficacy: Math.min(1.0, overallSignificance * 1.2),
                        progressIndicators: progressIndicators,
                        clinicalNotes: [
                            "Treatment shows ".concat(overallSignificance > 0.7 ? 'significant' : 'moderate', " improvement"),
