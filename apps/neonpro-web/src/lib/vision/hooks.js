...
function useVisionAnalysis() {
  ...
  var startAnalysis = (0, react_1.useCallback)(function (request) {
...
function useImageUpload() {
  ...
  var uploadImage = (0, react_1.useCallback)(function (file, type) {
    return __awaiter(_this, void 0, void 0, function () {
      var validation,
        errors,
        metadata,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!validation.valid) {
              errors = validation.errors.map(function (e) {
                return e.message;
              });
          ...
          case 5:
            ...
            setUploadedImages(function (prev) {
              return __spreadArray(__spreadArray([], prev, true), [imageData_1], false);
            });
...
function useAnalysisExport() {
  ...
  var exportAnalysis = (0, react_1.useCallback)(function (analysisId, options) {
    return __awaiter(_this, void 0, void 0, function () {
        ...
        switch (_b.label) {
          ...
          case 4:
            ...
            setExportHistory(function (prev) {
              return __spreadArray([exportResult_1], prev, true);
            });
...
function useAnnotations(imageId) {
  ...
  var addAnnotation = (0, react_1.useCallback)(function (annotation) {
    ...
    setAnnotations(function (prev) {
      return __spreadArray(__spreadArray([], prev, true), [newAnnotation], false);
    });
  ...
  var updateAnnotation = (0, react_1.useCallback)(function (id, updates) {
    setAnnotations(function (prev) {
      return prev.map(function (annotation) {
  ...
  var removeAnnotation = (0, react_1.useCallback)(
    function (id) {
      setAnnotations(function (prev) {
        return prev.filter(function (annotation) {
...
function useMeasurements(imageId) {
  ...
  var addMeasurement = (0, react_1.useCallback)(function (measurement) {
    ...
    setMeasurements(function (prev) {
      return __spreadArray(__spreadArray([], prev, true), [newMeasurement], false);
    });
  ...
  var updateMeasurement = (0, react_1.useCallback)(function (id, updates) {
    setMeasurements(function (prev) {
      return prev.map(function (measurement) {
  ...
  var removeMeasurement = (0, react_1.useCallback)(
    function (id) {
      setMeasurements(function (prev) {
        return prev.filter(function (measurement) {
            ...
            case 2:
              ...
              if (reset) {
                ...
                setHistory(function (prev) {
                  return __spreadArray(__spreadArray([], prev, true), data_1.results, true);
                });
