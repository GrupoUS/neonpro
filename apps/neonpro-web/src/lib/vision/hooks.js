...
function useVisionAnalysis() {
        ...
        return __generator(this, (_b) => {
          switch (_b.label) {
            case 0:
              ...
              if (!validation.valid) {
                throw new Error(
                  ((_a = validation.errors[0]) === null || _a === void 0 ? void 0 : _a.message) ||
            ...
            case 4:
              ...
              resultValidation =
                utils_1.VisionUtils.Analysis.validateAnalysisResult(analysisResult);
  ...
  var cancelAnalysis = (0, react_1.useCallback)(() => {
    if (abortControllerRef.current) {
      abortControllerRef.current.abort();
    }
  }, []);
  var resetAnalysis = (0, react_1.useCallback)(() => {
    setResult(null);
    setError(null);
    setProgress(null);
    setIsAnalyzing(false);
...
function useImageUpload() {
  ...
  var _c = (0, react_1.useState)([]),
    uploadedImages = _c[0],
    setUploadedImages = _c[1];
  var _d = (0, react_1.useState)([]),
    validationErrors = _d[0],
    setValidationErrors = _d[1];
  var uploadImage = (0, react_1.useCallback)(
    (file, type) =>
      __awaiter(this, void 0, void 0, function () {
        var validation,
          errors,
          ...
          switch (_a.label) {
            case 0:
              ...
              if (!validation.valid) {
                ...
                errors.forEach((error) => sonner_1.toast.error(error));
                return [2 /*return*/, null];
              }
            ...
            case 5:
              ...
              setUploadedImages((prev) =>
                __spreadArray(__spreadArray([], prev, true), [imageData_1], false),
              );
              setUploadProgress(100);
              sonner_1.toast.success(
                "Imagem ".concat(
                  type === "before" ? "anterior" : "posterior",
  ...
  var removeImage = (0, react_1.useCallback)((imageId) => {
    setUploadedImages((prev) => prev.filter((img) => img.id !== imageId));
    sonner_1.toast.info("Imagem removida");
  }, []);
  var clearImages = (0, react_1.useCallback)(() => {
    setUploadedImages([]);
    setValidationErrors([]);
...
function useAnalysisExport() {
  ...
  var _b = (0, react_1.useState)(0),
    exportProgress = _b[0],
    setExportProgress = _b[1];
  var _c = (0, react_1.useState)([]),
    exportHistory = _c[0],
    setExportHistory = _c[1];
        ...
        return __generator(this, (_b) => {
          switch (_b.label) {
            ...
            case 4:
              ...
              setExportHistory((prev) => __spreadArray([exportResult_1], prev, true));
              setExportProgress(100);
              sonner_1.toast.success(
                "An\u00E1lise exportada como ".concat(options.format.toUpperCase()),
              );
  ...
  var downloadExport = (0, react_1.useCallback)((exportResult) => {
 ...
 */
function useAnnotations(_imageId) {
  var _a = (0, react_1.useState)([]),
    annotations = _a[0],
    setAnnotations = _a[1];
  var _b = (0, react_1.useState)(null),
    selectedAnnotation = _b[0],
    setSelectedAnnotation = _b[1];
  var _c = (0, react_1.useState)(false),
    isEditing = _c[0],
    setIsEditing = _c[1];
  var addAnnotation = (0, react_1.useCallback)((annotation) => {
    var newAnnotation = __assign(__assign({}, annotation), {
      id: utils_1.VisionUtils.Annotation.generateAnnotationId(),
      createdAt: new Date().toISOString(),
    });
    setAnnotations((prev) => __spreadArray(__spreadArray([], prev, true), [newAnnotation], false));
    setSelectedAnnotation(newAnnotation.id);
    sonner_1.toast.success("Anotação adicionada");
  }, []);
  var updateAnnotation = (0, react_1.useCallback)((id, updates) => {
    setAnnotations((prev) =>
      prev.map((annotation) =>
        annotation.id === id ? __assign(__assign({}, annotation), updates) : annotation,
      ),
    );
    sonner_1.toast.success("Anotação atualizada");
  }, []);
  var removeAnnotation = (0, react_1.useCallback)(
    (id) => {
  ...
  var clearAnnotations = (0, react_1.useCallback)(() => {
    setAnnotations([]);
    setSelectedAnnotation(null);
    setIsEditing(false);
    sonner_1.toast.info("Todas as anotações foram removidas");
  }, []);
  var selectAnnotation = (0, react_1.useCallback)((id) => {
    setSelectedAnnotation(id);
    setIsEditing(false);
  }, []);
  var startEditing = (0, react_1.useCallback)((id) => {
    setSelectedAnnotation(id);
    setIsEditing(true);
  }, []);
  var stopEditing = (0, react_1.useCallback)(() => {
    setIsEditing(false);
  }, []);
  return {
 ...
 */
function useMeasurements(_imageId) {
  var _a = (0, react_1.useState)([]),
    measurements = _a[0],
    setMeasurements = _a[1];
  var _b = (0, react_1.useState)(null),
    selectedMeasurement = _b[0],
    setSelectedMeasurement = _b[1];
  var _c = (0, react_1.useState)(null),
    calibration = _c[0],
    setCalibration = _c[1];
  var addMeasurement = (0, react_1.useCallback)((measurement) => {
    var newMeasurement = __assign(__assign({}, measurement), {
      id: "measurement_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
      createdAt: new Date().toISOString(),
    });
    setMeasurements((prev) =>
      __spreadArray(__spreadArray([], prev, true), [newMeasurement], false),
    );
    setSelectedMeasurement(newMeasurement.id);
    sonner_1.toast.success("Medição adicionada");
  }, []);
  var updateMeasurement = (0, react_1.useCallback)((id, updates) => {
    setMeasurements((prev) =>
      prev.map((measurement) =>
        measurement.id === id ? __assign(__assign({}, measurement), updates) : measurement,
      ),
    );
    sonner_1.toast.success("Medição atualizada");
  }, []);
  var removeMeasurement = (0, react_1.useCallback)(
    (id) => {
  ...
  var clearMeasurements = (0, react_1.useCallback)(() => {
    setMeasurements([]);
    setSelectedMeasurement(null);
    sonner_1.toast.info("Todas as medições foram removidas");
  }, []);
  var setCalibrationRatio = (0, react_1.useCallback)((pixelToMmRatio) => {
    setCalibration({ pixelToMmRatio: pixelToMmRatio });
    // Recalculate all measurements with new calibration
    setMeasurements((prev) => prev.map((measurement) => __assign({}, measurement)));
...
function useAnalysisHistory() {
  ...
  var _d = (0, react_1.useState)(1),
    page = _d[0],
    setPage = _d[1];
  var loadHistory = (0, react_1.useCallback)(() => {
    var args_1 = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args_1[_i] = arguments[_i];
    }
    return __awaiter(this, __spreadArray([], args_1, true), void 0, function (reset) {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/vision/history?page=".concat(currentPage, "&limit=10")),
            ];
          case 1:
            response = _a.sent();
            if (!response.ok) return [3 /*break*/, 3];
          ...
          case 2:
            ...
            if (reset) {
              ...
              setHistory((prev) =>
                __spreadArray(__spreadArray([], prev, true), data_1.results, true),
              );
              setPage((prev) => prev + 1);
            }
  ...
  var refreshHistory = (0, react_1.useCallback)(() => {
    loadHistory(true);
  }, [loadHistory]);
  var loadMore = (0, react_1.useCallback)(() => {
...
function usePerformanceMonitoring() {
  ...
  var stopMonitoring = (0, react_1.useCallback)(() => {
    if (timerRef.current && isMonitoring) {
      ...
      var newMetrics = {
        ...
        memoryUsageMB:
          (memoryUsage === null || memoryUsage === void 0 ? void 0 : memoryUsage.used) || 0,
  ...
  var resetMetrics = (0, react_1.useCallback)(() => {
    setMetrics(null);
    setIsMonitoring(false);
