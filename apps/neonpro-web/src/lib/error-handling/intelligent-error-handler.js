...
var IntelligentErrorHandler = /** @class */ (function () {
    ...
    IntelligentErrorHandler.prototype.captureError = function (error, context) {
        ...
        var errorContext = __assign({ errorId: errorId, message: errorMessage, stack: errorStack, timestamp: Date.now(), severity: analysis.severity, category: analysis.category, recoveryAction: analysis.recoveryAction, resolved: false }, context);
    ...
    IntelligentErrorHandler.prototype.recordErrorMetrics = function (errorContext) {
        performance_monitor_1.performanceMonitor.recordClientPerformance("error.".concat(errorContext.category, ".").concat(errorContext.severity), 1, {
    ...
    IntelligentErrorHandler.prototype.getErrorSummary = function (timeWindow) {
        ...
        var now = Date.now();
        var recentErrors = this.errorHistory.filter(function (e) { return now - e.timestamp <= timeWindow; });
        var byCategory = {};
        var bySeverity = {};
    ...
    IntelligentErrorHandler.prototype.getError = function (errorId) {
        return this.errorHistory.find(function (e) { return e.errorId === errorId; }) ||
    ...
    IntelligentErrorHandler.prototype.resolveError = function (errorId, resolution) {
        ...
        if (error) {
            error.resolved = true;
            error.metadata = __assign(__assign({}, error.metadata), { resolution: resolution, resolvedAt: Date.now() });
            return true;
        }
        return false;
    };
    ...
    IntelligentErrorHandler.prototype.analyzeError = function (message, stack) {
        ...
        for (var _i = 0, KNOWN_ERROR_PATTERNS_1 = error_patterns_1.KNOWN_ERROR_PATTERNS; _i < KNOWN_ERROR_PATTERNS_1.length; _i++) {
        ...
        ErrorBoundaryWrapper.prototype.render = function () {
            if (this.state.hasError) {
                if (fallback && this.state.error && this.state.errorId) {
                    ...
                    return react_1.default.createElement(FallbackComponent, { error: this.state.error, errorId: this.state.errorId });
                }
                return react_1.default.createElement('div', {
                    ...
                    this.state.errorId && react_1.default.createElement('p', {
                        key: 'errorId',
