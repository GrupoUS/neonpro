...
var ErrorAnalysisSystem = /** @class */ (function () {
    ...
    ErrorAnalysisSystem.prototype.performAnalysis = function (message, stack) {
        ...
        for (var _i = 0, KNOWN_ERROR_PATTERNS_2 = KNOWN_ERROR_PATTERNS; _i < KNOWN_ERROR_PATTERNS_2.length; _i++) {
    ...
    ErrorAnalysisSystem.prototype.generateAnalysisReport = function () {
        ...
        return {
            summary: {
                ...
                topErrorPattern: ((_a = topPatterns[0]) === null || _a === void 0 ? void 0 : _a[0]) || 'None'
            },
            trends: trends,
    ...
    ErrorAnalysisSystem.prototype.getErrorById = function (errorId) {
        return this.errorHistory.find(function (error) { return error.errorId === errorId; });
    };
    /**
