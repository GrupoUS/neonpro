...
var ErrorRecoverySystem = /** @class */ (function () {
    ...
    ErrorRecoverySystem.prototype.initializeDefaultStrategies = function () {
        ...
        this.addRecoveryStrategy({
            name: 'network_retry',
            condition: function (error) { return error.errorType.includes('network') || error.errorType.includes('timeout'); },
            action: function (error) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.delay(Math.pow(2, this.getRetryCount(error.errorId)) * 1000)];
                        case 1:
                            _a.sent();
        ...
        this.addRecoveryStrategy({
            name: 'token_refresh',
            condition: function (error) { return error.errorType.includes('auth') || error.errorType.includes('unauthorized'); },
            action: function (error) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        this.addRecoveryStrategy({
            ...
            condition: function (error) { return error.errorType.includes('validation') || error.errorType.includes('invalid'); },
            action: function (error) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
    ...
    ErrorRecoverySystem.prototype.attemptRecovery = function (errorContext) {
        return __awaiter(this, void 0, void 0, function () {
            var applicableStrategies, _i, applicableStrategies_1, strategy, retryCount, success, recoveryError_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("\uD83D\uDD27 Attempting recovery for error: ".concat(errorContext.errorId));
                        applicableStrategies = Array.from(this.recoveryStrategies.values())
                            .filter(function (strategy) { return strategy.condition(errorContext); });
                        if (applicableStrategies.length === 0) {
                            console.log("\u274C No recovery strategy found for error: ".concat(errorContext.errorId));
                    ...
                    case 4:
                        ...
                        console.error("\u274C Recovery strategy failed: ".concat(strategy.name), recoveryError_1);
                        return [3 /*break*/, 5];
                    case 5:
                        _i++;
                        return [3 /*break*/, 1];
                    case 6:
                        console.log("\u274C All recovery strategies failed for error: ".concat(errorContext.errorId));
                        return [2 /*return*/, false];
                }
            });
        });
    ...
    ErrorRecoverySystem.prototype.scheduleRetry = function (errorContext) {
        var _a;
        var retryCount = ((_a = errorContext.metadata) === null || _a === void 0 ? void 0 : _a.retryCount) || 0;
        var maxRetries = 3;
        if (retryCount < maxRetries) {
            var backoffMs = Math.pow(2, retryCount) * 1000; // 1s, 2s, 4s
            setTimeout(function () {
                console.log("\uD83D\uDD04 Auto-retry attempt ".concat(retryCount + 1, " for error ").concat(errorContext.errorId));
                // Mark as recovery attempted
                errorContext.metadata = __assign(__assign({}, errorContext.metadata), { retryCount: retryCount + 1, retryAttempted: true, lastRetryAt: Date.now() });
            }, backoffMs);
        }
    };
    /**
    ...
    ErrorRecoverySystem.prototype.logRecoveryAction = function (errorContext, action) {
        console.log("\uD83D\uDD27 Recovery action for ".concat(errorContext.errorId, ": ").concat(action));
        errorContext.metadata = __assign(__assign({}, errorContext.metadata), { recoveryAction: action, recoveryAttemptedAt: Date.now() });
    };
    /**
    ...
    ErrorRecoverySystem.prototype.logRecoverySuccess = function (errorContext, strategyName) {
        var recoveredContext = __assign(__assign({}, errorContext), { metadata: __assign(__assign({}, errorContext.metadata), { recoveredAt: Date.now(), recoveryStrategy: strategyName, retryCount: this.getRetryCount(errorContext.errorId) }) });
    ...
    ErrorRecoverySystem.prototype.getRecoveryStats = function () {
        ...
        for (var _i = 0, _b = this.recoveryHistory; _i < _b.length; _i++) {
            var recovery = _b[_i];
            var strategy = ((_a = recovery.metadata) === null || _a === void 0 ? void 0 : _a.recoveryStrategy) || 'unknown';
    ...
    ErrorRecoverySystem.prototype.clearOldHistory = function (maxAge) {
        if (maxAge === void 0) { maxAge = 3600000; }
        var cutoff = Date.now() - maxAge;
        this.recoveryHistory = this.recoveryHistory.filter(function (recovery) { var _a; return (((_a = recovery.metadata) === null || _a === void 0 ? void 0 : _a.recoveredAt) || 0) > cutoff; });
    };
