...
function useHealthcareAuth() {
  ...
  var _a = client_1.trpc.auth.me.useQuery(undefined, {
      ...
      onError: (error) => {
        ...
        if (((_a = error.data) === null || _a === void 0 ? void 0 : _a.code) === "UNAUTHORIZED") {
          ...
          ((_b = error.data) === null || _b === void 0 ? void 0 : _b.code) === "FORBIDDEN"
        ) {
  ...
  var isMedicalProfessional =
    (user === null || user === void 0 ? void 0 : user.role) === "healthcare_professional" &&
    !!user.medical_license;
  // Validate admin access
  var isAdmin = (user === null || user === void 0 ? void 0 : user.role) === "admin";
  // Validate LGPD compliance
  var isLGPDCompliant =
    (user === null || user === void 0 ? void 0 : user.lgpd_consent) &&
  ...
  var canAccessPatientData = user && isLGPDCompliant && (isMedicalProfessional || isAdmin);
  return {
    user: user,
    isLoading: isLoading,
    error: error,
        ...
        case "FORBIDDEN":
          if (
            errorMessage === null || errorMessage === void 0
              ? void 0
              : errorMessage.includes("LGPD")
          ) {
            router.push("/consent");
          } else if (
            errorMessage === null || errorMessage === void 0
              ? void 0
              : errorMessage.includes("medical license")
          ) {
