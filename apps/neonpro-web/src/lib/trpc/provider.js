...
function TRPCProvider(_a) {
      ...
      defaultOptions: {
        queries: {
          ...
          retry: function (failureCount, error) {
            ...
            if (
              ((_a = error === null || error === void 0 ? void 0 : error.data) === null ||
              _a === void 0
                ? void 0
                : _a.code) === "UNAUTHORIZED" ||
              ((_b = error === null || error === void 0 ? void 0 : error.data) === null ||
              _b === void 0
                ? void 0
                : _b.code) === "FORBIDDEN"
            ) {
  ...
  return (
    <client_1.trpc.Provider client={client_1.trpcClient} queryClient={queryClient}>
