...
export const SessionValidation = {
   ...
   */
  checkConcurrentSessionLimit(activeSessions: UserSession[], userRole: string): boolean {
...
export const SecurityEventUtils = {
   ...
   */
  generateEventDescription(eventType: SecurityEventType, metadata?: Record<string, any>): string {
   ...
   */
  calculateEventRiskScore(eventType: SecurityEventType, metadata?: Record<string, any>): number {
