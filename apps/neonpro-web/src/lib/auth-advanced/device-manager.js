...
var DeviceManager = /** @class */ (function () {
    ...
    DeviceManager.prototype.registerDevice = function (userId, deviceInfo, location) {
        return __awaiter(this, void 0, void 0, function () {
            var fingerprint, trustScore, riskAssessment, deviceRegistration, existingDevice, _a, data, error, _b, data, error, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.findExistingDevice(userId, deviceRegistration.device_fingerprint)];
                    case 4:
                    ...
                    case 6: return [4 /*yield*/, this.supabase
                            .from('device_registrations')
                            .insert(__assign(__assign({}, deviceRegistration), { id: "device-".concat(Date.now(), "-").concat(Math.random().toString(36).substring(2)), created_at: new Date(), updated_at: new Date() }))
                            .select()
                            .single()];
                    case 7:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.logDeviceEvent(deviceId, 'trust_score_updated', {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        return [4 /*yield*/, this.logDeviceEvent(deviceId, 'device_blocked', { reason: reason })];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.calculateDeviceTrustScore(device.fingerprint_data, device.location)];
                    case 2:
                        trustScore = _a.sent();
                        return [4 /*yield*/, this.supabase
                                .from('device_registrations')
                    ...
                    case 3:
                        ...
                        if (error)
                            throw error;
                        return [4 /*yield*/, this.logDeviceEvent(deviceId, 'device_unblocked', { reason: reason })];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
    ...
    DeviceManager.prototype.detectDeviceType = function (deviceInfo) {
        var _a;
        var userAgent = ((_a = deviceInfo.userAgent) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || '';
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('device_events')
                                .insert({
                                id: "event-".concat(Date.now(), "-").concat(Math.random().toString(36).substring(2)),
                                device_id: deviceId,
    ...
    DeviceManager.prototype.calculateDeviceAnalytics = function (devices) {
        var analytics = {
            ...
            trustedDevices: devices.filter(function (d) { return d.is_trusted; }).length,
            suspiciousDevices: devices.filter(function (d) { return d.risk_indicators && d.risk_indicators.length > 0; }).length,
            blockedDevices: devices.filter(function (d) { return d.is_blocked; }).length,
            devicesByType: {},
            devicesByLocation: {},
            averageTrustScore: 0,
            riskDistribution: {
