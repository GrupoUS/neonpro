...
var SecurityMonitor = /** @class */ (function (_super) {
    ...
    SecurityMonitor.prototype.stopMonitoring = function (sessionId) {
        ...
        for (var _i = 0, _a = this.activeMonitoring.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], key = _b[0], interval = _b[1];
    ...
    SecurityMonitor.prototype.detectRapidRequests = function (userId, timestamp) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        max_requests_per_minute = config_1.SUSPICIOUS_ACTIVITY_PATTERNS.RAPID_REQUESTS.max_requests_per_minute;
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, ((recentEvents === null || recentEvents === void 0 ? void 0 : recentEvents.length) || 0) > max_requests_per_minute];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        timeDiff = new Date(activity.timestamp).getTime() -
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (activity.user_agent &&
                    !this.isUserAgentSimilar(activity.user_agent, "".concat(session.browser_name, " ").concat(session.browser_version))) {
                    return [2 /*return*/, true];
                }
                return [2 /*return*/, false];
            });
    ...
    SecurityMonitor.prototype.calculateSessionRisk = function (session) {
        ...
        if (session.security_level === 'high')
            risk += 15;
        if (session.security_level === 'critical')
            risk += 30;
        return risk;
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, Math.max(0, 100 - device.trust_score) + (((_a = device.risk_indicators) === null || _a === void 0 ? void 0 : _a.length) || 0) * 5];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        avgRiskScore = events.reduce(function (sum, event) { return sum + event.risk_score; }, 0) / events.length;
                        criticalEvents = events.filter(function (event) { return event.severity === 'critical'; }).length;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('session_security_events')
                                .insert(__assign(__assign({}, event), { id: "event-".concat(Date.now(), "-").concat(Math.random().toString(36).substring(2)), created_at: new Date() }))];
                    case 1:
                        error = (_a.sent()).error;
                        if (error) {
    ...
    SecurityMonitor.prototype.calculateMetricsFromEvents = function (events) {
        ...
        metrics.criticalEvents = events.filter(function (e) { return e.severity === 'critical'; }).length;
        metrics.highRiskEvents = events.filter(function (e) {
            return e.severity === 'high' || e.severity === 'critical';
        }).length;
        metrics.blockedAttempts = events.filter(function (e) { return e.is_blocked; }).length;
        if (events.length > 0) {
            metrics.averageRiskScore = events.reduce(function (sum, e) { return sum + e.risk_score; }, 0) / events.length;
        }
        return metrics;
    };
    ...
    SecurityMonitor.prototype.isUserAgentSimilar = function (ua1, ua2) {
        ...
        var normalize = function (ua) { return ua.toLowerCase().replace(/[^a-z0-9]/g, ''); };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!session.location)
                            return [2 /*return*/];
                        if (!config_1.LOCATION_RISK_FACTORS.HIGH_RISK_COUNTRIES.includes(session.location.country)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.handleSecurityEvent({
                                session_id: session.id,
                                user_id: session.user_id,
