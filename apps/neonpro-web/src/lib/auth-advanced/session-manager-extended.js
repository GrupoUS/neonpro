...
var SessionManagerExtended = /** @class */ (function () {
    ...
    SessionManagerExtended.prototype.cleanupExpiredSessions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var now, _a, expiredSessions, selectError, updateError, _i, expiredSessions_1, session, sessionData, error_1;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.logSessionActivity(session.id, session.user_id, 'session_expired', {
                                cleanup_time: now,
                    ...
                    case 5:
                        sessionData = _d.sent();
                        if (sessionData) {
                            (_c = (_b = this.hooks).onSessionExpired) === null || _c === void 0 ? void 0 : _c.call(_b, sessionData);
                        }
                        _d.label = 6;
                    case 6:
                        _i++;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        deletedCount = (deletedLogs === null || deletedLogs === void 0 ? void 0 : deletedLogs.length) || 0;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this.calculateDeviceRisk(session.device_fingerprint)];
                    case 4:
                        deviceRisk = _a.sent();
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        if (!(securityEvent.severity === 'high' || securityEvent.severity === 'critical')) return [3 /*break*/, 3];
                    ...
                    case 3:
                        ...
                        if (securityEvent.severity === 'high' || securityEvent.severity === 'critical') {
                            (_b = (_a = this.hooks).onSecurityThreat) === null || _b === void 0 ? void 0 : _b.call(_a, securityEvent);
                        }
                        else {
                            (_d = (_c = this.hooks).onSuspiciousActivity) === null || _d === void 0 ? void 0 : _d.call(_c, securityEvent);
                        }
                        return [3 /*break*/, 5];
                    case 4:
                        error_5 = _e.sent();
    ...
    SessionManagerExtended.prototype.registerDevice = function (userId, deviceInfo) {
        return __awaiter(this, void 0, void 0, function () {
            var existingDevice, _a, updatedDevice, error_7, trustScore, riskIndicators, deviceRegistration, _b, newDevice, error, error_6;
            var _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                    ...
                    case 3: return [4 /*yield*/, this.calculateDeviceTrustScore(deviceInfo)];
                    case 4:
                        trustScore = _e.sent();
                    ...
                    case 6:
                        ...
                        // Call hook
                        (_d = (_c = this.hooks).onDeviceRegistered) === null || _d === void 0 ? void 0 : _d.call(_c, newDevice);
    ...
    // Audit Logging
    SessionManagerExtended.prototype.logSessionActivity = function (sessionId, userId, action, details) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, ((recentLogs === null || recentLogs === void 0 ? void 0 : recentLogs.length) || 0) > 60]; // More than 60 requests per minute
                }
            });
        });
    };
    ...
    SessionManagerExtended.prototype.temporarilyBlockUser = function (userId, minutes) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log("User ".concat(userId, " temporarily blocked for ").concat(minutes, " minutes"));
                return [2 /*return*/];
            });
        });
    };
