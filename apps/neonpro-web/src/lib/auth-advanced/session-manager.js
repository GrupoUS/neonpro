...
var SessionManagerService = /** @class */ (function () {
    ...
    SessionManagerService.prototype.createSession = function (userId, deviceInfo, loginMethod) {
        return __awaiter(this, void 0, void 0, function () {
            var device, location_1, securityLevel, sessionToken, refreshToken, accessToken, session, _a, sessionData, error, createdSession, error_1;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.logSessionActivity(createdSession.id, userId, 'session_created', {
                    ...
                    case 6:
                        ...
                        _d.sent();
                        // Log security event
                        return [4 /*yield*/, this.handleSecurityEvent({
                    ...
                    case 7:
                        ...
                        _d.sent();
                        // Call hook
                        (_c = (_b = this.hooks).onSessionCreated) === null || _c === void 0 ? void 0 : _c.call(_b, createdSession);
    ...
    SessionManagerService.prototype.refreshSession = function (sessionToken) {
        return __awaiter(this, void 0, void 0, function () {
            var session, newAccessToken, newRefreshToken, _a, updatedSession, error, refreshedSession, error_2;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 4:
                        ...
                        if (error) {
                            throw new SessionError('Failed to refresh session', 'SYSTEM_ERROR', session.id, session.user_id);
                        }
                        refreshedSession = updatedSession;
                        // Log activity
                        return [4 /*yield*/, this.logSessionActivity(session.id, session.user_id, 'session_refreshed', {
                    ...
                    case 5:
                        ...
                        _d.sent();
                        // Call hook
                        (_c = (_b = this.hooks).onSessionRefreshed) === null || _c === void 0 ? void 0 : _c.call(_b, refreshedSession);
    ...
    SessionManagerService.prototype.extendSession = function (sessionId, duration) {
        return __awaiter(this, void 0, void 0, function () {
            var session, userRole, policy, extensionDuration, maxDuration, newExpiryTime, _a, extendedSession, error, error_3;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (!((_b = policy.settings) === null || _b === void 0 ? void 0 : _b.session_extension_allowed)) {
                            throw new SessionError('Session extension not allowed', 'INSUFFICIENT_PERMISSIONS', sessionId, session.user_id);
                        }
                        extensionDuration = duration || this.config.defaultSessionDuration;
                        maxDuration = ((_c = policy.settings) === null || _c === void 0 ? void 0 : _c.max_session_duration) || this.config.maxSessionDuration;
                        newExpiryTime = new Date(Date.now() + Math.min(extensionDuration, maxDuration) * 60 * 1000);
                        return [4 /*yield*/, this.supabase
                                .from('user_sessions')
                                .update({
                    ...
                    case 3:
                        ...
                        if (error) {
                            throw new SessionError('Failed to extend session', 'SYSTEM_ERROR', sessionId, session.user_id);
                        }
                        // Log activity
                        return [4 /*yield*/, this.logSessionActivity(sessionId, session.user_id, 'session_extended', {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        error = (_c.sent()).error;
                        if (error) {
                            throw new SessionError('Failed to terminate session', 'SYSTEM_ERROR', sessionId, session.user_id);
                        }
                        // Log activity
                        return [4 /*yield*/, this.logSessionActivity(sessionId, session.user_id, 'session_terminated', {
                    ...
                    case 4:
                        ...
                        _c.sent();
                        // Call hook
                        (_b = (_a = this.hooks).onSessionTerminated) === null || _b === void 0 ? void 0 : _b.call(_a, session, reason);
                        return [3 /*break*/, 6];
                    case 5:
                        error_4 = _c.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // Log activity
                        return [4 /*yield*/, this.logSessionActivity('bulk', userId, 'session_terminated', {
    ...
    SessionManagerService.prototype.generateSecureToken = function () {
        return (0, uuid_1.v4)() + '-' + Date.now().toString(36) + '-' + Math.random().toString(36).substring(2);
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(activeSessions && activeSessions.length >= this.config.maxConcurrentSessions)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.supabase
                                .from('user_sessions')
                                .select('id')
                                .eq('user_id', userId)
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!device.is_trusted)
                    riskScore += 30;
                if (device.risk_indicators.length > 0)
                    riskScore += 20;
                // Location risk factor
                if ((0, config_1.isHighRiskLocation)(location.country))
                    riskScore += 40;
    ...
    SessionManagerService.prototype.logSessionActivity = function (sessionId, userId, action, details) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
