...
var SessionRoutes = /** @class */ (function () {
    ...
    SessionRoutes.prototype.createSession = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var body, userId, userRole, deviceInfo, location_1, clientIP, userAgent, deviceId, sessionData, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        body = _a.sent();
                        userId = body.userId, userRole = body.userRole, deviceInfo = body.deviceInfo, location_1 = body.location;
                        // Validate required fields
                        if (!userId || !userRole) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing required fields: userId, userRole' }, { status: 400 })];
                        }
                        // Validate user role
                        if (!utils_1.ValidationUtils.isValidRole(userRole)) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid user role' }, { status: 400 })];
                        }
                        clientIP = this.getClientIP(request);
                        userAgent = request.headers.get('user-agent') || 'unknown';
                        deviceId = void 0;
                        if (!deviceInfo) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.deviceManager.registerDevice(__assign(__assign({}, deviceInfo), { userId: userId, ipAddress: clientIP, userAgent: userAgent }))];
                    case 2:
                        deviceId = _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this.sessionManager.createSession({
                            userId: userId,
                            userRole: userRole,
                            deviceId: deviceId,
                            ipAddress: clientIP,
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create session' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get session' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        success = _a.sent();
                        if (!success) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update activity' }, { status: 400 })];
                        }
                        return [2 /*return*/, server_1.NextResponse.json({
                                success: true,
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update activity' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        success = _a.sent();
                        if (!success) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to extend session' }, { status: 400 })];
                        }
                        return [4 /*yield*/, this.sessionManager.getSession(sessionId)];
                    case 3:
                        session = _a.sent();
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to extend session' }, { status: 500 })];
                    case 7: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        success = _b.sent();
                        if (!success) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to terminate session' }, { status: 400 })];
                        }
                        if (!session) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.securityMonitor.logSecurityEvent({
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to terminate session' }, { status: 500 })];
                    case 7: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get user sessions' }, { status: 500 })];
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        body = _b.sent();
                        _a = body.reason, reason = _a === void 0 ? 'admin_action' : _a, excludeSessionId = body.excludeSessionId;
                        return [4 /*yield*/, this.sessionManager.terminateUserSessions(userId, reason, excludeSessionId)];
                    case 3:
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to terminate user sessions' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!sessionId) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Session ID required' }, { status: 400 })];
                        }
                        clientIP = this.getClientIP(request);
                        userAgent = request.headers.get('user-agent') || 'unknown';
                        return [4 /*yield*/, this.sessionManager.validateSession(sessionId, {
                                ipAddress: clientIP,
                                userAgent: userAgent,
                            })];
                    case 2:
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to validate session' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.sessionManager.getSessionMetrics({
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get session metrics' }, { status: 500 })];
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to cleanup sessions' }, { status: 500 })];
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    // Helper methods
    SessionRoutes.prototype.getClientIP = function (request) {
