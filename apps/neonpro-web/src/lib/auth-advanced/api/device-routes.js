...
var DeviceRoutes = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!userId || !deviceInfo) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing required fields: userId, deviceInfo' }, { status: 400 })];
                        }
                        clientIP = this.getClientIP(request);
                        userAgent = request.headers.get('user-agent') || 'unknown';
                        // Validate device info
                        if (!this.validateDeviceInfo(deviceInfo)) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid device information' }, { status: 400 })];
                        }
                        deviceRegistration = __assign(__assign({}, deviceInfo), { userId: userId, ipAddress: clientIP, userAgent: userAgent, registeredAt: new Date() });
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to register device' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get user devices' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get device' }, { status: 500 })];
                    case 4: return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (typeof trusted !== 'boolean') {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid trust value' }, { status: 400 })];
                        }
                        return [4 /*yield*/, this.deviceManager.getDevice(deviceId)];
                    case 2:
                        device = _a.sent();
                    ...
                    case 4:
                        success = _a.sent();
                        if (!success) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update device trust' }, { status: 400 })];
                        }
                        // Log security event
                        return [4 /*yield*/, this.securityMonitor.logSecurityEvent({
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update device trust' }, { status: 500 })];
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (typeof blocked !== 'boolean') {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid block value' }, { status: 400 })];
                        }
                        return [4 /*yield*/, this.deviceManager.getDevice(deviceId)];
                    case 2:
                        device = _a.sent();
                    ...
                    case 4:
                        success = _a.sent();
                        if (!success) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update device block status' }, { status: 400 })];
                        }
                        if (!blocked) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.sessionManager.terminateDeviceSessions(deviceId, 'device_blocked')];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6: 
                    ...
                    case 8:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update device block status' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.sessionManager.terminateDeviceSessions(deviceId, 'device_removed')];
                    case 3:
                        // Terminate all sessions for this device
                        _a.sent();
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to remove device' }, { status: 500 })];
                    case 7: return [2 /*return*/];
                }
            });
        });
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!deviceId || !fingerprint) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing required fields: deviceId, fingerprint' }, { status: 400 })];
                        }
                    ...
                    case 7:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to validate device' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.deviceManager.getDeviceAnalytics({
                                period: period,
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get device analytics' }, { status: 500 })];
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update device' }, { status: 500 })];
                    case 7: return [2 /*return*/];
                }
            });
        });
    ...
    DeviceRoutes.prototype.validateDeviceInfo = function (deviceInfo) {
        ...
        return required.every(function (field) { return deviceInfo[field]; });
    };
