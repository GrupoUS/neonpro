...
var SecurityRoutes = /** @class */ (function () {
    ...
    SecurityRoutes.prototype.getSecurityEvents = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var authResult, url, userId, severity, type, startDate, endDate, limit, offset, events, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.securityMonitor.getSecurityEvents({
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get security events' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.securityMonitor.getSecurityAlerts({
                                userId: userId || undefined,
                                severity: severity,
                                dismissed: dismissed,
                                limit: limit,
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get security alerts' }, { status: 500 })];
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        success = _b.sent();
                        if (!success) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to dismiss alert' }, { status: 400 })];
                        }
                        // Log security event
                        return [4 /*yield*/, this.securityMonitor.logSecurityEvent({
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to dismiss alert' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        userId = url.searchParams.get('userId');
                        return [4 /*yield*/, this.securityMonitor.getSecurityMetrics({
                                period: period,
                                userId: userId || undefined,
                            })];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get security metrics' }, { status: 500 })];
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    SecurityRoutes.prototype.reportSuspiciousActivity = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var body, type, details, _a, severity, clientIP, userAgent, authHeader, userId, sessionId, session, event_1, riskScore, error_5;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 6, , 7]);
                    ...
                    case 1:
                        body = _b.sent();
                        type = body.type, details = body.details, _a = body.severity, severity = _a === void 0 ? 'medium' : _a;
                        if (!type || !details) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing required fields: type, details' }, { status: 400 })];
                        }
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3: return [4 /*yield*/, this.securityMonitor.logSecurityEvent({
                    ...
                    case 4:
                        event_1 = _b.sent();
                        return [4 /*yield*/, this.securityMonitor.calculateRiskScore({
                                userId: userId,
                                sessionId: sessionId,
                                ipAddress: clientIP,
                                userAgent: userAgent,
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to report suspicious activity' }, { status: 500 })];
    ...
    SecurityRoutes.prototype.getRiskAssessment = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var body, userId, sessionId, activity, clientIP, userAgent, riskScore, riskLevel, recommendations, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get risk assessment' }, { status: 500 })];
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!ipAddress || !reason) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing required fields: ipAddress, reason' }, { status: 400 })];
                        }
                        // Validate IP address format
                        if (!utils_1.ValidationUtils.isValidIP(ipAddress)) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid IP address format' }, { status: 400 })];
                        }
                        return [4 /*yield*/, this.securityMonitor.blockIP(ipAddress, reason, duration)];
                    case 3:
                        success = _a.sent();
                        if (!success) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to block IP address' }, { status: 400 })];
                        }
                        // Log security event
                        return [4 /*yield*/, this.securityMonitor.logSecurityEvent({
                                type: 'ip_blocked',
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to block IP address' }, { status: 500 })];
                    case 6: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        success = _a.sent();
                        if (!success) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to unblock IP address' }, { status: 400 })];
                        }
                        // Log security event
                        return [4 /*yield*/, this.securityMonitor.logSecurityEvent({
                                type: 'ip_unblocked',
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to unblock IP address' }, { status: 500 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get blocked IPs' }, { status: 500 })];
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    SecurityRoutes.prototype.exportSecurityReport = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var authResult, url, format, startDate, endDate, includeEvents, includeAlerts, includeMetrics, report, headers, error_10;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.securityMonitor.exportSecurityReport({
                                format: format,
                                startDate: startDate ? new Date(startDate) : undefined,
                                endDate: endDate ? new Date(endDate) : undefined,
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to export security report' }, { status: 500 })];
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    SecurityRoutes.prototype.getSecurityRecommendations = function (riskScore, riskLevel) {
        ...
        if (riskLevel === 'critical') {
            recommendations.push('Immediately terminate all user sessions', 'Block IP address temporarily', 'Require MFA for next login', 'Review and audit user account', 'Consider account suspension');
        }
        else if (riskLevel === 'high') {
            recommendations.push('Require MFA for sensitive operations', 'Monitor user activity closely', 'Consider device re-verification', 'Review recent login patterns');
        }
        else if (riskLevel === 'medium') {
            recommendations.push('Enable additional monitoring', 'Consider MFA prompt', 'Review device trust level');
        }
