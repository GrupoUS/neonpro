...
exports.ENV_CONFIGS = exports.REDIS_CONFIG = exports.WEBSOCKET_CONFIG = exports.SUSPICIOUS_ACTIVITY_PATTERNS = exports.LOCATION_RISK_FACTORS = exports.DEVICE_TRUST_FACTORS = exports.SECURITY_EVENT_RISK_SCORES = exports.SESSION_POLICIES = exports.DEFAULT_SESSION_CONFIG = void 0;
...
exports.ENV_CONFIGS = {
    development: __assign(__assign({}, exports.DEFAULT_SESSION_CONFIG), { enableDeviceFingerprinting: false, enableLocationTracking: false, riskScoreThreshold: 90, cleanupInterval: 5 }),
    staging: __assign(__assign({}, exports.DEFAULT_SESSION_CONFIG), { riskScoreThreshold: 80, cleanupInterval: 30 }),
