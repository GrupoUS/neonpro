      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            if (dbError) {
              throw new types_1.SessionError(
                "Failed to renew session in database",
                "SYSTEM_ERROR",
                { error: dbError },
              );
            }
          ...
          case 5:
            ...
            throw new types_1.SessionError("Failed to renew session", "SYSTEM_ERROR", {
              error: error_3,
            });
          case 6:
            return [2 /*return*/];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 4:
            ...
            if (dbError) {
              throw new types_1.SessionError(
                "Failed to terminate session in database",
                "SYSTEM_ERROR",
                { error: dbError },
              );
            }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            _a.sent();
            // Emit event
            this.emit("all_sessions_terminated", {
              userId: userId,
              reason: reason,
          ...
          case 3:
            error_5 = _a.sent();
            throw new types_1.SessionError("Failed to terminate all sessions", "SYSTEM_ERROR", {
              error: error_5,
            });
          case 4:
            return [2 /*return*/];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (error) {
              throw new types_1.SessionError("Failed to fetch user sessions", "SYSTEM_ERROR", {
                error: error,
              });
            }
          ...
          case 2:
            ...
            throw new types_1.SessionError("Failed to get user sessions", "SYSTEM_ERROR", {
              error: error_6,
            });
          case 3:
            return [2 /*return*/];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) {
              throw new types_1.SessionError("Failed to fetch active sessions", "SYSTEM_ERROR", {
                error: error,
              });
            }
            return [2 /*return*/, data.map(this.mapDatabaseToSession)];
          case 2:
            ...
            throw new types_1.SessionError("Failed to get active sessions", "SYSTEM_ERROR", {
              error: error_7,
            });
          case 3:
            return [2 /*return*/];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            query = this.supabase.from("user_sessions").select("*", { count: "exact" });
            // Apply filters
            if (params.filter) {
          ...
          case 1:
            ...
            if (error) {
              throw new types_1.SessionError("Failed to search sessions", "SYSTEM_ERROR", {
                error: error,
              });
            }
            return [
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (fetchError) {
              throw new types_1.SessionError("Failed to fetch expired sessions", "SYSTEM_ERROR", {
                error: fetchError,
              });
            }
          ...
          case 2:
            ...
            if (updateError) {
              throw new types_1.SessionError("Failed to update expired sessions", "SYSTEM_ERROR", {
                error: updateError,
              });
            }
          ...
          case 5:
            ...
            throw new types_1.SessionError("Failed to cleanup expired sessions", "SYSTEM_ERROR", {
              error: error_9,
            });
          case 6:
            return [2 /*return*/];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            activityRecord = __assign(__assign({}, activity), {
              sessionId: sessionId,
              timestamp: new Date(),
            });
            return [
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            cached = _a.sent();
            if (!cached) return [2 /*return*/, null];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.redis.setex("session:".concat(session.id), ttl, JSON.stringify(session)),
            ];
          case 1:
            _a.sent();
            _a.label = 2;
