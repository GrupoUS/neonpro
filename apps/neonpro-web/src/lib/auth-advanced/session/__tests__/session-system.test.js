        ...
        return __generator(this, (_b) => {
          switch (_b.label) {
            ...
            case 1:
              ...
              (0, vitest_1.expect)(
                (_a = result.session) === null || _a === void 0 ? void 0 : _a.userId,
              ).toBe(mockUser.id);
        ...
        return __generator(this, (_b) => {
          switch (_b.label) {
            case 0:
              ...
              renewedSession = __assign(__assign({}, sessionNeedingRenewal), {
                sessionToken: (0, utils_1.generateSessionToken)(),
                expiresAt: new Date(Date.now() + mockSessionConfig.sessionTimeout),
                updatedAt: new Date(),
              });
            ...
            case 1:
              ...
              (0, vitest_1.expect)(result.success).toBe(true);
              (0, vitest_1.expect)(
                (_a = result.session) === null || _a === void 0 ? void 0 : _a.sessionToken,
              ).not.toBe(sessionNeedingRenewal.sessionToken);
              return [2 /*return*/];
          }
        });
      }),
        ...
        return __generator(this, (_b) => {
          switch (_b.label) {
            ...
            case 1:
              ...
              (0, vitest_1.expect)(
                (_a = result.device) === null || _a === void 0 ? void 0 : _a.deviceType,
              ).toBe("desktop");
              return [2 /*return*/];
          }
        });
        ...
        return __generator(this, (_b) => {
          switch (_b.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                deviceManager.validateDevice(mockUser.id, mockDeviceFingerprint),
              ];
            case 1:
              result = _b.sent();
              (0, vitest_1.expect)(result.valid).toBe(true);
              (0, vitest_1.expect)(
                (_a = result.device) === null || _a === void 0 ? void 0 : _a.isTrusted,
              ).toBe(true);
...
(0, vitest_1.describe)("Session Utilities", () => {
  ...
  (0, vitest_1.describe)("isSessionExpired", () => {
    (0, vitest_1.it)("should correctly identify expired sessions", () => {
      ...
      var expiredSession = __assign(__assign({}, activeSession), {
  ...
  (0, vitest_1.describe)("needsRenewal", () => {
    (0, vitest_1.it)("should correctly identify sessions needing renewal", () => {
      ...
      var freshSession = __assign(__assign({}, sessionNeedingRenewal), {
        ...
        return __generator(this, (_b) => {
          switch (_b.label) {
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                sessionSystem.validateSession(createResult.session.sessionToken),
              ];
            case 3:
              validateResult = _b.sent();
              (0, vitest_1.expect)(
                (_a = validateResult.session) === null || _a === void 0 ? void 0 : _a.securityScore,
              ).toBeLessThan(100);
              return [2 /*return*/];
          }
        });
