...
var AuditLogger = /** @class */ (function (_super) {
    ...
    function AuditLogger(supabase, options) {
        ...
        _this.bufferSize = (options === null || options === void 0 ? void 0 : options.bufferSize) || 100;
        _this.flushInterval = (options === null || options === void 0 ? void 0 : options.flushInterval) || 5000;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        logEntry = {
                            ...
                            details: __assign(__assign({}, params.details), { eventId: eventId, source: 'session_manager' }),
    ...
    AuditLogger.prototype.logSecurityEvent = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.logSessionEvent(__assign(__assign({}, params), { severity: this.mapThreatToSeverity(params.threatLevel), details: __assign(__assign({}, params.details), { threatLevel: params.threatLevel, securityEvent: true }) }))];
                    case 1:
                        eventId = _a.sent();
                        // Create security event record
                        return [4 /*yield*/, this.createSecurityEventRecord({
                                eventId: eventId,
                                userId: params.userId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.logSessionEvent({
                                userId: params.userId,
                                clinicId: params.clinicId,
                                action: params.action,
                                severity: 'medium',
                                details: __assign(__assign({}, params.details), { dataType: params.dataType, legalBasis: params.legalBasis, purpose: params.purpose, lgpdCompliance: true }),
                                ipAddress: params.ipAddress,
                                userAgent: params.userAgent,
                                correlationId: params.correlationId
                            })];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (error) {
                            throw new types_1.SessionError('Failed to search audit logs', 'SYSTEM_ERROR', { error: error });
                        }
                    ...
                    case 3:
                        ...
                        throw new types_1.SessionError('Failed to search audit logs', 'SYSTEM_ERROR', { error: error_1 });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error) {
                            throw new types_1.SessionError('Failed to get correlated events', 'SYSTEM_ERROR', { error: error });
                        }
                    ...
                    case 2:
                        ...
                        throw new types_1.SessionError('Failed to get correlated events', 'SYSTEM_ERROR', { error: error_3 });
                    case 3: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error) {
                            throw new types_1.SessionError('Failed to generate audit statistics', 'SYSTEM_ERROR', { error: error });
                        }
                    ...
                    case 3:
                        ...
                        throw new types_1.SessionError('Failed to generate audit statistics', 'SYSTEM_ERROR', { error: error_4 });
                    case 4: return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        report = {
                            ...
                            consentEvents: events.filter(function (e) { return e.action.includes('consent'); }).length,
                            dataAccessEvents: events.filter(function (e) { return e.action === 'data_access'; }).length,
                            dataExportEvents: events.filter(function (e) { return e.action === 'data_exported'; }).length,
                            dataDeletionEvents: events.filter(function (e) { return e.action === 'data_deleted'; }).length,
                            complianceScore: 0,
                            violations: events.filter(function (e) { return e.severity === 'critical'; })
                        };
                        totalRequiredEvents = report.consentEvents + report.dataAccessEvents;
                        violationPenalty = report.violations.length * 10;
                        report.complianceScore = Math.max(0, Math.min(100, (totalRequiredEvents > 0 ? 80 : 60) - violationPenalty));
                        return [2 /*return*/, report];
                    case 2:
                        error_5 = _a.sent();
                        throw new types_1.SessionError('Failed to generate LGPD report', 'SYSTEM_ERROR', { error: error_5 });
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (filters, format) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.searchAuditLogs(__assign(__assign({}, filters), { limit: 10000 }))];
                    case 1:
                        result = _a.sent();
                        logs = result.logs;
                        data = void 0;
                    ...
                    case 3:
                        error_6 = _a.sent();
                        throw new types_1.SessionError('Failed to export audit logs', 'SYSTEM_ERROR', { error: error_6 });
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (fetchError) {
                            throw new types_1.SessionError('Failed to fetch old logs', 'SYSTEM_ERROR', { error: fetchError });
                        }
                        ...
                        return [4 /*yield*/, this.supabase
                                ...
                                .insert(oldLogs.map(function (log) { return (__assign(__assign({}, log), { archived_at: new Date().toISOString() })); }))];
                    case 2:
                        archiveError = (_b.sent()).error;
                        if (archiveError) {
                            throw new types_1.SessionError('Failed to archive logs', 'SYSTEM_ERROR', { error: archiveError });
                        }
                        return [4 /*yield*/, this.supabase
                                .from('session_audit_logs')
                                .delete()
                                .in('id', oldLogs.map(function (log) { return log.id; }))];
                    case 3:
                        deleteError = (_b.sent()).error;
                        if (deleteError) {
                            throw new types_1.SessionError('Failed to delete archived logs', 'SYSTEM_ERROR', { error: deleteError });
                        }
                        return [2 /*return*/, {
                    ...
                    case 4:
                        ...
                        throw new types_1.SessionError('Failed to archive old logs', 'SYSTEM_ERROR', { error: error_7 });
    ...
    AuditLogger.prototype.cleanupSensitiveData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var thirtyDaysAgo, _a, oldLogs, fetchError, cleanedCount, _i, oldLogs_1, log, cleanedDetails, error, error_8;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 6, , 7]);
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, cleanedCount];
                    case 6:
                        error_8 = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        dbEntries = entries.map(function (entry) { return ({
                            id: entry.id,
    ...
    AuditLogger.prototype.categorizeAction = function (action) {
        ...
        if (action.includes('consent') || action.includes('data_') || action.includes('privacy'))
            return 'lgpd';
        if (action.includes('system') || action.includes('configuration') || action.includes('maintenance'))
            return 'system';
        return 'user_activity';
    };
    AuditLogger.prototype.determineSeverity = function (action) {
        var criticalActions = [
            'session_hijack_detected', 'security_violation', 'unauthorized_access',
            'privilege_escalation', 'system_error'
        ];
        var highActions = [
            'login_failed', 'device_blocked', 'suspicious_activity', 'ip_blocked',
            'rate_limit_exceeded', 'consent_withdrawn'
        ];
        var mediumActions = [
            'session_terminated', 'device_registered', 'password_changed',
            'mfa_enabled', 'data_exported', 'data_deleted'
        ];
    ...
    AuditLogger.prototype.isLGPDRelevant = function (action) {
        var lgpdActions = [
            ...
            'privacy_policy_accepted', 'data_processing_logged', 'data_access'
        ];
    ...
    AuditLogger.prototype.determinePurpose = function (action) {
        if (action.includes('session'))
            return 'Session management and security';
        if (action.includes('login'))
            return 'User authentication';
        if (action.includes('device'))
            return 'Device security and management';
        if (action.includes('security'))
            return 'Security monitoring and protection';
        return 'System operation and compliance';
    };
    AuditLogger.prototype.determineLegalBasis = function (action) {
        if (action.includes('security') || action.includes('session'))
            return 'Legitimate interest';
        if (action.includes('consent'))
            return 'Consent';
        if (action.includes('data_'))
    ...
    AuditLogger.prototype.convertToCSV = function (logs) {
        var headers = [
            'ID', 'Session ID', 'User ID', 'Clinic ID', 'Action', 'Category',
            'Severity', 'IP Address', 'User Agent', 'Timestamp', 'Details'
        ];
