...
var DeviceManager = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.updateDeviceUsage(existingDevice.id, {
                                lastUsed: new Date(),
                    ...
                    case 3: return [4 /*yield*/, this.registerNewDevice(params, fingerprintHash)];
                    case 4:
                        newDevice = _a.sent();
                    ...
                    case 5:
                        error_1 = _a.sent();
                        throw new types_1.SessionError('Failed to register or validate device', 'SYSTEM_ERROR', { error: error_1 });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        isVerified = _b.sent();
                        if (!isVerified) {
                            throw new types_1.SessionError('Device trust verification failed', 'AUTHENTICATION_REQUIRED');
                        }
                    ...
                    case 2:
                        ...
                        if (error || !data) {
                            throw new types_1.SessionError('Failed to update device trust status', 'SYSTEM_ERROR', { error: error });
                        }
                        trustedDevice = this.mapDatabaseToDevice(data);
                        // Update cache
                        this.deviceCache.set(trustedDevice.id, trustedDevice);
                        // Log trust event
                        return [4 /*yield*/, this.logDeviceEvent({
                    ...
                    case 4:
                        ...
                        throw new types_1.SessionError('Failed to trust device', 'SYSTEM_ERROR', { error: error_3 });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        error = (_a.sent()).error;
                        if (error) {
                            throw new types_1.SessionError('Failed to block device', 'SYSTEM_ERROR', { error: error });
                        }
                    ...
                    case 4:
                        ...
                        throw new types_1.SessionError('Failed to block device', 'SYSTEM_ERROR', { error: error_4 });
                    case 5: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        error = (_a.sent()).error;
                        if (error) {
                            throw new types_1.SessionError('Failed to unblock device', 'SYSTEM_ERROR', { error: error });
                        }
                    ...
                    case 3:
                        ...
                        throw new types_1.SessionError('Failed to unblock device', 'SYSTEM_ERROR', { error: error_5 });
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error) {
                            throw new types_1.SessionError('Failed to fetch user devices', 'SYSTEM_ERROR', { error: error });
                        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error) {
                            throw new types_1.SessionError('Failed to fetch trusted devices', 'SYSTEM_ERROR', { error: error });
                        }
                        return [2 /*return*/, data.map(this.mapDatabaseToDevice)];
                    case 2:
                        error_7 = _b.sent();
                        ...
                        throw new types_1.SessionError('Failed to get trusted devices', 'SYSTEM_ERROR', { error: error_7 });
                    case 3: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error) {
                            throw new types_1.SessionError('Failed to search devices', 'SYSTEM_ERROR', { error: error });
                        }
                        return [2 /*return*/, data.map(this.mapDatabaseToDevice)];
                    case 2:
                        error_9 = _b.sent();
                        ...
                        throw new types_1.SessionError('Failed to search devices', 'SYSTEM_ERROR', { error: error_9 });
                    case 3: return [2 /*return*/];
                }
            });
        });
    ...
    DeviceManager.prototype.compareFingerprintSimilarity = function (fp1, fp2) {
        var fields = [
            ...
            'hardwareConcurrency', 'maxTouchPoints', 'pixelRatio', 'colorDepth'
        ];
        var matches = 0;
        var total = 0;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error) {
                            throw new types_1.SessionError('Failed to get device statistics', 'SYSTEM_ERROR', { error: error });
                        }
                        stats_1 = {
                            totalDevices: data.length,
                            trustedDevices: data.filter(function (d) { return d.is_trusted; }).length,
                            blockedDevices: data.filter(function (d) { return d.is_blocked; }).length,
                            deviceTypes: {
                                desktop: 0,
                                laptop: 0,
                                tablet: 0,
                        ...
                        totalUsage = data.reduce(function (sum, d) { return sum + (d.usage_count || 0); }, 0);
                    ...
                    case 2:
                        ...
                        throw new types_1.SessionError('Failed to get device statistics', 'SYSTEM_ERROR', { error: error_10 });
                    case 3: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (fetchError) {
                            throw new types_1.SessionError('Failed to fetch old devices', 'SYSTEM_ERROR', { error: fetchError });
                        }
                        ...
                        return [4 /*yield*/, this.supabase
                                .from('device_registrations')
                                .delete()
                                .in('id', oldDevices.map(function (d) { return d.id; }))];
                    case 2:
                        deleteError = (_b.sent()).error;
                        if (deleteError) {
                            throw new types_1.SessionError('Failed to delete old devices', 'SYSTEM_ERROR', { error: deleteError });
                        }
                        // Clear from cache
                    ...
                    case 3:
                        ...
                        throw new types_1.SessionError('Failed to cleanup old devices', 'SYSTEM_ERROR', { error: error_11 });
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        error = (_a.sent()).error;
                        if (error) {
                            throw new types_1.SessionError('Failed to register device in database', 'SYSTEM_ERROR', { error: error });
                        }
                        // Cache the device
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error || !data) {
                            throw new types_1.SessionError('Failed to update device usage', 'SYSTEM_ERROR', { error: error });
                        }
    ...
    DeviceManager.prototype.assessDeviceRisk = function (device) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                reasons = [];
                riskScore = 0;
                daysSinceRegistration = (Date.now() - device.registeredAt.getTime()) / (1000 * 60 * 60 * 24);
    ...
    DeviceManager.prototype.detectDeviceType = function (fingerprint) {
        ...
        if (/windows|macintosh|linux/i.test(userAgent)) {
            ...
            var _a = fingerprint.screenResolution.split('x').map(Number), width = _a[0], height = _a[1];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (blockedDevices) {
                            blockedDevices.forEach(function (device) { return _this.blockedDevices.add(device.id); });
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        error_15 = _a.sent();
