...
var getSessionConfig = function (environment) {
    ...
    if (environment === 'production') {
        return __assign(__assign({}, baseConfig), { sessionTimeout: 15 * 60 * 1000, requireDeviceVerification: true, maxConcurrentSessions: 2 });
    }
    return baseConfig;
};
// ============================================================================
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        redis = process.env.REDIS_URL
                            ...
                            : undefined;
                        config = getSessionConfig(process.env.NODE_ENV === 'production' ? 'production' : 'development');
                        return [4 /*yield*/, this.sessionSystem.initialize({
                                supabase: supabase,
                                redis: redis,
                                config: config,
                            })];
    ...
    SessionService.prototype.setupEventListeners = function () {
        ...
        this.sessionSystem.on('session_created', function (session) {
            ...
            console.log('✅ Session Created:', {
                ...
                deviceType: (_a = session.deviceFingerprint) === null || _a === void 0 ? void 0 : _a.platform,
            });
        });
        // Término de sessão
...
function authMiddleware(request) {
    return __awaiter(this, void 0, void 0, function () {
        var sessionToken, pathname, publicRoutes, isPublicRoute, sessionSystem, validation, response, clientIP, userAgent, renewal, response, requestHeaders, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    sessionToken = (_a = request.cookies.get('session_token')) === null || _a === void 0 ? void 0 : _a.value;
                    pathname = request.nextUrl.pathname;
                    publicRoutes = ['/login', '/register', '/forgot-password', '/api/auth'];
                    isPublicRoute = publicRoutes.some(function (route) { return pathname.startsWith(route); });
                    if (isPublicRoute) {
...
function createUserSession(userId, clinicId, request) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sessionService.initialize()];
                case 1:
                    _a.sent();
                    sessionSystem = sessionService.getSessionSystem();
                    clientIP = request.ip || request.headers.get('x-forwarded-for') || 'unknown';
                    ...
                    return [4 /*yield*/, sessionSystem.createSession({
                            userId: userId,
                            clinicId: clinicId,
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    user = _b.sent();
                    if (!user) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Invalid credentials' }, { status: 401 })];
                    }
                    return [4 /*yield*/, createUserSession(user.id, user.clinicId, request)];
                case 3:
                    sessionResult = _b.sent();
                    if (!sessionResult.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Failed to create session' }, { status: 500 })];
                    }
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (session) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'No valid session' }, { status: 401 })];
                    }
                    return [3 /*break*/, 3];
                case 2:
                    error_5 = _a.sent();
