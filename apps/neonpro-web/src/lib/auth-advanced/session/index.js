...
var SessionSystem = /** @class */ (function (_super) {
    ...
    function SessionSystem(supabase, config) {
        ...
        _this.securityMonitor = new security_monitor_1.SecurityMonitor(supabase, config.securityMonitoring);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new types_1.SessionError('Failed to initialize session system', 'SYSTEM_ERROR', { error: error_1 });
    ...
    SessionSystem.prototype.createSession = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, securityValidation, device, deviceValidation, requiresDeviceTrust, session, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        startTime = Date.now();
                    ...
                    case 3:
                        _a.sent();
                        throw new types_1.SessionError("Session creation blocked: ".concat(securityValidation.reason), 'SECURITY_VIOLATION', { riskScore: securityValidation.riskScore });
                    case 4: return [4 /*yield*/, this.deviceManager.registerOrValidateDevice({
                            userId: params.userId,
                            clinicId: params.clinicId,
                    ...
                    case 5:
                        device = _a.sent();
                        return [4 /*yield*/, this.deviceManager.validateDevice(device.deviceFingerprint, params.userId)];
                    case 6:
                    ...
                    case 7:
                        _a.sent();
                        throw new types_1.SessionError('Device validation failed', 'DEVICE_NOT_TRUSTED', { reasons: deviceValidation.reasons });
                    case 8:
                        requiresDeviceTrust = this.config.deviceManagement.requireTrustedDevices &&
                            !deviceValidation.isTrusted;
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, this.deviceManager.trustDevice({
                                deviceId: device.id,
                                userId: params.userId,
                    ...
                    case 13:
                        ...
                        throw new types_1.SessionError('Failed to create session', 'SYSTEM_ERROR', { error: error_2 });
                    case 14:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.securityMonitor.validateSessionActivity({
                                sessionId: session.id,
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.sessionManager.terminateSession(session.id, 'security_violation')];
                    case 5:
                        // Terminate suspicious session
                        _a.sent();
                        return [2 /*return*/, {
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, this.deviceManager.validateDevice(params.deviceFingerprint, session.userId)];
                    case 7:
                        deviceValidation = _a.sent();
                    ...
                    case 9:
                        ...
                        _a.label = 10;
                    case 10: return [4 /*yield*/, this.sessionManager.updateSessionActivity(session.id, {
                            ipAddress: params.ipAddress,
                            userAgent: params.userAgent,
                            location: params.location
                        })];
        ...
        return __awaiter(this, arguments, void 0, function (userId, reason) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        this.emit('user_sessions_terminated', { userId: userId, count: terminatedCount, reason: reason });
                        return [2 /*return*/, terminatedCount];
                    case 3:
                        error_5 = _a.sent();
                        throw new types_1.SessionError('Failed to terminate user sessions', 'SYSTEM_ERROR', { error: error_5 });
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_6 = _a.sent();
                        throw new types_1.SessionError('Failed to get user devices', 'SYSTEM_ERROR', { error: error_6 });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        throw new types_1.SessionError('Failed to trust device', 'SYSTEM_ERROR', { error: error_7 });
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        throw new types_1.SessionError('Failed to block device', 'SYSTEM_ERROR', { error: error_8 });
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_9 = _a.sent();
                        throw new types_1.SessionError('Failed to get security events', 'SYSTEM_ERROR', { error: error_9 });
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_10 = _a.sent();
                        throw new types_1.SessionError('Failed to block IP', 'SYSTEM_ERROR', { error: error_10 });
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_11 = _a.sent();
                        throw new types_1.SessionError('Failed to unblock IP', 'SYSTEM_ERROR', { error: error_11 });
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_12 = _a.sent();
                        throw new types_1.SessionError('Failed to search audit logs', 'SYSTEM_ERROR', { error: error_12 });
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_13 = _a.sent();
                        throw new types_1.SessionError('Failed to generate LGPD report', 'SYSTEM_ERROR', { error: error_13 });
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (filters, format) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_14 = _a.sent();
                        throw new types_1.SessionError('Failed to export audit logs', 'SYSTEM_ERROR', { error: error_14 });
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        error_15 = _b.sent();
                        throw new types_1.SessionError('Failed to get system stats', 'SYSTEM_ERROR', { error: error_15 });
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), sessionsCleanedUp = _a[0], devicesCleanedUp = _a[1], logsResult = _a[2];
                        return [4 /*yield*/, this.auditLogger.logSessionEvent({
                                userId: 'system',
                                clinicId: 'system',
                    ...
                    case 3:
                        error_16 = _b.sent();
                        throw new types_1.SessionError('Failed to perform maintenance', 'SYSTEM_ERROR', { error: error_16 });
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_17 = _a.sent();
                        throw new types_1.SessionError('Failed to update configuration', 'SYSTEM_ERROR', { error: error_17 });
                    case 3: return [2 /*return*/];
                }
            });
        });
    ...
    SessionSystem.prototype.validateConfig = function () {
        if (!this.config.sessionTimeout || this.config.sessionTimeout < 300000) {
            throw new types_1.SessionError('Session timeout must be at least 5 minutes', 'INVALID_CONFIG');
        }
        if (!this.config.renewalThreshold || this.config.renewalThreshold < 0.1 || this.config.renewalThreshold > 0.9) {
            throw new types_1.SessionError('Renewal threshold must be between 0.1 and 0.9', 'INVALID_CONFIG');
        }
