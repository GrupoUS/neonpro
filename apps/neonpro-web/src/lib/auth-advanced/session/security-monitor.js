...
var SecurityMonitor = /** @class */ (function (_super) {
    ...
    SecurityMonitor.prototype.validateSessionCreation = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var reasons, events, securityScore, ipReputation, geoRisk, deviceRisk, behaviorRisk, rateLimitViolation, concurrentViolation, allowed, event_1, _a, _b, error_1;
            var _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        _e.label = 3;
                    case 3: return [4 /*yield*/, this.analyzeDeviceRisk(params.deviceFingerprint, params.userId)];
                    case 4:
                        deviceRisk = _e.sent();
                        ...
                        return [4 /*yield*/, this.analyzeBehaviorRisk(params.userId, {
                    ...
                    case 7:
                        ...
                        allowed = securityScore >= this.config.suspiciousActivityThreshold &&
                    ...
                    case 9:
                        _b = null;
                        _e.label = 10;
                    case 10: return [4 /*yield*/, _a.apply(this, [(_c.details = (_d.geoRisk = _b,
    ...
    SecurityMonitor.prototype.validateSessionActivity = function (session) {
        return __awaiter(this, void 0, void 0, function () {
            var reasons, events, hijackingRisk, event_2, activityAnomaly, event_3, privilegeEscalation, event_4, allowed, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        reasons.push("Session hijacking detected: ".concat(hijackingRisk.indicators.join(', ')));
                        return [4 /*yield*/, this.createSecurityEvent({
                    ...
                    case 2:
                        ...
                        events.push(event_2);
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this.detectActivityAnomalies(session)];
                    case 4:
                    ...
                    case 5:
                        ...
                        events.push(event_3);
                        _a.label = 6;
                    case 6: return [4 /*yield*/, this.detectPrivilegeEscalation(session)];
                    case 7:
                        privilegeEscalation = _a.sent();
                        if (!privilegeEscalation.detected) return [3 /*break*/, 9];
                        reasons.push("Privilege escalation attempt: ".concat(privilegeEscalation.attempts.join(', ')));
                        return [4 /*yield*/, this.createSecurityEvent({
                                sessionId: session.id,
                                userId: session.userId,
    ...
    SecurityMonitor.prototype.assessGeographicRisk = function (location, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var reasons, riskScore, highRiskCountries, userLocations, typicalCountries, lastLocation, error_4;
            var _a;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (userLocations && userLocations.length > 0) {
                            typicalCountries = new Set(userLocations
                                .map(function (s) { var _a; return (_a = s.location) === null || _a === void 0 ? void 0 : _a.country; })
                                .filter(Boolean));
                            if (!typicalCountries.has(location.country)) {
                                reasons.push('Unusual country for user');
                                riskScore += 20;
                            }
                            lastLocation = (_a = userLocations[0]) === null || _a === void 0 ? void 0 : _a.location;
    ...
    SecurityMonitor.prototype.detectSessionHijacking = function (session) {
        return __awaiter(this, void 0, void 0, function () {
            var indicators, confidence, sessionHistory, uniqueIPs, userAgentHistory, uniqueUserAgents, activityPattern, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        indicators = [];
                    ...
                    case 2:
                        ...
                        if (sessionHistory && sessionHistory.length > 1) {
                            uniqueIPs = new Set(sessionHistory.map(function (h) { return h.ip_address; }));
                            if (uniqueIPs.size > 1) {
                    ...
                    case 3:
                        ...
                        if (userAgentHistory && userAgentHistory.length > 1) {
                            uniqueUserAgents = new Set(userAgentHistory.map(function (h) { return h.user_agent; }));
    ...
    SecurityMonitor.prototype.detectPrivilegeEscalation = function (session) {
        return __awaiter(this, void 0, void 0, function () {
            var attempts, riskLevel, adminAttempts, failedAttempts, roleAttempts, permissionAttempts, error_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        attempts = [];
                    ...
                    case 2:
                        ...
                        if (adminAttempts && adminAttempts.length > 0) {
                            failedAttempts = adminAttempts.filter(function (a) { return !a.success; });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, ((recentAttempts === null || recentAttempts === void 0 ? void 0 : recentAttempts.length) || 0) > 10];
                    case 2:
                        error_10 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, ((activeSessions === null || activeSessions === void 0 ? void 0 : activeSessions.length) || 0) >= this.config.maxConcurrentSessions];
                    case 2:
                        error_11 = _a.sent();
                        return [2 /*return*/, false];
                    case 3: return [2 /*return*/];
    ...
    SecurityMonitor.prototype.isImpossibleTravel = function (lastLocation, currentLocation) {
        ...
        var distance = this.calculateDistance(lastLocation.latitude, lastLocation.longitude, currentLocation.latitude, currentLocation.longitude);
    ...
    SecurityMonitor.prototype.hasAutomationIndicators = function (fingerprint) {
        // Check for automation indicators
        return (fingerprint.hardwareConcurrency > 16 || // Unusual CPU count
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (sessions && sessions.length > 0) {
                            loginHours = sessions.map(function (s) { return new Date(s.created_at).getHours(); });
                            profile_1.typicalLoginHours = __spreadArray([], new Set(loginHours), true);
                            // Extract known IPs
                            sessions.forEach(function (s) { return profile_1.knownIPs.add(s.ip_address); });
                            locations = sessions
                                .map(function (s) { return s.location; })
                                .filter(Boolean)
                                .map(function (l) { return "".concat(l.country, "-").concat(l.region); });
                            profile_1.typicalLocations = __spreadArray([], new Set(locations), true);
                            durations = sessions
                                .filter(function (s) { return s.terminated_at; })
                                .map(function (s) { return new Date(s.terminated_at).getTime() - new Date(s.created_at).getTime(); });
                            profile_1.averageSessionDuration = durations.length > 0 ?
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, (attempts === null || attempts === void 0 ? void 0 : attempts.length) || 0];
                    case 2:
                        error_13 = _a.sent();
                        return [2 /*return*/, 0];
                    case 3: return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (blockedIPs) {
                            blockedIPs.forEach(function (ip) { return _this.blockedIPs.add(ip.ip_address); });
                        }
                        return [4 /*yield*/, this.supabase
                                .from('suspicious_ips')
                                .select('ip_address')];
                    case 2:
                        ...
                        if (suspiciousIPs) {
                            suspiciousIPs.forEach(function (ip) { return _this.suspiciousIPs.add(ip.ip_address); });
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        error_14 = _a.sent();
