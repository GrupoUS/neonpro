...
function useSession() {
    ...
    var _d = (0, react_1.useState)('idle'), sessionState = _d[0], setSessionState = _d[1];
    ...
    (0, react_1.useEffect)(function () {
        ...
        return function () { return stopHeartbeat(); };
    ...
    var createSession = function (userId, deviceInfo, location) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var terminateSession = function () { return __awaiter(_this, void 0, void 0, function () {
        var err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var updateActivity = function () { return __awaiter(_this, void 0, void 0, function () {
        var err_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    ...
                    setSession(function (prev) { return prev ? __assign(__assign({}, prev), { last_activity: new Date() }) : null; });
                    return [3 /*break*/, 4];
                case 3:
                    err_5 = _a.sent();
    ...
    var validateSession = function () { return __awaiter(_this, void 0, void 0, function () {
        var isValid, err_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var startHeartbeat = function () {
        ...
        heartbeatRef.current = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            var isValid, err_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
function useSessionSecurity() {
    ...
    var _c = (0, react_1.useState)(0), riskScore = _c[0], setRiskScore = _c[1];
    ...
    var setupSecurityEventListeners = function () {
        ...
        securityMonitor.on('monitoring_started', function () { return setIsMonitoring(true); });
        securityMonitor.on('monitoring_stopped', function () { return setIsMonitoring(false); });
    };
    var cleanupSecurityEventListeners = function () {
        securityMonitor.removeAllListeners();
    };
    var handleSecurityEvent = function (alert) {
        setAlerts(function (prev) { return __spreadArray([alert], prev.slice(0, 49), true); }); // Keep last 50 alerts
    ...
    var calculateRiskScore = function (sessionId) { return __awaiter(_this, void 0, void 0, function () {
        var mockRiskScore;
        return __generator(this, function (_a) {
            try {
    ...
    var blockSession = function (sessionId, reason) { return __awaiter(_this, void 0, void 0, function () {
        var event_1, err_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function useSessionMetrics() {
    ...
    var _c = (0, react_1.useState)(null), error = _c[0], setError = _c[1];
    var _d = (0, react_1.useState)(false), autoRefresh = _d[0], setAutoRefresh = _d[1];
    ...
    (0, react_1.useEffect)(function () {
        ...
        return function () { return stopAutoRefresh(); };
    }, [autoRefresh]);
    var fetchMetrics = function (timeRange) { return __awaiter(_this, void 0, void 0, function () {
        var mockMetrics;
        return __generator(this, function (_a) {
            try {
                setIsLoading(true);
                ...
                mockMetrics = {
                    ...
                    peakHours: Array.from({ length: 24 }, function (_, i) { return ({
                        hour: i,
    ...
    return {
        ...
        refresh: function () { return fetchMetrics(); },
    };
}
...
function useDeviceManagement() {
    ...
    var fetchUserDevices = function (userId) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var blockDevice = function (deviceId, reason) { return __awaiter(_this, void 0, void 0, function () {
        var err_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.sent();
                    // Update local state
                    setDevices(function (prev) { return prev.map(function (device) {
                        return device.id === deviceId
                            ? __assign(__assign({}, device), { is_blocked: true, is_trusted: false }) : device;
                    }); });
                    return [3 /*break*/, 4];
                case 2:
                    err_10 = _a.sent();
    ...
    var unblockDevice = function (deviceId, reason) { return __awaiter(_this, void 0, void 0, function () {
        var err_11;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    setDevices(function (prev) { return prev.map(function (device) {
                        return device.id === deviceId
                            ? __assign(__assign({}, device), { is_blocked: false }) : device;
                    }); });
                    return [3 /*break*/, 4];
                case 2:
                    err_11 = _a.sent();
    ...
    var updateDeviceTrust = function (deviceId, trustScore, reason) { return __awaiter(_this, void 0, void 0, function () {
        var err_12;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    setDevices(function (prev) { return prev.map(function (device) {
                        return device.id === deviceId
                            ? __assign(__assign({}, device), { trust_score: trustScore, is_trusted: trustScore >= 60 // Assuming 60 is the threshold
                             }) : device;
                    }); });
                    return [3 /*break*/, 4];
                case 2:
    ...
    return {
        ...
        refresh: function (userId) { return fetchUserDevices(userId); },
    };
}
