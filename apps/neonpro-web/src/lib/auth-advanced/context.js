  ...
  switch (action.type) {
    ...
    case "ADD_SECURITY_EVENT":
      return __assign(__assign({}, state), {
        securityEvents: __spreadArray([action.payload], state.securityEvents, true).slice(0, 100),
      });
    ...
    case "UPDATE_CONFIG":
      return __assign(__assign({}, state), {
        config: __assign(__assign({}, state.config), action.payload),
      });
    case "RESET_STATE":
...
function SessionProvider(_a) {
  ...
  var children = _a.children,
    ...
    userId = _a.userId;
  var _d = (0, react_1.useReducer)(
      sessionReducer,
      __assign(__assign({}, initialState), {
        config: __assign(__assign({}, config_1.DEFAULT_SESSION_CONFIG), customConfig),
      }),
    ),
    state = _d[0],
    dispatch = _d[1];
  ...
  var _e = react_1.default.useState(null),
    ws = _e[0],
    setWs = _e[1];
  var _f = react_1.default.useState(null),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                securityMonitor.calculateRiskScore(
    ...
    function (event) {
      ...
      switch (event.type) {
        ...
        case "device_blocked":
          if (
            event.data.deviceId ===
            ((_b = state.currentDevice) === null || _b === void 0 ? void 0 : _b.id)
          ) {
  ...
  var contextValue = __assign(__assign({}, state), {
    ...
    clearSecurityAlerts: clearSecurityAlerts,
