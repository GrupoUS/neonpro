...
var suspiciousActivityStore = new Map < string, number = (void 0).attempts;
lastAttempt: number;
blocked: boolean;
 >> ();
/**
...
function createAuthMiddleware(config) {
    ...
    return function authMiddleware(request, sessionManager, securityMonitor, deviceManager) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, clientIP, userAgent, deviceInfo, locationInfo, rateLimitResult, suspiciousCheck, sessionToken, session, deviceCheck, locationCheck, requestHeaders, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, new server_1.NextResponse('Rate limit exceeded', { status: 429 })];
                    case 3:
                    ...
                    case 4:
                        _a.sent();
                        return [2 /*return*/, new server_1.NextResponse('Access blocked due to suspicious activity', {
                                status: 403,
                            })];
                    case 5:
                        sessionToken = extractSessionToken(request);
                        if (!sessionToken && finalConfig.requireAuth) {
                            return [2 /*return*/, new server_1.NextResponse('Authentication required', { status: 401 })];
                        }
                    ...
                    case 11:
                        if (!(finalConfig.allowedRoles && !finalConfig.allowedRoles.includes(session.user_role))) return [3 /*break*/, 13];
                        return [4 /*yield*/, logSecurityEvent({
                    ...
                    case 12:
                        _a.sent();
                        return [2 /*return*/, new server_1.NextResponse('Insufficient permissions', { status: 403 })];
                    case 13:
                        // MFA requirement check
                        if (finalConfig.requireMFA && !session.mfa_verified) {
                            return [2 /*return*/, new server_1.NextResponse('MFA verification required', { status: 403 })];
                        }
                    ...
                    case 15:
                        _a.sent();
                        _a.label = 16;
                    case 16: return [4 /*yield*/, checkLocationAnomaly(session, locationInfo, securityMonitor)];
                    case 17:
                    ...
                    return [4 /*yield*/, sessionManager.updateSessionActivity(sessionToken, {
                            ip_address: clientIP,
...
function checkLocationAnomaly(session, currentLocation, securityMonitor) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            try {
                distance = utils_1.AuthUtils.Location.calculateDistance(session.last_location.latitude, session.last_location.longitude, currentLocation.latitude, currentLocation.longitude);
