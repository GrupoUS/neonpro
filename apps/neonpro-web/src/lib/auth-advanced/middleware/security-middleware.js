        ...
        switch (_d.label) {
          ...
          case 4:
            return [
              4 /*yield*/,
              _a.apply(void 0, [
                ((_b.details = ((_c.payload = _d.sent()), _c)), _b),
                securityMonitor,
              ]),
            ];
          case 5:
            ...
            return [
              2 /*return*/,
              new server_1.NextResponse("Security threat detected", { status: 403 }),
            ];
          case 6:
          ...
          case 12:
            ...
            return [
              2 /*return*/,
              new server_1.NextResponse("Rate limit exceeded", {
                status: 429,
                headers: {
                  "Retry-After": "3600",
          ...
          case 14:
            ...
            if (!sessionSecurityCheck.valid) {
              return [
                2 /*return*/,
                new server_1.NextResponse(sessionSecurityCheck.reason, {
          ...
          case 19:
            ...
            return [
              2 /*return*/,
              new server_1.NextResponse("Security check failed", { status: 500 }),
            ];
          case 20:
            return [2 /*return*/];
        }
    ...
    return __generator(this, function (_o) {
      switch (_o.label) {
        ...
        case 4:
          ...
          for (
            _m = 0, suspiciousHeaders_1 = suspiciousHeaders;
            _m < suspiciousHeaders_1.length;
            _m++
          ) {
...
function detectAnomalies(request, clientIP) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      ...
      missingHeaders = commonHeaders.filter(function (header) {
...
function getMonitoringStats() {
  return {
    activeRequests: Array.from(monitoringData.activeRequests.values()).reduce(function (
      sum,
      count,
    ) {
      return sum + count;
    ...
    totalAlerts: Array.from(monitoringData.alertCounts.values()).reduce(function (sum, count) {
      return sum + count;
    }, 0),
  };
}
