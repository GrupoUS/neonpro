...
exports.MiddlewarePresets =
  ...
  exports.blockIP =
  exports.clearBlockedIP =
  exports.getMonitoringStats =
  exports.createSecurityMiddleware =
  exports.clearSuspiciousActivity =
  exports.recordSuspiciousActivity =
...
function createCombinedMiddleware(sessionManager, securityMonitor, deviceManager, config) {
  ...
  var _a = config.auth,
    authConfig = _a === void 0 ? {} : _a,
    _b = config.security,
    securityConfig = _b === void 0 ? {} : _b,
    _c = config.enableAuth,
    enableAuth = _c === void 0 ? true : _c,
    _d = config.enableSecurity,
    enableSecurity = _d === void 0 ? true : _d;
  var authMiddleware = enableAuth ? (0, auth_middleware_2.createAuthMiddleware)(authConfig) : null;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              authMiddleware(request, sessionManager, securityMonitor, deviceManager),
            ];
          case 3:
            authResult = _a.sent();
...
exports.MiddlewareUtils = {
  ...
  isPublicRoute: function (request, publicRoutes) {
    ...
    var allPublicRoutes = __spreadArray(
      __spreadArray([], defaultPublicRoutes, true),
      publicRoutes,
      true,
    );
