...
(0, vitest_1.describe)("SecurityMonitor", () => {
  ...
  (0, vitest_1.describe)("logSecurityEvent", () => {
    (0, vitest_1.it)("should log a security event successfully", () =>
    ...
    (0, vitest_1.it)("should create alert for high severity events", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var event, alerts;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, vitest_1.it)("should trigger auto-block for critical events", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var event, isBlocked;
        return __generator(this, (_a) => {
          switch (_a.label) {
  ...
  (0, vitest_1.describe)("detectAnomalies", () => {
    (0, vitest_1.it)("should detect location anomalies", () =>
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 1:
              // First session - establish baseline
              _a.sent();
              anomalousSession = __assign(__assign({}, sessionData), {
                location: {
                  country: "RU",
                  region: "MOW",
                  city: "Moscow",
            ...
            case 2:
              ...
              (0, vitest_1.expect)(anomalies.some((a) => a.type === "location_anomaly")).toBe(true);
              return [2 /*return*/];
          }
        });
      }),
    );
    (0, vitest_1.it)("should detect device anomalies", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var sessionData, anomalousSession, anomalies;
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 2:
              anomalies = _a.sent();
              (0, vitest_1.expect)(anomalies.length).toBeGreaterThan(0);
              (0, vitest_1.expect)(anomalies.some((a) => a.type === "device_anomaly")).toBe(true);
              return [2 /*return*/];
          }
        });
      }),
    );
    (0, vitest_1.it)("should detect time-based anomalies", () =>
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 1:
              anomalies = _a.sent();
              (0, vitest_1.expect)(anomalies.some((a) => a.type === "time_anomaly")).toBe(true);
              return [2 /*return*/];
          }
        });
      }),
  ...
  (0, vitest_1.describe)("calculateRiskScore", () => {
    (0, vitest_1.it)("should calculate low risk score for normal session", () =>
      __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)("should calculate high risk score for suspicious session", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var sessionData, riskScore;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, vitest_1.it)("should increase risk score for untrusted device", () =>
      __awaiter(void 0, void 0, void 0, function () {
  ...
  (0, vitest_1.describe)("getSecurityAlerts", () => {
    (0, vitest_1.it)("should return security alerts for user", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var event, alerts;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, vitest_1.it)("should filter alerts by severity", () =>
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 3:
              highAlerts = _a.sent();
              (0, vitest_1.expect)(highAlerts.every((alert) => alert.severity === "high")).toBe(
                true,
              );
              return [2 /*return*/];
          }
  ...
  (0, vitest_1.describe)("dismissAlert", () => {
    (0, vitest_1.it)("should dismiss an alert successfully", () =>
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                securityMonitor.dismissAlert(alertId, "user123", "False positive"),
              ];
            case 3:
              success = _a.sent();
            ...
            case 4:
              ...
              dismissedAlert = updatedAlerts.find((a) => a.id === alertId);
              (0, vitest_1.expect)(
                dismissedAlert === null || dismissedAlert === void 0
                  ? void 0
    ...
    (0, vitest_1.it)("should return false for non-existent alert", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var success;
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, securityMonitor.dismissAlert("non-existent", "user123", "Test")];
            case 1:
              success = _a.sent();
  ...
  (0, vitest_1.describe)("blockIP", () => {
    (0, vitest_1.it)("should block an IP address", () =>
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                securityMonitor.blockIP("192.168.1.100", "Manual block", 60 * 60 * 1000),
              ];
            case 1:
              success = _a.sent();
              (0, vitest_1.expect)(success).toBe(true);
    ...
    (0, vitest_1.it)("should unblock an IP address", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var success, isBlocked;
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                securityMonitor.blockIP("192.168.1.100", "Test block", 60 * 60 * 1000),
              ];
            case 1:
              _a.sent();
  ...
  (0, vitest_1.describe)("getSecurityMetrics", () => {
    (0, vitest_1.it)("should return security metrics", () =>
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, securityMonitor.getSecurityMetrics("user123", "24h")];
            case 1:
              metrics = _a.sent();
  ...
  (0, vitest_1.describe)("isRateLimited", () => {
    (0, vitest_1.it)("should track rate limiting", () =>
      __awaiter(void 0, void 0, void 0, function () {
  ...
  (0, vitest_1.describe)("generateSecurityReport", () => {
    (0, vitest_1.it)("should generate a security report", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var report;
        return __generator(this, (_a) => {
          switch (_a.label) {
    ...
    (0, vitest_1.it)("should include recommendations in report", () =>
      __awaiter(void 0, void 0, void 0, function () {
        var event, report;
        return __generator(this, (_a) => {
          switch (_a.label) {
  ...
  (0, vitest_1.describe)("threat detection", () => {
    (0, vitest_1.it)("should detect brute force attacks", () =>
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 5:
              anomalies = _a.sent();
              (0, vitest_1.expect)(anomalies.some((a) => a.type === "brute_force")).toBe(true);
              return [2 /*return*/];
          }
        });
      }),
    );
    (0, vitest_1.it)("should detect session hijacking attempts", () =>
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 2:
              anomalies = _a.sent();
              (0, vitest_1.expect)(anomalies.some((a) => a.type === "session_hijacking")).toBe(
                true,
              );
              return [2 /*return*/];
          }
