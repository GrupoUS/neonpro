...
(0, vitest_1.describe)('DeviceManager', function () {
    ...
    (0, vitest_1.describe)('registerDevice', function () {
        (0, vitest_1.it)('should register a new device successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.it)('should reject duplicate device fingerprints for same user', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, vitest_1.expect)(deviceManager.registerDevice(deviceRegistration)).rejects.toThrow('Device already registered')];
                    case 2:
                        // Try to register duplicate
                        _a.sent();
                        return [2 /*return*/];
        ...
        (0, vitest_1.it)('should allow same fingerprint for different users', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        deviceRegistration2 = __assign(__assign({}, deviceRegistration1), { userId: 'user456' });
    ...
    (0, vitest_1.describe)('getDevice', function () {
        (0, vitest_1.it)('should retrieve an existing device', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        (0, vitest_1.expect)(device === null || device === void 0 ? void 0 : device.id).toBe(deviceId);
                        (0, vitest_1.expect)(device === null || device === void 0 ? void 0 : device.userId).toBe('user123');
                        (0, vitest_1.expect)(device === null || device === void 0 ? void 0 : device.name).toBe('MacBook Pro');
                        (0, vitest_1.expect)(device === null || device === void 0 ? void 0 : device.trusted).toBe(false); // Default value
                        (0, vitest_1.expect)(device === null || device === void 0 ? void 0 : device.blocked).toBe(false); // Default value
                        return [2 /*return*/];
                }
            });
        }); });
        (0, vitest_1.it)('should return null for non-existent device', function () { return __awaiter(void 0, void 0, void 0, function () {
            var device;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, deviceManager.getDevice('non-existent')];
                    case 1:
                        device = _a.sent();
    ...
    (0, vitest_1.describe)('getUserDevices', function () {
        (0, vitest_1.it)('should return all devices for a user', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        (0, vitest_1.expect)(devices.every(function (d) { return d.userId === userId; })).toBe(true);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, vitest_1.it)('should return empty array for user with no devices', function () { return __awaiter(void 0, void 0, void 0, function () {
            var devices;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, deviceManager.getUserDevices('user-no-devices')];
                    case 1:
                        devices = _a.sent();
    ...
    (0, vitest_1.describe)('validateDevice', function () {
        (0, vitest_1.it)('should validate device with correct fingerprint', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.it)('should reject device with incorrect fingerprint', function () { return __awaiter(void 0, void 0, void 0, function () {
            var deviceRegistration, deviceId, isValid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, vitest_1.it)('should reject validation for non-existent device', function () { return __awaiter(void 0, void 0, void 0, function () {
            var isValid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, deviceManager.validateDevice('non-existent', 'any-fingerprint')];
                    case 1:
                        isValid = _a.sent();
                        (0, vitest_1.expect)(isValid).toBe(false);
                        return [2 /*return*/];
    ...
    (0, vitest_1.describe)('updateDeviceTrust', function () {
        (0, vitest_1.it)('should update device trust status', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        device = _a.sent();
                        (0, vitest_1.expect)(device === null || device === void 0 ? void 0 : device.trusted).toBe(false);
                        return [4 /*yield*/, deviceManager.updateDeviceTrust(deviceId, true, 'User verified')];
                    case 3:
                        success = _a.sent();
                    ...
                    case 4:
                        ...
                        device = _a.sent();
                        (0, vitest_1.expect)(device === null || device === void 0 ? void 0 : device.trusted).toBe(true);
                        return [2 /*return*/];
                }
            });
        }); });
        (0, vitest_1.it)('should return false for non-existent device', function () { return __awaiter(void 0, void 0, void 0, function () {
            var success;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, deviceManager.updateDeviceTrust('non-existent', true, 'Test')];
                    case 1:
                        success = _a.sent();
    ...
    (0, vitest_1.describe)('blockDevice', function () {
        (0, vitest_1.it)('should block and unblock device', function () { return __awaiter(void 0, void 0, void 0, function () {
            var deviceRegistration, deviceId, device, success;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        device = _a.sent();
                        (0, vitest_1.expect)(device === null || device === void 0 ? void 0 : device.blocked).toBe(false);
                        return [4 /*yield*/, deviceManager.blockDevice(deviceId, true, 'Suspicious activity')];
                    case 3:
                        success = _a.sent();
                        (0, vitest_1.expect)(success).toBe(true);
                        return [4 /*yield*/, deviceManager.getDevice(deviceId)];
                    case 4:
                        ...
                        device = _a.sent();
                        (0, vitest_1.expect)(device === null || device === void 0 ? void 0 : device.blocked).toBe(true);
        ...
        (0, vitest_1.it)('should return false for non-existent device', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, deviceManager.blockDevice('non-existent', true, 'Test')];
                    case 1:
                        success = _a.sent();
                        (0, vitest_1.expect)(success).toBe(false);
                        return [2 /*return*/];
    ...
    (0, vitest_1.describe)('removeDevice', function () {
        (0, vitest_1.it)('should remove device successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var deviceRegistration, deviceId, device, success;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, vitest_1.it)('should return false for non-existent device', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, deviceManager.removeDevice('non-existent')];
                    case 1:
                        success = _a.sent();
                        (0, vitest_1.expect)(success).toBe(false);
                        return [2 /*return*/];
    ...
    (0, vitest_1.describe)('calculateTrustScore', function () {
        (0, vitest_1.it)('should calculate trust score for new device', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, vitest_1.it)('should give higher trust score to established devices', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        establishedDevice = __assign(__assign({}, newDevice), { id: 'device456', name: 'Established Device', fingerprint: 'established123device', registeredAt: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000), sessionCount: 50, trusted: true });
        ...
        (0, vitest_1.it)('should give lower trust score to blocked devices', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        blockedDevice = __assign(__assign({}, normalDevice), { id: 'device456', name: 'Blocked Device', fingerprint: 'blocked123device', blocked: true });
    ...
    (0, vitest_1.describe)('getDeviceAnalytics', function () {
        (0, vitest_1.it)('should return device analytics', function () { return __awaiter(void 0, void 0, void 0, function () {
            var analytics;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, deviceManager.getDeviceAnalytics({
                            period: '30d',
                            userId: 'user123',
                        })];
                    case 1:
        ...
        (0, vitest_1.it)('should filter analytics by user when specified', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, deviceManager.getDeviceAnalytics({
                                period: '30d',
                                userId: 'user123',
                            })];
                    case 3:
                    ...
                    case 4:
                        ...
                        (0, vitest_1.expect)(user1Analytics.totalDevices).toBeLessThanOrEqual(allAnalytics.totalDevices);
                        return [2 /*return*/];
                }
            });
        }); });
