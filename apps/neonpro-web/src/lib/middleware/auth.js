 ...
 */
var JWT_SECRET = new TextEncoder().encode(process.env.JWT_SECRET || 'fallback-secret-key-change-in-production');
/**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2: return [4 /*yield*/, getSupabaseUser(request)];
                case 3:
...
function requireAuth(requiredRole, requiredPermission) {
    ...
    return function (request) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, authenticateRequest(request)];
                case 1:
                    authResult = _a.sent();
