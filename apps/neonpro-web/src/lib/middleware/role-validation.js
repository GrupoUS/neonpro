...
function validateRole(request_1) {
    return __awaiter(this, arguments, void 0, function (request, options) {
        var supabase, _a, user, authError, _b, profile_1, profileError, hasAllPermissions, body, url, resourceOwnerId, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                    ...
                    if (options.requiredRole && options.requiredRole.length > 0) {
                        if (!options.requiredRole.includes(profile_1.role)) {
                            return [2 /*return*/, {
                                    ...
                                    user: user,
                                    profile: profile_1,
                                    error: "Acesso negado. Roles permitidas: ".concat(options.requiredRole.join(', ')),
                                    statusCode: 403
                                }];
                        }
                    }
                    ...
                    if (options.requiredPermission && options.requiredPermission.length > 0) {
                        ...
                        if (!hasAllPermissions) {
                            return [2 /*return*/, {
                                    ...
                                    user: user,
                                    profile: profile_1,
                                    error: "Permiss\u00F5es insuficientes. Requeridas: ".concat(options.requiredPermission.join(', ')),
                                    statusCode: 403
                                }];
                        }
                    }
                ...
                case 4:
                    ...
                    resourceOwnerId = body[options.resourceOwnerField] || url.searchParams.get(options.resourceOwnerField);
...
function withRoleValidation(handler, options) {
    ...
    return function (request) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, validateRole(request, options)];
                case 1:
                    validation = _a.sent();
                    if (!validation.success) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: validation.error }, { status: validation.statusCode || 403 })];
                    }
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (error || !profiles || profiles.length !== 2) {
                        return [2 /*return*/, { canManage: false, reason: 'Erro ao buscar informações dos usuários' }];
                    }
                    managerProfile = profiles.find(function (p) { return p.id === managerUserId; });
                    targetProfile = profiles.find(function (p) { return p.id === targetUserId; });
                    ...
                    return [2 /*return*/, {
                            canManage: canManage,
                            reason: canManage ? undefined : "Role ".concat(managerProfile.role, " n\u00E3o pode gerenciar role ").concat(targetProfile.role)
                        }];
                case 3:
                    error_2 = _b.sent();
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            metadata: __assign(__assign({}, metadata), { timestamp: new Date().toISOString(), user_agent: metadata.user_agent || 'unknown' })
                        })];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
