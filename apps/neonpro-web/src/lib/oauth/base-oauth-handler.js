...
var BaseOAuthHandler = /** @class */ (() => {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [4 /*yield*/, supabase.from("oauth_states").delete().eq("state_id", stateId)];
          case 3:
            // Delete the used state to prevent replay attacks
            _b.sent();
            return [
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            supabase = _b.sent();
            encryptedAccessToken = token_encryption_1.TokenEncryptionService.encryptToken(
              tokens.accessToken,
            );
          ...
          case 2:
            ...
            try {
              ...
              if (data.encrypted_refresh_token) {
                ...
                refreshToken =
                  token_encryption_1.TokenEncryptionService.decryptToken(refreshTokenData);
              }
              return [
                2 /*return*/,
                {
              ...
              throw new Error(
                "Failed to decrypt tokens: ".concat(
   ...
   */
  BaseOAuthHandler.prototype.shouldRefreshTokens = (tokens) => {
