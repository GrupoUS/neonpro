...
var WhatsAppOAuthHandler = /** @class */ ((_super) => {
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              ...
              fetch(
                ""
                  .concat(this.config.userInfoUrl, "?fields=id,name,email&access_token=")
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch(
                "".concat(this.config.userInfoUrl, "?access_token=").concat(token.accessToken),
                {
                  method: "GET",
                  headers: {
                    Accept: "application/json",
        ...
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch(
                "https://graph.facebook.com/v18.0/me/businesses?access_token=".concat(
                  token.accessToken,
                ),
                {
                  method: "GET",
          ...
          case 3:
            ...
            throw new Error(
              "Business accounts fetch failed: "
        ...
        switch (_b.label) {
            ...
            return [
              ...
              fetch(
                "https://graph.facebook.com/v18.0/"
                  .concat(businessId, "/phone_numbers?access_token=")
                  .concat(token.accessToken),
                {
                  method: "GET",
                  headers: {
          ...
          case 5:
            ...
            logger_1.logger.info("WhatsApp phone numbers fetch successful", {
              ...
              businessId: businessId,
              phoneNumberCount:
                ((_a = data.data) === null || _a === void 0 ? void 0 : _a.length) || 0,
            });
            return [2 /*return*/, data.data || []];
          case 6:
            error_7 = _b.sent();
            logger_1.logger.error("WhatsApp phone numbers fetch error", {
              error: error_7,
              businessId: businessId,
            });
