            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fetch("".concat(this.config.revokeUrl, "/").concat(token.refreshToken), {
                                method: 'DELETE',
                                headers: {
                                    'Accept': 'application/json',
                                    'User-Agent': 'NeonPro/1.0'
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        return [4 /*yield*/, fetch("".concat(this.config.userInfoUrl, "/").concat(token.accessToken), {
                                method: 'GET',
                                headers: {
                                    'Accept': 'application/json',
                                    'User-Agent': 'NeonPro/1.0'
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        return [4 /*yield*/, fetch('https://api.hubapi.com/integrations/v1/me', {
                                method: 'GET',
                                headers: {
                    ...
                    case 3:
                        ...
                        throw new Error("Portal info fetch failed: ".concat(response.status, " ").concat(response.statusText));
                    case 4: return [4 /*yield*/, response.json()];
                    case 5:
                        portalInfo = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        return [4 /*yield*/, fetch('https://api.hubapi.com/account-info/v3/details', {
                                method: 'GET',
                                headers: {
                                    'Authorization': "Bearer ".concat(token.accessToken),
                                    'Accept': 'application/json',
                    ...
                    case 3:
                        ...
                        throw new Error("Account info fetch failed: ".concat(response.status, " ").concat(response.statusText));
                    case 4: return [4 /*yield*/, response.json()];
                    case 5:
                        accountInfo = _a.sent();
