 ...
 */
var InstagramOAuthHandler = /** @class */ (function (_super) {
    ...
    InstagramOAuthHandler.prototype.validateInstagramConfig = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, axios_1.default.post(this.config.tokenUrl, {
                                client_id: this.config.clientId,
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, axios_1.default.get('https://graph.instagram.com/access_token', {
                                params: {
                    ...
                    case 4:
                        ...
                        if (axios_1.default.isAxiosError(error_1)) {
                            ...
                            throw new Error("Instagram token exchange failed: ".concat((errorData === null || errorData === void 0 ? void 0 : errorData.error_description) || error_1.message));
                        }
                        throw new Error("Token exchange failed: ".concat(error_1 instanceof Error ? error_1.message : 'Unknown error'));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get('https://graph.instagram.com/refresh_access_token', {
                                params: {
                    ...
                    case 2:
                        ...
                        if (axios_1.default.isAxiosError(error_2)) {
                            ...
                            throw new Error("Instagram token refresh failed: ".concat(((_b = errorData === null || errorData === void 0 ? void 0 : errorData.error) === null || _b === void 0 ? void 0 : _b.message) || error_2.message));
                        }
                        throw new Error("Token refresh failed: ".concat(error_2 instanceof Error ? error_2.message : 'Unknown error'));
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        profile = {
                            ...
                            isVerified: response.data.account_type === 'BUSINESS' || response.data.account_type === 'CREATOR'
                        };
                    ...
                    case 2:
                        ...
                        if (axios_1.default.isAxiosError(error_3)) {
                            ...
                            throw new Error("Instagram profile fetch failed: ".concat(((_b = errorData === null || errorData === void 0 ? void 0 : errorData.error) === null || _b === void 0 ? void 0 : _b.message) || error_3.message));
                        }
                        throw new Error("Profile fetch failed: ".concat(error_3 instanceof Error ? error_3.message : 'Unknown error'));
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (accessToken, limit) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.config.apiBaseUrl, "/me/media"), {
                                params: {
                    ...
                    case 2:
                        ...
                        if (axios_1.default.isAxiosError(error_5)) {
                            ...
                            throw new Error("Instagram media fetch failed: ".concat(((_b = errorData === null || errorData === void 0 ? void 0 : errorData.error) === null || _b === void 0 ? void 0 : _b.message) || error_5.message));
                        }
                        throw new Error("Media fetch failed: ".concat(error_5 instanceof Error ? error_5.message : 'Unknown error'));
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (accessToken, period) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.config.apiBaseUrl, "/me/insights"), {
                                params: {
                    ...
                    case 2:
                        ...
                        if (axios_1.default.isAxiosError(error_6)) {
                            ...
                            if (((_b = errorData === null || errorData === void 0 ? void 0 : errorData.error) === null || _b === void 0 ? void 0 : _b.code) === 100) {
                                return [2 /*return*/, []];
                            }
                            throw new Error("Instagram insights fetch failed: ".concat(((_c = errorData === null || errorData === void 0 ? void 0 : errorData.error) === null || _c === void 0 ? void 0 : _c.message) || error_6.message));
                        }
                        throw new Error("Insights fetch failed: ".concat(error_6 instanceof Error ? error_6.message : 'Unknown error'));
                    case 3: return [2 /*return*/];
                }
            });
        });
