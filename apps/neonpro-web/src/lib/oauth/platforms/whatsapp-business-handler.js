...
var WhatsAppBusinessOAuthHandler = /** @class */ ((_super) => {
        ...
        switch (_f.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch(
                "https://graph.facebook.com/v18.0/me?fields=id,name,email&access_token=".concat(
                  accessToken,
                ),
              ),
            ];
          ...
          case 2:
            throw new (_a.apply(types_1.OAuthError, _b.concat([_f.sent()])))();
          case 3:
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              fetch(
                "https://graph.facebook.com/v18.0/me/businesses?fields=whatsapp_business_accounts{id,name,currency,timezone_id,message_template_namespace}&access_token=".concat(
                  accessToken,
                ),
              ),
            ];
          ...
          case 6:
            ...
            _f.label = 7;
          case 7:
            return [4 /*yield*/, this.getPhoneNumbers(accessToken, whatsappAccounts)];
          case 8:
            ...
            _c = {
              ...
              profilePicture: "https://graph.facebook.com/v18.0/".concat(
                userData.id,
                "/picture?type=large",
              ),
            };
          ...
          case 9:
            return [2 /*return*/, ((_c.platformData = ((_d.permissions = _f.sent()), _d)), _c)];
          case 10:
            error_1 = _f.sent();
            if (error_1 instanceof types_1.OAuthError) {
              throw error_1;
            }
            throw new types_1.OAuthError(
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            throw new (_a.apply(types_1.OAuthError, _b.concat([_c.sent()])))();
          case 3:
        ...
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch(
                "https://graph.facebook.com/v18.0/me/businesses?fields=whatsapp_business_accounts&access_token=".concat(
                  accessToken,
                ),
              ),
            ];
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("https://graph.facebook.com/v18.0/me?access_token=".concat(accessToken)),
            ];
          case 1:
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              fetch("https://graph.facebook.com/v18.0/".concat(userData.id, "/permissions"), {
                method: "DELETE",
                headers: {
  ...
  WhatsAppBusinessOAuthHandler.prototype.getPhoneNumbers = function (
    accessToken,
    whatsappAccounts,
  ) {
    return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, (_b) => {
                switch (_b.label) {
                    ...
                    return [
                      ...
                      fetch(
                        "https://graph.facebook.com/v18.0/"
                          .concat(account.id, "/phone_numbers?access_token=")
                          .concat(accessToken),
                      ),
                    ];
                  case 1:
                  ...
                  case 4:
                    error_3 = _b.sent();
                    console.warn(
                      "Failed to get phone numbers for WABA ".concat(account.id, ":"),
                      error_3,
                    );
                    return [3 /*break*/, 5];
                  case 5:
        ...
        switch (_d.label) {
          case 0:
            ...
            return [
              ...
              fetch(
                "https://graph.facebook.com/v18.0/"
                  .concat(userId, "/permissions?access_token=")
                  .concat(accessToken),
              ),
            ];
          case 1:
  ...
  WhatsAppBusinessOAuthHandler.prototype.sendMessage = function (
    accessToken,
    phoneNumberId,
    to,
    message,
      ...
      return __generator(this, (_c) => {
        switch (_c.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("https://graph.facebook.com/v18.0/".concat(phoneNumberId, "/messages"), {
                method: "POST",
                headers: {
        ...
        switch (_c.label) {
          case 0:
            ...
            return [
              ...
              fetch(
                "https://graph.facebook.com/v18.0/"
                  .concat(wabaId, "/message_templates?access_token=")
                  .concat(accessToken),
              ),
            ];
          case 1:
