  ...
  function FacebookOAuthHandler() {
    ...
    var config = {
      ...
      redirectUri:
        ...
        "".concat(process.env.NEXT_PUBLIC_APP_URL, "/api/oauth/facebook/callback"),
      scopes: [
        "public_profile",
        "email",
        "pages_show_list",
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              axios_1.default.get("".concat(this.config.tokenUrl, "?").concat(params.toString())),
            ];
          case 3:
            response = _a.sent();
          ...
          case 4:
            error_1 = _a.sent();
            throw new Error(
              "Failed to exchange code for tokens: ".concat(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            error_2 = _a.sent();
            throw new Error(
              "Failed to refresh Facebook tokens: ".concat(
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              axios_1.default.get("".concat(this.config.apiBaseUrl, "/me/accounts"), {
                params: {
                  access_token: accessToken,
                },
              }),
          ...
          case 3:
            ...
            pageCount =
              ((_a = pagesResponse.data.data) === null || _a === void 0 ? void 0 : _a.length) || 0;
            return [3 /*break*/, 5];
          case 4:
            error_3 = _d.sent();
          ...
          case 5:
            return [
              2 /*return*/,
              {
                ...
                profilePicture:
                  (_c = (_b = userData.picture) === null || _b === void 0 ? void 0 : _b.data) ===
                    null || _c === void 0
                    ? void 0
                    : _c.url,
          ...
          case 6:
            error_4 = _d.sent();
            throw new Error(
              "Failed to get Facebook user profile: ".concat(
          ...
          case 1:
            ...
            return [
              ...
              axios_1.default.delete(
                "".concat(this.config.apiBaseUrl, "/").concat(userResponse.data.id, "/permissions"),
                {
                  params: {
                    access_token: accessToken,
                  },
