...
exports.ResolutionAlgorithmFactory = exports.RuleBasedAlgorithm = exports.GeneticAlgorithmOptimizer = exports.ConstraintProgrammingAlgorithm = exports.MIPOptimizationAlgorithm = void 0;
...
var MIPOptimizationAlgorithm = /** @class */ (function () {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                explanation: "MIP optimization found ".concat(solution.feasible ? 'optimal' : 'infeasible', " solution with ").concat(proposedChanges.length, " changes"),
                                alternatives: (_a = solution.alternativeSolutions) === null || _a === void 0 ? void 0 : _a.map(function (alt) { return _this.convertAlternativeToResult(alt, conflict, context); })
                            }];
                    case 3:
                        error_1 = _b.sent();
                        throw new conflict_types_1.ResolutionExecutionError('MIP optimization failed', this.type, conflict.id, performance.now() - startTime, { originalError: error_1 });
    ...
    MIPOptimizationAlgorithm.prototype.calculateSuccessProbability = function (conflict, context) {
        ...
        var constraintPenalty = Math.max(0, (context.systemConstraints.resourceCapacityLimits.length - 5) * 0.02);
    ...
    MIPOptimizationAlgorithm.prototype.defineDecisionVariables = function (conflict, context) {
        ...
        context.availableAppointments.forEach(function (appointment) {
            ...
            for (var slot = 0; slot < 48; slot++) { // 30-minute slots in a day
                variables.set("x_".concat(appointment.id, "_").concat(slot), { type: 'binary', coefficient: 0 });
            }
        });
        return variables;
    };
    MIPOptimizationAlgorithm.prototype.defineConstraints = function (conflict, context) {
        ...
        context.availableAppointments.forEach(function (appointment) {
            var constraint = {
                type: 'equality',
                value: 1,
                variables: Array.from({ length: 48 }, function (_, slot) { return "x_".concat(appointment.id, "_").concat(slot); })
            };
    ...
    MIPOptimizationAlgorithm.prototype.convertSolutionToChanges = function (solution, conflict, context) {
        var _this = this;
        var changes = [];
        ...
        solution.solution.forEach(function (value, variable) {
            if (value > 0.5) { // Binary variable is "on"
                var _a = variable.split('_'), appointmentId_1 = _a[1], slotStr = _a[2];
                var slot = parseInt(slotStr);
                var originalAppointment = context.availableAppointments.find(function (a) { return a.id === appointmentId_1; });
                if (originalAppointment) {
                    ...
                    changes.push({
                        ...
                        impact: {
                            ...
                            description: "Rescheduled from ".concat(originalAppointment.appointmentDate, " to ").concat(newTime)
                        }
                    });
                }
            }
    ...
    MIPOptimizationAlgorithm.prototype.calculateStakeholderSatisfaction = function (changes, context) {
    ...
    MIPOptimizationAlgorithm.prototype.determineResolutionMethod = function (changes) {
        ...
        if (changes.every(function (c) { return c.changeType === 'reschedule'; }))
            return 'automatic_reschedule';
        if (changes.some(function (c) { return c.changeType === 'reassign'; }))
            return 'staff_reassignment';
        return 'resource_reallocation';
    };
    MIPOptimizationAlgorithm.prototype.convertAlternativeToResult = function (alternative, conflict, context) {
...
var ConstraintProgrammingAlgorithm = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                explanation: "CP solver ".concat(solution.satisfiable ? 'found satisfying assignment' : 'detected unsatisfiable constraints')
                            }];
                    case 3:
                        error_2 = _a.sent();
                        throw new conflict_types_1.ResolutionExecutionError('Constraint programming failed', this.type, conflict.id, performance.now() - startTime, { originalError: error_2 });
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ConstraintProgrammingAlgorithm.prototype.calculateSuccessProbability = function (conflict, context) {
        // CP works well for heavily constrained problems
        var baseProb = 0.82;
        var constraintBonus = Math.min(0.1, context.systemConstraints.resourceCapacityLimits.length * 0.02);
        return Math.min(0.95, baseProb + constraintBonus);
    };
    ConstraintProgrammingAlgorithm.prototype.defineConstraintSatisfactionProblem = function (conflict, context) {
        return {
    ...
    ConstraintProgrammingAlgorithm.prototype.defineVariableDomains = function (conflict, context) {
        ...
        context.availableAppointments.forEach(function (appointment) {
            ...
            domains.set("start_".concat(appointment.id), Array.from({ length: 48 }, function (_, i) { return i; }));
            // Professional domains
            var availableProfessionals = context.professionalAvailability
                .map(function (p) { return p.professionalId; })
    ...
    ConstraintProgrammingAlgorithm.prototype.extractChangesFromSolution = function (solution, conflict, context) {
        var _this = this;
        var changes = [];
        if (solution.satisfiable) {
            solution.assignments.forEach(function (value, variable) {
                if (variable.startsWith('start_')) {
                    ...
                    var originalAppointment = context.availableAppointments.find(function (a) { return a.id === appointmentId_2; });
                    if (originalAppointment) {
                        ...
                        changes.push({
                            ...
                            impact: {
                                stakeholder: 'patient',
                                severity: Math.min(5, Math.abs(value - _this.dateTimeToSlot(originalAppointment.appointmentDate))),
    ...
    ConstraintProgrammingAlgorithm.prototype.calculateStakeholderSatisfaction = function (changes, context) {
...
var GeneticAlgorithmOptimizer = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                executionTimeMs: performance.now() - startTime,
                                explanation: "GA found solution with fitness ".concat(bestSolution.fitness.toFixed(3), " after ").concat(this.parameters.generations, " generations")
                            }];
                    case 3:
                        error_3 = _a.sent();
                        throw new conflict_types_1.ResolutionExecutionError('Genetic algorithm optimization failed', this.type, conflict.id, performance.now() - startTime, { originalError: error_3 });
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                for (generation = 0; generation < this.parameters.generations; generation++) {
                    ...
                    population.splice.apply(population, __spreadArray([0, population.length], newPopulation, false));
                }
                // Return best individual
                return [2 /*return*/, population.reduce(function (best, current) {
                        return current.fitness > best.fitness ? current : best;
                    })];
            });
        });
    };
    GeneticAlgorithmOptimizer.prototype.createNextGeneration = function (population, conflict, context) {
        var newPopulation = [];
        // Elitism: keep best individuals
        var sorted = __spreadArray([], population, true).sort(function (a, b) { return b.fitness - a.fitness; });
    ...
    GeneticAlgorithmOptimizer.prototype.tournamentSelection = function (population, tournamentSize) {
        if (tournamentSize === void 0) { tournamentSize = 3; }
        var tournament = [];
    ...
    GeneticAlgorithmOptimizer.prototype.evaluateFitness = function (individual, conflict, context) {
        ...
        var fitness = (conflictResolution * 0.5) + ((1 - disruption / appointments.length) * 0.3) + (satisfaction * 0.2);
        return {
...
var RuleBasedAlgorithm = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    ...
                    return [2 /*return*/, {
                            ...
                            estimatedSatisfaction: satisfaction,
                            executionTimeMs: performance.now() - startTime,
                            explanation: "Applied ".concat(proposedChanges.length, " rule-based changes to resolve conflict")
                        }];
                }
                catch (error) {
                    throw new conflict_types_1.ResolutionExecutionError('Rule-based resolution failed', this.type, conflict.id, performance.now() - startTime, { originalError: error });
                }
                return [2 /*return*/];
            });
        });
    ...
    RuleBasedAlgorithm.prototype.applyResolutionRules = function (conflict, context) {
        ...
        var appointment1 = context.availableAppointments.find(function (a) { return a.id === conflict.appointmentAId; });
        var appointment2 = context.availableAppointments.find(function (a) { return a.id === conflict.appointmentBId; });
        if (!appointment1 || !appointment2)
            return changes;
        var targetAppointment = appointment1.priorityScore <= appointment2.priorityScore ? appointment1 : appointment2;
    ...
    RuleBasedAlgorithm.prototype.estimateSatisfaction = function (changes, context) {
        ...
        var avgSeverity = changes.reduce(function (sum, c) { return sum + c.impact.severity; }, 0) / changes.length;
...
var ResolutionAlgorithmFactory = /** @class */ (function () {
    function ResolutionAlgorithmFactory() {
        this.algorithms = new Map([
            ['mip_optimization', function () { return new MIPOptimizationAlgorithm(); }],
            ['constraint_programming', function () { return new ConstraintProgrammingAlgorithm(); }],
            ['genetic_algorithm', function () { return new GeneticAlgorithmOptimizer(); }],
            ['rule_based', function () { return new RuleBasedAlgorithm(); }]
        ]);
    }
