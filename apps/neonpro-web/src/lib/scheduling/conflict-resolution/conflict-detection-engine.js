...
var ConflictDetectionEngine = /** @class */ (() => {
   ...
   */
  ConflictDetectionEngine.prototype.detectConflictsForNewAppointment = function (
    appointmentData,
    clinicId,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 8:
            ...
            return [
              4 /*yield*/,
              this.detectBreakTimeViolations(
                appointmentData.staff_id,
                startTime,
                endTime,
                clinicId,
          ...
          case 11:
            error_1 = _a.sent();
            logger_1.logger.error("Error in conflict detection", {
              error: error_1,
              appointmentData: appointmentData,
              clinicId: clinicId,
            });
   ...
   */
  ConflictDetectionEngine.prototype.detectStaffConflicts = function (
    staffId,
    startTime,
    endTime,
    clinicId,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            if (error) {
              logger_1.logger.error("Error fetching staff conflicts", {
                error: error,
                staffId: staffId,
              });
              throw error;
          ...
          case 3:
            ...
            staffName =
              (staffData === null || staffData === void 0 ? void 0 : staffData.name) ||
              "Unknown Staff";
            conflicts.push({
            ...
            _b.label = 4;
          case 4:
            return [2 /*return*/, { conflicts: conflicts, resources: resources }];
          case 5:
            error_2 = _b.sent();
            logger_1.logger.error("Error detecting staff conflicts", {
              error: error_2,
              staffId: staffId,
            });
            throw error_2;
   ...
   */
  ConflictDetectionEngine.prototype.detectRoomConflicts = function (
    roomId,
    startTime,
    endTime,
    clinicId,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            (_a = _b.sent()), (conflictingAppointments = _a.data), (error = _a.error);
            if (error) {
              logger_1.logger.error("Error fetching room conflicts", {
                error: error,
                roomId: roomId,
              });
              throw error;
            ...
            return [
              4 /*yield*/,
              this.supabase.from("rooms").select("id, name, capacity").eq("id", roomId).single(),
            ];
          case 3:
            roomData = _b.sent().data;
            roomName =
              (roomData === null || roomData === void 0 ? void 0 : roomData.name) || "Unknown Room";
            conflicts.push({
          ...
          case 5:
            error_3 = _b.sent();
            logger_1.logger.error("Error detecting room conflicts", {
              error: error_3,
              roomId: roomId,
            });
            throw error_3;
   ...
   */
  ConflictDetectionEngine.prototype.detectEquipmentConflicts = function (
    equipmentIds,
    startTime,
    endTime,
    clinicId,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("equipment").select("id, name").eq("id", equipmentId).single(),
            ];
          case 4:
            equipmentData = _b.sent().data;
            equipmentName =
              (equipmentData === null || equipmentData === void 0 ? void 0 : equipmentData.name) ||
              "Unknown Equipment";
            conflicts.push({
          ...
          case 6:
            (_a = _b.sent()), (conflictingAppointments = _a.data), (error = _a.error);
            if (error) {
              logger_1.logger.error("Error fetching equipment conflicts", {
                error: error,
          ...
          case 10:
            error_4 = _b.sent();
            logger_1.logger.error("Error detecting equipment conflicts", {
              error: error_4,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            if (staffData && serviceData) {
              ...
              if (missingSpecialties.length > 0) {
                conflicts.push({
                  ...
                  severity: "high",
                  description: "Staff "
                    .concat(staffData.name, " lacks required specialties: ")
                    .concat(missingSpecialties.join(", ")),
                  affectedAppointments: [],
                  affectedResources: [
                    {
                      id: staffId,
          ...
          case 4:
            error_5 = _a.sent();
            logger_1.logger.error("Error detecting skill mismatch", {
              error: error_5,
              staffId: staffId,
              serviceId: serviceId,
            });
   ...
   */
  ConflictDetectionEngine.prototype.detectBreakTimeViolations = function (
    staffId,
    startTime,
    endTime,
    clinicId,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("staff").select("name").eq("id", staffId).single(),
            ];
          case 4:
            staffData = _a.sent().data;
            conflicts.push({
              ...
              severity: "medium",
              description: "Appointment conflicts with ".concat(
                (staffData === null || staffData === void 0 ? void 0 : staffData.name) || "staff",
                " break time",
              ),
              affectedAppointments: [],
              affectedResources: [
          ...
          case 7:
            error_6 = _a.sent();
            logger_1.logger.error("Error detecting break time violations", {
              error: error_6,
              staffId: staffId,
            });
            return [2 /*return*/, []];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            error_7 = _a.sent();
            logger_1.logger.error("Error in batch conflict detection", {
              error: error_7,
