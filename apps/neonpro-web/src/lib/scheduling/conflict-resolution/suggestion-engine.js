...
var SuggestionEngine = /** @class */ (function () {
    function SuggestionEngine(config) {
        ...
        this.config = __assign({ enableAutoSuggestions: true, maxSuggestionsPerConflict: 5, prioritizePatientPreference: true, considerStaffPreferences: true, allowOvertimeScheduling: false, maxRescheduleDistance: 7, minConfidenceThreshold: 70, enableCostOptimization: true }, config);
    }
    /**
     * Gera sugestões para resolver conflitos detectados
     */
    SuggestionEngine.prototype.generateSuggestions = function (conflictResult, appointmentData, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var suggestions, _i, _a, conflict, conflictSuggestions, optimizationSuggestions, filteredSuggestions, error_1;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        conflict = _a[_i];
                        return [4 /*yield*/, this.generateSuggestionsForConflict(conflict, appointmentData, clinicId)];
                    case 2:
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [4 /*yield*/, this.generateOptimizationSuggestions(conflictResult, appointmentData, clinicId)];
                    case 5:
                        optimizationSuggestions = _b.sent();
                        suggestions.push.apply(suggestions, optimizationSuggestions);
                        filteredSuggestions = suggestions
                            .filter(function (s) { return s.confidence >= _this.config.minConfidenceThreshold; })
                            .sort(function (a, b) {
                        ...
                        logger_1.logger.info('Generated suggestions', {
                            ...
                            autoApplicable: filteredSuggestions.filter(function (s) { return s.autoApplicable; }).length
                        });
                        return [2 /*return*/, filteredSuggestions];
                    case 6:
                        error_1 = _b.sent();
                        logger_1.logger.error('Error generating suggestions', { error: error_1, conflictResult: conflictResult });
                        throw error_1;
     ...
     */
    SuggestionEngine.prototype.generateSuggestionsForConflict = function (conflict, appointmentData, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_v) {
                switch (_v.label) {
                    case 0:
                        ...
                        _a = conflict.type;
                        switch (_a) {
                            case conflict_detection_engine_1.ConflictType.STAFF_DOUBLE_BOOKING: return [3 /*break*/, 1];
                            case conflict_detection_engine_1.ConflictType.ROOM_OVERLAP: return [3 /*break*/, 3];
                            case conflict_detection_engine_1.ConflictType.EQUIPMENT_UNAVAILABLE: return [3 /*break*/, 5];
                            case conflict_detection_engine_1.ConflictType.STAFF_SKILL_MISMATCH: return [3 /*break*/, 7];
                            case conflict_detection_engine_1.ConflictType.STAFF_BREAK_VIOLATION: return [3 /*break*/, 9];
                            case conflict_detection_engine_1.ConflictType.EQUIPMENT_MAINTENANCE: return [3 /*break*/, 11];
                        }
                        return [3 /*break*/, 13];
                    case 1:
                        _c = (_b = suggestions.push).apply;
                        _d = [suggestions];
                        return [4 /*yield*/, this.generateStaffConflictSuggestions(conflict, appointmentData, clinicId)];
                    case 2:
                    ...
                    case 3:
                        ...
                        _g = [suggestions];
                        return [4 /*yield*/, this.generateRoomConflictSuggestions(conflict, appointmentData, clinicId)];
                    case 4:
                    ...
                    case 5:
                        ...
                        _k = [suggestions];
                        return [4 /*yield*/, this.generateEquipmentConflictSuggestions(conflict, appointmentData, clinicId)];
                    case 6:
                    ...
                    case 7:
                        ...
                        _o = [suggestions];
                        return [4 /*yield*/, this.generateSkillMismatchSuggestions(conflict, appointmentData, clinicId)];
                    case 8:
                    ...
                    case 9:
                        ...
                        _r = [suggestions];
                        return [4 /*yield*/, this.generateBreakViolationSuggestions(conflict, appointmentData, clinicId)];
                    case 10:
                    ...
                    case 11:
                        ...
                        _u = [suggestions];
                        return [4 /*yield*/, this.generateMaintenanceSuggestions(conflict, appointmentData, clinicId)];
                    case 12:
                    ...
                    case 13:
                        ...
                        _v.label = 14;
                    case 14: return [2 /*return*/, suggestions];
                }
            });
        });
    };
     ...
     */
    SuggestionEngine.prototype.generateStaffConflictSuggestions = function (conflict, appointmentData, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.findAlternativeStaff(appointmentData.service_id, new Date(appointmentData.start_time), new Date(appointmentData.end_time), clinicId, appointmentData.staff_id)];
                    case 2:
                        ...
                        if (alternativeStaff.length > 0) {
                            for (_i = 0, _a = alternativeStaff.slice(0, 3); _i < _a.length; _i++) {
                                ...
                                suggestions.push({
                                    ...
                                    description: "Assign appointment to ".concat(staff.name, " who is available at the requested time"),
                                    impact: {
                                        resolvedConflicts: 1,
                                        ...
                                        steps: [
                                            {
                                                ...
                                                description: "Update appointment staff from ".concat(appointmentData.staff_id, " to ").concat(staff.id),
                                                automated: true,
                                                estimatedDuration: 1,
                                                dependencies: []
                                            },
                        ...
                        return [4 /*yield*/, this.findAvailableTimeSlots(appointmentData.staff_id, appointmentData.service_id, new Date(appointmentData.start_time), clinicId, this.config.maxRescheduleDistance)];
                    case 3:
                        ...
                        if (availableSlots.length > 0) {
                            for (_b = 0, _c = availableSlots.slice(0, 3); _b < _c.length; _b++) {
                                ...
                                suggestions.push({
                                    ...
                                    priority: 'medium',
                                    title: "Reschedule to ".concat(slot.start.toLocaleDateString(), " ").concat(slot.start.toLocaleTimeString()),
                    ...
                    case 4:
                        error_2 = _d.sent();
                        logger_1.logger.error('Error generating staff conflict suggestions', { error: error_2, conflict: conflict });
                        return [2 /*return*/, []];
     ...
     */
    SuggestionEngine.prototype.generateRoomConflictSuggestions = function (conflict, appointmentData, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.findAlternativeRooms(appointmentData.service_id, new Date(appointmentData.start_time), new Date(appointmentData.end_time), clinicId, appointmentData.room_id)];
                    case 2:
                        ...
                        if (alternativeRooms.length > 0) {
                            for (_i = 0, _a = alternativeRooms.slice(0, 3); _i < _a.length; _i++) {
                                ...
                                suggestions.push({
                                    ...
                                    description: "Use ".concat(room.name, " which is available at the requested time"),
                                    impact: {
                                        resolvedConflicts: 1,
                                        affectedAppointments: [appointmentData.id],
                                        resourceChanges: [{
                    ...
                    case 3:
                        error_3 = _b.sent();
                        logger_1.logger.error('Error generating room conflict suggestions', { error: error_3, conflict: conflict });
                        return [2 /*return*/, []];
     ...
     */
    SuggestionEngine.prototype.generateEquipmentConflictSuggestions = function (conflict, appointmentData, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var suggestions, requiredEquipment, _i, requiredEquipment_1, equipmentId, alternatives, _a, _b, equipment, error_4;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.findAlternativeEquipment(equipmentId, new Date(appointmentData.start_time), new Date(appointmentData.end_time), clinicId)];
                    case 3:
                    ...
                    case 6:
                        error_4 = _c.sent();
                        logger_1.logger.error('Error generating equipment conflict suggestions', { error: error_4, conflict: conflict });
                        return [2 /*return*/, []];
                    case 7: return [2 /*return*/];
                }
            });
     ...
     */
    SuggestionEngine.prototype.generateSkillMismatchSuggestions = function (conflict, appointmentData, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.findQualifiedStaff(appointmentData.service_id, new Date(appointmentData.start_time), new Date(appointmentData.end_time), clinicId)];
                    case 2:
                    ...
                    case 3:
                        error_5 = _b.sent();
                        logger_1.logger.error('Error generating skill mismatch suggestions', { error: error_5, conflict: conflict });
                        return [2 /*return*/, []];
                    case 4: return [2 /*return*/];
                }
            });
     ...
     */
    SuggestionEngine.prototype.generateBreakViolationSuggestions = function (conflict, appointmentData, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.findSlotsOutsideBreakTime(appointmentData.staff_id, appointmentData.service_id, new Date(appointmentData.start_time), clinicId)];
                    case 2:
                        ...
                        if (availableSlots.length > 0) {
                            for (_i = 0, _a = availableSlots.slice(0, 3); _i < _a.length; _i++) {
                                slot = _a[_i];
                                suggestions.push({
                                    id: "reschedule_outside_break_".concat(slot.start.getTime(), "_").concat(Date.now()),
                                    type: SuggestionType.RESCHEDULE_APPOINTMENT,
                                    priority: 'medium',
                                    title: "Reschedule outside break time",
                                    description: "Move to ".concat(slot.start.toLocaleTimeString(), " to avoid break conflict"),
                                    impact: {
                                        resolvedConflicts: 1,
                                        affectedAppointments: [appointmentData.id],
                                        resourceChanges: [],
                    ...
                    case 3:
                        error_6 = _b.sent();
                        logger_1.logger.error('Error generating break violation suggestions', { error: error_6, conflict: conflict });
                        return [2 /*return*/, []];
                    case 4: return [2 /*return*/];
                }
            });
     ...
     */
    SuggestionEngine.prototype.generateMaintenanceSuggestions = function (conflict, appointmentData, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.getMaintenanceEndTime((_a = conflict.affectedResources[0]) === null || _a === void 0 ? void 0 : _a.id, clinicId)];
                    case 2:
                        maintenanceEnd = _b.sent();
                        if (maintenanceEnd) {
                            suggestedStart = new Date(maintenanceEnd.getTime() + 30 * 60 * 1000) // 30 min buffer
                            ;
                            duration = new Date(appointmentData.end_time).getTime() - new Date(appointmentData.start_time).getTime();
                    ...
                    case 3:
                        error_7 = _b.sent();
                        logger_1.logger.error('Error generating maintenance suggestions', { error: error_7, conflict: conflict });
                        return [2 /*return*/, []];
                    case 4: return [2 /*return*/];
                }
            });
     ...
     */
    SuggestionEngine.prototype.generateOptimizationSuggestions = function (conflictResult, appointmentData, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var suggestions;
                    ...
                    if (conflictResult.conflicts.length >= 3) {
                        suggestions.push({
                            ...
                            impact: {
                                ...
                                affectedAppointments: conflictResult.conflicts.flatMap(function (c) { return c.affectedAppointments; }),
                                resourceChanges: [],
                                timeChanges: [],
                                costImpact: 0
                            },
                            ...
                            confidence: 75,
                            autoApplicable: false,
                            conflictIds: conflictResult.conflicts.map(function (c) { return c.id; })
                        });
                    }
                    return [2 /*return*/, suggestions];
                }
                catch (error) {
                    logger_1.logger.error('Error generating optimization suggestions', { error: error, conflictResult: conflictResult });
                    return [2 /*return*/, []];
                }
                return [2 /*return*/];
            });
    ...
    SuggestionEngine.prototype.findAlternativeStaff = function (serviceId, startTime, endTime, clinicId, excludeStaffId) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _a, staffList, error, availableStaff, _loop_1, this_1, _i, staffList_1, staff, error_8;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 6, , 7]);
                    ...
                    case 1:
                        ...
                        _loop_1 = function (staff) {
                            var serviceData, requiredSpecialties, staffSpecialties_1, hasRequiredSkills, isAvailable;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0: return [4 /*yield*/, this_1.supabase
                                            .from('services')
                                    ...
                                    case 1:
                                        ...
                                        if (serviceData === null || serviceData === void 0 ? void 0 : serviceData.required_specialties) {
                                        ...
                                        return [4 /*yield*/, this_1.checkStaffAvailability(staff.id, startTime, endTime, clinicId)];
                                    case 2:
                                        isAvailable = _c.sent();
                                        if (isAvailable) {
                                            availableStaff.push(__assign(__assign({}, staff), { confidence: 85 // Base confidence, pode ser ajustada
                                             }));
                                        }
                                        return [2 /*return*/];
                                }
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, availableStaff];
                    case 6:
                        error_8 = _b.sent();
    ...
    SuggestionEngine.prototype.findAlternativeRooms = function (serviceId, startTime, endTime, clinicId, excludeRoomId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, availableRooms];
                    case 6:
                        error_9 = _b.sent();
    ...
    SuggestionEngine.prototype.findAlternativeEquipment = function (equipmentId, startTime, endTime, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var originalEquipment, _a, similarEquipment, error, availableEquipment, _i, similarEquipment_1, equipment, isAvailable, error_10;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 7, , 8]);
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.checkEquipmentAvailability(equipment.id, startTime, endTime, clinicId)];
                    case 4:
                        isAvailable = _b.sent();
                        if (isAvailable) {
                    ...
                    case 5:
                        _i++;
                        return [3 /*break*/, 3];
                    case 6: return [2 /*return*/, availableEquipment];
                    case 7:
                        error_10 = _b.sent();
    ...
    SuggestionEngine.prototype.checkStaffAvailability = function (staffId, startTime, endTime, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SuggestionEngine.prototype.checkRoomAvailability = function (roomId, startTime, endTime, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SuggestionEngine.prototype.checkEquipmentAvailability = function (equipmentId, startTime, endTime, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SuggestionEngine.prototype.findAvailableTimeSlots = function (staffId, serviceId, preferredDate, clinicId, maxDays) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.checkStaffAvailability(staffId, slotStart, slotEnd, clinicId)];
                    case 3:
                        isAvailable = _a.sent();
                        if (isAvailable) {
                            slots.push({
                    ...
                    case 5:
                        day++;
                        return [3 /*break*/, 1];
                    case 6: return [2 /*return*/, slots.slice(0, 10)]; // Limitar a 10 slots
                }
            });
        });
    };
    SuggestionEngine.prototype.findQualifiedStaff = function (serviceId, startTime, endTime, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    SuggestionEngine.prototype.findSlotsOutsideBreakTime = function (staffId, serviceId, preferredDate, clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // Implementação similar ao findAvailableTimeSlots mas considerando break times
                return [2 /*return*/, this.findAvailableTimeSlots(staffId, serviceId, preferredDate, clinicId, 3)];
            });
        });
    };
     ...
     */
    SuggestionEngine.prototype.applySuggestion = function (suggestion, appointmentId, clinicId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var changes, _a, staffChange, error, roomChange, error, equipmentChange_1, appointment, currentEquipment, updatedEquipment, error, error_15;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = suggestion.type;
                        switch (_a) {
                            case SuggestionType.REASSIGN_STAFF: return [3 /*break*/, 1];
                            case SuggestionType.CHANGE_ROOM: return [3 /*break*/, 4];
                            case SuggestionType.SUBSTITUTE_EQUIPMENT: return [3 /*break*/, 7];
                        }
                        return [3 /*break*/, 11];
                    case 1:
                        staffChange = suggestion.impact.resourceChanges.find(function (c) { return c.resourceType === 'staff'; });
                    ...
                    case 4:
                        roomChange = suggestion.impact.resourceChanges.find(function (c) { return c.resourceType === 'room'; });
                    ...
                    case 7:
                        equipmentChange_1 = suggestion.impact.resourceChanges.find(function (c) { return c.resourceType === 'equipment'; });
                    ...
                    case 9:
                        ...
                        if (error)
                            throw error;
                        changes.push({ type: 'equipment_substitution', from: equipmentChange_1.from, to: equipmentChange_1.to });
                        _b.label = 10;
                    case 10: return [3 /*break*/, 12];
                    case 11: return [2 /*return*/, {
                            success: false,
                            message: "Auto-application not implemented for suggestion type: ".concat(suggestion.type),
                            changes: []
                        }];
                    case 12: 
                    ...
                    case 14:
                        error_15 = _b.sent();
                        logger_1.logger.error('Error applying suggestion', { error: error_15, suggestion: suggestion, appointmentId: appointmentId });
                        return [2 /*return*/, {
                                success: false,
...
// Instância singleton
var createsuggestionEngine = function () { return new SuggestionEngine(); };
