...
var ConflictDetectionEngine = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        error_1 = _a.sent();
                        throw new conflict_types_1.ConflictDetectionError('Failed to initialize conflict detection engine', undefined, 'INITIALIZATION_ERROR', { originalError: error_1 });
    ...
    ConflictDetectionEngine.prototype.detectConflicts = function (appointmentId) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, _a, conflicts, error, enhancedConflicts, recommendations, systemStatus, detectionLatency, response, error_2, detectionLatency;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (error) {
                            throw new conflict_types_1.ConflictDetectionError('Database conflict detection failed', appointmentId, 'DB_DETECTION_ERROR', { error: error });
                        }
                    ...
                    case 5:
                        ...
                        if (enhancedConflicts.length > 0) {
                            this.emitConflictEvent({
                                ...
                                appointmentIds: appointmentId ? [appointmentId] : enhancedConflicts.flatMap(function (c) { return [c.appointmentAId, c.appointmentBId]; }),
                                timestamp: new Date(),
                                metadata: { detectionLatency: detectionLatency, totalConflicts: enhancedConflicts.length }
                            });
                        }
                    ...
                    case 6:
                        ...
                        throw new conflict_types_1.ConflictDetectionError('Conflict detection failed', appointmentId, 'DETECTION_ERROR', { originalError: error_2, detectionLatency: detectionLatency });
    ...
    ConflictDetectionEngine.prototype.startRealtimeMonitoring = function () {
        return __awaiter(this, arguments, void 0, function (appointmentIds) {
            var _a, _b;
            if (appointmentIds === void 0) { appointmentIds = []; }
            return __generator(this, function (_c) {
                this.validateInitialization();
                if (!this.config.enableRealTimeDetection) {
                    throw new conflict_types_1.ConflictDetectionError('Real-time detection is disabled in configuration', undefined, 'REALTIME_DISABLED');
                }
                // Set up appointment-specific monitoring
                if (appointmentIds.length > 0) {
                    // Monitor specific appointments for changes
                    (_a = this.realtimeChannel) === null || _a === void 0 ? void 0 : _a.on('postgres_changes', {
                        event: 'UPDATE',
                        schema: 'public',
                        table: 'appointments',
                        filter: appointmentIds.map(function (id) { return "id=eq.".concat(id); }).join(',')
                    }, this.handleAppointmentChange.bind(this));
                }
                // Monitor conflict notifications
                (_b = this.realtimeChannel) === null || _b === void 0 ? void 0 : _b.on('postgres_changes', {
                    event: 'INSERT',
                    schema: 'public',
    ...
    ConflictDetectionEngine.prototype.getPerformanceMetrics = function () {
        return __assign(__assign({}, this.detectionMetrics), { isHealthy: this.detectionMetrics.averageLatency <= this.config.performanceThresholds.maxDetectionLatencyMs, configuredThresholds: this.config.performanceThresholds });
    };
    /**
     * Cleanup resources
     */
    ConflictDetectionEngine.prototype.cleanup = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.stopRealtimeMonitoring()];
                    case 1:
                        _a.sent();
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (tablesError || !tables || tables.length < 4) {
                            throw new conflict_types_1.ConflictDetectionError('Required database schema not found. Please run the conflict resolution migration.', undefined, 'SCHEMA_VALIDATION_ERROR');
                        }
                        return [4 /*yield*/, this.supabase
                    ...
                    case 2:
                        ...
                        if (functionsError && functionsError.code !== 'PGRST200') {
                            throw new conflict_types_1.ConflictDetectionError('Conflict detection function not available', undefined, 'FUNCTION_VALIDATION_ERROR', { error: functionsError });
                        }
                        return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, enhancedConflicts];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                ...
                for (_i = 0, conflicts_1 = conflicts; _i < conflicts_1.length; _i++) {
                    ...
                    recommendations.push({
                        ...
                        reasoning: "Recommended ".concat(recommendedStrategy, " based on conflict type ").concat(conflict.conflictType, " and severity ").concat(conflict.severityLevel)
                    });
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        avgDetectionLatency = (recentMetrics === null || recentMetrics === void 0 ? void 0 : recentMetrics.filter(function (m) { return m.metric_type === 'detection_latency'; }).reduce(function (sum, m) { return sum + m.metric_value; }, 0)) /
                            ((recentMetrics === null || recentMetrics === void 0 ? void 0 : recentMetrics.filter(function (m) { return m.metric_type === 'detection_latency'; }).length) || 1);
                        avgResolutionTime = (recentMetrics === null || recentMetrics === void 0 ? void 0 : recentMetrics.filter(function (m) { return m.metric_type === 'resolution_time'; }).reduce(function (sum, m) { return sum + m.metric_value; }, 0)) /
                            ((recentMetrics === null || recentMetrics === void 0 ? void 0 : recentMetrics.filter(function (m) { return m.metric_type === 'resolution_time'; }).length) || 1);
                        return [2 /*return*/, {
    ...
    ConflictDetectionEngine.prototype.validatePerformanceThresholds = function (latency) {
        if (latency > this.config.performanceThresholds.maxDetectionLatencyMs) {
            console.warn("Detection latency ".concat(latency, "ms exceeds threshold ").concat(this.config.performanceThresholds.maxDetectionLatencyMs, "ms"));
            ...
            this.supabase
                ...
                .then(null, function (error) { return console.error('Failed to record performance warning:', error); });
        }
    };
    ConflictDetectionEngine.prototype.validateInitialization = function () {
        if (!this.isInitialized) {
            throw new conflict_types_1.ConflictDetectionError('Conflict detection engine not initialized. Call initialize() first.', undefined, 'NOT_INITIALIZED');
        }
    };
