    ...
    ConflictDetectionService.prototype.analyzeConflictSeverity = function (conflictData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                conflictCount = conflictData.conflictCount, affectedProviders = conflictData.affectedProviders, timeOverlap = conflictData.timeOverlap;
                severity = 'low';
                ...
                return [2 /*return*/, { severity: severity, impact: impact, recommendation: recommendation }];
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        processed = (waitlistEntries === null || waitlistEntries === void 0 ? void 0 : waitlistEntries.length) || 2;
...
exports.default = { ConflictDetectionService: ConflictDetectionService, WaitlistService: WaitlistService };
