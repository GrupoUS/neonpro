...
exports.analyticsManager = exports.AdvancedAnalyticsManager = exports.AlertSystem = exports.PerformanceCalculator = exports.SchedulingAnalytics = void 0;
// Analytics Module Exports
var scheduling_analytics_1 = require("./scheduling-analytics");
Object.defineProperty(exports, "SchedulingAnalytics", { enumerable: true, get: function () { return scheduling_analytics_1.default; } });
var performance_calculator_1 = require("./performance-calculator");
Object.defineProperty(exports, "PerformanceCalculator", { enumerable: true, get: function () { return performance_calculator_1.default; } });
var alert_system_1 = require("./alert-system");
Object.defineProperty(exports, "AlertSystem", { enumerable: true, get: function () { return alert_system_1.default; } });
...
var AdvancedAnalyticsManager = /** @class */ (function () {
    ...
    AdvancedAnalyticsManager.prototype.getComprehensiveAnalytics = function (filter) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, schedulingMetrics, schedulingDashboard, performanceMetrics, alertDashboard, _b, benchmarks, recommendations, insights, summary, error_2;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        _a = _c.sent(), schedulingMetrics = _a[0], schedulingDashboard = _a[1], performanceMetrics = _a[2], alertDashboard = _a[3];
                        return [4 /*yield*/, Promise.all([
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, {
                                ...
                                alerts: {
                                    ...
                                    criticalCount: alertDashboard.activeAlerts.filter(function (a) { return a.severity === 'critical'; }).length
                                },
                                insights: insights,
                                summary: summary
                            }];
    ...
    AdvancedAnalyticsManager.prototype.getPerformanceSnapshot = function () {
        return __awaiter(this, void 0, void 0, function () {
            var endDate, startDate, filter, _a, performanceMetrics, alertDashboard, score, status_1, keyMetrics, trends, error_3;
     ...
     */
    AdvancedAnalyticsManager.prototype.generateInsights = function (schedulingMetrics, performanceMetrics, alertDashboard) {
        var keyFindings = [];
        var actionItems = [];
        var trends = [];
        var riskFactors = [];
     ...
     */
    AdvancedAnalyticsManager.prototype.generateSummary = function (performanceMetrics, benchmarks, alertDashboard) {
    ...
    AdvancedAnalyticsManager.prototype.determineStatus = function (score, alertCount) {
        if (alertCount > 10 || score < 60)
            return 'critical';
        if (alertCount > 5 || score < 75)
            return 'warning';
        if (score >= 90 && alertCount === 0)
            return 'excellent';
        return 'good';
    };
    /**
