...
var ExperienceQualityAnalyzer = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        qualityConfig = __assign({ auto_assessment_enabled: true, assessment_frequency_days: 30, quality_thresholds: {
                                excellent: 4.5,
                                good: 4.0,
                                fair: 3.5,
                                poor: 3.0
                    ...
                    case 1:
                        // Create initial baseline assessment
                        _a.sent();
                        logger_1.logger.info("Experience quality analysis initialized for patient ".concat(patientId), {
     ...
     */
    ExperienceQualityAnalyzer.prototype.conductQualityAssessment = function (patientId, assessmentMethod, touchpointId, journeyPhase, additionalData) {
        return __awaiter(this, void 0, void 0, function () {
            var qualityData, dimensionScores, overallScore, qualityCategory, frictionPoints, improvementOpportunities, benchmarkComparison, assessment, saveError, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                        return [4 /*yield*/, this.gatherQualityData(patientId, assessmentMethod, touchpointId)
                            // Analyze quality dimensions
                        ];
                    case 1:
                        qualityData = _a.sent();
                        return [4 /*yield*/, this.analyzeQualityDimensions(patientId, qualityData, assessmentMethod)
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.detectFrictionPoints(patientId, qualityData, touchpointId)
                            // Identify improvement opportunities
                        ];
                    case 3:
                        frictionPoints = _a.sent();
                        improvementOpportunities = this.identifyImprovementOpportunities(dimensionScores, frictionPoints);
                        benchmarkComparison = this.generateBenchmarkComparison(dimensionScores);
                        assessment = {
                            id: "assessment_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                            ...
                            metadata: __assign({ assessment_duration_minutes: Math.round(Math.random() * 30 + 10), data_quality_score: 0.95, statistical_significance: 0.90, sample_size: qualityData.sampleSize || 1, methodology_notes: "Assessment using ".concat(assessmentMethod), review_status: 'pending' }, additionalData),
                            created_at: new Date()
                        };
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.checkForImmediateInterventions(assessment)
    ...
    ExperienceQualityAnalyzer.prototype.generateQualityMetricsSummary = function (patientId_1) {
        return __awaiter(this, arguments, void 0, function (patientId, periodDays) {
            var periodStart, assessments, qualityTrend, dimensionScores, criticalFrictionPoints, topImprovementOpportunities, predictiveInsights, latestAssessment, summary, error_3;
            if (periodDays === void 0) { periodDays = 90; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
     ...
     */
    ExperienceQualityAnalyzer.prototype.createOptimizationStrategy = function (patientId, targetDimensions, targetGoals) {
        return __awaiter(this, void 0, void 0, function () {
            var currentMetrics_1, optimizationTactics, implementationRoadmap, successTracking, riskMitigation, strategy, saveError, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        if (!currentMetrics_1) {
                            return [2 /*return*/, { success: false, error: 'No quality metrics available for baseline' }];
                        }
                        optimizationTactics = this.createOptimizationTactics(targetDimensions, currentMetrics_1.dimension_scores, targetGoals);
                        ...
                        strategy = {
                            patient_id: patientId,
                            strategy_name: "Quality Optimization Strategy - ".concat(new Date().toISOString().split('T')[0]),
                            target_dimensions: targetDimensions,
                            current_baseline: Object.fromEntries(targetDimensions.map(function (dim) { var _a; return [dim, ((_a = currentMetrics_1.dimension_scores[dim]) === null || _a === void 0 ? void 0 : _a.current_score) || 0]; })),
    ...
    ExperienceQualityAnalyzer.prototype.monitorQualityTrends = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var alerts, patientsToMonitor, _a, _i, patientsToMonitor_1, pid, config, recentMetrics, error_5;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = [patientId];
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.getActivePatients()];
                    case 2:
                        _a = _b.sent();
                        _b.label = 3;
                    case 3:
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, this.conductQualityAssessment(patientId, 'behavioral_analysis', undefined, 'initial_baseline')];
                    case 1:
                        // Create initial baseline assessment for new patients
                        _a.sent();
                        return [2 /*return*/];
    ...
    ExperienceQualityAnalyzer.prototype.gatherQualityData = function (patientId, method, touchpointId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        _a = method;
                        switch (_a) {
                            case 'user_feedback': return [3 /*break*/, 1];
                            case 'behavioral_analysis': return [3 /*break*/, 3];
                            case 'satisfaction_surveys': return [3 /*break*/, 5];
                            case 'analytics_data': return [3 /*break*/, 7];
                        }
                        return [3 /*break*/, 9];
                    case 1:
                        _b = data;
    ...
    ExperienceQualityAnalyzer.prototype.analyzeQualityDimensions = function (patientId, qualityData, method) {
        return __awaiter(this, void 0, void 0, function () {
            var dimensions;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    ExperienceQualityAnalyzer.prototype.detectFrictionPoints = function (patientId, qualityData, touchpointId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, frictionPoints.sort(function (a, b) { return b.resolution_priority - a.resolution_priority; })];
            });
        });
    };
    ExperienceQualityAnalyzer.prototype.identifyImprovementOpportunities = function (dimensionScores, frictionPoints) {
        var _this = this;
        var opportunities = [];
        Object.keys(dimensionScores).forEach(function (dimensionKey) {
            var dimension = dimensionKey;
        ...
        return opportunities.sort(function (a, b) { return b.improvement_potential - a.improvement_potential; });
    };
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(config === null || config === void 0 ? void 0 : config.optimization.enabled))
                            return [2 /*return*/];
                        if (!(assessment.overall_quality_score < config.optimization.intervention_threshold)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.triggerImmediateIntervention(assessment)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        criticalFriction = assessment.friction_points.filter(function (fp) { return fp.severity === 'critical'; });
                        if (!(criticalFriction.length > 0)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.triggerFrictionPointIntervention(assessment, criticalFriction)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/];
    ...
    ExperienceQualityAnalyzer.prototype.calculateQualityTrend = function (assessments) {
        ...
        var scores = assessments.map(function (a) { return a.overall_quality_score; });
        var firstHalf = scores.slice(0, Math.floor(scores.length / 2));
        var secondHalf = scores.slice(Math.floor(scores.length / 2));
        var firstAvg = firstHalf.reduce(function (sum, score) { return sum + score; }, 0) / firstHalf.length;
        var secondAvg = secondHalf.reduce(function (sum, score) { return sum + score; }, 0) / secondHalf.length;
    ...
    ExperienceQualityAnalyzer.prototype.calculateDimensionScores = function (assessments) {
        ...
        Object.keys(this.industryBenchmarks).forEach(function (dimensionKey) {
            ...
            var currentScore = ((_a = latestAssessment.quality_dimensions[dimension]) === null || _a === void 0 ? void 0 : _a.score) || 0;
            // Calculate trend
            var scores = assessments.map(function (a) { var _a; return ((_a = a.quality_dimensions[dimension]) === null || _a === void 0 ? void 0 : _a.score) || 0; });
    ...
    ExperienceQualityAnalyzer.prototype.calculateDimensionTrend = function (scores) {
        ...
        var recentAvg = recent.reduce(function (sum, score) { return sum + score; }, 0) / recent.length;
        var earlierAvg = earlier.reduce(function (sum, score) { return sum + score; }, 0) / earlier.length;
    ...
    ExperienceQualityAnalyzer.prototype.identifyCriticalFrictionPoints = function (assessments) {
        ...
        assessments.forEach(function (assessment) {
            var _a;
            (_a = assessment.friction_points) === null || _a === void 0 ? void 0 : _a.forEach(function (fp) {
        ...
        return criticalPoints.sort(function (a, b) { return b.resolution_urgency - a.resolution_urgency; });
    };
    ExperienceQualityAnalyzer.prototype.findTopImprovementOpportunities = function (assessments) {
        ...
        if (latestAssessment.improvement_opportunities) {
            latestAssessment.improvement_opportunities.forEach(function (opp) {
                var effortToImpactRatio = opp.improvement_potential / _this.getEffortScore(opp.effort_required);
        ...
        return opportunities
            .sort(function (a, b) { return b.effort_to_impact_ratio - a.effort_to_impact_ratio; })
            .slice(0, 5); // Top 5 opportunities
    };
    ExperienceQualityAnalyzer.prototype.generatePredictiveInsights = function (assessments, qualityTrend) {
        var _a;
        var latestScore = ((_a = assessments[assessments.length - 1]) === null || _a === void 0 ? void 0 : _a.overall_quality_score) || 0;
        ...
        if (qualityTrend.direction === 'declining')
            churnRisk += 0.3 * qualityTrend.strength;
        ...
        var interventionRecommendations = this.generateInterventionRecommendations(latestScore, qualityTrend, churnRisk);
        return {
    ...
    // More helper methods...
    ExperienceQualityAnalyzer.prototype.estimateEffortRequired = function (dimension, improvementPotential) {
        if (improvementPotential < 0.5)
            return 'low';
        if (improvementPotential < 1.0)
            return 'medium';
        return 'high';
    };
    ExperienceQualityAnalyzer.prototype.estimateExpectedImpact = function (dimension, improvementPotential) {
    ...
    ExperienceQualityAnalyzer.prototype.estimateTimeline = function (dimension, improvementPotential) {
        if (improvementPotential < 0.5)
            return '2-4 weeks';
        if (improvementPotential < 1.0)
            return '4-8 weeks';
    ...
    ExperienceQualityAnalyzer.prototype.getRecommendedActionsForDimension = function (dimension, frictionPoints) {
    ...
    ExperienceQualityAnalyzer.prototype.triggerFrictionPointIntervention = function (assessment, criticalFriction) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ExperienceQualityAnalyzer.prototype.calculateOpportunityPriority = function (opportunity, effortToImpactRatio) {
        return Math.round(effortToImpactRatio * opportunity.improvement_potential * 100) / 100;
    };
    ExperienceQualityAnalyzer.prototype.generateInterventionRecommendations = function (score, trend, churnRisk) {
        var recommendations = [];
        if (score < 3.0) {
    ...
    ExperienceQualityAnalyzer.prototype.createOptimizationTactics = function (targetDimensions, currentScores, targetGoals) {
        ...
        return targetDimensions.map(function (dimension) {
            ...
            return ({
                ...
                expected_impact: targetGoals[dimension] - (((_a = currentScores[dimension]) === null || _a === void 0 ? void 0 : _a.current_score) || 0),
        ...
        return [
            {
                ...
                duration_weeks: 4,
                tactics: tactics.slice(0, Math.ceil(tactics.length / 2)).map(function (t) { return t.tactic_name; }),
                success_criteria: ['Phase 1 metrics achieved'],
                checkpoints: [new Date(Date.now() + 7 * 24 * 60 * 60 * 1000)] // 1 week from now
            }
        ];
    };
    ExperienceQualityAnalyzer.prototype.defineSuccessTracking = function (targetDimensions, targetGoals) {
        return {
            key_metrics: targetDimensions.map(function (d) { return "".concat(d, "_score"); }),
            measurement_frequency: 'weekly',
            target_milestones: targetDimensions.map(function (dimension) { return ({
