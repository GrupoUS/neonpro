...
exports.ReportUtils = exports.ReportBuilder = exports.JourneyReportsEngine = exports.CHART_COLOR_PALETTES = exports.DEFAULT_REPORT_TEMPLATES = void 0;
...
var JourneyReportsEngine = /** @class */ (function () {
    ...
    JourneyReportsEngine.prototype.generateReport = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var data, content, insights, recommendations, files, urls, stats, access, sharing, report, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.fetchReportData(config)
                            // Generate content
                        ];
                    case 1:
                        data = _a.sent();
                        return [4 /*yield*/, this.generateReportContent(config, data)
                            // Generate insights
                        ];
                    case 2:
                        content = _a.sent();
                        return [4 /*yield*/, this.generateAutomatedInsights(config, data)
                            // Generate recommendations
                        ];
                    case 3:
                        insights = _a.sent();
                        return [4 /*yield*/, this.generateRecommendations(config, data, insights)
                            // Generate files
                        ];
                    case 4:
                        recommendations = _a.sent();
                        return [4 /*yield*/, this.generateReportFiles(config, content, insights, recommendations)
                            // Generate URLs
                        ];
                    case 5:
                        files = _a.sent();
    ...
    JourneyReportsEngine.prototype.generateReportContent = function (config, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.generateHeader(config)
                        // Generate executive summary
                    ];
                    case 1:
                        header = _a.sent();
                        return [4 /*yield*/, this.generateExecutiveSummary(config, data)
                            // Generate sections
                        ];
                    case 2:
                        executiveSummary = _a.sent();
                        return [4 /*yield*/, this.generateSections(config, data)
                            // Generate appendices
                        ];
                    case 3:
                        sections = _a.sent();
                        return [4 /*yield*/, this.generateAppendices(config, data)
                            // Generate footer
                        ];
                    case 4:
                        appendices = _a.sent();
...
exports.ReportUtils = {
    ...
    getDefaultTemplate: function (type) {
        return exports.DEFAULT_REPORT_TEMPLATES[type] || exports.DEFAULT_REPORT_TEMPLATES.operational_overview;
    },
    /**
     * Get Color Palette
     */
