...
var PatientSatisfactionMetricsEngine = /** @class */ (function () {
     ...
     */
    PatientSatisfactionMetricsEngine.prototype.initializeSatisfactionTracking = function (patientId, config) {
        return __awaiter(this, void 0, void 0, function () {
            var satisfactionConfig;
            return __generator(this, function (_a) {
                try {
                    satisfactionConfig = __assign({ auto_surveys_enabled: true, preferred_collection_methods: ['email_survey', 'whatsapp_survey'], survey_frequency: {
     ...
     */
    PatientSatisfactionMetricsEngine.prototype.createSatisfactionSurvey = function (patientId, surveyType, collectionMethod, triggerEvent) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.sendSurvey(survey, collectionMethod)
                            // Schedule reminders if enabled
                        ];
                    case 2:
                        // Send survey based on collection method
                        _b.sent();
                        if (!(config === null || config === void 0 ? void 0 : config.reminder_schedule.enabled)) return [3 /*break*/, 4];
     ...
     */
    PatientSatisfactionMetricsEngine.prototype.processSurveyResponse = function (surveyId, responses, feedbackText, additionalData) {
        return __awaiter(this, void 0, void 0, function () {
            var survey, processedScores, feedbackSentiment, responseTimeMinutes, updateError, metrics, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 8, , 9]);
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        responseTimeMinutes = Math.round((new Date().getTime() - new Date(survey.sent_at).getTime()) / (1000 * 60));
                        return [4 /*yield*/, this.supabase
                                .from('satisfaction_surveys')
                                .update({
                                ...
                                metadata: __assign(__assign(__assign({}, survey.metadata), { processed_at: new Date().toISOString(), completion_rate: this.calculateCompletionRate(responses) }), additionalData)
                            })
                                .eq('id', surveyId)];
                    case 4:
                        ...
                        return [4 /*yield*/, this.calculateSatisfactionMetrics(survey.patient_id)
                            // Check for immediate actions needed
                        ];
                    case 5:
                        metrics = _a.sent();
                        // Check for immediate actions needed
                        return [4 /*yield*/, this.checkForImmediateActions(survey.patient_id, processedScores, feedbackSentiment)
    ...
    PatientSatisfactionMetricsEngine.prototype.calculateSatisfactionMetrics = function (patientId_1) {
        return __awaiter(this, arguments, void 0, function (patientId, periodDays) {
            var periodStart, surveys, averageScores, scoreTrends, npsScore, npsCategory, cesScore, csatScore, benchmarkComparison, satisfactionPercentile, improvementOpportunities, predictedTrends, allSurveys, totalSurveys, responseRate, metrics, error_3;
            if (periodDays === void 0) { periodDays = 365; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        improvementOpportunities = this.identifyImprovementOpportunities(averageScores, benchmarkComparison);
                    ...
                    case 2:
                        ...
                        totalSurveys = (allSurveys === null || allSurveys === void 0 ? void 0 : allSurveys.length) || 0;
    ...
    PatientSatisfactionMetricsEngine.prototype.analyzeSatisfactionTrends = function (patientId_1) {
        return __awaiter(this, arguments, void 0, function (patientId, periodDays) {
            var periodStart, surveys, trendData, predictiveInsights, benchmarkingInsights, analysis, error_4;
            if (periodDays === void 0) { periodDays = 365; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = method;
                        switch (_a) {
                            case 'email_survey': return [3 /*break*/, 1];
                            case 'whatsapp_survey': return [3 /*break*/, 3];
                            case 'sms_survey': return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 7];
                    case 1: return [4 /*yield*/, this.sendEmailSurvey(survey)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 3: return [4 /*yield*/, this.sendWhatsAppSurvey(survey)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 5: return [4 /*yield*/, this.sendSMSSurvey(survey)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 7:
                        logger_1.logger.debug("Survey method ".concat(method, " scheduled for manual handling"));
                        _b.label = 8;
    ...
    PatientSatisfactionMetricsEngine.prototype.scheduleReminders = function (surveyId, reminderConfig) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    PatientSatisfactionMetricsEngine.prototype.processResponses = function (responses) {
        ...
        if (!responses.overall) {
            ...
            if (relevantScores.length > 0) {
                processedScores.overall = relevantScores.reduce(function (sum, score) { return sum + score; }, 0) / relevantScores.length;
            }
        }
    ...
    PatientSatisfactionMetricsEngine.prototype.analyzeFeedbackSentiment = function (feedbackText) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                positiveKeywords = ['excellent', 'great', 'amazing', 'fantastic', 'perfect', 'love', 'recommend'];
                negativeKeywords = ['terrible', 'awful', 'horrible', 'hate', 'worst', 'disappointed', 'unsatisfied'];
    ...
    PatientSatisfactionMetricsEngine.prototype.calculateCompletionRate = function (responses) {
        ...
        var answeredQuestions = Object.values(responses).filter(function (value) { return value !== undefined && value > 0; }).length;
        return answeredQuestions / totalQuestions;
    };
    PatientSatisfactionMetricsEngine.prototype.checkForImmediateActions = function (patientId, scores, sentiment) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(criticalDimensions.length > 0 || (sentiment && sentiment < -0.5))) return [3 /*break*/, 2];
                        ...
                        return [4 /*yield*/, this.triggerImmediateAction(patientId, criticalDimensions, sentiment)];
                    case 1:
                        // Trigger immediate action workflow
                        _a.sent();
                        _a.label = 2;
    ...
    PatientSatisfactionMetricsEngine.prototype.triggerImmediateAction = function (patientId, criticalDimensions, sentiment) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    PatientSatisfactionMetricsEngine.prototype.updatePatientSatisfactionProfile = function (patientId, metrics) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    PatientSatisfactionMetricsEngine.prototype.calculateNPS = function (surveys) {
        var npsScores = surveys
            .map(function (s) { return s.recommendation_score; })
            .filter(function (score) { return score >= 0 && score <= 10; });
        if (npsScores.length === 0)
            return 0;
        var promoters = npsScores.filter(function (score) { return score >= 9; }).length;
        var detractors = npsScores.filter(function (score) { return score <= 6; }).length;
    ...
    PatientSatisfactionMetricsEngine.prototype.calculateCES = function (surveys) {
        var cesScores = surveys
            .map(function (s) { return s.effort_score; })
            .filter(function (score) { return score > 0; });
        return cesScores.length > 0 ?
            Math.round((cesScores.reduce(function (sum, score) { return sum + score; }, 0) / cesScores.length) * 100) / 100 : 0;
    };
    PatientSatisfactionMetricsEngine.prototype.calculateCSAT = function (surveys) {
        var csatScores = surveys
            .map(function (s) { return s.overall_score; })
            .filter(function (score) { return score > 0; });
        return csatScores.length > 0 ?
            Math.round((csatScores.reduce(function (sum, score) { return sum + score; }, 0) / csatScores.length) * 100) / 100 : 0;
    };
    PatientSatisfactionMetricsEngine.prototype.calculateBenchmarkComparison = function (averageScores) {
        var _this = this;
        var variance = {};
    ...
    PatientSatisfactionMetricsEngine.prototype.calculateSatisfactionPercentile = function (overallScore) {
    ...
    PatientSatisfactionMetricsEngine.prototype.identifyImprovementOpportunities = function (averageScores, benchmarkComparison) {
        var _this = this;
        var opportunities = [];
        Object.keys(averageScores).forEach(function (key) {
            var dimension = key;
    ...
    PatientSatisfactionMetricsEngine.prototype.getPriorityLevel = function (variance, currentScore) {
        if (currentScore < 2.0 || variance < -1.0)
            return 'critical';
        if (currentScore < 3.0 || variance < -0.7)
            return 'high';
        if (variance < -0.5)
            return 'medium';
        return 'low';
    };
    PatientSatisfactionMetricsEngine.prototype.getRecommendedActions = function (dimension, currentScore) {
        var actions = {
    ...
    PatientSatisfactionMetricsEngine.prototype.generatePredictedTrends = function (scoreTrends) {
        ...
        Object.keys(scoreTrends).forEach(function (key) {
            ...
            if (trend.length >= 2) {
                ...
                var trendDirection = lastScore > secondLastScore ? 'improving' :
    ...
    PatientSatisfactionMetricsEngine.prototype.analyzeTrendData = function (surveys) {
        ...
        var scores = surveys.map(function (s) { return s.overall_score; });
    ...
    PatientSatisfactionMetricsEngine.prototype.generatePredictiveInsights = function (surveys, trendData) {
        var latestSurvey = surveys[surveys.length - 1];
        var churnRiskIndicator = this.calculateChurnRisk(surveys);
        var loyaltyScore = (latestSurvey === null || latestSurvey === void 0 ? void 0 : latestSurvey.overall_score) || 0;
        return {
    ...
    PatientSatisfactionMetricsEngine.prototype.calculateBenchmarkingInsights = function (surveys) {
        ...
        Object.keys(this.industryBenchmarks).forEach(function (key) {
            var _a;
            var dimension = key;
            var patientScore = ((_a = latestSurvey === null || latestSurvey === void 0 ? void 0 : latestSurvey.satisfaction_scores) === null || _a === void 0 ? void 0 : _a[dimension]) || 0;
        ...
        var improvementPriorityRanking = Object.keys(performanceVsIndustry)
            .filter(function (key) { return performanceVsIndustry[key] === 'below'; })
            .sort(function (a, b) {
            var _a, _b;
            var scoreA = ((_a = latestSurvey === null || latestSurvey === void 0 ? void 0 : latestSurvey.satisfaction_scores) === null || _a === void 0 ? void 0 : _a[a]) || 0;
            var scoreB = ((_b = latestSurvey === null || latestSurvey === void 0 ? void 0 : latestSurvey.satisfaction_scores) === null || _b === void 0 ? void 0 : _b[b]) || 0;
        ...
        return {
            ...
            competitive_positioning: this.getCompetitivePositioning((latestSurvey === null || latestSurvey === void 0 ? void 0 : latestSurvey.overall_score) || 0)
        };
    };
    PatientSatisfactionMetricsEngine.prototype.calculateChurnRisk = function (surveys) {
        ...
        if (latestSurvey.overall_score < 3.0)
            riskScore += 0.3;
        // Low NPS
        if (latestSurvey.recommendation_score < 7)
            riskScore += 0.2;
        // Declining trend
        if (surveys.length > 1) {
            var previousSurvey = surveys[surveys.length - 2];
            if (latestSurvey.overall_score < previousSurvey.overall_score)
                riskScore += 0.2;
        }
        // Negative sentiment
    ...
    PatientSatisfactionMetricsEngine.prototype.generateInterventionRecommendations = function (churnRisk, loyaltyScore) {
        var recommendations = [];
        if (churnRisk > 0.7) {
