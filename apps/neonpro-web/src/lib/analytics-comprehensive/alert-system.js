...
var AlertSystem = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log("Starting alert monitoring with ".concat(intervalMinutes, " minute intervals"));
                        // Initial check
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        _i++;
                        return [3 /*break*/, 2];
                    case 6: return [2 /*return*/, triggeredAlerts];
                    case 7:
                        error_2 = _c.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        // Store in database
                        _b.sent();
                        console.log("Alert triggered: ".concat(rule.name, " - ").concat(alert.metric, ": ").concat(alert.currentValue));
                        return [3 /*break*/, 7];
                    case 6:
                        error_4 = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        setTimeout(function () { return _this.performAction(action, alert, rule); }, action.delay * 60 * 1000);
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.performAction(action, alert, rule)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'auto_reschedule': return [3 /*break*/, 9];
                            case 'escalate': return [3 /*break*/, 11];
                        }
                        return [3 /*break*/, 13];
                    case 1: return [4 /*yield*/, this.sendEmailNotification(alert, rule, action.config)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 14];
                    case 3: return [4 /*yield*/, this.sendSMSNotification(alert, rule, action.config)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 14];
                    case 5: return [4 /*yield*/, this.sendPushNotification(alert, rule, action.config)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 14];
                    case 7: return [4 /*yield*/, this.sendWebhookNotification(alert, rule, action.config)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 14];
                    case 9: return [4 /*yield*/, this.triggerAutoReschedule(alert, rule)];
                    case 10:
                        _b.sent();
                        return [3 /*break*/, 14];
                    case 11: return [4 /*yield*/, this.escalateAlert(alert, rule)];
                    case 12:
                        _b.sent();
                        return [3 /*break*/, 14];
                    case 13:
    ...
    AlertSystem.prototype.createAlertRule = function (rule) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newRule = __assign(__assign({}, rule), { id: "rule_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)), createdAt: new Date(), updatedAt: new Date() });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!existingRule)
                            return [2 /*return*/, null];
                        updatedRule = __assign(__assign(__assign({}, existingRule), updates), { updatedAt: new Date() });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        historyEntry = this.alertHistory.find(function (h) { return h.alertId === alertId; });
                        if (historyEntry) {
    ...
    AlertSystem.prototype.getAlertDashboard = function () {
        return __awaiter(this, void 0, void 0, function () {
            var activeAlerts, alertsByCategory, alertTrends, topAlertRules, resolutionMetrics, systemHealth;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    AlertSystem.prototype.isInCooldown = function (ruleId) {
        ...
        var lastTrigger = this.alertHistory
            .filter(function (h) { return h.ruleId === ruleId; })
            .sort(function (a, b) { return b.triggeredAt.getTime() - a.triggeredAt.getTime(); })[0];
        if (!lastTrigger)
            return false;
        var cooldownEnd = new Date(lastTrigger.triggeredAt.getTime() + rule.cooldownMinutes * 60 * 1000);
        return new Date() < cooldownEnd;
    };
    AlertSystem.prototype.getAlertType = function (metric) {
        if (metric.includes('utilization') || metric.includes('efficiency'))
            return 'efficiency';
        if (metric.includes('satisfaction') || metric.includes('quality'))
            return 'satisfaction';
        if (metric.includes('revenue') || metric.includes('productivity'))
            return 'productivity';
        return 'utilization';
    };
    ...
    AlertSystem.prototype.calculateTopAlertRules = function () {
        ...
        return Array.from(ruleCounts.entries())
            .map(function (_a) {
            var ruleId = _a[0], triggerCount = _a[1];
            ...
            .sort(function (a, b) { return b.triggerCount - a.triggerCount; })
            .slice(0, 10);
    };
    AlertSystem.prototype.calculateResolutionMetrics = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                resolvedAlerts = this.alertHistory.filter(function (h) { return h.status === 'resolved'; });
                acknowledgedAlerts = this.alertHistory.filter(function (h) { return h.acknowledgedAt; });
                resolutionTimes = resolvedAlerts
                    .filter(function (h) { return h.resolvedAt; })
                    .map(function (h) { return h.resolvedAt.getTime() - h.triggeredAt.getTime(); });
                averageResolutionTime = resolutionTimes.length > 0 ?
                    resolutionTimes.reduce(function (sum, time) { return sum + time; }, 0) / resolutionTimes.length / (1000 * 60) : 0;
                return [2 /*return*/, {
    ...
    AlertSystem.prototype.calculateSystemHealth = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                criticalAlerts = Array.from(this.activeAlerts.values()).filter(function (a) { return a.severity === 'critical'; });
                highAlerts = Array.from(this.activeAlerts.values()).filter(function (a) { return a.severity === 'high'; });
    ...
    AlertSystem.prototype.setupRealtimeSubscriptions = function () {
        ...
        this.supabase
            ...
            .on('postgres_changes', { event: '*', schema: 'public', table: 'appointments' }, function () { return _this.checkAllAlerts(); })
            .subscribe();
    };
