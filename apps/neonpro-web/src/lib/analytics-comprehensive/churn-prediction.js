...
var ChurnPredictionEngine = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.createBaselineFeatures(patientId)
    ...
    ChurnPredictionEngine.prototype.trainChurnModel = function () {
        return __awaiter(this, arguments, void 0, function (forceRetrain) {
            ...
            var _a;
            if (forceRetrain === void 0) { forceRetrain = false; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(this.modelStatus === 'trained' && !forceRetrain && !this.needsRetraining())) return [3 /*break*/, 2];
                        _a = { success: true };
                        return [4 /*yield*/, this.getModelMetrics()];
                    case 1: return [2 /*return*/, (_a.metrics = _b.sent(), _a)];
                    case 2:
                    ...
                    case 3:
                        ...
                        if (trainingData.samples < this.modelConfig.training_parameters.min_training_samples) {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    error: "Insufficient training data: ".concat(trainingData.samples, " < ").concat(this.modelConfig.training_parameters.min_training_samples)
                                }];
                        }
                        return [4 /*yield*/, this.engineerFeatures(trainingData)
                            // Train model
                        ];
                    case 4:
                        engineeredFeatures = _b.sent();
                        return [4 /*yield*/, this.trainModel(engineeredFeatures)
    ...
    ChurnPredictionEngine.prototype.predictChurnProbability = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var currentFeatures, prediction, riskLevel, contributingFactors, riskIndicators, recommendedInterventions, result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 9, , 10]);
                    ...
                    case 2: return [4 /*yield*/, this.extractPatientFeatures(patientId)
                        // Make prediction using trained model
                    ];
                    case 3:
                        currentFeatures = _a.sent();
                        return [4 /*yield*/, this.makePrediction(currentFeatures)
                            // Calculate risk level
                        ];
                    case 4:
                        prediction = _a.sent();
                        riskLevel = this.calculateRiskLevel(prediction.probability);
                        return [4 /*yield*/, this.identifyContributingFactors(currentFeatures, prediction)
                            // Generate risk indicators
                        ];
                    case 5:
                        contributingFactors = _a.sent();
                        riskIndicators = this.generateRiskIndicators(contributingFactors);
                        return [4 /*yield*/, this.recommendInterventions(patientId, prediction.probability, riskLevel, contributingFactors)];
                    case 6:
                        ...
                        return [4 /*yield*/, this.savePredictionResult(result)
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, this.identifyTargetPatients(campaignConfig.target_risk_levels || ['high', 'very_high'])];
                    case 1:
                        targetPatients = _a.sent();
                        campaign = {
                            id: "campaign_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                            campaign_name: campaignConfig.campaign_name || "Retention Campaign ".concat(new Date().toISOString().split('T')[0]),
                            target_risk_levels: campaignConfig.target_risk_levels || ['high', 'very_high'],
                            intervention_types: campaignConfig.intervention_types || ['customer_success_outreach', 'personalized_offer'],
                            target_patients: targetPatients,
                            campaign_start: new Date(),
                            campaign_end: campaignConfig.campaign_end,
                            status: 'planned',
                            campaign_rules: __assign({ min_risk_probability: 0.6, max_days_since_last_contact: 30, exclude_recent_campaigns: true, max_interventions_per_patient: 3 }, campaignConfig.campaign_rules),
                            ...
                            success_metrics: __assign({ target_retention_rate: 0.75, target_engagement_rate: 0.60, max_cost_per_retention: 500, roi_target: 3.0 }, campaignConfig.success_metrics),
                            created_at: new Date()
                        };
    ...
    ChurnPredictionEngine.prototype.monitorChurnRisk = function () {
        return __awaiter(this, void 0, void 0, function () {
            var alerts, highRiskPatients, activePatients, _i, activePatients_1, patientId, prediction, riskTrend, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        riskTrend = _a.sent();
                        if (riskTrend.increase_rate > 0.3) { // 30% increase
                            alerts.push({
                                type: 'rapid_risk_increase',
                                patient_id: patientId,
                                current_risk: prediction.churn_probability,
                                trend: riskTrend,
                                recommended_actions: ['Immediate customer success intervention', 'Investigate recent interactions']
                            });
                        }
                        _a.label = 5;
                    case 5:
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, this.createPreventionCampaign({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.calculateFeatureImportance()
                            // Analyze feature interactions
                        ];
                    case 1:
                        featureImportance = _a.sent();
                        return [4 /*yield*/, this.analyzeFeatureInteractions()
    ...
    ChurnPredictionEngine.prototype.initializeModelConfig = function (config) {
        return __assign({ model_name: 'neonpro_churn_predictor_v1', model_type: 'ensemble', feature_selection: [
    ...
    ChurnPredictionEngine.prototype.meetsPerformanceThresholds = function (metrics) {
        ...
        return (metrics.accuracy >= thresholds.min_accuracy &&
            metrics.precision >= thresholds.min_precision &&
            metrics.recall >= thresholds.min_recall &&
            metrics.f1_score >= thresholds.min_f1_score);
    };
    ChurnPredictionEngine.prototype.saveModelMetadata = function (trainingResults, validationResults) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ChurnPredictionEngine.prototype.heuristicChurnPrediction = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getPatientSatisfactionData(patientId)];
                    case 1:
                        satisfactionData = _a.sent();
                        return [4 /*yield*/, this.getPatientEngagementData(patientId)
                            // Simple heuristic scoring
                        ];
                    case 2:
                        engagementData = _a.sent();
                        riskScore = 0;
                        if (satisfactionData.averageScore < 3.0)
                            riskScore += 0.3;
                        if (engagementData.lastEngagement > 30)
                            riskScore += 0.2;
                        if (engagementData.frequency < 0.5)
                            riskScore += 0.2;
    ...
    ChurnPredictionEngine.prototype.makePrediction = function (features) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                avgFeatureValue = featureValues.reduce(function (sum, val) { return sum + val; }, 0) / featureValues.length;
                probability = 0.5 // Base probability
                ;
                if (avgFeatureValue < 0.3)
                    probability += 0.3;
                if (avgFeatureValue < 0.2)
                    probability += 0.2;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 1];
                    case 5: return [2 /*return*/, factors.sort(function (a, b) { return b.risk_contribution - a.risk_contribution; })];
                }
            });
        });
    };
        ...
        contributingFactors.forEach(function (factor) {
            if (factor.risk_contribution > 0.2) {
                indicators.push({
                    ...
                    description: "".concat(factor.feature, " shows high risk contribution (").concat(Math.round(factor.risk_contribution * 100), "%)"),
    ...
    ChurnPredictionEngine.prototype.recommendInterventions = function (patientId, probability, riskLevel, contributingFactors) {
        return __awaiter(this, void 0, void 0, function () {
            var interventions;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, interventions.sort(function (a, b) { return a.priority - b.priority; })];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        logger_1.logger.warn('Very high churn risk detected - triggering immediate intervention', {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        predictions = (_a.sent()) // Last 7 days
                        .data;
                        return [2 /*return*/, (predictions === null || predictions === void 0 ? void 0 : predictions.map(function (p) { return p.patient_id; })) || []];
                }
            });
        });
    };
    ...
    ChurnPredictionEngine.prototype.generateFeatureInsights = function (featureImportance, featureInteractions) {
        return [
            {
                insight_type: 'trend',
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = feature;
                        switch (_a) {
                            case 'engagement_frequency': return [3 /*break*/, 1];
                            case 'satisfaction_trend': return [3 /*break*/, 3];
                            case 'appointment_adherence': return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 7];
                    case 1: return [4 /*yield*/, this.calculateEngagementFrequency(patientId)];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3: return [4 /*yield*/, this.calculateSatisfactionTrend(patientId)];
                    case 4: return [2 /*return*/, _b.sent()];
                    case 5: return [4 /*yield*/, this.calculateAppointmentAdherence(patientId)];
                    case 6: return [2 /*return*/, _b.sent()];
                    case 7: return [2 /*return*/, Math.random()]; // Mock value
                }
            });
        });
    };
    ...
    ChurnPredictionEngine.prototype.calculateRiskContribution = function (feature, value, importance) {
    ...
    ChurnPredictionEngine.prototype.getFactorSpecificIntervention = function (factor) {
        if (factor.risk_contribution < 0.15)
            return null;
        var interventions = {
            satisfaction_trend: {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                logger_1.logger.info('Immediate intervention triggered', {
                    patient_id: result.patient_id,
                    interventions: result.recommended_interventions.filter(function (i) { return i.timing === 'immediate'; })
                });
                return [2 /*return*/];
            });
        });
