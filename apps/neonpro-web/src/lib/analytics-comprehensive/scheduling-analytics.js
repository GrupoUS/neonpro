...
var SchedulingAnalytics = /** @class */ (function () {
    ...
    SchedulingAnalytics.prototype.getSchedulingMetrics = function (filter) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, cached, _a, appointments, error, totalAppointments, completedAppointments, cancelledAppointments, noShowAppointments, avgDuration, totalScheduledHours, totalUsedHours, utilizationRate, revenueGenerated, patientSatisfactionScore, staffEfficiencyScore, peakHours, bottleneckIdentified, metrics, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        avgDuration = (appointments === null || appointments === void 0 ? void 0 : appointments.reduce(function (sum, a) { return sum + (a.actual_duration || a.scheduled_duration || 0); }, 0)) / totalAppointments || 0;
                        totalScheduledHours = this.calculateTotalScheduledHours(filter);
                        totalUsedHours = (appointments === null || appointments === void 0 ? void 0 : appointments.reduce(function (sum, a) { return sum + ((a.actual_duration || a.scheduled_duration || 0) / 60); }, 0)) || 0;
                        utilizationRate = totalScheduledHours > 0 ? (totalUsedHours / totalScheduledHours) * 100 : 0;
                        revenueGenerated = (appointments === null || appointments === void 0 ? void 0 : appointments.reduce(function (sum, a) {
                            var _a;
                            return sum + (((_a = a.services) === null || _a === void 0 ? void 0 : _a.price) || 0);
                        }, 0)) || 0;
                        return [4 /*yield*/, this.calculatePatientSatisfaction(filter)];
                    case 3:
                        patientSatisfactionScore = _b.sent();
                        return [4 /*yield*/, this.calculateStaffEfficiency(filter)
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (error)
                            throw error;
                        patterns_1 = new Map();
                        appointments === null || appointments === void 0 ? void 0 : appointments.forEach(function (appointment) {
                            var _a;
                            ...
                            if (appointment.status === 'no_show')
                                pattern.noShows++;
                            pattern.revenue += ((_a = appointment.services) === null || _a === void 0 ? void 0 : _a.price) || 0;
                        });
                        result = Array.from(patterns_1.entries()).map(function (_a) {
                            var _b;
                            var key = _a[0], data = _a[1];
                            var _c = key.split('_'), dayOfWeek = _c[0], hourStr = _c[1];
                            ...
                            return _b = {
                                ...
                                _b.staffUtilization = yield _this.calculateHourlyStaffUtilization(dayOfWeek, hour, filter),
                                _b;
                        });
                    ...
                    case 2:
                        ...
                        result = trends_1.map(function (trend, index) {
                            ...
                            var growthRate = previousTrend ?
                                ((trend.appointmentVolume - previousTrend.appointmentVolume) / previousTrend.appointmentVolume) * 100 : 0;
                            // Calculate seasonal index (current period vs average)
                            var averageVolume = trends_1.reduce(function (sum, t) { return sum + t.appointmentVolume; }, 0) / trends_1.length;
                            var seasonalIndex = averageVolume > 0 ? trend.appointmentVolume / averageVolume : 1;
                            return __assign(__assign({}, trend), { growthRate: growthRate, seasonalIndex: seasonalIndex });
                        });
                        this.setCachedData(cacheKey, result);
                        return [2 /*return*/, result];
                    case 3:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (error)
                            throw error;
                        return [4 /*yield*/, Promise.all((staffData || []).map(function (staff) { return __awaiter(_this, void 0, void 0, function () {
                                var appointments, completedAppointments, totalDuration, avgDuration, utilizationRate, ratings, avgRating, revenueGenerated, efficiencyScore, skillUtilizationRate, workloadBalance;
                                var _a;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            appointments = ((_a = staff.appointments) === null || _a === void 0 ? void 0 : _a.filter(function (a) {
                                                var appointmentDate = new Date(a.scheduled_at);
                                                return appointmentDate >= filter.startDate && appointmentDate <= filter.endDate;
                                            })) || [];
                                            completedAppointments = appointments.filter(function (a) { return a.status === 'completed'; });
                                            totalDuration = appointments.reduce(function (sum, a) { return sum + (a.actual_duration || a.scheduled_duration || 0); }, 0);
                                            avgDuration = appointments.length > 0 ? totalDuration / appointments.length : 0;
                                            return [4 /*yield*/, this.calculateStaffUtilization(staff.id, filter)
                                                // Calculate patient satisfaction
                                            ];
                                        case 1:
                                            utilizationRate = _b.sent();
                                            ratings = appointments.flatMap(function (a) { var _a; return ((_a = a.patient_feedback) === null || _a === void 0 ? void 0 : _a.map(function (f) { return f.rating; })) || []; });
                                            avgRating = ratings.length > 0 ? ratings.reduce(function (sum, r) { return sum + r; }, 0) / ratings.length : 0;
                                            revenueGenerated = appointments.reduce(function (sum, a) { var _a; return sum + (((_a = a.services) === null || _a === void 0 ? void 0 : _a.price) || 0); }, 0);
                                            efficiencyScore = appointments.length > 0 ? (completedAppointments.length / appointments.length) * 100 : 0;
    ...
    SchedulingAnalytics.prototype.getRevenueAnalytics = function (filter) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, cached, _a, appointments_1, error, totalRevenue, totalCost, appointmentCount, revenuePerAppointment, totalHours, revenuePerHour, uniqueStaff, revenuePerStaff, profitMargin, valueRanges, appointmentValueDistribution, treatmentRevenue_1, treatmentTypeRevenue, patientLifetimeValue, forecastedRevenue, result, error_5;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (error)
                            throw error;
                        totalRevenue = (appointments_1 === null || appointments_1 === void 0 ? void 0 : appointments_1.reduce(function (sum, a) { var _a; return sum + (((_a = a.services) === null || _a === void 0 ? void 0 : _a.price) || 0); }, 0)) || 0;
                        totalCost = (appointments_1 === null || appointments_1 === void 0 ? void 0 : appointments_1.reduce(function (sum, a) { var _a; return sum + (((_a = a.services) === null || _a === void 0 ? void 0 : _a.cost) || 0); }, 0)) || 0;
                        appointmentCount = (appointments_1 === null || appointments_1 === void 0 ? void 0 : appointments_1.length) || 0;
                        ...
                        uniqueStaff = new Set(appointments_1 === null || appointments_1 === void 0 ? void 0 : appointments_1.map(function (a) { return a.staff_id; })).size;
                        ...
                        appointmentValueDistribution = valueRanges.map(function (range) {
                            var appointmentsInRange = (appointments_1 === null || appointments_1 === void 0 ? void 0 : appointments_1.filter(function (a) {
                                var _a;
                                var price = ((_a = a.services) === null || _a === void 0 ? void 0 : _a.price) || 0;
                                return price >= range.min && price < range.max;
                            })) || [];
                            return {
                                range: range.range,
                                count: appointmentsInRange.length,
                                revenue: appointmentsInRange.reduce(function (sum, a) { var _a; return sum + (((_a = a.services) === null || _a === void 0 ? void 0 : _a.price) || 0); }, 0)
                            };
                        });
                        treatmentRevenue_1 = new Map();
                        appointments_1 === null || appointments_1 === void 0 ? void 0 : appointments_1.forEach(function (appointment) {
                            var _a, _b;
                            var serviceName = ((_a = appointment.services) === null || _a === void 0 ? void 0 : _a.name) || 'Unknown';
                            var price = ((_b = appointment.services) === null || _b === void 0 ? void 0 : _b.price) || 0;
                        ...
                        return [4 /*yield*/, this.calculatePatientLifetimeValue(filter)
    ...
    SchedulingAnalytics.prototype.calculateHourlyStaffUtilization = function (dayOfWeek, hour, filter) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
