...
export class JourneyReportsEngine {
   ...
   */
  async scheduleReport(config: ReportConfig, schedule: ReportSchedule): Promise<string> {
    try {
   ...
   */
  private async generateReportContent(config: ReportConfig, data: any): Promise<ReportContent> {
    // Generate header
