...
var AnalyticsEngine = /** @class */ (() => {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.rpc("execute_analytics_query", {
                query_text: query,
                query_params: params,
              }),
            ];
   ...
   */
  AnalyticsEngine.prototype.calculateAggregatedMetric = function (
    tableName_1,
    column_1,
    aggregation_1,
    timeRange_1,
    ...
    return __awaiter(
      ...
      arguments,
      void 0,
      function (tableName, column, aggregation, timeRange, filters) {
        var currentPeriod,
          previousPeriod,
          filterConditions,
          currentQuery,
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              ...
              currentQuery = "\n      SELECT "
                .concat(aggregation, "(")
                .concat(column, ") as value\n      FROM ")
                .concat(tableName, "\n      WHERE created_at >= '")
                .concat(currentPeriod.startDate, "'\n        AND created_at <= '")
                .concat(currentPeriod.endDate, "'\n        ")
                .concat(filterConditions ? "AND ".concat(filterConditions) : "", "\n    ");
              previousQuery = "\n      SELECT "
                .concat(aggregation, "(")
                .concat(column, ") as value\n      FROM ")
                .concat(tableName, "\n      WHERE created_at >= '")
                .concat(previousPeriod.startDate, "'\n        AND created_at <= '")
                .concat(previousPeriod.endDate, "'\n        ")
                .concat(filterConditions ? "AND ".concat(filterConditions) : "", "\n    ");
              return [
                4 /*yield*/,
                Promise.all([this.executeQuery(currentQuery), this.executeQuery(previousQuery)]),
              ];
            case 1:
              (_a = _d.sent()), (currentResult = _a[0]), (previousResult = _a[1]);
              currentValue =
                ((_b = currentResult[0]) === null || _b === void 0 ? void 0 : _b.value) || 0;
              previousValue =
                ((_c = previousResult[0]) === null || _c === void 0 ? void 0 : _c.value) || 0;
   ...
   */
  AnalyticsEngine.prototype.getTimeSeries = function (
    tableName_1,
    column_1,
    aggregation_1,
    timeRange_1,
    ...
    return __awaiter(
      ...
      arguments,
      void 0,
      function (tableName, column, aggregation, timeRange, groupBy, filters) {
        ...
        return __generator(this, function (_b) {
          (_a = this.formatTimeRange(timeRange)),
          ...
          query = "\n      SELECT \n        TO_CHAR(DATE_TRUNC('"
            .concat(dateTrunc, "', created_at), '")
            .concat(dateFormat, "') as date,\n        ")
            .concat(aggregation, "(")
            .concat(column, ") as value\n      FROM ")
            .concat(tableName, "\n      WHERE created_at >= '")
            .concat(startDate, "'\n        AND created_at <= '")
            .concat(endDate, "'\n        ")
            .concat(
              filterConditions ? "AND ".concat(filterConditions) : "",
              "\n      GROUP BY DATE_TRUNC('",
            )
            .concat(dateTrunc, "', created_at)\n      ORDER BY DATE_TRUNC('")
            .concat(dateTrunc, "', created_at)\n    ");
