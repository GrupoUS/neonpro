...
var TouchpointAnalysisEngine = /** @class */ (function () {
    function TouchpointAnalysisEngine(config) {
        ...
        this.criticalMomentConfig = __assign({ sentiment_threshold: -0.3, quality_threshold: 2.5, response_time_threshold: 3600, escalation_triggers: ['complaint_handling', 'emergency_contact', 'support_request'], auto_alert_enabled: true, alert_channels: ['email', 'whatsapp'], intervention_rules: [
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4: return [4 /*yield*/, this.supabase
                            ...
                            metadata: __assign(__assign({}, touchpointData.metadata), { analysis_timestamp: new Date().toISOString(), auto_analyzed: true })
                        })
                            .select()
                            .single()];
                    case 5:
    ...
    TouchpointAnalysisEngine.prototype.analyzePatientTouchpoints = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var touchpoints, touchpointBreakdown, qualityMetrics, channelEffectiveness, criticalMoments, optimizationOpportunities, sentimentAnalysis, performanceIndicators, analysis, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.analyzeChannelEffectiveness(touchpoints)
    ...
    TouchpointAnalysisEngine.prototype.analyzeChannelPerformance = function (channel, dateRange) {
        return __awaiter(this, void 0, void 0, function () {
            var query, touchpoints, totalInteractions, avgQualityScore, conversions, conversionRate, satisfactionScores, avgSatisfaction, responseTimes, responseTimeMetrics, costMetrics, effectivenessScore, optimizationRecommendations, performance_1, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        avgQualityScore = touchpoints.reduce(function (sum, t) { return sum + t.interaction_quality; }, 0) / totalInteractions;
                        ...
                        satisfactionScores = touchpoints
                            .filter(function (t) { return t.metadata.satisfaction_rating; })
                            .map(function (t) { return t.metadata.satisfaction_rating; });
                        avgSatisfaction = satisfactionScores.length > 0 ?
                            satisfactionScores.reduce(function (sum, score) { return sum + score; }, 0) / satisfactionScores.length : 0;
                        responseTimes = touchpoints
                            .filter(function (t) { return t.metadata.response_time_seconds; })
                            .map(function (t) { return t.metadata.response_time_seconds; })
                            .sort(function (a, b) { return a - b; });
                        responseTimeMetrics = {
                            average_seconds: responseTimes.length > 0 ?
                                responseTimes.reduce(function (sum, time) { return sum + time; }, 0) / responseTimes.length : 0,
    ...
    TouchpointAnalysisEngine.prototype.checkCriticalMoment = function (touchpoint) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                _a = this.criticalMomentConfig, sentiment_threshold = _a.sentiment_threshold, quality_threshold = _a.quality_threshold, escalation_triggers = _a.escalation_triggers;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        rule = _a[_i];
                        if (!this.evaluateInterventionCondition(rule.condition, touchpoint)) return [3 /*break*/, 3];
    ...
    TouchpointAnalysisEngine.prototype.calculateQualityMetrics = function (touchpoints) {
        var _this = this;
        var qualityScores = touchpoints.map(function (tp) { return tp.interaction_quality; });
    ...
    TouchpointAnalysisEngine.prototype.analyzeChannelEffectiveness = function (touchpoints) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                channelRankings = Object.keys(channelStats).map(function (channel) {
                    var stats = channelStats[channel];
                    var avgQuality = stats.quality_scores.reduce(function (sum, score) { return sum + score; }, 0) / stats.quality_scores.length;
                    var conversionRate = stats.conversions / stats.count;
                    var avgSatisfaction = stats.satisfaction_scores.length > 0 ?
                        stats.satisfaction_scores.reduce(function (sum, score) { return sum + score; }, 0) / stats.satisfaction_scores.length : 0;
                    var avgResponseTime = stats.response_times.length > 0 ?
                        stats.response_times.reduce(function (sum, time) { return sum + time; }, 0) / stats.response_times.length : 0;
                ...
                }).sort(function (a, b) { return b.effectiveness_score - a.effectiveness_score; });
                bestChannel = (_a = channelRankings[0]) === null || _a === void 0 ? void 0 : _a.channel;
                underperformingChannels = channelRankings
                    .filter(function (c) { return c.effectiveness_score < 3.0; })
    ...
    TouchpointAnalysisEngine.prototype.identifyCriticalMoments = function (touchpoints) {
        ...
        return touchpoints
            .filter(function (tp) {
            return tp.interaction_quality < _this.criticalMomentConfig.quality_threshold ||
            ...
            .sort(function (a, b) { return b.criticality_score - a.criticality_score; });
    };
    /**
    ...
    TouchpointAnalysisEngine.prototype.generateOptimizationOpportunities = function (touchpoints) {
        ...
        var lowQualityCount = touchpoints.filter(function (tp) { return tp.interaction_quality < 3.0; }).length;
        ...
        var underperformingChannels = Object.keys(channelPerformance)
            .filter(function (channel) { return channelPerformance[channel].avg_quality < 3.0; });
        if (underperformingChannels.length > 0) {
            opportunities.push({
                opportunity_type: 'channel_optimization',
                description: "Otimizar canais de baixo desempenho: ".concat(underperformingChannels.join(', ')),
        ...
        var avgResponseTime = touchpoints
            .filter(function (tp) { return tp.metadata.response_time_seconds; })
            .reduce(function (sum, tp) { return sum + tp.metadata.response_time_seconds; }, 0) /
            touchpoints.filter(function (tp) { return tp.metadata.response_time_seconds; }).length;
        ...
        return opportunities.sort(function (a, b) { return b.priority_score - a.priority_score; });
    };
    /**
    ...
    TouchpointAnalysisEngine.prototype.analyzeTouchpointSentiment = function (touchpoints) {
        var _this = this;
        var sentimentScores = touchpoints.map(function (tp) { return tp.sentiment_score; });
        var overallSentiment = sentimentScores.reduce(function (sum, score) { return sum + score; }, 0) / sentimentScores.length;
        // Sentiment trend (last 30 touchpoints)
        var trend = sentimentScores.slice(-30);
        // Emotional journey
        var emotionalJourney = touchpoints.map(function (tp) { return ({
            touchpoint_id: tp.id,
    ...
    TouchpointAnalysisEngine.prototype.calculatePerformanceIndicators = function (touchpoints) {
        var responseTimes = touchpoints
            .filter(function (tp) { return tp.metadata.response_time_seconds; })
            .map(function (tp) { return tp.metadata.response_time_seconds; });
        var firstResponseTime = responseTimes.length > 0 ?
            responseTimes.reduce(function (sum, time) { return sum + time; }, 0) / responseTimes.length : 0;
        var resolvedIssues = touchpoints.filter(function (tp) { return tp.outcome === 'issue_resolved'; }).length;
        var totalIssues = touchpoints.filter(function (tp) {
            return tp.touchpoint_type === 'complaint_handling' ||
                tp.touchpoint_type === 'support_request';
        }).length;
        var resolutionRate = totalIssues > 0 ? resolvedIssues / totalIssues : 0;
        var escalations = touchpoints.filter(function (tp) { return tp.outcome === 'escalation_required'; }).length;
        ...
        var totalRatings = touchpoints.filter(function (tp) { return tp.metadata.satisfaction_rating; }).length;
    ...
    TouchpointAnalysisEngine.prototype.calculateChannelROI = function (channel, touchpoints) {
        ...
        var channelTouchpoints = touchpoints.filter(function (tp) { return tp.channel === channel; });
        var conversions = channelTouchpoints.filter(function (tp) { return tp.outcome === 'conversion'; }).length;
    ...
    TouchpointAnalysisEngine.prototype.calculateChannelEffectivenessScore = function (metrics) {
        var quality_score = metrics.quality_score, conversion_rate = metrics.conversion_rate, satisfaction_score = metrics.satisfaction_score, response_time = metrics.response_time, cost_efficiency = metrics.cost_efficiency;
        // Normalize response time (lower is better)
        var normalizedResponseTime = Math.max(0, 1 - (response_time / 7200)); // 2 hours max
        // Weighted average of all factors
        var effectiveness = (quality_score * 0.25 +
    ...
    TouchpointAnalysisEngine.prototype.generateChannelOptimizationRecommendations = function (channel, metrics) {
        var recommendations = [];
    ...
    TouchpointAnalysisEngine.prototype.calculateCriticalityScore = function (touchpoint) {
        ...
        if (touchpoint.interaction_quality < 2.0)
            score += 0.4;
        else if (touchpoint.interaction_quality < 3.0)
            score += 0.2;
        // Sentiment factor
        if (touchpoint.sentiment_score < -0.5)
            score += 0.3;
        else if (touchpoint.sentiment_score < 0)
            score += 0.1;
        // Outcome factor
    ...
    TouchpointAnalysisEngine.prototype.evaluateInterventionCondition = function (condition, touchpoint) {
