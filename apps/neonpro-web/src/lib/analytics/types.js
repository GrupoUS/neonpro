...
exports.AnalyticsQuerySchema = exports.SubscriptionTierSchema = exports.TrialStatusSchema = exports.MetricCategorySchema = exports.MetricPeriodSchema = void 0;
var zod_1 = require("zod");
// ============================================================================
// ZOD VALIDATION SCHEMAS
// ============================================================================
exports.MetricPeriodSchema = zod_1.z.enum(['day', 'week', 'month', 'quarter', 'year']);
exports.MetricCategorySchema = zod_1.z.enum(['revenue', 'conversion', 'engagement', 'retention', 'growth']);
