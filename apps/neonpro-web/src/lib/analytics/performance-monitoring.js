...
exports.performanceMonitoringEngine = exports.PerformanceMonitoringEngine = exports.SystemMetricsSchema = exports.createperformanceMonitoringEngine = void 0;
...
var createperformanceMonitoringEngine = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _b = {
                            id: "metrics_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                    ...
                    case 6:
                        metrics = (_b.metrics = (_c.application = _d.sent(),
                            _c),
                            _b.healthScore = 0,
                            _b.status = 'optimal',
                            _b.alerts = [],
    ...
    createperformanceMonitoringEngine.prototype.getRealtimeData = function (clinicId_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, categories) {
            ...
            var _c;
            if (categories === void 0) { categories = ['system', 'application', 'database']; }
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 8, , 9]);
     ...
     */
    createperformanceMonitoringEngine.prototype.generateReport = function (clinicId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var report, error_4;
            var _a;
    ...
    createperformanceMonitoringEngine.prototype.optimizeResources = function (clinicId_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, resourceTypes) {
            ...
            if (resourceTypes === void 0) { resourceTypes = ['cpu', 'memory', 'storage']; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                    ...
                    case 5:
                        // Apply automatic optimizations
                        _a.sent();
                        logger_1.logger.info("Generated ".concat(optimizations.length, " resource optimizations"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4:
                        performance_1 = (_b.models = (_c.complianceMonitoring = _d.sent(),
                            _c),
                            _b.overallHealth = 0,
                            _b.recommendations = [],
                            _b);
                        modelScores = Object.values(performance_1.models).map(function (m) { return m.healthScore; });
                        performance_1.overallHealth = modelScores.reduce(function (sum, score) { return sum + score; }, 0) / modelScores.length;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        performanceThreshold = __assign({ id: "threshold_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)) }, threshold);
     ...
     */
    createperformanceMonitoringEngine.prototype.getHistoricalMetrics = function (clinicId_1, category_1, component_1, startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, category, component, startDate, endDate, aggregation) {
            var _a, data, error, aggregated, error_8;
            if (aggregation === void 0) { aggregation = 'hour'; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
    ...
    createperformanceMonitoringEngine.prototype.loadThresholds = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                for (_i = 0, defaultThresholds_1 = defaultThresholds; _i < defaultThresholds_1.length; _i++) {
                    threshold = defaultThresholds_1[_i];
                    id = "threshold_".concat(threshold.category, "_").concat(threshold.component, "_").concat(threshold.metric);
    ...
    createperformanceMonitoringEngine.prototype.calculateHealthScore = function (metrics) {
        ...
        // Weighted average
        var weights = { cpu: 0.2, memory: 0.2, storage: 0.15, network: 0.15, database: 0.15, application: 0.15 };
    ...
    createperformanceMonitoringEngine.prototype.calculateApplicationScore = function (application) {
        ...
        var avgFeatureScore = featureScores.reduce(function (sum, s) { return sum + s; }, 0) / featureScores.length;
    ...
    createperformanceMonitoringEngine.prototype.findThreshold = function (category, component, metric) {
    ...
    createperformanceMonitoringEngine.prototype.shouldAlert = function (threshold, value) {
        if (!threshold.enabled)
            return false;
        var key = "".concat(threshold.category, "_").concat(threshold.component, "_").concat(threshold.metric);
    ...
    createperformanceMonitoringEngine.prototype.createAlert = function (threshold, value, message) {
        ...
        return {
            ...
            message: message,
            description: "".concat(threshold.metric, " for ").concat(threshold.component, " is ").concat(value).concat(threshold.unit, ", exceeding threshold of ").concat(threshold.critical).concat(threshold.unit),
            recommendations: this.generateAlertRecommendations(threshold, value),
            acknowledged: false,
            resolved: false
        };
    };
    createperformanceMonitoringEngine.prototype.generateAlertRecommendations = function (threshold, value) {
        var recommendations = [];
...
exports.SystemMetricsSchema = zod_1.z.object({
    category: zod_1.z.enum(['system', 'application', 'database', 'network', 'user_experience', 'ai_models']),
