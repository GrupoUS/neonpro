...
var AnalyticsController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.service.getRevenueAnalytics(period, startDate, endDate, filters)];
                    case 1:
                        analytics = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.service.getConversionAnalytics(period, startDate, endDate, filters)];
                    case 1:
                        analytics = _a.sent();
                        return [2 /*return*/, server_1.NextResponse.json(analytics, {
                                status: 200,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!userId || !trialId) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'userId and trialId are required' }, { status: 400 })];
                        }
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, this.service.getRevenueAnalytics(query.period, query.startDate, query.endDate, query.filters)];
                                        case 1: return [2 /*return*/, _a.sent()];
                                        case 2:
                                            if (!query.metrics.includes('conversion')) return [3 /*break*/, 4];
                                            return [4 /*yield*/, this.service.getConversionAnalytics(query.period, query.startDate, query.endDate, query.filters)];
                                        case 3: return [2 /*return*/, _a.sent()];
                                        case 4: throw new Error("Unsupported metrics: ".concat(query.metrics.join(', ')));
                                    }
                                });
                            }); }))];
                    case 2:
    ...
    // ========================================================================
    AnalyticsController.prototype.handleError = function (error) {
