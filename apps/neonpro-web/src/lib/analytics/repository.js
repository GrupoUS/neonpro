      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("get_revenue_metrics", {
          ...
          case 1:
            ...
            if (error) throw new Error("Revenue metrics query failed: ".concat(error.message));
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("get_conversion_metrics", {
                p_start_date: query.startDate.toISOString(),
                p_end_date: query.endDate.toISOString(),
                p_filters: query.filters || {},
              }),
          ...
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw new Error("Conversion metrics query failed: ".concat(error.message));
            return [2 /*return*/, data || []];
        }
      });
    });
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("get_trial_metrics", {
                p_start_date: query.startDate.toISOString(),
                p_end_date: query.endDate.toISOString(),
                p_filters: query.filters || {},
              }),
          ...
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw new Error("Trial metrics query failed: ".concat(error.message));
            return [2 /*return*/, data || []];
        }
      });
    });
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("calculate_revenue_aggregation", {
          ...
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw new Error("Revenue aggregation failed: ".concat(error.message));
            return [
              2 /*return*/,
              (data === null || data === void 0 ? void 0 : data[0]) ||
                this.createEmptyAggregation(query),
            ];
        }
      });
    });
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.rpc("calculate_conversion_aggregation", {
                p_period: query.period,
                p_start_date: query.startDate.toISOString(),
                p_end_date: query.endDate.toISOString(),
                p_group_by: query.groupBy || [],
          ...
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw new Error("Conversion aggregation failed: ".concat(error.message));
            return [
              2 /*return*/,
              (data === null || data === void 0 ? void 0 : data[0]) ||
                this.createEmptyAggregation(query),
  ...
  AnalyticsRepository.prototype.getRealTimeMetrics = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this.supabase.rpc("get_realtime_metrics")];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw new Error("Real-time metrics query failed: ".concat(error.message));
            return [2 /*return*/, data || []];
        }
      });
    });
          ...
          .on(
            ...
            (payload) => {
              ...
              var metric = {
                ...
                timestamp: new Date(
                  ((_e = payload.new) === null || _e === void 0 ? void 0 : _e.created_at) ||
                    Date.now(),
                ),
                trend:
                  ((_f = payload.new) === null || _f === void 0 ? void 0 : _f.trend) || "stable",
              };
              callback(metric);
            },
          )
