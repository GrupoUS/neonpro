...
var AnalyticsExportService = /** @class */ (function () {
    ...
    AnalyticsExportService.prototype.generateExport = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, data, fileBuffer, fileName, mimeType, _a, pdfOptions, excelOptions, csvOptions, downloadUrl, processingTime, response, error_1, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.updateExportStatus(request.id, 'processing', {
                                percentage: 0,
                    ...
                    case 6:
                        fileBuffer = _b.sent();
                        fileName = "analytics-".concat(request.config.reportType, "-").concat(Date.now(), ".pdf");
                    ...
                    case 8:
                        fileBuffer = _b.sent();
                        fileName = "analytics-".concat(request.config.reportType, "-").concat(Date.now(), ".xlsx");
                    ...
                    case 10:
                        fileBuffer = _b.sent();
                        fileName = "analytics-".concat(request.config.reportType, "-").concat(Date.now(), ".csv");
                        mimeType = 'text/csv';
                        return [3 /*break*/, 13];
                    case 11:
                        fileBuffer = Buffer.from(JSON.stringify(data, null, 2));
                        fileName = "analytics-".concat(request.config.reportType, "-").concat(Date.now(), ".json");
                        mimeType = 'application/json';
                        return [3 /*break*/, 13];
                    case 12: throw new Error("Unsupported export format: ".concat(request.config.format));
                    case 13: return [4 /*yield*/, this.updateExportStatus(request.id, 'processing', {
                            percentage: 80,
                    ...
                    case 15:
                        ...
                        return [4 /*yield*/, this.updateExportStatus(request.id, 'completed')
    ...
    AnalyticsExportService.prototype.fetchAnalyticsData = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var reportType, dateRange, filters, startDate, endDate, data, queryStart, _a, _b, _c, trialMetrics, _d, _e, _f, _g, _h, _j, error_2;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        reportType = config.reportType, dateRange = config.dateRange, filters = config.filters;
                    ...
                    case 1:
                        ...
                        switch (_a) {
                            ...
                            case 'conversion': return [3 /*break*/, 4];
                            case 'trial': return [3 /*break*/, 6];
                            case 'cohort': return [3 /*break*/, 8];
                            case 'forecast': return [3 /*break*/, 10];
                            case 'comprehensive': return [3 /*break*/, 12];
                        }
                        return [3 /*break*/, 17];
                    case 2:
                        _b = data;
                        return [4 /*yield*/, this.analyticsService.getRevenueAnalytics('month', startDate, endDate, filters)];
                    case 3:
                        _b.revenue = _k.sent();
                        return [3 /*break*/, 18];
                    case 4:
                        _c = data;
                        return [4 /*yield*/, this.analyticsService.getConversionAnalytics('month', startDate, endDate, filters)];
                    case 5:
                        _c.conversion = _k.sent();
                        return [3 /*break*/, 18];
                    case 6: return [4 /*yield*/, this.analyticsService.getTrialMetrics(startDate, endDate, filters)];
                    case 7:
                    ...
                    case 8:
                        _d = data;
                        return [4 /*yield*/, this.analyticsService.getCohortAnalysis(startDate, endDate, filters)];
                    case 9:
                        _d.cohorts = _k.sent();
                        return [3 /*break*/, 18];
                    case 10:
                        _e = data;
                        return [4 /*yield*/, this.analyticsService.getRevenueForecasts(startDate, endDate, filters)];
                    case 11:
                    ...
                    case 16:
                        ...
                        return [3 /*break*/, 18];
                    case 17: throw new Error("Unsupported report type: ".concat(reportType));
                    case 18:
                    ...
                    case 19:
                        error_2 = _k.sent();
                        throw new Error("Failed to fetch analytics data: ".concat(error_2 instanceof Error ? error_2.message : 'Unknown error'));
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        title = ((_a = config.customization) === null || _a === void 0 ? void 0 : _a.title) || "Analytics Report - ".concat(config.reportType.toUpperCase());
                        ...
                        doc.text("Generated: ".concat(data.metadata.generatedAt.toLocaleString()), options.margins.left, yPosition);
                        yPosition += 5;
                        doc.text("Period: ".concat(config.dateRange.startDate.toLocaleDateString(), " - ").concat(config.dateRange.endDate.toLocaleDateString()), options.margins.left, yPosition);
                        yPosition += 15;
                        return [4 /*yield*/, this.addPDFContent(doc, data, config, options, yPosition)
                            // Add footer
                        ];
                    case 1:
                        ...
                        if (options.footer) {
                            ...
                            if (options.footer.includeTimestamp) {
                                doc.text("Generated: ".concat(new Date().toLocaleString()), options.margins.left, footerY);
                            }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (config.includeSummary) {
                    ...
                    doc.text("Total Records: ".concat(data.metadata.totalRecords), options.margins.left, yPosition);
                    yPosition += 5;
                    doc.text("Query Execution Time: ".concat(data.metadata.queryExecutionTime, "ms"), options.margins.left, yPosition);
                    yPosition += 15;
                }
    ...
    AnalyticsExportService.prototype.addRevenueSectionToPDF = function (doc, revenue, options, startY) {
        ...
        doc.setTextColor('#333333');
        if (revenue.mrr) {
            doc.text("MRR Total: $".concat(revenue.mrr.total.toLocaleString()), options.margins.left, yPosition);
            yPosition += 5;
            doc.text("MRR Growth: ".concat(revenue.mrr.growth.toFixed(2), "%"), options.margins.left, yPosition);
            yPosition += 5;
        }
        if (revenue.arr) {
            doc.text("ARR Total: $".concat(revenue.arr.total.toLocaleString()), options.margins.left, yPosition);
            yPosition += 5;
            doc.text("ARR Growth: ".concat(revenue.arr.growth.toFixed(2), "%"), options.margins.left, yPosition);
            yPosition += 10;
        }
        return yPosition;
    };
    AnalyticsExportService.prototype.addConversionSectionToPDF = function (doc, conversion, options, startY) {
        var yPosition = startY;
        doc.setFontSize(14);
        doc.setTextColor(options.styling.primaryColor);
        ...
        if (conversion.trialToPayment) {
            doc.text("Trial to Payment: ".concat(conversion.trialToPayment.average.toFixed(2), "%"), options.margins.left, yPosition);
            yPosition += 5;
        }
        if (conversion.signupToTrial) {
            doc.text("Signup to Trial: ".concat(conversion.signupToTrial.average.toFixed(2), "%"), options.margins.left, yPosition);
            yPosition += 10;
        }
        return yPosition;
    };
    AnalyticsExportService.prototype.addCohortSectionToPDF = function (doc, cohorts, options, startY) {
        var yPosition = startY;
        doc.setFontSize(14);
        doc.setTextColor(options.styling.primaryColor);
        ...
        cohorts.slice(0, 5).forEach(function (cohort, index) {
            doc.text("Cohort ".concat(cohort.period, ": ").concat(cohort.size, " users, ").concat(cohort.churnRate.toFixed(2), "% churn"), options.margins.left, yPosition);
            yPosition += 5;
        });
        return yPosition + 10;
    };
    ...
    AnalyticsExportService.prototype.generateExcel = function (data, config, options) {
        return __awaiter(this, void 0, void 0, function () {
            var workbook, summaryData, summaryWS, revenueData, revenueWS, conversionData, conversionWS, cohortData, cohortWS, forecastData, forecastWS, rawWS;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Buffer.from(XLSX.write(workbook, { type: 'buffer', bookType: 'xlsx' }))];
            });
        });
    };
    // ========================================================================
    ...
    AnalyticsExportService.prototype.generateCSV = function (data, config, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                csvContent += "# Period: ".concat(config.dateRange.startDate.toISOString(), " to ").concat(config.dateRange.endDate.toISOString(), "\n");
                csvContent += "\n";
    ...
    AnalyticsExportService.prototype.prepareCohortData = function (cohorts) {
        return cohorts.map(function (cohort) { return ({
    ...
    AnalyticsExportService.prototype.sendCompletionNotification = function (email, response) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log("Sending completion notification to ".concat(email, " for export ").concat(response.id));
                return [2 /*return*/];
            });
        });
    };
...
var createanalyticsExportService = function () { return new AnalyticsExportService(); };
