...
export type ExportDataByType<T extends ReportType> = T extends "revenue"
  ? { revenue: RevenueAnalytics }
  : T extends "conversion"
    ...
    : T extends "cohort"
      ...
      : T extends "forecast"
        ...
        : T extends "trial"
          ? { trials: TrialConversionPrediction[] }
          : T extends "comprehensive"
            ? ExportableData
            : never;

export type ExportOptionsForFormat<T extends ExportFormat> = T extends "pdf"
  ? PDFExportOptions
  : T extends "excel"
    ? ExcelExportOptions
    : T extends "csv"
