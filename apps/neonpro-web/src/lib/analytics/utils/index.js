...
exports.formatDate = exports.exportToExcel = exports.exportToPDF = exports.exportToCSV = exports.parseAnalyticsFilters = exports.validateDateRange = exports.generateDateRange = exports.aggregateMetricsByPeriod = exports.calculateARR = exports.calculateMRR = exports.calculateLTV = exports.calculateChurnRate = exports.calculateGrowthRate = exports.formatPercentage = exports.formatCurrency = void 0;
...
var calculateMRR = function (subscriptions) {
    ...
    return subscriptions
        .filter(function (sub) { return sub && sub.status === 'active' && typeof sub.amount === 'number' && !isNaN(sub.amount); })
        .reduce(function (total, sub) { return total + (sub.amount / 100); }, 0);
};
...
var aggregateMetricsByPeriod = function (data, // Accept any array since test uses strings for dates
period, aggregateFunction) {
    ...
    var result = Object.keys(grouped).map(function (key) { return ({
        period: key,
    ...
    result.sort(function (a, b) {
        ...
        if (formatString === 'MMM yyyy') {
            var parseMonthYear = function (str) {
                var monthNames = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
                var _a = str.split(' '), month = _a[0], year = _a[1];
...
var parseAnalyticsFilters = function (params) {
    ...
    var validPeriods = ['last_7_days', 'last_30_days', 'last_month', 'monthly', 'quarterly', 'last_quarter', 'last_year', 'custom'];
...
var exportToExcel = function (data, filename, options) {
    ...
    if (typeof data === 'object' && !Array.isArray(data) && data !== null) {
        ...
        var hasMultipleArrays = keys.length > 1 && keys.every(function (key) { return Array.isArray(data[key]); });
        if (hasMultipleArrays) {
            // Data is a multi-sheet object
            Object.entries(data).forEach(function (_a) {
                var sheetName = _a[0], sheetData = _a[1];
...
var formatDate = function (date, formatString) {
    if (formatString === void 0) { formatString = 'MMM dd, yyyy'; }
