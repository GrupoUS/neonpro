...
exports.predictiveAnalyticsEngine = exports.PredictiveAnalyticsEngine = exports.ForecastRequestSchema = exports.PredictionRequestSchema = exports.createpredictiveAnalyticsEngine = void 0;
...
var createpredictiveAnalyticsEngine = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        _a = {
                            id: "prediction_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                    ...
                    case 4:
                        _a.risk = _b.sent();
                        return [4 /*yield*/, this.generateExplanations(model, rawPrediction, processedFeatures)];
                    case 5:
                        _a.explanations = _b.sent();
                        return [4 /*yield*/, this.generateRecommendations(model, rawPrediction, request.features)];
                    case 6:
                        result = (_a.recommendations = _b.sent(),
                            _a.metadata = {
    ...
    createpredictiveAnalyticsEngine.prototype.forecast = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var model, timeSeriesData, forecastPoints, trendAnalysis, seasonalityAnalysis, result, error_3;
            var _a;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        ...
                        _a = {
                            id: "forecast_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                            timestamp: new Date().toISOString(),
                            request: request,
                    ...
                    case 6:
                        result = (_a.accuracy = _d.sent(),
                            _a.metadata = {
                                modelUsed: model.id,
                                dataPoints: timeSeriesData.length,
                                trainingPeriod: {
                                    start: ((_b = timeSeriesData[0]) === null || _b === void 0 ? void 0 : _b.timestamp) || '',
                                    end: ((_c = timeSeriesData[timeSeriesData.length - 1]) === null || _c === void 0 ? void 0 : _c.timestamp) || ''
                                },
                                processingTime: Date.now() - new Date().getTime(),
    ...
    createpredictiveAnalyticsEngine.prototype.trainModel = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var trainingData, _a, train, validation, test, model, performance_1, artifacts, result, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 9, , 10]);
                    ...
                    case 6:
                        artifacts = _b.sent();
                        result = {
                            id: "training_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                            timestamp: new Date().toISOString(),
                            request: request,
                            model: model,
     ...
     */
    createpredictiveAnalyticsEngine.prototype.getPredictionInsights = function (clinicId, type, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.analyzeRecommendationImpact(clinicId, type, startDate, endDate)];
                    case 6:
                    ...
                    case 9:
                        insights = (_a.businessImpact = _b.sent(),
                            _a);
     ...
     */
    createpredictiveAnalyticsEngine.prototype.updateModelWithFeedback = function (predictionId, feedback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    createpredictiveAnalyticsEngine.prototype.startBackgroundTasks = function () {
        ...
        setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.monitorModelPerformance()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.detectModelDriftForAllModels()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    createpredictiveAnalyticsEngine.prototype.generateCacheKey = function (request) {
        ...
        return "".concat(request.modelId, "_").concat(features, "_").concat(request.patientId || 'anonymous');
    };
            ...
            return __generator(this, function (_d) {
                for (_i = 0, _a = model.features; _i < _a.length; _i++) {
                    ...
                    if (value === undefined || value === null) {
                        if (feature.validationRules.some(function (rule) { return rule.type === 'required'; })) {
    ...
    createpredictiveAnalyticsEngine.prototype.simulateRandomForestPrediction = function (model, features) {
    ...
    createpredictiveAnalyticsEngine.prototype.simulateNeuralNetworkPrediction = function (model, features) {
    ...
    createpredictiveAnalyticsEngine.prototype.simulateLinearRegressionPrediction = function (model, features) {
    ...
    createpredictiveAnalyticsEngine.prototype.generateExplanations = function (model, rawPrediction, features) {
        return __awaiter(this, void 0, void 0, function () {
            var explanations;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                Object.entries(rawPrediction.contributions || {}).forEach(function (_a) {
                    var feature = _a[0], contribution = _a[1];
                    explanations.push({
                        feature: feature,
    ...
    createpredictiveAnalyticsEngine.prototype.interpretContribution = function (feature, contribution) {
        if (contribution > 0.1)
            return "".concat(feature, " strongly supports the prediction");
        if (contribution > 0.05)
            return "".concat(feature, " moderately supports the prediction");
        if (contribution < -0.1)
            return "".concat(feature, " strongly opposes the prediction");
        if (contribution < -0.05)
            return "".concat(feature, " moderately opposes the prediction");
        return "".concat(feature, " has minimal impact on the prediction");
    };
    createpredictiveAnalyticsEngine.prototype.generateRecommendations = function (model, rawPrediction, features) {
        return __awaiter(this, void 0, void 0, function () {
            var recommendations;
            return __generator(this, function (_a) {
                recommendations = [];
    ...
    createpredictiveAnalyticsEngine.prototype.findForecastingModel = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Array.from(this.models.values()).find(function (m) { return m.type === type; }) || null];
            });
        });
    };
    ...
    createpredictiveAnalyticsEngine.prototype.cleanupCache = function () {
        ...
        for (var _i = 0, _a = this.predictionCache.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], key = _b[0], prediction = _b[1];
