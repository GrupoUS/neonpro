...
exports.visionAnalyticsEngine = exports.VisionAnalyticsEngine = exports.VisionMetricSchema = exports.createvisionAnalyticsEngine = void 0;
...
var createvisionAnalyticsEngine = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        visionMetric = __assign({ id: "metric_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)), timestamp: new Date().toISOString() }, metric);
    ...
    createvisionAnalyticsEngine.prototype.getDashboardData = function (dashboardId_1) {
        return __awaiter(this, arguments, void 0, function (dashboardId, filters, timeRange) {
            ...
            if (timeRange === void 0) { timeRange = 'daily'; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        dashboardData = (_a.summary = _b.sent(),
    ...
    createvisionAnalyticsEngine.prototype.generateInsights = function () {
        return __awaiter(this, arguments, void 0, function (timeframe, categories) {
            var insights, trends, anomalies, correlations, performance_1, _i, insights_1, insight, error_4;
            if (timeframe === void 0) { timeframe = 'daily'; }
            if (categories === void 0) { categories = ['performance', 'outcome', 'efficiency']; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 9, , 10]);
    ...
    createvisionAnalyticsEngine.prototype.getPatientOutcomes = function (patientId_1) {
        return __awaiter(this, arguments, void 0, function (patientId, timeRange) {
            ...
            if (timeRange === void 0) { timeRange = 'monthly'; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
    ...
    createvisionAnalyticsEngine.prototype.analyzeTreatmentEffectiveness = function (treatmentType_1) {
        return __awaiter(this, arguments, void 0, function (treatmentType, timeRange) {
            ...
            var _a;
            if (timeRange === void 0) { timeRange = 'quarterly'; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        filteredOutcomes = treatmentType
                            ? outcomes.filter(function (o) { return o.treatmentType === treatmentType; })
                            : outcomes;
                        _a = {
     ...
     */
    createvisionAnalyticsEngine.prototype.generatePredictiveInsights = function (patientId, treatmentType) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    createvisionAnalyticsEngine.prototype.aggregateMetrics = function (metrics) {
        ...
        Object.entries(grouped).forEach(function (_a) {
            var key = _a[0], metricGroup = _a[1];
            aggregated[key] = {
                count: metricGroup.length,
                avg: metricGroup.reduce(function (sum, m) { return sum + m.value; }, 0) / metricGroup.length,
                min: Math.min.apply(Math, metricGroup.map(function (m) { return m.value; })),
                max: Math.max.apply(Math, metricGroup.map(function (m) { return m.value; })),
                sum: metricGroup.reduce(function (sum, m) { return sum + m.value; }, 0),
    ...
    createvisionAnalyticsEngine.prototype.calculateSuccessRate = function (outcomes) {
        if (outcomes.length === 0)
            return 0;
        var successful = outcomes.filter(function (o) { return o.treatmentSuccess; }).length;
        return (successful / outcomes.length) * 100;
    };
    createvisionAnalyticsEngine.prototype.calculateAverageImprovement = function (outcomes) {
        var improvementRates = outcomes.map(function (o) { return o.improvementRate; });
        return improvementRates.reduce(function (sum, rate) { return sum + rate; }, 0) / improvementRates.length;
    };
    createvisionAnalyticsEngine.prototype.calculateAverageSatisfaction = function (outcomes) {
        var scores = outcomes.map(function (o) { return o.satisfactionScore; });
    ...
    createvisionAnalyticsEngine.prototype.calculateComplicationRate = function (outcomes) {
        if (outcomes.length === 0)
            return 0;
        var complications = outcomes.filter(function (o) { return o.complicationDetected; }).length;
    ...
    createvisionAnalyticsEngine.prototype.generateClinicRecommendations = function (metrics, outcomes) {
...
exports.VisionMetricSchema = zod_1.z.object({
    metricType: zod_1.z.enum(['accuracy', 'performance', 'outcome', 'efficiency', 'compliance', 'financial']),
    component: zod_1.z.enum(['face_detection', 'aesthetic_analysis', 'complication_detection', 'compliance_monitoring']),
