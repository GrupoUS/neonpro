...
var AnalyticsService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, cache_1.unstable_cache)(function () { return __awaiter(_this, void 0, void 0, function () {
                                var _a, mrrAgg, arrAgg, churnAgg, ltvAgg, forecast, tierAnalytics;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, Promise.all([
                                                this.repository.getRevenueAggregation(__assign(__assign({}, query), { aggregation: 'sum' })),
                                                this.repository.getRevenueAggregation(__assign(__assign({}, query), { aggregation: 'sum' })),
                                                this.repository.getConversionAggregation(__assign(__assign({}, query), { metrics: ['retention'] })),
                                                this.repository.getRevenueAggregation(__assign(__assign({}, query), { aggregation: 'avg' }))
                                            ])];
                                        case 1:
                                            _a = _b.sent(), mrrAgg = _a[0], arrAgg = _a[1], churnAgg = _a[2], ltvAgg = _a[3];
                            ...
                            }); }, [cacheKey], { revalidate: this.defaultCacheTTL, tags: ['analytics', 'revenue'] })()];
                    case 1:
    ...
    AnalyticsService.prototype.getConversionAnalytics = function (period, startDate, endDate, filters) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, query, cacheKey, cachedAnalytics;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, cache_1.unstable_cache)(function () { return __awaiter(_this, void 0, void 0, function () {
                                var _a, trialToPaid, signupToTrial, visitorToSignup, funnelAnalysis, cohortAnalysis;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, Promise.all([
                                                this.repository.getConversionAggregation(__assign(__assign({}, query), { filters: __assign(__assign({}, filters), { stage: 'trial_to_paid' }) })),
                                                this.repository.getConversionAggregation(__assign(__assign({}, query), { filters: __assign(__assign({}, filters), { stage: 'signup_to_trial' }) })),
                                                this.repository.getConversionAggregation(__assign(__assign({}, query), { filters: __assign(__assign({}, filters), { stage: 'visitor_to_signup' }) }))
                                            ])];
                                        case 1:
                                            _a = _b.sent(), trialToPaid = _a[0], signupToTrial = _a[1], visitorToSignup = _a[2];
                            ...
                            }); }, [cacheKey], { revalidate: this.defaultCacheTTL, tags: ['analytics', 'conversion'] })()];
                    case 1:
                        cachedAnalytics = _a.sent();
                        return [2 /*return*/, this.createResponse(cachedAnalytics, query, startTime, true)];
                }
    ...
    AnalyticsService.prototype.getRealTimeMetrics = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.getRealTimeMetrics()];
                    case 1: 
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, cache_1.unstable_cache)(function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.repository.getTrialMetrics({
                                                metrics: ['engagement'],
                                                period: 'day',
                            ...
                            }); }, [cacheKey], { revalidate: 3600, tags: ['predictions', 'trials'] } // 1 hour cache
                            )()];
    ...
    AnalyticsService.prototype.generateRevenueForecast = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.getRevenueMetrics(query)];
                    case 1:
                        historicalRevenue = _a.sent();
                        values = historicalRevenue.map(function (m) { return m.value; });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(tiers.map(function (tier) {
                                return _this.repository.getRevenueAggregation(__assign(__assign({}, query), { filters: __assign(__assign({}, query.filters), { tier: tier }) }));
                            }))];
                    case 1:
                        tierData = _a.sent();
                        return [2 /*return*/, {
    ...
    AnalyticsService.prototype.calculateEngagementScore = function (metrics) {
        if (!metrics.length)
            return 0.1;
        var totalActions = metrics.reduce(function (sum, m) { return sum + (m.actionsCount || 0); }, 0);
        var avgDaysActive = metrics.reduce(function (sum, m) { return sum + (m.daysActive || 0); }, 0) / metrics.length;
    ...
    AnalyticsService.prototype.identifyRiskFactors = function (metrics) {
        var factors = [];
        var avgActions = metrics.reduce(function (sum, m) { return sum + (m.actionsCount || 0); }, 0) / metrics.length;
        var avgDaysActive = metrics.reduce(function (sum, m) { return sum + (m.daysActive || 0); }, 0) / metrics.length;
        if (avgActions < 10)
    ...
    AnalyticsService.prototype.calculateTrend = function (values) {
        ...
        var sumXY = values.reduce(function (sum, val, i) { return sum + i * val; }, 0);
    ...
    AnalyticsService.prototype.projectForecast = function (values, trend, periods) {
        ...
        return {
            realistic: realistic,
            conservative: realistic.map(function (v) { return v * 0.8; }),
            optimistic: realistic.map(function (v) { return v * 1.2; }),
            scenarios: {
                conservative: realistic.map(function (v) { return v * 0.8; }),
                optimistic: realistic.map(function (v) { return v * 1.2; }),
                realistic: realistic
            },
            confidence: realistic.map(function () { return Math.random() * 0.3 + 0.7; }) // 70-100% confidence
        };
    };
    AnalyticsService.prototype.generateCacheKey = function (type, query) {
        ...
        return "".concat(this.cachePrefix, ":").concat(type, ":").concat(Buffer.from(queryHash).toString('base64').slice(0, 16));
    };
