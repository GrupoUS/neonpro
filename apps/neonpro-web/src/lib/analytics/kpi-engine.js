...
var KPIEngine = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.getAllKPIs()];
                    case 4:
                        _a = _b.sent();
                        _b.label = 5;
                    case 5:
    ...
    KPIEngine.prototype.calculateSingleKPI = function (kpi, request) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, start_date, end_date, calculatedValue, dataPointsUsed, breakdown, _b, previousValue, _c, variancePercent, trendDirection, error_2;
            var _d, _e, _f, _g;
                ...
                switch (_h.label) {
                    ...
                    case 1:
                        ...
                        switch (_b) {
                            ...
                            case 'operational': return [3 /*break*/, 6];
                            case 'financial_health': return [3 /*break*/, 8];
                        }
                        return [3 /*break*/, 10];
                    case 2: return [4 /*yield*/, this.calculateRevenueKPI(kpi, start_date, end_date, request.filters)];
                    case 3:
                        (_d = _h.sent(), calculatedValue = _d.value, dataPointsUsed = _d.dataPoints, breakdown = _d.breakdown);
                        return [3 /*break*/, 10];
                    case 4: return [4 /*yield*/, this.calculateProfitabilityKPI(kpi, start_date, end_date, request.filters)];
                    case 5:
                        (_e = _h.sent(), calculatedValue = _e.value, dataPointsUsed = _e.dataPoints, breakdown = _e.breakdown);
                        return [3 /*break*/, 10];
                    case 6: return [4 /*yield*/, this.calculateOperationalKPI(kpi, start_date, end_date, request.filters)];
                    case 7:
                        (_f = _h.sent(), calculatedValue = _f.value, dataPointsUsed = _f.dataPoints, breakdown = _f.breakdown);
                        return [3 /*break*/, 10];
                    case 8: return [4 /*yield*/, this.calculateFinancialHealthKPI(kpi, start_date, end_date, request.filters)];
                    case 9:
                        (_g = _h.sent(), calculatedValue = _g.value, dataPointsUsed = _g.dataPoints, breakdown = _g.breakdown);
                        return [3 /*break*/, 10];
                    case 10:
    ...
    KPIEngine.prototype.calculateRevenueKPI = function (kpi, startDate, endDate, filters) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, cached, query, _a, invoices, error, value, breakdown, serviceBreakdown, patients, totalRevenue, result;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if ((_b = filters === null || filters === void 0 ? void 0 : filters.service_types) === null || _b === void 0 ? void 0 : _b.length) {
                    ...
                    case 1:
                        ...
                        value = invoices.reduce(function (sum, inv) { return sum + inv.amount; }, 0);
                    ...
                    case 3:
                        ...
                        totalRevenue = invoices.reduce(function (sum, inv) { return sum + inv.amount; }, 0);
                        value = (patients === null || patients === void 0 ? void 0 : patients.length) ? totalRevenue / patients.length : 0;
                        _c.label = 4;
                    case 4:
    ...
    KPIEngine.prototype.calculateProfitabilityKPI = function (kpi, startDate, endDate, filters) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, cached, invoices, expenses, totalRevenue, totalDirectCosts, totalExpenses, value, breakdown, netProfit, expenseBreakdown, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cacheKey = "profitability_".concat(kpi.kpi_name, "_").concat(startDate, "_").concat(endDate);
                        cached = this.getFromCache(cacheKey);
                        if (cached)
                            return [2 /*return*/, cached];
                        return [4 /*yield*/, this.supabase
                    ...
                    case 2:
                        ...
                        totalRevenue = (invoices === null || invoices === void 0 ? void 0 : invoices.reduce(function (sum, inv) { return sum + inv.amount; }, 0)) || 0;
                        totalDirectCosts = (invoices === null || invoices === void 0 ? void 0 : invoices.reduce(function (sum, inv) { return sum + (inv.direct_costs || 0); }, 0)) || 0;
                        totalExpenses = (expenses === null || expenses === void 0 ? void 0 : expenses.reduce(function (sum, exp) { return sum + exp.amount; }, 0)) || 0;
                        value = 0;
                        breakdown = [];
                        ...
                        expenseBreakdown = (expenses === null || expenses === void 0 ? void 0 : expenses.reduce(function (acc, exp) {
                        ...
                        result = {
                            value: value,
                            dataPoints: ((invoices === null || invoices === void 0 ? void 0 : invoices.length) || 0) + ((expenses === null || expenses === void 0 ? void 0 : expenses.length) || 0),
                            breakdown: breakdown
                        };
                        this.setCache(cacheKey, result);
                        return [2 /*return*/, result];
    ...
    KPIEngine.prototype.calculateOperationalKPI = function (kpi, startDate, endDate, filters) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, cached, value, dataPoints, breakdown, patients, appointments, returningPatients, totalPatients, appointments, totalSlots, bookedSlots, expenses, newPatients, marketingCosts, newPatientCount, result;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        cacheKey = "operational_".concat(kpi.kpi_name, "_").concat(startDate, "_").concat(endDate);
                        cached = this.getFromCache(cacheKey);
                        if (cached)
                            return [2 /*return*/, cached];
                        value = 0;
                    ...
                    case 2:
                        ...
                        returningPatients = new Set((appointments === null || appointments === void 0 ? void 0 : appointments.map(function (a) { return a.patient_id; })) || []);
                    ...
                    case 4:
                        appointments = (_b.sent()).data;
                        totalSlots = (appointments === null || appointments === void 0 ? void 0 : appointments.length) || 0;
                        bookedSlots = ((_a = appointments === null || appointments === void 0 ? void 0 : appointments.filter(function (a) { return a.status !== 'cancelled'; })) === null || _a === void 0 ? void 0 : _a.length) || 0;
                    ...
                    case 7:
                        ...
                        marketingCosts = (expenses === null || expenses === void 0 ? void 0 : expenses.reduce(function (sum, exp) { return sum + exp.amount; }, 0)) || 0;
                        newPatientCount = (newPatients === null || newPatients === void 0 ? void 0 : newPatients.length) || 0;
    ...
    KPIEngine.prototype.calculateFinancialHealthKPI = function (kpi, startDate, endDate, filters) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, cached, value, dataPoints, breakdown, revenue, expenses, operatingCashFlow, monthlyExpenses, currentLiabilities, invoices, totalRevenue, pendingReceivables, result;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        cacheKey = "financial_health_".concat(kpi.kpi_name, "_").concat(startDate, "_").concat(endDate);
                        cached = this.getFromCache(cacheKey);
                        if (cached)
                            return [2 /*return*/, cached];
                        value = 0;
                    ...
                    case 2:
                        expenses = (_b.sent()).data;
                        operatingCashFlow = ((revenue === null || revenue === void 0 ? void 0 : revenue.reduce(function (sum, r) { return sum + r.amount; }, 0)) || 0) -
                            ((expenses === null || expenses === void 0 ? void 0 : expenses.reduce(function (sum, e) { return sum + e.amount; }, 0)) || 0);
                        monthlyExpenses = (expenses === null || expenses === void 0 ? void 0 : expenses.reduce(function (sum, e) { return sum + e.amount; }, 0)) || 0;
                        currentLiabilities = monthlyExpenses * 0.3;
                        value = currentLiabilities ? operatingCashFlow / currentLiabilities : 0;
                        dataPoints = ((revenue === null || revenue === void 0 ? void 0 : revenue.length) || 0) + ((expenses === null || expenses === void 0 ? void 0 : expenses.length) || 0);
                        return [3 /*break*/, 5];
                    case 3:
                    ...
                    case 4:
                        ...
                        totalRevenue = (invoices === null || invoices === void 0 ? void 0 : invoices.reduce(function (sum, inv) { return sum + inv.amount; }, 0)) || 0;
                        pendingReceivables = ((_a = invoices === null || invoices === void 0 ? void 0 : invoices.filter(function (inv) { return inv.status === 'pending'; })) === null || _a === void 0 ? void 0 : _a.reduce(function (sum, inv) { return sum + inv.amount; }, 0)) || 0;
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        switch (_a) {
                            ...
                            case 'service_type': return [3 /*break*/, 5];
                            case 'provider': return [3 /*break*/, 7];
                            case 'patient_segment': return [3 /*break*/, 9];
                        }
                        return [3 /*break*/, 11];
                    case 3: return [4 /*yield*/, this.drillDownByTime(kpi, request)];
                    case 4:
                        results = _b.sent();
                        return [3 /*break*/, 12];
                    case 5: return [4 /*yield*/, this.drillDownByServiceType(kpi, request)];
                    case 6:
                        results = _b.sent();
                        return [3 /*break*/, 12];
                    case 7: return [4 /*yield*/, this.drillDownByProvider(kpi, request)];
                    case 8:
                        results = _b.sent();
                        return [3 /*break*/, 12];
                    case 9: return [4 /*yield*/, this.drillDownByPatientSegment(kpi, request)];
                    case 10:
                        results = _b.sent();
                        return [3 /*break*/, 12];
                    case 11: throw new Error("Unsupported drill-down dimension: ".concat(request.dimension));
                    case 12:
    ...
    KPIEngine.prototype.updateKPIValues = function (results) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        updates = results.map(function (result) { return ({
                            id: result.kpi_id,
    ...
    KPIEngine.prototype.recordKPIHistory = function (results) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        historyRecords = results.map(function (result) { return ({
    ...
    KPIEngine.prototype.checkThresholdBreach = function (value, threshold) {
        var threshold_value = threshold.threshold_value, comparison_operator = threshold.comparison_operator;
                ...
                switch (_a.label) {
                    case 0:
                        alert = {
                            ...
                            alert_message: "KPI ".concat(result.kpi_name, " ").concat(threshold.threshold_type, " threshold breached"),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        data = (_b.sent()).data;
                        return [2 /*return*/, (_a = data === null || data === void 0 ? void 0 : data[0]) === null || _a === void 0 ? void 0 : _a.value];
                }
            });
        });
    };
