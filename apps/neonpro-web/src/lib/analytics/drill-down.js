...
var DrillDownSystem = /** @class */ (function () {
    ...
    DrillDownSystem.prototype.executeDrillDown = function (kpiId_1, dimension_1) {
        return __awaiter(this, arguments, void 0, function (kpiId, dimension, filters, options) {
            var startTime, kpi, strategy, results, context, path, _i, results_1, result, _a, executionTime, error_1;
    ...
    DrillDownSystem.prototype.drillDownByTime = function (kpi_1, aggregationLevel_1) {
        return __awaiter(this, arguments, void 0, function (kpi, aggregationLevel, filters) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        cacheKey = "time_drill_".concat(kpi.id, "_").concat(aggregationLevel, "_").concat(JSON.stringify(filters));
                        ...
                        query = "\n        SELECT \n          TO_CHAR(".concat(groupBy, ", '").concat(dateFormat, "') as period,\n          SUM(amount) as value,\n          COUNT(*) as transaction_count\n        FROM invoices \n        WHERE status = 'paid'\n        ").concat(filters.start_date ? "AND created_at >= '".concat(filters.start_date, "'") : '', "\n        ").concat(filters.end_date ? "AND created_at <= '".concat(filters.end_date, "'") : '', "\n        ").concat(filters.service_types ? "AND service_type = ANY(ARRAY[".concat(filters.service_types.map(function (s) { return "'".concat(s, "'"); }).join(','), "])") : '', "\n        GROUP BY ").concat(groupBy, "\n        ORDER BY ").concat(groupBy, " DESC\n      ");
                        return [4 /*yield*/, this.supabase.rpc('execute_sql', { query: query })];
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw error;
                        totalValue_1 = data.reduce(function (sum, row) { return sum + parseFloat(row.value); }, 0);
                        results.push.apply(results, data.map(function (row) { return ({
                            dimension_value: row.period,
                            value: parseFloat(row.value),
                            percentage_of_total: totalValue_1 ? (parseFloat(row.value) / totalValue_1) * 100 : 0,
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        if (cached)
                            return [2 /*return*/, cached];
                        results = [];
                        if (!(kpi.kpi_category === 'revenue' || kpi.kpi_category === 'profitability')) return [3 /*break*/, 2];
                        query = this.supabase
                            .from('invoices')
                    ...
                    case 1:
                        ...
                        totalRevenue_1 = Object.values(serviceGroups).reduce(function (sum, group) { return sum + group.revenue; }, 0);
                        results.push.apply(results, Object.entries(serviceGroups).map(function (_a) {
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        providerGroups = data.reduce(function (acc, appointment) {
                            ...
                            var providerName = ((_a = appointment.providers) === null || _a === void 0 ? void 0 : _a.name) || 'Unknown Provider';
                            if (!acc[providerId]) {
                                acc[providerId] = {
                                    name: providerName,
                                    revenue: 0,
                        ...
                        totalRevenue = Object.values(providerGroups).reduce(function (sum, group) { return sum + group.revenue; }, 0);
                        results.push.apply(results, Object.entries(providerGroups).map(function (_a) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        ageSegments = data.reduce(function (acc, patient) {
                            ...
                            acc[ageGroup].revenue += ((_a = patient.invoices) === null || _a === void 0 ? void 0 : _a.reduce(function (sum, inv) { return sum + (inv.amount || 0); }, 0)) || 0;
                            acc[ageGroup].appointments += ((_b = patient.appointments) === null || _b === void 0 ? void 0 : _b.length) || 0;
                            return acc;
                        }, {});
                        totalPatients = Object.values(ageSegments).reduce(function (sum, segment) { return sum + segment.count; }, 0);
                        results.push.apply(results, Object.entries(ageSegments).map(function (_a) {
    ...
    DrillDownSystem.prototype.performDrillDown = function (kpi, dimension, filters, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (dimension) {
                    case 'time':
                        return [2 /*return*/, this.drillDownByTime(kpi, options.aggregationLevel || 'month', filters)];
                    case 'service_type':
    ...
    DrillDownSystem.prototype.getSubDimensions = function (kpi, parentDimension, parentResult, filters) {
        return __awaiter(this, void 0, void 0, function () {
            var subFilters, nextDimension;
            var _a;
            return __generator(this, function (_b) {
                subFilters = __assign(__assign({}, filters), (_a = {}, _a[parentDimension] = parentResult.dimension_value, _a));
