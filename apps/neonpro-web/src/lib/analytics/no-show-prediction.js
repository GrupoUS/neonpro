...
exports.noShowPredictionEngine = exports.NoShowPredictionEngine = exports.RiskFactorCategory = void 0;
...
var NoShowPredictionEngine = /** @class */ (function () {
    ...
    NoShowPredictionEngine.prototype.predictNoShow = function (appointmentId, appointmentData) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, patientHistory, appointmentFeatures, externalFactors, communicationPatterns, riskFactors, prediction, interventions, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), patientHistory = _a[0], appointmentFeatures = _a[1], externalFactors = _a[2], communicationPatterns = _a[3];
                        return [4 /*yield*/, this.calculateRiskFactors({
                    ...
                    case 3:
                        prediction = _b.sent();
                        return [4 /*yield*/, this.generateInterventionRecommendations(prediction.riskScore, riskFactors, appointmentData)];
                    case 4:
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        batchPromises = batch.map(function (apt) { return _this.predictNoShow(apt.id, apt); });
                                    ...
                                    case 1:
                                        ...
                                        batchResults.forEach(function (result, index) {
                                            if (result.status === 'fulfilled') {
                                                ...
                                                console.error("Failed to predict for appointment ".concat(batch[index].id, ":"), result.reason);
                                            }
                                        });
                                        return [2 /*return*/];
                                }
    ...
    NoShowPredictionEngine.prototype.getPatientHistory = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var appointments, noShows, totalAppointments, noShowCount, bookingDelays, avgDaysBetweenBookingAndAppointment, timeSlots, timeSlotCounts, preferredTimeSlots, seasonalPatterns, improvementTrend;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        noShows = appointments.filter(function (apt) { return apt.status === 'NO_SHOW'; });
                        ...
                        avgDaysBetweenBookingAndAppointment = bookingDelays.length > 0 ?
                            bookingDelays.reduce(function (sum, days) { return sum + days; }, 0) / bookingDelays.length : 0;
                        timeSlots = appointments.map(function (apt) {
                            var date = new Date(apt.scheduled_date);
                            return "".concat(date.getHours(), ":").concat(date.getMinutes().toString().padStart(2, '0'));
                        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    return [2 /*return*/, (_a.isSchoolHoliday = _b.sent(),
                            ...
                            _a.trafficPattern = 'normal' // Placeholder for traffic API integration
                        ,
                            _a)];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                factors.push({
                    ...
                    description: "Patient has ".concat((data.patientHistory.noShowRate * 100).toFixed(1), "% no-show rate")
                });
                factors.push({
                    category: RiskFactorCategory.PATIENT_HISTORY,
                    ...
                    description: "Average booking ".concat(data.patientHistory.avgDaysBetweenBookingAndAppointment.toFixed(1), " days in advance")
                });
                ...
                factors.push({
                    ...
                    description: "Patient response rate: ".concat((data.communicationPatterns.responseRate * 100).toFixed(1), "%")
                });
    ...
    NoShowPredictionEngine.prototype.ensemblePrediction = function (riskFactors) {
        return __awaiter(this, void 0, void 0, function () {
            var totalContribution, baseRiskScore, logisticScore, treeScore, neuralScore, ensembleScore, scores, meanScore, variance, confidence;
            return __generator(this, function (_a) {
                totalContribution = riskFactors.reduce(function (sum, factor) { return sum + factor.contribution; }, 0);
                ...
                ensembleScore = (baseRiskScore * 0.4 +
                    logisticScore * 0.3 +
                    treeScore * 0.2 +
                    neuralScore * 0.1);
                scores = [baseRiskScore, logisticScore, treeScore, neuralScore];
                meanScore = scores.reduce(function (sum, score) { return sum + score; }, 0) / scores.length;
                variance = scores.reduce(function (sum, score) { return sum + Math.pow(score - meanScore, 2); }, 0) / scores.length;
     ...
     */
    NoShowPredictionEngine.prototype.generateInterventionRecommendations = function (riskScore, riskFactors, appointmentData) {
        return __awaiter(this, void 0, void 0, function () {
            var recommendations;
            return __generator(this, function (_a) {
                recommendations = [];
    ...
    NoShowPredictionEngine.prototype.logisticRegressionScore = function (factors) {
        return factors.reduce(function (sum, factor) { return sum + factor.contribution; }, 0) * 0.95;
    };
    NoShowPredictionEngine.prototype.decisionTreeScore = function (factors) {
        return factors.reduce(function (sum, factor) { return sum + factor.contribution; }, 0) * 1.05;
    };
    NoShowPredictionEngine.prototype.neuralNetworkScore = function (factors) {
        return factors.reduce(function (sum, factor) { return sum + factor.contribution; }, 0) * 0.98;
    };
    // Helper methods
