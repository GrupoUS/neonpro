...
var StressTester = /** @class */ (function () {
    ...
    StressTester.prototype.executeStressTest = function (scenario, testFn) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, baselineMetrics, loadResult, recoveryStartTime, recoveryTime, endTime, postTestMetrics, report;
            var _this = this;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        report = {
                            ...
                            performanceDegradation: this.calculatePerformanceDegradation(baselineMetrics, postTestMetrics)
                        };
    ...
    StressTester.prototype.executeChaosAction = function (action) {
        console.log("\uD83D\uDCA5 Executing chaos action: ".concat(action.type, " (intensity: ").concat(action.intensity, ")"));
        switch (action.type) {
            case 'network_delay':
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_1 = _a.sent();
                        return [3 /*break*/, 5];
                    case 5: return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, checkInterval); })];
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 1];
                    case 7:
    ...
    StressTester.prototype.cleanupChaosActions = function (testId) {
        for (var _i = 0, _a = this.activeTests.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], key = _b[0], timeoutId = _b[1];
    ...
    StressTester.prototype.calculateStabilityScore = function (loadResult) {
        if (!loadResult.totalRequests)
            return 0;
        var successRate = (loadResult.totalRequests - loadResult.failedRequests) / loadResult.totalRequests;
    ...
    StressTester.prototype.generateComprehensiveReport = function () {
        ...
        var averageStability = this.reports.reduce(function (sum, report) { return sum + report.systemStability; }, 0) / totalTests;
        var averageRecoveryTime = this.reports.reduce(function (sum, report) { return sum + report.recoveryTime; }, 0) / totalTests;
        var totalFailures = this.reports.reduce(function (sum, report) { return sum + report.criticalFailures; }, 0);
        return {
