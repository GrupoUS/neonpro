...
var AllocationEngine = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.resourceManager.getAvailableResources(clinicId, criteria.startTime, criteria.endTime, criteria.resourceType, criteria.requirements)];
                    case 1:
                    ...
                    case 2:
                        suggestions = _a.sent();
                        return [4 /*yield*/, this.analyzeSystemConflicts(clinicId, criteria.startTime, criteria.endTime)];
                    case 3:
                        conflicts = _a.sent();
    ...
    AllocationEngine.prototype.scoreResources = function (resources, criteria) {
        return __awaiter(this, void 0, void 0, function () {
            var suggestions, _i, resources_1, resource, score, confidence, reasoning, estimatedCost, utilizationImpact;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        suggestions = [];
                    ...
                    return [2 /*return*/, suggestions.sort(function (a, b) { return b.score - a.score; })];
                }
            });
        });
    };
    AllocationEngine.prototype.calculateResourceScore = function (resource, criteria) {
        return __awaiter(this, void 0, void 0, function () {
            var score, req, resourceSkills_1, matchedSkills, skillScore, resourceEquipment_1, matchedEquipment, equipmentScore, pref, costFactor, currentUtilization, workload, maintenanceDate, appointmentDate, daysUntilMaintenance;
            var _a, _b;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        if (criteria.requirements) {
                            ...
                            if (req.skills && resource.type === 'staff') {
                                ...
                                matchedSkills = req.skills.filter(function (skill) { return resourceSkills_1.includes(skill); });
                            ...
                            if (req.equipment && resource.type === 'room') {
                                ...
                                matchedEquipment = req.equipment.filter(function (eq) { return resourceEquipment_1.includes(eq); });
                        ...
                        if (criteria.preferences) {
                            ...
                            if ((_a = pref.preferredResources) === null || _a === void 0 ? void 0 : _a.includes(resource.id)) {
                                score += 25;
                            }
                            // Avoided resources penalty
                            if ((_b = pref.avoidResources) === null || _b === void 0 ? void 0 : _b.includes(resource.id)) {
                                score -= 40;
                            }
                            // Cost optimization
                    ...
                    case 3:
                        ...
                        if (resource.type === 'equipment' && resource.next_maintenance) {
                            ...
                            daysUntilMaintenance = Math.ceil((maintenanceDate.getTime() - appointmentDate.getTime()) / (1000 * 60 * 60 * 24));
    ...
    AllocationEngine.prototype.generateReasoning = function (resource, criteria, score) {
        ...
        if (resource.type === 'staff' && ((_a = resource.skills) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    AllocationEngine.prototype.validateBusinessRules = function (allocation, criteria) {
        return __awaiter(this, void 0, void 0, function () {
            var violations, resource, rules, workload, workload, lastBreak, appointmentStart, minutesSinceBreak, workload, appointmentHours, appointmentDate, isHoliday, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        violations = [];
                    ...
                    case 3:
                        ...
                        if (workload.consecutive_hours >= rules.maxConsecutiveHours) {
                            violations.push("Exceeds maximum consecutive hours (".concat(rules.maxConsecutiveHours, ")"));
                        }
                        _a.label = 4;
                    case 4:
                    ...
                    case 5:
                        ...
                        if (workload.last_break) {
                            ...
                            if (minutesSinceBreak < rules.minimumBreak) {
                                violations.push("Insufficient break time (minimum ".concat(rules.minimumBreak, " minutes)"));
                            }
                        }
                        _a.label = 6;
                    case 6:
                    ...
                    case 7:
                        workload = _a.sent();
                        appointmentHours = (new Date(allocation.end_time).getTime() - new Date(allocation.start_time).getTime()) / (1000 * 60 * 60);
                    ...
                    case 9:
                        ...
                        _a.label = 10;
                    case 10: return [2 /*return*/, { valid: violations.length === 0, violations: violations }];
                    case 11:
                        error_3 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.resourceManager.detectConflicts(resource.id, startTime, endTime)];
                    case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.resourceManager.getAllocations(resourceId, "".concat(today, "T00:00:00Z"), "".concat(today, "T23:59:59Z"))];
                    case 1:
                        allocations = _a.sent();
                        totalMinutes = 8 * 60;
    ...
    AllocationEngine.prototype.getStaffWorkload = function (staffId, appointmentTime) {
        return __awaiter(this, void 0, void 0, function () {
            var appointmentDate, allocations, totalHours, consecutiveHours, lastBreak, _i, allocations_1, allocation, start, end, hours, fatigueScore, staff, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        appointmentDate = new Date(appointmentTime).toISOString().split('T')[0];
                        return [4 /*yield*/, this.resourceManager.getAllocations(staffId, "".concat(appointmentDate, "T00:00:00Z"), "".concat(appointmentDate, "T23:59:59Z"))];
                    case 1:
                        allocations = _a.sent();
                        totalHours = 0;
                        consecutiveHours = 0;
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                available_skills: (staff === null || staff === void 0 ? void 0 : staff.skills) || []
                            }];
                    case 3:
                        error_6 = _a.sent();
    ...
    AllocationEngine.prototype.optimizeStaffWorkload = function (clinicId, date) {
        return __awaiter(this, void 0, void 0, function () {
            var staffResources, recommendations, totalImprovement, _i, staffResources_1, staff, workload, optimalWorkload, currentWorkload, actions, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
