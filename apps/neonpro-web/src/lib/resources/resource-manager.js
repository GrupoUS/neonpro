...
var ResourceManager = /** @class */ (() => {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("resources").insert([resourceData]).select().single(),
            ];
          case 1:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("resources").select("*").eq("id", resourceId).single(),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.from("resources").delete().eq("id", resourceId)];
          case 1:
            error = _a.sent().error;
            if (error) throw error;
            return [3 /*break*/, 3];
        ...
        switch (_b.label) {
          ...
          case 1:
            ...
            if (conflicts.length > 0) {
              throw new Error(
                "Resource conflict detected. ".concat(
                  conflicts.length,
            ...
            return [
              ...
              this.supabase
                ...
                .insert([
                  __assign(__assign({}, allocationData), {
                    allocated_by: userId,
                    status: "pending",
  ...
  // =====================================================
  ResourceManager.prototype.detectConflicts = function (
    resourceId,
    startTime,
    endTime,
    excludeAllocationId,
          ...
          case 0:
            ...
            return [
              ...
              this.supabase
                ...
                .insert([
                  __assign(__assign({}, conflictData), {
                    created_by: userId,
                    status: "pending",
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            ...
            return [3 /*break*/, 2];
          case 5:
            return [2 /*return*/, availableResources];
          case 6:
            error_14 = _a.sent();
  ...
  ResourceManager.prototype.meetsRequirements = (resource, requirements) => {
    ...
    if (requirements.skills && resource.type === "staff") {
      ...
      if (!requiredSkills.every((skill) => resourceSkills_1.includes(skill))) {
        return false;
      }
    }
    return true;
  };
  ResourceManager.prototype.suggestAlternativeResources = function (
    originalResourceId,
    startTime,
    endTime,
    requirements,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              alternatives.filter((resource) => resource.id !== originalResourceId),
            ];
          case 3:
            error_15 = _a.sent();
