...
exports.getAuditStatistics = exports.generateAuditReport = exports.queryAuditEvents = exports.logAuditEvent = exports.createAuditSystem = exports.createauditSystem = exports.AuditSeverity = exports.AuditEventType = void 0;
 ...
 */
var createauditSystem = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                        auditEvent = __assign(__assign({}, event), { timestamp: new Date(), checksum: this.generateChecksum(event) });
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.map(function (event) { return (__assign(__assign({}, event), { old_values: event.old_values ? _this.decryptSensitiveData(event.old_values) : undefined, new_values: event.new_values ? _this.decryptSensitiveData(event.new_values) : undefined })); })) || []];
                    case 2:
                        error_2 = _d.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        invalid_1 = 0;
                        errors_1 = [];
                        logs === null || logs === void 0 ? void 0 : logs.forEach(function (log) {
    ...
    createauditSystem.prototype.generateChecksum = function (data) {
        ...
        return crypto_1.default.createHash('sha256').update(content + this.encryptionKey).digest('hex');
    };
    /**
     * Criptografa dados sensíveis
     */
    createauditSystem.prototype.encryptSensitiveData = function (data) {
        ...
        Object.keys(encrypted).forEach(function (key) {
            if (sensitiveFields.some(function (field) { return key.toLowerCase().includes(field); })) {
                var cipher = crypto_1.default.createCipher('aes-256-cbc', _this.encryptionKey);
        ...
        Object.keys(decrypted).forEach(function (key) {
            if (typeof decrypted[key] === 'string' && decrypted[key].startsWith('encrypted:')) {
                try {
                    ...
                    var decipher = crypto_1.default.createDecipher('aes-256-cbc', _this.encryptionKey);
     ...
     */
    createauditSystem.prototype.isSuspiciousActivity = function (event) {
        ...
        return suspiciousPatterns.includes(event.event_type) ||
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        logFile = path.join(logDir, "audit-".concat(new Date().toISOString().split('T')[0], ".log"));
                    ...
                    case 3:
                        // Cria diretório se não existir
                        _a.sent();
                        logEntry = "".concat(new Date().toISOString(), " - ").concat(JSON.stringify(event), "\n");
...
// Instância singleton
var createAuditSystem = function () { return new createauditSystem(); };
exports.createAuditSystem = createAuditSystem;
// Helper functions para uso fácil
var logAuditEvent = function (event) {
    return (0, exports.createAuditSystem)().logEvent(event);
};
exports.logAuditEvent = logAuditEvent;
var queryAuditEvents = function (filters) {
    return (0, exports.createAuditSystem)().queryEvents(filters);
};
exports.queryAuditEvents = queryAuditEvents;
var generateAuditReport = function (title, description, filters, generatedBy) { return (0, exports.createAuditSystem)().generateReport(title, description, filters, generatedBy); };
exports.generateAuditReport = generateAuditReport;
var getAuditStatistics = function (filters) {
    return (0, exports.createAuditSystem)().getStatistics(filters);
};
