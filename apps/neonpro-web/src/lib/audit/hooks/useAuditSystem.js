...
function useAuditLogs(options) {
    ...
    var _a = options.autoRefresh, autoRefresh = _a === void 0 ? false : _a, _b = options.refreshInterval, refreshInterval = _b === void 0 ? 30000 : _b, _c = options.initialFilters, initialFilters = _c === void 0 ? {} : _c;
    ...
    var exportLogs = (0, react_1.useCallback)(function (format) { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (format === 'json') {
                        ...
                        link.href = url;
                        link.download = "audit-logs-".concat(new Date().toISOString().split('T')[0], ".json");
                        link.click();
                        URL.revokeObjectURL(url);
                    }
                    else if (format === 'csv') {
                        headers = ['Timestamp', 'Event Type', 'Severity', 'User ID', 'Description', 'IP Address'];
                        ...
                        link = document.createElement('a');
                        link.href = url;
                        link.download = "audit-logs-".concat(new Date().toISOString().split('T')[0], ".csv");
                        link.click();
                        URL.revokeObjectURL(url);
                    }
                    toast({
...
function useSecurityAlerts() {
    ...
    var toast = (0, useToast_1.useToast)().toast;
    var fetchAlerts = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (fetchError)
                        throw fetchError;
                    formattedAlerts = (data === null || data === void 0 ? void 0 : data.map(function (alert) { return (__assign(__assign({}, alert), { created_at: new Date(alert.created_at), resolved_at: alert.resolved_at ? new Date(alert.resolved_at) : undefined })); })) || [];
                    setAlerts(formattedAlerts);
                    setUnreadCount(formattedAlerts.filter(function (alert) { return alert.status === 'open'; }).length);
                    return [3 /*break*/, 4];
                case 2:
                    err_3 = _b.sent();
    ...
    var markAsRead = (0, react_1.useCallback)(function (alertId) { return __awaiter(_this, void 0, void 0, function () {
        var error_1, err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var updateStatus = (0, react_1.useCallback)(function (alertId, status) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var assignAlert = (0, react_1.useCallback)(function (alertId, userId) { return __awaiter(_this, void 0, void 0, function () {
        var error_3, err_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function useAuditReports() {
    ...
    var supabase = yield (0, client_1.createClient)();
    var toast = (0, useToast_1.useToast)().toast;
    var fetchReports = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (fetchError)
                        throw fetchError;
                    formattedReports = (data === null || data === void 0 ? void 0 : data.map(function (report) { return (__assign(__assign({}, report), { generated_at: new Date(report.generated_at), events: [] // Events são carregados sob demanda
                     })); })) || [];
    ...
    var generateReport = (0, react_1.useCallback)(function (title, description, filters) { return __awaiter(_this, void 0, void 0, function () {
        var report, err_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, createauditSystem().generateReport(title, description, filters, user.id)];
                case 2:
                    report = _a.sent();
    ...
    var deleteReport = (0, react_1.useCallback)(function (reportId) { return __awaiter(_this, void 0, void 0, function () {
        var error_4, err_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var exportReport = (0, react_1.useCallback)(function (reportId, format) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
...
function useAuditStatistics() {
    ...
    var _c = (0, react_1.useState)(null), error = _c[0], setError = _c[1];
    var toast = (0, useToast_1.useToast)().toast;
    var generateStats = (0, react_1.useCallback)(function (filters) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_10 = _a.sent();
                    errorMessage = err_10 instanceof Error ? err_10.message : 'Erro ao gerar estatísticas';
                    setError(errorMessage);
                    toast({
                        title: 'Erro',
                        description: errorMessage,
...
function useAuditLogger() {
    ...
    var user = (0, useUser_1.useUser)().user;
    var toast = (0, useToast_1.useToast)().toast;
    var logEvent = (0, react_1.useCallback)(function (event) { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c, err_11;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    _b = [__assign({}, event)];
                    _d = { user_id: event.user_id || (user === null || user === void 0 ? void 0 : user.id) };
                    _c = event.ip_address;
                ...
                case 1:
                    _c = (_e.sent());
                    _e.label = 2;
                case 2: return [4 /*yield*/, _a.apply(void 0, [__assign.apply(void 0, _b.concat([(_d.ip_address = _c, _d.user_agent = event.user_agent || navigator.userAgent, _d)]))])];
                case 3:
                    _e.sent();
                    return [3 /*break*/, 5];
                case 4:
    ...
    var logUserAction = (0, react_1.useCallback)(function (action, resourceType, resourceId, metadata) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    var logSecurityEvent = (0, react_1.useCallback)(function (eventType_1, description_1) {
        var args_1 = [];
        for (var _i = 2; _i < arguments.length; _i++) {
            args_1[_i - 2] = arguments[_i];
        }
        return __awaiter(_this, __spreadArray([eventType_1, description_1], args_1, true), void 0, function (eventType, description, severity) {
            if (severity === void 0) { severity = audit_system_1.AuditSeverity.MEDIUM; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, logEvent({
