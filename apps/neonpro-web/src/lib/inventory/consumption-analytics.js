...
var ConsumptionAnalyzer = /** @class */ (function () {
   ...
   */
  ConsumptionAnalyzer.prototype.getConsumptionAnalytics = function (
    centroCustoId,
    dataInicio,
    dataFim,
  ) {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.calculateConsumptionTrends(centroCustoId, dataInicio, dataFim),
            ];
          case 3:
            trends = _d.sent();
          ...
          case 5:
            ...
            analytics = {
              ...
              nome_centro_custo:
                ((_c =
                  (_b = consumptions[0]) === null || _b === void 0 ? void 0 : _b.centro_custo) ===
                  null || _c === void 0
                  ? void 0
                  : _c.nome) || "Centro de Custo",
              consumo_total: {
   ...
   */
  ConsumptionAnalyzer.prototype.generateCostOptimizationRecommendations = function (
    centroCustoId,
    dataInicio,
    dataFim,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.analyzeSupplierConsolidation(analytics.produtos_mais_consumidos),
            ];
          case 2:
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.analyzeProductSubstitution(analytics.produtos_mais_consumidos),
            ];
          case 5:
        ...
        productGroups = consumptions.reduce(function (acc, consumption) {
          ...
          if (!acc[productId]) {
            acc[productId] = {
              ...
              nome_produto:
                ((_a = consumption.produto) === null || _a === void 0 ? void 0 : _a.nome) ||
                "Produto não identificado",
              categoria:
                ((_b = consumption.produto) === null || _b === void 0 ? void 0 : _b.categoria) ||
                "Sem categoria",
   ...
   */
  ConsumptionAnalyzer.prototype.calculateConsumptionTrends = function (
    centroCustoId,
    dataInicio,
    dataFim,
  ) {
   ...
   */
  ConsumptionAnalyzer.prototype.generateConsumptionAlerts = function (
    consumptions,
    productConsumptions,
  ) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        productConsumptions.forEach(function (product, index) {
          if (product.percentual_consumo_total > 20) {
            alerts.push({
              ...
              descricao: "Produto representa ".concat(
                product.percentual_consumo_total.toFixed(1),
                "% do consumo total",
              ),
          ...
          if (product.custo_medio_unitario > 100) {
            alerts.push({
              ...
              produto_id: product.produto_id,
              nome_produto: product.nome_produto,
              descricao: "Produto com custo unit\u00E1rio elevado: R$ ".concat(
                product.custo_medio_unitario.toFixed(2),
              ),
              valor_impacto: product.valor_consumido,
              gravidade: "media",
   ...
   */
  ConsumptionAnalyzer.prototype.calculateProductForecast = function (
    productId,
    consumptions,
    diasPrevisao,
  ) {
      ...
      return __generator(this, function (_c) {
        ...
        return [
          2 /*return*/,
          {
            produto_id: productId,
            nome_produto:
              ((_b = (_a = consumptions[0]) === null || _a === void 0 ? void 0 : _a.produto) ===
                null || _b === void 0
                ? void 0
                : _b.nome) || "Produto não identificado",
   ...
   */
  ConsumptionAnalyzer.prototype.analyzeProductPattern = function (
    centroCustoId,
    productId,
    consumptions,
  ) {
        ...
        if (highValueProducts.length > 5) {
          return [
            ...
            [
              {
                tipo: "consolidacao_fornecedor",
                descricao: "Consolidar ".concat(
                  highValueProducts.length,
      ...
      return __generator(this, function (_a) {
        ...
        products.forEach(function (product) {
          if (product.numero_movimentacoes > 10 && product.valor_consumido > 500) {
            opportunities.push({
              tipo: "otimizacao_lote",
              descricao: "Otimizar lotes de compra para "
                .concat(product.nome_produto, " (")
                .concat(product.numero_movimentacoes, " movimenta\u00E7\u00F5es)"),
   ...
   */
  ConsumptionAnalyzer.prototype.analyzeWasteReduction = function (
    centroCustoId,
    dataInicio,
    dataFim,
  ) {
