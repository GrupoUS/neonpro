      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [4 /*yield*/, query.order("data_validade", { ascending: true })];
          case 1:
              ...
              (expiringBatches === null || expiringBatches === void 0
                ...
                : expiringBatches.map((batch) => {
                    ...
                    var estimatedValue =
                      ...
                      (((_a = batch.produto) === null || _a === void 0 ? void 0 : _a.preco_custo) ||
                        0);
                    return {
                      id: "alert-".concat(batch.id),
                      produto_id: batch.produto_id,
                      nome_produto:
                        ((_b = batch.produto) === null || _b === void 0 ? void 0 : _b.nome) ||
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("lotes_estoque").select("*").eq("id", data.lote_id).single(),
            ];
          case 1:
            batch = _b.sent().data;
            if (!batch) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("itens_transferencia_interna").insert({
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            ...
            return [3 /*break*/, 3];
          case 6:
            return [2 /*return*/, { blocked: expiringBatches.length, error: null }];
          case 7:
            error_5 = _a.sent();
      ...
      return __generator(this, function (_c) {
        ...
        return [
          2 /*return*/,
          {
            ...
            nome_produto:
              ((_b = (_a = batches[0]) === null || _a === void 0 ? void 0 : _a.produto) === null ||
              _b === void 0
                ? void 0
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            for (
              _i = 0, availableBatches_1 = availableBatches;
              _i < availableBatches_1.length;
              _i++
            ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("movimentacoes_lote").insert(
                __assign(__assign({}, movement), {
