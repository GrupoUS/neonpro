...
var StockOutputManager = /** @class */ (function () {
    ...
    StockOutputManager.prototype.createStockOutput = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var stockValidation, itemsWithFIFO, totals, requiresApproval, outputNumber, _a, output_1, outputError, itemsData, _b, items, itemsError, error_1;
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!stockValidation.available) {
                            return [2 /*return*/, {
                                    data: null,
                                    error: "Estoque insuficiente: ".concat(stockValidation.unavailableItems.join(', '))
                                }];
                        }
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.checkApprovalRequirement(data.centro_custo_id, totals.valor_total, data.tipo_saida)];
                    case 3:
                    ...
                    case 5:
                        ...
                        if (outputError)
                            throw outputError;
                        itemsData = itemsWithFIFO.map(function (item) { return ({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        materialsForDeduction = this.applyManualAdjustments(standardMaterials, data.ajustes_manuais || []);
                        return [4 /*yield*/, this.createStockOutput({
                                tipo_saida: 'procedimento',
                                centro_custo_id: data.centro_custo_id,
                                profissional_id: data.profissional_id,
                                procedimento_id: data.procedimento_id,
                                agendamento_id: data.agendamento_id,
                                itens: materialsForDeduction.map(function (material) { return ({
    ...
    StockOutputManager.prototype.applyFIFOSelection = function (items) {
        return __awaiter(this, void 0, void 0, function () {
            var result, _i, items_1, item, availableBatches, remainingQuantity, fifoOrder, _a, availableBatches_1, batch, quantityToTake, latestEntry;
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!availableBatches || availableBatches.length === 0) {
                            throw new Error("Nenhum lote dispon\u00EDvel para o produto ".concat(item.produto_id));
                        }
                    ...
                    case 4:
                        ...
                        result.push({
                            ...
                            custo_unitario: (latestEntry === null || latestEntry === void 0 ? void 0 : latestEntry.custo_unitario) || 0,
                            localizacao_origem: item.localizacao_origem,
                    ...
                    case 6:
                        if (remainingQuantity > 0) {
                            throw new Error("Quantidade insuficiente em estoque para o produto ".concat(item.produto_id));
                        }
                        _b.label = 7;
                    case 7:
                        _i++;
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        totalAvailable = (batchSummary === null || batchSummary === void 0 ? void 0 : batchSummary.reduce(function (sum, batch) { return sum + batch.quantidade_disponivel; }, 0)) || 0;
                                        if (totalAvailable < item.quantidade) {
                                            unavailableItems.push(item.produto_id);
                                        }
                                        else {
                                            sortedBatches = batchSummary === null || batchSummary === void 0 ? void 0 : batchSummary.sort(function (a, b) {
                                            ...
                                            recommendations.push.apply(// Top 3 recommendations
                                            recommendations, sortedBatches.map(function (batch) { return ({
                                                lote_id: batch.id,
                                                produto_id: item.produto_id,
                                                numero_lote: batch.numero_lote,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        item = items_3[_i];
                        return [4 /*yield*/, this.supabase.rpc('update_batch_quantity_after_output', {
     ...
     */
    StockOutputManager.prototype.checkApprovalRequirement = function (centroCustoId, valorTotal, tipoSaida) {
        return __awaiter(this, void 0, void 0, function () {
            var costCenter;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    StockOutputManager.prototype.calculateOutputTotals = function (items) {
        return items.reduce(function (totals, item) { return ({
    ...
    StockOutputManager.prototype.applyManualAdjustments = function (standardMaterials, adjustments) {
        return standardMaterials.map(function (material) {
            var adjustment = adjustments.find(function (adj) { return adj.produto_id === material.produto_id; });
            return __assign(__assign({}, material), { quantidade_padrao: (adjustment === null || adjustment === void 0 ? void 0 : adjustment.quantidade_ajustada) || material.quantidade_padrao });
        });
    };
    /**
