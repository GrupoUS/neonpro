...
exports.inventoryIntegrationManager = exports.inventoryDashboardProvider = exports.inventoryConfigManager = exports.InventoryUtils = exports.InventoryIntegrationManager = exports.InventoryDashboardProvider = exports.InventoryConfigManager = void 0;
...
var InventoryConfigManager = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.config = __assign(__assign({}, types_1.DEFAULT_INVENTORY_CONFIG), configData.configuracao);
    ...
    InventoryConfigManager.prototype.updateConfigSection = function (section, updates) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _a;
            return __generator(this, function (_b) {
                newConfig = __assign(__assign({}, this.config), (_a = {}, _a[section] = __assign(__assign({}, this.config[section]), updates), _a));
...
var InventoryDashboardProvider = /** @class */ (function () {
    ...
    InventoryDashboardProvider.prototype.getStockLevels = function () {
        return __awaiter(this, void 0, void 0, function () {
            var stockData, totalProducts, lowStockProducts, outOfStockProducts, totalValue, thirtyDaysFromNow, expiringSoonProducts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        lowStockProducts = stockData.filter(function (p) { return p.estoque_atual <= p.estoque_minimo; }).length;
                        outOfStockProducts = stockData.filter(function (p) { return p.estoque_atual === 0; }).length;
                        totalValue = stockData.reduce(function (sum, p) { return sum + (p.estoque_atual * (p.preco_custo || 0)); }, 0);
                        thirtyDaysFromNow = new Date();
                        thirtyDaysFromNow.setDate(thirtyDaysFromNow.getDate() + 30);
                        expiringSoonProducts = stockData.filter(function (product) {
                            var _a;
                            return (_a = product.lotes_estoque) === null || _a === void 0 ? void 0 : _a.some(function (lote) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        outputsCount = (outputsToday === null || outputsToday === void 0 ? void 0 : outputsToday.length) || 0;
                        valueConsumedToday = (outputsToday === null || outputsToday === void 0 ? void 0 : outputsToday.reduce(function (sum, output) { return sum + output.valor_total; }, 0)) || 0;
                        return [4 /*yield*/, this.supabase
    ...
    InventoryDashboardProvider.prototype.getFIFOStatus = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sevenDaysFromNow, thirtyDaysFromNow, expiring7Days, expiring30Days, fifoComplianceScore, wastePreventedValue;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        monthlyValue = (monthlyConsumption === null || monthlyConsumption === void 0 ? void 0 : monthlyConsumption.reduce(function (sum, c) { return sum + c.valor_total; }, 0)) || 0;
                        return [4 /*yield*/, this.supabase
                                .from('agendamentos')
                                .select('*', { count: 'exact', head: true })
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error)
                            throw error;
                        integrations = (integrationData === null || integrationData === void 0 ? void 0 : integrationData.reduce(function (acc, integration) {
                            acc[integration.sistema_externo] = __assign({ enabled: integration.ativo }, integration.configuracao);
                            return acc;
                        }, {})) || {};
                        systemIntegration = {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, { data: null, error: 'Erro ao verificar status das integrações' }];
                    case 3: return [2 /*return*/];
                }
            });
        });
