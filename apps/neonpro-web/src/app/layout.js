...
function RootLayout(_a) {
    ...
    return (<nextjs_1.ClerkProvider publishableKey={clerk_config_1.clerkConfig.publishableKey} localization={localizations_1.ptBR} appearance={clerk_config_1.healthcareAppearance} signInUrl={clerk_config_1.clerkConfig.signInUrl} signUpUrl={clerk_config_1.clerkConfig.signUpUrl} afterSignInUrl={clerk_config_1.clerkConfig.afterSignInUrl} afterSignUpUrl={clerk_config_1.clerkConfig.afterSignUpUrl}>
      <html lang="pt-BR">
        <head>
