...
function SignUpPage() {
    return (<div className="relative flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 to-sky-50 p-4">
      <div className="w-full max-w-md">
        ...
        <nextjs_1.SignUp appearance={{
            ...
            elements: {
                formButtonPrimary: 'bg-sky-500 hover:bg-sky-600 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200',
                ...
                socialButtonsBlockButton: 'border border-slate-300 hover:border-slate-400 text-slate-700 font-medium py-2 px-4 rounded-lg transition-colors duration-200',
                formFieldInput: 'border border-slate-300 focus:border-sky-500 focus:ring-sky-500 rounded-lg px-3 py-2',
                footerActionText: 'text-slate-600 text-sm',
                footerActionLink: 'text-sky-600 hover:text-sky-700 font-medium text-sm',
            }
        }} redirectUrl="/dashboard" routing="path" path="/signup"/>
