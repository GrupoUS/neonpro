...
function OfflinePage() {
    return (<div className="min-h-screen bg-gradient-to-br from-background to-muted p-4 flex items-center justify-center">
      <card_1.Card className="w-full max-w-md mx-auto">
        ...
        <card_1.CardContent className="space-y-6">
          ...
          {/* Actions */}
          <div className="space-y-3">
            <button_1.Button onClick={function () { return window.location.reload(); }} className="w-full" size="lg">
              <lucide_react_1.Wifi className="w-4 h-4 mr-2"/>
              Tentar reconectar
            </button_1.Button>
            
            <button_1.Button onClick={function () { return window.history.back(); }} variant="outline" className="w-full" size="lg">
