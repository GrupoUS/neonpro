    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 9:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ success: true, data: updatedValidation }),
          ];
        case 10:
        ...
        case 11:
          (evidence_ids = data.evidence_ids),
            (synthesis_title = data.synthesis_title),
        ...
        case 12:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ success: true, data: synthesis }, { status: 201 }),
          ];
        case 13:
          return [
            2 /*return*/,
