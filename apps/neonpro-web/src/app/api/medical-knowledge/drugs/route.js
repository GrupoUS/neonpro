...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, searchParams, action, _a, searchQuery, searchResults, drugId, drug, drugIds, interactions, error_1;
        var _b, _c;
            ...
            switch (_d.label) {
                ...
                case 2:
                    ...
                    switch (_a) {
                        ...
                        case 'drug': return [3 /*break*/, 5];
                        case 'interactions': return [3 /*break*/, 7];
                    }
                    return [3 /*break*/, 9];
                case 3:
                    searchQuery = {
                        ...
                        interaction_check: ((_b = searchParams.get('interaction_check')) === null || _b === void 0 ? void 0 : _b.split(',')) || undefined,
                    };
                ...
                case 5:
                    ...
                    if (!drugId) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Drug ID required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, service.getDrugById(drugId)];
                case 6:
                    drug = _d.sent();
                    if (!drug) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Drug not found' }, { status: 404 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ success: true, data: drug })];
                case 7:
                    drugIds = (_c = searchParams.get('drug_ids')) === null || _c === void 0 ? void 0 : _c.split(',');
                ...
                case 9: return [2 /*return*/, server_2.NextResponse.json({ error: 'Invalid action parameter' }, { status: 400 })];
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, body, action, data, _a, queries, batchResults, drug_combinations, patient_factors, complexInteractions, allInteractions, uniqueInteractions, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    _a = action;
                    switch (_a) {
                        case 'batch-search': return [3 /*break*/, 4];
                        case 'complex-interaction-check': return [3 /*break*/, 6];
                    }
                    return [3 /*break*/, 8];
                case 4:
                    queries = data.queries;
                    if (!Array.isArray(queries)) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Queries must be an array' }, { status: 400 })];
                    }
                    return [4 /*yield*/, Promise.all(queries.map(function (query) { return service.searchDrugs(query); }))];
                case 5:
                ...
                case 6:
                    ...
                    return [4 /*yield*/, Promise.all(drug_combinations.map(function (combo) { return service.checkDrugInteractions(combo); }))];
                case 7:
                    ...
                    uniqueInteractions = allInteractions.filter(function (interaction, index, arr) {
                        return arr.findIndex(function (i) { return i.id === interaction.id; }) === index;
                    });
                    return [2 /*return*/, server_2.NextResponse.json({
                            success: true,
                            data: {
                                ...
                                risk_assessment: {
                                    ...
                                    high_severity: uniqueInteractions.filter(function (i) { return i.severity_level >= 8; }).length,
                                    moderate_severity: uniqueInteractions.filter(function (i) { return i.severity_level >= 5 && i.severity_level < 8; }).length,
                                    low_severity: uniqueInteractions.filter(function (i) { return i.severity_level < 5; }).length,
                                }
                            }
                        })];
