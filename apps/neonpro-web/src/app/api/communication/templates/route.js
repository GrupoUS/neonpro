...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, url, queryParams, validatedQuery, category, active, search, _a, page, _b, limit, _c, sort, _d, order, filters, pageNum, limitNum, offset, profile, communicationService, result, error_1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    if (!session) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Authentication required', code: 'AUTH_REQUIRED' }, { status: 401 })];
                    }
                    url = new URL(request.url);
                    queryParams = Object.fromEntries(url.searchParams.entries());
                    validatedQuery = QuerySchema.parse(queryParams);
                    category = validatedQuery.category, active = validatedQuery.active, search = validatedQuery.search, _a = validatedQuery.page, page = _a === void 0 ? '1' : _a, _b = validatedQuery.limit, limit = _b === void 0 ? '20' : _b, _c = validatedQuery.sort, sort = _c === void 0 ? 'name' : _c, _d = validatedQuery.order, order = _d === void 0 ? 'asc' : _d;
                    filters = {};
                    if (category) {
                ...
                case 3:
                    ...
                    if (!(profile === null || profile === void 0 ? void 0 : profile.clinic_id)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Clinic not found', code: 'CLINIC_NOT_FOUND' }, { status: 404 })];
                    }
                    communicationService = new communication_service_1.CommunicationService(supabase, profile.clinic_id);
                    return [4 /*yield*/, communicationService.getTemplates(__assign(__assign({}, filters), { limit: limitNum, offset: offset, sort_by: sort, sort_order: order }))];
                case 4:
                    result = _e.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, body, validatedData, profile, communicationService, existingTemplate, template, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, communicationService.createTemplate(__assign(__assign({}, validatedData), { created_by: session.user.id }))];
                case 6:
                    template = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, body, template_ids, is_active, profile, communicationService, updatedTemplates, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                ...
                case 3:
                    ...
                    if (!Array.isArray(template_ids) || template_ids.length === 0) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Template IDs array is required', code: 'INVALID_INPUT' }, { status: 400 })];
                    }
                    if (typeof is_active !== 'boolean') {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'is_active must be boolean', code: 'INVALID_INPUT' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('profiles')
                            .select('clinic_id')
                ...
                case 4:
                    ...
                    communicationService = new communication_service_1.CommunicationService(supabase, profile.clinic_id);
                    return [4 /*yield*/, communicationService.bulkUpdateTemplates(template_ids, { is_active: is_active, updated_by: session.user.id })];
                case 5:
...
function DELETE(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, body, template_ids, profile, communicationService, templatesInUse, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
