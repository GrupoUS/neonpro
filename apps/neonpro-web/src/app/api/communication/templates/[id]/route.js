        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!templateId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Template ID is required', code: 'INVALID_ID' }, { status: 400 })];
                    }
                ...
                case 3:
                    template = _c.sent();
                    if (!template) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Template not found', code: 'TEMPLATE_NOT_FOUND' }, { status: 404 })];
                    }
...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, templateId, body, validatedData, profile, communicationService, existingTemplate, nameConflict, updatedTemplate, error_2;
        var params = _b.params;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 4:
                    ...
                    if (!(validatedData.name && validatedData.name !== existingTemplate.name)) return [3 /*break*/, 6];
                ...
                case 5:
                    ...
                    _c.label = 6;
                case 6: return [4 /*yield*/, communicationService.updateTemplate(templateId, __assign(__assign({}, validatedData), { updated_by: session.user.id }))];
                case 7:
...
function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, templateId, profile, communicationService, existingTemplate, templatesInUse, error_3;
        var params = _b.params;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
...
function POST(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, templateId, body, name_1, profile, communicationService, sourceTemplate, nameConflict, duplicatedTemplate, error_4;
        var params = _b.params;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 2:
                    ...
                    if (!name_1 || typeof name_1 !== 'string') {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'New template name is required', code: 'INVALID_NAME' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('profiles')
                            .select('clinic_id')
                ...
                case 4:
                    ...
                    if (!sourceTemplate) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Source template not found', code: 'TEMPLATE_NOT_FOUND' }, { status: 404 })];
                    }
                ...
                case 5:
                    ...
                    return [4 /*yield*/, communicationService.duplicateTemplate(templateId, name_1, session.user.id)];
                case 6:
