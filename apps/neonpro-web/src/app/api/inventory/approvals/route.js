...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, searchParams, budgetId, status_1, approverId, query, _a, approvals, error, error_1;
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch approvals' }, { status: 500 })];
                    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, service.createApproval(user.id, __assign(__assign({}, validated), { requester_id: user.id }))];
                case 4:
                    approval = _a.sent();
                ...
                case 5:
                    ...
                    if (error_2 instanceof Error && error_2.name === 'ZodError') {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Invalid approval data' }, { status: 400 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create approval' }, { status: 500 })];
