    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            (0, inventory_reports_service_1.createinventoryReportsService)().generateReport(
              parameters,
            ),
          ];
        case 4:
          ...
          if (parameters.format === "csv") {
            ...
            return [
              2 /*return*/,
              new server_1.NextResponse(csvData, {
                headers: {
                  "Content-Type": "text/csv",
                  "Content-Disposition": 'attachment; filename="'
                    .concat(parameters.type, "_report_")
                    .concat(new Date().getTime(), '.csv"'),
                },
              }),
            ];
      ...
      switch (_a.label) {
        ...
        case 2:
          ...
          if (!reportType) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Report type is required" }, { status: 400 }),
            ];
          }
          filters = {};
...
function validateGenerateReportRequest(body) {
  ...
  if (
    ((_a = body.filters) === null || _a === void 0 ? void 0 : _a.start_date) &&
    !isValidDate(body.filters.start_date)
  ) {
    errors.push(
  ...
  if (
    ((_b = body.filters) === null || _b === void 0 ? void 0 : _b.end_date) &&
    !isValidDate(body.filters.end_date)
  ) {
    errors.push("Invalid end_date format. Use ISO 8601 format (YYYY-MM-DD or YYYY-MM-DDTHH:mm:ss)");
  }
  // Validate UUID formats for IDs
  if (
    ((_c = body.filters) === null || _c === void 0 ? void 0 : _c.clinic_id) &&
    !isValidUUID(body.filters.clinic_id)
  ) {
    errors.push("Invalid clinic_id format. Must be a valid UUID");
  }
  if (
    ((_d = body.filters) === null || _d === void 0 ? void 0 : _d.room_id) &&
    !isValidUUID(body.filters.room_id)
  ) {
    errors.push("Invalid room_id format. Must be a valid UUID");
  }
  if (
    ((_e = body.filters) === null || _e === void 0 ? void 0 : _e.item_id) &&
    !isValidUUID(body.filters.item_id)
  ) {
