...
var forecastRequestSchema = zod_1.z.object({
    ...
    forecast_date: zod_1.z.string().transform(function (str) { return new Date(str); }),
});
var bulkForecastRequestSchema = zod_1.z.object({
    items: zod_1.z.array(zod_1.z.object({
        item_id: zod_1.z.string(),
        forecast_period: zod_1.z.enum(['daily', 'weekly', 'monthly', 'quarterly']).optional().default('weekly'),
    })),
    clinic_id: zod_1.z.string(),
    forecast_date: zod_1.z.string().optional().transform(function (str) { return str ? new Date(str) : new Date(); }),
});
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, thresholdService.generateDemandForecast(validatedData.item_id, validatedData.clinic_id, validatedData.forecast_period, validatedData.forecast_date)];
                case 4:
                    forecast = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(validatedData_1.items.map(function (item) { return __awaiter(_this, void 0, void 0, function () {
                            var forecast, error_3;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, thresholdService.generateDemandForecast(item.item_id, validatedData_1.clinic_id, item.forecast_period, validatedData_1.forecast_date)];
                                    case 1:
                                        forecast = _a.sent();
                                        return [2 /*return*/, { success: true, item_id: item.item_id, data: forecast }];
                                    case 2:
                                        error_3 = _a.sent();
                                        return [2 /*return*/, {
                                                success: false,
                ...
                case 1:
                    forecasts = _a.sent();
                    successful = forecasts.filter(function (f) { return f.success; });
                    failed = forecasts.filter(function (f) { return !f.success; });
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: successful.map(function (f) { return f.data; }),
                            summary: {
                                total_requested: validatedData_1.items.length,
                                successful: successful.length,
                                failed: failed.length,
                                failures: failed.map(function (f) { return ({ item_id: f.item_id, error: f.error }); }),
                            },
                            message: "Bulk forecast completed: ".concat(successful.length, "/").concat(validatedData_1.items.length, " successful"),
                        })];
                case 2:
                    error_2 = _a.sent();
