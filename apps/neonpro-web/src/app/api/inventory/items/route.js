        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch inventory items' }, { status: 500 })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    body = _a.sent();
                    itemData = __assign(__assign({}, body), { created_by: session.user.id, updated_by: session.user.id });
                    inventoryService = new multi_location_inventory_service_1.MultiLocationInventoryService();
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create inventory item' }, { status: 500 })];
