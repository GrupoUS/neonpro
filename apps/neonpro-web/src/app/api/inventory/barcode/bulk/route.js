...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, searchParams, action, validatedData, result, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, barcode_service_1.barcodeService.processBulkScan(validatedData.operation_id, validatedData.scan_value, session.user.id)];
                case 4:
                    result = _b.sent();
                ...
                case 5: return [2 /*return*/, server_1.NextResponse.json({ error: 'Ação não suportada' }, { status: 400 })];
                case 6:
                    error_1 = _b.sent();
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, searchParams, operationId, status_1, limit, _b, operation, error_3, query, _c, operations, error, error_2;
            ...
            switch (_d.label) {
                ...
                case 3:
                    ...
                    if (error_3) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Operação não encontrada' }, { status: 404 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: operation
                ...
                case 5:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar operações' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: operations
...
function PATCH(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, searchParams, operationId, body, validatedData, _b, operation, error, error_4;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    operationId = searchParams.get('operation_id');
                    if (!operationId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'operation_id é obrigatório' }, { status: 400 })];
                    }
                    return [4 /*yield*/, request.json()];
                case 3:
                    body = _c.sent();
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao atualizar operação' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: operation
                ...
                case 5:
                    ...
                    if (error_4 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_1.NextResponse.json({
                                error: 'Dados inválidos',
                                details: error_4.errors.map(function (e) { return ({
                                    field: e.path.join('.'),
                                    message: e.message
                                }); })
                            }, { status: 400 })];
