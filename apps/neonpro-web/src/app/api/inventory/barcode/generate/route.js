...
var generateBarcodeSchema = zod_1.z.object({
    ...
    barcode_type: zod_1.z.enum(['EAN13', 'CODE128', 'CODE39'], {
        errorMap: function () { return ({ message: 'Tipo de código deve ser EAN13, CODE128 ou CODE39' }); }
    }),
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, validatedData, _b, item, itemError, existingBarcode, result, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    if (itemError || !item) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Item não encontrado' }, { status: 404 })];
                    }
                    return [4 /*yield*/, supabase
