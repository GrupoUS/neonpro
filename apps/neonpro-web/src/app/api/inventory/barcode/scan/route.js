    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            barcode_service_1.barcodeService.startBulkScanOperation(
              __assign(__assign({}, validatedData), { user_id: session.user.id }),
            ),
          ];
        case 4:
          result = _b.sent();
        ...
        case 5:
          ...
          return [
            4 /*yield*/,
            barcode_service_1.barcodeService.scanBarcode(
              __assign(__assign({}, validatedData), { user_id: session.user.id }),
            ),
          ];
        case 6:
