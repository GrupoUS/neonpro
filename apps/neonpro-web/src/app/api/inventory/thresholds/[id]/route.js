        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    threshold = _c.sent();
                    if (!threshold) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Threshold not found' }, { status: 404 })];
                    }
    ...
    return __awaiter(this, arguments, void 0, function (request, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, thresholdService.updateThreshold(params.id, {
                            is_active: false,
