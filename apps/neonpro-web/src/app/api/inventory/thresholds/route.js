...
var queryParamsSchema = zod_1.z.object({
    ...
    auto_reorder_enabled: zod_1.z.string().optional().transform(function (val) { return val === 'true'; }),
    needs_optimization: zod_1.z.string().optional().transform(function (val) { return val === 'true'; }),
});
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var url, params, _a, clinic_id, item_category, auto_reorder_enabled, needs_optimization, filters, thresholds, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = queryParamsSchema.parse(params), clinic_id = _a.clinic_id, item_category = _a.item_category, auto_reorder_enabled = _a.auto_reorder_enabled, needs_optimization = _a.needs_optimization;
                    filters = {};
                    if (item_category)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!id) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Threshold ID is required' }, { status: 400 })];
                    }
