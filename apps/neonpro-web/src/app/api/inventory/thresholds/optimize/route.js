...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var url, params, clinic_id, optimizations, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    clinic_id = queryParamsSchema.parse(params).clinic_id;
                    return [4 /*yield*/, thresholdService.analyzeThresholdOptimization(clinic_id)];
                case 1:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            summary: {
                                ...
                                potential_savings: optimizations.reduce(function (sum, opt) { return sum + opt.potential_savings; }, 0),
                                high_priority_items: optimizations.filter(function (opt) { return opt.implementation_priority === 'high'; }).length,
                                average_confidence: optimizations.length > 0
                                    ? optimizations.reduce(function (sum, opt) { return sum + opt.confidence_score; }, 0) / optimizations.length
                                    : 0,
                            },
                        })];
                case 2:
                    error_1 = _a.sent();
                    console.error('Error analyzing threshold optimization:', error_1);
