...
var AlertFiltersSchema = zod_1.z.object({
    type: zod_1.z.enum(['low_stock', 'out_of_stock', 'expired', 'expiring_soon', 'overstock']).optional(),
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    filters = AlertFiltersSchema.parse({
                        ...
                        is_read: searchParams.get('is_read') === 'true' ? true :
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch alerts' }, { status: 500 })];
                    }
                    transformedAlerts = (alerts === null || alerts === void 0 ? void 0 : alerts.map(function (alert) {
                        var _a, _b;
                        return ({
                            id: alert.id,
                            type: alert.type,
                            ...
                            item_name: ((_a = alert.inventory_items) === null || _a === void 0 ? void 0 : _a.name) || 'Unknown Item',
                            item_id: alert.item_id,
                            location_name: ((_b = alert.inventory_locations) === null || _b === void 0 ? void 0 : _b.name) || 'Unknown Location',
                ...
                case 4:
                    ...
                    if (error_1 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Invalid parameters', details: error_1.errors }, { status: 400 })];
                    }
            ...
            switch (_d.label) {
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create alert' }, { status: 500 })];
                    }
                    transformedAlert = {
                        id: alert_1.id,
                        type: alert_1.type,
                        ...
                        item_name: ((_b = alert_1.inventory_items) === null || _b === void 0 ? void 0 : _b.name) || 'Unknown Item',
                        item_id: alert_1.item_id,
                        location_name: ((_c = alert_1.inventory_locations) === null || _c === void 0 ? void 0 : _c.name) || 'Unknown Location',
                ...
                case 5:
                    ...
                    if (error_2 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Invalid alert data', details: error_2.errors }, { status: 400 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Internal server error' }, { status: 500 })];
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to mark alerts as read' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ message: 'All alerts marked as read' })];
                case 4: return [2 /*return*/, server_2.NextResponse.json({ error: 'Invalid action' }, { status: 400 })];
                case 5:
                    error_3 = _a.sent();
