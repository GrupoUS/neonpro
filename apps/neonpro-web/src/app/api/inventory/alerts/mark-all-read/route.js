...
function PATCH(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, _a, alerts, error, error_1;
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({
                            ...
                            updated_count: (alerts === null || alerts === void 0 ? void 0 : alerts.length) || 0
                        })];
                case 4:
                    error_1 = _b.sent();
                    console.error('Error in mark-all-read API:', error_1);
