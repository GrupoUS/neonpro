      ...
      switch (_a.label) {
        ...
        case 3:
          ...
          if (!budget_ids || !Array.isArray(budget_ids) || budget_ids.length === 0) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Budget IDs required" }, { status: 400 }),
            ];
          }
          ...
          return [
            4 /*yield*/,
            Promise.all(
              budget_ids.map((budgetId) =>
                service_1.generateBudgetOptimizationRecommendations(budgetId),
              ),
            ),
          ];
        case 4:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ recommendations: allRecommendations.flat() }),
          ];
        case 5:
          error_1 = _a.sent();
      ...
      switch (_a.label) {
        ...
        case 2:
          ...
          if (!budgetId) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Budget ID required" }, { status: 400 }),
            ];
          }
        ...
        case 4:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ error: "Failed to generate forecast" }, { status: 500 }),
          ];
        case 5:
          return [2 /*return*/];
      }
