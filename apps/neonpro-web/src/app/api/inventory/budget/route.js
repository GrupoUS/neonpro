...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, searchParams, period, costCenter, status_1, query, _a, budgets, error, error_1;
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch budgets' }, { status: 500 })];
                    }
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user_1, body, validated_1, service_1, results, validated, service, budget, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, Promise.all(validated_1.budgets.map(function (budgetData) {
                            return service_1.createBudget(user_1.id, __assign(__assign({}, budgetData), { user_id: user_1.id }));
                        }))];
                case 4:
                    results = _a.sent();
                ...
                case 5:
                    ...
                    return [4 /*yield*/, service.createBudget(user_1.id, __assign(__assign({}, validated), { user_id: user_1.id }))];
                case 6:
                    budget = _a.sent();
                ...
                case 7:
                    ...
                    if (error_2 instanceof Error && error_2.name === 'ZodError') {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Invalid budget data' }, { status: 400 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create budget' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    service = new budget_approval_service_1.BudgetApprovalService();
                    return [4 /*yield*/, service.updateBudgetPeriod(validated.budget_id, validated.period_data)];
                case 4:
                    updated = _a.sent();
