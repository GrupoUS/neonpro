      ...
      switch (_c.label) {
        ...
        case 3:
          ...
          if (!budget) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Budget not found" }, { status: 404 }),
            ];
          }
        ...
        case 4:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ error: "Failed to fetch budget" }, { status: 500 }),
          ];
        case 5:
          return [2 /*return*/];
      }
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            supabase.from("budgets").delete().eq("id", params.id).eq("user_id", user.id),
          ];
        case 3:
          error = _c.sent().error;
          if (error) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Failed to delete budget" }, { status: 500 }),
            ];
          }
