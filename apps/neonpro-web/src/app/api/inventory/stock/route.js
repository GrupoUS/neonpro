        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch inventory stock' }, { status: 500 })];
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session_1, body, updates, inventoryService_1, updatedStock, updateData, inventoryService, stock, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
                ...
                case 3:
                    ...
                    updates = body.map(function (update) { return (__assign(__assign({}, update), { last_counted_by: session_1.user.id })); });
                    inventoryService_1 = new multi_location_inventory_service_1.MultiLocationInventoryService();
                ...
                case 7:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update inventory stock' }, { status: 500 })];
