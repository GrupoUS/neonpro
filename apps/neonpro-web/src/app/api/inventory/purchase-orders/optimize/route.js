...
var optimizeBulkOrderSchema = zod_1.z.object({
    ...
    item_ids: zod_1.z.array(zod_1.z.string().min(1, 'Item ID is required')).min(1, 'At least one item is required'),
    analysis_type: zod_1.z.enum(['eoq', 'bulk_discount', 'seasonal', 'all']).optional().default('all')
});
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, body, validatedData, optimizationResults, _a, itemsData_1, itemsError, enhancedRecommendations, bulkOpportunities, seasonalRecommendations, _b, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, purchase_order_service_1.purchaseOrderService.optimizeBulkOrder(validatedData.clinic_id, validatedData.item_ids)];
                case 4:
                ...
                case 5:
                    ...
                    if (itemsError) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch item details' }, { status: 500 })];
                    }
                    enhancedRecommendations = optimizationResults.recommendations.map(function (rec) {
                        var itemData = itemsData_1 === null || itemsData_1 === void 0 ? void 0 : itemsData_1.find(function (item) { return item.id === rec.itemId; });
                        return __assign(__assign({}, rec), { item_details: itemData ? {
                                name: itemData.name,
                                sku: itemData.sku,
                                ...
                                unit: itemData.unit
                            } : null, optimization_type: 'EOQ', potential_savings_percentage: itemData ? (rec.costSavings / (itemData.unit_cost * rec.currentQuantity)) * 100 : 0 });
                    });
                    return [4 /*yield*/, analyzeBulkOpportunities(supabase, validatedData.item_ids, validatedData.clinic_id)];
                case 6:
                    bulkOpportunities = _c.sent();
                    if (!(validatedData.analysis_type === 'seasonal' || validatedData.analysis_type === 'all')) return [3 /*break*/, 8];
                    return [4 /*yield*/, generateSeasonalRecommendations(supabase, validatedData.item_ids, validatedData.clinic_id)];
                case 7:
                    _b = _c.sent();
                    return [3 /*break*/, 9];
                case 8:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error)
                        return [2 /*return*/, []];
                    bulkOpportunities = (supplierItems === null || supplierItems === void 0 ? void 0 : supplierItems.map(function (item) {
                        var _a;
                        var potentialSavings = item.unit_cost * item.bulk_discount_threshold * (item.bulk_discount_percentage / 100);
                        return {
                            item_id: item.item_id,
                            supplier_id: item.supplier_id,
                            supplier_name: (_a = item.suppliers) === null || _a === void 0 ? void 0 : _a.name,
                            ...
                            recommendation: "Order ".concat(item.bulk_discount_threshold, " units to get ").concat(item.bulk_discount_percentage, "% discount"),
                            priority: potentialSavings > 100 ? 'high' : potentialSavings > 50 ? 'medium' : 'low'
                        };
                    })) || [];
                    return [2 /*return*/, bulkOpportunities.sort(function (a, b) { return b.potential_savings - a.potential_savings; })];
                case 2:
                    error_2 = _b.sent();
...
function generateSeasonalRecommendations(supabase, itemIds, clinicId) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, consumptionData, error, monthlyConsumption, seasonalRecommendations, _loop_1, _i, _b, _c, itemId, monthlyData, error_3;
        var _d, _e;
            ...
            switch (_f.label) {
                ...
                case 1:
                    ...
                    _loop_1 = function (itemId, monthlyData) {
                        ...
                        var avgConsumption = months.reduce(function (sum, val) { return sum + val; }, 0) / months.length;
                        var maxConsumption = Math.max.apply(Math, months);
                        var peakMonth = (_d = Object.entries(monthlyData).find(function (_a) {
                            var value = _a[1];
                        ...
                        if (maxConsumption > avgConsumption * 1.5) {
                            var itemData = (_e = consumptionData.find(function (t) { return t.item_id === itemId; })) === null || _e === void 0 ? void 0 : _e.inventory_items;
                            seasonalRecommendations.push({
                                ...
                                recommendation: "Consider increasing stock before month ".concat(peakMonth ? parseInt(peakMonth) + 1 : 'N/A', " due to ").concat(Math.round(((maxConsumption / avgConsumption) - 1) * 100), "% higher consumption"),
                    ...
                    return [2 /*return*/, seasonalRecommendations.sort(function (a, b) { return b.seasonality_factor - a.seasonality_factor; })];
                case 2:
                    error_3 = _f.sent();
