                ...
                case 3:
                    ...
                    transformedOrder = {
                        ...
                        supplier: {
                            ...
                            email: (_f = purchaseOrder.suppliers) === null || _f === void 0 ? void 0 : _f.contact_email,
                            phone: (_g = purchaseOrder.suppliers) === null || _g === void 0 ? void 0 : _g.contact_phone,
                            payment_terms: (_h = purchaseOrder.suppliers) === null || _h === void 0 ? void 0 : _h.payment_terms
                        },
                        clinic: {
                        ...
                        items: ((_o = purchaseOrder.purchase_order_items) === null || _o === void 0 ? void 0 : _o.map(function (item) {
                            var _a, _b, _c, _d;
                            return ({
                                id: item.id,
                                ...
                                category: (_d = item.inventory_items) === null || _d === void 0 ? void 0 : _d.category,
...
function PATCH(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, user, body, validatedData, _c, existingPO, fetchError, validTransitions, allowedStatuses, updateData, _d, updatedPO, updateError, template, _e, fullPO, fullPOError, purchaseOrderData, error_2;
        var params = _b.params;
        return __generator(this, function (_f) {
            switch (_f.label) {
                    ...
                    if (validatedData.status && existingPO.status !== validatedData.status) {
                        ...
                        if (!allowedStatuses.includes(validatedData.status)) {
                            return [2 /*return*/, server_2.NextResponse.json({
                                    error: "Cannot change status from ".concat(existingPO.status, " to ").concat(validatedData.status)
                                }, { status: 400 })];
                        }
                    }
                    updateData = {};
                ...
                case 5:
                    ...
                    template = null;
                    if (!(validatedData.template_type && (updatedPO.status === 'approved' || updatedPO.status === 'sent'))) return [3 /*break*/, 8];
                    return [4 /*yield*/, supabase
                            .from('purchase_orders')
                ...
                case 6:
                    ...
                    purchaseOrderData = {
                        ...
                        items: fullPO.purchase_order_items.map(function (item) { return ({
                            item_id: item.item_id,
                    ...
                    return [4 /*yield*/, purchase_order_service_1.purchaseOrderService.generatePOTemplate(purchaseOrderData, validatedData.template_type)];
                case 7:
                    template = _f.sent();
                    _f.label = 8;
...
function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, user, _c, existingPO, fetchError, cancelableStatuses, _d, cancelledPO, cancelError, error_3;
        var params = _b.params;
            ...
            switch (_e.label) {
                ...
                case 4:
                    ...
                    if (cancelError) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to cancel purchase order' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({
