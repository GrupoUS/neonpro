    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          transformedOrders =
            (purchaseOrders === null || purchaseOrders === void 0
              ? void 0
              : purchaseOrders.map(function (order) {
                  var _a, _b, _c, _d, _e;
                  return {
                    id: order.id,
                    ...
                    supplier: {
                      ...
                      email:
                        (_c = order.suppliers) === null || _c === void 0
                          ? void 0
                          : _c.contact_email,
                      phone:
                        (_d = order.suppliers) === null || _d === void 0
                          ? void 0
                          : _d.contact_phone,
                    },
                    ...
                    items:
                      ((_e = order.purchase_order_items) === null || _e === void 0
                        ? void 0
                        : _e.map(function (item) {
                            ...
                            return {
                              ...
                              item_name:
                                (_a = item.inventory_items) === null || _a === void 0
                                  ? void 0
                                  : _a.name,
                              sku:
                                (_b = item.inventory_items) === null || _b === void 0
                                  ? void 0
                                  : _b.sku,
                              unit:
                                (_c = item.inventory_items) === null || _c === void 0
                                  ? void 0
                                  : _c.unit,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            purchase_order_service_1.purchaseOrderService.generatePurchaseOrder(
          ...
          return [
            ...
            supabase
              ...
              .insert({
                ...
                notes: "Auto-generated purchase order with ".concat(
                  validatedData.auto_optimize ? "EOQ optimization" : "standard quantities",
                ),
              })
              .select()
              .single(),
        ...
        case 5:
          ...
          itemsToInsert = purchaseOrder_1.items.map(function (item) {
            return {
          ...
          return [4 /*yield*/, supabase.from("purchase_order_items").insert(itemsToInsert)];
        case 6:
        ...
        case 8:
          return [
            ...
            server_2.NextResponse.json(
              {
                purchase_order: __assign(__assign({}, purchaseOrder_1), {
                  created_at: purchaseOrder_1.created_at.toISOString(),
                  expected_delivery_date: purchaseOrder_1.expected_delivery_date.toISOString(),
                }),
                template: template,
