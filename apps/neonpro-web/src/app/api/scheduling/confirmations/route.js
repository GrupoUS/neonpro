...
var ConfirmationRequestSchema = zod_1.z.object({
    ...
    sendTime: zod_1.z.string().regex(/^\d{2}:\d{2}$/).optional().default('09:00'), // HH:MM format
...
var BulkConfirmationSchema = zod_1.z.object({
    ...
    sendTime: zod_1.z.string().regex(/^\d{2}:\d{2}$/).default('09:00'),
    timeoutHours: zod_1.z.number().min(1).max(72).default(24),
    channels: zod_1.z.array(zod_1.z.enum(['sms', 'email', 'whatsapp'])).default(['whatsapp']),
    useWorkflow: zod_1.z.boolean().default(true)
});
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, validatedData, _b, appointment, appointmentError, existingConfirmation, workflowConfig, workflow, workflows, confirmationWorkflow, workflowError_1, error_1;
            ...
            switch (_c.label) {
                ...
                case 4:
                    ...
                    if (appointmentError || !appointment) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Appointment not found' }, { status: 404 })];
                    }
                    return [4 /*yield*/, supabase
                ...
                case 6:
                    ...
                    return [4 /*yield*/, workflow.initializeWorkflows(validatedData.appointmentId, workflowConfig)];
                case 7:
                    workflows = _c.sent();
                    confirmationWorkflow = workflows.find(function (w) { return w.workflowType === 'confirmation'; });
                ...
                case 8:
                    ...
                    return [3 /*break*/, 9];
                case 9: return [4 /*yield*/, handleLegacyConfirmation(supabase, validatedData, appointment, user)];
                case 10: 
                ...
                case 11:
                    ...
                    if (error_1 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid request data', details: error_1.errors }, { status: 400 })];
                    }
...
function handleLegacyConfirmation(supabase, data, appointment, user) {
    return __awaiter(this, void 0, void 0, function () {
        var confirmationToken, appointmentDate, _a, hours, minutes, sendAt, expiresAt, noShowPrediction, predictor, error_2, _b, confirmationRecord, insertError;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, body, validatedData, _a, confirmation, confirmationError, updateData, updateError, appointmentStatus, communicationService, notificationMessage, error_3;
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (confirmationError || !confirmation) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid confirmation token' }, { status: 404 })];
                    }
                    // Check if confirmation has expired
                    if (new Date() > new Date(confirmation.expires_at)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Confirmation request has expired' }, { status: 410 })];
                    }
                ...
                case 4:
                    ...
                    if (updateError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update confirmation' }, { status: 500 })];
                    }
                ...
                case 6:
                    ...
                    try {
                        ...
                        switch (validatedData.response) {
                            case 'confirmed':
                                notificationMessage = "\u2705 Consulta confirmada: ".concat(confirmation.patients.name, " - ").concat(new Date(confirmation.appointments.date).toLocaleDateString('pt-BR'));
                                break;
                            case 'cancelled':
                                notificationMessage = "\u274C Consulta cancelada: ".concat(confirmation.patients.name, " - ").concat(new Date(confirmation.appointments.date).toLocaleDateString('pt-BR'));
                                break;
                            case 'reschedule':
                                notificationMessage = "\uD83D\uDD04 Reagendamento solicitado: ".concat(confirmation.patients.name, " - ").concat(new Date(confirmation.appointments.date).toLocaleDateString('pt-BR'));
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, appointmentId, clinicId, status_1, date, confirmationToken, _b, confirmation, tokenError, isExpired, query, startOfDay, endOfDay, _c, confirmations, queryError, confirmationsWithStatus, error_4;
            ...
            switch (_d.label) {
                ...
                case 5:
                    ...
                    if (queryError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch confirmations' }, { status: 500 })];
                    }
                    confirmationsWithStatus = (confirmations === null || confirmations === void 0 ? void 0 : confirmations.map(function (conf) { return (__assign(__assign({}, conf), { expired: new Date() > new Date(conf.expires_at), timeRemaining: Math.max(0, new Date(conf.expires_at).getTime() - Date.now()) })); })) || [];
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            confirmations: confirmationsWithStatus,
                            count: confirmationsWithStatus.length,
                            summary: {
                                pending: confirmationsWithStatus.filter(function (c) { return c.status === 'pending' && !c.expired; }).length,
                                confirmed: confirmationsWithStatus.filter(function (c) { return c.status === 'confirmed'; }).length,
                                cancelled: confirmationsWithStatus.filter(function (c) { return c.status === 'cancelled'; }).length,
                                reschedule: confirmationsWithStatus.filter(function (c) { return c.status === 'reschedule'; }).length,
                                expired: confirmationsWithStatus.filter(function (c) { return c.expired; }).length
                            }
                        })];
                case 6:
                    error_4 = _d.sent();
...
function DELETE(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, confirmationId, appointmentId, query, _b, updated, updateError, error_5;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 4, , 5]);
                ...
                case 2:
                    ...
                    if (!confirmationId && !appointmentId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Either confirmationId or appointmentId required' }, { status: 400 })];
                    }
                    query = supabase
                        .from('appointment_confirmations')
                        .update({
                ...
                case 3:
                    ...
                    if (updateError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to expire confirmations' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            expired: (updated === null || updated === void 0 ? void 0 : updated.length) || 0,
                            message: "Expired ".concat((updated === null || updated === void 0 ? void 0 : updated.length) || 0, " confirmation(s)")
                        })];
                case 4:
                    error_5 = _c.sent();
