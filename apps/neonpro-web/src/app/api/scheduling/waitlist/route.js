    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 6:
          ...
          return [
            ...
            auditLogger.logActivity(
              "waitlist_added",
              "Patient ".concat(body.patientId, " added to waitlist"),
              {
        ...
        case 8:
          ...
          return [
            4 /*yield*/,
            waitlistService.processWaitlistForSlot(
        ...
        case 9:
          ...
          return [
            4 /*yield*/,
            auditLogger.logActivity("waitlist_processed", "Waitlist processed for available slot", {
              userId: session.user.id,
        ...
        case 11:
          ...
          return [
            4 /*yield*/,
            waitlistService.sendWaitlistNotifications(body.waitlistEntryId, body.availableSlots),
          ];
        case 12:
          result = _c.sent();
          return [
            ...
            auditLogger.logActivity(
              ...
              "Notification sent to waitlist entry ".concat(body.waitlistEntryId),
              {
                userId: session.user.id,
      ...
      switch (_c.label) {
        ...
        case 4:
          ...
          return [
            ...
            auditLogger.logActivity(
              "waitlist_retrieved",
              "Retrieved ".concat(waitlistEntries.length, " waitlist entries"),
              {
                userId: session.user.id,
