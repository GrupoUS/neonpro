...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, supabase, _a, user, authError, tenantId, body, validatedData, conflictIds, resolutionType, metadata, totalConflicts, _b, resolutionResult, resolutionError, processingTime, apiCallsReduced, batchEfficiency, error_1, processingTime;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    conflictIds = validatedData.conflictIds, resolutionType = validatedData.resolutionType, metadata = validatedData.metadata;
                    totalConflicts = conflictIds.length;
                    // LGPD compliance validation
                    if (!metadata.lgpdCompliant) {
                        return [2 /*return*/, server_1.NextResponse.json({
                                success: false,
                                performance: { totalConflicts: totalConflicts, processingTime: 0, apiCallsReduced: 0, batchEfficiency: '0%' },
                ...
                case 4:
                    ...
                    batchEfficiency = totalConflicts > 1
                    ...
                    return [4 /*yield*/, supabase.from('audit_logs').insert({
                            ...
                            metadata: {
                                ...
                                resolvedCount: (resolutionResult === null || resolutionResult === void 0 ? void 0 : resolutionResult.resolved_count) || 0,
                                lgpdCompliant: true,
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            data: {
                                resolvedCount: (resolutionResult === null || resolutionResult === void 0 ? void 0 : resolutionResult.resolved_count) || 0,
                                rescheduled: (resolutionResult === null || resolutionResult === void 0 ? void 0 : resolutionResult.rescheduled_count) || 0,
                                cancelled: (resolutionResult === null || resolutionResult === void 0 ? void 0 : resolutionResult.cancelled_count) || 0,
                                errors: (resolutionResult === null || resolutionResult === void 0 ? void 0 : resolutionResult.errors) || []
                            },
                            performance: {
                                totalConflicts: totalConflicts,
                                processingTime: processingTime,
                ...
                case 6:
                    ...
                    if (error_1 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_1.NextResponse.json({
                                success: false,
                                performance: { totalConflicts: 0, processingTime: processingTime, apiCallsReduced: 0, batchEfficiency: '0%' },
