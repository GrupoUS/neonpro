...
var ReminderConfigSchema = zod_1.z.object({
    ...
    patientPreferences: zod_1.z.object({
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, validatedData_1, validatedData, workflowConfig, workflow, workflows, reminderWorkflows, workflowError_1, error_1;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 6:
                    ...
                    workflowConfig = {
                        reminderSettings: {
                            ...
                            preferredChannel: ((_b = validatedData.patientPreferences) === null || _b === void 0 ? void 0 : _b.preferredChannel) || validatedData.channels[0]
                        }
                    };
                ...
                case 7:
                    workflows = _c.sent();
                    reminderWorkflows = workflows.filter(function (w) { return w.workflowType === 'reminder'; });
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            method: 'workflow',
                            workflows: reminderWorkflows.map(function (w) { return ({
                                id: w.id,
                ...
                case 8:
                    ...
                    return [3 /*break*/, 9];
                case 9: return [4 /*yield*/, handleLegacyReminders(supabase, validatedData, user)];
                case 10: 
...
function handleImmediateReminder(supabase, data, user) {
    return __awaiter(this, void 0, void 0, function () {
        var communicationService, _a, appointment, appointmentError, recentReminder, channel, message, template, variables, result;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (recentReminder) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Immediate reminder already sent recently' }, { status: 409 })];
                    }
                    _b.label = 3;
                case 3:
                    ...
                    template = scheduling_templates_1.schedulingTemplateEngine.selectBestTemplate('reminder', appointment, appointment.patients, null);
                ...
                case 5:
                    if (!message) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'No message content available' }, { status: 400 })];
                    }
                    return [4 /*yield*/, communicationService.sendMessage({
...
function handleLegacyReminders(supabase, data, user) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, appointment, appointmentError, appointmentDate, reminders, _i, _b, reminderType, scheduledTime, _c, insertedReminders, insertError;
            ...
            switch (_d.label) {
                ...
                case 2:
                    ...
                    if (insertError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to schedule reminders' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            method: 'legacy',
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, appointmentId, clinicId, status_1, date, workflowId, workflowInstance, workflow, error_2, query, startOfDay, endOfDay, _b, reminders, queryError, workflows, workflowData, error_3, error_4;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 7:
                    ...
                    if (queryError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch reminders' }, { status: 500 })];
                    }
                    workflows = [];
                ...
                case 11: return [2 /*return*/, server_1.NextResponse.json({
                        ...
                        workflows: workflows,
                        count: {
                            reminders: (reminders === null || reminders === void 0 ? void 0 : reminders.length) || 0,
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, validatedData, startOfDay, endOfDay, _b, appointments, appointmentsError, results, successCount, errorCount, _i, appointments_1, appointment, workflowConfig, workflowInstance, workflows, reminderData, error_5, error_6;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 4:
                    ...
                    if (appointmentsError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch appointments' }, { status: 500 })];
                    }
                ...
                case 6:
                    ...
                    workflowInstance = new scheduling_workflow_1.SchedulingCommunicationWorkflow();
                    return [4 /*yield*/, workflowInstance.initializeWorkflows(appointment.id, workflowConfig)];
                case 7:
                    workflows = _c.sent();
                    results.push({
                ...
                case 13: return [2 /*return*/, server_1.NextResponse.json({
                        ...
                        failed: errorCount,
                        results: results,
                        message: "Processed ".concat(appointments.length, " appointments: ").concat(successCount, " successful, ").concat(errorCount, " failed")
                    })];
                case 14:
                    error_6 = _c.sent();
                    console.error('Error in PUT /api/scheduling/reminders:', error_6);
                    if (error_6 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid request data', details: error_6.errors }, { status: 400 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Internal server error' }, { status: 500 })];
