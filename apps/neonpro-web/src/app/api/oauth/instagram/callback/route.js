    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
          ...
          if (error) {
            ...
            return [
              ...
              server_1.NextResponse.redirect(
                new URL(
                  "/dashboard/social-media?error="
                    .concat(encodeURIComponent(error), "&error_description=")
                    .concat(encodeURIComponent(errorDescription || "")),
                  request.url,
                ),
              ),
            ];
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            instagramHandler.storeTokens(oauthState.userId, oauthState.clinicId, tokens, profile),
          ];
        case 5:
          accountId = _a.sent();
  ...
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, (_a) => {
      try {
        ...
        return [
          2 /*return*/,
          server_1.NextResponse.json({ message: "Webhook endpoint - implementation pending" }),
        ];
      } catch (error) {
