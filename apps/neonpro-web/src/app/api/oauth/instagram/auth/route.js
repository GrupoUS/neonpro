...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, user, searchParams, redirectTo, profile, state, instagramHandler, authUrl, error_1;
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!(profile === null || profile === void 0 ? void 0 : profile.clinic_id)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'User clinic context not found' }, { status: 400 })];
                    }
                    state = {
                        userId: user.id,
