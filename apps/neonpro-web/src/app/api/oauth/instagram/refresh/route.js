      ...
      switch (_b.label) {
        ...
        case 3:
          ...
          if (!accountId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Account ID is required" }, { status: 400 }),
            ];
          }
          return [
            4 /*yield*/,
        ...
        case 4:
          ...
          currentAccessToken =
            token_encryption_1.TokenEncryptionService.decryptToken(encryptedAccessToken);
        ...
        case 5:
          newTokens = _b.sent();
          newEncryptedAccessToken = token_encryption_1.TokenEncryptionService.encryptToken(
      ...
      switch (_b.label) {
        ...
        case 3:
          ...
          if (error || !account) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Instagram account not found" }, { status: 404 }),
            ];
          }
