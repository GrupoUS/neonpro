    ...
    return __generator(this, (_e) => {
      switch (_e.label) {
        ...
        case 4:
          ...
          return [3 /*break*/, 13];
        case 5:
          return [4 /*yield*/, instagramHandler.getUserProfile(accessToken)];
        case 6:
          profile = _e.sent();
          return [
            2 /*return*/,
        ...
        case 11:
          return [
            4 /*yield*/,
            instagramHandler.validateTokens({
      ...
      switch (_e.label) {
        ...
        case 4:
          (_c = _e.sent()),
            ...
            (autoPost = _c.autoPost),
            (notificationsEnabled = _c.notificationsEnabled);
          updateData = {};
