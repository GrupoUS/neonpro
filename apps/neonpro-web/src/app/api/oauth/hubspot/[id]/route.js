...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var requestId, id, connectionId, supabase, _c, session, sessionError, _d, connection, connectionError, tokenExpiresAt, now, isTokenExpired, minutesUntilExpiry, error_1;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    _e.trys.push([2, 6, , 7]);
                    logger_1.Logger.info('HubSpot connection details request initiated', {
                        requestId: requestId,
                        provider: 'hubspot',
                ...
                case 4:
                    ...
                    if (sessionError || !(session === null || session === void 0 ? void 0 : session.user)) {
                        logger_1.Logger.warn('HubSpot connection details request without valid session', {
                            requestId: requestId,
                            provider: 'hubspot',
                            connectionId: connectionId,
                ...
                case 5:
                    ...
                    if (connectionError || !connection) {
                        logger_1.Logger.error('HubSpot connection not found', {
                            requestId: requestId,
                            provider: 'hubspot',
                            connectionId: connectionId,
                            userId: session.user.id,
                            error: connectionError === null || connectionError === void 0 ? void 0 : connectionError.message
                        });
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'HubSpot connection not found' }, { status: 404 })];
                    }
                    ...
                    logger_1.Logger.info('HubSpot connection details retrieved successfully', {
                        requestId: requestId,
                        provider: 'hubspot',
                        connectionId: connectionId,
                        userId: session.user.id,
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            isTokenExpired: isTokenExpired,
                            minutesUntilExpiry: isTokenExpired ? 0 : Math.max(0, minutesUntilExpiry),
                            scopes: connection.scopes,
                            platformData: connection.platform_data
                        })];
                case 6:
                    error_1 = _e.sent();
                    logger_1.Logger.error('HubSpot connection details error', {
                        requestId: requestId,
                        provider: 'hubspot',
                        connectionId: connectionId,
...
function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var requestId, id, connectionId, supabase, _c, session, sessionError, _d, connection, connectionError, oauthHandler, revokeError_1, updateError, error_2;
        var params = _b.params;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                ...
                case 2:
                    ...
                    logger_1.Logger.info('HubSpot connection disconnection request initiated', {
                        requestId: requestId,
                        provider: 'hubspot',
                        connectionId: connectionId,
                        userAgent: request.headers.get('user-agent'),
                ...
                case 4:
                    _c = _e.sent(), session = _c.data.session, sessionError = _c.error;
                    if (sessionError || !(session === null || session === void 0 ? void 0 : session.user)) {
                        logger_1.Logger.warn('HubSpot disconnection request without valid session', {
                            requestId: requestId,
                            provider: 'hubspot',
                            connectionId: connectionId,
                            error: sessionError === null || sessionError === void 0 ? void 0 : sessionError.message
                ...
                case 5:
                    _d = _e.sent(), connection = _d.data, connectionError = _d.error;
                    if (connectionError || !connection) {
                        logger_1.Logger.error('HubSpot connection not found for disconnection', {
                            requestId: requestId,
                            provider: 'hubspot',
                            connectionId: connectionId,
                            userId: session.user.id,
                ...
                case 8:
                    ...
                    logger_1.Logger.warn('Failed to revoke HubSpot token, continuing with disconnection', {
                        requestId: requestId,
                        provider: 'hubspot',
                        connectionId: connectionId,
                ...
                case 10:
                    ...
                    if (updateError) {
                        logger_1.Logger.error('Failed to update HubSpot connection status', {
                            requestId: requestId,
                            provider: 'hubspot',
                            connectionId: connectionId,
                            error: updateError.message
                        });
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to disconnect HubSpot account' }, { status: 500 })];
                    }
                    // Log disconnection
                    return [4 /*yield*/, supabase
                ...
                case 11:
                    // Log disconnection
                    _e.sent();
                    logger_1.Logger.info('HubSpot disconnection successful', {
                        requestId: requestId,
                        provider: 'hubspot',
                        connectionId: connectionId,
                        userId: session.user.id
                ...
                case 12:
                    error_2 = _e.sent();
                    logger_1.Logger.error('HubSpot disconnection error', {
                        requestId: requestId,
                        provider: 'hubspot',
                        connectionId: connectionId,
