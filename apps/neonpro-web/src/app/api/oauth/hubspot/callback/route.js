...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var requestId, searchParams, code, state, error, errorDescription, supabase, _a, stateRecord, stateError, stateData, userId, _b, session, sessionError, oauthHandler, encryptedToken, userInfo, portalInfo, accountInfo, connectionData, _c, connection, connectionError, error_1;
        var _d, _e;
            ...
            switch (_f.label) {
                ...
                case 1:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL("/dashboard/settings/integrations?error=oauth_error&provider=hubspot&message=".concat(encodeURIComponent(errorDescription || error)), request.url))];
                    }
                    ...
                    if (!code || !state) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?error=invalid_callback&provider=hubspot', request.url))];
                    }
                ...
                case 3:
                    ...
                    if (stateError || !stateRecord) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?error=invalid_state&provider=hubspot', request.url))];
                    }
                    ...
                    if (new Date(stateRecord.expires_at) < new Date()) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?error=state_expired&provider=hubspot', request.url))];
                    }
                ...
                case 4:
                    ...
                    if (sessionError || !(session === null || session === void 0 ? void 0 : session.user) || session.user.id !== userId) {
                        logger_1.Logger.error('HubSpot OAuth session mismatch', {
                            requestId: requestId,
                            provider: 'hubspot',
                            expectedUserId: userId,
                            actualUserId: (_d = session === null || session === void 0 ? void 0 : session.user) === null || _d === void 0 ? void 0 : _d.id,
                            error: sessionError === null || sessionError === void 0 ? void 0 : sessionError.message
                        });
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?error=session_mismatch&provider=hubspot', request.url))];
                    }
                ...
                case 8:
                    ...
                    connectionData = {
                        ...
                        platform_user_id: ((_e = userInfo.user_id) === null || _e === void 0 ? void 0 : _e.toString()) || userInfo.user,
                ...
                case 9:
                    ...
                    if (connectionError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?error=save_failed&provider=hubspot', request.url))];
                    }
                ...
                case 11:
                    ...
                    return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?success=hubspot_connected', request.url))];
                case 12:
                    error_1 = _f.sent();
                    ...
                    return [2 /*return*/, server_1.NextResponse.redirect(new URL("/dashboard/settings/integrations?error=callback_failed&provider=hubspot&requestId=".concat(requestId), request.url))];
