...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var requestId, supabase, _a, session, sessionError, _b, connection, connectionError, tokenExpiresAt, now, timeUntilExpiry, hoursUntilExpiry, oauthHandler, newEncryptedToken, updateError, error_1;
            ...
            switch (_c.label) {
                ...
                case 4:
                    ...
                    if (connection.status !== 'connected') {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'WhatsApp account not connected' }, { status: 400 })];
                    }
