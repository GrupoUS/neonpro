...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var requestId, searchParams, code, state, error, errorDescription, supabase, _a, stateRecord, stateError, stateData, userId, _b, session, sessionError, oauthHandler, encryptedToken, userInfo, businessAccounts, connectionData, _c, connection, connectionError, error_1;
        var _d;
            ...
            switch (_e.label) {
                ...
                case 1:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL("/dashboard/settings/integrations?error=oauth_error&provider=whatsapp&message=".concat(encodeURIComponent(errorDescription || error)), request.url))];
                    }
                    ...
                    if (!code || !state) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?error=invalid_callback&provider=whatsapp', request.url))];
                    }
                ...
                case 3:
                    ...
                    if (stateError || !stateRecord) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?error=invalid_state&provider=whatsapp', request.url))];
                    }
                    ...
                    if (new Date(stateRecord.expires_at) < new Date()) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?error=state_expired&provider=whatsapp', request.url))];
                    }
                ...
                case 4:
                    ...
                    if (sessionError || !(session === null || session === void 0 ? void 0 : session.user) || session.user.id !== userId) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?error=session_mismatch&provider=whatsapp', request.url))];
                    }
                ...
                case 7:
                    ...
                    connectionData = {
                        ...
                        platform_data: {
                            userInfo: userInfo,
                            businessAccounts: businessAccounts.map(function (account) { return ({
                                id: account.id,
                                name: account.name,
                ...
                case 8:
                    ...
                    if (connectionError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?error=save_failed&provider=whatsapp', request.url))];
                    }
                ...
                case 10:
                    ...
                    return [2 /*return*/, server_1.NextResponse.redirect(new URL('/dashboard/settings/integrations?success=whatsapp_connected', request.url))];
                case 11:
                    error_1 = _e.sent();
                    ...
                    return [2 /*return*/, server_1.NextResponse.redirect(new URL("/dashboard/settings/integrations?error=callback_failed&provider=whatsapp&requestId=".concat(requestId), request.url))];
