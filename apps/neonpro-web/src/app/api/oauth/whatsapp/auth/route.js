  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          _b.trys.push([1, 8, , 9]);
          logger_1.Logger.info("WhatsApp OAuth authorization request initiated", {
            requestId: requestId,
            provider: "whatsapp",
        ...
        case 3:
          ...
          if (sessionError || !(session === null || session === void 0 ? void 0 : session.user)) {
            logger_1.Logger.warn("WhatsApp OAuth authorization attempted without valid session", {
              requestId: requestId,
              provider: "whatsapp",
              error:
        ...
        case 4:
          ...
          if (
            ...
            logger_1.Logger.info("WhatsApp account already connected", {
              requestId: requestId,
              provider: "whatsapp",
        ...
        case 5:
          ...
          if (stateError) {
            logger_1.Logger.error("Failed to store WhatsApp OAuth state", {
              requestId: requestId,
              provider: "whatsapp",
        ...
        case 7:
          // Log OAuth initiation
          _b.sent();
          logger_1.Logger.info("WhatsApp OAuth authorization URL generated successfully", {
            requestId: requestId,
            provider: "whatsapp",
            userId: session.user.id,
            state: state,
        ...
        case 8:
          error_1 = _b.sent();
          logger_1.Logger.error("WhatsApp OAuth authorization error", {
            requestId: requestId,
            provider: "whatsapp",
