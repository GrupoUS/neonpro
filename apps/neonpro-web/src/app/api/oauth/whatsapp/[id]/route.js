...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var requestId, id, connectionId, supabase, _c, session, sessionError, _d, connection, connectionError, tokenExpiresAt, now, isTokenExpired, hoursUntilExpiry, error_1;
            ...
            switch (_e.label) {
                ...
                case 5:
                    ...
                    if (connectionError || !connection) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'WhatsApp connection not found' }, { status: 404 })];
                    }
                    tokenExpiresAt = new Date(connection.token_expires_at);
                    now = new Date();
                    isTokenExpired = tokenExpiresAt < now;
                    hoursUntilExpiry = Math.round((tokenExpiresAt.getTime() - now.getTime()) / (1000 * 60 * 60));
            ...
            switch (_e.label) {
                ...
                case 10:
                    ...
                    if (updateError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to disconnect WhatsApp account' }, { status: 500 })];
                    }
                    // Log disconnection
                    return [4 /*yield*/, supabase
