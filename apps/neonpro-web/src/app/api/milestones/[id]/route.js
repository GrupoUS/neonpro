  ...
  return __awaiter(this, arguments, void 0, function (request, _b) {
    ...
    return __generator(this, (_e) => {
      switch (_e.label) {
        ...
        case 2:
          body = _e.sent();
          (_d = validateMilestoneSchema.parse(body)),
            (validation_status = _d.validation_status),
            (notes = _d.notes);
          return [
            4 /*yield*/,
            progress_tracking_1.progressTrackingService.validateMilestone(
              id,
              validation_status,
              notes,
            ),
        ...
        case 4:
          ...
          return [
            2 /*return*/,
            server_1.NextResponse.json({ error: "Failed to validate milestone" }, { status: 500 }),
          ];
        case 5:
          return [2 /*return*/];
      }
