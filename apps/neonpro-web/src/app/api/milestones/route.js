        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.createProgressMilestone(validatedData)];
                case 4:
                    milestone = _b.sent();
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create progress milestone' }, { status: 500 })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    filters = {
                        ...
                        min_achievement_score: searchParams.get('min_achievement_score') ?
                            parseFloat(searchParams.get('min_achievement_score')) : undefined,
                        page: searchParams.get('page') ? parseInt(searchParams.get('page')) : 1,
                        limit: searchParams.get('limit') ? parseInt(searchParams.get('limit')) : 20
                    };
                    validatedFilters = progress_tracking_2.progressMilestoneFiltersSchema.parse(filters);
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.getProgressMilestones(validatedFilters)];
                case 3:
                    result = _b.sent();
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch progress milestones' }, { status: 500 })];
