        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch scenarios' }, { status: 500 })];
                    }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create scenario' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({ scenario: scenario }, { status: 201 })];
                case 4:
                    error_2 = _b.sent();
