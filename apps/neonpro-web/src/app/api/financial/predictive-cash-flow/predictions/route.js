...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, searchParams, validation, _a, clinicId, periodType, startDate, endDate, scenarioId, _b, limit, _c, offset, query, _d, predictions, error, countQuery, count, error_1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    _a = validation.data, clinicId = _a.clinicId, periodType = _a.periodType, startDate = _a.startDate, endDate = _a.endDate, scenarioId = _a.scenarioId, _b = _a.limit, limit = _b === void 0 ? 50 : _b, _c = _a.offset, offset = _c === void 0 ? 0 : _c;
                    query = supabase
                ...
                case 1:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch predictions' }, { status: 500 })];
                    }
                    countQuery = supabase
                        .from('cash_flow_predictions')
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, body, validation, _a, clinicId, modelId, periodType, startDate, endDate, scenarioId, user, _b, clinic, clinicError, start, end, engine, _c, prediction, predictionError, _d, completePrediction, fetchError, error_2;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _e.trys.push([0, 7, , 8]);
                ...
                case 1:
                    ...
                    if (!validation.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid request body', details: validation.error.errors }, { status: 400 })];
                    }
                    _a = validation.data, clinicId = _a.clinicId, modelId = _a.modelId, periodType = _a.periodType, startDate = _a.startDate, endDate = _a.endDate, scenarioId = _a.scenarioId;
                ...
                case 3:
                    ...
                    if (clinicError || !clinic) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Clinic not found or access denied' }, { status: 404 })];
                    }
                    ...
                    if (end.getTime() - start.getTime() > 365 * 24 * 60 * 60 * 1000) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Date range cannot exceed 1 year' }, { status: 400 })];
                    }
                    engine = new predictive_analytics_engine_1.default(supabase);
                    return [4 /*yield*/, engine.generatePrediction(clinicId, periodType, startDate, endDate, scenarioId)];
                case 4:
                    _c = _e.sent(), prediction = _c.data, predictionError = _c.error;
                    if (predictionError || !prediction) {
                        console.error('Error generating prediction:', predictionError);
                        return [2 /*return*/, server_1.NextResponse.json({ error: predictionError || 'Failed to generate prediction' }, { status: 500 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('cash_flow_predictions')
                            .select("\n        *,\n        prediction_models!inner(name, model_type, algorithm_type, accuracy_rate),\n        forecasting_scenarios(name, description)\n      ")
                ...
                case 5:
                    ...
                    if (fetchError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ prediction: prediction }, // Return basic prediction if fetch fails
                            { status: 201 })];
                    }
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, body, validation, _a, predictionId, actualInflow, actualOutflow, actualNet, user, _b, prediction, predictionError, _c, clinic, clinicError, engine, _d, accuracy, validationError, error_3;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _e.trys.push([0, 7, , 8]);
                ...
                case 1:
                    ...
                    _a = validation.data, predictionId = _a.predictionId, actualInflow = _a.actualInflow, actualOutflow = _a.actualOutflow, actualNet = _a.actualNet;
                    return [4 /*yield*/, supabase.auth.getUser()];
                case 2:
                    user = (_e.sent()).data;
                    if (!user.user) {
                ...
                case 3:
                    ...
                    if (predictionError || !prediction) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Prediction not found' }, { status: 404 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('clinics')
                            .select('id')
                ...
                case 4:
                    ...
                    engine = new predictive_analytics_engine_1.default(supabase);
                    return [4 /*yield*/, engine.validatePrediction(predictionId, actualInflow, actualOutflow, actualNet)];
                case 5:
                    _d = _e.sent(), accuracy = _d.accuracy, validationError = _d.error;
                    if (validationError) {
                        console.error('Error validating prediction:', validationError);
                        return [2 /*return*/, server_1.NextResponse.json({ error: validationError }, { status: 500 })];
                    }
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            metadata: {
                                ...
                                actual_values: { actualInflow: actualInflow, actualOutflow: actualOutflow, actualNet: actualNet },
                                predicted_values: {
...
function DELETE(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, searchParams, predictionId, user, _a, prediction, predictionError, _b, clinic, clinicError, deleteError, error_4;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (!predictionId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Prediction ID is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase.auth.getUser()];
                case 1:
                    user = (_c.sent()).data;
                ...
                case 4:
                    ...
                    if (deleteError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to delete prediction' }, { status: 500 })];
                    }
                    // Log deletion event
                    return [4 /*yield*/, supabase
                            .from('analytics_events')
                ...
                case 6:
                    error_4 = _c.sent();
                    console.error('Error in DELETE /api/financial/predictive-cash-flow/predictions:', error_4);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Internal server error' }, { status: 500 })];
