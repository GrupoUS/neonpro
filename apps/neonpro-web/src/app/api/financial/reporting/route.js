        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    _b = action;
                    switch (_b) {
                        case 'dashboard': return [3 /*break*/, 3];
                        case 'kpis': return [3 /*break*/, 5];
                        case 'reports': return [3 /*break*/, 7];
                        case 'generate-report': return [3 /*break*/, 9];
                        case 'performance': return [3 /*break*/, 11];
                    }
                    return [3 /*break*/, 13];
                case 3: return [4 /*yield*/, handleDashboardRequest(clinicId)];
                case 4: return [2 /*return*/, _c.sent()];
                case 5: return [4 /*yield*/, handleKPIRequest(clinicId, searchParams)];
                case 6: return [2 /*return*/, _c.sent()];
                case 7: return [4 /*yield*/, handleReportsListRequest(clinicId, searchParams)];
                case 8: return [2 /*return*/, _c.sent()];
                case 9: return [4 /*yield*/, handleReportGenerationRequest(clinicId, reportType, searchParams)];
                case 10: return [2 /*return*/, _c.sent()];
                case 11: return [4 /*yield*/, handlePerformanceRequest(clinicId, searchParams)];
                case 12: return [2 /*return*/, _c.sent()];
                case 13: return [2 /*return*/, server_1.NextResponse.json({ error: "A\u00E7\u00E3o '".concat(action, "' n\u00E3o reconhecida") }, { status: 400 })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    body = _c.sent();
                    action = body.action, clinic_id = body.clinic_id, parameters = body.parameters, options = body.options;
                    if (!clinic_id) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'clinic_id é obrigatório' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase.auth.getUser()];
                case 3:
                    ...
                    _b = action;
                    switch (_b) {
                        case 'generate-profit-loss': return [3 /*break*/, 4];
                        case 'generate-balance-sheet': return [3 /*break*/, 6];
                        case 'generate-cash-flow': return [3 /*break*/, 8];
                        case 'export-report': return [3 /*break*/, 10];
                        case 'schedule-report': return [3 /*break*/, 12];
                    }
                    return [3 /*break*/, 14];
                case 4: return [4 /*yield*/, handleProfitLossGeneration(clinic_id, parameters)];
                case 5: return [2 /*return*/, _c.sent()];
                case 6: return [4 /*yield*/, handleBalanceSheetGeneration(clinic_id, parameters)];
                case 7: return [2 /*return*/, _c.sent()];
                case 8: return [4 /*yield*/, handleCashFlowGeneration(clinic_id, parameters)];
                case 9: return [2 /*return*/, _c.sent()];
                case 10: return [4 /*yield*/, handleReportExport(clinic_id, parameters, options)];
                case 11: return [2 /*return*/, _c.sent()];
                case 12: return [4 /*yield*/, handleReportScheduling(clinic_id, parameters, options)];
                case 13: return [2 /*return*/, _c.sent()];
                case 14: return [2 /*return*/, server_1.NextResponse.json({ error: "A\u00E7\u00E3o '".concat(action, "' n\u00E3o reconhecida") }, { status: 400 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao gerar dados do dashboard' }, { status: 500 })];
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!validation.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Parâmetros inválidos', details: validation.error.errors }, { status: 400 })];
                    }
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao calcular KPIs' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar relatórios' }, { status: 500 })];
                case 3: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!reportType || !Object.values(financial_reporting_2.REPORT_TYPES).includes(reportType)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Tipo de relatório inválido' }, { status: 400 })];
                    }
                    periodStart = searchParams.get('period_start');
                    periodEnd = searchParams.get('period_end');
                    if (!periodStart || !periodEnd) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'period_start e period_end são obrigatórios' }, { status: 400 })];
                    }
                    parameters = { period_start: periodStart, period_end: periodEnd };
                    validation = financial_reporting_1.reportParametersSchema.safeParse(parameters);
                    if (!validation.success) {
                    ...
                    _a = reportType;
                    switch (_a) {
                        case financial_reporting_2.REPORT_TYPES.PROFIT_LOSS: return [3 /*break*/, 1];
                        case financial_reporting_2.REPORT_TYPES.BALANCE_SHEET: return [3 /*break*/, 3];
                        case financial_reporting_2.REPORT_TYPES.CASH_FLOW: return [3 /*break*/, 5];
                    }
                    return [3 /*break*/, 7];
                case 1: return [4 /*yield*/, reportingEngine.generateProfitLossStatement(clinicId, parameters)];
                case 2:
                    reportData = _b.sent();
                    return [3 /*break*/, 8];
                case 3: return [4 /*yield*/, reportingEngine.generateBalanceSheet(clinicId, periodEnd)];
                case 4:
                    reportData = _b.sent();
                    return [3 /*break*/, 8];
                case 5: return [4 /*yield*/, reportingEngine.generateCashFlowStatement(clinicId, parameters)];
                case 6:
                    reportData = _b.sent();
                    return [3 /*break*/, 8];
                case 7: return [2 /*return*/, server_1.NextResponse.json({ error: 'Tipo de relatório não implementado' }, { status: 400 })];
                case 8: return [4 /*yield*/, reportingEngine.saveFinancialReport({
                        clinic_id: clinicId,
                ...
                case 10:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao gerar relatório' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao calcular métricas de performance' }, { status: 500 })];
                case 3: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, reportingEngine.generateProfitLossStatement(clinicId, validation.data)];
                case 1:
                    profitLoss = _a.sent();
                    return [4 /*yield*/, reportingEngine.saveFinancialReport({
                            clinic_id: clinicId,
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao gerar DRE' }, { status: 500 })];
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!parameters.as_of_date) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'as_of_date é obrigatório para balanço patrimonial' }, { status: 400 })];
                    }
                    return [4 /*yield*/, reportingEngine.generateBalanceSheet(clinicId, parameters.as_of_date)];
                case 1:
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao gerar balanço patrimonial' }, { status: 500 })];
                case 4: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, reportingEngine.generateCashFlowStatement(clinicId, validation.data)];
                case 1:
                    cashFlow = _a.sent();
                    return [4 /*yield*/, reportingEngine.saveFinancialReport({
                            clinic_id: clinicId,
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao gerar fluxo de caixa' }, { status: 500 })];
                case 4: return [2 /*return*/];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
                ...
                return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao exportar relatório' }, { status: 500 })];
            }
            return [2 /*return*/];
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
                ...
                return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao agendar relatório' }, { status: 500 })];
            }
            return [2 /*return*/];
        });
    });
