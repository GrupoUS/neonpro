...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, params_1, _b, clinic, clinicError, _c, appointments, appointmentsError, _d, materialTemplates_1, templatesError, materialPredictions_1, dailyPredictions_1, productIds, _e, currentStock, stockError, stockMap_1, recommendations_1, alerts_1, dailyBreakdown, error_1;
            ...
            switch (_f.label) {
                ...
                case 4:
                    ...
                    if (appointmentsError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar agendamentos' }, { status: 500 })];
                    }
                    return [4 /*yield*/, supabase
                ...
                case 5:
                    ...
                    if (templatesError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar templates de materiais' }, { status: 500 })];
                    }
                    ...
                    appointments === null || appointments === void 0 ? void 0 : appointments.forEach(function (appointment) {
                        ...
                        var requiredMaterials = (materialTemplates_1 === null || materialTemplates_1 === void 0 ? void 0 : materialTemplates_1.filter(function (template) { return template.procedure_type === procedureType; })) || [];
                        requiredMaterials.forEach(function (material) {
                            var _a, _b;
                            var productId = material.product_id;
                            var quantity = material.estimated_quantity || 1;
                            var productName = ((_a = material.products) === null || _a === void 0 ? void 0 : _a.name) || 'Material desconhecido';
                            var unitCost = ((_b = material.products) === null || _b === void 0 ? void 0 : _b.unit_cost) || 0;
                ...
                case 6:
                    ...
                    if (stockError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar estoque atual' }, { status: 500 })];
                    }
                    stockMap_1 = new Map();
                    currentStock === null || currentStock === void 0 ? void 0 : currentStock.forEach(function (stock) {
                    ...
                    Array.from(materialPredictions_1.values()).forEach(function (prediction) {
                        ...
                        var availableQuantity = (currentStockItem === null || currentStockItem === void 0 ? void 0 : currentStockItem.quantity_available) || 0;
                        var minStockLevel = (currentStockItem === null || currentStockItem === void 0 ? void 0 : currentStockItem.min_stock_level) || 0;
                        ...
                        if (stockAfterConsumption < minStockLevel) {
                            ...
                            recommendations_1.push({
                                ...
                                message: stockAfterConsumption < 0
                                    ? "Falta cr\u00EDtica: ".concat(prediction.productName, " ter\u00E1 d\u00E9ficit de ").concat(Math.abs(stockAfterConsumption), " unidades")
                                    : "Reposi\u00E7\u00E3o necess\u00E1ria: ".concat(prediction.productName, " ficar\u00E1 abaixo do estoque m\u00EDnimo"),
                            ...
                            alerts_1.push({
                                ...
                                productId: prediction.productId,
                                message: "".concat(prediction.productName, ": estoque insuficiente para agendamentos"),
                                impact: "".concat(prediction.procedures, " procedimentos afetados")
                            });
                        }
                    });
                    dailyBreakdown = Array.from(dailyPredictions_1.values())
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            data: {
                                ...
                                summary: {
                                    ...
                                    totalEstimatedCost: Array.from(materialPredictions_1.values())
                                        .reduce(function (sum, pred) { return sum + (pred.totalQuantity * pred.unitCost); }, 0),
