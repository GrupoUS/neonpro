...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, params, _b, clinic, clinicError, _c, stockMovements, movementsError, _d, currentInventory, inventoryError, _e, budgetData, budgetError, financialMetrics_1, currentInventoryValue, categoryBreakdown_1, totalInvestment, totalReturns, wastePercentage, turnoverRate, budgetComparison, totalBudget, totalSpent, projections, daysInPeriod, dailyConsumption, dailyWaste, error_1;
            ...
            switch (_f.label) {
                ...
                case 4:
                    ...
                    if (movementsError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar movimentações de estoque' }, { status: 500 })];
                    }
                    return [4 /*yield*/, supabase
                ...
                case 5:
                    ...
                    if (inventoryError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar inventário atual' }, { status: 500 })];
                    }
                    return [4 /*yield*/, supabase
                ...
                case 6:
                    ...
                    stockMovements === null || stockMovements === void 0 ? void 0 : stockMovements.forEach(function (movement) {
                        var cost = movement.total_cost || (movement.unit_cost * (movement.quantity_in || movement.quantity_out || 0));
                        switch (movement.movement_type) {
                            ...
                            case 'adjustment':
                                ...
                                financialMetrics_1.adjustments.totalQuantity += Math.abs(movement.quantity_in || movement.quantity_out || 0);
                                financialMetrics_1.adjustments.transactions++;
                                break;
                        }
                    });
                    // Calculate averages
                    Object.keys(financialMetrics_1).forEach(function (key) {
                        var metric = financialMetrics_1[key];
                        if (metric.totalQuantity > 0) {
                            metric.averageUnitCost = metric.totalCost / metric.totalQuantity;
                        }
                    });
                    currentInventoryValue = (currentInventory === null || currentInventory === void 0 ? void 0 : currentInventory.reduce(function (sum, item) {
                        return sum + (item.quantity_available * item.unit_cost);
                    }, 0)) || 0;
                    categoryBreakdown_1 = new Map();
                    stockMovements === null || stockMovements === void 0 ? void 0 : stockMovements.forEach(function (movement) {
                        var _a, _b;
                        var category = ((_b = (_a = movement.products) === null || _a === void 0 ? void 0 : _a.product_categories) === null || _b === void 0 ? void 0 : _b.name) || 'Sem categoria';
                        var cost = movement.total_cost || (movement.unit_cost * (movement.quantity_in || movement.quantity_out || 0));
                    ...
                    ;
                    wastePercentage = totalInvestment > 0 ? (financialMetrics_1.waste.totalCost / totalInvestment) * 100 : 0;
                    turnoverRate = currentInventoryValue > 0 ? financialMetrics_1.consumption.totalCost / currentInventoryValue : 0;
                    budgetComparison = null;
                    if (params.includeBudgetComparison && budgetData && budgetData.length > 0) {
                        totalBudget = budgetData.reduce(function (sum, budget) { return sum + budget.allocated_amount; }, 0);
                    ...
                    if (params.includeProjections) {
                        daysInPeriod = Math.ceil((new Date(params.endDate).getTime() - new Date(params.startDate).getTime()) / (1000 * 60 * 60 * 24));
                        ...
                        projections = {
                            ...
                            recommendations: [
                                ...
                                {
                                    type: 'budget',
                                    message: (budgetComparison === null || budgetComparison === void 0 ? void 0 : budgetComparison.status) === 'over_budget' ? 'Orçamento excedido - revisar gastos' : 'Orçamento sob controle',
                                    priority: (budgetComparison === null || budgetComparison === void 0 ? void 0 : budgetComparison.status) === 'over_budget' ? 'critical' : 'low'
                                }
                            ]
                        };
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            data: {
                                ...
                                summary: {
                                    ...
                                    netCashFlow: totalInvestment - financialMetrics_1.consumption.totalCost - financialMetrics_1.waste.totalCost
                                },
