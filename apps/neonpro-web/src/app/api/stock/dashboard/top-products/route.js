...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, searchParams, params, startDate, endDate, days, _b, clinic, clinicError, _c, topProductsData, topProductsError, productMap_1, topProducts, totalConsumption_1, totalValue_1, productsWithPercentages, error_1;
            ...
            switch (_d.label) {
                ...
                case 3:
                    ...
                    if (topProductsError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar produtos mais consumidos' }, { status: 500 })];
                    }
                    productMap_1 = new Map();
                    topProductsData === null || topProductsData === void 0 ? void 0 : topProductsData.forEach(function (transaction) {
                        var _a, _b, _c;
                        ...
                        if (productMap_1.has(productId)) {
                            ...
                            productMap_1.set(productId, {
                                id: productId,
                                name: ((_a = transaction.products) === null || _a === void 0 ? void 0 : _a.name) || 'Produto sem nome',
                                category: ((_c = (_b = transaction.products) === null || _b === void 0 ? void 0 : _b.product_categories) === null || _c === void 0 ? void 0 : _c.name) || 'Sem categoria',
                    ...
                    topProducts = Array.from(productMap_1.values())
                        ...
                        .map(function (product, index) { return (__assign(__assign({}, product), { rank: index + 1, 
                        // Add trend calculation based on ranking (simplified)
                        trend: index < 3 ? 'up' : index > 7 ? 'down' : 'stable' })); });
                    totalConsumption_1 = topProducts.reduce(function (sum, product) { return sum + product.consumption; }, 0);
                    totalValue_1 = topProducts.reduce(function (sum, product) { return sum + product.value; }, 0);
                    productsWithPercentages = topProducts.map(function (product) { return (__assign(__assign({}, product), { consumptionPercentage: totalConsumption_1 > 0 ? (product.consumption / totalConsumption_1) * 100 : 0, valuePercentage: totalValue_1 > 0 ? (product.value / totalValue_1) * 100 : 0 })); });
