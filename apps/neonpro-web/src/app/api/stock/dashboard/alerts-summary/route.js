...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, searchParams, params, startDate_1, endDate_1, days, _b, clinic, clinicError, _c, alertsData, alertsError, _d, historicalAlertsData, historicalError, alertsByType_1, alertTypes, previousPeriodStart, previousPeriodEnd, currentPeriodCounts_1, previousPeriodCounts_1, previousPeriodData, alertsSummary, totalActiveAlerts, criticalAlerts, highAlerts, error_1;
            ...
            switch (_e.label) {
                ...
                case 3:
                    ...
                    if (alertsError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar alertas' }, { status: 500 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('stock_alerts')
                ...
                case 4:
                    ...
                    if (historicalError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar histórico de alertas' }, { status: 500 })];
                    }
                    ...
                    alertsData === null || alertsData === void 0 ? void 0 : alertsData.forEach(function (alert) {
                    ...
                    previousPeriodStart = new Date(startDate_1.getTime() - (endDate_1.getTime() - startDate_1.getTime()));
                    ...
                    historicalAlertsData === null || historicalAlertsData === void 0 ? void 0 : historicalAlertsData.forEach(function (alert) {
                ...
                case 5:
                    ...
                    previousPeriodData === null || previousPeriodData === void 0 ? void 0 : previousPeriodData.forEach(function (alert) {
                    ...
                    totalActiveAlerts = (alertsData === null || alertsData === void 0 ? void 0 : alertsData.length) || 0;
                    criticalAlerts = (alertsData === null || alertsData === void 0 ? void 0 : alertsData.filter(function (alert) { return alert.severity_level === 'critical'; }).length) || 0;
                    highAlerts = (alertsData === null || alertsData === void 0 ? void 0 : alertsData.filter(function (alert) { return alert.severity_level === 'high'; }).length) || 0;
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            metadata: {
                                ...
                                totalHistoricalAlerts: (historicalAlertsData === null || historicalAlertsData === void 0 ? void 0 : historicalAlertsData.length) || 0
                            }
                        })];
                case 6:
                    error_1 = _e.sent();
