...
function getClinicIdFromSession() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/supabase/server'); })];
                case 1:
                ...
                case 3:
                    ...
                    if (sessionError || !session) {
                        throw new stock_1.StockAlertError('Authentication required', 'UNAUTHORIZED', { sessionError: sessionError === null || sessionError === void 0 ? void 0 : sessionError.message });
                    }
                ...
                case 4:
                    ...
                    if (profileError || !(profile === null || profile === void 0 ? void 0 : profile.clinic_id)) {
                        throw new stock_1.StockAlertError('User profile not found or no clinic associated', 'PROFILE_NOT_FOUND', { userId: userId, profileError: profileError === null || profileError === void 0 ? void 0 : profileError.message });
                    }
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, body, validatedRequest, _a, clinicId, userId, alertService, acknowledgedAlert, duration, error_1;
