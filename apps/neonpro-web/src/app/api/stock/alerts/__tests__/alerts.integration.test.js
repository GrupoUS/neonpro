...
globals_1.jest.mock('@supabase/auth-helpers-nextjs', function () { return ({
    createRouteHandlerClient: globals_1.jest.fn(function () { return ({
        auth: {
...
(0, globals_1.describe)('GET /api/stock/alerts', function () {
    (0, globals_1.it)('should return paginated alert configurations', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, mockSupabase, mockQuery, createRouteHandlerClient, request, response, data;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = createMockSupabaseClient(), mockSupabase = _a.mockSupabase, mockQuery = _a.mockQuery;
                    ...
                    // Mock user clinic
                    mockSupabase.from.mockReturnValueOnce(__assign(__assign({}, mockQuery), { single: globals_1.jest.fn().mockResolvedValue({
                            data: { clinic_id: mockClinicId },
                            error: null
                        }) }));
                    // Mock alert configs
                    mockSupabase.from.mockReturnValueOnce(__assign(__assign({}, mockQuery), { count: globals_1.jest.fn().mockResolvedValue({
    ...
    (0, globals_1.it)('should handle query parameter validation', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    createRouteHandlerClient = require('@supabase/auth-helpers-nextjs').createRouteHandlerClient;
                    createRouteHandlerClient.mockReturnValue(mockSupabase);
                    request = createMockRequest('http://localhost:3000/api/stock/alerts?page=invalid&limit=999');
                    return [4 /*yield*/, (0, route_1.GET)(request)];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
...
(0, globals_1.describe)('POST /api/stock/alerts', function () {
    (0, globals_1.it)('should create new alert configuration', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, mockSupabase, mockQuery, createRouteHandlerClient, requestBody, request, response, data;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = createMockSupabaseClient(), mockSupabase = _a.mockSupabase, mockQuery = _a.mockQuery;
    ...
    (0, globals_1.it)('should validate request body', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.it)('should handle database errors', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, mockSupabase, mockQuery, createRouteHandlerClient, requestBody, request, response, data;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
...
(0, globals_1.describe)('PUT /api/stock/alerts/[id]', function () {
    (0, globals_1.it)('should update alert configuration', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, mockSupabase, mockQuery, createRouteHandlerClient, updatedConfig, requestBody, request, response, data;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = createMockSupabaseClient(), mockSupabase = _a.mockSupabase, mockQuery = _a.mockQuery;
                    ...
                    request = createMockRequest("http://localhost:3000/api/stock/alerts/".concat(mockAlertConfig.id), {
                        method: 'PUT',
                        body: JSON.stringify(requestBody),
                        headers: { 'Content-Type': 'application/json' }
                    });
...
(0, globals_1.describe)('POST /api/stock/alerts/acknowledge', function () {
    (0, globals_1.it)('should acknowledge alert successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, mockSupabase, mockQuery, createRouteHandlerClient, acknowledgedAlert, requestBody, request, response, data;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = createMockSupabaseClient(), mockSupabase = _a.mockSupabase, mockQuery = _a.mockQuery;
                    ...
                    acknowledgedAlert = __assign(__assign({}, mockAlert), { status: 'acknowledged', acknowledged_at: '2024-01-01T13:00:00Z' });
                    mockSupabase.from.mockReturnValueOnce(__assign(__assign({}, mockQuery), { single: globals_1.jest.fn().mockResolvedValue({
    ...
    (0, globals_1.it)('should validate acknowledgment request', function () { return __awaiter(void 0, void 0, void 0, function () {
...
(0, globals_1.describe)('End-to-End Alert Workflow', function () {
    (0, globals_1.it)('should complete full alert lifecycle', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, mockSupabase, mockQuery, createRouteHandlerClient, createRequest, createResponse, createData, acknowledgedAlert, ackRequest, ackResponse, ackData;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = createMockSupabaseClient(), mockSupabase = _a.mockSupabase, mockQuery = _a.mockQuery;
