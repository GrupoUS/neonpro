            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!(profile === null || profile === void 0 ? void 0 : profile.clinic_id)) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Clinic not found' }, { status: 404 })];
                    }
                    ...
                    validatedQuery = (0, stock_alerts_1.validateAlertsQuery)(__assign(__assign({}, queryFilters), { sortBy: searchParams.get('sortBy') || 'created_at', sortOrder: searchParams.get('sortOrder') || 'desc' }));
                    return [4 /*yield*/, alertsService.getActiveAlerts(profile.clinic_id, {
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, profile, body, action, _a, ackResult, resolveResult, dismissResult, generateResult, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 4:
                    ...
                    _a = action;
                    switch (_a) {
                        case 'acknowledge': return [3 /*break*/, 5];
                        case 'resolve': return [3 /*break*/, 7];
                        case 'dismiss': return [3 /*break*/, 9];
                        case 'generate': return [3 /*break*/, 11];
                    }
                    return [3 /*break*/, 13];
                case 5: return [4 /*yield*/, alertsService.acknowledgeAlert(body.data, user.id)];
                case 6:
                    ackResult = _b.sent();
                    if (!ackResult.success) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: ackResult.error }, { status: 400 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ data: ackResult.data })];
                case 7: return [4 /*yield*/, alertsService.resolveAlert(body.data, user.id)];
                case 8:
                    resolveResult = _b.sent();
                    if (!resolveResult.success) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: resolveResult.error }, { status: 400 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ data: resolveResult.data })];
                case 9: return [4 /*yield*/, alertsService.dismissAlert(body.data.alert_id, user.id, body.data.reason)];
                case 10:
                    dismissResult = _b.sent();
                    if (!dismissResult.success) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: dismissResult.error }, { status: 400 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ data: dismissResult.data })];
                case 11: return [4 /*yield*/, alertsService.generateAlerts(profile.clinic_id)];
                case 12:
                    generateResult = _b.sent();
                    if (!generateResult.success) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: generateResult.error }, { status: 500 })];
                    }
