...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, profile, body, predictionService, model, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, predictionService.updateModel(params.id, body)];
                case 5:
                    model = _c.sent();
                ...
                case 6:
                    error_1 = _c.sent();
                    console.error('Error updating prediction model:', error_1);
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to update prediction model' }, { status: 500 })];
...
function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, profile, predictions, error, error_2;
        var params = _b.params;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 4:
                    ...
                    if (predictions && predictions.length > 0) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Cannot delete model with existing predictions. Archive it instead.' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                ...
                case 6:
                    error_2 = _c.sent();
                    console.error('Error deleting prediction model:', error_2);
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to delete prediction model' }, { status: 500 })];
                case 7: return [2 /*return*/];
            }
        });
    });
