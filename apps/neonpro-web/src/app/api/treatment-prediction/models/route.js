...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, supabase, session, filters, predictionService, models, error_1;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (searchParams.get('algorithm_type')) {
                        filters.algorithm_type = searchParams.get('algorithm_type');
                    }
                    ...
                    return [4 /*yield*/, predictionService.getModels(filters)];
                case 3:
                    models = _a.sent();
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Error fetching prediction models:', error_1);
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch prediction models' }, { status: 500 })];
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, profile, body, predictionService, model, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                ...
                case 3:
                    ...
                    if (!profile || !['admin', 'manager'].includes(profile.role)) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Insufficient permissions' }, { status: 403 })];
                    }
                ...
                case 4:
                    ...
                    if (!body.name || !body.algorithm_type) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Missing required fields: name, algorithm_type' }, { status: 400 })];
                    }
                    predictionService = new treatment_prediction_1.TreatmentPredictionService();
                    return [4 /*yield*/, predictionService.createModel(body)];
                case 5:
                    model = _a.sent();
                    return [2 /*return*/, server_2.NextResponse.json({
                            model: model,
                ...
                case 6:
                    error_2 = _a.sent();
                    console.error('Error creating prediction model:', error_2);
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create prediction model' }, { status: 500 })];
