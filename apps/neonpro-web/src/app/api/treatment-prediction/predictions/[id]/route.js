...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, body, validOutcomes, prediction, predictionService, updatedPrediction, error_1;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (!body.actual_outcome || !body.outcome_date) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Missing required fields: actual_outcome, outcome_date' }, { status: 400 })];
                    }
                    validOutcomes = ['success', 'partial_success', 'failure'];
                    if (!validOutcomes.includes(body.actual_outcome)) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Invalid outcome. Must be: success, partial_success, or failure' }, { status: 400 })];
                    }
                ...
                case 4:
                    ...
                    return [4 /*yield*/, predictionService.updatePredictionOutcome(params.id, body.actual_outcome, body.outcome_date)];
                case 5:
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to update prediction outcome' }, { status: 500 })];
