    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        ...
        case 4:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ error: "Failed to fetch predictions" }, { status: 500 }),
          ];
        case 5:
          return [2 /*return*/];
      }
    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            supabase.from("patients").select("id").eq("id", body.patient_id).single(),
          ];
        case 4:
        ...
        case 5:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json(
              __assign(__assign({}, predictionResponse), {
        ...
        case 6:
          ...
          if (error_2 instanceof Error) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: error_2.message }, { status: 400 }),
            ];
          }
          return [
            2 /*return*/,
            server_2.NextResponse.json({ error: "Failed to generate prediction" }, { status: 500 }),
          ];
        case 7:
          return [2 /*return*/];
      }
