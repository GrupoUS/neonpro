...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, supabase, session, profile, dateFrom, dateTo, predictionService, analytics, error_1;
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!profile || !['admin', 'manager'].includes(profile.role)) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Insufficient permissions for analytics' }, { status: 403 })];
                    }
                    dateFrom = searchParams.get('date_from');
                    dateTo = searchParams.get('date_to');
                    predictionService = new treatment_prediction_1.TreatmentPredictionService();
                    return [4 /*yield*/, predictionService.getPredictionAnalytics(dateFrom || undefined, dateTo || undefined)];
                case 4:
                    analytics = _a.sent();
                ...
                case 5:
                    error_1 = _a.sent();
                    console.error('Error fetching prediction analytics:', error_1);
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch prediction analytics' }, { status: 500 })];
