...
function GET(request) {
  return __awaiter(this, void 0, void 0, function () {
    var dataSources, error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 2, , 3]);
          return [4 /*yield*/, reportService.getDataSources()];
        case 1:
          dataSources = _a.sent();
          return [
            2 /*return*/,
        ...
        case 2:
          error_1 = _a.sent();
          console.error("Error fetching data sources:", error_1);
          return [
            2 /*return*/,
            server_1.NextResponse.json(
              {
                success: false,
                error: error_1 instanceof Error ? error_1.message : "Failed to fetch data sources",
              },
              { status: 500 },
            ),
          ];
