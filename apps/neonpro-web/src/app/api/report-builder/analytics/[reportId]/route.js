...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var reportId, analytics, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, reportService.getReportAnalytics(reportId)];
                case 1:
                    analytics = _c.sent();
                    if (!analytics) {
                        return [2 /*return*/, server_1.NextResponse.json({
                ...
                case 2:
                    error_1 = _c.sent();
                    console.error('Error fetching report analytics:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
                            error: error_1 instanceof Error ? error_1.message : 'Failed to fetch report analytics'
                        }, { status: 500 })];
