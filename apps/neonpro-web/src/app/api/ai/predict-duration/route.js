...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, supabase, _a, user, authError, _b, userRole, roleError, aiService, abTestService, shouldUseAI, testGroup, features, prediction, aiError_1, fallbackDuration, baselineDuration, error_1;
...
function GET() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Method not allowed. Use POST.' }, { status: 405 })];
        });
    });
}
function PUT() {
