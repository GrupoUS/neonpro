    ...
    return __generator(this, (_d) => {
      switch (_d.label) {
        ...
        case 4:
          ...
          return [3 /*break*/, 9];
        case 5:
          return [4 /*yield*/, performanceService.updateModelPerformance(modelVersion)];
        case 6:
        ...
        case 7:
          (hyperparameters = body.hyperparameters),
            ...
            (trainingDataCount = body.trainingDataCount);
          ...
          return [
            4 /*yield*/,
            performanceService.deployNewModel(
              modelVersion,
              hyperparameters,
              featureImportance,
              trainingDataCount,
        ...
        case 9:
          return [
            ...
            server_1.NextResponse.json(
              {
                success: false,
                error: "Unsupported action: ".concat(
                  action,
                  ". Supported actions: update_performance, deploy_model",
                ),
              },
              { status: 400 },
            ),
