...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var requestData, patient_id, learning_data, learner, learningResult, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    requestData = _a.sent();
                    patient_id = requestData.patient_id, learning_data = requestData.learning_data;
                    if (!patient_id || !learning_data) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing required fields: patient_id, learning_data' }, { status: 400 })];
                    }
                    learner = new preference_learner_1.PatientPreferenceLearner();
                    return [4 /*yield*/, learner.updatePreferences(patient_id, learning_data)];
                case 2:
                    learningResult = _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Patient preference learning error:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, patientId, includeHistory, learner, preferences, error_2;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    learner = new preference_learner_1.PatientPreferenceLearner();
                    return [4 /*yield*/, learner.getPatientPreferences(patientId, includeHistory)];
                case 1:
                    preferences = _e.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: __assign({ patient_preferences: preferences.current_preferences, confidence_metrics: {
                                    ...
                                    time_preferences: ((_a = preferences.patterns) === null || _a === void 0 ? void 0 : _a.time_preferences) || [],
                                    staff_preferences: ((_b = preferences.patterns) === null || _b === void 0 ? void 0 : _b.staff_preferences) || [],
                                    treatment_preferences: ((_c = preferences.patterns) === null || _c === void 0 ? void 0 : _c.treatment_preferences) || [],
                                    scheduling_behaviors: ((_d = preferences.patterns) === null || _d === void 0 ? void 0 : _d.scheduling_behaviors) || []
                                } }, (includeHistory && {
