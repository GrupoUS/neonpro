        ...
        case 1:
          ...
          if (!patient_id || !action_type || !feedback_data) {
            return [
              ...
              server_1.NextResponse.json(
                { error: "Missing required fields: patient_id, action_type, feedback_data" },
                { status: 400 },
              ),
            ];
          }
          ...
          if (!validActions.includes(action_type)) {
            return [
              2 /*return*/,
              server_1.NextResponse.json(
                { error: "Invalid action_type. Must be one of: ".concat(validActions.join(", ")) },
                { status: 400 },
              ),
            ];
          }
          ...
          return [
            4 /*yield*/,
            optimizer.processFeedback({
              patient_id: patient_id,
              action_type: action_type,
              feedback_data: __assign(__assign({}, feedback_data), {
          ...
          return [
            ...
            server_1.NextResponse.json({
              ...
              data: {
                ...
                insights: {
                  strongest_patterns:
                    ((_a = feedbackHistory.insights) === null || _a === void 0
                      ? void 0
                      : _a.strongest_patterns) || [],
                  improvement_areas:
                    ((_b = feedbackHistory.insights) === null || _b === void 0
                      ? void 0
                      : _b.improvement_areas) || [],
                  recommendation_accuracy:
                    ((_c = feedbackHistory.insights) === null || _c === void 0
                      ? void 0
                      : _c.accuracy_metrics) || {},
                },
              },
