...
export async function POST(request: NextRequest) {
  try {
    ...
    const validActions = ['appointment_scheduled', 'appointment_rescheduled', 'appointment_cancelled', 'preference_updated'];
  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        insights: {
          strongest_patterns: feedbackHistory.insights?.strongest_patterns || [],
          improvement_areas: feedbackHistory.insights?.improvement_areas || [],
          recommendation_accuracy: feedbackHistory.insights?.accuracy_metrics || {}
        }
      }
    });
