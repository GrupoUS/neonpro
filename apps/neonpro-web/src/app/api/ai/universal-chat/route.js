...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, query, context, sessionId, supabase, _a, session, sessionError, userId, profile, clinicId, chatContext, response, error_1, errorMessage;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!query || typeof query !== "string") {
                        return [2 /*return*/, server_2.NextResponse.json({ success: false, error: "Query is required and must be a string" }, { status: 400 })];
                    }
                ...
                case 4:
                    ...
                    if (!(profile === null || profile === void 0 ? void 0 : profile.clinic_id)) {
                        return [2 /*return*/, server_2.NextResponse.json({ success: false, error: "User clinic not found" }, { status: 403 })];
                    }
                ...
                case 6:
                    ...
                    */
                    ...
                    console.log("AI Chat - User: ".concat(userId, ", Clinic: ").concat(clinicId, ", Query length: ").concat(query.length));
                ...
                case 7:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ success: false, error: errorMessage }, { status: 500 })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _a = _d.sent(), appointmentsData = _a[0], financialData = _a[1], clinicalData = _a[2], biData = _a[3], clinicData = _a[4];
                    return [2 /*return*/, {
                            user: {
                                id: userId,
                            ...
                            clinic: {
                                id: clinicId,
                                name: ((_b = clinicData === null || clinicData === void 0 ? void 0 : clinicData.data) === null || _b === void 0 ? void 0 : _b.name) || 'Clinic Name',
                                settings: ((_c = clinicData === null || clinicData === void 0 ? void 0 : clinicData.data) === null || _c === void 0 ? void 0 : _c.settings) || {}
                            },
...
function OPTIONS(request) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new server_2.NextResponse(null, {
                    status: 200,
                    headers: {
