    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 5:
          ...
          return [
            4 /*yield*/,
            aiService.updatePredictionWithActual(
              body.appointmentId,
              body.actualDuration,
              body.feedbackNotes,
            ),
        ...
        case 7:
          ...
          _c.label = 8;
        case 8:
          _c.trys.push([8, 10, undefined, 11]);
          ...
          return [
            ...
            server_1.NextResponse.json({
              ...
              feedback: {
                ...
                predictedDuration:
                  (_d = data.ml_duration_predictions) === null || _d === void 0
                    ? void 0
                    : _d.predicted_duration,
                accuracyScore: data.accuracy_score,
                predictionError: data.prediction_error,
                confidenceScore:
                  (_e = data.ml_duration_predictions) === null || _e === void 0
                    ? void 0
                    : _e.confidence_score,
                modelVersion:
                  (_f = data.ml_duration_predictions) === null || _f === void 0
                    ? void 0
                    : _f.model_version,
