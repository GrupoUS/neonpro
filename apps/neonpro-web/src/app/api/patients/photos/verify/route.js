    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            photoManager.verifyPatientIdentity(patientId, photoFile, user.id, verificationContext),
          ];
        case 4:
          ...
          return [
            ...
            server_1.NextResponse.json({
              ...
              data: {
                ...
                matchedPhotos: verificationResult.matchedPhotos.map(function (photo) {
                  return {
                    id: photo.id,
                    type: photo.type,
          ...
          return [
            ...
            server_1.NextResponse.json({
              ...
              pagination: {
                ...
                offset: offset,
                hasMore:
                  ((verifications === null || verifications === void 0
                    ? void 0
                    : verifications.length) || 0) === limit,
              },
            }),
          ];
        case 3:
