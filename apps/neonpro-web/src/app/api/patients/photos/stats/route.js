...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, token, _a, user, authError, _b, userProfile, profileError, searchParams, timeframe, patientId, stats, systemStats, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    ;
                    return [4 /*yield*/, photoManager.getRecognitionStats(timeframe, patientId || undefined)
...
function getSystemPhotoStats(timeframe) {
    return __awaiter(this, void 0, void 0, function () {
        var timeframeDays, startDate, totalPhotos, photosByType, typeDistribution, verificationAttempts, successfulVerifications, confidenceData, avgConfidence, privacyData, privacyStats, storageData, totalStorageUsed, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    typeDistribution = (photosByType === null || photosByType === void 0 ? void 0 : photosByType.reduce(function (acc, photo) {
                ...
                case 6:
                    ...
                    avgConfidence = (confidenceData === null || confidenceData === void 0 ? void 0 : confidenceData.length)
                        ? confidenceData.reduce(function (sum, item) { return sum + (item.confidence || 0); }, 0) / confidenceData.length
                        : 0;
                    return [4 /*yield*/, supabase
                ...
                case 7:
                    ...
                    privacyStats = (privacyData === null || privacyData === void 0 ? void 0 : privacyData.reduce(function (acc, privacy) {
                ...
                case 8:
                    ...
                    totalStorageUsed = (storageData === null || storageData === void 0 ? void 0 : storageData.reduce(function (sum, photo) { return sum + (photo.file_size || 0); }, 0)) || 0;
                    return [2 /*return*/, {
                            uploads: {
                                total: totalPhotos || 0,
                            ...
                            verifications: {
                                ...
                                successRate: verificationAttempts ? (successfulVerifications || 0) / verificationAttempts : 0,
                                averageConfidence: Math.round(avgConfidence * 100) / 100
                            },
                            privacy: {
                                facialRecognitionOptIn: privacyStats.total ? privacyStats.facialRecognitionEnabled / privacyStats.total : 0,
                                photoSharingOptIn: privacyStats.total ? privacyStats.photoSharingEnabled / privacyStats.total : 0,
