...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, token, _a, user, authError, formData, photoFile, patientId, photoType, allowedTypes, _b, patient, patientError, result, error_1;
            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (photoFile.size > 10 * 1024 * 1024) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'File too large. Maximum size is 10MB' }, { status: 400 })];
                    }
                ...
                case 3:
                    ...
                    return [4 /*yield*/, photoManager.uploadPatientPhoto(patientId, photoFile, photoType, user.id)];
                case 4:
                    result = _c.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, photoManager.getPatientPhotos(patientId, photoType || undefined, user.id)];
                case 2:
                    photos = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
