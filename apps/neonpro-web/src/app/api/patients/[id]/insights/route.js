...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, patientId, _c, session, sessionError, userRole, PatientInsights, insightsEngine, insights, error_1;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/ai/patient-insights'); })];
                case 5:
                ...
                case 6:
                    insights = _d.sent();
                    if (!insights) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to generate patient insights' }, { status: 500 })];
                    }
...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, patientId, body, _c, session, sessionError, userRole, risk_score, risk_level, notes, _d, updatedProfile, updateError, error_2;
        var params = _b.params;
            ...
            switch (_e.label) {
                ...
                case 4:
                    ...
                    if (updateError) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to update risk assessment' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({
