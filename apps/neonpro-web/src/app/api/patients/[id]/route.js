      ...
      switch (_e.label) {
        ...
        case 4:
          ...
          (demographics = body.demographics),
            ...
            (care_preferences = body.care_preferences);
          return [
            4 /*yield*/,
            supabase
              .from("patient_profiles_extended")
        ...
        case 5:
          ...
          return [
            4 /*yield*/,
            supabase.from("emergency_contacts").delete().eq("patient_id", patientId_1),
          ];
        case 6:
          // Delete existing contacts
          _e.sent();
          return [
            ...
            supabase.from("emergency_contacts").insert(
              emergency_contacts.map(function (contact) {
                return __assign({ patient_id: patientId_1 }, contact);
              }),
            ),
          ];
        case 7:
