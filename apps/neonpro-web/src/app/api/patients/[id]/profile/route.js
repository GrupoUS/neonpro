    ...
    return __generator(this, function (_g) {
      switch (_g.label) {
        ...
        case 3:
          ...
          // Validate LGPD consent
          if (
            !((_e = body.lgpdConsent) === null || _e === void 0
              ? void 0
              : _e.dataProcessingConsent) ||
            !((_f = body.lgpdConsent) === null || _f === void 0 ? void 0 : _f.sensitiveDataConsent)
          ) {
            return [
              2 /*return*/,
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            supabase.rpc("update_patient_profile_with_lgpd_audit", {
              p_patient_id: id,
    ...
    return __generator(this, function (_f) {
      switch (_f.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            supabase.from("patients").select("id, clinic_id").eq("id", id).single(),
          ];
        case 5:
