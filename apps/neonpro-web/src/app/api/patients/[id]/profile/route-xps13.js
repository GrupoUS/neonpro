...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, _d, patient, error, error_1;
...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, body, validatedData, _d, updatedPatient, updateError, error_2;
        var _e, _f;
        var params = _b.params;
...
function PATCH(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, body, _d, patient, fetchError, _e, updatedPatient, updateError, error_3;
        var params = _b.params;
