            ...
            switch (_e.label) {
                ...
                case 5:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to record consent' }, { status: 500 })];
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 5:
                    _d = _e.sent(), consent = _d.data, error = _d.error;
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update consent' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
