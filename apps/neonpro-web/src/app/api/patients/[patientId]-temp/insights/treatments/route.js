...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, patient, searchParams, treatmentContext, treatmentRecommendations, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, patientInsights.generateTreatmentGuidance(params.patientId, treatmentContext)];
                case 3:
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to generate treatment recommendations' }, { status: 500 })];
...
function POST(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, body, treatmentContext, _c, includeAlternatives, _d, includeRiskAssessment, _e, outcomeData, treatmentRecommendations, response, riskAssessment, learningInsights, error_2;
        var params = _b.params;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    body = _f.sent();
                    treatmentContext = body.treatmentContext, _c = body.includeAlternatives, includeAlternatives = _c === void 0 ? true : _c, _d = body.includeRiskAssessment, includeRiskAssessment = _d === void 0 ? true : _d, _e = body.outcomeData, outcomeData = _e === void 0 ? null : _e;
                    return [4 /*yield*/, patientInsights.generateTreatmentGuidance(params.patientId, treatmentContext)];
                case 3:
                ...
                case 5:
                    ...
                    return [4 /*yield*/, patientInsights.updatePatientOutcome(params.patientId, outcomeData.treatmentId, outcomeData)];
                case 6:
                ...
                case 8:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to generate comprehensive treatment recommendations' }, { status: 500 })];
