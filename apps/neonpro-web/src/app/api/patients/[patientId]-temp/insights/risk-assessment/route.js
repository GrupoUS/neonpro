        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to generate risk assessment' }, { status: 500 })];
...
function POST(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, body, _c, includeRecommendations, riskAssessment, recommendations, treatmentGuidance, error_2;
        var params = _b.params;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to generate comprehensive risk assessment' }, { status: 500 })];
