    ...
    return __generator(this, (_e) => {
      switch (_e.label) {
        ...
        case 2:
          body = _e.sent();
          (_c = body.alertTypes),
            (alertTypes_1 = _c === void 0 ? [] : _c),
            (_d = body.severityFilter),
            (severityFilter_1 = _d === void 0 ? null : _d);
          return [
            4 /*yield*/,
            patientInsights.monitorPatientAlerts(params.patientId),
            // Apply filters
          ];
        case 3:
          ...
          if (alertTypes_1.length > 0) {
            filteredAlerts = filteredAlerts.filter((alert) => alertTypes_1.includes(alert.type));
          }
          if (severityFilter_1) {
            filteredAlerts = filteredAlerts.filter((alert) => alert.severity === severityFilter_1);
          }
          return [
            2 /*return*/,
            server_1.NextResponse.json({
              success: true,
              data: __assign(__assign({}, alertSummary), {
