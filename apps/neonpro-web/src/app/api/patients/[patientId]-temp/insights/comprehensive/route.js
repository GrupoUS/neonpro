...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, patient, searchParams, requestedInsights, treatmentContext, insightRequest, comprehensiveInsights, error_1;
        var _c;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    requestedInsights = ((_c = searchParams.get('insights')) === null || _c === void 0 ? void 0 : _c.split(',')) || [];
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to generate comprehensive insights' }, { status: 500 })];
