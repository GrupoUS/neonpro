        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    profile = _b.sent();
                    if (!profile) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create patient profile' }, { status: 500 })];
                    }
            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    searchData = {
                        ...
                        conditions: ((_b = searchParams.get('conditions')) === null || _b === void 0 ? void 0 : _b.split(',')) || undefined,
                ...
                case 4:
                    ...
                    if (error_2 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid search parameters', details: error_2.errors }, { status: 400 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Internal server error' }, { status: 500 })];
