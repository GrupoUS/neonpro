...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, id, profile, searchParams, insightType, insights, _d, error_1;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    profile = _e.sent();
                    if (!profile) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Patient profile not found' }, { status: 404 })];
                    }
                    ...
                    _d = insightType;
                    switch (_d) {
                        case 'clinical': return [3 /*break*/, 4];
                        case 'personalization': return [3 /*break*/, 6];
                        case 'risk': return [3 /*break*/, 8];
                        case 'care': return [3 /*break*/, 10];
                        case 'trending': return [3 /*break*/, 12];
                    }
                    return [3 /*break*/, 14];
                case 4: return [4 /*yield*/, patientInsights.generateClinicalInsights(profile)];
                case 5:
                    insights = _e.sent();
                    return [3 /*break*/, 16];
                case 6: return [4 /*yield*/, patientInsights.generatePersonalizationInsights(profile)];
                case 7:
                    insights = _e.sent();
                    return [3 /*break*/, 16];
                case 8: return [4 /*yield*/, patientInsights.generateRiskAssessment(profile)];
                case 9:
                    insights = _e.sent();
                    return [3 /*break*/, 16];
                case 10: return [4 /*yield*/, patientInsights.generateCareRecommendations(profile)];
                case 11:
                    insights = _e.sent();
                    return [3 /*break*/, 16];
                case 12: return [4 /*yield*/, patientInsights.getTrendingInsights(id)];
                case 13:
                    insights = _e.sent();
                    return [3 /*break*/, 16];
                case 14: return [4 /*yield*/, patientInsights.generateComprehensiveInsights(profile)];
                case 15:
                    insights = _e.sent();
                    _e.label = 16;
                case 16: return [2 /*return*/, server_2.NextResponse.json({
                        insights: insights,
                        patient_id: id,
