...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, profile, searchParams, query, limit, filters, minAge, maxAge, lastVisitFrom, lastVisitTo, tags, searchResults, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (tags) {
                        filters.tags = tags.split(',').map(function (tag) { return tag.trim(); });
                    }
                    return [4 /*yield*/, (0, system_integration_manager_1.createsystemIntegrationManager)().searchPatients(query, filters, user.id, limit)];
                case 4:
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, profile, body, name_1, description, criteria, segment, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 7, , 9]);
                ...
                case 3:
                    ...
                    if (!profile || !['admin', 'manager'].includes(profile.role)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Acesso negado: apenas administradores e gerentes podem criar segmentos' }, { status: 403 })];
                    }
                ...
                case 4:
                    ...
                    if (!name_1 || !description || !criteria) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Campos obrigatórios: name, description, criteria' }, { status: 400 })];
                    }
                    return [4 /*yield*/, (0, system_integration_manager_1.createsystemIntegrationManager)().createPatientSegment(name_1, description, criteria, user.id)];
                case 5:
                    segment = _b.sent();
