      ...
      switch (_f.label) {
        ...
        case 2:
          ...
          if (!patientId) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Patient ID is required" }, { status: 400 }),
            ];
          }
          _a = action;
          switch (_a) {
        ...
        case 3:
          eventTypes =
            (_b = searchParams.get("eventTypes")) === null || _b === void 0
              ...
              : _b.split(",");
          categories =
            (_c = searchParams.get("categories")) === null || _c === void 0
              ? void 0
              : _c.split(",");
          startDate = searchParams.get("startDate");
          endDate = searchParams.get("endDate");
          professionals =
            (_d = searchParams.get("professionals")) === null || _d === void 0
              ? void 0
              : _d.split(",");
          severity =
            (_e = searchParams.get("severity")) === null || _e === void 0 ? void 0 : _e.split(",");
          filter = __assign(
            __assign(
              __assign(
                __assign(
                  __assign(
                    __assign({}, eventTypes && { eventTypes: eventTypes }),
          ...
          return [
            4 /*yield*/,
            (0, medical_timeline_1.createmedicalTimelineService)().getPatientTimeline(
              patientId,
              filter,
            ),
          ];
        case 4:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ timeline: timeline }, { status: 200 }),
          ];
        case 5:
          return [
            4 /*yield*/,
            (0, medical_timeline_1.createmedicalTimelineService)().getTreatmentMilestones(
              patientId,
            ),
          ];
        case 6:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ milestones: milestones }, { status: 200 }),
          ];
        case 7:
          period = searchParams.get("period") || "month";
          return [
            4 /*yield*/,
            (0, medical_timeline_1.createmedicalTimelineService)().getTimelineSummary(
              patientId,
              period,
            ),
          ];
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            (0, medical_timeline_1.createmedicalTimelineService)().addTimelineEvent({
              patientId: patientId,
              eventType: eventType,
              title: title,
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            (0, medical_timeline_1.createmedicalTimelineService)().addProgressNote(eventId, {
              note: note,
              date: new Date(),
              author: author,
        ...
        case 7:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ note: progressNote }, { status: 201 }),
          ];
        case 8:
          (photoEventId = data.eventId),
          ...
          return [
            4 /*yield*/,
            (0, medical_timeline_1.createmedicalTimelineService)().addBeforeAfterPhotos(
              photoEventId,
              {
        ...
        case 9:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ photos: beforeAfterPhotos }, { status: 201 }),
          ];
        case 10:
          return [
            2 /*return*/,
      ...
      switch (_b.label) {
        ...
        case 4:
          ...
          if (!eventId) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Event ID is required" }, { status: 400 }),
            ];
          }
          ...
          return [
            4 /*yield*/,
            (0, medical_timeline_1.createmedicalTimelineService)().updateTimelineEvent(
              eventId,
              updates,
            ),
          ];
        case 5:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ event: updatedEvent }, { status: 200 }),
          ];
        case 6:
          ...
          return [
            4 /*yield*/,
            (0, medical_timeline_1.createmedicalTimelineService)().updateMilestoneProgress(
              milestoneId,
              progress,
              notes,
            ),
        ...
        case 7:
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ milestone: updatedMilestone }, { status: 200 }),
          ];
        case 8:
          return [
            2 /*return*/,
