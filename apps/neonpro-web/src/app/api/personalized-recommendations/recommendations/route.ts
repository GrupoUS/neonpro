...
export async function GET(request: NextRequest) {
  try {
    ...
    const recommendations =
      await createpersonalizedRecommendationsService().getRecommendations(query);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const recommendation =
      await createpersonalizedRecommendationsService().createRecommendation(recommendationData);
