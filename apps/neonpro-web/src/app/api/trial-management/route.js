...
var trialUpdateSchema = zod_1.z.object({
    ...
    conversion_data: zod_1.z.object({
...
var campaignSchema = zod_1.z.object({
    ...
    ai_optimization: zod_1.z.object({
        enabled: zod_1.z.boolean().default(true),
        optimization_goals: zod_1.z.array(zod_1.z.enum(['conversion_rate', 'trial_length', 'engagement'])).optional(),
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = action;
                    switch (_a) {
                        case 'trials': return [3 /*break*/, 1];
                        case 'campaigns': return [3 /*break*/, 3];
                        case 'analytics': return [3 /*break*/, 5];
                        case 'ai-insights': return [3 /*break*/, 7];
                    }
                    return [3 /*break*/, 9];
                case 1: return [4 /*yield*/, getTrials(targetUserId || userId, status_1, campaignId)];
                ...
                case 5: return [4 /*yield*/, getTrialAnalytics(targetUserId || userId, userRole)];
                ...
                case 9: return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid action parameter' }, { status: 400 })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    _a = action;
                    switch (_a) {
                        case 'create-trial': return [3 /*break*/, 2];
                        case 'create-campaign': return [3 /*break*/, 4];
                        case 'ai-optimize': return [3 /*break*/, 6];
                    }
                    return [3 /*break*/, 8];
                case 2: return [4 /*yield*/, createTrial(body, userId, userRole)];
                ...
                case 8: return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid action parameter' }, { status: 400 })];
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, userRole, body, validatedUpdate, _a, trial, trialError, updateData, currentTrial, newEndDate, _b, data, error, error_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (trialError || !trial) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Trial not found' }, { status: 404 })];
                    }
                ...
                case 5:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update trial' }, { status: 500 })];
                    }
...
function getTrialAnalytics(userId, userRole) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, supabase
                        .rpc('get_trial_analytics_detailed', {
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (validatedTrial.user_id !== userId && userRole !== 'admin') {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Cannot create trial for other users' }, { status: 403 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('trials')
                            .select('id')
                ...
                case 1:
                    ...
                    if (existingTrial) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'User already has an active trial' }, { status: 409 })];
                    }
                    startDate = new Date();
                ...
                case 2:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create trial' }, { status: 500 })];
                    }
                    // Track analytics event
                    return [4 /*yield*/, supabase
                            .from('analytics_events')
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            .from('campaigns')
                            .insert(__assign(__assign({}, validatedCampaign), { created_by: userId, status: 'active' }))
                            .select()
                            .single()];
                case 1:
                    _a = _b.sent(), data = _a.data, error = _a.error;
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create campaign' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: data,
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to trigger AI optimization' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: data,
