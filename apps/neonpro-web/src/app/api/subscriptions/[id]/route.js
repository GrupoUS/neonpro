...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, subscriptionId, _d, subscription, error, userProfile, isAdmin, isCustomerOwner, isSameOrganization, error_1;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    if (!subscriptionId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Subscription ID is required' }, { status: 400 })];
                    }
                ...
                case 2:
                    ...
                    if (error || !subscription) {
                        logger_1.logger.error("Error fetching subscription ".concat(subscriptionId, ":"), error);
                ...
                case 3:
                    ...
                    isSameOrganization = subscription.customer.organization_id === (userProfile === null || userProfile === void 0 ? void 0 : userProfile.organization_id);
...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, subscriptionId, body, validationResult, _d, subscription, fetchError, userProfile, isAdmin, isCustomerOwner, isSameOrganization, updatedSubscription, error_2;
        var params = _b.params;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                ...
                case 5:
                    ...
                    logger_1.logger.info("Subscription updated: ".concat(subscriptionId, " by user: ").concat(user.id));
                    return [2 /*return*/, server_1.NextResponse.json({
...
function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, subscriptionId, searchParams, immediate, _d, subscription, fetchError, userProfile, isAdmin, isCustomerOwner, isSameOrganization, canceledSubscription, error_3;
        var params = _b.params;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                ...
                case 4:
                    ...
                    logger_1.logger.info("Subscription canceled: ".concat(subscriptionId, " by user: ").concat(user.id, ", immediate: ").concat(immediate));
                    return [2 /*return*/, server_1.NextResponse.json({
                ...
                case 5:
                    error_3 = _e.sent();
                    logger_1.logger.error("Error in DELETE /api/subscriptions/".concat(params.id, ":"), error_3);
