...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, customerId, status_1, planId, page, limit, query, _b, subscriptions, error, count, totalCount, error_1;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch subscriptions' }, { status: 500 })];
                    }
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, validationResult, subscriptionData, _b, customer, customerError, existingSubscriptions, subscription, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 7, , 8]);
                ...
                case 5:
                    ...
                    if (existingSubscriptions && existingSubscriptions.length > 0) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Customer already has an active subscription' }, { status: 409 })];
                    }
                    return [4 /*yield*/, subscription_manager_1.subscriptionManager.createSubscription(subscriptionData)];
                case 6:
                    subscription = _c.sent();
                    logger_1.logger.info("Subscription created: ".concat(subscription.id, " for customer: ").concat(subscriptionData.customer_id));
                    return [2 /*return*/, server_1.NextResponse.json({
                            data: subscription,
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, userProfile, body, subscription_ids, updates, validationResult, results, errors, _i, subscription_ids_1, subscriptionId, updatedSubscription, error_3, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    _b.trys.push([6, 8, , 9]);
                    return [4 /*yield*/, subscription_manager_1.subscriptionManager.updateSubscription(subscriptionId, validationResult.data)];
                case 7:
                ...
                case 10: return [2 /*return*/, server_1.NextResponse.json({
                        data: results,
                        errors: errors,
                        message: "Updated ".concat(results.length, " subscriptions, ").concat(errors.length, " errors")
                    })];
                case 11:
                    error_4 = _b.sent();
...
function DELETE(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, userProfile, body, subscription_ids, _b, immediate, results, errors, _i, subscription_ids_2, subscriptionId, canceledSubscription, error_5, error_6;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 4:
                    body = _c.sent();
                    subscription_ids = body.subscription_ids, _b = body.immediate, immediate = _b === void 0 ? false : _b;
                ...
                case 6:
                    _c.trys.push([6, 8, , 9]);
                    return [4 /*yield*/, subscription_manager_1.subscriptionManager.cancelSubscription(subscriptionId, immediate)];
                case 7:
                ...
                case 10: return [2 /*return*/, server_1.NextResponse.json({
                        data: results,
                        errors: errors,
                        message: "Canceled ".concat(results.length, " subscriptions, ").concat(errors.length, " errors")
                    })];
                case 11:
                    error_6 = _c.sent();
