...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, body, google_profile_data, _b, force_update, _c, currentProfile, profileError, googleUpdate, changes, conflicts, updateData, _d, updatedProfile, updateError, error_1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    body = _e.sent();
                    google_profile_data = body.google_profile_data, _b = body.force_update, force_update = _b === void 0 ? false : _b;
                    if (!google_profile_data) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Missing data', message: 'google_profile_data is required' }, { status: 400 })];
                    }
                ...
                case 6:
                    ...
                    updateData = __assign(__assign({}, changes), { profile_sync_status: 'synced', last_google_sync: new Date().toISOString(), updated_at: new Date().toISOString() });
                    return [4 /*yield*/, supabase
                            .from('profiles')
                            .update(updateData)
                            .eq('id', user.id)
                ...
                case 7:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            google_verified: googleUpdate.email_verified || currentProfile.google_verified_email,
                            has_conflicts: false,
                            updated_at: new Date().toISOString()
                        })
                ...
                case 11:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Internal server error', message: 'Profile update failed' }, { status: 500 })];
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, _b, profile, profileError, _c, updateLogs, logsError, error_2;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Internal server error', message: 'Could not fetch update information' }, { status: 500 })];
