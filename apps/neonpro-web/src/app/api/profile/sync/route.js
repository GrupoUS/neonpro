...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, googleData, appData, hasGoogleProvider, profileData, _b, profile, updateError, _c, newProfile, insertError, error_1;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    hasGoogleProvider = (_d = user.identities) === null || _d === void 0 ? void 0 : _d.some(function (identity) { return identity.provider === 'google'; });
                    if (!hasGoogleProvider) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'No Google provider', message: 'User is not authenticated with Google' }, { status: 400 })];
                    }
                    profileData = {
                        email: user.email,
                ...
                case 3:
                    ...
                    return [4 /*yield*/, supabase
                            .from('profiles')
                            .insert(__assign(__assign({ id: user.id }, profileData), { role: 'professional', data_consent_given: false, created_at: new Date().toISOString() }))
                            .select()
                            .single()];
                case 4:
                    ...
                    if (insertError) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Sync failed', message: 'Could not create or update profile' }, { status: 500 })];
                    }
                ...
                case 5: return [2 /*return*/, server_2.NextResponse.json({ error: 'Sync failed', message: updateError.message }, { status: 500 })];
                case 6: 
                ...
                case 8:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Internal server error', message: 'Profile sync failed' }, { status: 500 })];
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, _b, profile, profileError, _c, syncStatus, syncError, error_2;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                ...
                case 3:
                    ...
                    if (profileError) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Profile not found', message: profileError.message }, { status: 404 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('profile_sync_status')
                            .select('*')
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({
                            ...
                            google_connected: ((_d = user.identities) === null || _d === void 0 ? void 0 : _d.some(function (identity) { return identity.provider === 'google'; })) || false
                        })];
                case 5:
                    error_2 = _e.sent();
                    console.error('Profile sync GET error:', error_2);
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Internal server error', message: 'Could not fetch profile sync data' }, { status: 500 })];
