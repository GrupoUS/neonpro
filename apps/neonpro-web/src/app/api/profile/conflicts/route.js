...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, conflictType, localProfile, googleProfile, resolution, resolvedProfile, _b, updatedProfile, updateError, logError, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    body = _c.sent();
                    conflictType = body.conflictType, localProfile = body.localProfile, googleProfile = body.googleProfile, resolution = body.resolution;
                    // Validar dados obrigatórios
                    if (!conflictType || !localProfile || !googleProfile || !resolution) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Dados obrigatórios ausentes' }, { status: 400 })];
                    }
                    resolvedProfile = {};
                    ...
                    switch (resolution) {
                        case 'keep_local':
                            ...
                            break;
                        case 'use_google':
                            resolvedProfile = __assign(__assign({}, localProfile), { full_name: googleProfile.name || localProfile.full_name, avatar_url: googleProfile.picture || localProfile.avatar_url, updated_at: new Date().toISOString() });
                            break;
                        case 'merge_smart':
                            resolvedProfile = __assign(__assign({}, localProfile), { 
                                ...
                                avatar_url: !localProfile.avatar_url ?
                                    googleProfile.picture : localProfile.avatar_url, updated_at: new Date().toISOString() });
                            break;
                        case 'custom':
                            // Para resolução customizada, usar os dados fornecidos
                            resolvedProfile = __assign(__assign(__assign({}, localProfile), body.customData), { updated_at: new Date().toISOString() });
                            break;
                        default:
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Estratégia de resolução inválida' }, { status: 400 })];
                    }
                ...
                case 4:
                    ...
                    if (updateError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao resolver conflito de perfil' }, { status: 500 })];
                    }
                    return [4 /*yield*/, supabase
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 3:
                    ...
                    if (profileError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar perfil' }, { status: 500 })];
                    }
                    googleProfile = {
                        name: ((_c = user.user_metadata) === null || _c === void 0 ? void 0 : _c.full_name) || ((_d = user.user_metadata) === null || _d === void 0 ? void 0 : _d.name),
                        email: user.email,
                        picture: ((_e = user.user_metadata) === null || _e === void 0 ? void 0 : _e.avatar_url) || ((_f = user.user_metadata) === null || _f === void 0 ? void 0 : _f.picture),
