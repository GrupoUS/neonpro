...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, body, google_picture_url, _b, sync_to_local_storage, _c, force_update, custom_avatar_url, _d, currentProfile, profileError, finalAvatarUrl, syncMethod, response, imageBuffer, fileName, _e, uploadData, uploadError, publicUrlData, error_1, needsUpdate, updateData, _f, updatedProfile, updateError, error_2;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 3:
                    body = _g.sent();
                    google_picture_url = body.google_picture_url, _b = body.sync_to_local_storage, sync_to_local_storage = _b === void 0 ? false : _b, _c = body.force_update, force_update = _c === void 0 ? false : _c, custom_avatar_url = body.custom_avatar_url;
                ...
                case 16:
                    ...
                    if (updateError) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Update failed', message: updateError.message }, { status: 500 })];
                    }
                ...
                case 18:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Internal server error', message: 'Avatar synchronization failed' }, { status: 500 })];
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, _b, profile, profileError, _c, syncLogs, logsError, _d, bucketInfo, bucketError, error_3;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({
                            ...
                            local_storage: {
                                ...
                                avatar_count: (bucketInfo === null || bucketInfo === void 0 ? void 0 : bucketInfo.length) || 0,
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Internal server error', message: 'Could not fetch avatar information' }, { status: 500 })];
