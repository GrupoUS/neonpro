    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        case 0:
          ...
          Object.keys(filters_1).forEach((key) => {
          ...
          return [
            4 /*yield*/,
            marketing_campaigns_service_1.marketingCampaignsService.getTemplates(filters_1),
          ];
        case 1:
          templates = _a.sent();
          return [
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        ...
        case 1:
          body = _a.sent();
          requiredFields = ["name", "category", "campaignType", "contentTemplate", "clinicId"];
          ...
          return [
            4 /*yield*/,
            marketing_campaigns_service_1.marketingCampaignsService.createTemplate(templateData),
          ];
        case 2:
          template = _a.sent();
          return [
