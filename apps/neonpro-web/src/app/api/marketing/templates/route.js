...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, filters_1, templates, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, marketing_campaigns_service_1.marketingCampaignsService.getTemplates(filters_1)];
                case 1:
                    templates = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('GET /api/marketing/templates error:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, requiredFields, _i, requiredFields_1, field, validCategories, validCampaignTypes, templateData, template, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    ...
                    if (!validCategories.includes(body.category)) {
                        return [2 /*return*/, server_1.NextResponse.json({
                                success: false,
                                error: "Invalid category. Must be one of: ".concat(validCategories.join(', '))
                            }, { status: 400 })];
                    }
                    validCampaignTypes = ['email', 'sms', 'whatsapp', 'push_notification', 'in_app', 'multi_channel'];
                    if (!validCampaignTypes.includes(body.campaignType)) {
                        return [2 /*return*/, server_1.NextResponse.json({
                                success: false,
                                error: "Invalid campaign type. Must be one of: ".concat(validCampaignTypes.join(', '))
                            }, { status: 400 })];
                    }
                    templateData = {
                        name: body.name,
                    ...
                    return [4 /*yield*/, marketing_campaigns_service_1.marketingCampaignsService.createTemplate(templateData)];
                case 2:
                    template = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('POST /api/marketing/templates error:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
