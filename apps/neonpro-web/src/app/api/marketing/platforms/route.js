    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [4 /*yield*/, query.order("platform_name")];
        case 4:
          ...
          platformsWithStatus =
            platforms === null || platforms === void 0
              ...
              : platforms.map(function (platform) {
                  var connection =
                    connections_1 === null || connections_1 === void 0
                      ? void 0
                      : connections_1.find(function (conn) {
                          return conn.platform_id === platform.id;
                        });
                  return __assign(__assign({}, platform), {
                    connection_status: connection || null,
                    is_connected: !!connection,
                    connection_health:
                      (connection === null || connection === void 0
                        ? void 0
                        : connection.connection_health_score) || null,
                  });
                });
          return [
            2 /*return*/,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 5:
          ...
          return [
            4 /*yield*/,
            supabase.from("marketing_platforms").insert([validatedData]).select().single(),
          ];
        case 6:
