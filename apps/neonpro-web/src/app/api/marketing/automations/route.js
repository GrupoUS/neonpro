        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, marketing_campaigns_service_1.marketingCampaignsService.getAutomations(clinicId)];
                case 1:
                    automations = _a.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, requiredFields, _i, requiredFields_1, field, _a, _b, step, automationData, automation, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, marketing_campaigns_service_1.marketingCampaignsService.createAutomation(automationData)];
                case 2:
                    automation = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
