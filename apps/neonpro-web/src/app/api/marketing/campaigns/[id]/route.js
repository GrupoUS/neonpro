            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (body.status && existingCampaign.status === 'completed' && body.status !== 'completed') {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Cannot modify completed campaigns' }, { status: 400 })];
                    }
                    return [4 /*yield*/, marketing_campaigns_service_1.marketingCampaignsService.updateCampaign(id, body)];
                case 3:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, marketing_campaigns_service_1.marketingCampaignsService.deleteCampaign(id)];
                case 2:
                    _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
