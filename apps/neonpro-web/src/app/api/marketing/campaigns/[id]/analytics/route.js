    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            marketing_campaigns_service_1.marketingCampaignsService.getCampaignAnalytics(id),
          ];
        case 2:
          analytics = _c.sent();
          ...
          if (startDate_1 || endDate_1) {
            ...
            if (analyticsData_1.timeline) {
              analyticsData_1.timeline = analyticsData_1.timeline.filter(function (point) {
                ...
                if (startDate_1 && pointDate < new Date(startDate_1)) return false;
                if (endDate_1 && pointDate > new Date(endDate_1)) return false;
                return true;
              });
            }
          }
        ...
        case 3:
          error_1 = _c.sent();
          console.error(
            "GET /api/marketing/campaigns/".concat(params.id, "/analytics error:"),
            error_1,
          );
          return [
            2 /*return*/,
