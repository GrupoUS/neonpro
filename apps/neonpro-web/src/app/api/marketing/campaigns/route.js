        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    filters_1 = {
                        status: (_a = searchParams.get('status')) === null || _a === void 0 ? void 0 : _a.split(','),
                        type: (_b = searchParams.get('type')) === null || _b === void 0 ? void 0 : _b.split(','),
                    ...
                    return [4 /*yield*/, marketing_campaigns_service_1.marketingCampaignsService.getCampaigns(filters_1)];
                case 1:
                    campaigns = _c.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, requiredFields, _i, requiredFields_1, field, validCampaignTypes, validTriggerTypes, campaignData, campaign, error_2;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!validTriggerTypes.includes(body.triggerType)) {
                        return [2 /*return*/, server_1.NextResponse.json({
                                success: false,
                                error: "Invalid trigger type. Must be one of: ".concat(validTriggerTypes.join(', '))
                            }, { status: 400 })];
                    }
                    campaignData = {
                        name: body.name,
                    ...
                    return [4 /*yield*/, marketing_campaigns_service_1.marketingCampaignsService.createCampaign(campaignData)];
                case 2:
                    campaign = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
