      ...
      switch (_b.label) {
        ...
        case 4:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to fetch connections" }, { status: 500 }),
            ];
          }
          sanitizedConnections =
          ...
          return [
            ...
            server_1.NextResponse.json({
              ...
              total:
                (connections === null || connections === void 0 ? void 0 : connections.length) || 0,
            }),
          ];
        case 5:
          error_1 = _b.sent();
      ...
      switch (_b.label) {
        ...
        case 8:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to create connection" }, { status: 500 }),
            ];
          }
          return [
            2 /*return*/,
