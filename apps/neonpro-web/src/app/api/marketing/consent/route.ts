...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await campaignService.getPatientConsent(patientId, consentType);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const result = await campaignService.withdrawConsent(patientId, consentType, reason);
