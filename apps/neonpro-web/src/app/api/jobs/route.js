            ...
            switch (_d.label) {
                ...
                case 7:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            health: 'ok',
                            metrics: {
                                failedJobsLast24h: ((_b = failedJobs === null || failedJobs === void 0 ? void 0 : failedJobs[0]) === null || _b === void 0 ? void 0 : _b.count) || 0,
                                pendingJobs: ((_c = pendingJobs === null || pendingJobs === void 0 ? void 0 : pendingJobs[0]) === null || _c === void 0 ? void 0 : _c.count) || 0
                            },
                            timestamp: new Date().toISOString()
                        })];
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, action, params, startTime, supabase, _a, stats, duration, processStats, scheduler, refreshStats, syncScheduler, syncStats, cutoffDate, _b, deletedJobs, cleanupError, cleanupStats, _c, maxAge, retryDate, _d, retriedJobs, retryError, retryStats, error_3;
        var _e, _f;
            ...
            switch (_g.label) {
                ...
                case 2:
                    ...
                    switch (_a) {
                        ...
                        case 'schedule_token_refresh': return [3 /*break*/, 6];
                        case 'schedule_daily_sync': return [3 /*break*/, 9];
                        case 'cleanup': return [3 /*break*/, 12];
                        case 'retry_failed': return [3 /*break*/, 15];
                    }
                    return [3 /*break*/, 18];
                case 3:
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            stats: processStats,
                            message: "Processed ".concat(stats.processed, " jobs with ").concat(stats.errors, " errors")
                        })];
                case 6:
                ...
                case 13:
                    ...
                    cleanupStats = {
                        processed: ((_e = deletedJobs === null || deletedJobs === void 0 ? void 0 : deletedJobs[0]) === null || _e === void 0 ? void 0 : _e.count) || 0,
                        errors: 0,
                        duration: Date.now() - startTime,
                        timestamp: new Date().toISOString()
                    };
                ...
                case 16:
                    ...
                    retryStats = {
                        processed: ((_f = retriedJobs === null || retriedJobs === void 0 ? void 0 : retriedJobs[0]) === null || _f === void 0 ? void 0 : _f.count) || 0,
                        errors: 0,
                        duration: Date.now() - startTime,
                        timestamp: new Date().toISOString()
                    };
                ...
                case 20:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: error_3.message || 'Internal server error' }, { status: 500 })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    supabase = _b.sent();
                    if (!jobId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Job ID required' }, { status: 400 })];
                    }
                    _a = action;
                    switch (_a) {
                ...
                case 7: return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid action' }, { status: 400 })];
                case 8: return [3 /*break*/, 10];
                case 9:
                    error_4 = _b.sent();
                    console.error('Jobs API PUT error:', error_4);
                    return [2 /*return*/, server_1.NextResponse.json({ error: error_4.message || 'Internal server error' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: error_5.message || 'Internal server error' }, { status: 500 })];
