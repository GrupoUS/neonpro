...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, error, errorDescription, loginUrl, validationResult, loginUrl, _a, code, state, providerId, result, loginUrl, redirectUrl, stateParams, redirectTo, redirectUrlObj, finalUrl, error_1, loginUrl;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    _a = validationResult.data, code = _a.code, state = _a.state, providerId = _a.provider;
                    return [4 /*yield*/, sso_manager_1.ssoManager.handleCallback(providerId, {
                            code: code,
                            state: state,
                        })];
                case 1:
                    ...
                    if (!result.success) {
                        ...
                        loginUrl.searchParams.set('message', ((_b = result.error) === null || _b === void 0 ? void 0 : _b.message) || 'Authentication failed');
                        return [2 /*return*/, server_1.NextResponse.redirect(loginUrl)];
                    }
                    // Set session cookies
                    ...
                    if (state) {
                        try {
                            ...
                            logger_1.logger.warn('SSO callback: Invalid state parameter', { state: state, error: error.message });
                        }
                    }
