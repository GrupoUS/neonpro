...
var logoutSchema = zod_1.z.object({
    ...
    revoke_tokens: zod_1.z.string().transform(function (val) { return val === 'true'; }).optional(),
    global_logout: zod_1.z.string().transform(function (val) { return val === 'true'; }).optional(),
});
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var sessionCookie, userCookie, logoutOptions, body, validationResult, _a, searchParams, queryValidation, redirect_to, _b, revoke_tokens, _c, global_logout, sessionId, provider, userId, userData, error_1, cookieOptions, redirectUrl, redirectUrlObj, finalUrl, error_2;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    ...
                    redirect_to = logoutOptions.redirect_to, _b = logoutOptions.revoke_tokens, revoke_tokens = _b === void 0 ? true : _b, _c = logoutOptions.global_logout, global_logout = _c === void 0 ? false : _c;
                    sessionId = null;
                    provider = null;
                    userId = null;
                    ...
                    if (userCookie) {
                        try {
                            ...
                            logger_1.logger.warn('SSO logout: Failed to parse user cookie', { error: error.message });
                        }
                    }
                ...
                case 5:
                    _d.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, sso_manager_1.ssoManager.logout(sessionId, {
                ...
                case 8:
                    ...
                    cookieStore.set('sso_user', '', __assign(__assign({}, cookieOptions), { httpOnly: false }));
                    ...
                    if (redirect_to) {
                        try {
                            ...
                            logger_1.logger.warn('SSO logout: Invalid redirect URL', { redirect_to: redirect_to, error: error.message });
                        }
                    }
...
function PUT() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, server_1.NextResponse.json({ error: 'METHOD_NOT_ALLOWED', message: 'PUT method not allowed' }, { status: 405 })];
        });
    });
}
function DELETE() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, server_1.NextResponse.json({ error: 'METHOD_NOT_ALLOWED', message: 'DELETE method not allowed' }, { status: 405 })];
        });
    });
}
