...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, validationResult, _a, providerId_1, redirect_to, login_hint, domain_hint, prompt_1, availableProviders, provider, authUrl, error_1;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _a = validationResult.data, providerId_1 = _a.provider, redirect_to = _a.redirect_to, login_hint = _a.login_hint, domain_hint = _a.domain_hint, prompt_1 = _a.prompt;
                    availableProviders = sso_manager_1.ssoManager.getAvailableProviders();
                    provider = availableProviders.find(function (p) { return p.id === providerId_1; });
                    if (!provider) {
                    ...
                    return [4 /*yield*/, sso_manager_1.ssoManager.generateAuthUrl(providerId_1, {
                            ...
                            state: redirect_to ? "redirect_to=".concat(encodeURIComponent(redirect_to)) : undefined,
                        })];
                case 1:
                    authUrl = _c.sent();
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            provider: {
                                id: provider.id,
                                name: provider.name,
                                displayName: ((_b = provider.metadata) === null || _b === void 0 ? void 0 : _b.displayName) || provider.name,
                            },
                        })];
                case 2:
                    error_1 = _c.sent();
...
function POST() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, server_1.NextResponse.json({ error: 'METHOD_NOT_ALLOWED', message: 'POST method not allowed' }, { status: 405 })];
        });
    });
}
function PUT() {
