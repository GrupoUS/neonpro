...
var providersQuerySchema = zod_1.z.object({
    ...
    enabled_only: zod_1.z.string().transform(function (val) { return val === 'true'; }).optional(),
});
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            try {
                ...
                if (enabled_only) {
                    providers = providers.filter(function (provider) { return provider.config.enabled; });
                }
                publicProviders = providers.map(function (provider) {
                    ...
                    return ({
                        ...
                        displayName: ((_a = provider.metadata) === null || _a === void 0 ? void 0 : _a.displayName) || provider.name,
                        description: (_b = provider.metadata) === null || _b === void 0 ? void 0 : _b.description,
                        iconUrl: (_c = provider.metadata) === null || _c === void 0 ? void 0 : _c.iconUrl,
                        buttonColor: (_d = provider.metadata) === null || _d === void 0 ? void 0 : _d.buttonColor,
                        textColor: (_e = provider.metadata) === null || _e === void 0 ? void 0 : _e.textColor,
                        supportedDomains: (_f = provider.metadata) === null || _f === void 0 ? void 0 : _f.supportedDomains,
                        features: {
                        ...
                        scopes: (_g = provider.config.scopes) === null || _g === void 0 ? void 0 : _g.filter(function (scope) {
