    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            sessionSystem.securityEventLogger.getEvents(filters, {
              limit: limit,
              offset: offset,
...
function POST(request) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, (_d) => {
      switch (_d.label) {
        case 0:
          _d.trys.push([0, 12, undefined, 13]);
          return [4 /*yield*/, getCurrentUser()];
        case 1:
          user = _d.sent();
          return [4 /*yield*/, initializeSessionSystem()];
        ...
        case 7:
          ...
          return [
            4 /*yield*/,
            sessionSystem.securityEventLogger.resolveEvent(
              eventId,
              resolution,
        ...
        case 8:
          ...
          if (!success) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to resolve event" }, { status: 400 }),
            ];
          }
...
function DELETE(request) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 13, undefined, 14]);
          return [4 /*yield*/, getCurrentUser()];
        case 1:
          user = _a.sent();
          return [4 /*yield*/, initializeSessionSystem()];
        ...
        case 4:
          ...
          if (!success) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to delete event" }, { status: 400 }),
            ];
          }
          return [
            2 /*return*/,
        ...
        case 5:
          ...
          return [
            4 /*yield*/,
            sessionSystem.securityEventLogger.clearUserEvents(user.id),
            // Log the cleanup
          ];
        case 6:
        ...
        case 8:
          ...
          return [
            4 /*yield*/,
            sessionSystem.securityEventLogger.clearOldEvents(user.id, cutoffDate),
            // Log the cleanup
          ];
        case 9:
          deletedCount = _a.sent();
