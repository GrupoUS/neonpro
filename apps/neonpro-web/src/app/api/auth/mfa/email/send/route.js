...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, code, userId, supabase, _b, user, authError, rateLimitResult, response, result, emailError_1, error_1;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!email || !code || !userId) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Missing required parameters' }, { status: 400 })];
                    }
                ...
                case 3:
                    ...
                    if (authError || !user || user.id !== userId) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Unauthorized' }, { status: 401 })];
                    }
                ...
                case 10:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Failed to send email' }, { status: 500 })];
