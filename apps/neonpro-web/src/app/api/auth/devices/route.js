    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            sessionSystem.deviceManager.getUserDevices(user.id),
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            sessionSystem.deviceManager.generateFingerprint({
              userAgent: userAgent,
              ipAddress: clientIP,
            }),
            // Mark current device
        ...
        case 4:
          ...
          devicesWithCurrent = devices.map(function (device) {
            return __assign(__assign({}, device), {
              isCurrentDevice: device.fingerprint === currentDeviceFingerprint_1,
            });
          });
          return [
            2 /*return*/,
      ...
      switch (_g.label) {
        ...
        case 6:
          deviceInfo =
            ...
            (_f.metadata = __assign(__assign({}, body.metadata), {
          ...
          return [
            4 /*yield*/,
            sessionSystem.deviceManager.registerDevice(user.id, validation.data),
            // Log security event
          ];
        case 7:
          device = _g.sent();
        ...
        case 11:
          ...
          return [3 /*break*/, 14];
        case 12:
          return [4 /*yield*/, sessionSystem.deviceManager.untrustDevice(deviceId)];
        case 13:
          _d = _g.sent();
          _g.label = 14;
        case 14:
          ...
          return [
            ...
            sessionSystem.securityEventLogger.logEvent({
              ...
              severity: "medium",
              description: "Device "
                .concat(trusted ? "trusted" : "untrusted", ": ")
                .concat(device.name),
              userId: user.id,
              deviceId: deviceId,
              ipAddress: clientIP,
        ...
        case 17:
          ...
          return [
            4 /*yield*/,
            sessionSystem.deviceManager.reportSuspiciousDevice(deviceId, reason),
            // Log security event
          ];
        case 18:
          // Report suspicious device
          ...
          return [
            ...
            sessionSystem.securityEventLogger.logEvent({
              ...
              severity: "high",
              description: "Device reported as suspicious: "
                .concat(device.name, ". Reason: ")
                .concat(reason),
              userId: user.id,
              deviceId: deviceId,
              ipAddress: clientIP,
      ...
      switch (_a.label) {
        ...
        case 3:
          ...
          if (!deviceId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Device ID is required" }, { status: 400 }),
            ];
          }
          return [4 /*yield*/, sessionSystem.deviceManager.getDevice(deviceId)];
        case 4:
          ...
          return [
            4 /*yield*/,
            sessionSystem.deviceManager.updateDevice(
              deviceId,
              __assign(__assign({}, updates), { updatedAt: new Date().toISOString() }),
            ),
          ];
        case 5:
          success = _a.sent();
