        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (statusResult.success && ((_b = statusResult.data) === null || _b === void 0 ? void 0 : _b.isRunning)) {
                        return [2 /*return*/, server_1.NextResponse.json({
                                success: false,
                                error: {
                    ...
                    _c.label = 4;
                case 4: return [4 /*yield*/, cleanupService.runCleanup(tasks)];
                case 5:
                    result = _c.sent();
                    if (result.success) {
 ...
 */
function verifyCleanupPermissions(request_1) {
    return __awaiter(this, arguments, void 0, function (request, requireAdmin) {
        ...
        if (requireAdmin === void 0) { requireAdmin = false; }
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 4, , 5]);
 ...
 */
function validateCleanupTasks(tasks) {
    var validTasks = [
        'expired_sessions',
        'inactive_devices',
        'old_security_events',
    ...
    var invalidTasks = tasks.filter(function (task) { return !validTasks.includes(task); });
    return {
