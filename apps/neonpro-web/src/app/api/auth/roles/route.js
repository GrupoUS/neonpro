      ...
      switch (_c.label) {
        ...
        case 4:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to fetch users" }, { status: 500 }),
            ];
          }
          return [
            2 /*return*/,
      ...
      switch (_c.label) {
        ...
        case 9:
          ...
          if (updateError) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to update user role" }, { status: 500 }),
            ];
          }
          auditLog = {
          ...
          return [4 /*yield*/, supabase.from("permission_audit_log").insert(auditLog)];
        case 10:
          _c.sent();
          return [
            2 /*return*/,
