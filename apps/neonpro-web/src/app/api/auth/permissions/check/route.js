...
var PermissionCheckSchema = zod_1.z.union([
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authResult, requestBody, error_1, validationResult, data, user, result, permissions, result, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, permissions_1.hasPermission)(user, data.permission, data.resourceId, data.context)];
                case 6:
                    result = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                ...
                case 8:
                    result = _a.sent();
                    return [3 /*break*/, 11];
                case 9: return [4 /*yield*/, (0, permissions_1.hasAnyPermission)(user, permissions)];
                case 10:
                    result = _a.sent();
                    _a.label = 11;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json(__assign(__assign({}, userInfo), { capabilities: roleCapabilities }))];
                case 2:
                    error_3 = _a.sent();
...
function getRoleCapabilities(role) {
    ...
    switch (role) {
        case 'owner':
            return __assign(__assign({}, capabilities), { canManageUsers: true, canManagePatients: true, canManageAppointments: true, canViewBilling: true, canManageBilling: true, canManageClinic: true, canViewReports: true, canManageSystem: true });
        case 'manager':
            return __assign(__assign({}, capabilities), { canManageUsers: true, canManagePatients: true, canManageAppointments: true, canViewBilling: true, canManageBilling: true, canViewReports: true });
        case 'staff':
            return __assign(__assign({}, capabilities), { canManagePatients: true, canManageAppointments: true });
        case 'patient':
            return __assign({}, capabilities
