...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, userId, sessionId, eventType, severity, limit, offset, startDate, endDate, manager, filters, events, totalCount, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Internal server error while fetching security events' }, { status: 500 })];
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, sessionId, eventType, severity, description, metadata, manager, clientIP, userAgent, event_1, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), sessionId = _a.sessionId, eventType = _a.eventType, severity = _a.severity, description = _a.description, metadata = _a.metadata;
                    if (!sessionId || !eventType || !severity || !description) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Session ID, event type, severity, and description are required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, getSessionManager()];
                case 2:
                    manager = _b.sent();
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Internal server error during security event creation' }, { status: 500 })];
                case 5: return [2 /*return*/];
            }
        });
    });
