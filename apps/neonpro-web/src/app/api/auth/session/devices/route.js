    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          (_a = _c.sent()),
            (userId = _a.userId),
            (deviceName = _a.deviceName),
            (deviceType = _a.deviceType),
            (_b = _a.trusted),
            (trusted = _b === void 0 ? false : _b);
        ...
        case 3:
          ...
          return [
            ...
            manager.logSecurityEvent({
              ...
              severity: trusted
                ? session_1.SecuritySeverity.LOW
                : session_1.SecuritySeverity.MEDIUM,
        ...
        case 3:
          ...
          return [
            ...
            manager.logSecurityEvent({
              ...
              event_type: trusted
                ? session_1.SecurityEventType.DEVICE_TRUSTED
                : session_1.SecurityEventType.DEVICE_UNTRUSTED,
              severity: session_1.SecuritySeverity.MEDIUM,
              description: "Device "
                .concat(trusted ? "trusted" : "untrusted", ": ")
                .concat(deviceName || deviceId),
              ip_address: clientIP,
              user_agent: userAgent,
              metadata: {
                device_id: deviceId,
        ...
        case 3:
          ...
          return [
            ...
            manager.logSecurityEvent({
              ...
              severity: session_1.SecuritySeverity.MEDIUM,
              description: "Device removed: ".concat(
                (device === null || device === void 0 ? void 0 : device.device_name) || deviceId,
              ),
              ip_address: clientIP,
              user_agent: userAgent,
              metadata: {
