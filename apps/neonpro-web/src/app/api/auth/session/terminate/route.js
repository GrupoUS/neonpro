...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, sessionId, reason, sessionToken, manager, clientIP, userAgent, session, terminated, response, error_1;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    sessionToken = sessionId || ((_b = cookieStore.get('session-token')) === null || _b === void 0 ? void 0 : _b.value);
                    if (!sessionToken) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'No session token provided' }, { status: 400 })];
                    }
                ...
                case 4:
                    terminated = _c.sent();
                    if (!terminated) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to terminate session or session not found' }, { status: 404 })];
                    }
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Internal server error during session termination' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, manager.logSecurityEvent({
                            ...
                            metadata: {
                                ...
                                terminated_sessions: activeSessions.map(function (s) { return s.id; }),
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Internal server error during bulk session termination' }, { status: 500 })];
                case 7: return [2 /*return*/];
            }
        });
    });
