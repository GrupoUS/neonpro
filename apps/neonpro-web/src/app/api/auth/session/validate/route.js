...
function POST(request) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        case 0:
          _c.trys.push([0, 13, undefined, 14]);
          sessionToken =
            (_a = cookieStore.get("session-token")) === null || _a === void 0 ? void 0 : _a.value;
          if (!sessionToken) {
            return [
              2 /*return*/,
        ...
        case 2:
          ...
          return [
            ...
            manager.logSecurityEvent({
              ...
              description: "Session validation failed: ".concat(
                (_b = validation.errors) === null || _b === void 0 ? void 0 : _b.join(", "),
              ),
              ip_address: clientIP,
              user_agent: userAgent,
              metadata: {
        ...
        case 6:
          ...
          return [
            ...
            manager.logSecurityEvent({
              ...
              severity: session_1.SecuritySeverity.MEDIUM,
              description: "IP address changed from "
                .concat(session.ip_address, " to ")
                .concat(clientIP),
              ip_address: clientIP,
              user_agent: userAgent,
              metadata: {
