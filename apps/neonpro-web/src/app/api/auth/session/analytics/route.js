    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            manager.getSessionMetrics(userId, {
      ...
      switch (_a.label) {
        ...
        case 5:
          ...
          realTimeData = {
            ...
            alerts: {
              suspiciousActivity: recentSecurityEvents.filter(function (event) {
                return event.severity === "HIGH";
              }).length,
              newDevices: recentSecurityEvents.filter(function (event) {
                return event.event_type === "DEVICE_REGISTERED";
              }).length,
              failedValidations: recentSecurityEvents.filter(function (event) {
                return event.event_type === "SESSION_VALIDATION_FAILED";
              }).length,
            },
          };
