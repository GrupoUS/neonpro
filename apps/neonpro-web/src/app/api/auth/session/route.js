...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var sessionSystem, searchParams, sessionId, validation, session, _a, activities, securityScore, error_1;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!validation.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid session ID format' }, { status: 400 })];
                    }
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var sessionSystem, body, action, clientIP, userAgent, _a, validation, _b, sessionId, _c, extendBy, success, validation, sessionId, isValid, session, _d, validation, _e, sessionId, activityType, metadata, error_2;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    ...
                    _a = action;
                    switch (_a) {
                        case 'extend': return [3 /*break*/, 3];
                        case 'validate': return [3 /*break*/, 6];
                        case 'activity': return [3 /*break*/, 11];
                    }
                    return [3 /*break*/, 13];
                case 3:
                    ...
                    _b = validation.data, sessionId = _b.sessionId, _c = _b.extendBy, extendBy = _c === void 0 ? 30 : _c;
                ...
                case 11:
                    ...
                    _e = validation.data, sessionId = _e.sessionId, activityType = _e.activityType, metadata = _e.metadata;
                    // Record activity
                    return [4 /*yield*/, sessionSystem.sessionManager.recordActivity(sessionId, activityType, __assign(__assign({}, metadata), { ipAddress: clientIP, userAgent: userAgent }))];
                case 12:
                    // Record activity
                    _f.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    success = _a.sent();
                    if (!success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update session' }, { status: 400 })];
                    }
                    // Log security event
                    return [4 /*yield*/, sessionSystem.securityEventLogger.logEvent({
