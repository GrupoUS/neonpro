...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, extendMinutes, reason, sessionToken, manager, clientIP, userAgent, validation, currentSession, extendedSession, error_1;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    sessionToken = (_b = cookieStore.get('session-token')) === null || _b === void 0 ? void 0 : _b.value;
                    if (!sessionToken) {
                    ...
                    if (!extendMinutes || extendMinutes <= 0 || extendMinutes > 480) { // Max 8 hours
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid extension duration. Must be between 1 and 480 minutes.' }, { status: 400 })];
                    }
                ...
                case 7:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Internal server error during session extension' }, { status: 500 })];
