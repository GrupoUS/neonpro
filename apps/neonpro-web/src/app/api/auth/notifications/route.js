...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var user, sessionSystem, searchParams, action, preferences, stats, queryData, validation, _a, limit, offset, type, priority, status_1, startDate, endDate, filters, notifications, unreadCount, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 9, , 10]);
                ...
                case 4:
                    ...
                    return [4 /*yield*/, sessionSystem.notificationService.getNotificationStatistics(user.id)];
                case 5:
                    stats = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            statistics: stats,
                ...
                case 6:
                    ...
                    _a = validation.data, limit = _a.limit, offset = _a.offset, type = _a.type, priority = _a.priority, status_1 = _a.status, startDate = _a.startDate, endDate = _a.endDate;
                    filters = {
                        userId: user.id
                    };
                    if (type)
                    ...
                    return [4 /*yield*/, sessionSystem.notificationService.getUserNotifications(user.id, {
                            limit: limit,
                            offset: offset,
                            filters: filters,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var user_1, sessionSystem_1, body, action, clientIP, userAgent, _a, validation, _b, type, priority, title, message, channels, metadata, scheduledFor, notification, notificationIds, results, successCount, markedCount, error_2;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    switch (_a) {
                        ...
                        case 'mark_read': return [3 /*break*/, 7];
                        case 'mark_all_read': return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 11];
                case 4:
                    validation = sendNotificationSchema.safeParse(body);
                    if (!validation.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid notification data', details: validation.error.errors }, { status: 400 })];
                    }
                    _b = validation.data, type = _b.type, priority = _b.priority, title = _b.title, message = _b.message, channels = _b.channels, metadata = _b.metadata, scheduledFor = _b.scheduledFor;
                    return [4 /*yield*/, sessionSystem_1.notificationService.sendNotification({
                            userId: user_1.id,
                            type: type,
                            priority: priority,
                            title: title,
                            ...
                            metadata: __assign(__assign({}, metadata), { sentViaAPI: true, senderIP: clientIP, senderUserAgent: userAgent }),
                ...
                case 5:
                    ...
                    // Log security event
                    return [4 /*yield*/, sessionSystem_1.securityEventLogger.logEvent({
                ...
                case 7:
                    ...
                    if (!Array.isArray(notificationIds) || notificationIds.length === 0) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid notification IDs' }, { status: 400 })];
                    }
                    return [4 /*yield*/, Promise.all(notificationIds.map(function (id) {
                ...
                case 9: return [4 /*yield*/, sessionSystem_1.notificationService.markAllAsRead(user_1.id)];
                case 10:
                    markedCount = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!validation.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid preferences data', details: validation.error.errors }, { status: 400 })];
                    }
                    preferences = validation.data;
                    return [4 /*yield*/, sessionSystem.notificationService.updateUserPreferences(user.id, preferences)];
                case 4:
                    success = _a.sent();
                    if (!success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update preferences' }, { status: 400 })];
                    }
                    // Log security event
...
function DELETE(request) {
    return __awaiter(this, void 0, void 0, function () {
        var user, sessionSystem, searchParams, notificationId, clearAll, clearRead, olderThan, success, deletedCount, deletedCount, cutoffDate, deletedCount, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    ...
                    return [4 /*yield*/, sessionSystem.notificationService.deleteNotification(notificationId, user.id)];
                case 3:
                    success = _a.sent();
                    if (!success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to delete notification or notification not found' }, { status: 400 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 4:
                    ...
                    return [4 /*yield*/, sessionSystem.notificationService.clearUserNotifications(user.id)
                        // Log the cleanup
                    ];
                case 5:
                    ...
                    return [4 /*yield*/, sessionSystem.securityEventLogger.logEvent({
                            type: 'data_deletion',
                            severity: 'medium',
                            description: "All notifications cleared: ".concat(deletedCount, " notifications deleted"),
                            userId: user.id,
                            ipAddress: getClientIP(request),
                            userAgent: getUserAgent(request),
                ...
                case 7:
                    ...
                    return [4 /*yield*/, sessionSystem.notificationService.clearReadNotifications(user.id)
                        // Log the cleanup
                    ];
                case 8:
                    deletedCount = _a.sent();
                    ...
                    return [4 /*yield*/, sessionSystem.securityEventLogger.logEvent({
                            type: 'data_deletion',
                            severity: 'low',
                            description: "Read notifications cleared: ".concat(deletedCount, " notifications deleted"),
                            userId: user.id,
                            ipAddress: getClientIP(request),
                            userAgent: getUserAgent(request),
                ...
                case 10:
                    ...
                    return [4 /*yield*/, sessionSystem.notificationService.clearOldNotifications(user.id, cutoffDate)
                        // Log the cleanup
                    ];
                case 11:
                    deletedCount = _a.sent();
                    ...
                    return [4 /*yield*/, sessionSystem.securityEventLogger.logEvent({
                            type: 'data_deletion',
                            severity: 'low',
                            description: "Old notifications cleared: ".concat(deletedCount, " notifications deleted"),
                            userId: user.id,
                            ipAddress: getClientIP(request),
                            userAgent: getUserAgent(request),
                ...
                case 13: return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid delete operation' }, { status: 400 })];
