        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 5:
                    ...
                    if (error || !account) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Account not found' }, { status: 404 })];
                    }
                    accountWithTokenStatus = __assign(__assign({}, account), { has_access_token: !!account.access_token, has_refresh_token: !!account.refresh_token, token_valid: account.token_expires_at ?
                            new Date(account.token_expires_at) > new Date() : null, access_token: undefined, refresh_token: undefined });
...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var id, supabase, session, profile, existingAccount, body, validatedData, _c, updatedAccount, error, error_2;
        var params = _b.params;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                ...
                case 7:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update account' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: updatedAccount,
            ...
            switch (_c.label) {
                ...
                case 7:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to disconnect account' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 9:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to delete account' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
            ...
            switch (_d.label) {
                ...
                case 6:
                    ...
                    switch (_c) {
                        ...
                        case 'test_connection': return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 10];
