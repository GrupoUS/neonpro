...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, profile, searchParams, platform, status_1, syncStatus, query, _a, accounts, error, sanitizedAccounts, error_1;
            ...
            switch (_b.label) {
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch accounts' }, { status: 500 })];
                    }
                    sanitizedAccounts = accounts === null || accounts === void 0 ? void 0 : accounts.map(function (account) { return (__assign(__assign({}, account), { has_access_token: !!account.access_token, has_refresh_token: !!account.refresh_token, access_token: undefined, refresh_token: undefined })); });
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, profile, body, validatedData, platform, existingAccount, accountData, _a, newAccount, error, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 9, , 10]);
                ...
                case 5:
                    ...
                    if (!platform) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid platform' }, { status: 400 })];
                    }
                ...
                case 6:
                    ...
                    if (existingAccount) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Account already connected' }, { status: 409 })];
                    }
                    _b.label = 7;
                case 7:
                    accountData = __assign(__assign({}, validatedData), { clinic_id: profile.clinic_id, created_by: session.user.id });
                    return [4 /*yield*/, supabase
                            .from('social_media_accounts')
                            .insert([accountData])
                            .select("\n        id,\n        platform_name,\n        account_name,\n        account_handle,\n        account_id,\n        account_metadata,\n        sync_settings,\n        sync_status,\n        status,\n        created_at,\n        social_media_platforms!inner(\n          platform_display_name,\n          platform_icon_url\n        )\n      ")
                ...
                case 8:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create account connection' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: newAccount,
