...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, body, plan_id, billing_cycle, _a, payment_provider, userClinic, _b, plan, planError, price, existingSubscription, checkoutData, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    body = _c.sent();
                    plan_id = body.plan_id, billing_cycle = body.billing_cycle, _a = body.payment_provider, payment_provider = _a === void 0 ? 'stripe' : _a;
                    // Validate input
                    if (!plan_id || !billing_cycle) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing required fields: plan_id, billing_cycle' }, { status: 400 })];
                    }
                ...
                case 4:
                    ...
                    if (!userClinic) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'No active clinic found' }, { status: 404 })];
                    }
                    return [4 /*yield*/, supabase
                ...
                case 5:
                    ...
                    if (planError || !plan) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid subscription plan' }, { status: 400 })];
                    }
                    price = void 0;
                    switch (billing_cycle) {
                        ...
                        case 'yearly':
                            ...
                            break;
                        default:
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid billing cycle' }, { status: 400 })];
                    }
                    if (price <= 0) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Price not available for selected billing cycle' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                ...
                case 6:
                    ...
                    return [4 /*yield*/, createStripeCheckout({
                            plan: plan,
                ...
                case 8:
                    ...
                    return [4 /*yield*/, createMercadoPagoCheckout({
                            plan: plan,
                            billing_cycle: billing_cycle,
                            price: price,
                            user: session.user,
                ...
                case 9:
                    checkoutData = _c.sent();
                    return [3 /*break*/, 11];
                case 10: return [2 /*return*/, server_1.NextResponse.json({ error: 'Unsupported payment provider' }, { status: 400 })];
                case 11: 
                // Create billing event record
                return [4 /*yield*/, supabase
                        .from('billing_events')
                        .insert({
                        subscription_id: (existingSubscription === null || existingSubscription === void 0 ? void 0 : existingSubscription.id) || null,
...
function createStripeCheckout(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            plan = params.plan, billing_cycle = params.billing_cycle, price = params.price, user = params.user, clinic_id = params.clinic_id;
            // Placeholder response - replace with actual Stripe implementation
            return [2 /*return*/, {
                    url: "".concat(process.env.NEXT_PUBLIC_APP_URL, "/subscription/checkout/stripe?session_id=placeholder_session_id"),
                    session_id: "cs_test_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9))
                }];
        });
    });
}
...
function createMercadoPagoCheckout(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, {
                    url: "".concat(process.env.NEXT_PUBLIC_APP_URL, "/subscription/checkout/mercado-pago?session_id=placeholder_session_id"),
