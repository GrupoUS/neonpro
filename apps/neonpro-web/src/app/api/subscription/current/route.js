...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, userClinic, _a, subscription, error, usageStats, subscriptionStatus, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: __assign(__assign({}, subscription), { status_info: subscriptionStatus, usage_stats: usageStats, formatted_dates: {
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, body, cancel_at_period_end, cancellation_reason, userClinic, updateData, _a, updatedSubscription, error, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 6, , 7]);
                ...
                case 3:
                    body = _b.sent();
                    cancel_at_period_end = body.cancel_at_period_end, cancellation_reason = body.cancellation_reason;
                    return [4 /*yield*/, supabase
                            .from('user_clinics')
                            .select('clinic_id')
                            .eq('user_id', session.user.id)
                ...
                case 5:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update subscription' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    usagePromises = Object.keys(limits).map(function (limitKey) { return __awaiter(_this, void 0, void 0, function () {
                        var currentUsage, _a, patientCount, startOfMonth, appointmentCount, userCount, limit, percentage;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    currentUsage = 0;
