    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a = _b.sent(), plans = _a.data, error = _a.error;
                    if (error) {
                        console.error('Error fetching subscription plans:', error);
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch subscription plans' }, { status: 500 })];
                    }
                    formattedPlans = plans.map(function (plan) { return (__assign(__assign({}, plan), { savings: {
                ...
                case 3:
                    error_1 = _b.sent();
                    console.error('Subscription plans API error:', error_1);
