...
function GET(request) {
  return __awaiter(this, void 0, void 0, function () {
    var searchParams, clinicId, dashboardData, error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4 /*yield*/, supplierService.getDashboardData(clinicId)];
        case 1:
          dashboardData = _a.sent();
          return [2 /*return*/, server_1.NextResponse.json(dashboardData)];
        case 2:
          error_1 = _a.sent();
          console.error("Erro ao buscar dados do dashboard:", error_1);
          return [
            2 /*return*/,
