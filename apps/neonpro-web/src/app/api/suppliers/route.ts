...
import type { createSupplierSchema, supplierFiltersSchema } from "@/app/lib/validations/suppliers";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const supplier = await supplierService.createSupplier(clinicId, validationResult.data);
