...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, supplierId, evaluations, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supplierService.getSupplierEvaluations(supplierId)];
                case 1:
                    evaluations = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ evaluations: evaluations })];
                case 2:
                    error_1 = _a.sent();
                    console.error('Erro ao buscar avaliações:', error_1);
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validationResult, evaluation, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    body = _a.sent();
                    validationResult = suppliers_1.createEvaluationSchema.safeParse(body);
                    if (!validationResult.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Dados inválidos', details: validationResult.error.issues }, { status: 400 })];
                    }
                    return [4 /*yield*/, supplierService.createEvaluation(validationResult.data)];
                case 2:
                    evaluation = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(evaluation, { status: 201 })];
                case 3:
                    error_2 = _a.sent();
                    console.error('Erro ao criar avaliação:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro interno do servidor' }, { status: 500 })];
