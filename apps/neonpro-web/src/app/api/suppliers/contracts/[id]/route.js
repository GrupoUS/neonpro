    ...
    return __awaiter(this, arguments, void 0, function (request, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, supplierService.getContract(params.id)];
                case 1:
                    contract = _c.sent();
                    if (!contract) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Contrato não encontrado' }, { status: 404 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json(contract)];
                case 2:
                    error_1 = _c.sent();
                    console.error('Erro ao buscar contrato:', error_1);
    ...
    return __awaiter(this, arguments, void 0, function (request, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    body = _c.sent();
                    validationResult = zod_1.z.any().safeParse(body);
                    if (!validationResult.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Dados inválidos', details: validationResult.error.issues }, { status: 400 })];
                    }
                    return [4 /*yield*/, supplierService.updateContract(params.id, validationResult.data)];
                case 2:
                    contract = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json(contract)];
                case 3:
                    error_2 = _c.sent();
                    console.error('Erro ao atualizar contrato:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro interno do servidor' }, { status: 500 })];
