      ...
      switch (_c.label) {
        ...
        case 1:
          ...
          if (!supplier) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Fornecedor não encontrado" }, { status: 404 }),
            ];
          }
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            supplierService.updateSupplier(clinicId, params.id, validationResult.data),
          ];
        case 2:
          supplier = _c.sent();
          return [2 /*return*/, server_1.NextResponse.json(supplier)];
      ...
      switch (_c.label) {
        ...
        case 2:
          ...
          if (error_3 instanceof Error && error_3.message.includes("contratos ativos")) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: error_3.message }, { status: 409 }),
            ];
          }
          return [
            2 /*return*/,
