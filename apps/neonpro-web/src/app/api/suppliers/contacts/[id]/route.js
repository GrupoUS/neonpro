...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var body, validationResult, contact, error_1;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!validationResult.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Dados inválidos' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supplierService.updateContact(params.id, validationResult.data)];
                case 2:
                    contact = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json(contact)];
                case 3:
                    error_1 = _c.sent();
                    console.error('Erro ao atualizar contato:', error_1);
