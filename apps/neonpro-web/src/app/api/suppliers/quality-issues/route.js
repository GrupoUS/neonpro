...
function GET(request) {
  return __awaiter(this, void 0, void 0, function () {
    var searchParams, clinicId, summary, error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4 /*yield*/, supplierService.getQualityIssuesSummary(clinicId)];
        case 1:
          summary = _a.sent();
          return [2 /*return*/, server_1.NextResponse.json({ summary: summary })];
        case 2:
          error_1 = _a.sent();
          console.error("Erro ao buscar resumo de issues:", error_1);
          return [
            2 /*return*/,
...
function POST(request) {
  return __awaiter(this, void 0, void 0, function () {
    var body, validationResult, issue, error_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 3, , 4]);
        ...
        case 1:
          body = _a.sent();
          validationResult = suppliers_1.createQualityIssueSchema.safeParse(body);
          ...
          return [4 /*yield*/, supplierService.createQualityIssue(validationResult.data)];
        case 2:
          issue = _a.sent();
          return [2 /*return*/, server_1.NextResponse.json(issue, { status: 201 })];
        case 3:
          error_2 = _a.sent();
          console.error("Erro ao criar issue de qualidade:", error_2);
          return [
            2 /*return*/,
            server_1.NextResponse.json({ error: "Erro interno do servidor" }, { status: 500 }),
          ];
