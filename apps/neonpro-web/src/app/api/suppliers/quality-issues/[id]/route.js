...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var body, validationResult, issue, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, supplierService.updateQualityIssue(params.id, validationResult.data)];
                case 2:
                    issue = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json(issue)];
                case 3:
                    error_1 = _c.sent();
                    console.error('Erro ao atualizar issue:', error_1);
