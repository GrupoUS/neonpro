        ...
        case 0:
          ...
          if (searchParams.get("supplier_type")) {
            filters.supplier_type =
              (_a = searchParams.get("supplier_type")) === null || _a === void 0
                ? void 0
                : _a.split(",");
          }
          if (searchParams.get("status")) {
            filters.status =
              (_b = searchParams.get("status")) === null || _b === void 0 ? void 0 : _b.split(",");
          }
          ...
          return [
            4 /*yield*/,
            supplierService.listSuppliers(clinicId, validationResult.data, page, limit),
          ];
        case 1:
          result = _c.sent();
      ...
      switch (_a.label) {
        ...
        case 3:
          ...
          if (error_2 instanceof Error && error_2.message.includes("já existe")) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: error_2.message }, { status: 409 }),
            ];
          }
          return [
            2 /*return*/,
