...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, clinicId, periodStart, periodEnd, analytics, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!clinicId || !periodStart || !periodEnd) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'clinic_id, period_start e period_end são obrigatórios' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supplierService.getSupplierAnalytics(clinicId, periodStart, periodEnd)];
                case 1:
                    analytics = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(analytics)];
                case 2:
                    error_1 = _a.sent();
                    console.error('Erro ao buscar analytics:', error_1);
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validationResult, comparison, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    body = _a.sent();
                    validationResult = suppliers_1.supplierComparisonSchema.safeParse(body);
                    if (!validationResult.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Dados inválidos', details: validationResult.error.issues }, { status: 400 })];
                    }
                    return [4 /*yield*/, supplierService.compareSuppliers(validationResult.data.supplier_ids)];
                case 2:
                    comparison = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(comparison)];
                case 3:
                    error_2 = _a.sent();
                    console.error('Erro ao comparar fornecedores:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro interno do servidor' }, { status: 500 })];
