...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, supplierId, communications, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!supplierId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'supplier_id é obrigatório' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supplierService.getSupplierCommunications(supplierId)];
                case 1:
                    communications = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ communications: communications })];
                case 2:
                    error_1 = _a.sent();
                    console.error('Erro ao buscar comunicações:', error_1);
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validationResult, communication, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    body = _a.sent();
                    validationResult = suppliers_1.createCommunicationSchema.safeParse(body);
                    if (!validationResult.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Dados inválidos', details: validationResult.error.issues }, { status: 400 })];
                    }
                    return [4 /*yield*/, supplierService.createCommunication(validationResult.data)];
                case 2:
                    communication = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(communication, { status: 201 })];
                case 3:
                    error_2 = _a.sent();
                    console.error('Erro ao criar comunicação:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro interno do servidor' }, { status: 500 })];
