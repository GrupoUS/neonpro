    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            (0, unified_search_1.createunifiedSearchSystem)().conversationalSearch(
              naturalQuery,
              session.user.id,
              "user",
            ),
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            (0, unified_search_1.createunifiedSearchSystem)().smartSearch(
              naturalQuery,
              {
        ...
        case 6:
          query = {
            ...
            filters: {
              types:
                ((_a = searchParams.get("types")) === null || _a === void 0
                  ? void 0
                  : _a.split(",")) || undefined,
              dateRange:
              ...
              status:
                ((_b = searchParams.get("status")) === null || _b === void 0
                  ? void 0
                  : _b.split(",")) || undefined,
              priority:
                ((_c = searchParams.get("priority")) === null || _c === void 0
                  ? void 0
                  : _c.split(",")) || undefined,
            },
            options: {
        ...
        case 7:
          ...
          logSearchAnalytics(session.user.id, query.term, "traditional", response.totalCount).catch(
            function (error) {
              return console.error("Failed to log search analytics:", error);
            },
          );
          return [
            2 /*return*/,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          return [
            4 /*yield*/,
            (0, unified_search_1.createunifiedSearchSystem)().advancedSearch(data.criteria),
          ];
        case 3:
          response = _b.sent();
          return [
        ...
        case 4:
          return [
            4 /*yield*/,
            (0, unified_search_1.createunifiedSearchSystem)().saveSearch(
              data.name,
              data.query,
              data.userId,
            ),
        ...
        case 6:
          return [
            4 /*yield*/,
            (0, unified_search_1.createunifiedSearchSystem)().getSearchStatistics(data.timeframe),
          ];
        case 7:
          stats = _b.sent();
          return [
