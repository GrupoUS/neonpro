    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                ...
                return [2 /*return*/, server_1.NextResponse.json({ message: 'WebSocket server ready' }, { status: 200 })];
            }
            catch (error) {
                console.error('WebSocket setup error:', error);
                return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to setup WebSocket server' }, { status: 500 })];
            }
            return [2 /*return*/];
        });
    });
            ...
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case 'unsubscribe': return [3 /*break*/, 4];
                        case 'ping': return [3 /*break*/, 5];
                    }
                    return [3 /*break*/, 6];
                case 1:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    channelRules = {
                        'analytics': function (uid) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                // Users can access their own analytics
                                return [2 /*return*/, true];
                            });
                        }); },
                        'trials': function (uid) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                // Users can access their trial updates
                                return [2 /*return*/, true];
                            });
                        }); },
                        'admin': function (uid) { return __awaiter(_this, void 0, void 0, function () {
                            var user;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                        ...
                        'global': function (uid) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
