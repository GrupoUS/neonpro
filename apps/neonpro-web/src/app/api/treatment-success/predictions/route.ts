...
import type { createSuccessPredictionSchema } from "@/app/lib/validations/treatment-success";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const prediction = await treatmentSuccessService.createSuccessPrediction(validatedData);
