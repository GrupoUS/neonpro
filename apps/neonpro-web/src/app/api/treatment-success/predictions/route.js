...
function POST(request) {
  return __awaiter(this, void 0, void 0, function () {
    var body, validatedData, prediction, error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          body = _a.sent();
          validatedData = treatment_success_2.createSuccessPredictionSchema.parse(body);
          return [4 /*yield*/, treatmentSuccessService.createSuccessPrediction(validatedData)];
        case 2:
          prediction = _a.sent();
          return [
            2 /*return*/,
        ...
        case 3:
          error_1 = _a.sent();
          console.error("Error creating success prediction:", error_1);
