        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, treatmentSuccessService.getComplianceReports(page, limit)];
                case 1:
                    result = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching compliance reports:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validatedData, report, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    body = _a.sent();
                    validatedData = treatment_success_2.createComplianceReportSchema.parse(body);
                    return [4 /*yield*/, treatmentSuccessService.createComplianceReport(validatedData)];
                case 2:
                    report = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('Error creating compliance report:', error_2);
