      ...
      switch (_a.label) {
        case 0:
          ...
          filters = {
            ...
            implementation_priority: searchParams.get("implementation_priority"),
            approval_status: searchParams.get("approval_status"),
            success_improvement_min: searchParams.get("success_improvement_min")
              ? parseFloat(searchParams.get("success_improvement_min"))
              : undefined,
          };
          return [
            4 /*yield*/,
            treatmentSuccessService.getProtocolOptimizations(filters, page, limit),
          ];
        case 1:
          result = _a.sent();
          return [
        ...
        case 2:
          error_1 = _a.sent();
          console.error("Error fetching protocol optimizations:", error_1);
          return [
            2 /*return*/,
            server_1.NextResponse.json(
              {
...
function POST(request) {
  return __awaiter(this, void 0, void 0, function () {
    var body, validatedData, optimization, error_2;
    return __generator(this, (_a) => {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 3, , 4]);
        ...
        case 1:
          body = _a.sent();
          validatedData = treatment_success_2.createProtocolOptimizationSchema.parse(body);
          return [4 /*yield*/, treatmentSuccessService.createProtocolOptimization(validatedData)];
        case 2:
        ...
        case 3:
          error_2 = _a.sent();
          console.error("Error creating protocol optimization:", error_2);
