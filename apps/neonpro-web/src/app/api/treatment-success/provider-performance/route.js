      ...
      switch (_a.label) {
        case 0:
          ...
          filters = {
            ...
            evaluation_period: searchParams.get("evaluation_period"),
          ...
          return [
            4 /*yield*/,
            treatmentSuccessService.getProviderPerformance(filters, page, limit),
          ];
        case 1:
          result = _a.sent();
          return [
        ...
        case 2:
          error_1 = _a.sent();
          console.error("Error fetching provider performance:", error_1);
          return [
            2 /*return*/,
            server_1.NextResponse.json(
              {
