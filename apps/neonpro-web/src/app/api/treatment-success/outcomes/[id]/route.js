    ...
    return __awaiter(this, arguments, void 0, function (request, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, treatmentSuccessService.getTreatmentOutcomeById(params.id)];
                case 1:
                    outcome = _c.sent();
                ...
                case 2:
                    error_1 = _c.sent();
                    console.error('Error fetching treatment outcome:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
    ...
    return __awaiter(this, arguments, void 0, function (request, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    body = _c.sent();
                    validatedData = treatment_success_2.updateTreatmentOutcomeSchema.parse(body);
                    return [4 /*yield*/, treatmentSuccessService.updateTreatmentOutcome(params.id, validatedData)];
                case 2:
                    outcome = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 3:
                    error_2 = _c.sent();
                    console.error('Error updating treatment outcome:', error_2);
    ...
    return __awaiter(this, arguments, void 0, function (request, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, treatmentSuccessService.deleteTreatmentOutcome(params.id)];
                case 1:
                    _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 2:
                    error_3 = _c.sent();
                    console.error('Error deleting treatment outcome:', error_3);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
                            error: 'Erro interno do servidor',
