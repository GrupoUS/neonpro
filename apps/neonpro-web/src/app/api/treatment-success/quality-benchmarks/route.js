...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, page, limit, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, treatmentSuccessService.getQualityBenchmarks(page, limit)];
                case 1:
                    result = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching quality benchmarks:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validatedData, benchmark, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    body = _a.sent();
                    validatedData = treatment_success_2.createQualityBenchmarkSchema.parse(body);
                    return [4 /*yield*/, treatmentSuccessService.createQualityBenchmark(validatedData)];
                case 2:
                    benchmark = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('Error creating quality benchmark:', error_2);
