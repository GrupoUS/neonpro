        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, treatmentSuccessService.getSuccessMetrics(filters, page, limit)];
                case 1:
                    result = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching success metrics:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, treatment_type, provider_id, _a, time_period, metrics, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    body = _b.sent();
                    treatment_type = body.treatment_type, provider_id = body.provider_id, _a = body.time_period, time_period = _a === void 0 ? 'monthly' : _a;
                    if (!treatment_type) {
                        return [2 /*return*/, server_1.NextResponse.json({
                                success: false,
                    ...
                    return [4 /*yield*/, treatmentSuccessService.generateSuccessMetrics(treatment_type, provider_id, time_period)];
                case 2:
                    metrics = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 3:
                    error_2 = _b.sent();
                    console.error('Error generating success metrics:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
                            error: 'Erro interno do servidor',
