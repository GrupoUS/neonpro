...
function GET(request) {
  return __awaiter(this, void 0, void 0, function () {
    var authResult, user, searchParams, period, clinicId, dashboardData, error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            analytics_1.analyticsService.getDashboardOverview({
              period: period,
        ...
        case 4:
          error_1 = _a.sent();
          console.error("Dashboard analytics error:", error_1);
          return [
            2 /*return*/,
            server_1.NextResponse.json(
              {
