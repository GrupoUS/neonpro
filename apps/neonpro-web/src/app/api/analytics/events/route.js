...
function POST(request) {
  return __awaiter(this, void 0, void 0, function () {
    var body, events, _validation, validation, user_1, authResult, _a, trackedEvents, error_1;
              ...
              events.map((event) =>
                __awaiter(this, void 0, void 0, function () {
                  ...
                  return __generator(this, (_a) => {
                    switch (_a.label) {
                      case 0:
                        eventData = __assign(__assign({}, event), {
                          userId:
                            (user_1 === null || user_1 === void 0 ? void 0 : user_1.id) ||
                            event.userId,
                          clinicId:
                            (user_1 === null || user_1 === void 0 ? void 0 : user_1.clinicId) ||
                            event.clinicId,
    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            (0, auth_1.requireAuth)(["admin", "clinic_owner", "manager"])(request),
          ];
        case 1:
          authResult = _a.sent();
          if (!authResult.authenticated) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            analytics_1.analyticsService.getEvents({
