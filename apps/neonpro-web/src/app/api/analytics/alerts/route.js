    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 3:
          ...
          countQuery = supabase.from("kpi_alerts").select("*", { count: "exact", head: true });
            ...
            (alerts === null || alerts === void 0
              ...
              : alerts.map((alert) => {
                  ...
                  return {
                    ...
                    kpi_id: alert.kpi_id,
                    kpi_name:
                      (_a = alert.financial_kpis) === null || _a === void 0 ? void 0 : _a.kpi_name,
                    kpi_category:
                      (_b = alert.financial_kpis) === null || _b === void 0
                        ? void 0
                        : _b.kpi_category,
