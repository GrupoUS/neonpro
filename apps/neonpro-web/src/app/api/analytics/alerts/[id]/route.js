                ...
                case 2:
                    ...
                    if (error) {
                        if (error.code === 'PGRST116') {
                            return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Alert not found' }, { status: 404 })];
                        }
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            data: {
                                ...
                                kpi_name: (_e = alert_1.financial_kpis) === null || _e === void 0 ? void 0 : _e.kpi_name,
                                kpi_category: (_f = alert_1.financial_kpis) === null || _f === void 0 ? void 0 : _f.kpi_category,
...
function PATCH(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, userError, body, action, metadata, updateData, _d, updatedAlert, error, error_2;
        var _e, _f;
        var params = _b.params;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 2:
                    ...
                    if (action === 'acknowledge') {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Invalid action. Use "acknowledge" or "unacknowledge"' }, { status: 400 })];
                    }
                    if (metadata) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            data: {
                                ...
                                kpi_name: (_e = updatedAlert.financial_kpis) === null || _e === void 0 ? void 0 : _e.kpi_name,
                                kpi_category: (_f = updatedAlert.financial_kpis) === null || _f === void 0 ? void 0 : _f.kpi_category,
