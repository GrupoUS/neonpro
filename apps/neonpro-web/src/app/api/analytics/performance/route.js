    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 2:
          ...
          validMetrics = metricsArray.filter(
            (metric) =>
              metric.name &&
          ...
          if (validMetrics.length === 0) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "No valid metrics provided" }, { status: 400 }),
            ];
          }
        ...
        case 3:
          ...
          userId_1 =
            (_b = session === null || session === void 0 ? void 0 : session.user) === null ||
            _b === void 0
              ? void 0
              : _b.id;
          enrichedMetrics = validMetrics.map((metric) => {
            var _a, _b;
            return __assign(__assign({}, metric), {
              userId: userId_1 || null,
              ...
              grade: metric.grade || calculateGrade(metric.name, metric.value),
              ip_address: getClientIP(request),
              country:
                ((_a = request.geo) === null || _a === void 0 ? void 0 : _a.country) || "unknown",
              city: ((_b = request.geo) === null || _b === void 0 ? void 0 : _b.city) || "unknown",
            });
          });
          return [
            4 /*yield*/,
            supabase.from("performance_metrics").insert(enrichedMetrics).select(),
          ];
        case 4:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to store metrics" }, { status: 500 }),
            ];
          }
          // Check for performance alerts
          return [
            4 /*yield*/,
            checkPerformanceAlerts(enrichedMetrics, supabase),
          ...
          response_1 = server_1.NextResponse.json({
            ...
            metrics:
              data === null || data === void 0
                ? void 0
                : data.map((d) => ({ id: d.id, name: d.name, grade: d.grade })),
          });
      ...
      switch (_b.label) {
        ...
        case 3:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to fetch metrics" }, { status: 500 }),
            ];
          }
...
function generateSessionId(request) {
  ...
  return Buffer.from("".concat(ip, "-").concat(userAgent, "-").concat(timestamp))
    .toString("base64")
    .slice(0, 16);
}
...
function calculateAggregatedStats(metrics) {
  ...
  for (var _a = 0, _b = Object.entries(statsByMetric); _a < _b.length; _a++) {
    var _c = _b[_a],
      metricName = _c[0],
      stats = _c[1];
    var values = stats.values.sort((a, b) => a - b);
    var count = values.length;
    statsByMetric[metricName] = __assign(__assign({}, stats), {
      min: values[0],
      max: values[count - 1],
        ...
        case 1:
          ...
          console.warn(
            "\uD83D\uDEA8 Critical performance issue: "
              .concat(metric.name, " = ")
              .concat(metric.value, "ms (threshold: ")
              .concat(threshold.critical, "ms)"),
          );
          _a.label = 2;
        case 2:
          ...
          return [
            4 /*yield*/,
            supabase.from("performance_alerts").insert({
