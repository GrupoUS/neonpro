  ...
  if (data.statistics) {
    ...
    var statsData = [
      [
        ...
        "".concat((data.statistics.averageRetention || 0).toFixed(2), "%"),
      ],
...
function generateInsightsPDF(data, options) {
  ...
  if (data.predictions && data.predictions.length > 0) {
    ...
    data.predictions.slice(0, 10).forEach(function (pred, index) {
      ...
      doc.text(
        "Confidence: ".concat(
          pred.confidence ? "".concat((pred.confidence * 100).toFixed(1), "%") : "N/A",
        ),
        20,
        yPosition,
      );
      ...
      if (section.key === "insights") {
        ...
        var summaryData = data[section.key].slice(0, section.maxRows).map(function (item, index) {
          ...
          return [
            ...
            ((_a = item.value) === null || _a === void 0 ? void 0 : _a.toString()) ||
              ((_b = item.prediction) === null || _b === void 0 ? void 0 : _b.toString()) ||
              "N/A",
          ];
        });
        doc.autoTable({
...
function addPDFFooter(doc) {
  ...
  for (var i = 1; i <= pageCount; i++) {
    ...
    doc.text(
      "Page ".concat(i, " of ").concat(pageCount),
