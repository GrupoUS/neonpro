...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, body, validatedData_1, kpiEngine, results, formattedResults, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, kpiEngine.calculateKPIs({
                ...
                case 4:
                    ...
                    formattedResults = results.map(function (result) {
                        ...
                        return ({
                            ...
                            variance_percent: validatedData_1.include_variance ? result.variance_percent : undefined,
                            trend_direction: validatedData_1.include_variance ? result.trend_direction : undefined,
                            calculation_date: result.calculation_date,
                            last_updated: ((_a = result.metadata) === null || _a === void 0 ? void 0 : _a.calculation_timestamp) || new Date().toISOString(),
                            metadata: {
                                data_points: (_b = result.metadata) === null || _b === void 0 ? void 0 : _b.data_points,
                                calculation_method: (_c = result.metadata) === null || _c === void 0 ? void 0 : _c.calculation_method,
                                confidence_score: (_d = result.metadata) === null || _d === void 0 ? void 0 : _d.confidence_score,
                            },
                        });
                    });
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            metadata: {
                                ...
                                time_period: validatedData_1.time_period,
                                filters_applied: validatedData_1.filters ? Object.keys(validatedData_1.filters).length : 0,
                            },
                        })];
                case 5:
                    error_1 = _b.sent();
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, searchParams, category, includeTargets_1, limit, query, _b, kpis, error, formattedKpis, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    formattedKpis = (kpis === null || kpis === void 0 ? void 0 : kpis.map(function (kpi) {
                        var _a, _b;
                        return ({
                            id: kpi.id,
                            ...
                            target_value: includeTargets_1 && ((_b = (_a = kpi.kpi_targets) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.target_value)
