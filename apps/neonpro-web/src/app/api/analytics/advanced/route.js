...
var CohortAnalysisRequestSchema = zod_1.z.object({
  ...
  metrics: zod_1.z
    .array(zod_1.z.enum(["retention", "revenue", "churn", "ltv"]))
    .default(["retention"]),
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 2:
          ...
          return [3 /*break*/, 9];
        case 3:
          return [4 /*yield*/, handleCohortAnalysis(request, supabase, user.id)];
        case 4:
          return [2 /*return*/, _c.sent()];
        case 5:
          return [4 /*yield*/, handleForecasting(request, supabase, user.id)];
        case 6:
          return [2 /*return*/, _c.sent()];
        case 7:
          return [4 /*yield*/, handleStatisticalAnalysis(request, supabase, user.id)];
        case 8:
          return [2 /*return*/, _c.sent()];
        case 9:
          return [
    ...
    return __generator(this, (_a) => {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            cohortAnalyzer.generateCohortAnalysis({
              userId: userId,
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            cohortAnalyzer.predictCohortBehavior(cohortData),
            // Format response
          ];
        case 5:
          predictions = _a.sent();
          ...
          cacheKey = "cohort_"
            .concat(userId, "_")
            .concat(validatedData.startDate, "_")
            .concat(validatedData.endDate);
          return [
            4 /*yield*/,
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            forecastingEngine.getHistoricalData({
              userId: userId,
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            forecastingEngine.generateScenarios({
        ...
        case 5:
          return [
            4 /*yield*/,
            forecastingEngine.validateModel({
        ...
        case 6:
          ...
          response = {
            ...
            data: {
              ...
              metadata: {
                ...
                model_type:
                  ((_a = forecast.model_info) === null || _a === void 0
                    ? void 0
                    : _a.selected_model) || validatedData.model_type,
                confidence_level: validatedData.confidence_level,
          ...
          cacheKey = "forecast_"
            .concat(userId, "_")
            .concat(validatedData.metric, "_")
            .concat(validatedData.periods);
          return [
            4 /*yield*/,
            supabase.from("analytics_cache").upsert({
              cache_key: cacheKey,
    ...
    return __generator(this, (_g) => {
      switch (_g.label) {
        ...
        case 2:
          ...
          if (
            !(
              validatedData.analysis_type === "correlation" || validatedData.analysis_type === "all"
            )
          )
            return [3 /*break*/, 4];
          _b = results;
        ...
        case 4:
          if (
            !(validatedData.analysis_type === "regression" || validatedData.analysis_type === "all")
          )
            return [3 /*break*/, 6];
          _c = results;
          return [
        ...
        case 8:
          return [
            4 /*yield*/,
            assessDataQuality(processedData, validatedData.include_outliers),
        ...
        case 9:
          ...
          return [
            4 /*yield*/,
            evaluatePredictiveModels(processedData, validatedData.metrics),
            // Format response
          ];
        case 10:
          ...
          response = {
            success: true,
            data: __assign(__assign({}, results), {
              data_quality: dataQuality,
              predictive_models: predictiveModels,
              raw_data: processedData.slice(-100),
              metadata: {
                generated_at: new Date().toISOString(),
                ...
                date_range: {
                  start: (_e = analyticsData[0]) === null || _e === void 0 ? void 0 : _e.created_at,
                    ...
                    (_f = analyticsData[analyticsData.length - 1]) === null || _f === void 0
                      ? void 0
                      : _f.created_at,
                },
              },
      ...
      switch (_c.label) {
        ...
        case 2:
          ...
          if (!cacheKey) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Cache key required" }, { status: 400 }),
            ];
          }
          return [
            4 /*yield*/,
        ...
        case 3:
          ...
          if (cacheError || !cachedData) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Cache miss or expired" }, { status: 404 }),
            ];
          }
          return [
            2 /*return*/,
  ...
  var dailyData = rawData.reduce((acc, event) => {
    ...
    switch (event.event_type) {
      case "subscription_created":
        ...
        acc[date].mrr +=
          ((_a = event.properties) === null || _a === void 0 ? void 0 : _a.amount) || 0;
        break;
      case "payment_succeeded":
        acc[date].revenue +=
          ((_b = event.properties) === null || _b === void 0 ? void 0 : _b.amount) || 0;
        break;
