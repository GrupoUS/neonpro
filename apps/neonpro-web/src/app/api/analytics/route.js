    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 11:
          return [
            4 /*yield*/,
            getDashboardAnalytics(startDate, endDate, validatedParams.userId || userId, userRole),
          ];
        case 12:
      ...
      switch (_b.label) {
        ...
        case 2:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to track event" }, { status: 500 }),
            ];
          }
          return [
            2 /*return*/,
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          return [
            4 /*yield*/,
            supabase.rpc("get_trial_analytics", {
              start_date: startDate,
              end_date: endDate,
              granularity: granularity,
              user_id: userId,
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          return [
            4 /*yield*/,
            supabase.rpc("get_churn_analytics", {
              start_date: startDate,
              end_date: endDate,
              granularity: granularity,
              user_id: userId,
          ...
          return [
            2 /*return*/,
            {
              ...
              summary: {
                ...
                conversionRate:
                  (conversions === null || conversions === void 0
                    ? void 0
