...
var drill_down_1 = require("@/lib/analytics/drill-down");
...
var requestSchema = zod_1.z.object({
    ...
    aggregation_level: zod_1.z.enum(['day', 'week', 'month', 'quarter', 'year']).optional(),
    limit: zod_1.z.number().int().min(1).max(1000).default(50),
    sort_by: zod_1.z.enum(['value', 'percentage', 'variance']).default('value'),
    sort_order: zod_1.z.enum(['asc', 'desc']).default('desc'),
    include_variance: zod_1.z.boolean().default(true),
    drill_path: zod_1.z.array(zod_1.z.object({
        dimension: zod_1.z.string(),
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, body, validatedData_1, drillDownSystem, analysisResult, sortedResults, formattedResults, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    drillDownSystem = new drill_down_1.DrillDownSystem();
                    return [4 /*yield*/, drillDownSystem.performDrillDown({
                            kpi_id: validatedData_1.kpi_id,
                            dimension: validatedData_1.dimension,
                            filters: validatedData_1.filters,
                            aggregation_level: validatedData_1.aggregation_level,
                            limit: validatedData_1.limit,
                            drill_path: validatedData_1.drill_path,
                        })];
                case 4:
                    analysisResult = _b.sent();
                    sortedResults = __spreadArray([], analysisResult.results, true);
                    switch (validatedData_1.sort_by) {
                        case 'value':
                            sortedResults.sort(function (a, b) { return validatedData_1.sort_order === 'desc'
                                ? b.value - a.value
                                : a.value - b.value; });
                            break;
                        case 'percentage':
                        ...
                        case 'variance':
                            sortedResults.sort(function (a, b) {
                                var aVariance = a.variance_from_previous || 0;
                                var bVariance = b.variance_from_previous || 0;
                                return validatedData_1.sort_order === 'desc'
                                    ? bVariance - aVariance
                                    : aVariance - bVariance;
                            });
                            break;
                    }
                    formattedResults = sortedResults.map(function (result) { return ({
                        dimension_value: result.dimension_value,
                        value: result.value,
                        percentage_of_total: result.percentage_of_total,
                        variance_from_previous: validatedData_1.include_variance
                            ? result.variance_from_previous
                            : undefined,
                        variance_from_target: validatedData_1.include_variance
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            data: {
                                ...
                                metadata: {
                                    ...
                                    aggregation_level: validatedData_1.aggregation_level,
                                    time_period: validatedData_1.filters.time_period,
                                },
                            },
                        })];
                case 5:
                    error_1 = _b.sent();
                    console.error('Error performing drill-down analysis:', error_1);
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, userError, searchParams, kpiId, drillDownSystem, availableDimensions, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 4, , 5]);
                ...
                case 2:
                    ...
                    kpiId = searchParams.get('kpi_id');
                    if (!kpiId) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'KPI ID is required' }, { status: 400 })];
                    }
                    drillDownSystem = new drill_down_1.DrillDownSystem();
                    return [4 /*yield*/, drillDownSystem.getAvailableDimensions(kpiId)];
                case 3:
                    availableDimensions = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: {
                                kpi_id: kpiId,
                ...
                case 4:
                    error_2 = _b.sent();
                    console.error('Error getting drill-down dimensions:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
                            error: 'Internal server error',
