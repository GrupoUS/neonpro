    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [3 /*break*/, 12];
        case 2:
          return [4 /*yield*/, getAnalyticsData(validatedRequest_1, userId, userRole)];
        case 3:
          data = _b.sent();
          filename = "analytics_export_".concat(new Date().toISOString().split("T")[0]);
          return [3 /*break*/, 13];
        case 4:
          return [4 /*yield*/, getTrialsData(validatedRequest_1, userId, userRole)];
        case 5:
          data = _b.sent();
          filename = "trials_export_".concat(new Date().toISOString().split("T")[0]);
          return [3 /*break*/, 13];
        case 6:
          return [4 /*yield*/, getSubscriptionsData(validatedRequest_1, userId, userRole)];
        case 7:
          data = _b.sent();
        ...
        case 12:
          return [
            2 /*return*/,
            server_1.NextResponse.json({ error: "Invalid export type" }, { status: 400 }),
          ];
        case 13:
          if (!data || data.length === 0) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "No data found for export" }, { status: 404 }),
            ];
          }
          ...
          switch (validatedRequest_1.format) {
            ...
            default:
              return [
                2 /*return*/,
                server_1.NextResponse.json({ error: "Unsupported export format" }, { status: 400 }),
              ];
          }
          // Log export activity
          return [
        ...
        case 14:
          ...
          return [
            2 /*return*/,
            new server_1.NextResponse(fileBuffer, {
              status: 200,
              headers: {
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        case 0:
          ...
          query = supabase.from("analytics_events").select("*");
