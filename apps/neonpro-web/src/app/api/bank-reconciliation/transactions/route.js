...
var BulkUpdateSchema = zod_1.z.object({
    ...
    action: zod_1.z.enum(['mark_matched', 'mark_unmatched', 'mark_disputed', 'mark_ignored', 'set_category']),
    data: zod_1.z.object({
        reconciliationStatus: zod_1.z.enum(['unmatched', 'matched', 'disputed', 'ignored']).optional(),
        category: zod_1.z.string().optional(),
        notes: zod_1.z.string().optional(),
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, url, queryParams, validatedQuery, query, sortColumn, _b, transactions, transactionsError, countQuery, _c, count, countError, summary, error_1;
            ...
            switch (_d.label) {
                ...
                case 2:
                    ...
                    if (validatedQuery.amountMin !== undefined) {
                        query = query.or("debit_amount.gte.".concat(validatedQuery.amountMin, ",credit_amount.gte.").concat(validatedQuery.amountMin));
                    }
                    if (validatedQuery.amountMax !== undefined) {
                        query = query.or("debit_amount.lte.".concat(validatedQuery.amountMax, ",credit_amount.lte.").concat(validatedQuery.amountMax));
                    }
                    if (validatedQuery.searchTerm) {
                        query = query.or("description.ilike.%".concat(validatedQuery.searchTerm, "%,reference_number.ilike.%").concat(validatedQuery.searchTerm, "%"));
                    }
                    sortColumn = validatedQuery.sortBy === 'amount'
                        ? 'debit_amount'
                ...
                case 3:
                    ...
                    if (validatedQuery.searchTerm) {
                        countQuery = countQuery.or("description.ilike.%".concat(validatedQuery.searchTerm, "%,reference_number.ilike.%").concat(validatedQuery.searchTerm, "%"));
                    }
                ...
                case 4:
                    ...
                    summary = {
                        ...
                        matchedCount: (transactions === null || transactions === void 0 ? void 0 : transactions.filter(function (t) { return t.reconciliation_status === 'matched'; }).length) || 0,
                        unmatchedCount: (transactions === null || transactions === void 0 ? void 0 : transactions.filter(function (t) { return t.reconciliation_status === 'unmatched'; }).length) || 0,
                        disputedCount: (transactions === null || transactions === void 0 ? void 0 : transactions.filter(function (t) { return t.reconciliation_status === 'disputed'; }).length) || 0,
                        totalAmount: (transactions === null || transactions === void 0 ? void 0 : transactions.reduce(function (sum, t) {
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, action, _b, validatedData, reconciliationManager, result, validatedData, updateData, _c, updatedTransactions, updateError, transactionId, reconciliationManager, matches, error_2;
        var _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    ...
                    _b = action;
                    switch (_b) {
                        case 'match_transaction': return [3 /*break*/, 4];
                        case 'bulk_update': return [3 /*break*/, 6];
                        case 'find_potential_matches': return [3 /*break*/, 8];
                    }
                    return [3 /*break*/, 10];
                case 4:
                    ...
                    return [4 /*yield*/, reconciliationManager.performManualMatching(validatedData.transactionId, validatedData.paymentId, validatedData.confidence, validatedData.notes)];
                case 5:
                    result = _f.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                ...
                case 7:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            message: "Successfully updated ".concat((updatedTransactions === null || updatedTransactions === void 0 ? void 0 : updatedTransactions.length) || 0, " transactions"),
                        })];
                case 8:
                    transactionId = body.transactionId;
                    if (!transactionId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Transaction ID is required' }, { status: 400 })];
                    }
                    reconciliationManager = new bank_reconciliation_manager_1.BankReconciliationManager();
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, validatedData, updateData, _b, transaction, updateError, error_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    if (!transaction) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Transaction not found or access denied' }, { status: 404 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: transaction,
...
function DELETE(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, transactionIds, _b, permanent, deleteError, _c, transactions, updateError, error_4;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 8, , 9]);
                ...
                case 3:
                    body = _d.sent();
                    transactionIds = body.transactionIds, _b = body.permanent, permanent = _b === void 0 ? false : _b;
                    if (!transactionIds || !Array.isArray(transactionIds)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Transaction IDs array is required' }, { status: 400 })];
                    }
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: transactions,
                            message: "Successfully marked ".concat((transactions === null || transactions === void 0 ? void 0 : transactions.length) || 0, " transactions as ignored"),
                        })];
