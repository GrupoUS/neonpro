...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, url, queryParams, validatedQuery, reconciliationManager, filters, _b, statements, statementsError, _c, count, countError, summary, error_1;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, reconciliationManager.getReconciliationSummary({
                            dateFrom: validatedQuery.dateFrom,
                            dateTo: validatedQuery.dateTo,
                            bankName: validatedQuery.bankName,
                        })];
                case 5:
                    summary = (_d.reconciliationStats = _e.sent(),
                        _d);
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, contentType, formData, file, metadata, statementData, validatedData, processor, result, body, action, _b, validatedData, reconciliationManager, result, validatedData, reconciliationManager, result, error_2;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    try {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid metadata JSON' }, { status: 400 })];
                    }
                    validatedData = ImportStatementSchema.parse(statementData);
                    processor = new bank_statement_processor_1.BankStatementProcessor();
                    return [4 /*yield*/, processor.processStatementFile(file, file.name, validatedData.processingOptions)];
                case 4:
                    result = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                ...
                case 6:
                    ...
                    _b = action;
                    switch (_b) {
                        case 'reconcile': return [3 /*break*/, 7];
                        case 'manual_match': return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 11];
                case 7:
                    validatedData = ReconcileTransactionsSchema.parse(body);
                    reconciliationManager = new bank_reconciliation_manager_1.BankReconciliationManager();
                    return [4 /*yield*/, reconciliationManager.performAutoMatching(validatedData.statementId, {
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, action, _b, ruleId, ruleData, _c, rule, updateError, statementId, status_1, _d, statement, updateError, error_3;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                ...
                case 3:
                    ...
                    _b = action;
                    switch (_b) {
                        case 'update_rule': return [3 /*break*/, 4];
                        case 'update_statement_status': return [3 /*break*/, 6];
                    }
                    return [3 /*break*/, 8];
                case 4:
                    ruleId = body.ruleId, ruleData = __rest(body, ["ruleId"]);
                    if (!ruleId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Rule ID is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                ...
                case 6:
                    ...
                    if (!statementId || !status_1) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Statement ID and status are required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('bank_statements')
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (!action || !ids || !Array.isArray(ids)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Action and IDs array are required' }, { status: 400 })];
                    }
                    _b = action;
                    switch (_b) {
                        case 'delete_statements': return [3 /*break*/, 4];
                        case 'delete_rules': return [3 /*break*/, 6];
                    }
                    return [3 /*break*/, 8];
