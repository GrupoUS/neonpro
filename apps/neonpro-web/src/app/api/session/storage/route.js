...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, action, token_type, encrypted_data, expires_at, _b, storedToken, storeError, token_type, _c, token, retrieveError, token_id, token_type, query, revokeError, error_1;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    token_type = body.token_type, encrypted_data = body.encrypted_data, expires_at = body.expires_at;
                    // Validar dados obrigatórios
                    if (!token_type || !encrypted_data) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Tipo de token e dados criptografados são obrigatórios' }, { status: 400 })];
                    }
                ...
                case 4:
                    ...
                    if (storeError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao armazenar token de forma segura' }, { status: 500 })];
                    }
                ...
                case 5:
                    ...
                    if (!token_type) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Tipo de token é obrigatório' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('secure_tokens')
                            .select('*')
                ...
                case 6:
                    ...
                    if (retrieveError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Token não encontrado ou expirado' }, { status: 404 })];
                    }
                ...
                case 8:
                    ...
                    if (token_id) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'ID do token ou tipo de token é obrigatório' }, { status: 400 })];
                    }
                ...
                case 9:
                    ...
                    if (revokeError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao revogar token' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            message: 'Token revogado com sucesso'
                        })];
                case 10: return [2 /*return*/, server_1.NextResponse.json({ error: 'Ação não reconhecida' }, { status: 400 })];
                case 11:
                    error_1 = _d.sent();
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, token_type, include_expired, query, _b, tokens, tokensError, active_tokens, expired_tokens, revoked_tokens, error_2;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (tokensError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar tokens' }, { status: 500 })];
                    }
                    active_tokens = (tokens === null || tokens === void 0 ? void 0 : tokens.filter(function (t) { return t.is_active && new Date(t.expires_at) > new Date(); }).length) || 0;
                    expired_tokens = (tokens === null || tokens === void 0 ? void 0 : tokens.filter(function (t) { return new Date(t.expires_at) <= new Date(); }).length) || 0;
                    revoked_tokens = (tokens === null || tokens === void 0 ? void 0 : tokens.filter(function (t) { return !t.is_active; }).length) || 0;
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            tokens: tokens || [],
                            statistics: {
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (revokeError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao revogar tokens' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 5:
                    ...
                    if (cleanupError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao limpar tokens expirados' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            message: 'Tokens expirados foram limpos'
                        })];
                case 6: return [2 /*return*/, server_1.NextResponse.json({ error: 'Ação de exclusão não reconhecida' }, { status: 400 })];
                case 7:
                    error_3 = _b.sent();
