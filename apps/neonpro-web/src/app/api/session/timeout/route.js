...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, _b, profile, profileError, _c, userTimeout, timeoutError, timeoutMinutes, session, sessionExpiresAt, now, expiresAt, timeRemaining, error_1;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    if (profileError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar perfil do usuário' }, { status: 500 })];
                    }
                    return [4 /*yield*/, supabase
                ...
                case 4:
                    ...
                    timeoutMinutes = (userTimeout === null || userTimeout === void 0 ? void 0 : userTimeout.timeout_minutes) ||
                        TIMEOUT_CONFIGS[profile.role] ||
                        15;
                    return [4 /*yield*/, supabase.auth.getSession()];
                case 5:
                    session = _e.sent();
                    sessionExpiresAt = (_d = session.data.session) === null || _d === void 0 ? void 0 : _d.expires_at;
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            timeout_config: {
                                ...
                                auto_extend_enabled: (userTimeout === null || userTimeout === void 0 ? void 0 : userTimeout.auto_extend_enabled) || false,
                                role_based_timeout: TIMEOUT_CONFIGS[profile.role],
                                custom_timeout: (userTimeout === null || userTimeout === void 0 ? void 0 : userTimeout.timeout_minutes) || null
                            },
                            session_info: {
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, action, _b, refreshData, refreshError, refreshError_1, timeout_minutes, auto_extend_enabled, _c, updatedConfig, updateError, error_2;
        var _d, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 5:
                    ...
                    if (refreshError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Não foi possível estender a sessão' }, { status: 401 })];
                    }
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            metadata: {
                                ...
                                new_expires_at: (_d = refreshData.session) === null || _d === void 0 ? void 0 : _d.expires_at
                            }
                        })];
                case 6:
                    // Registrar extensão da sessão
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            new_expires_at: (_e = refreshData.session) === null || _e === void 0 ? void 0 : _e.expires_at,
                            access_token: (_f = refreshData.session) === null || _f === void 0 ? void 0 : _f.access_token
                        })];
                case 7:
                    refreshError_1 = _g.sent();
                    console.error('Erro ao renovar sessão:', refreshError_1);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao estender sessão' }, { status: 500 })];
                case 8:
                    if (!(action === 'update_timeout_config')) return [3 /*break*/, 10];
                    timeout_minutes = body.timeout_minutes, auto_extend_enabled = body.auto_extend_enabled;
                    // Validar timeout (mínimo 5 minutos, máximo 120 minutos)
                    if (timeout_minutes && (timeout_minutes < 5 || timeout_minutes > 120)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Timeout deve estar entre 5 e 120 minutos' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('user_session_settings')
                            .upsert({
                            ...
                            auto_extend_enabled: auto_extend_enabled !== undefined ? auto_extend_enabled : false,
                ...
                case 9:
                    ...
                    if (updateError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao salvar configurações de timeout' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 12: return [2 /*return*/, server_1.NextResponse.json({ error: 'Ação não reconhecida' }, { status: 400 })];
                case 13:
                    error_2 = _g.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao encerrar sessão' }, { status: 500 })];
