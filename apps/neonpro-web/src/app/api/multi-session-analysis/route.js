    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            progress_tracking_1.progressTrackingService.createMultiSessionAnalysis(validatedData),
          ];
        case 4:
          analysis = _b.sent();
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            progress_tracking_1.progressTrackingService.getMultiSessionAnalyses(patientId),
          ];
        case 3:
          analyses = _b.sent();
