        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch segmentation rules' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, patient_segmentation_service_1.createpatientSegmentationService)().createAutomatedSegment(ruleData)];
                case 4:
                    rule = _a.sent();
                    return [2 /*return*/, server_2.NextResponse.json({
                            success: true,
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create segmentation rule' }, { status: 500 })];
