        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    id = params.id;
                    return [4 /*yield*/, patient_segmentation_service_1.patientSegmentationService.analyzePatientsForSegmentation(id)];
                case 3:
                    analysis = _c.sent();
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch patient analysis' }, { status: 500 })];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, patient_segmentation_service_1.patientSegmentationService.updateSegmentMemberships(body.updates)];
                case 4:
                    // Update segment memberships
                    _c.sent();
                    return [2 /*return*/, server_2.NextResponse.json({
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to update segment memberships' }, { status: 500 })];
