        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, patient_segmentation_service_1.createpatientSegmentationService)().createAISegment(segmentData)];
                case 4:
                    segment = _a.sent();
                    return [2 /*return*/, server_2.NextResponse.json({
                            success: true,
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create patient segment' }, { status: 500 })];
