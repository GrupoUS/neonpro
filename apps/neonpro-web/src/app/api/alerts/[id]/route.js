...
function PATCH(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, id, searchParams, action, alert_1, body, action_notes, alert_2, error_1;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.markAlertActionTaken(id, action_notes)];
                case 5:
                    alert_2 = _d.sent();
                    return [2 /*return*/, server_1.NextResponse.json(alert_2)];
                case 6: return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid action. Use mark_read or mark_action_taken' }, { status: 400 })];
                ...
                case 8:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update alert' }, { status: 500 })];
