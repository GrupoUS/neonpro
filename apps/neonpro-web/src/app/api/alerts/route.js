    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            progress_tracking_1.progressTrackingService.createProgressAlert(validatedData),
          ];
        case 4:
          alert_1 = _b.sent();
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            progress_tracking_1.progressTrackingService.getProgressAlerts(validatedFilters),
          ];
        case 3:
          result = _b.sent();
