...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, validatedData, alert_1, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    body = _b.sent();
                    validatedData = progress_tracking_2.createProgressAlertRequestSchema.parse(body);
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.createProgressAlert(validatedData)];
                case 4:
                    alert_1 = _b.sent();
                    return [2 /*return*/, server_2.NextResponse.json(alert_1, { status: 201 })];
                case 5:
                    error_1 = _b.sent();
                    console.error('Error creating progress alert:', error_1);
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create progress alert' }, { status: 500 })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    validatedFilters = progress_tracking_2.progressAlertFiltersSchema.parse(filters);
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.getProgressAlerts(validatedFilters)];
                case 3:
                    result = _b.sent();
                    return [2 /*return*/, server_2.NextResponse.json(result)];
                case 4:
                    error_2 = _b.sent();
                    console.error('Error fetching progress alerts:', error_2);
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch progress alerts' }, { status: 500 })];
