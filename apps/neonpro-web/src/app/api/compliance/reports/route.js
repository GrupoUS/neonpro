...
function generateComplianceReport(clinicId, request, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, supabase, auditTrail, lgpdCore, period, baseReport, reportData, _b, formattedReport, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = initializeServices(), supabase = _a.supabase, auditTrail = _a.auditTrail, lgpdCore = _a.lgpdCore;
                    _c.label = 1;
                case 1:
                ...
                case 2:
                    ...
                    switch (_b) {
                        ...
                        case 'consent': return [3 /*break*/, 5];
                        case 'data_subject': return [3 /*break*/, 7];
                        case 'security': return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 11];
                case 3: return [4 /*yield*/, generateAuditReport(auditTrail, clinicId, period, request.filters)];
                case 4:
                    reportData = _c.sent();
                    return [3 /*break*/, 12];
                case 5: return [4 /*yield*/, generateConsentReport(lgpdCore, clinicId, period)];
                case 6:
                    reportData = _c.sent();
                    return [3 /*break*/, 12];
                case 7: return [4 /*yield*/, generateDataSubjectReport(lgpdCore, clinicId, period)];
                case 8:
                    reportData = _c.sent();
                    return [3 /*break*/, 12];
                case 9: return [4 /*yield*/, generateSecurityReport(auditTrail, clinicId, period)];
                case 10:
                    reportData = _c.sent();
                    return [3 /*break*/, 12];
                case 11: 
                ...
                return [3 /*break*/, 12];
                case 12: return [4 /*yield*/, formatReport(reportData, request.format)];
                case 13:
...
function generateAuditReport(auditTrail, clinicId, period, filters) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    query = __assign({ clinicId: clinicId, startDate: period.start, endDate: period.end, limit: 10000 }, filters);
                ...
                case 1:
                    ...
                    return [2 /*return*/, {
                            ...
                            summary: {
                                ...
                                uniqueUsers: new Set(events.map(function (e) { return e.userId; })).size,
                                timeRange: {
                                    start: period.start,
                                    end: period.end
                                }
...
function generateSecurityReport(auditTrail, clinicId, period) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, auditTrail.queryEvents({
                        clinicId: clinicId,
                ...
                case 1:
                    ...
                    return [4 /*yield*/, auditTrail.queryEvents({
                            clinicId: clinicId,
                            startDate: period.start,
                            endDate: period.end,
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            ...
                            summary: {
                                ...
                                criticalEvents: __spreadArray(__spreadArray([], securityEvents.events, true), breachEvents.events, true).filter(function (e) { return e.severity === 'critical'; }).length,
                                riskLevel: breachEvents.events.length > 0 ? 'high' :
                                    securityEvents.events.length > 10 ? 'medium' : 'low'
                            },
                            events: __spreadArray(__spreadArray([], securityEvents.events, true), breachEvents.events, true),
                            generatedAt: new Date()
                        }];
            }
        });
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var rateLimitResult, authResult, user, hasAccess, url, queryParams, query, supabase, offset, dbQuery, _a, reports, error, count, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, (0, rate_limit_1.rateLimit)(request, {
                            maxRequests: 100,
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, permissions_1.hasPermission)(user.id, user.clinicId, 'compliance.reports.read')];
                case 3:
                    hasAccess = _b.sent();
                    if (!hasAccess) {
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var rateLimitResult, csrfValid, authResult, user, hasAccess, body, reportRequest, _a, supabase, auditTrail, reportId, reportRecord, insertError, reportData, generateError_1, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 2:
                    csrfValid = _b.sent();
                    if (!csrfValid) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'CSRF validation failed' }, { status: 403 })];
                    }
                    return [4 /*yield*/, (0, middleware_1.requireAuth)(request)];
                case 3:
                    authResult = _b.sent();
                    ...
                    user = authResult.user;
                    return [4 /*yield*/, (0, permissions_1.hasPermission)(user.id, user.clinicId, 'compliance.reports.create')];
                case 4:
                    hasAccess = _b.sent();
                    if (!hasAccess) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Insufficient permissions' }, { status: 403 })];
                ...
                case 6:
                    ...
                    // Log audit event
                    return [4 /*yield*/, auditTrail.logEvent({
                ...
                case 9:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            downloadUrl: reportData.filename ? "/api/compliance/reports/".concat(reportId, "/download") : null
                        })
                            .eq('id', reportId)];
                case 10:
                    // Update report with generated data
