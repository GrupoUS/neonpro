      ...
      switch (_c.label) {
        ...
        case 1:
          ...
          (clinicId = validatedQuery.clinicId),
            ...
            (requestType = validatedQuery.requestType),
        ...
        case 4:
          ...
          if (!hasAccess) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Access denied to clinic" }, { status: 403 }),
            ];
          }
      ...
      switch (_c.label) {
        ...
        case 2:
          ...
          if (!csrfValid) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "CSRF token invalid" }, { status: 403 }),
            ];
          }
        ...
        case 5:
          ...
          if (!clinicId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Clinic ID required" }, { status: 400 }),
            ];
          }
          return [4 /*yield*/, validateUserAccess(supabase, user.id, clinicId)];
        case 6:
        ...
        case 8:
          ...
          if (!isValid) {
            return [
              2 /*return*/,
              server_1.NextResponse.json(
                { error: "Invalid data field: ".concat(field) },
                { status: 400 },
              ),
            ];
          }
        ...
        case 10:
          ...
          return [
            4 /*yield*/,
            lgpdCore.createDataSubjectRequest({
              userId: user.id,
              clinicId: clinicId,
        ...
        case 11:
          ...
          _b = requestType;
          switch (_b) {
            case lgpd_core_1.DataSubjectRequestType.ACCESS:
              return [3 /*break*/, 12];
            case lgpd_core_1.DataSubjectRequestType.DELETION:
              return [3 /*break*/, 14];
            case lgpd_core_1.DataSubjectRequestType.PORTABILITY:
              return [3 /*break*/, 16];
          }
          return [3 /*break*/, 18];
        case 12:
          return [
            4 /*yield*/,
            (0, data_export_1.generateDataExport)(supabase, user.id, clinicId, specificData),
          ];
        case 13:
          exportData = _c.sent();
        ...
        case 14:
          ...
          return [
            4 /*yield*/,
            (0, data_deletion_1.scheduleDataDeletion)(supabase, user.id, clinicId, {
              gracePeriodDays: 30,
        ...
        case 8:
          ...
          if (!isValid) {
            return [
              2 /*return*/,
              server_1.NextResponse.json(
                { error: "Invalid data field: ".concat(correction.field) },
                { status: 400 },
              ),
            ];
          }
