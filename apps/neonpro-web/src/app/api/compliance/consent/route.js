      ...
      switch (_c.label) {
        ...
        case 1:
          ...
          (clinicId = validatedQuery.clinicId),
            ...
            (consentType = validatedQuery.consentType),
        ...
        case 4:
          ...
          _lgpdCore = new lgpd_core_1.LGPDCore(supabase);
          ...
          return [
            ...
            (0, audit_logger_1.auditLog)({
              ...
              details: {
                filters: filters,
                resultCount:
                  (consents === null || consents === void 0 ? void 0 : consents.length) || 0,
              },
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            lgpdCore.withdrawConsent(consentId, {
              reason: reason,
              ipAddress: clientInfo.ipAddress,
              userAgent: clientInfo.userAgent,
            }),
