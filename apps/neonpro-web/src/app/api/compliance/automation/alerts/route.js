...
var CreateAlertSchema = zod_1.z.object({
    ...
    category: zod_1.z.enum(['consent', 'data_subject_rights', 'audit', 'security', 'retention', 'anonymization']),
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, searchParams, status_1, severity, category, limit, offset, clinicId, query, _b, alerts, error, countQuery, count, error_1;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    countQuery = supabase
                        ...
                        .eq('clinic_id', clinicId);
                    if (status_1)
                        countQuery = countQuery.eq('status', status_1);
                    if (severity)
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, validationResult, alertData, clinicId, autoResolveAt, _b, alert_1, error, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 6, , 7]);
                ...
                case 3:
                    ...
                    if (alertData.auto_resolve && alertData.resolve_after_hours) {
                        autoResolveAt = new Date(Date.now() + alertData.resolve_after_hours * 60 * 60 * 1000).toISOString();
                    }
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, searchParams, alertId, body, validationResult, updateData, clinicId, _b, existingAlert, fetchError, updatePayload, _c, updatedAlert, error, error_3;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    if (!alertId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'ID do alerta é obrigatório' }, { status: 400 })];
                    }
                    return [4 /*yield*/, request.json()];
                case 3:
                    body = _d.sent();
                ...
                case 4:
                    ...
                    if (fetchError || !existingAlert) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Alerta não encontrado' }, { status: 404 })];
                    }
                    updatePayload = {
