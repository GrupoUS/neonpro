    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    status_1 = _b.sent();
                    return [4 /*yield*/, orchestrator.getDashboardMetrics()];
                case 4:
                    metrics = _b.sent();
                    return [4 /*yield*/, orchestrator.performComplianceHealthCheck()];
                case 5:
                    healthCheck = _b.sent();
                ...
                case 6:
                    error_1 = _b.sent();
                    console.error('Erro ao obter status da automaï¿½ï¿½o:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    _b = action;
                    switch (_b) {
                        case 'run_full_automation': return [3 /*break*/, 4];
                        case 'process_consent_automation': return [3 /*break*/, 6];
                        case 'process_data_subject_rights': return [3 /*break*/, 8];
                        case 'run_audit_automation': return [3 /*break*/, 10];
                        case 'generate_compliance_reports': return [3 /*break*/, 12];
                        case 'run_anonymization': return [3 /*break*/, 14];
                        case 'health_check': return [3 /*break*/, 16];
                    }
                    return [3 /*break*/, 18];
                case 4: return [4 /*yield*/, orchestrator.runFullAutomation()];
                case 5:
                    result = _c.sent();
                    return [3 /*break*/, 19];
                case 6: return [4 /*yield*/, orchestrator.processConsentAutomation()];
                case 7:
                    result = _c.sent();
                    return [3 /*break*/, 19];
                case 8: return [4 /*yield*/, orchestrator.processDataSubjectRights()];
                case 9:
                    result = _c.sent();
                    return [3 /*break*/, 19];
                case 10: return [4 /*yield*/, orchestrator.runAuditAutomation()];
                case 11:
                    result = _c.sent();
                    return [3 /*break*/, 19];
                case 12: return [4 /*yield*/, orchestrator.generateComplianceReports()];
                case 13:
                    result = _c.sent();
                    return [3 /*break*/, 19];
                case 14: return [4 /*yield*/, orchestrator.runAnonymization()];
                case 15:
                    result = _c.sent();
                    return [3 /*break*/, 19];
                case 16: return [4 /*yield*/, orchestrator.performComplianceHealthCheck()];
                case 17:
                    result = _c.sent();
                    return [3 /*break*/, 19];
                case 18: return [2 /*return*/, server_1.NextResponse.json({ error: 'Aï¿½ï¿½o nï¿½o reconhecida' }, { status: 400 })];
                case 19: return [2 /*return*/, server_1.NextResponse.json({
                        success: true,
                        data: result,
                        timestamp: new Date().toISOString()
                    })];
                case 20:
                    error_2 = _c.sent();
                    console.error('Erro ao executar automaï¿½ï¿½o:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({
                            error: 'Erro interno do servidor',
