      ...
      switch (_c.label) {
        ...
        case 2:
          ...
          (sessionId = body.sessionId),
            ...
            (activityType = _a === void 0 ? "user_interaction" : _a),
            (_b = body.metadata),
          ...
          return [
            4 /*yield*/,
            timeoutManager.updateActivity(authResult.user.id, sessionId, activityType, metadata),
          ];
        case 3:
          // Update session activity
          _c.sent();
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 2:
          body = _b.sent();
          (sessionId = body.sessionId),
            (_a = body.extensionMinutes),
            (extensionMinutes = _a === void 0 ? 30 : _a);
          if (!sessionId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Session ID is required" }, { status: 400 }),
          ...
          return [
            4 /*yield*/,
            timeoutManager.extendSession(authResult.user.id, sessionId, extensionMinutes),
          ];
        case 3:
          result = _b.sent();
          return [
