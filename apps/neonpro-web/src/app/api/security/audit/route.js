...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, _a, start, end, period, report, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 6, , 7]);
                    return [4 /*yield*/, (0, server_2.createServerClient)()];
                case 1:
                    supabase = _b.sent();
                ...
                case 3:
                    ...
                    if (!start || !end) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Start and end dates are required' }, { status: 400 })];
                    }
                    period = {
                ...
                case 6:
                    error_1 = _b.sent();
                    console.error('Compliance report generation error:', error_1);
