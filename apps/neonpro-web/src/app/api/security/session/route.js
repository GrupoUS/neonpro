    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    body = _b.sent();
                    sessionId = body.sessionId, _a = body.maxConcurrentSessions, maxConcurrentSessions = _a === void 0 ? 3 : _a;
                    if (!sessionId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Session ID is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, sessionSecurity.initializeSessionSecurity(authResult.user.id, sessionId, request, { maxConcurrentSessions: maxConcurrentSessions })];
                case 3:
                    result = _b.sent();
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to initialize session security' }, { status: 500 })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    body = _b.sent();
                    sessionId = body.sessionId, userId = body.userId, _a = body.activityType, activityType = _a === void 0 ? 'api_call' : _a;
                    if (!sessionId || !userId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Session ID and User ID are required' }, { status: 400 })];
                    }
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to validate session security' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, sessionSecurity.getSessionSecurityStatus(authResult.user.id, sessionId)];
                case 2:
                    status_1 = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            sessionId: sessionId,
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to get session security status' }, { status: 500 })];
                case 4: return [2 /*return*/];
            }
        });
    });
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!sessionId && !terminateAll) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Session ID is required or set terminateAll=true' }, { status: 400 })];
                    }
