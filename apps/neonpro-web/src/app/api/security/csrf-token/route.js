        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, csrfProtection.generateToken(sessionId, request.headers.get('user-agent') || '', ((_a = request.headers.get('x-forwarded-for')) === null || _a === void 0 ? void 0 : _a.split(',')[0]) ||
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to generate CSRF token' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!token || !sessionId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Token and session ID are required' }, { status: 400 })];
                    }
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to validate CSRF token' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to invalidate CSRF tokens' }, { status: 500 })];
                case 4: return [2 /*return*/];
            }
        });
    });
