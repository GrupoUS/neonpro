...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, body, validatedData, _a, cardPayment, paymentError, userProfile, isOwner, hasPermission, confirmationResult, updateError, installmentPlan, response, error_1, stripeError;
        var _b, _c, _d, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 3:
                    ...
                    hasPermission = ((_b = userProfile.data) === null || _b === void 0 ? void 0 : _b.role) && ['admin', 'manager', 'financial'].includes(userProfile.data.role);
                    ...
                    if (!['requires_payment_method', 'requires_confirmation', 'requires_action'].includes(cardPayment.status)) {
                        return [2 /*return*/, server_1.NextResponse.json({
                                error: 'Invalid State',
                                message: "Payment cannot be confirmed in current state: ".concat(cardPayment.status),
                            }, { status: 400 })];
                    }
                    return [4 /*yield*/, card_payment_service_1.CardPaymentService.confirmPayment(validatedData.payment_intent_id, {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            stripe_payment_method_id: ((_c = confirmationResult.payment_method) === null || _c === void 0 ? void 0 : _c.id) || cardPayment.stripe_payment_method_id,
                ...
                case 12:
                    ...
                    if (confirmationResult.status === 'succeeded') {
                        response.payment_method = {
                            id: (_d = confirmationResult.payment_method) === null || _d === void 0 ? void 0 : _d.id,
                            type: (_e = confirmationResult.payment_method) === null || _e === void 0 ? void 0 : _e.type,
                            card: ((_f = confirmationResult.payment_method) === null || _f === void 0 ? void 0 : _f.card) ? {
