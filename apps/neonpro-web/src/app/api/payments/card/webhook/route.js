            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    switch (_a) {
                        ...
                        case 'payment_intent.requires_action': return [3 /*break*/, 7];
                        case 'payment_intent.canceled': return [3 /*break*/, 9];
                        case 'charge.dispute.created': return [3 /*break*/, 11];
                        case 'invoice.payment_succeeded': return [3 /*break*/, 13];
                        case 'invoice.payment_failed': return [3 /*break*/, 15];
                    }
                    return [3 /*break*/, 17];
                case 3: return [4 /*yield*/, handlePaymentIntentSucceeded(event_1.data.object)];
                case 4:
                    _b.sent();
                    return [3 /*break*/, 18];
                case 5: return [4 /*yield*/, handlePaymentIntentFailed(event_1.data.object)];
                case 6:
                    _b.sent();
                    return [3 /*break*/, 18];
                case 7: return [4 /*yield*/, handlePaymentIntentRequiresAction(event_1.data.object)];
                case 8:
                    _b.sent();
                    return [3 /*break*/, 18];
                case 9: return [4 /*yield*/, handlePaymentIntentCanceled(event_1.data.object)];
                case 10:
                    _b.sent();
                    return [3 /*break*/, 18];
                case 11: return [4 /*yield*/, handleChargeDisputeCreated(event_1.data.object)];
                case 12:
                    _b.sent();
                    return [3 /*break*/, 18];
                case 13: return [4 /*yield*/, handleInvoicePaymentSucceeded(event_1.data.object)];
                case 14:
                    _b.sent();
                    return [3 /*break*/, 18];
                case 15: return [4 /*yield*/, handleInvoicePaymentFailed(event_1.data.object)];
                case 16:
                    _b.sent();
                    return [3 /*break*/, 18];
                case 17:
            ...
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .update({
                            status: 'failed',
                            failure_reason: ((_b = paymentIntent.last_payment_error) === null || _b === void 0 ? void 0 : _b.message) || 'Payment failed',
                            updated_at: new Date().toISOString(),
                        })
                            .eq('stripe_payment_intent_id', paymentIntent.id)
                            .select('*')
                ...
                return [4 /*yield*/, supabase
                        ...
                        metadata: {
                            ...
                            failure_reason: (_c = paymentIntent.last_payment_error) === null || _c === void 0 ? void 0 : _c.message,
                        },
                    })];
                case 7:
                    // Log audit trail
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(cardPayment === null || cardPayment === void 0 ? void 0 : cardPayment.payable_id)) return [3 /*break*/, 3];
                    return [4 /*yield*/, supabase
                            .from('ap_payments')
                            .update({
                            status: 'canceled',
