...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, amount, _a, currency, invoiceId, patientId, _b, metadata, supabase, _c, user, authError, paymentIntent, updateError, error_1;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    body = _d.sent();
                    amount = body.amount, _a = body.currency, currency = _a === void 0 ? stripe_1.STRIPE_CONFIG.currency : _a, invoiceId = body.invoiceId, patientId = body.patientId, _b = body.metadata, metadata = _b === void 0 ? {} : _b;
                    // Validate required fields
                    if (!amount || amount <= 0) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid amount provided' }, { status: 400 })];
                    }
                ...
                case 3:
                    ...
                    return [4 /*yield*/, stripe_1.stripe.paymentIntents.create({
                            ...
                            metadata: __assign({ userId: user.id, invoiceId: invoiceId || '', patientId: patientId || '' }, metadata),
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!paymentIntentId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Payment Intent ID required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, (0, server_2.createClient)()];
                case 1:
                    supabase = _b.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, stripe_1.stripe.paymentIntents.retrieve(paymentIntentId)
                ...
                case 3:
                    ...
                    if (paymentIntent.metadata.userId !== user.id) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Unauthorized access to payment intent' }, { status: 403 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            id: paymentIntent.id,
                            status: paymentIntent.status,
