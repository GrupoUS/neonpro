      ...
      switch (_d.label) {
        ...
        case 1:
          ...
          if (!paymentId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Payment ID is required" }, { status: 400 }),
            ];
          }
        ...
        case 2:
          ...
          if (!paymentStatus) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Payment not found" }, { status: 404 }),
            ];
          }
          return [
            4 /*yield*/,
        ...
        case 4:
          ...
          isAuthorized =
            ...
            ["admin", "manager", "financial"].includes(
