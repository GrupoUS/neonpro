        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    filters = {
                        status: searchParams.get('status') ? (_a = searchParams.get('status')) === null || _a === void 0 ? void 0 : _a.split(',') : undefined,
                        campaign_type: searchParams.get('campaign_type') ? (_b = searchParams.get('campaign_type')) === null || _b === void 0 ? void 0 : _b.split(',') : undefined,
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    campaignData = __assign(__assign({}, validationResult.data), { created_by: session.user.id, clinic_id: ((_a = session.user.user_metadata) === null || _a === void 0 ? void 0 : _a.clinic_id) || 'default' });
                    // Ensure automation level is ≥80% as per Epic 7.2 requirements
                    if (campaignData.automation_level < 0.80) {
                        campaignData.automation_level = 0.80;
                    }
