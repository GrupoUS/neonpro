...
function POST(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, body, validationResult, result, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    body = _c.sent();
                    validationResult = campaigns_1.ABTestCreateSchema.safeParse(__assign(__assign({}, body), { campaign_id: params.id }));
                    ...
                    return [4 /*yield*/, campaignService.createABTest(validationResult.data)];
                case 4:
                    result = _c.sent();
                    if (!result.success) {
                ...
                case 5:
                    error_1 = _c.sent();
                    console.error('Error in A/B test creation:', error_1);
