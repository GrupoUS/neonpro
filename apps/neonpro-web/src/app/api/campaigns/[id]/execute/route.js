...
function POST(request_1, _a) {
  return __awaiter(this, arguments, void 0, function (request, _b) {
    var supabase, session, body, validationResult, execution_type, result, error_1;
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 3:
          body = _c.sent();
          validationResult = campaigns_1.CampaignExecutionSchema.safeParse(body);
          ...
          execution_type = validationResult.data.execution_type;
          return [4 /*yield*/, campaignService.executeCampaign(params.id, execution_type)];
        case 4:
          result = _c.sent();
          if (!result.success) {
            return [
        ...
        case 5:
          error_1 = _c.sent();
          console.error("Error in campaign execution:", error_1);
          return [
            2 /*return*/,
