        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (route) {
                        routePerformance = performance_monitor_1.performanceMonitor.getRoutePerformance(route, timeWindow);
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!name_1 || typeof value !== 'number') {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Invalid metric data" }, { status: 400 })];
                    }
                    // Record client-side performance
                    performance_monitor_1.performanceMonitor.recordClientPerformance(name_1, value, __assign(__assign({}, metadata), { userId: user.id, userAgent: request.headers.get('user-agent') }));
