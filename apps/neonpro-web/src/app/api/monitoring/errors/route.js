            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (errorId) {
                        ...
                        if (!error) {
                            return [2 /*return*/, server_2.NextResponse.json({ error: "Error not found" }, { status: 404 })];
                        }
                        ...
                        summary = intelligent_error_handler_1.intelligentErrorHandler.getErrorSummary(timeWindow);
                        return [2 /*return*/, server_2.NextResponse.json({
                                success: true,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    body = _a.sent();
                    message = body.message, stack = body.stack, route = body.route, severity = body.severity, metadata = body.metadata;
                    if (!message) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Error message is required" }, { status: 400 })];
                    }
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to report error" }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!errorId) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Error ID is required" }, { status: 400 })];
                    }
                    resolved = intelligent_error_handler_1.intelligentErrorHandler.resolveError(errorId, resolution);
                    if (!resolved) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Error not found" }, { status: 404 })];
                    }
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to resolve error" }, { status: 500 })];
                case 5: return [2 /*return*/];
            }
        });
    });
