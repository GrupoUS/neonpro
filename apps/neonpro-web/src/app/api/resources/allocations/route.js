      ...
      switch (_b.label) {
        case 0:
          ...
          if (!resourceId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "resource_id is required" }, { status: 400 }),
            ];
          }
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            resourceManager.getAllocations(
              resourceId,
              startDate || undefined,
              endDate || undefined,
            ),
      ...
      switch (_b.label) {
        case 0:
          ...
          if (!allocationId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Allocation id is required" }, { status: 400 }),
            ];
          }
          return [4 /*yield*/, (0, server_2.createClient)()];
        case 1:
