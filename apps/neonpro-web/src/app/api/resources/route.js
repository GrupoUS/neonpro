...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, clinicId, type, status_1, category, supabase, _a, user, authError, resourceManager, filters, resources, error_1;
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, name_1, type, clinic_id, supabase, _a, user, authError, resourceManager, resourceData, newResource, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 5, , 6]);
                ...
                case 1:
                    ...
                    if (!name_1 || !type || !clinic_id) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'name, type, and clinic_id are required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, (0, server_2.createClient)()];
                case 2:
                    supabase = _b.sent();
                ...
                case 3:
                    ...
                    resourceManager = new resource_manager_1.ResourceManager();
                    resourceData = __assign(__assign({}, body), { created_by: user.id, updated_by: user.id, status: body.status || 'available' });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!id) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Resource id is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, (0, server_2.createClient)()];
                case 2:
                    supabase = _b.sent();
                ...
                case 3:
                    ...
                    resourceManager = new resource_manager_1.ResourceManager();
                    return [4 /*yield*/, resourceManager.updateResource(id, __assign(__assign({}, updates), { updated_by: user.id }))];
                case 4:
