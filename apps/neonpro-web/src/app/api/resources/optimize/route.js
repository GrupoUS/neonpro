...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, clinic_id, resource_type, start_time, end_time, supabase, _a, user, authError, allocationEngine, optimization, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    body = _b.sent();
                    clinic_id = body.clinic_id, resource_type = body.resource_type, start_time = body.start_time, end_time = body.end_time;
                    if (!clinic_id || !resource_type || !start_time || !end_time) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'clinic_id, resource_type, start_time, and end_time are required' }, { status: 400 })];
                    }
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, clinicId, date, supabase, _a, user, authError, allocationEngine, optimization, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 4, , 5]);
                    ...
                    if (!clinicId || !date) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'clinic_id and date are required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, (0, server_2.createClient)()];
                case 1:
                    supabase = _b.sent();
