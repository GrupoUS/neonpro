    ...
    return __generator(this, (_d) => {
      switch (_d.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            no_show_prediction_1.noShowPredictionEngine.getPrediction(params.id),
          ];
        case 2:
          prediction = _d.sent();
          if (!prediction) {
          ...
          return [
            ...
            Promise.all([
              ...
              no_show_prediction_1.noShowPredictionEngine.getRecommendedInterventions(
                prediction.id,
              ),
            ]),
          ];
        ...
        case 5:
          ...
          return [
            2 /*return*/,
            server_1.NextResponse.json({ error: "Failed to fetch prediction" }, { status: 500 }),
          ];
        case 6:
          return [2 /*return*/];
      }
    ...
    return __generator(this, (_d) => {
      switch (_d.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            no_show_prediction_1.noShowPredictionEngine.updatePrediction(params.id, validatedInput),
          ];
        case 4:
        ...
        case 6:
          ...
          return [
            2 /*return*/,
            server_1.NextResponse.json({ error: "Failed to update prediction" }, { status: 500 }),
          ];
        case 7:
          return [2 /*return*/];
      }
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 2:
          ...
          return [4 /*yield*/, supabase.from("no_show_predictions").delete().eq("id", params.id)];
        case 3:
          error = _c.sent().error;
          if (error) {
