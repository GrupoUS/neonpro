...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, searchParams, queryParams, parsedQuery, query, offset, _a, predictions, error, count, totalCount, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    parsedQuery = no_show_prediction_2.GetPredictionsQuerySchema.parse(__assign(__assign({}, queryParams), { page: queryParams.page ? parseInt(queryParams.page) : 1, limit: queryParams.limit ? parseInt(queryParams.limit) : 20, risk_threshold: queryParams.risk_threshold ? parseFloat(queryParams.risk_threshold) : undefined, intervention_recommended: queryParams.intervention_recommended === 'true' }));
                    query = supabase
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, body, validatedInput, existingPrediction, prediction, recommendedInterventions, riskFactors, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.getPredictionsByAppointment(validatedInput.appointment_id)];
                case 4:
                    existingPrediction = _a.sent();
                    if (existingPrediction.length > 0) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Prediction already exists for this appointment' }, { status: 409 })];
                    }
                    return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.createPrediction(validatedInput)];
                case 5:
                    prediction = _a.sent();
                    recommendedInterventions = [];
                    if (!prediction.intervention_recommended) return [3 /*break*/, 7];
                    return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.getRecommendedInterventions(prediction.id)];
                case 6:
                    recommendedInterventions = _a.sent();
                    _a.label = 7;
                case 7: return [4 /*yield*/, no_show_prediction_1.noShowPredictionEngine.getRiskFactorsByPatient(prediction.patient_id)];
                case 8:
                    riskFactors = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                ...
                case 9:
                    ...
                    if (error_2 instanceof Error && error_2.message.includes('validation')) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid input data', details: error_2.message }, { status: 400 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create prediction' }, { status: 500 })];
