        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error) {
                        throw new stock_1.StockAlertError('Failed to fetch active clinics', 'FETCH_CLINICS_FAILED', { error: error.message });
                    }
                    return [2 /*return*/, __spreadArray([], new Set((clinics === null || clinics === void 0 ? void 0 : clinics.map(function (c) { return c.clinic_id; })) || []), true)];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    console.log("Processed clinic ".concat(clinicId, ": ").concat(alerts.length, " alerts generated"));
                    return [3 /*break*/, 7];
                case 4:
                    error_2 = _a.sent();
                    attempts++;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (configError) {
                        throw new stock_1.StockAlertError('Failed to fetch alert configurations', 'FETCH_CONFIGS_FAILED', { clinicId: clinicId, error: configError.message });
                    }
                ...
                case 6:
                    _i++;
                    return [3 /*break*/, 2];
                case 7: return [2 /*return*/, generatedAlerts];
            }
        });
    });
}
...
function evaluateConfigCondition(config, supabase) {
    return __awaiter(this, void 0, void 0, function () {
        var product, shouldAlert, currentValue, message, daysUntilExpiration, daysUntilExpiration, maxStock, existingAlert, alertData, _a, newAlert, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    switch (config.alert_type) {
                        case 'low_stock':
                            ...
                            message = "Estoque baixo para ".concat(product.name, ": ").concat(currentValue, " unidades (limite: ").concat(config.threshold_value, ")");
                            break;
                        case 'expiring':
                            if (product.expiration_date) {
                                daysUntilExpiration = Math.ceil((new Date(product.expiration_date).getTime() - Date.now()) / (1000 * 60 * 60 * 24));
                                currentValue = daysUntilExpiration;
                                shouldAlert = daysUntilExpiration <= config.threshold_value && daysUntilExpiration > 0;
                                message = "Produto ".concat(product.name, " vence em ").concat(daysUntilExpiration, " dias");
                            }
                            break;
                        case 'expired':
                            if (product.expiration_date) {
                                ...
                                message = "Produto ".concat(product.name, " vencido h\u00E1 ").concat(Math.abs(daysUntilExpiration), " dias");
                            }
                            break;
                        case 'overstock':
                            currentValue = product.current_stock || 0;
                            ...
                            message = "Excesso de estoque para ".concat(product.name, ": ").concat(currentValue, " unidades (m\u00E1ximo: ").concat(maxStock, ")");
                            break;
                        default:
                            return [2 /*return*/, null];
                    }
                ...
                case 2:
                    ...
                    if (error) {
                        throw new stock_1.StockAlertError('Failed to create alert', 'CREATE_ALERT_FAILED', { configId: config.id, error: error.message });
                    }
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, supabase, clinicIds, batches, i, totalResult, i, batchResult, error_5, executionTime;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 1:
                    ...
                    if (!validateCronRequest(request)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Unauthorized', code: 'INVALID_CRON_REQUEST' }, { status: 401 })];
                    }
                ...
                case 3:
                    clinicIds = _b.sent();
                    console.log("Found ".concat(clinicIds.length, " clinics with active alert configurations"));
