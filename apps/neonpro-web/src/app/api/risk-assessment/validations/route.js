...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, assessmentId, validatorId, status_1, limit, offset, filters, validations, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    validatorId = searchParams.get('validatorId');
                    ...
                    if (status_1)
                        filters.validation_status = status_1;
                    return [4 /*yield*/, riskAssessmentService.getAllValidations(filters, limit, offset)];
                case 1:
                    validations = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching validations:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validationResult, requestData, validation, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    body = _a.sent();
                    validationResult = risk_assessment_automation_2.ValidationSchema.safeParse(body);
                    ...
                    return [4 /*yield*/, riskAssessmentService.createValidation(requestData)];
                case 2:
                    validation = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('Error creating validation:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
