...
var exportRequestSchema = zod_1.z.object({
    analysisIds: zod_1.z.array(zod_1.z.string().uuid()).min(1, 'Pelo menos uma análise deve ser selecionada'),
    format: zod_1.z.enum(['pdf', 'excel', 'json', 'csv'], { required_error: 'Formato de exportação é obrigatório' }),
...
exports.POST = (0, monitoring_1.withErrorMonitoring)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, _a, user, authError, body, validatedData, _b, analysisData, analysisError, exportResult, timestamp, filename, _c, headers, error_1;
        ...
        switch (_d.label) {
            ...
            case 5:
                ...
                if (!analysisData || analysisData.length === 0) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Nenhuma análise encontrada' }, { status: 404 })];
                }
                exportResult = void 0;
                ...
                switch (_c) {
                    ...
                    case 'csv': return [3 /*break*/, 8];
                    case 'pdf': return [3 /*break*/, 10];
                    case 'excel': return [3 /*break*/, 12];
                }
                return [3 /*break*/, 14];
            case 6: return [4 /*yield*/, generateJSONExport(analysisData, validatedData)];
            case 7:
                exportResult = _d.sent();
                return [3 /*break*/, 15];
            case 8: return [4 /*yield*/, generateCSVExport(analysisData, validatedData)];
            case 9:
                exportResult = _d.sent();
                return [3 /*break*/, 15];
            case 10: return [4 /*yield*/, generatePDFExport(analysisData, validatedData)];
            case 11:
                exportResult = _d.sent();
                return [3 /*break*/, 15];
            case 12: return [4 /*yield*/, generateExcelExport(analysisData, validatedData)];
            case 13:
                exportResult = _d.sent();
                return [3 /*break*/, 15];
            case 14: throw new Error('Formato de exportação não suportado');
            case 15: 
            // Log export activity
            return [4 /*yield*/, supabase.from('analysis_exports').insert({
                    user_id: user.id,
            ...
            case 16:
                ...
                headers.set('Content-Disposition', "attachment; filename=\"".concat(filename, ".").concat(validatedData.format, "\""));
                headers.set('Content-Length', exportResult.data.length.toString());
                return [2 /*return*/, new server_1.NextResponse(exportResult.data, {
                        status: 200,
                        headers: headers
                    })];
            case 17:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            exportData = {
                ...
                analyses: analysisData.map(function (analysis) {
                    var _a, _b;
                    return (__assign(__assign(__assign(__assign({ id: analysis.id, patientId: analysis.patient_id, treatmentType: analysis.treatment_type, status: analysis.status, createdAt: analysis.created_at }, (options.includeMetrics && {
                        metrics: {
                    ...
                    })), { performance: ((_a = analysis.analysis_performance) === null || _a === void 0 ? void 0 : _a[0]) || null, qualityControl: ((_b = analysis.analysis_quality_control) === null || _b === void 0 ? void 0 : _b[0]) || null }));
                })
            };
            return [2 /*return*/, {
...
function generateCSVExport(analysisData, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            headers = __spreadArray(__spreadArray([
                'ID',
                'Patient ID',
                'Treatment Type',
                'Status',
            ...
            rows = analysisData.map(function (analysis) {
                var _a, _b;
                return __spreadArray(__spreadArray([
                    ...
                    ((_b = (_a = analysis.analysis_performance) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.processing_time_ms) || ''
                ] : []), true), [
                    analysis.notes || ''
                ], false);
            });
            csvContent = __spreadArray([headers], rows, true).map(function (row) { return row.map(function (field) { return "\"".concat(String(field).replace(/"/g, '""'), "\""); }).join(','); })
                .join('\n');
            return [2 /*return*/, {
...
function generatePDFExport(analysisData, options) {
    return __awaiter(this, void 0, void 0, function () {
        var content;
        return __generator(this, function (_a) {
            content = "\nRELAT\u00D3RIO DE AN\u00C1LISE DE VIS\u00C3O COMPUTACIONAL\n\nGerado em: ".concat(new Date().toLocaleString('pt-BR'), "\nTotal de An\u00E1lises: ").concat(analysisData.length, "\n\n").concat(analysisData.map(function (analysis, index) { return "\nAN\u00C1LISE ".concat(index + 1, "\n").concat('='.repeat(20), "\nID: ").concat(analysis.id, "\nPaciente: ").concat(analysis.patient_id, "\nTipo de Tratamento: ").concat(analysis.treatment_type, "\nStatus: ").concat(analysis.status, "\nData: ").concat(new Date(analysis.created_at).toLocaleString('pt-BR'), "\n").concat(options.includeMetrics ? "\nM\u00C9TRICAS:\n- Precis\u00E3o: ".concat((analysis.accuracy_score * 100).toFixed(1), "%\n- Confian\u00E7a: ").concat((analysis.confidence * 100).toFixed(1), "%\n- Melhoria: ").concat(analysis.improvement_percentage.toFixed(1), "%\n") : '', "\n").concat(analysis.notes ? "Observa\u00E7\u00F5es: ".concat(analysis.notes) : '', "\n"); }).join('\n'), "\n");
            return [2 /*return*/, {
...
function generateExcelExport(analysisData, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, generateCSVExport(analysisData, options)];
                case 1:
                    csvResult = _a.sent();
                    return [2 /*return*/, {
                            data: csvResult.data,
...
exports.GET = (0, monitoring_1.withErrorMonitoring)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, _a, user, authError, searchParams, limit, offset, _b, exportHistory, error, error_2;
