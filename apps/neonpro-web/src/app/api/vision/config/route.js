...
var configSchema = zod_1.z.object({
    ...
    defaultConfidenceThreshold: zod_1.z.number().min(0.5).max(1.0).default(0.80),
...
exports.GET = (0, monitoring_1.withErrorMonitoring)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, _a, user, authError, _b, config, configError, defaultConfig, userConfig, systemInfo, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 4:
                ...
                userConfig = config ? __assign(__assign({}, defaultConfig), config.settings) : defaultConfig;
                systemInfo = {
                ...
                return [2 /*return*/, server_1.NextResponse.json({
                        ...
                        data: {
                            ...
                            lastUpdated: (config === null || config === void 0 ? void 0 : config.updated_at) || null
                        }
                    })];
            case 5:
                error_1 = _c.sent();
...
exports.PUT = (0, monitoring_1.withErrorMonitoring)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, _a, user, authError, body, validatedConfig, existingConfig, result, _b, data, error, _c, data, error, error_2;
        ...
        switch (_d.label) {
            ...
            case 4:
                ...
                if (validatedConfig.defaultAccuracyThreshold > validatedConfig.defaultConfidenceThreshold) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Limite de precisão não pode ser maior que limite de confiança' }, { status: 400 })];
                }
                if (validatedConfig.retentionPeriodDays < 30) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Período de retenção mínimo é de 30 dias' }, { status: 400 })];
                }
                return [4 /*yield*/, supabase
                        .from('vision_analysis_config')
                        .select('id')
...
exports.POST = (0, monitoring_1.withErrorMonitoring)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, _a, user, authError, searchParams, action, defaultConfig, _b, data, error, error_3;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, (0, server_2.createClient)()];
            case 1:
            ...
            case 6: return [2 /*return*/, server_1.NextResponse.json({ error: 'Ação não suportada' }, { status: 400 })];
            case 7:
                error_3 = _c.sent();
