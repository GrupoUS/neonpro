...
var shareRequestSchema = zod_1.z.object({
    ...
    shareType: zod_1.z.enum(['public', 'private', 'professional'], { required_error: 'Tipo de compartilhamento é obrigatório' }),
...
exports.POST = (0, monitoring_1.withErrorMonitoring)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, _a, user, authError, body, validatedData, _b, analysis, analysisError, shareId, shareUrl, defaultExpiration, expiresAt, hashedPassword, _c, shareRecord, shareError, error_1;
        ...
        switch (_d.label) {
            ...
            case 5:
                ...
                if (analysisError || !analysis) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Análise não encontrada ou acesso negado' }, { status: 404 })];
                }
            ...
            case 6:
                ...
                return [4 /*yield*/, supabase.from('analysis_activity_log').insert({
                        analysis_id: validatedData.analysisId,
                        user_id: user.id,
...
exports.GET = (0, monitoring_1.withErrorMonitoring)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, searchParams, shareId, password, viewerEmail, _a, shareRecord, shareError, providedPasswordHash, analysis, options, responseData, error_2;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0: return [4 /*yield*/, (0, server_2.createClient)()];
            ...
            case 2:
                ...
                if (!shareId) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'ID de compartilhamento é obrigatório' }, { status: 400 })];
                }
                return [4 /*yield*/, supabase
                        .from('analysis_shares')
            ...
            case 3:
                ...
                if (shareError || !shareRecord) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Link de compartilhamento não encontrado ou expirado' }, { status: 404 })];
                }
                // Check if share has expired
                if (new Date(shareRecord.expires_at) < new Date()) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Link de compartilhamento expirado' }, { status: 410 })];
                }
                ...
                if (shareRecord.password_hash && password) {
                    ...
                    if (providedPasswordHash !== shareRecord.password_hash) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Senha incorreta' }, { status: 401 })];
                    }
                }
                else if (shareRecord.password_hash && !password) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Senha obrigatória', requiresPassword: true }, { status: 401 })];
                }
                // Check email restrictions for private shares
                if (shareRecord.share_type === 'private' && ((_b = shareRecord.allowed_emails) === null || _b === void 0 ? void 0 : _b.length) > 0) {
                    if (!viewerEmail || !shareRecord.allowed_emails.includes(viewerEmail)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Acesso restrito - email não autorizado' }, { status: 403 })];
                    }
                }
            ...
            case 4:
                ...
                _d.sent();
                // Log view activity
                return [4 /*yield*/, supabase.from('analysis_share_views').insert({
                        share_id: shareId,
            ...
            case 5:
                ...
                responseData = {
                    ...
                    analysis: __assign(__assign(__assign(__assign(__assign(__assign({ id: analysis.id }, (options.includePersonalInfo && { patientId: analysis.patient_id })), { treatmentType: analysis.treatment_type, status: analysis.status, createdAt: analysis.created_at, notes: analysis.notes }), (options.includeMetrics && {
                        metrics: {
                    ...
                    })), { performance: ((_c = analysis.analysis_performance) === null || _c === void 0 ? void 0 : _c[0]) || null })
                };
                return [2 /*return*/, server_1.NextResponse.json({
                        success: true,
                        data: responseData
...
exports.DELETE = (0, monitoring_1.withErrorMonitoring)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 4:
                ...
                if (error || !data) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Compartilhamento não encontrado ou acesso negado' }, { status: 404 })];
                }
