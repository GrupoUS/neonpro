    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                if (!patientId) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'ID do paciente é obrigatório' }, { status: 400 })];
                }
                return [4 /*yield*/, analysis_engine_1.visionAnalysisEngine.getPatientAnalysisHistory(patientId, limit, offset)];
            case 4:
                history_1 = _b.sent();
...
exports.POST = (0, monitoring_1.withErrorMonitoring)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, _a, user, authError, body, validatedData, startTime, analysisResult, processingTime, performanceWarnings, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, server_2.createClient)()];
            case 1:
            ...
            case 4:
                ...
                startTime = Date.now();
                return [4 /*yield*/, analysis_engine_1.visionAnalysisEngine.analyzeBeforeAfter(validatedData.beforeImageUrl, validatedData.afterImageUrl, validatedData.patientId, validatedData.treatmentType, validatedData.analysisOptions)];
            case 5:
                analysisResult = _b.sent();
                processingTime = Date.now() - startTime;
                performanceWarnings = [];
                if (analysisResult.accuracyScore < 0.95) {
                    performanceWarnings.push("Precis\u00E3o abaixo do esperado: ".concat((analysisResult.accuracyScore * 100).toFixed(1), "%"));
                }
                if (processingTime > 30000) {
                    performanceWarnings.push("Tempo de processamento excedeu 30s: ".concat((processingTime / 1000).toFixed(1), "s"));
                }
                // Log performance metrics
                return [4 /*yield*/, supabase.from('analysis_performance').insert({
...
// PUT - Update analysis
exports.PUT = (0, monitoring_1.withErrorMonitoring)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var supabase, _a, user, authError, searchParams, analysisId, body, notes, qualityRating, reviewStatus, _b, data, error, error_3;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                if (!analysisId) {
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'ID da análise é obrigatório' }, { status: 400 })];
                }
                return [4 /*yield*/, request.json()];
            case 4:
                body = _c.sent();
                notes = body.notes, qualityRating = body.qualityRating, reviewStatus = body.reviewStatus;
