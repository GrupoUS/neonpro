    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [3 /*break*/, 16];
        case 2:
          return [4 /*yield*/, handleCheckoutCompleted(supabase, event_1)];
        case 3:
          _b.sent();
          return [3 /*break*/, 17];
        case 4:
          return [4 /*yield*/, handlePaymentSucceeded(supabase, event_1)];
        case 5:
          _b.sent();
          return [3 /*break*/, 17];
        case 6:
          return [4 /*yield*/, handlePaymentFailed(supabase, event_1)];
        case 7:
          _b.sent();
          return [3 /*break*/, 17];
        case 8:
          return [4 /*yield*/, handleSubscriptionCreated(supabase, event_1)];
        case 9:
          _b.sent();
          return [3 /*break*/, 17];
        case 10:
          return [4 /*yield*/, handleSubscriptionUpdated(supabase, event_1)];
        case 11:
          _b.sent();
          return [3 /*break*/, 17];
        case 12:
          return [4 /*yield*/, handleSubscriptionDeleted(supabase, event_1)];
        case 13:
          _b.sent();
          return [3 /*break*/, 17];
        case 14:
          return [4 /*yield*/, handleInvoiceCreated(supabase, event_1)];
        case 15:
          _b.sent();
          return [3 /*break*/, 17];
        case 16:
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (
            !(metadata === null || metadata === void 0 ? void 0 : metadata.clinic_id) ||
            !(metadata === null || metadata === void 0 ? void 0 : metadata.plan_id)
          ) {
