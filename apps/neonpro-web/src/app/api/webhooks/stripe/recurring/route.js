            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    switch (_a) {
                        ...
                        case 'invoice.payment_failed': return [3 /*break*/, 4];
                        case 'invoice.created': return [3 /*break*/, 6];
                        case 'invoice.finalized': return [3 /*break*/, 8];
                        case 'customer.subscription.created': return [3 /*break*/, 10];
                        case 'customer.subscription.updated': return [3 /*break*/, 12];
                        case 'customer.subscription.deleted': return [3 /*break*/, 14];
                        case 'customer.subscription.trial_will_end': return [3 /*break*/, 16];
                        case 'payment_intent.succeeded': return [3 /*break*/, 18];
                        case 'payment_intent.payment_failed': return [3 /*break*/, 20];
                    }
                    return [3 /*break*/, 22];
                case 2: return [4 /*yield*/, handleInvoicePaymentSucceeded(event_1.data.object)];
                case 3:
                    _b.sent();
                    return [3 /*break*/, 23];
                case 4: return [4 /*yield*/, handleInvoicePaymentFailed(event_1.data.object)];
                case 5:
                    _b.sent();
                    return [3 /*break*/, 23];
                case 6: return [4 /*yield*/, handleInvoiceCreated(event_1.data.object)];
                case 7:
                    _b.sent();
                    return [3 /*break*/, 23];
                case 8: return [4 /*yield*/, handleInvoiceFinalized(event_1.data.object)];
                case 9:
                    _b.sent();
                    return [3 /*break*/, 23];
                case 10: return [4 /*yield*/, handleSubscriptionCreated(event_1.data.object)];
                case 11:
                    _b.sent();
                    return [3 /*break*/, 23];
                case 12: return [4 /*yield*/, handleSubscriptionUpdated(event_1.data.object)];
                case 13:
                    _b.sent();
                    return [3 /*break*/, 23];
                case 14: return [4 /*yield*/, handleSubscriptionDeleted(event_1.data.object)];
                case 15:
                    _b.sent();
                    return [3 /*break*/, 23];
                case 16: return [4 /*yield*/, handleSubscriptionTrialWillEnd(event_1.data.object)];
                case 17:
                    _b.sent();
                    return [3 /*break*/, 23];
                case 18: return [4 /*yield*/, handlePaymentIntentSucceeded(event_1.data.object)];
                case 19:
                    _b.sent();
                    return [3 /*break*/, 23];
                case 20: return [4 /*yield*/, handlePaymentIntentFailed(event_1.data.object)];
                case 21:
                    _b.sent();
                    return [3 /*break*/, 23];
                case 22:
                    ...
                    _b.label = 23;
                case 23: return [2 /*return*/, server_1.NextResponse.json({ received: true })];
                case 24:
                    error_1 = _b.sent();
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            failure_reason: ((_a = invoice.last_finalization_error) === null || _a === void 0 ? void 0 : _a.message) || 'Payment failed',
                            updated_at: new Date().toISOString()
                        })
                            .eq('id', billingEvent.id)];
                case 2:
                    ...
                    return [4 /*yield*/, recurring_payment_processor_1.recurringPaymentProcessor.schedulePaymentRetry(billingEvent.id)];
                case 3:
                    // Schedule retry if within limits
                    _b.sent();
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .update({
                            stripe_payment_intent_id: paymentIntent.id,
                            failure_reason: ((_a = paymentIntent.last_payment_error) === null || _a === void 0 ? void 0 : _a.message) || 'Payment failed',
                            updated_at: new Date().toISOString()
                        })
                            .eq('stripe_payment_intent_id', paymentIntent.id)];
                case 1:
