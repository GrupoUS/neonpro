    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 9:
          ...
          return [3 /*break*/, 21];
        case 10:
          return [4 /*yield*/, handlePaymentIntentProcessing(event_1.data.object)];
        case 11:
          _b.sent();
          return [3 /*break*/, 21];
        case 12:
          return [4 /*yield*/, handlePaymentMethodAttached(event_1.data.object)];
        case 13:
          _b.sent();
          return [3 /*break*/, 21];
        case 14:
          return [4 /*yield*/, handleCustomerUpdated(event_1.data.object)];
        case 15:
          _b.sent();
          return [3 /*break*/, 21];
        case 16:
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, (_c) => {
      try {
        ...
        console.log(
          "Payment failed for installment ".concat(installmentId, ": ").concat(errorMessage),
        );
        ...
        console.log({
          ...
          error: errorMessage,
          errorCode:
            (_b = paymentIntent.last_payment_error) === null || _b === void 0 ? void 0 : _b.code,
          paymentIntentId: paymentIntent.id,
          timestamp: new Date().toISOString(),
        });
  ...
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, (_a) => {
      try {
        console.log(
          "Payment method "
            .concat(paymentMethod.id, " attached to customer ")
            .concat(paymentMethod.customer),
        );
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, (_c) => {
      try {
        ...
        paymentPlanId =
          (_b = invoice.metadata) === null || _b === void 0 ? void 0 : _b.payment_plan_id;
