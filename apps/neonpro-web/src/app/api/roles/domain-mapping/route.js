    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            supabase.from("role_domain_mappings").select("*").order("domain", { ascending: true }),
          ];
        case 4:
      ...
      switch (_e.label) {
        ...
        case 5:
          ...
          if (checkError && checkError.code !== "PGRST116") {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Erro ao verificar domínio" }, { status: 500 }),
            ];
          }
          if (existingMapping) {
            return [
          ...
          return [
            4 /*yield*/,
            supabase.from("role_domain_mappings").insert(newMapping).select().single(),
          ];
        case 6:
