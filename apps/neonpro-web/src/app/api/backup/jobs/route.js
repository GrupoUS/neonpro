...
var startBackupSchema = zod_1.z.object({
    config_id: zod_1.z.string().uuid('ID de configuração inválido'),
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, searchParams, page, limit, status_1, type, config_id, filters, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    if (!backupManager) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Backup service not configured' }, { status: 503 })];
                    }
                ...
                case 2:
                    ...
                    filters = __assign(__assign(__assign({}, (status_1 && { status: status_1 })), (type && { type: type })), (config_id && { config_id: config_id }));
                    return [4 /*yield*/, backupManager.getBackupJobs({
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Erro ao buscar jobs de backup:', error_1);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    body = _a.sent();
                    validatedData = startBackupSchema.parse(body);
                    return [4 /*yield*/, backupManager.startBackup(__assign(__assign({}, validatedData), { initiated_by: user.id }))];
                case 4:
                    result = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(result, {
                ...
                case 5:
                    ...
                    console.error('Erro ao iniciar backup:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro interno do servidor' }, { status: 500 })];
