        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    filters = __assign(__assign({}, (status_1 && { status: status_1 })), (type && { type: type }));
                    return [4 /*yield*/, backupManager.getRecoveryOperations({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, backupManager.startRecovery(__assign(__assign({}, validatedData), { initiated_by: user.id }))];
                case 4:
                    result = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(result, {
