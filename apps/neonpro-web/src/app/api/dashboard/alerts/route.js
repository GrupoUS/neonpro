            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (alertId && data && data.length === 0) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Alert not found' }, { status: 404 })];
                    }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!alertId) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Alert ID is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('dashboard_alerts')
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to update alert' }, { status: 500 })];
                    }
                    if (!data) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Alert not found' }, { status: 404 })];
                    }
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to delete alert' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ message: 'Alert deleted successfully' })];
                case 4:
                    error_4 = _a.sent();
