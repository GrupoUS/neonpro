            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch performance logs' }, { status: 500 })];
                    }
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!metric_type || value === undefined) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Metric type and value are required' }, { status: 400 })];
                    }
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create performance log' }, { status: 500 })];
                    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!olderThan) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'older_than parameter is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('dashboard_performance_logs')
                            .delete()
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to delete performance logs' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ message: 'Performance logs deleted successfully' })];
                case 4:
                    error_3 = _a.sent();
