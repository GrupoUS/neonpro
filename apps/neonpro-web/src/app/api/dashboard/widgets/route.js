...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, url, configId, widgetId, _a, data, error, _b, data, error, _c, data, error, error_1;
            ...
            switch (_d.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch widget' }, { status: 500 })];
                    }
                    if (!data) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Widget not found' }, { status: 404 })];
                    }
                ...
                case 5:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch widgets' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json(data || [])];
            ...
            switch (_b.label) {
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create widget' }, { status: 500 })];
                    }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!widgetId) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Widget ID is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('dashboard_widgets')
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to update widget' }, { status: 500 })];
                    }
                    if (!data) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Widget not found' }, { status: 404 })];
                    }
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to delete widget' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ message: 'Widget deleted successfully' })];
                case 4:
                    error_4 = _a.sent();
