...
function GET(request) {
  return __awaiter(this, void 0, void 0, function () {
    var supabase, user, url, configId, _a, _data, _error, _b, data, error, error_1;
      ...
      switch (_c.label) {
        ...
        case 3:
          ...
          if (!data) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Dashboard config not found" }, { status: 404 }),
            ];
          }
      ...
      switch (_a.label) {
        ...
        case 2:
          ...
          if (!configId) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Config ID is required" }, { status: 400 }),
            ];
          }
          return [
            4 /*yield*/,
            supabase.from("dashboard_configs").delete().eq("id", configId).eq("user_id", user.id),
          ];
        case 3:
          error = _a.sent().error;
          if (error) {
          ...
          return [
            2 /*return*/,
            server_2.NextResponse.json({ message: "Dashboard config deleted successfully" }),
          ];
        case 4:
          error_4 = _a.sent();
