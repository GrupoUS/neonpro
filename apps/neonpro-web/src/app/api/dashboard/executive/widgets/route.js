...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, clinicUser, searchParams, layoutId, category, type, active, withData, widgetService_1, filters, widgets, widgetsWithData, error_1;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                    ...
                    return [4 /*yield*/, Promise.all(widgets.map(function (widget) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        error_2 = _a.sent();
                                        console.error("Error fetching data for widget ".concat(widget.id, ":"), error_2);
                                        return [2 /*return*/, __assign(__assign({}, widget), { data: null, error: 'Erro ao carregar dados' })];
                ...
                case 6: return [2 /*return*/, server_1.NextResponse.json({ widgets: widgets })];
                case 7:
                    error_1 = _b.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, clinicUser, body, validatedData, widgetService, widget, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 6, , 7]);
                ...
                case 6:
                    ...
                    if (error_3 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Dados invÃ¡lidos', details: error_3.errors }, { status: 400 })];
                    }
