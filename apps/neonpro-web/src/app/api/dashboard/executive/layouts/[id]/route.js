        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    if (!clinicUser) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Usuário não associado a uma clínica' }, { status: 403 })];
                    }
                    layoutEngine = new dashboard_layout_engine_1.DashboardLayoutEngine(supabase, clinicUser.clinic_id);
                    return [4 /*yield*/, layoutEngine.getLayout(params.id)];
                case 3:
                    layout = _d.sent();
                    if (!layout) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Layout não encontrado' }, { status: 404 })];
                    }
...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, clinicUser, body, validatedData, layoutEngine, existingLayout, layout, error_2;
        var params = _b.params;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                ...
                case 6:
                    ...
                    if (error_2 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Dados inválidos', details: error_2.errors }, { status: 400 })];
                    }
            ...
            switch (_d.label) {
                ...
                case 3:
                    ...
                    if (existingLayout.isDefault) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Não é possível deletar o layout padrão' }, { status: 400 })];
                    }
