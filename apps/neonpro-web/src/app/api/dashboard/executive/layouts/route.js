...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, clinicUser, body, validatedData, layoutEngine, layout, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 6, , 7]);
                ...
                case 4:
                    ...
                    layoutEngine = new dashboard_layout_engine_1.DashboardLayoutEngine(supabase, clinicUser.clinic_id);
                    return [4 /*yield*/, layoutEngine.createLayout(__assign(__assign({}, validatedData), { userId: user.id }))];
                case 5:
                    layout = _b.sent();
