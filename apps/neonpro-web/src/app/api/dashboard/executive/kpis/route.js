...
var CalculateKPIsSchema = zod_1.z.object({
  ...
  categories: zod_1.z
    .array(zod_1.z.enum(["financial", "operational", "patients", "staff"]))
    .optional(),
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 4:
          ...
          kpiService = new kpi_calculation_service_1.createkpiCalculationService(
            supabase,
            clinicUser.clinic_id,
          );
          return [
            4 /*yield*/,
            kpiService.calculateKPIsForPeriod(
