...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, clinicUser, searchParams, type, status_1, limit, offset, reportSystem, templates, schedules, filters, instances, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, reportSystem.getTemplates({
                ...
                case 5:
                    ...
                    return [4 /*yield*/, reportSystem.getSchedules({
                            isActive: status_1 !== 'inactive'
                        })];
                case 6:
                    schedules = _b.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, clinicUser, searchParams, action, reportSystem, body, validatedData, reportInstance, body, validatedData, template, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 10, , 11]);
                ...
                case 4:
                    ...
                    return [4 /*yield*/, reportSystem.generateReport(validatedData.templateId, {
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ reportInstance: reportInstance }, { status: 201 })];
                case 6: return [4 /*yield*/, request.json()];
                case 7:
                    body = _b.sent();
                ...
                case 8:
                    template = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ template: template }, { status: 201 })];
                case 9: return [3 /*break*/, 11];
                case 10:
                    error_2 = _b.sent();
