...
var CreateAlertRuleSchema = zod_1.z.object({
    ...
    notificationConfig: zod_1.z.object({
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, clinicUser, searchParams, type, status_1, severity, limit, offset, alertSystem, rules, filters, instances, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (authError || !user) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Nï¿½o autorizado' }, { status: 401 })];
                    }
                ...
                case 3:
                    ...
                    if (!clinicUser) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Usuï¿½rio nï¿½o associado a uma clï¿½nica' }, { status: 403 })];
                    }
                    ...
                    return [4 /*yield*/, alertSystem.getAlertRules({
            ...
            switch (_b.label) {
                ...
                case 6:
                    ...
                    if (error_2 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Dados invï¿½lidos', details: error_2.errors }, { status: 400 })];
                    }
