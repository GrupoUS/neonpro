...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, supabase, _a, user, authError, _b, profile, profileError, body, validatedData, _c, validationResult, validationError, result, response, status_1, error_1;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, supabase.rpc("sp_validate_appointment_slot", {
                ...
                case 6:
                    ...
                    result = typeof validationResult === "string"
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, supabase, _a, user, authError, _b, profile, profileError, searchParams, professionalId, serviceTypeId, startTime_1, endTime, excludeAppointmentId, queryData, validatedData, _c, validationResult, validationError, result, error_2;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    startTime = Date.now();
