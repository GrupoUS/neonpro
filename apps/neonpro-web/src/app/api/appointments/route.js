...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, body, _a, profile, profileError, _b, bookingResult, bookingError, response, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, supabase.rpc("book_appointment", {
                ...
                case 5:
                    ...
                    if (!bookingResult || !bookingResult.success) {
                        return [2 /*return*/, server_2.NextResponse.json({
                                success: false,
                                error_message: (bookingResult === null || bookingResult === void 0 ? void 0 : bookingResult.error_message) || "Erro desconhecido ao agendar",
                            }, { status: 400 })];
                    }
                    response = {
                        success: true,
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, profile, searchParams, search, status_1, professional_id, service_type_id, date_from, date_to, query, endDate, _a, appointmentsData, error, appointments, searchLower_1, error_2;
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!(profile === null || profile === void 0 ? void 0 : profile.clinic_id)) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Clinic not found" }, { status: 400 })];
                    }
                ...
                case 4:
                    ...
                    if (search && appointments) {
                        ...
                        appointments = appointments.filter(function (appointment) {
                            ...
                            var patientName = ((_c = (_b = (_a = appointment.patients) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.full_name) === null || _c === void 0 ? void 0 : _c.toLowerCase()) || '';
                            var notes = ((_d = appointment.notes) === null || _d === void 0 ? void 0 : _d.toLowerCase()) || '';
                            var professionalName = ((_g = (_f = (_e = appointment.professionals) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.full_name) === null || _g === void 0 ? void 0 : _g.toLowerCase()) || '';
                            var serviceName = ((_k = (_j = (_h = appointment.service_types) === null || _h === void 0 ? void 0 : _h[0]) === null || _j === void 0 ? void 0 : _j.name) === null || _k === void 0 ? void 0 : _k.toLowerCase()) || '';
                            return (patientName.includes(searchLower_1) ||
