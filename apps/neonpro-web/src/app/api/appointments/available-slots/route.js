...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, searchParams, professionalId, date, profile, generateTimeSlots, timeSlots, startOfDay, endOfDay, _a, existingAppointments_1, appointmentsError, availableSlots, response, error_1;
            ...
            switch (_b.label) {
                ...
                case 4:
                    ...
                    availableSlots = timeSlots.map(function (slot) {
                        ...
                        var hasConflict = existingAppointments_1 === null || existingAppointments_1 === void 0 ? void 0 : existingAppointments_1.some(function (appointment) {
