...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, resolvedParams, appointmentId, searchParams, limit, offset, _c, history_1, error, count, transformedHistory, response, error_1;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    ...
                    transformedHistory = (history_1 || []).map(function (entry) {
                        var _a;
                        return (__assign(__assign({}, entry), { changed_by_name: ((_a = entry.changed_by_user) === null || _a === void 0 ? void 0 : _a.full_name) || 'Unknown User' }));
                    });
                    response = {
                        success: true,
