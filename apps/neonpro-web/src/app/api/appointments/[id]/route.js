...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, resolvedParams, appointmentId, _c, appointment, error, appointmentWithDetails, response, error_1;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    if (!session) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error_message: 'Authentication required' }, { status: 401 })];
                    }
                ...
                case 4:
                    ...
                    if (error || !appointment) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error_message: 'Appointment not found' }, { status: 404 })];
                    }
                    appointmentWithDetails = __assign(__assign({}, appointment), { patient_name: appointment.patients.full_name, patient_email: appointment.patients.email, patient_phone: appointment.patients.phone, professional_name: appointment.professionals.full_name, service_name: appointment.service_types.name, service_duration: appointment.service_types.duration_minutes, service_price: appointment.service_types.price, service_color: appointment.service_types.color, clinic_name: appointment.clinics.name });
                    response = {
                        success: true,
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ success: false, error_message: 'Internal server error' }, { status: 500 })];
...
function PATCH(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, session, resolvedParams, appointmentId, updateData, processedData, _c, data, error, _d, updatedAppointment, fetchError, appointmentWithDetails, response, error_2;
        var _e, _f;
        var params = _b.params;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 4:
                    updateData = _g.sent();
                    processedData = __assign(__assign({}, updateData), { start_time: updateData.start_time ? new Date(updateData.start_time).toISOString() : undefined, end_time: updateData.end_time ? new Date(updateData.end_time).toISOString() : undefined, updated_by: session.user.id, updated_at: new Date().toISOString() });
                    return [4 /*yield*/, supabase.rpc('sp_update_appointment', {
                ...
                case 5:
                    ...
                    if (error) {
                        ...
                        if ((_f = error.message) === null || _f === void 0 ? void 0 : _f.includes('business_hours')) {
                            return [2 /*return*/, server_1.NextResponse.json({
                                    success: false,
                ...
                case 6:
                    ...
                    appointmentWithDetails = __assign(__assign({}, updatedAppointment), { patient_name: updatedAppointment.patients.full_name, patient_email: updatedAppointment.patients.email, patient_phone: updatedAppointment.patients.phone, professional_name: updatedAppointment.professionals.full_name, service_name: updatedAppointment.service_types.name, service_duration: updatedAppointment.service_types.duration_minutes, service_price: updatedAppointment.service_types.price, service_color: updatedAppointment.service_types.color, clinic_name: updatedAppointment.clinics.name });
                    response = {
                        success: true,
                        data: appointmentWithDetails
                    };
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, supabase.rpc('sp_delete_appointment', {
                            p_appointment_id: appointmentId,
