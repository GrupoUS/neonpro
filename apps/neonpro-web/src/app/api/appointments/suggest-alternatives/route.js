...
var suggestAlternativesSchema = zod_1.z.object({
    ...
    preferred_times: zod_1.z.array(zod_1.z.string().regex(/^([0-1][0-9]|2[0-3]):[0-5][0-9]$/)).optional(),
    exclude_appointment_id: zod_1.z.string().uuid().optional(),
});
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, supabase, _a, user, authError, _b, profile, profileError, body, validatedData_1, _c, suggestionsResult, suggestionsError, result, enhancedSuggestions, response, error_1;
            ...
            switch (_d.label) {
                ...
                case 3:
                    ...
                    if (authError || !(user === null || user === void 0 ? void 0 : user.id)) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Unauthorized", details: "Authentication required" }, { status: 401 })];
                    }
                ...
                case 5:
                    ...
                    return [4 /*yield*/, supabase.rpc("sp_suggest_alternative_slots", {
                ...
                case 6:
                    ...
                    result = typeof suggestionsResult === "string"
                        ? JSON.parse(suggestionsResult)
                        : suggestionsResult;
                    enhancedSuggestions = (result.suggestions || []).map(function (slot) { return (__assign(__assign({}, slot), { formatted_start_time: new Date(slot.start_time).toLocaleString('pt-BR', {
                            dateStyle: 'short',
                            timeStyle: 'short',
                            ...
                            new Date(validatedData_1.preferred_start_time).toDateString(), days_from_preferred: Math.ceil((new Date(slot.start_time).getTime() -
                            new Date(validatedData_1.preferred_start_time).getTime()) /
                            (1000 * 60 * 60 * 24)) })); });
                    // Sort suggestions by score (highest first)
                    enhancedSuggestions.sort(function (a, b) { return b.score - a.score; });
                    response = {
                        ...
                        metadata: {
                            ...
                            search_window_end: new Date(new Date(validatedData_1.preferred_start_time).getTime() +
                                (validatedData_1.search_window_days * 24 * 60 * 60 * 1000)).toISOString(),
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, supabase, _a, user, authError, _b, profile, profileError, searchParams, professionalId, serviceTypeId, preferredStartTime, durationMinutes, maxSuggestions, queryData, validatedData, _c, suggestionsResult, suggestionsError, result, error_2;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    startTime = Date.now();
                ...
                case 4:
                    _b = _d.sent(), profile = _b.data, profileError = _b.error;
                    if (profileError || !(profile === null || profile === void 0 ? void 0 : profile.clinic_id)) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Profile not found" }, { status: 404 })];
                    }
                    ...
                    if (!professionalId || !serviceTypeId || !preferredStartTime || !durationMinutes) {
                        return [2 /*return*/, server_2.NextResponse.json({
                                ...
                                details: "professional_id, service_type_id, preferred_start_time, and duration_minutes are required",
                            }, { status: 400 })];
                    }
                    queryData = {
