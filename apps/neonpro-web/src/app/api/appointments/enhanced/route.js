...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, body, _a, profile, profileError, _b, patientResult, professionalResult, serviceResult, clinicResult, _c, appointment, appointmentError, automationResults, automationError_1, response, error_1;
        ...
        return __generator(this, function (_o) {
            switch (_o.label) {
                ...
                case 2:
                    ...
                    if (!user) {
                        return [2 /*return*/, server_2.NextResponse.json({ success: false, error_message: "Unauthorized" }, { status: 401 })];
                    }
                ...
                case 4:
                    ...
                    if (profileError || !profile) {
                        return [2 /*return*/, server_2.NextResponse.json({ success: false, error_message: "Perfil do usuário não encontrado" }, { status: 400 })];
                    }
                ...
                case 5:
                    _b = _o.sent(), patientResult = _b[0], professionalResult = _b[1], serviceResult = _b[2], clinicResult = _b[3];
                    return [4 /*yield*/, supabase
                            .from("appointments")
                            .insert({
                            ...
                            appointment_time: ((_d = body.start_time.split("T")[1]) === null || _d === void 0 ? void 0 : _d.split("Z")[0]) || body.start_time,
                ...
                case 7:
                    ...
                    if (!(((_e = patientResult.data) === null || _e === void 0 ? void 0 : _e.email) &&
                        ((_f = professionalResult.data) === null || _f === void 0 ? void 0 : _f.name) &&
                        ((_g = serviceResult.data) === null || _g === void 0 ? void 0 : _g.name) &&
                        ((_h = clinicResult.data) === null || _h === void 0 ? void 0 : _h.name))) return [3 /*break*/, 9];
                    console.log("🤖 Triggering appointment automation...");
                    return [4 /*yield*/, trigger_jobs_1.NeonProAutomation.onNewAppointmentCreated({
                ...
                case 8:
                    ...
                    console.log("✅ Appointment automation triggered successfully", {
                        appointmentId: appointment.id,
                        confirmationJobId: (_j = automationResults === null || automationResults === void 0 ? void 0 : automationResults.confirmation) === null || _j === void 0 ? void 0 : _j.jobId,
                        reminderJobId: (_k = automationResults === null || automationResults === void 0 ? void 0 : automationResults.reminder) === null || _k === void 0 ? void 0 : _k.jobId,
                    });
                    _o.label = 9;
                ...
                case 10:
                    ...
                    console.error("⚠️ Automation failed, but appointment was created", {
                        appointmentId: appointment.id,
                        error: automationError_1 instanceof Error ? automationError_1.message : automationError_1,
                    });
                    return [3 /*break*/, 11];
                case 11:
                    response = {
                        ...
                        automation: automationResults ? {
                            confirmation_job_id: (_l = automationResults.confirmation) === null || _l === void 0 ? void 0 : _l.jobId,
                            reminder_job_id: (_m = automationResults.reminder) === null || _m === void 0 ? void 0 : _m.jobId,
                            status: "triggered",
                        } : {
                            status: "skipped",
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, searchParams, user, _a, profile, profileError, date, status_1, limit, query, _b, appointments, appointmentsError, enhancedAppointments, error_2;
            ...
            switch (_c.label) {
                ...
                case 4:
                    ...
                    if (appointmentsError) {
                        return [2 /*return*/, server_2.NextResponse.json({ success: false, error_message: "Erro ao buscar consultas" }, { status: 500 })];
                    }
                    enhancedAppointments = appointments === null || appointments === void 0 ? void 0 : appointments.map(function (appointment) { return (__assign(__assign({}, appointment), { automation_status: {
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({
                            ...
                            total: (enhancedAppointments === null || enhancedAppointments === void 0 ? void 0 : enhancedAppointments.length) || 0,
