...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, professionalId, clinicId, startDateStr, endDateStr, serviceTypeId, startDate, endDate, supabase, _a, professionalSchedule, existingAppointments, serviceRules, holidays, days, _loop_1, currentDate, response, error_1;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!professionalId || !clinicId || !startDateStr || !endDateStr) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Missing required parameters" }, { status: 400 })];
                    }
                ...
                case 2:
                    _a = _b.sent(), professionalSchedule = _a[0], existingAppointments = _a[1], serviceRules = _a[2], holidays = _a[3];
                    days = [];
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    daySchedule = professionalSchedule.find(function (s) { return s.day_of_week === dayOfWeek; });
                                    if (!(daySchedule && daySchedule.is_available)) return [3 /*break*/, 2];
                                    return [4 /*yield*/, generateDayAvailability(currentDate, daySchedule, existingAppointments, serviceRules, holidays)];
                                case 1:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, supabase
                        ...
                        .eq("clinic_id", clinicId)
                        .eq("is_active", true)
                        .or("start_date.lte.".concat((0, date_fns_1.format)(endDate, "yyyy-MM-dd"), ",end_date.gte.").concat((0, date_fns_1.format)(startDate, "yyyy-MM-dd")))];
                case 1:
                    _a = _b.sent(), data = _a.data, error = _a.error;
                    if (error) {
...
function generateDayAvailability(date, schedule, appointments, serviceRules, holidays) {
    return __awaiter(this, void 0, void 0, function () {
        var slots, intervalMinutes, startTime, endTime, dayHolidays, currentTime, slotStart, slotEnd, slot, summary;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, analyzeSlot(slotStart, slotEnd, schedule, appointments, serviceRules, dayHolidays)];
                case 2:
                    slot = _a.sent();
                    slots.push(slot);
                    _a.label = 3;
                ...
                case 4:
                    summary = {
                        ...
                        available_slots: slots.filter(function (s) { return s.available && s.conflicts.length === 0; }).length,
                        blocked_slots: slots.filter(function (s) { return !s.available; }).length,
                        warning_slots: slots.filter(function (s) { return s.available && s.conflicts.some(function (c) { return c.severity === "warning"; }); }).length,
                    };
                    return [2 /*return*/, {
...
function analyzeSlot(slotStart, slotEnd, schedule, appointments, serviceRules, holidays) {
    return __awaiter(this, void 0, void 0, function () {
        var conflicts, available, capacityUsed, maxCapacity, _i, holidays_1, holiday, holidayStartTime, holidayEndTime, slotStartTime, slotEndTime, breakStart, breakEnd, slotStartTime, slotEndTime, hourStart, hourEnd, appointmentsInHour, directOverlaps, bufferBefore_1, bufferAfter_1, bufferConflicts;
        return __generator(this, function (_a) {
            conflicts = [];
            available = true;
            capacityUsed = 0;
            ...
            if (serviceRules) {
                ...
                if (bufferBefore_1 > 0 || bufferAfter_1 > 0) {
                    bufferConflicts = appointments.filter(function (apt) {
                        ...
                        return ((slotWithBufferStart >= aptStart && slotWithBufferStart < aptEnd) ||
                    ...
                    if (bufferConflicts.length > 0) {
                        conflicts.push({
                            ...
                            message: "Conflito com tempo de buffer (".concat(bufferBefore_1 + bufferAfter_1, "min)"),
                            severity: "warning",
                        });
                    }
                }
