...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, params, supabase, _a, professionalSchedule, serviceRules, existingAppointments, suggestions, preferredDate, searchInfo, response, error_1;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            ...
                            getExistingAppointments(supabase, params.professional_id, params.clinic_id, params.search_window_days, params.exclude_appointment_id),
                        ])];
                case 2:
                    _a = _b.sent(), professionalSchedule = _a[0], serviceRules = _a[1], existingAppointments = _a[2];
                    return [4 /*yield*/, generateSlotSuggestions(params, professionalSchedule, serviceRules, existingAppointments)];
                case 3:
                    suggestions = _b.sent();
                    ...
                    searchInfo = {
                        ...
                        search_period: {
                            ...
                            end_date: (0, date_fns_1.format)((0, date_fns_1.addDays)(preferredDate, params.search_window_days), "yyyy-MM-dd"),
                        },
                    };
                    response = {
...
function generateSlotSuggestions(params, schedule, serviceRules, existingAppointments) {
    return __awaiter(this, void 0, void 0, function () {
        var suggestions, preferredDate, preferredTime, scheduleMap, appointments, dayOffset, searchDate, dayOfWeek, daySchedule, daySlots;
        return __generator(this, function (_a) {
            ...
            appointments = existingAppointments.map(function (apt) { return ({
            ...
            for (dayOffset = 0; dayOffset < params.search_window_days; dayOffset++) {
                ...
                daySlots = generateDaySuggestions(searchDate, daySchedule, serviceRules, appointments, params, preferredTime, dayOffset);
                suggestions.push.apply(suggestions, daySlots);
            }
            // Sort by score (best first)
            return [2 /*return*/, suggestions.sort(function (a, b) { return (b.score || 0) - (a.score || 0); })];
        });
    });
}
function generateDaySuggestions(date, schedule, serviceRules, appointments, params, preferredTime, dayOffset) {
    var slots = [];
    ...
    while (currentTime + params.duration_minutes <= endTime) {
        ...
        // Check for conflicts
        var conflicts = checkSlotConflicts(slotStart, slotEnd, appointments, schedule, bufferBefore, bufferAfter);
        var hasErrors = conflicts.some(function (c) { return c.severity === "error"; });
        if (!hasErrors) {
...
function checkSlotConflicts(slotStart, slotEnd, appointments, schedule, bufferBefore, bufferAfter) {
    ...
    for (var _i = 0, appointments_1 = appointments; _i < appointments_1.length; _i++) {
        ...
        if ((slotStartWithBuffer >= apt.start && slotStartWithBuffer < apt.end) ||
    ...
    if (schedule.break_start_time && schedule.break_end_time) {
        ...
        if ((slotTimeStart >= breakStart && slotTimeStart < breakEnd) ||
    ...
    var appointmentsInHour = appointments.filter(function (apt) { return apt.start >= hourStart && apt.start < hourEnd; }).length;
    if (appointmentsInHour >= (schedule.max_appointments_per_hour || 4)) {
        conflicts.push({
            type: "capacity_exceeded",
            message: "Capacidade m\u00E1xima da hora (".concat(schedule.max_appointments_per_hour, ") atingida"),
            severity: "warning",
        });
    }
    return conflicts;
