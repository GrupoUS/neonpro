...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, body, appointment_id, professional_id, clinic_id, patient_id, service_type_id, start_time, end_time, override_reason, conflicts, hasManagerPermission, _b, transactionResult, transactionError, response, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    body = _c.sent();
                    appointment_id = body.appointment_id, professional_id = body.professional_id, clinic_id = body.clinic_id, patient_id = body.patient_id, service_type_id = body.service_type_id, start_time = body.start_time, end_time = body.end_time, override_reason = body.override_reason, conflicts = body.conflicts;
                ...
                case 4:
                    ...
                    if (!hasManagerPermission) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Insufficient permissions. Manager access required." }, { status: 403 })];
                    }
                    return [4 /*yield*/, supabase.rpc("handle_conflict_override", {
                ...
                case 5:
                    ...
                    if (transactionError) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to process override request" }, { status: 500 })];
                    }
                    // Send notifications
                    return [4 /*yield*/, sendOverrideNotifications(supabase, transactionResult.appointment_id, professional_id, patient_id, user.email || "Unknown Manager", override_reason, conflicts)];
                case 6:
                    // Send notifications
                    _c.sent();
                    response = {
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, appointmentId, clinicId, supabase, _a, user, authError, hasAccess, _b, overrides, error, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 5, , 6]);
                    ...
                    if (!appointmentId || !clinicId) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Missing appointment_id or clinic_id parameter" }, { status: 400 })];
                    }
                    return [4 /*yield*/, (0, server_1.createClient)()];
                case 1:
                    supabase = _c.sent();
                ...
                case 3:
                    hasAccess = _c.sent();
                    if (!hasAccess) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Access denied" }, { status: 403 })];
                    }
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to fetch override history" }, { status: 500 })];
                    }
...
function sendOverrideNotifications(supabase, appointmentId, professionalId, patientId, managerEmail, overrideReason, conflicts) {
    return __awaiter(this, void 0, void 0, function () {
                    ...
                    notifications = [
                        {
                            ...
                            message: "Um gestor (".concat(managerEmail, ") autorizou um agendamento que possui conflitos. Motivo: ").concat(overrideReason),
                            data: {
                        ...
                        },
                        {
                            ...
                            message: "Seu agendamento foi confirmado mesmo com restri\u00E7\u00F5es. Profissional: ".concat(appointment.profiles.full_name),
                            data: {
                                appointment_id: appointmentId,
                                start_time: appointment.start_time,
