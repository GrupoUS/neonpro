...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var validation, clinicId, _a, start_date, end_date, treatmentIds, minROI, minProcedures, sortBy, sortOrder, filters, validatedFilters, profitabilityAnalysis, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    _a = getDateRangeParams(request), start_date = _a.start_date, end_date = _a.end_date;
                    ...
                    return [4 /*yield*/, (0, marketing_roi_service_1.createmarketingROIService)().getTreatmentProfitabilityAnalysis(clinicId, validatedFilters)];
                case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    body = _a.sent();
                    treatment_id = body.treatment_id, period_start = body.period_start, period_end = body.period_end;
                    if (!treatment_id || !period_start || !period_end) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'treatment_id, period_start, and period_end are required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, (0, marketing_roi_service_1.createmarketingROIService)().calculateTreatmentROI(clinicId, treatment_id, new Date(period_start), new Date(period_end))];
                case 3:
