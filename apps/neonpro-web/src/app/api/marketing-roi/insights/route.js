    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 2:
          ...
          campaignIds =
            (_a = searchParams.get("campaignIds")) === null || _a === void 0
              ? void 0
              : _a.split(",").filter(Boolean);
          treatmentIds =
            (_b = searchParams.get("treatmentIds")) === null || _b === void 0
              ? void 0
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().generateMarketingInsights(
              requestData,
            ),
          ];
        case 3:
          ...
          response = {
            ...
            metadata: {
              ...
              confidenceScore:
                insights.reduce(function (sum, i) {
                  return sum + (i.confidence || 0);
                }, 0) / insights.length,
            },
          };
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().generateDeepAnalytics({
              insights: insights,
        ...
        case 5:
          ...
          return [
            4 /*yield*/,
            (0,
            marketing_roi_service_1.createmarketingROIService)().generateActionableRecommendations({
              insights: insights,
              analytics: analytics,
              priority: "high",
            }),
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          (_a = _b.sent()),
            (insightId = _a.insightId),
            (feedback = _a.feedback),
            (rating = _a.rating),
            (implemented = _a.implemented);
          if (!insightId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Insight ID is required" }, { status: 400 }),
            ];
          }
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().updateInsightFeedback(
              insightId,
              {
                feedback: feedback,
                rating: rating,
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().improveInsightAccuracy(
              insightId,
              { feedback: feedback, rating: rating, implemented: implemented },
            ),
          ];
        case 5:
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().deleteInsight(insightId),
          ];
        case 3:
          result = _a.sent();
          return [
