...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: "Failed to generate marketing insights" }, { status: 500 });
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updatedInsight = await createmarketingROIService().updateInsightFeedback(insightId, {
      feedback,
      rating,
      implemented,
    ...
    const learningResult = await createmarketingROIService().improveInsightAccuracy(insightId, {
      feedback,
      rating,
      implemented,
    });
    ...
    return NextResponse.json({ error: "Failed to update marketing insight" }, { status: 500 });
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: "Failed to delete marketing insight" }, { status: 500 });
  }
}
