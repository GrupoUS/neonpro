    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().getOptimizationRecommendations(
              requestData,
            ),
          ];
        case 3:
          ...
          response = {
            ...
            metadata: {
              ...
              highPriorityCount: recommendations.filter(function (r) {
                return r.priority === "high";
              }).length,
              averageImpact:
                recommendations.reduce(function (sum, r) {
                  return sum + r.expectedImpact;
                }, 0) / recommendations.length,
              totalImplementationCost: recommendations.reduce(function (sum, r) {
                return sum + (r.implementationCost || 0);
              }, 0),
            },
          };
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().generateOptimizationInsights({
              recommendations: recommendations,
              timeframe: "90d",
        ...
        case 5:
          ...
          response = {
            ...
            metadata: {
              ...
              estimatedTimeframe: Math.max.apply(
                Math,
                recommendations.map(function (r) {
                  return r.timeframe || 30;
                }),
              ),
            },
          };
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          (_a = _b.sent()),
            (recommendationId = _a.recommendationId),
            (status_1 = _a.status),
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().updateRecommendationStatus(
              recommendationId,
              status_1,
              feedback,
            ),
