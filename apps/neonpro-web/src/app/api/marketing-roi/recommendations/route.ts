  ...
  try {
    ...
    const response: OptimizationRecommendationsResponse = {
      ...
      metadata: {
        ...
        averageImpact: recommendations.reduce((sum, r) => sum + r.expectedImpact, 0) / recommendations.length,
        totalImplementationCost: recommendations.reduce((sum, r) => sum + (r.implementationCost || 0), 0)
      }
    }
