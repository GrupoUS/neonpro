...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var validation, clinicId, _a, start_date, end_date, analysis, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, marketing_roi_service_1.createmarketingROIService)().getCACLTVAnalysis(clinicId, start_date, end_date)];
                case 2:
                    analysis = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json(analysis)];
                case 3:
                    error_1 = _b.sent();
                    console.error('[Marketing ROI API] GET CAC LTV analysis:', error_1);
