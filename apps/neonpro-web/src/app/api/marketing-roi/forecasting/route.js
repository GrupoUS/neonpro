    ...
    return __generator(this, (_d) => {
      switch (_d.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().generateMarketingForecast(
              requestData,
            ),
          ];
        case 3:
          ...
          response = {
            ...
            metadata: {
              ...
              dataPointsUsed:
                ((_c = forecast.historicalData) === null || _c === void 0 ? void 0 : _c.length) ||
                0,
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().generateForecastInsights({
              forecast: forecast,
        ...
        case 5:
          ...
          response = {
            ...
            metadata: {
              ...
              generatedAt: new Date().toISOString(),
              dataPointsUsed:
                ((_a = forecast.historicalData) === null || _a === void 0 ? void 0 : _a.length) ||
                0,
              confidenceLevel: forecast.confidenceLevel || 0.95,
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 3:
          (_a = _b.sent()),
            (forecastId = _a.forecastId),
            (actualResults = _a.actualResults),
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().updateForecastAccuracy(
              forecastId,
              actualResults,
              feedback,
            ),
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().recalibrateForecastModel(
              forecastId,
              actualResults,
            ),
          ];
