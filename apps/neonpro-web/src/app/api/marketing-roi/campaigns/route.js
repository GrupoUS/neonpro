    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          (_b = getDateRangeParams(request)),
            (start_date = _b.start_date),
            (end_date = _b.end_date);
          filters = {
            ...
            max_budget: request.nextUrl.searchParams.get("max_budget")
              ? parseFloat(request.nextUrl.searchParams.get("max_budget"))
              : undefined,
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().getMarketingCampaigns(
              clinicId,
              validatedFilters,
              limit,
              offset,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            (0, marketing_roi_service_1.createmarketingROIService)().createMarketingCampaign(
              clinicId,
              validatedData,
              user.id,
            ),
