      ...
      switch (_e.label) {
        ...
        case 1:
          ...
          if (!planId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Plan ID is required" }, { status: 400 }),
            ];
          }
          return [
            4 /*yield*/,
        ...
        case 2:
          ...
          if (error || !plan) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Plan not found" }, { status: 404 }),
            ];
          }
          return [
            4 /*yield*/,
            supabase.from("subscriptions").select("status").eq("plan_id", planId),
          ];
        case 3:
          subscriptionStats = _e.sent().data;
          stats = {
            total_subscriptions:
              (subscriptionStats === null || subscriptionStats === void 0
                ? void 0
                : subscriptionStats.length) || 0,
            active_subscriptions:
              (subscriptionStats === null || subscriptionStats === void 0
                ? void 0
                : subscriptionStats.filter(function (s) {
        ...
        case 4:
          ...
          logger_1.logger.error(
            "Error in GET /api/subscription-plans/".concat(params.id, ":"),
            error_1,
          );
          return [
            2 /*return*/,
    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 6:
          return [
            4 /*yield*/,
            subscription_manager_1.subscriptionManager.updatePlan(planId, validationResult.data),
          ];
        case 7:
          updatedPlan = _e.sent();
        ...
        case 8:
          error_2 = _e.sent();
          logger_1.logger.error(
            "Error in PUT /api/subscription-plans/".concat(params.id, ":"),
            error_2,
          );
    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            subscription_manager_1.subscriptionManager.updatePlan(planId, { active: false }),
          ];
        case 5:
        ...
        case 6:
          error_3 = _e.sent();
          logger_1.logger.error(
            "Error in DELETE /api/subscription-plans/".concat(params.id, ":"),
            error_3,
          );
