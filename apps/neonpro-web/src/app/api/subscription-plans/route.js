    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            supabase.from("subscription_plans").select("id").eq("name", planData.name).single(),
          ];
        case 5:
        ...
        case 6:
          ...
          logger_1.logger.info(
            "Subscription plan created: ".concat(plan.id, " by user: ").concat(user.id),
          );
          return [
            2 /*return*/,
            server_1.NextResponse.json(
