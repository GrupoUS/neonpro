...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var searchParams, clinicId, validation, _c, patientId, validatedClinicId, supabase, _d, user, authError, _e, userProfile, profileError, _f, patient, patientError, retentionService, metrics, error_1;
            ...
            switch (_g.label) {
                ...
                case 4:
                    ...
                    if (patientError || !patient) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Patient not found or does not belong to clinic' }, { status: 404 })];
                    }
                    retentionService = new retention_analytics_service_1.RetentionAnalyticsService();
                    return [4 /*yield*/, retentionService.getPatientRetentionMetrics(patientId, validatedClinicId)];
                case 5:
                    metrics = _g.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
...
function POST(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var body, validation, _c, patientId, clinicId, supabase, _d, user, authError, _e, userProfile, profileError, _f, patient, patientError, allowedRoles, retentionService, metrics, error_2;
        var params = _b.params;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                ...
                case 5:
                    ...
                    if (!allowedRoles.includes(userProfile.role)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Insufficient permissions to calculate metrics' }, { status: 403 })];
                    }
                    retentionService = new retention_analytics_service_1.RetentionAnalyticsService();
                    return [4 /*yield*/, retentionService.calculatePatientRetentionMetrics(patientId, clinicId)];
                case 6:
                    metrics = _g.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
