...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var clinicValidation, clinicId, searchParams, queryValidation, _c, limit, offset, startDate_1, endDate_1, riskLevel_1, supabase, _d, user, authError, _e, userProfile, profileError, _f, clinic, clinicError, retentionService, metrics, filteredMetrics, summary, error_1;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    _c = queryValidation.data, limit = _c.limit, offset = _c.offset, startDate_1 = _c.startDate, endDate_1 = _c.endDate, riskLevel_1 = _c.riskLevel;
                ...
                case 5:
                    ...
                    summary = {
                        ...
                        average_churn_risk: filteredMetrics.reduce(function (sum, m) { return sum + m.churn_risk_score; }, 0) / filteredMetrics.length || 0,
                        risk_distribution: {
                            low: filteredMetrics.filter(function (m) { return m.churn_risk_level === 'low'; }).length,
                            medium: filteredMetrics.filter(function (m) { return m.churn_risk_level === 'medium'; }).length,
                            high: filteredMetrics.filter(function (m) { return m.churn_risk_level === 'high'; }).length,
                            critical: filteredMetrics.filter(function (m) { return m.churn_risk_level === 'critical'; }).length,
                        },
                        total_lifetime_value: filteredMetrics.reduce(function (sum, m) { return sum + m.lifetime_value; }, 0),
                        patients_at_risk: filteredMetrics.filter(function (m) { return ['high', 'critical'].includes(m.churn_risk_level); }).length,
                    };
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: {
...
function POST(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var clinicValidation, clinicId_1, body, patientIds, _c, forceRecalculate, supabase, _d, user, authError, _e, userProfile, profileError, allowedRoles, targetPatientIds, _f, patients, patientsError, _g, validPatients, validationError, retentionService_1, results_1, errors_1, batchSize, i, batch, batchPromises, batchResults, summary, error_2;
        var _this = this;
        var params = _b.params;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 1:
                    body = _h.sent();
                    patientIds = body.patientIds, _c = body.forceRecalculate, forceRecalculate = _c === void 0 ? false : _c;
                    return [4 /*yield*/, (0, server_2.createClient)()];
                case 2:
                    supabase = _h.sent();
                    return [4 /*yield*/, supabase.auth.getUser()];
                ...
                case 4:
                    ...
                    if (!allowedRoles.includes(userProfile.role)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Insufficient permissions for bulk calculations' }, { status: 403 })];
                    }
                ...
                case 5:
                    ...
                    targetPatientIds = patients.map(function (p) { return p.id; });
                    _h.label = 6;
                ...
                case 7:
                    ...
                    if (validationError || validPatients.length !== targetPatientIds.length) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Some patients do not belong to the specified clinic' }, { status: 400 })];
                    }
                    ...
                    batchPromises = batch.map(function (patientId) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, retentionService_1.calculatePatientRetentionMetrics(patientId, clinicId_1)];
                                case 1:
                                    metrics = _a.sent();
                                    return [2 /*return*/, { patientId: patientId, metrics: metrics, success: true }];
                                case 2:
                                    error_3 = _a.sent();
                                    console.error("Failed to calculate metrics for patient ".concat(patientId, ":"), error_3);
                                    return [2 /*return*/, {
                                            patientId: patientId,
                ...
                case 11:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: {
                                results: results_1.map(function (r) { return r.metrics; }),
                                summary: summary,
                                errors: errors_1.length > 0 ? errors_1 : undefined
                            },
                            message: "Processed ".concat(results_1.length, " patients successfully, ").concat(errors_1.length, " failed"),
                            timestamp: new Date().toISOString()
                        })];
                case 12:
                    error_2 = _h.sent();
