    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 1:
          ...
          (_a = validation.data),
            (strategyId_1 = _a.strategyId),
            (clinicId = _a.clinicId),
            (patientIds = _a.patientIds),
            (executeImmediately = _a.executeImmediately),
            (scheduledAt = _a.scheduledAt),
            (dryRun = _a.dryRun),
            (notes = _a.notes);
        ...
        case 7:
          ...
          return [
            4 /*yield*/,
            supabase.from("retention_strategy_executions").insert({
          ...
          return [
            ...
            server_1.NextResponse.json({
              ...
              message: "Strategy executed "
                .concat(executionResult.success ? "successfully" : "with errors", " for ")
                .concat(validPatients_1.length, " patients"),
              timestamp: new Date().toISOString(),
            }),
          ];
        case 9:
