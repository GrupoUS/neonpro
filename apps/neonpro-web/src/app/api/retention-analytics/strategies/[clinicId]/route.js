...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var clinicValidation, clinicId, searchParams, queryValidation, _c, activeOnly, strategyType_1, status_1, limit, offset, sortBy_1, sortOrder_1, supabase, _d, user, authError, _e, userProfile, profileError, retentionService, strategies, filteredStrategies_1, paginatedStrategies, summary, error_1;
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    _c = queryValidation.data, activeOnly = _c.activeOnly, strategyType_1 = _c.strategyType, status_1 = _c.status, limit = _c.limit, offset = _c.offset, sortBy_1 = _c.sortBy, sortOrder_1 = _c.sortOrder;
                ...
                case 4:
                    ...
                    if (strategyType_1) {
                        filteredStrategies_1 = filteredStrategies_1.filter(function (s) { return s.strategy_type === strategyType_1; });
                    }
                    if (status_1) {
                        filteredStrategies_1 = filteredStrategies_1.filter(function (s) { return s.status === status_1; });
                    }
                    // Apply sorting
                    filteredStrategies_1.sort(function (a, b) {
                        var valueA, valueB;
                        switch (sortBy_1) {
                            case 'created_at':
                    ...
                    summary = {
                        ...
                        active_strategies: filteredStrategies_1.filter(function (s) { return s.is_active; }).length,
                        strategy_types: Object.values(retention_analytics_1.RetentionStrategyType).map(function (type) { return ({
                            type: type,
                            count: filteredStrategies_1.filter(function (s) { return s.strategy_type === type; }).length
                        }); }),
                        average_success_rate: filteredStrategies_1.reduce(function (sum, s) { return sum + (s.success_rate || 0); }, 0) / filteredStrategies_1.length || 0,
                        total_executions: filteredStrategies_1.reduce(function (sum, s) { return sum + s.execution_count; }, 0),
                        successful_executions: filteredStrategies_1.reduce(function (sum, s) { return sum + s.successful_executions; }, 0),
                    };
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: {
...
function POST(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var clinicValidation, clinicId, body, validation, strategyData, supabase, _c, user, authError, _d, userProfile, profileError, allowedRoles, retentionService, createData, strategy, error_2;
        var params = _b.params;
            ...
            switch (_e.label) {
                ...
                case 4:
                    ...
                    if (!allowedRoles.includes(userProfile.role)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Insufficient permissions to create strategies' }, { status: 403 })];
                    }
                    retentionService = new retention_analytics_service_1.RetentionAnalyticsService();
                    createData = __assign(__assign({}, strategyData), { clinic_id: clinicId, created_by: user.id });
