...
var PredictionsQuerySchema = zod_1.z.object({
    ...
    sortBy: zod_1.z.enum(['prediction_date', 'churn_probability', 'risk_level']).default('prediction_date'),
...
var GeneratePredictionSchema = zod_1.z.object({
    ...
    modelType: zod_1.z.nativeEnum(retention_analytics_1.ChurnModelType).default(retention_analytics_1.ChurnModelType.ENSEMBLE),
    forceRegenerate: zod_1.z.boolean().default(false),
}).refine(function (data) { return data.patientId || (data.patientIds && data.patientIds.length > 0); }, {
...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var clinicValidation, clinicId, searchParams, queryValidation, _c, riskLevel, limit, offset, startDate_1, endDate_1, sortBy_1, sortOrder_1, supabase, _d, user, authError, _e, userProfile, profileError, retentionService, predictions, filteredPredictions, paginatedPredictions, summary, error_1;
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    _c = queryValidation.data, riskLevel = _c.riskLevel, limit = _c.limit, offset = _c.offset, startDate_1 = _c.startDate, endDate_1 = _c.endDate, sortBy_1 = _c.sortBy, sortOrder_1 = _c.sortOrder;
                ...
                case 3:
                    ...
                    return [4 /*yield*/, retentionService.getChurnPredictions(clinicId, riskLevel, limit, offset)];
                case 4:
                    predictions = _f.sent();
                    ...
                    if (startDate_1 || endDate_1) {
                        filteredPredictions = predictions.filter(function (prediction) {
                            ...
                            if (startDate_1 && predictionDate < new Date(startDate_1))
                                return false;
                            if (endDate_1 && predictionDate > new Date(endDate_1))
                                return false;
                            return true;
                        });
                    }
                    ...
                    summary = {
                        ...
                        risk_distribution: {
                            low: filteredPredictions.filter(function (p) { return p.risk_level === retention_analytics_1.ChurnRiskLevel.LOW; }).length,
                            medium: filteredPredictions.filter(function (p) { return p.risk_level === retention_analytics_1.ChurnRiskLevel.MEDIUM; }).length,
                            high: filteredPredictions.filter(function (p) { return p.risk_level === retention_analytics_1.ChurnRiskLevel.HIGH; }).length,
                            critical: filteredPredictions.filter(function (p) { return p.risk_level === retention_analytics_1.ChurnRiskLevel.CRITICAL; }).length,
                        },
                        ...
                        high_risk_patients: filteredPredictions.filter(function (p) { return ['high', 'critical'].includes(p.risk_level); }).length,
...
function POST(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var clinicValidation, clinicId_1, body, validation, _c, patientId, patientIds, modelType_1, forceRegenerate, supabase, _d, user, authError, _e, userProfile, profileError, allowedRoles, targetPatientIds, _f, validPatients_1, validationError, invalidIds, retentionService_1, results_1, errors_1, batchSize, i, batch, batchPromises, batchResults, summary, error_2;
        var _this = this;
        var params = _b.params;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    ...
                    _c = validation.data, patientId = _c.patientId, patientIds = _c.patientIds, modelType_1 = _c.modelType, forceRegenerate = _c.forceRegenerate;
                    return [4 /*yield*/, (0, server_2.createClient)()];
                case 2:
                    supabase = _g.sent();
                    return [4 /*yield*/, supabase.auth.getUser()];
                ...
                case 4:
                    ...
                    if (!allowedRoles.includes(userProfile.role)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Insufficient permissions to generate predictions' }, { status: 403 })];
                    }
                ...
                case 6:
                    ...
                    batchPromises = batch.map(function (patientId) { return __awaiter(_this, void 0, void 0, function () {
                        var prediction, error_3;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, retentionService_1.generateChurnPrediction(patientId, clinicId_1, modelType_1)];
                                case 1:
                                    prediction = _a.sent();
                                    return [2 /*return*/, { patientId: patientId, prediction: prediction, success: true }];
                                case 2:
                                    error_3 = _a.sent();
                                    console.error("Failed to generate prediction for patient ".concat(patientId, ":"), error_3);
                                    return [2 /*return*/, {
                                            patientId: patientId,
                ...
                case 9:
                    summary = {
                        ...
                        high_risk_detected: results_1.filter(function (r) { return ['high', 'critical'].includes(r.prediction.risk_level); }).length,
                    };
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                            data: {
                                predictions: results_1.map(function (r) { return r.prediction; }),
                                summary: summary,
                                errors: errors_1.length > 0 ? errors_1 : undefined
                            },
                            message: "Generated ".concat(results_1.length, " predictions successfully, ").concat(errors_1.length, " failed"),
                            timestamp: new Date().toISOString()
                        })];
                case 10:
                    error_2 = _g.sent();
