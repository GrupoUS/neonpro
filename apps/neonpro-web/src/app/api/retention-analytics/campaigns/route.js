...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, clinicId, status_1, segment, supabase, query, _a, campaigns, error, enrichedCampaigns, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    enrichedCampaigns = campaigns.map(function (campaign) {
                        var _a, _b;
                        var metrics = campaign.campaign_metrics[0] || {};
                        var executions = ((_a = campaign.executions[0]) === null || _a === void 0 ? void 0 : _a.count) || 0;
                        return __assign(__assign({}, campaign), { performance: {
                            ...
                            }, lastExecuted: ((_b = campaign.executions[0]) === null || _b === void 0 ? void 0 : _b.executed_at) || null });
                    });
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validation, data, supabase, _a, clinic, clinicError, _b, campaign, campaignError, metricsError, error_2;
...
function PATCH(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validation, _a, campaignId, metrics, timestamp, supabase, _b, updatedMetrics, error, error_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 4, , 5]);
                ...
                case 1:
                    ...
                    _a = validation.data, campaignId = _a.campaignId, metrics = _a.metrics, timestamp = _a.timestamp;
                    return [4 /*yield*/, (0, server_2.createClient)()];
                case 2:
                    supabase = _c.sent();
                    return [4 /*yield*/, supabase
                            .from('retention_campaign_metrics')
                            .update(__assign(__assign({}, metrics), { updated_at: timestamp || new Date().toISOString() }))
