      ...
      switch (_h.label) {
        ...
        case 1:
          ...
          (_c = validation.data),
            ...
            (dryRun = _c.dryRun),
            (scheduledAt = _c.scheduledAt),
            (overrideConditions = _c.overrideConditions);
          return [4 /*yield*/, (0, server_2.createClient)()];
        case 2:
          supabase = _h.sent();
          return [
            4 /*yield*/,
            supabase.from("retention_campaigns").select("*").eq("id", campaignId).single(),
          ];
        case 3:
          ...
          if (!campaign.is_active && !overrideConditions) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Campaign is not active" }, { status: 400 }),
            ];
          }
        ...
        case 6:
          ...
          targetPatients = patients.map(function (p) {
            return p.patients;
          });
          _h.label = 7;
        case 7:
            ...
            supabase
              ...
              .insert({
                ...
                execution_summary: {
                  ...
                  patientsTargeted: targetPatients.map(function (p) {
                    return {
                      id: p.id,
                      name: p.name,
                      email: p.email,
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 2:
          ...
          return [4 /*yield*/, supabase.from("retention_campaigns").delete().eq("id", campaignId)];
        case 3:
          error = _d.sent().error;
          if (error) {
