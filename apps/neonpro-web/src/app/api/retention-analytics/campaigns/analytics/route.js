      ...
      switch (_e.label) {
        case 0:
          ...
          queryData = {
            ...
            campaignIds:
              (_c = searchParams.get("campaign_ids")) === null || _c === void 0
                ? void 0
                : _c.split(","),
            dateRange:
              searchParams.get("start_date") && searchParams.get("end_date")
                ...
                : undefined,
            metrics:
              (_d = searchParams.get("metrics")) === null || _d === void 0 ? void 0 : _d.split(","),
          ...
          (_a = validation.data),
            ...
            (campaignIds = _a.campaignIds),
            (dateRange = _a.dateRange),
            (metrics = _a.metrics),
            (groupBy_1 = _a.groupBy),
            (includeComparison = _a.includeComparison);
        ...
        case 2:
          ...
          campaignAnalytics = campaigns.map((campaign) => {
            ...
            var performance = {
              ...
              engagementScore:
                ((metrics.opened + metrics.clicked * 2 + metrics.conversions * 3) /
                  (metrics.sent || 1)) *
                100,
            };
            return {
              ...
              interventionType:
                (_a = campaign.intervention_strategy) === null || _a === void 0 ? void 0 : _a.type,
          ...
          if (groupBy_1) {
            ...
            campaignAnalytics.forEach((analytics) => {
              ...
              switch (groupBy_1) {
                ...
                case "segment":
                  key =
                    ((_a = analytics.targetSegments) === null || _a === void 0 ? void 0 : _a[0]) ||
                    "no_segment";
                  break;
                case "campaign":
          ...
          if (includeComparison) {
            ...
            comparisonData = {
              ...
              performanceVsBenchmark: {
                deliveryRate:
                  clinicAverages.deliveryRate -
                  industryBenchmarks.healthcareEmailMarketing.deliveryRate,
                openRate:
                  clinicAverages.openRate - industryBenchmarks.healthcareEmailMarketing.openRate,
                clickRate:
      ...
      switch (_c.label) {
        ...
        case 1:
          ...
          (_a = validation.data),
            ...
            (testDurationDays = _a.testDurationDays),
          ...
          return [
            ...
            server_1.NextResponse.json({
              ...
              data: {
                ...
                results: {
                  groupA: __assign(__assign({}, groupAPerformance), {
                    roi:
                  ...
                  groupB: __assign(__assign({}, groupBPerformance), {
                    roi:
                  ...
                  conclusion: {
                    ...
                    recommendation: isStatisticallySignificant
                      ? "Group "
                          .concat(winner, " is statistically significantly better with ")
                          .concat(improvement.toFixed(1), "% improvement")
