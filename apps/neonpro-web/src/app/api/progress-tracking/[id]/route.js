        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    id = params.id;
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.getProgressTrackingById(id)];
                case 2:
                    tracking = _d.sent();
                    if (!tracking) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Progress tracking not found' }, { status: 404 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json(tracking)];
                case 3:
                    error_1 = _d.sent();
                    console.error('Error fetching progress tracking:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch progress tracking' }, { status: 500 })];
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.updateProgressTracking(id, validatedData)];
                case 3:
                    tracking = _d.sent();
                    return [2 /*return*/, server_1.NextResponse.json(tracking)];
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update progress tracking' }, { status: 500 })];
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.deleteProgressTracking(id)];
                case 2:
                    // Delete progress tracking
                    _d.sent();
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to delete progress tracking' }, { status: 500 })];
                case 4: return [2 /*return*/];
            }
        });
    });
