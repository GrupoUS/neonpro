    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            progress_tracking_1.progressTrackingService.createProgressTracking(validatedData),
          ];
        case 4:
          tracking = _b.sent();
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            progress_tracking_1.progressTrackingService.getProgressTrackings(validatedFilters),
          ];
        case 3:
          result = _b.sent();
