        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    hasReportAccess = profile.role === 'admin' ||
                        profile.role === 'security_admin' ||
                        profile.role === 'compliance_officer' ||
                        ((_a = profile.permissions) === null || _a === void 0 ? void 0 : _a.includes('audit.reports'));
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var clientIP, rateLimitResult, supabase, _a, user, authError, hasAccess, searchParams, rawFilters, validationResult, filters, query, _b, reports, queryError, countQuery, count, error_3;
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, audit_system_1.logAuditEvent)({
                            ...
                            metadata: {
                                ...
                                results_count: (reports === null || reports === void 0 ? void 0 : reports.length) || 0
                            }
                        })];
                case 9:
                    // Log da consulta
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var clientIP, rateLimitResult, supabase, _a, user, authError, csrfValid, hasAccess, body, validationResult, reportData, startDate, endDate, maxPeriod, report, reportLogs, generateError_1, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 6: return [4 /*yield*/, validateReportAccess(supabase, user.id)];
                case 7:
                    hasAccess = _b.sent();
                    if (!hasAccess) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Insufficient permissions' }, { status: 403 })];
                ...
                case 8:
                    ...
                    if (endDate.getTime() - startDate.getTime() > maxPeriod) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Report period cannot exceed 1 year' }, { status: 400 })];
                    }
                    return [4 /*yield*/, createReportRecord(supabase, reportData, user.id)
                ...
                case 10:
                    ...
                    return [4 /*yield*/, generateReportData(supabase, reportData.filters)
