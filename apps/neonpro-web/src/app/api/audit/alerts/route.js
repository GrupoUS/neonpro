...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, success, rateLimit_1, remaining, reset, url, searchParams, validatedParams, supabase, query, _b, alerts, error, count, totalCount, error_1;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 7, , 9]);
                    return [4 /*yield*/, limiter.check((_c = request.ip) !== null && _c !== void 0 ? _c : 'anonymous')];
                case 1:
                    _a = _d.sent(), success = _a.success, rateLimit_1 = _a.limit, remaining = _a.remaining, reset = _a.reset;
                    if (!success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Rate limit exceeded', limit: rateLimit_1, remaining: remaining, reset: reset }, { status: 429 })];
                    }
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, audit_system_1.logAuditEvent)({
                ...
                case 3:
                    // Log audit event for error
                    _d.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch security alerts' }, { status: 500 })];
                ...
                case 7:
                    ...
                    return [4 /*yield*/, (0, audit_system_1.logAuditEvent)({
                            type: audit_system_1.AuditEventType.SECURITY_ALERT_ACCESS,
                            severity: audit_system_1.AuditSeverity.HIGH,
                            description: "Unexpected error in security alerts API: ".concat(error_1 instanceof Error ? error_1.message : 'Unknown error'),
                            metadata: {
...
function PATCH(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, success, rateLimit_2, remaining, reset, body, validatedData, supabase, updateData, _b, updatedAlert, error, error_2;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, limiter.check((_c = request.ip) !== null && _c !== void 0 ? _c : 'anonymous')];
                case 1:
                    _a = _d.sent(), success = _a.success, rateLimit_2 = _a.limit, remaining = _a.remaining, reset = _a.reset;
                    if (!success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Rate limit exceeded', limit: rateLimit_2, remaining: remaining, reset: reset }, { status: 429 })];
                    }
                ...
                case 4:
                    // Log audit event for error
                    _d.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update security alert' }, { status: 500 })];
                case 5: 
                ...
                return [4 /*yield*/, (0, audit_system_1.logAuditEvent)({
                        ...
                        metadata: {
                            alert_id: validatedData.alert_id,
                            old_status: updatedAlert === null || updatedAlert === void 0 ? void 0 : updatedAlert.status,
                ...
                case 7:
                    ...
                    return [4 /*yield*/, (0, audit_system_1.logAuditEvent)({
                            type: audit_system_1.AuditEventType.SECURITY_ALERT_UPDATE,
                            severity: audit_system_1.AuditSeverity.HIGH,
                            description: "Unexpected error in security alert update API: ".concat(error_2 instanceof Error ? error_2.message : 'Unknown error'),
                            metadata: {
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, success, rateLimit_3, remaining, reset, body, requiredFields, _i, requiredFields_1, field, supabase, alertData, _b, newAlert, error, error_3;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, limiter.check((_c = request.ip) !== null && _c !== void 0 ? _c : 'anonymous', 10 // Limite de 10 por minuto para criacao
                        )];
                case 1:
                    _a = _d.sent(), success = _a.success, rateLimit_3 = _a.limit, remaining = _a.remaining, reset = _a.reset;
                    if (!success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Rate limit exceeded', limit: rateLimit_3, remaining: remaining, reset: reset }, { status: 429 })];
                    }
                    return [4 /*yield*/, request.json()
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create security alert' }, { status: 500 })];
                    }
