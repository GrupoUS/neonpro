        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    hasAuditPermission = profile.role === 'admin' ||
                        profile.role === 'security_admin' ||
                        ((_a = profile.permissions) === null || _a === void 0 ? void 0 : _a.includes('audit.read'));
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var clientIP, rateLimitResult, supabase, _a, user, authError, hasAccess, searchParams, rawFilters, validationResult, filters, events, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 5: return [4 /*yield*/, validateAuditAccess(supabase, user.id)];
                case 6:
                    hasAccess = _b.sent();
                ...
                case 8:
                    ...
                    return [4 /*yield*/, createauditSystem().queryEvents(__assign(__assign({}, filters), { start_date: filters.start_date ? new Date(filters.start_date) : undefined, end_date: filters.end_date ? new Date(filters.end_date) : undefined }))
                        // Log da consulta
                    ];
                case 9:
                    events = _b.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var clientIP, rateLimitResult, supabase, _a, user, authError, csrfValid, hasAccess, body, validationResult, eventData, event_1, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 6: return [4 /*yield*/, validateAuditAccess(supabase, user.id)];
                case 7:
                    hasAccess = _b.sent();
                    if (!hasAccess) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Insufficient permissions' }, { status: 403 })];
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, audit_system_1.logAuditEvent)(__assign(__assign({}, eventData), { user_id: user.id, ip_address: clientIP, user_agent: eventData.user_agent || request.headers.get('user-agent') || undefined }))];
                case 9:
                    event_1 = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
