        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    hasStatsAccess = profile.role === 'admin' ||
                        profile.role === 'security_admin' ||
                        profile.role === 'compliance_officer' ||
                        ((_a = profile.permissions) === null || _a === void 0 ? void 0 : _a.includes('audit.statistics'));
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    uniqueUserIds = new Set((uniqueUsers === null || uniqueUsers === void 0 ? void 0 : uniqueUsers.map(function (u) { return u.user_id; })) || []);
                    return [2 /*return*/, {
                            total_alerts: (alerts === null || alerts === void 0 ? void 0 : alerts.length) || 0,
                            open_alerts: (alerts === null || alerts === void 0 ? void 0 : alerts.filter(function (a) { return a.status === 'open'; }).length) || 0,
                            resolved_alerts: (alerts === null || alerts === void 0 ? void 0 : alerts.filter(function (a) { return a.status === 'resolved'; }).length) || 0,
                            unique_users: uniqueUserIds.size,
                            alerts_by_severity: (alerts === null || alerts === void 0 ? void 0 : alerts.reduce(function (acc, alert) {
            ...
            switch (_c.label) {
                case 0:
                    ...
                    switch (filters.metric) {
                        case 'events':
                            query = "\n        SELECT \n          to_char(date_trunc('".concat(filters.granularity, "', created_at), '").concat(dateFormat, "') as period,\n          count(*) as value\n        FROM audit_logs \n        WHERE created_at >= '").concat(startDate.toISOString(), "' \n          AND created_at <= '").concat(endDate.toISOString(), "'\n        GROUP BY date_trunc('").concat(filters.granularity, "', created_at)\n        ORDER BY period\n      ");
                            break;
                        case 'users':
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var clientIP, rateLimitResult, supabase, _a, user, authError, hasAccess, _b, pathname, searchParams, rawFilters, validationResult, filters, trendData, start30d, start7d, _c, events30d, security30d, _d, events7d, security7d, rawFilters, validationResult, filters, _e, eventStats, securityStats, trendData, error_2;
        var _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, rate_limiting_1.rateLimit)({
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, security_events_1.logSecurityEvent)({
                ...
                case 11:
                    rawFilters = {
                        period: searchParams.get('period') || '30d',
                        granularity: searchParams.get('granularity') || 'day',
                        event_types: (_f = searchParams.get('event_types')) === null || _f === void 0 ? void 0 : _f.split(','),
                        severity_levels: (_g = searchParams.get('severity_levels')) === null || _g === void 0 ? void 0 : _g.split(','),
                ...
                case 12:
                    ...
                    return [4 /*yield*/, getTrendData(supabase, {
                            period: filters.period,
                            granularity: filters.granularity,
                            metric: 'events'
                        })];
