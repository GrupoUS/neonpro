...
var GET = function (request) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, Sentry.withServerSideSentry(function () { return __awaiter(void 0, void 0, void 0, function () {
                var data;
                var _a;
                return __generator(this, function (_b) {
                    try {
                        ...
                        data = {
                            status: 'ok',
                            timestamp: new Date().toISOString(),
                            sentryTraceId: (_a = Sentry.getCurrentScope().getTransaction()) === null || _a === void 0 ? void 0 : _a.traceId,
                        };
