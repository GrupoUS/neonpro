...
var querySchema = zod_1.z.object({
    ...
    customerId: zod_1.z.string().uuid().optional(),
    dueDateFrom: zod_1.z.string().refine(function (date) { return !isNaN(Date.parse(date)); }, {
        message: 'Invalid date format'
    }).optional(),
    dueDateTo: zod_1.z.string().refine(function (date) { return !isNaN(Date.parse(date)); }, {
        message: 'Invalid date format'
    }).optional(),
    sortBy: zod_1.z.enum(['due_date', 'amount', 'status', 'created_at']).optional().default('due_date'),
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, url, queryParams, validatedQuery, page, limit, status_1, paymentPlanId, customerId, dueDateFrom, dueDateTo, sortBy, sortOrder, installmentManager, filters, result, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    page = validatedQuery.page, limit = validatedQuery.limit, status_1 = validatedQuery.status, paymentPlanId = validatedQuery.paymentPlanId, customerId = validatedQuery.customerId, dueDateFrom = validatedQuery.dueDateFrom, dueDateTo = validatedQuery.dueDateTo, sortBy = validatedQuery.sortBy, sortOrder = validatedQuery.sortOrder;
                    ...
                    return [4 /*yield*/, installmentManager.getInstallmentsList({
                            page: page,
                            limit: limit,
                            filters: filters,
                            sortBy: sortBy,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, action, installmentProcessor, result, _b, singleData, bulkData, overdueOptions, retryData, error_2;
        var _c, _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    ...
                    _b = action;
                    switch (_b) {
                        case 'process_single': return [3 /*break*/, 4];
                        case 'process_bulk': return [3 /*break*/, 6];
                        case 'process_overdue': return [3 /*break*/, 8];
                        case 'retry_failed': return [3 /*break*/, 10];
                    }
                    return [3 /*break*/, 12];
                case 4:
                    singleData = processInstallmentSchema.parse(body.data);
                    return [4 /*yield*/, installmentProcessor.processInstallmentPayment(singleData.installmentId, singleData.paymentMethodId, singleData.customerId)];
                case 5:
                    result = _f.sent();
                    return [3 /*break*/, 13];
                case 6:
                    bulkData = bulkProcessSchema.parse(body.data);
                    return [4 /*yield*/, installmentProcessor.processBulkInstallments(bulkData.installmentIds, {
                ...
                case 8:
                    overdueOptions = {
                        maxDaysOverdue: ((_c = body.data) === null || _c === void 0 ? void 0 : _c.maxDaysOverdue) || 30,
                        maxInstallments: ((_d = body.data) === null || _d === void 0 ? void 0 : _d.maxInstallments) || 100,
                ...
                case 9:
                    ...
                    return [3 /*break*/, 13];
                case 10:
                    retryData = zod_1.z.object({
                        installmentId: zod_1.z.string().uuid(),
                        paymentMethodId: zod_1.z.string().optional()
                    }).parse(body.data);
                    return [4 /*yield*/, installmentProcessor.retryFailedPayment(retryData.installmentId, retryData.paymentMethodId)];
                case 11:
                    result = _f.sent();
                    return [3 /*break*/, 13];
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, action, installmentIds, updateData, installmentManager_1, results, _b, paymentData_1, cancelReason_1, successful, failed, error_3;
        var _this = this;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (!action || !installmentIds || !Array.isArray(installmentIds)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid request: action and installmentIds are required' }, { status: 400 })];
                    }
                    installmentManager_1 = (0, installment_manager_1.getInstallmentManager)();
                    results = void 0;
                    _b = action;
                    switch (_b) {
                        case 'mark_paid': return [3 /*break*/, 4];
                        case 'mark_overdue': return [3 /*break*/, 6];
                        case 'cancel': return [3 /*break*/, 8];
                    }
                    return [3 /*break*/, 10];
                case 4:
                    paymentData_1 = zod_1.z.object({
                        paymentIntentId: zod_1.z.string(),
                        paymentMethod: zod_1.z.string().optional().default('manual')
                    }).parse(updateData);
                    return [4 /*yield*/, Promise.all(installmentIds.map(function (id) { return __awaiter(_this, void 0, void 0, function () {
                            var error_4;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, installmentManager_1.markInstallmentAsPaid(id, paymentData_1.paymentIntentId, paymentData_1.paymentMethod)];
                                    case 1:
                                        _a.sent();
                ...
                case 5:
                    results = _c.sent();
                    return [3 /*break*/, 11];
                case 6: return [4 /*yield*/, Promise.all(installmentIds.map(function (id) { return __awaiter(_this, void 0, void 0, function () {
                        var error_5;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                ...
                case 7:
                    ...
                    return [3 /*break*/, 11];
                case 8:
                    cancelReason_1 = (updateData === null || updateData === void 0 ? void 0 : updateData.reason) || 'Cancelled by user';
                    return [4 /*yield*/, Promise.all(installmentIds.map(function (id) { return __awaiter(_this, void 0, void 0, function () {
                            var error_6;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, installmentManager_1.cancelInstallment(id, cancelReason_1)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/, { id: id, success: true }];
                                    case 2:
                ...
                case 11:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            message: "Bulk ".concat(action, " completed: ").concat(successful, " successful, ").concat(failed, " failed")
                        })];
                case 12:
                    error_3 = _c.sent();
