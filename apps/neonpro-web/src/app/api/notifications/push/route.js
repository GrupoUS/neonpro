            ...
            switch (_d.label) {
                ...
                case 3:
                    ...
                    if (!subscription || !subscription.endpoint) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid subscription data' }, { status: 400 })];
                    }
                    // Validate subscription format
                    if (!((_b = subscription.keys) === null || _b === void 0 ? void 0 : _b.p256dh) || !((_c = subscription.keys) === null || _c === void 0 ? void 0 : _c.auth)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing subscription keys' }, { status: 400 })];
                    }
                    return [4 /*yield*/, push_notification_service_1.default.saveSubscription(user.id, subscription)];
                case 4:
                    result = _d.sent();
                    if (!result.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: result.error || 'Failed to save subscription' }, { status: 500 })];
                    }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!endpoint) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing endpoint' }, { status: 400 })];
                    }
                    return [4 /*yield*/, push_notification_service_1.default.removeSubscription(user.id, endpoint)];
                case 4:
                    result = _b.sent();
                    if (!result.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: result.error || 'Failed to remove subscription' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({ success: true })];
                case 5:
                    error_2 = _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (!vapidPublicKey) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Push notifications not configured' }, { status: 503 })];
                    }
