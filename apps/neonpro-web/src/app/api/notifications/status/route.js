...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authResult, profile, supabase, searchParams, queryParams, validationResult, query, dbQuery, _a, notifications, error, count, totalCount, error_1;
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Erro ao buscar notificações' }, { status: 500 })];
                    }
                    totalCount = count || (notifications === null || notifications === void 0 ? void 0 : notifications.length) || 0;
