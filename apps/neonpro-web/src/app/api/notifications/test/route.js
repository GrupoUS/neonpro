...
function POST(request) {
  return __awaiter(this, void 0, void 0, function () {
    var supabase, _a, user, authError, result, error_1;
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          ...
          return [4 /*yield*/, push_notification_service_1.default.sendTestNotification(user.id)];
        case 3:
          result = _b.sent();
          if (!result.success) {
            return [
          ...
          return [
            ...
            server_1.NextResponse.json({
              success: true,
              sent: result.sent,
              message: "Test notification sent to ".concat(result.sent, " device(s)"),
            }),
          ];
        case 4:
          error_1 = _b.sent();
          console.error("Error sending test notification:", error_1);
          return [
            2 /*return*/,
