...
var AnalyticsQuerySchema = zod_1.z.object({
    metric: zod_1.z.enum(['overview', 'performance', 'engagement', 'channels', 'trends']).default('overview'),
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    ...
                    canViewAnalytics = ((_c = profile.permissions) === null || _c === void 0 ? void 0 : _c.includes('view_analytics')) ||
                        ['admin', 'manager'].includes(profile.role);
                    if (!canViewAnalytics) {
                        return [2 /*return*/, { error: 'Sem permissão para visualizar analytics', status: 403 }];
                    }
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authResult, profile, searchParams, queryParams, validationResult, query, _a, from, to, analyticsData, createNotificationAnalytics, notificationAnalytics, _b, error_1;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!validationResult.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Parâmetros inválidos', details: validationResult.error.errors }, { status: 400 })];
                    }
                    query = validationResult.data;
                    _a = calculatePeriod(query.period, query.dateFrom, query.dateTo), from = _a.from, to = _a.to;
                    analyticsData = void 0;
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/notifications/analytics/notification-analytics'); })];
                case 2:
                    createNotificationAnalytics = (_c.sent()).createNotificationAnalytics;
                    notificationAnalytics = createNotificationAnalytics();
                    _b = query.metric;
                    switch (_b) {
                        case 'overview': return [3 /*break*/, 3];
                        case 'performance': return [3 /*break*/, 5];
                        case 'engagement': return [3 /*break*/, 7];
                        case 'channels': return [3 /*break*/, 9];
                        case 'trends': return [3 /*break*/, 11];
                    }
                    return [3 /*break*/, 13];
                case 3: return [4 /*yield*/, notificationAnalytics.getOverviewMetrics(profile.clinic_id, from, to)];
                case 4:
                    analyticsData = _c.sent();
                    return [3 /*break*/, 14];
                case 5: return [4 /*yield*/, notificationAnalytics.getPerformanceMetrics(profile.clinic_id, from, to, query.filters)];
                case 6:
                    analyticsData = _c.sent();
                    return [3 /*break*/, 14];
                case 7: return [4 /*yield*/, notificationAnalytics.getEngagementMetrics(profile.clinic_id, from, to, query.filters)];
                case 8:
                    analyticsData = _c.sent();
                    return [3 /*break*/, 14];
                case 9: return [4 /*yield*/, notificationAnalytics.getChannelAnalytics(profile.clinic_id, from, to)];
                case 10:
                    analyticsData = _c.sent();
                    return [3 /*break*/, 14];
                case 11: return [4 /*yield*/, notificationAnalytics.getTrendAnalysis(profile.clinic_id, from, to, query.groupBy || 'type')];
                case 12:
                    analyticsData = _c.sent();
                    return [3 /*break*/, 14];
                case 13: return [2 /*return*/, server_1.NextResponse.json({ error: 'Tipo de métrica não suportado' }, { status: 400 })];
