...
import type { recurringPaymentProcessor } from "@/lib/payments/recurring/recurring-payment-processor";
    ...
    return NextResponse.json({
      data: {
        retry_statistics: {
          ...
          success_rate:
            totalRetries > 0 ? ((successfulRetries / totalRetries) * 100).toFixed(2) + "%" : "0%",
        },
