      ...
      switch (_a.label) {
        ...
        case 2:
          ...
          if (!signature) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Missing webhook signature" }, { status: 400 }),
            ];
          }
          provider = void 0;
          ...
          if (!provider) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Unknown webhook provider" }, { status: 400 }),
            ];
          }
        ...
        case 3:
          ...
          if (!isValidSignature) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Invalid webhook signature" }, { status: 401 }),
            ];
          }
      ...
      try {
        switch (provider) {
          case "postmark":
            ...
            if (!postmarkSecret) return [2 /*return*/, false];
          ...
          case "sendgrid":
            ...
            if (!sendgridPublicKey) return [2 /*return*/, false];
          ...
          case "mailgun":
            ...
            if (!mailgunSecret) return [2 /*return*/, false];
            timestamp = headers.get("x-mailgun-timestamp");
            token = headers.get("x-mailgun-token");
            if (!timestamp || !token) return [2 /*return*/, false];
