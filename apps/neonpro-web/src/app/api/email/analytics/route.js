...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, profile, searchParams, startDate, endDate, templateId, provider, emailService, analytics, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, emailService.getAnalytics({
                ...
                case 5:
                    error_1 = _b.sent();
                    console.error('Get email analytics error:', error_1);
