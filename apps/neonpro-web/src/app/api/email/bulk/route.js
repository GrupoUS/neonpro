...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session_1, authError, profile_1, body, messages_1, batchSize_1, now, oneHourAgo, recentEmailCount, settings, hourlyLimit, dailyLimit, oneDayAgo, dailyEmailCount, emailService, providerConfigs, campaignId_1, result, emailLogs, logError, error_1;
        var _b, _c, _d, _e;
            ...
            switch (_f.label) {
                ...
                case 3:
                    ...
                    if (!['admin', 'manager', 'marketer'].includes(profile_1.role)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Insufficient permissions for bulk email sending' }, { status: 403 })];
                    }
                ...
                case 6:
                    ...
                    hourlyLimit = ((_c = (_b = settings === null || settings === void 0 ? void 0 : settings.delivery_optimization) === null || _b === void 0 ? void 0 : _b.rateLimit) === null || _c === void 0 ? void 0 : _c.emailsPerHour) || 1000;
                    dailyLimit = ((_e = (_d = settings === null || settings === void 0 ? void 0 : settings.delivery_optimization) === null || _d === void 0 ? void 0 : _d.rateLimit) === null || _e === void 0 ? void 0 : _e.emailsPerDay) || 10000;
                ...
                case 8:
                    ...
                    if (!providerConfigs || providerConfigs.length === 0) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'No email providers configured' }, { status: 503 })];
                    }
                    // Initialize providers
                    return [4 /*yield*/, emailService.initializeProviders(providerConfigs.map(function (config) { return ({
                ...
                case 11:
                    ...
                    emailLogs = result.results.map(function (emailResult, index) {
                        ...
                        return ({
                            ...
                            subject: ((_a = messages_1[index]) === null || _a === void 0 ? void 0 : _a.subject) || '',
                            template_id: (_b = messages_1[index]) === null || _b === void 0 ? void 0 : _b.templateId,
                ...
                case 14:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json(__assign(__assign({}, result), { campaignId: campaignId_1, metadata: {
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, profile, url, campaignId, _b, campaigns, error, _c, campaign, campaignError, emailLogs, events, error_2;
            ...
            switch (_d.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, supabase
                            .from('email_events')
                            .select('*')
                            .in('message_id', (emailLogs === null || emailLogs === void 0 ? void 0 : emailLogs.map(function (log) { return log.message_id; })) || [])
                            .eq('clinic_id', profile.clinic_id)];
                case 8:
                    events = (_d.sent()).data;
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            events: events || [],
                            analytics: {
                                sent: (emailLogs === null || emailLogs === void 0 ? void 0 : emailLogs.filter(function (log) { return log.status === 'sent'; }).length) || 0,
                                failed: (emailLogs === null || emailLogs === void 0 ? void 0 : emailLogs.filter(function (log) { return log.status === 'failed'; }).length) || 0,
                                delivered: (events === null || events === void 0 ? void 0 : events.filter(function (event) { return event.event === 'delivered'; }).length) || 0,
                                opened: (events === null || events === void 0 ? void 0 : events.filter(function (event) { return event.event === 'opened'; }).length) || 0,
                                clicked: (events === null || events === void 0 ? void 0 : events.filter(function (event) { return event.event === 'clicked'; }).length) || 0,
                                bounced: (events === null || events === void 0 ? void 0 : events.filter(function (event) { return event.event === 'bounced'; }).length) || 0,
                            },
                        })];
                case 9:
                    error_2 = _d.sent();
