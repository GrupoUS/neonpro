      ...
      switch (_d.label) {
        ...
        case 3:
          ...
          (_b = validation.data),
            ...
            (includeAttachment = _b.includeAttachment);
          return [
            4 /*yield*/,
            supabase
              .from("invoices")
        ...
        case 4:
          ...
          if (invoiceError || !invoice) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Fatura não encontrada" }, { status: 404 }),
            ];
          }
          if (!invoice.profiles) {
            return [
      ...
      switch (_c.label) {
        ...
        case 2:
          ...
          if (!invoiceId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "ID da fatura obrigatório" }, { status: 400 }),
            ];
          }
          return [
            4 /*yield*/,
