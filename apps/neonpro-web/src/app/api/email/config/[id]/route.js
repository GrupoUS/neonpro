        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    config = (_d.sent()).data;
                    if (!config) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Configuration not found' }, { status: 404 })];
                    }
...
function PATCH(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, session, authError, profile, body, partialSchema, validatedConfig, _d, config, error, error_2;
        var params = _b.params;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, supabase
                            .from('email_provider_configs')
                            .update(__assign(__assign({}, validatedConfig), { updated_at: new Date().toISOString() }))
                            .eq('id', params.id)
                            .eq('clinic_id', profile.clinic_id)
                            .select()
                            .single()];
