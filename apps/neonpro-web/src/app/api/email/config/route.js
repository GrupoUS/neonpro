...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, profile, configs, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    configs = (_b.sent()).data;
                    return [2 /*return*/, server_1.NextResponse.json(configs || [])];
                case 5:
                    error_1 = _b.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, profile, body, validatedConfig, _b, config, error, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    body = _c.sent();
                    validatedConfig = email_1.EmailProviderConfigSchema.parse(body);
                    return [4 /*yield*/, supabase
                            .from('email_provider_configs')
                            .insert({
                ...
                case 6:
                    error_2 = _c.sent();
                    console.error('Create email config error:', error_2);
                    if (error_2 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid configuration data', details: error_2.errors }, { status: 400 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Internal server error' }, { status: 500 })];
