...
var ListAlertsSchema = zod_1.z.object({
    page: zod_1.z.string().transform(function (val) { return parseInt(val) || 1; }).optional(),
    limit: zod_1.z.string().transform(function (val) { return Math.min(parseInt(val) || 10, 50); }).optional(),
    alert_type: zod_1.z.enum(['90_days_before', '30_days_before', '7_days_before', 'expired', 'training_due', 'document_review']).optional(),
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, queryParams, _b, _c, page, _d, limit, alert_type, status_1, priority, profile, query, userProfile, statusFilter, offset, _e, alerts, error, count, totalPages, hasNextPage, hasPrevPage, error_1;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    ...
                    _b = ListAlertsSchema.parse(queryParams), _c = _b.page, page = _c === void 0 ? 1 : _c, _d = _b.limit, limit = _d === void 0 ? 10 : _d, alert_type = _b.alert_type, status_1 = _b.status, priority = _b.priority;
                ...
                case 3:
                    ...
                    if (!(profile === null || profile === void 0 ? void 0 : profile.clinic_id)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'User not associated with clinic' }, { status: 403 })];
                    }
                    query = supabase
                ...
                case 5:
                    ...
                    if (status_1) {
                        statusFilter = status_1 === 'pending' ? 'is.null' :
                            status_1 === 'sent' ? 'not.is.null' :
                                'not.is.null';
                        if (status_1 === 'pending') {
                ...
                case 6:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch alerts' }, { status: 500 })];
                    }
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, requestBody, _b, alert_id, acknowledgment_note, _c, alert_1, error, error_2;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    requestBody = _d.sent();
                    _b = AcknowledgeAlertSchema.parse(requestBody), alert_id = _b.alert_id, acknowledgment_note = _b.acknowledgment_note;
                    return [4 /*yield*/, supabase
                            .from('compliance_alerts')
                            .update({
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        if (error.code === 'PGRST116') {
                            return [2 /*return*/, server_1.NextResponse.json({ error: 'Alert not found' }, { status: 404 })];
                        }
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to acknowledge alert' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
