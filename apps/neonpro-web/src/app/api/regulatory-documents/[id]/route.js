      ...
      switch (_e.label) {
        ...
        case 4:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to fetch document" }, { status: 500 }),
            ];
          }
      ...
      switch (_f.label) {
        ...
        case 6:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to update document" }, { status: 500 }),
            ];
          }
        ...
        case 7:
          ...
          _f.label = 8;
        case 8:
          return [2 /*return*/, server_1.NextResponse.json({ document: document_2 })];
        case 9:
          error_2 = _f.sent();
    ...
    return __generator(this, (_e) => {
      switch (_e.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            supabase.from("regulatory_documents").select("id").eq("id", id).single(),
          ];
        case 4:
          ...
          return [4 /*yield*/, supabase.from("regulatory_documents").delete().eq("id", id)];
        case 5:
          error = _e.sent().error;
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to delete document" }, { status: 500 }),
            ];
          }
          return [
            2 /*return*/,
            server_1.NextResponse.json({ message: "Document deleted successfully" }),
          ];
        case 6:
          error_3 = _e.sent();
