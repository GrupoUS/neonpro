...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, queryParams, _b, _c, page, _d, limit, category, status_1, search, query, offset, _e, documents, error, count, totalPages, hasNextPage, hasPrevPage, error_1;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    ...
                    _b = ListDocumentsSchema.parse(queryParams), _c = _b.page, page = _c === void 0 ? 1 : _c, _d = _b.limit, limit = _d === void 0 ? 10 : _d, category = _b.category, status_1 = _b.status, search = _b.search;
                    query = supabase
                    ...
                    if (search) {
                        query = query.or("document_type.ilike.%".concat(search, "%,document_number.ilike.%").concat(search, "%,file_name.ilike.%").concat(search, "%"));
                    }
                    offset = (page - 1) * limit;
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch documents' }, { status: 500 })];
                    }
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, requestBody, validatedData, profile, _b, document_1, error, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, supabase
                            .from('regulatory_documents')
                            .insert(__assign(__assign({}, validatedData), { clinic_id: profile.clinic_id, created_by: user.id, updated_by: user.id }))
                            .select("\n        *,\n        regulation_categories!inner(name, authority_name)\n      ")
                            .single()];
                case 5:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create document' }, { status: 500 })];
                    }
                ...
                case 6:
                    _c.sent();
                    _c.label = 7;
                case 7: return [2 /*return*/, server_1.NextResponse.json({ document: document_1 }, { status: 201 })];
                case 8:
                    error_2 = _c.sent();
