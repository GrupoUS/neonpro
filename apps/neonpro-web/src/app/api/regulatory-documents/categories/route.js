    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 2:
          ...
          (_b = ListCategoriesSchema.parse(queryParams)),
            (authority = _b.authority),
            (search = _b.search);
          query = supabase
          ...
          if (search) {
            query = query.or(
              "name.ilike.%"
                .concat(search, "%,authority_name.ilike.%")
                .concat(search, "%,description.ilike.%")
                .concat(search, "%"),
            );
          }
        ...
        case 3:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to fetch categories" }, { status: 500 }),
            ];
          }
          groupedCategories =
      ...
      switch (_c.label) {
        ...
        case 3:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to fetch authorities" }, { status: 500 }),
            ];
          }
          uniqueAuthorities =
            authorities === null || authorities === void 0
              ? void 0
              : authorities.reduce(function (acc, item) {
                  var existing = acc.find(function (a) {
                    return a.authority_name === item.authority_name;
                  });
                  if (!existing) {
                    acc.push({
