        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    queryParams = retention_2.ChurnPredictionQuerySchema.parse({
                    ...
                    return [4 /*yield*/, retention_1.RetentionService.getChurnPredictions(filters)];
                case 1:
                    result = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error in churn predictions GET:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validatedData, churnPrediction, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    body = _a.sent();
                    validatedData = retention_2.CreatePatientChurnPredictionSchema.parse(body);
                    return [4 /*yield*/, retention_1.RetentionService.createChurnPrediction(validatedData)];
                case 2:
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('Error in churn predictions POST:', error_2);
