...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, clinic_id, dashboardSummary, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, retention_1.RetentionService.getDashboardSummary()];
                case 1:
                    dashboardSummary = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error in retention dashboard GET:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
