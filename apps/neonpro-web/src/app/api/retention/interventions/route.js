...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, queryParams, patient_id, filters, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    searchParams = new URL(request.url).searchParams;
                    queryParams = retention_2.InterventionQuerySchema.parse({
                    ...
                    return [4 /*yield*/, retention_1.RetentionService.getRetentionInterventions(filters)];
                case 1:
                    result = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error in retention interventions GET:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validatedData, intervention, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    body = _a.sent();
                    validatedData = retention_2.CreateRetentionInterventionSchema.parse(body);
                    return [4 /*yield*/, retention_1.RetentionService.createRetentionIntervention(validatedData)];
                case 2:
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('Error in retention interventions POST:', error_2);
