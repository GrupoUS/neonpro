...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var patientId, retentionAnalytics, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, retention_1.RetentionService.getRetentionAnalyticsByPatient(patientId)];
                case 2:
                    retentionAnalytics = _c.sent();
                ...
                case 3:
                    error_1 = _c.sent();
                    console.error('Error in retention analytics by patient GET:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
