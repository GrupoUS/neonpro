      ...
      switch (_c.label) {
        ...
        case 3:
          ...
          if (error && error.code !== "PGRST116") {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to fetch preferences" }, { status: 500 }),
            ];
          }
      ...
      switch (_d.label) {
        ...
        case 3:
          (_b = _d.sent()),
            ...
            (personality = _b.personality),
            (temperature = _b.temperature),
            (max_tokens = _b.max_tokens),
            (preferred_model = _b.preferred_model),
            (voice_enabled = _b.voice_enabled),
            (notifications_enabled = _b.notifications_enabled),
            (context_memory = _b.context_memory),
            (suggestions_enabled = _b.suggestions_enabled);
          // Validações
          ...
          if (preferred_model && !["gpt4", "claude", "gpt35"].includes(preferred_model)) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Invalid preferred model" }, { status: 400 }),
            ];
          }
          preferencesData = __assign(
            __assign(
              __assign(
                __assign(
                  __assign(
                    ...
                    preferred_model !== undefined && { preferred_model: preferred_model },
                  ),
              ...
              context_memory !== undefined && { context_memory: context_memory },
            ),
            suggestions_enabled !== undefined && { suggestions_enabled: suggestions_enabled },
          );
          return [
            4 /*yield*/,
            supabase
        ...
        case 4:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to save preferences" }, { status: 500 }),
            ];
          }
          return [2 /*return*/, server_1.NextResponse.json({ preferences: preferences })];
        case 5:
