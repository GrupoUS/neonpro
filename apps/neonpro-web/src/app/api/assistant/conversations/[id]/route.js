      ...
      switch (_f.label) {
        ...
        case 5:
          ...
          if (messagesError) {
            ...
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Failed to fetch messages" }, { status: 500 }),
            ];
          }
          return [
            2 /*return*/,
      ...
      switch (_g.label) {
        ...
        case 5:
          ...
          if (Object.keys(updateData).length === 0) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "No valid fields to update" }, { status: 400 }),
            ];
          }
          return [
            4 /*yield*/,
