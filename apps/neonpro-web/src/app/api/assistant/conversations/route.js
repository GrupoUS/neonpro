...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, limit, offset, _b, conversations, error, formattedConversations, error_1;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Failed to fetch conversations" }, { status: 500 })];
                    }
                    formattedConversations = (conversations === null || conversations === void 0 ? void 0 : conversations.map(function (conv) {
                        var _a, _b;
                        return ({
                            id: conv.id,
                            title: conv.title,
                            ...
                            message_count: ((_b = (_a = conv.assistant_messages) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.count) || 0
                        });
                    })) || [];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    _b = _e.sent(), title = _b.title, _c = _b.model, model = _c === void 0 ? 'gpt4' : _c;
