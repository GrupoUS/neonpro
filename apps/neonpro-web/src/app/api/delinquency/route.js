    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          delinquencyManager = new delinquency_manager_1.DelinquencyManager(
            process.env.SUPABASE_URL,
            process.env.SUPABASE_SERVICE_ROLE_KEY,
          );
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 7:
          return [4 /*yield*/, delinquencyManager.processCollectionWorkflows()];
        case 8:
          _c.sent();
          return [
            2 /*return*/,
        ...
        case 9:
          ...
          return [
            4 /*yield*/,
            delinquencyManager.createPaymentPlan({
        ...
        case 11:
          ...
          return [
            4 /*yield*/,
            delinquencyManager.sendNotification(
        ...
        case 13:
          customerId = zod_1.z
            .object({ customerId: zod_1.z.string().uuid() })
            .parse(data).customerId;
    ...
    return __generator(this, function (_h) {
      switch (_h.label) {
        ...
        case 4:
          ...
          return [
            2 /*return*/,
            server_1.NextResponse.json({ success: true, data: updatedProfile }),
          ];
        case 5:
          (_d = zod_1.z
            .object({
          ...
          return [
            ...
            supabase
              ...
              .update(
                __assign(
                  { status: status_1, updated_at: new Date().toISOString() },
                  status_1 === "active"
        ...
        case 7:
          (_f = zod_1.z
            ...
            (currentStage = _f.currentStage),
            (nextActionType = _f.nextActionType),
            (nextActionDate = _f.nextActionDate),
            (notes = _f.notes);
          updateData = {
            updated_at: new Date().toISOString(),
          };
      ...
      switch (_c.label) {
        case 0:
          ...
          if (!action || !id) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Action and ID are required" }, { status: 400 }),
            ];
          }
          supabase = (0, supabase_js_1.createClient)(
            process.env.SUPABASE_URL,
        ...
        case 5:
          ...
          return [
            2 /*return*/,
            server_1.NextResponse.json({ success: true, message: "Collection workflow completed" }),
          ];
        case 6:
          return [
            4 /*yield*/,
