    ...
    return __generator(this, function (_k) {
      switch (_k.label) {
        ...
        case 9:
          ...
          actionHistory =
            (currentWorkflow === null || currentWorkflow === void 0
              ? void 0
              : currentWorkflow.action_history) || [];
          actionHistory.push({
        ...
        case 12:
          ...
          return [
            ...
            server_1.NextResponse.json({
              success: true,
              message: "".concat(
                (updatedWorkflows === null || updatedWorkflows === void 0
                  ? void 0
                  : updatedWorkflows.length) || 0,
                " workflows assigned successfully",
              ),
        ...
        case 13:
          (_h = zod_1.z
            ...
            .parse(data)),
            (workflowId = _h.workflowId),
            (escalationReason = _h.escalationReason),
            (escalateTo = _h.escalateTo);
          return [
            4 /*yield*/,
            supabase
              .from("collection_workflows")
      ...
      switch (_j.label) {
        ...
        case 3:
          (_c = zod_1.z
            ...
            .parse(data)),
            (workflowId = _c.workflowId),
            (updates = __rest(_c, ["workflowId"]));
          updateData = {
            updated_at: new Date().toISOString(),
          };
          if (updates.currentStage) updateData.current_stage = updates.currentStage;
          if (updates.nextActionType) updateData.next_action_type = updates.nextActionType;
          if (updates.nextActionDate) updateData.next_action_date = updates.nextActionDate;
        ...
        case 5:
          ...
          if (validatedData.updates.priority) updateData.priority = validatedData.updates.priority;
          return [
            4 /*yield*/,
            supabase
              .from("collection_workflows")
