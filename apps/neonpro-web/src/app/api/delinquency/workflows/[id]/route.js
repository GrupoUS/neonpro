...
var GetActivitiesQuerySchema = zod_1.z.object({
  ...
  activityType: zod_1.z
    .enum(["call", "email", "sms", "meeting", "payment", "promise", "escalation"])
    .optional(),
  dateFrom: zod_1.z.string().datetime().optional(),
  dateTo: zod_1.z.string().datetime().optional(),
  performedBy: zod_1.z.string().uuid().optional(),
  sortBy: zod_1.z
    .enum(["created_at", "activity_type", "amount_collected"])
    .optional()
    .default("created_at"),
      ...
      switch (_h.label) {
        case 0:
          ...
          if (!workflowId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Workflow ID is required" }, { status: 400 }),
            ];
          }
        ...
        case 2:
          return [
            4 /*yield*/,
            supabase.from("collection_workflow_status").select("*").eq("id", workflowId).single(),
          ];
        case 3:
        ...
        case 5:
          ...
          return [
            ...
            server_1.NextResponse.json({
              data: __assign(__assign({}, workflow), {
                recentActivities: recentActivities || [],
                statistics: {
                  totalActivities:
                    (stats === null || stats === void 0 ? void 0 : stats.length) || 0,
                  totalCollected: totalCollected,
                  averageActivityValue: (stats === null || stats === void 0 ? void 0 : stats.length)
                    ? totalCollected / stats.length
                    : 0,
                },
              }),
            }),
        ...
        case 6:
          ...
          activitiesQuery = activitiesQuery.order(sortColumn, {
        ...
        case 11:
          return [
            4 /*yield*/,
            supabase.from("collection_activities").select("*").eq("workflow_id", workflowId),
          ];
        case 12:
          activities = _h.sent().data;
          stats_1 = {
            totalActivities:
              (activities === null || activities === void 0 ? void 0 : activities.length) || 0,
            activitiesByType: {},
            totalCollected: 0,
        ...
        case 15:
          ...
          return [
            2 /*return*/,
            server_1.NextResponse.json({ error: "Failed to fetch workflow data" }, { status: 500 }),
          ];
        case 16:
          return [2 /*return*/];
      }
    ...
    return __generator(this, function (_m) {
      switch (_m.label) {
        ...
        case 9:
          ...
          return [
            2 /*return*/,
            server_1.NextResponse.json({ success: true, data: scheduledAction }),
          ];
        case 10:
          (_h = zod_1.z
            .object({
            ...
            .parse(data)),
            (amount = _h.amount),
            (paymentMethod = _h.paymentMethod),
        ...
        case 15:
          (_k = zod_1.z
            ...
            .parse(data)),
            (notificationType = _k.notificationType),
            (message = _k.message),
            (channel = _k.channel);
          return [
            4 /*yield*/,
        ...
        case 16:
          ...
          return [
            4 /*yield*/,
            supabase.from("collection_activities").insert({
              workflow_id: workflowId,
              customer_id: workflow.customer_id,
        ...
        case 20:
          ...
          if (error_2 instanceof zod_1.z.ZodError) {
            return [
              2 /*return*/,
              server_1.NextResponse.json(
                { error: "Validation error", details: error_2.errors },
                { status: 400 },
              ),
            ];
          }
    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 3:
          ...
          return [
            2 /*return*/,
            server_1.NextResponse.json({ success: true, data: updatedWorkflow }),
          ];
        case 4:
          error_3 = _e.sent();
          ...
          if (error_3 instanceof zod_1.z.ZodError) {
            return [
              2 /*return*/,
              server_1.NextResponse.json(
                { error: "Validation error", details: error_3.errors },
                { status: 400 },
              ),
            ];
          }
          return [
            2 /*return*/,
            server_1.NextResponse.json({ error: "Failed to update workflow" }, { status: 500 }),
          ];
        case 5:
          return [2 /*return*/];
      }
    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 4:
          ...
          return [
            2 /*return*/,
            server_1.NextResponse.json({ error: "Failed to complete workflow" }, { status: 500 }),
          ];
        case 5:
          return [2 /*return*/];
      }
