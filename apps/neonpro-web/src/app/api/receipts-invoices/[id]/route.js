...
function POST(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, authHeader, _c, user, authError, documentId, url, action, manager, _d, body, validatedData, result, body, validatedData, document_2, templateOptions, result, document_3, result, _e, document_4, error, _f, pdfData, downloadError, pdfBuffer, _g, _h, result, result, result, error_2;
        var _j, _k, _l;
        var params = _b.params;
        return __generator(this, function (_m) {
            switch (_m.label) {
                ...
                case 1:
                    ...
                    if (!action) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Action parameter is required' }, { status: 400 })];
                    }
                    manager = getReceiptInvoiceManager();
                    _d = action;
                    switch (_d) {
                        case 'send-email': return [3 /*break*/, 2];
                        case 'regenerate-pdf': return [3 /*break*/, 5];
                        case 'generate-nfse': return [3 /*break*/, 9];
                        case 'download-pdf': return [3 /*break*/, 12];
                        case 'mark-paid': return [3 /*break*/, 16];
                        case 'mark-overdue': return [3 /*break*/, 18];
                        case 'cancel': return [3 /*break*/, 20];
                    }
                    return [3 /*break*/, 22];
                case 2: return [4 /*yield*/, request.json()];
                case 3:
                    body = _m.sent();
                    validatedData = SendEmailSchema.parse(body);
                    return [4 /*yield*/, manager.sendEmail(documentId, validatedData.recipientEmail, validatedData.customMessage)];
                case 4:
                    result = _m.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                ...
                case 7:
                    document_2 = _m.sent();
                    templateOptions = {
                        template: ((_j = validatedData.templateOptions) === null || _j === void 0 ? void 0 : _j.template) || 'modern',
                        colors: ((_k = validatedData.templateOptions) === null || _k === void 0 ? void 0 : _k.colors) || {
                            primary: '#2563eb',
                            secondary: '#64748b',
                            accent: '#10b981',
                        },
                        fonts: ((_l = validatedData.templateOptions) === null || _l === void 0 ? void 0 : _l.fonts) || {
                ...
                case 9: return [4 /*yield*/, manager.getDocument(documentId)];
                case 10:
                    document_3 = _m.sent();
                    if (document_3.type !== 'invoice') {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'NFSe can only be generated for invoices' }, { status: 400 })];
                    }
                ...
                case 13:
                    ...
                    if (!document_4.pdf_path) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'PDF not available' }, { status: 404 })];
                    }
                    return [4 /*yield*/, supabase.storage
                            .from('documents')
                            .download(document_4.pdf_path)];
                case 14:
                    _f = _m.sent(), pdfData = _f.data, downloadError = _f.error;
                    if (downloadError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to download PDF' }, { status: 500 })];
                    }
                    _h = (_g = Buffer).from;
                    return [4 /*yield*/, pdfData.arrayBuffer()];
                case 15:
                    pdfBuffer = _h.apply(_g, [_m.sent()]);
                    return [2 /*return*/, new server_1.NextResponse(pdfBuffer, {
                            headers: {
                                'Content-Type': 'application/pdf',
                                'Content-Disposition': "attachment; filename=\"".concat(document_4.type, "-").concat(document_4.number, ".pdf\""),
                            },
                        })];
                case 16: return [4 /*yield*/, manager.updateStatus(documentId, 'paid')];
                case 17:
                    result = _m.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 18: return [4 /*yield*/, manager.updateStatus(documentId, 'overdue')];
                case 19:
                    result = _m.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 20: return [4 /*yield*/, manager.updateStatus(documentId, 'cancelled')];
                case 21:
                    result = _m.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 22: return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid action' }, { status: 400 })];
...
function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, authHeader, _c, user, authError, documentId, _d, document_5, fetchError, deleteError, error_4;
        var params = _b.params;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
