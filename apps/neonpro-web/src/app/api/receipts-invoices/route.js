    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 1:
          ...
          filters = __assign(__assign({}, queryParams), {
    ...
    return __generator(this, (_f) => {
      switch (_f.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            supabase.from("customers").select("*").eq("id", validatedData.customerId).single(),
          ];
        case 3:
          ...
          subtotal = validatedData.items.reduce((sum, item) => sum + item.total, 0);
          taxTotal = validatedData.items.reduce((sum, item) => sum + item.taxAmount, 0);
        ...
        case 4:
          ...
          receiptData = {
            id: documentId,
            number:
              numberResult || "".concat(validatedData.type.toUpperCase(), "-").concat(Date.now()),
          ...
          templateOptions = {
            template:
              ((_c = validatedData.template) === null || _c === void 0 ? void 0 : _c.template) ||
              "modern",
            colors: ((_d = validatedData.template) === null || _d === void 0
              ? void 0
              : _d.colors) || {
              primary: "#2563eb",
              secondary: "#64748b",
            ...
            fonts: ((_e = validatedData.template) === null || _e === void 0
              ? void 0
              : _e.fonts) || {
        ...
        case 5:
          ...
          if (!pdfResult.success) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: pdfResult.error }, { status: 500 }),
            ];
          }
          nfseResult = void 0;
          ...
          return [
            ...
            server_1.NextResponse.json({
              ...
              data: {
                ...
                nfseGenerated:
                  (nfseResult === null || nfseResult === void 0 ? void 0 : nfseResult.success) ||
                  false,
                nfseNumber:
                  nfseResult === null || nfseResult === void 0 ? void 0 : nfseResult.nfseNumber,
              },
            }),
          ];
        case 8:
      ...
      switch (_c.label) {
        ...
        case 1:
          ...
          if (!documentId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Document ID is required" }, { status: 400 }),
            ];
          }
          return [4 /*yield*/, request.json()];
        case 2:
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 2:
          ...
          return [4 /*yield*/, supabase.storage.from("documents").remove([document_1.pdf_path])];
        case 3:
          _c.sent();
          _c.label = 4;
        case 4:
