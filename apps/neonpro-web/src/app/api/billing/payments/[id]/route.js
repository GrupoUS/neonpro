      ...
      switch (_d.label) {
        ...
        case 4:
          ...
          if (error || !payment) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Payment not found" }, { status: 404 }),
            ];
          }
      ...
      switch (_f.label) {
        ...
        case 6:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Failed to update payment" }, { status: 500 }),
            ];
          }
          if (!(validatedData.status === "completed" && currentPayment.status !== "completed"))
            return [3 /*break*/, 9];
    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            supabase.from("installment_payments").delete().eq("payment_id", resolvedParams.id),
          ];
        case 5:
          ...
          return [4 /*yield*/, supabase.from("payments").delete().eq("id", resolvedParams.id)];
        case 6:
          error = _e.sent().error;
          if (error) {
            ...
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Failed to delete payment" }, { status: 500 }),
            ];
          }
          return [
            4 /*yield*/,
        ...
        case 7:
          ...
          return [
            4 /*yield*/,
            supabase.from("invoices").update({ status: "pending" }).eq("id", payment.invoice_id),
          ];
        case 8:
          _e.sent();
          _e.label = 9;
        case 9:
          return [
            2 /*return*/,
            server_2.NextResponse.json({ message: "Payment deleted successfully" }),
          ];
        case 10:
          error_3 = _e.sent();
    ...
    return __generator(this, function (_g) {
      switch (_g.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            supabase.from("payments").select("*").eq("id", resolvedParams.id).single(),
          ];
        case 5:
        ...
        case 6:
          ...
          if (refundError) {
            ...
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Failed to create refund" }, { status: 500 }),
            ];
          }
          return [
            4 /*yield*/,
        ...
        case 8:
          ...
          return [
            4 /*yield*/,
            supabase.from("invoices").update({ status: newStatus }).eq("id", payment.invoice_id),
          ];
        case 9:
          _g.sent();
          _g.label = 10;
