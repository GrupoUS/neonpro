      ...
      switch (_b.label) {
        ...
        case 3:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Failed to fetch payments" }, { status: 500 }),
            ];
          }
          totalAmount =
      ...
      switch (_d.label) {
        ...
        case 6:
          ...
          if (paymentError) {
            ...
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Failed to create payment" }, { status: 500 }),
            ];
          }
          ...
          return [
            4 /*yield*/,
            supabase.from("invoices").update({ status: "paid" }).eq("id", validatedData.invoice_id),
          ];
        case 7:
          _d.sent();
          _d.label = 8;
        case 8:
          ...
          return [4 /*yield*/, supabase.from("installment_payments").insert(installments)];
        case 9:
          ...
          _d.label = 10;
        case 10:
          return [2 /*return*/, server_2.NextResponse.json({ payment: payment }, { status: 201 })];
        case 11:
          error_2 = _d.sent();
