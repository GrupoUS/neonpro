...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, searchParams, status_1, patientId, page, limit, offset, query, _a, invoices, error, count, error_1;
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to fetch invoices" }, { status: 500 })];
                    }
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, body, validatedData, _a, invoice_1, invoiceError, items, itemsError, _b, completeInvoice, fetchError, error_2;
            ...
            switch (_c.label) {
                ...
                case 4:
                    ...
                    if (invoiceError) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to create invoice" }, { status: 500 })];
                    }
                    items = validatedData.items.map(function (item) { return ({
                ...
                case 6:
                    // Rollback - delete the invoice
                    _c.sent();
                    return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to create invoice items" }, { status: 500 })];
                ...
                case 8:
                    ...
                    if (fetchError) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Invoice created but failed to fetch complete data" }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ invoice: completeInvoice }, { status: 201 })];
                case 9:
                    error_2 = _c.sent();
