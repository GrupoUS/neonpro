      ...
      switch (_d.label) {
        ...
        case 4:
          ...
          if (error || !invoice) {
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Invoice not found" }, { status: 404 }),
            ];
          }
      ...
      switch (_d.label) {
        ...
        case 5:
          ...
          if (error) {
            ...
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Failed to update invoice" }, { status: 500 }),
            ];
          }
          return [2 /*return*/, server_2.NextResponse.json({ invoice: invoice })];
        case 6:
    ...
    return __generator(this, (_e) => {
      switch (_e.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            supabase.from("payments").select("id").eq("invoice_id", resolvedParams.id).limit(1),
          ];
        case 4:
        ...
        case 5:
          ...
          if (error_4) {
            ...
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Failed to cancel invoice" }, { status: 500 }),
            ];
          }
          return [
            2 /*return*/,
        ...
        case 6:
          return [
            4 /*yield*/,
            supabase.from("invoice_items").delete().eq("invoice_id", resolvedParams.id),
          ];
        case 7:
          ...
          return [4 /*yield*/, supabase.from("invoices").delete().eq("id", resolvedParams.id)];
        case 8:
          error = _e.sent().error;
          if (error) {
            ...
            return [
              2 /*return*/,
              server_2.NextResponse.json({ error: "Failed to delete invoice" }, { status: 500 }),
            ];
          }
          return [
            2 /*return*/,
            server_2.NextResponse.json({ message: "Invoice deleted successfully" }),
          ];
        case 9:
          error_3 = _e.sent();
