...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, searchParams, startDate, endDate, period, _a, financialSummary, summaryError, _b, revenueByPeriod, revenueError, _c, revenueByService, serviceRevenueError, _d, paymentMethodStats, paymentStatsError, methodStats, _e, topPatients, patientsError, patientRevenue, topPatientsArray, _f, outstandingInvoices, outstandingError, outstandingAnalysis_1, now_1, monthlyTrendsStartDate, _g, monthlyTrends, trendsError, error_1;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, supabase.rpc("get_financial_summary", {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, supabase.rpc("get_revenue_by_period", {
                            start_date: startDate,
                            end_date: endDate,
                            period_type: period,
                        })];
                case 4:
                    ...
                    return [4 /*yield*/, supabase.rpc("get_revenue_by_service", {
                            start_date: startDate,
                            end_date: endDate,
                        })];
                case 5:
                ...
                case 7:
                    ...
                    if (!patientsError && topPatients) {
                        patientRevenue = topPatients.reduce(function (acc, payment) {
                            ...
                            if (patientId && (invoice === null || invoice === void 0 ? void 0 : invoice.patient)) {
                                if (!acc[patientId]) {
                                    acc[patientId] = {
                ...
                case 8:
                    ...
                    if (!outstandingError && outstandingInvoices) {
                        ...
                        outstandingInvoices.forEach(function (invoice) {
                            var _a;
                            var paidAmount = ((_a = invoice.payments) === null || _a === void 0 ? void 0 : _a.reduce(function (sum, p) { return sum + p.amount; }, 0)) || 0;
                            ...
                            if (remainingAmount > 0) {
                                ...
                                var daysPastDue = Math.floor((now_1.getTime() - dueDate.getTime()) / (1000 * 60 * 60 * 24));
                                if (daysPastDue > 0) {
                ...
                case 9:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({
                            financial_summary: (financialSummary === null || financialSummary === void 0 ? void 0 : financialSummary[0]) || {
                                total_revenue: 0,
                                pending_invoices: 0,
                                overdue_invoices: 0,
                                paid_invoices: 0,
