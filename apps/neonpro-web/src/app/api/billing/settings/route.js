            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to fetch financial settings" }, { status: 500 })];
                    }
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, body, validatedData, _a, existingSettings, checkError, settings, error, _b, data, updateError, _c, data, insertError, error_2;
            ...
            switch (_d.label) {
                ...
                case 4:
                    ...
                    if (checkError && checkError.code !== "PGRST116") {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to check existing settings" }, { status: 500 })];
                    }
                    settings = void 0;
                    error = void 0;
                ...
                case 6: return [4 /*yield*/, supabase
                        .from("financial_settings")
                        .insert(__assign(__assign({ clinic_id: user.id, company_name: "", address: "", phone: "", email: user.email || "", tax_rate: 0, default_payment_terms: "30 dias", invoice_prefix: "INV", next_invoice_number: 1, payment_prefix: "PAY", next_payment_number: 1, default_due_days: 30, late_fee_percentage: 0, discount_limit_percentage: 10 }, validatedData), { created_at: new Date().toISOString(), updated_at: new Date().toISOString() }))
                        .select()
                        .single()];
                case 7:
                ...
                case 8:
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to update financial settings" }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ settings: settings })];
                case 9:
                    error_2 = _d.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, body, action, _a, settings, settingsError, updateData, _b, updatedSettings, updateError, error_3;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (!["next_invoice_number", "next_payment_number"].includes(action)) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Invalid action" }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from("financial_settings")
                            .select("*")
                ...
                case 5:
                    ...
                    if (updateError) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to update settings" }, { status: 500 })];
                    }
