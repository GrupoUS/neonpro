        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    ...
                    if (error || !service) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Service not found" }, { status: 404 })];
                    }
            ...
            switch (_d.label) {
                ...
                case 5:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to update service" }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ service: service })];
                case 6:
                    error_2 = _d.sent();
...
function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var resolvedParams, supabase, user, _c, invoices, invoiceError, _d, service, error_4, error, error_3;
        var params = _b.params;
            ...
            switch (_e.label) {
                ...
                case 4:
                    ...
                    if (invoiceError) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to check service relations" }, { status: 500 })];
                    }
                ...
                case 5:
                    ...
                    if (error_4) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to deactivate service" }, { status: 500 })];
                    }
                ...
                case 7:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to delete service" }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json({ message: "Service deleted successfully" })];
                case 8:
                    error_3 = _e.sent();
