            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to fetch services" }, { status: 500 })];
                    }
            ...
            switch (_b.label) {
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: "Failed to create service" }, { status: 500 })];
                    }
