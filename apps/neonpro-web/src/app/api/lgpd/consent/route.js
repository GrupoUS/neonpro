    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            complianceManager.grantConsent(user.id, validatedData.purposes, {
      ...
      switch (_c.label) {
        ...
        case 3:
          ...
          if (!consentId) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Consent ID is required" }, { status: 400 }),
            ];
          }
          return [4 /*yield*/, supabase.from("profiles").select("role").eq("id", user.id).single()];
        case 4:
          ...
          return [
            4 /*yield*/,
            supabase.from("lgpd_consents").select("user_id").eq("id", consentId).single(),
          ];
        case 5:
          ...
          if (!existingConsent) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Consent not found" }, { status: 404 }),
            ];
          }
          ...
          return [
            4 /*yield*/,
            complianceManager.withdrawConsent(
        ...
        case 7:
          ...
          return [
            4 /*yield*/,
            supabase.from("lgpd_consents").update(updateData).eq("id", consentId).select().single(),
          ];
        case 8:
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 2:
          ...
          url = new URL(request.url);
          purposes =
            ((_b = url.searchParams.get("purposes")) === null || _b === void 0
              ? void 0
              : _b.split(",")) || [];
