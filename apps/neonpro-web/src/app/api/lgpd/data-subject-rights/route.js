...
var requestQuerySchema = zod_1.z.object({
    ...
    requestType: zod_1.z.enum(['access', 'rectification', 'deletion', 'portability', 'objection']).optional(),
    status: zod_1.z.enum(['pending', 'in_progress', 'completed', 'rejected']).optional(),
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, url, queryParams, validatedQuery, profile, isAdmin, targetUserId, query, _b, requests, requestsError, countQuery, totalCount, complianceManager, error_1;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    complianceManager = new compliance_manager_1.LGPDComplianceManager(supabase);
                    return [4 /*yield*/, complianceManager.createDataSubjectRequest({
                            userId: user.id,
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, profile, body, validatedData, url, requestId, existingRequest, complianceManager, result, updateData, _b, updatedRequest, updateError, error_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 4:
                    ...
                    if (!requestId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Request ID is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('lgpd_data_subject_requests')
                            .select('*')
                ...
                case 5:
                    ...
                    if (!existingRequest) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Request not found' }, { status: 404 })];
                    }
                    complianceManager = new compliance_manager_1.LGPDComplianceManager(supabase);
                    if (!(validatedData.status === 'completed')) return [3 /*break*/, 7];
                    return [4 /*yield*/, complianceManager.processDataSubjectRequest(requestId, {
