...
var breachCreateSchema = zod_1.z.object({
    ...
    breachType: zod_1.z.enum(['unauthorized_access', 'data_loss', 'system_compromise', 'human_error', 'malicious_attack', 'other']),
...
var breachQuerySchema = zod_1.z.object({
    status: zod_1.z.enum(['reported', 'investigating', 'contained', 'resolved']).optional(),
    severity: zod_1.z.enum(['low', 'medium', 'high', 'critical']).optional(),
    breachType: zod_1.z.enum(['unauthorized_access', 'data_loss', 'system_compromise', 'human_error', 'malicious_attack', 'other']).optional(),
    startDate: zod_1.z.string().datetime().optional(),
    endDate: zod_1.z.string().datetime().optional(),
    search: zod_1.z.string().optional(),
    page: zod_1.z.coerce.number().min(1).default(1),
    limit: zod_1.z.coerce.number().min(1).max(100).default(20),
    sortBy: zod_1.z.enum(['discovered_at', 'severity', 'status', 'estimated_affected_users']).default('discovered_at'),
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, profile, url, queryParams, validatedQuery, query, _b, breaches, breachError, countQuery, totalCount, stats, severityStats, statusStats, complianceManager, error_1;
            ...
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (validatedQuery.search) {
                        query = query.or("title.ilike.%".concat(validatedQuery.search, "%,description.ilike.%").concat(validatedQuery.search, "%"));
                    }
                ...
                case 5:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .gte('discovered_at', new Date(Date.now() - 365 * 24 * 60 * 60 * 1000).toISOString())]; // Last year
                case 6:
                    stats = (_c.sent()) // Last year
                    .data;
                    severityStats = (stats === null || stats === void 0 ? void 0 : stats.reduce(function (acc, breach) {
                        acc[breach.severity] = (acc[breach.severity] || 0) + 1;
                        return acc;
                    }, {})) || {};
                    statusStats = (stats === null || stats === void 0 ? void 0 : stats.reduce(function (acc, breach) {
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, profile, body, validatedData, complianceManager, breach, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    complianceManager = new compliance_manager_1.LGPDComplianceManager(supabase);
                    return [4 /*yield*/, complianceManager.reportBreachIncident({
                            ...
                            containedAt: validatedData.containedAt ? new Date(validatedData.containedAt) : undefined,
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, profile, body, validatedData, url, breachId, existingBreach, updateData, _b, updatedBreach, updateError, complianceManager, error_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 8, , 9]);
                ...
                case 4:
                    ...
                    if (!breachId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Breach ID is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('lgpd_breach_incidents')
                            .select('*')
                ...
                case 5:
                    ...
                    if (!existingBreach) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Breach incident not found' }, { status: 404 })];
                    }
                    updateData = {
