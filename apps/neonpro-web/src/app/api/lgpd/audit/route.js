...
var auditQuerySchema = zod_1.z.object({
    ...
    eventType: zod_1.z.enum(['consent_change', 'data_access', 'data_modification', 'data_deletion', 'admin_action', 'system_access', 'security_event']).optional(),
...
var auditCreateSchema = zod_1.z.object({
    eventType: zod_1.z.enum(['consent_change', 'data_access', 'data_modification', 'data_deletion', 'admin_action', 'system_access', 'security_event']),
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, profile, isAdmin, url, queryParams, validatedQuery, isExport, query, _b, auditEvents, auditError, countQuery, totalCount, stats, eventTypeStats, complianceManager, error_1;
            ...
            switch (_c.label) {
                ...
                case 5:
                    ...
                    if (validatedQuery.search) {
                        query = query.or("description.ilike.%".concat(validatedQuery.search, "%,details.ilike.%").concat(validatedQuery.search, "%"));
                    }
                ...
                case 8:
                    stats = (_c.sent()) // Last 30 days
                    .data;
                    eventTypeStats = (stats === null || stats === void 0 ? void 0 : stats.reduce(function (acc, event) {
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, profile, body, validatedData, complianceManager, auditEvent, error_2;
...
function handleAuditExport(supabase, queryParams, adminUserId) {
    return __awaiter(this, void 0, void 0, function () {
        var exportParams, query, _a, auditEvents, auditError, complianceManager, csvHeaders, csvRows, csvContent, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                ...
                case 1:
                    _a = _b.sent() // Reasonable limit for export
                    , auditEvents = _a.data, auditError = _a.error;
                    if (auditError) {
                    ...
                    return [4 /*yield*/, complianceManager.logAuditEvent({
                            ...
                            details: "Admin exported ".concat((auditEvents === null || auditEvents === void 0 ? void 0 : auditEvents.length) || 0, " audit events in ").concat(exportParams.format, " format"),
                            metadata: {
                                export_params: exportParams,
                                export_count: (auditEvents === null || auditEvents === void 0 ? void 0 : auditEvents.length) || 0,
                ...
                case 2:
                    ...
                    if (exportParams.format === 'csv') {
                        csvHeaders = 'ID,Event Type,User ID,Description,Details,IP Address,User Agent,Created At\n';
                        csvRows = (auditEvents === null || auditEvents === void 0 ? void 0 : auditEvents.map(function (event) {
                            var details = typeof event.details === 'string' ? event.details.replace(/"/g, '""') : '';
                            var description = event.description.replace(/"/g, '""');
                            return "\"".concat(event.id, "\",\"").concat(event.event_type, "\",\"").concat(event.user_id, "\",\"").concat(description, "\",\"").concat(details, "\",\"").concat(event.ip_address || '', "\",\"").concat(event.user_agent || '', "\",\"").concat(event.created_at, "\"");
                        }).join('\n')) || '';
                        csvContent = csvHeaders + csvRows;
                        return [2 /*return*/, new server_1.NextResponse(csvContent, {
                                headers: {
                                    'Content-Type': 'text/csv',
                                    'Content-Disposition': "attachment; filename=\"lgpd_audit_export_".concat(new Date().toISOString().split('T')[0], ".csv\"")
                                }
                            })];
                    }
                    // Return JSON format
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            data: {
                                ...
                                exportInfo: {
                                    ...
                                    totalRecords: (auditEvents === null || auditEvents === void 0 ? void 0 : auditEvents.length) || 0,
