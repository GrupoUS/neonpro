    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 3:
          ...
          validatedQuery = complianceQuerySchema.parse(
          ...
          return [
            4 /*yield*/,
            complianceManager.getComplianceOverview({
        ...
        case 4:
          ...
          return [4 /*yield*/, supabase.from("lgpd_dashboard_metrics").select("*").single()];
        case 5:
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            complianceManager.createComplianceAssessment({
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 3:
          ...
          return [4 /*yield*/, supabase.rpc("generate_compliance_assessment")];
        case 4:
        ...
        case 5:
          ...
          return [
            ...
            complianceManager.logAuditEvent({
              ...
              details: "Assessment completed with score: ".concat(
                assessment === null || assessment === void 0 ? void 0 : assessment.score,
                "/100",
              ),
              metadata: {
