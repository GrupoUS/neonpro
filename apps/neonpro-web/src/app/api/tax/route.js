            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    switch (_a) {
                        ...
                        case 'nfe-status': return [3 /*break*/, 6];
                    }
                    return [3 /*break*/, 8];
                case 2: return [4 /*yield*/, getTaxConfiguration(supabase, clinicId)];
                case 3: return [2 /*return*/, _b.sent()];
                case 4: return [4 /*yield*/, getTaxStatistics(supabase, clinicId)];
                case 5: return [2 /*return*/, _b.sent()];
                case 6: return [4 /*yield*/, getNFEStatus(supabase, clinicId)];
                case 7: return [2 /*return*/, _b.sent()];
                case 8: return [4 /*yield*/, getTaxOverview(supabase, clinicId)];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    _a = action;
                    switch (_a) {
                        case 'calculate': return [3 /*break*/, 3];
                        case 'generate-nfe': return [3 /*break*/, 5];
                        case 'validate-cnpj': return [3 /*break*/, 7];
                    }
                    return [3 /*break*/, 9];
                case 3: return [4 /*yield*/, calculateTaxes(supabase, body)];
                case 4: return [2 /*return*/, _b.sent()];
                case 5: return [4 /*yield*/, generateNFE(supabase, body)];
                case 6: return [2 /*return*/, _b.sent()];
                case 7: return [4 /*yield*/, validateCNPJ(supabase, body)];
                case 8: return [2 /*return*/, _b.sent()];
                case 9: return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid action specified' }, { status: 400 })];
                case 10: return [3 /*break*/, 12];
                case 11:
                    error_2 = _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    totalValue = nfeStats.reduce(function (sum, doc) { return sum + doc.valor_total; }, 0);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), data = _a.data, error = _a.error;
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch NFE status' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({ data: data })];
            }
        });
...
function calculateTaxes(supabase, body) {
    return __awaiter(this, void 0, void 0, function () {
        var validatedData, BrazilianTaxEngine, taxEngine, calculations, _i, _a, service, calculation, _b, data, error;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    validatedData = taxCalculationSchema.parse(body);
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/services/tax/tax-engine'); })];
                case 1:
                ...
                case 2:
                    ...
                    service = _a[_i];
                    return [4 /*yield*/, taxEngine.calculateTaxes({
                ...
                case 5: return [4 /*yield*/, supabase
                        ...
                        total_base: validatedData.services.reduce(function (sum, s) { return sum + s.valor_total; }, 0),
                        total_taxes: calculations.reduce(function (sum, c) { return sum + c.calculation.total_taxes; }, 0),
                ...
                case 6:
                    ...
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to store tax calculation' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            data: {
...
function generateNFE(supabase, body) {
    return __awaiter(this, void 0, void 0, function () {
        var validatedData, NFEIntegrationService, nfeService, _a, invoice, invoiceError, nfeDocument, _b, data, error, error_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 3:
                    ...
                    if (invoiceError || !invoice) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invoice not found' }, { status: 404 })];
                    }
                    return [4 /*yield*/, nfeService.generateNFE({
                            clinic_id: validatedData.clinic_id,
                            invoice_id: validatedData.invoice_id,
                ...
                case 5:
                    _b = _c.sent(), data = _b.data, error = _b.error;
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to store NFE document' }, { status: 500 })];
                    }
                    if (!(validatedData.emit_immediately && !validatedData.test_mode)) return [3 /*break*/, 7];
                ...
                case 8:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'NFE generation failed' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'CNPJ validation failed' }, { status: 500 })];
