            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    switch (_a) {
                        ...
                        case 'download': return [3 /*break*/, 6];
                        case 'calendar': return [3 /*break*/, 8];
                        case 'compliance': return [3 /*break*/, 10];
                    }
                    return [3 /*break*/, 12];
                case 2: return [4 /*yield*/, listDeclarations(supabase, clinicId, searchParams)];
                case 3: return [2 /*return*/, _b.sent()];
                case 4: return [4 /*yield*/, getDeclarationStatus(supabase, searchParams)];
                case 5: return [2 /*return*/, _b.sent()];
                case 6: return [4 /*yield*/, downloadDeclaration(supabase, searchParams)];
                case 7: return [2 /*return*/, _b.sent()];
                case 8: return [4 /*yield*/, getDeclarationCalendar(supabase, clinicId)];
                case 9: return [2 /*return*/, _b.sent()];
                case 10: return [4 /*yield*/, getComplianceStatus(supabase, clinicId)];
                case 11: return [2 /*return*/, _b.sent()];
                case 12: return [4 /*yield*/, getDeclarationsOverview(supabase, clinicId)];
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    switch (_a) {
                        ...
                        case 'schedule': return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 11];
                case 3: return [4 /*yield*/, generateDeclaration(supabase, body)];
                case 4: return [2 /*return*/, _b.sent()];
                case 5: return [4 /*yield*/, validateDeclaration(supabase, body)];
                case 6: return [2 /*return*/, _b.sent()];
                case 7: return [4 /*yield*/, submitDeclaration(supabase, body)];
                case 8: return [2 /*return*/, _b.sent()];
                case 9: return [4 /*yield*/, scheduleDeclaration(supabase, body)];
                case 10: return [2 /*return*/, _b.sent()];
                case 11: return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid action specified' }, { status: 400 })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch declarations' }, { status: 500 })];
                    }
...
function getDeclarationStatus(supabase, searchParams) {
    return __awaiter(this, void 0, void 0, function () {
        var declarationId, _a, data, error, TaxDeclarationService, declarationService, updatedStatus, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    declarationId = searchParams.get('declaration_id');
                    if (!declarationId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'declaration_id parameter is required' }, { status: 400 })];
                    }
                ...
                case 1:
                    ...
                    if (error || !data) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Declaration not found' }, { status: 404 })];
                    }
                    if (!(data.status === 'submitted' && data.protocol_number)) return [3 /*break*/, 8];
                    _b.label = 2;
                case 2:
                    _b.trys.push([2, 7, , 8]);
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/services/tax/tax-declarations'); })];
                case 3:
                    TaxDeclarationService = (_b.sent()).TaxDeclarationService;
                    declarationService = new TaxDeclarationService();
                    return [4 /*yield*/, declarationService.checkSubmissionStatus(data.declaration_type, data.protocol_number)];
                case 4:
...
function downloadDeclaration(supabase, searchParams) {
    return __awaiter(this, void 0, void 0, function () {
        var declarationId, format, _a, declaration, error, TaxDeclarationService, declarationService, fileData, headers, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    declarationId = searchParams.get('declaration_id');
                ...
                case 4:
                    ...
                    headers.set('Content-Disposition', "attachment; filename=\"".concat(declaration.declaration_type, "_").concat(declaration.period_year, ".").concat(format, "\""));
                    return [2 /*return*/, new server_1.NextResponse(fileData, { headers: headers })];
                case 5:
                    error_4 = _b.sent();
                    console.error('Declaration download error:', error_4);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to download declaration' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    config = (_a.sent()).data;
                    if (!config) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Tax configuration not found' }, { status: 404 })];
                    }
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/services/tax/tax-declarations'); })];
                case 2:
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, declarationService.generateDeclarationCalendar(config.tax_regime, currentYear)];
                case 4:
                    calendar = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            data: {
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to generate declaration calendar' }, { status: 500 })];
                case 6: return [2 /*return*/];
            }
        });
    });
...
function getComplianceStatus(supabase, clinicId) {
    return __awaiter(this, void 0, void 0, function () {
        var currentYear, declarations, config, TaxDeclarationService, declarationService, compliance, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    currentYear = new Date().getFullYear();
                ...
                case 4:
                    TaxDeclarationService = (_a.sent()).TaxDeclarationService;
                    declarationService = new TaxDeclarationService();
                    return [4 /*yield*/, declarationService.assessCompliance(clinicId, config.tax_regime, currentYear)];
                case 5:
                    compliance = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            data: {
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to assess compliance' }, { status: 500 })];
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    summary = {
                        ...
                        by_type: (stats === null || stats === void 0 ? void 0 : stats.reduce(function (acc, decl) {
                            acc[decl.declaration_type] = (acc[decl.declaration_type] || 0) + 1;
                            return acc;
                        }, {})) || {},
                        by_status: (stats === null || stats === void 0 ? void 0 : stats.reduce(function (acc, decl) {
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            data: {
                                summary: summary,
                                recent_declarations: (stats === null || stats === void 0 ? void 0 : stats.slice(0, 10)) || []
                            }
                        })];
            }
        });
...
function generateDeclaration(supabase, body) {
    return __awaiter(this, void 0, void 0, function () {
        var validatedData, TaxDeclarationService, declarationService, declaration, _a, data, error, submission, submissionError_1, error_7;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 2:
                    TaxDeclarationService = (_b.sent()).TaxDeclarationService;
                    declarationService = new TaxDeclarationService();
                    return [4 /*yield*/, declarationService.generateDeclaration({
                ...
                case 4:
                    _a = _b.sent(), data = _a.data, error = _a.error;
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to store declaration' }, { status: 500 })];
                    }
                ...
                case 10:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Declaration generation failed', details: error_7.message }, { status: 500 })];
...
function validateDeclaration(supabase, body) {
    return __awaiter(this, void 0, void 0, function () {
        var validatedData, _a, declaration, error, TaxDeclarationService, declarationService, validation, error_8;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 3:
                    TaxDeclarationService = (_b.sent()).TaxDeclarationService;
                    declarationService = new TaxDeclarationService();
                    return [4 /*yield*/, declarationService.validateDeclaration(validatedData.declaration_id, {
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Declaration validation failed', details: error_8.message }, { status: 500 })];
                case 7: return [2 /*return*/];
            }
        });
    });
...
function submitDeclaration(supabase, body) {
    return __awaiter(this, void 0, void 0, function () {
        var declaration_id, _a, force_submit, _b, declaration, error, TaxDeclarationService, declarationService, submission, error_9;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    declaration_id = body.declaration_id, _a = body.force_submit, force_submit = _a === void 0 ? false : _a;
                    if (!declaration_id) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'declaration_id is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('tax_declarations')
                            .select('*')
                ...
                case 1:
                    ...
                    if (declaration.status === 'submitted' && !force_submit) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Declaration already submitted' }, { status: 400 })];
                    }
                    _c.label = 2;
                case 2:
                    _c.trys.push([2, 6, , 8]);
                ...
                case 7:
                    // Update status to error
                    _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Declaration submission failed', details: error_9.message }, { status: 500 })];
...
function scheduleDeclaration(supabase, body) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    clinic_id = body.clinic_id, declaration_type = body.declaration_type, period = body.period, schedule_date = body.schedule_date;
                    if (!clinic_id || !declaration_type || !period || !schedule_date) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'clinic_id, declaration_type, period, and schedule_date are required' }, { status: 400 })];
                    }
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                ...
                case 2:
                    _a = _b.sent(), data = _a.data, error = _a.error;
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to schedule declaration' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            data: {
                                schedule_id: data.id,
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Declaration scheduling failed', details: error_10.message }, { status: 500 })];
