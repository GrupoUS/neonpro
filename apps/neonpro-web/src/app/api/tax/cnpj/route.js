        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    _a = action;
                    switch (_a) {
                        case 'validate': return [3 /*break*/, 2];
                        case 'search': return [3 /*break*/, 4];
                        case 'history': return [3 /*break*/, 6];
                        case 'status': return [3 /*break*/, 8];
                    }
                    return [3 /*break*/, 10];
                case 2: return [4 /*yield*/, validateSingleCNPJ(supabase, searchParams)];
                case 3: return [2 /*return*/, _b.sent()];
                case 4: return [4 /*yield*/, searchCompanies(supabase, searchParams)];
                case 5: return [2 /*return*/, _b.sent()];
                case 6: return [4 /*yield*/, getValidationHistory(supabase, searchParams)];
                case 7: return [2 /*return*/, _b.sent()];
                case 8: return [4 /*yield*/, getCNPJStatus(supabase, searchParams)];
                case 9: return [2 /*return*/, _b.sent()];
                case 10: return [2 /*return*/, server_1.NextResponse.json({ error: 'Action parameter is required' }, { status: 400 })];
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    switch (_a) {
                        ...
                        case 'batch-validate': return [3 /*break*/, 5];
                        case 'search': return [3 /*break*/, 7];
                        case 'update-status': return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 11];
                case 3: return [4 /*yield*/, validateCNPJ(supabase, body)];
                case 4: return [2 /*return*/, _b.sent()];
                case 5: return [4 /*yield*/, batchValidateCNPJ(supabase, body)];
                case 6: return [2 /*return*/, _b.sent()];
                case 7: return [4 /*yield*/, searchCompaniesByData(supabase, body)];
                case 8: return [2 /*return*/, _b.sent()];
                case 9: return [4 /*yield*/, updateCNPJStatus(supabase, body)];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!cnpj) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'cnpj parameter is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/services/brazilian-tax/cnpj-validator'); })];
                case 1:
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'CNPJ validation failed', details: error_3.message }, { status: 500 })];
...
function searchCompanies(supabase, searchParams) {
    return __awaiter(this, void 0, void 0, function () {
        var companyName, activityCode, city, state, status, CNPJConsultationService, consultationService, searchParams_1, results, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!companyName && !activityCode && !city) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'At least one search parameter is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/services/brazilian-tax/cnpj-consultation'); })];
                case 1:
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Company search failed', details: error_4.message }, { status: 500 })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch validation history' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            data: data,
                            pagination: {
...
function getCNPJStatus(supabase, searchParams) {
    return __awaiter(this, void 0, void 0, function () {
        var cnpj, _a, latestValidation, error, validationAge, isRecent, currentStatus, CNPJValidator, validator, updatedValidation, updated, error_5;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    cnpj = searchParams.get('cnpj');
                ...
                case 1:
                    ...
                    if (error || !latestValidation) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'CNPJ validation not found' }, { status: 404 })];
                    }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    validation = _a.sent();
                    if (!(validatedData.store_result && validation.valid && validation.companyData)) return [3 /*break*/, 5];
                    return [4 /*yield*/, supabase
                            .from('cnpj_validations')
                            .upsert({
                            cnpj: validation.formatted,
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'CNPJ validation failed', details: error_6.message }, { status: 500 })];
                case 7: return [2 /*return*/];
            }
        });
    });
...
function batchValidateCNPJ(supabase, body) {
    return __awaiter(this, void 0, void 0, function () {
        var validatedData, CNPJValidator, validator, results, validationPromises, results_1, summary, error_7;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    validator = new CNPJValidator();
                    results = [];
                    validationPromises = validatedData.cnpjs.map(function (cnpj) { return __awaiter(_this, void 0, void 0, function () {
                ...
                case 3:
                    ...
                    summary = {
                        ...
                        valid_count: results_1.filter(function (r) { return r.valid; }).length,
                        invalid_count: results_1.filter(function (r) { return !r.valid; }).length,
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Batch validation failed', details: error_7.message }, { status: 500 })];
                case 5: return [2 /*return*/];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 5, , 6]);
                    return [4 /*yield*/, consultationService.searchCompanies({
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Company search failed', details: error_9.message }, { status: 500 })];
...
function updateCNPJStatus(supabase, body) {
    return __awaiter(this, void 0, void 0, function () {
        var cnpj, _a, force_update, existing, shouldUpdate, CNPJValidator, validator, validation, updated, error_10;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    cnpj = body.cnpj, _a = body.force_update, force_update = _a === void 0 ? false : _a;
                    if (!cnpj) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'cnpj is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('cnpj_validations')
                            .select('*')
                ...
                case 6: return [2 /*return*/, server_1.NextResponse.json({ error: 'CNPJ validation failed', details: validation.errors }, { status: 400 })];
                case 7: return [3 /*break*/, 9];
                case 8:
                    error_10 = _b.sent();
                    console.error('CNPJ status update error:', error_10);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'CNPJ status update failed', details: error_10.message }, { status: 500 })];
