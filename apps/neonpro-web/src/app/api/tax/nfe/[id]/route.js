...
function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, session, authError, id, _d, nfeDocument, fetchError, _e, clinic, clinicError, error_1;
...
function PATCH(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, session, authError, id, body, _d, existingNfe, fetchError, _e, clinic, clinicError, _f, updatedNfe, updateError, error_2;
        var params = _b.params;
...
function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, session, authError, id, _d, existingNfe, fetchError, _e, clinic, clinicError, deleteError, error_3;
        var params = _b.params;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                ...
                case 3:
                    ...
                    if (existingNfe.status !== 'draft') {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Only draft NFe documents can be deleted' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('nfe_documents')
                            .delete()
                ...
                case 4:
                    ...
                    if (deleteError) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to delete NFe document' }, { status: 500 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
