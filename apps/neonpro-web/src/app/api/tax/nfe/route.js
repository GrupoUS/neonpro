        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 10];
                case 2: return [4 /*yield*/, listNFEDocuments(supabase, clinicId, searchParams)];
                case 3: return [2 /*return*/, _b.sent()];
                case 4: return [4 /*yield*/, getNFEStatus(supabase, searchParams)];
                case 5: return [2 /*return*/, _b.sent()];
                case 6: return [4 /*yield*/, downloadNFE(supabase, searchParams)];
                case 7: return [2 /*return*/, _b.sent()];
                case 8: return [4 /*yield*/, validateNFE(supabase, searchParams)];
                case 9: return [2 /*return*/, _b.sent()];
                case 10: return [4 /*yield*/, getNFEOverview(supabase, clinicId)];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    _a = action;
                    switch (_a) {
                        case 'emit': return [3 /*break*/, 3];
                        case 'cancel': return [3 /*break*/, 5];
                        case 'reprocess': return [3 /*break*/, 7];
                        case 'batch-emit': return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 11];
                case 3: return [4 /*yield*/, emitNFE(supabase, body)];
                case 4: return [2 /*return*/, _b.sent()];
                case 5: return [4 /*yield*/, cancelNFE(supabase, body)];
                case 6: return [2 /*return*/, _b.sent()];
                case 7: return [4 /*yield*/, reprocessNFE(supabase, body)];
                case 8: return [2 /*return*/, _b.sent()];
                case 9: return [4 /*yield*/, batchEmitNFE(supabase, body)];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch NFE documents' }, { status: 500 })];
                    }
...
function getNFEStatus(supabase, searchParams) {
    return __awaiter(this, void 0, void 0, function () {
        var nfeId, chaveNfe, query, _a, data, error, NFEIntegrationService, nfeService, updatedStatus, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!nfeId && !chaveNfe) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'nfe_id or chave_nfe parameter is required' }, { status: 400 })];
                    }
                    query = supabase
                        .from('nfe_documents')
                        .select('*');
                ...
                case 1:
                    ...
                    if (error) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'NFE not found' }, { status: 404 })];
                    }
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/services/tax/nfe-service'); })];
                case 2:
                ...
                case 6: return [2 /*return*/, server_1.NextResponse.json({
                        data: __assign(__assign({}, data), { status: updatedStatus.status, latest_consultation: updatedStatus })
                    })];
                case 7:
                    error_3 = _b.sent();
...
function downloadNFE(supabase, searchParams) {
    return __awaiter(this, void 0, void 0, function () {
        var nfeId, format, _a, nfe, error, NFEIntegrationService, nfeService, fileData, headers, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    nfeId = searchParams.get('nfe_id');
                    ...
                    if (!nfeId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'nfe_id parameter is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('nfe_documents')
                            .select('*')
                ...
                case 4:
                    ...
                    headers.set('Content-Disposition', "attachment; filename=\"NFE_".concat(nfe.numero_nfe, ".").concat(format, "\""));
                    return [2 /*return*/, new server_1.NextResponse(fileData, { headers: headers })];
                case 5:
                    error_4 = _b.sent();
                    console.error('NFE download error:', error_4);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to download NFE' }, { status: 500 })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'NFE validation failed' }, { status: 500 })];
                case 6: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (statsError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to fetch NFE statistics' }, { status: 500 })];
                    }
                    summary = {
                        total_documents: stats.length,
                        total_value: stats.reduce(function (sum, doc) { return sum + doc.valor_total; }, 0),
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (nfe.status === 'emitted' && !validatedData.force_emission) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'NFE already emitted' }, { status: 400 })];
                    }
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/services/tax/nfe-service'); })];
                case 2:
                    NFEIntegrationService = (_b.sent()).NFEIntegrationService;
                ...
                case 7:
                    // Update status to error
                    _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'NFE emission failed', details: error_6.message }, { status: 500 })];
                case 8: return [2 /*return*/];
            }
        });
    });
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (nfe.status !== 'emitted') {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Only emitted NFEs can be cancelled' }, { status: 400 })];
                    }
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/services/tax/nfe-service'); })];
                case 2:
                    NFEIntegrationService = (_b.sent()).NFEIntegrationService;
                ...
                case 6:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'NFE cancellation failed', details: error_7.message }, { status: 500 })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    nfe_id = body.nfe_id;
                    if (!nfe_id) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'nfe_id is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('nfe_documents')
                            .select('*')
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'NFE reprocessing failed', details: error_8.message }, { status: 500 })];
                case 6: return [2 /*return*/];
            }
        });
    });
...
function batchEmitNFE(supabase, body) {
    return __awaiter(this, void 0, void 0, function () {
        var nfe_ids, _a, emit_options, NFEIntegrationService, nfeService, results, _i, nfe_ids_1, nfeId, emission, error_9, successful, failed;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    nfe_ids = body.nfe_ids, _a = body.emit_options, emit_options = _a === void 0 ? {} : _a;
                    if (!nfe_ids || !Array.isArray(nfe_ids)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'nfe_ids array is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@/lib/services/tax/nfe-service'); })];
                case 1:
                    NFEIntegrationService = (_b.sent()).NFEIntegrationService;
