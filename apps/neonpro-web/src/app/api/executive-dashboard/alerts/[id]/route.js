...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, alertId, action, alert_1, professional, updatedAlert, error_1, _d, _e, _f;
        var _g;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    ...
                    alertId = params.id;
                    if (!alertId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Alert ID is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, request.json()];
                case 3:
                    action = (_h.sent()).action;
                    if (!action || !['acknowledge', 'resolve'].includes(action)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid action. Must be "acknowledge" or "resolve"' }, { status: 400 })];
                    }
                ...
                case 5:
                    ...
                    return [4 /*yield*/, executive_dashboard_1.executiveDashboardService.acknowledgeAlert(alertId)];
                case 6:
                    updatedAlert = _h.sent();
                    return [3 /*break*/, 9];
                case 7:
                    if (!(action === 'resolve')) return [3 /*break*/, 9];
                    return [4 /*yield*/, executive_dashboard_1.executiveDashboardService.resolveAlert(alertId)];
                case 8:
                    updatedAlert = _h.sent();
                    _h.label = 9;
                ...
                case 10:
                    ...
                    _f = "Failed to ".concat;
                    return [4 /*yield*/, request.json()];
                case 11: return [2 /*return*/, _e.apply(_d, [(_g.error = _f.apply("Failed to ", [(_h.sent()).action, " alert"]),
