...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, clinicId, severity, professional, alerts, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, executive_dashboard_1.executiveDashboardService.getDashboardAlerts(clinicId, severity || undefined)];
                case 4:
                    alerts = _b.sent();
                ...
                case 5:
                    error_1 = _b.sent();
                    console.error('Alerts API error:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
