...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, clinicId, periodType, professional, dashboardData, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, executive_dashboard_1.executiveDashboardService.getDashboardData(clinicId, user.id, periodType)];
                case 4:
                ...
                case 5:
                    error_1 = _b.sent();
                    console.error('Executive dashboard API error:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
