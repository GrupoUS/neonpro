...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, clinicId, kpiName, periodType, professional, comparison, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    kpiName = searchParams.get('kpi_name');
                    periodType = searchParams.get('period_type') || 'monthly';
                    if (!clinicId || !kpiName) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'clinic_id and kpi_name parameters are required' }, { status: 400 })];
                    }
                ...
                case 3:
                    ...
                    return [4 /*yield*/, executive_dashboard_1.executiveDashboardService.getKPIComparison(clinicId, kpiName, periodType)];
                case 4:
                    comparison = _b.sent();
                ...
                case 5:
                    error_1 = _b.sent();
                    console.error('KPI comparison API error:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
