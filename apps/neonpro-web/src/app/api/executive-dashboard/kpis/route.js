...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, clinicId, periodType, kpiNames, customStart, customEnd, professional, kpis, error_1;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    periodType = searchParams.get('period_type') || 'monthly';
                    kpiNames = (_b = searchParams.get('kpi_names')) === null || _b === void 0 ? void 0 : _b.split(',');
                    customStart = searchParams.get('custom_start')
                        ? new Date(searchParams.get('custom_start'))
                        : undefined;
                    customEnd = searchParams.get('custom_end')
                ...
                case 3:
                    ...
                    return [4 /*yield*/, executive_dashboard_1.executiveDashboardService.getKPIValues(clinicId, periodType, kpiNames, customStart, customEnd)];
                case 4:
                    kpis = _c.sent();
                ...
                case 5:
                    error_1 = _c.sent();
                    console.error('KPI API error:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, kpiData, professional, kpi, error_2;
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!kpiData.clinic_id || !kpiData.kpi_name || !kpiData.kpi_value || !kpiData.period_type) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing required fields: clinic_id, kpi_name, kpi_value, period_type' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from('professionals')
                            .select('id')
                ...
                case 4:
                    ...
                    return [4 /*yield*/, executive_dashboard_1.executiveDashboardService.upsertKPIValue(kpiData)];
                case 5:
                    kpi = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 6:
                    error_2 = _b.sent();
                    console.error('KPI create/update API error:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({
