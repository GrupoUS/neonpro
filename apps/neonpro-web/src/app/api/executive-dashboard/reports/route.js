...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, searchParams, clinicId, limit, professional, reports, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, executive_dashboard_1.executiveDashboardService.getDashboardReports(clinicId, limit)];
                case 4:
                    reports = _b.sent();
                ...
                case 5:
                    error_1 = _b.sent();
                    console.error('Reports API error:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, user, authError, reportRequest, requiredFields, _i, requiredFields_1, field, professional, report, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 6, , 7]);
                ...
                case 3:
                    reportRequest = _b.sent();
                    requiredFields = ['clinic_id', 'report_name', 'report_type', 'period_type', 'period_start', 'period_end'];
                ...
                case 4:
                    ...
                    return [4 /*yield*/, executive_dashboard_1.executiveDashboardService.requestReport(reportRequest.clinic_id, reportRequest.report_name, reportRequest.report_type, reportRequest.period_type, new Date(reportRequest.period_start), new Date(reportRequest.period_end), reportRequest.format || 'pdf', reportRequest.parameters)];
                case 5:
                    report = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 6:
                    error_2 = _b.sent();
                    console.error('Report request API error:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({
