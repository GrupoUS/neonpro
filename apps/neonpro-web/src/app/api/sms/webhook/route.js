        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!provider) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: { code: 'MISSING_PROVIDER', message: 'Provider parameter required' } }, { status: 400 })];
                    }
                ...
                case 2:
                    ...
                    if (!isValid) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: { code: 'INVALID_SIGNATURE', message: 'Invalid webhook signature' } }, { status: 401 })];
                    }
        ...
        return __generator(this, function (_a) {
            ...
            try {
                switch (provider) {
                    ...
                    default:
                        console.warn("Webhook signature verification not implemented for provider: ".concat(provider));
