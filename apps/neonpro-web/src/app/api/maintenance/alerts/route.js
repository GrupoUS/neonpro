...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, clinicId, page, limit, filters, equipmentId, alertTypes, severities, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.getMaintenanceAlerts(clinicId, Object.keys(filters).length ? filters : undefined, { page: page, limit: limit })];
                case 1:
                    result = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.createMaintenanceAlert(validatedData)];
                case 2:
                    alert_1 = _a.sent();
                ...
                case 3:
                    ...
                    if (error_2 instanceof Error && error_2.message.includes('validation')) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid alert data', details: error_2.message }, { status: 400 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create maintenance alert' }, { status: 500 })];
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, alertId, action, body, result, acknowledged_by, notes, resolved_by, notes, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
                    ...
                    if (!alertId || !action) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'alert_id e action são obrigatórios' }, { status: 400 })];
                    }
                    return [4 /*yield*/, request.json()];
                case 1:
                    body = _a.sent();
                    ...
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.acknowledgeAlert(alertId, acknowledged_by, notes)];
                case 2:
                    result = _a.sent();
                    return [3 /*break*/, 6];
                case 3:
                    ...
                    if (!resolved_by || !notes) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'resolved_by e notes são obrigatórios para resolver alertas' }, { status: 400 })];
                    }
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.resolveAlert(alertId, resolved_by, notes)];
                case 4:
                    result = _a.sent();
                    return [3 /*break*/, 6];
                case 5: return [2 /*return*/, server_1.NextResponse.json({ error: 'action deve ser "acknowledge" ou "resolve"' }, { status: 400 })];
                case 6: return [2 /*return*/, server_1.NextResponse.json(result)];
                case 7:
                    error_3 = _a.sent();
                    console.error('Update Maintenance Alert Error:', error_3);
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update maintenance alert' }, { status: 500 })];
