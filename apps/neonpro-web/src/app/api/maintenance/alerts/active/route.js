...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, clinicId, filters, equipmentId, alertTypes, severities, alerts, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.getActiveAlerts(clinicId, Object.keys(filters).length ? filters : undefined)];
                case 1:
                    alerts = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(alerts)];
                case 2:
                    error_1 = _a.sent();
                    console.error('Active Alerts API Error:', error_1);
