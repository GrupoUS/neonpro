...
import type { createMaintenanceAlertSchema } from "@/app/lib/validations/maintenance";
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: "Failed to create maintenance alert" }, { status: 500 });
  }
}
