...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, clinicId, page, limit, filters, equipmentTypes, statuses, criticalityLevels, departments, locations, search, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.getClinicEquipment(clinicId, Object.keys(filters).length ? filters : undefined, { page: page, limit: limit })];
                case 1:
                    result = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.createEquipment(__assign(__assign({}, validatedData), { clinic_id: clinicId }))];
                case 2:
                    equipment = _a.sent();
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to create equipment' }, { status: 500 })];
