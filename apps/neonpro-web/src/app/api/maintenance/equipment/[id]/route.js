        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.getEquipment(params.id)];
                case 1:
                    equipment = _c.sent();
                    if (!equipment) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Equipment not found' }, { status: 404 })];
                    }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.updateEquipment(params.id, validatedData)];
                case 3:
                    equipment = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json(equipment)];
                case 4:
                    ...
                    if (error_2 instanceof Error && error_2.message.includes('validation')) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid equipment data', details: error_2.message }, { status: 400 })];
                    }
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to update equipment' }, { status: 500 })];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.updateEquipment(params.id, {
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to delete equipment' }, { status: 500 })];
