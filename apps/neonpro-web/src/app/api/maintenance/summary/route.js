        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, equipment_maintenance_service_1.equipmentMaintenanceService.getMaintenanceSummary(clinicId)];
                case 1:
                    summary = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(summary)];
                case 2:
                    error_1 = _a.sent();
                    console.error('Maintenance Summary API Error:', error_1);
