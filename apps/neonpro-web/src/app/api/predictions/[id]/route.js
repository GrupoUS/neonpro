...
function PATCH(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var supabase, _c, user, authError, id, body, _d, actual_outcome, accuracy_score, prediction, error_1;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    body = _e.sent();
                    _d = verifyPredictionSchema.parse(body), actual_outcome = _d.actual_outcome, accuracy_score = _d.accuracy_score;
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.verifyPrediction(id, actual_outcome, accuracy_score)];
                case 3:
                    prediction = _e.sent();
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Failed to verify prediction' }, { status: 500 })];
