        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.createProgressPrediction(validatedData)];
                case 4:
                    prediction = _b.sent();
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create progress prediction' }, { status: 500 })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, progress_tracking_1.progressTrackingService.getProgressPredictions(patientId)];
                case 3:
                    predictions = _b.sent();
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch progress predictions' }, { status: 500 })];
