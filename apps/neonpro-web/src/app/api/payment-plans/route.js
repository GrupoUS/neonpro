...
var querySchema = zod_1.z.object({
    ...
    frequency: zod_1.z.enum(['weekly', 'biweekly', 'monthly', 'quarterly']).optional(),
    sortBy: zod_1.z.enum(['created_at', 'start_date', 'total_amount', 'status']).optional().default('created_at'),
...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, url, queryParams, validatedQuery, page, limit, status_1, customerId, frequency, sortBy, sortOrder, installmentManager, filters, result, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    page = validatedQuery.page, limit = validatedQuery.limit, status_1 = validatedQuery.status, customerId = validatedQuery.customerId, frequency = validatedQuery.frequency, sortBy = validatedQuery.sortBy, sortOrder = validatedQuery.sortOrder;
                    ...
                    return [4 /*yield*/, installmentManager.getPaymentPlans({
                            page: page,
                            limit: limit,
                            filters: filters,
                            sortBy: sortBy,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, validatedData, installmentManager, paymentPlan, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 5, , 6]);
                ...
                case 3:
                    ...
                    installmentManager = (0, installment_manager_1.getInstallmentManager)();
                    return [4 /*yield*/, installmentManager.createPaymentPlan({
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, action, paymentPlanIds, updateData_1, installmentManager_1, results, _b, validatedUpdateData_1, error_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    body = _c.sent();
                    action = body.action, paymentPlanIds = body.paymentPlanIds, updateData_1 = body.data;
                    if (!action || !paymentPlanIds || !Array.isArray(paymentPlanIds)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid request: action and paymentPlanIds are required' }, { status: 400 })];
                    }
                    ...
                    return [3 /*break*/, 8];
                case 4: return [4 /*yield*/, Promise.all(paymentPlanIds.map(function (id) {
                        return installmentManager_1.cancelPaymentPlan(id, updateData_1 === null || updateData_1 === void 0 ? void 0 : updateData_1.reason);
                    }))];
                case 5:
                    results = _c.sent();
                    return [3 /*break*/, 9];
                case 6:
                    if (!updateData_1) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Update data is required for update action' }, { status: 400 })];
                    }
                    validatedUpdateData_1 = updatePaymentPlanSchema.parse(updateData_1);
                    return [4 /*yield*/, Promise.all(paymentPlanIds.map(function (id) {
                            return installmentManager_1.modifyPaymentPlan(id, validatedUpdateData_1);
                        }))];
                case 7:
                    results = _c.sent();
                    return [3 /*break*/, 9];
                case 8: return [2 /*return*/, server_1.NextResponse.json({ error: 'Invalid action. Supported actions: cancel, update' }, { status: 400 })];
...
function DELETE(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, paymentPlanIds, reason_1, installmentManager_2, results, successful, failed, error_4;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 3:
                    ...
                    if (!paymentPlanIds || !Array.isArray(paymentPlanIds)) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'paymentPlanIds array is required' }, { status: 400 })];
                    }
                    installmentManager_2 = (0, installment_manager_1.getInstallmentManager)();
                    return [4 /*yield*/, Promise.all(paymentPlanIds.map(function (id) { return __awaiter(_this, void 0, void 0, function () {
                            var error_5;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, installmentManager_2.cancelPaymentPlan(id, reason_1 || 'Bulk deletion')];
                                    case 1:
                                        _a.sent();
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({
                            ...
                            message: "Bulk deletion completed: ".concat(successful, " successful, ").concat(failed, " failed")
                        })];
                case 5:
                    error_4 = _b.sent();
