      ...
      switch (_d.label) {
        ...
        case 2:
          ...
          if (!paymentPlan) {
            return [
              2 /*return*/,
              server_1.NextResponse.json({ error: "Payment plan not found" }, { status: 404 }),
            ];
          }
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            installmentManager.modifyPaymentPlan(
              id,
    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 2:
          ...
          return [3 /*break*/, 11];
        case 3:
          return [4 /*yield*/, installmentManager.regenerateInstallments(id)];
        case 4:
          // Regenerate installments for the payment plan
          result = _e.sent();
          return [3 /*break*/, 12];
        case 5:
          return [4 /*yield*/, installmentManager.recalculateInstallmentAmounts(id)];
        case 6:
        ...
        case 7:
          reason =
            (data === null || data === void 0 ? void 0 : data.reason) || "Marked as defaulted";
          return [4 /*yield*/, installmentManager.markAsDefaulted(id, reason)];
        case 8:
          result = _e.sent();
          return [3 /*break*/, 12];
        case 9:
          return [4 /*yield*/, installmentManager.reactivatePaymentPlan(id)];
        case 10:
        ...
        case 13:
          ...
          if (error_4 instanceof Error) {
            ...
            if (error_4.message.includes("Invalid action for current status")) {
              return [
                2 /*return*/,
                server_1.NextResponse.json({ error: error_4.message }, { status: 400 }),
              ];
            }
          }
          return [
