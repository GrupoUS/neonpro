...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, user, profile, _a, serviceTypes, error, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    _a = _b.sent(), serviceTypes = _a.data, error = _a.error;
                    if (error) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: error.message }, { status: 500 })];
                    }
                    return [2 /*return*/, server_2.NextResponse.json(serviceTypes)];
                case 5:
                    error_1 = _b.sent();
