...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, filters, outcomes, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, treatment_followup_service_1.createtreatmentFollowupService)().getTreatmentOutcomes(filters)];
                case 1:
                    outcomes = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    body = _a.sent();
                    validatedData = followup_1.createTreatmentOutcomeSchema.parse(body);
                    return [4 /*yield*/, (0, treatment_followup_service_1.createtreatmentFollowupService)().createTreatmentOutcome(validatedData)];
                case 2:
                    outcome = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
