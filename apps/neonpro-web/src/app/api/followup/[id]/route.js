    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            treatment_followup_service_1.treatmentFollowupService.getPatientFollowupById(params.id),
          ];
        case 1:
          followup = _c.sent();
          if (!followup) {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            treatment_followup_service_1.treatmentFollowupService.updatePatientFollowup(
              params.id,
              validatedData,
            ),
          ];
