...
var followup_1 = require("@/app/lib/validations/followup");
    ...
    return __awaiter(this, arguments, void 0, function (request, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, treatment_followup_service_1.treatmentFollowupService.getFollowupProtocolById(params.id)];
                case 1:
                    protocol = _c.sent();
                    if (!protocol) {
                ...
                case 2:
                    error_1 = _c.sent();
                    console.error('Error fetching follow-up protocol:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
...
function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var body, updateSchema, validatedData, protocol, error_2;
        var params = _b.params;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 1:
                    body = _c.sent();
                    updateSchema = followup_1.createFollowupProtocolSchema.partial();
                    validatedData = updateSchema.parse(body);
                    return [4 /*yield*/, treatment_followup_service_1.treatmentFollowupService.updateFollowupProtocol(params.id, validatedData)];
                case 2:
                    protocol = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 3:
                    ...
                    console.error('Error updating follow-up protocol:', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
    ...
    return __awaiter(this, arguments, void 0, function (request, _b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, treatment_followup_service_1.treatmentFollowupService.deleteFollowupProtocol(params.id)];
                case 1:
                    _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: true,
                ...
                case 2:
                    error_3 = _c.sent();
                    console.error('Error deleting follow-up protocol:', error_3);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
