    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            treatment_followup_service_1.treatmentFollowupService.getFollowupProtocolById(
              params.id,
            ),
          ];
        case 1:
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            treatment_followup_service_1.treatmentFollowupService.updateFollowupProtocol(
              params.id,
              validatedData,
            ),
          ];
    ...
    return __generator(this, (_c) => {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            treatment_followup_service_1.treatmentFollowupService.deleteFollowupProtocol(params.id),
          ];
        case 1:
          _c.sent();
          return [
