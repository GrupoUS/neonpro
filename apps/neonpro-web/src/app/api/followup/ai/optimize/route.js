      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            (0,
            treatment_followup_service_1.createtreatmentFollowupService)().calculateOptimalTiming(
              patientId,
            ),
          ];
        case 2:
          ...
          return [
            4 /*yield*/,
            (0,
            treatment_followup_service_1.createtreatmentFollowupService)().generatePersonalizedMessage(
              patientId,
              protocolId,
              channel,
            ),
          ...
          return [
            ...
            server_1.NextResponse.json({
              ...
              data: {
                ...
                recommendations: {
                  bestTimeToSend: "".concat(
                    optimalTiming.optimal_hour.toString().padStart(2, "0"),
                    ":00",
                  ),
