...
export async function GET(request: NextRequest) {
  try {
    ...
    const photoPairs =
      await createautomatedBeforeAfterAnalysisService().getPhotoPairs(validatedFilters);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const photoPair =
      await createautomatedBeforeAfterAnalysisService().createPhotoPair(validatedData);
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updatedPhotoPair = await createautomatedBeforeAfterAnalysisService().updatePhotoPair(
      id,
      validatedUpdates,
    );
