        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    validatedFilters = automated_before_after_analysis_2.validationSchemas.analysisSessionFilters.parse(filters);
                    return [4 /*yield*/, (0, automated_before_after_analysis_1.createautomatedBeforeAfterAnalysisService)().getAnalysisSessions(validatedFilters)];
                case 3:
                    sessions = _a.sent();
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to fetch analysis sessions', details: error_1 instanceof Error ? error_1.message : 'Unknown error' }, { status: 500 })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    body = _a.sent();
                    validatedData = automated_before_after_analysis_2.validationSchemas.createAnalysisSession.parse(body);
                    return [4 /*yield*/, (0, automated_before_after_analysis_1.createautomatedBeforeAfterAnalysisService)().createAnalysisSession(validatedData)];
                case 4:
                    session = _a.sent();
                    return [2 /*return*/, server_2.NextResponse.json({
                            success: true,
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to create analysis session', details: error_2 instanceof Error ? error_2.message : 'Unknown error' }, { status: 500 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    validatedUpdates = automated_before_after_analysis_2.validationSchemas.updateAnalysisSession.parse(updates);
                    return [4 /*yield*/, (0, automated_before_after_analysis_1.createautomatedBeforeAfterAnalysisService)().updateAnalysisSession(id, validatedUpdates)];
                case 4:
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to update analysis session', details: error_3 instanceof Error ? error_3.message : 'Unknown error' }, { status: 500 })];
                case 6: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, automated_before_after_analysis_1.createautomatedBeforeAfterAnalysisService)().deleteAnalysisSession(id)];
                case 3:
                    _a.sent();
                    return [2 /*return*/, server_2.NextResponse.json({
                            success: true,
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to delete analysis session', details: error_4 instanceof Error ? error_4.message : 'Unknown error' }, { status: 500 })];
                case 5: return [2 /*return*/];
            }
        });
    });
