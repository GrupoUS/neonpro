...
export async function GET(request: NextRequest) {
  try {
    ...
    const sessions =
      await createautomatedBeforeAfterAnalysisService().getAnalysisSessions(validatedFilters);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const session =
      await createautomatedBeforeAfterAnalysisService().createAnalysisSession(validatedData);
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updatedSession = await createautomatedBeforeAfterAnalysisService().updateAnalysisSession(
      id,
      validatedUpdates,
    );
