  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 4:
          validatedData =
            automated_before_after_analysis_2.validationSchemas.startAnalysis.parse(data);
          return [
            4 /*yield*/,
            (0,
            automated_before_after_analysis_1.createautomatedBeforeAfterAnalysisService)().startAnalysis(
              validatedData,
            ),
          ];
        case 5:
        ...
        case 6:
          validatedData =
            automated_before_after_analysis_2.validationSchemas.comparisonAnalysis.parse(data);
          return [
            4 /*yield*/,
            (0,
            automated_before_after_analysis_1.createautomatedBeforeAfterAnalysisService)().performComparisonAnalysis(
              validatedData,
            ),
          ];
        case 7:
        ...
        case 8:
          validatedData =
            automated_before_after_analysis_2.validationSchemas.batchAnalysis.parse(data);
          return [
            4 /*yield*/,
            (0,
            automated_before_after_analysis_1.createautomatedBeforeAfterAnalysisService)().batchAnalysis(
              validatedData,
            ),
          ];
        case 9:
        ...
        case 10:
          return [
            2 /*return*/,
            server_2.NextResponse.json({ error: "Invalid action specified" }, { status: 400 }),
          ];
        case 11:
          return [3 /*break*/, 13];
        case 12:
      ...
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            (0,
            automated_before_after_analysis_1.createautomatedBeforeAfterAnalysisService)().getAnalysisProgress(
              sessionId,
            ),
          ];
        case 3:
