        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    id = params.id;
                    if (!id) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Follow-up ID is required' }, { status: 400 })];
                    }
                    return [4 /*yield*/, treatment_followup_service_1.treatmentFollowupService.getFollowupById(id)];
                case 3:
                    followup = _d.sent();
                    if (!followup) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Follow-up not found' }, { status: 404 })];
                    }
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, treatment_followup_service_1.treatmentFollowupService.updateFollowup(id, updates)];
                case 4:
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    // Delete follow-up
                    return [4 /*yield*/, treatment_followup_service_1.treatmentFollowupService.deleteFollowup(id)];
                case 3:
                    // Delete follow-up
                    _d.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                ...
                case 4:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Internal server error', message: error_3 instanceof Error ? error_3.message : 'Unknown error' }, { status: 500 })];
                case 5: return [2 /*return*/];
            }
        });
    });
