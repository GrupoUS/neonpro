            ...
            switch (_e.label) {
                ...
                case 2:
                    ...
                    if (searchParams.get('treatment_type')) {
                        filters.treatment_type = (_b = searchParams.get('treatment_type')) === null || _b === void 0 ? void 0 : _b.split(',');
                    }
                    ...
                    return [4 /*yield*/, (0, treatment_followup_service_1.createtreatmentFollowupService)().getTemplates(filters)];
                case 3:
                    templates = _e.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, session, authError, body, requiredFields, _i, requiredFields_1, field, templateData, newTemplate, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    body = _b.sent();
                    requiredFields = ['clinic_id', 'name', 'treatment_type', 'followup_type', 'communication_method', 'message_template'];
                    ...
                    return [4 /*yield*/, (0, treatment_followup_service_1.createtreatmentFollowupService)().createTemplate(templateData)];
                case 4:
                    newTemplate = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                            data: newTemplate,
