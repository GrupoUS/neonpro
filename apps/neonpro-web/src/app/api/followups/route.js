      ...
      switch (_f.label) {
        ...
        case 2:
          ...
          if (searchParams.get("priority")) {
            filters.priority =
              (_e = searchParams.get("priority")) === null || _e === void 0
                ? void 0
                : _e.split(",");
          }
          ...
          return [
            4 /*yield*/,
            (0, treatment_followup_service_1.createtreatmentFollowupService)().getFollowups(
              filters,
            ),
          ];
        case 3:
    ...
    return __generator(this, (_b) => {
      switch (_b.label) {
        ...
        case 3:
          ...
          followupData = __assign(__assign({}, body), {
            scheduled_date: new Date(body.scheduled_date),
            created_by: session.user.id,
          });
          return [
            4 /*yield*/,
            (0, treatment_followup_service_1.createtreatmentFollowupService)().createFollowup(
              followupData,
            ),
          ];
        case 4:
