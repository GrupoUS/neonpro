...
export const AppointmentOutcome = z.enum(["attended", "no_show", "cancelled", "rescheduled"]);

export const InterventionOutcome = z.enum(["successful", "failed", "no_response"]);
...
export const NoShowDashboardStatsSchema = z.object({
  today: z.object({
