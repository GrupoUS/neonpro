...
exports.EmailSettingsSchema = exports.EmailProviderConfigSchema = exports.EmailCampaignSchema = exports.EmailMessageSchema = exports.EmailTemplateSchema = exports.EmailAttachmentSchema = exports.EmailRecipientSchema = void 0;
...
exports.EmailMessageSchema = zod_1.z.object({
    to: zod_1.z.array(exports.EmailRecipientSchema).min(1, 'Pelo menos um destinatário é obrigatório'),
...
exports.EmailCampaignSchema = zod_1.z.object({
    ...
    recipients: zod_1.z.array(exports.EmailRecipientSchema).min(1, 'Pelo menos um destinatário é obrigatório'),
    scheduledAt: zod_1.z.date().optional(),
