...
exports.RiskFactorAnalysisSchema = exports.NoShowDashboardStatsSchema = exports.NoShowTrendsSchema = exports.ModelPerformanceSchema = exports.PredictionAnalysisSchema = exports.UpdateInterventionInputSchema = exports.CreateInterventionInputSchema = exports.CreateRiskFactorInputSchema = exports.UpdatePredictionInputSchema = exports.CreatePredictionInputSchema = exports.NoShowAnalyticsSchema = exports.InterventionStrategySchema = exports.RiskFactorSchema = exports.NoShowPredictionSchema = exports.InterventionOutcome = exports.AppointmentOutcome = exports.InterventionType = exports.RiskFactorType = void 0;
...
exports.AppointmentOutcome = zod_1.z.enum([
    'attended',
    'no_show',
    'cancelled',
    'rescheduled'
]);
exports.InterventionOutcome = zod_1.z.enum([
    'successful',
    'failed',
    'no_response'
]);
...
exports.NoShowTrendsSchema = zod_1.z.object({
    ...
    trends_by_factor: zod_1.z.record(zod_1.z.object({
    ...
    intervention_effectiveness: zod_1.z.record(zod_1.z.object({
