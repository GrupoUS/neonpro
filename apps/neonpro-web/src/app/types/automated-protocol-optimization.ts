...
export interface ProtocolExperiment {
  id: string;
...
export interface CreateProtocolOutcomeRequest {
  protocol_version_id: string;
  patient_id: string;
  treatment_id?: string;
  outcome_data: Record<string, any>;
...
export interface CreateProtocolExperimentRequest {
  experiment_name: string;
  description?: string;
  control_protocol_id?: string;
  test_protocol_id?: string;
...
export interface ProtocolPerformanceReport {
  protocol_version_id: string;
  reporting_period: {
    start: string;
    end: string;
...
export interface ProtocolExperimentResults {
...
export interface ProtocolOptimizationQueue {
...
export interface ProtocolApiResponse<T> {
  data: T;
  success: boolean;
  message?: string;
  pagination?: {
