// Types for Automated Reorder Alerts and Threshold Management
...
export interface UpdateReorderThresholdRequest extends Partial<CreateReorderThresholdRequest> {
  id: string;
}
