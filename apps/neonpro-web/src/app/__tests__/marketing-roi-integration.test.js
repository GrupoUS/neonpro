        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                roiService.calculateCampaignROI(
                  "test-campaign",
                  "test-clinic",
                  new Date(),
                  new Date(),
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                roiService.analyzeTreatmentProfitability("test-clinic", new Date(), new Date()),
              ];
            case 1:
              analysis = _a.sent();
              expect(analysis).toBeDefined();
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                roiService.generateROIForecast("test-clinic", "test-campaign", 90),
              ];
            case 1:
              forecast = _a.sent();
