...
// =====================================================================================
var QUERY_KEYS = {
    followups: function (filters) { return ['followups', filters]; },
    followup: function (id) { return ['followups', id]; },
    templates: function (filters) { return ['followup-templates', filters]; },
    template: function (id) { return ['followup-templates', id]; },
    protocols: function (filters) { return ['treatment-protocols', filters]; },
    protocol: function (id) { return ['treatment-protocols', id]; },
    analytics: function (clinicId, dateFrom, dateTo) { return ['followup-analytics', clinicId, dateFrom, dateTo]; },
    dashboardSummary: function (clinicId) { return ['followup-dashboard', clinicId]; }
};
// =====================================================================================
// FOLLOW-UP HOOKS
// =====================================================================================
...
function useFollowups(filters) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return treatment_followup_service_1.treatmentFollowupService.getFollowups(filters); },
...
function useFollowup(id) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return treatment_followup_service_1.treatmentFollowupService.getFollowupById(id); },
        enabled: !!id,
        staleTime: 1000 * 60 * 5,
...
function useCreateFollowup() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (data) { return treatment_followup_service_1.treatmentFollowupService.createFollowup(data); },
...
function useDeleteFollowup() {
    var queryClient = (0, react_query_1.useQueryClient)();
    return (0, react_query_1.useMutation)({
        mutationFn: function (id) { return treatment_followup_service_1.treatmentFollowupService.deleteFollowup(id); },
...
function useFollowupTemplates(filters) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return treatment_followup_service_1.treatmentFollowupService.getTemplates(filters); },
...
function useCreateFollowupTemplate() {
    var queryClient = (0, react_query_1.useQueryClient)();
    return (0, react_query_1.useMutation)({
        mutationFn: function (data) { return treatment_followup_service_1.treatmentFollowupService.createTemplate(data); },
...
function useTreatmentProtocols(filters) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return treatment_followup_service_1.treatmentFollowupService.getProtocols(filters); },
...
function useCreateTreatmentProtocol() {
    var queryClient = (0, react_query_1.useQueryClient)();
    return (0, react_query_1.useMutation)({
        mutationFn: function (data) { return treatment_followup_service_1.treatmentFollowupService.createProtocol(data); },
...
function useFollowupAnalytics(clinicId, dateFrom, dateTo) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return treatment_followup_service_1.treatmentFollowupService.getAnalytics(clinicId, dateFrom, dateTo); },
        enabled: !!clinicId,
        staleTime: 1000 * 60 * 5, // 5 minutes
...
function useFollowupDashboardSummary(clinicId) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return treatment_followup_service_1.treatmentFollowupService.getDashboardSummary(clinicId); },
        enabled: !!clinicId,
