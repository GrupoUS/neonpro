...
export function useSupplierManagement({
  ...
  const loadContacts = useCallback(async (supplierId: string) => {
    await handleApiCall(
      async () => {
  ...
  const loadEvaluations = useCallback(async (supplierId: string) => {
    await handleApiCall(
      async () => {
  ...
  const updateQualityIssue = useCallback(async (issueId: string, updates: any) => {
    return await handleApiCall(
      async () => {
  ...
  const loadCommunications = useCallback(async (supplierId: string) => {
    await handleApiCall(
      async () => {
