...
function useBarcodeGeneration() {
    ...
    var generateBarcode = (0, react_query_1.useMutation)({
        mutationFn: function (options) { return __awaiter(_this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, barcode_service_1.barcodeService.generateBarcode(options)];
                    case 1:
                        result = _a.sent();
                        if (!result.success) {
...
function useBarcodeScanner() {
    ...
    var _b = (0, react_1.useState)([]), scanHistory = _b[0], setScanHistory = _b[1];
    var _c = (0, react_1.useState)(null), lastScanResult = _c[0], setLastScanResult = _c[1];
    var scanBarcode = (0, react_1.useCallback)(function (options) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    setScanHistory(function (prev) { return __spreadArray([result_1], prev.slice(0, 19), true); }); // Keep last 20 scans
                    if (result_1.success) {
                        sonner_1.toast.success("Item escaneado: ".concat((_a = result_1.data) === null || _a === void 0 ? void 0 : _a.item_name));
                    }
                    else {
...
function useBulkScanning() {
    var _this = this;
    var _a = (0, react_1.useState)(null), activeOperation = _a[0], setActiveOperation = _a[1];
    var _b = (0, react_1.useState)(0), operationProgress = _b[0], setOperationProgress = _b[1];
    var startBulkOperation = (0, react_query_1.useMutation)({
        mutationFn: function (options) { return __awaiter(_this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, barcode_service_1.barcodeService.startBulkScanOperation(options)];
                    case 1:
                        result = _a.sent();
                        if (!result.success) {
                            throw new Error(result.error);
    ...
    var processBulkScan = (0, react_1.useCallback)(function (operationId, scanValue, userId) { return __awaiter(_this, void 0, void 0, function () {
        var result, newProgress, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, barcode_service_1.barcodeService.processBulkScan(operationId, scanValue, userId)
                        // Update progress
                    ];
                case 1:
                    result = _a.sent();
                    // Update progress
                    if (activeOperation) {
                        newProgress = ((activeOperation.scanned_items + 1) / activeOperation.total_items) * 100;
...
function useBarcodeData(itemId) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return barcode_service_1.barcodeService.getBarcodeData(itemId); },
        enabled: !!itemId
    });
}
...
function useCameraScanner() {
    ...
    var startCamera = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
...
function useBarcodeValidation() {
    ...
    var validateBarcodeAsync = (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var result;
            var barcode = _b.barcode, type = _b.type;
...
function useQRCodeManager() {
    var _this = this;
    var _a = (0, react_1.useState)(null), qrData = _a[0], setQrData = _a[1];
    var _b = (0, react_1.useState)(''), qrCode = _b[0], setQrCode = _b[1];
    var generateQRCode = (0, react_1.useCallback)(function (data) { return __awaiter(_this, void 0, void 0, function () {
        var qrString;
        return __generator(this, function (_a) {
            try {
...
function useLabelPrinting() {
    var _this = this;
    var _a = (0, react_1.useState)(false), isPrinting = _a[0], setIsPrinting = _a[1];
    var printLabel = (0, react_1.useCallback)(function (options) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            try {
                ...
                sonner_1.toast.success("Etiqueta enviada para impress\u00E3o (".concat(options.copies || 1, " c\u00F3pia(s))"));
            }
            catch (error) {
                console.error('Erro na impressão:', error);
                sonner_1.toast.error("Falha na impress\u00E3o: ".concat(error instanceof Error ? error.message : 'Erro desconhecido'));
            }
            finally {
                setIsPrinting(false);
            }
...
function createLabelHTML(options) {
    ...
    for (var i = 0; i < copies; i++) {
        labelsHTML += "\n      <div class=\"label\" style=\"\n        width: 4in; \n        height: 2in; \n        border: 1px solid #000; \n        padding: 10px; \n        margin-bottom: 10px;\n        page-break-after: always;\n        font-family: Arial, sans-serif;\n        display: flex;\n        flex-direction: column;\n        justify-content: space-between;\n      \">\n        <div style=\"text-align: center;\">\n          <h3 style=\"margin: 0; font-size: 14px;\">".concat(options.item_name, "</h3>\n          <div style=\"font-size: 24px; font-family: monospace; margin: 5px 0;\">\n            ").concat(options.barcode, "\n          </div>\n        </div>\n        \n        <div style=\"display: flex; justify-content: space-between; font-size: 10px;\">\n          <div>\n            ").concat(options.batch_number ? "Lote: ".concat(options.batch_number) : '', "\n          </div>\n          <div>\n            ").concat(options.expiration_date ? "Exp: ".concat(options.expiration_date) : '', "\n          </div>\n        </div>\n        \n        ").concat(options.qr_code ? "\n          <div style=\"text-align: center; margin-top: 5px;\">\n            <div style=\"font-size: 8px; background: #000; color: #fff; padding: 2px;\">\n              QR: ".concat(options.qr_code.substring(0, 20), "...\n            </div>\n          </div>\n        ") : '', "\n      </div>\n    ");
    }
