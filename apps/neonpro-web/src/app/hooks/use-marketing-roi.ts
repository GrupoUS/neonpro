 ...
 */
export function useTreatmentProfitabilityAnalysis(clinicId: string, filters?: TreatmentROIFilters) {
  return useQuery({
 ...
 */
export function useCACLTVAnalysis(clinicId: string, periodStart: Date, periodEnd: Date) {
  return useQuery({
 ...
 */
export function useROIMetricsSummary(clinicId: string, periodStart: Date, periodEnd: Date) {
  return useQuery({
