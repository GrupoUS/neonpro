...
var QUERY_KEYS = {
    ...
    report: function (params) { return __spreadArray(__spreadArray([], QUERY_KEYS.reports, true), ['generate', params], false); },
...
function generateReport(parameters) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('/api/inventory/reports/generate', {
                        method: 'POST',
                        headers: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("/api/inventory/reports/generate?".concat(searchParams.toString()))];
                case 1:
                    response = _a.sent();
                    if (!!response.ok) return [3 /*break*/, 3];
                    return [4 /*yield*/, response.json()];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("/api/inventory/reports/definitions?".concat(searchParams.toString()))];
                case 1:
                    response = _a.sent();
                    if (!!response.ok) return [3 /*break*/, 3];
                    return [4 /*yield*/, response.json()];
...
function createReportDefinition(definition) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('/api/inventory/reports/definitions', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
...
function fetchDashboardStats() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('/api/inventory/reports/dashboard')];
                case 1:
                    response = _a.sent();
                    if (!!response.ok) return [3 /*break*/, 3];
                    return [4 /*yield*/, response.json()];
...
function useStockMovementReport(filters, options) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return generateReport(parameters); },
...
function useReportDefinitions(filters) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return fetchReportDefinitions(filters); },
...
function useReportFilters() {
    ...
    var buildMonthFilter = (0, react_1.useCallback)(function (monthsBack) {
        if (monthsBack === void 0) { monthsBack = 0; }
        var endDate = new Date();
    ...
    var buildYearFilter = (0, react_1.useCallback)(function (yearsBack) {
        if (yearsBack === void 0) { yearsBack = 0; }
...
function useReportExport() {
    var _this = this;
    var exportToCSV = (0, react_1.useCallback)(function (type, filters, filename) { return __awaiter(_this, void 0, void 0, function () {
...
function useInventoryAnalytics(filters) {
    ...
    var analytics = (0, react_1.useMemo)(function () {
        ...
        return {
            overview: {
                ...
                lowStockItems: ((_a = lowStock.data) === null || _a === void 0 ? void 0 : _a.summary.total_low_stock_items) || 0,
                expiringItems: ((_b = expiringItems.data) === null || _b === void 0 ? void 0 : _b.summary.total_expiring_items) || 0,
                activeTransfers: ((_c = transfers.data) === null || _c === void 0 ? void 0 : _c.summary.pending_transfers) || 0,
            },
            performance: {
                averageTurnover: ((_d = locationPerformance.data) === null || _d === void 0 ? void 0 : _d.summary.average_turnover_rate) || 0,
                bestLocation: ((_e = locationPerformance.data) === null || _e === void 0 ? void 0 : _e.summary.best_performing_location) || '',
                systemEfficiency: ((_f = locationPerformance.data) === null || _f === void 0 ? void 0 : _f.summary.average_performance_score) || 0,
            },
            trends: {
    ...
    var isLoading = stockValuation.isLoading ||
        stockMovement.isLoading ||
        lowStock.isLoading ||
        expiringItems.isLoading ||
        transfers.isLoading ||
        locationPerformance.isLoading;
    var error = stockValuation.error ||
        stockMovement.error ||
        lowStock.error ||
        expiringItems.error ||
        transfers.error ||
        locationPerformance.error;
    var refetchAll = (0, react_1.useCallback)(function () {
