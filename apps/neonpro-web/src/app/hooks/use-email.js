...
function useEmailTemplate(id) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/email/templates/".concat(id))];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
...
function useCreateEmailTemplate() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (template) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/templates', {
                            method: 'POST',
...
function useSendEmail() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (message) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/send', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
...
function useSendBulkEmail() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response;
            var messages = _b.messages, _c = _b.batchSize, batchSize = _c === void 0 ? 10 : _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/bulk', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
        ...
        onSuccess: function (result) {
            if (result.success) {
                toast({
                    ...
                    description: "".concat(result.totalSent, " emails enviados com sucesso. ").concat(result.totalFailed, " falharam."),
                });
            }
            else {
                toast({
...
function useEmailPreview() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response;
            var templateId = _b.templateId, variables = _b.variables;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/preview', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
...
function useValidateEmail() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (email) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/validate', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
...
function useEmailDeliveryReport(messageId) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/email/delivery/".concat(messageId))];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            if (response.status === 404)
...
function useEmailSettings() {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/settings')];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            if (response.status === 404)
...
function useUpdateEmailSettings() {
    ...
    var toast = (0, use_toast_1.useToast)().toast;
    return (0, react_query_1.useMutation)({
        mutationFn: function (settings) { return __awaiter(_this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/settings', {
...
function useEmailProviders() {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/providers')];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
...
function useCreateEmailProvider() {
    ...
    var toast = (0, use_toast_1.useToast)().toast;
    return (0, react_query_1.useMutation)({
        mutationFn: function (provider) { return __awaiter(_this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/providers', {
...
function useUpdateEmailProvider() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch("/api/email/providers/".concat(id), {
                            method: 'PATCH',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify(updates),
                        })];
...
function useTestEmailProvider() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/email/providers/".concat(id, "/test"), {
                            method: 'POST',
                        })];
                    case 1:
                        response = _a.sent();
...
function useEmailSuppressions() {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/suppressions')];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
...
function useAddEmailSuppression() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response;
            var email = _b.email, reason = _b.reason;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/suppressions', {
                            method: 'POST',
...
function useRemoveEmailSuppression() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (email) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/email/suppressions/".concat(encodeURIComponent(email)), {
                            method: 'DELETE',
                        })];
                    case 1:
                        response = _a.sent();
...
function useEmailQuota() {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/quota')];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
...
function useEmailHealth() {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/email/health')];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
