...
function usePatientRetentionMetrics(patientId, clinicId, options) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return retentionService.getPatientRetentionMetrics(patientId, clinicId); },
        enabled: (options === null || options === void 0 ? void 0 : options.enabled) !== false && !!patientId && !!clinicId,
        refetchInterval: (options === null || options === void 0 ? void 0 : options.refetchInterval) || 5 * 60 * 1000, // 5 minutes
...
function useClinicRetentionMetrics(clinicId, options) {
    var _a = options || {}, _b = _a.limit, limit = _b === void 0 ? 100 : _b, _c = _a.offset, offset = _c === void 0 ? 0 : _c, _d = _a.enabled, enabled = _d === void 0 ? true : _d;
    return (0, react_query_1.useQuery)({
        queryKey: ['clinic-retention-metrics', clinicId, limit, offset],
        queryFn: function () { return retentionService.getClinicRetentionMetrics(clinicId, limit, offset); },
...
function useChurnPredictions(clinicId, options) {
    var _a = options || {}, riskLevel = _a.riskLevel, _b = _a.limit, limit = _b === void 0 ? 100 : _b, _c = _a.offset, offset = _c === void 0 ? 0 : _c, _d = _a.enabled, enabled = _d === void 0 ? true : _d;
    return (0, react_query_1.useQuery)({
        queryKey: ['churn-predictions', clinicId, riskLevel, limit, offset],
        queryFn: function () { return retentionService.getChurnPredictions(clinicId, riskLevel, limit, offset); },
        enabled: enabled && !!clinicId,
...
function useGenerateChurnPrediction() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) {
            var patientId = _a.patientId, clinicId = _a.clinicId, _b = _a.modelType, modelType = _b === void 0 ? retention_analytics_1.ChurnModelType.ENSEMBLE : _b;
...
function useRetentionStrategies(clinicId, options) {
    var _a = options || {}, _b = _a.activeOnly, activeOnly = _b === void 0 ? false : _b, _c = _a.enabled, enabled = _c === void 0 ? true : _c;
    return (0, react_query_1.useQuery)({
        queryKey: ['retention-strategies', clinicId, activeOnly],
        queryFn: function () { return retentionService.getRetentionStrategies(clinicId, activeOnly); },
        enabled: enabled && !!clinicId,
...
function useExecuteRetentionStrategy() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) {
            var strategyId = _a.strategyId, patientIds = _a.patientIds;
...
function useRetentionAnalyticsDashboard(clinicId, periodStart, periodEnd, options) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return retentionService.generateRetentionAnalyticsDashboard(clinicId, periodStart, periodEnd); },
        enabled: (options === null || options === void 0 ? void 0 : options.enabled) !== false && !!clinicId && !!periodStart && !!periodEnd,
        refetchInterval: (options === null || options === void 0 ? void 0 : options.refetchInterval) || 15 * 60 * 1000, // 15 minutes
        staleTime: 10 * 60 * 1000, // 10 minutes
    });
}
// =====================================================================================
...
function useChurnRiskMonitoring(clinicId, options) {
    ...
    react_2.default.useEffect(function () {
        if (predictions) {
            var critical = predictions.filter(function (p) { return p.risk_level === retention_analytics_1.ChurnRiskLevel.CRITICAL; }).length;
            var high = predictions.filter(function (p) { return p.risk_level === retention_analytics_1.ChurnRiskLevel.HIGH; }).length;
            var medium = predictions.filter(function (p) { return p.risk_level === retention_analytics_1.ChurnRiskLevel.MEDIUM; }).length;
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, retentionService.getRetentionStrategies(clinicId)];
                    case 1:
                        strategies = _a.sent();
                        if (strategyId) {
                            strategy = strategies.find(function (s) { return s.id === strategyId; });
        ...
        enabled: (options === null || options === void 0 ? void 0 : options.enabled) !== false && !!clinicId,
...
function usePatientRiskInsights(patientId, clinicId, options) {
    ...
    var predictions = (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, retentionService.getChurnPredictions(clinicId)];
                    case 1:
                        allPredictions = _a.sent();
                        return [2 /*return*/, allPredictions.filter(function (p) { return p.patient_id === patientId; })];
                }
            });
        }); },
        enabled: (options === null || options === void 0 ? void 0 : options.enabled) !== false && !!patientId && !!clinicId,
    ...
    var insights = react_2.default.useMemo(function () {
        if (!metrics)
            return null;
        var riskFactors = [];
        var recommendations = [];
...
function useBulkChurnPrediction() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            ...
            var clinicId = _b.clinicId, patientIds = _b.patientIds, _c = _b.modelType, modelType = _c === void 0 ? retention_analytics_1.ChurnModelType.ENSEMBLE : _c;
...
function useBulkRetentionMetrics() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            ...
            var clinicId = _b.clinicId, patientIds = _b.patientIds;
...
function useRetentionAnalyticsFormatters() {
    ...
    var formatDaysToChurn = function (days) {
        ...
        if (days < 365)
            return "".concat(Math.round(days / 30), " meses");
