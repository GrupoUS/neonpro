...
function useDemandForecasting() {
  ...
  var _c = (0, react_1.useState)([]),
    bulkForecasts = _c[0],
    setBulkForecasts = _c[1];
  var _d = (0, react_1.useState)(null),
    seasonalAnalysis = _d[0],
    setSeasonalAnalysis = _d[1];
  var _e = (0, react_1.useState)(null),
    accuracyAnalysis = _e[0],
    setAccuracyAnalysis = _e[1];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                fetch("/api/inventory/forecasting/seasonal", {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  body: JSON.stringify({
                    itemId: itemId,
            ...
            case 4:
              error_3 = _a.sent();
              message =
                error_3 instanceof Error ? error_3.message : "Failed to analyze seasonal patterns";
              sonner_1.toast.error(message);
              throw error_3;
            case 5:
              setIsLoading(false);
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              params = new URLSearchParams(
                __assign(
                  __assign({ clinicId: clinicId, period: period }, itemId && { itemId: itemId }),
            ...
            case 4:
              error_4 = _a.sent();
              message =
                error_4 instanceof Error ? error_4.message : "Failed to get accuracy analysis";
              sonner_1.toast.error(message);
              throw error_4;
            case 5:
              setIsLoading(false);
