...
exports.communicationKeys = {
    all: ['communication'],
    // Messages
    messages: function () { return __spreadArray(__spreadArray([], exports.communicationKeys.all, true), ['messages'], false); },
    messagesList: function (filters) { return __spreadArray(__spreadArray([], exports.communicationKeys.messages(), true), ['list', filters], false); },
    message: function (id) { return __spreadArray(__spreadArray([], exports.communicationKeys.messages(), true), ['detail', id], false); },
    messagesByThread: function (threadId) { return __spreadArray(__spreadArray([], exports.communicationKeys.messages(), true), ['thread', threadId], false); },
    // Threads
    threads: function () { return __spreadArray(__spreadArray([], exports.communicationKeys.all, true), ['threads'], false); },
    threadsList: function (filters) { return __spreadArray(__spreadArray([], exports.communicationKeys.threads(), true), ['list', filters], false); },
    thread: function (id) { return __spreadArray(__spreadArray([], exports.communicationKeys.threads(), true), ['detail', id], false); },
    threadsStats: function () { return __spreadArray(__spreadArray([], exports.communicationKeys.threads(), true), ['stats'], false); },
    // Templates
    templates: function () { return __spreadArray(__spreadArray([], exports.communicationKeys.all, true), ['templates'], false); },
    templatesList: function (filters) { return __spreadArray(__spreadArray([], exports.communicationKeys.templates(), true), ['list', filters], false); },
    template: function (id) { return __spreadArray(__spreadArray([], exports.communicationKeys.templates(), true), ['detail', id], false); },
    templatesByCategory: function (category) { return __spreadArray(__spreadArray([], exports.communicationKeys.templates(), true), ['category', category], false); },
    // Stats
    stats: function () { return __spreadArray(__spreadArray([], exports.communicationKeys.all, true), ['stats'], false); },
    statsOverview: function () { return __spreadArray(__spreadArray([], exports.communicationKeys.stats(), true), ['overview'], false); },
    statsMessages: function (period) { return __spreadArray(__spreadArray([], exports.communicationKeys.stats(), true), ['messages', period], false); }
};
// API functions
var api = {
    // Messages
    ...
    getMessage: function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/communication/messages/".concat(id))];
                    case 1:
                        response = _a.sent();
                        if (!!response.ok) return [3 /*break*/, 3];
                        return [4 /*yield*/, response.json()];
    ...
    markMessageAsRead: function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/communication/messages/".concat(id, "/read"), {
                            method: 'POST'
                        })];
                    case 1:
                        response = _a.sent();
    ...
    getThread: function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/communication/threads/".concat(id))];
                    case 1:
                        response = _a.sent();
                        if (!!response.ok) return [3 /*break*/, 3];
                        return [4 /*yield*/, response.json()];
    ...
    createThread: function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/communication/threads', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify(data)
                        })];
    ...
    archiveThread: function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/communication/threads/".concat(id, "/archive"), {
                            method: 'POST'
                        })];
                    case 1:
                        response = _a.sent();
    ...
    getTemplate: function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/communication/templates/".concat(id))];
                    case 1:
                        response = _a.sent();
                        if (!!response.ok) return [3 /*break*/, 3];
                        return [4 /*yield*/, response.json()];
    ...
    createTemplate: function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/communication/templates', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify(data)
                        })];
    ...
    duplicateTemplate: function (id, name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/communication/templates/".concat(id, "/duplicate"), {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
    ...
    getCommunicationStats: function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/communication/stats')];
                    case 1:
                        response = _a.sent();
                        if (!!response.ok) return [3 /*break*/, 3];
                        return [4 /*yield*/, response.json()];
...
function useMessages(filters) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return api.getMessages(filters); },
...
function useMessage(id, enabled) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return api.getMessage(id); },
        enabled: enabled && !!id,
...
function useMarkMessageAsRead() {
    ...
    return (0, react_query_1.useMutation)({
        ...
        onSuccess: function (data, messageId) {
            ...
            queryClient.setQueryData(exports.communicationKeys.message(messageId), { data: { message: data.data.message } });
...
function useThreads(filters) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return api.getThreads(filters); },
        staleTime: 30000, // 30 seconds
        refetchOnWindowFocus: false
    });
}
function useThread(id, enabled) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return api.getThread(id); },
        enabled: enabled && !!id,
        staleTime: 60000 // 1 minute
    });
}
...
function useUpdateThread() {
    ...
    return (0, react_query_1.useMutation)({
        ...
        onSuccess: function (data, _a) {
            ...
            queryClient.setQueryData(exports.communicationKeys.thread(id), { data: { thread: data.data.thread } });
            // Invalidate threads list
            queryClient.invalidateQueries({ queryKey: exports.communicationKeys.threads() });
...
function useArchiveThread() {
    ...
    return (0, react_query_1.useMutation)({
        ...
        onSuccess: function (data, threadId) {
            // Update the specific thread in cache
            queryClient.setQueryData(exports.communicationKeys.thread(threadId), { data: { thread: data.data.thread } });
            // Invalidate threads list
            queryClient.invalidateQueries({ queryKey: exports.communicationKeys.threads() });
...
function useTemplates(filters) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return api.getTemplates(filters); },
...
function useTemplate(id, enabled) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return api.getTemplate(id); },
        enabled: enabled && !!id,
...
function useUpdateTemplate() {
    ...
    return (0, react_query_1.useMutation)({
        ...
        onSuccess: function (data, _a) {
            ...
            queryClient.setQueryData(exports.communicationKeys.template(id), { data: { template: data.data.template } });
            // Invalidate templates list
            queryClient.invalidateQueries({ queryKey: exports.communicationKeys.templates() });
...
function useInbox(filters) {
    var _a = (0, react_1.useState)(null), selectedMessage = _a[0], setSelectedMessage = _a[1];
    var messagesQuery = useMessages(__assign(__assign({}, filters), { status: 'delivered', sort: 'created_at', order: 'desc' }));
    var markAsRead = useMarkMessageAsRead();
    var handleSelectMessage = (0, react_1.useCallback)(function (messageId) {
        setSelectedMessage(messageId);
        // Auto-mark as read when selected
        markAsRead.mutate(messageId);
    }, [markAsRead]);
    return __assign(__assign({}, messagesQuery), { selectedMessage: selectedMessage, setSelectedMessage: handleSelectMessage, markAsRead: markAsRead });
}
function usePatientCommunication(patientId) {
    ...
    var startConversation = (0, react_1.useCallback)(function (subject) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, createThread.mutateAsync({
                    patient_id: patientId,
                    subject: subject,
                    priority: 'normal'
                })];
    ...
    var sendQuickMessage = (0, react_1.useCallback)(function (content_1) {
        var args_1 = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args_1[_i - 1] = arguments[_i];
        }
        return __awaiter(_this, __spreadArray([content_1], args_1, true), void 0, function (content, channel) {
            if (channel === void 0) { channel = 'sms'; }
            return __generator(this, function (_a) {
                return [2 /*return*/, sendMessage.mutateAsync({
                        recipient_id: patientId,
...
function useRealtimeCommunication() {
    ...
    var refreshInbox = (0, react_1.useCallback)(function () {
        queryClient.invalidateQueries({ queryKey: exports.communicationKeys.messages() });
        queryClient.invalidateQueries({ queryKey: exports.communicationKeys.threads() });
    }, [queryClient]);
    return {
        ...
        unreadCount: ((_a = stats === null || stats === void 0 ? void 0 : stats.data) === null || _a === void 0 ? void 0 : _a.unread_messages) || 0,
        activeThreads: ((_b = stats === null || stats === void 0 ? void 0 : stats.data) === null || _b === void 0 ? void 0 : _b.active_threads) || 0
    };
}
