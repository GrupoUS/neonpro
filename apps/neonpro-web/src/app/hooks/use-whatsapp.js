...
function useWhatsAppStatus() {
  var _a = useWhatsAppConfig(),
    config = _a.data,
    configLoading = _a.isLoading;
  var _b = useWhatsAppTemplates(),
    templates = _b.data,
    templatesLoading = _b.isLoading;
  var isConfigured = !!(
    (config === null || config === void 0 ? void 0 : config.phoneNumberId) &&
