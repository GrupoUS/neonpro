...
function useMarketingCampaign(campaignId) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/marketing-roi/campaigns/".concat(campaignId))];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
...
function useCreateMarketingCampaign() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response, error;
            var clinicId = _b.clinicId, campaignData = _b.campaignData;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch('/api/marketing-roi/campaigns', {
                            method: 'POST',
                            headers: {
...
function useUpdateCampaignMetrics() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response, error;
            var campaignId = _b.campaignId, metrics = _b.metrics;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch("/api/marketing-roi/campaigns/".concat(campaignId, "/metrics"), {
                            method: 'PATCH',
                            headers: {
                                'Content-Type': 'application/json'
                            },
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if ((_a = filters === null || filters === void 0 ? void 0 : filters.treatment_ids) === null || _a === void 0 ? void 0 : _a.length) {
                            filters.treatment_ids.forEach(function (id) { return params.append('treatment_ids', id); });
                        }
                        if (filters === null || filters === void 0 ? void 0 : filters.min_roi)
                            params.append('min_roi', filters.min_roi.toString());
                        ...
                        return [4 /*yield*/, fetch("/api/marketing-roi/treatment-profitability?".concat(params))];
                    case 1:
                        response = _b.sent();
                        if (!response.ok) {
...
function useCalculateTreatmentROI() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response, error;
            var clinicId = _b.clinicId, treatmentId = _b.treatmentId, periodStart = _b.periodStart, periodEnd = _b.periodEnd;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch('/api/marketing-roi/treatment-profitability/calculate', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
...
function useCalculateCAC() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response, error;
            var clinicId = _b.clinicId, channel = _b.channel, periodStart = _b.periodStart, periodEnd = _b.periodEnd;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch('/api/marketing-roi/cac/calculate', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
...
function useCalculateLTV() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response, error;
            var clinicId = _b.clinicId, patientId = _b.patientId, acquisitionChannel = _b.acquisitionChannel;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch('/api/marketing-roi/ltv/calculate', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
...
function useROIAlerts(clinicId) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/marketing-roi/alerts?clinic_id=".concat(clinicId))];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
...
function useCreateROIAlert() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response, error;
            var clinicId = _b.clinicId, alertData = _b.alertData;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch('/api/marketing-roi/alerts', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
...
function useUpdateROIAlert() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response, error;
            var alertId = _b.alertId, status = _b.status;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch("/api/marketing-roi/alerts/".concat(alertId), {
                            method: 'PATCH',
                            headers: {
                                'Content-Type': 'application/json'
                            },
...
function useOptimizationRecommendations(clinicId) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/marketing-roi/optimization-recommendations?clinic_id=".concat(clinicId))];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
...
function useGenerateOptimizationRecommendations() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch('/api/marketing-roi/optimization-recommendations/generate', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
...
function useUpdateRecommendationStatus() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response, error;
            var recommendationId = _b.recommendationId, status = _b.status;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch("/api/marketing-roi/optimization-recommendations/".concat(recommendationId), {
                            method: 'PATCH',
                            headers: {
                                'Content-Type': 'application/json'
                            },
 ...
 */
function useROIDashboardMetrics(clinicId, periodStart, periodEnd, includeTrends, includeComparisons, includeForecasts) {
    var _this = this;
    if (includeTrends === void 0) { includeTrends = false; }
    if (includeComparisons === void 0) { includeComparisons = false; }
    if (includeForecasts === void 0) { includeForecasts = false; }
    return (0, react_query_1.useQuery)({
        queryKey: ['roi-dashboard-metrics', clinicId, periodStart, periodEnd, includeTrends, includeComparisons, includeForecasts],
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            var params, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
 ...
 */
function useROIComparisons(clinicId, entityType, currentPeriodStart, currentPeriodEnd, previousPeriodStart, previousPeriodEnd) {
    var _this = this;
    return (0, react_query_1.useQuery)({
        queryKey: ['roi-comparisons', clinicId, entityType, currentPeriodStart, currentPeriodEnd, previousPeriodStart, previousPeriodEnd],
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            var params, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        enabled: !!clinicId && !!currentPeriodStart && !!currentPeriodEnd && !!previousPeriodStart && !!previousPeriodEnd
    });
}
...
function useGenerateROIForecast() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response, error;
            var clinicId = _b.clinicId, forecastType = _b.forecastType, entityId = _b.entityId, forecastPeriodStart = _b.forecastPeriodStart, forecastPeriodEnd = _b.forecastPeriodEnd;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch('/api/marketing-roi/forecasts/generate', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
...
function useMarketingROIInsights(clinicId) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/marketing-roi/insights?clinic_id=".concat(clinicId))];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
...
function useBulkCampaignOperations() {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var response, error;
            var operation = _b.operation, campaignIds = _b.campaignIds, data = _b.data;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, fetch('/api/marketing-roi/campaigns/bulk', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
...
function useRealTimeROIMonitoring(clinicId, enabled) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/marketing-roi/real-time-monitoring?clinic_id=".concat(clinicId))];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
...
function useROICalculationSettings(clinicId) {
    ...
    var _a = (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("/api/marketing-roi/calculation-settings?clinic_id=".concat(clinicId))];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
        ...
        enabled: !!clinicId
    }), settings = _a.data, isLoading = _a.isLoading;
    var updateSettings = (0, react_query_1.useMutation)({
        mutationFn: function (newSettings) { return __awaiter(_this, void 0, void 0, function () {
            var response, error;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/marketing-roi/calculation-settings', {
                            method: 'PUT',
                            headers: {
                                'Content-Type': 'application/json'
                            },
