...
exports.CACHE_KEYS = exports.CACHE_TTL = exports.cacheMetrics = exports.stockAlertCache = exports.cacheManager = exports.CacheMetrics = exports.StockAlertCache = exports.CacheManager = void 0;
...
var CACHE_KEYS = {
    ALERT_CONFIGS: function (clinicId) { return "alerts:configs:".concat(clinicId); },
    ACTIVE_ALERTS: function (clinicId) { return "alerts:active:".concat(clinicId); },
    DASHBOARD_DATA: function (clinicId, period) { return "dashboard:".concat(clinicId, ":").concat(period); },
    PRODUCT_STOCK: function (productId) { return "stock:product:".concat(productId); },
    CLINIC_PRODUCTS: function (clinicId) { return "products:clinic:".concat(clinicId); },
    REPORT_DATA: function (reportId) { return "report:".concat(reportId); },
    USER_PERMISSIONS: function (userId, clinicId) { return "permissions:".concat(userId, ":").concat(clinicId); },
    NOTIFICATION_QUEUE: function (clinicId) { return "notifications:queue:".concat(clinicId); }
};
...
var CacheManager = /** @class */ (function () {
    ...
    CacheManager.prototype.set = function (key_1, value_1) {
        return __awaiter(this, arguments, void 0, function (key, value, ttlSeconds) {
            ...
            if (ttlSeconds === void 0) { ttlSeconds = CACHE_TTL.MEDIUM; }
...
var StockAlertCache = /** @class */ (function () {
    ...
    StockAlertCache.prototype.setAlertConfigs = function (clinicId, configs) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.set(CACHE_KEYS.ALERT_CONFIGS(clinicId), configs, CACHE_TTL.CONFIGS)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.invalidateAlertConfigs = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.delete(CACHE_KEYS.ALERT_CONFIGS(clinicId))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.setActiveAlerts = function (clinicId, alerts) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.set(CACHE_KEYS.ACTIVE_ALERTS(clinicId), alerts, CACHE_TTL.ALERTS)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.invalidateActiveAlerts = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.delete(CACHE_KEYS.ACTIVE_ALERTS(clinicId))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.setDashboardData = function (clinicId, period, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.set(CACHE_KEYS.DASHBOARD_DATA(clinicId, period), data, CACHE_TTL.DASHBOARD)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.invalidateDashboardData = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.deletePattern("dashboard:".concat(clinicId, ":*"))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.setProductStock = function (productId, stock) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.set(CACHE_KEYS.PRODUCT_STOCK(productId), stock, CACHE_TTL.SHORT)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.invalidateProductStock = function (productId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.delete(CACHE_KEYS.PRODUCT_STOCK(productId))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.setClinicProducts = function (clinicId, products) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.set(CACHE_KEYS.CLINIC_PRODUCTS(clinicId), products, CACHE_TTL.MEDIUM)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.invalidateClinicProducts = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.delete(CACHE_KEYS.CLINIC_PRODUCTS(clinicId))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.setReportData = function (reportId, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.set(CACHE_KEYS.REPORT_DATA(reportId), data, CACHE_TTL.REPORTS)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.addNotification = function (clinicId, notification) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.listPush(CACHE_KEYS.NOTIFICATION_QUEUE(clinicId), notification)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StockAlertCache.prototype.getNotifications = function (clinicId_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, limit) {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.cache.listGet(CACHE_KEYS.NOTIFICATION_QUEUE(clinicId), 0, limit - 1)];
            });
        });
    };
...
var CacheMetrics = /** @class */ (function () {
    ...
    CacheMetrics.prototype.getHitRate = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cache.get("metrics:hits:".concat(key))];
                    case 1:
                        hits = (_a.sent()) || 0;
