...
exports.DB_CONFIG = exports.queryMonitor = exports.dbHealthMonitor = exports.optimizedQueries = exports.DatabaseHealthMonitor = exports.StockAlertQueries = exports.OptimizedQueryBuilder = void 0;
...
var QueryPerformanceMonitor = /** @class */ (function () {
    ...
    QueryPerformanceMonitor.prototype.getSlowQueries = function (threshold) {
        ...
        return this.metrics.filter(function (m) { return m.duration > limit; });
    };
    QueryPerformanceMonitor.prototype.getAverageQueryTime = function () {
        if (this.metrics.length === 0)
            return 0;
        var total = this.metrics.reduce(function (sum, m) { return sum + m.duration; }, 0);
        return total / this.metrics.length;
    };
    QueryPerformanceMonitor.prototype.getCacheHitRate = function () {
        if (this.metrics.length === 0)
            return 0;
        var cached = this.metrics.filter(function (m) { return m.cached; }).length;
...
var OptimizedQueryBuilder = /** @class */ (function () {
    ...
    OptimizedQueryBuilder.prototype.cachedSelect = function (cacheKey_1, selectQuery_1) {
        return __awaiter(this, arguments, void 0, function (cacheKey, selectQuery, filters, cacheTtl) {
            ...
            if (cacheTtl === void 0) { cacheTtl = 300; }
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3: return [4 /*yield*/, cache_1.cacheMetrics.recordMiss(cacheKey)];
                    case 4:
                        _d.sent();
                    ...
                    case 6:
                        _d.sent();
                        _d.label = 7;
                    case 7: return [2 /*return*/, { data: data, fromCache: false }];
                }
            });
        });
    };
    ...
    OptimizedQueryBuilder.prototype.batchInsert = function (records_1) {
        return __awaiter(this, arguments, void 0, function (records, batchSize) {
            ...
            if (batchSize === void 0) { batchSize = DB_CONFIG.defaultBatchSize; }
    ...
    OptimizedQueryBuilder.prototype.aggregate = function (cacheKey_1, aggregations_1) {
        return __awaiter(this, arguments, void 0, function (cacheKey, aggregations, filters, cacheTtl) {
            ...
            if (filters === void 0) { filters = {}; }
            if (cacheTtl === void 0) { cacheTtl = 600; }
...
var StockAlertQueries = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, builder.cachedSelect(cacheKey, "\n        *,\n        product:products (\n          id,\n          name,\n          sku,\n          current_stock,\n          min_stock,\n          max_stock,\n          expiration_date\n        ),\n        category:product_categories (\n          id,\n          name\n        )\n      ", { clinic_id: clinicId, is_active: true }, 900 // 15 minutes cache
                            )];
                    case 1:
                        data = (_a.sent()).data;
    ...
    StockAlertQueries.prototype.getDashboardData = function (clinicId_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, days) {
            var cacheKey, cached, startTime, endDate, startDate, _a, productsResult, alertsResult, metricsResult, dashboardData;
            if (days === void 0) { days = 30; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        cacheKey = "dashboard:".concat(clinicId, ":").concat(days, "d");
                        return [4 /*yield*/, cache_1.stockAlertCache.getDashboardData(clinicId, "".concat(days, "d"))];
                    case 1:
                        cached = _b.sent();
                        if (cached) {
                            return [2 /*return*/, cached];
                    ...
                    case 2:
                        _a = _b.sent(), productsResult = _a[0], alertsResult = _a[1], metricsResult = _a[2];
                        dashboardData = {
                        ...
                        // Cache the result
                        return [4 /*yield*/, cache_1.stockAlertCache.setDashboardData(clinicId, "".concat(days, "d"), dashboardData)];
                    case 3:
                        // Cache the result
                        _b.sent();
                    ...
                    case 0:
                        ...
                        switch (config.alert_type) {
                            case 'low_stock':
                                ...
                                message = "Estoque baixo para ".concat(product.name, ": ").concat(currentValue, " unidades");
                                break;
                            case 'expiring':
...
var DatabaseHealthMonitor = /** @class */ (function () {
    ...
    DatabaseHealthMonitor.prototype.checkHealth = function () {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, connectionStart, connectionTime, queryStart, queryTime, metrics, status_1, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        startTime = Date.now();
