      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("lgpd_breach_detection_rules").select("*").eq("enabled", true),
            ];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              lgpd_audit_1.lgpdAuditLogger.logEvent({
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            rule = _a[_i];
            if (!rule.enabled) return [3 /*break*/, 4];
  ...
  BreachDetectionSystem.prototype.detectFailedLogins = function (rule, events) {
    ...
    for (var _i = 0, _a = Object.entries(groupedByUser); _i < _a.length; _i++) {
      ...
      if (userEvents.length >= rule.thresholds.failed_attempts) {
        var timeSpan =
          new Date(userEvents[0].created_at).getTime() -
