...
function useComplianceMonitoring() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setIsLoading(true);
                    setError(undefined);
                    return [4 /*yield*/, compliance_monitoring_1.realTimeComplianceMonitor.startMonitoring()
                        // Add status listener
                    ];
                case 1:
                    _a.sent();
                    ...
                    compliance_monitoring_1.realTimeComplianceMonitor.addStatusListener(handleStatusUpdate);
                    return [4 /*yield*/, compliance_monitoring_1.realTimeComplianceMonitor.getCurrentStatus()];
                case 2:
    ...
    var stopMonitoring = (0, react_1.useCallback)(function () {
        ...
        if (statusUpdateRef.current) {
            compliance_monitoring_1.realTimeComplianceMonitor.removeStatusListener(statusUpdateRef.current);
    ...
    // Report violation
    var reportViolation = (0, react_1.useCallback)(function (violation) { return __awaiter(_this, void 0, void 0, function () {
        var err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, compliance_monitoring_1.realTimeComplianceMonitor.reportViolation(violation)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    // Resolve violation
    var resolveViolation = (0, react_1.useCallback)(function (violationId, resolution, responsible) { return __awaiter(_this, void 0, void 0, function () {
        var err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, compliance_monitoring_1.realTimeComplianceMonitor.resolveViolation(violationId, resolution, responsible)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    // Acknowledge alert
    var acknowledgeAlert = (0, react_1.useCallback)(function (alertId, acknowledgedBy) { return __awaiter(_this, void 0, void 0, function () {
        var err_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, compliance_monitoring_1.realTimeComplianceMonitor.acknowledgeAlert(alertId, acknowledgedBy)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    var triggerAssessment = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var err_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, compliance_monitoring_1.realTimeComplianceMonitor.triggerAssessment()];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
function useComplianceMetrics() {
    var _a = useComplianceMonitoring(), status = _a.status, isLoading = _a.isLoading;
...
function useComplianceViolations() {
    var _a = useComplianceMonitoring(), status = _a.status, isLoading = _a.isLoading, reportViolation = _a.reportViolation, resolveViolation = _a.resolveViolation;
    var violations = (status === null || status === void 0 ? void 0 : status.violations) || [];
    var getViolationsByType = (0, react_1.useCallback)(function (type) {
        if (!type)
            return violations;
        return violations.filter(function (v) { return v.type === type; });
    }, [violations]);
    var getViolationsByCategory = (0, react_1.useCallback)(function (category) {
        if (!category)
            return violations;
        return violations.filter(function (v) { return v.category === category; });
    }, [violations]);
    var getCriticalViolations = (0, react_1.useCallback)(function () {
        return violations.filter(function (v) { return v.severity === 'critical'; });
    }, [violations]);
...
function useComplianceAlerts() {
    var _a = useComplianceMonitoring(), status = _a.status, isLoading = _a.isLoading, acknowledgeAlert = _a.acknowledgeAlert;
    var alerts = (status === null || status === void 0 ? void 0 : status.alerts) || [];
    var getUnacknowledgedAlerts = (0, react_1.useCallback)(function () {
    ...
    var getAlertsByCategory = (0, react_1.useCallback)(function (category) {
        if (!category)
            return alerts;
        return alerts.filter(function (a) { return a.category === category; });
    }, [alerts]);
...
function useComplianceRecommendations() {
    var _a = useComplianceMonitoring(), status = _a.status, isLoading = _a.isLoading;
    var recommendations = (status === null || status === void 0 ? void 0 : status.recommendations) || [];
    var getRecommendationsByPriority = (0, react_1.useCallback)(function (priority) {
        if (!priority)
            return recommendations;
        return recommendations.filter(function (r) { return r.priority === priority; });
    }, [recommendations]);
    var getCriticalRecommendations = (0, react_1.useCallback)(function () {
        return recommendations.filter(function (r) { return r.priority === 'critical'; });
    }, [recommendations]);
    var getRecommendationsByCategory = (0, react_1.useCallback)(function (category) {
        if (!category)
            return recommendations;
        return recommendations.filter(function (r) { return r.category === category; });
    }, [recommendations]);
