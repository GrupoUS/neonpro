...
exports.realTimeComplianceMonitor =
  exports.ViolationType =
  exports.ComplianceLevel =
...
var MONITORING_CONFIG = {
  ...
  SCORE_WEIGHTS:
    ((_a = {}),
    (_a[ComplianceCategory.CONSENT_MANAGEMENT] = 0.2),
    (_a[ComplianceCategory.DATA_SUBJECT_RIGHTS] = 0.2),
    (_a[ComplianceCategory.DATA_PROTECTION] = 0.15),
    (_a[ComplianceCategory.AUDIT_TRAIL] = 0.15),
    (_a[ComplianceCategory.DATA_RETENTION] = 0.1),
    (_a[ComplianceCategory.BREACH_RESPONSE] = 0.1),
...
var RealTimeComplianceMonitor = /** @class */ (() => {
          ...
          case 2:
            ...
            return [
              ...
              security_audit_logger_1.securityAuditLogger.logEvent(
                security_audit_logger_1.AuditEventType.PROFILE_UPDATE,
                {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 5, , 6]);
            newViolation = __assign(__assign({}, violation), {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.createViolationAlert(newViolation),
              // Log violation
            ];
          case 2:
            _a.sent();
            ...
            return [
              4 /*yield*/,
              security_audit_logger_1.securityAuditLogger.logEvent(
                security_audit_logger_1.AuditEventType.SUSPICIOUS_ACTIVITY,
                {
   ...
   * Resolve violation
   */
  RealTimeComplianceMonitor.prototype.resolveViolation = function (
    violationId,
    resolution,
    responsible,
  ) {
          ...
          case 1:
            ...
            return [
              ...
              this.createAlert({
                ...
                message: "Viola\u00E7\u00E3o "
                  .concat(violationId, " foi resolvida: ")
                  .concat(resolution),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.updateComplianceTrends(metrics),
              // Notify listeners
            ];
          case 3:
            // Update trends
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              lgpd_compliance_manager_1.lgpdComplianceManager.getDataSubjectRequestMetrics(),
            ];
          case 4:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              security_audit_logger_1.securityAuditLogger.getSecurityMetrics(24),
            ];
          case 1:
  ...
  RealTimeComplianceMonitor.prototype.checkExcessiveFailedLogins = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, security_audit_logger_1.securityAuditLogger.getSecurityMetrics(1)];
          case 1:
            securityMetrics = _a.sent();
            ...
            return [
              ...
              this.reportViolation({
                ...
                description: "Excessivo n\u00FAmero de tentativas de login falhadas: ".concat(
        ...
        Object.entries(metrics.categoryScores).forEach((_a) => {
          ...
          if (score < 75) {
            recommendations.push({
              ...
              description: "Score atual: ".concat(
                score,
                "%. A\u00E7\u00F5es necess\u00E1rias para melhorar conformidade.",
              ),
          ...
          case 0:
            return [
              ...
              this.createAlert({
                ...
                message: ""
                  .concat(violation.description, " (Risco: ")
                  .concat(violation.legalRisk, ")"),
                category: violation.category,
                actionRequired: true,
