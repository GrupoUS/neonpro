...
var AppointmentReminderEmail = function (_a) {
    var _b = _a.patientName, patientName = _b === void 0 ? 'Patient' : _b, _c = _a.appointmentDate, appointmentDate = _c === void 0 ? 'January 15, 2024' : _c, _d = _a.appointmentTime, appointmentTime = _d === void 0 ? '2:00 PM' : _d, _e = _a.treatmentType, treatmentType = _e === void 0 ? 'Consultation' : _e, _f = _a.doctorName, doctorName = _f === void 0 ? 'Dr. Smith' : _f, _g = _a.clinicName, clinicName = _g === void 0 ? 'NeonPro Aesthetic Clinic' : _g, _h = _a.clinicAddress, clinicAddress = _h === void 0 ? '123 Main Street, City, State 12345' : _h, _j = _a.clinicPhone, clinicPhone = _j === void 0 ? '(555) 123-4567' : _j, cancellationLink = _a.cancellationLink, rescheduleLink = _a.rescheduleLink, confirmationLink = _a.confirmationLink, _k = _a.timezone, timezone = _k === void 0 ? 'UTC' : _k;
    return (<components_1.Html>
      <components_1.Head />
      <components_1.Preview>Appointment reminder for {appointmentDate} at {appointmentTime}</components_1.Preview>
        ...
        <components_1.Body className="bg-white my-auto mx-auto font-sans">
          <components_1.Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
            <components_1.Section className="mt-[32px]">
              <components_1.Img src="https://your-clinic-logo.com/logo.png" width="200" height="60" alt={clinicName} className="my-0 mx-auto"/>
            ...
            <components_1.Section className="text-center mt-[32px] mb-[32px]">
              {confirmationLink && (<components_1.Button className="bg-[#000000] rounded text-white text-[12px] font-semibold no-underline text-center px-[20px] py-[12px] mr-[8px]" href={confirmationLink}>
                  Confirm Appointment
                </components_1.Button>)}
              
              {rescheduleLink && (<components_1.Button className="bg-[#0070f3] rounded text-white text-[12px] font-semibold no-underline text-center px-[20px] py-[12px] mr-[8px]" href={rescheduleLink}>
                  Reschedule
                </components_1.Button>)}
              
              {cancellationLink && (<components_1.Button className="bg-[#dc2626] rounded text-white text-[12px] font-semibold no-underline text-center px-[20px] py-[12px]" href={cancellationLink}>
                  Cancel
                </components_1.Button>)}
            </components_1.Section>
