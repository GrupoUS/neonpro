...
var NotificationPayloadSchema = zod_1.z.object({
    ...
    type: zod_1.z.enum(['appointment_reminder', 'appointment_confirmation', 'appointment_cancellation', 'reschedule_request', 'treatment_reminder', 'follow_up_reminder', 'emergency_alert', 'billing_reminder']),
...
var NotificationService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        if (!(validPayload.scheduledFor && validPayload.scheduledFor > new Date())) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.scheduleNotification(validPayload, channels, preferences)];
                    case 6: return [2 /*return*/, _a.sent()];
                    case 7: return [4 /*yield*/, this.sendImmediately(validPayload, channels, preferences)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 5, , 6]);
                        return [4 /*yield*/, this.schedulingService.scheduleNotification({
                                recipientId: payload.recipientId,
                                type: payload.type,
                                channel: channel,
                                payload: payload,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 9];
                    case 3: return [4 /*yield*/, this.emailService.send(__assign(__assign({}, payload), { recipientEmail: preferences.email, timezone: preferences.timezone }))];
                    case 4:
                        result = _b.sent();
                        return [3 /*break*/, 10];
                    case 5: return [4 /*yield*/, this.smsService.send(__assign(__assign({}, payload), { recipientPhone: preferences.phone, timezone: preferences.timezone }))];
                    case 6:
                        result = _b.sent();
                        return [3 /*break*/, 10];
                    case 7: return [4 /*yield*/, this.sendInAppNotification(payload)];
                    case 8:
                        result = _b.sent();
                        return [3 /*break*/, 10];
    ...
    NotificationService.prototype.getChannelsForType = function (type, preferences) {
        ...
        Object.entries(preferences.channels).forEach(function (_a) {
            var channelKey = _a[0], channelPrefs = _a[1];
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                channel: 'in_app',
                                error: error_5 instanceof Error ? error_5.message : 'Failed to send in-app notification'
                            }];
                    case 3: return [2 /*return*/];
                }
            });
