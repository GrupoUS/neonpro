...
var SchedulingService = /** @class */ (function () {
    ...
    SchedulingService.prototype.markNotificationFailed = function (notificationId, errorMessage) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, current, fetchError, newRetryCount, shouldRetry, updateData, retryDelay, nextRetry, error, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        if (shouldRetry) {
                            retryDelay = this.retryIntervals[Math.min(newRetryCount - 1, this.retryIntervals.length - 1)];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        deliveredAt = data.sent_at ? new Date(data.sent_at) :
     ...
     */
    SchedulingService.prototype.scheduleAppointmentReminders = function (appointmentId, appointmentDate, patientId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, preferences, prefError, scheduledIds, _i, _b, interval, reminderTime, _c, _d, _e, channel, channelPrefs, scheduledId, error_8, error_9;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 3:
                        ...
                        if (!(channelPrefs.enabled && channelPrefs.enabledTypes.includes('appointment_reminder'))) return [3 /*break*/, 7];
                        _f.label = 4;
                    case 4:
                        _f.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, this.scheduleNotification({
                    ...
                    case 8:
                        _i++;
                        return [3 /*break*/, 2];
                    case 9: return [2 /*return*/, scheduledIds];
                    case 10:
                        error_9 = _f.sent();
