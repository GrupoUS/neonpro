...
var SMSService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        messageContent = this.generateSMSContent(payload.type, payload.content, payload.templateData);
        ...
        try {
            ...
            var templates = {
                'appointment_reminder': function (data) {
                    return "\uD83C\uDFE5 ".concat((data === null || data === void 0 ? void 0 : data.clinicName) || 'NeonPro', ": Lembrete de consulta para ").concat(data === null || data === void 0 ? void 0 : data.patientName, " em ").concat(data === null || data === void 0 ? void 0 : data.appointmentDate, " \u00E0s ").concat(data === null || data === void 0 ? void 0 : data.appointmentTime, ". Para cancelar/reagendar: ").concat(data === null || data === void 0 ? void 0 : data.clinicPhone, ". STOP para cancelar msgs.");
                },
                'appointment_confirmation': function (data) {
                    return "\u2705 ".concat((data === null || data === void 0 ? void 0 : data.clinicName) || 'NeonPro', ": Consulta confirmada para ").concat(data === null || data === void 0 ? void 0 : data.patientName, " em ").concat(data === null || data === void 0 ? void 0 : data.appointmentDate, " \u00E0s ").concat(data === null || data === void 0 ? void 0 : data.appointmentTime, ". Local: ").concat(data === null || data === void 0 ? void 0 : data.clinicAddress, ". Chegue 15min antes.");
                },
                'appointment_cancellation': function (data) {
                    return "\u274C ".concat((data === null || data === void 0 ? void 0 : data.clinicName) || 'NeonPro', ": Consulta cancelada para ").concat(data === null || data === void 0 ? void 0 : data.patientName, " em ").concat(data === null || data === void 0 ? void 0 : data.appointmentDate, " \u00E0s ").concat(data === null || data === void 0 ? void 0 : data.appointmentTime, ". Para reagendar: ").concat(data === null || data === void 0 ? void 0 : data.clinicPhone, ".");
                },
                'reschedule_request': function (data) {
                    return "\uD83D\uDCC5 ".concat((data === null || data === void 0 ? void 0 : data.clinicName) || 'NeonPro', ": Solicita\u00E7\u00E3o de reagendamento para ").concat(data === null || data === void 0 ? void 0 : data.patientName, ". Nova data dispon\u00EDvel: ").concat(data === null || data === void 0 ? void 0 : data.newDate, ". Confirme: ").concat(data === null || data === void 0 ? void 0 : data.confirmationLink);
                },
                'treatment_reminder': function (data) {
                    return "\uD83D\uDC8A ".concat((data === null || data === void 0 ? void 0 : data.clinicName) || 'NeonPro', ": Lembrete de tratamento para ").concat(data === null || data === void 0 ? void 0 : data.patientName, ". ").concat(data === null || data === void 0 ? void 0 : data.treatmentName, " - Pr\u00F3xima sess\u00E3o: ").concat(data === null || data === void 0 ? void 0 : data.nextAppointment, ".");
                },
                'follow_up_reminder': function (data) {
                    return "\uD83D\uDC68\u200D\u2695\uFE0F ".concat((data === null || data === void 0 ? void 0 : data.clinicName) || 'NeonPro', ": Acompanhamento p\u00F3s-tratamento para ").concat(data === null || data === void 0 ? void 0 : data.patientName, ". Agende consulta de retorno: ").concat(data === null || data === void 0 ? void 0 : data.clinicPhone, ".");
                },
                'emergency_alert': function (data) {
                    return "\uD83D\uDEA8 ".concat((data === null || data === void 0 ? void 0 : data.clinicName) || 'NeonPro', " - URGENTE: ").concat(data === null || data === void 0 ? void 0 : data.message, ". Contato: ").concat(data === null || data === void 0 ? void 0 : data.contactInfo, ". ").concat(data === null || data === void 0 ? void 0 : data.patientName);
                },
                'billing_reminder': function (data) {
                    return "\uD83D\uDCB3 ".concat((data === null || data === void 0 ? void 0 : data.clinicName) || 'NeonPro', ": Cobran\u00E7a de R$ ").concat(data === null || data === void 0 ? void 0 : data.amountDue, " vence em ").concat(data === null || data === void 0 ? void 0 : data.dueDate, ". Pague online: ").concat(data === null || data === void 0 ? void 0 : data.paymentLink);
                }
            };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                error: message.errorCode ? "".concat(message.errorCode, ": ").concat(message.errorMessage) : undefined
                            }];
                    case 2:
                        error_2 = _a.sent();
    ...
    SMSService.prototype.validateSMSTemplate = function (type, data) {
        try {
            ...
            return required.every(function (field) { return data && data[field]; });
        }
        catch (error) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        batchPromises = batch.map(function (payload) { return _this.send(payload); });
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 6, , 7]);
