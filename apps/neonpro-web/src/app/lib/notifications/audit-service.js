...
var AuditService = /** @class */ (function () {
        ...
        switch (_c.label) {
          case 0:
            ...
            auditData = {
              ...
              reason: entry.reason,
              delivered_at:
                (_a = entry.deliveredAt) === null || _a === void 0 ? void 0 : _a.toISOString(),
              scheduled_for:
                (_b = entry.scheduledFor) === null || _b === void 0 ? void 0 : _b.toISOString(),
            ...
            return [
              4 /*yield*/,
              client_1.supabase.from("notification_audit_log").insert(auditData),
            ];
          case 1:
            error = _c.sent().error;
            if (error) {
   ...
   */
  AuditService.prototype.logDelivery = function (
    notificationId,
    recipientId,
    channel,
    type,
   ...
   */
  AuditService.prototype.logScheduling = function (
    notificationId,
    recipientId,
    channel,
    type,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [4 /*yield*/, query.order("timestamp", { ascending: false }).limit(limit)];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) {
        ...
        switch (_b.label) {
          ...
          case 1:
            ...
            logs.forEach(function (log) {
              ...
              // Channel stats
              if (log.channel) {
                if (!channelGroups_1[log.channel]) channelGroups_1[log.channel] = [];
