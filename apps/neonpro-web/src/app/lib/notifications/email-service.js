...
var EmailService = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        emailHtml = (0, render_1.render)(TemplateComponent(__assign(__assign({}, payload.templateData), { recipientEmail: payload.recipientEmail, timezone: payload.timezone || 'UTC' })));
                        emailData = {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                success: true,
                                notificationId: ((_a = result.data) === null || _a === void 0 ? void 0 : _a.id) || "email_".concat(Date.now()),
     ...
     */
    EmailService.prototype.getTemplateComponent = function (type) {
        var templates = {
     ...
     */
    EmailService.prototype.getPriorityHeader = function (priority) {
        switch (priority) {
     ...
     */
    EmailService.prototype.validateTemplateData = function (type, data) {
        try {
