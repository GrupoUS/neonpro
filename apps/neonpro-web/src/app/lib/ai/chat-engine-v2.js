...
var NeonProAIChatEngine = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.generateResponse(request.query, enrichedContext, classification)];
                    case 4:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!lgpdCompliant) {
                            return [2 /*return*/, { isValid: false, reason: "LGPD compliance violation detected" }];
                        }
                        return [2 /*return*/, { isValid: true, reason: "Security validation passed" }];
                    case 2:
                        error_2 = _a.sent();
                        return [2 /*return*/, { isValid: false, reason: "Security validation error: ".concat(error_2) }];
    ...
    NeonProAIChatEngine.prototype.enrichContext = function (classification, baseContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        enriched = __assign(__assign({}, baseContext), { enrichedData: {}, queryClassification: classification, relevantData: {}, searchResults: [], suggestedQueries: [], permissions: classification.requiredPermissions });
                        _f.label = 1;
                    case 1:
                        _f.trys.push([1, 15, , 16]);
                        _a = classification.category;
                        switch (_a) {
                            case "appointment_query": return [3 /*break*/, 2];
                            case "financial_query": return [3 /*break*/, 5];
                            case "patient_query": return [3 /*break*/, 8];
                            case "analytics_query": return [3 /*break*/, 11];
                        }
                        return [3 /*break*/, 14];
                    case 2:
                    ...
                    case 14: return [2 /*return*/, enriched];
                    case 15:
                        error_4 = _f.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = (_a.sent()).data;
                        return [2 /*return*/, {
                                totalRevenue: (data === null || data === void 0 ? void 0 : data.filter(function (t) { return t.type === "income"; }).reduce(function (sum, t) { return sum + t.amount; }, 0)) || 0,
                                totalExpenses: (data === null || data === void 0 ? void 0 : data.filter(function (t) { return t.type === "expense"; }).reduce(function (sum, t) { return sum + t.amount; }, 0)) || 0,
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                newPatientsThisMonth: (data === null || data === void 0 ? void 0 : data.filter(function (p) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, ((_c = (_b = session.session) === null || _b === void 0 ? void 0 : _b.user) === null || _c === void 0 ? void 0 : _c.id) ? true : false];
                    case 2:
                        _a = _d.sent();
    ...
    NeonProAIChatEngine.prototype.validateLGPDCompliance = function (message) {
        ...
        return !sensitivePatterns.some(function (pattern) { return pattern.test(message); });
    };
    ...
    NeonProAIChatEngine.prototype.createErrorResponse = function (error) {
        return {
            message: "Desculpe, encontrei um problema ao processar sua solicitação. Tente novamente em alguns instantes.",
