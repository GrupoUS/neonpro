...
var NeonProAIChatEngine = /** @class */ (() => {
   ...
   */
  NeonProAIChatEngine.prototype.processUniversalQuery = function (
    query,
    context,
    userId,
    clinicId,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.enrichContext(context, queryType, clinicId),
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.validateAccess(userId, clinicId, queryType.requiredPermissions),
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.generateResponse(query, enrichedContext, queryType),
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              this.validateResponse(response, clinicId),
              // 6. Audit Trail
            ];
          case 6:
          ...
          case 7:
            ...
            return [
              2 /*return*/,
              __assign(__assign({}, validatedResponse), {
                metadata: {
