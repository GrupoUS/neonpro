      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.evaluatePermission(check, userPermissions),
              // Cache result
            ];
          case 2:
            result = _a.sent();
      ...
      return __generator(this, function (_a) {
        try {
          ...
          localStorage.setItem(
            "user_permissions_".concat(userId),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            updatedPermissions = __assign(__assign({}, currentPermissions), {
              roles: roles,
              lastUpdated: Date.now(),
            });
            ...
            return [
              ...
              security_audit_logger_1.securityAuditLogger.logEvent(
                security_audit_logger_1.AuditEventType.ROLE_CHANGE,
                {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            currentPermissions = _a.sent();
            updatedPermissions = __assign(__assign({}, currentPermissions), {
              customPermissions: __spreadArray(
                __spreadArray([], currentPermissions.customPermissions, true),
                [permission],
                false,
              ),
              lastUpdated: Date.now(),
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.evaluateConditions(check, permission.conditions, userPermissions),
            ];
          case 3:
