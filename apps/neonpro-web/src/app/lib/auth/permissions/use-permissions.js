...
function usePermissions(userId) {
    var _this = this;
    var _a = (0, react_1.useState)(null), userPermissions = _a[0], setUserPermissions = _a[1];
    var _b = (0, react_1.useState)(true), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(), error = _c[0], setError = _c[1];
    // Load user permissions
    var loadPermissions = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setIsLoading(true);
                    setError(undefined);
                    return [4 /*yield*/, permission_validator_1.permissionValidator.getUserPermissions(userId)];
                case 2:
                    permissions = _a.sent();
    ...
    // Check permission
    var checkPermission = (0, react_1.useCallback)(function (resource, action, resourceId) { return __awaiter(_this, void 0, void 0, function () {
        var err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, permission_validator_1.hasPermission)(userId, resource, action, resourceId)];
    ...
    var hasRole = (0, react_1.useCallback)(function (role) {
        return (userPermissions === null || userPermissions === void 0 ? void 0 : userPermissions.roles.includes(role)) || false;
    }, [userPermissions]);
    // Check if user has any of the specified roles
    var hasAnyRole = (0, react_1.useCallback)(function (roles) {
        if (!userPermissions)
            return false;
        return roles.some(function (role) { return userPermissions.roles.includes(role); });
    }, [userPermissions]);
    // Check if user has higher role than target
    var hasHigherRole = (0, react_1.useCallback)(function (targetRole) {
        if (!userPermissions)
            return false;
    ...
    var refresh = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadPermissions()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    // Get user roles
    var roles = (0, react_1.useMemo)(function () {
        return (userPermissions === null || userPermissions === void 0 ? void 0 : userPermissions.roles) || [];
    }, [userPermissions]);
...
function usePermissionCheck(userId, resource, action, resourceId) {
    ...
    var _b = (0, react_1.useState)(true), isLoading = _b[0], setIsLoading = _b[1];
    var checkPermission = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    setIsLoading(true);
                    return [4 /*yield*/, permission_validator_1.permissionValidator.checkPermission({
                            userId: userId,
                            resource: resource,
                            action: action,
...
function useMultiplePermissions(userId, permissions) {
    ...
    var _b = (0, react_1.useState)(true), isLoading = _b[0], setIsLoading = _b[1];
    var checkPermissions = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    setIsLoading(true);
                    return [4 /*yield*/, (0, permission_validator_1.checkMultiplePermissions)(userId, permissions)];
                case 2:
                    permissionResults_1 = _a.sent();
                    resultMap_1 = {};
                    permissions.forEach(function (permission, index) {
                        var key = permission.key || "".concat(permission.resource, ":").concat(permission.action, ":").concat(permission.resourceId || 'none');
    ...
    return {
        ...
        can: function (key) { return results[key] || false; }
    };
}
// Hook for role-based component rendering
function useRoleAccess(userId, allowedRoles) {
    var _a = usePermissions(userId), roles = _a.roles, isLoading = _a.isLoading;
    var hasAccess = (0, react_1.useMemo)(function () {
        if (isLoading || !roles.length)
            return false;
        return allowedRoles.some(function (role) { return roles.includes(role); });
...
function withPermissionCheck(Component, resource, action, fallback) {
    return function PermissionProtectedComponent(props) {
        var userId = props.userId, resourceId = props.resourceId, componentProps = __rest(props, ["userId", "resourceId"]);
        var _a = usePermissionCheck(userId, resource, action, resourceId), allowed = _a.allowed, isLoading = _a.isLoading;
        if (isLoading) {
            return Verificando;
            permissões;
            /div>;
...
function useAdminAccess(userId) {
    var _a = usePermissions(userId), roles = _a.roles, isLoading = _a.isLoading;
    var isAdmin = (0, react_1.useMemo)(function () {
        return roles.includes(permission_validator_1.SystemRole.ADMIN) || roles.includes(permission_validator_1.SystemRole.SUPER_ADMIN);
    }, [roles]);
    var isSuperAdmin = (0, react_1.useMemo)(function () {
...
function useMedicalAccess(userId) {
    var _a = usePermissions(userId), roles = _a.roles, isLoading = _a.isLoading;
    var isMedicalStaff = (0, react_1.useMemo)(function () {
        return roles.some(function (role) { return [
    ...
    var isDoctor = (0, react_1.useMemo)(function () {
        return roles.includes(permission_validator_1.SystemRole.DOCTOR);
    }, [roles]);
    var isNurse = (0, react_1.useMemo)(function () {
