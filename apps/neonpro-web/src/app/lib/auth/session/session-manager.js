        ...
        switch (_d.label) {
          case 0:
            ...
            _a = {
              ...
              email: user.email || "",
              role:
                ((_b = user.user_metadata) === null || _b === void 0 ? void 0 : _b.role) || "user",
              clinicId:
                ((_c = user.user_metadata) === null || _c === void 0 ? void 0 : _c.clinic_id) || "",
              lastActivity: now,
          ...
          case 1:
            sessionData = ((_a.ipAddress = _d.sent()), _a);
        ...
        switch (_a.label) {
          case 0:
            ...
            encryptedData = localStorage.getItem(
              "".concat(SESSION_CONFIG.STORAGE_KEY_PREFIX, "current"),
            );
            if (!encryptedData) return [2 /*return*/, null];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 5:
            ...
            _b.label = 6;
          case 6:
            return [4 /*yield*/, this.logActivity("session_refreshed")];
          case 7:
            _b.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.logActivity("session_destroyed", {
                sessionId: session.sessionId,
                duration:
                  Date.now() - (session.expiresAt - SESSION_CONFIG.TIMEOUT_MINUTES * 60 * 1000),
              }),
            ];
          case 4:
            _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.logActivity("session_terminated", { terminatedSessionId: sessionId }),
            ];
          case 1:
            _a.sent();
            return [2 /*return*/, true];
      ...
      function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4 /*yield*/, this.logActivity("session_timeout")];
              case 1:
                _a.sent();
                return [4 /*yield*/, this.destroySession()];
              case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        try {
          ...
          localStorage.setItem(
            "".concat(SESSION_CONFIG.STORAGE_KEY_PREFIX).concat(session.sessionId),
            encryptedData,
          );
        } catch (error) {
