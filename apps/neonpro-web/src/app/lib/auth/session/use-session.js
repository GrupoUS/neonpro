...
function useSession() {
    ...
    var _c = (0, react_1.useState)([]), activeSessions = _c[0], setActiveSessions = _c[1];
    var _d = (0, react_1.useState)(false), shouldRefreshToken = _d[0], setShouldRefreshToken = _d[1];
    ...
    (0, react_1.useEffect)(function () {
        var subscription = supabase.auth.onAuthStateChange(function (event, supabaseSession) { return __awaiter(_this, void 0, void 0, function () {
            var newSession, sessions, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(event === 'SIGNED_IN' && (supabaseSession === null || supabaseSession === void 0 ? void 0 : supabaseSession.user))) return [3 /*break*/, 6];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, SessionManager_1.sessionManager.createSession(supabaseSession.user)];
                    case 2:
                        newSession = _a.sent();
     ...
     */
    var destroySession = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
     ...
     */
    var updateActivity = (0, react_1.useCallback)(function (action, metadata) { return __awaiter(_this, void 0, void 0, function () {
        var updatedSession, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, SessionManager_1.sessionManager.updateActivity(action, metadata)
...
function useSessionActivity() {
     ...
     */
    var trackNavigation = (0, react_1.useCallback)(function (route) {
        updateActivity('navigation', { route: route });
    }, [updateActivity]);
    /**
     * Track user actions
     */
    var trackAction = (0, react_1.useCallback)(function (action, metadata) {
        updateActivity(action, metadata);
    }, [updateActivity]);
    /**
     * Track form submissions
     */
    var trackFormSubmission = (0, react_1.useCallback)(function (formName, success) {
        updateActivity('form_submission', { formName: formName, success: success });
    }, [updateActivity]);
    /**
     * Track API calls
     */
    var trackApiCall = (0, react_1.useCallback)(function (endpoint, method, status) {
