...
var AuthErrorHandler = /** @class */ (function () {
    ...
    AuthErrorHandler.prototype.createError = function (type, code, originalError, metadata) {
        ...
        var authError = {
            type: type,
            code: code,
            message: (originalError === null || originalError === void 0 ? void 0 : originalError.message) || errorConfig.technical,
            details: __assign({ originalError: originalError === null || originalError === void 0 ? void 0 : originalError.toString(), stack: originalError === null || originalError === void 0 ? void 0 : originalError.stack }, metadata),
    ...
    AuthErrorHandler.prototype.handleSessionError = function (error) {
        ...
        if ((_a = error === null || error === void 0 ? void 0 : error.message) === null || _a === void 0 ? void 0 : _a.includes('expired')) {
            code = 'session_expired';
        }
        else if ((_b = error === null || error === void 0 ? void 0 : error.message) === null || _b === void 0 ? void 0 : _b.includes('concurrent')) {
    ...
    AuthErrorHandler.prototype.displayError = function (error) {
        ...
        var toastOptions = {
            ...
            action: error.actionable ? {
                label: 'Como resolver',
                onClick: function () { return _this.showErrorDetails(error); }
            } : undefined
        };
    ...
    AuthErrorHandler.prototype.retry = function (operation_1, errorType_1) {
        return __awaiter(this, arguments, void 0, function (operation, errorType, maxRetries) {
            ...
            if (maxRetries === void 0) { maxRetries = RETRY_CONFIG.MAX_RETRIES; }
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        delay_1 = Math.min(RETRY_CONFIG.BASE_DELAY * Math.pow(RETRY_CONFIG.BACKOFF_FACTOR, attempt - 1), RETRY_CONFIG.MAX_DELAY);
                                        sonner_1.toast.info("Tentativa ".concat(attempt + 1, " de ").concat(maxRetries + 1, "..."), {
                                            duration: delay_1
                                        });
    ...
    AuthErrorHandler.prototype.getToastDuration = function (severity) {
        switch (severity) {
            case AuthErrorSeverity.LOW: return 3000;
            case AuthErrorSeverity.MEDIUM: return 5000;
            case AuthErrorSeverity.HIGH: return 8000;
            case AuthErrorSeverity.CRITICAL: return 10000;
            default: return 5000;
        }
    };
...
function handleAuthError(error, type) {
    ...
    if (((_a = error === null || error === void 0 ? void 0 : error.message) === null || _a === void 0 ? void 0 : _a.includes('oauth')) || ((_b = error === null || error === void 0 ? void 0 : error.message) === null || _b === void 0 ? void 0 : _b.includes('google'))) {
        return exports.authErrorHandler.handleOAuthError(error);
    }
    if (!navigator.onLine || (error === null || error === void 0 ? void 0 : error.code) === 'NETWORK_ERROR') {
        return exports.authErrorHandler.handleNetworkError(error);
    }
    if (((_c = error === null || error === void 0 ? void 0 : error.message) === null || _c === void 0 ? void 0 : _c.includes('session')) || ((_d = error === null || error === void 0 ? void 0 : error.message) === null || _d === void 0 ? void 0 : _d.includes('token'))) {
...
function withRetry(operation, type) {
    if (type === void 0) { type = AuthErrorType.UNKNOWN; }
