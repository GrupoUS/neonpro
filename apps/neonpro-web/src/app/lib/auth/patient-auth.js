...
var PatientAuthServer = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        // Record access for LGPD compliance
                        return [4 /*yield*/, PatientAuthServer.recordDataAccess(profile.id, 'profile_access', { accessed_fields: ['basic_info'] })];
                    case 4:
                        // Record access for LGPD compliance
                        _c.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        supabase = _a.sent();
                        return [4 /*yield*/, supabase.rpc('record_patient_data_access', {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        supabase = _b.sent();
                        return [4 /*yield*/, supabase.rpc('check_patient_consent', {
                                p_patient_id: patientId,
    ...
    PatientAuthServer.isPatientRoute = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, patientRoutes.some(function (route) { return path.startsWith(route); })];
            });
        });
    };
    PatientAuthServer.validatePatientAccess = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, PatientAuthServer.getCurrentPatient()];
                    case 1:
                        patient = _a.sent();
                        if (!patient) {
                            return [2 /*return*/, {
