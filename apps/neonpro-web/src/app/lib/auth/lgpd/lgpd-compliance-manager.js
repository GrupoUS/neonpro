...
var LGPDComplianceManager = /** @class */ (() => {
   ...
   */
  LGPDComplianceManager.prototype.recordConsent = function (
    userId_1,
    type_1,
    purpose_1,
    granted_1,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [4 /*yield*/, this.getClientIP()];
          case 2:
            request = ((_a.requestorIP = _b.sent()), (_a.description = description), _a);
            // Store request
            return [
              4 /*yield*/,
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            updatedSettings = __assign(__assign(__assign({}, currentSettings), settings), {
              lastUpdated: Date.now(),
            });
            // Store settings
            localStorage.setItem(
              "privacy_settings_".concat(userId),
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.recordConsent(userId, type, this.getDefaultPurpose(type), granted),
            ];
          case 3:
            _c.sent();
            _c.label = 4;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 6:
            userData = ((_a.auditLog = _b.sent()), _a);
            // Log export event
            return [
              4 /*yield*/,
              security_audit_logger_1.securityAuditLogger.logEvent(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [3 /*break*/, 4];
          case 2:
            return [4 /*yield*/, this.hardDeleteUserData(userId)];
          case 3:
            _a.sent();
            _a.label = 4;
          case 4:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 4:
            summary =
              ((_a.dataRetentionCompliance = _b.sent()),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [3 /*break*/, 10];
          case 1:
            return [4 /*yield*/, this.exportUserData(request.userId)];
          case 2:
            userData = _b.sent();
