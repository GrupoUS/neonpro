      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            if (!(event_1.severity === AuditSeverity.CRITICAL || this.eventQueue.length >= 10))
              return [3 /*break*/, 5];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.logEvent(AuditEventType.LOGIN_FAILURE, {
                email: email,
                reason: reason,
                method: method,
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              ...
              this.logEvent(
                eventType,
                __assign({ provider: "google", flowDuration: details.duration }, details),
              ),
            ];
          case 1:
            _a.sent();
          ...
          case 0:
            ...
            if (event.type === AuditEventType.LOGIN_FAILURE) {
              ...
              if (failedLogins.length >= SUSPICIOUS_PATTERNS.MULTIPLE_FAILED_LOGINS.threshold) {
                suspiciousPatterns.push({
                  ...
                  description: ""
                    .concat(failedLogins.length, " tentativas de login falharam para ")
                    .concat(event.email),
            ...
            if (rapidAttempts.length >= SUSPICIOUS_PATTERNS.RAPID_LOGIN_ATTEMPTS.threshold) {
              suspiciousPatterns.push({
                ...
                description: ""
                  .concat(rapidAttempts.length, " tentativas r\u00E1pidas de login do IP ")
                  .concat(event.ipAddress),
  ...
  SecurityAuditLogger.prototype.getSecurityReport = function () {
    return __awaiter(this, arguments, void 0, function (hoursBack) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getSecurityMetrics(hoursBack)];
          case 1:
            metrics = _a.sent();
  ...
  SecurityAuditLogger.prototype.processEventQueue = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            if (this.isProcessing || this.eventQueue.length === 0) return [2 /*return*/];
