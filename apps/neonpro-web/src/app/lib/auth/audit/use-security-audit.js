...
function useSecurityAudit(options) {
          ...
          switch (_a.label) {
            ...
            case 2:
              ...
              if (enableRealTimeAlerts) {
                newAlerts_1 = report.suspiciousPatterns.filter(
                  (pattern) => pattern.riskLevel === "high" || pattern.riskLevel === "critical",
                );
                if (newAlerts_1.length > 0) {
                  setAlerts((prev) =>
                    __spreadArray(__spreadArray([], prev, true), newAlerts_1, true),
                  );
                }
              }
              return [3 /*break*/, 4];
  ...
  var clearAlert = (0, react_1.useCallback)((index) => {
  ...
  return __awaiter(this, arguments, void 0, function (limit) {
    ...
    return __generator(this, (_a) => {
      try {
        ...
        return [2 /*return*/, events.sort((a, b) => b.timestamp - a.timestamp).slice(0, limit)];
      } catch (_b) {
        return [2 /*return*/, []];
      }
      return [2 /*return*/];
...
function useAuthAudit() {
  var logLoginAttempt = (0, react_1.useCallback)((email_1) => {
    var args_1 = [];
  ...
  var logLoginSuccess = (0, react_1.useCallback)((userId_1, sessionId_1) => {
    var args_1 = [];
  ...
  var logLoginFailure = (0, react_1.useCallback)((email_1, reason_1) => {
    var args_1 = [];
    for (var _i = 2; _i < arguments.length; _i++) {
      args_1[_i - 2] = arguments[_i];
    }
  ...
  var logOAuthFlow = (0, react_1.useCallback)(
    (stage, details) =>
      __awaiter(this, void 0, void 0, function () {
        return __generator(this, (_a) => {
          switch (_a.label) {
  ...
  var logSessionEvent = (0, react_1.useCallback)(
    (type, userId, sessionId, details) =>
      __awaiter(this, void 0, void 0, function () {
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
  ...
  var logPermissionDenied = (0, react_1.useCallback)(
