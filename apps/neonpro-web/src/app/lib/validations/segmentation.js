...
exports.SegmentationSchemas =
  exports.SegmentValidationResultSchema =
  exports.PerformancePredictionSchema =
  exports.ValidationWarningSchema =
  exports.ValidationErrorSchema =
  exports.SegmentBuilderConfigSchema =
  exports.AISuggestionSchema =
  exports.OperatorDefinitionSchema =
  exports.FieldDefinitionSchema =
  exports.SegmentValidationRequestSchema =
  exports.BulkSegmentUpdateSchema =
  exports.SegmentMembersQuerySchema =
  exports.SegmentationQuerySchema =
  exports.CreateRuleSchema =
  exports.SegmentationRuleSchema =
  exports.AIModelSchema =
  exports.TrainingDataInfoSchema =
  exports.ModelParametersSchema =
  exports.SegmentPerformanceSchema =
  exports.PatientAnalyticsSchema =
  exports.PreferencePredictionsSchema =
  exports.PersonalityProfileSchema =
  exports.AIInsightsSchema =
  exports.NextBestActionSchema =
  exports.RecommendationSchema =
  exports.CommunicationPreferenceSchema =
  exports.PatientSegmentMembershipSchema =
  exports.MembershipReasonSchema =
  exports.TreatmentPropensitySchema =
  exports.UpdateSegmentSchema =
  exports.CreateSegmentSchema =
  exports.PatientSegmentSchema =
  exports.RuleLogicSchema =
  exports.RuleConditionSchema =
  exports.SegmentCriteriaSchema =
  exports.CriteriaRuleSchema =
  exports.PeriodTypeSchema =
  exports.ModelStatusSchema =
  exports.ModelTypeSchema =
  exports.HealthTrendSchema =
  exports.RiskLevelSchema =
  exports.RevenueTrendSchema =
  exports.EngagementLevelSchema =
  exports.UpdateFrequencySchema =
  exports.SegmentTypeSchema =
    void 0;
...
exports.UpdateFrequencySchema = zod_1.z.enum(["real_time", "hourly", "daily", "weekly", "monthly"]);
exports.EngagementLevelSchema = zod_1.z.enum(["very_low", "low", "medium", "high", "very_high"]);
exports.RevenueTrendSchema = zod_1.z.enum(["declining", "stable", "growing", "volatile"]);
exports.RiskLevelSchema = zod_1.z.enum(["very_low", "low", "medium", "high", "very_high"]);
exports.HealthTrendSchema = zod_1.z.enum(["declining", "stable", "improving", "fluctuating"]);
...
exports.PeriodTypeSchema = zod_1.z.enum(["daily", "weekly", "monthly", "quarterly", "yearly"]);
// =====================================================================================
...
// =====================================================================================
exports.TreatmentPropensitySchema = zod_1.z.record(
  zod_1.z.string(),
  zod_1.z.object({
...
// =====================================================================================
exports.SegmentPerformanceSchema = zod_1.z
  .object({
    id: zod_1.z.string().uuid(),
    segment_id: zod_1.z.string().uuid(),
    // Time Period
