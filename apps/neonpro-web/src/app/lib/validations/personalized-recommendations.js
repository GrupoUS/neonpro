...
exports.performanceQuerySchema = exports.feedbackQuerySchema = exports.recommendationQuerySchema = exports.recordPerformanceRequestSchema = exports.createProtocolCustomizationRequestSchema = exports.updateSafetyProfileRequestSchema = exports.createPersonalizationFactorRequestSchema = exports.createRecommendationFeedbackRequestSchema = exports.approveRecommendationRequestSchema = exports.createTreatmentRecommendationRequestSchema = exports.updateRecommendationProfileRequestSchema = exports.createRecommendationProfileRequestSchema = exports.recommendationPerformanceSchema = exports.protocolCustomizationSchema = exports.protocolModificationSchema = exports.safetyProfileSchema = exports.safetyAlertSchema = exports.medicalConditionSchema = exports.drugInteractionSchema = exports.allergySchema = exports.personalizationFactorSchema = exports.recommendationFeedbackSchema = exports.treatmentRecommendationSchema = exports.treatmentAlternativeSchema = exports.contraindicationSchema = exports.riskAssessmentSchema = exports.treatmentOptionSchema = exports.recommendationProfileSchema = void 0;
...
exports.treatmentOptionSchema = zod_1.z.object({
    ...
    type: zod_1.z.enum(['aesthetic', 'dermatological', 'cosmetic', 'therapeutic', 'preventive', 'maintenance']),
...
exports.riskAssessmentSchema = zod_1.z.object({
    ...
    risk_factors: zod_1.z.array(zod_1.z.object({
        ...
        factor_type: zod_1.z.enum(['genetic', 'environmental', 'behavioral', 'medical', 'social', 'occupational']),
        risk_level: zod_1.z.enum(['very_low', 'low', 'moderate', 'high', 'very_high']),
...
exports.treatmentRecommendationSchema = zod_1.z.object({
    ...
    status: zod_1.z.enum(['pending', 'approved', 'rejected', 'implemented', 'completed', 'expired']).default('pending'),
...
exports.recommendationFeedbackSchema = zod_1.z.object({
    ...
    provider_id: zod_1.z.string().uuid(),
    feedback_type: zod_1.z.enum(['accuracy', 'usefulness', 'adoption', 'quality', 'improvement', 'general']),
    adoption_status: zod_1.z.enum(['adopted', 'modified', 'rejected', 'pending', 'partially_adopted']),
...
exports.drugInteractionSchema = zod_1.z.object({
    ...
    interaction_type: zod_1.z.enum(['antagonistic', 'synergistic', 'additive', 'competitive', 'incompatible']),
    severity: zod_1.z.enum(['mild', 'moderate', 'severe', 'critical']),
    description: zod_1.z.string().min(10).max(1000),
...
exports.safetyAlertSchema = zod_1.z.object({
    id: zod_1.z.string(),
    alert_type: zod_1.z.enum(['contraindication', 'allergy', 'interaction', 'safety', 'monitoring', 'dose_adjustment']),
    severity: zod_1.z.enum(['mild', 'moderate', 'severe', 'critical']),
...
exports.protocolCustomizationSchema = zod_1.z.object({
    ...
    approval_status: zod_1.z.enum(['pending', 'approved', 'rejected', 'requires_review', 'expired']).default('pending'),
...
exports.recommendationQuerySchema = zod_1.z.object({
    ...
    status: zod_1.z.enum(['pending', 'approved', 'rejected', 'implemented', 'completed', 'expired']).optional(),
    recommendation_type: zod_1.z.enum([
        'primary_treatment',
        'alternative_therapy',
        'combination_therapy',
...
exports.feedbackQuerySchema = zod_1.z.object({
    ...
    provider_id: zod_1.z.string().uuid().optional(),
    feedback_type: zod_1.z.enum(['accuracy', 'usefulness', 'adoption', 'quality', 'improvement', 'general']).optional(),
    adoption_status: zod_1.z.enum(['adopted', 'modified', 'rejected', 'pending', 'partially_adopted']).optional(),
    limit: zod_1.z.coerce.number().min(1).max(100).default(20),
    offset: zod_1.z.coerce.number().min(0).default(0),
    sort_by: zod_1.z.enum(['created_at', 'quality_rating', 'usefulness_rating']).default('created_at'),
    sort_order: zod_1.z.enum(['asc', 'desc']).default('desc'),
});
