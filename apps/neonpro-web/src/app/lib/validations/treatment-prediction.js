...
exports.UpdateTreatmentPredictionSchema = exports.UpdateTreatmentCharacteristicsSchema = exports.UpdatePredictionModelSchema = exports.UpdatePatientFactorsSchema = exports.PerformanceFiltersSchema = exports.ModelFiltersSchema = exports.PredictionFiltersSchema = exports.TrainingResponseSchema = exports.TrainingRequestSchema = exports.BatchPredictionResponseSchema = exports.PredictionSummarySchema = exports.BatchPredictionRequestSchema = exports.PredictionRequestSchema = exports.PredictionResponseSchema = exports.RiskFactorSchema = exports.AlternativeTreatmentSchema = exports.TreatmentRecommendationSchema = exports.PredictionFeedbackSchema = exports.ModelPerformanceSchema = exports.TreatmentCharacteristicsSchema = exports.TreatmentPredictionSchema = exports.PredictionModelSchema = exports.ExplainabilityDataSchema = exports.PredictionFeaturesSchema = exports.PatientFactorsSchema = exports.GeographicFactorsSchema = exports.SocialFactorsSchema = exports.PsychologicalFactorsSchema = exports.TreatmentHistorySchema = exports.TreatmentHistoryItemSchema = exports.LifestyleFactorsSchema = exports.MedicalHistorySchema = exports.SideEffectsSchema = exports.CostRangeSchema = exports.ModelPerformanceMetricsSchema = exports.ConfidenceIntervalSchema = void 0;
...
exports.ConfidenceIntervalSchema = zod_1.z.object({
    ...
    confidence_level: zod_1.z.number().min(0).max(1).default(0.95).describe('Confidence level (e.g., 0.95 for 95%)')
}).refine(function (data) { return data.lower <= data.upper; }, {
...
exports.PredictionModelSchema = zod_1.z.object({
    ...
    algorithm_type: zod_1.z.enum(['ensemble', 'neural_network', 'random_forest', 'gradient_boosting', 'svm']),
    accuracy: zod_1.z.number().min(0).max(1).refine(function (val) { return val >= 0.85; }, {
...
exports.ModelFiltersSchema = zod_1.z.object({
    ...
    algorithm_type: zod_1.z.enum(['ensemble', 'neural_network', 'random_forest', 'gradient_boosting', 'svm']).optional(),
