...
exports.aiPersonalizationSchema = exports.aiTimingOptimizationSchema = exports.messageTemplateSchema = exports.followupFiltersSchema = exports.updateFollowupStatusSchema = exports.treatmentOutcomeSchema = exports.createTreatmentOutcomeSchema = exports.createPatientFollowupSchema = exports.createFollowupProtocolSchema = exports.performanceAnalyticsSchema = exports.escalationRuleSchema = exports.followupCommunicationSchema = exports.patientFollowupSchema = exports.followupProtocolSchema = void 0;
...
exports.patientFollowupSchema = zod_1.z.object({
    ...
    scheduled_time: zod_1.z.string().regex(/^\d{2}:\d{2}$/, 'Hora inválida').optional(),
    ...
    backup_channels: zod_1.z.array(zod_1.z.enum(['sms', 'whatsapp', 'email', 'phone'])).default(['email', 'phone']),
    language_preference: zod_1.z.string().max(10).default('pt-BR'),
    // Status tracking
    status: zod_1.z.enum(['scheduled', 'sent', 'completed', 'missed', 'cancelled', 'escalated']).default('scheduled'),
...
exports.followupCommunicationSchema = zod_1.z.object({
    ...
    delivery_status: zod_1.z.enum(['pending', 'sent', 'delivered', 'failed', 'read']).default('pending'),
...
exports.escalationRuleSchema = zod_1.z.object({
    ...
    protocol_id: zod_1.z.string().uuid(),
    // Trigger conditions
    trigger_condition: zod_1.z.enum(['missed_followup', 'negative_response', 'urgent_symptoms', 'manual_escalation']),
    ...
    notification_channels: zod_1.z.array(zod_1.z.enum(['email', 'sms', 'whatsapp', 'phone', 'dashboard'])),
...
exports.createFollowupProtocolSchema = zod_1.z.object({
    ...
    protocol_source: zod_1.z.string().max(500).optional(),
    initial_followup_days: zod_1.z.number().int().min(0).max(365),
    subsequent_intervals: zod_1.z.array(zod_1.z.number().int().min(1).max(365)).min(1, 'Pelo menos um intervalo é obrigatório'),
    max_followups: zod_1.z.number().int().min(1).max(20).default(4),
    urgent_threshold_hours: zod_1.z.number().int().min(1).max(168).default(24),
    automation_level: zod_1.z.number().min(0.5).max(1.0),
    auto_schedule_enabled: zod_1.z.boolean().default(true),
...
exports.createPatientFollowupSchema = zod_1.z.object({
    ...
    scheduled_time: zod_1.z.string().regex(/^\d{2}:\d{2}$/, 'Hora inválida (use HH:MM)').optional(),
    preferred_channel: zod_1.z.enum(['sms', 'whatsapp', 'email', 'phone']).default('sms'),
    backup_channels: zod_1.z.array(zod_1.z.enum(['sms', 'whatsapp', 'email', 'phone'])).default(['email', 'phone']),
    language_preference: zod_1.z.string().max(10).default('pt-BR'),
    shadow_test_variant: zod_1.z.string().max(50).optional()
...
exports.createTreatmentOutcomeSchema = zod_1.z.object({
    ...
    data_source: zod_1.z.enum(['patient_report', 'clinical_exam', 'automated_assessment']).default('patient_report'),
...
exports.followupFiltersSchema = zod_1.z.object({
    ...
    status: zod_1.z.enum(['scheduled', 'sent', 'completed', 'missed', 'cancelled', 'escalated']).optional(),
