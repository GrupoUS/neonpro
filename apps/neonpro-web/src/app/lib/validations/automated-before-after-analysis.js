...
exports.validationSchemas = exports.bulkDeleteSchema = exports.bulkUpdatePhotoPairSchema = exports.bulkUpdateAnalysisSessionSchema = exports.photoPairSortSchema = exports.analysisSessionSortSchema = exports.paginationSchema = exports.updateMLModelTrainingSchema = exports.updateTreatmentAreaSchema = exports.updateMeasurementMetricSchema = exports.updateAnalysisEngineConfigSchema = exports.updatePhotoPairSchema = exports.updateAnalysisSessionSchema = exports.reportFiltersSchema = exports.analysisResultFiltersSchema = exports.photoPairFiltersSchema = exports.analysisSessionFiltersSchema = exports.annotationCreateRequestSchema = exports.accuracyValidationRequestSchema = exports.modelTrainingRequestSchema = exports.batchAnalysisRequestSchema = exports.generateReportRequestSchema = exports.comparisonAnalysisRequestSchema = exports.startAnalysisRequestSchema = exports.createPhotoPairRequestSchema = exports.createAnalysisSessionRequestSchema = exports.mlModelTrainingSchema = exports.qualityValidationSchema = exports.analysisReportSchema = exports.visualAnnotationSchema = exports.treatmentAreaSchema = exports.measurementMetricSchema = exports.imageAnalysisResultSchema = exports.beforeAfterPhotoPairSchema = exports.photoAnalysisSessionSchema = exports.analysisEngineConfigSchema = void 0;
...
exports.photoAnalysisSessionSchema = zod_1.z.object({
    ...
    status: zod_1.z.enum(['pending', 'processing', 'completed', 'failed', 'queued']).default('pending'),
...
exports.beforeAfterPhotoPairSchema = zod_1.z.object({
    ...
    analysis_status: zod_1.z.enum(['pending', 'analyzed', 'failed', 'manual_review']).default('pending'),
...
exports.measurementMetricSchema = zod_1.z.object({
    ...
    metric_type: zod_1.z.enum(['distance', 'area', 'volume', 'angle', 'texture', 'color', 'symmetry']),
...
exports.visualAnnotationSchema = zod_1.z.object({
    ...
    annotation_type: zod_1.z.enum(['highlight', 'measurement', 'comparison', 'change_area', 'improvement_zone']),
...
exports.analysisReportSchema = zod_1.z.object({
    id: zod_1.z.string().uuid().optional(),
    session_id: zod_1.z.string().uuid(),
    report_type: zod_1.z.enum(['summary', 'detailed', 'patient_consultation', 'clinical', 'research']),
...
exports.qualityValidationSchema = zod_1.z.object({
    ...
    validation_status: zod_1.z.enum(['pending', 'approved', 'rejected', 'needs_review']).default('pending'),
...
exports.mlModelTrainingSchema = zod_1.z.object({
    ...
    deployment_status: zod_1.z.enum(['training', 'completed', 'deployed', 'archived']).default('training'),
...
exports.analysisSessionFiltersSchema = zod_1.z.object({
    ...
    treatment_type: zod_1.z.string().max(100).optional(),
    analysis_type: zod_1.z.enum(['before_after', 'progress_tracking', 'treatment_validation']).optional(),
...
exports.photoPairFiltersSchema = zod_1.z.object({
    ...
    treatment_area: zod_1.z.string().max(100).optional(),
    pair_type: zod_1.z.enum(['frontal', 'profile', 'close_up', 'full_body', 'specific_area']).optional(),
...
exports.reportFiltersSchema = zod_1.z.object({
    session_id: zod_1.z.string().uuid().optional(),
    report_type: zod_1.z.enum(['summary', 'detailed', 'patient_consultation', 'clinical', 'research']).optional(),
    generated_by: zod_1.z.string().uuid().optional(),
    date_from: zod_1.z.string().date().optional(),
    date_to: zod_1.z.string().date().optional(),
...
exports.bulkDeleteSchema = zod_1.z.object({
    ...
    confirm: zod_1.z.boolean().refine(function (val) { return val === true; }, {
