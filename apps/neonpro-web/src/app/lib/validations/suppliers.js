...
exports.supplierComparisonSchema = exports.performanceAnalysisSchema = exports.bulkCreateContactsSchema = exports.bulkUpdateSuppliersSchema = exports.qualityIssueFiltersSchema = exports.supplierFiltersSchema = exports.createContactSchema = exports.createCommunicationSchema = exports.createQualityIssueSchema = exports.createEvaluationSchema = exports.createContractSchema = exports.updateSupplierSchema = exports.createSupplierSchema = exports.supplierQualityIssueSchema = exports.supplierCommunicationSchema = exports.supplierEvaluationSchema = exports.supplierPerformanceSchema = exports.supplierContactSchema = exports.supplierContractSchema = exports.supplierSchema = exports.volumeDiscountTierSchema = exports.issueStatusSchema = exports.severityLevelSchema = exports.qualityIssueTypeSchema = exports.priorityLevelSchema = exports.communicationStatusSchema = exports.communicationDirectionSchema = exports.communicationMethodSchema = exports.communicationTypeSchema = exports.riskLevelSchema = exports.performanceGradeSchema = exports.evaluationTypeSchema = exports.contactTypeSchema = exports.contractStatusSchema = exports.contractTypeSchema = exports.supplierStatusSchema = exports.supplierRatingSchema = exports.supplierTypeSchema = void 0;
...
exports.performanceGradeSchema = zod_1.z.enum([
    'A+',
    'A',
    'B+',
    'B',
...
exports.communicationDirectionSchema = zod_1.z.enum([
    'outbound',
    'inbound'
]);
...
exports.priorityLevelSchema = zod_1.z.enum([
    'low',
    'medium',
    'high',
    'urgent'
...
// =====================================================================================
exports.volumeDiscountTierSchema = zod_1.z.object({
...
}).refine(function (data) { return !data.max_quantity || data.max_quantity > data.min_quantity; }, {
...
exports.supplierContractSchema = zod_1.z.object({
    id: zod_1.z.string().uuid(),
    supplier_id: zod_1.z.string().uuid(),
    // Contract Information
    contract_number: zod_1.z.string()
    ...
    created_at: zod_1.z.string().datetime(),
    updated_at: zod_1.z.string().datetime()
}).refine(function (data) { return !data.end_date || new Date(data.end_date) > new Date(data.start_date); }, {
    message: "Data de fim deve ser posterior à data de início",
    path: ["end_date"]
});
exports.supplierContactSchema = zod_1.z.object({
    id: zod_1.z.string().uuid(),
    supplier_id: zod_1.z.string().uuid(),
    // Contact Information
    ...
    created_at: zod_1.z.string().datetime(),
    updated_at: zod_1.z.string().datetime()
}).refine(function (data) { return data.email || data.phone || data.mobile; }, {
    message: "Pelo menos um método de contato deve ser fornecido",
    path: ["email"]
});
exports.supplierPerformanceSchema = zod_1.z.object({
    id: zod_1.z.string().uuid(),
    supplier_id: zod_1.z.string().uuid(),
    // Time Period
...
}).refine(function (data) { return new Date(data.period_end) > new Date(data.period_start); }, {
    message: "Data de fim deve ser posterior à data de início",
    path: ["period_end"]
});
exports.supplierEvaluationSchema = zod_1.z.object({
    id: zod_1.z.string().uuid(),
    supplier_id: zod_1.z.string().uuid(),
    ...
    delivery_reliability: zod_1.z.number()
        .min(1, 'Nota mínima é 1')
        .max(10, 'Nota máxima é 10'),
    product_quality: zod_1.z.number()
        .min(1, 'Nota mínima é 1')
        .max(10, 'Nota máxima é 10'),
    customer_service: zod_1.z.number()
        .min(1, 'Nota mínima é 1')
        .max(10, 'Nota máxima é 10'),
    pricing_competitiveness: zod_1.z.number()
        .min(1, 'Nota mínima é 1')
        .max(10, 'Nota máxima é 10'),
    technical_support: zod_1.z.number()
        .min(1, 'Nota mínima é 1')
        .max(10, 'Nota máxima é 10'),
    documentation_quality: zod_1.z.number()
        .min(1, 'Nota mínima é 1')
        .max(10, 'Nota máxima é 10'),
    // Calculated Scores
    ...
    created_at: zod_1.z.string().datetime(),
    updated_at: zod_1.z.string().datetime()
}).refine(function (data) { return new Date(data.evaluation_period_end) > new Date(data.evaluation_period_start); }, {
    message: "Data de fim deve ser posterior à data de início",
...
// FILTER SCHEMAS
// =====================================================================================
exports.supplierFiltersSchema = zod_1.z.object({
...
exports.qualityIssueFiltersSchema = zod_1.z.object({
...
exports.bulkUpdateSuppliersSchema = zod_1.z.object({
    supplier_ids: zod_1.z.array(zod_1.z.string().uuid()).min(1, 'Pelo menos um fornecedor deve ser selecionado'),
...
exports.bulkCreateContactsSchema = zod_1.z.object({
    supplier_id: zod_1.z.string().uuid(),
    contacts: zod_1.z.array(exports.createContactSchema).min(1, 'Pelo menos um contato deve ser fornecido')
});
// =====================================================================================
// ANALYSIS AND REPORTING SCHEMAS
// =====================================================================================
exports.performanceAnalysisSchema = zod_1.z.object({
...
exports.supplierComparisonSchema = zod_1.z.object({
    supplier_ids: zod_1.z.array(zod_1.z.string().uuid())
        .min(2, 'Pelo menos 2 fornecedores devem ser selecionados')
        .max(10, 'Máximo de 10 fornecedores por comparação'),
    comparison_criteria: zod_1.z.array(zod_1.z.string()).min(1, 'Pelo menos um critério deve ser selecionado'),
