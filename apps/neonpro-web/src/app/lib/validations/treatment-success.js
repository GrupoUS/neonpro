...
exports.complianceReportQuerySchema =
  ...
  exports.providerPerformanceQuerySchema =
  exports.successMetricsQuerySchema =
  exports.treatmentSuccessQuerySchema =
  exports.updateComplianceReportSchema =
  exports.createComplianceReportSchema =
  exports.updateSuccessPredictionSchema =
  exports.createSuccessPredictionSchema =
  exports.updateQualityBenchmarkSchema =
  exports.createQualityBenchmarkSchema =
  exports.updateProtocolOptimizationSchema =
  exports.createProtocolOptimizationSchema =
  exports.createProviderPerformanceSchema =
  exports.createSuccessMetricsSchema =
  exports.updateTreatmentOutcomeSchema =
...
exports.updateTreatmentOutcomeSchema = zod_1.z.object({
  ...
  success_score: zod_1.z
    .number()
    .min(0)
    .max(1, "Score de sucesso deve estar entre 0 e 1")
    .optional(),
  ...
  patient_satisfaction_score: zod_1.z
    .number()
    .min(0)
    .max(1, "Score de satisfação deve estar entre 0 e 1")
    .optional(),
...
exports.createSuccessMetricsSchema = zod_1.z
  .object({
    treatment_type: zod_1.z.string().min(1, "Tipo de tratamento é obrigatório").max(100),
    ...
    successful_treatments: zod_1.z
      .number()
      .int()
      .min(0, "Tratamentos bem-sucedidos deve ser positivo"),
    success_rate: zod_1.z.number().min(0).max(1, "Taxa de sucesso deve estar entre 0 e 1"),
    average_satisfaction: zod_1.z
      .number()
      .min(0)
      .max(1, "Satisfação média deve estar entre 0 e 1")
      .optional(),
    complication_rate: zod_1.z
      .number()
      .min(0)
      .max(1, "Taxa de complicação deve estar entre 0 e 1")
      .optional(),
...
exports.createProviderPerformanceSchema = zod_1.z.object({
  ...
  overall_success_rate: zod_1.z
    .number()
    .min(0)
    .max(1, "Taxa de sucesso deve estar entre 0 e 1")
    .optional(),
  patient_satisfaction_avg: zod_1.z
    .number()
    .min(0)
    .max(1, "Satisfação média deve estar entre 0 e 1")
    .optional(),
...
exports.createSuccessPredictionSchema = zod_1.z.object({
  ...
  confidence_score: zod_1.z
    .number()
    .min(0)
    .max(1, "Score de confiança deve estar entre 0 e 1")
    .optional(),
...
exports.updateSuccessPredictionSchema = zod_1.z.object({
  predicted_success_rate: zod_1.z
    .number()
    .min(0)
    .max(1, "Taxa de sucesso predita deve estar entre 0 e 1")
    .optional(),
...
exports.createComplianceReportSchema = zod_1.z.object({
  ...
  compliance_score: zod_1.z
    .number()
    .min(0)
    .max(1, "Score de conformidade deve estar entre 0 e 1")
    .optional(),
...
exports.treatmentSuccessQuerySchema = zod_1.z.object({
  ...
  success_rate_min: zod_1.z
    ...
    .optional(),
  success_rate_max: zod_1.z
    .string()
    .transform(Number)
    .pipe(zod_1.z.number().min(0).max(1))
    .optional(),
  satisfaction_min: zod_1.z
    .string()
    .transform(Number)
    .pipe(zod_1.z.number().min(0).max(1))
    .optional(),
...
exports.protocolOptimizationQuerySchema = zod_1.z.object({
  ...
  implementation_priority: zod_1.z.enum(["low", "medium", "high", "critical"]).optional(),
  approval_status: zod_1.z.enum(["pending", "approved", "rejected", "implemented"]).optional(),
  success_improvement_min: zod_1.z
    .string()
    .transform(Number)
