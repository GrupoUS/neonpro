...
exports.ABTestCreateSchema = exports.bulkBudgetCreateSchema = exports.approvalSchema = exports.budgetSchema = exports.createForecastingScenarioSchema = exports.predictionPeriodTypeSchema = exports.updateProtocolVersionSchema = exports.createProtocolVersionSchema = exports.createProtocolOutcomeSchema = exports.updateProtocolFeedbackSchema = exports.createProtocolFeedbackSchema = exports.updateProtocolExperimentSchema = exports.createProtocolExperimentSchema = exports.CampaignQuerySchema = exports.CreateConsentSchema = exports.MarketingConsentSchema = exports.CreateABTestSchema = exports.CampaignABTestSchema = exports.CampaignExecutionSchema = exports.UpdateCampaignSchema = exports.CreateCampaignSchema = exports.MarketingCampaignSchema = exports.CreateCampaignTemplateSchema = exports.CampaignTemplateSchema = void 0;
...
exports.MarketingCampaignSchema = zod_1.z.object({
    ...
    delivery_channels: zod_1.z.array(zod_1.z.string()).min(1, 'At least one delivery channel is required'),
    ...
    automation_level: zod_1.z.number().min(0).max(1).default(0.80), // ≥80% automation target
    status: zod_1.z.enum(['draft', 'scheduled', 'running', 'paused', 'completed', 'cancelled']).default('draft'),
...
exports.CreateCampaignSchema = zod_1.z.object({
    ...
    target_segments: zod_1.z.record(zod_1.z.any()),
    content: zod_1.z.record(zod_1.z.any()),
    delivery_channels: zod_1.z.array(zod_1.z.enum(['email', 'sms', 'whatsapp', 'push'])).min(1, 'At least one delivery channel is required'),
    schedule_config: zod_1.z.record(zod_1.z.any()).optional(),
    trigger_config: zod_1.z.record(zod_1.z.any()).optional(),
    personalization_config: zod_1.z.record(zod_1.z.any()).optional(),
    send_time_optimization: zod_1.z.boolean().default(true),
    automation_level: zod_1.z.number().min(0.80, 'Automation level must be at least 80%').max(1).default(0.80),
    start_date: zod_1.z.string().optional(),
    end_date: zod_1.z.string().optional()
...
exports.UpdateCampaignSchema = zod_1.z.object({
    id: zod_1.z.string().uuid(),
    name: zod_1.z.string().min(1, 'Campaign name is required').max(255, 'Campaign name too long').optional(),
    description: zod_1.z.string().optional(),
    campaign_type: zod_1.z.enum(['automated', 'manual', 'trigger-based', 'a-b-test']).optional(),
    template_id: zod_1.z.string().uuid().optional(),
    target_segments: zod_1.z.record(zod_1.z.any()).optional(),
    content: zod_1.z.record(zod_1.z.any()).optional(),
    delivery_channels: zod_1.z.array(zod_1.z.enum(['email', 'sms', 'whatsapp', 'push'])).min(1, 'At least one delivery channel is required').optional(),
    schedule_config: zod_1.z.record(zod_1.z.any()).optional(),
    trigger_config: zod_1.z.record(zod_1.z.any()).optional(),
    personalization_config: zod_1.z.record(zod_1.z.any()).optional(),
    send_time_optimization: zod_1.z.boolean().optional(),
    automation_level: zod_1.z.number().min(0.80, 'Automation level must be at least 80%').max(1).optional(),
    start_date: zod_1.z.string().optional(),
    end_date: zod_1.z.string().optional()
});
...
exports.CampaignExecutionSchema = zod_1.z.object({
    ...
    execution_status: zod_1.z.enum(['pending', 'sending', 'sent', 'failed', 'cancelled']).default('pending'),
...
exports.CampaignABTestSchema = zod_1.z.object({
    ...
    confidence_level: zod_1.z.number().min(0.80).max(0.99).default(0.95),
...
exports.CreateConsentSchema = zod_1.z.object({
    ...
    consent_status: zod_1.z.boolean(),
    consent_source: zod_1.z.string().optional(),
    consent_date: zod_1.z.string().default(function () { return new Date().toISOString(); }),
    expiry_date: zod_1.z.string().optional(),
    legal_basis: zod_1.z.string().optional(),
    consent_text: zod_1.z.string().optional()
});
