...
exports.ValidationStatusSchema = exports.UpdateRetentionMetricsSchema = exports.UpdateRetentionInterventionSchema = exports.UpdateRetentionCampaignAnalyticsSchema = exports.UpdatePatientRetentionAnalyticsSchema = exports.UpdatePatientChurnPredictionSchema = exports.RetentionMetricsSchema = exports.RetentionMetricsRequestSchema = exports.RetentionInterventionSchema = exports.RetentionInterventionRequestSchema = exports.RetentionInterventionFormSchema = exports.RetentionCampaignAnalyticsSchema = exports.RetentionAnalyticsRequestSchema = exports.RetentionAnalyticsQuerySchema = exports.PatientRetentionAnalyticsSchema = exports.PatientChurnPredictionSchema = exports.OutcomeSchema = exports.ModelTypeSchema = exports.InterventionStatusSchema = exports.InterventionQuerySchema = exports.InterventionChannelSchema = exports.DeploymentStatusSchema = exports.CreateRetentionMetricsSchema = exports.CreateRetentionInterventionSchema = exports.CreateRetentionCampaignAnalyticsSchema = exports.CreatePatientRetentionAnalyticsSchema = exports.CreatePatientChurnPredictionSchema = exports.ClinicSizeCategorySchema = exports.ChurnRiskLevelSchema = exports.ChurnPredictionRequestSchema = exports.ChurnPredictionQuerySchema = exports.BenchmarkTypeSchema = void 0;
...
var InterventionChannelSchema = zod_1.z.enum(['email', 'sms', 'whatsapp', 'phone', 'in_person', 'push']);
exports.InterventionChannelSchema = InterventionChannelSchema;
var InterventionStatusSchema = zod_1.z.enum(['planned', 'scheduled', 'sent', 'delivered', 'opened', 'clicked', 'responded', 'failed']);
...
var BenchmarkTypeSchema = zod_1.z.enum(['retention_rate', 'churn_rate', 'ltv', 'intervention_effectiveness']);
...
var PatientRetentionAnalyticsSchema = zod_1.z.object({
    ...
    retention_interventions: zod_1.z.array(zod_1.z.object({
...
var PatientChurnPredictionSchema = zod_1.z.object({
    ...
    contributing_factors: zod_1.z.array(zod_1.z.object({
        ...
        category: zod_1.z.enum(['behavioral', 'financial', 'clinical', 'satisfaction', 'demographic']),
        description: zod_1.z.string().min(1)
    })).default([]),
    intervention_recommendations: zod_1.z.array(zod_1.z.object({
        intervention_type: zod_1.z.string().min(1),
...
var CreateRetentionMetricsSchema = RetentionMetricsSchema.omit({ id: true, created_at: true, updated_at: true });
exports.CreateRetentionMetricsSchema = CreateRetentionMetricsSchema;
var CreateRetentionCampaignAnalyticsSchema = RetentionCampaignAnalyticsSchema.omit({ id: true, created_at: true, updated_at: true });
exports.CreateRetentionCampaignAnalyticsSchema = CreateRetentionCampaignAnalyticsSchema;
// Update schemas (for PATCH operations)
var UpdatePatientRetentionAnalyticsSchema = PatientRetentionAnalyticsSchema.partial().omit({ id: true, created_at: true });
exports.UpdatePatientRetentionAnalyticsSchema = UpdatePatientRetentionAnalyticsSchema;
var UpdateRetentionMetricsSchema = RetentionMetricsSchema.partial().omit({ id: true, created_at: true });
exports.UpdateRetentionMetricsSchema = UpdateRetentionMetricsSchema;
var UpdatePatientChurnPredictionSchema = PatientChurnPredictionSchema.partial().omit({ id: true, created_at: true });
exports.UpdatePatientChurnPredictionSchema = UpdatePatientChurnPredictionSchema;
var UpdateRetentionInterventionSchema = RetentionInterventionSchema.partial().omit({ id: true, created_at: true });
exports.UpdateRetentionInterventionSchema = UpdateRetentionInterventionSchema;
var UpdateRetentionCampaignAnalyticsSchema = RetentionCampaignAnalyticsSchema.partial().omit({ id: true, created_at: true });
...
var RetentionAnalyticsQuerySchema = zod_1.z.object({
    ...
    sort_by: zod_1.z.enum(['retention_score', 'churn_probability', 'lifetime_value', 'created_at']).default('created_at'),
...
var ChurnPredictionQuerySchema = zod_1.z.object({
    page: zod_1.z.coerce.number().int().min(1).default(1),
    limit: zod_1.z.coerce.number().int().min(1).max(100).default(20),
    sort_by: zod_1.z.enum(['churn_probability', 'risk_score', 'prediction_date', 'created_at']).default('churn_probability'),
    sort_order: zod_1.z.enum(['asc', 'desc']).default('desc'),
    risk_level: ChurnRiskLevelSchema.optional(),
...
var InterventionQuerySchema = zod_1.z.object({
    page: zod_1.z.coerce.number().int().min(1).default(1),
    limit: zod_1.z.coerce.number().int().min(1).max(100).default(20),
    sort_by: zod_1.z.enum(['scheduled_date', 'executed_date', 'effectiveness_score', 'created_at']).default('created_at'),
    sort_order: zod_1.z.enum(['asc', 'desc']).default('desc'),
