...
exports.notificationSettingsSchema =
  exports.optimizationAnalysisSchema =
  exports.demandAnalyticsSchema =
  exports.alertAnalyticsSchema =
  exports.bulkThresholdUpdateSchema =
  exports.bulkAlertActionSchema =
  exports.purchaseOrderFilterSchema =
  exports.thresholdFilterSchema =
  exports.alertFilterSchema =
  exports.updatePurchaseOrderSchema =
  exports.createPurchaseOrderSchema =
  exports.updateReorderAlertSchema =
  exports.createReorderAlertSchema =
  exports.updateReorderThresholdSchema =
  exports.createReorderThresholdSchema =
  exports.supplierLeadTimeSchema =
  exports.approvalWorkflowSchema =
  exports.purchaseOrderItemSchema =
  exports.purchaseOrderSchema =
  exports.demandForecastSchema =
  exports.reorderAlertSchema =
  exports.reorderThresholdSchema =
    void 0;
var zod_1 = require("zod");
// Base schemas
exports.reorderThresholdSchema = zod_1.z
  .object({
...
exports.purchaseOrderSchema = zod_1.z
  .object({
    id: zod_1.z.string().uuid(),
    clinic_id: zod_1.z.string().uuid(),
...
exports.purchaseOrderItemSchema = zod_1.z
  .object({
    id: zod_1.z.string().uuid(),
...
exports.supplierLeadTimeSchema = zod_1.z
  .object({
    id: zod_1.z.string().uuid(),
    supplier_id: zod_1.z.string().uuid(),
    item_id: zod_1.z.string().uuid(),
...
exports.createReorderThresholdSchema = zod_1.z
  .object({
    item_id: zod_1.z.string().uuid(),
    clinic_id: zod_1.z.string().uuid(),
    reorder_point: zod_1.z.number().int().min(0),
...
exports.updateReorderAlertSchema = zod_1.z.object({
  id: zod_1.z.string().uuid(),
  status: zod_1.z
    .enum(["pending", "acknowledged", "resolved", "escalated", "dismissed"])
    .optional(),
  resolution_notes: zod_1.z.string().max(1000).optional(),
  acknowledged_by: zod_1.z.string().uuid().optional(),
  resolved_by: zod_1.z.string().uuid().optional(),
...
exports.alertFilterSchema = zod_1.z.object({
  status: zod_1.z
    .array(zod_1.z.enum(["pending", "acknowledged", "resolved", "escalated", "dismissed"]))
    .optional(),
  priority: zod_1.z
    .array(zod_1.z.enum(["low", "medium", "high", "critical", "emergency"]))
    .optional(),
  alert_type: zod_1.z
    .array(zod_1.z.enum(["warning", "critical", "emergency", "reorder", "overstock"]))
    .optional(),
  date_range: zod_1.z
    .object({
...
exports.optimizationAnalysisSchema = zod_1.z.object({
  ...
  analysis_type: zod_1.z
    .enum(["cost_reduction", "service_level", "storage_optimization", "comprehensive"])
    .optional(),
...
exports.notificationSettingsSchema = zod_1.z.object({
  ...
  alert_types: zod_1.z.array(
    zod_1.z.enum(["warning", "critical", "emergency", "reorder", "overstock"]),
  ),
