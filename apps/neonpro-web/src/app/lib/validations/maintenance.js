...
exports.validateComplianceRecordCreation =
  exports.validateUsageLogCreation =
  exports.validateWorkOrderCreation =
  exports.validateMaintenanceScheduleCreation =
  exports.validateEquipmentUpdate =
  exports.validateEquipmentCreation =
  exports.analyticsQuerySchema =
  exports.alertQuerySchema =
  exports.workOrderQuerySchema =
  exports.maintenanceScheduleQuerySchema =
  exports.equipmentQuerySchema =
  exports.createComplianceRecordSchema =
  exports.createVendorServiceContractSchema =
  exports.resolveAlertSchema =
  exports.acknowledgeAlertSchema =
  exports.createMaintenanceAlertSchema =
  exports.createUsageLogSchema =
  exports.updateWorkOrderSchema =
  exports.createWorkOrderSchema =
  exports.updateMaintenanceScheduleSchema =
  exports.createMaintenanceScheduleSchema =
  exports.equipmentFiltersSchema =
  exports.updateEquipmentSchema =
  exports.createEquipmentSchema =
  exports.alertSeveritySchema =
  exports.alertTypeSchema =
  exports.workOrderPrioritySchema =
  exports.workOrderStatusSchema =
  exports.frequencyTypeSchema =
  exports.maintenanceTypeSchema =
  exports.criticalityLevelSchema =
  exports.equipmentStatusSchema =
  exports.equipmentCategorySchema =
  exports.equipmentTypeSchema =
    void 0;
...
exports.criticalityLevelSchema = zod_1.z.enum(["critical", "high", "medium", "low"]);
...
exports.frequencyTypeSchema = zod_1.z.enum(["fixed_interval", "usage_based", "condition_based"]);
...
exports.workOrderPrioritySchema = zod_1.z.enum(["emergency", "high", "medium", "low"]);
...
exports.createEquipmentSchema = zod_1.z.object({
  ...
  estimated_lifespan_years: zod_1.z
    .number()
    .int()
    .min(1)
    .max(50, "Vida útil deve estar entre 1 e 50 anos")
    .optional(),
  maintenance_frequency_days: zod_1.z
    .number()
    .int()
  ...
  usage_threshold_cycles: zod_1.z
    .number()
    .int()
  ...
  calibration_frequency_days: zod_1.z
    .number()
    .int()
...
// =====================================================================================
exports.createMaintenanceScheduleSchema = zod_1.z
  .object({
    ...
    estimated_duration_minutes: zod_1.z
      .number()
      .int()
    ...
    alert_days_before: zod_1.z
      .number()
      .int()
      .min(0)
      .max(365, "Alerta deve estar entre 0 e 365 dias")
      .default(7),
    critical_alert_days_before: zod_1.z
      .number()
      .int()
      .min(0)
      .max(30, "Alerta crítico deve estar entre 0 e 30 dias")
      .default(3),
    notification_recipients: zod_1.z
      .array(zod_1.z.string().uuid("ID do destinatário deve ser um UUID válido"))
      .default([]),
  })
  .refine(
    function (data) {
...
exports.createWorkOrderSchema = zod_1.z.object({
  ...
  assigned_team_ids: zod_1.z
    .array(zod_1.z.string().uuid("ID da equipe deve ser um UUID válido"))
    .default([]),
...
// USAGE LOG SCHEMAS
// =====================================================================================
exports.createUsageLogSchema = zod_1.z
  .object({
    equipment_id: zod_1.z.string().uuid("ID do equipamento deve ser um UUID válido"),
    clinic_id: zod_1.z.string().uuid("ID da clínica deve ser um UUID válido"),
    // Usage session
    ...
    // Metrics
    cycles_performed: zod_1.z
      .number()
      .int()
      .min(0, "Ciclos executados deve ser positivo")
      .optional(),
    power_consumption_kwh: zod_1.z
      .number()
    ...
    ambient_temperature: zod_1.z
      .number()
      .min(-50)
      .max(100, "Temperatura deve estar entre -50°C e 100°C")
      .optional(),
    humidity_percentage: zod_1.z
      .number()
      .min(0)
...
exports.createMaintenanceAlertSchema = zod_1.z.object({
  ...
  title: zod_1.z
    ...
    .max(255, "Título deve ter no máximo 255 caracteres"),
  message: zod_1.z.string().min(1, "Mensagem do alerta é obrigatória"),
  // Timing
  trigger_date: zod_1.z
    .string()
...
exports.resolveAlertSchema = zod_1.z.object({
  ...
  resolution_notes: zod_1.z.string().min(1, "Notas de resolução são obrigatórias"),
});
// =====================================================================================
// VENDOR SERVICE CONTRACT SCHEMAS
// =====================================================================================
exports.createVendorServiceContractSchema = zod_1.z
  .object({
    equipment_id: zod_1.z.string().uuid("ID do equipamento deve ser um UUID válido"),
    ...
    response_time_hours: zod_1.z
      .number()
      .int()
      .min(1, "Tempo de resposta deve ser pelo menos 1 hora")
      .optional(),
    resolution_time_hours: zod_1.z
      .number()
      .int()
    ...
    uptime_guarantee_percentage: zod_1.z
      .number()
      .min(0)
...
exports.createComplianceRecordSchema = zod_1.z.object({
  ...
  // Timing
  last_compliance_date: zod_1.z
    .string()
    .regex(/^\d{4}-\d{2}-\d{2}$/, "Data de última conformidade deve estar no formato YYYY-MM-DD")
    .optional(),
  next_compliance_due_date: zod_1.z
    .string()
    .regex(/^\d{4}-\d{2}-\d{2}$/, "Data de vencimento deve estar no formato YYYY-MM-DD")
    .optional(),
  compliance_frequency_days: zod_1.z
    .number()
    .int()
  ...
  // Notification settings
  reminder_days_before: zod_1.z
    .number()
    .int()
    .min(1)
    .max(365, "Lembrete deve estar entre 1 e 365 dias")
    .default(30),
  critical_reminder_days_before: zod_1.z
    .number()
    .int()
    .min(1)
