...
exports.kpiResponseSchema = exports.widgetDataResponseSchema = exports.dashboardResponseSchema = exports.dashboardSummarySchema = exports.dashboardDataSchema = exports.performanceMetricsSchema = exports.trendDataSchema = exports.efficiencyMetricsSchema = exports.appointmentMetricsSchema = exports.patientMetricsSchema = exports.revenueMetricsSchema = exports.timeSlotDataSchema = exports.appointmentTypeSchema = exports.acquisitionSourceSchema = exports.patientSegmentSchema = exports.serviceRevenueSchema = exports.forecastPointSchema = exports.trendPointSchema = exports.widgetDataQuerySchema = exports.dashboardQueryParamsSchema = exports.dashboardExportSchema = exports.dashboardCacheSchema = exports.createPerformanceLogSchema = exports.performanceLogSchema = exports.updateAlertSchema = exports.createAlertSchema = exports.dashboardAlertSchema = exports.kpiCalculationRequestSchema = exports.kpiMetricSchema = exports.updateWidgetSchema = exports.createWidgetSchema = exports.dashboardWidgetSchema = exports.updateDashboardConfigSchema = exports.createDashboardConfigSchema = exports.dashboardConfigSchema = exports.widgetConfigurationSchema = exports.widgetPreferencesSchema = exports.layoutConfigSchema = void 0;
...
exports.dashboardAlertSchema = zod_1.z.object({
    ...
    user_id: zod_1.z.string().uuid(),
    clinic_id: zod_1.z.string().uuid().optional(),
    alert_type: zod_1.z.enum(['revenue_drop', 'low_bookings', 'high_cancellations', 'efficiency_warning']),
    metric_name: zod_1.z.string().min(1).max(100),
...
exports.createAlertSchema = zod_1.z.object({
    ...
    metric_name: zod_1.z.string().min(1).max(100),
    threshold_value: zod_1.z.number(),
    threshold_operator: zod_1.z.enum(['less_than', 'greater_than', 'equals']).optional().default('less_than'),
    notification_method: zod_1.z.enum(['email', 'sms', 'push', 'dashboard']).optional().default('dashboard'),
});
exports.updateAlertSchema = zod_1.z.object({
    alert_type: zod_1.z.enum(['revenue_drop', 'low_bookings', 'high_cancellations', 'efficiency_warning']).optional(),
