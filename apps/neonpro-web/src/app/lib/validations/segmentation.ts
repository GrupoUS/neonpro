...
export const UpdateFrequencySchema = z.enum(["real_time", "hourly", "daily", "weekly", "monthly"]);

export const EngagementLevelSchema = z.enum(["very_low", "low", "medium", "high", "very_high"]);

export const RevenueTrendSchema = z.enum(["declining", "stable", "growing", "volatile"]);

export const RiskLevelSchema = z.enum(["very_low", "low", "medium", "high", "very_high"]);

export const HealthTrendSchema = z.enum(["declining", "stable", "improving", "fluctuating"]);
