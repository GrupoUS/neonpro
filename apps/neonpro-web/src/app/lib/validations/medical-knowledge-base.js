...
exports.knowledgeQueryBuilderSchema = exports.filterSchema = exports.sortingSchema = exports.paginationSchema = exports.knowledgeBaseErrorSchema = exports.evidenceValidationResponseSchema = exports.drugSearchResultSchema = exports.knowledgeSearchResultSchema = exports.bulkKnowledgeImportSchema = exports.syncTriggerRequestSchema = exports.validateRecommendationRequestSchema = exports.createMedicalKnowledgeRequestSchema = exports.updateKnowledgeSourceRequestSchema = exports.createKnowledgeSourceRequestSchema = exports.knowledgeBaseSettingsSchema = exports.knowledgeIntegrationConfigSchema = exports.evidenceValidationRequestSchema = exports.drugSearchQuerySchema = exports.medicalSearchQuerySchema = exports.medicalGuidelineSchema = exports.drugInteractionSchema = exports.drugInformationSchema = exports.validationResultSchema = exports.researchCacheSchema = exports.medicalKnowledgeSchema = exports.knowledgeSourceSchema = void 0;
var zod_1 = require("zod");
// Base validation schemas
exports.knowledgeSourceSchema = zod_1.z.object({
    id: zod_1.z.string().uuid().optional(),
    source_name: zod_1.z.string().min(1).max(255),
    source_type: zod_1.z.enum(['database', 'journal', 'guideline', 'drug_db', 'classification', 'research']),
...
exports.medicalKnowledgeSchema = zod_1.z.object({
    id: zod_1.z.string().uuid().optional(),
    knowledge_type: zod_1.z.enum(['guideline', 'research', 'drug_info', 'diagnosis', 'treatment', 'protocol', 'reference']),
...
exports.validationResultSchema = zod_1.z.object({
    ...
    validation_status: zod_1.z.enum(['validated', 'conflicted', 'unsupported', 'pending', 'requires_review']),
...
exports.drugInteractionSchema = zod_1.z.object({
    ...
    evidence_level: zod_1.z.string().max(50).optional(),
    source_id: zod_1.z.string().uuid().optional(),
}).refine(function (data) { return data.drug_1_id !== data.drug_2_id; }, {
...
exports.updateKnowledgeSourceRequestSchema = exports.knowledgeSourceSchema.pick({
    source_name: true,
    api_endpoint: true,
    sync_frequency: true,
    status: true,
...
exports.filterSchema = zod_1.z.object({
    ...
    value: zod_1.z.union([zod_1.z.string(), zod_1.z.number(), zod_1.z.boolean(), zod_1.z.array(zod_1.z.any())]),
});
