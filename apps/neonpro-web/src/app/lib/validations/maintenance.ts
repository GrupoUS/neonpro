...
export const criticalityLevelSchema = z.enum(["critical", "high", "medium", "low"] as const);
...
export const workOrderPrioritySchema = z.enum(["emergency", "high", "medium", "low"] as const);
...
export const alertSeveritySchema = z.enum(["critical", "high", "medium", "low", "info"] as const);
...
export const createEquipmentSchema = z.object({
  ...
  warranty_start_date: z
    .string()
    .regex(/^\d{4}-\d{2}-\d{2}$/, "Data de início da garantia deve estar no formato YYYY-MM-DD")
    .optional(),
  warranty_end_date: z
    .string()
    .regex(/^\d{4}-\d{2}-\d{2}$/, "Data de fim da garantia deve estar no formato YYYY-MM-DD")
    .optional(),
...
export const createWorkOrderSchema = z.object({
  ...
  scheduled_date: z
    .string()
    .regex(/^\d{4}-\d{2}-\d{2}$/, "Data agendada deve estar no formato YYYY-MM-DD")
    .optional(),
...
export const createMaintenanceAlertSchema = z.object({
  ...
  trigger_date: z
    .string()
    .regex(/^\d{4}-\d{2}-\d{2}$/, "Data do trigger deve estar no formato YYYY-MM-DD"),
  due_date: z
    .string()
...
export const createComplianceRecordSchema = z.object({
  ...
  last_compliance_date: z
    .string()
    .regex(/^\d{4}-\d{2}-\d{2}$/, "Data de última conformidade deve estar no formato YYYY-MM-DD")
    .optional(),
