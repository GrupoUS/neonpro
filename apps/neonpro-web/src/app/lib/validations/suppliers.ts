...
export const performanceGradeSchema = z.enum(["A+", "A", "B+", "B", "C+", "C", "D", "F"] as const);
...
export const communicationDirectionSchema = z.enum(["outbound", "inbound"] as const);
...
export const priorityLevelSchema = z.enum(["low", "medium", "high", "urgent"] as const);
...
export const severityLevelSchema = z.enum(["low", "medium", "high", "critical"] as const);
...
export const supplierPerformanceSchema = z
  .object({
    id: z.string().uuid(),
    supplier_id: z.string().uuid(),
...
export const supplierEvaluationSchema = z
  .object({
    id: z.string().uuid(),
    supplier_id: z.string().uuid(),
    ...
    delivery_reliability: z.number().min(1, "Nota mínima é 1").max(10, "Nota máxima é 10"),
    product_quality: z.number().min(1, "Nota mínima é 1").max(10, "Nota máxima é 10"),
    customer_service: z.number().min(1, "Nota mínima é 1").max(10, "Nota máxima é 10"),
    pricing_competitiveness: z.number().min(1, "Nota mínima é 1").max(10, "Nota máxima é 10"),
    technical_support: z.number().min(1, "Nota mínima é 1").max(10, "Nota máxima é 10"),
    documentation_quality: z.number().min(1, "Nota mínima é 1").max(10, "Nota máxima é 10"),
