...
var RetentionService = /** @class */ (function () {
    ...
    RetentionService.getPatientRetentionAnalytics = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, _a, page, _b, limit, patient_id, risk_level, segment, date_range, search, _c, sort_by, _d, sort_order, query, start, end, _e, data, error;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, (0, client_1.createClient)()];
                    case 1:
                        supabase = _f.sent();
                        _a = params.page, page = _a === void 0 ? 1 : _a, _b = params.limit, limit = _b === void 0 ? 20 : _b, patient_id = params.patient_id, risk_level = params.risk_level, segment = params.segment, date_range = params.date_range, search = params.search, _c = params.sort_by, sort_by = _c === void 0 ? 'created_at' : _c, _d = params.sort_order, sort_order = _d === void 0 ? 'desc' : _d;
                        query = supabase
                        ...
                        if (search) {
                            query = query.or("\n        patients.first_name.ilike.%".concat(search, "%,\n        patients.last_name.ilike.%").concat(search, "%,\n        patients.email.ilike.%").concat(search, "%,\n        retention_segment.ilike.%").concat(search, "%\n      "));
                        }
                        // Apply sorting
    ...
    RetentionService.getChurnPredictions = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, _a, page, _b, limit, patient_id, risk_level, date_range, model_version, validation_status, _c, sort_by, _d, sort_order, query, _e, data, error;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, (0, client_1.createClient)()];
                    case 1:
                        supabase = _f.sent();
                        _a = params.page, page = _a === void 0 ? 1 : _a, _b = params.limit, limit = _b === void 0 ? 20 : _b, patient_id = params.patient_id, risk_level = params.risk_level, date_range = params.date_range, model_version = params.model_version, validation_status = params.validation_status, _c = params.sort_by, sort_by = _c === void 0 ? 'prediction_date' : _c, _d = params.sort_order, sort_order = _d === void 0 ? 'desc' : _d;
                        query = supabase
     ...
     */
    RetentionService.updateChurnPredictionValidation = function (id, validation_status, actual_outcome, outcome_date) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RetentionService.getRetentionInterventions = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, _a, page, _b, limit, patient_id, channel, status, campaign_id, date_range, _c, sort_by, _d, sort_order, query, _e, data, error;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, (0, client_1.createClient)()];
                    case 1:
                        supabase = _f.sent();
                        _a = params.page, page = _a === void 0 ? 1 : _a, _b = params.limit, limit = _b === void 0 ? 20 : _b, patient_id = params.patient_id, channel = params.channel, status = params.status, campaign_id = params.campaign_id, date_range = params.date_range, _c = params.sort_by, sort_by = _c === void 0 ? 'created_at' : _c, _d = params.sort_order, sort_order = _d === void 0 ? 'desc' : _d;
                        query = supabase
     ...
     */
    RetentionService.updateRetentionInterventionStatus = function (id, status, response_data, effectiveness_score, roi) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, updates, _a, data, error;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    RetentionService.getRetentionMetrics = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var highRiskPatients, criticalRiskPatients, churnSummary, totalPatients, avgChurnProbability, avgLifetimeValue, avgPredictedLTV, avgRetentionScore, error_1;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        totalPatients = (churnSummary === null || churnSummary === void 0 ? void 0 : churnSummary.length) || 0;
                        avgChurnProbability = totalPatients > 0
                            ? ((churnSummary === null || churnSummary === void 0 ? void 0 : churnSummary.reduce(function (sum, item) { return sum + (item.churn_probability || 0); }, 0)) || 0) / totalPatients
                            : 0;
                        avgLifetimeValue = totalPatients > 0
                            ? ((churnSummary === null || churnSummary === void 0 ? void 0 : churnSummary.reduce(function (sum, item) { return sum + (item.lifetime_value || 0); }, 0)) || 0) / totalPatients
                            : 0;
                        avgPredictedLTV = totalPatients > 0
                            ? ((churnSummary === null || churnSummary === void 0 ? void 0 : churnSummary.reduce(function (sum, item) { return sum + (item.predicted_ltv || 0); }, 0)) || 0) / totalPatients
                            : 0;
                        avgRetentionScore = totalPatients > 0
                            ? ((churnSummary === null || churnSummary === void 0 ? void 0 : churnSummary.reduce(function (sum, item) { return sum + (item.retention_score || 0); }, 0)) || 0) / totalPatients
                            : 0;
                        return [2 /*return*/, {
                                ...
                                period_start: ((_a = params.date_range) === null || _a === void 0 ? void 0 : _a.start_date) || new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString(),
                                period_end: ((_b = params.date_range) === null || _b === void 0 ? void 0 : _b.end_date) || new Date().toISOString()
                            }];
                    case 4:
                        error_1 = _c.sent();
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                risk_distribution: {
                                    low: summary.filter(function (p) { return p.churn_risk_level === 'low'; }).length,
                                    medium: summary.filter(function (p) { return p.churn_risk_level === 'medium'; }).length,
                                    high: summary.filter(function (p) { return p.churn_risk_level === 'high'; }).length,
                                    critical: summary.filter(function (p) { return p.churn_risk_level === 'critical'; }).length
                                },
                                average_retention_score: summary.reduce(function (sum, p) { return sum + (p.retention_score || 0); }, 0) / summary.length || 0,
                                average_churn_probability: summary.reduce(function (sum, p) { return sum + (p.churn_probability || 0); }, 0) / summary.length || 0,
                                average_lifetime_value: summary.reduce(function (sum, p) { return sum + (p.lifetime_value || 0); }, 0) / summary.length || 0,
                                segments: Array.from(new Set(summary.map(function (p) { return p.retention_segment; }))).map(function (segment) { return ({
                                    name: segment,
                                    count: summary.filter(function (p) { return p.retention_segment === segment; }).length
                                }); })
                            }];
                }
            });
