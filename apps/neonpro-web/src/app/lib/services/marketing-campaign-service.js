      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
              ...
              supabase
                ...
                .insert([
                  __assign(__assign({}, data), {
                    automation_level: data.automation_level || 0.8,
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.createAuditEntry(campaign.id, "CAMPAIGN_CREATED", { campaign_data: data }),
            ];
          case 4:
            // Create audit trail
            _b.sent();
        ...
        switch (_b.label) {
          ...
          case 4:
            ...
            return [
              ...
              {
                success: true,
                data: __assign(__assign({}, campaign), {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.createAuditEntry(id, "CAMPAIGN_UPDATED", { update_data: data }),
            ];
          case 2:
            // Create audit trail
            _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 3, , 4]);
            return [4 /*yield*/, this.supabase.from("marketing_campaigns").delete().eq("id", id)];
          case 1:
            error = _a.sent().error;
            if (error) throw error;
            // Create audit trail
    ...
    return __awaiter(this, arguments, void 0, function (campaignId, executionType) {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 4:
            executionData =
              ((_c.personalized_content = _d.sent()),
              (_c.execution_status = "pending"),
              (_c.scheduled_at = new Date().toISOString()),
              _c);
            return [
              4 /*yield*/,
              this.supabase.from("campaign_executions").insert([executionData]).select().single(),
            ];
          case 5:
          ...
          case 8:
            ...
            return [
              4 /*yield*/,
              this.createAuditEntry(campaignId, "CAMPAIGN_EXECUTED", {
                execution_type: executionType,
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.getTargetPatients(abTest.marketing_campaigns.target_segments),
            ];
          case 2:
          ...
          case 0:
            ...
            return [
              ...
              this.supabase
                .from("patient_personalization_profiles")
                .upsert([
                  __assign(__assign({ patient_id: patientId }, data), {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            query = this.supabase.from("marketing_consent").select("*").eq("patient_id", patientId);
            if (consentType) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 4:
            analytics = ((_c.compliance_status = _d.sent()), _c);
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.supabase.from("patients").select("id, email, phone, preferences").limit(1000),
            ];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("campaign_audit_trail").insert([
                {
                  campaign_id: campaignId,
                  action: action,
