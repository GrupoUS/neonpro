...
var RiskAssessmentService = /** @class */ (function () {
    ...
    RiskAssessmentService.prototype.calculateRiskScore = function (factors, context) {
        ...
        if (factors.medical) {
            var medicalScore = 0;
            if ((_a = factors.medical.chronic_conditions) === null || _a === void 0 ? void 0 : _a.length) {
            ...
            if ((_d = factors.medical.previous_complications) === null || _d === void 0 ? void 0 : _d.length) {
        ...
        if (factors.procedural) {
            ...
            if ((_e = factors.procedural.equipment_factors) === null || _e === void 0 ? void 0 : _e.length) {
                proceduralScore += Math.min(factors.procedural.equipment_factors.length * 5, 25);
            }
            if ((_f = factors.procedural.technique_risks) === null || _f === void 0 ? void 0 : _f.length) {
        ...
        if (factors.patient_specific) {
            ...
            if ((_g = factors.patient_specific.mobility_limitations) === null || _g === void 0 ? void 0 : _g.length) {
        ...
        if (factors.environmental) {
            ...
            if ((_h = factors.environmental.equipment_status) === null || _h === void 0 ? void 0 : _h.length) {
    ...
    RiskAssessmentService.prototype.generateRiskCategories = function (factors) {
        ...
        if (factors.medical) {
            ...
            if ((_a = factors.medical.chronic_conditions) === null || _a === void 0 ? void 0 : _a.length) {
                ...
                medicalFactors.push("".concat(factors.medical.chronic_conditions.length, " chronic conditions"));
            }
            if ((_b = factors.medical.allergies) === null || _b === void 0 ? void 0 : _b.length) {
            ...
            if ((_c = factors.medical.contraindications) === null || _c === void 0 ? void 0 : _c.length) {
                ...
                medicalFactors.push("".concat(factors.medical.contraindications.length, " contraindications"));
            }
            categories.medical = {
    ...
    RiskAssessmentService.prototype.requiresValidation = function (assessment) {
    ...
    RiskAssessmentService.prototype.createRiskAssessment = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        riskScore = this.calculateRiskScore(data.risk_factors || {}, data.assessment_context || {});
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Failed to create risk assessment: ".concat(error.message));
                        ...
                        return [4 /*yield*/, this.createAlert({
                                ...
                                alert_message: "Patient has been assessed with ".concat(riskLevel, " risk (score: ").concat(riskScore, "). Medical validation required."),
                    ...
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3: return [2 /*return*/, assessment];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to fetch risk assessments: ".concat(error.message));
                        return [2 /*return*/, data || []];
                }
            });
        });
    ...
    RiskAssessmentService.prototype.createAlert = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        alertData = __assign(__assign({}, data), { alert_details: data.alert_details || {}, recommended_actions: data.recommended_actions || {}, alert_status: 'active', escalation_level: 0, escalation_path: {}, emergency_protocol_triggered: false });
                        return [4 /*yield*/, supabase
                                .from('risk_alerts')
                                .insert(alertData)
                                .select()
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to fetch validations: ".concat(error.message));
                        return [2 /*return*/, data || []];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to fetch alerts: ".concat(error.message));
                        return [2 /*return*/, data || []];
                }
            });
        });
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (currentAssessment) {
                            newScore = this.calculateRiskScore(updates.risk_factors, currentAssessment.assessment_context);
                            ...
                            updateData.validation_required = this.requiresValidation(__assign(__assign({}, currentAssessment), { risk_level: newLevel, risk_score: newScore }));
                        }
                        _b.label = 2;
                    case 2:
                    ...
                    case 3:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to update risk assessment: ".concat(error.message));
                        return [2 /*return*/, data];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        error = (_a.sent()).error;
                        if (error)
                            throw new Error("Failed to delete risk assessment: ".concat(error.message));
                        return [2 /*return*/];
                }
            });
        });
    ...
    RiskAssessmentService.prototype.createValidation = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        validationData = __assign(__assign({}, data), { validation_date: new Date().toISOString(), validator_credentials: data.validator_credentials || {}, requires_second_opinion: data.requires_second_opinion || false });
                        return [4 /*yield*/, supabase
                                .from('risk_validations')
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Failed to create validation: ".concat(error.message));
                        // Update assessment validation status
                        return [4 /*yield*/, this.updateRiskAssessment(data.assessment_id, {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to get validations: ".concat(error.message));
                        return [2 /*return*/, data || []];
                }
            });
        });
    ...
    RiskAssessmentService.prototype.createMitigation = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        mitigationData = __assign(__assign({}, data), { mitigation_details: data.mitigation_details || {}, implementation_status: 'planned' });
                        return [4 /*yield*/, supabase
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Failed to create mitigation: ".concat(error.message));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (fetchError)
                            throw new Error("Failed to fetch alert: ".concat(fetchError.message));
                    ...
                    case 3:
                        error = (_b.sent()).error;
                        if (error)
                            throw new Error("Failed to escalate alert: ".concat(error.message));
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to get risk thresholds: ".concat(error.message));
                        return [2 /*return*/, data || []];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to update risk threshold: ".concat(error.message));
                        return [2 /*return*/, data];
                }
            });
        });
