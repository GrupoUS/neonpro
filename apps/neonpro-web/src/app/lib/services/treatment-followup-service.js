    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            _d.trys.push([0, 2, , 3]);
            followupData = __assign(__assign({}, data), {
              scheduled_date: data.scheduled_date.toISOString(),
              status: "pending",
              automated: (_b = data.automated) !== null && _b !== void 0 ? _b : true,
              priority: (_c = data.priority) !== null && _c !== void 0 ? _c : "normal",
            });
            return [
              4 /*yield*/,
              supabase
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3]);
            return [4 /*yield*/, supabase.from("treatment_followups").delete().eq("id", id)];
          case 1:
            error = _a.sent().error;
            if (error) {
    ...
    return __awaiter(this, arguments, void 0, function (filters) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            query = supabase.from("followup_templates").select("*");
            // Apply filters
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            _e.trys.push([0, 2, , 3]);
            templateData = __assign(__assign({}, data), {
              timing_hours: (_b = data.timing_hours) !== null && _b !== void 0 ? _b : 0,
              requires_response:
                (_c = data.requires_response) !== null && _c !== void 0 ? _c : false,
              active: (_d = data.active) !== null && _d !== void 0 ? _d : true,
            });
            return [
              4 /*yield*/,
              supabase.from("followup_templates").insert(templateData).select("*").single(),
            ];
          case 1:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("followup_templates").update(updates).eq("id", id).select("*").single(),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) {
    ...
    return __awaiter(this, arguments, void 0, function (filters) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            query = supabase.from("treatment_protocols").select("*");
            // Apply filters
            if (filters.treatment_type) {
              query = query.in("treatment_type", filters.treatment_type);
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            _d.trys.push([0, 2, , 3]);
            protocolData = __assign(__assign({}, data), {
              next_appointment_suggestion:
                (_b = data.next_appointment_suggestion) !== null && _b !== void 0 ? _b : 30,
              active: (_c = data.active) !== null && _c !== void 0 ? _c : true,
            });
            return [
              4 /*yield*/,
              supabase.from("treatment_protocols").insert(protocolData).select("*").single(),
            ];
          case 1:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            completed_followups = followups.filter(function (f) {
              return f.status === "completed";
            }).length;
            pending_followups = followups.filter(function (f) {
              return f.status === "pending";
            }).length;
            followupsWithResponses = followups.filter(function (f) {
              return f.responses && f.responses.length > 0;
            }).length;
            response_rate =
              total_followups > 0 ? (followupsWithResponses / total_followups) * 100 : 0;
            satisfactionResponses = followups
              .flatMap(function (f) {
                return f.responses || [];
              })
              .filter(function (r) {
                return r.satisfaction_score !== null && r.satisfaction_score !== undefined;
              });
            satisfaction_average =
              satisfactionResponses.length > 0
                ? satisfactionResponses.reduce(function (sum, r) {
                    return sum + (r.satisfaction_score || 0);
        ...
        switch (_a.label) {
          ...
          case 5:
            ...
            return [
              ...
              {
                today_followups:
                  (todayFollowups === null || todayFollowups === void 0
                    ? void 0
                    : todayFollowups.length) || 0,
                pending_responses:
                  (pendingResponses === null || pendingResponses === void 0
                    ? void 0
                    : pendingResponses.length) || 0,
                overdue_followups:
                  (overdueFollowups === null || overdueFollowups === void 0
                    ? void 0
                    : overdueFollowups.length) || 0,
                satisfaction_average: 0, // TODO: Calculate from recent responses
                upcoming_this_week:
                  (upcomingWeek === null || upcomingWeek === void 0
                    ? void 0
...
var createtreatmentFollowupService = function () {
  return new TreatmentFollowupService();
};
