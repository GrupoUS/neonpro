...
// =====================================================================================
var InventoryTrackingEngine = /** @class */ (function () {
    ...
    InventoryTrackingEngine.prototype.updateStockLevel = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var itemId, locationId, quantityChange, transactionType, reason, batchNumber, expirationDate, referenceType, referenceId, userId, _a, currentStock, stockError, currentQuantity, newQuantity, stockLevelData, updatedStock, _b, data, error, _c, data, error, transactionData, _d, transaction, transactionError, alertsCreated, error_1;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        itemId = params.itemId, locationId = params.locationId, quantityChange = params.quantityChange, transactionType = params.transactionType, reason = params.reason, batchNumber = params.batchNumber, expirationDate = params.expirationDate, referenceType = params.referenceType, referenceId = params.referenceId, userId = params.userId;
                        _e.label = 1;
                    case 1:
                        _e.trys.push([1, 9, , 10]);
                    ...
                    case 2:
                        ...
                        currentQuantity = (currentStock === null || currentStock === void 0 ? void 0 : currentStock.current_quantity) || 0;
                        ...
                        if (quantityChange < 0 && Math.abs(quantityChange) > currentQuantity) {
                            return [2 /*return*/, {
                                    ...
                                    availableQuantity: (currentStock === null || currentStock === void 0 ? void 0 : currentStock.available_quantity) || 0,
                                    alertsCreated: [],
                    ...
                    case 9:
                        ...
                        return [2 /*return*/, {
                                ...
                                availableQuantity: 0,
                                alertsCreated: [],
                                errors: ["Stock update failed: ".concat(error_1 instanceof Error ? error_1.message : 'Unknown error')]
                            }];
    ...
    InventoryTrackingEngine.prototype.transferStock = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var itemId, sourceLocationId, destinationLocationId, quantity, reason, batchNumber, userId, sourceStock, sourceResult, destinationResult, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        itemId = params.itemId, sourceLocationId = params.sourceLocationId, destinationLocationId = params.destinationLocationId, quantity = params.quantity, reason = params.reason, batchNumber = params.batchNumber, userId = params.userId;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 7, , 8]);
                        return [4 /*yield*/, supabase
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.updateStockLevel({
                                itemId: itemId,
                    ...
                    case 7:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                errors: ["Transfer failed: ".concat(error_2 instanceof Error ? error_2.message : 'Unknown error')]
                            }];
    ...
    InventoryTrackingEngine.prototype.reserveStock = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var itemId, locationId, quantity, referenceType, referenceId, userId, currentStock, _a, updatedStock, error, transaction, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        itemId = params.itemId, locationId = params.locationId, quantity = params.quantity, referenceType = params.referenceType, referenceId = params.referenceId, userId = params.userId;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, supabase
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, {
                                success: true,
                                reservationId: transaction === null || transaction === void 0 ? void 0 : transaction.id,
                                errors: []
                            }];
                    case 5:
                        error_3 = _b.sent();
                        ...
                        return [2 /*return*/, {
                                success: false,
                                errors: ["Reservation failed: ".concat(error_3 instanceof Error ? error_3.message : 'Unknown error')]
                            }];
                    case 6: return [2 /*return*/];
                }
            });
    ...
    InventoryTrackingEngine.prototype.releaseReservedStock = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var itemId, locationId, quantity, isConsumption, referenceId, userId, currentStock, updates, _a, updatedStock, error, transactionType, transaction, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        itemId = params.itemId, locationId = params.locationId, quantity = params.quantity, isConsumption = params.isConsumption, referenceId = params.referenceId, userId = params.userId;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, supabase
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                errors: ["Release failed: ".concat(error_4 instanceof Error ? error_4.message : 'Unknown error')]
                            }];
                    case 6: return [2 /*return*/];
                }
            });
     ...
     */
    InventoryTrackingEngine.prototype.checkAndCreateAlerts = function (itemId, locationId, stockLevel) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, item, alerts, currentQuantity, existingAlerts, activeAlertTypes, alert_1, alertLevel, alert_2, expirationDate, today, daysToExpiry, alert_3, alert_4, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        activeAlertTypes = new Set((existingAlerts === null || existingAlerts === void 0 ? void 0 : existingAlerts.map(function (a) { return a.alert_type; })) || []);
                        if (!(currentQuantity === 0 && !activeAlertTypes.has('zero_stock'))) return [3 /*break*/, 5];
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 7];
                    case 5:
                        if (!(currentQuantity <= item.reorder_level && !activeAlertTypes.has('low_stock'))) return [3 /*break*/, 7];
                        ...
                        return [4 /*yield*/, this.createAlert({
                                ...
                                message: "".concat(item.name, " stock is below reorder level. Current: ").concat(currentQuantity, ", Reorder Level: ").concat(item.reorder_level),
                                currentQuantity: currentQuantity,
                    ...
                    case 7:
                        ...
                        today = new Date();
                        daysToExpiry = Math.ceil((expirationDate.getTime() - today.getTime()) / (1000 * 60 * 60 * 24));
                        ...
                        return [4 /*yield*/, this.createAlert({
                                ...
                                message: "".concat(item.name, " (Batch: ").concat(stockLevel.batch_number || 'N/A', ") has expired."),
                                currentQuantity: currentQuantity,
                                thresholdQuantity: 0
                            })];
                    case 8:
                        ...
                        return [3 /*break*/, 11];
                    case 9:
                        if (!(daysToExpiry <= 7 && daysToExpiry > 0 && !activeAlertTypes.has('expiring'))) return [3 /*break*/, 11];
                        return [4 /*yield*/, this.createAlert({
                                itemId: itemId,
                                locationId: locationId,
                                alertType: 'expiring',
                                ...
                                message: "".concat(item.name, " (Batch: ").concat(stockLevel.batch_number || 'N/A', ") expires in ").concat(daysToExpiry, " days."),
                                currentQuantity: currentQuantity,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.updateStockLevel(__assign(__assign({}, update), { userId: userId }))];
                    case 3:
                        result = _a.sent();
                        if (result.success) {
                            successful++;
                    ...
                    case 4:
                        error_8 = _a.sent();
                        failed++;
                        errors.push("Batch update failed: ".concat(error_8 instanceof Error ? error_8.message : 'Unknown error'));
                        return [3 /*break*/, 5];
                    case 5:
                        _i++;
                        return [3 /*break*/, 1];
                    case 6: return [2 /*return*/, { successful: successful, failed: failed, errors: errors }];
                }
            });
        });
    };
...
function calculateAlertPriority(currentQuantity, reorderLevel, minStock, isCriticalItem) {
    if (isCriticalItem === void 0) { isCriticalItem = false; }
