...
var ReportBuilderService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        if (error)
                            throw new Error("Failed to create report: ".concat(error.message));
                        // Track usage
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), report = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to update report: ".concat(error.message));
                        // Track usage
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error = (_a.sent()).error;
                        if (error)
                            throw new Error("Failed to delete report: ".concat(error.message));
                        return [2 /*return*/];
                }
            });
        });
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, supabase
                                ...
                                .eq('id', reportId)
                                .or("user_id.eq.".concat(user.id, ",is_public.eq.true,report_collaborators.user_id.eq.").concat(user.id))
                                .single()];
                    case 2:
                        _a = _b.sent(), report = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to fetch report: ".concat(error.message));
                        // Track usage
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if ((filters === null || filters === void 0 ? void 0 : filters.is_template) !== undefined) {
                            query = query.eq('is_template', filters.is_template);
                        }
                        if (filters === null || filters === void 0 ? void 0 : filters.search) {
                            query = query.or("report_name.ilike.%".concat(filters.search, "%,report_description.ilike.%").concat(filters.search, "%"));
                        }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        if (error)
                            throw new Error("Failed to clone report: ".concat(error.message));
                        // Track usage
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        categories = __spreadArray([], new Set((templates === null || templates === void 0 ? void 0 : templates.map(function (t) { return t.category; })) || []), true);
                        featured = (templates === null || templates === void 0 ? void 0 : templates.filter(function (t) { return t.is_featured; })) || [];
                        return [2 /*return*/, {
                                templates: templates || [],
                                categories: categories,
                                featured: featured,
                                total_count: (templates === null || templates === void 0 ? void 0 : templates.length) || 0
                            }];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (error)
                            throw new Error("Failed to fetch data sources: ".concat(error.message));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (error)
                            throw new Error("Failed to add collaborator: ".concat(error.message));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error = (_a.sent()).error;
                        if (error)
                            throw new Error("Failed to remove collaborator: ".concat(error.message));
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (error)
                            throw new Error("Failed to fetch collaborators: ".concat(error.message));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (error)
                            throw new Error("Failed to add comment: ".concat(error.message));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (error)
                            throw new Error("Failed to fetch comments: ".concat(error.message));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error = (_a.sent()).error;
                        if (error)
                            throw new Error("Failed to resolve comment: ".concat(error.message));
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!user)
                            throw new Error('User not authenticated');
                        schedule = __assign(__assign({}, scheduleData), { created_by: user.id, run_count: 0, failure_count: 0, next_run: this.calculateNextRun(scheduleData.schedule_config) });
                        return [4 /*yield*/, supabase
                    ...
                    case 2:
                        ...
                        if (error)
                            throw new Error("Failed to create schedule: ".concat(error.message));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        totalViews = (usageStats === null || usageStats === void 0 ? void 0 : usageStats.reduce(function (sum, stat) { return sum + stat.access_count; }, 0)) || 0;
                        uniqueUsers = new Set((usageStats === null || usageStats === void 0 ? void 0 : usageStats.map(function (stat) { return stat.user_id; })) || []).size;
                        avgDuration = (usageStats === null || usageStats === void 0 ? void 0 : usageStats.length) ?
                            usageStats.reduce(function (sum, stat) { return sum + stat.usage_duration; }, 0) / usageStats.length : 0;
                        return [2 /*return*/, {
    ...
    ReportBuilderService.prototype.calculateNextRun = function (scheduleConfig) {
        ...
        // Set the time
        var _a = scheduleConfig.time.split(':'), hours = _a[0], minutes = _a[1];
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        dbQuery = supabase
                            ...
                            .select('*')
                            .or("user_id.eq.".concat(user.id, ",is_public.eq.true"))
                            .or("report_name.ilike.%".concat(query, "%,report_description.ilike.%").concat(query, "%"))
                            .order('updated_at', { ascending: false })
                            .limit(20);
                        if (filters === null || filters === void 0 ? void 0 : filters.visualization_type) {
                    ...
                    case 2:
                        ...
                        if (error)
                            throw new Error("Failed to search reports: ".concat(error.message));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), reports = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to fetch recent reports: ".concat(error.message));
                        return [2 /*return*/, reports || []];
                }
            });
        });
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!(analytics === null || analytics === void 0 ? void 0 : analytics.length))
                            return [2 /*return*/, []];
                        reportIds = analytics.map(function (a) { return a.report_id; });
                        return [4 /*yield*/, supabase
                                .from('custom_reports')
                                .select('*')
                                .in('id', reportIds)
                    ...
                    case 3:
                        _a = _b.sent(), reports = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to fetch favorite reports: ".concat(error.message));
                        return [2 /*return*/, reports || []];
                }
            });
        });
