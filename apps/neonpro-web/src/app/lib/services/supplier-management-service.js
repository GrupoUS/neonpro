...
var SupplierManagementService = /** @class */ (function () {
    function SupplierManagementService(supabaseUrl, supabaseKey) {
        this.supabase = (0, supabase_js_1.createClient)(supabaseUrl || process.env.SUPABASE_URL, supabaseKey || process.env.SUPABASE_ANON_KEY);
    }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (existingCode) {
                            throw new Error("C\u00F3digo de fornecedor '".concat(supplierCode, "' j\u00E1 existe"));
                        }
                        supplierToCreate = __assign(__assign({}, supplierData), { clinic_id: clinicId, supplier_code: supplierCode, status: 'active', created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
                        return [4 /*yield*/, supabase
                                .from('suppliers')
    ...
    SupplierManagementService.prototype.getSupplier = function (clinicId, supplierId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, supabase_js_1.createClient)()];
                    case 1:
                        supabase = _b.sent();
                        return [4 /*yield*/, supabase
                                .from('suppliers')
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (filters) {
                            ...
                            if (filters.search) {
                                query = query.or("supplier_name.ilike.%".concat(filters.search, "%,supplier_code.ilike.%").concat(filters.search, "%"));
                            }
                        }
                        offset = (page - 1) * limit;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (existingContract) {
                            throw new Error("N\u00FAmero de contrato '".concat(contractData.contract_number, "' j\u00E1 existe para este fornecedor"));
                        }
                        contractToCreate = __assign(__assign({}, contractData), { status: 'draft', created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
                        return [4 /*yield*/, supabase
                                .from('supplier_contracts')
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error) {
                            throw new Error("Erro ao buscar alertas de renova\u00E7\u00E3o: ".concat(error.message));
                        }
                        return [2 /*return*/, data];
                }
            });
    ...
    SupplierManagementService.prototype.createContact = function (contactData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        contactToCreate = __assign(__assign({}, contactData), { created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
                        return [4 /*yield*/, supabase
    ...
    // =====================================================================================
    SupplierManagementService.prototype.calculateSupplierPerformance = function (supplierId, periodStart, periodEnd, evaluationType) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, ordersData, qualityData, financialData, deliveryScore, qualityScore, overallScore, performanceData, _b, data, error;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        weightedScore = evaluationData.delivery_reliability * weights.delivery_reliability +
                        ...
                        evaluationToCreate = __assign(__assign({}, evaluationData), { evaluation_date: new Date().toISOString(), weighted_score: Number(weightedScore.toFixed(2)), final_grade: finalGrade, created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
                        return [4 /*yield*/, supabase
    ...
    SupplierManagementService.prototype.createQualityIssue = function (issueData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        issueToCreate = __assign(__assign({}, issueData), { issue_date: new Date().toISOString(), status: 'open', created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
                        return [4 /*yield*/, supabase
    ...
    SupplierManagementService.prototype.createCommunication = function (communicationData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        communicationToCreate = __assign(__assign({}, communicationData), { communication_date: new Date().toISOString(), status: 'sent', created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
                        return [4 /*yield*/, supabase
    ...
    SupplierManagementService.prototype.getDashboardData = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, suppliers, totalSuppliers, activeSuppliers, preferredSuppliers, criticalSuppliers, avgPerformanceScore, suppliersByType, contractAlerts, recentCommunications, _a, qualityIssues, openQualityIssues;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, supabase_js_1.createClient)()];
                    case 1:
                    ...
                    case 2:
                        ...
                        preferredSuppliers = (suppliers === null || suppliers === void 0 ? void 0 : suppliers.filter(function (s) { return s.is_preferred; }).length) || 0;
                        criticalSuppliers = (suppliers === null || suppliers === void 0 ? void 0 : suppliers.filter(function (s) { return s.is_critical; }).length) || 0;
                        avgPerformanceScore = (suppliers === null || suppliers === void 0 ? void 0 : suppliers.length)
                            ? suppliers.reduce(function (sum, s) { return sum + (s.performance_score || 0); }, 0) / suppliers.length
                            : 0;
                        suppliersByType = (suppliers === null || suppliers === void 0 ? void 0 : suppliers.reduce(function (acc, supplier) {
    ...
    SupplierManagementService.prototype.getSupplierAnalytics = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (error) {
                            throw new Error("Erro ao buscar fornecedores para compara\u00E7\u00E3o: ".concat(error.message));
                        }
    ...
    // HELPER METHODS
    // =====================================================================================
    SupplierManagementService.prototype.getDeliveryPerformanceData = function (supplierId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    SupplierManagementService.prototype.getQualityPerformanceData = function (supplierId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                defectiveItems: (qualityIssues === null || qualityIssues === void 0 ? void 0 : qualityIssues.length) || 0,
                                returnedItems: (qualityIssues === null || qualityIssues === void 0 ? void 0 : qualityIssues.filter(function (i) { return i.issue_type === 'defective_product'; }).length) || 0
                            }];
                }
            });
        });
    };
    SupplierManagementService.prototype.getFinancialPerformanceData = function (supplierId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
