...
var PersonalizedRecommendationService = /** @class */ (() => {
  ...
  PersonalizedRecommendationService.prototype.updateRecommendationProfile = function (
    patientId,
    updates,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  PersonalizedRecommendationService.prototype.generatePersonalizedRecommendations = function (
    patientId,
    treatmentCategory,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            return [4 /*yield*/, this.getRecommendationProfile(patientId)];
          case 1:
            profile = _c.sent();
  ...
  PersonalizedRecommendationService.prototype.runRecommendationEngine = function (
    patientId,
    profile,
    factors,
    safetyProfile,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getBaseTreatmentOptions(category)];
          case 1:
                  ...
                  __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_d) {
                      recommendation = {
                        ...
                        ranking_scores:
                          ((_a = {}), (_a[option.id] = option.success_probability), _a),
                        rationale:
                          "Personalized recommendation based on patient factors and safety profile. Success probability: ".concat(
                            (option.success_probability * 100).toFixed(1),
                            "%",
                          ),
                        success_probabilities:
                          ((_b = {}), (_b[option.id] = option.success_probability), _b),
                        risk_assessments:
                          ((_c = {}),
                          (_c[option.id] = this.generateRiskAssessment(option, safetyProfile)),
                          _c),
                        contraindications:
                          (safetyProfile === null || safetyProfile === void 0
                            ? void 0
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw new Error("Failed to approve recommendation: ".concat(error.message));
            return [2 /*return*/, data];
        }
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw new Error("Failed to reject recommendation: ".concat(error.message));
            return [2 /*return*/, data];
        }
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 1:
            supabase = _b.sent();
            queryBuilder = supabase.from("recommendation_feedback").select("*", { count: "exact" });
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw new Error("Failed to create safety profile: ".concat(error.message));
            return [2 /*return*/, data];
        }
      });
    });
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("safety_profiles").select("*").eq("patient_id", patientId).single(),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error && error.code !== "PGRST116") {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              ...
              supabase
                .from("safety_profiles")
                .update(
                  __assign(__assign({}, updates), { last_reviewed: new Date().toISOString() }),
                )
                .eq("patient_id", patientId)
                .select()
                .single(),
          ...
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw new Error("Failed to update safety profile: ".concat(error.message));
            return [2 /*return*/, data];
        }
      });
    });
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 2:
            ...
            if (error)
              throw new Error(
                "Failed to record recommendation performance: ".concat(error.message),
              );
  ...
  PersonalizedRecommendationService.prototype.getRecommendationAnalytics = function (
    dateFrom,
    dateTo,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 1:
            supabase = _b.sent();
            query = supabase.from("treatment_recommendations").select("*");
          ...
          case 2:
            ...
            feedbackQuery = supabase.from("recommendation_feedback").select("*");
          ...
          case 3:
            ...
            totalRecommendations =
              (recommendations === null || recommendations === void 0
                ? void 0
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            supabase = _a.sent();
            factorsQuery = supabase.from("personalization_factors").select("*");
