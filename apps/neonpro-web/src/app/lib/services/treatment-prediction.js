...
var TreatmentPredictionService = /** @class */ (function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("prediction_models").insert(model).select().single(),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("prediction_models").update(updates).eq("id", id).select().single(),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
  ...
  TreatmentPredictionService.prototype.updatePredictionOutcome = function (
    id,
    outcome,
    outcomeDate,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("patient_factors").select("*").eq("patient_id", patientId).single(),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error && error.code !== "PGRST116") throw error;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            supabase = _b.sent();
            query = supabase.from("treatment_characteristics").select("*").order("treatment_type");
            if (treatmentType) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("treatment_characteristics").insert(characteristics).select().single(),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              this.generateRecommendations(prediction, patientFactors, treatmentChar),
            ];
          case 7:
            ...
            return [
              4 /*yield*/,
              this.generateAlternativeTreatments(
                request.patient_id,
          ...
          case 10:
            ...
            return [
              4 /*yield*/,
              this.generateRiskFactors(features, predictionResult.explainability_data),
            ];
          case 11:
            riskFactors = _b.sent();
            return [
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 4:
            error_1 = _b.sent();
            console.error(
              "Error generating prediction for patient ".concat(predictionRequest.patient_id, ":"),
              error_1,
            );
            return [3 /*break*/, 5];
          case 5:
  ...
  // ==================== ML MODEL OPERATIONS ====================
  TreatmentPredictionService.prototype.buildFeatureVector = function (
    patientFactors,
    treatmentChar,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_o) {
        features = {
          ...
          previous_treatments:
            ((_a = patientFactors.treatment_history) === null || _a === void 0
              ? void 0
              : _a.total_treatments) || 0,
          success_rate_history:
            ((_b = patientFactors.treatment_history) === null || _b === void 0
              ? void 0
              : _b.success_rate) || 0.5,
          medical_conditions:
            ((_c = patientFactors.medical_history) === null || _c === void 0
              ? void 0
              : _c.conditions) || [],
          medications:
            ((_d = patientFactors.medical_history) === null || _d === void 0
              ? void 0
              : _d.medications) || [],
          allergies:
            ((_e = patientFactors.medical_history) === null || _e === void 0
              ? void 0
              : _e.allergies) || [],
          // Lifestyle factors
          smoking_status:
            ((_f = patientFactors.lifestyle_factors) === null || _f === void 0
              ? void 0
              : _f.smoking) || "never",
          alcohol_consumption:
            ((_g = patientFactors.lifestyle_factors) === null || _g === void 0
              ? void 0
              : _g.alcohol) || "none",
          exercise_frequency:
            ((_h = patientFactors.lifestyle_factors) === null || _h === void 0
              ? void 0
              : _h.exercise) || "none",
          ...
          treatment_expectations:
            ((_j = patientFactors.psychological_factors) === null || _j === void 0
              ? void 0
              : _j.treatment_expectations) || "realistic",
          anxiety_level:
            ((_k = patientFactors.psychological_factors) === null || _k === void 0
              ? void 0
              : _k.anxiety_level) || 3,
          ...
          geographic_location:
            (_l = patientFactors.geographic_factors) === null || _l === void 0
              ? void 0
              : _l.location,
          support_system:
            ((_m = patientFactors.social_factors) === null || _m === void 0
              ? void 0
              : _m.support_system) || "moderate",
        };
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            explainability_data = {
              ...
              confidence_reasoning: "Prediction based on "
                .concat(Object.keys(features).length, " patient factors with ")
                .concat((model.accuracy * 100).toFixed(1), "% model accuracy."),
            };
            return [
              2 /*return*/,
              {
  ...
  TreatmentPredictionService.prototype.generateRecommendations = function (
    prediction,
    patientFactors,
    treatmentChar,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        ...
        if (
          ((_a = patientFactors.lifestyle_factors) === null || _a === void 0
            ? void 0
            : _a.smoking) === "current"
        ) {
          recommendations.push({
        ...
        // Anxiety management
        if (
          ((_b = patientFactors.psychological_factors) === null || _b === void 0
            ? void 0
            : _b.anxiety_level) &&
        ...
        if (
          ((_c = patientFactors.psychological_factors) === null || _c === void 0
            ? void 0
            : _c.treatment_expectations) === "unrealistic"
        ) {
          recommendations.push({
            type: "preparation",
  ...
  TreatmentPredictionService.prototype.generateAlternativeTreatments = function (
    patientId,
    currentTreatment,
    features,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 5:
            error_2 = _b.sent();
            console.error(
              "Error generating alternative prediction for ".concat(treatment.treatment_type, ":"),
              error_2,
            );
            return [3 /*break*/, 6];
          case 6:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("prediction_feedback").insert(feedback).select().single(),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
          ...
          case 0:
            return [
              ...
              this.createModel({
                ...
                feature_count:
                  ((_a = request.feature_selection) === null || _a === void 0
                    ? void 0
                    : _a.length) || 0,
              }),
            ];
