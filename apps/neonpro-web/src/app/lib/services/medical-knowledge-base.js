...
var MedicalKnowledgeBaseService = /** @class */ (function () {
    ...
    MedicalKnowledgeBaseService.prototype.updateKnowledgeSource = function (id, updates) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        validatedData = medical_knowledge_base_1.updateKnowledgeSourceRequestSchema.parse(updates);
                        return [4 /*yield*/, (0, server_1.createClient)()];
                    case 1:
                        supabase = _b.sent();
                        return [4 /*yield*/, supabase
    ...
    MedicalKnowledgeBaseService.prototype.createMedicalKnowledge = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        validatedData = medical_knowledge_base_1.createMedicalKnowledgeRequestSchema.parse(data);
                        return [4 /*yield*/, (0, server_1.createClient)()];
                    case 1:
                        supabase = _b.sent();
                        return [4 /*yield*/, supabase
                ...
                switch (_g.label) {
                    case 0:
                        ...
                        if (validatedQuery.filters) {
                            ...
                            if ((_d = filters.medical_categories) === null || _d === void 0 ? void 0 : _d.length) {
                        ...
                        page = ((_e = validatedQuery.pagination) === null || _e === void 0 ? void 0 : _e.page) || 1;
                        limit = ((_f = validatedQuery.pagination) === null || _f === void 0 ? void 0 : _f.limit) || 20;
                        offset = (page - 1) * limit;
    ...
    MedicalKnowledgeBaseService.prototype.searchDrugs = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var validatedQuery, dbQuery, _a, drugs, error, count, interactions, drugIds, checkIds, _b, interactionData, interactionError;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        interactions = [];
                        if (!(((_c = validatedQuery.interaction_check) === null || _c === void 0 ? void 0 : _c.length) && (drugs === null || drugs === void 0 ? void 0 : drugs.length))) return [3 /*break*/, 3];
                        drugIds = drugs.map(function (d) { return d.id; });
                        checkIds = validatedQuery.interaction_check;
                        return [4 /*yield*/, supabase
                                .from('drug_interactions')
                                .select('*')
                                .or("and(drug_1_id.in.(".concat(drugIds.join(','), "),drug_2_id.in.(").concat(checkIds.join(','), ")),and(drug_1_id.in.(").concat(checkIds.join(','), "),drug_2_id.in.(").concat(drugIds.join(','), "))"))];
                    case 2:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, supabase
                                .from('drug_interactions')
                                .select('*')
                                .or("and(drug_1_id.in.(".concat(drugIds.join(','), "),drug_2_id.in.(").concat(drugIds.join(','), ")),and(drug_2_id.in.(").concat(drugIds.join(','), "),drug_1_id.in.(").concat(drugIds.join(','), "))"))];
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if ((_b = filters === null || filters === void 0 ? void 0 : filters.conditions) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    MedicalKnowledgeBaseService.prototype.validateRecommendation = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var validatedRequest, evidenceQuery, supabase, _a, evidence, error, evidenceSources, supportingEvidence, conflictingEvidence, overallStatus, confidenceScore, action, humanReviewRequired, validationResult, _b, storedValidation, storeError;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        validatedRequest = medical_knowledge_base_1.evidenceValidationRequestSchema.parse(request);
                        evidenceQuery = validatedRequest.recommendation_content.title ||
                    ...
                    case 2:
                        ...
                        evidenceSources = (evidence === null || evidence === void 0 ? void 0 : evidence.map(function (item) {
                            var _a;
                            return ({
                                source_id: item.source_id || '',
                                source_name: ((_a = item.knowledge_sources) === null || _a === void 0 ? void 0 : _a.source_name) || 'Unknown',
                        ...
                        supportingEvidence = evidenceSources.filter(function (e) { return e.supports_recommendation; });
                        conflictingEvidence = evidenceSources.filter(function (e) { return e.conflicting_evidence; });
                        ...
                        validationResult = {
                            ...
                            validation_notes: "Automated validation based on ".concat(evidenceSources.length, " evidence sources"),
                            automated: true,
                        };
                        return [4 /*yield*/, supabase
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, {
                                ...
                                recommendations: {
                                    action: action,
                                    reason: "Based on analysis of ".concat(evidenceSources.length, " evidence sources"),
    ...
    MedicalKnowledgeBaseService.prototype.getKnowledgeBaseDashboard = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, sourcesResult, knowledgeResult, validationsResult, totalSources, activeSources, totalKnowledge, validationsPending, _b, sourceDetails, sourceError, sourceStatus;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _a = _d.sent(), sourcesResult = _a[0], knowledgeResult = _a[1], validationsResult = _a[2];
                        totalSources = sourcesResult.count || 0;
                        activeSources = ((_c = sourcesResult.data) === null || _c === void 0 ? void 0 : _c.filter(function (s) { return s.status === 'active'; }).length) || 0;
                    ...
                    case 2:
                        ...
                        sourceStatus = (sourceDetails === null || sourceDetails === void 0 ? void 0 : sourceDetails.map(function (source) { return ({
                            source_id: source.id,
    ...
    MedicalKnowledgeBaseService.prototype.getKnowledgeTypes = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, ['guideline', 'research', 'drug_info', 'diagnosis', 'treatment', 'protocol', 'reference']];
            });
        });
    };
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        data === null || data === void 0 ? void 0 : data.forEach(function (item) {
                            var _a;
                            (_a = item.medical_categories) === null || _a === void 0 ? void 0 : _a.forEach(function (cat) { return categories.add(cat); });
                        });
