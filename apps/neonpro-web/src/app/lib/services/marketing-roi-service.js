...
var MarketingROIService = /** @class */ (function () {
     ...
     */
    MarketingROIService.prototype.createMarketingCampaign = function (clinicId, campaignData, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        campaign = __assign(__assign({ id: crypto.randomUUID(), clinic_id: clinicId }, campaignData), { start_date: new Date(campaignData.start_date), end_date: campaignData.end_date ? new Date(campaignData.end_date) : undefined, status: marketing_roi_1.CampaignStatus.DRAFT, actual_spend: 0, impressions: 0, clicks: 0, leads_generated: 0, conversions: 0, revenue_generated: 0, profit_generated: 0, roi_percentage: 0, profit_roi_percentage: 0, ltv_cac_ratio: 0, payback_period_days: 0, created_at: new Date(), updated_at: new Date(), created_by: userId });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, supabase
                                .from('marketing_campaigns')
                                .update(__assign(__assign(__assign({}, metrics), updatedMetrics), { updated_at: new Date() }))
                                .eq('id', campaignId)
                                .select()
                                .single()];
                    case 4:
    ...
    MarketingROIService.prototype.calculateCampaignROI = function (campaign, newMetrics) {
        return __awaiter(this, void 0, void 0, function () {
            var actualSpend, revenueGenerated, profitGenerated, conversions, roiPercentage, profitROIPercentage, cac, estimatedLTV, ltvCacRatio, monthlyRevenuePerCustomer, paybackPeriodDays;
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        actualSpend = (_a = newMetrics.actual_spend) !== null && _a !== void 0 ? _a : campaign.actual_spend;
                        revenueGenerated = (_b = newMetrics.revenue_generated) !== null && _b !== void 0 ? _b : campaign.revenue_generated;
                        profitGenerated = (_c = newMetrics.profit_generated) !== null && _c !== void 0 ? _c : campaign.profit_generated;
                        conversions = (_d = newMetrics.conversions) !== null && _d !== void 0 ? _d : campaign.conversions;
                        roiPercentage = actualSpend > 0 ? ((revenueGenerated - actualSpend) / actualSpend) * 100 : 0;
                    ...
                    case 1:
                        ...
                        paybackPeriodDays = cac > 0 && monthlyRevenuePerCustomer > 0
     ...
     */
    MarketingROIService.prototype.calculateTreatmentROI = function (clinicId, treatmentId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var treatmentData, totalCosts, grossProfit, grossMarginPercentage, roiPercentage, profitPerProcedure, clinicAverageROI, industryBenchmarkROI, ranking, optimizationAnalysis, treatmentROI, _a, data, error, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 7, , 8]);
                        return [4 /*yield*/, this.getTreatmentFinancialData(treatmentId, periodStart, periodEnd)];
                    case 1:
                        treatmentData = _b.sent();
                        totalCosts = treatmentData.direct_costs + treatmentData.indirect_costs +
                        ...
                        grossMarginPercentage = treatmentData.total_revenue > 0
                            ? (grossProfit / treatmentData.total_revenue) * 100
                            : 0;
                        roiPercentage = totalCosts > 0 ? (grossProfit / totalCosts) * 100 : 0;
                        profitPerProcedure = treatmentData.procedures_count > 0
                    ...
                    case 5:
                        ...
                        treatmentROI = __assign(__assign(__assign(__assign({ id: crypto.randomUUID(), clinic_id: clinicId, treatment_id: treatmentId, treatment_name: treatmentData.treatment_name }, treatmentData), { total_costs: totalCosts, gross_profit: grossProfit, gross_margin_percentage: grossMarginPercentage, roi_percentage: roiPercentage, profit_per_procedure: profitPerProcedure, clinic_average_roi: clinicAverageROI, industry_benchmark_roi: industryBenchmarkROI, ranking_among_treatments: ranking }), optimizationAnalysis), { period_start: periodStart, period_end: periodEnd, created_at: new Date(), updated_at: new Date() });
                        return [4 /*yield*/, supabase
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        query = supabase
                            ...
                            .eq('clinic_id', clinicId);
                        // Apply filters
                        if ((_b = filters === null || filters === void 0 ? void 0 : filters.treatment_ids) === null || _b === void 0 ? void 0 : _b.length) {
                        ...
                        sortBy = (filters === null || filters === void 0 ? void 0 : filters.sort_by) || 'roi_percentage';
     ...
     */
    MarketingROIService.prototype.calculateCAC = function (clinicId, channel, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, _a, campaigns, campaignError, totalSpend, totalCustomers, totalLeads, cac, costPerLead, conversionRate, leadToCustomerRate, previousPeriodStart, previousPeriodEnd, previousCAC, cacChangePercentage, clinicAverageCAC, industryBenchmarkCAC, customerQualityMetrics, cacAnalysis, _b, data, error, error_6;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 8, , 9]);
                    ...
                    case 2:
                        ...
                        if (campaignError)
                            throw campaignError;
                        totalSpend = (campaigns === null || campaigns === void 0 ? void 0 : campaigns.reduce(function (sum, c) { return sum + c.actual_spend; }, 0)) || 0;
                        totalCustomers = (campaigns === null || campaigns === void 0 ? void 0 : campaigns.reduce(function (sum, c) { return sum + c.conversions; }, 0)) || 0;
                        totalLeads = (campaigns === null || campaigns === void 0 ? void 0 : campaigns.reduce(function (sum, c) { return sum + c.leads_generated; }, 0)) || 0;
                        ...
                        return [4 /*yield*/, this.getPreviousCAC(clinicId, channel, previousPeriodStart, previousPeriodEnd)];
                    case 3:
                        previousCAC = _c.sent();
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.calculateCustomerQualityMetrics(clinicId, channel, periodStart, periodEnd)];
                    case 6:
                        customerQualityMetrics = _c.sent();
                        cacAnalysis = __assign(__assign({ id: crypto.randomUUID(), clinic_id: clinicId, channel: channel, period_start: periodStart, period_end: periodEnd, total_marketing_spend: totalSpend, customers_acquired: totalCustomers, cac: cac, conversion_rate: conversionRate, cost_per_lead: costPerLead, lead_to_customer_rate: leadToCustomerRate, previous_period_cac: previousCAC, cac_change_percentage: cacChangePercentage, clinic_average_cac: clinicAverageCAC, industry_benchmark_cac: industryBenchmarkCAC }, customerQualityMetrics), { created_at: new Date(), updated_at: new Date() });
                        return [4 /*yield*/, supabase
    ...
    MarketingROIService.prototype.calculateLTV = function (clinicId, patientId, acquisitionChannel) {
        return __awaiter(this, void 0, void 0, function () {
            var ltvData, cac, ltvCacRatio, paybackPeriodMonths, predictiveMetrics, ltvAnalysis, _a, data, error, error_7;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 8, , 9]);
                    ...
                    case 1:
                        ...
                        ltvData = _b.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.calculateAggregateLTV(clinicId, acquisitionChannel)];
                    case 3:
                        // Calculate aggregate LTV for channel or clinic
                        ltvData = _b.sent();
                        _b.label = 4;
                    case 4: return [4 /*yield*/, this.getCAC(clinicId, acquisitionChannel || marketing_roi_1.MarketingChannel.DIRECT)];
                    case 5:
                        cac = _b.sent();
                        ltvCacRatio = cac > 0 ? ltvData.lifetime_value / cac : 0;
                        paybackPeriodMonths = cac > 0 && ltvData.average_order_value > 0
                            ? cac / ltvData.average_order_value
                            : 0;
                        return [4 /*yield*/, this.calculateLTVPredictiveMetrics(clinicId, patientId, acquisitionChannel)];
                    case 6:
                        predictiveMetrics = _b.sent();
                        ltvAnalysis = __assign(__assign(__assign(__assign({ id: crypto.randomUUID(), clinic_id: clinicId, patient_id: patientId }, ltvData), { acquisition_channel: acquisitionChannel || marketing_roi_1.MarketingChannel.DIRECT, cac: cac, ltv_cac_ratio: ltvCacRatio, payback_period_months: paybackPeriodMonths }), predictiveMetrics), { period_start: new Date(Date.now() - 365 * 24 * 60 * 60 * 1000), period_end: new Date(), created_at: new Date(), updated_at: new Date() });
                        return [4 /*yield*/, supabase
    ...
    MarketingROIService.prototype.getCACLTVAnalysis = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var channels, cacPromises, cacAnalysis, ltvPromises, ltvAnalysis_1, ltvCacRatios, paybackAnalysis, error_8;
            var _this = this;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        alert_1 = __assign(__assign({ id: crypto.randomUUID(), clinic_id: clinicId }, alertData), { status: 'active', created_at: new Date(), updated_at: new Date() });
                        return [4 /*yield*/, supabase
                                .from('roi_alerts')
                                .insert(alert_1)
                                .select()
    ...
    MarketingROIService.prototype.generateOptimizationRecommendations = function (clinicId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var recommendations, campaignRecommendations, treatmentRecommendations, budgetRecommendations, channelRecommendations, error_12;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
     ...
     */
    MarketingROIService.prototype.createOptimizationRecommendation = function (clinicId, recommendationData, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        recommendation = __assign(__assign({ id: crypto.randomUUID(), clinic_id: clinicId }, recommendationData), { status: 'pending', created_at: new Date(), updated_at: new Date(), created_by: userId });
                        return [4 /*yield*/, supabase
     ...
     */
    MarketingROIService.prototype.getROIDashboardMetrics = function (clinicId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, _a, campaigns, campaignError, totalSpend, totalRevenue, totalProfit, overallROI, overallProfitROI, activeCampaigns, avgCampaignROI, sortedCampaigns, bestCampaign, worstCampaign, channelPerformance, cacLtvMetrics, treatmentProfitability, activeAlerts, optimizationOpportunities, trends, dashboardMetrics, error_14;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 9, , 10]);
                    ...
                    case 2:
                        ...
                        if (campaignError)
                            throw campaignError;
                        totalSpend = (campaigns === null || campaigns === void 0 ? void 0 : campaigns.reduce(function (sum, c) { return sum + c.actual_spend; }, 0)) || 0;
                        totalRevenue = (campaigns === null || campaigns === void 0 ? void 0 : campaigns.reduce(function (sum, c) { return sum + c.revenue_generated; }, 0)) || 0;
                        totalProfit = (campaigns === null || campaigns === void 0 ? void 0 : campaigns.reduce(function (sum, c) { return sum + c.profit_generated; }, 0)) || 0;
                        ...
                        activeCampaigns = (campaigns === null || campaigns === void 0 ? void 0 : campaigns.filter(function (c) { return c.status === marketing_roi_1.CampaignStatus.ACTIVE; })) || [];
                        avgCampaignROI = (campaigns === null || campaigns === void 0 ? void 0 : campaigns.length) > 0
                            ? campaigns.reduce(function (sum, c) { return sum + c.roi_percentage; }, 0) / campaigns.length
                            : 0;
                        sortedCampaigns = (campaigns === null || campaigns === void 0 ? void 0 : campaigns.sort(function (a, b) { return b.roi_percentage - a.roi_percentage; })) || [];
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.getTreatmentProfitabilityMetrics(clinicId, periodStart, periodEnd)];
                    case 5:
                    ...
                    case 8:
                        ...
                        dashboardMetrics = {
                            ...
                            total_campaigns_count: (campaigns === null || campaigns === void 0 ? void 0 : campaigns.length) || 0,
                            ...
                            potential_roi_improvement: optimizationOpportunities.reduce(function (sum, o) { return sum + o.roi_improvement_percentage; }, 0),
     ...
     */
    MarketingROIService.prototype.getROITrendData = function (clinicId_1, periodStart_1, periodEnd_1) {
        return __awaiter(this, arguments, void 0, function (clinicId, periodStart, periodEnd, granularity) {
     ...
     */
    MarketingROIService.prototype.generateROIForecast = function (clinicId, forecastType, entityId, forecastPeriodStart, forecastPeriodEnd, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.applyForecastingModel(historicalData, forecastPeriodStart, forecastPeriodEnd)];
                    case 2:
                        forecast = _b.sent();
                        roiForecast = {
     ...
     */
    MarketingROIService.prototype.createCampaignMonitoringRules = function (campaignId, clinicId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var rules;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MarketingROIService.prototype.sendAlertNotifications = function (alert) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log("Sending ROI alert notification: ".concat(alert.title, " (").concat(alert.severity, ")"));
                return [2 /*return*/];
            });
        });
    };
...
var createmarketingROIService = function () { return new MarketingROIService(); };
