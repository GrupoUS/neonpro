...
var DashboardService = /** @class */ (() => {
          ...
          case 1:
            ...
            return [
              ...
              supabase
                ...
                .insert(
                  __assign(__assign({ user_id: userId }, data), {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("dashboard_configurations").delete().eq("id", configId),
            ];
          case 2:
            error = _a.sent().error;
            if (error) throw error;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            supabase = _a.sent();
            return [4 /*yield*/, supabase.from("dashboard_widgets").delete().eq("id", widgetId)];
          case 2:
            error = _a.sent().error;
            if (error) throw error;
            return [2 /*return*/, { success: true }];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 1:
            supabase = _b.sent();
            query = supabase.from("dashboard_alerts").select("*").eq("user_id", userId);
            if (clinicId) query = query.eq("clinic_id", clinicId);
            return [4 /*yield*/, query];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            supabase = _a.sent();
            return [4 /*yield*/, supabase.from("dashboard_alerts").delete().eq("id", alertId)];
          case 2:
            error = _a.sent().error;
            if (error) throw error;
            return [2 /*return*/, { success: true }];
  ...
  DashboardService.prototype.setCachedData = function (cacheKey_1, data_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (cacheKey, data, expiresInMinutes, clinicId) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("dashboard_widgets").select("*").eq("id", widgetId).single(),
            ];
          case 2:
            (_a = _b.sent()), (widget = _a.data), (error = _a.error);
            if (error) throw error;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [3 /*break*/, 8];
          case 2:
            return [4 /*yield*/, this.getRevenueData(configuration, query)];
          case 3:
            return [2 /*return*/, _b.sent()];
          case 4:
            return [4 /*yield*/, this.getPatientData(configuration, query)];
          case 5:
            return [2 /*return*/, _b.sent()];
          case 6:
            return [4 /*yield*/, this.getAppointmentData(configuration, query)];
          case 7:
            return [2 /*return*/, _b.sent()];
          case 8:
            return [2 /*return*/, []];
