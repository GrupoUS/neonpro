...
var MultiLocationInventoryService = /** @class */ (function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            supabase = _b.sent();
            return [4 /*yield*/, supabase.from("inventory_items").insert(item).select().single()];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
            return [2 /*return*/, data];
          ...
          case 0:
            ...
            return [
              ...
              supabase
                .from("inventory_stock")
                .update(
                  __assign(__assign({}, updates), { last_counted_at: new Date().toISOString() }),
                )
                .eq("id", id)
                .select(
                  "\n        *,\n        inventory_item:inventory_items(*),\n        clinic:clinics(id, clinic_name, clinic_code),\n        room:rooms(id, name, description)\n      ",
          ...
          case 1:
            ...
            return [
              ...
              supabase
                .from("stock_transfers")
                .insert(
                  __assign(__assign({}, transfer), { requested_at: new Date().toISOString() }),
                )
                .select(
                  "\n        *,\n        inventory_item:inventory_items(id, name, sku, category),\n        from_clinic:from_clinic_id(id, clinic_name, clinic_code),\n        from_room:from_room_id(id, name),\n        to_clinic:to_clinic_id(id, clinic_name, clinic_code),\n        to_room:to_room_id(id, name)\n      ",
                )
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.rpc("get_inventory_movement_summary", {
  ...
  MultiLocationInventoryService.prototype.transferStock = function (
    inventory_item_id,
    from_clinic_id,
    to_clinic_id,
    quantity,
