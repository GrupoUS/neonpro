...
var SMSService = /** @class */ (() => {
  function SMSService() {}
  SMSService.sendSMS = function (phoneNumber, message) {
  ...
  SMSService.sendBulkSMS = function (phoneNumbers, message) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, (_a) => {
  ...
  SMSService.validatePhoneNumber = function (phoneNumber) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, (_a) => {
