...
var InventoryReportsService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        reportData = (movements === null || movements === void 0 ? void 0 : movements.map(function (movement) {
                            var _a;
                            return ({
                                ...
                                room_name: ((_a = movement.rooms) === null || _a === void 0 ? void 0 : _a.name) || 'N/A',
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        reportData = (stockData === null || stockData === void 0 ? void 0 : stockData.map(function (stock) {
                            var _a;
                            var daysSinceMovement = stock.last_updated
                                ? Math.floor((Date.now() - new Date(stock.last_updated).getTime()) / (1000 * 60 * 60 * 24))
                                : null;
                            ...
                            return {
                                ...
                                room_name: ((_a = stock.rooms) === null || _a === void 0 ? void 0 : _a.name) || 'N/A',
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        reportData = (expiringData === null || expiringData === void 0 ? void 0 : expiringData.map(function (item) {
                            var _a;
                            var expiryDate = new Date(item.expiry_date);
                            var today = new Date();
                            var daysToExpiry = Math.ceil((expiryDate.getTime() - today.getTime()) / (1000 * 60 * 60 * 24));
                            ...
                            return {
                                ...
                                room_name: ((_a = item.rooms) === null || _a === void 0 ? void 0 : _a.name) || 'N/A',
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        reportData = (transfers === null || transfers === void 0 ? void 0 : transfers.map(function (transfer) {
                            var _a, _b;
                            return ({
                                ...
                                from_room_name: ((_a = transfer.from_rooms) === null || _a === void 0 ? void 0 : _a.name) || 'N/A',
                                to_clinic_name: transfer.to_clinics.name,
                                to_room_name: ((_b = transfer.to_rooms) === null || _b === void 0 ? void 0 : _b.name) || 'N/A',
    ...
    InventoryReportsService.prototype.calculateTransferSummary = function (data) {
        ...
        summary.average_transfer_value = summary.total_transfers > 0
    ...
    InventoryReportsService.prototype.generateLocationPerformanceReport = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, locationsQuery, _a, clinics, clinicsError, reportData, _i, _b, clinic, performance_1, summary;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        reportData.push(__assign({ clinic_id: clinic.id, clinic_name: clinic.name }, performance_1));
                        _c.label = 4;
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
    ...
    InventoryReportsService.prototype.calculateLocationPerformance = function (clinicId, filters) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, stockData, movementQuery, movements, transfersOut, transfersIn, totalItems, totalValue, totalMovements, movementsIn, movementsOut, valueIn, valueOut, lowStockItems, turnoverRate, stockAccuracy, transferRequests, utilizationRate, performanceScore;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        totalItems = (stockData === null || stockData === void 0 ? void 0 : stockData.length) || 0;
                        ...
                        totalMovements = (movements === null || movements === void 0 ? void 0 : movements.length) || 0;
                        movementsIn = (movements === null || movements === void 0 ? void 0 : movements.filter(function (m) {
                            return ['in', 'return', 'adjustment'].includes(m.transaction_type) && m.quantity_change > 0;
                        }).length) || 0;
                        movementsOut = (movements === null || movements === void 0 ? void 0 : movements.filter(function (m) {
                            return ['out', 'transfer', 'waste'].includes(m.transaction_type) && m.quantity_change < 0;
                        }).length) || 0;
                        valueIn = (movements === null || movements === void 0 ? void 0 : movements.filter(function (m) { return m.quantity_change > 0; }).reduce(function (sum, m) { return sum + (Math.abs(m.quantity_change) * (m.unit_cost || 0)); }, 0)) || 0;
                        valueOut = (movements === null || movements === void 0 ? void 0 : movements.filter(function (m) { return m.quantity_change < 0; }).reduce(function (sum, m) { return sum + (Math.abs(m.quantity_change) * (m.unit_cost || 0)); }, 0)) || 0;
                        lowStockItems = (stockData === null || stockData === void 0 ? void 0 : stockData.filter(function (item) {
                            return item.current_quantity <= (item.inventory_items.minimum_quantity || 0);
                        }).length) || 0;
                        turnoverRate = totalValue > 0 ? (valueOut / totalValue) * 100 : 0;
                        stockAccuracy = totalItems > 0 ? ((totalItems - lowStockItems) / totalItems) * 100 : 100;
                        transferRequests = ((transfersOut === null || transfersOut === void 0 ? void 0 : transfersOut.length) || 0) + ((transfersIn === null || transfersIn === void 0 ? void 0 : transfersIn.length) || 0);
                        utilizationRate = totalItems > 0 ? (movementsOut / totalItems) * 100 : 0;
                        performanceScore = Math.min(100, (turnoverRate * 0.3) +
                            (stockAccuracy * 0.3) +
                            (utilizationRate * 0.2) +
    ...
    InventoryReportsService.prototype.calculateLocationPerformanceSummary = function (data) {
        ...
        return {
            ...
            average_performance_score: data.reduce(function (sum, loc) { return sum + loc.performance_score; }, 0) / data.length,
            best_performing_location: bestLocation.clinic_name,
            worst_performing_location: worstLocation.clinic_name,
            total_system_value: data.reduce(function (sum, loc) { return sum + loc.total_value; }, 0),
            total_system_movements: data.reduce(function (sum, loc) { return sum + loc.total_movements; }, 0),
            average_turnover_rate: data.reduce(function (sum, loc) { return sum + loc.turnover_rate; }, 0) / data.length,
            locations_needing_attention: data.filter(function (loc) { return loc.performance_score < 70; }).length,
        };
    };
    // =============================================================================
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = parameters.type;
                        switch (_a) {
                            case 'stock_movement': return [3 /*break*/, 1];
                            case 'stock_valuation': return [3 /*break*/, 2];
                            case 'expiring_items': return [3 /*break*/, 3];
                            case 'transfers': return [3 /*break*/, 4];
                            case 'location_performance': return [3 /*break*/, 5];
                            case 'low_stock': return [3 /*break*/, 6];
                        }
                        return [3 /*break*/, 8];
                    case 1: return [2 /*return*/, this.generateStockMovementReport(parameters.filters)];
                    case 2: return [2 /*return*/, this.generateStockValuationReport(parameters.filters)];
                    case 3: return [2 /*return*/, this.generateExpiringItemsReport(parameters.filters)];
                    case 4: return [2 /*return*/, this.generateTransferReport(parameters.filters)];
                    case 5: return [2 /*return*/, this.generateLocationPerformanceReport(parameters.filters)];
                    case 6: return [4 /*yield*/, this.generateStockValuationReport(parameters.filters)];
                    case 7:
                        result = _b.sent();
                    ...
                    case 8: throw new Error("Unsupported report type: ".concat(parameters.type));
                }
            });
        });
    };
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, supabase
                                ...
                                .insert([__assign(__assign({}, definition), { created_at: new Date().toISOString(), updated_at: new Date().toISOString() })])
                                .select()
                                .single()];
                    case 2:
...
var createinventoryReportsService = function () { return new InventoryReportsService(); };
