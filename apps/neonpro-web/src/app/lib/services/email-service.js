...
var EmailService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_1 = _a.sent();
                        console.error("Failed to initialize email provider ".concat(config.provider, ":"), error_1);
                        return [3 /*break*/, 5];
                    case 5:
                        _i++;
                        return [3 /*break*/, 1];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.logEmailEvent({
    ...
    EmailService.prototype.sendBulkEmail = function (messages_1, providerPreference_1) {
        return __awaiter(this, arguments, void 0, function (messages, providerPreference, batchSize) {
            var provider, results, totalSent, totalFailed, i, batch, batchResult, _i, _a, result, batchError_1, _b, batch_1, message, error_3;
            var _c;
                ...
                switch (_d.label) {
                    ...
                    case 10:
                        ...
                        for (_b = 0, batch_1 = batch; _b < batch_1.length; _b++) {
                            message = batch_1[_b];
                            results.push({
                                email: ((_c = message.to[0]) === null || _c === void 0 ? void 0 : _c.email) || 'unknown',
                                success: false,
                    ...
                    case 13:
                        ...
                        return [2 /*return*/, {
                                ...
                                results: messages.map(function (msg) {
                                    var _a;
                                    return ({
                                        email: ((_a = msg.to[0]) === null || _a === void 0 ? void 0 : _a.email) || 'unknown',
                                        success: false,
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, supabase
                                ...
                                .insert([__assign(__assign({}, template), { id: crypto.randomUUID(), created_at: new Date().toISOString(), updated_at: new Date().toISOString() })])
                                .select()
                                .single()];
                    case 2:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (filters === null || filters === void 0 ? void 0 : filters.search) {
                            query = query.or("name.ilike.%".concat(filters.search, "%,subject.ilike.%").concat(filters.search, "%"));
                        }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, query];
                    case 1:
                        _a = _c.sent(), _b = _a.data, events = _b === void 0 ? [] : _b, error = _a.error;
                        if (error) {
    ...
    EmailService.prototype.getDeliveryReport = function (messageId) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, _a, data, error, events, sentEvent, deliveredEvent, openedEvent, clickedEvent, bouncedEvent;
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        sentEvent = events.find(function (e) { return e.event === 'sent'; });
                        deliveredEvent = events.find(function (e) { return e.event === 'delivered'; });
                        openedEvent = events.find(function (e) { return e.event === 'opened'; });
                        clickedEvent = events.find(function (e) { return e.event === 'clicked'; });
                        bouncedEvent = events.find(function (e) { return e.event === 'bounced'; });
                        return [2 /*return*/, {
                                messageId: messageId,
                                recipient: ((_c = (_b = events[0]) === null || _b === void 0 ? void 0 : _b.metadata) === null || _c === void 0 ? void 0 : _c.recipient) || 'unknown',
                                status: ((_d = events[events.length - 1]) === null || _d === void 0 ? void 0 : _d.event) || 'unknown',
                                sentAt: (sentEvent === null || sentEvent === void 0 ? void 0 : sentEvent.timestamp) || new Date(),
                                deliveredAt: deliveredEvent === null || deliveredEvent === void 0 ? void 0 : deliveredEvent.timestamp,
                                openedAt: openedEvent === null || openedEvent === void 0 ? void 0 : openedEvent.timestamp,
                                clickedAt: clickedEvent === null || clickedEvent === void 0 ? void 0 : clickedEvent.timestamp,
                                bounceReason: bouncedEvent === null || bouncedEvent === void 0 ? void 0 : bouncedEvent.reason,
                                provider: ((_f = (_e = events[0]) === null || _e === void 0 ? void 0 : _e.metadata) === null || _f === void 0 ? void 0 : _f.provider) || 'unknown',
                                cost: (_h = (_g = events[0]) === null || _g === void 0 ? void 0 : _g.metadata) === null || _h === void 0 ? void 0 : _h.cost,
                            }];
                }
            });
        });
    ...
    EmailService.prototype.getProviderName = function (provider) {
        for (var _i = 0, _a = this.providers.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], name_1 = _b[0], p = _b[1];
            if (p === provider)
                return name_1;
        }
        return 'unknown';
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!validation.isValid) {
                            return [2 /*return*/, { isValid: false, reason: "Invalid recipient ".concat(recipient.email, ": ").concat(validation.reason) }];
                        }
                        _b.label = 3;
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, { isValid: true }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        if (!message.from.email && ((_b = this.settings) === null || _b === void 0 ? void 0 : _b.defaultFrom)) {
                            message.from = this.settings.defaultFrom;
                        }
                        // Apply default reply-to if not specified
                        if (!message.replyTo && ((_c = this.settings) === null || _c === void 0 ? void 0 : _c.defaultReplyTo)) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, supabase
                                .from('email_events')
                                .insert([__assign(__assign({}, event), { clinic_id: this.clinicId, timestamp: event.timestamp.toISOString() })])];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.transporter.sendMail({
                                ...
                                to: message.to.map(function (r) { return "".concat(r.name || '', " <").concat(r.email, ">"); }).join(', '),
                                cc: (_a = message.cc) === null || _a === void 0 ? void 0 : _a.map(function (r) { return "".concat(r.name || '', " <").concat(r.email, ">"); }).join(', '),
                                bcc: (_b = message.bcc) === null || _b === void 0 ? void 0 : _b.map(function (r) { return "".concat(r.name || '', " <").concat(r.email, ">"); }).join(', '),
                                replyTo: message.replyTo ? "".concat(message.replyTo.name || '', " <").concat(message.replyTo.email, ">") : undefined,
                                subject: message.subject,
                                html: message.htmlContent,
                                text: message.textContent,
                                attachments: (_c = message.attachments) === null || _c === void 0 ? void 0 : _c.map(function (att) { return ({
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        result = _b.sent();
                        results.push({
                            email: ((_a = message.to[0]) === null || _a === void 0 ? void 0 : _a.email) || 'unknown',
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        command = new client_ses_1.SendEmailCommand({
                            ...
                            Destination: {
                                ToAddresses: message.to.map(function (r) { return "".concat(r.name || '', " <").concat(r.email, ">"); }),
                                CcAddresses: (_a = message.cc) === null || _a === void 0 ? void 0 : _a.map(function (r) { return "".concat(r.name || '', " <").concat(r.email, ">"); }),
                                BccAddresses: (_b = message.bcc) === null || _b === void 0 ? void 0 : _b.map(function (r) { return "".concat(r.name || '', " <").concat(r.email, ">"); }),
                            },
                            Message: {
                            ...
                            ReplyToAddresses: message.replyTo ? ["".concat(message.replyTo.name || '', " <").concat(message.replyTo.email, ">")] : undefined,
...
var SendGridEmailProvider = /** @class */ (function () {
    ...
    SendGridEmailProvider.prototype.sendBulkEmail = function (messages) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, { success: false, results: [], totalSent: 0, totalFailed: messages.length }];
            });
        });
    };
