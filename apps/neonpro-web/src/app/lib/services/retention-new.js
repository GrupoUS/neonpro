            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        avgChurnProbability = (churnSummary === null || churnSummary === void 0 ? void 0 : churnSummary.reduce(function (sum, item) { return sum + (item.churn_probability || 0); }, 0)) / totalPatients || 0;
                        avgLifetimeValue = (churnSummary === null || churnSummary === void 0 ? void 0 : churnSummary.reduce(function (sum, item) { return sum + (item.lifetime_value || 0); }, 0)) / totalPatients || 0;
                        avgPredictedLTV = (churnSummary === null || churnSummary === void 0 ? void 0 : churnSummary.reduce(function (sum, item) { return sum + (item.predicted_ltv || 0); }, 0)) / totalPatients || 0;
                        avgRetentionScore = (churnSummary === null || churnSummary === void 0 ? void 0 : churnSummary.reduce(function (sum, item) { return sum + (item.retention_score || 0); }, 0)) / totalPatients || 0;
                        return [2 /*return*/, {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                segments: __spreadArray([], new Set(summary.map(function (p) { return p.retention_segment; })), true).map(function (segment) { return ({
                                    name: segment,
