...
var NoShowPredictionEngine = /** @class */ (function () {
    ...
    NoShowPredictionEngine.prototype.generatePrediction = function (appointmentId, patientId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAppointmentDetails(appointmentId)];
                    case 1:
                        appointment = _a.sent();
                        if (!appointment) {
    ...
    NoShowPredictionEngine.prototype.analyzeRiskFactors = function (patientId, appointment) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.calculateRiskFactors(patientId, appointment)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    NoShowPredictionEngine.prototype.updatePredictionOutcome = function (predictionId, actualOutcome) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    NoShowPredictionEngine.prototype.calculateAccuracyMetrics = function (clinicId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, _a, predictions, error, totalPredictions, correctPredictions, accuracy, precision, recall, f1Score;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    NoShowPredictionEngine.prototype.updateRiskFactorWeights = function (patientId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRiskFactorsByPatient(patientId)];
                    case 1:
                        factors = _a.sent();
                    ...
                    case 7:
                        _i++;
                        return [3 /*break*/, 3];
                    case 8: return [4 /*yield*/, this.getRiskFactorsByPatient(patientId)];
    ...
    NoShowPredictionEngine.prototype.getRecommendedInterventions = function (predictionId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getPrediction(predictionId)];
                    case 1:
                        prediction = _a.sent();
                    ...
                    case 2:
                        ...
                        existingTypes = (existing === null || existing === void 0 ? void 0 : existing.map(function (i) { return i.intervention_type; })) || [];
                        return [4 /*yield*/, this.generateInterventionRecommendations(prediction, existingTypes)];
                    case 3:
    ...
    NoShowPredictionEngine.prototype.getModelPerformance = function (modelVersion) {
        return __awaiter(this, void 0, void 0, function () {
            var version, supabase, _a, predictions, error, totalPredictions, correctPredictions, falsePositives, falseNegatives, truePositives, trueNegatives, accuracy, precision, recall, f1Score;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        truePositives = 0;
                        trueNegatives = 0;
                        predictions === null || predictions === void 0 ? void 0 : predictions.forEach(function (pred) {
    ...
    NoShowPredictionEngine.prototype.getDashboardStats = function () {
        return __awaiter(this, void 0, void 0, function () {
            var today, weekStart, monthStart, todayHighRisk, todayInterventions, weekAnalytics, monthAnalytics;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        today = new Date().toISOString().split('T')[0];
                        weekStart = new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString().split('T')[0];
                        monthStart = new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString().split('T')[0];
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, {
                                today: {
                                    ...
                                    predicted_no_shows: todayHighRisk.filter(function (p) { return p.risk_score >= 0.8; }).length,
    ...
    NoShowPredictionEngine.prototype.getNoShowTrends = function (startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, _a, analytics, error, totalAppointments, totalPredicted, totalActual, totalCost, totalRevenue, avgAccuracy;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (error)
                            throw error;
                        totalAppointments = (analytics === null || analytics === void 0 ? void 0 : analytics.reduce(function (sum, a) { return sum + (a.predicted_no_shows + a.actual_no_shows); }, 0)) || 0;
                        totalPredicted = (analytics === null || analytics === void 0 ? void 0 : analytics.reduce(function (sum, a) { return sum + a.predicted_no_shows; }, 0)) || 0;
                        totalActual = (analytics === null || analytics === void 0 ? void 0 : analytics.reduce(function (sum, a) { return sum + a.actual_no_shows; }, 0)) || 0;
                        totalCost = (analytics === null || analytics === void 0 ? void 0 : analytics.reduce(function (sum, a) { return sum + a.cost_impact; }, 0)) || 0;
                        totalRevenue = (analytics === null || analytics === void 0 ? void 0 : analytics.reduce(function (sum, a) { return sum + a.revenue_recovered; }, 0)) || 0;
                        avgAccuracy = (analytics === null || analytics === void 0 ? void 0 : analytics.reduce(function (sum, a) { return sum + a.accuracy_rate; }, 0)) / ((analytics === null || analytics === void 0 ? void 0 : analytics.length) || 1) || 0;
                        _b = {
                    ...
                    case 4: return [2 /*return*/, (_b.intervention_effectiveness = _c.sent(),
                            _b)];
                }
            });
        });
    ...
    NoShowPredictionEngine.prototype.calculatePrecision = function (predictions) {
        var _this = this;
        var predictedPositives = predictions.filter(function (p) { return p.risk_score >= _this.config.confidenceThreshold; });
        var truePositives = predictedPositives.filter(function (p) { return p.actual_outcome === 'no_show'; });
    ...
    NoShowPredictionEngine.prototype.calculateRecall = function (predictions) {
        var _this = this;
        var actualPositives = predictions.filter(function (p) { return p.actual_outcome === 'no_show'; });
        var truePositives = actualPositives.filter(function (p) { return p.risk_score >= _this.config.confidenceThreshold; });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (error)
                            throw error;
                        total = (appointments === null || appointments === void 0 ? void 0 : appointments.length) || 0;
                        noShows = (appointments === null || appointments === void 0 ? void 0 : appointments.filter(function (a) { return a.status === 'no_show'; }).length) || 0;
                        attended = (appointments === null || appointments === void 0 ? void 0 : appointments.filter(function (a) { return a.status === 'completed'; }).length) || 0;
                        lastAttendance = (_b = appointments === null || appointments === void 0 ? void 0 : appointments.find(function (a) { return a.status === 'completed'; })) === null || _b === void 0 ? void 0 : _b.start_time;
                        return [2 /*return*/, {
    ...
    NoShowPredictionEngine.prototype.calculateRiskFactors = function (patientId, appointment) {
        return __awaiter(this, void 0, void 0, function () {
            var factors, patientHistory, appointmentHour, timingRisk, dayOfWeek, dayRisk, createdFactors, _i, factors_2, factor, created, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        factors = [];
                    ...
                    case 6:
                        _i++;
                        return [3 /*break*/, 2];
                    case 7: return [2 /*return*/, createdFactors];
                }
            });
        });
    };
    NoShowPredictionEngine.prototype.runPredictionModel = function (riskFactors, historicalPattern) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, totalRisk, totalWeight, keyFactors, baseRiskScore, historyAdjustment, finalRiskScore, confidence;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, server_1.createClient)()];
                    case 1:
    ...
    NoShowPredictionEngine.prototype.calculatePredictionConfidence = function (riskFactors, historicalPattern) {
    ...
    NoShowPredictionEngine.prototype.generateInterventionRecommendations = function (prediction, existingTypes) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        interventions = data || [];
                        scheduled = interventions.filter(function (i) { return !i.executed_at; }).length;
                        estimatedCost = interventions.reduce(function (sum, i) { return sum + (i.cost_impact || 0); }, 0);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        analytics = data || [];
                        return [2 /*return*/, {
                                averageAccuracy: analytics.reduce(function (sum, a) { return sum + a.accuracy_rate; }, 0) / (analytics.length || 1),
                                interventionsExecuted: analytics.reduce(function (sum, a) { return sum + a.interventions_executed; }, 0),
                                successfulInterventions: analytics.reduce(function (sum, a) { return sum + a.interventions_executed * 0.7; }, 0), // Estimated
                                revenueSaved: analytics.reduce(function (sum, a) { return sum + a.revenue_recovered; }, 0),
                                totalPredictions: analytics.length * 10, // Estimated
                                costSavings: analytics.reduce(function (sum, a) { return sum + a.revenue_recovered - a.cost_impact; }, 0),
    ...
    NoShowPredictionEngine.prototype.calculateInterventionEffectiveness = function (startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
