...
var WhatsAppService = /** @class */ (() => {
  ...
  WhatsAppService.prototype.buildTemplateComponents = (template, parameters) =>
    template.components.map((component) => {
      if (component.type === "BODY" && component.text) {
        // Replace placeholders with actual parameters
        var text_1 = component.text;
        Object.entries(parameters).forEach((_a) => {
          var key = _a[0],
            value = _a[1];
...
var createwhatsAppService = () => new WhatsAppService();
