...
var WhatsAppService = /** @class */ (function () {
    ...
    WhatsAppService.prototype.sendMessage = function (phoneNumber_1, content_1) {
        return __awaiter(this, arguments, void 0, function (phoneNumber, content, type, patientId, templateName) {
            var config, messageRequest, response, errorData, result, messageId, error_3;
            var _a, _b;
            if (type === void 0) { type = whatsapp_1.WhatsAppMessageType.TEXT; }
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, fetch("".concat(WHATSAPP_API_BASE, "/").concat(config.phoneNumberId, "/messages"), {
                                method: 'POST',
                                headers: {
                    ...
                    case 4:
                        errorData = _c.sent();
                        throw new Error("WhatsApp API error: ".concat(((_a = errorData.error) === null || _a === void 0 ? void 0 : _a.message) || 'Unknown error'));
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, this.storeMessage({
                                patientId: patientId,
    ...
    WhatsAppService.prototype.sendTemplateMessage = function (phoneNumber_1, templateName_1) {
        return __awaiter(this, arguments, void 0, function (phoneNumber, templateName, parameters, patientId) {
            var config, template, components, messageRequest, response, errorData, result, messageId, error_4;
            var _a, _b;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, supabase
                                ...
                                .insert(__assign(__assign({}, message), { created_at: new Date().toISOString(), updated_at: new Date().toISOString() }))];
                    case 1:
                        error = (_a.sent()).error;
                        if (error) {
    ...
    WhatsAppService.prototype.buildTemplateComponents = function (template, parameters) {
        return template.components.map(function (component) {
            if (component.type === 'BODY' && component.text) {
                ...
                return {
                    type: 'body',
                    parameters: Object.values(parameters).map(function (value) { return ({
                        type: 'text',
                        text: value
                    }); })
                };
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        status_1 = _a[_i];
                        return [4 /*yield*/, this.updateMessageStatus(status_1.id, status_1.status, status_1.timestamp)];
                    case 2:
                        _d.sent();
                        _d.label = 3;
                    case 3:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.storeMessage({
                                ...
                                content: ((_a = message.text) === null || _a === void 0 ? void 0 : _a.body) || 'Mensagem recebida',
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, (data === null || data === void 0 ? void 0 : data.is_opted_in) || false];
                    case 3:
                        error_11 = _b.sent();
    ...
    WhatsAppService.prototype.recordOptIn = function (patientId_1, phoneNumber_1) {
        return __awaiter(this, arguments, void 0, function (patientId, phoneNumber, source, consentMessage) {
            var error, error_12;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (!isOptedIn) {
                            results.failed++;
                            results.errors.push("".concat(phoneNumber, ": Not opted in for WhatsApp communications"));
                            return [3 /*break*/, 7];
                        }
                    ...
                    case 6:
                        error_14 = _a.sent();
                        results.failed++;
                        results.errors.push("".concat(phoneNumber, ": ").concat(error_14 instanceof Error ? error_14.message : 'Unknown error'));
                        return [3 /*break*/, 7];
                    case 7:
                        _i++;
                        return [3 /*break*/, 1];
...
var createwhatsAppService = function () { return new WhatsAppService(); };
