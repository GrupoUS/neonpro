...
var RetentionAnalyticsService = /** @class */ (() => {
   ...
   */
  RetentionAnalyticsService.prototype.calculatePatientRetentionMetrics = function (
    patientId,
    clinicId,
  ) {
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              supabase.from("followup_responses").select("*").eq("patient_id", patientId),
            ];
          case 3:
            (_b = _e.sent()), (responses = _b.data), (responsesError = _b.error);
            if (responsesError) throw responsesError;
            return [4 /*yield*/, supabase.from("payments").select("*").eq("patient_id", patientId)];
          case 4:
            (_c = _e.sent()), (payments = _c.data), (paymentsError = _c.error);
            if (paymentsError) throw paymentsError;
            now = new Date();
            firstAppointment =
              appointments === null || appointments === void 0 ? void 0 : appointments[0];
            lastAppointment =
            ...
            totalFollowups =
              (responses === null || responses === void 0 ? void 0 : responses.length) || 0;
            respondedFollowups =
            ...
            metrics = {
              ...
              first_appointment_date:
                (firstAppointment === null || firstAppointment === void 0
                  ? void 0
                  : firstAppointment.date) || now.toISOString(),
              last_appointment_date:
                (lastAppointment === null || lastAppointment === void 0
                  ? void 0
                  : lastAppointment.date) || now.toISOString(),
  ...
  RetentionAnalyticsService.prototype.generateChurnPrediction = function (patientId_1, clinicId_1) {
    return __awaiter(this, arguments, void 0, function (patientId, clinicId, modelType) {
      var metrics,
        ...
        error_4;
      if (modelType === void 0) {
        modelType = retention_analytics_1.ChurnModelType.ENSEMBLE;
      }
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              supabase.from("churn_predictions").insert(churnPrediction).select().single(),
            ];
          case 5:
    ...
    return __awaiter(this, arguments, void 0, function (clinicId, riskLevel, limit, offset) {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            query = supabase.from("churn_predictions").select("*").eq("clinic_id", clinicId);
            if (riskLevel) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            newStrategy = __assign(__assign({}, strategy), {
              success_rate: 0,
              patients_targeted: 0,
              patients_retained: 0,
            ...
            return [
              4 /*yield*/,
              supabase.from("retention_strategies").insert(newStrategy).select().single(),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
    ...
    return __awaiter(this, arguments, void 0, function (clinicId, activeOnly) {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            query = supabase.from("retention_strategies").select("*").eq("clinic_id", clinicId);
            if (activeOnly) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("retention_strategies").select("*").eq("id", strategyId).single(),
            ];
          case 2:
   ...
   */
  RetentionAnalyticsService.prototype.generateRetentionAnalyticsDashboard = function (
    clinicId,
    periodStart,
    periodEnd,
  ) {
        ...
        switch (_b.label) {
          ...
          case 1:
            (_a = _b.sent()),
              (overview = _a[0]),
              (churnAnalysis = _a[1]),
              (strategyPerformance = _a[2]),
              (retentionBySegment = _a[3]),
              (retentionTrends = _a[4]),
              (churnPredictionsSummary = _a[5]);
            return [
              2 /*return*/,
              {
                clinic_id: clinicId,
   ...
   */
  RetentionAnalyticsService.prototype.generateRecommendedActions = function (
    metrics,
    churnProbability,
    riskLevel,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        ...
        if (
          riskLevel === retention_analytics_1.ChurnRiskLevel.CRITICAL ||
          riskLevel === retention_analytics_1.ChurnRiskLevel.HIGH
        ) {
          actions.push({
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              supabase.from("retention_performance").insert(performance).select().single(),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
   ...
   */
  RetentionAnalyticsService.prototype.updateStrategyPerformance = function (
    strategyId,
    performances,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  RetentionAnalyticsService.prototype.getRetentionOverview = function (
    clinicId,
    periodStart,
    periodEnd,
  ) {
  ...
  RetentionAnalyticsService.prototype.getChurnAnalysis = function (
    clinicId,
    periodStart,
    periodEnd,
  ) {
  ...
  RetentionAnalyticsService.prototype.getStrategyPerformanceMetrics = function (
    clinicId,
    periodStart,
    periodEnd,
  ) {
