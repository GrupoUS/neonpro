...
var BudgetApprovalService = /** @class */ (function () {
    ...
    BudgetApprovalService.prototype.createBudget = function (request, clinicId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        budgetData = __assign(__assign({}, request), { clinic_id: clinicId, created_by: userId, allocated_amount: 0, spent_amount: 0, remaining_amount: request.total_amount, status: 'draft' });
                    ...
                    case 1:
                        ...
                        if (error)
                            throw new Error("Failed to create budget: ".concat(error.message));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to update budget: ".concat(error.message));
                        return [2 /*return*/, data];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to list budgets: ".concat(error.message));
                        return [2 /*return*/, data || []];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to approve budget: ".concat(error.message));
                        return [2 /*return*/, data];
                }
            });
        });
    ...
    BudgetApprovalService.prototype.validateBudget = function (budgetId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getBudget(budgetId)];
                    case 1:
                        budget = _a.sent();
                        if (!budget) {
                            return [2 /*return*/, {
                        ...
                        utilizationRate = (budget.allocated_amount || 0) > 0 ? ((budget.spent_amount || 0) / (budget.allocated_amount || 0)) * 100 : 0;
    ...
    BudgetApprovalService.prototype.createBudgetAllocations = function (budgetId, allocations) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        allocationsData = allocations.map(function (allocation) { return (__assign(__assign({}, allocation), { budget_id: budgetId, available_amount: allocation.allocated_amount, percentage_of_total: 0 // Will be calculated after insert
                         })); });
                        return [4 /*yield*/, supabase
                    ...
                    case 1:
                        ...
                        totalAllocated = allocations.reduce(function (sum, allocation) { return sum + allocation.allocated_amount; }, 0);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to get budget allocations: ".concat(error.message));
                        return [2 /*return*/, data || []];
                }
            });
        });
    ...
    BudgetApprovalService.prototype.updateBudgetAllocatedAmount = function (budgetId, additionalAmount) {
        return __awaiter(this, void 0, void 0, function () {
            var error;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, supabase.rpc('update_budget_allocated_amount', {
                            budget_id: budgetId,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to create cost center: ".concat(error.message));
                        return [2 /*return*/, data];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to list cost centers: ".concat(error.message));
                        return [2 /*return*/, data || []];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to create approval request: ".concat(error.message));
                        return [2 /*return*/, data || []];
                }
            });
        });
    ...
    BudgetApprovalService.prototype.checkApprovalEligibility = function (purchaseOrderId) {
        return __awaiter(this, void 0, void 0, function () {
            var supabase, _a, approvals, error, totalApprovals, approvedCount, rejectedCount, pendingCount, isEligible, escalationRequired;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, server_1.createClient)()];
                    case 1:
                    ...
                    case 2:
                        ...
                        totalApprovals = (approvals === null || approvals === void 0 ? void 0 : approvals.length) || 0;
                        approvedCount = (approvals === null || approvals === void 0 ? void 0 : approvals.filter(function (a) { return a.status === 'approved'; }).length) || 0;
                        rejectedCount = (approvals === null || approvals === void 0 ? void 0 : approvals.filter(function (a) { return a.status === 'rejected'; }).length) || 0;
                        pendingCount = (approvals === null || approvals === void 0 ? void 0 : approvals.filter(function (a) { return a.status === 'pending'; }).length) || 0;
                        isEligible = rejectedCount === 0 && pendingCount === 0 && approvedCount >= totalApprovals;
                        escalationRequired = (approvals === null || approvals === void 0 ? void 0 : approvals.some(function (a) { return a.status === 'escalated'; })) || false;
                        return [2 /*return*/, {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to get workflow rules: ".concat(error.message));
                        // Filter rules based on trigger conditions
                        return [2 /*return*/, (data || []).filter(function (rule) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, supabase
                                .from('approval_workflow_rules')
                                .insert(__assign(__assign({}, request), { clinic_id: clinicId, created_by: userId }))
                                .select()
                                .single()];
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
                        if (error)
                            throw new Error("Failed to create workflow rule: ".concat(error.message));
                        return [2 /*return*/, data];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        allocations = _a.sent();
                        utilizationPercentage = (budget.allocated_amount || 0) > 0
                            ? ((budget.spent_amount || 0) / (budget.allocated_amount || 0)) * 100
                            : 0;
                        categories = allocations.map(function (allocation) { return ({
    ...
    BudgetApprovalService.prototype.getApprovalWorkflowPerformance = function (workflowId, periodStart, periodEnd) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    BudgetApprovalService.prototype.generateBudgetForecast = function (budgetId_1) {
        return __awaiter(this, arguments, void 0, function (budgetId, forecastMonths) {
            ...
            if (forecastMonths === void 0) { forecastMonths = 3; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getBudget(budgetId)];
                    case 1:
