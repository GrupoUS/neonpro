...
var CommunicationService = /** @class */ (() => {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              supabase.from("communication_messages").insert(messageData).select().single(),
            ];
          case 7:
        ...
        switch (_b.label) {
          case 0:
            ...
            if (request.search) {
              query = query.or(
                "content.ilike.%"
                  .concat(request.search, "%,subject.ilike.%")
                  .concat(request.search, "%"),
              );
            }
                ...
                (threads || []).map((thread) =>
                  __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                      switch (_a.label) {
                        case 0:
                          return [4 /*yield*/, this.getUnreadMessageCount(thread.id)];
                        case 1:
                          unreadCount = _a.sent();
                          return [
                            2 /*return*/,
                            __assign(__assign({}, thread), { unread_count: unreadCount }),
                          ];
                      }
                    });
                  }),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [3 /*break*/, 5];
          case 3:
            return [4 /*yield*/, this.getCampaignRecipients(campaign.target_audience)];
          case 4:
            _a = _b.sent();
            _b.label = 5;
          case 5:
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          ...
          case 2:
            ...
            if (!consent) return [2 /*return*/, false];
        ...
        switch (_c.label) {
          ...
          case 2:
            ...
            _b = {
              period: period,
              total_messages:
                (messageStats === null || messageStats === void 0 ? void 0 : messageStats.length) ||
                0,
          ...
          case 7:
            stats = ((_b.staff_performance = _c.sent()), _b);
        ...
        switch (_b.label) {
          ...
          case 1:
            (_a = _b.sent()),
              (stats = _a[0]),
              (recentMessages = _a[1]),
              (activeCampaigns = _a[2]),
              (pendingApprovals = _a[3]),
              (failedMessages = _a[4]),
              (topPerformers = _a[5]);
            return [
              2 /*return*/,
  ...
  CommunicationService.prototype.queueCampaignMessages = function (
    campaign,
    recipients,
    executionId,
  ) {
