...
var IntelligentThresholdService = /** @class */ (function () {
    ...
    IntelligentThresholdService.prototype.createThreshold = function (threshold) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.calculateIntelligentThresholds(threshold.item_id, threshold.clinic_id, {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, supabase
                                ...
                                .insert(__assign(__assign(__assign({}, threshold), calculatedThreshold), { last_calculation_date: new Date().toISOString() }))
                                .select()
                                .single()];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        calculatedUpdates = {};
                        if (!(updates.reorder_point || updates.safety_stock || updates.demand_forecast_weekly || updates.lead_time_days)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.getThreshold(id)];
                    case 1:
                        existing = _b.sent();
                        if (!existing) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.calculateIntelligentThresholds(existing.item_id, existing.clinic_id, {
                    ...
                    case 3: return [4 /*yield*/, supabase
                            .from('reorder_thresholds')
                            .update(__assign(__assign(__assign({}, updates), calculatedUpdates), { last_calculation_date: new Date().toISOString(), updated_at: new Date().toISOString() }))
                            .eq('id', id)
                            .select()
                            .single()];
                    case 4:
                ...
                switch (_c.label) {
                    case 0:
                        query = supabase
                            ...
                            .eq('is_active', true);
                        if ((_b = filters === null || filters === void 0 ? void 0 : filters.item_category) === null || _b === void 0 ? void 0 : _b.length) {
                            query = query.in('inventory_items.category', filters.item_category);
                        }
                        if ((filters === null || filters === void 0 ? void 0 : filters.auto_reorder_enabled) !== undefined) {
    ...
    IntelligentThresholdService.prototype.calculateIntelligentThresholds = function (itemId, clinicId, baseParams) {
        return __awaiter(this, void 0, void 0, function () {
            var demandHistory, demandStats, seasonalFactor, leadTimeVariability, avgDailyDemand, demandDuringLeadTime, variabilityFactor, serviceLevel, calculatedSafetyStock, calculatedReorderPoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getHistoricalDemand(itemId, clinicId, 90)];
                    case 1:
                    ...
                    case 3:
                        ...
                        variabilityFactor = Math.sqrt((demandStats.variance * baseParams.lead_time_days) +
                        ...
                        calculatedReorderPoint = Math.ceil(demandDuringLeadTime * seasonalFactor + calculatedSafetyStock);
                        return [2 /*return*/, {
    ...
    IntelligentThresholdService.prototype.generateDemandForecast = function (itemId, clinicId, forecastPeriod, forecastDate) {
        return __awaiter(this, void 0, void 0, function () {
            var historicalData, forecast, seasonalFactor, adjustedDemand, appointmentDemand, demandForecast, _a, data, error;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getHistoricalDemand(itemId, clinicId, 365)];
                    case 1:
                        historicalData = _b.sent();
                        return [4 /*yield*/, this.calculatePredictiveForecast(historicalData, forecastPeriod, forecastDate)];
                    case 2:
                        forecast = _b.sent();
    ...
    IntelligentThresholdService.prototype.createAlert = function (alert) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        deliveryTime = this.estimateNotificationDeliveryTime(alert.notification_channels || ['dashboard']);
                        return [4 /*yield*/, (0, server_1.createClient)()];
                    case 1:
                        supabase = _b.sent();
                        return [4 /*yield*/, supabase
                                .from('reorder_alerts')
                                .insert(__assign(__assign({}, alert), { delivery_time_ms: deliveryTime, notification_sent: false, status: 'pending' }))
                                .select()
                                .single()];
                    case 2:
                        _a = _b.sent(), data = _a.data, error = _a.error;
    ...
    IntelligentThresholdService.prototype.acknowledgeAlert = function (id, userId, notes) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.updateAlert(id, {
                        status: 'acknowledged',
    ...
    IntelligentThresholdService.prototype.analyzeThresholdOptimization = function (clinicId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getThresholdsByClinic(clinicId)];
                    case 1:
                        thresholds = _a.sent();
                        optimizations = [];
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, optimizations.sort(function (a, b) { return b.potential_savings - a.potential_savings; })];
                }
            });
        });
    };
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        stats = {
                            ...
                            pending_alerts: alerts.filter(function (a) { return a.status === 'pending'; }).length,
                            critical_alerts: alerts.filter(function (a) { return a.priority === 'critical' || a.priority === 'emergency'; }).length,
                            emergency_alerts: alerts.filter(function (a) { return a.priority === 'emergency'; }).length,
    ...
    IntelligentThresholdService.prototype.calculateDemandStatistics = function (demandHistory) {
        ...
        var values = demandHistory.map(function (d) { return d.quantity; });
        var average = values.reduce(function (sum, val) { return sum + val; }, 0) / values.length;
        var variance = values.reduce(function (sum, val) { return sum + Math.pow(val - average, 2); }, 0) / values.length;
        var standardDeviation = Math.sqrt(variance);
        return { average: average, variance: variance, standardDeviation: standardDeviation };
    };
    IntelligentThresholdService.prototype.calculateSeasonalAdjustment = function (itemId, clinicId, date) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (error || !data.length)
                            return [2 /*return*/, 0.5]; // Default variability
                        leadTimes = data.map(function (d) { return d.average_lead_time_days; });
                        avg = leadTimes.reduce(function (sum, val) { return sum + val; }, 0) / leadTimes.length;
                        variance = leadTimes.reduce(function (sum, val) { return sum + Math.pow(val - avg, 2); }, 0) / leadTimes.length;
                        return [2 /*return*/, variance / Math.pow(avg, 2)]; // Coefficient of variation
                }
            });
        });
    };
    IntelligentThresholdService.prototype.calculatePredictiveForecast = function (historicalData, period, date) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        average = recentData.length > 0
                            ? recentData.reduce(function (sum, d) { return sum + d.quantity; }, 0) / recentData.length
                            : 0;
                        return [2 /*return*/, {
    ...
    IntelligentThresholdService.prototype.getAppointmentBasedDemand = function (itemId, clinicId, date) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.updateAlert(alert.id, {
    ...
    IntelligentThresholdService.prototype.calculateAverageResolutionTime = function (alerts) {
        var resolvedAlerts = alerts.filter(function (a) { return a.status === 'resolved' && a.resolved_at; });
