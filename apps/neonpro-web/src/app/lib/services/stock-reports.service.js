          ...
          case 4:
            ...
            return [
              2 /*return*/,
              {
                success: false,
                error: String(
                  (error_1 === null || error_1 === void 0 ? void 0 : error_1.message) || error_1,
                ),
              },
            ];
          case 5:
          ...
          case 4:
            ...
            return [
              2 /*return*/,
              {
                success: false,
                error: String(
                  (error_2 === null || error_2 === void 0 ? void 0 : error_2.message) || error_2,
                ),
              },
            ];
          case 5:
          ...
          case 4:
            ...
            return [
              2 /*return*/,
              {
                success: false,
                error: String(
                  (error_3 === null || error_3 === void 0 ? void 0 : error_3.message) || error_3,
                ),
              },
            ];
          case 5:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 2:
            _a.trys.push([2, 4, , 5]);
            return [4 /*yield*/, supabase.from("stock_report_configs").delete().eq("id", id)];
          case 3:
            error = _a.sent().error;
            if (error) throw error;
          ...
          case 4:
            ...
            return [
              2 /*return*/,
              {
                success: false,
                error: String(
                  (error_4 === null || error_4 === void 0 ? void 0 : error_4.message) || error_4,
                ),
              },
            ];
          case 5:
          ...
          case 3:
            ...
            reportData = {
              ...
              period: filters.dateRange
                ...
                : null,
              total_items:
                (usageData === null || usageData === void 0 ? void 0 : usageData.length) || 0,
          ...
          case 4:
            ...
            return [
              2 /*return*/,
              {
                success: false,
                error: String(
                  (error_5 === null || error_5 === void 0 ? void 0 : error_5.message) || error_5,
                ),
              },
            ];
          case 5:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            _b.trys.push([2, 4, , 5]);
            query = supabase.from("material_usage").select("*").eq("clinic_id", clinic_id);
            if (filters.dateRange) {
              query = query
                .gte("created_at", filters.dateRange.start.toISOString())
                .lte("created_at", filters.dateRange.end.toISOString());
          ...
          case 3:
            ...
            reportData = {
              ...
              by_type: {
                outbound:
                  (movements === null || movements === void 0 ? void 0 : movements.length) || 0, // Todas s�o sa�das no material_usage
          ...
          case 4:
            ...
            return [
              2 /*return*/,
              {
                success: false,
                error: String(
                  (error_6 === null || error_6 === void 0 ? void 0 : error_6.message) || error_6,
                ),
              },
            ];
          case 5:
          ...
          case 5:
            ...
            return [
              2 /*return*/,
              {
                success: false,
                error: String(
                  (error_7 === null || error_7 === void 0 ? void 0 : error_7.message) || error_7,
                ),
              },
            ];
          case 6:
          ...
          case 4:
            ...
            return [
              2 /*return*/,
              {
                success: false,
                error: String(
                  (error_8 === null || error_8 === void 0 ? void 0 : error_8.message) || error_8,
                ),
              },
            ];
          case 5:
