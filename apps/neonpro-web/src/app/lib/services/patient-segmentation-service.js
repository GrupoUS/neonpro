  ...
  PatientSegmentationService.prototype.createAISegment = function (data) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this.generateAICriteria(data)];
          case 1:
            aiCriteria = _b.sent();
            return [4 /*yield*/, (0, server_1.createClient)()];
          case 2:
                ...
                patients.map(function (patient) {
                  return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                      switch (_a.label) {
                        case 0:
                          return [4 /*yield*/, this.generatePatientBehaviorAnalysis(patient)];
                        case 1:
                          return [2 /*return*/, _a.sent()];
                      }
                    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          ...
          case 1:
            supabase = _e.sent();
            _c = (_b = supabase.from("segmentation_rules")).insert;
            _d = {
          ...
          case 4:
            ...
            _e.label = 5;
          case 5:
            return [2 /*return*/, segmentationRule];
        }
      });
    });
  };
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("segmentation_rules").select("*").eq("id", ruleId).single(),
            ];
          case 2:
            ...
            return [
              4 /*yield*/,
              this.createAISegment({
                segment_name: ""
                  .concat(rule.rule_name, "_")
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              supabase.from("patient_consent").select("*").eq("patient_id", patientId).single(),
            ];
          case 1:
          ...
          case 0:
            return [
              ...
              supabase.from("patient_consent").upsert(
                __assign(__assign({ patient_id: patientId }, consents), {
                  last_updated: new Date().toISOString(),
                }),
              ),
            ];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        criteria = {
          ...
          behavioral:
            ((_b = data.criteria) === null || _b === void 0 ? void 0 : _b.behavioral) || {},
          psychographic:
            ((_c = data.criteria) === null || _c === void 0 ? void 0 : _c.psychographic) || {},
          ai_generated: true,
  ...
  PatientSegmentationService.prototype.generateSegmentMemberships = function (segmentId, criteria) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.analyzePatientsForSegmentation(segmentId)];
          case 1:
            analyses = _a.sent();
  ...
  PatientSegmentationService.prototype.generateSegmentPerformance = function (segmentId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this.getSegmentMemberships(segmentId)];
          case 1:
            memberships = _b.sent();
            performance = {
              segment_id: segmentId,
            ...
            return [
              4 /*yield*/,
              supabase.from("segment_performance").insert(performance).select().single(),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("segment_memberships").select("*").eq("segment_id", segmentId),
            ];
          case 2:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
  ...
  PatientSegmentationService.prototype.updateRulePerformance = function (ruleId, segmentId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getSegmentPerformance(segmentId)];
          case 1:
            performance = _a.sent();
            return [
              4 /*yield*/,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              supabase.from("segment_memberships").delete().eq("patient_id", patientId),
            ];
          case 1:
            error = _a.sent().error;
            if (error) throw error;
