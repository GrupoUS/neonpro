...
var ProgressTrackingService = /** @class */ (function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            user = _b.sent();
            trackingData = __assign(__assign({}, data), {
              created_by: user.id,
              updated_by: user.id,
            });
            return [
              4 /*yield*/,
              supabase.from("progress_tracking").insert(trackingData).select().single(),
            ];
          case 2:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("progress_tracking").select("*").eq("id", id).single(),
            ];
          case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            user = _b.sent();
            milestoneData = __assign(__assign({}, data), {
              created_by: user.id,
              updated_by: user.id,
            });
            return [
              4 /*yield*/,
              supabase.from("progress_milestones").insert(milestoneData).select().single(),
            ];
          case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            user = _b.sent();
            predictionData = __assign(__assign({}, data), {
              created_by: user.id,
              updated_by: user.id,
            });
            return [
              4 /*yield*/,
              supabase.from("progress_predictions").insert(predictionData).select().single(),
            ];
          case 2:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            analysisData = __assign(__assign({}, data), {
            ...
            return [
              4 /*yield*/,
              supabase.from("multi_session_analysis").insert(analysisData).select().single(),
            ];
          case 3:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("progress_alerts").insert(alertData).select().single(),
            ];
          case 2:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              supabase.from("tracking_metrics").insert(metricData).select().single(),
            ];
          case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            (_a = _b.sent()),
              (totalTrackings = _a[0].count),
              (activeData = _a[1].data),
              (milestoneData = _a[2].data),
              (alertData = _a[3].data),
            ...
            return [
              2 /*return*/,
              {
                ...
                milestone_achievements:
                  (milestoneData === null || milestoneData === void 0
                    ? void 0
                    : milestoneData.length) || 0,
                pending_validations: 0, // Would need separate query
                urgent_alerts:
                  (alertData === null || alertData === void 0 ? void 0 : alertData.length) || 0,
  ...
  ProgressTrackingService.prototype.processProgressAnalysis = function (
    imageData,
    analysisType,
    baselineId,
  ) {
