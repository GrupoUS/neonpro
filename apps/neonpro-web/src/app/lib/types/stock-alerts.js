...
exports.REPORT_TYPE_LABELS = exports.NOTIFICATION_CHANNEL_LABELS = exports.STATUS_LABELS = exports.SEVERITY_LABELS = exports.ALERT_TYPE_LABELS = exports.StockAlertValidationError = exports.validateReportsQuery = exports.validateAlertsQuery = exports.validateCustomStockReport = exports.validateResolveAlert = exports.validateAcknowledgeAlert = exports.validateCreateStockAlertConfig = exports.validateStockAlertConfig = exports.reportsQuerySchema = exports.alertsQuerySchema = exports.stockDashboardDataSchema = exports.recommendationSchema = exports.wasteAnalysisSchema = exports.alertsByTypeSchema = exports.topProductSchema = exports.consumptionTrendSchema = exports.stockKPIsSchema = exports.stockPerformanceMetricsSchema = exports.createCustomReportSchema = exports.customStockReportSchema = exports.resolveAlertSchema = exports.acknowledgeAlertSchema = exports.stockAlertSchema = exports.updateStockAlertConfigSchema = exports.createStockAlertConfigSchema = exports.stockAlertConfigSchema = exports.ReportType = exports.NotificationChannel = exports.ThresholdUnit = exports.AlertStatus = exports.SeverityLevel = exports.AlertType = void 0;
...
var severityLevelSchema = zod_1.z.enum([
    'low',
    'medium',
    'high',
    'critical'
...
var alertStatusSchema = zod_1.z.enum([
    'active',
    'acknowledged',
    'resolved',
    'dismissed'
...
var thresholdUnitSchema = zod_1.z.enum([
    'quantity',
    'days',
    'percentage'
]);
// Notification channels validation
var notificationChannelSchema = zod_1.z.enum([
    'in_app',
    'email',
    'whatsapp',
    'sms'
...
exports.stockAlertConfigSchema = zod_1.z.object({
    ...
    notificationChannels: zod_1.z.array(notificationChannelSchema).min(1, 'At least one notification channel required'),
    createdAt: zod_1.z.date().optional(),
    updatedAt: zod_1.z.date().optional(),
    createdBy: uuidSchema.optional(),
    updatedBy: uuidSchema.optional()
}).refine(function (data) { return data.productId || data.categoryId || (!data.productId && !data.categoryId); }, {
...
exports.createStockAlertConfigSchema = zod_1.z.object({
    clinicId: uuidSchema,
    productId: uuidSchema.optional(),
    categoryId: uuidSchema.optional(),
    alertType: alertTypeSchema,
...
exports.updateStockAlertConfigSchema = zod_1.z.object({
    productId: uuidSchema.optional(),
    categoryId: uuidSchema.optional(),
...
exports.acknowledgeAlertSchema = zod_1.z.object({
    ...
    note: zod_1.z.string().optional().transform(function (val) { return val === null || val === void 0 ? void 0 : val.trim(); }).pipe(zod_1.z.string().max(500, 'Note too long').optional())
});
// Resolve alert schema
exports.resolveAlertSchema = zod_1.z.object({
    alertId: uuidSchema,
    resolvedBy: uuidSchema,
    resolution: zod_1.z.string().min(1, 'Resolution description required').max(1000, 'Resolution too long'),
...
var reportFiltersSchema = zod_1.z.object({
    ...
    }).optional().refine(function (data) { return !data || data.start <= data.end; }, { message: "Start date must be before or equal to end date" }),
...
var reportScheduleConfigSchema = zod_1.z.object({
...
exports.customStockReportSchema = zod_1.z.object({
    ...
    clinicId: uuidSchema,
    userId: uuidSchema,
    reportName: zod_1.z.string().min(1, 'Report name required').max(200, 'Report name too long').trim(),
...
exports.stockDashboardDataSchema = zod_1.z.object({
    ...
    lastUpdated: zod_1.z.date().default(function () { return new Date(); })
});
// =====================================================
...
exports.STATUS_LABELS = (_c = {},
    ...
    _c);
exports.NOTIFICATION_CHANNEL_LABELS = (_d = {},
