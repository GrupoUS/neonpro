...
exports.CommunicationPreferencesSchema =
  exports.QuickResponseSchema =
  exports.CommunicationCampaignSchema =
  exports.CommunicationConsentSchema =
...
exports.CommunicationCampaignSchema = zod_1.z.object({
  ...
  target_audience: zod_1.z.object({
    include_criteria: zod_1.z.array(
      zod_1.z.object({
    ...
    exclude_criteria: zod_1.z.array(
      zod_1.z.object({
        field: zod_1.z.string(),
        operator: zod_1.z.string(),
        value: zod_1.z.any(),
