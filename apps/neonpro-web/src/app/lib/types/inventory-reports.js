...
exports.ScheduleReportRequestSchema = exports.GenerateReportRequestSchema = exports.ReportParametersSchema = exports.ReportFiltersSchema = void 0;
...
exports.ReportFiltersSchema = zod_1.z.object({
    ...
    movement_type: zod_1.z.enum(['in', 'out', 'transfer', 'adjustment', 'return', 'waste']).optional(),
...
exports.ReportParametersSchema = zod_1.z.object({
    type: zod_1.z.enum(['stock_movement', 'stock_valuation', 'expiring_items', 'low_stock', 'transfers', 'location_performance', 'supplier_analysis', 'category_analysis']),
