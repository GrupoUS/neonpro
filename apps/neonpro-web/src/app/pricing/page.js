...
function PricingPage() {
    ...
    var handleSelectPlan = function (planId) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map(function (_a, index) {
            var planId = _a[0], plan = _a[1];
            return (<card_1.Card key={planId} className={"relative overflow-hidden transition-all duration-300 hover:shadow-xl ".concat(index === 1
                    ? "border-2 border-blue-500 scale-105"
                    : "border hover:border-blue-300")}>
              {index === 1 && (<badge_1.Badge className="absolute top-4 right-4 bg-blue-500 text-white">
                  Mais Popular
                </badge_1.Badge>)}
              ...
              <card_1.CardFooter>
                <button_1.Button className={"w-full ".concat(index === 1
                    ? "bg-blue-600 hover:bg-blue-700"
                    : "bg-gray-900 hover:bg-gray-800")} onClick={function () { return handleSelectPlan(planId); }} disabled={loading !== null}>
                  {loading === planId ? (<>
