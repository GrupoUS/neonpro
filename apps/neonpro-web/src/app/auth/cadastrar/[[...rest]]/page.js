...
exports.default = CadastrarPage;
var nextjs_1 = require("@clerk/nextjs");
function CadastrarPage() {
    return (<div className="min-h-screen bg-gradient-to-br from-sky-50 to-slate-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8">
          <nextjs_1.SignUp path="/auth/cadastrar" routing="path" signInUrl="/auth/entrar" redirectUrl="/dashboard" appearance={{
            elements: {
                rootBox: "mx-auto",
