...
function DashboardPage() {
    ...
    var _c = (0, react_1.useState)([]), todayAppointments = _c[0], setTodayAppointments = _c[1];
    ...
    return (<main className="flex-1 space-y-6 p-6 max-w-7xl mx-auto">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <card_1.Card className="border-l-4 border-l-orange-500">
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Taxa de Cancelamento</card_1.CardTitle>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <card_1.Card className="lg:col-span-2">
          ...
          <card_1.CardContent className="space-y-4">
            {todayAppointments.length === 0 ? (<div className="text-center py-8 text-muted-foreground">
                ...
                <p>Nenhuma consulta agendada para hoje</p>
              </div>) : (todayAppointments.map(function (appointment) { return (<div key={appointment.id} className="flex items-center justify-between p-4 rounded-lg border bg-card hover:bg-accent/50 transition-colors">
                  ...
                  <div className="flex items-center space-x-2">
                    <badge_1.Badge variant="outline" className={getStatusColor(appointment.status)}>
        ...
        </card_1.Card>        {/* Quick Actions & Analytics */}
