...
import type { SignUp } from "@/lib/auth";
import type { clerkConfig } from "@/lib/auth/clerk-config";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-sky-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">NeonPro</h1>
          <p className="text-sm text-slate-600">Cadastro no Sistema de Gestão de Saúde</p>
          <p className="text-xs text-slate-500 mt-2">Registro seguro em conformidade com a LGPD</p>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-amber-800">Consentimento LGPD</h3>
              <div className="mt-2 text-sm text-amber-700">
                <p>
                  Ao se cadastrar, você está consentindo com o processamento dos seus dados conforme
                  nossa{" "}
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
          <h4 className="text-sm font-medium text-slate-900 mb-2">Proteção dos Seus Dados</h4>
        ...
        <div className="text-center">
          <p className="text-xs text-slate-500 mb-2">Ambiente seguro para profissionais de saúde</p>
