...
function SubscriptionUIDemo() {
    ...
    return (<div className="container mx-auto p-6 space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <subscription_1.SubscriptionStatusCard onUpgrade={handleUpgrade} onManage={handleManage}/>
          </div>

          <div className="space-y-2">
            <h3 className="text-lg font-medium">Variante Compacta</h3>
            <subscription_1.SubscriptionStatusCard variant="compact" onUpgrade={handleUpgrade} onManage={handleManage}/>
          </div>

          <div className="space-y-2 md:col-span-2">
            <h3 className="text-lg font-medium">Variante Detalhada</h3>
            <subscription_1.SubscriptionStatusCard variant="detailed" onUpgrade={handleUpgrade} onManage={handleManage}/>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="space-y-2">
            ...
            <subscription_1.CompactSubscriptionWidget onUpgrade={handleUpgrade} onManage={handleManage}/>
          </div>

          <div className="space-y-2">
            <h3 className="text-lg font-medium">Widget Padrão</h3>
            <subscription_1.SubscriptionDashboardWidget onUpgrade={handleUpgrade} onManage={handleManage}/>
          </div>

          <div className="space-y-2">
            <h3 className="text-lg font-medium">Widget Detalhado</h3>
            <subscription_1.DetailedSubscriptionWidget onUpgrade={handleUpgrade} onManage={handleManage}/>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-4">
            ...
            <subscription_1.FeatureGate feature="basic_reports" requiredPlan="basic" onUpgrade={handleUpgrade}>
              <card_1.Card>
          ...
          <div className="space-y-4">
            ...
            <subscription_1.UsageLimitGate current={85} limit={100} feature="relatórios mensais" onUpgrade={handleUpgrade}>
              <card_1.Card>
                <card_1.CardContent className="p-6">
      ...
      <subscription_1.SubscriptionNotificationProvider autoHide={true} hideAfter={5000} showProgress={true}/>
    </div>);
}
