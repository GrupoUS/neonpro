...
exports.default = OAuthDemoPage;
var enhanced_oauth_demo_1 = require("@/components/auth/enhanced-oauth-demo");
exports.metadata = {
    title: 'Enhanced OAuth Demo - NeonPro',
    description: 'Demonstração das funcionalidades aprimoradas de OAuth Google Integration',
};
function OAuthDemoPage() {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Demonstração completa das funcionalidades aprimoradas de autenticação OAuth,
            incluindo auditoria de segurança, sistema de permissões granular,
            gerenciamento de sessão avançado e conformidade com LGPD.
          </p>
        </div>
        
        <enhanced_oauth_demo_1.default />
