...
function FinancialPage() {
  ...
  var _c = (0, react_1.useState)([]),
    transactions = _c[0],
    setTransactions = _c[1];
  var _d = (0, react_1.useState)([]),
    monthlyData = _d[0],
    setMonthlyData = _d[1];
  var _e = (0, react_1.useState)("this-month"),
    selectedPeriod = _e[0],
    setSelectedPeriod = _e[1];
  ...
  (0, react_1.useEffect)(function () {
    var loadFinancialData = function () {
  ...
  var getPaymentMethodIcon = function (method) {
    switch (method) {
      ...
      case "dinheiro":
        return <lucide_react_1.Receipt className="w-4 h-4" />;
      case "convenio":
        return <lucide_react_1.FileText className="w-4 h-4" />;
      case "transferencia":
        return <lucide_react_1.ArrowUpRight className="w-4 h-4" />;
      default:
        return <lucide_react_1.DollarSign className="w-4 h-4" />;
    }
  };
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <card_1.Card className="lg:col-span-1">
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Breakdown por tipo de serviço</card_1.CardDescription>
          </card_1.CardHeader>
        ...
        <card_1.Card className="lg:col-span-2">
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Receita vs Despesas dos últimos 5 meses</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent>
              ...
              <div className="w-full h-full bg-gradient-to-br from-neon-50 to-green-50 rounded-lg flex items-center justify-center border-2 border-dashed border-neon-200">
                <div className="text-center">
                  ...
                  <div className="mt-4 space-y-2">
                    {monthlyData.map(function (data, index) {
                      return (
        ...
        <card_1.CardHeader>
          <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
            <div>
              ...
              <card_1.CardDescription>Histórico de receitas e despesas</card_1.CardDescription>
            </div>
            ...
            <table_1.Table>
              ...
              <table_1.TableBody>
                {filteredTransactions.map(function (transaction) {
                  return (
                    <table_1.TableRow key={transaction.id} className="hover:bg-muted/50">
                      <table_1.TableCell>
                      ...
                      <table_1.TableCell>
                        ...
                        >
                          {transaction.type === "receita"
                            ? <lucide_react_1.ArrowUpRight className="w-3 h-3 mr-1" />
                            : <lucide_react_1.ArrowDownRight className="w-3 h-3 mr-1" />}
