...
function SignInPage() {
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 to-sky-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="flex justify-center">
          <auth_1.SignIn path="/entrar" routing="path" signUpUrl="/cadastro" redirectUrl={clerk_config_1.clerkConfig.afterSignInUrl} appearance={{
            elements: {
                rootBox: "w-full",
