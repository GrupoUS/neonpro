    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-sky-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-slate-600">Sistema de Gestão de Saúde</p>
          <p className="text-xs text-slate-500 mt-2">Acesso seguro em conformidade com a LGPD</p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Proteção de Dados</h3>
              <div className="mt-2 text-sm text-blue-700">
                <p>
                  Seus dados são protegidos conforme a LGPD. Ao fazer login, você concorda com nossa{" "}
        ...
        <div className="flex justify-center">
          <auth_1.SignIn
            ...
            routing="path"
            signUpUrl="/cadastro"
            redirectUrl={clerk_config_1.clerkConfig.afterSignInUrl}
            appearance={{
              elements: {
                rootBox: "w-full",
