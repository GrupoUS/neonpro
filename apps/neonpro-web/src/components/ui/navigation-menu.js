...
function NavigationMenuTrigger(_a) {
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={(0, utils_1.cn)(navigationMenuTriggerStyle(), "group", className)}
      {...props}
    >
      {children}{" "}
...
function NavigationMenuViewport(_a) {
  var className = _a.className,
    props = __rest(_a, ["className"]);
  return (
    <div className={(0, utils_1.cn)("absolute top-full left-0 isolate z-50 flex justify-center")}>
