...
function ErrorDialog(_a) {
  var error = _a.error,
    ...
    onRetry = _a.onRetry,
    onContactSupport = _a.onContactSupport,
    _b = _a.showTechnicalDetails,
    showTechnicalDetails = _b === void 0 ? false : _b;
      ...
      <dialog_1.DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <card_1.Card>
            <card_1.CardHeader className="pb-3">
              <card_1.CardTitle className="text-sm font-medium flex items-center gap-2">
                <lucide_react_1.CheckCircle className="w-4 h-4 text-green-600" />O que você pode
                fazer
              </card_1.CardTitle>
            </card_1.CardHeader>
            <card_1.CardContent className="pt-0">
          ...
          {showTechnicalDetails && error.technicalDetails && (
            <collapsible_1.Collapsible open={showContext} onOpenChange={setShowContext}>
              <collapsible_1.CollapsibleTrigger asChild>
                <button_1.Button
                  variant="ghost"
          ...
          {/* Help Link */}
          {error.helpUrl && (
            <card_1.Card className="border-green-200 bg-green-50/50">
              <card_1.CardContent className="pt-4">
