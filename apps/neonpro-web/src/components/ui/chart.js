                ...
                colorConfig
                  .map((_a) => {
                    ...
                    var key = _a[0],
                      itemConfig = _a[1];
                    var color =
                      ((_b = itemConfig.theme) === null || _b === void 0 ? void 0 : _b[theme]) ||
                      itemConfig.color;
          ...
          return (
            ...
            >
              ...
              item.name
                ...
                : <>
                    {(itemConfig === null || itemConfig === void 0 ? void 0 : itemConfig.icon)
                      ? <itemConfig.icon />
                      : !hideIndicator && (
                          <div
                            className={(0, utils_1.cn)(
    ...
    >
      {payload.map((item) => {
        ...
        return (
          ...
          >
            {(itemConfig === null || itemConfig === void 0 ? void 0 : itemConfig.icon) && !hideIcon
              ? <itemConfig.icon />
              : <div
