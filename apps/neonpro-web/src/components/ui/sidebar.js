...
var SidebarGroup = React.forwardRef(function (_a, ref) {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="group"
      className={(0, utils_1.cn)("relative flex w-full min-w-0 flex-col p-2", className)}
      {...props}
    />
  );
});
...
var SidebarMenuSkeleton = React.forwardRef(function (_a, ref) {
  ...
  return (
    <div
      ...
      className={(0, utils_1.cn)("rounded-md h-8 flex gap-2 px-2 items-center", className)}
      {...props}
    >
      {showIcon && (
        <skeleton_1.Skeleton className="size-4 rounded-md" data-sidebar="menu-skeleton-icon" />
      )}
      <skeleton_1.Skeleton
