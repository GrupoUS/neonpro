...
var PaymentForm = function (_a) {
  ...
  var _e = (0, react_1.useState)("idle"),
    paymentStatus = _e[0],
    setPaymentStatus = _e[1];
  var _f = (0, react_1.useState)({}),
    errors = _f[0],
    setErrors = _f[1];
  var _g = (0, react_1.useState)(false),
    cardComplete = _g[0],
    setCardComplete = _g[1];
  var _h = (0, react_1.useState)(null),
    cardError = _h[0],
    setCardError = _h[1];
  // Calculate installment amount
  var installmentAmount = formData.installments
    ? Math.ceil(amount / formData.installments)
    : amount;
  var totalWithInterest =
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch("/api/payments/card/create", {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
                },
                body: JSON.stringify(
                  __assign(__assign({}, formData), { installments: formData.installments || 1 }),
                ),
              }),
            ];
          case 2:
          ...
          case 5:
            (_a = _d.sent()),
              ...
              (payment_intent_id = _a.payment_intent_id);
            ...
            if (paymentIntent.status === "succeeded") {
              ...
              onSuccess === null || onSuccess === void 0
                ...
                : onSuccess({
                    ...
                    receipt_url:
                      (_c = paymentIntent.charges.data[0]) === null || _c === void 0
                        ? void 0
                        : _c.receipt_url,
                  });
            } else {
              ...
              >
                ...
                <select_1.SelectContent>
                  {Array.from({ length: 12 }, function (_, i) {
                    ...
                    return (
                      <select_1.SelectItem key={installment} value={installment.toString()}>
...
var CardPaymentForm = function (props) {
  ...
  return (
    <react_stripe_js_1.Elements stripe={stripePromise} options={options}>
      <PaymentForm {...props} />
