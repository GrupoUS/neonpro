...
function PixPaymentForm(_a) {
  var amount = _a.amount,
    ...
    onPaymentError = _a.onPaymentError,
                ...
                case 2:
                  ...
                  if (data.status !== pix_integration_1.PixPaymentStatus.PENDING) {
                    ...
                    if (data.status === pix_integration_1.PixPaymentStatus.PAID) {
                      onPaymentSuccess === null || onPaymentSuccess === void 0
                        ? void 0
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 4:
            ...
            onPaymentError === null || onPaymentError === void 0
              ? void 0
    ...
    return (
      <card_1.Card className={className}>
        <card_1.CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <card_1.CardDescription>{formatCurrency(payment.amount)}</card_1.CardDescription>
            </div>
        ...
        <card_1.CardContent className="space-y-6">
          ...
          {status === pix_integration_1.PixPaymentStatus.PAID && (
            <div className="text-center space-y-4">
          ...
          {status === pix_integration_1.PixPaymentStatus.EXPIRED && (
            <div className="text-center space-y-4">
