...
import type {
  ...
  PixPaymentResponse,
  PixPaymentStatus,
} from "@/lib/payments/gateways/pix-integration";
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>{formatCurrency(payment.amount)}</CardDescription>
            </div>
              ...
              <div className="text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant="outline" size="icon" onClick={copyQRCode}>
  ...
  return (
    <Card className={className}>
      <CardHeader>
        ...
        <CardDescription>Pague instantaneamente com PIX - {formatCurrency(amount)}</CardDescription>
      </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, payerDocument: e.target.value }))
                }
