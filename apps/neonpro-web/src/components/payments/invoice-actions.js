...
function InvoiceActions(_a) {
  ...
  var _c = (0, react_1.useState)(false),
    showPaymentDialog = _c[0],
    setShowPaymentDialog = _c[1];
  var _d = (0, react_1.useState)(false),
    showPdfPreview = _d[0],
    setShowPdfPreview = _d[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch("/api/pdf/invoice?id=".concat(invoice.id), {
                method: "GET",
              }),
            ];
          case 2:
        ...
        <dropdown_menu_1.DropdownMenuContent align="end">
          ...
          <dropdown_menu_1.DropdownMenuItem onClick={handleSendEmail} disabled={isLoading.email}>
            ...
            {invoice.email_sent_at && (
              <lucide_react_1.CheckCircle className="ml-1 h-3 w-3 text-green-600" />
            )}
          </dropdown_menu_1.DropdownMenuItem>
          ...
          {pdfData && (
            <div className="flex-1 min-h-[600px]">
              <iframe
                ...
                title={"Fatura ".concat(invoice.invoice_number)}
              />
            </div>
          )}
        </dialog_1.DialogContent>
