                ...
                {Object.entries(statistics.nfe_statistics.by_status).map(function (_a) {
                  ...
                  return (
                    <div key={status} className="flex items-center space-x-3 p-3 border rounded-lg">
                      ...
                      <div>
                        <badge_1.Badge className={getStatusColor(status)}>{status}</badge_1.Badge>
        ...
        <tabs_1.TabsContent value="taxes" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>Breakdown dos impostos calculados</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
                    ...
                    return (
                      <div key={tax} className="p-4 border rounded-lg">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {(
                            (value / Math.max(statistics.tax_summary.total_taxes, 1)) *
                            100
                          ).toFixed(1)}
                          % do total
                        </div>
        ...
        <tabs_1.TabsContent value="monthly" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>NFes emitidas e valores por mês</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
