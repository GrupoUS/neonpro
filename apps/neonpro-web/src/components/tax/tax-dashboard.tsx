      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Período: {new Date(statistics.period.start).toLocaleDateString()} -{" "}
            {new Date(statistics.period.end).toLocaleDateString()}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(
                statistics.tax_summary.total_revenue || statistics.nfe_statistics.total_value,
              )}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Taxa efetiva de impostos</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {(
                ((statistics.nfe_statistics.by_status.authorized || 0) /
                  Math.max(statistics.nfe_statistics.total_documents, 1)) *
                100
              ).toFixed(1)}
              % do total
            </p>
        ...
        <TabsContent value="nfe" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Distribuição das notas fiscais por status</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="taxes" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Breakdown dos impostos calculados</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  .map(([tax, value]) => (
                    <div key={tax} className="p-4 border rounded-lg">
                      ...
                      <div className="text-xs text-muted-foreground">
                        {((value / Math.max(statistics.tax_summary.total_taxes, 1)) * 100).toFixed(
                          1,
                        )}
                        % do total
                      </div>
        ...
        <TabsContent value="monthly" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>NFes emitidas e valores por mês</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {statistics.nfe_statistics.by_month.map((month) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="text-lg font-semibold">{formatCurrency(month.value)}</p>
