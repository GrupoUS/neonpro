...
function TaxCalculator(_a) {
    ...
    var _c = (0, react_1.useState)(null), calculation = _c[0], setCalculation = _c[1];
    ...
    var calculateTaxes = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch('/api/tax/calculate', {
                            method: 'POST',
                            headers: {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input_1.Input id="valor_base" type="number" step="0.01" min="0" placeholder="0,00" value={formData.valor_base} onChange={function (e) { return handleInputChange('valor_base', e.target.value); }} required/>
              </div>

              <div className="space-y-2">
                <label_1.Label htmlFor="tipo_servico">Tipo de Serviço</label_1.Label>
                <select_1.Select onValueChange={function (value) { return handleInputChange('tipo_servico', value); }}>
                  <select_1.SelectTrigger>
                    <select_1.SelectValue placeholder="Selecione o serviço"/>
                  </select_1.SelectTrigger>
                  <select_1.SelectContent>
                    {serviceTypes.map(function (service) { return (<select_1.SelectItem key={service} value={service}>
                        {service}
                      </select_1.SelectItem>); })}
                  </select_1.SelectContent>
                </select_1.Select>
              ...
              <div className="space-y-2">
                ...
                <input_1.Input id="codigo_servico" placeholder="Ex: 04.01" value={formData.codigo_servico} onChange={function (e) { return handleInputChange('codigo_servico', e.target.value); }}/>
              </div>

              <div className="space-y-2">
                <label_1.Label htmlFor="regime_tributario">Regime Tributário (opcional)</label_1.Label>
                <select_1.Select onValueChange={function (value) { return handleInputChange('regime_tributario', value); }}>
                  <select_1.SelectTrigger>
                    <select_1.SelectValue placeholder="Usar configuração da clínica"/>
                  </select_1.SelectTrigger>
                  <select_1.SelectContent>
                    {taxRegimes.map(function (regime) { return (<select_1.SelectItem key={regime.value} value={regime.value}>
                        {regime.label}
                      </select_1.SelectItem>); })}
                  </select_1.SelectContent>
                </select_1.Select>
            ...
            {error && (<div className="flex items-center space-x-2 text-red-600 bg-red-50 p-3 rounded-md">
          ...
          <card_1.CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-2xl font-bold">{(0, utils_1.formatCurrency)(calculation.valor_base)}</p>
              </div>
              ...
              <div className="p-4 bg-red-50 rounded-lg">
                ...
                <p className="text-2xl font-bold">{(0, utils_1.formatCurrency)(calculation.total_taxes)}</p>
              ...
              <div className="p-4 bg-green-50 rounded-lg">
                ...
                <p className="text-2xl font-bold">{(0, utils_1.formatCurrency)(calculation.valor_liquido)}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                return (<div key={tax} className="p-3 border rounded-lg">
                      ...
                      <p className="text-lg font-semibold">{(0, utils_1.formatCurrency)(value)}</p>
                    </div>);
            })}
              </div>
            </div>
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <ul className="text-sm text-blue-700 space-y-1">
                    ...
                    {calculation.service_code && (<li>• Código do serviço: {calculation.service_code}</li>)}
                    <li>• Carga tributária efetiva: {(0, utils_1.formatPercentage)(calculation.effective_rate)}</li>
                  </ul>
                </div>
              </div>
            </div>
