            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input_1.Input
                  ...
                  onChange={function (e) {
                    return handleInputChange("valor_base", e.target.value);
                  }}
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select_1.Select
                  onValueChange={function (value) {
                    return handleInputChange("tipo_servico", value);
                  }}
                >
              ...
              <div className="space-y-2">
                ...
                <input_1.Input
                  ...
                  onChange={function (e) {
                    return handleInputChange("codigo_servico", e.target.value);
                  }}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select_1.Select
                  onValueChange={function (value) {
                    return handleInputChange("regime_tributario", value);
                  }}
                >
                  <select_1.SelectTrigger>
                  ...
                  <select_1.SelectContent>
                    {taxRegimes.map(function (regime) {
                      return (
