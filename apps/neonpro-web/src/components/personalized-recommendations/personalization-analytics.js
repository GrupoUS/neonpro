...
function MetricCard(_a) {
    var title = _a.title, value = _a.value, change = _a.change, changeType = _a.changeType, icon = _a.icon;
    var changeColor = changeType === 'positive' ? 'text-green-600' :
    ...
    return (<card_1.Card>
      ...
      <card_1.CardContent>
        ...
        <p className={"text-xs ".concat(changeColor)}>
...
function PersonalizationAnalytics() {
    var _a = (0, react_1.useState)('6m'), timeRange = _a[0], setTimeRange = _a[1];
    var _b = (0, react_1.useState)('all'), selectedSegment = _b[0], setSelectedSegment = _b[1];
    return (<div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <MetricCard title="Taxa de Precisão" value="95%" change="+2.3%" changeType="positive" icon={<lucide_react_1.Target className="h-4 w-4 text-muted-foreground"/>}/>
        <MetricCard title="Taxa de Engajamento" value="94%" change="+3.1%" changeType="positive" icon={<lucide_react_1.Zap className="h-4 w-4 text-muted-foreground"/>}/>
        <MetricCard title="Conversões" value="28" change="+12.5%" changeType="positive" icon={<lucide_react_1.TrendingUp className="h-4 w-4 text-muted-foreground"/>}/>
        <MetricCard title="Receita Gerada" value="R$ 229k" change="+18.7%" changeType="positive" icon={<lucide_react_1.DollarSign className="h-4 w-4 text-muted-foreground"/>}/>
      </div>
      ...
      <tabs_1.Tabs defaultValue="performance" className="w-full">
        ...
        <tabs_1.TabsContent value="performance" className="space-y-4">
            ...
            <card_1.CardContent>
              <recharts_1.ResponsiveContainer width="100%" height={300}>
                <recharts_1.LineChart data={performanceData}>
                  ...
                  <recharts_1.YAxis />
                  <recharts_1.Tooltip />
                  <recharts_1.Line type="monotone" dataKey="accuracy" stroke="#8884d8" strokeWidth={2} name="Precisão (%)"/>
                  <recharts_1.Line type="monotone" dataKey="engagement" stroke="#82ca9d" strokeWidth={2} name="Engajamento (%)"/>
                  <recharts_1.Line type="monotone" dataKey="conversions" stroke="#ffc658" strokeWidth={2} name="Conversões"/>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            return (<div key={segment.segment} className="space-y-2">
            ...
            return (<div key={segment.segment} className="flex justify-between items-center">
        ...
        <tabs_1.TabsContent value="segments" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {segmentPerformance.map(function (segment) { return (<card_1.Card key={segment.segment}>
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <recharts_1.ResponsiveContainer width="100%" height={250}>
                  <recharts_1.PieChart>
                    <recharts_1.Pie data={treatmentRecommendations} cx="50%" cy="50%" outerRadius={80} fill="#8884d8" dataKey="value" label={function (_a) {
        var name = _a.name, value = _a.value;
        return "".concat(name, ": ").concat(value, "%");
    }}>
                      {treatmentRecommendations.map(function (entry, index) { return (<recharts_1.Cell key={"cell-".concat(index)} fill={entry.color}/>); })}
                    </recharts_1.Pie>
                    <recharts_1.Tooltip />
                  </recharts_1.PieChart>
                </recharts_1.ResponsiveContainer>
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-4">
                  {treatmentRecommendations.map(function (treatment, index) { return (<div key={treatment.name} className="flex items-center justify-between">
