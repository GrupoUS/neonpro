...
function PersonalizationProfilesManagement() {
  var _a = (0, react_1.useState)(mockProfiles),
    profiles = _a[0],
    setProfiles = _a[1];
  var _b = (0, react_1.useState)(false),
    isCreateDialogOpen = _b[0],
    setIsCreateDialogOpen = _b[1];
  var _c = (0, react_1.useState)(null),
    editingProfile = _c[0],
    setEditingProfile = _c[1];
                  ...
                  <div className="flex items-center gap-2">
                    <switch_1.Switch
                      ...
                      onCheckedChange={function () {
                        return handleToggleProfile(profile.id);
                      }}
                    />
                    ...
                    <button_1.Button
                      ...
                      size="sm"
                      onClick={function () {
                        return handleDeleteProfile(profile.id);
                      }}
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                  <div>
                    ...
                    <div className="space-y-1 mt-1">
                      {profile.preferences.treatmentTypes.map(function (treatment, index) {
                        return (
