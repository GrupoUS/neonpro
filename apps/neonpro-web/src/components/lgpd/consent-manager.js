...
function ConsentManager(_a) {
  var _b = _a.patientCpf,
    ...
    _c = _a.patientName,
    patientName = _c === void 0 ? "" : _c,
    _d = _a.existingConsents,
    existingConsents = _d === void 0 ? [] : _d,
    onSubmit = _a.onSubmit,
    onRevoke = _a.onRevoke,
    _e = _a.isLoading,
  ...
  var _g = (0, react_1.useState)(null),
    selectedConsent = _g[0],
    setSelectedConsent = _g[1];
                      ...
                      <form_1.FormItem>
                        ...
                        <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <select_1.SelectContent>
                            <select_1.SelectItem value="data_processing">
                              Tratamento de Dados
                            </select_1.SelectItem>
                            <select_1.SelectItem value="marketing">
                              Comunicações de Marketing
                            </select_1.SelectItem>
                            <select_1.SelectItem value="research">
                              Pesquisa e Desenvolvimento
                            </select_1.SelectItem>
                            <select_1.SelectItem value="procedure">
                              Procedimento Médico
                            </select_1.SelectItem>
                            <select_1.SelectItem value="photography">
                              Uso de Imagem
                            </select_1.SelectItem>
                            <select_1.SelectItem value="testimonial">
                    ...
                    return (
                      <form_1.FormItem>
                        ...
                        <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <select_1.SelectContent>
                            <select_1.SelectItem value="consent">
                              Consentimento do Titular
                            </select_1.SelectItem>
                            <select_1.SelectItem value="legitimate_interest">
                              Interesse Legítimo
                            </select_1.SelectItem>
                            <select_1.SelectItem value="vital_interest">
                              Interesse Vital
                            </select_1.SelectItem>
                            <select_1.SelectItem value="public_task">
                              Exercício Regular de Direitos
                            </select_1.SelectItem>
                            <select_1.SelectItem value="legal_obligation">
                              Obrigação Legal
                            </select_1.SelectItem>
                          </select_1.SelectContent>
                        </select_1.Select>
