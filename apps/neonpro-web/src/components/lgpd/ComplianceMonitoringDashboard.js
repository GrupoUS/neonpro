...
function ComplianceMonitoringDashboard(_a) {
  ...
  var _b = (0, use_compliance_monitoring_1.useComplianceMonitoring)(),
    ...
    isMonitoring = _b.isMonitoring,
    error = _b.error,
    startMonitoring = _b.startMonitoring,
    stopMonitoring = _b.stopMonitoring,
    refresh = _b.refresh,
    reportViolation = _b.reportViolation,
    resolveViolation = _b.resolveViolation,
    acknowledgeAlert = _b.acknowledgeAlert,
    triggerAssessment = _b.triggerAssessment;
  var _c = (0, use_compliance_monitoring_1.useComplianceMetrics)(),
    metrics = _c.metrics,
    getComplianceLevelColor = _c.getComplianceLevelColor,
    getComplianceLevelText = _c.getComplianceLevelText;
  var _d = (0, use_compliance_monitoring_1.useComplianceViolations)(),
    violations = _d.violations,
    getViolationsByType = _d.getViolationsByType,
    getCriticalViolations = _d.getCriticalViolations,
    getViolationTypeText = _d.getViolationTypeText,
    getSeverityColor = _d.getSeverityColor;
  var _e = (0, use_compliance_monitoring_1.useComplianceAlerts)(),
    alerts = _e.alerts,
    getUnacknowledgedAlerts = _e.getUnacknowledgedAlerts,
    getCriticalAlerts = _e.getCriticalAlerts,
    getAlertSeverityColor = _e.getAlertSeverityColor;
  var _f = (0, use_compliance_monitoring_1.useComplianceRecommendations)(),
    recommendations = _f.recommendations,
    getCriticalRecommendations = _f.getCriticalRecommendations,
    getPriorityColor = _f.getPriorityColor;
  // Dialog states
  var _g = (0, react_1.useState)(false),
    violationDialogOpen = _g[0],
    setViolationDialogOpen = _g[1];
  var _h = (0, react_1.useState)(false),
    resolveDialogOpen = _h[0],
    setResolveDialogOpen = _h[1];
  var _j = (0, react_1.useState)(null),
    selectedViolation = _j[0],
    setSelectedViolation = _j[1];
  // Form states
    ...
    <div className={"space-y-6 ".concat(className)}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          {isMonitoring
            ? <button_1.Button variant="destructive" size="sm" onClick={stopMonitoring}>
                <lucide_react_1.Square className="h-4 w-4 mr-2" />
                Parar Monitoramento
              </button_1.Button>
            : <button_1.Button variant="default" size="sm" onClick={startMonitoring}>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Score:{" "}
              {metrics === null || metrics === void 0 ? void 0 : metrics.overallScore.toFixed(1)}%
            </p>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            {criticalViolations.length > 0 && (
              <badge_1.Badge variant="destructive" className="mt-2">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Pontuação detalhada por categoria</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
                {metrics && (
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Últimas violações e alertas</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
                <div className="space-y-3">
                ...
                <div className="grid gap-4 py-4">
                  <div className="grid gap-2">
                    ...
                    >
                      ...
                      <select_1.SelectContent>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ViolationType.CONSENT_VIOLATION}
                        >
                          Violação de Consentimento
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ViolationType.DATA_ACCESS_VIOLATION}
                        >
                          Violação de Acesso a Dados
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ViolationType.RETENTION_VIOLATION}
                        >
                          Violação de Retenção
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ViolationType.AUDIT_VIOLATION}
                        >
                          Violação de Auditoria
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ViolationType.DISCLOSURE_VIOLATION}
                        >
                          Violação de Divulgação
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ViolationType.SECURITY_VIOLATION}
                        >
                          Violação de Segurança
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ViolationType.RESPONSE_TIME_VIOLATION}
                        >
                          Violação de Prazo
                        </select_1.SelectItem>
                      </select_1.SelectContent>
                  ...
                  <div className="grid gap-2">
                    ...
                    >
                      ...
                      <select_1.SelectContent>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ComplianceCategory.CONSENT}
                        >
                          Consentimento
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ComplianceCategory.DATA_ACCESS}
                        >
                          Acesso a Dados
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ComplianceCategory.DATA_RETENTION}
                        >
                          Retenção de Dados
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ComplianceCategory.AUDIT_TRAIL}
                        >
                          Trilha de Auditoria
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ComplianceCategory.SECURITY}
                        >
                          Segurança
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ComplianceCategory.DISCLOSURE}
                        >
                          Divulgação
                        </select_1.SelectItem>
                        <select_1.SelectItem
                          value={compliance_monitoring_1.ComplianceCategory.RESPONSE_TIME}
                        >
                          Tempo de Resposta
                        </select_1.SelectItem>
                      </select_1.SelectContent>
