...
function LGPDComplianceDashboard(_a) {
  ...
  var _f = (0, react_1.useState)(null),
    complianceOverview = _f[0],
    setComplianceOverview = _f[1];
  var _g = (0, react_1.useState)(null),
    consentAnalytics = _g[0],
    setConsentAnalytics = _g[1];
  var _h = (0, react_1.useState)(null),
    auditAnalytics = _h[0],
    setAuditAnalytics = _h[1];
  var _j = (0, react_1.useState)(null),
    retentionAnalytics = _j[0],
    setRetentionAnalytics = _j[1];
  var _k = (0, react_1.useState)([]),
    auditTrail = _k[0],
    setAuditTrail = _k[1];
  var _l = (0, react_1.useState)([]),
    dataSubjectRequests = _l[0],
    setDataSubjectRequests = _l[1];
  // Filter states
  var _m = (0, react_1.useState)({ start: "", end: "" }),
    dateRange = _m[0],
    setDateRange = _m[1];
  var _o = (0, react_1.useState)({
    ...
    auditFilters = _o[0],
    setAuditFilters = _o[1];
  // Dialog states
  var _p = (0, react_1.useState)(false),
    showConsentDialog = _p[0],
    setShowConsentDialog = _p[1];
  var _q = (0, react_1.useState)(false),
    showRequestDialog = _q[0],
    setShowRequestDialog = _q[1];
  var _r = (0, react_1.useState)(null),
    selectedRequest = _r[0],
    setSelectedRequest = _r[1];
  /**
   * Load dashboard data
   */
  ...
  var getEventTypeIcon = function (eventType) {
    ...
    var iconMap =
      ((_a = {}),
      (_a[audit_trail_manager_1.LGPDAuditEventType.DATA_ACCESS] = (
        <lucide_react_1.Eye className="h-4 w-4" />
      )),
      (_a[audit_trail_manager_1.LGPDAuditEventType.DATA_MODIFICATION] = (
        <lucide_react_1.Settings className="h-4 w-4" />
      )),
      (_a[audit_trail_manager_1.LGPDAuditEventType.DATA_DELETION] = (
        <lucide_react_1.Trash2 className="h-4 w-4" />
      )),
      (_a[audit_trail_manager_1.LGPDAuditEventType.CONSENT_COLLECTED] = (
        <lucide_react_1.UserCheck className="h-4 w-4" />
      )),
      (_a[audit_trail_manager_1.LGPDAuditEventType.CONSENT_WITHDRAWN] = (
        <lucide_react_1.AlertCircle className="h-4 w-4" />
      )),
      (_a[audit_trail_manager_1.LGPDAuditEventType.DATA_BREACH] = (
        <lucide_react_1.AlertTriangle className="h-4 w-4" />
      )),
      (_a[audit_trail_manager_1.LGPDAuditEventType.DATA_SUBJECT_REQUEST] = (
            ...
            <card_1.CardContent>
              <div
                className={"text-2xl font-bold ".concat(
                  getComplianceColor(complianceOverview.complianceScore),
                )}
              >
