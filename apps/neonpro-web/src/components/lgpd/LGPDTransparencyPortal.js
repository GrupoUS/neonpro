...
function LGPDTransparencyPortal(_a) {
    var _this = this;
    var userId = _a.userId, clinicId = _a.clinicId;
    var _b = (0, react_1.useState)([]), consents = _b[0], setConsents = _b[1];
    var _c = (0, react_1.useState)([]), requests = _c[0], setRequests = _c[1];
    var _d = (0, react_1.useState)([]), reports = _d[0], setReports = _d[1];
    ...
    var loadPortalData = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), consentsData = _a[0], requestsData = _a[1], reportsData = _a[2], configData = _a[3];
    ...
    var fetchUserConsents = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // Implementar chamada à API
            return [2 /*return*/, []];
        });
    }); };
    var fetchUserRequests = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // Implementar chamada à API
            return [2 /*return*/, []];
        });
    }); };
    var fetchComplianceReports = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // Implementar chamada à API
            return [2 /*return*/, []];
        });
    }); };
    var fetchLGPDConfig = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // Implementar chamada à API
            return [2 /*return*/, {
                    clinicId: clinicId,
    ...
    var handleConsentAction = function (consentId, action) { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleDataRequest = function (requestType) { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var downloadData = function (format) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
    ...
    var getRequestStatusBadge = function (status) {
        ...
        var variants = (_a = {},
            ...
            _a);
        return (<badge_1.Badge variant={variants[status] || 'secondary'}>
        {status}
      </badge_1.Badge>);
    };
    var calculateComplianceScore = function () {
        var activeConsents = consents.filter(function (c) { return c.status === lgpd_1.ConsentStatus.GRANTED; }).length;
        var totalConsents = consents.length;
        var completedRequests = requests.filter(function (r) { return r.status === lgpd_1.RequestStatus.COMPLETED; }).length;
    ...
    return (<div className="container mx-auto p-6 space-y-6">
        ...
        <card_1.CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">{consents.filter(function (c) { return c.status === lgpd_1.ConsentStatus.GRANTED; }).length}</div>
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <tabs_1.TabsContent value="overview" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-3">
                  {consents.slice(0, 3).map(function (consent) { return (<div key={consent.id} className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                ...
                {consents.length > 3 && (<button_1.Button variant="link" className="mt-2 p-0 h-auto" onClick={function () { return setActiveTab('consents'); }}>
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-3">
                  {requests.slice(0, 3).map(function (request) { return (<div key={request.id} className="flex items-center justify-between">
                      <div>
                ...
                {requests.length > 3 && (<button_1.Button variant="link" className="mt-2 p-0 h-auto" onClick={function () { return setActiveTab('requests'); }}>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <button_1.Button variant="outline" className="h-20 flex-col space-y-2" onClick={function () { return handleDataRequest(lgpd_1.DataSubjectRight.ACCESS); }}>
                  <lucide_react_1.Eye className="h-6 w-6"/>
                  <span className="text-xs">Acessar Dados</span>
                </button_1.Button>
                <button_1.Button variant="outline" className="h-20 flex-col space-y-2" onClick={function () { return downloadData('json'); }}>
                  <lucide_react_1.Download className="h-6 w-6"/>
                  <span className="text-xs">Baixar Dados</span>
                </button_1.Button>
                <button_1.Button variant="outline" className="h-20 flex-col space-y-2" onClick={function () { return handleDataRequest(lgpd_1.DataSubjectRight.RECTIFICATION); }}>
                  <lucide_react_1.Edit className="h-6 w-6"/>
                  <span className="text-xs">Corrigir Dados</span>
                </button_1.Button>
                <button_1.Button variant="outline" className="h-20 flex-col space-y-2" onClick={function () { return handleDataRequest(lgpd_1.DataSubjectRight.ERASURE); }}>
        ...
        </tabs_1.TabsContent>        {/* Consents Tab */}
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {consents.map(function (consent) { return (<div key={consent.id} className="border rounded-lg p-4">
                    ...
                    <div className="flex space-x-2">
                      {consent.status === lgpd_1.ConsentStatus.GRANTED ? (<button_1.Button variant="destructive" size="sm" onClick={function () { return handleConsentAction(consent.id, 'withdraw'); }}>
                          <lucide_react_1.XCircle className="h-4 w-4 mr-1"/>
                          Retirar Consentimento
                        </button_1.Button>) : (<button_1.Button variant="default" size="sm" onClick={function () { return handleConsentAction(consent.id, 'grant'); }}>
                ...
                {consents.length === 0 && (<div className="text-center py-8 text-gray-500">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <card_1.Card>
                  ...
                  <card_1.CardContent>
                    ...
                    <button_1.Button onClick={function () { return handleDataRequest(lgpd_1.DataSubjectRight.ACCESS); }} className="w-full">
                      Solicitar Acesso
                    </button_1.Button>
                  </card_1.CardContent>
                </card_1.Card>
                ...
                <card_1.Card>
                  ...
                  <card_1.CardContent>
                    ...
                    <button_1.Button onClick={function () { return handleDataRequest(lgpd_1.DataSubjectRight.PORTABILITY); }} className="w-full">
                ...
                <card_1.Card>
                  ...
                  <card_1.CardContent>
                    ...
                    <button_1.Button onClick={function () { return handleDataRequest(lgpd_1.DataSubjectRight.RECTIFICATION); }} className="w-full">
                      Solicitar Correção
                    </button_1.Button>
                  </card_1.CardContent>
                </card_1.Card>
                ...
                <card_1.Card>
                  ...
                  <card_1.CardContent>
                    ...
                    <button_1.Button onClick={function () { return handleDataRequest(lgpd_1.DataSubjectRight.ERASURE); }} variant="destructive" className="w-full">
                      Solicitar Exclusão
                    </button_1.Button>
                  </card_1.CardContent>
                </card_1.Card>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {requests.map(function (request) { return (<div key={request.id} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                      ...
                      {request.response && (<div className="mt-3 p-3 bg-gray-50 rounded">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                ...
                <div className="flex space-x-2">
                  <button_1.Button onClick={function () { return downloadData('json'); }}>
                    <lucide_react_1.Download className="h-4 w-4 mr-1"/>
                    JSON
                  </button_1.Button>
                  <button_1.Button onClick={function () { return downloadData('csv'); }} variant="outline">
                    <lucide_react_1.Download className="h-4 w-4 mr-1"/>
                    CSV
                  </button_1.Button>
                  <button_1.Button onClick={function () { return downloadData('pdf'); }} variant="outline">
                    <lucide_react_1.Download className="h-4 w-4 mr-1"/>
                    PDF
                  </button_1.Button>
                </div>
        ...
        <tabs_1.TabsContent value="reports" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {reports.map(function (report) { return (<div key={report.id} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
      ...
      {(config === null || config === void 0 ? void 0 : config.dpoContact) && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center space-x-2">
