...
function SubscriptionManagement() {
    var _this = this;
    var _a = (0, use_subscription_1.useSubscription)(), subscription = _a.subscription, refreshSubscription = _a.refreshSubscription;
    var _b = (0, use_subscription_status_1.useSubscriptionStatus)(), hasAccess = _b.hasAccess, isActive = _b.isActive, isTrialing = _b.isTrialing, isPastDue = _b.isPastDue, inGracePeriod = _b.inGracePeriod, currentPeriodEnd = _b.currentPeriodEnd, cancelAtPeriodEnd = _b.cancelAtPeriodEnd, status = _b.status;
    var _c = (0, react_1.useState)(false), isLoading = _c[0], setIsLoading = _c[1];
    var handleSubscribe = function (priceId) { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("/api/stripe/create-checkout-session", {
                            ...
                            body: JSON.stringify({
                                priceId: priceId,
                                successUrl: "".concat(window.location.origin, "/dashboard/subscription?success=true"),
                                cancelUrl: "".concat(window.location.origin, "/dashboard/subscription?canceled=true"),
                            }),
                        })];
                case 2:
                    response = _a.sent();
    ...
    var handleManageBilling = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, 5, 6]);
                    return [4 /*yield*/, fetch("/api/stripe/create-portal-session", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                            },
    ...
    var currentPlan = plans.find(function (plan) { return plan.priceId === subscription.priceId; });
    return (<div className="space-y-6">
      {/* Current Subscription Status */}
      <div className="grid gap-6 md:grid-cols-2">
        <status_indicator_1.SubscriptionStatusIndicator showFullCard className="h-fit"/>

        {hasAccess && (<card_1.Card>
            <card_1.CardHeader>
            ...
            <card_1.CardContent className="space-y-4">
              {currentPlan ? (<>
                  <div className="flex items-center justify-between">
                    ...
                    {currentPlan.popular && (<badge_1.Badge variant="default">Popular</badge_1.Badge>)}
                  </div>

                  {currentPeriodEnd && (<div className="flex items-center gap-2 text-sm">
              ...
              <button_1.Button onClick={handleManageBilling} disabled={isLoading} variant="outline" className="w-full">
                Manage Billing
              </button_1.Button>
            </card_1.CardContent>
          </card_1.Card>)}
      ...
      {inGracePeriod && (<alert_1.Alert variant="destructive">
          ...
          <alert_1.AlertDescription>
            ...
            <button_1.Button onClick={handleManageBilling} size="sm" variant="outline" className="ml-2">
              Update Payment
            </button_1.Button>
          </alert_1.AlertDescription>
        </alert_1.Alert>)}
      ...
      <div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {plans.map(function (plan) {
            ...
            return (<card_1.Card key={plan.id} className={"relative ".concat(plan.popular ? "border-primary" : "")}>
                ...
                <card_1.CardContent className="space-y-4">
                  <ul className="space-y-2">
                    {plan.features.map(function (feature, index) { return (<li key={index} className="flex items-center gap-2 text-sm">
                  ...
                  <button_1.Button onClick={function () { return handleSubscribe(plan.priceId); }} disabled={isLoading || isCurrentPlan || !plan.priceId} className="w-full" variant={plan.popular ? "default" : "outline"}>
                    {isCurrentPlan
                    ? "Current Plan"
                    : hasAccess
                        ? "Switch Plan"
