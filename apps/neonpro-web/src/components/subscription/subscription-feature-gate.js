...
function FeatureGate(_a) {
  var children = _a.children,
    feature = _a.feature,
    _b = _a.requiredPlan,
    requiredPlan = _b === void 0 ? "basic" : _b,
    _c = _a.requiredStatus,
    requiredStatus = _c === void 0 ? "active_or_trial" : _c,
    className = _a.className,
    fallback = _a.fallback,
    _d = _a.showUpgrade,
    showUpgrade = _d === void 0 ? true : _d,
  ...
  if (isLoading) {
    return (
      <div className={(0, utils_1.cn)("animate-pulse", className)}>
  ...
  var getBlockReason = () => {
    ...
    if (!hasValidPlan) {
      return {
        ...
        description: "Esta funcionalidade est\u00E1 dispon\u00EDvel no plano ".concat(
  ...
  return (
    <card_1.Card className={(0, utils_1.cn)("border-2 border-dashed border-gray-300", className)}>
...
function UsageLimitGate(_a) {
  ...
  return (
    <card_1.Card className={(0, utils_1.cn)("border-2 border-dashed border-orange-300", className)}>
      <card_1.CardHeader className="text-center">
