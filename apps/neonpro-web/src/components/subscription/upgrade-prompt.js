...
var upgradeReasons = {
    expired: {
        ...
        description: "Your subscription has expired. Renew now to continue accessing all premium features.",
        urgency: "critical",
    ...
    cancelled: {
        ...
        description: "Your subscription was cancelled. Reactivate to restore access to premium features.",
        urgency: "high",
        icon: lucide_react_1.AlertTriangle,
        badge: "Reactivate",
        features: [
    ...
    trial_ended: {
        ...
        description: "Your free trial has ended. Upgrade now to continue using NeonPro without limitations.",
        urgency: "high",
    ...
    feature_limit: {
        ...
        description: "This feature requires a higher subscription tier. Upgrade to unlock advanced capabilities.",
        urgency: "medium",
    ...
    usage_limit: {
        ...
        description: "You've reached your plan's usage limit. Upgrade to continue without restrictions.",
        urgency: "medium",
...
function UpgradePrompt(_a) {
    var _this = this;
    var isOpen = _a.isOpen, onClose = _a.onClose, reason = _a.reason, _b = _a.currentPlan, currentPlan = _b === void 0 ? "Free" : _b, _c = _a.suggestedPlan, suggestedPlan = _c === void 0 ? "Professional" : _c, usageMetrics = _a.usageMetrics, onUpgrade = _a.onUpgrade, onExtendTrial = _a.onExtendTrial, className = _a.className;
    var _d = (0, react_1.useState)(false), isUpgrading = _d[0], setIsUpgrading = _d[1];
    var _e = (0, react_1.useState)(false), isExtending = _e[0], setIsExtending = _e[1];
    ...
    var handleExtendTrial = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (<dialog_1.Dialog open={isOpen} onOpenChange={onClose}>
      <dialog_1.DialogContent className={(0, utils_1.cn)("sm:max-w-lg", className)}>
        ...
        <div className="space-y-6">
          {/* Usage Metrics */}
          {usageMetrics && (<div className={(0, utils_1.cn)("p-4 rounded-lg", urgency.bgColor)}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {config.features.map(function (feature, index) { return (<li key={index} className="flex items-center text-sm">
        ...
        <dialog_1.DialogFooter className="flex-col space-y-2 sm:space-y-0 sm:flex-row">
          {config.ctaSecondary && (<button_1.Button variant="outline" onClick={reason === "trial_ended" ? handleExtendTrial : onClose} disabled={isUpgrading || isExtending} className="w-full sm:w-auto">
              {isExtending ? "Extending..." : config.ctaSecondary}
            </button_1.Button>)}
          <button_1.Button onClick={handleUpgrade} disabled={isUpgrading || isExtending || !onUpgrade} className="w-full sm:w-auto">
