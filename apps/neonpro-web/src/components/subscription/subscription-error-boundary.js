...
exports.SubscriptionPaymentErrorBoundary = exports.SubscriptionStatusErrorBoundary = exports.SubscriptionErrorBoundary = void 0;
...
var SubscriptionErrorBoundary = /** @class */ (function (_super) {
    ...
    function SubscriptionErrorBoundary(props) {
        ...
        _this.retryTimeouts = [];
        _this.handleRetry = function () { return __awaiter(_this, void 0, void 0, function () {
            var retryError_1;
    ...
    SubscriptionErrorBoundary.prototype.componentDidCatch = function (error, errorInfo) {
        ...
        var subscriptionError = subscription_errors_1.SubscriptionErrorFactory.createError('validation', "React Error Boundary: ".concat(error.message), {
            additionalContext: {
        ...
        subscription_error_handler_1.subscriptionErrorHandler.handleError(subscriptionError, function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    SubscriptionErrorBoundary.prototype.render = function () {
        ...
        if (this.state.hasError) {
          ...
          <card_1.CardContent className="space-y-4">
            ...
            {this.props.showDetails && this.state.error && (<details className="text-sm text-muted-foreground">
              ...
              {this.state.canRetry && (<button_1.Button onClick={this.handleRetry} disabled={this.state.isRecovering} variant="default" className="w-full">
...
var SubscriptionStatusErrorBoundary = function (_a) {
    ...
    return (<SubscriptionErrorBoundary componentName="SubscriptionStatus" maxRetries={2} customErrorMessage="Unable to load subscription status. Please try again." enableRecovery={true}>
    {children}
...
var SubscriptionPaymentErrorBoundary = function (_a) {
    var children = _a.children;
    return (<SubscriptionErrorBoundary componentName="SubscriptionPayment" maxRetries={1} customErrorMessage="Payment processing error. Please try again or contact support." enableRecovery={false} showDetails={false}>
    {children}
  </SubscriptionErrorBoundary>);
};
...
function withSubscriptionErrorBoundary(WrappedComponent, options) {
    var ComponentWithErrorBoundary = function (props) { return (<SubscriptionErrorBoundary {...options}>
      <WrappedComponent {...props}/>
    </SubscriptionErrorBoundary>); };
    ComponentWithErrorBoundary.displayName =
        "withSubscriptionErrorBoundary(".concat(WrappedComponent.displayName || WrappedComponent.name, ")");
