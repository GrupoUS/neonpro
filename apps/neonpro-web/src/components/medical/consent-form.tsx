            ...
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-end space-x-4">
                  ...
                  <Button onClick={saveForm} disabled={!newForm.title || !newForm.type}>
                    Salvar Formulário
                  </Button>
                </div>
              </div>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t">
                          ...
                          <div className="flex items-center space-x-1">
                            <Button variant="outline" size="sm" onClick={() => loadForm(form.id)}>
                    ...
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Respondido em{" "}
                            {format(response.timestamp, "dd/MM/yyyy HH:mm", { locale: ptBR })}
                          </CardDescription>
                        </div>
                        <div className="flex items-center space-x-2">
                          {typeInfo && (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                          <div>
                            ...
                            <div className="font-medium">
                              {CONSENT_METHODS.find((m) => m.value === response.consentMethod)
                                ?.label || response.consentMethod}
                            </div>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <div
                              className={`font-medium ${response.consentGiven ? "text-green-600" : "text-red-600"}`}
                            >
                        ...
                        {response.withdrawnAt && (
                          <Alert>
                            ...
                            <AlertDescription>
                              ...
                              {format(response.withdrawnAt, "dd/MM/yyyy HH:mm", { locale: ptBR })}
