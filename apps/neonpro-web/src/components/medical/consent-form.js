...
var FIELD_TYPES = [
    ...
    { value: 'textarea', label: 'Texto Longo', icon: <lucide_react_1.FileText className="w-4 h-4"/> },
    { value: 'select', label: 'Seleção', icon: <lucide_react_1.Filter className="w-4 h-4"/> },
    { value: 'radio', label: 'Opção Única', icon: <lucide_react_1.CheckCircle className="w-4 h-4"/> },
    { value: 'checkbox', label: 'Múltipla Escolha', icon: <lucide_react_1.CheckCircle className="w-4 h-4"/> },
...
var DATA_CATEGORIES = [
    { value: 'personal_data', label: 'Dados Pessoais', icon: <lucide_react_1.User className="w-4 h-4"/> },
    { value: 'health_data', label: 'Dados de Saúde', icon: <lucide_react_1.Heart className="w-4 h-4"/> },
    { value: 'biometric_data', label: 'Dados Biométricos', icon: <lucide_react_1.Fingerprint className="w-4 h-4"/> },
    { value: 'genetic_data', label: 'Dados Genéticos', icon: <lucide_react_1.Brain className="w-4 h-4"/> },
    { value: 'location_data', label: 'Dados de Localização', icon: <lucide_react_1.MapPin className="w-4 h-4"/> },
    { value: 'contact_data', label: 'Dados de Contato', icon: <lucide_react_1.Phone className="w-4 h-4"/> },
    { value: 'financial_data', label: 'Dados Financeiros', icon: <lucide_react_1.DollarSign className="w-4 h-4"/> },
    { value: 'behavioral_data', label: 'Dados Comportamentais', icon: <lucide_react_1.Activity className="w-4 h-4"/> }
];
...
var CONSENT_METHODS = [
    { value: 'digital_signature', label: 'Assinatura Digital', icon: <lucide_react_1.Edit className="w-4 h-4"/> },
    { value: 'electronic_consent', label: 'Consentimento Eletrônico', icon: <lucide_react_1.Smartphone className="w-4 h-4"/> },
    { value: 'verbal_consent', label: 'Consentimento Verbal', icon: <lucide_react_1.Mic className="w-4 h-4"/> },
    { value: 'written_consent', label: 'Consentimento Escrito', icon: <lucide_react_1.FileText className="w-4 h-4"/> }
];
function ConsentForm(_a) {
    var _this = this;
    var patientId = _a.patientId, clinicId = _a.clinicId, formId = _a.formId, _b = _a.mode, mode = _b === void 0 ? 'view' : _b, onSubmit = _a.onSubmit, onSave = _a.onSave, _c = _a.allowWithdrawal, allowWithdrawal = _c === void 0 ? true : _c, _d = _a.requireDigitalSignature, requireDigitalSignature = _d === void 0 ? false : _d;
    var _e = (0, react_1.useState)([]), forms = _e[0], setForms = _e[1];
    var _f = (0, react_1.useState)([]), responses = _f[0], setResponses = _f[1];
    var _g = (0, react_1.useState)(null), currentForm = _g[0], setCurrentForm = _g[1];
    var _h = (0, react_1.useState)(null), currentResponse = _h[0], setCurrentResponse = _h[1];
    var _j = (0, react_1.useState)(false), isLoading = _j[0], setIsLoading = _j[1];
    var _k = (0, react_1.useState)(false), showFormBuilder = _k[0], setShowFormBuilder = _k[1];
    var _l = (0, react_1.useState)({}), formData = _l[0], setFormData = _l[1];
    var _m = (0, react_1.useState)({}), validationErrors = _m[0], setValidationErrors = _m[1];
    var _o = (0, react_1.useState)(''), searchTerm = _o[0], setSearchTerm = _o[1];
    var _p = (0, react_1.useState)(''), filterType = _p[0], setFilterType = _p[1];
    var _q = (0, react_1.useState)('forms'), selectedTab = _q[0], setSelectedTab = _q[1];
    // Form builder state
    var _r = (0, react_1.useState)({
        ...
        retentionPeriod: 5,
        metadata: {}
    }), newForm = _r[0], setNewForm = _r[1];
    var _s = (0, react_1.useState)({
        title: '',
        description: '',
        isRequired: false
    }), newSection = _s[0], setNewSection = _s[1];
    var _t = (0, react_1.useState)({
        ...
        options: [],
        sectionId: ''
    }), newField = _t[0], setNewField = _t[1];
    var _u = (0, react_1.useState)({
        value: '',
        label: '',
        description: ''
    }), newOption = _u[0], setNewOption = _u[1];
    ...
    var loadForms = function () { return __awaiter(_this, void 0, void 0, function () {
        var mockForms;
    ...
    var loadResponses = function () { return __awaiter(_this, void 0, void 0, function () {
        var mockResponses;
        return __generator(this, function (_a) {
            try {
                mockResponses = [
    ...
    var loadForm = function (id) { return __awaiter(_this, void 0, void 0, function () {
        var form, initialData_1;
        return __generator(this, function (_a) {
            form = forms.find(function (f) { return f.id === id; });
            if (form) {
                setCurrentForm(form);
                initialData_1 = {};
    ...
    var handleSubmit = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            try {
                ...
                setResponses(function (prev) { return __spreadArray(__spreadArray([], prev, true), [response_1], false); });
    ...
    var withdrawConsent = function (responseId, reason) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
                setResponses(function (prev) { return prev.map(function (response) {
                    return response.id === responseId
                        ? __assign(__assign({}, response), { isActive: false, withdrawnAt: new Date(), withdrawalReason: reason }) : response;
                }); });
            }
            catch (error) {
    ...
    var addSection = function () {
        ...
        var section = {
            ...
            order: (((_a = newForm.content) === null || _a === void 0 ? void 0 : _a.sections.length) || 0) + 1,
            isRequired: newSection.isRequired,
            fields: []
        };
        setNewForm(function (prev) {
            var _a;
            return (__assign(__assign({}, prev), { content: __assign(__assign({}, prev.content), { sections: __spreadArray(__spreadArray([], (((_a = prev.content) === null || _a === void 0 ? void 0 : _a.sections) || []), true), [section], false) }) }));
        });
        setNewSection({ title: '', description: '', isRequired: false });
    };
    var addField = function () {
        var _a;
        if (!newField.name || !newField.label || !newField.sectionId)
            return;
        var field = {
            id: crypto.randomUUID(),
            name: newField.name,
            ...
            order: (((_a = newForm.content) === null || _a === void 0 ? void 0 : _a.fields.length) || 0) + 1,
            sectionId: newField.sectionId,
            metadata: {}
        };
        setNewForm(function (prev) {
            var _a;
            return (__assign(__assign({}, prev), { content: __assign(__assign({}, prev.content), { fields: __spreadArray(__spreadArray([], (((_a = prev.content) === null || _a === void 0 ? void 0 : _a.fields) || []), true), [field], false) }) }));
        });
        // Add field to section
        setNewForm(function (prev) { return (__assign(__assign({}, prev), { content: __assign(__assign({}, prev.content), { sections: prev.content.sections.map(function (section) {
                    return section.id === newField.sectionId
                        ? __assign(__assign({}, section), { fields: __spreadArray(__spreadArray([], section.fields, true), [field.id], false) }) : section;
                }) }) })); });
        setNewField({
            name: '',
            label: '',
    ...
    var addOption = function () {
        ...
        setNewField(function (prev) { return (__assign(__assign({}, prev), { options: __spreadArray(__spreadArray([], prev.options, true), [option], false) })); });
        setNewOption({ value: '', label: '', description: '' });
    };
    var saveForm = function () { return __awaiter(_this, void 0, void 0, function () {
        var form_1;
        return __generator(this, function (_a) {
            if (!newForm.title || !newForm.type)
                return [2 /*return*/];
            try {
                form_1 = {
                    id: crypto.randomUUID(),
                ...
                setForms(function (prev) { return __spreadArray(__spreadArray([], prev, true), [form_1], false); });
    ...
    var renderField = function (field) {
        ...
        var baseProps = {
            id: field.name,
            value: value,
            onChange: function (e) { return handleFieldChange(field.name, e.target ? e.target.value : e); },
        ...
        switch (field.type) {
            ...
            case 'select':
                return (<select_1.Select value={value} onValueChange={function (val) { return handleFieldChange(field.name, val); }}>
            <select_1.SelectTrigger className={error ? 'border-red-500' : ''}>
              <select_1.SelectValue placeholder={field.placeholder}/>
            </select_1.SelectTrigger>
            <select_1.SelectContent>
              {(_a = field.options) === null || _a === void 0 ? void 0 : _a.map(function (option) { return (<select_1.SelectItem key={option.value} value={option.value}>
                  {option.label}
                </select_1.SelectItem>); })}
            </select_1.SelectContent>
          </select_1.Select>);
            case 'radio':
                return (<radio_group_1.RadioGroup value={value} onValueChange={function (val) { return handleFieldChange(field.name, val); }}>
            {(_b = field.options) === null || _b === void 0 ? void 0 : _b.map(function (option) { return (<div key={option.value} className="flex items-center space-x-2">
                <radio_group_1.RadioGroupItem value={option.value} id={"".concat(field.name, "_").concat(option.value)}/>
                <label_1.Label htmlFor={"".concat(field.name, "_").concat(option.value)}>{option.label}</label_1.Label>
              </div>); })}
            ...
            case 'checkbox':
              ...
              {field.options.map(function (option) { return (<div key={option.value} className="flex items-center space-x-2">
                  <checkbox_1.Checkbox id={"".concat(field.name, "_").concat(option.value)} checked={selectedValues_1.includes(option.value)} onCheckedChange={function (checked) {
                                var newValues = checked
                                    ? __spreadArray(__spreadArray([], selectedValues_1, true), [option.value], false) : selectedValues_1.filter(function (v) { return v !== option.value; });
              ...
              <checkbox_1.Checkbox id={field.name} checked={!!value} onCheckedChange={function (checked) { return handleFieldChange(field.name, checked); }}/>
            ...
            <div className="flex items-center space-x-2">
              <checkbox_1.Checkbox id={field.name} checked={!!value} onCheckedChange={function (checked) { return handleFieldChange(field.name, checked); }} className={error ? 'border-red-500' : ''}/>
    ...
    var getFormTypeInfo = function (type) {
        return FORM_TYPES.find(function (t) { return t.value === type; }) || FORM_TYPES[0];
    };
    var getDataCategoryInfo = function (category) {
        return DATA_CATEGORIES.find(function (c) { return c.value === category; }) || DATA_CATEGORIES[0];
    };
    var getLegalBasisInfo = function (type) {
        return LEGAL_BASIS_TYPES.find(function (b) { return b.value === type; }) || LEGAL_BASIS_TYPES[0];
    };
    var filteredForms = forms.filter(function (form) {
        var matchesSearch = form.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    if (mode === 'fill' && currentForm) {
        ...
        <div className="text-center">
          ...
          {currentForm.isRequired && (<badge_1.Badge className="mt-2 bg-red-100 text-red-800">
        ...
        <card_1.Card>
          <card_1.CardContent className="p-6">
            <form onSubmit={function (e) { e.preventDefault(); handleSubmit(); }} className="space-y-6">
              {currentForm.content.sections.map(function (section) { return (<div key={section.id} className="space-y-4">
                  ...
                  {currentForm.content.fields
                    .filter(function (field) { return field.sectionId === section.id; })
                    .sort(function (a, b) { return a.order - b.order; })
                    .map(function (field) { return (<div key={field.id} className="space-y-2">
                        {field.type !== 'consent' && field.type !== 'checkbox' && (<label_1.Label htmlFor={field.name} className="flex items-center space-x-1">
                        ...
                        {field.helpText && field.type !== 'consent' && (<p className="text-sm text-gray-500">{field.helpText}</p>)}
                        
                        {validationErrors[field.name] && (<p className="text-sm text-red-600 flex items-center space-x-1">
              ...
              <div className="flex items-center justify-between pt-6 border-t">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button_1.Button type="submit" disabled={isLoading}>
                    {isLoading ? (<lucide_react_1.RefreshCw className="w-4 h-4 mr-2 animate-spin"/>) : (<lucide_react_1.CheckCircle className="w-4 h-4 mr-2"/>)}
    ...
    return (<div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input_1.Input id="formTitle" value={newForm.title} onChange={function (e) { return setNewForm(function (prev) { return (__assign(__assign({}, prev), { title: e.target.value })); }); }} placeholder="Ex: Termo de Consentimento para Cirurgia"/>
                  </div>
                  
                  <div className="space-y-2">
                    <label_1.Label htmlFor="formType">Tipo de Formulário *</label_1.Label>
                    <select_1.Select value={newForm.type} onValueChange={function (value) { return setNewForm(function (prev) { return (__assign(__assign({}, prev), { type: value })); }); }}>
                      <select_1.SelectTrigger>
                        <select_1.SelectValue placeholder="Selecione o tipo"/>
                      </select_1.SelectTrigger>
                      <select_1.SelectContent>
                        {FORM_TYPES.map(function (type) { return (<select_1.SelectItem key={type.value} value={type.value}>
                            <div className="flex items-center space-x-2">
                              {type.icon}
                ...
                <div className="space-y-2">
                  ...
                  <textarea_1.Textarea id="formDescription" value={newForm.description} onChange={function (e) { return setNewForm(function (prev) { return (__assign(__assign({}, prev), { description: e.target.value })); }); }} placeholder="Descreva o propósito e contexto do formulário" rows={3}/>
                </div>

                <div className="flex items-center justify-end space-x-4">
                  <button_1.Button type="button" variant="outline" onClick={function () { return setShowFormBuilder(false); }}>
                    Cancelar
                  </button_1.Button>
      ...
      <div className="flex items-center space-x-4">
        <div className="flex-1">
          <div className="relative">
            ...
            <input_1.Input placeholder="Buscar formulários..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-10"/>
          </div>
        </div>
      ...
      <tabs_1.Tabs value={selectedTab} onValueChange={setSelectedTab}>
        ...
        <tabs_1.TabsContent value="forms" className="space-y-4">
          {filteredForms.length === 0 ? (<card_1.Card>
              <card_1.CardContent className="text-center py-8">
                ...
                <button_1.Button onClick={function () { return setShowFormBuilder(true); }}>
                  <lucide_react_1.Plus className="w-4 h-4 mr-2"/>
                  Criar Formulário
                </button_1.Button>
              </card_1.CardContent>
              ...
              {filteredForms.map(function (form) {
                ...
                return (<card_1.Card key={form.id} className="hover:shadow-md transition-shadow">
                    <card_1.CardHeader>
                    ...
                    <card_1.CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <badge_1.Badge className={form.isActive ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}>
                        ...
                        {form.dataCategories.length > 0 && (<div className="space-y-1">
                            ...
                            return (<badge_1.Badge key={category} variant="outline" className="text-xs">
                                    {categoryInfo.icon}
                                    <span className="ml-1">{categoryInfo.label}</span>
                                  </badge_1.Badge>);
                        })}
                              {form.dataCategories.length > 2 && (<badge_1.Badge variant="outline" className="text-xs">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t">
                          <div className="text-xs text-gray-500">
                            {(0, date_fns_1.format)(form.updatedAt, 'dd/MM/yyyy', { locale: locale_1.ptBR })}
                          </div>
                          <div className="flex items-center space-x-1">
                            <button_1.Button variant="outline" size="sm" onClick={function () { return loadForm(form.id); }}>
        ...
        <tabs_1.TabsContent value="responses" className="space-y-4">
          {responses.length === 0 ? (<card_1.Card>
              <card_1.CardContent className="text-center py-8">
              ...
              {responses.map(function (response) {
                var _a;
                var form = forms.find(function (f) { return f.id === response.formId; });
                var typeInfo = form ? getFormTypeInfo(form.type) : null;
                return (<card_1.Card key={response.id}>
                    <card_1.CardHeader>
                      <div className="flex items-start justify-between">
                        <div>
                          <card_1.CardTitle className="text-lg">
                            {(form === null || form === void 0 ? void 0 : form.title) || 'Formulário não encontrado'}
                          </card_1.CardTitle>
                          <card_1.CardDescription>
                            Respondido em {(0, date_fns_1.format)(response.timestamp, 'dd/MM/yyyy HH:mm', { locale: locale_1.ptBR })}
                          </card_1.CardDescription>
                        </div>
                        <div className="flex items-center space-x-2">
                          {typeInfo && (<badge_1.Badge className={typeInfo.color}>
                              <div className="flex items-center space-x-1">
                                {typeInfo.icon}
                                <span>{typeInfo.label}</span>
                              </div>
                            </badge_1.Badge>)}
                          <badge_1.Badge className={response.isActive ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
                    ...
                    <card_1.CardContent>
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                          <div>
                            ...
                            <div className="font-medium">
                              {((_a = CONSENT_METHODS.find(function (m) { return m.value === response.consentMethod; })) === null || _a === void 0 ? void 0 : _a.label) || response.consentMethod}
                            </div>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <div className={"font-medium ".concat(response.consentGiven ? 'text-green-600' : 'text-red-600')}>
                              {response.consentGiven ? 'Concedido' : 'Negado'}
                            </div>
                          </div>
                        </div>
                        
                        {response.withdrawnAt && (<alert_1.Alert>
                            <lucide_react_1.AlertTriangle className="w-4 h-4"/>
                            <alert_1.AlertDescription>
                              <strong>Consentimento retirado</strong> em {(0, date_fns_1.format)(response.withdrawnAt, 'dd/MM/yyyy HH:mm', { locale: locale_1.ptBR })}
                              {response.withdrawalReason && (<span className="block mt-1">Motivo: {response.withdrawalReason}</span>)}
                            </alert_1.AlertDescription>
                          </alert_1.Alert>)}
                        ...
                        <div className="flex items-center justify-end space-x-2">
                          ...
                          {response.isActive && allowWithdrawal && (<button_1.Button variant="outline" size="sm" className="text-red-600">
            ...
            <card_1.Card>
              <card_1.CardContent className="p-6">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="text-2xl font-bold">{responses.filter(function (r) { return r.isActive; }).length}</div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="text-2xl font-bold">
                      {responses.filter(function (r) { return r.consentMethod === 'digital_signature'; }).length}
                    </div>
