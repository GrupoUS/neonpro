...
var DOCUMENT_CATEGORIES = [
  ...
  },
  {
    ...
    icon: <lucide_react_1.FileImage className="w-4 h-4" />,
...
var FILE_TYPES = {
  ...
  "application/pdf": {
    icon: <lucide_react_1.FilePdf className="w-4 h-4" />,
    color: "text-red-600",
  },
  "application/msword": {
    icon: <lucide_react_1.FileText className="w-4 h-4" />,
  ...
  "application/vnd.ms-excel": {
    icon: <lucide_react_1.FileSpreadsheet className="w-4 h-4" />,
  ...
  "application/zip": {
    icon: <lucide_react_1.Archive className="w-4 h-4" />,
    color: "text-gray-600",
  },
  "application/rar": {
    icon: <lucide_react_1.Archive className="w-4 h-4" />,
...
function DocumentUpload(_a) {
  var patientId = _a.patientId,
    ...
    _b = _a.allowedTypes,
    allowedTypes = _b === void 0 ? DEFAULT_ALLOWED_TYPES : _b,
    _c = _a.maxFileSize,
    maxFileSize = _c === void 0 ? MAX_FILE_SIZE : _c,
    category = _a.category,
    _d = _a.isBeforeAfter,
    isBeforeAfter = _d === void 0 ? false : _d;
  ...
  var _g = (0, react_1.useState)({}),
    uploadProgress = _g[0],
    setUploadProgress = _g[1];
  var _h = (0, react_1.useState)(false),
    dragActive = _h[0],
    setDragActive = _h[1];
  var _j = (0, react_1.useState)(false),
    showUploadDialog = _j[0],
    setShowUploadDialog = _j[1];
  var _k = (0, react_1.useState)("grid"),
    viewMode = _k[0],
    setViewMode = _k[1];
  ...
  var _m = (0, react_1.useState)("all"),
    selectedCategory = _m[0],
    setSelectedCategory = _m[1];
  var _o = (0, react_1.useState)(null),
    selectedDocument = _o[0],
    setSelectedDocument = _o[1];
  var _p = (0, react_1.useState)({
    ...
    newDocumentData = _p[0],
    setNewDocumentData = _p[1];
      ...
      if (file.size > maxFileSize) {
        alert(
          "Arquivo muito grande: "
            .concat(file.name, ". M\u00E1ximo permitido: ")
            .concat(formatFileSize(maxFileSize)),
        );
        return false;
      }
      return true;
                  ...
                  case 0:
                    ...
                    uploadInterval_1 = setInterval(() => {
                      setUploadProgress((prev) => {
                        ...
                        return __assign(
                          __assign({}, prev),
                          ((_a = {}), (_a[file.name] = currentProgress + 10), _a),
                        );
                      });
                    }, 200);
                    // Simulate API call
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Drag and Drop Area */}
      <card_1.Card
        className={"border-2 border-dashed transition-colors ".concat(
                      ...
                      <card_1.CardContent className="pt-6">
                        <div className="space-y-3">
                          ...
                          <div className="text-xs text-gray-500">
                            {(0, date_fns_1.format)(document.uploadDate, "dd/MM/yyyy HH:mm", {
