...
export function MedicalRecordsForm({
  ...
  const getPriorityBadge = (priority: number) => {
    ...
    return <Badge className={priorityOption?.color}>{priorityOption?.label}</Badge>;
  };
          ...
          <TabsContent value="basic" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Informações principais do registro médico</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="metadata" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Informações de auditoria e metadados do registro</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      value={
                        record.createdAt
                          ? format(record.createdAt, "dd/MM/yyyy HH:mm", { locale: ptBR })
                          : ""
                      }
                      disabled
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      value={
                        record.updatedAt
                          ? format(record.updatedAt, "dd/MM/yyyy HH:mm", { locale: ptBR })
                          : ""
                      }
                      disabled
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      value={
                        record.signedAt
                          ? format(record.signedAt, "dd/MM/yyyy HH:mm", { locale: ptBR })
                          : "Não assinado"
                      }
                      disabled
                    />
