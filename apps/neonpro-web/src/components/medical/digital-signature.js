...
var SIGNATURE_STATUS = [
  ...
  },
  {
    ...
    icon: <lucide_react_1.X className="w-3 h-3" />,
  },
  {
    value: "expired",
    label: "Expirado",
    color: "bg-gray-100 text-gray-800",
    icon: <lucide_react_1.AlertTriangle className="w-3 h-3" />,
  },
];
var SIGNER_ROLES = [
  ...
  { value: "patient", label: "Paciente", icon: <lucide_react_1.User className="w-4 h-4" /> },
  {
    value: "nurse",
    label: "Enfermeiro(a)",
    icon: <lucide_react_1.UserCheck className="w-4 h-4" />,
  },
...
function DigitalSignature(_a) {
  ...
  var documentId = _a.documentId,
    ...
    onSignatureComplete = _a.onSignatureComplete,
    onRequestSent = _a.onRequestSent,
    _b = _a.allowedSignatureTypes,
    allowedSignatureTypes = _b === void 0 ? ["digital_certificate", "electronic", "pin"] : _b,
    _c = _a.requireMultipleSignatures,
    requireMultipleSignatures = _c === void 0 ? false : _c;
  var _d = (0, react_1.useState)([]),
    signatures = _d[0],
    setSignatures = _d[1];
  var _e = (0, react_1.useState)([]),
    signatureRequests = _e[0],
    setSignatureRequests = _e[1];
  var _f = (0, react_1.useState)(false),
    isLoading = _f[0],
    setIsLoading = _f[1];
  var _g = (0, react_1.useState)(false),
    showSignDialog = _g[0],
    setShowSignDialog = _g[1];
  var _h = (0, react_1.useState)(false),
    showRequestDialog = _h[0],
    setShowRequestDialog = _h[1];
  var _j = (0, react_1.useState)(""),
    selectedSignatureType = _j[0],
    setSelectedSignatureType = _j[1];
              ...
              <div className="space-y-4">
                ...
                <div className="border rounded-lg p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <label_1.Label htmlFor="signerSignatureType">
                        Tipo de Assinatura
                      </label_1.Label>
                      <select_1.Select
                  ...
                  return (
                    <tabs_1.TabsContent key={type.value} value={type.value} className="space-y-4">
                      <alert_1.Alert>
                        ...
                        <alert_1.AlertDescription>{type.description}</alert_1.AlertDescription>
                      </alert_1.Alert>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                            <div className="flex items-center space-x-1">
                              ...
                              <span>
                                {(0, date_fns_1.format)(signature.timestamp, "dd/MM/yyyy HH:mm", {
