...
var getBenchmarkStatus = function (value, benchmark) {
  ...
  if (ratio >= 0.9) return { status: "good", color: "text-blue-600", icon: lucide_react_1.Target };
  if (ratio >= 0.7)
...
function AdvancedMetricsDashboard(_a) {
  var kpis = _a.kpis,
    timeSeriesData = _a.timeSeriesData,
    segmentationData = _a.segmentationData,
    benchmarkData = _a.benchmarkData,
    _b = _a.cohortData,
    cohortData = _b === void 0 ? [] : _b,
    _c = _a.forecastData,
    forecastData = _c === void 0 ? [] : _c,
    _d = _a.loading,
    loading = _d === void 0 ? false : _d,
    dateRange = _a.dateRange,
    _e = _a.className,
    className = _e === void 0 ? "" : _e,
    onMetricClick = _a.onMetricClick,
  ...
  var _g = (0, react_1.useState)(null),
    selectedKPI = _g[0],
    setSelectedKPI = _g[1];
  var _h = (0, react_1.useState)("line"),
    chartType = _h[0],
    setChartType = _h[1];
  var _j = (0, react_1.useState)("day"),
                  ...
                  >
                    ...
                    <card_1.CardContent className="pt-0">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          <ChangeIcon
                            className={"h-3 w-3 ".concat(getChangeColor(kpi.value.change))}
                          />
                          <span
                            className={"text-xs font-medium ".concat(
                              getChangeColor(kpi.value.change),
                            )}
                          >
                        ...
                        {kpi.value.target && (
                          <div className="mt-2">
                            <div className="flex justify-between text-xs text-gray-600 mb-1">
                              ...
                              <span>
                                {((kpi.value.current / kpi.value.target) * 100).toFixed(0)}%
                              </span>
                            </div>
                            <progress_1.Progress
              ...
              <card_1.CardContent>
                <div className="h-96">
                  <recharts_1.ResponsiveContainer width="100%" height="100%">
                    {chartType === "line" && (
                      <recharts_1.LineChart data={processedTimeSeriesData}>
                    ...
                    {chartType === "area" && (
                      <recharts_1.AreaChart data={processedTimeSeriesData}>
                        <recharts_1.CartesianGrid strokeDasharray="3 3" />
                        <recharts_1.XAxis
                          dataKey="date"
                          tickFormatter={function (date) {
                    ...
                    {chartType === "bar" && (
                      <recharts_1.BarChart data={processedTimeSeriesData}>
                        <recharts_1.CartesianGrid strokeDasharray="3 3" />
                        <recharts_1.XAxis
                          dataKey="date"
                          tickFormatter={function (date) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Distribution across key segments</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
                <div className="h-80">
                  <recharts_1.ResponsiveContainer width="100%" height="100%">
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Growth and performance by segment</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
                <div className="space-y-4">
                      ...
                      <div key={benchmark.metric} className="space-y-3">
                        ...
                        <div className="space-y-1">
                          <div className="flex justify-between text-xs text-gray-600">
                            ...
                            <span>
                              {((benchmark.value / benchmark.benchmark) * 100).toFixed(0)}%
                            </span>
                          </div>
                          <progress_1.Progress
      ...
      {dashboardSummary.underPerforming > 0 && (
        <alert_1.Alert>
          ...
          <alert_1.AlertDescription>
            <strong>Action Required:</strong> {dashboardSummary.underPerforming} KPI(s) are
            significantly below target. Review performance metrics and consider strategic
            adjustments.
          </alert_1.AlertDescription>
        </alert_1.Alert>
      )}
