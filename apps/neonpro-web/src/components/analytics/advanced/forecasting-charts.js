...
function ForecastingCharts(_a) {
  ...
  var metric = _a.metric,
    historicalData = _a.historicalData,
    forecastData = _a.forecastData,
    _c = _a.scenarios,
    scenarios = _c === void 0 ? [] : _c,
    accuracyMetrics = _a.accuracyMetrics,
    _d = _a.loading,
    loading = _d === void 0 ? false : _d,
    _e = _a.className,
    className = _e === void 0 ? "" : _e,
    onDateRangeChange = _a.onDateRangeChange,
    onScenarioToggle = _a.onScenarioToggle;
  ...
  var _h = (0, react_1.useState)(true),
    showConfidenceInterval = _h[0],
    setShowConfidenceInterval = _h[1];
  ...
  var handleScenarioToggle = (0, react_1.useCallback)(
    (scenarioName) => {
      ...
      onScenarioToggle === null || onScenarioToggle === void 0
        ? void 0
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      {forecastInsights.trend === "positive"
                        ...
                        : forecastInsights.trend === "negative"
                          ...
                          : <lucide_react_1.Activity className="h-4 w-4 text-gray-600" />}
                ...
                <recharts_1.ResponsiveContainer width="100%" height="100%">
                  <recharts_1.ComposedChart data={combinedData}>
                    ...
                    <recharts_1.ReferenceLine
                      x={
                        (_b = historicalData[historicalData.length - 1]) === null || _b === void 0
                          ? void 0
                          : _b.date
                      }
                      stroke="#6b7280"
                    ...
                    <recharts_1.Brush
                      ...
                      onChange={(domain) => {
                        ...
                        if (
                          ...
                          var start =
                            (_a = combinedData[domain.startIndex]) === null || _a === void 0
                              ? void 0
                              : _a.date;
                          var end =
                            (_b = combinedData[domain.endIndex]) === null || _b === void 0
                              ? void 0
                              : _b.date;
                          if (start && end) {
                            setZoomDomain([start, end]);
                            onDateRangeChange === null || onDateRangeChange === void 0
                              ? void 0
              ...
              {forecastData.length > 0 && (
                <alert_1.Alert>
                  ...
                  <alert_1.AlertDescription>
                    ...
                    {(forecastInsights === null || forecastInsights === void 0
                      ? void 0
                      : forecastInsights.trend) === "positive"
                      ? "increase"
                      : (forecastInsights === null || forecastInsights === void 0
                  ...
                  return (
                    <card_1.Card
                      ...
                      className={"border-l-4 ".concat(
                        enabledScenarios.has(scenario.name) ? "opacity-100" : "opacity-50",
                      )}
