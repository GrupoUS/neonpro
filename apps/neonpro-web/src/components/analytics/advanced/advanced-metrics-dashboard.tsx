                    ...
                    <CardContent className="pt-0">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`text-xs font-medium ${getChangeColor(kpi.value.change)}`}
                          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>How each KPI performs against its target</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>KPIs ranked by performance vs target</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Distribution across key segments</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Growth and performance by segment</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {segmentationData.map((segment, index) => (
                    <div key={segment.name} className="space-y-2">
                      ...
                      <Progress
                        value={
                          (segment.value / Math.max(...segmentationData.map((s) => s.value))) * 100
                        }
                        className="h-2"
                      />
                    </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Performance vs industry benchmarks and targets</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
