...
function AnalyticsDashboard() {
  ...
  var _b = (0, react_1.useState)([]),
    revenueTrends = _b[0],
    setRevenueTrends = _b[1];
  var _c = (0, react_1.useState)([]),
    appointmentTrends = _c[0],
    setAppointmentTrends = _c[1];
  var _d = (0, react_1.useState)(true),
    loading = _d[0],
    setLoading = _d[1];
  var _e = (0, react_1.useState)({
      start: (0, date_fns_1.format)(
        (0, date_fns_1.startOfMonth)((0, date_fns_1.subDays)(new Date(), 30)),
        "yyyy-MM-dd",
      ),
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch(
                "/api/analytics/dashboard?start_date="
                  .concat(dateRange.start, "&end_date=")
                  .concat(dateRange.end),
              ),
            ];
          case 2:
            kpiResponse = _a.sent();
          ...
          case 4:
            return [
              4 /*yield*/,
              fetch(
                "/api/analytics/trends?type=revenue&period=monthly&start_date="
                  .concat(dateRange.start, "&end_date=")
                  .concat(dateRange.end),
              ),
            ];
          ...
          case 7:
            return [
              4 /*yield*/,
              fetch(
                "/api/analytics/trends?type=appointments&period=monthly&start_date="
                  .concat(dateRange.start, "&end_date=")
                  .concat(dateRange.end),
              ),
            ];
