...
function ExportDashboard(_a) {
  ...
  var className = _a.className,
    ...
    defaultDateRange =
      _e === void 0
        ...
        : _e,
    onExportComplete = _a.onExportComplete,
    onExportError = _a.onExportError;
  // State management
  var _f = (0, react_1.useState)("create"),
    activeTab = _f[0],
    setActiveTab = _f[1];
  ...
  var _h = (0, react_1.useState)([]),
    activeExports = _h[0],
    setActiveExports = _h[1];
  var _j = (0, react_1.useState)([]),
    exportHistory = _j[0],
    setExportHistory = _j[1];
  // Form state
  ...
  // API FUNCTIONS
  // ========================================================================
  var createExport = (0, react_1.useCallback)(
    function () {
  ...
  var pollActiveExports = (0, react_1.useCallback)(
    function () {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              if (activeExports.length === 0) return [2 /*return*/];
              pendingExports = activeExports.filter(function (exp) {
                return exp.status === "pending" || exp.status === "processing";
              });
              if (pendingExports.length === 0) return [2 /*return*/];
              _a.label = 1;
            case 1:
              _a.trys.push([1, 3, , 4]);
              statusPromises = pendingExports.map(function (exp) {
                return __awaiter(_this, void 0, void 0, function () {
                  var response;
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [4 /*yield*/, fetch("/api/analytics/export/".concat(exp.id))];
                      case 1:
                        response = _a.sent();
            ...
            case 2:
              ...
              setActiveExports(function (prev) {
                return prev.map(function (exp) {
                  var _a;
                  var statusIndex = pendingExports.findIndex(function (pending) {
                    return pending.id === exp.id;
                  });
                  if (statusIndex >= 0 && statuses_1[statusIndex]) {
                    var status_1 = statuses_1[statusIndex];
                    var updatedExport = __assign(__assign({}, exp), {
                      status: status_1.status,
                      progress: status_1.progress,
                      downloadUrl: status_1.downloadUrl,
                      fileName: status_1.fileName,
                      fileSize: status_1.fileSize,
                      completedAt: status_1.completedAt
                        ? new Date(status_1.completedAt)
                        : undefined,
                    ...
                    if (status_1.status === "completed" && exp.status !== "completed") {
                      ...
                      onExportComplete === null || onExportComplete === void 0
                        ? void 0
                        : onExportComplete(status_1);
                    } else if (status_1.status === "failed" && exp.status !== "failed") {
                      sonner_1.toast.error("Export failed", {
                        description:
                          ((_a = status_1.error) === null || _a === void 0 ? void 0 : _a.message) ||
  ...
  var loadExportHistory = (0, react_1.useCallback)(function () {
    return __awaiter(_this, void 0, void 0, function () {
  ...
  var cancelExport = (0, react_1.useCallback)(function (exportId) {
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/analytics/export/".concat(exportId), {
                method: "DELETE",
              }),
            ];
          case 1:
              ...
              setActiveExports(function (prev) {
                return prev.map(function (exp) {
                  return exp.id === exportId
                    ? __assign(__assign({}, exp), { status: "cancelled" })
                    : exp;
                });
              });
  ...
  var downloadExport = (0, react_1.useCallback)(function (exportItem) {
    return __awaiter(_this, void 0, void 0, function () {
      var link;
      return __generator(this, function (_a) {
        if (!exportItem.downloadUrl) return [2 /*return*/];
        try {
  ...
  var getFormatIcon = function (format) {
    switch (format) {
      ...
      case "excel":
        return <lucide_react_1.FileSpreadsheet className="h-4 w-4" />;
      case "csv":
        return <lucide_react_1.FileText className="h-4 w-4" />;
      case "json":
        return <lucide_react_1.FileText className="h-4 w-4" />;
  ...
  var getReportTypeIcon = function (reportType) {
    switch (reportType) {
      case "revenue":
        return <lucide_react_1.DollarSign className="h-4 w-4" />;
      case "conversion":
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <badge_1.Badge variant="outline" className="text-xs">
            {
              activeExports.filter(function (exp) {
                return exp.status === "processing";
              }).length
            }{" "}
            Processing
          </badge_1.Badge>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <select_1.Select
                        ...
                        onValueChange={function (value) {
                          return updateFormData({ format: value });
                        }}
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <select_1.Select
                        ...
                        onValueChange={function (value) {
                          return updateFormData({ reportType: value });
                        }}
                      >
                        <select_1.SelectTrigger>
                        ...
                        <popover_1.PopoverTrigger asChild>
                          ...
                          >
                            ...
                            {formData.dateRange.startDate
                              ? (0, date_fns_1.format)(formData.dateRange.startDate, "PPP")
                        ...
                        <popover_1.PopoverContent className="w-auto p-0">
                          <calendar_1.Calendar
                            ...
                            onSelect={function (date) {
                              return date && updateNestedFormData("dateRange.startDate", date);
                            }}
                            initialFocus
                          />
                      ...
                      <popover_1.Popover>
                        <popover_1.PopoverTrigger asChild>
                          ...
                          >
                            ...
                            {formData.dateRange.endDate
                              ? (0, date_fns_1.format)(formData.dateRange.endDate, "PPP")
                        ...
                        <popover_1.PopoverContent className="w-auto p-0">
                          <calendar_1.Calendar
                            ...
                            onSelect={function (date) {
                              return date && updateNestedFormData("dateRange.endDate", date);
                            }}
                            initialFocus
                          />
                        </popover_1.PopoverContent>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2">
                      <checkbox_1.Checkbox
                        ...
                        onCheckedChange={function (checked) {
                          return updateFormData({ includeSummary: !!checked });
                        }}
                      />
                      <label_1.Label htmlFor="includeSummary">
                    ...
                    <div className="flex items-center space-x-2">
                      <checkbox_1.Checkbox
                        ...
                        onCheckedChange={function (checked) {
                          return updateFormData({ notifyOnComplete: !!checked });
                        }}
                      />
                      <label_1.Label htmlFor="notifyOnComplete">
                    ...
                    {formData.notifyOnComplete && (
                      <div className="space-y-2">
                        ...
                        <input_1.Input
                          ...
                          onChange={function (e) {
                            return updateFormData({ email: e.target.value });
                          }}
                        />
                      </div>
                    )}
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <input_1.Input
                        ...
                        onChange={function (e) {
                          return updateNestedFormData("customization.title", e.target.value);
                        }}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <input_1.Input
                        ...
                        onChange={function (e) {
                          return updateNestedFormData("customization.subtitle", e.target.value);
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="space-y-2">
                      ...
                      <input_1.Input
                        ...
                        type="color"
                        value={
                          ((_b = formData.customization.branding) === null || _b === void 0
                            ? void 0
                            : _b.primaryColor) || "#1f2937"
                        }
                        onChange={function (e) {
                          return updateNestedFormData(
                    ...
                    <div className="space-y-2">
                      ...
                      <input_1.Input
                        ...
                        type="color"
                        value={
                          ((_c = formData.customization.branding) === null || _c === void 0
                            ? void 0
                            : _c.secondaryColor) || "#6b7280"
                        }
                        onChange={function (e) {
                          return updateNestedFormData(
                    ...
                    <div className="space-y-2">
                      ...
                      <select_1.Select
                        value={
                          ((_d = formData.customization.branding) === null || _d === void 0
                            ? void 0
                            : _d.fontFamily) || "Inter"
                        }
                        onValueChange={function (value) {
                          return updateNestedFormData("customization.branding.fontFamily", value);
                        }}
                      >
                        <select_1.SelectTrigger>
                ...
                <card_1.CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {(0, date_fns_1.format)(formData.dateRange.startDate, "MMM d, yyyy")} -{" "}
                      {(0, date_fns_1.format)(formData.dateRange.endDate, "MMM d, yyyy")}
                    </div>
                  </div>
        ...
        <tabs_1.TabsContent value="history" className="space-y-6">
          ...
          {activeExports.length > 0 && (
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Currently processing exports</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
                <scroll_area_1.ScrollArea className="h-[300px]">
                  <div className="space-y-4">
                    {activeExports.map(function (exportItem) {
                      return (
                        <div
                          key={exportItem.id}
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-muted-foreground">
                                ...
                                {(0, date_fns_1.format)(exportItem.createdAt, "MMM d, HH:mm")}
                              </div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {(exportItem.status === "pending" ||
                              ...
                              <button_1.Button
                                ...
                                variant="outline"
                                onClick={function () {
                                  return cancelExport(exportItem.id);
                                }}
                              >
          ...
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>Previous exports and downloads</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <div className="font-medium">
                                  {exportItem.fileName ||
                                    "".concat(exportItem.config.reportType, "-export")}
                                </div>
                                <div className="text-sm text-muted-foreground">
                                  {exportItem.config.format.toUpperCase()} •{" "}
