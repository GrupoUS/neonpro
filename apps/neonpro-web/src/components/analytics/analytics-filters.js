...
function AnalyticsFilters(_a) {
  ...
  var _d = (0, react_1.useState)([]),
    filterOptions = _d[0],
    setFilterOptions = _d[1];
  var _e = (0, react_1.useState)({ start: null, end: null }),
    customDateRange = _e[0],
    setCustomDateRange = _e[1];
  /**
                  ...
                  options: [
                    {
                      ...
                      count:
                        (_b =
                          (_a = options.demographics) === null || _a === void 0
                            ? void 0
                            : _a.age_ranges) === null || _b === void 0
                          ? void 0
                          : _b["18-25"],
                    },
                    {
                      ...
                      count:
                        (_d =
                          (_c = options.demographics) === null || _c === void 0
                            ? void 0
                            : _c.age_ranges) === null || _d === void 0
                          ? void 0
                          : _d["26-35"],
                    },
                    {
                      ...
                      count:
                        (_f =
                          (_e = options.demographics) === null || _e === void 0
                            ? void 0
                            : _e.age_ranges) === null || _f === void 0
                          ? void 0
                          : _f["36-45"],
                    },
                    {
                      ...
                      count:
                        (_h =
                          (_g = options.demographics) === null || _g === void 0
                            ? void 0
                            : _g.age_ranges) === null || _h === void 0
                          ? void 0
                          : _h["46-55"],
                    },
                    {
                      ...
                      count:
                        (_k =
                          (_j = options.demographics) === null || _j === void 0
                            ? void 0
                            : _j.age_ranges) === null || _k === void 0
                          ? void 0
                          : _k["56+"],
                    },
                    {
                      ...
                      count:
                        (_m =
                          (_l = options.demographics) === null || _l === void 0
                            ? void 0
                            : _l.gender) === null || _m === void 0
                          ? void 0
                          : _m.female,
                    },
                    {
                      ...
                      count:
                        (_p =
                          (_o = options.demographics) === null || _o === void 0
                            ? void 0
                            : _o.gender) === null || _p === void 0
                          ? void 0
                          : _p.male,
                    },
                    {
                      ...
                      count:
                        (_r =
                          (_q = options.demographics) === null || _q === void 0
                            ? void 0
                            : _q.gender) === null || _r === void 0
                          ? void 0
                          : _r.other,
                    },
                  ],
                  ...
                  options: [
                    {
                      ...
                      count:
                        (_s = options.procedures) === null || _s === void 0 ? void 0 : _s.facial,
                    },
                    {
                      value: "body_contouring",
                      label: "Body Contouring",
                      count: (_t = options.procedures) === null || _t === void 0 ? void 0 : _t.body,
                    },
                    {
                      value: "skin_treatments",
                      label: "Skin Treatments",
                      count: (_u = options.procedures) === null || _u === void 0 ? void 0 : _u.skin,
                    },
                    {
                      value: "injectables",
                      label: "Injectables",
                      count:
                        (_v = options.procedures) === null || _v === void 0
                          ? void 0
                          : _v.injectables,
                    },
                    {
                      ...
                      count:
                        (_w = options.procedures) === null || _w === void 0 ? void 0 : _w.laser,
                    },
                    {
                      value: "surgical",
                      label: "Surgical",
                      count:
                        (_x = options.procedures) === null || _x === void 0 ? void 0 : _x.surgical,
                    },
                    {
                      value: "non_surgical",
                      label: "Non-Surgical",
                      count:
                        (_y = options.procedures) === null || _y === void 0
                          ? void 0
                          : _y.non_surgical,
                    },
                  ],
                  ...
                  options: [
                    {
                      ...
                      label: "Excellent",
                      count:
                        (_z = options.outcomes) === null || _z === void 0 ? void 0 : _z.excellent,
                    },
                    {
                      value: "very_good",
                      label: "Very Good",
                      count:
                        (_0 = options.outcomes) === null || _0 === void 0 ? void 0 : _0.very_good,
                    },
                    {
                      value: "good",
                      label: "Good",
                      count: (_1 = options.outcomes) === null || _1 === void 0 ? void 0 : _1.good,
                    },
                    {
                      value: "fair",
                      label: "Fair",
                      count: (_2 = options.outcomes) === null || _2 === void 0 ? void 0 : _2.fair,
                    },
                    {
                      value: "poor",
                      label: "Poor",
                      count: (_3 = options.outcomes) === null || _3 === void 0 ? void 0 : _3.poor,
                    },
                    {
                      value: "complications",
                      label: "With Complications",
                      count:
                        (_4 = options.outcomes) === null || _4 === void 0
                          ? void 0
                          : _4.complications,
                    },
                    {
                      ...
                      count:
                        (_5 = options.outcomes) === null || _5 === void 0
                          ? void 0
                          : _5.no_complications,
                    },
                  ],
            ...
            <popover_1.PopoverContent className="w-96 p-0" align="start">
              <div className="p-4 border-b">
                <div className="flex items-center justify-between mb-3">
                  ...
                  {activeFilters.length > 0 && (
                    <button_1.Button variant="ghost" size="sm" onClick={clearAllFilters}>
