...
function PerformanceMetricsPanel(_a) {
  ...
  var _b = (0, react_1.useState)("system"),
    selectedCategory = _b[0],
    setSelectedCategory = _b[1];
  var _c = (0, react_1.useState)([]),
    historicalData = _c[0],
    setHistoricalData = _c[1];
  var _d = (0, react_1.useState)(false),
    isLoadingHistory = _d[0],
    setIsLoadingHistory = _d[1];
  /**
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              analytics_1.performanceMonitoringEngine.getHistoricalData(
                clinicId,
                analytics_1.AnalyticsUtils.getTimeRangeStart(timeframe),
                new Date(),
              ),
            ];
          case 2:
  ...
  var MetricCard = function (_a) {
    ...
    return (
      <card_1.Card className={"".concat(statusColors[status])}>
        ...
        <card_1.CardContent>
          ...
          {trend !== undefined && (
            <div className="flex items-center text-xs text-muted-foreground mt-1">
              {trend > 0
                ? <lucide_react_1.TrendingUp className="w-3 h-3 text-red-500 mr-1" />
                : <lucide_react_1.TrendingDown className="w-3 h-3 text-green-500 mr-1" />}
