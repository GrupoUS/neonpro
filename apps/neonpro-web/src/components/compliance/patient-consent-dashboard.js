...
function PatientConsentDashboard(_a) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              Promise.all([fetchServiceDependencies(patientId), fetchConsentHistory(patientId)]),
            ];
          case 2:
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            ...
            {overallStatus === "partially_consented" && (
              <lucide_react_1.AlertTriangle className="mr-1 h-4 w-4" />
            )}
  ...
  function handlePrivacyRequest(requestType) {
    onPrivacyRequest === null || onPrivacyRequest === void 0
      ? void 0
          ...
          <div className="flex items-center space-x-2">
            ...
            <badge_1.Badge variant={isGranted ? "default" : "outline"}>
              {isGranted
                ...
                : <lucide_react_1.Lock className="mr-1 h-3 w-3" />}
...
function ConsentHistoryItem(_a) {
  ...
  var getActivityIcon = function (type) {
    switch (type) {
      ...
      case "withdrawn":
        return <lucide_react_1.Lock className="h-4 w-4 text-red-500" />;
      case "modified":
        return <lucide_react_1.Edit className="h-4 w-4 text-blue-500" />;
      default:
