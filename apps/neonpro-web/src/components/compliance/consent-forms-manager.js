...
function ConsentFormsManager(_a) {
    ...
    var _b = (0, react_1.useState)([]), consentForms = _b[0], setConsentForms = _b[1];
    var _c = (0, react_1.useState)(true), loading = _c[0], setLoading = _c[1];
    var _d = (0, react_1.useState)(null), selectedForm = _d[0], setSelectedForm = _d[1];
    var toast = (0, use_toast_1.useToast)().toast;
    var consentService = new consent_service_1.ConsentService();
    (0, react_1.useEffect)(function () {
        loadConsentForms();
    }, [clinicId]);
    var loadConsentForms = function () { return __awaiter(_this, void 0, void 0, function () {
        var forms, error_1;
    ...
    var handleArchiveForm = function (formId) { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {userRole === 'admin' && (<button_1.Button>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">
                  {consentForms.filter(function (f) { return f.is_active; }).length}
                </p>
              </div>
            </div>
          </card_1.CardContent>
          ...
          <card_1.CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">
                  {consentForms.filter(function (f) { return f.auto_expire; }).length}
                </p>
              </div>
            </div>
          </card_1.CardContent>
          ...
          <card_1.CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">
                  {new Set(consentForms.map(function (f) { return f.consent_type; })).size}
                </p>
              </div>
            </div>
          </card_1.CardContent>
      ...
      <div className="grid gap-4">
        {consentForms.length === 0 ? (<card_1.Card>
            <card_1.CardContent className="p-8 text-center">
          ...
          </card_1.Card>) : (consentForms.map(function (form) { return (<card_1.Card key={form.id} className="hover:shadow-md transition-shadow">
              <card_1.CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <badge_1.Badge variant={form.is_active ? 'default' : 'secondary'} className={form.is_active ? 'bg-green-100 text-green-800' : ''}>
              ...
              <card_1.CardContent className="pt-0">
                ...
                {form.auto_expire && form.retention_period_days && (<div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                ...
                <div className="flex items-center justify-between mt-4 pt-4 border-t">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {userRole === 'admin' && (<>
                        ...
                        {form.is_active && (<button_1.Button variant="outline" size="sm" onClick={function () { return handleArchiveForm(form.id); }}>
