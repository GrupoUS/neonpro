...
function ComplianceReportingDashboard(_a) {
  ...
  var _d = (0, react_1.useState)("30"),
    timeRange = _d[0],
    setTimeRange = _d[1]; // days
  var _e = (0, react_1.useState)("summary"),
    reportType = _e[0],
    setReportType = _e[1];
  var _f = (0, react_1.useState)(false),
    generatingReport = _f[0],
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <p className={"text-xs ".concat(complianceStatus.color)}>{complianceStatus.label}</p>
          ...
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <lucide_react_1.AlertTriangle
              className={"h-4 w-4 ".concat(
                analytics.criticalAlerts > 0 ? "text-red-500" : "text-green-500",
              )}
            />
          </card_1.CardHeader>
          <card_1.CardContent>
