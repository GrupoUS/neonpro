...
function AutomationDashboard() {
  ...
  var _d = (0, react_1.useState)(null),
    automationStatus = _d[0],
    setAutomationStatus = _d[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            _a.label = 3;
          case 3:
            return [4 /*yield*/, fetch("/api/compliance/automation")];
          case 4:
          ...
          case 5:
            ...
            _a.label = 6;
          case 6:
            return [4 /*yield*/, fetch("/api/compliance/automation/alerts?status=active&limit=10")];
          case 7:
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              {(metrics === null || metrics === void 0 ? void 0 : metrics.consent.active) || 0}
            </div>
            ...
            <div className="text-2xl font-bold">
              {((_a =
                metrics === null || metrics === void 0
                  ? void 0
                  : metrics.dataSubjectRequests.byStatus) === null || _a === void 0
                ? void 0
                : _a.pending) || 0}
            </div>
            <p className="text-xs text-muted-foreground">
              {(metrics === null || metrics === void 0
                ? void 0
                : metrics.dataSubjectRequests.total) || 0}{" "}
              total
            </p>
          </card_1.CardContent>
        </card_1.Card>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <badge_1.Badge
                    variant={
                      (automationStatus === null || automationStatus === void 0
                        ? void 0
                ...
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch
                    checked={
                      (automationStatus === null || automationStatus === void 0
                        ? void 0
                        : automationStatus.features.autoConsentManagement) || false
                    }
                    disabled
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch
                    checked={
                      (automationStatus === null || automationStatus === void 0
                        ? void 0
                        : automationStatus.features.autoDataSubjectRights) || false
                    }
                    disabled
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch
                    checked={
                      (automationStatus === null || automationStatus === void 0
                        ? void 0
                        : automationStatus.features.autoAuditReporting) || false
                    }
                    disabled
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch
                    checked={
                      (automationStatus === null || automationStatus === void 0
                        ? void 0
                        : automationStatus.features.autoAnonymization) || false
                    }
                    disabled
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch
                    checked={
                      (automationStatus === null || automationStatus === void 0
                        ? void 0
                        : automationStatus.features.realTimeMonitoring) || false
                    }
                    disabled
                  />
                </div>
        ...
        <tabs_1.TabsContent value="alerts" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>Alertas ativos que requerem atenção</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
              {alerts.length === 0
                ...
                : <div className="space-y-3">
                    {alerts.map(function (alert) {
                      return (
                        <alert_1.Alert key={alert.id} className="border-l-4 border-l-red-500">
        ...
        <tabs_1.TabsContent value="actions" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>Execute ações manuais de conformidade</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {(metrics === null || metrics === void 0 ? void 0 : metrics.consent.total) ||
                        0}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-green-600">
                      {(metrics === null || metrics === void 0 ? void 0 : metrics.consent.active) ||
                        0}
                    </span>
                  </div>
                  <div className="flex justify-between">
              ...
              <card_1.CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {(metrics === null || metrics === void 0 ? void 0 : metrics.audit.total) || 0}
                    </span>
                  </div>
                  {(metrics === null || metrics === void 0 ? void 0 : metrics.audit.bySeverity) &&
                    Object.entries(metrics.audit.bySeverity).map(function (_a) {
                      var severity = _a[0],
                        count = _a[1];
                      return (
