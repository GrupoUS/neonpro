...
function AutomationConfig() {
    ...
    var saveConfig = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          {hasChanges && (<badge_1.Badge variant="outline" className="text-yellow-600">
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          <div className="flex items-center justify-between">
            ...
            <switch_1.Switch id="automation-enabled" checked={config.enabled} onCheckedChange={function (checked) { return updateConfig('enabled', checked); }}/>
          </div>
        </card_1.CardContent>
      </card_1.Card>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <label_1.Label className="text-base font-medium">Automação Completa</label_1.Label>
                  <switch_1.Switch checked={config.schedules.fullAutomation.enabled} onCheckedChange={function (checked) {
            return updateConfig('schedules.fullAutomation.enabled', checked);
        }}/>
                </div>
                {config.schedules.fullAutomation.enabled && (<div className="grid gap-4 md:grid-cols-2">
                    <div>
                      <label_1.Label htmlFor="full-cron">Expressão Cron</label_1.Label>
                      <input_1.Input id="full-cron" value={config.schedules.fullAutomation.cron} onChange={function (e) {
                return updateConfig('schedules.fullAutomation.cron', e.target.value);
                    ...
                    <div>
                      ...
                      <select_1.Select value={config.schedules.fullAutomation.timezone} onValueChange={function (value) {
                return updateConfig('schedules.fullAutomation.timezone', value);
                        ...
                        <select_1.SelectContent>
                          <select_1.SelectItem value="America/Sao_Paulo">São Paulo (UTC-3)</select_1.SelectItem>
                          <select_1.SelectItem value="America/New_York">New York (UTC-5)</select_1.SelectItem>
                          <select_1.SelectItem value="Europe/London">London (UTC+0)</select_1.SelectItem>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <label_1.Label className="text-base font-medium">Gestão de Consentimentos</label_1.Label>
                    <p className="text-sm text-muted-foreground">
                      Verificação e atualização de consentimentos
                    </p>
                  </div>
                  <switch_1.Switch checked={config.schedules.consentManagement.enabled} onCheckedChange={function (checked) {
            return updateConfig('schedules.consentManagement.enabled', checked);
        }}/>
                </div>
                {config.schedules.consentManagement.enabled && (<div>
                    <label_1.Label htmlFor="consent-cron">Expressão Cron</label_1.Label>
                    <input_1.Input id="consent-cron" value={config.schedules.consentManagement.cron} onChange={function (e) {
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <label_1.Label className="text-base font-medium">Direitos dos Titulares</label_1.Label>
                    <p className="text-sm text-muted-foreground">
                      Processamento de solicitações de direitos
                    </p>
                  </div>
                  <switch_1.Switch checked={config.schedules.dataSubjectRights.enabled} onCheckedChange={function (checked) {
            return updateConfig('schedules.dataSubjectRights.enabled', checked);
        }}/>
                </div>
                {config.schedules.dataSubjectRights.enabled && (<div>
                    <label_1.Label htmlFor="rights-cron">Expressão Cron</label_1.Label>
                    <input_1.Input id="rights-cron" value={config.schedules.dataSubjectRights.cron} onChange={function (e) {
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <div className="grid gap-4">
                <div className="flex items-center justify-between">
                  <div>
                    <label_1.Label className="text-base font-medium">Gestão Automática de Consentimentos</label_1.Label>
                    <p className="text-sm text-muted-foreground">
                      Verificação e renovação automática de consentimentos
                    </p>
                  </div>
                  <switch_1.Switch checked={config.features.autoConsentManagement} onCheckedChange={function (checked) {
            return updateConfig('features.autoConsentManagement', checked);
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <label_1.Label className="text-base font-medium">Processamento de Direitos dos Titulares</label_1.Label>
                    <p className="text-sm text-muted-foreground">
                      Processamento automático de solicitações de direitos
                    </p>
                  </div>
                  <switch_1.Switch checked={config.features.autoDataSubjectRights} onCheckedChange={function (checked) {
            return updateConfig('features.autoDataSubjectRights', checked);
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <label_1.Label className="text-base font-medium">Relatórios de Auditoria Automáticos</label_1.Label>
                    <p className="text-sm text-muted-foreground">
                      Geração automática de relatórios de conformidade
                    </p>
                  </div>
                  <switch_1.Switch checked={config.features.autoAuditReporting} onCheckedChange={function (checked) {
            return updateConfig('features.autoAuditReporting', checked);
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <label_1.Label className="text-base font-medium">Anonimização Automática</label_1.Label>
                    <p className="text-sm text-muted-foreground">
                      Anonimização automática de dados antigos
                    </p>
                  </div>
                  <switch_1.Switch checked={config.features.autoAnonymization} onCheckedChange={function (checked) {
            return updateConfig('features.autoAnonymization', checked);
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <label_1.Label className="text-base font-medium">Monitoramento em Tempo Real</label_1.Label>
                    <p className="text-sm text-muted-foreground">
                      Monitoramento contínuo de conformidade
                    </p>
                  </div>
                  <switch_1.Switch checked={config.features.realTimeMonitoring} onCheckedChange={function (checked) {
            return updateConfig('features.realTimeMonitoring', checked);
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <label_1.Label className="text-base font-medium">Alertas Inteligentes</label_1.Label>
                    <p className="text-sm text-muted-foreground">
                      Sistema de alertas baseado em IA
                    </p>
                  </div>
                  <switch_1.Switch checked={config.features.smartAlerts} onCheckedChange={function (checked) {
        ...
        <tabs_1.TabsContent value="notifications" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <label_1.Label className="text-base font-medium">Notificações por Email</label_1.Label>
                  <switch_1.Switch checked={config.notifications.email.enabled} onCheckedChange={function (checked) {
            return updateConfig('notifications.email.enabled', checked);
        }}/>
                </div>
                {config.notifications.email.enabled && (<div className="space-y-4">
                    <div>
                      <label_1.Label htmlFor="email-recipients">Destinatários</label_1.Label>
                      <textarea_1.Textarea id="email-recipients" value={config.notifications.email.recipients.join('\n')} onChange={function (e) {
                return updateConfig('notifications.email.recipients', e.target.value.split('\n').filter(function (email) { return email.trim(); }));
            }} placeholder="admin@clinica.com\nresponsavel@clinica.com" rows={3}/>
                      <p className="text-xs text-muted-foreground mt-1">
                        Um email por linha
                      </p>
                    </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.notifications.webhook.enabled} onCheckedChange={function (checked) {
            return updateConfig('notifications.webhook.enabled', checked);
        }}/>
                </div>
                {config.notifications.webhook.enabled && (<div>
                    <label_1.Label htmlFor="webhook-url">URL do Webhook</label_1.Label>
                    <input_1.Input id="webhook-url" value={config.notifications.webhook.url} onChange={function (e) {
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  ...
                  <input_1.Input id="max-jobs" type="number" min="1" max="10" value={config.limits.maxConcurrentJobs} onChange={function (e) {
            return updateConfig('limits.maxConcurrentJobs', parseInt(e.target.value));
                ...
                <div>
                  ...
                  <input_1.Input id="job-timeout" type="number" min="300" max="7200" value={config.limits.jobTimeout} onChange={function (e) {
            return updateConfig('limits.jobTimeout', parseInt(e.target.value));
                ...
                <div>
                  ...
                  <input_1.Input id="retry-attempts" type="number" min="0" max="5" value={config.limits.retryAttempts} onChange={function (e) {
            return updateConfig('limits.retryAttempts', parseInt(e.target.value));
                ...
                <div>
                  ...
                  <input_1.Input id="batch-size" type="number" min="10" max="1000" value={config.limits.batchSize} onChange={function (e) {
