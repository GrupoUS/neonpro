...
function PatientDataProcessingTransparencyDashboard(_a) {
    var _this = this;
    var patientId = _a.patientId, _b = _a.viewMode, viewMode = _b === void 0 ? 'patient' : _b, _c = _a.className, className = _c === void 0 ? '' : _c;
    ...
    var loadTransparencyData = function () { return __awaiter(_this, void 0, void 0, function () {
        var mockData;
    ...
    var handleRightExercise = function (rightType) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
                // In production, this would call the privacy rights manager
                sonner_1.toast.success("Solicita\u00E7\u00E3o de ".concat(rightType, " enviada com sucesso"));
            }
            catch (error) {
    ...
    var exportTransparencyReport = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h2 className="text-2xl font-bold flex items-center gap-2">
            ...
            {viewMode === 'admin' && (<badge_1.Badge variant="outline">Visão Administrativa</badge_1.Badge>)}
          </h2>
          <p className="text-sm text-muted-foreground">
            Última atualização: {(0, date_fns_1.format)(dashboardData.lastUpdated, "dd/MM/yyyy 'às' HH:mm", { locale: locale_1.ptBR })}
          </p>
        </div>
        <div className="flex items-center gap-4">
          <div className="text-right">
            <div className="text-sm font-medium">Score de Transparência</div>
            <div className={"text-2xl font-bold ".concat(getScoreColor(dashboardData.overallTransparencyScore))}>
          ...
          <div className="flex gap-2">
            <button_1.Button variant="outline" size="sm" onClick={refreshData} disabled={refreshing}>
              {refreshing ? <lucide_react_1.Clock className="h-4 w-4"/> : <lucide_react_1.Activity className="h-4 w-4"/>}
              Atualizar
            </button_1.Button>
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <tabs_1.TabsContent value="overview" className="space-y-4">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-3">
                {dashboardData.recentActivities.slice(0, 5).map(function (activity, index) { return (<div key={index} className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      {getComplianceStatusIcon(activity.complianceStatus)}
                      <div>
                        <div className="font-medium">{activity.description}</div>
                        <div className="text-sm text-muted-foreground">
                          {(0, date_fns_1.format)(activity.timestamp, "dd/MM/yyyy 'às' HH:mm", { locale: locale_1.ptBR })}
                        </div>
                      </div>
                    </div>
                    <badge_1.Badge variant={activity.complianceStatus === 'compliant' ? 'default' : 'secondary'}>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {dashboardData.processingActivities.map(function (activity, index) { return (<div key={index} className="border rounded-lg p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2">
                        <badge_1.Badge variant={getScoreBadgeVariant(activity.complianceScore)} className={getRiskLevelColor(activity.riskLevel)}>
                ...
                activity.riskLevel === 'medium' ? 'Médio Risco' : 'Alto Risco'}
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="text-muted-foreground">
                          {(0, date_fns_1.format)(activity.lastActivity, "dd/MM/yyyy", { locale: locale_1.ptBR })}
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                    ...
                    {activity.canOptOut && (<div className="pt-2 border-t">
                        <button_1.Button variant="outline" size="sm" onClick={function () { return handleRightExercise('objection'); }}>
        ...
        <tabs_1.TabsContent value="sharing" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {dashboardData.thirdPartySharing.map(function (sharing, index) { return (<div key={index} className="border rounded-lg p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2">
                        <badge_1.Badge variant={sharing.status === 'active' ? 'default' : 'secondary'}>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="text-muted-foreground">
                          {(0, date_fns_1.format)(sharing.sharingDate, "dd/MM/yyyy", { locale: locale_1.ptBR })}
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="font-medium">Pode recusar:</span>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {sharing.safeguards.map(function (safeguard, i) { return (<badge_1.Badge key={i} variant="outline" className="text-xs">
                    ...
                    {sharing.canOptOut && (<div className="pt-2 border-t">
                        <button_1.Button variant="outline" size="sm" onClick={function () { return handleRightExercise('objection'); }}>
                          <lucide_react_1.Settings className="h-4 w-4 mr-2"/>
        ...
        <tabs_1.TabsContent value="rights" className="space-y-4">
          <card_1.Card>
            ...
            var rightKey = _a[0], right = _a[1];
            return (<div key={rightKey} className="border rounded-lg p-4 space-y-3">
                    <div className="flex items-center justify-between">
                    ...
                    {right.lastUsed && (<p className="text-xs text-muted-foreground">
                        Último uso: {(0, date_fns_1.format)(right.lastUsed, "dd/MM/yyyy", { locale: locale_1.ptBR })}
                      </p>)}

                    {right.available && (<button_1.Button variant="outline" size="sm" onClick={function () { return handleRightExercise(rightKey); }} className="w-full">
          ...
          <card_1.Card>
            ...
            var setting = _a[0], enabled = _a[1];
            return (<div key={setting} className="flex items-center justify-between">
                    <div>
        ...
        <tabs_1.TabsContent value="activities" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-3">
                {dashboardData.recentActivities.map(function (activity, index) { return (<div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center gap-3">
                      {getComplianceStatusIcon(activity.complianceStatus)}
                      <div>
                        <div className="font-medium">{activity.description}</div>
                        <div className="text-sm text-muted-foreground">
                          {(0, date_fns_1.format)(activity.timestamp, "dd/MM/yyyy 'às' HH:mm:ss", { locale: locale_1.ptBR })}
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      {viewMode === 'admin' && (<button_1.Button variant="ghost" size="sm">
