...
function ConsentWithdrawalManager(_a) {
    ...
    var _d = (0, react_1.useState)(null), withdrawing = _d[0], setWithdrawing = _d[1];
    var _e = (0, react_1.useState)(''), withdrawalReason = _e[0], setWithdrawalReason = _e[1];
    var _f = (0, react_1.useState)('all'), selectedConsentType = _f[0], setSelectedConsentType = _f[1];
    var _g = (0, react_1.useState)('active'), selectedStatus = _g[0], setSelectedStatus = _g[1];
    ...
    var fetchPatientConsents = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return (<div className="space-y-6">
      <card_1.Card>
        ...
        <card_1.CardContent>
          ...
          {consents.length === 0 ? (<alert_1.Alert>
              ...
              <table_1.TableBody>
                ...
                var _a, _b, _c, _d;
                return (<table_1.TableRow key={consent.id}>
                    <table_1.TableCell>
                      <div className="flex items-center gap-2">
                        <lucide_react_1.User className="h-4 w-4"/>
                        {((_a = consent.patient) === null || _a === void 0 ? void 0 : _a.full_name) || 'Unknown Patient'}
                      </div>
                    </table_1.TableCell>
                    <table_1.TableCell>
                      <badge_1.Badge variant="outline" className="capitalize">
                        {(_b = consent.consent_type) === null || _b === void 0 ? void 0 : _b.replace('_', ' ')}
                      </badge_1.Badge>
                    </table_1.TableCell>
                    <table_1.TableCell>
                      <div>
                        <div className="font-medium">{(_c = consent.consent_form) === null || _c === void 0 ? void 0 : _c.form_name}</div>
                        <div className="text-sm text-muted-foreground">
                          v{(_d = consent.consent_form) === null || _d === void 0 ? void 0 : _d.form_version}
                        </div>
                      </div>
                    </table_1.TableCell>
                    ...
                    <table_1.TableCell>
                      {consent.withdrawal_date ? (<div>
                          ...
                          {consent.withdrawal_reason && (<div className="text-xs text-muted-foreground mt-1">
                              {consent.withdrawal_reason}
                            </div>)}
                        </div>) : (<span className="text-muted-foreground">-</span>)}
                    </table_1.TableCell>
                    <table_1.TableCell>
                      {canWithdraw(consent) && (<dialog_1.Dialog>
                          <dialog_1.DialogTrigger asChild>
                            <button_1.Button variant="outline" size="sm" className="text-red-600 hover:text-red-700">
                          ...
                          <dialog_1.DialogContent>
                            ...
                            <div className="space-y-4">
                              <div>
                                <label_1.Label htmlFor="reason">Reason for Withdrawal (Required)</label_1.Label>
                                <textarea_1.Textarea id="reason" placeholder="Please provide a reason for withdrawing this consent..." value={withdrawalReason} onChange={function (e) { return setWithdrawalReason(e.target.value); }} rows={3}/>
                              </div>
                            </div>
                            ...
                            setWithdrawing(null);
                              ...
                              <button_1.Button variant="destructive" onClick={function () { return handleWithdrawConsent(consent.id); }} disabled={withdrawing === consent.id || !withdrawalReason.trim()}>
