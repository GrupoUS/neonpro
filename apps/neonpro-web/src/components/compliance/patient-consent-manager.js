...
function PatientConsentManager(_a) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [3 /*break*/, 4];
          case 2:
            return [4 /*yield*/, consentService.getClinicConsents(clinicId)];
          case 3:
            _a = _b.sent();
            _b.label = 4;
          case 4:
  ...
  var filteredConsents = consents.filter(function (consent) {
    ...
    var matchesSearch =
      ...
      ((_d = (_c = consent.patient) === null || _c === void 0 ? void 0 : _c.full_name) === null ||
      _d === void 0
        ? void 0
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <h4 className="font-semibold">
                            {(_a = consent.consent_form) === null || _a === void 0
                              ? void 0
                              : _a.form_name}
                          </h4>
                        ...
                        {!patientId && (
                          <p className="text-sm text-muted-foreground mb-2">
                            ...
                            <span className="font-medium">
                              {(_b = consent.patient) === null || _b === void 0
                                ? void 0
                                : _b.full_name}
                            </span>
                          </p>
