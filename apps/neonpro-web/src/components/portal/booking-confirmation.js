...
function BookingConfirmation(_a) {
    var service = _a.service, professional = _a.professional, timeSlot = _a.timeSlot, notes = _a.notes, onConfirm = _a.onConfirm, isLoading = _a.isLoading;
    ...
    return (<div className="space-y-6">
      ...
      <card_1.Card>
        ...
        <card_1.CardContent className="space-y-6">
          {/* Service Details */}
          {service && (<div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-4 text-xs text-muted-foreground">
                  ...
                  {service.price && (<span className="flex items-center gap-1 text-green-600">
          ...
          {professional && (<div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                {professional.license_number && (<p className="text-xs text-muted-foreground">
          ...
          {/* Date & Time */}
          {timeSlot && (<div className="flex items-start gap-3">
      ...
      <card_1.Card className="bg-primary/5">
        <card_1.CardContent className="p-6">
          <div className="text-center space-y-4">
            ...
            <button_1.Button onClick={onConfirm} disabled={isLoading} className="w-full md:w-auto px-8" size="lg">
              {isLoading ? (<>
