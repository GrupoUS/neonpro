...
function AppointmentNotes(_a) {
    var notes = _a.notes, onNotesChange = _a.onNotesChange, _b = _a.maxLength, maxLength = _b === void 0 ? 1000 : _b, serviceInstructions = _a.serviceInstructions;
    var t = (0, use_translation_1.useTranslation)().t;
    return (<div className="space-y-6">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-semibold text-foreground">
          {t('booking.steps.notes.title')}
        </h2>
        <p className="text-muted-foreground">
          {t('booking.notes.subtitle')}
        </p>
      </div>

      {serviceInstructions && (<alert_1.Alert>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <textarea_1.Textarea id="notes" placeholder={t('booking.notes.example')} value={notes} onChange={function (e) { return onNotesChange(e.target.value); }} maxLength={maxLength} className="min-h-32"/>
