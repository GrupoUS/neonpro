...
function PatientLoginForm(_a) {
    var _this = this;
    var initialClinicCode = _a.initialClinicCode, redirectUrl = _a.redirectUrl;
    var router = (0, navigation_1.useRouter)();
    var _b = (0, react_1.useState)(false), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(null), loginError = _c[0], setLoginError = _c[1];
    var _d = (0, react_1.useState)(false), showPWAFeatures = _d[0], setShowPWAFeatures = _d[1];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, patient_portal_auth_1.PatientPortalAuthService.authenticatePatient(data)];
                case 2:
                    response = _b.sent();
                    if (response.success && response.data) {
                        ...
                        setLoginError(((_a = response.error) === null || _a === void 0 ? void 0 : _a.message) || 'Erro ao fazer login');
                    }
                    return [3 /*break*/, 5];
                case 3:
                    error_1 = _b.sent();
    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <input_1.Input id="clinic_code" type="text" placeholder="Ex: CLINIC123" className="text-center font-mono uppercase" {...register('clinic_code')} onChange={function (e) {
      ...
      <div className="space-y-2">
        ...
        <select_1.Select value={loginType} onValueChange={function (value) { return setValue('login_type', value); }}>
      ...
      <div className="space-y-2">
        {loginType === 'email' && (<>
            ...
            <input_1.Input id="email" type="email" placeholder="seu@email.com" {...register('email')}/>
        ...
        {loginType === 'phone' && (<>
            ...
            <input_1.Input id="phone" type="tel" placeholder="(11) 99999-9999" {...register('phone')} onChange={function (e) {
        ...
        {loginType === 'document' && (<>
            ...
            <input_1.Input id="document_number" type="text" placeholder="000.000.000-00" {...register('document_number')} onChange={function (e) {
                var formatted = formatDocument(e.target.value);
                setValue('document_number', formatted);
            }}/>
            {errors.document_number && (<p className="text-sm text-red-600">{errors.document_number.message}</p>)}
          </>)}
      </div>

      {/* Remember Me */}
      <div className="flex items-center space-x-3">
        <switch_1.Switch id="remember_me" {...register('remember_me')} onCheckedChange={function (checked) { return setValue('remember_me', checked); }}/>
      ...
      {/* Error Message */}
      {loginError && (<div className="rounded-lg bg-red-50 border border-red-200 p-3">
          <p className="text-sm text-red-800">{loginError}</p>
        </div>)}

      {/* Submit Button */}
      <button_1.Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3" disabled={isLoading}>
        {isLoading ? (<div className="flex items-center space-x-2">
            <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
            <span>Entrando...</span>
          </div>) : ('Entrar no Portal')}
      </button_1.Button>

      {/* PWA Install Hint */}
      {showPWAFeatures && (<div className="text-center pt-4">
