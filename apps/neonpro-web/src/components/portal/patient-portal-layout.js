...
function PatientPortalLayout(_a) {
    var children = _a.children, patient = _a.patient, breadcrumbs = _a.breadcrumbs, title = _a.title, description = _a.description, className = _a.className;
    var _b = React.useState(false), isNavigationOpen = _b[0], setIsNavigationOpen = _b[1];
    var status = (patient === null || patient === void 0 ? void 0 : patient.account_status) || 'active';
    var statusInfo = statusConfig[status];
    return (<div className="min-h-screen bg-background">
      {/* Account Status Alert */}
      {patient && status !== 'active' && (<alert_1.Alert className="rounded-none border-l-0 border-r-0 border-t-0">
          ...
          <alert_1.AlertDescription>
            ...
            {status === 'suspended' && (<>
                Sua conta foi temporariamente suspensa. Entre em contato com a clínica para mais informações.
      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <patient_navigation_1.PatientNavigation patient={patient} className="w-80 lg:w-72 xl:w-80"/>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
              ...
              <div className="min-w-0 flex-1">
                {title && (<div className="mb-2">
                    <div className="flex items-center gap-3">
                      ...
                      {patient && (<badge_1.Badge variant={statusInfo.variant} className="flex items-center gap-1 text-xs">
          ...
          {/* Main Content */}
          <main className={(0, utils_1.cn)("flex-1 overflow-y-auto p-4 lg:p-6", "focus:outline-none", className)}>
