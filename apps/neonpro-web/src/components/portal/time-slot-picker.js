...
function TimeSlotPicker(_a) {
  var serviceId = _a.serviceId,
    ...
    selectedTimeSlot = _a.selectedTimeSlot,
    onTimeSlotSelect = _a.onTimeSlotSelect,
  ...
  var _c = (0, react_1.useState)(null),
    selectedRealtimeSlot = _c[0],
    setSelectedRealtimeSlot = _c[1];
      ...
      <card_1.CardContent className="space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <real_time_availability_1.RealTimeAvailability
              professionalId={professionalId}
              serviceId={serviceId}
        ...
        {selectedTimeSlot && (
          ...
          >
            ...
            <div className="flex items-center gap-4 text-sm">
              ...
              <span>
                {(0, date_fns_1.format)(new Date(selectedTimeSlot.start_time), "HH:mm")} às{" "}
                {(0, date_fns_1.format)(new Date(selectedTimeSlot.end_time), "HH:mm")}
              </span>
            </div>
          </framer_motion_1.motion.div>
        )}
