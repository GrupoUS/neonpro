...
var routeBreadcrumbs = {
  "/portal": [{ title: "Início" }],
  "/portal/appointments": [{ title: "Início", href: "/portal" }, { title: "Agendamentos" }],
  ...
  "/portal/history": [{ title: "Início", href: "/portal" }, { title: "Histórico" }],
  "/portal/payments": [{ title: "Início", href: "/portal" }, { title: "Pagamentos" }],
  "/portal/payments/[id]": [
    { title: "Início", href: "/portal" },
    { title: "Pagamentos", href: "/portal/payments" },
    { title: "Fatura" },
  ],
  "/portal/profile": [{ title: "Início", href: "/portal" }, { title: "Perfil" }],
  "/portal/profile/edit": [
    { title: "Início", href: "/portal" },
    { title: "Perfil", href: "/portal/profile" },
    { title: "Editar" },
  ],
  "/portal/contact": [{ title: "Início", href: "/portal" }, { title: "Contato" }],
  "/portal/help": [{ title: "Início", href: "/portal" }, { title: "Ajuda" }],
};
            ...
            return (
              <React.Fragment key={index}>
                <breadcrumb_1.BreadcrumbItem>
                  {isLast
                    ? <breadcrumb_1.BreadcrumbPage aria-current="page">
                        {item.title}
                    ...
                    : <breadcrumb_1.BreadcrumbLink asChild>
                        <link_1.default
                          ...
                          aria-label={"Ir para ".concat(item.title)}
                        >
                          {index === 0 && (
                            <lucide_react_1.Home
                ...
                {!isLast && (
                  <breadcrumb_1.BreadcrumbSeparator aria-hidden="true">
