...
function ProfessionalSelection(_a) {
  ...
  var _c = (0, react_1.useState)(true),
    isLoadingProfessionals = _c[0],
    setIsLoadingProfessionals = _c[1];
  var _d = (0, react_1.useState)("all"),
    selectedSpecialty = _d[0],
    setSelectedSpecialty = _d[1];
  var _e = (0, react_1.useState)(null),
    selectedProfessionalForModal = _e[0],
    setSelectedProfessionalForModal = _e[1];
                ...
                >
                  {(function () {
                    ...
                    if (
                      (selectedProfessional === null || selectedProfessional === void 0
                        ? void 0
                        : selectedProfessional.id) === selectedProfessionalForModal.id
                    ) {
