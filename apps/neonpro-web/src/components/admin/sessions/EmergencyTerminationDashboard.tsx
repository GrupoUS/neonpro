...
export function EmergencyTerminationDashboard({
  ...
  const handleExecuteProtocol = async (protocolId: string) => {
    try {
      ...
      if (result.success) {
        toast.success(
          `Protocolo executado com sucesso (${result.totalSuccessful} sessões terminadas)`,
        );
        await loadDashboardData();
      } else {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Controles rápidos para situações críticas</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" onClick={() => setShowProtocolDialog(true)}>
                    ...
                    <CardContent>
                      ...
                      {protocol.lastTriggered && (
                        <div className="mt-4 pt-4 border-t">
                          <span className="text-sm text-muted-foreground">
                            Última execução:{" "}
                            {format(protocol.lastTriggered, "dd/MM/yyyy HH:mm", { locale: ptBR })}
                          </span>
                        </div>
                      )}
                    </CardContent>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Histórico de terminações de sessão</CardDescription>
                </div>
                <Button
                  variant="outline"
                  size="sm"
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure as políticas de terminação de emergência</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                <Alert>
            ...
            <DialogTitle className="flex items-center">
              ...
              {terminationType === "all"
                ...
                : terminationType === "bulk"
                  ? `Terminar ${selectedSessions.length} Sessões`
                  : "Terminar Sessão"}
            </DialogTitle>
            <DialogDescription>
              {terminationType === "all"
