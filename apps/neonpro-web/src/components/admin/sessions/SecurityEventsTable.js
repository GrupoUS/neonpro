...
function SecurityEventsTable(_a) {
  ...
  var _b = (0, useSession_1.useSecurityEvents)(),
    resolveEvent = _b.resolveEvent,
    dismissEvent = _b.dismissEvent;
  ...
  var handleExportEvents = () => {
    ...
    a.href = url;
    a.download = "security-events-".concat(
  ...
  var getSeverityBadge = (severity) => {
    ...
    var _a = config[severity] || config.medium,
      variant = _a.variant,
      color = _a.color;
    return (
      <badge_1.Badge variant={variant} className={color}>
  ...
  var getEventTypeIcon = (eventType) => {
    ...
    var icons =
      ((_a = {}),
      (_a[session_1.SecurityEventType.UNUSUAL_LOCATION] = (
        <lucide_react_1.MapPin className="h-4 w-4" />
      )),
      (_a[session_1.SecurityEventType.DEVICE_CHANGE] = (
        <lucide_react_1.Monitor className="h-4 w-4" />
      )),
      (_a[session_1.SecurityEventType.RAPID_REQUESTS] = (
        <lucide_react_1.Clock className="h-4 w-4" />
      )),
      (_a[session_1.SecurityEventType.SESSION_HIJACK_ATTEMPT] = (
        <lucide_react_1.Shield className="h-4 w-4" />
      )),
      (_a[session_1.SecurityEventType.SUSPICIOUS_USER_AGENT] = (
        <lucide_react_1.Eye className="h-4 w-4" />
      )),
      (_a[session_1.SecurityEventType.CONCURRENT_SESSION_LIMIT] = (
        <lucide_react_1.AlertTriangle className="h-4 w-4" />
      )),
      (_a[session_1.SecurityEventType.FAILED_AUTHENTICATION] = (
        <lucide_react_1.XCircle className="h-4 w-4" />
      )),
      (_a[session_1.SecurityEventType.PRIVILEGE_ESCALATION] = (
        <lucide_react_1.Shield className="h-4 w-4" />
      )),
      _a);
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            {selectedEvents.length > 0 && (
              <button_1.Button variant="outline" size="sm" onClick={handleBulkResolve}>
