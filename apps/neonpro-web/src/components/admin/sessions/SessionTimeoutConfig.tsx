          ...
          {Object.entries(ROLE_LABELS).map(([role, label]) => {
            ...
            return (
              <TabsTrigger key={role} value={role} className="flex flex-col gap-1">
                <span>{label}</span>
                <Badge className={`text-xs ${securityLevel.color}`}>{securityLevel.level}</Badge>
              </TabsTrigger>
            );
          })}
        </TabsList>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor={`${role}-default-timeout`}>Timeout Padrão (minutos)</Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor={`${role}-max-timeout`}>Timeout Máximo (minutos)</Label>
                    <Input
                      id={`${role}-max-timeout`}
                      type="number"
                      min="1"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor={`${role}-grace-period`}>Período de Graça (minutos)</Label>
                    <Input
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleConfigChange(role as UserRole, "autoExtendEnabled", checked)
                    }
                  />
                </div>
