...
function BreachManagementPanel(_a) {
    ...
    var _b = (0, useLGPD_1.useBreachManagement)(), incidents = _b.incidents, isLoading = _b.isLoading, error = _b.error, reportIncident = _b.reportIncident, updateIncident = _b.updateIncident, exportIncidents = _b.exportIncidents, refreshData = _b.refreshData;
    ...
    var _f = (0, react_1.useState)(null), selectedIncident = _f[0], setSelectedIncident = _f[1];
    var _g = (0, react_1.useState)(false), isCreateOpen = _g[0], setIsCreateOpen = _g[1];
    var _h = (0, react_1.useState)(false), isEditOpen = _h[0], setIsEditOpen = _h[1];
    ...
    }), newIncident = _j[0], setNewIncident = _j[1];
    // Filtrar incidentes
    var filteredIncidents = (incidents === null || incidents === void 0 ? void 0 : incidents.filter(function (incident) {
        var _a, _b;
        var matchesSearch = ((_a = incident.title) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(searchTerm.toLowerCase())) ||
            ((_b = incident.description) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    var getSeverityBadge = function (severity) {
        switch (severity) {
            case 'low':
                return <badge_1.Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">Baixa</badge_1.Badge>;
            case 'medium':
                return <badge_1.Badge variant="outline" className="bg-yellow-50 text-yellow-700 border-yellow-200">Média</badge_1.Badge>;
            case 'high':
                return <badge_1.Badge variant="outline" className="bg-orange-50 text-orange-700 border-orange-200">Alta</badge_1.Badge>;
            case 'critical':
    ...
    var getStatusBadge = function (status) {
        switch (status) {
            case 'reported':
                return <badge_1.Badge variant="secondary"><lucide_react_1.Bell className="h-3 w-3 mr-1"/>Reportado</badge_1.Badge>;
            case 'investigating':
                return <badge_1.Badge variant="default"><lucide_react_1.Search className="h-3 w-3 mr-1"/>Investigando</badge_1.Badge>;
            case 'contained':
                return <badge_1.Badge variant="outline"><lucide_react_1.Shield className="h-3 w-3 mr-1"/>Contido</badge_1.Badge>;
            case 'resolved':
                return <badge_1.Badge variant="outline" className="bg-green-50 text-green-700"><lucide_react_1.CheckCircle className="h-3 w-3 mr-1"/>Resolvido</badge_1.Badge>;
            case 'closed':
                return <badge_1.Badge variant="outline"><lucide_react_1.XCircle className="h-3 w-3 mr-1"/>Fechado</badge_1.Badge>;
            default:
    ...
    var handleCreateIncident = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_1;
    ...
    var handleUpdateIncident = function (id, updates) { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var stats = {
        ...
        active: (incidents === null || incidents === void 0 ? void 0 : incidents.filter(function (i) { return !['resolved', 'closed'].includes(i.status); }).length) || 0,
        critical: (incidents === null || incidents === void 0 ? void 0 : incidents.filter(function (i) { return i.severity === 'critical'; }).length) || 0,
        thisMonth: (incidents === null || incidents === void 0 ? void 0 : incidents.filter(function (i) {
    ...
    return (<div className={className}>
            ...
            <dialog_1.DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input_1.Input id="title" value={newIncident.title} onChange={function (e) { return setNewIncident(__assign(__assign({}, newIncident), { title: e.target.value })); }} placeholder="Ex: Acesso não autorizado ao banco de dados"/>
                </div>
                
                <div>
                  <label_1.Label htmlFor="description">Descrição</label_1.Label>
                  <textarea_1.Textarea id="description" value={newIncident.description} onChange={function (e) { return setNewIncident(__assign(__assign({}, newIncident), { description: e.target.value })); }} placeholder="Descreva detalhadamente o incidente..." rows={3}/>
                </div>
                
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label_1.Label htmlFor="severity">Severidade</label_1.Label>
                    <select_1.Select value={newIncident.severity} onValueChange={function (value) {
            return setNewIncident(__assign(__assign({}, newIncident), { severity: value }));
        }}>
                  ...
                  <div>
                    ...
                    <input_1.Input id="count" type="number" value={newIncident.affected_individuals_count} onChange={function (e) { return setNewIncident(__assign(__assign({}, newIncident), { affected_individuals_count: parseInt(e.target.value) || 0 })); }} placeholder="0"/>
                  </div>
                </div>
                
                <div>
                  <label_1.Label htmlFor="discovery">Método de Descoberta</label_1.Label>
                  <input_1.Input id="discovery" value={newIncident.discovery_method} onChange={function (e) { return setNewIncident(__assign(__assign({}, newIncident), { discovery_method: e.target.value })); }} placeholder="Ex: Monitoramento de segurança, relatório de usuário"/>
                </div>
                
                <div>
                  <label_1.Label htmlFor="containment">Ações de Contenção</label_1.Label>
                  <textarea_1.Textarea id="containment" value={newIncident.containment_actions} onChange={function (e) { return setNewIncident(__assign(__assign({}, newIncident), { containment_actions: e.target.value })); }} placeholder="Descreva as ações tomadas para conter o incidente..." rows={2}/>
                </div>
              </div>
              <dialog_1.DialogFooter>
                <button_1.Button variant="outline" onClick={function () { return setIsCreateOpen(false); }}>
                  Cancelar
                </button_1.Button>
                <button_1.Button onClick={handleCreateIncident}>
                  Reportar Incidente
                </button_1.Button>
              </dialog_1.DialogFooter>
      ...
      {(incidents === null || incidents === void 0 ? void 0 : incidents.filter(function (i) { return i.severity === 'critical' && !['resolved', 'closed'].includes(i.status); }).length) > 0 && (<alert_1.Alert variant="destructive" className="mb-6">
          <lucide_react_1.AlertTriangle className="h-4 w-4"/>
          <alert_1.AlertDescription>
            <strong>Atenção:</strong> Existem {incidents.filter(function (i) { return i.severity === 'critical' && !['resolved', 'closed'].includes(i.status); }).length} incidente(s) crítico(s) que requerem atenção imediata.
          </alert_1.AlertDescription>
        </alert_1.Alert>)}
      ...
      <tabs_1.Tabs defaultValue="incidents" className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input_1.Input id="search" placeholder="Título ou descrição..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-8"/>
                  </div>
                </div>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <table_1.Table>
                ...
                <table_1.TableBody>
                  {filteredIncidents.map(function (incident) { return (<table_1.TableRow key={incident.id}>
                      <table_1.TableCell>
                        <div>
                          ...
                          <dialog_1.Dialog>
                            ...
                            <dialog_1.DialogContent className="max-w-4xl">
                              ...
                              <div className="space-y-6">
                                ...
                                {incident.affected_data_types && incident.affected_data_types.length > 0 && (<div>
                                    <label_1.Label>Tipos de Dados Afetados</label_1.Label>
                                    <div className="flex flex-wrap gap-2 mt-1">
                                      {incident.affected_data_types.map(function (type, index) { return (<badge_1.Badge key={index} variant="outline">{type}</badge_1.Badge>); })}
                                    </div>
                                  </div>)}
                                
                                {/* Método de descoberta */}
                                {incident.discovery_method && (<div>
                                    <label_1.Label>Método de Descoberta</label_1.Label>
                                    <p className="text-sm mt-1">{incident.discovery_method}</p>
                                  </div>)}
                                
                                {/* Ações de contenção */}
                                {incident.containment_actions && (<div>
                                ...
                                {/* Notificações */}
                                {incident.notifications && incident.notifications.length > 0 && (<div>
                                    <label_1.Label>Notificações Enviadas</label_1.Label>
                                    <div className="space-y-2 mt-1">
                                      {incident.notifications.map(function (notification, index) { return (<div key={index} className="text-sm bg-muted p-2 rounded flex items-center gap-2">
                                          {notification.type === 'email' ? <lucide_react_1.Mail className="h-4 w-4"/> : <lucide_react_1.Bell className="h-4 w-4"/>}
              ...
              {filteredIncidents.length === 0 && (<div className="text-center py-8 text-muted-foreground">
        ...
        <tabs_1.TabsContent value="timeline" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {incidents === null || incidents === void 0 ? void 0 : incidents.slice(0, 10).map(function (incident, index) { return (<div key={incident.id} className="flex items-start gap-4 pb-4 border-b last:border-b-0">
                    <div className="flex-shrink-0">
                      <div className={"w-3 h-3 rounded-full mt-2 ".concat(incident.severity === 'critical' ? 'bg-red-500' :
                ...
                {(incidents === null || incidents === void 0 ? void 0 : incidents.length) === 0 && (<div className="text-center py-8 text-muted-foreground">
      ...
      <dialog_1.Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <dialog_1.DialogContent>
          <dialog_1.DialogHeader>
            ...
            <dialog_1.DialogDescription>
              {selectedIncident === null || selectedIncident === void 0 ? void 0 : selectedIncident.title}
            </dialog_1.DialogDescription>
          </dialog_1.DialogHeader>
          {selectedIncident && (<div className="space-y-4">
              <div>
                <label_1.Label htmlFor="status">Novo Status</label_1.Label>
                <select_1.Select value={selectedIncident.status} onValueChange={function (value) {
                return setSelectedIncident(__assign(__assign({}, selectedIncident), { status: value }));
            }}>
                  <select_1.SelectTrigger>
          ...
          <dialog_1.DialogFooter>
            <button_1.Button variant="outline" onClick={function () { return setIsEditOpen(false); }}>
              Cancelar
            </button_1.Button>
            <button_1.Button onClick={function () { return selectedIncident && handleUpdateIncident(selectedIncident.id, {
