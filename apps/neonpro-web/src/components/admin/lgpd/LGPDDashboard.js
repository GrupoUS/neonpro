...
function LGPDDashboard(_a) {
  ...
  var _b = (0, useLGPD_1.useLGPDDashboard)(),
    metrics = _b.metrics,
    isLoading = _b.isLoading,
    error = _b.error,
    refreshMetrics = _b.refreshMetrics,
    exportReport = _b.exportReport;
  if (isLoading) {
    return (
  ...
  if (error) {
    return (
      <alert_1.Alert variant="destructive">
        ...
        <alert_1.AlertDescription>Erro ao carregar métricas: {error}</alert_1.AlertDescription>
      </alert_1.Alert>
    );
  }
  if (!metrics) {
    return (
      <alert_1.Alert>
        <lucide_react_1.AlertTriangle className="h-4 w-4" />
        <alert_1.AlertDescription>Nenhuma métrica disponível</alert_1.AlertDescription>
      </alert_1.Alert>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <card_1.Card>
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Conformidade Geral</card_1.CardTitle>
          ...
          <card_1.CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {metrics.totalUsers > 0 &&
                "".concat(
                  ((metrics.activeConsents / metrics.totalUsers) * 100).toFixed(1),
                  "% dos usu\u00E1rios",
                )}
            </p>
          </card_1.CardContent>
        ...
        <card_1.Card>
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Incidentes Ativos</card_1.CardTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Evolução dos consentimentos</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
