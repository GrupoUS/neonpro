...
function DataSubjectRightsPanel(_a) {
  ...
  var _b = (0, useLGPD_1.useDataSubjectRights)(),
    ...
    error = _b.error,
    updateRequest = _b.updateRequest,
    processRequest = _b.processRequest,
    exportRequests = _b.exportRequests,
  ...
  var _f = (0, react_1.useState)(null),
    selectedRequest = _f[0],
    setSelectedRequest = _f[1];
  var _g = (0, react_1.useState)(false),
    isProcessingOpen = _g[0],
    setIsProcessingOpen = _g[1];
    ...
    (requests === null || requests === void 0
      ...
      : requests.filter(function (request) {
          ...
          var matchesSearch =
            ...
            ((_b = request.request_type) === null || _b === void 0
              ? void 0
  ...
  if (error) {
    return (
      <alert_1.Alert variant="destructive">
        ...
        <alert_1.AlertDescription>Erro ao carregar solicitações: {error}</alert_1.AlertDescription>
      </alert_1.Alert>
    );
  }
  return (
                  ...
                  <table_1.TableRow key={request.id}>
                    ...
                    <table_1.TableCell>
                      <div className={getPriorityColor(request.created_at)}>
                        {daysRemaining > 0
                          ? "".concat(daysRemaining, " dias restantes")
        ...
        <dialog_1.DialogContent className="max-w-2xl">
          ...
          {selectedRequest && (
            <div className="space-y-4">
              ...
              <div>
                <label_1.Label htmlFor="admin_notes">
