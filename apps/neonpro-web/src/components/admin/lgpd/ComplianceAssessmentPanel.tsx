...
import type { useComplianceAssessment } from "@/hooks/useLGPD";
import type { ComplianceAssessment } from "@/types/lgpd";
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-2">
                  <span
                    className={`text-3xl font-bold ${getScoreColor(latestAssessment.score || 0)}`}
                  >
                              ...
                              {assessment.score !== null && (
                                <div>
                                  ...
                                  <div className="mt-2">
                                    <div className="flex items-center gap-2 mb-2">
                                      <span
                                        className={`text-2xl font-bold ${getScoreColor(assessment.score)}`}
                                      >
                                        {assessment.score}%
                                      </span>
                                      {getScoreBadge(assessment.score)}
        ...
        <TabsContent value="create" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure uma nova avaliação de conformidade LGPD</CardDescription>
            </CardHeader>
