...
function ConsentManagementPanel(_a) {
    ...
    var _b = (0, useLGPD_1.useConsentManagement)(), consents = _b.consents, purposes = _b.purposes, isLoading = _b.isLoading, error = _b.error, createPurpose = _b.createPurpose, updatePurpose = _b.updatePurpose, deletePurpose = _b.deletePurpose, updateConsent = _b.updateConsent, withdrawConsent = _b.withdrawConsent, exportConsents = _b.exportConsents, refreshData = _b.refreshData;
    ...
    var _e = (0, react_1.useState)('all'), purposeFilter = _e[0], setPurposeFilter = _e[1];
    var _f = (0, react_1.useState)(false), isCreatePurposeOpen = _f[0], setIsCreatePurposeOpen = _f[1];
    var _g = (0, react_1.useState)(null), editingPurpose = _g[0], setEditingPurpose = _g[1];
    var _h = (0, react_1.useState)({
        name: '',
        description: '',
        required: false,
        retention_period: 365
    }), newPurpose = _h[0], setNewPurpose = _h[1];
    // Filtrar consentimentos
    var filteredConsents = (consents === null || consents === void 0 ? void 0 : consents.filter(function (consent) {
        var _a, _b;
        var matchesSearch = ((_a = consent.user_email) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(searchTerm.toLowerCase())) ||
            ((_b = consent.purpose_name) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    var getStatusBadge = function (status) {
        switch (status) {
            case 'active':
                return <badge_1.Badge variant="default"><lucide_react_1.CheckCircle className="h-3 w-3 mr-1"/>Ativo</badge_1.Badge>;
            case 'expired':
                return <badge_1.Badge variant="secondary"><lucide_react_1.Clock className="h-3 w-3 mr-1"/>Expirado</badge_1.Badge>;
            case 'withdrawn':
                return <badge_1.Badge variant="outline"><lucide_react_1.XCircle className="h-3 w-3 mr-1"/>Retirado</badge_1.Badge>;
            default:
                return <badge_1.Badge variant="secondary">{status}</badge_1.Badge>;
        }
    };
    var handleCreatePurpose = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_1;
    ...
    var handleUpdatePurpose = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleWithdrawConsent = function (consentId) { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
      ...
      <tabs_1.Tabs defaultValue="consents" className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input_1.Input id="search" placeholder="Email ou finalidade..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-8"/>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select_1.Select value={purposeFilter} onValueChange={setPurposeFilter}>
                    ...
                    <select_1.SelectContent>
                      ...
                      {purposes === null || purposes === void 0 ? void 0 : purposes.map(function (purpose) { return (<select_1.SelectItem key={purpose.id} value={purpose.id}>
                          {purpose.name}
                        </select_1.SelectItem>); })}
                    </select_1.SelectContent>
                  </select_1.Select>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <table_1.Table>
                ...
                <table_1.TableBody>
                  {filteredConsents.map(function (consent) { return (<table_1.TableRow key={consent.id}>
                      <table_1.TableCell>
                        <div>
                      ...
                      <table_1.TableCell>
                        <div>
                          ...
                          {consent.purpose_required && (<badge_1.Badge variant="outline" className="text-xs">
                              Obrigatório
                            </badge_1.Badge>)}
                        </div>
                      </table_1.TableCell>
                      ...
                      <table_1.TableCell>
                        {consent.expires_at ? (<div className={"".concat(new Date(consent.expires_at) < new Date()
                    ? 'text-red-600'
                    : new Date(consent.expires_at) < new Date(Date.now() + 30 * 24 * 60 * 60 * 1000)
                        ? 'text-yellow-600'
                        : 'text-green-600')}>
                            {new Date(consent.expires_at).toLocaleDateString('pt-BR')}
                          </div>) : (<span className="text-muted-foreground">Sem expiração</span>)}
                      </table_1.TableCell>
                      <table_1.TableCell>
                      ...
                      <table_1.TableCell>
                        <div className="flex gap-2">
                          {consent.status === 'active' && (<button_1.Button size="sm" variant="outline" onClick={function () { return handleWithdrawConsent(consent.id); }}>
              ...
              {filteredConsents.length === 0 && (<div className="text-center py-8 text-muted-foreground">
        ...
        <tabs_1.TabsContent value="purposes" className="space-y-4">
              ...
              <dialog_1.DialogContent>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input_1.Input id="name" value={newPurpose.name} onChange={function (e) { return setNewPurpose(__assign(__assign({}, newPurpose), { name: e.target.value })); }} placeholder="Ex: Marketing por email"/>
                  </div>
                  <div>
                    <label_1.Label htmlFor="description">Descrição</label_1.Label>
                    <textarea_1.Textarea id="description" value={newPurpose.description} onChange={function (e) { return setNewPurpose(__assign(__assign({}, newPurpose), { description: e.target.value })); }} placeholder="Descreva como os dados serão utilizados..."/>
                  </div>
                  <div>
                    <label_1.Label htmlFor="retention">Período de Retenção (dias)</label_1.Label>
                    <input_1.Input id="retention" type="number" value={newPurpose.retention_period} onChange={function (e) { return setNewPurpose(__assign(__assign({}, newPurpose), { retention_period: parseInt(e.target.value) })); }}/>
                  </div>
                  <div className="flex items-center space-x-2">
                    <checkbox_1.Checkbox id="required" checked={newPurpose.required} onCheckedChange={function (checked) { return setNewPurpose(__assign(__assign({}, newPurpose), { required: !!checked })); }}/>
                    <label_1.Label htmlFor="required">Consentimento obrigatório</label_1.Label>
                  </div>
                </div>
                <dialog_1.DialogFooter>
                  <button_1.Button variant="outline" onClick={function () { return setIsCreatePurposeOpen(false); }}>
                    Cancelar
                  </button_1.Button>
                  <button_1.Button onClick={handleCreatePurpose}>
                    Criar Finalidade
                  </button_1.Button>
                </dialog_1.DialogFooter>
              </dialog_1.DialogContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {purposes === null || purposes === void 0 ? void 0 : purposes.map(function (purpose) { return (<card_1.Card key={purpose.id}>
                <card_1.CardHeader>
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-2">
                      <button_1.Button size="sm" variant="outline" onClick={function () { return setEditingPurpose(purpose); }}>
                        <lucide_react_1.Edit className="h-3 w-3"/>
                      </button_1.Button>
                      <button_1.Button size="sm" variant="outline" onClick={function () { return deletePurpose(purpose.id); }}>
          ...
          {/* Dialog de edição */}
          <dialog_1.Dialog open={!!editingPurpose} onOpenChange={function () { return setEditingPurpose(null); }}>
            <dialog_1.DialogContent>
              <dialog_1.DialogHeader>
              ...
              {editingPurpose && (<div className="space-y-4">
                  <div>
                    <label_1.Label htmlFor="edit-name">Nome</label_1.Label>
                    <input_1.Input id="edit-name" value={editingPurpose.name} onChange={function (e) { return setEditingPurpose(__assign(__assign({}, editingPurpose), { name: e.target.value })); }}/>
                  </div>
                  <div>
                    <label_1.Label htmlFor="edit-description">Descrição</label_1.Label>
                    <textarea_1.Textarea id="edit-description" value={editingPurpose.description} onChange={function (e) { return setEditingPurpose(__assign(__assign({}, editingPurpose), { description: e.target.value })); }}/>
                  </div>
                  <div>
                    <label_1.Label htmlFor="edit-retention">Período de Retenção (dias)</label_1.Label>
                    <input_1.Input id="edit-retention" type="number" value={editingPurpose.retention_period} onChange={function (e) { return setEditingPurpose(__assign(__assign({}, editingPurpose), { retention_period: parseInt(e.target.value) })); }}/>
                  </div>
                  <div className="flex items-center space-x-2">
                    <checkbox_1.Checkbox id="edit-required" checked={editingPurpose.required} onCheckedChange={function (checked) { return setEditingPurpose(__assign(__assign({}, editingPurpose), { required: !!checked })); }}/>
                    <label_1.Label htmlFor="edit-required">Consentimento obrigatório</label_1.Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <checkbox_1.Checkbox id="edit-active" checked={editingPurpose.active} onCheckedChange={function (checked) { return setEditingPurpose(__assign(__assign({}, editingPurpose), { active: !!checked })); }}/>
                    <label_1.Label htmlFor="edit-active">Finalidade ativa</label_1.Label>
                  </div>
                </div>)}
              <dialog_1.DialogFooter>
                <button_1.Button variant="outline" onClick={function () { return setEditingPurpose(null); }}>
                  Cancelar
                </button_1.Button>
                <button_1.Button onClick={handleUpdatePurpose}>
                  Salvar Alterações
                </button_1.Button>
              </dialog_1.DialogFooter>
            </dialog_1.DialogContent>
