...
function RoleManagement(_a) {
    ...
    var _b = (0, use_rbac_1.useRBAC)({ clinicId: clinicId }), hasPermission = _b.hasPermission, userRole = _b.userRole, rbacLoading = _b.isLoading;
    var supabase = (0, client_1.createClient)();
    // State
    var _c = (0, react_1.useState)([]), users = _c[0], setUsers = _c[1];
    var _d = (0, react_1.useState)([]), roles = _d[0], setRoles = _d[1];
    ...
    var _g = (0, react_1.useState)('all'), roleFilter = _g[0], setRoleFilter = _g[1];
    var _h = (0, react_1.useState)(false), showAssignDialog = _h[0], setShowAssignDialog = _h[1];
    var _j = (0, react_1.useState)(false), showCreateRoleDialog = _j[0], setShowCreateRoleDialog = _j[1];
    var _k = (0, react_1.useState)(null), selectedUser = _k[0], setSelectedUser = _k[1];
    var _l = (0, react_1.useState)({
        userId: '',
        roleId: ''
    }), assignmentForm = _l[0], setAssignmentForm = _l[1];
    // Check permissions
    var _m = (0, react_1.useState)(false), canManageRoles = _m[0], setCanManageRoles = _m[1];
    var _o = (0, react_1.useState)(false), canAssignRoles = _o[0], setCanAssignRoles = _o[1];
    var _p = (0, react_1.useState)(false), canViewUsers = _p[0], setCanViewUsers = _p[1];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error)
                        throw error;
                    usersWithRoles = data.map(function (assignment) { return ({
    ...
    var loadRoles = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var handleAssignRole = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, permissions_1.rbacManager.assignRole(assignmentForm.userId, assignmentForm.roleId, clinicId, {
    ...
    // Handle role removal
    var handleRemoveRole = function (userId) { return __awaiter(_this, void 0, void 0, function () {
        var error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var filteredUsers = users.filter(function (user) {
        var matchesSearch = user.full_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {canAssignRoles && (<dialog_1.Dialog open={showAssignDialog} onOpenChange={setShowAssignDialog}>
            ...
            <dialog_1.DialogContent>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select_1.Select value={assignmentForm.userId} onValueChange={function (value) { return setAssignmentForm(function (prev) { return (__assign(__assign({}, prev), { userId: value })); }); }}>
                    <select_1.SelectTrigger>
                      <select_1.SelectValue placeholder="Selecione um usuário"/>
                    </select_1.SelectTrigger>
                    <select_1.SelectContent>
                      {users.map(function (user) { return (<select_1.SelectItem key={user.id} value={user.id}>
                ...
                <div>
                  ...
                  <select_1.Select value={assignmentForm.roleId} onValueChange={function (value) { return setAssignmentForm(function (prev) { return (__assign(__assign({}, prev), { roleId: value })); }); }}>
                    <select_1.SelectTrigger>
                ...
                <div>
                  ...
                  <input_1.Input id="expires-at" type="datetime-local" value={assignmentForm.expiresAt || ''} onChange={function (e) { return setAssignmentForm(function (prev) { return (__assign(__assign({}, prev), { expiresAt: e.target.value })); }); }}/>
                </div>
                
                <div>
                  <label_1.Label htmlFor="notes">Notas (Opcional)</label_1.Label>
                  <input_1.Input id="notes" placeholder="Notas sobre a atribuição" value={assignmentForm.notes || ''} onChange={function (e) { return setAssignmentForm(function (prev) { return (__assign(__assign({}, prev), { notes: e.target.value })); }); }}/>
                </div>
              </div>
              
              <dialog_1.DialogFooter>
                <button_1.Button variant="outline" onClick={function () { return setShowAssignDialog(false); }}>
                  Cancelar
                </button_1.Button>
                <button_1.Button onClick={handleAssignRole}>
                  Atribuir
                </button_1.Button>
              </dialog_1.DialogFooter>
            </dialog_1.DialogContent>
      ...
      <tabs_1.Tabs defaultValue="users" className="space-y-4">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input_1.Input placeholder="Buscar usuários..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-8"/>
              </div>
            </div>
                  ...
                  {filteredUsers.map(function (user) { return (<table_1.TableRow key={user.id}>
                      ...
                      <table_1.TableCell>
                        <div className="flex items-center space-x-2">
                          {user.is_active ? (<lucide_react_1.CheckCircle className="h-4 w-4 text-green-500"/>) : (<lucide_react_1.Clock className="h-4 w-4 text-yellow-500"/>)}
                      ...
                      <table_1.TableCell>
                        {canAssignRoles && (<dropdown_menu_1.DropdownMenu>
                            ...
                            <dropdown_menu_1.DropdownMenuContent align="end">
                              ...
                              <dropdown_menu_1.DropdownMenuItem onClick={function () { return setSelectedUser(user); }}>
                    ...
                    setShowAssignDialog(true);
                              ...
                              <dropdown_menu_1.DropdownMenuSeparator />
                              <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleRemoveRole(user.id); }} className="text-destructive">
        ...
        <tabs_1.TabsContent value="roles">
          <RoleDefinitionsTab roles={roles} canManageRoles={canManageRoles} onRolesChange={loadRoles} clinicId={clinicId}/>
        </tabs_1.TabsContent>
...
function RoleDefinitionsTab(_a) {
    var roles = _a.roles, canManageRoles = _a.canManageRoles, onRolesChange = _a.onRolesChange, clinicId = _a.clinicId;
    return (<div className="space-y-4">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {roles.map(function (role) { return (<card_1.Card key={role.id}>
            <card_1.CardHeader>
            ...
            <card_1.CardContent>
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-1">
                  {role.permissions.slice(0, 3).map(function (permission) { return (<badge_1.Badge key={permission} variant="secondary" className="text-xs">
                      {permission}
                    </badge_1.Badge>); })}
                  {role.permissions.length > 3 && (<badge_1.Badge variant="secondary" className="text-xs">
...
function PermissionsTab(_a) {
    ...
    return (<div className="space-y-6">
      {Object.entries(rbac_1.PERMISSION_GROUPS).map(function (_a) {
            var groupName = _a[0], permissions = _a[1];
            return (<card_1.Card key={groupName}>
          <card_1.CardHeader>
            <card_1.CardTitle className="capitalize">{groupName.replace('_', ' ')}</card_1.CardTitle>
          ...
          <card_1.CardContent>
            <div className="space-y-4">
              {permissions.map(function (permission) { return (<div key={permission} className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                  ...
                  <div className="flex space-x-2">
                    {roles.map(function (role) { return (<badge_1.Badge key={role.id} variant={role.permissions.includes(permission) ? 'default' : 'outline'} className="text-xs">
                        {role.name}
                      </badge_1.Badge>); })}
                  </div>
                </div>); })}
