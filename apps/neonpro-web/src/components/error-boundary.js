        ...
        if (this.state.hasError) {
          ...
          <card_1.Card className="w-full max-w-2xl">
            ...
            <card_1.CardContent className="space-y-4">
              ...
              {process.env.NODE_ENV === 'development' && this.state.error && (<div className="bg-gray-100 p-4 rounded-lg">
...
function DashboardErrorBoundary(_a) {
    ...
    return (<ErrorBoundary fallback={<div className="p-6">
          <alert_1.Alert>
        ...
        </div>} onError={function (error, errorInfo) {
...
function FormErrorBoundary(_a) {
    var children = _a.children;
    return (<ErrorBoundary fallback={<alert_1.Alert>
          <lucide_react_1.AlertTriangle className="h-4 w-4"/>
          <alert_1.AlertDescription>
            Erro no formulário. Verifique os dados e tente novamente.
          </alert_1.AlertDescription>
        </alert_1.Alert>} onError={function (error, errorInfo) {
