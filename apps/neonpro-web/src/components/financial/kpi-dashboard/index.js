...
exports.validateKPIConfig =
  exports.createKPIDashboard =
  exports.services =
  exports.config =
  exports.ANIMATIONS =
  ...
  exports.filterAlerts =
  exports.sortKPIs =
  exports.getDateRangePreset =
  exports.getTrendColor =
  exports.getKPIStatusColor =
  exports.getKPIStatus =
  ...
  exports.formatDateRange =
  exports.formatDate =
  exports.formatNumber =
  exports.formatPercentage =
  exports.formatCurrency =
  exports.PerformanceService =
  exports.SupabaseKPIService =
  exports.FinancialKPIService =
  exports.useFinancialKPIs =
  exports.KPIDrillDown =
  exports.KPIFilters =
  exports.FinancialKPIDashboard =
    void 0;
exports.checkBrowserCompatibility =
  exports.FEATURES =
  exports.BUILD_DATE =
  exports.VERSION =
  exports.createChartConfig =
  exports.createAlertRule =
    void 0;
// Main Components
...
var createKPIDashboard = (_a) => {
  var containerId = _a.containerId,
    ...
    _c = _a.enableRealtime,
    enableRealtime = _c === void 0 ? true : _c,
    _d = _a.enableExport,
    enableExport = _d === void 0 ? true : _d,
    _e = _a.enableSharing,
    enableSharing = _e === void 0 ? true : _e,
    _f = _a.customConfig,
...
var createAlertRule = (_a) => {
  var kpiId = _a.kpiId,
    ...
    _b = _a.severity,
    severity = _b === void 0 ? "warning" : _b,
    _c = _a.notifications,
    notifications = _c === void 0 ? { email: true, sms: false, push: true } : _c;
  return {
...
var createChartConfig = (_a) => {
  var type = _a.type,
    ...
    xAxisLabel = _a.xAxisLabel,
    yAxisLabel = _a.yAxisLabel,
    series = _a.series,
    _b = _a.colors,
    colors = _b === void 0 ? CHART_COLORS : _b;
  return {
    type: type,
    title: title,
    subtitle: subtitle,
