...
// Default filters
var getDefaultFilters = function () { return ({
    dateRange: {
...
var generateKPIAlerts = function (kpi) {
    ...
    if (kpi.target) {
        ...
        if (targetAchievement < 70) {
            alerts.push({
                ...
                type: 'critical',
                message: "".concat(kpi.name, " est\u00E1 ").concat((100 - targetAchievement).toFixed(1), "% abaixo da meta"),
    ...
    if (kpi.trend === 'down' && Math.abs(kpi.changePercentage) > 10) {
        alerts.push({
            ...
            type: 'warning',
            message: "".concat(kpi.name, " apresenta queda de ").concat(Math.abs(kpi.changePercentage).toFixed(1), "%"),
...
function useFinancialKPIs(_a) {
    var _this = this;
    var clinicId = _a.clinicId, _b = _a.autoRefresh, autoRefresh = _b === void 0 ? true : _b, _c = _a.refreshInterval, refreshInterval = _c === void 0 ? 30 : _c, _d = _a.enableRealTime, enableRealTime = _d === void 0 ? false : _d, _e = _a.enableBenchmarks, enableBenchmarks = _e === void 0 ? true : _e, _f = _a.enableForecasting, enableForecasting = _f === void 0 ? true : _f, _g = _a.cacheTimeout, cacheTimeout = _g === void 0 ? 5 : _g;
    // State
    var _h = (0, react_1.useState)([]), kpis = _h[0], setKpis = _h[1];
    ...
    var _m = (0, react_1.useState)(null), lastUpdated = _m[0], setLastUpdated = _m[1];
    var _o = (0, react_1.useState)(getDefaultFilters()), filters = _o[0], setFilters = _o[1];
    var _p = (0, react_1.useState)(new Map()), cache = _p[0], setCache = _p[1];
    // Fetch financial data from Supabase
    var fetchFinancialData = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, start, end, cacheKey, cached, _b, appointments, appointmentsError, _c, expenses, expensesError, totalRevenue, totalExpenses, netProfit, grossMargin, uniquePatients, averageTicket, calculatedMetrics, err_1;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _a = filters.dateRange, start = _a.start, end = _a.end;
                    cacheKey = "financial-data-".concat(clinicId, "-").concat((0, date_fns_1.format)(start, 'yyyy-MM-dd'), "-").concat((0, date_fns_1.format)(end, 'yyyy-MM-dd'));
                ...
                case 3:
                    ...
                    if (expensesError)
                        throw expensesError;
                    totalRevenue = (appointments === null || appointments === void 0 ? void 0 : appointments.reduce(function (sum, apt) { return sum + (apt.total_amount || 0); }, 0)) || 0;
                    totalExpenses = (expenses === null || expenses === void 0 ? void 0 : expenses.reduce(function (sum, exp) { return sum + (exp.amount || 0); }, 0)) || 0;
                    netProfit = totalRevenue - totalExpenses;
                    grossMargin = totalRevenue > 0 ? ((totalRevenue - totalExpenses) / totalRevenue) * 100 : 0;
                    uniquePatients = new Set(appointments === null || appointments === void 0 ? void 0 : appointments.map(function (apt) { var _a; return (_a = apt.patient) === null || _a === void 0 ? void 0 : _a.id; })).size || 0;
    ...
    var fetchComparisonData = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, start, end, periodLength, comparisonStart, comparisonEnd, tempFilters, originalFilters, comparisonMetrics, err_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    tempFilters = __assign(__assign({}, filters), { dateRange: __assign(__assign({}, filters.dateRange), { start: comparisonStart, end: comparisonEnd }) });
    ...
    var generateKPIs = (0, react_1.useCallback)(function (currentMetrics, previousMetrics) { return __awaiter(_this, void 0, void 0, function () {
        var kpiList;
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, kpiList.map(function (kpi) { return (__assign(__assign({}, kpi), { alerts: generateKPIAlerts(kpi) })); })];
        });
    }); }, []);
    // Main data loading function
    var loadKPIData = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    err_3 = _b.sent();
                    setError(err_3 instanceof Error ? err_3.message : 'Erro ao carregar dados financeiros');
    ...
    // Refresh function
    var refreshKPIs = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    // Acknowledge alert
    var acknowledgeAlert = (0, react_1.useCallback)(function (alertId) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            setKpis(function (prev) { return prev.map(function (kpi) {
                var _a;
                return (__assign(__assign({}, kpi), { alerts: (_a = kpi.alerts) === null || _a === void 0 ? void 0 : _a.map(function (alert) {
    ...
    // Export data
    var exportData = (0, react_1.useCallback)(function (format) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    // Get KPI history
    var getKPIHistory = (0, react_1.useCallback)(function (kpiId, days) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    // Computed values
    var getKPIsByCategory = (0, react_1.useCallback)(function (category) {
        return kpis.filter(function (kpi) { return kpi.category === category; });
    }, [kpis]);
    var getTrendAnalysis = (0, react_1.useCallback)(function () {
        var trends = {
            improving: kpis.filter(function (kpi) { return kpi.trend === 'up'; }).length,
            declining: kpis.filter(function (kpi) { return kpi.trend === 'down'; }).length,
            stable: kpis.filter(function (kpi) { return kpi.trend === 'stable'; }).length
        };
        return __assign(__assign({}, trends), { total: kpis.length, overallTrend: trends.improving > trends.declining ? 'positive' :
                trends.declining > trends.improving ? 'negative' : 'neutral' });
    }, [kpis]);
    var getPerformanceScore = (0, react_1.useCallback)(function () {
        if (kpis.length === 0)
            return 0;
    ...
    var getBenchmarkComparison = (0, react_1.useCallback)(function () {
        var benchmarkedKPIs = kpis.filter(function (kpi) { return kpi.benchmarkData; });
        if (benchmarkedKPIs.length === 0)
            return null;
        var avgPercentile = benchmarkedKPIs.reduce(function (sum, kpi) {
            var _a;
            return sum + (((_a = kpi.benchmarkData) === null || _a === void 0 ? void 0 : _a.percentile) || 50);
        }, 0) / benchmarkedKPIs.length;
        return {
            averagePercentile: avgPercentile,
            aboveIndustryAverage: benchmarkedKPIs.filter(function (kpi) { var _a; return kpi.value > (((_a = kpi.benchmarkData) === null || _a === void 0 ? void 0 : _a.industryAverage) || 0); }).length,
