...
function FinancialKPIDashboard(_a) {
  ...
  var _h = (0, react_1.useState)(true),
    autoRefresh = _h[0],
    setAutoRefresh = _h[1];
  var _j = (0, react_1.useState)(30),
    refreshInterval = _j[0],
    setRefreshInterval = _j[1]; // seconds
  var _k = (0, react_1.useState)(false),
    isCustomizing = _k[0],
    setIsCustomizing = _k[1];
  ...
  return (
    <div className={"space-y-6 ".concat(className)}>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Última atualização:{" "}
            {(0, date_fns_1.format)(lastUpdated, "dd/MM/yyyy 'às' HH:mm", {
      ...
      {selectedKPI && (
        <card_1.Card className="fixed inset-4 z-50 bg-background shadow-lg">
