  ...
  return (
    <div
      className={(0, utils_1.cn)(
        "h-64 bg-muted/20 rounded-lg flex items-center justify-center",
        className,
      )}
    >
...
function FinancialDashboard(_a) {
  ...
  var _g = (0, react_1.useState)(true),
    autoRefresh = _g[0],
    setAutoRefresh = _g[1];
  var _h = (0, react_1.useState)("30d"),
    selectedTimeframe = _h[0],
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                dashboardEngine.getDashboardData(clinicId, {
  ...
  var getTrendIcon = (trend) => {
    switch (trend) {
      ...
      case "down":
        return <lucide_react_1.ArrowDown className="h-4 w-4 text-red-500" />;
      case "stable":
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            Última atualização:{" "}
            {lastUpdated === null || lastUpdated === void 0
              ? void 0
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex items-center text-xs text-muted-foreground">
              ...
              <span className="ml-1">
                {(0, formatters_1.formatPercentage)(
                  Math.abs(dashboardData.metrics.revenue_growth.monthly),
                )}{" "}
                vs mês anterior
              </span>
            </div>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <div className="flex items-center text-xs text-muted-foreground">
              <span>
                Margem: {(0, formatters_1.formatPercentage)(dashboardData.metrics.net_margin)}
              </span>
            </div>
          </card_1.CardContent>
        </card_1.Card>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <div className="flex items-center text-xs text-muted-foreground">
              ...
              <span className="ml-1">
                {(0, formatters_1.formatCurrency)(Math.abs(dashboardData.cash_flow.net_cash_flow))}{" "}
                hoje
              </span>
            </div>
          </card_1.CardContent>
            ...
            <card_1.Card className="col-span-1">
              ...
              <card_1.CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <progress_1.Progress
                    value={dashboardData.performance_indicators.financial_health_score}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <progress_1.Progress
                    value={dashboardData.performance_indicators.efficiency_score}
                  />
                </div>
