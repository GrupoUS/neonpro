...
function FinancialReportingDashboard(_a) {
  ...
  var _e = (0, react_1.useState)(false),
    refreshing = _e[0],
    setRefreshing = _e[1];
  var _f = (0, react_1.useState)("current_month"),
    selectedPeriod = _f[0],
  ...
  if (loading) {
    return (
      <div className={"space-y-8 ".concat(className)}>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <div
              className={"flex items-center text-xs ".concat(
                getTrendColor(
          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <progress_1.Progress
                  value={Math.max(0, dashboardData.charts_data.kpi_dashboard.net_margin)}
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <progress_1.Progress
                  value={dashboardData.charts_data.kpi_dashboard.debt_ratio * 100}
                />
              </div>
            </div>
          </div>
