...
function PaymentManager(_a) {
    var _this = this;
    var invoiceId = _a.invoiceId, _b = _a.defaultView, defaultView = _b === void 0 ? "list" : _b, selectedPaymentId = _a.selectedPaymentId;
    var router = (0, navigation_1.useRouter)();
    // State Management
    var _c = (0, react_1.useState)(defaultView), activeTab = _c[0], setActiveTab = _c[1];
    var _d = (0, react_1.useState)([]), payments = _d[0], setPayments = _d[1];
    var _e = (0, react_1.useState)(null), selectedPayment = _e[0], setSelectedPayment = _e[1];
    ...
    var loadPayments = function () { return __awaiter(_this, void 0, void 0, function () {
        var result, error_1;
    ...
    var loadPaymentDetails = function (paymentId) { return __awaiter(_this, void 0, void 0, function () {
        var result, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    // Handlers
    var handleCreatePayment = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, 3, 4]);
                    setLoading(true);
                    paymentData = __assign(__assign({}, formData), { invoice_id: invoiceId || formData.invoice_id || "" });
    ...
    var handleUpdateStatus = function (paymentId, status) { return __awaiter(_this, void 0, void 0, function () {
        var error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var filteredPayments = payments.filter(function (payment) {
        var _a, _b;
        return ((_a = payment.external_transaction_id) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(searchTerm.toLowerCase())) ||
            ((_b = payment.authorization_code) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(searchTerm.toLowerCase())) ||
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          <tabs_1.Tabs value={activeTab} onValueChange={function (value) { return setActiveTab(value); }}>
            ...
            <tabs_1.TabsContent value="list" className="space-y-4">
              <div className="flex items-center space-x-2">
                <div className="relative flex-1">
                  ...
                  <input_1.Input placeholder="Buscar pagamentos..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-8"/>
                </div>
                <button_1.Button onClick={function () { return setActiveTab("create"); }}>
              ...
              <div className="space-y-2">
                {loading ? (<div className="text-center py-8">Carregando...</div>) : filteredPayments.length === 0 ? (<div className="text-center py-8 text-muted-foreground">
                    Nenhum pagamento encontrado
                  </div>) : (filteredPayments.map(function (payment) { return (<card_1.Card key={payment.id} className="p-4">
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          ...
                          {payment.external_transaction_id && (<div className="text-sm text-muted-foreground">
                              ID: {payment.external_transaction_id}
                            </div>)}
                          {payment.processed_at && (<div className="text-sm text-muted-foreground">
                              Processado:{" "}
            ...
            <tabs_1.TabsContent value="create" className="space-y-4">
              <div className="grid gap-4">
                <div className="grid gap-2">
                  ...
                  <input_1.Input id="invoice_id" placeholder="ID da fatura" value={formData.invoice_id || ""} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { invoice_id: e.target.value }));
        }} disabled={!!invoiceId}/>
                </div>
            ...
            return setFormData(__assign(__assign({}, formData), { payment_method: value }));
        }}>
                ...
                <div className="grid gap-2">
                  ...
                  <input_1.Input id="amount" type="number" step="0.01" placeholder="0.00" value={formData.amount || ""} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { amount: parseFloat(e.target.value) || 0 }));
                ...
                <div className="grid gap-2">
                  ...
                  <input_1.Input id="external_transaction_id" placeholder="ID da transação do processador" value={formData.external_transaction_id || ""} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { external_transaction_id: e.target.value }));
        }}/>
                </div>

                <div className="grid gap-2">
                  <label_1.Label htmlFor="authorization_code">
                    Código de Autorização
                  </label_1.Label>
                  <input_1.Input id="authorization_code" placeholder="Código de autorização" value={formData.authorization_code || ""} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { authorization_code: e.target.value }));
        }}/>
                </div>
              </div>
              ...
              <div className="flex justify-end space-x-2">
                <button_1.Button variant="outline" onClick={function () { return setActiveTab("list"); }}>
                  Cancelar
                </button_1.Button>
            ...
            <tabs_1.TabsContent value="edit" className="space-y-4">
              {selectedPayment && (<div className="grid gap-4">
                  <div className="grid gap-2">
                  ...
                  <div className="grid gap-2">
                    ...
                    <select_1.Select value={formData.status} onValueChange={function (value) {
                return setFormData(__assign(__assign({}, formData), { status: value }));
                  ...
                  <div className="grid gap-2">
                    ...
                    <input_1.Input id="edit_external_transaction_id" value={formData.external_transaction_id || ""} onChange={function (e) {
                return setFormData(__assign(__assign({}, formData), { external_transaction_id: e.target.value }));
            }}/>
                  </div>
                  ...
                  <div className="grid gap-2">
                    ...
                    <input_1.Input id="edit_authorization_code" value={formData.authorization_code || ""} onChange={function (e) {
                return setFormData(__assign(__assign({}, formData), { authorization_code: e.target.value }));
            }}/>
                  </div>
                </div>)}
