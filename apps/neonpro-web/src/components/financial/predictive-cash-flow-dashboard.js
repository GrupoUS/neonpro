...
function PredictiveCashFlowDashboard(_a) {
  ...
  var _g = (0, react_1.useState)(""),
    selectedModel = _g[0],
    setSelectedModel = _g[1];
  var _h = (0, react_1.useState)("monthly"),
    selectedPeriod = _h[0],
    setSelectedPeriod = _h[1];
  var _j = (0, react_1.useState)(""),
    selectedScenario = _j[0],
    setSelectedScenario = _j[1];
  var _k = (0, react_1.useState)({
      startDate: new Date().toISOString().split("T")[0],
      endDate: new Date(Date.now() + 90 * 24 * 60 * 60 * 1000).toISOString().split("T")[0], // 3 months
    }),
    forecastRange = _k[0],
    setForecastRange = _k[1];
  // =====================================================================================
  // DATA LOADING
  // =====================================================================================
          ...
          switch (_d.label) {
            case 0:
              ...
              return [
                ...
                Promise.all([
                  fetch(
                    "/api/financial/predictive-cash-flow/predictions?clinicId=".concat(
                      clinicId,
                      "&limit=50",
                    ),
                  ),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch("/api/financial/predictive-cash-flow/predictions", {
                method: "POST",
          ...
          case 3:
            ...
            (0, use_toast_1.toast)({
              ...
              description: "Previs\u00E3o de fluxo de caixa gerada com ".concat(
                result.prediction.confidence_score.toFixed(1),
                "% de confian\u00E7a.",
              ),
            });
            // Reload predictions
                      ...
                      {models.map(function (model) {
                        ...
                        return (
                          <select_1.SelectItem key={model.id} value={model.id}>
                            {model.name} (
                            {(_a = model.accuracy_rate) === null || _a === void 0
                              ? void 0
                              : _a.toFixed(1)}
                            %)
                          </select_1.SelectItem>
                    ...
                    <div key={model.id} className="p-4 border rounded-lg">
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <badge_1.Badge
                            variant={model.is_production_ready ? "default" : "secondary"}
                          >
                            {model.is_production_ready ? "Produção" : "Desenvolvimento"}
                          </badge_1.Badge>
                          {model.is_active && (
                            <badge_1.Badge variant="outline">Ativo</badge_1.Badge>
                          )}
                        </div>
