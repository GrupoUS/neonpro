...
function AlertManager(_a) {
  ...
  var _b = (0, react_1.useState)("active"),
    selectedTab = _b[0],
    setSelectedTab = _b[1];
  var _c = (0, react_1.useState)(),
    filterSeverity = _c[0],
    setFilterSeverity = _c[1];
  var _d = (0, react_1.useState)(),
    filterType = _d[0],
    setFilterType = _d[1];
  var _e = (0, use_alert_system_1.useFinancialAlerts)(filterSeverity, filterType),
    alerts = _e.alerts,
    isLoading = _e.isLoading,
    refetch = _e.refetch;
  var _f = (0, use_alert_system_1.useAlertResolution)(),
    resolveAlert = _f.resolveAlert,
    isResolving = _f.isResolving;
  var statistics = (0, use_alert_system_1.useAlertStatistics)(30).statistics;
  var _g = (0, use_alert_system_1.useRealTimeAlerts)(),
  ...
  var getSeverityIcon = function (severity) {
    switch (severity) {
      ...
      case "info":
        return <lucide_react_1.Bell className="h-4 w-4 text-blue-600" />;
      default:
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold">
                  {(
                    statistics === null || statistics === void 0
                      ? void 0
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            >
              ...
              <select_1.SelectContent>
                ...
                <select_1.SelectItem value="negative_cash_flow">
                  Cash Flow Negativo
                </select_1.SelectItem>
                <select_1.SelectItem value="high_expenses">Despesas Altas</select_1.SelectItem>
                <select_1.SelectItem value="budget_exceeded">
                  Orçamento Excedido
                </select_1.SelectItem>
              </select_1.SelectContent>
            </select_1.Select>
          ...
          <tabs_1.Tabs value={selectedTab} onValueChange={setSelectedTab}>
            <tabs_1.TabsList>
              <tabs_1.TabsTrigger value="active">Ativos ({activeAlerts.length})</tabs_1.TabsTrigger>
...
function AlertCard(_a) {
  ...
  return (
    <card_1.Card className={"".concat(isResolved ? "opacity-60" : "")}>
      <card_1.CardContent className="p-6">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center space-x-2 mb-2">
              ...
              {isResolved && (
                <badge_1.Badge className="bg-green-100 text-green-800 border-green-300">
                  RESOLVIDO
                </badge_1.Badge>
              )}
            </div>
          ...
          {!isResolved && onResolve && (
            <dialog_1.Dialog open={showResolveDialog} onOpenChange={setShowResolveDialog}>
              <dialog_1.DialogTrigger asChild>
                <button_1.Button size="sm">Resolver</button_1.Button>
...
function CreateAlertRuleDialog(_a) {
  ...
  var _b = (0, react_1.useState)(false),
    open = _b[0],
    setOpen = _b[1];
  var _c = (0, use_alert_system_1.useAlertRuleCreation)(),
    createRule = _c.createRule,
    isCreating = _c.isCreating;
  var _d = (0, use_alert_system_1.useAlertRuleTemplates)(),
    templates = _d.templates,
    createFromTemplate = _d.createFromTemplate;
  var _e = (0, react_1.useState)(""),
    selectedTemplate = _e[0],
    setSelectedTemplate = _e[1];
...
function AlertSettingsDialog() {
  var _a = (0, react_1.useState)(false),
    open = _a[0],
    setOpen = _a[1];
  var _b = (0, use_alert_system_1.useAlertChannelConfig)(),
    config = _b.config,
    updateChannelConfig = _b.updateChannelConfig;
  return (
    <dialog_1.Dialog open={open} onOpenChange={setOpen}>
      <dialog_1.DialogTrigger asChild>
