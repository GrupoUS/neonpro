...
export function PredictiveCashFlowDashboard({ clinicId }: PredictiveCashFlowDashboardProps) {
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      if (modelsRes.ok) {
        ...
        const bestModel =
          modelsData.models?.find((m: PredictionModel) => m.is_production_ready) ||
          modelsData.models?.[0];
        if (bestModel) {
  ...
  const calculateMetrics = () => {
    ...
    const totalPredictedInflow = recentPredictions.reduce(
      (sum, p) => sum + p.predicted_inflow_amount,
      0,
    );
    const totalPredictedOutflow = recentPredictions.reduce(
        ...
        <TabsContent value="forecast" className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setSelectedPeriod(value as PredictionPeriodType)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setForecastRange((prev) => ({ ...prev, startDate: e.target.value }))
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setForecastRange((prev) => ({ ...prev, endDate: e.target.value }))
                    }
                  />
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Histórico das últimas previsões geradas</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <div className="text-sm text-muted-foreground">
                        Entrada: {formatCurrency(prediction.predicted_inflow_amount)} | Saída:{" "}
                        {formatCurrency(prediction.predicted_outflow_amount)}
                      </div>
                    </div>
        ...
        <TabsContent value="scenarios" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Compare diferentes cenários de previsão financeira</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
        ...
        <TabsContent value="models" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Gerencie e monitore os modelos de predição</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {models.map((model) => (
                  <div key={model.id} className="p-4 border rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        {model.is_active && <Badge variant="outline">Ativo</Badge>}
                      </div>
                    ...
                    <div className="grid gap-2 text-sm text-muted-foreground">
                      <div>
                        Tipo: {model.model_type} | Algoritmo: {model.algorithm_type}
                      </div>
                      <div>
                        Versão: {model.version} | Última atualização:{" "}
        ...
        <TabsContent value="accuracy" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monitore a precisão e performance dos modelos de IA</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
