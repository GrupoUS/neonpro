...
function IntelligentInvoicing(_a) {
    var _this = this;
    var patientId = _a.patientId, appointmentId = _a.appointmentId, onInvoiceGenerated = _a.onInvoiceGenerated;
    var _b = (0, react_1.useState)(null), patient = _b[0], setPatient = _b[1];
    var _c = (0, react_1.useState)(null), selectedTemplate = _c[0], setSelectedTemplate = _c[1];
    var _d = (0, react_1.useState)([]), invoiceItems = _d[0], setInvoiceItems = _d[1];
    var _e = (0, react_1.useState)(), dueDate = _e[0], setDueDate = _e[1];
    var _f = (0, react_1.useState)(0), discount = _f[0], setDiscount = _f[1];
    var _g = (0, react_1.useState)(0), taxRate = _g[0], setTaxRate = _g[1];
    var _h = (0, react_1.useState)(false), isGenerating = _h[0], setIsGenerating = _h[1];
    var _j = (0, react_1.useState)(false), previewMode = _j[0], setPreviewMode = _j[1];
    ...
    var recommendTemplate = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var calculateTotals = function () {
        var subtotal = invoiceItems.reduce(function (sum, item) { return sum + item.total; }, 0);
    ...
    var generateInvoice = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    invoiceData = __assign(__assign({ patientId: patient.id, appointmentId: appointmentId, items: invoiceItems, dueDate: dueDate, discount: discount, taxRate: taxRate }, totals_1), { template: selectedTemplate === null || selectedTemplate === void 0 ? void 0 : selectedTemplate.name, generatedAt: new Date().toISOString(), status: 'pending' });
                    // Mock API call
                ...
                case 2:
                    ...
                    onInvoiceGenerated === null || onInvoiceGenerated === void 0 ? void 0 : onInvoiceGenerated(invoiceId);
                    return [3 /*break*/, 5];
                case 3:
                    error_2 = _a.sent();
                    toast({
        ...
        <card_1.CardContent className="space-y-6">
              ...
              <popover_1.Popover>
                <popover_1.PopoverTrigger asChild>
                  <button_1.Button variant="outline" className="w-full justify-start text-left">
                    ...
                    {dueDate ? (0, date_fns_1.format)(dueDate, "PPP", { locale: locale_1.pt }) : "Selecionar data"}
                  </button_1.Button>
                </popover_1.PopoverTrigger>
                <popover_1.PopoverContent className="w-auto p-0">
                  <calendar_1.Calendar mode="single" selected={dueDate} onSelect={setDueDate} initialFocus/>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button_1.Button variant="outline" size="sm" onClick={recommendTemplate} disabled={isGenerating}>
                {isGenerating ? 'Analisando...' : 'Recomendar com AI'}
              </button_1.Button>
            </div>
            
            <select_1.Select onValueChange={function (templateId) {
          ...
          {/* Invoice Items */}
          {invoiceItems.length > 0 && (<div className="space-y-4">
              <label_1.Label>Itens da Fatura</label_1.Label>
              <div className="border rounded-lg">
                <div className="p-4 space-y-4">
                  {invoiceItems.map(function (item, index) { return (<div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 rounded">
                      <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input_1.Input id="discount" type="number" min="0" max="100" value={discount} onChange={function (e) { return setDiscount(Number(e.target.value)); }}/>
            </div>
            <div className="space-y-2">
              <label_1.Label htmlFor="tax">Taxa/Imposto (%)</label_1.Label>
              <input_1.Input id="tax" type="number" min="0" max="100" value={taxRate} onChange={function (e) { return setTaxRate(Number(e.target.value)); }}/>
            </div>
          </div>

          {/* Totals Summary */}
          {invoiceItems.length > 0 && (<div className="border-t pt-4">
              <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-2">
            <button_1.Button onClick={generateInvoice} disabled={isGenerating || !patient || invoiceItems.length === 0} className="flex-1 sm:flex-none">
