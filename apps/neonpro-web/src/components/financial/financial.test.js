...
describe("Financial Components Test Suite", () => {
      ...
      __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              (0, react_1.render)(
                <IntelligentInvoicing_1.IntelligentInvoicing patientId="patient_1" />,
              );
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              (0, react_1.render)(
                <IntelligentInvoicing_1.IntelligentInvoicing
  ...
  describe("IntelligentScheduling Component", () => {
    test("renders scheduling interface", () => {
      ...
      expect(
        react_1.screen.getByText("Sistema AI para otimização de horários e detecção de conflitos"),
      ).toBeInTheDocument();
      expect(react_1.screen.getByPlaceholderText("Selecionar paciente")).toBeInTheDocument();
  ...
  describe("FinancialAnalytics Component", () => {
    test("renders analytics dashboard", () => {
      ...
      expect(
        react_1.screen.getByText("Dashboard com insights preditivos e métricas em tempo real"),
      ).toBeInTheDocument();
