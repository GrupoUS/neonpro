...
function InvoiceManager(_a) {
    var _this = this;
    var clinicId = _a.clinicId, _b = _a.defaultView, defaultView = _b === void 0 ? "list" : _b, selectedInvoiceId = _a.selectedInvoiceId;
    ...
    var _e = (0, react_1.useState)(null), selectedInvoice = _e[0], setSelectedInvoice = _e[1];
    ...
    var loadInvoiceDetails = function (invoiceId) { return __awaiter(_this, void 0, void 0, function () {
        var result, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleUpdateInvoice = function () { return __awaiter(_this, void 0, void 0, function () {
        var result, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, (0, financial_1.updateInvoice)(selectedInvoice.id, {
    ...
    var handleDownloadPDF = function (invoiceId) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
    ...
    var handleSendEmail = function (invoiceId) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
    ...
    var filteredInvoices = invoices.filter(function (invoice) {
        var _a, _b;
        return ((_b = (_a = invoice.patient) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(searchTerm.toLowerCase())) ||
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          <tabs_1.Tabs value={activeTab} onValueChange={function (value) { return setActiveTab(value); }}>
            ...
            <tabs_1.TabsContent value="list" className="space-y-4">
              <div className="flex items-center space-x-2">
                <div className="relative flex-1">
                  ...
                  <input_1.Input placeholder="Buscar faturas..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-8"/>
                </div>
              ...
              <div className="space-y-2">
                {loading ? (<div className="text-center py-8">Carregando...</div>) : filteredInvoices.length === 0 ? (<div className="text-center py-8 text-muted-foreground">
                    Nenhuma fatura encontrada
                  </div>) : (filteredInvoices.map(function (invoice) {
            var _a;
            return (<card_1.Card key={invoice.id} className="p-4">
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          ...
                          <div className="text-sm text-muted-foreground">
                            {(_a = invoice.patient) === null || _a === void 0 ? void 0 : _a.name} • {invoice.description}
                          </div>
                          <div className="text-sm text-muted-foreground">
                            Valor: R$ {(invoice.total_amount / 100).toFixed(2)}
                            {invoice.due_date &&
                    " \u2022 Vence: ".concat(new Date(invoice.due_date).toLocaleDateString("pt-BR"))}
                          </div>
                        </div>

                        <div className="flex items-center space-x-2">
                          <button_1.Button variant="outline" size="sm" onClick={function () { return handleDownloadPDF(invoice.id); }}>
                            <lucide_react_1.Download className="h-4 w-4"/>
                          </button_1.Button>

                          {invoice.status !== "sent" &&
                    invoice.status !== "paid" && (<button_1.Button variant="outline" size="sm" onClick={function () { return handleSendEmail(invoice.id); }}>
            ...
            <tabs_1.TabsContent value="create" className="space-y-4">
              <div className="grid gap-4">
                <div className="grid gap-2">
                  ...
                  <input_1.Input id="patient" placeholder="ID do paciente" value={formData.patient_id || ""} onChange={function (e) {
            return setFormData(__assign(__assign({}, formData), { patient_id: e.target.value }));
        }}/>
                </div>

                <div className="grid gap-2">
                  <label_1.Label htmlFor="description">Descrição</label_1.Label>
                  <textarea_1.Textarea id="description" placeholder="Descrição dos serviços..." value={formData.description || ""} onChange={function (e) {
            ...
            return setFormData(__assign(__assign({}, formData), { due_date: e.target.value }));
        }}/>
                </div>
              </div>
            ...
            <tabs_1.TabsContent value="edit" className="space-y-4">
              {selectedInvoice && (<div className="grid gap-4">
                  <div className="grid gap-2">
                  ...
                  <div className="grid gap-2">
                    ...
                    <textarea_1.Textarea id="edit_description" value={formData.description || ""} onChange={function (e) {
                return setFormData(__assign(__assign({}, formData), { description: e.target.value }));
            }}/>
                  </div>
                  ...
                  <div className="grid gap-2">
                    ...
                    <input_1.Input id="edit_due_date" type="date" value={formData.due_date || ""} onChange={function (e) {
                return setFormData(__assign(__assign({}, formData), { due_date: e.target.value }));
            }}/>
                  </div>
                </div>)}
