...
function FinancialReports(_a) {
    var _b = _a.reports, reports = _b === void 0 ? [] : _b, _c = _a.templates, templates = _c === void 0 ? [] : _c, _d = _a.loading, loading = _d === void 0 ? false : _d, onGenerateReport = _a.onGenerateReport, onScheduleReport = _a.onScheduleReport, onDeleteReport = _a.onDeleteReport, _e = _a.className, className = _e === void 0 ? '' : _e;
    var _f = (0, react_1.useState)('reports'), activeTab = _f[0], setActiveTab = _f[1];
    ...
    var _l = (0, react_1.useState)(false), showScheduleDialog = _l[0], setShowScheduleDialog = _l[1];
    var _m = (0, react_1.useState)(null), selectedTemplate = _m[0], setSelectedTemplate = _m[1];
    ...
    if (loading) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {__spreadArray([], Array(6), true).map(function (_, i) { return (<card_1.Card key={i}>
              <card_1.CardHeader>
    ...
    return (<div className={"space-y-6 ".concat(className)}>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button_1.Button onClick={function () { return setShowScheduleDialog(true); }} variant="outline">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <div className="flex-1 max-w-sm">
          <div className="relative">
            ...
            <input_1.Input placeholder="Buscar relatórios..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-10"/>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {activeTab === 'reports' && (<select_1.Select value={filterStatus} onValueChange={setFilterStatus}>
              <select_1.SelectTrigger className="w-40">
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={function (value) { return setActiveTab(value); }}>
        ...
        <tabs_1.TabsContent value="reports" className="space-y-4">
          {filteredReports.length === 0 ? (<card_1.Card>
            ...
            </card_1.Card>) : (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredReports.map(function (report) {
                var TypeIcon = getTypeIcon(report.type);
                return (<card_1.Card key={report.id} className="hover:shadow-md transition-shadow">
                    <card_1.CardHeader>
                    ...
                    <card_1.CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2">
                          {report.status === 'completed' && report.downloadUrl && (<button_1.Button size="sm" variant="outline">
        ...
        <tabs_1.TabsContent value="templates" className="space-y-4">
          {filteredTemplates.length === 0 ? (<card_1.Card>
              <card_1.CardContent className="flex flex-col items-center justify-center py-12">
                <lucide_react_1.FileText className="h-12 w-12 text-muted-foreground mb-4"/>
              ...
              {filteredTemplates.map(function (template) {
                ...
                return (<card_1.Card key={template.id} className="hover:shadow-md transition-shadow">
                    <card_1.CardHeader>
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-2">
                          <TypeIcon className="h-5 w-5 text-muted-foreground"/>
                    ...
                    <card_1.CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2">
                          <button_1.Button size="sm" onClick={function () { return handleGenerateReport(template.id); }}>
        ...
        <tabs_1.TabsContent value="scheduled" className="space-y-4">
          <card_1.Card>
            <card_1.CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <button_1.Button onClick={function () { return setShowScheduleDialog(true); }}>
                <lucide_react_1.Plus className="h-4 w-4 mr-2"/>
                Agendar Relatório
              </button_1.Button>
            </card_1.CardContent>
        ...
        <dialog_1.DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <textarea_1.Textarea id="report-description" placeholder="Descreva o objetivo e conteúdo do relatório" rows={3}/>
            </div>
            ...
            <div className="flex justify-end gap-2 pt-4">
              ...
              <button_1.Button onClick={function () { return setShowCreateDialog(false); }}>
                Criar Relatório
              </button_1.Button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <select_1.Select>
                ...
                <select_1.SelectContent>
                  {mockTemplates.map(function (template) { return (<select_1.SelectItem key={template.id} value={template.id}>
                      {template.name}
                    </select_1.SelectItem>); })}
                </select_1.SelectContent>
              </select_1.Select>
            ...
            <div className="flex justify-end gap-2 pt-4">
              <button_1.Button variant="outline" onClick={function () { return setShowScheduleDialog(false); }}>
                Cancelar
              </button_1.Button>
              <button_1.Button onClick={function () { return setShowScheduleDialog(false); }}>
                Agendar
              </button_1.Button>
            </div>
          </div>
