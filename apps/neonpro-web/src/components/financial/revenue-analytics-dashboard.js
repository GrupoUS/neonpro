...
function RevenueAnalyticsDashboard() {
  ...
  var _c = (0, react_1.useState)(true),
    loading = _c[0],
    setLoading = _c[1];
  var _d = (0, react_1.useState)("current_month"),
    dateRange = _d[0],
    setDateRange = _d[1];
  ...
  var _f = (0, react_1.useState)([]),
    providerData = _f[0],
    setProviderData = _f[1];
  var _g = (0, react_1.useState)([]),
    patientLTVData = _g[0],
    setPatientLTVData = _g[1];
  var _h = (0, react_1.useState)([]),
    timeSeriesData = _h[0],
    setTimeSeriesData = _h[1];
  var _j = (0, react_1.useState)([]),
    forecastData = _j[0],
    setForecastData = _j[1];
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {((_b = providerData[0]) === null || _b === void 0 ? void 0 : _b.providerName) ||
                "N/A"}
            </p>
          </card_1.CardContent>
        </card_1.Card>
        ...
        <tabs_1.TabsContent value="providers" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>
                Análise de receita e eficiência por profissional
              </card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
              <div className="space-y-4">
        ...
        <tabs_1.TabsContent value="patients" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>
                Análise de valor e comportamento dos pacientes
              </card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
              <div className="space-y-4">
