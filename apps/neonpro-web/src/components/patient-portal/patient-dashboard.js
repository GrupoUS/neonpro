...
function PatientDashboard() {
  ...
  var _c = (0, use_patient_data_1.usePatientData)(),
    appointments = _c.appointments,
    treatmentHistory = _c.treatmentHistory,
          ...
          <div className="flex items-center gap-4 mb-4">
            <avatar_1.Avatar className="h-16 w-16 border-4 border-white/30">
              ...
              <avatar_1.AvatarFallback className="bg-white/20 text-white text-xl font-bold">
                {(_a = patient === null || patient === void 0 ? void 0 : patient.name) === null ||
                _a === void 0
                  ? void 0
                  : _a
                      .split(" ")
            ...
            <div>
              <h1 className="text-3xl font-bold">
                {getGreeting()},{" "}
                {(_b = patient === null || patient === void 0 ? void 0 : patient.name) === null ||
                _b === void 0
                  ? void 0
                  : _b.split(" ")[0]}
                ! ✨
              </h1>
              <p className="text-white/90 text-lg">Bem-vindo ao seu portal de saúde e beleza</p>
            </div>
          </div>
          ...
          <card_1.CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              ...
              <button_1.Button asChild variant="ghost" size="sm">
                <link_1.default href="/patient-portal/appointments">Ver todas</link_1.default>
              </button_1.Button>
            </div>
          </card_1.CardHeader>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        {(0, date_fns_1.format)(
                          (0, date_fns_1.parseISO)(activity.date),
                          "d 'de' MMMM 'às' HH:mm",
        ...
        <card_1.CardContent className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-blue-900 mb-2">Seus Dados Estão Protegidos</h3>
              <p className="text-blue-800 text-sm mb-3">
                Todas as suas informações médicas são tratadas com máxima segurança, seguindo
                rigorosamente a Lei Geral de Proteção de Dados (LGPD) e as normas do Conselho
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button_1.Button asChild variant="ghost" size="sm" className="text-blue-700">
                  <link_1.default href="/privacy-policy">Política de Privacidade</link_1.default>
                </button_1.Button>
              </div>
            </div>
          </div>
