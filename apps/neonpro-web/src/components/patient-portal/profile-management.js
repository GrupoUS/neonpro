...
function ProfileManagement() {
    var _this = this;
    var _a = (0, patient_auth_1.usePatientAuth)(), patient = _a.patient, updatePatient = _a.updatePatient;
    var _b = (0, react_1.useState)(false), isUpdating = _b[0], setIsUpdating = _b[1];
    var _c = (0, react_1.useState)(false), showPasswordForm = _c[0], setShowPasswordForm = _c[1];
    ...
    var profileForm = (0, react_hook_form_1.useForm)({
        ...
        defaultValues: {
            ...
            emergency_contact_name: (patient === null || patient === void 0 ? void 0 : patient.emergency_contact_name) || '',
            emergency_contact: (patient === null || patient === void 0 ? void 0 : patient.emergency_contact) || '',
            address: {
                street: '',
                number: '',
                complement: '',
    ...
    var handleProfileUpdate = function (data) { return __awaiter(_this, void 0, void 0, function () {
        var error_1;
    ...
    var handlePasswordUpdate = function (data) { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleAvatarUpload = function (event) { return __awaiter(_this, void 0, void 0, function () {
        var file;
        var _a;
    ...
    return (<div className="space-y-8">
          ...
          <div className="flex items-center gap-6">
            <avatar_1.Avatar className="h-24 w-24 border-4 border-primary/20">
              ...
              <avatar_1.AvatarFallback className="bg-primary/10 text-primary text-xl font-bold">
                {(patient === null || patient === void 0 ? void 0 : patient.name) && getInitials(patient.name)}
          ...
          <form_1.Form {...profileForm}>
            <form onSubmit={profileForm.handleSubmit(handleProfileUpdate)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <form_1.FormField control={profileForm.control} name="name" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                ...
                <form_1.FormField control={profileForm.control} name="email" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <form_1.FormField control={profileForm.control} name="phone" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                      <form_1.FormLabel>Telefone *</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input placeholder="(11) 99999-9999" {...field} onChange={function (e) {
                ...
                <form_1.FormField control={profileForm.control} name="birth_date" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                ...
                <form_1.FormField control={profileForm.control} name="gender" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <form_1.FormField control={profileForm.control} name="emergency_contact_name" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={profileForm.control} name="emergency_contact" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <form_1.FormField control={profileForm.control} name="address.street" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="md:col-span-2">
                  ...
                  <form_1.FormField control={profileForm.control} name="address.number" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <form_1.FormField control={profileForm.control} name="address.complement" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={profileForm.control} name="address.neighborhood" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <form_1.FormField control={profileForm.control} name="address.city" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={profileForm.control} name="address.state" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={profileForm.control} name="address.zipcode" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
      ...
      <card_1.Card className="medical-card">
        ...
        <card_1.CardContent className="space-y-4">
          {!showPasswordForm ? (<div className="flex items-center justify-between p-4 border rounded-lg">
              <div>
              ...
              <button_1.Button variant="outline" onClick={function () { return setShowPasswordForm(true); }}>
                Alterar Senha
              </button_1.Button>
            </div>) : (<form_1.Form {...passwordForm}>
              <form onSubmit={passwordForm.handleSubmit(handlePasswordUpdate)} className="space-y-4">
                <form_1.FormField control={passwordForm.control} name="currentPassword" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      <form_1.FormLabel>Senha Atual *</form_1.FormLabel>
                      <form_1.FormControl>
                        <div className="relative">
                          <input_1.Input type={showCurrentPassword ? "text" : "password"} placeholder="Digite sua senha atual" {...field}/>
                          <button_1.Button type="button" variant="ghost" size="sm" className="absolute right-0 top-0 h-full px-3" onClick={function () { return setShowCurrentPassword(!showCurrentPassword); }}>
                            {showCurrentPassword ? (<lucide_react_1.EyeOff className="w-4 h-4"/>) : (<lucide_react_1.Eye className="w-4 h-4"/>)}
                          </button_1.Button>
                        </div>
                      </form_1.FormControl>
                      <form_1.FormMessage />
                ...
                <form_1.FormField control={passwordForm.control} name="newPassword" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      <form_1.FormLabel>Nova Senha *</form_1.FormLabel>
                      <form_1.FormControl>
                        <div className="relative">
                          <input_1.Input type={showNewPassword ? "text" : "password"} placeholder="Digite a nova senha" {...field}/>
                          <button_1.Button type="button" variant="ghost" size="sm" className="absolute right-0 top-0 h-full px-3" onClick={function () { return setShowNewPassword(!showNewPassword); }}>
                            {showNewPassword ? (<lucide_react_1.EyeOff className="w-4 h-4"/>) : (<lucide_react_1.Eye className="w-4 h-4"/>)}
                          </button_1.Button>
                        </div>
                      </form_1.FormControl>
                ...
                <form_1.FormField control={passwordForm.control} name="confirmPassword" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      <form_1.FormLabel>Confirmar Nova Senha *</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input type="password" placeholder="Confirme a nova senha" {...field}/>
                      </form_1.FormControl>
                      <form_1.FormMessage />
                    </form_1.FormItem>);
            }}/>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center gap-3 p-3 border rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {(patient === null || patient === void 0 ? void 0 : patient.created_at) && (0, date_fns_1.format)(new Date(patient.created_at), "MMMM 'de' yyyy")}
                </p>
              </div>
            </div>
