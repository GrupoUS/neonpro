...
function PatientPortalEnhanced(_a) {
  ...
  var _b = (0, react_1.useState)("home"),
    activeTab = _b[0],
    setActiveTab = _b[1];
  ...
  return (
    <div className={(0, utils_1.cn)("max-w-6xl mx-auto space-y-6 p-6", className)}>
      {/* Header acolhedor */}
                  ...
                  <div>
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      {daysUntilNext && daysUntilNext <= 2 && (
                        <badge_1.Badge variant="outline" className="animate-pulse">
