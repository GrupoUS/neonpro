        ...
        categories: prev.categories.map((category) => {
          ...
          return category.id === categoryId
            ? __assign(__assign({}, category), {
                settings: __assign(
                  __assign({}, category.settings),
                  ((_a = {}), (_a[channel] = enabled), _a),
                ),
              })
            : category;
        }),
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              {preferences.doNotDisturb
                ? <lucide_react_1.VolumeX className="h-5 w-5 text-red-600" />
                : <lucide_react_1.Volume2 className="h-5 w-5 text-green-600" />}
              <div>
            ...
            <div>
              ...
              >
                ...
                <select_1.SelectContent>
                  ...
                  <select_1.SelectItem value="America/Rio_Branco">Acre (GMT-5)</select_1.SelectItem>
                </select_1.SelectContent>
              </select_1.Select>
            </div>
          </div>
