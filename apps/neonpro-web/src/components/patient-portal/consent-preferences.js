...
function ConsentPreferences() {
    var _this = this;
    var _a = (0, use_patient_auth_1.usePatientAuth)(), patient = _a.patient, updatePatient = _a.updatePatient;
    ...
    ]), consents = _c[0], setConsents = _c[1];
    // LGPD Rights
    var dataRights = [
        {
            id: 'access',
    ...
    var handleConsentToggle = function (consentId, granted) { return __awaiter(_this, void 0, void 0, function () {
        var consent, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setConsents(function (prev) { return prev.map(function (c) {
                        return c.id === consentId
                            ? __assign(__assign({}, c), { granted: granted, granted_at: granted ? new Date().toISOString() : c.granted_at, revoked_at: !granted ? new Date().toISOString() : undefined }) : c;
                    }); });
                ...
                case 2:
                    // TODO: Call API to update consent
                    _a.sent();
                    sonner_1.toast.success(granted
                ...
                case 3:
                    ...
                    setConsents(function (prev) { return prev.map(function (c) {
                        return c.id === consentId
                            ? __assign(__assign({}, c), { granted: !granted }) : c;
                    }); });
    ...
    var handleDataRightRequest = function (rightId) { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var getConsentStatus = function (consent) {
        if (consent.granted) {
            return {
                ...
                date: consent.granted_at ? (0, date_fns_1.format)((0, date_fns_1.parseISO)(consent.granted_at), "d 'de' MMM, yyyy", { locale: locale_1.ptBR }) : ''
            };
        }
        else {
            return {
                ...
                date: consent.revoked_at ? (0, date_fns_1.format)((0, date_fns_1.parseISO)(consent.revoked_at), "d 'de' MMM, yyyy", { locale: locale_1.ptBR }) : ''
            };
        }
    };
      ...
      <card_1.Card className="medical-card">
        ...
        <card_1.CardContent className="space-y-6">
          {consents.map(function (consent) {
            ...
            return (<div key={consent.id} className="flex items-start gap-4 p-4 border rounded-lg">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <badge_1.Badge className={status.color}>
                          {status.label}
                        </badge_1.Badge>
                        {consent.required && (<badge_1.Badge variant="outline" className="text-xs">
                            Obrigatório
                          </badge_1.Badge>)}
                      </div>
                      ...
                      {status.date && (<p className="text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center gap-3">
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <ul className="text-sm text-muted-foreground space-y-1">
                                {consent.purposes.map(function (purpose, index) { return (<li key={index} className="flex items-start gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <switch_1.Switch id={"consent-".concat(consent.id)} checked={consent.granted} onCheckedChange={function (checked) { return handleConsentToggle(consent.id, checked); }} disabled={consent.required || isUpdating}/>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <card_1.Card className="medical-card">
        ...
        <card_1.CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            var Icon = right.icon;
            return (<div key={right.id} className="flex items-start gap-4 p-4 border rounded-lg">
                  <div className="flex-shrink-0">
                    <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center">
                      <Icon className="w-5 h-5 text-primary"/>
                    </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <button_1.Button variant="outline" size="sm" onClick={function () { return handleDataRightRequest(right.id); }}>
                      {right.action}
                    </button_1.Button>
                  </div>
                </div>);
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                <button_1.Button variant="outline" size="sm" className="text-blue-700 border-blue-300">
