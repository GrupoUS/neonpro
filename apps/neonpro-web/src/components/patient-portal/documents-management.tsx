...
import { AlertTriangle, Download, FileText, Image, Upload, X, Eye, Lock, Shield } from 'lucide-react'
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-500">
                            <span>{documentTypeLabels[doc.type as keyof typeof documentTypeLabels]}</span>
                            <span>{doc.size}</span>
