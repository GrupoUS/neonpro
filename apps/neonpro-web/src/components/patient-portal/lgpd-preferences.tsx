    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure como seus dados podem ser utilizados</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            {Object.entries(
            ...
            <Dialog>
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  ...
                  <Button onClick={() => handleDataRequest("portability")} className="w-full">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Acompanhe suas solicitações de dados LGPD</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
