      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              ...
              <Button asChild variant="ghost" size="sm">
                <Link href="/patient-portal/appointments">Ver todas</Link>
              </Button>
            </div>
          </CardHeader>
            ...
            {upcomingAppointments.length > 0 ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <Button asChild variant="outline" size="sm" className="mt-2">
                  <Link href="/patient-portal/appointments/new">Agendar consulta</Link>
                </Button>
              </div>
            )}
          </CardContent>
        ...
        <Card className="medical-card">
          <CardHeader className="pb-4">
            ...
            <CardDescription>Acompanhe seu progresso nos tratamentos</CardDescription>
          </CardHeader>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                >
                  <Link href="/patient-portal/consent">Gerenciar Consentimentos</Link>
                </Button>
