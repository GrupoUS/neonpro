...
function PerformanceDashboard() {
  var _a = (0, performance_monitor_1.usePerformanceMonitor)(),
    report = _a.report,
    isMonitoring = _a.isMonitoring,
    startMonitoring = _a.startMonitoring,
    stopMonitoring = _a.stopMonitoring;
              ...
              <div className="flex items-center gap-4">
                <div className="text-center">
                  <div
                    className={(0, utils_1.cn)(
                      "text-4xl font-bold",
                      getScoreColor(report.overall.score),
                    )}
                  >
                ...
                <badge_1.Badge
                  className={(0, utils_1.cn)(
                    "text-lg px-3 py-1",
                    getGradeColor(report.overall.grade),
                  )}
                >
      ...
      <tabs_1.Tabs value={selectedTab} onValueChange={setSelectedTab}>
        ...
        <tabs_1.TabsContent value="overview" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <MetricCard
              title="Memory Usage"
              value={getLatestMetric(
                report === null || report === void 0 ? void 0 : report.metrics,
                "heap-used",
              )}
              unit="MB"
