...
function SessionDashboard(_a) {
  ...
  var _b = (0, use_session_1.useSession)(),
    ...
    error = _b.error,
    refresh = _b.refresh,
    terminate = _b.terminate,
    extend = _b.extend,
    getActiveSessions = _b.getActiveSessions,
    terminateSession = _b.terminateSession;
  var securityEvents = (0, use_session_1.useSessionSecurity)().securityEvents;
  var _c = (0, use_session_1.useDeviceManagement)(),
    devices = _c.devices,
    trustDevice = _c.trustDevice,
    revokeDevice = _c.revokeDevice;
  var _d = (0, react_1.useState)([]),
    activeSessions = _d[0],
    setActiveSessions = _d[1];
  var _e = (0, react_1.useState)(false),
    showSecurityDetails = _e[0],
    setShowSecurityDetails = _e[1];
  var _f = (0, react_1.useState)(null),
    selectedSession = _f[0],
    setSelectedSession = _f[1];
        ...
        <card_1.CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <card_1.CardDescription>Session ID: {session.id}</card_1.CardDescription>
            </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">
                  {minutesUntilExpiry > 0
                    ? "".concat(minutesUntilExpiry, "m remaining")
                    : "Expired"}
                </span>
              </div>
              <progress_1.Progress
                        ...
                        <table_1.TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                {(_a = activeSession.user_agent) === null || _a === void 0
                                  ? void 0
                                  : _a.split(" ")[0]}
                              </p>
                            </div>
                        ...
                        <table_1.TableCell>
                          <div className="flex items-center gap-2">
                            {activeSession.id === session.id
                              ? <badge_1.Badge variant="default">Current</badge_1.Badge>
        ...
        <tabs_1.TabsContent value="security" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>Security events from the last 30 days</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
