...
var DeviceManager = function (_a) {
  ...
  var _c = (0, use_session_1.useDeviceManagement)(userId),
    devices = _c.devices,
    loading = _c.loading,
    error = _c.error,
    trustDevice = _c.trustDevice,
    untrustDevice = _c.untrustDevice,
    removeDevice = _c.removeDevice,
    registerDevice = _c.registerDevice,
    refreshDevices = _c.refreshDevices;
  var _d = (0, react_1.useState)(false),
    showAddDialog = _d[0],
    setShowAddDialog = _d[1];
  var _e = (0, react_1.useState)(false),
    showRemoveDialog = _e[0],
    setShowRemoveDialog = _e[1];
      ...
      <card_1.Card className={className}>
        ...
        <card_1.CardContent>
          <alert_1.Alert variant="destructive">
            ...
            <alert_1.AlertDescription>Failed to load devices: {error}</alert_1.AlertDescription>
          </alert_1.Alert>
        </card_1.CardContent>
      </card_1.Card>
    );
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {selectedDevice.device_type} • Last seen{" "}
