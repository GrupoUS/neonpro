...
var SecurityAlerts = (_a) => {
  ...
  var _c = (0, use_session_1.useSessionSecurity)(userId),
    securityEvents = _c.securityEvents,
    suspiciousActivities = _c.suspiciousActivities,
    loading = _c.loading,
    error = _c.error,
    refreshSecurityData = _c.refreshSecurityData;
  var _d = (0, react_1.useState)(new Set()),
    dismissedAlerts = _d[0],
    setDismissedAlerts = _d[1];
  var _e = (0, react_1.useState)(false),
    showResolved = _e[0],
    setShowResolved = _e[1];
