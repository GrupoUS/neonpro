...
function InventoryMetrics(_a) {
    ...
    var loadMetrics = function () { return __awaiter(_this, void 0, void 0, function () {
        var endDate, startDate, _a, analyticsData, analyticsError, fifoStatus, calculatedMetrics, generatedAlerts, error_1, errorMessage;
        ...
        return __generator(this, function (_p) {
            switch (_p.label) {
                case 0:
                    ...
                    return [4 /*yield*/, consumptionAnalyzer.getConsumptionAnalytics(filters.centro_custo === 'all' ? undefined : filters.centro_custo, startDate, endDate)];
                case 1:
                    _a = _p.sent(), analyticsData = _a.data, analyticsError = _a.error;
                    if (analyticsError) {
                        console.warn('Analytics error:', analyticsError);
                    }
                    return [4 /*yield*/, fifoManager.getFIFOStatusByCostCenter(filters.centro_custo === 'all' ? undefined : filters.centro_custo)];
                case 2:
                    fifoStatus = (_p.sent()).data;
                    calculatedMetrics = {
                        total_items: ((_b = analyticsData === null || analyticsData === void 0 ? void 0 : analyticsData.produtos_mais_consumidos) === null || _b === void 0 ? void 0 : _b.length) || 0,
                        total_value: ((_c = analyticsData === null || analyticsData === void 0 ? void 0 : analyticsData.consumo_total) === null || _c === void 0 ? void 0 : _c.valor_total) || 0,
                        consumption_rate: ((_d = analyticsData === null || analyticsData === void 0 ? void 0 : analyticsData.media_diaria) === null || _d === void 0 ? void 0 : _d.valor) || 0,
                        efficiency_score: ((_e = analyticsData === null || analyticsData === void 0 ? void 0 : analyticsData.eficiencia_custos) === null || _e === void 0 ? void 0 : _e.score_eficiencia) || 0,
                        cost_savings: ((_f = analyticsData === null || analyticsData === void 0 ? void 0 : analyticsData.eficiencia_custos) === null || _f === void 0 ? void 0 : _f.economia_potencial) || 0,
                        expiry_alerts: ((_g = fifoStatus === null || fifoStatus === void 0 ? void 0 : fifoStatus.filter(function (item) {
                            return item.status_validade === 'proximoVencimento' || item.status_validade === 'vencido';
                        })) === null || _g === void 0 ? void 0 : _g.length) || 0,
                        low_stock_alerts: ((_h = fifoStatus === null || fifoStatus === void 0 ? void 0 : fifoStatus.filter(function (item) {
                            return item.quantidade_atual <= (item.estoque_minimo || 0);
                        })) === null || _h === void 0 ? void 0 : _h.length) || 0,
                        transfer_requests: 0, // Will be calculated separately
                        aging_analysis: {
                            items_30_days: ((_j = fifoStatus === null || fifoStatus === void 0 ? void 0 : fifoStatus.filter(function (item) {
                                var daysToExpiry = Math.ceil((new Date(item.data_validade).getTime() - Date.now()) / (1000 * 60 * 60 * 24));
                                return daysToExpiry <= 30 && daysToExpiry > 0;
                            })) === null || _j === void 0 ? void 0 : _j.length) || 0,
                            items_60_days: ((_k = fifoStatus === null || fifoStatus === void 0 ? void 0 : fifoStatus.filter(function (item) {
                                var daysToExpiry = Math.ceil((new Date(item.data_validade).getTime() - Date.now()) / (1000 * 60 * 60 * 24));
                                return daysToExpiry <= 60 && daysToExpiry > 30;
                            })) === null || _k === void 0 ? void 0 : _k.length) || 0,
                            items_90_days: ((_l = fifoStatus === null || fifoStatus === void 0 ? void 0 : fifoStatus.filter(function (item) {
                                var daysToExpiry = Math.ceil((new Date(item.data_validade).getTime() - Date.now()) / (1000 * 60 * 60 * 24));
                                return daysToExpiry <= 90 && daysToExpiry > 60;
                            })) === null || _l === void 0 ? void 0 : _l.length) || 0,
                            expired_items: ((_m = fifoStatus === null || fifoStatus === void 0 ? void 0 : fifoStatus.filter(function (item) {
                                return new Date(item.data_validade) < new Date();
                            })) === null || _m === void 0 ? void 0 : _m.length) || 0
                        },
                        top_consumers: ((_o = analyticsData === null || analyticsData === void 0 ? void 0 : analyticsData.produtos_mais_consumidos) === null || _o === void 0 ? void 0 : _o.slice(0, 5)) || [],
                        trends: (analyticsData === null || analyticsData === void 0 ? void 0 : analyticsData.tendencias) || []
                    };
                    ...
                    if (calculatedMetrics.low_stock_alerts > 0) {
                        generatedAlerts.push({
                            ...
                            severity: 'alta',
                            title: 'Estoque Baixo',
                            message: "".concat(calculatedMetrics.low_stock_alerts, " produto(s) com estoque abaixo do m\u00EDnimo"),
                            product_id: 'multiple',
                            threshold_value: 0,
                    ...
                    if (calculatedMetrics.expiry_alerts > 0) {
                        generatedAlerts.push({
                            ...
                            message: "".concat(calculatedMetrics.expiry_alerts, " produto(s) pr\u00F3ximo(s) ao vencimento"),
                            product_id: 'multiple',
                            threshold_value: 30,
                    ...
                    if (calculatedMetrics.efficiency_score < 70) {
                        generatedAlerts.push({
                            ...
                            message: "Score de efici\u00EAncia atual: ".concat(calculatedMetrics.efficiency_score, "%"),
                            product_id: 'general',
                            threshold_value: 70,
    ...
    var getTrendIcon = function (trend) {
        ...
        return trend.variacao_valor >= 0 ? (<icons_1.Icons.TrendingUp className="h-4 w-4 text-green-500"/>) : (<icons_1.Icons.TrendingDown className="h-4 w-4 text-red-500"/>);
    };
    if (isLoading) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[1, 2, 3, 4].map(function (i) { return (<card_1.Card key={i}>
    ...
    return (<div className={"space-y-6 ".concat(className)}>
        ...
        <card_1.CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <select_1.Select value={filters.centro_custo} onValueChange={function (value) { return setFilters(function (prev) { return (__assign(__assign({}, prev), { centro_custo: value })); }); }}>
            ...
            <div className="space-y-2">
              ...
              <select_1.Select value={filters.periodo} onValueChange={function (value) { return setFilters(function (prev) { return (__assign(__assign({}, prev), { periodo: value })); }); }}>
                <select_1.SelectTrigger>
                  <select_1.SelectValue />
                </select_1.SelectTrigger>
                <select_1.SelectContent>
      ...
      {/* Key Metrics */}
      {metrics && (<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <card_1.Card>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className={"text-2xl font-bold ".concat(getEfficiencyColor(metrics.efficiency_score))}>
      ...
      {/* Secondary Metrics */}
      {metrics && (<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <card_1.Card>
            <card_1.CardHeader className="pb-2">
              <card_1.CardTitle className="text-sm font-medium text-muted-foreground">
                Economia Potencial
      ...
      {/* Top Consumers */}
      {metrics && metrics.top_consumers.length > 0 && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center gap-2">
          ...
          <card_1.CardContent>
            <table_1.Table>
              ...
              <table_1.TableBody>
                {metrics.top_consumers.map(function (product, index) { return (<table_1.TableRow key={index}>
                    <table_1.TableCell className="font-medium">{product.nome_produto}</table_1.TableCell>
      ...
      {alerts.length > 0 && (<card_1.Card>
          ...
          <card_1.CardContent>
            <div className="space-y-3">
              {alerts.map(function (alert) { return (<div key={alert.id} className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <div className="text-right">
                    ...
                    {alert.threshold_value && (<p className="text-sm text-muted-foreground mt-1">
