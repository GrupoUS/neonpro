...
function BatchTracking() {
  ...
  var _d = (0, react_1.useState)("summary"),
    viewMode = _d[0],
    setViewMode = _d[1];
            ...
            <table_1.Table>
              <table_1.TableHeader>
                <table_1.TableRow>
                  ...
                  {viewMode === "detailed" && (
                    <table_1.TableHead>Rastreabilidade</table_1.TableHead>
                  )}
                </table_1.TableRow>
              </table_1.TableHeader>
              <table_1.TableBody>
                {filteredBatches.map(function (batch) {
                  ...
                  return (
                    <table_1.TableRow key={batch.id} className="hover:bg-muted/50">
                      <table_1.TableCell>
                        <div className="space-y-1">
                          ...
                          {alert && (
                            <alert_1.Alert className={"".concat(alert.color, " p-2")}>
