...
function StockTransfers(_a) {
    ...
    var _b = (0, react_1.useState)([]), transfers = _b[0], setTransfers = _b[1];
    var _c = (0, react_1.useState)([]), pendingTransfers = _c[0], setPendingTransfers = _c[1];
    ...
    var _f = (0, react_1.useState)(null), isApproving = _f[0], setIsApproving = _f[1];
    var _g = (0, react_1.useState)(null), isRejecting = _g[0], setIsRejecting = _g[1];
    var _h = (0, react_1.useState)(false), isDialogOpen = _h[0], setIsDialogOpen = _h[1];
    var _j = (0, react_1.useState)('pendente'), selectedStatus = _j[0], setSelectedStatus = _j[1];
    ...
    var loadTransfers = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    error_1 = _b.sent();
                    errorMessage = error_1 instanceof Error ? error_1.message : 'Erro ao carregar transferências';
                    toast({
                        title: 'Erro',
    ...
    var handleSubmitTransfer = function (e) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    error_2 = _b.sent();
                    errorMessage = error_2 instanceof Error ? error_2.message : 'Erro ao criar transferência';
                    toast({
                        title: 'Erro',
                        description: errorMessage,
                        variant: 'destructive',
    ...
    var handleApproveTransfer = function (transferId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_3 = _a.sent();
                    errorMessage = error_3 instanceof Error ? error_3.message : 'Erro ao aprovar transferência';
                    toast({
                        title: 'Erro',
                        description: errorMessage,
                        variant: 'destructive',
    ...
    var handleRejectTransfer = function (transferId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, stockOutputManager.rejectTransfer(transferId, 'user-123', 'Rejeitado via interface')];
                case 1:
                    error = (_a.sent()).error;
                    if (error) {
                        throw new Error(error);
                ...
                case 2:
                    error_4 = _a.sent();
                    errorMessage = error_4 instanceof Error ? error_4.message : 'Erro ao rejeitar transferência';
                    toast({
                        title: 'Erro',
                        description: errorMessage,
                        variant: 'destructive',
    ...
    return (<div className={"space-y-6 ".concat(className)}>
              ...
              <form onSubmit={handleSubmitTransfer}>
                ...
                <div className="space-y-4 py-4">
                  <div className="space-y-2">
                    ...
                    <select_1.Select value={formData.produto_id} onValueChange={function (value) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { produto_id: value })); });
        }}>
                  ...
                  <div className="space-y-2">
                    <label_1.Label htmlFor="centro_custo_origem">Centro de Custo Origem *</label_1.Label>
                    <select_1.Select value={formData.centro_custo_origem} onValueChange={function (value) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { centro_custo_origem: value })); });
        }}>
                      <select_1.SelectTrigger>
                  ...
                  <div className="space-y-2">
                    <label_1.Label htmlFor="centro_custo_destino">Centro de Custo Destino *</label_1.Label>
                    <select_1.Select value={formData.centro_custo_destino} onValueChange={function (value) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { centro_custo_destino: value })); });
        }}>
                      <select_1.SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <input_1.Input id="quantidade" type="number" min="1" value={formData.quantidade} onChange={function (e) { return setFormData(function (prev) { return (__assign(__assign({}, prev), { quantidade: parseInt(e.target.value) || 1 })); }); }} required/>
                  </div>

                  <div className="space-y-2">
                    <label_1.Label htmlFor="prioridade">Prioridade</label_1.Label>
                    <select_1.Select value={formData.prioridade} onValueChange={function (value) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { prioridade: value })); });
        }}>
                      <select_1.SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea_1.Textarea id="observacoes" value={formData.observacoes} onChange={function (e) { return setFormData(function (prev) { return (__assign(__assign({}, prev), { observacoes: e.target.value })); }); }} placeholder="Observações adicionais..." rows={3}/>
                  </div>
                </div>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          {displayTransfers.length === 0 ? (<div className="text-center py-8">
              ...
              <table_1.TableBody>
                {displayTransfers.map(function (transfer) { return (<table_1.TableRow key={transfer.id}>
                    <table_1.TableCell className="font-mono text-sm">
                      {transfer.id.slice(-8)}
                    </table_1.TableCell>
                    <table_1.TableCell className="font-medium">
                      {transfer.nome_produto}
                      {transfer.observacoes && (<p className="text-sm text-muted-foreground">
                    ...
                    <table_1.TableCell className="text-sm">
                      ...
                      {transfer.data_aprovacao && (<p className="text-muted-foreground">
                          Aprovado: {formatDateTime(transfer.data_aprovacao)}
                        </p>)}
                    </table_1.TableCell>
                    <table_1.TableCell>
                      {transfer.status === 'pendente' && (<div className="flex gap-2">
                          <button_1.Button size="sm" variant="outline" onClick={function () { return handleApproveTransfer(transfer.id); }} disabled={isApproving === transfer.id} className="text-green-600 hover:text-green-700">
                            {isApproving === transfer.id ? (<icons_1.Icons.Loader2 className="w-4 h-4 animate-spin"/>) : (<icons_1.Icons.Check className="w-4 h-4"/>)}
                          </button_1.Button>
                          <button_1.Button size="sm" variant="outline" onClick={function () { return handleRejectTransfer(transfer.id); }} disabled={isRejecting === transfer.id} className="text-red-600 hover:text-red-700">
                            {isRejecting === transfer.id ? (<icons_1.Icons.Loader2 className="w-4 h-4 animate-spin"/>) : (<icons_1.Icons.X className="w-4 h-4"/>)}
                          </button_1.Button>
                        </div>)}
                      {transfer.status === 'aprovado' && (<badge_1.Badge variant="outline">Aguardando execução</badge_1.Badge>)}
                      {transfer.status === 'concluido' && (<badge_1.Badge variant="secondary">Concluído</badge_1.Badge>)}
                    </table_1.TableCell>
                  </table_1.TableRow>); })}
              </table_1.TableBody>
            </table_1.Table>)}
