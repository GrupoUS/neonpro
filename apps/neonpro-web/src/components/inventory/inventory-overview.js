...
function InventoryOverview(_a) {
  ...
  var _c = (0, react_1.useState)([]),
    lowStockProducts = _c[0],
    setLowStockProducts = _c[1];
  var _d = (0, react_1.useState)([]),
    expiringProducts = _d[0],
    setExpiringProducts = _d[1];
    ...
    <div className={"space-y-6 ".concat(className)}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <card_1.Card>
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Situações que requerem atenção imediata</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent>
            {isLoadingDetails
        ...
        <card_1.Card>
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Produtos próximos ao estoque mínimo</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent>
            {isLoadingDetails
              ? <div className="space-y-3">
      ...
      <card_1.Card>
        <card_1.CardHeader>
          ...
          <card_1.CardDescription>Lotes que vencem nos próximos 30 dias</card_1.CardDescription>
        </card_1.CardHeader>
        <card_1.CardContent>
          {isLoadingDetails
