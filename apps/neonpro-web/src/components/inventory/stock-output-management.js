...
function StockOutputManagement(_a) {
    ...
    var _b = (0, react_1.useState)([]), stockOutputs = _b[0], setStockOutputs = _b[1];
    var _c = (0, react_1.useState)([]), pendingRequests = _c[0], setPendingRequests = _c[1];
    ...
    var _g = (0, react_1.useState)({
        ...
        urgente: false,
        items: []
    }), newOutputData = _g[0], setNewOutputData = _g[1];
    var toast = (0, use_toast_1.useToast)().toast;
    var stockOutputManager = new inventory_1.StockOutputManager();
    (0, react_1.useEffect)(function () {
        loadStockOutputs();
    }, []);
    var loadStockOutputs = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    setIsLoading(true);
                    return [4 /*yield*/, stockOutputManager.getStockOutputs({
                            limit: 50,
                            status: undefined
                        })];
                case 1:
                    ...
                    return [4 /*yield*/, stockOutputManager.getStockRequests({
                            status: 'pendente'
                        })];
                case 2:
                ...
                case 3:
                    error_1 = _c.sent();
                    errorMessage = error_1 instanceof Error ? error_1.message : 'Erro ao carregar saídas de estoque';
                    toast({
                        title: 'Erro',
    ...
    var handleCreateStockOutput = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, stockOutputManager.createStockOutput({
                            ...
                            items: newOutputData.items.map(function (item) { return ({
                ...
                case 1:
                    ...
                    toast({
                        title: 'Sucesso',
                        description: "Sa\u00EDda de estoque ".concat(output === null || output === void 0 ? void 0 : output.numero_saida, " criada com sucesso"),
                    });
                ...
                case 2:
                    error_2 = _b.sent();
                    errorMessage = error_2 instanceof Error ? error_2.message : 'Erro ao criar saída de estoque';
                    toast({
                        title: 'Erro',
                        description: errorMessage,
                        variant: 'destructive',
    ...
    var handleApproveRequest = function (requestId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    error_3 = _b.sent();
                    errorMessage = error_3 instanceof Error ? error_3.message : 'Erro ao aprovar solicitação';
                    toast({
                        title: 'Erro',
                        description: errorMessage,
                        variant: 'destructive',
    ...
    var addItemToOutput = function () {
        setNewOutputData(function (prev) { return (__assign(__assign({}, prev), { items: __spreadArray(__spreadArray([], prev.items, true), [{
                    produto_id: '',
                    nome_produto: '',
    ...
    var removeItemFromOutput = function (index) {
        setNewOutputData(function (prev) { return (__assign(__assign({}, prev), { items: prev.items.filter(function (_, i) { return i !== index; }) })); });
    };
    var updateOutputItem = function (index, field, value) {
        setNewOutputData(function (prev) { return (__assign(__assign({}, prev), { items: prev.items.map(function (item, i) {
                var _a;
    ...
    if (isLoading) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {[1, 2].map(function (i) { return (<card_1.Card key={i}>
    ...
    return (<div className={"space-y-6 ".concat(className)}>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <select_1.Select value={newOutputData.centro_custo_id} onValueChange={function (value) { return setNewOutputData(function (prev) { return (__assign(__assign({}, prev), { centro_custo_id: value })); }); }}>
                ...
                <div className="space-y-2">
                  ...
                  <input_1.Input id="solicitante" value={newOutputData.solicitante} onChange={function (e) { return setNewOutputData(function (prev) { return (__assign(__assign({}, prev), { solicitante: e.target.value })); }); }} placeholder="Nome do solicitante"/>
                </div>
              </div>

              <div className="space-y-2">
                <label_1.Label htmlFor="motivo">Motivo da Saída</label_1.Label>
                <textarea_1.Textarea id="motivo" value={newOutputData.motivo} onChange={function (e) { return setNewOutputData(function (prev) { return (__assign(__assign({}, prev), { motivo: e.target.value })); }); }} placeholder="Descreva o motivo da saída" rows={3}/>
              </div>

              <div className="flex items-center space-x-2">
                <input type="checkbox" id="urgente" checked={newOutputData.urgente} onChange={function (e) { return setNewOutputData(function (prev) { return (__assign(__assign({}, prev), { urgente: e.target.checked })); }); }} className="rounded border-gray-300"/>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button_1.Button type="button" variant="outline" size="sm" onClick={addItemToOutput}>
                    <icons_1.Icons.Plus className="w-4 h-4 mr-2"/>
                    Adicionar Item
                  </button_1.Button>
                </div>

                {newOutputData.items.length === 0 ? (<alert_1.Alert>
                    ...
                    {newOutputData.items.map(function (item, index) { return (<div key={index} className="p-4 border rounded-lg space-y-3">
                        <div className="flex items-center justify-between">
                          <h4 className="font-medium">Item {index + 1}</h4>
                          <button_1.Button type="button" variant="ghost" size="sm" onClick={function () { return removeItemFromOutput(index); }}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                          <div className="space-y-2">
                            ...
                            <select_1.Select value={item.produto_id} onValueChange={function (value) {
                    ...
                    updateOutputItem(index, 'nome_produto', 'Nome do Produto');
                              ...
                              <select_1.SelectContent>
                                <select_1.SelectItem value="prod001">Luvas de Procedimento</select_1.SelectItem>
                                <select_1.SelectItem value="prod002">Máscaras Cirúrgicas</select_1.SelectItem>
                                <select_1.SelectItem value="prod003">Soro Fisiológico</select_1.SelectItem>
                                <select_1.SelectItem value="prod004">Gaze Estéril</select_1.SelectItem>
                              </select_1.SelectContent>
                            </select_1.Select>
                          </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <input_1.Input type="number" value={item.quantidade_solicitada} onChange={function (e) { return updateOutputItem(index, 'quantidade_solicitada', parseInt(e.target.value) || 0); }} placeholder="0" min="1"/>
                          </div>

                          <div className="space-y-2">
                            <label_1.Label>Observações</label_1.Label>
                            <input_1.Input value={item.observacoes || ''} onChange={function (e) { return updateOutputItem(index, 'observacoes', e.target.value); }} placeholder="Observações opcionais"/>
                          </div>
                        </div>
                      </div>); })}
                  </div>)}
              ...
              <div className="flex justify-end space-x-2 pt-4">
                ...
                <button_1.Button onClick={handleCreateStockOutput} disabled={isCreating || newOutputData.items.length === 0}>
                  {isCreating ? (<>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            .reduce(function (sum, output) { return sum + (output.valor_total || 0); }, 0))}
            </div>
      ...
      {/* Pending Requests */}
      {pendingRequests.length > 0 && (<card_1.Card>
          <card_1.CardHeader>
          ...
          <card_1.CardContent>
            <table_1.Table>
              ...
              <table_1.TableBody>
                {pendingRequests.map(function (request) { return (<table_1.TableRow key={request.id}>
                    <table_1.TableCell className="font-medium">{request.solicitante}</table_1.TableCell>
                    <table_1.TableCell>{request.centro_custo_id}</table_1.TableCell>
                    <table_1.TableCell className="max-w-xs truncate">{request.motivo}</table_1.TableCell>
                    <table_1.TableCell>
                    ...
                    <table_1.TableCell>
                      <div className="flex gap-2">
                        <button_1.Button size="sm" onClick={function () { return handleApproveRequest(request.id); }}>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          {stockOutputs.length > 0 ? (<table_1.Table>
              <table_1.TableHeader>
                <table_1.TableRow>
              ...
              <table_1.TableBody>
                {stockOutputs.slice(0, 10).map(function (output) { return (<table_1.TableRow key={output.id}>
                    <table_1.TableCell className="font-medium">{output.numero_saida}</table_1.TableCell>
                    ...
                    <table_1.TableCell>{formatCurrency(output.valor_total || 0)}</table_1.TableCell>
                    <table_1.TableCell>
