...
function InventoryConfiguration(_a) {
  ...
  var _d = (0, react_1.useState)([]),
    automationRules = _d[0],
    setAutomationRules = _d[1];
  ...
  var _f = (0, react_1.useState)(false),
    isSaving = _f[0],
    setIsSaving = _f[1];
  var _g = (0, react_1.useState)("general"),
    activeTab = _g[0],
    setActiveTab = _g[1];
      ...
      return __generator(this, (_d) => {
        switch (_d.label) {
          ...
          case 4:
            error_1 = _d.sent();
            errorMessage =
              error_1 instanceof Error ? error_1.message : "Erro ao carregar configurações";
            toast({
              title: "Erro",
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 2:
            error_2 = _a.sent();
            errorMessage =
              error_2 instanceof Error ? error_2.message : "Erro ao salvar configurações";
            toast({
              title: "Erro",
              description: errorMessage,
              variant: "destructive",
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [3 /*break*/, 5];
          case 3:
            return [4 /*yield*/, inventoryConfig.createAlertRule(alertRuleForm)];
          case 4:
            error = _a.sent().error;
            if (error) throw new Error(error);
            _a.label = 5;
            ...
            <card_1.CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label_1.Label htmlFor="min_stock_threshold">
                  ...
                  <div className="space-y-2">
                    <label_1.Label htmlFor="expiry_warning_days">
                      Aviso de Vencimento (dias)
                    </label_1.Label>
                    <input_1.Input
                  ...
                  <div className="space-y-2">
                    <label_1.Label htmlFor="consumption_forecast_days">
                      Previsão de Consumo (dias)
                    </label_1.Label>
                    <input_1.Input
                  ...
                  <div className="space-y-2">
                    <label_1.Label htmlFor="efficiency_target">
                      Meta de Eficiência (%)
                    </label_1.Label>
                    <input_1.Input
              ...
              <div className="space-y-4">
                ...
                {configForm.auto_reorder_enabled && (
                  <div className="space-y-2">
                    <label_1.Label htmlFor="reorder_lead_time">
                      Lead Time para Reposição (dias)
                    </label_1.Label>
                    <input_1.Input
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <select_1.SelectContent>
                      ...
                      <select_1.SelectItem value="expiry_warning">
                        Vencimento Próximo
                      </select_1.SelectItem>
                      <select_1.SelectItem value="efficiency_low">
                        Eficiência Baixa
                      </select_1.SelectItem>
                      <select_1.SelectItem value="cost_high">Custo Alto</select_1.SelectItem>
                      <select_1.SelectItem value="consumption_anomaly">
                        Anomalia de Consumo
                      </select_1.SelectItem>
                    </select_1.SelectContent>
                  </select_1.Select>
