...
function ConsumptionAnalytics(_a) {
    ...
    var _c = (0, react_1.useState)([]), forecasts = _c[0], setForecasts = _c[1];
    ...
    var _f = (0, react_1.useState)(false), isGeneratingRecommendations = _f[0], setIsGeneratingRecommendations = _f[1];
    ...
    var loadAnalyticsData = function () { return __awaiter(_this, void 0, void 0, function () {
        var startDate, endDate, _a, analyticsData, analyticsError, _b, forecastData, forecastError, error_1, errorMessage;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, consumptionAnalyzer.getConsumptionAnalytics(filters.centroCustoId, startDate, endDate)];
                case 1:
                    ...
                    return [4 /*yield*/, consumptionAnalyzer.getConsumptionForecast(filters.centroCustoId, undefined, 30)];
                case 2:
                ...
                case 3:
                    error_1 = _c.sent();
                    errorMessage = error_1 instanceof Error ? error_1.message : 'Erro ao carregar dados de analytics';
                    toast({
                        title: 'Erro',
    ...
    var generateOptimizationRecommendations = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    startDate = new Date(filters.dataInicio);
                    endDate = new Date(filters.dataFim);
                    return [4 /*yield*/, consumptionAnalyzer.generateCostOptimizationRecommendations(filters.centroCustoId, startDate, endDate)];
                case 1:
                    ...
                    toast({
                        title: 'Sucesso',
                        description: "".concat((recommendationsData === null || recommendationsData === void 0 ? void 0 : recommendationsData.length) || 0, " oportunidades de otimiza\u00E7\u00E3o identificadas"),
                    });
                    return [3 /*break*/, 4];
                case 2:
                    error_2 = _b.sent();
                    errorMessage = error_2 instanceof Error ? error_2.message : 'Erro ao gerar recomendações';
                    toast({
                        title: 'Erro',
                        description: errorMessage,
                        variant: 'destructive',
    ...
    var getTrendIcon = function (trend) {
        switch (trend) {
            case 'crescente': return <icons_1.Icons.TrendingUp className="h-4 w-4 text-green-500"/>;
            case 'decrescente': return <icons_1.Icons.TrendingDown className="h-4 w-4 text-red-500"/>;
            default: return <icons_1.Icons.Minus className="h-4 w-4 text-gray-500"/>;
        }
    };
    ...
    return (<div className={"space-y-6 ".concat(className)}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button_1.Button onClick={generateOptimizationRecommendations} disabled={isGeneratingRecommendations}>
        ...
        <card_1.CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="space-y-2">
              ...
              <select_1.Select value={filters.centroCustoId} onValueChange={function (value) { return handleFilterChange('centroCustoId', value); }}>
            ...
            <div className="space-y-2">
              ...
              <input_1.Input type="date" value={filters.dataInicio} onChange={function (e) { return handleFilterChange('dataInicio', e.target.value); }}/>
            </div>

            <div className="space-y-2">
              <label_1.Label>Data Fim</label_1.Label>
              <input_1.Input type="date" value={filters.dataFim} onChange={function (e) { return handleFilterChange('dataFim', e.target.value); }}/>
            </div>

            <div className="space-y-2">
              <label_1.Label>Período</label_1.Label>
              <select_1.Select value={filters.periodo} onValueChange={function (value) { return handleFilterChange('periodo', value); }}>
                <select_1.SelectTrigger>
      ...
      {/* Summary Cards */}
      {analytics && (<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <card_1.Card>
      ...
      {analytics && analytics.produtos_mais_consumidos.length > 0 && (<card_1.Card>
          <card_1.CardHeader>
          ...
          <card_1.CardContent>
            <table_1.Table>
              ...
              <table_1.TableBody>
                {analytics.produtos_mais_consumidos.slice(0, 10).map(function (product) { return (<table_1.TableRow key={product.produto_id}>
                    ...
                    <table_1.TableCell>{formatCurrency(product.custo_medio_unitario)}</table_1.TableCell>
                  </table_1.TableRow>); })}
              </table_1.TableBody>
            </table_1.Table>
          </card_1.CardContent>
      ...
      {/* Consumption Trends */}
      {analytics && analytics.tendencias.length > 0 && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center gap-2">
          ...
          <card_1.CardContent>
            <div className="space-y-4">
              {analytics.tendencias.map(function (trend, index) { return (<div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                  ...
                  <div className="text-right">
                    <div className="flex items-center gap-2 mb-1">
                      {trend.variacao_valor >= 0 ? (<icons_1.Icons.TrendingUp className="h-4 w-4 text-green-500"/>) : (<icons_1.Icons.TrendingDown className="h-4 w-4 text-red-500"/>)}
                      <span className={"text-sm font-medium ".concat(trend.variacao_valor >= 0 ? 'text-green-600' : 'text-red-600')}>
      ...
      {opportunities.length > 0 && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center gap-2">
          ...
          <card_1.CardContent>
            <div className="space-y-4">
              {opportunities.map(function (opportunity, index) { return (<div key={index} className="border rounded-lg p-4">
      ...
      {forecasts.length > 0 && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center gap-2">
          ...
          <card_1.CardContent>
            <table_1.Table>
              ...
              <table_1.TableBody>
                {forecasts.slice(0, 5).map(function (forecast) { return (<table_1.TableRow key={forecast.produto_id}>
                    <table_1.TableCell className="font-medium">{forecast.nome_produto}</table_1.TableCell>
                    ...
                    <table_1.TableCell>
                      <badge_1.Badge variant={forecast.confianca_previsao >= 75 ? 'default' : 'secondary'}>
                    ...
                    <table_1.TableCell>{formatCurrency(forecast.recomendacao_compra.economia_esperada)}</table_1.TableCell>
                  </table_1.TableRow>); })}
              </table_1.TableBody>
            </table_1.Table>
          </card_1.CardContent>
      ...
      {/* Alerts */}
      {analytics && analytics.alertas.length > 0 && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center gap-2">
          ...
          <card_1.CardContent>
            <div className="space-y-3">
              {analytics.alertas.map(function (alert) { return (<div key={alert.id} className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <div className="text-right">
                    <badge_1.Badge variant={alert.gravidade === 'alta' ? 'destructive' : 'secondary'}>
                      {alert.gravidade}
                    </badge_1.Badge>
