...
function ReorderManagement() {
    var _a = (0, react_1.useState)("all"), selectedUrgency = _a[0], setSelectedUrgency = _a[1];
    var _b = (0, react_1.useState)("all"), selectedCategory = _b[0], setSelectedCategory = _b[1];
    var _c = (0, react_1.useState)([]), selectedSuggestions = _c[0], setSelectedSuggestions = _c[1];
    var _d = (0, react_1.useState)(false), isBulkOrderOpen = _d[0], setIsBulkOrderOpen = _d[1];
    var filteredSuggestions = (0, react_1.useMemo)(function () {
        return mockReorderSuggestions.filter(function (suggestion) {
            ...
            var matchesCategory = selectedCategory === "all" || suggestion.category === selectedCategory;
            return matchesUrgency && matchesCategory;
        });
    }, [selectedUrgency, selectedCategory]);
    var summaryMetrics = (0, react_1.useMemo)(function () {
        var totalSuggestions = filteredSuggestions.length;
        var criticalCount = filteredSuggestions.filter(function (s) { return s.urgency === "critical"; }).length;
        var totalValue = filteredSuggestions.reduce(function (sum, s) { return sum + s.totalCost; }, 0);
        var avgStockoutRisk = filteredSuggestions.reduce(function (sum, s) { return sum + s.stockoutRisk; }, 0) /
            totalSuggestions || 0;
        return {
    ...
    var handleSuggestionSelect = function (suggestionId, checked) {
        if (checked) {
            setSelectedSuggestions(__spreadArray(__spreadArray([], selectedSuggestions, true), [suggestionId], false));
        }
        else {
            setSelectedSuggestions(selectedSuggestions.filter(function (id) { return id !== suggestionId; }));
        }
    };
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex gap-2 ml-auto">
          {selectedSuggestions.length > 0 && (<button_1.Button onClick={handleApproveSelected}>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          <div className="overflow-x-auto">
              ...
              <table_1.TableHeader>
                <table_1.TableRow>
                  <table_1.TableHead className="w-12">
                    <checkbox_1.Checkbox checked={selectedSuggestions.length ===
            filteredSuggestions.length} onCheckedChange={function (checked) {
            if (checked) {
                setSelectedSuggestions(filteredSuggestions.map(function (s) { return s.productId; }));
            }
            else {
                setSelectedSuggestions([]);
            }
            ...
            return (<table_1.TableRow key={suggestion.productId} className="hover:bg-muted/50">
                      <table_1.TableCell>
                    ...
                    return handleSuggestionSelect(suggestion.productId, checked);
                      ...
                      <table_1.TableCell>
                        <div className="space-y-1">
                          ...
                          {suggestion.temperatureControlled && (<badge_1.Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200 text-xs">
                              Refrigerado
                            </badge_1.Badge>)}
                        </div>
                      </table_1.TableCell>
                      ...
                      <table_1.TableCell>
                        <div className="space-y-2">
                          ...
                          <progress_1.Progress value={(suggestion.currentStock / suggestion.maxStock) *
                    100} className="h-2"/>
                          <div className="text-xs text-muted-foreground">
                    ...
                    suggestion.bulkDiscountTier && (<badge_1.Badge variant="outline" className="bg-green-50 text-green-700 border-green-200 text-xs">
                      ...
                      <table_1.TableCell>
                        <div className="space-y-1">
                          ...
                          {suggestion.lastOrderDate && (<div className="text-xs text-muted-foreground">
                      ...
                      <table_1.TableCell>
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            <progress_1.Progress value={suggestion.stockoutRisk} className="h-2 w-20"/>
                          ...
                          {suggestion.stockoutRisk > 70 && (<badge_1.Badge variant="outline" className="bg-red-50 text-red-700 border-red-200 text-xs">
            ...
            {filteredSuggestions.length === 0 && (<div className="text-center py-8 text-muted-foreground">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <badge_1.Badge variant="outline" className="bg-yellow-50 text-yellow-700 border-yellow-200">
                    Bom
                  </badge_1.Badge>
                </div>
                <div className="space-y-2 text-xs text-muted-foreground">
