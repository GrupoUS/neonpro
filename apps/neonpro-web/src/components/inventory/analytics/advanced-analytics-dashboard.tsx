...
import { 
  ...
  PolarAngleAxis, PolarRadiusAxis, Radar, FunnelChart, 
  Funnel, LabelList
} from 'recharts'
import { 
  TrendingUp, TrendingDown, Package, AlertTriangle, 
  DollarSign, BarChart3, Calendar, Download, 
  Filter, RotateCcw, PieChart as PieChartIcon,
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Tabs defaultValue="turnover" className="space-y-6">
        ...
        </TabsContent>        {/* Category Performance Analysis */}
                ...
                {analyticsData.abcAnalysis.map((item) => (
                  <div key={item.category} className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <Badge 
                        variant={
                          item.category === 'A' ? 'destructive' :
                          item.category === 'B' ? 'default' : 'secondary'
                        }
