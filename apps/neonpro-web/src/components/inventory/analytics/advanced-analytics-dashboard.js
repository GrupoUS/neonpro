...
function AdvancedAnalyticsDashboard() {
  ...
  var _d = (0, react_1.useState)(0),
    refreshKey = _d[0],
    setRefreshKey = _d[1];
  var _e = (0, use_inventory_1.useInventory)(),
    inventoryState = _e.state,
    isLoading = _e.isLoading;
  var _f = (0, use_reports_1.useReports)(),
    generateAnalytics = _f.generateAnalytics,
    exportReport = _f.exportReport,
          ...
          return (
            <card_1.Card key={kpi.id} className="relative overflow-hidden">
              <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <card_1.CardTitle className="text-sm font-medium">{kpi.title}</card_1.CardTitle>
