...
function BarcodeScanner(_a) {
  ...
  var onScan = _a.onScan,
    ...
    _c = _a.showHistory,
    showHistory = _c === void 0 ? true : _c,
    _d = _a.showManualInput,
    showManualInput = _d === void 0 ? true : _d,
    _e = _a.autoStart,
    autoStart = _e === void 0 ? false : _e,
    _f = _a.className,
    className = _f === void 0 ? "" : _f,
    style = _a.style,
    _g = _a.beepOnScan,
    beepOnScan = _g === void 0 ? true : _g,
    _h = _a.vibrationOnScan,
    vibrationOnScan = _h === void 0 ? true : _h,
    _j = _a.preferredCameraFacing,
    preferredCameraFacing = _j === void 0 ? "environment" : _j,
    _k = _a.height,
    height = _k === void 0 ? 300 : _k,
    _l = _a.width,
    width = _l === void 0 ? 400 : _l,
    _m = _a.borderRadius,
    borderRadius = _m === void 0 ? 8 : _m,
    _o = _a.showControls,
    showControls = _o === void 0 ? true : _o,
    _p = _a.showPreview,
    showPreview = _p === void 0 ? true : _p;
  var videoRef = (0, react_1.useRef)(null);
  var _q = (0, react_1.useState)(""),
    manualInput = _q[0],
    setManualInput = _q[1];
  var _r = (0, react_1.useState)(false),
    showManualEntry = _r[0],
    setShowManualEntry = _r[1];
  var _s = (0, react_1.useState)(false),
    flashlightOn = _s[0],
    setFlashlightOn = _s[1];
  var _t = (0, use_barcode_1.useBarcode)({
    ...
    isInitialized = _t.isInitialized,
    hasPermission = _t.hasPermission,
    error = _t.error,
    lastResult = _t.lastResult,
    scanHistory = _t.scanHistory,
    startScanning = _t.startScanning,
    stopScanning = _t.stopScanning,
    toggleScanning = _t.toggleScanning,
    switchCamera = _t.switchCamera,
    availableCameras = _t.availableCameras,
    currentCamera = _t.currentCamera,
    configuration = _t.configuration,
    updateConfiguration = _t.updateConfiguration,
    clearHistory = _t.clearHistory,
        ...
        switch (_b.label) {
          case 0:
            if (
              !(
                isScanning &&
                ((_a = videoRef.current) === null || _a === void 0 ? void 0 : _a.srcObject)
              )
            )
              return [3 /*break*/, 4];
      ...
      <card_1.Card className="w-full max-w-2xl mx-auto">
        <card_1.CardHeader className="pb-3">
          <card_1.CardTitle className="flex items-center justify-between">
            ...
            {isScanning && (
              <badge_1.Badge variant="secondary" className="animate-pulse">
          ...
          {showControls && (
            <div className="flex flex-wrap gap-2 justify-center">
              ...
              {availableCameras.length > 1 && (
                <button_1.Button onClick={switchCamera} variant="outline" disabled={!isInitialized}>
              ...
              {showHistory && scanHistory.length > 0 && (
                <button_1.Button onClick={clearHistory} variant="outline" size="sm">
                  Clear History
                </button_1.Button>
              )}
            </div>
