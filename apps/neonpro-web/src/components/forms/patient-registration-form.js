...
function PatientRegistrationForm(_a) {
    var _this = this;
    var onSubmit = _a.onSubmit, _b = _a.isLoading, isLoading = _b === void 0 ? false : _b;
    var _c = (0, react_1.useState)(false), showLgpdDetails = _c[0], setShowLgpdDetails = _c[1];
    ...
    return (<card_1.Card className="w-full max-w-4xl mx-auto medical-card">
      <card_1.CardHeader className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          {Array.from({ length: totalSteps }, function (_, i) { return (<div key={i} className={"flex-1 h-2 rounded-full transition-colors ".concat(i + 1 <= currentStep ? "bg-primary" : "bg-muted")}/>); })}
        </div>
          ...
          <form onSubmit={form.handleSubmit(handleSubmitForm)} className="space-y-6">
            ...
            {currentStep === 1 && (<div className="space-y-6">
                ...
                return (<form_1.FormItem>
                        ...
                        <form_1.FormControl>
                          <input_1.Input placeholder="Digite o nome completo" {...field} className="bg-background"/>
                        </form_1.FormControl>
                        <form_1.FormMessage />
                      </form_1.FormItem>);
            }}/>
                ...
                return (<form_1.FormItem>
                        ...
                        <form_1.FormControl>
                          <input_1.Input type="email" placeholder="email@exemplo.com" {...field} className="bg-background"/>
                        </form_1.FormControl>
            ...
            {currentStep === 2 && (<div className="space-y-6">
                ...
                return (<form_1.FormItem>
                        ...
                        <form_1.FormControl>
                          <input_1.Input placeholder="Nome completo" {...field} className="bg-background"/>
                        </form_1.FormControl>
                        <form_1.FormMessage />
                      </form_1.FormItem>);
            }}/>

                  <form_1.FormField control={form.control} name="emergency_contact" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <form_1.FormField control={form.control} name="address.street" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="md:col-span-2">
                          <form_1.FormLabel>Rua/Avenida *</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input placeholder="Nome da rua" {...field} className="bg-background"/>
                          </form_1.FormControl>
                          <form_1.FormMessage />
                        </form_1.FormItem>);
            }}/>

                    <form_1.FormField control={form.control} name="address.number" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                          <form_1.FormLabel>Número *</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input placeholder="123" {...field} className="bg-background"/>
                          </form_1.FormControl>
                          <form_1.FormMessage />
                        </form_1.FormItem>);
            }}/>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <form_1.FormField control={form.control} name="address.complement" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                          <form_1.FormLabel>Complemento</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input placeholder="Apt, Bloco, etc." {...field} className="bg-background"/>
                          </form_1.FormControl>
                          <form_1.FormMessage />
                        </form_1.FormItem>);
            }}/>

                    <form_1.FormField control={form.control} name="address.neighborhood" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                          <form_1.FormLabel>Bairro *</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input placeholder="Nome do bairro" {...field} className="bg-background"/>
                          </form_1.FormControl>
                          <form_1.FormMessage />
                        </form_1.FormItem>);
            }}/>
            ...
            {currentStep === 3 && (<div className="space-y-6">
                ...
                return (<form_1.FormItem>
                      ...
                      <form_1.FormControl>
                        <textarea_1.Textarea placeholder="Descreva condições médicas relevantes, cirurgias anteriores, etc." {...field} className="bg-background" rows={3}/>
                      </form_1.FormControl>
                      <form_1.FormDescription>
                ...
                <form_1.FormField control={form.control} name="allergies" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      <form_1.FormLabel>Alergias</form_1.FormLabel>
                      <form_1.FormControl>
                        <textarea_1.Textarea placeholder="Alergias a medicamentos, substâncias, materiais, etc." {...field} className="bg-background" rows={2}/>
                      </form_1.FormControl>
                      <form_1.FormDescription>
                ...
                <form_1.FormField control={form.control} name="medications" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      <form_1.FormLabel>Medicações em Uso</form_1.FormLabel>
                      <form_1.FormControl>
                        <textarea_1.Textarea placeholder="Liste medicações atuais, dosagens e frequência" {...field} className="bg-background" rows={2}/>
                      </form_1.FormControl>
                      <form_1.FormDescription>
            ...
            {currentStep === 4 && (<div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <button_1.Button type="button" variant="link" className="text-blue-600 p-0 h-auto" onClick={function () { return setShowLgpdDetails(!showLgpdDetails); }}>
                        {showLgpdDetails ? (<>
                            <lucide_react_1.EyeOff className="w-4 h-4 mr-1"/> Ocultar detalhes
                          </>) : (<>
                            <lucide_react_1.Eye className="w-4 h-4 mr-1"/> Ver detalhes
                            completos
                          </>)}
                      </button_1.Button>
                    </div>
                ...
                {showLgpdDetails && (<div className="bg-gray-50 border rounded-lg p-4 text-sm space-y-3">
                ...
                <div className="space-y-4">
                  <form_1.FormField control={form.control} name="consent_lgpd" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="lgpd-consent">
                  ...
                  <form_1.FormField control={form.control} name="consent_marketing" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        <div className="flex items-start space-x-3">
                          <form_1.FormControl>
                  ...
                  <form_1.FormField control={form.control} name="consent_whatsapp" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        <div className="flex items-start space-x-3">
                          <form_1.FormControl>
                ...
                <div className="flex justify-between">
                  ...
                  <button_1.Button type="submit" disabled={isLoading || !form.watch("consent_lgpd")}>
