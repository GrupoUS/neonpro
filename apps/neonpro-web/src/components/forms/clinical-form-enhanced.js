...
function ClinicalFormEnhanced(_a) {
  ...
  var _c = (0, react_1.useState)(0),
    formProgress = _c[0],
    setFormProgress = _c[1];
  var _d = (0, react_1.useState)([]),
    aiSuggestions = _d[0],
    setAiSuggestions = _d[1];
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          if (typeSuggestions.length > 0) {
            announceToScreenReader(
              "IA gerou ".concat(typeSuggestions.length, " sugest\u00F5es para este tratamento"),
              "polite",
            );
          }
          return [2 /*return*/];
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        ...
        <card_1.Card className="border-green-200">
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Conforme Lei Geral de Proteção de Dados</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent className="space-y-4">
