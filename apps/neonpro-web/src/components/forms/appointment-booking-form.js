...
function AppointmentBookingForm(_a) {
    var _this = this;
    var patients = _a.patients, professionals = _a.professionals, services = _a.services, onSubmit = _a.onSubmit, _b = _a.isLoading, isLoading = _b === void 0 ? false : _b;
    var _c = (0, react_1.useState)(null), selectedService = _c[0], setSelectedService = _c[1];
    ...
    var generateTimeSlots = function (professional, date) {
        ...
        professional.available_times.forEach(function (timeStr) {
            ...
            if ((0, date_fns_1.isToday)(date) && slotTime <= today)
                return;
            slots.push(slotTime);
        });
        return slots;
    ...
    var formatDateLabel = function (date) {
        ...
        if ((0, date_fns_1.isTomorrow)(date))
            return "Amanh\u00E3 - ".concat((0, date_fns_1.format)(date, 'dd/MM', { locale: locale_1.ptBR }));
        ...
        <form_1.Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmitForm)} className="space-y-8">
            ...
            <div className="flex justify-end gap-3 pt-6 border-t">
              <button_1.Button type="button" variant="outline" onClick={function () { return onCancel === null || onCancel === void 0 ? void 0 : onCancel(); }}>
                Cancelar
              </button_1.Button>
