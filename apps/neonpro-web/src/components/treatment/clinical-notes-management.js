...
function ClinicalNotesManagement(_a) {
    var _this = this;
    var treatmentPlanId = _a.treatmentPlanId, patientId = _a.patientId, onSelectNote = _a.onSelectNote;
    ...
    var _j = (0, react_1.useState)(false), isDialogOpen = _j[0], setIsDialogOpen = _j[1];
    var _k = (0, react_1.useState)(null), editingNote = _k[0], setEditingNote = _k[1];
    var perPage = 10;
    // Form setup
    ...
    var loadData = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadClinicalNotes()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var loadClinicalNotes = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, treatments_1.searchClinicalNotes)(searchFilters, currentPage, perPage)];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, (0, treatments_1.createClinicalNote)(data)];
                case 3:
                    _a.sent();
                    toast({
                        title: 'Sucesso',
    ...
    var handleDeleteNote = function (note) { return __awaiter(_this, void 0, void 0, function () {
        var error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var getNoteType = function (type) {
        return noteTypes.find(function (nt) { return nt.value === type; });
    };
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center">
        <div className="relative flex-1">
          ...
          <input_1.Input placeholder="Buscar notas clínicas..." value={searchText} onChange={function (e) { return handleSearch(e.target.value); }} className="pl-9"/>
        </div>
        ...
        <div className="flex gap-2">
          ...
          <select_1.Select value={filters.note_type || 'all'} onValueChange={function (value) {
            ...
            <select_1.SelectContent>
              ...
              {noteTypes.map(function (type) { return (<select_1.SelectItem key={type.value} value={type.value}>
                  {type.label}
                </select_1.SelectItem>); })}
            </select_1.SelectContent>
          </select_1.Select>
      ...
      <div className="grid gap-4">
        {loading ? (<div className="flex items-center justify-center py-8">
          ...
          </div>) : notes.length === 0 ? (<div className="flex items-center justify-center py-8">
          ...
          </div>) : (notes.map(function (note) {
            var _a, _b, _c;
            var noteType = getNoteType(note.note_type);
            return (<card_1.Card key={note.id} className="cursor-pointer hover:shadow-md transition-shadow" onClick={function () { return onSelectNote === null || onSelectNote === void 0 ? void 0 : onSelectNote(note); }}>
                <card_1.CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    <div className="space-y-1 flex-1">
                      <div className="flex items-center gap-2">
                        <card_1.CardTitle className="text-lg">{note.title}</card_1.CardTitle>
                        {noteType && (<badge_1.Badge className={noteType.color}>
                            {noteType.label}
                          </badge_1.Badge>)}
                      </div>
                      <card_1.CardDescription className="flex items-center gap-4 text-sm">
                        <span className="flex items-center gap-1">
                          ...
                          {(_b = (_a = note.patient) === null || _a === void 0 ? void 0 : _a.given_name) === null || _b === void 0 ? void 0 : _b[0]} {(_c = note.patient) === null || _c === void 0 ? void 0 : _c.family_name}
                        </span>
                        <span className="flex items-center gap-1">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          {(0, date_fns_1.format)(new Date(note.created_at), "HH:mm", { locale: locale_1.ptBR })}
                        </span>
                    ...
                    <dropdown_menu_1.DropdownMenu>
                      <dropdown_menu_1.DropdownMenuTrigger asChild>
                        <button_1.Button variant="ghost" size="sm" onClick={function (e) { return e.stopPropagation(); }}>
                ...
                <card_1.CardContent className="pt-0">
                  ...
                  {note.tags && note.tags.length > 0 && (<div className="flex flex-wrap gap-1 mt-3">
                      {note.tags.map(function (tag, index) { return (<badge_1.Badge key={index} variant="secondary" className="text-xs">
                          {tag}
                        </badge_1.Badge>); })}
                    </div>)}
                </card_1.CardContent>
        ...
        <dialog_1.DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <form_1.Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {commonTemplates.map(function (template, index) { return (<badge_1.Badge key={index} variant="outline" className="cursor-pointer hover:bg-primary hover:text-primary-foreground" onClick={function () { return applyTemplate(template); }}>
            ...
            return (<form_1.FormItem>
                ...
                <form_1.FormField control={form.control} name="note_type" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
              ...
              {/* Date */}
              <form_1.FormField control={form.control} name="created_date" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
              ...
              {/* Content */}
              <form_1.FormField control={form.control} name="content" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    <form_1.FormLabel>Conteúdo da Nota *</form_1.FormLabel>
                    <form_1.FormControl>
                      <textarea_1.Textarea placeholder="Descreva suas observações clínicas..." rows={10} {...field}/>
                    </form_1.FormControl>
                    <form_1.FormDescription>
            ...
            return (<form_1.FormItem>
                    ...
                    <form_1.FormControl>
                      <input_1.Input placeholder="Ex: botox, preenchimento, pós-operatório (separadas por vírgula)" value={((_b = field.value) === null || _b === void 0 ? void 0 : _b.join(', ')) || ''} onChange={function (e) {
