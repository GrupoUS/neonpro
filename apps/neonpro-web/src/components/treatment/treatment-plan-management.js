...
function TreatmentPlanManagement(_a) {
  ...
  var loadData = () =>
    __awaiter(this, void 0, void 0, function () {
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, Promise.all([loadTreatmentPlans(), loadStatistics()])];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              (0, treatments_1.searchTreatmentPlans)(searchFilters, currentPage, perPage),
            ];
          case 1:
            response = _a.sent();
  ...
  var handleDeleteTreatmentPlan = (treatmentPlan) =>
    __awaiter(this, void 0, void 0, function () {
      var error_4;
      return __generator(this, (_a) => {
        switch (_a.label) {
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            <select_1.SelectContent>
              ...
              {Object.entries(statusLabels).map((_a) => {
                var value = _a[0],
                  label = _a[1];
                return (
                    ...
                    {treatmentPlans.map((treatmentPlan) => {
                      ...
                      return (
                        <table_1.TableRow
                          ...
                          onClick={() =>
                            onSelectTreatmentPlan === null || onSelectTreatmentPlan === void 0
                              ? void 0
                        ...
                        >
                          <table_1.TableCell>
                            <div className="font-medium">
                              ...
                              {(_b =
                                (_a = treatmentPlan.patient) === null || _a === void 0
                                  ? void 0
                                  : _a.given_name) === null || _b === void 0
                                ? void 0
                                : _b[0]}{" "}
                              {(_c = treatmentPlan.patient) === null || _c === void 0
                                ? void 0
                                : _c.family_name}
                            </div>
                          </table_1.TableCell>
                            ...
                            <dropdown_menu_1.DropdownMenu>
                              ...
                              <dropdown_menu_1.DropdownMenuContent align="end">
                                ...
                                <dropdown_menu_1.DropdownMenuItem
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    onSelectTreatmentPlan === null ||
                                    onSelectTreatmentPlan === void 0
                                      ? void 0
                                      : onSelectTreatmentPlan(treatmentPlan);
                                  }}
                                >
