...
function ProcedureManagement(_a) {
    var _this = this;
    var _b;
    var treatmentPlanId = _a.treatmentPlanId, patientId = _a.patientId, onSelectProcedure = _a.onSelectProcedure;
    var toast = (0, use_toast_1.useToast)().toast;
    // State management
    var _c = (0, react_1.useState)([]), procedures = _c[0], setProcedures = _c[1];
    ...
    var _k = (0, react_1.useState)(false), isDialogOpen = _k[0], setIsDialogOpen = _k[1];
    var _l = (0, react_1.useState)(null), editingProcedure = _l[0], setEditingProcedure = _l[1];
    var perPage = 10;
    // Form setup
    ...
    var loadData = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadProcedures()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var loadProcedures = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, treatments_1.searchProcedures)(searchFilters, currentPage, perPage)];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, (0, treatments_1.createProcedure)(data)];
                case 3:
                    _a.sent();
                    toast({
                        title: 'Sucesso',
    ...
    var handleDeleteProcedure = function (procedure) { return __awaiter(_this, void 0, void 0, function () {
        var error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var getStatusOption = function (status) {
        return statusOptions.find(function (option) { return option.value === status; });
    };
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center">
        <div className="relative flex-1">
          ...
          <input_1.Input placeholder="Buscar procedimentos..." value={searchText} onChange={function (e) { return handleSearch(e.target.value); }} className="pl-9"/>
        </div>
        
        <div className="flex gap-2">
          {!patientId && (<select_1.Select value={filters.patient_id || 'all'} onValueChange={function (value) {
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          {loading ? (<div className="flex items-center justify-center py-8">
            ...
            </div>) : procedures.length === 0 ? (<div className="flex items-center justify-center py-8">
              ...
              <table_1.TableBody>
                ...
                return (<table_1.TableRow key={procedure.id} className="cursor-pointer hover:bg-muted/50" onClick={function () { return onSelectProcedure === null || onSelectProcedure === void 0 ? void 0 : onSelectProcedure(procedure); }}>
                      <table_1.TableCell>
                        <div className="font-medium">{procedure.display}</div>
                        {procedure.reason_display && (<div className="text-sm text-muted-foreground">
                      ...
                      <table_1.TableCell>
                        <div className="font-medium">
                          ...
                          {(_b = (_a = procedure.patient) === null || _a === void 0 ? void 0 : _a.given_name) === null || _b === void 0 ? void 0 : _b[0]} {(_c = procedure.patient) === null || _c === void 0 ? void 0 : _c.family_name}
                        </div>
                      </table_1.TableCell>
                      <table_1.TableCell>
                        {statusOption && (<badge_1.Badge className={statusOption.color}>
                            {statusOption.label}
                          </badge_1.Badge>)}
                      </table_1.TableCell>
                      <table_1.TableCell>
                        {procedure.performed_date_time ? (formatDateTime(procedure.performed_date_time)) : (<span className="text-muted-foreground">Não realizado</span>)}
                      </table_1.TableCell>
                      <table_1.TableCell>
                      ...
                      <table_1.TableCell>
                        ...
                        e.stopPropagation();
                        onSelectProcedure === null || onSelectProcedure === void 0 ? void 0 : onSelectProcedure(procedure);
                    }}>
        ...
        <dialog_1.DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <form_1.Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {commonProcedures.map(function (procedure) { return (<badge_1.Badge key={procedure} variant="outline" className="cursor-pointer hover:bg-primary hover:text-primary-foreground" onClick={function () { return selectCommonProcedure(procedure); }}>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <form_1.FormField control={form.control} name="display" render={function (_a) {
            var field = _a.field;
            ...
            return (<form_1.FormItem>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {!patientId && (<form_1.FormField control={form.control} name="patient_id" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
            ...
            return (<form_1.FormItem>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <form_1.FormField control={form.control} name="performed_date_time" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                ...
                <form_1.FormField control={form.control} name="location" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                      <form_1.FormLabel>Local</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input placeholder="Ex: Sala 1, Consultório principal" {...field}/>
                      </form_1.FormControl>
                      <form_1.FormMessage />
                    </form_1.FormItem>);
        }}/>
              ...
              {/* Reason */}
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <form_1.FormField control={form.control} name="reason_display" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                ...
                <form_1.FormField control={form.control} name="outcome" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                      <form_1.FormLabel>Resultado</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input placeholder="Ex: Procedimento realizado com sucesso" {...field}/>
                      </form_1.FormControl>
                      <form_1.FormMessage />
                    </form_1.FormItem>);
        }}/>
            ...
            return (<form_1.FormItem>
                    ...
                    <form_1.FormControl>
                      <textarea_1.Textarea placeholder="Adicione observações sobre o procedimento, reações do paciente, cuidados pós-procedimento..." rows={4} {...field}/>
                    </form_1.FormControl>
                    <form_1.FormDescription>
