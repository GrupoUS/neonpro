...
function PatientSegmentation(_a) {
  ...
  var _c = (0, react_1.useState)(null),
    selectedSegment = _c[0],
    setSelectedSegment = _c[1];
  ...
  var _g = (0, react_1.useState)(""),
    searchQuery = _g[0],
    setSearchQuery = _g[1];
  var _h = (0, react_1.useState)("segments"),
    activeTab = _h[0],
    setActiveTab = _h[1];
  var _j = (0, react_1.useState)(false),
    showCreateDialog = _j[0],
    setShowCreateDialog = _j[1];
  var _k = (0, react_1.useState)(false),
    showSegmentDetails = _k[0],
    setShowSegmentDetails = _k[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              patient_segmentation_1.patientSegmentation.createSegment(
                newSegment.name,
          ...
          case 2:
            ...
            sonner_1.toast.success(
              'Segmento "'.concat(segment_1.criteria.name, '" criado com sucesso!'),
            );
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              patient_segmentation_1.patientSegmentation.deleteSegment(segmentId),
            ];
          case 1:
            _a.sent();
            setSegments(function (prev) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              patient_segmentation_1.patientSegmentation.generateSegment(segment.criteria, {
                refreshData: true,
              }),
            ];
          case 1:
          ...
          <dialog_1.Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
            ...
            <dialog_1.DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label_1.Label htmlFor="segment-criteria">
                    Critérios em Linguagem Natural
                  </label_1.Label>
                  <textarea_1.Textarea
                    id="segment-criteria"
          ...
          {analytics && (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <card_1.Card>
                  <card_1.CardHeader>
                    <card_1.CardTitle className="text-green-600">
                      Segmentos Crescendo
                    </card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                ...
                <card_1.Card>
                  <card_1.CardHeader>
                    <card_1.CardTitle className="text-blue-600">
                      Segmentos Estáveis
                    </card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                ...
                <card_1.Card>
                  <card_1.CardHeader>
                    <card_1.CardTitle className="text-red-600">
                  ...
                  <div className="text-center">
                    <div
                      className={"text-2xl font-bold ".concat(
                        getPerformanceColor(selectedSegment.performance.accuracy),
                      )}
                    >
