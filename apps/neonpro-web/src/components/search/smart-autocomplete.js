...
function SmartAutocomplete(_a) {
  var value = _a.value,
    ...
    context = _a.context,
    _b = _a.placeholder,
    placeholder = _b === void 0 ? "Buscar..." : _b,
    _c = _a.disabled,
    disabled = _c === void 0 ? false : _c,
    className = _a.className,
    _d = _a.maxSuggestions,
    maxSuggestions = _d === void 0 ? 8 : _d,
    _e = _a.showCategories,
    showCategories = _e === void 0 ? true : _e,
    _f = _a.showIcons,
    showIcons = _f === void 0 ? true : _f,
    _g = _a.enableLearning,
    enableLearning = _g === void 0 ? true : _g;
  // State
  ...
  var _k = (0, react_1.useState)(false),
    isLoading = _k[0],
    setIsLoading = _k[1];
  var _l = (0, react_1.useState)(-1),
    selectedIndex = _l[0],
    setSelectedIndex = _l[1];
  var _m = (0, react_1.useState)(0),
    interactionStartTime = _m[0],
    setInteractionStartTime = _m[1];
  // Refs
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                search_suggestions_1.searchSuggestions.getSuggestions(query, context, options),
              ];
            case 2:
              results = _a.sent();
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              search_suggestions_1.searchSuggestions.learnFromInteraction(learningData),
            ];
          case 1:
            _a.sent();
            _a.label = 2;
                                    ...
                                    >
                                      <div className="flex items-center flex-1 min-w-0">
                                        ...
                                        <div className="ml-3 flex-1 min-w-0">
                                          ...
                                          {((_a = suggestion.metadata) === null || _a === void 0
                                            ? void 0
                                            : _a.context) && (
...
function EnhancedSmartAutocomplete(_a) {
  var value = _a.value,
    ...
    onSearch = _a.onSearch,
    context = _a.context,
    props = __rest(_a, ["value", "onValueChange", "onSuggestionSelect", "onSearch", "context"]);
  var _b = (0, react_1.useState)(false),
    showAdvanced = _b[0],
    setShowAdvanced = _b[1];
