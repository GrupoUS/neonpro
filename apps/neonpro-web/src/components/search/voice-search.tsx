      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {session && <Badge variant="outline">{queries.length} consultas</Badge>}
            </div>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            {session && (
              <Button variant="outline" onClick={endSession} disabled={isListening || isProcessing}>
                Finalizar Sessão
              </Button>
            )}
          ...
          {errors.length > 0 && (
            <Alert variant="destructive">
              ...
              <AlertDescription>{errors[errors.length - 1].message}</AlertDescription>
            </Alert>
          )}
