...
function AnalyticsDashboard(_a) {
    var _this = this;
    var userId = _a.userId, className = _a.className, _b = _a.autoRefresh, autoRefresh = _b === void 0 ? true : _b, _c = _a.refreshInterval // 30 seconds
    , refreshInterval = _c === void 0 ? 30000 : _c // 30 seconds
    ;
    // State
    var _d = (0, react_1.useState)(null), metrics = _d[0], setMetrics = _d[1];
    var _e = (0, react_1.useState)([]), alerts = _e[0], setAlerts = _e[1];
    var _f = (0, react_1.useState)([]), optimizations = _f[0], setOptimizations = _f[1];
    ...
    var _k = (0, react_1.useState)({
        ...
        to: new Date()
    }), selectedTimeRange = _k[0], setSelectedTimeRange = _k[1];
    var _l = (0, react_1.useState)('all'), selectedSearchType = _l[0], setSelectedSearchType = _l[1];
    var _m = (0, react_1.useState)('overview'), activeTab = _m[0], setActiveTab = _m[1];
    var _o = (0, react_1.useState)({}), realTimeMetrics = _o[0], setRealTimeMetrics = _o[1];
    // Load analytics data
    var loadAnalytics = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), metricsData = _a[0], alertsData = _a[1], optimizationsData = _a[2], reportData = _a[3];
    ...
    return (<div className={(0, utils_1.cn)("space-y-6", className)}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <date_range_picker_1.DatePickerWithRange date={selectedTimeRange} onDateChange={setSelectedTimeRange}/>
          ...
          <button_1.Button variant="outline" size="sm" onClick={loadAnalytics} disabled={loading}>
            {loading ? (<lucide_react_1.Loader2 className="h-4 w-4 animate-spin"/>) : (<lucide_react_1.RefreshCw className="h-4 w-4"/>)}
          </button_1.Button>
        </div>
      </div>

      {/* Critical Alerts */}
      {alerts.filter(function (a) { return a.severity === 'critical'; }).length > 0 && (<alert_1.Alert variant="destructive">
          <lucide_react_1.AlertTriangle className="h-4 w-4"/>
          <alert_1.AlertDescription>
            <strong>{alerts.filter(function (a) { return a.severity === 'critical'; }).length} alertas críticos</strong> detectados.
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              {formatNumber((metrics === null || metrics === void 0 ? void 0 : metrics.totalSearches) || 0)}
            </div>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              {formatDuration((metrics === null || metrics === void 0 ? void 0 : metrics.averageResponseTime) || 0)}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              {formatPercentage((metrics === null || metrics === void 0 ? void 0 : metrics.successRate) || 0)}
            </div>
            <progress_1.Progress value={((metrics === null || metrics === void 0 ? void 0 : metrics.successRate) || 0) * 100} className="mt-2"/>
          </card_1.CardContent>
        </card_1.Card>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              {formatPercentage((metrics === null || metrics === void 0 ? void 0 : metrics.userEngagement.clickThroughRate) || 0)}
            </div>
            <p className="text-xs text-muted-foreground">
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <card_1.CardContent>
                <recharts_1.ResponsiveContainer width="100%" height={300}>
                  <recharts_1.AreaChart data={trends}>
                    ...
                    <recharts_1.YAxis />
                    <recharts_1.Tooltip formatter={function (value) { return [formatDuration(value), 'Tempo de Resposta']; }}/>
                    <recharts_1.Area type="monotone" dataKey="metrics.averageResponseTime" stroke={CHART_COLORS.primary} fill={CHART_COLORS.primary} fillOpacity={0.3}/>
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <recharts_1.ResponsiveContainer width="100%" height={300}>
                  <recharts_1.PieChart>
                    <recharts_1.Pie data={(metrics === null || metrics === void 0 ? void 0 : metrics.searchTypes) || []} cx="50%" cy="50%" labelLine={false} label={function (_a) {
        var type = _a.type, count = _a.count;
        return "".concat(type, ": ").concat(count);
    }} outerRadius={80} fill="#8884d8" dataKey="count">
                      {((metrics === null || metrics === void 0 ? void 0 : metrics.searchTypes) || []).map(function (entry, index) { return (<recharts_1.Cell key={"cell-".concat(index)} fill={PIE_COLORS[index % PIE_COLORS.length]}/>); })}
                    </recharts_1.Pie>
                    <recharts_1.Tooltip />
                  </recharts_1.PieChart>
                </recharts_1.ResponsiveContainer>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-3">
                {((metrics === null || metrics === void 0 ? void 0 : metrics.popularQueries) || []).slice(0, 10).map(function (query, index) { return (<div key={index} className="flex items-center justify-between">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-sm">
                      ...
                      <span>{formatDuration((metrics === null || metrics === void 0 ? void 0 : metrics.performanceBreakdown.nlpProcessing) || 0)}</span>
                    </div>
                    <progress_1.Progress value={((metrics === null || metrics === void 0 ? void 0 : metrics.performanceBreakdown.nlpProcessing) || 0) / ((metrics === null || metrics === void 0 ? void 0 : metrics.performanceBreakdown.total) || 1) * 100} className="mt-1"/>
                  </div>
                  
                  <div>
                    <div className="flex justify-between text-sm">
                      <span>Consulta ao Banco</span>
                      <span>{formatDuration((metrics === null || metrics === void 0 ? void 0 : metrics.performanceBreakdown.databaseQuery) || 0)}</span>
                    </div>
                    <progress_1.Progress value={((metrics === null || metrics === void 0 ? void 0 : metrics.performanceBreakdown.databaseQuery) || 0) / ((metrics === null || metrics === void 0 ? void 0 : metrics.performanceBreakdown.total) || 1) * 100} className="mt-1"/>
                  </div>
                  
                  <div>
                    <div className="flex justify-between text-sm">
                      <span>Processamento de Resultados</span>
                      <span>{formatDuration((metrics === null || metrics === void 0 ? void 0 : metrics.performanceBreakdown.resultProcessing) || 0)}</span>
                    </div>
                    <progress_1.Progress value={((metrics === null || metrics === void 0 ? void 0 : metrics.performanceBreakdown.resultProcessing) || 0) / ((metrics === null || metrics === void 0 ? void 0 : metrics.performanceBreakdown.total) || 1) * 100} className="mt-1"/>
                  </div>
                </div>
              </card_1.CardContent>
            </card_1.Card>
              ...
              <card_1.CardContent>
                <recharts_1.ResponsiveContainer width="100%" height={300}>
                  <recharts_1.LineChart data={trends}>
                    ...
                    <recharts_1.Tooltip formatter={function (value) { return [formatPercentage(value), 'Taxa de Sucesso']; }}/>
                    <recharts_1.Line type="monotone" dataKey="metrics.successRate" stroke={CHART_COLORS.secondary} strokeWidth={2}/>
            ...
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {formatNumber((metrics === null || metrics === void 0 ? void 0 : metrics.userEngagement.averageResultsViewed) || 0, 1)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">Taxa de Refinamento</span>
                  <span className="font-medium">
                    {formatPercentage((metrics === null || metrics === void 0 ? void 0 : metrics.userEngagement.refinementRate) || 0)}
                  </span>
                </div>
              </card_1.CardContent>
            </card_1.Card>
            ...
            <card_1.Card className="lg:col-span-2">
              ...
              <card_1.CardContent>
                <recharts_1.ResponsiveContainer width="100%" height={200}>
                  <recharts_1.BarChart data={(metrics === null || metrics === void 0 ? void 0 : metrics.searchTypes) || []}>
                    <recharts_1.CartesianGrid strokeDasharray="3 3"/>
              ...
              <scroll_area_1.ScrollArea className="h-96">
                <div className="space-y-3">
                  {alerts.length === 0 ? (<div className="text-center py-8 text-muted-foreground">
                    ...
                    </div>) : (alerts.map(function (alert) { return (<div key={alert.id} className={(0, utils_1.cn)("p-3 rounded-lg border", getAlertSeverityColor(alert.severity))}>
        ...
        <tabs_1.TabsContent value="optimizations" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {optimizations.length === 0 ? (<div className="text-center py-8 text-muted-foreground">
                    <lucide_react_1.Lightbulb className="h-12 w-12 mx-auto mb-2"/>
                    <p>Nenhuma otimização sugerida no momento</p>
                  </div>) : (optimizations.map(function (optimization, index) { return (<div key={index} className="p-4 border rounded-lg">
                      ...
                      {optimization.optimization.implementation && (<div className="mt-3 p-2 bg-muted rounded text-xs font-mono">
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, search_analytics_1.searchAnalytics.getSearchMetrics({
                                timeRange: {
      ...
      <card_1.CardContent className="space-y-3">
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div>
            ...
            <div className="font-medium">{(metrics === null || metrics === void 0 ? void 0 : metrics.totalSearches) || 0}</div>
          </div>
          <div>
