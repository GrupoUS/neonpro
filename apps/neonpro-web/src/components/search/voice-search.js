...
function VoiceSearch(_a) {
  var onSearchResults = _a.onSearchResults,
    ...
    _c = _a.showCommands,
    showCommands = _c === void 0 ? true : _c,
    _d = _a.showAnalytics,
    showAnalytics = _d === void 0 ? false : _d,
    _e = _a.autoStart,
  ...
  var _g = (0, react_1.useState)(false),
    isProcessing = _g[0],
    setIsProcessing = _g[1];
  var _h = (0, react_1.useState)(""),
    currentTranscript = _h[0],
    setCurrentTranscript = _h[1];
  var _j = (0, react_1.useState)(""),
    interimTranscript = _j[0],
    setInterimTranscript = _j[1];
  ...
  var _q = (0, react_1.useState)(false),
    permissionGranted = _q[0],
    setPermissionGranted = _q[1];
        ...
        <card_1.CardContent className="pt-6">
          <alert_1.Alert>
            ...
            <alert_1.AlertDescription>
              Reconhecimento de voz não é suportado neste navegador. Tente usar Chrome, Edge ou
              Safari mais recentes.
            </alert_1.AlertDescription>
          </alert_1.Alert>
        </card_1.CardContent>
      </card_1.Card>
        ...
        <card_1.CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {session && (
                <badge_1.Badge variant="outline">{queries.length} consultas</badge_1.Badge>
              )}
            </div>
          </div>
        </card_1.CardHeader>
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            >
              {isProcessing
                ...
                : isListening
                  ? <lucide_react_1.Square className="h-6 w-6" />
                  : <lucide_react_1.Mic className="h-6 w-6" />}
            </button_1.Button>
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span
                  className={(0, utils_1.cn)(
                    "font-medium",
                    audioLevel > 50 ? "text-green-600" : "text-gray-500",
                  )}
                >
            ...
            {(currentTranscript || interimTranscript) && (
              <div className="p-3 bg-muted rounded-lg">
                <div className="flex items-start justify-between gap-2">
                  ...
                  {confidence > 0 && (
                    <badge_1.Badge variant="outline" className={getConfidenceColor(confidence)}>
