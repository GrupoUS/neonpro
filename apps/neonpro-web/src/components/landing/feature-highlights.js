      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {complianceFeatures.map(function (feature, index) { return (<card_1.Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800">
                ...
                <card_1.CardContent className="pt-0">
                  ...
                  <ul className="space-y-2">
                    {feature.details.map(function (detail, idx) { return (<li key={idx} className="flex items-center text-sm text-slate-600 dark:text-slate-400">
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {intelligentFeatures.map(function (feature, index) { return (<card_1.Card key={index} className="text-center border-0 shadow-md hover:shadow-lg transition-shadow">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreFeatures.map(function (feature, index) { return (<div key={index} className="group cursor-pointer">
