...
function TestimonialsSection() {
    return (<div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
        {overallStats.map(function (stat, index) { return (<card_1.Card key={index} className="text-center bg-white border-slate-200 hover:border-[#6366f1]/30 transition-colors">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        {testimonials.map(function (testimonial) { return (<card_1.Card key={testimonial.id} className="group hover:shadow-xl transition-all duration-300 border-slate-200 hover:border-[#6366f1]/30">
                ...
                <div className="flex items-center space-x-3">
                  <avatar_1.Avatar className="h-12 w-12 border-2 border-[#6366f1]/20">
                    ...
                    <avatar_1.AvatarFallback className="bg-gradient-to-br from-[#6366f1] to-purple-600 text-white font-semibold">
                      {testimonial.name.split(' ').map(function (n) { return n[0]; }).join('')}
      ...
      <div className="bg-gradient-to-br from-[#6366f1] to-purple-600 rounded-2xl p-8 text-white text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="pt-4">
            <button_1.Button size="lg" className="bg-white text-[#6366f1] hover:bg-white/90 font-semibold shadow-xl">
