    ...
    <section className="py-16 lg:py-24 bg-white dark:bg-slate-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <card_1.CardContent className="p-6">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  {Object.entries(testimonial.metrics).map((_a, idx) => {
                    var key = _a[0],
                      value = _a[1];
                    return (
                      <div
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2">
                      ...
                      {testimonial.verified && (
                        <badge_1.Badge className="bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300 text-xs">
                          Verificado
                        </badge_1.Badge>
                      )}
                    </div>
        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-8 lg:p-12 text-center">
          <badge_1.Badge className="mb-4 bg-white/20 text-white">Depoimento em Vídeo</badge_1.Badge>
          ...
          <div className="relative bg-slate-700 rounded-xl overflow-hidden max-w-4xl mx-auto mb-8">
            ...
            <div className="absolute top-4 right-4">
              <badge_1.Badge className="bg-red-600 text-white text-xs">AO VIVO</badge_1.Badge>
            </div>
          </div>
