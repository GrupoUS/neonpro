...
function DemoRequest() {
    ...
    if (isSubmitted) {
        return (<section id="demo" className="py-16 lg:py-24 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950">
    ...
    return (<section id="demo" className="py-16 lg:py-24 bg-slate-50 dark:bg-slate-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            {benefits.map(function (benefit, index) { return (<div key={index} className="flex items-start space-x-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input_1.Input id="name" type="text" value={formData.name} onChange={function (e) { return handleInputChange('name', e.target.value); }} required placeholder="Dr. João Silva"/>
                    </div>
                    
                    <div className="space-y-2">
                      <label_1.Label htmlFor="email">E-mail Profissional *</label_1.Label>
                      <input_1.Input id="email" type="email" value={formData.email} onChange={function (e) { return handleInputChange('email', e.target.value); }} required placeholder="joao@clinica.com.br"/>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input_1.Input id="phone" type="tel" value={formData.phone} onChange={function (e) { return handleInputChange('phone', e.target.value); }} required placeholder="(11) 99999-0000"/>
                    </div>

                    <div className="space-y-2">
                      <label_1.Label htmlFor="bestTime">Melhor Horário</label_1.Label>
                      <select_1.Select onValueChange={function (value) { return handleInputChange('bestTime', value); }}>
                        ...
                        <select_1.SelectContent>
                          ...
                          <select_1.SelectItem value="afternoon">Tarde (13h-17h)</select_1.SelectItem>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input_1.Input id="clinicName" type="text" value={formData.clinicName} onChange={function (e) { return handleInputChange('clinicName', e.target.value); }} required placeholder="Clínica Bella Vita"/>
                    </div>

                    <div className="space-y-2">
                      <label_1.Label htmlFor="clinicType">Tipo de Clínica *</label_1.Label>
                      <select_1.Select onValueChange={function (value) { return handleInputChange('clinicType', value); }}>
                        <select_1.SelectTrigger>
                        ...
                        <select_1.SelectContent>
                          ...
                          <select_1.SelectItem value="plastic-surgery">Cirurgia Plástica</select_1.SelectItem>
                          <select_1.SelectItem value="beauty">Beleza e Bem-estar</select_1.SelectItem>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      ...
                      <input_1.Input id="city" type="text" value={formData.city} onChange={function (e) { return handleInputChange('city', e.target.value); }} required placeholder="São Paulo"/>
                    </div>

                    <div className="space-y-2">
                      <label_1.Label htmlFor="state">Estado *</label_1.Label>
                      <select_1.Select onValueChange={function (value) { return handleInputChange('state', value); }}>
                        <select_1.SelectTrigger>
                          <select_1.SelectValue placeholder="UF"/>
                        </select_1.SelectTrigger>
                        <select_1.SelectContent>
                          {states.map(function (state) { return (<select_1.SelectItem key={state} value={state}>{state}</select_1.SelectItem>); })}
                        </select_1.SelectContent>
                      </select_1.Select>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <select_1.Select onValueChange={function (value) { return handleInputChange('currentPatients', value); }}>
                        <select_1.SelectTrigger>
                  ...
                  <div className="space-y-2">
                    <label_1.Label htmlFor="painPoints">Principais Desafios (Opcional)</label_1.Label>
                    <textarea_1.Textarea id="painPoints" value={formData.painPoints} onChange={function (e) { return handleInputChange('painPoints', e.target.value); }} placeholder="Ex: conflitos de agenda, dificuldade com compliance, relatórios manuais..." rows={3}/>
                  </div>

                  {/* Consent Checkboxes */}
                  <div className="space-y-3">
                    <div className="flex items-start space-x-2">
                      <checkbox_1.Checkbox id="gdprConsent" checked={formData.gdprConsent} onCheckedChange={function (checked) { return handleInputChange('gdprConsent', checked); }} required/>
                    ...
                    <div className="flex items-start space-x-2">
                      <checkbox_1.Checkbox id="marketingConsent" checked={formData.marketingConsent} onCheckedChange={function (checked) { return handleInputChange('marketingConsent', checked); }}/>
                  ...
                  {/* Submit Button */}
                  <button_1.Button type="submit" disabled={isSubmitting || !formData.gdprConsent} className="w-full bg-sky-600 hover:bg-sky-700 text-white py-3 text-base font-semibold" size="lg">
                    {isSubmitting ? (<>
