          ...
          <TabsContent value="thresholds" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Set minimum performance requirements for models</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="advanced" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Performance optimization and system configuration</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
