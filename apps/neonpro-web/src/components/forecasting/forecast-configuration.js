...
function ForecastConfiguration(_a) {
    ...
    var _c = (0, react_1.useState)(DEFAULT_CONFIG), config = _c[0], setConfig = _c[1];
    var _d = (0, react_1.useState)(false), loading = _d[0], setSaving = _d[1];
    ...
    // Save configuration
    var saveConfiguration = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setSaving(true);
                    // Simulate API call
                    return [4 /*yield*/, fetch('/api/forecasting/configuration', {
                            method: 'POST',
    ...
    var exportConfiguration = function () {
        ...
        var exportFileDefaultName = "forecast-config-".concat(new Date().toISOString().split('T')[0], ".json");
    ...
    // Test configuration
    var testConfiguration = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch('/api/forecasting/configuration/test', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify(config)
                        })];
    ...
    return (<card_1.Card className={className}>
      <card_1.CardHeader>
        <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
          ...
          <div className="flex items-center space-x-2">
            {hasChanges && (<badge_1.Badge variant="outline" className="bg-yellow-100 text-yellow-800">
            ...
            <button_1.Button variant="outline" size="sm" onClick={testConfiguration} disabled={loading}>
              <lucide_react_1.Zap className="h-4 w-4 mr-1"/>
              Test
            </button_1.Button>
            
            <button_1.Button size="sm" onClick={saveConfiguration} disabled={loading || !hasChanges}>
              {loading ? (<>
      ...
      <card_1.CardContent>
              ...
              <card_1.CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <select_1.Select value={config.primaryModel} onValueChange={function (value) { return updateConfig({ primaryModel: value }); }}>
                      <select_1.SelectTrigger>
                        <select_1.SelectValue placeholder="Select primary model"/>
                      </select_1.SelectTrigger>
                      <select_1.SelectContent>
                        {AVAILABLE_MODELS.map(function (model) { return (<select_1.SelectItem key={model.id} value={model.id}>
                            <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <select_1.Select value={config.fallbackModel} onValueChange={function (value) { return updateConfig({ fallbackModel: value }); }}>
                      <select_1.SelectTrigger>
                        <select_1.SelectValue placeholder="Select fallback model"/>
                      </select_1.SelectTrigger>
                      <select_1.SelectContent>
                        {AVAILABLE_MODELS.filter(function (m) { return m.id !== config.primaryModel; }).map(function (model) { return (<select_1.SelectItem key={model.id} value={model.id}>
                            <div>
                              <div className="font-medium">{model.name}</div>
                              <div className="text-xs text-muted-foreground">{model.description}</div>
                            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <switch_1.Switch id="ensemble-enabled" checked={config.ensembleEnabled} onCheckedChange={function (checked) { return updateConfig({ ensembleEnabled: checked }); }}/>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <switch_1.Switch id="auto-retraining" checked={config.autoRetraining} onCheckedChange={function (checked) { return updateConfig({ autoRetraining: checked }); }}/>
                  </div>

                  {config.autoRetraining && (<div className="space-y-2">
                      <label_1.Label htmlFor="retraining-interval">Retraining Interval (days)</label_1.Label>
        ...
        }} max={30} min={1} step={1} className="flex-1"/>
              ...
              <card_1.CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <slider_1.Slider value={[config.accuracyThreshold]} onValueChange={function (_a) {
        var value = _a[0];
        return updateConfig({ accuracyThreshold: value });
                  ...
                  <div className="space-y-2">
                    <label_1.Label>Confidence Threshold: {config.confidenceThreshold}%</label_1.Label>
                    <slider_1.Slider value={[config.confidenceThreshold]} onValueChange={function (_a) {
        var value = _a[0];
        return updateConfig({ confidenceThreshold: value });
                  ...
                  <div className="space-y-2">
                    <label_1.Label>Drift Threshold: {(config.driftThreshold * 100).toFixed(1)}%</label_1.Label>
                    <slider_1.Slider value={[config.driftThreshold * 100]} onValueChange={function (_a) {
        var value = _a[0];
              ...
              <card_1.CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <switch_1.Switch checked={config.alertsEnabled} onCheckedChange={function (checked) { return updateConfig({ alertsEnabled: checked }); }}/>
                  </div>
                  ...
                  {config.alertsEnabled && (<>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <switch_1.Switch checked={config.emailNotifications} onCheckedChange={function (checked) { return updateConfig({ emailNotifications: checked }); }}/>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <switch_1.Switch checked={config.slackNotifications} onCheckedChange={function (checked) { return updateConfig({ slackNotifications: checked }); }}/>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <label_1.Label>Demand Spike Alert: {config.alertThresholds.demandSpike}%</label_1.Label>
                          <slider_1.Slider value={[config.alertThresholds.demandSpike]} onValueChange={function (_a) {
                var value = _a[0];
                return updateConfig({
                    alertThresholds: __assign(__assign({}, config.alertThresholds), { demandSpike: value })
                });
                        ...
                        <div className="space-y-2">
                          <label_1.Label>Resource Shortage Alert: {config.alertThresholds.resourceShortage}%</label_1.Label>
                          <slider_1.Slider value={[config.alertThresholds.resourceShortage]} onValueChange={function (_a) {
                var value = _a[0];
                return updateConfig({
                    alertThresholds: __assign(__assign({}, config.alertThresholds), { resourceShortage: value })
                });
              ...
              <card_1.CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <slider_1.Slider value={[config.dataRetentionDays]} onValueChange={function (_a) {
        var value = _a[0];
     ...
     min={30} step={30}/>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <switch_1.Switch checked={config.externalFactorsEnabled} onCheckedChange={function (checked) { return updateConfig({ externalFactorsEnabled: checked }); }}/>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <switch_1.Switch checked={config.seasonalAdjustment} onCheckedChange={function (checked) { return updateConfig({ seasonalAdjustment: checked }); }}/>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <switch_1.Switch checked={config.holidayAdjustment} onCheckedChange={function (checked) { return updateConfig({ holidayAdjustment: checked }); }}/>
                    </div>
                  </div>
                </div>
              </card_1.CardContent>
              ...
              <card_1.CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <switch_1.Switch checked={config.parallelProcessing} onCheckedChange={function (checked) { return updateConfig({ parallelProcessing: checked }); }}/>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <switch_1.Switch checked={config.cacheEnabled} onCheckedChange={function (checked) { return updateConfig({ cacheEnabled: checked }); }}/>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <switch_1.Switch checked={config.debugMode} onCheckedChange={function (checked) { return updateConfig({ debugMode: checked }); }}/>
                  </div>

                  <div className="space-y-2">
                    <label_1.Label>API Rate Limit: {config.apiRateLimit} requests/minute</label_1.Label>
                    <slider_1.Slider value={[config.apiRateLimit]} onValueChange={function (_a) {
        var value = _a[0];
