...
var ScheduleConflictResolverOptimized = function () {
  ...
  var _c = (0, react_1.useState)([]),
    selectedConflicts = _c[0],
    setSelectedConflicts = _c[1];
  var _d = (0, react_1.useState)(false),
    isResolving = _d[0],
    setIsResolving = _d[1];
  var _e = useOptimizedConflictApi(),
    debouncedSearch = _e.debouncedSearch,
    deduplicatedRequest = _e.deduplicatedRequest,
    batchedConflictCheck = _e.batchedConflictCheck;
  var _f = useCacheManager(),
    invalidateConflictCache = _f.invalidateConflictCache,
    setCachedData = _f.setCachedData;
  ...
  var _g = (0, react_query_1.useQuery)({
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [
                          4 /*yield*/,
                          fetch("/api/scheduling/conflicts", {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({
                              search: searchTerm,
    ...
    conflictsData = _g.data,
    conflictsLoading = _g.isLoading,
    conflictsError = _g.error,
  ...
  var resolveConflictsMutation = (0, react_query_1.useMutation)({
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                fetch("/api/scheduling/conflicts/resolve-batch", {
                  method: "POST",
                  headers: {
                  ...
                  body: JSON.stringify(
                    __assign(__assign({}, resolutionData), {
                      timestamp: new Date().toISOString(),
    ...
    onSuccess: function (data) {
      ...
      sonner_1.toast.success("Successfully resolved ".concat(data.resolvedCount, " conflicts"), {
        description: ""
          .concat(data.rescheduled, " rescheduled, ")
  ...
  return (
    <div className="space-y-6 p-6">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              {(conflictStats === null || conflictStats === void 0
                ? void 0
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold text-orange-600">
              {(conflictStats === null || conflictStats === void 0 ? void 0 : conflictStats.high) ||
                0}
            </div>
          </card_1.CardContent>
        </card_1.Card>
      ...
      {selectedConflicts.length > 0 && (
        <card_1.Card className="mb-6 border-blue-200 bg-blue-50">
  ...
  return (
    <div
      className={"border rounded-lg p-4 "
        .concat(getSeverityColor(conflict.severity), " ")
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              ...
              {conflict.metadata.emergencyFlag && (
                <badge_1.Badge variant="destructive">EMERGENCY</badge_1.Badge>
              )}
            </div>
