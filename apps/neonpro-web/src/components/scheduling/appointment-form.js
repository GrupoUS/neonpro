...
var AppointmentForm = (_a) => {
  ...
  var _b = (0, react_1.useState)(""),
    patientSearch = _b[0],
    setPatientSearch = _b[1];
  var _c = (0, react_1.useState)(false),
    showConflictDetection = _c[0],
    setShowConflictDetection = _c[1];
  var _d = (0, react_1.useState)(false),
    isSubmitting = _d[0],
    setIsSubmitting = _d[1];
  var _e = (0, react_1.useState)(null),
    selectedPatient = _e[0],
    setSelectedPatient = _e[1];
  ...
  var form = (0, react_hook_form_1.useForm)({
    ...
    defaultValues: {
      ...
      time:
        selectedTime ||
        (editingAppointment
          ? (0, date_fns_1.format)(new Date(editingAppointment.start_time), "HH:mm")
          : ""),
      duration_minutes: 30,
      notes:
        (editingAppointment === null || editingAppointment === void 0
      ...
      internal_notes:
        (editingAppointment === null || editingAppointment === void 0
          ? void 0
          : editingAppointment.internal_notes) || "",
      priority:
        (editingAppointment === null || editingAppointment === void 0
          ? void 0
          : editingAppointment.priority) || 1,
      room_id:
        (editingAppointment === null || editingAppointment === void 0
          ? void 0
          : editingAppointment.room_id) || "",
  ...
  var date = watchedValues.date,
    time = watchedValues.time,
    professional_id = watchedValues.professional_id,
    service_type_id = watchedValues.service_type_id,
    duration_minutes = watchedValues.duration_minutes;
  // Calculate appointment end time
  var appointmentStartTime = (0, react_1.useMemo)(() => {
  ...
  var appointmentEndTime = (0, react_1.useMemo)(() => {
  ...
  var _f = (0, react_query_1.useQuery)({
      ...
      queryFn: () =>
        __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, (_b) => {
            switch (_b.label) {
              case 0:
                if (patientSearch.length < 2) return [2 /*return*/, []];
                return [
                  4 /*yield*/,
                  supabase
                    .from("patients")
                    ...
                    .or(
                      "full_name.ilike.%"
                        .concat(patientSearch, "%,phone_primary.ilike.%")
                        .concat(patientSearch, "%,medical_record_number.ilike.%")
                        .concat(patientSearch, "%"),
                    )
                    .eq("is_active", true)
                    .limit(10),
                ];
    ...
    _g = _f.data,
    patients = _g === void 0 ? [] : _g,
    patientsLoading = _f.isLoading;
  // Fetch professionals
  ...
  var _l = (0, react_query_1.useQuery)({
      ...
      queryFn: () =>
        __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, (_a) => {
            switch (_a.label) {
              case 0:
                if (!professional_id || !date) return [2 /*return*/, []];
                return [
                  4 /*yield*/,
    ...
    _m = _l.data,
    availableSlots = _m === void 0 ? [] : _m,
    slotsLoading = _l.isLoading;
  // Filter service types by professional
  var availableServiceTypes = (0, react_1.useMemo)(() => {
    var selectedProfessional = professionals.find((p) => p.id === professional_id);
    if (
      !(selectedProfessional === null || selectedProfessional === void 0
        ? void 0
        : selectedProfessional.service_type_ids)
    )
      return serviceTypes;
    return serviceTypes.filter((st) => {
      var _a;
      return (_a = selectedProfessional.service_type_ids) === null || _a === void 0
        ? void 0
        : _a.includes(st.id);
    });
  ...
  (0, react_1.useEffect)(() => {
    var selectedServiceType = serviceTypes.find((st) => st.id === service_type_id);
  ...
  var timeSlots = (0, react_1.useMemo)(() => {
    ...
    for (var hour = 8; hour <= 18; hour++) {
      var _loop_1 = (minute) => {
        ...
        var isAvailable = availableSlots.some((slot) => slot.time === timeString && slot.available);
  ...
  return (
    <card_1.Card className="w-full max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                    ...
                    {patients.map((patient) => (
                      <div
                        ...
                        className={(0, utils_1.cn)(
                          ...
                          (selectedPatient === null || selectedPatient === void 0
                            ? void 0
                ...
                <form_1.FormField
                  ...
                  name="patient_id"
                  render={() => (
                    <form_1.FormItem className="hidden">
                      <form_1.FormControl>
                        <input_1.Input />
                      </form_1.FormControl>
                      <form_1.FormMessage />
                  ...
                  return (
                    <form_1.FormItem>
                      ...
                      <select_1.Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <select_1.SelectContent>
                          {availableServiceTypes.map((serviceType) => (
                            <select_1.SelectItem key={serviceType.id} value={serviceType.id}>
                      ...
                      <form_1.FormDescription>
                        {service_type_id &&
                          ((_b = availableServiceTypes.find((st) => st.id === service_type_id)) ===
                            null || _b === void 0
                            ? void 0
                            : _b.description)}
                      </form_1.FormDescription>
                      ...
                      <popover_1.Popover>
                        ...
                        <popover_1.PopoverContent className="w-auto p-0" align="start">
                          <calendar_1.Calendar
                            ...
                            disabled={(date) =>
                              (0, date_fns_1.isBefore)(date, (0, date_fns_1.startOfDay)(new Date()))
                            }
                            initialFocus
                            locale={locale_1.ptBR}
                          />
                      ...
                      <form_1.FormItem>
                        ...
                        <select_1.Select onValueChange={field.onChange} value={field.value}>
                          ...
                          <select_1.SelectContent>
                            ...
                            {rooms.map((room) => (
                              <select_1.SelectItem key={room.id} value={room.id}>
      ...
      {createAppointmentMutation.error && (
        <alert_1.Alert variant="destructive" className="mx-6 mb-6">
