...
function QuickBookingModal(_a) {
    var _this = this;
    var isOpen = _a.isOpen, onClose = _a.onClose, onSubmit = _a.onSubmit, professionals = _a.professionals, selectedDate = _a.selectedDate, selectedSlot = _a.selectedSlot;
    ...
    var form = (0, react_hook_form_1.useForm)({
        ...
        defaultValues: {
            ...
            professionalId: '',
            date: selectedDate ? (0, moment_1.default)(selectedDate).format('YYYY-MM-DD') : (0, moment_1.default)().format('YYYY-MM-DD'),
    ...
    (0, react_1.useEffect)(function () {
        if (selectedSlot) {
            ...
            var suggestedDuration = (0, moment_1.default)(selectedSlot.end).diff((0, moment_1.default)(selectedSlot.start), 'minutes');
    ...
    (0, react_1.useEffect)(function () {
        var serviceOption = serviceOptions.find(function (s) { return s.value === watchedServiceType; });
        if (serviceOption) {
    ...
    var formatPhoneNumber = function (value) {
        ...
        if (numbers.length <= 6)
            return "(".concat(numbers.slice(0, 2), ") ").concat(numbers.slice(2));
        if (numbers.length <= 10)
            return "(".concat(numbers.slice(0, 2), ") ").concat(numbers.slice(2, 6), "-").concat(numbers.slice(6));
        return "(".concat(numbers.slice(0, 2), ") ").concat(numbers.slice(2, 7), "-").concat(numbers.slice(7, 11));
    };
    ...
    var validateSlot = function (data) {
        ...
        var professional = professionals.find(function (p) { return p.id === data.professionalId; });
        if (professional && !professional.availability) {
            conflicts.push("".concat(professional.name, " n\u00E3o est\u00E1 dispon\u00EDvel"));
        }
        return conflicts;
    };
    var onFormSubmit = function (data) { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                case 0:
                    ...
                    appointmentData = {
                        ...
                        equipmentNeeded: ((_a = data.equipmentNeeded) === null || _a === void 0 ? void 0 : _a.length) ? data.equipmentNeeded : undefined,
      ...
      <dialog_1.DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        <form_1.Form {...form}>
          <form onSubmit={form.handleSubmit(onFormSubmit)} className="space-y-6">
            {/* Conflicts alert */}
            {conflicts.length > 0 && (<div className="p-4 bg-red-50 border border-red-200 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <form_1.FormField control={form.control} name="patientName" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    <form_1.FormLabel>Nome do Paciente</form_1.FormLabel>
                    <form_1.FormControl>
                      <input_1.Input placeholder="Nome completo" {...field} className="flex items-center"/>
                    </form_1.FormControl>
                    <form_1.FormMessage />
                  </form_1.FormItem>);
        }}/>

              <form_1.FormField control={form.control} name="phoneNumber" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <form_1.FormField control={form.control} name="serviceType" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    ...
                    <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <select_1.SelectContent>
                        {serviceOptions.map(function (service) { return (<select_1.SelectItem key={service.value} value={service.value}>
              ...
              <form_1.FormField control={form.control} name="professionalId" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    ...
                    <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <select_1.SelectContent>
                        {professionals.map(function (professional) { return (<select_1.SelectItem key={professional.id} value={professional.id} disabled={!professional.availability}>
                            <div className="flex items-center justify-between w-full">
                              ...
                              {!professional.availability && (<badge_1.Badge variant="secondary">Indisponível</badge_1.Badge>)}
                            </div>
                          </select_1.SelectItem>); })}
                      </select_1.SelectContent>
                    </select_1.Select>
            ...
            return (<form_1.FormItem>
                    ...
                    <form_1.FormControl>
                      <input_1.Input type="date" {...field} min={(0, moment_1.default)().format('YYYY-MM-DD')}/>
                    </form_1.FormControl>
                    <form_1.FormMessage />
                  </form_1.FormItem>);
        }}/>

              <form_1.FormField control={form.control} name="startTime" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    <form_1.FormLabel>Horário</form_1.FormLabel>
                    <form_1.FormControl>
                      <input_1.Input type="time" {...field} min="08:00" max="17:30" step="900" // 15-minute steps
            />
                    </form_1.FormControl>
                    <form_1.FormMessage />
                  </form_1.FormItem>);
            ...
            return (<form_1.FormItem>
                    ...
                    <select_1.Select onValueChange={function (value) { return field.onChange(parseInt(value)); }}>
                      <form_1.FormControl>
                        <select_1.SelectTrigger>
            ...
            return (<form_1.FormItem>
                  ...
                  <form_1.FormControl>
                    <textarea_1.Textarea placeholder="Observações sobre a consulta..." className="resize-none" rows={3} {...field}/>
                  </form_1.FormControl>
            ...
            {/* WhatsApp Reminder */}
            <form_1.FormField control={form.control} name="whatsappReminder" render={function (_a) {
            var field = _a.field;
            ...
            <dialog_1.DialogFooter>
              <button_1.Button type="button" variant="outline" onClick={onClose} disabled={isSubmitting}>
                Cancelar
              </button_1.Button>
