...
function DeviceManagement(_a) {
  ...
  var className = _a.className,
    ...
    _c = _a.showRemoveDevice,
    showRemoveDevice = _c === void 0 ? true : _c,
    _d = _a.maxDevices,
    maxDevices = _d === void 0 ? 5 : _d;
  var _e = (0, auth_1.useDeviceManagement)(),
    devices = _e.devices,
    currentDevice = _e.currentDevice,
    isLoading = _e.isLoading,
    registerDevice = _e.registerDevice,
    trustDevice = _e.trustDevice,
    untrustDevice = _e.untrustDevice,
    removeDevice = _e.removeDevice,
    reportSuspiciousDevice = _e.reportSuspiciousDevice,
    refreshDevices = _e.refreshDevices;
  var _f = (0, react_1.useState)(null),
    selectedDevice = _f[0],
    setSelectedDevice = _f[1];
  var _g = (0, react_1.useState)(false),
    showRemoveDialog = _g[0],
    setShowRemoveDialog = _g[1];
  var _h = (0, react_1.useState)(false),
    showTrustDialog = _h[0],
    setShowTrustDialog = _h[1];
  ...
  var getDeviceIcon = function (type) {
    switch (type) {
      ...
      case "tablet":
        return lucide_react_1.Tablet;
      case "laptop":
        return lucide_react_1.Laptop;
      default:
        return lucide_react_1.Monitor;
    }
  };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [3 /*break*/, 4];
          case 2:
            return [4 /*yield*/, trustDevice(device.id)];
          case 3:
            _a.sent();
            _a.label = 4;
          case 4:
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        {device.isTrusted
                          ...
                          : <lucide_react_1.ShieldAlert className="h-4 w-4 text-orange-600" />}
                        <span
                          className={(0, utils_1.cn)(
                            "text-xs font-medium",
          ...
          <dialog_1.DialogHeader>
            ...
            <dialog_1.DialogDescription>
              {(
                ...
                ? 'Are you sure you want to untrust "'.concat(
                    selectedDevice === null || selectedDevice === void 0
                      ? void 0
                      : selectedDevice.name,
                    '"? This device will require additional verification for future logins.',
                  )
                : 'Are you sure you want to trust "'.concat(
                    selectedDevice === null || selectedDevice === void 0
                      ? void 0
                      : selectedDevice.name,
                    '"? This device will be allowed to access your account with reduced security checks.',
                  )}
            </dialog_1.DialogDescription>
          </dialog_1.DialogHeader>
