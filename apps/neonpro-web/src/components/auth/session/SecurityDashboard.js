...
function SecurityDashboard(_a) {
  var className = _a.className,
    ...
    _c = _a.maxEvents,
    maxEvents = _c === void 0 ? 10 : _c,
    _d = _a.autoRefresh,
    autoRefresh = _d === void 0 ? true : _d,
    _e = _a.refreshInterval,
    refreshInterval = _e === void 0 ? 30 : _e;
  var _f = (0, auth_1.useSecurityMonitoring)(),
    securityScore = _f.securityScore,
    securityStatus = _f.securityStatus,
    deviceRiskLevel = _f.deviceRiskLevel,
    isDeviceTrusted = _f.isDeviceTrusted,
    securityEvents = _f.securityEvents,
    refreshSecurityData = _f.refreshSecurityData;
  ...
  var metrics = (0, react_1.useState)({
    totalEvents:
      (securityEvents === null || securityEvents === void 0 ? void 0 : securityEvents.length) || 0,
    criticalEvents:
  ...
  return (
    <div className={(0, utils_1.cn)("w-full space-y-6", className)}>
      {/* Header */}
      ...
      {securityStatus !== "secure" && (
        <alert_1.Alert variant={securityStatus === "critical" ? "destructive" : "default"}>
