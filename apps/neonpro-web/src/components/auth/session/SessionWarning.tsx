...
export function SessionWarning({
  ...
  const { isAuthenticated, isExpiringSoon, isExpired, extendSession, logout } = useSession();

  const { timeRemainingMinutes, timeRemainingFormatted } = useSessionTimeout();
  ...
  if (showAsAlert) {
    return (
      <Alert
        ...
        className={cn("relative", config.bgColor, config.borderColor, className)}
      >
