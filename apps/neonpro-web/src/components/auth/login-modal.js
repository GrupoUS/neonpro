...
function LoginModal(_a) {
    var _this = this;
    var open = _a.open, onOpenChange = _a.onOpenChange, type = _a.type;
      ...
      <dialog_1.DialogContent className="sm:max-w-md">
        <dialog_1.DialogHeader>
          <dialog_1.DialogTitle className="flex items-center space-x-2">
            ...
            <badge_1.Badge className="bg-sky-100 text-sky-700 text-xs">
              Seguro
            </badge_1.Badge>
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (<div className="flex items-center space-x-2 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input_1.Input id="email" type="email" value={formData.email} onChange={function (e) { return handleInputChange('email', e.target.value); }} className="pl-10" placeholder={type === 'professional'
            ? 'dr.silva@clinica.com.br'
            : 'seu@email.com ou 000.000.000-00'} required/>
              </div>
            </div>
            ...
            <button_1.Button type="submit" disabled={isLoading} className="w-full bg-sky-600 hover:bg-sky-700 text-white" size="lg">
              {isLoading ? (<>
          ...
          {type === 'professional' && (<>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-slate-600 dark:text-slate-400">
                  {securityFeatures.map(function (feature, index) { return (<div key={index} className="flex items-center space-x-2">
              ...
              <div className="text-center space-y-3">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <button_1.Button variant="outline" size="sm" className="flex-1" onClick={function () { return window.open('/setup-guide', '_blank'); }}>
                    Guia de Configuração
                    <lucide_react_1.ExternalLink className="ml-1 h-3 w-3"/>
                  </button_1.Button>
                  <button_1.Button variant="outline" size="sm" className="flex-1" onClick={function () { return window.open('/contact-support', '_blank'); }}>
                    Suporte Técnico
                  </button_1.Button>
                </div>
              </div>
          ...
          {type === 'patient' && (<>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                ...
                <button_1.Button variant="outline" size="sm" className="w-full" onClick={function () { return window.open('/patient-help', '_blank'); }}>
