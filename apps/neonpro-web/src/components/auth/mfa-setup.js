...
function MFASetup(_a) {
    var _this = this;
    var _b;
    var userId = _a.userId, onSetupComplete = _a.onSetupComplete, onSetupError = _a.onSetupError, className = _a.className, _c = _a.theme, theme = _c === void 0 ? 'light' : _c, _d = _a.locale, locale = _d === void 0 ? 'pt-BR' : _d;
    // Translations
    var t = useTranslations(locale);
    // MFA hook
    var _e = (0, use_mfa_1.useMFA)({ userId: userId }), setupMFA = _e.setupMFA, verifyMFA = _e.verifyMFA, isLoading = _e.isLoading, error = _e.error;
    // Component state
    ...
    var handleMethodSelect = (0, react_1.useCallback)(function (method) {
        setState(function (prev) { return (__assign(__assign({}, prev), { selectedMethod: method })); });
    }, []);
    /**
     * Handle device name change
     */
    var handleDeviceNameChange = (0, react_1.useCallback)(function (name) {
        setState(function (prev) { return (__assign(__assign({}, prev), { deviceName: name })); });
    }, []);
    /**
     * Handle phone number change
     */
    var handlePhoneNumberChange = (0, react_1.useCallback)(function (phone) {
        setState(function (prev) { return (__assign(__assign({}, prev), { phoneNumber: phone })); });
    }, []);
    /**
     * Handle LGPD consent change
     */
    var handleLGPDConsentChange = (0, react_1.useCallback)(function (consent) {
        setState(function (prev) { return (__assign(__assign({}, prev), { lgpdConsent: consent })); });
    }, []);
    /**
     * Start MFA setup process
     */
    var startSetup = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    result_1 = _c.sent();
                    setState(function (prev) { return (__assign(__assign({}, prev), { qrCodeUri: result_1.qrCodeUri, secret: result_1.secret, backupCodes: result_1.backupCodes, recoveryToken: result_1.recoveryToken, currentStep: 2 })); });
                    (0, use_toast_1.toast)({
     ...
     * Verify MFA token
     */
    var verifyToken = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    result = _c.sent();
                    if (result.isValid) {
                        setState(function (prev) { return (__assign(__assign({}, prev), { currentStep: 3 })); }); // Move to backup codes step
                        (0, use_toast_1.toast)({
     ...
     */
    var completeSetup = (0, react_1.useCallback)(function () {
        var result = {
            secret: state.secret,
     ...
     */
    var copyToClipboard = (0, react_1.useCallback)(function (text, label) { return __awaiter(_this, void 0, void 0, function () {
        var err_3;
     ...
     */
    var downloadBackupCodes = (0, react_1.useCallback)(function () {
        var content = __spreadArray(__spreadArray([
            t.backupCodes.fileHeader,
            t.backupCodes.fileWarning,
            ''
        ], state.backupCodes.map(function (code, index) { return "".concat(index + 1, ". ").concat(code); }), true), [
            '',
            t.backupCodes.fileFooter,
            "Generated: ".concat(new Date().toLocaleString(locale)),
        ], false).join('\n');
    ...
    return (<div className={(0, utils_1.cn)('w-full max-w-2xl mx-auto', className)}>
      {/* Progress Header */}
      <div className="mb-8">
        ...
        <card_1.CardContent className="p-6">
          ...
          {state.currentStep === 0 && (<div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input_1.Input id="deviceName" type="text" placeholder={t.deviceName.placeholder} value={state.deviceName} onChange={function (e) { return handleDeviceNameChange(e.target.value); }} maxLength={50}/>
              ...
              {state.selectedMethod === 'sms' && (<div className="space-y-2">
                  <label_1.Label htmlFor="phoneNumber">{t.phoneNumber.label}</label_1.Label>
                  <input_1.Input id="phoneNumber" type="tel" placeholder={t.phoneNumber.placeholder} value={state.phoneNumber} onChange={function (e) { return handlePhoneNumberChange(e.target.value); }}/>
                  <p className="text-sm text-gray-500">
                    {t.phoneNumber.help}
                  </p>
                </div>)}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  <checkbox_1.Checkbox id="lgpdConsent" checked={state.lgpdConsent} onCheckedChange={handleLGPDConsentChange}/>
              ...
              <div className="flex justify-end">
                <button_1.Button onClick={function () { return setState(function (prev) { return (__assign(__assign({}, prev), { currentStep: 1 })); }); }} disabled={!state.deviceName.trim() || !state.lgpdConsent ||
          ...
          {state.currentStep === 1 && (<div className="space-y-6">
              ...
              <card_1.Card className="bg-gray-50 dark:bg-gray-800">
                <card_1.CardContent className="p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {state.selectedMethod === 'sms' && (<div className="flex justify-between">
              ...
              {/* Action Buttons */}
              <div className="flex justify-between">
                <button_1.Button variant="outline" onClick={function () { return setState(function (prev) { return (__assign(__assign({}, prev), { currentStep: 0 })); }); }}>
                  {t.buttons.back}
                </button_1.Button>
          ...
          {state.currentStep === 2 && (<div className="space-y-6">
              ...
              {/* TOTP Setup */}
              {state.selectedMethod === 'totp' && (<div className="space-y-6">
                  {/* QR Code */}
                  <card_1.Card>
                    <card_1.CardHeader>
                    ...
                    <card_1.CardContent className="flex flex-col items-center space-y-4">
                      {state.qrCodeUri && (<div className="bg-white p-4 rounded-lg border">
                      ...
                      <div className="w-full">
                        ...
                        <div className="flex items-center space-x-2 mt-2">
                          <input_1.Input type={state.showSecret ? 'text' : 'password'} value={state.secret} readOnly className="font-mono text-sm"/>
                          <button_1.Button variant="outline" size="sm" onClick={function () { return setState(function (prev) { return (__assign(__assign({}, prev), { showSecret: !prev.showSecret })); }); }}>
                            {state.showSecret ? <lucide_react_1.EyeOff className="h-4 w-4"/> : <lucide_react_1.Eye className="h-4 w-4"/>}
                          </button_1.Button>
                          <button_1.Button variant="outline" size="sm" onClick={function () { return copyToClipboard(state.secret, t.verification.totp.secret); }}>
              ...
              {/* SMS Setup */}
              {state.selectedMethod === 'sms' && (<alert_1.Alert>
                  <lucide_react_1.Smartphone className="h-4 w-4"/>
                  <alert_1.AlertDescription>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <label_1.Label htmlFor="verificationToken">{t.verification.tokenLabel}</label_1.Label>
                      <input_1.Input id="verificationToken" type="text" placeholder="123456" value={state.verificationToken} onChange={function (e) { return setState(function (prev) { return (__assign(__assign({}, prev), { verificationToken: e.target.value.replace(/\D/g, '').slice(0, 6) })); }); }} maxLength={6} className="text-center text-2xl font-mono"/>
                    </div>
                    
                    <div className="flex justify-between">
                      <button_1.Button variant="outline" onClick={function () { return setState(function (prev) { return (__assign(__assign({}, prev), { currentStep: 1 })); }); }}>
                        {t.buttons.back}
                      </button_1.Button>
                      <button_1.Button onClick={verifyToken} disabled={state.verificationToken.length !== 6 || state.isVerifying}>
          ...
          {state.currentStep === 3 && (<div className="space-y-6">
              ...
              <card_1.Card>
                <card_1.CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button_1.Button variant="outline" size="sm" onClick={function () { return setState(function (prev) { return (__assign(__assign({}, prev), { showBackupCodes: !prev.showBackupCodes })); }); }}>
                        {state.showBackupCodes ? <lucide_react_1.EyeOff className="h-4 w-4"/> : <lucide_react_1.Eye className="h-4 w-4"/>}
                        {state.showBackupCodes ? t.buttons.hide : t.buttons.show}
                      </button_1.Button>
                      <button_1.Button variant="outline" size="sm" onClick={function () { return copyToClipboard(state.backupCodes.join('\n'), t.backupCodes.title); }}>
                        <lucide_react_1.Copy className="h-4 w-4"/>
                        {t.buttons.copy}
                      </button_1.Button>
                ...
                <card_1.CardContent>
                  {state.showBackupCodes ? (<div className="grid grid-cols-2 gap-3">
                      {state.backupCodes.map(function (code, index) { return (<div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border">
                          <span className="font-mono text-sm">{code}</span>
                          <button_1.Button variant="ghost" size="sm" onClick={function () { return copyToClipboard(code, "".concat(t.backupCodes.code, " ").concat(index + 1)); }}>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent>
                  <div className="flex items-center space-x-2">
                    <input_1.Input type="password" value={state.recoveryToken} readOnly className="font-mono text-sm"/>
                    <button_1.Button variant="outline" size="sm" onClick={function () { return copyToClipboard(state.recoveryToken, t.recoveryToken.title); }}>
                      <lucide_react_1.Copy className="h-4 w-4"/>
                    </button_1.Button>
                  </div>
                </card_1.CardContent>
              ...
              {/* Complete Setup */}
              <div className="flex justify-between">
                <button_1.Button variant="outline" onClick={function () { return setState(function (prev) { return (__assign(__assign({}, prev), { currentStep: 2 })); }); }}>
                  {t.buttons.back}
                </button_1.Button>
                <button_1.Button onClick={completeSetup} size="lg" className="bg-green-600 hover:bg-green-700">
