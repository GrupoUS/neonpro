...
function EnhancedOAuthDemo() {
  ...
  var _d = (0, auth_context_1.useAuth)(),
    user = _d.user,
    session = _d.session,
    signInWithGoogle = _d.signInWithGoogle,
    signOut = _d.signOut,
    checkPermission = _d.checkPermission,
    getUserPermissions = _d.getUserPermissions,
    hasRole = _d.hasRole;
  ...
  var _g = (0, react_1.useState)([]),
    permissionChecks = _g[0],
    setPermissionChecks = _g[1];
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              security_audit_logger_1.securityAuditLogger.getAuditLogs({
                userId: user.id,
                limit: 10,
                eventTypes: [
                  "oauth_attempt",
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 4:
            error_4 = _a.sent();
            console.error(
              "Error checking permission ".concat(test.resource, ":").concat(test.action, ":"),
              error_4,
            );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-green-50 p-4 rounded-lg">
            ...
            <p className="text-green-700">
              Nome:{" "}
              {((_a = user.user_metadata) === null || _a === void 0 ? void 0 : _a.name) || "N/A"}
            </p>
          </div>
