...
function SignInWithGooglePopupButton(_a) {
  var _b = _a.text,
    ...
    _c = _a.loadingText,
    loadingText = _c === void 0 ? "Autenticando..." : _c,
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 2:
              ...
              if (totalTime_1 <= 3000) {
                console.log(
                  "\u2705 OAuth completed in ".concat(totalTime_1, "ms (\u22643s requirement met)"),
                );
              } else {
                console.warn(
                  "\u26A0\uFE0F OAuth took ".concat(totalTime_1, "ms (exceeds 3s requirement)"),
                );
              }
  ...
  return (
    <button_1.Button
      ...
      aria-label={"".concat(text, " - Login com Google OAuth")}
      role="button"
      tabIndex={0}
    >
      {getButtonContent()}
