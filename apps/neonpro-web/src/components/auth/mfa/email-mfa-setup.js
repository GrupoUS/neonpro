...
function EmailMFASetup(_a) {
    ...
    var _b = (0, react_1.useState)('email'), step = _b[0], setStep = _b[1];
    ...
    var handleEmailSubmit = function (data) { return __awaiter(_this, void 0, void 0, function () {
        var result, err_1;
        ...
        <card_1.CardContent>
          <form onSubmit={emailForm.handleSubmit(handleEmailSubmit)} className="space-y-4">
            <div className="space-y-2">
              ...
              <input_1.Input id="email" type="email" placeholder="your.email@example.com" {...emailForm.register('email')} className={emailForm.formState.errors.email ? 'border-red-500' : ''}/>
              {emailForm.formState.errors.email && (<p className="text-sm text-red-500">
    ...
    return (<card_1.Card className="w-full max-w-md">
      ...
      <card_1.CardContent>
        <form onSubmit={verificationForm.handleSubmit(handleVerificationSubmit)} className="space-y-4">
          ...
          <div className="flex gap-2">
            <button_1.Button type="button" variant="outline" onClick={function () { return setStep('email'); }} className="flex-1">
              Back
            </button_1.Button>
            <button_1.Button type="submit" disabled={isLoading} className="flex-1">
              {isLoading && <lucide_react_1.Loader2 className="w-4 h-4 mr-2 animate-spin"/>}
