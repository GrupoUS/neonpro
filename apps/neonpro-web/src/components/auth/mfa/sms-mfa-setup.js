...
function SMSMFASetup(_a) {
    var _this = this;
    var userId = _a.userId, onSuccess = _a.onSuccess, onCancel = _a.onCancel;
    var _b = (0, react_1.useState)('phone'), step = _b[0], setStep = _b[1];
    var _c = (0, react_1.useState)(''), phoneNumber = _c[0], setPhoneNumber = _c[1];
    var _d = (0, react_1.useState)(false), isLoading = _d[0], setIsLoading = _d[1];
    var _e = (0, react_1.useState)(''), error = _e[0], setError = _e[1];
    var _f = (0, react_1.useState)(0), resendCount = _f[0], setResendCount = _f[1];
    var _g = (0, react_1.useState)(true), canResend = _g[0], setCanResend = _g[1];
    ...
    var handlePhoneSubmit = function (data) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var handleVerificationSubmit = function (data) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    result = _a.sent();
                    if (result.success) {
                        setResendCount(function (prev) { return prev + 1; });
                        setCanResend(false);
                        // Allow resend after 60 seconds
                        setTimeout(function () { return setCanResend(true); }, 60000);
        ...
        <card_1.CardContent>
          <form onSubmit={phoneForm.handleSubmit(handlePhoneSubmit)} className="space-y-4">
            <div className="space-y-2">
              ...
              <input_1.Input id="phoneNumber" type="tel" placeholder="+55 11 99999-9999" {...phoneForm.register('phoneNumber')} className={phoneForm.formState.errors.phoneNumber ? 'border-red-500' : ''}/>
              {phoneForm.formState.errors.phoneNumber && (<p className="text-sm text-red-500">
            ...
            <div className="flex gap-2">
              <button_1.Button type="button" variant="outline" onClick={onCancel} className="flex-1">
                Cancel
              </button_1.Button>
      ...
      <card_1.CardContent>
        <form onSubmit={verificationForm.handleSubmit(handleVerificationSubmit)} className="space-y-4">
          <div className="space-y-2">
            ...
            <input_1.Input id="code" type="text" placeholder="123456" maxLength={6} className={"text-center text-lg tracking-widest ".concat(verificationForm.formState.errors.code ? 'border-red-500' : '')} {...verificationForm.register('code')}/>
            {verificationForm.formState.errors.code && (<p className="text-sm text-red-500">
          ...
          <div className="text-center">
            <button_1.Button type="button" variant="link" onClick={handleResendCode} disabled={!canResend || resendCount >= 3 || isLoading} className="text-sm">
              {resendCount >= 3
          ...
          <div className="flex gap-2">
            <button_1.Button type="button" variant="outline" onClick={function () { return setStep('phone'); }} className="flex-1">
              Back
            </button_1.Button>
            <button_1.Button type="submit" disabled={isLoading} className="flex-1">
              {isLoading && <lucide_react_1.Loader2 className="w-4 h-4 mr-2 animate-spin"/>}
