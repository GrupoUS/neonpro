...
function SignInWithGooglePopupButton() {
    ...
    var signInWithGoogleTest = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    sonner_1.toast.info("ℹ️ Para login real, configure as credenciais do Google OAuth no .env.local");
                    return [3 /*break*/, 4];
                case 2:
                    error_1 = _a.sent();
