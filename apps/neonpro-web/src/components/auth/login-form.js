...
function LoginForm(_a) {
    var _this = this;
    var type = _a.type, onSwitchToRegister = _a.onSwitchToRegister, onClose = _a.onClose;
            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (authData === null || authData === void 0 ? void 0 : authData.user) {
                        userRole = ((_b = authData.user.user_metadata) === null || _b === void 0 ? void 0 : _b.role) || 'patient';
      ...
      <card_1.CardContent className="space-y-6">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            return (<form_1.FormItem>
                  ...
                  <form_1.FormControl>
                    <div className="relative">
                      ...
                      <input_1.Input {...field} type={showPassword ? "text" : "password"} placeholder="Digite sua senha" className="pl-10 pr-10 h-12 border-slate-300 focus:border-[#6366f1] focus:ring-[#6366f1]" disabled={isLoading}/>
            ...
            <button_1.Button type="submit" className="w-full h-12 bg-[#6366f1] hover:bg-[#5855eb] text-white font-medium shadow-md" disabled={isLoading}>
              {isLoading ? (<div className="flex items-center space-x-2">
                  ...
                  <span>Entrando...</span>
                </div>) : ("Entrar ".concat(type === 'professional' ? 'no Sistema' : 'no Portal'))}
            </button_1.Button>
          </form>
        </form_1.Form>
        ...
        {type === 'patient' && onSwitchToRegister && (<>
            ...
            <div className="text-center space-y-3">
              ...
              <button_1.Button variant="outline" onClick={onSwitchToRegister} className="w-full h-12 border-[#6366f1] text-[#6366f1] hover:bg-[#6366f1] hover:text-white" disabled={isLoading}>
        ...
        <div className="text-center">
          <a href="/forgot-password" className="text-sm text-[#6366f1] hover:text-[#5855eb] font-medium underline-offset-4 hover:underline">
            Esqueceu sua senha?
          </a>
        </div>
