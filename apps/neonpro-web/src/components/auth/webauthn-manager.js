...
function WebAuthnManager() {
    var _this = this;
    var _a = (0, react_1.useState)([]), credentials = _a[0], setCredentials = _a[1];
    var _b = (0, react_1.useState)(null), capabilities = _b[0], setCapabilities = _b[1];
    var _c = (0, react_1.useState)(true), loading = _c[0], setLoading = _c[1];
    var _d = (0, react_1.useState)(false), registering = _d[0], setRegistering = _d[1];
    var _e = (0, react_1.useState)(''), deviceName = _e[0], setDeviceName = _e[1];
    ...
    var checkCapabilities = function () { return __awaiter(_this, void 0, void 0, function () {
        var caps, error_1;
    ...
    var handleRegister = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(capabilities === null || capabilities === void 0 ? void 0 : capabilities.supported)) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, webauthn_client_1.webAuthnClient.registerCredential(deviceName || undefined)];
                case 2:
                    result = _a.sent();
    ...
    var handleRemove = function (credentialId) { return __awaiter(_this, void 0, void 0, function () {
        var response, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, fetch("/api/auth/webauthn/credentials/".concat(credentialId), {
                            method: 'DELETE',
                        })];
                case 1:
                    response = _a.sent();
    ...
    return (<div className="space-y-6">
      ...
      <card_1.Card>
        ...
        <card_1.CardContent className="space-y-4">
          {capabilities && (<div className="space-y-2">
              <div className="flex items-center gap-2">
                {capabilities.supported ? (<lucide_react_1.CheckCircle className="h-4 w-4 text-green-500"/>) : (<lucide_react_1.AlertCircle className="h-4 w-4 text-red-500"/>)}
                <span className="text-sm">
                  WebAuthn Support: {capabilities.supported ? 'Available' : 'Not Available'}
                </span>
              </div>
              <div className="flex items-center gap-2">
                {capabilities.platformAuthenticatorAvailable ? (<lucide_react_1.CheckCircle className="h-4 w-4 text-green-500"/>) : (<lucide_react_1.AlertCircle className="h-4 w-4 text-yellow-500"/>)}
                <span className="text-sm">
          ...
          {!(capabilities === null || capabilities === void 0 ? void 0 : capabilities.supported) && (<alert_1.Alert>
      ...
      {/* Add New Credential */}
      {(capabilities === null || capabilities === void 0 ? void 0 : capabilities.supported) && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center gap-2">
          ...
          <card_1.CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <input_1.Input id="deviceName" placeholder="e.g., iPhone Touch ID, YubiKey 5" value={deviceName} onChange={function (e) { return setDeviceName(e.target.value); }} disabled={registering}/>
            </div>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          {credentials.length === 0 ? (<div className="text-center py-6 text-muted-foreground">
              No authenticators registered yet.
            </div>) : (<div className="space-y-3">
              {credentials.map(function (credential) { return (<div key={credential.id} className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">
                        ...
                        {credential.last_used_at && (<span className="ml-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button_1.Button variant="ghost" size="sm" onClick={function () { return handleRemove(credential.credential_id); }}>
