...
export function MFAVerify({
  ...
  // MFA hook
  const { mfaSettings, verifyMFA, sendSMSOTP, isLoading, error } = useMFA({ userId });
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-center">
                  ...
                  >
                    ...
                    {state.canResendSMS
                      ? t.buttons.resendSMS
                      : `${t.buttons.resendIn} ${state.smsCountdown}s`}
                  </Button>
                </div>
              ...
              <div className="flex items-start space-x-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setState((prev) => ({ ...prev, trustDevice: !!checked }))
                  }
                />
                ...
                {!state.showEmergencyBypass ? (
                  ...
                  <div className="space-y-4">
                    <Alert variant="destructive">
                      <AlertTriangle className="h-4 w-4" />
                      <AlertDescription>{t.emergency.warning}</AlertDescription>
                    </Alert>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setState((prev) => ({ ...prev, emergencyReason: e.target.value }))
                        }
                        maxLength={200}
                      />
