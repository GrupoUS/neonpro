...
var registerSchema = zod_2.z
  .object({
    ...
    marketingConsent: zod_2.z.boolean().optional(),
  })
...
function RegisterForm(_a) {
  ...
  var _c = (0, react_1.useState)(false),
    showConfirmPassword = _c[0],
    setShowConfirmPassword = _c[1];
  ...
  var handleBirthDateChange = (value) => {
    var cleaned = value.replace(/\D/g, "");
    if (cleaned.length <= 8) {
      ...
      return __generator(this, (_c) => {
        switch (_c.label) {
          ...
          case 1:
            ...
            birthDateISO = ""
              .concat(year, "-")
              .concat(month.padStart(2, "0"), "-")
              .concat(day.padStart(2, "0"));
            return [
              4 /*yield*/,
