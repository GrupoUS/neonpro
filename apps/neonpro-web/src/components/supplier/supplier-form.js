...
function SupplierForm(_a) {
  ...
  var _d = (0, react_1.useState)([]),
    completedSteps = _d[0],
    setCompletedSteps = _d[1];
  var _e = (0, react_1.useState)(false),
    isSubmitting = _e[0],
    setIsSubmitting = _e[1];
  // Data management
  var _f = (0, use_supplier_1.useSuppliers)(clinicId),
    createSupplier = _f.createSupplier,
    updateSupplier = _f.updateSupplier,
    isCreating = _f.isCreating,
    isUpdating = _f.isUpdating;
  // Form setup
  var form = (0, react_hook_form_1.useForm)({
    ...
    defaultValues: {
      ...
      category:
        (supplier === null || supplier === void 0 ? void 0 : supplier.category) ||
        supplier_1.SupplierCategory.MEDICAL_EQUIPMENT,
      subcategories:
        (supplier === null || supplier === void 0 ? void 0 : supplier.subcategories) || [],
      status:
        (supplier === null || supplier === void 0 ? void 0 : supplier.status) ||
        supplier_1.SupplierStatus.PENDING_VERIFICATION,
      primary_contact: (supplier === null || supplier === void 0
        ? void 0
      ...
      secondary_contacts:
        (supplier === null || supplier === void 0 ? void 0 : supplier.secondary_contacts) || [],
      website: (supplier === null || supplier === void 0 ? void 0 : supplier.website) || "",
      registration_number:
        (supplier === null || supplier === void 0 ? void 0 : supplier.registration_number) || "",
      ...
      performance_score:
        (supplier === null || supplier === void 0 ? void 0 : supplier.performance_score) || 0,
      quality_rating:
        (supplier === null || supplier === void 0 ? void 0 : supplier.quality_rating) || 0,
      reliability_score:
        (supplier === null || supplier === void 0 ? void 0 : supplier.reliability_score) || 0,
      cost_competitiveness:
        (supplier === null || supplier === void 0 ? void 0 : supplier.cost_competitiveness) || 0,
      credit_rating:
        (supplier === null || supplier === void 0 ? void 0 : supplier.credit_rating) || "",
      payment_terms:
        (supplier === null || supplier === void 0 ? void 0 : supplier.payment_terms) ||
        supplier_1.PaymentTerms.NET_30,
      currency: (supplier === null || supplier === void 0 ? void 0 : supplier.currency) || "BRL",
      early_payment_discount:
        (supplier === null || supplier === void 0 ? void 0 : supplier.early_payment_discount) || 0,
      risk_level:
        (supplier === null || supplier === void 0 ? void 0 : supplier.risk_level) ||
        supplier_1.RiskLevel.MEDIUM,
      risk_factors:
        (supplier === null || supplier === void 0 ? void 0 : supplier.risk_factors) || [],
      certifications:
        (supplier === null || supplier === void 0 ? void 0 : supplier.certifications) || [],
      regulatory_compliance:
        (supplier === null || supplier === void 0 ? void 0 : supplier.regulatory_compliance) ||
        false,
      anvisa_registration:
        (supplier === null || supplier === void 0 ? void 0 : supplier.anvisa_registration) || "",
  ...
  var _g = (0, react_hook_form_1.useFieldArray)({
    ...
    secondaryContactFields = _g.fields,
    appendSecondaryContact = _g.append,
    removeSecondaryContact = _g.remove;
  var _h = (0, react_hook_form_1.useFieldArray)({
      control: control,
      name: "certifications",
    }),
    certificationFields = _h.fields,
    appendCertification = _h.append,
    removeCertification = _h.remove;
  var _j = (0, react_hook_form_1.useFieldArray)({
      control: control,
      name: "risk_factors",
    }),
    riskFactorFields = _j.fields,
    appendRiskFactor = _j.append,
    removeRiskFactor = _j.remove;
  ...
  function validateBusinessRules() {
    ...
    if (
      !((_a = watchedValues.primary_contact) === null || _a === void 0 ? void 0 : _a.name) ||
      !((_b = watchedValues.primary_contact) === null || _b === void 0 ? void 0 : _b.email)
    ) {
      validationErrors.push("Contato principal é obrigatório");
    }
    // Address validation
    if (
      !((_c = watchedValues.address) === null || _c === void 0 ? void 0 : _c.street) ||
      !((_d = watchedValues.address) === null || _d === void 0 ? void 0 : _d.city)
    ) {
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            submissionData = __assign(
              __assign(__assign({}, data), { updated_at: new Date().toISOString() }),
              mode === "create" && {
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <dialog_1.DialogFooter className="flex justify-between">
              <div className="flex gap-2">
                {currentStep > 0 && (
                  <button_1.Button type="button" variant="outline" onClick={handlePrevious}>
                    Anterior
                  </button_1.Button>
                )}

                {!isLastStep
                  ? <button_1.Button type="button" onClick={handleNext} disabled={!canProceed}>
                      Próximo
                    </button_1.Button>
                  : <button_1.Button
                      type="submit"
