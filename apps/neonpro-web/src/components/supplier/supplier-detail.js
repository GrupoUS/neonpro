  ...
  var trendIcon =
    trend === "up"
      ...
      : trend === "down"
        ...
        : null;
  return (
    <card_1.Card className={(0, utils_1.cn)("transition-all hover:shadow-md", colorClasses[color])}>
...
function SupplierDetail(_a) {
  ...
  var _c = (0, react_1.useState)(false),
    editFormOpen = _c[0],
    setEditFormOpen = _c[1];
  var _d = (0, react_1.useState)("3months"),
    selectedTimeRange = _d[0],
    setSelectedTimeRange = _d[1];
  // Data hooks
  var _e = (0, use_supplier_1.useSuppliers)(clinicId),
    supplier = _e.supplier,
    deleteSupplier = _e.deleteSupplier,
    isLoadingSupplier = _e.isLoading;
  var _f = (0, use_supplier_1.useSupplierPerformance)(clinicId, supplierId, selectedTimeRange),
    performanceData = _f.performanceData,
    performanceStats = _f.performanceStats,
    isLoadingPerformance = _f.isLoading;
  var _g = (0, use_supplier_1.useSupplierProcurement)(clinicId, supplierId, selectedTimeRange),
    procurementHistory = _g.procurementHistory,
    procurementStats = _g.procurementStats,
    isLoadingProcurement = _g.isLoading;
  var _h = (0, use_supplier_1.useSupplierQuality)(clinicId, supplierId, selectedTimeRange),
    qualityData = _h.qualityData,
    qualityStats = _h.qualityStats,
    isLoadingQuality = _h.isLoading;
  var _j = (0, use_supplier_1.useSupplierContracts)(clinicId, supplierId),
    contracts = _j.contracts,
    activeContracts = _j.activeContracts,
    isLoadingContracts = _j.isLoading;
  var _k = (0, use_supplier_1.useSupplierCommunications)(clinicId, supplierId),
    communications = _k.communications,
    recentCommunications = _k.recentCommunications,
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <div className="flex items-center space-x-4 mt-3 text-sm text-gray-500">
              ...
              {((_a = currentSupplier.primary_contact) === null || _a === void 0
                ? void 0
                : _a.email) && (
                <div className="flex items-center space-x-1">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p
                    className={(0, utils_1.cn)(
                      "font-medium",
                      getRiskLevelColor(currentSupplier.risk_level),
                    )}
                  >
                ...
                <div className="text-sm space-y-1">
                  <p>
                    ...
                    {currentSupplier.address.complement &&
                      ", ".concat(currentSupplier.address.complement)}
                  </p>
