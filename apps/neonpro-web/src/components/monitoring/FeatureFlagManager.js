...
function FeatureFlagManager() {
    var _this = this;
    var _a = (0, react_1.useState)([]), flags = _a[0], setFlags = _a[1];
    var _b = (0, react_1.useState)([]), rolloutPlans = _b[0], setRolloutPlans = _b[1];
    var _c = (0, react_1.useState)(true), loading = _c[0], setLoading = _c[1];
    var _d = (0, react_1.useState)(null), selectedFlag = _d[0], setSelectedFlag = _d[1];
    ...
    var loadFeatureFlags = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loadRolloutPlans = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var toggleFlag = function (flagId, enabled) { return __awaiter(_this, void 0, void 0, function () {
        var response, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("/api/monitoring/feature-flags/".concat(flagId), {
                            method: 'PATCH',
                ...
                case 1:
                    response = _a.sent();
                    if (response.ok) {
                        setFlags(function (prev) { return prev.map(function (flag) {
                            return flag.id === flagId ? __assign(__assign({}, flag), { enabled: enabled }) : flag;
                        }); });
    ...
    var updateRolloutPercentage = function (flagId, percentage) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (response.ok) {
                        setFlags(function (prev) { return prev.map(function (flag) {
                            return flag.id === flagId ? __assign(__assign({}, flag), { rollout_percentage: percentage }) : flag;
                        }); });
      ...
      <tabs_1.Tabs defaultValue="flags" className="space-y-4">
        ...
        <tabs_1.TabsContent value="flags" className="space-y-4">
          {flags.length === 0 ? (<card_1.Card>
              <card_1.CardContent className="p-6 text-center">
                ...
                <button_1.Button onClick={function () { return setIsCreating(true); }}>Create First Flag</button_1.Button>
              </card_1.CardContent>
            </card_1.Card>) : (<div className="grid gap-4">
              {flags.map(function (flag) { return (<card_1.Card key={flag.id}>
                  <card_1.CardHeader>
                    <div className="flex justify-between items-start">
                      <div className="space-y-1">
                        ...
                        <div className="flex gap-2">
                          ...
                          {getStatusBadge(flag)}
                          {flag.epic_id && (<badge_1.Badge variant="outline">Epic {flag.epic_id}</badge_1.Badge>)}
                        </div>
                      </div>
                      <div className="flex items-center space-x-2">
                        ...
                        <switch_1.Switch id={"toggle-".concat(flag.id)} checked={flag.enabled} onCheckedChange={function (enabled) { return toggleFlag(flag.id, enabled); }}/>
                      </div>
                    </div>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                    {flag.enabled && (<div className="space-y-4">
                        <div>
                          <div className="flex justify-between items-center mb-2">
                            <label_1.Label className="text-sm font-medium">Rollout Percentage</label_1.Label>
                          ...
                          <div className="flex gap-2">
                            <button_1.Button size="sm" variant="outline" onClick={function () { return quickRollout(flag.id, 0); }} disabled={flag.rollout_percentage === 0}>
                              0%
                            </button_1.Button>
                            <button_1.Button size="sm" variant="outline" onClick={function () { return quickRollout(flag.id, 10); }} disabled={flag.rollout_percentage === 10}>
                              10%
                            </button_1.Button>
                            <button_1.Button size="sm" variant="outline" onClick={function () { return quickRollout(flag.id, 50); }} disabled={flag.rollout_percentage === 50}>
                              50%
                            </button_1.Button>
                            <button_1.Button size="sm" variant="outline" onClick={function () { return quickRollout(flag.id, 100); }} disabled={flag.rollout_percentage === 100}>
                              100%
                            </button_1.Button>
                          </div>
                        </div>
        ...
        <tabs_1.TabsContent value="rollouts" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent>
              {rolloutPlans.length === 0 ? (<div className="text-center py-6">
                  ...
                  {rolloutPlans.map(function (plan) { return (<div key={plan.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-center">
                        <div>
