      ...
      return __generator(this, (_c) => {
        switch (_c.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              Promise.all([fetch("/api/monitoring/metrics"), fetch("/api/health")]),
            ];
          case 1:
            (_a = _c.sent()), (metricsRes = _a[0]), (healthRes = _a[1]);
            if (!(metricsRes.ok && healthRes.ok)) return [3 /*break*/, 3];
            return [4 /*yield*/, Promise.all([metricsRes.json(), healthRes.json()])];
          case 2:
        ...
        <card_1.CardHeader>
          <card_1.CardTitle className="flex items-center gap-2">
            ...
            {health && (
              <badge_1.Badge
                variant="outline"
                className={"".concat(getStatusColor(health.status), " text-white")}
              >
          ...
          <card_1.CardDescription>
            Last updated:{" "}
            {(health === null || health === void 0 ? void 0 : health.timestamp)
      ...
      <tabs_1.Tabs defaultValue="overview" className="w-full">
        ...
        <tabs_1.TabsContent value="overview">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <card_1.Card>
              <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <card_1.CardTitle className="text-sm font-medium">Throughput</card_1.CardTitle>
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                ...
                <progress_1.Progress
                  value={(metrics === null || metrics === void 0 ? void 0 : metrics.errorRate) || 0}
                  className="mt-2"
                  // @ts-ignore
                  indicatorClassName={
                    (metrics === null || metrics === void 0 ? void 0 : metrics.errorRate) &&
                    metrics.errorRate > 5
                      ? "bg-red-500"
                      : "bg-green-500"
                  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {(metrics === null || metrics === void 0 ? void 0 : metrics.cacheHitRate) ||
                        0}
                      %
                    </span>
                  </div>
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Current system resource utilization</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm text-muted-foreground">
                        {(metrics === null || metrics === void 0 ? void 0 : metrics.memoryUsage) ||
                          0}
                        %
                      </span>
                    </div>
