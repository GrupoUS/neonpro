...
function AccessibleMenu(_a) {
  ...
  var handleKeyDown = (event) => {
    ...
    if (
      [
        accessibility_utils_1.KEYBOARD_KEYS.ARROW_UP,
        accessibility_utils_1.KEYBOARD_KEYS.ARROW_DOWN,
        accessibility_utils_1.KEYBOARD_KEYS.ARROW_LEFT,
        accessibility_utils_1.KEYBOARD_KEYS.ARROW_RIGHT,
      ].includes(event.key)
    ) {
    ...
    if (
      event.key === accessibility_utils_1.KEYBOARD_KEYS.ENTER ||
...
function AccessibleTabs(_a) {
  var tabs = _a.tabs,
    ...
    className = _a.className;
  var _b = (0, react_1.useState)(activeTab),
    focusedTab = _b[0],
    setFocusedTab = _b[1];
