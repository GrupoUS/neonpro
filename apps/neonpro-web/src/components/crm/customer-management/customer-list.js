...
function CustomerList(_a) {
    var _this = this;
    var onCustomerSelect = _a.onCustomerSelect, onCreateCustomer = _a.onCreateCustomer, onEditCustomer = _a.onEditCustomer;
    var _b = (0, crm_context_1.useCRM)(), state = _b.state, dispatch = _b.dispatch, filteredCustomers = _b.filteredCustomers, totalCustomers = _b.totalCustomers, activeCustomers = _b.activeCustomers, vipCustomers = _b.vipCustomers, setFilter = _b.setFilter, resetFilters = _b.resetFilters, setLoading = _b.setLoading, setError = _b.setError;
    var _c = (0, react_1.useState)([]), selectedCustomers = _c[0], setSelectedCustomers = _c[1];
    ...
    var handleSelectAll = function () {
        if (selectedCustomers.length === filteredCustomers.length) {
            ...
            setSelectedCustomers(filteredCustomers.map(function (c) { return c.id; }));
        }
    };
    var handleSelectCustomer = function (customerId) {
        if (selectedCustomers.includes(customerId)) {
            setSelectedCustomers(function (prev) { return prev.filter(function (id) { return id !== customerId; }); });
        }
        else {
            setSelectedCustomers(function (prev) { return __spreadArray(__spreadArray([], prev, true), [customerId], false); });
        }
    };
    ...
    if (state.errors.customers) {
        ...
        <card_1.CardContent className="p-6">
          <div className="text-center text-red-600">
            ...
            <button_1.Button onClick={function () { return window.location.reload(); }} className="mt-4">
              Tentar Novamente
            </button_1.Button>
          </div>
        </card_1.CardContent>
    ...
    return (<div className="space-y-6">
        ...
        <card_1.CardHeader>
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              {onCreateCustomer && (<button_1.Button onClick={onCreateCustomer} size="sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input_1.Input placeholder="Buscar por nome ou email..." value={state.filters.customer_search} onChange={function (e) { return setFilter("customer_search", e.target.value); }} className="pl-10"/>
            </div>

            <select_1.Select value={state.filters.customer_status} onValueChange={function (value) { return setFilter("customer_status", value); }}>
            ...
            state.filters.customer_status) && (<button_1.Button onClick={resetFilters} variant="outline" size="sm">
                Limpar Filtros
              </button_1.Button>)}
          </div>
        </card_1.CardHeader>
              ...
              <table_1.TableHeader>
                <table_1.TableRow>
                  <table_1.TableHead className="w-12">
                    <input type="checkbox" checked={selectedCustomers.length === filteredCustomers.length &&
            filteredCustomers.length > 0} onChange={handleSelectAll} className="rounded border-gray-300"/>
                  </table_1.TableHead>
              ...
              <table_1.TableBody>
                ...
                state.filters.customer_status ? (<>
                  ...
                  </table_1.TableRow>) : (filteredCustomers.map(function (customer) {
            var _a, _b, _c;
            return (<table_1.TableRow key={customer.id} className="cursor-pointer hover:bg-muted/50" onClick={function () { return onCustomerSelect === null || onCustomerSelect === void 0 ? void 0 : onCustomerSelect(customer); }}>
                      <table_1.TableCell onClick={function (e) { return e.stopPropagation(); }}>
                        <input type="checkbox" checked={selectedCustomers.includes(customer.id)} onChange={function () { return handleSelectCustomer(customer.id); }} className="rounded border-gray-300"/>
                      </table_1.TableCell>
                      <table_1.TableCell>
                      ...
                      <table_1.TableCell onClick={function (e) { return e.stopPropagation(); }}>
                        <dropdown_menu_1.DropdownMenu>
                          ...
                          <dropdown_menu_1.DropdownMenuContent align="end">
                            ...
                            <dropdown_menu_1.DropdownMenuItem onClick={function () { return onCustomerSelect === null || onCustomerSelect === void 0 ? void 0 : onCustomerSelect(customer); }}>
                              Ver Detalhes
                            </dropdown_menu_1.DropdownMenuItem>
                            {onEditCustomer && (<dropdown_menu_1.DropdownMenuItem onClick={function () { return onEditCustomer(customer); }}>
                                Editar
                              </dropdown_menu_1.DropdownMenuItem>)}
                            <dropdown_menu_1.DropdownMenuSeparator />
      ...
      {selectedCustomers.length > 0 && (<div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-primary text-primary-foreground px-4 py-2 rounded-lg shadow-lg">
