...
function PatientActions(_a) {
    var selectedCount = _a.selectedCount, onBulkAction = _a.onBulkAction, onClearSelection = _a.onClearSelection;
    var _b = (0, react_1.useState)(false), showExportDialog = _b[0], setShowExportDialog = _b[1];
    var _c = (0, react_1.useState)(false), showMessageDialog = _c[0], setShowMessageDialog = _c[1];
    var _d = (0, react_1.useState)(false), showArchiveDialog = _d[0], setShowArchiveDialog = _d[1];
    // Export settings
    ...
    }), exportFields = _f[0], setExportFields = _f[1];
    var _g = (0, react_1.useState)(true), anonymizeData = _g[0], setAnonymizeData = _g[1];
    // Message settings
    var _h = (0, react_1.useState)('email'), messageType = _h[0], setMessageType = _h[1];
    var _j = (0, react_1.useState)(''), messageContent = _j[0], setMessageContent = _j[1];
    var _k = (0, react_1.useState)(''), messageTemplate = _k[0], setMessageTemplate = _k[1];
    var handleExport = function () {
        // LGPD compliance validation
        if (exportFields.medical || exportFields.lgpd_sensitive) {
            if (!anonymizeData) {
                sonner_1.toast.error('Dados médicos e sensíveis devem ser anonimizados para conformidade LGPD');
                return;
            }
        }
        ...
        logLGPDAudit('data_export', {
            ...
            fields_exported: Object.keys(exportFields).filter(function (key) { return exportFields[key]; })
        });
    };
    ...
    return (<card_1.Card className="bg-blue-50 border-blue-200">
      <card_1.CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <lucide_react_1.Users className="h-5 w-5 text-blue-600"/>
            <card_1.CardTitle className="text-lg text-blue-900">
              Ações em Lote
            </card_1.CardTitle>
          ...
          <button_1.Button variant="ghost" size="sm" onClick={onClearSelection} className="text-blue-600 hover:text-blue-800">
      ...
      <card_1.CardContent>
        <div className="flex flex-wrap gap-2">
            ...
            <dialog_1.DialogContent className="sm:max-w-md">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <select_1.Select value={exportFormat} onValueChange={setExportFormat}>
                    ...
                    <select_1.SelectContent>
                      ...
                      <select_1.SelectItem value="json">JSON (Dados estruturados)</select_1.SelectItem>
                    </select_1.SelectContent>
                  </select_1.Select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <checkbox_1.Checkbox id="personal" checked={exportFields.personal} onCheckedChange={function (checked) {
            return setExportFields(__assign(__assign({}, exportFields), { personal: !!checked }));
        }}/>
                    ...
                    <div className="flex items-center space-x-2">
                      <checkbox_1.Checkbox id="contact" checked={exportFields.contact} onCheckedChange={function (checked) {
            return setExportFields(__assign(__assign({}, exportFields), { contact: !!checked }));
        }}/>
                    ...
                    <div className="flex items-center space-x-2">
                      <checkbox_1.Checkbox id="medical" checked={exportFields.medical} onCheckedChange={function (checked) {
            return setExportFields(__assign(__assign({}, exportFields), { medical: !!checked }));
        }}/>
                    ...
                    <div className="flex items-center space-x-2">
                      <checkbox_1.Checkbox id="lgpd_sensitive" checked={exportFields.lgpd_sensitive} onCheckedChange={function (checked) {
            return setExportFields(__assign(__assign({}, exportFields), { lgpd_sensitive: !!checked }));
        }}/>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <checkbox_1.Checkbox id="anonymize" checked={anonymizeData} onCheckedChange={function (checked) { return setAnonymizeData(!!checked); }}/>
                    <label_1.Label htmlFor="anonymize" className="text-sm font-medium">
                      Anonimizar dados sensíveis (Recomendado)
                    </label_1.Label>
                  </div>
                  {!anonymizeData && (exportFields.medical || exportFields.lgpd_sensitive) && (<alert_1.Alert>
          ...
          <dialog_1.Dialog open={showMessageDialog} onOpenChange={setShowMessageDialog}>
            ...
            <dialog_1.DialogContent className="sm:max-w-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <select_1.Select value={messageTemplate} onValueChange={function (value) {
            ...
            populateTemplate(value);
                    ...
                    <select_1.SelectContent>
                      ...
                      <select_1.SelectItem value="follow_up">Acompanhamento pós-consulta</select_1.SelectItem>
                      <select_1.SelectItem value="wellness_check">Check-up de bem-estar</select_1.SelectItem>
                ...
                <div className="space-y-2">
                  ...
                  <textarea_1.Textarea placeholder="Digite sua mensagem aqui..." value={messageContent} onChange={function (e) { return setMessageContent(e.target.value); }} rows={4}/>
              ...
              <dialog_1.DialogFooter>
                <button_1.Button variant="outline" onClick={function () { return setShowMessageDialog(false); }}>
                  Cancelar
                </button_1.Button>
          ...
          <dialog_1.Dialog open={showArchiveDialog} onOpenChange={setShowArchiveDialog}>
            <dialog_1.DialogTrigger asChild>
              <button_1.Button variant="outline" size="sm" className="flex items-center text-orange-600">
            ...
            <dialog_1.DialogContent>
              ...
              <dialog_1.DialogFooter>
                <button_1.Button variant="outline" onClick={function () { return setShowArchiveDialog(false); }}>
                  Cancelar
                </button_1.Button>
          ...
          <button_1.Button variant="outline" size="sm" onClick={function () { return onBulkAction('schedule_bulk'); }} className="flex items-center">
