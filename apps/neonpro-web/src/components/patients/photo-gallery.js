...
function PhotoGallery(_a) {
    var _this = this;
    var patientId = _a.patientId, _b = _a.readonly, readonly = _b === void 0 ? false : _b, onPhotoDeleted = _a.onPhotoDeleted, onPhotoUpdated = _a.onPhotoUpdated, className = _a.className;
    var _c = (0, react_1.useState)([]), photos = _c[0], setPhotos = _c[1];
    var _d = (0, react_1.useState)([]), filteredPhotos = _d[0], setFilteredPhotos = _d[1];
    var _e = (0, react_1.useState)(true), loading = _e[0], setLoading = _e[1];
    var _f = (0, react_1.useState)(null), error = _f[0], setError = _f[1];
    var _g = (0, react_1.useState)(null), selectedPhoto = _g[0], setSelectedPhoto = _g[1];
    var _h = (0, react_1.useState)('grid'), viewMode = _h[0], setViewMode = _h[1];
    var _j = (0, react_1.useState)('date_desc'), sortBy = _j[0], setSortBy = _j[1];
    // Filters
    var _k = (0, react_1.useState)(''), searchTerm = _k[0], setSearchTerm = _k[1];
    var _l = (0, react_1.useState)('all'), categoryFilter = _l[0], setCategoryFilter = _l[1];
    var _m = (0, react_1.useState)('all'), treatmentFilter = _m[0], setTreatmentFilter = _m[1];
    var _o = (0, react_1.useState)('all'), areaFilter = _o[0], setAreaFilter = _o[1];
    // Pagination
    var _p = (0, react_1.useState)(1), currentPage = _p[0], setCurrentPage = _p[1];
    var _q = (0, react_1.useState)(1), totalPages = _q[0], setTotalPages = _q[1];
    var _r = (0, react_1.useState)(false), hasMore = _r[0], setHasMore = _r[1];
    ...
    var loadPhotos = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    setError(null);
                    return [4 /*yield*/, (0, supabase_storage_1.getPatientPhotos)(patientId, {
                            page: currentPage,
                ...
                case 1:
                    ...
                    if (currentPage === 1) {
                        ...
                        setPhotos(function (prev) { return __spreadArray(__spreadArray([], prev, true), newPhotos_1, true); });
                    }
    ...
    var applyFiltersAndSort = function () {
        ...
        if (searchTerm) {
            ...
            filtered = filtered.filter(function (photo) {
                return photo.file_name.toLowerCase().includes(term_1) ||
        ...
        if (categoryFilter !== 'all') {
            filtered = filtered.filter(function (photo) { return photo.metadata.category === categoryFilter; });
        }
        // Apply treatment filter
        if (treatmentFilter !== 'all') {
            filtered = filtered.filter(function (photo) { return photo.metadata.treatmentType === treatmentFilter; });
        }
        // Apply area filter
        if (areaFilter !== 'all') {
            filtered = filtered.filter(function (photo) { return photo.metadata.anatomicalArea === areaFilter; });
        }
        // Apply sorting
    ...
    var handleDownload = function (photo) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var handleDelete = function (photo) { return __awaiter(_this, void 0, void 0, function () {
        var result, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var getCategoryColor = function (category) {
        switch (category) {
            ...
            case 'after': return 'text-green-600 bg-green-50';
            case 'during': return 'text-orange-600 bg-orange-50';
    ...
    var uniqueTreatments = __spreadArray([], new Set(photos.map(function (p) { return p.metadata.treatmentType; })), true).filter(Boolean);
    var uniqueAreas = __spreadArray([], new Set(photos.map(function (p) { return p.metadata.anatomicalArea; })), true).filter(Boolean);
    ...
    return (<div className={(0, utils_1.cn)("space-y-6", className)}>
      ...
      <div className="space-y-4">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="relative flex-1">
            ...
            <input_1.Input placeholder="Buscar por nome, tratamento, área ou observações..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-9"/>
          </div>

          {/* View Mode Toggle */}
          <div className="flex items-center gap-2">
            <button_1.Button variant={viewMode === 'grid' ? 'default' : 'outline'} size="sm" onClick={function () { return setViewMode('grid'); }}>
          ...
          <div className="space-y-2">
            ...
            <select_1.Select value={treatmentFilter} onValueChange={setTreatmentFilter}>
              ...
              <select_1.SelectContent>
                ...
                {uniqueTreatments.map(function (treatment) { return (<select_1.SelectItem key={treatment} value={treatment}>
                    {treatment}
                  </select_1.SelectItem>); })}
              </select_1.SelectContent>
            </select_1.Select>
          ...
          <div className="space-y-2">
            ...
            <select_1.Select value={areaFilter} onValueChange={setAreaFilter}>
              ...
              <select_1.SelectContent>
                ...
                {uniqueAreas.map(function (area) { return (<select_1.SelectItem key={area} value={area}>
                    {area}
                  </select_1.SelectItem>); })}
              </select_1.SelectContent>
            </select_1.Select>
      ...
      <div className="flex items-center justify-between">
        ...
        {filteredPhotos.length > 0 && (<div className="text-sm text-muted-foreground">
            {formatFileSize(filteredPhotos.reduce(function (sum, photo) { return sum + photo.file_size; }, 0))} total
          </div>)}
      </div>
      ...
      {filteredPhotos.length === 0 ? (<div className="text-center py-12">
          ...
          {viewMode === 'grid' ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {filteredPhotos.map(function (photo) { return (<card_1.Card key={photo.id} className="overflow-hidden group">
                  <div className="aspect-square relative">
                    {photo.publicUrl && (<img src={photo.publicUrl} alt={photo.file_name} className="w-full h-full object-cover" loading="lazy"/>)}
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                      ...
                      <button_1.Button size="sm" variant="secondary" onClick={function () { return handleDownload(photo); }}>
                        <lucide_react_1.Download className="h-4 w-4"/>
                      </button_1.Button>
                      {!readonly && (<button_1.Button size="sm" variant="destructive" onClick={function () { return handleDelete(photo); }}>
                  ...
                  <card_1.CardContent className="p-3">
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">{photo.metadata.anatomicalArea}</p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-muted-foreground">
                          {(0, date_fns_1.format)(new Date(photo.created_at), "dd/MM/yyyy", { locale: locale_1.ptBR })}
                        </span>
                        <span className="text-xs text-muted-foreground">
            ...
            /* List View */
            <div className="space-y-2">
              {filteredPhotos.map(function (photo) { return (<card_1.Card key={photo.id} className="p-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {photo.metadata.notes && (<p className="text-sm text-muted-foreground mt-1 line-clamp-1">
                    ...
                    {/* Actions */}
                    <div className="flex items-center gap-2">
                      <button_1.Button size="sm" variant="outline" onClick={function () { return setSelectedPhoto(photo); }}>
                        <lucide_react_1.Eye className="h-4 w-4"/>
                      </button_1.Button>
                      <button_1.Button size="sm" variant="outline" onClick={function () { return handleDownload(photo); }}>
                        <lucide_react_1.Download className="h-4 w-4"/>
                      </button_1.Button>
                      {!readonly && (<button_1.Button size="sm" variant="outline" onClick={function () { return handleDelete(photo); }}>
                          <lucide_react_1.Trash2 className="h-4 w-4"/>
                        </button_1.Button>)}
                    </div>
                  </div>
          ...
          {hasMore && (<div className="text-center pt-6">
              <button_1.Button variant="outline" onClick={function () { return setCurrentPage(function (prev) { return prev + 1; }); }} disabled={loading}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2">
                  <div className="max-h-96 flex items-center justify-center">
                    <img src={selectedPhoto.publicUrl} alt={selectedPhoto.file_name} className="max-w-full max-h-96 object-contain rounded-lg"/>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {(0, date_fns_1.format)(new Date(selectedPhoto.metadata.date), "PPP", { locale: locale_1.ptBR })}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {(0, date_fns_1.format)(new Date(selectedPhoto.created_at), "PPP 'às' HH:mm", { locale: locale_1.ptBR })}
                      </p>
                    </div>
                    ...
                    {selectedPhoto.metadata.notes && (<div>
                  ...
                  <div className="flex gap-2 pt-4">
                    <button_1.Button size="sm" onClick={function () { return handleDownload(selectedPhoto); }} className="flex-1">
                      <lucide_react_1.Download className="h-4 w-4 mr-2"/>
                      Download
                    </button_1.Button>
                    {!readonly && (<button_1.Button size="sm" variant="destructive" onClick={function () {
