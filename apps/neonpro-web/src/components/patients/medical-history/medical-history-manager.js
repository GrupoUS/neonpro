...
function MedicalHistoryManager(_a) {
    var _this = this;
    var patientId = _a.patientId, _b = _a.readOnly, readOnly = _b === void 0 ? false : _b, onHistoryUpdate = _a.onHistoryUpdate;
    // State management
    var _c = (0, react_1.useState)([]), conditions = _c[0], setConditions = _c[1];
    var _d = (0, react_1.useState)([]), allergies = _d[0], setAllergies = _d[1];
    var _e = (0, react_1.useState)([]), medications = _e[0], setMedications = _e[1];
    var _f = (0, react_1.useState)([]), familyHistory = _f[0], setFamilyHistory = _f[1];
    var _g = (0, react_1.useState)(null), socialHistory = _g[0], setSocialHistory = _g[1];
    var _h = (0, react_1.useState)(true), loading = _h[0], setLoading = _h[1];
    var _j = (0, react_1.useState)('conditions'), activeTab = _j[0], setActiveTab = _j[1];
    var _k = (0, react_1.useState)(''), searchTerm = _k[0], setSearchTerm = _k[1];
    var _l = (0, react_1.useState)('all'), filterStatus = _l[0], setFilterStatus = _l[1];
    // Dialog states
    var _m = (0, react_1.useState)(false), showConditionDialog = _m[0], setShowConditionDialog = _m[1];
    var _o = (0, react_1.useState)(false), showAllergyDialog = _o[0], setShowAllergyDialog = _o[1];
    var _p = (0, react_1.useState)(false), showMedicationDialog = _p[0], setShowMedicationDialog = _p[1];
    var _q = (0, react_1.useState)(false), showFamilyDialog = _q[0], setShowFamilyDialog = _q[1];
    var _r = (0, react_1.useState)(false), showSocialDialog = _r[0], setShowSocialDialog = _r[1];
    var _s = (0, react_1.useState)(null), editingItem = _s[0], setEditingItem = _s[1];
    ...
    var handleAddCondition = function (conditionData) { return __awaiter(_this, void 0, void 0, function () {
        var newCondition_1;
        return __generator(this, function (_a) {
            try {
                newCondition_1 = __assign(__assign({ id: "condition_".concat(Date.now()), patient_id: patientId }, conditionData), { created_at: new Date().toISOString(), updated_at: new Date().toISOString(), created_by: 'current_user_id', updated_by: 'current_user_id', lgpd_consent: true, data_retention_date: new Date(Date.now() + 7 * 365 * 24 * 60 * 60 * 1000).toISOString() // 7 years
                 });
                setConditions(function (prev) { return __spreadArray([newCondition_1], prev, true); });
    ...
    var handleAddAllergy = function (allergyData) { return __awaiter(_this, void 0, void 0, function () {
        var newAllergy_1;
        return __generator(this, function (_a) {
            try {
                newAllergy_1 = __assign(__assign({ id: "allergy_".concat(Date.now()), patient_id: patientId }, allergyData), { created_at: new Date().toISOString(), updated_at: new Date().toISOString(), lgpd_consent: true });
                setAllergies(function (prev) { return __spreadArray([newAllergy_1], prev, true); });
    ...
    var handleAddMedication = function (medicationData) { return __awaiter(_this, void 0, void 0, function () {
        var newMedication_1;
        return __generator(this, function (_a) {
            try {
                newMedication_1 = __assign(__assign({ id: "medication_".concat(Date.now()), patient_id: patientId }, medicationData), { created_at: new Date().toISOString(), updated_at: new Date().toISOString(), lgpd_consent: true });
                setMedications(function (prev) { return __spreadArray([newMedication_1], prev, true); });
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <button_1.Button variant="outline" onClick={handleExportHistory} className="hidden sm:flex">
            <lucide_react_1.Download className="mr-2 h-4 w-4"/>
            Exportar
          </button_1.Button>
          {!readOnly && (<button_1.Button onClick={function () { return loadMedicalHistory(); }}>
      ...
      <div className="flex items-center space-x-4">
        <div className="relative flex-1">
          ...
          <input_1.Input placeholder="Buscar no histórico médico..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-10"/>
        </div>
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <tabs_1.TabsContent value="conditions" className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            {!readOnly && (<dialog_1.Dialog open={showConditionDialog} onOpenChange={setShowConditionDialog}>
                ...
                <dialog_1.DialogContent className="max-w-2xl">
                  ...
                  <ConditionForm onSubmit={handleAddCondition} onCancel={function () { return setShowConditionDialog(false); }}/>
                </dialog_1.DialogContent>
              </dialog_1.Dialog>)}
          </div>
          
          <div className="grid gap-4">
            {conditions.map(function (condition) { return (<card_1.Card key={condition.id} className="p-4">
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <h4 className="font-semibold">{condition.condition_name}</h4>
                      {condition.icd_10_code && (<badge_1.Badge variant="outline">{condition.icd_10_code}</badge_1.Badge>)}
                    ...
                    <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                      <span>Início: {(0, date_fns_1.format)(new Date(condition.onset_date), 'dd/MM/yyyy', { locale: locale_1.ptBR })}</span>
                      {condition.resolution_date && (<span>Resolução: {(0, date_fns_1.format)(new Date(condition.resolution_date), 'dd/MM/yyyy', { locale: locale_1.ptBR })}</span>)}
                    </div>
                  </div>
        ...
        <tabs_1.TabsContent value="allergies" className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            {!readOnly && (<dialog_1.Dialog open={showAllergyDialog} onOpenChange={setShowAllergyDialog}>
                <dialog_1.DialogTrigger asChild>
                  <button_1.Button>
                    <lucide_react_1.Plus className="mr-2 h-4 w-4"/>
                    Nova Alergia
                ...
                <dialog_1.DialogContent className="max-w-2xl">
                  ...
                  <AllergyForm onSubmit={handleAddAllergy} onCancel={function () { return setShowAllergyDialog(false); }}/>
                </dialog_1.DialogContent>
              </dialog_1.Dialog>)}
          </div>
          
          <div className="grid gap-4">
            {allergies.map(function (allergy) { return (<card_1.Card key={allergy.id} className="p-4">
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {allergy.symptoms.map(function (symptom, index) { return (<badge_1.Badge key={index} variant="secondary" className="text-xs">
                          {symptom}
                        </badge_1.Badge>); })}
                    </div>
                  </div>
        ...
        <tabs_1.TabsContent value="medications" className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            {!readOnly && (<dialog_1.Dialog open={showMedicationDialog} onOpenChange={setShowMedicationDialog}>
                <dialog_1.DialogTrigger asChild>
                  <button_1.Button>
                    <lucide_react_1.Plus className="mr-2 h-4 w-4"/>
                    Nova Medicação
                ...
                <dialog_1.DialogContent className="max-w-2xl">
                  ...
                  <MedicationForm onSubmit={handleAddMedication} onCancel={function () { return setShowMedicationDialog(false); }}/>
                </dialog_1.DialogContent>
              </dialog_1.Dialog>)}
          </div>
          
          <div className="grid gap-4">
            {medications.map(function (medication) { return (<card_1.Card key={medication.id} className="p-4">
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <h4 className="font-semibold">{medication.medication_name}</h4>
                      {medication.generic_name && (<badge_1.Badge variant="outline">{medication.generic_name}</badge_1.Badge>)}
                    ...
                    <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                      <span>Início: {(0, date_fns_1.format)(new Date(medication.start_date), 'dd/MM/yyyy', { locale: locale_1.ptBR })}</span>
                      {medication.end_date && (<span>Fim: {(0, date_fns_1.format)(new Date(medication.end_date), 'dd/MM/yyyy', { locale: locale_1.ptBR })}</span>)}
                    </div>
                  </div>
                  {!readOnly && (<div className="flex items-center space-x-2">
                      <button_1.Button variant="ghost" size="sm">
        ...
        <tabs_1.TabsContent value="family" className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            {!readOnly && (<dialog_1.Dialog open={showFamilyDialog} onOpenChange={setShowFamilyDialog}>
                <dialog_1.DialogTrigger asChild>
                  <button_1.Button>
                    <lucide_react_1.Plus className="mr-2 h-4 w-4"/>
                    Novo Registro
                ...
                <dialog_1.DialogContent className="max-w-2xl">
                  ...
                  <FamilyHistoryForm onSubmit={function (data) {
                // Handle family history submission
                setShowFamilyDialog(false);
                sonner_1.toast.success('Histórico familiar adicionado');
            }} onCancel={function () { return setShowFamilyDialog(false); }}/>
                </dialog_1.DialogContent>
              </dialog_1.Dialog>)}
          </div>
          
          <div className="grid gap-4">
            {familyHistory.map(function (history) { return (<card_1.Card key={history.id} className="p-4">
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                      {history.age_of_onset && (<span>Idade de início: {history.age_of_onset} anos</span>)}
                      {history.age_of_death && (<span>Idade do óbito: {history.age_of_death} anos</span>)}
                    </div>
                  </div>
                  {!readOnly && (<div className="flex items-center space-x-2">
                      <button_1.Button variant="ghost" size="sm">
        ...
        <tabs_1.TabsContent value="social" className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            {!readOnly && (<dialog_1.Dialog open={showSocialDialog} onOpenChange={setShowSocialDialog}>
                <dialog_1.DialogTrigger asChild>
                  <button_1.Button>
                ...
                <dialog_1.DialogContent className="max-w-2xl">
                  ...
                  <SocialHistoryForm initialData={socialHistory} onSubmit={function (data) {
                setSocialHistory(data);
                setShowSocialDialog(false);
                sonner_1.toast.success('Histórico social atualizado');
            }} onCancel={function () { return setShowSocialDialog(false); }}/>
                </dialog_1.DialogContent>
              </dialog_1.Dialog>)}
          </div>
          
          {socialHistory && (<card_1.Card className="p-6">
              <div className="grid gap-6 md:grid-cols-2">
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold mb-2">Tabagismo</h4>
                    <badge_1.Badge className={socialHistory.smoking_status === 'current' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'}>
                      {socialHistory.smoking_status}
                    </badge_1.Badge>
                    {socialHistory.smoking_details && (<div className="text-sm text-muted-foreground mt-1">
                        {socialHistory.smoking_details.packs_per_day && (<p>Maços/dia: {socialHistory.smoking_details.packs_per_day}</p>)}
                        {socialHistory.smoking_details.years_smoked && (<p>Anos fumando: {socialHistory.smoking_details.years_smoked}</p>)}
                      </div>)}
                  </div>
                  ...
                  <div>
                    ...
                    {socialHistory.alcohol_details && (<div className="text-sm text-muted-foreground mt-1">
                        {socialHistory.alcohol_details.drinks_per_week && (<p>Doses/semana: {socialHistory.alcohol_details.drinks_per_week}</p>)}
                      </div>)}
                  </div>
                  
                  <div>
                    <h4 className="font-semibold mb-2">Exercício</h4>
                    <badge_1.Badge variant="outline">{socialHistory.exercise_frequency}</badge_1.Badge>
                    {socialHistory.exercise_details && (<p className="text-sm text-muted-foreground mt-1">{socialHistory.exercise_details}</p>)}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    {socialHistory.occupational_hazards && socialHistory.occupational_hazards.length > 0 && (<div className="mt-1">
                        <p className="text-xs text-muted-foreground">Riscos ocupacionais:</p>
                        <div className="flex flex-wrap gap-1 mt-1">
                          {socialHistory.occupational_hazards.map(function (hazard, index) { return (<badge_1.Badge key={index} variant="secondary" className="text-xs">
                              {hazard}
                            </badge_1.Badge>); })}
                        </div>
                      </div>)}
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <badge_1.Badge variant="outline">{socialHistory.stress_level}/10</badge_1.Badge>
                      <div className="flex-1 bg-gray-200 rounded-full h-2">
                        <div className="bg-blue-600 h-2 rounded-full" style={{ width: "".concat((socialHistory.stress_level / 10) * 100, "%") }}></div>
                      </div>
                    </div>
                  </div>
    ...
    return (<form onSubmit={function (e) { e.preventDefault(); onSubmit(formData); }} className="space-y-4">
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          ...
          <input_1.Input id="condition_name" value={formData.condition_name} onChange={function (e) { return setFormData(function (prev) { return (__assign(__assign({}, prev), { condition_name: e.target.value })); }); }} required/>
        </div>
        <div>
          <label_1.Label htmlFor="icd_10_code">Código CID-10</label_1.Label>
          <input_1.Input id="icd_10_code" value={formData.icd_10_code} onChange={function (e) { return setFormData(function (prev) { return (__assign(__assign({}, prev), { icd_10_code: e.target.value })); }); }}/>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div>
          ...
          <select_1.Select value={formData.severity} onValueChange={function (value) { return setFormData(function (prev) { return (__assign(__assign({}, prev), { severity: value })); }); }}>
            <select_1.SelectTrigger>
        ...
        <div>
          ...
          <select_1.Select value={formData.status} onValueChange={function (value) { return setFormData(function (prev) { return (__assign(__assign({}, prev), { status: value })); }); }}>
            <select_1.SelectTrigger>
              <select_1.SelectValue />
            </select_1.SelectTrigger>
            <select_1.SelectContent>
        ...
        <div>
          ...
          <input_1.Input id="onset_date" type="date" value={formData.onset_date} onChange={function (e) { return setFormData(function (prev) { return (__assign(__assign({}, prev), { onset_date: e.target.value })); }); }}/>
        </div>
      </div>
      ...
      <div>
        ...
        <textarea_1.Textarea id="treatment_notes" value={formData.treatment_notes} onChange={function (e) { return setFormData(function (prev) { return (__assign(__assign({}, prev), { treatment_notes: e.target.value })); }); }} rows={3}/>
      </div>
