      ...
      <CardContent className="space-y-6">
        ...
        {enableRecognition && (
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="facial-recognition">Habilitar reconhecimento facial</Label>
          </div>
        )}
        ...
        <div className="flex gap-3">
          <Button onClick={uploadPhoto} disabled={!selectedFile || isUploading} className="flex-1">
            {isUploading ? (
              <>
          ...
          {selectedFile && (
            <Button type="button" variant="outline" onClick={resetUpload} disabled={isUploading}>
              Cancelar
            </Button>
          )}
        </div>
