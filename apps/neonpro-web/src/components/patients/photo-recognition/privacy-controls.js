...
function PrivacyControls(_a) {
  ...
  var _c = (0, react_1.useState)(null),
    privacyControls = _c[0],
    setPrivacyControls = _c[1];
  var _d = (0, react_1.useState)([]),
    consentHistory = _d[0],
    setConsentHistory = _d[1];
  ...
  var _g = (0, react_1.useState)(false),
    showConsentDialog = _g[0],
    setShowConsentDialog = _g[1];
  var _h = (0, react_1.useState)(false),
    showExportDialog = _h[0],
    setShowExportDialog = _h[1];
  var _j = (0, react_1.useState)(false),
    showDeletionDialog = _j[0],
    setShowDeletionDialog = _j[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/patients/photos/privacy/consent-history?patientId=".concat(patientId), {
                headers: {
                  Authorization: "Bearer ".concat(localStorage.getItem("supabase_token")),
                },
              }),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            result = _a.sent();
            setPrivacyControls(result.data);
            onPrivacyUpdated === null || onPrivacyUpdated === void 0
              ? void 0
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/patients/photos/privacy/export", {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
                  Authorization: "Bearer ".concat(localStorage.getItem("supabase_token")),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch("/api/patients/photos/privacy/deletion", {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
                  Authorization: "Bearer ".concat(localStorage.getItem("supabase_token")),
        ...
        <card_1.CardHeader>
          <card_1.CardTitle className="text-lg flex items-center gap-2">
            {privacyControls.consentGiven
              ? <lucide_react_1.Check className="h-5 w-5 text-green-600" />
              : <lucide_react_1.X className="h-5 w-5 text-red-600" />}
        ...
        <dialog_1.DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <button_1.Button onClick={requestDataDeletion}>Enviar Solicitação</button_1.Button>
            </div>
          </div>
        </dialog_1.DialogContent>
      </dialog_1.Dialog>
