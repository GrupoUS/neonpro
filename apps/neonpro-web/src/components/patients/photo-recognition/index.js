...
function PhotoRecognitionSystem(_a) {
  ...
  var patientId = _a.patientId,
    ...
    onSystemUpdate = _a.onSystemUpdate,
    _b = _a.defaultTab,
    defaultTab = _b === void 0 ? "gallery" : _b,
    _c = _a.permissions,
    permissions = _c === void 0 ? DEFAULT_PERMISSIONS : _c;
  var _d = (0, react_1.useState)(defaultTab),
    activeTab = _d[0],
    setActiveTab = _d[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch("/api/patients/photos/stats?patientId=".concat(patientId), {
                headers: {
  ...
  var getComplianceStatus = function () {
    ...
    var _a = systemStats.privacyCompliance,
      consentGiven = _a.consentGiven,
      lgpdCompliant = _a.lgpdCompliant;
          ...
          <card_1.CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                {complianceStatus && (
                  <badge_1.Badge className={complianceStatus.color}>
            ...
            {Object.entries(systemStats.photosByType).map(function (_a) {
              ...
              return (
                <div key={type} className="text-center">
                  ...
                  <p className="text-sm text-gray-600">{PHOTO_TYPE_LABELS[type] || type}</p>
                </div>
              );
            })}
          </div>
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab}>
        <tabs_1.TabsList className="grid w-full grid-cols-4">
          ...
          {permissions.canVerify && (
            <tabs_1.TabsTrigger value="verify" className="flex items-center gap-2">
        ...
        {/* Verification Tab */}
        {permissions.canVerify && (
          <tabs_1.TabsContent value="verify" className="space-y-4">
            <identity_verification_1.IdentityVerification
              patientId={patientId}
              patientName={patientName}
        ...
        {permissions.canManagePrivacy && (
          <tabs_1.TabsContent value="privacy" className="space-y-4">
            <privacy_controls_1.PrivacyControls
              patientId={patientId}
              patientName={patientName}
