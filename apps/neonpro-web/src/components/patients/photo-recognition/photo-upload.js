...
function PhotoUpload(_a) {
  ...
  var patientId = _a.patientId,
    ...
    _b = _a.allowedTypes,
    allowedTypes = _b === void 0 ? ["image/jpeg", "image/jpg", "image/png", "image/webp"] : _b,
    _c = _a.maxFileSize,
    maxFileSize = _c === void 0 ? 10 * 1024 * 1024 : _c, // 10MB
    _d = _a.enableRecognition, // 10MB
    enableRecognition = _d === void 0 ? true : _d;
  var _e = (0, react_1.useState)(null),
    selectedFile = _e[0],
    setSelectedFile = _e[1];
  var _f = (0, react_1.useState)("profile"),
    photoType = _f[0],
    setPhotoType = _f[1];
  ...
  var _h = (0, react_1.useState)(0),
    uploadProgress = _h[0],
    setUploadProgress = _h[1];
  var _j = (0, react_1.useState)(null),
    previewUrl = _j[0],
    setPreviewUrl = _j[1];
  var _k = (0, react_1.useState)(null),
    uploadResult = _k[0],
    setUploadResult = _k[1];
  var _l = (0, react_1.useState)(enableRecognition),
    enableFacialRecognition = _l[0],
    setEnableFacialRecognition = _l[1];
    ...
    function (file) {
      ...
      if (file.size > maxFileSize) {
        toast({
          ...
          description: "O arquivo deve ter no m\u00E1ximo ".concat(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch("/api/patients/photos/upload", {
                method: "POST",
                headers: {
          ...
          case 5:
            ...
            toast({
              ...
              description:
                enableFacialRecognition && result.data.recognition
                  ? "Reconhecimento facial: ".concat(
                      result.data.recognition.confidence,
                      "% de confian\u00E7a",
                    )
                  : "Foto enviada com sucesso.",
            });
            onUploadSuccess === null || onUploadSuccess === void 0
              ? void 0
  ...
  return (
    <card_1.Card className="w-full max-w-2xl mx-auto">
      ...
      <card_1.CardContent className="space-y-6">
        ...
        {/* File Upload Area */}
        <div
          className={"border-2 border-dashed rounded-lg p-8 text-center transition-colors ".concat(
              ...
              <div className="space-y-2">
                ...
                {uploadResult.recognition && (
                  <div className="flex items-center gap-2">
                    <badge_1.Badge
                      variant={uploadResult.recognition.success ? "default" : "secondary"}
                    >
