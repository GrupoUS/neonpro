...
function PhotoGallery(_a) {
    var _this = this;
    var _b;
    var patientId = _a.patientId, patientName = _a.patientName, onPhotoDeleted = _a.onPhotoDeleted, _c = _a.allowDelete, allowDelete = _c === void 0 ? true : _c, _d = _a.allowDownload, allowDownload = _d === void 0 ? true : _d;
    var _e = (0, react_1.useState)([]), photos = _e[0], setPhotos = _e[1];
    var _f = (0, react_1.useState)(null), privacyControls = _f[0], setPrivacyControls = _f[1];
    var _g = (0, react_1.useState)(true), isLoading = _g[0], setIsLoading = _g[1];
    var _h = (0, react_1.useState)('all'), selectedPhotoType = _h[0], setSelectedPhotoType = _h[1];
    var _j = (0, react_1.useState)('grid'), viewMode = _j[0], setViewMode = _j[1];
    var _k = (0, react_1.useState)(null), selectedPhoto = _k[0], setSelectedPhoto = _k[1];
    var _l = (0, react_1.useState)(false), showPrivacyDialog = _l[0], setShowPrivacyDialog = _l[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("/api/patients/photos/upload?patientId=".concat(patientId).concat(selectedPhotoType !== 'all' ? "&photoType=".concat(selectedPhotoType) : ''), {
                            headers: {
    ...
    var updatePrivacyControls = function (newControls) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var deletePhoto = function (photoId) { return __awaiter(_this, void 0, void 0, function () {
        var response, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("/api/patients/photos/privacy?photoId=".concat(photoId, "&reason=user_request"), {
                            method: 'DELETE',
                            headers: {
                                'Authorization': "Bearer ".concat(localStorage.getItem('supabase_token'))
                            }
                ...
                case 1:
                    ...
                    setPhotos(photos.filter(function (photo) { return photo.id !== photoId; }));
    ...
    return (<div className="space-y-6">
      ...
      <card_1.Card>
        <card_1.CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button_1.Button variant="outline" size="sm" onClick={function () { return setShowPrivacyDialog(true); }}>
        ...
        <card_1.CardContent>
          <div className="flex items-center gap-4 mb-4">
            ...
            return (<select_1.SelectItem key={value} value={value}>{label}</select_1.SelectItem>);
        })}
                </select_1.SelectContent>
              </select_1.Select>
            </div>
      ...
      {/* Photos Display */}
      {filteredPhotos.length === 0 ? (<card_1.Card>
        ...
        </card_1.Card>) : (<div className={viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4' : 'space-y-4'}>
          {filteredPhotos.map(function (photo) { return (<card_1.Card key={photo.id} className="overflow-hidden">
              {viewMode === 'grid' ? (<div>
                  <div className="aspect-square relative overflow-hidden">
                    <img src={photo.storageUrl} alt={photo.fileName} className="w-full h-full object-cover cursor-pointer hover:scale-105 transition-transform" onClick={function () { return setSelectedPhoto(photo); }}/>
                  ...
                  <card_1.CardContent className="p-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-1">
                        {allowDownload && (<button_1.Button variant="outline" size="sm" onClick={function () { return downloadPhoto(photo); }}>
                            <lucide_react_1.Download className="h-3 w-3"/>
                          </button_1.Button>)}
                        {allowDelete && (<alert_dialog_1.AlertDialog>
                            ...
                            <alert_dialog_1.AlertDialogContent>
                              <alert_dialog_1.AlertDialogHeader>
                                <alert_dialog_1.AlertDialogTitle>Excluir foto</alert_dialog_1.AlertDialogTitle>
                              ...
                              <alert_dialog_1.AlertDialogFooter>
                                ...
                                <alert_dialog_1.AlertDialogAction onClick={function () { return deletePhoto(photo.id); }}>
                                  Excluir
                ...
                </div>) : (<card_1.CardContent className="p-4">
                  <div className="flex items-center gap-4">
                    <img src={photo.storageUrl} alt={photo.fileName} className="w-16 h-16 object-cover rounded cursor-pointer" onClick={function () { return setSelectedPhoto(photo); }}/>
      ...
      {/* Photo Detail Dialog */}
      {selectedPhoto && (<dialog_1.Dialog open={!!selectedPhoto} onOpenChange={function () { return setSelectedPhoto(null); }}>
          <dialog_1.DialogContent className="max-w-4xl">
            <dialog_1.DialogHeader>
              <dialog_1.DialogTitle>{selectedPhoto.fileName}</dialog_1.DialogTitle>
            </dialog_1.DialogHeader>
            <div className="space-y-4">
              <img src={selectedPhoto.storageUrl} alt={selectedPhoto.fileName} className="w-full h-auto max-h-96 object-contain rounded"/>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p><strong>Tipo:</strong> {PHOTO_TYPE_LABELS[selectedPhoto.photoType]}</p>
                ...
                <div>
                  ...
                  {((_b = selectedPhoto.metadata.facialFeatures) === null || _b === void 0 ? void 0 : _b.detected) && (<p><strong>Rosto detectado:</strong> {Math.round(selectedPhoto.metadata.facialFeatures.confidence * 100)}%</p>)}
                </div>
              </div>
            </div>
      ...
      {privacyControls && (<dialog_1.Dialog open={showPrivacyDialog} onOpenChange={setShowPrivacyDialog}>
          <dialog_1.DialogContent>
            <dialog_1.DialogHeader>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <label_1.Label htmlFor="facial-recognition">Permitir reconhecimento facial</label_1.Label>
              ...
              <div className="flex items-center justify-between">
                <label_1.Label htmlFor="photo-sharing">Permitir compartilhamento de fotos</label_1.Label>
