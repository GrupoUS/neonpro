...
function OptimizedPatientList(_a) {
    ...
    // =====================================================================================
    var _this = this;
    var onPatientSelect = _a.onPatientSelect, _b = _a.searchTerm, searchTerm = _b === void 0 ? '' : _b, onSearchChange = _a.onSearchChange;
    ...
    var _g = (0, react_1.useState)(0), totalCount = _g[0], setTotalCount = _g[1];
    var _h = (0, react_1.useState)(searchTerm), localSearchTerm = _h[0], setLocalSearchTerm = _h[1];
    var _j = (0, react_1.useState)(true), mounted = _j[0], setMounted = _j[1];
    ...
    var paginationInfo = (0, react_1.useMemo)(function () {
    ...
    // =====================================================================================
    var fetchPatients = (0, react_1.useCallback)(function (page, search) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (search.trim()) {
                        query = query.or("name.ilike.%".concat(search, "%,email.ilike.%").concat(search, "%,phone.ilike.%").concat(search, "%"));
                    }
    ...
    return (<card_1.Card>
      <card_1.CardHeader>
        ...
        <div className="relative">
          ...
          <input_1.Input placeholder="Buscar pacientes (mín. 2 caracteres)..." value={localSearchTerm} onChange={function (e) { return handleSearchChange(e.target.value); }} className="pl-10"/>
        </div>
      </card_1.CardHeader>
      ...
      <card_1.CardContent>
        ...
        <div className="border rounded-lg">
          <table_1.Table>
            ...
            <table_1.TableBody>
              {patients.map(function (patient) { return (<table_1.TableRow key={patient.id}>
                  <table_1.TableCell>
                  ...
                  <table_1.TableCell>
                    <div className="space-y-1">
                      {patient.email && (<div className="flex items-center text-sm">
                          <lucide_react_1.Mail className="h-3 w-3 mr-1"/>
                          {patient.email}
                        </div>)}
                      {patient.phone && (<div className="flex items-center text-sm">
                  ...
                  <table_1.TableCell>
                    <button_1.Button variant="ghost" size="sm" onClick={function () { return onPatientSelect === null || onPatientSelect === void 0 ? void 0 : onPatientSelect(patient); }}>
