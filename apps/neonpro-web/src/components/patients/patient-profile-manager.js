...
var generateMockPatientActivity = function () {
    ...
    return activities.sort(function (a, b) { return b.timestamp.getTime() - a.timestamp.getTime(); });
};
function PatientProfileManager() {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    var _l = (0, react_1.useState)(null), patientProfile = _l[0], setPatientProfile = _l[1];
    var _m = (0, react_1.useState)(null), patientStats = _m[0], setPatientStats = _m[1];
    var _o = (0, react_1.useState)([]), patientActivity = _o[0], setPatientActivity = _o[1];
    var _p = (0, react_1.useState)('overview'), activeTab = _p[0], setActiveTab = _p[1];
    var _q = (0, react_1.useState)(false), isEditing = _q[0], setIsEditing = _q[1];
    var _r = (0, react_1.useState)({}), editedProfile = _r[0], setEditedProfile = _r[1];
    var _s = (0, react_1.useState)(false), showLGPDDialog = _s[0], setShowLGPDDialog = _s[1];
    var _t = (0, react_1.useState)(false), showContactDialog = _t[0], setShowContactDialog = _t[1];
    ...
    var handleSaveProfile = function () {
        if (patientProfile && editedProfile) {
            var updatedProfile = __assign(__assign(__assign({}, patientProfile), editedProfile), { updatedAt: new Date(), updatedBy: 'Current User' });
    ...
    var getActivityIcon = function (type) {
        switch (type) {
            ...
            case 'payment': return <lucide_react_1.Target className="h-4 w-4"/>;
            case 'communication': return <lucide_react_1.MessageSquare className="h-4 w-4"/>;
            case 'document': return <lucide_react_1.FileText className="h-4 w-4"/>;
            case 'progress': return <lucide_react_1.TrendingUp className="h-4 w-4"/>;
    ...
    var getStatusIcon = function (status) {
        switch (status) {
            ...
            case 'in_progress': return <lucide_react_1.Activity className="h-4 w-4 text-blue-500"/>;
            case 'pending': return <lucide_react_1.Clock className="h-4 w-4 text-yellow-500"/>;
            case 'cancelled': return <lucide_react_1.XCircle className="h-4 w-4 text-red-500"/>;
            default: return <lucide_react_1.Info className="h-4 w-4 text-gray-500"/>;
        }
    };
    ...
    var primaryName = patientProfile.name.find(function (n) { return n.use === 'official'; }) || patientProfile.name[0];
    var primaryPhone = patientProfile.telecom.find(function (t) { return t.system === 'phone' && t.use === 'mobile'; });
    var primaryEmail = patientProfile.telecom.find(function (t) { return t.system === 'email'; });
    var primaryAddress = patientProfile.address.find(function (a) { return a.use === 'home'; }) || patientProfile.address[0];
    return (<div className="space-y-6">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <avatar_1.Avatar className="h-16 w-16">
            <avatar_1.AvatarImage src={(_b = (_a = patientProfile.photo) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.url}/>
            <avatar_1.AvatarFallback>
              {(_c = primaryName.given[0]) === null || _c === void 0 ? void 0 : _c[0]}{primaryName.family[0]}
            </avatar_1.AvatarFallback>
          </avatar_1.Avatar>
          <div>
            <h1 className="text-3xl font-bold tracking-tight">
              {(_d = primaryName.prefix) === null || _d === void 0 ? void 0 : _d[0]} {primaryName.given.join(' ')} {primaryName.family}
            </h1>
            <div className="flex items-center space-x-4 text-muted-foreground">
              <span className="flex items-center">
                <lucide_react_1.User className="h-4 w-4 mr-1"/>
                {(_e = patientProfile.identifier.find(function (i) { return i.type === 'medical_record'; })) === null || _e === void 0 ? void 0 : _e.value}
              </span>
              <span className="flex items-center">
                <lucide_react_1.Calendar className="h-4 w-4 mr-1"/>
                {(0, date_fns_1.format)(patientProfile.birthDate, 'MMM dd, yyyy')}
              </span>
              <badge_1.Badge className={getRiskLevelColor(patientProfile.clinicalSummary.riskLevel)}>
        ...
        <div className="flex items-center space-x-2">
          <button_1.Button variant="outline" size="sm" onClick={function () { return setShowContactDialog(true); }}>
          ...
          <button_1.Button variant="outline" size="sm" onClick={function () { return setShowLGPDDialog(true); }}>
            <lucide_react_1.Shield className="h-4 w-4 mr-2"/>
            Privacy
          </button_1.Button>
          <button_1.Button variant={isEditing ? "default" : "outline"} size="sm" onClick={isEditing ? handleSaveProfile : function () { return setIsEditing(true); }}>
            {isEditing ? (<><lucide_react_1.Save className="h-4 w-4 mr-2"/>Save</>) : (<><lucide_react_1.Edit className="h-4 w-4 mr-2"/>Edit</>)}
          </button_1.Button>
          {isEditing && (<button_1.Button variant="ghost" size="sm" onClick={function () {
                setIsEditing(false);
                setEditedProfile({});
            }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <card_1.CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      {isEditing ? (<input_1.Input value={((_g = (_f = editedProfile.name) === null || _f === void 0 ? void 0 : _f[0]) === null || _g === void 0 ? void 0 : _g.given.join(' ')) + ' ' + ((_j = (_h = editedProfile.name) === null || _h === void 0 ? void 0 : _h[0]) === null || _j === void 0 ? void 0 : _j.family) ||
                primaryName.given.join(' ') + ' ' + primaryName.family} onChange={function (e) {
                var _a = e.target.value.split(' '), given = _a[0], family = _a.slice(1);
                setEditedProfile(__assign(__assign({}, editedProfile), { name: [__assign(__assign({}, primaryName), { given: [given], family: family.join(' ') || primaryName.family })] }));
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {(_k = patientProfile.identifier.find(function (i) { return i.type === 'CPF'; })) === null || _k === void 0 ? void 0 : _k.value}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground flex items-center">
                          <lucide_react_1.Phone className="h-4 w-4 mr-2"/>
                          {primaryPhone === null || primaryPhone === void 0 ? void 0 : primaryPhone.value}
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground flex items-center">
                          ...
                          {primaryEmail === null || primaryEmail === void 0 ? void 0 : primaryEmail.value}
                        </p>
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground flex items-start">
                        ...
                        <span>
                          {primaryAddress === null || primaryAddress === void 0 ? void 0 : primaryAddress.line.join(', ')}<br />
                          {primaryAddress === null || primaryAddress === void 0 ? void 0 : primaryAddress.city}, {primaryAddress === null || primaryAddress === void 0 ? void 0 : primaryAddress.state} {primaryAddress === null || primaryAddress === void 0 ? void 0 : primaryAddress.postalCode}
                        </span>
                      </p>
                    </div>
                  </div>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label_1.Label className="text-sm font-medium">Treatment Status</label_1.Label>
                  ...
                  <div>
                    <label_1.Label className="text-sm font-medium">Treatment Progress</label_1.Label>
                    <div className="flex items-center space-x-2 mt-1">
                      <progress_1.Progress value={patientProfile.clinicalSummary.progressPercentage} className="flex-1"/>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label_1.Label className="text-sm font-medium">Chronic Conditions</label_1.Label>
                      <div className="flex flex-wrap gap-1 mt-1">
                        {patientProfile.clinicalSummary.chronicConditions.map(function (condition) { return (<badge_1.Badge key={condition} variant="secondary" className="text-xs">
                            {condition}
                          </badge_1.Badge>); })}
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {patientProfile.clinicalSummary.allergies.map(function (allergy) { return (<badge_1.Badge key={allergy} variant="destructive" className="text-xs">
            ...
            <div className="space-y-6">
              ...
              <card_1.Card>
                ...
                <card_1.CardContent>
                  <div className="space-y-3">
                    {patientActivity.slice(0, 5).map(function (activity) { return (<div key={activity.id} className="flex items-start space-x-3">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {patientActivity.map(function (activity) { return (<div key={activity.id} className="flex items-start space-x-4 p-4 border rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  {patientProfile.lgpdConsent.rightToWithdraw && (<badge_1.Badge variant="outline" className="text-xs">
                      <lucide_react_1.CheckCircle className="h-3 w-3 mr-1"/>
                      Withdraw
                    </badge_1.Badge>)}
                  {patientProfile.lgpdConsent.rightToPortability && (<badge_1.Badge variant="outline" className="text-xs">
                      <lucide_react_1.CheckCircle className="h-3 w-3 mr-1"/>
                      Portability
                    </badge_1.Badge>)}
                </div>
            ...
            <div>
              <label_1.Label className="text-sm font-medium">Data Processing Purposes</label_1.Label>
              <div className="flex flex-wrap gap-1 mt-1">
                {patientProfile.lgpdConsent.dataProcessingPurposes.map(function (purpose) { return (<badge_1.Badge key={purpose} variant="secondary" className="text-xs">
                    {purpose}
                  </badge_1.Badge>); })}
              </div>
            </div>
            ...
            <div className="flex justify-end space-x-2">
              <button_1.Button variant="outline" onClick={function () { return setShowLGPDDialog(false); }}>
                Close
              </button_1.Button>
