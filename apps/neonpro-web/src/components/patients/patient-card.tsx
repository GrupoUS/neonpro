      ...
      <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className={`text-xs font-medium ${
                getProfileCompletenessColor(patient.patient_profiles_extended.profile_completeness_score)
              }`}>
        ...
        {patient.patient_profiles_extended?.risk_score !== undefined && (
          <div className="flex items-center justify-between text-xs">
            ...
            <span className={`font-medium ${getRiskLevelColor(patient.patient_profiles_extended.risk_level)}`}>
