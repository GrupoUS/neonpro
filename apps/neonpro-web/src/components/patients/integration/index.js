...
function SystemIntegration(_a) {
    var _this = this;
    var onPatientSelect = _a.onPatientSelect, _b = _a.userRole, userRole = _b === void 0 ? 'staff' : _b;
    var _c = (0, react_1.useState)('quick-access'), activeTab = _c[0], setActiveTab = _c[1];
    var _d = (0, react_1.useState)(null), stats = _d[0], setStats = _d[1];
    var _e = (0, react_1.useState)(true), isLoadingStats = _e[0], setIsLoadingStats = _e[1];
    var _f = (0, react_1.useState)([]), selectedPatients = _f[0], setSelectedPatients = _f[1];
    var _g = (0, react_1.useState)(false), showSegmentDialog = _g[0], setShowSegmentDialog = _g[1];
    var _h = (0, react_1.useState)(''), segmentName = _h[0], setSegmentName = _h[1];
    var _j = (0, react_1.useState)(''), segmentDescription = _j[0], setSegmentDescription = _j[1];
    ...
    var createPatientSegment = function (patients) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    criteria = {
                        ...
                        filters: {
                            ...
                            riskLevels: __spreadArray([], new Set(patients.map(function (p) { return p.riskLevel; })), true),
                            treatmentTypes: __spreadArray([], new Set(patients.map(function (p) { return p.treatmentType; })), true),
                            ageRange: {
                                min: Math.min.apply(Math, patients.map(function (p) { return p.age; })),
                                max: Math.max.apply(Math, patients.map(function (p) { return p.age; }))
                            }
                        }
                    };
                    return [4 /*yield*/, fetch('/api/patients/integration/search', {
                            method: 'POST',
                            headers: {
                ...
                case 3:
                    result = _a.sent();
                    if (result.success) {
                        sonner_1.toast.success("Segmento \"".concat(segmentName, "\" criado com ").concat(patients.length, " pacientes"));
    ...
    return (<div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              {isLoadingStats ? '...' : formatNumber((stats === null || stats === void 0 ? void 0 : stats.totalPatients) || 0)}
            </div>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              {isLoadingStats ? '...' : formatNumber((stats === null || stats === void 0 ? void 0 : stats.searchesPerformed) || 0)}
            </div>
            <p className="text-xs text-muted-foreground">
              Tempo médio: {(stats === null || stats === void 0 ? void 0 : stats.averageSearchTime) || 0}ms
            </p>
          </card_1.CardContent>
        </card_1.Card>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold text-red-600">
              {isLoadingStats ? '...' : formatNumber((stats === null || stats === void 0 ? void 0 : stats.highRiskPatients) || 0)}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              <span className={getPerformanceColor((stats === null || stats === void 0 ? void 0 : stats.systemPerformance.uptime) || 0, { good: 99, warning: 95 })}>
                {(stats === null || stats === void 0 ? void 0 : stats.systemPerformance.uptime) || 0}%
              </span>
            </div>
            <p className="text-xs text-muted-foreground">
              Uptime do sistema
        ...
        <card_1.CardContent>
          <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <tabs_1.TabsContent value="advanced-search" className="mt-6">
              <advanced_search_1.AdvancedSearch onPatientSelect={onPatientSelect} onCreateSegment={userRole !== 'staff' ? handleCreateSegment : undefined}/>
            </tabs_1.TabsContent>
          </tabs_1.Tabs>
        </card_1.CardContent>
      </card_1.Card>
      ...
      {showSegmentDialog && (<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <card_1.Card className="w-full max-w-md mx-4">
            ...
            <card_1.CardContent className="space-y-4">
              <div>
                ...
                <input type="text" className="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md" placeholder="Ex: Pacientes Alto Risco Cardíaco" value={segmentName} onChange={function (e) { return setSegmentName(e.target.value); }}/>
              </div>
              
              <div>
                <label className="text-sm font-medium">Descrição</label>
                <textarea className="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md" placeholder="Descreva os critérios e objetivo deste segmento..." rows={3} value={segmentDescription} onChange={function (e) { return setSegmentDescription(e.target.value); }}/>
              </div>
              ...
              <div className="flex space-x-2">
                ...
                <button_1.Button onClick={function () { return createPatientSegment(selectedPatients); }} className="flex-1" disabled={!segmentName.trim() || !segmentDescription.trim()}>
                  Criar Segmento
                </button_1.Button>
              </div>
            </card_1.CardContent>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
        <div>
          <div className="text-lg font-semibold text-blue-600">
            {formatNumber((stats === null || stats === void 0 ? void 0 : stats.pendingVerifications) || 0)}
          </div>
        ...
        <div>
          <div className="text-lg font-semibold text-green-600">
            {formatNumber((stats === null || stats === void 0 ? void 0 : stats.upcomingAppointments) || 0)}
          </div>
        ...
        <div>
          <div className="text-lg font-semibold text-purple-600">
            {formatNumber((stats === null || stats === void 0 ? void 0 : stats.favoritePatients) || 0)}
          </div>
