...
function AdvancedSearch(_a) {
          ...
          return __generator(this, (_a) => {
            switch (_a.label) {
              ...
              case 1:
                ...
                Object.entries(searchFilters).forEach((_a) => {
                  var key = _a[0],
                    value = _a[1];
  ...
  var togglePatientSelection = (patientId) => {
  ...
  var handleCreateSegment = () => {
    ...
    var selectedPatientData = results.patients.filter((p) => selectedPatients.includes(p.id));
