...
function AdvancedSearch(_a) {
  ...
  var onPatientSelect = _a.onPatientSelect,
    onCreateSegment = _a.onCreateSegment;
  ...
  var _e = (0, react_1.useState)([]),
    selectedPatients = _e[0],
    setSelectedPatients = _e[1];
  ...
  var debouncedSearch = (0, react_1.useCallback)(
    (0, lodash_1.debounce)(function (searchQuery, searchFilters) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (searchQuery.trim()) params_1.append("q", searchQuery);
  ...
  var handleCreateSegment = function () {
    ...
    onCreateSegment === null || onCreateSegment === void 0
      ? void 0
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select_1.Select
                  ...
                  onValueChange={function (value) {
                    return handleFilterChange("treatmentType", value);
                  }}
                >
                  <select_1.SelectTrigger>
              ...
              <div>
                ...
                <input_1.Input
                  ...
                  onChange={function (e) {
                    return handleFilterChange("minAge", parseInt(e.target.value) || undefined);
                  }}
                />
              </div>
              ...
              <div>
                ...
                <input_1.Input
                  ...
                  onChange={function (e) {
                    return handleFilterChange("maxAge", parseInt(e.target.value) || undefined);
                  }}
                />
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center space-x-2">
                <checkbox_1.Checkbox
                  ...
                  onCheckedChange={function (checked) {
                    return handleFilterChange("hasPhotos", checked);
                  }}
                />
              ...
              <div className="flex items-center space-x-2">
                <checkbox_1.Checkbox
                  ...
                  onCheckedChange={function (checked) {
                    return handleFilterChange("consentStatus", checked);
                  }}
                />
              ...
              <div className="flex space-x-2">
                ...
                {selectedPatients.length > 0 && (
                  <>
                    ...
                    {onCreateSegment && (
                      <button_1.Button size="sm" onClick={handleCreateSegment}>
            ...
            {results.patients.map(function (patient) {
              return (
                <card_1.Card
                  ...
                  onClick={function () {
                    return togglePatientSelection(patient.id);
                  }}
                >
                  <card_1.CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {patient.hasPhotos && (
                          <badge_1.Badge variant="outline">📸 Fotos</badge_1.Badge>
                        )}

                        {patient.consentStatus && (
                          <badge_1.Badge variant="outline">✓ LGPD</badge_1.Badge>
                        )}
                    ...
                    {patient.tags.length > 0 && (
                      <div className="mt-2 flex flex-wrap gap-1">
                        {patient.tags.map(function (tag, index) {
                          return (
