...
function TreatmentPlanManager(_a) {
  ...
  var patientId = _a.patientId,
    ...
    onPlanUpdate = _a.onPlanUpdate;
  // State management
  var _c = (0, react_1.useState)([]),
    treatmentPlans = _c[0],
    setTreatmentPlans = _c[1];
  var _d = (0, react_1.useState)(null),
    selectedPlan = _d[0],
    setSelectedPlan = _d[1];
  ...
  var _k = (0, react_1.useState)(false),
    showPlanDialog = _k[0],
    setShowPlanDialog = _k[1];
  var _l = (0, react_1.useState)(false),
    showProtocolDialog = _l[0],
    setShowProtocolDialog = _l[1];
  var _m = (0, react_1.useState)(false),
    showProgressDialog = _m[0],
    setShowProgressDialog = _m[1];
      ...
      return __generator(this, function (_a) {
        ...
        try {
          newProtocol = __assign(
            __assign(
              { id: "protocol_".concat(Date.now()), treatment_plan_id: selectedPlan.id },
              protocolData,
            ),
            {
              status: "pending",
          ...
          updatedPlan_1 = __assign(__assign({}, selectedPlan), {
            protocols: __spreadArray(
              __spreadArray([], selectedPlan.protocols, true),
              [newProtocol],
              false,
            ),
          });
  ...
  var getTypeIcon = function (type) {
    switch (type) {
      ...
      case "endodontics":
        return <lucide_react_1.Clipboard className="h-4 w-4" />;
      case "oral_surgery":
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          {!readOnly && (
            <dialog_1.Dialog open={showPlanDialog} onOpenChange={setShowPlanDialog}>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between text-xs text-muted-foreground">
                          ...
                          <span>
                            {(0, date_fns_1.format)(new Date(plan.start_date), "dd/MM/yy", {
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex justify-between">
                                ...
                                <span>
                                  {(0, date_fns_1.format)(
                                    new Date(selectedPlan.start_date),
                                    "dd/MM/yyyy",
                                    { locale: locale_1.ptBR },
                                  )}
                                </span>
                              ...
                              <div className="flex justify-between">
                                ...
                                <span>
                                  {(0, date_fns_1.format)(
                                    new Date(selectedPlan.estimated_end_date),
                                    "dd/MM/yyyy",
                                    { locale: locale_1.ptBR },
                                  )}
                                </span>
                              ...
                              {selectedPlan.actual_end_date && (
                                <div className="flex justify-between">
                                  ...
                                  <span>
                                    {(0, date_fns_1.format)(
                                      new Date(selectedPlan.actual_end_date),
                                      "dd/MM/yyyy",
                                      { locale: locale_1.ptBR },
                                    )}
                                  </span>
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              ...
                              <progress_1.Progress
                                value={calculatePlanProgress(selectedPlan)}
                                className="h-2"
                              />
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex justify-between">
                                ...
                                <span>
                                  R$ {selectedPlan.estimated_cost.toLocaleString("pt-BR")}
                                </span>
                              </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end space-x-2">
        ...
        <button_1.Button type="submit">Criar Plano</button_1.Button>
      </div>
    </form>
  );
}
