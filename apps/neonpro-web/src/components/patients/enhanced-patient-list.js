...
function EnhancedPatientList(_a) {
  ...
  (0, react_1.useEffect)(() => {
    ...
    if (ageRangeFilter !== "all") {
      filtered = filtered.filter((patient) => {
        var _a;
        if (
          !((_a = patient.raw_user_meta_data) === null || _a === void 0 ? void 0 : _a.date_of_birth)
        )
          return false;
  ...
  var handlePatientSelection = (patientId, selected) => {
        ...
        <div className="grid gap-4 md:grid-cols-5">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-2">
              <select_1.Select value={searchType} onValueChange={(value) => setSearchType(value)}>
