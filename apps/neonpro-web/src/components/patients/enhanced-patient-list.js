...
function EnhancedPatientList(_a) {
    var _this = this;
    var onPatientSelect = _a.onPatientSelect, onPatientCreate = _a.onPatientCreate, _b = _a.compact, compact = _b === void 0 ? false : _b;
    var _c = (0, react_1.useState)([]), patients = _c[0], setPatients = _c[1];
    var _d = (0, react_1.useState)([]), filteredPatients = _d[0], setFilteredPatients = _d[1];
    var _e = (0, react_1.useState)(false), loading = _e[0], setLoading = _e[1];
    var _f = (0, react_1.useState)(null), error = _f[0], setError = _f[1];
    // Search and filter states
    var _g = (0, react_1.useState)(''), searchQuery = _g[0], setSearchQuery = _g[1];
    var _h = (0, react_1.useState)('name'), searchType = _h[0], setSearchType = _h[1];
    var _j = (0, react_1.useState)('all'), riskFilter = _j[0], setRiskFilter = _j[1];
    var _k = (0, react_1.useState)('all'), statusFilter = _k[0], setStatusFilter = _k[1];
    var _l = (0, react_1.useState)('all'), ageRangeFilter = _l[0], setAgeRangeFilter = _l[1];
    // View and pagination states
    var _m = (0, react_1.useState)('table'), viewMode = _m[0], setViewMode = _m[1];
    var _o = (0, react_1.useState)(1), currentPage = _o[0], setCurrentPage = _o[1];
    var itemsPerPage = (0, react_1.useState)(compact ? 5 : 10)[0];
    var _p = (0, react_1.useState)(new Set()), selectedPatients = _p[0], setSelectedPatients = _p[1];
    // Sort state
    var _q = (0, react_1.useState)('created_at'), sortField = _q[0], setSortField = _q[1];
    var _r = (0, react_1.useState)('desc'), sortDirection = _r[0], setSortDirection = _r[1];
    var supabase = (0, client_1.createClient)();
    // Load patients from Supabase
    var loadPatients = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (patientsError)
                        throw patientsError;
                    return [4 /*yield*/, Promise.all((patientsData || []).map(function (patient) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        return [2 /*return*/, __assign(__assign({}, patient), { upcoming_appointments: count || 0, last_visit: (lastVisitData === null || lastVisitData === void 0 ? void 0 : lastVisitData.event_date) || null })];
                                }
                            });
                        }); }))];
                case 3:
                    ...
                    sonner_1.toast.success("".concat(patientsWithAppointments.length, " pacientes carregados"));
                    return [3 /*break*/, 6];
                case 4:
                    error_1 = _b.sent();
                    errorMessage = error_1 instanceof Error ? error_1.message : 'Erro ao carregar pacientes';
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (searchQuery.trim()) {
            filtered = filtered.filter(function (patient) {
                ...
                switch (searchType) {
                    case 'name':
                        return (_b = (_a = patient.raw_user_meta_data) === null || _a === void 0 ? void 0 : _a.full_name) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(query);
                    case 'phone':
                        return (_c = patient.phone) === null || _c === void 0 ? void 0 : _c.toLowerCase().includes(query);
                    case 'email':
                        return (_d = patient.email) === null || _d === void 0 ? void 0 : _d.toLowerCase().includes(query);
                    case 'cpf':
                        return (_f = (_e = patient.raw_user_meta_data) === null || _e === void 0 ? void 0 : _e.cpf) === null || _f === void 0 ? void 0 : _f.toLowerCase().includes(query);
                    default:
                        return false;
                }
            });
        ...
        // Apply risk filter
        if (riskFilter !== 'all') {
            filtered = filtered.filter(function (patient) { var _a; return ((_a = patient.patient_profiles_extended) === null || _a === void 0 ? void 0 : _a.risk_level) === riskFilter; });
        }
        // Apply age range filter
        if (ageRangeFilter !== 'all') {
            filtered = filtered.filter(function (patient) {
                var _a;
                if (!((_a = patient.raw_user_meta_data) === null || _a === void 0 ? void 0 : _a.date_of_birth))
                    return false;
        ...
        filtered.sort(function (a, b) {
            ...
            switch (sortField) {
                case 'name':
                    aValue = ((_a = a.raw_user_meta_data) === null || _a === void 0 ? void 0 : _a.full_name) || '';
                    bValue = ((_b = b.raw_user_meta_data) === null || _b === void 0 ? void 0 : _b.full_name) || '';
                    break;
                case 'risk_score':
                    aValue = ((_c = a.patient_profiles_extended) === null || _c === void 0 ? void 0 : _c.risk_score) || 0;
                    bValue = ((_d = b.patient_profiles_extended) === null || _d === void 0 ? void 0 : _d.risk_score) || 0;
                    break;
                case 'completeness':
                    aValue = ((_e = a.patient_profiles_extended) === null || _e === void 0 ? void 0 : _e.profile_completeness_score) || 0;
                    bValue = ((_f = b.patient_profiles_extended) === null || _f === void 0 ? void 0 : _f.profile_completeness_score) || 0;
                    break;
                case 'last_visit':
    ...
    var handleSelectAll = function (selected) {
        if (selected) {
            ...
            setSelectedPatients(new Set(pagePatients.map(function (p) { return p.id; })));
        }
        else {
    ...
    // Render functions
    var renderTableView = function () { return (<div className="border rounded-lg">
      <table_1.Table>
        <table_1.TableHeader>
          <table_1.TableRow>
            <table_1.TableHead className="w-12">
              <checkbox_1.Checkbox checked={getCurrentPagePatients().length > 0 && getCurrentPagePatients().every(function (p) { return selectedPatients.has(p.id); })} onCheckedChange={handleSelectAll}/>
            </table_1.TableHead>
            <table_1.TableHead className="cursor-pointer hover:bg-gray-50" onClick={function () {
            if (sortField === 'name') {
        ...
        <table_1.TableBody>
          {getCurrentPagePatients().map(function (patient) {
            ...
            return (<table_1.TableRow key={patient.id} className="cursor-pointer hover:bg-gray-50" onClick={function () { return onPatientSelect === null || onPatientSelect === void 0 ? void 0 : onPatientSelect(patient); }}>
              <table_1.TableCell onClick={function (e) { return e.stopPropagation(); }}>
                <checkbox_1.Checkbox checked={selectedPatients.has(patient.id)} onCheckedChange={function (checked) { return handlePatientSelection(patient.id, checked); }}/>
              </table_1.TableCell>
              <table_1.TableCell>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    " \u2022 ".concat(patient.raw_user_meta_data.gender)}
                    </div>
                  </div>
                </div>
              </table_1.TableCell>
              <table_1.TableCell>
                <div className="space-y-1">
                  {patient.phone && (<div className="flex items-center gap-1 text-sm">
                      <lucide_react_1.Phone className="h-3 w-3"/>
                      {patient.phone}
                    </div>)}
                  {patient.email && (<div className="flex items-center gap-1 text-sm text-muted-foreground">
              ...
              <table_1.TableCell>
                <div className="flex flex-col gap-1">
                  ...
                  {patient.upcoming_appointments > 0 && (<div className="flex items-center gap-1 text-xs text-muted-foreground">
              ...
              <table_1.TableCell>
                {((_j = patient.patient_profiles_extended) === null || _j === void 0 ? void 0 : _j.risk_level) && (<badge_1.Badge className={getRiskColor(patient.patient_profiles_extended.risk_level)} variant="outline">
              ...
              <table_1.TableCell>
                {((_k = patient.patient_profiles_extended) === null || _k === void 0 ? void 0 : _k.profile_completeness_score) && (<div className="flex items-center gap-2">
                    <progress_1.Progress value={patient.patient_profiles_extended.profile_completeness_score * 100} className="w-16"/>
              ...
              <table_1.TableCell>
                {patient.last_visit ? (<div className="text-sm">
                    {new Date(patient.last_visit).toLocaleDateString('pt-BR')}
                  </div>) : (<span className="text-sm text-muted-foreground">Nunca</span>)}
              </table_1.TableCell>
              <table_1.TableCell onClick={function (e) { return e.stopPropagation(); }}>
                <dropdown_menu_1.DropdownMenu>
                  ...
                  <dropdown_menu_1.DropdownMenuContent align="end">
                    ...
                    <dropdown_menu_1.DropdownMenuItem onClick={function () { return onPatientSelect === null || onPatientSelect === void 0 ? void 0 : onPatientSelect(patient); }}>
    ...
    return (<card_1.Card className={compact ? '' : 'h-full'}>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <card_1.CardDescription>
              ...
              {selectedPatients.size > 0 && " \u2022 ".concat(selectedPatients.size, " selecionados")}
            </card_1.CardDescription>
          </div>
          <div className="flex items-center gap-2">
            {onPatientCreate && (<button_1.Button onClick={onPatientCreate} size="sm">
            ...
            <div className="flex items-center border rounded-md">
              <button_1.Button variant={viewMode === 'table' ? 'default' : 'ghost'} size="sm" onClick={function () { return setViewMode('table'); }}>
                <lucide_react_1.List className="h-4 w-4"/>
              </button_1.Button>
              <button_1.Button variant={viewMode === 'grid' ? 'default' : 'ghost'} size="sm" onClick={function () { return setViewMode('grid'); }}>
        ...
        <div className="grid gap-4 md:grid-cols-5">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-2">
              <select_1.Select value={searchType} onValueChange={function (value) { return setSearchType(value); }}>
              ...
              <input_1.Input id="search" placeholder={"Buscar por ".concat(searchType === 'name' ? 'nome' : searchType, "...")} value={searchQuery} onChange={function (e) { return setSearchQuery(e.target.value); }} className="flex-1"/>
            </div>
          </div>
