...
exports.COMPONENT_METADATA = exports.PATIENT_CONSTANTS = exports.PatientUtils = exports.PATIENT_MANAGEMENT_CONFIG = exports.ProgressTrackingManager = exports.TreatmentPlanManager = exports.MedicalHistoryManager = exports.PatientProfileManager = void 0;
// Main Patient Profile Manager
var patient_profile_manager_1 = require("./patient-profile-manager");
Object.defineProperty(exports, "PatientProfileManager", { enumerable: true, get: function () { return patient_profile_manager_1.default; } });
// Medical History Management
var medical_history_manager_1 = require("./medical-history/medical-history-manager");
Object.defineProperty(exports, "MedicalHistoryManager", { enumerable: true, get: function () { return medical_history_manager_1.default; } });
// Treatment Plans Management
var treatment_plan_manager_1 = require("./treatment-plans/treatment-plan-manager");
Object.defineProperty(exports, "TreatmentPlanManager", { enumerable: true, get: function () { return treatment_plan_manager_1.default; } });
// Progress Tracking Management
var progress_tracking_manager_1 = require("./progress-tracking/progress-tracking-manager");
Object.defineProperty(exports, "ProgressTrackingManager", { enumerable: true, get: function () { return progress_tracking_manager_1.default; } });
...
exports.PatientUtils = {
    ...
    formatPhoneNumber: function (phone) {
        ...
        if (cleanPhone.length === 11) {
            return "+55 ".concat(cleanPhone.slice(0, 2), " ").concat(cleanPhone.slice(2, 7), "-").concat(cleanPhone.slice(7));
        }
        else if (cleanPhone.length === 10) {
            return "+55 ".concat(cleanPhone.slice(0, 2), " ").concat(cleanPhone.slice(2, 6), "-").concat(cleanPhone.slice(6));
        }
        return phone;
    },
    // Calculate BMI
    ...
    assessRiskLevel: function (conditions, allergies, age) {
        ...
        if (age > 65)
            ...
            riskScore += 1;
        // Chronic conditions
        var highRiskConditions = ['diabetes', 'hypertension', 'heart disease', 'cancer', 'kidney disease'];
        var hasHighRiskCondition = conditions.some(function (condition) {
            return highRiskConditions.some(function (risk) { return condition.toLowerCase().includes(risk); });
        });
        ...
        var hasSevereAllergy = allergies.some(function (allergy) {
            return severeAllergies.some(function (severe) { return allergy.toLowerCase().includes(severe); });
        });
        if (hasSevereAllergy)
            riskScore += 2;
...
exports.PATIENT_CONSTANTS = {
    ...
    // Activity types
    ACTIVITY_TYPES: [
        'appointment', 'treatment', 'payment',
        'communication', 'document', 'progress'
    ],
    // Priority levels
...
exports.COMPONENT_METADATA = {
    ...
    version: '1.0.0',
    description: 'Comprehensive patient profile management with FHIR R4 compliance and LGPD data protection',
