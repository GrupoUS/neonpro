...
export const PatientUtils = {
  ...
  assessRiskLevel: (conditions: string[], allergies: string[], age: number): 'low' | 'medium' | 'high' | 'critical' => {
    let riskScore = 0
    ...
    // Chronic conditions
    const highRiskConditions = ['diabetes', 'hypertension', 'heart disease', 'cancer', 'kidney disease']
