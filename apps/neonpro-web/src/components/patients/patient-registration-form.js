...
var lgpdConsentSchema = z.object({
    data_processing_consent: z.boolean().refine(function (val) { return val === true; }, 'Consentimento obrigatório'),
    medical_data_consent: z.boolean().refine(function (val) { return val === true; }, 'Consentimento obrigatório'),
    photo_consent: z.boolean(),
    marketing_consent: z.boolean(),
    data_sharing_consent: z.boolean(),
    retention_period_consent: z.boolean().refine(function (val) { return val === true; }, 'Consentimento obrigatório'),
});
function PatientRegistrationForm(_a) {
    var _this = this;
    var onSubmit = _a.onSubmit, onCancel = _a.onCancel, initialData = _a.initialData, _b = _a.isOpen, isOpen = _b === void 0 ? false : _b, onOpenChange = _a.onOpenChange;
    var _c = (0, react_1.useState)(1), currentStep = _c[0], setCurrentStep = _c[1];
    var _d = (0, react_1.useState)(0), completionScore = _d[0], setCompletionScore = _d[1];
    var _e = (0, react_1.useState)(false), isSubmitting = _e[0], setIsSubmitting = _e[1];
    var _f = (0, react_1.useState)(false), showConsentDetails = _f[0], setShowConsentDetails = _f[1];
    ...
    var steps = [
        ...
        { id: 3, title: 'Informações Médicas', icon: lucide_react_1.Stethoscope, schema: medicalInfoSchema },
    ...
    var personalForm = (0, react_hook_form_1.useForm)({
        ...
        defaultValues: __assign({ full_name: '', date_of_birth: '', gender: 'prefer_not_to_say', cpf: '', phone: '', email: '', emergency_contact_name: '', emergency_contact_phone: '', emergency_contact_relationship: '' }, initialData === null || initialData === void 0 ? void 0 : initialData.personal)
    });
    var addressForm = (0, react_hook_form_1.useForm)({
        resolver: (0, zod_1.zodResolver)(addressSchema),
        defaultValues: __assign({ street: '', number: '', complement: '', neighborhood: '', city: '', state: '', zip_code: '' }, initialData === null || initialData === void 0 ? void 0 : initialData.address)
    });
    var medicalForm = (0, react_hook_form_1.useForm)({
        resolver: (0, zod_1.zodResolver)(medicalInfoSchema),
        defaultValues: __assign({ height_cm: '', weight_kg: '', blood_type: 'unknown', allergies: [], chronic_conditions: [], medications: [], previous_surgeries: [], family_history: '' }, initialData === null || initialData === void 0 ? void 0 : initialData.medical)
    });
    var consentForm = (0, react_hook_form_1.useForm)({
        resolver: (0, zod_1.zodResolver)(lgpdConsentSchema),
        defaultValues: __assign({ data_processing_consent: false, medical_data_consent: false, photo_consent: false, marketing_consent: false, data_sharing_consent: false, retention_period_consent: false }, initialData === null || initialData === void 0 ? void 0 : initialData.consent)
    });
        ...
        var medicalFieldsCount = Object.keys(medicalData).filter(function (key) {
            return medicalData[key] &&
                (Array.isArray(medicalData[key])
                    ...
                    : medicalData[key] !== '' &&
                        medicalData[key] !== 'unknown');
        }).length;
        score += (medicalFieldsCount / 8) * 20;
        // LGPD consent (20%)
        var consentData = consentForm.getValues();
        var requiredConsents = ['data_processing_consent', 'medical_data_consent', 'retention_period_consent'];
    ...
    var handleSubmit = function () { return __awaiter(_this, void 0, void 0, function () {
        var isPersonalValid, isAddressValid, isMedicalValid, isConsentValid, personalData, addressData, medicalData, consentData, _a, authData, authError, userId, profileError, extendedProfileError, addressError, auditError, error_1, errorMessage;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, personalForm.trigger()];
                case 1:
                ...
                case 11:
                    error_1 = _c.sent();
                    errorMessage = error_1 instanceof Error ? error_1.message : 'Erro ao cadastrar paciente';
    ...
    var renderStepContent = function () {
        switch (currentStep) {
            case 1:
                return (<form_1.Form {...personalForm}>
            <form className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <form_1.FormField control={personalForm.control} name="full_name" render={function (_a) {
                        var field = _a.field;
                ...
                <form_1.FormField control={personalForm.control} name="date_of_birth" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                ...
                <form_1.FormField control={personalForm.control} name="gender" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                      ...
                      <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <select_1.SelectContent>
                          ...
                          <select_1.SelectItem value="prefer_not_to_say">Prefiro não informar</select_1.SelectItem>
                        </select_1.SelectContent>
                      </select_1.Select>
                      <form_1.FormMessage />
                    </form_1.FormItem>);
                ...
                <form_1.FormField control={personalForm.control} name="cpf" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                      <form_1.FormLabel>CPF *</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input placeholder="000.000.000-00" {...field} onChange={function (e) { return field.onChange(formatCPF(e.target.value)); }} maxLength={14}/>
                      </form_1.FormControl>
                      <form_1.FormMessage />
                    </form_1.FormItem>);
                    }}/>

                <form_1.FormField control={personalForm.control} name="phone" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                      <form_1.FormLabel>Telefone *</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input placeholder="(11) 99999-9999" {...field} onChange={function (e) { return field.onChange(formatPhone(e.target.value)); }} maxLength={15}/>
                      </form_1.FormControl>
                      <form_1.FormMessage />
                    </form_1.FormItem>);
                    }}/>

                <form_1.FormField control={personalForm.control} name="email" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <form_1.FormField control={personalForm.control} name="emergency_contact_name" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={personalForm.control} name="emergency_contact_phone" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                        <form_1.FormLabel>Telefone *</form_1.FormLabel>
                        <form_1.FormControl>
                  ...
                  <form_1.FormField control={personalForm.control} name="emergency_contact_relationship" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
            ...
            case 2:
                return (<form_1.Form {...addressForm}>
            <form className="space-y-4">
              <div className="grid gap-4 md:grid-cols-3">
                <div className="md:col-span-2">
                  <form_1.FormField control={addressForm.control} name="street" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                ...
                <form_1.FormField control={addressForm.control} name="number" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                ...
                <form_1.FormField control={addressForm.control} name="complement" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                ...
                <form_1.FormField control={addressForm.control} name="neighborhood" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                ...
                <form_1.FormField control={addressForm.control} name="zip_code" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                      <form_1.FormLabel>CEP *</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input placeholder="00000-000" {...field} onChange={function (e) { return field.onChange(formatCEP(e.target.value)); }} maxLength={9}/>
                      </form_1.FormControl>
                      <form_1.FormMessage />
                    </form_1.FormItem>);
                    }}/>

                <form_1.FormField control={addressForm.control} name="city" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                ...
                <form_1.FormField control={addressForm.control} name="state" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                      ...
                      <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <select_1.SelectContent>
                          ...
                          <select_1.SelectItem value="RN">Rio Grande do Norte</select_1.SelectItem>
            ...
            case 3:
                return (<form_1.Form {...medicalForm}>
            <form className="space-y-6">
              <div className="grid gap-4 md:grid-cols-3">
                <form_1.FormField control={medicalForm.control} name="height_cm" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                ...
                <form_1.FormField control={medicalForm.control} name="weight_kg" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                ...
                <form_1.FormField control={medicalForm.control} name="blood_type" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
              ...
              <div className="space-y-4">
                <form_1.FormField control={medicalForm.control} name="family_history" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem>
                      <form_1.FormLabel>Histórico Familiar</form_1.FormLabel>
                      <form_1.FormControl>
                        <textarea_1.Textarea placeholder="Descreva doenças na família (diabetes, hipertensão, câncer, etc.)" className="min-h-[80px]" {...field}/>
                      </form_1.FormControl>
            ...
            case 4:
                return (<form_1.Form {...consentForm}>
            <form className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button_1.Button type="button" variant="outline" size="sm" onClick={function () { return setShowConsentDetails(!showConsentDetails); }}>
                    {showConsentDetails ? <lucide_react_1.EyeOff className="h-4 w-4"/> : <lucide_react_1.Eye className="h-4 w-4"/>}
                    {showConsentDetails ? 'Ocultar' : 'Detalhes'}
                  </button_1.Button>
                </div>

                {showConsentDetails && (<card_1.Card className="p-4 bg-blue-50 border-blue-200">
                ...
                <div className="space-y-4">
                  <form_1.FormField control={consentForm.control} name="data_processing_consent" render={function (_a) {
                        var field = _a.field;
                  ...
                  <form_1.FormField control={consentForm.control} name="medical_data_consent" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        <form_1.FormControl>
                          <checkbox_1.Checkbox checked={field.value} onCheckedChange={field.onChange}/>
                  ...
                  <form_1.FormField control={consentForm.control} name="retention_period_consent" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        <form_1.FormControl>
                          <checkbox_1.Checkbox checked={field.value} onCheckedChange={field.onChange}/>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="space-y-4">
                    <form_1.FormField control={consentForm.control} name="photo_consent" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          <form_1.FormControl>
                            <checkbox_1.Checkbox checked={field.value} onCheckedChange={field.onChange}/>
                    ...
                    <form_1.FormField control={consentForm.control} name="marketing_consent" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          <form_1.FormControl>
                            <checkbox_1.Checkbox checked={field.value} onCheckedChange={field.onChange}/>
                    ...
                    <form_1.FormField control={consentForm.control} name="data_sharing_consent" render={function (_a) {
                        var field = _a.field;
                        return (<form_1.FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          <form_1.FormControl>
                            <checkbox_1.Checkbox checked={field.value} onCheckedChange={field.onChange}/>
      ...
      <dialog_1.DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            return (<div key={step.id} className="flex items-center">
                  <div className={"\n                    flex items-center justify-center w-10 h-10 rounded-full border-2 \n                    ".concat(isActive
                    ...
                    {isCompleted ? (<lucide_react_1.Check className="h-5 w-5"/>) : (<Icon className="h-5 w-5"/>)}
                  </div>
                  <div className="ml-2 hidden sm:block">
                    <div className={"text-sm font-medium ".concat(isActive ? 'text-blue-600' : isCompleted ? 'text-green-600' : 'text-gray-500')}>
                      {step.title}
                    </div>
                  </div>
                  {index < steps.length - 1 && (<div className={"hidden sm:block w-16 h-px mx-4 ".concat(isCompleted ? 'bg-green-500' : 'bg-gray-300')}/>)}
                </div>);
        })}
          </div>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle className="flex items-center gap-2">
                {react_1.default.createElement(steps[currentStep - 1].icon, { className: "h-5 w-5" })}
          ...
          <div className="flex justify-between">
            <button_1.Button type="button" variant="outline" onClick={currentStep === 1 ? onCancel : handlePrevious} disabled={isSubmitting}>
            ...
            {currentStep < steps.length ? (<button_1.Button type="button" onClick={handleNext} disabled={isSubmitting}>
                Próximo
                <lucide_react_1.ChevronRight className="ml-2 h-4 w-4"/>
              </button_1.Button>) : (<button_1.Button type="button" onClick={handleSubmit} disabled={isSubmitting || completionScore < 50} className="min-w-32">
                {isSubmitting ? (<>
