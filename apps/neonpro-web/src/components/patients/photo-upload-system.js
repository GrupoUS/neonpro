...
function PhotoUploadSystem(_a) {
  ...
  var _e = (0, react_1.useState)(0),
    uploadProgress = _e[0],
    setUploadProgress = _e[1];
  var _f = (0, react_1.useState)([]),
    uploadedPhotos = _f[0],
    setUploadedPhotos = _f[1];
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              supabase.from("profiles").select("lgpd_consents").eq("id", patientId).single(),
            ];
          case 1:
            ...
            photoConsent =
              (consents === null || consents === void 0 ? void 0 : consents.photo_consent) || false;
      ...
      if (!ALLOWED_FILE_TYPES.includes(file.type)) {
        setError(
          "Tipo de arquivo n\u00E3o permitido: ".concat(
            file.name,
            ". Use apenas JPG, PNG, HEIC ou WebP.",
          ),
        );
        return false;
      }
        ...
        switch (_a.label) {
          case 0:
            ...
            if (!photoMetadata.treatmentType || !photoMetadata.anatomicalArea) {
              setError(
                "Preencha todos os campos obrigatórios (Tipo de Tratamento e Área Anatômica)",
              );
              return [2 /*return*/];
            }
            setUploading(true);
                ...
                return __generator(this, (_c) => {
                  switch (_c.label) {
                    ...
                    case 1:
                      ...
                      return [
                        4 /*yield*/,
                        supabase.storage.from("patient-photos").upload(fileName, compressedBlob, {
    ...
    __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 3, , 4]);
            return [4 /*yield*/, supabase.storage.from("patient-photos").remove([filePath])];
          case 1:
            storageError = _a.sent().error;
            if (storageError) throw storageError;
            return [4 /*yield*/, supabase.from("patient_photos").delete().eq("id", photoId)];
          case 2:
    ...
    __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_b) => {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 2, , 3]);
            return [4 /*yield*/, supabase.storage.from("patient-photos").download(photo.filePath)];
          case 1:
                        ...
                        <popover_1.Popover>
                          <popover_1.PopoverTrigger asChild>
                            ...
                            >
                              ...
                              {photoMetadata.date
                                ? (0, date_fns_1.format)(photoMetadata.date, "PPP", {
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {(0, date_fns_1.format)(selectedPhoto.metadata.date, "dd/MM/yyyy", {
                          locale: locale_1.ptBR,
                        })}
                      </p>
                    </div>
