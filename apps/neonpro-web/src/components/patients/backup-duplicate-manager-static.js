...
function DuplicateManagerStatic(_a) {
    ...
    return (<div className="space-y-6">
      ...
      {duplicates.length === 0 ? (<card_1.Card>
          ...
          {duplicates.map(function (duplicate) { return (<card_1.Card key={duplicate.id} className="border-orange-200">
              <card_1.CardHeader>
              ...
              <card_1.CardContent>
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  {duplicate.patients.map(function (patient, index) { return (<div key={patient.id} className="border rounded-lg p-4">
                ...
                <div className="flex gap-2 justify-end">
                  <button_1.Button variant="outline" onClick={function () { return handleDismiss(duplicate.id); }} className="gap-2">
                    <lucide_react_1.X className="h-4 w-4"/>
                    Não é duplicata
                  </button_1.Button>
                  <button_1.Button onClick={function () { return handleMerge(duplicate.id); }} className="gap-2">
