...
function PatientFilters(_a) {
    var filters = _a.filters, onFiltersChange = _a.onFiltersChange;
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center space-x-2 h-10 px-3 border rounded-md">
            <checkbox_1.Checkbox id="upcoming-appointments" checked={filters.hasUpcomingAppointments} onCheckedChange={function (checked) {
      ...
      {activeFiltersCount > 0 && (<>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button_1.Button variant="ghost" size="sm" onClick={clearAllFilters} className="h-8 px-2 text-xs text-muted-foreground hover:text-foreground">
            ...
            <div className="flex flex-wrap gap-2">
              {activeFiltersList.map(function (filter) { return (<badge_1.Badge key={filter.key} variant="secondary" className="flex items-center gap-1 pr-1">
