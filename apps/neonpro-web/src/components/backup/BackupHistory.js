...
var BackupHistory = () => {
  ...
  var _b = (0, react_1.useState)([]),
    filteredBackups = _b[0],
    setFilteredBackups = _b[1];
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/backup/jobs/".concat(backupId), {
                method: "DELETE",
              }),
            ];
          case 1:
  ...
  return (
    <div className="space-y-6">
      ...
      <card_1.Card>
        <card_1.CardHeader>
          <card_1.CardTitle>Backups ({filteredBackups.length})</card_1.CardTitle>
          <card_1.CardDescription>Histórico completo de operações de backup</card_1.CardDescription>
        </card_1.CardHeader>
        <card_1.CardContent>
          {loading
          ...
          {selectedBackup && (
            <div className="space-y-4">
              ...
              {selectedBackup.error_message && (
                <alert_1.Alert className="border-red-200">
