...
var BackupScheduler = function () {
    ...
    var _c = (0, react_1.useState)(false), showNewDialog = _c[0], setShowNewDialog = _c[1];
    var _d = (0, react_1.useState)({
        ...
        priority: 'MEDIUM',
        notification_email: '',
    }), newConfig = _d[0], setNewConfig = _d[1];
    (0, react_1.useEffect)(function () {
        loadConfigs();
    }, []);
    var loadConfigs = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var handleCreateConfig = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var handleToggleConfig = function (id, enabled) { return __awaiter(void 0, void 0, void 0, function () {
        var response, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("/api/backup/configs/".concat(id), {
                            method: 'PUT',
                            headers: {
                                'Content-Type': 'application/json',
                            },
                ...
                case 1:
                    response = _a.sent();
                    if (response.ok) {
                        sonner_1.toast.success("Configura\u00E7\u00E3o ".concat(enabled ? 'ativada' : 'desativada', " com sucesso"));
                        loadConfigs();
                    }
                    else {
    ...
    return (<div className="space-y-6">
          ...
          <dialog_1.DialogContent className="max-w-2xl">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input_1.Input id="name" value={newConfig.name} onChange={function (e) { return setNewConfig(__assign(__assign({}, newConfig), { name: e.target.value })); }} placeholder="Ex: Backup Diário Completo"/>
              </div>
              <div className="space-y-2">
                <label_1.Label htmlFor="type">Tipo de Backup</label_1.Label>
                <select_1.Select value={newConfig.type} onValueChange={function (value) { return setNewConfig(__assign(__assign({}, newConfig), { type: value })); }}>
              ...
              <div className="space-y-2">
                ...
                <select_1.Select value={newConfig.schedule_frequency} onValueChange={function (value) { return setNewConfig(__assign(__assign({}, newConfig), { schedule_frequency: value })); }}>
                  <select_1.SelectTrigger>
                    <select_1.SelectValue />
                  </select_1.SelectTrigger>
                  <select_1.SelectContent>
              ...
              <div className="space-y-2">
                ...
                <input_1.Input id="time" type="time" value={newConfig.schedule_time} onChange={function (e) { return setNewConfig(__assign(__assign({}, newConfig), { schedule_time: e.target.value })); }}/>
              </div>
              <div className="space-y-2">
                <label_1.Label htmlFor="provider">Armazenamento</label_1.Label>
                <select_1.Select value={newConfig.storage_provider} onValueChange={function (value) { return setNewConfig(__assign(__assign({}, newConfig), { storage_provider: value })); }}>
                  <select_1.SelectTrigger>
                    <select_1.SelectValue />
                  </select_1.SelectTrigger>
                  <select_1.SelectContent>
              ...
              <div className="space-y-2">
                ...
                <input_1.Input id="retention" type="number" min="1" max="365" value={newConfig.retention_daily} onChange={function (e) { return setNewConfig(__assign(__assign({}, newConfig), { retention_daily: parseInt(e.target.value) })); }}/>
              </div>
              <div className="col-span-2 space-y-2">
                <label_1.Label htmlFor="description">Descrição</label_1.Label>
                <textarea_1.Textarea id="description" value={newConfig.description} onChange={function (e) { return setNewConfig(__assign(__assign({}, newConfig), { description: e.target.value })); }} placeholder="Descrição opcional da configuração..."/>
              </div>
            </div>
            <dialog_1.DialogFooter>
              <button_1.Button variant="outline" onClick={function () { return setShowNewDialog(false); }}>
                Cancelar
              </button_1.Button>
              <button_1.Button onClick={handleCreateConfig}>
                Criar Configuração
              </button_1.Button>
            </dialog_1.DialogFooter>
      ...
      {loading ? (<div className="text-center py-8">
          ...
          <card_1.CardContent>
            {configs.length === 0 ? (<div className="text-center py-8">
                ...
                <table_1.TableBody>
                  {configs.map(function (config) { return (<table_1.TableRow key={config.id}>
                      ...
                      <table_1.TableCell>
                        ...
                        {config.schedule_time && (<div className="text-sm text-muted-foreground">
                            às {config.schedule_time}
                          </div>)}
                      </table_1.TableCell>
                      <table_1.TableCell>
                        {config.next_backup ? (<div className="text-sm">
                      ...
                      <table_1.TableCell>
                        <div className="flex items-center space-x-2">
                          <switch_1.Switch checked={config.enabled} onCheckedChange={function (checked) { return handleToggleConfig(config.id, checked); }}/>
