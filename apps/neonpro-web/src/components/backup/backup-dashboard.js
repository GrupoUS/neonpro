...
var BackupDashboard = () => {
  ...
  var _g = (0, react_1.useState)(false),
    showCreateDialog = _g[0],
    setShowCreateDialog = _g[1];
          ...
          <card_1.Card>
            <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <lucide_react_1.Shield
                className={"h-4 w-4 ".concat(getHealthColor(metrics.system_health))}
              />
            </card_1.CardHeader>
            <card_1.CardContent>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="text-2xl font-bold">
                {(0, utils_1.formatBytes)(metrics.total_storage_used)}
              </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Monitor backup storage consumption</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
