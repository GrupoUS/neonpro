...
var BackupConfigForm = function (_a) {
    var initialData = _a.initialData, onSubmit = _a.onSubmit, onCancel = _a.onCancel, _b = _a.isEditing, isEditing = _b === void 0 ? false : _b;
    var _c = (0, react_1.useState)(false), isSubmitting = _c[0], setIsSubmitting = _c[1];
    var _d = (0, react_1.useState)('idle'), testConnection = _d[0], setTestConnection = _d[1];
    var _e = (0, react_1.useState)('basic'), activeTab = _e[0], setActiveTab = _e[1];
    var form = (0, react_hook_form_1.useForm)({
        resolver: (0, zod_1.zodResolver)(backupConfigSchema),
        defaultValues: __assign({ enabled: true, type: 'FULL', source_type: 'DATABASE', schedule_frequency: 'DAILY', storage_provider: 'LOCAL', compression_enabled: true, compression_level: 6, encryption_enabled: true, parallel_uploads: 3, chunk_size_mb: 64, verify_integrity: true, test_restore: false, source_config: {}, schedule_config: {
                timezone: 'UTC',
            }, storage_config: {}, retention_policy: {
                daily: 7,
                weekly: 4,
                monthly: 3,
                yearly: 1,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    setTimeout(function () { return setTestConnection('idle'); }, 3000);
                    return [3 /*break*/, 4];
                case 3:
                    error_2 = _a.sent();
    ...
    var generateCronExpression = function (frequency, config) {
        switch (frequency) {
            case 'HOURLY':
                return '0 * * * *';
            case 'DAILY':
                var hour = config.time_of_day ? new Date("2000-01-01T".concat(config.time_of_day)).getHours() : 2;
                return "0 ".concat(hour, " * * *");
            case 'WEEKLY':
                var weekHour = config.time_of_day ? new Date("2000-01-01T".concat(config.time_of_day)).getHours() : 2;
                var dayOfWeek = config.day_of_week || 0;
                return "0 ".concat(weekHour, " * * ").concat(dayOfWeek);
            case 'MONTHLY':
                var monthHour = config.time_of_day ? new Date("2000-01-01T".concat(config.time_of_day)).getHours() : 2;
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
          <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
            ...
            return (<form_1.FormItem>
                          ...
                          <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <select_1.SelectContent>
                              ...
                              <select_1.SelectItem value="DIFFERENTIAL">Differential</select_1.SelectItem>
            ...
            return (<form_1.FormItem>
                        ...
                        <form_1.FormControl>
                          <textarea_1.Textarea placeholder="Describe what this backup includes..." {...field}/>
                        </form_1.FormControl>
                        <form_1.FormDescription>
                  ...
                  <form_1.FormField control={form.control} name="enabled" render={function (_a) {
            var field = _a.field;
            ...
            <tabs_1.TabsContent value="source" className="space-y-4">
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-4">
                  <form_1.FormField control={form.control} name="source_type" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                        ...
                        <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <select_1.SelectContent>
                            ...
                            <select_1.SelectItem value="FILES">Specific Files</select_1.SelectItem>
                          </select_1.SelectContent>
                        </select_1.Select>
                        <form_1.FormDescription>
                  ...
                  {watchedValues.source_type === 'DATABASE' && (<form_1.FormField control={form.control} name="source_config.database_url" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                          <form_1.FormLabel>Database URL</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="password" placeholder="postgresql://user:pass@host:port/db" {...field}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                  ...
                  {watchedValues.source_type === 'DIRECTORY' && (<form_1.FormField control={form.control} name="source_config.directory_path" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                  ...
                  <accordion_1.Accordion type="single" collapsible>
                    <accordion_1.AccordionItem value="patterns">
                      <accordion_1.AccordionTrigger>File Patterns (Optional)</accordion_1.AccordionTrigger>
                      <accordion_1.AccordionContent className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <form_1.FormLabel>Include Patterns</form_1.FormLabel>
                            <textarea_1.Textarea placeholder="*.sql\n*.json\n*.txt" className="mt-2"/>
                            <form_1.FormDescription>
                          ...
                          <div>
                            ...
                            <textarea_1.Textarea placeholder="*.log\n*.tmp\n*.cache" className="mt-2"/>
                            <form_1.FormDescription>
            ...
            <tabs_1.TabsContent value="schedule" className="space-y-4">
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-4">
                  <form_1.FormField control={form.control} name="schedule_frequency" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                        ...
                        <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <select_1.SelectContent>
                            ...
                            <select_1.SelectItem value="CUSTOM">Custom (Cron)</select_1.SelectItem>
                          </select_1.SelectContent>
                        </select_1.Select>
                        <form_1.FormMessage />
                      </form_1.FormItem>);
                  ...
                  {watchedValues.schedule_frequency !== 'HOURLY' && watchedValues.schedule_frequency !== 'CUSTOM' && (<form_1.FormField control={form.control} name="schedule_config.time_of_day" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                  ...
                  {watchedValues.schedule_frequency === 'WEEKLY' && (<form_1.FormField control={form.control} name="schedule_config.day_of_week" render={function (_a) {
                var _b;
                var field = _a.field;
                return (<form_1.FormItem>
                          <form_1.FormLabel>Day of Week</form_1.FormLabel>
                          <select_1.Select onValueChange={function (value) { return field.onChange(parseInt(value)); }} defaultValue={(_b = field.value) === null || _b === void 0 ? void 0 : _b.toString()}>
                            <form_1.FormControl>
                              <select_1.SelectTrigger>
                  ...
                  {watchedValues.schedule_frequency === 'MONTHLY' && (<form_1.FormField control={form.control} name="schedule_config.day_of_month" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                          <form_1.FormLabel>Day of Month</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="1" max="31" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value)); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                  ...
                  {watchedValues.schedule_frequency === 'CUSTOM' && (<form_1.FormField control={form.control} name="schedule_config.cron_expression" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={form.control} name="schedule_config.timezone" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                        ...
                        <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <select_1.SelectContent>
                            ...
                            <select_1.SelectItem value="America/New_York">Eastern Time</select_1.SelectItem>
                            <select_1.SelectItem value="America/Chicago">Central Time</select_1.SelectItem>
                            <select_1.SelectItem value="America/Denver">Mountain Time</select_1.SelectItem>
                            <select_1.SelectItem value="America/Los_Angeles">Pacific Time</select_1.SelectItem>
                            <select_1.SelectItem value="Europe/London">London</select_1.SelectItem>
                  ...
                  <alert_1.Alert>
                    ...
                    <alert_1.AlertDescription>
                      ...
                      {generateCronExpression(watchedValues.schedule_frequency, watchedValues.schedule_config)}
                    </alert_1.AlertDescription>
                  </alert_1.Alert>
                </card_1.CardContent>
              </card_1.Card>
            ...
            <tabs_1.TabsContent value="storage" className="space-y-4">
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-4">
                  <form_1.FormField control={form.control} name="storage_provider" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                        ...
                        <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <select_1.SelectContent>
                            ...
                            <select_1.SelectItem value="GCS">Google Cloud Storage</select_1.SelectItem>
                            <select_1.SelectItem value="AZURE">Azure Blob Storage</select_1.SelectItem>
                          </select_1.SelectContent>
                        </select_1.Select>
                        <form_1.FormMessage />
                      </form_1.FormItem>);
                  ...
                  {/* Local Storage */}
                  {watchedValues.storage_provider === 'LOCAL' && (<form_1.FormField control={form.control} name="storage_config.local_path" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                  ...
                  {/* AWS S3 */}
                  {watchedValues.storage_provider === 'S3' && (<div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <form_1.FormField control={form.control} name="storage_config.s3_bucket" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        ...
                        <form_1.FormField control={form.control} name="storage_config.s3_region" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <form_1.FormField control={form.control} name="storage_config.s3_access_key" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        ...
                        <form_1.FormField control={form.control} name="storage_config.s3_secret_key" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                              <form_1.FormLabel>Secret Key</form_1.FormLabel>
                              <form_1.FormControl>
                                <input_1.Input type="password" placeholder="Secret key" {...field}/>
                              </form_1.FormControl>
                              <form_1.FormMessage />
                            </form_1.FormItem>);
            }}/>
                  ...
                  {watchedValues.storage_provider === 'GCS' && (<div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <form_1.FormField control={form.control} name="storage_config.gcs_bucket" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        ...
                        <form_1.FormField control={form.control} name="storage_config.gcs_project_id" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      ...
                      <form_1.FormField control={form.control} name="storage_config.gcs_key_file" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                            <form_1.FormLabel>Service Account Key File</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input placeholder="/path/to/service-account.json" {...field}/>
                            </form_1.FormControl>
                            <form_1.FormMessage />
                          </form_1.FormItem>);
            }}/>
                  ...
                  {/* Azure Blob Storage */}
                  {watchedValues.storage_provider === 'AZURE' && (<div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <form_1.FormField control={form.control} name="storage_config.azure_container" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        ...
                        <form_1.FormField control={form.control} name="storage_config.azure_account" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      ...
                      <form_1.FormField control={form.control} name="storage_config.azure_key" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                            <form_1.FormLabel>Access Key</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input type="password" placeholder="Storage account key" {...field}/>
                            </form_1.FormControl>
                            <form_1.FormMessage />
                          </form_1.FormItem>);
            }}/>
                  ...
                  {/* Test Connection */}
                  <div className="flex items-center space-x-2">
                    <button_1.Button type="button" variant="outline" onClick={handleTestConnection} disabled={testConnection === 'testing'}>
                      <lucide_react_1.TestTube className="h-4 w-4 mr-2"/>
                      {testConnection === 'testing' ? 'Testing...' : 'Test Connection'}
                    </button_1.Button>
                    {testConnection === 'success' && (<badge_1.Badge variant="default" className="bg-green-500">
                        Connection successful
                      </badge_1.Badge>)}
                    {testConnection === 'error' && (<badge_1.Badge variant="destructive">
                        Connection failed
                      </badge_1.Badge>)}
                  </div>
                </card_1.CardContent>
            ...
            <tabs_1.TabsContent value="retention" className="space-y-4">
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <form_1.FormField control={form.control} name="retention_policy.daily" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Daily Backups</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="1" max="365" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value)); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                    ...
                    <form_1.FormField control={form.control} name="retention_policy.weekly" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Weekly Backups</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="0" max="52" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value)); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <form_1.FormField control={form.control} name="retention_policy.monthly" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Monthly Backups</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="0" max="12" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value)); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                    ...
                    <form_1.FormField control={form.control} name="retention_policy.yearly" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Yearly Backups</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="0" max="10" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value)); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <form_1.FormField control={form.control} name="compression_enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                              <form_1.FormLabel className="text-base">Enable Compression</form_1.FormLabel>
                              <form_1.FormDescription>
                      ...
                      <form_1.FormField control={form.control} name="encryption_enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                              <form_1.FormLabel className="text-base">Enable Encryption</form_1.FormLabel>
                              <form_1.FormDescription>
                    ...
                    {watchedValues.compression_enabled && (<form_1.FormField control={form.control} name="compression_level" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                            <form_1.FormLabel>Compression Level (1-9)</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input type="number" min="1" max="9" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value)); }}/>
                            </form_1.FormControl>
                            <form_1.FormDescription>
                    ...
                    {watchedValues.encryption_enabled && (<form_1.FormField control={form.control} name="encryption_key" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                            <form_1.FormLabel>Encryption Key</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input type="password" placeholder="Enter encryption key" {...field}/>
                            </form_1.FormControl>
                            <form_1.FormDescription>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <form_1.FormField control={form.control} name="parallel_uploads" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                            <form_1.FormLabel>Parallel Uploads</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input type="number" min="1" max="10" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value)); }}/>
                            </form_1.FormControl>
                            <form_1.FormDescription>
                      ...
                      <form_1.FormField control={form.control} name="chunk_size_mb" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                            <form_1.FormLabel>Chunk Size (MB)</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input type="number" min="1" max="1024" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value)); }}/>
                            </form_1.FormControl>
                            <form_1.FormDescription>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <form_1.FormField control={form.control} name="verify_integrity" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                              <form_1.FormLabel className="text-base">Verify Integrity</form_1.FormLabel>
                              <form_1.FormDescription>
                      ...
                      <form_1.FormField control={form.control} name="test_restore" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                              <form_1.FormLabel className="text-base">Test Restore</form_1.FormLabel>
                              <form_1.FormDescription>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <form_1.FormField control={form.control} name="notification_config.on_success" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                              <form_1.FormLabel className="text-base">Notify on Success</form_1.FormLabel>
                              <form_1.FormDescription>
                      ...
                      <form_1.FormField control={form.control} name="notification_config.on_failure" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                              <form_1.FormLabel className="text-base">Notify on Failure</form_1.FormLabel>
                              <form_1.FormDescription>
