...
var ComplianceReports = () => {
  ...
  var _b = (0, react_1.useState)([]),
    filteredReports = _b[0],
    setFilteredReports = _b[1];
  ...
  var _g = (0, react_1.useState)(null),
    selectedReport = _g[0],
    setSelectedReport = _g[1];
  var _h = (0, react_1.useState)(false),
    showDetailsDialog = _h[0],
    setShowDetailsDialog = _h[1];
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            setLoading(true);
            return [4 /*yield*/, Promise.all([loadReports(), loadTemplates(), loadMetrics()])];
          case 1:
            _a.sent();
            return [3 /*break*/, 4];
          case 2:
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/backup/compliance/reports", {
                method: "POST",
                headers: {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/backup/compliance/reports/".concat(reportId, "/generate"), {
                method: "POST",
              }),
            ];
          case 1:
  ...
  var handleDownloadReport = (reportId_1) => {
    ...
    return __awaiter(
      void 0,
      __spreadArray([reportId_1], args_1, true),
      void 0,
          ...
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                fetch(
                  "/api/backup/compliance/reports/"
                    .concat(reportId, "/download?format=")
                    .concat(format),
                ),
              ];
            case 1:
  ...
  return (
    <div className="space-y-6">
                ...
                <div>
                  <p
                    className={"text-2xl font-bold ".concat(
                      getComplianceScoreColor(metrics.overall_score),
                    )}
                  >
      ...
      <card_1.Card>
        <card_1.CardHeader>
          <card_1.CardTitle>Relatórios ({filteredReports.length})</card_1.CardTitle>
        </card_1.CardHeader>
        <card_1.CardContent>
          {loading
                ...
                <card_1.Card>
                  <card_1.CardContent className="pt-4">
                    <div className="text-center">
                      <p
                        className={"text-2xl font-bold ".concat(
                          getComplianceScoreColor(selectedReport.metrics.compliance_score),
                        )}
                      >
                ...
                <card_1.Card>
                  <card_1.CardContent className="pt-4">
                    <div className="text-center">
                      <p
                        className={"text-2xl font-bold ".concat(
                          getComplianceScoreColor(selectedReport.metrics.data_protection_score),
                        )}
                      >
                ...
                <card_1.Card>
                  <card_1.CardContent className="pt-4">
                    <div className="text-center">
                      <p
                        className={"text-2xl font-bold ".concat(
                          getComplianceScoreColor(selectedReport.metrics.availability_score),
                        )}
                      >
