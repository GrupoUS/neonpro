...
function PredictionConfiguration(_a) {
    var _b;
    var currentConfiguration = _a.currentConfiguration, availableModels = _a.availableModels, onSaveConfiguration = _a.onSaveConfiguration, onActivateModel = _a.onActivateModel, onRetrainModel = _a.onRetrainModel;
    var _c = (0, react_1.useState)(currentConfiguration), config = _c[0], setConfig = _c[1];
    ...
    var updateConfig = function (updates) {
        setConfig(function (prev) { return (__assign(__assign({}, prev), updates)); });
        setHasChanges(true);
    };
    /**
    ...
    var updateNestedConfig = function (key, updates) {
        setConfig(function (prev) {
            var _a;
            return (__assign(__assign({}, prev), (_a = {}, _a[key] = __assign(__assign({}, prev[key]), updates), _a)));
        });
        setHasChanges(true);
    };
    /**
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {hasChanges && (<alert_1.Alert className="py-2 px-3">
              <lucide_react_1.Info className="h-4 w-4"/>
              <alert_1.AlertDescription className="text-sm">
                You have unsaved changes
              </alert_1.AlertDescription>
            </alert_1.Alert>)}
          <button_1.Button variant="outline" onClick={handleResetConfiguration} disabled={!hasChanges}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <div className={"w-3 h-3 rounded-full ".concat(config.enabled ? 'bg-green-500' : 'bg-red-500')}/>
                <span className="font-medium">
                  Prediction System: {config.enabled ? 'Active' : 'Inactive'}
                </span>
              </div>
              <badge_1.Badge variant={config.enabled ? 'default' : 'secondary'}>
                {availableModels.filter(function (m) { return m.isActive; }).length} models active
              </badge_1.Badge>
            </div>
            <switch_1.Switch checked={config.enabled} onCheckedChange={function (enabled) { return updateConfig({ enabled: enabled }); }}/>
          </div>
        </card_1.CardContent>
      </card_1.Card>
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={function (value) { return setActiveTab(value); }}>
            ...
            <card_1.CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <slider_1.Slider value={[config.predictionWindow]} onValueChange={function (_a) {
        var value = _a[0];
        return updateConfig({ predictionWindow: value });
    }} max={168} min={1} step={1} className="w-full"/>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <slider_1.Slider value={[config.minimumConfidence]} onValueChange={function (_a) {
        var value = _a[0];
        return updateConfig({ minimumConfidence: value });
    }} max={100} min={50} step={5} className="w-full"/>
                    <div className="flex justify-between text-xs text-muted-foreground">
                      <span>50%</span>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.autoRetraining} onCheckedChange={function (autoRetraining) { return updateConfig({ autoRetraining: autoRetraining }); }}/>
                </div>

                {config.autoRetraining && (<div className="space-y-2 ml-4">
                    <label_1.Label>Retraining Interval (days)</label_1.Label>
                    <div className="space-y-2">
                      <slider_1.Slider value={[config.retrainingInterval]} onValueChange={function (_a) {
            var value = _a[0];
            return updateConfig({ retrainingInterval: value });
        }} max={90} min={7} step={7} className="w-full"/>
                      <div className="flex justify-between text-xs text-muted-foreground">
                        <span>Weekly</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">
                    {((_b = availableModels.find(function (m) { return m.isActive; })) === null || _b === void 0 ? void 0 : _b.accuracy.toFixed(1)) || 0}%
                  </div>
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600">
                    {availableModels.filter(function (m) { return m.isActive; }).length}
                  </div>
        ...
        <tabs_1.TabsContent value="models" className="space-y-6">
          ...
          <card_1.Card>
            ...
            return (<card_1.Card key={model.id} className={"p-4 ".concat(model.isActive ? 'border-green-200 bg-green-50/50' : '')}>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="text-right">
                          <div className={"text-lg font-bold ".concat(getAccuracyColor(model.accuracy))}>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                          <button_1.Button variant="outline" size="sm" onClick={function () { return onRetrainModel(model.id); }}>
                            <lucide_react_1.RotateCcw className="h-4 w-4 mr-1"/>
                            Retrain
                          </button_1.Button>
                          {!model.isActive ? (<button_1.Button variant="default" size="sm" onClick={function () { return onActivateModel(model.id); }}>
                              <lucide_react_1.Play className="h-4 w-4 mr-1"/>
                              Activate
                            </button_1.Button>) : (<button_1.Button variant="outline" size="sm" disabled>
            ...
            <card_1.CardContent className="space-y-6">
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <slider_1.Slider value={[config.riskThresholds.low]} onValueChange={function (_a) {
        var value = _a[0];
        return updateNestedConfig('riskThresholds', { low: value });
    }} max={50} min={10} step={5} className="w-full"/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <slider_1.Slider value={[config.riskThresholds.medium]} onValueChange={function (_a) {
        var value = _a[0];
        return updateNestedConfig('riskThresholds', { medium: value });
    }} max={80} min={config.riskThresholds.low + 5} step={5} className="w-full"/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <slider_1.Slider value={[config.riskThresholds.high]} onValueChange={function (_a) {
        var value = _a[0];
        return updateNestedConfig('riskThresholds', { high: value });
    }} max={95} min={config.riskThresholds.medium + 5} step={5} className="w-full"/>
                </div>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.features.historicalData} onCheckedChange={function (historicalData) {
            return updateNestedConfig('features', { historicalData: historicalData });
                ...
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.features.demographicInfo} onCheckedChange={function (demographicInfo) {
            return updateNestedConfig('features', { demographicInfo: demographicInfo });
                ...
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.features.appointmentCharacteristics} onCheckedChange={function (appointmentCharacteristics) {
            return updateNestedConfig('features', { appointmentCharacteristics: appointmentCharacteristics });
        }}/>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.features.externalFactors} onCheckedChange={function (externalFactors) {
            return updateNestedConfig('features', { externalFactors: externalFactors });
                ...
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.features.communicationPatterns} onCheckedChange={function (communicationPatterns) {
            return updateNestedConfig('features', { communicationPatterns: communicationPatterns });
        }}/>
                </div>
              </div>
            </card_1.CardContent>
        ...
        ].map(function (item, index) { return (<div key={index} className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className={"text-sm font-medium ".concat(item.enabled ? '' : 'text-muted-foreground')}>
                        {item.feature}
                      </span>
                      <span className={"text-sm ".concat(item.enabled ? 'font-medium' : 'text-muted-foreground')}>
                        {item.importance}%
                      </span>
                    </div>
                    <progress_1.Progress value={item.enabled ? item.importance : 0} className={"h-2 ".concat(item.enabled ? '' : 'opacity-50')}/>
                  </div>); })}
              </div>
            </card_1.CardContent>
          </card_1.Card>
            ...
            <card_1.CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.notifications.highRiskPatients} onCheckedChange={function (highRiskPatients) {
            return updateNestedConfig('notifications', { highRiskPatients: highRiskPatients });
        }}/>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.notifications.modelPerformanceDrop} onCheckedChange={function (modelPerformanceDrop) {
            return updateNestedConfig('notifications', { modelPerformanceDrop: modelPerformanceDrop });
        }}/>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.notifications.retrainingRequired} onCheckedChange={function (retrainingRequired) {
            return updateNestedConfig('notifications', { retrainingRequired: retrainingRequired });
        }}/>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <switch_1.Switch checked={config.notifications.predictionErrors} onCheckedChange={function (predictionErrors) {
            return updateNestedConfig('notifications', { predictionErrors: predictionErrors });
        }}/>
                </div>
              </div>
            </card_1.CardContent>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <textarea_1.Textarea placeholder="admin@neonpro.com, manager@neonpro.com" value="admin@neonpro.com" className="mt-1"/>
                ...
                <div>
                  ...
                  <input_1.Input placeholder="https://hooks.slack.com/services/..." className="mt-1"/>
                </div>
