...
var INTERVENTION_TYPES = [
  ...
  },
  {
    ...
    icon: <lucide_react_1.Bell className="h-4 w-4" />,
  },
  {
...
function InterventionManagement(_a) {
  var interventions = _a.interventions,
    outcomes = _a.outcomes,
    onCreateIntervention = _a.onCreateIntervention,
    onUpdateIntervention = _a.onUpdateIntervention,
    onDeleteIntervention = _a.onDeleteIntervention;
  var _b = (0, react_1.useState)(null),
    selectedIntervention = _b[0],
    setSelectedIntervention = _b[1];
  var _c = (0, react_1.useState)(false),
    showCreateForm = _c[0],
    setShowCreateForm = _c[1];
  var _d = (0, react_1.useState)("active"),
    activeTab = _d[0],
    setActiveTab = _d[1];
  var _e = (0, react_1.useState)({
    ...
    interventionForm = _e[0],
    setInterventionForm = _e[1];
  /**
   * Calculate intervention analytics from outcomes
   */
  var interventionAnalytics = (0, react_1.useMemo)(
    function () {
      ...
      var effectiveness = Object.entries(interventionGroups).map(function (_a) {
        var interventionId = _a[0],
          outcomes = _a[1];
        var intervention = interventions.find(function (i) {
          return i.id === interventionId;
        });
        var successfulOutcomes = outcomes.filter(function (o) {
          return o.success;
        });
        var noShowReduction = outcomes.filter(function (o) {
          return o.noShowPrevented;
        }).length;
        return {
          intervention:
            (intervention === null || intervention === void 0 ? void 0 : intervention.name) ||
            "Unknown",
          successRate: (successfulOutcomes.length / outcomes.length) * 100,
          totalSent: outcomes.length,
          responseRate:
            (outcomes.filter(function (o) {
              return o.patientEngaged;
            }).length /
              outcomes.length) *
            100,
      ...
      var channelPerformance = Object.entries(channelGroups).map(function (_a) {
        ...
        return {
          ...
          satisfaction:
            outcomes.reduce(function (sum, o) {
              return sum + (o.satisfactionScore || 0);
            }, 0) / outcomes.length,
        };
      });
  ...
  var getInterventionTypeInfo = function (type) {
    return (
      INTERVENTION_TYPES.find(function (t) {
        return t.value === type;
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input_1.Input
                      ...
                      onChange={function (e) {
                        return setInterventionForm(function (prev) {
                  ...
                  <div>
                    ...
                    >
                      ...
                      <select_1.SelectContent>
                        {INTERVENTION_TYPES.map(function (type) {
                          return (
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-2">
                      {COMMUNICATION_CHANNELS.map(function (channel) {
                        return (
                          <label key={channel.value} className="flex items-center space-x-2">
                            <input
                              ...
                              onChange={function (e) {
                                if (e.target.checked) {
                                  setInterventionForm(function (prev) {
                                    return __assign(__assign({}, prev), {
                                      channels: __spreadArray(
                                        __spreadArray([], prev.channels, true),
                                        [channel.value],
                                        false,
                                      ),
                                    });
                                  ...
                                  setInterventionForm(function (prev) {
                                    return __assign(__assign({}, prev), {
                                      channels: prev.channels.filter(function (c) {
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {TRIGGER_CONDITIONS.map(function (trigger) {
                      return (
                        <label key={trigger.value} className="flex items-center space-x-2">
                          <input
                            type="checkbox"
                            checked={interventionForm.triggers.includes(trigger.value)}
                            onChange={function (e) {
                              if (e.target.checked) {
                                setInterventionForm(function (prev) {
                                  return __assign(__assign({}, prev), {
                                    triggers: __spreadArray(
                                      __spreadArray([], prev.triggers, true),
                                      [trigger.value],
                                      false,
                                    ),
                                  });
                                ...
                                setInterventionForm(function (prev) {
                                  return __assign(__assign({}, prev), {
                                    triggers: prev.triggers.filter(function (t) {
                ...
                <div>
                  ...
                  <textarea_1.Textarea
                    ...
                    onChange={function (e) {
                      return setInterventionForm(function (prev) {
                        return __assign(__assign({}, prev), { template: e.target.value });
                      });
                    }}
                    ...
                    <div>
                      ...
                      <input_1.Input
                        ...
                        onChange={function (e) {
                          return setInterventionForm(function (prev) {
                            return __assign(__assign({}, prev), {
                              timing: __assign(__assign({}, prev.timing), {
                ...
                <div className="flex items-center justify-between pt-4">
                  <div className="flex items-center space-x-2">
                    <switch_1.Switch
                      ...
                      onCheckedChange={function (checked) {
                        return setInterventionForm(function (prev) {
                          return __assign(__assign({}, prev), { active: checked });
                        });
                      }}
                    />
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="text-2xl font-bold">
                  {
                    interventions.filter(function (i) {
                      return i.active;
                    }).length
                  }
                </div>
              ...
              <div className="space-y-4">
                {interventions.length === 0
                  ...
                  : interventions.map(function (intervention) {
                      ...
                      var interventionOutcomes = outcomes.filter(function (o) {
                        return o.interventionId === intervention.id;
                      });
                      var successRate =
                        interventionOutcomes.length > 0
                          ? (interventionOutcomes.filter(function (o) {
                              return o.success;
                            }).length /
                      ...
                      return (
                        <card_1.Card
                          ...
                          onClick={function () {
                            return setSelectedIntervention(intervention);
                          }}
                        >
                          <card_1.CardContent className="pt-4">
                            <div className="flex items-center justify-between mb-3">
                              <div className="flex items-center gap-3">
                                ...
                                <badge_1.Badge
                                  variant={intervention.active ? "default" : "secondary"}
                                >
                              ...
                              <div>
                                ...
                                <div
                                  className={"text-sm font-medium ".concat(
                                    getEffectivenessColor(successRate),
                                  )}
                                >
        ...
        <tabs_1.TabsContent value="analytics" className="space-y-6">
                  ...
                  <recharts_1.Tooltip
                    formatter={function (value, name) {
                      return [
                        ""
                          .concat(value)
                          .concat(name.includes("Rate") || name.includes("Reduction") ? "%" : ""),
                        name,
                      ];
                    }}
                  />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-4">
                  {interventionAnalytics.channelPerformance.map(function (channel, index) {
                    return (
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {interventionAnalytics.patientSegments.map(function (segment, index) {
                  return (
                        ...
                        <div className="flex justify-between text-sm">
                          ...
                          <span
                            className={"font-medium ".concat(
                              getEffectivenessColor(segment.responseRate),
                            )}
                          >
      ...
      {selectedIntervention && (
        <dialog_1.Dialog
          ...
          onOpenChange={function () {
            return setSelectedIntervention(null);
          }}
        >
          <dialog_1.DialogContent className="max-w-4xl">
            ...
            <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <badge_1.Badge
                          variant={selectedIntervention.active ? "default" : "secondary"}
                        >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      {selectedIntervention.triggers.map(function (trigger, index) {
                        return (
                          <badge_1.Badge key={index} variant="outline" className="mr-1 mb-1">
              ...
              <div>
                ...
                {(function () {
                  var interventionOutcomes = outcomes.filter(function (o) {
                    return o.interventionId === selectedIntervention.id;
                  });
                  var successRate =
                    interventionOutcomes.length > 0
                      ? (interventionOutcomes.filter(function (o) {
              ...
              <div className="flex justify-end gap-3">
                ...
                <button_1.Button>Edit Intervention</button_1.Button>
              </div>
            </div>
          </dialog_1.DialogContent>
        </dialog_1.Dialog>
