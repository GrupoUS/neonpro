...
function InterventionManagement(_a) {
  ...
  var interventionAnalytics = (0, react_1.useMemo)(() => {
    ...
    var interventionGroups = outcomes.reduce((acc, outcome) => {
    ...
    var effectiveness = Object.entries(interventionGroups).map((_a) => {
      var interventionId = _a[0],
        outcomes = _a[1];
      var intervention = interventions.find((i) => i.id === interventionId);
      var successfulOutcomes = outcomes.filter((o) => o.success);
      var noShowReduction = outcomes.filter((o) => o.noShowPrevented).length;
      return {
        intervention:
    ...
    var channelGroups = outcomes.reduce((acc, outcome) => {
    ...
    var channelPerformance = Object.entries(channelGroups).map((_a) => {
      var channel = _a[0],
        outcomes = _a[1];
      return {
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select_1.Select
                      ...
                      onValueChange={(value) =>
                        setInterventionForm((prev) => __assign(__assign({}, prev), { type: value }))
                      }
                    >
                ...
                <div>
                  ...
                  <textarea_1.Textarea
                    ...
                    onChange={(e) =>
                      setInterventionForm((prev) =>
                        __assign(__assign({}, prev), { template: e.target.value }),
                      )
                    }
                ...
                <div className="flex items-center justify-between pt-4">
                  <div className="flex items-center space-x-2">
                    <switch_1.Switch
                      ...
                      onCheckedChange={(checked) =>
                        setInterventionForm((prev) =>
                          __assign(__assign({}, prev), { active: checked }),
                        )
                      }
                    />
              ...
              <div className="space-y-4">
                {interventions.length === 0
                  ...
                  : interventions.map((intervention) => {
                      ...
                      var interventionOutcomes = outcomes.filter(
          ...
          <dialog_1.DialogContent className="max-w-4xl">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end gap-3">
                <button_1.Button variant="outline" onClick={() => setSelectedIntervention(null)}>
                  Close
                </button_1.Button>
