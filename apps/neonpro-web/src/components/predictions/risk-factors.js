    ...
    function () {
      ...
      var categoryBreakdown = Object.entries(categoryData).map(function (_a) {
        ...
        var category = _a[0],
          data = _a[1];
        var avgRisk =
          data.risks.reduce(function (sum, risk) {
            return sum + risk;
          }, 0) / data.risks.length;
        var categoryConfig =
          ((_b = {}),
      ...
      var patientSegments = [
        {
          ...
          count: riskProfiles.filter(function (p) {
            return p.overallRiskScore < 25;
          }).length,
          avgRisk: 15,
          characteristics: [
        ...
        },
        {
          ...
          count: riskProfiles.filter(function (p) {
            return p.overallRiskScore >= 25 && p.overallRiskScore < 50;
          }).length,
          avgRisk: 35,
        ...
        },
        {
          segment: "High Risk",
          count: riskProfiles.filter(function (p) {
            return p.overallRiskScore >= 50 && p.overallRiskScore < 75;
          }).length,
          avgRisk: 62,
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold text-green-600">
              {
                riskProfiles.filter(function (p) {
                  return p.riskTrend === "IMPROVING";
                }).length
              }
            </div>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold text-orange-600">
              {
                riskAnalysis.factorCorrelations.filter(function (f) {
                  return f.correlation > 0.7;
                }).length
              }
            </div>
      ...
      >
        ...
        <tabs_1.TabsContent value="overview" className="space-y-6">
                ...
                <recharts_1.ResponsiveContainer width="100%" height={300}>
                  <recharts_1.BarChart data={riskAnalysis.categoryBreakdown}>
                    ...
                    <recharts_1.Bar dataKey="avgRisk" name="Average Risk">
                      {riskAnalysis.categoryBreakdown.map(function (entry, index) {
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-4">
                  {riskAnalysis.patientSegments.map(function (segment, index) {
                    return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-3">
                  {riskAnalysis.protectiveFactors.map(function (factor, index) {
                    return (
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-3">
                  {riskAnalysis.timePatterns.map(function (pattern, index) {
                    return (
        ...
        <tabs_1.TabsContent value="categories" className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
            {riskAnalysis.categoryBreakdown.map(function (category) {
              return (
                ...
                >
                  ...
                  <recharts_1.Tooltip
                    formatter={function (value) {
                      return ["".concat(value, "%"), "Average Risk"];
                    }}
                  />
        ...
        <tabs_1.TabsContent value="segments" className="space-y-6">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {riskProfiles.slice(0, 10).map(function (profile) {
                  return (
                    <card_1.Card
          ...
          <card_1.CardContent>
            ...
            {selectedProfile.topRiskFactors.length > 0 && (
              <div className="mt-6">
                ...
                <div className="space-y-3">
                  {selectedProfile.topRiskFactors.map(function (factor, index) {
                    return (
            ...
            {selectedProfile.recommendedInterventions.length > 0 && (
              <div className="mt-6">
                ...
                <div className="space-y-2">
                  {selectedProfile.recommendedInterventions.map(function (intervention, index) {
                    return (
                      <div
                        key={index}
