      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              ab_testing_engine_1.abTestingEngine.pauseTest(testId, "Pausado pelo usuário"),
            ];
          case 1:
            _a.sent();
            return [4 /*yield*/, loadTests()];
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              ab_testing_engine_1.abTestingEngine.completeTest(testId, "Finalizado pelo usuário"),
            ];
          case 1:
            results = _a.sent();
            setTestResults(results);
                  ...
                  <div key={result.variationId} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2">
                        ...
                        {result.isWinner && (
                          <badge_1.Badge variant="success" className="flex items-center gap-1">
                      ...
                      <div className="mt-3 p-2 bg-muted rounded">
                        <p className="text-sm">
                          <span
                            className={(0, utils_1.cn)(
                              "font-medium",
                              getSignificanceColor(result.significance),
                            )}
                          >
                            Significância: {result.significance}
                          </span>{" "}
                          (p-value:{" "}
                          {(_a = result.pValue) === null || _a === void 0 ? void 0 : _a.toFixed(4)})
                        </p>
                      </div>
                    )}
                  </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <button_1.Button onClick={loadTests} variant="outline" disabled={isLoading}>
            <lucide_react_1.RefreshCw
              className={(0, utils_1.cn)("h-4 w-4 mr-2", isLoading && "animate-spin")}
            />
            Atualizar
          </button_1.Button>
        </div>
          ...
          <tabs_1.TabsContent value="settings" className="space-y-6">
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <label_1.Label htmlFor="auto-winner">
