...
function TransactionEntryForm(_a) {
    var _this = this;
    var clinicId = _a.clinicId, userId = _a.userId, onSuccess = _a.onSuccess, onCancel = _a.onCancel;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    entryData = __assign(__assign({}, data), { reference_number: data.reference_number || (0, calculations_1.generateReferenceNumber)(data.transaction_type) });
        ...
        <form_1.Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <form_1.FormField control={form.control} name="transaction_type" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    ...
                    <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <select_1.SelectContent>
                        ...
                        <select_1.SelectItem value="opening_balance">Saldo Inicial</select_1.SelectItem>
                        <select_1.SelectItem value="closing_balance">Saldo Final</select_1.SelectItem>
                      </select_1.SelectContent>
                    </select_1.Select>
                    <form_1.FormMessage />
                  </form_1.FormItem>);
            ...
            return (<form_1.FormItem>
                    ...
                    <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <select_1.SelectContent>
                        <select_1.SelectItem value="service_payment">Pagamento de Serviço</select_1.SelectItem>
                        <select_1.SelectItem value="product_sale">Venda de Produto</select_1.SelectItem>
            ...
            <div className="grid grid-cols-2 gap-4">
              <form_1.FormField control={form.control} name="amount" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
              ...
              <form_1.FormField control={form.control} name="payment_method" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
            ...
            </div>            <form_1.FormField control={form.control} name="register_id" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
            ...
            return (<form_1.FormItem>
                  ...
                  <form_1.FormControl>
                    <textarea_1.Textarea placeholder="Digite a descrição da transação..." className="resize-none" {...field}/>
                  </form_1.FormControl>
                  <form_1.FormMessage />
                </form_1.FormItem>);
        }}/>

            <form_1.FormField control={form.control} name="reference_number" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
