...
function CashFlowDashboard(_a) {
  ...
  var totalBalance = registers.reduce(function (sum, register) {
    return sum + register.current_balance;
  }, 0);
  var activeRegisters = registers.filter(function (r) {
    return r.is_active;
  }).length;
  var lowBalanceRegisters = registers.filter(function (r) {
    return r.is_active && r.current_balance < 500;
  }).length;
  ...
  var recentTransactions = entries.slice(0, 10).map(function (t) {
    ...
    return __assign(__assign({}, t), {
      registerName:
        ((_a = registers.find(function (r) {
          return r.id === t.register_id;
        })) === null || _a === void 0
          ? void 0
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button_1.Button
            size="sm"
            onClick={function () {
              return setShowNewTransaction(true);
            }}
          >
      ...
      <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
        ...
        <div className="flex items-center gap-2">
          ...
          <select_1.Select
            ...
            onValueChange={function (value) {
              return setSelectedRegisterId(value === "all" ? undefined : value);
            }}
          >
            ...
            <p className="text-xs text-muted-foreground">
              {
                entries.filter(function (e) {
                  return e.transaction_type === "receipt";
                }).length
              }{" "}
              transações
            </p>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {
                entries.filter(function (e) {
                  return e.transaction_type === "payment";
                }).length
              }{" "}
              transações
            </p>
      ...
      {showNewTransaction && (
        <transaction_entry_form_1.TransactionEntryForm
          ...
          registers={registers}
          onClose={function () {
            return setShowNewTransaction(false);
          }}
          onSuccess={function () {
