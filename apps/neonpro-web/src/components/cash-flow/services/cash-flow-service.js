...
var CashFlowService = /** @class */ (function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (
              (filters === null || filters === void 0 ? void 0 : filters.isReconciled) !== undefined
            ) {
            ...
            if (filters === null || filters === void 0 ? void 0 : filters.search) {
              query = query.or(
                "description.ilike.%"
                  .concat(filters.search, "%,reference_number.ilike.%")
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("cash_flow_entries").insert(entry).select().single(),
            ];
          case 1:
            ...
            return [
              4 /*yield*/,
              this.updateRegisterBalance(entry.register_id, entry.amount, entry.transaction_type),
            ];
          case 2:
            _b.sent();
            _b.label = 3;
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3]);
            return [4 /*yield*/, this.supabase.from("cash_flow_entries").delete().eq("id", id)];
          case 1:
            error = _a.sent().error;
            if (error) throw error;
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.supabase.from("cash_registers").insert(register).select().single(),
            ];
          case 1:
            (_a = _b.sent()), (data = _a.data), (error = _a.error);
            if (error) throw error;
  ...
  CashFlowService.prototype.getCashFlowAnalytics = function (
    clinicId,
    periodStart,
    periodEnd,
    registerId,
