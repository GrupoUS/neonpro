...
describe('Cash Flow Validation', function () {
    describe('CashFlowEntrySchema', function () {
        ...
        it('rejects invalid clinic_id', function () {
            var _a;
            var result = (0, validation_1.validateCashFlowEntry)(__assign(__assign({}, validEntry), { clinic_id: 'invalid-uuid' }));
            expect(result.success).toBe(false);
            expect((_a = result.error) === null || _a === void 0 ? void 0 : _a.issues[0].message).toContain('Invalid clinic ID');
        });
        it('rejects negative amounts', function () {
            var _a;
            var result = (0, validation_1.validateCashFlowEntry)(__assign(__assign({}, validEntry), { amount: -50 }));
            expect(result.success).toBe(false);
            expect((_a = result.error) === null || _a === void 0 ? void 0 : _a.issues[0].message).toContain('Amount must be positive');
        });
        it('rejects empty description', function () {
            var _a;
            var result = (0, validation_1.validateCashFlowEntry)(__assign(__assign({}, validEntry), { description: '' }));
            expect(result.success).toBe(false);
            expect((_a = result.error) === null || _a === void 0 ? void 0 : _a.issues[0].message).toContain('Description is required');
        });
        it('rejects invalid transaction type', function () {
            var result = (0, validation_1.validateCashFlowEntry)(__assign(__assign({}, validEntry), { transaction_type: 'invalid_type' }));
            expect(result.success).toBe(false);
        });
    });
    describe('CashRegisterSchema', function () {
        ...
        it('rejects empty register name', function () {
            var _a;
            var result = (0, validation_1.validateCashRegister)(__assign(__assign({}, validRegister), { register_name: '' }));
            expect(result.success).toBe(false);
            expect((_a = result.error) === null || _a === void 0 ? void 0 : _a.issues[0].message).toContain('Register name is required');
        });
        it('rejects negative opening balance', function () {
            var _a;
            var result = (0, validation_1.validateCashRegister)(__assign(__assign({}, validRegister), { opening_balance: -100 }));
            expect(result.success).toBe(false);
            expect((_a = result.error) === null || _a === void 0 ? void 0 : _a.issues[0].message).toContain('Opening balance cannot be negative');
        });
    });
    describe('CashFlowFiltersSchema', function () {
        it('validates correct filters', function () {
            ...
            try {
                ...
                try {
                    ...
                    process.stderr.write('- Error message: ' + ((validateError === null || validateError === void 0 ? void 0 : validateError.message) || 'N/A') + '\n');
                    throw validateError;
                }
                ...
                process.stderr.write('- Error message: ' + ((testError === null || testError === void 0 ? void 0 : testError.message) || 'N/A') + '\n');
                throw testError;
            }
        });
        it('rejects invalid date range', function () {
            ...
            if (!result.success) {
                console.log('Error details:', (_a = result.error) === null || _a === void 0 ? void 0 : _a.issues);
            }
            expect(result.success).toBe(false);
            expect((_b = result.error) === null || _b === void 0 ? void 0 : _b.issues[0].message).toContain('Start date must be before end date');
        });
