...
function useTransactionEntry(clinicId) {
    ...
    var createEntry = function (entry) { return __awaiter(_this, void 0, void 0, function () {
        var newEntry, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    // Simulate API call
                    _a.sent();
                    newEntry = __assign(__assign({}, entry), { id: Math.random().toString(36).substr(2, 9), clinic_id: clinicId, created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
                    setIsLoading(false);
    ...
    var updateEntry = function (id, updates) { return __awaiter(_this, void 0, void 0, function () {
        var err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var deleteEntry = function (id) { return __awaiter(_this, void 0, void 0, function () {
        var err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
