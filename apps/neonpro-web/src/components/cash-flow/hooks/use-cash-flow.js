...
function useCashFlow(clinicId, initialFilters) {
    var _this = this;
    var _a = (0, react_1.useState)([]), entries = _a[0], setEntries = _a[1];
    ...
    var loadEntries = (0, react_1.useCallback)(function (newFilters_1) {
        var args_1 = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args_1[_i - 1] = arguments[_i];
        }
        return __awaiter(_this, __spreadArray([newFilters_1], args_1, true), void 0, function (newFilters, page) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        setCurrentPage(page);
                        return [4 /*yield*/, cash_flow_service_1.cashFlowService.getCashFlowEntries(clinicId, filtersToUse, page)];
                    case 1:
                        result = _a.sent();
                    ...
                    case 2:
                        err_1 = _a.sent();
                        errorMessage = err_1 instanceof Error ? err_1.message : 'Failed to load cash flow entries';
    ...
    var loadAnalytics = (0, react_1.useCallback)(function (periodStart, periodEnd, registerId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    setError(null);
                    return [4 /*yield*/, cash_flow_service_1.cashFlowService.getCashFlowAnalytics(clinicId, periodStart, periodEnd, registerId)];
                case 1:
    ...
    var createEntry = (0, react_1.useCallback)(function (entry) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var updateEntry = (0, react_1.useCallback)(function (id, updates) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    setError(null);
                    return [4 /*yield*/, cash_flow_service_1.cashFlowService.updateCashFlowEntry(id, updates)];
                case 1:
    ...
    var deleteEntry = (0, react_1.useCallback)(function (id) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var refetch = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadEntries(filters, currentPage)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
