...
var mockAnalytics = {
    ...
    byCategory: [
        { category: 'service_payment', amount: 1500.00, percentage: 100 }
    ],
    byPaymentMethod: [
        { method: 'pix', amount: 1500.00, count: 10 }
    ],
    byDay: [],
    registers: [
        { id: '1', name: 'Caixa Principal', balance: 1500.50, transactions: 10 }
    ]
};
function useCashRegisters(clinicId) {
    var _this = this;
    var _a = (0, react_1.useState)(mockRegisters), registers = _a[0], setRegisters = _a[1];
...
function useCashFlowEntries(clinicId, filters) {
    var _this = this;
    var _a = (0, react_1.useState)(mockEntries), entries = _a[0], setEntries = _a[1];
    var _b = (0, react_1.useState)(false), loading = _b[0], setLoading = _b[1];
    var refetch = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            setLoading(true);
...
function useCashFlowAnalytics(clinicId, filters) {
    var _this = this;
    var _a = (0, react_1.useState)(mockAnalytics), analytics = _a[0], setAnalytics = _a[1];
    var _b = (0, react_1.useState)(false), loading = _b[0], setLoading = _b[1];
    var refetch = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            setLoading(true);
