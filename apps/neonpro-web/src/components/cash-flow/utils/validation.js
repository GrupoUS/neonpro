...
exports.ReconciliationSchema =
  exports.CashFlowFiltersSchema =
  exports.CashRegisterSchema =
  exports.CashFlowEntrySchema =
...
exports.CashFlowFiltersSchema = zod_1.z
  .object({
...
exports.ReconciliationSchema = zod_1.z
  .object({
    clinic_id: zod_1.z.string().uuid("Invalid clinic ID"),
