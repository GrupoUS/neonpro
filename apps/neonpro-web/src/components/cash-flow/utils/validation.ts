...
export const CashRegisterSchema = z.object({
  clinic_id: z.string().uuid("Invalid clinic ID"),
  register_name: z.string().min(1, "Register name is required").max(100, "Register name too long"),
  register_code: z.string().min(1, "Register code is required").max(20, "Register code too long"),
...
export const CashFlowFiltersSchema = z
  .object({
