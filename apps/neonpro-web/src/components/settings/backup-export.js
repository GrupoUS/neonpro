...
function BackupExport() {
    ...
    var _d = (0, react_1.useState)([]), backupHistory = _d[0], setBackupHistory = _d[1];
    var _e = (0, react_1.useState)(0), exportProgress = _e[0], setExportProgress = _e[1];
    var _f = (0, react_1.useState)(false), isExporting = _f[0], setIsExporting = _f[1];
    ...
    (0, react_1.useEffect)(function () {
        var loadBackupSettings = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var startManualBackup = function () { return __awaiter(_this, void 0, void 0, function () {
        var interval_1;
        return __generator(this, function (_a) {
            try {
                setIsExporting(true);
    ...
    var exportPatientData = function (patientId) { return __awaiter(_this, void 0, void 0, function () {
        var interval_2;
        return __generator(this, function (_a) {
            try {
                setIsExporting(true);
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <form_1.FormField control={form.control} name="automaticBackup.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      <form_1.FormLabel className="text-base">Habilitar Backup Automático</form_1.FormLabel>
              ...
              {form.watch("automaticBackup.enabled") && (<>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <form_1.FormField control={form.control} name="automaticBackup.frequency" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                    ...
                    <form_1.FormField control={form.control} name="automaticBackup.time" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                          ...
                          <form_1.FormDescription>Horário para executar o backup</form_1.FormDescription>
                          <form_1.FormMessage />
                        </form_1.FormItem>);
            }}/>

                    <form_1.FormField control={form.control} name="automaticBackup.retentionDays" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                          <form_1.FormLabel>Retenção (dias)</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="7" max="365" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 30); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>Dias para manter backups</form_1.FormDescription>
                          <form_1.FormMessage />
                        </form_1.FormItem>);
            }}/>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <form_1.FormField control={form.control} name="automaticBackup.includeDatabase" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                          <div className="space-y-0.5">
                            ...
                            <form_1.FormDescription>Backup completo do banco</form_1.FormDescription>
                          </div>
                          <form_1.FormControl>
                            <switch_1.Switch checked={field.value} onCheckedChange={field.onChange}/>
                          </form_1.FormControl>
                    ...
                    <form_1.FormField control={form.control} name="automaticBackup.includeFiles" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                          <div className="space-y-0.5">
                            <form_1.FormLabel>Incluir Arquivos</form_1.FormLabel>
                            <form_1.FormDescription>Backup de documentos e imagens</form_1.FormDescription>
                          </div>
                          <form_1.FormControl>
                            <switch_1.Switch checked={field.value} onCheckedChange={field.onChange}/>
                          </form_1.FormControl>
                    ...
                    <form_1.FormField control={form.control} name="automaticBackup.encryption" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                          <div className="space-y-0.5">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-4">
                <button_1.Button type="button" onClick={startManualBackup} disabled={isExporting} className="flex-1">
                  <lucide_react_1.Database className="h-4 w-4 mr-2"/>
                  {isExporting ? "Realizando Backup..." : "Backup Manual"}
                </button_1.Button>

                <button_1.Button type="button" variant="outline" onClick={function () { return exportPatientData(); }} disabled={isExporting} className="flex-1">
              ...
              <form_1.FormField control={form.control} name="exportSettings.defaultFormat" render={function (_a) {
            var field = _a.field;
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <form_1.FormField control={form.control} name="lgpdCompliance.dataPortabilityEnabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
              ...
              <form_1.FormField control={form.control} name="lgpdCompliance.rightToErasure" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      <form_1.FormLabel className="text-base">
              ...
              <form_1.FormField control={form.control} name="lgpdCompliance.automaticAnonymization" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      <form_1.FormLabel className="text-base">Anonimização Automática</form_1.FormLabel>
                      <form_1.FormDescription>
              ...
              {form.watch("lgpdCompliance.automaticAnonymization") && (<form_1.FormField control={form.control} name="lgpdCompliance.anonymizationDays" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="md:w-1/3">
                      <form_1.FormLabel>Dias para Anonimização</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input type="number" min="30" max="2555" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 365); }}/>
                      </form_1.FormControl>
                      <form_1.FormDescription>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              {backupHistory.length === 0 ? (<div className="text-center p-8">
                  ...
                  {backupHistory.map(function (backup) { return (<div key={backup.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center gap-3">
                        <div className={"p-2 rounded-full ".concat(backup.status === "success" ? "bg-green-100" :
                    backup.status === "failed" ? "bg-red-100" : "bg-yellow-100")}>
                          {backup.status === "success" ? (<lucide_react_1.CheckCircle2 className="h-4 w-4 text-green-600"/>) : backup.status === "failed" ? (<lucide_react_1.AlertTriangle className="h-4 w-4 text-red-600"/>) : (<lucide_react_1.Clock className="h-4 w-4 text-yellow-600"/>)}
                        </div>
                        <div>
                      ...
                      <div className="flex items-center gap-2">
                        <badge_1.Badge className={backup.status === "success" ? "bg-green-100 text-green-800" :
