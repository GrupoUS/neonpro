...
function ComplianceSettings() {
  ...
  var _c = (0, react_1.useState)(null),
    lastSaved = _c[0],
    setLastSaved = _c[1];
  var _d = (0, react_1.useState)("licenses"),
    activeTab = _d[0],
    setActiveTab = _d[1];
  var _e = (0, react_1.useState)([]),
    complianceScores = _e[0],
    setComplianceScores = _e[1];
  ...
  var _f = (0, react_hook_form_1.useFieldArray)({
    ...
    licenseFields = _f.fields,
    appendLicense = _f.append,
    removeLicense = _f.remove;
  var _g = (0, react_hook_form_1.useFieldArray)({
      control: form.control,
      name: "auditLogs",
    }),
    auditLogFields = _g.fields,
