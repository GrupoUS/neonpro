...
function IntegrationSettings() {
    ...
    var _d = (0, react_1.useState)("whatsapp"), activeTab = _d[0], setActiveTab = _d[1];
    var _e = (0, react_1.useState)({}), connectionStatus = _e[0], setConnectionStatus = _e[1];
    ...
    (0, react_1.useEffect)(function () {
        var loadIntegrationSettings = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var testConnection = function (service) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
          ...
          <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <tabs_1.TabsContent value="whatsapp" className="space-y-6">
              <card_1.Card>
                <card_1.CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      {connectionStatus.whatsapp !== undefined && (<badge_1.Badge className={connectionStatus.whatsapp ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}>
                      ...
                      <button_1.Button type="button" variant="outline" size="sm" onClick={function () { return testConnection("whatsapp"); }} disabled={!form.watch("whatsapp.enabled")}>
                ...
                <card_1.CardContent className="space-y-6">
                  <form_1.FormField control={form.control} name="whatsapp.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          <form_1.FormLabel className="text-base">Habilitar WhatsApp Business</form_1.FormLabel>
                  ...
                  {form.watch("whatsapp.enabled") && (<>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <form_1.FormField control={form.control} name="whatsapp.phoneNumber" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        ...
                        <form_1.FormField control={form.control} name="whatsapp.businessAccountId" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      ...
                      <form_1.FormField control={form.control} name="whatsapp.accessToken" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                            <form_1.FormLabel>Access Token</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input type="password" placeholder="EAABsBCS..." {...field}/>
                            </form_1.FormControl>
                            <form_1.FormDescription>
                      ...
                      <form_1.FormField control={form.control} name="whatsapp.webhookUrl" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                            <form_1.FormLabel>Webhook URL</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input placeholder="https://suaapi.com/webhook/whatsapp" {...field}/>
                            </form_1.FormControl>
                            <form_1.FormDescription>
                      ...
                      <div className="space-y-4">
                        ...
                        <form_1.FormField control={form.control} name="whatsapp.enableAppointmentReminders" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                              <div className="space-y-0.5">
                        ...
                        <form_1.FormField control={form.control} name="whatsapp.enableConfirmations" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                              <div className="space-y-0.5">
                        ...
                        <form_1.FormField control={form.control} name="whatsapp.enableStatusUpdates" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                              <div className="space-y-0.5">
              ...
              <card_1.Card>
                <card_1.CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <button_1.Button type="button" variant="outline" size="sm" onClick={function () { return testConnection("email"); }} disabled={!form.watch("email.enabled")}>
                      <lucide_react_1.TestTube className="h-4 w-4 mr-2"/>
                      Testar Email
                    </button_1.Button>
                  </div>
                ...
                <card_1.CardContent className="space-y-6">
                  <form_1.FormField control={form.control} name="email.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          <form_1.FormLabel className="text-base">Habilitar Email</form_1.FormLabel>
                          <form_1.FormDescription>
                  ...
                  {form.watch("email.enabled") && (<>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <form_1.FormField control={form.control} name="email.fromName" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        ...
                        <form_1.FormField control={form.control} name="email.fromEmail" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <form_1.FormField control={form.control} name="email.smtpHost" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        ...
                        <form_1.FormField control={form.control} name="email.smtpPort" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                              <form_1.FormLabel>Porta SMTP</form_1.FormLabel>
                              <form_1.FormControl>
                                <input_1.Input type="number" placeholder="587" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 587); }}/>
                              </form_1.FormControl>
                              <form_1.FormMessage />
                            </form_1.FormItem>);
            }}/>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <form_1.FormField control={form.control} name="email.smtpUser" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        ...
                        <form_1.FormField control={form.control} name="email.smtpPassword" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
            ...
            <tabs_1.TabsContent value="sms" className="space-y-6">
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-6">
                  <form_1.FormField control={form.control} name="sms.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                  ...
                  {form.watch("sms.enabled") && (<>
                      <form_1.FormField control={form.control} name="sms.provider" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                            <form_1.FormLabel>Provedor SMS</form_1.FormLabel>
                            <form_1.FormControl>
                              <select className="w-full p-2 border rounded-md" value={field.value} onChange={field.onChange}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <form_1.FormField control={form.control} name="sms.accountSid" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        ...
                        <form_1.FormField control={form.control} name="sms.authToken" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <form_1.FormField control={form.control} name="paymentGateways.mercadoPagoAccessToken" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    ...
                    <form_1.FormField control={form.control} name="paymentGateways.pixApiKey" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                  ...
                  <div className="border-t pt-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <form_1.FormField control={form.control} name="calendar.googleCalendar.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormControl>
                            <switch_1.Switch checked={field.value} onCheckedChange={field.onChange}/>
                          </form_1.FormControl>);
        }}/>
                    </div>
                    
                    {form.watch("calendar.googleCalendar.enabled") && (<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <form_1.FormField control={form.control} name="calendar.googleCalendar.clientId" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                              <form_1.FormLabel>Client ID</form_1.FormLabel>
                              <form_1.FormControl>
                                <input_1.Input placeholder="123456789.apps.googleusercontent.com" {...field}/>
                              </form_1.FormControl>
                              <form_1.FormMessage />
                            </form_1.FormItem>);
            }}/>

                        <form_1.FormField control={form.control} name="calendar.googleCalendar.clientSecret" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                              <form_1.FormLabel>Client Secret</form_1.FormLabel>
                              <form_1.FormControl>
                                <input_1.Input type="password" placeholder="GOCSPX-..." {...field}/>
                              </form_1.FormControl>
                              <form_1.FormMessage />
                            </form_1.FormItem>);
            }}/>
