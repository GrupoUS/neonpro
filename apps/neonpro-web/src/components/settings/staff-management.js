...
var staffMemberSchema = z.object({
    ...
    var professionalType = professionalTypes.find(function (pt) { return pt.value === data.professionalType; });
    if (professionalType === null || professionalType === void 0 ? void 0 : professionalType.requiresCRM) {
...
function StaffManagement() {
    var _this = this;
    var _a;
    var _b = (0, react_1.useState)([]), staffMembers = _b[0], setStaffMembers = _b[1];
    var _c = (0, react_1.useState)(false), isLoading = _c[0], setIsLoading = _c[1];
    var _d = (0, react_1.useState)(false), isDialogOpen = _d[0], setIsDialogOpen = _d[1];
    var _e = (0, react_1.useState)(null), editingMember = _e[0], setEditingMember = _e[1];
    ...
    var requiresCRM = ((_a = professionalTypes.find(function (pt) { return pt.value === watchedProfessionalType; })) === null || _a === void 0 ? void 0 : _a.requiresCRM) || false;
    // Format CPF input
    ...
    (0, react_1.useEffect)(function () {
        var loadStaffMembers = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                if (editingMember) {
                    ...
                    setStaffMembers(function (prev) { return prev.map(function (member) {
                        return member.id === editingMember.id ? updatedMember_1 : member;
                    }); });
                    sonner_1.toast.success("Profissional atualizado com sucesso!");
                }
                else {
                    newMember_1 = __assign(__assign({}, data), { id: Date.now().toString(), createdAt: new Date() });
                    setStaffMembers(function (prev) { return __spreadArray(__spreadArray([], prev, true), [newMember_1], false); });
    ...
    var handleDelete = function (memberId) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (confirm("Tem certeza que deseja remover este profissional?")) {
                try {
                    setStaffMembers(function (prev) { return prev.filter(function (member) { return member.id !== memberId; }); });
    ...
    var handleToggleActive = function (memberId) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
                setStaffMembers(function (prev) { return prev.map(function (member) {
                    return member.id === memberId ? __assign(__assign({}, member), { active: !member.active }) : member;
                }); });
    ...
    var filteredMembers = staffMembers.filter(function (member) {
        var matchesSearch = member.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
        ...
        var csvContent = "data:text/csv;charset=utf-8," +
            ...
            staffMembers.map(function (member) {
                ...
                return [
                    ...
                    member.email,
                    member.phone,
                    ((_a = professionalTypes.find(function (pt) { return pt.value === member.professionalType; })) === null || _a === void 0 ? void 0 : _a.label) || member.professionalType,
                    member.crm || "",
                    member.crmState || "",
                    member.specialty || "",
        ...
        <div className="flex items-center gap-2">
          ...
          <dialog_1.Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            return (<form_1.FormItem>
                          ...
                          <form_1.FormControl>
                            <input_1.Input type="email" placeholder="joao@clinica.com.br" {...field}/>
                          </form_1.FormControl>
                          <form_1.FormMessage />
                        </form_1.FormItem>);
        }}/>
            ...
            return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={form.control} name="professionalType" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                        ...
                        <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <select_1.SelectContent>
                            {professionalTypes.map(function (type) { return (<select_1.SelectItem key={type.value} value={type.value}>
                                <div className="flex items-center gap-2">
                                  {type.label}
                                  {type.requiresCRM && (<badge_1.Badge variant="secondary" className="text-xs">
                                      CRM
                                    </badge_1.Badge>)}
                                </div>
                              </select_1.SelectItem>); })}
                  ...
                  {requiresCRM && (<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <form_1.FormField control={form.control} name="crm" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      ...
                      <form_1.FormField control={form.control} name="crmState" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                            ...
                            <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <select_1.SelectContent>
                                {brazilianStates.map(function (state) { return (<select_1.SelectItem key={state} value={state}>
                                    {state}
                                  </select_1.SelectItem>); })}
                              </select_1.SelectContent>
                            </select_1.Select>
            ...
            return (<form_1.FormItem>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <form_1.FormField control={form.control} name="canPerformProcedures" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center space-x-3 space-y-0">
                      ...
                      <form_1.FormField control={form.control} name="canManageSchedule" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center space-x-3 space-y-0">
                            <form_1.FormControl>
                              <input type="checkbox" checked={field.value} onChange={field.onChange} className="rounded border-gray-300"/>
                      ...
                      <form_1.FormField control={form.control} name="canAccessFinancial" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center space-x-3 space-y-0">
                            <form_1.FormControl>
                              <input type="checkbox" checked={field.value} onChange={field.onChange} className="rounded border-gray-300"/>
                      ...
                      <form_1.FormField control={form.control} name="isAdmin" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center space-x-3 space-y-0">
                            <form_1.FormControl>
                              <input type="checkbox" checked={field.value} onChange={field.onChange} className="rounded border-gray-300"/>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input_1.Input placeholder="Buscar por nome, email ou CRM..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-10"/>
              </div>
            </div>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          {isLoading ? (<div className="flex items-center justify-center p-8">
            ...
            </div>) : filteredMembers.length === 0 ? (<div className="text-center p-8">
              ...
              <table_1.Table>
                ...
                var professionalType = professionalTypes.find(function (pt) { return pt.value === member.professionalType; });
                var permissions = [
                ...
                return (<table_1.TableRow key={member.id}>
                        <table_1.TableCell>
                          <div>
                        ...
                        <table_1.TableCell>
                          <div className="flex items-center gap-2">
                            {professionalType === null || professionalType === void 0 ? void 0 : professionalType.label}
                            {(professionalType === null || professionalType === void 0 ? void 0 : professionalType.requiresCRM) && (<badge_1.Badge variant="secondary" className="text-xs">
                                CRM
                              </badge_1.Badge>)}
                          </div>
                        </table_1.TableCell>
                        <table_1.TableCell>
                          {member.crm ? "".concat(member.crm, "/").concat(member.crmState) : "-"}
                        </table_1.TableCell>
                        <table_1.TableCell>{member.specialty || "-"}</table_1.TableCell>
                        <table_1.TableCell>
                          <div className="flex flex-wrap gap-1">
                            {permissions.map(function (permission) { return (<badge_1.Badge key={permission} variant="outline" className="text-xs">
                                {permission}
                              </badge_1.Badge>); })}
                          </div>
                        </table_1.TableCell>
                        <table_1.TableCell>
                          <button onClick={function () { return handleToggleActive(member.id); }} className="flex items-center gap-1">
                            {member.active ? (<>
                        ...
                        <table_1.TableCell>
                          <div className="flex items-center gap-1">
                            <button_1.Button variant="ghost" size="sm" onClick={function () { return handleEdit(member); }}>
                              <lucide_react_1.Edit className="h-4 w-4"/>
                            </button_1.Button>
                            <button_1.Button variant="ghost" size="sm" onClick={function () { return handleDelete(member.id); }} className="text-red-600 hover:text-red-800">
