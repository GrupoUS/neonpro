    ...
    <div className="space-y-6">
                      ...
                      render={(_a) => {
                        ...
                        return (
                          <form_1.FormItem>
                            ...
                            <form_1.FormControl>
                              <input_1.Input
                                placeholder="limpeza, extração, hidratação"
                                {...field}
                              />
                            </form_1.FormControl>
                            <form_1.FormDescription>
      ...
      <card_1.Card>
        <card_1.CardHeader>
          ...
          <card_1.CardDescription>Lista completa do catálogo de serviços</card_1.CardDescription>
        </card_1.CardHeader>
        <card_1.CardContent>
          {isLoading
                    ...
                    <table_1.TableBody>
                      {filteredServices.map((service) => {
                        ...
                        var _a = calculateProfit(service.price, service.cost),
                          ...
                          margin = _a.margin;
                        return (
                          <table_1.TableRow key={service.id}>
                            <table_1.TableCell>
                              <div>
                            ...
                            <table_1.TableCell>
                              <div className="flex flex-col gap-1">
                                ...
                                {service.featured && (
                                  <badge_1.Badge variant="secondary" className="text-xs w-fit">
                                    Destaque
                                  </badge_1.Badge>
                                )}
                              </div>
