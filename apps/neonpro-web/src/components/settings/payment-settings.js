...
function PaymentSettings() {
    ...
    (0, react_1.useEffect)(function () {
        var loadPaymentSettings = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <form_1.FormField control={form.control} name="pix.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
              ...
              {form.watch("pix.enabled") && (<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <form_1.FormField control={form.control} name="pix.pixKey" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={form.control} name="pix.expirationMinutes" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                        <form_1.FormLabel>Validade (minutos)</form_1.FormLabel>
                        <form_1.FormControl>
                          <input_1.Input type="number" min="5" max="1440" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 30); }}/>
                        </form_1.FormControl>
                        <form_1.FormDescription>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <form_1.FormField control={form.control} name="cards.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
              ...
              {form.watch("cards.enabled") && (<>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <form_1.FormField control={form.control} name="cards.acceptCredit" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    ...
                    <form_1.FormField control={form.control} name="cards.acceptDebit" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                          <div className="space-y-0.5">
                  ...
                  <div className="border-t pt-4">
                    <form_1.FormField control={form.control} name="cards.installments.enabled" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4 mb-4">
                          <div className="space-y-0.5">
                            <form_1.FormLabel className="text-base">Parcelamento</form_1.FormLabel>
                            <form_1.FormDescription>
                    ...
                    {form.watch("cards.installments.enabled") && (<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <form_1.FormField control={form.control} name="cards.installments.maxInstallments" render={function (_a) {
                    var field = _a.field;
                    return (<form_1.FormItem>
                              <form_1.FormLabel>Máx. Parcelas</form_1.FormLabel>
                              <form_1.FormControl>
                                <input_1.Input type="number" min="1" max="12" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 12); }}/>
                              </form_1.FormControl>
                              <form_1.FormMessage />
                            </form_1.FormItem>);
                }}/>

                        <form_1.FormField control={form.control} name="cards.installments.minAmountPerInstallment" render={function (_a) {
                    var field = _a.field;
                    return (<form_1.FormItem>
                              <form_1.FormLabel>Mín. por Parcela (R$)</form_1.FormLabel>
                              <form_1.FormControl>
                                <input_1.Input type="number" min="10" {...field} onChange={function (e) { return field.onChange(parseFloat(e.target.value) || 50); }}/>
                              </form_1.FormControl>
                              <form_1.FormMessage />
                            </form_1.FormItem>);
                }}/>

                        <form_1.FormField control={form.control} name="cards.installments.interestRate" render={function (_a) {
                    var field = _a.field;
                    return (<form_1.FormItem>
                              <form_1.FormLabel>Taxa de Juros (% a.m.)</form_1.FormLabel>
                              <form_1.FormControl>
                                <input_1.Input type="number" step="0.01" min="0" max="10" {...field} onChange={function (e) { return field.onChange(parseFloat(e.target.value) || 2.99); }}/>
                              </form_1.FormControl>
                              <form_1.FormMessage />
                            </form_1.FormItem>);
                }}/>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <form_1.FormField control={form.control} name="bankTransfer.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      <form_1.FormLabel className="text-base">Aceitar Transferência</form_1.FormLabel>
                      <form_1.FormDescription>
              ...
              {form.watch("bankTransfer.enabled") && (<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <form_1.FormField control={form.control} name="bankTransfer.bankName" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={form.control} name="bankTransfer.accountType" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={form.control} name="bankTransfer.agency" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={form.control} name="bankTransfer.account" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <form_1.FormField control={form.control} name="cash.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
              ...
              {form.watch("cash.enabled") && (<form_1.FormField control={form.control} name="cash.discountPercent" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="md:w-1/3">
                      <form_1.FormLabel>Desconto à Vista (%)</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input type="number" min="0" max="50" step="0.5" {...field} onChange={function (e) { return field.onChange(parseFloat(e.target.value) || 0); }}/>
                      </form_1.FormControl>
                      <form_1.FormDescription>
