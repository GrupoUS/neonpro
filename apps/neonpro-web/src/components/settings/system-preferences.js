...
function SystemPreferences() {
    ...
    (0, react_1.useEffect)(function () {
        var loadSystemPreferences = function () { return __awaiter(_this, void 0, void 0, function () {
      ...
      <form_1.Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <form_1.FormField control={form.control} name="ui.theme" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                ...
                <form_1.FormField control={form.control} name="ui.language" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                ...
                <form_1.FormField control={form.control} name="ui.dateFormat" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                ...
                <form_1.FormField control={form.control} name="ui.timeFormat" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
              ...
              <form_1.FormField control={form.control} name="ui.compactMode" render={function (_a) {
            var field = _a.field;
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <form_1.FormField control={form.control} name="notifications.email.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        <form_1.FormLabel className="text-base">Notificações por Email</form_1.FormLabel>
                        <form_1.FormDescription>
                ...
                {form.watch("notifications.email.enabled") && (<div className="ml-4 space-y-3">
                    <form_1.FormField control={form.control} name="notifications.email.appointmentReminders" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    ...
                    <form_1.FormField control={form.control} name="notifications.email.systemAlerts" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                          <div className="space-y-0.5">
                    ...
                    <form_1.FormField control={form.control} name="notifications.email.weeklyReports" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                          <div className="space-y-0.5">
              ...
              <div className="space-y-4">
                ...
                <form_1.FormField control={form.control} name="notifications.push.enabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        <form_1.FormLabel className="text-base">Notificações Push</form_1.FormLabel>
                        <form_1.FormDescription>
                ...
                {form.watch("notifications.push.enabled") && (<div className="ml-4 space-y-3">
                    <form_1.FormField control={form.control} name="notifications.push.appointmentReminders" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                          <div className="space-y-0.5">
                            <form_1.FormLabel>Lembretes de Consulta</form_1.FormLabel>
                    ...
                    <form_1.FormField control={form.control} name="notifications.push.patientMessages" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                          <div className="space-y-0.5">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <form_1.FormField control={form.control} name="system.autoLogout" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
              ...
              {form.watch("system.autoLogout") && (<form_1.FormField control={form.control} name="system.autoLogoutMinutes" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="md:w-1/3">
                      <form_1.FormLabel>Tempo de Inatividade (minutos)</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input type="number" min="5" max="480" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 60); }}/>
                      </form_1.FormControl>
                      <form_1.FormDescription>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <form_1.FormField control={form.control} name="system.performanceMode" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                      ...
                      <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <select_1.SelectContent>
                          <select_1.SelectItem value="low">Baixa (economiza recursos)</select_1.SelectItem>
                          <select_1.SelectItem value="normal">Normal</select_1.SelectItem>
                          <select_1.SelectItem value="high">Alta (máxima velocidade)</select_1.SelectItem>
                        </select_1.SelectContent>
                      </select_1.Select>
                      <form_1.FormMessage />
                    </form_1.FormItem>);
                ...
                <form_1.FormField control={form.control} name="system.dataRetentionDays" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                      <form_1.FormLabel>Retenção de Dados (dias)</form_1.FormLabel>
                      <form_1.FormControl>
                        <input_1.Input type="number" min="90" max="2555" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 1825); }}/>
                      </form_1.FormControl>
                      <form_1.FormDescription>
              ...
              <form_1.FormField control={form.control} name="system.auditLogging" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
