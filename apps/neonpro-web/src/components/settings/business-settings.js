...
function BusinessSettings() {
    ...
    var _d = (0, react_1.useState)("hours"), activeTab = _d[0], setActiveTab = _d[1];
    var form = (0, react_hook_form_1.useForm)({
        resolver: (0, zod_1.zodResolver)(businessSettingsSchema),
        defaultValues: {
            workingHours: daysOfWeek.map(function (day) { return ({
                day: day.value,
    ...
    var _e = (0, react_hook_form_1.useFieldArray)({
        ...
        name: "holidays",
    }), holidayFields = _e.fields, appendHoliday = _e.append, removeHoliday = _e.remove;
    // Load existing settings
    (0, react_1.useEffect)(function () {
        var loadBusinessSettings = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var copyScheduleToAll = function (sourceDay) {
        var sourceSchedule = form.getValues("workingHours.".concat(daysOfWeek.findIndex(function (d) { return d.value === sourceDay; })));
        daysOfWeek.forEach(function (day, index) {
            if (day.value !== sourceDay) {
                form.setValue("workingHours.".concat(index), __assign(__assign({}, sourceSchedule), { day: day.value }));
            }
        });
    ...
    var addBrazilianHoliday = function () {
        ...
        var commonHolidays = [
            { date: "".concat(currentYear, "-01-01"), name: "Confraternização Universal", isRecurring: true },
            ...
            { date: "".concat(currentYear, "-07-09"), name: "Independência do Brasil", isRecurring: true },
            { date: "".concat(currentYear, "-10-12"), name: "Nossa Senhora Aparecida", isRecurring: true },
            { date: "".concat(currentYear, "-11-02"), name: "Finados", isRecurring: true },
            { date: "".concat(currentYear, "-11-15"), name: "Proclamação da República", isRecurring: true },
            { date: "".concat(currentYear, "-12-25"), name: "Natal", isRecurring: true },
        ];
        var existingDates = form.getValues("holidays").map(function (h) { return h.date; });
        var newHolidays = commonHolidays.filter(function (h) { return !existingDates.includes(h.date); });
          ...
          <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <tabs_1.TabsContent value="hours" className="space-y-6">
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-6">
                  {daysOfWeek.map(function (day, index) { return (<div key={day.value} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          <form_1.FormField control={form.control} name={"workingHours.".concat(index, ".isOpen")} render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem className="flex items-center space-x-2">
                          ...
                          <button_1.Button type="button" variant="outline" size="sm" onClick={function () { return copyScheduleToAll(day.value); }} disabled={!form.watch("workingHours.".concat(index, ".isOpen"))}>
                            Copiar para todos
                          </button_1.Button>
                        </div>
                      </div>

                      {form.watch("workingHours.".concat(index, ".isOpen")) && (<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <form_1.FormField control={form.control} name={"workingHours.".concat(index, ".openTime")} render={function (_a) {
                    var field = _a.field;
                    return (<form_1.FormItem>
                                ...
                                <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                                  ...
                                  <select_1.SelectContent>
                                    {timeSlots.slice(0, timeSlots.length - 4).map(function (slot) { return (<select_1.SelectItem key={slot.value} value={slot.value}>
                                        {slot.label}
                                      </select_1.SelectItem>); })}
                                  </select_1.SelectContent>
                                </select_1.Select>
                          ...
                          <form_1.FormField control={form.control} name={"workingHours.".concat(index, ".closeTime")} render={function (_a) {
                    var field = _a.field;
                    return (<form_1.FormItem>
                                ...
                                <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                                  ...
                                  <select_1.SelectContent>
                                    {timeSlots.slice(4).map(function (slot) { return (<select_1.SelectItem key={slot.value} value={slot.value}>
                                        {slot.label}
                                      </select_1.SelectItem>); })}
                                  </select_1.SelectContent>
                                </select_1.Select>
                          ...
                          <form_1.FormField control={form.control} name={"workingHours.".concat(index, ".breakStart")} render={function (_a) {
                    var field = _a.field;
                    return (<form_1.FormItem>
                                ...
                                <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                                  ...
                                  <select_1.SelectContent>
                                    ...
                                    {timeSlots.map(function (slot) { return (<select_1.SelectItem key={slot.value} value={slot.value}>
                                        {slot.label}
                                      </select_1.SelectItem>); })}
                                  </select_1.SelectContent>
                                </select_1.Select>
                          ...
                          <form_1.FormField control={form.control} name={"workingHours.".concat(index, ".breakEnd")} render={function (_a) {
                    var field = _a.field;
                    return (<form_1.FormItem>
                  ...
                  <form_1.FormField control={form.control} name="timezone" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="md:w-1/2">
                        ...
                        <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <select_1.SelectContent>
                            {brazilianTimezones.map(function (tz) { return (<select_1.SelectItem key={tz.value} value={tz.value}>
                                {tz.label}
                              </select_1.SelectItem>); })}
                          </select_1.SelectContent>
                        </select_1.Select>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <form_1.FormField control={form.control} name="defaultAppointmentDuration" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Duração Padrão (min)</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="15" step="15" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 60); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                    ...
                    <form_1.FormField control={form.control} name="appointmentBuffer" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Intervalo Entre Consultas (min)</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="0" step="5" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 0); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                    ...
                    <form_1.FormField control={form.control} name="maxAppointmentsPerDay" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Máximo Consultas/Dia</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="1" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 20); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <form_1.FormField control={form.control} name="autoConfirmBookings" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <form_1.FormLabel className="text-base">Confirmação Automática</form_1.FormLabel>
                            <form_1.FormDescription>
                    ...
                    {form.watch("autoConfirmBookings") && (<form_1.FormField control={form.control} name="autoConfirmHours" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                            <form_1.FormLabel>Confirmar Após (horas)</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input type="number" min="0" max="168" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 2); }}/>
                            </form_1.FormControl>
                            <form_1.FormDescription>
            ...
            <tabs_1.TabsContent value="policies" className="space-y-6">
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <form_1.FormField control={form.control} name="advanceBookingLimit" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Antecedência Máxima (dias)</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="0" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 30); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                    ...
                    <form_1.FormField control={form.control} name="cancellationDeadline" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Prazo Cancelamento (horas)</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="0" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 24); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                    ...
                    <form_1.FormField control={form.control} name="rescheduleLimit" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Limite de Reagendamentos</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input type="number" min="0" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 2); }}/>
                          </form_1.FormControl>
                          <form_1.FormDescription>
                  ...
                  <div className="border-t pt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <form_1.FormField control={form.control} name="noShowFee" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                            <form_1.FormLabel>Taxa por Falta (R$)</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input type="number" step="0.01" min="0" {...field} onChange={function (e) { return field.onChange(parseFloat(e.target.value) || 0); }}/>
                            </form_1.FormControl>
                            <form_1.FormDescription>
                      ...
                      <form_1.FormField control={form.control} name="noShowAfterMinutes" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                            <form_1.FormLabel>Tolerância (minutos)</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input type="number" min="0" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 15); }}/>
                            </form_1.FormControl>
                            <form_1.FormDescription>
                      ...
                      <form_1.FormField control={form.control} name="blacklistAfterNoShows" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                            <form_1.FormLabel>Bloqueio Após Faltas</form_1.FormLabel>
                            <form_1.FormControl>
                              <input_1.Input type="number" min="0" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value) || 3); }}/>
                            </form_1.FormControl>
                            <form_1.FormDescription>
                  ...
                  <div className="border-t pt-6">
                    <form_1.FormField control={form.control} name="enableReminders" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <form_1.FormLabel className="text-base">Lembretes Automáticos</form_1.FormLabel>
                            <form_1.FormDescription>
                    ...
                    {form.watch("enableReminders") && (<div className="mt-4">
                        <form_1.FormLabel className="text-base">Horários dos Lembretes</form_1.FormLabel>
                        <div className="flex flex-wrap gap-2 mt-2">
                          {[1, 2, 4, 24, 48].map(function (hours) {
                var _a;
                return (<label key={hours} className="flex items-center space-x-2">
                              <input type="checkbox" checked={((_a = form.watch("reminderHours")) === null || _a === void 0 ? void 0 : _a.includes(hours)) || false} onChange={function (e) {
                        var current = form.getValues("reminderHours") || [];
                        if (e.target.checked) {
                            form.setValue("reminderHours", __spreadArray(__spreadArray([], current, true), [hours], false));
                        }
                        else {
                            form.setValue("reminderHours", current.filter(function (h) { return h !== hours; }));
                        }
                ...
                <card_1.CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button_1.Button type="button" variant="outline" onClick={addBrazilianHoliday}>
                        Adicionar Feriados Nacionais
                      </button_1.Button>
                      <button_1.Button type="button" onClick={function () { return appendHoliday({
            date: "",
            name: "",
            isRecurring: false,
        }); }}>
                ...
                <card_1.CardContent>
                  {holidayFields.length === 0 ? (<div className="text-center p-8">
                      ...
                      {holidayFields.map(function (field, index) { return (<div key={field.id} className="flex items-end gap-4 p-4 border rounded-lg">
                          <form_1.FormField control={form.control} name={"holidays.".concat(index, ".date")} render={function (_a) {
                    var field = _a.field;
                    return (<form_1.FormItem className="flex-1">
                          ...
                          <form_1.FormField control={form.control} name={"holidays.".concat(index, ".name")} render={function (_a) {
                    var field = _a.field;
                    return (<form_1.FormItem className="flex-2">
                          ...
                          <form_1.FormField control={form.control} name={"holidays.".concat(index, ".isRecurring")} render={function (_a) {
                    var field = _a.field;
                    return (<form_1.FormItem className="flex flex-row items-center space-x-2">
                                <form_1.FormControl>
                          ...
                          <button_1.Button type="button" variant="outline" size="sm" onClick={function () { return removeHoliday(index); }} className="text-red-600 hover:text-red-800">
