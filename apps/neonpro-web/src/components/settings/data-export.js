...
function DataExport() {
    ...
    var _b = (0, react_1.useState)("export"), activeTab = _b[0], setActiveTab = _b[1];
    ...
    ]), exportHistory = _d[0], setExportHistory = _d[1];
    ...
    var selectedExportType = exportTypes.find(function (type) { return type.id === watchedExportType; });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    setExportHistory(function (prev) { return __spreadArray([newExport_1], prev, true); });
                    sonner_1.toast.success("Exportação iniciada! Você será notificado quando estiver pronta.");
                    form.reset();
                    return [3 /*break*/, 5];
                case 3:
                    error_1 = _a.sent();
    ...
    var filteredExportTypes = selectedCategory === "all"
        ? exportTypes
        : exportTypes.filter(function (type) { return type.category === selectedCategory; });
    ...
    var getExportTypeInfo = function (typeId) {
        return exportTypes.find(function (type) { return type.id === typeId; });
    };
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <card_1.Card>
                ...
                <card_1.CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {filteredExportTypes.map(function (exportType) { return (<div key={exportType.id} className={"border rounded-lg p-4 cursor-pointer transition-colors ".concat(watchedExportType === exportType.id
                ? "border-blue-500 bg-blue-50"
                : "border-gray-200 hover:border-gray-300")} onClick={function () { return form.setValue("exportType", exportType.id); }}>
                        <div className="flex items-start justify-between mb-2">
                          <h4 className="font-medium">{exportType.name}</h4>
                          <input type="radio" checked={watchedExportType === exportType.id} onChange={function () { return form.setValue("exportType", exportType.id); }} className="mt-1"/>
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {exportType.formats.map(function (format) { return (<badge_1.Badge key={format} variant="secondary" className="text-xs">
                                {format}
                              </badge_1.Badge>); })}
                          </div>
                        </div>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  <card_1.Card>
                    ...
                    <card_1.CardContent className="space-y-4">
                      {selectedExportType && (<div className="mb-4 p-3 bg-blue-50 rounded-lg">
                      ...
                      <form_1.FormField control={form.control} name="format" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                            ...
                            <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <select_1.SelectContent>
                                {selectedExportType === null || selectedExportType === void 0 ? void 0 : selectedExportType.formats.map(function (format) { return (<select_1.SelectItem key={format} value={format}>
                                    {format}
                                  </select_1.SelectItem>); })}
                              </select_1.SelectContent>
                            </select_1.Select>
                      ...
                      <form_1.FormField control={form.control} name="dateRange" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                            ...
                            <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <select_1.SelectContent>
                                {dateRanges.map(function (range) { return (<select_1.SelectItem key={range.value} value={range.value}>
                                    {range.label}
                                  </select_1.SelectItem>); })}
                              </select_1.SelectContent>
                            </select_1.Select>
                      ...
                      {watchedDateRange === "custom" && (<div className="grid grid-cols-2 gap-2">
                          <form_1.FormField control={form.control} name="startDate" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                          ...
                          <form_1.FormField control={form.control} name="endDate" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                      ...
                      <div className="space-y-4 border-t pt-4">
                        ...
                        <form_1.FormField control={form.control} name="anonymizeData" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between">
                              <div className="space-y-0.5">
                                <form_1.FormLabel className="text-sm">Anonimizar Dados</form_1.FormLabel>
                        ...
                        <form_1.FormField control={form.control} name="includeMetadata" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between">
                              <div className="space-y-0.5">
                                <form_1.FormLabel className="text-sm">Incluir Metadados</form_1.FormLabel>
                                <form_1.FormDescription className="text-xs">
                        ...
                        <form_1.FormField control={form.control} name="compressionEnabled" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between">
                              <div className="space-y-0.5">
                                <form_1.FormLabel className="text-sm">Compressão</form_1.FormLabel>
                                <form_1.FormDescription className="text-xs">
                        ...
                        <form_1.FormField control={form.control} name="passwordProtection" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-center justify-between">
                              <div className="space-y-0.5">
                                <form_1.FormLabel className="text-sm">Proteção por Senha</form_1.FormLabel>
                                <form_1.FormDescription className="text-xs">
                        ...
                        {watchedPasswordProtection && (<form_1.FormField control={form.control} name="password" render={function (_a) {
                var field = _a.field;
                return (<form_1.FormItem>
                                <form_1.FormLabel>Senha</form_1.FormLabel>
                                <form_1.FormControl>
                                  <input_1.Input type="password" placeholder="Mínimo 8 caracteres" {...field}/>
                                </form_1.FormControl>
                                <form_1.FormMessage />
                              </form_1.FormItem>);
            }}/>)}

                        <form_1.FormField control={form.control} name="notificationEmail" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                              <form_1.FormLabel>Email de Notificação</form_1.FormLabel>
                              <form_1.FormControl>
                                <input_1.Input type="email" placeholder="email@clinica.com.br" {...field}/>
                              </form_1.FormControl>
                              <form_1.FormDescription>
                      ...
                      <button_1.Button type="submit" disabled={!watchedExportType || isExporting} className="w-full">
                        {isExporting ? (<>
        ...
        <tabs_1.TabsContent value="history" className="space-y-6">
          <card_1.Card>
            ...
            <card_1.CardContent>
              {exportHistory.length === 0 ? (<div className="text-center p-8">
                ...
                return (<div key={exportItem.id} className="border rounded-lg p-4">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-3">
                            <lucide_react_1.FileText className="h-5 w-5 text-gray-400"/>
                            <div>
                              <h4 className="font-medium">
                                {(typeInfo === null || typeInfo === void 0 ? void 0 : typeInfo.name) || exportItem.type}
                              </h4>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {exportItem.status === "completed" && exportItem.downloadUrl && (<button_1.Button variant="outline" size="sm" onClick={function () { return downloadExport(exportItem); }}>
                        ...
                        <div className="flex items-center justify-between text-sm text-gray-600">
                          <div className="flex items-center gap-4">
                            ...
                            {exportItem.fileSize && (<span className="flex items-center gap-1">
                                <lucide_react_1.Database className="h-3 w-3"/>
                                {exportItem.fileSize}
                              </span>)}
                          </div>
                          {exportItem.expiresAt && (<span className="flex items-center gap-1 text-orange-600">
