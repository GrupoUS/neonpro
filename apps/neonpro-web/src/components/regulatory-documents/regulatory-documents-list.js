...
function RegulatoryDocumentsList(_a) {
  ...
  var _e = (0, use_regulatory_documents_1.useRegulatoryDocuments)({
    ...
    documents = _e.documents,
    loading = _e.loading,
    pagination = _e.pagination,
    loadMore = _e.loadMore,
    hasMore = _e.hasMore,
    deleteDocument = _e.deleteDocument;
            ...
            ? <card_1.Card>
                <card_1.CardContent className="pt-6">
                  <div className="text-center py-8">
                    ...
                    {onCreateDocument && (
                      <button_1.Button onClick={onCreateDocument}>
                            ...
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              {(isExpiring || isExpired) && (
                                <badge_1.Badge variant="destructive" className="gap-1">
                                  ...
                                  {isExpired ? "Expirado" : "".concat(daysUntilExpiration, " dias")}
                                </badge_1.Badge>
                              )}
                            </div>
