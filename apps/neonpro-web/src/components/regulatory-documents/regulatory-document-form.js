...
function RegulatoryDocumentForm(_a) {
    var _this = this;
    var document = _a.document, onSubmit = _a.onSubmit, onCancel = _a.onCancel, _b = _a.loading, loading = _b === void 0 ? false : _b;
    var _c = (0, react_1.useState)(null), uploadedFile = _c[0], setUploadedFile = _c[1];
    var _d = (0, react_1.useState)(false), uploading = _d[0], setUploading = _d[1];
    var _e = (0, use_regulatory_categories_1.useRegulatoryCategories)(), categories = _e.categories, authorities = _e.authorities, groupedCategories = _e.groupedCategories;
    var form = (0, react_hook_form_1.useForm)({
        resolver: (0, zod_1.zodResolver)(documentFormSchema),
        defaultValues: {
            document_type: (document === null || document === void 0 ? void 0 : document.document_type) || '',
            document_category: (document === null || document === void 0 ? void 0 : document.document_category) || '',
            authority: (document === null || document === void 0 ? void 0 : document.authority) || '',
            document_number: (document === null || document === void 0 ? void 0 : document.document_number) || '',
            issue_date: document ? new Date(document.issue_date) : undefined,
            expiration_date: (document === null || document === void 0 ? void 0 : document.expiration_date) ? new Date(document.expiration_date) : undefined,
            status: (document === null || document === void 0 ? void 0 : document.status) || 'pending',
            associated_professional_id: (document === null || document === void 0 ? void 0 : document.associated_professional_id) || '',
            associated_equipment_id: (document === null || document === void 0 ? void 0 : document.associated_equipment_id) || '',
        }
    });
    ...
    (0, react_1.useEffect)(function () {
        if (selectedCategory && categories.length > 0) {
            var category = categories.find(function (cat) { return cat.name === selectedCategory; });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch('/api/regulatory-documents/upload', {
                            method: 'POST',
                            body: formData,
                        })];
                case 2:
    ...
    var removeUploadedFile = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
    ...
    var handleSubmit = function (data) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    submitData = __assign(__assign({}, data), { issue_date: data.issue_date.toISOString().split('T')[0], expiration_date: (_a = data.expiration_date) === null || _a === void 0 ? void 0 : _a.toISOString().split('T')[0], file_url: uploadedFile === null || uploadedFile === void 0 ? void 0 : uploadedFile.url, file_name: uploadedFile === null || uploadedFile === void 0 ? void 0 : uploadedFile.name, file_size: uploadedFile === null || uploadedFile === void 0 ? void 0 : uploadedFile.size, 
                        // Remove empty strings
                        document_number: data.document_number || undefined, associated_professional_id: data.associated_professional_id || undefined, associated_equipment_id: data.associated_equipment_id || undefined });
        ...
        <form_1.Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Document Type */}
              <form_1.FormField control={form.control} name="document_type" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    <form_1.FormLabel>Tipo do Documento</form_1.FormLabel>
                    <form_1.FormControl>
                      <input_1.Input placeholder="Ex: Alvará Sanitário, Licença de Funcionamento" {...field}/>
                    </form_1.FormControl>
                    <form_1.FormMessage />
                  </form_1.FormItem>);
        }}/>
              ...
              {/* Category */}
              <form_1.FormField control={form.control} name="document_category" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    ...
                    var authority = _a[0], cats = _a[1];
                    return (<div key={authority}>
                            <div className="px-2 py-1.5 text-sm font-semibold text-muted-foreground">
                              {authority}
                            </div>
                            {cats.map(function (category) { return (<select_1.SelectItem key={category.id} value={category.name}>
                                {category.name}
                              </select_1.SelectItem>); })}
                          </div>);
                })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Authority */}
              <form_1.FormField control={form.control} name="authority" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    ...
                    <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <select_1.SelectContent>
                        {authorities.map(function (authority) { return (<select_1.SelectItem key={authority.authority_code} value={authority.authority_name}>
              ...
              {/* Document Number */}
              <form_1.FormField control={form.control} name="document_number" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Issue Date */}
              <form_1.FormField control={form.control} name="issue_date" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-col">
                      ...
                      <popover_1.PopoverTrigger asChild>
                        <form_1.FormControl>
                          <button_1.Button variant="outline" className={(0, utils_1.cn)("w-full pl-3 text-left font-normal", !field.value && "text-muted-foreground")}>
                            {field.value ? ((0, date_fns_1.format)(field.value, "PPP", { locale: locale_1.ptBR })) : (<span>Selecione a data</span>)}
              ...
              {/* Expiration Date */}
              <form_1.FormField control={form.control} name="expiration_date" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-col">
            ...
            <div className="space-y-4">
              ...
              {!uploadedFile ? (<div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-6">
                  <div className="flex flex-col items-center justify-center space-y-2">
                    <lucide_react_1.Upload className="h-8 w-8 text-muted-foreground"/>
                    <div className="text-center">
                      <label_1.Label htmlFor="file-upload" className="cursor-pointer text-sm font-medium text-primary hover:text-primary/80">
                    ...
                    <input_1.Input id="file-upload" type="file" className="hidden" accept=".pdf,.jpg,.jpeg,.png,.webp,.doc,.docx" onChange={handleFileUpload} disabled={uploading}/>
                  </div>
                  {uploading && (<div className="mt-4 text-center">
                      <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-primary mx-auto"></div>
                      <p className="text-sm text-muted-foreground mt-2">Fazendo upload...</p>
                    </div>)}
                </div>) : (<div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                  ...
                  <button_1.Button type="button" variant="outline" size="sm" onClick={removeUploadedFile} className="gap-1">
            ...
            <div className="flex items-center justify-end space-x-4 pt-6">
              <button_1.Button type="button" variant="outline" onClick={onCancel} disabled={loading}>
                Cancelar
              </button_1.Button>
              <button_1.Button type="submit" disabled={loading || uploading} className="min-w-[120px]">
