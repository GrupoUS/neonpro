...
function RegulatoryDocumentsListSkeleton() {
    return (<div className="space-y-4" data-testid="loading-skeleton">
      ...
      <div className="grid gap-4">
        {Array.from({ length: 3 }).map(function (_, i) { return (<div key={i} className="border rounded-lg p-4 space-y-3">
            <div className="flex items-center justify-between">
