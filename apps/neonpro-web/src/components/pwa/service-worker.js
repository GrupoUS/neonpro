...
function PWAServiceWorker() {
    ...
    (0, react_1.useEffect)(function () {
        ...
        setState(function (prev) { return (__assign(__assign({}, prev), { isSupported: true })); });
        // Register Service Worker
        var registerServiceWorker = function () { return __awaiter(_this, void 0, void 0, function () {
            var registration_1, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        setState(function (prev) { return (__assign(__assign({}, prev), { isInstalling: true })); });
                    ...
                    case 1:
                        ...
                        setState(function (prev) { return (__assign(__assign({}, prev), { isRegistered: true, isInstalling: false, registration: registration_1 })); });
                            ...
                            if (newWorker) {
                                newWorker.addEventListener('statechange', function () {
                                    if (newWorker.state === 'installed' && navigator.serviceWorker.controller) {
                                        ...
                                        setState(function (prev) { return (__assign(__assign({}, prev), { isWaitingUpdate: true })); });
                        ...
                        navigator.serviceWorker.addEventListener('message', function (event) {
                            if (event.data && event.data.type === 'BACKGROUND_SYNC') {
                                var _a = event.data, success = _a.success, failed = _a.failed, total = _a.total;
                                if (success > 0) {
                                    sonner_1.toast.success("".concat(success, " a\u00E7\u00F5es sincronizadas com sucesso"));
                                }
                                if (failed > 0) {
                                    sonner_1.toast.error("".concat(failed, " a\u00E7\u00F5es falharam na sincroniza\u00E7\u00E3o"));
                                }
                                console.log("\uD83D\uDCE1 Background sync completed: ".concat(success, "/").concat(total, " successful"));
                            }
                        });
                    ...
                    case 2:
                        ...
                        setState(function (prev) { return (__assign(__assign({}, prev), { isInstalling: false })); });
...
function PWAInstallPrompt() {
    var _this = this;
    var _a = (0, react_1.useState)(null), installPrompt = _a[0], setInstallPrompt = _a[1];
    var _b = (0, react_1.useState)(false), isInstalled = _b[0], setIsInstalled = _b[1];
    (0, react_1.useEffect)(function () {
