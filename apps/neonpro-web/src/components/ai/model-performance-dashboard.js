...
function ModelPerformanceDashboard(_a) {
  ...
  var _c = _a.className,
    ...
    _d = _a.showABStats,
    showABStats = _d === void 0 ? true : _d,
    _e = _a.allowModelManagement,
    allowModelManagement = _e === void 0 ? false : _e;
  // State
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch("/api/ai/model-performance", {
                method: "POST",
          ...
          case 5:
            ...
            sonner_1.toast.error("Failed to update model performance", {
  ...
  return (
    <div className={"space-y-6 ".concat(className)}>
      ...
      <tabs_1.Tabs defaultValue="overview" className="space-y-4">
        ...
        {/* A/B Testing Tab */}
        {showABStats && (data === null || data === void 0 ? void 0 : data.abTestStats) && (
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <card_1.Card>
                ...
                <card_1.CardContent>
                  ...
                  <progress_1.Progress
                    value={data.abTestStats.split_percentage.control}
                    className="mt-2"
                  />
                  <p className="text-xs text-muted-foreground mt-2">
