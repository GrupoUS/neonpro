...
function AIDurationPrediction(_a) {
  var appointmentId = _a.appointmentId,
    ...
    _b = _a.isFirstVisit,
    isFirstVisit = _b === void 0 ? false : _b,
    historicalDuration = _a.historicalDuration,
    onDurationSelected = _a.onDurationSelected,
    onOverride = _a.onOverride,
    _c = _a.className,
  ...
  var _g = (0, react_1.useState)(0),
    manualDuration = _g[0],
    setManualDuration = _g[1];
  var _h = (0, react_1.useState)(""),
    overrideReason = _h[0],
    setOverrideReason = _h[1];
  var _j = (0, react_1.useState)(false),
    useManualOverride = _j[0],
    setUseManualOverride = _j[1];
  var _k = (0, react_1.useState)(false),
    showAdvancedOptions = _k[0],
    setShowAdvancedOptions = _k[1];
  // Advanced options state
  var _l = (0, react_1.useState)("medium"),
    anxietyLevel = _l[0],
    setAnxietyLevel = _l[1];
  var _m = (0, react_1.useState)("standard"),
    treatmentComplexity = _m[0],
    setTreatmentComplexity = _m[1];
  var _o = (0, react_1.useState)(""),
    specialRequirements = _o[0],
    setSpecialRequirements = _o[1];
          ...
          case 3:
            ...
            if (data.prediction) {
              ...
              if (data.prediction.confidenceScore >= 0.8 && !useManualOverride) {
                onDurationSelected(
                  data.prediction.predictedDuration,
                  data.prediction.isAIPrediction,
                );
              }
            }
            return [3 /*break*/, 6];
  ...
  var handleDurationSelect = () => {
    ...
    var isAI =
      !useManualOverride &&
      (prediction === null || prediction === void 0 ? void 0 : prediction.isAIPrediction);
    ...
    sonner_1.toast.success("Duration selected", {
      description: ""
        .concat(selectedDuration, " minutes ")
        .concat(isAI ? "(AI prediction)" : "(manual)"),
    });
  };
  /**
        ...
        >
          {loading
            ...
            : "Select ".concat(
                useManualOverride
                  ? manualDuration
                  : (prediction === null || prediction === void 0
                      ? void 0
