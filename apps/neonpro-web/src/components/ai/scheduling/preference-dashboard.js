...
function PatientPreferenceDashboard() {
  ...
  var _f = (0, react_1.useState)(null),
    confidenceMetrics = _f[0],
    setConfidenceMetrics = _f[1];
  var _g = (0, react_1.useState)(null),
    learnedPatterns = _g[0],
    setLearnedPatterns = _g[1];
  var _h = (0, react_1.useState)([]),
    learningHistory = _h[0],
    setLearningHistory = _h[1];
  var _j = (0, react_1.useState)(false),
    isUpdatingPreferences = _j[0],
    setIsUpdatingPreferences = _j[1];
  var _k = (0, react_1.useState)(null),
    updateError = _k[0],
    setUpdateError = _k[1];
  var _l = (0, react_1.useState)(false),
    updateSuccess = _l[0],
    setUpdateSuccess = _l[1];
  var loadPatientPreferences = function () {
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch(
                "/api/ai/scheduling/preferences?patient_id="
                  .concat(patientId, "&include_history=")
                  .concat(includeHistory),
              ),
            ];
          case 2:
            response = _a.sent();
  ...
  var updatePatientPreferences = function (learningData) {
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch("/api/ai/scheduling/preferences", {
                method: "POST",
                headers: {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label_1.Label htmlFor="include-history" className="text-sm">
            ...
            <div className="space-y-2">
              ...
              <button_1.Button
                onClick={loadPatientPreferences}
                disabled={isLoading}
                className="w-full"
              >
          ...
          {updateSuccess && (
            <alert_1.Alert className="border-green-200 bg-green-50">
              <alert_1.AlertDescription>
                Patient preferences updated successfully!
              </alert_1.AlertDescription>
            </alert_1.Alert>
          )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={"text-sm font-bold ".concat(
                        getConfidenceColor(confidenceMetrics.overall_confidence),
                      )}
                    >
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={"text-sm font-bold ".concat(
                        getConfidenceColor(confidenceMetrics.preference_reliability),
                      )}
                    >
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={"text-sm font-bold ".concat(
                        getConfidenceColor(confidenceMetrics.data_completeness),
                      )}
                    >
            ...
            <card_1.CardContent>
              <tabs_1.Tabs defaultValue="time" className="space-y-4">
                ...
                <tabs_1.TabsContent value="time" className="space-y-3">
                  {learnedPatterns.time_preferences.map(function (pattern, index) {
                    return (
                      <div
                        key={index}
                ...
                <tabs_1.TabsContent value="staff" className="space-y-3">
                  {learnedPatterns.staff_preferences.map(function (staff, index) {
                    return (
                      <div
                        key={index}
                        className="flex justify-between items-center p-3 bg-gray-50 rounded-lg"
                ...
                <tabs_1.TabsContent value="treatment" className="space-y-3">
                  {learnedPatterns.treatment_preferences.map(function (treatment, index) {
                    return (
                      <div
                        key={index}
                        className="flex justify-between items-center p-3 bg-gray-50 rounded-lg"
                ...
                <tabs_1.TabsContent value="behavior" className="space-y-3">
                  {learnedPatterns.scheduling_behaviors.map(function (behavior, index) {
                    return (
                      <div
                        key={index}
                        className="flex justify-between items-center p-3 bg-gray-50 rounded-lg"
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-3 max-h-64 overflow-y-auto">
                  {learningHistory.map(function (entry, index) {
                    return (
                      <div
                        key={index}
