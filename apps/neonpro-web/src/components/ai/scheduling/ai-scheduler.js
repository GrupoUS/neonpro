...
function AISchedulingOptimizer() {
    ...
    var _b = (0, react_1.useState)(''), treatmentType = _b[0], setTreatmentType = _b[1];
    var _c = (0, react_1.useState)(''), preferredDateStart = _c[0], setPreferredDateStart = _c[1];
    var _d = (0, react_1.useState)(''), preferredDateEnd = _d[0], setPreferredDateEnd = _d[1];
    var _e = (0, react_1.useState)('60'), durationMinutes = _e[0], setDurationMinutes = _e[1];
    var _f = (0, react_1.useState)(''), staffPreference = _f[0], setStaffPreference = _f[1];
    var _g = (0, react_1.useState)('normal'), priority = _g[0], setPriority = _g[1];
    var _h = (0, react_1.useState)(false), isLoading = _h[0], setIsLoading = _h[1];
    var _j = (0, react_1.useState)(null), error = _j[0], setError = _j[1];
    var _k = (0, react_1.useState)([]), optimizedSlots = _k[0], setOptimizedSlots = _k[1];
    var _l = (0, react_1.useState)(null), metadata = _l[0], setMetadata = _l[1];
    var _m = (0, react_1.useState)([]), recommendations = _m[0], setRecommendations = _m[1];
    var handleOptimizeScheduling = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch('/api/ai/scheduling/optimize', {
                            method: 'POST',
                            headers: {
    ...
    return (<div className="space-y-6">
        ...
        <card_1.CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <input_1.Input id="date-start" type="datetime-local" value={preferredDateStart} onChange={function (e) { return setPreferredDateStart(e.target.value); }}/>
            </div>
            <div className="space-y-2">
              <label_1.Label htmlFor="date-end">Preferred End Date</label_1.Label>
              <input_1.Input id="date-end" type="datetime-local" value={preferredDateEnd} onChange={function (e) { return setPreferredDateEnd(e.target.value); }}/>
            </div>
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input_1.Input id="staff-preference" value={staffPreference} onChange={function (e) { return setStaffPreference(e.target.value); }} placeholder="Enter preferred staff ID"/>
            </div>
            <div className="space-y-2">
          ...
          <button_1.Button onClick={handleOptimizeScheduling} disabled={isLoading} className="w-full">
      ...
      {optimizedSlots.length > 0 && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center gap-2">
          ...
          <card_1.CardContent className="space-y-4">
            {/* Metadata Summary */}
            {metadata && (<div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="space-y-3">
              {optimizedSlots.map(function (slot, index) { return (<card_1.Card key={slot.slot_id} className="border-l-4 border-l-blue-500">
                  <card_1.CardContent className="p-4">
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center gap-3">
                        <badge_1.Badge className={"".concat(getConfidenceColor(slot.confidence_score))}>
                          {Math.round(slot.confidence_score * 100)}% Confidence
                        </badge_1.Badge>
                        {index === 0 && (<badge_1.Badge className="bg-blue-100 text-blue-800">AI Recommended</badge_1.Badge>)}
                      </div>
                    ...
                    {slot.reasons.length > 0 && (<div className="text-sm text-gray-600">
            ...
            {/* AI Recommendations */}
            {recommendations.length > 0 && (<card_1.Card className="bg-blue-50 border-blue-200">
                <card_1.CardContent className="p-4">
                  ...
                  <ul className="text-sm space-y-1 text-blue-800">
                    {recommendations.map(function (rec, index) { return (<li key={index} className="flex items-start gap-2">
                        <span>•</span>
                        <span>{rec}</span>
                      </li>); })}
                  </ul>
