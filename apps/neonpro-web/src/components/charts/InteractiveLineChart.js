...
function InteractiveLineChart(_a) {
    var title = _a.title, data = _a.data, lines = _a.lines, _b = _a.height, height = _b === void 0 ? 350 : _b, className = _a.className, _c = _a.xAxisDataKey, xAxisDataKey = _c === void 0 ? 'name' : _c, _d = _a.showGrid, showGrid = _d === void 0 ? true : _d, _e = _a.showLegend, showLegend = _e === void 0 ? true : _e, formatTooltip = _a.formatTooltip, formatXAxisLabel = _a.formatXAxisLabel, formatYAxisLabel = _a.formatYAxisLabel;
      ...
      <card_1.CardContent>
        <recharts_1.ResponsiveContainer width="100%" height={height}>
          <recharts_1.LineChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            {lines.map(function (line) { return (<recharts_1.Line key={line.dataKey} type="monotone" dataKey={line.dataKey} stroke={line.color} strokeWidth={line.strokeWidth || 2} name={line.name} dot={{ r: 4 }} activeDot={{ r: 6 }}/>); })}
