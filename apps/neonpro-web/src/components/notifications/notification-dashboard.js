...
function NotificationDashboard() {
    ...
    var _c = (0, react_1.useState)([]), channelStatus = _c[0], setChannelStatus = _c[1];
    var _d = (0, react_1.useState)([]), templates = _d[0], setTemplates = _d[1];
    var _e = (0, react_1.useState)([]), deliveries = _e[0], setDeliveries = _e[1];
    var _f = (0, react_1.useState)([]), automationRules = _f[0], setAutomationRules = _f[1];
    var _g = (0, react_1.useState)(true), loading = _g[0], setLoading = _g[1];
    var _h = (0, react_1.useState)(''), searchTerm = _h[0], setSearchTerm = _h[1];
    var _j = (0, react_1.useState)('all'), filterChannel = _j[0], setFilterChannel = _j[1];
    ...
    var getStatusBadge = function (status) {
        switch (status) {
            case types_1.DeliveryStatus.SENT:
                return <badge_1.Badge variant="outline" className="text-blue-600">Enviado</badge_1.Badge>;
            case types_1.DeliveryStatus.DELIVERED:
                return <badge_1.Badge variant="outline" className="text-green-600">Entregue</badge_1.Badge>;
    ...
    var renderOverview = function () { return (<div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">{stats === null || stats === void 0 ? void 0 : stats.total.toLocaleString()}</div>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold text-red-600">{stats === null || stats === void 0 ? void 0 : stats.failed}</div>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold text-orange-600">{stats === null || stats === void 0 ? void 0 : stats.pending}</div>
      ...
      <card_1.Card>
        <card_1.CardHeader>
          ...
          <card_1.CardDescription>Monitoramento em tempo real dos canais de notificação</card_1.CardDescription>
        </card_1.CardHeader>
        <card_1.CardContent>
          <div className="space-y-4">
            {channelStatus.map(function (channel) { return (<div key={channel.channel} className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className={"w-3 h-3 rounded-full ".concat(channel.healthy ? 'bg-green-500' : 'bg-red-500')}/>
                  </div>
                </div>
              </div>); })}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="space-y-3">
              {stats && Object.entries(stats.channels).map(function (_a) {
            var channel = _a[0], count = _a[1];
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="space-y-3">
              {stats && Object.entries(stats.types).map(function (_a) {
    ...
    var renderTemplates = function () { return (<div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {templates.map(function (template) { return (<card_1.Card key={template.id}>
            ...
            <card_1.CardContent>
              <div className="space-y-3">
                <div>
                  <label_1.Label className="text-xs text-muted-foreground">CANAIS</label_1.Label>
                  <div className="flex space-x-1 mt-1">
                    {template.channels.map(function (channel) { return (<badge_1.Badge key={channel} variant="outline" className="text-xs">
                ...
                <div>
                  <label_1.Label className="text-xs text-muted-foreground">ASSUNTO</label_1.Label>
                  <p className="text-sm mt-1 truncate">{template.subject}</p>
                </div>
                
                <div>
                  <label_1.Label className="text-xs text-muted-foreground">VARIÁVEIS</label_1.Label>
    ...
    var renderDeliveries = function () { return (<div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
      ...
      <div className="flex space-x-4">
        <input_1.Input placeholder="Buscar por destinatário..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="max-w-sm"/>
            ...
            <table className="w-full">
              ...
              <tbody>
                ...
                <tr className="border-b">
                  ...
                  <td className="p-4">
                    {getStatusBadge(types_1.DeliveryStatus.DELIVERED)}
                  </td>
                  <td className="p-4">
    ...
    var renderAutomation = function () { return (<div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
