...
function NotificationDashboard() {
  ...
  var _f = (0, react_1.useState)([]),
    channelPerformance = _f[0],
    setChannelPerformance = _f[1];
  var _g = (0, react_1.useState)([]),
    patientEngagement = _g[0],
    setPatientEngagement = _g[1];
  var _h = (0, react_1.useState)([]),
    escalationRules = _h[0],
    setEscalationRules = _h[1];
  var _j = (0, react_1.useState)("week"),
    selectedPeriod = _j[0],
    setSelectedPeriod = _j[1];
  var _k = (0, react_1.useState)(null),
    selectedTemplate = _k[0],
    setSelectedTemplate = _k[1];
  var _l = (0, react_1.useState)(false),
    isTemplateDialogOpen = _l[0],
    setIsTemplateDialogOpen = _l[1];
  var _m = (0, react_1.useState)(false),
    isRuleDialogOpen = _m[0],
    setIsRuleDialogOpen = _m[1];
  var _o = (0, react_1.useState)(""),
    searchQuery = _o[0],
    setSearchQuery = _o[1];
  var _p = (0, react_1.useState)("all"),
    filterChannel = _p[0],
    setFilterChannel = _p[1];
          ...
          case 1:
            ...
            engagement = data.map(function (record) {
              ...
              return {
                ...
                patientName:
                  ((_a = record.patient) === null || _a === void 0 ? void 0 : _a.name) || "N/A",
          ...
          case 1:
            ...
            rules = data.map(function (rule) {
              ...
              return __assign(__assign({}, rule), {
                targetUserName:
                  ((_a = rule.target_user) === null || _a === void 0 ? void 0 : _a.email) || "N/A",
              });
            });
  ...
  var getChannelIcon = function (channel) {
    switch (channel) {
      ...
      default:
        return <lucide_react_1.Send className="h-4 w-4" />;
    }
  };
  /**
  ...
  var getPerformanceBadge = function (rate) {
    ...
    if (rate >= 50)
      return (
        <badge_1.Badge variant="default" className="bg-yellow-500">
          Regular
        </badge_1.Badge>
      );
        ...
        <tabs_1.TabsContent value="overview" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Taxa de entrega dos últimos 7 dias</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>Performance detalhada de cada canal</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <card_1.CardDescription>
                          ...
                          {(_a = template.successRate) === null || _a === void 0
                            ? void 0
                            : _a.toFixed(1)}
                          % sucesso
                        </card_1.CardDescription>
                  ...
                  <card_1.CardContent>
                    <div className="space-y-2">
                      <p className="text-sm">
                        ...
                        {((_a = rule.template) === null || _a === void 0 ? void 0 : _a.name) ||
                          "N/A"}
                      </p>
                      <p className="text-sm">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Configurações globais do sistema</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
                <div className="space-y-4">
