...
function StockAlertsManagement(_a) {
  ...
  var _d = (0, react_1.useState)(true),
    isLoading = _d[0],
    setIsLoading = _d[1];
  var _e = (0, react_1.useState)("alerts"),
    selectedTab = _e[0],
    setSelectedTab = _e[1];
  var _f = (0, react_1.useState)("all"),
    filterSeverity = _f[0],
    setFilterSeverity = _f[1];
  ...
  var _j = (0, react_1.useState)(false),
    showConfigDialog = _j[0],
    setShowConfigDialog = _j[1];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              Promise.all([fetch("/api/stock/alerts"), fetch("/api/stock/alerts/configs")]),
            ];
          case 2:
