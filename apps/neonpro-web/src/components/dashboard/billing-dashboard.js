...
function BillingDashboard() {
    ...
    var _b = (0, use_billing_1.useBilling)(), loading = _b.loading, financialSummary = _b.financialSummary, invoices = _b.invoices, payments = _b.payments, services = _b.services;
    ...
    var totalRevenue = (financialSummary === null || financialSummary === void 0 ? void 0 : financialSummary.total_revenue) || 0;
    var pendingAmount = invoices
        .filter(function (inv) { return ["pending", "overdue"].includes(inv.status); })
    ...
    var conversionRate = invoices.length > 0
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="text-2xl font-bold">
                  {invoices.length > 0
            ? formatCurrency(totalRevenue /
                invoices.filter(function (inv) { return inv.status === "paid"; })
                    .length || 1)
            : formatCurrency(0)}
                </div>
                <p className="text-xs text-muted-foreground">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                {invoices.slice(0, 5).map(function (invoice) { return (<div key={invoice.id} className="flex items-center justify-between">
                    <div>
                ...
                {invoices.length === 0 && (<p className="text-center text-muted-foreground py-4">
            ...
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                {payments.slice(0, 5).map(function (payment) { return (<div key={payment.id} className="flex items-center justify-between">
                    <div>
                ...
                {payments.length === 0 && (<p className="text-center text-muted-foreground py-4">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {services.slice(0, 5).map(function (service, index) { return (<div key={service.id} className="flex items-center justify-between">
                ...
                {services.length === 0 && (<p className="text-center text-muted-foreground py-4">
