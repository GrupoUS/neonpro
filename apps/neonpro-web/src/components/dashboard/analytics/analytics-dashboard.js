...
function AnalyticsDashboard() {
    var _a = (0, react_1.useState)(false), showExportModal = _a[0], setShowExportModal = _a[1];
    return (<div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button_1.Button onClick={function () { return setShowExportModal(true); }} className="bg-blue-600 hover:bg-blue-700">
          📊 Exportar Relatório
        </button_1.Button>
      </div>
      ...
      <tabs_1.Tabs defaultValue="clinical" className="space-y-4">
        ...
        <tabs_1.TabsContent value="clinical" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <kpi_card_1.KPICard title="Satisfação do Paciente" value={kpiData.clinical.patientSatisfaction.value} change={kpiData.clinical.patientSatisfaction.change} trend={kpiData.clinical.patientSatisfaction.trend} format="percentage" icon="😊"/>
            <kpi_card_1.KPICard title="Taxa de Conclusão" value={kpiData.clinical.appointmentCompletion.value} change={kpiData.clinical.appointmentCompletion.change} trend={kpiData.clinical.appointmentCompletion.trend} format="percentage" icon="✅"/>
            <kpi_card_1.KPICard title="Sucesso dos Tratamentos" value={kpiData.clinical.treatmentSuccess.value} change={kpiData.clinical.treatmentSuccess.change} trend={kpiData.clinical.treatmentSuccess.trend} format="percentage" icon="🎯"/>
            <kpi_card_1.KPICard title="Adesão ao Follow-up" value={kpiData.clinical.followUpAdherence.value} change={kpiData.clinical.followUpAdherence.change} trend={kpiData.clinical.followUpAdherence.trend} format="percentage" icon="📋"/>
          </div>
        ...
        <tabs_1.TabsContent value="operational" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <kpi_card_1.KPICard title="Tempo Médio de Espera" value={kpiData.operational.averageWaitTime.value} change={kpiData.operational.averageWaitTime.change} trend={kpiData.operational.averageWaitTime.trend} format="time" icon="⏱️"/>
            <kpi_card_1.KPICard title="Utilização da Equipe" value={kpiData.operational.staffUtilization.value} change={kpiData.operational.staffUtilization.change} trend={kpiData.operational.staffUtilization.trend} format="percentage" icon="👥"/>
            <kpi_card_1.KPICard title="Eficiência dos Agendamentos" value={kpiData.operational.appointmentEfficiency.value} change={kpiData.operational.appointmentEfficiency.change} trend={kpiData.operational.appointmentEfficiency.trend} format="percentage" icon="📅"/>
            <kpi_card_1.KPICard title="Utilização de Recursos" value={kpiData.operational.resourceUtilization.value} change={kpiData.operational.resourceUtilization.change} trend={kpiData.operational.resourceUtilization.trend} format="percentage" icon="🏥"/>
          </div>
        ...
        <tabs_1.TabsContent value="financial" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <kpi_card_1.KPICard title="Receita Mensal" value={kpiData.financial.monthlyRevenue.value} change={kpiData.financial.monthlyRevenue.change} trend={kpiData.financial.monthlyRevenue.trend} format="currency" icon="💰"/>
            <kpi_card_1.KPICard title="Receita por Paciente" value={kpiData.financial.revenuePerPatient.value} change={kpiData.financial.revenuePerPatient.change} trend={kpiData.financial.revenuePerPatient.trend} format="currency" icon="👤"/>
            <kpi_card_1.KPICard title="Custo por Aquisição" value={kpiData.financial.costPerAcquisition.value} change={kpiData.financial.costPerAcquisition.change} trend={kpiData.financial.costPerAcquisition.trend} format="currency" icon="📈"/>
            <kpi_card_1.KPICard title="Margem de Lucro" value={kpiData.financial.profitMargin.value} change={kpiData.financial.profitMargin.change} trend={kpiData.financial.profitMargin.trend} format="percentage" icon="📊"/>
          </div>
      ...
      <export_modal_1.ExportModal open={showExportModal} onClose={function () { return setShowExportModal(false); }} data={{
            kpis: kpiData,
            charts: {},
            activeTab: "clinical",
        }}/>
