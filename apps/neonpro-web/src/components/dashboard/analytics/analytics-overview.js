...
function AnalyticsOverview(_a) {
    var _this = this;
    var className = _a.className, _b = _a.refreshInterval, refreshInterval = _b === void 0 ? 30000 : _b;
    ...
    var generateKPIs = function (data) { return [
        {
            id: 'total-trials',
            title: 'Total Trials',
    ...
    if (loading) {
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 6 }).map(function (_, i) { return (<card_1.Card key={i} className="animate-pulse">
