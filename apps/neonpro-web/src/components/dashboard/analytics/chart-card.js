...
function ChartCard(_a) {
    var title = _a.title, description = _a.description, children = _a.children, _b = _a.className, className = _b === void 0 ? "" : _b;
    return (<card_1.Card className={"hover:shadow-lg transition-shadow duration-200 ".concat(className)}>
      <card_1.CardHeader>
        ...
        {description && (<card_1.CardDescription className="text-sm text-muted-foreground">
            {description}
