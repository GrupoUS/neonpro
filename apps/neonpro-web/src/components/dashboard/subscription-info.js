...
function SubscriptionInfo() {
    ...
    var loadSubscriptionData = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    if (!subscription) {
        return (<card_1.Card className="border-yellow-200 bg-yellow-50">
        <card_1.CardHeader>
    ...
    return (<card_1.Card>
      ...
      <card_1.CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          {subscription.max_patients && (<div className="flex items-center gap-2">
          ...
          {subscription.max_clinics && (<div className="flex items-center gap-2">
        ...
        {subscription.cancel_at_period_end && (<div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
            <div className="flex items-center gap-2">
        ...
        {daysUntilRenewal <= 7 && !subscription.cancel_at_period_end && (<div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <div className="flex items-center gap-2">
