...
function PatientProfileEditForm(_a) {
    var _this = this;
    var patientId = _a.patientId, initialData = _a.initialData, onSuccess = _a.onSuccess, onCancel = _a.onCancel;
    var _b = (0, react_1.useState)(false), isSubmitting = _b[0], setIsSubmitting = _b[1];
    var _c = (0, react_1.useState)(false), showLgpdInfo = _c[0], setShowLgpdInfo = _c[1];
    var _d = (0, use_lgpd_consent_1.useLgpdConsent)(), recordConsent = _d.recordConsent, updateConsent = _d.updateConsent, logDataModification = _d.logDataModification, checkConsentValidity = _d.checkConsentValidity, consentLoading = _d.isLoading;
    var form = (0, react_hook_form_1.useForm)({
        resolver: (0, zod_1.zodResolver)(patient_profile_1.PatientProfileSchema),
        defaultValues: __assign({ fullName: '', dateOfBirth: '', gender: 'prefer_not_to_say', cpf: '', rg: '', phone: '', mobile: '', email: '', address: {
                street: '',
                number: '',
                complement: '',
                neighborhood: '',
    ...
    }), emergencyContactFields = _e.fields, addEmergencyContact = _e.append, removeEmergencyContact = _e.remove;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!data.lgpdConsent.dataProcessingConsent || !data.lgpdConsent.sensitiveDataConsent) {
                        sonner_1.toast.error('Consentimento LGPD é obrigatório para processar dados de saúde');
                        setShowLgpdInfo(true);
                        return [2 /*return*/];
                    }
                    modifiedFields = Object.keys(data);
                    return [4 /*yield*/, logDataModification(patientId, modifiedFields, 'update')
                        // Submit profile data
                    ];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, fetch("/api/patients/".concat(patientId, "/profile"), {
                            method: 'PUT',
                            headers: {
    ...
    return (<div className="space-y-6">
      ...
      {showLgpdInfo && (<card_1.Card className="border-orange-200 bg-orange-50">
          <card_1.CardHeader>
            <div className="flex items-center gap-2">
              <lucide_react_1.Shield className="h-5 w-5 text-orange-600"/>
              <card_1.CardTitle className="text-orange-800">Informações sobre LGPD</card_1.CardTitle>
            </div>
          ...
          <card_1.CardContent>
            <div className="flex items-center gap-4">
              <button_1.Button variant="outline" size="sm" onClick={function () { return setShowLgpdInfo(false); }}>
                Entendi
              </button_1.Button>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <tabs_1.Tabs defaultValue="personal" className="w-full">
              ...
              <card_1.CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input_1.Input id="fullName" {...form.register('fullName')} placeholder="Digite o nome completo"/>
                    {form.formState.errors.fullName && (<p className="text-sm text-red-600">
                  ...
                  <div className="space-y-2">
                    ...
                    {form.formState.errors.dateOfBirth && (<p className="text-sm text-red-600">
              ...
              <card_1.CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input_1.Input id="email" type="email" {...form.register('email')} placeholder="exemplo@email.com"/>
                    {form.formState.errors.email && (<p className="text-sm text-red-600">
                  ...
                  <div className="space-y-2">
                    ...
                    <input_1.Input id="phone" {...form.register('phone')} placeholder="(11) 99999-9999"/>
                  </div>
                </div>
              </card_1.CardContent>
            </card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input_1.Input id="street" {...form.register('address.street')} placeholder="Nome da rua"/>
                  </div>
                  
                  <div className="space-y-2">
                    <label_1.Label htmlFor="city">Cidade</label_1.Label>
                    <input_1.Input id="city" {...form.register('address.city')} placeholder="Nome da cidade"/>
                  </div>
                </div>
              </card_1.CardContent>
            </card_1.Card>
          ...
          <tabs_1.TabsContent value="emergency">
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                <button_1.Button type="button" variant="outline" onClick={handleAddEmergencyContact} className="w-full">
              ...
              <card_1.CardContent className="space-y-4">
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <react_hook_form_1.Controller name="lgpdConsent.dataProcessingConsent" control={form.control} render={function (_a) {
            var field = _a.field;
            return (<checkbox_1.Checkbox id="dataProcessingConsent" checked={field.value} onCheckedChange={field.onChange}/>);
        }}/>
        ...
        <div className="flex justify-end gap-4">
          <button_1.Button type="button" variant="outline" onClick={onCancel} disabled={isSubmitting}>
            Cancelar
          </button_1.Button>
