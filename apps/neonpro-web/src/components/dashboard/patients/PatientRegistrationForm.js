                ...
                render={(_a) => {
                  ...
                  return (
                    <form_1.FormItem>
                      ...
                      <form_1.FormControl>
                        <input_1.Input
                          placeholder="How the patient likes to be called"
                          {...field}
                        />
                      </form_1.FormControl>
                      <form_1.FormMessage />
                ...
                render={(_a) => {
                  ...
                  return (
                    <form_1.FormItem>
                      ...
                      <form_1.FormDescription>Brazilian general registry</form_1.FormDescription>
                      <form_1.FormMessage />
                    </form_1.FormItem>
                  );
                }}
                    ...
                    <form_1.FormItem>
                      ...
                      <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <select_1.SelectContent>
                          ...
                          <select_1.SelectItem value="unknown">
                            Prefer not to say
                          </select_1.SelectItem>
                        </select_1.SelectContent>
                      </select_1.Select>
                    ...
                    <form_1.FormItem>
                      ...
                      <select_1.Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <select_1.SelectContent>
                          ...
                          <select_1.SelectItem value="domestic_partner">
                            Domestic Partner
                          </select_1.SelectItem>
                ...
                render={(_a) => {
                  ...
                  return (
                    <form_1.FormItem>
                      ...
                      <form_1.FormDescription>Alternative contact number</form_1.FormDescription>
                      <form_1.FormMessage />
                    </form_1.FormItem>
                  );
                }}
                ...
                render={(_a) => {
                  ...
                  return (
                    <form_1.FormItem>
                      ...
                      <form_1.FormDescription>Two-letter state code</form_1.FormDescription>
                      <form_1.FormMessage />
                    </form_1.FormItem>
                  );
                }}
                ...
                render={(_a) => {
                  ...
                  return (
                    <form_1.FormItem>
                      ...
                      <form_1.FormDescription>Brazilian postal code</form_1.FormDescription>
                      <form_1.FormMessage />
                    </form_1.FormItem>
                  );
                }}
                  ...
                  return (
                    <form_1.FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <form_1.FormDescription className="text-xs">
                          I consent to sharing my data with healthcare partners, insurance
                          providers, and authorized third parties for care coordination.
                          <strong>Legal basis:</strong> LGPD Article 7, Item I.
