...
describe('PatientRegistrationForm', function () {
    ...
    describe('LGPD Consent Management', function () {
        it('requires basic consent to submit form', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('Nome Completo'), 'João Silva')];
                    case 1:
                        // Fill form without basic consent
                        _a.sent();
        ...
        it('allows submission when basic consent is provided', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('properly handles optional consents', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Field Validation', function () {
        it('validates CPF format', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, cpfInput;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('validates phone format', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, phoneInput;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('validates birth date is not in future', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('validates CEP format', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, cepInput;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('FHIR Compliance', function () {
        it('includes all required FHIR Patient resource fields', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('Nome Completo'), 'João Silva Santos')];
                    case 1:
                        // Fill FHIR-required fields
                        _a.sent();
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('CPF'), '12345678901')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('Data de Nascimento'), '1990-01-15')];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, user.selectOptions(react_1.screen.getByLabelText('Sexo'), 'male')];
                    case 4:
                        _a.sent();
    ...
    describe('Form Submission', function () {
        var fillValidForm = function (user) { return __awaiter(void 0, void 0, void 0, function () {
            var basicConsentCheckbox;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user.type(react_1.screen.getByLabelText('Nome Completo'), 'João Silva Santos')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('CPF'), '12345678901')];
                    case 2:
                    ...
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('Telefone'), '11987654321')];
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('Email'), 'joao@email.com')];
                    case 7:
                        _a.sent();
                        // Address
                    ...
                    case 8:
                        // Address
                        _a.sent();
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('Logradouro'), 'Rua das Flores, 123')];
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('Cidade'), 'São Paulo')];
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, user.selectOptions(react_1.screen.getByLabelText('Estado'), 'SP')];
                    case 11:
                        _a.sent();
                        // Emergency contact
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('Nome do Contato'), 'Maria Silva')];
                    case 12:
                        // Emergency contact
                        _a.sent();
                        return [4 /*yield*/, user.selectOptions(react_1.screen.getByLabelText('Parentesco'), 'spouse')];
                    case 13:
                        _a.sent();
                        return [4 /*yield*/, user.type(react_1.screen.getByLabelText('Telefone do Contato'), '11987654322')];
                    case 14:
                        _a.sent();
                        basicConsentCheckbox = react_1.screen.getByRole('checkbox', {
                            name: /Dados básicos para cadastro/
        ...
        it('successfully submits valid form', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, submitButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                ...
                                expect(sonner_1.toast.success).toHaveBeenCalledWith('Paciente cadastrado com sucesso!');
        ...
        it('shows loading state during submission', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, submitButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabase.from.mockReturnValue({
                            insert: jest.fn().mockImplementation(function () {
                                return new Promise(function (resolve) { return setTimeout(function () { return resolve({ data: null, error: null }); }, 100); });
                            })
                        });
                        return [4 /*yield*/, fillValidForm(user)];
                    case 1:
        ...
        it('handles submission errors gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, submitButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                expect(sonner_1.toast.error).toHaveBeenCalledWith('Erro ao cadastrar paciente. Tente novamente.');
                            })];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('Accessibility', function () {
        it('has proper ARIA labels for form sections', function () {
            ...
            expect(react_1.screen.getByRole('heading', { name: 'Consentimentos LGPD' })).toBeInTheDocument();
        });
        ...
        it('provides proper error announcements', function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, cpfInput;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
