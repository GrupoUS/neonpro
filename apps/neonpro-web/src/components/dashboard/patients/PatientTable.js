...
function PatientTable(_a) {
    var data = _a.data, loading = _a.loading, currentPage = _a.currentPage, totalPages = _a.totalPages, onPageChange = _a.onPageChange, onViewPatient = _a.onViewPatient, onEditPatient = _a.onEditPatient, onDeletePatient = _a.onDeletePatient;
    ...
    var handleViewPatient = function (id) {
      ...
      <card_1.CardContent>
        <div className="rounded-md border">
          <table_1.Table>
            ...
            <table_1.TableBody>
              {data.map(function (patient) { return (<table_1.TableRow key={patient.id} className="hover:bg-muted/50">
                  <table_1.TableCell>
                  ...
                  <table_1.TableCell>
                    <div className="flex flex-col gap-1">
                      {patient.phone !== 'N/A' && (<div className="flex items-center gap-1 text-sm">
                  ...
                  <table_1.TableCell>
                    <dropdown_menu_1.DropdownMenu>
                      ...
                      <dropdown_menu_1.DropdownMenuContent align="end">
                        ...
                        <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleViewPatient(patient.id); }}>
                          <lucide_react_1.Eye className="mr-2 h-4 w-4"/>
                          Visualizar
                        </dropdown_menu_1.DropdownMenuItem>
                        <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleEditPatient(patient.id); }}>
                          <lucide_react_1.Edit className="mr-2 h-4 w-4"/>
                          Editar
                        </dropdown_menu_1.DropdownMenuItem>
                        <dropdown_menu_1.DropdownMenuSeparator />
                        <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleDeletePatient(patient.id); }} className="text-destructive">
        ...
        {totalPages > 1 && (<div className="flex items-center justify-between px-2 py-4">
            ...
            <div className="flex items-center space-x-2">
              <button_1.Button variant="outline" size="sm" onClick={function () { return onPageChange(currentPage - 1); }} disabled={currentPage <= 1}>
                <lucide_react_1.ChevronLeft className="h-4 w-4"/>
                Anterior
              </button_1.Button>
              <button_1.Button variant="outline" size="sm" onClick={function () { return onPageChange(currentPage + 1); }} disabled={currentPage >= totalPages}>
                Próxima
