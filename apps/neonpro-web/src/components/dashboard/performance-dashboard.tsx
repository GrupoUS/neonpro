...
export default function PerformanceDashboard() {
  ...
  const getSystemMetrics = (): SystemMetrics => {
    ...
    return {
      ...
      loadTime:
        Math.round(performance.timing?.loadEventEnd - performance.timing?.navigationStart) || 0,
        ...
        <TabsContent value="vitals">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{formatMetric(metrics?.lcp || 0, "s")}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{formatMetric(metrics?.fid || 0, "ms")}</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{(metrics?.cls || 0).toFixed(3)}</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{formatMetric(metrics?.fcp || 0, "s")}</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{formatMetric(metrics?.ttfb || 0, "ms")}</div>
                <p className="text-xs text-muted-foreground">
        ...
        <TabsContent value="system">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{systemMetrics?.memoryUsage || 0} MB</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{systemMetrics?.loadTime || 0} ms</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{systemMetrics?.domNodes || 0}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{systemMetrics?.resources || 0}</div>
