...
function CommunicationLog(_a) {
  ...
  var _c = (0, react_1.useState)([]),
    filteredLogs = _c[0],
    setFilteredLogs = _c[1];
  var _d = (0, react_1.useState)(true),
    loading = _d[0],
    setLoading = _d[1];
  var _e = (0, react_1.useState)(false),
    showNewLogDialog = _e[0],
    setShowNewLogDialog = _e[1];
      ...
      return __generator(this, (_a) => {
        ...
        try {
          newLogEntry_1 = __assign(__assign({ id: Date.now().toString() }, newLog), {
            communication_type: newLog.communication_type,
      ...
      <div className="space-y-4">
        {filteredLogs.length === 0
          ...
          : filteredLogs.map((log) => {
              ...
              return (
                <card_1.Card key={log.id} className="hover:shadow-md transition-shadow">
                  <card_1.CardContent className="p-4">
        ...
        <dialog_1.DialogContent className="max-w-2xl">
          ...
          <form onSubmit={handleNewLogSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <label_1.Label htmlFor="follow_up_date">Data de Follow-up (opcional)</label_1.Label>
                <input_1.Input
                  id="follow_up_date"
                  type="datetime-local"
