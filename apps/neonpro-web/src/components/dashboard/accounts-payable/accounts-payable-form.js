...
function AccountsPayableForm(_a) {
    var _this = this;
    var accountsPayable = _a.accountsPayable, open = _a.open, onOpenChange = _a.onOpenChange, onSuccess = _a.onSuccess;
    var _b = (0, react_1.useState)(false), loading = _b[0], setLoading = _b[1];
    var _c = (0, react_1.useState)([]), vendors = _c[0], setVendors = _c[1];
    var _d = (0, react_1.useState)([]), categories = _d[0], setCategories = _d[1];
    var _e = (0, react_1.useState)(true), loadingOptions = _e[0], setLoadingOptions = _e[1];
    var _f = (0, react_1.useState)([]), documents = _f[0], setDocuments = _f[1];
    var _g = (0, react_1.useState)(false), loadingDocuments = _g[0], setLoadingDocuments = _g[1];
    ...
    var _j = (0, react_1.useState)({
        invoice: false,
        due: false,
    }), showCalendar = _j[0], setShowCalendar = _j[1];
    var loadDocuments = function () { return __awaiter(_this, void 0, void 0, function () {
        var payableDocuments, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(accountsPayable === null || accountsPayable === void 0 ? void 0 : accountsPayable.id))
                        return [2 /*return*/];
                    setLoadingDocuments(true);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    return [4 /*yield*/, documents_1.documentsService.getDocuments("payable", accountsPayable.id)];
                case 2:
    ...
    (0, react_1.useEffect)(function () {
        if (open && (accountsPayable === null || accountsPayable === void 0 ? void 0 : accountsPayable.id)) {
            loadDocuments();
        }
    ...
    (0, react_1.useEffect)(function () {
        var netAmount = (formData.gross_amount || 0) +
            (formData.tax_amount || 0) -
            (formData.discount_amount || 0);
        if (netAmount !== formData.net_amount) {
            setFormData(function (prev) { return (__assign(__assign({}, prev), { net_amount: netAmount })); });
        }
    ...
    (0, react_1.useEffect)(function () {
        if (formData.invoice_date && formData.payment_terms_days) {
            ...
            if (dueDateString_1 !== formData.due_date) {
                setFormData(function (prev) { return (__assign(__assign({}, prev), { due_date: dueDateString_1 })); });
            }
        }
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!formData.vendor_id ||
                        ...
                        !formData.due_date) {
                        sonner_1.toast.error("Fornecedor, categoria de despesa e data de vencimento são obrigatórios");
                        return [2 /*return*/];
                    }
                ...
                case 1:
                    ...
                    return [4 /*yield*/, accounts_payable_1.AccountsPayableService.updateAccountsPayable(accountsPayable.id, formData)];
                case 2:
                    _a.sent();
                    sonner_1.toast.success("Conta a pagar atualizada com sucesso!");
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, accounts_payable_1.AccountsPayableService.createAccountsPayable(formData)];
                case 4:
                    _a.sent();
    ...
    var handleDateSelect = function (date, field) {
        ...
        setShowCalendar(function (prev) {
            var _a;
            return (__assign(__assign({}, prev), (_a = {}, _a[field === "invoice_date" ? "invoice" : "due"] = false, _a)));
        });
    };
      ...
      <dialog_1.DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        ...
        <tabs_1.Tabs defaultValue="info" className="w-full">
          <tabs_1.TabsList className="grid w-full grid-cols-2">
            ...
            <tabs_1.TabsTrigger value="documents" className="flex items-center gap-2" disabled={!(accountsPayable === null || accountsPayable === void 0 ? void 0 : accountsPayable.id)}>
          ...
          <tabs_1.TabsContent value="info" className="mt-6">
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select_1.Select value={formData.vendor_id} onValueChange={function (value) { return updateField("vendor_id", value); }}>
                      <select_1.SelectTrigger>
                        <select_1.SelectValue placeholder="Selecione o fornecedor"/>
                      </select_1.SelectTrigger>
                      <select_1.SelectContent>
                        {vendors.map(function (vendor) { return (<select_1.SelectItem key={vendor.id} value={vendor.value}>
                            {vendor.label}
                          </select_1.SelectItem>); })}
                      </select_1.SelectContent>
                    </select_1.Select>
                  ...
                  <div>
                    ...
                    <select_1.Select value={formData.expense_category_id} onValueChange={function (value) {
            return updateField("expense_category_id", value);
                      ...
                      <select_1.SelectContent>
                        {categories.map(function (category) { return (<select_1.SelectItem key={category.id} value={category.value}>
                            {category.label}
                          </select_1.SelectItem>); })}
                      </select_1.SelectContent>
                    </select_1.Select>
                  ...
                  <div>
                    ...
                    <input_1.Input id="invoice_number" value={formData.invoice_number} onChange={function (e) {
            return updateField("invoice_number", e.target.value);
                  ...
                  <div>
                    ...
                    <select_1.Select value={formData.status} onValueChange={function (value) { return updateField("status", value); }}>
                      <select_1.SelectTrigger>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <popover_1.Popover open={showCalendar.invoice} onOpenChange={function (open) {
            return setShowCalendar(function (prev) { return (__assign(__assign({}, prev), { invoice: open })); });
        }}>
                      <popover_1.PopoverTrigger asChild>
                        <button_1.Button variant="outline" className={(0, utils_1.cn)("w-full justify-start text-left font-normal", !formData.invoice_date && "text-muted-foreground")}>
            ...
            : "Selecionar data"}
                      ...
                      <popover_1.PopoverContent className="w-auto p-0">
                        <calendar_1.Calendar mode="single" selected={formData.invoice_date
            ? new Date(formData.invoice_date)
            : undefined} onSelect={function (date) {
            return handleDateSelect(date, "invoice_date");
                  ...
                  <div>
                    ...
                    <input_1.Input id="payment_terms_days" type="number" value={formData.payment_terms_days} onChange={function (e) {
            return updateField("payment_terms_days", parseInt(e.target.value) || 30);
                  ...
                  <div>
                    ...
                    <popover_1.Popover open={showCalendar.due} onOpenChange={function (open) {
            return setShowCalendar(function (prev) { return (__assign(__assign({}, prev), { due: open })); });
        }}>
                      <popover_1.PopoverTrigger asChild>
                        <button_1.Button variant="outline" className={(0, utils_1.cn)("w-full justify-start text-left font-normal", !formData.due_date && "text-muted-foreground")}>
                          <lucide_react_1.CalendarIcon className="mr-2 h-4 w-4"/>
                          {formData.due_date
            ...
            : "Selecionar data"}
                      ...
                      <popover_1.PopoverContent className="w-auto p-0">
                        <calendar_1.Calendar mode="single" selected={formData.due_date
                ...
                <card_1.CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input_1.Input id="gross_amount" type="number" value={formData.gross_amount} onChange={function (e) {
            return updateField("gross_amount", parseFloat(e.target.value) || 0);
                    ...
                    <div>
                      ...
                      <input_1.Input id="tax_amount" type="number" value={formData.tax_amount} onChange={function (e) {
            return updateField("tax_amount", parseFloat(e.target.value) || 0);
                    ...
                    <div>
                      ...
                      <input_1.Input id="discount_amount" type="number" value={formData.discount_amount} onChange={function (e) {
            ...
            return updateField("payment_method", value);
                      ...
                      <select_1.SelectContent>
                        {paymentMethods.map(function (method) { return (<select_1.SelectItem key={method.value} value={method.value}>
                            {method.label}
                          </select_1.SelectItem>); })}
                      </select_1.SelectContent>
                    </select_1.Select>
                  ...
                  <div>
                    ...
                    <select_1.Select value={formData.priority} onValueChange={function (value) { return updateField("priority", value); }}>
                      <select_1.SelectTrigger>
                        <select_1.SelectValue />
                      </select_1.SelectTrigger>
                      <select_1.SelectContent>
        ...
        }} placeholder="Descrição da despesa..." rows={3}/>
                  </div>

                  <div>
                    <label_1.Label htmlFor="notes">Observações</label_1.Label>
                    <textarea_1.Textarea id="notes" value={formData.notes} onChange={function (e) { return updateField("notes", e.target.value); }} placeholder="Observações internas..." rows={2}/>
                  </div>
                </card_1.CardContent>
              </card_1.Card>
            </form>
          ...
          <tabs_1.TabsContent value="documents" className="mt-6">
            {(accountsPayable === null || accountsPayable === void 0 ? void 0 : accountsPayable.id) && (<document_upload_1.default entityType="payable" entityId={accountsPayable.id} existingDocuments={documents} onDocumentsChange={loadDocuments}/>)}
          </tabs_1.TabsContent>
        </tabs_1.Tabs>
