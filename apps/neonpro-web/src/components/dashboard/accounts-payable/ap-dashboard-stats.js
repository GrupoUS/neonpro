    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <card_1.Card>
        <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <card_1.CardTitle className="text-sm font-medium">Contas Pendentes</card_1.CardTitle>
        ...
        <card_1.CardContent>
          ...
          <p className="text-xs text-muted-foreground">Aguardando aprovação ou pagamento</p>
        </card_1.CardContent>
      </card_1.Card>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          {loading
            ...
            : <div className="text-2xl font-bold">{formatCurrency(stats.totalOpenAmount)}</div>}
          <p className="text-xs text-muted-foreground">Valor total a ser pago</p>
        </card_1.CardContent>
      </card_1.Card>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          ...
          <p className="text-xs text-muted-foreground">Contas com vencimento hoje</p>
        </card_1.CardContent>
      </card_1.Card>

      <card_1.Card>
        <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <card_1.CardTitle className="text-sm font-medium">Fornecedores Ativos</card_1.CardTitle>
