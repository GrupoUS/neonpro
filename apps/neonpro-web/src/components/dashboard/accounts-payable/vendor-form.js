...
function VendorForm(_a) {
    var _this = this;
    var vendor = _a.vendor, open = _a.open, onOpenChange = _a.onOpenChange, onSuccess = _a.onSuccess;
    var _b = (0, react_1.useState)(false), loading = _b[0], setLoading = _b[1];
    var _c = (0, react_1.useState)([]), documents = _c[0], setDocuments = _c[1];
    var _d = (0, react_1.useState)(false), loadingDocuments = _d[0], setLoadingDocuments = _d[1];
    ...
    var generateVendorCode = function () { return __awaiter(_this, void 0, void 0, function () {
        var code_1, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    code_1 = _a.sent();
                    setFormData(function (prev) { return (__assign(__assign({}, prev), { vendor_code: code_1 })); });
                    return [3 /*break*/, 3];
                case 2:
                    error_2 = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, vendors_1.VendorService.createVendor(formData)];
                case 4:
                    _a.sent();
      ...
      <dialog_1.DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        ...
        <tabs_1.Tabs defaultValue="info" className="w-full">
          <tabs_1.TabsList className="grid w-full grid-cols-2">
            ...
            <tabs_1.TabsTrigger value="documents" className="flex items-center gap-2" disabled={!(vendor === null || vendor === void 0 ? void 0 : vendor.id)}>
          ...
          <tabs_1.TabsContent value="info" className="mt-6">
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input_1.Input id="vendor_code" value={formData.vendor_code} onChange={function (e) {
            return updateField("vendor_code", e.target.value);
        }} placeholder="VEND001" required/>
                  </div>

                  <div>
                    <label_1.Label htmlFor="company_name">Nome da Empresa *</label_1.Label>
                    <input_1.Input id="company_name" value={formData.company_name} onChange={function (e) {
            return updateField("company_name", e.target.value);
                  ...
                  <div>
                    ...
                    <input_1.Input id="legal_name" value={formData.legal_name} onChange={function (e) {
            return updateField("legal_name", e.target.value);
                  ...
                  <div>
                    ...
                    <select_1.Select value={formData.vendor_type} onValueChange={function (value) {
            return updateField("vendor_type", value);
                      ...
                      <select_1.SelectContent>
                        {vendorTypes.map(function (type) { return (<select_1.SelectItem key={type.value} value={type.value}>
                            {type.label}
                          </select_1.SelectItem>); })}
                      </select_1.SelectContent>
                    </select_1.Select>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input_1.Input id="contact_person" value={formData.contact_person} onChange={function (e) {
            return updateField("contact_person", e.target.value);
                  ...
                  <div>
                    ...
                    <input_1.Input id="email" type="email" value={formData.email} onChange={function (e) { return updateField("email", e.target.value); }} placeholder="email@exemplo.com"/>
                  </div>

                  <div>
                    <label_1.Label htmlFor="phone">Telefone</label_1.Label>
                    <input_1.Input id="phone" value={formData.phone} onChange={function (e) { return updateField("phone", e.target.value); }} placeholder="(11) 1234-5678"/>
                  </div>

                  <div>
                    <label_1.Label htmlFor="mobile">Celular</label_1.Label>
                    <input_1.Input id="mobile" value={formData.mobile} onChange={function (e) { return updateField("mobile", e.target.value); }} placeholder="(11) 98765-4321"/>
                  </div>
                </card_1.CardContent>
              </card_1.Card>
                ...
                <card_1.CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                      ...
                      <input_1.Input id="address_line1" value={formData.address_line1} onChange={function (e) {
            return updateField("address_line1", e.target.value);
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input_1.Input id="address_line2" value={formData.address_line2} onChange={function (e) {
            return updateField("address_line2", e.target.value);
                    ...
                    <div>
                      ...
                      <input_1.Input id="city" value={formData.city} onChange={function (e) { return updateField("city", e.target.value); }} placeholder="São Paulo"/>
                    </div>

                    <div>
                      <label_1.Label htmlFor="state">Estado</label_1.Label>
                      <input_1.Input id="state" value={formData.state} onChange={function (e) { return updateField("state", e.target.value); }} placeholder="SP"/>
                    </div>

                    <div>
                      <label_1.Label htmlFor="postal_code">CEP</label_1.Label>
                      <input_1.Input id="postal_code" value={formData.postal_code} onChange={function (e) {
            return updateField("postal_code", e.target.value);
                    ...
                    <div>
                      ...
                      <input_1.Input id="country" value={formData.country} onChange={function (e) { return updateField("country", e.target.value); }} placeholder="Brasil"/>
                    </div>
                  </div>
                </card_1.CardContent>
              </card_1.Card>
                ...
                <card_1.Card>
                  ...
                  <card_1.CardContent className="space-y-4">
                    <div>
                      ...
                      <input_1.Input id="tax_id" value={formData.tax_id} onChange={function (e) { return updateField("tax_id", e.target.value); }} placeholder="000.000.000-00"/>
                    </div>

                    <div>
                      <label_1.Label htmlFor="state_registration">
                        Inscrição Estadual
                      </label_1.Label>
                      <input_1.Input id="state_registration" value={formData.state_registration} onChange={function (e) {
            return updateField("state_registration", e.target.value);
                    ...
                    <div>
                      ...
                      <input_1.Input id="municipal_registration" value={formData.municipal_registration} onChange={function (e) {
            return updateField("municipal_registration", e.target.value);
        }} placeholder="123456789"/>
                    </div>

                    <div className="flex items-center space-x-2">
                      <checkbox_1.Checkbox id="tax_exempt" checked={formData.tax_exempt} onCheckedChange={function (checked) {
                ...
                <card_1.Card>
                  ...
                  <card_1.CardContent className="space-y-4">
                    <div>
                      ...
                      <input_1.Input id="bank_name" value={formData.bank_name} onChange={function (e) {
            return updateField("bank_name", e.target.value);
                    ...
                    <div>
                      ...
                      <input_1.Input id="bank_branch" value={formData.bank_branch} onChange={function (e) {
            ...
            return updateField("bank_account", e.target.value);
                    ...
                    <div>
                      ...
                      <input_1.Input id="pix_key" value={formData.pix_key} onChange={function (e) { return updateField("pix_key", e.target.value); }} placeholder="email@exemplo.com"/>
                    </div>
                  </card_1.CardContent>
                </card_1.Card>
              </div>
            ...
            return updateField("payment_method", value);
                  ...
                  <div>
                    ...
                    <input_1.Input id="credit_limit" type="number" value={formData.credit_limit || ""} onChange={function (e) {
            return updateField("credit_limit", parseFloat(e.target.value) || undefined);
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <checkbox_1.Checkbox id="is_active" checked={formData.is_active} onCheckedChange={function (checked) {
            return updateField("is_active", checked);
                  ...
                  <div className="flex items-center space-x-2">
                    <checkbox_1.Checkbox id="requires_approval" checked={formData.requires_approval} onCheckedChange={function (checked) {
          ...
          <tabs_1.TabsContent value="documents" className="mt-6">
            {(vendor === null || vendor === void 0 ? void 0 : vendor.id) && (<document_upload_1.default entityType="vendor" entityId={vendor.id} existingDocuments={documents} onDocumentsChange={loadDocuments}/>)}
          </tabs_1.TabsContent>
        </tabs_1.Tabs>
