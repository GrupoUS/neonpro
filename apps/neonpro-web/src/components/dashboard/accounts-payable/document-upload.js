...
function DocumentUpload(_a) {
    var _this = this;
    var entityType = _a.entityType, entityId = _a.entityId, _b = _a.existingDocuments, existingDocuments = _b === void 0 ? [] : _b, onDocumentsChange = _a.onDocumentsChange;
    ...
    var handleFileSelect = function (e) {
        if (e.target.files) {
            ...
            setFiles(function (prev) { return __spreadArray(__spreadArray([], prev, true), newFiles_1, true); });
        }
    };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    file = files_1[_i];
                    return [4 /*yield*/, documents_1.documentsService.uploadDocument({
                            file: file,
                ...
                case 5:
                    ...
                    onDocumentsChange === null || onDocumentsChange === void 0 ? void 0 : onDocumentsChange();
                    return [3 /*break*/, 8];
                case 6:
                    error_1 = _a.sent();
    ...
    var handleDownload = function (documentId, fileName) { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, documents_1.documentsService.downloadDocument(documentId, fileName)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    var handleDelete = function (documentId) { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (<div className="space-y-6">
        ...
        <card_1.CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <input_1.Input ref={fileInputRef} id="fileInput" type="file" multiple accept=".pdf,.doc,.docx,.jpg,.jpeg,.png,.xls,.xlsx" onChange={handleFileSelect}/>
            </div>
          </div>
          ...
          {files.length > 0 && (<div className="space-y-2">
              ...
              <div className="space-y-2">
                {files.map(function (file, index) { return (<div key={index} className="flex items-center justify-between p-2 border rounded">
                    ...
                    <button_1.Button variant="ghost" size="sm" onClick={function () { return removeFile(index); }}>
          ...
          <button_1.Button onClick={handleUpload} disabled={files.length === 0 || !documentType || uploading} className="w-full">
      ...
      {/* Existing Documents */}
      {existingDocuments.length > 0 && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center gap-2">
          ...
          <card_1.CardContent>
            <div className="space-y-2">
              {existingDocuments.map(function (doc) {
                var _a;
                return (<div key={doc.id} className="flex items-center justify-between p-3 border rounded">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        <badge_1.Badge variant="outline">
                          {((_a = documentTypes.find(function (t) { return t.value === doc.document_type; })) === null || _a === void 0 ? void 0 : _a.label) || doc.document_type}
                        </badge_1.Badge>
                  ...
                  <div className="flex gap-2">
                    <button_1.Button variant="outline" size="sm" onClick={function () { return handleDownload(doc.id, doc.file_name); }}>
                      <lucide_react_1.Download className="h-4 w-4"/>
                    </button_1.Button>
                    <button_1.Button variant="ghost" size="sm" onClick={function () { return handleDelete(doc.id); }}>
                      <lucide_react_1.Trash2 className="h-4 w-4"/>
                    </button_1.Button>
                  </div>
                </div>);
