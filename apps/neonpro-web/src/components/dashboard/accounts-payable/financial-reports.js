...
function FinancialReportsPage(_a) {
  ...
  var _b = (0, react_1.useState)(false),
    loading = _b[0],
    setLoading = _b[1];
  var _c = (0, react_1.useState)("summary"),
    activeTab = _c[0],
    setActiveTab = _c[1];
  ...
  var _f = (0, react_1.useState)([]),
    vendorPerformance = _f[0],
    setVendorPerformance = _f[1];
  var _g = (0, react_1.useState)([]),
    categoryExpenses = _g[0],
    setCategoryExpenses = _g[1];
  var _h = (0, react_1.useState)(null),
    budgetTracking = _h[0],
    setBudgetTracking = _h[1];
  // Filtros de período
          ...
          case 0:
            ...
            return [
              ...
              Promise.all([
                ...
                financial_reports_service_1.financialReportsService.getVendorPerformanceReport(
                  clinicId,
                  "2025-01-01",
                  "2025-07-21",
                ),
                financial_reports_service_1.financialReportsService.getCategoryExpenseReport(
                  clinicId,
                  2025,
                  7,
                ),
                financial_reports_service_1.financialReportsService.getBudgetTrackingReport(
                  clinicId,
                  "2025-07",
                ),
              ]),
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <card_1.Card>
            <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <card_1.CardTitle className="text-sm font-medium">Total a Pagar</card_1.CardTitle>
          ...
          <card_1.Card>
            <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <card_1.CardTitle className="text-sm font-medium">Economia YTD</card_1.CardTitle>
              <lucide_react_1.TrendingDown className="h-4 w-4 text-green-600" />
            </card_1.CardHeader>
            <card_1.CardContent>
              <div className="text-2xl font-bold text-green-600">
                {financial_reports_service_1.financialReportsService.formatCurrency(
                  summary.cost_savings_ytd,
                )}
              </div>
        ...
        <tabs_1.TabsContent value="budget" className="space-y-4">
          {budgetTracking && (
            <>
              ...
              <card_1.Card>
                <card_1.CardHeader>
                  <card_1.CardTitle>Resumo Orçamentário - {budgetTracking.period}</card_1.CardTitle>
                </card_1.CardHeader>
                <card_1.CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold text-yellow-600">
                        {financial_reports_service_1.financialReportsService.formatCurrency(
                          budgetTracking.total_committed,
                        )}
                      </p>
                    </div>
                    <div className="text-center">
                      ...
                      >
                        {financial_reports_service_1.financialReportsService.formatCurrency(
                          budgetTracking.remaining_budget,
                        )}
                      </p>
                    </div>
                  </div>
