...
function PaymentForm(_a) {
  ...
  var _c = (0, react_1.useState)(false),
    showCalendar = _c[0],
    setShowCalendar = _c[1];
  var _d = (0, react_1.useState)([]),
    previousPayments = _d[0],
    setPreviousPayments = _d[1];
  var _e = (0, react_1.useState)(false),
    loadingPayments = _e[0],
    setLoadingPayments = _e[1];
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            paymentData = __assign(__assign({}, formData), {
              ...
              reference_number: formData.reference_number || "PAY".concat(Date.now()),
            });
    ...
    <dialog_1.Dialog open={open} onOpenChange={onOpenChange}>
      <dialog_1.DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle className="text-sm">Informações da Conta a Pagar</card_1.CardTitle>
            </card_1.CardHeader>
          ...
          {previousPayments.length > 0 && (
            <card_1.Card>
              <card_1.CardHeader>
                <card_1.CardTitle className="text-sm">Histórico de Pagamentos</card_1.CardTitle>
              </card_1.CardHeader>
              <card_1.CardContent>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <badge_1.Badge
                            className={(0, utils_1.cn)(
                              "text-xs",
                              statusConfig === null || statusConfig === void 0
                                ? void 0
                                : statusConfig.color,
                            )}
                          >
                      ...
                      <popover_1.PopoverTrigger asChild>
                        ...
                        >
                          ...
                          {formData.payment_date
                            ? (0, date_fns_1.format)(formData.payment_date, "dd/MM/yyyy", {
                                locale: locale_1.ptBR,
                              })
