...
function AccountsPayableList() {
    var _this = this;
    var _a = (0, react_1.useState)([]), accountsPayable = _a[0], setAccountsPayable = _a[1];
    var _b = (0, react_1.useState)(true), loading = _b[0], setLoading = _b[1];
    var _c = (0, react_1.useState)(0), totalAP = _c[0], setTotalAP = _c[1];
    ...
    var _f = (0, react_1.useState)(), selectedAP = _f[0], setSelectedAP = _f[1];
    var _g = (0, react_1.useState)(false), showDeleteDialog = _g[0], setShowDeleteDialog = _g[1];
    var _h = (0, react_1.useState)(null), apToDelete = _h[0], setApToDelete = _h[1];
    var _j = (0, react_1.useState)(false), deleteLoading = _j[0], setDeleteLoading = _j[1];
    // Filter options
    var _k = (0, react_1.useState)([]), vendors = _k[0], setVendors = _k[1];
    var _l = (0, react_1.useState)([]), categories = _l[0], setCategories = _l[1];
    // Filters
    ...
    var loadAccountsPayable = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, accounts_payable_1.AccountsPayableService.getAccountsPayable(filters, currentPage, pageSize)];
                case 1:
                    response = _a.sent();
    ...
    var handleSearch = function (search) {
        setFilters(function (prev) { return (__assign(__assign({}, prev), { search: search })); });
        setCurrentPage(1);
    };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, accounts_payable_1.AccountsPayableService.deleteAccountsPayable(apToDelete.id, "Deletado pelo usuário")];
                case 2:
                    _a.sent();
    ...
    var handleStatusUpdate = function (ap, newStatus) { return __awaiter(_this, void 0, void 0, function () {
        var error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, accounts_payable_1.AccountsPayableService.updateStatus(ap.id, newStatus)];
                case 1:
                    _a.sent();
    ...
    var getStatusBadge = function (status) {
        ...
        return (<badge_1.Badge variant={statusInfo.variant} className="flex items-center gap-1">
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button_1.Button onClick={function () { return setShowForm(true); }}>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input_1.Input placeholder="Buscar por número AP, fatura ou descrição..." value={filters.search || ""} onChange={function (e) { return handleSearch(e.target.value); }} className="pl-8"/>
              </div>
            </div>

            <div className="flex flex-wrap gap-2">
              <select_1.Select value={filters.vendor_id || "all"} onValueChange={function (value) {
            return handleFilterChange("vendor_id", value === "all" ? undefined : value);
              ...
              <select_1.Select value={filters.status || "all"} onValueChange={function (value) {
            return handleFilterChange("status", value === "all" ? undefined : value);
              ...
              <select_1.Select value={filters.priority || "all"} onValueChange={function (value) {
            return handleFilterChange("priority", value === "all" ? undefined : value);
              ...
              <select_1.Select value={filters.expense_category_id || "all"} onValueChange={function (value) {
            return handleFilterChange("expense_category_id", value === "all" ? undefined : value);
        }}>
          ...
          <table_1.Table>
            ...
            <table_1.TableBody>
              {loading ? (<table_1.TableRow>
                ...
                </table_1.TableRow>) : accountsPayable.length === 0 ? (<table_1.TableRow>
                  <table_1.TableCell colSpan={7} className="text-center py-8">
                    <lucide_react_1.FileText className="h-12 w-12 text-muted-foreground mx-auto mb-4"/>
                    <p className="text-sm text-muted-foreground">
                      {Object.values(filters).some(function (v) { return v !== undefined && v !== ""; })
                ? "Nenhuma conta a pagar encontrada com os filtros aplicados"
                : "Nenhuma conta a pagar cadastrada"}
                    </p>
                  </table_1.TableCell>
                </table_1.TableRow>) : (accountsPayable.map(function (ap) {
            var _a, _b;
            return (<table_1.TableRow key={ap.id}>
                    <table_1.TableCell>
                      <div>
                        <div className="font-medium">{ap.ap_number}</div>
                        {ap.invoice_number && (<div className="text-sm text-muted-foreground">
                    ...
                    <table_1.TableCell>
                      <div>
                        <div className="font-medium">
                          {(_a = ap.vendor) === null || _a === void 0 ? void 0 : _a.company_name}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          {(_b = ap.expense_category) === null || _b === void 0 ? void 0 : _b.category_name}
                        </div>
                      </div>
                    </table_1.TableCell>

                    <table_1.TableCell>
                      <div className={(0, utils_1.cn)("text-sm", isOverdue(ap.due_date, ap.status) &&
                    "text-destructive font-medium")}>
                        {formatDate(ap.due_date)}
                        {isOverdue(ap.due_date, ap.status) && (<div className="flex items-center gap-1 text-destructive">
                    ...
                    <table_1.TableCell>
                      <div>
                        ...
                        {ap.balance_amount < ap.net_amount && (<div className="text-sm text-muted-foreground">
                    ...
                    <table_1.TableCell>
                      <dropdown_menu_1.DropdownMenu>
                        ...
                        <dropdown_menu_1.DropdownMenuContent align="end">
                          <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleEdit(ap); }}>
                            <lucide_react_1.Pencil className="mr-2 h-4 w-4"/>
                            Editar
                          </dropdown_menu_1.DropdownMenuItem>

                          {ap.status === "pending" && (<dropdown_menu_1.DropdownMenuItem onClick={function () { return handleStatusUpdate(ap, "approved"); }}>
                              <lucide_react_1.CheckCircle className="mr-2 h-4 w-4"/>
                              Aprovar
                            </dropdown_menu_1.DropdownMenuItem>)}

                          <dropdown_menu_1.DropdownMenuItem className="text-destructive" onClick={function () {
                    setApToDelete(ap);
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1">
              {Array.from({ length: Math.min(5, totalPages) }, function (_, i) {
                ...
                return (<button_1.Button key={pageNum} variant={currentPage === pageNum ? "default" : "outline"} size="sm" onClick={function () { return setCurrentPage(pageNum); }}>
                    {pageNum}
                  </button_1.Button>);
            })}
            </div>
            <button_1.Button variant="outline" size="sm" onClick={function () {
                return setCurrentPage(function (prev) { return Math.min(totalPages, prev + 1); });
      ...
      {/* AP Form Dialog */}
      <accounts_payable_form_1.AccountsPayableForm accountsPayable={selectedAP} open={showForm} onOpenChange={function (open) {
            setShowForm(open);
            if (!open)
                setSelectedAP(undefined);
        ...
        <dialog_1.DialogContent>
          <dialog_1.DialogHeader>
            ...
            <dialog_1.DialogDescription>
              ...
              {apToDelete === null || apToDelete === void 0 ? void 0 : apToDelete.ap_number}"? Esta ação não pode ser desfeita.
            </dialog_1.DialogDescription>
          </dialog_1.DialogHeader>
