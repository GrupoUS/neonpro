...
function ApprovalRequestTracker(_a) {
  ...
  var _d = (0, react_1.useState)(false),
    showActionModal = _d[0],
    setShowActionModal = _d[1];
  var _e = (0, react_1.useState)("approve"),
    selectedAction = _e[0],
    setSelectedAction = _e[1];
  var _f = (0, react_1.useState)(""),
    actionComments = _f[0],
    setActionComments = _f[1];
      ...
      return __generator(this, (_a) => {
        ...
        try {
          ...
          setRequest((prevRequest) => {
            ...
            var newCurrentLevel =
              (currentStep === null || currentStep === void 0 ? void 0 : currentStep.status) ===
                "approved" && prevRequest.current_level < updatedChain.length
                ? prevRequest.current_level + 1
                : prevRequest.current_level;
            return __assign(__assign({}, prevRequest), {
            ...
            <card_1.CardHeader>
              <card_1.CardTitle className="text-sm flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <badge_1.Badge
                    className={(0, utils_1.cn)("text-xs", priorityConfig[request.priority].color)}
                  >
            ...
            <card_1.CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {(0, date_fns_1.format)(new Date(request.request_date), "dd/MM/yyyy HH:mm", {
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-xs text-muted-foreground">
                  ...
                  <span>
                    {currentStep ? "Aguardando: ".concat(currentStep.level_name) : "Concluído"}
                  </span>
                </div>
              </div>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-right text-sm">
                              <div className="flex items-center gap-2">
                                ...
                                >
                                  {((_b = statusConfig[step.status]) === null || _b === void 0
                                    ? void 0
                                    : _b.label) || step.status}
                                </badge_1.Badge>
                              </div>
                              {step.status === "pending" && (
                                <p
            ...
            <dialog_1.DialogFooter>
              ...
              >
                ...
                {!loading && selectedAction === "escalate" && (
                  <lucide_react_1.FastForward className="mr-2 h-4 w-4" />
                )}
