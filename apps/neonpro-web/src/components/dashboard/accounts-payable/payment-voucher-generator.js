...
function PaymentVoucherGenerator(_a) {
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 2:
            ...
            newVoucher = __assign(
              {
                id: "voucher_".concat(Date.now()),
                voucher_number: "CV"
                  .concat(new Date().getFullYear())
                  .concat(String(Date.now()).slice(-6)),
          ...
          case 1:
            ...
            return [
              ...
              navigator.share({
                ...
                text: "Comprovante de pagamento no valor de "
                  .concat(formatCurrency(voucher.amount_paid), " para ")
                  .concat(voucher.vendor_name),
  ...
  var handleCopyLink = () => {
    if (typeof window !== "undefined" && voucher) {
      var link = ""
        .concat(window.location.origin, "/dashboard/payments/voucher/")
        .concat(voucher.id);
      navigator.clipboard.writeText(link);
      sonner_1.toast.success("Link copiado para a área de transferência!");
    }
  };
  var PaymentMethodIcon = (_a) => {
            ...
            : // Voucher Display
              <div className="space-y-6" id="voucher-content">
                ...
                <div className="flex flex-wrap gap-2 pt-4 border-t">
                  ...
                  <button_1.Button
                    onClick={() =>
                      window.open("/dashboard/payments/voucher/".concat(voucher.id), "_blank")
                    }
                    variant="outline"
                  >
