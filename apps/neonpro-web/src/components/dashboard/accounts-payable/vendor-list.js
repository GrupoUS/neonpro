...
function VendorList() {
    ...
    var _c = (0, react_1.useState)(0), totalVendors = _c[0], setTotalVendors = _c[1];
    ...
    var _f = (0, react_1.useState)(), selectedVendor = _f[0], setSelectedVendor = _f[1];
    var _g = (0, react_1.useState)(false), showDeleteDialog = _g[0], setShowDeleteDialog = _g[1];
    var _h = (0, react_1.useState)(null), vendorToDelete = _h[0], setVendorToDelete = _h[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, vendors_1.VendorService.getVendors(filters, currentPage, pageSize)];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, vendors_1.VendorService.deleteVendor(vendorToDelete.id, "Deletado pelo usuário")];
                case 2:
                    _a.sent();
    ...
    var handleToggleStatus = function (vendor) { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, vendors_1.VendorService.toggleVendorStatus(vendor.id, !vendor.is_active)];
                case 1:
                    _a.sent();
                    sonner_1.toast.success("Fornecedor ".concat(!vendor.is_active ? "ativado" : "desativado", " com sucesso!"));
                    loadVendors();
                    return [3 /*break*/, 3];
                case 2:
                    error_3 = _a.sent();
    ...
    return (<div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input_1.Input placeholder="Buscar por nome, código ou contato..." value={filters.search || ""} onChange={function (e) { return handleSearch(e.target.value); }} className="pl-8"/>
              </div>
            </div>

            <select_1.Select value={filters.vendor_type || "all"} onValueChange={function (value) {
            ...
            return handleFilterChange("is_active", value === "all" ? undefined : value === "true");
        }}>
            ...
            <select_1.Select value={filters.payment_method || "all"} onValueChange={function (value) {
          ...
          <table_1.Table>
            ...
            <table_1.TableBody>
              {loading ? (<table_1.TableRow>
                ...
                </table_1.TableRow>) : vendors.length === 0 ? (<table_1.TableRow>
                  <table_1.TableCell colSpan={7} className="text-center py-8">
                ...
                : "Nenhum fornecedor cadastrado"}
                ...
                </table_1.TableRow>) : (vendors.map(function (vendor) { return (<table_1.TableRow key={vendor.id}>
                    <table_1.TableCell>
                      <div>
                    ...
                    <table_1.TableCell>
                      <div className="space-y-1">
                        ...
                        {vendor.email && (<div className="flex items-center gap-1 text-sm text-muted-foreground">
                            <lucide_react_1.Mail className="h-3 w-3"/>
                            {vendor.email}
                          </div>)}
                        {vendor.phone && (<div className="flex items-center gap-1 text-sm text-muted-foreground">
                    ...
                    <table_1.TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        {vendor.requires_approval && (<badge_1.Badge variant="outline" className="text-xs">
                            Aprovação
                          </badge_1.Badge>)}
                      </div>
                    </table_1.TableCell>
                    ...
                    <table_1.TableCell>
                      <dropdown_menu_1.DropdownMenu>
                        ...
                        <dropdown_menu_1.DropdownMenuContent align="end">
                          <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleEdit(vendor); }}>
                            <lucide_react_1.Pencil className="mr-2 h-4 w-4"/>
                            Editar
                          </dropdown_menu_1.DropdownMenuItem>
                          <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleToggleStatus(vendor); }}>
                            {vendor.is_active ? (<lucide_react_1.ToggleLeft className="mr-2 h-4 w-4"/>) : (<lucide_react_1.ToggleRight className="mr-2 h-4 w-4"/>)}
      ...
      {/* Vendor Form Dialog */}
      <vendor_form_1.VendorForm vendor={selectedVendor} open={showForm} onOpenChange={function (open) {
            setShowForm(open);
            if (!open)
                setSelectedVendor(undefined);
        ...
        <dialog_1.DialogContent>
          <dialog_1.DialogHeader>
            ...
            <dialog_1.DialogDescription>
              ...
              {vendorToDelete === null || vendorToDelete === void 0 ? void 0 : vendorToDelete.company_name}"? Esta ação não pode ser desfeita.
            </dialog_1.DialogDescription>
          </dialog_1.DialogHeader>
