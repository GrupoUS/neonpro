              ...
              <CardContent>
                <div className="space-y-2">
                  {previousPayments.map((payment) => {
                    const IconComponent = getPaymentMethodIcon(
                      payment.payment_method
                    );
                    const statusConfig = paymentStatuses.find(
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {formData.amount_paid > 0 &&
                      formData.amount_paid < remainingBalance && (
                        <div className="flex items-center gap-1 text-sm text-blue-600">
                          <AlertCircle className="h-3 w-3" />
                          Pagamento parcial - Saldo restante:{" "}
                          {formatCurrency(
                            remainingBalance - formData.amount_paid
                          )}
                        </div>
                      )}
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updateField("is_partial_payment", checked)
                      }
                    />
