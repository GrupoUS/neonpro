...
function ApprovalDashboard(_a) {
  ...
  var _j = (0, react_1.useState)("all"),
    priorityFilter = _j[0],
    setPriorityFilter = _j[1];
  // Modals
  var _k = (0, react_1.useState)(""),
    selectedRequestId = _k[0],
    setSelectedRequestId = _k[1];
  var _l = (0, react_1.useState)(false),
    showRequestTracker = _l[0],
    setShowRequestTracker = _l[1];
  var _m = (0, react_1.useState)(false),
    showHierarchyConfig = _m[0],
    setShowHierarchyConfig = _m[1];
  (0, react_1.useEffect)(() => {
    loadDashboardData();
  }, []);
    ...
    __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, (_a) => {
        ...
        try {
          ...
          mockAllRequests = __spreadArray(
            __spreadArray(__spreadArray([], mockPendingApprovals, true), mockMyRequests, true),
            [
              {
                id: "req_005",
  ...
  var handleViewRequest = (requestId) => {
    setSelectedRequestId(requestId);
    setShowRequestTracker(true);
  };
  var filterRequests = (requests) =>
    requests.filter((request) => {
      var _a, _b;
      var matchesSearch =
        searchTerm === "" ||
        request.requester_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
        ((_a = request.vendor_name) === null || _a === void 0
          ? void 0
          : _a.toLowerCase().includes(searchTerm.toLowerCase())) ||
        ((_b = request.invoice_number) === null || _b === void 0
          ? void 0
                ...
                return (
                  <table_1.TableRow key={request.id}>
                    ...
                    <table_1.TableCell>
                      <div>
                        <p className="text-sm">
                          {(0, date_fns_1.format)(new Date(request.due_date), "dd/MM/yyyy HH:mm", {
                            locale: locale_1.ptBR,
                          })}
                        </p>
                        <p
                    ...
                    <table_1.TableCell>
                      <badge_1.Badge
                        className={(0, utils_1.cn)("text-xs", statusConfig[request.status].color)}
                      >
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button_1.Button onClick={() => setShowHierarchyConfig(true)} variant="outline">
      ...
      {/* Modals */}
      <approval_request_tracker_1.default
        requestId={selectedRequestId}
        open={showRequestTracker}
        onOpenChange={setShowRequestTracker}
      />

      <approval_hierarchy_config_1.default
