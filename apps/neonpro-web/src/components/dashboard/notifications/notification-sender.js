...
var NotificationFormSchema = zod_2.z.object({
    ...
    channels: zod_2.z.array(zod_2.z.enum(['email', 'sms', 'whatsapp', 'push', 'in_app'])).min(1, 'Selecione pelo menos um canal'),
...
function NotificationSender(_a) {
    ...
    var _c = (0, react_1.useState)(0), estimatedReach = _c[0], setEstimatedReach = _c[1];
    ...
    var calculateEstimatedReach = function (formData) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 5, , 6]);
                    params = new URLSearchParams(__assign({ type: formData.recipientType }, (formData.groupFilters && Object.fromEntries(Object.entries(formData.groupFilters).filter(function (_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    payload = __assign(__assign({}, data), { scheduledFor: data.scheduledFor ? new Date(data.scheduledFor).toISOString() : undefined, metadata: {
                            estimatedReach: estimatedReach,
                            formSource: 'dashboard',
                        } });
                    endpoint = data.recipientType === 'single'
                ...
                case 2:
                    ...
                    toast({
                        ...
                        description: data.testMode
                            ...
                            : "Notifica\u00E7\u00E3o enviada para ".concat(estimatedReach, " destinat\u00E1rio(s)"),
                    });
                    // Reset form
                    form.reset();
                    setEstimatedReach(0);
    ...
    // RENDER HELPERS
    // ================================================================================
    var renderRecipientSelection = function () { return (<div className/>); };
    "space-y-4\">
        < form_1.FormField;
            ...
            <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
              <form_1.FormControl>
                <select_1.SelectTrigger>
                  <select_1.SelectValue placeholder/>\"Selecione o tipo de destinatário\" />
                </select_1.SelectTrigger>
              </form_1.FormControl>
              <select_1.SelectContent>
                <select_1.SelectItem value/>\"single\">Paciente Individual</select_1.SelectItem>
                <select_1.SelectItem value/>\"group\">Grupo de Pacientes</select_1.SelectItem>
...
/>;
{
    ...
    (<form_1.FormItem>
              ...
              <form_1.FormControl>
                <input_1.Input placeholder/>\"Buscar paciente...\" {...field} />
              </form_1.FormControl>
...
;
;
var renderChannelSelection = function () { return (<form_1.FormField control={form.control} name/>); };
"channels\";
render = {}();
(<form_1.FormItem>
          <div className/>\"mb-4\">
            <form_1.FormLabel className/>\"text-base\">Canais de Envio</form_1.FormLabel>
    ,
        <form_1.FormDescription>
...
"grid grid-cols-2 gap-4\">;
{
    [
        ...
        >
            (<form_1.FormControl>
                        <checkbox_1.Checkbox checked={(_a = field.value) === null || _a === void 0 ? void 0 : _a.includes(channel.id)} onCheckedChange={function (checked) {
...
/>;
;
var renderAdvancedOptions = function () { return (<div className/>); };
"space-y-4\">
    < div;
className = ;
"grid grid-cols-2 gap-4\">
...
(<form_1.FormItem>
              ...
              <form_1.FormControl>
                <input_1.Input type/>\"datetime-local\"
                  {...field}
                />
              </form_1.FormControl>
              <form_1.FormDescription>
          ...
          <form_1.Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className/>\"space-y-6\">
              ...
              <div className/>\"grid grid-cols-1 gap-4\">
                <form_1.FormField control={form.control} name/>\"type\"
                  render={function (_a) {
                    var field = _a.field;
...
(<form_1.FormItem>
                      ...
                      <form_1.FormControl>
                        <input_1.Input placeholder/>\"Título da notificação...\" 
                          {...field} 
                        />
                      </form_1.FormControl>
                      <form_1.FormDescription>
...
(<form_1.FormItem>
                      ...
                      <form_1.FormControl>
                        <textarea_1.Textarea placeholder/>\"Conteúdo da notificação...\"
