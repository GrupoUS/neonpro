...
export function NotificationSender({ onNotificationSent }: NotificationSenderProps) {
  ...
  const onSubmit = async (data: NotificationFormData) => {
    try {
      ...
      const endpoint =
        data.recipientType === "single" ? "/api/notifications/send" : "/api/notifications/send";
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Digite o nome ou CPF do paciente</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
      ...
      render={() => (
        <FormItem>
          <div className="mb-4">
            ...
            <FormDescription>Selecione os canais para envio da notificação</FormDescription>
          </div>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Deixe vazio para enviar imediatamente</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
              <div className="space-y-0.5">
                <FormLabel className="text-base">Otimização Inteligente</FormLabel>
                <FormDescription>Usar IA para otimizar horário e canal de envio</FormDescription>
              </div>
              <FormControl>
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
              <div className="space-y-0.5">
                ...
                <FormDescription>Enviar apenas para administradores</FormDescription>
              </div>
              <FormControl>
                <Checkbox checked={field.value} onCheckedChange={field.onChange} />
              </FormControl>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>{field.value?.length || 0}/100 caracteres</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
              ...
              <div className="flex items-center justify-between pt-6">
                <div className="flex items-center space-x-2">
                  {form.watch("testMode") && <Badge variant="outline">Modo Teste</Badge>}
