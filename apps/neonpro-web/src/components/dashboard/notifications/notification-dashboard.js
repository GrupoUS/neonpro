...
function NotificationDashboard() {
    ...
    var _c = (0, react_1.useState)([]), recentNotifications = _c[0], setRecentNotifications = _c[1];
    ...
    // RENDER HELPERS
    // ================================================================================
    var renderOverviewCards = function () { return (<div className/>); };
    ...
    card_1.Card >
        <card_1.Card>
        <card_1.CardHeader className/>\"flex flex-row items-center justify-between space-y-0 pb-2\">
          <card_1.CardTitle className/>\"text-sm font-medium\">Engajamento</card_1.CardTitle>
            ,
    ...
    ;
    ;
    var renderRecentNotifications = function () { return (<card_1.Card>
      <card_1.CardHeader>
      ...
      <card_1.CardContent>
        <div className/>\"space-y-4\">
          {recentNotifications.map(function (notification) { return (<div key={notification.id} className/>); })}\"flex items-center justify-between space-x-4\"
            >
    ...
    div >
        <badge_1.Badge variant={notification.status === 'delivered' ? 'default' :
...
;
;
var renderQuickActions = function () { return (<card_1.Card>
      <card_1.CardHeader>
      ...
      <card_1.CardContent className/>\"space-y-4\">
        <button_1.Button className/>\"w-full justify-start\" 
          variant=\"outline\"
          onClick={function () { return setActiveTab('send'); }}
        >
          <icons_1.Icons.Send className/>\"mr-2 h-4 w-4\" />
          Enviar Notificação
        </button_1.Button>
    ,
...
;
div >
    <button_1.Button onClick={loadDashboardData} variant/>;
"outline\" size=\"sm\">
...
onNotificationSent = { loadDashboardData: loadDashboardData } /  >
;
tabs_1.TabsContent >
    <tabs_1.TabsContent value/>;
"history\">
