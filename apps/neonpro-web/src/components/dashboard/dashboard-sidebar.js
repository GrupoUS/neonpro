              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-foreground truncate">
                  {((_d = user === null || user === void 0 ? void 0 : user.user_metadata) ===
                    null || _d === void 0
                    ? void 0
                    : _d.full_name) || (user === null || user === void 0 ? void 0 : user.email)}
                </p>
            ...
            <div className="flex items-center gap-3 px-3 py-2">
              <avatar_1.Avatar className="h-8 w-8">
                ...
                <avatar_1.AvatarFallback>
                  ...
                  _f === void 0
                    ? void 0
                    : _f.charAt(0).toUpperCase()}
                </avatar_1.AvatarFallback>
              </avatar_1.Avatar>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-foreground truncate">
                  {((_g = user === null || user === void 0 ? void 0 : user.user_metadata) ===
                    null || _g === void 0
                    ? void 0
                    : _g.full_name) || (user === null || user === void 0 ? void 0 : user.email)}
                </p>
                <p className="text-xs text-muted-foreground truncate">
                  {user === null || user === void 0 ? void 0 : user.email}
                </p>
