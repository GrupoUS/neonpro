  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <card_1.Card>
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Pacientes Ativos</card_1.CardTitle>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <card_1.Card className="col-span-4">
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Suas consultas programadas para hoje</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent>
        ...
        <card_1.Card className="col-span-3">
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Estatísticas importantes</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
