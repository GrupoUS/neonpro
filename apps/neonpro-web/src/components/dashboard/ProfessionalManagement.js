...
function ProfessionalManagement(_a) {
    var _this = this;
    var _b = _a.initialProfessionals, initialProfessionals = _b === void 0 ? [] : _b;
    var router = (0, navigation_1.useRouter)();
    var _c = (0, react_1.useState)(initialProfessionals), professionals = _c[0], setProfessionals = _c[1];
    var _d = (0, react_1.useState)(initialProfessionals), filteredProfessionals = _d[0], setFilteredProfessionals = _d[1];
    ...
    var _j = (0, react_1.useState)('all'), specialtyFilter = _j[0], setSpecialtyFilter = _j[1];
    var _k = (0, react_1.useState)(null), selectedProfessional = _k[0], setSelectedProfessional = _k[1];
    var _l = (0, react_1.useState)([]), credentials = _l[0], setCredentials = _l[1];
    var _m = (0, react_1.useState)([]), services = _m[0], setServices = _m[1];
    var _o = (0, react_1.useState)(false), showDetailsDialog = _o[0], setShowDetailsDialog = _o[1];
    var _p = (0, react_1.useState)(false), showDeleteDialog = _p[0], setShowDeleteDialog = _p[1];
    var _q = (0, react_1.useState)(null), professionalToDelete = _q[0], setProfessionalToDelete = _q[1];
    ...
    var calculateStats = function (professionalsData) {
        ...
        var active = professionalsData.filter(function (p) { return p.status === 'active'; }).length;
        var pending_verification = professionalsData.filter(function (p) { return p.status === 'pending_verification'; }).length;
    ...
    var filterProfessionals = function () {
        ...
        if (searchTerm) {
            filtered = filtered.filter(function (professional) {
                var _a, _b;
                return professional.given_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
                    professional.family_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
                    ((_a = professional.email) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(searchTerm.toLowerCase())) ||
                    ((_b = professional.license_number) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(searchTerm.toLowerCase()));
            });
        }
        // Status filter
        if (statusFilter !== 'all') {
            filtered = filtered.filter(function (professional) { return professional.status === statusFilter; });
        }
    ...
    var handleViewDetails = function (professional) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var confirmDelete = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    setProfessionals(function (prev) { return prev.filter(function (p) { return p.id !== professionalToDelete.id; }); });
    ...
    var handleVerifyCredential = function (credentialId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, (0, professionals_1.verifyCredential)(credentialId)
                        // Reload credentials
                    ];
                case 1:
                    _a.sent();
                    if (!selectedProfessional) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0, professionals_1.getProfessionalCredentials)(selectedProfessional.id)];
                case 2:
    ...
    return (<div className="flex-1 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button_1.Button onClick={function () { return router.push('/dashboard/professionals/new'); }}>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <card_1.Card>
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Total de Profissionais</card_1.CardTitle>
        ...
        <card_1.Card>
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Profissionais Ativos</card_1.CardTitle>
        ...
        <card_1.Card>
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Pendente Verificação</card_1.CardTitle>
        ...
        <card_1.Card>
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Credenciais Expirando</card_1.CardTitle>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex flex-1 gap-4">
              <div className="relative max-w-sm">
                ...
                <input_1.Input placeholder="Buscar profissionais..." value={searchTerm} onChange={function (e) { return setSearchTerm(e.target.value); }} className="pl-8"/>
              </div>
              ...
              <select_1.Select value={specialtyFilter} onValueChange={setSpecialtyFilter}>
                ...
                <select_1.SelectContent>
                  ...
                  <select_1.SelectItem value="plastic_surgery">Cirurgia Plástica</select_1.SelectItem>
          ...
          <table_1.Table>
            ...
            <table_1.TableBody>
              {loading ? (<table_1.TableRow>
                ...
                </table_1.TableRow>) : filteredProfessionals.length === 0 ? (<table_1.TableRow>
                  <table_1.TableCell colSpan={6} className="text-center py-8">
                    Nenhum profissional encontrado
                  </table_1.TableCell>
                </table_1.TableRow>) : (filteredProfessionals.map(function (professional) { return (<table_1.TableRow key={professional.id}>
                    <table_1.TableCell>
                    ...
                    <table_1.TableCell className="text-right">
                      <dropdown_menu_1.DropdownMenu>
                        ...
                        <dropdown_menu_1.DropdownMenuContent align="end">
                          ...
                          <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleViewDetails(professional); }}>
                            <lucide_react_1.Eye className="mr-2 h-4 w-4"/>
                            Ver Detalhes
                          </dropdown_menu_1.DropdownMenuItem>
                          <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleEdit(professional); }}>
                            <lucide_react_1.Edit className="mr-2 h-4 w-4"/>
                            Editar
                          </dropdown_menu_1.DropdownMenuItem>
                          <dropdown_menu_1.DropdownMenuSeparator />
                          <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleDelete(professional); }} className="text-destructive">
        ...
        <dialog_1.DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          <dialog_1.DialogHeader>
            ...
            <dialog_1.DialogDescription>
              Informações completas sobre {selectedProfessional === null || selectedProfessional === void 0 ? void 0 : selectedProfessional.given_name} {selectedProfessional === null || selectedProfessional === void 0 ? void 0 : selectedProfessional.family_name}
            </dialog_1.DialogDescription>
          </dialog_1.DialogHeader>
          
          {selectedProfessional && (<tabs_1.Tabs defaultValue="overview" className="w-full">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div><strong>Status:</strong> 
                        <badge_1.Badge className="ml-2" variant={getStatusBadgeVariant(selectedProfessional.status)}>
              ...
              <tabs_1.TabsContent value="credentials" className="space-y-4">
                ...
                <div className="space-y-3">
                  {credentials.map(function (credential) { return (<card_1.Card key={credential.id}>
                      <card_1.CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {credential.verification_status === 'pending' && (<button_1.Button size="sm" variant="outline" onClick={function () { return handleVerifyCredential(credential.id); }}>
                                Verificar
                              </button_1.Button>)}
                          </div>
                        </div>
              ...
              <tabs_1.TabsContent value="services" className="space-y-4">
                ...
                var _a;
                return (<card_1.Card key={service.id}>
                      <card_1.CardContent className="p-4">
          ...
          <dialog_1.DialogFooter>
            <button_1.Button variant="outline" onClick={function () { return setShowDetailsDialog(false); }}>
              Fechar
            </button_1.Button>
            {selectedProfessional && (<button_1.Button onClick={function () { return handleEdit(selectedProfessional); }}>
                <lucide_react_1.Edit className="mr-2 h-4 w-4"/>
                Editar Profissional
              </button_1.Button>)}
          </dialog_1.DialogFooter>
      ...
      <dialog_1.Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <dialog_1.DialogContent>
          <dialog_1.DialogHeader>
            ...
            <dialog_1.DialogDescription>
              Tem certeza que deseja remover o profissional {professionalToDelete === null || professionalToDelete === void 0 ? void 0 : professionalToDelete.given_name} {professionalToDelete === null || professionalToDelete === void 0 ? void 0 : professionalToDelete.family_name}?
              Esta ação não pode ser desfeita.
            </dialog_1.DialogDescription>
          </dialog_1.DialogHeader>
          <dialog_1.DialogFooter>
            <button_1.Button variant="outline" onClick={function () { return setShowDeleteDialog(false); }} disabled={loading}>
              Cancelar
            </button_1.Button>
