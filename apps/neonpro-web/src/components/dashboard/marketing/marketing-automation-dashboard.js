...
function MarketingAutomationDashboard() {
    ...
    var _d = (0, react_1.useState)([]), triggers = _d[0], setTriggers = _d[1];
    ...
    var _g = (0, react_1.useState)(null), selectedCampaign = _g[0], setSelectedCampaign = _g[1];
    var _h = (0, react_1.useState)({}), editingCampaign = _h[0], setEditingCampaign = _h[1];
    (0, react_1.useEffect)(function () {
        loadCampaigns();
        loadTemplates();
        loadTriggers();
    }, []);
    var loadCampaigns = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loadTriggers = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var createCampaign = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var updateCampaign = function (campaignId, updates) { return __awaiter(_this, void 0, void 0, function () {
        var response, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("/api/marketing/campaigns/".concat(campaignId), {
                            method: 'PATCH',
                            headers: { 'Content-Type': 'application/json' },
    ...
    var deleteCampaign = function (campaignId) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var runCampaign = function (campaignId) { return __awaiter(_this, void 0, void 0, function () {
        var response, error_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("/api/marketing/campaigns/".concat(campaignId, "/run"), {
                            method: 'POST',
                        })];
                case 1:
                    response = _a.sent();
    ...
    var pauseCampaign = function (campaignId) { return __awaiter(_this, void 0, void 0, function () {
        var response, error_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("/api/marketing/campaigns/".concat(campaignId, "/pause"), {
                            method: 'POST',
                        })];
                case 1:
                    response = _a.sent();
    ...
    var getStatusBadge = function (status) {
        switch (status) {
            case 'active':
                return <badge_1.Badge className="bg-green-100 text-green-800"><lucide_react_1.Play className="w-3 h-3 mr-1"/>Active</badge_1.Badge>;
            case 'paused':
                return <badge_1.Badge className="bg-yellow-100 text-yellow-800"><lucide_react_1.Pause className="w-3 h-3 mr-1"/>Paused</badge_1.Badge>;
            case 'completed':
                return <badge_1.Badge className="bg-blue-100 text-blue-800"><lucide_react_1.CheckCircle className="w-3 h-3 mr-1"/>Completed</badge_1.Badge>;
            case 'archived':
    ...
    var getCampaignTypeIcon = function (type) {
        var campaignType = CAMPAIGN_TYPES.find(function (t) { return t.value === type; });
        if (campaignType) {
    ...
    var formatMetrics = function (metrics) {
        if (!metrics)
            return 'No data';
        var openRate = metrics.total_sent > 0 ? (metrics.opened / metrics.total_sent * 100).toFixed(1) : '0';
        var clickRate = metrics.opened > 0 ? (metrics.clicked / metrics.opened * 100).toFixed(1) : '0';
        var conversionRate = metrics.total_sent > 0 ? (metrics.converted / metrics.total_sent * 100).toFixed(1) : '0';
        return "".concat(openRate, "% open, ").concat(clickRate, "% click, ").concat(conversionRate, "% conversion");
    };
    ...
    if (loading) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {__spreadArray([], Array(3), true).map(function (_, i) { return (<div key={i} className="h-32 bg-gray-200 rounded animate-pulse"/>); })}
        </div>
      </div>);
    }
    return (<div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  {campaigns.filter(function (c) { return c.status === 'active'; }).length}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">
                  {formatRevenue(campaigns.reduce(function (sum, c) { var _a; return sum + (((_a = c.performance_metrics) === null || _a === void 0 ? void 0 : _a.revenue) || 0); }, 0))}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {campaigns.length > 0 ? (campaigns.reduce(function (sum, c) {
            var metrics = c.performance_metrics;
            if (!metrics || metrics.total_sent === 0)
                return sum;
            return sum + (metrics.converted / metrics.total_sent * 100);
        }, 0) / campaigns.filter(function (c) { var _a; return (_a = c.performance_metrics) === null || _a === void 0 ? void 0 : _a.total_sent; }).length).toFixed(1) : '0'}%
                </p>
              </div>
      ...
      <card_1.Card>
            ...
            <dialog_1.Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
              ...
              <dialog_1.DialogContent className="max-w-2xl">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input_1.Input id="name" value={editingCampaign.name || ''} onChange={function (e) { return setEditingCampaign(function (prev) { return (__assign(__assign({}, prev), { name: e.target.value })); }); }} placeholder="Enter campaign name"/>
                    </div>
                    
                    <div>
                      <label_1.Label htmlFor="type">Campaign Type</label_1.Label>
                      <select_1.Select value={editingCampaign.type || ''} onValueChange={function (value) { return setEditingCampaign(function (prev) { return (__assign(__assign({}, prev), { type: value })); }); }}>
                        <select_1.SelectTrigger>
                          <select_1.SelectValue placeholder="Select campaign type"/>
                        </select_1.SelectTrigger>
                        <select_1.SelectContent>
                          {CAMPAIGN_TYPES.map(function (type) { return (<select_1.SelectItem key={type.value} value={type.value}>
                  ...
                  <div>
                    ...
                    <textarea_1.Textarea id="description" value={editingCampaign.description || ''} onChange={function (e) { return setEditingCampaign(function (prev) { return (__assign(__assign({}, prev), { description: e.target.value })); }); }} placeholder="Describe the campaign goals and strategy" rows={3}/>
                  </div>
                  
                  {editingCampaign.type && (<alert_1.Alert>
                      <lucide_react_1.AlertTriangle className="w-4 h-4"/>
                      <alert_1.AlertDescription>
                        {(_a = CAMPAIGN_TYPES.find(function (t) { return t.value === editingCampaign.type; })) === null || _a === void 0 ? void 0 : _a.description}
                      </alert_1.AlertDescription>
                    </alert_1.Alert>)}
                </div>
                ...
                <dialog_1.DialogFooter>
                  ...
                  <button_1.Button onClick={createCampaign} disabled={!editingCampaign.name || !editingCampaign.type}>
                    Create Campaign
                  </button_1.Button>
                </dialog_1.DialogFooter>
        ...
        <card_1.CardContent>
            ...
            return (<table_1.TableRow key={campaign.id}>
                  <table_1.TableCell>
                    <div>
                      ...
                      {campaign.description && (<p className="text-sm text-gray-500 truncate max-w-xs">
                  ...
                  <table_1.TableCell className="text-sm font-medium">
                    {((_a = campaign.performance_metrics) === null || _a === void 0 ? void 0 : _a.revenue)
                  ...
                  <table_1.TableCell>
                    <div className="flex items-center space-x-2">
                      {campaign.status === 'draft' || campaign.status === 'paused' ? (<button_1.Button variant="ghost" size="sm" onClick={function () { return runCampaign(campaign.id); }}>
                          <lucide_react_1.Play className="w-4 h-4"/>
                        </button_1.Button>) : campaign.status === 'active' ? (<button_1.Button variant="ghost" size="sm" onClick={function () { return pauseCampaign(campaign.id); }}>
                      ...
                      <dropdown_menu_1.DropdownMenu>
                        ...
                        <dropdown_menu_1.DropdownMenuContent align="end">
                          ...
                          <dropdown_menu_1.DropdownMenuItem onClick={function () { return deleteCampaign(campaign.id); }} className="text-red-600">
          ...
          {campaigns.length === 0 && (<div className="text-center py-8">
              ...
              <button_1.Button className="mt-4" onClick={function () { return setShowCreateDialog(true); }}>
                <lucide_react_1.Plus className="w-4 h-4 mr-2"/>
