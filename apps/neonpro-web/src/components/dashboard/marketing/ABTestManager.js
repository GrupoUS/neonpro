...
function ABTestManager(_a) {
    var _this = this;
    var campaignId = _a.campaignId, onTestCreated = _a.onTestCreated;
    ...
    var _e = (0, react_1.useState)(null), selectedTest = _e[0], setSelectedTest = _e[1];
    ...
    var loadABTests = function () { return __awaiter(_this, void 0, void 0, function () {
        var mockTests;
    ...
    var handleCreateTest = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("/api/campaigns/".concat(campaignId, "/ab-test"), {
                            method: "POST",
    ...
    var updateVariationPercentage = function (variationKey, percentage) {
        ...
        var otherKey = variationKeys.find(function (key) { return key !== variationKey; });
        if (otherKey) {
            variations[variationKey].percentage = percentage;
            variations[otherKey].percentage = 100 - percentage;
            setFormData(function (prev) { return (__assign(__assign({}, prev), { variations: variations })); });
        }
    };
    var getStatusBadge = function (status) {
        ...
        return (<badge_1.Badge className={"".concat(config.color, " text-white")}>{config.text}</badge_1.Badge>);
    };
    ...
    return (<div className="space-y-6">
        ...
        <card_1.CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input_1.Input id="test_name" value={formData.test_name} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { test_name: e.target.value })); });
        }} placeholder="Ex: Teste de Assunto do Email"/>
            </div>

            <div>
              <label_1.Label htmlFor="success_metric">Métrica de Sucesso</label_1.Label>
              <select_1.Select value={formData.success_metric} onValueChange={function (value) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { success_metric: value })); });
        }}>
          ...
          <div>
            ...
            <textarea_1.Textarea id="hypothesis" value={formData.hypothesis} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { hypothesis: e.target.value })); });
        }} placeholder="Ex: Assuntos mais personalizados aumentam a taxa de abertura em 15%" rows={2}/>
          </div>
          ...
          <div className="space-y-4">
            ...
            return (<card_1.Card key={key} className="p-4">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <h4 className="font-medium">{variation.name}</h4>
                      <div className="flex items-center space-x-2">
                        <label_1.Label className="text-sm">Tráfego:</label_1.Label>
                        <input_1.Input type="number" min="10" max="90" value={variation.percentage} onChange={function (e) {
                    ...
                    <textarea_1.Textarea value={variation.content} onChange={function (e) {
                    var variations = __assign({}, formData.variations);
                    variations[key].content = e.target.value;
                    setFormData(function (prev) { return (__assign(__assign({}, prev), { variations: variations })); });
                }} placeholder="Conteúdo da variação..." rows={2}/>
                  </div>
                </card_1.Card>);
        })}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select_1.Select value={formData.confidence_level.toString()} onValueChange={function (value) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { confidence_level: parseInt(value) })); });
        }}>
                <select_1.SelectTrigger>
            ...
            <div>
              ...
              <input_1.Input id="duration_days" type="number" min="3" max="30" value={formData.duration_days} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { duration_days: parseInt(e.target.value) || 14 })); });
        }}/>
            </div>
          </div>

          <button_1.Button onClick={handleCreateTest} disabled={isCreating || !formData.test_name || !formData.hypothesis} className="w-full">
      ...
      <div className="space-y-4">
        ...
        {tests.map(function (test) { return (<card_1.Card key={test.id}>
            <card_1.CardHeader>
              <div className="flex items-center justify-between">
                <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {test.status === "running" &&
                test.statistical_significance && (<badge_1.Badge variant="outline">
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                ...
                return (<div key={key} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {test.winner_variation === key && (<badge_1.Badge className="bg-yellow-500 text-white">
                ...
                {test.status === "running" && test.statistical_significance && (<div className="space-y-2">
                    ...
                    {test.statistical_significance >= 0.95 ? (<p className="text-sm text-green-600">
                        ✓ Resultado estatisticamente significativo! Pode
                        declarar vencedor.
                      </p>) : (<p className="text-sm text-yellow-600">
                ...
                <div className="flex items-center space-x-2 pt-2">
                  ...
                  {test.status === "running" && (<>
                    ...
                    test.statistical_significance >= 0.95 && (<button_1.Button size="sm">
                            <lucide_react_1.Trophy className="h-4 w-4 mr-2"/>
                            Declarar Vencedor
                          </button_1.Button>)}
                    </>)}

                  {test.status === "draft" && (<button_1.Button size="sm">
