...
function PersonalizationEngine(_a) {
    var _this = this;
    var campaignId = _a.campaignId, onRuleCreated = _a.onRuleCreated;
    var _b = (0, react_1.useState)([]), rules = _b[0], setRules = _b[1];
    var _c = (0, react_1.useState)([]), templates = _c[0], setTemplates = _c[1];
    var _d = (0, react_1.useState)(false), isLoading = _d[0], setIsLoading = _d[1];
    var _e = (0, react_1.useState)("rules"), activeTab = _e[0], setActiveTab = _e[1];
    ...
    var _f = (0, react_1.useState)({
        ...
        priority: 5,
        is_active: true,
    }), ruleForm = _f[0], setRuleForm = _f[1];
    ...
    }), templateForm = _g[0], setTemplateForm = _g[1];
    var loadPersonalizationData = function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                mockTemplates = [
                    {
                        ...
                        base_template: "Olá {{first_name}}, como membro {{vip_tier}}, temos uma oferta exclusiva...",
                        personalization_fields: {
                    ...
                    },
                    {
                        ...
                        base_template: "Sentimos sua falta, {{first_name}}! Veja o que há de novo em {{favorite_category}}...",
                        personalization_fields: {
                            tone: "friendly",
    ...
    var handleCreateRule = function () { return __awaiter(_this, void 0, void 0, function () {
        var ruleData;
        return __generator(this, function (_a) {
            try {
                ruleData = {
    ...
    var getPriorityBadge = function (priority) {
        if (priority >= 8)
            return <badge_1.Badge className="bg-red-500 text-white">Alta</badge_1.Badge>;
        if (priority >= 5)
    ...
    var addContentVariable = function () {
        ...
        if (newVar && !templateForm.content_variables.includes(newVar)) {
            setTemplateForm(function (prev) { return (__assign(__assign({}, prev), { content_variables: __spreadArray(__spreadArray([], prev.content_variables, true), [newVar], false) })); });
        }
    };
    var removeContentVariable = function (variable) {
        setTemplateForm(function (prev) { return (__assign(__assign({}, prev), { content_variables: prev.content_variables.filter(function (v) { return v !== variable; }) })); });
    };
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {rules.filter(function (r) { return r.is_active; }).length}
                </p>
              </div>
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <tabs_1.TabsContent value="rules" className="space-y-6">
            ...
            <card_1.CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input_1.Input id="rule_name" value={ruleForm.name} onChange={function (e) {
            return setRuleForm(function (prev) { return (__assign(__assign({}, prev), { name: e.target.value })); });
        }} placeholder="Ex: Personalização VIP"/>
                </div>

                <div>
                  <label_1.Label htmlFor="priority">Prioridade</label_1.Label>
                  <select_1.Select value={ruleForm.priority.toString()} onValueChange={function (value) {
            return setRuleForm(function (prev) { return (__assign(__assign({}, prev), { priority: parseInt(value) })); });
        }}>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select_1.Select value={ruleForm.conditions.segment_id} onValueChange={function (value) {
            return setRuleForm(function (prev) { return (__assign(__assign({}, prev), { conditions: __assign(__assign({}, prev.conditions), { segment_id: value }) })); });
        }}>
                      <select_1.SelectTrigger>
                  ...
                  <div>
                    <label_1.Label htmlFor="engagement_level">
                      Nível de Engajamento
                    </label_1.Label>
                    <select_1.Select value={ruleForm.conditions.engagement_level} onValueChange={function (value) {
            return setRuleForm(function (prev) { return (__assign(__assign({}, prev), { conditions: __assign(__assign({}, prev.conditions), { engagement_level: value }) })); });
        }}>
                      <select_1.SelectTrigger>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label_1.Label htmlFor="content_variation">
                      Variação de Conteúdo
                    </label_1.Label>
                    <select_1.Select value={ruleForm.actions.content_variation} onValueChange={function (value) {
            return setRuleForm(function (prev) { return (__assign(__assign({}, prev), { actions: __assign(__assign({}, prev.actions), { content_variation: value }) })); });
        }}>
                      <select_1.SelectTrigger>
                  ...
                  <div>
                    ...
                    <select_1.Select value={ruleForm.actions.channel_preference} onValueChange={function (value) {
            return setRuleForm(function (prev) { return (__assign(__assign({}, prev), { actions: __assign(__assign({}, prev.actions), { channel_preference: value }) })); });
        }}>
                      <select_1.SelectTrigger>
                ...
                <div className="flex items-center space-x-2">
                  <switch_1.Switch id="send_time_optimization" checked={ruleForm.actions.send_time_optimization} onCheckedChange={function (checked) {
            return setRuleForm(function (prev) { return (__assign(__assign({}, prev), { actions: __assign(__assign({}, prev.actions), { send_time_optimization: checked }) })); });
        }}/>
              ...
              <div className="flex items-center space-x-2">
                <switch_1.Switch id="is_active" checked={ruleForm.is_active} onCheckedChange={function (checked) {
            return setRuleForm(function (prev) { return (__assign(__assign({}, prev), { is_active: checked })); });
        }}/>
                <label_1.Label htmlFor="is_active">Regra Ativa</label_1.Label>
              </div>

              <button_1.Button onClick={handleCreateRule} disabled={!ruleForm.name} className="w-full">
          ...
          <div className="space-y-4">
            ...
            {rules.map(function (rule) { return (<card_1.Card key={rule.id}>
                <card_1.CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {rule.is_active ? (<badge_1.Badge className="bg-green-500 text-white">Ativa</badge_1.Badge>) : (<badge_1.Badge variant="outline">Inativa</badge_1.Badge>)}
                    </div>
                  </div>
                </card_1.CardHeader>
                <card_1.CardContent>
                  <div className="space-y-4">
                    {/* Performance Score */}
                    {rule.performance_score && (<div className="flex items-center justify-between">
                        <span className="text-sm font-medium">
                          Performance:
                        </span>
                        <div className="flex items-center space-x-2">
                          <span className={"font-bold ".concat(getPerformanceColor(rule.performance_score))}>
                            {rule.performance_score.toFixed(1)}/10
                          </span>
                          <progress_1.Progress value={rule.performance_score * 10} className="w-20"/>
                        </div>
                      </div>)}
        ...
        <tabs_1.TabsContent value="templates" className="space-y-6">
          ...
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input_1.Input id="template_name" value={templateForm.name} onChange={function (e) {
            return setTemplateForm(function (prev) { return (__assign(__assign({}, prev), { name: e.target.value })); });
                ...
                <div>
                  ...
                  <select_1.Select value={templateForm.type} onValueChange={function (value) {
            return setTemplateForm(function (prev) { return (__assign(__assign({}, prev), { type: value })); });
        }}>
                    <select_1.SelectTrigger>
                      <select_1.SelectValue />
                    </select_1.SelectTrigger>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {templateForm.content_variables.map(function (variable) { return (<badge_1.Badge key={variable} variant="outline" className="flex items-center gap-1">
                      {"{{".concat(variable, "}}")}
                      <button onClick={function () { return removeContentVariable(variable); }} className="ml-1 text-xs hover:text-red-500">
                        ×
                      </button>
                    </badge_1.Badge>); })}
                </div>
              ...
              <div>
                ...
                <textarea_1.Textarea id="base_template" value={templateForm.base_template} onChange={function (e) {
            return setTemplateForm(function (prev) { return (__assign(__assign({}, prev), { base_template: e.target.value })); });
        }} placeholder="Ex: Olá {{first_name}}, como membro {{vip_tier}}..." rows={4}/>
                <p className="text-xs text-muted-foreground mt-1">
                  Use {"{{variable}}"} para inserir variáveis dinâmicas
                </p>
              </div>

              <button_1.Button onClick={handleCreateTemplate} disabled={!templateForm.name || !templateForm.base_template} className="w-full">
                Criar Template
              </button_1.Button>
            </card_1.CardContent>
          </card_1.Card>
          ...
          <div className="space-y-4">
            ...
            {templates.map(function (template) { return (<card_1.Card key={template.id}>
                <card_1.CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {template.conversion_rate && (<badge_1.Badge className="bg-green-500 text-white">
                ...
                <card_1.CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {template.content_variables.map(function (variable) { return (<badge_1.Badge key={variable} variant="outline">
                            {"{{".concat(variable, "}}")}
                          </badge_1.Badge>); })}
                      </div>
                    </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {rules
            .filter(function (r) { return r.performance_score; })
            .sort(function (a, b) {
            return (b.performance_score || 0) -
                (a.performance_score || 0);
        })
            .slice(0, 3)
            .map(function (rule, index) {
            var _a;
            return (<div key={rule.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          ...
                          <div className="text-right">
                            <div className={"font-bold ".concat(getPerformanceColor(rule.performance_score))}>
                              {(_a = rule.performance_score) === null || _a === void 0 ? void 0 : _a.toFixed(1)}/10
                            </div>
