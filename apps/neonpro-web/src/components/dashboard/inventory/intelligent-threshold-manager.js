...
function IntelligentThresholdManager(_a) {
  ...
  var _b = (0, useIntelligentThresholds_1.useIntelligentThresholds)({
    ...
    optimizations = _b.optimizations,
    alertStats = _b.alertStats,
    loading = _b.loading,
    error = _b.error,
    refresh = _b.refresh,
    createThreshold = _b.createThreshold,
    updateThreshold = _b.updateThreshold,
    deleteThreshold = _b.deleteThreshold,
    generateForecast = _b.generateForecast,
    totalThresholds = _b.totalThresholds,
    activeThresholds = _b.activeThresholds,
    autoReorderEnabled = _b.autoReorderEnabled,
    optimizationOpportunities = _b.optimizationOpportunities,
    totalPotentialSavings = _b.totalPotentialSavings;
  var _c = (0, react_1.useState)(null),
    selectedThreshold = _c[0],
    setSelectedThreshold = _c[1];
  var _d = (0, react_1.useState)(false),
    showCreateDialog = _d[0],
    setShowCreateDialog = _d[1];
  var _e = (0, react_1.useState)(false),
    showOptimizationDialog = _e[0],
    setShowOptimizationDialog = _e[1];
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              createThreshold(
                __assign(__assign({}, newThreshold), { clinic_id: clinicId, is_active: true }),
              ),
            ];
          case 1:
            _a.sent();
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              updateThreshold(optimization.item_id, {
...
function PredictiveAnalytics(_a) {
  var clinicId = _a.clinicId,
    generateForecast = _a.generateForecast;
  return (
    <card_1.Card>
      <card_1.CardHeader>
