...
function InventoryDashboard(_a) {
    var _b = _a.defaultTab, defaultTab = _b === void 0 ? "overview" : _b;
    var _c = (0, react_1.useState)(defaultTab), activeTab = _c[0], setActiveTab = _c[1];
    var _d = (0, useInventoryAlerts_1.useInventoryAlerts)(), unreadCount = _d.unreadCount, criticalCount = _d.criticalCount;
    // =====================================================================================
    // QUICK STATS COMPONENT
    // =====================================================================================
    var QuickStats = function () { return (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <card_1.Card>
    ...
    // =====================================================================================
    var QuickActions = function () { return (<card_1.Card className="mb-6">
      <card_1.CardHeader>
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <tabs_1.TabsList className="grid w-full grid-cols-7">
          ...
          <tabs_1.TabsTrigger value="alerts" className="relative">
            Alerts
            {unreadCount > 0 && (<badge_1.Badge variant="destructive" className="absolute -top-2 -right-2 h-5 w-5 p-0 text-xs">
        ...
        <tabs_1.TabsContent value="forecasting" className="space-y-4">
          <demand_forecasting_engine_1.DemandForecastingEngine clinicId="default-clinic" inventoryItems={[
            {
                id: "1",
                name: "Botox",
        ...
        <tabs_1.TabsContent value="budget" className="space-y-4">
          <budget_approval_workflow_1.BudgetApprovalWorkflow clinicId="default-clinic" onBudgetCreated={function () {
