...
function SupplierDashboard(_a) {
  ...
  var _s = (0, useSupplierManagement_1.useSupplierManagement)({
    ...
    dashboardData = _s.dashboardData,
    contractAlerts = _s.contractAlerts,
    qualityIssuesSummary = _s.qualityIssuesSummary,
    analytics = _s.analytics,
    isLoading = _s.isLoading,
    error = _s.error,
    loadSuppliers = _s.loadSuppliers,
    loadDashboardData = _s.loadDashboardData,
    loadContractAlerts = _s.loadContractAlerts,
    loadQualityIssuesSummary = _s.loadQualityIssuesSummary,
    loadAnalytics = _s.loadAnalytics,
    refreshData = _s.refreshData;
  ...
  if (error) {
    return (
      <card_1.Card className="border-destructive">
        <card_1.CardHeader>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {(dashboardData === null || dashboardData === void 0
                ? void 0
                : dashboardData.activeSuppliers) || 0}{" "}
              ativos
            </p>
          </card_1.CardContent>
        </card_1.Card>
        ...
        <card_1.Card>
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Performance Média</card_1.CardTitle>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              {((_b =
                dashboardData === null || dashboardData === void 0
                  ? void 0
                  : dashboardData.averagePerformance) === null || _b === void 0
                ? void 0
                : _b.toFixed(1)) || "0.0"}
              %
            </div>
        ...
        <card_1.Card>
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Contratos Vencendo</card_1.CardTitle>
        ...
        <card_1.Card>
          <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <card_1.CardTitle className="text-sm font-medium">Issues de Qualidade</card_1.CardTitle>
        ...
        <tabs_1.TabsContent value="overview" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          ...
                          <div key={supplier.id} className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                              ...
                              {supplier.is_preferred && (
                                <lucide_react_1.Star className="h-4 w-4 text-yellow-500 fill-yellow-500" />
                              )}
                            </div>
                            <div className="text-right">
                              <div
                                className={"font-semibold ".concat(
                                  getPerformanceColor(supplier.performance_score || 0),
                                )}
                              >
                                {((_a = supplier.performance_score) === null || _a === void 0
                                  ? void 0
                                  : _a.toFixed(1)) || "0.0"}
                                %
                              </div>
                              <div className="text-xs text-muted-foreground">
                                {((_b = supplier.delivery_reliability) === null || _b === void 0
                                  ? void 0
                                  : _b.toFixed(0)) || "0"}
                                % entrega
                              </div>
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Contratos que requerem atenção</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
                <div className="space-y-4">
                  {contractAlerts === null || contractAlerts === void 0
          ...
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>Evolução da performance por categoria</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
              <div className="space-y-4">
                {(_d =
                        ...
                        <div key={alert.contractId} className="border rounded-lg p-4">
                          <div className="flex justify-between items-start">
                            <div className="space-y-1">
                              ...
                              <p className="text-sm">
                                Valor: R${" "}
                                {((_a = alert.contractValue) === null || _a === void 0
                                  ? void 0
                                  : _a.toLocaleString("pt-BR")) || "N/A"}
                              </p>
                            </div>
                            <div className="text-right">
                              <badge_1.Badge
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">
                            {((_f =
                              (_e = analytics.deliveryMetrics) === null || _e === void 0
                                ? void 0
                                : _e.onTimeDeliveryRate) === null || _f === void 0
                              ? void 0
                              : _f.toFixed(1)) || "0.0"}
                            %
                          </span>
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">
                            {((_h =
                              (_g = analytics.qualityMetrics) === null || _g === void 0
                                ? void 0
                                : _g.averageQualityRating) === null || _h === void 0
                              ? void 0
                              : _h.toFixed(1)) || "0.0"}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">
                            {((_k =
                              (_j = analytics.responseMetrics) === null || _j === void 0
                                ? void 0
                                : _j.averageResponseTime) === null || _k === void 0
                              ? void 0
                              : _k.toFixed(1)) || "0.0"}
                            h
                          </span>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">
                            R${" "}
                            {((_m =
                              (_l = analytics.costMetrics) === null || _l === void 0
                                ? void 0
                                : _l.totalSpent) === null || _m === void 0
                              ? void 0
                              : _m.toLocaleString("pt-BR")) || "0"}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold text-green-600">
                            R${" "}
                            {((_p =
                              (_o = analytics.costMetrics) === null || _o === void 0
                                ? void 0
                                : _o.savingsAchieved) === null || _p === void 0
                              ? void 0
                              : _p.toLocaleString("pt-BR")) || "0"}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span>ROI Médio:</span>
                          <span className="font-semibold">
                            {((_r =
                              (_q = analytics.costMetrics) === null || _q === void 0
                                ? void 0
                                : _q.averageROI) === null || _r === void 0
                              ? void 0
                              : _r.toFixed(1)) || "0.0"}
                            %
                          </span>
