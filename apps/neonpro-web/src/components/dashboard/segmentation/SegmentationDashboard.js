...
var SegmentationDashboard = function () {
    ...
    var _b = (0, react_1.useState)({}), performance = _b[0], setPerformance = _b[1];
    var _c = (0, react_1.useState)([]), rules = _c[0], setRules = _c[1];
    var _d = (0, react_1.useState)(true), loading = _d[0], setLoading = _d[1];
    var _e = (0, react_1.useState)(null), error = _e[0], setError = _e[1];
    var _f = (0, react_1.useState)("all"), selectedSegment = _f[0], setSelectedSegment = _f[1];
    var _g = (0, react_1.useState)("overview"), activeTab = _g[0], setActiveTab = _g[1];
    // New segment form state
    var _h = (0, react_1.useState)(false), showCreateDialog = _h[0], setShowCreateDialog = _h[1];
    ...
    }), newSegment = _j[0], setNewSegment = _j[1];
    (0, react_1.useEffect)(function () {
        loadSegmentationData();
    }, []);
    var loadSegmentationData = function () { return __awaiter(void 0, void 0, void 0, function () {
        var segmentsResponse, segmentsData, performanceData, _i, _a, segment, perfResponse, perfData, error_1, rulesResponse, rulesData, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    _b.trys.push([4, 8, , 9]);
                    return [4 /*yield*/, fetch("/api/segmentation/segments/".concat(segment.id, "/performance"))];
                case 5:
                ...
                case 8:
                    error_1 = _b.sent();
                    console.warn("Failed to load performance for segment ".concat(segment.id, ":"), error_1);
                    return [3 /*break*/, 9];
                case 9:
                    _i++;
                    return [3 /*break*/, 3];
                ...
                case 14:
                    ...
                    setError(error_2 instanceof Error
                        ? error_2.message
    ...
    var createSegment = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var filteredSegments = selectedSegment === "all"
        ? segments
        : segments.filter(function (s) { return s.id === selectedSegment; });
    var totalPatients = segments.reduce(function (sum, segment) { return sum + segment.member_count; }, 0);
    var aiGeneratedCount = segments.filter(function (s) { return s.ai_generated; }).length;
    var activeSegmentsCount = segments.filter(function (s) { return s.is_active; }).length;
    if (loading) {
            ...
            <dialog_1.DialogContent className="max-w-md">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input_1.Input id="segment-name" value={newSegment.name} onChange={function (e) {
            return setNewSegment(__assign(__assign({}, newSegment), { name: e.target.value }));
        }} placeholder="Ex: Pacientes Premium"/>
                </div>
                <div>
                  <label_1.Label htmlFor="segment-description">Descrição</label_1.Label>
                  <textarea_1.Textarea id="segment-description" value={newSegment.description} onChange={function (e) {
            return setNewSegment(__assign(__assign({}, newSegment), { description: e.target.value }));
        }} placeholder="Descreva o segmento..."/>
                </div>
                <div>
                  <label_1.Label htmlFor="segment-type">Tipo de Segmento</label_1.Label>
                  <select_1.Select value={newSegment.segment_type} onValueChange={function (value) {
            return setNewSegment(__assign(__assign({}, newSegment), { segment_type: value }));
        }}>
                ...
                <div className="flex items-center space-x-2">
                  <switch_1.Switch id="auto-update" checked={newSegment.auto_update} onCheckedChange={function (checked) {
            return setNewSegment(__assign(__assign({}, newSegment), { auto_update: checked }));
        }}/>
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <select_1.Select value={selectedSegment} onValueChange={setSelectedSegment}>
              ...
              <select_1.SelectContent>
                ...
                {segments.map(function (segment) { return (<select_1.SelectItem key={segment.id} value={segment.id}>
                    {segment.name}
                  </select_1.SelectItem>); })}
              </select_1.SelectContent>
            </select_1.Select>
        ...
        <tabs_1.TabsContent value="overview" className="space-y-4">
          <div className="grid gap-4">
            ...
            return (<card_1.Card key={segment.id}>
                  <card_1.CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        <card_1.CardTitle className="flex items-center gap-2">
                          ...
                          {segment.ai_generated && (<badge_1.Badge variant="secondary">
                              <lucide_react_1.Brain className="w-3 h-3 mr-1"/>
                              IA
                            </badge_1.Badge>)}
                          {segment.is_active ? (<badge_1.Badge variant="default">
                  ...
                  {segmentPerf && (<card_1.CardContent>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                          ...
                          <div className={"text-lg ".concat(segmentPerf.roi > 0 ? "text-green-600" : "text-red-600")}>
        ...
        <tabs_1.TabsContent value="segments" className="space-y-4">
          <div className="grid gap-4">
            {filteredSegments.map(function (segment) { return (<card_1.Card key={segment.id}>
                <card_1.CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                  ...
                  <card_1.CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <div className={"text-2xl font-bold ".concat(segmentPerf.roi > 0 ? "text-green-600" : "text-red-600")}>
                          {formatPercentage(segmentPerf.roi)}
                        </div>
                      </div>
                    </div>
            ...
            {rules.map(function (rule) { return (<card_1.Card key={rule.id}>
                <card_1.CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      {rule.requires_ai && (<badge_1.Badge variant="secondary">
                          <lucide_react_1.Brain className="w-3 h-3 mr-1"/>
                          IA
                        </badge_1.Badge>)}
