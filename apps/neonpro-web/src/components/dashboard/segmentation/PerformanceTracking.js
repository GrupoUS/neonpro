...
function PerformanceTracking() {
    var _this = this;
    var _a, _b, _c;
    var _d = (0, react_1.useState)([]), performanceData = _d[0], setPerformanceData = _d[1];
    var _e = (0, react_1.useState)(null), comparisonData = _e[0], setComparisonData = _e[1];
    var _f = (0, react_1.useState)(""), selectedSegment = _f[0], setSelectedSegment = _f[1];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    setSelectedSegment(((_a = mockData[0]) === null || _a === void 0 ? void 0 : _a.id) || "");
                    // Mock comparison data
                    setComparisonData({
                        segments: mockData.map(function (segment, index) { return ({
                            name: segment.name,
    ...
    var selectedSegmentData = performanceData.find(function (s) { return s.id === selectedSegment; });
          ...
          <card_1.CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-2">
                ...
                <div className="flex items-center">
                  <div className="text-2xl font-bold">
                    {formatPercentage(performanceData.reduce(function (acc, s) { return acc + s.metrics.engagementRate; }, 0) / performanceData.length)}
                  </div>
                </div>
              </div>
            </div>
          ...
          <card_1.CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-2">
                ...
                <div className="flex items-center">
                  <div className="text-2xl font-bold">
                    {formatPercentage(performanceData.reduce(function (acc, s) { return acc + s.metrics.conversionRate; }, 0) / performanceData.length)}
                  </div>
                </div>
              </div>
            </div>
          ...
          <card_1.CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-2">
                ...
                <div className="flex items-center">
                  <div className="text-2xl font-bold">
                    {formatPercentage(performanceData.reduce(function (acc, s) { return acc + s.campaigns.totalROI; }, 0) / performanceData.length)}
                  </div>
                </div>
              </div>
            </div>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="flex flex-wrap gap-2 mb-6">
                {performanceData.map(function (segment) { return (<button_1.Button key={segment.id} variant={selectedSegment === segment.id ? "default" : "outline"} onClick={function () { return setSelectedSegment(segment.id); }}>
                    {segment.name}
                  </button_1.Button>); })}
              </div>

              {selectedSegmentData && (<div className="space-y-6">
                  {/* Alerts */}
                  {selectedSegmentData.alerts.length > 0 && (<div className="space-y-2">
                      {selectedSegmentData.alerts.map(function (alert, index) { return (<alert_1.Alert key={index} variant={alert.type === "warning" ? "destructive" : "default"}>
                      ...
                      <card_1.CardContent className="p-6">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <progress_1.Progress value={selectedSegmentData.metrics.engagementRate} className="mt-2"/>
                          </div>
                      ...
                      <card_1.CardContent className="p-6">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <progress_1.Progress value={selectedSegmentData.metrics.conversionRate} className="mt-2"/>
                          </div>
                      ...
                      <card_1.CardContent className="p-6">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <progress_1.Progress value={selectedSegmentData.metrics.retentionRate} className="mt-2"/>
                          </div>
                        ...
                        <div className="grid grid-cols-3 gap-4 text-center">
                          <div>
                            ...
                            <div className="text-lg font-bold">
                              {formatPercentage(((_a = selectedSegmentData.trends[selectedSegmentData.trends.length - 1]) === null || _a === void 0 ? void 0 : _a.engagement) || 0)}
                            </div>
                          </div>
                          <div>
                            <div className="text-sm font-medium">
                            ...
                            <div className="text-lg font-bold">
                              {formatPercentage(((_b = selectedSegmentData.trends[selectedSegmentData.trends.length - 1]) === null || _b === void 0 ? void 0 : _b.conversion) || 0)}
                            </div>
                          </div>
                          <div>
                            <div className="text-sm font-medium">Revenue</div>
                            <div className="text-lg font-bold">
                              {formatCurrency(((_c = selectedSegmentData.trends[selectedSegmentData.trends.length - 1]) === null || _c === void 0 ? void 0 : _c.revenue) || 0)}
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <card_1.Card>
            ...
            <card_1.CardContent>
              <table_1.Table>
                ...
                <table_1.TableBody>
                  {performanceData.map(function (segment) { return (<table_1.TableRow key={segment.id}>
