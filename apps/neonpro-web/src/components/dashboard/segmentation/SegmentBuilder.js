...
function SegmentBuilder() {
    var _this = this;
    var _a = (0, react_1.useState)(""), segmentName = _a[0], setSegmentName = _a[1];
    var _b = (0, react_1.useState)(""), segmentDescription = _b[0], setSegmentDescription = _b[1];
    var _c = (0, react_1.useState)([
        { id: "1", field: "", operator: "", value: "" },
    ]), criteria = _c[0], setCriteria = _c[1];
    var _d = (0, react_1.useState)(null), preview = _d[0], setPreview = _d[1];
    var _e = (0, react_1.useState)(false), isBuilding = _e[0], setIsBuilding = _e[1];
    ...
    var removeCriteria = function (id) {
        setCriteria(criteria.filter(function (c) { return c.id !== id; }));
    };
    var updateCriteria = function (id, field, value) {
        setCriteria(criteria.map(function (c) {
            var _a;
    ...
    var generatePreview = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var saveSegment = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    segmentData = {
                        ...
                        criteria: criteria.filter(function (c) { return c.field && c.operator && c.value; }),
                        ai_model_config: {
    ...
    return (<div className="space-y-6">
        ...
        <card_1.CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input_1.Input id="segment-name" value={segmentName} onChange={function (e) { return setSegmentName(e.target.value); }} placeholder="e.g., High-Value Customers"/>
            </div>
            <div>
              <label_1.Label htmlFor="segment-description">Description</label_1.Label>
              <textarea_1.Textarea id="segment-description" value={segmentDescription} onChange={function (e) { return setSegmentDescription(e.target.value); }} placeholder="Describe this segment..." rows={3}/>
            </div>
          </div>
        </card_1.CardContent>
      </card_1.Card>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent className="space-y-4">
          {criteria.map(function (criterion, index) {
            var _a;
            return (<div key={criterion.id} className="border rounded-lg p-4 space-y-4">
              {index > 0 && (<div className="flex items-center gap-2">
                  <select_1.Select value={criterion.logicalOperator || "AND"} onValueChange={function (value) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <select_1.Select value={criterion.field} onValueChange={function (value) {
                    ...
                    <select_1.SelectContent>
                      {fieldOptions.map(function (option) { return (<select_1.SelectItem key={option.value} value={option.value}>
                          {option.label}
                        </select_1.SelectItem>); })}
                    </select_1.SelectContent>
                  </select_1.Select>
                ...
                <div>
                  ...
                  <select_1.Select value={criterion.operator} onValueChange={function (value) {
                    ...
                    <select_1.SelectContent>
                      {criterion.field &&
                    ((_a = operatorOptions[criterion.field]) === null || _a === void 0 ? void 0 : _a.map(function (option) { return (<select_1.SelectItem key={option.value} value={option.value}>
                            {option.label}
                          </select_1.SelectItem>); }))}
                    </select_1.SelectContent>
                  </select_1.Select>
                ...
                <div>
                  ...
                  <input_1.Input value={criterion.value} onChange={function (e) {
                    return updateCriteria(criterion.id, "value", e.target.value);
                }} placeholder="Enter value"/>
                </div>

                <div className="flex items-end">
                  <button_1.Button variant="outline" size="sm" onClick={function () { return removeCriteria(criterion.id); }} disabled={criteria.length === 1}>
      ...
      {/* Validation Errors */}
      {validationErrors.length > 0 && (<alert_1.Alert variant="destructive">
        ...
        <card_1.CardContent>
          ...
          {preview && (<div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                .slice(0, 2)
                .map(function (_a) {
                var service = _a[0], percentage = _a[1];
                return (<div key={service} className="flex justify-between text-sm">
