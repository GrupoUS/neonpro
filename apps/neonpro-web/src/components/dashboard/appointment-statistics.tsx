...
export function AppointmentStatistics({
  ...
  const statistics = useMemo(() => {
    ...
    const prevCompleted = previousPeriodAppointments.filter(
              ...
              <CardContent className="p-6">
                ...
                {stat.trend && (
                  <div className="mt-4 flex items-center space-x-1">
                    ...
                    <span className="text-sm text-muted-foreground">{stat.trend.label}</span>
                  </div>
                )}
              </CardContent>
            </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Breakdown dos agendamentos por status atual</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Indicadores de qualidade do atendimento</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Progress value={statistics.noShowRate} className="h-2" />
                <p className="text-xs text-muted-foreground">
                  Meta: ≤ 10% (
                  {statistics.noShowRate <= 10 ? (
                    <span className="text-green-600">Atingida ✓</span>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-blue-600">
                    {statistics.total > 0
                      ? (
                          ((statistics.confirmed + statistics.completed) / statistics.total) *
                          100
                        ).toFixed(1)
                      : 0}
                    %
                ...
                <Progress
                  value={
                    statistics.total > 0
                      ? ((statistics.confirmed + statistics.completed) / statistics.total) * 100
                      : 0
                  }
                  className="h-2"
                />
                <p className="text-xs text-muted-foreground">
                  {statistics.pending > 0 ? (
                    <>
                      {statistics.pending} agendamento{statistics.pending !== 1 ? "s" : ""} pendente
