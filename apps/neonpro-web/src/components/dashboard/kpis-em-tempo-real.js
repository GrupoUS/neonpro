    ...
    return (<card_1.Card>
      ...
      <card_1.CardContent>
        <div className="grid grid-cols-1 gap-4">
          {mockKpis.map(function (kpi, index) { return (<div key={index} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
              ...
              {kpi.trend && (<div className="text-sm font-medium text-green-600">
                  {kpi.trend}
                </div>)}
            </div>); })}
        </div>
