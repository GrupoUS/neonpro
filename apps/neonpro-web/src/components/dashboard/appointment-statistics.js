      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <card_1.Card>
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Indicadores de qualidade do atendimento</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {statistics.pending > 0
                    ? <>
                        {statistics.pending} agendamento{statistics.pending !== 1 ? "s" : ""}{" "}
                        pendente{statistics.pending !== 1 ? "s" : ""}
                      </>
