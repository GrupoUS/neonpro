...
function ExecutiveSummary(_a) {
  ...
  var clinicId = _a.clinicId,
    ...
    _e = _a.refreshInterval, // 5 minutes
  ...
  var handleExport = function () {
    ...
    link.href = url;
    link.download = "executive-summary-".concat(
    ...
    <card_1.Card className={className}>
      <card_1.CardHeader>
        ...
        <div className="flex items-center gap-4 text-sm text-muted-foreground">
          ...
          <span>
            Period: {(0, date_fns_1.format)(dateRange.from, "MMM dd")} -{" "}
            {(0, date_fns_1.format)(dateRange.to, "MMM dd")}
          </span>
        </div>
      </card_1.CardHeader>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {summaryData.financialSummary.cashFlow.trend === "positive" && (
                        <lucide_react_1.ArrowUp className="h-3 w-3 text-green-600" />
                      )}
                    </div>
                  </div>
                </card_1.CardContent>
                ...
                {summaryData.insights.map(function (insight) {
                  ...
                  return (
                    <card_1.Card
                      key={insight.id}
                      className={""
                        .concat(priorityConfig.borderColor, " ")
                        .concat(priorityConfig.bgColor)}
                    >
                      <card_1.CardContent className="p-4">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <badge_1.Badge
                                variant="outline"
                                className={"text-xs ".concat(priorityConfig.color)}
                              >
