...
function PerformanceMetrics(_a) {
    var _this = this;
    var clinicId = _a.clinicId, dateRange = _a.dateRange, _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.showTargets, showTargets = _c === void 0 ? true : _c, _d = _a.showBenchmarks, showBenchmarks = _d === void 0 ? true : _d, _e = _a.showTrends, showTrends = _e === void 0 ? true : _e, _f = _a.autoRefresh, autoRefresh = _f === void 0 ? true : _f, _g = _a.refreshInterval // 5 minutes
    , refreshInterval = _g === void 0 ? 300000 : _g // 5 minutes
    ;
    var _h = (0, react_1.useState)([]), metrics = _h[0], setMetrics = _h[1];
    var _j = (0, react_1.useState)(null), summary = _j[0], setSummary = _j[1];
    var _k = (0, react_1.useState)('all'), selectedCategory = _k[0], setSelectedCategory = _k[1];
    var _l = (0, react_1.useState)('grid'), selectedView = _l[0], setSelectedView = _l[1];
    var _m = (0, react_1.useState)(true), isLoading = _m[0], setIsLoading = _m[1];
    var _o = (0, react_1.useState)(new Date()), lastRefresh = _o[0], setLastRefresh = _o[1];
    var _p = (0, react_1.useState)('status'), sortBy = _p[0], setSortBy = _p[1];
    var _q = (0, react_1.useState)('desc'), sortOrder = _q[0], setSortOrder = _q[1];
    ...
    (0, react_1.useEffect)(function () {
        ...
        var interval = setInterval(function () {
            // Refresh metrics
            var refreshMetrics = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var filteredMetrics = metrics
        .filter(function (metric) { return selectedCategory === 'all' || metric.category === selectedCategory; })
        .sort(function (a, b) {
        var aValue, bValue;
        switch (sortBy) {
            case 'name':
    ...
    var handleExport = function () {
        ...
        link.href = url;
        link.download = "performance-metrics-".concat((0, date_fns_1.format)(new Date(), 'yyyy-MM-dd'), ".json");
        link.click();
      ...
      <card_1.CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            return (<select_1.SelectItem key={category.value} value={category.value}>
                      <div className="flex items-center gap-2">
        ...
        {summary && (<div className="flex items-center gap-4 text-sm text-muted-foreground">
        ...
        <tabs_1.Tabs value={selectedView} onValueChange={function (value) { return setSelectedView(value); }}>
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button_1.Button size="sm" variant="outline" onClick={function () { return setSortOrder(sortOrder === 'asc' ? 'desc' : 'asc'); }}>
                {sortOrder === 'asc' ? '↑' : '↓'}
              </button_1.Button>
            </div>
          </div>
            ...
            {summary && (<div className="space-y-6">
                ...
                <card_1.Card>
                  <card_1.CardContent className="p-6">
                    <div className="text-center">
                      ...
                      <progress_1.Progress value={summary.overallScore * 10} className="w-full max-w-md mx-auto"/>
                    </div>
                  </card_1.CardContent>
                </card_1.Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <card_1.Card>
                    ...
                    <card_1.CardContent>
                      <div className="space-y-2">
                        {summary.achievements.map(function (achievement, index) { return (<div key={index} className="flex items-center gap-2 text-sm">
                  ...
                  <card_1.Card>
                    ...
                    <card_1.CardContent>
                      <div className="space-y-2">
                        {summary.improvementAreas.map(function (area, index) { return (<div key={index} className="flex items-center gap-2 text-sm">
          ...
          <tabs_1.TabsContent value="grid">
            ...
            return (<card_1.Card key={metric.id} className={"".concat(statusConfig.borderColor, " ").concat(statusConfig.bgColor)}>
                    <card_1.CardContent className="p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        {showTargets && (<div className="space-y-1">
                        ...
                        {showBenchmarks && metric.benchmark && (<div className="text-xs text-muted-foreground">
          ...
          <tabs_1.TabsContent value="list">
            ...
            var StatusIcon = statusConfig.icon;
            var progress = calculateProgress(metric.value, metric.target);
            return (<card_1.Card key={metric.id} className="p-4">
                    <div className="flex items-center justify-between">
...
function calculatePerformanceSummary(metrics) {
    var excellentCount = metrics.filter(function (m) { return m.status === 'excellent'; }).length;
    var goodCount = metrics.filter(function (m) { return m.status === 'good'; }).length;
    ...
    var totalScore = metrics.reduce(function (sum, metric) { return sum + statusScores[metric.status]; }, 0);
