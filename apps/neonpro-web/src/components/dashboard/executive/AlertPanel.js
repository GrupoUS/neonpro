...
function AlertPanel(_a) {
  ...
  var clinicId = _a.clinicId,
    ...
    _c = _a.maxHeight,
    maxHeight = _c === void 0 ? 600 : _c,
    _d = _a.showFilters,
    showFilters = _d === void 0 ? true : _d,
    _e = _a.autoRefresh,
    autoRefresh = _e === void 0 ? true : _e,
    onAlertClick = _a.onAlertClick;
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <h4
                className={"font-medium text-sm truncate ".concat(
  ...
  if (error) {
    return (
      <card_1.Card className={"".concat(className, " border-red-200 bg-red-50")}>
