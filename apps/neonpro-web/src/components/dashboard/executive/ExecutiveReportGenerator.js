...
var ExecutiveReportGenerator = function (_a) {
  ...
  var clinicId = _a.clinicId,
    ...
    alerts = _a.alerts,
    summary = _a.summary,
    onReportGenerated = _a.onReportGenerated,
    onScheduleCreated = _a.onScheduleCreated,
    className = _a.className;
  var _d = (0, react_1.useState)("generate"),
    activeTab = _d[0],
    setActiveTab = _d[1];
  var _e = (0, react_1.useState)(false),
    isGenerating = _e[0],
    setIsGenerating = _e[1];
  var _f = (0, react_1.useState)(0),
    generationProgress = _f[0],
    setGenerationProgress = _f[1];
  var _g = (0, react_1.useState)([]),
    generatedReports = _g[0],
    setGeneratedReports = _g[1];
  var _h = (0, react_1.useState)([]),
    reportSchedules = _h[0],
    setReportSchedules = _h[1];
  var _j = (0, react_1.useState)([]),
    reportTemplates = _j[0],
    setReportTemplates = _j[1];
  ...
  var _l = (0, react_1.useState)(false),
    showTemplateDialog = _l[0],
    setShowTemplateDialog = _l[1];
  var _m = (0, react_1.useState)(false),
    showScheduleDialog = _m[0],
    setShowScheduleDialog = _m[1];
  var _o = (0, react_1.useState)(false),
    showPreviewDialog = _o[0],
    setShowPreviewDialog = _o[1];
  var _p = (0, react_1.useState)(null),
    selectedReport = _p[0],
    setSelectedReport = _p[1];
  // Form states
  var _q = (0, react_1.useState)({}),
    templateForm = _q[0],
    setTemplateForm = _q[1];
  var _r = (0, react_1.useState)({}),
    scheduleForm = _r[0],
    setScheduleForm = _r[1];
  // ============================================================================
  // EFFECTS
  // ============================================================================
  (0, react_1.useEffect)(
          ...
          switch (_b.label) {
            ...
            case 5:
              newReport_1 = {
                ...
                name: ""
                  .concat(config.template.name, " - ")
                  .concat(utils_1.formatters.date(new Date())),
        ...
        return __generator(this, function (_a) {
          ...
          try {
            ...
            onScheduleCreated === null || onScheduleCreated === void 0
              ? void 0
              : onScheduleCreated(newSchedule_1);
          } catch (error) {
  ...
  var getFrequencyBadge = function (frequency) {
    ...
    return (
      <ui_1.Badge className={colors[frequency] || "bg-gray-100 text-gray-800"}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <ui_1.Textarea
                      placeholder="Enter email addresses separated by commas"
                      value={
                        ((_c = scheduleForm.recipients) === null || _c === void 0
                          ? void 0
                          : _c.join(", ")) || ""
                      }
                      onChange={function (e) {
