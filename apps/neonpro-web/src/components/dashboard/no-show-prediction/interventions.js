...
function NoShowPredictionInterventions() {
    var _this = this;
    var _a = (0, react_1.useState)([]), interventions = _a[0], setInterventions = _a[1];
    ...
    var fetchInterventions = function () { return __awaiter(_this, void 0, void 0, function () {
              ...
              <div>
                ...
                <select_1.Select>
                  ...
                  <select_1.SelectContent>
                    ...
                    <select_1.SelectItem value="whatsapp_message">WhatsApp Message</select_1.SelectItem>
                    <select_1.SelectItem value="appointment_reschedule">Reschedule Offer</select_1.SelectItem>
                  </select_1.SelectContent>
                </select_1.Select>
              </div>
              <div>
                <label_1.Label htmlFor="message">Message</label_1.Label>
                <textarea_1.Textarea id="message" placeholder="Enter intervention message..." className="h-24"/>
              </div>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          {loading ? (<div className="space-y-4">
              {Array.from({ length: 5 }).map(function (_, i) { return (<div key={i} className="h-16 bg-muted animate-pulse rounded"/>); })}
            </div>) : (<div className="space-y-4">
              {interventions.map(function (intervention) { return (<div key={intervention.id} className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {intervention.outcome && (<badge_1.Badge variant={getOutcomeBadgeVariant(intervention.outcome)}>
                        {intervention.outcome.replace('_', ' ')}
                      </badge_1.Badge>)}
                    {intervention.effectiveness_score && (<span className="text-sm font-medium">
