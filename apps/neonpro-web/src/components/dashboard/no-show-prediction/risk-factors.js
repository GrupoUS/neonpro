...
function RiskFactorsManagement() {
    var _this = this;
    var _a = (0, react_1.useState)([]), riskFactors = _a[0], setRiskFactors = _a[1];
    ...
    var fetchRiskFactors = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return (<div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {Object.entries(summary).map(function (_a) {
            var factorType = _a[0], data = _a[1];
            return (<card_1.Card key={factorType}>
            ...
            <card_1.CardContent>
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <span className={"text-sm font-medium ".concat(getImpactColor(data.average_impact))}>
            ...
            <div className="flex items-center space-x-4">
              <select_1.Select value={filter} onValueChange={setFilter}>
                ...
                <select_1.SelectContent>
                  ...
                  <select_1.SelectItem value="appointment_history">Appointment History</select_1.SelectItem>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          {loading ? (<div className="space-y-4">
              {Array.from({ length: 8 }).map(function (_, i) { return (<div key={i} className="h-16 bg-muted animate-pulse rounded"/>); })}
            </div>) : (<div className="space-y-4">
              {riskFactors.map(function (factor) { return (<div key={factor.id} className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center space-x-4">
                    <div className={"w-3 h-3 rounded-full ".concat(factor.impact_weight >= 0.8 ? 'bg-red-500' :
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="text-right">
                      <p className={"text-sm font-medium ".concat(getImpactColor(factor.impact_weight))}>
              ...
              {riskFactors.length === 0 && (<div className="text-center py-8 text-muted-foreground">
        ...
        <card_1.CardContent>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-4">
              ...
              {Object.entries(summary).map(function (_a) {
            var factorType = _a[0], data = _a[1];
            return (<div key={factorType} className="flex items-center justify-between">
