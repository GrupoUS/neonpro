...
function TreatmentSuccessPage(_a) {
    ...
    var _c = (0, react_1.useState)(null), successStats = _c[0], setSuccessStats = _c[1];
    var _d = (0, react_1.useState)(null), providerStats = _d[0], setProviderStats = _d[1];
    var _e = (0, react_1.useState)([]), treatmentTypeStats = _e[0], setTreatmentTypeStats = _e[1];
    var _f = (0, react_1.useState)(null), complianceStats = _f[0], setComplianceStats = _f[1];
    var _g = (0, react_1.useState)([]), treatmentOutcomes = _g[0], setTreatmentOutcomes = _g[1];
    var _h = (0, react_1.useState)([]), successMetrics = _h[0], setSuccessMetrics = _h[1];
    var _j = (0, react_1.useState)([]), providerPerformance = _j[0], setProviderPerformance = _j[1];
    var _k = (0, react_1.useState)([]), protocolOptimizations = _k[0], setProtocolOptimizations = _k[1];
    var _l = (0, react_1.useState)([]), qualityBenchmarks = _l[0], setQualityBenchmarks = _l[1];
    var _m = (0, react_1.useState)([]), complianceReports = _m[0], setComplianceReports = _m[1];
    ...
    var _q = (0, react_1.useState)({
        ...
        follow_up_notes: "",
        status: "completed",
    }), outcomeForm = _q[0], setOutcomeForm = _q[1];
    var _r = (0, react_1.useState)({
        ...
        rationale: "",
    }), optimizationForm = _r[0], setOptimizationForm = _r[1];
    ...
    }), benchmarkForm = _s[0], setBenchmarkForm = _s[1];
    ...
    var loadSuccessStats = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    if (!response.ok)
                        throw new Error("Failed to fetch success stats");
    ...
    var loadProviderStats = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loadTreatmentTypeStats = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    if (!response.ok)
                        throw new Error("Failed to fetch treatment type stats");
                    return [4 /*yield*/, response.json()];
                case 2:
                    data = _a.sent();
    ...
    var loadComplianceStats = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loadTreatmentOutcomes = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loadSuccessMetrics = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loadProviderPerformance = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loadProtocolOptimizations = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loadQualityBenchmarks = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    if (!response.ok)
                        throw new Error("Failed to fetch quality benchmarks");
                    return [4 /*yield*/, response.json()];
                case 2:
                    data = _a.sent();
    ...
    var loadComplianceReports = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var handleCreateOutcome = function () { return __awaiter(_this, void 0, void 0, function () {
        var response, err_12;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, fetch("/api/treatment-success/outcomes", {
                            method: "POST",
    ...
    var handleCreateOptimization = function () { return __awaiter(_this, void 0, void 0, function () {
        var response, err_13;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("/api/treatment-success/protocol-optimizations", {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
    ...
    var handleCreateBenchmark = function () { return __awaiter(_this, void 0, void 0, function () {
        var response, err_14;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("/api/treatment-success/quality-benchmarks", {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
    ...
    var formatPercentage = function (value) { return "".concat((value * 100).toFixed(1), "%"); };
    var formatScore = function (value) { return value.toFixed(2); };
    if (loading) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <p className="text-xs text-gray-600">
              {(successStats === null || successStats === void 0 ? void 0 : successStats.trend_direction) === "up" ? (<span className="flex items-center text-green-600">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold text-blue-600">
              {(successStats === null || successStats === void 0 ? void 0 : successStats.total_treatments) || 0}
            </div>
            <p className="text-xs text-gray-600">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold text-purple-600">
              {(providerStats === null || providerStats === void 0 ? void 0 : providerStats.total_providers) || 0}
            </div>
            <p className="text-xs text-gray-600">
              {(providerStats === null || providerStats === void 0 ? void 0 : providerStats.improvement_needed) || 0} precisam de melhoria
            </p>
          </card_1.CardContent>
        </card_1.Card>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <p className="text-xs text-gray-600">
              {(complianceStats === null || complianceStats === void 0 ? void 0 : complianceStats.pending_reports) || 0} relatórios pendentes
            </p>
          </card_1.CardContent>
        </card_1.Card>
      </div>
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                {treatmentTypeStats.map(function (stat, index) { return (<div key={index} className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <badge_1.Badge variant={stat.benchmark_status === "above"
                ? "default"
            ...
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                {protocolOptimizations.slice(0, 5).map(function (optimization) { return (<div key={optimization.id} className="border-l-4 border-blue-500 pl-4">
              ...
              <card_1.CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input_1.Input id="patient_id" value={outcomeForm.patient_id} onChange={function (e) {
            return setOutcomeForm(__assign(__assign({}, outcomeForm), { patient_id: e.target.value }));
        }}/>
                  </div>
                  <div>
                    <label_1.Label htmlFor="treatment_type">Tipo de Tratamento</label_1.Label>
                    <input_1.Input id="treatment_type" value={outcomeForm.treatment_type} onChange={function (e) {
            return setOutcomeForm(__assign(__assign({}, outcomeForm), { treatment_type: e.target.value }));
        }}/>
                  </div>
                  <div>
                    <label_1.Label htmlFor="provider_id">ID do Profissional</label_1.Label>
                    <input_1.Input id="provider_id" value={outcomeForm.provider_id} onChange={function (e) {
            return setOutcomeForm(__assign(__assign({}, outcomeForm), { provider_id: e.target.value }));
        }}/>
                  </div>
                  <div>
                    <label_1.Label htmlFor="treatment_date">Data do Tratamento</label_1.Label>
                    <input_1.Input id="treatment_date" type="date" value={outcomeForm.treatment_date} onChange={function (e) {
            return setOutcomeForm(__assign(__assign({}, outcomeForm), { treatment_date: e.target.value }));
        }}/>
                  </div>
                  <div>
                    <label_1.Label htmlFor="success_score">
                      Score de Sucesso (0-1)
                    </label_1.Label>
                    <input_1.Input id="success_score" type="number" min="0" max="1" step="0.1" value={outcomeForm.success_score} onChange={function (e) {
            return setOutcomeForm(__assign(__assign({}, outcomeForm), { success_score: parseFloat(e.target.value) }));
        }}/>
                  </div>
                  <div>
                    ...
                    <input_1.Input id="satisfaction_score" type="number" min="0" max="10" value={outcomeForm.patient_satisfaction_score} onChange={function (e) {
            return setOutcomeForm(__assign(__assign({}, outcomeForm), { patient_satisfaction_score: parseFloat(e.target.value) }));
        }}/>
                  </div>
                </div>
                <div>
                  <label_1.Label htmlFor="complications">Complicações</label_1.Label>
                  <textarea_1.Textarea id="complications" value={outcomeForm.complications} onChange={function (e) {
            return setOutcomeForm(__assign(__assign({}, outcomeForm), { complications: e.target.value }));
        }}/>
                </div>
                <div>
                  <label_1.Label htmlFor="follow_up_notes">
                    Notas de Acompanhamento
                  </label_1.Label>
                  <textarea_1.Textarea id="follow_up_notes" value={outcomeForm.follow_up_notes} onChange={function (e) {
            return setOutcomeForm(__assign(__assign({}, outcomeForm), { follow_up_notes: e.target.value }));
        }}/>
                </div>
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-4">
                  {treatmentOutcomes.map(function (outcome) { return (<div key={outcome.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Data:{" "}
                            {new Date(outcome.treatment_date).toLocaleDateString("pt-BR")}
                          </p>
                        </div>
                        <div className="text-right">
                          ...
                          <badge_1.Badge variant={outcome.status === "completed"
                ? "default"
                : "secondary"}>
                ...
                : outcome.status === "in_progress"
                    ...
                    : "Acompanhamento"}
                      ...
                      {outcome.complications && (<div className="mt-2 p-2 bg-red-50 rounded text-sm text-red-700">
        ...
        <tabs_1.TabsContent value="metrics">
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {successMetrics.map(function (metric) { return (<div key={metric.id} className="border rounded-lg p-4">
                    <div className="flex justify-between items-start">
                      <div>
        ...
        <tabs_1.TabsContent value="performance">
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {providerPerformance.map(function (performance) { return (<div key={performance.id} className="border rounded-lg p-4">
                    <div className="flex justify-between items-start">
                      <div>
                        <h4 className="font-medium">
          ...
          <div className="space-y-6">
            ...
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label_1.Label htmlFor="opt_treatment_type">
                      Tipo de Tratamento
                    </label_1.Label>
                    <input_1.Input id="opt_treatment_type" value={optimizationForm.treatment_type} onChange={function (e) {
            return setOptimizationForm(__assign(__assign({}, optimizationForm), { treatment_type: e.target.value }));
        }}/>
                  </div>
                  <div>
                    <label_1.Label htmlFor="implementation_priority">Prioridade</label_1.Label>
                    <select_1.Select value={optimizationForm.implementation_priority} onValueChange={function (value) {
            return setOptimizationForm(__assign(__assign({}, optimizationForm), { implementation_priority: value }));
        }}>
                ...
                <div>
                  ...
                  <textarea_1.Textarea id="current_protocol" value={optimizationForm.current_protocol} onChange={function (e) {
            return setOptimizationForm(__assign(__assign({}, optimizationForm), { current_protocol: e.target.value }));
        }}/>
                </div>
                <div>
                  ...
                  <textarea_1.Textarea id="suggested_improvements" value={optimizationForm.suggested_improvements} onChange={function (e) {
            return setOptimizationForm(__assign(__assign({}, optimizationForm), { suggested_improvements: e.target.value }));
        }}/>
                </div>
                <div>
                  <label_1.Label htmlFor="rationale">Justificativa</label_1.Label>
                  <textarea_1.Textarea id="rationale" value={optimizationForm.rationale} onChange={function (e) {
            return setOptimizationForm(__assign(__assign({}, optimizationForm), { rationale: e.target.value }));
        }}/>
                </div>
                <div>
                  ...
                  <input_1.Input id="success_improvement" type="number" min="0" max="1" step="0.01" value={optimizationForm.success_rate_improvement} onChange={function (e) {
            return setOptimizationForm(__assign(__assign({}, optimizationForm), { success_rate_improvement: parseFloat(e.target.value) }));
        }}/>
                </div>
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-4">
                  {protocolOptimizations.map(function (optimization) { return (<div key={optimization.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start">
                        <div>
                          <h4 className="font-medium">
                            {optimization.treatment_type}
                          ...
                          {optimization.rationale && (<p className="text-sm text-gray-500 mt-1">
                ...
                : optimization.implementation_priority ===
                    ...
                    : "Baixa"}
                          ...
                          <badge_1.Badge variant={optimization.approval_status === "approved"
                ? "default"
          ...
          <div className="space-y-6">
            ...
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label_1.Label htmlFor="bench_treatment_type">
                      Tipo de Tratamento
                    </label_1.Label>
                    <input_1.Input id="bench_treatment_type" value={benchmarkForm.treatment_type} onChange={function (e) {
            return setBenchmarkForm(__assign(__assign({}, benchmarkForm), { treatment_type: e.target.value }));
        }}/>
                  </div>
                  <div>
                    ...
                    <input_1.Input id="target_success_rate" type="number" min="0" max="1" step="0.01" value={benchmarkForm.target_success_rate} onChange={function (e) {
            return setBenchmarkForm(__assign(__assign({}, benchmarkForm), { target_success_rate: parseFloat(e.target.value) }));
        }}/>
                  </div>
                  <div>
                    ...
                    <input_1.Input id="minimum_satisfaction" type="number" min="0" max="10" value={benchmarkForm.minimum_satisfaction} onChange={function (e) {
            return setBenchmarkForm(__assign(__assign({}, benchmarkForm), { minimum_satisfaction: parseFloat(e.target.value) }));
        }}/>
                  </div>
                  <div>
                    ...
                    <input_1.Input id="max_complication_rate" type="number" min="0" max="1" step="0.01" value={benchmarkForm.maximum_complication_rate} onChange={function (e) {
            return setBenchmarkForm(__assign(__assign({}, benchmarkForm), { maximum_complication_rate: parseFloat(e.target.value) }));
        }}/>
                  </div>
                  <div>
                    ...
                    <input_1.Input id="industry_standard" type="number" min="0" max="1" step="0.01" value={benchmarkForm.industry_standard} onChange={function (e) {
            return setBenchmarkForm(__assign(__assign({}, benchmarkForm), { industry_standard: parseFloat(e.target.value) }));
        }}/>
                  </div>
                  <div>
                    ...
                    <input_1.Input id="certification_requirement" value={benchmarkForm.certification_requirement} onChange={function (e) {
            return setBenchmarkForm(__assign(__assign({}, benchmarkForm), { certification_requirement: e.target.value }));
        }}/>
                  </div>
                </div>
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="space-y-4">
                  {qualityBenchmarks.map(function (benchmark) { return (<div key={benchmark.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start">
                        <div>
                          <h4 className="font-medium">
                        ...
                        <div className="text-right">
                          ...
                          {benchmark.certification_requirement && (<badge_1.Badge variant="outline" className="mt-1">
        ...
        <tabs_1.TabsContent value="compliance">
          <card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-4">
                {complianceReports.map(function (report) { return (<div key={report.id} className="border rounded-lg p-4">
                    <div className="flex justify-between items-start">
                      <div>
                      ...
                      <div className="text-right">
                        ...
                        <badge_1.Badge variant={report.status === "finalized"
                ? "default"
