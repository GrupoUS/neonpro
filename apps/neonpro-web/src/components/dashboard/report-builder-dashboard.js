      ...
      <div className="flex items-center gap-4">
        <div className="flex-1">
          <div className="relative">
            ...
            <input_1.Input placeholder="Buscar relatórios..." value={searchQuery} onChange={function (e) { return setSearchQuery(e.target.value); }} className="pl-10"/>
          </div>
        </div>
      ...
      <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <tabs_1.TabsContent value="reports" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            return (<card_1.Card key={report.id} className="medical-card hover:shadow-lg transition-shadow">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            {report.is_public && (<badge_1.Badge variant="secondary" className="text-xs">
                                Público
                              </badge_1.Badge>)}
                  ...
                  <card_1.CardContent className="pt-0">
                    {report.description && (<p className="text-sm text-muted-foreground mb-3 line-clamp-2">
                        {report.description}
                      </p>)}
                    ...
                    <div className="space-y-2 text-xs text-muted-foreground">
                      ...
                      {report.last_run && (<div className="flex items-center gap-1">
                          <lucide_react_1.Clock className="w-3 h-3"/>
                          <span>
                            Última execução:{" "}
                            {(0, utils_1.formatDate)(new Date(report.last_run))}
                          </span>
                        </div>)}
                    </div>
                  </card_1.CardContent>
        ...
        <tabs_1.TabsContent value="templates" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            return (<card_1.Card key={template.id} className="medical-card hover:shadow-lg transition-shadow cursor-pointer">
                  <card_1.CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <badge_1.Badge variant="secondary" className={"text-xs ".concat(getCategoryColor(template.category))}>
                  ...
                  <card_1.CardContent className="pt-0">
                    {template.description && (<p className="text-sm text-muted-foreground mb-3 line-clamp-2">
                        {template.description}
                      </p>)}
