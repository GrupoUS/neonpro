...
function RevenueMetricsCard(_a) {
    ...
    var growthPercentage = ((metrics.projectedRevenue - metrics.currentRevenue) / metrics.currentRevenue) * 100;
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          ...
          <div className="flex items-center gap-1 text-xs">
            {isGrowthPositive ? (<lucide_react_1.TrendingUp className="h-3 w-3 text-green-500"/>) : (<lucide_react_1.TrendingDown className="h-3 w-3 text-red-500"/>)}
