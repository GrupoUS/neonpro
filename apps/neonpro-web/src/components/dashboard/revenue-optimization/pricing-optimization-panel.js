...
function PricingOptimizationPanel(_a) {
  var pricingData = _a.pricingData,
    ...
    <div className="grid gap-4 md:grid-cols-2">
      <card_1.Card>
        <card_1.CardHeader>
          ...
          <card_1.CardDescription>Active pricing models and configurations</card_1.CardDescription>
        </card_1.CardHeader>
        <card_1.CardContent>
            ...
            ? <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <badge_1.Badge variant="outline">
                    {pricingData.currentStrategy.strategy_name}
                  </badge_1.Badge>
                </div>
                <div className="flex items-center justify-between">
...
function ServiceMixChart(_a) {
  var serviceMixData = _a.serviceMixData,
    clinicId = _a.clinicId;
  return (
    <card_1.Card>
      <card_1.CardHeader>
...
function CompetitiveAnalysisChart(_a) {
  var competitiveData = _a.competitiveData,
    clinicId = _a.clinicId;
  return (
    <card_1.Card>
      <card_1.CardHeader>
