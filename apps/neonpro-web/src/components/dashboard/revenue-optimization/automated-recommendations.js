...
function AutomatedRecommendations(_a) {
    var recommendations = _a.recommendations, implementationPlan = _a.implementationPlan;
    ...
    var totalImpact = recommendations.reduce(function (sum, rec) { return sum + rec.expectedImpact; }, 0);
    return (<div className="space-y-4">
      ...
      <div className="space-y-3">
        {sortedRecommendations.map(function (recommendation, index) { return (<card_1.Card key={index} className="border-l-4 border-l-blue-500">
            <card_1.CardContent className="pt-4">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 space-y-2">
                  <div className="flex items-center gap-2">
                    <badge_1.Badge variant="outline" className={priorityColors[recommendation.priority]}>
                  ...
                  <div className="flex items-center gap-4 text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center gap-1">
                      <lucide_react_1.Target className={"h-3 w-3 ".concat(effortColors[recommendation.implementationEffort])}/>
                  ...
                  <div className="space-y-1">
                    ...
                    <progress_1.Progress value={Math.min(recommendation.expectedImpact * 5, 100)} className="h-2"/>
                  </div>
                </div>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          <div className="space-y-3">
            {implementationPlan.map(function (step, index) { return (<div key={index} className="flex items-start gap-3">
