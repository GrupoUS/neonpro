...
function ConflictOverrideDialog(_a) {
    var _this = this;
    var open = _a.open, onOpenChange = _a.onOpenChange, conflictDetails = _a.conflictDetails, onOverrideComplete = _a.onOverrideComplete;
    var _b = (0, react_1.useState)('emergency_appointment'), selectedReason = _b[0], setSelectedReason = _b[1];
    var _c = (0, react_1.useState)(''), reasonText = _c[0], setReasonText = _c[1];
    var _d = (0, react_1.useState)('request'), activeTab = _d[0], setActiveTab = _d[1];
    var _e = (0, use_conflict_override_1.useConflictOverride)(), loading = _e.loading, userPermissions = _e.userPermissions, requestConflictOverride = _e.requestConflictOverride, checkOverridePermissions = _e.checkOverridePermissions;
    ...
    var handleSubmitOverride = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, requestConflictOverride({
                ...
                case 2:
                    ...
                    onOverrideComplete === null || onOverrideComplete === void 0 ? void 0 : onOverrideComplete(overrideRequest);
                    onOpenChange(false);
                    // Reset form
    ...
    var canRequestOverride = userPermissions === null || userPermissions === void 0 ? void 0 : userPermissions.can_override_conflicts;
    var requiresApproval = userPermissions === null || userPermissions === void 0 ? void 0 : userPermissions.requires_approval;
    var impactSeverity = conflictDetails ? getImpactSeverity(conflictDetails.estimated_impact_minutes) : null;
    if (!conflictDetails)
        return null;
      ...
      <dialog_1.DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <tabs_1.TabsContent value="conflict" className="space-y-4">
            <card_1.Card className="border-red-200 bg-red-50/50">
              ...
              <card_1.CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label_1.Label className="text-red-600 font-medium">Tipo de Conflito:</label_1.Label>
                    <p className="mt-1">{conflictDetails.conflict_type}</p>
                  </div>
                  <div>
                    <label_1.Label className="text-red-600 font-medium">ID do Agendamento:</label_1.Label>
            ...
            {conflictDetails.affected_appointments.length > 0 && (<card_1.Card>
                <card_1.CardHeader>
                  <card_1.CardTitle className="text-lg">Agendamentos Afetados</card_1.CardTitle>
                </card_1.CardHeader>
                <card_1.CardContent>
                  <div className="space-y-3">
                    {conflictDetails.affected_appointments.map(function (appointment) { return (<div key={appointment.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="text-right">
                          <p className="text-sm font-medium">
                            {(0, dayjs_1.default)(appointment.original_time).format('DD/MM/YYYY HH:mm')}
                          </p>
          ...
          <tabs_1.TabsContent value="request" className="space-y-4">
            {!canRequestOverride ? (<card_1.Card className="border-orange-200 bg-orange-50/50">
                ...
                <card_1.Card>
                  <card_1.CardHeader>
                    <card_1.CardTitle className="text-lg">Justificativa para Override</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent className="space-y-4">
                    <div>
                      <label_1.Label htmlFor="reason">Motivo Principal</label_1.Label>
                      <select_1.Select value={selectedReason} onValueChange={function (value) { return setSelectedReason(value); }}>
                        <select_1.SelectTrigger>
                          <select_1.SelectValue placeholder="Selecione o motivo"/>
                        </select_1.SelectTrigger>
                        <select_1.SelectContent>
                          {OVERRIDE_REASONS.map(function (reason) { return (<select_1.SelectItem key={reason.value} value={reason.value}>
                              <div>
                    ...
                    <div>
                      <label_1.Label htmlFor="reason-text">Justificativa Detalhada *</label_1.Label>
                      <textarea_1.Textarea id="reason-text" value={reasonText} onChange={function (e) { return setReasonText(e.target.value); }} placeholder="Forneça uma justificativa detalhada para este override, incluindo quaisquer circunstâncias especiais ou considerações médicas..." rows={4} className="mt-1"/>
                ...
                {requiresApproval && (<card_1.Card className="border-blue-200 bg-blue-50/50">
                    <card_1.CardContent className="pt-6">
            ...
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <badge_1.Badge className={"".concat(impactSeverity === null || impactSeverity === void 0 ? void 0 : impactSeverity.color, " text-lg px-3 py-1")}>
                      {(impactSeverity === null || impactSeverity === void 0 ? void 0 : impactSeverity.level) === 'low' && 'Baixo'}
                      {(impactSeverity === null || impactSeverity === void 0 ? void 0 : impactSeverity.level) === 'medium' && 'Médio'}
                      {(impactSeverity === null || impactSeverity === void 0 ? void 0 : impactSeverity.level) === 'high' && 'Alto'}
                    </badge_1.Badge>
        ...
        <div className="flex justify-end gap-2 pt-4 border-t">
          ...
          {canRequestOverride && activeTab === 'request' && (<button_1.Button onClick={handleSubmitOverride} disabled={loading || !reasonText.trim()} className="min-w-[140px]">
              {loading ? ('Processando...') : requiresApproval ? ('Solicitar Aprovação') : ('Aplicar Override')}
            </button_1.Button>)}
        </div>
