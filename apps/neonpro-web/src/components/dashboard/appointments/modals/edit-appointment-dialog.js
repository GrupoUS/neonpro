...
var appointmentEditSchema = zod_2.z.object({
    ...
    status: zod_2.z.enum(['scheduled', 'confirmed', 'in_progress', 'completed', 'cancelled', 'no_show']),
...
function EditAppointmentDialog(_a) {
    var _this = this;
    var appointment = _a.appointment, open = _a.open, onOpenChange = _a.onOpenChange, onUpdate = _a.onUpdate;
    ...
    var _e = (0, react_1.useState)(''), conflictError = _e[0], setConflictError = _e[1];
    var _f = (0, react_1.useState)(false), checkingConflict = _f[0], setCheckingConflict = _f[1];
    ...
    var checkConflicts = function (professionalId, startTime, serviceId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!professionalId || !startTime || !serviceId || !appointment)
                        return [2 /*return*/];
                    _b.label = 1;
                case 1:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("/api/appointments/".concat(appointment.id), {
                            method: 'PATCH',
                            headers: { 'Content-Type': 'application/json' },
        ...
        <form_1.Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            return (<form_1.FormItem>
                  ...
                  <form_1.FormControl>
                    <input_1.Input type="datetime-local" {...field} min={new Date().toISOString().slice(0, 16)}/>
                  </form_1.FormControl>
                  <form_1.FormMessage />
                </form_1.FormItem>);
        }}/>
            ...
            {/* Change Reason */}
            <form_1.FormField control={form.control} name="change_reason" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                  <form_1.FormLabel>Motivo da Alteração</form_1.FormLabel>
                  <form_1.FormControl>
                    <textarea_1.Textarea placeholder="Descreva o motivo da alteração..." {...field}/>
                  </form_1.FormControl>
                  <form_1.FormMessage />
                </form_1.FormItem>);
        }}/>
            ...
            <dialog_1.DialogFooter className="gap-2 sm:gap-0">
              <button_1.Button type="button" variant="outline" onClick={function () { return onOpenChange(false); }} disabled={isUpdating}>
                Cancelar
              </button_1.Button>
              <button_1.Button type="submit" disabled={isUpdating || !!conflictError || checkingConflict}>
