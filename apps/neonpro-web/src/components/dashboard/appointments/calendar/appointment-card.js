...
function AppointmentCard(_a) {
  ...
  var appointment = _a.appointment,
    ...
    _j = _a.showActions,
    showActions = _j === void 0 ? true : _j,
    _k = _a.showPatient,
    showPatient = _k === void 0 ? true : _k,
    _l = _a.showProfessional,
    showProfessional = _l === void 0 ? true : _l,
    onEdit = _a.onEdit,
              ...
              <dropdown_menu_1.DropdownMenu>
                <dropdown_menu_1.DropdownMenuTrigger asChild>
                  <button_1.Button
                    ...
                    aria-label={"A\u00E7\u00F5es para agendamento de ".concat(
                      ((_e = appointment.patient) === null || _e === void 0
                        ? void 0
                        : _e.full_name) || "paciente",
                    )}
                  >
      ...
      <card_1.CardContent className="p-4">
        <div className="space-y-3">
              ...
              <dropdown_menu_1.DropdownMenu>
                <dropdown_menu_1.DropdownMenuTrigger asChild>
                  <button_1.Button
                    ...
                    size="sm"
                    aria-label={"A\u00E7\u00F5es para agendamento de ".concat(
                      ((_f = appointment.patient) === null || _f === void 0
                        ? void 0
                        : _f.full_name) || "paciente",
                    )}
          ...
          <div className="flex justify-between items-center">
            ...
            {((_g = appointment.service_type) === null || _g === void 0 ? void 0 : _g.price) && (
