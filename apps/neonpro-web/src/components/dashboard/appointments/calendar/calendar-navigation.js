...
function CalendarNavigation(_a) {
    ...
    switch (view) {
      ...
      case "week": {
        ...
        if (startOfWeek.getMonth() === endOfWeek.getMonth()) {
          return ""
            .concat((0, date_fns_1.format)(startOfWeek, "d", { locale: locale_1.ptBR }), " - ")
            .concat(
              (0, date_fns_1.format)(endOfWeek, "d 'de' MMMM 'de' yyyy", { locale: locale_1.ptBR }),
            );
        } else {
          return ""
            .concat(
              (0, date_fns_1.format)(startOfWeek, "d 'de' MMM", { locale: locale_1.ptBR }),
              " - ",
            )
            .concat(
              (0, date_fns_1.format)(endOfWeek, "d 'de' MMM 'de' yyyy", { locale: locale_1.ptBR }),
            );
        }
      }
      case "month":
  ...
  return (
    <div
      className={(0, utils_1.cn)("flex items-center justify-between gap-4 p-4 border-b", className)}
    >
