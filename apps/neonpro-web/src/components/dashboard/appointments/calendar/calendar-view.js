...
function CalendarView(_a) {
    var _this = this;
    var appointments = _a.appointments, onRefresh = _a.onRefresh, onAppointmentClick = _a.onAppointmentClick, onAppointmentEdit = _a.onAppointmentEdit, onAppointmentCancel = _a.onAppointmentCancel, onAppointmentComplete = _a.onAppointmentComplete, onCreateAppointment = _a.onCreateAppointment, className = _a.className;
    // State management
    var _b = (0, react_1.useState)(null), currentDate = _b[0], setCurrentDate = _b[1];
    var _c = (0, react_1.useState)("week"), view = _c[0], setView = _c[1];
    ...
    (0, react_1.useEffect)(function () {
        var handleKeyPress = function (event) {
            ...
            if ((activeElement === null || activeElement === void 0 ? void 0 : activeElement.tagName) === 'INPUT' ||
                ...
                (activeElement === null || activeElement === void 0 ? void 0 : activeElement.tagName) === 'SELECT') {
                return;
            }
            switch (event.key) {
                case 'ArrowLeft':
    ...
    // Navigation handlers
    var handlePreviousNavigation = (0, react_1.useCallback)(function () {
        if (!currentDate)
            return;
        var today = new Date();
        switch (view) {
            case 'day':
                setCurrentDate(function (prev) { return prev ? new Date(prev.getTime() - 24 * 60 * 60 * 1000) : new Date(); });
                break;
            case 'week':
                setCurrentDate(function (prev) { return prev ? new Date(prev.getTime() - 7 * 24 * 60 * 60 * 1000) : new Date(); });
                break;
            case 'month':
    ...
    var handleNextNavigation = (0, react_1.useCallback)(function () {
        if (!currentDate)
            return;
        switch (view) {
            case 'day':
    ...
    var handleAppointmentEdit = (0, react_1.useCallback)(function (appointment) { return __awaiter(_this, void 0, void 0, function () {
        var error_1;
    ...
    var handleAppointmentCancel = (0, react_1.useCallback)(function (appointment) { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleAppointmentComplete = (0, react_1.useCallback)(function (appointment) { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleTimeSlotClick = (0, react_1.useCallback)(function (time) {
        if (onCreateAppointment) {
            onCreateAppointment(currentDate || undefined, time);
        }
    }, [currentDate, onCreateAppointment]);
    var handleWeekTimeSlotClick = (0, react_1.useCallback)(function (date, time) {
        if (onCreateAppointment) {
    ...
    var renderCurrentView = function () {
        ...
        switch (view) {
            case 'day':
                return (<day_view_1.DayView date={currentDate} onTimeSlotClick={handleTimeSlotClick} {...commonProps}/>);
            case 'week':
                return (<week_view_1.WeekView date={currentDate} onTimeSlotClick={handleWeekTimeSlotClick} {...commonProps}/>);
            case 'month':
                return (<month_view_1.MonthView date={currentDate} onDayClick={handleDayClick} {...commonProps}/>);
            default:
                return null;
        }
    };
    ...
    return (<div className={"flex flex-col h-full ".concat(className || '')}>
      {/* Navigation */}
      <calendar_navigation_1.CalendarNavigation currentDate={currentDate} view={view} onDateChange={setCurrentDate} onViewChange={setView} onToday={handleToday}/>

      {/* Current view */}
      <div className="flex-1 relative">
        {isLoading && (<div className="absolute inset-0 bg-background/50 flex items-center justify-center z-50">
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div>
          </div>)}
        {renderCurrentView()}
      </div>
