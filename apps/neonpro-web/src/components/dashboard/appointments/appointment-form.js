...
function AppointmentForm(_a) {
    var _this = this;
    var patients = _a.patients, professionals = _a.professionals, serviceTypes = _a.serviceTypes, onSuccess = _a.onSuccess, defaultValues = _a.defaultValues;
    var _b = (0, react_1.useState)(false), isSubmitting = _b[0], setIsSubmitting = _b[1];
    var _c = (0, react_1.useState)([]), conflicts = _c[0], setConflicts = _c[1];
    ...
    var form = (0, react_hook_form_1.useForm)({
        ...
        defaultValues: __assign({ appointment_date: (defaultValues === null || defaultValues === void 0 ? void 0 : defaultValues.appointment_date) || new Date(), start_time: (defaultValues === null || defaultValues === void 0 ? void 0 : defaultValues.start_time) || "", duration_minutes: 60, notes: (defaultValues === null || defaultValues === void 0 ? void 0 : defaultValues.notes) || "", internal_notes: (defaultValues === null || defaultValues === void 0 ? void 0 : defaultValues.internal_notes) || "" }, defaultValues),
    });
    ...
    var generateTimeSlots = function () {
        ...
        for (var hour = 8; hour < 18; hour++) {
            for (var minute = 0; minute < 60; minute += 15) {
                var timeString = "".concat(hour.toString().padStart(2, "0"), ":").concat(minute
                    .toString()
                    .padStart(2, "0"));
    ...
    var checkConflicts = function (professionalId, date, startTime, durationMinutes) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var loadAvailableSlots = function (professionalId, date) { return __awaiter(_this, void 0, void 0, function () {
        var response, result_1, slots, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("/api/appointments/available-slots?professional_id=".concat(professionalId, "&date=").concat((0, date_fns_1.format)(date, "yyyy-MM-dd")))];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    ...
                    if (result_1.success) {
                        slots = result_1.data
                            .map(function (slot) { return (0, date_fns_1.format)(new Date(slot.slot_start), "HH:mm"); })
    ...
    var onSubmit = function (data) { return __awaiter(_this, void 0, void 0, function () {
        var hasConflict, _a, hour, minute, startDateTime, endDateTime, appointmentData, response, result, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, checkConflicts(data.professional_id, data.appointment_date, data.start_time, data.duration_minutes)];
                case 2:
                    hasConflict = _b.sent();
                    if (hasConflict) {
                        sonner_1.toast.error("Conflito de horário detectado. Por favor, escolha outro horário.");
    ...
    return (<form_1.Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <select_1.SelectContent>
                      {patients.map(function (patient) { return (<select_1.SelectItem key={patient.id} value={patient.id}>
                          <div className="flex flex-col">
                            ...
                            {patient.phone && (<span className="text-sm text-muted-foreground">
                                {patient.phone}
                              </span>)}
                          </div>
                        </select_1.SelectItem>); })}
          ...
          <div className="space-y-4">
            ...
            return (<form_1.FormItem>
                  ...
                  <select_1.Select onValueChange={function (value) {
                    ...
                    var service = serviceTypes.find(function (s) { return s.id === value; });
                    if (service) {
                    ...
                    <select_1.SelectContent>
                      {serviceTypes.map(function (service) { return (<select_1.SelectItem key={service.id} value={service.id}>
                    ...
                    <select_1.SelectContent>
                      {professionals.map(function (professional) { return (<select_1.SelectItem key={professional.id} value={professional.id}>
                          <div className="flex flex-col">
                            ...
                            {professional.specialization && (<span className="text-sm text-muted-foreground">
        ...
        {/* Date & Time Selection */}
        <div className="grid gap-6 md:grid-cols-2">
          <form_1.FormField control={form.control} name="appointment_date" render={function (_a) {
            var field = _a.field;
                  ...
                  <popover_1.PopoverTrigger asChild>
                    <form_1.FormControl>
                      <button_1.Button variant="outline" className={(0, utils_1.cn)("pl-3 text-left font-normal", !field.value && "text-muted-foreground")}>
                        {field.value ? ((0, date_fns_1.format)(field.value, "PPP", { locale: locale_1.ptBR })) : (<span>Escolha uma data</span>)}
            ...
            return (<form_1.FormItem>
                ...
                <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <select_1.SelectContent>
                    ...
                    return (<select_1.SelectItem key={time} value={time} disabled={!isAvailable} className={(0, utils_1.cn)(!isAvailable && "opacity-50 cursor-not-allowed")}>
                          <div className="flex items-center gap-2">
                            {isAvailable ? (<lucide_react_1.CheckCircle2 className="h-4 w-4 text-green-500"/>) : (<lucide_react_1.AlertCircle className="h-4 w-4 text-red-500"/>)}
                            <span>{time}</span>
                          </div>
                        </select_1.SelectItem>);
                })}
        ...
        {/* Conflict Warning */}
        {conflicts.length > 0 && (<div className="p-4 border border-red-200 rounded-md bg-red-50">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <form_1.FormField control={form.control} name="notes" render={function (_a) {
            ...
            return (<form_1.FormItem>
                ...
                <form_1.FormControl>
                  <textarea_1.Textarea placeholder="Observações visíveis ao paciente..." {...field} rows={3}/>
                </form_1.FormControl>
                <form_1.FormMessage />
              </form_1.FormItem>);
        }}/>
          ...
          <form_1.FormField control={form.control} name="internal_notes" render={function (_a) {
            ...
            return (<form_1.FormItem>
                ...
                <form_1.FormControl>
                  <textarea_1.Textarea placeholder="Observações internas da equipe..." {...field} rows={3}/>
                </form_1.FormControl>
        ...
        <div className="flex justify-end gap-4">
          <button_1.Button type="button" variant="outline" onClick={function () { return router.back(); }} disabled={isSubmitting}>
            Cancelar
          </button_1.Button>
          <button_1.Button type="submit" disabled={isSubmitting || conflicts.length > 0} className="min-w-[150px]">
