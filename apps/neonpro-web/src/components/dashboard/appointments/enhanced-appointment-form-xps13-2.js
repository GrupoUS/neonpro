...
var alternative_slots_display_1 = require("@/components/dashboard/appointments/alternative-slots-display");
...
function EnhancedAppointmentForm(_a) {
    var _this = this;
    var clinicId = _a.clinicId, editingAppointment = _a.editingAppointment, onSave = _a.onSave, onCancel = _a.onCancel;
    // Form state
    ...
    var _f = (0, react_1.useState)(60), estimatedDuration = _f[0], setEstimatedDuration = _f[1]; // minutes
    // Conflict prevention integration
    var _g = (0, use_conflict_prevention_1.useConflictPrevention)({
        debounceMs: 500,
        enableRealTime: true,
    }), isValidating = _g.isValidating, conflicts = _g.conflicts, warnings = _g.warnings, alternativeSlots = _g.alternativeSlots, isAvailable = _g.isAvailable, hasErrors = _g.hasErrors, hasWarnings = _g.hasWarnings, validateSlot = _g.validateSlot, clearValidation = _g.clearValidation, getSuggestedSlots = _g.getSuggestedSlots;
    ...
    var form = (0, react_hook_form_1.useForm)({
        ...
        defaultValues: {
            patient_id: (editingAppointment === null || editingAppointment === void 0 ? void 0 : editingAppointment.patient_id) || "",
            professional_id: (editingAppointment === null || editingAppointment === void 0 ? void 0 : editingAppointment.professional_id) || "",
            service_type_id: (editingAppointment === null || editingAppointment === void 0 ? void 0 : editingAppointment.service_type_id) || "",
            start_time: (editingAppointment === null || editingAppointment === void 0 ? void 0 : editingAppointment.start_time) || "",
            end_time: (editingAppointment === null || editingAppointment === void 0 ? void 0 : editingAppointment.end_time) || "",
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (startTime && serviceId) {
            ...
            if (service) {
                ...
                var endTime = (0, date_fns_1.addMinutes)((0, date_fns_1.parseISO)(startTime), service.duration).toISOString();
    ...
    var loadPatients = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    setPatients(data.map(function (p) { return ({ id: p.id, name: p.name }); }));
                    _a.label = 3;
    ...
    var loadServices = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    setServices(data.map(function (s) { return ({
                        id: s.id,
                        name: s.name,
    ...
    var triggerValidation = function () { return __awaiter(_this, void 0, void 0, function () {
        var values, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(values.professional_id &&
                        ...
                        values.start_time &&
                        values.end_time)) return [3 /*break*/, 4];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, validateSlot({
                            professional_id: values.professional_id,
                            service_type_id: values.service_type_id,
                            start_time: values.start_time,
                            end_time: values.end_time,
                            exclude_appointment_id: editingAppointment === null || editingAppointment === void 0 ? void 0 : editingAppointment.id,
                        })];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
    ...
    var getAlternativeSuggestions = function () { return __awaiter(_this, void 0, void 0, function () {
        var formData, service, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    formData = form.getValues();
                    if (!formData.professional_id || !formData.service_type_id || !formData.start_time) {
                        sonner_1.toast.error("Complete os campos obrigatórios antes de buscar alternativas");
                        return [2 /*return*/];
                    }
                    service = services.find(function (s) { return s.id === formData.service_type_id; });
                    if (!service) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, alternativeSlots.getSuggestions({
                ...
                case 3:
                    error_5 = _a.sent();
                    console.error("Error getting alternative suggestions:", error_5);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (hasErrors) {
                        sonner_1.toast.error("Existem conflitos que impedem o agendamento. Por favor, resolva-os primeiro.");
                        return [2 /*return*/];
                    }
                ...
                case 2:
                    _a.sent();
                    sonner_1.toast.success(editingAppointment ? "Agendamento atualizado!" : "Agendamento criado!");
                    return [3 /*break*/, 5];
                case 3:
                    error_6 = _a.sent();
                    console.error("Error saving appointment:", error_6);
    ...
    var formatDateTime = function (dateTime) {
        try {
            return (0, date_fns_1.format)((0, date_fns_1.parseISO)(dateTime), "dd/MM/yyyy HH:mm", { locale: locale_1.ptBR });
        }
        catch (_a) {
            return dateTime;
        }
      ...
      <card_1.CardContent>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <react_hook_form_1.Controller name="patient_id" control={form.control} render={function (_a) {
            var field = _a.field;
            return (<select_1.Select value={field.value} onValueChange={field.onChange}>
                  <select_1.SelectTrigger>
                    <select_1.SelectValue placeholder="Selecione um paciente"/>
                  </select_1.SelectTrigger>
                  <select_1.SelectContent>
                    {patients.map(function (patient) { return (<select_1.SelectItem key={patient.id} value={patient.id}>
            ...
            {form.formState.errors.patient_id && (<p className="text-sm text-red-600 mt-1">
          ...
          <div>
            ...
            <react_hook_form_1.Controller name="professional_id" control={form.control} render={function (_a) {
            var field = _a.field;
            return (<select_1.Select value={field.value} onValueChange={function (value) {
            ...
            {form.formState.errors.professional_id && (<p className="text-sm text-red-600 mt-1">
          ...
          <div>
            ...
            <react_hook_form_1.Controller name="service_type_id" control={form.control} render={function (_a) {
            var field = _a.field;
            return (<select_1.Select value={field.value} onValueChange={function (value) {
                    field.onChange(value);
                    clearValidation();
            ...
            {form.formState.errors.service_type_id && (<p className="text-sm text-red-600 mt-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <react_hook_form_1.Controller name="start_time" control={form.control} render={function (_a) {
            var field = _a.field;
            return (<input_1.Input type="datetime-local" {...field} onChange={function (e) {
              ...
              {form.formState.errors.start_time && (<p className="text-sm text-red-600 mt-1">
          ...
          {/* Conflict Display */}
          {(hasErrors || hasWarnings) && (<div className="space-y-3">
              {conflicts
                .filter(function (c) { return c.severity === "error"; })
                .map(function (conflict, index) { return (<alert_1.Alert key={index} className="border-red-200 bg-red-50">
              ...
              {warnings.map(function (warning, index) { return (<alert_1.Alert key={index} className="border-amber-200 bg-amber-50">
          ...
          {hasErrors && (<div className="space-y-4">
              <div className="flex items-center justify-between">
                <h4 className="font-medium text-blue-900 flex items-center gap-2">
                  <lucide_react_1.CalendarDays className="h-4 w-4"/>
                  Buscar Horários Alternativos
                </h4>
                <button_1.Button type="button" variant="outline" size="sm" onClick={getAlternativeSuggestions} disabled={alternativeSlots.isLoading}>
                  {alternativeSlots.isLoading && <lucide_react_1.Loader2 className="mr-2 h-4 w-4 animate-spin"/>}
                  Buscar Alternativas
                </button_1.Button>
              </div>
              
              <alternative_slots_display_1.default alternativeSlots={alternativeSlots} onSelectSlot={function (slot) {
                applyAlternativeSlot(slot);
                alternativeSlots.selectSuggestion(slot);
            }} compact={true} maxDisplaySlots={3}/>
            </div>)}

          {/* Basic Alternative Slots Suggestions (Legacy) */}
          {hasErrors && suggestedSlots.length > 0 && !alternativeSlots.suggestions.length && (<card_1.Card className="border-blue-200 bg-blue-50">
              <card_1.CardContent className="p-4">
                ...
                <div className="space-y-2">
                  {suggestedSlots.map(function (slot, index) { return (<button_1.Button key={index} variant="outline" size="sm" onClick={function () { return applyAlternativeSlot(slot); }} className="w-full justify-between text-sm">
          ...
          {/* Success State */}
          {isAvailable && !hasErrors && !hasWarnings && (<alert_1.Alert className="border-green-200 bg-green-50">
          ...
          <div>
            ...
            <react_hook_form_1.Controller name="notes" control={form.control} render={function (_a) {
            var field = _a.field;
            return (<textarea_1.Textarea {...field} placeholder="Observações adicionais sobre o agendamento..." rows={3}/>);
        }}/>
          </div>
