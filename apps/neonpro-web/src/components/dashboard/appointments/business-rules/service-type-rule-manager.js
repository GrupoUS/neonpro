...
function ServiceTypeRuleManager(_a) {
    var _this = this;
    var clinicId = _a.clinicId, onRulesChange = _a.onRulesChange;
    // State management
    var _b = (0, react_1.useState)([]), rules = _b[0], setRules = _b[1];
    ...
    var _g = (0, react_1.useState)(null), editingRule = _g[0], setEditingRule = _g[1];
    ...
    var loadServices = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    setServices(data.map(function (s) { return ({ id: s.id, name: s.name }); }));
                    _a.label = 3;
    ...
    var loadProfessionals = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    setProfessionals(data.map(function (p) { return ({ id: p.id, name: p.name }); }));
                    _a.label = 3;
                case 3: return [3 /*break*/, 5];
                case 4:
                    error_3 = _a.sent();
    ...
    var saveRule = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (formData.requires_specific_professional &&
                        formData.allowed_professional_ids.length === 0) {
                        sonner_1.toast.error('Selecione pelo menos um profissional quando "Requer profissional específico" está ativo');
                        return [2 /*return*/];
                    }
                ...
                case 2:
                    ...
                    if (editingRule) {
                        setRules(function (prev) {
                            return prev.map(function (r) { return (r.id === editingRule.id ? savedRule_1 : r); });
                        });
                        sonner_1.toast.success("Regra atualizada com sucesso!");
                    }
                    else {
                        setRules(function (prev) { return __spreadArray(__spreadArray([], prev, true), [savedRule_1], false); });
    ...
    var deleteRule = function (ruleId) { return __awaiter(_this, void 0, void 0, function () {
        var response, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("/api/clinic/".concat(clinicId, "/service-rules/").concat(ruleId), {
                            method: "DELETE",
                        })];
                case 1:
                    response = _a.sent();
    ...
    var toggleRuleStatus = function (ruleId, isActive) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setRules(function (prev) {
                        return prev.map(function (r) { return (r.id === ruleId ? __assign(__assign({}, r), { is_active: isActive }) : r); });
                    });
                    sonner_1.toast.success("Regra ".concat(isActive ? "ativada" : "desativada", " com sucesso!"));
                    return [3 /*break*/, 3];
                case 2:
                    error_6 = _a.sent();
    ...
    var getServiceName = function (serviceId) {
        ...
        return (service === null || service === void 0 ? void 0 : service.name) || "Serviço não encontrado";
    };
    var getProfessionalNames = function (professionalIds) {
        return professionalIds.map(function (id) {
            var professional = professionals.find(function (p) { return p.id === id; });
            return (professional === null || professional === void 0 ? void 0 : professional.name) || "Profissional não encontrado";
        });
    };
    ...
    return (<card_1.Card>
        ...
        <div className="flex items-center justify-between">
          ...
          <dialog_1.Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <dialog_1.DialogTrigger asChild>
              <button_1.Button onClick={function () { return openDialog(); }}>
            ...
            <dialog_1.DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <select_1.Select value={formData.service_type_id} onValueChange={function (value) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { service_type_id: value })); });
        }}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input_1.Input type="number" min="15" step="15" value={formData.minimum_duration} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { minimum_duration: parseInt(e.target.value) || 30 })); });
        }}/>
                    </div>
                    <div>
                      <label_1.Label>Duração máxima (min) *</label_1.Label>
                      <input_1.Input type="number" min="15" step="15" value={formData.maximum_duration} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { maximum_duration: parseInt(e.target.value) || 180 })); });
        }}/>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input_1.Input type="number" min="0" step="5" value={formData.buffer_before} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { buffer_before: parseInt(e.target.value) || 0 })); });
        }}/>
                    </div>
                    <div>
                      <label_1.Label>Buffer depois (min)</label_1.Label>
                      <input_1.Input type="number" min="0" step="5" value={formData.buffer_after} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { buffer_after: parseInt(e.target.value) || 0 })); });
        }}/>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input_1.Input type="number" min="1" value={formData.max_daily_bookings || ""} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { max_daily_bookings: e.target.value
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <switch_1.Switch checked={formData.requires_specific_professional} onCheckedChange={function (checked) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { requires_specific_professional: checked, allowed_professional_ids: checked
                  ...
                  {formData.requires_specific_professional && (<div>
                      <label_1.Label>Profissionais autorizados</label_1.Label>
                      <select_1.Select value="" onValueChange={function (professionalId) {
                if (!formData.allowed_professional_ids.includes(professionalId)) {
                    setFormData(function (prev) { return (__assign(__assign({}, prev), { allowed_professional_ids: __spreadArray(__spreadArray([], prev.allowed_professional_ids, true), [
                            professionalId,
                        ], false) })); });
                }
            }}>
                ...
                .map(function (professional) { return (<select_1.SelectItem key={professional.id} value={professional.id}>
                                {professional.name}
                              </select_1.SelectItem>); })}
                        </select_1.SelectContent>
                      </select_1.Select>

                      {formData.allowed_professional_ids.length > 0 && (<div className="flex flex-wrap gap-2 mt-2">
                          {getProfessionalNames(formData.allowed_professional_ids).map(function (name, index) { return (<badge_1.Badge key={index} variant="secondary" className="cursor-pointer" onClick={function () {
                        var professionalId = formData.allowed_professional_ids[index];
                        setFormData(function (prev) { return (__assign(__assign({}, prev), { allowed_professional_ids: prev.allowed_professional_ids.filter(function (id) { return id !== professionalId; }) })); });
                    }}>
                              {name} ×
                            </badge_1.Badge>); })}
                        </div>)}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <switch_1.Switch checked={formData.allow_same_day} onCheckedChange={function (checked) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { allow_same_day: checked, minimum_advance_hours: checked
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input_1.Input type="number" min="0" value={formData.minimum_advance_hours} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { minimum_advance_hours: parseInt(e.target.value) || 0 })); });
        }} disabled={!formData.allow_same_day &&
            formData.minimum_advance_hours < 24}/>
                    </div>
                    <div>
                      <label_1.Label>Máximo antecedência (dias)</label_1.Label>
                      <input_1.Input type="number" min="1" value={formData.maximum_advance_days} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { maximum_advance_days: parseInt(e.target.value) || 90 })); });
        }}/>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea_1.Textarea value={formData.description} onChange={function (e) {
            return setFormData(function (prev) { return (__assign(__assign({}, prev), { description: e.target.value })); });
        }} placeholder="Detalhes adicionais sobre esta regra..." rows={2}/>
                </div>
              </div>
      ...
      <card_1.CardContent>
        <div className="space-y-4">
          {rules.length === 0 ? (<div className="text-center py-8 text-muted-foreground">
            ...
            return (<card_1.Card key={rule.id} className={!rule.is_active ? "opacity-60" : ""}>
                  <card_1.CardContent className="p-4">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <h4 className="font-medium">{serviceName}</h4>
                          {!rule.is_active && (<badge_1.Badge variant="outline" className="text-xs">
                              Inativa
                            </badge_1.Badge>)}
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-muted-foreground">
                          <div className="space-y-1">
                            <div className="flex items-center gap-1">
                              ...
                              Duração: {formatDuration(rule.minimum_duration)} - {formatDuration(rule.maximum_duration)}
                            </div>
                            {(rule.buffer_before > 0 ||
                    rule.buffer_after > 0) && (<div className="text-xs">
                                Buffer: {rule.buffer_before}min antes,{" "}
                                {rule.buffer_after}min depois
                              </div>)}
                            {rule.max_daily_bookings && (<div className="flex items-center gap-1">
                          ...
                          <div className="space-y-1">
                            ...
                            {rule.requires_specific_professional && (<div className="text-xs">
                        ...
                        {rule.description && (<p className="text-xs text-muted-foreground mt-2 italic">
                            {rule.description}
                          </p>)}
                      </div>

                      <div className="flex items-center gap-1">
                        <switch_1.Switch checked={rule.is_active} onCheckedChange={function (checked) {
                    return toggleRuleStatus(rule.id, checked);
                }}/>
                        <button_1.Button variant="ghost" size="sm" onClick={function () { return openDialog(rule); }}>
                          <lucide_react_1.Edit className="h-3 w-3"/>
                        </button_1.Button>
                        <button_1.Button variant="ghost" size="sm" onClick={function () { return deleteRule(rule.id); }} className="text-red-600 hover:text-red-700">
        ...
        {rules.length > 0 && (<div className="mt-4 p-3 bg-amber-50 rounded-lg">
