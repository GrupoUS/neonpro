...
function ClinicHolidayManager(_a) {
            ...
            if (editingHoliday) {
              setHolidays(function (prev) {
                return prev.map(function (h) {
                  return h.id === editingHoliday.id ? savedHoliday_1 : h;
                });
              });
              sonner_1.toast.success("Feriado atualizado com sucesso!");
            } else {
              setHolidays(function (prev) {
                return __spreadArray(__spreadArray([], prev, true), [savedHoliday_1], false);
              });
  ...
  var deleteHoliday = function (holidayId) {
    return __awaiter(_this, void 0, void 0, function () {
  ...
  var toggleHolidayStatus = function (holidayId, isActive) {
    return __awaiter(_this, void 0, void 0, function () {
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input_1.Input
                      ...
                      onChange={function (e) {
                        return setFormData(function (prev) {
                          return __assign(__assign({}, prev), { end_date: e.target.value });
                        });
                      }}
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input_1.Input
                      ...
                      onChange={function (e) {
                        return setFormData(function (prev) {
                          return __assign(__assign({}, prev), { start_time: e.target.value });
                        });
                      }}
                    />
                  </div>
                  <div>
                    ...
                    <input_1.Input
                      ...
                      onChange={function (e) {
                        return setFormData(function (prev) {
                          return __assign(__assign({}, prev), { end_time: e.target.value });
                        });
                      }}
                    />
                  </div>
                  ...
                  {formData.is_recurring && (
                    <select_1.Select
                      ...
                      onValueChange={function (value) {
                        return setFormData(function (prev) {
                          return __assign(__assign({}, prev), { recurrence_type: value });
                        });
                      }}
                    >
