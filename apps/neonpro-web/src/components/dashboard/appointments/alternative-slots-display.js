...
function AlternativeSlotsDisplay(_a) {
  var alternativeSlots = _a.alternativeSlots,
    onSelectSlot = _a.onSelectSlot,
    _b = _a.maxDisplaySlots,
    maxDisplaySlots = _b === void 0 ? 5 : _b,
    _c = _a.showGroupByDay,
    showGroupByDay = _c === void 0 ? false : _c,
    _d = _a.compact,
    ...
    // Research-based props
    showPerformanceMetrics = _e === void 0 ? false : _e,
    _f = _a.enableRealtimeFiltering,
    enableRealtimeFiltering = _f === void 0 ? false : _f,
    _g = _a.showBookingProbability,
    showBookingProbability = _g === void 0 ? false : _g;
  var suggestions = alternativeSlots.suggestions,
    isLoading = alternativeSlots.isLoading,
    error = alternativeSlots.error,
    selectedSuggestion = alternativeSlots.selectedSuggestion,
...
function SlotCard(_a) {
  var slot = _a.slot,
    ...
    _d = _a.showRanking,
    showRanking = _d === void 0 ? false : _d,
    ranking = _a.ranking;
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium">
            {(0, use_alternative_slots_1.formatAlternativeSlot)(slot)}
          </span>
        </div>
        <div className="flex items-center gap-2">
          {slot.is_same_day && (
    ...
    >
      <div className="flex items-start justify-between">
        <div className="space-y-2 flex-1">
          <div className="flex items-center gap-2">
            {showRanking && ranking && (
              <badge_1.Badge variant="outline" className="text-xs px-2 py-1">
                #{ranking}
              </badge_1.Badge>
            )}
        ...
        <div className="ml-4 flex items-center">
          {isSelected
            ? <badge_1.Badge className="bg-primary text-primary-foreground">
                Selecionado
              </badge_1.Badge>
