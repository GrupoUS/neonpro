...
function DeleteAppointmentDialog(_a) {
    var _this = this;
    var _b, _c, _d;
    var appointment = _a.appointment, isOpen = _a.isOpen, onClose = _a.onClose, onDelete = _a.onDelete;
    ...
    if (isFutureAppointment) {
        warnings.push({
            ...
            message: "Este \u00E9 um agendamento futuro (".concat((0, date_fns_1.format)(appointmentDate, "dd/MM/yyyy 'às' HH:mm", { locale: locale_1.ptBR }), ")"),
            severity: "warning",
        });
    }
    if (isConfirmed) {
    ...
    return (<dialog_1.Dialog open={isOpen} onOpenChange={handleClose}>
      <dialog_1.DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          <div className="rounded-lg border bg-muted/50 p-4">
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-medium">
                  {((_b = appointment.patient) === null || _b === void 0 ? void 0 : _b.full_name) || "Paciente não informado"}
                </span>
              </div>
              <div className="flex items-center gap-2 text-sm">
            ...
            locale: locale_1.ptBR,
              ...
              <div className="text-sm text-muted-foreground">
                {((_d = appointment.service_type) === null || _d === void 0 ? void 0 : _d.name) || "Serviço não especificado"}
              </div>
            </div>
          </div>
          ...
          {warnings.length > 0 && (<div className="space-y-2">
              {warnings.map(function (warning, index) {
                ...
                return (<alert_1.Alert key={index} variant={warning.severity === "error" ? "destructive" : "default"}>
          ...
          <div className="space-y-2">
            ...
            <textarea_1.Textarea id="reason" placeholder="Ex: Paciente solicitou reagendamento, conflito de horário, etc..." value={reason} onChange={function (e) { return setReason(e.target.value); }} disabled={isDeleting} className="min-h-[80px]"/>
        ...
        <dialog_1.DialogFooter>
          ...
          <button_1.Button variant="destructive" onClick={handleDelete} disabled={isDeleting || !reason.trim()}>
