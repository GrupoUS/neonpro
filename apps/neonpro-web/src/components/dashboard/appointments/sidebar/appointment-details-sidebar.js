...
function AppointmentDetailsSidebar(_a) {
    var _this = this;
    var isOpen = _a.isOpen, appointmentId = _a.appointmentId, onClose = _a.onClose, onUpdate = _a.onUpdate, onDelete = _a.onDelete;
    var _b = (0, react_1.useState)('view'), mode = _b[0], setMode = _b[1];
    var _c = (0, react_1.useState)(null), appointment = _c[0], setAppointment = _c[1];
    var _d = (0, react_1.useState)([]), history = _d[0], setHistory = _d[1];
    var _e = (0, react_1.useState)(false), loading = _e[0], setLoading = _e[1];
    var _f = (0, react_1.useState)(false), updating = _f[0], setUpdating = _f[1];
    // Fetch appointment details
    var fetchAppointmentDetails = function (id) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var fetchAppointmentHistory = function (id) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var handleUpdate = function (updatedAppointment) { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleDelete = function (reason) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch("/api/appointments/".concat(appointmentId), {
                            method: 'DELETE',
    ...
    if (!isOpen)
        return null;
    return (<sheet_1.Sheet open={isOpen} onOpenChange={handleClose}>
      <sheet_1.SheetContent className="w-full sm:max-w-lg overflow-y-auto">
        <sheet_1.SheetHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              {appointment && (<sheet_1.SheetDescription className="text-left">
                  {appointment.patient_name} - {appointment.service_name}
                </sheet_1.SheetDescription>)}
            </div>
            <div className="flex gap-2">
              {mode === 'view' && appointment && (<button_1.Button variant="outline" size="sm" onClick={function () { return setMode('edit'); }} disabled={loading}>
                  <lucide_react_1.Edit className="h-4 w-4"/>
                  Editar
                </button_1.Button>)}
              {mode === 'edit' && (<button_1.Button variant="outline" size="sm" onClick={function () { return setMode('view'); }} disabled={updating}>
        ...
        {loading && (<div className="flex items-center justify-center py-8">
          ...
          </div>)}        {!loading && appointment && (<>
            {mode === 'view' ? (<tabs_1.Tabs defaultValue="details" className="space-y-4">
                ...
                <tabs_1.TabsContent value="details">
                  <appointment_details_1.default appointment={appointment} onDelete={handleDelete}/>
                </tabs_1.TabsContent>
                
                <tabs_1.TabsContent value="history">
                  <appointment_history_1.default history={history} isLoading={loading}/>
                </tabs_1.TabsContent>
              </tabs_1.Tabs>) : (<appointment_edit_form_1.default appointment={appointment} onUpdate={handleUpdate} onCancel={function () { return setMode('view'); }} isUpdating={updating}/>)}
          </>)}

        {!loading && !appointment && (<div className="flex items-center justify-center py-8">
