...
function AppointmentHistory(_a) {
    var history = _a.history, _b = _a.isLoading, isLoading = _b === void 0 ? false : _b;
    ...
    var renderFieldChange = function (field, oldValue, newValue) {
        ...
        return (<div key={field} className="text-xs space-y-1">
        ...
        <scroll_area_1.ScrollArea className="h-[400px]">
          <div className="space-y-4">
            ...
            return (<div key={entry.id} className="relative">
                  {/* Timeline line */}
                  {index < history.length - 1 && (<div className="absolute left-6 top-10 h-full w-px bg-border"/>)}
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      {entry.change_reason && (<div className="bg-muted/50 rounded p-2">
                      ...
                      {/* Field changes */}
                      {entry.action === 'update' && entry.changed_fields.length > 0 && (<div className="bg-muted/30 rounded p-3 space-y-2">
                          <p className="text-xs font-medium text-muted-foreground mb-2">
                            Campos alterados:
                          </p>
                          {entry.changed_fields.map(function (field) {
                        var _a, _b;
                        return (renderFieldChange(field, (_a = entry.old_values) === null || _a === void 0 ? void 0 : _a[field], (_b = entry.new_values) === null || _b === void 0 ? void 0 : _b[field]));
                    })}
                        </div>)}
                    </div>
                  </div>
