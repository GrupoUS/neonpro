...
function AppointmentEditForm(_a) {
    var _this = this;
    var appointment = _a.appointment, onUpdate = _a.onUpdate, onCancel = _a.onCancel, _b = _a.isUpdating, isUpdating = _b === void 0 ? false : _b;
          ...
          <form_1.Form {...form}>
            ...
            return (<form_1.FormItem>
              ...
              <div className="flex gap-3 pt-4">
                <button_1.Button type="submit" disabled={isUpdating || !!conflictError || checkingConflict} className="flex-1">
                  {isUpdating && <lucide_react_1.Loader2 className="mr-2 h-4 w-4 animate-spin"/>}
                  <lucide_react_1.Save className="mr-2 h-4 w-4"/>
                  Salvar Alterações
                </button_1.Button>
                <button_1.Button type="button" variant="outline" onClick={onCancel} disabled={isUpdating}>
                  Cancelar
                </button_1.Button>
              </div>
            </form>
