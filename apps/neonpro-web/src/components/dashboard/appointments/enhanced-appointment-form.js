    ...
    return (<card_1.Card>
      ...
      <card_1.CardContent>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
          ...
          {hasErrors && suggestedSlots.length > 0 && (<card_1.Card className="border-blue-200 bg-blue-50">
...
exports.default = (0, error_boundary_1.withErrorBoundary)(EnhancedAppointmentForm, {
    onError: function (error, errorInfo) {
        ...
        if (typeof window !== 'undefined') {
            Promise.resolve().then(function () { return require('@sentry/nextjs'); }).then(function (_a) {
                var withScope = _a.withScope, captureException = _a.captureException;
