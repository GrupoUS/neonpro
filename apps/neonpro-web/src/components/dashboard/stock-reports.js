...
function StockReports(_a) {
  ...
  var _d = (0, react_1.useState)([]),
    consumptionTrend = _d[0],
    setConsumptionTrend = _d[1];
  var _e = (0, react_1.useState)([]),
    topProducts = _e[0],
    setTopProducts = _e[1];
  var _f = (0, react_1.useState)([]),
    wasteAnalysis = _f[0],
    setWasteAnalysis = _f[1];
  var _g = (0, react_1.useState)(true),
    isLoading = _g[0],
    setIsLoading = _g[1];
  var _h = (0, react_1.useState)("dashboard"),
    selectedTab = _h[0],
    setSelectedTab = _h[1];
      ...
      return __generator(this, (_e) => {
        switch (_e.label) {
          ...
          case 3:
            ...
            setConsumptionTrend(
              ((_b = dashboardData.charts) === null || _b === void 0
                ? void 0
                : _b.consumptionTrend) || [],
            );
            setTopProducts(
              ((_c = dashboardData.charts) === null || _c === void 0 ? void 0 : _c.topProducts) ||
                [],
            );
            setWasteAnalysis(
              ((_d = dashboardData.charts) === null || _d === void 0 ? void 0 : _d.wasteAnalysis) ||
                [],
            );
            _e.label = 4;
          case 4:
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/stock/reports/generate", {
                method: "POST",
        ...
        <tabs_1.Tabs value={selectedTab} onValueChange={(value) => setSelectedTab(value)}>
          ...
          <tabs_1.TabsContent value="dashboard" className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <card_1.Card>
                <card_1.CardHeader>
                  <card_1.CardTitle className="text-lg">Produtos Mais Consumidos</card_1.CardTitle>
                </card_1.CardHeader>
                <card_1.CardContent>
              ...
              <card_1.Card>
                <card_1.CardHeader>
                  <card_1.CardTitle className="text-lg">Análise de Desperdício</card_1.CardTitle>
                </card_1.CardHeader>
                <card_1.CardContent>
