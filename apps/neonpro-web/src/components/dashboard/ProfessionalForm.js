...
function ProfessionalForm(_a) {
    var _this = this;
    var professionalId = _a.professionalId, _b = _a.mode, mode = _b === void 0 ? 'create' : _b;
    var router = (0, navigation_1.useRouter)();
    var _c = (0, react_1.useState)(false), loading = _c[0], setLoading = _c[1];
    var _d = (0, react_1.useState)(null), professional = _d[0], setProfessional = _d[1];
    var _e = (0, react_1.useState)([]), credentials = _e[0], setCredentials = _e[1];
    var _f = (0, react_1.useState)([]), services = _f[0], setServices = _f[1];
    var _g = (0, react_1.useState)([]), specialties = _g[0], setSpecialties = _g[1];
    var _h = (0, react_1.useState)([]), selectedSpecialties = _h[0], setSelectedSpecialties = _h[1];
    var _j = (0, react_1.useState)(false), showCredentialDialog = _j[0], setShowCredentialDialog = _j[1];
    var _k = (0, react_1.useState)(false), showServiceDialog = _k[0], setShowServiceDialog = _k[1];
    var _l = (0, react_1.useState)(null), profilePhoto = _l[0], setProfilePhoto = _l[1];
    var form = (0, react_hook_form_1.useForm)({
        resolver: (0, zod_1.zodResolver)(mode === 'create' ? professional_1.ProfessionalCreateSchema : professional_1.ProfessionalUpdateSchema),
        defaultValues: {
            given_name: '',
            family_name: '',
            email: '',
    ...
    var credentialForm = (0, react_hook_form_1.useForm)({
        resolver: (0, zod_1.zodResolver)(professional_1.CredentialCreateSchema.omit({ professional_id: true })),
        defaultValues: {
            credential_type: '',
            credential_number: '',
            issuing_authority: '',
    ...
    var serviceForm = (0, react_hook_form_1.useForm)({
        resolver: (0, zod_1.zodResolver)(professional_1.ServiceCreateSchema.omit({ professional_id: true })),
        defaultValues: {
            service_name: '',
            service_type: '',
            description: '',
    ...
    var loadSpecialties = function () { return __awaiter(_this, void 0, void 0, function () {
        var data, error_1;
    ...
    var loadProfessional = function () { return __awaiter(_this, void 0, void 0, function () {
        var data, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleAddCredential = function (data) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    setCredentials(function (prev) { return __spreadArray(__spreadArray([], prev, true), [newCredential_1], false); });
    ...
    var handleAddService = function (data) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var handleSpecialtyToggle = function (specialtyId) {
        setSelectedSpecialties(function (prev) {
            return prev.includes(specialtyId)
                ? prev.filter(function (id) { return id !== specialtyId; })
    ...
    return (<div className="flex-1 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button_1.Button variant="outline" onClick={function () { return router.back(); }}>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <tabs_1.Tabs defaultValue="personal" className="w-full">
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="h-24 w-24 rounded-full bg-muted flex items-center justify-center">
                        {profilePhoto ? (<img src={URL.createObjectURL(profilePhoto)} alt="Profile" className="h-24 w-24 rounded-full object-cover"/>) : (<lucide_react_1.User className="h-12 w-12 text-muted-foreground"/>)}
                      </div>
                      <div>
                        <input_1.Input id="photo" type="file" accept="image/*" onChange={handlePhotoUpload} className="hidden"/>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <form_1.FormField control={form.control} name="given_name" render={function (_a) {
            var field = _a.field;
            ...
            return (<form_1.FormItem>
                    ...
                    <form_1.FormField control={form.control} name="phone_number" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
            ...
            return (<form_1.FormItem>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <form_1.FormField control={form.control} name="address.line" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                      ...
                      <form_1.FormField control={form.control} name="address.city" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                      ...
                      <form_1.FormField control={form.control} name="address.state" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                      ...
                      <form_1.FormField control={form.control} name="address.postal_code" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
            ...
            return (<form_1.FormItem>
                        ...
                        <form_1.FormControl>
                          <textarea_1.Textarea placeholder="Descrição sobre o profissional, experiência, especialidades..." className="min-h-[100px]" {...field}/>
                        </form_1.FormControl>
            ...
            <tabs_1.TabsContent value="professional">
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <form_1.FormField control={form.control} name="license_number" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                    ...
                    <form_1.FormField control={form.control} name="qualification" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          <form_1.FormLabel>Qualificação Principal</form_1.FormLabel>
                          <form_1.FormControl>
                            <input_1.Input placeholder="Médico, Dentista, Fisioterapeuta, etc." {...field}/>
                          </form_1.FormControl>
                          <form_1.FormMessage />
                        </form_1.FormItem>);
        }}/>

                    <form_1.FormField control={form.control} name="employment_status" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          ...
                          <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <select_1.SelectContent>
                              {employmentStatusOptions.map(function (option) { return (<select_1.SelectItem key={option.value} value={option.value}>
                                  {option.label}
                                </select_1.SelectItem>); })}
                            </select_1.SelectContent>
                          </select_1.Select>
                    ...
                    <form_1.FormField control={form.control} name="status" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                          ...
                          <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <select_1.SelectContent>
                              {professionalStatusOptions.map(function (option) { return (<select_1.SelectItem key={option.value} value={option.value}>
                                  {option.label}
                                </select_1.SelectItem>); })}
                            </select_1.SelectContent>
                          </select_1.Select>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {specialties.map(function (specialty) { return (<div key={specialty.id} className="flex items-center space-x-2 p-3 border rounded-lg hover:bg-accent cursor-pointer" onClick={function () { return handleSpecialtyToggle(specialty.id); }}>
                        <checkbox_1.Checkbox checked={selectedSpecialties.includes(specialty.id)} onChange={function () { return handleSpecialtyToggle(specialty.id); }}/>
              ...
              <card_1.Card>
                <card_1.CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <dialog_1.Dialog open={showCredentialDialog} onOpenChange={setShowCredentialDialog}>
                      ...
                      <dialog_1.DialogContent>
                        ...
                        <form_1.Form {...credentialForm}>
                          <form onSubmit={credentialForm.handleSubmit(handleAddCredential)} className="space-y-4">
                            <form_1.FormField control={credentialForm.control} name="credential_type" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                                  ...
                                  <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                                    ...
                                    <select_1.SelectContent>
                                      {credentialTypeOptions.map(function (option) { return (<select_1.SelectItem key={option.value} value={option.value}>
                                          {option.label}
                                        </select_1.SelectItem>); })}
                                    </select_1.SelectContent>
                                  </select_1.Select>
                            ...
                            <form_1.FormField control={credentialForm.control} name="credential_number" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                                  <form_1.FormLabel>Número da Credencial</form_1.FormLabel>
                                  <form_1.FormControl>
                                    <input_1.Input placeholder="Número ou código da credencial" {...field}/>
                                  </form_1.FormControl>
                                  <form_1.FormMessage />
                                </form_1.FormItem>);
        }}/>

                            <form_1.FormField control={credentialForm.control} name="issuing_authority" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                                  <form_1.FormLabel>Autoridade Emissora</form_1.FormLabel>
                                  <form_1.FormControl>
                                    <input_1.Input placeholder="CFM, CRO, Universidade, etc." {...field}/>
                                  </form_1.FormControl>
                                  <form_1.FormMessage />
                                </form_1.FormItem>);
        }}/>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <form_1.FormField control={credentialForm.control} name="issue_date" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                              ...
                              <form_1.FormField control={credentialForm.control} name="expiry_date" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                            ...
                            <form_1.FormField control={credentialForm.control} name="description" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                                  <form_1.FormLabel>Descrição</form_1.FormLabel>
                                  <form_1.FormControl>
                                    <textarea_1.Textarea placeholder="Detalhes sobre a credencial..." {...field}/>
                                  </form_1.FormControl>
                                  <form_1.FormMessage />
                                </form_1.FormItem>);
        }}/>
                        ...
                        <dialog_1.DialogFooter>
                          <button_1.Button variant="outline" onClick={function () { return setShowCredentialDialog(false); }}>
                            Cancelar
                          </button_1.Button>
                          <button_1.Button onClick={credentialForm.handleSubmit(handleAddCredential)} disabled={loading}>
                            Adicionar
                          </button_1.Button>
                        </dialog_1.DialogFooter>
                      </dialog_1.DialogContent>
                ...
                <card_1.CardContent>
                  {credentials.length === 0 ? (<div className="text-center py-8">
                      ...
                      {credentials.map(function (credential) { return (<div key={credential.id} className="flex items-center justify-between p-4 border rounded-lg">
                          <div>
                          ...
                          <div className="flex items-center gap-2">
                            <badge_1.Badge variant={credential.verification_status === 'verified' ? 'default' : 'outline'}>
                      ...
                      <dialog_1.DialogContent>
                        ...
                        <form_1.Form {...serviceForm}>
                          <form onSubmit={serviceForm.handleSubmit(handleAddService)} className="space-y-4">
                            <form_1.FormField control={serviceForm.control} name="service_name" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                            ...
                            <form_1.FormField control={serviceForm.control} name="service_type" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                                  ...
                                  <select_1.Select onValueChange={field.onChange} defaultValue={field.value}>
                                    ...
                                    <select_1.SelectContent>
                                      {serviceTypeOptions.map(function (option) { return (<select_1.SelectItem key={option.value} value={option.value}>
                                          {option.label}
                                        </select_1.SelectItem>); })}
                                    </select_1.SelectContent>
                                  </select_1.Select>
                            ...
                            <form_1.FormField control={serviceForm.control} name="description" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                                  <form_1.FormLabel>Descrição</form_1.FormLabel>
                                  <form_1.FormControl>
                                    <textarea_1.Textarea placeholder="Descrição do serviço..." {...field}/>
                                  </form_1.FormControl>
                                  <form_1.FormMessage />
                                </form_1.FormItem>);
        }}/>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <form_1.FormField control={serviceForm.control} name="duration_minutes" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                                    <form_1.FormLabel>Duração (minutos)</form_1.FormLabel>
                                    <form_1.FormControl>
                                      <input_1.Input type="number" placeholder="60" {...field} onChange={function (e) { return field.onChange(parseInt(e.target.value)); }}/>
                                    </form_1.FormControl>
                                    <form_1.FormMessage />
                                  </form_1.FormItem>);
        }}/>

                              <form_1.FormField control={serviceForm.control} name="base_price" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                                    <form_1.FormLabel>Preço Base (R$)</form_1.FormLabel>
                                    <form_1.FormControl>
                                      <input_1.Input type="number" step="0.01" placeholder="0.00" {...field} onChange={function (e) { return field.onChange(parseFloat(e.target.value)); }}/>
                                    </form_1.FormControl>
                                    <form_1.FormMessage />
                                  </form_1.FormItem>);
        }}/>
                            ...
                            <form_1.FormField control={serviceForm.control} name="requires_certification" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <dialog_1.DialogFooter>
                          <button_1.Button variant="outline" onClick={function () { return setShowServiceDialog(false); }}>
                            Cancelar
                          </button_1.Button>
                          <button_1.Button onClick={serviceForm.handleSubmit(handleAddService)} disabled={loading}>
                            Adicionar
                          </button_1.Button>
                        </dialog_1.DialogFooter>
                      </dialog_1.DialogContent>
                ...
                var _a;
                return (<div key={service.id} className="p-4 border rounded-lg">
                          ...
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-medium">
                              R$ {((_a = service.base_price) === null || _a === void 0 ? void 0 : _a.toFixed(2)) || '0.00'}
                            </span>
                          </div>
                          {service.requires_certification && (<badge_1.Badge className="mt-2" variant="outline">
