      ...
      <div className="flex h-16 items-center gap-4 px-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            Bem-vindo de volta,{" "}
            {((_b = user === null || user === void 0 ? void 0 : user.user_metadata) === null ||
            _b === void 0
              ? void 0
              : _b.full_name) ||
              ((_c = user === null || user === void 0 ? void 0 : user.email) === null ||
              _c === void 0
                ? void 0
                : _c.split("@")[0])}
            !
        ...
        <div className="flex items-center gap-2">
          ...
          <dropdown_menu_1.DropdownMenu>
              ...
              <button_1.Button variant="ghost" className="relative h-8 w-8 rounded-full">
                <avatar_1.Avatar className="h-8 w-8">
                  <avatar_1.AvatarImage
                    src={
                      (_d = user === null || user === void 0 ? void 0 : user.user_metadata) ===
                        null || _d === void 0
                        ? void 0
                        : _d.avatar_url
                    }
                  ...
                  <avatar_1.AvatarFallback>
                    {(_e = user === null || user === void 0 ? void 0 : user.email) === null ||
                    _e === void 0
                      ? void 0
                      : _e.charAt(0).toUpperCase()}
                  </avatar_1.AvatarFallback>
                </avatar_1.Avatar>
              </button_1.Button>
            </dropdown_menu_1.DropdownMenuTrigger>
            <dropdown_menu_1.DropdownMenuContent className="w-56" align="end" forceMount>
              <dropdown_menu_1.DropdownMenuLabel className="font-normal">
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium leading-none">
                    {((_f = user === null || user === void 0 ? void 0 : user.user_metadata) ===
                      null || _f === void 0
                      ? void 0
                      : _f.full_name) || "Usuário"}
                  </p>
              ...
              <dropdown_menu_1.DropdownMenuSeparator />
              <dropdown_menu_1.DropdownMenuItem>Perfil</dropdown_menu_1.DropdownMenuItem>
              <dropdown_menu_1.DropdownMenuItem>Configurações</dropdown_menu_1.DropdownMenuItem>
              <dropdown_menu_1.DropdownMenuItem>Suporte</dropdown_menu_1.DropdownMenuItem>
              <dropdown_menu_1.DropdownMenuSeparator />
