    ...
    return (<card_1.Card>
      ...
      <card_1.CardContent>
        <div className="space-y-3">
          {mockOpportunities.map(function (opportunity, index) { return (<div key={index} className={"flex items-start space-x-3 p-3 rounded-lg border-l-2 bg-muted/30 ".concat(getPriorityColor(opportunity.priority))}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <button_1.Button variant="ghost" size="sm" className="h-auto p-0 font-medium text-primary hover:text-primary/80">
        ...
        {mockOpportunities.length === 0 && (<div className="text-center py-6 text-muted-foreground">
