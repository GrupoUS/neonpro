...
function ProfessionalPerformanceDashboard(_a) {
  ...
  var _b = (0, react_1.useState)([]),
    professionals = _b[0],
    setProfessionals = _b[1];
  var _c = (0, react_1.useState)(professionalId || "all"),
  ...
  var _e = (0, react_1.useState)([]),
    teamPerformance = _e[0],
    setTeamPerformance = _e[1];
  var _f = (0, react_1.useState)("month"),
    period = _f[0],
    setPeriod = _f[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              (0, professionals_1.getProfessionalMetrics)(selectedProfessional, period),
            ];
          case 2:
            metricsData = _a.sent();
          ...
          case 3:
            return [
              4 /*yield*/,
              (0, professionals_1.getAggregatedMetrics)(period),
                ...
                <card_1.Card key={metric.id}>
                  ...
                  <card_1.CardContent>
                    ...
                    <div className="flex items-center text-xs text-muted-foreground">
                      ...
                      <span className="ml-1">
                        {(_a = metric.change) === null || _a === void 0 ? void 0 : _a.toFixed(1)}%
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Comparativo de consultas por área</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
                <div className="h-[200px] flex items-center justify-center text-muted-foreground">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3 p-3 border rounded-lg">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            Considere revisar o cronograma para melhorar a pontualidade nas
                            consultas
                          </div>
                        </div>
                      </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <card_1.Card>
              <card_1.CardHeader>
                ...
                <card_1.CardDescription>Objetivos coletivos da clínica</card_1.CardDescription>
              </card_1.CardHeader>
              <card_1.CardContent>
                <div className="space-y-4">
                  <div>
