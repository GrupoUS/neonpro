        ...
        <card_1.CardContent className="p-6">
          <div className="animate-pulse">
            ...
            <div className="grid grid-cols-7 gap-2">
              {__spreadArray([], Array(35), true).map(function (_, i) {
                return <div key={i} className="h-20 bg-gray-200 rounded"></div>;
              })}
            </div>
          </div>
        </card_1.CardContent>
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-1">
                    {day.appointments.slice(0, 2).map(function (appointment) {
                      return (
                        <div
                          key={appointment.id}
                          className={(0, utils_1.cn)(
      ...
      {selectedDate && selectedDateAppointments.length > 0 && (
        <card_1.Card>
          ...
          <card_1.CardContent className="space-y-3">
            {selectedDateAppointments.map(function (appointment) {
              return (
                <div
                  key={appointment.id}
                  className="flex items-center justify-between p-3 border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors"
                  onClick={function () {
                    return onAppointmentSelect === null || onAppointmentSelect === void 0
                      ? void 0
                      : onAppointmentSelect(appointment);
                  }}
                >
