...
function AppointmentManagementDashboard(_a) {
  ...
  var _f = (0, react_1.useState)(false),
    editDialogOpen = _f[0],
    setEditDialogOpen = _f[1];
  var _g = (0, react_1.useState)(false),
    rescheduleDialogOpen = _g[0],
    setRescheduleDialogOpen = _g[1];
  var _h = (0, react_1.useState)(false),
    contactDialogOpen = _h[0],
    setContactDialogOpen = _h[1];
  var _j = (0, react_1.useState)(false),
    createDialogOpen = _j[0],
    setCreateDialogOpen = _j[1];
  var _k = (0, react_1.useState)(null),
    selectedAppointment = _k[0],
    setSelectedAppointment = _k[1];
  var _l = (0, use_appointments_manager_1.useAppointmentsManager)({
    ...
    appointments = _l.appointments,
    filters = _l.filters,
    statistics = _l.statistics,
    isLoading = _l.isLoading,
    error = _l.error,
    updateFilters = _l.updateFilters,
    clearFilters = _l.clearFilters,
    confirmAppointment = _l.confirmAppointment,
    cancelAppointment = _l.cancelAppointment,
    rescheduleAppointment = _l.rescheduleAppointment,
    markCompleted = _l.markCompleted,
    markNoShow = _l.markNoShow,
    refreshData = _l.refreshData;
    ...
    switch (filters.dateRange) {
      ...
      case "custom":
        if (filters.startDate && filters.endDate) {
          return ""
            .concat((0, date_fns_1.format)(filters.startDate, "dd/MM"), " - ")
            .concat((0, date_fns_1.format)(filters.endDate, "dd/MM"));
        }
  ...
  return (
    <div className={"space-y-6 ".concat(className)}>
      ...
      {/* Filters */}
      <appointment_filters_1.AppointmentFilters
        filters={filters}
      ...
      <tabs_1.Tabs value={selectedView} onValueChange={(value) => setSelectedView(value)}>
        ...
        <tabs_1.TabsContent value="calendar" className="space-y-4">
          <appointment_calendar_view_1.AppointmentCalendarView
            appointments={appointments}
      ...
      {/* Modals */}
      <modals_1.EditAppointmentDialog
      ...
      <modals_1.RescheduleAppointmentDialog
        appointment={selectedAppointment}
      ...
      <modals_1.ContactPatientDialog
        appointment={selectedAppointment}
        open={contactDialogOpen}
        onOpenChange={setContactDialogOpen}
      />

      <modals_1.CreateAppointmentDialog
