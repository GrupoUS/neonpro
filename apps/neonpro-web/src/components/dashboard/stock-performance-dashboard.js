...
function StockPerformanceDashboard(_a) {
  ...
  var _e = (0, react_1.useState)([]),
    alertsSummary = _e[0],
    setAlertsSummary = _e[1];
  var _f = (0, react_1.useState)([]),
    performanceData = _f[0],
    setPerformanceData = _f[1];
  ...
  var _j = (0, react_1.useState)({
    ...
    selectedDateRange = _j[0],
    setSelectedDateRange = _j[1];
  var _k = (0, react_1.useState)("30d"),
    selectedPeriod = _k[0],
    setSelectedPeriod = _k[1];
        ...
        switch (_c.label) {
          case 0:
            ...
            params = new URLSearchParams(
              __assign(
                __assign(
                  { clinicId: clinicId, period: selectedPeriod },
                  (selectedDateRange === null || selectedDateRange === void 0
                    ? void 0
    ...
    var statusColor =
      kpi.status === "good"
        ...
        : kpi.status === "warning"
          ...
          : COLORS.danger;
    return (
      <card_1.Card key={kpi.key} className="relative overflow-hidden">
      ...
      <tabs_1.Tabs defaultValue="trends" className="space-y-4">
        ...
        <tabs_1.TabsContent value="trends" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent>{renderPerformanceTrendsChart()}</card_1.CardContent>
          </card_1.Card>
        </tabs_1.TabsContent>
        ...
        <tabs_1.TabsContent value="products" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent>{renderTopProductsChart()}</card_1.CardContent>
          </card_1.Card>
        ...
        <tabs_1.TabsContent value="alerts" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <card_1.Card>
              ...
              <card_1.CardContent>{renderAlertsSummaryChart()}</card_1.CardContent>
            </card_1.Card>
