...
function RealTimeAvailability(_a) {
  ...
  var _b = (0, use_availability_manager_1.useAvailabilityManager)(),
    timeSlots = _b.timeSlots,
    groupedSlots = _b.groupedSlots,
    selectedSlot = _b.selectedSlot,
    isConnected = _b.isConnected,
    isLoading = _b.isLoading,
    error = _b.error,
    availability = _b.availability,
    updateFilters = _b.updateFilters,
        ...
        <card_1.CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <card_1.CardDescription>Carregando horários disponíveis...</card_1.CardDescription>
            </div>
                  ...
                  <div key={date}>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="font-medium">
                        {(0, date_fns_1.format)(new Date(date + "T00:00:00"), "EEEE, dd/MM/yyyy", {
                          locale: locale_1.pt,
                        })}
                      </h3>
                      ...
                      {slots.map((slot) => {
                        ...
                        return (
                          <button_1.Button
                            key={slot.id}
                            variant={
                              isSelected ? "default" : slot.is_available ? "outline" : "ghost"
                            }
                            size="sm"
                          ...
                          >
                            <span className="font-medium">
                              {(0, date_fns_1.format)(
                                new Date("2000-01-01T".concat(slot.start_time)),
                                "HH:mm",
                              )}
                            </span>
                            ...
                            {isSelected && (
                              <lucide_react_1.CheckCircle className="h-3 w-3 absolute -top-1 -right-1 text-primary" />
                            )}
                          </button_1.Button>
                        );
                      })}
          ...
          <div className="mt-6 p-4 bg-muted rounded-lg">
            ...
            <div className="w-full bg-background rounded-full h-2 mt-2">
              <div
                ...
                style={{ width: "".concat(availability.availabilityRate, "%") }}
              />
            </div>
          </div>
        )}
