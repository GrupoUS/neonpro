...
function BookingConflictPrevention(_a) {
    var _this = this;
    var selectedSlot = _a.selectedSlot, patientId = _a.patientId, onConflictResolved = _a.onConflictResolved;
    var _b = (0, react_1.useState)(false), isChecking = _b[0], setIsChecking = _b[1];
    var _c = (0, react_1.useState)(null), conflictDetector = _c[0], setConflictDetector = _c[1];
    var _d = (0, react_1.useState)(null), lastCheckedAt = _d[0], setLastCheckedAt = _d[1];
    var supabase = (0, client_1.createClient)();
    var toast = (0, use_toast_1.useToast)().toast;
    var checkIntervalRef = (0, react_1.useRef)(null);
    // Função para verificar conflitos
    var checkForConflicts = function (slot) { return __awaiter(_this, void 0, void 0, function () {
        var _a, currentSlot, slotError, _b, professionalSlots, profError, conflictingSlots, _c, patientAppointments, patientError, sameDayAppointments, error_1;
            ...
            switch (_d.label) {
                ...
                case 2:
                    ...
                    conflictingSlots = professionalSlots.filter(function (profSlot) {
                        ...
                        return ((slotStart < profEnd && slotEnd > profStart) ||
                ...
                case 3:
                    ...
                    sameDayAppointments = patientAppointments.filter(function (apt) { var _a; return ((_a = apt.time_slot) === null || _a === void 0 ? void 0 : _a.date) === slot.date; });
                    if (sameDayAppointments.length > 0) {
                        return [2 /*return*/, {
                                hasConflict: true,
                                conflictType: 'double_booking',
                                conflictingSlots: sameDayAppointments.map(function (apt) { return apt.time_slot; }),
    ...
    var runConflictCheck = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var resolveConflict = function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!(conflictDetector === null || conflictDetector === void 0 ? void 0 : conflictDetector.hasConflict))
                        return [2 /*return*/];
                    _a = conflictDetector.conflictType;
                    switch (_a) {
                        case 'double_booking': return [3 /*break*/, 1];
                        case 'time_overlap': return [3 /*break*/, 1];
                        case 'professional_unavailable': return [3 /*break*/, 2];
                    }
                    return [3 /*break*/, 4];
                case 1:
                    ...
                    onConflictResolved === null || onConflictResolved === void 0 ? void 0 : onConflictResolved();
                    return [3 /*break*/, 4];
                case 2: 
                // Atualizar dados
    ...
    return (<card_1.Card>
      <card_1.CardHeader>
        <div className="flex items-center justify-between">
          ...
          <button_1.Button size="sm" variant="outline" onClick={runConflictCheck} disabled={isChecking}>
            <lucide_react_1.RefreshCw className={"h-3 w-3 mr-1 ".concat(isChecking ? 'animate-spin' : '')}/>
            Verificar
          </button_1.Button>
        </div>
      </card_1.CardHeader>
      ...
      <card_1.CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <badge_1.Badge variant="outline">
              ...
              {(0, date_fns_1.format)(new Date(selectedSlot.date + 'T00:00:00'), 'dd/MM/yyyy', { locale: locale_1.pt })}
              {' às '}
              {(0, date_fns_1.format)(new Date("2000-01-01T".concat(selectedSlot.start_time)), 'HH:mm')}
            </badge_1.Badge>
          </div>
          
          {lastCheckedAt && (<div className="flex items-center justify-between text-xs text-muted-foreground">
        ...
        {conflictDetector && !isChecking && (<div className="space-y-3">
            ...
            {conflictDetector.conflictingSlots.length > 0 && (<div className="space-y-2">
                <p className="text-xs font-medium text-muted-foreground">
                  Horários conflitantes:
                </p>
                {conflictDetector.conflictingSlots.map(function (slot, index) { return (<div key={index} className="flex items-center justify-between text-xs p-2 bg-muted rounded">
            ...
            {/* Ações de resolução */}
            {conflictDetector.hasConflict && (<button_1.Button size="sm" variant="outline" onClick={resolveConflict} className="w-full">
                Resolver Conflito
              </button_1.Button>)}
          </div>)}
      </card_1.CardContent>
