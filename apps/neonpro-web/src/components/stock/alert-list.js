...
var AlertList = function (_a) {
    var configs = _a.configs, alerts = _a.alerts, onCreateNew = _a.onCreateNew, onEdit = _a.onEdit, onDelete = _a.onDelete, onToggleActive = _a.onToggleActive, onAcknowledge = _a.onAcknowledge, onRefresh = _a.onRefresh, _b = _a.loading, loading = _b === void 0 ? false : _b;
    var _c = (0, react_1.useState)(null), actionError = _c[0], setActionError = _c[1];
    var _d = (0, react_1.useState)(null), actionLoading = _d[0], setActionLoading = _d[1];
    // =====================================================
    // ACTION HANDLERS
    // =====================================================
    var handleToggleActive = function (configId, isActive) { return __awaiter(void 0, void 0, void 0, function () {
        var error_1;
    ...
    var handleDelete = function (configId) { return __awaiter(void 0, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleAcknowledge = function (alertId) { return __awaiter(void 0, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    // COMPUTED VALUES
    // =====================================================
    var activeAlerts = alerts.filter(function (alert) { return !alert.acknowledgedAt; });
    var criticalAlerts = activeAlerts.filter(function (alert) { return alert.severityLevel === 'critical'; });
    // =====================================================
    // RENDER
    // =====================================================
    return (<div className="space-y-6">
      ...
      {/* Error Alert */}
      {actionError && (<alert_1.Alert variant="destructive">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {configs.filter(function (c) { return c.isActive; }).length} ativas
            </p>
          </card_1.CardContent>
        </card_1.Card>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="text-2xl font-bold">
              {alerts.length > 0
            ? Math.round((alerts.filter(function (a) { return a.acknowledgedAt; }).length / alerts.length) * 100)
            : 0}%
            </div>
            <p className="text-xs text-muted-foreground">
              alertas confirmados
      ...
      {activeAlerts.length > 0 && (<card_1.Card>
          ...
          <card_1.CardContent>
            <div className="space-y-3">
              {activeAlerts.map(function (alert) { return (<div key={alert.id} className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button_1.Button size="sm" variant="outline" onClick={function () { return handleAcknowledge(alert.id); }} disabled={actionLoading === alert.id}>
                      Confirmar
                    </button_1.Button>
                  </div>
                </div>); })}
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          {configs.length === 0 ? (<div className="text-center py-8">
              ...
              {configs.map(function (config) { return (<div key={config.id} className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <switch_1.Switch checked={config.isActive} onCheckedChange={function (checked) { return handleToggleActive(config.id, checked); }} disabled={actionLoading === config.id}/>
                    </div>
                    <dropdown_menu_1.DropdownMenu>
                      ...
                      <dropdown_menu_1.DropdownMenuContent align="end">
                        <dropdown_menu_1.DropdownMenuItem onClick={function () { return onEdit(config); }}>
                          <lucide_react_1.Edit className="h-4 w-4 mr-2"/>
                          Editar
                        </dropdown_menu_1.DropdownMenuItem>
                        <dropdown_menu_1.DropdownMenuItem onClick={function () { return handleDelete(config.id); }} className="text-red-600">
