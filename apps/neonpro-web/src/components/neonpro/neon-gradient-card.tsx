...
export const NeonGradientCard = React.forwardRef<HTMLDivElement, NeonGradientCardProps>(
  (
    ...
    return (
      <Card ref={ref} className={cardClassName} onClick={onClick} {...props}>
        ...
        <div className="relative z-10">
          {(title || description) && (
            <CardHeader className="pb-4">
              {title && (
                <CardTitle
                  className={cn("text-xl font-bold transition-colors duration-200", {
          ...
          <CardContent className={cn("relative", !title && !description && "pt-6")}>
            {loading ? (
