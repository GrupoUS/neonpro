...
function BookingConfirmation(_a) {
  ...
  var service = _a.service,
    ...
    notes = _a.notes,
    specialRequests = _a.specialRequests,
  ...
  var _d = (0, react_1.useState)(""),
    confirmationError = _d[0],
    setConfirmationError = _d[1];
  var _e = (0, react_1.useState)(false),
    agreedToTerms = _e[0],
    setAgreedToTerms = _e[1];
  var _f = (0, react_1.useState)({
    ...
    notificationPrefs = _f[0],
    setNotificationPrefs = _f[1];
            ...
            <div className="flex-1">
              ...
              {professional && professional.specialties.length > 0 && (
                <div className="flex flex-wrap gap-1 mt-1">
                  {professional.specialties.slice(0, 2).map(function (specialty) {
                    return (
                      <badge_1.Badge key={specialty} variant="secondary" className="text-xs">
                        {specialty}
                      </badge_1.Badge>
                    );
                  })}
                ...
                <div className="flex-1">
                  ...
                  {specialRequests.length > 0 && (
                    <div className="space-y-1 mb-3">
                      {specialRequests.map(function (request, index) {
                        return (
              ...
              <div className="space-y-2 ml-6">
                <div className="flex items-center space-x-3">
                  <checkbox_1.Checkbox
                    ...
                    onCheckedChange={function (checked) {
                      return handleNotificationChange("emailConfirmation", checked);
                    }}
                  />
                  <label_1.Label
                ...
                <div className="flex items-center space-x-3">
                  <checkbox_1.Checkbox
                    ...
                    onCheckedChange={function (checked) {
                      return handleNotificationChange("smsConfirmation", checked);
                    }}
                  />
                  <label_1.Label
              ...
              <div className="space-y-2 ml-6">
                <div className="flex items-center space-x-3">
                  <checkbox_1.Checkbox
                    ...
                    onCheckedChange={function (checked) {
                      return handleNotificationChange("emailReminder", checked);
                    }}
                  />
                  <label_1.Label
                ...
                <div className="flex items-center space-x-3">
                  <checkbox_1.Checkbox
                    ...
                    onCheckedChange={function (checked) {
                      return handleNotificationChange("smsReminder", checked);
                    }}
                  />
        ...
        <card_1.CardContent className="p-4">
          <div className="flex items-start space-x-3">
            <checkbox_1.Checkbox
              ...
              onCheckedChange={function (checked) {
                return setAgreedToTerms(checked);
              }}
              className="mt-1"
            />
            <label_1.Label
