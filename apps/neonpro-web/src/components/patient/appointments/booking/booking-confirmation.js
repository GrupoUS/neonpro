...
function BookingConfirmation(_a) {
  ...
  var handleNotificationChange = (key, value) => {
              ...
              <div className="space-y-2 ml-6">
                <div className="flex items-center space-x-3">
                  <checkbox_1.Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("emailConfirmation", checked)
                    }
                  />
                  <label_1.Label
                ...
                <div className="flex items-center space-x-3">
                  <checkbox_1.Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("smsConfirmation", checked)
                    }
                  />
                  <label_1.Label
              ...
              <div className="space-y-2 ml-6">
                <div className="flex items-center space-x-3">
                  <checkbox_1.Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationChange("emailReminder", checked)
                    }
                  />
                  <label_1.Label
                ...
                <div className="flex items-center space-x-3">
                  <checkbox_1.Checkbox
                    ...
                    onCheckedChange={(checked) => handleNotificationChange("smsReminder", checked)}
                  />
