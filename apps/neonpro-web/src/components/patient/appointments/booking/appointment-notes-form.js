...
function AppointmentNotesForm(_a) {
  var notes = _a.notes,
    ...
    onSpecialRequestsChange = _a.onSpecialRequestsChange,
    _b = _a.className,
    className = _b === void 0 ? "" : _b;
  var _c = (0, react_1.useState)(specialRequests),
              ...
              return (
                <div key={note.id} className="flex items-center space-x-3">
                  ...
                  >
                    ...
                    {isSelected && (
                      <badge_1.Badge variant="secondary" className={note.color}>
                        Selecionado
                      </badge_1.Badge>
                    )}
                  </label_1.Label>
                  ...
                  {selectedSuggestions.map(function (suggestionId) {
                    ...
                    return (
                      <badge_1.Badge
                        key={suggestionId}
                        variant="secondary"
                        className={"".concat(suggestion.color, " flex items-center gap-1")}
                      >
