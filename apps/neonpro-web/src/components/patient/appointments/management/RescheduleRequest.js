...
function RescheduleRequest(_a) {
  ...
  var _c = (0, react_1.useState)(""),
    selectedTime = _c[0],
    setSelectedTime = _c[1];
  var _d = (0, react_1.useState)(""),
    selectedReason = _d[0],
    setSelectedReason = _d[1];
  var _e = (0, react_1.useState)(""),
    customReason = _e[0],
    setCustomReason = _e[1];
  var _f = (0, react_1.useState)(false),
    isSubmitting = _f[0],
    setIsSubmitting = _f[1];
  var _g = (0, react_1.useState)([]),
    availableSlots = _g[0],
    setAvailableSlots = _g[1];
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              onConfirm(appointmentId, formattedDate, selectedTime, finalReason),
              // Reset form
            ];
          case 2:
            _a.sent();
            ...
            ? <alert_1.Alert variant="destructive">
                ...
                <alert_1.AlertDescription>
                  ...
                  <div className="text-sm mt-1">
                    Solicitações de reagendamento devem ser feitas com pelo menos 48h de
                    antecedência. Restam apenas {hoursUntil}h para seu agendamento.
                  </div>
                </alert_1.AlertDescription>
              </alert_1.Alert>
                  ...
                  <popover_1.Popover>
                    <popover_1.PopoverTrigger asChild>
                      ...
                      >
                        ...
                        {selectedDate
                          ? (0, date_fns_1.format)(selectedDate, "PPP", { locale: locale_1.ptBR })
                          : "Selecione uma data"}
                      </button_1.Button>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <select_1.SelectContent>
                      {loadingSlots
                        ? <select_1.SelectItem value="loading" disabled>
                            Carregando horários...
                          </select_1.SelectItem>
                        : availableSlots.length === 0
                          ? <select_1.SelectItem value="none" disabled>
                              {selectedDate
