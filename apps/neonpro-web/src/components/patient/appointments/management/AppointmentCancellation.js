...
function AppointmentCancellation(_a) {
  ...
  var isEmergencyReason =
    (selectedReasonData === null || selectedReasonData === void 0
      ? void 0
      : selectedReasonData.emergency) || false;
  // Calculate fees
  var feeApplies =
    (cancellationPolicies === null || cancellationPolicies === void 0
      ? void 0
      ...
      return __generator(this, (_a) => {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              onConfirm(appointmentId, finalReason),
              // Reset form
            ];
          case 2:
            _a.sent();
  ...
  var _e = formatAppointmentDateTime(appointment.appointment_date, appointment.appointment_time),
    date = _e.date,
    time = _e.time;
  return (
      ...
      <dialog_1.DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-6">
          ...
          {!canCancel
            ...
            : <alert_1.Alert className="border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950">
