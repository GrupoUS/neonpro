...
import { format, startOfDay, endOfDay, isAfter, isBefore, addMinutes } from 'date-fns'
import { pt } from 'date-fns/locale'
import { useRealtimeAvailability, TimeSlot } from '@/hooks/use-realtime-availability'
...
export function useAvailabilityManager() {
  ...
  const bookSelectedSlot = useCallback(async (patientId: string) => {
