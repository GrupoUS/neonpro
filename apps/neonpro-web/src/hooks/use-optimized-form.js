...
function useOptimizedForm(options) {
    var _this = this;
    var initialValues = options.initialValues, validationSchema = options.validationSchema, _a = options.validationMode, validationMode = _a === void 0 ? 'onBlur' : _a, _b = options.validateOnMount, validateOnMount = _b === void 0 ? false : _b, _c = options.enableReinitialize, enableReinitialize = _c === void 0 ? false : _c, onSubmit = options.onSubmit, onValidationError = options.onValidationError, _d = options.debounceMs, debounceMs = _d === void 0 ? 300 : _d;
    // =====================================================================================
    // STATE MANAGEMENT
    // =====================================================================================
    var _e = (0, react_1.useState)(function () { return ({
    ...
    (0, react_1.useEffect)(function () {
        if (enableReinitialize && initialValues !== initialValuesRef.current) {
            ...
            setState(function (prev) { return (__assign(__assign({}, prev), { values: __assign({}, initialValues), errors: {}, touched: {}, isDirty: false })); });
        }
    ...
    // =====================================================================================
    var validateField = (0, react_1.useCallback)(function (field) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    fieldSchema = (_a = validationSchema.shape) === null || _a === void 0 ? void 0 : _a[field];
                    if (!fieldSchema)
                        return [2 /*return*/, undefined];
                ...
                case 3:
                    ...
                    if (error_1 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, ((_b = error_1.errors[0]) === null || _b === void 0 ? void 0 : _b.message) || 'Validation error'];
                    }
    ...
    var debouncedValidation = (0, react_1.useCallback)(function (field) {
        if (validationTimeoutRef.current) {
            clearTimeout(validationTimeoutRef.current);
        }
        validationTimeoutRef.current = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    case 2:
                        ...
                        if (mountedRef.current) {
                            setState(function (prev) {
                                var _a;
                                return (__assign(__assign({}, prev), { errors: __assign(__assign({}, prev.errors), (_a = {}, _a[field] = error_4, _a)), isValidating: false }));
                            });
                        }
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, validateForm()];
                    case 4:
                        errors_2 = _a.sent();
                        if (mountedRef.current) {
                            setState(function (prev) { return (__assign(__assign({}, prev), { errors: errors_2, isValid: Object.keys(errors_2).length === 0, isValidating: false })); });
                            if (Object.keys(errors_2).length > 0) {
                                onValidationError === null || onValidationError === void 0 ? void 0 : onValidationError(errors_2);
                            }
                        }
                        _a.label = 5;
    ...
    // FORM HELPERS
    // =====================================================================================
    var setFieldValue = (0, react_1.useCallback)(function (field, value) {
        setState(function (prev) {
            var _a;
    ...
    var setFieldError = (0, react_1.useCallback)(function (field, error) {
        setState(function (prev) {
            var _a;
            return (__assign(__assign({}, prev), { errors: __assign(__assign({}, prev.errors), (_a = {}, _a[field] = error, _a)) }));
        });
    }, []);
    var setFieldTouched = (0, react_1.useCallback)(function (field, touched) {
        setState(function (prev) {
            var _a;
            return (__assign(__assign({}, prev), { touched: __assign(__assign({}, prev.touched), (_a = {}, _a[field] = touched, _a)) }));
        });
    ...
    var setValues = (0, react_1.useCallback)(function (values) {
        setState(function (prev) {
    ...
    var setErrors = (0, react_1.useCallback)(function (errors) {
        setState(function (prev) { return (__assign(__assign({}, prev), { errors: __assign(__assign({}, prev.errors), errors) })); });
    }, []);
    var setTouched = (0, react_1.useCallback)(function (touched) {
        setState(function (prev) { return (__assign(__assign({}, prev), { touched: __assign(__assign({}, prev.touched), touched) })); });
    }, []);
    var resetForm = (0, react_1.useCallback)(function (newValues) {
        var resetValues = newValues ? __assign(__assign({}, initialValues), newValues) : initialValues;
        setState({
            values: resetValues,
            errors: {},
            touched: {},
    ...
    var setSubmitting = (0, react_1.useCallback)(function (isSubmitting) {
        setState(function (prev) { return (__assign(__assign({}, prev), { isSubmitting: isSubmitting })); });
    }, []);
    // =====================================================================================
    // FIELD HELPERS
    // =====================================================================================
    var getFieldProps = (0, react_1.useCallback)(function (field) {
        return {
    ...
    var getFieldHelpers = (0, react_1.useCallback)(function (field) {
        return {
            onChange: function (value) { return setFieldValue(field, value); },
            onBlur: function () { return setFieldTouched(field, true); },
            onFocus: function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setState(function (prev) { return (__assign(__assign({}, prev), { isSubmitting: true, submitCount: prev.submitCount + 1 })); });
                    _a.label = 1;
                case 1:
                ...
                case 2:
                    ...
                    if (Object.keys(errors_3).length > 0) {
                        setState(function (prev) { return (__assign(__assign({}, prev), { errors: errors_3, isValid: false, isSubmitting: false })); });
                        onValidationError === null || onValidationError === void 0 ? void 0 : onValidationError(errors_3);
                        return [2 /*return*/];
                    }
                    ...
                    setState(function (prev) { return (__assign(__assign({}, prev), { touched: allTouched_1, errors: {}, isValid: true })); });
                ...
                case 6:
                    if (mountedRef.current) {
                        setState(function (prev) { return (__assign(__assign({}, prev), { isSubmitting: false })); });
                    }
                    return [7 /*endfinally*/];
                case 7: return [2 /*return*/];
            }
