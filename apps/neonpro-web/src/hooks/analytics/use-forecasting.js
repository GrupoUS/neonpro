...
function useForecasting(initialConfig) {
    ...
    var _c = (0, react_1.useState)(initialConfig), config = _c[0], setConfig = _c[1];
    var _d = (0, react_1.useState)({}), scenarios = _d[0], setScenarios = _d[1];
    var _e = (0, react_1.useState)(null), error = _e[0], setError = _e[1];
    // Initialize forecasting engine
    var forecastingEngine = (0, react_1.useMemo)(function () { return (0, forecasting_engine_1.createForecastingEngine)(); }, []);
    ...
    var _f = (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            var forecastConfig, forecast, evaluation, sensitivityAnalysis, chartData, confidenceIntervals, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, forecastingEngine.evaluateModel(forecast, forecastConfig)
                            // Generate sensitivity analysis
                        ];
                    case 2:
                        evaluation = _a.sent();
                        return [4 /*yield*/, forecastingEngine.performSensitivityAnalysis(forecastConfig, ['growth_rate', 'seasonal_factor', 'trend_strength'])
                            // Format data for visualization
                        ];
                    case 3:
                        sensitivityAnalysis = _a.sent();
                        chartData = forecasting_engine_1.forecastingUtils.formatForChart(forecast, config.granularity);
                        confidenceIntervals = forecasting_engine_1.forecastingUtils.calculateConfidenceIntervals(forecast.predictions, config.confidenceLevel);
                        return [2 /*return*/, {
                                forecast: forecast,
    ...
    }), forecastData = _f.data, isLoading = _f.isLoading, refreshData = _f.refetch;
    // Auto-refresh effect
    ...
    var generateForecastMutation = (0, react_query_1.useMutation)({
        mutationFn: function (newConfig) { return __awaiter(_this, void 0, void 0, function () {
            var forecast, evaluation;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, forecastingEngine.generateForecast(newConfig)];
                    case 1:
                        forecast = _a.sent();
    ...
    var runScenarioMutation = (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            var scenarioResult;
            var name = _b.name, scenarioConfig = _b.scenarioConfig;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(forecastData === null || forecastData === void 0 ? void 0 : forecastData.forecast)) {
                            throw new Error('Base forecast required for scenario analysis');
                        }
                        return [4 /*yield*/, forecastingEngine.runScenarioAnalysis(forecastData.forecast, scenarioConfig)];
                    case 1:
        ...
        onSuccess: function (_a) {
            var name = _a.name, result = _a.result;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        a.href = url;
                        a.download = "forecast-".concat(config.metric, "-").concat(new Date().toISOString().split('T')[0], ".").concat(format);
    ...
    // Actions
    var generateForecast = (0, react_1.useCallback)(function (newConfig) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, generateForecastMutation.mutateAsync(newConfig)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var runScenario = (0, react_1.useCallback)(function (name, scenarioConfig) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, runScenarioMutation.mutateAsync({ name: name, scenarioConfig: scenarioConfig })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var updateModel = (0, react_1.useCallback)(function (modelType) { return __awaiter(_this, void 0, void 0, function () {
        var newConfig;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var exportForecast = (0, react_1.useCallback)(function (format) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exportForecastMutation.mutateAsync(format)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return {
        // State
        forecast: (forecastData === null || forecastData === void 0 ? void 0 : forecastData.forecast) || null,
        scenarios: scenarios,
        evaluation: (forecastData === null || forecastData === void 0 ? void 0 : forecastData.evaluation) || null,
        predictions: (forecastData === null || forecastData === void 0 ? void 0 : forecastData.predictions) || [],
        chartData: (forecastData === null || forecastData === void 0 ? void 0 : forecastData.chartData) || [],
        confidence: (forecastData === null || forecastData === void 0 ? void 0 : forecastData.confidenceIntervals) || { upper: [], lower: [], mean: [] },
        accuracy: (forecastData === null || forecastData === void 0 ? void 0 : forecastData.accuracy) || { mape: 0, rmse: 0, r2: 0 },
        isLoading: isLoading || generateForecastMutation.isPending || runScenarioMutation.isPending,
        error: error || ((_a = generateForecastMutation.error) === null || _a === void 0 ? void 0 : _a.message) || ((_b = runScenarioMutation.error) === null || _b === void 0 ? void 0 : _b.message) || null,
...
function useForecastComparison(forecasts) {
    ...
    return (0, react_query_1.useQuery)({
        queryKey: ['forecast-comparison', forecasts.map(function (f) { return f.config.metric; })],
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/analytics/advanced?type=forecasting', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                action: 'compare',
...
function useRealTimeForecastUpdates(metric, enabled) {
    ...
    var _a = (0, react_1.useState)([]), updates = _a[0], setUpdates = _a[1];
    var supabase = yield (0, client_1.createClient)();
    (0, react_1.useEffect)(function () {
        if (!enabled || !metric)
            return;
        ...
        var subscription = supabase
            ...
            setUpdates(function (prev) { return __spreadArray(__spreadArray([], prev, true), [{
                    timestamp: new Date(),
...
function useForecastAccuracy(metric, timeWindow) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/analytics/accuracy', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                metric: metric,
...
function useForecastFormatters() {
    return (0, react_1.useMemo)(function () { return ({
        ...
        formatTimeHorizon: function (days) {
            ...
            if (days < 30)
                return "".concat(Math.round(days / 7), " week").concat(Math.round(days / 7) > 1 ? 's' : '');
            if (days < 365)
                return "".concat(Math.round(days / 30), " month").concat(Math.round(days / 30) > 1 ? 's' : '');
            return "".concat(Math.round(days / 365), " year").concat(Math.round(days / 365) > 1 ? 's' : '');
        }
    }); }, []);
}
