...
function useKPIData(options) {
    ...
    var dateRange = options.dateRange, _b = options.autoRefresh, autoRefresh = _b === void 0 ? true : _b, _c = options.refreshInterval, refreshInterval = _c === void 0 ? 30000 : _c, filters = options.filters;
    ...
    var fetchKPIData = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    setState(function (prev) { return (__assign(__assign({}, prev), { loading: false, error: error_1 instanceof Error ? error_1.message : 'Erro ao carregar dados KPI' })); });
                    return [3 /*break*/, 5];
...
function useDrillDownData() {
    ...
    var getDrillDownData = (0, react_1.useCallback)(function (request) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    setError(error_2 instanceof Error ? error_2.message : 'Erro ao carregar análise detalhada');
                    setLoading(false);
...
function useProfessionalMetrics(dateRange) {
    ...
    var fetchProfessionalMetrics = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    timePeriod = calculateDateRange(dateRange);
                    return [4 /*yield*/, fetch('/api/analytics/professional-metrics', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
                ...
                case 4:
                    ...
                    setError(error_3 instanceof Error ? error_3.message : 'Erro ao carregar métricas profissionais');
                    setLoading(false);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
