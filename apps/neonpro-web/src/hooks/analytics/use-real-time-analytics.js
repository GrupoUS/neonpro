...
function useRealTimeAnalytics(initialConfig) {
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch('/api/analytics/real-time', {
                                method: 'POST',
    ...
    }), initialData = _g.data, refreshMetrics = _g.refetch;
    // Check for alerts based on thresholds
    var checkAlerts = (0, react_1.useCallback)(function (newMetrics) {
        ...
        if (config.alertThresholds.churnRate && newMetrics.churnRate > config.alertThresholds.churnRate) {
            newAlerts.push({
                ...
                type: 'critical',
                message: "Churn rate (".concat(newMetrics.churnRate.toFixed(2), "%) exceeds threshold (").concat(config.alertThresholds.churnRate, "%)"),
                timestamp: new Date(),
                metric: 'churn'
            });
        }
        ...
        if (config.alertThresholds.revenueGrowth && metrics.monthlyRecurringRevenue > 0) {
            var growth = ((newMetrics.monthlyRecurringRevenue - metrics.monthlyRecurringRevenue) / metrics.monthlyRecurringRevenue) * 100;
            if (growth < config.alertThresholds.revenueGrowth) {
                newAlerts.push({
                    id: "revenue-".concat(Date.now()),
                    type: 'warning',
                    message: "Revenue growth (".concat(growth.toFixed(2), "%) below threshold (").concat(config.alertThresholds.revenueGrowth, "%)"),
                    timestamp: new Date(),
                    metric: 'revenue'
                });
            }
        ...
        if (newAlerts.length > 0) {
            setAlerts(function (prev) { return __spreadArray(__spreadArray([], prev, true), newAlerts, true); });
        }
    }, [config, metrics]);
        ...
        try {
                ...
                subscriptionsRef.current.subscriptions = supabase
                    ...
                    setMetrics(function (prev) {
                        ...
                        if (payload.eventType === 'INSERT') {
                            ...
                            if ((old === null || old === void 0 ? void 0 : old.status) !== (newSub === null || newSub === void 0 ? void 0 : newSub.status)) {
                                if ((newSub === null || newSub === void 0 ? void 0 : newSub.status) === 'active' && (old === null || old === void 0 ? void 0 : old.status) !== 'active') {
                                    updated.activeSubscriptions += 1;
                                    if ((old === null || old === void 0 ? void 0 : old.status) === 'trialing') {
                                        updated.trialConversions += 1;
                                    }
                                }
                                else if ((old === null || old === void 0 ? void 0 : old.status) === 'active' && (newSub === null || newSub === void 0 ? void 0 : newSub.status) !== 'active') {
                                    updated.activeSubscriptions -= 1;
                                }
                            }
                        }
            ...
            if (config.metrics.includes('trials')) {
                subscriptionsRef.current.trials = supabase
                    ...
                    var _a;
                    if (payload.eventType === 'UPDATE' && ((_a = payload.new) === null || _a === void 0 ? void 0 : _a.converted_at)) {
                        setMetrics(function (prev) { return (__assign(__assign({}, prev), { trialConversions: prev.trialConversions + 1, lastUpdated: new Date() })); });
                    }
                })
                    .subscribe();
            }
    ...
    return {
        ...
        refreshMetrics: function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, refreshMetrics()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
function usePerformanceMonitoring() {
    ...
    var _a = (0, react_1.useState)({
        ...
        throughput: 0,
        uptime: 100
    }), performance = _a[0], setPerformance = _a[1];
    (0, react_1.useEffect)(function () {
        var checkPerformance = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        setPerformance(function (prev) { return (__assign(__assign({}, prev), { errorRate: prev.errorRate + 1 })); });
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
...
function useUserActivityMonitoring() {
    var _a = (0, react_1.useState)({
        ...
        bounceRate: 0
    }), activity = _a[0], setActivity = _a[1];
    var supabase = yield (0, client_1.createClient)();
    (0, react_1.useEffect)(function () {
        ...
        var subscription = supabase
            ...
            setActivity(function (prev) {
                ...
                else if (payload.eventType === 'UPDATE' && ((_a = payload.new) === null || _a === void 0 ? void 0 : _a.ended_at)) {
                    updated.activeUsers -= 1;
                    // Calculate session duration
                    var duration = new Date(payload.new.ended_at).getTime() -
