...
function useStatisticalInsights(initialConfig) {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                fetch("/api/analytics/statistical-analysis", {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
      ...
      queryClient.setQueryData(queryKey, (old) =>
        __assign(__assign({}, old), {
          anomalies: __spreadArray(
            __spreadArray(
              [],
              (old === null || old === void 0 ? void 0 : old.anomalies) || [],
              true,
            ),
            data.anomalies,
            true,
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                fetch("/api/analytics/correlation-analysis", {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  body: JSON.stringify({
                    metrics: metrics,
      ...
      queryClient.setQueryData(queryKey, (old) =>
        __assign(__assign({}, old), {
          predictions: __spreadArray(
            __spreadArray(
              [],
              (old === null || old === void 0 ? void 0 : old.predictions) || [],
              true,
            ),
            [data.prediction],
            false,
          ...
          recommendations: __spreadArray(
            __spreadArray(
              [],
              (old === null || old === void 0 ? void 0 : old.recommendations) || [],
              true,
            ),
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 2:
              ...
              a.href = url;
              a.download = "statistical-insights-"
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                anomalyDetectionMutation.mutateAsync({ metric: metric, threshold: threshold }),
              ];
            case 1:
              _a.sent();
              return [2 /*return*/];
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                predictionMutation.mutateAsync({ metric: metric, timeframe: timeframe }),
              ];
            case 1:
              _a.sent();
              return [2 /*return*/];
  ...
  return {
    // State
    correlations:
      (insightsData === null || insightsData === void 0 ? void 0 : insightsData.correlations) || [],
    anomalies:
      (insightsData === null || insightsData === void 0 ? void 0 : insightsData.anomalies) || [],
    predictions:
      (insightsData === null || insightsData === void 0 ? void 0 : insightsData.predictions) || [],
    comparisons:
      (insightsData === null || insightsData === void 0 ? void 0 : insightsData.comparisons) || [],
    significance:
      (insightsData === null || insightsData === void 0 ? void 0 : insightsData.significance) || [],
    insights:
      (insightsData === null || insightsData === void 0 ? void 0 : insightsData.insights) || [],
    recommendations:
      (insightsData === null || insightsData === void 0 ? void 0 : insightsData.recommendations) ||
      [],
    isLoading: isLoading || runAnalysisMutation.isPending,
    error:
      error ||
      ((_a = runAnalysisMutation.error) === null || _a === void 0 ? void 0 : _a.message) ||
      null,
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                fetch("/api/analytics/ab-test-analysis", {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                fetch("/api/analytics/benchmarking", {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  body: JSON.stringify({
                    metrics: metrics,
