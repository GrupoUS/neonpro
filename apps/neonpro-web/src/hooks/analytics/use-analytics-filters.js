...
function useAnalyticsFilters(initialFilters) {
  ...
  var _a = (0, react_1.useState)(__assign(__assign({}, DEFAULT_FILTERS), initialFilters)),
    filters = _a[0],
    setFilters = _a[1];
  var _b = (0, react_1.useState)(null),
    appliedFilters = _b[0],
    setAppliedFilters = _b[1];
  ...
  var saveFilterSet = (0, react_1.useCallback)(
    function (name) {
      ...
      var newFilterSets = __assign(
        ...
        ((_a = {}), (_a[name] = __assign({}, filters)), _a),
      );
