...
function useAnalyticsDashboard(initialConfig) {
  ...
  var _c = (0, react_1.useState)([]),
    dashboardAlerts = _c[0],
    setDashboardAlerts = _c[1];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                cohortAnalysis.generateAnalysis({
            ...
            case 2:
              ...
              return [
                ...
                forecasting.generateForecast({
                  ...
                  model:
                    config.forecasting.model === "auto" ? "seasonal" : config.forecasting.model,
            ...
            case 3:
              ...
              return [
                4 /*yield*/,
                statisticalInsights.runAnalysis({
                  metrics: config.filters.metrics,
                  timeRange: ""
                    .concat(config.filters.dateRange.start, ":")
                    .concat(config.filters.dateRange.end),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                fetch("/api/analytics/export-dashboard", {
                  method: "POST",
            ...
            case 2:
              ...
              a.href = url;
              a.download = "analytics-dashboard-"
