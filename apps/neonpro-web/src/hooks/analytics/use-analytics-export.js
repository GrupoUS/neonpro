...
function useAnalyticsExport() {
    ...
    var _c = (0, react_1.useState)(null), lastExport = _c[0], setLastExport = _c[1];
    // Single export mutation
    var exportMutation = (0, react_query_1.useMutation)({
        mutationFn: function (config) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        filename = ((_a = config.options) === null || _a === void 0 ? void 0 : _a.filename) || "".concat(config.type, "-export.json");
                        return [3 /*break*/, 5];
                    ...
                    case 4:
                        ...
                        filename = contentDisposition
                            ? (_b = contentDisposition.split('filename=')[1]) === null || _b === void 0 ? void 0 : _b.replace(/"/g, '')
                            : ((_c = config.options) === null || _c === void 0 ? void 0 : _c.filename) || "".concat(config.type, "-export.").concat(config.format);
                        _d.label = 5;
                    case 5:
                        setProgress(100);
    ...
    var multipleExportMutation = (0, react_query_1.useMutation)({
        mutationFn: function (configs) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        blob = _b.sent();
                        filename = ((_a = config.options) === null || _a === void 0 ? void 0 : _a.filename) || "".concat(config.type, "-export-").concat(i + 1, ".").concat(config.format);
                    ...
                    case 7:
                        ...
                        failedCount = results.filter(function (r) { return r.error; }).length;
                        if (failedCount > 0) {
                            throw new Error("".concat(failedCount, " of ").concat(totalConfigs, " exports failed"));
                        }
                        setProgress(100);
                        setLastExport(new Date());
                        setTimeout(function () { return setProgress(0); }, 1000);
                        return [2 /*return*/];
                }
            });
        }); },
    ...
    var reportMutation = (0, react_query_1.useMutation)({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            ...
            var type = _b.type, data = _b.data;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        setProgress(0);
                        setError(null);
                        return [4 /*yield*/, fetch('/api/analytics/generate-report', {
                                method: 'POST',
                                headers: { 'Content-Type': 'application/json' },
                                body: JSON.stringify({
                                    reportType: type,
                    ...
                    case 2:
                        blob = _c.sent();
                        filename = "".concat(type, "-analytics-report-").concat(new Date().toISOString().split('T')[0], ".pdf");
                        setProgress(100);
                        url = window.URL.createObjectURL(blob);
                        a = document.createElement('a');
                        a.href = url;
    ...
    // Actions
    var exportData = (0, react_1.useCallback)(function (config) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exportMutation.mutateAsync(config)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var exportMultiple = (0, react_1.useCallback)(function (configs) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, multipleExportMutation.mutateAsync(configs)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var generateReport = (0, react_1.useCallback)(function (type, data) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, reportMutation.mutateAsync({ type: type, data: data })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function useExportTemplates() {
    var _a = useAnalyticsExport(), exportData = _a.exportData, generateReport = _a.generateReport;
    return {
        // Cohort analysis templates
        exportCohortCSV: (0, react_1.useCallback)(function (data) {
            return exportData({
                type: 'cohort',
                format: 'csv',
                data: data,
        ...
        exportCohortExcel: (0, react_1.useCallback)(function (data) {
            return exportData({
                type: 'cohort',
                format: 'excel',
                data: data,
        ...
        exportForecastPDF: (0, react_1.useCallback)(function (data) {
            return exportData({
                type: 'forecast',
                format: 'pdf',
                data: data,
        ...
        // Dashboard templates
        exportExecutiveDashboard: (0, react_1.useCallback)(function (data) {
            return generateReport('executive', data);
        }, [generateReport]),
        exportTechnicalDashboard: (0, react_1.useCallback)(function (data) {
            return generateReport('technical', data);
        }, [generateReport]),
        // Insights templates
        exportInsightsJSON: (0, react_1.useCallback)(function (data) {
            return exportData({
                type: 'insights',
                format: 'json',
                data: data,
                options: {
                    filename: "statistical-insights-".concat(new Date().toISOString().split('T')[0], ".json"),
                    includeMetadata: true
                }
            });
        }, [exportData])
