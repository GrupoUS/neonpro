...
function useCohortAnalysis(initialConfig) {
    ...
    var cohortAnalyzer = (0, react_1.useMemo)(function () { return (0, cohort_analyzer_1.createCohortAnalyzer)(); }, []);
    ...
    var _d = (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            var analysisConfig, cohorts, metrics, revenueCohorts, statistics, heatmapData, comparisonData, cohortSizes, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, cohortAnalyzer.calculateCohortRetention(cohorts, analysisConfig)
                            // Calculate revenue cohorts
                        ];
                    case 2:
                        metrics = _a.sent();
                        return [4 /*yield*/, cohortAnalyzer.calculateRevenueCohorts(cohorts, analysisConfig)
    ...
    }), analysisData = _d.data, isLoading = _d.isLoading, refreshData = _d.refetch;
    // Auto-refresh effect
    ...
    var generateAnalysisMutation = (0, react_query_1.useMutation)({
        mutationFn: function (newConfig) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cohortAnalyzer.generateCohorts(newConfig)];
                    case 1:
                        cohorts = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        a.href = url;
                        a.download = "cohort-analysis-".concat(new Date().toISOString().split('T')[0], ".").concat(format);
    ...
    // Actions
    var generateAnalysis = (0, react_1.useCallback)(function (newConfig) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, generateAnalysisMutation.mutateAsync(newConfig)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var exportData = (0, react_1.useCallback)(function (format) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exportDataMutation.mutateAsync(format)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return {
        // State
        cohorts: (analysisData === null || analysisData === void 0 ? void 0 : analysisData.cohorts) || [],
        metrics: (analysisData === null || analysisData === void 0 ? void 0 : analysisData.metrics) || [],
        heatmapData: (analysisData === null || analysisData === void 0 ? void 0 : analysisData.heatmapData) || [],
        statistics: (analysisData === null || analysisData === void 0 ? void 0 : analysisData.statistics) || null,
        insights: (analysisData === null || analysisData === void 0 ? void 0 : analysisData.insights) || [],
        isLoading: isLoading || generateAnalysisMutation.isPending,
        error: error || ((_a = generateAnalysisMutation.error) === null || _a === void 0 ? void 0 : _a.message) || null,
...
function useCohortComparison(cohortIds) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/analytics/advanced?type=cohort-analysis', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                action: 'compare',
    ...
    (0, react_1.useEffect)(function () {
        ...
        var subscription = supabase
            ...
            setMetrics(function (prev) {
                ...
                var index = updated.findIndex(function (m) { return m.cohortId === cohortId; });
                if (index >= 0) {
...
function useCohortInsights(config) {
    ...
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/api/analytics/insights', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                type: 'cohort',
    ...
    return (0, react_1.useMemo)(function () { return ({
        ...
        formatCohortName: function (date, granularity) {
            ...
            if (granularity === 'daily') {
                ...
                return "Week of ".concat(d.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }));
            }
            else {
        ...
        formatPeriodLabel: function (period, granularity) {
            ...
            return "".concat(period, " ").concat(unit).concat(period > 1 ? 's' : '');
        },
