...
function useNotifications(_a) {
    var _this = this;
    var userId = _a.userId, _b = _a.autoMarkAsRead, autoMarkAsRead = _b === void 0 ? false : _b, _c = _a.limit, limit = _c === void 0 ? 50 : _c, types = _a.types, _d = _a.realtime, realtime = _d === void 0 ? true : _d;
    var _e = (0, react_1.useState)([]), notifications = _e[0], setNotifications = _e[1];
    var _f = (0, react_1.useState)(null), preferences = _f[0], setPreferences = _f[1];
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (notificationsError) {
                        throw new Error("Failed to load notifications: ".concat(notificationsError.message));
                    }
                    setNotifications(notificationsData || []);
                    return [3 /*break*/, 4];
                case 2:
                    err_1 = _b.sent();
                    errorMessage = err_1 instanceof Error ? err_1.message : 'Failed to load notifications';
    ...
    var setupRealtimeSubscription = (0, react_1.useCallback)(function () {
        ...
        var channel = supabase
            ...
            if (payload.eventType === 'INSERT') {
                ...
                setNotifications(function (prev) { return __spreadArray([newNotification_1], prev.slice(0, limit - 1), true); });
                // Auto-mark as read if enabled
                if (autoMarkAsRead) {
                    setTimeout(function () { return markAsRead(newNotification_1.id); }, 5000);
                }
                ...
                setNotifications(function (prev) {
                    return prev.map(function (notif) { return notif.id === updatedNotification_1.id ? updatedNotification_1 : notif; });
                });
            }
            else if (payload.eventType === 'DELETE') {
                setNotifications(function (prev) {
                    return prev.filter(function (notif) { return notif.id !== payload.old.id; });
                });
            }
        })
            .subscribe();
                    ...
                    setNotifications(function (prev) {
                        return prev.map(function (notif) {
                            return notif.id === notificationId
                                ? __assign(__assign({}, notif), { read_at: new Date().toISOString() }) : notif;
                        });
                    });
                    return [3 /*break*/, 3];
                case 2:
            ...
            switch (_a.label) {
                case 0:
                    ...
                    unreadIds_1 = notifications
                        .filter(function (notif) { return !notif.read_at; })
                        .map(function (notif) { return notif.id; });
                    if (unreadIds_1.length === 0)
                        return [2 /*return*/];
                    return [4 /*yield*/, supabase
                            .from('notifications')
                            .update({ read_at: new Date().toISOString() })
                    ...
                    setNotifications(function (prev) {
                        return prev.map(function (notif) {
                            return unreadIds_1.includes(notif.id)
                                ? __assign(__assign({}, notif), { read_at: now_1 }) : notif;
                        });
                    });
                    return [3 /*break*/, 3];
                case 2:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    // Update local state
                    setNotifications(function (prev) { return prev.filter(function (notif) { return notif.id !== notificationId; }); });
                    return [3 /*break*/, 3];
                case 2:
                    err_5 = _a.sent();
    ...
    // Update preferences
    var updatePreferences = (0, react_1.useCallback)(function (newPreferences) { return __awaiter(_this, void 0, void 0, function () {
    ...
    // Send notification
    var sendNotification = (0, react_1.useCallback)(function (notification) { return __awaiter(_this, void 0, void 0, function () {
        var error_5, err_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            .from('notifications')
                            .insert([__assign(__assign({}, notification), { created_at: new Date().toISOString() })])];
                case 1:
    ...
    var refreshNotifications = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadNotifications()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    // Utility functions
    var getNotificationsByType = (0, react_1.useCallback)(function (type) {
        return notifications.filter(function (notif) { return notif.type === type; });
    }, [notifications]);
    var getUnreadNotifications = (0, react_1.useCallback)(function () {
        return notifications.filter(function (notif) { return !notif.read_at; });
    }, [notifications]);
    // Computed values
