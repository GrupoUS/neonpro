...
export function useRegulatoryCategories(options: ListCategoriesRequest = {}): UseRegulatoryCategories {
  ...
  const [authorities, setAuthorities] = useState<Array<{ authority_name: string; authority_code: string }>>([])
