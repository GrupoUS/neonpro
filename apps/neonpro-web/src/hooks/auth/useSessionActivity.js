...
function useSessionActivity(options) {
    ...
    var _a = (0, useSession_1.useSession)(), updateActivity = _a.updateActivity, isAuthenticated = _a.isAuthenticated;
    ...
    // =====================================================
    var trackActivity = (0, react_1.useCallback)(function (activityType, metadata) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, updateActivity('idle_end', { duration: Date.now() - (((_a = lastActivityRef.current) === null || _a === void 0 ? void 0 : _a.getTime()) || 0) })];
                case 2:
                    _b.sent();
                    _b.label = 3;
                case 3:
                    ...
                    return [4 /*yield*/, updateActivity(activityType, __assign(__assign({}, metadata), { pathname: pathname, timestamp: now.toISOString(), userAgent: navigator.userAgent }))];
                case 4:
                    // Send to session manager
                    _b.sent();
                    return [3 /*break*/, 6];
    ...
    var debouncedTrackActivity = (0, react_1.useCallback)(function (activityType, metadata) {
    ...
    // IDLE DETECTION
    // =====================================================
    var resetIdleTimer = (0, react_1.useCallback)(function () {
        if (!config.trackIdleTime)
            return;
        if (idleTimerRef.current) {
            clearTimeout(idleTimerRef.current);
        }
        idleTimerRef.current = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, trackActivity('idle_start', {
                                lastActivity: (_a = lastActivityRef.current) === null || _a === void 0 ? void 0 : _a.toISOString()
                            })];
                    case 1:
                        _b.sent();
                        _b.label = 2;
    ...
    // EVENT HANDLERS
    // =====================================================
    var handlePageView = (0, react_1.useCallback)(function () {
        if (!config.trackPageViews)
            return;
        if (config.excludePaths.some(function (path) { return pathname.startsWith(path); }))
            return;
    ...
    var handleClick = (0, react_1.useCallback)(function (event) {
        ...
        var id = target.id;
        var text = ((_a = target.textContent) === null || _a === void 0 ? void 0 : _a.slice(0, 100)) || '';
    ...
    var handleFormSubmit = (0, react_1.useCallback)(function (event) {
        ...
        trackActivity('form_submit', {
            ...
            fields: fields.filter(function (field) { return !field.toLowerCase().includes('password'); })
        });
    ...
    var handleBeforeUnload = (0, react_1.useCallback)(function () {
    ...
    (0, react_1.useEffect)(function () {
        ...
        var handleMouseMove = function () { return resetIdleTimer(); };
    ...
    }, [isAuthenticated, config, handleClick, handleFormSubmit, handleScroll,
        handleKeyPress, handleVisibilityChange, handleBeforeUnload, resetIdleTimer]);
    // =====================================================
    // UTILITY FUNCTIONS
    // =====================================================
...
function useBusinessActivityTracking() {
    var trackActivity = useSessionActivity().trackActivity;
    return {
        trackPurchase: function (metadata) { return trackActivity('purchase', metadata); },
