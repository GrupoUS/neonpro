...
function useSession(options) {
    ...
    var _a = options.autoRefresh, autoRefresh = _a === void 0 ? true : _a, _b = options.refreshInterval, refreshInterval = _b === void 0 ? 60000 : _b, // 1 minute
    _c = options.redirectOnExpiry, // 1 minute
    redirectOnExpiry = _c === void 0 ? '/login' : _c, _d = options.showWarnings, showWarnings = _d === void 0 ? true : _d, _e = options.trackActivity, trackActivity = _e === void 0 ? true : _e;
    ...
    var _g = (0, react_1.useState)(null), timeUntilExpiry = _g[0], setTimeUntilExpiry = _g[1];
    var _h = (0, react_1.useState)(null), sessionStats = _h[0], setSessionStats = _h[1];
    // Refs for intervals
    ...
    // SESSION MANAGEMENT
    // =====================================================
    var checkExistingSession = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    deviceInfo = _b.sent();
                    return [4 /*yield*/, ((_a = sessionSystemRef.current) === null || _a === void 0 ? void 0 : _a.validateSession(sessionId, deviceInfo.ipAddress, deviceInfo.userAgent))];
                case 2:
                    validation = _b.sent();
                    if ((validation === null || validation === void 0 ? void 0 : validation.isValid) && validation.session) {
                        setState({
                            isLoading: false,
    ...
    var login = (0, react_1.useCallback)(function (credentials, deviceInfo) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ((_a = sessionSystemRef.current) === null || _a === void 0 ? void 0 : _a.authenticateUser(credentials, deviceInfo))];
                case 1:
                    result_1 = _c.sent();
                    if ((result_1 === null || result_1 === void 0 ? void 0 : result_1.success) && result_1.session) {
                        // Store session ID
                        ...
                        if (showWarnings) {
                            ...
                            if (!((_b = result_1.deviceValidation) === null || _b === void 0 ? void 0 : _b.isTrusted)) {
                                sonner_1.toast.warning('New device detected. Check your email for security notification.');
                            }
                        }
                        return [2 /*return*/, true];
                    }
                    else {
                        setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, error: (result_1 === null || result_1 === void 0 ? void 0 : result_1.error) || 'Login failed' })); });
                        if (showWarnings) {
                            sonner_1.toast.error((result_1 === null || result_1 === void 0 ? void 0 : result_1.error) || 'Login failed');
                        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sessionSystemRef.current.terminateSession(sessionId, 'user_logout')];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (!((validation_1 === null || validation_1 === void 0 ? void 0 : validation_1.isValid) && validation_1.session)) return [3 /*break*/, 3];
                    setState(function (prev) { return (__assign(__assign({}, prev), { session: validation_1.session, securityScore: validation_1.securityScore, error: null })); });
                    // Update expiry timer
                ...
                case 6:
                    ...
                    setState(function (prev) { return (__assign(__assign({}, prev), { error: error_4 instanceof Error ? error_4.message : 'Session refresh failed' })); });
                    return [3 /*break*/, 7];
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!sessionId || !sessionSystemRef.current)
                        return [2 /*return*/];
                    return [4 /*yield*/, sessionSystemRef.current.sessionManager.extendSession(sessionId)];
                case 1:
                    result_2 = _a.sent();
                    if (result_2.success && result_2.newExpiresAt) {
                        setState(function (prev) { return (__assign(__assign({}, prev), { session: prev.session ? __assign(__assign({}, prev.session), { expiresAt: result_2.newExpiresAt }) : null })); });
                        // Update expiry timer
    ...
    var validateSession = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    validation = _b.sent();
                    return [2 /*return*/, (validation === null || validation === void 0 ? void 0 : validation.isValid) || false];
                case 3:
                    error_6 = _b.sent();
    ...
    var updateActivity = (0, react_1.useCallback)(function (activityType, metadata) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!sessionId || !sessionSystemRef.current)
                        return [2 /*return*/];
                    return [4 /*yield*/, sessionSystemRef.current.sessionManager.updateActivity(sessionId, activityType, metadata)
                        // Update session stats
                    ];
                case 1:
                    _a.sent();
    ...
    // HELPER FUNCTIONS
    // =====================================================
    var startAutoRefresh = (0, react_1.useCallback)(function () {
        if (refreshIntervalRef.current) {
            clearInterval(refreshIntervalRef.current);
        }
    ...
    var startExpiryTimer = (0, react_1.useCallback)(function (expiresAt) {
        if (expiryTimerRef.current) {
            clearTimeout(expiryTimerRef.current);
        }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3: return [2 /*return*/, (_a.location = _b.sent(),
                        _a)];
            }
        });
    });
