...
exports.useDeviceManagement = exports.useBusinessActivityTracking = exports.withActivityTracking = exports.dispatchCustomActivity = exports.useSessionActivity = exports.useSession = void 0;
...
Object.defineProperty(exports, "useSessionActivity", { enumerable: true, get: function () { return useSessionActivity_1.useSessionActivity; } });
// Additional activity tracking utilities
var useSessionActivity_2 = require("./useSessionActivity");
Object.defineProperty(exports, "dispatchCustomActivity", { enumerable: true, get: function () { return useSessionActivity_2.dispatchCustomActivity; } });
Object.defineProperty(exports, "withActivityTracking", { enumerable: true, get: function () { return useSessionActivity_2.withActivityTracking; } });
Object.defineProperty(exports, "useBusinessActivityTracking", { enumerable: true, get: function () { return useSessionActivity_2.useBusinessActivityTracking; } });
...
function useCompleteSessionManagement(userId) {
    ...
    var devices = (0, useDeviceManagement_2.useDeviceManagement)(userId || ((_a = session.user) === null || _a === void 0 ? void 0 : _a.id), {
        autoRegister: true,
    ...
    return {
        ...
        securityLevel: {
            ...
            securityScore: ((_b = session.securityScore) === null || _b === void 0 ? void 0 : _b.score) || 0,
        ...
        authenticateWithDevice: function (credentials, deviceInfo) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, session.login(credentials, deviceInfo)];
                        case 1:
                        ...
                        case 2:
                            _a.sent();
                            _a.label = 3;
                        case 3: return [2 /*return*/, loginSuccess];
                    }
                });
            });
        },
        secureLogout: function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, session.logout()
...
function useSessionTimeout() {
    var _a = (0, useSession_2.useSession)(), timeUntilExpiry = _a.timeUntilExpiry, isExpiringSoon = _a.isExpiringSoon, extendSession = _a.extendSession;
    return {
...
function useSecurityMonitoring() {
    var _a = (0, useSession_2.useSession)(), securityScore = _a.securityScore, session = _a.session;
    var _b = (0, useDeviceManagement_2.useDeviceManagement)(session === null || session === void 0 ? void 0 : session.userId), deviceRiskLevel = _b.deviceRiskLevel, deviceValidation = _b.deviceValidation;
    var _c = (0, useSessionActivity_3.useSessionActivity)(), isIdle = _c.isIdle, lastActivity = _c.lastActivity;
    return {
        securityScore: (securityScore === null || securityScore === void 0 ? void 0 : securityScore.score) || 0,
        securityFactors: (securityScore === null || securityScore === void 0 ? void 0 : securityScore.factors) || [],
        deviceRiskLevel: deviceRiskLevel,
        isDeviceTrusted: (deviceValidation === null || deviceValidation === void 0 ? void 0 : deviceValidation.isTrusted) || false,
        isUserIdle: isIdle,
        lastActivity: lastActivity,
        // Overall security status
        securityStatus: (function () {
            var score = (securityScore === null || securityScore === void 0 ? void 0 : securityScore.score) || 0;
            var deviceTrusted = (deviceValidation === null || deviceValidation === void 0 ? void 0 : deviceValidation.isTrusted) || false;
...
function useSessionStatistics() {
    var _a = (0, useSession_2.useSession)(), sessionStats = _a.sessionStats, session = _a.session;
    var getActivityHistory = (0, useSessionActivity_3.useSessionActivity)().getActivityHistory;
    var deviceStats = (0, useDeviceManagement_2.useDeviceManagement)(session === null || session === void 0 ? void 0 : session.userId).deviceStats;
    return {
        sessionDuration: (sessionStats === null || sessionStats === void 0 ? void 0 : sessionStats.duration) || 0,
        activitiesCount: (sessionStats === null || sessionStats === void 0 ? void 0 : sessionStats.activitiesCount) || 0,
        lastActivity: sessionStats === null || sessionStats === void 0 ? void 0 : sessionStats.lastActivity,
...
function SessionProvider(_a) {
    var children = _a.children, userId = _a.userId;
    var sessionManagement = useCompleteSessionManagement(userId);
    return value = { sessionManagement: sessionManagement } >
        { children: children }
