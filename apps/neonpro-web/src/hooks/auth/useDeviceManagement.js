...
function useDeviceManagement(userId, options) {
  ...
  var _c = options.autoRegister,
    autoRegister = _c === void 0 ? true : _c,
    _d = options.showNotifications,
    showNotifications = _d === void 0 ? true : _d,
    _e = options.trackDeviceChanges,
    trackDeviceChanges = _e === void 0 ? true : _e,
    _f = options.validateOnMount,
    validateOnMount = _f === void 0 ? true : _f;
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                deviceManagerRef.current.validateDevice(userId, currentDevice.fingerprint, {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                deviceManagerRef.current.validateDevice(userId, state.currentDevice.fingerprint, {
                  userAgent: state.currentDevice.userAgent,
                  ipAddress: state.currentDevice.ipAddress,
                  location: state.currentDevice.location,
                }),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 6:
              error_4 = _a.sent();
              errorMessage =
                error_4 instanceof Error ? error_4.message : "Failed to untrust device";
              if (showNotifications) {
                sonner_1.toast.error(errorMessage);
              }
              return [2 /*return*/, false];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                deviceManagerRef.current.reportSuspiciousDevice(userId, deviceId, reason),
              ];
            case 2:
              result = _a.sent();
              if (result.success) {
  ...
  // COMPUTED VALUES
  // =====================================================
  var isCurrentDeviceTrusted =
    ((_a = state.deviceValidation) === null || _a === void 0 ? void 0 : _a.isTrusted) || false;
  var deviceRiskLevel =
