...
function useSession(options) {
    ...
    onExpiry = options.onExpiry, onSecurityAlert = options.onSecurityAlert, onDeviceChange = options.onDeviceChange;
    ...
    var _g = (0, react_1.useState)([]), securityAlerts = _g[0], setSecurityAlerts = _g[1];
    var _h = (0, react_1.useState)(new Date()), lastActivity = _h[0], setLastActivity = _h[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch(SESSION_API.validate, {
                            method: 'POST',
                            headers: {
                ...
                case 3:
                    ...
                    if (result.valid && result.session) {
                        ...
                        if (result.warnings && result.warnings.length > 0) {
                            alerts_1 = result.warnings.map(function (warning, index) { return ({
                            ...
                            setSecurityAlerts(function (prev) { return __spreadArray(__spreadArray([], prev, true), alerts_1, true); });
                            alerts_1.forEach(function (alert) { return onSecurityAlert === null || onSecurityAlert === void 0 ? void 0 : onSecurityAlert(alert); });
                        }
                    }
                    else {
                        setSession(null);
    ...
    var refresh = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch(SESSION_API.refresh, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
    ...
    // Terminate session
    var terminate = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var err_3, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch(SESSION_API.terminate, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
    ...
    // Extend session
    var extend = (0, react_1.useCallback)(function (minutes) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch(SESSION_API.extend, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
    ...
    var registerDevice = (0, react_1.useCallback)(function (deviceName) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    device = _a.sent();
                    onDeviceChange === null || onDeviceChange === void 0 ? void 0 : onDeviceChange(device);
    ...
    // Get active sessions
    var getActiveSessions = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var response, err_6, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch(SESSION_API.active, {
                            method: 'GET',
                            credentials: 'include'
                        })];
                case 1:
    ...
    var terminateSession = (0, react_1.useCallback)(function (sessionId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("".concat(SESSION_API.terminate, "/").concat(sessionId), {
                            method: 'POST',
                            credentials: 'include'
                        })];
                case 1:
    ...
    // Get security events
    var getSecurityEvents = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var setupExpiryWarnings = (0, react_1.useCallback)(function (currentSession) {
        ...
        if (fiveMinuteWarning > 0) {
            setTimeout(function () {
                sonner_1.toast.warning('Your session will expire in 5 minutes', {
                    action: {
                        label: 'Extend',
                        onClick: function () { return extend(30); }
                    }
                });
            }, fiveMinuteWarning);
        }
    ...
    // Track user activity
    var trackActivity = (0, react_1.useCallback)(function () {
        setLastActivity(new Date());
    ...
    (0, react_1.useEffect)(function () {
        ...
        var handleActivity = function () { return trackActivity(); };
...
function useSessionSecurity() {
    ...
    var fetchSecurityEvents = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
...
function useDeviceManagement() {
    ...
    var _b = (0, react_1.useState)(true), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(null), error = _c[0], setError = _c[1];
    var fetchDevices = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var trustDevice = (0, react_1.useCallback)(function (deviceId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("".concat(SESSION_API.devices, "/").concat(deviceId, "/trust"), {
                            method: 'POST'
                        })];
                case 1:
                    response = _a.sent();
    ...
    var revokeDevice = (0, react_1.useCallback)(function (deviceId) { return __awaiter(_this, void 0, void 0, function () {
        var response, err_12;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("".concat(SESSION_API.devices, "/").concat(deviceId), {
                            method: 'DELETE'
                        })];
                case 1:
                    response = _a.sent();
