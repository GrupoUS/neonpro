...
function useRealTimeAvailability(_a) {
    var _this = this;
    var professionalId = _a.professionalId, serviceId = _a.serviceId, dateRange = _a.dateRange, _b = _a.autoRefetch, autoRefetch = _b === void 0 ? true : _b, _c = _a.enableOptimistic, enableOptimistic = _c === void 0 ? true : _c;
     ...
     */
    var fetchAvailability = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    setState(function (prev) { return (__assign(__assign({}, prev), { slots: filteredSlots_1, loading: false, connectionStatus: 'connected' })); });
                    versionRef.current += 1;
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _b.sent();
                    console.error('Error fetching availability:', error_1);
                    setState(function (prev) { return (__assign(__assign({}, prev), { error: error_1 instanceof Error ? error_1.message : 'Failed to fetch availability', loading: false, connectionStatus: 'disconnected' })); });
                    return [3 /*break*/, 3];
     ...
     */
    var handleRealtimeEvent = (0, react_1.useCallback)(function (payload) {
        ...
        setState(function (prev) {
            ...
            switch (eventType) {
                ...
                case 'UPDATE':
                    ...
                    var slotIndex = updatedSlots.findIndex(function (s) { return s.id === newRecord.id; });
                    if (slotIndex >= 0) {
                        if (newRecord.available) {
                ...
                case 'DELETE':
                    // Slot was deleted
                    updatedSlots = updatedSlots.filter(function (s) { return s.id !== oldRecord.id; });
                    break;
            }
    ...
    var setupRealtimeSubscription = (0, react_1.useCallback)(function () {
        try {
            ...
            var channelName = "availability-".concat(professionalId || 'all', "-").concat(serviceId || 'all');
            channelRef.current = supabase.channel(channelName)
                ...
                setState(function (prev) { return (__assign(__assign({}, prev), { connectionStatus: status === 'SUBSCRIBED' ? 'connected' :
            ...
            setState(function (prev) { return (__assign(__assign({}, prev), { connectionStatus: 'disconnected', error: 'Failed to setup real-time updates' })); });
        }
     ...
     */
    var reserveSlotOptimistic = (0, react_1.useCallback)(function (slotId, patientId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    slot = state.slots.find(function (s) { return s.id === slotId; });
                    if (!slot)
                        return [2 /*return*/, false
                            // Create optimistic update
                        ];
                    optimisticSlot = __assign(__assign({}, slot), { available: false, reserved_until: new Date(Date.now() + 5 * 60 * 1000).toISOString(), reserved_by: patientId, version: slot.version + 1 });
                    // Apply optimistic update
                    setState(function (prev) { return (__assign(__assign({}, prev), { optimisticUpdates: new Map(prev.optimisticUpdates.set(slotId, optimisticSlot)), slots: prev.slots.map(function (s) { return s.id === slotId ? optimisticSlot : s; }) })); });
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, supabase.rpc('reserve_appointment_slot', {
                            slot_id: slotId,
                ...
                case 2:
                    ...
                    if (error) {
                        ...
                        setState(function (prev) {
                            ...
                            return __assign(__assign({}, prev), { optimisticUpdates: newOptimisticUpdates, slots: prev.slots.map(function (s) { return s.id === slotId ? slot : s; }), error: 'Slot no longer available' });
                        });
                        return [2 /*return*/, false];
                    }
                ...
                case 3:
                    ...
                    setState(function (prev) {
                        var newOptimisticUpdates = new Map(prev.optimisticUpdates);
                        newOptimisticUpdates.delete(slotId);
                        return __assign(__assign({}, prev), { optimisticUpdates: newOptimisticUpdates, slots: prev.slots.map(function (s) { return s.id === slotId ? slot : s; }), error: error_2 instanceof Error ? error_2.message : 'Failed to reserve slot' });
                    });
                    return [2 /*return*/, false];
     ...
     */
    var getAlternativeSuggestions = (0, react_1.useCallback)(function (preferredSlot, maxAlternatives) {
        if (maxAlternatives === void 0) { maxAlternatives = 3; }
        ...
        return state.slots
            ...
            return slot.id !== preferredSlot.id &&
                slot.service_id === preferredSlot.service_id &&
                slot.available;
        })
            .map(function (slot) { return (__assign(__assign({}, slot), { score: calculateSlotScore(slot, preferredDate, preferredTime) })); })
    ...
    return __assign(__assign({}, state), { refetch: fetchAvailability, reserveSlot: reserveSlotOptimistic, getAlternatives: getAlternativeSuggestions });
}
