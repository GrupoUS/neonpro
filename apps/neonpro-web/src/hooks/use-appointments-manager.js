...
function useAppointmentsManager() {
    ...
    var dateRange = (0, react_1.useMemo)(function () {
        ...
        switch (filters.dateRange) {
            ...
            case 'week':
                return { start: (0, date_fns_1.startOfWeek)(now, { locale: locale_1.pt }), end: (0, date_fns_1.endOfWeek)(now, { locale: locale_1.pt }) };
            case 'month':
    ...
    var fetchAppointments = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (filters.patientName) {
                        ...
                        filteredData = filteredData.filter(function (apt) { var _a, _b; return (_b = (_a = apt.patient) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(searchTerm_1); });
                    }
        ...
        setAppointments(function (prev) {
            return prev.map(function (apt) {
                return apt.id === updatedAppointment.id
                    ? __assign(__assign(__assign({}, apt), updatedAppointment), { updated_at: new Date().toISOString() }) : apt;
            });
        });
    ...
    var handleAppointmentDelete = function (deletedAppointment) {
        setAppointments(function (prev) {
            return prev.filter(function (apt) { return apt.id !== deletedAppointment.id; });
        });
        toast({
    ...
    // Action functions
    var updateAppointmentStatus = (0, react_1.useCallback)(function (appointmentId, newStatus, notes) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var cancelAppointment = (0, react_1.useCallback)(function (appointmentId, reason) {
        return updateAppointmentStatus(appointmentId, 'cancelled', reason);
    }, [updateAppointmentStatus]);
    var completeAppointment = (0, react_1.useCallback)(function (appointmentId, notes) {
        return updateAppointmentStatus(appointmentId, 'completed', notes);
    }, [updateAppointmentStatus]);
    var markNoShow = (0, react_1.useCallback)(function (appointmentId) {
    ...
    var statistics = (0, react_1.useMemo)(function () {
        ...
        var todayTotal = appointments.filter(function (apt) { var _a; return ((_a = apt.time_slot) === null || _a === void 0 ? void 0 : _a.date) === today; }).length;
        var weekStart = (0, date_fns_1.format)((0, date_fns_1.startOfWeek)(new Date(), { locale: locale_1.pt }), 'yyyy-MM-dd');
        var weekEnd = (0, date_fns_1.format)((0, date_fns_1.endOfWeek)(new Date(), { locale: locale_1.pt }), 'yyyy-MM-dd');
        var weekTotal = appointments.filter(function (apt) { var _a, _b; return ((_a = apt.time_slot) === null || _a === void 0 ? void 0 : _a.date) >= weekStart && ((_b = apt.time_slot) === null || _b === void 0 ? void 0 : _b.date) <= weekEnd; }).length;
        return {
            total: total,
            confirmed: confirmed,
            pending: pending,
    ...
    var appointmentsByDate = (0, react_1.useMemo)(function () {
        var grouped = {};
        ...
        Object.keys(grouped).forEach(function (date) {
            grouped[date].sort(function (a, b) {
                var _a, _b;
                var timeA = ((_a = a.time_slot) === null || _a === void 0 ? void 0 : _a.start_time) || '00:00';
                var timeB = ((_b = b.time_slot) === null || _b === void 0 ? void 0 : _b.start_time) || '00:00';
