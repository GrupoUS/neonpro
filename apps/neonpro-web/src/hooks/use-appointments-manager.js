...
function useAppointmentsManager() {
  ...
  var handleAppointmentInsert = (newAppointment) => {
  ...
  var handleAppointmentUpdate = (updatedAppointment, oldAppointment) => {
  ...
  var handleAppointmentDelete = (deletedAppointment) => {
  ...
  var confirmAppointment = (0, react_1.useCallback)(
    (appointmentId) => updateAppointmentStatus(appointmentId, "confirmed"),
    [updateAppointmentStatus],
  );
  var cancelAppointment = (0, react_1.useCallback)(
    (appointmentId, reason) => updateAppointmentStatus(appointmentId, "cancelled", reason),
    [updateAppointmentStatus],
  );
  var completeAppointment = (0, react_1.useCallback)(
    (appointmentId, notes) => updateAppointmentStatus(appointmentId, "completed", notes),
    [updateAppointmentStatus],
  );
  var markNoShow = (0, react_1.useCallback)(
    (appointmentId) => updateAppointmentStatus(appointmentId, "no_show"),
    [updateAppointmentStatus],
  );
  // Statistics
  var statistics = (0, react_1.useMemo)(() => {
    ...
    var todayTotal = appointments.filter((apt) => {
      var _a;
    ...
    var weekTotal = appointments.filter((apt) => {
      var _a, _b;
      return (
