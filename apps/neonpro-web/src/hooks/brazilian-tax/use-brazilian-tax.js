...
function useCNPJValidation() {
    ...
    var validateCNPJ = (0, react_1.useCallback)(function (cnpj) {
        ...
        setValidationState(function (prev) { return (__assign(__assign({}, prev), { cnpj: cnpj, isValid: validation.valid, errors: validation.errors || [] })); });
        return validation;
    }, []);
    var consultCNPJ = (0, react_1.useCallback)(function (cnpj) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!cnpj)
                        return [2 /*return*/];
                    setValidationState(function (prev) { return (__assign(__assign({}, prev), { isLoading: true, errors: [] })); });
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 2:
                    result_1 = _a.sent();
                    setValidationState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, consultationResult: result_1, companyData: result_1.success ? result_1.data || null : null, errors: result_1.errors || [] })); });
                    return [2 /*return*/, result_1];
                case 3:
                    error_1 = _a.sent();
                    errorMessage_1 = error_1 instanceof Error ? error_1.message : 'Erro na consulta';
                    setValidationState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, errors: [errorMessage_1] })); });
                    return [2 /*return*/, null];
                case 4: return [2 /*return*/];
            }
        });
    }); }, []);
    var formatAndValidate = (0, react_1.useCallback)(function (cnpj) {
    ...
    return __assign(__assign({}, validationState), { validateCNPJ: validateCNPJ, consultCNPJ: consultCNPJ, formatAndValidate: formatAndValidate, clearValidation: clearValidation });
}
/**
...
function useTaxCalculation() {
    ...
    var _a = (0, react_1.useState)({
        ...
        errors: [],
        history: []
    }), calculationState = _a[0], setCalculationState = _a[1];
    var calculateTaxes = (0, react_1.useCallback)(function (request) { return __awaiter(_this, void 0, void 0, function () {
        var result_2, errorMessage_2;
        return __generator(this, function (_a) {
            setCalculationState(function (prev) { return (__assign(__assign({}, prev), { isLoading: true, errors: [] })); });
            try {
                result_2 = tax_calculator_v2_1.default.calculateTaxes(request);
                setCalculationState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, result: result_2, history: __spreadArray([result_2], prev.history.slice(0, 9), true) })); });
                return [2 /*return*/, result_2];
            }
            catch (error) {
                errorMessage_2 = error instanceof Error ? error.message : 'Erro no cálculo';
                setCalculationState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, errors: [errorMessage_2] })); });
                return [2 /*return*/, null];
            }
            return [2 /*return*/];
        });
    }); }, []);
    var batchCalculate = (0, react_1.useCallback)(function (requests) { return __awaiter(_this, void 0, void 0, function () {
        var results, errorMessage_3;
        return __generator(this, function (_a) {
            setCalculationState(function (prev) { return (__assign(__assign({}, prev), { isLoading: true, errors: [] })); });
            try {
                results = tax_calculator_v2_1.default.batchCalculateTaxes(requests);
                setCalculationState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false })); });
                return [2 /*return*/, results];
            }
            catch (error) {
                errorMessage_3 = error instanceof Error ? error.message : 'Erro no cálculo em lote';
                setCalculationState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, errors: [errorMessage_3] })); });
                return [2 /*return*/, null];
            }
            return [2 /*return*/];
        });
    ...
    var estimateAnnualTax = (0, react_1.useCallback)(function (monthlyRevenue, regime, serviceType) {
        try {
            ...
            setCalculationState(function (prev) { return (__assign(__assign({}, prev), { errors: [errorMessage_4] })); });
            return null;
        }
    }, []);
    ...
    return __assign(__assign({}, calculationState), { calculateTaxes: calculateTaxes, batchCalculate: batchCalculate, estimateAnnualTax: estimateAnnualTax, clearCalculations: clearCalculations });
}
/**
...
function useBrazilianTaxCompliance() {
    ...
    var _a = (0, react_1.useState)({
        ...
        errors: []
    }), complianceState = _a[0], setComplianceState = _a[1];
    var checkHealthcareCNAE = (0, react_1.useCallback)(function (cnae) {
        ...
        var isValid = healthcareCNAEs.some(function (code) { return cnae.startsWith(code.replace('-', '')); });
        setComplianceState(function (prev) { return (__assign(__assign({}, prev), { healthcareCNAEValid: isValid })); });
        return isValid;
    }, []);
    var validateCompliance = (0, react_1.useCallback)(function (companyData) { return __awaiter(_this, void 0, void 0, function () {
        var cnpjValid_1, healthcareValid_1, regimeTributario_1, errorMessage_5;
        return __generator(this, function (_a) {
            setComplianceState(function (prev) { return (__assign(__assign({}, prev), { isLoading: true, errors: [] })); });
            try {
                ...
                setComplianceState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, healthcareCNAEValid: healthcareValid_1, regimeTributario: regimeTributario_1, complianceChecks: {
                ...
                setComplianceState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, errors: [errorMessage_5] })); });
                return [2 /*return*/, null];
            }
            return [2 /*return*/];
        });
    ...
    return __assign(__assign({}, complianceState), { checkHealthcareCNAE: checkHealthcareCNAE, validateCompliance: validateCompliance, clearCompliance: clearCompliance });
}
/**
...
function useBrazilianTax() {
    ...
    var validateAndCalculate = (0, react_1.useCallback)(function (cnpj, serviceType, serviceValue) { return __awaiter(_this, void 0, void 0, function () {
        var cnpjResult, complianceResult, taxRequest, taxResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, cnpjValidation.consultCNPJ(cnpj)];
                case 1:
                    cnpjResult = _a.sent();
