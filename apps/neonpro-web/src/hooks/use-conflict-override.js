...
function useConflictOverride() {
    ...
    var _b = (0, react_1.useState)([]), overrideRequests = _b[0], setOverrideRequests = _b[1];
    ...
    var checkOverridePermissions = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var requestConflictOverride = (0, react_1.useCallback)(function (overrideData) { return __awaiter(_this, void 0, void 0, function () {
        var _a, user, userError, permissions, overrideRequest, _b, savedRequest_1, insertError, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    setLoading(true);
                ...
                case 3:
                    permissions = _c.sent();
                    if (!(permissions === null || permissions === void 0 ? void 0 : permissions.can_override_conflicts)) {
                    ...
                    if (overrideData.impact_assessment.estimated_delay_minutes > permissions.max_override_impact_minutes) {
                        throw new Error("Impacto excede limite permitido: ".concat(permissions.max_override_impact_minutes, " minutos"));
                    }
                    overrideRequest = __assign(__assign({}, overrideData), { requested_by: user.id, status: permissions.requires_approval ? 'pending' : 'approved', approved_by: permissions.requires_approval ? undefined : user.id, created_at: new Date().toISOString(), approved_at: permissions.requires_approval ? undefined : new Date().toISOString() });
                    return [4 /*yield*/, supabase
                ...
                case 6:
                    ...
                    _c.label = 7;
                case 7:
                    setOverrideRequests(function (prev) { return __spreadArray(__spreadArray([], prev, true), [savedRequest_1], false); });
    ...
    var processOverrideRequest = (0, react_1.useCallback)(function (requestId, action, approvalNotes) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    permissions = _c.sent();
                    if (!(permissions === null || permissions === void 0 ? void 0 : permissions.can_approve_overrides)) {
                ...
                case 7:
                    ...
                    setOverrideRequests(function (prev) {
                        return prev.map(function (req) { return req.id === requestId ? updatedRequest_1 : req; });
                    });
                    toast({
    ...
    var processApprovedOverride = (0, react_1.useCallback)(function (overrideRequest) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    notificationPromises = overrideRequest.impact_assessment.affected_appointments.map(function (appointment) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: 
                                // This would integrate with your notification system
                                // For now, we'll just log the notification requirement
                                return [4 /*yield*/, supabase.from('notification_queue').insert([{
    ...
    var loadPendingOverrides = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
