...
function useRealTimeAvailability(_a) {
    var _this = this;
    var serviceId = _a.serviceId, professionalId = _a.professionalId, startDate = _a.startDate, endDate = _a.endDate, _b = _a.enabled, enabled = _b === void 0 ? true : _b;
    var _c = (0, react_1.useState)([]), slots = _c[0], setSlots = _c[1];
    var _d = (0, react_1.useState)(true), loading = _d[0], setLoading = _d[1];
    var _e = (0, react_1.useState)(null), error = _e[0], setError = _e[1];
    var _f = (0, react_1.useState)(false), isConnected = _f[0], setIsConnected = _f[1];
    var _g = (0, react_1.useState)(null), lastUpdated = _g[0], setLastUpdated = _g[1];
    var _h = (0, react_1.useState)(null), channel = _h[0], setChannel = _h[1];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (fetchError)
                        throw fetchError;
                    enrichedSlots = data.map(function (slot) { return ({
    ...
    (0, react_1.useEffect)(function () {
        if (!serviceId || !enabled)
            return;
        var channelName = "availability:".concat(serviceId).concat(professionalId ? ":".concat(professionalId) : '');
    ...
    var refreshAvailability = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchAvailability()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function useConflictDetection() {
    var _this = this;
    var supabase = yield (0, client_1.createClient)();
    var checkForConflicts = (0, react_1.useCallback)(function (datetime, serviceId, professionalId, duration) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (conflictError)
                        throw conflictError;
                    if (!(conflictCheck === null || conflictCheck === void 0 ? void 0 : conflictCheck.has_conflict)) return [3 /*break*/, 3];
                    return [4 /*yield*/, supabase
                ...
                case 3: return [2 /*return*/, { hasConflict: false }];
                case 4:
                    error_1 = _c.sent();
...
function useOptimisticBooking() {
    var _this = this;
    var supabase = yield (0, client_1.createClient)();
    var _a = (0, react_1.useState)(new Set()), reservedSlots = _a[0], setReservedSlots = _a[1];
    var reserveSlot = (0, react_1.useCallback)(function (datetime, serviceId, professionalId) { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (data === null || data === void 0 ? void 0 : data.reservation_id) {
                        setReservedSlots(function (prev) { return new Set(__spreadArray(__spreadArray([], prev, true), [datetime], false)); });
    ...
    var releaseSlot = (0, react_1.useCallback)(function (reservationId) { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
