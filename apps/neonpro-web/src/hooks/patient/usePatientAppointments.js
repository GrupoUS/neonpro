...
function usePatientAppointments() {
  ...
  var _b = (0, react_1.useState)([]),
    pastAppointments = _b[0],
    setPastAppointments = _b[1];
  ...
  var _e = (0, react_1.useState)(null),
    cancellationPolicies = _e[0],
    setCancellationPolicies = _e[1];
          ...
          switch (_g.label) {
            ...
            case 2:
              ...
              processedAppointments = (appointments || []).map((apt) => {
                ...
                var hoursUntil = Math.floor(
                  (appointmentDateTime.getTime() - now_1.getTime()) / (1000 * 60 * 60),
                );
                return {
                  id: apt.id,
                  service_id: apt.service_id,
                  service_name:
                    ((_a = apt.services) === null || _a === void 0 ? void 0 : _a.name) ||
                    "Unknown Service",
                  service_duration:
                    ((_b = apt.services) === null || _b === void 0
                      ? void 0
                      : _b.duration_minutes) ||
                    apt.duration ||
                    60,
                  ...
                  professional_name:
                    ((_c = apt.professionals) === null || _c === void 0 ? void 0 : _c.name) ||
                    "Any Professional",
            ...
            case 3:
              ...
              if (policies) {
                setCancellationPolicies({
                  minimum_hours:
                    ((_c = policies.config) === null || _c === void 0
                      ? void 0
                      : _c.minimum_hours) || 24,
                  fee_amount:
                    ((_d = policies.config) === null || _d === void 0 ? void 0 : _d.fee_amount) ||
                    0,
                  fee_applies:
                    ((_e = policies.config) === null || _e === void 0 ? void 0 : _e.fee_applies) ||
                    false,
                  emergency_exceptions: ((_f = policies.config) === null || _f === void 0
                    ? void 0
                    : _f.emergency_exceptions) || ["medical_emergency", "family_emergency"],
                });
              } else {
            ...
            case 0:
              ...
              if (!appointment.can_cancel) {
                ...
                sonner_1.toast.error(
                  "Cancelamento deve ser feito com pelo menos "
                    .concat(requiredHours, "h de anteced\u00EAncia. Restam ")
                    .concat(hoursRemaining, "h."),
                );
                return [2 /*return*/, false];
              }
              isEmergency =
                cancellationPolicies === null || cancellationPolicies === void 0
                  ? void 0
                  : cancellationPolicies.emergency_exceptions.includes(reason);
              return [
                4 /*yield*/,
                supabase.rpc("cancel_patient_appointment", {
          ...
          switch (_a.label) {
            case 0:
              ...
              if (!appointment.can_reschedule) {
                sonner_1.toast.error(
                  "Reagendamento deve ser solicitado com pelo menos 48h de antecedência",
                );
                return [2 /*return*/, false];
              }
              return [
                4 /*yield*/,
                supabase.from("reschedule_requests").insert({
                  appointment_id: appointmentId,
            ...
            case 1:
              ...
              sonner_1.toast.success(
                "Solicitação de reagendamento enviada! Você será notificado da resposta.",
              );
              return [2 /*return*/, true];
            case 2:
              err_3 = _a.sent();
