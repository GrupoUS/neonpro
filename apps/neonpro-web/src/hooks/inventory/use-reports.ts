...
export function useReports() {
  ...
  const generateAnalytics = useCallback(async (filters: ReportFilters = {}): Promise<ReportData | null> => {
  ...
  const generateMetrics = useCallback(async (filters: ReportFilters = {}): Promise<AnalyticsMetrics | null> => {
    setIsGenerating(true)
  ...
  const generatePredictiveAnalysis = useCallback(async (filters: ReportFilters = {}) => {
    setIsGenerating(true)
