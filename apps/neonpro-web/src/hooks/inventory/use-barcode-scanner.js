...
function useBarcodeScanner(config, callbacks) {
    ...
    var defaultConfig = __assign({ enableCamera: true, enableKeyboard: true, enableMobile: true, soundEnabled: true, vibrationEnabled: true, continuousScanning: false }, config);
     ...
     */
    var initializeScanner = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setState(function (prev) { return (__assign(__assign({}, prev), { cameraPermission: permissionStatus_1 })); });
                    _a.label = 2;
                case 2:
                    ...
                    setState(function (prev) { return (__assign(__assign({}, prev), { isInitialized: true, error: null })); });
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    setState(function (prev) { return (__assign(__assign({}, prev), { error: "Scanner initialization failed: ".concat(error_1 instanceof Error ? error_1.message : 'Unknown error'), isInitialized: false })); });
                    return [3 /*break*/, 4];
     ...
     */
    var checkCameraPermission = function () { return __awaiter(_this, void 0, void 0, function () {
        var permission, _a;
     ...
     */
    var startCameraScanning = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    setState(function (prev) { return (__assign(__assign({}, prev), { isScanning: true, error: null, cameraPermission: 'granted' })); });
                ...
                case 3:
                    ...
                    setState(function (prev) { return (__assign(__assign({}, prev), { error: errorMessage_1, cameraPermission: 'denied' })); });
                    (_a = callbacks === null || callbacks === void 0 ? void 0 : callbacks.onScanError) === null || _a === void 0 ? void 0 : _a.call(callbacks, errorMessage_1);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
     ...
     */
    var stopCameraScanning = (0, react_1.useCallback)(function () {
        ...
        setState(function (prev) { return (__assign(__assign({}, prev), { isScanning: false })); });
    }, []);
    /**
     * Handle keyboard input for barcode scanning
     */
    var handleKeyboardInput = (0, react_1.useCallback)(function (event) {
        var key = event.key;
     ...
     */
    var processBarcodeInput = (0, react_1.useCallback)(function (rawData_1) {
        var args_1 = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args_1[_i - 1] = arguments[_i];
        }
        return __awaiter(_this, __spreadArray([rawData_1], args_1, true), void 0, function (rawData, source) {
            var parsedData, scanResult_1, error_3, errorMessage_2;
            var _a, _b;
            if (source === void 0) { source = 'keyboard'; }
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        // Update state
                        setState(function (prev) { return (__assign(__assign({}, prev), { lastScanResult: scanResult_1, scanHistory: __spreadArray(__spreadArray([], prev.scanHistory.slice(-49), true), [scanResult_1], false) })); });
                        // Provide feedback
                        if (scanResult_1.success) {
                            playSuccessSound();
                            triggerHapticFeedback();
                            (_a = callbacks === null || callbacks === void 0 ? void 0 : callbacks.onScanSuccess) === null || _a === void 0 ? void 0 : _a.call(callbacks, scanResult_1);
                        }
                    ...
                    case 3:
                        error_3 = _c.sent();
                        errorMessage_2 = error_3 instanceof Error ? error_3.message : 'Scan processing failed';
                        setState(function (prev) { return (__assign(__assign({}, prev), { error: errorMessage_2 })); });
                        (_b = callbacks === null || callbacks === void 0 ? void 0 : callbacks.onScanError) === null || _b === void 0 ? void 0 : _b.call(callbacks, errorMessage_2);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
     ...
     */
    var parseBarcodeData = function (rawData) {
        ...
        if (productMatch) {
            return {
                ...
                expirationDate: productMatch[3] ? "20".concat(productMatch[3].slice(0, 2), "-").concat(productMatch[3].slice(2, 4), "-").concat(productMatch[3].slice(4, 6)) : undefined
            };
        }
     ...
     */
    var detectBarcodeFormat = function (rawData) {
     ...
     */
    var validateBarcodeData = function (scanResult) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch(defaultConfig.validationEndpoint, {
                            method: 'POST',
                            headers: {
                ...
                case 3:
                    ...
                    (_a = callbacks === null || callbacks === void 0 ? void 0 : callbacks.onValidationComplete) === null || _a === void 0 ? void 0 : _a.call(callbacks, scanResult);
                    return [3 /*break*/, 5];
                case 4:
                    error_4 = _b.sent();
     ...
     */
    var handleWorkerMessage = (0, react_1.useCallback)(function (event) {
        var _a;
        var _b = event.data, type = _b.type, data = _b.data;
        switch (type) {
            case 'barcode_detected':
                processBarcodeInput(data.code, 'camera');
                break;
            case 'error':
                setState(function (prev) { return (__assign(__assign({}, prev), { error: data.message })); });
                (_a = callbacks === null || callbacks === void 0 ? void 0 : callbacks.onScanError) === null || _a === void 0 ? void 0 : _a.call(callbacks, data.message);
                break;
        }
     ...
     */
    var triggerHapticFeedback = function () {
     ...
     */
    var manualScan = (0, react_1.useCallback)(function (barcode) {
        processBarcodeInput(barcode, 'keyboard');
    }, [processBarcodeInput]);
    /**
     * Clear scan history
    ...
    var clearHistory = (0, react_1.useCallback)(function () {
        setState(function (prev) { return (__assign(__assign({}, prev), { scanHistory: [], lastScanResult: null })); });
    }, []);
    /**
     * Cleanup function
     */
    ...
    return __assign(__assign({}, state), { 
        ...
        // Camera controls
        startCameraScanning: startCameraScanning, stopCameraScanning: stopCameraScanning, videoRef: videoRef, 
        // Manual controls
        manualScan: manualScan, clearHistory: clearHistory, 
        // Utilities
        cleanup: cleanup, reinitialize: initializeScanner });
}
