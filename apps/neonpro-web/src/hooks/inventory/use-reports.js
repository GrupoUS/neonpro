...
function useReports() {
    var _this = this;
    var _a = (0, react_1.useState)(false), isGenerating = _a[0], setIsGenerating = _a[1];
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        mockData = {
                            ...
                            categoryPerformance: [
                                { category: 'Medicamentos', revenue: 450000, volume: 2800, margin: 32, growth: 15.8 },
                                { category: 'Materiais', revenue: 280000, volume: 1900, margin: 28, growth: 8.2 },
                                { category: 'Equipamentos', revenue: 150000, volume: 680, margin: 45, growth: -2.1 },
                                { category: 'Consumíveis', revenue: 120000, volume: 1200, margin: 18, growth: 12.4 },
                            ],
                            movementAnalysis: [
                            ...
                            supplierMetrics: [
                                { supplier: 'Fornecedor Alpha', deliveryTime: 12, qualityScore: 92, costEfficiency: 78, reliability: 90 },
                                { supplier: 'Fornecedor Beta', deliveryTime: 8, qualityScore: 88, costEfficiency: 85, reliability: 85 },
                                { supplier: 'Fornecedor Gamma', deliveryTime: 15, qualityScore: 78, costEfficiency: 92, reliability: 80 },
                            ],
                            kpiSummary: {
                                turnoverRate: 11.2,
                                stockAccuracy: 98.7,
                            ...
                            insights: [
                                {
                                    ...
                                    description: 'Estoque atual permite apenas 7 dias de operação baseado na demanda média.',
                                    impact: 'high',
    ...
    var exportReport = (0, react_1.useCallback)(function (options) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    type = options.type, _a = options.filters, filters = _a === void 0 ? {} : _a, _b = options.templateType, templateType = _b === void 0 ? 'detailed' : _b;
                ...
                case 2:
                    ...
                    filename = "inventory-analytics-".concat(templateType, "-").concat(timestamp, ".").concat(type);
                    ...
                    react_hot_toast_1.toast.success("Relat\u00F3rio ".concat(type.toUpperCase(), " exportado com sucesso!"));
                    return [3 /*break*/, 5];
                case 3:
                    error_3 = _c.sent();
                    ...
                    case 2:
                        ...
                        predictiveData = {
                            ...
                            stockRecommendations: [
                                { product: 'Produto A', currentStock: 150, recommendedStock: 280, reason: 'Aumento de demanda esperado' },
                                { product: 'Produto B', currentStock: 320, recommendedStock: 180, reason: 'Sazonalidade baixa' },
                            ],
                            riskAnalysis: [
                                { type: 'Ruptura de estoque', probability: 15, impact: 'Alto', products: ['Produto A', 'Material X'] },
                                { type: 'Excesso de estoque', probability: 8, impact: 'Médio', products: ['Produto D'] },
                            ],
                        };
    ...
    var generateCustomReport = (0, react_1.useCallback)(function (config) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, 1800); })
