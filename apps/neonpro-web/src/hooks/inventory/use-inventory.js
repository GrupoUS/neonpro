...
function useInventory(options) {
  ...
  var _a = options.enableRealTime,
    enableRealTime = _a === void 0 ? true : _a,
    _b = options.autoLoadData,
    autoLoadData = _b === void 0 ? true : _b,
    _c = options.alertRefreshInterval, // 30 seconds
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, inventory_1.updateStockLevel)(
                  itemId,
                  quantity,
                  movementType,
                  locationId,
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                (0, inventory_1.addScannedItem)(
                  sessionId,
                  barcodeValue,
                  scanResult.success ? "success" : "item_not_found",
                  (_a = scanResult.item) === null || _a === void 0 ? void 0 : _a.id,
