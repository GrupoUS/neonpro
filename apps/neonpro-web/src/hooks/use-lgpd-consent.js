...
function useLgpdConsent() {
    var _this = this;
    var _a = (0, react_1.useState)(null), consentData = _a[0], setConsentData = _a[1];
    var _b = (0, react_1.useState)(false), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(null), error = _c[0], setError = _c[1];
    // Record initial consent
    var recordConsent = (0, react_1.useCallback)(function (consent, patientId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    consentWithTimestamp = __assign(__assign({}, consent), { consentDate: new Date().toISOString(), consentVersion: '1.0' });
                    return [4 /*yield*/, fetch("/api/patients/".concat(patientId, "/lgpd/consent"), {
                            method: 'POST',
                            headers: {
    ...
    var revokeConsent = (0, react_1.useCallback)(function (patientId, consentTypes) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var updateConsent = (0, react_1.useCallback)(function (patientId, updates) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var logDataAccess = (0, react_1.useCallback)(function (patientId, dataFields, action) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch('/api/lgpd/audit', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
    ...
    var logDataModification = (0, react_1.useCallback)(function (patientId, dataFields, action) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var checkConsentValidity = (0, react_1.useCallback)(function (patientId, dataTypes) { return __awaiter(_this, void 0, void 0, function () {
        var response, result, err_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("/api/patients/".concat(patientId, "/lgpd/consent/check"), {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
    ...
    var getConsentHistory = (0, react_1.useCallback)(function (patientId) { return __awaiter(_this, void 0, void 0, function () {
        var response, result, err_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("/api/patients/".concat(patientId, "/lgpd/consent/history"))];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
    ...
    var exportPatientData = (0, react_1.useCallback)(function (patientId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 5, 6, 7]);
                    return [4 /*yield*/, fetch("/api/patients/".concat(patientId, "/lgpd/export"), {
                            method: 'GET',
                        })];
                case 2:
                    response = _a.sent();
    ...
    var deletePatientData = (0, react_1.useCallback)(function (patientId, confirmCode) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, 5, 6]);
                    return [4 /*yield*/, fetch("/api/patients/".concat(patientId, "/lgpd/delete"), {
                            method: 'DELETE',
                            headers: {
                                'Content-Type': 'application/json',
                            },
    ...
    var anonymizePatientData = (0, react_1.useCallback)(function (patientId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, 5, 6]);
                    return [4 /*yield*/, fetch("/api/patients/".concat(patientId, "/lgpd/anonymize"), {
                            method: 'POST',
                        })];
                case 2:
                    response = _a.sent();
