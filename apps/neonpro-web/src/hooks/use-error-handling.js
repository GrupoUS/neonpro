...
function useErrorHandling() {
    ...
    var createErrorContext = (0, react_1.useCallback)(function (component, action, metadata) {
        return {
            component: component,
            action: action,
            sessionId: sessionId(),
            ...
            metadata: metadata ? __assign(__assign({}, metadata), { sensitive_data_removed: true }) : undefined
        };
    }, [sessionId]);
    // Create standardized error following privacy-by-design principles
    var createError = (0, react_1.useCallback)(function (errorCode, context, customMessage, customDetails) {
        var template = ERROR_TEMPLATES[errorCode] || ERROR_TEMPLATES['SYSTEM_MAINTENANCE'];
        var error = __assign({ id: "err_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)), code: errorCode, title: template.title || 'Erro do Sistema', message: customMessage || template.message || 'Ocorreu um erro inesperado.', category: template.category || 'system', severity: template.severity || 'medium', suggestedActions: template.suggestedActions || ['Entre em contato com o suporte'], context: context, isUserFacing: true, requiresSupport: template.requiresSupport || false, helpUrl: template.helpUrl, canRetry: template.canRetry || false, retryDelay: template.retryDelay }, customDetails);
        return error;
    }, []);
    // Log error with LGPD compliance (no sensitive data)
    var logError = (0, react_1.useCallback)(function (error, originalError) { return __awaiter(_this, void 0, void 0, function () {
                ...
                case 1:
                    ...
                    logEntry = {
                        ...
                        technical_details: originalError ? {
                            ...
                            stack: (_a = originalError.stack) === null || _a === void 0 ? void 0 : _a.substring(0, 500) // Limited stack trace
                        } : null
                    };
    ...
    var handleError = (0, react_1.useCallback)(function (errorCode, component, action, originalError, metadata) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    setErrors(function (prev) { return __spreadArray(__spreadArray([], prev, true), [appError_1], false); });
                    // Show user-friendly toast notification
                    toast({
                        variant: appError_1.severity === 'critical' || appError_1.severity === 'high' ? 'destructive' : 'default',
                        ...
                        action: appError_1.canRetry ? {
                            ...
                            onClick: function () {
                                ...
                                setErrors(function (prev) { return prev.filter(function (e) { return e.id !== appError_1.id; }); });
                            }
                        } : undefined
                    });
    ...
    var handleApiError = (0, react_1.useCallback)(function (error, component, action, metadata) { return __awaiter(_this, void 0, void 0, function () {
        var errorCode;
        return __generator(this, function (_a) {
    ...
    var clearError = (0, react_1.useCallback)(function (errorId) {
        setErrors(function (prev) { return prev.filter(function (error) { return error.id !== errorId; }); });
    }, []);
    // Clear all errors
    ...
    var getErrorsByCategory = (0, react_1.useCallback)(function (category) {
        return errors.filter(function (error) { return error.category === category; });
    }, [errors]);
    // Check if there are critical errors requiring immediate attention
    var hasCriticalErrors = (0, react_1.useCallback)(function () {
        return errors.some(function (error) { return error.severity === 'critical'; });
    }, [errors]);
    return {
        // State
        errors: errors,
