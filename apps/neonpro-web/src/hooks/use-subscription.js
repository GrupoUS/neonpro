...
function SubscriptionProvider(_a) {
    ...
    var refreshSubscription = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    error_2 = _a.sent();
                    console.error("Error fetching subscription:", error_2);
                    setError("Erro de conexão");
                    return [3 /*break*/, 8];
                case 7:
                    setLoading(false);
...
function useSubscriptionContext() {
    var context = (0, react_1.useContext)(SubscriptionContext);
