...
function GlobalStateProvider(_a) {
    var children = _a.children, _b = _a.persistKeys, persistKeys = _b === void 0 ? [] : _b;
    var stateRef = (0, react_1.useRef)(new Map());
    var subscribersRef = (0, react_1.useRef)(new Map());
    var _c = (0, react_1.useState)({}), forceUpdate = _c[1];
    ...
    var setState = (0, react_1.useCallback)(function (key, value) {
    ...
    var clearState = (0, react_1.useCallback)(function (key) {
        ...
        var subscribers = subscribersRef.current.get(key);
        if (subscribers) {
            subscribers.forEach(function (callback) { return callback(undefined); });
        }
    }, [persistKeys]);
    var clearAllState = (0, react_1.useCallback)(function () {
...
function useGlobalState(key, initialValue) {
    ...
    var getState = context.getState, setState = context.setState, subscribe = context.subscribe;
    var _a = (0, react_1.useState)(function () {
        var existing = getState(key);
        return existing !== undefined ? existing : initialValue;
    }), localState = _a[0], setLocalState = _a[1];
    ...
    var setGlobalState = (0, react_1.useCallback)(function (value) {
        setState(key, value);
    }, [key, setState]);
...
function useOperationState(operationKey) {
    var _a = useLoadingStates(), loadingStates = _a[0], setLoadingStates = _a[1];
    var _b = useErrorStates(), errorStates = _b[0], setErrorStates = _b[1];
    ...
    return {
        isLoading: (loadingStates === null || loadingStates === void 0 ? void 0 : loadingStates[operationKey]) || false,
        error: (errorStates === null || errorStates === void 0 ? void 0 : errorStates[operationKey]) || null,
...
function useTemporaryState(key, initialValue, timeoutMs) {
    ...
    var _a = useGlobalState(key, initialValue), state = _a[0], setState = _a[1];
    var timeoutRef = (0, react_1.useRef)();
    var setTemporaryState = (0, react_1.useCallback)(function (value) {
        setState(value);
