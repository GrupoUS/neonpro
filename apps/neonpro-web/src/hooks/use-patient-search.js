...
var usePatientSearch = (patients, options) => {
  ...
  var _a = options.debounceMs,
    debounceMs = _a === void 0 ? 300 : _a,
    _b = options.minSearchLength,
    minSearchLength = _b === void 0 ? 2 : _b,
    _c = options.enableFuzzySearch,
    enableFuzzySearch = _c === void 0 ? true : _c,
    _d = options.maxResults,
    maxResults = _d === void 0 ? 100 : _d,
    _e = options.caseSensitive,
    caseSensitive = _e === void 0 ? false : _e;
  // State management
  var _f = (0, react_1.useState)(""),
    searchTerm = _f[0],
    setSearchTerm = _f[1];
  var _g = (0, react_1.useState)(""),
    debouncedSearchTerm = _g[0],
    setDebouncedSearchTerm = _g[1];
