...
export function useLgpdConsent(): UseLgpdConsentReturn {
  ...
  const updateConsent = useCallback(async (
    patientId: string, 
    updates: Partial<LgpdConsentData>
  ): Promise<boolean> => {
    setIsLoading(true)
    setError(null)
  ...
  const checkConsentValidity = useCallback(async (
    patientId: string, 
    dataTypes: string[]
  ): Promise<boolean> => {
    try {
  ...
  const exportPatientData = useCallback(async (patientId: string): Promise<any> => {
    setIsLoading(true)
    setError(null)
  ...
  const deletePatientData = useCallback(async (
    patientId: string, 
    confirmCode: string
  ): Promise<boolean> => {
    setIsLoading(true)
  ...
  const anonymizePatientData = useCallback(async (patientId: string): Promise<boolean> => {
    setIsLoading(true)
    setError(null)
