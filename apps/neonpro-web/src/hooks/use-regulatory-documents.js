...
function useRegulatoryDocuments(options) {
          ...
          switch (_a.label) {
            ...
            case 2:
              ...
              if (options.page && options.page > 1) {
                ...
                setDocuments((prev) =>
                  __spreadArray(__spreadArray([], prev, true), data_1.documents, true),
                );
              } else {
  ...
  var createDocument = (0, react_1.useCallback)(
    (data) =>
      __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 4:
              ...
              // Add to local state
              setDocuments((prev) => __spreadArray([newDocument_1], prev, true));
  ...
  var updateDocument = (0, react_1.useCallback)(
    (id, data) =>
      __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 4:
              ...
              // Update local state
              setDocuments((prev) => prev.map((doc) => (doc.id === id ? updatedDocument_1 : doc)));
  ...
  var deleteDocument = (0, react_1.useCallback)(
    (id) =>
      __awaiter(this, void 0, void 0, function () {
