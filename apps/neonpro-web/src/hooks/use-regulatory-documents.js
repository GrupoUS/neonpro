...
function useRegulatoryDocuments(options) {
  ...
  var _e = (0, react_1.useState)(null),
    pagination = _e[0],
    setPagination = _e[1];
  var buildQuery = (0, react_1.useCallback)(
    function () {
  ...
  var fetchDocuments = (0, react_1.useCallback)(
    function () {
            ...
            case 2:
              ...
              if (options.page && options.page > 1) {
                ...
                setDocuments(function (prev) {
                  return __spreadArray(__spreadArray([], prev, true), data_1.documents, true);
                });
              } else {
  ...
  var createDocument = (0, react_1.useCallback)(function (data) {
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/regulatory-documents", {
                method: "POST",
                headers: {
          ...
          case 4:
            ...
            // Add to local state
            setDocuments(function (prev) {
              return __spreadArray([newDocument_1], prev, true);
            });
  ...
  var updateDocument = (0, react_1.useCallback)(function (id, data) {
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/regulatory-documents/".concat(id), {
                method: "PUT",
                headers: {
                  "Content-Type": "application/json",
                },
          ...
          case 4:
            ...
            setDocuments(function (prev) {
              return prev.map(function (doc) {
                return doc.id === id ? updatedDocument_1 : doc;
              });
            });
  ...
  var deleteDocument = (0, react_1.useCallback)(function (id) {
    return __awaiter(_this, void 0, void 0, function () {
  ...
  var loadMore = (0, react_1.useCallback)(
    ...
    [
      fetchDocuments,
      pagination === null || pagination === void 0 ? void 0 : pagination.hasNextPage,
    ],
  );
  ...
  return {
    ...
    loadMore: loadMore,
    hasMore:
      (_a = pagination === null || pagination === void 0 ? void 0 : pagination.hasNextPage) !==
        null && _a !== void 0
        ? _a
        : false,
  };
