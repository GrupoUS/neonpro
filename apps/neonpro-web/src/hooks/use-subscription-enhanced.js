...
function useSubscription(userId, config) {
              ...
              case 1:
                ...
                if (!backgroundUpdate) {
                  setState(function (prev) {
                    return __assign(__assign({}, prev), { isFetching: true, error: null });
                  });
                }
                timerId =
                ...
                if (
                  !(
                    (globalState === null || globalState === void 0
                      ? void 0
                      : globalState.promise) && !backgroundUpdate
                  )
                )
                  return [3 /*break*/, 3];
  ...
  var invalidate = (0, react_1.useCallback)(
    function () {
      ...
      setState(function (prev) {
        return __assign(__assign({}, prev), { isStale: true });
      });
    },
    [cacheKey],
  );
