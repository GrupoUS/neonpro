...
function useSubscription(userId, config) {
    ...
    var mergedConfig = (0, react_1.useMemo)(function () { return (__assign(__assign({}, defaultConfig), config)); }, [config]);
    ...
    var _c = (0, react_1.useState)(userId || null), currentUserId = _c[0], setCurrentUserId = _c[1];
    ...
    var cacheKey = (0, react_1.useMemo)(function () {
        return currentUserId ? "subscription_".concat(currentUserId) : null;
    }, [currentUserId]);
    // Memoized global state key
    var globalStateKey = (0, react_1.useMemo)(function () {
        return currentUserId ? "hook_".concat(currentUserId) : null;
    }, [currentUserId]);
    /**
     * Fetch subscription data with performance optimizations
     */
    var fetchSubscription = (0, react_1.useCallback)(function () {
        var args_1 = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args_1[_i] = arguments[_i];
        }
        return __awaiter(_this, __spreadArray([], args_1, true), void 0, function (force, backgroundUpdate) {
            var timerId, startTime, globalState, result_1, fromCache_1, isStale_1, endTime_1, duration_1, fetchPromise, globalState, globalState, endTime, duration_2, error_1, fetchError_1, globalState;
            if (force === void 0) { force = false; }
            if (backgroundUpdate === void 0) { backgroundUpdate = false; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!backgroundUpdate) {
                            setState(function (prev) { return (__assign(__assign({}, prev), { isFetching: true, error: null })); });
                        }
                        timerId = subscription_performance_monitor_1.subscriptionPerformanceMonitor.startTimer("hook_fetch_".concat(currentUserId));
                        startTime = performance.now();
                        if (!(!force && globalStateKey)) return [3 /*break*/, 3];
                        globalState = globalHookState.get(globalStateKey);
                        if (!((globalState === null || globalState === void 0 ? void 0 : globalState.promise) && !backgroundUpdate)) return [3 /*break*/, 3];
                    ...
                    case 4:
                        ...
                        if (result_1) {
                            fromCache_1 = true;
                            isStale_1 = result_1.performance &&
                            ...
                            if (!isStale_1 || backgroundUpdate) {
                                ...
                                // Update state
                                setState(function (prev) { return (__assign(__assign({}, prev), { data: result_1, isLoading: false, isFetching: false, isError: false, error: null, lastUpdated: Date.now(), cacheHit: true, isStale: isStale_1 || false, performance: __assign(__assign({}, prev.performance), { lastFetchTime: duration_1, cacheHitRate: (prev.performance.cacheHitRate * prev.performance.totalFetches + 1) /
                    ...
                    case 5:
                        ...
                        fetchPromise = subscription_query_optimizer_1.subscriptionQueryOptimizer.getSubscriptionStatus(currentUserId, {
                    ...
                    case 6:
                        ...
                        setState(function (prev) {
                            ...
                            var newAverageResponseTime = (prev.performance.averageResponseTime * prev.performance.totalFetches + duration_2) / newTotalFetches;
                            return __assign(__assign({}, prev), { data: result_1, isLoading: false, isFetching: false, isError: false, error: null, lastUpdated: Date.now(), cacheHit: fromCache_1, isStale: false, performance: {
                                    lastFetchTime: duration_2,
                                    totalFetches: newTotalFetches,
                                    cacheHitRate: fromCache_1 ?
                                        (prev.performance.cacheHitRate * prev.performance.totalFetches + 1) / newTotalFetches :
                                        (prev.performance.cacheHitRate * prev.performance.totalFetches) / newTotalFetches,
                                    averageResponseTime: newAverageResponseTime,
                                } });
                        });
                        // Trigger status change callback
                        if ((result_1 === null || result_1 === void 0 ? void 0 : result_1.status) && mergedConfig.onStatusChange) {
                    ...
                    case 7:
                        ...
                        if (performanceTimerRef.current) {
                            subscription_performance_monitor_1.subscriptionPerformanceMonitor.endTimer(performanceTimerRef.current, false);
                        }
                        // Don't update state if request was aborted
                        if (fetchError_1.name === 'AbortError') {
                            return [2 /*return*/, null];
                        }
                        setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, isFetching: false, isError: true, error: fetchError_1, lastUpdated: Date.now() })); });
     ...
     */
    var fetchWithRetry = (0, react_1.useCallback)(function () {
        var args_1 = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args_1[_i] = arguments[_i];
        }
        return __awaiter(_this, __spreadArray([], args_1, true), void 0, function (attempt, force, backgroundUpdate) {
            var error_2, delay;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (attempt < mergedConfig.retryAttempts) {
                            delay = mergedConfig.retryDelay * Math.pow(2, attempt - 1) // Exponential backoff
                            ;
    ...
    var refetch = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, fetchWithRetry(1, true, false)];
        });
    }); }, [fetchWithRetry]);
    /**
     * Invalidate cache
    ...
    var invalidate = (0, react_1.useCallback)(function () {
        ...
        setState(function (prev) { return (__assign(__assign({}, prev), { isStale: true })); });
    }, [cacheKey]);
    /**
     * Prefetch subscription data
     */
    var prefetch = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
     ...
     */
    var getCacheTTL = (0, react_1.useCallback)(function (strategy) {
        var _a;
        switch (strategy) {
            case 'aggressive':
            ...
            case 'adaptive':
                return ((_a = state.data) === null || _a === void 0 ? void 0 : _a.hasAccess) ? 5 * 60 * 1000 : 1 * 60 * 1000; // 5 min if active, 1 min if not
            default:
    ...
    (0, react_1.useEffect)(function () {
        if (!mergedConfig.enableBackgroundSync || mergedConfig.refetchInterval <= 0)
            return;
        backgroundSyncRef.current = setInterval(function () {
    ...
    var derivedValues = (0, react_1.useMemo)(function () {
        var data = state.data;
        ...
        var canAccessFeature = function (feature) {
            var _a;
            if (!hasAccess || !((_a = subscription === null || subscription === void 0 ? void 0 : subscription.plan) === null || _a === void 0 ? void 0 : _a.features))
                return false;
            return subscription.plan.features.includes(feature);
        };
        // Usage limit check
        var getUsageLimit = function (resource) {
    ...
    return __assign(__assign(__assign({}, state), derivedValues), { refetch: refetch, invalidate: invalidate, prefetch: prefetch });
}
...
function useSubscriptionStatus(userId) {
    ...
    }), status = _a.status, isLoading = _a.isLoading, isActive = _a.isActive, refetch = _a.refetch;
...
function useSubscriptionAccess(userId) {
    var _a = useSubscription(userId, {
        enableBackgroundSync: true,
        cacheStrategy: 'adaptive',
    }), hasAccess = _a.hasAccess, isLoading = _a.isLoading, canAccessFeature = _a.canAccessFeature, refetch = _a.refetch;
    return { hasAccess: hasAccess, isLoading: isLoading, canAccessFeature: canAccessFeature, refetch: refetch };
}
function useSubscriptionLimits(userId) {
    var _a = useSubscription(userId, {
        enableRealtime: true,
        cacheStrategy: 'aggressive',
    }), getUsageLimit = _a.getUsageLimit, subscription = _a.subscription, isLoading = _a.isLoading, refetch = _a.refetch;
    return { getUsageLimit: getUsageLimit, subscription: subscription, isLoading: isLoading, refetch: refetch };
}
