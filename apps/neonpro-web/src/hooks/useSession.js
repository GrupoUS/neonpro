...
function useSession() {
    ...
    var _c = (0, react_1.useState)([]), securityEvents = _c[0], setSecurityEvents = _c[1];
    var _d = (0, react_1.useState)([]), devices = _d[0], setDevices = _d[1];
    var _e = (0, react_1.useState)(null), analytics = _e[0], setAnalytics = _e[1];
    ...
    // SESSION MANAGEMENT
    // ============================================================================
    var createSession = (0, react_1.useCallback)(function (request) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var updateSession = (0, react_1.useCallback)(function (updates) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    logger_1.logger.info('Session updated via hook', { session_id: session.id, updates: updates });
                    return [3 /*break*/, 4];
                case 3:
                    err_2 = _a.sent();
                    errorMessage = err_2 instanceof Error ? err_2.message : 'Failed to update session';
                    setError(errorMessage);
                    logger_1.logger.error('Session update failed', { error: err_2, session_id: session.id });
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    }); }, [session]);
    var terminateSession = (0, react_1.useCallback)(function () {
        var args_1 = [];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        logger_1.logger.info('Session terminated via hook', { session_id: session.id, reason: reason });
                        return [3 /*break*/, 5];
                    case 3:
                        err_3 = _a.sent();
    ...
    var terminateAllSessions = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setIsLoading(true);
                    return [4 /*yield*/, session_1.sessionManager.supabase
                            .from('user_sessions')
                            .select('id')
                ...
                case 2:
                    ...
                    return [4 /*yield*/, Promise.all(activeSessions.map(function (s) { return session_1.sessionManager.terminateSession(s.id, 'terminate_all_sessions'); }))];
                case 3:
                    // Terminate all sessions
                    _a.sent();
                    _a.label = 4;
                case 4:
                    ...
                    // Redirect to login
                    router.push('/auth/login');
                    logger_1.logger.info('All sessions terminated via hook', { user_id: session.user_id });
                    return [3 /*break*/, 7];
                case 5:
                    err_4 = _a.sent();
                    errorMessage = err_4 instanceof Error ? err_4.message : 'Failed to terminate all sessions';
                    setError(errorMessage);
                    toast({
    ...
    var refreshSession = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    err_5 = _a.sent();
                    logger_1.logger.error('Session refresh failed', { error: err_5, session_id: session.id });
    ...
    var extendSession = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var err_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    err_6 = _a.sent();
                    logger_1.logger.error('Session extension failed', { error: err_6, session_id: session.id });
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    ...
    // SECURITY MONITORING
    // ============================================================================
    var reportSuspiciousActivity = (0, react_1.useCallback)(function (eventType, details) { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, session_1.sessionManager.supabase
                            ...
                            severity: 'medium',
                            details: __assign(__assign({}, details), { reported_by: 'user', timestamp: new Date().toISOString() }),
                ...
                case 4:
                    err_7 = _a.sent();
                    errorMessage = err_7 instanceof Error ? err_7.message : 'Failed to report suspicious activity';
                    setError(errorMessage);
                    toast({
                        title: "Report Failed",
                        description: errorMessage,
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, session_1.sessionManager.supabase
                            .from('user_sessions')
                            .select('id')
                            .eq('device_fingerprint', ((_a = devices.find(function (d) { return d.id === deviceId; })) === null || _a === void 0 ? void 0 : _a.device_fingerprint))
                            .eq('is_active', true)];
                case 2:
                    deviceSessions = (_b.sent()).data;
                    if (!deviceSessions) return [3 /*break*/, 4];
                    return [4 /*yield*/, Promise.all(deviceSessions.map(function (s) { return session_1.sessionManager.terminateSession(s.id, 'device_blocked'); }))];
                case 3:
                    _b.sent();
                    _b.label = 4;
                case 4:
    ...
    // DATA LOADING
    // ============================================================================
    var loadSecurityEvents = (0, react_1.useCallback)(function (sessionId) { return __awaiter(_this, void 0, void 0, function () {
        var events, err_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    err_10 = _a.sent();
                    logger_1.logger.error('Failed to load security events', { error: err_10, session_id: sessionId });
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
    }); }, []);
    var loadUserDevices = (0, react_1.useCallback)(function (userId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_11 = _a.sent();
                    logger_1.logger.error('Failed to load user devices', { error: err_11, user_id: userId });
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
    }); }, []);
    var loadSessionAnalytics = (0, react_1.useCallback)(function (userId) { return __awaiter(_this, void 0, void 0, function () {
        var thirtyDaysAgo, sessions, analytics_1, completedSessions, totalDuration, securityCount, err_12;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 1:
                    ...
                    analytics_1 = {
                        ...
                        active_sessions: sessions.filter(function (s) { return s.is_active; }).length,
                        average_duration_minutes: 0,
                        unique_devices: new Set(sessions.map(function (s) { return s.device_fingerprint; })).size,
                        unique_locations: new Set(sessions.map(function (s) { return s.ip_address; })).size,
                        security_events_count: 0,
                        last_login: sessions.length > 0 ? sessions[0].created_at : null,
                        most_used_device: '',
                        risk_score: 0
                    };
                    completedSessions = sessions.filter(function (s) { return !s.is_active; });
                    if (completedSessions.length > 0) {
                        ...
                        analytics_1.average_duration_minutes = Math.round(totalDuration / completedSessions.length / 60000);
                    }
                    return [4 /*yield*/, session_1.sessionManager.supabase
                            .from('session_security_events')
                ...
                case 2:
                    ...
                    analytics_1.risk_score = Math.min(100, (analytics_1.security_events_count * 10) +
                ...
                case 4:
                    err_12 = _a.sent();
                    logger_1.logger.error('Failed to load session analytics', { error: err_12, user_id: userId });
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
    ...
    // SESSION MONITORING
    // ============================================================================
    var startSessionMonitoring = (0, react_1.useCallback)(function (sessionData) {
    ...
    (0, react_1.useEffect)(function () {
        if (session) {
            var refreshInterval_1 = setInterval(function () {
                refreshSession();
            }, 10 * 60 * 1000); // Every 10 minutes
            return function () { return clearInterval(refreshInterval_1); };
        }
...
function useSecurityEvents(sessionId) {
    ...
    var loadEvents = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    err_13 = _b.sent();
                    errorMessage = err_13 instanceof Error ? err_13.message : 'Failed to load security events';
                    setError(errorMessage);
                    logger_1.logger.error('Failed to load security events', { error: err_13, session_id: sessionId });
                    return [3 /*break*/, 5];
                case 4:
                    setIsLoading(false);
                    return [7 /*endfinally*/];
    ...
    var resolveEvent = (0, react_1.useCallback)(function (eventId) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var dismissEvent = (0, react_1.useCallback)(function (eventId) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var getEventsByType = (0, react_1.useCallback)(function (eventType) {
        return events.filter(function (event) { return event.event_type === eventType; });
    }, [events]);
    var getUnresolvedEvents = (0, react_1.useCallback)(function () {
        return events.filter(function (event) { return !event.resolved; });
    }, [events]);
    var getCriticalEvents = (0, react_1.useCallback)(function () {
        return events.filter(function (event) { return event.severity === 'critical' && !event.resolved; });
    }, [events]);
