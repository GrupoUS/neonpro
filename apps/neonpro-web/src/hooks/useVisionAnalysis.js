...
function useVisionAnalysis() {
   ...
   */
  var startAnalysis = (0, react_1.useCallback)(function (
    beforeImageUrl,
    afterImageUrl,
    patientId,
    treatmentType,
        ...
        switch (_a.label) {
          case 0:
            setState(function (prev) {
              return __assign(__assign({}, prev), { isAnalyzing: true, error: null, progress: 0 });
            });
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
   ...
   */
  var loadAnalysisHistory = (0, react_1.useCallback)(function (patientId) {
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            history_1 = _a.sent();
            setState(function (prev) {
              return __assign(__assign({}, prev), { analysisHistory: history_1 });
            });
          ...
          case 2:
            ...
            setState(function (prev) {
              return __assign(__assign({}, prev), { error: errorMessage_2 });
            });
  ...
  var clearCurrentAnalysis = (0, react_1.useCallback)(function () {
    setState(function (prev) {
      return __assign(__assign({}, prev), { currentAnalysis: null, progress: 0 });
    });
  }, []);
  /**
   * Clear error state
   ...
   */
  var shareAnalysis = (0, react_1.useCallback)(function (analysisId, options) {
    return __awaiter(_this, void 0, void 0, function () {
            ...
            return [
              ...
              fetch("/api/vision/share", {
                ...
                body: JSON.stringify({
                  ...
                  includeMetrics:
                    (_e =
                      options === null || options === void 0 ? void 0 : options.includeMetrics) !==
                      null && _e !== void 0
                      ? _e
                      : true,
                }),
