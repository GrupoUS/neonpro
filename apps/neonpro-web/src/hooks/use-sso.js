...
function useSSO(options) {
    ...
    var _a = options.autoRefresh, autoRefresh = _a === void 0 ? true : _a, _b = options.refreshThreshold, refreshThreshold = _b === void 0 ? 5 : _b, onSessionExpired = options.onSessionExpired, onError = options.onError;
    var router = (0, navigation_1.useRouter)();
    var _c = (0, auth_helpers_nextjs_1.useUser)(), currentUser = _c.user, refreshUser = _c.refreshUser;
     ...
     */
    var loadProviders = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    providers_1 = _a.sent();
                    setState(function (prev) { return (__assign(__assign({}, prev), { availableProviders: providers_1 })); });
                    _a.label = 3;
     ...
     */
    var loadSession = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch('/api/auth/sso/session', {
                            credentials: 'include',
                        })];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    session_1 = _a.sent();
                    setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, isAuthenticated: true, session: session_1, user: session_1.userInfo, error: null })); });
                    return [3 /*break*/, 4];
                case 3:
                    setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, isAuthenticated: false, session: null, user: null })); });
                    _a.label = 4;
                case 4: return [3 /*break*/, 6];
                case 5:
                    error_2 = _a.sent();
                    logger_1.logger.error('Failed to load SSO session', { error: error_2.message });
                    setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, isAuthenticated: false, session: null, user: null, error: {
     ...
     */
    var signInWithSSO = (0, react_1.useCallback)(function (providerId_1) {
        var args_1 = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args_1[_i - 1] = arguments[_i];
        }
        return __awaiter(_this, __spreadArray([providerId_1], args_1, true), void 0, function (providerId, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        params = new URLSearchParams(__assign(__assign(__assign(__assign({ provider: providerId }, (options.redirectTo && { redirect_to: options.redirectTo })), (options.loginHint && { login_hint: options.loginHint })), (options.domainHint && { domain_hint: options.domainHint })), (options.prompt && { prompt: options.prompt })));
                    ...
                    case 4:
                        ...
                        logger_1.logger.info('SSO: Redirecting to provider', { providerId: providerId, authUrl: authUrl });
                        // Redirect to SSO provider
                        window.location.href = authUrl;
                        return [3 /*break*/, 6];
                    case 5:
                        error_3 = _a.sent();
                        logger_1.logger.error('SSO sign-in failed', { providerId: providerId, error: error_3.message });
                        ssoError_1 = {
                            code: 'SIGN_IN_FAILED',
                            message: error_3.message,
                            timestamp: new Date(),
                        };
                        setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, error: ssoError_1 })); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: true })); });
                    return [4 /*yield*/, fetch('/api/auth/sso/logout', {
                            method: 'POST',
                            credentials: 'include',
                        })];
                case 1:
                    response = _a.sent();
                    if (!response.ok) return [3 /*break*/, 3];
                    setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, isAuthenticated: false, session: null, user: null, error: null })); });
                ...
                case 2:
                    ...
                    return [3 /*break*/, 4];
                case 3: throw new Error('Sign-out failed');
                case 4: return [3 /*break*/, 6];
                case 5:
                    error_4 = _a.sent();
                    ...
                    setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, error: ssoError_2 })); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!state.session)
                        return [2 /*return*/];
                    return [4 /*yield*/, fetch('/api/auth/sso/refresh', {
                            method: 'POST',
                            credentials: 'include',
                        })];
                case 1:
                ...
                case 2:
                    session_2 = _a.sent();
                    setState(function (prev) { return (__assign(__assign({}, prev), { session: session_2, user: session_2.userInfo, error: null })); });
                ...
                case 4:
                    // Session refresh failed, sign out
                    _a.sent();
                    onSessionExpired === null || onSessionExpired === void 0 ? void 0 : onSessionExpired();
                    _a.label = 5;
    ...
    (0, react_1.useEffect)(function () {
        var handleCallback = function () { return __awaiter(_this, void 0, void 0, function () {
            var urlParams, code, state, error, errorDescription, ssoError_3, response, session_3, redirectTo, errorData, error_6, ssoError_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (error) {
                            ...
                            logger_1.logger.error('SSO callback error', { error: error, errorDescription: errorDescription });
                            ssoError_3 = {
                                code: 'CALLBACK_ERROR',
                                message: errorDescription || error,
                                timestamp: new Date(),
                            };
                            setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, error: ssoError_3 })); });
                    ...
                    case 1:
                        _a.trys.push([1, 8, , 9]);
                        setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: true })); });
                        return [4 /*yield*/, fetch('/api/auth/sso/callback', {
                                method: 'POST',
                                headers: {
                    ...
                    case 3:
                        session_3 = _a.sent();
                        setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, isAuthenticated: true, session: session_3, user: session_3.userInfo, error: null })); });
                        // Refresh user context
                        return [4 /*yield*/, refreshUser()];
                    case 4:
                        // Refresh user context
                    ...
                    case 8:
                        ...
                        setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: false, error: ssoError_4 })); });
    ...
    return __assign(__assign({}, state), { signInWithSSO: signInWithSSO, signOut: signOut, refreshSession: refreshSession, clearError: clearError, getDomainProvider: getDomainProvider });
}
/**
 * Hook for checking if user has SSO session
 */
function useSSOSession() {
    var _a = useSSO({ autoRefresh: false }), isAuthenticated = _a.isAuthenticated, session = _a.session, user = _a.user;
    return {
...
function useSSOProviders() {
    ...
    return {
        ...
        getProvider: function (id) { return availableProviders.find(function (p) { return p.id === id; }); },
        isProviderEnabled: function (id) { return availableProviders.some(function (p) { return p.id === id && p.enabled; }); },
    };
}
