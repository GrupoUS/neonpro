...
function useAlternativeSlots() {
  ...
  var _d = (0, react_1.useState)(null),
    selectedSuggestion = _d[0],
    setSelectedSuggestion = _d[1];
  var _e = (0, react_1.useState)(null),
    searchMetadata = _e[0],
    setSearchMetadata = _e[1];
  ...
  var selectSuggestion = (0, react_1.useCallback)(function (suggestion) {
    ...
    sonner_1.toast.success("Horário alternativo selecionado", {
      description: ""
        .concat(suggestion.formatted_date, " \u00E0s ")
        .concat(suggestion.formatted_time),
      duration: 3000,
    });
  }, []);
  return {
...
function formatAlternativeSlot(slot) {
  var dayName = new Intl.DateTimeFormat("pt-BR", { weekday: "long" }).format(
...
function filterSuggestionsWithDayjs(suggestions, filters) {
  return suggestions.filter(function (suggestion) {
    ...
    if (filters.minTime) {
      ...
      var suggestionTime = (0, dayjs_1.default)(
        "1970-01-01 ".concat(suggestionDayjs.format("HH:mm")),
      );
