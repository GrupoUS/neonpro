...
function useAppointmentFilters() {
    ...
    var parseFiltersFromURL = (0, react_1.useCallback)(function () {
        ...
        var date_from = searchParams.get('date_from') ? new Date(searchParams.get('date_from')) : undefined;
    ...
    var updateURL = (0, react_1.useCallback)(function (newFilters) {
        var _a;
        ...
        var newURL = "".concat(window.location.pathname).concat(params.toString() ? "?".concat(params.toString()) : '');
    ...
    var getAPIQueryParams = (0, react_1.useMemo)(function () {
        var _a;
        var params = {};
        if (filters.professional_id)
