...
function useConflictPrevention(_a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, _c = _b.debounceMs, debounceMs = _c === void 0 ? 300 : _c, _d = _b.enableRealTime, enableRealTime = _d === void 0 ? true : _d;
    // State management
    var _e = (0, react_1.useState)(false), isValidating = _e[0], setIsValidating = _e[1];
    var _f = (0, react_1.useState)(null), lastValidation = _f[0], setLastValidation = _f[1];
    var _g = (0, react_1.useState)([]), conflicts = _g[0], setConflicts = _g[1];
    var _h = (0, react_1.useState)([]), warnings = _h[0], setWarnings = _h[1];
    var _j = (0, react_1.useState)([]), alternativeSlots = _j[0], setAlternativeSlots = _j[1];
    var _k = (0, react_1.useState)(false), isAvailable = _k[0], setIsAvailable = _k[1];
    ...
    var generateRequestKey = function (request) {
        return "".concat(request.professional_id, "-").concat(request.service_type_id, "-").concat(request.start_time, "-").concat(request.end_time);
    };
    // Main validation function
    var validateSlot = (0, react_1.useCallback)(function (request) { return __awaiter(_this, void 0, void 0, function () {
        var requestKey;
        var _this = this;
        return __generator(this, function (_a) {
            ...
            if (currentRequestRef.current === requestKey && isValidating) {
                return [2 /*return*/, (lastValidation || {
                        success: false,
                        available: false,
                        conflicts: [],
                        warnings: [],
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    debounceTimeoutRef.current = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, fetch("/api/appointments/validate-slot", {
                                            method: "POST",
                                            headers: {
                                ...
                                case 5:
                                    ...
                                    errorResponse = {
                                        ...
                                        validation_details: {
                                            ...
                                            duration_minutes: Math.round((new Date(request.end_time).getTime() -
    ...
    var hasWarnings = warnings.length > 0 || conflicts.some(function (c) { return c.severity === "warning"; });
    var getConflictsByType = (0, react_1.useCallback)(function (type) {
        return conflicts.filter(function (conflict) { return conflict.type === type; });
    }, [conflicts]);
    var getSuggestedSlots = (0, react_1.useCallback)(function (limit) {
...
function useQuickAvailabilityCheck() {
    var _this = this;
    var _a = (0, react_1.useState)(false), isChecking = _a[0], setIsChecking = _a[1];
    var checkAvailability = (0, react_1.useCallback)(function (professionalId, serviceTypeId, startTime, endTime, excludeAppointmentId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setIsChecking(true);
                    params = new URLSearchParams(__assign({ professional_id: professionalId, service_type_id: serviceTypeId, start_time: startTime, end_time: endTime }, (excludeAppointmentId && {
