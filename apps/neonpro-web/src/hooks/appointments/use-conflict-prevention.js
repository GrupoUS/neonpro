...
function useConflictPrevention(_a) {
  ...
  var generateRequestKey = (request) =>
    ""
  ...
  var hasWarnings = warnings.length > 0 || conflicts.some((c) => c.severity === "warning");
  var getConflictsByType = (0, react_1.useCallback)(
    (type) => conflicts.filter((conflict) => conflict.type === type),
    [conflicts],
  );
...
function useQuickAvailabilityCheck() {
  var _a = (0, react_1.useState)(false),
    isChecking = _a[0],
    setIsChecking = _a[1];
  var checkAvailability = (0, react_1.useCallback)(
    (professionalId, serviceTypeId, startTime, endTime, excludeAppointmentId) =>
      __awaiter(this, void 0, void 0, function () {
