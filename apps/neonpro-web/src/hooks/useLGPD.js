...
function useLGPDDashboard() {
    ...
    var fetchMetrics = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
...
function useConsentManagement() {
    ...
    var fetchConsents = (0, react_1.useCallback)(function (filters) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var updateConsent = (0, react_1.useCallback)(function (consentData) { return __awaiter(_this, void 0, void 0, function () {
        var response, data, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, fetch('/api/lgpd/consent', {
                            method: 'POST',
                            headers: {
    ...
    var withdrawConsent = (0, react_1.useCallback)(function (consentId) { return __awaiter(_this, void 0, void 0, function () {
        var response, err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function useDataSubjectRights() {
    ...
    var _b = (0, react_1.useState)(false), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(null), error = _c[0], setError = _c[1];
    var fetchRequests = (0, react_1.useCallback)(function (filters) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var createRequest = (0, react_1.useCallback)(function (requestData) { return __awaiter(_this, void 0, void 0, function () {
        var response, data, err_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, fetch('/api/lgpd/data-subject-rights', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
    ...
    var updateRequest = (0, react_1.useCallback)(function (requestId, updateData) { return __awaiter(_this, void 0, void 0, function () {
...
function useBreachManagement() {
    var _this = this;
    var _a = (0, react_1.useState)([]), breaches = _a[0], setBreaches = _a[1];
    var _b = (0, react_1.useState)(false), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(null), error = _c[0], setError = _c[1];
    var fetchBreaches = (0, react_1.useCallback)(function (filters) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var reportBreach = (0, react_1.useCallback)(function (breachData) { return __awaiter(_this, void 0, void 0, function () {
        var response, data, err_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, fetch('/api/lgpd/breach', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
    ...
    var updateBreach = (0, react_1.useCallback)(function (breachId, updateData) { return __awaiter(_this, void 0, void 0, function () {
...
function useAuditTrail() {
    ...
    var _b = (0, react_1.useState)(false), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(null), error = _c[0], setError = _c[1];
    var fetchEvents = (0, react_1.useCallback)(function (filters) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var exportEvents = (0, react_1.useCallback)(function (format, filters) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    a.href = url;
                    a.download = "audit-trail-".concat(new Date().toISOString().split('T')[0], ".").concat(format);
...
function useComplianceAssessment() {
    var _this = this;
    var _a = (0, react_1.useState)([]), assessments = _a[0], setAssessments = _a[1];
    var _b = (0, react_1.useState)(false), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(null), error = _c[0], setError = _c[1];
    var fetchAssessments = (0, react_1.useCallback)(function (filters) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var createAssessment = (0, react_1.useCallback)(function (assessmentData) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var runAutomatedAssessment = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
...
function useConsentBanner() {
    ...
    var _b = (0, react_1.useState)([]), userConsents = _b[0], setUserConsents = _b[1];
    var _c = (0, react_1.useState)(false), isLoading = _c[0], setIsLoading = _c[1];
    var _d = (0, react_1.useState)(null), error = _d[0], setError = _d[1];
    var user = (0, auth_helpers_react_1.useUser)();
    var supabase = (0, auth_helpers_nextjs_1.createClientComponentClient)();
    var fetchConsentPurposes = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var fetchUserConsents = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var updateUserConsent = (0, react_1.useCallback)(function (purposeId, granted) { return __awaiter(_this, void 0, void 0, function () {
        var response, err_18;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    // Refresh user consents
                    _a.sent();
                    sonner_1.toast.success(granted ? 'Consentimento concedido' : 'Consentimento retirado');
                    return [3 /*break*/, 4];
                case 3:
                    err_18 = _a.sent();
                    setError(err_18);
