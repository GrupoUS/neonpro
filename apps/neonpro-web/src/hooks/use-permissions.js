...
function usePermissions(options) {
    ...
    var _a = options.realtime, realtime = _a === void 0 ? true : _a, _b = options.cacheDuration, cacheDuration = _b === void 0 ? 5 * 60 * 1000 : _b, // 5 minutes
    ...
    // Dependencies
    var _e = (0, use_session_1.useSession)(), user = _e.user, session = _e.session;
    ...
    var _h = (0, react_1.useState)(null), userContext = _h[0], setUserContext = _h[1];
    var _j = (0, react_1.useState)([]), effectivePermissions = _j[0], setEffectivePermissions = _j[1];
    var _k = (0, react_1.useState)(null), lastUpdated = _k[0], setLastUpdated = _k[1];
    // Cache and refs
     ...
     */
    var loadUserPermissions = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_h.label) {
                ...
                case 2:
                    ...
                    context = {
                        ...
                        medical_license: ((_b = roleData.medical_licenses) === null || _b === void 0 ? void 0 : _b.license_number) || null,
                        cfm_number: ((_c = roleData.medical_licenses) === null || _c === void 0 ? void 0 : _c.cfm_number) || null,
                        medical_specialty: ((_d = roleData.medical_licenses) === null || _d === void 0 ? void 0 : _d.specialty) || null,
                        license_expiry: ((_e = roleData.medical_licenses) === null || _e === void 0 ? void 0 : _e.expires_at) ? new Date(roleData.medical_licenses.expires_at) : null,
                        license_active: ((_f = roleData.medical_licenses) === null || _f === void 0 ? void 0 : _f.active) || false,
                        additional_specialties: ((_g = roleData.medical_licenses) === null || _g === void 0 ? void 0 : _g.additional_specialties) || [],
                        ...
                        access_expires_at: roleData.access_expires_at ? new Date(roleData.access_expires_at) : undefined,
     ...
     */
    var checkPermission = (0, react_1.useCallback)(function (permission, context) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    cacheKey = "".concat(user.id, ":").concat(permission, ":").concat(JSON.stringify(context));
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, rbacEngine.current.checkPermission(user.id, permission, context)];
                case 2:
                    result = _a.sent();
                    // Cache result
                ...
                case 3:
                    ...
                    return [2 /*return*/, {
                            ...
                            permission: permission,
                            user_id: user.id,
                            role: (userContext === null || userContext === void 0 ? void 0 : userContext.role) || permissions_1.HealthcareRole.GUEST,
    ...
    }); }, [user === null || user === void 0 ? void 0 : user.id, userContext === null || userContext === void 0 ? void 0 : userContext.role, cacheDuration]);
    /**
     * Check multiple permissions
     */
    var checkPermissions = (0, react_1.useCallback)(function (permissions, context) { return __awaiter(_this, void 0, void 0, function () {
        var results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.all(permissions.map(function (permission) { return checkPermission(permission, context); }))];
                case 1:
                    results = _a.sent();
     ...
     */
    var hasPermission = (0, react_1.useCallback)(function (permission, context) {
     ...
     */
    var hasAnyPermission = (0, react_1.useCallback)(function (permissions, context) {
        return permissions.some(function (permission) { return hasPermission(permission, context); });
    }, [hasPermission]);
    /**
     * Check if user has all permissions (sync)
     */
    var hasAllPermissions = (0, react_1.useCallback)(function (permissions, context) {
        return permissions.every(function (permission) { return hasPermission(permission, context); });
    }, [hasPermission]);
    // ============================================================================
     ...
     */
    var requestEmergencyOverride = (0, react_1.useCallback)(function (permission, reason) { return __awaiter(_this, void 0, void 0, function () {
        var logError, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(user === null || user === void 0 ? void 0 : user.id) || !allowEmergencyOverride || !userContext) {
    ...
    }); }, [user === null || user === void 0 ? void 0 : user.id, allowEmergencyOverride, userContext, supabase, toast]);
    // ============================================================================
    // UTILITY FUNCTIONS
    // ============================================================================
    /**
     ...
     */
    var refreshPermissions = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    clearCache();
     ...
     */
    var resetPermissions = (0, react_1.useCallback)(function () {
        setUserContext(null);
    ...
    // COMPUTED VALUES
    // ============================================================================
    var userRole = (userContext === null || userContext === void 0 ? void 0 : userContext.role) || permissions_1.HealthcareRole.GUEST;
    var medicalLicense = (userContext === null || userContext === void 0 ? void 0 : userContext.medical_license) || null;
    var cfmNumber = (userContext === null || userContext === void 0 ? void 0 : userContext.cfm_number) || null;
    var medicalSpecialty = (userContext === null || userContext === void 0 ? void 0 : userContext.medical_specialty) || null;
    var additionalSpecialties = (userContext === null || userContext === void 0 ? void 0 : userContext.additional_specialties) || [];
    var licenseActive = (userContext === null || userContext === void 0 ? void 0 : userContext.license_active) || false;
    var licenseExpiry = (userContext === null || userContext === void 0 ? void 0 : userContext.license_expiry) || null;
    var hasEmergencyOverride = allowEmergencyOverride && ((userContext === null || userContext === void 0 ? void 0 : userContext.emergency_access) || false);
    return {
        // Permission checking
...
function useClinicalPermissions(patientId) {
    ...
    var checkClinicalPermission = (0, react_1.useCallback)(function (permission) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, permissions.checkPermission(permission, { patientId: patientId })];
        });
    }); }, [permissions.checkPermission, patientId]);
    var canAccessPatient = (0, react_1.useCallback)(function (targetPatientId) {
        var id = targetPatientId || patientId;
        return permissions.hasAnyPermission(['patient.read.own', 'patient.read.clinic'], { patientId: id });
    }, [permissions.hasAnyPermission, patientId]);
    var canPerformProcedure = (0, react_1.useCallback)(function (procedureType) {
        if (procedureType === void 0) { procedureType = 'general'; }
        return permissions.hasPermission("procedure.perform.".concat(procedureType));
    }, [permissions.hasPermission]);
    var canPrescribe = (0, react_1.useCallback)(function (type) {
        if (type === void 0) { type = 'standard'; }
        return permissions.hasPermission("prescription.create.".concat(type));
    }, [permissions.hasPermission]);
    return __assign(__assign({}, permissions), { checkClinicalPermission: checkClinicalPermission, canAccessPatient: canAccessPatient, canPerformProcedure: canPerformProcedure, canPrescribe: canPrescribe });
}
/**
...
function useAdministrativePermissions() {
    ...
    var canManageScheduling = (0, react_1.useCallback)(function (scope) {
        if (scope === void 0) { scope = 'own'; }
        return permissions.hasPermission("scheduling.manage.".concat(scope));
    }, [permissions.hasPermission]);
    var canProcessBilling = (0, react_1.useCallback)(), boolean;
    {
        return permissions.hasPermission('billing.process.standard');
    }
    [permissions.hasPermission];
    ;
    var canManageUsers = (0, react_1.useCallback)(), boolean;
    {
        return permissions.hasPermission('system.manage.users');
    }
    [permissions.hasPermission];
    ;
    var canConfigureClinic = (0, react_1.useCallback)(), boolean;
    {
        return permissions.hasPermission('system.configure.clinic');
    }
    [permissions.hasPermission];
    ;
    return __assign(__assign({}, permissions), { canManageScheduling: canManageScheduling, canProcessBilling: canProcessBilling, canManageUsers: canManageUsers, canConfigureClinic: canConfigureClinic });
}
/**
...
function useCompliancePermissions() {
    ...
    var canAccessAuditLogs = (0, react_1.useCallback)(), boolean;
    {
        return permissions.hasPermission('audit.access.clinic');
    }
    [permissions.hasPermission];
    ;
    var canGenerateReports = (0, react_1.useCallback)(function (type) {
        return permissions.hasPermission("compliance.report.".concat(type));
    }, [permissions.hasPermission]);
    var canValidateLicenses = (0, react_1.useCallback)(), boolean;
    {
        return permissions.hasPermission('license.validate.cfm');
    }
    [permissions.hasPermission];
    ;
    var canMonitorLicenses = (0, react_1.useCallback)(), boolean;
    {
        return permissions.hasPermission('license.monitor.expiration');
    }
    [permissions.hasPermission];
    ;
    return __assign(__assign({}, permissions), { canAccessAuditLogs: canAccessAuditLogs, canGenerateReports: canGenerateReports, canValidateLicenses: canValidateLicenses, canMonitorLicenses: canMonitorLicenses });
}
