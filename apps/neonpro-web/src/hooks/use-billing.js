...
function useBilling() {
  ...
  var _e = (0, react_1.useState)(null),
    financialSummary = _e[0],
    setFinancialSummary = _e[1];
        ...
        return __generator(this, (_d) => {
          switch (_d.label) {
            case 0:
              ...
              // Apply filters
              if (
                (_b = filters === null || filters === void 0 ? void 0 : filters.type) === null ||
                _b === void 0
                  ? void 0
                  : _b.length
              ) {
              ...
              if (
                (_c = filters === null || filters === void 0 ? void 0 : filters.category) ===
                  null || _c === void 0
                  ? void 0
                  : _c.length
              ) {
              ...
              if (
                (filters === null || filters === void 0 ? void 0 : filters.price_min) !== undefined
              ) {
                query = query.gte("base_price", filters.price_min);
              }
              if (
                (filters === null || filters === void 0 ? void 0 : filters.price_max) !== undefined
              ) {
              ...
              sortBy =
                (filters === null || filters === void 0 ? void 0 : filters.sort_by) || "name";
              sortOrder =
                (filters === null || filters === void 0 ? void 0 : filters.sort_order) || "asc";
        ...
        return __generator(this, (_b) => {
          switch (_b.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                supabase.from("services").insert([serviceData]).select().single(),
              ];
            case 1:
        ...
        return __generator(this, (_c) => {
          switch (_c.label) {
            case 0:
              ...
              // Apply filters
              if (
                (_b = filters === null || filters === void 0 ? void 0 : filters.status) === null ||
                _b === void 0
                  ? void 0
                  : _b.length
              ) {
              ...
              if (
                (filters === null || filters === void 0 ? void 0 : filters.amount_min) !== undefined
              ) {
                query = query.gte("total_amount", filters.amount_min);
              }
              if (
                (filters === null || filters === void 0 ? void 0 : filters.amount_max) !== undefined
              ) {
              ...
              if (filters === null || filters === void 0 ? void 0 : filters.search) {
                query = query.or(
                  "invoice_number.ilike.%"
                    .concat(filters.search, "%,notes.ilike.%")
                    .concat(filters.search, "%"),
                );
              }
              ...
              sortBy =
                (filters === null || filters === void 0 ? void 0 : filters.sort_by) || "issue_date";
              sortOrder =
        ...
        return __generator(this, (_d) => {
          switch (_d.label) {
            case 0:
              ...
              if (
                (_c = filters === null || filters === void 0 ? void 0 : filters.method) === null ||
                _c === void 0
                  ? void 0
                  : _c.length
              ) {
  ...
  var calculateInvoiceTotals = (0, react_1.useCallback)(
    (items) => {
      ...
      var taxAmount =
        ...
        (((settings === null || settings === void 0 ? void 0 : settings.tax_rate) || 0) / 100);
