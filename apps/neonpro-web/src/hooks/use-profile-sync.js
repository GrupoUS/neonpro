...
function useProfileSync() {
    var _this = this;
    var _a = (0, auth_context_1.useAuth)(), user = _a.user, session = _a.session, getValidSession = _a.getValidSession;
    var _b = (0, react_1.useState)(null), profile = _b[0], setProfile = _b[1];
    var _c = (0, react_1.useState)(null), syncStatus = _c[0], setSyncStatus = _c[1];
    var _d = (0, react_1.useState)(true), isLoading = _d[0], setIsLoading = _d[1];
    var _e = (0, react_1.useState)(false), isUpdating = _e[0], setIsUpdating = _e[1];
    var _f = (0, react_1.useState)(null), error = _f[0], setError = _f[1];
    var _g = (0, react_1.useState)(null), supabase = _g[0], setSupabase = _g[1];
    ...
    var fetchProfile = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var fetchSyncStatus = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, supabase
                            .rpc('get_profile_sync_status', { user_id: user.id })];
                case 2:
    ...
    var refreshProfile = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    // Update profile data
    var updateProfile = (0, react_1.useCallback)(function (updates) { return __awaiter(_this, void 0, void 0, function () {
    ...
    }); }, [user === null || user === void 0 ? void 0 : user.id, getValidSession, supabase, refreshProfile]);
    // Sync profile with Google data
    var syncWithGoogle = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        var error_4, err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var resolveConflict = (0, react_1.useCallback)(function (resolutionData) { return __awaiter(_this, void 0, void 0, function () {
        var error_5, err_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    // Toggle Google sync
    var toggleGoogleSync = (0, react_1.useCallback)(function (enabled) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(user === null || user === void 0 ? void 0 : user.id)) {
