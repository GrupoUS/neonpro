...
exports.useLGPDComplianceStatus = exports.withLGPDProtection = exports.useDataSubjectRights = exports.useConsentManagement = exports.useLGPDAudit = void 0;
...
var useLGPDAudit = function () {
    ...
    var logEvent = (0, react_1.useCallback)(function (eventType, details) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, compliance.createAuditLog({
    ...
    var logPatientAccess = (0, react_1.useCallback)(function (patientId_1, clinicId_1, action_1) {
        var args_1 = [];
        for (var _i = 3; _i < arguments.length; _i++) {
            args_1[_i - 3] = arguments[_i];
        }
        return __awaiter(void 0, __spreadArray([patientId_1, clinicId_1, action_1], args_1, true), void 0, function (patientId, clinicId, action, tableName, recordId) {
            if (tableName === void 0) { tableName = 'patients'; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, logEvent('patient_record_access', {
                            patientId: patientId,
                            clinicId: clinicId,
                            tableName: tableName,
                            action: action,
    ...
    var logSensitiveAccess = (0, react_1.useCallback)(function (patientId, clinicId, dataType, action, recordId) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, compliance.logSensitiveDataAccess(user.id, patientId, clinicId, dataType, action, recordId)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 3:
...
var useConsentManagement = function (patientId, clinicId) {
    var _a = (0, react_1.useState)([]), consents = _a[0], setConsents = _a[1];
    var _b = (0, react_1.useState)(false), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(null), error = _c[0], setError = _c[1];
    var supabase = yield (0, client_1.createClient)();
    var compliance = new lgpd_compliance_1.LGPDComplianceManager();
    var refreshConsents = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var activeConsents = consents.filter(function (consent) { return consent.consent_status === 'active'; });
    var checkConsent = (0, react_1.useCallback)(function (consentType) {
        return activeConsents.some(function (consent) { return consent.consent_type === consentType; });
    }, [activeConsents]);
    var grantConsent = (0, react_1.useCallback)(function (consentType, purpose, details) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    consentData = lgpd_compliance_1.lgpdUtils.generateConsentFormData(consentType, purpose);
                    return [4 /*yield*/, supabase
                            .from('patient_consents')
                            .insert(__assign(__assign({ patient_id: patientId, clinic_id: clinicId, user_id: user.id }, consentData), details))];
                case 3:
                    ...
                    // Log consent action
                    return [4 /*yield*/, compliance.logConsentAction(patientId, clinicId, consentType, 'granted', __assign({ purpose: purpose }, details))];
                case 4:
                    // Log consent action
                    _a.sent();
    ...
    var revokeConsent = (0, react_1.useCallback)(function (consentId, reason) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    consent = consents.find(function (c) { return c.id === consentId; });
                    if (!consent) return [3 /*break*/, 4];
                    return [4 /*yield*/, compliance.logConsentAction(patientId, clinicId, consent.consent_type, 'revoked', { reason: reason, consent_id: consentId })];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4: return [4 /*yield*/, refreshConsents()];
                case 5:
                    _a.sent();
                    return [2 /*return*/, true];
                case 6:
...
var useDataSubjectRights = function (patientId, clinicId) {
    ...
    var refreshRequests = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var submitRequest = (0, react_1.useCallback)(function (requestType, description, details) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, compliance.processDataSubjectRequest(patientId, clinicId, requestType, __assign({ description: description }, details))];
                case 4:
                    _b.sent();
                    _b.label = 5;
                case 5: return [4 /*yield*/, refreshRequests()];
                case 6:
                    _b.sent();
                    return [2 /*return*/, { success: true, requestId: data === null || data === void 0 ? void 0 : data.id }];
                case 7:
                    err_7 = _b.sent();
    ...
    var trackRequest = (0, react_1.useCallback)(function (requestId) {
        return requests.find(function (req) { return req.id === requestId; }) || null;
    }, [requests]);
    var downloadData = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setIsLoading(true);
                    return [4 /*yield*/, compliance.processDataSubjectRequest(patientId, clinicId, 'portability', { format: 'json', include_metadata: true })];
                case 2:
                    result = _a.sent();
                    if (result.success && result.data) {
                        ...
                        link.href = url;
                        link.download = "patient-data-".concat(patientId, "-").concat(new Date().toISOString().split('T')[0], ".json");
                        link.click();
    ...
    var requestDeletion = (0, react_1.useCallback)(function (reason) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, submitRequest('erasure', reason || 'Patient requests deletion of personal data under LGPD Article 18', { deletion_reason: reason })];
...
var withLGPDProtection = function (Component, config) {
    ...
    return function LGPDProtectedComponent(props) {
        ...
        var _a = (0, react_1.useState)(false), accessLogged = _a[0], setAccessLogged = _a[1];
        (0, react_1.useEffect)(function () {
...
var useLGPDComplianceStatus = function (patientId, clinicId) {
    var _a = (0, react_1.useState)({
        ...
        lastAccess: null,
        complianceScore: 0
    }), complianceStatus = _a[0], setComplianceStatus = _a[1];
    var supabase = yield (0, client_1.createClient)();
    (0, react_1.useEffect)(function () {
        if (!patientId || !clinicId)
            return;
        var fetchComplianceStatus = function () { return __awaiter(void 0, void 0, void 0, function () {
            var data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
