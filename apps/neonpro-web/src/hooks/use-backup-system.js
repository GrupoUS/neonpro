        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              error_4 = _a.sent();
              throw new Error(
                error_4 instanceof Error ? error_4.message : "Failed to toggle config",
              );
            case 3:
              return [2 /*return*/];
          }
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              error_5 = _a.sent();
              throw new Error(
                error_5 instanceof Error ? error_5.message : "Failed to run quick backup",
              );
            case 3:
              return [2 /*return*/];
          }
