...
function useConsentManagement() {
    ...
    var _b = (0, react_1.useState)([]), purposes = _b[0], setPurposes = _b[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    setError(null);
                    return [4 /*yield*/, complianceManager.getConsents(__assign(__assign({}, filters), { offset: (currentPage - 1) * (filters.limit || 20) }))];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    err_1 = _a.sent();
                    errorMessage = err_1 instanceof Error ? err_1.message : 'Erro ao carregar consentimentos';
    ...
    var createPurpose = (0, react_1.useCallback)(function (purpose) { return __awaiter(_this, void 0, void 0, function () {
        var newPurpose_1, errorMessage;
        return __generator(this, function (_a) {
            setIsCreating(true);
            try {
                setError(null);
                newPurpose_1 = __assign(__assign({}, purpose), { id: Date.now().toString(), created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
                setPurposes(function (prev) { return __spreadArray(__spreadArray([], prev, true), [newPurpose_1], false); });
                toast({
    ...
    var updatePurpose = (0, react_1.useCallback)(function (id, updates) { return __awaiter(_this, void 0, void 0, function () {
        var errorMessage;
        return __generator(this, function (_a) {
            setIsUpdating(true);
            try {
                setError(null);
                setPurposes(function (prev) { return prev.map(function (purpose) {
                    return purpose.id === id
                        ? __assign(__assign(__assign({}, purpose), updates), { updated_at: new Date().toISOString() }) : purpose;
                }); });
                toast({
    ...
    var deletePurpose = (0, react_1.useCallback)(function (id) { return __awaiter(_this, void 0, void 0, function () {
        var purpose, errorMessage;
        return __generator(this, function (_a) {
            setIsDeleting(true);
            try {
                setError(null);
                purpose = purposes.find(function (p) { return p.id === id; });
                if (purpose === null || purpose === void 0 ? void 0 : purpose.required) {
                    throw new Error('Não é possível excluir finalidades obrigatórias');
                }
                setPurposes(function (prev) { return prev.filter(function (purpose) { return purpose.id !== id; }); });
                toast({
    ...
    var withdrawConsent = (0, react_1.useCallback)(function (consentId, reason) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    // Update local state
                    setConsents(function (prev) { return prev.map(function (consent) {
                        return consent.id === consentId
                            ? __assign(__assign({}, consent), { status: 'withdrawn', updated_at: new Date().toISOString() }) : consent;
                    }); });
                    toast({
                ...
                case 2:
                    err_2 = _a.sent();
                    errorMessage = err_2 instanceof Error ? err_2.message : 'Erro ao retirar consentimento';
                    setError(errorMessage);
                    toast({
                        title: 'Erro',
                        description: errorMessage,
    ...
    var exportConsents = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                ...
                csvRows = consents.map(function (consent) { return [
                    consent.id,
                    consent.user_id,
                    consent.purpose_id,
                    consent.status,
                ...
                link.setAttribute('download', "lgpd-consents-".concat(new Date().toISOString().split('T')[0], ".csv"));
