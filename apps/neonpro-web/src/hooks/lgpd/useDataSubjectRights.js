...
function useDataSubjectRights() {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              err_1 = _a.sent();
              errorMessage =
                err_1 instanceof Error ? err_1.message : "Erro ao carregar solicitações";
  ...
  var processRequest = (0, react_1.useCallback)(
    function (requestId, action, notes) {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                complianceManager.updateDataSubjectRequest(requestId, updateData_1),
              ];
            case 2:
              _a.sent();
              // Update local state
              setRequests(function (prev) {
                return prev.map(function (request) {
                  return request.id === requestId
                    ? __assign(__assign(__assign({}, request), updateData_1), {
              ...
              toast({
                ...
                description: "Solicita\u00E7\u00E3o foi ".concat(
            ...
            case 3:
              err_2 = _a.sent();
              errorMessage =
                err_2 instanceof Error ? err_2.message : "Erro ao processar solicitação";
              setError(errorMessage);
              toast({
                title: "Erro",
                description: errorMessage,
  ...
  var updateRequestStatus = (0, react_1.useCallback)(
    function (requestId, status, notes) {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                complianceManager.updateDataSubjectRequest(requestId, updateData_2),
              ];
            case 2:
              _a.sent();
              // Update local state
              setRequests(function (prev) {
                return prev.map(function (request) {
                  return request.id === requestId
                    ? __assign(__assign({}, request), updateData_2)
                    : request;
                });
              });
              // Update statistics
  ...
  var exportRequests = (0, react_1.useCallback)(
    function () {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          try {
            ...
            csvRows = requests.map(function (request) {
              return [
                request.id,
            ...
            link.setAttribute(
              "download",
              "lgpd-requests-".concat(new Date().toISOString().split("T")[0], ".csv"),
            );
