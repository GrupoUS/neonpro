...
function useComplianceAssessment() {
    ...
    var _e = (0, react_1.useState)(null), latestAssessment = _e[0], setLatestAssessment = _e[1];
    var _f = (0, react_1.useState)(true), isLoading = _f[0], setIsLoading = _f[1];
    var _g = (0, react_1.useState)(false), isCreating = _g[0], setIsCreating = _g[1];
    var _h = (0, react_1.useState)(false), isRunning = _h[0], setIsRunning = _h[1];
    ...
    var loadAssessments = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    setError(null);
                    return [4 /*yield*/, complianceManager.getComplianceAssessments(__assign(__assign({}, filters), { offset: (currentPage - 1) * (filters.limit || 20) }))];
                case 1:
                    response = _a.sent();
                    setAssessments(response.data);
                    setTotalCount(response.total);
                    completed = response.data.filter(function (a) { return a.status === 'completed'; });
                    pending = response.data.filter(function (a) { return a.status === 'pending'; });
                    averageScore = completed.length > 0
                        ? completed.reduce(function (sum, a) { return sum + (a.score || 0); }, 0) / completed.length
                        : 0;
                    setStatistics({
    ...
    var createAssessment = (0, react_1.useCallback)(function (assessment) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    // Update local state
                    setAssessments(function (prev) { return __spreadArray([newAssessment_1], prev, true); });
                    setTotalCount(function (prev) { return prev + 1; });
                    // Update statistics
                    setStatistics(function (prev) { return (__assign(__assign({}, prev), { total: prev.total + 1, pending: prev.pending + 1 })); });
                    toast({
                        title: 'Avaliação criada',
                        description: "Avalia\u00E7\u00E3o \"".concat(assessment.title, "\" foi criada com sucesso.")
                    });
                    return [3 /*break*/, 5];
                case 3:
                    err_2 = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setError(null);
                    automatedAssessment = {
                        title: "Avalia\u00E7\u00E3o Automatizada - ".concat(new Date().toLocaleDateString('pt-BR')),
                    ...
                    return [4 /*yield*/, complianceManager.createComplianceAssessment(automatedAssessment)];
                case 2:
                ...
                case 3:
                    ...
                    setAssessments(function (prev) { return prev.map(function (assessment) {
                        return assessment.id === newAssessment_2.id ? result_1 : assessment;
                    }); });
                    // Update statistics
                    setStatistics(function (prev) { return (__assign(__assign({}, prev), { completed: prev.completed + 1, pending: Math.max(0, prev.pending - 1), averageScore: prev.completed > 0
                            ? ((prev.averageScore * (prev.completed - 1)) + (result_1.score || 0)) / prev.completed
                            : result_1.score || 0 })); });
                    // Update latest assessment
                    setLatestAssessment(result_1);
                    toast({
                        title: 'Avaliação concluída',
                        description: "Avalia\u00E7\u00E3o automatizada conclu\u00EDda com pontua\u00E7\u00E3o: ".concat(result_1.score, "/100")
                    });
                    return [3 /*break*/, 6];
                case 4:
                    err_3 = _a.sent();
                    errorMessage = err_3 instanceof Error ? err_3.message : 'Erro ao executar avaliação automatizada';
                    setError(errorMessage);
                    toast({
                        title: 'Erro',
                        description: errorMessage,
    ...
    var exportAssessments = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                ...
                link.setAttribute('download', "lgpd-assessments-".concat(new Date().toISOString().split('T')[0], ".csv"));
