...
function useConsentBanner() {
  ...
  var _e = (0, react_1.useState)(false),
    showPreferences = _e[0],
    setShowPreferences = _e[1];
            ...
            case 2:
              ...
              errorMessage =
                err_1 instanceof Error
                  ? err_1.message
                  : "Erro ao carregar finalidades de consentimento";
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                complianceManager.getConsentRecords({
                  limit: 50,
                  sortBy: "created_at",
                  sortOrder: "desc",
                }),
            ...
            case 2:
              ...
              errorMessage =
                err_2 instanceof Error
                  ? err_2.message
                  : "Erro ao carregar histórico de consentimentos";
              setError(errorMessage);
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 2:
              err_3 = _a.sent();
              errorMessage =
                err_3 instanceof Error ? err_3.message : "Erro ao salvar consentimentos";
              setError(errorMessage);
              toast({
                title: "Erro",
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 2:
              err_4 = _a.sent();
              errorMessage =
                err_4 instanceof Error ? err_4.message : "Erro ao salvar consentimentos";
              setError(errorMessage);
              toast({
                title: "Erro",
                description: errorMessage,
