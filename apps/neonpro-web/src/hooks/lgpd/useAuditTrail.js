        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                complianceManager.getAuditTrail(
            ...
            case 1:
              ...
              todayEvents = response.data.filter((e) => new Date(e.timestamp) >= today_1).length;
              thisWeekEvents = response.data.filter(
                (e) => new Date(e.timestamp) >= thisWeek_1,
              ).length;
              uniqueUsers = new Set(response.data.map((e) => e.user_id).filter(Boolean)).size;
              setStatistics({
            ...
            case 2:
              err_1 = _a.sent();
              errorMessage =
                err_1 instanceof Error ? err_1.message : "Erro ao carregar eventos de auditoria";
        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 1:
              ...
              actionCounts = allEvents.reduce((acc, event) => {
              ...
              entityCounts = allEvents.reduce((acc, event) => {
              ...
              userCounts = allEvents.reduce((acc, event) => {
                if (event.user_id) {
      ...
      __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
          try {
            ...
            link.setAttribute(
              "download",
              "lgpd-audit-trail-".concat(new Date().toISOString().split("T")[0], ".csv"),
            );
