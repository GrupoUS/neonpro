        ...
        return __generator(this, (_a) => {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                complianceManager.updateBreachIncident(incidentId, updateData_1),
              ];
            case 2:
              _a.sent();
              // Update local state
          ...
          try {
            ...
            csvRows = incidents.map((incident) => {
              ...
              return [
                ...
                incident.severity,
                incident.status,
                ((_a = incident.affected_data_types) === null || _a === void 0
                  ? void 0
                  : _a.join("; ")) || "",
                ((_b = incident.affected_individuals) === null || _b === void 0
                  ? void 0
                  : _b.toString()) || "",
                ...
                ((_c = incident.mitigation_actions) === null || _c === void 0
                  ? void 0
                  : _c.join("; ")) || "",
              ];
            });
            ...
            link.setAttribute(
              "download",
              "lgpd-incidents-".concat(new Date().toISOString().split("T")[0], ".csv"),
            );
