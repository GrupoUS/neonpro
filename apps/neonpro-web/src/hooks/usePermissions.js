...
function usePermissions() {
    var _this = this;
    var _a = (0, auth_context_1.useAuth)(), user = _a.user, authLoading = _a.isLoading;
    var _b = (0, react_1.useState)(false), isLoading = _b[0], setIsLoading = _b[1];
    var _c = (0, react_1.useState)(null), error = _c[0], setError = _c[1];
    var _d = (0, react_1.useState)([]), userPermissions = _d[0], setUserPermissions = _d[1];
    /**
     * Get user's role
     */
    var role = (0, react_1.useMemo)(function () {
        return (user === null || user === void 0 ? void 0 : user.role) || null;
    }, [user === null || user === void 0 ? void 0 : user.role]);
    /**
     * Get user's permissions based on role
     */
    var permissions = (0, react_1.useMemo)(function () {
        if (!role || !user)
            return [];
     ...
     * Generate cache key
     */
    var getCacheKey = (0, react_1.useCallback)(function (permission, resourceId) {
        return "".concat(user === null || user === void 0 ? void 0 : user.id, ":").concat(permission, ":").concat(resourceId || 'global', ":").concat(user === null || user === void 0 ? void 0 : user.clinicId);
    }, [user === null || user === void 0 ? void 0 : user.id, user === null || user === void 0 ? void 0 : user.clinicId]);
    /**
     ...
     */
    var hasPermission = (0, react_1.useCallback)(function (permission, resourceId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            try {
                ...
                if (!hasRolePermission) {
                    result_1 = {
                        granted: false,
                        reason: "Role '".concat(role, "' does not have permission '").concat(permission, "'"),
                        roleUsed: role
                    };
     ...
     */
    var hasAnyPermission = (0, react_1.useCallback)(function (permissionList, resourceId) { return __awaiter(_this, void 0, void 0, function () {
     ...
     */
    var hasAllPermissions = (0, react_1.useCallback)(function (permissionList, resourceId) { return __awaiter(_this, void 0, void 0, function () {
     ...
     */
    var hasRole = (0, react_1.useCallback)(function (targetRole) {
        return role === targetRole;
    }, [role]);
    /**
     * Check if user has minimum role level
     */
    var hasMinimumRole = (0, react_1.useCallback)(function (minimumRole) {
        if (!role)
            return false;
     ...
     */
    var canAccess = (0, react_1.useCallback)(function (feature) {
        var featurePermissions = FEATURE_PERMISSIONS[feature];
        if (!featurePermissions)
            return false;
        return featurePermissions.some(function (permission) { return permissions.includes(permission); });
    }, [permissions]);
    /**
     * Check if user can manage a resource
     */
    var canManage = (0, react_1.useCallback)(function (resource) {
     ...
     */
    var canView = (0, react_1.useCallback)(function (resource) {
    ...
    var refreshPermissions = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    errorMessage = err_1 instanceof Error ? err_1.message : 'Failed to refresh permissions';
                    setError(errorMessage);
...
function usePermission(permission, resourceId) {
    var _this = this;
    var _a = usePermissions(), hasPermission = _a.hasPermission, isLoading = _a.isLoading, error = _a.error;
    var _b = (0, react_1.useState)(false), allowed = _b[0], setAllowed = _b[1];
    var _c = (0, react_1.useState)(true), checking = _c[0], setChecking = _c[1];
    (0, react_1.useEffect)(function () {
        var mounted = true;
        var checkPermission = function () { return __awaiter(_this, void 0, void 0, function () {
            var result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
 ...
 */
function useRole() {
    var _a = usePermissions(), role = _a.role, hasRole = _a.hasRole, hasMinimumRole = _a.hasMinimumRole, isLoading = _a.isLoading, error = _a.error;
    return {
        role: role,
        hasRole: hasRole,
        hasMinimumRole: hasMinimumRole,
