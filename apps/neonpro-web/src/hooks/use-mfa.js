        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                mfaServiceRef.current.setupMFA(opts.userId, request.method, {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 3:
              ...
              return [
                4 /*yield*/,
                mfaServiceRef.current.verifyMFA(opts.userId, request.token, request.method, {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            ...
            case 2:
              return [4 /*yield*/, _b.apply(_a, _c.concat([((_d.ipAddress = _e.sent()), _d)]))];
            case 3:
              _e.sent();
        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            ...
            case 5:
              err_5 = _e.sent();
              error_5 =
                err_5 instanceof Error ? err_5 : new Error("Failed to generate backup codes");
              setError(error_5);
              throw error_5;
            case 6:
              setIsLoading(false);
