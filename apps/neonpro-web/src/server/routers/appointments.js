...
exports.appointmentsRouter = (0, trpc_1.createTRPCRouter)({
    ...
    list: trpc_1.protectedProcedure
        ...
        status: zod_1.z.enum(['scheduled', 'completed', 'cancelled', 'no_show', 'all']).default('scheduled'),
    }))
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, supabase
                            .from('appointments')
                            .insert(__assign(__assign({}, input), { status: 'scheduled', created_by: user.id, created_at: new Date().toISOString() }))
                            .select()
                            .single()];
                case 2:
    ...
    getAvailableSlots: trpc_1.protectedProcedure
        ...
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var supabase, startOfDay, endOfDay, _c, appointments, error, workingHours, slots, hour, _loop_1, minute;
        var ctx = _b.ctx, input = _b.input;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                ...
                case 1:
                    ...
                    for (hour = workingHours.start; hour < workingHours.end; hour++) {
                        _loop_1 = function (minute) {
                            ...
                            var hasConflict = appointments === null || appointments === void 0 ? void 0 : appointments.some(function (apt) {
                                var aptStart = new Date(apt.appointment_date);
                                var aptEnd = new Date(aptStart.getTime() + apt.duration_minutes * 60000);
                                var slotEnd = new Date(slotTime.getTime() + input.duration_minutes * 60000);
