...
exports.doctorsRouter = (0, trpc_1.createTRPCRouter)({
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, supabase
                            .from('doctors')
                            .insert(__assign(__assign({}, input), { status: 'active', created_by: user.id, created_at: new Date().toISOString() }))
                            .select()
                            .single()];
                case 2:
                    _c = _d.sent(), data = _c.data, error = _c.error;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            .from('doctors')
                            .update(__assign(__assign({}, updateData), { updated_by: user.id, updated_at: new Date().toISOString() }))
                            .eq('id', id)
                            .select()
                            .single()];
                case 1:
    ...
    getSpecialties: trpc_1.protectedProcedure
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    specialties = __spreadArray([], new Set((data === null || data === void 0 ? void 0 : data.map(function (d) { return d.specialty; })) || []), true);
                    return [2 /*return*/, { specialties: specialties }];
            }
        });
    }); }),
    // Get departments list
    getDepartments: trpc_1.protectedProcedure
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    departments = __spreadArray([], new Set((data === null || data === void 0 ? void 0 : data.map(function (d) { return d.department; })) || []), true);
