...
exports.adminProcedure = exports.protectedProcedure = exports.publicProcedure = exports.createTRPCRouter = exports.createTRPCContext = void 0;
 ...
 */
exports.protectedProcedure = t.procedure.use(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        ...
        return [2 /*return*/, next({
                ctx: __assign(__assign({}, ctx), { session: __assign(__assign({}, ctx.session), { user: ctx.user }) }),
            })];
    });
}); });
/**
 ...
 */
exports.adminProcedure = exports.protectedProcedure.use(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var isAdmin;
    var _c, _d;
    var ctx = _b.ctx, next = _b.next;
    return __generator(this, function (_e) {
        isAdmin = ((_d = (_c = ctx.user) === null || _c === void 0 ? void 0 : _c.user_metadata) === null || _d === void 0 ? void 0 : _d.role) === 'admin';
        if (!isAdmin) {
