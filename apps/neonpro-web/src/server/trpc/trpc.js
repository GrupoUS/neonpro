...
var t = server_1.initTRPC.context().create({
    ...
    errorFormatter: function (_a) {
        ...
        return __assign(__assign({}, shape), { data: __assign(__assign({}, shape.data), { zodError: error.cause instanceof zod_1.ZodError ? error.cause.flatten() : null, healthcareCompliant: true, timestamp: new Date().toISOString() }) });
    },
});
