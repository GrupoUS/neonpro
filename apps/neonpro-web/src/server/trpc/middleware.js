...
exports.tenantProcedure = exports.adminProcedure = exports.medicalProcedure = exports.protectedProcedure = exports.publicProcedureWithAudit = exports.tenantMiddleware = exports.adminMiddleware = exports.medicalProfessionalMiddleware = exports.authMiddleware = exports.healthcareAuditMiddleware = void 0;
var server_1 = require("@trpc/server");
var trpc_1 = require("./trpc");
// Healthcare compliance middleware
exports.healthcareAuditMiddleware = (0, trpc_1.middleware)(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var startTime, result, error_1;
    var ctx = _b.ctx, next = _b.next, path = _b.path, type = _b.type;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, logHealthcareAudit({
                        ctx: ctx,
                        path: path,
                        type: type,
                        success: true,
...
exports.authMiddleware = (0, trpc_1.middleware)(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
...
exports.medicalProfessionalMiddleware = exports.authMiddleware.unstable_pipe((0, trpc_1.middleware)(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var allowedRoles;
    var ctx = _b.ctx, next = _b.next;
    return __generator(this, function (_c) {
...
exports.adminMiddleware = exports.authMiddleware.unstable_pipe((0, trpc_1.middleware)(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var ctx = _b.ctx, next = _b.next;
    return __generator(this, function (_c) {
...
exports.tenantMiddleware = exports.authMiddleware.unstable_pipe((0, trpc_1.middleware)(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var ctx = _b.ctx, next = _b.next, input = _b.input;
    return __generator(this, function (_c) {
...
function logHealthcareAudit(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        var ctx = _b.ctx, path = _b.path, type = _b.type, success = _b.success, duration = _b.duration, error = _b.error;
            ...
            switch (_j.label) {
                case 0:
                    ...
                    auditData = {
                        ...
                        compliance_flags: {
                            lgpd_compliant: ((_e = ctx.user) === null || _e === void 0 ? void 0 : _e.lgpd_consent) || false,
                            data_consent_validated: ((_f = ctx.user) === null || _f === void 0 ? void 0 : _f.data_consent_given) || false,
                            medical_role_verified: ((_g = ctx.user) === null || _g === void 0 ? void 0 : _g.role) === 'healthcare_professional' ?
                                !!((_h = ctx.user) === null || _h === void 0 ? void 0 : _h.medical_license) : true,
                        },
                    };
                    // Insert audit log into Supabase
                    return [4 /*yield*/, ctx.supabase
...
exports.medicalProcedure = exports.publicProcedureWithAudit.use(exports.medicalProfessionalMiddleware);
