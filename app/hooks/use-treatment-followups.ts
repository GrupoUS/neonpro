...
const QUERY_KEYS = {
  followups: (filters?: FollowupFilters) => ['followups', filters],
 ...
 */
export function useFollowupTemplates(filters?: TemplateFilters) {
  return useQuery({
 ...
 */
export function useTreatmentProtocols(filters?: ProtocolFilters) {
  return useQuery({
 ...
 */
export function useFollowupDashboardSummary(clinicId: string) {
  return useQuery({
 ...
 */
export function usePendingFollowups(clinicId: string) {
  return useFollowups({
    clinic_id: clinicId,
    status: ['pending'],
    limit: 100
 ...
 */
export function useOverdueFollowups(clinicId: string) {
 ...
 */
export function useActiveFollowupTemplates(clinicId: string) {
 ...
 */
export function useActiveTreatmentProtocols(clinicId: string) {
