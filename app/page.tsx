  ...
  return (
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2 relative">
      ...
      <div className="hidden bg-muted lg:block relative">
        <img src="/spectral-dark-bg.jpg" alt="Spectral Dark Background" className="h-full w-full object-cover" />
        <div className="absolute inset-0 bg-black/20" />
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white p-8">
            <h2 className="text-4xl font-bold mb-4">Bem-vindo ao NEON PRO!</h2>
            <p className="text-lg">A plataforma completa para gestão da sua clínica de estética.</p>
          </div>
        </div>
      </div>
    </div>
