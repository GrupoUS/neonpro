...
export async function GET(
  ...
  try {
    const protocol = await treatmentFollowupService.getFollowupProtocolById(params.id);
...
export async function PUT(
  ...
  try {
    ...
    // Update protocol
    const protocol = await treatmentFollowupService.updateFollowupProtocol(params.id, validatedData);
