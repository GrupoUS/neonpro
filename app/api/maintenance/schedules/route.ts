...
import { createMaintenanceScheduleSchema, updateMaintenanceScheduleSchema } from '@/app/lib/validations/maintenance';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const schedules = await equipmentMaintenanceService.getEquipmentSchedules(equipmentId);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const schedule = await equipmentMaintenanceService.createMaintenanceSchedule(validatedData);
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const schedule = await equipmentMaintenanceService.updateMaintenanceSchedule(
      scheduleId,
      validatedData
    );
