...
export interface InventoryBudget {
  ...
  clinic_id: string;
  name: string;
  category?: string; // 'monthly', 'quarterly', 'annual', 'project'
  budget_type: string; // 'operational', 'expansion', 'emergency'
  total_amount: number;
  allocated_amount?: number;
  spent_amount?: number;
  remaining_amount?: number; // Generated field
  currency?: string;
  start_date: string;
  end_date: string;
  status?: string; // 'active', 'paused', 'exhausted', 'expired'
...
export interface BudgetAllocation {
  ...
  allocated_amount: number;
  spent_amount?: number;
  reserved_amount?: number; // for pending orders
...
export interface BudgetVariance {
  ...
  variance_type: string; // 'overspend', 'underspend', 'forecast_variance'
...
export interface PurchaseOrderApproval {
  ...
  approval_type: string; // 'budget', 'manager', 'director', 'automatic'
...
export interface ApprovalWorkflowRule {
  ...
  clinic_id: string;
  rule_name: string;
  rule_type: string; // 'amount_based', 'category_based', 'department_based'
  category?: string;
  department?: string;
  cost_center?: string;
  min_amount?: number;
...
export interface BudgetUtilizationSummary {
  ...
  utilization_status: string; // 'over_budget', 'high_utilization', 'medium_utilization', 'low_utilization'
  start_date: string;
  end_date: string;
