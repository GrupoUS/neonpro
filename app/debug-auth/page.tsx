      ...
      try {
        ...
        setDebugInfo((prev: any) => ({
          ...
          callbacks: {
            ...
            configured: "Check Supabase Dashboard",
          },
          loading: false,
        }));
      } catch (err: any) {
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <Badge
                variant={debugInfo.supabaseUrl ? "default" : "destructive"}
              >
            ...
            <div className="flex justify-between items-center">
              ...
              <Badge
                variant={
                  debugInfo.sessionStatus === "active" ? "default" : "outline"
                }
              >
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground mt-4">
              ⚠️ Configure estas URLs no Supabase Dashboard em Authentication →
              URL Configuration
            </div>
          </CardContent>
        </Card>
