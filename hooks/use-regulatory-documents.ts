...
export function useRegulatoryDocuments(options: UseDocumentsOptions = {}): UseRegulatoryDocumentsReturn {
  ...
  const createDocument = useCallback(async (data: CreateDocumentRequest): Promise<RegulatoryDocument | null> => {
    try {
  ...
  const updateDocument = useCallback(async (id: string, data: UpdateDocumentRequest): Promise<RegulatoryDocument | null> => {
    try {
