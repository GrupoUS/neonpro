...
export function useLgpdConsent(): UseLgpdConsentReturn {
    ...
    async (consent: LgpdConsentData, patientId: string): Promise<boolean> => {
      ...
      try {
        ...
        const response = await fetch(
          `/api/patients/${patientId}/lgpd/consent`,
          {
            method: 'POST',
            headers: {
  ...
  const checkConsentValidity = useCallback(
    async (patientId: string, dataTypes: string[]): Promise<boolean> => {
      try {
        const response = await fetch(
          `/api/patients/${patientId}/lgpd/consent/check`,
          {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
  ...
  const getConsentHistory = useCallback(
    async (patientId: string): Promise<LgpdAuditEntry[]> => {
      try {
        const response = await fetch(
          `/api/patients/${patientId}/lgpd/consent/history`
        );
  ...
  const anonymizePatientData = useCallback(
    async (patientId: string): Promise<boolean> => {
      ...
      try {
        const response = await fetch(
          `/api/patients/${patientId}/lgpd/anonymize`,
          {
            method: 'POST',
          }
        );
