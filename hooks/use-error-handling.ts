...
export function useErrorHandling() {
  ...
  const createErrorContext = useCallback(
    (
      ...
      return {
        ...
        metadata: metadata
          ? { ...metadata, sensitive_data_removed: true }
          : undefined,
      };
    },
    [sessionId]
  ...
  const createError = useCallback(
    (
      ...
      const template =
        ERROR_TEMPLATES[errorCode] || ERROR_TEMPLATES.SYSTEM_MAINTENANCE;
      ...
      const error: AppError = {
        ...
        message:
          customMessage || template.message || 'Ocorreu um erro inesperado.',
