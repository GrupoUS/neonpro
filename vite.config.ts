...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: '@sentry/react', replacement: path.resolve(__dirname, './apps/web/src/shims/sentry-react.ts') },
      { find: '@sentry/tracing', replacement: path.resolve(__dirname, './apps/web/src/shims/sentry-tracing.ts') },
      // App path aliases
      ...
      { find: /^file-saver(\/.*)?$/, replacement: path.resolve(__dirname, './apps/web/src/shims/file-saver/index.ts') },
    ],
