...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@neonpro/tools-shared': path.resolve(__dirname, '../../tools/shared/src'),
      '@neonpro/tools-frontend-tests': path.resolve(__dirname, '../../tools/frontend/src'),
      '@neonpro/tools-backend-tests': path.resolve(__dirname, '../../tools/backend/src'),
      '@neonpro/tools-database-tests': path.resolve(__dirname, '../../tools/database/src'),
      '@neonpro/tools-quality-tests': path.resolve(__dirname, '../../tools/quality/src')
    },
  },
});
