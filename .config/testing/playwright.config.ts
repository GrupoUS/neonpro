...
export default defineConfig({
  ...
  reporter: [['html', { outputFolder: '../../tools/frontend/reports/e2e/html' }], ['list']],
  use: {
    baseURL: BASE_URL,
  ...
  globalSetup: new URL('../../tools/frontend/src/e2e/global-setup.ts', import.meta.url).pathname,
  globalTeardown: new URL('../../tools/frontend/src/e2e/global-teardown.ts', import.meta.url).pathname,
  projects: [
    {
      name: 'Chromium',
