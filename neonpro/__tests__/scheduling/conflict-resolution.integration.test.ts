...
import { ConflictDetectionService, WaitlistService } from '../../lib/scheduling/conflict-resolution';
  ...
  describe('ConflictDetectionService', () => {
    describe('detectConflicts', () => {
      ...
      test('should handle database errors gracefully', async () => {
        ...
        await expect(conflictService.detectConflicts(appointmentData))
  ...
  describe('WaitlistService', () => {
    describe('addToWaitlist', () => {
      ...
      test('should handle duplicate waitlist entries', async () => {
        ...
        await expect(waitlistService.addToWaitlist(waitlistData))
