...
describe('SessionDashboard', () => {
  ...
  it('should render dashboard with all sections', () => {
    ...
    expect(screen.getByText('Monitor and manage user sessions, security events, and device access')).toBeInTheDocument();
  ...
  it('should handle security event resolution', async () => {
    ...
    await waitFor(() => {
      expect(mockResolveEvent).toHaveBeenCalledWith('event-123', expect.any(String), expect.any(String));
    });
  });
