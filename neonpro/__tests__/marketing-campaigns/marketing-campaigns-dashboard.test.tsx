  ...
  describe('Tab Navigation', () => {
    ...
    it('should display campaigns tab content when selected', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Manage and monitor your automated marketing campaigns')).toBeInTheDocument();
      });
    });
    ...
    it('should display A/B testing tab content when selected', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Optimize campaigns with statistical A/B testing')).toBeInTheDocument();
      });
    });
    ...
    it('should display analytics tab content when selected', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Real-time performance tracking and ROI measurement')).toBeInTheDocument();
      });
    });
    ...
    it('should display automation tab content when selected', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('≥80% automation rate with AI-driven optimization')).toBeInTheDocument();
      });
    });
  });
