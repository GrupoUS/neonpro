...
jest.mock('../../../app/lib/services/inventory-reports-service', () => ({
  ...
  getReportDefinitions: jest.fn(() => Promise.resolve({
    data: [
      {
        id: 'def-001',
        name: 'Inventory Summary',
  ...
  getReportAnalytics: jest.fn(() => Promise.resolve({
    data: {
...
const TestReportFilters = ({ onSubmit }: { onSubmit: () => void }) => (
  <form data-testid="report-filters" onSubmit={(e) => { e.preventDefault(); onSubmit(); }}>
