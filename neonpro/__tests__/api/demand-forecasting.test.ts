...
import { GET as getAllocationsGET, POST as allocationsPOST } from '@/src/app/api/forecasting/resource-allocation/route';
...
describe('/api/forecasting/resource-allocation - Resource Allocation API', () => {
  ...
  describe('GET /api/forecasting/resource-allocation', () => {
    test('should return current resource allocation status', async () => {
      const request = new NextRequest(`http://localhost:3000/api/forecasting/resource-allocation?forecastId=${validForecastId}`);
