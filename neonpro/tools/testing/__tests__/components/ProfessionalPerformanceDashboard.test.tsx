...
jest.mock('@/lib/supabase/professionals', () => ({
  getProfessionalPerformanceMetrics: jest.fn()
}))
...
describe('ProfessionalPerformanceDashboard', () => {
  beforeEach(() => {
    jest.clearAllMocks()
    ;(getProfessionalPerformanceMetrics as jest.Mock).mockResolvedValue(mockPerformanceMetrics)
  })
  ...
  describe('Component Rendering', () => {
    it('should render dashboard header', async () => {
      ...
      expect(screen.getByText('Métricas de performance e desenvolvimento profissional')).toBeInTheDocument()
    })
  ...
  describe('Data Loading', () => {
    ...
    it('should handle loading error', async () => {
      ;(getProfessionalPerformanceMetrics as jest.Mock).mockRejectedValue(new Error('Failed to load'))
    ...
    it('should display loading state', () => {
      ;(getProfessionalPerformanceMetrics as jest.Mock).mockImplementation(() => 
  ...
  describe('Charts and Visualizations', () => {
    ...
    it('should handle empty chart data gracefully', async () => {
      ;(getProfessionalPerformanceMetrics as jest.Mock).mockResolvedValue([])
  ...
  describe('Performance Insights', () => {
    ...
    it('should show recommendations when performance is below target', async () => {
      ...
      ;(getProfessionalPerformanceMetrics as jest.Mock).mockResolvedValue(lowPerformanceMetrics)
      
      render(<ProfessionalPerformanceDashboard professional={mockProfessional} />)
      
      await waitFor(() => {
        expect(screen.getByText('Recomendações')).toBeInTheDocument()
        expect(screen.getByText('Considere melhorar a comunicação com pacientes')).toBeInTheDocument()
      })
    })
    ...
    it('should highlight exceptional performance', async () => {
      ...
      ;(getProfessionalPerformanceMetrics as jest.Mock).mockResolvedValue(highPerformanceMetrics)
  ...
  describe('Error Handling', () => {
    it('should handle network errors gracefully', async () => {
      ;(getProfessionalPerformanceMetrics as jest.Mock).mockRejectedValue(new Error('Network error'))
    ...
    it('should retry loading when retry button is clicked', async () => {
      ;(getProfessionalPerformanceMetrics as jest.Mock)
  ...
  describe('Data Validation', () => {
    it('should handle malformed metric data', async () => {
      ...
      ;(getProfessionalPerformanceMetrics as jest.Mock).mockResolvedValue(malformedMetrics)
