...
export async function GET(request: NextRequest) {
  try {
    ...
    if (action === 'check') {
      ...
      const canManageRole = targetRole ? canManageTargetRole(role as keyof typeof ROLE_HIERARCHY, targetRole as keyof typeof ROLE_HIERARCHY) : null;
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (action === 'validate_access') {
      ...
      const hasAccess = checkPermission(user_role as keyof typeof ROLE_HIERARCHY, required_permission);
