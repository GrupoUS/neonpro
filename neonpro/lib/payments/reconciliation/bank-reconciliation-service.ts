...
export class BankReconciliationService {
  ...
  static async importBankStatement(
    ...
    try {
      ...
      const matchingResult = await this.performAutomaticMatching(insertedTransactions || [], userId);
  ...
  private static parseAmount(amountStr: string, format: 'decimal' | 'cents'): number {
