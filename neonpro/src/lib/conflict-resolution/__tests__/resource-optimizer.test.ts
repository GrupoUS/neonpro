...
describe('ResourceOptimizer', () => {
  ...
  describe('optimizeResources', () => {
    ...
    it('should respect staff availability constraints', async () => {
      ...
      const availabilityRecommendations = result.recommendations.filter(
        rec => rec.description.includes('availability')
      );
  ...
  describe('Error Handling', () => {
    it('should handle database errors gracefully', async () => {
      ...
      await expect(optimizer.optimizeResources(dateRange)).rejects.toThrow('Database connection failed');
    });
