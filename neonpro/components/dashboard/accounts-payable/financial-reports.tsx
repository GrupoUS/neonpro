...
export default function FinancialReportsPage({
  ...
  const [categoryExpenses, setCategoryExpenses] = useState<
    CategoryExpenseReport[]
  >([]);
  const [budgetTracking, setBudgetTracking] =
    useState<BudgetTrackingReport | null>(null);
  ...
  const loadReportsData = async () => {
    try {
      ...
      const [
        ...
        financialReportsService.getVendorPerformanceReport(
          clinicId,
          "2025-01-01",
          "2025-07-21"
        ),
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="flex items-center text-xs text-muted-foreground">
                <Badge
                  variant={
                    summary.total_overdue > 0 ? "destructive" : "secondary"
                  }
                  className="text-xs"
                >
                ...
                {vendorPerformance.map((vendor) => (
                  <div key={vendor.vendor_id} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Badge
                        variant={financialReportsService.getRiskColor(
                          vendor.risk_score
                        )}
                        className="text-sm"
                      >
                    ...
                    <div className="text-center">
                      ...
                      <p
                        className={`text-2xl font-bold ${
                          budgetTracking.remaining_budget < 0
                            ? "text-red-600"
                            : "text-green-600"
                        }`}
                      >
