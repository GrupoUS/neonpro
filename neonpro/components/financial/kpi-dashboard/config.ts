...
export const DEFAULT_KPI_CONFIGS: KPIConfiguration[] = [
  {
    id: 'total-revenue',
    name: 'Receita Total',
    ...
    thresholds: KPI_THRESHOLDS.revenue,
    targets: {
      daily: 3500,
      weekly: 25000,
      monthly: 100000,
  ...
  },
  {
    ...
    thresholds: KPI_THRESHOLDS.profitMargin,
    targets: {
      daily: 35,
      weekly: 35,
      monthly: 35,
  ...
  },
  {
    ...
    updateFrequency: 'daily',
    thresholds: KPI_THRESHOLDS.cashFlow,
    targets: {
      daily: 1500,
      weekly: 10000,
      monthly: 40000,
  ...
  },
  {
    ...
    dataSource: 'schedule',
    updateFrequency: 'hourly',
    thresholds: KPI_THRESHOLDS.utilizationRate,
    targets: {
      daily: 85,
      weekly: 85,
      monthly: 85,
...
export const DEFAULT_CHART_CONFIGS: { [key: string]: ChartConfiguration } = {
  revenue_trend: {
    type: 'line',
