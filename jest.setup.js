...
jest.mock('@/lib/whatsapp/whatsapp-service', () => ({
  whatsappService: {
    ...
    testConnection: jest.fn().mockResolvedValue({ success: true, message: 'Test successful' }),
    getAvailableTemplates: jest.fn().mockReturnValue([
      {
        ...
        sample: 'Olá {{1}}, você tem um agendamento...'
      }
    ]),
  },
}))
