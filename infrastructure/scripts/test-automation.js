...
function testEmailAutomation() {
    return __awaiter(this, void 0, void 0, function () {
        var testAppointmentData, confirmationResult, reminderResult, fullResult, requiredEnvVars, missingVars, supabase, _a, data, error, supabaseError_1, deploymentChecks, allChecksPass, error_1;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    if (!(process.env.NODE_ENV === "development" && process.env.ENABLE_TEST_JOBS === "true")) return [3 /*break*/, 5];
                    return [4 /*yield*/, trigger_jobs_1.NeonProAutomation.sendAppointmentConfirmation(testAppointmentData)];
                case 2:
                    confirmationResult = _d.sent();
                    console.log("✅ Confirmation job triggered:", confirmationResult);
                    return [4 /*yield*/, trigger_jobs_1.NeonProAutomation.scheduleAppointmentReminder(testAppointmentData)];
                case 3:
                    reminderResult = _d.sent();
                    console.log("✅ Reminder job scheduled:", reminderResult);
                    console.log("\n🎯 Full automation test...");
                    return [4 /*yield*/, trigger_jobs_1.NeonProAutomation.onNewAppointmentCreated(testAppointmentData)];
                case 4:
                    fullResult = _d.sent();
                    console.log("✅ Full automation completed:", {
                        confirmationJobId: (_b = fullResult.confirmation) === null || _b === void 0 ? void 0 : _b.jobId,
                ...
                case 11:
                    ...
                    allChecksPass = deploymentChecks.every(function (check) { return check.status; });
                    if (allChecksPass) {
