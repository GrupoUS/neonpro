...
interface DocumentationTemplates {
  initialConsultation: {
    sections: ["Chief Complaint", "Medical History", "Aesthetic Goals", "Physical Examination", "Assessment", "Plan"],
  ...
  treatmentRecord: {
    sections: ["Procedure Details", "Products Used", "Complications", "Patient Tolerance", "Next Session"],
