...
test.describe('Patient Portal - Medical Records', () => {
  ...
  test('should download medical record PDF', async ({ page }) => {
    ...
    const downloadButton = page.locator('[data-testid="download-record"]').or(page.locator('button:has-text("Download")')).first();
...
test.describe('Patient Portal - Appointments', () => {
  ...
  test('should display upcoming appointments', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="appointments-list"]').or(page.locator('.appointments-list'))).toBeVisible();
    
    // Should display appointment details
    const appointmentCard = page.locator('.appointment-card').or(page.locator('[data-testid="appointment-card"]')).first();
  ...
  test('should schedule new appointment', async ({ page }) => {
    ...
    if (await scheduleButton.isVisible()) {
      ...
      await expect(page.locator('[data-testid="appointment-form"]').or(page.locator('.appointment-form'))).toBeVisible();
  ...
  test('should cancel appointment', async ({ page }) => {
    ...
    if (await cancelButton.isVisible()) {
      ...
      await expect(page.locator('[data-testid="cancel-confirmation"]').or(page.locator('.confirmation-dialog'))).toBeVisible();
...
test.describe('Patient Portal - Test Results', () => {
  ...
  test('should download test result PDF', async ({ page }) => {
    // Look for download button
    const downloadButton = page.locator('[data-testid="download-test"]').or(page.locator('button:has-text("Download")')).first();
