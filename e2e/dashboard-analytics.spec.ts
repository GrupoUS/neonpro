...
test.describe('Dashboard Analytics - Overview', () => {
  ...
  test('should display analytics dashboard overview', async ({ page }) => {
    ...
    const timePeriodSelector = page.locator('[data-testid="time-period"]').or(page.locator('select[name="timePeriod"]'));
  ...
  test('should display real-time metrics', async ({ page }) => {
    ...
    const realTimeIndicator = page.locator('[data-testid="real-time-indicator"]').or(page.locator('.real-time-indicator'));
  ...
  test('should export analytics data', async ({ page }) => {
    ...
    const exportButton = page.locator('[data-testid="export-analytics"]').or(page.locator('button:has-text("Exportar")')).first();
...
test.describe('Dashboard Analytics - Patient Analytics', () => {
  ...
  test('should display patient demographics analytics', async ({ page }) => {
    ...
    if (await patientAnalytics.isVisible()) {
      ...
      const demographicsChart = page.locator('[data-testid="demographics-chart"]').or(page.locator('.demographics-chart'));
  ...
  test('should track patient acquisition trends', async ({ page }) => {
    ...
    const acquisitionAnalytics = page.locator('[data-testid="acquisition-analytics"]').or(page.locator('.acquisition-analytics'));
    if (await acquisitionAnalytics.isVisible()) {
      await expect(acquisitionAnalytics).toBeVisible();
      
      // Should show new patient trends
      const newPatientTrends = page.locator('[data-testid="new-patient-trends"]').or(page.locator('.new-patient-trends'));
  ...
  test('should display patient retention metrics', async ({ page }) => {
    ...
    const retentionAnalytics = page.locator('[data-testid="retention-analytics"]').or(page.locator('.retention-analytics'));
  ...
  test('should analyze patient satisfaction scores', async ({ page }) => {
    ...
    const satisfactionAnalytics = page.locator('[data-testid="satisfaction-analytics"]').or(page.locator('.satisfaction-analytics'));
    if (await satisfactionAnalytics.isVisible()) {
      ...
      const satisfactionTrends = page.locator('[data-testid="satisfaction-trends"]').or(page.locator('.satisfaction-trends'));
      if (await satisfactionTrends.isVisible()) {
        await expect(satisfactionTrends).toBeVisible();
      }
      
      // Should show feedback categories
      const feedbackCategories = page.locator('[data-testid="feedback-categories"]').or(page.locator('.feedback-categories'));
...
test.describe('Dashboard Analytics - Treatment Analytics', () => {
  ...
  test('should display treatment outcome analytics', async ({ page }) => {
    ...
    const treatmentAnalytics = page.locator('[data-testid="treatment-analytics"]').or(page.locator('button:has-text("Tratamentos")')).first();
  ...
  test('should analyze treatment effectiveness by type', async ({ page }) => {
    ...
    const treatmentTypeAnalytics = page.locator('[data-testid="treatment-type-analytics"]').or(page.locator('.treatment-type-analytics'));
    if (await treatmentTypeAnalytics.isVisible()) {
      ...
      const comparativeEffectiveness = page.locator('[data-testid="comparative-effectiveness"]').or(page.locator('.comparative-effectiveness'));
  ...
  test('should track adverse events and complications', async ({ page }) => {
    ...
    const adverseEventsAnalytics = page.locator('[data-testid="adverse-events-analytics"]').or(page.locator('.adverse-events-analytics'));
    if (await adverseEventsAnalytics.isVisible()) {
      await expect(adverseEventsAnalytics).toBeVisible();
      
      // Should show complication rates
      const complicationRates = page.locator('[data-testid="complication-rates"]').or(page.locator('.complication-rates'));
  ...
  test('should analyze treatment costs and ROI', async ({ page }) => {
    ...
    if (await costAnalytics.isVisible()) {
      ...
      const costPerTreatment = page.locator('[data-testid="cost-per-treatment"]').or(page.locator('.cost-per-treatment'));
      ...
      const profitabilityAnalysis = page.locator('[data-testid="profitability-analysis"]').or(page.locator('.profitability-analysis'));
...
test.describe('Dashboard Analytics - Financial Analytics', () => {
  ...
  test('should display revenue analytics', async ({ page }) => {
    ...
    const financialAnalytics = page.locator('[data-testid="financial-analytics"]').or(page.locator('button:has-text("Financeiro")')).first();
    if (await financialAnalytics.isVisible()) {
      ...
      const revenueByService = page.locator('[data-testid="revenue-by-service"]').or(page.locator('.revenue-by-service'));
  ...
  test('should analyze payment methods and trends', async ({ page }) => {
    ...
    if (await paymentAnalytics.isVisible()) {
      ...
      const paymentSuccessRates = page.locator('[data-testid="payment-success-rates"]').or(page.locator('.payment-success-rates'));
  ...
  test('should track outstanding payments and collections', async ({ page }) => {
    ...
    const collectionsAnalytics = page.locator('[data-testid="collections-analytics"]').or(page.locator('.collections-analytics'));
    if (await collectionsAnalytics.isVisible()) {
      await expect(collectionsAnalytics).toBeVisible();
      
      // Should show outstanding amounts
      const outstandingAmounts = page.locator('[data-testid="outstanding-amounts"]').or(page.locator('.outstanding-amounts'));
      ...
      const collectionEfficiency = page.locator('[data-testid="collection-efficiency"]').or(page.locator('.collection-efficiency'));
  ...
  test('should analyze insurance claims and reimbursements', async ({ page }) => {
    ...
    const insuranceAnalytics = page.locator('[data-testid="insurance-analytics"]').or(page.locator('.insurance-analytics'));
    if (await insuranceAnalytics.isVisible()) {
      ...
      const reimbursementRates = page.locator('[data-testid="reimbursement-rates"]').or(page.locator('.reimbursement-rates'));
...
test.describe('Dashboard Analytics - Operational Analytics', () => {
  ...
  test('should display appointment analytics', async ({ page }) => {
    ...
    const appointmentAnalytics = page.locator('[data-testid="appointment-analytics"]').or(page.locator('.appointment-analytics'));
    if (await appointmentAnalytics.isVisible()) {
      ...
      const cancellationAnalytics = page.locator('[data-testid="cancellation-analytics"]').or(page.locator('.cancellation-analytics'));
  ...
  test('should track staff productivity metrics', async ({ page }) => {
    ...
    if (await staffAnalytics.isVisible()) {
      ...
      const productivityMetrics = page.locator('[data-testid="productivity-metrics"]').or(page.locator('.productivity-metrics'));
      ...
      const performanceComparisons = page.locator('[data-testid="performance-comparisons"]').or(page.locator('.performance-comparisons'));
  ...
  test('should analyze resource utilization', async ({ page }) => {
    ...
    const resourceAnalytics = page.locator('[data-testid="resource-analytics"]').or(page.locator('.resource-analytics'));
    if (await resourceAnalytics.isVisible()) {
      await expect(resourceAnalytics).toBeVisible();
      
      // Should show equipment utilization
      const equipmentUtilization = page.locator('[data-testid="equipment-utilization"]').or(page.locator('.equipment-utilization'));
  ...
  test('should track wait times and efficiency', async ({ page }) => {
    ...
    const efficiencyAnalytics = page.locator('[data-testid="efficiency-analytics"]').or(page.locator('.efficiency-analytics'));
    if (await efficiencyAnalytics.isVisible()) {
      ...
      const throughputMetrics = page.locator('[data-testid="throughput-metrics"]').or(page.locator('.throughput-metrics'));
      if (await throughputMetrics.isVisible()) {
        await expect(throughputMetrics).toBeVisible();
      }
      
      // Should show bottleneck analysis
      const bottleneckAnalysis = page.locator('[data-testid="bottleneck-analysis"]').or(page.locator('.bottleneck-analysis'));
...
test.describe('Dashboard Analytics - Performance & Accessibility', () => {
  ...
  test('should work on mobile devices', async ({ page }) => {
    ...
    const analyticsButton = page.locator('[data-testid="patient-analytics"]').or(page.locator('button:has-text("Pacientes")')).first();
  ...
  test('should handle real-time data updates', async ({ page }) => {
    ...
    if (await realTimeIndicator.isVisible()) {
      ...
      const initialText = await page.locator('[data-testid="today-metrics"]').or(page.locator('.today-metrics')).textContent();
      
      // Wait for potential update
      await page.waitForTimeout(5000);
      
      // Check if content might have updated (or at least didn't error)
      const updatedText = await page.locator('[data-testid="today-metrics"]').or(page.locator('.today-metrics')).textContent();
