...
test.describe('Team Management - Staff Operations', () => {
  ...
  test('should display team overview dashboard', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="total-staff"]').or(page.locator('text=Total de Funcionários'))).toBeVisible();
  ...
  test('should handle scheduling system', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="scheduling-system"]').or(page.locator('.scheduling-system'))).toBeVisible();
  ...
  test('should display performance analytics', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="performance-analytics"]').or(page.locator('.performance-analytics'))).toBeVisible();
  ...
  test('should handle resource allocation', async ({ page }) => {
    ...
    const resourceSection = page.locator('[data-testid="resource-allocation"]').or(page.locator('.resource-allocation'));
...
test.describe('Team Management - Emergency Protocols', () => {
  ...
  test('should activate emergency team protocols', async ({ page }) => {
    ...
    const emergencyButton = page.locator('[data-testid="emergency-activate"]').or(page.locator('button:has-text("Emergência")');
