...
test.describe('Emergency Access - Patient Search', () => {
  ...
  test('should search patient by CPF', async ({ page }) => {
    // Enter patient CPF
    const cpfField = page.locator('[data-testid="patient-cpf"]').or(page.locator('input[name="cpf"]')).or(page.locator('input[placeholder*="CPF"]'));
    await cpfField.fill('123.456.789-00');
    
    // Click search button
    const searchButton = page.locator('[data-testid="search-patient"]').or(page.locator('button:has-text("Buscar")')).first();
  ...
  test('should search patient by name', async ({ page }) => {
    // Enter patient name
    const nameField = page.locator('[data-testid="patient-name"]').or(page.locator('input[name="name"]')).or(page.locator('input[placeholder*="Nome"]'));
  ...
  test('should search patient by phone number', async ({ page }) => {
    ...
    const phoneField = page.locator('[data-testid="patient-phone"]').or(page.locator('input[name="phone"]')).or(page.locator('input[placeholder*="Telefone"]'));
  ...
  test('should validate search input', async ({ page }) => {
    ...
    await expect(page.locator('.error').or(page.locator('text=obrigatório')).or(page.locator('text=preencha'))).toBeVisible();
  });
  ...
  test('should handle invalid CPF format', async ({ page }) => {
    ...
    await expect(page.locator('.error').or(page.locator('text=inválido')).or(page.locator('text=formato'))).toBeVisible();
  });
});
...
test.describe('Emergency Access - Patient Information', () => {
  ...
  test('should display critical patient information', async ({ page }) => {
    ...
    const emergencyContact = page.locator('[data-testid="emergency-contact"]').or(page.locator('text=Contato de Emergência'));
    if (await emergencyContact.isVisible()) {
      await expect(emergencyContact).toBeVisible();
    }
  });
  ...
  test('should display current medications', async ({ page }) => {
    ...
    if (await medicationsSection.isVisible()) {
      ...
      const criticalMedication = page.locator('[data-testid="critical-medication"]').or(page.locator('.critical-medication'));
  ...
  test('should display medical history summary', async ({ page }) => {
    ...
    if (await historySection.isVisible()) {
      ...
      const chronicConditions = page.locator('[data-testid="chronic-conditions"]').or(page.locator('text=Condições Crônicas'));
  ...
  test('should display insurance information', async ({ page }) => {
    ...
    if (await insuranceSection.isVisible()) {
      ...
      const insuranceProvider = page.locator('[data-testid="insurance-provider"]').or(page.locator('.insurance-provider'));
...
test.describe('Emergency Access - Emergency Actions', () => {
  ...
  test('should call emergency services', async ({ page }) => {
    ...
    const emergencyCallButton = page.locator('[data-testid="call-emergency"]').or(page.locator('button:has-text("192")')).or(page.locator('button:has-text("SAMU")')).first();
  ...
  test('should contact patient emergency contact', async ({ page }) => {
    ...
    const contactButton = page.locator('[data-testid="call-emergency-contact"]').or(page.locator('button:has-text("Contatar")')).first();
  ...
  test('should print patient summary', async ({ page }) => {
    ...
    const printButton = page.locator('[data-testid="print-summary"]').or(page.locator('button:has-text("Imprimir")')).first();
  ...
  test('should export patient data for transfer', async ({ page }) => {
    ...
    const exportButton = page.locator('[data-testid="export-patient"]').or(page.locator('button:has-text("Exportar")')).first();
...
test.describe('Emergency Access - Security & Compliance', () => {
  test('should require emergency access justification', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="emergency-warning"]').or(page.locator('.emergency-warning'))).toBeVisible();
    
    // Should require justification
    const justificationField = page.locator('[data-testid="access-justification"]').or(page.locator('textarea[name="justification"]'));
  ...
  test('should comply with ANVISA emergency protocols', async ({ page }) => {
    ...
    const protocolNotice = page.locator('[data-testid="emergency-protocol"]').or(page.locator('text=protocolo de emergência'));
...
test.describe('Emergency Access - Performance & Accessibility', () => {
  ...
  test('should have high contrast for emergency visibility', async ({ page }) => {
    ...
    const emergencyButton = page.locator('[data-testid="call-emergency"]').or(page.locator('button:has-text("192")')).first();
