...
test.describe('Pricing Page - Plan Display', () => {
  ...
  test('should highlight recommended plan', async ({ page }) => {
    ...
    const recommendedPlan = page.locator('[data-testid="recommended-plan"]').or(page.locator('.recommended')).or(page.locator('text=Recomendado'));
...
test.describe('Pricing Page - Subscription Flow', () => {
  ...
  test('should initiate subscription for Basic plan', async ({ page }) => {
    ...
    const basicSubscribe = page.locator('[data-testid="subscribe-basic"]').or(page.locator('button:has-text("Assinar Básico")')).first();
  ...
  test('should initiate subscription for Professional plan', async ({ page }) => {
    ...
    const proSubscribe = page.locator('[data-testid="subscribe-professional"]').or(page.locator('button:has-text("Assinar Profissional")')).first();
  ...
  test('should handle Enterprise plan contact request', async ({ page }) => {
    ...
    const enterpriseButton = page.locator('[data-testid="contact-enterprise"]').or(page.locator('button:has-text("Contato")')).first();
  ...
  test('should toggle between monthly and annual pricing', async ({ page }) => {
    ...
    const annualToggle = page.locator('[data-testid="annual-toggle"]').or(page.locator('input[type="checkbox"]')).first();
...
test.describe('Pricing Page - Trial and Free Options', () => {
  ...
  test('should start free trial', async ({ page }) => {
    ...
    const trialButton = page.locator('[data-testid="start-trial"]').or(page.locator('button:has-text("Teste Gratuito")')).first();
...
test.describe('Pricing Page - Payment Security', () => {
  ...
  test('should display payment security badges', async ({ page }) => {
    ...
    const paymentMethods = page.locator('img[alt*="Visa"]').or(page.locator('img[alt*="Mastercard"]')).or(page.locator('img[alt*="PIX"]'));
