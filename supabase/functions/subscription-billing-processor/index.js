    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          console.log(
            "Found ".concat(
              (expiredTrials === null || expiredTrials === void 0
                ? void 0
        ...
        case 6:
          error_2 = _c.sent();
          console.error(
            "Error processing trial expiration for ".concat(subscription.id, ":"),
            error_2,
          );
          return [3 /*break*/, 7];
        case 7:
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          console.log(
            "Found ".concat(
              (renewalDue === null || renewalDue === void 0 ? void 0 : renewalDue.length) || 0,
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          console.log(
            "Found ".concat(
              (toCancelSubs === null || toCancelSubs === void 0 ? void 0 : toCancelSubs.length) ||
                0,
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          console.log(
            "Found ".concat(
              (failedPayments === null || failedPayments === void 0
                ? void 0
        ...
        case 4:
          ...
          console.log(
            "Retry attempt "
              .concat(payment.processing_attempts + 1, " for payment ")
              .concat(payment.id),
          );
          return [3 /*break*/, 7];
        case 5:
