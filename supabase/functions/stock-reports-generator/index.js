...
(0, server_ts_1.serve)(function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var supabaseUrl, supabaseServiceKey, supabase, now, currentDay, currentDate, currentHour, _a, reportConfigs, configError, processedReports, emailQueue, _i, _b, config, schedule, shouldGenerate, scheduleHour, reportData, _c, reportRecord, reportError_1, error_1, _d, emailQueue_1, email, error_2;
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 2:
                ...
                console.log("Found ".concat((reportConfigs === null || reportConfigs === void 0 ? void 0 : reportConfigs.length) || 0, " scheduled reports"));
                processedReports = [];
                emailQueue = [];
            ...
            case 3:
                ...
                console.log("Generating report: ".concat(config.report_name, " for clinic ").concat(config.clinic_id));
                _e.label = 4;
            case 4:
                _e.trys.push([4, 7, , 8]);
                return [4 /*yield*/, generateReport(supabase, config)
            ...
            case 9:
                ...
                for (_d = 0, emailQueue_1 = emailQueue; _d < emailQueue_1.length; _d++) {
                    ...
                    console.log("Queuing email for report ".concat(email.reportName, " to ").concat(email.recipients.length, " recipients"));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        case 'consumption': return [3 /*break*/, 1];
                        case 'valuation': return [3 /*break*/, 3];
                        case 'movement': return [3 /*break*/, 5];
                    }
                    return [3 /*break*/, 7];
                case 1: return [4 /*yield*/, generateConsumptionReport(supabase, clinicId, filters, startDate, endDate)];
                case 2: return [2 /*return*/, _b.sent()];
                case 3: return [4 /*yield*/, generateValuationReport(supabase, clinicId, filters, startDate, endDate)];
                case 4: return [2 /*return*/, _b.sent()];
                case 5: return [4 /*yield*/, generateMovementReport(supabase, clinicId, filters, startDate, endDate)];
                case 6: return [2 /*return*/, _b.sent()];
                case 7: return [4 /*yield*/, generateCustomReport(supabase, clinicId, filters, startDate, endDate)];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    totalConsumption = 0;
                    totalValue = 0;
                    movements === null || movements === void 0 ? void 0 : movements.forEach(function (movement) {
                        var _a, _b, _c;
                        ...
                        if (consumptionByProduct.has(productId)) {
                            ...
                            consumptionByProduct.set(productId, {
                                productId: productId,
                                productName: ((_a = movement.products) === null || _a === void 0 ? void 0 : _a.name) || 'Produto sem nome',
                                category: ((_c = (_b = movement.products) === null || _b === void 0 ? void 0 : _b.product_categories) === null || _c === void 0 ? void 0 : _c.name) || 'Sem categoria',
                                quantity: quantity,
                                value: value,
                                transactions: 1
                            });
                    ...
                    return [2 /*return*/, {
                            ...
                            summary: {
                                ...
                                totalTransactions: (movements === null || movements === void 0 ? void 0 : movements.length) || 0
                            },
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error)
                        throw error;
                    totalValue = (inventory === null || inventory === void 0 ? void 0 : inventory.reduce(function (sum, item) {
                        return sum + (item.quantity_available * item.unit_cost);
                    }, 0)) || 0;
                    byCategory = new Map();
                    inventory === null || inventory === void 0 ? void 0 : inventory.forEach(function (item) {
                        var _a, _b;
                        var category = ((_b = (_a = item.products) === null || _a === void 0 ? void 0 : _a.product_categories) === null || _b === void 0 ? void 0 : _b.name) || 'Sem categoria';
                    ...
                    return [2 /*return*/, {
                            ...
                            summary: {
                                totalValue: totalValue,
                                totalProducts: (inventory === null || inventory === void 0 ? void 0 : inventory.length) || 0,
                                categories: byCategory.size
                            },
                            byCategory: Array.from(byCategory.values()),
                            topValueProducts: (inventory === null || inventory === void 0 ? void 0 : inventory.map(function (item) {
                                var _a;
                                return ({
                                    productName: ((_a = item.products) === null || _a === void 0 ? void 0 : _a.name) || 'Produto sem nome',
                                    quantity: item.quantity_available,
                                    unitCost: item.unit_cost,
                                    totalValue: item.quantity_available * item.unit_cost
                                });
                            }).sort(function (a, b) { return b.totalValue - a.totalValue; }).slice(0, 20)) || [],
                            generatedAt: new Date().toISOString()
                        }];
            }
        });
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, {
                            type: 'movement',
                            period: { startDate: startDate.toISOString(), endDate: endDate.toISOString() },
                            summary: __assign(__assign({}, summary), { byType: Array.from(summary.byType.values()) }),
                            generatedAt: new Date().toISOString()
                        }];
            }
        });
