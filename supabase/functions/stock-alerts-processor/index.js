...
(0, server_ts_1.serve)(function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var supabaseUrl, supabaseServiceKey, supabase, _a, alertConfigs, configError, generatedAlerts, notificationQueue, clinicIds, _loop_1, _i, clinicIds_1, clinicId, alertKeys, existingAlerts, existingKeys_1, newAlerts, insertError, _loop_2, _b, newAlerts_1, alert_1, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                console.log("Found ".concat((alertConfigs === null || alertConfigs === void 0 ? void 0 : alertConfigs.length) || 0, " active alert configurations"));
                generatedAlerts = [];
                notificationQueue = [];
                clinicIds = __spreadArray([], new Set((alertConfigs === null || alertConfigs === void 0 ? void 0 : alertConfigs.map(function (config) { return config.clinic_id; })) || []), true);
                    ...
                    return __generator(this, function (_f) {
                        switch (_f.label) {
                            case 0:
                                ...
                                clinicConfigs = (alertConfigs === null || alertConfigs === void 0 ? void 0 : alertConfigs.filter(function (config) { return config.clinic_id === clinicId; })) || [];
                                return [4 /*yield*/, supabase
                            ...
                            case 1:
                                ...
                                if (inventoryError) {
                                    console.error("Error fetching inventory for clinic ".concat(clinicId, ":"), inventoryError);
                                    return [2 /*return*/, "continue"];
                                }
                                console.log("Found ".concat((inventory === null || inventory === void 0 ? void 0 : inventory.length) || 0, " products in inventory for clinic ").concat(clinicId));
                                _loop_3 = function (config) {
                                    var relevantProducts, _g, relevantProducts_1, product, alerts;
                                    return __generator(this, function (_h) {
                                        switch (_h.label) {
                                            case 0:
                                                relevantProducts = (inventory === null || inventory === void 0 ? void 0 : inventory.filter(function (item) {
            ...
            case 6:
                ...
                alertKeys = generatedAlerts.map(function (alert) {
                    return "".concat(alert.clinic_id, "-").concat(alert.product_id, "-").concat(alert.alert_type);
                });
                return [4 /*yield*/, supabase
                        .from('stock_alerts')
                        .select('clinic_id, product_id, alert_type')
                        .eq('status', 'active')
                        .in('clinic_id', __spreadArray([], new Set(generatedAlerts.map(function (a) { return a.clinic_id; })), true))];
            case 7:
                existingAlerts = (_c.sent()).data;
                existingKeys_1 = new Set((existingAlerts === null || existingAlerts === void 0 ? void 0 : existingAlerts.map(function (alert) {
                    return "".concat(alert.clinic_id, "-").concat(alert.product_id, "-").concat(alert.alert_type);
                })) || []);
                newAlerts = generatedAlerts.filter(function (alert) {
                    return !existingKeys_1.has("".concat(alert.clinic_id, "-").concat(alert.product_id, "-").concat(alert.alert_type));
                });
                console.log("Inserting ".concat(newAlerts.length, " new alerts (").concat(generatedAlerts.length - newAlerts.length, " duplicates filtered)"));
            ...
            case 8:
                ...
                _loop_2 = function (alert_1) {
                    var config = alertConfigs === null || alertConfigs === void 0 ? void 0 : alertConfigs.find(function (c) { return c.id === alert_1.alert_config_id; });
                    if ((config === null || config === void 0 ? void 0 : config.notification_channels) && config.notification_channels.length > 0) {
            ...
            case 10:
                ...
                return [2 /*return*/, new Response(JSON.stringify({
                        ...
                        processed: {
                            ...
                            configurations: (alertConfigs === null || alertConfigs === void 0 ? void 0 : alertConfigs.length) || 0,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            switch (config.alert_type) {
                case 'low_stock':
                    if (config.threshold_unit === 'quantity' &&
                        ...
                        alerts.push({
                            ...
                            message: "Estoque baixo: ".concat(productData.name || 'Produto', " com apenas ").concat(product.quantity_available, " unidades dispon\u00EDveis (m\u00EDnimo: ").concat(config.threshold_value, ")"),
                            status: 'active'
                        });
                    }
                    break;
                    ...
                    if (productData.expiry_date && config.threshold_unit === 'days') {
                        ...
                        if (daysToExpiry <= config.threshold_value && daysToExpiry > 0) {
                            alerts.push({
                                ...
                                threshold_value: config.threshold_value,
                                message: "Produto pr\u00F3ximo ao vencimento: ".concat(productData.name || 'Produto', " vence em ").concat(daysToExpiry, " dias"),
                                status: 'active'
                            });
                        }
                    }
                ...
                case 'expired':
                    if (productData.expiry_date) {
                        ...
                        today = new Date();
                        if (expiryDate < today) {
                            daysExpired = Math.ceil((today.getTime() - expiryDate.getTime()) / (1000 * 60 * 60 * 24));
                            alerts.push({
                                clinic_id: config.clinic_id,
                                alert_config_id: config.id,
                                product_id: product.product_id,
                                ...
                                threshold_value: 0,
                                message: "Produto vencido: ".concat(productData.name || 'Produto', " venceu h\u00E1 ").concat(daysExpired, " dias"),
                                status: 'active'
                            });
                        }
                    }
                ...
                case 'overstock':
                    if (config.threshold_unit === 'quantity' &&
                        ...
                        alerts.push({
                            ...
                            current_value: product.quantity_available,
                            threshold_value: config.threshold_value,
                            message: "Excesso de estoque: ".concat(productData.name || 'Produto', " com ").concat(product.quantity_available, " unidades (m\u00E1ximo recomendado: ").concat(config.threshold_value, ")"),
                            status: 'active'
                        });
                    }
                    break;
...
function updatePerformanceMetrics(supabase, clinicIds) {
    return __awaiter(this, void 0, void 0, function () {
        var _i, clinicIds_2, clinicId, today, inventory, totalValue, productsInRange, accuracyPercentage, metricsError, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
