          ...
          case 3:
            ...
            invoiceHtml =
              '\n        <!DOCTYPE html>\n        <html>\n        <head>\n          <meta charset="utf-8">\n          <title>Fatura #'
                ...
                .concat(
                  payload.clinicName,
                  '</h1>\n                <p style="color: #666; margin: 5px 0;">Fatura de Servi\u00E7os</p>\n              </div>\n              <div style="text-align: right;">\n                <h2 style="color: #1e40af; margin: 0;">Fatura #',
                )
                .concat(
                  invoice.invoice_number,
                  '</h2>\n                <p style="color: #666; margin: 5px 0;">Data: ',
                )
                .concat(
                  invoiceDate,
                  '</p>\n              </div>\n            </header>\n            \n            <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">\n              <h3 style="color: #1e40af; margin-top: 0;">Ol\u00E1, ',
                )
                .concat(
                ...
                .concat(
                  invoice.description
                    ? "<li>Observa\u00E7\u00E3o: ".concat(invoice.description, "</li>")
                    : "",
            ...
            return [
              ...
              resend.emails.send({
                ...
                subject: "\uD83D\uDCB0 Fatura #"
                  .concat(invoice.invoice_number, " - R$ ")
                  .concat(payload.amount.toFixed(2), " - Venc: ")
                  .concat(dueDate),
                html: invoiceHtml,
                headers: {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 3:
            ...
            dueDate = new Date(
              (invoice === null || invoice === void 0 ? void 0 : invoice.due_date) ||
                payload.dueDate,
            );
            today = new Date();
            ...
            reminderHtml =
              '\n        <!DOCTYPE html>\n        <html>\n        <head>\n          <meta charset="utf-8">\n          <title>Lembrete de Pagamento - '
                ...
                .concat(
                  payload.amount.toFixed(2),
                  '</p>\n                <p style="margin: 5px 0;"><strong>\uD83D\uDCC5 Vencimento:</strong> ',
                )
                .concat(
                  payload.dueDate,
                  '</p>\n                <p style="margin: 5px 0;"><strong>\uD83E\uDDFE Fatura:</strong> Para ',
                )
                .concat(
                  payload.recipientName,
                ...
                .concat(
                  payload.invoiceUrl
                    ? '\n                <div style="margin: 25px 0;">\n                  <a href="'.concat(
                        payload.invoiceUrl,
                        '" style="display: inline-block; background: #059669; color: white; padding: 15px 30px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px;">\n                    \uD83D\uDCB3 Pagar Agora\n                  </a>\n                </div>\n              ',
                      )
                    : "",
            ...
            return [
              ...
              resend.emails.send({
                ...
                subject:
                  daysOverdue > 0
                    ? "\u26A0\uFE0F Pagamento em Atraso - R$ "
                        .concat(payload.amount.toFixed(2), " (")
                        .concat(daysOverdue, " dia")
                        .concat(daysOverdue > 1 ? "s" : "", ")")
                    : "\uD83D\uDCB0 Lembrete: Fatura vence hoje - R$ ".concat(
                        payload.amount.toFixed(2),
                      ),
                html: reminderHtml,
                headers: {
