        ...
        return __generator(this, function (_q) {
            switch (_q.label) {
                ...
                case 3:
                    ...
                    emailHtml = "\n        <!DOCTYPE html>\n        <html>\n        <head>\n          <meta charset=\"utf-8\">\n          <title>Confirma\u00E7\u00E3o de Consulta - ".concat(payload.clinicName, "</title>\n        </head>\n        <body style=\"font-family: Arial, sans-serif; line-height: 1.6; color: #333;\">\n          <div style=\"max-width: 600px; margin: 0 auto; padding: 20px;\">\n            <header style=\"text-align: center; border-bottom: 2px solid #e0e0e0; padding-bottom: 20px; margin-bottom: 30px;\">\n              <h1 style=\"color: #2563eb; margin: 0;\">").concat(payload.clinicName, "</h1>\n              <p style=\"color: #666; margin: 5px 0;\">Consulta Confirmada \u2728</p>\n            </header>\n            \n            <div style=\"background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;\">\n              <h2 style=\"color: #1e40af; margin-top: 0;\">Ol\u00E1, ").concat(payload.recipientName, "!</h2>\n              <p>Sua consulta foi confirmada com sucesso. Aqui est\u00E3o os detalhes:</p>\n              \n              <div style=\"background: white; padding: 15px; border-radius: 6px; border-left: 4px solid #10b981;\">\n                <p><strong>\uD83D\uDCC5 Data:</strong> ").concat(new Date(appointment.appointment_date).toLocaleDateString('pt-BR', {
                        weekday: 'long',
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric'
                    }), "</p>\n                <p><strong>\uD83D\uDD50 Hor\u00E1rio:</strong> ").concat(appointment.appointment_time, "</p>\n                <p><strong>\uD83D\uDC68\u200D\u2695\uFE0F Profissional:</strong> ").concat(Array.isArray(appointment.professionals) ? (_b = appointment.professionals[0]) === null || _b === void 0 ? void 0 : _b.name : (_c = appointment.professionals) === null || _c === void 0 ? void 0 : _c.name, "</p>\n                <p><strong>\uD83D\uDC85 Servi\u00E7o:</strong> ").concat(Array.isArray(appointment.service_types) ? (_d = appointment.service_types[0]) === null || _d === void 0 ? void 0 : _d.name : (_e = appointment.service_types) === null || _e === void 0 ? void 0 : _e.name, "</p>\n                <p><strong>\u23F1\uFE0F Dura\u00E7\u00E3o:</strong> ").concat(Array.isArray(appointment.service_types) ? (_f = appointment.service_types[0]) === null || _f === void 0 ? void 0 : _f.duration_minutes : (_g = appointment.service_types) === null || _g === void 0 ? void 0 : _g.duration_minutes, " minutos</p>\n                ").concat((Array.isArray(appointment.service_types) ? (_h = appointment.service_types[0]) === null || _h === void 0 ? void 0 : _h.price : (_j = appointment.service_types) === null || _j === void 0 ? void 0 : _j.price) ? "<p><strong>\uD83D\uDCB0 Valor:</strong> R$ ".concat((_m = (Array.isArray(appointment.service_types) ? (_k = appointment.service_types[0]) === null || _k === void 0 ? void 0 : _k.price : (_l = appointment.service_types) === null || _l === void 0 ? void 0 : _l.price)) === null || _m === void 0 ? void 0 : _m.toFixed(2), "</p>") : '', "\n              </div>\n            </div>\n            \n            <div style=\"background: #fef3c7; border: 1px solid #f59e0b; border-radius: 6px; padding: 15px; margin: 20px 0;\">\n              <h3 style=\"color: #92400e; margin-top: 0;\">\uD83D\uDCDD Lembrete Importante</h3>\n              <ul style=\"color: #92400e; margin: 0;\">\n                <li>Chegue 10 minutos antes do hor\u00E1rio marcado</li>\n                <li>Traga um documento de identidade</li>\n                <li>Para reagendamentos, entre em contato conosco</li>\n                ").concat(appointment.notes ? "<li>Observa\u00E7\u00E3o especial: ".concat(appointment.notes, "</li>") : '', "\n              </ul>\n            </div>\n            \n            <div style=\"text-align: center; margin: 30px 0;\">\n              <p>Precisa reagendar ou tem alguma d\u00FAvida?</p>\n              <p style=\"color: #666; font-size: 14px;\">\n                Entre em contato conosco<br>\n                \uD83D\uDCF1 WhatsApp: Dispon\u00EDvel no seu painel<br>\n                \u2709\uFE0F Email: Responda este email\n              </p>\n            </div>\n            \n            <footer style=\"text-align: center; border-top: 1px solid #e0e0e0; padding-top: 20px; color: #666; font-size: 12px;\">\n              <p>\u00A9 ").concat(new Date().getFullYear(), " ").concat(payload.clinicName, " - Powered by NeonPro</p>\n              <p>Este \u00E9 um email autom\u00E1tico. Voc\u00EA recebeu porque tem uma consulta agendada conosco.</p>\n            </footer>\n          </div>\n        </body>\n        </html>\n      ");
                    return [4 /*yield*/, resend.emails.send({
                            from: "".concat(payload.clinicName, " <noreply@neonpro.app>"),
                            to: [payload.recipientEmail],
                            subject: "\u2728 Consulta Confirmada - ".concat(payload.appointmentDate, " \u00E0s ").concat(payload.appointmentTime),
                            html: emailHtml,
                            headers: {
