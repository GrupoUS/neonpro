      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Generate personalized treatment recommendations using advanced AI
            analysis
          </p>
        </div>
        ...
        <TabsContent value="generate" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select a patient and generate AI-powered treatment
                recommendations
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-4">
                <div className="p-4 border rounded-lg bg-blue-50">
                  <p className="text-sm text-blue-800 mb-2">
                    <strong>Demo Mode:</strong> For demonstration purposes,
              ...
              <div className="space-y-4">
                <div className="p-6 border rounded-lg text-center">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    here. Track recommendation accuracy, user feedback, and
                    system performance.
                  </p>
                </div>
              </div>
