...
import { ClinicAIAssistant, type AIResponse } from '@/chatbot/ClinicAIAssistant'; // Ajustado para o caminho do NeonPro
...
export function useClinicAI() {
  ...
  const [assistant, setAssistant] = useState<ClinicAIAssistant | null>(null);
