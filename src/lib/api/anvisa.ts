...
export interface ANVISAAdverseEvent {
  id: string;
  clinic_id: string;
  event_id: string;
...
export interface ANVISAProfessional {
  id: string;
  clinic_id: string;
  user_id: string;
...
export class ANVISAComplianceAPI {
  ...
  async getProducts(clinicId: string): Promise<ANVISAProduct[]> {
    try {
      ...
      console.error('Error fetching ANVISA products:', error);
  ...
  async getProduct(productId: string): Promise<ANVISAProduct | null> {
    try {
      ...
      console.error('Error fetching ANVISA product:', error);
  ...
  async createProduct(clinicId: string, productData: z.infer<typeof ANVISAProductSchema>): Promise<ANVISAProduct> {
    try {
      ...
      console.error('Error creating ANVISA product:', error);
  ...
  async updateProduct(productId: string, updates: Partial<z.infer<typeof ANVISAProductSchema>>): Promise<ANVISAProduct> {
    try {
      ...
      console.error('Error updating ANVISA product:', error);
  ...
  async deleteProduct(productId: string): Promise<boolean> {
    try {
      ...
      console.error('Error deleting ANVISA product:', error);
  ...
  async getProductsNearingExpiry(clinicId: string, daysAhead: number = 30): Promise<any[]> {
    try {
      ...
      console.error('Error fetching products nearing expiry:', error);
  ...
  async getProcedures(clinicId: string): Promise<ANVISAProcedure[]> {
    try {
      ...
      console.error('Error fetching ANVISA procedures:', error);
  ...
  async getProcedure(procedureId: string): Promise<ANVISAProcedure | null> {
    try {
      ...
      console.error('Error fetching ANVISA procedure:', error);
  ...
  async verifyProfessionalAuthorization(professionalId: string, procedureCode: string): Promise<boolean> {
    try {
      ...
      console.error('Error verifying professional authorization:', error);
  ...
  async updateAdverseEventStatus(eventId: string, status: ANVISAEventStatus, notes?: string): Promise<boolean> {
    try {
      ...
      console.error('Error updating adverse event status:', error);
  ...
  async getPendingANVISANotifications(clinicId: string): Promise<any[]> {
    try {
      ...
      console.error('Error fetching pending ANVISA notifications:', error);
  ...
  async getProfessionals(clinicId: string): Promise<ANVISAProfessional[]> {
    try {
      ...
      console.error('Error fetching ANVISA professionals:', error);
  ...
  async updateProfessionalComplianceScore(professionalId: string): Promise<number> {
    try {
      ...
      console.error('Error updating professional compliance score:', error);
  ...
  async calculateClinicComplianceScore(clinicId: string): Promise<any> {
    try {
      ...
      console.error('Error calculating clinic compliance score:', error);
  ...
  async getBatchesNearingExpiry(clinicId: string, daysAhead: number = 30): Promise<any[]> {
    try {
      ...
      console.error('Error fetching batches nearing expiry:', error);
  ...
  async useProductFromBatch(batchId: string, quantity: number, procedureId?: string): Promise<boolean> {
    try {
      ...
      console.error('Error using product from batch:', error);
