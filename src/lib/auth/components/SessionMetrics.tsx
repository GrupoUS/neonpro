          ...
          <div className="bg-white p-4 rounded-lg border">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-2xl font-bold ${getSecurityStatusColor(metrics?.securityEvents || 0)}`}>
        ...
        <div className="p-4 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className={`bg-gradient-to-r p-4 rounded-lg ${
              (metrics?.securityEvents || 0) === 0 ? 'from-green-50 to-green-100' :
              (metrics?.securityEvents || 0) <= 2 ? 'from-yellow-50 to-yellow-100' :
              'from-red-50 to-red-100'
            }`}>
              <div className="flex items-center justify-between">
                <div>
                  <p className={`text-sm font-medium ${
                    (metrics?.securityEvents || 0) === 0 ? 'text-green-600' :
                    (metrics?.securityEvents || 0) <= 2 ? 'text-yellow-600' :
                    'text-red-600'
                  }`}>
                    Security Events
                  </p>
                  <p className={`text-2xl font-bold ${
                    (metrics?.securityEvents || 0) === 0 ? 'text-green-900' :
                    (metrics?.securityEvents || 0) <= 2 ? 'text-yellow-900' :
                    'text-red-900'
                  }`}>
                    {metrics?.securityEvents || 0}
                  </p>
