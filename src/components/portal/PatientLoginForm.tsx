...
import { PatientPortalAuthService } from '@/lib/services/patient-portal-auth'
import { registerPortalServiceWorker, enableOfflineSupport, enableInstallPrompt } from '@/lib/utils/pwa-config'
