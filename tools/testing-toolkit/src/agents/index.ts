...
export const AGENT_REGISTRY = {
  'architect-review': {
    ...
    qualityGates: ['architecture-compliance', 'pattern-validation', 'scalability-check'],
  },
  'code-reviewer': {
    name: 'code-reviewer',
    description: 'Code quality and performance analysis',
    specialties: ['quality', 'performance', 'maintainability'],
    qualityGates: ['code-quality', 'performance-metrics', 'maintainability-score'],
  },
  'security-auditor': {
    name: 'security-auditor',
    description: 'Security and compliance validation',
    specialties: ['security', 'compliance', 'vulnerabilities'],
    qualityGates: ['security-scan', 'compliance-check', 'vulnerability-assessment'],
  },
  'tdd-orchestrator': {
