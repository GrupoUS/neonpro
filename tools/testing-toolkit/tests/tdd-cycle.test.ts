...
describe('TDDCycle', () => {
  ...
  describe('redPhase', () => {
    ...
    it('should handle different agent configurations', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith('Primary Agent: tdd-orchestrator');
      expect(mockConsoleLog).toHaveBeenCalledWith(
  ...
  describe('greenPhase', () => {
    it('should complete GREEN phase when implementation passes', async () => {
      ...
      expect(result).toBe(true);
      expect(mockConsoleLog).toHaveBeenCalledWith('🟢 GREEN Phase: Test Feature');
      expect(mockConsoleLog).toHaveBeenCalledWith('✅ GREEN Phase complete - Tests passing');
    });
    ...
    it('should fail GREEN phase when implementation fails', async () => {
      ...
      expect(result).toBe(false);
      expect(mockConsoleError).toHaveBeenCalledWith('❌ GREEN Phase failed:', expect.any(Error));
    });
  ...
  describe('refactorPhase', () => {
    it('should complete REFACTOR phase when refactoring succeeds', async () => {
      ...
      expect(result).toBe(true);
      expect(mockConsoleLog).toHaveBeenCalledWith('🔄 REFACTOR Phase: Test Feature');
      expect(mockConsoleLog).toHaveBeenCalledWith('✅ REFACTOR Phase complete - Code improved');
    });
    ...
    it('should fail REFACTOR phase when refactoring fails', async () => {
      ...
      expect(result).toBe(false);
      expect(mockConsoleError).toHaveBeenCalledWith('❌ REFACTOR Phase failed:', expect.any(Error));
    });
