...
describe('TestRunner', () => {
  ...
  describe('runTest', () => {
    it('should run a successful test', async () => {
      ...
      expect(result.category).toBe('unit-tests');
  ...
  describe('getSuite', () => {
    ...
    it('should handle suite with all tests having coverage', () => {
      const mockResults: TestResult[] = [
        { name: 'test 1', category: 'unit-tests', passed: true, duration: 100, coverage: 85 },
        { name: 'test 2', category: 'unit-tests', passed: true, duration: 120, coverage: 90 },
        { name: 'test 3', category: 'unit-tests', passed: true, duration: 80, coverage: 88 },
      ];
    ...
    it('should handle suite with no tests having coverage', () => {
      const mockResults: TestResult[] = [
        { name: 'test 1', category: 'unit-tests', passed: true, duration: 100 },
        { name: 'test 2', category: 'unit-tests', passed: false, duration: 50 },
        { name: 'test 3', category: 'unit-tests', passed: true, duration: 75 },
      ];
