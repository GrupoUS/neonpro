		...
		ha ||
			...
			((Et, _zt) => {
				((_C, De) => {
					...
					const ze = se && (ie || (z && (de === undefined || de < 12.11))),
						fe = I || (b && N >= 9);
					function H(e) {
					...
					function y(e) {
						...
						while (n?.shadowRoot?.activeElement) {
					...
					const be = function be() {
						(this.id = undefined),
							(this.f = undefined),
							(this.time = 0),
							(this.handler = ue(this.onTimeout, this));
					};
					(be.prototype.onTimeout = (e) => {
						(e.id = 0),
							e.time <= Date.now()
								? e.f()
								: setTimeout(e.handler, e.time - Date.now());
					}),
						(be.prototype.set = function set(e, t) {
							this.f = t;
							const n = Date.now() + e;
							(!this.id || n < this.time) &&
					...
					function T(e, t, n) {
						for (let r = 0, i = n(t); r < e.length && n(e[r]) <= i; ) {
							r++;
						}
						e.splice(r, 0, t);
					}
					...
					function Me(e) {
						return e.codePointAt(0) >= 768 && Be.test(e);
					}
					function Lt(e, t, n) {
						while ((n < 0 ? t > 0 : t < e.length) && Me(e.charAt(t))) {
							t += n;
						}
						return t;
					}
					...
					const mi = (() => {
						...
						return (u, h) => {
							...
							for (let k = u.length, x = [], M = 0; M < k; ++M) {
								x.push(n(u.codePointAt(M)));
							}
							for (let E = 0, R = v; E < k; ++E) {
								const U = x[E];
								U === "m" ? (x[E] = R) : (R = U);
							}
							for (let Q = 0, G = v; Q < k; ++Q) {
								const ee = x[Q];
								ee === "1" && G === "r"
									? (x[Q] = "n")
									: o.test(ee) && ((G = ee), ee === "r" && (x[Q] = "R"));
							}
							for (let me = 1, pe = x[0]; me < k - 1; ++me) {
								const Fe = x[me];
								Fe === "+" && pe === "1" && x[me + 1] === "1"
									? (x[me] = "1")
									: Fe === "," &&
					...
					function We(e, t) {
						let n = e.order;
						return n === undefined && (n = e.order = mi(e.text, t)), n;
					}
					const Bn = [],
						ve = (e, t, n) => {
					...
					function Ot(e) {
						const t = e._handlers?.cursorActivity;
						if (t) {
							for (
								let n =
					...
					function Bt(e) {
						(e.prototype.on = function on(t, n) {
							ve(this, t, n);
						}),
							(e.prototype.off = function off(t, n) {
								dt(this, t, n);
							});
					}
					function ht(e) {
					...
					function yt(e) {
						return e.defaultPrevented !== undefined
							? e.defaultPrevented
							: e.returnValue === !1;
					}
					function ar(e) {
					...
					function sr(e) {
						...
						const t = J(e, document.createTextNode("AخA")),
...
`,
					...
					function Ir(e) {
						if (typeof e === "string" && Object.hasOwn(Ht, e)) {
							e = Ht[e];
						} else if (
							e &&
					...
					const fr = {};
					function Br(e, t) {
						const n = Object.hasOwn(fr, e) ? fr[e] : (fr[e] = {});
						Te(t, n);
					}
					function Gt(e, t) {
						if (t === !0) {
						...
						for (const r in t) {
							let i = t[r];
							Array.isArray(i) && (i = i.concat([])), (n[r] = i);
						}
						return n;
					}
					function sn(e, t) {
					...
					(Je.prototype.eol = function eol() {
						return this.pos >= this.string.length;
					}),
						(Je.prototype.sol = function sol() {
							return this.pos === this.lineStart;
						}),
						(Je.prototype.peek = function peek() {
							return this.string.charAt(this.pos) || void 0;
						}),
						(Je.prototype.next = function next() {
							if (this.pos < this.string.length) {
								return this.string.charAt(this.pos++);
							}
						}),
						(Je.prototype.eat = function eat(e) {
						...
						(Je.prototype.eatWhile = function eatWhile(e) {
							for (const { pos: _t } = this; this.eat(e); ) {}
							return this.pos > t;
						}),
						(Je.prototype.eatSpace = function eatSpace() {
							for (
								const { pos: _e } = this;
						...
						(Je.prototype.skipToEnd = function skipToEnd() {
							this.pos = this.string.length;
						}),
						(Je.prototype.skipTo = function skipTo(e) {
							const t = this.string.indexOf(e, this.pos);
							if (t !== -1) {
								return (this.pos = t), !0;
							}
						}),
						(Je.prototype.backUp = function backUp(e) {
							this.pos -= e;
						}),
						(Je.prototype.column = function column() {
							return (
						...
						(Je.prototype.indentation = function indentation() {
							return (
								Le(this.string, undefined, this.tabSize) -
								(this.lineStart
									? Le(this.string, this.lineStart, this.tabSize)
									: 0)
							);
						}),
						(Je.prototype.match = function match(e, t, n) {
							if (typeof e === "string") {
								const r = (l) => (n ? l.toLowerCase() : l),
									i = this.string.slice(this.pos, e.length);
								if (r(i) === r(e)) {
						...
						(Je.prototype.current = function current() {
							return this.string.slice(this.start, this.pos);
						}),
						(Je.prototype.hideFirstChars = function hideFirstChars(e, t) {
							this.lineStart += e;
							try {
								return t();
							} finally {
						...
						(Je.prototype.lookAhead = function lookAhead(e) {
							const { lineOracle: t } = this;
							return t?.lookAhead(e);
						}),
						(Je.prototype.baseToken = function baseToken() {
							const { lineOracle: e } = this;
							return e?.baseToken(this.pos);
						});
					function ce(e, t) {
					...
					function f(e) {
						...
						for (
							let t = e.parent, n = oe(t.lines, e), r = t.parent;
							r;
							t = r, r = r.parent
						) {
					...
					function L(e, t, n) {
						if ((n === void 0 && (n = undefined), !(this instanceof L))) {
							return new L(e, t, n);
						}
					...
					const Hn = function Hn(e, t) {
							(this.state = e), (this.lookAhead = t);
						},
						Xt = function Xt(e, t, n, r) {
							(this.state = t),
								(this.doc = e),
								(this.line = n),
					...
					(Xt.prototype.lookAhead = function lookAhead(e) {
						...
						(Xt.prototype.baseToken = function baseToken(e) {
							if (!this.baseTokens) {
								return;
							}
							...
							return {
								type: t?.replace(/( |^)overlay .*/, ""),
								size: this.baseTokens[this.baseTokenPos] - e,
							};
						}),
						(Xt.prototype.nextLine = function nextLine() {
						...
						(Xt.prototype.save = function save(e) {
					...
					function vo(e, t, n, r) {
						const i = [e.state.modeGen],
							o = {};
						wo(e, t.text, e.doc.mode, n, (u, h) => i.push(u, h), o, r);
						for (
							let l = n.state,
								a = (u) => {
									n.baseTokens = i;
						...
						return {
							styles: i,
							classes: o.bgClass || o.textClass ? o : undefined,
						};
					}
					function mo(e, t, n) {
						if (!t.styles || t.styles[0] !== e.state.modeGen) {
							...
							i && (r.state = i),
								...
								o.classes
									...
									: t.styleClasses && (t.styleClasses = undefined),
					...
					function wo(e, t, n, r, i, o, l) {
						...
						a === undefined && (a = e.options.flattenSpans);
						let s = 0,
							u,
							h = new Je(t, e.options.tabSize, r),
							v,
							k = e.options.addModeClass && [undefined];
					...
					function Ha(e, t, n) {
						for (
							...
							const h = Le(s.text, undefined, e.options.tabSize);
							(i === undefined || r > h) && ((i = a - 1), (r = h));
						}
						return i;
					}
					function Ra(e, t) {
						if (
							...
							for (let n = e.first, r = t - 1; r > n; r--) {
								const i = ce(e, r).stateAfter;
						...
						if (e) {
							for (let i = 0; i < e.length; ++i) {
								...
								if (
									...
									(r || (r = [])).push(new Rn(l, o.from, s ? undefined : o.to));
								}
							}
						}
						return r;
							...
							for (let i = 0; i < e.length; ++i) {
								...
								if (
									...
									(r || (r = [])).push(
										new Rn(
											l,
											s ? undefined : o.from - t,
											o.to === undefined ? undefined : o.to - t,
										),
									);
								}
							}
					...
					function wi(e, t) {
						...
						const n = A(e, t.from.line) && ce(e, t.from.line).markedSpans,
						...
						if (a) {
							for (let v = 0; v < a.length; ++v) {
								const k = a[v];
								if (k.to === undefined) {
									const x = cn(s, k.marker);
									x
										? u && (k.to = x.to === undefined ? undefined : x.to + h)
										: (k.to = i);
								}
							}
						}
						if (s) {
							for (let M = 0; M < s.length; ++M) {
								const E = s[M];
								if ((E.to !== undefined && (E.to += h), E.from === undefined)) {
									const R = cn(a, E.marker);
									R || ((E.from = h), u && (a || (a = [])).push(E));
								} else {
									(E.from += h), u && (a || (a = [])).push(E);
								}
							}
						}
						...
						const U = [a];
						if (!u) {
							let Q = t.text.length - 2,
								G;
							if (Q > 0 && a) {
								for (let ee = 0; ee < a.length; ++ee) {
									a[ee].to === undefined &&
										(G || (G = [])).push(
											new Rn(a[ee].marker, undefined, undefined),
										);
								}
							}
					...
					function Ya(e, t, n) {
						...
						if (
							(e.iter(t.line, n.line + 1, (x) => {
								if (x.markedSpans) {
									for (let M = 0; M < x.markedSpans.length; ++M) {
										const E = x.markedSpans[M].marker;
										E.readOnly &&
											(!r || oe(r, E) === -1) &&
											(r || (r = [])).push(E);
									}
						...
						for (let i = [{ from: t, to: n }], o = 0; o < r.length; ++o) {
					...
					function Lo(e) {
						const { markedSpans: t } = e;
						if (t) {
							for (let n = 0; n < t.length; ++n) {
								t[n].marker.detachLine(e);
							}
							e.markedSpans = undefined;
						}
					}
					function Co(e, t) {
						if (t) {
					...
					function Za(e, t) {
						...
						if (n) {
							for (let i = 0; i < n.length; ++i) {
								const o = n[i];
								o.marker.collapsed &&
									(o.from === undefined || o.from < t) &&
									(o.to === undefined || o.to > t) &&
									(!r || Si(r, o.marker) < 0) &&
									(r = o.marker);
							}
						}
					...
					function er(e) {
						e = qt(e);
						for (let t = 0, n = e.parent, r = 0; r < n.lines.length; ++r) {
							const i = n.lines[r];
							if (i === e) {
								break;
							}
					...
					function Un(e) {
						...
						for (let t = e.text.length, n, r = e; (n = Mo(r)); ) {
							const i = n.find(0, !0);
					...
					const Hr = function Hr(e, t, n) {
						(this.text = e), Co(this, t), (this.height = n ? n(this) : 1);
					};
					(Hr.prototype.lineNo = function lineNo() {
						return f(this);
					}),
						Bt(Hr);
					function Va(e, t, n, r) {
						(e.text = t),
							e.stateAfter && (e.stateAfter = undefined),
							e.styles && (e.styles = undefined),
							e.order !== undefined && (e.order = undefined),
							Lo(e),
							Co(e, n);
						const i = r ? r(e) : 1;
						i !== e.height && Ft(e, i);
					...
					function Eo(e, t) {
						...
						const n = t.addModeClass ? ts : es;
						return n[e] || (n[e] = e.replaceAll(/\S+/g, "cm-$&"));
					}
					function No(e, t) {
						const n = S(
								"span",
						...
						for (let i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
							...
							ls(o, r, mo(e, o, a)),
								...
								r.map.length === 0 &&
									r.map.push(0, 0, r.content.append(Wn(e.display.measure))),
								i === 0
					...
					function rs(e) {
						...
						return (
							(t.title = `\\u${e.codePointAt(0).toString(16)}`),
					...
					function ns(e, t, n, r, i, o, l) {
						if (t) {
							let a = e.splitSpaces ? is(t, e.trailingSpace) : t,
							...
							if (s.test(t)) {
								...
								for (let v = 0; ; ) {
									...
									if (x) {
										const M = document.createTextNode(a.slice(v, v + x));
										b && N < 9 ? h.append(d("span", [M])) : h.append(M),
									...
									let E = void 0;
									if (k[0] === "	") {
										const R = e.cm.options.tabSize,
											U = R - (e.col % R);
										(E = h.append(d("span", et(U), "cm-tab"))),
...
`
											...
											: ((E = e.cm.options.specialCharPlaceholder(k[0])),
												E.setAttribute("cm-text", k[0]),
												b && N < 9 ? h.append(d("span", [E])) : h.append(E),
												(e.col += 1));
									}
							...
							if (
								((e.trailingSpace = a.codePointAt(t.length - 1) === 32),
								n || r || i || u || o || l)
							) {
								let Q = n || "";
								r && (Q += r), i && (Q += i);
								const G = d("span", [h], Q, o);
								if (l) {
									for (const ee in l) {
										Object.hasOwn(l, ee) &&
											ee !== "style" &&
								...
								return e.content.append(G);
							}
							e.content.append(h);
						}
					}
					function is(e, t) {
						if (e.length > 1 && !/ {2}/.test(e)) {
							return e;
						}
						for (let n = t, r = "", i = 0; i < e.length; i++) {
							let o = e.charAt(i);
							o === " " &&
								n &&
								(i === e.length - 1 || e.codePointAt(i + 1) === 32) &&
								(o = " "),
								(r += o),
								(n = o === " ");
						}
					...
					function os(e, t) {
						return (n, r, i, o, l, a, s) => {
							...
							for (let u = n.pos, h = u + r.length; ; ) {
								...
								e(n, r.slice(0, v.to - u), i, o, undefined, a, s),
									(o = undefined),
									(r = r.slice(v.to - u)),
									(u = v.to);
							}
					...
					function Oo(e, t, n, r) {
						...
						i && e.map.push(e.pos, e.pos + t, i),
							!r &&
								...
								(i || (i = e.content.append(document.createElement("span"))),
								i.setAttribute("cm-marker", n.id)),
							i && (e.cm.display.input.setUneditable(i), e.content.append(i)),
							(e.pos += t),
							(e.trailingSpace = !1);
					}
					function ls(e, t, n) {
						...
						for (
							...
							if (x === s) {
								(M = E = R = k = ""),
									...
									(U = undefined),
									(x = 1 / 0);
								for (let G = [], ee = void 0, me = 0; me < r.length; ++me) {
									const pe = r[me],
										Fe = pe.marker;
									if (
										Fe.type === "bookmark" &&
										...
										if (
											...
											for (const Ke in Fe.attributes) {
												(Q || (Q = {}))[Ke] = Fe.attributes[Ke];
											}
										}
										Fe.collapsed && (!U || Si(U.marker, Fe) < 0) && (U = pe);
									} else {
										pe.from > s && x > pe.from && (x = pe.from);
									}
								}
								if (ee) {
									for (let st = 0; st < ee.length; st += 2) {
										ee[st + 1] === x && (E += ` ${ee[st]}`);
									}
								}
								if (!U || U.from === s) {
					...
					function Gn(e, t, n) {
						for (let r = [], i, o = t; o < n; o = i) {
							const l = new Po(e.doc, ce(e.doc, o), o);
							(i = o + l.size), r.push(l);
						}
						return r;
					}
					...
					function zo(e, t) {
						...
						return n && n.line === t.line
							? ((e.display.externalMeasured = undefined),
								(t.measure = n.measure),
								n.built)
							: No(e, t);
					}
					...
					function Bo(e, t, n, r) {
						if (
							(t.gutter &&
								(t.node.removeChild(t.gutter), (t.gutter = undefined)),
							t.gutterBackground &&
								(t.node.removeChild(t.gutterBackground),
								(t.gutterBackground = undefined)),
							t.line.gutterClass)
						) {
							const i = hn(t);
					...
					function hs(e, t, n) {
						t.alignable && (t.alignable = undefined);
						for (
							let r = H("CodeMirror-linewidget"),
								i = t.node.firstChild,
								o = void 0;
							i;
							i = o
					...
					function pn(e) {
						...
						if (!m(document.body, e.node)) {
							...
							e.coverGutter &&
								...
								J(t.display.measure, d("div", [e.node], undefined, n));
						}
					...
					function Ho(e) {
						...
						const t = J(e.measure, d("pre", "x", "CodeMirror-line-like")),
							n = window.getComputedStyle
								? window.getComputedStyle(t)
								: t.currentStyle,
							r = {
								left: Number.parseInt(n.paddingLeft, 10),
								right: Number.parseInt(n.paddingRight, 10),
							};
						return (
							!(Number.isNaN(r.left) || Number.isNaN(r.right)) &&
								(e.cachedPaddingH = r),
							r
						);
					}
					...
					function vs(e, t, n) {
						...
						if (!t.measure.heights || (r && t.measure.width !== i)) {
							...
							if (r) {
								t.measure.width = i;
								for (
									let l = t.text.firstChild.getClientRects(), a = 0;
									a < l.length - 1;
									a++
								) {
									const s = l[a],
					...
					function qr(e, t) {
						...
						r && !r.text
							? (r = undefined)
							: r?.changes && (Io(e, r, n, Ii(e)), (e.curOp.forceUpdate = !0)),
							r || (r = ms(e, t));
						const i = Ro(r, t, n);
						return {
							line: t,
					...
					function Ko(e, t, n) {
						for (let r, i, o, l, a, s, u = 0; u < e.length; u += 3) {
							if (
								((a = e[u]),
								(s = e[u + 1]),
								t < a
					...
					function xs(e, t, n, r) {
						...
						if (o.nodeType === 3) {
							for (let h = 0; h < 4; h++) {
								while (l && Me(t.line.text.charAt(i.coverStart + l))) {
									--l;
								}
								while (
					...
					function Uo(e) {
						if (
							e.measure &&
							((e.measure.cache = {}), (e.measure.heights = undefined), e.rest)
						) {
					...
					function Go(e) {
						(e.display.externalMeasure = undefined), D(e.display.lineMeasure);
					...
					function gn(e) {
						Go(e),
							...
							(e.display.lineNumChars = undefined);
					}
					function Xo(e) {
						return O && re
							? -(
									e.body.getBoundingClientRect().left -
									Number.parseInt(getComputedStyle(e.body).marginLeft, 10)
								)
					...
					function Yo(e) {
						return O && re
							? -(
									...
									Number.parseInt(getComputedStyle(e.body).marginTop, 10)
								)
					...
					function jt(e, t, n, r, i, o) {
						...
						function l(M, E) {
							const R = Zt(e, i, M, E ? "right" : "left", o);
							return (
						...
						const v = lr(a, s, u),
							k = br,
							x = h(s, v, u === "before");
						return k !== undefined && (x.other = h(s, k, u !== "before")), x;
					}
					function Jo(e, t) {
						let n = 0;
						(t = Ce(e.doc, t)),
							e.options.lineWrapping || (n = Kr(e.display) * t.ch);
						const r = ce(e.doc, t.line),
							i = er(r) + Xn(e.display);
					...
					function Oi(e, t, n) {
						...
						if (((n += e.display.viewOffset), n < 0)) {
							return Ni(r.first, 0, undefined, -1, -1);
						}
						let i = g(r, n),
							o = r.first + r.size - 1;
						if (i > o) {
					...
					function Qo(e, t, n, r) {
						r -= Ei(t);
						let i = t.text.length,
							o = Nt((l) => Zt(e, n, l - 1).bottom <= r, i, 0);
						return (
							(i = Nt((l) => Zt(e, n, l).top > r, o, i)), { begin: o, end: i }
						);
					}
					function Vo(e, t, n, r) {
						n || (n = qr(e, t));
					...
					function ks(e, t, n, r, i) {
						...
						if (h) {
							const v = (e.options.lineWrapping ? Ss : ws)(e, t, n, o, h, r, i);
							(u = v.level !== 1),
								(a = u ? v.from : v.to - 1),
								(s = u ? v.to : v.from - 1);
						}
									...
									M === 0
										...
										: M === t.text.length
											...
											: Zt(e, o, M - (u ? 1 : 0)).bottom + l <= i === u
												? "after"
												: "before");
							const ee = jt(e, L(n, M, R), "line", t, o);
					...
					function Ss(e, t, r, i, o, l) {
						let a = Qo(e, t, r, l),
							s = a.begin,
							u = a.end;
						/\s/.test(t.text.charAt(u - 1)) && u--;
						for (let h, v, k = 0; k < i.length; k++) {
							const x = i[k];
							if (!(x.from >= u || x.to <= s)) {
								const M = x.level !== 1,
									E = Zt(
					...
					let Sr;
					function jr(e) {
						if (e.cachedTextHeight !== undefined) {
							return e.cachedTextHeight;
						}
						if (Sr === undefined) {
							Sr = d("pre", undefined, "CodeMirror-line-like");
							for (let t = 0; t < 49; ++t) {
								Sr.append(document.createTextNode("x")), Sr.append(d("br"));
							}
							Sr.append(document.createTextNode("x"));
						}
						J(e.measure, Sr);
					...
					function Kr(e) {
						if (e.cachedCharWidth !== undefined) {
					...
					function Tr(e, t, n, r) {
						...
						if (
							...
							const h = Le(u, u.length, e.options.tabSize) - u.length;
							s = L(
								s.line,
								Math.max(
									0,
					...
					function bt(e, t, n, r) {
						t === undefined && (t = e.doc.first),
							n === undefined && (n = e.doc.first + e.doc.size),
							r || (r = 0);
						const { display: i } = e;
						if (
							(r &&
								n < i.viewTo &&
								(i.updateLineNumbers === undefined ||
						...
						const { externalMeasured: u } = i;
						u &&
							(n < u.lineN
								? (u.lineN += r)
								: t < u.lineN + u.size && (i.externalMeasured = undefined));
					}
					function dr(e, t, n) {
						e.curOp.viewChanged = !0;
						const r = e.display,
						...
						if (
							(i &&
								t >= i.lineN &&
								t < i.lineN + i.size &&
								(r.externalMeasured = undefined),
							!(t < r.viewFrom || t >= r.viewTo))
						) {
							const o = r.view[Lr(e, t)];
							if (o.node !== undefined) {
					...
					function Jn(e, t, n, r) {
						...
						for (let a = e.display.viewFrom, s = 0; s < i; s++) {
							a += l[s].size;
						}
						if (a !== t) {
							if (r > 0) {
					...
					function el(e) {
						for (let t = e.display.view, n = 0, r = 0; r < t.length; r++) {
							const i = t[r];
					...
					function Wi(e, t, n) {
						const r = jt(
							...
							i = n.append(d("div", " ", "CodeMirror-cursor"));
						if (
					...
					function Ls(e, t, n) {
						...
						function v(G, ee, me) {
							...
							const wt = We(pe, i.direction);
							return (
								or(wt, ee || 0, me ?? Fe, (tt, St, ft, nt) => {
									const rt = ft === "ltr",
										Qe = Xe(tt, rt ? "left" : "right"),
										Tt = Xe(St - 1, rt ? "right" : "left"),
										nn = ee === undefined && tt === 0,
										xr = me === undefined && St === Fe,
										gt = nt === 0,
									...
									if (Tt.top - Qe.top <= 3) {
										...
										rt
											...
											Qe.bottom < Tt.top && h(a, Qe.bottom, undefined, Tt.top),
						...
						if (k.line === x.line) {
							...
							const M = ce(i, k.line),
								E = ce(i, x.line),
								R = qt(M) === qt(E),
								U = v(k.line, k.ch, R ? M.text.length + 1 : undefined).end,
								Q = v(x.line, R ? 0 : undefined, x.ch).start;
							R &&
								(U.top < Q.top - 2
									? (h(U.right, U.top, undefined, U.bottom),
										h(a, Q.top, Q.left, Q.bottom))
									: h(U.right, U.top, Q.left - U.right, U.bottom)),
								U.bottom < Q.top && h(a, U.bottom, undefined, Q.top);
						}
						n.append(o);
					}
					function _i(e) {
							...
							e.options.readOnly !== "nocursor" &&
								(e.state.focused ||
									...
									!e.curOp &&
										...
										_ && setTimeout(() => e.display.input.reset(!0), 20)),
						...
						for (
							...
							if (!a.hidden) {
								...
								if (h > e.display.sizerWidth) {
									const E = Math.ceil(h / Kr(e.display));
					...
					function Ds(e, t, n, r) {
						...
						for (let o = 0; o < 5; o++) {
							...
							const u = qi(e, i),
								...
								v = e.doc.scrollLeft;
							if (
								(u.scrollTop !== undefined &&
									(yn(e, u.scrollTop),
									Math.abs(e.doc.scrollTop - h) > 1 && (l = !0)),
								u.scrollLeft !== undefined &&
									(Cr(e, u.scrollLeft),
					...
					function Ms(e, t) {
						const n = qi(e, t);
						n.scrollTop !== undefined && yn(e, n.scrollTop),
							n.scrollLeft !== undefined && Cr(e, n.scrollLeft);
					}
					function qi(e, t) {
						const n = e.display,
							r = jr(e.display);
						t.top < 0 && (t.top = 0);
						const i =
								e.curOp && e.curOp.scrollTop !== undefined
									? e.curOp.scrollTop
						...
						const v = e.options.fixedGutter ? 0 : n.gutters.offsetWidth,
							k =
								e.curOp && e.curOp.scrollLeft !== undefined
									? e.curOp.scrollLeft
					...
					function mn(e, t, n) {
						(t !== undefined || n !== undefined) && ei(e),
							t !== undefined && (e.curOp.scrollLeft = t),
							n !== undefined && (e.curOp.scrollTop = n);
					}
					function Fs(e, t) {
					...
					const Dr = function Dr(e, t, n) {
						this.cm = n;
						const r = (this.vert = d(
								"div",
								[d("div", undefined, undefined, "min-width: 1px")],
					...
					(Dr.prototype.update = function update(e) {
						...
						if (n) {
							...
							this.vert.firstChild.style.height = `${Math.max(
								0,
								e.scrollHeight - e.clientHeight + i,
							)}px`;
						} else {
						...
						(Dr.prototype.setScrollLeft = function setScrollLeft(e) {
						...
						(Dr.prototype.setScrollTop = function setScrollTop(e) {
							this.vert.scrollTop !== e && (this.vert.scrollTop = e),
								this.disableVert &&
									this.enableZeroWidthBar(this.vert, this.disableVert, "vert");
						}),
						(Dr.prototype.zeroWidthHack = function zeroWidthHack() {
							const e = se && !ke ? "12px" : "18px";
						...
						(Dr.prototype.clear = function clear() {
						...
						t &&
							us(t, (n) => {
								for (let r = 0; r < n.ops.length; r++) {
									n.ops[r].cm.curOp = undefined;
								}
								Es(n);
							});
					}
					function Es(e) {
						for (let t = e.ops, n = 0; n < t.length; n++) {
							Ns(t[n]);
						}
					...
					function zs(e) {
						...
						if (
							...
							n.wheelStartX !== undefined &&
								(e.scrollTop !== undefined ||
									e.scrollLeft !== undefined ||
									e.scrollToPos) &&
								(n.wheelStartX = n.wheelStartY = undefined),
							e.scrollTop !== undefined && ol(t, e.scrollTop, e.forceScroll),
							e.scrollLeft !== undefined && Cr(t, e.scrollLeft, !0, !0),
							e.scrollToPos)
						) {
							const i = Ds(
								t,
					...
					function Bs(e) {
						...
						if (!(t.highlightFrontier >= e.display.viewTo)) {
							const n = Date.now() + e.options.workTime,
							...
							t.iter(
								...
								(o) => {
									if (r.line >= e.display.viewFrom) {
										...
										o.text.length <= e.options.maxHighlightLength &&
											bi(e, o.text, r),
											(o.stateAfter = r.line % 5 === 0 ? r.save() : undefined),
											r.nextLine();
									}
									if (Date.now() > n) {
					...
					(ti.prototype.signal = function signal(e, t) {
						Ct(e, t) && this.events.push(arguments);
					}),
						(ti.prototype.finish = function finish() {
							for (let e = 0; e < this.events.length; e++) {
								Ye.apply(undefined, this.events[e]);
							}
						});
					function Ws(e) {
						const { display: t } = e;
					...
					function Hs(e) {
						if (
							!(!e?.activeElt || e.activeElt === y(xe(e.activeElt))) &&
							(e.activeElt.focus(),
					...
					function ul(e, t) {
						for (let n = t.viewport, r = !0; ; r = !1) {
							if (
								...
								r && (t.visible = $n(e.display, e.doc, n));
							}
							if (!Ki(e, t)) {
								break;
							}
						...
						for (let s = r.view, u = r.viewFrom, h = 0; h < s.length; h++) {
							...
							if (!v.hidden) {
								if (!v.node || v.node.parentNode !== o) {
									...
									let x = i && t !== undefined && t <= u && v.lineNumber;
									v.changes &&
					...
					function fl(e) {
						...
						if (
							...
							for (
								let r = zi(t) - t.scroller.scrollLeft + e.doc.scrollLeft,
									_i = t.gutters.offsetWidth,
									o = `${r}px`,
									l = 0;
								l < n.length;
								l++
					...
					function Yi(e, t) {
						for (let n = [], r = !1, i = 0; i < e.length; i++) {
							let o = e[i],
								l;
							if (
					...
					function dl(e) {
						const t = e.gutters,
							n = e.gutterSpecs;
						D(t), (e.lineGutter = undefined);
						for (let r = 0; r < n.length; ++r) {
							const i = n[r],
								o = i.className,
								l = i.style,
								a = t.append(d("div", undefined, `CodeMirror-gutter ${o}`));
							l && (a.style.cssText = l),
								o === "CodeMirror-linenumbers" &&
									((e.lineGutter = a),
									(a.style.width = `${e.lineNumWidth || 1}px`));
						}
						(t.style.display = n.length > 0 ? "" : "none"), Gi(e);
					}
					function wn(e) {
					...
					function qs(e, t, n, r) {
						(this.input = n),
							...
							(this.lineDiv = S("div", undefined, "CodeMirror-code")),
							(this.selectionDiv = d(
								"div",
								undefined,
								undefined,
							...
							(this.cursorDiv = d("div", undefined, "CodeMirror-cursors")),
							(this.measure = d("div", undefined, "CodeMirror-measure")),
							(this.lineMeasure = d("div", undefined, "CodeMirror-measure")),
							(this.lineSpace = S(
								"div",
								[
									this.measure,
						...
						const o = S("div", [this.lineSpace], "CodeMirror-lines");
						(this.mover = d("div", [o], undefined, "position: relative")),
							(this.sizer = d("div", [this.mover], "CodeMirror-sizer")),
							...
							(this.gutters = d("div", undefined, "CodeMirror-gutters")),
							...
							O && q >= 105 && (this.wrapper.style.clipPath = "inset(0px)"),
							this.wrapper.setAttribute("translate", "no"),
							b &&
								N < 8 &&
								((this.gutters.style.zIndex = -1),
								(this.scroller.style.paddingRight = 0)),
							!(_ || (I && ne)) && (this.scroller.draggable = !0),
							e && (e.appendChild ? e.append(this.wrapper) : e(this.wrapper)),
					...
					function hl(e) {
						...
						return (
							t === undefined &&
								...
								(t = e.detail),
							n === undefined && e.detail && e.axis === e.VERTICAL_AXIS
								? (n = e.detail)
								: n === undefined && (n = e.wheelDelta),
							{ x: t, y: n }
						);
					}
					function js(e) {
					...
					function pl(e, t) {
						O &&
							q === 102 &&
							(e.display.chromeScrollHack === undefined
							...
							ri < 20 &&
								...
								(l.wheelStartX === undefined
									? ((l.wheelStartX = a.scrollLeft),
										...
										(l.wheelDY = i),
										setTimeout(() => {
											if (l.wheelStartX !== undefined) {
												const R = a.scrollLeft - l.wheelStartX,
													U = a.scrollTop - l.wheelStartY,
													Q =
														(U && l.wheelDY && U / l.wheelDY) ||
														(R && l.wheelDX && R / l.wheelDX);
												(l.wheelStartX = l.wheelStartY = undefined),
					...
					const At = function At(e, t) {
						(this.ranges = e), (this.primIndex = t);
					};
					(At.prototype.primary = function primary() {
						return this.ranges[this.primIndex];
					}),
						(At.prototype.equals = function equals(e) {
							if (e === this) {
								return !0;
							}
							if (
							...
							for (let t = 0; t < this.ranges.length; t++) {
								const n = this.ranges[t],
									r = e.ranges[t];
								if (!(_e(n.anchor, r.anchor) && _e(n.head, r.head))) {
									return !1;
								}
							}
							return !0;
						}),
						(At.prototype.deepCopy = function deepCopy() {
							for (let e = [], t = 0; t < this.ranges.length; t++) {
								e[t] = new He(
						...
						(At.prototype.somethingSelected = function somethingSelected() {
						...
						(At.prototype.contains = function contains(e, t) {
							t || (t = e);
					...
					const He = function He(e, t) {
						(this.anchor = e), (this.head = t);
					};
					(He.prototype.from = function from() {
						return _r(this.anchor, this.head);
					}),
						(He.prototype.to = function to() {
							return xt(this.anchor, this.head);
						}),
						(He.prototype.empty = function empty() {
							return (
					...
					function Kt(e, t, n) {
						const r = e?.options.selectionsMayTouch,
							i = t[n];
						t.sort((k, x) => Z(k.from(), x.from())), (n = oe(t, i));
						for (let o = 1; o < t.length; o++) {
							const l = t[o],
								a = t[o - 1],
								s = Z(a.to(), l.from());
							if (r && !l.empty() ? s > 0 : s >= 0) {
								const u = _r(a.from(), l.from()),
									h = xt(a.to(), l.to()),
					...
					function Zi(e, t) {
						for (let n = [], r = 0; r < e.sel.ranges.length; r++) {
					...
					function Sn(e) {
						e.doc.iter((t) => {
							t.stateAfter && (t.stateAfter = undefined),
								t.styles && (t.styles = undefined);
						}),
					...
					function Vi(e, t) {
						...
						return (
							...
							vr(e, (r) => wl(r, n, t.from.line, t.to.line + 1), !0),
							n
						);
					}
					function bl(e) {
					...
					function Gs(e, t) {
						if (t) {
							return bl(e.done), ge(e.done);
						}
						if (e.done.length > 0 && !ge(e.done).ranges) {
							return ge(e.done);
						}
						if (e.done.length > 1 && !e.done.at(-2).ranges) {
					...
					function Xs(e, t, n, r) {
						...
						return (
							...
							(i === "+" &&
								...
								Date.now() - e.history.lastSelTime <=
					...
					function Zs(e) {
						...
						return t ? (t.length > 0 ? t : undefined) : e;
					}
					function Js(e, t) {
						...
						for (let r = [], i = 0; i < t.text.length; ++i) {
							r.push(Zs(n[i]));
						}
						return r;
					}
						...
						for (let i = 0; i < n.length; ++i) {
							...
							if (o && l) {
								e: for (let a = 0; a < l.length; ++a) {
									for (let s = l[a], u = 0; u < o.length; ++u) {
					...
					function oi(e, t, n, r, i) {
						i === undefined && (i = e.cm && (e.cm.display.shift || e.extend)),
							pt(e, new At([$i(e.sel.primary(), t, n, i)], 0), r);
					}
					function Tl(e, t, n) {
						for (
							let r = [], i = e.cm && (e.cm.display.shift || e.extend), o = 0;
							o < e.sel.ranges.length;
							o++
						) {
							r[o] = $i(e.sel.ranges[o], t[o], undefined, i);
						}
						const l = Kt(e.cm, r, e.sel.primIndex);
						pt(e, l, n);
					}
					function eo(e, t, n, r) {
						const i = [...e.sel.ranges];
					...
					function Cl(e, t, n) {
						const r = e.history.done,
							i = ge(r);
						i?.ranges ? ((r[r.length - 1] = t), li(e, t, n)) : pt(e, t, n);
					}
					function pt(e, t, n) {
						li(e, t, n), Ys(e, e.sel, e.cm ? e.cm.curOp.id : Number.NaN, n);
					}
					function li(e, t, n) {
					...
					function Ml(e) {
						Dl(e, Fl(e, e.sel, undefined, !1));
					}
					function Fl(e, t, n, r) {
						for (let i, o = 0; o < t.ranges.length; o++) {
							const l = t.ranges[o],
								a = t.ranges.length === e.sel.ranges.length && e.sel.ranges[o],
								s = ai(e, l.anchor, a?.anchor, n, r),
								u = l.head === l.anchor ? s : ai(e, l.head, a?.head, n, r);
						...
						if (o.markedSpans) {
							for (let l = 0; l < o.markedSpans.length; ++l) {
								...
								if (
									...
									(a.to === undefined || (h ? a.to >= t.ch : a.to > t.ch))
								) {
									...
									let x = s.find(r < 0 ? -1 : 1);
									return (
										(r < 0 ? u : h) &&
											(x = Al(e, x, r, x.line === t.line ? o : undefined)),
										x ? Zr(e, x, t, r, i) : undefined
									);
								}
							}
						}
					...
					function Nl(e, t, n) {
						...
						return (
							...
							r.canceled
								? (e.cm && (e.cm.curOp.updateInput = 2), undefined)
					...
					function Ol(e, t) {
						if (
							...
							const n = Zi(e, t);
							kl(e, t, n, e.cm ? e.cm.curOp.id : Number.NaN),
								Tn(e, t, n, wi(e, t));
							const r = [];
							vr(e, (i, o) => {
								!o &&
									...
									Tn(i, t, undefined, wi(i, t));
							});
						}
					}
					function si(e, t, n) {
						const r = e.cm?.state.suppressEdits;
						if (!(r && !n)) {
							for (
								let i = e.history,
									o,
							...
							if (u !== a.length) {
								for (i.lastOrigin = i.lastSelOrigin = undefined; ; ) {
									if (((o = a.pop()), o.ranges)) {
					...
					function Vs(e, t, n) {
						...
						e.options.lineWrapping ||
							...
							Qi(r, t, n, $o(e)),
							e.options.lineWrapping ||
								(r.iter(s, o.line + t.text.length, (x) => {
									const M = Un(x);
									M > i.maxLineLength &&
										((i.maxLine = x),
										(i.maxLineLength = M),
						...
						e.display.selForContextMenu = undefined;
					}
					...
					function Cn(e) {
						(this.lines = e), (this.parent = undefined);
						for (let t = 0, n = 0; n < e.length; ++n) {
					...
					function Dn(e) {
						this.children = e;
						for (let t = 0, n = 0, r = 0; r < e.length; ++r) {
							const i = e[r];
							(t += i.chunkSize()), (n += i.height), (i.parent = this);
						}
						(this.size = t), (this.height = n), (this.parent = undefined);
					}
					Dn.prototype = {
						chunkSize() {
							return this.size;
							...
							for (let n = 0; n < this.children.length; ++n) {
								...
								if (e < i) {
									...
									if (
										...
										i === o &&
											(this.children.splice(n--, 1), (r.parent = undefined)),
										(t -= o) === 0)
									) {
										break;
									}
							...
							for (let r = 0; r < this.children.length; ++r) {
								...
								if (e <= o) {
									if (
										...
										for (
											let l = (i.lines.length % 25) + 25, a = l;
											a < i.lines.length;
										) {
						...
						maybeSpill() {
							if (!(this.children.length <= 10)) {
								let e = this;
								do {
									const t = e.children.splice(-5, 5),
										n = new Dn(t);
									if (e.parent) {
										(e.size -= n.size), (e.height -= n.height);
										const i = oe(e.parent.children, e);
					...
					const Mn = function Mn(e, t, n) {
						if (n) {
							for (const r in n) {
								Object.hasOwn(n, r) && (this[r] = n[r]);
							}
						}
						(this.doc = e), (this.node = t);
					};
					(Mn.prototype.clear = function clear() {
						const e = this.doc.cm,
							t = this.line.widgets,
							n = this.line,
							r = f(n);
						...
						(Mn.prototype.changed = function changed() {
							const t = this.height,
								n = this.doc.cm,
								r = this.line;
						...
						Bt(Mn);
					function Wl(e, t, n) {
						er(t) < (e.curOp?.scrollTop || e.doc.scrollTop) && ji(e, n);
					}
					function $s(e, t, n, r) {
					...
					(mr.prototype.clear = function clear() {
						if (!this.explicitlyCleared) {
							...
							for (let r, i, o = 0; o < this.lines.length; ++o) {
								const l = this.lines[o],
									a = cn(l.markedSpans, this);
								e && !this.collapsed
									? dr(e, f(l), "text")
									: e &&
										(a.to !== undefined && (i = f(l)),
										a.from !== undefined && (r = f(l))),
							...
							r !== undefined && e && this.collapsed && bt(e, r, i + 1),
								(this.lines.length = 0),
						...
						(mr.prototype.find = function find(e, t) {
							e === undefined && this.type === "bookmark" && (e = 1);
							for (let n, r, i = 0; i < this.lines.length; ++i) {
						...
						(mr.prototype.changed = function changed() {
							...
							!(t && r) ||
								Dt(r, () => {
									...
									if (
										...
										!cr(this.doc, i) && this.height !== undefined)
									) {
										const { height: a } = this;
										this.height = undefined;
										const s = pn(this) - a;
						...
						(mr.prototype.attachLine = function attachLine(e) {
						...
						(mr.prototype.detachLine = function detachLine(e) {
							if (
					...
					function Vr(e, t, n, r, i) {
						...
						o.addToHistory &&
							kl(e, { from: t, to: n, origin: "markText" }, e.sel, Number.NaN);
						let a = t.line,
							s = e.cm,
							u;
						if (
							(e.iter(a, n.line + 1, (v) => {
								s &&
									...
									Ua(
										...
										new Rn(
											o,
											a === t.line ? t.ch : undefined,
											a === n.line ? n.ch : undefined,
										),
										e.cm?.curOp,
									),
									++a;
							...
							o.collapsed &&
								e.iter(t.line, n.line + 1, (v) => {
									cr(e, v) && Ft(v, 0);
								}),
							o.clearOnEnter && ve(o, "beforeCursorEnter", () => o.clear()),
							o.readOnly &&
								(qa(),
					...
					const Fn = function Fn(e, t) {
						(this.markers = e), (this.primary = t);
						for (let n = 0; n < e.length; ++n) {
							e[n].parent = this;
						}
					};
					(Fn.prototype.clear = function clear() {
						if (!this.explicitlyCleared) {
							this.explicitlyCleared = !0;
						...
						(Fn.prototype.find = function find(e, t) {
					...
					function eu(e, t, n, r, i) {
						...
						return (
							vr(e, (s) => {
								...
								for (let u = 0; u < s.linked.length; ++u) {
						...
						for (
							let t = (r) => {
									...
									for (let l = 0; l < i.markers.length; l++) {
										const a = i.markers[l];
										oe(o, a.doc) === -1 &&
											((a.parent = undefined), i.markers.splice(l--, 1));
									}
								},
								n = 0;
							n < e.length;
					...
					let nu = 0,
						kt = function (e, t, n, r, i) {
							...
							n === undefined && (n = 0),
								Dn.call(this, [new Cn([new Hr("", undefined)])]),
								(this.first = n),
					...
					(kt.prototype = F(Dn.prototype, {
						...
						getRange(e, t, n) {
							const r = Vt(this, Ce(this, e), Ce(this, t));
							return n === !1
								? r
								: (n === ""
									? r.join("")
						...
						getSelections(e) {
							for (let t = [], n = this.sel.ranges, r = 0; r < n.length; r++) {
						...
						replaceSelection(e, t, n) {
							for (let r = [], i = 0; i < this.sel.ranges.length; i++) {
								r[i] = e;
							}
							this.replaceSelections(r, t, n || "+input");
						},
						replaceSelections: at(function (e, t, n) {
							for (let r = [], i = this.sel, o = 0; o < i.ranges.length; o++) {
								const l = i.ranges[o];
								r[o] = {
									from: l.from(),
									to: l.to(),
							...
							for (
								let _a = t && t !== "end" && Ks(this, r, t), s = r.length - 1;
								s >= 0;
								s--
							) {
								Jr(this, r[s]);
						...
						historySize() {
							for (
								let e = this.history, t = 0, _n = 0, r = 0;
								r < e.done.length;
								r++
							) {
								e.done[r].ranges || ++t;
						...
						setHistory(e) {
							...
							(t.done = Yr([...e.done], undefined, !0)),
								(t.undone = Yr([...e.undone], undefined, !0));
						},
						setGutterMarker: at(function (e, t, n) {
							return Ln(this, e, "gutter", (r) => {
								const i = r.gutterMarkers || (r.gutterMarkers = {});
								return (
									(i[t] = n), !n && he(i) && (r.gutterMarkers = undefined), !0
								);
							});
						}),
							...
							this.iter((n) => {
								n.gutterMarkers?.[e] &&
									Ln(
										...
										"gutter",
										() => (
											(n.gutterMarkers[e] = undefined),
											he(n.gutterMarkers) && (n.gutterMarkers = undefined),
											!0
										),
									);
							});
						...
						addLineClass: at(function (e, t, n) {
							return Ln(this, e, t === "gutter" ? "gutter" : "class", (r) => {
								const i =
									t === "text"
										? "textClass"
										: t === "background"
						...
						markText(e, t, n) {
							return Vr(this, Ce(this, e), Ce(this, t), n, n?.type || "range");
						},
						setBookmark(e, t) {
							const n = {
								replacedWith: t && (t.nodeType === undefined ? t.widget : t),
								insertLeft: t?.insertLeft,
								clearWhenEmpty: !1,
								shared: t?.shared,
								handleMouseEvents: t?.handleMouseEvents,
							};
						...
						findMarksAt(e) {
							...
							if (n) {
								for (let r = 0; r < n.length; ++r) {
									const i = n[r];
									(i.from === undefined || i.from <= e.ch) &&
										(i.to === undefined || i.to >= e.ch) &&
						...
						findMarks(e, t, n) {
							...
							return (
								this.iter(e.line, t.line + 1, (o) => {
									const { markedSpans: l } = o;
									if (l) {
										for (let a = 0; a < l.length; a++) {
											const s = l[a];
											!(
												(s.to !== undefined && i === e.line && e.ch >= s.to) ||
												(s.from === undefined && i !== e.line) ||
												(s.from !== undefined && i === t.line && s.from >= t.ch)
											) &&
												(!n || n(s.marker)) &&
						...
						getAllMarks() {
							...
							return (
								this.iter((t) => {
									const { markedSpans: n } = t;
									if (n) {
										for (let r = 0; r < n.length; ++r) {
											n[r].from !== undefined && e.push(n[r].marker);
										}
									}
								}),
								e
						...
						linkedDoc(e) {
							...
							e.from !== undefined && e.from > t && (t = e.from),
								e.to !== undefined && e.to < n && (n = e.to);
							const r = new kt(
								un(this, t, n),
...
`
					...
					let Rl = 0;
					function iu(e) {
						if ((ql(this), !(Ze(this, e) || tr(this.display, e)))) {
							ht(e), b && (Rl = Date.now());
							let n = Tr(this, e, !0),
								r = e.dataTransfer.files;
							if (!(!n || this.isReadOnly())) {
								if (r?.length && window.FileReader && window.File) {
									for (
										let i = r.length,
											o = new Array(i),
											l = 0,
												...
												++l === i &&
													lt(this, () => {
														...
														Jr(this.doc, x),
															Cl(
																this.doc,
																pr(Ce(this.doc, n), Ce(this.doc, gr(x))),
															);
													})();
											},
											s = (x, M) => {
												if (
													...
													oe(this.options.allowDropFileTypes, x.type) === -1
												) {
													a();
													return;
												}
										...
										if (h) {
											...
											if (
												(this.state.draggingText &&
													...
													(v = this.listSelections()),
												li(this.doc, pr(n, n)),
												v)
											) {
												for (let k = 0; k < v.length; ++k) {
													Qr(this.doc, "", v[k].anchor, v[k].head, "drag");
												}
											}
					...
					function ou(e, t) {
						if (b && (!e.state.draggingText || Date.now() - Rl < 100)) {
							ar(t);
							return;
						}
						if (
					...
					function ql(e) {
						e.display.dragCursor &&
							...
							(e.display.dragCursor = undefined));
					}
					function jl(e) {
						if (document.getElementsByClassName) {
							for (
								let t = document.querySelectorAll(".CodeMirror"), n = [], r = 0;
								r < t.length;
								r++
							) {
					...
					for (let ui = 65; ui <= 90; ui++) {
						yr[ui] = String.fromCodePoint(ui);
					}
					for (let En = 1; En <= 12; En++) {
						yr[En + 111] = yr[En + 63_235] = `F${En}`;
					}
					const nr = {};
					(nr.basic = {
						Left: "goCharLeft",
					...
					function fu(e) {
						const t = e.split(/-(?!$)/);
						e = t.at(-1);
						for (let n, r, i, o, l = 0; l < t.length - 1; l++) {
							const a = t[l];
					...
					function cu(e) {
						...
						for (const n in e) {
							if (Object.hasOwn(e, n)) {
								...
								for (let i = Pe(n.split(" "), fu), o = 0; o < i.length; o++) {
									let l = void 0,
										a = void 0;
									o === i.length - 1
										? ((a = i.join(" ")), (l = r))
					...
					function Ul(e) {
						const t = typeof e === "string" ? e : yr[e.keyCode];
					...
					function Xl(e, t) {
						if (z && e.keyCode === 34 && e.char) {
							return !1;
						}
						let n = yr[e.keyCode];
						return n === undefined || e.altGraphKey
							? !1
					...
					function en(e, t) {
						for (let n = e.doc.sel.ranges, r = [], i = 0; i < n.length; i++) {
							for (
								const o = t(n[i]);
								r.length > 0 && Z(o.from, ge(r).to) <= 0;
							) {
								const l = r.pop();
					...
					function to(e, t, n) {
						const r = Lt(e.text, t + n, n);
						return r < 0 || r > e.text.length ? undefined : r;
					}
					function ro(e, t, n) {
						const r = to(e, t.ch, n);
						return r === undefined
					...
					function du(e, t, n, r) {
						...
						let a = (U, Q) => to(t, U instanceof L ? U.ch : U, Q),
							s,
							u = (U) =>
								e.options.lineWrapping
					...
					const Nn = {
						...
						killLine(e) {
							return en(e, (t) => {
								if (t.empty()) {
									const n = ce(e.doc, t.head.line).text.length;
						...
						goLineStart(e) {
							return e.extendSelectionsBy((t) => Yl(e, t.head.line), {
								origin: "+move",
								bias: 1,
							});
						},
						goLineStartSmart(e) {
							return e.extendSelectionsBy((t) => Zl(e, t.head), {
								origin: "+move",
								bias: 1,
							});
						},
						goLineEnd(e) {
							return e.extendSelectionsBy((t) => hu(e, t.head.line), {
								origin: "+move",
								bias: -1,
							});
						},
									...
									if (t[r].empty()) {
										...
										if (o) {
											if (
												...
												const l = ce(e.doc, i.line - 1).text;
												l &&
													((i = new L(i.line, 1)),
													e.replaceRange(
														o.charAt(0) + e.doc.lineSeparator() + l.at(-1),
						...
						newlineAndIndent(e) {
							return Dt(e, () => {
								for (
									let t = e.listSelections(), n = t.length - 1;
									n >= 0;
									n--
								) {
									e.replaceRange(
								...
								t = e.listSelections();
								for (let r = 0; r < t.length; r++) {
									e.indentLine(t[r].from().line, undefined, !0);
								}
								Gr(e);
							});
						},
...
`,
					...
					function On(e, t, n, r) {
						...
						if (i) {
							...
							if (
								(t.endsWith("'")
									? (e.state.keySeq = undefined)
									: gu.set(50, () => {
											e.state.keySeq === i &&
												((e.state.keySeq = undefined), e.display.input.reset());
										}),
								Jl(e, `${i} ${t}`, n, r))
							) {
								return !0;
					...
					function Vl(e) {
						if (
							...
							((this.curOp.focus = y(Y(this))), !Ze(this, e))
						) {
					...
					function ea(e) {
						if (
							...
							if (!(z && (!e.which || e.which < 10) && Ql(this, e))) {
								const i = String.fromCodePoint(r ?? n);
								i !== "\b" &&
									(vu(this, e, i) || this.display.input.onKeyPress(e));
							}
						}
					}
					const yu = 400,
					...
					oo.prototype.compare = function compare(e, t, n) {
						return (
					...
					function xu(e, t) {
						const n = Date.now();
						return In?.compare(n, e, t)
							? ((Pn = In = undefined), "triple")
							: (Pn?.compare(n, e, t)
								? ((In = new oo(n, e, t)), (Pn = null), "double")
								: ((Pn = new oo(n, e, t)), (In = null), "single"));
					}
					function ta(e) {
						const { display: n } = this;
						if (!(Ze(this, e) || (n.activeTouch && n.input.supportsTouch()))) {
					...
					function ku(e, t, n) {
						const r = e.getOption("configureMouse"),
							i = r ? r(e, t, n) : {};
						if (i.unit === undefined) {
							const o = Ae ? n.shiftKey && n.metaKey : n.altKey;
							i.unit = o
								? "rectangle"
								: t === "single"
									? "char"
						...
						return (
							(i.extend === undefined || e.doc.extend) &&
								(i.extend = e.doc.extend || n.shiftKey),
							i.addNew === undefined && (i.addNew = se ? n.metaKey : n.ctrlKey),
							i.moveOnDrag === undefined &&
						...
						let i = e.display,
							...
							l = lt(e, (u) => {
								_ && (i.scroller.draggable = !1),
									...
									o ||
										(ht(u),
										r.addNew || oi(e.doc, n, undefined, undefined, r.extend),
										(_ && !X) || (b && N === 9)
											? setTimeout(() => {
					...
					function Tu(e, t, n, r) {
						...
						let x = i.wrapper.getBoundingClientRect(),
							M = 0;
						function E(G) {
							const ee = ++M,
						...
						function R(G) {
							(e.state.selectingText = !1),
								...
								(o.history.lastSelOrigin = undefined);
						}
						const U = lt(e, (G) => {
					...
					function oa(e) {
						(e.display.wrapper.className =
							e.display.wrapper.className.replaceAll(/\s*cm-s-\S+/g, "") +
							e.options.theme.replaceAll(/(^|\s)\s*/g, " cm-s-")),
							gn(e);
					}
					const tn = {
							toString() {
					...
					function Du(e) {
						...
						(e.defineOption = n),
							...
							n("specialCharPlaceholder", rs, (r) => r.refresh(), !0),
							n("electricChars", !0),
							n(
								"inputStyle",
							...
							n("keyMap", "default", (r, i, o) => {
								const l = fi(i),
									a = o !== tn && fi(o);
								a?.detach?.(r, l), l.attach?.(r, a || undefined);
							}),
							n("extraKeys"),
							n("configureMouse"),
							...
							n("screenReaderLabel", undefined, (r, i) => {
								(i = i === "" ? undefined : i),
					...
					function Fu(e) {
						e.options.lineWrapping
							? (P(e.display.wrapper, "CodeMirror-wrap"),
								...
								(e.display.sizerWidth = undefined))
					...
					function Ge(e, t) {
						...
						let r = t.value;
						typeof r === "string"
							? (r = new kt(r, t.mode, undefined, t.lineSeparator, t.direction))
						...
						(o.wrapper.CodeMirror = this),
							...
							b && N < 11 && setTimeout(() => this.display.input.reset(!0), 20),
							Au(this),
							au(),
							Mr(this),
							...
							(t.autofocus && !ne) || this.hasFocus()
								? setTimeout(() => {
										this.hasFocus() && !this.state.focused && Ri(this);
									}, 20)
								: Ur(this);
						for (const l in di) {
							Object.hasOwn(di, l) && di[l](this, t[l], tn);
						}
						cl(this), t.finishInit?.(this);
					...
					function Au(e) {
						...
						ve(t.scroller, "mousedown", lt(e, ta)),
							b && N < 11
								...
								: ve(t.scroller, "dblclick", (s) => Ze(e, s) || ht(s)),
							ve(t.scroller, "contextmenu", (s) => ia(e, s)),
							ve(t.input.getField(), "contextmenu", (s) => {
						...
						function i() {
							t.activeTouch &&
								((n = setTimeout(() => (t.activeTouch = undefined), 1e3)),
								(r = t.activeTouch),
								(r.end = Date.now()));
						}
						function o(s) {
						...
						ve(t.scroller, "touchstart", (s) => {
							...
							ve(t.scroller, "touchend", (s) => {
								const { activeTouch: u } = t;
								if (
									u &&
									!tr(t, s) &&
									u.left !== undefined &&
									!u.moved &&
									Date.now() - u.start < 300
								) {
							...
							ve(t.scroller, "scroll", () => {
								t.scroller.clientHeight &&
									(yn(e, t.scroller.scrollTop),
									Cr(e, t.scroller.scrollLeft, !0),
									Ye(e, "scroll", e));
							}),
							ve(t.scroller, "mousewheel", (s) => pl(e, s)),
							ve(t.scroller, "DOMMouseScroll", (s) => pl(e, s)),
							ve(
								t.wrapper,
								"scroll",
					...
					function zn(e, t, n, r) {
						...
						const l = e.options.tabSize,
							a = ce(i, t),
							s = Le(a.text, undefined, l);
						a.stateAfter && (a.stateAfter = undefined);
						...
						if ((k < h && (v += et(h - k)), v !== u)) {
							return (
								...
								(a.stateAfter = undefined),
								!0
							);
						}
						for (let M = 0; M < i.sel.ranges.length; M++) {
							const E = i.sel.ranges[M];
							if (E.head.line === t && E.head.ch < u.length) {
								const R = L(t, u.length);
								eo(i, M, new He(R, R));
								break;
							}
						}
...
`) === t
								...
								if (r.ranges.length % Ut.text.length === 0) {
									u = [];
									for (let h = 0; h < Ut.text.length; h++) {
						...
						for (
							let _v = e.curOp.updateInput, k = r.ranges.length - 1;
							k >= 0;
							k--
						) {
							let x = r.ranges[k],
...
`) &&
					...
					function ua(e) {
						for (let t = [], n = [], r = 0; r < e.doc.sel.ranges.length; r++) {
					...
					function Eu(e) {
						...
						(e.prototype = {
							...
							indentSelection: vt(function (r) {
								for (
									let i = this.doc.sel.ranges, o = -1, l = 0;
									l < i.length;
									l++
								) {
									const a = i[l];
							...
							getTokenTypeAt(r) {
								r = Ce(this.doc, r);
								let i = mo(this, ce(this.doc, r.line)),
									o = 0,
									l = (i.length - 1) / 2,
									a = r.ch,
									s;
							...
							execCommand(r) {
								if (Object.hasOwn(Nn, r)) {
									return Nn[r].call(undefined, this);
								}
							},
							...
							deleteH: vt(function (r, i) {
								const o = this.doc.sel,
									l = this.doc;
								o.somethingSelected()
									? l.replaceSelection("", undefined, "+delete")
									: en(this, (a) => {
							...
							findPosV(r, i, o, l) {
								let a = 1,
									s = l;
								i < 0 && ((a = -1), (i = -i));
								for (let u = Ce(this.doc, r), h = 0; h < i; ++h) {
									const v = jt(this, u, "div");
									if (
										(s === undefined ? (s = v.left) : (v.left = s),
										(u = ca(this, v, a, o)),
										u.hitSide)
									) {
										break;
							...
							moveV: vt(function (r, i) {
								...
								if (
									(l.extendSelectionsBy((h) => {
										...
										const v = jt(this, h.head, "div");
										h.goalColumn !== undefined && (v.left = h.goalColumn),
											a.push(v.left);
										const k = ca(this, v, r, i);
										return (
											i === "page" &&
												h === l.sel.primary() &&
												ji(this, Zn(this, k, "div").top - v.top),
											k
										);
									}, Oe),
									a.length)
								) {
									for (let u = 0; u < l.sel.ranges.length; u++) {
							...
							toggleOverwrite(r) {
								(r !== undefined && r === this.state.overwrite) ||
							...
							scrollIntoView: vt(function (r, i) {
								r === undefined
									? ((r = { from: this.doc.sel.primary().head, to: undefined }),
										i === undefined && (i = this.options.cursorScrollMargin))
									: (typeof r === "number"
										? (r = { from: L(r, 0), to: null })
										: r.from == null && (r = { from: r, to: null })),
									r.to || (r.to = r.from),
									(r.margin = i || 0),
									r.from.line !== undefined
										? Fs(this, r)
							...
							setSize: vt(function (r, i) {
								const l = (s) =>
									typeof s === "number" || /^\d+$/.test(String(s))
										? `${s}px`
										: s;
								r !== undefined && (this.display.wrapper.style.width = l(r)),
									i !== undefined && (this.display.wrapper.style.height = l(i)),
					...
					function fo(e, t, n, r, i) {
						...
						function h(Q) {
							let G;
							if (r === "codepoint") {
								const ee = a.text.codePointAt(t.ch + (n > 0 ? 0 : -1));
								if (Number.isNaN(ee)) {
									G = undefined;
								} else {
									const me =
								...
								i ? (G = du(e.cm, a, t, n)) : (G = ro(a, t, n));
							}
							if (G === undefined) {
								if (!Q && u()) {
									t = no(i, e.cm, a, t.line, s);
								} else {
									return !1;
								}
							} else {
...
`
					...
					(je.prototype.init = function init(e) {
						const n = this,
							r = n.cm,
							i = (n.div = e.lineDiv);
						(i.contentEditable = !0),
							...
							if (!(!o(a) || Ze(r, a))) {
								if (r.somethingSelected()) {
									hi({ lineWise: !1, text: r.getSelections() }),
										a.type === "cut" &&
											r.replaceSelection("", undefined, "cut");
...
`));
						...
						(je.prototype.screenReaderLabelChanged =
							function screenReaderLabelChanged(e) {
								e
									? this.div.setAttribute("aria-label", e)
									: this.div.removeAttribute("aria-label");
							}),
						(je.prototype.prepareSelection = function prepareSelection() {
							const e = tl(this.cm, !1);
							return (e.focus = y(xe(this.div)) === this.div), e;
						}),
						(je.prototype.showSelection = function showSelection(e, t) {
							!(e && this.cm.display.view.length > 0) ||
								((e.focus || t) && this.showPrimarySelection(),
								this.showMultipleSelections(e));
						}),
						(je.prototype.getSelection = function getSelection() {
							return this.cm.display.wrapper.ownerDocument.getSelection();
						}),
						(je.prototype.showPrimarySelection =
							function showPrimarySelection() {
								...
								if (
									...
									if (!u) {
										const h = a.at(-1).measure,
											v = h.maps ? h.maps.at(-1) : h.map;
										u = { node: v.at(-1), offset: v.at(-2) - v.at(-3) };
									}
									if (!(s && u)) {
										e.removeAllRanges();
										return;
									...
									x &&
										...
										k && e.anchorNode === undefined
											? e.addRange(k)
											: I && this.startGracePeriod()),
										this.rememberSelection();
								}
							}),
						(je.prototype.startGracePeriod = function startGracePeriod() {
						...
						(je.prototype.showMultipleSelections =
							function showMultipleSelections(e) {
								J(this.cm.display.cursorDiv, e.cursors),
									J(this.cm.display.selectionDiv, e.selection);
							}),
						(je.prototype.rememberSelection = function rememberSelection() {
							const e = this.getSelection();
						...
						(je.prototype.selectionInEditor = function selectionInEditor() {
							const e = this.getSelection();
							if (!e.rangeCount) {
								return !1;
							}
						...
						(je.prototype.focus = function focus() {
							this.cm.options.readOnly !== "nocursor" &&
								((!this.selectionInEditor() || y(xe(this.div)) !== this.div) &&
									this.showSelection(this.prepareSelection(), !0),
								this.div.focus());
						}),
						(je.prototype.blur = function blur() {
							this.div.blur();
						}),
						(je.prototype.getField = function getField() {
							return this.div;
						}),
						(je.prototype.supportsTouch = () => !0),
						(je.prototype.receivedFocus = function receivedFocus() {
							const t = this;
							this.selectionInEditor()
								? setTimeout(() => this.pollSelection(), 20)
								: Dt(this.cm, () => (t.cm.curOp.selectionChanged = !0));
							function n() {
								t.cm.state.focused &&
									(t.pollSelection(),
						...
						(je.prototype.selectionChanged = function selectionChanged() {
							const e = this.getSelection();
							return (
						...
						(je.prototype.pollSelection = function pollSelection() {
							if (
								!(
									this.readDOMTimeout !== undefined ||
									this.gracePeriod ||
						...
						(je.prototype.pollContent = function pollContent() {
							this.readDOMTimeout !== undefined &&
							...
							for (
								const v = e.doc.splitLines(Ou(e, a, h, l, u)),
							...
							for (
								...
								x < U && E.codePointAt(x) === R.codePointAt(x);
							) {
								++x;
							}
							for (
								...
								M < ee &&
								Q.codePointAt(Q.length - M - 1) ===
									G.codePointAt(G.length - M - 1);
							) {
								++M;
							}
							...
							const me = L(l, x),
								pe = L(u, k.length > 0 ? ge(k).length - M : 0);
							if (v.length > 1 || v[0] || Z(me, pe)) {
								return Qr(e.doc, v, me, pe, "+input"), !0;
							}
						}),
						(je.prototype.ensurePolled = function ensurePolled() {
							this.forceCompositionEnd();
						}),
						(je.prototype.reset = function reset() {
							this.forceCompositionEnd();
						}),
						(je.prototype.forceCompositionEnd = function forceCompositionEnd() {
							this.composing &&
								(clearTimeout(this.readDOMTimeout),
								(this.composing = undefined),
								this.updateFromDOM(),
						...
						(je.prototype.readFromDOMSoon = function readFromDOMSoon() {
							this.readDOMTimeout === undefined &&
						...
						(je.prototype.updateFromDOM = function updateFromDOM() {
							(this.cm.isReadOnly() || !this.pollContent()) &&
								Dt(this.cm, () => bt(this.cm));
						}),
						(je.prototype.setUneditable = (e) => {
							e.contentEditable = "false";
						}),
						(je.prototype.onKeyPress = function onKeyPress(e) {
							e.charCode === 0 ||
								this.composing ||
								(e.preventDefault(),
								this.cm.isReadOnly() ||
						...
						(je.prototype.readOnlyChanged = function readOnlyChanged(e) {
					...
					function Ou(e, t, n, r, i) {
						...
						function k(x) {
							if (x.nodeType === 1) {
								const M = x.getAttribute("cm-text");
								if (M) {
									v(M);
									return;
								}
								...
								const Q = /^(pre|div|p|li|table|br)$/i.test(x.nodeName);
								if (!/^br$/i.test(x.nodeName) && x.textContent.length === 0) {
									return;
								}
								Q && h();
								for (let G = 0; G < x.childNodes.length; G++) {
									k(x.childNodes[G]);
								}
					...
					function Pu(e, t, n) {
						let r = e.text.firstChild,
							i = !1;
						if (!(t && m(r, t))) {
							return rn(L(f(e.line), 0), !0);
						}
						if (t === r && ((i = !0), (t = r.childNodes[n]), (n = 0), !t)) {
							const o = e.rest ? ge(e.rest) : e.line;
							return rn(L(f(o), o.text.length), i);
						}
						let l = t.nodeType === 3 ? t : undefined,
							a = t;
						for (
							!l &&
						...
						const s = e.measure,
							u = s.maps;
						function h(R, U, Q) {
							for (let G = -1; G < (u ? u.length : 0); G++) {
								for (
									let ee = G < 0 ? s.map : u[G], me = 0;
									me < ee.length;
									me += 3
								) {
									const pe = ee[me + 2];
									if (pe === R || pe === U) {
										let Fe = f(G < 0 ? e.line : e.rest[G]),
											Ke = ee[me] + Q;
										return (
						...
						for (
							let k = a.nextSibling, x = l ? l.nodeValue.length - n : 0;
							k;
							k = k.nextSibling
						) {
						...
						for (let M = a.previousSibling, E = n; M; M = M.previousSibling) {
					...
					($e.prototype.init = function init(e) {
						const n = this,
							r = this.cm;
						this.createField(e);
						const { textarea: i } = this;
						e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
							...
							ve(i, "input", () => {
								b &&
									N >= 9 &&
									this.hasSelection &&
									(this.hasSelection = undefined),
									n.poll();
							}),
							ve(i, "paste", (l) => {
								Ze(r, l) ||
									aa(l, r) ||
									((r.state.pasteIncoming = Date.now()), n.fastPoll());
							});
						function o(l) {
							if (!Ze(r, l)) {
								if (r.somethingSelected()) {
									...
									hi({ lineWise: !0, text: a.text }),
										l.type === "cut"
											? r.setSelections(a.ranges, undefined, Ve)
											: ((n.prevInput = ""),
												(i.value = a.text.join(`
`)),
												p(i));
								...
								l.type === "cut" && (r.state.cutIncoming = Date.now());
							}
						}
						ve(i, "cut", o),
							ve(i, "copy", o),
							ve(e.scroller, "paste", (l) => {
								if (!(tr(e, l) || Ze(r, l))) {
									if (!i.dispatchEvent) {
										(r.state.pasteIncoming = Date.now()), n.focus();
										return;
									}
							...
							ve(e.lineSpace, "selectstart", (l) => {
								tr(e, l) || ht(l);
							}),
							ve(i, "compositionstart", () => {
							...
							ve(i, "compositionend", () => {
								n.composing &&
									(n.poll(),
									n.composing.range.clear(),
									(n.composing = undefined));
							});
					}),
						($e.prototype.createField = function createField(_e) {
						...
						($e.prototype.screenReaderLabelChanged =
							function screenReaderLabelChanged(e) {
								e
									? this.textarea.setAttribute("aria-label", e)
									: this.textarea.removeAttribute("aria-label");
							}),
						($e.prototype.prepareSelection = function prepareSelection() {
							const e = this.cm,
								t = e.display,
								n = e.doc,
								r = tl(e);
						...
						($e.prototype.showSelection = function showSelection(e) {
							const t = this.cm,
								n = t.display;
						...
						($e.prototype.reset = function reset(e) {
							if (!(this.contextMenuPending || (this.composing && e))) {
								...
								if (((this.resetting = !0), t.somethingSelected())) {
									...
									e ||
										...
										b && N >= 9 && (this.hasSelection = undefined));
								}
								this.resetting = !1;
							}
						}),
						($e.prototype.getField = function getField() {
							return this.textarea;
						}),
						($e.prototype.supportsTouch = () => !1),
						($e.prototype.focus = function focus() {
							if (
								this.cm.options.readOnly !== "nocursor" &&
						...
						($e.prototype.blur = function blur() {
							this.textarea.blur();
						}),
						($e.prototype.resetPosition = function resetPosition() {
							this.wrapper.style.top = this.wrapper.style.left = 0;
						}),
						($e.prototype.receivedFocus = function receivedFocus() {
							this.slowPoll();
						}),
						($e.prototype.slowPoll = function slowPoll() {
							this.pollingFast ||
								this.polling.set(this.cm.options.pollInterval, () => {
									this.poll(), this.cm.state.focused && this.slowPoll();
								});
						}),
						($e.prototype.fastPoll = function fastPoll() {
							let e = !1,
								t = this;
							t.pollingFast = !0;
							function n() {
						...
						($e.prototype.poll = function poll() {
							let t = this.cm,
								n = this.textarea,
								r = this.prevInput;
							if (
							...
							for (
								let l = 0, a = Math.min(r.length, i.length);
								l < a && r.codePointAt(l) === i.codePointAt(l);
							) {
								++l;
							}
							return (
...
`) > -1
						...
						($e.prototype.ensurePolled = function ensurePolled() {
							this.pollingFast && this.poll() && (this.pollingFast = !1);
						}),
						($e.prototype.onKeyPress = function onKeyPress() {
							b && N >= 9 && (this.hasSelection = undefined), this.fastPoll();
						}),
						($e.prototype.onContextMenu = function onContextMenu(e) {
							const t = this,
								n = t.cm,
								r = n.display,
								i = t.textarea;
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`);
							...
							_ && (v = i.ownerDocument.defaultView.scrollY),
								r.input.focus(),
								_ && i.ownerDocument.defaultView.scrollTo(undefined, v),
								r.input.reset(),
					...
					function Iu(e, t) {
						if (
							...
							t.autofocus === undefined)
						) {
							const n = y(xe(e));
							t.autofocus =
								n === e ||
								(e.getAttribute("autofocus") !== undefined &&
									n === document.body);
						}
						function r() {
							e.value = a.getValue();
						...
						const a = Ge((s) => e.parentNode.insertBefore(s, e.nextSibling), t);
						return a;
					}
					function zu(e) {
						(e.off = dt),
					...
					Du(Ge), Eu(Ge);
					const Bu = "iter insert remove copy getEditor constructor".split(" ");
					for (const gi in kt.prototype) {
						Object.hasOwn(kt.prototype, gi) &&
							oe(Bu, gi) < 0 &&
							(Ge.prototype[gi] = ((e) =>
								function () {
					...
					return (
						...
						(Ge.defineMode = function defineMode(e) {
			...
			((_Et, _zt) => {
				((C) => {
					...
					C.defineMode("css", (fe, H) => {
						...
						function qe(T) {
							return (B, F) => {
								for (let Ie = !1, ae; (ae = B.next()) !== undefined; ) {
									if (ae === T && !Ie) {
										T === ")" && B.backUp(1);
										break;
									}
								...
								return (
									(ae === T || (!Ie && T !== ")")) && (F.tokenize = undefined),
									oe("string", "string")
								);
							};
						}
						...
						return (
							...
							(Pe.block = (T, B, F) => {
								if (T === "word") {
									const Ie = B.current().toLowerCase();
									return Object.hasOwn(y, Ie)
							...
							(Pe.maybeprop = (T, B, F) =>
								T === ":" ? Oe(F, B, "prop") : Ue(T, B, F)),
							(Pe.prop = (T, B, F) => {
								if (T === ";") {
									return Re(F);
								}
								if (T === "{" && xe) {
									return Oe(F, B, "propBlock");
								}
								if (T === "}" || T === "{") {
									return et(T, B, F);
								}
							...
							(Pe.pseudo = (T, B, F) =>
								T === "meta"
									...
									: (T === "word"
										...
										: Ue(T, B, F))),
							(Pe.documentTypes = (T, B, F) =>
								T === "word" && Object.hasOwn(d, B.current())
									? ((be = "tag"), F.context.type)
									: Pe.atBlock(T, B, F)),
							(Pe.atBlock = (T, B, F) => {
								if (T === "(") {
									return Oe(F, B, "atBlock_parens");
								}
								if (T === "}" || T === ";") {
									return et(T, B, F);
								}
							...
							(Pe.atComponentBlock = (T, B, F) =>
								T === "}"
									? et(T, B, F)
									: (T === "{"
										? Re(F) && Oe(F, B, xe ? "block" : "top", !1)
										: (T === "word" && (be = "error"), F.context.type))),
							(Pe.atBlock_parens = (T, B, F) =>
								T === ")"
									? Re(F)
									: (T === "{" || T === "}"
										? et(T, B, F, 2)
										: Pe.atBlock(T, B, F))),
							(Pe.restricted_atBlock_before = (T, B, F) =>
								T === "{"
									? Oe(F, B, "restricted_atBlock")
									: (T === "word" && F.stateArg === "@counter-style"
										? ((be = "variable"), "restricted_atBlock_before")
										: Ue(T, B, F))),
							(Pe.restricted_atBlock = (T, B, F) =>
								T === "}"
									? ((F.stateArg = undefined), Re(F))
									: (T === "word"
										? ((F.stateArg === "@font-face" &&
												!Object.hasOwn(le, B.current().toLowerCase())) ||
											(F.stateArg === "@counter-style" &&
												!Object.hasOwn(p, B.current().toLowerCase()))
												? (be = "error")
												: (be = "property"),
											"maybeprop")
										: "restricted_atBlock")),
											...
											"interpolation"))),
							{
								startState(T) {
									return {
										...
										state: Ee ? "block" : "top",
										stateArg: undefined,
										context: new ct(Ee ? "block" : "top", T || 0, undefined),
									};
								},
								token(T, B) {
									if (!B.tokenize && T.eatSpace()) {
										return;
									}
									let F = (B.tokenize || Ne)(T, B);
									return (
					...
					function De(fe) {
						for (let H = {}, Ee = 0; Ee < fe.length; ++Ee) {
							H[fe[Ee].toLowerCase()] = !0;
						}
						return H;
					}
					const I = ["domain", "regexp", "url", "url-prefix"],
						K = De(I),
						$ = [
							"all",
							"aural",
					...
					function ze(fe, H) {
						for (let Ee = !1, D; (D = fe.next()) !== undefined; ) {
							if (Ee && D === "/") {
					...
					C.defineMIME("text/css", {
						...
						C.defineMIME("text/x-scss", {
							...
							tokenHooks: {
								...
								":"(fe) {
									return fe.match(/^\s*\{/, !1) ? [undefined, undefined] : !1;
								},
								$(fe) {
									return (
										fe.match(/^[\w-]+/),
								...
								"#"(fe) {
									return fe.eat("{") ? [undefined, "interpolation"] : !1;
								},
							},
							name: "css",
							helperType: "scss",
				...
				((C) => {
					...
					C.defineMode("xml", (K, $) => {
						...
						function z(d, S) {
							...
							if (w === "=") {
								return (ie = "equals"), undefined;
							}
							if (w === "<") {
								(S.tokenize = q),
									(S.state = Ae),
									(S.tagName = S.tagStart = undefined);
						...
						function re(d, S, w) {
							(this.prev = d.context),
								...
								(this.startOfLine = w),
								(Object.hasOwn(b.doNotIndent, S) || d.context?.noIndent) &&
									(this.noIndent = !0);
						}
						function ne(d) {
						...
						function se(d, S) {
							for (let w; ; ) {
								if (
									...
									((w = d.context.tagName),
									!(
										Object.hasOwn(b.contextGrabbers, te(w)) &&
										Object.hasOwn(b.contextGrabbers[te(w)], te(S))
									))
								) {
									return;
								}
						...
						function de(d, S, w) {
							if (d === "word") {
								...
								return (
									w.context &&
										w.context.tagName !== m &&
										Object.hasOwn(b.implicitlyClosed, te(w.context.tagName)) &&
										ne(w),
									(w.context && w.context.tagName === m) ||
									b.matchClosing === !1
										? ((O = "tag"), ze)
										: ((O = "tag error"), fe)
								);
						...
						function H(d, w) {
							...
							if (d === "endTag" || d === "selfcloseTag") {
								const m = w.tagName,
									y = w.tagStart;
								return (
									(w.tagName = w.tagStart = undefined),
									d === "selfcloseTag" ||
									Object.hasOwn(b.autoSelfClosers, te(m))
										? se(w, m)
						...
						return {
							startState(d) {
								...
								return d !== undefined && (S.baseIndent = d), S;
							},
							token(d, S) {
								if (
							...
							indent(d, S, w) {
								...
								if (y?.[1]) {
									while (m) {
										...
										if (Object.hasOwn(b.implicitlyClosed, te(m.tagName))) {
											m = m.prev;
										} else {
											break;
										}
									...
									while (m) {
										const P = b.contextGrabbers[te(m.tagName)];
										if (P && Object.hasOwn(P, te(y[2]))) {
											m = m.prev;
										} else {
											break;
										}
							...
							xmlCurrentContext(d) {
								for (let S = [], w = d.context; w; w = w.prev) {
									S.push(w.tagName);
								}
								return S.reverse();
							},
						...
						Object.hasOwn(C.mimeModes, "text/html") ||
		...
		ba ||
			...
			((_Et, _zt) => {
				((C) => {
					...
					C.defineMode("javascript", (De, I) => {
						const K = De.indentUnit,
							$ = I.statementIndent,
							V = I.jsonld,
							b = I.json || V,
							N = I.trackScope !== !1,
							_ = I.typescript,
							ie = I.wordCharacters || /[\w$\u00A1-\uFFFF]/,
							O = (() => {
								function f(it) {
						...
						function X(f) {
							for (let g = !1, A, W = !1; (A = f.next()) !== undefined; ) {
								if (!g) {
									if (A === "/" && !W) {
										return;
									}
						...
						function re(f, g) {
							...
							if (
								A === "0" &&
								f.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/)
							) {
								return te("number", "number");
							}
							if (/\d/.test(A)) {
						...
						function ne(f) {
							return (g, A) => {
								...
								while ((L = g.next()) !== undefined && !(L === f && !W)) {
									W = !W && L === "\\";
								}
						...
						function Ae(f, g) {
							for (let A = !1, W; (W = f.next()) !== undefined; ) {
								if (!A && (W === "`" || (W === "$" && f.eat("{")))) {
									g.tokenize = re;
									break;
								}
						...
						const ye = "([{}])";
						function de(f, g) {
							g.fatArrowAt && (g.fatArrowAt = undefined);
							let A = f.string.indexOf("=>", f.start);
							if (!(A < 0)) {
								if (_) {
									const W = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(
								...
								for (let L = 0, Z = !1, _e = A - 1; _e >= 0; --_e) {
									const it = f.string.charAt(_e),
										xt = ye.indexOf(it);
									if (xt !== -1 && xt < 3) {
										if (!L) {
											++_e;
						...
						function fe(f, g, A, W, L, Z) {
							(this.indented = f),
								...
								(this.prev = L),
								(this.info = Z),
								W !== undefined && (this.align = W);
						}
						function H(f, g) {
							if (!N) {
								return !1;
							}
							for (let A = f.localVars; A; A = A.next) {
								if (A.name === g) {
									return !0;
								}
							}
							for (let W = f.context; W; W = W.prev) {
								for (let A = W.vars; A; A = A.next) {
									if (A.name === g) {
										return !0;
									}
								}
						...
						const D = { state: undefined, marked: undefined, cc: undefined };
						function J() {
							for (let f = arguments.length - 1; f >= 0; f--) {
								D.cc.push(arguments[f]);
							}
						}
						function d() {
							return J.apply(undefined, arguments), !0;
						}
						function S(f, g) {
							for (let A = g; A; A = A.next) {
								if (A.name === f) {
									return !0;
								}
							}
						...
						const p = new le("this", new le("arguments", undefined));
						function c() {
						...
						function Re(f, g, A) {
							...
							if (f !== ";") {
								...
								if (f === "[") {
									return d(j("]"), ct, Te("]"), ue, W);
								}
								if (_ && g === "as") {
									return (D.marked = "keyword"), d(We, W);
								}
								if (f === "regexp") {
									return (
						...
						function Me(f, g, A) {
							function W(L, Z) {
								if (A ? A.indexOf(L) > -1 : L === ",") {									return (
										_e.info === "call" && (_e.pos = (_e.pos || 0) + 1),
										d((it, xt) => (it === g || xt === g ? J() : J(f)), W)
									);
								}
								return L === g || Z === g
									? d()
							...
							return (L, Z) => (L === g || Z === g ? d() : J(f, W));
						}
						function Lt(f, g, A) {
							for (let W = 3; W < arguments.length; W++) {
						...
						function Pt(f, g) {
							...
							if (f === "(") {
								return d(c, j(")"), Me(_t, ")"), ue, lr, Le, xe);
							}
							if (_ && g === "<") {
						...
						function zr(f, g) {
							if (g === "as") {
								return (D.marked = "keyword"), d(Te("variable"));
							}
							if (f === "variable") {
								return J(Ne, zr);
							}
						...
						return {
							startState(f) {
								const g = {
									...
									context: I.localVars && new P(undefined, undefined, !1),
									indented: f || 0,
								};
								return (
									I.globalVars &&
							...
							indent(f, g) {
								if (f.tokenize === se || f.tokenize === Ae) {
									return C.Pass;
								}
								if (f.tokenize !== re) {
									return 0;
								...
								let A = g?.charAt(0),
									...
									L;
								if (!/^\s*else\b/.test(g)) {
									for (let Z = f.cc.length - 1; Z >= 0; --Z) {										if (_e === ue) {
											W = W.prev;
										} else if (_e !== Or && _e !== xe) {
											break;
										}
							...
							blockCommentStart: b ? undefined : "/*",
							blockCommentEnd: b ? undefined : "*/",
							blockCommentContinue: b ? undefined : " * ",
							lineComment: b ? undefined : "//",
							fold: "brace",
							closeBrackets: "()[]{}''\"\"``",
							...
							skipExpression(f) {
								Ee(
									...
									"atom",
									"true",
									new C.StringStream("", 2, undefined),
								);
							},
						};
					}),
			...
			((_Et, _zt) => {
				((C) => {
					...
					function N(ie, O) {
						for (const q in ie) {
							for (
								let z = O[q] || (O[q] = []), X = ie[q], ke = X.length - 1;
								ke >= 0;
								ke--
							) {
								z.unshift(X[ke]);
					...
					C.defineMode(
						...
						(ie, O) => {
							...
							function te(re, ne) {
								let se = q.token(re, ne.htmlState),
									Ae = /\btag\b/.test(se),
									ye;
								if (
									Ae &&
									!/[<>\s/]/.test(re.current()) &&
									(ye = ne.htmlState.tagName?.toLowerCase()) &&
									Object.hasOwn(z, ye)
								) {
									ne.inTag = `${ye} `;
								} else if (ne.inTag && Ae && re.current().endsWith(">")) {
									const de = /^([\S]+) (.*)/.exec(ne.inTag);
									ne.inTag = undefined;
									const ze = re.current() === ">" && _(z[de[1]], de[2]),
										fe = C.getMode(ie, ze),
										H = b(de[1], !0),
										Ee = b(de[1], !1);
									(ne.token = (D, J) =>
										D.match(H, !1)
											? ((J.token = te),
												(J.localState = J.localMode = undefined),
												undefined)
		...
		Sa ||
			...
			((_Et, _zt) => {
				((C) => {
					...
					function V(N) {
						return N.scopes.at(-1);
					}
					C.defineMode("python", (N, _) => {
						for (
							let _ie = "error",
								_O =
									_.delimiters || _.singleDelimiters || /^[()[\]{}@,:`=;.\\]/,
								q = [
									_.singleOperators,
									_.doubleOperators,
									_.doubleDelimiters,
						...
						let X = _.hangingIndent || N.indentUnit,
							ke = K,
							we = $;
						_.extra_keywords !== undefined &&
							(ke = ke.concat(_.extra_keywords)),
							_.extra_builtins !== undefined &&
								(we = we.concat(_.extra_builtins));
						const te = !(_.version && Number(_.version) < 3);
						if (te) {							(ke = ke.concat([
								"nonlocal",
								"None",
								"aiter",
								...
								(we = we.concat(["ascii", "bytes", "exec", "print"]));						} else {							(ke = ke.concat(["exec", "print"])),
								(we = we.concat([
									"apply",
									"basestring",
									"buffer",
						...
						const se = De(ke),
							Ae = De(we);
						function ye(S, w) {
							const m = S.sol() && w.lastToken !== "\\";
							if (
								(m && (w.indent = S.indentation()), m && V(w).type === "py")
							) {
								const y = V(w).offset;
								if (S.eatSpace()) {
									const P = S.indentation();
									return (
										P > y
											? H(w)
											: P < y &&
						...
						function de(S, w, m) {
							...
							if (ne.test(S)) {
								const le = S.current().toLowerCase().indexOf("f") !== -1;
								return le
											...
											: /^(self|cls)\b/.test(S)
												...
												: re.test(S)
													? w.lastToken === "def" || w.lastToken === "class"
														? "def"
														: "variable"
													: (S.next(), m ? undefined : ie);
						}
						function ze(S, w) {
							while ("rubf".indexOf(S.charAt(0).toLowerCase()) >= 0) {
								S = S.slice(1);
							}
							const m = S.length === 1,
								y = "string";
						...
						const d = {
							startState(S) {
								return {
									tokenize: ye,
									scopes: [{ offset: S || 0, type: "py", align: undefined }],
									indent: S || 0,
									lastToken: undefined,
									lambda: !1,
									dedent: 0,
				...
				((C) => {
					...
					function I(m, y, P, le) {
						...
						return (
							...
							(m.context = new De(p, y, P, le, undefined, m.context))
						);
					}
					function K(m) {
						const y = m.context.type;
						return (
							(y === ")" || y === "]" || y === "}") &&
					...
					C.defineMode("clike", (m, y) => {
						...
						function T(ae, Se) {
							...
							if (ct.test(he)) {
								if ((ae.backUp(1), ae.match(Oe))) {
									return "number";
								}
								ae.next();
							}
							if (Ve.test(he)) {
								return (ge = he), undefined;
							}
							if (he === "/") {
								if (ae.eat("*")) {
								...
								if (ae.eat("/")) {
									return ae.skipToEnd(), "comment";
								}
							}
							if (Re.test(he)) {
								while (!ae.match(/^\/[/*]/, !1) && ae.eat(Re)) {}
								return "operator";
							}
						...
						function B(ae) {
							return (Se, he) => {
								...
								return (
									(Lt || !(Be || be)) && (he.tokenize = undefined), "string"
								);
							};
						}
						function F(ae, Se) {
							for (let he = !1, Be; (Be = ae.next()); ) {
								if (Be === "/" && he) {
									Se.tokenize = undefined;
									break;
								}
								he = Be === "*";
							}
						...
						return {
							startState(ae) {
								return {
									tokenize: undefined,
									context: new De((ae || 0) - P, 0, "top", undefined, !1),
									indented: 0,
									startOfLine: !0,
									prevToken: undefined,
								};
							...
							token(ae, Se) {
								...
								if (
									(ae.sol() &&
										(he.align === undefined && (he.align = !1),
										(Se.indented = ae.indentation()),
										(Se.startOfLine = !0)),
									ae.eatSpace())
								) {
									return Ie(ae, Se), undefined;
								}
								ge = Pe = undefined;
								let Be = (Se.tokenize || T)(ae, Se);
								if (Be === "comment" || Be === "meta") {
									return Be;
								}
								if (
									(he.align === undefined && (he.align = !0),
									ge === ";" ||
										ge === ":" ||
										(ge === "," && ae.match(/^\s*(?:\/\/.*)?$/, !1)))
								) {
									while (Se.context.type === "statement") {
										K(Se);
									}
								} else if (ge === "{") {
									I(Se, ae.column(), "}");
							...
							indent(ae, Se) {
								if (
									(ae.tokenize !== T && ae.tokenize !== undefined) ||
								...
								if (Le.indent) {
									const Lt = Le.indent(ae, he, Se, P);
									if (typeof Lt === "number") {
										return Lt;
									}
								}
								const Nt = he.prev && he.prev.info === "switch";
								if (y.allmanIndentation && /[{(]/.test(Be)) {
									while (he.type !== "top" && he.type !== "}") {
										he = he.prev;
									}
									return he.indented;
								}
					...
					function b(m) {
						for (let y = {}, P = m.split(" "), le = 0; le < P.length; ++le) {
							y[P[le]] = !0;
						}
						return y;
					}
					...
					const te = "case do else for if switch while struct enum union",
						re = "struct enum union";
					function ne(m, y) {
						if (!y.startOfLine) {
							return !1;
						}
						for (let P, _le; (P = m.peek()); ) {
							if (P === "\\" && m.match(/^.$/)) {
								_le = ne;
								break;
							}
					...
					function de(m, y) {
						if ((m.backUp(1), m.match(/^(?:R|u8R|uR|UR|LR)/))) {
							const P = m.match(/^"([^\s\\()]{0,16})\(/);
							return P
								? ((y.cpp11RawStringDelim = P[1]), (y.tokenize = H), H(m, y))
								: !1;
						}
						return /^(?:u8|u|U|L)/.test(m)
							? (m.match(/^["']/, !1)
								? "string"
								: !1)
							: (m.next(), !1);
					...
					function fe(m, y) {
						for (let P; (P = m.next()) !== undefined; ) {
							if (P === '"' && !m.eat('"')) {
								y.tokenize = undefined;
								break;
							}
						}
						return "string";
					...
					function H(m, y) {
						const P = y.cpp11RawStringDelim.replaceAll(
								/[^\w\s]/g,
								String.raw`\$&`,
							),
							le = m.match(new RegExp(`.*?\\)${P}"`));
						return le ? (y.tokenize = undefined) : m.skipToEnd(), "string";
					}
					function Ee(m, y) {
						typeof m === "string" && (m = [m]);
						const P = [];
					...
					function J(m) {
						return (y, P) => {
							for (let le; (le = y.next()); ) {
								if (le === "*" && y.eat("/")) {
									if (m === 1) {
										P.tokenize = undefined;
										break;
									}
					...
					function d(m) {
						return (y, P) => {
							...
							return (c || !m) && (P.tokenize = undefined), "string";
						};
					}
					Ee("text/x-kotlin", {
						name: "clike",
						...
						Ee("text/x-objectivec++", {
							...
							builtin: b(q),
							blockKeywords: b(
								`${te} @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch`,
							),
							defKeywords: b(
					...
					function w(m) {
						return (y, P) => {
							...
							return c && (P.tokenize = undefined), "string";
						};
					}
					Ee("text/x-ceylon", {
						name: "clike",
						...
						hooks: {
							...
							"`"(m, y) {
								return S && m.match("`")
									? ((y.tokenize = S), (S = undefined), y.tokenize(m, y))
									: !1;
							},
							"'"(m) {
								return m.eatWhile(/[\w$_\u00A1-\uFFFF]/), "atom";
							},
							token(_m, y, P) {
			...
			((_Et, _zt) => {
				((C) => {
					...
					for (let De = 0; De < C.modeInfo.length; De++) {
						const I = C.modeInfo[De];
						I.mimes && (I.mime = I.mimes[0]);
					}
					(C.findModeByMIME = (K) => {
						K = K.toLowerCase();
						for (let $ = 0; $ < C.modeInfo.length; $++) {
							const V = C.modeInfo[$];
							if (V.mime === K) {
								return V;
							}
							if (V.mimes) {
								for (let b = 0; b < V.mimes.length; b++) {
									if (V.mimes[b] === K) {
										return V;
									}
								}
						...
						if (K.endsWith("+json")) {
							return C.findModeByMIME("application/json");
						}
					}),
						(C.findModeByExtension = (K) => {
							K = K.toLowerCase();
							for (let $ = 0; $ < C.modeInfo.length; $++) {
								const V = C.modeInfo[$];
								if (V.ext) {
									for (let b = 0; b < V.ext.length; b++) {
										if (V.ext[b] === K) {
											return V;
										}
									}
						...
						(C.findModeByFileName = (K) => {
							...
							const b = K.lastIndexOf("."),
								N = b !== -1 && K.slice(b + 1);
							if (N) {
								return C.findModeByExtension(N);
							}
						}),
						(C.findModeByName = (K) => {
							K = K.toLowerCase();
							for (let $ = 0; $ < C.modeInfo.length; $++) {
								...
								if (V.alias) {
									for (let b = 0; b < V.alias.length; b++) {
										if (V.alias[b].toLowerCase() === K) {
											return V;
										}
									}
								}
			...
			((_Et, _zt) => {
				((C) => {
					...
					C.defineMode(
						"markdown",
						(De, I) => {
							const K = C.getMode(De, "text/html"),
								$ = K.name === "null";
							function V(p) {
								if (C.findModeByName) {
								...
								const Y = C.getMode(De, p);
								return Y.name === "null" ? undefined : Y;
							}
							...
							function ye(p) {
								if (
									...
									let c = $;
									if (!c) {
										const Y = C.innerMode(K, p.htmlState);
										c =
											Y.mode.name === "xml" &&
									...
									c && ((p.f = D), (p.block = de), (p.htmlState = undefined));
								}
								return (
									(p.trailingSpace = 0),
									(p.trailingSpaceNewLine = !1),
									(p.prevLine = p.thisLine),
									(p.thisLine = { stream: undefined }),
									undefined
								);
							}
							function de(p, c) {
								const Y = p.column() === c.indentation,
									xe = Ae(c.prevLine.stream),
									j = c.indentedCode,
									ue = c.prevLine.hr,
									Te = c.list !== !1,
									Le = (c.listStack.at(-1) || 0) + 3;
								c.indentedCode = !1;
								const { indentation: be } = c;
								if (
									c.indentationDiff === null &&
									((c.indentationDiff = c.indentation), Te)
								) {
									for (c.list = undefined; be < c.listStack.at(-1); ) {
										c.listStack.pop(),
											c.listStack.length > 0
												? (c.indentation = c.listStack.at(-1))
												: (c.list = !1);
									}
									c.list !== !1 &&
										(c.indentationDiff = be - c.listStack.at(-1));
								}
								let oe = !(
										xe ||
										ue ||
							...
							function ze(p, c) {
								const Y = K.token(p, c.htmlState);
								if (!$) {
									const xe = C.innerMode(K, c.htmlState);
									((xe.mode.name === "xml" &&
										xe.state.tagStart === null &&
										!xe.state.context &&
										xe.state.tokenize.isInText) ||
										(c.md_inside && p.current().indexOf(">") > -1)) &&
										((c.f = D), (c.block = de), (c.htmlState = undefined));
								}
								return Y;
							}
							function fe(p, c) {
								const Y = c.listStack.at(-1) || 0,
									xe = c.indentation < Y,
									j = Y + 3;
								if (
									c.fencedEndRE &&
									...
									return (
										xe || (ue = H(c)),
										(c.localMode = c.localState = undefined),
										(c.block = de),
										(c.f = D),
										(c.fencedEndRE = undefined),
										(c.code = 0),
							...
							function H(p) {
								...
								if (p.formatting) {
									...
									for (let Y = 0; Y < p.formatting.length; Y++) {
								...
								if (p.taskOpen) {
									return c.push("meta"), c.length > 0 ? c.join(" ") : undefined;
								}
								if (p.taskClosed) {
									return (
										c.push("property"), c.length > 0 ? c.join(" ") : undefined
									);
								}
								if (
									(p.linkHref
									...
									const xe = (p.listStack.length - 1) % 3;
									xe
										? (xe === 1
											? c.push(b.list2)
											: c.push(b.list3))
							...
							function D(p, c) {
								...
								if (c.list) {
									return (c.list = undefined), H(c);
								}
								if (c.taskList) {
									const xe = p.match(O, !0)[1] === " ";
									return (
								...
								if (j === "`") {
									const { formatting: Le } = c;
									I.highlightFormatting && (c.formatting = "code"),
										p.eatWhile("`");
									const be = p.current().length;
								...
								if (
									...
									if (Ve !== -1) {
										const ct = p.string.slice(p.start, Ve);
								...
								if (j === "*" || j === "_") {
									for (
										let Oe = 1,
											_Re = p.pos === 1 ? " " : p.string.charAt(p.pos - 2);
										Oe < 3 && p.eat(j);
									) {
										Oe++;
									}
							...
							const le = {
								startState() {
									return {
										f: de,
										prevLine: { stream: undefined },
										thisLine: { stream: undefined },
										block: de,
										htmlState: undefined,
										indentation: 0,
										inline: D,
								...
								token(p, c) {
									if (((c.formatting = !1), p !== c.thisLine.stream)) {
										...
										if (
											...
											const Y = p
												.match(/^\s*/, !0)[0]
												.replaceAll("\\t", re).length;
											if (
												((c.indentation = Y),
												(c.indentationDiff = undefined),
												Y > 0)
											) {
												return;
											}
		...
		Ea ||
			...
			((_Et, _zt) => {
				((C) => {
					...
					C.defineOption("placeholder", "", (N, _, ie) => {
						const O = ie && ie !== C.Init;
						if (_ && !O) {
							N.on("blur", $),
								N.on("change", V),
								N.on("swapDoc", V),
					...
					function De(N) {
						N.state.placeholder &&
							...
							(N.state.placeholder = undefined));
					}
					function I(N) {
						De(N);
						const _ = (N.state.placeholder = document.createElement("pre"));
						...
						let ie = N.getOption("placeholder");
					...
					function K(N) {
						setTimeout(() => {
							let _ = !1;
							if (N.lineCount() === 1) {
								const ie = N.getInputField();
								_ =
									ie.nodeName === "TEXTAREA"
										? N.getLine(0).length === 0
										: !/[^\u200B]/.test(
		...
		Oa ||
			...
			((_Et, _zt) => {
				((C) => {
					...
					(C.defineSimpleMode = (O, q) => {
						C.defineMode(O, (z) => C.simpleMode(z, q));
					}),
						(C.simpleMode = (O, q) => {
							De(q, "start");
							let z = {},
								...
								ke = !1;
							for (const we in q) {
								if (we !== X && Object.hasOwn(q, we)) {
									for (
										let te = (z[we] = []), re = q[we], ne = 0;
										ne < re.length;
										ne++
									) {
										const se = re[ne];
							...
							const Ae = {
								...
								copyState(de) {
									...
									de.localState &&
										...
										de.stack && (ze.stack = [...de.stack]);
									for (let fe = de.persistentStates; fe; fe = fe.next) {
										ze.persistentStates = {
											mode: fe.mode,
											spec: fe.spec,
											state:
					...
					function K(O) {
						...
						for (let q = [], z = 0; z < O.length; z++) {
							q.push(O[z]?.replaceAll("\\.", " "));
						}
						return q;
					}
					function $(O, q) {
					...
					function V(O, q) {
						return (z, X) => {
							if (X.pending) {
								const ke = X.pending.shift();
								return (
									X.pending.length === 0 && (X.pending = undefined),
							...
							if (X.local) {
								if (X.local.end && z.match(X.local.end)) {
									const we = X.local.endToken || undefined;
									return (X.local = X.localState = undefined), we;
								}
								let we = X.local.mode.token(z, X.localState),
									te;
								return (
									X.local.endScan &&
							...
							for (let re = O[X.state], ne = 0; ne < re.length; ne++) {
								const se = re[ne],
								...
								if (Ae) {
									...
									return ye?.join ? ye[0] : ye;
								}
							}
							return z.next(), undefined;
						};
					}
					function b(O, q) {
						if (O === q) {
						...
						for (const X in O) {
							if (Object.hasOwn(O, X)) {
								if (!(Object.hasOwn(q, X) && b(O[X], q[X]))) {
									return !1;
								}
								z++;
							}
					...
					function N(O, q, z, X) {
						let ke;
						if (z.persistent) {
							for (let we = q.persistentStates; we && !ke; we = we.next) {
								(z.spec ? b(z.spec, we.spec) : z.mode === we.mode) && (ke = we);
							}
						}
						const te = ke ? ke.mode : z.mode || C.getMode(O, z.spec),
		...
		Ia ||
			...
			((_Et, _zt) => {
				((C) => {
					...
					C.defineMode("yaml", () => {
						const De = ["true", "false", "on", "off", "yes", "no"],
