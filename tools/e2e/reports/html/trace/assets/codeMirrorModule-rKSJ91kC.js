...
`,
					...
					(Je.prototype.eol = function eol() {
						...
						(Je.prototype.eatSpace = function eatSpace() {
							for (
								const { pos: _e } = this;
								/[\s\u00A0]/u.test(this.string.charAt(this.pos));
							) {
								++this.pos;
							}
							return this.pos > e;
