		...
		ha ||
			...
			((Et, zt) => {
				((C, De) => {
					...
					function Te(e, t, n) {
						t || (t = {});
						for (var r in e) Object.hasOwn(e, r) && (n !== !1 || !Object.hasOwn(t, r)) && (t[r] = e[r]);
						return t;
					}
					...
					var Ue = [""];
					function et(e) {
						while (Ue.length <= e) Ue.push(ge(Ue) + " ");
						return Ue[e];
					}
					function ge(e) {
						return e[e.length - 1];
					...
					function Lt(e, t, n) {
						while ((n < 0 ? t > 0 : t < e.length) && Me(e.charAt(t))) t += n;
						return t;
					}
					function Nt(e, t, n) {
						for (var r = t > n ? -1 : 1; ; ) {
...
`,
					...
					function Ir(e) {
						...
						else if (e && typeof e.name == "string" && Object.hasOwn(Ht, e.name)) {
							var t = Ht[e.name];
					...
					function zr(e, t) {
						...
						if (Object.hasOwn(fr, t.name)) {
							var i = fr[t.name];
							for (var o in i) Object.hasOwn(i, o) && (Object.hasOwn(r, o) && (r["_" + o] = r[o]), (r[o] = i[o]));
						}
					...
					(Xt.prototype.lookAhead = function (e) {
						...
						(Xt.fromSaved = (e, t, n) =>
							t instanceof Hn ? new Xt(e, Gt(e.mode, t.state), n, t.lookAhead) : new Xt(e, Gt(e.mode, t), n)),
...
`
							...
							if (((e.trailingSpace = a.charCodeAt(t.length - 1) == 32), n || r || i || u || o || l)) {
								...
								var G = d("span", [h], Q, o);
								if (l)
									for (var ee in l) Object.hasOwn(l, ee) && ee != "style" && ee != "class" && G.setAttribute(ee, l[ee]);
					...
					function Ho(e) {
						...
						var t = J(e.measure, d("pre", "x", "CodeMirror-line-like")),
							...
							r = { left: Number.parseInt(n.paddingLeft), right: Number.parseInt(n.paddingRight) };
						...
						for (var r, i, o, l, a, s, u = 0; u < e.length; u += 3)
							if (
								...
								if (
									...
									while (u && e[u - 2] == e[u - 3] && e[u - 1].insertLeft) (r = e[(u -= 3) + 2]), (l = "left");
								if (n == "right" && i == s - a)
					...
					function xs(e, t, n, r) {
						...
						if (o.nodeType == 3) {
							for (var h = 0; h < 4; h++) {
								while (l && Me(t.line.text.charAt(i.coverStart + l))) --l;
								while (i.coverStart + a < i.coverEnd && Me(t.line.text.charAt(i.coverStart + a))) ++a;
								if (
					...
					function Xo(e) {
						return O && re
							? -(e.body.getBoundingClientRect().left - Number.parseInt(getComputedStyle(e.body).marginLeft))
							: e.defaultView.pageXOffset || (e.documentElement || e.body).scrollLeft;
					}
					function Yo(e) {
						return O && re
							? -(e.body.getBoundingClientRect().top - Number.parseInt(getComputedStyle(e.body).marginTop))
					...
					function Qo(e, t, n, r) {
						...
						return (i = Nt((l) => Zt(e, n, l).top > r, o, i)), { begin: o, end: i };
					}
					function Vo(e, t, n, r) {
						n || (n = qr(e, t));
							...
							e.options.readOnly != "nocursor" &&
								(e.state.focused ||
									...
									!e.curOp &&
										...
										(e.display.input.reset(), _ && setTimeout(() => e.display.input.reset(!0), 20)),
					...
					function Bs(e) {
						...
						if (!(t.highlightFrontier >= e.display.viewTo)) {
							var n = +new Date() + e.options.workTime,
								...
								i = [];
							t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), (o) => {
					...
					function qs(e, t, n, r) {
						(this.input = n),
							(this.scrollbarFiller = d("div", null, "CodeMirror-scrollbar-filler")),
							...
							(this.selectionDiv = d("div", null, null, "position: relative; z-index: 1")),
						...
						var o = S("div", [this.lineSpace], "CodeMirror-lines");
						(this.mover = d("div", [o], null, "position: relative")),
							(this.sizer = d("div", [this.mover], "CodeMirror-sizer")),
							(this.sizerWidth = null),
							(this.heightForcer = d("div", null, null, "position: absolute; height: " + Ne + "px; width: 1px;")),
							(this.gutters = d("div", null, "CodeMirror-gutters")),
							(this.lineGutter = null),
							(this.scroller = d("div", [this.sizer, this.heightForcer, this.gutters], "CodeMirror-scroll")),
							this.scroller.setAttribute("tabIndex", "-1"),
							(this.wrapper = d("div", [this.scrollbarFiller, this.gutterFiller, this.scroller], "CodeMirror")),
							O && q >= 105 && (this.wrapper.style.clipPath = "inset(0px)"),
							this.wrapper.setAttribute("translate", "no"),
							b && N < 8 && ((this.gutters.style.zIndex = -1), (this.scroller.style.paddingRight = 0)),
					...
					function Vi(e, t) {
						...
						return wl(e, n, t.from.line, t.to.line + 1), vr(e, (r) => wl(r, n, t.from.line, t.to.line + 1), !0), n;
					}
					function bl(e) {
						while (e.length) {
							var t = ge(e);
					...
					function Ol(e, t) {
						if (!(t.text.length == 1 && t.text[0] == "" && Z(t.from, t.to) == 0)) {
							var n = Zi(e, t);
							kl(e, t, n, e.cm ? e.cm.curOp.id : Number.NaN), Tn(e, t, n, wi(e, t));
							var r = [];
							vr(e, (i, o) => {
					...
					function Pl(e, t) {
						if (
							...
							((e.first += t),
							(e.sel = new At(
								Pe(e.sel.ranges, (i) => new He(L(i.anchor.line + t, i.anchor.ch), L(i.head.line + t, i.head.ch))),
								e.sel.primIndex
							)),
							e.cm)
						) {
					...
					(Mn.prototype.clear = function () {
						...
						(Mn.prototype.changed = function () {
							...
							i &&
								...
								n &&
									Dt(n, () => {
										(n.curOp.forceUpdate = !0), Wl(n, r, i), ot(n, "lineWidgetChanged", n, this, f(r));
									}));
						}),
						Bt(Mn);
					function Wl(e, t, n) {
					...
					function Vr(e, t, n, r, i) {
						...
						o.addToHistory && kl(e, { from: t, to: n, origin: "markText" }, e.sel, Number.NaN);
						var a = t.line,
							s = e.cm,
							u;
						if (
					...
					function Hl(e) {
						return e.findMarks(L(e.first, 0), e.clipPos(L(e.lastLine())), (t) => t.parent);
					}
					function tu(e, t) {
					...
					(kt.prototype = F(Dn.prototype, {
						...
						clearHistory() {
							(this.history = new ni(this.history)), vr(this, (t) => (t.history = this.history), !0);
						},
						markClean() {
							...
							this.iter((n) => {
								n.gutterMarkers &&
									...
									Ln(
										...
										n,
										"gutter",
										() => ((n.gutterMarkers[e] = null), he(n.gutterMarkers) && (n.gutterMarkers = null), !0)
									);
							});
						}),
						lineInfo(e) {
...
`
						...
						setDirection: at(function (e) {
							e != "rtl" && (e = "ltr"),
								e != this.direction &&
									((this.direction = e), this.iter((t) => (t.order = null)), this.cm && Us(this.cm));
						}),
					})),
						...
						if ((ql(this), !(Ze(this, e) || tr(this.display, e)))) {
							...
							if (!(!n || this.isReadOnly()))
								if (r && r.length && window.FileReader && window.File)
												...
												++l == i &&
													lt(this, () => {
														...
														var x = {
															from: n,
															to: n,
															text: this.doc.splitLines(o.filter((M) => M != null).join(this.doc.lineSeparator())),
															origin: "paste",
														};
														Jr(this.doc, x), Cl(this.doc, pr(Ce(this.doc, n), Ce(this.doc, gr(x))));
													})();
											},
											s = (x, M) => {
												if (this.options.allowDropFileTypes && oe(this.options.allowDropFileTypes, x.type) == -1) {
													a();
													return;
												}
									...
									if (this.state.draggingText && this.doc.sel.contains(n) > -1) {
										this.state.draggingText(e), setTimeout(() => this.display.input.focus(), 20);
										return;
									}
									try {
										...
										if (h) {
											var v;
											if (
												(this.state.draggingText && !this.state.draggingText.copy && (v = this.listSelections()),
												li(this.doc, pr(n, n)),
												v)
											)
												for (var k = 0; k < v.length; ++k) Qr(this.doc, "", v[k].anchor, v[k].head, "drag");
											this.replaceSelection(h, "around", "paste"), this.display.input.focus();
										}
									} catch {}
								}
						}
					...
					for (var En = 1; En <= 12; En++) yr[En + 111] = yr[En + 63_235] = "F" + En;
					var nr = {};
					(nr.basic = {
						Left: "goCharLeft",
						Right: "goCharRight",
						...
						if (e) {
							...
							if (o) {
								...
								if (l.level > 0 || t.doc.direction == "rtl") {
									...
									var v = Zt(t, h, u).top;
									(u = Nt((k) => Zt(t, h, k).top == v, i < 0 == (l.level == 1) ? l.from : l.to - 1, u)),
										s == "before" && (u = to(n, u, 1));
					...
					function du(e, t, n, r) {
						...
						if (e.doc.direction == "ltr" && l.level % 2 == 0 && (r > 0 ? l.to > n.ch : l.from < n.ch))
							return ro(t, n, r);
						var a = (U, Q) => to(t, U instanceof L ? U.ch : U, Q),
							s,
							u = (U) =>
								e.options.lineWrapping ? ((s = s || qr(e, t)), Vo(e, t, s, U)) : { begin: 0, end: t.text.length },
						...
						var M = (U, Q, G) => {
								for (
									var ee = (Ke, st) => (st ? new L(n.line, a(Ke, 1), "before") : new L(n.line, Ke, "after"));
									U >= 0 && U < i.length;
									U += Q
								) {
									var me = i[U],
					...
					var Nn = {
						...
						deleteLine(e) {
							return en(e, (t) => ({ from: L(t.from().line, 0), to: Ce(e.doc, L(t.to().line + 1, 0)) }));
						},
						delLineLeft(e) {
							return en(e, (t) => ({ from: L(t.from().line, 0), to: t.from() }));
						},
						...
						goLineStart(e) {
							return e.extendSelectionsBy((t) => Yl(e, t.head.line), { origin: "+move", bias: 1 });
						},
						goLineStartSmart(e) {
							return e.extendSelectionsBy((t) => Zl(e, t.head), { origin: "+move", bias: 1 });
						},
						goLineEnd(e) {
							return e.extendSelectionsBy((t) => hu(e, t.head.line), { origin: "+move", bias: -1 });
						},
						goLineRight(e) {
...
`,
					...
					function Vl(e) {
						if (
							...
							z &&
								((io = r ? n : null),
								!r && n == 88 && !_n && (se ? e.metaKey : e.ctrlKey) && this.replaceSelection("", null, "cut")),
								I &&
									!se &&
									!r &&
									n == 46 &&
								...
								n == 18 && !/\bCodeMirror-crosshair\b/.test(this.display.lineDiv.className) && mu(this);
						}
					}
					function mu(e) {
					...
					function ea(e) {
						if (
							...
							if (!(z && (!e.which || e.which < 10) && Ql(this, e))) {
								...
								i != "\b" && (vu(this, e, i) || this.display.input.onKeyPress(e));
							}
						}
					}
					var yu = 400,
					...
					function ta(e) {
						...
						if (!(Ze(this, e) || (n.activeTouch && n.input.supportsTouch()))) {
							if ((n.input.ensurePolled(), (n.shift = e.shiftKey), tr(n, e))) {
								_ || ((n.scroller.draggable = !1), setTimeout(() => (n.scroller.draggable = !0), 100));
								return;
							}
							if (!lo(this, e)) {
								var r = Tr(this, e),
									...
									o = r ? xu(r, i) : "single";
								j(this).focus(),
									i == 1 && this.state.selectingText && this.state.selectingText(e),
									!(r && bu(this, i, r, o, e)) &&
										(i == 1
											? r
												? wu(this, r, o, e)
											...
											: i == 2
												? (r && oi(this.doc, r), setTimeout(() => n.input.focus(), 20))
												: i == 3 && (fe ? this.display.input.onContextMenu(e) : Hi(this)));
							}
						}
					}
					...
					function Du(e) {
						...
						(e.defineOption = n),
							...
							n("spellcheck", !1, (r, i) => (r.getInputField().spellcheck = i), !0),
							n("autocorrect", !1, (r, i) => (r.getInputField().autocorrect = i), !0),
							n("autocapitalize", !1, (r, i) => (r.getInputField().autocapitalize = i), !0),
							...
							n("tabindex", null, (r, i) => (r.display.input.getField().tabIndex = i || "")),
							n("autofocus", null),
					...
					function Au(e) {
						...
						function i() {
							t.activeTouch &&
								((n = setTimeout(() => (t.activeTouch = null), 1e3)), (r = t.activeTouch), (r.end = +new Date()));
						}
						function o(s) {
						...
						ve(t.scroller, "touchstart", (s) => {
							...
							ve(t.wrapper, "scroll", () => (t.wrapper.scrollTop = t.wrapper.scrollLeft = 0)),
							(t.dragFunctions = {
								enter(s) {
									Ze(e, s) || ar(s);
								},
...
`) == t
							...
							} else s.length == r.ranges.length && e.options.pasteLinesPerSelection && (u = Pe(s, (U) => [U]));
...
`) &&
					...
					function aa(e, t) {
						...
						if (n)
							return (
								e.preventDefault(),
								!(t.isReadOnly() || t.options.disableInput) && t.hasFocus() && Dt(t, () => so(t, n, 0, null, "paste")),
								!0
							);
					}
					function sa(e, t) {
						...
						(e.prototype = {
							...
							setOption(r, i) {
								var o = this.options,
									l = o[r];
								(o[r] == i && r != "mode") ||
									((o[r] = i), Object.hasOwn(t, r) && lt(this, t[r])(this, i, l), Ye(this, "optionChange", this, r));
							},
							getOption(r) {
							...
							execCommand(r) {
								if (Object.hasOwn(Nn, r)) return Nn[r].call(null, this);
							},
							...
							moveV: vt(function (r, i) {
								...
								if (
									(l.extendSelectionsBy((h) => {
										...
										var v = jt(this, h.head, "div");
										h.goalColumn != null && (v.left = h.goalColumn), a.push(v.left);
										var k = ca(this, v, r, i);
										return i == "page" && h == l.sel.primary() && ji(this, Zn(this, k, "div").top - v.top), k;
									}, Oe),
									a.length)
								)
							...
							setSize: vt(function (r, i) {
								var l = (s) => (typeof s == "number" || /^\d+$/.test(String(s)) ? s + "px" : s);
							...
							(e.registerHelper = (r, i, o) => {
								Object.hasOwn(n, r) || (n[r] = e[r] = { _global: [] }), (n[r][i] = o);
							}),
						...
						function h(Q) {
							...
							if (r == "codepoint") {
								...
								if (isNaN(ee)) G = null;
									...
									var me = n > 0 ? ee >= 55_296 && ee < 56_320 : ee >= 56_320 && ee < 57_343;
...
`));
						...
						(je.prototype.pollContent = function () {
							...
							if (v.length == 1 && k.length == 1 && l == r.line)
								while (x && x > r.ch && Q.charCodeAt(Q.length - M - 1) == G.charCodeAt(G.length - M - 1)) x--, M++;
						...
						(je.prototype.updateFromDOM = function () {
							(this.cm.isReadOnly() || !this.pollContent()) && Dt(this.cm, () => bt(this.cm));
						}),
					...
					function Ou(e, t, n, r, i) {
						...
						while ((k(t), t != n)) (t = t.nextSibling), (s = !1);
						return o;
					}
					function pi(e, t, n) {
						var r;
					...
					($e.prototype.init = function (e) {
						...
						e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
							...
							ve(i, "input", () => {
								b && N >= 9 && this.hasSelection && (this.hasSelection = null), n.poll();
							}),
							ve(i, "paste", (l) => {
...
`)),
						...
						($e.prototype.poll = function () {
							...
							return (
								Dt(t, () => {
									so(t, i.slice(l), r.length - l, null, this.composing ? "*compose" : null),
										i.length > 1e3 ||
										i.indexOf(`
`) > -1
										...
										this.composing &&
											...
											(this.composing.range = t.markText(this.composing.start, t.getCursor("to"), {
				...
				((C) => {
					...
					C.defineMode("css", (fe, H) => {
						...
						function ge(T) {
							...
							Object.hasOwn(Y, B) ? (be = "atom") : Object.hasOwn(c, B) ? (be = "keyword") : (be = "variable");
						}
						var Pe = {};
						return (
							(Pe.top = (T, B, F) => {
							...
							(Pe.maybeprop = (T, B, F) => (T == ":" ? Oe(F, B, "prop") : Ue(T, B, F))),
							(Pe.prop = (T, B, F) => {
								if (T == ";") return Re(F);
							...
							(Pe.propBlock = (T, B, F) =>
								T == "}" ? Re(F) : T == "word" ? ((be = "property"), "maybeprop") : F.context.type),
							(Pe.parens = (T, B, F) =>
								T == "{" || T == "}"
									? et(T, B, F)
									: T == ")"
										...
										: T == "("
											...
											: T == "interpolation"
												...
												: (T == "word" && ge(B), "parens")),
							(Pe.pseudo = (T, B, F) =>
								T == "meta" ? "pseudo" : T == "word" ? ((be = "variable-3"), F.context.type) : Ue(T, B, F)),
							(Pe.documentTypes = (T, B, F) =>
								T == "word" && Object.hasOwn(d, B.current()) ? ((be = "tag"), F.context.type) : Pe.atBlock(T, B, F)),
							(Pe.atBlock = (T, B, F) => {
							...
							(Pe.atBlock_parens = (T, B, F) =>
								T == ")" ? Re(F) : T == "{" || T == "}" ? et(T, B, F, 2) : Pe.atBlock(T, B, F)),
							...
							(Pe.restricted_atBlock = (T, B, F) =>
								T == "}"
									...
									: T == "word"
										? ((F.stateArg == "@font-face" && !Object.hasOwn(le, B.current().toLowerCase())) ||
											(F.stateArg == "@counter-style" && !Object.hasOwn(p, B.current().toLowerCase()))
												? (be = "error")
												: (be = "property"),
											"maybeprop")
										: "restricted_atBlock"),
							(Pe.keyframes = (T, B, F) =>
								T == "word" ? ((be = "variable"), "keyframes") : T == "{" ? Oe(F, B, "top") : Ue(T, B, F)),
							(Pe.at = (T, B, F) =>
								T == ";"
									? Re(F)
									: T == "{" || T == "}"
					...
					C.defineMode("xml", (K, $) => {
						...
						function re(d, S, w) {
							(this.prev = d.context),
								...
								(this.startOfLine = w),
								(Object.hasOwn(b.doNotIndent, S) || (d.context && d.context.noIndent)) && (this.noIndent = !0);
						}
						function ne(d) {
						...
						function se(d, S) {
							for (var w; ; ) {
								if (
									!d.context ||
									((w = d.context.tagName),
									!(Object.hasOwn(b.contextGrabbers, te(w)) && Object.hasOwn(b.contextGrabbers[te(w)], te(S))))
								)
									return;
								ne(d);
							}
						...
						function de(d, S, w) {
							...
							return b.allowMissingTagName && d == "endTag" ? ((O = "tag bracket"), ze(d, S, w)) : ((O = "error"), fe);
						}
						function ze(d, S, w) {
						...
						function H(d, S, w) {
							...
							if (d == "endTag" || d == "selfcloseTag") {
								...
								return (
									...
									d == "selfcloseTag" || Object.hasOwn(b.autoSelfClosers, te(m))
										? se(w, m)
								...
								if (y && y[1])
									while (m)
										if (m.tagName == y[2]) {
											m = m.prev;
											break;
										} else if (Object.hasOwn(b.implicitlyClosed, te(m.tagName))) m = m.prev;
										else break;
								else if (y)
									while (m) {
										var P = b.contextGrabbers[te(m.tagName)];
										if (P && Object.hasOwn(P, te(y[2]))) m = m.prev;
										else break;
									}
								while (m && m.prev && !m.startOfLine) m = m.prev;
						...
						Object.hasOwn(C.mimeModes, "text/html") || C.defineMIME("text/html", { name: "xml", htmlMode: !0 });
				});
			})()),
		ma.exports
	);
					...
					C.defineMode("javascript", (De, I) => {
						...
						function ne(f) {
							return (g, A) => {
								...
								while ((L = g.next()) != null && !(L == f && !W)) W = !W && L == "\\";
						...
						function Ee(f, g, A, W, L) {
							...
							for (
								...
								if (_e(A, W)) {
									while (Z.length && Z[Z.length - 1].lex) Z.pop()();
						...
						function T(f) {
							return (g) => (g == "." ? d(f ? F : B) : g == "variable" && _ ? d(Ct, f ? Re : Oe) : J(f ? Ne : oe));
						}
						function B(f, g) {
						...
						return {
							...
							token(f, g) {
								if (
									(f.sol() &&
										(Object.hasOwn(g.lexical, "align") || (g.lexical.align = !1),
			...
			((Et, zt) => {
				((C) => {
					...
					C.defineMode("python", (N, _) => {
						...
						function ze(S, w) {
							while ("rubf".indexOf(S.charAt(0).toLowerCase()) >= 0) S = S.substr(1);
							var m = S.length == 1,
								y = "string";
							function P(p) {
								return (c, Y) => {
						...
						function H(S) {
							while (V(S).type != "py") S.scopes.pop();
				...
				((C) => {
					...
					C.defineMode("clike", (m, y) => {
						...
						function T(ae, Se) {
							...
							if ((ae.eatWhile(Ue), qe)) while (ae.match(qe)) ae.eatWhile(Ue);
							var Me = ae.current();
							return N(c, Me)
						...
						return {
							...
							token(ae, Se) {
								...
								if (
									...
									while (Se.context.type == "statement") K(Se);
								else if (ge == "{") I(Se, ae.column(), "}");
								else if (ge == "[") I(Se, ae.column(), "]");
								else if (ge == "(") I(Se, ae.column(), ")");
								else if (ge == "}") {
									while (he.type == "statement") he = K(Se);
							...
							indent(ae, Se) {
								...
								if ((he.type == "statement" && Be == "}" && (he = he.prev), y.dontIndentStatements))
									while (he.type == "statement" && y.dontIndentStatements.test(he.info)) he = he.prev;
								if (Le.indent) {
								...
								if (y.allmanIndentation && /[{(]/.test(Be)) {
									while (he.type != "top" && he.type != "}") he = he.prev;
									return he.indented;
								}
					...
					function Ee(m, y) {
						...
						var P = [];
						function le(c) {
							if (c) for (var Y in c) Object.hasOwn(c, Y) && P.push(Y);
						}
						le(y.keywords),
							le(y.types),
							le(y.builtin),
					...
					Ee("text/x-ceylon", {
						...
						hooks: {
							...
							"`"(m, y) {
								return S && m.match("`") ? ((y.tokenize = S), (S = null), y.tokenize(m, y)) : !1;
							},
							"'"(m) {
				...
				((C) => {
					...
					C.defineMode(
						...
						(De, I) => {
							...
							for (var N in b) Object.hasOwn(b, N) && I.tokenTypeOverrides[N] && (b[N] = I.tokenTypeOverrides[N]);
							var _ = /^([*\-_])(?:\s*\1){2,}\s*$/,
								ie = /^(?:[*\-+]|^[0-9]+([.)]))\s+/,
								O = /^\[(x| )\](?=\s)/i,
				...
				((C) => {
					...
					(C.defineSimpleMode = (O, q) => {
						...
						(C.simpleMode = (O, q) => {
							...
							if (X) for (var ye in X) Object.hasOwn(X, ye) && (Ae[ye] = X[ye]);
							return Ae;
						});
					function De(O, q) {
						if (!Object.hasOwn(O, q)) throw new Error("Undefined state " + q + " in simple mode");
					}
					function I(O, q) {
						if (!O) return /(?:)/;
						var z = "";
					...
					function b(O, q) {
						...
						for (var X in O)
							if (Object.hasOwn(O, X)) {
								if (!(Object.hasOwn(q, X) && b(O[X], q[X]))) return !1;
								z++;
							}
						for (var X in q) Object.hasOwn(q, X) && z--;
						return z == 0;
					}
					function N(O, q, z, X) {
						var ke;
