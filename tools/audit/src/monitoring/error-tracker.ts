...
export type ErrorCategory = 'validation' | 'performance' | 'integration' | 'constitutional' | 'system' | 'user'
...
export class ErrorTracker extends EventEmitter {
   ...
   */
  private checkConstitutionalViolation(error: Error, context: ErrorContext): ClassifiedError['constitutional'] {
  ...
  getErrorStats(timeWindow?: number): ErrorStats {
    ...
    const byCategory: Record<ErrorCategory, number> = {
      validation: 0, performance: 0, integration: 0, 
      constitutional: 0, system: 0, user: 0
    }
