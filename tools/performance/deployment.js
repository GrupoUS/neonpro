...
exports.DeploymentAutomation = exports.ProductionHealthCheck = exports.BuildOptimizer = exports.PreBuildOptimizer = exports.DEPLOYMENT_CONFIG = void 0;
var fs_1 = require("fs");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.optimizeImages()
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (stats.size > 500 * 1024) {
                            console.log("\uD83D\uDCF7 Large image detected: ".concat(path_1.default.relative(process.cwd(), file), " (").concat((stats.size / 1024).toFixed(0), "KB)"));
                        }
                        _a.label = 5;
                    case 5:
                        _i++;
    ...
    PreBuildOptimizer.validateEnvironment = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                missing = requiredVars.filter(function (varName) { return !process.env[varName]; });
                if (missing.length > 0) {
                            ...
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [3 /*break*/, 3];
                                    case 2:
                                        if (extensions.some(function (ext) { return item.name.toLowerCase().endsWith(ext); })) {
                                            files.push(fullPath);
                                        }
                                        _e.label = 3;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, fs_1.promises.stat(fullPath)];
                    case 6:
                        stats = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, PreBuildOptimizer.optimizeAssets()
                    ...
                    case 4:
                        ...
                        console.log("\uD83C\uDF89 Build completed in ".concat((buildTime / 1000).toFixed(2), "s"));
                        return [3 /*break*/, 6];
                    case 5:
                        error_5 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                buildCommand = __spreadArray([
                    'next',
                    'build',
                    exports.DEPLOYMENT_CONFIG.TURBOPACK ? '--turbopack' : ''
                ], exports.DEPLOYMENT_CONFIG.BUILD_FLAGS, true).filter(Boolean).join(' ');
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fs_1.promises.access(buildDir)
                            // Analyze build size
                        ];
                    case 2:
                        // Check if build directory exists
                    ...
                    case 3:
                        buildSize = _b.sent();
                        console.log("\uD83D\uDCE6 Build size: ".concat(PreBuildOptimizer['formatBytes'](buildSize)));
                        criticalFiles = [
                            '.next/static',
                            '.next/server',
                            '.next/standalone'
...
var ProductionHealthCheck = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.allSettled(checks.map(function (check) { return check(); }))];
                    case 1:
                        results = _a.sent();
                        failed = results.filter(function (result) { return result.status === 'rejected'; });
                        if (failed.length > 0) {
    ...
    ProductionHealthCheck.checkDependencies = function () {
        return __awaiter(this, void 0, void 0, function () {
            var packageJsonPath, packageJson, _a, _b, prodDeps, requiredDeps, _i, requiredDeps_1, dep, error_7;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fs_1.promises.readFile(nextConfigPath, 'utf-8')
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        // Run optimized build
                        return [4 /*yield*/, BuildOptimizer.optimizedBuild()
                    ...
                    case 4:
                        // Environment-specific deployment steps
                        _a.sent();
                        console.log("\uD83C\uDF89 Deployment to ".concat(environment, " completed successfully"));
                        return [3 /*break*/, 6];
                    case 5:
                        error_10 = _a.sent();
    ...
    switch (command) {
        ...
        case 'health-check':
            ProductionHealthCheck.runHealthChecks()
                .then(function (passed) { return process.exit(passed ? 0 : 1); });
            break;
        case 'deploy':
