...
exports.CachePerformanceMonitor = exports.CDNOptimization = exports.CacheInvalidation = exports.CacheHeaders = exports.cacheManager = exports.CacheManager = exports.CacheKeyGenerator = exports.CACHE_CONFIG = void 0;
...
var CacheManager = /** @class */ (function () {
    ...
    CacheManager.prototype.invalidateByTags = function (tags) {
        ...
        for (var _i = 0, _a = this.memoryCache.entries(); _i < _a.length; _i++) {
            ...
            if (cached.tags.some(function (tag) { return tags.includes(tag); })) {
                this.memoryCache.delete(key);
                invalidated++;
            }
        }
...
var CacheHeaders = /** @class */ (function () {
    ...
    CacheHeaders.staticAsset = function () {
        ...
        headers.set('Cache-Control', "public, max-age=".concat(exports.CACHE_CONFIG.STATIC_ASSETS.maxAge, ", immutable"));
        headers.set('ETag', "\"".concat(Date.now(), "\""));
        return headers;
    };
    CacheHeaders.apiResponse = function (config) {
        if (config === void 0) { config = exports.CACHE_CONFIG.API_RESPONSES; }
        var headers = new Headers();
        headers.set('Cache-Control', "public, max-age=".concat(config.maxAge, ", stale-while-revalidate=").concat(config.swr));
        headers.set('ETag', "\"".concat(Date.now(), "\""));
    ...
    CacheHeaders.dynamicContent = function () {
        var headers = new Headers();
        headers.set('Cache-Control', "public, max-age=".concat(exports.CACHE_CONFIG.DYNAMIC_CONTENT.maxAge, ", stale-while-revalidate=").concat(exports.CACHE_CONFIG.DYNAMIC_CONTENT.swr));
        headers.set('ETag', "\"".concat(Date.now(), "\""));
        return headers;
    };
    ...
    CacheHeaders.conditionalCache = function (request) {
        ...
        var isAuthenticated = request.headers.get('authorization') ||
    ...
    CacheInvalidation.invalidateUser = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                tags = ["user:".concat(userId), "analytics:".concat(userId), "subscription:".concat(userId)];
                invalidated = exports.cacheManager.invalidateByTags(tags);
                console.log("\uD83D\uDDD1\uFE0F Invalidated ".concat(invalidated, " cache entries for user ").concat(userId));
                return [2 /*return*/];
            });
        });
    };
...
var CDNOptimization = /** @class */ (function () {
    ...
    CDNOptimization.imageUrl = function (src, options) {
        ...
        var width = options.width, height = options.height, _a = options.quality, quality = _a === void 0 ? 75 : _a, _b = options.format, format = _b === void 0 ? 'auto' : _b;
    ...
    CDNOptimization.generatePreloadLinks = function (resources) {
        return resources.map(function (resource) {
            var link = "<link rel=\"preload\" href=\"".concat(resource.href, "\" as=\"").concat(resource.as, "\"");
            if (resource.type)
                link += " type=\"".concat(resource.type, "\"");
...
function withCache(handler, config) {
    ...
    return function (req) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = config.ttl, ttl = _a === void 0 ? 300000 : _a, _b = config.tags, tags = _b === void 0 ? [] : _b, keyGenerator = config.keyGenerator, skipCache = config.skipCache;
                    ...
                    if (cached) {
                        ...
                        return [2 /*return*/, new server_1.NextResponse(JSON.stringify(cached), {
                                status: 200,
