...
(0, globals_1.describe)('TASK-001 Foundation Setup Verification', function () {
    var rootDir = path_1.default.join(__dirname, '../../');
    (0, globals_1.describe)('Monitoring Utilities', function () {
        (0, globals_1.it)('should have all required monitoring utility files', function () {
        ...
        (0, globals_1.it)('should have monitoring components', function () {
        ...
        (0, globals_1.it)('should have monitoring API endpoints', function () {
    ...
    (0, globals_1.describe)('Code Quality', function () {
        (0, globals_1.it)('should have TypeScript configuration', function () {
        ...
        (0, globals_1.it)('should have ESLint configuration', function () {
        ...
        (0, globals_1.it)('should have package.json with required scripts', function () {
    ...
    (0, globals_1.describe)('Testing Infrastructure', function () {
        (0, globals_1.it)('should have Jest configuration', function () {
        ...
        (0, globals_1.it)('should have test setup files', function () {
    ...
    (0, globals_1.describe)('Performance Monitoring', function () {
        (0, globals_1.it)('should have Sentry configuration files', function () {
        ...
        (0, globals_1.it)('should have performance monitoring utilities', function () {
