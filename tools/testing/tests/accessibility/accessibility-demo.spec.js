...
test_1.test.describe('Accessibility Demo', function () {
    test_1.test.beforeEach(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, page.goto('/dashboard/accessibility-demo')];
                case 1:
                    _c.sent();
                    return [2 /*return*/];
            }
    ...
    (0, test_1.test)('should have accessible form elements', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, test_1.expect)(mainHeading).toBeVisible()
                ...
                case 7:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(phoneInput).toHaveAttribute('type', 'tel')
    ...
    (0, test_1.test)('should navigate with keyboard', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    _c.sent();
                    nameInput = page.getByRole('textbox', { name: /nome completo/i });
                    return [4 /*yield*/, (0, test_1.expect)(nameInput).toBeFocused()
    ...
    (0, test_1.test)('should show validation errors accessibly', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, test_1.expect)(phoneError).toBeVisible()
                        // Check that inputs have aria-invalid
                    ];
                case 4:
                    _c.sent();
                    nameInput = page.getByRole('textbox', { name: /nome completo/i });
                    return [4 /*yield*/, (0, test_1.expect)(nameInput).toHaveAttribute('aria-invalid', 'true')];
                case 5:
                    _c.sent();
                    return [2 /*return*/];
            }
    ...
    (0, test_1.test)('should handle loading states accessibly', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    _c.sent();
                    return [4 /*yield*/, page.fill('input[type="tel"]', '(11) 99999-9999')
                        // Submit form
                    ];
                case 3:
                    _c.sent();
                ...
                case 5:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(loadingButton).toBeDisabled()
    ...
    (0, test_1.test)('should open and close dialog accessibly', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, helpButton.click()
                ...
                case 2:
                    _c.sent();
                    // Check dialog has proper ARIA attributes
                    return [4 /*yield*/, (0, test_1.expect)(dialog).toHaveAttribute('aria-modal', 'true')
                ...
                case 4:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(dialog).not.toBeVisible()
    ...
    (0, test_1.test)('should work with screen reader announcements', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 6:
                    // Wait for success message and check announcements
                    _c.sent();
                    return [4 /*yield*/, page.evaluate(function () { return window.ariaAnnouncements; })];
                case 7:
                    announcements = _c.sent();
                    (0, test_1.expect)(announcements.some(function (text) { return text.includes('sucesso'); })).toBeTruthy();
                    return [2 /*return*/];
            }
        });
    }); });
...
test_1.test.describe('Accessibility Audit', function () {
    (0, test_1.test)('should pass automated accessibility checks', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var results;
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
    ...
    (0, test_1.test)('should meet WCAG contrast requirements', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    (0, test_1.test)('should support reduced motion preferences', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
