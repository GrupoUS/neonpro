...
describe("lGPD Compliance Tests", () => {
  ...
  describe("data Minimization", () => {
    it("should only collect necessary data for medical treatment", () => {
      ...
      expect(minimumValidation.isMinimal).toBeTruthy();
      expect(excessiveValidation.isMinimal).toBeFalsy();
  ...
  describe("data Breach Notification", () => {
    it("should have breach notification procedures", async () => {
      ...
      expect(requiresAuthorityNotification(breachEvent)).toBeTruthy();
      expect(requiresSubjectNotification(breachEvent)).toBeTruthy();
    });
  });
});
