...
async function main() {
  ...
  switch (command) {
    ...
    default:
      console.log('Usage:');
      console.log('  node run-tests.js vitest [simple|full]     - Run Vitest tests');
      console.log('  node run-tests.js playwright [simple|full] - Run Playwright tests');
      console.log('  node run-tests.js all [simple|full]        - Run all tests');
