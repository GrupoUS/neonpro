...
vi.mock<typeof import('next/dist/server/app-render/work-unit-async-storage.external')>('next/dist/server/app-render/work-unit-async-storage.external', () => ({
  workUnitAsyncStorage: mockAsyncLocalStorage,
}));

vi.mock<typeof import('next/dist/server/web/spec-extension/adapters/request-cookies')>('next/dist/server/web/spec-extension/adapters/request-cookies', () => ({
