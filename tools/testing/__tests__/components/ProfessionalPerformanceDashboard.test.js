    ...
    it("should render dashboard header", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          ...
          expect(
            react_1.screen.getByText("Métricas de performance e desenvolvimento profissional"),
          ).toBeInTheDocument();
          return [2 /*return*/];
        });
      });
            ...
            case 0:
              ...
              return [
                ...
                (0, react_1.waitFor)(function () {
                  ...
                  expect(react_1.screen.getByText("Receita Gerada")).toBeInTheDocument();
                  expect(
                    react_1.screen.getByText("Horas de Desenvolvimento Profissional"),
                  ).toBeInTheDocument();
                }),
              ];
            case 1:
            ...
            case 0:
              ...
              return [
                ...
                (0, react_1.waitFor)(function () {
                  ...
                  expect(
                    react_1.screen.getByText("Alta taxa de conclusão de consultas"),
                  ).toBeInTheDocument();
                }),
              ];
            case 1:
          ...
          switch (_a.label) {
            case 0:
              lowPerformanceMetrics = [
                __assign(__assign({}, mockPerformanceMetrics[0]), {
            ...
            case 0:
              ...
              return [
                ...
                (0, react_1.waitFor)(function () {
                  ...
                  expect(
                    react_1.screen.getByRole("button", { name: "Tentar Novamente" }),
                  ).toBeInTheDocument();
                }),
              ];
            case 1:
