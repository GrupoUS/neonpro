...
// Mock hooks
vi.mock<typeof import('@/hooks/analytics/useAnalyticsData')>('@/hooks/analytics/useAnalyticsData', () => ({
  useAnalyticsData: vi.fn(),
}));

vi.mock<typeof import('@/hooks/analytics/useExportData')>('@/hooks/analytics/useExportData', () => ({
  useExportData: vi.fn(),
}));
