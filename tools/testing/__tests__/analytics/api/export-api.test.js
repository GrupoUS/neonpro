...
globals_1.jest.mock('jspdf', function () { return ({
    __esModule: true,
    default: globals_1.jest.fn().mockImplementation(function () { return ({
...
(0, globals_1.describe)('Export API Routes', function () {
    ...
    (0, globals_1.describe)('GET /api/export', function () {
        (0, globals_1.test)('should export subscription data as CSV', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/export?type=subscriptions&format=csv', { method: 'GET' });
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(response.headers.get('content-disposition')).toContain('attachment');
                        (0, globals_1.expect)(mockSupabase.from).toHaveBeenCalledWith('subscriptions');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should export analytics data as PDF', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/export?type=analytics&format=pdf', { method: 'GET' });
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        // Assert
        ...
        (0, globals_1.test)('should export trial data as Excel', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabase.from.mockReturnValue(mockFrom);
                        request = new server_1.NextRequest('http://localhost:3000/api/export?type=trials&format=xlsx', { method: 'GET' });
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        // Assert
                        (0, globals_1.expect)(response.status).toBe(200);
                        (0, globals_1.expect)(response.headers.get('content-type')).toBe('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
                        (0, globals_1.expect)(response.headers.get('content-disposition')).toContain('attachment');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should return 401 for unauthenticated requests', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should return 403 for non-admin users', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should validate query parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockUser, request, response, responseData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        request = new server_1.NextRequest('http://localhost:3000/api/export?type=invalid&format=unknown', { method: 'GET' });
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
                    case 2:
                        ...
                        (0, globals_1.expect)(responseData.success).toBe(false);
                        (0, globals_1.expect)(responseData.message).toContain('Invalid export type or format');
                        return [2 /*return*/];
                }
            });
        }); });
        (0, globals_1.test)('should handle date range filters', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabase.from.mockReturnValue(mockFrom);
                        request = new server_1.NextRequest('http://localhost:3000/api/export?type=subscriptions&format=csv&start_date=2024-01-01&end_date=2024-01-31', { method: 'GET' });
                        return [4 /*yield*/, (0, route_1.GET)(request)];
                    case 1:
                        response = _a.sent();
                        // Assert
    ...
    (0, globals_1.describe)('POST /api/export', function () {
        (0, globals_1.test)('should schedule bulk export job', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.test)('should validate bulk export request', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, globals_1.describe)('performance and limits', function () {
        (0, globals_1.test)('should respect export size limits', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        largeDataset = Array(100000).fill(null).map(function (_, i) { return ({
                            id: "sub_".concat(i),
        ...
        (0, globals_1.test)('should handle concurrent export requests', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockSupabase.from.mockReturnValue(mockFrom);
                        requests = Array(5).fill(null).map(function () {
                            return new server_1.NextRequest('http://localhost:3000/api/export?type=subscriptions&format=csv', { method: 'GET' });
                        });
                        return [4 /*yield*/, Promise.all(requests.map(function (request) { return (0, route_1.GET)(request); }))];
                    case 1:
                        responses = _a.sent();
                        // Assert
        ...
        (0, globals_1.test)('should compress large exports', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        moderateDataset = Array(5000).fill(null).map(function (_, i) { return ({
                            id: "sub_".concat(i),
                            user_id: "user_".concat(i),
                            status: 'active'
                        }); });
