...
globals_1.jest.mock("date-fns", function () {
  return {
    ...
    subDays: globals_1.jest.fn(function (date, days) {
    ...
    startOfMonth: globals_1.jest.fn(function (date) {
      return new Date(date.getFullYear(), date.getMonth(), 1);
    }),
    endOfMonth: globals_1.jest.fn(function (date) {
      return new Date(date.getFullYear(), date.getMonth() + 1, 0);
    }),
    isValid: globals_1.jest.fn(function () {
      return true;
    }),
    parseISO: globals_1.jest.fn(function (dateStr) {
      return new Date(dateStr);
    }),
    differenceInDays: globals_1.jest.fn(function () {
      return 30;
    }),
    differenceInMonths: globals_1.jest.fn(function () {
      return 12;
    }),
  };
});
// Mock lodash groupBy
globals_1.jest.mock("lodash", function () {
  return {
...
globals_1.jest.mock("jspdf", function () {
  return {
    __esModule: true,
    default: globals_1.jest.fn(function () {
...
(0, globals_1.describe)("Analytics Utils", function () {
  ...
  (0, globals_1.describe)("generateDateRange", function () {
    ...
    (0, globals_1.test)("should handle reverse date order", function () {
      ...
      (0, globals_1.expect)(function () {
        return (0, utils_1.generateDateRange)(start, end);
  ...
  (0, globals_1.describe)("parseAnalyticsFilters", function () {
    ...
    (0, globals_1.test)("should validate filter parameters", function () {
      ...
      (0, globals_1.expect)(function () {
        return (0, utils_1.parseAnalyticsFilters)(params);
