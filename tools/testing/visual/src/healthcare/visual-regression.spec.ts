...
test.describe("Healthcare Dashboard Visuals", () => {
	...
	test("Medical Appointment Calendar", async ({ page }) => {
		...
		await expect(page.locator('[data-testid="day-view-container"]')).toHaveScreenshot("appointment-day-view.png");

		// Week view
		await page.click('[data-testid="calendar-week-view"]');
		await page.waitForSelector('[data-testid="week-view-container"]');

		await expect(page.locator('[data-testid="week-view-container"]')).toHaveScreenshot("appointment-week-view.png");
	});
	...
	test("Medical Records Interface", async ({ page }) => {
		...
		// Records list view
		await expect(page.locator('[data-testid="medical-records-list"]')).toHaveScreenshot("medical-records-list.png");
		...
		await expect(page.locator('[data-testid="record-detail-view"]')).toHaveScreenshot("medical-record-detail.png");

		// Prescription view
		await page.click('[data-testid="view-prescription"]');
		await page.waitForSelector('[data-testid="prescription-viewer"]');

		await expect(page.locator('[data-testid="prescription-viewer"]')).toHaveScreenshot("prescription-detail.png");
	});
	...
	test("Professional Dashboard", async ({ page }) => {
		...
		// Sidebar navigation
		await expect(page.locator('[data-testid="professional-sidebar"]')).toHaveScreenshot("professional-sidebar.png");

		// Patient queue
		await expect(page.locator('[data-testid="patient-queue"]')).toHaveScreenshot("patient-queue.png");
	});
});
...
test.describe("Healthcare Forms and Components", () => {
	test("LGPD Consent Forms", async ({ page }) => {
		...
		await expect(page.locator('[data-testid="lgpd-consent-form"]')).toHaveScreenshot("lgpd-consent-initial.png");
		...
		await expect(page.locator('[data-testid="lgpd-consent-form"]')).toHaveScreenshot("lgpd-consent-details.png");

		// Consent granted state
		await page.check('[data-testid="consent-data-processing"]');
		await page.check('[data-testid="consent-marketing"]');

		await expect(page.locator('[data-testid="lgpd-consent-form"]')).toHaveScreenshot("lgpd-consent-granted.png");
	});
	...
	test("Medical Procedure Forms", async ({ page }) => {
		...
		await expect(page.locator('[data-testid="procedure-form"]')).toHaveScreenshot("procedure-form-empty.png");
		...
		await expect(page.locator('[data-testid="procedure-form"]')).toHaveScreenshot("procedure-form-filled.png");

		// Risk assessment section
		await page.click('[data-testid="show-risk-assessment"]');
		await page.waitForSelector('[data-testid="risk-assessment-section"]');

		await expect(page.locator('[data-testid="procedure-form"]')).toHaveScreenshot("procedure-form-with-risks.png");
	});
	...
	test("Medication Management", async ({ page }) => {
		...
		await expect(page.locator('[data-testid="current-medications"]')).toHaveScreenshot("current-medications.png");

		// Add new medication form
		await page.click('[data-testid="add-medication-btn"]');
		await page.waitForSelector('[data-testid="add-medication-form"]');

		await expect(page.locator('[data-testid="add-medication-form"]')).toHaveScreenshot("add-medication-form.png");
...
test.describe("Accessibility Visual Validation", () => {
	...
	test("Focus States", async ({ page }) => {
		...
		await expect(page.locator('[data-testid="patient-name"]')).toHaveScreenshot("input-focus-state.png");

		await page.focus('[data-testid="submit-registration"]');
		await expect(page.locator('[data-testid="submit-registration"]')).toHaveScreenshot("button-focus-state.png");
	});
});
