...
export class AgentRegistry {
  ...
  private hasSecurityTriggers(feature: FeatureContext): boolean {
    ...
    return (
      securityAgent.triggers.some((trigger) => featureText.includes(trigger.toLowerCase()))
  ...
  private hasArchitectureTriggers(feature: FeatureContext): boolean {
    ...
    return architectAgent.triggers.some((trigger) => featureText.includes(trigger.toLowerCase()))
  }
  ...
  private hasQualityTriggers(feature: FeatureContext): boolean {
    ...
    return codeReviewerAgent.triggers.some((trigger) => featureText.includes(trigger.toLowerCase()))
  }
  ...
  private hasTestTriggers(feature: FeatureContext): boolean {
    ...
    return testAgent.triggers.some((trigger) => featureText.includes(trigger.toLowerCase()))
  }
  ...
  private hasComplianceTriggers(feature: FeatureContext): boolean {
    ...
    return (
      complianceAgent.triggers.some((trigger) => featureText.includes(trigger.toLowerCase()))
      || (feature.complianceRequirements
