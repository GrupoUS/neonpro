...
describe('AgentRegistry', () => {
  const createBaseFeature = (overrides: Partial<FeatureContext> = {}): FeatureContext => ({
    name: 'Test Feature',
  ...
  it('treats high numeric complexity as high-level and activates full agent set', () => {
    ...
    expect(agents).toEqual(expect.arrayContaining(['test', 'code-reviewer', 'architect-review', 'security-auditor']));
  });
