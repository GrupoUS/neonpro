...
export class ArchitectReviewAgent extends BaseAgent {
  ...
  private async executeRedPhase(
    ...
    if (context.domain.includes('microservices') || context.domain.includes('api')) {
      findings.push(
        this.createFinding(
          'architecture-design',
    ...
    if (context.domain.includes('database') || context.domain.includes('persistence')) {
      recommendations.push(
        this.createRecommendation(
          'architecture',
  ...
  private async executeRefactorPhase(
    ...
    if (context.domain.includes('database') || context.domain.includes('data')) {
      recommendations.push(
        this.createRecommendation(
          'architecture',
