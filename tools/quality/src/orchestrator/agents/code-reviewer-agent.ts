...
export class CodeReviewerAgent extends BaseAgent {
    ...
    try {
      ...
      return {
        ...
        metrics: {
          ...
          codeQualityIssues: findings.filter(f => f.type === 'code-quality').length,
          refactoringOpportunities: findings.filter(f => f.type === 'refactoring-quality').length,
  ...
  getConfiguration(): Record<string, any> {
    return {
      ...
      qualityMetrics: ['complexity', 'maintainability', 'duplication', 'coverage'],
      qualityThresholds: {
