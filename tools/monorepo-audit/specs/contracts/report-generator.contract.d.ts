...
export type ReportFormat = 'html' | 'markdown' | 'json' | 'pdf' | 'csv' | 'xml' | 'yaml';
export type ReportSection = 'executive_summary' | 'file_analysis' | 'dependency_graph' | 'architecture_compliance' | 'cleanup_operations' | 'performance_metrics' | 'recommendations' | 'technical_details' | 'appendices';
...
export type AuditPhase = 'initialization' | 'file_scanning' | 'dependency_analysis' | 'architecture_validation' | 'usage_analysis' | 'cleanup_planning' | 'cleanup_execution' | 'report_generation';
...
export interface IReportGenerator {
     ...
     */
    generateTechnicalReport(auditData: AuditData, options: TechnicalReportOptions): Promise<TechnicalReport>;
    /**
...
export declare const DEFAULT_REPORT_OPTIONS: ReportOptions;
export declare const REPORT_PERFORMANCE_REQUIREMENTS: {
    /** Maximum report generation time (ms) */
    readonly MAX_GENERATION_TIME: 30000;
    /** Maximum memory usage during generation (bytes) */
    readonly MAX_MEMORY_USAGE: 200000000;
    /** Maximum report size (bytes) */
    readonly MAX_REPORT_SIZE: 50000000;
};
//# sourceMappingURL=report-generator.contract.d.ts.map