...
export type ViolationCategory = 'file_structure' | 'naming_convention' | 'import_structure' | 'routing_pattern' | 'dependency_rule' | 'coding_standard' | 'architecture_layer' | 'performance' | 'security' | 'documentation';
...
export interface IArchitectureValidator {
     ...
     */
    applyAutoFixes(violations: ArchitectureViolation[], options: AutoFixOptions): Promise<FixResult[]>;
}
...
export declare const VALIDATION_PERFORMANCE_REQUIREMENTS: {
    /** Maximum validation time for 10k files (ms) */
    readonly MAX_VALIDATION_TIME_10K_FILES: 60000;
    /** Maximum memory usage during validation (bytes) */
    readonly MAX_MEMORY_USAGE: 400000000;
    /** Maximum document parsing time (ms) */
    readonly MAX_DOCUMENT_PARSING_TIME: 5000;
};
//# sourceMappingURL=architecture-validator.contract.d.ts.map