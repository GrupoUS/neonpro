...
describe('Usage Analysis Integration Tests', () => {
  const testTimeout = 30_000; // 30 second timeout for usage analysis
  ...
  describe('Basic Find-Unused Command', () => {
    it(
      'should identify unused and orphaned files',
      async () => {
    ...
    it(
      'should categorize files by usage type',
      async () => {
  ...
  describe('Unused Files Detection', () => {
    it(
      'should detect actually unused files',
      async () => {
    ...
    it(
      'should not falsely flag important files',
      async () => {
    ...
    it(
      'should provide confidence scores for unused file detection',
      async () => {
