...
describe('File Discovery Integration Tests', () => {
  const testTimeout = 30_000 // 30 second timeout for file operations
  ...
  describe('Basic Scan Command', () => {
    it(
      'should scan monorepo structure with dry-run',
      async () => {
    ...
    it(
      'should scan specific directories',
      async () => {
        // This will FAIL until CLI scan command is implemented
        try {
          const { stdout, } = await execAsync(
  ...
  describe('File Type Classification', () => {
    it(
      'should correctly identify TypeScript/JavaScript files',
      async () => {
    ...
    it(
      'should exclude hidden and node_modules directories',
      async () => {
    ...
    it(
      'should identify package boundaries correctly',
      async () => {
  ...
  describe('Performance Requirements', () => {
    ...
    it(
      'should report scan performance metrics',
      async () => {
  ...
  describe('Output Formats', () => {
    ...
    it(
      'should support verbose output mode',
      async () => {
    ...
    it(
      ...
      async () => {
        ...
        try {
          ...
          if (
            stdout.includes('permission-denied-expected',)
