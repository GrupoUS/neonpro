...
import { ConfigManager, HealthcareConfigSchemas, createConfigManager } from '../../apps/api/src/utils/config-manager'
import { SecureLogger } from '../../apps/api/src/utils/secure-logger'
import { HealthcareError, HealthcareErrorSeverity, HealthcareErrorCategory } from '../../apps/api/src/utils/healthcare-errors'
...
describe('ConfigManager - Enhanced Features', () => {
  ...
  describe('Advanced Configuration Validation', () => {
    it('should validate allowed values', () => {
      ...
      expect(() => configManager.set('environment', 'invalid' as any)).toThrow('INVALID_CONFIG_VALUE')
    })
