...
const assessment = await thirdPartyCompliance.performComplianceAssessment(
  providerId
)
...
const consentSchema = Joi.object({
  ...
  collection_method: Joi.string().valid(
    'web_form', 'email', 'phone', 'in_person', 'api'
  ).required(),
  legal_basis: Joi.string().valid(
