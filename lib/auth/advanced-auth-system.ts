...
import { UserSession, SessionConfig, SessionMetrics } from '@/types/session';
import { SessionConfig as Config } from './config/session-config';
import { SessionUtils } from './utils/session-utils';
import { IntelligentTimeoutManager } from './timeout/intelligent-timeout';
import { ConcurrentSessionManager } from './concurrent/concurrent-session-manager';
import { SuspiciousActivityDetector } from './suspicious/suspicious-activity-detector';
import { SecurityMonitor } from './monitoring/security-monitor';
import { SessionSyncManager } from './sync/session-sync';
import { SessionPreservationManager } from './preservation/session-preservation';
import { EmergencyShutdownManager } from './emergency/emergency-shutdown';
import { AuditTrailManager } from './audit/audit-trail';
import { DataCleanupManager } from './cleanup/data-cleanup';
