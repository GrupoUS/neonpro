...
const Breadcrumb = React.forwardRef<
	...
	React.ComponentPropsWithoutRef<"nav"> & {
		separator?: React.ComponentType<React.ComponentPropsWithoutRef<"svg">>;
	}
...
const BreadcrumbPage = React.forwardRef<HTMLSpanElement, React.ComponentPropsWithoutRef<"span">>(
	({ className, ...props }, ref) => (
		<span aria-current="page" className={cn("font-normal text-foreground", className)} ref={ref} {...props} />
	)
);
