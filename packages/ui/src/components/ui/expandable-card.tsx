...
export function ExpandableCardProvider({ children, className }: ExpandableCardProviderProps) {
  const [expandedCard, setExpandedCard] = useState<string | null>(null);

  return (
    <ExpandableCardContext.Provider value={{ id: null, expandedCard, setExpandedCard }}>
...
export function ExpandableCard({ id, children, className, expandedContent }: ExpandableCardProps) {
