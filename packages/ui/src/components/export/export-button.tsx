                ...
                <div className='space-y-4'>
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: 'csv' | 'xlsx') => setSelectedFormat(value)}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <Alert>
                    <AlertDescription className='text-xs'>
                      A exportação será processada em segundo plano. Você será notificado quando
                      estiver pronta. Os dados sensíveis serão anonimizados conforme a LGPD.
                    </AlertDescription>
                  </Alert>
