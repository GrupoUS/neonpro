			...
			<Card>
				...
				<CardContent>
					...
					<div className="mt-2 flex items-center space-x-2">
						<Badge className="text-xs" variant={metrics.threat_level === "low" ? "default" : "destructive"}>
			...
			<Card>
				...
				<CardContent>
					...
					<div className="mt-2 flex items-center justify-between">
						...
						<Badge className="text-xs" variant={metrics.high_risk_sessions > 0 ? "destructive" : "secondary"}>
			...
			<Card>
				...
				<CardContent>
					...
					<div className="mt-2 flex items-center justify-between">
						...
						<Badge className="text-xs" variant={metrics.failed_attempts_24h > 10 ? "destructive" : "secondary"}>
			...
			<Card className="md:col-span-2 lg:col-span-2">
				...
				<CardContent>
					<div className="grid grid-cols-3 gap-4 text-center">
						<div>
							<div className="font-semibold text-green-600 text-lg">{metrics.compliance_score >= 95 ? "✓" : "⚠"}</div>
