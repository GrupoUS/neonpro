...
export function AceternityHoverBorderDemo() {
  return (
    <div className="flex flex-col gap-8 p-8 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold text-center">Aceternity Hover Border Gradient + NeonPro Shine Border</h1>
      
      {/* Pure Aceternity Hover Border Gradient */}
      <div className="space-y-4">
        <h2 className="text-xl font-semibold">Pure Aceternity Hover Border Gradient</h2>
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold">Enhanced Shine Border (Shine + Hover Gradient)</h2>
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold">NeonPro Clínica Estética - Showcase</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="text-center p-4">
              <h3 className="text-lg font-bold text-amber-800">Harmonização Facial</h3>
              <p className="text-sm text-amber-700">Resultado natural e elegante</p>
              <div className="mt-2 text-2xl font-bold text-amber-900">R$ 899</div>
          ...
          >
            <div className="text-center p-4">
              <h3 className="text-lg font-bold text-purple-800">Lifting Facial</h3>
              <p className="text-sm text-purple-700">Tecnologia avançada</p>
              <div className="mt-2 text-2xl font-bold text-purple-900">R$ 1.299</div>
          ...
          >
            <div className="text-center p-4">
              <h3 className="text-lg font-bold text-green-800">Protocolo Completo</h3>
              <p className="text-sm text-green-700">Rejuvenescimento total</p>
              <div className="mt-2 text-2xl font-bold text-green-900">R$ 2.499</div>
      ...
      {/* Interactive Demo */}
      <div className="space-y-4">
        <h2 className="text-xl font-semibold">Interactive Demo - Hover Effects</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 bg-white rounded-lg shadow-lg">
            <h3 className="text-lg font-semibold mb-4">Aceternity Hover Border</h3>
