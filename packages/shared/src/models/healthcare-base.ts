...
export const DEFAULT_HEALTHCARE_CLASSIFICATIONS: Record<
...
> = {
  [HealthcareDataClassification.PUBLIC]: {
    ...
    allowedPurposes: [
      HealthcareProcessingPurpose.PUBLIC_HEALTH,
      HealthcareProcessingPurpose.RESEARCH,
    ],
    accessLevels: [
      HealthcareAccessLevel.PATIENT,
      HealthcareAccessLevel.HEALTHCARE_PROFESSIONAL,
      HealthcareAccessLevel.ADMINISTRATIVE,
    ],
  },
  ...
  [HealthcareDataClassification.INTERNAL]: {
    ...
    allowedPurposes: [
      HealthcareProcessingPurpose.ADMINISTRATION,
      HealthcareProcessingPurpose.QUALITY_ASSURANCE,
    ],
    accessLevels: [
      HealthcareAccessLevel.HEALTHCARE_PROFESSIONAL,
      HealthcareAccessLevel.ADMINISTRATIVE,
  ...
  [HealthcareDataClassification.PATIENT_IDENTIFYING]: {
    ...
    requiredStandards: [
      ...
      ComplianceStandard.ANVISA,
      ComplianceStandard.CFM,
    ],
    allowedPurposes: [
      HealthcareProcessingPurpose.PATIENT_CARE,
      HealthcareProcessingPurpose.BILLING,
      HealthcareProcessingPurpose.LEGAL_COMPLIANCE,
    ],
    accessLevels: [
      HealthcareAccessLevel.PATIENT,
      HealthcareAccessLevel.HEALTHCARE_PROFESSIONAL,
      HealthcareAccessLevel.EMERGENCY,
    ],
  },
  ...
  [HealthcareDataClassification.PATIENT_SENSITIVE]: {
    ...
    allowedPurposes: [
      HealthcareProcessingPurpose.PATIENT_CARE,
      HealthcareProcessingPurpose.EMERGENCY_CARE,
    ],
    accessLevels: [
      HealthcareAccessLevel.PATIENT,
      HealthcareAccessLevel.HEALTHCARE_PROFESSIONAL,
...
export class HealthcareDataClassificationUtils {
   ...
   */
  static getMostRestrictiveClassification(
    classifications: HealthcareDataClassification[],
  ): HealthcareDataClassification {
    const hierarchy = {
    ...
    return classifications.reduce(_(mostRestrictive,_current) => {
  ...
  static validateComplianceRequirements(
    ...
    const missingStandards = mapping.requiredStandards.filter(_(std) => !requiredStandards.includes(std),
    );
