...
export const corenValidator = z
  .string()
  .regex(HEALTHCARE_CONSTANTS.BRAZIL.COREN_PATTERN, 'COREN deve estar no formato NNNNNN/UF')
...
export const passwordValidator = z
  .string()
  .min(
    HEALTHCARE_CONSTANTS.LIMITS.PASSWORD_MIN_LENGTH,
...
export const pastDateValidator = z.coerce
  .date()
  .refine(date => date < new Date(), 'Data deve ser no passado')

export const birthDateValidator = z.coerce
  .date()
...
export const paginationQuerySchema = z.object({
  ...
  limit: z.coerce
    ...
    .max(
      HEALTHCARE_CONSTANTS.API.MAX_PAGE_SIZE,
      `Limite máximo é ${HEALTHCARE_CONSTANTS.API.MAX_PAGE_SIZE}`
    )
    .default(HEALTHCARE_CONSTANTS.API.DEFAULT_PAGE_SIZE),
})
