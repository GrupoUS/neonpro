...
export function validatePasswordStrength(password: string): {
  ...
  if (password.length < HEALTHCARE_CONSTANTS.LIMITS.PASSWORD_MIN_LENGTH) {
    errors.push(`Senha deve ter pelo menos ${HEALTHCARE_CONSTANTS.LIMITS.PASSWORD_MIN_LENGTH} caracteres`);
  }
 ...
 */
export function formatDate(date: Date | string, formatStr = HEALTHCARE_CONSTANTS.DATE_FORMATS.BR_DATE): string {
  try {
