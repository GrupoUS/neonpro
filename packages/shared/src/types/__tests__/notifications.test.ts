...
describe('Real-time Notification Model (T036)', () => {
  ...
  it('should support notification types', () => {
    ...
    expect(NotificationType.APPOINTMENT_CONFIRMATION).toBe('appointment_confirmation');
  ...
  it('should support multi-channel delivery', () => {
    ...
    const notifications = createMultiChannelNotification(baseNotification, channels);
