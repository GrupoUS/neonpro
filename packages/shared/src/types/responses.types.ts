...
import type { ApiResponse, ApiMeta, PaginationMeta } from './api.types';
import type { 
  Patient, 
  Appointment, 
  Clinic, 
...
export interface PatientStatsResponse extends ApiResponse<{
...
export interface PatientExportResponse extends ApiResponse<{
  downloadUrl: string;
  format: 'csv' | 'xlsx' | 'pdf';
  totalRecords: number;
  expiresAt: string;
...
export interface AppointmentRescheduleResponse extends ApiResponse<{
  appointment: Appointment;
  message: string;
}> {}

export interface AppointmentCancelResponse extends ApiResponse<{
  appointment: Appointment;
  refundAmount?: number;
  message: string;
}> {}

export interface AppointmentStatsResponse extends ApiResponse<{
...
export interface ClinicServicesResponse extends ListResponse<{
  id: string;
  name: string;
  category: string;
  duration: number;
...
export interface ClinicAvailabilityResponse extends ApiResponse<{
  date: string;
  professionals: Array<{
...
export interface ClinicStatsResponse extends ApiResponse<{
  totalRevenue: number;
...
export interface ProfessionalScheduleResponse extends ApiResponse<{
...
export interface ProfessionalStatsResponse extends ApiResponse<{
  totalPatients: number;
  totalAppointments: number;
...
export interface NotificationMarkReadResponse extends ApiResponse<{
...
export interface TreatmentStatsResponse extends ApiResponse<{
