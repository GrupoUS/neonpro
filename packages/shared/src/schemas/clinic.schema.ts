...
export const ClinicBaseSchema = z.object({
  ...
  acceptedPaymentMethods: z.array(z.enum([
    'cash', 'credit_card', 'debit_card', 'pix', 'bank_transfer', 'installments'
  ])).default(['cash']),
...
export const UpdateClinicSchema = ClinicBaseSchema
  .partial()
  .extend({
...
export const ClinicSearchSchema = z.object({
  ...
  serviceCategory: z.enum([
    'injectables', 'laser', 'skincare', 'body_treatments', 
    'hair_removal', 'wellness', 'consultation', 'other'
  ]).optional(),
