...
describe('Structured Logging Service', () => {
  ...
  describe('Healthcare Context Integration', () => {
    it('should handle healthcare workflow context', () => {
      ...
      testLogger.info('Patient registration started', {}, { healthcare: healthcareContext });
    ...
    it('should log clinical workflow events', () => {
      ...
      expect(logEntry.healthcareContext?.workflowType).toBe('medical_consultation');
  ...
  describe('LGPD Compliance and PII Redaction', () => {
    ...
    it('should determine correct LGPD compliance metadata', () => {
      ...
      testLogger.info('Patient data processed', {}, {
        healthcare: {
          patientContext: {
  ...
  describe('Performance and Batching', () => {
    ...
    it('should manage buffer overflow correctly', () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith('Log buffer overflow, dropping oldest entries');
  ...
  describe('Error Handling', () => {
    ...
    it('should handle custom error objects', () => {
      ...
      testLogger.error('Custom error occurred', customError as any, { context: 'custom' });
    ...
    it('should continue logging even if individual log processing fails', () => {
      ...
      expect(errorSpy).toHaveBeenCalledWith('Failed to log message:', expect.any(Error));
  ...
  describe('Technical Context Integration', () => {
    it('should include technical context in log entries', () => {
      ...
      testLogger.info('API request processed', { endpoint: '/api/patients' }, {
  ...
  describe('Integration Scenarios', () => {
    it('should handle complete patient consultation workflow', () => {
      ...
      logs.forEach(log => {
        expect(log.healthcareContext?.patientContext?.anonymizedPatientId)
          .toBe('anon_patient_workflow_001');
    ...
    it('should handle emergency scenario with proper escalation', () => {
      ...
      testLogger.alert('Cardiac arrest detected', {
