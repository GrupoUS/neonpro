...
export const HEALTHCARE_REALTIME_CONFIG: HealthcareRealtimeConfig = {
  ...
  healthcare: {
    ...
    auditLogRetention: 10000, // Keep last 10000 audit entries
...
export const COMPLIANCE_EVENT_TYPES = {
  ...
  LGPD_DATA_PORTABILITY: { severity: 'MEDIUM', retention: 1825, reportable: true },
  
  // ANVISA Events
  ANVISA_AUDIT_START: { severity: 'MEDIUM', retention: 3650, reportable: true },
  ANVISA_COMPLIANCE_CHECK: { severity: 'LOW', retention: 3650, reportable: false },
  ANVISA_VIOLATION: { severity: 'CRITICAL', retention: 3650, reportable: true },
  
  // Security Events
  DATA_BREACH_DETECTED: { severity: 'CRITICAL', retention: 3650, reportable: true },
  UNAUTHORIZED_ACCESS: { severity: 'HIGH', retention: 3650, reportable: true },
  SUSPICIOUS_ACTIVITY: { severity: 'MEDIUM', retention: 1825, reportable: true }
} as const;