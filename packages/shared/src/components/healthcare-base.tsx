...
export function PatientRiskCard({
  ...
  return (
    <div
      className={`p-4 rounded-lg border transition-all ${getRiskColor(riskScore.score)} ${className}`}
    >
      ...
      {patient.nextAppointment && (
        <p className="text-sm mb-2">Próximo: {patient.nextAppointment}</p>
      )}
      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-600 mb-3">
            Utilizamos seus dados para melhorar sua experiência com tratamentos
            estéticos. Seus dados são protegidos conforme a Lei Geral de
            Proteção de Dados.
          </p>
          ...
          {showDetails && (
            <div className="text-xs text-gray-500 mb-3 p-2 bg-gray-50 rounded">
              <p>
                • Dados coletados: informações de contato e histórico de
                tratamentos
              </p>
