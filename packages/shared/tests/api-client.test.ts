...
describe('aPI Client - Error Handling', () => {
  ...
  describe('apiHelpers.formatError', () => {
    ...
    it('should handle null and undefined errors', () => {
      expect(ApiHelpers.formatError()).toBe(
        'An unexpected error occurred',
      );
      expect(ApiHelpers.formatError()).toBe('An unexpected error occurred');
    });
  ...
  describe('apiHelpers.createQueryKey', () => {
    it('should create basic query key', () => {
      ...
      expect(result).toStrictEqual(['api', 'patients']);
    });
    ...
    it('should create query key with user ID', () => {
      ...
      expect(result).toStrictEqual(['api', 'patients', 'user', 'user123']);
    });
...
describe('aPI Client - Healthcare Compliance', () => {
  it('should handle LGPD compliant data processing', async () => {
    ...
    expect(processedResponse.success).toBeTruthy();
    expect(processedResponse.data).toStrictEqual(patientData);
  });
});
