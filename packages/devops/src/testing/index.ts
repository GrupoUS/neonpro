...
export function createHealthcareTestSuite(
  ...
  return {
    lgpd: finalConfig.enableLGPDTests ? createLGPDTest : undefined,
    anvisa: finalConfig.enableANVISATests ? createANVISATest : undefined,
    cfm: finalConfig.enableCFMTests ? createCFMTest : undefined,
    qualityGates: finalConfig.enablePerformanceTests
      ? createQualityGatesTest
      : undefined,
    e2e: finalConfig.enableE2ETests ? createHealthcareE2ETest : undefined,
