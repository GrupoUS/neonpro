...
export function setActiveChatSessions(value: number, labels: MetricLabels = {}): void {
  activeChatSessions?.set(labels, value);
}

export function setRateLimitUsage(value: number, labels: MetricLabels = {}): void {
  rateLimitUsage?.set(labels, value);
}

export function setAIProviderHealth(value: number, labels: MetricLabels = {}): void {
  aiProviderHealth?.set(labels, value);
}

export function setDatabaseConnections(value: number, labels: MetricLabels = {}): void {
  databaseConnections?.set(labels, value);
}

export function setSystemHealth(value: number, labels: MetricLabels = {}): void {
