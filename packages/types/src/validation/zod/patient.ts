 ...
 * Consolidated from packages/schemas
 */
import { z } from 'zod'
...
export type PatientHealthInsurance = z.infer<typeof PatientHealthInsuranceSchema>
...
export type DeletePatient = z.infer<typeof DeletePatientSchema>