...
export type ExternalChatInterface = {
...
export type InternalChatInterface = {
...
export type PortugueseHealthcareContext = {
	medical_terminology: "portuguese" | "brazilian" | "international";
	regulatory_compliance: Array<"LGPD" | "ANVISA" | "CFM" | "SUS">;
