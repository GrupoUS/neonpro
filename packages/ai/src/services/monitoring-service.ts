...
export interface MonitoringInput extends AIServiceInput {
  action: "record_metric" | "get_metrics" | "create_alert_rule" | "update_alert_rule" | 
          "delete_alert_rule" | "list_alert_rules" | "get_alerts" | "acknowledge_alert" | 
          "resolve_alert" | "get_service_health" | "bulk_record_metrics";
...
export class MonitoringService extends EnhancedAIService<MonitoringInput, MonitoringOutput> {
  ...
  private readonly ALERT_CHECK_INTERVAL_MS = 30000; // 30 seconds
  ...
  private evaluateAlertCondition(metric: MonitoringMetric, rule: AlertRule): boolean {
    ...
    switch (operator) {
      case ">": return value > threshold_value;
      case "<": return value < threshold_value;
      case ">=": return value >= threshold_value;
      case "<=": return value <= threshold_value;
      case "==": return value === threshold_value;
