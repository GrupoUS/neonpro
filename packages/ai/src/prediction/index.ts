...
export * from './medical-data-analyzer';
export * from './prediction-validator';
export * from './outcome-analytics';
...
export const TREATMENT_PREDICTION_CONFIG = {
  ...
  accuracyTargets: {
    ...
    confidenceThresholds: {
      ...
      low: 0.70, // Low confidence: ≥70% certainty
      requiresReview: 0.60 // Below 60% requires human review
    }
  },
  ...
  dataFactors: {
    patientDemographics: {
      ...
      lifestyle: { weight: 0.10, importance: 'medium' }
    },
    medicalHistory: {
      previousConditions: { weight: 0.20, importance: 'critical' },
