...
exports.PatientDataSchema = exports.TenantFilterInputSchema = exports.UpdateConsentInputSchema = exports.HealthcareAuditLogSchema = exports.HealthcareUserSchema = exports.LGPDComplianceSchema = exports.MedicalLicenseSchema = exports.MedicalSpecializationSchema = exports.HealthcareRoleSchema = void 0;
...
exports.MedicalLicenseSchema = zod_1.z.string()
...
exports.HealthcareUserSchema = zod_1.z.object({
    ...
    phone: zod_1.z.string().regex(/^\+?[1-9]\d{10,14}$/, 'Telefone inválido').optional(),
...
exports.PatientDataSchema = zod_1.z.object({
    ...
    phone: zod_1.z.string().regex(/^\+?[1-9]\d{10,14}$/).optional(),
