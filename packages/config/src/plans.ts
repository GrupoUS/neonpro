 ...
 */
export const MODEL_ACCESS_CONTROL: Record<EnhancedAIModel, {
 ...
 */
export const PLAN_CONFIG: Record<SubscriptionTier, {
  displayName: string;
  description: string;
  ...
  free: {
    ...
    description: 'Plano gratuito para consultórios iniciantes com IA básica em português brasileiro',
  ...
  pro: {
    ...
    availableModels: ['gpt-4o-mini', 'gemini-pro', 'gpt-4o', 'healthcare-pt-br'],
    features: [
      'ai_chat_basic',
      'ai_chat_advanced',
      'ai_analytics',
 ...
 */
export const MEDICAL_SPECIALTY_REQUIREMENTS: Record<MedicalSpecialty, {
...
export function validateModelAccess(
  ...
  return planConfig.availableModels.includes(modelCode) &&
