...
export class ChatService {
  ...
  private async askSync(session: ChatSession, input: string, systemPrompt: string) {
    try {
  ...
  private async *askStream(session: ChatSession, input: string, systemPrompt: string) {
    try {
