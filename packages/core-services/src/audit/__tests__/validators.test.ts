  ...
  describe('LGPDValidator', () => {
    ...
    describe('validateConsent', () => {
      it('should return violation when no consent provided', () => {
        ...
        expect(violations[0].description).toContain('No consent reference provided');
      });
      ...
      it('should return violation for inactive consent', () => {
        ...
        expect(violations[0].description).toContain('Consent status is REVOKED');
      });
  ...
  describe('ANVISAValidator', () => {
    ...
    describe('validateMedicalAction', () => {
      it('should return violation for unauthorized medical action', () => {
        ...
        expect(violations[0].severity).toBe('CRITICAL');
        expect(violations[0].description).toContain('unauthorized actor PATIENT');
      });
      ...
      it('should return violation for incomplete identification', () => {
        ...
        expect(violations).toHaveLength(1);
        expect(violations[0].severity).toBe('HIGH');
        expect(violations[0].description).toContain('Incomplete medical professional identification');
      });
  ...
  describe('CFMValidator', () => {
    describe('validateTelemedicine', () => {
      it('should return violation for unauthorized telemedicine diagnosis', () => {
        ...
        expect(violations[0].description).toContain('without proper authorization');
      });
      ...
      it('should return violation for telemedicine without consent', () => {
        ...
        const violations = CFMValidator.validateTelemedicine(auditEvent);
        expect(violations).toHaveLength(1);
        expect(violations[0].description).toContain('without explicit patient consent');
      });
    ...
    describe('validatePrescription', () => {
      it('should return violation for prescription by non-doctor', () => {
        ...
        expect(violations.length).toBeGreaterThanOrEqual(1);
        expect(violations[0].severity).toBe('CRITICAL');
        expect(violations[0].description).toContain('Prescription by non-doctor');
      });
      ...
      it('should return violation for incomplete prescription documentation', () => {
        ...
        expect(violations).toHaveLength(1);
        expect(violations[0].severity).toBe('HIGH');
        expect(violations[0].description).toContain('Incomplete prescription documentation');
      });
  ...
  describe('ComplianceValidator', () => {
    ...
    describe('requiresConsent', () => {
      it('should require consent for LGPD framework', () => {
        expect(ComplianceValidator.requiresConsent('READ', ['LGPD'])).toBe(true);
        expect(ComplianceValidator.requiresConsent('CREATE', ['LGPD'])).toBe(true);
      });

      it('should require consent for GDPR framework', () => {
        expect(ComplianceValidator.requiresConsent('READ', ['GDPR'])).toBe(true);
        expect(ComplianceValidator.requiresConsent('CREATE', ['GDPR'])).toBe(true);
      });

      it('should not require consent for other frameworks', () => {
        expect(ComplianceValidator.requiresConsent('READ', ['ANVISA'])).toBe(false);
        expect(ComplianceValidator.requiresConsent('READ', ['CFM'])).toBe(false);
      });

      it('should require consent if any framework requires it', () => {
        expect(ComplianceValidator.requiresConsent('READ', ['LGPD', 'ANVISA'])).toBe(true);
        expect(ComplianceValidator.requiresConsent('READ', ['ANVISA', 'CFM'])).toBe(false);
      });
    });
  });
});