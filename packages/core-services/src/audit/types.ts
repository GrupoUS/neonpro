...
export type AuditAction = 
  ...
  // Healthcare specific
  | 'PRESCRIBE' | 'DIAGNOSE' | 'CONSENT_GRANT' | 'CONSENT_REVOKE'
  // System actions
  | 'BACKUP' | 'RESTORE' | 'MIGRATE' | 'AUDIT';

export type ActorType = 
  | 'PATIENT' | 'DOCTOR' | 'NURSE' | 'ADMIN' 
  | 'SYSTEM' | 'EXTERNAL_API' | 'ANONYMOUS';

export type RiskLevel = 'LOW' | 'MEDIUM' | 'HIGH' | 'CRITICAL';

export type ComplianceStatus = 'COMPLIANT' | 'NON_COMPLIANT' | 'PENDING_REVIEW' | 'UNKNOWN';
