...
export class StubModelProvider implements ModelProvider {
  ...
  async batchPredict(input: BatchPredictionInput): Promise<BatchPredictionResult> {
      ...
      case 'cost_prediction':
        ...
        return {
          value: {
            ...
            currency: 'BRL',
            factors: ['procedure_complexity', 'length_of_stay', 'complications']
          },
  ...
  private _generateFeatureImportance(input: PredictionInput): FeatureImportance[] {
