...
describe('AntiNoShowEngine', () => {
        ...
        featureImportance: [
          {
            ...
            importance: 0.4,
            description: "Patient's past appointment behavior",
          },
          {
            feature: 'time_until_appointment',
            importance: 0.3,
  ...
  describe('getInterventionConfig', () => {
    ...
    it('should return high risk intervention config', () => {
      ...
      expect(config.enabledChannels).toEqual(
        expect.arrayContaining(['whatsapp', 'sms', 'email', 'phone']),
      )
  ...
  describe('executeInterventions', () => {
      ...
      contributingFactors: [
        {
          ...
          impact: 0.4,
          description: 'Patient has missed 80% of appointments',
        },
        {
          factor: 'last_minute_scheduling',
          impact: 0.3,
          description: 'Appointment scheduled very recently',
        },
      ],
    ...
    it('should execute interventions successfully', async () => {
      mockWhatsAppService.sendAppointmentReminder.mockResolvedValue({
        success: true,
        messageId: 'msg-123',
      })
