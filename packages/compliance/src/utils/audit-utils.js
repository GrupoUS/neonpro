...
function calculateRetentionPeriod(dataCategory) {
    switch (dataCategory) {
        case 'health':
...
function determineAccessLevel(action) {
...
export function anonymizeAuditData(data) {
