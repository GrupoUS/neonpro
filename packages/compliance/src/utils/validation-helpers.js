...
export function validateAnvisaRegistration(registration) {
...
export function validateCFMLicense(license, state) {
...
export function validateHealthcareProfessionalAccess(user, requiredRole) {
    if (!user) {
...
export function validateDataRetention(dataType, createdAt, retentionPolicy) {
...
export const AppointmentSchema = z.object({
    ...
    scheduled_at: z
        .date()
        .refine((date) => date > new Date(), 'Appointment must be scheduled in the future'),
