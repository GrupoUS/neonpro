 ...
 */
export function createAuditServices(supabaseClient) {
    return {
 ...
 */
export async function validateAuditCompliance(tenantId, supabaseClient) {
    try {
        ...
        if (complianceAuditReport.report?.lastAuditDate &&
