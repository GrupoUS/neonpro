...
export { AuditTrailGeneratorService, } from './audit-trail-generator';
// Compliance Scoring Service
export { ComplianceScoringService, } from './compliance-scoring';
// Real-Time Compliance Monitor Service
export { RealTimeComplianceMonitor, } from './real-time-monitor';
/**
 * Service Factory Functions
 * Creates audit services with constitutional compliance
 */
export function createAuditTrailGeneratorService(supabaseClient) {
    return new AuditTrailGeneratorService(supabaseClient);
}
export function createRealTimeComplianceMonitorService(supabaseClient) {
    return new RealTimeComplianceMonitor(supabaseClient);
}
export function createComplianceScoringService(supabaseClient) {
 ...
 */
export function createEnterpriseAuditServices(supabaseClient) {
    return {
 ...
 */
export function validateEnterpriseAuditCompliance(supabaseClient) {
...
export function validateAuditTrailGenerator(config) {
    return Boolean(config?.retention_period_days);
}
export function validateRealTimeComplianceMonitor(config) {
    return Boolean(config?.automated_actions);
}
export function validateComplianceScoring(config) {
...
export const ENTERPRISE_AUDIT_CONFIGS = {
    auditTrail: {
        ...
        audit_detail_level: 'constitutional_full',
