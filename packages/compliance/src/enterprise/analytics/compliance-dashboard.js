...
export class ComplianceDashboardService {
    ...
    async checkComplianceViolations(metrics) {
        ...
        if (metrics.overall_compliance_score <
        ...
        if (metrics.privacy_metrics.privacy_budget_utilization >
    ...
    calculateOverallComplianceScore(scores) {
        ...
        const weightedSum = Object.entries(scores).reduce((sum, [key, score]) => sum + score * (weights[key] || 0), 0);
