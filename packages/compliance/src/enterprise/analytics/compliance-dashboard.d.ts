...
declare const ComplianceAlertSchema: z.ZodObject<{
    ...
    description: string;
    category: "anvisa" | "cfm" | "lgpd" | "constitutional" | "privacy" | "security" | "operational";
    created_at: string;
    title: string;
    alert_id: string;
...
export declare class ComplianceDashboardService {
     ...
     */
    generateComplianceReport(reportType: 'daily' | 'weekly' | 'monthly' | 'quarterly' | 'annual' | 'incident', options?: {
        reason?: string;
     ...
     */
    resolveAlert(alertId: string, resolution: string): Promise<{
        success: boolean;
    }>;
