...
export { ComplianceDashboardService, createComplianceDashboardService, validateComplianceDashboard, } from './compliance-dashboard';
export { createHealthcareIntelligenceService, HealthcareIntelligenceService, validateHealthcareIntelligence, } from './healthcare-intelligence';
export { createPrivacyPreservingAnalyticsService, PrivacyPreservingAnalyticsService, validatePrivacyPreservingAnalytics, } from './privacy-preserving-analytics';
/**
 ...
 */
export async function validateEnterpriseAnalyticsCompliance(privacyQuery, privacyConfig, dashboardConfig, intelligenceQuery, intelligenceConfig) {
    const violations = [];
