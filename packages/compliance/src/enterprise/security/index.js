...
export { ApiRateLimitingService, createApiRateLimitingService, validateApiRateLimiting, } from './api-rate-limiting';
// Healthcare Role-Based Access Control Service
export { createHealthcareRbacService, HealthcareRbacService, validateHealthcareRbac, } from './healthcare-rbac';
/**
 ...
 */
export async function validateEnterpriseSecurityCompliance(rbacConfig, rateLimitConfig) {
    const violations = [];
