...
export class ComplianceAnalyticsService {
    constructor(_supabaseClient) {
        this._supabaseClient = _supabaseClient;
    }
    async getComplianceMetrics(_tenantId) {
        return {
            success: true,
            metrics: {
                complianceScore: 85,
    ...
    async generateReport(_tenantId) {
        return {
            success: true,
            report: {
 ...
 */
export function createAnalyticsServices(supabaseClient) {
    return {
 ...
 */
export async function validateAnalyticsCompliance(tenantId, supabaseClient) {
    try {
