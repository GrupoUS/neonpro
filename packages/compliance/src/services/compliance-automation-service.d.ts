 ...
 */
export declare function createBrazilianComplianceAutomationService(supabaseClient: ReturnType<typeof createClient<Database>>, config: ComplianceAutomationConfig): BrazilianComplianceAutomationService;
/**
