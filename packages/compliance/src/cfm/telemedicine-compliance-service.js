...
export class TelemedicineComplianceService {
     ...
     */
    async validateTelemedicineCompliance(params) {
        try {
     ...
     */
    async registerTelemedicineConsultation(consultationData, userId) {
        try {
     ...
     */
    async validateDoctorTelemedicineEligibility(cfmNumber) {
        try {
            ...
            const _telemedicineSpecializations = license.specializations?.filter((spec) => spec.toLowerCase().includes('telemedicina') ||
     ...
     */
    async validateTelemedicinePlatform(platformName) {
        try {
     ...
     */
    async validateConsultationParameters(params) {
        try {
            const issues = [];
            const recommendations = [];
     ...
     */
    async checkCfmResolutionsCompliance(params) {
        try {
            ...
            const allCompliant = resolution2314.compliant &&
     ...
     */
    calculateTelemedicineComplianceScore(validationResults) {
        try {
     ...
     */
    async validateResolution2314(params) {
        const issues = [];
        // Doctor-patient relationship establishment
        if (params.consultation_type === 'telediagnosis' &&
     ...
     */
    async validateResolution2315(params) {
        const issues = [];
     ...
     */
    async validateResolution2316(params) {
        const issues = [];
     ...
     */
    async getTelemedicineConsultations(tenantId, filters) {
        try {
     ...
     */
    async generateTelemedicineComplianceReport(tenantId) {
        try {
     ...
     */
    async updateConsultationCompliance(consultationId, complianceStatus, userId, reason) {
        try {
