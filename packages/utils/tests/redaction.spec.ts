...
describe('T009: Redaction Regex Corpus', () => {
  ...
  describe('Edge Cases and Complex Patterns', () => {
    it('should handle mixed PII in single message', () => {
      const input = 'Paciente João Silva, CPF 123.456.789-00, telefone (11) 99999-8888, email joao@clinica.com';
      const result = redactPII(input);
    ...
    it('should handle non-PII medical terms', () => {
      const input = 'Paciente apresenta hipertensão arterial, glicemia 120mg/dl';
      const result = redactPII(input);
  ...
  describe('Regex Pattern Validation', () => {
    ...
    it('should handle Unicode and special characters', () => {
      const input = 'Paciente José André, CPF 123.456.789-00, telefone (11) 99999-8888';
      const result = redactPII(input);
