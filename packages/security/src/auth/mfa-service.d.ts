 ...
 */
export declare function generateTotpQrCodeUrl(secret: string, accountName: string, issuer?: string): string;
/**
 ...
 */
export declare function verifyTotpCode(secret: string, code: string, timestamp?: number): boolean;
/**
 ...
 */
export declare function sendSmsCode(_phoneNumber: string, _code: string): boolean;
/**
 ...
 * Setup MFA for user
 */
export declare function setupMfa(request: z.infer<typeof mfaSetupSchema>): Promise<{
    success: boolean;
    secret?: string;
    qrCode?: string;
    backupCodes?: string[];
 ...
 * Verify MFA code
 */
export declare function verifyMfa(request: z.infer<typeof mfaVerificationSchema>): Promise<MfaVerificationResult>;
