...
exports.globalOptimizationConfig =
...
var OptimizationConfigManager = /** @class */ (() => {
  ...
  OptimizationConfigManager.prototype.isFeatureEnabled = function (feature) {
    var _a, _b;
    return (_b = (_a = this.config[feature]) === null || _a === void 0 ? void 0 : _a.enabled) !==
      null && _b !== void 0
      ? _b
      : false;
  };
...
function useFeatureFlag(feature) {
  var _a = useOptimizationConfig(),
    isFeatureEnabled = _a.isFeatureEnabled,
    enableFeature = _a.enableFeature,
...
function validateConfig(config) {
  ...
  try {
    // Basic validation
    if (
      ((_a = config.performance) === null || _a === void 0 ? void 0 : _a.samplingInterval) &&
      config.performance.samplingInterval < 100
    ) {
      console.warn("Performance sampling interval too low, minimum is 100ms");
      return false;
    }
    if (
      ((_b = config.memory) === null || _b === void 0 ? void 0 : _b.alertThreshold) &&
    ...
    if (
      ((_c = config.bundle) === null || _c === void 0 ? void 0 : _c.chunkSizeLimit) &&
      config.bundle.chunkSizeLimit < 10000
    ) {
