...
```yaml
ui-ux-agent: ALWAYS reference in the context the ui-ux agent to follow the dev chatmode at "#file:chatmodes\apex-dev.chatmode.md → Coding, implementation, debugging"
execution_patterns:
