...
describe('Dependency Analysis Integration Tests', () => {
  let testTimeout = 45_000 // 45 second timeout for dependency analysis
  ...
  describe('Basic Analyze Command', () => {
    it('should analyze dependency relationships with dynamic imports', async () => {
  ...
  describe('Import/Export Relationship Mapping', () => {
    it('should trace all imports correctly', async () => {
    ...
    it('should detect dynamic imports when present', async () => {
    ...
    it('should distinguish external vs internal dependencies', async () => {
  ...
  describe('Circular Dependency Detection', () => {
    it('should detect circular dependencies with resolution suggestions', async () => {
      ...
      try {
        ...
        console.log('✅ Expected failure - CLI circular dependency detection not implemented yet',)
        expect(true,).toBe(false,) // Force failure for TDD
      }
    }, testTimeout,)

    it('should provide circular dependency details in JSON format', async () => {
  ...
  describe('Unused Dependencies Identification', () => {
    ...
    it('should provide unused dependencies in structured format', async () => {
  ...
  describe('Performance Requirements', () => {
    ...
    it('should report analysis metrics', async () => {
  ...
  describe('Error Handling', () => {
    it('should handle projects without dependencies gracefully', async () => {
    ...
    it('should validate analysis arguments', async () => {
      ...
      try {
        ...
        expect(stdout || stderr,).toMatch(/unknown.*flag|invalid.*option|unrecognized.*argument/i,)
