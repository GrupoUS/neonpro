...
describe('Architecture Validation Integration Tests', () => {
  let testTimeout = 30_000 // 30 second timeout for architecture validation
  ...
  describe('Basic Validate Command', () => {
    it('should validate against architecture documentation', async () => {
    ...
    it('should parse source-tree.md and tech-stack.md', async () => {
  ...
  describe('File Structure Rules Validation', () => {
    it('should validate file structure rules', async () => {
    ...
    it('should report structure violations with specific details', async () => {
      ...
      try {
        ...
        console.log('✅ Expected failure - CLI structure violation reporting not implemented yet',)
        expect(true,).toBe(false,) // Force failure for TDD
      }
    }, testTimeout,)
  })
  ...
  describe('Framework-Specific Pattern Validation', () => {
    it('should validate Turborepo patterns', async () => {
    ...
    it('should validate Hono routing patterns', async () => {
    ...
    it('should validate TanStack Router patterns', async () => {
  ...
  describe('Compliance Scoring and Reporting', () => {
    it('should generate compliance scores', async () => {
  ...
  describe('Violation Reporting with Fixes', () => {
    it('should include specific fixes in violation reports', async () => {
    ...
    it('should provide auto-fix capabilities', async () => {
  ...
  describe('Error Handling', () => {
    it('should handle missing architecture documents gracefully', async () => {
    ...
    it('should handle malformed architecture documents', async () => {
      ...
      try {
        ...
        if (error.message?.includes('parsing',) || error.message?.includes('malformed',)) {
          console.log('✅ Expected failure - CLI malformed document handling not implemented yet',)
        }
        expect(true,).toBe(false,) // Force failure for TDD
      }
    }, testTimeout,)

    it('should validate required documentation arguments', async () => {
    ...
    it('should handle projects without architecture documentation', async () => {
    ...
    it('should handle invalid framework flags', async () => {
