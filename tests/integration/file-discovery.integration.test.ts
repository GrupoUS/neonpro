...
describe('File Discovery Integration Tests', () => {
  let testTimeout = 30000 // 30 second timeout for file operations
  ...
  describe('Basic Scan Command', () => {
    it('should scan monorepo structure with dry-run', async () => {
      ...
      try {
        const { stdout } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan --dry-run apps/ packages/')
    ...
    it('should scan specific directories', async () => {
      // This will FAIL until CLI scan command is implemented  
      try {
        const { stdout } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan apps/')
    ...
    it('should correctly identify TypeScript/JavaScript files', async () => {
      ...
      try {
        const { stdout } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan --dry-run --format json packages/')
    ...
    it('should exclude hidden and node_modules directories', async () => {
      ...
      try {
        const { stdout } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan --dry-run --verbose .')
    ...
    it('should identify package boundaries correctly', async () => {
      ...
      try {
        const { stdout } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan --dry-run --show-packages .')
    ...
    it('should complete scan under 30 seconds for moderate repo size', async () => {
      ...
      try {
        ...
        const { stdout } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan --dry-run .')
    ...
    it('should report scan performance metrics', async () => {
      ...
      try {
        const { stdout } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan --dry-run --metrics packages/')
  ...
  describe('Output Formats', () => {
    it('should support JSON output format', async () => {
      ...
      try {
        const { stdout } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan --dry-run --format json apps/')
    ...
    it('should support verbose output mode', async () => {
      ...
      try {
        const { stdout } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan --dry-run --verbose packages/')
    ...
    it('should handle nonexistent directories gracefully', async () => {
      ...
      try {
        const { stdout, stderr } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan /nonexistent/directory')
    ...
    it('should handle permission denied gracefully', async () => {
      ...
      try {
        ...
        const { stdout, stderr } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan /root/ 2>&1 || echo "permission-denied-expected"')
        
        // Should handle permission errors gracefully
        if (stdout.includes('permission-denied-expected') || stderr?.includes('permission denied')) {
    ...
    it('should validate required arguments', async () => {
      ...
      try {
        const { stdout, stderr } = await execAsync('cd /home/vibecoder/neonpro && bun run audit-tool scan')
