    ...
    ScreenReaderSimulator.prototype.testHealthcareAnnouncements = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.page.locator('[role="row"]')];
                    case 1:
                        patientRows = _b.sent();
                        i = 0;
                        _b.label = 2;
...
var HealthcareFormTester = /** @class */ (function () {
    ...
    HealthcareFormTester.prototype.testBrazilianHealthcareForms = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cpfField, errorMessage, phoneField, healthcareFields, _i, healthcareFields_1, field, fieldElement;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, (0, test_1.expect)(cpfField.first()).toHaveAttribute('aria-label')];
                    case 3:
                        _a.sent();
                    ...
                    case 11:
                        _a.sent();
                        return [4 /*yield*/, (0, test_1.expect)(phoneField.first()).toHaveAttribute('aria-label')];
                    case 12:
                        _a.sent();
                        _a.label = 13;
                    case 13:
                    ...
                    case 14:
                        ...
                        fieldElement = this.page.locator("[name=\"".concat(field, "\"], [aria-label*=\"").concat(field, "\"]"));
                        return [4 /*yield*/, fieldElement.count()];
                    case 15:
                        if (!((_a.sent()) > 0)) return [3 /*break*/, 17];
                        return [4 /*yield*/, (0, test_1.expect)(fieldElement.first()).toHaveAttribute('aria-required', 'true')];
                    case 16:
                        _a.sent();
                        _a.label = 17;
                    case 17:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, test_1.expect)(errorSummary.first()).toHaveAttribute('aria-live', 'polite')];
                    case 2:
                        _b.sent();
...
test_1.test.describe('Healthcare Accessibility Compliance - WCAG 2.1 AA', function () {
    ...
    test_1.test.describe('Patients Portal Accessibility', function () {
        (0, test_1.test)('should pass WCAG 2.1 AA compliance for patients page', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            var accessibilityScanResults;
            var page = _b.page;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, page.goto('/dashboard/patients')];
                    case 1:
                        _c.sent();
        ...
        (0, test_1.test)('should support keyboard navigation in patients table', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        (0, test_1.test)('should work with NVDA screen reader', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            var firstPatientRow;
            var page = _b.page;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, (0, test_1.expect)(firstPatientRow.locator('a')).toHaveAttribute('aria-describedby')];
                    case 5:
                        // Verify aria-label for patient information
                        _c.sent();
                        return [2 /*return*/];
        ...
        (0, test_1.test)('should work with JAWS screen reader', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        (0, test_1.test)('should work with VoiceOver', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            var landmarks, _c;
            var page = _b.page;
            return __generator(this, function (_d) {
                switch (_d.label) {
    ...
    test_1.test.describe('Healthcare Forms Accessibility', function () {
        (0, test_1.test)('should support Brazilian healthcare form patterns', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            var page = _b.page;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, page.goto('/dashboard/patients/new')];
                    case 1:
                        _c.sent();
        ...
        (0, test_1.test)('should handle healthcare form errors accessibly', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            var submitButton;
            var page = _b.page;
            return __generator(this, function (_c) {
                switch (_c.label) {
    ...
    test_1.test.describe('Color Contrast and Visual Accessibility', function () {
        (0, test_1.test)('should meet WCAG AA color contrast ratios', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            var axeResults;
            var page = _b.page;
            return __generator(this, function (_c) {
                switch (_c.label) {
        ...
        (0, test_1.test)('should support high contrast mode', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    return [4 /*yield*/, page.emulateMedia({ colorScheme: 'dark', forcedColors: 'active' })];
                    case 1:
                        // Test Windows high contrast mode
                        _g.sent();
    ...
    test_1.test.describe('Portuguese Localization Accessibility', function () {
        (0, test_1.test)('should provide proper Portuguese language declarations', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        (0, test_1.test)('should format Brazilian data correctly for screen readers', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    test_1.test.describe('Healthcare-Specific Accessibility Patterns', function () {
        (0, test_1.test)('should announce patient status changes appropriately', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        (0, test_1.test)('should provide appropriate healthcare data context', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
