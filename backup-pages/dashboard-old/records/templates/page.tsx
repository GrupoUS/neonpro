...
export default async function RecordTemplatesPage() {
  ...
  const breadcrumbs = [{"title":"Dashboard","href":"/dashboard"},{"title":"Prontuários","href":"/dashboard/records"},{"title":"Modelos"}];
    ...
    <DashboardLayout user={user} breadcrumbs={breadcrumbs}>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Modelos de Prontuário</h2>
            <p className="text-muted-foreground">Gerencie modelos de prontuários</p>
          </div>
          <Button>
