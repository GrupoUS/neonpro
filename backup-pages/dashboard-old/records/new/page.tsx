...
export default async function NewRecordPage() {
  ...
  const breadcrumbs = [{"title":"Dashboard","href":"/dashboard"},{"title":"Prontuários","href":"/dashboard/records"},{"title":"Novo Prontuário"}];
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Crie um novo prontuário médico</p>
          </div>
          <Button>
