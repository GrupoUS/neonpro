...
export default async function ExportPage() {
  ...
  const breadcrumbs = [{"title":"Dashboard","href":"/dashboard"},{"title":"Relatórios","href":"/dashboard/reports"},{"title":"Exportar Dados"}];
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Exporte dados e relatórios</p>
          </div>
          <Button>
